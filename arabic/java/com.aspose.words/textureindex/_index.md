...
description: "يحدد نسيج التظليل في Java."
type: docs
weight: 681
url: /ar/java/com.aspose.words/textureindex/
---
...
| [TEXTURE_NIL](#TEXTURE-NIL) | يحدد أنه لا يجب استخدام أي نمط في المنطقة المظللة الحالية (أي |
...
يحدد أنه لا يجب استخدام أي نمط في المنطقة المظللة الحالية (أي يجب أن يكون النمط تعبئة كاملة بلون الخلفية).
