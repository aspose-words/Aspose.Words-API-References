...
description: "يُنفّذ حقل EQ في Java."
type: docs
weight: 226
url: /ar/java/com.aspose.words/fieldeq/
---
...
يُظهر كيفية استخدام حقل EQ لعرض مجموعة متنوعة من المعادلات الرياضية.
...
يُظهر كيفية استبدال حقل EQ بـ Office Math.
...
| طريقة | الوصف |
| --- | --- |
| [asOfficeMath()](#asOfficeMath) | يعيد كائن Office Math المقابل لحقل EQ. |
...
يعيد كائن Office Math المقابل لحقل EQ.
