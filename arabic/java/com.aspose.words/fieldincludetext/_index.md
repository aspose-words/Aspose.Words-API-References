...
description: "يطبق حقل INCLUDETEXT في Java."
type: docs
weight: 248
url: /ar/java/com.aspose.words/fieldincludetext/
---
...
ينفّذ حقل INCLUDETEXT.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يدرج كل أو جزء من النص والرسومات الموجودة في مستند آخر.

 **Examples:** 

يظهر كيفية إنشاء حقل INCLUDETEXT، وتعيين خصائصه.
...
| طريقة | الوصف |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | يحصل على اسم الإشارة المرجعية في المستند المراد تضمينه. |
| [getDisplayResult()](#getDisplayResult) | يحصل على النص الذي يمثل نتيجة الحقل المعروضة. |
| [getEncoding()](#getEncoding) | يحصل على الترميز المطبق على البيانات داخل الملف المشار إليه. |
...
| [getLockFields()](#getLockFields) | يحصل على ما إذا كان يجب منع حقول المستند المضمن من التحديث. |
| [getMimeType()](#getMimeType) | يحصل على نوع MIME للملف المشار إليه. |
| [getNamespaceMappings()](#getNamespaceMappings) | يحصل على تعيينات مساحة الاسم لاستعلامات XPath. |
...
| [getSourceFullName()](#getSourceFullName) | يحصل على موقع المستند باستخدام IRI. |
| [getStart()](#getStart) | يحصل على العقدة التي تمثل بداية الحقل. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTextConverter()](#getTextConverter) | يحصل على اسم محول النص لتنسيق الملف المضمن. |
| [getType()](#getType) | يحصل على نوع حقل Microsoft Word. |
| [getXPath()](#getXPath) | يحصل على XPath للجزء المطلوب من ملف XML. |
| [getXslTransformation()](#getXslTransformation) | يحصل على موقع تحويل XSL لتنسيق بيانات XML. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | يضبط اسم الإشارة المرجعية في المستند المراد تضمينه. |
| [setEncoding(String value)](#setEncoding-java.lang.String) | يضبط الترميز المطبق على البيانات داخل الملف المشار إليه. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setLockFields(boolean value)](#setLockFields-boolean) | يضبط ما إذا كان يجب منع حقول المستند المضمن من التحديث. |
| [setMimeType(String value)](#setMimeType-java.lang.String) | يضبط نوع MIME للملف المشار إليه. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | يضبط تعيينات مساحة الاسم لاستعلامات XPath. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يضبط موقع المستند باستخدام IRI. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | يضبط اسم محول النص لتنسيق الملف المضمن. |
| [setXPath(String value)](#setXPath-java.lang.String) | يضبط XPath للجزء المطلوب من ملف XML. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | يضبط موقع تحويل XSL لتنسيق بيانات XML. |
...
يحصل على اسم الإشارة المرجعية في المستند المراد تضمينه.
...
**Returns:**
java.lang.String - اسم الإشارة المرجعية في المستند المراد تضمينه.
...
يحصل على الترميز المطبق على البيانات داخل الملف المشار إليه.
...
**Returns:**
java.lang.String - الترميز المطبق على البيانات داخل الملف المشار إليه.
### getEnd() {#getEnd}
```
...
يحصل على ما إذا كان يجب منع حقول المستند المضمن من التحديث.
...
**Returns:**
boolean - ما إذا كان يجب منع حقول المستند المضمن من التحديث.
...
يحصل على نوع MIME للملف المشار إليه.
...
**Returns:**
java.lang.String - نوع MIME للملف المشار إليه.
...
يحصل على تعيينات مساحة الاسم لاستعلامات XPath.
...
**Returns:**
java.lang.String - تعيينات مساحة الاسم لاستعلامات XPath.
### getResult() {#getResult}
```
...
يحصل على موقع المستند باستخدام IRI.
...
**Returns:**
java.lang.String - موقع المستند باستخدام IRI.
### getStart() {#getStart}
```
...
يحصل على اسم محول النص لتنسيق الملف المضمن.
...
**Returns:**
java.lang.String - اسم محول النص لتنسيق الملف المضمن.
### getType() {#getType}
```
public int getType()
```
...
يحصل على XPath للجزء المطلوب من ملف XML.
...
**Returns:**
java.lang.String - XPath للجزء المطلوب من ملف XML.
...
يحصل على موقع تحويل XSL لتنسيق بيانات XML.
...
**Returns:**
java.lang.String - موقع تحويل XSL لتنسيق بيانات XML.
### isDirty() {#isDirty}
```
...
يضبط اسم الإشارة المرجعية في المستند المراد تضمينه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم العلامة المرجعية في المستند لتضمينه. |
...
يضبط الترميز المطبق على البيانات داخل الملف المشار إليه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الترميز المطبق على البيانات داخل الملف المشار إليه. |
...
يضبط ما إذا كان يجب منع حقول المستند المضمن من التحديث.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب منع حقول المستند المضمن من التحديث. |
...
يضبط نوع MIME للملف المشار إليه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نوع MIME للملف المشار إليه. |
...
يضبط تعيينات مساحة الاسم لاستعلامات XPath.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | تعيينات مساحة الاسم لاستعلامات XPath. |
...
يضبط موقع المستند باستخدام IRI.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع المستند باستخدام IRI. |
...
يضبط اسم محول النص لتنسيق الملف المضمن.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم محول النص لتنسيق الملف المضمن. |
...
يضبط XPath للجزء المطلوب من ملف XML.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | XPath للجزء المطلوب من ملف XML. |
...
يضبط موقع تحويل XSL لتنسيق بيانات XML.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع تحويل XSL لتنسيق بيانات XML. |
