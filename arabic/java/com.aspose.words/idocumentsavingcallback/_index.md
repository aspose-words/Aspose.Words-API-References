...
description: "نفّذ هذه الواجهة إذا كنت تريد أن يتم استدعاء طريقتك المخصصة أثناء حفظ مستند في Java."
type: docs
weight: 763
url: /ar/java/com.aspose.words/idocumentsavingcallback/
---
```
public interface IDocumentSavingCallback
```

نفّذ هذه الواجهة إذا كنت تريد أن تكون لديك طريقة مخصصة تُستدعى أثناء حفظ مستند.
...
| طريقة | الوصف |
| --- | --- |
| [notify(DocumentSavingArgs args)](#notify-com.aspose.words.DocumentSavingArgs) | يُستدعى هذا لإبلاغك بتقدم حفظ المستند. |
...
يُستدعى هذا لإبلاغك بتقدم حفظ المستند.

 **Remarks:** 

الاستخدامات الأساسية لهذا الواجهة هي السماح لكود التطبيق بالحصول على حالة التقدم وإلغاء عملية الحفظ.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| args | [DocumentSavingArgs](../../com.aspose.words/documentsavingargs/) | معامل الحدث. |
