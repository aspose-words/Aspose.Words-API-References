...
description: "يسرد المواقع المتاحة لكائن لوحة المهام في جافا."
type: docs
weight: 665
url: /ar/java/com.aspose.words/taskpanedockstate/
---
...
| حقل | الوصف |
| --- | --- |
| [LEFT](#LEFT) | إرساء لوحة المهام على الجانب الأيسر من نافذة المستند. |
| [RIGHT](#RIGHT) | إرساء لوحة المهام على الجانب الأيمن من نافذة المستند. |
| [length](#length) |  |
## الطرق
...
إرساء لوحة المهام على الجانب الأيسر من نافذة المستند.
...
إرساء لوحة المهام على الجانب الأيمن من نافذة المستند.
