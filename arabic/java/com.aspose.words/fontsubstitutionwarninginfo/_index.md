...
description: "يحتوي على معلومات حول تحذير استبدال الخط الذي أصدرته Aspose.Words أثناء تحميل أو حفظ المستند في جافا."
type: docs
weight: 338
url: /ar/java/com.aspose.words/fontsubstitutionwarninginfo/
---
...
يحتوي على معلومات حول تحذير استبدال الخط الذي أصدرته Aspose.Words أثناء تحميل أو حفظ المستند.
...
| [getReason()](#getReason) | سبب استبدال الخط. |
| [getRequestedBold()](#getRequestedBold) | يشير إلى ما إذا كان نمط الغامق مطلوبًا. |
| [getRequestedFamilyName()](#getRequestedFamilyName) | اسم عائلة الخط المطلوبة. |
| [getRequestedItalic()](#getRequestedItalic) | يشير إلى ما إذا كان نمط المائل مطلوبًا. |
| [getResolvedFont()](#getResolvedFont) | الخط المحلول. |
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [FontSubstitutionReason](../../com.aspose.words/fontsubstitutionreason/).
...
يشير إلى ما إذا كان نمط الغامق مطلوبًا.
...
يشير إلى ما إذا كان نمط المائل مطلوبًا.
