...
description: "يوفر وظائف مساعدة لتحويل بين وحدات قياس مختلفة في Java."
type: docs
weight: 131
url: /ar/java/com.aspose.words/convertutil/
---
...
يوفر دوال مساعدة للتحويل بين وحدات قياس مختلفة.

لمزيد من المعلومات، زر مقالة الوثائق [ Convert Between Measurement Units ][Convert Between Measurement Units].
...
| طريقة | الوصف |
| --- | --- |
| [inchToPoint(double inches)](#inchToPoint-double) | يحول البوصة إلى نقاط. |
| [millimeterToPoint(double millimeters)](#millimeterToPoint-double) | يحول المليمترات إلى نقاط. |
| [pixelToNewDpi(double pixels, double oldDpi, double newDpi)](#pixelToNewDpi-double-double-double) | يحول البكسلات من دقة إلى أخرى. |
| [pixelToPoint(double pixels)](#pixelToPoint-double) | يحول البكسلات إلى نقاط. |
| [pixelToPoint(double pixels, double resolution)](#pixelToPoint-double-double) | يحول البكسلات إلى نقاط عند دقة البكسل المحددة. |
| [pointToInch(double points)](#pointToInch-double) | يحول النقاط إلى بوصة. |
| [pointToPixel(double points)](#pointToPixel-double) | يحول النقاط إلى بكسلات. |
| [pointToPixel(double points, double resolution)](#pointToPixel-double-double) | يحول النقاط إلى بكسلات عند دقة البكسل المحددة. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| بوصات | double | القيمة المراد تحويلها. |
...
1 بوصة تساوي 25.4 مليمتر. 1 بوصة تساوي 72 نقطة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| مليمترات | double | القيمة المراد تحويلها. |
...
يحول البكسلات من دقة إلى أخرى.

 **Examples:** 

يوضح كيفية استخدام تحويل النقاط إلى بكسلات مع الدقة الافتراضية والمخصصة.
...
| oldDpi | double | دقة الـ dpi الحالية (نقطة في البوصة). |
| newDpi | double | دقة الـ dpi الجديدة (نقطة في البوصة). |
...
يحوّل البكسلات إلى نقاط.  يحوّل البكسلات إلى نقاط عند 96 dpi.
...
يوضح كيفية تحديد خصائص الصفحة بالبكسلات.
...
يحول البكسلات إلى نقاط عند دقة البكسل المحددة.
...
| --- | --- | --- |
| بكسلات | double | القيمة المراد تحويلها. |
| resolution | double | دقة الـ dpi (نقطة في البوصة). |
...
يحوّل النقاط إلى بكسلات.  يحوّل النقاط إلى بكسلات عند 96 dpi.
...
يحول النقاط إلى بكسلات عند دقة البكسل المحددة.
