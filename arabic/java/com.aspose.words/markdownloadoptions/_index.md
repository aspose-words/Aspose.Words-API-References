...
description: "يسمح بتحديد خيارات إضافية عند تحميل مستند LoadFormat.MARKDOWN إلى كائن Document في Java."
type: docs
weight: 454
url: /ar/java/com.aspose.words/markdownloadoptions/
---
...
يسمح بتحديد خيارات إضافية عند تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) إلى كائن [Document](../../com.aspose.words/document/).

 **Examples:** 

يوضح كيفية الحفاظ على سطر فارغ أثناء تحميل مستند.
...
| المنشئ | الوصف |
| --- | --- |
| [MarkdownLoadOptions()](#MarkdownLoadOptions) | يُنشئ مثيلًا جديدًا من الفئة [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/). |
## الطرق
...
| [getImportUnderlineFormatting()](#getImportUnderlineFormatting) | يحصل على قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي. |
...
| [getPreserveEmptyLines()](#getPreserveEmptyLines) | يحصل على قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [getSoftLineBreakCharacter()](#getSoftLineBreakCharacter) | يحصل على قيمة حرفية تمثل فاصل سطر ناعم. |
...
| [setImportUnderlineFormatting(boolean value)](#setImportUnderlineFormatting-boolean) | يضبط قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي. |
...
| [setPreserveEmptyLines(boolean value)](#setPreserveEmptyLines-boolean) | يضبط قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [setSoftLineBreakCharacter(char value)](#setSoftLineBreakCharacter-char) | يضبط قيمة حرفية تمثل فاصل سطر ناعم. |
...
يُنشئ مثيلًا جديدًا من الفئة [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/).

 **Remarks:** 

يضبط تلقائيًا [LoadFormat](../../com.aspose.words/loadformat/) إلى [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
يحصل على قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي. القيمة الافتراضية هي false.

 **Examples:** 

يوضح كيفية التعرف على حرفي زائد "++" كتنسيق نص تحتي.
...
**Returns:**
boolean - قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي.
...
يحصل على قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). القيمة الافتراضية هي false.

عادةً ما يتم تجاهل الأسطر الفارغة بين العناصر على مستوى الكتلة في Markdown. كما يتم تجاهل الأسطر الفارغة في بداية ونهاية المستند. يتيح هذا الخيار استيراد هذه الأسطر الفارغة.
...
**Returns:**
boolean - قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
يحصل على قيمة حرفية تمثل فاصل سطر ناعم. القيمة الافتراضية هي SPACE (U+0020).

 **Remarks:** 

ملاحظة، ضبط هذا الخيار إلى [ControlChar.LINE\_BREAK\_CHAR](../../com.aspose.words/controlchar/\#LINE-BREAK-CHAR) يتيح لك تحميل فواصل السطر الناعمة كفواصل سطر صلبة.

 **Examples:** 

يوضح كيفية ضبط حرف فاصل السطر الناعم.
...
**Returns:**
char - قيمة حرفية تمثل فاصل سطر ناعم.
...
يضبط قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي. القيمة الافتراضية هي false.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | قيمة منطقية تشير إلى ما إذا كان يجب التعرف على تسلسل من حرفين زائد "++" كتنسيق نص تحتي. |
...
يضبط قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). القيمة الافتراضية هي false.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | boolean | قيمة منطقية تشير إلى ما إذا كان يجب الحفاظ على الأسطر الفارغة أثناء تحميل مستند [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
يضبط قيمة حرفية تمثل فاصل سطر ناعم. القيمة الافتراضية هي SPACE (U+0020) .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | char | قيمة حرفية تمثل فاصل سطر ناعم. |
