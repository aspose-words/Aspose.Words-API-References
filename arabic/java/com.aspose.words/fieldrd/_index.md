...
description: "ينفّذ حقل RD في Java."
type: docs
weight: 277
url: /ar/java/com.aspose.words/fieldrd/
---
...
يحدد ملفًا لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس باستخدام حقل TOC أو TOA أو INDEX.

 **Examples:** 

يوضح كيفية استخدام حقل RD لإنشاء إدخالات جدول محتويات من العناوين في مستندات أخرى.
...
| [getFileName()](#getFileName) | يحصل على اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس. |
...
| [isPathRelative()](#isPathRelative) | يحصل على ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | يضبط ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي. |
| [remove()](#remove) | يزيل الحقل من المستند. |
| [setFileName(String value)](#setFileName-java.lang.String) | يضبط اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس. |
...
يحصل على اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس.
...
**Returns:**
java.lang.String - اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس.
### getFormat() {#getFormat}
```
...
يحصل على ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي.
...
**Returns:**
boolean - ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي.
...
يضبط ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان المسار نسبيًا بالنسبة للمستند الحالي. |
...
يضبط اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم الملف لتضمينه عند إنشاء جدول محتويات أو جدول مراجع أو فهرس. |
