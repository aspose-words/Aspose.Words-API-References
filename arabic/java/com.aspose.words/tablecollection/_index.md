...
description: "يوفر وصولًا مكتوبًا إلى مجموعة من عقد Table في Java."
type: docs
weight: 658
url: /ar/java/com.aspose.words/tablecollection/
---
...
يوفر وصولًا مكتوبًا إلى مجموعة من عقد [Table](../../com.aspose.words/table/).

للتعرف على المزيد، زر مقالة الوثائق [ Working with Tables ][Working with Tables].

 **Examples:** 

يظهر كيفية إزالة الصف الأول والأخير من جميع الجداول في مستند.
...
| [get(int index)](#get-int) | يسترجع [Table](../../com.aspose.words/table/) عند الفهرس المعطى. |
...
يسترجع [Table](../../com.aspose.words/table/) عند الفهرس المعطى.
...
ينسخ جميع الجداول من المجموعة إلى مصفوفة جديدة من الجداول.
...
**Returns:**
com.aspose.words.Node[] - مصفوفة من الجداول.
