...
description: "قم بتنفيذ هذه الواجهة إذا كنت ترغب في التحكم في كيفية إدراج البيانات في حقول الدمج أثناء عملية دمج البريد في Java."
type: docs
weight: 765
url: /ar/java/com.aspose.words/ifieldmergingcallback/
---
```
public interface IFieldMergingCallback
```

نفّذ هذه الواجهة إذا كنت تريد التحكم في كيفية إدخال البيانات في حقول الدمج أثناء عملية دمج البريد.
...
| طريقة | الوصف |
| --- | --- |
| [fieldMerging(FieldMergingArgs args)](#fieldMerging-com.aspose.words.FieldMergingArgs) | يُستدعى عندما يكون محرك دمج البريد Aspose.Words على وشك إدراج بيانات في حقل دمج داخل المستند. |
| [imageFieldMerging(ImageFieldMergingArgs args)](#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs) | يُستدعى عندما يكون محرك دمج البريد Aspose.Words على وشك إدراج صورة في حقل دمج. |
...
يُستدعى عندما يكون محرك دمج البريد Aspose.Words على وشك إدراج بيانات في حقل دمج داخل المستند.
...
يُستدعى عندما يكون محرك دمج البريد Aspose.Words على وشك إدراج صورة في حقل دمج.
