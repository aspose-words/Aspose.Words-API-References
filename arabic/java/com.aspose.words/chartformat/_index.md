...
description: "يمثل تنسيق عنصر المخطط في Java."
type: docs
weight: 78
url: /ar/java/com.aspose.words/chartformat/
---
...
| [getEndCap()](#getEndCap) |  |
| [getFill()](#getFill) | يحصل على تنسيق التعبئة لعنصر المخطط الأب. |
...
| [getShapeType()](#getShapeType) | يحصل على نوع الشكل لعنصر المخطط الأب. |
| [getStartArrowLength()](#getStartArrowLength) |  |
| [getStartArrowType()](#getStartArrowType) |  |
| [getStartArrowWidth()](#getStartArrowWidth) |  |
| [getStroke()](#getStroke) | يحصل على تنسيق الخط لعنصر المخطط الأب. |
...
| [getWeight()](#getWeight) |  |
| [isDefined()](#isDefined) | يحصل على علامة تشير إلى ما إذا كان أي تنسيق معرف. |
...
| [setDefaultFill()](#setDefaultFill) | يعيد تعيين تعبئة عنصر المخطط لتكون بالقيمة الافتراضية. |
...
| [setShapeType(int value)](#setShapeType-int) | يضبط نوع الشكل لعنصر المخطط الأب. |
...
يحصل على نوع الشكل لعنصر المخطط الأب.
...
**Returns:**
int - نوع الشكل لعنصر المخطط الأب. القيمة المرجعة هي واحدة من ثوابت [ChartShapeType](../../com.aspose.words/chartshapetype/).
### getStartArrowLength() {#getStartArrowLength}
```
...
يحصل على تنسيق الخط لعنصر المخطط الأب.
...
يحصل على علامة تشير إلى ما إذا كان أي تنسيق معرف.
...
**Returns:**
boolean - علامة تشير إلى ما إذا كان أي تنسيق معرف.
### oneColorGradient(int style, int variant, double degree) {#oneColorGradient-int-int-double}
```
...
يعيد تعيين تعبئة عنصر المخطط لتكون بالقيمة الافتراضية.
...
يضبط نوع الشكل لعنصر المخطط الأب.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | نوع الشكل لعنصر المخطط الأب. يجب أن تكون القيمة واحدة من ثوابت [ChartShapeType](../../com.aspose.words/chartshapetype/). |
