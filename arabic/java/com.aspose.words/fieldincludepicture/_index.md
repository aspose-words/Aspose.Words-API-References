...
description: "تنفذ الحقل INCLUDEPICTURE في Java."
type: docs
weight: 247
url: /ar/java/com.aspose.words/fieldincludepicture/
---
...
ينفّذ حقل INCLUDEPICTURE.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

تسترجع صورة وتعرضها كنتيجة الحقل.

 **Examples:** 

توضح كيفية إدراج الصور باستخدام حقول IMPORT و INCLUDEPICTURE.
...
| [getGraphicFilter()](#getGraphicFilter) | يحصل على اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getResizeHorizontally()](#getResizeHorizontally) | يحصل على ما إذا كان يجب تغيير حجم الصورة أفقياً من المصدر. |
| [getResizeVertically()](#getResizeVertically) | يحصل على ما إذا كان يجب تغيير حجم الصورة عمودياً من المصدر. |
...
| [getSourceFullName()](#getSourceFullName) | يحصل على موقع الصورة باستخدام IRI. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | يضبط اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | يضبط ما إذا كان يجب تغيير حجم الصورة أفقياً من المصدر. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | يضبط ما إذا كان يجب تغيير حجم الصورة عمودياً من المصدر. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يضبط موقع الصورة باستخدام IRI. |
...
يحصل على اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه.
...
**Returns:**
java.lang.String - اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه.
...
يحصل على ما إذا كان يجب تغيير حجم الصورة أفقياً من المصدر.
...
**Returns:**
boolean - ما إذا كان يجب تغيير حجم الصورة أفقياً من المصدر.
...
يحصل على ما إذا كان يجب تغيير حجم الصورة عمودياً من المصدر.
...
**Returns:**
boolean - ما إذا كان يجب تغيير حجم الصورة عمودياً من المصدر.
### getResult() {#getResult}
```
...
يحصل على موقع الصورة باستخدام IRI.
...
**Returns:**
java.lang.String - موقع الصورة باستخدام IRI.
### getStart() {#getStart}
```
...
يضبط اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم الفلتر لتنسيق الصورة التي سيتم إدراجها. |
...
يضبط ما إذا كان يجب تغيير حجم الصورة أفقياً من المصدر.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم تغيير حجم الصورة أفقياً من المصدر. |
...
يضبط ما إذا كان يجب تغيير حجم الصورة عمودياً من المصدر.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم تغيير حجم الصورة رأسياً من المصدر. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع الصورة باستخدام IRI. |
