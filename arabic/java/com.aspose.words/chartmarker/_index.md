...
description: "يمثل علامة بيانات المخطط في جافا."
type: docs
weight: 82
url: /ar/java/com.aspose.words/chartmarker/
---
...
| طريقة | الوصف |
| --- | --- |
| [getFormat()](#getFormat) | يوفر الوصول إلى تنسيق التعبئة والخط لهذه العلامة. |
| [getShapeType()](#getShapeType) |  |
| [getSize()](#getSize) | يحصل على حجم علامة المخطط. |
| [getSymbol()](#getSymbol) | يحصل على رمز علامة المخطط. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSize(int value)](#setSize-int) | يضبط حجم علامة المخطط. |
| [setSymbol(int value)](#setSymbol-int) | يضبط رمز علامة المخطط. |
### getFormat() {#getFormat}
```
...
يوفر الوصول إلى تنسيق التعبئة والخط لهذه العلامة.
...
يحصل على حجم علامة المخطط. القيمة الافتراضية هي 7.
...
**Returns:**
int - رمز علامة المخطط. القيمة المرجعة هي واحدة من الثوابت [MarkerSymbol](../../com.aspose.words/markersymbol/).
### isFillSupported() {#isFillSupported}
```
...
يضبط حجم علامة المخطط. القيمة الافتراضية هي 7.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | رمز علامة المخطط. يجب أن تكون القيمة واحدة من الثوابت [MarkerSymbol](../../com.aspose.words/markersymbol/). |
