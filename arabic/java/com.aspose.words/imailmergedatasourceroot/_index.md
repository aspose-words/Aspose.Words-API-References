...
description: "نفّذ هذه الواجهة للسماح بدمج البريد من مصدر بيانات مخصص يحتوي على بيانات رئيسية-تفصيلية في جافا."
type: docs
weight: 777
url: /ar/java/com.aspose.words/imailmergedatasourceroot/
---
```
public interface IMailMergeDataSourceRoot
```

قم بتنفيذ هذه الواجهة للسماح بدمج البريد من مصدر بيانات مخصص يحتوي على بيانات رئيسية وتفصيلية.

 **Examples:** 

يُجري دمج البريد من مصدر بيانات مخصص يحتوي على بيانات رئيسية-تفصيلية.
...
| طريقة | الوصف |
| --- | --- |
| [getDataSource(String tableName)](#getDataSource-java.lang.String) | محرك دمج البريد في Aspose.Words يستدعي هذه الطريقة عندما يصادف بداية منطقة دمج بريد من المستوى الأعلى. |
...
محرك دمج البريد في Aspose.Words يستدعي هذه الطريقة عندما يصادف بداية منطقة دمج بريد من المستوى الأعلى.

 **Remarks:** 

عندما يقوم محرك دمج البريد في Aspose.Words بملء مستند بالبيانات ويصادف MERGEFIELD TableStart:TableName، يستدعي [getDataSource(java.lang.String)](../../com.aspose.words/imailmergedatasourceroot/\\#getDataSource-java.lang.String) على هذا الكائن. يحتاج تنفيذك إلى إرجاع كائن مصدر بيانات جديد. سيستخدم Aspose.Words مصدر البيانات المرتجع لملء منطقة دمج البريد.

إذا لم يكن مصدر بيانات (جدول) بالاسم المحدد موجودًا، يجب على تنفيذك إرجاع  null .
