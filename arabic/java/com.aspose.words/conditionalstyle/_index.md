...
description: "يمثل تنسيقًا خاصًا يُطبق على جزء من جدول مع نمط جدول معين في Java."
type: docs
weight: 123
url: /ar/java/com.aspose.words/conditionalstyle/
---
...
يمثل التنسيق الخاص المطبق على جزء من جدول مع نمط جدول معين.
...
| [equals(Object obj)](#equals-java.lang.Object) | يقارن هذا النمط الشرطي مع الكائن المحدد. |
...
| [getBorders()](#getBorders) | يحصل على مجموعة حدود الخلايا الافتراضية للنمط الشرطي. |
...
| [getFont()](#getFont) | يحصل على تنسيق الأحرف للنمط الشرطي. |
| [getLeftPadding()](#getLeftPadding) | يحصل على مقدار المسافة (بالنقاط) لإضافتها إلى يسار محتويات خلايا الجدول. |
| [getParagraphFormat()](#getParagraphFormat) | يحصل على تنسيق الفقرة للنمط الشرطي. |
| [getRightPadding()](#getRightPadding) | يحصل على مقدار المسافة (بالنقاط) لإضافتها إلى يمين محتويات خلايا الجدول. |
| [getShading()](#getShading) | يحصل على كائن [Shading](../../com.aspose.words/shading/) الذي يشير إلى تنسيق التظليل لهذا النمط الشرطي. |
| [getTopPadding()](#getTopPadding) | يحصل على مقدار المسافة (بالنقاط) لإضافتها فوق محتويات خلايا الجدول. |
| [getType()](#getType) | يحصل على منطقة الجدول التي يرتبط بها هذا النمط الشرطي. |
| [hashCode()](#hashCode) |  |
...
يقارن هذا النمط الشرطي مع الكائن المحدد.
...
يحصل على تنسيق الأحرف للنمط الشرطي.
...
يحصل على كائن [Shading](../../com.aspose.words/shading/) الذي يشير إلى تنسيق التظليل لهذا النمط الشرطي.
...
يحصل على منطقة الجدول التي يرتبط بها هذا النمط الشرطي.
...
**Returns:**
int - منطقة الجدول التي يرتبط بها هذا النمط الشرطي. القيمة المرجعة هي واحدة من ثوابت [ConditionalStyleType](../../com.aspose.words/conditionalstyletype/) .
### hashCode() {#hashCode}
```
public int hashCode()
```
