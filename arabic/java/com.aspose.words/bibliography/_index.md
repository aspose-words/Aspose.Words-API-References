...
description: "يمثل قائمة مصادر الببليوغرافيا المتاحة في المستند في جافا."
type: docs
weight: 38
url: /ar/java/com.aspose.words/bibliography/
---
...
يمثل قائمة مصادر الببليوغرافيا المتاحة في المستند.
...
| طريقة | الوصف |
| --- | --- |
| [getBibliographyStyle()](#getBibliographyStyle) | يحصل على سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا. |
| [getSources()](#getSources) | يحصل على مجموعة تمثل جميع المصادر الموجودة في الببليوغرافيا. |
| [setBibliographyStyle(String value)](#setBibliographyStyle-java.lang.String) | يضبط سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا. |
...
يحصل على سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا.
...
**Returns:**
java.lang.String - سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا.
...
يحصل على مجموعة تمثل جميع المصادر الموجودة في الببليوغرافيا.
...
**Returns:**
java.util.ArrayList - مجموعة تمثل جميع المصادر الموجودة في الببليوغرافيا.
...
يضبط سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | سلسلة تمثل اسم النمط النشط لاستخدامه في الببليوغرافيا. |
