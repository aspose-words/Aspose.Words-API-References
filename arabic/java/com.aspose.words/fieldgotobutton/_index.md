...
description: "ينفذ حقل GOTOBUTTON في جافا."
type: docs
weight: 240
url: /ar/java/com.aspose.words/fieldgotobutton/
---
...
ينفّذ حقل GOTOBUTTON.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يدرج أمر قفزة، بحيث عندما يتم تنشيطه، يتم نقل نقطة الإدراج في المستند إلى الموقع المحدد.

 **Examples:** 

يعرض طريقة إدراج حقل GOTOBUTTON.
...
| [getDisplayText()](#getDisplayText) | يحصل على نص \"الزر\" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفزة. |
...
| [getLocation()](#getLocation) | يحصل على اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفزة إليه. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | يضبط نص \"الزر\" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفزة. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setLocation(String value)](#setLocation-java.lang.String) | يضبط اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفزة إليه. |
...
يحصل على نص \"الزر\" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفزة.
...
**Returns:**
java.lang.String - النص الخاص بـ "button" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفز.
### getEnd() {#getEnd}
```
...
يحصل على اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفزة إليه.
...
**Returns:**
java.lang.String - اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفز إليه.
### getResult() {#getResult}
```
...
يضبط نص \"الزر\" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفزة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص الخاص بـ "button" الذي يظهر في المستند، بحيث يمكن اختياره لتفعيل القفز. |
...
يضبط اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفزة إليه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفز إليه. |
