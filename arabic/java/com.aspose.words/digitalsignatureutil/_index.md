...
description: "يوفر طرقًا لتوقيع المستند في Java."
type: docs
weight: 154
url: /ar/java/com.aspose.words/digitalsignatureutil/
---
...
نظرًا لأن التوقيع الرقمي يعمل مع محتوى الملف بدلاً من نموذج كائن المستند، تم وضع هذه الطرق في فئة منفصلة.

الصيغ المدعومة هي: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).

 **Examples:** 

يعرض كيفية تحميل التوقيعات من مستند موقّع رقمياً.
...
يعرض كيفية إزالة التوقيعات الرقمية من مستند موقّع رقمياً.
...
| [loadSignatures(String fileName)](#loadSignatures-java.lang.String) | يقوم بتحميل التوقيعات الرقمية من المستند. |
...
| [removeAllSignatures(String srcFileName, String dstFileName)](#removeAllSignatures-java.lang.String-java.lang.String) | يزيل جميع التوقيعات الرقمية من الملف المصدر ويكتب ملفًا غير موقع إلى ملف الوجهة. |
...
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder) | يوقع المستند المصدر باستخدام [CertificateHolder](../../com.aspose.words/certificateholder/) المعطى مع توقيع رقمي ويكتب المستند الموقع إلى ملف الوجهة. |
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder, SignOptions signOptions)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder-com.aspose.words.SignOptions) | يوقع المستند المصدر باستخدام [CertificateHolder](../../com.aspose.words/certificateholder/) و[SignOptions](../../com.aspose.words/signoptions/) المعطى مع توقيع رقمي ويكتب المستند الموقع إلى ملف الوجهة. |
### loadSignatures(InputStream stream) {#loadSignatures-java.io.InputStream}
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| fileName | java.lang.String | مسار المستند. |
...
يزيل جميع التوقيعات الرقمية من الملف المصدر ويكتب ملفًا غير موقع إلى ملف الوجهة.

الصيغ التالية متوافقة لإزالة التوقيع الرقمي: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
يوقع المستند المصدر باستخدام [CertificateHolder](../../com.aspose.words/certificateholder/) المعطى مع توقيع رقمي ويكتب المستند الموقع إلى ملف الوجهة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| srcFileName | java.lang.String | اسم ملف المستند الذي سيتم توقيعه. |
| dstFileName | java.lang.String | اسم ملف مخرجات المستند الموقع. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | كائن [CertificateHolder](../../com.aspose.words/certificateholder/) مع الشهادة المستخدمة لتوقيع الملف. |
...
يوقع المستند المصدر باستخدام [CertificateHolder](../../com.aspose.words/certificateholder/) و[SignOptions](../../com.aspose.words/signoptions/) المعطى مع توقيع رقمي ويكتب المستند الموقع إلى ملف الوجهة.
...
| dstFileName | java.lang.String | اسم ملف مخرجات المستند الموقع. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | كائن [CertificateHolder](../../com.aspose.words/certificateholder/) مع الشهادة المستخدمة لتوقيع الملف. |
| signOptions | [SignOptions](../../com.aspose.words/signoptions/) | كائن [SignOptions](../../com.aspose.words/signoptions/) مع خيارات توقيع مختلفة. |
