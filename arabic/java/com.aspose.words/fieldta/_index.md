...
description: "ينفّذ الحقل TA في Java."
type: docs
weight: 292
url: /ar/java/com.aspose.words/fieldta/
---
...
يحدد النص ورقم الصفحة لإدخال جدول السلطات، والذي يُستخدم بواسطة حقل TOA.
...
| [getEntryCategory()](#getEntryCategory) | يحصل على فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات. |
...
| [getLongCitation()](#getLongCitation) | يحصل على الاقتباس الطويل للإدخال. |
| [getPageRangeBookmarkName()](#getPageRangeBookmarkName) | يحصل على اسم الإشارة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة الإدخال. |
...
| [getShortCitation()](#getShortCitation) | يحصل على الاقتباس القصير للإدخال. |
| [getStart()](#getStart) | يحصل على العقدة التي تمثل بداية الحقل. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | يحصل على نوع حقل Microsoft Word. |
| [isBold()](#isBold) | يحصل على ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال. |
| [isBold(boolean value)](#isBold-boolean) | يضبط ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال. |
...
| [isItalic()](#isItalic) | يحصل على ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال. |
| [isItalic(boolean value)](#isItalic-boolean) | يضبط ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | يضبط فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String) | يضبط الاقتباس الطويل للإدخال. |
| [setPageRangeBookmarkName(String value)](#setPageRangeBookmarkName-java.lang.String) | يضبط اسم الإشارة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة الإدخال. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setShortCitation(String value)](#setShortCitation-java.lang.String) | يضبط الاقتباس القصير للإدخال. |
...
يحصل على فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات.
...
**Returns:**
java.lang.String - فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات.
...
يحصل على الاقتباس الطويل للإدخال.
...
**Returns:**
java.lang.String - الاقتباس الطويل للإدخال.
...
يحصل على اسم الإشارة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة الإدخال.
...
**Returns:**
java.lang.String - اسم العلامة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة للمدخل.
### getResult() {#getResult}
```
...
يحصل على الاقتباس القصير للإدخال.
...
**Returns:**
java.lang.String - الاقتباس القصير للإدخال.
### getStart() {#getStart}
```
...
يحصل على ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال.
...
**Returns:**
boolean - ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال.
...
يضبط ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تطبيق تنسيق غامق على رقم الصفحة للإدخال. |
...
يحصل على ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال.
...
**Returns:**
boolean - ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال.
...
يضبط ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تطبيق تنسيق مائل على رقم الصفحة للإدخال. |
...
يضبط فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | فئة الإدخال المتكاملة، وهي رقم يتطابق مع ترتيب الفئات. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الاقتباس الطويل للإدخال. |
...
يضبط اسم الإشارة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة الإدخال.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم العلامة المرجعية التي تحدد نطاقًا من الصفحات يتم إدراجه كرقم صفحة للمدخل. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الاقتباس القصير للإدخال. |
