...
description: "تنفيذ حقل PRINT في Java."
type: docs
weight: 273
url: /ar/java/com.aspose.words/fieldprint/
---
...
تعليمات لإرسال أحرف رموز التحكم الخاصة بالطابعة إلى الطابعة المحددة عند طباعة المستند.
...
| [getPostScriptGroup()](#getPostScriptGroup) | يحصل على مستطيل الرسم الذي تعمل عليه تعليمات PostScript. |
| [getPrinterInstructions()](#getPrinterInstructions) | يحصل على أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | يضبط مستطيل الرسم الذي تعمل عليه تعليمات PostScript. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | يضبط أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript. |
...
يحصل على مستطيل الرسم الذي تعمل عليه تعليمات PostScript.
...
**Returns:**
java.lang.String - مستطيل الرسم الذي تعمل عليه تعليمات PostScript.
...
يحصل على أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript.
...
**Returns:**
java.lang.String - أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript.
### getResult() {#getResult}
```
...
يضبط مستطيل الرسم الذي تعمل عليه تعليمات PostScript.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | مستطيل الرسم الذي تعمل عليه تعليمات PostScript. |
...
يضبط أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript. |
