...
description: "ينفّذ حقل ASK في Java."
type: docs
weight: 199
url: /ar/java/com.aspose.words/fieldask/
---
...
يطلب من المستخدم إدخال معلومات ويُعيّن إشارة مرجعية لتمثيل استجابة المستخدم.
...
| [getDefaultResponse()](#getDefaultResponse) | يحصل على استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | يحصل على ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد. |
| [getPromptText()](#getPromptText) | يحصل على نص المطالبة (عنوان نافذة المطالبة). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | يضبط استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة). |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | يضبط ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | يضبط نص المطالبة (عنوان نافذة المطالبة). |
...
يحصل على استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة).
...
**Returns:**
java.lang.String - استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة).
...
يحصل على ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد.
...
**Returns:**
boolean - ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد.
...
يحصل على نص المطالبة (عنوان نافذة المطالبة).
...
**Returns:**
java.lang.String - نص المطالبة (عنوان نافذة المطالبة).
### getResult() {#getResult}
```
...
يضبط استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة). |
...
يضبط ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد. |
...
يضبط نص المطالبة (عنوان نافذة المطالبة).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص المطالبة (عنوان نافذة المطالبة). |
