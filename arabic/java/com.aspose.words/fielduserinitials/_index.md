...
description: "ينفذ حقل USERINITIALS في Java."
type: docs
weight: 304
url: /ar/java/com.aspose.words/fielduserinitials/
---
...
يعرض كيفية استخدام حقل USERINITIALS.
...
| [getUserInitials()](#getUserInitials) | يحصل على الأحرف الأولى للمستخدم الحالي. |
...
| [setUserInitials(String value)](#setUserInitials-java.lang.String) | يضبط الأحرف الأولى للمستخدم الحالي. |
...
يحصل على الأحرف الأولى للمستخدم الحالي.
...
**Returns:**
java.lang.String - الأحرف الأولى للمستخدم الحالي.
### isDirty() {#isDirty}
```
...
يضبط الأحرف الأولى للمستخدم الحالي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الأحرف الأولى للمستخدم الحالي. |
