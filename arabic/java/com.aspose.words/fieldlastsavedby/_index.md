...
description: "تنفذ الحقل LASTSAVEDBY في Java."
type: docs
weight: 253
url: /ar/java/com.aspose.words/fieldlastsavedby/
---
...
ينفّذ حقل LASTSAVEDBY.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

تسترجع اسم المستخدم الذي عدّل وحفظ المستند الحالي آخر مرة، كما هو مسجل في خاصية **LastModifiedBy** من خصائص المستند المدمجة.
