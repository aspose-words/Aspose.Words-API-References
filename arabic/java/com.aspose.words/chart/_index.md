...
description: "يوفر الوصول إلى خصائص شكل المخطط في Java."
type: docs
weight: 66
url: /ar/java/com.aspose.words/chart/
---
...
| طريقة | الوصف |
| --- | --- |
| [getAxes()](#getAxes) | يحصل على مجموعة من جميع محاور هذا المخطط. |
| [getAxisX()](#getAxisX) | يوفر الوصول إلى خصائص المحور X الأساسي للمخطط. |
| [getAxisY()](#getAxisY) | يوفر إمكانية الوصول إلى خصائص المحور Y الأساسي للمخطط. |
| [getAxisZ()](#getAxisZ) | يوفر إمكانية الوصول إلى خصائص المحور Z للمخطط. |
| [getDataTable()](#getDataTable) | يوفر إمكانية الوصول إلى خصائص جدول البيانات لهذا المخطط. |
| [getFormat()](#getFormat) | يوفر إمكانية الوصول إلى تنسيق التعبئة والخط للمخطط. |
| [getLegend()](#getLegend) | يوفر إمكانية الوصول إلى خصائص وسيلة إيضاح المخطط. |
| [getSeries()](#getSeries) | يوفر إمكانية الوصول إلى مجموعة السلاسل. |
| [getSeriesGroups()](#getSeriesGroups) | يوفر إمكانية الوصول إلى مجموعة مجموعات السلاسل لهذا المخطط. |
| [getShapeType()](#getShapeType) |  |
| [getSourceFullName()](#getSourceFullName) | يحصل على مسار واسم ملف xls/xlsx المرتبط بهذا المخطط. |
| [getStyle()](#getStyle) | يحصل على نمط المخطط. |
| [getTitle()](#getTitle) | يوفر الوصول إلى خصائص عنوان المخطط. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يحصل على مسار واسم ملف xls/xlsx المرتبط بهذا المخطط. |
| [setStyle(int value)](#setStyle-int) | يضبط نمط المخطط. |
### getAxes() {#getAxes}
```
...
يحصل على مجموعة من جميع محاور هذا المخطط.
...
يوفر إمكانية الوصول إلى خصائص المحور Y الأساسي للمخطط.
...
يوفر إمكانية الوصول إلى خصائص المحور Z للمخطط.
...
يوفر إمكانية الوصول إلى خصائص جدول البيانات لهذا المخطط. يمكن إظهار جدول البيانات باستخدام الخاصية [ChartDataTable.getShow()](../../com.aspose.words/chartdatatable/\#getShow) / [ChartDataTable.setShow(boolean)](../../com.aspose.words/chartdatatable/\#setShow-boolean).
...
يوفر إمكانية الوصول إلى تنسيق التعبئة والخط للمخطط.
...
يوفر إمكانية الوصول إلى خصائص وسيلة إيضاح المخطط.
...
يوفر إمكانية الوصول إلى مجموعة السلاسل.
...
يوفر إمكانية الوصول إلى مجموعة مجموعات السلاسل لهذا المخطط.
...
يوضح كيفية الحصول على/تعيين الاسم الكامل للمستند الخارجي xls/xlsx إذا كان المخطط مرتبطًا.
...
**Returns:**
java.lang.String - المسار واسم ملف xls/xlsx الذي يرتبط به هذا المخطط.
### getStyle() {#getStyle}
```
public int getStyle()
```
...
**Returns:**
int - نمط المخطط. القيمة المرجعة هي واحدة من ثوابت [ChartStyle](../../com.aspose.words/chartstyle/).
### getTitle() {#getTitle}
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | المسار واسم ملف xls/xlsx الذي يرتبط به هذا المخطط. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | نمط المخطط. يجب أن تكون القيمة واحدة من ثوابت [ChartStyle](../../com.aspose.words/chartstyle/). |
