...
description: "قاعدة استبدال معلومات الخط في Java."
type: docs
weight: 328
url: /ar/java/com.aspose.words/fontinfosubstitutionrule/
---
...
وفقًا لهذه القاعدة، تقوم Aspose.Words بتقييم جميع الحقول المتعلقة في [FontInfo](../../com.aspose.words/fontinfo/) (Panose، Sig وغيرها) للخط المفقود وتبحث عن أقرب تطابق بين مصادر الخطوط المتاحة. إذا لم يكن [FontInfo](../../com.aspose.words/fontinfo/) متاحًا للخط المفقود فلن يتم اتخاذ أي إجراء.
