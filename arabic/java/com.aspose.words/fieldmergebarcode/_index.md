...
description: "ينفّذ حقل MERGEBARCODE في Java."
type: docs
weight: 257
url: /ar/java/com.aspose.words/fieldmergebarcode/
---
...
يوضح كيفية إجراء دمج بريد على باركودات QR.
...
يوضح كيفية إجراء دمج بريد على باركودات EAN13.
...
يوضح كيفية إجراء دمج بريد على باركودات CODE39.
...
يوضح كيفية إجراء دمج بريد على باركودات ITF14.
...
| [getAddStartStopChar()](#getAddStartStopChar) | يحدد ما إذا كان يجب إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39. |
| [getBackgroundColor()](#getBackgroundColor) | يحصل على لون الخلفية لرمز الباركود. |
| [getBarcodeType()](#getBarcodeType) | يحصل على نوع الباركود (QR، إلخ). |
| [getBarcodeValue()](#getBarcodeValue) | يحصل على قيمة الباركود. |
| [getCaseCodeStyle()](#getCaseCodeStyle) | يحصل على نمط Case Code لنوع الباركود ITF14. |
| [getDisplayResult()](#getDisplayResult) | يحصل على النص الذي يمثل نتيجة الحقل المعروضة. |
| [getDisplayText()](#getDisplayText) | يحدد ما إذا كان يجب عرض بيانات الباركود (النص) مع الصورة. |
| [getEnd()](#getEnd) | يحصل على العقدة التي تمثل نهاية الحقل. |
| [getErrorCorrectionLevel()](#getErrorCorrectionLevel) | يحصل على مستوى تصحيح الأخطاء لرمز QR. |
...
| [getFixCheckDigit()](#getFixCheckDigit) | يحدد ما إذا كان يجب تصحيح رقم الفحص إذا كان غير صالح. |
| [getForegroundColor()](#getForegroundColor) | يحصل على لون المقدمة لرمز الباركود. |
...
| [getScalingFactor()](#getScalingFactor) | يحصل على معامل التحجيم للرمز. |
...
| [getSymbolHeight()](#getSymbolHeight) | يحصل على ارتفاع الرمز. |
| [getSymbolRotation()](#getSymbolRotation) | يحصل على دوران رمز الباركود. |
...
| [setAddStartStopChar(boolean value)](#setAddStartStopChar-boolean) | يضبط ما إذا كان يجب إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39. |
| [setBackgroundColor(String value)](#setBackgroundColor-java.lang.String) | يضبط لون الخلفية لرمز الباركود. |
| [setBarcodeType(String value)](#setBarcodeType-java.lang.String) | يضبط نوع الباركود (QR، إلخ.) |
| [setBarcodeValue(String value)](#setBarcodeValue-java.lang.String) | يضبط قيمة الباركود. |
| [setCaseCodeStyle(String value)](#setCaseCodeStyle-java.lang.String) | يضبط نمط رمز الحالة لنوع الباركود ITF14. |
| [setDisplayText(boolean value)](#setDisplayText-boolean) | يضبط ما إذا كان سيتم عرض بيانات الباركود (النص) مع الصورة. |
| [setErrorCorrectionLevel(String value)](#setErrorCorrectionLevel-java.lang.String) | يضبط مستوى تصحيح الأخطاء لرمز QR. |
| [setFixCheckDigit(boolean value)](#setFixCheckDigit-boolean) | يضبط ما إذا كان سيتم إصلاح رقم التحقق إذا كان غير صالح. |
| [setForegroundColor(String value)](#setForegroundColor-java.lang.String) | يضبط لون المقدمة لرمز الباركود. |
...
| [setScalingFactor(String value)](#setScalingFactor-java.lang.String) | يضبط عامل التحجيم للرمز. |
| [setSymbolHeight(String value)](#setSymbolHeight-java.lang.String) | يضبط ارتفاع الرمز. |
| [setSymbolRotation(String value)](#setSymbolRotation-java.lang.String) | يضبط دوران رمز الباركود. |
...
يحدد ما إذا كان يجب إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39.
...
**Returns:**
boolean - ما إذا كان سيتم إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39.
...
يحصل على لون الخلفية لرمز الباركود. القيم الصالحة في النطاق [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - لون الخلفية لرمز الباركود.
...
**Returns:**
java.lang.String - نوع الباركود (QR، إلخ.)
...
**Returns:**
java.lang.String - قيمة الباركود.
...
يحصل على نمط رمز الحالة لنوع الباركود ITF14. القيم الصالحة هي [STD|EXT|ADD]
...
**Returns:**
java.lang.String - نمط رمز الحالة لنوع الباركود ITF14.
...
يحدد ما إذا كان يجب عرض بيانات الباركود (النص) مع الصورة.
...
**Returns:**
boolean - ما إذا كان سيتم عرض بيانات الباركود (النص) مع الصورة.
### getEnd() {#getEnd}
```
...
يحصل على مستوى تصحيح الأخطاء لرمز QR. القيم الصالحة هي [0, 3].
...
**Returns:**
java.lang.String - مستوى تصحيح الأخطاء لرمز QR.
...
يحدد ما إذا كان يجب تصحيح رقم الفحص إذا كان غير صالح.
...
**Returns:**
boolean - ما إذا كان سيتم إصلاح رقم التحقق إذا كان غير صالح.
...
يحصل على لون المقدمة لرمز الباركود. القيم الصالحة في النطاق [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - لون المقدمة لرمز الباركود.
### getFormat() {#getFormat}
```
...
يحصل على نمط باركود نقطة البيع (أنواع الباركود UPCA|UPCE|EAN13|EAN8). القيم الصالحة (غير حساسة لحالة الأحرف) هي [STD|SUP2|SUP5|CASE].
...
**Returns:**
java.lang.String - نمط باركود نقطة البيع (أنواع الباركود UPCA|UPCE|EAN13|EAN8).
### getResult() {#getResult}
```
...
يحصل على عامل قياس للرمز. القيمة بوحدات النسبة المئوية الكاملة والقيم الصالحة هي [10, 1000]
...
**Returns:**
java.lang.String - عامل قياس للرمز.
...
يحصل على ارتفاع الرمز. الوحدات هي TWIPS (1/1440 بوصة).
...
يحصل على دوران رمز الباركود. القيم الصالحة هي [0, 3]
...
**Returns:**
java.lang.String - دوران رمز الباركود.
### getType() {#getType}
```
public int getType()
```
...
يضبط ما إذا كان يجب إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب إضافة أحرف البداية/النهاية لأنواع الباركود NW7 و CODE39. |
...
يضبط لون الخلفية لرمز الباركود. القيم الصالحة في النطاق [0, 0xFFFFFF]
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | لون الخلفية لرمز الباركود. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نوع الباركود (QR، إلخ). |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | قيمة الباركود. |
...
يضبط نمط رمز الحالة لنوع الباركود ITF14. القيم الصالحة هي [STD|EXT|ADD]
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نمط رمز الحالة لنوع الباركود ITF14. |
...
يضبط ما إذا كان سيتم عرض بيانات الباركود (النص) مع الصورة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب عرض بيانات الباركود (نص) مع الصورة. |
...
يضبط مستوى تصحيح الأخطاء لرمز QR. القيم الصالحة هي [0, 3].
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | مستوى تصحيح الأخطاء لرمز QR. |
...
يضبط ما إذا كان سيتم إصلاح رقم التحقق إذا كان غير صالح.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تصحيح رقم التحقق إذا كان غير صالح. |
...
يضبط لون المقدمة لرمز الباركود. القيم الصالحة في النطاق [0, 0xFFFFFF]
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | لون المقدمة لرمز الباركود. |
...
يضبط نمط باركود نقطة البيع (أنواع الباركود UPCA|UPCE|EAN13|EAN8). القيم الصالحة (غير حساسة لحالة الأحرف) هي [STD|SUP2|SUP5|CASE].
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نمط باركود نقطة البيع (أنواع الباركود UPCA | UPCE | EAN13 | EAN8). |
...
يضبط عامل قياس للرمز. القيمة بوحدات النسبة المئوية الكاملة والقيم الصالحة هي [10, 1000]
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عامل قياس للرمز. |
...
يضبط ارتفاع الرمز. الوحدات هي TWIPS (1/1440 بوصة).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | ارتفاع الرمز. |
...
يضبط دوران رمز الباركود. القيم الصالحة هي [0, 3].
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | دوران رمز الباركود. |
