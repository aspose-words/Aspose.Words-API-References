...
description: "يمثل مجموعة من كائنات CustomPart في جافا."
type: docs
weight: 142
url: /ar/java/com.aspose.words/custompartcollection/
---
...
يمثل مجموعة من كائنات [CustomPart](../../com.aspose.words/custompart/) .
...
عادةً لا تحتاج إلى إنشاء مثيلات من هذه الفئة. يمكنك الوصول إلى الأجزاء المخصصة المتعلقة بحزمة OOXML عبر خاصية [Document.getPackageCustomParts()](../../com.aspose.words/document/\#getPackageCustomParts) / [Document.setPackageCustomParts(com.aspose.words.CustomPartCollection)](../../com.aspose.words/document/\#setPackageCustomParts-com.aspose.words.CustomPartCollection).
...
| طريقة | الوصف |
| --- | --- |
| [add(CustomPart part)](#add-com.aspose.words.CustomPart) | يضيف عنصرًا إلى المجموعة. |
...
| [set(int index, CustomPart value)](#set-int-com.aspose.words.CustomPart) | يضبط عنصرًا في الفهرس المحدد. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| part | [CustomPart](../../com.aspose.words/custompart/) | العنصر المراد إضافته. |
...
| --- | --- | --- |
| الفهرس | int | فهرس العنصر يبدأ من الصفر. |
| value | [CustomPart](../../com.aspose.words/custompart/) | عنصر في الفهرس المحدد. |
