...
description: "قاعدة استبدال الخط الافتراضي في Java."
type: docs
weight: 149
url: /ar/java/com.aspose.words/defaultfontsubstitutionrule/
---
...
تحدد هذه القاعدة اسم الخط الافتراضي الوحيد الذي سيُستخدم للاستبدال إذا لم يكن الخط الأصلي متاحًا.
...
| [setDefaultFontName(String value)](#setDefaultFontName-java.lang.String) | يضبط اسم الخط الافتراضي. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم الخط الافتراضي. |
