...
description: "يحدد نوع الفاصل داخل المستند في Java."
type: docs
weight: 49
url: /ar/java/com.aspose.words/breaktype/
---
...
| حقل | الوصف |
| --- | --- |
| [COLUMN_BREAK](#COLUMN-BREAK) | فاصل عمود صريح. |
| [LINE_BREAK](#LINE-BREAK) | فاصل سطر صريح. |
| [PAGE_BREAK](#PAGE-BREAK) | فاصل صفحة صريح. |
| [PARAGRAPH_BREAK](#PARAGRAPH-BREAK) | فاصل بين الفقرات. |
| [SECTION_BREAK_CONTINUOUS](#SECTION-BREAK-CONTINUOUS) | يحدد بدء قسم جديد على نفس الصفحة كما في القسم السابق. |
| [SECTION_BREAK_EVEN_PAGE](#SECTION-BREAK-EVEN-PAGE) | يحدد بدء قسم جديد على صفحة زوجية جديدة. |
| [SECTION_BREAK_NEW_COLUMN](#SECTION-BREAK-NEW-COLUMN) | يحدد بدء قسم جديد في العمود الجديد. |
| [SECTION_BREAK_NEW_PAGE](#SECTION-BREAK-NEW-PAGE) | يحدد بدء قسم جديد على صفحة جديدة. |
| [SECTION_BREAK_ODD_PAGE](#SECTION-BREAK-ODD-PAGE) | يحدد بدء قسم جديد على صفحة فردية. |
| [length](#length) |  |
## الطرق
...
يحدد بدء قسم جديد على نفس الصفحة كما في القسم السابق.
...
يحدد بدء قسم جديد على صفحة زوجية جديدة.
...
يحدد بدء قسم جديد في العمود الجديد.
...
يحدد بدء قسم جديد على صفحة جديدة.
...
يحدد بدء قسم جديد على صفحة فردية.
