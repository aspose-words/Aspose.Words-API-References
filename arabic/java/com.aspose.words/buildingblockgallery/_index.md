...
description: "يحدد المعرض المحدد مسبقًا الذي يُصنّف فيه كتلة بناء في Java."
type: docs
weight: 55
url: /ar/java/com.aspose.words/buildingblockgallery/
---
...
يحدد المعرض المحدد مسبقًا الذي تُصنّف فيه كتلة البناء.

 **Remarks:** 

يتطابق مع النوع **ST\_DocPartGallery** في OOXML.
...
| حقل | الوصف |
| --- | --- |
| [ALL](#ALL) | يحدد أن هذا الإدخال في وثيقة القاموس يجب أن يكون مرتبطًا بجميع قيم تصنيف المعرض الممكنة. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | نفس [ALL](../../com.aspose.words/buildingblockgallery/\#ALL). |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
يحدد أن هذا الإدخال في وثيقة القاموس يجب أن يكون مرتبطًا بجميع قيم تصنيف المعرض الممكنة.
...
نفس [ALL](../../com.aspose.words/buildingblockgallery/\#ALL).
