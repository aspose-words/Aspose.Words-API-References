...
description: "يطبق الحقل NUMWORDS في جافا."
type: docs
weight: 268
url: /ar/java/com.aspose.words/fieldnumwords/
---
...
يسترجع عدد الكلمات في المستند الحالي، كما هو مسجل في الخاصية **Words** لخصائص المستند المدمجة.
