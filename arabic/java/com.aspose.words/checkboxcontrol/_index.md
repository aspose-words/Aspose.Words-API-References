...
description: "يتحكم عنصر CheckBox في تبديل قيمة في Java."
type: docs
weight: 100
url: /ar/java/com.aspose.words/checkboxcontrol/
---
...
يتحكم عنصر CheckBox في تبديل قيمة.

 **Remarks:** 

له ثلاث حالات محتملة: محدد، مُمسوح، ولا محدد ولا مُمسوح، مما يعني مزيجًا من حالات التشغيل والإيقاف.
...
| [getChecked()](#getChecked) | يحصل على قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا. |
...
| [setChecked(boolean value)](#setChecked-boolean) | يضبط قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا. |
...
يحصل على قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا. القيمة الافتراضية هي  false .
...
**Returns:**
boolean - قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا.
...
يضبط قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا. القيمة الافتراضية هي  false .
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | boolean | قيمة منطقية تشير إلى ما إذا كان هذا [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) محددًا أم لا. |
