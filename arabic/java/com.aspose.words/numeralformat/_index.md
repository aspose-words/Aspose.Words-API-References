...
description: "يشير إلى مجموعة الرموز المستخدمة لتمثيل الأرقام أثناء التحويل إلى صيغ صفحات ثابتة في Java."
type: docs
weight: 486
url: /ar/java/com.aspose.words/numeralformat/
---
...
يشير إلى مجموعة الرموز المستخدمة لتمثيل الأرقام أثناء التصيير إلى تنسيقات صفحات ثابتة.

 **Examples:** 

يوضح كيفية تعيين تنسيق الأرقام المستخدم عند الحفظ إلى PDF.
...
| حقل | الوصف |
| --- | --- |
| [ARABIC_INDIC](#ARABIC-INDIC) | الأرقام المستخدمة في العربية: \u0660\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669. |
| [CONTEXT](#CONTEXT) | تُحدد مجموعة الرموز بناءً على السياق (الإعدادات الإقليمية وخصائص RTL). |
| [EASTERN_ARABIC_INDIC](#EASTERN-ARABIC-INDIC) | الأرقام المستخدمة في الفارسية والأردية: \u06f0\u06f1\u06f2\u06f3\u06f4\u06f5\u06f6\u06f7\u06f8\u06f9. |
| [EUROPEAN](#EUROPEAN) | الأرقام الأوروبية: 0123456789. |
| [SYSTEM](#SYSTEM) | هذا الخيار غير مدعوم. |
| [length](#length) |  |
## الطرق
...
الأرقام المستخدمة في العربية: \u0660\u0661\u0662\u0663\u0664\u0665\u0666\u0667\u0668\u0669. نطاق Unicode U+0660 - u+0669.
...
تُحدد مجموعة الرموز بناءً على السياق (الإعدادات الإقليمية وخصائص RTL).
...
الأرقام المستخدمة في الفارسية والأردية: \u06f0\u06f1\u06f2\u06f3\u06f4\u06f5\u06f6\u06f7\u06f8\u06f9. نطاق Unicode U+06F0 - u+06F9.
...
هذا الخيار غير مدعوم. تُحدد مجموعة الرموز بناءً على الإعدادات الإقليمية.
