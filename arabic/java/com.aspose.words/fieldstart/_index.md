...
description: "يمثل بداية حقل Word في مستند بلغة Java."
type: docs
weight: 288
url: /ar/java/com.aspose.words/fieldstart/
---
...
| [getFieldData()](#getFieldData) | يحصل على بيانات الحقل المخصصة المرتبطة بالحقل. |
...
| [getNodeType()](#getNodeType) | يعيد [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). |
...
ينادي [DocumentVisitor.visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
**Returns:**
byte[] - بيانات الحقل المخصصة المرتبطة بالحقل.
...
يعيد [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START).
...
**Returns:**
int - [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). القيمة المعادة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
