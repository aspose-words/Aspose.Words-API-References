...
description: "ينفّذ حقل ADDRESSBLOCK في Java."
type: docs
weight: 196
url: /ar/java/com.aspose.words/fieldaddressblock/
---
...
ينفّذ حقل ADDRESSBLOCK.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يمثّل كتلة عنوان. *كتلة عنوان* هي مجموعة من النصوص تحدد المعلومات المناسبة لعنوان بريدٍ بريدي، بالترتيب المطلوب حسب بلد الوجهة.

 **Examples:** 

يوضح كيفية الحصول على أسماء حقول دمج البريد المستخدمة في الحقل.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | يحصل على اسم الدولة/المنطقة المستبعدة. |
...
| [getFieldNames()](#getFieldNames) | يعيد مجموعة من أسماء حقول دمج البريد المستخدمة في الحقل. |
| [getFormat()](#getFormat) | يحصل على كائن [FieldFormat](../../com.aspose.words/fieldformat/) الذي يوفر وصولًا مكتوبًا إلى تنسيق الحقل. |
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | يحصل على ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | يحصل على ما إذا كان يجب تضمين اسم الدولة/المنطقة. |
| [getLanguageId()](#getLanguageId) | يحصل على معرف اللغة المستخدم لتنسيق العنوان. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | يحصل على تنسيق الاسم والعنوان. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | يضبط اسم الدولة/المنطقة المستبعدة. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | يضبط ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006). |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | يضبط ما إذا كان يجب تضمين اسم الدولة/المنطقة. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | يضبط معرف اللغة المستخدم لتنسيق العنوان. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | يضبط تنسيق الاسم والعنوان. |
...
يحصل على اسم الدولة/المنطقة المستبعدة.
...
**Returns:**
java.lang.String - اسم الدولة/المنطقة المستبعدة.
...
يعيد مجموعة من أسماء حقول دمج البريد المستخدمة في الحقل.
...
يحصل على ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006).
...
**Returns:**
boolean - ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006).
...
يحصل على ما إذا كان يجب تضمين اسم الدولة/المنطقة.
...
**Returns:**
java.lang.String - ما إذا كان يجب تضمين اسم الدولة/المنطقة.
...
يحصل على معرف اللغة المستخدم لتنسيق العنوان.
...
**Returns:**
java.lang.String - معرف اللغة المستخدم لتنسيق العنوان.
...
**Returns:**
java.lang.String - تنسيق الاسم والعنوان.
### getResult() {#getResult}
```
...
يضبط اسم الدولة/المنطقة المستبعدة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم الدولة/المنطقة المستبعدة. |
...
يضبط ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف في POST\*CODE (الاتحاد البريدي العالمي 2006). |
...
يضبط ما إذا كان يجب تضمين اسم الدولة/المنطقة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | ما إذا كان يجب تضمين اسم الدولة/المنطقة. |
...
يضبط معرف اللغة المستخدم لتنسيق العنوان.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرف اللغة المستخدم لتنسيق العنوان. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | تنسيق الاسم والعنوان. |
