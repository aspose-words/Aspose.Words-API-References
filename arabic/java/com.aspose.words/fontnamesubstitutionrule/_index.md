...
description: "قاعدة استبدال الخط لمعالجة اسم الخط في Java."
type: docs
weight: 329
url: /ar/java/com.aspose.words/fontnamesubstitutionrule/
---
...
وفقًا لهذه القاعدة، تحاول Aspose.Words معالجة اسم الخط للحصول على الاستبدال. على وجه الخصوص، تحاول Aspose.Words إزالة اللاحقات التي تفصلها '-', ',' و '(' كما يفعل MS Word.
