...
description: "محاذاة WordArt في Java."
type: docs
weight: 677
url: /ar/java/com.aspose.words/textpathalignment/
---
...
| حقل | الوصف |
| --- | --- |
| [CENTER](#CENTER) | مركز النص على العرض. |
| [LEFT](#LEFT) | محاذاة إلى اليسار. |
| [LETTER_JUSTIFY](#LETTER-JUSTIFY) | توزيع الأحرف لتناسب العرض. |
| [RIGHT](#RIGHT) | محاذاة إلى اليمين. |
| [STRETCH](#STRETCH) | تمديد كل سطر من النص لتناسب العرض. |
| [WORD_JUSTIFY](#WORD-JUSTIFY) | توزيع الكلمات لتناسب العرض. |
| [length](#length) |  |
## الطرق
...
تمديد كل سطر من النص لتناسب العرض.
