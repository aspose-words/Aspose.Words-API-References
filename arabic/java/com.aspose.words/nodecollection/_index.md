...
description: "يمثل مجموعة من العقد من نوع محدد في Java."
type: docs
weight: 479
url: /ar/java/com.aspose.words/nodecollection/
---
...
يمثل مجموعة من العقد من نوع محدد.
...
مجموعة [NodeCollection](../../com.aspose.words/nodecollection/) هي "مباشرة"، أي أن التغييرات على عناصر العقدة التي تم إنشاء المجموعة منها تنعكس فورًا في العقد التي تُرجعها خصائص وطرق [NodeCollection](../../com.aspose.words/nodecollection/).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الفهرس | int | فهرس داخل مجموعة العقد. |
