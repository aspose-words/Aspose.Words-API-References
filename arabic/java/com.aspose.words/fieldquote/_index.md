...
description: "ينفذ الحقل QUOTE في Java."
type: docs
weight: 276
url: /ar/java/com.aspose.words/fieldquote/
---
...
| [getText()](#getText) | يحصل على النص لاسترجاعه. |
...
| [setText(String value)](#setText-java.lang.String) | يضبط النص المراد استرجاعه. |
...
**Returns:**
java.lang.String - النص المراد استرجاعه.
### getType() {#getType}
```
public int getType()
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص المراد استرجاعه. |
