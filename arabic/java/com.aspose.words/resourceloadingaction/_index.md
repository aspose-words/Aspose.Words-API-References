...
description: "يحدد وضع تحميل الموارد في Java."
type: docs
weight: 575
url: /ar/java/com.aspose.words/resourceloadingaction/
---
...
| حقل | الوصف |
| --- | --- |
| [DEFAULT](#DEFAULT) | ستقوم Aspose.Words بتحميل هذا المورد كالمعتاد. |
| [SKIP](#SKIP) | ستتخطى Aspose.Words تحميل هذا المورد. |
| [USER_PROVIDED](#USER-PROVIDED) | ستستخدم Aspose.Words مصفوفة البايتات التي يقدمها المستخدم في [ResourceLoadingArgs.setData(byte[])](../../com.aspose.words/resourceloadingargs/\#setData-byte) كبيانات المورد. |
| [length](#length) |  |
## الطرق
...
ستقوم Aspose.Words بتحميل هذا المورد كالمعتاد.
...
ستتخطى Aspose.Words تحميل هذا المورد. سيتم حفظ الرابط فقط بدون بيانات لصورة، وسيتم تجاهل ورقة الأنماط CSS لتنسيق HTML.
...
ستستخدم Aspose.Words مصفوفة البايتات التي يقدمها المستخدم في [ResourceLoadingArgs.setData(byte[])](../../com.aspose.words/resourceloadingargs/\#setData-byte) كبيانات المورد.
