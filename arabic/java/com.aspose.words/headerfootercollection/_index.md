...
description: "يوفر وصولًا مكتوبًا إلى عقد HeaderFooter في Section في جافا."
type: docs
weight: 371
url: /ar/java/com.aspose.words/headerfootercollection/
---
...
يوفر وصولًا مكتوبًا إلى عقد [HeaderFooter](../../com.aspose.words/headerfooter/) في [Section](../../com.aspose.words/section/).

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Headers and Footers ][Working with Headers and Footers].

 **Remarks:** 

يمكن أن يكون هناك بحد أقصى واحد من [HeaderFooter](../../com.aspose.words/headerfooter/).

لكل [HeaderFooterType](../../com.aspose.words/headerfootertype/) في كل [Section](../../com.aspose.words/section/).

[HeaderFooter](../../com.aspose.words/headerfooter/) objects can occur in any order in the collection.

 **Examples:** 

يعرض كيفية إنشاء رأس وتذييل.
...
يعرض كيفية حذف جميع التذييلات من المستند.
...
| [get(int index)](#get-int) | يسترجع [HeaderFooter](../../com.aspose.words/headerfooter/) في الفهرس المحدد. |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean) | يربط أو يفك ربط جميع رؤوس وتذييلات الصفحات بالرؤوس والتذييلات المقابلة في القسم السابق. |
...
| [toArray()](#toArray) | ينسخ جميع كائنات  HeaderFooter  من المجموعة إلى مصفوفة جديدة من  HeaderFooter . |
...
يسترجع [HeaderFooter](../../com.aspose.words/headerfooter/) في الفهرس المحدد.
...
يعرض كيفية ربط الرؤوس والتذييلات بين الأقسام.
...
يربط أو يفك ربط جميع رؤوس وتذييلات الصفحات بالرؤوس والتذييلات المقابلة في القسم السابق.

 **Remarks:** 

إذا لم يكن أي من الرؤوس أو التذييلات موجودًا، يتم إنشاؤه تلقائيًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| isLinkToPrevious | boolean | true لربط الرؤوس والتذييلات بالقسم السابق؛ false لفك ربطها. |
...
ينسخ جميع كائنات  HeaderFooter  من المجموعة إلى مصفوفة جديدة من  HeaderFooter .
...
**Returns:**
com.aspose.words.HeaderFooter[] - مصفوفة من  HeaderFooter .
