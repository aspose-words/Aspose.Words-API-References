...
description: "يعرض عنصر التحكم TextBox النص من مجموعة منظمة من البيانات أو مدخلات المستخدم في Java."
type: docs
weight: 668
url: /ar/java/com.aspose.words/textboxcontrol/
---
...
يعرض عنصر التحكم TextBox النص من مجموعة منظمة من البيانات أو إدخال المستخدم.
...
| [setText(String value)](#setText-java.lang.String) | يضبط نص العنصر. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص العنصر. |
