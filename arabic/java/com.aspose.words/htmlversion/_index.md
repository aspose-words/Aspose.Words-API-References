...
description: "يشير إلى أن نسخة HTML تُستخدم عند حفظ المستند إلى صيغ SaveFormat.HTML و SaveFormat.MHTML في Java."
type: docs
weight: 386
url: /ar/java/com.aspose.words/htmlversion/
---
...
يشير إلى أن نسخة HTML تُستخدم عند حفظ المستند إلى صيغ [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) و [SaveFormat.MHTML](../../com.aspose.words/saveformat/\#MHTML).

 **Examples:** 

يظهر كيفية حفظ مستند إلى نسخة محددة من HTML.
...
// سيحتوي مستندنا على عنوان إعلان DOCTYPE فقط إذا قمنا بتعيين العلامة "ExportXhtmlTransitional" إلى "true".
