...
description: "نفّذ هذه الواجهة إذا رغبت في وجود طريقة مخصصة خاصة بك تُستدعى أثناء عملية البحث والاستبدال في Java."
type: docs
weight: 781
url: /ar/java/com.aspose.words/ireplacingcallback/
---
```
public interface IReplacingCallback
```

قم بتنفيذ هذه الواجهة إذا كنت تريد استدعاء طريقتك المخصصة الخاصة أثناء عملية البحث والاستبدال.
...
| طريقة | الوصف |
| --- | --- |
| [replacing(ReplacingArgs args)](#replacing-com.aspose.words.ReplacingArgs) | طريقة يحددها المستخدم تُستدعى أثناء عملية الاستبدال لكل تطابق يتم العثور عليه مباشرةً قبل إجراء الاستبدال. |
...
طريقة يحددها المستخدم تُستدعى أثناء عملية الاستبدال لكل تطابق يتم العثور عليه مباشرةً قبل إجراء الاستبدال.
...
**Returns:**
int - قيمة [ReplaceAction](../../com.aspose.words/replaceaction/) التي تحدد الإجراء الذي سيُتخذ للمطابقة الحالية. القيمة المرجعة هي واحدة من ثوابت [ReplaceAction](../../com.aspose.words/replaceaction/).
