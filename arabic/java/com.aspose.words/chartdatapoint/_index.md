...
description: "يسمح بتحديد تنسيق نقطة بيانات واحدة على المخطط في جافا."
type: docs
weight: 75
url: /ar/java/com.aspose.words/chartdatapoint/
---
...
في سلسلة، كائن [ChartDataPoint](../../com.aspose.words/chartdatapoint/) هو عضو في [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/). يحتوي [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/) على كائن [ChartDataPoint](../../com.aspose.words/chartdatapoint/) لكل نقطة.
...
| طريقة | الوصف |
| --- | --- |
| [clearFormat()](#clearFormat) | يمسح تنسيق هذه النقطة. |
...
| [getFormat()](#getFormat) | يوفر الوصول إلى تنسيق التعبئة والخط لهذه النقطة. |
| [getIndex()](#getIndex) | فهرس النقطة التي يطبق عليها هذا الكائن التنسيق. |
| [getInvertIfNegative()](#getInvertIfNegative) | يحدد ما إذا كان العنصر الأب سيعكس ألوانه إذا كانت القيمة سلبية. |
| [getMarker()](#getMarker) | يحدد علامة بيانات المخطط. |
...
يمسح تنسيق هذه النقطة. يتم تعيين الخصائص إلى القيم الافتراضية المحددة في السلسلة الأصلية.
...
يوفر الوصول إلى تنسيق التعبئة والخط لهذه النقطة.
...
فهرس النقطة التي يطبق عليها هذا الكائن التنسيق.
