...
description: "ينفذ حقل MERGEFIELD في Java."
type: docs
weight: 258
url: /ar/java/com.aspose.words/fieldmergefield/
---
...
ينفّذ حقل MERGEFIELD.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يسترجع اسم حقل البيانات داخل أحرف الدمج في المستند الرئيسي للدمج البريدي. عندما يتم دمج المستند الرئيسي مع مصدر البيانات المحدد، تُدرج معلومات حقل البيانات المحدد في مكان حقل الدمج.

 **Examples:** 

يوضح كيفية استخدام حقول MERGEFIELD لإجراء دمج بريدي.
...
| [getFieldName()](#getFieldName) | يحصل على اسم حقل البيانات. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | يعيد فقط اسم حقل البيانات. |
...
| [getTextAfter()](#getTextAfter) | يحصل على النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا. |
| [getTextBefore()](#getTextBefore) | يحصل على النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا. |
...
| [isMapped()](#isMapped) | يحصل على ما إذا كان هذا الحقل حقلًا مُرَبطًا. |
| [isMapped(boolean value)](#isMapped-boolean) | يضبط ما إذا كان هذا الحقل حقلًا مُرَبطًا. |
| [isVerticalFormatting()](#isVerticalFormatting) | يحصل على ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | يضبط ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي. |
| [remove()](#remove) | يزيل الحقل من المستند. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | يضبط اسم حقل البيانات. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | يضبط النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | يضبط النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا. |
...
**Returns:**
java.lang.String - اسم حقل البيانات.
...
يعيد فقط اسم حقل البيانات. يتم إزالة أي بادئة إلى خاصية البادئة.
...
**Returns:**
java.lang.String - فقط اسم حقل البيانات.
### getFormat() {#getFormat}
```
...
يحصل على النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا.
...
**Returns:**
java.lang.String - النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا.
...
يحصل على النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا.
...
**Returns:**
java.lang.String - النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا.
### getType() {#getType}
```
public int getType()
```
...
يحصل على ما إذا كان هذا الحقل حقلًا مُرَبطًا.
...
**Returns:**
boolean - ما إذا كان هذا الحقل حقلًا مُرَبطًا.
...
يضبط ما إذا كان هذا الحقل حقلًا مُرَبطًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان هذا الحقل حقلًا مُرَبطًا. |
...
يحصل على ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي.
...
**Returns:**
boolean - ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي.
...
يضبط ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تمكين تحويل الأحرف للتنسيق العمودي. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم حقل البيانات. |
...
يضبط النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص الذي سيُدرج بعد الحقل إذا لم يكن الحقل فارغًا. |
...
يضبط النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص الذي سيُدرج قبل الحقل إذا لم يكن الحقل فارغًا. |
