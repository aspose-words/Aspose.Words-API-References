...
description: "ينفّذ الحقل PRIVATE في Java."
type: docs
weight: 275
url: /ar/java/com.aspose.words/fieldprivate/
---
...
يوفر مساحة تخزين خاصة. يُستخدم هذا الحقل لتخزين البيانات للمستندات التي تم تحويلها من صيغ ملفات أخرى.
