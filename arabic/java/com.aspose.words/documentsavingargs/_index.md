...
description: "معامل يُمرَّر إلى IDocumentSavingCallback.notifycom.aspose.words.DocumentSavingArgs في جافا."
type: docs
weight: 172
url: /ar/java/com.aspose.words/documentsavingargs/
---
...
معامل يُمرَّر إلى [IDocumentSavingCallback.notify(com.aspose.words.DocumentSavingArgs)](../../com.aspose.words/idocumentsavingcallback/\#notify-com.aspose.words.DocumentSavingArgs).

للتعرف على المزيد، زر [ Save a Document ][Save a Document] مقالة الوثائق.

 **Examples:** 

يوضح كيفية إدارة مستند أثناء حفظه إلى html.
...
يوضح كيفية إدارة مستند أثناء حفظه إلى docx.
...
يوضح كيفية إدارة مستند أثناء الحفظ إلى xamlflow.
