...
description: "يمثل قائمة من الأشخاص الذين هم مساهمو مصدر الببليوغرافيا في Java."
type: docs
weight: 546
url: /ar/java/com.aspose.words/personcollection/
---
...
يمثل قائمة بالأشخاص الذين هم مساهمون في مصدر الببليوغرافيا.
...
| المنشئ | الوصف |
| --- | --- |
| [PersonCollection()](#PersonCollection) | إنشاء مثال جديد من الفئة [PersonCollection](../../com.aspose.words/personcollection/). |
| [PersonCollection(Iterable persons)](#PersonCollection-java.lang.Iterable) | يقوم بتهيئة نسخة جديدة من هذه الفئة. |
| [PersonCollection(Person[] persons)](#PersonCollection-com.aspose.words.Person...) | إنشاء مثال جديد من الفئة [PersonCollection](../../com.aspose.words/personcollection/). |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [add(Person person)](#add-com.aspose.words.Person) | يضيف [Person](../../com.aspose.words/person/) إلى المجموعة. |
| [clear()](#clear) | يزيل جميع العناصر من المجموعة. |
| [contains(Person person)](#contains-com.aspose.words.Person) | يحدد ما إذا كانت المجموعة تحتوي على شخص محدد. |
| [get(int index)](#get-int) | يحصل على شخص في الفهرس المحدد. |
| [getCount()](#getCount) | يحصل على عدد الأشخاص الموجودين في المجموعة. |
| [iterator()](#iterator) |  |
| [remove(Person person)](#remove-com.aspose.words.Person) | يزيل الشخص من المجموعة. |
| [removeAt(int index)](#removeAt-int) | يزيل الشخص في الفهرس المحدد. |
| [set(int index, Person value)](#set-int-com.aspose.words.Person) | يضبط شخصًا في الفهرس المحدد. |
...
إنشاء مثال جديد من الفئة [PersonCollection](../../com.aspose.words/personcollection/).
...
يضيف [Person](../../com.aspose.words/person/) إلى المجموعة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | الشخص لإضافته إلى المجموعة. |
...
يحدد ما إذا كانت المجموعة تحتوي على شخص محدد.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | الشخص لتحديد موقعه في المجموعة. |
...
يحصل على عدد الأشخاص الموجودين في المجموعة.
...
**Returns:**
int - عدد الأشخاص الموجودين في المجموعة.
### iterator() {#iterator}
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | الشخص لإزالته من المجموعة. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الفهرس | int | الفهرس الصفري للشخص الذي سيتم إزالته. |
...
| --- | --- | --- |
| الفهرس | int | فهرس داخل المجموعة. |
| value | [Person](../../com.aspose.words/person/) | شخص في الفهرس المحدد. |
