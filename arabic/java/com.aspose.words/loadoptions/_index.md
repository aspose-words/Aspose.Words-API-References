...
description: "يسمح بتحديد خيارات إضافية مثل كلمة المرور أو عنوان URI الأساسي عند تحميل مستند إلى كائن Document في Java."
type: docs
weight: 435
url: /ar/java/com.aspose.words/loadoptions/
---
...
يسمح بتحديد خيارات إضافية (مثل كلمة المرور أو عنوان URI الأساسي) عند تحميل مستند إلى كائن [Document](../../com.aspose.words/document/).
...
| المنشئ | الوصف |
| --- | --- |
| [LoadOptions()](#LoadOptions) | يُهيئ نسخة جديدة من هذه الفئة بالقيم الافتراضية. |
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | اختصار لتهيئة نسخة جديدة من هذه الفئة باستخدام كلمة المرور المحددة لتحميل مستند مشفر. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | يقوم بتهيئة نسخة جديدة من هذه الفئة. |
## الطرق
