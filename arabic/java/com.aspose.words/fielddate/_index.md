...
description: "ينفّذ حقل DATE في Java."
type: docs
weight: 220
url: /ar/java/com.aspose.words/fielddate/
---
...
يدرج التاريخ والوقت الحاليين. بشكل افتراضي، يتم استخدام التقويم الغريغوري.

 **Examples:** 

يوضح كيفية استخدام حقول DATE لعرض التواريخ وفقًا لأنواع مختلفة من التقويمات.
...
| [getUseLastFormat()](#getUseLastFormat) | يحصل على ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المضيف عند إدراج حقل DATE جديد. |
| [getUseLunarCalendar()](#getUseLunarCalendar) | يحصل على ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | يحصل على ما إذا كان سيتم استخدام تقويم العصر سكا. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | يحصل على ما إذا كان سيتم استخدام تقويم أم القرى. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | يضبط ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المضيف عند إدراج حقل DATE جديد. |
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | يضبط ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | يضبط ما إذا كان سيتم استخدام تقويم العصر سكا. |
| [setUseUmAlQuraCalendar(boolean value)](#setUseUmAlQuraCalendar-boolean) | يضبط ما إذا كان سيتم استخدام تقويم أم القرى. |
...
يحصل على ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المضيف عند إدراج حقل DATE جديد.
...
**Returns:**
منطقي - ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المضيف عند إدراج حقل DATE جديد.
...
يحصل على ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري.
...
**Returns:**
boolean - ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري.
...
يحصل على ما إذا كان سيتم استخدام تقويم العصر سكا.
...
**Returns:**
boolean - ما إذا كان سيتم استخدام تقويم العصر سكا.
...
يحصل على ما إذا كان سيتم استخدام تقويم أم القرى.
...
**Returns:**
boolean - ما إذا كان سيتم استخدام تقويم أم القرى.
### isDirty() {#isDirty}
```
...
يضبط ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المضيف عند إدراج حقل DATE جديد.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب استخدام تنسيق تم استخدامه آخرًا من قبل التطبيق المستضيف عند إدراج حقل DATE جديد. |
...
يضبط ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم استخدام التقويم القمري الهجري أو التقويم القمري العبري. |
...
يضبط ما إذا كان سيتم استخدام تقويم العصر سكا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب استخدام تقويم سكا إيرا. |
...
يضبط ما إذا كان سيتم استخدام تقويم أم القرى.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب استخدام تقويم أم القرى. |
