...
description: "ينفّذ حقل SET في Java."
type: docs
weight: 285
url: /ar/java/com.aspose.words/fieldset/
---
...
يُعيّن نصًا جديدًا إلى إشارة مرجعية.

 **Examples:** 

يُظهر كيفية إنشاء نص مع إشارة مرجعية باستخدام حقل SET، ثم عرضه في المستند باستخدام حقل REF.
...
| [getBookmarkText()](#getBookmarkText) | يحصل على النص الجديد للإشارة المرجعية. |
...
| [setBookmarkText(String value)](#setBookmarkText-java.lang.String) | يضبط النص الجديد للإشارة المرجعية. |
...
يحصل على النص الجديد للإشارة المرجعية.
...
**Returns:**
java.lang.String - النص الجديد للإشارة المرجعية.
...
يضبط النص الجديد للإشارة المرجعية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص الجديد للإشارة المرجعية. |
