...
description: "نفّذ هذه الواجهة إذا كنت تريد التحكم في كيفية حفظ Aspose.Words للصور عند حفظ مستند إلى HTML في Java."
type: docs
weight: 773
url: /ar/java/com.aspose.words/iimagesavingcallback/
---
```
public interface IImageSavingCallback
```

نفّذ هذه الواجهة إذا كنت تريد التحكم في كيفية حفظ Aspose.Words للصور عند حفظ مستند إلى HTML. قد تُستخدم في صيغ أخرى.
...
| طريقة | الوصف |
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | يُستدعى عندما يقوم Aspose.Words بحفظ صورة إلى HTML. |
...
يُستدعى عندما يقوم Aspose.Words بحفظ صورة إلى HTML.
