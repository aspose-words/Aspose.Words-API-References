...
description: "يُنفّذ حقل KEYWORDS في جافا."
type: docs
weight: 252
url: /ar/java/com.aspose.words/fieldkeywords/
---
...
يسترجع، وباختياريًا يضبط، كلمات مفتاح المستند كما هو مسجل في خاصية **Keywords** من خصائص المستند المدمجة.

 **Examples:** 

يوضح كيفية إدراج حقل KEYWORDS.
...
| [getText()](#getText) | يحصل على نص الكلمات المفتاحية. |
...
| [setText(String value)](#setText-java.lang.String) | يضبط نص الكلمات المفتاحية. |
...
**Returns:**
java.lang.String - نص الكلمات المفتاحية.
### getType() {#getType}
```
public int getType()
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص الكلمات المفتاحية. |
