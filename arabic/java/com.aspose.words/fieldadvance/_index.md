...
description: "يُنفّذ حقل ADVANCE في Java."
type: docs
weight: 197
url: /ar/java/com.aspose.words/fieldadvance/
---
...
ينقل نقطة البداية التي يُعرض عندها النص الذي يلي الحقل نحويًا إلى اليمين أو اليسار، أو إلى الأعلى أو الأسفل، أو إلى موضع أفقي أو عمودي محدد.
...
| [getDownOffset()](#getDownOffset) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأسفل بها. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو صندوق النص. |
| [getLeftOffset()](#getLeftOffset) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى اليسار بها. |
...
| [getRightOffset()](#getRightOffset) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى اليمين بها. |
...
| [getUpOffset()](#getUpOffset) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأعلى بها. |
| [getVerticalPosition()](#getVerticalPosition) | يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | يضبط عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأسفل بها. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو مربع النص. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليسار. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليمين. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأعلى. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة. |
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأسفل بها.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأسفل.
### getEnd() {#getEnd}
```
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو صندوق النص.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو مربع النص.
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى اليسار بها.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليسار.
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى اليمين بها.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليمين.
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأعلى بها.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأعلى.
...
يحصل على عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة.
...
**Returns:**
java.lang.String - عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة.
### isDirty() {#isDirty}
```
...
يضبط عدد النقاط التي يجب أن يُنقل النص الذي يلي الحقل إلى الأسفل بها.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأسفل. |
...
يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو مربع النص.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو مربع النص. |
...
يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليسار.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليسار. |
...
يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليمين.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى اليمين. |
...
يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأعلى.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل إلى الأعلى. |
...
يحدد عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل عموديًا من الحافة العلوية للصفحة. |
