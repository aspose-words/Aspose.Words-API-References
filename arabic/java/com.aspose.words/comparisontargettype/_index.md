...
description: "يسمح بتحديد المستند الأساسي الذي سيُستخدم أثناء المقارنة في جافا."
type: docs
weight: 118
url: /ar/java/com.aspose.words/comparisontargettype/
---
...
يسمح بتحديد المستند الأساسي الذي سيُستخدم أثناء المقارنة. القيمة الافتراضية هي [CURRENT](../../com.aspose.words/comparisontargettype/\#CURRENT).

 **Remarks:** 

يتعلق بخيار "Show changes in" في Microsoft Word داخل مربع الحوار "Compare Documents".
...
| حقل | الوصف |
| --- | --- |
| [CURRENT](#CURRENT) | يُستخدم هذا المستند كأساس أثناء المقارنة. |
| [NEW](#NEW) | يُستخدم مستند آخر كأساس أثناء المقارنة. |
| [length](#length) |  |
## الطرق
...
يُستخدم هذا المستند كأساس أثناء المقارنة.
...
يُستخدم مستند آخر كأساس أثناء المقارنة.
