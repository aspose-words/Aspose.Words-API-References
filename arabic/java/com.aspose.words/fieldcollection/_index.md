...
description: "مجموعة من كائنات Field تمثل الحقول في النطاق المحدد في Java."
type: docs
weight: 212
url: /ar/java/com.aspose.words/fieldcollection/
---
...
مجموعة من كائنات [Field](../../com.aspose.words/field/) تمثل الحقول في النطاق المحدد.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

مثيل من هذه المجموعة يتنقل عبر الحقول التي تبدأ ضمن النطاق المحدد.

مجموعة [FieldCollection](../../com.aspose.words/fieldcollection/) لا تملك الحقول التي تحتويها، بل هي مجرد اختيار للحقول.

مجموعة [FieldCollection](../../com.aspose.words/fieldcollection/) هي "مباشرة"، أي أن التغييرات على عناصر العقدة التي تم إنشاءها منها تنعكس فورًا في الحقول التي تُرجعها خصائص وطرق [FieldCollection](../../com.aspose.words/fieldcollection/).
...
| [get(int index)](#get-int) | يعيد حقلًا عند الفهرس المحدد. |
| [getCount()](#getCount) | يعيد عدد الحقول في المجموعة. |
| [iterator()](#iterator) | يرجع كائن عداد. |
| [remove(Field field)](#remove-com.aspose.words.Field) | يزيل الحقل المحدد من هذه المجموعة ومن المستند. |
| [removeAt(int index)](#removeAt-int) | يزيل حقلًا عند الفهرس المحدد من هذه المجموعة ومن المستند. |
### clear() {#clear}
```
public void clear()
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| field | [Field](../../com.aspose.words/field/) | حقل للإزالة. |
