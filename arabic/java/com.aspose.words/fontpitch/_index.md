...
description: "يمثل درجة عرض الخط في Java."
type: docs
weight: 330
url: /ar/java/com.aspose.words/fontpitch/
---
...
| حقل | الوصف |
| --- | --- |
| [DEFAULT](#DEFAULT) | يحدد عدم توفر أي معلومات حول درجة عرض الخط. |
| [FIXED](#FIXED) | يحدد أن هذا خط ذو عرض ثابت. |
| [VARIABLE](#VARIABLE) | يحدد أن هذا خط ذو عرض نسبي. |
| [length](#length) |  |
## الطرق
...
يحدد عدم توفر أي معلومات حول درجة عرض الخط.
