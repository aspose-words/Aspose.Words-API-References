...
description: "يمثل نهاية لعلامة مستند منسقة ذات نطاق تقبل محتوى متعدد الأقسام في Java."
type: docs
weight: 639
url: /ar/java/com.aspose.words/structureddocumenttagrangeend/
---
...
يمثل نهاية لعلامة مستند منسقة **ranged** تقبل محتوى متعدد الأقسام. راجع أيضًا عقدة [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).
...
| المنشئ | الوصف |
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int) | ينشئ مثيلًا جديدًا للفئة **Structured document tag range end**. |
## الطرق
...
| [getId()](#getId) | يحدد معرفًا رقميًا فريدًا للقراءة فقط ومستمر لهذا العقدة **StructuredDocumentTagRange**. |
| [getNextSibling()](#getNextSibling) | يحصل على العقدة التي تلي هذه العقدة مباشرةً. |
| [getNodeType()](#getNodeType) | يرجع [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). |
...
ينشئ مثيلًا جديدًا للفئة **Structured document tag range end**.
...
| id | int | معرّف بداية نطاق علامة المستند المهيكلة المقابلة. |
...
يحدد معرّفًا رقميًا فريدًا للقراءة فقط ومستمرًا لهذا العقدة **StructuredDocumentTagRange**. العقدة [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/) المقابلة لها نفس [StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart/\#getId).
...
يرجع [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END).

**Returns:**
int - [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
