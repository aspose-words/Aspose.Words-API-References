...
description: "يمثل نهاية إشارة مرجعية في مستند Word في Java."
type: docs
weight: 43
url: /ar/java/com.aspose.words/bookmarkend/
---
...
يمثل نهاية علامة مرجعية في مستند Word.
...
استخدم الفئة [Bookmark](../../com.aspose.words/bookmark/) كـ "واجهة" للعمل مع إشارة مرجعية ككائن واحد.
...
| المنشئ | الوصف |
| --- | --- |
| [BookmarkEnd(DocumentBase doc, String name)](#BookmarkEnd-com.aspose.words.DocumentBase-java.lang.String) | ينشئ مثيلًا جديدًا للفئة [BookmarkEnd](../../com.aspose.words/bookmarkend/). |
## الطرق
...
| [getNodeType()](#getNodeType) | يرجع [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). |
...
ينشئ مثيلًا جديدًا للفئة [BookmarkEnd](../../com.aspose.words/bookmarkend/).
...
ينادي [DocumentVisitor.visitBookmarkEnd(com.aspose.words.BookmarkEnd)](../../com.aspose.words/documentvisitor/\#visitBookmarkEnd-com.aspose.words.BookmarkEnd).
...
يرجع [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END).
...
**Returns:**
int - [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
