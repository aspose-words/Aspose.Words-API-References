...
description: "يطبق الحقل NUMCHARS في Java."
type: docs
weight: 266
url: /ar/java/com.aspose.words/fieldnumchars/
---
...
يسترجع عدد الأحرف في المستند الحالي، كما هو مسجل في خاصية **Characters** من خصائص المستند المدمجة.

 **Examples:** 

يوضح كيفية استخدام حقول NUMCHARS و NUMWORDS و NUMPAGES و PAGE لتتبع حجم مستنداتنا.
