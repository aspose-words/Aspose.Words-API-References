...
description: "يطبق حقل COMMENTS في Java."
type: docs
weight: 213
url: /ar/java/com.aspose.words/fieldcomments/
---
...
يسترجع، ويضبط اختياريًا، التعليقات المتعلقة بالمستند الحالي، كما هو مسجل في خاصية [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) للخصائص المدمجة للمستند.

 **Examples:** 

يوضح كيفية استخدام حقل COMMENTS.
...
| [getText()](#getText) | يحصل على نص التعليقات. |
...
| [setText(String value)](#setText-java.lang.String) | يضبط نص التعليقات. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص التعليقات. |
