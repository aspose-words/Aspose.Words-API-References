...
description: "يحدد الخيارات المتاحة لمعالجة المسافات البادئة أثناء الاستيراد من ملف LoadFormat.TEXT في Java."
type: docs
weight: 691
url: /ar/java/com.aspose.words/txtleadingspacesoptions/
---
...
يحدد الخيارات المتاحة لمعالجة المسافات البادئة أثناء الاستيراد من ملف [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT).
...
| حقل | الوصف |
| --- | --- |
| [CONVERT_TO_INDENT](#CONVERT-TO-INDENT) | يتم إزالة المسافات البادئة وتحويلها إلى مسافة بادئة يسرى. |
| [PRESERVE](#PRESERVE) | يتم الحفاظ على المسافات البادئة. |
| [TRIM](#TRIM) | يتم قص المسافات البادئة |
| [length](#length) |  |
## الطرق
...
يتم إزالة المسافات البادئة وتحويلها إلى مسافة بادئة يسرى.
...
يتم الحفاظ على المسافات البادئة.
