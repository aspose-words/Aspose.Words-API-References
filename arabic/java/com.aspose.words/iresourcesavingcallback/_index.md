...
description: "قم بتنفيذ هذه الواجهة إذا كنت تريد التحكم في طريقة حفظ Aspose.Words للموارد الخارجية مثل الصور والخطوط و CSS عند حفظ مستند إلى HTML ثابت أو SVG في Java."
type: docs
weight: 783
url: /ar/java/com.aspose.words/iresourcesavingcallback/
---
```
public interface IResourceSavingCallback
```

قم بتنفيذ هذه الواجهة إذا كنت تريد التحكم في طريقة حفظ Aspose.Words للموارد الخارجية (الصور، الخطوط و css) عند حفظ مستند إلى HTML أو SVG بصفحات ثابتة.
...
يعرض كيفية استخدام رد نداء لتغيير URI المورد.
...
| طريقة | الوصف |
| --- | --- |
| [resourceSaving(ResourceSavingArgs args)](#resourceSaving-com.aspose.words.ResourceSavingArgs) | يتم استدعاؤه عندما تقوم Aspose.Words بحفظ مورد خارجي إلى تنسيقات HTML ثابت أو SVG. |
...
يتم استدعاؤه عندما تقوم Aspose.Words بحفظ مورد خارجي إلى تنسيقات HTML ثابت أو SVG.
