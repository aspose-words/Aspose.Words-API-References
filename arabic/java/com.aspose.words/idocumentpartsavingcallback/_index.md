...
description: "نفّذ هذه الواجهة إذا كنت تريد تلقي الإشعارات والتحكم في طريقة حفظ Aspose.Words لأجزاء المستند عند تصدير المستند إلى تنسيق SaveFormat.HTML أو SaveFormat.EPUB في Java."
type: docs
weight: 760
url: /ar/java/com.aspose.words/idocumentpartsavingcallback/
---
```
public interface IDocumentPartSavingCallback
```

نفّذ هذه الواجهة إذا كنت تريد تلقي الإشعارات والتحكم في طريقة حفظ Aspose.Words لأجزاء المستند عند تصدير المستند إلى تنسيق [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) أو [SaveFormat.EPUB](../../com.aspose.words/saveformat/\#EPUB).
...
| طريقة | الوصف |
| --- | --- |
| [documentPartSaving(DocumentPartSavingArgs args)](#documentPartSaving-com.aspose.words.DocumentPartSavingArgs) | يُستدعى عندما تكون Aspose.Words على وشك حفظ جزء من المستند. |
...
يُستدعى عندما تكون Aspose.Words على وشك حفظ جزء من المستند.
