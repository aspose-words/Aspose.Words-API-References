...
description: "يُنفّذ حقل DDE في جافا."
type: docs
weight: 221
url: /ar/java/com.aspose.words/fielddde/
---
...
للمعلومات المنسوخة من تطبيق آخر، يربط هذا الحقل تلك المعلومات بملف المصدر الأصلي باستخدام DDE.

 **Examples:** 

يعرض كيفية استخدام أنواع الحقول المختلفة للربط بمستندات أخرى في نظام الملفات المحلي وعرض محتوياتها.
...
| طريقة | الوصف |
| --- | --- |
| [getAutoUpdate()](#getAutoUpdate) | يحصل على ما إذا كان يجب تحديث هذا الحقل تلقائيًا. |
...
| [getInsertAsBitmap()](#getInsertAsBitmap) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كصورة نقطية. |
| [getInsertAsHtml()](#getInsertAsHtml) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كنص بتنسيق HTML. |
| [getInsertAsPicture()](#getInsertAsPicture) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كصورة. |
| [getInsertAsRtf()](#getInsertAsRtf) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق النص الغني (RTF). |
| [getInsertAsText()](#getInsertAsText) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نص فقط. |
| [getInsertAsUnicode()](#getInsertAsUnicode) | يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كنص يونيكود. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getProgId()](#getProgId) | يحصل على نوع التطبيق لمعلومات الارتباط. |
...
| [getSourceFullName()](#getSourceFullName) | يحصل على اسم وموقع ملف المصدر. |
| [getSourceItem()](#getSourceItem) | يحصل على الجزء من ملف المصدر الذي يتم ربطه. |
...
| [isLinked()](#isLinked) | يحصل على ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند. |
| [isLinked(boolean value)](#isLinked-boolean) | يضبط ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند. |
...
| [setAutoUpdate(boolean value)](#setAutoUpdate-boolean) | يضبط ما إذا كان يجب تحديث هذا الحقل تلقائيًا. |
| [setInsertAsBitmap(boolean value)](#setInsertAsBitmap-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط كصورة نقطية. |
| [setInsertAsHtml(boolean value)](#setInsertAsHtml-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط كنص بتنسيق HTML. |
| [setInsertAsPicture(boolean value)](#setInsertAsPicture-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط كصورة. |
| [setInsertAsRtf(boolean value)](#setInsertAsRtf-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص الغني (RTF). |
| [setInsertAsText(boolean value)](#setInsertAsText-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص فقط. |
| [setInsertAsUnicode(boolean value)](#setInsertAsUnicode-boolean) | يضبط ما إذا كان يجب إدراج الكائن المرتبط كنص Unicode. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setProgId(String value)](#setProgId-java.lang.String) | يضبط نوع التطبيق لمعلومات الارتباط. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يضبط اسم وموقع ملف المصدر. |
| [setSourceItem(String value)](#setSourceItem-java.lang.String) | يضبط الجزء من ملف المصدر الذي يتم ربطه. |
...
يحصل على ما إذا كان يجب تحديث هذا الحقل تلقائيًا.
...
**Returns:**
منطقي - ما إذا كان يجب تحديث هذا الحقل تلقائيًا.
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كصورة نقطية.
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط كصورة نقطية.
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كنص بتنسيق HTML.
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط كنص بتنسيق HTML.
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كصورة.
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط كصورة.
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق النص الغني (RTF).
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص الغني (RTF).
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نص فقط.
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص فقط.
...
يحصل على ما إذا كان سيتم إدراج الكائن المرتبط كنص يونيكود.
...
**Returns:**
boolean - ما إذا كان يجب إدراج الكائن المرتبط كنص Unicode.
...
يحصل على نوع التطبيق لمعلومات الارتباط.
...
**Returns:**
java.lang.String - نوع التطبيق لمعلومات الارتباط.
### getResult() {#getResult}
```
...
**Returns:**
java.lang.String - اسم وموقع ملف المصدر.
...
يحصل على الجزء من ملف المصدر الذي يتم ربطه.
...
**Returns:**
java.lang.String - الجزء من ملف المصدر الذي يتم ربطه.
### getStart() {#getStart}
```
...
يحصل على ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند.
...
**Returns:**
boolean - ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند.
...
يضبط ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند. |
...
يضبط ما إذا كان يجب تحديث هذا الحقل تلقائيًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تحديث هذا الحقل تلقائيًا. |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط كصورة نقطية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط كصورة نقطية. |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط كنص بتنسيق HTML.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط كنص بتنسيق HTML. |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط كصورة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط كصورة. |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص الغني (RTF).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق النص الغني (RTF). |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط بتنسيق النص فقط.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نص فقط. |
...
يضبط ما إذا كان يجب إدراج الكائن المرتبط كنص Unicode.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج الكائن المرتبط كنص Unicode. |
...
يضبط نوع التطبيق لمعلومات الارتباط.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نوع التطبيق لمعلومات الارتباط. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم وموقع ملف المصدر. |
...
يضبط الجزء من ملف المصدر الذي يتم ربطه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الجزء من ملف المصدر الذي يتم ربطه. |
