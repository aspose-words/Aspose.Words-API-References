...
description: "يوفر وصولًا مكتوبًا إلى مجموعة من عقد Run في Java."
type: docs
weight: 594
url: /ar/java/com.aspose.words/runcollection/
---
...
يوفر وصولًا مكتوبًا إلى مجموعة من عقد [Run](../../com.aspose.words/run/) .
...
| [get(int index)](#get-int) | يسترجع [Run](../../com.aspose.words/run/) عند الفهرس المحدد. |
...
يسترجع [Run](../../com.aspose.words/run/) عند الفهرس المحدد.
...
**Returns:**
com.aspose.words.Node[] - مصفوفة من الـ runs.
