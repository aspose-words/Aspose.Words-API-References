...
description: "يوفر وصولًا مكتوبًا إلى مجموعة من عقد Comment في جافا."
type: docs
weight: 109
url: /ar/java/com.aspose.words/commentcollection/
---
...
يوفر وصولًا مكتوبًا إلى مجموعة من عقد [Comment](../../com.aspose.words/comment/) .

للتعرف على المزيد، قم بزيارة مقالة الوثائق [ Working with Comments ][Working with Comments].

 **Examples:** 

يعرض كيفية وضع علامة "تم" على التعليق.
...
| [get(int index)](#get-int) | يسترجع [Comment](../../com.aspose.words/comment/) عند الفهرس المحدد. |
...
يسترجع [Comment](../../com.aspose.words/comment/) عند الفهرس المحدد.
