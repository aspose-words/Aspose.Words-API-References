...
description: "ينفّذ حقل BIBLIOGRAPHY في جافا."
type: docs
weight: 207
url: /ar/java/com.aspose.words/fieldbibliography/
---
...
ينفّذ حقل BIBLIOGRAPHY.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يدرج محتويات جزء الببليوغرافيا في المستند بأسلوب ببليوغرافي.
...
| [getFilterLanguageId()](#getFilterLanguageId) | يحصل على معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة. |
| [getFormat()](#getFormat) | يحصل على كائن [FieldFormat](../../com.aspose.words/fieldformat/) الذي يوفر وصولًا مكتوبًا إلى تنسيق الحقل. |
| [getFormatLanguageId()](#getFormatLanguageId) | يحصل على معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
| [getSourceTag()](#getSourceTag) | يحصل على قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | يضبط معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | يضبط معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | يضبط قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا. |
...
يحصل على معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة.
...
**Returns:**
java.lang.String - معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة.
### getFormat() {#getFormat}
```
...
يحصل على معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند.
...
**Returns:**
java.lang.String - معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند.
...
يحصل على قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا.
...
**Returns:**
java.lang.String - قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا.
### getStart() {#getStart}
```
...
يضبط معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة. |
...
يضبط معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
يضبط قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | قيمة بحيث تُعرض فقط المصادر التي تتطابق قيمة عنصر Tag الخاص بها في الببليوغرافيا. |
