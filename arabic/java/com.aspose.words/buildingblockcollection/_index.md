...
description: "مجموعة من كائنات BuildingBlock في المستند في Java."
type: docs
weight: 54
url: /ar/java/com.aspose.words/buildingblockcollection/
---
...
مجموعة من كائنات [BuildingBlock](../../com.aspose.words/buildingblock/) في المستند.

لمزيد من المعلومات، قم بزيارة مقالة وثائق [ Aspose.Words Document Object Model (DOM) ][Aspose.Words Document Object Model _DOM_]

 **Remarks:** 

أنت لا تنشئ مثيلات من هذه الفئة مباشرة. للوصول إلى مجموعة من كتل البناء استخدم الخاصية [GlossaryDocument.getBuildingBlocks()](../../com.aspose.words/glossarydocument/\#getBuildingBlocks).
...
| [get(int index)](#get-int) | يسترجع كتلة بناء في الفهرس المحدد. |
...
يسترجع كتلة بناء في الفهرس المحدد.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الفهرس | int | فهرس في قائمة كتل البناء. |
...
ينسخ جميع كتل البناء من المجموعة إلى مصفوفة جديدة من كتل البناء.
...
**Returns:**
com.aspose.words.Node[] - مصفوفة من كتل البناء.
