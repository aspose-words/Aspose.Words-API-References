...
description: "علامة تبويب الموضع المطلق هي حرف يُستخدم لتقدم الموضع على السطر الحالي من النص عند عرض محتوى WordprocessingML هذا في Java."
type: docs
weight: 10
url: /ar/java/com.aspose.words/absolutepositiontab/
---
...
علامة التبويب ذات الموضع المطلق هي حرف يُستخدم لتقدم الموضع على السطر الحالي من النص عند عرض محتوى WordprocessingML هذا.
...
| [getNodeType()](#getNodeType) | يعيد [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). |
...
يستدعي [DocumentVisitor.visitAbsolutePositionTab(com.aspose.words.AbsolutePositionTab)](../../com.aspose.words/documentvisitor/\#visitAbsolutePositionTab-com.aspose.words.AbsolutePositionTab).
...
يعيد [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR).
...
**Returns:**
int - [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). القيمة المعادة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/) .
