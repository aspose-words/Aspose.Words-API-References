...
description: "ينفذ حقل DOCVARIABLE في Java."
type: docs
weight: 225
url: /ar/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | يحصل على اسم المتغيّر الوثائقي المراد استرجاعه. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | يضبط اسم المتغيّر الوثائقي المراد استرجاعه. |
...
يحصل على اسم المتغيّر الوثائقي المراد استرجاعه.
...
**Returns:**
java.lang.String - اسم المتغيّر الوثائقي المراد استرجاعه.
### isDirty() {#isDirty}
```
...
يضبط اسم المتغيّر الوثائقي المراد استرجاعه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم المتغيّر الوثائقي المراد استرجاعه. |
