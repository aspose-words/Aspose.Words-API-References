...
description: "ينفّذ حقل XE في Java."
type: docs
weight: 306
url: /ar/java/com.aspose.words/fieldxe/
---
...
يحدد النص ورقم الصفحة لإدخال الفهرس، والذي يُستخدم بواسطة حقل INDEX.
...
| [getEntryType()](#getEntryType) | يحصل على نوع إدخال الفهرس. |
...
| [getPageNumberReplacement()](#getPageNumberReplacement) | يحصل على النص المستخدم بدلاً من رقم الصفحة. |
...
| [getYomi()](#getYomi) | يحصل على الـ yomi (الحرف الصوتي الأول لفرز الفهارس) لإدخال الفهرس |
| [isBold()](#isBold) | يحصل على ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة الإدخال. |
| [isBold(boolean value)](#isBold-boolean) | يضبط ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة الإدخال. |
...
| [isItalic()](#isItalic) | يحصل على ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة الإدخال. |
| [isItalic(boolean value)](#isItalic-boolean) | يضبط ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة الإدخال. |
...
| [setEntryType(String value)](#setEntryType-java.lang.String) | يضبط نوع إدخال الفهرس. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setPageNumberReplacement(String value)](#setPageNumberReplacement-java.lang.String) | يضبط النص المستخدم بدلاً من رقم الصفحة. |
...
| [setYomi(String value)](#setYomi-java.lang.String) | يضبط الـ yomi (الحرف الصوتي الأول لفرز الفهارس) لإدخال الفهرس |
...
**Returns:**
java.lang.String - نوع إدخال الفهرس.
...
يحصل على النص المستخدم بدلاً من رقم الصفحة.
...
**Returns:**
java.lang.String - النص المستخدم بدلاً من رقم الصفحة.
...
يحصل على الـ yomi (الحرف الصوتي الأول لفرز الفهارس) لإدخال الفهرس
...
**Returns:**
java.lang.String - الـ yomi (الحرف الصوتي الأول لفرز الفهارس) للمدخل الفهرسي
### isBold() {#isBold}
```
...
يحصل على ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة الإدخال.
...
**Returns:**
boolean - ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة المدخل.
...
يضبط ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة الإدخال.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تطبيق تنسيق غامق على رقم صفحة المدخل. |
...
يحصل على ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة الإدخال.
...
**Returns:**
boolean - ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة المدخل.
...
يضبط ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة الإدخال.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تطبيق تنسيق مائل على رقم صفحة المدخل. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نوع مدخل فهرس. |
...
يضبط النص المستخدم بدلاً من رقم الصفحة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص المستخدم بدلاً من رقم الصفحة. |
...
يضبط الـ yomi (الحرف الصوتي الأول لفرز الفهارس) لإدخال الفهرس
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الـ yomi (الحرف الصوتي الأول لفرز الفهارس) للمدخل الفهرسي |
