...
description: "يحدد اللغة التي سيتم ترجمة النص إليها باستخدام الذكاء الاصطناعي. في Java."
type: docs
weight: 413
url: /ar/java/com.aspose.words/language/
---
...
يحدد اللغة التي سيتم ترجمة النص إليها باستخدام الذكاء الاصطناعي..
