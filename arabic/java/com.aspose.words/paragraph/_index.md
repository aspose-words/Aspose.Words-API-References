...
description: "يمثل فقرة نصية في Java."
type: docs
weight: 522
url: /ar/java/com.aspose.words/paragraph/
---
...
الفقرة الصالحة في Microsoft Word تنتهي دائمًا بحرف فاصل الفقرة، وتكوّن الفقرة الصالحة الأدنى مجرد فاصل فقرة. تقوم فئة [Paragraph](../../com.aspose.words/paragraph/) تلقائيًا بإضافة حرف فاصل الفقرة المناسب في النهاية، وهذا الحرف ليس جزءًا من عقد الأطفال لفئة [Paragraph](../../com.aspose.words/paragraph/)، وبالتالي يمكن أن تكون [Paragraph](../../com.aspose.words/paragraph/) فارغة.

لا تقم بتضمين أحرف نهاية الفقرة [ControlChar.PARAGRAPH\_BREAK](../../com.aspose.words/controlchar/\#PARAGRAPH-BREAK) أو نهاية الخلية [ControlChar.CELL](../../com.aspose.words/controlchar/\#CELL) داخل نص الفقرة، حيث قد يجعل ذلك الفقرة غير صالحة عند فتح المستند في Microsoft Word.
...
| المنشئ | الوصف |
| --- | --- |
| [Paragraph(DocumentBase doc)](#Paragraph-com.aspose.words.DocumentBase) | يُنشئ مثيلًا جديدًا لفئة [Paragraph](../../com.aspose.words/paragraph/). |
## الطرق

| طريقة | الوصف |
| --- | --- |
| [accept(DocumentVisitor visitor)](#accept-com.aspose.words.DocumentVisitor) | يقبل زائرًا. |
| [acceptEnd(DocumentVisitor visitor)](#acceptEnd-com.aspose.words.DocumentVisitor) | يقبل زائرًا لزيارة نهاية فقرة المستند. |
| [acceptStart(DocumentVisitor visitor)](#acceptStart-com.aspose.words.DocumentVisitor) | يقبل زائرًا لزيارة بداية فقرة المستند. |
...
| [appendField(String fieldCode)](#appendField-java.lang.String) | يضيف حقلًا إلى هذه الفقرة. |
| [appendField(String fieldCode, String fieldValue)](#appendField-java.lang.String-java.lang.String) | يضيف حقلًا إلى هذه الفقرة. |
...
| [getBreakIsStyleSeparator()](#getBreakIsStyleSeparator) | صحيح إذا كان فاصل الفقرة هذا فاصل نمط. |
...
| [getEffectiveTabStops()](#getEffectiveTabStops) | يرجع مصفوفة لجميع مواضع التبويب المطبقة على هذه الفقرة، بما في ذلك تلك المطبقة بشكل غير مباشر عبر الأنماط أو القوائم. |
| [getFirstChild()](#getFirstChild) | يحصل على الطفل الأول للعقدة. |
| [getFrameFormat()](#getFrameFormat) | يوفر الوصول إلى خصائص تنسيق الإطار. |
| [getLastChild()](#getLastChild) | يحصل على الطفل الأخير للعقدة. |
| [getListFormat()](#getListFormat) | يوفر الوصول إلى خصائص تنسيق القائمة للفقرة. |
| [getListLabel()](#getListLabel) | يحصل على كائن [getListLabel()](../../com.aspose.words/paragraph/#getListLabel) الذي يوفر الوصول إلى قيمة ترقيم القائمة وتنسيقها لهذه الفقرة. |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node) |  |
| [getNextSibling()](#getNextSibling) | يحصل على العقدة التي تلي هذه العقدة مباشرةً. |
| [getNodeType()](#getNodeType) | يرجع [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/#PARAGRAPH). |
| [getParagraphBreakFont()](#getParagraphBreakFont) | يوفر الوصول إلى تنسيق الخط لحرف فاصل الفقرة. |
| [getParagraphFormat()](#getParagraphFormat) | يوفر الوصول إلى خصائص تنسيق الفقرة. |
| [getParentNode()](#getParentNode) | يحصل على الوالد المباشر لهذه العقدة. |
| [getParentSection()](#getParentSection) | يسترجع القسم الأب [Section](../../com.aspose.words/section/) للفقرة. |
| [getParentStory()](#getParentStory) | يسترجع قصة المستوى القسمية الأم التي يمكن أن تكون [Body](../../com.aspose.words/body/) أو [HeaderFooter](../../com.aspose.words/headerfooter/). |
...
| [getRuns()](#getRuns) | يوفر الوصول إلى مجموعة مكتوبة من قطع النص داخل الفقرة. |
| [getText()](#getText) | يحصل على نص هذه الفقرة بما في ذلك حرف نهاية الفقرة. |
...
| [insertField(String fieldCode, Node refNode, boolean isAfter)](#insertField-java.lang.String-com.aspose.words.Node-boolean) | يدرج حقلًا في هذه الفقرة. |
| [insertField(String fieldCode, String fieldValue, Node refNode, boolean isAfter)](#insertField-java.lang.String-java.lang.String-com.aspose.words.Node-boolean) | يدرج حقلًا في هذه الفقرة. |
...
| [isEndOfCell()](#isEndOfCell) | صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [Cell](../../com.aspose.words/cell/); خطأ وإلا. |
| [isEndOfDocument()](#isEndOfDocument) | صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في آخر قسم من المستند. |
| [isEndOfHeaderFooter()](#isEndOfHeaderFooter) | صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [HeaderFooter](../../com.aspose.words/headerfooter/) (قصة النص الرئيسي) لـ [Section](../../com.aspose.words/section/); خطأ وإلا. |
| [isEndOfSection()](#isEndOfSection) | صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [Body](../../com.aspose.words/body/) (قصة النص الرئيسي) لـ [Section](../../com.aspose.words/section/); خطأ وإلا. |
| [isFormatRevision()](#isFormatRevision) | يرجع true إذا تم تغيير تنسيق الكائن في Microsoft Word بينما كان تتبع التغييرات مفعلاً. |
| [isInCell()](#isInCell) | صحيح إذا كانت هذه الفقرة طفلًا مباشرًا لـ [Cell](../../com.aspose.words/cell/); خطأ وإلا. |
| [isInsertRevision()](#isInsertRevision) | يرجع true إذا تم إدراج هذا الكائن في Microsoft Word بينما كان تتبع التغييرات مفعلاً. |
| [isListItem()](#isListItem) | صحيح عندما تكون الفقرة عنصرًا في قائمة نقطية أو مرقمة في المراجعة الأصلية. |
...
| [joinRunsWithSameFormatting()](#joinRunsWithSameFormatting) | ينضم إلى السلاسل ذات التنسيق نفسه في الفقرة. |
| [joinRunsWithSameFormatting(JoinRunsOptions options)](#joinRunsWithSameFormatting-com.aspose.words.JoinRunsOptions) | ينضم إلى السلاسل ذات التنسيق نفسه في الفقرة. |
...
يُنشئ مثيلًا جديدًا لفئة [Paragraph](../../com.aspose.words/paragraph/).

 **Remarks:** 

عند إنشاء [Paragraph](../../com.aspose.words/paragraph/)، ينتمي إلى المستند المحدد، لكنه ليس بعد جزءًا من المستند و[Node.getParentNode()](../../com.aspose.words/node/#getParentNode) هو null.

لإضافة [Paragraph](../../com.aspose.words/paragraph/) إلى المستند استخدم [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/#insertAfter-com.aspose.words.Node--com.aspose.words.Node) أو [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/#insertBefore-com.aspose.words.Node--com.aspose.words.Node) على القصة التي تريد إدراج الفقرة فيها.
...
ينادي [DocumentVisitor.visitParagraphStart(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/#visitParagraphStart-com.aspose.words.Paragraph)، ثم ينادي [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/#accept-com.aspose.words.DocumentVisitor) لجميع العقد الفرعية للفقرة وينادي [DocumentVisitor.visitParagraphEnd(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/#visitParagraphEnd-com.aspose.words.Paragraph) في النهاية.
...
يقبل زائرًا لزيارة نهاية فقرة المستند.
...
يقبل زائرًا لزيارة بداية فقرة المستند.
...
يعرض طرقًا مختلفة لإضافة الحقول إلى فقرة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| fieldCode | java.lang.String | رمز الحقل الذي سيتم إضافته (بدون الأقواس المعقوفة). |
...
| --- | --- | --- |
| fieldCode | java.lang.String | رمز الحقل الذي سيتم إضافته (بدون الأقواس المعقوفة). |
| fieldValue | java.lang.String | قيمة الحقل التي سيتم إضافتها. مرر  null  للحقول التي لا تملك قيمة. |
...
صحيح إذا كان هذا الفاصل الفقري هو فاصل نمط. يسمح فاصل النمط للفقرة أن تتكون من أجزاء ذات أنماط فقرة مختلفة.

 **Examples:** 

يعرض كيفية كتابة نص على نفس سطر عنوان الفهرس (TOC) وجعله لا يظهر في الفهرس.
...
يرجع مصفوفة لجميع مواضع التبويب المطبقة على هذه الفقرة، بما في ذلك تلك المطبقة بشكل غير مباشر عبر الأنماط أو القوائم.
...
يحصل على كائن [getListLabel()](../../com.aspose.words/paragraph/#getListLabel) الذي يوفر الوصول إلى قيمة ترقيم القائمة وتنسيقها لهذه الفقرة.
...
يرجع [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/#PARAGRAPH).
...
**Returns:**
int - [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH). القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
...
يسترجع القسم الأب [Section](../../com.aspose.words/section/) للفقرة.
...
يسترجع قصة المستوى القسمية الأم التي يمكن أن تكون [Body](../../com.aspose.words/body/) أو [HeaderFooter](../../com.aspose.words/headerfooter/).
...
يوفر الوصول إلى مجموعة مكتوبة من قطع النص داخل الفقرة.
...
يتم دمج نص جميع العقد الفرعية وتضاف علامة نهاية الفقرة كما يلي:
...
| refNode | [Node](../../com.aspose.words/node/) | عقدة المرجع داخل هذه الفقرة (إذا كان  refNode  هو  null , فسيتم الإضافة إلى نهاية الفقرة). |
...
يعرض كيفية التعامل مع فقرات المراجعة.
...
صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [Cell](../../com.aspose.words/cell/); خطأ وإلا.
...
صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في آخر قسم من المستند.
...
صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [HeaderFooter](../../com.aspose.words/headerfooter/) (قصة النص الرئيسي) لـ [Section](../../com.aspose.words/section/); خطأ وإلا.
...
صحيح إذا كانت هذه الفقرة هي الفقرة الأخيرة في [Body](../../com.aspose.words/body/) (قصة النص الرئيسي) لـ [Section](../../com.aspose.words/section/); خطأ وإلا.
...
يعرض كيفية التحقق مما إذا كانت الفقرة مراجعة تنسيق.
...
صحيح إذا كانت هذه الفقرة طفلًا مباشرًا لـ [Cell](../../com.aspose.words/cell/); خطأ وإلا.
...
ينضم إلى السلاسل ذات التنسيق نفسه في الفقرة.
...
**Returns:**
int - عدد عمليات الجمع التي تم تنفيذها. عندما يتم دمج **N** مقاطع متجاورة تُحسب كـ **N - 1** عمليات دمج.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| options | [JoinRunsOptions](../../com.aspose.words/joinrunsoptions/) | خيارات إضافية |
