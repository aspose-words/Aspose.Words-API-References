...
description: "الفئة الأساسية لعقد المستوى المضمن التي يمكن أن يكون لها تنسيق أحرف مرتبط بها ولكن لا يمكنها أن تحتوي على عقد فرعية خاصة بها في جافا."
type: docs
weight: 403
url: /ar/java/com.aspose.words/inline/
---
...
الفئة الأساسية لعقد المستوى الداخلي التي يمكن أن يكون لها تنسيق أحرف مرتبط بها، ولكن لا يمكن أن تحتوي على عقد فرعية.

لمزيد من المعلومات، زر مقالة الوثائق [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document].

 **Remarks:** 

فئة مشتقة من [Inline](../../com.aspose.words/inline/) يمكن أن تكون طفلاً لـ [Paragraph](../../com.aspose.words/paragraph/).
...
| [getNodeType()](#getNodeType) | يحصل على نوع هذه العقدة. |
...
**Returns:**
int - نوع هذه العقدة. القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
