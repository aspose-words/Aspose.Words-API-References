...
description: "الفئة الأساسية للأحرف الخاصة في المستند بلغة Java."
type: docs
weight: 628
url: /ar/java/com.aspose.words/specialchar/
---
...
يمكن لمستند Microsoft Word أن يحتوي على عدد من الأحرف الخاصة التي تمثل الحقول، حقول النماذج، الأشكال، كائنات OLE، الحواشي السفلية وغيرها. للحصول على قائمة الأحرف الخاصة راجع [ControlChar](../../com.aspose.words/controlchar/).
