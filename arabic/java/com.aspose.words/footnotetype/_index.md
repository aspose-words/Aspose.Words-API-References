...
description: "يحدد ما إذا كان هذا حاشية سفلية أو حاشية ختامية في Java."
type: docs
weight: 346
url: /ar/java/com.aspose.words/footnotetype/
---
...
يحدد ما إذا كان هذا حاشية سفلية أم حاشية علوية.

 **Remarks:** 

كلا الحواشي السفلية والختامية ممثلة بواسطة كائنات من الفئة [FOOTNOTE](../../com.aspose.words/footnotetype/\#FOOTNOTE). استخدم [Footnote.getFootnoteType()](../../com.aspose.words/footnote/\#getFootnoteType) للتمييز بين الحواشي السفلية والختامية.

 **Examples:** 

يوضح كيفية الإشارة إلى النص باستخدام حاشية سفلية وحاشية ختامية.
...
| حقل | الوصف |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | الكائن هو حاشية ختامية. |
| [FOOTNOTE](#FOOTNOTE) | الكائن هو حاشية سفلية. |
| [length](#length) |  |
## الطرق
