...
description: "مجموعة من كائنات Section في المستند بلغة Java."
type: docs
weight: 606
url: /ar/java/com.aspose.words/sectioncollection/
---
...
مجموعة من كائنات [Section](../../com.aspose.words/section/) في المستند.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Sections ][Working with Sections].

 **Remarks:** 

يمكن لمستند Microsoft Word أن يحتوي على أقسام متعددة. لإنشاء قسم في Microsoft Word، اختر أمر Insert/Break وحدد نوع الفاصل. يحدد الفاصل ما إذا كان القسم يبدأ في صفحة جديدة أم في نفس الصفحة.

يمكن استخدام إدراج الأقسام وإزالتها برمجيًا لتخصيص المستندات التي يتم إنشاؤها أثناء دمج البريد. إذا كان المستند يحتاج إلى محتوى مختلف أو أجزاء من المحتوى بناءً على معايير معينة، يمكنك إنشاء مستند "master" يحتوي على أقسام متعددة وحذف بعض الأقسام قبل أو بعد دمج البريد.
...
| [get(int index)](#get-int) | يسترجع قسمًا عند الفهرس المحدد. |
...
| [toArray()](#toArray) | ينسخ جميع الأقسام من المجموعة إلى مصفوفة أقسام جديدة. |
...
يسترجع قسمًا عند الفهرس المحدد.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الفهرس | int | فهرس في قائمة الأقسام. |
...
ينسخ جميع الأقسام من المجموعة إلى مصفوفة أقسام جديدة.

**Returns:**
com.aspose.words.Node[] - مصفوفة من الأقسام.
