...
description: "ينفذ حقل AUTOTEXTLIST في Java."
type: docs
weight: 205
url: /ar/java/com.aspose.words/fieldautotextlist/
---
...
ينفّذ حقل AUTOTEXTLIST.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

ينشئ قائمة اختصارات بناءً على مدخلات AutoText في القالب النشط.

 **Examples:** 

يوضح كيفية استخدام حقل AUTOTEXTLIST لتحديد من قائمة مدخلات AutoText.
...
| [getListStyle()](#getListStyle) | يحصل على اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات. |
...
| [getScreenTip()](#getScreenTip) | يحصل على نص تلميح الشاشة للعرض. |
...
| [setListStyle(String value)](#setListStyle-java.lang.String) | يضبط اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | يضبط نص تلميح الشاشة للعرض. |
...
يحصل على اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات.
...
**Returns:**
java.lang.String - اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات.
...
يحصل على نص تلميح الشاشة للعرض.
...
**Returns:**
java.lang.String - نص تلميح الشاشة للعرض.
...
يضبط اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم النمط الذي تستند إليه القائمة التي تحتوي على المدخلات. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص تلميح الشاشة للعرض. |
