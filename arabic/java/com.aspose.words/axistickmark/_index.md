...
description: "يحدد المواقع الممكنة لعلامات الفواصل في Java."
type: docs
weight: 32
url: /ar/java/com.aspose.words/axistickmark/
---
...
| حقل | الوصف |
| --- | --- |
| [CROSS](#CROSS) | يحدد أن علامات الفواصل يجب أن تتقاطع مع المحور. |
| [INSIDE](#INSIDE) | يحدد أن علامات الفواصل يجب أن تكون داخل منطقة الرسم. |
| [NONE](#NONE) | يحدد أنه لا يجب أن تكون هناك علامات فواصل. |
| [OUTSIDE](#OUTSIDE) | يحدد أن علامات الفواصل يجب أن تكون خارج منطقة الرسم. |
| [length](#length) |  |
## الطرق
...
يحدد أن علامات الفواصل يجب أن تتقاطع مع المحور.
...
يحدد أن علامات الفواصل يجب أن تكون داخل منطقة الرسم.
...
يحدد أنه لا يجب أن تكون هناك علامات فواصل.
...
يحدد أن علامات الفواصل يجب أن تكون خارج منطقة الرسم.
