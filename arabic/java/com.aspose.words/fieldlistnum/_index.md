...
description: "ينفّذ حقل LISTNUM في Java."
type: docs
weight: 255
url: /ar/java/com.aspose.words/fieldlistnum/
---
...
| [getListLevel()](#getListLevel) | يحصل على المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل. |
| [getListName()](#getListName) | يحصل على اسم تعريف الترقيم المجرد المستخدم للترقيم. |
...
| [getStartingNumber()](#getStartingNumber) | يحصل على القيمة الابتدائية لهذا الحقل. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | يحصل على نوع حقل Microsoft Word. |
| [hasListName()](#hasListName) | يرجع قيمة تشير إلى ما إذا كان اسم تعريف الترقيم المجرد مُقدَّمًا بواسطة شفرة الحقل. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | يضبط المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل. |
| [setListName(String value)](#setListName-java.lang.String) | يضبط اسم تعريف الترقيم المجرد المستخدم للترقيم. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | يضبط القيمة الابتدائية لهذا الحقل. |
...
يحصل على المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل.
...
**Returns:**
java.lang.String - المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل.
...
يحصل على اسم تعريف الترقيم المجرد المستخدم للترقيم.
...
**Returns:**
java.lang.String - اسم تعريف الترقيم المجرد المستخدم للترقيم.
...
يحصل على القيمة الابتدائية لهذا الحقل.
...
**Returns:**
java.lang.String - القيمة الابتدائية لهذا الحقل.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
**Returns:**
boolean - قيمة تشير إلى ما إذا كان اسم تعريف الترقيم المجرد مُقدَّمًا بواسطة شفرة الحقل.
### isDirty() {#isDirty}
```
...
يضبط المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | المستوى في القائمة، متجاوزًا السلوك الافتراضي للحقل. |
...
يضبط اسم تعريف الترقيم المجرد المستخدم للترقيم.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم تعريف الترقيم المجرد المستخدم للترقيم. |
...
يضبط القيمة الابتدائية لهذا الحقل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | القيمة الابتدائية لهذا الحقل. |
