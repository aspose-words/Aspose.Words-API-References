...
description: "يمثل مجموعة من كائنات ChartSeriesGroup في Java."
type: docs
weight: 88
url: /ar/java/com.aspose.words/chartseriesgroupcollection/
---
...
يمثل مجموعة من كائنات [ChartSeriesGroup](../../com.aspose.words/chartseriesgroup/).
...
| [get(int index)](#get-int) | يرجع [ChartSeriesGroup](../../com.aspose.words/chartseriesgroup/) عند الفهرس المحدد. |
| [getCount()](#getCount) | يرجع عدد مجموعات السلاسل في هذه المجموعة. |
| [iterator()](#iterator) | يرجع كائن عداد. |
| [removeAt(int index)](#removeAt-int) | يزيل مجموعة سلاسل عند الفهرس المحدد. |
### add(int seriesType) {#add-int}
```
...
يرجع [ChartSeriesGroup](../../com.aspose.words/chartseriesgroup/) عند الفهرس المحدد.

 **Examples:** 

يوضح كيفية إزالة المحور الثانوي.
...
**Returns:**
int - عدد مجموعات السلاسل في هذه المجموعة.
### iterator() {#iterator}
```
...
يزيل مجموعة سلاسل عند الفهرس المحدد. سيتم إزالة جميع السلاسل الفرعية من المخطط.
