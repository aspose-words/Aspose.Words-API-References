...
description: "يحدد كيفية دمج خلية في جدول مع خلايا أخرى في Java."
type: docs
weight: 62
url: /ar/java/com.aspose.words/cellmerge/
---
...
| حقل | الوصف |
| --- | --- |
| [FIRST](#FIRST) | الخلية هي الخلية الأولى في نطاق من الخلايا المدمجة. |
| [NONE](#NONE) | الخلية غير مدمجة. |
| [PREVIOUS](#PREVIOUS) | الخلية مدمجة مع الخلية السابقة أفقياً أو عمودياً. |
| [length](#length) |  |
## الطرق
...
الخلية هي الخلية الأولى في نطاق من الخلايا المدمجة.
...
الخلية مدمجة مع الخلية السابقة أفقياً أو عمودياً.
