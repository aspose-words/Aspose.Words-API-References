...
description: "يحدد كيفية تفسير القيم التي تحدد موقع تسمية البيانات - خصائص ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble و ChartDataLabel.getTop / ChartDataLabel.setTopdouble - في Java."
type: docs
weight: 73
url: /ar/java/com.aspose.words/chartdatalabellocationmode/
---
...
يحدد كيف يتم تفسير القيم التي تحدد موقع تسمية البيانات - خصائص [ChartDataLabel.getLeft()](../../com.aspose.words/chartdatalabel/\#getLeft) / [ChartDataLabel.setLeft(double)](../../com.aspose.words/chartdatalabel/\#setLeft-double) و [ChartDataLabel.getTop()](../../com.aspose.words/chartdatalabel/\#getTop) / [ChartDataLabel.setTop(double)](../../com.aspose.words/chartdatalabel/\#setTop-double) - يتم تفسيرها.
...
| حقل | الوصف |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | يتم تحديد موقع تسمية البيانات باستخدام إحداثيات مطلقة، بدءًا من الزاوية العلوية اليسرى للمخطط. |
| [OFFSET](#OFFSET) | يتم تحديد موقع تسمية البيانات بواسطة إزاحة من الموضع المحدد بواسطة خاصية [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int). |
| [length](#length) |  |
## الطرق
...
يتم تحديد موقع تسمية البيانات باستخدام إحداثيات مطلقة، بدءًا من الزاوية العلوية اليسرى للمخطط.
...
يتم تحديد موقع تسمية البيانات بواسطة إزاحة من الموضع المحدد بواسطة خاصية [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int).
