...
description: "يشير إلى بداية منطقة من النص لديها تعليق مرتبط بها في جافا."
type: docs
weight: 112
url: /ar/java/com.aspose.words/commentrangestart/
---
...
يشير إلى بداية منطقة النص التي لها تعليق مرتبط بها.
...
| المنشئ | الوصف |
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | يقوم بتهيئة نسخة جديدة من هذه الفئة. |
## الطرق
...
| [getNodeType()](#getNodeType) | يرجع [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). |
...
عند إنشاء [CommentRangeStart](../../com.aspose.words/commentrangestart/)، ينتمي إلى المستند المحدد، لكنه ليس جزءًا من المستند بعد و[Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) يكون  null.

لإضافة [CommentRangeStart](../../com.aspose.words/commentrangestart/) إلى المستند، استخدم InsertAfter أو InsertBefore على الفقرة التي تريد إدراج التعليق فيها.
...
يستدعي [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\#visitCommentRangeStart-com.aspose.words.CommentRangeStart).
...
يرجع [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START).
...
**Returns:**
عدد صحيح - [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
