...
description: "ينفذ حقل IF في Java."
type: docs
weight: 243
url: /ar/java/com.aspose.words/fieldif/
---
...
يقارن القيم المحددة بواسطة التعبيرات [getLeftExpression()](../../com.aspose.words/fieldif/\\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldif/\\#setLeftExpression-java.lang.String) و [getRightExpression()](../../com.aspose.words/fieldif/\\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldif/\\#setRightExpression-java.lang.String) في المقارنة باستخدام العامل المحدد بواسطة [getComparisonOperator()](../../com.aspose.words/fieldif/\\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldif/\\#setComparisonOperator-java.lang.String).
...
| [getComparisonOperator()](#getComparisonOperator) | يحصل على عامل المقارنة. |
...
| [getFalseText()](#getFalseText) | يحصل على النص المعروض إذا كان تعبير المقارنة خاطئًا. |
...
| [getLeftExpression()](#getLeftExpression) | يحصل على الجزء الأيسر من تعبير المقارنة. |
...
| [getRightExpression()](#getRightExpression) | يحصل على الجزء الأيمن من تعبير المقارنة. |
| [getSeparator()](#getSeparator) | يحصل على العقدة التي تمثل فاصل الحقل. |
| [getStart()](#getStart) | يحصل على العقدة التي تمثل بداية الحقل. |
| [getTrueText()](#getTrueText) | يحصل على النص المعروض إذا كان تعبير المقارنة صحيحًا. |
...
| [setComparisonOperator(String value)](#setComparisonOperator-java.lang.String) | يضبط عامل المقارنة. |
| [setFalseText(String value)](#setFalseText-java.lang.String) | يضبط النص المعروض إذا كان تعبير المقارنة خاطئًا. |
| [setLeftExpression(String value)](#setLeftExpression-java.lang.String) | يضبط الجزء الأيسر من تعبير المقارنة. |
...
| [setRightExpression(String value)](#setRightExpression-java.lang.String) | يضبط الجزء الأيمن من تعبير المقارنة. |
| [setTrueText(String value)](#setTrueText-java.lang.String) | يضبط النص المعروض إذا كان تعبير المقارنة صحيحًا. |
...
**Returns:**
int - قيمة [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/) تمثل نتيجة تقييم الشرط. القيمة المرجعة هي واحدة من ثوابت [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/).
...
**Returns:**
java.lang.String - عامل المقارنة.
...
يحصل على النص المعروض إذا كان تعبير المقارنة خاطئًا.
...
**Returns:**
java.lang.String - النص المعروض إذا كان تعبير المقارنة خاطئًا.
...
يحصل على الجزء الأيسر من تعبير المقارنة.
...
**Returns:**
java.lang.String - الجزء الأيسر من تعبير المقارنة.
...
يحصل على الجزء الأيمن من تعبير المقارنة.
...
**Returns:**
java.lang.String - الجزء الأيمن من تعبير المقارنة.
...
يحصل على النص المعروض إذا كان تعبير المقارنة صحيحًا.
...
**Returns:**
java.lang.String - النص المعروض إذا كان تعبير المقارنة صحيحًا.
### getType() {#getType}
```
public int getType()
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | عامل المقارنة. |
...
يضبط النص المعروض إذا كان تعبير المقارنة خاطئًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص المعروض إذا كان تعبير المقارنة خاطئًا. |
...
يضبط الجزء الأيسر من تعبير المقارنة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الجزء الأيسر من تعبير المقارنة. |
...
يضبط الجزء الأيمن من تعبير المقارنة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الجزء الأيمن من تعبير المقارنة. |
...
يضبط النص المعروض إذا كان تعبير المقارنة صحيحًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص المعروض إذا كان تعبير المقارنة صحيحًا. |
