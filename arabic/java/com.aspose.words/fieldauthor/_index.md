...
description: "ينفّذ حقل AUTHOR في Java."
type: docs
weight: 200
url: /ar/java/com.aspose.words/fieldauthor/
---
...
يسترجع، ويضبط اختياريًا، اسم مؤلف المستند كما هو مسجَّل في خاصية **Author** للخصائص المدمجة للمستند.
...
| طريقة | الوصف |
| --- | --- |
| [getAuthorName()](#getAuthorName) | يحصل على اسم مؤلف المستند. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | يضبط اسم مؤلف المستند. |
