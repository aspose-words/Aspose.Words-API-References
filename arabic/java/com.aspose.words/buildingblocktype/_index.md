...
description: "يحدد نوع كتلة بناء في Java."
type: docs
weight: 56
url: /ar/java/com.aspose.words/buildingblocktype/
---
...
يحدد نوع كتلة بناء. قد يؤثر النوع على رؤية وسلوك كتلة البناء في Microsoft Word.

 **Remarks:** 

يتطابق مع النوع **ST\_DocPartType** في OOXML.
...
| حقل | الوصف |
| --- | --- |
| [ALL](#ALL) | كتلة البناء مرتبطة بجميع الأنواع. |
| [AUTOMATICALLY_REPLACE_NAME_WITH_CONTENT](#AUTOMATICALLY-REPLACE-NAME-WITH-CONTENT) | يسمح بإدراج كتلة البناء تلقائيًا في المستند كلما تم إدخال اسمها في تطبيق. |
| [AUTO_CORRECT](#AUTO-CORRECT) | كتلة البناء مرتبطة بأدوات التدقيق الإملائي والنحوي. |
| [AUTO_TEXT](#AUTO-TEXT) | كتلة البناء هي إدخال AutoText. |
| [DEFAULT](#DEFAULT) | احفظ كـ [NONE](../../com.aspose.words/buildingblocktype/\#NONE). |
| [FORM_FIELD_HELP_TEXT](#FORM-FIELD-HELP-TEXT) | كتلة البناء هي نص مساعدة لحقل النموذج. |
| [NONE](#NONE) | لم يتم تحديد معلومات النوع لكتلة البناء. |
| [NORMAL](#NORMAL) | كتلة البناء هي عادية (مثلاً). |
| [STRUCTURED_DOCUMENT_TAG_PLACEHOLDER_TEXT](#STRUCTURED-DOCUMENT-TAG-PLACEHOLDER-TEXT) | كتلة البناء هي نص عنصر نائب لعلامة مستند منظم. |
| [length](#length) |  |
## الطرق
...
كتلة البناء مرتبطة بجميع الأنواع.
...
يسمح بإدراج كتلة البناء تلقائيًا في المستند كلما تم إدخال اسمها في تطبيق.
...
كتلة البناء مرتبطة بأدوات التدقيق الإملائي والنحوي.
...
احفظ كـ [NONE](../../com.aspose.words/buildingblocktype/\#NONE).
...
كتلة البناء هي نص مساعدة لحقل النموذج.
...
لم يتم تحديد معلومات النوع لكتلة البناء.
...
كتلة البناء هي إدخال عادي (أي منتظم) في مستند القاموس.
...
كتلة البناء هي نص عنصر نائب لعلامة مستند منظم.
