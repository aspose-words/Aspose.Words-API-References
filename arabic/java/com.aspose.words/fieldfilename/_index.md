...
description: "يُنفّذ الحقل FILENAME في Java."
type: docs
weight: 230
url: /ar/java/com.aspose.words/fieldfilename/
---
...
يسترجع اسم المستند الحالي من موقع تخزينه.

في التنفيذ الحالي، يستخدم الخاصية [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) لاسترجاع اسم الملف. إذا تم تحميل المستند من تدفق أو تم إنشاؤه فارغًا، يستخدم اسم الملف الذي يتم حفظه إليه (إذا كان معروفًا).

 **Examples:** 

يظهر كيفية استخدام FieldOptions لتجاوز القيمة الافتراضية لحقل FILENAME.
...
| [getIncludeFullPath()](#getIncludeFullPath) | يحصل على ما إذا كان يجب تضمين اسم مسار الملف الكامل. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | يضبط ما إذا كان يجب تضمين اسم مسار الملف الكامل. |
...
يحصل على ما إذا كان يجب تضمين اسم مسار الملف الكامل.
...
**Returns:**
boolean - ما إذا كان يجب تضمين اسم مسار الملف الكامل.
...
يضبط ما إذا كان يجب تضمين اسم مسار الملف الكامل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب تضمين اسم مسار الملف الكامل. |
