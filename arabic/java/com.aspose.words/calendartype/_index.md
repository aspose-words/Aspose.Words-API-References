...
description: "يحدد نوع التقويم في Java."
type: docs
weight: 58
url: /ar/java/com.aspose.words/calendartype/
---
...
| حقل | الوصف |
| --- | --- |
| [GREGORIAN](#GREGORIAN) | التقويم الغريغوري. |
| [HEBREW](#HEBREW) | التقويم العبري القمري. |
| [HIJRI](#HIJRI) | التقويم الهجري القمري. |
| [SAKA_ERA](#SAKA-ERA) | تقويم عصر سكا. |
| [UM_AL_QURA](#UM-AL-QURA) | تقويم أم القرى. |
| [length](#length) |  |
## الطرق
