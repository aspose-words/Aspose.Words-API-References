...
description: "ينفّذ حقل SKIPIF في Java."
type: docs
weight: 287
url: /ar/java/com.aspose.words/fieldskipif/
---
...
يقارن القيم المحددة بواسطة التعبيرات [getLeftExpression()](../../com.aspose.words/fieldskipif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldskipif/\#setLeftExpression-java.lang.String) و [getRightExpression()](../../com.aspose.words/fieldskipif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldskipif/\#setRightExpression-java.lang.String) في المقارنة باستخدام العامل المحدد بواسطة [getComparisonOperator()](../../com.aspose.words/fieldskipif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldskipif/\#setComparisonOperator-java.lang.String). إذا كانت المقارنة صحيحة، يقوم SKIPIF بإلغاء مستند الدمج الحالي، ينتقل إلى سجل البيانات التالي في مصدر البيانات، ويبدأ مستند دمج جديد. إذا كانت المقارنة خاطئة، يستمر مستند الدمج الحالي.

 **Examples:** 

يعرض كيفية تخطي الصفحات في دمج البريد باستخدام حقل SKIPIF.
...
يظهر كيفية استخدام حقول MERGEREC و MERGESEQ للترقيم وحساب سجلات الدمج البريدي في مستندات إخراج الدمج البريدي.
