...
description: "يوفر وصولًا مكتوبًا إلى مجموعة من عقد Row في Java."
type: docs
weight: 589
url: /ar/java/com.aspose.words/rowcollection/
---
...
يوفر وصولًا مكتوبًا إلى مجموعة من عقد [Row](../../com.aspose.words/row/) .
...
| [get(int index)](#get-int) | يسترجع [Row](../../com.aspose.words/row/) عند الفهرس المحدد. |
...
يسترجع [Row](../../com.aspose.words/row/) عند الفهرس المحدد.
...
ينسخ جميع الصفوف من المجموعة إلى مصفوفة جديدة من الصفوف.
...
**Returns:**
com.aspose.words.Node[] - مصفوفة من الصفوف.
