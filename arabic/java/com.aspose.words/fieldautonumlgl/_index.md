...
description: "ينفذ الحقل AUTONUMLGL في Java."
type: docs
weight: 202
url: /ar/java/com.aspose.words/fieldautonumlgl/
---
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | يحصل على ما إذا كان يجب عرض الرقم بدون نقطة نهائية. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | يحصل على حرف الفاصل الذي سيُستخدم. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | يضبط ما إذا كان يجب عرض الرقم بدون نقطة نهائية. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | يضبط حرف الفاصل الذي سيُستخدم. |
...
يحصل على ما إذا كان يجب عرض الرقم بدون نقطة نهائية.
...
**Returns:**
boolean - ما إذا كان يجب عرض الرقم بدون نقطة نهائية.
### getResult() {#getResult}
```
...
يحصل على حرف الفاصل الذي سيُستخدم.
...
**Returns:**
java.lang.String - حرف الفاصل الذي سيُستخدم.
### getStart() {#getStart}
```
...
يضبط ما إذا كان يجب عرض الرقم بدون نقطة نهائية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب عرض الرقم بدون نقطة نهائية. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | حرف الفاصل الذي سيُستخدم. |
