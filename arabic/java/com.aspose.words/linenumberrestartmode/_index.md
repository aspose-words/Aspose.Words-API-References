...
description: "يحدد متى يتم إعادة تشغيل ترقيم السطور التلقائي في Java."
type: docs
weight: 422
url: /ar/java/com.aspose.words/linenumberrestartmode/
---
...
يحدد متى يتم إعادة تشغيل ترقيم الأسطر تلقائيًا.
...
| حقل | الوصف |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | ترقيم السطور مستمر من القسم السابق. |
| [RESTART_PAGE](#RESTART-PAGE) | ترقيم السطور يعاد تشغيله في بداية كل صفحة. |
| [RESTART_SECTION](#RESTART-SECTION) | ترقيم السطور يعاد تشغيله في بداية القسم. |
| [length](#length) |  |
## الطرق
...
ترقيم السطور مستمر من القسم السابق.
...
ترقيم السطور يعاد تشغيله في بداية كل صفحة.
...
ترقيم السطور يعاد تشغيله في بداية القسم.
