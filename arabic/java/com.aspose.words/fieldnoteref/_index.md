...
description: "ينفّذ حقل NOTEREF في Java."
type: docs
weight: 265
url: /ar/java/com.aspose.words/fieldnoteref/
---
...
يدرج علامة الهوامش السفلية أو الهوامش النهائية التي تم وضع علامة عليها بالإشارة المرجعية المحددة.

 **Examples:** 

يُظهر كيفية إدراج حقول NOTEREF وتعديل مظهرها.
...
يُظهر كيفية الإشارة المتقاطعة إلى الهوامش السفلية باستخدام حقل NOTEREF.
...
| طريقة | الوصف |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | يحصل على اسم الإشارة المرجعية. |
...
| [getInsertHyperlink()](#getInsertHyperlink) | يحصل على ما إذا كان يجب إدراج رابط تشعبي إلى الفقرة المرجعية. |
| [getInsertReferenceMark()](#getInsertReferenceMark) | يدرج علامة الإشارة بنفس تنسيق الأحرف كما هو في نمط إشارة الهوامش السفلية أو إشارة الهوامش النهائية. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | يحصل على ما إذا كان يجب إدراج موضع نسبي للفقرة المرجعية. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | يضبط اسم الإشارة المرجعية. |
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | يضبط ما إذا كان سيتم إدراج ارتباط تشعبي إلى الفقرة التي تم وضع إشارة مرجعية لها. |
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | يدرج علامة الإشارة بنفس تنسيق الأحرف كما هو في نمط إشارة الهوامش السفلية أو إشارة الهوامش النهائية. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | يضبط ما إذا كان سيتم إدراج موضع نسبي للفقرة التي تم وضع إشارة مرجعية لها. |
...
يحصل على ما إذا كان يجب إدراج رابط تشعبي إلى الفقرة المرجعية.
...
**Returns:**
منطقي - ما إذا كان سيتم إدراج ارتباط تشعبي إلى الفقرة التي تم وضع إشارة مرجعية لها.
...
يدرج علامة الإشارة بنفس تنسيق الأحرف كما هو في نمط إشارة الهوامش السفلية أو إشارة الهوامش النهائية.
...
يحصل على ما إذا كان يجب إدراج موضع نسبي للفقرة المرجعية.
...
**Returns:**
منطقي - ما إذا كان سيتم إدراج موضع نسبي للفقرة التي تم وضع إشارة مرجعية لها.
...
يضبط ما إذا كان سيتم إدراج ارتباط تشعبي إلى الفقرة التي تم وضع إشارة مرجعية لها.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج ارتباط تشعبي إلى الفقرة التي تم وضع إشارة مرجعية لها. |
...
يضبط ما إذا كان سيتم إدراج موضع نسبي للفقرة التي تم وضع إشارة مرجعية لها.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان سيتم إدراج موضع نسبي للفقرة التي تم وضع إشارة مرجعية لها. |
