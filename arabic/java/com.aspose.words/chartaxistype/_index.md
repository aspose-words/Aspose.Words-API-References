...
description: "يحدد نوع محور المخطط في Java."
type: docs
weight: 70
url: /ar/java/com.aspose.words/chartaxistype/
---
...
| حقل | الوصف |
| --- | --- |
| [CATEGORY](#CATEGORY) | محور الفئة في المخطط. |
| [SERIES](#SERIES) | محور السلسلة في المخطط. |
| [VALUE](#VALUE) | محور القيمة في المخطط. |
| [length](#length) |  |
## الطرق
