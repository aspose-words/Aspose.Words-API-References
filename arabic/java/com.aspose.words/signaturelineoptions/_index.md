...
description: "يسمح بتحديد الخيارات لسطر التوقيع الذي يتم إدراجه في Java."
type: docs
weight: 622
url: /ar/java/com.aspose.words/signaturelineoptions/
---
...
يسمح بتحديد الخيارات لسطر التوقيع الذي يتم إدراجه. يستخدم في [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
| [getSignerTitle()](#getSignerTitle) | يحصل على لقب الموقع المقترح. |
...
| [setSignerTitle(String value)](#setSignerTitle-java.lang.String) | يضبط لقب الموقع المقترح. |
...
يحصل على التعليمات للموقع التي تُعرض عند توقيع سطر التوقيع. القيمة الافتراضية لهذه الخاصية هي **empty string**.
...
يحصل على لقب المُوقّع المقترح. القيمة الافتراضية لهذه الخاصية هي **empty string**.
...
**Returns:**
java.lang.String - لقب المُوقّع المقترح.
...
يضبط التعليمات للمُوقّع التي تُعرض عند توقيع سطر التوقيع. القيمة الافتراضية لهذه الخاصية هي **empty string**.
...
يضبط لقب المُوقّع المقترح. القيمة الافتراضية لهذه الخاصية هي **empty string**.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | لقب المُوقّع المقترح. |
