...
description: "يُنفّذ حقل CITATION في Java."
type: docs
weight: 211
url: /ar/java/com.aspose.words/fieldcitation/
---
...
يدرج محتويات عنصر **Source** مع عنصر **Tag** المحدد باستخدام نمط ببليوغرافي.

 **Examples:** 

يظهر كيفية العمل مع حقول CITATION و BIBLIOGRAPHY.
...
| طريقة | الوصف |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | يحصل على قيمة تطابق قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | يحصل على معرف اللغة المستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getPageNumber()](#getPageNumber) | يحصل على رقم صفحة مرتبط بالاقتباس. |
| [getPrefix()](#getPrefix) | يحصل على بادئة تُضاف قبل الاقتباس. |
...
| [getSourceTag()](#getSourceTag) | يحصل على قيمة تطابق قيمة عنصر **Tag** للمصدر المراد إدراجه. |
| [getStart()](#getStart) | يحصل على العقدة التي تمثل بداية الحقل. |
| [getSuffix()](#getSuffix) | يحصل على لاحقة تُضاف بعد الاقتباس. |
| [getSuppressAuthor()](#getSuppressAuthor) | يحصل على ما إذا كانت معلومات المؤلف محجوبة من الاقتباس. |
| [getSuppressTitle()](#getSuppressTitle) | يحصل على ما إذا كانت معلومات العنوان محجوبة من الاقتباس. |
| [getSuppressYear()](#getSuppressYear) | يحصل على ما إذا كانت معلومات السنة محجوبة من الاقتباس. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | يحصل على نوع حقل Microsoft Word. |
| [getVolumeNumber()](#getVolumeNumber) | يحصل على رقم المجلد المرتبط بالاقتباس. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | يضبط قيمة تتطابق مع قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | يضبط معرف اللغة المستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setPageNumber(String value)](#setPageNumber-java.lang.String) | يضبط رقم صفحة مرتبط بالاقتباس. |
| [setPrefix(String value)](#setPrefix-java.lang.String) | يضبط بادئة تُضاف إلى بداية الاقتباس. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | يضبط قيمة تتطابق مع قيمة عنصر **Tag** للمصدر الذي سيتم إدراجه. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | يضبط لاحقة تُضاف إلى نهاية الاقتباس. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | يضبط ما إذا كانت معلومات المؤلف محجوبة من الاقتباس. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | يضبط ما إذا كانت معلومات العنوان محجوبة من الاقتباس. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | يضبط ما إذا كانت معلومات السنة محجوبة من الاقتباس. |
| [setVolumeNumber(String value)](#setVolumeNumber-java.lang.String) | يضبط رقم المجلد المرتبط بالاقتباس. |
...
يحصل على قيمة تطابق قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس.
...
**Returns:**
java.lang.String - قيمة تتطابق مع قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس.
...
يحصل على معرف اللغة المستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند.
...
**Returns:**
java.lang.String - معرف اللغة المستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند.
...
يحصل على رقم صفحة مرتبط بالاقتباس.
...
**Returns:**
java.lang.String - رقم صفحة مرتبط بالاقتباس.
### getPrefix() {#getPrefix}
```
...
يحصل على بادئة تُضاف قبل الاقتباس.
...
**Returns:**
java.lang.String - بادئة تُضاف إلى بداية الاقتباس.
### getResult() {#getResult}
```
...
يحصل على قيمة تطابق قيمة عنصر **Tag** للمصدر المراد إدراجه.
...
**Returns:**
java.lang.String - قيمة تتطابق مع قيمة عنصر **Tag** للمصدر الذي سيتم إدراجه.
### getStart() {#getStart}
```
...
يحصل على لاحقة تُضاف بعد الاقتباس.
...
**Returns:**
java.lang.String - لاحقة تُضاف إلى نهاية الاقتباس.
...
يحصل على ما إذا كانت معلومات المؤلف محجوبة من الاقتباس.
...
**Returns:**
boolean - ما إذا كانت معلومات المؤلف محجوبة من الاقتباس.
...
يحصل على ما إذا كانت معلومات العنوان محجوبة من الاقتباس.
...
**Returns:**
boolean - ما إذا كانت معلومات العنوان محجوبة من الاقتباس.
...
يحصل على ما إذا كانت معلومات السنة محجوبة من الاقتباس.
...
**Returns:**
boolean - ما إذا كانت معلومات السنة محجوبة من الاقتباس.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
يحصل على رقم المجلد المرتبط بالاقتباس.
...
**Returns:**
java.lang.String - رقم المجلد المرتبط بالاقتباس.
### isDirty() {#isDirty}
```
...
يضبط قيمة تتطابق مع قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | قيمة تتطابق مع قيمة عنصر **Tag** لمصدر آخر لتضمينه في الاقتباس. |
...
يضبط معرف اللغة المستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرّف اللغة الذي يُستخدم بالاشتراك مع النمط الببليوغرافي المحدد لتنسيق الاقتباس في المستند. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | رقم صفحة مرتبط بالاقتباس. |
...
يضبط بادئة تُضاف إلى بداية الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | بادئة تُضاف إلى بداية الاقتباس. |
...
يضبط قيمة تتطابق مع قيمة عنصر **Tag** للمصدر الذي سيتم إدراجه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | قيمة تتطابق مع قيمة عنصر **Tag** للمصدر المراد إدراجه. |
...
يضبط لاحقة تُضاف إلى نهاية الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | لاحقة تُضاف إلى نهاية الاقتباس. |
...
يضبط ما إذا كانت معلومات المؤلف محجوبة من الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كانت معلومات المؤلف محجوبة من الاقتباس. |
...
يضبط ما إذا كانت معلومات العنوان محجوبة من الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كانت معلومات العنوان محجوبة من الاقتباس. |
...
يضبط ما إذا كانت معلومات السنة محجوبة من الاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كانت معلومات السنة محجوبة من الاقتباس. |
...
يضبط رقم المجلد المرتبط بالاقتباس.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | رقم المجلد المرتبط بالاقتباس. |
