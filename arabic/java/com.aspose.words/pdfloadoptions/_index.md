...
description: "يسمح بتحديد خيارات إضافية عند تحميل مستند Pdf إلى كائن Document في Java."
type: docs
weight: 538
url: /ar/java/com.aspose.words/pdfloadoptions/
---
...
يسمح بتحديد خيارات إضافية عند تحميل مستند Pdf إلى كائن [Document](../../com.aspose.words/document/) .
...
| [getPageCount()](#getPageCount) | يحصل على عدد الصفحات التي سيتم قراءتها. |
| [getPageIndex()](#getPageIndex) | يحصل على الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها. |
...
| [getSkipPdfImages()](#getSkipPdfImages) | يحصل على العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. |
...
| [setPageCount(int value)](#setPageCount-int) | يضبط عدد الصفحات التي سيتم قراءتها. |
| [setPageIndex(int value)](#setPageIndex-int) | يضبط الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها. |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean) | يضبط العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. |
...
يحصل على عدد الصفحات التي سيتم قراءتها. القيمة الافتراضية هي MaxValue مما يعني أنه سيتم قراءة جميع صفحات المستند.
...
**Returns:**
int - عدد الصفحات التي سيتم قراءتها.
...
يحصل على الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها. القيمة الافتراضية هي 0.
...
**Returns:**
int - الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها.
...
يحصل على العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. القيمة الافتراضية هي false.
...
**Returns:**
boolean - العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF.
...
يضبط عدد الصفحات التي سيتم قراءتها. القيمة الافتراضية هي MaxValue مما يعني أنه سيتم قراءة جميع صفحات المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | int | عدد الصفحات التي سيتم قراءتها. |
...
يضبط الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها. القيمة الافتراضية هي 0.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | int | الفهرس القائم على الصفر للصفحة الأولى التي سيتم قراءتها. |
...
يضبط العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. القيمة الافتراضية هي false.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. |
