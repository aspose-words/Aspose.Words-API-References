...
description: "يطبق حقل INFO في Java."
type: docs
weight: 251
url: /ar/java/com.aspose.words/fieldinfo/
---
...
يدرج معلومات حول خاصية المستند.

 **Examples:** 

يظهر كيفية العمل مع حقول INFO.
...
| [getInfoType()](#getInfoType) | يحصل على نوع خاصية المستند لإدراجها. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getNewValue()](#getNewValue) | يحصل على قيمة اختيارية تقوم بتحديث الخاصية. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | يضبط نوع خاصية المستند لإدراجها. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | يضبط قيمة اختيارية تقوم بتحديث الخاصية. |
...
يحصل على نوع خاصية المستند لإدراجها.
...
**Returns:**
java.lang.String - نوع خاصية المستند لإدراجها.
...
يحصل على قيمة اختيارية تقوم بتحديث الخاصية.
...
**Returns:**
java.lang.String - قيمة اختيارية تقوم بتحديث الخاصية.
### getResult() {#getResult}
```
...
يضبط نوع خاصية المستند لإدراجها.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نوع خاصية المستند لإدراجها. |
...
يضبط قيمة اختيارية تقوم بتحديث الخاصية.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | قيمة اختيارية تقوم بتحديث الخاصية. |
