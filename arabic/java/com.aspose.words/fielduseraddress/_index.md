...
description: "ينفّذ الحقل USERADDRESS في جافا."
type: docs
weight: 303
url: /ar/java/com.aspose.words/fielduseraddress/
---
...
يعرض كيفية استخدام حقل USERADDRESS.
...
| [getUserAddress()](#getUserAddress) | يحصل على العنوان البريدي للمستخدم الحالي. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | يضبط العنوان البريدي للمستخدم الحالي. |
...
يحصل على العنوان البريدي للمستخدم الحالي.
...
**Returns:**
java.lang.String - العنوان البريدي للمستخدم الحالي.
### isDirty() {#isDirty}
```
...
يضبط العنوان البريدي للمستخدم الحالي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | العنوان البريدي للمستخدم الحالي. |
