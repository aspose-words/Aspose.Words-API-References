...
description: "يحدد إعدادات آلية الاستبدال للخطوط في Java."
type: docs
weight: 323
url: /ar/java/com.aspose.words/fontfallbacksettings/
---
...
يحدد إعدادات آلية الاحتياطي للخط.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

بشكل افتراضي يتم تهيئة إعدادات الاستبدال بإعدادات مسبقة تحاكي استبدال Microsoft Word.

 **Examples:** 

يعرض كيفية توزيع خطوط الاستبدال عبر نطاقات رموز الأحرف Unicode.
...
| طريقة | الوصف |
| --- | --- |
| [buildAutomatic()](#buildAutomatic) | يبني إعدادات الاستبدال تلقائياً عن طريق فحص الخطوط المتاحة. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | يقوم بتحميل إعدادات استبدال الخطوط من ملف XML. |
| [loadMsOfficeFallbackSettings()](#loadMsOfficeFallbackSettings) | يقوم بتحميل إعدادات استبدال مسبقة تحاكي استبدال Microsoft Word وتستخدم خطوط Microsoft Office. |
| [loadNotoFallbackSettings()](#loadNotoFallbackSettings) | يقوم بتحميل إعدادات استبدال مسبقة تستخدم خطوط Google Noto. |
| [save(OutputStream outputStream)](#save-java.io.OutputStream) |  |
| [save(String fileName)](#save-java.lang.String) | يحفظ إعدادات الاستبدال الحالية إلى ملف. |
...
يبني إعدادات الاستبدال تلقائياً عن طريق فحص الخطوط المتاحة.

 **Remarks:** 

قد ينتج عن هذه الطريقة إعدادات استبدال غير مثالية. يتم فحص الخطوط عبر حقول [ Unicode Character Range ][Unicode Character Range] وليس بناءً على وجود الحروف الفعلية. كما يتم فحص نطاقات Unicode بشكل فردي وقد تستخدم عدة نطاقات مرتبطة بلغة/نص واحد خطوط استبدال مختلفة.
...
يقوم بتحميل إعدادات استبدال الخطوط من ملف XML.

 **Examples:** 

يعرض كيفية تحميل وحفظ إعدادات استبدال الخطوط إلى/من مستند XML في نظام الملفات المحلي.
...
يقوم بتحميل إعدادات استبدال مسبقة تحاكي استبدال Microsoft Word وتستخدم خطوط Microsoft Office.

 **Examples:** 

يعرض كيفية تحميل إعدادات خطوط الاستبدال المعرفة مسبقاً.
...
يقوم بتحميل إعدادات استبدال مسبقة تستخدم خطوط Google Noto.

 **Examples:** 

يعرض كيفية إضافة إعدادات استبدال خطوط معرفة مسبقاً لخطوط Google Noto.
...
يحفظ إعدادات الاستبدال الحالية إلى ملف.
