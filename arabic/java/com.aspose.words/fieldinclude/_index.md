...
description: "يطبق حقل INCLUDE في Java."
type: docs
weight: 246
url: /ar/java/com.aspose.words/fieldinclude/
---
...
يُظهر كيفية إنشاء حقل INCLUDE وتعيين خصائصه.
...
| [getSourceFullName()](#getSourceFullName) | يحصل على موقع المستند. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يضبط موقع المستند. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع المستند. |
