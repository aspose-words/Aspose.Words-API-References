...
description: "يمثل المرجع إلى امتداد ويب في Java."
type: docs
weight: 732
url: /ar/java/com.aspose.words/webextensionreference/
---
...
يمثل المرجع إلى امتداد ويب. يُستخدم المرجع لتحديد موقع المزود وإصدار الامتداد.
...
| طريقة | الوصف |
| --- | --- |
| [getId()](#getId) | المعرّف المرتبط بامتداد الويب داخل مزود الفهرس. |
| [getStore()](#getStore) | يحدد نسخة السوق حيث يتم تخزين امتداد الويب. |
| [getStoreType()](#getStoreType) | يحدد نوع السوق. |
| [getVersion()](#getVersion) | يحدد إصدار امتداد الويب. |
| [setId(String value)](#setId-java.lang.String) | المعرّف المرتبط بامتداد الويب داخل مزود الفهرس. |
| [setStore(String value)](#setStore-java.lang.String) | يحدد نسخة السوق حيث يتم تخزين امتداد الويب. |
| [setStoreType(int value)](#setStoreType-int) | يحدد نوع السوق. |
| [setVersion(String value)](#setVersion-java.lang.String) | يحدد إصدار امتداد الويب. |
### getId() {#getId}
```
public String getId()
```
...
المعرّف المرتبط بامتداد الويب داخل مزود الفهرس.
...
يحدد نسخة السوق حيث يتم تخزين امتداد الويب.
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة int المقابلة. يجب أن تكون القيمة واحدة من ثوابت [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/). |
