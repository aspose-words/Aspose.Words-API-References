...
description: "يحدد الخيارات المتاحة لمعالجة المسافات المتتبعة أثناء الاستيراد من ملف LoadFormat.TEXT في Java."
type: docs
weight: 697
url: /ar/java/com.aspose.words/txttrailingspacesoptions/
---
...
يحدد الخيارات المتاحة لمعالجة المسافات المتتبقة أثناء الاستيراد من ملف [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT).
...
| حقل | الوصف |
| --- | --- |
| [PRESERVE](#PRESERVE) | يتم الحفاظ على المسافات المتتبقة. |
| [TRIM](#TRIM) | يتم قص المسافات المتتبقة. |
| [length](#length) |  |
## الطرق
...
يتم الحفاظ على المسافات المتتبقة.
