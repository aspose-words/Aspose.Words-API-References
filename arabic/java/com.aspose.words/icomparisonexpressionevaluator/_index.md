...
description: "عند تنفيذها تسمح بتجاوز تقييم تعبيرات المقارنة الافتراضية لحقلي FieldIf و FieldCompare في جافا."
type: docs
weight: 755
url: /ar/java/com.aspose.words/icomparisonexpressionevaluator/
---
```
public interface IComparisonExpressionEvaluator
```

عند تنفيذها، تسمح بتجاوز تقييم تعبيرات المقارنة الافتراضية لحقلي [FieldIf](../../com.aspose.words/fieldif/) و [FieldCompare](../../com.aspose.words/fieldcompare/) .
...
| طريقة | الوصف |
| --- | --- |
| [evaluate(Field field, ComparisonExpression expression)](#evaluate-com.aspose.words.Field-com.aspose.words.ComparisonExpression) | يقيم تعبير المقارنة. |
...
يجب أن تُعيد التنفيذ  null  للإشارة إلى أنه يجب إجراء التقييم الافتراضي.
