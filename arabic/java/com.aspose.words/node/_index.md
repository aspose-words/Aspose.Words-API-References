...
description: "الفئة الأساسية لجميع العقد في مستند Word بلغة Java."
type: docs
weight: 476
url: /ar/java/com.aspose.words/node/
---
...
يتم تمثيل المستند كشجرة من العقد، مشابهة لـ DOM أو XmlDocument.

لمزيد من المعلومات، راجع نمط التصميم Composite.

الفئة [Node](../../com.aspose.words/node/) :
