...
description: "تنفذ حقل SUBJECT في Java."
type: docs
weight: 290
url: /ar/java/com.aspose.words/fieldsubject/
---
...
تسترجع، وتُعيّن اختياريًا، موضوع المستند كما هو مسجَّل في خاصية **Subject** من خصائص المستند المدمجة.
...
| [getText()](#getText) | يحصل على نص الموضوع. |
...
| [setText(String value)](#setText-java.lang.String) | يضبط نص الموضوع. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص الموضوع. |
