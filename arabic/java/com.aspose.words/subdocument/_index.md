---
title: "المستند الفرعي"
linktitle: "المستند الفرعي"
second_title: "Aspose.Words لـ Java"
description: "يمثل المستند الفرعي - وهو إشارة إلى مستند مخزن خارجيًا في Java."
type: docs
weight: 645
url: /ar/java/com.aspose.words/subdocument/
---
...
يمثل **SubDocument** \- وهو إشارة إلى مستند مخزن خارجيًا.

لمزيد من المعلومات، قم بزيارة مقالة وثائق [ Aspose.Words Document Object Model (DOM) ][Aspose.Words Document Object Model _DOM_]

 **Remarks:** 

في هذا الإصدار من Aspose.Words، لا توفر عقد [SubDocument](../../com.aspose.words/subdocument/) طرقًا عامة وخصائص لإنشاء أو تعديل مستند فرعي. في هذا الإصدار لا يمكنك إنشاء عقد [SubDocument](../../com.aspose.words/subdocument/) أو تعديل الموجودة باستثناء حذفها.

[SubDocument](../../com.aspose.words/subdocument/) can only be a child of [Paragraph](../../com.aspose.words/paragraph/).

 **Examples:** 

يوضح كيفية الوصول إلى المستند الفرعي للوثيقة الرئيسية.
...
| [getNodeType()](#getNodeType) | يعيد [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). |
...
يعيد [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT).
...
**Returns:**
int - [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). القيمة المرجعة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
