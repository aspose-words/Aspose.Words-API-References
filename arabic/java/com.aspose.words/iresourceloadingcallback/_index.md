...
description: "نفذ هذه الواجهة إذا كنت ترغب في التحكم في طريقة تحميل Aspose.Words للموارد الخارجية عند استيراد مستند وإدراج صور باستخدام DocumentBuilder في Java."
type: docs
weight: 782
url: /ar/java/com.aspose.words/iresourceloadingcallback/
---
```
public interface IResourceLoadingCallback
```

نفذ هذه الواجهة إذا كنت ترغب في التحكم في طريقة تحميل Aspose.Words للموارد الخارجية عند استيراد مستند وإدراج صور باستخدام [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
| طريقة | الوصف |
| --- | --- |
| [resourceLoading(ResourceLoadingArgs args)](#resourceLoading-com.aspose.words.ResourceLoadingArgs) | يُستدعى عندما يقوم Aspose.Words بتحميل أي مورد خارجي. |
...
يُستدعى عندما يقوم Aspose.Words بتحميل أي مورد خارجي.
