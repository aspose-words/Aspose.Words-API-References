...
description: "ينفّذ الحقل CREATEDATE في Java."
type: docs
weight: 215
url: /ar/java/com.aspose.words/fieldcreatedate/
---
...
ينفّذ حقل CREATEDATE.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يسترجع التاريخ والوقت الذي تم فيه إنشاء المستند. بشكل افتراضي، يُستخدم التقويم الميلادي.
