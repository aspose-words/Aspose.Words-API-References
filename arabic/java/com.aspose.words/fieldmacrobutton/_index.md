...
description: "يطبق حقل MACROBUTTON في Java."
type: docs
weight: 256
url: /ar/java/com.aspose.words/fieldmacrobutton/
---
...
يظهر كيفية استخدام حقول MACROBUTTON للسماح لنا بتشغيل ماكروات المستند بالنقر.
...
| [getDisplayText()](#getDisplayText) | يحصل على النص الذي يظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر. |
...
| [getMacroName()](#getMacroName) | يحصل على اسم الماكرو أو الأمر لتشغيله. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | يضبط النص الذي يظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | يضبط اسم الماكرو أو الأمر لتشغيله. |
...
يحصل على النص الذي يظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر.
...
**Returns:**
java.lang.String - النص الذي يظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر.
### getEnd() {#getEnd}
```
...
يحصل على اسم الماكرو أو الأمر لتشغيله.
...
**Returns:**
java.lang.String - اسم الماكرو أو الأمر لتشغيله.
### getMergeFieldName() {#getMergeFieldName}
```
...
يضبط النص الذي يظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص الذي سيظهر كـ "زر" يتم اختياره لتشغيل الماكرو أو الأمر. |
...
يضبط اسم الماكرو أو الأمر لتشغيله.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم الماكرو أو الأمر لتشغيله. |
