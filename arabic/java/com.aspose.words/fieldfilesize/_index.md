...
description: "يطبق حقل FILESIZE في Java."
type: docs
weight: 231
url: /ar/java/com.aspose.words/fieldfilesize/
---
...
في التنفيذ الحالي، يستخدم خاصية [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) لاسترجاع اسم الملف المستخدم لتحديد حجم الملف.
...
| [isInKilobytes()](#isInKilobytes) | يحصل على ما إذا كان يجب عرض حجم الملف بالكيلوبايت. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | يضبط ما إذا كان يجب عرض حجم الملف بالكيلوبايت. |
| [isInMegabytes()](#isInMegabytes) | يحصل على ما إذا كان يجب عرض حجم الملف بالميغابايت. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | يضبط ما إذا كان يجب عرض حجم الملف بالميغابايت. |
...
يحصل على ما إذا كان يجب عرض حجم الملف بالكيلوبايت.
...
**Returns:**
boolean - ما إذا كان يجب عرض حجم الملف بالكيلوبايت.
...
يضبط ما إذا كان يجب عرض حجم الملف بالكيلوبايت.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب عرض حجم الملف بالكيلوبايت. |
...
يحصل على ما إذا كان يجب عرض حجم الملف بالميغابايت.
...
**Returns:**
boolean - ما إذا كان يجب عرض حجم الملف بالميغابايت.
...
يضبط ما إذا كان يجب عرض حجم الملف بالميغابايت.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب عرض حجم الملف بالميغابايت. |
