...
description: "يمثل نهاية حقل Word في مستند بلغة Java."
type: docs
weight: 229
url: /ar/java/com.aspose.words/fieldend/
---
...
| [getNodeType()](#getNodeType) | يعيد [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). |
...
| [hasSeparator()](#hasSeparator) | يعيد  true  إذا كان لهذا الحقل فاصل. |
...
يستدعي [DocumentVisitor.visitFieldEnd(com.aspose.words.FieldEnd)](../../com.aspose.words/documentvisitor/\#visitFieldEnd-com.aspose.words.FieldEnd).
...
يعيد [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END).
...
**Returns:**
int - [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). القيمة المعادة هي واحدة من ثوابت [NodeType](../../com.aspose.words/nodetype/).
...
يعيد  true  إذا كان لهذا الحقل فاصل.
...
**Returns:**
منطقي -  true  إذا كان لهذا الحقل فاصل.
