...
description: "واجهة عامة لمولد الباركود المخصص في Java."
type: docs
weight: 752
url: /ar/java/com.aspose.words/ibarcodegenerator/
---
```
...
يجب تمرير كائن المولد عبر خاصية [FieldOptions.getBarcodeGenerator()](../../com.aspose.words/fieldoptions/\#getBarcodeGenerator) / [FieldOptions.setBarcodeGenerator(com.aspose.words.IBarcodeGenerator)](../../com.aspose.words/fieldoptions/\#setBarcodeGenerator-com.aspose.words.IBarcodeGenerator).
...
| طريقة | الوصف |
| --- | --- |
| [getBarcodeImage(BarcodeParameters parameters)](#getBarcodeImage-com.aspose.words.BarcodeParameters) | إنشاء صورة باركود باستخدام مجموعة المعلمات (لحقل DisplayBarcode). |
| [getOldBarcodeImage(BarcodeParameters parameters)](#getOldBarcodeImage-com.aspose.words.BarcodeParameters) | إنشاء صورة باركود باستخدام مجموعة المعلمات (لحقل Barcode التقليدي). |
...
إنشاء صورة باركود باستخدام مجموعة المعلمات (لحقل DisplayBarcode).

 **Remarks:** 

تنسيقات الصور المدعومة هي Bmp, Emf, Gif, Jpeg, Png, Tiff, Wmf, Pict, Ico, WebP, Svg.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| parameters | [BarcodeParameters](../../com.aspose.words/barcodeparameters/) | مجموعة المعلمات |

**Returns:**
java.awt.image.BufferedImage - تدفق ببيانات الصورة التي تمثل الباركود المُولد.
...
إنشاء صورة باركود باستخدام مجموعة المعلمات (لحقل Barcode التقليدي).
