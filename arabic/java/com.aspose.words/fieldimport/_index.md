...
description: "ينفّذ حقل IMPORT في Java."
type: docs
weight: 245
url: /ar/java/com.aspose.words/fieldimport/
---
...
يسترجع الصورة الموجودة في المستند.
...
| [getSourceFullName()](#getSourceFullName) | يحصل على موقع الصورة. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | يضبط موقع الصورة. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع الصورة. |
