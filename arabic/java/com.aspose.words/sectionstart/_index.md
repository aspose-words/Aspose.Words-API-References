...
description: "نوع الفاصل في بداية القسم في جافا."
type: docs
weight: 608
url: /ar/java/com.aspose.words/sectionstart/
---
...
| حقل | الوصف |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | يبدأ القسم الجديد في نفس الصفحة التي كان فيها القسم السابق. |
| [EVEN_PAGE](#EVEN-PAGE) | يبدأ القسم في صفحة زوجية جديدة. |
| [NEW_COLUMN](#NEW-COLUMN) | يبدأ القسم من عمود جديد. |
| [NEW_PAGE](#NEW-PAGE) | يبدأ القسم من صفحة جديدة. |
| [ODD_PAGE](#ODD-PAGE) | يبدأ القسم في صفحة فردية جديدة. |
| [length](#length) |  |
## الطرق
...
يبدأ القسم الجديد في نفس الصفحة التي كان فيها القسم السابق.
...
يبدأ القسم في صفحة زوجية جديدة.
...
يبدأ القسم في صفحة فردية جديدة.
