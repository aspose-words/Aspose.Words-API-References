...
description: "يسمح للزائر بالتحكم في تعداد العقد في Java."
type: docs
weight: 716
url: /ar/java/com.aspose.words/visitoraction/
---
...
| حقل | الوصف |
| --- | --- |
| [CONTINUE](#CONTINUE) | الزائر يطلب استمرار التعداد. |
| [SKIP_THIS_NODE](#SKIP-THIS-NODE) | الزائر يطلب تخطي العقدة الحالية ومتابعة التعداد. |
| [STOP](#STOP) | الزائر يطلب إيقاف تعداد العقد. |
| [length](#length) |  |
## الطرق
...
الزائر يطلب تخطي العقدة الحالية ومتابعة التعداد.
