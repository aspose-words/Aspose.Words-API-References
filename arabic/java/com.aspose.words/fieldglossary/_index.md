...
description: "ينفّذ حقل GLOSSARY في جافا."
type: docs
weight: 239
url: /ar/java/com.aspose.words/fieldglossary/
---
...
يدرج إدخالًا في القاموس.

 **Examples:** 

يوضح كيفية عرض كتلة بناء باستخدام حقول AUTOTEXT و GLOSSARY.
...
| [getEntryName()](#getEntryName) | يحصل على اسم إدخال القاموس المراد إدراجه. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | يضبط اسم إدخال القاموس المراد إدراجه. |
...
يحصل على اسم إدخال القاموس المراد إدراجه.
...
**Returns:**
java.lang.String - اسم إدخال القاموس المراد إدراجه.
...
يضبط اسم إدخال القاموس المراد إدراجه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم إدخال القاموس المراد إدراجه. |
