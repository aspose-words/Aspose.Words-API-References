...
description: "يمثل كائن امتداد ويب في Java."
type: docs
weight: 726
url: /ar/java/com.aspose.words/webextension/
---
...
| طريقة | الوصف |
| --- | --- |
| [getAlternateReferences()](#getAlternateReferences) | يحدد مراجع بديلة لامتداد ويب. |
| [getBindings()](#getBindings) | يحدد قائمة بربط امتدادات الويب. |
| [getId()](#getId) | يحدد بشكل فريد نسخة امتداد الويب في المستند الحالي. |
| [getProperties()](#getProperties) | يمثل مجموعة من خصائص امتداد الويب المخصصة. |
| [getReference()](#getReference) | يحدد المرجع الأساسي لملحق ويب. |
| [isFrozen()](#isFrozen) | يحدد ما إذا كان المستخدم يمكنه التفاعل مع ملحق الويب أم لا. |
| [isFrozen(boolean value)](#isFrozen-boolean) | يحدد ما إذا كان المستخدم يمكنه التفاعل مع ملحق الويب أم لا. |
| [setId(String value)](#setId-java.lang.String) | يحدد بشكل فريد نسخة امتداد الويب في المستند الحالي. |
...
يحدد قائمة بربط امتدادات الويب.
...
يحدد بشكل فريد نسخة امتداد الويب في المستند الحالي.
...
يمثل مجموعة من خصائص امتداد الويب المخصصة.
...
يحدد ما إذا كان المستخدم يمكنه التفاعل مع ملحق الويب أم لا.
