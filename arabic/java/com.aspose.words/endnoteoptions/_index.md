...
description: "يمثل خيارات ترقيم الهوامش السفلية لمستند أو قسم في Java."
type: docs
weight: 189
url: /ar/java/com.aspose.words/endnoteoptions/
---
...
يمثل خيارات ترقيم الهوامش السفلية لمستند أو قسم.
...
| [getNumberStyle()](#getNumberStyle) | يحدد تنسيق الرقم للملاحظات الختامية المرقمة تلقائيًا. |
| [getPosition()](#getPosition) | يحدد موضع الملاحظات الختامية. |
| [getRestartRule()](#getRestartRule) | يحدد متى يتم إعادة بدء الترقيم التلقائي. |
| [getStartNumber()](#getStartNumber) | يحدد الرقم أو الحرف الابتدائي للملاحظة الختامية الأولى المرقمة تلقائيًا. |
| [setLocation(int value)](#setLocation-int) |  |
| [setNumberStyle(int value)](#setNumberStyle-int) | يحدد تنسيق الرقم للملاحظات الختامية المرقمة تلقائيًا. |
| [setPosition(int value)](#setPosition-int) | يحدد موضع الملاحظات الختامية. |
| [setRestartRule(int value)](#setRestartRule-int) | يحدد متى يتم إعادة بدء الترقيم التلقائي. |
| [setStartNumber(int value)](#setStartNumber-int) | يحدد الرقم أو الحرف الابتدائي للملاحظة الختامية الأولى المرقمة تلقائيًا. |
### getLocation() {#getLocation}
```
...
يحدد تنسيق الرقم للملاحظات الختامية المرقمة تلقائيًا.
...
**Returns:**
int - القيمة المقابلة من نوع  int . القيمة المرجعة هي واحدة من ثوابت [EndnotePosition](../../com.aspose.words/endnoteposition/).
...
ليس كل القيم قابلة للتطبيق على الملاحظات الختامية. لتحديد القيم القابلة للتطبيق راجع [FootnoteNumberingRule](../../com.aspose.words/footnotenumberingrule/).
...
يحدد الرقم أو الحرف الابتدائي للملاحظة الختامية الأولى المرقمة تلقائيًا.

 **Remarks:** 

هذه الخاصية لها تأثير فقط عندما يتم تعيين [getRestartRule()](../../com.aspose.words/endnoteoptions/\#getRestartRule) / [setRestartRule(int)](../../com.aspose.words/endnoteoptions/\#setRestartRule-int) إلى [FootnoteNumberingRule.CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة المقابلة من نوع  int . يجب أن تكون القيمة واحدة من ثوابت [EndnotePosition](../../com.aspose.words/endnoteposition/). |
