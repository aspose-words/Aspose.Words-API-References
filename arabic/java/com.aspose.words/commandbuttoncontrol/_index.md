...
description: "يقوم عنصر التحكم CommandButton بتشغيل ماكرو ينفذ إجراءً عندما ينقر المستخدم عليه في Java."
type: docs
weight: 107
url: /ar/java/com.aspose.words/commandbuttoncontrol/
---
...
يتحكم عنصر CommandButton في تشغيل ماكرو يقوم بتنفيذ إجراء عندما ينقر المستخدم عليه.
...
| المنشئ | الوصف |
| --- | --- |
| [CommandButtonControl()](#CommandButtonControl) | ينشئ مثيلًا جديدًا من الفئة [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/). |
## الطرق
...
ينشئ مثيلًا جديدًا من الفئة [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/).
