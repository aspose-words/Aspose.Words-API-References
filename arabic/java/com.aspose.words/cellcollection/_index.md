...
description: "توفر وصولًا مكتوبًا إلى مجموعة من عقد Cell في Java."
type: docs
weight: 60
url: /ar/java/com.aspose.words/cellcollection/
---
...
توفر وصولًا مكتوبًا إلى مجموعة من عقد [Cell](../../com.aspose.words/cell/)
...
| [get(int index)](#get-int) | يسترجع [Cell](../../com.aspose.words/cell/) في الفهرس المحدد. |
...
يسترجع [Cell](../../com.aspose.words/cell/) في الفهرس المحدد.
...
ينسخ جميع الخلايا من المجموعة إلى مصفوفة جديدة من الخلايا.
...
**Returns:**
com.aspose.words.Node[] - مصفوفة من الخلايا.
