...
description: "ينفذ حقل TITLE في Java."
type: docs
weight: 296
url: /ar/java/com.aspose.words/fieldtitle/
---
...
يسترجع، ويحدد اختياريًا، عنوان المستند كما هو مسجل في الخاصية **Title** للخصائص المدمجة للمستند.

 **Examples:** 

يعرض كيفية استخدام الحقل TITLE.
...
| [getText()](#getText) | يحصل على نص العنوان. |
...
| [setText(String value)](#setText-java.lang.String) | يضبط نص العنوان. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص العنوان. |
