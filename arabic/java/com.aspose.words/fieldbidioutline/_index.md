...
description: "ينفّذ حقل BIDIOUTLINE في Java."
type: docs
weight: 208
url: /ar/java/com.aspose.words/fieldbidioutline/
---
...
ينفّذ حقل BIDIOUTLINE.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

هذا الحقل مطابق لحقل AUTONUMLGL، باستثناء الفاصل الذي يحدد كل مستوى من ترقيم الفقرات.
