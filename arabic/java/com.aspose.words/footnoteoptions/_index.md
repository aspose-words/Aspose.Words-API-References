...
description: "يمثل خيارات ترقيم الهوامش لمستند أو قسم في Java."
type: docs
weight: 341
url: /ar/java/com.aspose.words/footnoteoptions/
---
...
لمزيد من المعلومات، زر مقالة الوثائق [ Working with Footnote and Endnote ][Working with Footnote and Endnote].

 **Examples:** 

يوضح كيفية تقسيم قسم الهوامش إلى عدد محدد من الأعمدة.
...
يوضح كيفية تغيير نمط رقم علامات الإشارة للهوامش/الحواشي.
...
يوضح كيفية تعيين رقم يبدأ عنده المستند عد الهوامش/الحواشي.
...
| طريقة | الوصف |
| --- | --- |
| [getColumns()](#getColumns) | يحدد عدد الأعمدة التي يتم تنسيق منطقة الهوامش بها. |
| [getLocation()](#getLocation) |  |
| [getNumberStyle()](#getNumberStyle) | يحدد تنسيق الرقم للهوامش المرقمة تلقائيًا. |
| [getPosition()](#getPosition) | يحدد موضع الهوامش. |
| [getRestartRule()](#getRestartRule) | يحدد متى يتم إعادة بدء الترقيم التلقائي. |
| [getStartNumber()](#getStartNumber) | يحدد الرقم أو الحرف الابتدائي للهوامش المرقمة تلقائيًا الأولى. |
| [setColumns(int value)](#setColumns-int) | يحدد عدد الأعمدة التي يتم تنسيق منطقة الهوامش بها. |
| [setLocation(int value)](#setLocation-int) |  |
| [setNumberStyle(int value)](#setNumberStyle-int) | يحدد تنسيق الرقم للهوامش المرقمة تلقائيًا. |
| [setPosition(int value)](#setPosition-int) | يحدد موضع الهوامش. |
| [setRestartRule(int value)](#setRestartRule-int) | يحدد متى يتم إعادة بدء الترقيم التلقائي. |
| [setStartNumber(int value)](#setStartNumber-int) | يحدد الرقم أو الحرف الابتدائي للهوامش المرقمة تلقائيًا الأولى. |
...
يحدد عدد الأعمدة التي يتم تنسيق منطقة الهوامش بها.

 **Remarks:** 

إذا كانت قيمة هذه الخاصية 0، يتم تنسيق منطقة الهوامش بعدد أعمدة يعتمد على عدد الأعمدة في الصفحة المعروضة. القيمة الافتراضية هي 0.
...
يحدد تنسيق الرقم للهوامش المرقمة تلقائيًا.

 **Remarks:** 

ليس كل أنماط الأرقام قابلة للتطبيق على هذه الخاصية. للحصول على قائمة الأنماط القابلة للتطبيق، راجع مربع حوار إدراج هامش أو حاشية في Microsoft Word. إذا اخترت نمط رقم غير قابل للتطبيق، سيعود Microsoft Word إلى القيمة الافتراضية.
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [NumberStyle](../../com.aspose.words/numberstyle/).
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [FootnotePosition](../../com.aspose.words/footnoteposition/).
...
يحدد متى يتم إعادة بدء الترقيم التلقائي.
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [FootnoteNumberingRule](../../com.aspose.words/footnotenumberingrule/).
...
يحدد الرقم أو الحرف الابتدائي للهوامش المرقمة تلقائيًا الأولى.

 **Remarks:** 

هذه الخاصية لها تأثير فقط عندما يتم تعيين [getRestartRule()](../../com.aspose.words/footnoteoptions/\#getRestartRule) / [setRestartRule(int)](../../com.aspose.words/footnoteoptions/\#setRestartRule-int) إلى [FootnoteNumberingRule.CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة int المقابلة. يجب أن تكون القيمة واحدة من ثوابت [NumberStyle](../../com.aspose.words/numberstyle/). |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة الصحيحة المقابلة. يجب أن تكون القيمة واحدة من ثوابت [FootnotePosition](../../com.aspose.words/footnoteposition/). |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة الصحيحة المقابلة. يجب أن تكون القيمة واحدة من ثوابت [FootnoteNumberingRule](../../com.aspose.words/footnotenumberingrule/). |
