...
description: "يمثل كائن لوحة مهام إضافية في Java."
type: docs
weight: 663
url: /ar/java/com.aspose.words/taskpane/
---
...
| طريقة | الوصف |
| --- | --- |
| [getDockState()](#getDockState) | يحدد الموقع الأخير المثبت لهذا كائن لوحة المهام. |
| [getRow()](#getRow) | يحدد الفهرس، بدءًا من الخارج إلى الداخل، لهذه اللوحة بين لوحات المهام الأخرى المستمرة المثبتة في نفس الموقع الافتراضي. |
| [getWebExtension()](#getWebExtension) | يمثل كائن امتداد ويب. |
| [getWidth()](#getWidth) | يحدد قيمة العرض الافتراضية لهذه اللوحة. |
| [isLocked()](#isLocked) | يحدد ما إذا كانت لوحة المهام مقفلة على المستند في واجهة المستخدم ولا يمكن إغلاقها من قبل المستخدم. |
| [isLocked(boolean value)](#isLocked-boolean) | يحدد ما إذا كانت لوحة المهام مقفلة على المستند في واجهة المستخدم ولا يمكن إغلاقها من قبل المستخدم. |
| [isVisible()](#isVisible) | يحدد ما إذا كانت لوحة المهام تظهر مرئية افتراضيًا عند فتح المستند. |
| [isVisible(boolean value)](#isVisible-boolean) | يحدد ما إذا كانت لوحة المهام تظهر مرئية افتراضيًا عند فتح المستند. |
| [setDockState(int value)](#setDockState-int) | يحدد الموقع الأخير المثبت لهذا كائن لوحة المهام. |
| [setRow(int value)](#setRow-int) | يحدد الفهرس، بدءًا من الخارج إلى الداخل، لهذه اللوحة بين لوحات المهام الأخرى المستمرة المثبتة في نفس الموقع الافتراضي. |
| [setWidth(double value)](#setWidth-double) | يحدد قيمة العرض الافتراضية لهذه اللوحة. |
...
يحدد الموقع الأخير المثبت لهذا كائن لوحة المهام.
...
**Returns:**
int - القيمة int المقابلة. القيمة المرجعة هي واحدة من ثوابت [TaskPaneDockState](../../com.aspose.words/taskpanedockstate/).
### getRow() {#getRow}
```
public int getRow()
```
...
يحدد الفهرس، بدءًا من الخارج إلى الداخل، لهذه اللوحة بين لوحات المهام الأخرى المستمرة المثبتة في نفس الموقع الافتراضي.
...
يحدد قيمة العرض الافتراضية لهذه اللوحة.
...
يحدد ما إذا كانت لوحة المهام تظهر مرئية افتراضيًا عند فتح المستند.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| value | int | القيمة int المقابلة. يجب أن تكون القيمة واحدة من ثوابت [TaskPaneDockState](../../com.aspose.words/taskpanedockstate/). |
