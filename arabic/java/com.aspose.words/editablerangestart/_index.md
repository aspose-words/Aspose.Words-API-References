...
description: "يمثل بداية نطاق قابل للتحرير في مستند Word في جافا."
type: docs
weight: 181
url: /ar/java/com.aspose.words/editablerangestart/
---
...
يتكون نطاق قابل للتحرير كامل في مستند Word من [EditableRangeStart](../../com.aspose.words/editablerangestart/) و[EditableRangeEnd](../../com.aspose.words/editablerangeend/) متطابقين يحملان نفس المعرف.
...
استخدم الفئة [getEditableRange()](../../com.aspose.words/editablerangestart/\#getEditableRange) كـ \"واجهة\" للعمل مع نطاق قابل للتحرير ككائن واحد.
...
| [getEditableRange()](#getEditableRange) | يحصل على كائن الواجهة الذي يضم بداية ونهاية هذا النطاق القابل للتحرير. |
...
| [getNodeType()](#getNodeType) | يرجع [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). |
...
ينادي [DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor/\#visitEditableRangeStart-com.aspose.words.EditableRangeStart).
...
يرجع [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START).
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). القيمة المرجعة هي إحدى ثوابت [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
