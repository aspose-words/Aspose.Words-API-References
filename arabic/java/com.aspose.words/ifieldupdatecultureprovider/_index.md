...
description: "عند التنفيذ، يوفر كائن CultureInfo يجب استخدامه أثناء تحديث حقل معين في Java."
type: docs
weight: 767
url: /ar/java/com.aspose.words/ifieldupdatecultureprovider/
---
```
public interface IFieldUpdateCultureProvider
```

عند التنفيذ، يوفر كائن [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) يجب استخدامه أثناء تحديث حقل معين.
...
| طريقة | الوصف |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | يعيد كائن [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) لاستخدامه أثناء تحديث الحقل. |
...
يعيد كائن [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) لاستخدامه أثناء تحديث الحقل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| الثقافة | java.lang.String | اسم الثقافة المطلوبة للحقل الذي يتم تحديثه. |
| field | [Field](../../com.aspose.words/field/) | الحقل الذي يتم تحديثه. |
