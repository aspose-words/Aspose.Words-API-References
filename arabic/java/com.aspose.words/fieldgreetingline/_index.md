...
description: "ينفّذ حقل GREETINGLINE في Java."
type: docs
weight: 241
url: /ar/java/com.aspose.words/fieldgreetingline/
---
...
ينفّذ حقل GREETINGLINE.

لمزيد من المعلومات، زر مقالة الوثائق [ Working with Fields ][Working with Fields].

 **Remarks:** 

يدرج سطر تحية دمج البريد.

 **Examples:** 

يظهر كيفية إدراج حقل GREETINGLINE.
...
| طريقة | الوصف |
| --- | --- |
| [getAlternateText()](#getAlternateText) | يحصل على النص لتضمينه في الحقل إذا كان الاسم فارغًا. |
...
| [getLanguageId()](#getLanguageId) | يحصل على معرف اللغة المستخدم لتنسيق الاسم. |
| [getLocaleId()](#getLocaleId) | يحصل على معرف اللغة (LCID) للحقل. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | يحصل على تنسيق الاسم المضمن في الحقل. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | يضبط النص لتضمينه في الحقل إذا كان الاسم فارغًا. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | يضبط معرف اللغة المستخدم لتنسيق الاسم. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | يضبط تنسيق الاسم المضمن في الحقل. |
...
يحصل على النص لتضمينه في الحقل إذا كان الاسم فارغًا.
...
**Returns:**
java.lang.String - النص لتضمينه في الحقل إذا كان الاسم فارغًا.
...
يحصل على معرف اللغة المستخدم لتنسيق الاسم.
...
**Returns:**
java.lang.String - معرف اللغة المستخدم لتنسيق الاسم.
...
يحصل على تنسيق الاسم المضمن في الحقل.
...
**Returns:**
java.lang.String - تنسيق الاسم المضمن في الحقل.
### getResult() {#getResult}
```
...
يضبط النص لتضمينه في الحقل إذا كان الاسم فارغًا.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | النص لتضمينه في الحقل إذا كان الاسم فارغًا. |
...
يضبط معرف اللغة المستخدم لتنسيق الاسم.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرف اللغة المستخدم لتنسيق الاسم. |
...
يضبط تنسيق الاسم المضمن في الحقل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | تنسيق الاسم المضمن في الحقل. |
