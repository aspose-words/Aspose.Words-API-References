...
description: "ينفّذ حقل TC في Java."
type: docs
weight: 293
url: /ar/java/com.aspose.words/fieldtc/
---
...
يحدد النص ورقم الصفحة لإدخال جدول المحتويات (بما في ذلك جدول الأشكال)، والذي يُستخدم بواسطة حقل TOC.
...
| [getEntryLevel()](#getEntryLevel) | يحصل على مستوى الإدخال. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | يحصل على ما إذا كان يجب حذف رقم الصفحة في TOC لهذا الحقل. |
...
| [getText()](#getText) | يحصل على نص الإدخال. |
| [getType()](#getType) | يحصل على نوع حقل Microsoft Word. |
| [getTypeIdentifier()](#getTypeIdentifier) | يحصل على معرف نوع لهذا الحقل (عادةً ما يكون حرفًا). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | يضبط مستوى الإدخال. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | يضبط ما إذا كان يجب حذف رقم الصفحة في TOC لهذا الحقل. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setText(String value)](#setText-java.lang.String) | يضبط نص الإدخال. |
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | يضبط معرف نوع لهذا الحقل (عادةً ما يكون حرفًا). |
...
**Returns:**
java.lang.String - مستوى الإدخال.
...
يحصل على ما إذا كان يجب حذف رقم الصفحة في TOC لهذا الحقل.
...
**Returns:**
boolean - ما إذا كان يجب حذف رقم الصفحة في TOC لهذا الحقل.
### getPageNumber() {#getPageNumber}
```
...
يحصل على معرف نوع لهذا الحقل (عادةً ما يكون حرفًا).
...
**Returns:**
java.lang.String - معرف نوع لهذا الحقل (عادةً ما يكون حرفًا).
### hasBookmark() {#hasBookmark}
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | مستوى الإدخال. |
...
يضبط ما إذا كان يجب حذف رقم الصفحة في TOC لهذا الحقل.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب حذف رقم الصفحة في جدول المحتويات لهذا الحقل. |
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص المدخل. |
...
يضبط معرف نوع لهذا الحقل (عادةً ما يكون حرفًا).
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | معرف نوع لهذا الحقل (عادةً ما يكون حرفًا). |
