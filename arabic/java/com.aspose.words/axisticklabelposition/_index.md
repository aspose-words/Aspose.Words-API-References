...
description: "يحدد المواقع الممكنة لتسميات العلامات في Java."
type: docs
weight: 30
url: /ar/java/com.aspose.words/axisticklabelposition/
---
...
يحدد المواقع الممكنة لتسميات العلامات.
...
| حقل | الوصف |
| --- | --- |
| [DEFAULT](#DEFAULT) | يحدد القيمة الافتراضية لموضع تسميات العلامات. |
| [HIGH](#HIGH) | يحدد أن تسميات المحور ستكون في الطرف العلوي من المحور المتعامد. |
| [LOW](#LOW) | يحدد أن تسميات المحور ستكون في الطرف السفلي من المحور المتعامد. |
| [NEXT_TO_AXIS](#NEXT-TO-AXIS) | يحدد أن تسميات المحور ستكون بجوار المحور. |
| [NONE](#NONE) | يحدد أن تسميات المحور لا تُرسم. |
| [length](#length) |  |
## الطرق
...
يحدد القيمة الافتراضية لموضع تسميات العلامات.
...
يحدد أن تسميات المحور ستكون في الطرف العلوي من المحور المتعامد.
...
يحدد أن تسميات المحور ستكون في الطرف السفلي من المحور المتعامد.
...
يحدد أن تسميات المحور ستكون بجوار المحور.
...
يحدد أن تسميات المحور لا تُرسم.
