...
description: "ينفذ حقل HYPERLINK في Java."
type: docs
weight: 242
url: /ar/java/com.aspose.words/fieldhyperlink/
---
...
عند الاختيار، يتسبب في قفز التحكم إلى الموقع مثل إشارة مرجعية أو عنوان URL.

 **Examples:** 

يوضح كيفية استخدام حقول HYPERLINK لربط المستندات بنظام الملفات المحلي.
...
| طريقة | الوصف |
| --- | --- |
| [getAddress()](#getAddress) | يحصل على موقع القفز لهذا الارتباط التشعبي. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | يحصل على ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة. |
| [getResult()](#getResult) | يحصل على النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [getScreenTip()](#getScreenTip) | يحصل على نص تلميح الشاشة للرابط التشعبي. |
...
| [getSubAddress()](#getSubAddress) | يحصل على موقع في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | يحصل على الهدف الذي يجب إعادة توجيه الرابط إليه. |
...
| [isImageMap()](#isImageMap) | يحصل على ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم. |
| [isImageMap(boolean value)](#isImageMap-boolean) | يضبط ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | يضبط موقعًا ينتقل إليه هذا الرابط التشعبي. |
| [setLocaleId(int value)](#setLocaleId-int) | يضبط LCID الخاص بالحقل. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | يضبط ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة. |
| [setResult(String value)](#setResult-java.lang.String) | يضبط النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | يضبط نص تلميح الشاشة للرابط التشعبي. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | يضبط موقعًا في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي. |
| [setTarget(String value)](#setTarget-java.lang.String) | يضبط الهدف الذي يجب إعادة توجيه الرابط إليه. |
...
يحصل على موقع القفز لهذا الارتباط التشعبي.
...
**Returns:**
java.lang.String - موقع ينتقل إليه هذا الرابط التشعبي.
...
يحصل على ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة.
...
**Returns:**
boolean - ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة.
### getResult() {#getResult}
```
...
يحصل على نص تلميح الشاشة للرابط التشعبي.
...
**Returns:**
java.lang.String - نص تلميح الشاشة للرابط التشعبي.
...
يحصل على موقع في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي.
...
**Returns:**
java.lang.String - موقع في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
يحصل على الهدف الذي يجب إعادة توجيه الرابط إليه.
...
**Returns:**
java.lang.String - الهدف الذي يجب إعادة توجيه الرابط إليه.
### getType() {#getType}
```
public int getType()
```
...
يحصل على ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم.
...
**Returns:**
boolean - ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم.
...
يضبط ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم. |
...
يضبط موقعًا ينتقل إليه هذا الرابط التشعبي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع ينتقل إليه هذا الرابط التشعبي. |
...
يضبط ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | boolean | ما إذا كان يجب فتح الموقع الوجهة في نافذة متصفح ويب جديدة. |
...
يضبط نص تلميح الشاشة للرابط التشعبي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | نص تلميح الشاشة للرابط التشعبي. |
...
يضبط موقعًا في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | موقع في الملف، مثل إشارة مرجعية، حيث ينتقل هذا الرابط التشعبي. |
...
يضبط الهدف الذي يجب إعادة توجيه الرابط إليه.
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | الهدف الذي يجب إعادة توجيه الرابط إليه. |
