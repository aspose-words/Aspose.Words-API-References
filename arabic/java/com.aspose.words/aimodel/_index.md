...
description: "فئة مجردة تمثل التكامل مع نماذج الذكاء الاصطناعي المختلفة داخل Aspose.Words في Java."
type: docs
weight: 14
url: /ar/java/com.aspose.words/aimodel/
---
...
فئة تجريدية تمثل التكامل مع نماذج AI المختلفة داخل Aspose.Words.
...
يحصل على عنوان URL للنموذج. القيمة الافتراضية مخصصة لهذا النموذج.
...
يوضح كيفية تغيير عنوان URL الافتراضي للنموذج.
...
يضبط عنوان URL للنموذج. القيمة الافتراضية مخصصة لهذا النموذج.
