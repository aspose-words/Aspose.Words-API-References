...
description: "يوفر طرقًا لتصوير OfficeMath فردي إلى صورة نقطية أو متجهة أو إلى كائن Graphics في Java."
type: docs
weight: 499
url: /ar/java/com.aspose.words/officemathrenderer/
---
...
يوفر طرقًا لتصوير [OfficeMath](../../com.aspose.words/officemath/) فردي إلى صورة نقطية أو متجهة أو إلى كائن Graphics.

لمزيد من المعلومات، قم بزيارة مقالة الوثائق [ Working with OfficeMath ][Working with OfficeMath].
...
| المنشئ | الوصف |
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | يقوم بتهيئة نسخة جديدة من هذه الفئة. |
## الطرق
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | الكائن [OfficeMath](../../com.aspose.words/officemath/) الذي تريد عرضه. |
