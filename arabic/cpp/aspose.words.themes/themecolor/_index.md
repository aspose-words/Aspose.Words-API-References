---
title: "Aspose::Words::Themes::ThemeColor تعداد"
linktitle: "ThemeColor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Themes::ThemeColor تعداد. يحدد ألوان السمة لمظاهر المستند. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.themes/themecolor/
---
## ThemeColor enum


يحدد ألوان السمة لسيمات المستند. لمعرفة المزيد، زر مقالة الوثائق [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
