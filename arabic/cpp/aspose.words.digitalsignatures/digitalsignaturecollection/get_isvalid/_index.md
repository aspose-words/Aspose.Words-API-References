...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid method. تُرجِع true إذا كانت جميع التوقيعات الرقمية في هذه المجموعة صالحة ولم يتم العبث بالمستند. كما تُرجِع true إذا لم توجد توقيعات رقمية. تُرجِع false إذا كان هناك توقيع رقمي واحد على الأقل غير صالح في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/get_isvalid/
---
