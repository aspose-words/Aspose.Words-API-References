...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::idx_get method. يحصل على توقيع المستند في الفهرس المحدد في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/idx_get/
---
## DigitalSignatureCollection::idx_get method


يحصل على توقيع المستند عند الفهرس المحدد.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| index | int32_t | الفهرس الصفري للتوقيع. |
