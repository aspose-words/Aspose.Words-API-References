...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureType enum. يحدد نوع التوقيع الرقمي في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.digitalsignatures/digitalsignaturetype/
---
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| غير معروف | 0 | يشير إلى خطأ، نوع توقيع رقمي غير معروف. |
| CryptoApi | 1 | طريقة توقيع Crypto API المستخدمة في مستندات .DOC الثنائية لبرنامج Microsoft Word 97-2003. |
