...
description: "طريقة Aspose::Words::Properties::BuiltInDocumentProperties::get_Template. تحصل أو تعين الاسم الإعلامي لقالب المستند في C++."
type: docs
weight: 27000
url: /ar/cpp/aspose.words.properties/builtindocumentproperties/get_template/
---
## BuiltInDocumentProperties::get_Template method


يحصل أو يضبط الاسم الإعلامي لقالب المستند.
...
في Microsoft Word، هذه الخاصية مخصصة لأغراض إعلامية فقط وعادةً ما تحتوي فقط على اسم ملف القالب دون المسار.

السلسلة الفارغة تعني أن المستند مرفق بالقالب Normal.

للحصول على الاسم الفعلي للقالب المرفق أو لتعيينه، استخدم الخاصية [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/).
