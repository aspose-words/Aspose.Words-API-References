---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_CreatedTime طريقة"
linktitle: "get_CreatedTime"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_CreatedTime طريقة. يحصل أو يضبط تاريخ إنشاء المستند بتوقيت UTC في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.properties/builtindocumentproperties/get_createdtime/
---
## BuiltInDocumentProperties::get_CreatedTime method


يحصل أو يضبط تاريخ إنشاء المستند بتوقيت UTC.
...
بالنسبة للمستندات التي نشأت من تنسيق RTF، تُعيد هذه الخاصية الوقت المحلي لجهاز المؤلف في لحظة إنشاء المستند.
