---
title: "طريقة Aspose::Words::Properties::CustomDocumentProperties::Add"
linktitle: "Add"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Properties::CustomDocumentProperties::Add. ينشئ خاصية مستند مخصصة جديدة من نوع البيانات Boolean في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.properties/customdocumentproperties/add/
---
## CustomDocumentProperties::Add(const System::String\&, bool) method


ينشئ خاصية مستند مخصصة جديدة من نوع البيانات [Boolean](../../propertytype/).
...
ينشئ خاصية مستند مخصصة جديدة من نوع البيانات [String](../../propertytype/).
...
| --- | --- | --- |
| name | const System::String\& | اسم الخاصية. |
| value | const System::String\& | قيمة الخاصية. |
...
ينشئ خاصية مستند مخصصة جديدة من نوع البيانات [Double](../../propertytype/).
...
ينشئ خاصية مستند مخصصة جديدة من نوع البيانات [Number](../../propertytype/).
...
ينشئ خاصية مستند مخصصة جديدة من نوع البيانات [DateTime](../../propertytype/).
...
| --- | --- | --- |
| name | const System::String\& | اسم الخاصية. |
| value | System::DateTime | قيمة الخاصية. |
