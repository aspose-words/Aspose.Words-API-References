...
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit class. يوفر الوصول إلى خيارات التحجيم لوحدات العرض لمحور القيم. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


يوفر الوصول إلى خيارات التحجيم لوحدات العرض للمحور القيمي. لمعرفة المزيد، زر مقالة الوثائق [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | يحصل أو يضبط مقسماً معرفاً من قبل المستخدم لتقليص وحدات العرض على محور القيم. |
| [get_Document](./get_document/)() | يرجع المستند الذي يحتوي على المخطط الأب. |
| [get_Unit](./get_unit/)() const | يحصل أو يضبط قيمة التحجيم لوحدات العرض كإحدى القيم المعرفة مسبقاً. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | دالة تعيين لـ [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | دالة تعيين لـ [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
