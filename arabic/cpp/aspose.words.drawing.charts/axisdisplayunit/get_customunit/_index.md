---
title: "طريقة Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit"
linktitle: "get_CustomUnit"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit. تحصل أو تعيّن مقسّمًا معرفًا من قبل المستخدم لتقليل وحدات العرض على محور القيم في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


يحصل أو يضبط مقسماً معرفاً من قبل المستخدم لتقليص وحدات العرض على محور القيم.
...
تعيين هذه الخاصية يضبط خاصية [Unit](../get_unit/) إلى [Custom](../../axisbuiltinunit/).
