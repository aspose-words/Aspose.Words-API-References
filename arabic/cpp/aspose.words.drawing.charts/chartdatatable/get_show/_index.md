---
title: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_Show"
linktitle: "get_Show"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_Show. يحصل على أو يضبط علامة تشير إلى ما إذا كان جدول البيانات سيظهر للمخطط. القيمة الافتراضية هي false في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.drawing.charts/chartdatatable/get_show/
---
## ChartDataTable::get_Show method


يحصل أو يعيّن علامة تشير إلى ما إذا كان سيتم عرض جدول البيانات للمخطط. القيمة الافتراضية هي **false**.
