---
title: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder"
linktitle: "get_HasVerticalBorder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder. يحصل على أو يضبط علامة تشير إلى ما إذا كان الحد العمودي لجدول البيانات معروضًا. القيمة الافتراضية هي true في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.drawing.charts/chartdatatable/get_hasverticalborder/
---
## ChartDataTable::get_HasVerticalBorder method


يحصل أو يعيّن علامة تشير إلى ما إذا كان الحد العمودي لجدول البيانات معروضًا. القيمة الافتراضية هي **true**.
