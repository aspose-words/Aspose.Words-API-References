---
title: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder"
linktitle: "get_HasOutlineBorder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder. يحصل على أو يضبط علامة تشير إلى ما إذا كان حدًا خارجيًا، أي حدًا حول أسماء السلاسل والفئات، معروضًا. القيمة الافتراضية هي true في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.drawing.charts/chartdatatable/get_hasoutlineborder/
---
## ChartDataTable::get_HasOutlineBorder method


يحصل أو يعيّن علامة تشير إلى ما إذا كان الحد الخارجي، أي الحد حول أسماء السلاسل والفئات، معروضًا. القيمة الافتراضية هي **true**.
