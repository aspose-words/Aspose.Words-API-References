---
title: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder"
linktitle: "get_HasHorizontalBorder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder. يحصل على أو يضبط علامة تشير إلى ما إذا كان الحد الأفقي لجدول البيانات معروضًا. القيمة الافتراضية هي true في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.drawing.charts/chartdatatable/get_hashorizontalborder/
---
## ChartDataTable::get_HasHorizontalBorder method


يحصل أو يعيّن علامة تشير إلى ما إذا كان الحد الأفقي لجدول البيانات معروضًا. القيمة الافتراضية هي **true**.
