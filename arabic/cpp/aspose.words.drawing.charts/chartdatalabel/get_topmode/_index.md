---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode طريقة"
linktitle: "get_TopMode"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode طريقة. يحصل أو يضبط وضع تفسير قيمة الخاصية Top: ما إذا كان يحدد موقع تسمية البيانات من الحافة العلوية للمخطط أو من الموضع المحدد بواسطة خاصية Position الخاصة به في C++."
type: docs
weight: 16667
url: /ar/cpp/aspose.words.drawing.charts/chartdatalabel/get_topmode/
---
## ChartDataLabel::get_TopMode method


يحصل أو يضبط وضع تفسير قيمة الخاصية [Top](../get_top/) : ما إذا كان يحدد موقع تسمية البيانات من الحافة العلوية للمخطط أو من الموضع المحدد بواسطة خاصية [Position](../get_position/) الخاصة به.
