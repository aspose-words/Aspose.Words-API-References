---
title: "طريقة Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left"
linktitle: "get_Left"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left. يحصل أو يضبط مسافة تسمية البيانات بالنقاط من الحافة اليسرى للمخطط أو من الموضع المحدد بواسطة خاصية Position الخاصة به، اعتمادًا على قيمة خاصية LeftMode في C++."
type: docs
weight: 6334
url: /ar/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


يحصل أو يضبط مسافة تسمية البيانات بالنقاط من الحافة اليسرى للمخطط أو من الموضع المحدد بواسطة خاصية [Position](../get_position/) الخاصة به، اعتمادًا على قيمة خاصية [LeftMode](../get_leftmode/).
