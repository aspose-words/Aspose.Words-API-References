...
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition enum. يحدد المواقع الممكنة لتسميات العلامات في C++."
type: docs
weight: 24000
url: /ar/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| High | 0 | يحدد أن تسميات المحور ستكون في الطرف العلوي للمحور المتعامد. |
| Low | 1 | يحدد أن تسميات المحور ستكون في الطرف السفلي للمحور المتعامد. |
| NextToAxis | 2 | يحدد أن تسميات المحور ستكون بجوار المحور. |
| None | 3 | يحدد أن تسميات المحور غير مرسومة. |
| افتراضي | n/a | يحدد القيمة الافتراضية لموقع تسميات العلامات. |
