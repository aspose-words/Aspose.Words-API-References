---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat طريقة"
linktitle: "get_NumberFormat"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat طريقة. يحصل على مثيل ChartNumberFormat يسمح بتعيين تنسيق الأرقام لتسميات البيانات للسلسلة بأكملها في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_numberformat/
---
## ChartDataLabelCollection::get_NumberFormat method


يحصل على مثيل [ChartNumberFormat](../../chartnumberformat/) يسمح بتعيين تنسيق الأرقام لتسميات البيانات للسلسلة بأكملها.
