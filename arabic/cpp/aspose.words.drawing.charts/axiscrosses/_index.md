---
title: "تعداد Aspose::Words::Drawing::Charts::AxisCrosses"
linktitle: "AxisCrosses"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "تعداد Aspose::Words::Drawing::Charts::AxisCrosses. يحدد نقاط التقاطع الممكنة للمحور في C++."
type: docs
weight: 22000
url: /ar/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| تلقائي | 0 | يتقاطع محور الفئة عند نقطة الصفر للمحور القيمي (إن أمكن)، أو عند القيمة الصغرى إذا كانت الصغرى أكبر من الصفر، أو عند القيمة العظمى إذا كانت العظمى أقل من الصفر. |
| الأقصى | 1 | يتقاطع محور عمودي عند القيمة العظمى للمحور. |
| الحد الأدنى | 2 | يتقاطع محور عمودي عند القيمة الصغرى للمحور. |
| مخصص | 3 | يتقاطع محور عمودي عند القيمة المحددة للمحور. |
