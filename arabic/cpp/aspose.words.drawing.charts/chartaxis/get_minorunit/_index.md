---
title: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit"
linktitle: "get_MinorUnit"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit. تُرجع أو تُعيّن المسافة بين علامات الفواصل الثانوية في C++."
type: docs
weight: 17000
url: /ar/cpp/aspose.words.drawing.charts/chartaxis/get_minorunit/
---
## ChartAxis::get_MinorUnit method


يرجع أو يعيّن المسافة بين العلامات الفرعية.
...
النطاق الصالح للقيمة هو أكبر من الصفر. الخاصية لها تأثير على محاور الفئة الزمنية والقيمة.

ضبط هذه الخاصية يضبط الخاصية [MinorUnitIsAuto](../get_minorunitisauto/) إلى **false**.
