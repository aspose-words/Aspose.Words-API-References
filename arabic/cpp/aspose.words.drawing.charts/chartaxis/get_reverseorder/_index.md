---
title: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder"
linktitle: "get_ReverseOrder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder. تُرجع أو تعيّن علامة تشير إلى ما إذا كان يجب عرض قيم المحور بترتيب عكسي، أي من الحد الأقصى إلى الحد الأدنى في C++."
type: docs
weight: 21000
url: /ar/cpp/aspose.words.drawing.charts/chartaxis/get_reverseorder/
---
## ChartAxis::get_ReverseOrder method


يرجع أو يعيّن علمًا يشير إلى ما إذا كان يجب عرض قيم المحور بترتيب عكسي، أي من الحد الأقصى إلى الحد الأدنى.
