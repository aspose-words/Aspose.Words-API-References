---
title: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto"
linktitle: "get_MajorUnitIsAuto"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto. تُرجع أو تعيّن علامة تشير إلى ما إذا كان يجب استخدام المسافة الافتراضية بين علامات الفواصل الرئيسية في C++."
type: docs
weight: 14000
url: /ar/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitisauto/
---
## ChartAxis::get_MajorUnitIsAuto method


يحصل أو يعيّن علمًا يشير إلى ما إذا كان يجب استخدام المسافة الافتراضية بين العلامات الرئيسية.
