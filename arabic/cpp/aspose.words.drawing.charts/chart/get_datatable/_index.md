---
title: "طريقة Aspose::Words::Drawing::Charts::Chart::get_DataTable"
linktitle: "get_DataTable"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::Chart::get_DataTable. توفر الوصول إلى خصائص جدول البيانات لهذا المخطط. يمكن إظهار جدول البيانات باستخدام خاصية Show في C++."
type: docs
weight: 4500
url: /ar/cpp/aspose.words.drawing.charts/chart/get_datatable/
---
## Chart::get_DataTable method


توفر الوصول إلى خصائص جدول البيانات لهذا المخطط. يمكن إظهار جدول البيانات باستخدام خاصية [Show](../../chartdatatable/get_show/).
