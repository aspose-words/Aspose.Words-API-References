---
title: "Aspose::Words::Drawing::Charts::AxisCategoryType تعداد"
...
type: docs
weight: 21000
url: /ar/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| تلقائي | 0 | يحدد أن نوع محور الفئة يتم تحديده تلقائيًا بناءً على البيانات. |
| فئة | 1 | يحدد محورًا لمجموعة عشوائية من الفئات. |
| وقت | 2 | يحدد محور فئة زمنية. |
