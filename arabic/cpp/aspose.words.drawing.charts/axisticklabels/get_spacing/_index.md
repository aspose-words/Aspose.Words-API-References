---
title: "طريقة Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing"
linktitle: "get_Spacing"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing. يسترجع أو يعيّن الفاصل الزمني الذي تُرسم عنده تسميات العلامة في C++."
type: docs
weight: 9000
url: /ar/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


يحصل أو يضبط الفاصل الزمني الذي تُرسم فيه تسميات العلامات.
...
الخاصية لها تأثير على محاور فئة النص والسلاسل. لا يدعمها المخططات الجديدة في MS Office 2016. النطاق الصالح للقيمة هو أكبر من أو يساوي 1.

تعيين هذه الخاصية يضبط الخاصية [IsAutoSpacing](../get_isautospacing/) إلى **false**.
