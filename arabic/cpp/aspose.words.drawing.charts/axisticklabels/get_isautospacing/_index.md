---
title: "طريقة Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing"
linktitle: "get_IsAutoSpacing"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing. يسترجع أو يعيّن علامة تشير إلى ما إذا كان يجب استخدام الفاصل الزمني التلقائي لرسم تسميات العلامة في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.drawing.charts/axisticklabels/get_isautospacing/
---
## AxisTickLabels::get_IsAutoSpacing method


يحصل أو يضبط علامة تشير إلى ما إذا كان يجب استخدام الفاصل الزمني التلقائي لرسم تسميات العلامات.
...
الخاصية لها تأثير على محاور فئة النص والسلاسل. لا يدعمها المخططات الجديدة في MS Office 2016.
