---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels فئة"
linktitle: "AxisTickLabels"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels فئة. تمثل خصائص تسميات علامات المحور في C++."
type: docs
weight: 3250
url: /ar/cpp/aspose.words.drawing.charts/axisticklabels/
---
## AxisTickLabels class


يمثل خصائص تسميات علامات الفواصل للمحور.
...
| طريقة | الوصف |
| --- | --- |
| [get_Alignment](./get_alignment/)() | يحصل أو يضبط محاذاة النص لتسميات علامات المحور. |
| [get_Font](./get_font/)() | يوفر الوصول إلى تنسيق الخط لتسميات العلامات. |
| [get_IsAutoSpacing](./get_isautospacing/)() | يحصل أو يضبط علامة تشير إلى ما إذا كان يجب استخدام الفاصل الزمني التلقائي لرسم تسميات العلامات. |
| [get_Offset](./get_offset/)() | يحصل أو يضبط المسافة بين تسميات العلامات والمحور. |
| [get_Orientation](./get_orientation/)() | يحصل أو يضبط اتجاه نص تسمية العلامة. |
| [get_Position](./get_position/)() | يحصل أو يضبط موضع تسميات العلامات على المحور. |
| [get_Rotation](./get_rotation/)() | يحصل أو يضبط دوران تسميات العلامات بالدرجات. |
| [get_Spacing](./get_spacing/)() | يحصل أو يضبط الفاصل الزمني الذي تُرسم فيه تسميات العلامات. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Alignment](./set_alignment/)(Aspose::Words::ParagraphAlignment) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Alignment](./get_alignment/). |
| [set_IsAutoSpacing](./set_isautospacing/)(bool) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing](./get_isautospacing/). |
| [set_Offset](./set_offset/)(int32_t) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Offset](./get_offset/). |
| [set_Orientation](./set_orientation/)(Aspose::Words::Drawing::ShapeTextOrientation) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Orientation](./get_orientation/). |
| [set_Position](./set_position/)(Aspose::Words::Drawing::Charts::AxisTickLabelPosition) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Position](./get_position/). |
| [set_Rotation](./set_rotation/)(int32_t) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Rotation](./get_rotation/). |
| [set_Spacing](./set_spacing/)(int32_t) | مُعيّن لـ [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing](./get_spacing/). |
| static [Type](./type/)() |  |
