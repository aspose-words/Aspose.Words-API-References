...
description: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode enum. يحدد كيفية تفسير القيم التي تحدد موقع ملصق البيانات - الخاصيتين Left و Top - في C++."
type: docs
weight: 27167
url: /ar/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


يحدد كيفية تفسير القيم التي تحدد موقع ملصق البيانات - الخاصيتين [Left](../chartdatalabel/get_left/) و [Top](../chartdatalabel/get_top/) -.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Offset | 0 | يتم تحديد موقع ملصق البيانات بواسطة إزاحة من الموضع المحدد بواسطة خاصية [Position](../chartdatalabel/get_position/). |
| مطلق | 1 | يتم تحديد موقع ملصق البيانات باستخدام إحداثيات مطلقة، بدءًا من الزاوية العليا اليسرى للمخطط. |
