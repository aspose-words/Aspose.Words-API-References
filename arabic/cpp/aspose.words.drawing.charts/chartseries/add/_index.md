---
title: "طريقة Aspose::Words::Drawing::Charts::ChartSeries::Add"
linktitle: "Add"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::Charts::ChartSeries::Add. تُضيف قيمة X المحددة إلى سلسلة المخطط. إذا كانت السلسلة تدعم قيم Y وأحجام الفقاعات، فستكون فارغة لقيمة X في C++."
type: docs
weight: 1250
url: /ar/cpp/aspose.words.drawing.charts/chartseries/add/
---
## ChartSeries::Add(const System::SharedPtr\<Aspose::Words::Drawing::Charts::ChartXValue\>\&) method


يضيف قيمة X المحددة إلى سلسلة المخطط. إذا كانت السلسلة تدعم قيم Y وأحجام الفقاعات، فستكون فارغة بالنسبة لقيمة X.
...
يضيف قيم X و Y المحددة إلى سلسلة المخطط.
...
يضيف قيمة X المحددة، وقيمة Y، وحجم الفقاعة إلى سلسلة المخطط.
