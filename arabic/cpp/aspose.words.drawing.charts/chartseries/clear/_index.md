---
title: "Aspose::Words::Drawing::Charts::ChartSeries::Clear طريقة"
linktitle: "Clear"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::Charts::ChartSeries::Clear طريقة. يزيل جميع قيم البيانات من سلسلة المخطط. يتم مسح تنسيق جميع نقاط البيانات الفردية وملصقات البيانات في C++."
type: docs
weight: 1500
url: /ar/cpp/aspose.words.drawing.charts/chartseries/clear/
---
## ChartSeries::Clear method


يزيل جميع قيم البيانات من سلسلة المخطط. يتم مسح تنسيق جميع نقاط البيانات الفردية وعناوين البيانات.
