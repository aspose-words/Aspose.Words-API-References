...
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText method. يحدد ما إذا كان محتوى هذه الـ SDT سيُفسَّر على أنه يحتوي على نص نائب (على عكس محتوى نص عادي داخل الـ SDT). إذا تم تعيينه إلى true، فسيتم استئناف هذه الحالة (عرض نص نائب) عند فتح هذا المستند في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.markup/istructureddocumenttag/get_isshowingplaceholdertext/
---
## IStructuredDocumentTag::get_IsShowingPlaceholderText method


يحدد ما إذا كان محتوى هذا **SDT** سيُفسَّر على أنه يحتوي نصًا نائبًا (على عكس محتويات النص العادية داخل الـ SDT). إذا تم تعيينه إلى true، ستستأنف هذه الحالة (عرض النص النائب) عند فتح هذا المستند.
