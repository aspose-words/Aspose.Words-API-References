---
title: "طريقة Aspose::Words::Markup::XmlMapping::SetMapping"
linktitle: "SetMapping"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Markup::XmlMapping::SetMapping. تُحدد ربطًا بين العلامة المهيكلة للوثيقة الأصلية وعقدة XML لجزء بيانات XML مخصص في C++."
type: docs
weight: 10000
url: /ar/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


يضبط ربطًا بين العلامة المهيكلة للأب للمستند وعقدة XML لجزء بيانات XML مخصص.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | جزء بيانات XML مخصص للربط به. |
| xPath | const System::String\& | تعبير XPath للعثور على عقدة XML. |
| prefixMapping | const System::String\& | تعيينات بادئات مساحة أسماء XML لتقييم XPath. |

### ReturnValue

علامة تشير إلى ما إذا كانت العلامة المهيكلة للوثيقة الأصلية مرتبطة بنجاح بعقدة XML.
