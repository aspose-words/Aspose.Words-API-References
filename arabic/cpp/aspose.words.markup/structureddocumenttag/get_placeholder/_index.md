...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder method. يحصل على الـ BuildingBlock الذي يحتوي على نص العنصر النائب الذي يجب عرضه عندما تكون محتويات تشغيل هذا الـ SDT فارغة، أو عندما يكون عنصر XML المرتبط فارغًا كما هو محدد عبر عنصر XmlMapping أو عندما يكون عنصر IsShowingPlaceholderText صحيحًا في C++."
type: docs
weight: 26000
url: /ar/cpp/aspose.words.markup/structureddocumenttag/get_placeholder/
---
## StructuredDocumentTag::get_Placeholder method


يحصل على الـ [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) الذي يحتوي على نص العنصر النائب والذي يجب عرضه عندما تكون محتويات تشغيل هذا الـ SDT فارغة، أو عندما يكون عنصر XML المرتبط فارغًا كما هو محدد عبر عنصر [XmlMapping](../get_xmlmapping/) أو عندما يكون عنصر [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) هو **true**.
