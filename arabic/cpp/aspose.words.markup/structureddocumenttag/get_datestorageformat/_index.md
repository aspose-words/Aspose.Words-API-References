---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat طريقة"
linktitle: "get_DateStorageFormat"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat. يحصل/يضبط التنسيق الذي يُخزن به التاريخ لعنصر SDT من نوع تاريخ عندما يكون الـ SDT مرتبطًا بعقدة XML في مخزن بيانات المستند. القيمة الافتراضية هي DateTime في C++."
type: docs
weight: 14000
url: /ar/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


يحصل/يضبط التنسيق الذي يُخزن به التاريخ لعنصر SDT من نوع تاريخ عندما يكون **SDT** مرتبطًا بعقدة XML في مخزن بيانات المستند. القيمة الافتراضية هي [DateTime](../../sdtdatestorageformat/)
