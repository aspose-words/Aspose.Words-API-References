...
description: "Aspose::Words::Markup::StructuredDocumentTag::SetCheckedSymbol method. يحدد الرمز المستخدم لتمثيل الحالة المحددة لعنصر تحكم محتوى مربع الاختيار في C++."
type: docs
weight: 58000
url: /ar/cpp/aspose.words.markup/structureddocumenttag/setcheckedsymbol/
---
## StructuredDocumentTag::SetCheckedSymbol method


يضبط الرمز المستخدم لتمثيل الحالة المحددة لمربع اختيار عنصر التحكم بالمحتوى.
