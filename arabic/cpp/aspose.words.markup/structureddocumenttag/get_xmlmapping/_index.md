...
description: "طريقة Aspose::Words::Markup::StructuredDocumentTag::get_XmlMapping. يحصل على كائن يمثل تخطيط هذه العلامة المهيكلة إلى بيانات XML في جزء XML مخصص للمستند الحالي في C++."
type: docs
weight: 34000
url: /ar/cpp/aspose.words.markup/structureddocumenttag/get_xmlmapping/
---
## StructuredDocumentTag::get_XmlMapping method


يحصل على كائن يمثل تخطيط هذه علامة المستند المهيكلة إلى بيانات XML في جزء XML مخصص للمستند الحالي.
