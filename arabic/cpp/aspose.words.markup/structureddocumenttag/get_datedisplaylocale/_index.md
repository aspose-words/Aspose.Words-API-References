...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateDisplayLocale method. يسمح بتعيين/إلغاء تعيين تنسيق اللغة للتاريخ المعروض في هذا SDT في C++."
type: docs
weight: 13000
url: /ar/cpp/aspose.words.markup/structureddocumenttag/get_datedisplaylocale/
---
## StructuredDocumentTag::get_DateDisplayLocale method


يسمح بتعيين/الحصول على تنسيق اللغة للتاريخ المعروض في هذه **SDT**.
