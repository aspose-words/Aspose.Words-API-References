...
description: "Aspose::Words::Markup::SdtListItem class. يحدد هذا العنصر عنصر قائمة واحد داخل علامة مستند منظم من نوع ComboBox أو DropDownList. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.markup/sdtlistitem/
---
## SdtListItem class


هذا العنصر يحدد عنصر قائمة واحد داخل علامة مستند منظم من نوع [ComboBox](../sdttype/) أو [DropDownList](../sdttype/). لمعرفة المزيد، زر مقالة الوثائق [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| طريقة | الوصف |
| --- | --- |
| [get_DisplayText](./get_displaytext/)() const | يحصل على النص لعرضه في محتوى التشغيل بدلاً من محتويات سمة [Value](./get_value/) لهذا عنصر القائمة. |
| [get_Value](./get_value/)() const | يحصل على قيمة هذا عنصر القائمة. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [SdtListItem](./sdtlistitem/)(const System::String\&, const System::String\&) | يُنشئ مثيلًا جديدًا لهذه الفئة. |
| [SdtListItem](./sdtlistitem/)(const System::String\&) | يُنشئ مثيلًا جديدًا لهذه الفئة. |
| static [Type](./type/)() |  |
