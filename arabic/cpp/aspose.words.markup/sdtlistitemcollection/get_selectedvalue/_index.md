---
title: "طريقة Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue"
linktitle: "get_SelectedValue"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue. تحدد القيمة المحددة حاليًا في هذه القائمة. يُسمح بالقيمة الفارغة (null)، مما يعني عدم وجود إدخال محدد حاليًا مرتبط بهذه مجموعة عناصر القائمة في C++."
type: docs
weight: 9000
url: /ar/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


يحدد القيمة المحددة حاليًا في هذه القائمة. يُسمح بالقيمة الفارغة، مما يعني عدم ارتباط أي إدخال محدد حاليًا بمجموعة عناصر هذه القائمة.
