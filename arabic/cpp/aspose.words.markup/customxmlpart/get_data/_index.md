---
title: "Aspose::Words::Markup::CustomXmlPart::get_Data طريقة"
linktitle: "get_Data"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Data طريقة. يحصل على أو يضبط محتوى XML لهذا الجزء المخصص لتخزين بيانات XML في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.markup/customxmlpart/get_data/
---
## CustomXmlPart::get_Data method


يحصل أو يضبط محتوى XML لهذا جزء تخزين بيانات XML مخصص.
...
القيمة الافتراضية هي مصفوفة بايتات فارغة. لا يمكن أن تكون القيمة **null**.
