---
title: "Aspose::Words::Markup::CustomXmlPart::get_Id طريقة"
linktitle: "get_Id"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Id طريقة. يحصل على أو يضبط السلسلة التي تحدد هذا الجزء المخصص من XML داخل مستند OOXML في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.markup/customxmlpart/get_id/
---
## CustomXmlPart::get_Id method


يحصل أو يضبط السلسلة التي تحدد هذا الجزء المخصص من XML داخل مستند OOXML.
...
تحدد ISO/IEC 29500 أن هذه القيمة هي GUID، لكن الإصدارات القديمة من Microsoft Word سمحت بأي سلسلة هنا. تقوم Aspose.Words بنفس الشيء لتنسيق ECMA-376. لكن لاحظ أن Microsoft Word Online يفشل في فتح مستند تم إنشاؤه بقيمة غير GUID. لذا، يُفضَّل أن تكون القيمة GUID لهذه الخاصية.
