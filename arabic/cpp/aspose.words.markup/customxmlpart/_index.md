...
description: "Aspose::Words::Markup::CustomXmlPart class. يمثل جزء تخزين بيانات XML مخصص (بيانات XML مخصصة داخل حزمة). لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.markup/customxmlpart/
---
## CustomXmlPart class


يمثل جزء تخزين بيانات XML مخصص (بيانات XML مخصصة داخل الحزمة). لمعرفة المزيد، قم بزيارة مقالة الوثائق [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| [get_Data](./get_data/)() const | يحصل أو يضبط محتوى XML لهذا جزء تخزين بيانات XML مخصص. |
| [get_DataChecksum](./get_datachecksum/)() | يحدد فحص التكرار الدوري (CRC) لمحتوى [Data](./get_data/). |
| [get_Id](./get_id/)() const | يحصل أو يضبط السلسلة التي تحدد هذا الجزء المخصص من XML داخل مستند OOXML. |
| [get_Schemas](./get_schemas/)() const | يحدد مجموعة مخططات XML المرتبطة بهذا الجزء المخصص من XML. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Data](./set_data/)(const System::ArrayPtr\<uint8_t\>\&) | مُعيّن لـ [Aspose::Words::Markup::CustomXmlPart::get_Data](./get_data/). |
| [set_Id](./set_id/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Markup::CustomXmlPart::get_Id](./get_id/). |
| static [Type](./type/)() |  |
## ملاحظات


يمكن أن يحتوي مستند DOCX أو DOC على جزء أو أكثر من أجزاء تخزين بيانات XML المخصصة. يحافظ Aspose.Words ويسمح بإنشاء واستخراج بيانات XML المخصصة عبر مجموعة [CustomXmlParts](../../aspose.words/document/get_customxmlparts/).
