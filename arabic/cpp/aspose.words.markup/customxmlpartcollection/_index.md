...
description: "Aspose::Words::Markup::CustomXmlPartCollection class. يمثل مجموعة من أجزاء XML المخصصة. العناصر هي كائنات CustomXmlPart. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.markup/customxmlpartcollection/
---
## CustomXmlPartCollection class


يمثل مجموعة من أجزاء XML المخصصة. العناصر هي كائنات [CustomXmlPart](../customxmlpart/). لمعرفة المزيد، زر مقالة الوثائق [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| طريقة | الوصف |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | يضيف عنصرًا إلى المجموعة. |
| [Add](./add/)(const System::String\&, const System::String\&) | ينشئ جزء XML جديد باستخدام XML المحدد ويضيفه إلى المجموعة. |
| [begin](./begin/)() |  |
| [begin](./begin/)() const |  |
| [cbegin](./cbegin/)() const |  |
| [cend](./cend/)() const |  |
...
| [GetById](./getbyid/)(const System::String\&) | يبحث ويعيد جزء XML مخصص بناءً على معرفه. |
...
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | يحصل أو يعيّن عنصرًا عند الفهرس المحدد. |
...
عادةً لا تحتاج إلى إنشاء مثيلات من هذه الفئة. يمكنك الوصول إلى بيانات XML المخصصة المخزنة في مستند عبر الخاصية [CustomXmlParts](../../aspose.words/document/get_customxmlparts/).
