---
title: "طريقة Aspose::Words::Markup::CustomXmlPartCollection::Add"
linktitle: "Add"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Markup::CustomXmlPartCollection::Add. تُضيف عنصرًا إلى المجموعة في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| جزء | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | جزء XML المخصص للإضافة. |
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| معرف | const System::String\& | معرف جزء XML مخصص جديد. |
| xml | const System::String\& | بيانات XML للجزء. |
