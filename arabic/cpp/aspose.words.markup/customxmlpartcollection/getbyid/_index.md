---
title: "طريقة Aspose::Words::Markup::CustomXmlPartCollection::GetById"
linktitle: "GetById"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Markup::CustomXmlPartCollection::GetById. يبحث ويعيد جزء XML مخصص حسب معرفه في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
## CustomXmlPartCollection::GetById method


يبحث ويعيد جزء XML مخصص بناءً على معرفه.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| معرف | const System::String\& | سلسلة حساسة لحالة الأحرف تحدد جزء XML المخصص. |

### ReturnValue

يرجع **null** إذا لم يتم العثور على جزء XML مخصص بالمعرف المحدد.
