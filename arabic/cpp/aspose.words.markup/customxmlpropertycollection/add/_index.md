...
description: "Aspose::Words::Markup::CustomXmlPropertyCollection::Add method. يضيف خاصية إلى المجموعة في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.markup/customxmlpropertycollection/add/
---
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| خاصية | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlProperty\>\& | الخاصية المراد إضافتها. |
