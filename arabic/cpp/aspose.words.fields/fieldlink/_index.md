---
title: "Aspose::Words::Fields::FieldLink فئة"
linktitle: "FieldLink"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldLink فئة. يُنفّذ حقل LINK. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 63000
url: /ar/cpp/aspose.words.fields/fieldlink/
---
## FieldLink class


ينفذ حقل LINK. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FormatUpdateType](./get_formatupdatetype/)() | يحصل على طريقة تحديث الكائن المرتبط لتنسيقه. |
...
| [set_FormatUpdateType](./set_formatupdatetype/)(const System::String\&) | يضبط طريقة تحديث الكائن المرتبط لتنسيقه. |
