---
title: "طريقة Aspose::Words::Fields::FieldSeq::get_ResetNumber"
linktitle: "get_ResetNumber"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldSeq::get_ResetNumber. يحصل أو يضبط عددًا صحيحًا لإعادة تعيين رقم التسلسل إليه. تُرجع -1 إذا كان العدد غير موجود في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.fields/fieldseq/get_resetnumber/
---
## FieldSeq::get_ResetNumber method


يحصل أو يعيّن عددًا صحيحًا لإعادة تعيين رقم التسلسل إليه. يُعيد -1 إذا كان العدد غير موجود.
