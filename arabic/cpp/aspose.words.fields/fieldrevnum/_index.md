...
description: "Aspose::Words::Fields::FieldRevNum class. تنفذ حقل REVNUM. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 86000
url: /ar/cpp/aspose.words.fields/fieldrevnum/
---
## FieldRevNum class


يُنفّذ الحقل REVNUM. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
