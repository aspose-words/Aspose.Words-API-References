...
description: "Aspose::Words::Fields::FieldPage class. ينفّذ حقل PAGE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 78000
url: /ar/cpp/aspose.words.fields/fieldpage/
---
## FieldPage class


ينفذ حقل PAGE. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
