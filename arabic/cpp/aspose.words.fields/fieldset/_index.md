---
title: "Aspose::Words::Fields::FieldSet فئة"
linktitle: "FieldSet"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldSet فئة. ينفّذ حقل SET. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 92000
url: /ar/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


يُنفّذ الحقل SET. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| طريقة | الوصف |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | يحصل أو يعيّن اسم الإشارة المرجعية. |
| [get_BookmarkText](./get_bookmarktext/)() | يحصل أو يضبط النص الجديد للعلامة المرجعية. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/). |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/). |
