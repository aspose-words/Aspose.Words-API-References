---
title: "فئة Aspose::Words::Fields::FieldPrint"
linktitle: "FieldPrint"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldPrint. تنفذ حقل PRINT. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 80000
url: /ar/cpp/aspose.words.fields/fieldprint/
---
## FieldPrint class


ينفذ حقل PRINT. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_PostScriptGroup](./get_postscriptgroup/)() | يحصل أو يضبط مستطيل الرسم الذي تعمل عليه تعليمات PostScript. |
| [get_PrinterInstructions](./get_printerinstructions/)() | يحصل أو يضبط أحرف رموز التحكم الخاصة بالطابعة أو تعليمات PostScript. |
...
| [set_PostScriptGroup](./set_postscriptgroup/)(const System::String\&) | دالة ضبط لـ [Aspose::Words::Fields::FieldPrint::get_PostScriptGroup](./get_postscriptgroup/). |
| [set_PrinterInstructions](./set_printerinstructions/)(const System::String\&) | دالة ضبط لـ [Aspose::Words::Fields::FieldPrint::get_PrinterInstructions](./get_printerinstructions/). |
