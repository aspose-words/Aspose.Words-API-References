---
title: "Aspose::Words::Fields::FieldNoteRef فئة"
linktitle: "FieldNoteRef"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldNoteRef فئة. ينفّذ حقل NOTEREF. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 72000
url: /ar/cpp/aspose.words.fields/fieldnoteref/
---
## FieldNoteRef class


ينفذ حقل NOTEREF. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| طريقة | الوصف |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | يحصل على اسم الإشارة المرجعية. |
...
| [get_InsertHyperlink](./get_inserthyperlink/)() | يحصل ما إذا كان يجب إدراج ارتباط تشعبي إلى الفقرة المعلمة. |
| [get_InsertReferenceMark](./get_insertreferencemark/)() | يدرج علامة الإشارة بنفس تنسيق الأحرف كما هو في نمط إشارة الحاشية السفلية أو إشارة الحاشية الختامية. |
| [get_InsertRelativePosition](./get_insertrelativeposition/)() | يحصل ما إذا كان يجب إدراج موضع نسبي للفقرة المعلمة. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | يضبط اسم الإشارة المرجعية. |
| [set_InsertHyperlink](./set_inserthyperlink/)(bool) | يضبط ما إذا كان يجب إدراج ارتباط تشعبي إلى الفقرة المعلمة. |
| [set_InsertReferenceMark](./set_insertreferencemark/)(bool) | يدرج علامة الإشارة بنفس تنسيق الأحرف كما هو في نمط إشارة الحاشية السفلية أو إشارة الحاشية الختامية. |
| [set_InsertRelativePosition](./set_insertrelativeposition/)(bool) | يضبط ما إذا كان يجب إدراج موضع نسبي للفقرة المعلمة. |
...
يعرض كيفية الإشارة المتبادلة إلى الحواشي باستخدام حقل NOTEREF.
```cpp
