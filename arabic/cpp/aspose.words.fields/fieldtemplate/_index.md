...
description: "Aspose::Words::Fields::FieldTemplate class. ينفّذ حقل TEMPLATE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 101000
url: /ar/cpp/aspose.words.fields/fieldtemplate/
---
## FieldTemplate class


يُنفّذ الحقل TEMPLATE. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_IncludeFullPath](./get_includefullpath/)() | يحصل أو يضبط ما إذا كان يجب تضمين اسم مسار الملف الكامل. |
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldTemplate::get_IncludeFullPath](./get_includefullpath/). |
