---
title: "Aspose::Words::Fields::FieldBibliography فئة"
linktitle: "FieldBibliography"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldBibliography فئة. تنفذ حقل BIBLIOGRAPHY. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 18000
url: /ar/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


يُنفّذ حقل BIBLIOGRAPHY. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | يحصل على معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة. |
| [get_Format](../field/get_format/)() | يحصل على كائن [FieldFormat](../fieldformat/) الذي يوفّر وصولًا من نوع إلى تنسيق الحقل. |
| [get_FormatLanguageId](./get_formatlanguageid/)() | يحصل على معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
| [get_SourceTag](./get_sourcetag/)() | يحصل على قيمة بحيث يتم عرض فقط المصادر التي لها قيمة عنصر Tag مطابقة في الببليوغرافيا. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | يضبط معرف اللغة المستخدم لتصفية البيانات الببليوغرافية بحيث تشمل فقط المصادر في المستند التي تستخدم تلك اللغة. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | يضبط معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | يضبط قيمة بحيث يتم عرض فقط المصادر التي لها قيمة عنصر Tag مطابقة في الببليوغرافيا. |
| static [Type](./type/)() |  |
