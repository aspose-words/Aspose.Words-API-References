---
title: "Aspose::Words::Fields::FieldFileName فئة"
linktitle: "FieldFileName"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldFileName فئة. ينفّذ حقل FILENAME. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 41000
url: /ar/cpp/aspose.words.fields/fieldfilename/
---
## FieldFileName class


يطبق حقل FILENAME. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | المحدد لـ [Aspose::Words::Fields::FieldFileName::get_IncludeFullPath](./get_includefullpath/). |
...
في التنفيذ الحالي، يستخدم خاصية [OriginalFileName](../../aspose.words/document/get_originalfilename/) لاسترجاع اسم الملف. إذا تم تحميل المستند من تدفق أو تم إنشاؤه فارغًا، يستخدم اسم الملف الذي يتم حفظه إليه (إذا كان معروفًا).

## أمثلة



يظهر كيفية استخدام [FieldOptions](../fieldoptions/) لتجاوز القيمة الافتراضية لحقل FILENAME.
```cpp
