---
title: "فئة Aspose::Words::Fields::FieldSkipIf"
linktitle: "FieldSkipIf"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldSkipIf. تنفّذ حقل SKIPIF. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 94000
url: /ar/cpp/aspose.words.fields/fieldskipif/
---
## FieldSkipIf class


يُنفّذ الحقل SKIPIF. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| طريقة | الوصف |
| --- | --- |
| [get_ComparisonOperator](./get_comparisonoperator/)() | يحصل على مشغل المقارنة. |
...
| [get_LeftExpression](./get_leftexpression/)() | يحصل على الجزء الأيسر من تعبير المقارنة. |
...
| [get_RightExpression](./get_rightexpression/)() | يحصل على الجزء الأيمن من تعبير المقارنة. |
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | يضبط عامل المقارنة. |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | يضبط الجزء الأيسر من تعبير المقارنة. |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | يضبط الجزء الأيمن من تعبير المقارنة. |
| static [Type](./type/)() |  |
