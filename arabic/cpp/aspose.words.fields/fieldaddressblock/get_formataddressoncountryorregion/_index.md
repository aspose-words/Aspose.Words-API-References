---
title: "طريقة Aspose::Words::Fields::FieldAddressBlock::get_FormatAddressOnCountryOrRegion"
linktitle: "get_FormatAddressOnCountryOrRegion"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldAddressBlock::get_FormatAddressOnCountryOrRegion. يحصل أو يضبط ما إذا كان يجب تنسيق العنوان وفقًا للدولة/المنطقة الخاصة بالمستلم كما هو معرف بواسطة POST*CODE (الاتحاد البريدي العالمي 2006) في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.fields/fieldaddressblock/get_formataddressoncountryorregion/
---
## FieldAddressBlock::get_FormatAddressOnCountryOrRegion method


يحصل أو يعيّن ما إذا كان يجب تنسيق العنوان وفقًا لدولة/منطقة المستلم كما هو معرف بواسطة POST*CODE (الاتحاد البريدي العالمي 2006).
