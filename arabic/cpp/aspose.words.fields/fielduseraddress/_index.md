---
title: "Aspose::Words::Fields::FieldUserAddress فئة"
linktitle: "FieldUserAddress"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldUserAddress فئة. ينفّذ حقل USERADDRESS. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 108000
url: /ar/cpp/aspose.words.fields/fielduseraddress/
---
## FieldUserAddress class


ينفّذ حقل USERADDRESS. لمعرفة المزيد، زر مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_UserAddress](./get_useraddress/)() | يحصل أو يعيّن عنوان البريد الحالي للمستخدم. |
...
| [set_UserAddress](./set_useraddress/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::FieldUserAddress::get_UserAddress](./get_useraddress/). |
| static [Type](./type/)() |  |
