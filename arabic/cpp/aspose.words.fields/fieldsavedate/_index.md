---
title: "Aspose::Words::Fields::FieldSaveDate فئة"
linktitle: "FieldSaveDate"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldSaveDate فئة. يُنفّذ حقل SAVEDATE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 87000
url: /ar/cpp/aspose.words.fields/fieldsavedate/
---
## FieldSaveDate class


يُنفّذ الحقل SAVEDATE. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldSaveDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldSaveDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldSaveDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
