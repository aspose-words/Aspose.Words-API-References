---
title: "Aspose::Words::Fields::FieldKeywords فئة"
linktitle: "FieldKeywords"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldKeywords فئة. يُنفّذ حقل KEYWORDS. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 61000
url: /ar/cpp/aspose.words.fields/fieldkeywords/
---
## FieldKeywords class


ينفذ حقل KEYWORDS. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_Text](./get_text/)() | يحصل أو يضبط نص الكلمات المفتاحية. |
...
| [set_Text](./set_text/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldKeywords::get_Text](./get_text/). |
| static [Type](./type/)() |  |
