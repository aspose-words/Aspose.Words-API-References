---
title: "Aspose::Words::Fields::FieldEQ فئة"
linktitle: "FieldEQ"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldEQ فئة. ينفّذ حقل EQ. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 40000
url: /ar/cpp/aspose.words.fields/fieldeq/
---
## FieldEQ class


يطبق حقل EQ. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| طريقة | الوصف |
| --- | --- |
| [AsOfficeMath](./asofficemath/)() | يرجع كائن Office [Math](../../aspose.words.math/) المقابل لحقل EQ. |
...
يعرض كيفية استبدال حقل EQ بـ Office [Math](../../aspose.words.math/).
```cpp
