---
title: "الفئة Aspose::Words::Fields::FieldIndex"
linktitle: "FieldIndex"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::Fields::FieldIndex. تنفّذ حقل INDEX. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 59000
url: /ar/cpp/aspose.words.fields/fieldindex/
---
## FieldIndex class


ينفذ حقل INDEX. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| طريقة | الوصف |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | يحصل أو يعيّن اسم العلامة المرجعية التي تحدد الجزء من المستند المستخدم لبناء الفهرس. |
| [get_CrossReferenceSeparator](./get_crossreferenceseparator/)() | يحصل أو يعيّن تسلسل الأحرف المستخدم لفصل الإشارات المتقاطعة وغيرها من الإدخالات. |
...
| [get_EntryType](./get_entrytype/)() | يحصل أو يعيّن نوع إدخال الفهرس المستخدم لبناء الفهرس. |
...
| [get_HasPageNumberSeparator](./get_haspagenumberseparator/)() | يحصل على قيمة تشير إلى ما إذا كان فاصل رقم الصفحة قد تم تجاوزه عبر شفرة الحقل. |
| [get_HasSequenceName](./get_hassequencename/)() | يحصل على قيمة تشير إلى ما إذا كان يجب استخدام تسلسل أثناء بناء نتيجة الحقل. |
| [get_Heading](./get_heading/)() | يحصل أو يعيّن عنوانًا يظهر في بداية كل مجموعة من الإدخالات لأي حرف معين. |
...
| [get_LanguageId](./get_languageid/)() | يحصل أو يعيّن معرف اللغة المستخدم لتوليد الفهرس. |
| [get_LetterRange](./get_letterrange/)() | يحصل أو يعيّن نطاق الحروف التي يحدّ الفهرس إليها. |
| [get_LocaleId](../field/get_localeid/)() | يحصل أو يعيّن معرف اللغة (LCID) للحقل. |
| [get_NumberOfColumns](./get_numberofcolumns/)() | يحصل أو يعيّن عدد الأعمدة في كل صفحة المستخدمة عند بناء الفهرس. |
| [get_PageNumberListSeparator](./get_pagenumberlistseparator/)() | يحصل أو يعيّن تسلسل الأحرف المستخدم لفصل رقمين صفحة في قائمة أرقام الصفحات. |
| [get_PageNumberSeparator](./get_pagenumberseparator/)() | يحصل أو يعيّن تسلسل الأحرف المستخدم لفصل إدخال الفهرس ورقم صفحته. |
| [get_PageRangeSeparator](./get_pagerangeseparator/)() | يحصل أو يعيّن تسلسل الأحرف المستخدم لفصل بداية ونهاية نطاق الصفحات. |
| [get_Result](../field/get_result/)() | يحصل أو يعيّن النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [get_RunSubentriesOnSameLine](./get_runsubentriesonsameline/)() | يحصل أو يعيّن ما إذا كان يتم تشغيل الإدخالات الفرعية في نفس السطر مع الإدخال الرئيسي. |
| [get_Separator](../field/get_separator/)() | يحصل على العقدة التي تمثل فاصل الحقل. يمكن أن تكون **null**. |
| [get_SequenceName](./get_sequencename/)() | يحصل أو يعيّن اسم التسلسل الذي يُضمّن رقمه مع رقم الصفحة. |
...
| [get_UseYomi](./get_useyomi/)() | يحصل أو يعيّن ما إذا كان يجب تمكين استخدام نص يومي لإدخالات الفهرس. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_BookmarkName](./get_bookmarkname/). |
| [set_CrossReferenceSeparator](./set_crossreferenceseparator/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_CrossReferenceSeparator](./get_crossreferenceseparator/). |
| [set_EntryType](./set_entrytype/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_EntryType](./get_entrytype/). |
| [set_Heading](./set_heading/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_Heading](./get_heading/). |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_LanguageId](./get_languageid/). |
| [set_LetterRange](./set_letterrange/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_LetterRange](./get_letterrange/). |
| [set_LocaleId](../field/set_localeid/)(int32_t) | مُعيّن لـ [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NumberOfColumns](./set_numberofcolumns/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_NumberOfColumns](./get_numberofcolumns/). |
| [set_PageNumberListSeparator](./set_pagenumberlistseparator/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator](./get_pagenumberlistseparator/). |
| [set_PageNumberSeparator](./set_pagenumberseparator/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_PageNumberSeparator](./get_pagenumberseparator/). |
| [set_PageRangeSeparator](./set_pagerangeseparator/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_PageRangeSeparator](./get_pagerangeseparator/). |
| [set_Result](../field/set_result/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_RunSubentriesOnSameLine](./set_runsubentriesonsameline/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_RunSubentriesOnSameLine](./get_runsubentriesonsameline/). |
| [set_SequenceName](./set_sequencename/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_SequenceName](./get_sequencename/). |
| [set_SequenceSeparator](./set_sequenceseparator/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_SequenceSeparator](./get_sequenceseparator/). |
| [set_UseYomi](./set_useyomi/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldIndex::get_UseYomi](./get_useyomi/). |
| static [Type](./type/)() |  |
