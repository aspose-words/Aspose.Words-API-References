---
title: "طريقة Aspose::Words::Fields::FieldIndex::get_BookmarkName"
linktitle: "طريقة Aspose::Words::Fields::FieldAsk::set_DefaultResponse"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldIndex::get_BookmarkName. تحصل أو تعيين اسم الإشارة المرجعية التي تحدد الجزء من المستند المستخدم لبناء الفهرس في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.fields/fieldindex/get_bookmarkname/
---
## FieldIndex::get_BookmarkName method


يحصل أو يعيّن اسم العلامة المرجعية التي تحدد الجزء من المستند المستخدم لبناء الفهرس.
