---
title: "فئة Aspose::Words::Fields::FieldGlossary"
linktitle: "FieldGlossary"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldGlossary. تنفذ حقل GLOSSARY. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 50000
url: /ar/cpp/aspose.words.fields/fieldglossary/
---
## FieldGlossary class


يطبق حقل GLOSSARY. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_EntryName](./get_entryname/)() override | يحصل أو يضبط اسم مدخل القاموس لإدراجه. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldGlossary::get_EntryName](./get_entryname/). |
