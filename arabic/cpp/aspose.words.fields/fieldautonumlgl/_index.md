---
title: "فئة Aspose::Words::Fields::FieldAutoNumLgl"
linktitle: "FieldAutoNumLgl"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldAutoNumLgl. تنفذ حقل AUTONUMLGL. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 13000
url: /ar/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


يُنفّذ حقل AUTONUMLGL. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | يحصل على ما إذا كان سيتم عرض الرقم دون نقطة نهائية. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | يحصل على حرف الفاصل الذي سيُستخدم. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | يضبط ما إذا كان سيتم عرض الرقم دون نقطة نهائية. |
| [set_Result](../field/set_result/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | يضبط حرف الفاصل الذي سيُستخدم. |
| static [Type](./type/)() |  |
