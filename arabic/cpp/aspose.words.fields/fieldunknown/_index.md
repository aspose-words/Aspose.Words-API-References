...
description: "Aspose::Words::Fields::FieldUnknown class. ينفّذ حقلًا غير معروف أو غير مُعترف به. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 106000
url: /ar/cpp/aspose.words.fields/fieldunknown/
---
## FieldUnknown class


يُنفّذ حقل غير معروف أو غير مُعرّف. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يعرض كيفية العمل مع الحقل 'FieldNone' في مستند.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// أدرج حقلًا لا يدل على نوع حقل موضوعي في شفرة الحقل الخاصة به.
System::SharedPtr<Aspose::Words::Fields::Field> field = builder->InsertField(u" NOTAREALFIELD //a");

// نوع الحقل "FieldNone" محجوز للحقول مثل هذه.
ASSERT_EQ(Aspose::Words::Fields::FieldType::FieldNone, field->get_Type());

// يمكننا أيضًا الاستمرار في العمل مع هذه الحقول وتعيينها ككائنات من فئة FieldUnknown.
