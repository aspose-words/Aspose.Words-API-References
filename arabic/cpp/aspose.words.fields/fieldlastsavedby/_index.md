---
title: "فئة Aspose::Words::Fields::FieldLastSavedBy"
linktitle: "FieldLastSavedBy"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldLastSavedBy. تنفّذ حقل LASTSAVEDBY. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 62000
url: /ar/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


ينفذ حقل LASTSAVEDBY. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
يظهر كيفية استخدام حقل LASTSAVEDBY.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// إذا أنشأنا مستندًا في Microsoft Word، فسيحتوي على اسم المستخدم في الخاصية المدمجة "Last saved by".
// إذا أنشأنا مستندًا برمجيًا، ستكون هذه الخاصية فارغة (null)، وسنحتاج إلى تعيين قيمة.
