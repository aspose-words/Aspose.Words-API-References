---
title: "فئة Aspose::Words::Fields::FieldGoToButton"
linktitle: "FieldGoToButton"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldGoToButton. تنفذ حقل GOTOBUTTON. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 51000
url: /ar/cpp/aspose.words.fields/fieldgotobutton/
---
## FieldGoToButton class


يطبق حقل GOTOBUTTON. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_DisplayText](./get_displaytext/)() | يحصل أو يضبط نص \"الزر\" الذي يظهر في المستند، بحيث يمكن تحديده لتفعيل القفزة. |
...
| [get_Location](./get_location/)() | يحصل أو يضبط اسم إشارة مرجعية أو رقم صفحة أو أي عنصر آخر للقفز إليه. |
...
| [set_DisplayText](./set_displaytext/)(const System::String\&) | محدد لـ [Aspose::Words::Fields::FieldGoToButton::get_DisplayText](./get_displaytext/). |
...
| [set_Location](./set_location/)(const System::String\&) | محدد لـ [Aspose::Words::Fields::FieldGoToButton::get_Location](./get_location/). |
