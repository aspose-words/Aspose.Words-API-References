---
title: "فئة Aspose::Words::Fields::FieldFormula"
linktitle: "FieldFormula"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldFormula. تنفّذ حقل = (الصيغة). لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 49000
url: /ar/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


يطبق حقل = (معادلة). لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يظهر كيفية استخدام حقل الصيغة لعرض نتيجة معادلة.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();

// استخدم مُنشئ الحقول لإنشاء معادلة رياضية،
