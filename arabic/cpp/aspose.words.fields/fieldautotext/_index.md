---
title: "Aspose::Words::Fields::FieldAutoText فئة"
linktitle: "FieldAutoText"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldAutoText فئة. ينفّذ حقل AUTOTEXT. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 15000
url: /ar/cpp/aspose.words.fields/fieldautotext/
---
## FieldAutoText class


يُنفّذ حقل AUTOTEXT. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_EntryName](./get_entryname/)() override | يحصل أو يعيّن اسم إدخال AutoText. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::FieldAutoText::get_EntryName](./get_entryname/). |
