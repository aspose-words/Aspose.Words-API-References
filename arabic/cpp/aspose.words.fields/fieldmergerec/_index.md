...
description: "Aspose::Words::Fields::FieldMergeRec class. ينفّذ حقل MERGEREC. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 68000
url: /ar/cpp/aspose.words.fields/fieldmergerec/
---
## FieldMergeRec class


ينفذ حقل MERGEREC. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
