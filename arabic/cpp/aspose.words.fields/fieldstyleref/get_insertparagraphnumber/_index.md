---
title: "طريقة Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber"
linktitle: "get_InsertParagraphNumber"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber. يحصل أو يضبط ما إذا كان يجب إدراج رقم الفقرة للفقرة المشار إليها بالضبط كما يظهر في المستند في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.fields/fieldstyleref/get_insertparagraphnumber/
---
## FieldStyleRef::get_InsertParagraphNumber method


يحصل أو يعيّن ما إذا كان سيتم إدراج رقم الفقرة للفقرة المشار إليها بالضبط كما هو في المستند.
