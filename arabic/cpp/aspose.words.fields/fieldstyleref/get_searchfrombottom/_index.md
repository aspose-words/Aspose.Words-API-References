---
title: "طريقة Aspose::Words::Fields::FieldStyleRef::get_SearchFromBottom"
linktitle: "get_SearchFromBottom"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldStyleRef::get_SearchFromBottom. يحصل أو يضبط ما إذا كان يجب البحث من أسفل الصفحة الحالية، بدلاً من الأعلى في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.fields/fieldstyleref/get_searchfrombottom/
---
## FieldStyleRef::get_SearchFromBottom method


يحصل أو يعيّن ما إذا كان يجب البحث من أسفل الصفحة الحالية، بدلاً من الأعلى.
