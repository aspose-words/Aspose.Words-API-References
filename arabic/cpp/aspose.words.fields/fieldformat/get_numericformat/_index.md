---
title: "Aspose::Words::Fields::FieldFormat::get_NumericFormat طريقة"
linktitle: "get_NumericFormat"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldFormat::get_NumericFormat طريقة. يحصل على أو يضبط تنسيقًا يُطبق على نتيجة حقل رقمي. يتطابق مع مفتاح \\# في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.fields/fieldformat/get_numericformat/
---
## FieldFormat::get_NumericFormat method


يحصل أو يعيّن تنسيقًا يُطبق على نتيجة حقل رقمي. يتوافق مع المفتاح \#.
