---
title: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat طريقة"
linktitle: "get_DateTimeFormat"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat طريقة. يحصل أو يضبط تنسيقًا يتم تطبيقه على نتيجة حقل التاريخ والوقت. يتوافق مع المفتاح \\@ في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.fields/fieldformat/get_datetimeformat/
---
## FieldFormat::get_DateTimeFormat method


يحصل أو يعيّن تنسيقًا يُطبق على نتيجة حقل التاريخ والوقت. يتوافق مع المفتاح \@.
