---
title: "فئة Aspose::Words::Fields::FieldData"
linktitle: "FieldData"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldData. تنفّذ حقل DATA. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 27000
url: /ar/cpp/aspose.words.fields/fielddata/
---
## FieldData class


يُنفّذ حقل DATA. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يظهر كيفية إدراج حقل DATA في مستند.
```cpp
