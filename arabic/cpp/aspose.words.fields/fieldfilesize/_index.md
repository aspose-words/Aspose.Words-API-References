---
title: "الفئة Aspose::Words::Fields::FieldFileSize"
linktitle: "FieldFileSize"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::Fields::FieldFileSize. تنفّذ حقل FILESIZE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 42000
url: /ar/cpp/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class


يطبق حقل FILESIZE. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_IsInKilobytes](./get_isinkilobytes/)() | يحصل أو يضبط ما إذا كان يجب عرض حجم الملف بالكيلوبايت. |
| [get_IsInMegabytes](./get_isinmegabytes/)() | يحصل أو يضبط ما إذا كان يجب عرض حجم الملف بالميغابايت. |
...
| [set_IsInKilobytes](./set_isinkilobytes/)(bool) | مُعيّن لـ [Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes](./get_isinkilobytes/). |
| [set_IsInMegabytes](./set_isinmegabytes/)(bool) | مُعيّن لـ [Aspose::Words::Fields::FieldFileSize::get_IsInMegabytes](./get_isinmegabytes/). |
...
في التنفيذ الحالي، يستخدم خاصية [OriginalFileName](../../aspose.words/document/get_originalfilename/) لاسترجاع اسم الملف المستخدم لتحديد حجم الملف.
