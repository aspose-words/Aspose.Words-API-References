---
title: "فئة Aspose::Words::Fields::FieldImport"
linktitle: "FieldImport"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldImport. تنفّذ حقل IMPORT. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 55000
url: /ar/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


يطبق حقل IMPORT. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_GraphicFilter](./get_graphicfilter/)() | يحصل أو يضبط اسم الفلتر لتنسيق الرسم الذي سيتم إدراجه. |
...
| [get_IsLinked](./get_islinked/)() override | يحصل أو يضبط ما إذا كان سيتم تقليل حجم الملف بعدم تخزين بيانات الرسومات مع المستند. |
...
| [get_SourceFullName](./get_sourcefullname/)() override | يحصل أو يعيّن موقع الصورة. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | المحدد لـ [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | مُعيّن لـ [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | المحدد لـ [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/). |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | المحدد لـ [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
