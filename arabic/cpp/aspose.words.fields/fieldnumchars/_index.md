...
description: "فئة Aspose::Words::Fields::FieldNumChars. تنفذ حقل NUMCHARS. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 73000
url: /ar/cpp/aspose.words.fields/fieldnumchars/
---
## FieldNumChars class


ينفذ حقل NUMCHARS. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
