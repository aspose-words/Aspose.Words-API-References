---
title: "طريقة Aspose::Words::Fields::FieldAdvance::get_VerticalPosition"
linktitle: "get_VerticalPosition"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldAdvance::get_VerticalPosition. يحصل أو يضبط عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل رأسياً من الحافة العلوية للصفحة في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.fields/fieldadvance/get_verticalposition/
---
## FieldAdvance::get_VerticalPosition method


يحصل أو يعيّن عدد النقاط التي يجب أن يتحرك بها النص الذي يلي الحقل عموديًا من الحافة العليا للصفحة.
