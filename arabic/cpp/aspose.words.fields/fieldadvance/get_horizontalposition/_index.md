---
title: "طريقة Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition"
linktitle: "get_HorizontalPosition"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition. يحصل أو يضبط عدد النقاط التي يجب أن يتحرك النص الذي يلي الحقل أفقياً من الحافة اليسرى للعمود أو الإطار أو مربع النص في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.fields/fieldadvance/get_horizontalposition/
---
## FieldAdvance::get_HorizontalPosition method


يحصل أو يعيّن عدد النقاط التي يجب أن يتحرك بها النص الذي يلي الحقل أفقيًا من الحافة اليسرى للعمود أو الإطار أو مربع النص.
