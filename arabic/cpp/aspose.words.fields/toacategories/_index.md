---
title: "Aspose::Words::Fields::ToaCategories فئة"
linktitle: "ToaCategories"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::ToaCategories فئة. تمثّل جدول فئات السلطات. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 116000
url: /ar/cpp/aspose.words.fields/toacategories/
---
## ToaCategories class


يمثل جدولًا لفئات السلطات. لمعرفة المزيد، زر مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| طريقة | الوصف |
| --- | --- |
| static [get_DefaultCategories](./get_defaultcategories/)() | يحصل على جدول فئات السلطات الافتراضي. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | يحصل أو يعيّن عنوان الفئة حسب رقم الفئة. |
| [idx_set](./idx_set/)(int32_t, const System::String\&) | يحصل أو يعيّن عنوان الفئة حسب رقم الفئة. |
