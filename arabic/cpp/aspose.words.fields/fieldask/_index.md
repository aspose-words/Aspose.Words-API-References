---
title: "Aspose::Words::Fields::FieldAsk فئة"
linktitle: "FieldAsk"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldAsk فئة. ينفّذ حقل ASK. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 10000
url: /ar/cpp/aspose.words.fields/fieldask/
---
## FieldAsk class


يُنفّذ حقل ASK. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_DefaultResponse](./get_defaultresponse/)() | يحصل على استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة). |
...
| [get_PromptOnceOnMailMerge](./get_promptonceonmailmerge/)() | يحصل على ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج بريد. |
| [get_PromptText](./get_prompttext/)() | يحصل على نص المطالبة (عنوان نافذة المطالبة). |
...
| [set_DefaultResponse](./set_defaultresponse/)(const System::String\&) | يضبط استجابة المستخدم الافتراضية (القيمة الأولية الموجودة في نافذة المطالبة). |
...
| [set_PromptOnceOnMailMerge](./set_promptonceonmailmerge/)(bool) | يضبط ما إذا كان يجب استلام استجابة المستخدم مرة واحدة لكل عملية دمج البريد. |
| [set_PromptText](./set_prompttext/)(const System::String\&) | يضبط نص المطالبة (عنوان نافذة المطالبة). |
