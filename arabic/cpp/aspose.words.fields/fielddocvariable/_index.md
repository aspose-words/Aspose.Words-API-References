---
title: "فئة Aspose::Words::Fields::FieldDocVariable"
linktitle: "FieldDocVariable"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldDocVariable. تنفّذ حقل DOCVARIABLE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 36000
url: /ar/cpp/aspose.words.fields/fielddocvariable/
---
## FieldDocVariable class


يطبق حقل DOCVARIABLE. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_VariableName](./get_variablename/)() | يحصل أو يضبط اسم المتغيّر في المستند لاسترجاعه. |
...
| [set_VariableName](./set_variablename/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Fields::FieldDocVariable::get_VariableName](./get_variablename/). |
| static [Type](./type/)() |  |
