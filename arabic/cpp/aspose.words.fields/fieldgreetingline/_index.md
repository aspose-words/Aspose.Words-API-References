...
description: "Aspose::Words::Fields::FieldGreetingLine class. ينفّذ حقل GREETINGLINE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 52000
url: /ar/cpp/aspose.words.fields/fieldgreetingline/
---
## FieldGreetingLine class


يطبق حقل GREETINGLINE. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_AlternateText](./get_alternatetext/)() | يحصل على النص لتضمينه في الحقل إذا كان الاسم فارغًا. |
...
| [get_LanguageId](./get_languageid/)() | يحصل على معرف اللغة المستخدم لتنسيق الاسم. |
| [get_LocaleId](../field/get_localeid/)() | يحصل أو يعيّن معرف اللغة (LCID) للحقل. |
| [get_NameFormat](./get_nameformat/)() | يحصل على تنسيق الاسم المضمن في الحقل. |
...
| [set_AlternateText](./set_alternatetext/)(const System::String\&) | يضبط النص لتضمينه في الحقل إذا كان الاسم فارغًا. |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | يضبط معرف اللغة المستخدم لتنسيق الاسم. |
| [set_LocaleId](../field/set_localeid/)(int32_t) | مُعيّن لـ [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NameFormat](./set_nameformat/)(const System::String\&) | يضبط تنسيق الاسم المضمن في الحقل. |
