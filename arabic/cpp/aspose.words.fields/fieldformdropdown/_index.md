---
title: "Aspose::Words::Fields::FieldFormDropDown فئة"
linktitle: "FieldFormDropDown"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldFormDropDown فئة. ينفّذ حقل FORMDROPDOWN. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 47000
url: /ar/cpp/aspose.words.fields/fieldformdropdown/
---
## FieldFormDropDown class


يطبق حقل FORMDROPDOWN. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يظهر كيفية معالجة حقول FORMCHECKBOX و FORMDROPDOWN و FORMTEXT.
```cpp
// هذه الحقول هي ما يعادل الأدوات القديمة لـ FormField. يمكننا قراءتها، لكن لا يمكن إنشاء هذه الحقول باستخدام Aspose.Words.
// في Microsoft Word، يمكننا إدراج هذه الحقول عبر قائمة Legacy Tools في علامة تبويب Developer.
