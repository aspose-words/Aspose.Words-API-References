---
title: "فئة Aspose::Words::Fields::FieldAutoNumOut"
linktitle: "FieldAutoNumOut"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldAutoNumOut. تنفذ حقل AUTONUMOUT. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 14000
url: /ar/cpp/aspose.words.fields/fieldautonumout/
---
## FieldAutoNumOut class


يُنفّذ حقل AUTONUMOUT. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يعرض كيفية ترقيم الفقرات باستخدام حقول AUTONUMOUT.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// حقول AUTONUMOUT تعرض رقمًا يزداد في كل حقل AUTONUMOUT.
// على عكس حقول AUTONUM، تستخدم حقول AUTONUMOUT مخطط ترقيم المخطط التفصيلي،
// والتي يمكننا تعريفها في Microsoft Word عبر تنسيق -> تعداد نقطي وترقيم -> "Outline Numbered".
