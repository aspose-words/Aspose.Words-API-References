...
description: "Aspose::Words::Fields::FieldIncludePicture class. ينفّذ حقل INCLUDEPICTURE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 57000
url: /ar/cpp/aspose.words.fields/fieldincludepicture/
---
## FieldIncludePicture class


ينفذ حقل INCLUDEPICTURE. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_ResizeHorizontally](./get_resizehorizontally/)() | يحصل أو يضبط ما إذا كان سيتم تغيير حجم الصورة أفقياً من المصدر. |
| [get_ResizeVertically](./get_resizevertically/)() | يحصل أو يضبط ما إذا كان سيتم تغيير حجم الصورة عمودياً من المصدر. |
...
| [get_SourceFullName](./get_sourcefullname/)() override | يحصل أو يضبط موقع الصورة باستخدام IRI. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::FieldIncludePicture::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | مُعيّن لـ [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | مُعيّن لـ [Aspose::Words::Fields::FieldIncludePicture::get_IsLinked](./get_islinked/). |
...
| [set_ResizeHorizontally](./set_resizehorizontally/)(bool) | مُعيّن لـ [Aspose::Words::Fields::FieldIncludePicture::get_ResizeHorizontally](./get_resizehorizontally/). |
| [set_ResizeVertically](./set_resizevertically/)(bool) | مُعيّن لـ [Aspose::Words::Fields::FieldIncludePicture::get_ResizeVertically](./get_resizevertically/). |
| [set_Result](../field/set_result/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Fields::FieldIncludePicture::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
