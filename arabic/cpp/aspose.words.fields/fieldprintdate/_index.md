---
title: "الفئة Aspose::Words::Fields::FieldPrintDate"
linktitle: "FieldPrintDate"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::Fields::FieldPrintDate. تنفّذ حقل PRINTDATE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 81000
url: /ar/cpp/aspose.words.fields/fieldprintdate/
---
## FieldPrintDate class


ينفذ حقل PRINTDATE. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldPrintDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldPrintDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldPrintDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
