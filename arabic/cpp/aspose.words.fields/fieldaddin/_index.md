---
title: "فئة Aspose::Words::Fields::FieldAddIn"
linktitle: "FieldAddIn"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldAddIn. تنفذ حقل ADDIN في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.fields/fieldaddin/
---
## FieldAddIn class
...
يعرض كيفية معالجة حقل ADDIN.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>(get_MyDir() + u"Field sample - ADDIN.docx");

// لا يدعم Aspose.Words إدراج حقول ADDIN، ولكن لا يزال بإمكاننا تحميلها وقراءتها.
