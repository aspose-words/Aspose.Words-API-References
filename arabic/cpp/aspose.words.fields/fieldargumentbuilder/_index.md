---
title: "فئة Aspose::Words::Fields::FieldArgumentBuilder"
linktitle: "FieldArgumentBuilder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldArgumentBuilder. تُنشئ حجة حقل معقّدة تتكوّن من حقول وعُقد ونص عادي. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 9000
url: /ar/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


يبني حجة حقل مركبة تتكون من الحقول والعقد والنص العادي. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| طريقة | الوصف |
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | يضيف حقلًا ممثلاً بـ [FieldBuilder](../fieldbuilder/) إلى الحجة. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | يضيف عقدة إلى الحجة. |
| [AddText](./addtext/)(const System::String\&) | يضيف نصًا عاديًا إلى الحجة. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | يُهيئ نسخة من فئة [FieldArgumentBuilder](./). |
