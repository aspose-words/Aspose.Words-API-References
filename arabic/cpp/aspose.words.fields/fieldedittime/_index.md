---
title: "الفئة Aspose::Words::Fields::FieldEditTime"
linktitle: "FieldEditTime"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::Fields::FieldEditTime. تنفذ الحقل EDITTIME. لمعرفة المزيد، قم بزيارة مقالة الوثائق في C++."
type: docs
weight: 37000
url: /ar/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


يطبق حقل EDITTIME. لمعرفة المزيد، قم بزيارة [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
// هذه الخاصية المدمجة في المستند تتعقب الدقائق. يستخدم Microsoft Word هذه الخاصية
// لتتبع الوقت المستغرق مع فتح المستند. يمكننا أيضًا تعديلها بأنفسنا.
...
// الحقل لا يتم تحديثه تلقائيًا في الوقت الفعلي، وسيتعين أيضًا
// تحديثه يدويًا في Microsoft Word في أي وقت نحتاج فيه إلى قيمة دقيقة.
doc->UpdateFields();
