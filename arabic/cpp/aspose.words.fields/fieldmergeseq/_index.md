...
description: "Aspose::Words::Fields::FieldMergeSeq class. ينفّذ حقل MERGESEQ. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 69000
url: /ar/cpp/aspose.words.fields/fieldmergeseq/
---
## FieldMergeSeq class


ينفذ حقل MERGESEQ. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
