---
title: "فئة Aspose::Words::Fields::FieldSeparator"
linktitle: "FieldSeparator"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldSeparator. تمثل فاصل حقل Word الذي يفصل شفرة الحقل عن نتيجة الحقل. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 90000
url: /ar/cpp/aspose.words.fields/fieldseparator/
---
## FieldSeparator class


يمثّل فاصل حقل Word يفصل بين شفرة الحقل ونتيجة الحقل. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_NodeType](./get_nodetype/)() const override | يرجع [FieldSeparator](../../aspose.words/nodetype/). |
