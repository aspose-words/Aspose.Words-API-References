---
title: "Aspose::Words::Fields::FieldHyperlink::get_IsImageMap طريقة"
linktitle: "get_IsImageMap"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldHyperlink::get_IsImageMap طريقة. يحصل أو يضبط ما إذا كان يجب إلحاق إحداثيات بالرابط التشعبي لخريطة صورة من جانب الخادم في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.fields/fieldhyperlink/get_isimagemap/
---
## FieldHyperlink::get_IsImageMap method


يحصل أو يعيّن ما إذا كان سيتم إلحاق إحداثيات بالارتباط التشعبي لخريطة صورة من جانب الخادم.
