...
description: "Aspose::Words::Fields::FieldIfComparisonResult enum. تحدد نتيجة تقييم شرط الحقل IF في C++."
type: docs
weight: 128000
url: /ar/cpp/aspose.words.fields/fieldifcomparisonresult/
---
## FieldIfComparisonResult enum


يحدد نتيجة تقييم شرط حقل IF.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| خطأ | 0 | هناك خطأ في الشرط. |
| صحيح | 1 | الشرط هو **true**. |
| خطأ | 2 | الشرط هو **false**. |
