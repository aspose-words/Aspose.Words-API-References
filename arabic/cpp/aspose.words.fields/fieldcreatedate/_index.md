---
title: "فئة Aspose::Words::Fields::FieldCreateDate"
linktitle: "FieldCreateDate"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldCreateDate فئة. ينفّذ حقل CREATEDATE. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 26000
url: /ar/cpp/aspose.words.fields/fieldcreatedate/
---
## FieldCreateDate class


يُنفّذ حقل CREATEDATE. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldCreateDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldCreateDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | المُعيّن لـ [Aspose::Words::Fields::FieldCreateDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
