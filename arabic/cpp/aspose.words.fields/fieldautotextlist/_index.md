---
title: "فئة Aspose::Words::Fields::FieldAutoTextList"
linktitle: "FieldAutoTextList"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldAutoTextList. تنفذ الحقل AUTOTEXTLIST. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 16000
url: /ar/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


يُنفّذ حقل AUTOTEXTLIST. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| [get_EntryName](./get_entryname/)() | يحصل على اسم إدخال AutoText. |
...
| [get_ListStyle](./get_liststyle/)() | يحصل على اسم النمط الذي تستند إليه القائمة التي تحتوي على الإدخالات. |
...
| [get_ScreenTip](./get_screentip/)() | يحصل على نص ScreenTip لعرضه. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | يضبط اسم إدخال AutoText. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | يضبط اسم النمط الذي تستند إليه القائمة التي تحتوي على الإدخالات. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | يضبط نص ScreenTip لعرضه. |
| static [Type](./type/)() |  |
