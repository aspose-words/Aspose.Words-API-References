...
description: "Aspose::Words::Fields::Field::get_IsLocked method. يحصل أو يضبط ما إذا كان الحقل مقفلًا (يجب عدم إعادة حساب نتيجته) في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.fields/field/get_islocked/
---
## Field::get_IsLocked method


يحصل أو يعيّن ما إذا كان الحقل مقفلًا (يجب عدم إعادة حساب نتيجته).
