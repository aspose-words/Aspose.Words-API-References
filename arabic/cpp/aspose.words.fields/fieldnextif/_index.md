...
description: "Aspose::Words::Fields::FieldNextIf class. ينفّذ حقل NEXTIF. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 71000
url: /ar/cpp/aspose.words.fields/fieldnextif/
---
## FieldNextIf class


ينفذ حقل NEXTIF. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
