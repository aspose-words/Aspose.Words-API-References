---
title: "Aspose::Words::Fields::FieldAuthor فئة"
linktitle: "FieldAuthor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Fields::FieldAuthor فئة. ينفّذ حقل AUTHOR. لمزيد من المعلومات، قم بزيارة مقالة الوثائق في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.fields/fieldauthor/
---
## FieldAuthor class


يُنفّذ حقل AUTHOR. لمزيد من المعلومات، زر [العمل مع الحقول](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
| طريقة | الوصف |
| --- | --- |
| [get_AuthorName](./get_authorname/)() | يحصل أو يعيّن اسم مؤلف المستند. |
...
| [set_AuthorName](./set_authorname/)(const System::String\&) | دالة تعيين لـ [Aspose::Words::Fields::FieldAuthor::get_AuthorName](./get_authorname/). |
