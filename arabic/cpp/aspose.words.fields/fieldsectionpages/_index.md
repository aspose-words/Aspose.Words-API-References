---
title: "فئة Aspose::Words::Fields::FieldSectionPages"
linktitle: "FieldSectionPages"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fields::FieldSectionPages. تنفّذ الحقل SECTIONPAGES. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 89000
url: /ar/cpp/aspose.words.fields/fieldsectionpages/
---
## FieldSectionPages class


يُنفّذ الحقل SECTIONPAGES. لتعلم المزيد، زر [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) مقالة الوثائق.
...
يظهر كيفية استخدام حقلي SECTION و SECTIONPAGES لترقيم الصفحات حسب الأقسام.
```cpp
...
// يعرض حقل SECTION رقم القسم الذي هو فيه.
...
// يعرض حقل PAGE رقم الصفحة التي هو فيها.
builder->Write(u"\nPage ");
...
// يعرض حقل SECTIONPAGES عدد الصفحات التي يغطيها القسم الذي هو فيه.
builder->Write(u" of ");
...
// اخرج من الترويسة عائدًا إلى المستند الرئيسي وأدرج صفحتين.
// ستكون جميع هذه الصفحات في القسم الأول. حقولنا، التي تظهر مرة واحدة في كل ترويسة،
// ستُرقم الصفحات الحالية/الإجمالية لهذا القسم.
builder->MoveToDocumentEnd();
builder->InsertBreak(Aspose::Words::BreakType::PageBreak);
builder->InsertBreak(Aspose::Words::BreakType::PageBreak);

// يمكننا إدراج قسم جديد باستخدام مُنشئ المستند بهذه الطريقة.
// سيؤثر هذا على القيم المعروضة في حقلي SECTION و SECTIONPAGES في جميع الترويسات القادمة.
builder->InsertBreak(Aspose::Words::BreakType::SectionBreakNewPage);

// سيستمر حقل PAGE في عد الصفحات عبر المستند بأكمله.
// يمكننا إعادة ضبط عدده يدويًا في كل قسم لتتبع الصفحات قسمًا بآخر.
