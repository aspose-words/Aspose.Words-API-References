---
title: "طريقة Aspose::Words::Bibliography::ContributorCollection::get_Producer"
linktitle: "get_Producer"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Bibliography::ContributorCollection::get_Producer. يحصل أو يعيّن المنتج لمصدر في C++."
type: docs
weight: 15000
url: /ar/cpp/aspose.words.bibliography/contributorcollection/get_producer/
---
## ContributorCollection::get_Producer method


يحصل أو يضبط المنتج لمصدر.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Producer()
```
