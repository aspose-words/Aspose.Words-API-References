---
title: "Aspose::Words::Bibliography::PersonCollection فئة"
linktitle: "PersonCollection"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Bibliography::PersonCollection فئة. تمثل قائمة بالأشخاص الذين يضيفون كمصادر ببليوغرافية في C++."
type: docs
weight: 750
url: /ar/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


يمثل قائمة بالأشخاص الذين هم مساهمو مصدر الببليوغرافيا.
...
| طريقة | الوصف |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | يضيف [Person](../person/) إلى المجموعة. |
| [Clear](./clear/)() | يزيل جميع العناصر من المجموعة. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | يحدد ما إذا كانت المجموعة تحتوي على شخص معين. |
| [get_Count](./get_count/)() | يحصل على عدد الأشخاص الموجودين في المجموعة. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | يحصل أو يضبط شخصًا في الفهرس المحدد. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | يحصل أو يضبط شخصًا في الفهرس المحدد. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | تهيئة نسخة جديدة من فئة [PersonCollection](./). |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | تهيئة نسخة جديدة من فئة [PersonCollection](./). |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | يزيل الشخص من المجموعة. |
| [RemoveAt](./removeat/)(int32_t) | يزيل الشخص في الفهرس المحدد. |
