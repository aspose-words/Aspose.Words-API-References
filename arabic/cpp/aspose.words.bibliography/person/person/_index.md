---
title: "منشئ Person في Aspose::Words::Bibliography::Person"
linktitle: "Person"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "منشئ Person في Aspose::Words::Bibliography::Person. إنشاء نسخة جديدة من فئة Person في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.bibliography/person/person/
---
## Person::Person constructor


إنشاء نسخة جديدة من فئة [Person](../).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| last | const System::String\& | الاسم الأخير. |
| first | const System::String\& | الاسم الأخير. |
| middle | const System::String\& | الاسم الأخير. |
