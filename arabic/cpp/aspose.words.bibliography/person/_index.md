---
title: "Aspose::Words::Bibliography::Person فئة"
linktitle: "Person"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Bibliography::Person فئة. تمثل مساهمًا فرديًا (شخصًا) في مصدر الببليوغرافيا في C++."
type: docs
weight: 625
url: /ar/cpp/aspose.words.bibliography/person/
---
## Person class


يمثل مساهمًا في مصدر الببليوغرافيا من نوع فرد (شخص).
...
| [get_First](./get_first/)() const | يحصل أو يضبط الاسم الأول لشخص. |
| [get_Last](./get_last/)() const | يحصل أو يضبط اسم العائلة لشخص. |
| [get_Middle](./get_middle/)() const | يحصل أو يضبط الاسم الأوسط لشخص. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | تهيئة نسخة جديدة من فئة [Person](./). |
| [set_First](./set_first/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | مُعيّن لـ [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
