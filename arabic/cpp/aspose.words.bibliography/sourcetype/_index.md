---
title: "عدد Aspose::Words::Bibliography::SourceType"
linktitle: "SourceType"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "عدد Aspose::Words::Bibliography::SourceType. يمثل أنواع مصادر الببليوغرافيا في C++."
type: docs
weight: 1000
url: /ar/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| ArticleInAPeriodical | 0 | يحدد المقال في مصدر دوري. |
| Book | 1 | يحدد مصدر الكتاب. |
| BookSection | 2 | يحدد مصدر قسم الكتاب. |
| JournalArticle | 3 | يحدد مصدر المقالة في المجلة. |
| محاضر المؤتمر | 4 | يحدد مصدر محاضر المؤتمر. |
| تقرير | 5 | يحدد مصدر المراسل. |
| تسجيل صوتي | 6 | يحدد مصدر التسجيل الصوتي. |
| أداء | 7 | يحدد مصدر الأداء. |
| فن | 8 | يحدد مصدر الفن. |
| مستند من موقع الإنترنت | 9 | يحدد مصدر المستند من موقع الإنترنت. |
| موقع الإنترنت | 10 | يحدد مصدر موقع الإنترنت. |
| فيلم | 11 | يحدد مصدر الفيلم. |
| مقابلة | 12 | يحدد مصدر المقابلة. |
| براءة اختراع | 13 | يحدد مصدر براءة الاختراع. |
| إلكتروني | 14 | يحدد المصدر الإلكتروني. |
| قضية | 15 | يحدد مصدر القضية. |
| متنوع | 16 | يحدد المصدر المتنوع. |
