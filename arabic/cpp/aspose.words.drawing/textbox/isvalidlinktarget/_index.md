---
title: "Aspose::Words::Drawing::TextBox::IsValidLinkTarget طريقة"
linktitle: "IsValidLinkTarget"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::TextBox::IsValidLinkTarget طريقة. يحدد ما إذا كان يمكن ربط هذا TextBox بـ TextBox الهدف في C++."
type: docs
weight: 17000
url: /ar/cpp/aspose.words.drawing/textbox/isvalidlinktarget/
---
## TextBox::IsValidLinkTarget method


يحدد ما إذا كان يمكن ربط هذا [TextBox](../) بـ [TextBox](../) الهدف.
...
// إنشاء روابط بين بعض صناديق النص.
...
// يمكن فقط لصندوق نص فارغ أن يحتوي على رابط.
...
if (textBox3->get_Next() == nullptr && textBox3->get_Previous() != nullptr)
{
    ...
    // قم بقطع الرابط الأمامي بين textBox2 و textBox3، ثم تحقق من أنهما لم يعودا مرتبطين.
