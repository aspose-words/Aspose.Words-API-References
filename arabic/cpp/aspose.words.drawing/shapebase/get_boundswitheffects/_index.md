---
title: "Aspose::Words::Drawing::ShapeBase::get_BoundsWithEffects طريقة"
linktitle: "get_BoundsWithEffects"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::ShapeBase::get_BoundsWithEffects طريقة. يحصل على الامتداد النهائي الذي يمتلكه كائن الشكل بعد تطبيق تأثيرات الرسم. القيمة مقاسة بالنقاط في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.drawing/shapebase/get_boundswitheffects/
---
## ShapeBase::get_BoundsWithEffects method


يحصل على الامتداد النهائي لهذا الكائن الشكل بعد تطبيق تأثيرات الرسم. القيمة مقاسة بالنقاط.
