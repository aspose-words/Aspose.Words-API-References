...
description: "Aspose::Words::Drawing::ShapeBase::get_DistanceRight method. يُرجع أو يعيّن المسافة (بالنقاط) بين نص المستند والحافة اليمنى للشكل في C++."
type: docs
weight: 17000
url: /ar/cpp/aspose.words.drawing/shapebase/get_distanceright/
---
## ShapeBase::get_DistanceRight method


يرجع أو يضبط المسافة (بالنقاط) بين نص المستند والحافة اليمنى للشكل.
