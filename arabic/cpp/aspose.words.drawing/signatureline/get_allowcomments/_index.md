---
title: "Aspose::Words::Drawing::SignatureLine::get_AllowComments طريقة"
linktitle: "get_AllowComments"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::SignatureLine::get_AllowComments طريقة. يحصل أو يعيّن قيمة تشير إلى أن المُوقّع يمكنه إضافة تعليقات في مربع حوار التوقيع. القيمة الافتراضية لهذه الخاصية هي false في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.drawing/signatureline/get_allowcomments/
---
## SignatureLine::get_AllowComments method


يحصل أو يعيّن قيمة تشير إلى أن الموقّع يمكنه إضافة تعليقات في مربع حوار التوقيع. القيمة الافتراضية لهذه الخاصية هي **false**
