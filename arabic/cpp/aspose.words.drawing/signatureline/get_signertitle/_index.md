---
title: "طريقة Aspose::Words::Drawing::SignatureLine::get_SignerTitle"
linktitle: "get_SignerTitle"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::SignatureLine::get_SignerTitle. يحصل أو يضبط لقب الموقع المقترح (مثال، Manager). القيمة الافتراضية لهذه الخاصية هي empty string في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.drawing/signatureline/get_signertitle/
---
## SignatureLine::get_SignerTitle method


يحصل أو يعيّن لقب الموقع المقترح (مثال: مدير). القيمة الافتراضية لهذه الخاصية هي **empty string**.
