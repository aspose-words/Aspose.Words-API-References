---
title: "Aspose::Words::Drawing::GradientStyle تعداد"
linktitle: "GradientStyle"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Drawing::GradientStyle تعداد. يحدد النمط لتعبئة التدرج في C++."
type: docs
weight: 24000
url: /ar/cpp/aspose.words.drawing/gradientstyle/
---
## GradientStyle enum
...
| --- | --- | --- |
| None | -1 | بدون تدرج. |
| أفقي | 1 | تدرج يمتد أفقياً عبر كائن. |
| عمودي | 2 | تدرج يمتد عمودياً عبر كائن. |
| DiagonalUp | 3 | تدرج قطري يتحرك من زاوية سفلية إلى الزاوية المقابلة. |
| DiagonalDown | 4 | تدرج قطري يتحرك من زاوية علوية إلى الزاوية المقابلة. |
| FromCorner | 5 | تدرج يمتد من زاوية إلى الزوايا الثلاث الأخرى. |
| FromCenter | 6 | تدرج يمتد من المركز إلى الزوايا. |
