---
title: "طريقة Aspose::Words::Drawing::ImageData::get_CropBottom"
linktitle: "get_CropBottom"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::ImageData::get_CropBottom. يحدد نسبة إزالة الصورة من الجانب السفلي في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.drawing/imagedata/get_cropbottom/
---
## ImageData::get_CropBottom method


يحدد جزء إزالة الصورة من الجانب السفلي.
...
يمكن أن يتراوح مقدار القص من -1.0 إلى 1.0. القيمة الافتراضية هي 0. لاحظ أن القيمة 1 ستؤدي إلى عدم عرض أي صورة على الإطلاق. القيم السالبة ستؤدي إلى ضغط الصورة نحو الداخل من الحافة المقصوصة (سيتم ملء الفراغ بين الصورة والحافة المقصوصة بلون تعبئة الشكل). القيم الإيجابية الأقل من 1 ستؤدي إلى تمديد الصورة المتبقية لتناسب الشكل.
