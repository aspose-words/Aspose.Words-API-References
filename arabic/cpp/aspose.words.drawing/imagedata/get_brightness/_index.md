---
title: "طريقة Aspose::Words::Drawing::ImageData::get_Brightness"
linktitle: "get_Brightness"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::ImageData::get_Brightness. يحصل على سطوع الصورة أو يضبطه. يجب أن تكون قيمة هذه الخاصية رقمًا من 0.0 (أكثر قتامة) إلى 1.0 (أكثر إشراقًا) في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.drawing/imagedata/get_brightness/
---
## ImageData::get_Brightness method


يحصل أو يضبط سطوع الصورة. يجب أن تكون قيمة هذه الخاصية رقمًا بين 0.0 (أكثر تعتيمًا) إلى 1.0 (أكثر سطوعًا).
