---
title: "طريقة Aspose::Words::Drawing::OleFormat::GetOleEntry"
linktitle: "GetOleEntry"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::OleFormat::GetOleEntry. يحصل على مدخل بيانات كائن OLE في C++."
type: docs
weight: 15000
url: /ar/cpp/aspose.words.drawing/oleformat/getoleentry/
---
## OleFormat::GetOleEntry method


يحصل على مدخل بيانات كائن OLE.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| oleEntryName | const System::String\& | اسم حساس لحالة الأحرف لتدفق بيانات OLE. |

### ReturnValue

تدفق بيانات OLE أو **null**.
