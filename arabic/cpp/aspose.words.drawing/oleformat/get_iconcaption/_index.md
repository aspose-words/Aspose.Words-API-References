---
title: "طريقة Aspose::Words::Drawing::OleFormat::get_IconCaption"
linktitle: "get_IconCaption"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::OleFormat::get_IconCaption. يحصل على تسمية أيقونة كائن OLE. في حال عدم وجود أيقونة للكائن OLE أو تعذر استرجاع التسمية، تُرجع سلسلة فارغة في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.drawing/oleformat/get_iconcaption/
---
## OleFormat::get_IconCaption method


يحصل على تسمية أيقونة كائن OLE. في حال عدم وجود أيقونة لكائن OLE أو عدم إمكانية استرجاع التسمية، يُرجع سلسلة فارغة.
