---
title: "طريقة Aspose::Words::Drawing::GlowFormat::get_Radius"
linktitle: "get_Radius"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::GlowFormat::get_Radius. يحصل أو يعيّن قيمة مزدوجة تمثل طول نصف القطر لتأثير التوهج بالنقاط (pt). القيمة الافتراضية هي 0.0 في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.drawing/glowformat/get_radius/
---
## GlowFormat::get_Radius method


يسترجع أو يعيّن قيمة مزدوجة تمثل طول نصف القطر لتأثير التوهج بالنقاط (pt). القيمة الافتراضية هي 0.0.
