---
title: "Aspose::Words::Drawing::GradientStop::GradientStop منشئ"
linktitle: "GradientStop"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "منشئ Aspose::Words::Drawing::GradientStop::GradientStop. يهيئ نسخة جديدة من فئة GradientStop في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
## GradientStop::GradientStop(System::Drawing::Color, double) constructor


يهيئ نسخة جديدة من الفئة [GradientStop](../).
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| color | System::Drawing::Color | يمثل لون نقطة التدرج. |
| position | double | يمثل موضع نقطة داخل التدرج معبرًا عنها كنسبة مئوية في النطاق من 0.0 إلى 1.0. |
