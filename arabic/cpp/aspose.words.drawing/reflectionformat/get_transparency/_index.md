---
title: "طريقة Aspose::Words::Drawing::ReflectionFormat::get_Transparency"
linktitle: "get_Transparency"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Drawing::ReflectionFormat::get_Transparency. يحصل على أو يضبط قيمة مزدوجة بين 0.0 (معتم) و 1.0 (شفاف) تمثل درجة الشفافية لتأثير الانعكاس. القيمة الافتراضية هي 0.0 في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.drawing/reflectionformat/get_transparency/
---
## ReflectionFormat::get_Transparency method


يحصل أو يعيّن قيمة مزدوجة بين 0.0 (معتم) و 1.0 (شفاف) تمثل درجة الشفافية لتأثير الانعكاس. القيمة الافتراضية هي 0.0.
