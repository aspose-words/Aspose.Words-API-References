...
description: "Aspose::Words::Notes::EndnotePosition enum. يحدد موضع الحاشية السفلية في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.notes/endnoteposition/
---
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| EndOfSection | 0 | تُخرج الحواشي السفلية في نهاية القسم. |
| EndOfDocument | 3 | تُخرج الحواشي السفلية في نهاية المستند. |
