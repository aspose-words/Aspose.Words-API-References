---
title: "فئة Aspose::Words::Notes::EndnoteOptions"
linktitle: "EndnoteOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Notes::EndnoteOptions. تمثل خيارات ترقيم الهوامش النهائية لمستند أو قسم. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 1000
url: /ar/cpp/aspose.words.notes/endnoteoptions/
---
## EndnoteOptions class


يمثل خيارات ترقيم الهوامش الختامية لمستند أو قسم. لمعرفة المزيد، زر مقالة الوثائق [Working with Footnote and Endnote](https://docs.aspose.com/words/cpp/working-with-footnote-and-endnote/).
...
| طريقة | الوصف |
| --- | --- |
| [get_NumberStyle](./get_numberstyle/)() override | يحدد تنسيق الرقم للهوامش النهائية المرقمة تلقائيًا. |
...
| [get_StartNumber](./get_startnumber/)() override | يحدد الرقم أو الحرف الابتدائي للحواشي السفلية المرقمة تلقائيًا الأولى. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_NumberStyle](./set_numberstyle/)(Aspose::Words::NumberStyle) override | محدد لـ [Aspose::Words::Notes::EndnoteOptions::get_NumberStyle](./get_numberstyle/). |
| [set_Position](./set_position/)(Aspose::Words::Notes::EndnotePosition) | محدد لـ [Aspose::Words::Notes::EndnoteOptions::get_Position](./get_position/). |
| [set_RestartRule](./set_restartrule/)(Aspose::Words::Notes::FootnoteNumberingRule) override | محدد لـ [Aspose::Words::Notes::EndnoteOptions::get_RestartRule](./get_restartrule/). |
| [set_StartNumber](./set_startnumber/)(int32_t) override | محدد لـ [Aspose::Words::Notes::EndnoteOptions::get_StartNumber](./get_startnumber/). |
| static [Type](./type/)() |  |
