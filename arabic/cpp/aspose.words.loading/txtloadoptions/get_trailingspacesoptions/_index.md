---
title: "طريقة Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions"
linktitle: "get_TrailingSpacesOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions. تحصل أو تعيّن الخيار المفضّل لمعالجة المسافات المتتالية. القيمة الافتراضية هي Trim في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.loading/txtloadoptions/get_trailingspacesoptions/
---
## TxtLoadOptions::get_TrailingSpacesOptions method


تحصل أو تعيّن الخيار المفضّل لمعالجة المسافات المتتالية. القيمة الافتراضية هي [Trim](../../txttrailingspacesoptions/).
