...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. يحدد الخيارات المتاحة لمعالجة المسافات البادئة أثناء الاستيراد من ملف نصي في C++."
type: docs
weight: 18000
url: /ar/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


يحدد الخيارات المتاحة لمعالجة المسافات البادئة أثناء الاستيراد من ملف [Text](../../aspose.words/loadformat/) .
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| ConvertToIndent | 0 | يتم إزالة المسافات البادئة وتحويلها إلى إزاحة إلى اليسار. |
| Trim | 1 | يتم قص المسافات البادئة. |
