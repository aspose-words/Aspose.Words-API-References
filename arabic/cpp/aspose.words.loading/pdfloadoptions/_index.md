---
title: "فئة Aspose::Words::Loading::PdfLoadOptions"
linktitle: "PdfLoadOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Loading::PdfLoadOptions. تسمح بتحديد خيارات إضافية عند تحميل مستند Pdf إلى كائن Document. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.loading/pdfloadoptions/
---
## PdfLoadOptions class


السماح بتحديد خيارات إضافية عند تحميل مستند Pdf إلى كائن [Document](../../aspose.words/document/) . لمعرفة المزيد، زر مقالة الوثائق [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_PageCount](./get_pagecount/)() const | يحصل على عدد الصفحات التي سيتم قراءتها. القيمة الافتراضية هي MaxValue والتي تعني أن جميع صفحات المستند ستُقرأ. |
| [get_PageIndex](./get_pageindex/)() const | يحصل على الفهرس صفر‑الأساس للصفحة الأولى التي سيتم قراءتها. القيمة الافتراضية هي 0. |
...
| [get_SkipPdfImages](./get_skippdfimages/)() const | يحصل على العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. القيمة الافتراضية هي **false**. |
...
| [set_PageCount](./set_pagecount/)(int32_t) | يضبط عدد الصفحات التي سيتم قراءتها. القيمة الافتراضية هي MaxValue والتي تعني أن جميع صفحات المستند ستُقرأ. |
| [set_PageIndex](./set_pageindex/)(int32_t) | يضبط الفهرس القائم على الصفر للصفحة الأولى للقراءة. القيمة الافتراضية هي 0. |
...
| [set_SkipPdfImages](./set_skippdfimages/)(bool) | يضبط العلامة التي تشير إلى ما إذا كان يجب تخطي الصور أثناء تحميل مستند PDF. القيمة الافتراضية هي **false**. |
