---
title: "Aspose::Words::Tables::CellFormat::get_RightPadding طريقة"
linktitle: "get_RightPadding"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Tables::CellFormat::get_RightPadding طريقة. تُرجع أو تُعيّن مقدار المسافة (بالنقاط) لإضافتها إلى يمين محتويات الخلية في C++."
type: docs
weight: 10000
url: /ar/cpp/aspose.words.tables/cellformat/get_rightpadding/
---
## CellFormat::get_RightPadding method


يرجع أو يضبط مقدار المسافة (بالنقاط) لإضافتها إلى يمين محتويات الخلية.
