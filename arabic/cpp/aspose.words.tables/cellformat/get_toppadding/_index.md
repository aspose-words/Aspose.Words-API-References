---
title: "Aspose::Words::Tables::CellFormat::get_TopPadding طريقة"
linktitle: "get_TopPadding"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Tables::CellFormat::get_TopPadding طريقة. تُرجع أو تُعيّن مقدار المسافة (بالنقاط) لإضافتها فوق محتويات الخلية في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.tables/cellformat/get_toppadding/
---
## CellFormat::get_TopPadding method


يرجع أو يضبط مقدار المسافة (بالنقاط) لإضافتها فوق محتويات الخلية.
