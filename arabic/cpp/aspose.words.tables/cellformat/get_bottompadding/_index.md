---
title: "طريقة Aspose::Words::Tables::CellFormat::get_BottomPadding"
linktitle: "get_BottomPadding"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Tables::CellFormat::get_BottomPadding. تُرجع أو تُعيّن مقدار المسافة (بالنقاط) لإضافتها أسفل محتويات الخلية في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.tables/cellformat/get_bottompadding/
---
## CellFormat::get_BottomPadding method


يرجع أو يضبط مقدار المسافة (بالنقاط) لإضافتها أسفل محتويات الخلية.
