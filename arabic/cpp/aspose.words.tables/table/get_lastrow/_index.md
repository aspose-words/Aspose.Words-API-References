---
title: "طريقة Aspose::Words::Tables::Table::get_LastRow"
linktitle: "get_LastRow"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Tables::Table::get_LastRow. تُرجع آخر عقدة Row في الجدول في C++."
type: docs
weight: 25000
url: /ar/cpp/aspose.words.tables/table/get_lastrow/
---
## Table::get_LastRow method


تُرجع آخر عقدة [Row](../../row/) في الجدول.
