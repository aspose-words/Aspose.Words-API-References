...
description: "Aspose::Words::Tables::CellVerticalAlignment enum. يحدد محاذاة النص عموديًا داخل خلية جدول في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.tables/cellverticalalignment/
---
## CellVerticalAlignment enum


يحدد محاذاة النص عموديًا داخل خلية الجدول.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| أعلى | 0 | النص محاذى إلى أعلى الخلية. |
| وسط | 1 | النص محاذى في وسط الخلية. |
| أسفل | 2 | النص محاذى إلى أسفل الخلية. |
