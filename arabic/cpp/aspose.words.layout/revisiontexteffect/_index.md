...
description: "Aspose::Words::Layout::RevisionTextEffect enum. يسمح بتحديد تأثير الزخرفة للمراجعات لنص المستند في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.layout/revisiontexteffect/
---
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| None | 0 | المحتوى المُراجَع لا يُطبق عليه أي تأثيرات خاصة. وهذا يتطابق مع [NoHighlight](../revisioncolor/). |
| اللون | 1 | المحتوى المُراجَع مُبرز باللون فقط. |
| عريض | 2 | يتم جعل المحتوى المعدل غامقًا وملونًا. |
| مائل | 3 | يتم جعل المحتوى المعدل مائلًا وملونًا. |
| تسطير | 4 | يتم وضع خط تحت المحتوى المعدل وتلوينه. |
| تسطير مزدوج | 5 | يتم وضع خط مزدوج تحت المحتوى المعدل وتلوينه. |
| شطب | 6 | يتم شطب المحتوى المعدل وتلوينه. |
| شطب مزدوج | 7 | يتم شطب المحتوى المعدل مرتين وتلوينه. |
| مخفي | 8 | المحتوى المعدل مخفي. |
