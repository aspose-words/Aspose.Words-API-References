---
title: "طريقة Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned"
linktitle: "GetNumPagesSpanned"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned. يحصل على عدد الصفحات التي تمتد إليها العقدة المحددة. 0 إذا كانت العقدة ضمن صفحة واحدة. هذا يساوي GetEndPageIndex() - GetStartPageIndex() في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


يحصل على عدد الصفحات التي تغطيها العقدة المحددة. 0 إذا كانت العقدة ضمن صفحة واحدة. هذا يساوي [GetEndPageIndex()](../) - [GetStartPageIndex()](../).
