---
title: "منشئ Aspose::Words::Layout::LayoutCollector::LayoutCollector"
linktitle: "LayoutCollector"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "منشئ Aspose::Words::Layout::LayoutCollector::LayoutCollector. يهيئ مثيلاً من هذه الفئة في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.layout/layoutcollector/layoutcollector/
---
## LayoutCollector::LayoutCollector constructor


يُهيئ مثيلًا من هذه الفئة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| doc | const System::SharedPtr\<Aspose::Words::Document\>\& | المستند الذي سيتم إرفاق مثيل هذا الجامع به. |
