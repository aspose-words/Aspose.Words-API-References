---
title: "طريقة Aspose::Words::Layout::LayoutCollector::Clear"
linktitle: "Clear"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::LayoutCollector::Clear. تمسح جميع بيانات التخطيط المجمعة. استدعِ هذه الطريقة بعد تحديث المستند يدويًا، أو بعد إعادة بناء التخطيط في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.layout/layoutcollector/clear/
---
## LayoutCollector::Clear method


يمسح جميع بيانات التخطيط المجمعة. استدعِ هذه الطريقة بعد تحديث المستند يدويًا، أو إعادة بناء التخطيط.
