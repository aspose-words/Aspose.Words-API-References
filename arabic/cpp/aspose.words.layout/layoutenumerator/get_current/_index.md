---
title: "طريقة Aspose::Words::Layout::LayoutEnumerator::get_Current"
linktitle: "get_Current"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::LayoutEnumerator::get_Current. يحصل أو يضبط الموضع الحالي في نموذج تخطيط الصفحة. تُعيد هذه الخاصية كائنًا غير شفاف يتطابق مع الكيان الحالي في التخطيط في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.layout/layoutenumerator/get_current/
---
## LayoutEnumerator::get_Current method


يحصل على أو يعيّن الموضع الحالي في نموذج تخطيط الصفحة. تُعيد هذه الخاصية كائنًا غير شفاف يتCorrespond إلى كائن التخطيط الحالي.
