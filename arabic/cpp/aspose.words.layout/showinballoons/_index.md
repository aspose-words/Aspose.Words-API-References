---
title: "Aspose::Words::Layout::ShowInBalloons تعداد"
linktitle: "ShowInBalloons"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Layout::ShowInBalloons تعداد. يحدد أي المراجعات تُعرض في الفقاعات في C++."
type: docs
weight: 13000
url: /ar/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


يحدد أي المراجعات تُعرض في الفقاعات.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| None | 0 | يعرض إدراج، حذف وتنسيق المراجعات داخل السطر. |
| تنسيق | 1 | يعرض إدراج وحذف المراجعات داخل السطر، وتنسيق المراجعات في الفقاعات. |
| FormatAndDelete | 2 | يعرض مراجعات الإدراج مضمّنة، ومراجعات الحذف والتنسيق في الفقاعات. |
