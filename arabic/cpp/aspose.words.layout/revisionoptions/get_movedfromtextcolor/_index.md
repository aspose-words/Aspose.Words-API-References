---
title: "طريقة Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor"
linktitle: "get_MovedFromTextColor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor. يسمح بتحديد اللون الذي سيُستخدم للمناطق التي تم نقل المحتوى منها في حالة Moving. القيمة الافتراضية هي ByAuthor في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


يسمح بتحديد اللون الذي سيُستخدم للمناطق التي تم نقل المحتوى منها [Moving](../../../aspose.words/revisiontype/). القيمة الافتراضية هي [ByAuthor](../../revisioncolor/).
