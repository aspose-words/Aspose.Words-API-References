...
description: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons method. تسمح بتحديد ما إذا كانت المراجعات تُعرض في الفقاعات. القيمة الافتراضية هي None في C++."
type: docs
weight: 17000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_showinballoons/
---
## RevisionOptions::get_ShowInBalloons method


تسمح بتحديد ما إذا كانت المراجعات تُعرض في الفقاعات. القيمة الافتراضية هي [None](../../showinballoons/).
...
يعرض كيفية عرض المراجعات في الفقاعات.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>(get_MyDir() + u"Revisions.docx");

// بشكل افتراضي، النص الذي يمثل مراجعة يكون بلون مختلف لتمييزه عن النص غير المراجَع الآخر.
// قم بتعيين خيار مراجعة لعرض مزيد من التفاصيل حول كل مراجعة في فقاعة على الهامش الأيمن للصفحة.
