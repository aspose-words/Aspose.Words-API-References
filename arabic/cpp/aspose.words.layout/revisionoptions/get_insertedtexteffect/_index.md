...
description: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect method. تسمح بتحديد التأثير الذي سيُطبق على المحتوى المُدرج Insertion. القيمة الافتراضية هي Underline في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_insertedtexteffect/
---
## RevisionOptions::get_InsertedTextEffect method


تسمح بتحديد التأثير الذي سيُطبق على المحتوى المُدرج [Insertion](../../../aspose.words/revisiontype/). القيمة الافتراضية هي [Underline](../../revisiontexteffect/).
