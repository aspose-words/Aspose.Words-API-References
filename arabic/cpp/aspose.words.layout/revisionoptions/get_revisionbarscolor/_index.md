---
title: "طريقة Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor"
linktitle: "get_RevisionBarsColor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor. يسمح بتحديد اللون المستخدم للأشرطة الجانبية التي تحدد أسطر المستند التي تحتوي على معلومات مُعدَّلة. القيمة الافتراضية هي Red في C++."
type: docs
weight: 14000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


يسمح بتحديد اللون المستخدم للأشرطة الجانبية التي تحدد أسطر المستند التي تحتوي على معلومات مُعدَّلة. القيمة الافتراضية هي [Red](../../revisioncolor/).
