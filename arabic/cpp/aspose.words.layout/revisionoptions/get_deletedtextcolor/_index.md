---
title: "طريقة Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor"
linktitle: "get_DeletedTextColor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor. يسمح بتحديد اللون المستخدم للمحتوى المحذوف Deletion. القيمة الافتراضية هي ByAuthor في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


يسمح بتحديد اللون المستخدم للمحتوى المحذوف [Deletion](../../../aspose.words/revisiontype/). القيمة الافتراضية هي [ByAuthor](../../revisioncolor/).
