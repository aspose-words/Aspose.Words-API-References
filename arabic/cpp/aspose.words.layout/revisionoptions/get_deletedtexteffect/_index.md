---
title: "طريقة Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect"
linktitle: "get_DeletedTextEffect"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect. يسمح بتحديد التأثير الذي سيُطبق على المحتوى المحذوف Deletion. القيمة الافتراضية هي StrikeThrough في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


يسمح بتحديد التأثير الذي سيُطبق على المحتوى المحذوف [Deletion](../../../aspose.words/revisiontype/). القيمة الافتراضية هي [StrikeThrough](../../revisiontexteffect/)
