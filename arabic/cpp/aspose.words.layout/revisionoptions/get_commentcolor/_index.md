---
title: "Aspose::Words::Layout::RevisionOptions::get_CommentColor طريقة"
linktitle: "get_CommentColor"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Layout::RevisionOptions::get_CommentColor طريقة. يسمح بتحديد اللون المستخدم للتعليقات. القيمة الافتراضية هي Red في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


يسمح بتحديد اللون المستخدم للتعليقات. القيمة الافتراضية هي [Red](../../revisioncolor/).
