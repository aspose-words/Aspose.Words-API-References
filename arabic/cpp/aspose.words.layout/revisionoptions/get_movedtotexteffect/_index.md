---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect طريقة"
linktitle: "get_MovedToTextEffect"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect طريقة. يسمح بتحديد التأثير الذي سيُطبق على المناطق التي تم نقل المحتوى إليها Moving. القيمة الافتراضية هي DoubleUnderline في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.layout/revisionoptions/get_movedtotexteffect/
---
## RevisionOptions::get_MovedToTextEffect method


يسمح بتحديد التأثير الذي سيُطبق على المناطق التي تم نقل المحتوى إليها [Moving](../../../aspose.words/revisiontype/). القيمة الافتراضية هي [DoubleUnderline](../../revisiontexteffect/)
