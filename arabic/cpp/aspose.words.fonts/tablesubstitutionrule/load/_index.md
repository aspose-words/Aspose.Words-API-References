...
description: "Aspose::Words::Fonts::TableSubstitutionRule::Load method. يحمل إعدادات استبدال الجدول من تدفق XML في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.fonts/tablesubstitutionrule/load/
---
## TableSubstitutionRule::Load(const System::SharedPtr\<System::IO::Stream\>\&) method


يقوم بتحميل إعدادات استبدال الجداول من تدفق XML.
