...
description: "Aspose::Words::Fonts::FontPitch enum. يمثل درجة الخط في C++."
type: docs
weight: 22000
url: /ar/cpp/aspose.words.fonts/fontpitch/
---
## FontPitch enum
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| افتراضي | 0 | يحدد أنه لا تتوفر معلومات حول درجة الخط. |
| ثابت | 1 | يحدد أن هذا خط بعرض ثابت. |
| متغير | 2 | يحدد أن هذا خط بعرض متناسب. |
