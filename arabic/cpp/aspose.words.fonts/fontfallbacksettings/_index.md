---
title: "فئة Aspose::Words::Fonts::FontFallbackSettings"
linktitle: "FontFallbackSettings"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Fonts::FontFallbackSettings. تحدد إعدادات آلية احتياطي الخط. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.fonts/fontfallbacksettings/
---
## FontFallbackSettings class


يحدد إعدادات آلية الاحتياطي للخط. لمعرفة المزيد، زر مقالة الوثائق [Working with Fonts](https://docs.aspose.com/words/cpp/working-with-fonts/).
...
| طريقة | الوصف |
| --- | --- |
| [BuildAutomatic](./buildautomatic/)() | يبني إعدادات الاحتياطي تلقائيًا عن طريق مسح الخطوط المتاحة. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Load](./load/)(const System::String\&) | يقوم بتحميل إعدادات احتياطي الخط من ملف XML. |
| [Load](./load/)(const System::SharedPtr\<System::IO::Stream\>\&) | يقوم بتحميل إعدادات الاحتياطي من تدفق XML. |
| [Load](./load/)(std::basic_istream\<CharType, Traits\>\&) |  |
| [LoadMsOfficeFallbackSettings](./loadmsofficefallbacksettings/)() | يقوم بتحميل إعدادات احتياطي مسبقة التعريف تحاكي احتياطي Microsoft Word وتستخدم خطوط Microsoft Office. |
| [LoadNotoFallbackSettings](./loadnotofallbacksettings/)() | يقوم بتحميل إعدادات احتياطي مسبقة التعريف التي تستخدم خطوط Google Noto. |
| [Save](./save/)(const System::SharedPtr\<System::IO::Stream\>\&) | يحفظ إعدادات الاحتياطي الحالية إلى التدفق. |
| [Save](./save/)(const System::String\&) | يحفظ إعدادات الاحتياطي الحالية إلى ملف. |
