...
description: "Aspose::Words::Rendering::OfficeMathRenderer::OfficeMathRenderer constructor. يهيئ نسخة جديدة من هذه الفئة في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.rendering/officemathrenderer/officemathrenderer/
---
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| math | const System::SharedPtr\<Aspose::Words::Math::OfficeMath\>\& | الكائن [OfficeMath](../../../aspose.words.math/officemath/) الذي تريد رسمه. |
