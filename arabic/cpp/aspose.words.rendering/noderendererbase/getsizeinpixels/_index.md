...
description: "Aspose::Words::Rendering::NodeRendererBase::GetSizeInPixels method. تحسب حجم الشكل بالبكسل لعامل تكبير ودقة محددين في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.rendering/noderendererbase/getsizeinpixels/
---
...
| dpi | float | الدقة (الأفقية والعمودية) للتحويل من النقاط إلى البكسل (نقطة لكل بوصة). |
...
تحول هذه الطريقة [SizeInPoints](../get_sizeinpoints/) إلى حجم بالبكسل وتكون مفيدة عندما تريد إنشاء صورة نقطية لتصوير الشكل بدقة على الصورة النقطية.
