...
description: "طريقة Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints. يحصل على الحجم الفعلي للشكل بالنقاط في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
...
هذه الخاصية تُعيد حجم الصندوق المحيط الفعلي (كما يُعرض على الصفحة) للشكل. يأخذ الحجم في الاعتبار دوران الشكل (إن وجد).
