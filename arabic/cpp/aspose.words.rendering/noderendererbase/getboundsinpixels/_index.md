...
description: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels طريقة. تحسب حدود الشكل بالبكسل لعامل تكبير ودقة محددين في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.rendering/noderendererbase/getboundsinpixels/
---
...
الصندوق المحيط الفعلي (كما يُعرض على الصفحة) للشكل بالبكسل.
## ملاحظات


هذه الطريقة تحول [BoundsInPoints](../get_boundsinpoints/) إلى مستطيل بالبكسل.
