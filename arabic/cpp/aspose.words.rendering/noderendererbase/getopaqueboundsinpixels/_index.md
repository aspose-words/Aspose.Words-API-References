...
description: "Aspose::Words::Rendering::NodeRendererBase::GetOpaqueBoundsInPixels طريقة. تحسب الحدود غير الشفافة للشكل بالبكسل لعامل تكبير ودقة محددين في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.rendering/noderendererbase/getopaqueboundsinpixels/
---
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| scale | float | عامل التكبير (1.0 يساوي 100%). |
| dpi | float | الدقة للتحويل من النقاط إلى البكسل (نقطة لكل بوصة). |

### ReturnValue

المستطيل غير الشفاف للشكل بالبكسل.
## ملاحظات


هذه الطريقة تحول [OpaqueBoundsInPoints](../get_opaqueboundsinpoints/) إلى مستطيل بالبكسل وتكون مفيدة عندما تريد إنشاء صورة نقطية لعرض الشكل مع الجزء غير الشفاف فقط من الشكل.
...
| --- | --- | --- |
| scale | float | عامل التكبير (1.0 يساوي 100%). |
| horizontalDpi | float | الدقة الأفقية للتحويل من النقاط إلى البكسل (نقطة لكل بوصة). |
| verticalDpi | float | الدقة العمودية للتحويل من النقاط إلى البكسل (نقطة لكل بوصة). |
