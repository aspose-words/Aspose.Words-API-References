---
title: "طريقة Aspose::Words::Settings::WriteProtection::SetPassword"
linktitle: "SetPassword"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Settings::WriteProtection::SetPassword. تعيين كلمة مرور الحماية للكتابة للمستند في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.settings/writeprotection/setpassword/
---
## WriteProtection::SetPassword method


يضبط كلمة مرور الحماية من الكتابة للمستند.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| password | const System::String\& | كلمة المرور المراد تعيينها. لا يمكن أن تكون **null**، ولكن يمكن أن تكون سلسلة فارغة. |
## ملاحظات
