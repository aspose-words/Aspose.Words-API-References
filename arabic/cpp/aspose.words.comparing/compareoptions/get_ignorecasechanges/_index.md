---
title: "Aspose::Words::Comparing::CompareOptions::get_IgnoreCaseChanges طريقة"
linktitle: "get_IgnoreCaseChanges"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Comparing::CompareOptions::get_IgnoreCaseChanges طريقة. صحيح يشير إلى أن مقارنة المستندات لا تفرق بين الأحرف في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.comparing/compareoptions/get_ignorecasechanges/
---
## CompareOptions::get_IgnoreCaseChanges method


True تشير إلى أن مقارنة المستندات غير حساسة لحالة الأحرف.
