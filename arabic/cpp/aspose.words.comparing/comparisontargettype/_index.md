...
description: "Aspose::Words::Comparing::ComparisonTargetType enum. يسمح بتحديد المستند الأساسي الذي سيُستخدم أثناء المقارنة. القيمة الافتراضية هي Current في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


يسمح بتحديد المستند الأساسي الذي سيُستخدم أثناء المقارنة. القيمة الافتراضية هي [Current](./).
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| Current | 0 | يُستخدم هذا المستند كأساس أثناء المقارنة. |
| جديد | 1 | يُستخدم مستند آخر كأساس أثناء المقارنة. |
