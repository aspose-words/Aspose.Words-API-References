---
title: "الفئة Aspose::Words::Lists::ListLevelCollection"
linktitle: "ListLevelCollection"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::Lists::ListLevelCollection. مجموعة من تنسيقات القائمة لكل مستوى في القائمة. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.lists/listlevelcollection/
---
## ListLevelCollection class


مجموعة من تنسيقات القوائم لكل مستوى في القائمة. لمعرفة المزيد، زر مقالة الوثائق [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/).
...
| [end](./end/)() |  |
| [end](./end/)() const |  |
| [get_Count](./get_count/)() | يحصل على عدد المستويات في هذه القائمة. |
| [GetEnumerator](./getenumerator/)() override | يحصل على كائن المُعدِّد الذي سيعدّ المستويات في هذه القائمة. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | يحصل على مستوى قائمة حسب الفهرس. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Lists::ListLevel\>\&) | يحصل على مستوى قائمة حسب الفهرس. |
