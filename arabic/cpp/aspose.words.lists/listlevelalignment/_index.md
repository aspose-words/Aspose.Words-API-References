...
description: "Aspose::Words::Lists::ListLevelAlignment enum. يحدد محاذاة رقم القائمة أو الرصاصة في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words.lists/listlevelalignment/
---
## ListLevelAlignment enum


يحدد محاذاة رقم القائمة أو الرصاصة.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| يسار | 0 | يتم محاذاة تسمية القائمة إلى اليسار من موضع الرقم. |
| وسط | 1 | تكون تسمية القائمة في وسط موضع الرقم. |
| يمين | 2 | يتم محاذاة تسمية القائمة إلى اليمين من موضع الرقم. |

## ملاحظات


يُستخدم كقيمة لخاصية [Alignment](../listlevel/get_alignment/).
