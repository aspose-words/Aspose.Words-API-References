---
title: "طريقة Aspose::Words::Lists::ListLevel::get_LinkedStyle"
linktitle: "get_LinkedStyle"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Lists::ListLevel::get_LinkedStyle. يحصل على أو يضبط نمط الفقرة المرتبط بهذا المستوى من القائمة في C++."
type: docs
weight: 11000
url: /ar/cpp/aspose.words.lists/listlevel/get_linkedstyle/
---
## ListLevel::get_LinkedStyle method


يحصل أو يضبط نمط الفقرة المرتبط بهذا المستوى من القائمة.
...
هذه الخاصية تكون **null** عندما لا يكون مستوى القائمة مرتبطًا بنمط فقرة. يمكن ضبط هذه الخاصية إلى **null**.
