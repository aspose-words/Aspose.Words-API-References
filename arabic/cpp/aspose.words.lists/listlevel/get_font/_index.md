---
title: "طريقة Aspose::Words::Lists::ListLevel::get_Font"
linktitle: "get_Font"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Lists::ListLevel::get_Font. تحدد تنسيق الأحرف المستخدم لتسمية القائمة في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.lists/listlevel/get_font/
---
## ListLevel::get_Font method


يحدد تنسيق الأحرف المستخدم لتسمية القائمة.
