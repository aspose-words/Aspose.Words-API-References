...
description: "Aspose::Words::Lists::List::get_ListId method. يحصل على المعرف الفريد للقائمة في C++."
type: docs
weight: 9000
url: /ar/cpp/aspose.words.lists/list/get_listid/
---
## List::get_ListId method


يحصل على المعرف الفريد للقائمة.
...
عادةً لا تحتاج إلى استخدام هذه الخاصية. ولكن إذا استخدمتها، فعادةً ما تفعل ذلك بالتزامن مع طريقة [GetListByListId()](../../listcollection/getlistbylistid/) للعثور على قائمة بواسطة معرفها.
