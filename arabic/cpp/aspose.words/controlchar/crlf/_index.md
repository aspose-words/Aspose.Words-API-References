---
title: "Aspose::Words::ControlChar::CrLf طريقة"
linktitle: "CrLf"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::ControlChar::CrLf طريقة. حرف عودة السطر متبوعًا بحرف سطر جديد: \"\\x000d\\x000a\" أو \"\\r\\n\". لا يُستخدم بهذه الطريقة في مستندات Microsoft Word، لكنه يُستخدم عادةً في ملفات النص لفواصل الفقرات في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words/controlchar/crlf/
---
## ControlChar::CrLf method


عودة السطر متبوعة بحرف تغذية السطر: "\x000d\x000a" أو "\r\n". لا يُستخدم بهذه الطريقة في مستندات Microsoft Word، لكنه يُستعمل عادةً في ملفات النص للفواصل الفقرية.
