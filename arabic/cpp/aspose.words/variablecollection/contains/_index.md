---
title: "Aspose::Words::VariableCollection::Contains طريقة"
linktitle: "Contains"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::VariableCollection::Contains. تحدد ما إذا كانت المجموعة تحتوي على متغير مستند بالاسم المحدد في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words/variablecollection/contains/
---
## VariableCollection::Contains method


يحدد ما إذا كانت المجموعة تحتوي على متغيّر مستند بالاسم المعطى.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| name | const System::String\& | الاسم غير حساس لحالة الأحرف لمتغير المستند المراد تحديده. |
