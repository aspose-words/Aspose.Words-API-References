---
title: "Aspose::Words::VariableCollection::idx_set طريقة"
linktitle: "idx_set"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::VariableCollection::idx_set. يحصل أو يضبط متغير مستند حسب الاسم غير حساس لحالة الأحرف. القيم null غير مسموح بها كجانب أيمن للتعيين وسيتم استبدالها بسلسلة فارغة في C++."
type: docs
weight: 13000
url: /ar/cpp/aspose.words/variablecollection/idx_set/
---
## VariableCollection::idx_set(const System::String\&, const System::String\&) method


يحصل أو يعيّن متغيّر مستند بالاسم غير حساس لحالة الأحرف. القيم **null** غير مسموح بها كقيمة على الجانب الأيمن من التعيين وستُستبدل بسلسلة فارغة.
...
يحصل أو يعيّن متغيّر مستند في الفهرس المحدد. القيم **null** غير مسموح بها كقيمة على الجانب الأيمن من التعيين وستُستبدل بسلسلة فارغة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| index | int32_t | الفهرس الصفري لمتغيّر المستند. |
