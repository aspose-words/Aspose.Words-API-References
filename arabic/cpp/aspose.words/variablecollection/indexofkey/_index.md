---
title: "Aspose::Words::VariableCollection::IndexOfKey طريقة"
linktitle: "IndexOfKey"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::VariableCollection::IndexOfKey طريقة. يرجع الفهرس الصفري للمتغيّر المستند المحدد في المجموعة في C++."
type: docs
weight: 14000
url: /ar/cpp/aspose.words/variablecollection/indexofkey/
---
## VariableCollection::IndexOfKey method


يعيد الفهرس الصفري للمتغيّر المستند المحدد في المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| name | const System::String\& | الاسم غير حساس لحالة الأحرف للمتغيّر. |
