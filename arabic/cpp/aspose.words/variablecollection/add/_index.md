---
title: "طريقة Aspose::Words::VariableCollection::Add"
linktitle: "Add"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::VariableCollection::Add. يضيف متغيّر مستند إلى المجموعة في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words/variablecollection/add/
---
## VariableCollection::Add method


يضيف متغيّر مستند إلى المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| name | const System::String\& | الاسم غير حساس لحالة الأحرف للمتغيّر المراد إضافته. |
| value | const System::String\& | قيمة المتغيّر. لا يمكن أن تكون القيمة **null**، إذا كانت القيمة null سيتم استخدام سلسلة فارغة بدلاً منها. |
