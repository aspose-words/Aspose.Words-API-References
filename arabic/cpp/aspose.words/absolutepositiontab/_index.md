---
title: "Aspose::Words::AbsolutePositionTab فئة"
linktitle: "AbsolutePositionTab"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::AbsolutePositionTab فئة. علامة التبويب ذات الموضع المطلق هي حرف يُستخدم لتقدم الموضع على السطر الحالي من النص عند عرض محتوى WordprocessingML هذا. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 1000
url: /ar/cpp/aspose.words/absolutepositiontab/
---
## AbsolutePositionTab class


علامة التبويب ذات الموضع المطلق هي حرف يُستخدم لتقدم الموضع على السطر الحالي من النص عند عرض محتوى WordprocessingML هذا. لمعرفة المزيد، زر مقالة الوثائق [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_NodeType](../specialchar/get_nodetype/)() const override | يعيد [SpecialChar](../nodetype/). |
...
| [GetText](../specialchar/gettext/)() override | يحصل على الحرف الخاص الذي تمثله هذه العقدة. |
