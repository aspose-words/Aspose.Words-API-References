---
title: "طريقة Aspose::Words::BookmarkCollection::Remove"
linktitle: "Remove"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::BookmarkCollection::Remove. تزيل العلامة المرجعية المحددة من المستند في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words/bookmarkcollection/remove/
---
## BookmarkCollection::Remove(const System::SharedPtr\<Aspose::Words::Bookmark\>\&) method


يزيل العلامة المرجعية المحددة من المستند.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| علامة مرجعية | const System::SharedPtr\<Aspose::Words::Bookmark\>\& | العلامة المرجعية التي سيتم إزالتها. |
...
يزيل علامة مرجعية بالاسم المحدد.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| bookmarkName | const System::String\& | اسم العلامة المرجعية غير حساس لحالة الأحرف الذي سيتم إزالته. |
