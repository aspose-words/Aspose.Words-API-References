---
title: "Aspose::Words::ConditionalStyleCollection::idx_get طريقة"
linktitle: "idx_get"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::ConditionalStyleCollection::idx_get طريقة. يسترجع كائن ConditionalStyle حسب نوع النمط الشرطي في C++."
type: docs
weight: 18000
url: /ar/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


يسترجع كائن [ConditionalStyle](../../conditionalstyle/) حسب نوع النمط الشرطي.
...
يسترجع كائن [ConditionalStyle](../../conditionalstyle/) حسب الفهرس.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| index | int32_t | الفهرس الصفري للنسق الشرطي المراد استرجاعه. |
