...
description: "Aspose::Words::RevisionType enum. يحدد نوع التغيير الذي يتم تتبعه في Revision في C++."
type: docs
weight: 113000
url: /ar/cpp/aspose.words/revisiontype/
---
## RevisionType enum


يحدد نوع التغيير الذي يتم تتبعه في [Revision](../revision/).
