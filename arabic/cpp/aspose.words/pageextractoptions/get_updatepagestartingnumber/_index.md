---
title: "طريقة Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber"
linktitle: "get_UpdatePageStartingNumber"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber. تحدد ما إذا كان رقم الصفحة الأول في المستند الناتج يجب تحديثه. القيمة الافتراضية هي true في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words/pageextractoptions/get_updatepagestartingnumber/
---
## PageExtractOptions::get_UpdatePageStartingNumber method


يحدد ما إذا كان رقم صفحة البداية في المستند الناتج سيُحدَّث. القيمة الافتراضية هي **true**.
