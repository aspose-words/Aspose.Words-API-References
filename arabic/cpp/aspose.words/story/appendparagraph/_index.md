---
title: "طريقة Aspose::Words::Story::AppendParagraph"
linktitle: "AppendParagraph"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Story::AppendParagraph. طريقة مختصرة تنشئ كائن Paragraph مع نص اختياري وتلحقه بنهاية هذا الكائن في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words/story/appendparagraph/
---
## Story::AppendParagraph method


طريقة مختصرة تنشئ كائن [Paragraph](../../paragraph/) مع نص اختياري وتلحقه بنهاية هذا الكائن.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| نص | const System::String\& | النص للفقرة. يمكن أن يكون **null** أو سلسلة فارغة. |
