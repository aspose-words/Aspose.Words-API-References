---
title: "Aspose::Words::TableStyle::get_ColumnStripe طريقة"
linktitle: "get_ColumnStripe"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::TableStyle::get_ColumnStripe طريقة. يحصل أو يضبط عدد الأعمدة لتضمينها في التظليل عندما يحدد النمط تظليل الأعمدة الزوجية/الفردية في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words/tablestyle/get_columnstripe/
---
## TableStyle::get_ColumnStripe method


يحصل أو يضبط عدد الأعمدة التي تُضمّن في التظليل عندما يحدد النمط تظليل الأعمدة الفردية/الزوجية.
