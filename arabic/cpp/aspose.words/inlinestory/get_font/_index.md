...
description: "Aspose::Words::InlineStory::get_Font method. يوفّر الوصول إلى تنسيق الخط لحرف المرجعية لهذا الكائن في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words/inlinestory/get_font/
---
## InlineStory::get_Font method


يوفر الوصول إلى تنسيق الخط لحرف المرجع لهذا الكائن.
