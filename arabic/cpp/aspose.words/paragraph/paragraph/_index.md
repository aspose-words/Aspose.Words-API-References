---
title: "Aspose::Words::Paragraph::Paragraph مُنشئ"
linktitle: "Paragraph"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Paragraph::Paragraph مُنشئ. يهيئ نسخة جديدة من فئة Paragraph في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words/paragraph/paragraph/
---
## Paragraph::Paragraph constructor


يُهيئ نسخة جديدة من الفئة [Paragraph](../).
...
عند إنشاء [Paragraph](../)، ينتمي إلى المستند المحدد، لكنه ليس جزءًا من المستند بعد و[ParentNode](../../node/get_parentnode/) هو **null**.

لإضافة [Paragraph](../) إلى المستند استخدم [InsertAfter1()</see> أو <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) في القصة حيث تريد إدراج الفقرة.
