...
description: "Aspose::Words::Section::Section constructor. يهيئ مثالًا جديدًا من فئة Section في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words/section/section/
---
## Section::Section constructor


يهيئ مثالًا جديدًا من فئة [Section](../).
...
عند إنشاء القسم، ينتمي إلى المستند المحدد، لكنه ليس بعد جزءًا من المستند و[ParentNode](../../node/get_parentnode/) هو **null**.

لإدراج [Section](../) في مستند، استخدم طرق [InsertAfter1()</see> و <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) الخاصة بـ [Document](../../document/) أو طرق [Add()](../) و [Insert()](../) الخاصة بخصية [Sections](../../document/get_sections/).
