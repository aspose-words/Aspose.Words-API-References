---
title: "Aspose::Words::Document::get_Revisions طريقة"
linktitle: "get_Revisions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Document::get_Revisions طريقة. يحصل على مجموعة من المراجعات (التغييرات المتتبعة) الموجودة في هذا المستند في C++."
type: docs
weight: 46000
url: /ar/cpp/aspose.words/document/get_revisions/
---
## Document::get_Revisions method


يحصل على مجموعة من المراجعات (التغييرات المتتبعة) الموجودة في هذا المستند.
