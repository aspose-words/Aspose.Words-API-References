...
description: "Aspose::Words::Document::get_EndnoteOptions method. يوفر خيارات تتحكم في ترقيم وتحديد موضع الحواشي السفلية في هذا المستند في C++."
type: docs
weight: 22000
url: /ar/cpp/aspose.words/document/get_endnoteoptions/
---
## Document::get_EndnoteOptions method


يوفر خيارات تتحكم في ترقيم وتحديد موضع الحواشي الختامية في هذا المستند.
