---
title: "Aspose::Words::Document::get_TrackRevisions طريقة"
linktitle: "get_TrackRevisions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Document::get_TrackRevisions طريقة. صحيح إذا تم تتبع التغييرات عندما يتم تحرير هذا المستند في Microsoft Word في C++."
type: docs
weight: 54000
url: /ar/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


صحيح إذا تم تتبع التغييرات عندما يتم تحرير هذا المستند في Microsoft Word.
...
ضبط هذا الخيار يوجه Microsoft Word فقط ما إذا كان تتبع التغييرات مفعلاً أم لا. هذه الخاصية لا تؤثر على التغييرات التي تجريها على المستند برمجيًا عبر Aspose.Words.

إذا كنت تريد تتبع التغييرات تلقائيًا كما يتم إجراؤها برمجيًا بواسطة [Aspose.Words](../../) على هذا المستند، استخدم طريقة [StartTrackRevisions()](../).
