...
description: "طريقة Aspose::Words::Document::get_Bibliography. يحصل على كائن Bibliography الذي يمثل قائمة المصادر المتاحة في المستند في C++."
type: docs
weight: 14500
url: /ar/cpp/aspose.words/document/get_bibliography/
---
## Document::get_Bibliography method


يحصل على كائن [Bibliography](./) الذي يمثل قائمة المصادر المتاحة في المستند.
