---
title: "طريقة Aspose::Words::Document::UpdateListLabels"
linktitle: "UpdateListLabels"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Document::UpdateListLabels. تُحدّث تسميات القوائم لجميع عناصر القائمة في المستند في C++."
type: docs
weight: 97000
url: /ar/cpp/aspose.words/document/updatelistlabels/
---
## Document::UpdateListLabels method


يحدّث تسميات القوائم لجميع عناصر القائمة في المستند.
...
تُحدّث هذه الطريقة خصائص تسمية القائمة مثل [LabelValue](../../../aspose.words.lists/listlabel/get_labelvalue/) و [LabelString](../../../aspose.words.lists/listlabel/get_labelstring/) لكل كائن [ListLabel](../../paragraph/get_listlabel/) في المستند.

أيضًا، تُستدعى هذه الطريقة أحيانًا بصورة ضمنية عند تحديث الحقول في المستند. هذا مطلوب لأن بعض الحقول التي قد تشير إلى أرقام القوائم (مثل TOC أو REF) تحتاج إلى أن تكون محدثة.
