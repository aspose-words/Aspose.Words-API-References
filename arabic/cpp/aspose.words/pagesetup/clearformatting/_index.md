...
description: "Aspose::Words::PageSetup::ClearFormatting method. يعيد إعداد الصفحة إلى حجم الورق الافتراضي والهوامش والاتجاه في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words/pagesetup/clearformatting/
---
## PageSetup::ClearFormatting method


يعيد إعداد الصفحة إلى حجم الورق الافتراضي، الهوامش والاتجاه.
