---
title: "الفئة Aspose::Words::EditableRangeEnd"
linktitle: "EditableRangeEnd"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "الفئة Aspose::Words::EditableRangeEnd. تمثل نهاية نطاق قابل للتحرير في مستند Word. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 25000
url: /ar/cpp/aspose.words/editablerangeend/
---
## EditableRangeEnd class


يمثل نهاية نطاق قابل للتحرير في مستند Word. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_EditableRangeStart](./get_editablerangestart/)() | المقابل [EditableRangeStart](../editablerangestart/)، تم استلامه بالمعرف. |
...
| [get_NodeType](./get_nodetype/)() const override | يرجع [EditableRangeEnd](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | محدد لـ [Aspose::Words::EditableRangeEnd::get_Id](./get_id/). |
...
يتكون نطاق قابل للتحرير كامل في مستند Word من [EditableRangeStart](./get_editablerangestart/) و[EditableRangeEnd](./) المطابقين بنفس المعرف.
...
استخدم الفئة [EditableRange](../editablerange/) كـ "واجهة" للعمل مع نطاق قابل للتحرير ككائن واحد.
