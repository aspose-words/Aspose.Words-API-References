...
description: "Aspose::Words::BreakType enum. يحدد نوع الفاصل داخل مستند في C++."
type: docs
weight: 82000
url: /ar/cpp/aspose.words/breaktype/
---
## BreakType enum
...
| SectionBreakContinuous | 3 | يحدد بدء قسم جديد على نفس الصفحة كما في القسم السابق. |
| SectionBreakNewColumn | 4 | يحدد بدء قسم جديد في العمود الجديد. |
| SectionBreakNewPage | 5 | يحدد بدء قسم جديد على صفحة جديدة. |
| SectionBreakEvenPage | 6 | يحدد بدء قسم جديد على صفحة زوجية جديدة. |
| SectionBreakOddPage | 7 | يحدد بدء قسم جديد على صفحة فردية. |
