---
title: "طريقة Aspose::Words::Node::PreviousPreOrder"
linktitle: "PreviousPreOrder"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Node::PreviousPreOrder. تحصل على العقدة السابقة وفقًا لخوارزمية استعراض الشجرة بترتيب ما قبل الترتيب في C++."
type: docs
weight: 19000
url: /ar/cpp/aspose.words/node/previouspreorder/
---
## Node::PreviousPreOrder method


يحصل على العقدة السابقة وفقًا لخوارزمية عبور الشجرة بترتيب ما قبل الترتيب.
...
العقدة السابقة بترتيب ما قبل الترتيب. تكون القيمة Null إذا تم الوصول إلى *rootNode*.
