---
title: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent طريقة"
linktitle: "get_CharacterUnitFirstLineIndent"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent طريقة. يحصل على أو يضبط القيمة (بالحروف) للمسافة البادئة للسطر الأول أو المتدلية. استخدم القيم الموجبة لضبط مسافة البادئة للسطر الأول، والقيم السالبة لضبط المسافة المتدلية في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words/paragraphformat/get_characterunitfirstlineindent/
---
## ParagraphFormat::get_CharacterUnitFirstLineIndent method


يحصل أو يضبط القيمة (بالحروف) للمسافة البادئة للسطر الأول أو المعلقة. استخدم القيم الموجبة لضبط مسافة البادئة للسطر الأول، والقيم السالبة لضبط المسافة المعلقة.
