---
title: "طريقة Aspose::Words::CleanupOptions::get_UnusedLists"
linktitle: "get_UnusedLists"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::CleanupOptions::get_UnusedLists. يحدد ما إذا كان يجب إزالة القوائم غير المستخدمة وتعريفات القوائم من المستند. القيمة الافتراضية هي true في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words/cleanupoptions/get_unusedlists/
---
## CleanupOptions::get_UnusedLists method


يحدد ما إذا كان يجب إزالة القوائم غير المستخدمة وتعريفات القوائم من المستند. القيمة الافتراضية هي **true**.
