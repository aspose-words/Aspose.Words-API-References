---
title: "Aspose::Words::Revision::get_ParentStyle طريقة"
linktitle: "get_ParentStyle"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Revision::get_ParentStyle طريقة. يحصل على النمط الأب الفوري (المالك) لهذا التعديل. هذه الخاصية ستعمل فقط لنوع التعديل StyleDefinitionChange في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words/revision/get_parentstyle/
---
## Revision::get_ParentStyle method


يحصل على النمط الأب الفوري (المالك) لهذا التعديل. هذه الخاصية ستعمل فقط لنوع التعديل [StyleDefinitionChange](../../revisiontype/).
