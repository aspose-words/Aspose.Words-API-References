---
title: "طريقة Aspose::Words::Revision::get_ParentNode"
linktitle: "get_ParentNode"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Revision::get_ParentNode. يحصل على العقدة الأصلية الفورية (المالك) لهذا التعديل. هذه الخاصية ستعمل لأي نوع تعديل باستثناء StyleDefinitionChange في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


يحصل على العقدة الأصلية الفورية (المالك) لهذا التعديل. هذه الخاصية ستعمل لأي نوع تعديل باستثناء [StyleDefinitionChange](../../revisiontype/).
