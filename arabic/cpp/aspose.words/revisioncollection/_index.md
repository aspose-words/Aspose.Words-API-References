...
description: "Aspose::Words::RevisionCollection class. مجموعة من كائنات Revision التي تمثل المراجعات في المستند. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 53000
url: /ar/cpp/aspose.words/revisioncollection/
---
## RevisionCollection class


مجموعة من كائنات [Revision](../revision/) التي تمثل المراجعات في المستند. لمعرفة المزيد، زر مقالة الوثائق [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/).
...
| طريقة | الوصف |
| --- | --- |
| [Accept](./accept/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | يقبل المراجعات التي تطابق المعايير المحددة. |
| [AcceptAll](./acceptall/)() | يقبل جميع المراجعات في هذه المجموعة. |
| [get_Count](./get_count/)() | يعيد عدد المراجعات في المجموعة. |
| [get_Groups](./get_groups/)() | مجموعة من مجموعات المراجعات. |
| [GetEnumerator](./getenumerator/)() override | يرجع كائن عدّاد. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | يرجع [Revision](../revision/) في الفهرس المحدد. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | يرفض المراجعات التي تطابق المعايير المحددة. |
| [RejectAll](./rejectall/)() | يرفض جميع المراجعات في هذه المجموعة. |
| static [Type](./type/)() |  |
## ملاحظات


لا تقوم بإنشاء مثيلات من هذه الفئة مباشرة. استخدم خاصية [Revisions](../document/get_revisions/) للحصول على المراجعات الموجودة في المستند.
