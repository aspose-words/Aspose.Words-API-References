---
title: "Aspose::Words::ConditionalStyle::get_BottomPadding طريقة"
linktitle: "get_BottomPadding"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::ConditionalStyle::get_BottomPadding طريقة. يسترجع أو يضبط مقدار المسافة (بالنقاط) لإضافتها أسفل محتويات خلايا الجدول في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words/conditionalstyle/get_bottompadding/
---
## ConditionalStyle::get_BottomPadding method


يحصل أو يحدد مقدار المسافة (بالنقاط) لإضافتها أسفل محتويات خلايا الجدول.
