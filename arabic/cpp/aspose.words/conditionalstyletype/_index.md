...
description: "Aspose::Words::ConditionalStyleType enum. يمثل مناطق الجدول الممكنة التي يمكن تعريف التنسيق الشرطي فيها في نمط جدول بلغة C++."
type: docs
weight: 85000
url: /ar/cpp/aspose.words/conditionalstyletype/
---
## ConditionalStyleType enum


يمثل مناطق الجدول الممكنة التي يمكن تعريف التنسيق الشرطي فيها في نمط الجدول.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| FirstRow | 0 | يحدد تنسيق الصف الأول في الجدول. |
| FirstColumn | 1 | يحدد تنسيق العمود الأول في الجدول. |
| LastRow | 2 | يحدد تنسيق الصف الأخير في الجدول. |
| LastColumn | 3 | يحدد تنسيق العمود الأخير في الجدول. |
| OddRowBanding | 4 | يحدد تنسيق شريط الصفوف ذات الأرقام الفردية. |
| OddColumnBanding | 5 | يحدد تنسيق شريط الأعمدة ذات الأرقام الفردية. |
| EvenRowBanding | 6 | يحدد تنسيق شريط الصفوف ذات الأرقام الزوجية. |
| EvenColumnBanding | 7 | يحدد تنسيق شريط العمود ذو الأرقام الزوجية. |
| TopLeftCell | 8 | يحدد تنسيق الخلية العلوية اليسرى في جدول. |
| TopRightCell | 9 | يحدد تنسيق الخلية العلوية اليمنى في جدول. |
| BottomLeftCell | 10 | يحدد تنسيق الخلية السفلية اليسرى في جدول. |
| BottomRightCell | 11 | يحدد تنسيق الخلية السفلية اليمنى في جدول. |
