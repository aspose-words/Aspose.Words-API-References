---
title: "طريقة Aspose::Words::EditableRange::get_Id"
linktitle: "get_Id"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::EditableRange::get_Id. يحصل على معرف النطاق القابل للتحرير في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words/editablerange/get_id/
---
...
يجب تحديد المنطقة باستخدام [EditableRangeStart](../get_editablerangestart/) و [EditableRangeEnd](../get_editablerangeend/).

من المفترض أن تكون معرفات النطاق القابل للتحرير فريدة عبر المستند وأن Aspose.Words يحافظ تلقائيًا على معرفات النطاق القابل للتحرير عند تحميل المستندات وحفظها ودمجها.
