---
title: "فئة Aspose::Words::NodeCollection"
linktitle: "NodeCollection"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::NodeCollection. تمثل مجموعة من العقد من نوع محدد. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 43000
url: /ar/cpp/aspose.words/nodecollection/
---
## NodeCollection class


يمثل مجموعة من العقد من نوع معين. لمعرفة المزيد، زر مقالة الوثائق [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/)
...
| طريقة | الوصف |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Node\>\&) | يضيف عقدة إلى نهاية المجموعة. |
| [Clear](./clear/)() | يزيل جميع العقد من هذه المجموعة ومن المستند. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Node\>\&) | يحدد ما إذا كانت العقدة موجودة في المجموعة. |
| [get_Count](./get_count/)() | يحصل على عدد العقد في المجموعة. |
| [GetEnumerator](./getenumerator/)() override | يوفر تكرارًا بسيطًا بنمط "foreach" على مجموعة العقد. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | يسترجع عقدة في الفهرس المحدد. |
| [IndexOf](./indexof/)(const System::SharedPtr\<Aspose::Words::Node\>\&) | يعيد الفهرس الصفري للعقدة المحددة. |
| [Insert](./insert/)(int32_t, const System::SharedPtr\<Aspose::Words::Node\>\&) | يدرج عقدة في المجموعة عند الفهرس المحدد. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Node\>\&) | يزيل العقدة من المجموعة ومن المستند. |
| [RemoveAt](./removeat/)(int32_t) | يزيل العقدة في الفهرس المحدد من المجموعة ومن المستند. |
...
المجموعة [NodeCollection](./) هي "live", أي أن التغييرات على أبناء كائن العقدة الذي تم إنشاؤها منه تنعكس فورًا في العقد التي تُرجعها خصائص وطرق [NodeCollection](./).
