---
title: "طريقة Aspose::Words::SignatureLineOptions::get_Email method"
linktitle: "get_Email"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::SignatureLineOptions::get_Email. يحصل على أو يضبط عنوان البريد الإلكتروني المقترح للموقع. القيمة الافتراضية لهذه الخاصية هي سلسلة فارغة في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words/signaturelineoptions/get_email/
---
## SignatureLineOptions::get_Email method


يحصل أو يعيّن عنوان البريد الإلكتروني المقترح للموقّع. القيمة الافتراضية لهذه الخاصية هي **empty string**.
