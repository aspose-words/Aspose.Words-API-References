---
title: "Aspose::Words::SignatureLineOptions::get_Instructions طريقة"
linktitle: "get_Instructions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::SignatureLineOptions::get_Instructions method. يحصل على أو يضبط التعليمات للموقع التي يتم عرضها عند توقيع سطر التوقيع. القيمة الافتراضية لهذه الخاصية هي سلسلة فارغة في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


يحصل أو يعيّن التعليمات للموقّع التي تُعرض عند توقيع سطر التوقيع. القيمة الافتراضية لهذه الخاصية هي **empty string**.
