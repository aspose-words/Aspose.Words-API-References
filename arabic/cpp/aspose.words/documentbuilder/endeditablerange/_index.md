...
description: "طريقة Aspose::Words::DocumentBuilder::EndEditableRange. يحدد الموضع الحالي في المستند كنهاية نطاق قابل للتحرير في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words/documentbuilder/endeditablerange/
---
## DocumentBuilder::EndEditableRange() method


يُعلِّم الموضع الحالي في المستند كنهاية نطاق قابل للتحرير.
...
العقدة النهائية للنطاق القابل للتحرير التي تم إنشاؤها للتو.
## ملاحظات


يمكن أن يتداخل النطاق القابل للتحرير في المستند ويمتد عبر أي نطاق. لإنشاء نطاق قابل للتحرير صالح تحتاج إلى استدعاء كل من [StartEditableRange](../starteditablerange/) و[EndEditableRange](./) أو [EndEditableRange()](../) الطرق.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| ابدأ | const System::SharedPtr\<Aspose::Words::EditableRangeStart\>\& | بداية هذا النطاق القابل للتحرير. |
