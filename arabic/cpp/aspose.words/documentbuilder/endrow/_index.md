...
description: "Aspose::Words::DocumentBuilder::EndRow method. ينهي صفًا في الجدول داخل المستند في C++."
type: docs
weight: 7000
url: /ar/cpp/aspose.words/documentbuilder/endrow/
---
...
عقدة الصف التي انتهت للتو.
## ملاحظات


استدعِ [EndRow](./) لإنهاء صف جدول. إذا استدعيت [InsertCell](../insertcell/) مباشرةً بعد ذلك، سيستمر الجدول في صف جديد.

استخدم الخاصية [RowFormat](../get_rowformat/) لتحديد تنسيق الصف.
