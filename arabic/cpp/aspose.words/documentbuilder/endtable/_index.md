...
description: "Aspose::Words::DocumentBuilder::EndTable method. ينهي جدولًا في المستند بلغة C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words/documentbuilder/endtable/
---
...
يجب استدعاء هذه الطريقة مرة واحدة فقط بعد استدعاء [EndRow](../endrow/). عند الاستدعاء، يقوم [EndTable](./) بنقل المؤشر خارج الخلية الحالية ليشير مباشرةً بعد الجدول.
