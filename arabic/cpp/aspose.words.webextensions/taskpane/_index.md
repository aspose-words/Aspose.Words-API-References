...
description: "Aspose::Words::WebExtensions::TaskPane class. يمثل كائن لوحة مهام الإضافة. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 2000
url: /ar/cpp/aspose.words.webextensions/taskpane/
---
## TaskPane class


يمثل كائن لوحة مهام الإضافة. لمعرفة المزيد، زر مقالة الوثائق [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) documentation article.
...
| طريقة | الوصف |
| --- | --- |
| [get_DockState](./get_dockstate/)() const | يحدد الموقع الأخير المثبت لهذه لوحة المهام. |
| [get_IsLocked](./get_islocked/)() const | يحدد ما إذا كانت لوحة المهام مقفلة على المستند في واجهة المستخدم ولا يمكن إغلاقها من قبل المستخدم. |
| [get_IsVisible](./get_isvisible/)() const | يحدد ما إذا كانت لوحة المهام تُظهر كمرئية افتراضيًا عند فتح المستند. |
| [get_Row](./get_row/)() const | يحدد الفهرس، من الخارج إلى الداخل، لهذه لوحة المهام بين لوحات المهام الأخرى المستمرة المثبتة في نفس الموقع الافتراضي. |
| [get_WebExtension](./get_webextension/)() const | يمثل كائن ملحق ويب. |
| [get_Width](./get_width/)() const | يحدد قيمة العرض الافتراضية لهذا المثيل من لوحة المهام. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DockState](./set_dockstate/)(Aspose::Words::WebExtensions::TaskPaneDockState) | المُعيّن لـ [Aspose::Words::WebExtensions::TaskPane::get_DockState](./get_dockstate/). |
| [set_IsLocked](./set_islocked/)(bool) | المُعيّن لـ [Aspose::Words::WebExtensions::TaskPane::get_IsLocked](./get_islocked/). |
| [set_IsVisible](./set_isvisible/)(bool) | المُعيّن لـ [Aspose::Words::WebExtensions::TaskPane::get_IsVisible](./get_isvisible/). |
| [set_Row](./set_row/)(int32_t) | المُعيّن لـ [Aspose::Words::WebExtensions::TaskPane::get_Row](./get_row/). |
| [set_Width](./set_width/)(double) | المُعيّن لـ [Aspose::Words::WebExtensions::TaskPane::get_Width](./get_width/). |
| [TaskPane](./taskpane/)() |  |
| static [Type](./type/)() |  |
