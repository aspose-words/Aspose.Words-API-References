---
title: "Aspose::Words::WebExtensions::TaskPane::get_IsVisible طريقة"
linktitle: "get_IsVisible"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::WebExtensions::TaskPane::get_IsVisible. تحدد ما إذا كان جزء المهام يُظهر كمرئي افتراضيًا عند فتح المستند في C++."
type: docs
weight: 5000
url: /ar/cpp/aspose.words.webextensions/taskpane/get_isvisible/
---
## TaskPane::get_IsVisible method


يحدد ما إذا كانت لوحة المهام تُظهر كمرئية افتراضيًا عند فتح المستند.
