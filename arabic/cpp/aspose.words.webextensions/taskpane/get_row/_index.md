---
title: "Aspose::Words::WebExtensions::TaskPane::get_Row طريقة"
linktitle: "get_Row"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::WebExtensions::TaskPane::get_Row طريقة. تحدد الفهرس، بدءًا من الخارج إلى الداخل، لهذه لوحة المهام بين لوحات المهام المستمرة الأخرى المرساة في نفس الموقع الافتراضي في C++."
type: docs
weight: 6000
url: /ar/cpp/aspose.words.webextensions/taskpane/get_row/
---
## TaskPane::get_Row method


يحدد الفهرس، من الخارج إلى الداخل، لهذه لوحة المهام بين لوحات المهام الأخرى المستمرة المثبتة في نفس الموقع الافتراضي.
