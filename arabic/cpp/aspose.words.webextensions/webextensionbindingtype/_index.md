---
title: "تعداد Aspose::Words::WebExtensions::WebExtensionBindingType"
linktitle: "WebExtensionBindingType"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "تعداد Aspose::Words::WebExtensions::WebExtensionBindingType. يعدد الأنواع المتاحة للربط بين امتداد ويب والبيانات في المستند في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.webextensions/webextensionbindingtype/
---
## WebExtensionBindingType enum


يسرد الأنواع المتاحة للربط بين ملحق ويب والبيانات في المستند.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| المصفوفة | 0 | بيانات جدوليّة بدون صف رأس. |
| Table | 1 | بيانات جدوليّة مع صف رأس. |
| Text | 2 | نص عادي. |
| افتراضي | n/a | المصفوفة المستخدمة افتراضيًا. |
