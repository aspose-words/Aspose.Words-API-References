---
title: "Aspose::Words::WebExtensions::WebExtension فئة"
linktitle: "WebExtension"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::WebExtensions::WebExtension فئة. يمثل كائن ملحق ويب. لمزيد من المعلومات، زر مقالة الوثائق في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


يمثل كائن امتداد ويب. لمعرفة المزيد، زر مقالة الوثائق [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) documentation article.
...
| طريقة | الوصف |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | يحدد مراجع بديلة لملحق ويب. |
| [get_Bindings](./get_bindings/)() const | يحدد قائمة من روابط ملحق الويب. |
| [get_Id](./get_id/)() const | يحدد بشكل فريد نسخة ملحق الويب في المستند الحالي. |
| [get_IsFrozen](./get_isfrozen/)() const | يحدد ما إذا كان المستخدم يمكنه التفاعل مع ملحق الويب أم لا. |
| [get_Properties](./get_properties/)() const | يمثل مجموعة من خصائص ملحق الويب المخصصة. |
| [get_Reference](./get_reference/)() const | يحدد المرجع الأساسي لملحق ويب. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | محدد لـ [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | محدد لـ [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
