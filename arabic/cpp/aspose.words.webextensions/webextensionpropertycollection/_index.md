---
title: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection فئة"
linktitle: "WebExtensionPropertyCollection"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection فئة. يحدد مجموعة من خصائص الامتداد الويب المخصصة. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


يحدد مجموعة من الخصائص المخصصة لملحق الويب. لمعرفة المزيد، قم بزيارة مقالة الوثائق [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
