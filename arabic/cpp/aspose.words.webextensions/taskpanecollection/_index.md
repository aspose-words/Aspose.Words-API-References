---
title: "فئة Aspose::Words::WebExtensions::TaskPaneCollection"
linktitle: "TaskPaneCollection"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::WebExtensions::TaskPaneCollection. تحدد قائمة من كائنات لوحة المهام المستمرة. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


يحدد قائمة من كائنات لوحة المهام المستمرة. لمعرفة المزيد، زر مقالة الوثائق [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) documentation article.
