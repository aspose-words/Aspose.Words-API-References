---
title: "طريقة Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef"
linktitle: "get_AppRef"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef. يحدد مفتاح الربط المستخدم لتعيين إدخال الربط في هذه القائمة مع البيانات المرتبطة في المستند في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.webextensions/webextensionbinding/get_appref/
---
## WebExtensionBinding::get_AppRef method


يحدد مفتاح الربط المستخدم لتعيين مدخل الربط في هذه القائمة مع البيانات المرتبطة في المستند.
