---
title: "طريقة Aspose::Words::Saving::OutlineOptions::get_BookmarksOutlineLevels"
linktitle: "get_BookmarksOutlineLevels"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Saving::OutlineOptions::get_BookmarksOutlineLevels. تسمح بتحديد مستوى مخطط العلامات المرجعية الفردية في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.saving/outlineoptions/get_bookmarksoutlinelevels/
---
...
إذا لم يتم تحديد مستوى العلامة المرجعية في هذه المجموعة، فسيتم استخدام قيمة [DefaultBookmarksOutlineLevel](../get_defaultbookmarksoutlinelevel/).
