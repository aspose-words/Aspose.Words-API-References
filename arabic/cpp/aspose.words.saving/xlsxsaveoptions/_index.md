...
description: "Aspose::Words::Saving::XlsxSaveOptions class. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق Xlsx. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 37500
url: /ar/cpp/aspose.words.saving/xlsxsaveoptions/
---
## XlsxSaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق [Xlsx](../../aspose.words/saveformat/). لمعرفة المزيد، زر مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_DateTimeParsingMode](./get_datetimeparsingmode/)() const | يحصل أو يضبط الوضع الذي يحدد كيفية تحليل نص المستند لتحديد قيم التاريخ والوقت. القيمة الافتراضية هي [UseCurrentLocale](../xlsxdatetimeparsingmode/). |
...
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Xlsx](../../aspose.words/saveformat/). |
| [get_SectionMode](./get_sectionmode/)() const | يحصل أو يضبط الطريقة التي يتم بها معالجة الأقسام عند الحفظ إلى مستند XLSX الناتج. القيمة الافتراضية هي [MultipleWorksheets](../xlsxsectionmode/). |
...
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | محدد لـ [Aspose::Words::Saving::XlsxSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DateTimeParsingMode](./set_datetimeparsingmode/)(Aspose::Words::Saving::XlsxDateTimeParsingMode) | المحدد لـ [Aspose::Words::Saving::XlsxSaveOptions::get_DateTimeParsingMode](./get_datetimeparsingmode/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | المحدد لـ [Aspose::Words::Saving::XlsxSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SectionMode](./set_sectionmode/)(Aspose::Words::Saving::XlsxSectionMode) | المحدد لـ [Aspose::Words::Saving::XlsxSaveOptions::get_SectionMode](./get_sectionmode/). |
