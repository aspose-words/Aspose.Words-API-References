---
title: "فئة Aspose::Words::Saving::MarkdownSaveOptions"
linktitle: "MarkdownSaveOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Saving::MarkdownSaveOptions. فئة لتحديد خيارات إضافية عند حفظ مستند بتنسيق Markdown. لمزيد من المعلومات، زر مقالة الوثائق في C++."
type: docs
weight: 13000
url: /ar/cpp/aspose.words.saving/markdownsaveoptions/
---
## MarkdownSaveOptions class


فئة لتحديد خيارات إضافية عند حفظ مستند بتنسيق [Markdown](../../aspose.words/saveformat/). لمزيد من المعلومات، زر مقالة [تحديد خيارات الحفظ](https://docs.aspose.com/words/cpp/specify-save-options/) الوثائقية.
...
| [get_EmptyParagraphExportMode](./get_emptyparagraphexportmode/)() const | يحدد كيفية تصدير الفقرات الفارغة إلى Markdown. القيمة الافتراضية هي [EmptyLine](../markdownemptyparagraphexportmode/). |
| [get_Encoding](../txtsaveoptionsbase/get_encoding/)() const | يحدد الترميز المستخدم عند التصدير إلى تنسيقات نصية. القيمة الافتراضية هي **Encoding.UTF8**. |
| [get_ExportAsHtml](./get_exportashtml/)() const | يسمح بتحديد العناصر التي سيتم تصديرها إلى Markdown كـ HTML خام. القيمة الافتراضية هي [None](../markdownexportashtml/). |
...
| [get_ExportHeadersFootersMode](../txtsaveoptionsbase/get_exportheadersfootersmode/)() const | يحدد الطريقة التي يتم بها تصدير الترويسات والتذييلات إلى تنسيقات النص. القيمة الافتراضية هي [PrimaryOnly](../txtexportheadersfootersmode/). |
| [get_ExportImagesAsBase64](./get_exportimagesasbase64/)() const | يحدد ما إذا كانت الصور تُحفظ بتنسيق Base64 في ملف الإخراج. القيمة الافتراضية هي **false**. |
| [get_ExportUnderlineFormatting](./get_exportunderlineformatting/)() const | يحصل أو يعيّن قيمة منطقية تشير إلى ما إذا كان سيتم تصدير تنسيق النص المسطر كسلسلة من حرفي زائد "++". القيمة الافتراضية هي **false**. |
| [get_ForcePageBreaks](../txtsaveoptionsbase/get_forcepagebreaks/)() const | يسمح بتحديد ما إذا كان يجب الحفاظ على فواصل الصفحات أثناء التصدير. القيمة الافتراضية هي **false**. |
| [get_ImageResolution](./get_imageresolution/)() const | يحدد دقة الإخراج للصور عند التصدير إلى Markdown. القيمة الافتراضية هي **%96 dpi**. |
| [get_ImageSavingCallback](./get_imagesavingcallback/)() const | يسمح بالتحكم في كيفية حفظ الصور عندما يتم حفظ مستند بتنسيق [Markdown](../../aspose.words/saveformat/). |
| [get_ImagesFolder](./get_imagesfolder/)() const | يحدد المجلد الفعلي حيث تُحفظ الصور عند تصدير مستند إلى تنسيق [Markdown](../../aspose.words/saveformat/). القيمة الافتراضية هي سلسلة فارغة. |
| [get_ImagesFolderAlias](./get_imagesfolderalias/)() const | يحدد اسم المجلد المستخدم لإنشاء عناوين URI للصور المكتوبة في المستند. القيمة الافتراضية هي سلسلة فارغة. |
| [get_ImlRenderingMode](../saveoptions/get_imlrenderingmode/)() const | يحصل أو يعيّن قيمة تحدد كيفية عرض كائنات الحبر (InkML). |
| [get_LinkExportMode](./get_linkexportmode/)() const | يحدد كيفية كتابة الروابط إلى ملف الإخراج. القيمة الافتراضية هي [Auto](../markdownlinkexportmode/). |
| [get_ListExportMode](./get_listexportmode/)() const | يحدد كيفية كتابة عناصر القائمة إلى ملف الإخراج. القيمة الافتراضية هي [MarkdownSyntax](../markdownlistexportmode/). |
...
| [get_OfficeMathExportMode](./get_officemathexportmode/)() const | يحدد كيفية كتابة OfficeMath إلى ملف الإخراج. القيمة الافتراضية هي [Text](../markdownofficemathexportmode/). |
| [get_ParagraphBreak](../txtsaveoptionsbase/get_paragraphbreak/)() const | يحدد السلسلة المستخدمة كفاصل فقرة عند التصدير إلى تنسيقات نصية. |
...
| [get_ResourceSavingCallback](./get_resourcesavingcallback/)() const | يسمح بالتحكم في كيفية حفظ الموارد عندما يتم تصدير مستند إلى تنسيق [Markdown](../../aspose.words/saveformat/). |
| [get_SaveFormat](./get_saveformat/)() override | يحدد الصيغة التي سيُحفظ بها المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Markdown](../../aspose.words/saveformat/). |
| [get_TableContentAlignment](./get_tablecontentalignment/)() const | يحصل أو يعيّن قيمة تحدد كيفية محاذاة المحتويات في الجداول عند التصدير إلى تنسيق [Markdown](../../aspose.words/saveformat/). القيمة الافتراضية هي [Auto](../tablecontentalignment/). |
...
| [MarkdownSaveOptions](./markdownsaveoptions/)() | يُنشئ مثيلًا جديدًا لهذه الفئة يمكن استخدامه لحفظ مستند بتنسيق [Markdown](../../aspose.words/saveformat/). |
...
| [set_EmptyParagraphExportMode](./set_emptyparagraphexportmode/)(Aspose::Words::Saving::MarkdownEmptyParagraphExportMode) | مُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_EmptyParagraphExportMode](./get_emptyparagraphexportmode/). |
| [set_Encoding](../txtsaveoptionsbase/set_encoding/)(const System::SharedPtr\<System::Text::Encoding\>\&) | مُعيّن لـ [Aspose::Words::Saving::TxtSaveOptionsBase::get_Encoding](../txtsaveoptionsbase/get_encoding/). |
| [set_ExportAsHtml](./set_exportashtml/)(Aspose::Words::Saving::MarkdownExportAsHtml) | مُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ExportAsHtml](./get_exportashtml/). |
...
| [set_ExportHeadersFootersMode](../txtsaveoptionsbase/set_exportheadersfootersmode/)(Aspose::Words::Saving::TxtExportHeadersFootersMode) | مُعيّن لـ [Aspose::Words::Saving::TxtSaveOptionsBase::get_ExportHeadersFootersMode](../txtsaveoptionsbase/get_exportheadersfootersmode/). |
| [set_ExportImagesAsBase64](./set_exportimagesasbase64/)(bool) | مُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ExportImagesAsBase64](./get_exportimagesasbase64/). |
| [set_ExportUnderlineFormatting](./set_exportunderlineformatting/)(bool) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ExportUnderlineFormatting](./get_exportunderlineformatting/). |
| [set_ForcePageBreaks](../txtsaveoptionsbase/set_forcepagebreaks/)(bool) | المُعيّن لـ [Aspose::Words::Saving::TxtSaveOptionsBase::get_ForcePageBreaks](../txtsaveoptionsbase/get_forcepagebreaks/). |
| [set_ImageResolution](./set_imageresolution/)(int32_t) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ImageResolution](./get_imageresolution/). |
| [set_ImageSavingCallback](./set_imagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IImageSavingCallback\>\&) | يسمح بالتحكم في كيفية حفظ الصور عندما يتم حفظ مستند بتنسيق [Markdown](../../aspose.words/saveformat/). |
| [set_ImagesFolder](./set_imagesfolder/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ImagesFolder](./get_imagesfolder/). |
| [set_ImagesFolderAlias](./set_imagesfolderalias/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ImagesFolderAlias](./get_imagesfolderalias/). |
...
| [set_LinkExportMode](./set_linkexportmode/)(Aspose::Words::Saving::MarkdownLinkExportMode) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_LinkExportMode](./get_linkexportmode/). |
| [set_ListExportMode](./set_listexportmode/)(Aspose::Words::Saving::MarkdownListExportMode) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_ListExportMode](./get_listexportmode/). |
...
| [set_OfficeMathExportMode](./set_officemathexportmode/)(Aspose::Words::Saving::MarkdownOfficeMathExportMode) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_OfficeMathExportMode](./get_officemathexportmode/). |
| [set_ParagraphBreak](../txtsaveoptionsbase/set_paragraphbreak/)(const System::String\&) | المُعيّن لـ [Aspose::Words::Saving::TxtSaveOptionsBase::get_ParagraphBreak](../txtsaveoptionsbase/get_paragraphbreak/). |
...
| [set_ResourceSavingCallback](./set_resourcesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IResourceSavingCallback\>\&) | يسمح بالتحكم في كيفية حفظ الموارد عندما يتم تصدير مستند إلى تنسيق [Markdown](../../aspose.words/saveformat/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | يحدد الصيغة التي سيُحفظ بها المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Markdown](../../aspose.words/saveformat/). |
| [set_TableContentAlignment](./set_tablecontentalignment/)(Aspose::Words::Saving::TableContentAlignment) | المُعيّن لـ [Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment](./get_tablecontentalignment/). |
