---
title: "طريقة Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment"
linktitle: "get_TableContentAlignment"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment. يحصل على أو يضبط قيمة تحدد كيفية محاذاة المحتوى في الجداول عند التصدير إلى تنسيق Markdown. القيمة الافتراضية هي Auto في C++."
type: docs
weight: 8000
url: /ar/cpp/aspose.words.saving/markdownsaveoptions/get_tablecontentalignment/
---
## MarkdownSaveOptions::get_TableContentAlignment method


يحصل أو يضبط قيمة تحدد كيفية محاذاة المحتوى في الجداول عند التصدير إلى تنسيق [Markdown](../../../aspose.words/saveformat/). القيمة الافتراضية هي [Auto](../../tablecontentalignment/).
