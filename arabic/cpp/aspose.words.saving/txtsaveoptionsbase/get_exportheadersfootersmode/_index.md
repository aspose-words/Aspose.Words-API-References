---
title: "Aspose::Words::Saving::TxtSaveOptionsBase::get_ExportHeadersFootersMode طريقة"
linktitle: "get_ExportHeadersFootersMode"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Saving::TxtSaveOptionsBase::get_ExportHeadersFootersMode طريقة. يحدد الطريقة التي يتم بها تصدير رؤوس وتذييلات الصفحات إلى تنسيقات النص. القيمة الافتراضية هي PrimaryOnly في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.saving/txtsaveoptionsbase/get_exportheadersfootersmode/
---
## TxtSaveOptionsBase::get_ExportHeadersFootersMode method


يحدد الطريقة التي يتم بها تصدير رؤوس وتذييلات الصفحات إلى تنسيقات النص. القيمة الافتراضية هي [PrimaryOnly](../../txtexportheadersfootersmode/).
