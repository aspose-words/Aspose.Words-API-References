---
title: "فئة Aspose::Words::Saving::TxtSaveOptions"
linktitle: "TxtSaveOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Saving::TxtSaveOptions. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق النص. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 33000
url: /ar/cpp/aspose.words.saving/txtsaveoptions/
---
## TxtSaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق [Text](../../aspose.words/saveformat/). لمعرفة المزيد، زر مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_AddBidiMarks](./get_addbidimarks/)() const | يحدد ما إذا كان سيتم إضافة علامات ثنائية الاتجاه قبل كل مقطع BiDi عند التصدير بتنسيق النص العادي. القيمة الافتراضية هي **false**. |
...
| [get_ListIndentation](./get_listindentation/)() const | يحصل على كائن [TxtListIndentation](../txtlistindentation/) الذي يحدد عدد وحرف المسافة البادئة المستخدمة لمستويات القوائم. بشكل افتراضي، يكون عدد الأحرف '\\0' صفرًا، مما يعني عدم وجود مسافة بادئة. |
| [get_MaxCharactersPerLine](./get_maxcharactersperline/)() const | يحصل أو يضبط قيمة عددية تحدد الحد الأقصى لعدد الأحرف في سطر واحد. القيمة الافتراضية هي 0، مما يعني عدم وجود حد. |
...
| [get_OfficeMathExportMode](./get_officemathexportmode/)() const | يحدد كيفية كتابة OfficeMath إلى ملف الإخراج. القيمة الافتراضية هي [Text](../txtofficemathexportmode/). |
...
| [get_PreserveTableLayout](./get_preservetablelayout/)() const | يحدد ما إذا كان البرنامج يجب أن يحاول الحفاظ على تخطيط الجداول عند الحفظ بتنسيق النص العادي. القيمة الافتراضية هي **false**. |
...
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيتم حفظ المستند به إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Text](../../aspose.words/saveformat/). |
| [get_SimplifyListLabels](./get_simplifylistlabels/)() const | يحدد ما إذا كان البرنامج يجب أن يبسط تسميات القوائم في حالة عدم تمثيل تنسيق التسميات المعقد بشكل كافٍ في النص العادي. إذا تم ضبطه على **true**، تُكتب تسميات القوائم المرقمة بصيغة رقمية بسيطة وتُكتب تسميات القوائم النقطية كحروف ASCII بسيطة. القيمة الافتراضية هي **false**. |
...
| [set_AddBidiMarks](./set_addbidimarks/)(bool) | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_AddBidiMarks](./get_addbidimarks/). |
...
| [set_MaxCharactersPerLine](./set_maxcharactersperline/)(int32_t) | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_MaxCharactersPerLine](./get_maxcharactersperline/). |
...
| [set_OfficeMathExportMode](./set_officemathexportmode/)(Aspose::Words::Saving::TxtOfficeMathExportMode) | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_OfficeMathExportMode](./get_officemathexportmode/). |
...
| [set_PreserveTableLayout](./set_preservetablelayout/)(bool) | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_PreserveTableLayout](./get_preservetablelayout/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SimplifyListLabels](./set_simplifylistlabels/)(bool) | المحدد لـ [Aspose::Words::Saving::TxtSaveOptions::get_SimplifyListLabels](./get_simplifylistlabels/). |
