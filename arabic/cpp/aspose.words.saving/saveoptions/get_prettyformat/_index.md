---
title: "طريقة Aspose::Words::Saving::SaveOptions::get_PrettyFormat"
linktitle: "get_PrettyFormat"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat method. عندما تكون true، تقوم بتنسيق المخرجات بشكل جميل حيثما ينطبق. القيمة الافتراضية هي false في C++."
type: docs
weight: 12000
url: /ar/cpp/aspose.words.saving/saveoptions/get_prettyformat/
---
## SaveOptions::get_PrettyFormat method


عند **true**، يتم تنسيق الإخراج بشكل جميل حيثما كان ذلك ممكنًا. القيمة الافتراضية هي **false**.
...
اضبط إلى **true** لجعل مخرجات HTML و MHTML و EPUB و WordML و RTF و DOCX و ODT قابلة للقراءة من قبل الإنسان. مفيد للاختبار أو تصحيح الأخطاء.

## أمثلة



يظهر كيفية تحسين قابلية قراءة الشيفرة الأصلية لمستند .html المحفوظ.
```cpp
...
// تمكين تنسيق جميل يجعل شيفرة html الأصلية أكثر قابلية للقراءة عن طريق إضافة مسافات تبويب وحروف سطر جديد.
