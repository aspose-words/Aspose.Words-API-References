---
title: "طريقة Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels"
linktitle: "get_ExportListLabels"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels. يتحكم في كيفية إخراج تسميات القوائم إلى HTML أو MHTML أو EPUB. القيمة الافتراضية هي Auto في C++."
type: docs
weight: 21000
url: /ar/cpp/aspose.words.saving/htmlsaveoptions/get_exportlistlabels/
---
## HtmlSaveOptions::get_ExportListLabels method


يتحكم في كيفية إخراج تسميات القوائم إلى HTML أو MHTML أو EPUB. القيمة الافتراضية هي [Auto](../../exportlistlabels/).
...
يوضح كيفية تكوين تصدير القوائم إلى HTML.
```cpp
...
// سيتم إنشاء القوائم عن طريق تنسيق الفواصل.
// تعيين الخاصية "ExportListLabels" إلى "ExportListLabels.Auto" سيستخدم الوسم <p>
// لبناء القوائم في الحالات التي قد يتسبب فيها استخدام الوسوم <ol> و <li> بفقدان التنسيق.
// تعيين الخاصية "ExportListLabels" إلى "ExportListLabels.ByHtmlTags"
// سيستخدم الوسوم <ol> و <li> لبناء جميع القوائم.
