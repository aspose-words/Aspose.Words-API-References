---
title: "Aspose::Words::Saving::SvgSaveOptions فئة"
linktitle: "SvgSaveOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Saving::SvgSaveOptions فئة. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق Svg. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 31000
url: /ar/cpp/aspose.words.saving/svgsaveoptions/
---
## SvgSaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق [Svg](../../aspose.words/saveformat/). لمعرفة المزيد، زر مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportEmbeddedImages](./get_exportembeddedimages/)() const | يحدد ما إذا كان يجب تضمين الصور في مستند SVG كـ base64. كن على علم أن تفعيل هذا الخيار قد يؤدي إلى زيادة كبيرة في حجم ملف SVG الناتج. |
...
| [get_FitToViewPort](./get_fittoviewport/)() const | يحدد ما إذا كان SVG الناتج يجب أن يملأ مساحة العرض المتاحة (نافذة المتصفح أو الحاوية). عند تعيينه إلى **true** يتم ضبط عرض وارتفاع SVG الناتج إلى 100٪. القيمة الافتراضية هي **false**. |
...
| [get_MaxImageResolution](./get_maximageresolution/)() const | يحصل أو يعيّن قيمة بوحدة بكسل لكل بوصة تحدد حد دقة الصور النقطية المصدرة. القيمة الافتراضية هي صفر. |
...
| [get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/)() const | يحدد ما إذا كان سيتم إزالة JavaScript من الروابط. القيمة الافتراضية هي **false**. إذا تم تمكين هذا الخيار، سيتم استبدال جميع الروابط التي تحتوي على JavaScript بـ "javascript:void(0)". |
| [get_ResourceSavingCallback](./get_resourcesavingcallback/)() const | يسمح بالتحكم في كيفية حفظ الموارد (الصور) عند تصدير المستند إلى تنسيق SVG. |
| [get_ResourcesFolder](./get_resourcesfolder/)() const | يحدد المجلد الفعلي حيث يتم حفظ الموارد (الصور) عند تصدير مستند إلى تنسيق Svg. القيمة الافتراضية هي **null**. |
| [get_ResourcesFolderAlias](./get_resourcesfolderalias/)() const | يحدد اسم المجلد المستخدم لإنشاء عناوين URI للصور المكتوبة في مستند SVG. القيمة الافتراضية هي **null**. |
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Svg](../../aspose.words/saveformat/). |
| [get_ShowPageBorder](./get_showpageborder/)() const | يتحكم فيما إذا كان يتم إضافة حد إلى مخطط الصفحة. القيمة الافتراضية هي **true**. |
...
| [get_TextOutputMode](./get_textoutputmode/)() const | يحصل أو يعيّن قيمة تحدد كيفية عرض النص في SVG. |
...
| [set_ExportEmbeddedImages](./set_exportembeddedimages/)(bool) | يحدد ما إذا كان يجب تضمين الصور في مستند SVG كـ base64. كن على علم أن تفعيل هذا الخيار قد يؤدي إلى زيادة كبيرة في حجم ملف SVG الناتج. |
...
| [set_FitToViewPort](./set_fittoviewport/)(bool) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_FitToViewPort](./get_fittoviewport/). |
| [set_IdPrefix](./set_idprefix/)(const System::String\&) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_IdPrefix](./get_idprefix/). |
...
| [set_MaxImageResolution](./set_maximageresolution/)(int32_t) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_MaxImageResolution](./get_maximageresolution/). |
...
| [set_RemoveJavaScriptFromLinks](./set_removejavascriptfromlinks/)(bool) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/). |
| [set_ResourceSavingCallback](./set_resourcesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IResourceSavingCallback\>\&) | يسمح بالتحكم في كيفية حفظ الموارد (الصور) عند تصدير المستند إلى تنسيق SVG. |
| [set_ResourcesFolder](./set_resourcesfolder/)(const System::String\&) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolder](./get_resourcesfolder/). |
| [set_ResourcesFolderAlias](./set_resourcesfolderalias/)(const System::String\&) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolderAlias](./get_resourcesfolderalias/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Svg](../../aspose.words/saveformat/). |
| [set_ShowPageBorder](./set_showpageborder/)(bool) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_ShowPageBorder](./get_showpageborder/). |
...
| [set_TextOutputMode](./set_textoutputmode/)(Aspose::Words::Saving::SvgTextOutputMode) | محدد لـ [Aspose::Words::Saving::SvgSaveOptions::get_TextOutputMode](./get_textoutputmode/). |
