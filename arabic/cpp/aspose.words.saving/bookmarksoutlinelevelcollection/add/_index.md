---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add طريقة"
linktitle: "Add"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add طريقة. يضيف إشارة مرجعية إلى المجموعة في C++."
type: docs
weight: 3000
url: /ar/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
## BookmarksOutlineLevelCollection::Add method


يضيف علامة مرجعية إلى المجموعة.
...
| معامل | النوع | الوصف |
| --- | --- | --- |
| name | const System::String\& | الاسم غير حساس لحالة الأحرف للإشارة المرجعية التي سيتم إضافتها. |
| outlineLevel | int32_t | مستوى المخطط للإشارة المرجعية. النطاق الصالح هو من 0 إلى 9. |
