---
title: "فئة Aspose::Words::Saving::XamlFlowSaveOptions"
linktitle: "XamlFlowSaveOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Saving::XamlFlowSaveOptions. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند إلى تنسيق XamlFlow أو XamlFlowPack. لمعرفة المزيد، قم بزيارة مقالة الوثائق في C++."
type: docs
weight: 37000
url: /ar/cpp/aspose.words.saving/xamlflowsaveoptions/
---
## XamlFlowSaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند إلى تنسيق [XamlFlow](../../aspose.words/saveformat/) أو [XamlFlowPack](../../aspose.words/saveformat/). لمعرفة المزيد، قم بزيارة مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ImageSavingCallback](./get_imagesavingcallback/)() const | يسمح بالتحكم في كيفية حفظ الصور عندما يتم حفظ المستند إلى XAML. |
| [get_ImagesFolder](./get_imagesfolder/)() const | يحدد المجلد الفعلي حيث تُحفظ الصور عند تصدير مستند إلى تنسيق XAML. القيمة الافتراضية هي سلسلة فارغة. |
| [get_ImagesFolderAlias](./get_imagesfolderalias/)() const | يحدد اسم المجلد المستخدم لإنشاء عناوين URI للصور المكتوبة في مستند XAML. القيمة الافتراضية هي سلسلة فارغة. |
...
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [XamlFlow](../../aspose.words/saveformat/). |
...
| [set_ImageSavingCallback](./set_imagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IImageSavingCallback\>\&) | يسمح بالتحكم في كيفية حفظ الصور عندما يتم حفظ المستند إلى XAML. |
| [set_ImagesFolder](./set_imagesfolder/)(const System::String\&) | دالة ضبط لـ [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolder](./get_imagesfolder/). |
| [set_ImagesFolderAlias](./set_imagesfolderalias/)(const System::String\&) | دالة ضبط لـ [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolderAlias](./get_imagesfolderalias/). |
...
| [set_ReplaceBackslashWithYenSign](./set_replacebackslashwithyensign/)(bool) | دالة ضبط لـ [Aspose::Words::Saving::XamlFlowSaveOptions::get_ReplaceBackslashWithYenSign](./get_replacebackslashwithyensign/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [XamlFlow](../../aspose.words/saveformat/). |
...
| static [Type](./type/)() |  |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)() | ينشئ مثيلًا جديدًا لهذه الفئة يمكن استخدامه لحفظ مستند بتنسيق [XamlFlow](../../aspose.words/saveformat/). |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)(Aspose::Words::SaveFormat) | ينشئ مثيلًا جديدًا لهذه الفئة يمكن استخدامه لحفظ مستند بتنسيق [XamlFlow](../../aspose.words/saveformat/) أو [XamlFlowPack](../../aspose.words/saveformat/). |
## انظر أيضًا
