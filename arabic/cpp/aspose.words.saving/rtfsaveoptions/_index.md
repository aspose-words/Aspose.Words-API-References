---
title: "فئة Aspose::Words::Saving::RtfSaveOptions"
linktitle: "RtfSaveOptions"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "فئة Aspose::Words::Saving::RtfSaveOptions. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق Rtf. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 28000
url: /ar/cpp/aspose.words.saving/rtfsaveoptions/
---
## RtfSaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق [Rtf](../../aspose.words/saveformat/). لمعرفة المزيد، زر مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportCompactSize](./get_exportcompactsize/)() const | يسمح بجعل مستندات RTF الناتجة أصغر حجماً، ولكن إذا احتوت على نص RTL (من اليمين إلى اليسار) فلن يتم عرضها بشكل صحيح. القيمة الافتراضية هي **false**. |
...
| [get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/)() const | يحدد ما إذا كانت الكلمات المفتاحية لـ "القراء القدامى" تُكتب إلى RTF أم لا. يمكن أن يؤثر ذلك بشكل كبير على حجم مستند RTF. القيمة الافتراضية هي **true**. |
...
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيُحفظ به المستند إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [Rtf](../../aspose.words/saveformat/). |
| [get_SaveImagesAsWmf](./get_saveimagesaswmf/)() const | عند **true** سيتم حفظ جميع الصور كـ WMF. |
...
| [set_ExportCompactSize](./set_exportcompactsize/)(bool) | المحدد لـ [Aspose::Words::Saving::RtfSaveOptions::get_ExportCompactSize](./get_exportcompactsize/). |
...
| [set_ExportImagesForOldReaders](./set_exportimagesforoldreaders/)(bool) | المُعيّن لـ [Aspose::Words::Saving::RtfSaveOptions::get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | المُعيّن لـ [Aspose::Words::Saving::RtfSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SaveImagesAsWmf](./set_saveimagesaswmf/)(bool) | المُعيّن لـ [Aspose::Words::Saving::RtfSaveOptions::get_SaveImagesAsWmf](./get_saveimagesaswmf/). |
