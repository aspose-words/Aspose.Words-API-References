...
description: "Aspose::Words::Saving::ExportListLabels enum. يحدد كيفية تصدير تسميات القوائم إلى HTML و MHTML و EPUB في C++."
type: docs
weight: 56000
url: /ar/cpp/aspose.words.saving/exportlistlabels/
---
## ExportListLabels enum


يحدد كيفية تصدير تسميات القوائم إلى HTML أو MHTML و EPUB.
...
| الاسم | القيمة | الوصف |
| --- | --- | --- |
| تلقائي | 0 | Outputs list labels in auto mode. Uses HTML native elements when possible. |
| AsInlineText | 1 | يُخرج جميع تسميات القوائم كنص مضمن. |
| ByHtmlTags | 2 | يُخرج جميع تسميات القوائم كعناصر HTML الأصلية. |
