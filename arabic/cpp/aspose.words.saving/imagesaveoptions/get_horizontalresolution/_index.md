---
title: "طريقة Aspose::Words::Saving::ImageSaveOptions::get_HorizontalResolution"
linktitle: "get_HorizontalResolution"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Saving::ImageSaveOptions::get_HorizontalResolution. يحصل أو يضبط الدقة الأفقية للصور المُنشأة، بوحدات النقاط في البوصة في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.saving/imagesaveoptions/get_horizontalresolution/
---
## ImageSaveOptions::get_HorizontalResolution method


يحصل أو يضبط الدقة الأفقية للصور المُولَّدة، بالنقاط في البوصة.
