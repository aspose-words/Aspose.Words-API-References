---
title: "طريقة Aspose::Words::Saving::TxtListIndentation::get_Count"
linktitle: "get_Count"
second_title: "مرجع API لـ Aspose.Words للغة C++"
description: "طريقة Aspose::Words::Saving::TxtListIndentation::get_Count. يحصل أو يحدد عدد الأحرف المستخدمة كمسافة بادئة لكل مستوى قائمة. القيمة الافتراضية هي 0، وهذا يعني عدم وجود مسافة بادئة في C++."
type: docs
weight: 4000
url: /ar/cpp/aspose.words.saving/txtlistindentation/get_count/
---
## TxtListIndentation::get_Count method


يحصل أو يحدد عدد [Character](../get_character/) المستخدمة كمسافة بادئة لكل مستوى قائمة. القيمة الافتراضية هي 0، وهذا يعني عدم وجود مسافة بادئة.
