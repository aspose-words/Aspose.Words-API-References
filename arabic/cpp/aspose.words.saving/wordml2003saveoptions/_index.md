...
description: "Aspose::Words::Saving::WordML2003SaveOptions class. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند إلى تنسيق WordML. لمعرفة المزيد، زر مقالة الوثائق في C++."
type: docs
weight: 35000
url: /ar/cpp/aspose.words.saving/wordml2003saveoptions/
---
## WordML2003SaveOptions class


يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند بتنسيق [WordML](../../aspose.words/saveformat/). لمعرفة المزيد، زر مقالة الوثائق [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | يحدد التنسيق الذي سيتم حفظ المستند به إذا تم استخدام كائن خيارات الحفظ هذا. يمكن أن يكون فقط [WordML](../../aspose.words/saveformat/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | دالة ضبط لـ [Aspose::Words::Saving::WordML2003SaveOptions::get_SaveFormat](./get_saveformat/). |
...
في الوقت الحالي يوفر فقط الخاصية [SaveFormat](./get_saveformat/)، ولكن قد تُضاف خيارات أخرى في المستقبل.
...
// اضبط علامة \"MemoryOptimization\" إلى \"true\" لتقليل استهلاك الذاكرة
// خلال عملية حفظ المستند على حساب وقت حفظ أطول.
// اضبط علامة \"MemoryOptimization\" إلى \"false\" لحفظ المستند بشكل طبيعي.
