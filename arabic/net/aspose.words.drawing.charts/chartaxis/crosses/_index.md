...
description: اكتشف كيف يعمل ChartAxis على تعزيز تصور البيانات من خلال تحديد تقاطعات المحاور للحصول على رؤى أكثر وضوحًا وعروض تقديمية أكثر تأثيرًا.
type: docs
weight: 40
...
يحدد كيفية عبور هذا المحور للمحور العمودي.
