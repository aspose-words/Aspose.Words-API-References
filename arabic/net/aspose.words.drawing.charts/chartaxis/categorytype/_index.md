...
description: اكتشف خاصية ChartAxis CategoryType لتخصيص محور الفئة الخاص بك بسهولة لتحسين تصور البيانات وتحسين وضوح الرسم البياني.
type: docs
weight: 30
...
يحصل على نوع محور الفئة أو يعينه.
...
فئات النص فقط (Category مسموح بها في المخططات الجديدة في MS Office 2016.
