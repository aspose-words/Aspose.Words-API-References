...
description: اكتشف خاصية تنسيق ChartAxis لتسهيل تنسيق الخطوط وتعبئة علامات التجزئة القابلة للتخصيص، مما يعزز تجربة تصور البيانات لديك.
type: docs
weight: 80
url: /ar/net/aspose.words.drawing.charts/chartaxis/format/
---
## ChartAxis.Format property

يوفر الوصول إلى تنسيق خط المحور وملء تسميات العلامات.
...
يمكن تغيير ملء علامات التجزئة في المخططات فقط في المخططات السابقة لإصدارات Word 2016. لا تدعم مخططات Word 2016 هذه الميزة.
