...
description: اكتشف كيف تعمل خاصية ChartAxis DisplayUnit على تعزيز تصور البيانات لديك من خلال تحسين مقياس محور القيمة للحصول على رؤى أكثر وضوحًا.
type: docs
weight: 60
...
يحدد قيمة مقياس وحدات العرض لمحور القيمة.
