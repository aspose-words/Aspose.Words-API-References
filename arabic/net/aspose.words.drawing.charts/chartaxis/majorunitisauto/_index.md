...
description: اكتشف خاصية ChartAxis MajorUnitIsAuto، وتحكم بسهولة في المسافة بين علامات التجزئة الرئيسية لتحسين وضوح الرسم البياني ودقته في تصورات البيانات الخاصة بك.
type: docs
weight: 140
...
يحصل على علم أو يعينه للإشارة إلى ما إذا كان سيتم استخدام المسافة الافتراضية بين علامات التجزئة الرئيسية.
