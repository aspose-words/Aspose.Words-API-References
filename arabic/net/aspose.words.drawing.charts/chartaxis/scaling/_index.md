...
description: اكتشف خصائص قياس ChartAxis لضبط المحور بشكل مثالي. تحكم بدقة في تصور بياناتك باستخدام خيارات قياس سهلة الاستخدام.
type: docs
weight: 220
...
يوفر الوصول إلى خيارات قياس المحور.
