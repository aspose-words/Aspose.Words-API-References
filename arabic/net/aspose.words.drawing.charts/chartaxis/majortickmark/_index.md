...
description: اكتشف خاصية ChartAxis MajorTickMark لتخصيص علامات التجزئة الرئيسية في الرسم البياني بسهولة لتحسين الوضوح البصري والدقة.
type: docs
weight: 120
...
يعيد أو يضبط علامات التجزئة الرئيسية.
