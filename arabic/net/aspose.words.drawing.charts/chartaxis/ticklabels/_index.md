...
description: اكتشف خاصية ChartAxis TickLabels لتخصيص علامات علامات المحور لتحسين تصور البيانات ووضوحها في مخططاتك.
type: docs
weight: 230
url: /ar/net/aspose.words.drawing.charts/chartaxis/ticklabels/
---
## ChartAxis.TickLabels property

يوفر الوصول إلى خصائص علامات محور التجزئة.
