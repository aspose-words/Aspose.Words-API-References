...
description: ChartAxis ملكية. الحصول على أو تعيين علامة تشير إلى ما إذا كان يجب استخدام المسافة الافتراضية بين علامات التجزئة الصغيرة.
type: docs
weight: 150
...
الحصول على أو تعيين علامة تشير إلى ما إذا كان يجب استخدام المسافة الافتراضية بين علامات التجزئة الصغيرة.
