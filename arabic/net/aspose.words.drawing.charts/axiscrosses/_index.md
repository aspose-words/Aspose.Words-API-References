...
description: يحدد نقاط التقاطع المحتملة للمحور.
type: docs
weight: 530
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Automatic | `0` | يتقاطع محور الفئة عند نقطة الصفر لمحور القيمة (إن أمكن) ، أو عند أدنى قيمة_ x000d_ إذا كان الحد الأدنى أكبر من الصفر ، أو عند الحد الأقصى إذا كان الحد الأقصى أقل من الصفر. |
