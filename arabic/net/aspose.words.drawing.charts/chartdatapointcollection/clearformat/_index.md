...
description: اكتشف كيف تعمل طريقة ClearFormat على تعزيز ChartDataPointCollection من خلال إعادة تعيين جميع تنسيقات نقاط بيانات الرسم البياني بسهولة للحصول على صور أكثر وضوحًا.
type: docs
weight: 30
...
يمسح تنسيق الكل[`ChartDataPoint`](../../chartdatapoint/) في هذه المجموعة.
