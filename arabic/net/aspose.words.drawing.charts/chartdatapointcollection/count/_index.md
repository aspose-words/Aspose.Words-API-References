...
description: اكتشف خاصية Count في ChartDataPointCollection، والتي تقوم بإرجاع العدد الإجمالي لـ ChartDataPoints بكفاءة، مما يعمل على تحسين تصور البيانات لديك.
type: docs
weight: 10
