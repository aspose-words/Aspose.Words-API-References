...
description: قم بتعزيز مخططاتك باستخدام خاصية الخط AxisTickLabels، مما يسمح بتنسيق الخط القابل للتخصيص للحصول على تسميات علامات أكثر وضوحًا وأكثر تأثيرًا.
type: docs
weight: 20
url: /ar/net/aspose.words.drawing.charts/axisticklabels/font/
---
## AxisTickLabels.Font property

يوفر إمكانية الوصول إلى تنسيق الخط الخاص بعلامات التجزئة.
