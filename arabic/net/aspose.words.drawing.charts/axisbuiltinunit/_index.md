...
description: يحدد وحدات العرض للمحور .
type: docs
weight: 510
...
| Custom | `1` | تحديد يجب تقسيم القيم الموجودة على الرسم البياني بواسطة قاسم يحدده المستخدم. هذه القيمة غير مدعومة x000d_ بواسطة أنواع المخططات الجديدة لـ MS Office 2016. |
