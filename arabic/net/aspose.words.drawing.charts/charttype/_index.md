...
description: يحدد نوع الرسم البياني .
type: docs
weight: 760
...
| --- | --- | --- |
| Area | `0` | مخطط مساحي. |
| AreaStacked | `1` | مخطط مساحي مكدس ._ x000d_ |
| AreaPercentStacked | `2` | مخطط مساحي مكدس بنسبة 100٪ . |
| Area3D | `3` | مخطط منطقة ثلاثي الأبعاد . |
| Area3DStacked | `4` | مخطط مساحي مكدس ثلاثي الأبعاد ._ x000d_ |
...
| Bar3DStacked | `10` | مخطط شريطي مكدس ثلاثي الأبعاد ._ x000d_ |
| Bar3DPercentStacked | `11` | مخطط شريطي مكدس بنسبة 100٪ ثلاثي الأبعاد . |
| Bubble | `12` | مخطط فقاعي ._ x000d_ |
| Bubble3D | `13` | مخطط فقاعي ثلاثي الأبعاد ._ x000d_ |
| Column | `14` | مخطط العمود . |
| ColumnStacked | `15` | مخطط عمودي مكدس ._ x000d_ |
| ColumnPercentStacked | `16` | مخطط عمودي مكدس بنسبة 100٪ . |
| Column3D | `17` | مخطط عمودي ثلاثي الأبعاد ._ x000d_ |
| Column3DStacked | `18` | مخطط عمودي مكدس ثلاثي الأبعاد ._ x000d_ |
| Column3DPercentStacked | `19` | مخطط عمودي مكدس بنسبة 100٪ ثلاثي الأبعاد . |
| Column3DClustered | `20` | مخطط عمودي مجمع ثلاثي الأبعاد ._ x000d_ |
| Doughnut | `21` | مخطط دائري . |
| Line | `22` | مخطط خطي . |
| LineStacked | `23` | مخطط خطي مكدس ._ x000d_ |
| LinePercentStacked | `24` | مخطط خطي مكدس بنسبة 100٪ . |
| Line3D | `25` | مخطط خطي ثلاثي الأبعاد . |
| Pie | `26` | مخطط دائري ._ x000d_ |
| Pie3D | `27` | مخطط دائري ثلاثي الأبعاد ._ x000d_ |
| PieOfBar | `28` | مخطط دائري شريطي ._ x000d_ |
| PieOfPie | `29` | مخطط دائري دائري ._ x000d_ |
| Radar | `30` | مخطط رادار ._ x000d_ |
| Scatter | `31` | مخطط مبعثر ._ x000d_ |
