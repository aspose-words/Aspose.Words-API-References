...
description: يحدد المواضع المحتملة لعلامات التجزئة ._ x000d_
type: docs
weight: 580
...
يحدد المواضع المحتملة لعلامات التجزئة ._ x000d_
...
| Inside | `1` | تحديد أن تكون علامات التجزئة داخل منطقة قطعة الأرض. _ x000d_ |
| Outside | `2` | تحديد أن تكون علامات التجزئة خارج منطقة قطعة الأرض. _ x000d_ |
| None | `3` | يحدد أنه لن يكون هناك علامات تجزئة ._ x000d_ |
