...
description: يحدد المقدار الذي يجب نقل نقطة البيانات من مركز الدائرة. يمكن أن تكون سالبة  وتعني السالبة أن الخاصية لم يتم تعيينها ولا يجب تطبيق أي انفجار. ينطبق فقط على المخططات الدائرية .
type: docs
weight: 20
