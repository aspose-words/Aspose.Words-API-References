...
description: اكتشف خاصية ShowCategoryName في ChartDataLabelCollection. تحكّم في رؤية تسميات البيانات لسلسلتك وحسّن وضوح مخططك!
type: docs
weight: 110
...
يسمح بتحديد ما إذا كان سيتم عرض اسم الفئة لملصقات البيانات الخاصة بالسلسلة بأكملها. القيمة الافتراضية هي`خطأ شنيع` .
...
يمكن تجاوز القيمة المحددة لهذه الخاصية لعلامة بيانات فردية باستخدام [`ShowCategoryName`](../../chartdatalabel/showcategoryname/) الملكية.
