...
description: اكتشف خاصية ShowDataLabelsRange في ChartDataLabelCollection. تحكّم في رؤية تسميات البيانات لسلسلتك، وحسّن عرض البيانات بسهولة!
type: docs
weight: 120
...
يسمح بتحديد ما إذا كانت القيم من نطاق تسميات البيانات سيتم عرضها في تسميات البيانات الخاصة بالسلسلة بأكملها. القيمة الافتراضية هي`خطأ شنيع` .
...
يمكن تجاوز القيمة المحددة لهذه الخاصية لعلامة بيانات فردية باستخدام [`ShowDataLabelsRange`](../../chartdatalabel/showdatalabelsrange/) الملكية.
