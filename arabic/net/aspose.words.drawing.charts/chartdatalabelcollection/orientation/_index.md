...
description: اكتشف خاصية اتجاه ChartDataLabelCollection لتخصيص اتجاه النص لملصقات البيانات الخاصة بك بسهولة، مما يعزز وضوح الرسم البياني وتأثيره.
type: docs
weight: 60
url: /ar/net/aspose.words.drawing.charts/chartdatalabelcollection/orientation/
---
## ChartDataLabelCollection.Orientation property

يحصل على اتجاه النص لملصقات البيانات الخاصة بالسلسلة بأكملها أو يعينه.
