...
description: اكتشف كيفية استخدام طريقة ClearFormat في ChartDataLabelCollection لإعادة تعيين جميع تنسيقات تسميات بيانات الرسم البياني بسهولة للحصول على صور أكثر وضوحًا.
type: docs
weight: 180
...
يمسح تنسيق الكل[`ChartDataLabel`](../../chartdatalabel/) في هذه المجموعة.
