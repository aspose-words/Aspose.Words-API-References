...
description: اكتشف خاصية ChartDataPoint Marker لتحسين مخططاتك باستخدام علامات بيانات قابلة للتخصيص للحصول على رؤى أكثر وضوحًا وتصورات مؤثرة.
type: docs
weight: 60
...
يحدد علامة بيانات الرسم البياني.
