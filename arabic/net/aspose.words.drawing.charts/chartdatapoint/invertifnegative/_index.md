...
description: اكتشف كيف تعمل خاصية ChartDataPoint InvertIfNegative على تحسين تصور البيانات عن طريق عكس الألوان للقيم السلبية، مما يؤدي إلى تحسين الوضوح والتأثير.
type: docs
weight: 50
...
يحدد ما إذا كان العنصر الرئيسي سيعكس ألوانه إذا كانت القيمة سلبية.
