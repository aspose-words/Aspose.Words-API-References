...
description: اكتشف خاصية "إظهار مفتاح الأسطورة" في ChartDataLabel للتحكم بسهولة في رؤية مفتاح الأسطورة على مخططاتك. حسّن وضوح البيانات وعرضها بسهولة!
type: docs
weight: 170
...
يسمح بتحديد ما إذا كان سيتم عرض مفتاح الأسطورة لملصقات البيانات على الرسم البياني. القيمة الافتراضية هي`خطأ شنيع` .
