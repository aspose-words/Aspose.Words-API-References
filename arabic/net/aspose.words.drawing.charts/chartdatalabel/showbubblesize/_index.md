...
description: ChartDataLabel ملكية. يسمح بتحديد ما إذا كان سيتم عرض حجم الفقاعة لتسميات البيانات على الرسم البياني. ينطبق فقط على المخططات الفقاعية. القيمة الافتراضية خاطئة .
type: docs
weight: 60
