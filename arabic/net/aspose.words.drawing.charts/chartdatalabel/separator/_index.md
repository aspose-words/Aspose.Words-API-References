...
description: الحصول على أو تعيين فاصل السلسلة المستخدم لتسميات البيانات على الرسم البياني. الافتراضي هو الفاصلة  باستثناء المخططات الدائرية التي تعرض اسم الفئة والنسبة المئوية فقط  عند استخدام فاصل أسطر بدلاً من ذلك.
type: docs
weight: 50
