...
description: اكتشف خاصية تنسيق ChartDataLabel للوصول بسهولة إلى تنسيق التعبئة والخط القابل للتخصيص، مما يعزز تصور البيانات لديك بسهولة.
type: docs
weight: 20
...
يوفر إمكانية الوصول إلى تنسيق التعبئة والخطوط لملصق البيانات.
