...
description: اكتشف كيفية استخدام طريقة ChartDataLabel ClearFormat لإعادة تعيين تسميات البيانات إلى الإعدادات الافتراضية، مما يعزز الوضوح والتناسق في الرسوم البيانية الخاصة بك.
type: docs
weight: 230
...
يمسح تنسيق تسمية البيانات هذه. تم ضبط الخصائص على القيم الافتراضية المحددة في مجموعة تسميات data الأصلية.
