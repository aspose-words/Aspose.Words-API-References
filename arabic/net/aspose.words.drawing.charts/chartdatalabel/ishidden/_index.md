...
description: اكتشف خاصية ChartDataLabel IsHidden للتحكم بسهولة في ظهور التسميات في مخططاتك. حسّن عرض بياناتك بهذه الميزة البسيطة!
type: docs
weight: 40
...
يحصل على/يضبط علامة تشير إلى ما إذا كانت هذه العلامة مخفية أم لا. القيمة الافتراضية هي`خطأ شنيع` .
