...
description: ChartDataLabel ملكية. يحصل / يحدد علامة تشير إلى ما إذا كانت هذه التسمية مخفية. القيمة الافتراضية هي خاطئة .
type: docs
weight: 20
...
يحصل / يحدد علامة تشير إلى ما إذا كانت هذه التسمية مخفية. القيمة الافتراضية هي **خاطئة** .
