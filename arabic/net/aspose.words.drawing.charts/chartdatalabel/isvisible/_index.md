...
description: اكتشف كيف تعمل خاصية ChartDataLabel IsVisible على تعزيز تصور البيانات من خلال التأكيد على موعد جاهزية العلامات لعرض رؤى قيمة.
type: docs
weight: 50
...
إرجاع`حقيقي` إذا كان ملصق البيانات هذا يحتوي على شيء لعرضه.
