...
description: ChartDataLabel ShowDataLabelsRange ملكية. يسمح بتحديد ما إذا كانت القيم من تسميات البيانات سيتم عرضها في تسميات البيانات. القيمة الافتراضية هيخطأ شنيع  في C#.
type: docs
weight: 100
