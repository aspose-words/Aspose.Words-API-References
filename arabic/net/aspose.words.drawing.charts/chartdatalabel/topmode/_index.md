...
description: اكتشف خاصية ChartDataLabel TopMode لتخصيص موضع تسميات البيانات على مخططاتك. حسّن الوضوح والدقة في عروضك المرئية للبيانات!
type: docs
weight: 220
url: /ar/net/aspose.words.drawing.charts/chartdatalabel/topmode/
---
## ChartDataLabel.TopMode property

يحصل على وضع التفسير أو يعينه[`Top`](../top/) قيمة الخاصية: ما إذا كانت تحدد موقع لتسمية البيانات من الحافة العلوية للرسم البياني أو من الموضع المحدد بواسطة[`Position`](../position/) الخاصية.
