...
description: اكتشف خاصية ChartDataLabel LeftMode لتخصيص موضع تسميات البيانات في مخططاتك. حسّن الوضوح والعرض من خلال التحكم الدقيق.
type: docs
weight: 70
url: /ar/net/aspose.words.drawing.charts/chartdatalabel/leftmode/
---
## ChartDataLabel.LeftMode property

يحصل على وضع التفسير أو يعينه[`Left`](../left/) قيمة الخاصية: ما إذا كانت تحدد موقع لتسمية البيانات من الحافة اليسرى للرسم البياني أو من الموضع المحدد بواسطة[`Position`](../position/) الخاصية.
