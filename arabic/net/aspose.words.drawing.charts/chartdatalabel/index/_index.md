...
description: اكتشف خاصية فهرس ChartDataLabel، وحدد تسلسل العناصر، وحسّن عرض البيانات. القيمة الافتراضية هي 0 لسهولة التكامل.
type: docs
weight: 30
...
يحدد مؤشر العنصر المحتوي. يحدد هذا المؤشر أي من مجموعات الأطفال الأصلية ينطبق عليها هذا العنصر. القيمة الافتراضية هي 0.
