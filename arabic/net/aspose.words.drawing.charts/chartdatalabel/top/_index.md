...
description: اضبط خاصية ChartDataLabel Top للتحكم في موضع تسميات البيانات، مما يزيد من وضوح الرسم البياني. حسّن تمثيل بياناتك المرئي بسهولة!
type: docs
weight: 210
url: /ar/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

يحصل على أو يعين مسافة تسمية البيانات بالنقاط من الحافة العلوية للرسم البياني أو من الموضع المحدد بواسطة[`Position`](../position/) الممتلكات، اعتمادا على قيمة[`TopMode`](../topmode/) الخاصية.
