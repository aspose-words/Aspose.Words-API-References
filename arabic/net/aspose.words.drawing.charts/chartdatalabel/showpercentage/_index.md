...
description: فعّل عرض النسب المئوية على تسميات بيانات المخطط باستخدام خاصية "إظهار النسبة المئوية" في ChartDataLabel. حسّن وضوح بياناتك المرئية ووضوحها!
type: docs
weight: 180
...
يسمح بتحديد ما إذا كان سيتم عرض قيمة النسبة المئوية لملصقات البيانات على الرسم البياني. القيمة الافتراضية هي`خطأ شنيع` .
