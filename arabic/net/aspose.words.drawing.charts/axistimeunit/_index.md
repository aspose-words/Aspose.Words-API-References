...
description: Aspose.Words.Drawing.Charts.AxisTimeUnit تعداد. يحدد الوحدة الزمنية للمحاور .
type: docs
weight: 590
...
| Days | `1` | يحدد عرض بيانات الرسم البياني بالأيام. |
| Months | `2` | يحدد عرض بيانات الرسم البياني بالأشهر. |
| Years | `3` | يحدد عرض بيانات المخطط بالسنوات. |
