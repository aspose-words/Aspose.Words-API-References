...
description: اكتشف خاصية ChartYValueCollection FormatCode لتخصيص تنسيق قيمة Y بسهولة. حسّن دقة عرض بياناتك!
type: docs
weight: 20
url: /ar/net/aspose.words.drawing.charts/chartyvaluecollection/formatcode/
---
## ChartYValueCollection.FormatCode property

يحصل على رمز التنسيق المطبق على قيم Y أو يعينه.
