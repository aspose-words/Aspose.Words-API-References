...
| اسم | وصف |
| --- | --- |
| [DateTimeValue](../../aspose.words.drawing.charts/chartxvalue/datetimevalue/) { get; } | الحصول على قيمة التاريخ والوقت المخزنة. |
| [DoubleValue](../../aspose.words.drawing.charts/chartxvalue/doublevalue/) { get; } | الحصول على القيمة الرقمية المخزنة. |
| [MultilevelValue](../../aspose.words.drawing.charts/chartxvalue/multilevelvalue/) { get; } | الحصول على القيمة المخزنة متعددة المستويات. |
| [StringValue](../../aspose.words.drawing.charts/chartxvalue/stringvalue/) { get; } | الحصول على قيمة السلسلة المخزنة. |
| [TimeValue](../../aspose.words.drawing.charts/chartxvalue/timevalue/) { get; } | الحصول على قيمة الوقت المخزنة. |
| [ValueType](../../aspose.words.drawing.charts/chartxvalue/valuetype/) { get; } | الحصول على نوع قيمة X المخزنة في الكائن. |
...
يجب أن تكون جميع قيم X غير الخالية لسلسلة المخططات متماثلة[`ChartXValueType`](../chartxvaluetype/) يكتب.
