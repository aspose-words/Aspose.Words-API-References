...
description: اكتشف خاصية الحد الأدنى لـ AxisScaling لتعيين الحد الأدنى لقيمة المحور وتخصيصه بسهولة لتحسين تصور البيانات.
type: docs
weight: 40
...
يحصل على الحد الأدنى لقيمة المحور أو يعينها.
