...
description: استكشف خاصية Chart AxisX للتحكم بشكل سلس في المحور X الأساسي للرسم البياني الخاص بك، مما يعزز تصور البيانات والرؤى.
type: docs
weight: 20
...
يوفر الوصول إلى خصائص المحور X الأساسي للرسم البياني.
