...
description: استكشف خاصية Chart AxisZ لفتح خيارات تخصيص المحور Z، مما يعزز تصور البيانات لديك للحصول على رؤى أكثر وضوحًا وعروض تقديمية مؤثرة.
type: docs
weight: 40
...
يوفر الوصول إلى خصائص المحور Z للرسم البياني.
