...
description: استخدم أداتنا لتعديل تنسيقات الرسوم البيانية المتقدمة! خصص أنماط التعبئة والخطوط بسهولة للحصول على صور احترافية رائعة تُحسّن عرض بياناتك.
type: docs
weight: 60
url: /ar/net/aspose.words.drawing.charts/chart/format/
---
## Chart.Format property

يوفر إمكانية الوصول إلى تعبئة وتنسيق الخطوط للرسم البياني.
