...
description: اكتشف خاصية اسم ChartSeries، وقم بإدارة أسماء السلسلة بسهولة، وإنشاءها تلقائيًا باستخدام المؤشرات، وتحسين تصور البيانات بسهولة.
type: docs
weight: 110
...
يحصل على اسم السلسلة أو يعينه، إذا لم يتم تعيين الاسم صراحةً، فسيتم إنشاؤه باستخدام الفهرس. بشكل افتراضي، يتم إرجاع السلسلة بالإضافة إلى فهرس واحد بناءً على ذلك.
