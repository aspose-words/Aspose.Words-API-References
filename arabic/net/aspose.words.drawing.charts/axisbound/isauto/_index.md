...
description: اكتشف AxisBound IsAuto. حدّد حدود المحاور تلقائيًا لتحسين تصور البيانات وتحليلها. حسّن مخططاتك البيانية بسهولة!
type: docs
weight: 20
...
يعيد علمًا يشير إلى أنه يجب تحديد حدود المحور تلقائيًا.
