...
description: اكتشف خاصية BubbleSizeCollection FormatCode لتخصيص أحجام الفقاعات بسهولة. حسّن عرض بياناتك باستخدام خيارات تنسيق مخصصة.
type: docs
weight: 20
url: /ar/net/aspose.words.drawing.charts/bubblesizecollection/formatcode/
---
## BubbleSizeCollection.FormatCode property

يحصل على رمز التنسيق المطبق على أحجام الفقاعات أو يعينه.
