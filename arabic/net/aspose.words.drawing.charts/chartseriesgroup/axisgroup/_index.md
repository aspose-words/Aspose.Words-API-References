...
description: اكتشف خاصية ChartSeriesGroup AxisGroup، وقم بإدارة محور مجموعة السلسلة الخاصة بك بسهولة لتحسين تصور البيانات وتحليلها.
type: docs
weight: 10
url: /ar/net/aspose.words.drawing.charts/chartseriesgroup/axisgroup/
---
## ChartSeriesGroup.AxisGroup property

يحصل على مجموعة المحاور التي تنتمي إليها مجموعة السلسلة هذه أو يعينها.
