...
description: اكتشف خاصية ChartSeriesGroup SeriesType لتحديد أنواع سلسلة المخططات بسهولة في تصورات البيانات الخاصة بك للحصول على تحليلات ورؤى محسّنة.
type: docs
weight: 110
url: /ar/net/aspose.words.drawing.charts/chartseriesgroup/seriestype/
---
## ChartSeriesGroup.SeriesType property

يحصل على نوع سلسلة المخططات المضمنة في هذه المجموعة.
