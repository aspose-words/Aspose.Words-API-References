...
description: اكتشف خاصية ChartSeriesGroup AxisX للوصول بسهولة إلى ميزات المحور X، مما يعزز تجربة تحليل البيانات وتصورها.
type: docs
weight: 20
url: /ar/net/aspose.words.drawing.charts/chartseriesgroup/axisx/
---
## ChartSeriesGroup.AxisX property

يوفر الوصول إلى خصائص المحور X لهذه المجموعة المتسلسلة.
