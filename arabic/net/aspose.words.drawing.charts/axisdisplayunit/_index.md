...
| اسم | وصف |
| --- | --- |
| [CustomUnit](../../aspose.words.drawing.charts/axisdisplayunit/customunit/) { get; set; } | الحصول على أو تعيين قاسم معرف من قبل المستخدم لقياس وحدات العرض على محور القيمة. |
| [Document](../../aspose.words.drawing.charts/axisdisplayunit/document/) { get; } | إرجاع المستند الذي ينتمي إليه صاحب العنوان . |
