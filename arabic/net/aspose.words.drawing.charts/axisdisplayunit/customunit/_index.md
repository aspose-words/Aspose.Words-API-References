...
description: AxisDisplayUnit ملكية. الحصول على أو تعيين قاسم معرف من قبل المستخدم لقياس وحدات العرض على محور القيمة.
type: docs
weight: 20
...
الحصول على أو تعيين قاسم معرف من قبل المستخدم لقياس وحدات العرض على محور القيمة.
...
الخاصية غير مدعومة بواسطة مخططات MS Office 2016 الجديدة. القيمة الافتراضية هي 1.

تعيين هذه الخاصية يعيّن[`Unit`](../unit/) الخاصية إلى Custom.
