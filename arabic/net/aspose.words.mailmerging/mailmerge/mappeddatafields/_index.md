...
description: إرجاع مجموعة تمثل حقول البيانات المعينة لعملية دمج المراسلات.
type: docs
weight: 50
...
تسمح حقول البيانات المعينة بالتعيين تلقائيًا بين أسماء الحقول في مصدر البيانات_ x000d_ وأسماء حقول دمج البريد في المستند.
