...
description: اكتشف خاصية MailMerge RegionEndTag لإدارة مناطق دمج البريد بكفاءة. بسّط أتمتة المستندات من خلال تكامل سلس للعلامات.
type: docs
weight: 90
...
يحصل على علامة نهاية منطقة دمج البريد أو يعينها.
