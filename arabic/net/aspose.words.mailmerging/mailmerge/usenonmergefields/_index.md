...
description: عندما يكون صحيحًا  يحدد أنه بالإضافة إلى حقول MERGEFIELD  يتم تنفيذ دمج المراسلات في بعض أنواع الحقول الأخرى و_ x000d_ أيضًا في علامات fieldName.
type: docs
weight: 150
...
عندما يكون صحيحًا ، يحدد أنه بالإضافة إلى حقول MERGEFIELD ، يتم تنفيذ دمج المراسلات في بعض أنواع الحقول الأخرى و_ x000d_ أيضًا في علامات "{{fieldName}}".
...
عادةً ، يتم تنفيذ دمج البريد فقط في حقول MERGEFIELD ، ولكن العديد من العملاء قد تم إنشاء تقاريرهم_ x000d_ باستخدام حقول أخرى وتم إنشاء العديد من المستندات بهذه الطريقة. لتبسيط الترحيل (ولأن هذا الأسلوب تم استخدامه بشكل مستقل من قبل العديد من العملاء) تم تقديم القدرة على دمج البريد في الحقول الأخرى.
