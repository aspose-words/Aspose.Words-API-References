...
description: اكتشف خاصية MailMerge RegionStartTag لتحديد مناطق دمج البريد وتخصيصها بسهولة، مما يعزز عملية أتمتة المستندات لديك.
type: docs
weight: 100
...
يحصل على علامة بدء منطقة دمج البريد أو يعينها.
