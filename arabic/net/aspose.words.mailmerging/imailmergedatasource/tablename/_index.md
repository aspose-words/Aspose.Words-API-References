...
description: إرجاع اسم مصدر البيانات.
type: docs
weight: 10
...
إذا كنت تنفذ[`IMailMergeDataSource`](../../imailmergedatasource)، قم بإرجاع اسم مصدر data من هذه الخاصية.

يستخدم Aspose.Words هذا الاسم لمطابقة اسم منطقة دمج المراسلات المحدد في مستند النموذج. المقارنة بين اسم مصدر البيانات و_ x000d_ اسم منطقة دمج المراسلات ليست حساسة لحالة الأحرف.
