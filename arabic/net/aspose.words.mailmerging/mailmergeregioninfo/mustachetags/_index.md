...
description: اكتشف خاصية MailMergeRegionInfo MustacheTags، التي تقوم بإرجاع قائمة شاملة من علامات mustache الفرعية بكفاءة لضمان تكامل البيانات بسلاسة.
type: docs
weight: 50
...
يعيد قائمة من علامات "الشارب" الفرعية.
