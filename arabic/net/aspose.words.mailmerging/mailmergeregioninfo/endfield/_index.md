...
description: اكتشف خاصية MailMergeRegionInfo EndField، التي تقوم بإرجاع حقل النهاية لمناطق البيانات الخاصة بك بكفاءة، مما يعزز أتمتة المستندات لديك.
type: docs
weight: 10
