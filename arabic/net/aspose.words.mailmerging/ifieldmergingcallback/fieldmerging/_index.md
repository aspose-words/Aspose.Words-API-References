...
description: IFieldMergingCallback طريقة. تم الاستدعاء عندما يكون محرك دمج المراسلات Aspose.Words على وشك إدراج البيانات في حقل دمج في المستند.
type: docs
weight: 10
...
تم الاستدعاء عندما يكون محرك دمج المراسلات Aspose.Words على وشك إدراج البيانات في حقل دمج في المستند.
