...
description: اضبط ImageFileName في ImageFieldMergingArgs لإدراج الصور بسهولة في مستنداتك أثناء دمج البريد. حسّن سير عملك اليوم!
type: docs
weight: 20
...
يحدد اسم ملف الصورة التي يجب على محرك دمج البريد إدراجها في المستند.
