...
description: اكتشف وجود تعيين حقل مستند محدد في MappedDataFieldCollection باستخدام طريقة ContainsKey. سهّل إدارة البيانات!
type: docs
weight: 50
...
يحدد ما إذا كان تعيين الحقل المحدد في المستند موجودًا في المجموعة.
