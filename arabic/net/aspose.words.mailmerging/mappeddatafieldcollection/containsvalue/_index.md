...
description: اكتشف وجود تعيين حقل في MappedDataFieldCollection باستخدام طريقة ContainsValue. حسّن كفاءة إدارة بياناتك اليوم!
type: docs
weight: 60
...
يحدد ما إذا كان هناك تعيين من الحقل المحدد في مصدر البيانات موجودًا في المجموعة.
