...
description: اكتشف خاصية عنصر MappedDataFieldCollection لإدارة أسماء الحقول في مصدر البيانات لديك بسهولة لتحقيق تكامل دمج البريد بسلاسة.
type: docs
weight: 20
...
يحصل على اسم الحقل في مصدر البيانات المرتبط بحقل دمج البريد المحدد أو يعينه.
