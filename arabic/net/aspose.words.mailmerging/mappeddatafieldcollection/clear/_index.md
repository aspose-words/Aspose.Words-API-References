...
description: قم بمسح MappedDataFieldCollection الخاص بك بسهولة باستخدام طريقة Clear الخاصة بنا، والتي تعمل على إزالة جميع العناصر على الفور لإدارة البيانات بشكل مبسط.
type: docs
weight: 40
