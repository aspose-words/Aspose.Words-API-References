...
| اسم | قيمة | وصف |
| --- | --- | --- |
| None | `0` | تحديد قيمة افتراضية ._ x000d_ |
...
| RemoveStaticFields | `10` | تحديد ما إذا كان يجب إزالة الحقول الثابتة من المستند. الحقول الثابتة هي الحقول التي_تظل النتائج كما هي عند تغيير أي مستند. الحقول التي لا تخزن نتائجها في ملف document ويتم حسابها سريعًا (مثلFieldListNum ، FieldSymbol ، وما إلى ذلك) لا تعتبر ثابتة. |
