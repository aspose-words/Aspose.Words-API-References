...
description: IMailMergeDataSourceRoot طريقة. يستدعي محرك دمج المراسلات Aspose.Words هذه الطريقة عندما يواجه بداية منطقة دمج بريد عالية المستوى .
type: docs
weight: 10
...
يستدعي محرك دمج المراسلات Aspose.Words هذه الطريقة عندما يواجه بداية منطقة دمج بريد عالية المستوى .
...
عندما تملأ محركات دمج المراسلات Aspose.Words مستندًا بالبيانات وتواجه MERGEFIELD TableStart: TableName ، تستدعي`GetDataSource` على هذا الكائن. يحتاج التنفيذ الخاص بك إلى إرجاع كائن مصدر بيانات جديد.

في حالة عدم وجود مصدر بيانات (جدول) بالاسم المحدد ، يجب أن يعود التنفيذ`لا شيء` .
