...
description: اكتشف خاصية FieldMergingArgsBase TableName، وقم بالوصول بسهولة إلى اسم جدول البيانات لعمليات الدمج الخاصة بك، أو تعرف على وقت عدم توفره.
type: docs
weight: 70
...
يحصل على اسم جدول البيانات لعملية الدمج الحالية أو سلسلة فارغة إذا لم يكن الاسم متاحًا.
