...
description: CleanupOptions ملكية. تحديد ذلك غير المستخدمBuiltIn يجب إزالة الأنماط من المستند.
type: docs
weight: 30
...
تحديد ذلك غير المستخدم[`BuiltIn`](../../style/builtin/) يجب إزالة الأنماط من المستند.
