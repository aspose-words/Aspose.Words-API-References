...
description: FileFormatInfo ملكية. يتم إرجاع صحيح إذا كان هذا المستند يحتوي على توقيع رقمي. تخبر هذه الخاصية فقط بوجود توقيع رقمي على المستند  ولكنها لا تحدد ما إذا كان التوقيع صالحًا أم لا.
type: docs
weight: 20
