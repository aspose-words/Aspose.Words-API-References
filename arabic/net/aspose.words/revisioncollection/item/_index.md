...
description: الوصول إلى المراجعات المحددة بسهولة باستخدام خاصية عنصر RevisionCollection. استرجع المراجعات بسرعة حسب الفهرس لإدارة بيانات مبسطة.
type: docs
weight: 30
...
يعيد[`Revision`](../../revision/) عند الفهرس المحدد.
