...
description: اكتشف حقل ControlChar DefaultTextInputChar، الذي يتميز بحرف "o" كخيار افتراضي مثالي لنماذج إدخال النص. حسّن تجربة المستخدم!
type: docs
weight: 70
url: /ar/net/aspose.words/controlchar/defaulttextinputchar/
---
## ControlChar.DefaultTextInputChar field

هذا هو الحرف "o" المستخدم كقيمة افتراضية في حقول نموذج إدخال النص.
