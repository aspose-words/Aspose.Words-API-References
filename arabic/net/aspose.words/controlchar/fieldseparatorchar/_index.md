...
description: ControlChar مجال. يفصل حرف فاصل الحقل رمز الحقل عن قيمة الحقل. اختياري في بعض المجالات. القيمة شار 20.
type: docs
weight: 90
...
يفصل حرف فاصل الحقل رمز الحقل عن قيمة الحقل. اختياري في بعض المجالات. القيمة: (شار) 20.
