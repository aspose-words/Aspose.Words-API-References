...
description: اكتشف كيف يعمل ControlChar FieldSeparatorChar على تعزيز إدارة البيانات من خلال فصل رموز الحقول عن القيم بشكل فعال، مما يؤدي إلى تحسين سير عملك دون عناء.
type: docs
weight: 90
url: /ar/net/aspose.words/controlchar/fieldseparatorchar/
---
## ControlChar.FieldSeparatorChar field

يفصل حرف فاصل الحقل رمز الحقل عن قيمته. اختياري في بعض الحقول. القيمة: (char)20.
