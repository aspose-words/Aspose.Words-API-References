...
description: واصلة اختيارية في Microsoft Word هي حرف 31.
type: docs
weight: 190
...
لا تتوافق الواصلة الاختيارية في Microsoft Word مع حرف Unicode U + 00AD الواصلة الناعمة. _ x000d_ بدلاً من ذلك ، تُدرج المعلومات الداخلية التي تخبر Word عن نقطة الواصلة المحتملة.
