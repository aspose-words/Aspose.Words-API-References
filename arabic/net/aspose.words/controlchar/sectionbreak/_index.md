...
description: اكتشف حقل ControlChar SectionBreak، وقم بإدارة أقسام المستند بكفاءة باستخدام حرف x000c، مما يعمل على تحسين التنسيق وإمكانية القراءة.
type: docs
weight: 240
...
حرف نهاية المقطع: "\x000c" أو "\f". لاحظ أن قيمته هي نفسها[`PageBreak`](../pagebreak/) .
