...
description: ControlChar مجال. نهاية حرف القسم  x000c أو  f. لاحظ أن لها نفس القيمة مثلPageBreak .
type: docs
weight: 240
...
نهاية حرف القسم: "\ x000c" أو "\ f". لاحظ أن لها نفس القيمة مثل[`PageBreak`](../pagebreak/) .
