...
description: اكتشف حقل فواصل الفقرات ControlChar. أدر فواصل الفقرات بسهولة باستخدام حرف x000d لتنسيق نص سلس وقراءة أفضل.
type: docs
weight: 220
url: /ar/net/aspose.words/controlchar/paragraphbreak/
---
## ControlChar.ParagraphBreak field

حرف نهاية الفقرة: "\x000d" أو "\r". نفس[`Cr`](../cr/)
