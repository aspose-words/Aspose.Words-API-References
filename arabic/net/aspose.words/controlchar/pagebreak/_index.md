...
description: ControlChar مجال. حرف فاصل الصفحة  x000c أو  f. لاحظ أن لها نفس القيمة مثلSectionBreak .
type: docs
weight: 200
...
حرف فاصل الصفحة: "\ x000c" أو "\ f". لاحظ أن لها نفس القيمة مثل[`SectionBreak`](../sectionbreak/) .
