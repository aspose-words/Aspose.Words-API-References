...
description: اكتشف ControlChar CrLf، مفتاح تنسيق النصوص بكفاءة. تعرّف على كيفية تحسين فواصل الفقرات في ملفات النصوص باستخدام علامتي إرجاع السطر وتغذية السطر.
type: docs
weight: 60
