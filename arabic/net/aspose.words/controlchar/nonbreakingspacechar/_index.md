...
description: اكتشف ControlChar NonBreakingSpaceChar لتنسيق نصوص سلس. حسّن مستنداتك باستخدام حرف المسافة غير المنقطعة char160 لتحسين قابلية القراءة.
type: docs
weight: 180
url: /ar/net/aspose.words/controlchar/nonbreakingspacechar/
---
## ControlChar.NonBreakingSpaceChar field

حرف مسافة غير قابلة للكسر: (char)160.
