...
description: اكتشف خاصية TableStyle ConditionalStyles—قم بتخصيص جدولك باستخدام أنماط شرطية فريدة لتحسين المظهر والوظائف.
type: docs
weight: 80
...
مجموعة من الأنماط الشرطية التي يمكن تعريفها لهذا الجدول style.
