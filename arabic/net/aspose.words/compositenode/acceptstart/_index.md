...
description: اكتشف كيف تعمل طريقة CompositeNode AcceptStart على تعزيز معالجة المستندات من خلال استدعاء طريقة VisitXXXStart لتحقيق التكامل السلس للزائر.
type: docs
weight: 70
url: /ar/net/aspose.words/compositenode/acceptstart/
---
## CompositeNode.AcceptStart method

عند تنفيذه في فئة مشتقة، يتم استدعاء طريقة VisitXXXStart للزائر المستند المحدد.
