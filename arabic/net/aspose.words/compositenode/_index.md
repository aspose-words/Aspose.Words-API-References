...
description: اكتشف فئة Aspose.Words.CompositeNode، أداة أساسية لإنشاء هياكل مستندات معقدة بسهولة وكفاءة.
type: docs
weight: 500
...
* تنفيذ العمليات المركبة مثل إدراج وإزالة الأطفال.
* توفر طرقًا للتنقل في XPath.
