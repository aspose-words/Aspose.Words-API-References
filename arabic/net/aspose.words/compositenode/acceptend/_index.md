...
description: اكتشف كيفية تحسين معالجة المستندات باستخدام طريقة AcceptEnd من CompositeNode. بسّط عملية تنفيذ نمط الزائر لديك لتحقيق أداء مثالي.
type: docs
weight: 60
url: /ar/net/aspose.words/compositenode/acceptend/
---
## CompositeNode.AcceptEnd method

عند تنفيذه في فئة مشتقة، يتم استدعاء طريقة VisitXXXEnd للزائر المستند المحدد.
