...
description: CompositeNode PrependChild طريقة. إضافة العقدة المحددة إلى بداية قائمة العقد التابعة لهذه العقدة في C#.
type: docs
weight: 150
...
إضافة العقدة المحددة إلى بداية قائمة العقد التابعة لهذه العقدة.
