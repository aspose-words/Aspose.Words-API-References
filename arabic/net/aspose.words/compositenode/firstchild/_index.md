...
description: اكتشف خاصية CompositeNode FirstChild للوصول بسهولة إلى أول عقدة فرعية، مما يعزز كفاءة الترميز لديك ويبسط إدارة البيانات.
type: docs
weight: 20
...
إذا لم تكن هناك عقدة فرعية أولى،`باطل` تم إرجاعه.
