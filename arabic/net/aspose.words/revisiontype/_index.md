...
description: اكتشف خاصية Aspose.Words.RevisionType لتتبع وإدارة تغييرات المستندات بكفاءة. حسّن دقة تحرير مستنداتك!
type: docs
weight: 5540
...
يحدد نوع التغيير الذي يتم تعقبه في[`Revision`](../revision/) .
...
| StyleDefinitionChange | `3` | تم تطبيق تغيير التنسيق على النمط الرئيسي. |
