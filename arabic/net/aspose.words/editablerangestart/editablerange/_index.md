...
description: اكتشف خاصية EditableRangeStart، مفتاحك لإدارة النطاقات القابلة للتعديل بسهولة. تمتع بالوصول إلى محتواك والتحكم فيه بسهولة!
type: docs
weight: 10
...
يحصل على كائن الواجهة الذي يغلف بداية ونهاية هذا النطاق القابل للتحرير.
