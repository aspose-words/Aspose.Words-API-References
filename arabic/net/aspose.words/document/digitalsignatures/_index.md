...
description: الحصول على مجموعة التوقيعات الرقمية لهذا المستند ونتائج التحقق من صحتها.
type: docs
weight: 100
...
تحتوي هذه المجموعة على تواقيع رقمية تم تحميلها من المستند الأصلي ._ x000d_ لن يتم حفظ هذه التوقيعات الرقمية عند حفظ هذا[`Document`](../../document) object في ملف أو دفق لأن الحفظ أو التحويل سينتج مستندًا مختلفًا عن الأصلي ولن تكون التوقيعات الرقمية الأصلية صالحة.
