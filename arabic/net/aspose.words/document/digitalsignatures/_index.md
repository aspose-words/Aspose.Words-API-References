...
تحتوي هذه المجموعة على تواقيع رقمية تم تحميلها من المستند الأصلي . لن يتم حفظ هذه التوقيعات الرقمية عند حفظ هذا[`Document`](../../document) object في ملف أو دفق لأن الحفظ أو التحويل سينتج مستندًا مختلفًا عن الأصلي ولن تكون التوقيعات الرقمية الأصلية صالحة.
