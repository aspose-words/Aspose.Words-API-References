...
description: إرجاع أFramesetaspose.words/document/framesetمثال إذا كان هذا المستند يمثل صفحة إطارات.
type: docs
weight: 160
...
إذا لم يكن المستند مؤطرًا ، فإن الخاصية لها الامتداد **لا شيء** القيمة ._ x000d_
