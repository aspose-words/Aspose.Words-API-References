...
description: Document ملكية. يوفر خيارات تتحكم في ترقيم وموضع التعليقات الختامية في هذا المستند.
type: docs
weight: 110
...
يوفر خيارات تتحكم في ترقيم وموضع التعليقات الختامية في هذا المستند.
