...
description: يمكنك الوصول إلى خاصية ببليوغرافيا المستندات لاسترجاع قائمة شاملة من المصادر، مما يعزز بحثك ودقة الاستشهادات.
type: docs
weight: 40
url: /ar/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

يحصل على`Bibliography`الكائن الذي يمثل قائمة المصادر المتوفرة في المستند.
