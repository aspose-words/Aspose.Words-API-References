...
description: استكشف طريقة AcceptEnd للمستند لإدارة وصول الزوار بكفاءة في نهاية المستند. حسّن تجربة المستخدم من خلال التنقل السلس.
type: docs
weight: 550
...
يقبل الزائر لزيارة نهاية المستند.
