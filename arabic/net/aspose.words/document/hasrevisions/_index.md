...
description: اكتشف ما إذا كان مستندك قد تعقب التغييرات باستخدام خاصية HasRevisions. أدر التعديلات بسهولة وحسّن كفاءة سير عملك.
type: docs
weight: 210
...
إرجاع`حقيقي` إذا كان المستند يحتوي على أي تغييرات متعقبة.
