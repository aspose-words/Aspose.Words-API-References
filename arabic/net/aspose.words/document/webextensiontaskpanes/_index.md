...
description: استكشف خاصية WebExtensionTaskPanes للوصول إلى مجموعة قيمة من الوظائف الإضافية لجزء المهام، مما يعمل على تحسين وظائف مستندك وتجربة المستخدم.
type: docs
weight: 510
...
يعيد مجموعة تمثل قائمة من الوظائف الإضافية لجزء المهام.
