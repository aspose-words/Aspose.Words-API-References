...
description: اكتشف طريقة AcceptStart، وقم بالترحيب بالزائرين بسلاسة في بداية مستندك للحصول على تجربة مستخدم محسنة وتنقل أكثر سلاسة.
type: docs
weight: 560
url: /ar/net/aspose.words/document/acceptstart/
---
## Document.AcceptStart method

يقبل الزائر لزيارة بداية المستند.
