...
description: استخدم خيارات توافق المستندات في Word لتخصيص تفضيلات المستخدم وتحسين تجربة التحرير الخاصة بك باستخدام الإعدادات المخصصة للتعاون السلس.
type: docs
weight: 60
...
يوفر الوصول إلى خيارات توافق المستندات (أي تفضيلات المستخدم المدخلة على**التوافق** علامة التبويب من**خيارات**الحوار في Word).
