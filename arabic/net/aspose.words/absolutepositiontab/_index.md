...
description: Aspose.Words.AbsolutePositionTab فصل. علامة تبويب الموضع المطلق هي حرف يُستخدم لتقديم الموضع على السطر الحالي للنص عند عرض محتوى معالجة Word هذا.
type: docs
weight: 10
