...
description: يحدد مجموعة من الأسماء المستعارة المحتملة أو مجموعات التحرير التي يمكن استخدامها كأسماء مستعارة لتحديد ما إذا كان المستخدم الحالي مسموحًا له بتحرير نطاق واحد محدد بنطاق قابل للتحرير داخل مستند.
type: docs
weight: 1300
...
| Everyone | `5` | يحدد أنه يجب السماح لجميع المستخدمين الذين يفتحون المستند بتحرير النطاقات القابلة للتحرير باستخدام هذا النوع من التحرير_ x000d_ عند تمكين حماية المستند. |
| None | `6` | يحدد عدم السماح لأي من المستخدمين الذين يفتحون المستند بتحرير النطاقات القابلة للتحرير_ x000d_ باستخدام نوع التحرير هذا عند تمكين حماية المستند. |
