...
description: Style List ملكية. الحصول على القائمة التي تحدد تنسيق نمط القائمة هذا في C#.
type: docs
weight: 100
...
هذه الخاصية صالحة فقط لأنماط القائمة. بالنسبة لأنواع الأنماط الأخرى، تُرجع هذه الخاصية`باطل`.
