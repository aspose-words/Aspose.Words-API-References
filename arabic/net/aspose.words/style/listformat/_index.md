...
description: يوفر الوصول إلى خصائص تنسيق القائمة الخاصة بنمط الفقرة.
type: docs
weight: 100
...
هذه الخاصية صالحة فقط لأنماط الفقرة ._ x000d_ بالنسبة لأنواع الأنماط الأخرى ، تُرجع هذه الخاصية قيمة خالية.
