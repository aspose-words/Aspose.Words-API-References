...
description: اكتشف منشئ CommentRangeEnd، وقم بإنشاء مثيلات جديدة لهذه الفئة بسهولة لتحقيق تكامل سلس للكود وتحسين الوظائف.
type: docs
weight: 10
...
متى[`CommentRangeEnd`](../) يتم إنشاؤه، فهو ينتمي إلى المستند المحدد، ولكنه ليس جزءًا من المستند بعد[`ParentNode`](../../node/parentnode/) يكون`باطل`.

لإضافة[`CommentRangeEnd`](../) بالنسبة للمستند، استخدم InsertAfter أو InsertBefore في الفقرة التي تريد إدراج التعليق فيها.
