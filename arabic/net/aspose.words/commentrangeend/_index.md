...
description: اكتشف فئة Aspose.Words.CommentRangeEnd، التي تُشير إلى نهاية مناطق النص المرتبطة بالتعليق. حسّن إدارة المستندات بدقة من خلال التعليقات!
type: docs
weight: 440
...
| اسم | وصف |
| --- | --- |
| [CommentRangeEnd](commentrangeend/)(*[DocumentBase](../documentbase/), int*) | يقوم بتهيئة مثيل جديد لهذه الفئة. |
...
| override [NodeType](../../aspose.words/commentrangeend/nodetype/) { get; } | إرجاعCommentRangeEnd . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.words/commentrangeend/accept/)(*[DocumentVisitor](../documentvisitor/)*) | يقبل زائرًا. |
...
لإنشاء تعليق مرتبط بمنطقة من النص، تحتاج إلى إنشاء[`Comment`](../comment/) and ثم قم بإنشاء[`CommentRangeStart`](../commentrangestart/) و`CommentRangeEnd` وتعيين معرفاتهم إلى نفس القيمة[`Id`](../comment/id/) قيمة.

`CommentRangeEnd` هي عقدة على مستوى الخط ولا يمكن أن تكون إلا طفلة لـ[`Paragraph`](../paragraph/).
