...
description: استكشف خاصية CommentRangeEnd NodeType لاسترداد CommentRangeEnd بكفاءة، مما يعزز تجربة الترميز والتطوير لديك.
type: docs
weight: 30
url: /ar/net/aspose.words/commentrangeend/nodetype/
---
## CommentRangeEnd.NodeType property

إرجاعCommentRangeEnd .
