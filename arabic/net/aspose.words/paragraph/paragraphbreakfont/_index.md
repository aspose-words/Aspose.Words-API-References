...
description: اكتشف خاصية ParagraphBreakFont لتنسيق الخطوط بشكل سلس عند فواصل الفقرات، مما يعزز مظهر النص وقابليته للقراءة.
type: docs
weight: 180
...
يوفر الوصول إلى تنسيق الخط لحرف فاصل الفقرة.
