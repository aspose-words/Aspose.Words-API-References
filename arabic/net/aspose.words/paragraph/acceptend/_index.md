...
description: اكتشف طريقة Paragraph AcceptEnd، المصممة لتحسين التنقل في المستندات من خلال قبول الزوار بكفاءة في نهاية الفقرات.
type: docs
weight: 240
...
يقبل الزائر لزيارة نهاية فقرة المستند.
