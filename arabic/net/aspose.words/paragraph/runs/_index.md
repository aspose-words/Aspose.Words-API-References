...
description: اكتشف خاصية تشغيل الفقرات للوصول بسهولة إلى مجموعات النصوص المنسقة داخل الفقرات، مما يعزز بنية مستندك وقابليته للقراءة.
type: docs
weight: 220
...
يوفر الوصول إلى مجموعة النصوص المكتوبة داخل الفقرة.
