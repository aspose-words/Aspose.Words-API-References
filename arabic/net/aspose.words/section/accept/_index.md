...
description: اكتشف طريقة قبول القسم لتعزيز تفاعل الزوار وتبسيط التفاعلات. حسّن أداء موقعك اليوم!
type: docs
weight: 70
...
مكالمات [`VisitSectionStart`](../../documentvisitor/visitsectionstart/) ، ثم يدعو[`Accept`](../../node/accept/) لجميع العقد الفرعية لقسم والمكالمات[`VisitSectionEnd`](../../documentvisitor/visitsectionend/) في النهاية.
