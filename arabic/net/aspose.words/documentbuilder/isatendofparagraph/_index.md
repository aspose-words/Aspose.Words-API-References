...
description: اكتشف خاصية IsAtEndOfParagraph في DocumentBuilder، والتي تتحقق بشكل فعال مما إذا كان المؤشر موجودًا في نهاية الفقرة لتحرير المستند بشكل سلس.
type: docs
weight: 110
...
إرجاع`حقيقي` إذا كان المؤشر في نهاية الفقرة الحالية.
