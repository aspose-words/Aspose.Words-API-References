...
description: تعليم الموضع الحالي في المستند كبداية إشارة عمود. يجب أن يكون الموضع في خلية جدول.
type: docs
weight: 590
...
تغطي الإشارة المرجعية للعمود عمودًا واحدًا أو أكثر في نطاق من الصفوف. لإنشاء إشارة مرجعية صالحة you تحتاج إلى الاتصال بكليهما`StartColumnBookmark` و[`EndColumnBookmark`](../endcolumnbookmark) بنفس_ x000d_ **اسم العلامة** معامل.
