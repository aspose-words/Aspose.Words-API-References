...
description: DocumentBuilder ملكية. يحصل على العقدة المحددة حاليًا في DocumentBuilder هذا.
type: docs
weight: 40
...
**العقدة الحالية** هو مؤشر **DocumentBuilder** ويشير إلى أ **العقدة** هذا هو تابع مباشر لملف **فقرة** . أي عمليات إدراج تقوم بإجرائها باستخدام  **DocumentBuilder** سيتم إدراجها قبل **العقدة الحالية**.

عندما تكون الفقرة الحالية فارغة أو يتم وضع المؤشر فقط قبل نهاية الفقرة ، **العقدة الحالية** ترجع فارغة.
