...
description: تحريك المؤشر إلى فقرة في القسم الحالي.
type: docs
weight: 540
...
| characterIndex | Int32 | فهرس الحرف داخل الفقرة ._ x000d_ تسمح لك القيمة السالبة بتحديد موضع من نهاية الفقرة. استخدم -1 للانتقال إلى نهاية الفقرة. |
