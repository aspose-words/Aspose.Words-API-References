...
description: إنهاء جدول في المستند.
type: docs
weight: 230
...
يجب استدعاء هذه الطريقة مرة واحدة فقط بعد ذلك[`EndRow`](../endrow/) كان يسمى. عند الاتصال ،  **EndTable** يحرك المؤشر خارج الخلية الحالية للإشارة بعد الجدول مباشرة.
