...
يمكن إنشاء جدول محتويات في مستند Word بعدة طرق وتنسيقه باستخدام مجموعة متنوعة من الخيارات. يتم التحكم بالطريقة التي تم بها إنشاء الجدول و_ x000d_ بواسطة Microsoft Word بواسطة مفاتيح التبديل الميدانية.
