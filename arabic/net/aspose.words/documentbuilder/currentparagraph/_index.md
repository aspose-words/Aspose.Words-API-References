...
description: يمكنك الوصول بسهولة إلى الفقرة المحددة في DocumentBuilder باستخدام خاصية CurrentParagraph. حسّن عملية تحرير مستنداتك اليوم!
type: docs
weight: 50
...
يحصل على الفقرة المحددة حاليًا في هذه[`DocumentBuilder`](../) .
