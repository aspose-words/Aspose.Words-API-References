...
description: DocumentBuilder طريقة. إدراج حقل Word في مستند وتحديث نتيجة الحقل اختياريًا.
type: docs
weight: 300
...
لإنشاء حقل ، تحتاج إلى تحديد نوع الحقل ورمز الحقل وقيمة الحقل "عنصر نائب" . إذا لم تكن متأكدًا من بناء جملة رمز حقل معين ، فأنشئ الحقل في Microsoft Word first وقم بالتبديل لرؤية رمز الحقل الخاص به .
