...
description: إدراج مستند في موضع المؤشر .
type: docs
weight: 290
...
تحاكي هذه الطريقة سلوك MS Word ، كما لو تم الضغط على CTRL + 'A' (حدد كل المحتوى) ، ثم CTRL + 'C' (تم تحديد النسخ في المخزن المؤقت) داخل مستند واحد_ x000d_ ثم CTRL + 'V' (أدخل محتوى من المخزن المؤقت) داخل مستند آخر.
