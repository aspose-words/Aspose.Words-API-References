...
description: ينقل المؤشر إلى إشارة مرجعية .
type: docs
weight: 470
...
لاحظ أن بعض الإشارات المرجعية في المستند مخصصة لحقول النموذج. على الرغم من أن هذا لن يبطل حقل النموذج ، لن يكون النص المدرج x000d_ مرئيًا لأنه يصبح جزءًا من رمز الحقل.
...
ينقل المؤشر إلى إشارة مرجعية بدقة أكبر ._ x000d_
...
| --- | --- | --- |
| bookmarkName | String | اسم الإشارة المرجعية المراد نقل المؤشر إليها. |
| isStart | Boolean | عندما يكون صحيحًا ، ينقل المؤشر إلى بداية الإشارة المرجعية ._ x000d_ عندما يكون خطأً ، ينقل المؤشر إلى نهاية الإشارة المرجعية. |
