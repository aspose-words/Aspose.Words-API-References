...
description: اكتشف طريقة ConditionalStyleCollection GetEnumerator للتنقل بسهولة عبر كافة الأنماط الشرطية، مما يعزز كفاءة تصميم الويب الخاص بك.
type: docs
weight: 160
...
يعيد كائن عداد يمكن استخدامه للتكرار على جميع الأنماط الشرطية في المجموعة.
