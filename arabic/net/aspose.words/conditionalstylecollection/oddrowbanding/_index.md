...
description: اكتشف خاصية ConditionalStyleCollection OddRowBanding لتحسين تصميم الجدول الخاص بك باستخدام أشرطة الصفوف الفردية الأنيقة لتحسين إمكانية القراءة.
type: docs
weight: 120
