...
description: ConditionalStyleCollection ملكية. يسترجع أConditionalStyle الكائن حسب نوع النمط الشرطي.
type: docs
weight: 80
...
يسترجع أ[`ConditionalStyle`](../../conditionalstyle/) الكائن حسب نوع النمط الشرطي.
...
يسترجع أ[`ConditionalStyle`](../../conditionalstyle/) كائن بالفهرس .
...
| معامل | وصف |
| --- | --- |
| index | فهرس على أساس الصفر للنمط الشرطي المراد استرداده. |
