...
description: EditableRange ملكية. إرجاع أو تعيين الاسم المستعار أو مجموعة التحرير التي يجب استخدامها لتحديد ما إذا كان المستخدم الحالي مسموحًا به لتحرير هذا النطاق القابل للتحرير.
type: docs
weight: 30
