...
description: قم بإدارة معرفات التعليقات بسهولة باستخدام خاصية معرف التعليق - مما يبسط تنظيم بياناتك ويعزز تفاعل المستخدم.
type: docs
weight: 70
...
يحصل على معرف التعليق أو يعينه.
...
يسمح معرف التعليق بربط التعليق بمنطقة نصية في المستند. يجب تحديد المنطقة باستخدام[`CommentRangeStart`](../../commentrangestart/) و[`CommentRangeEnd`](../../commentrangeend/) كائن يشترك في نفس قيمة المعرف مثل[`Comment`](../) هدف.
...
من المفترض أن تكون معرفات التعليقات فريدة عبر المستند، ويحافظ Aspose.Words تلقائيًا على معرفات التعليقات عند تحميل المستندات وحفظها ودمجها.
