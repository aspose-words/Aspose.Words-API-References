...
description: اكتشف خاصية Comment DateTime، التي تلتقط التاريخ والوقت الدقيقين لنشر التعليق، مما يعزز تجربة إدارة المحتوى لديك.
type: docs
weight: 40
...
يحصل على التاريخ والوقت الذي تم فيه تقديم التعليق.
