...
description: اكتشف طريقة قبول التعليقات لتعزيز تفاعل الزوار وخلق تفاعلات قيّمة على موقعك. عزّز مجتمعك الإلكتروني اليوم!
type: docs
weight: 130
...
مكالمات [`VisitCommentStart`](../../documentvisitor/visitcommentstart/) ، ثم يدعو[`Accept`](../../node/accept/)لجميع العقد الفرعية x000d_ للتعليق والمكالمات[`VisitCommentEnd`](../../documentvisitor/visitcommentend/) في النهاية.
