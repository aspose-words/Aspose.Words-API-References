...
description: Comment البناء. يقوم بتهيئة مثيل جديد لملف تعليق فئة .
type: docs
weight: 10
...
متي **تعليق** تم إنشاؤه ، فهو ينتمي إلى المستند المحدد ، ولكنه ليس بعد جزءًا من المستند و **عقدة الأم** باطل.

لإلحاق **تعليق** في المستند ، استخدم InsertAfter أو InsertBefore في الفقرة التي تريد إدراج التعليق فيها.

بعد إنشاء تعليق ، لا تنس تعيينه[`Author`](../author/) ، [`Initial`](../initial/) و[`DateTime`](../datetime/) الخصائص.
...
| --- | --- | --- |
| doc | DocumentBase | وثيقة المالك. |
| author | String | اسم المؤلف للتعليق. لا يمكن أن تكون لاغية. |
| initial | String | المؤلف بالأحرف الأولى للتعليق. لا يمكن أن تكون لاغية. |
