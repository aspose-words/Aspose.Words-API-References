...
description: Aspose.Words.ParagraphFormat فصل. يمثل كل تنسيقات الفقرة.
type: docs
weight: 4180
...
| [KeepTogether](../../aspose.words/paragraphformat/keeptogether/) { get; set; } | صحيح إذا كانت كل سطور الفقرة ستبقى في نفس الصفحة. |
| [KeepWithNext](../../aspose.words/paragraphformat/keepwithnext/) { get; set; } | صحيح إذا كانت الفقرة ستبقى على نفس الصفحة مثل الفقرة التي تليها. |
| [LeftIndent](../../aspose.words/paragraphformat/leftindent/) { get; set; } | الحصول على أو تحديد القيمة (بالنقاط) التي تمثل المسافة البادئة اليسرى للفقرة. |
| [LineSpacing](../../aspose.words/paragraphformat/linespacing/) { get; set; } | الحصول على تباعد الأسطر (بالنقاط) للفقرة أو تحديده. |
| [LineSpacingRule](../../aspose.words/paragraphformat/linespacingrule/) { get; set; } | الحصول على أو تحديد تباعد الأسطر للفقرة. |
...
| [SpaceAfterAuto](../../aspose.words/paragraphformat/spaceafterauto/) { get; set; } | صحيح إذا تم تعيين مقدار التباعد بعد الفقرة تلقائيًا. |
| [SpaceBefore](../../aspose.words/paragraphformat/spacebefore/) { get; set; } | الحصول على أو تحديد مقدار التباعد (بالنقاط) قبل الفقرة. |
| [SpaceBeforeAuto](../../aspose.words/paragraphformat/spacebeforeauto/) { get; set; } | True إذا تم تعيين مقدار التباعد قبل الفقرة تلقائيًا. |
| [Style](../../aspose.words/paragraphformat/style/) { get; set; } | الحصول على أو تحديد نمط الفقرة المطبق على هذا التنسيق. |
| [StyleIdentifier](../../aspose.words/paragraphformat/styleidentifier/) { get; set; } | الحصول على أو تعيين معرف النمط المستقل للإعدادات المحلية لنمط الفقرة المطبق على هذا التنسيق. |
| [StyleName](../../aspose.words/paragraphformat/stylename/) { get; set; } | الحصول على أو تحديد اسم نمط الفقرة المطبق على هذا التنسيق. |
...
| اسم | وصف |
| --- | --- |
| [ClearFormatting](../../aspose.words/paragraphformat/clearformatting/)() | إعادة التعيين إلى التنسيق الافتراضي للفقرة. |
