...
description: اكتشف خاصية ParagraphFormat SpaceBeforeAuto. اضبط مسافات الفقرات تلقائيًا لإضفاء مظهر أنيق واحترافي على مستنداتك.
type: docs
weight: 340
...
عند ضبطه على`حقيقي` ، يتجاوز تأثير[`SpaceBefore`](../spacebefore/).
