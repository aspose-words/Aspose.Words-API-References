...
description: ParagraphFormat ملكية. يحدد ما إذا كان يجب استثناء سطور الفقرة الحالية من رقم السطر الذي يتم تطبيقه في القسم الأصل.
type: docs
weight: 370
...
يحدد ما إذا كان يجب استثناء سطور الفقرة الحالية من رقم السطر الذي يتم تطبيقه في القسم الأصل.
