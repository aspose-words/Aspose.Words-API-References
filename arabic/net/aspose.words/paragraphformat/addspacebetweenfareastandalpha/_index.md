...
description: الحصول على علامة أو تعيينها تشير إلى ما إذا كان يتم ضبط التباعد بين الأحرف تلقائيًا بين مناطق من النص اللاتيني ومناطق نص شرق آسيا في الفقرة الحالية.
type: docs
weight: 10
