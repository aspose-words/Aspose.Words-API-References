...
description: اكتشف خاصية ParagraphFormat SpaceBefore لتعديل المسافة بين الفقرات بسهولة بالنقاط، مما يعزز قابلية قراءة المستند وأسلوبه.
type: docs
weight: 330
...
يحصل على مقدار المسافة (بالنقاط) قبل الفقرة أو يعينه.
...
ليس له تأثير عندما[`SpaceBeforeAuto`](../spacebeforeauto/) يكون`حقيقي`.
