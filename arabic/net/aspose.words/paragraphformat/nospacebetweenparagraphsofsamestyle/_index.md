...
description: عندما يكون صحيحًا SpaceBeforeaspose.words/paragraphformat/spacebefore وSpaceAfteraspose.words/paragraphformat/spaceafter سيتم تجاهله_ x000d_ بين فقرات نفس النمط.
type: docs
weight: 230
...
عندما يكون صحيحًا ،[`SpaceBefore`](../spacebefore) و[`SpaceAfter`](../spaceafter) سيتم تجاهله_ x000d_ بين فقرات نفس النمط.
