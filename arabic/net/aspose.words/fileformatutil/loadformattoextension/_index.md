...
description: FileFormatUtil طريقة. تحويل قيمة تعداد تنسيق تحميل إلى امتداد ملف. الامتداد الذي تم إرجاعه عبارة عن سلسلة أحرف صغيرة بنقطة بادئة.
type: docs
weight: 60
...
تحويل قيمة تعداد تنسيق تحميل إلى امتداد ملف. الامتداد الذي تم إرجاعه عبارة عن سلسلة أحرف صغيرة بنقطة بادئة.
