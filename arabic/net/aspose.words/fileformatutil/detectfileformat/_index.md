...
description: يكتشف ويعيد المعلومات المتعلقة بتنسيق مستند مخزن في ملف قرص.
type: docs
weight: 30
...
حتى إذا اكتشفت هذه الطريقة تنسيق المستند ، فإنها لا تضمن أن المستند المحدد صالح. تكتشف هذه الطريقة تنسيق المستند فقط عن طريق قراءة البيانات الكافية للكشف عن _x000d. للتحقق الكامل من صلاحية المستند ، يلزمك تحميل المستند في ملف[`Document`](../../document) هدف.
