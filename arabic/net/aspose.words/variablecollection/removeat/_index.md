...
description: قم بإدارة مستنداتك بسهولة باستخدام طريقة RemoveAt في VariableCollection، والتي تقوم بإزالة متغير عند أي فهرس محدد للتعامل مع البيانات بسلاسة.
type: docs
weight: 90
...
يزيل متغير المستند عند الفهرس المحدد.
