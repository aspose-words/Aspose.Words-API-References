...
description: VariableCollection طريقة. يضيف متغير مستند إلى المجموعة.
type: docs
weight: 30
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| name | String | اسم المتغير المراد إضافته غير حساس لحالة الأحرف. |
| value | String | قيمة المتغير. لا يمكن أن تكون القيمة خالية ، إذا كانت القيمة خالية ، فسيتم استخدام سلسلة فارغة بدلاً من ذلك. |
