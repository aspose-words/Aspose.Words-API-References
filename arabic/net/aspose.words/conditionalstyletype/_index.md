...
| OddRowBanding | `4` | يحدد تنسيق شريط الصفوف المرقمة بأرقام فردية ._ x000d_ |
| OddColumnBanding | `5` | يحدد تنسيق شريط الأعمدة المرقّم بأرقام فردية ._ x000d_ |
| EvenRowBanding | `6` | تحديد تنسيق شريط الصفوف ذات الأرقام الزوجية ._ x000d_ |
| EvenColumnBanding | `7` | تحديد تنسيق شريط الأعمدة ذات الأرقام الزوجية. |
| TopLeftCell | `8` | تحديد تنسيق الخلية اليسرى العلوية للجدول. |
| TopRightCell | `9` | تحديد تنسيق الخلية اليمنى العلوية للجدول ._ x000d_ |
