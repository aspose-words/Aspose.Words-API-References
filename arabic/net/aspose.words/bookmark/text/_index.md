...
description: أدر إشاراتك المرجعية بكل سهولة! حدّد النص داخل إشاراتك المرجعية أو حدّده لتنظيمها بسهولة وسرعة الوصول إلى الملاحظات المهمة.
type: docs
weight: 70
...
يحصل على النص الموجود في الإشارة المرجعية أو يعينه.
