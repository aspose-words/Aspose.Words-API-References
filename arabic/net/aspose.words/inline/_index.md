...
description: Aspose.Words.Inline فصل. الفئة الأساسية للعقد ذات المستوى المضمن التي يمكن أن يكون لها تنسيق أحرف مقترن بها  ولكن لا يمكن أن يكون لها عقد فرعية خاصة بها .
type: docs
weight: 3060
