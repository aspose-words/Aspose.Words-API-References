...
description: Aspose.Words.Inline فصل. الفئة الأساسية للعقد ذات المستوى المضمّن التي يمكن أن يكون لها تنسيق أحرف مرتبط بها ولكن لا يمكن أن تحتوي على عقد فرعية خاصة بها في C#.
type: docs
weight: 3260
