...
description: اكتشف خاصية Inline IsMoveFromRevision في مايكروسوفت وورد. تعرّف على كيفية تتبعها للعناصر المحذوفة لإدارة المستندات وتحريرها بكفاءة.
type: docs
weight: 50
url: /ar/net/aspose.words/inline/ismovefromrevision/
---
