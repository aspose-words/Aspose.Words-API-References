...
description: قم بإدارة إشاراتك المرجعية بسهولة باستخدام طريقة RemoveAt - احذف أي إشارة مرجعية بسرعة من خلال فهرسها للحصول على مجموعة مبسطة!
type: docs
weight: 60
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| index | Int32 | الفهرس المبني على الصفر للإشارة المرجعية التي يجب إزالتها. |
