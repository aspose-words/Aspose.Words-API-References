...
description: اكتشف فئة Aspose.Words.EditableRangeEnd، المصممة لإدارة النطاقات القابلة للتحرير في مستندات Word بكفاءة لتحرير المستندات بسلاسة.
type: docs
weight: 1840
...
| [EditableRangeStart](../../aspose.words/editablerangeend/editablerangestart/) { get; } | المقابلة[`EditableRangeStart`](../editablerangestart/) ، تم استلامها بواسطة ID. |
...
| override [NodeType](../../aspose.words/editablerangeend/nodetype/) { get; } | إرجاعEditableRangeEnd . |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.words/editablerangeend/accept/)(*[DocumentVisitor](../documentvisitor/)*) | يقبل زائرًا. |
...
يتكون النطاق الكامل القابل للتحرير في مستند Word من[`EditableRangeStart`](./editablerangestart/) ومطابقة`EditableRangeEnd` مع نفس المعرف.

[`EditableRangeStart`](./editablerangestart/) و`EditableRangeEnd` هي مجرد علامات داخل document تحدد مكان بدء وانتهاء النطاق القابل للتحرير.
