...
يمثل نهاية النطاق القابل للتحرير في مستند Word.
...
| [EditableRangeStart](../../aspose.words/editablerangeend/editablerangestart/) { get; } | المقابلة[`EditableRangeStart`](../editablerangestart/) ، تم الاستلام بواسطة ID. |
...
[`EditableRangeStart`](./editablerangestart/) و`EditableRangeEnd` هي مجرد علامات داخل document تحدد أين يبدأ وينتهي النطاق القابل للتحرير.
