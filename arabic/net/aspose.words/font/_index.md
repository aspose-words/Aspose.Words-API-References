...
description: Aspose.Words.Font فصل. يحتوي على سمات الخط اسم الخط وحجم الخط واللون وما إلى ذلك لكائن.
type: docs
weight: 2650
...
يحتوي على سمات الخط (اسم الخط وحجم الخط واللون وما إلى ذلك) لكائن.
...
| [Fill](../../aspose.words/font/fill/) { get; } | يحصل على تنسيق التعبئة للخط. |
...
| [Size](../../aspose.words/font/size/) { get; set; } | الحصول على أو تحديد حجم الخط بالنقاط. |
| [SizeBi](../../aspose.words/font/sizebi/) { get; set; } | الحصول على أو تحديد حجم الخط بالنقاط المستخدمة في مستند من اليمين إلى اليسار. |
...
| [Subscript](../../aspose.words/font/subscript/) { get; set; } | True إذا تم تنسيق الخط على أنه منخفض. |
| [Superscript](../../aspose.words/font/superscript/) { get; set; } | True إذا كان تنسيق الخط مرتفعًا. |
| [TextEffect](../../aspose.words/font/texteffect/) { get; set; } | الحصول على أو تعيين تأثير حركة الخط. |
...
| [Underline](../../aspose.words/font/underline/) { get; set; } | الحصول على أو تحديد نوع التسطير المطبق على الخط. |
| [UnderlineColor](../../aspose.words/font/underlinecolor/) { get; set; } | الحصول على أو تحديد لون التسطير المطبق على الخط. |
...
| [HasDmlEffect](../../aspose.words/font/hasdmleffect/)(TextDmlEffect) | للتحقق من تطبيق تأثير نص DrawingML معين. |
