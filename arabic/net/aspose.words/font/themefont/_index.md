...
description: اكتشف كيفية إدارة خطوط السمات بسهولة باستخدام خاصية Font ThemeFont. حسّن تصميمك بأنماط خطوط قابلة للتخصيص لمظهر أنيق!
type: docs
weight: 480
...
يحصل على خط السمة أو يعينه في مخطط الخطوط المطبق المرتبط بهذا[`Font`](../) الكائن.
