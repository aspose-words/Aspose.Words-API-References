...
description: Font ملكية. True إذا تم تنسيق الخط كنص مخفي.
type: docs
weight: 140
...
True إذا تم تنسيق الخط كنص مخفي.
...
يوضح كيفية إنشاء سلسلة من النص المخفي.

```csharp
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);

// مع ضبط العلامة المخفية على صحيح ، فإن أي نص نقوم بإنشائه باستخدام كائن الخط هذا سيكون غير مرئي في المستند.
// لن نرى أو نبرز النص المخفي إلا إذا قمنا بتمكين خيار "النص المخفي"
// وجدت في Microsoft Word عبر "ملف" - >. "خيارات" - >. "عرض". سيظل النص موجودًا ،
// وسنتمكن من الوصول إلى هذا النص برمجيًا.
// لا ينصح باستخدام هذه الطريقة لإخفاء المعلومات الحساسة.
