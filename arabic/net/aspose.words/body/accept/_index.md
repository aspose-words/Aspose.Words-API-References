...
description: Body طريقة. يقبل الزائر .
type: docs
weight: 40
...
Calls DocumentVisitor.VisitBodyStart ، ثم استدعاء Accept لجميع العقد الفرعية من section واستدعاء DocumentVisitor.VisitBodyEnd في النهاية.
