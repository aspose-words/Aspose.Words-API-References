...
description: قم بتعزيز تجربة الويب الخاصة بك باستخدام طريقة Body AcceptEnd، المصممة لقبول الزوار بسلاسة في نهاية المستند لتحسين التنقل.
type: docs
weight: 50
url: /ar/net/aspose.words/body/acceptend/
---
## Body.AcceptEnd method

يقبل الزائر لزيارة نهاية نص المستند.
