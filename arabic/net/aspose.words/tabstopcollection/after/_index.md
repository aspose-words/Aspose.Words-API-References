...
description: اكتشف طريقة TabStopCollection After لاسترداد علامة التبويب الأولى الموجودة على يمين الموضع المحدد بكفاءة لضمان التنقل السلس.
type: docs
weight: 40
...
يحصل على علامة تبويب أولى على يمين الموضع المحدد.
