...
description: TabStopCollection طريقة. الحصول على علامة الجدولة الأولى على يسار الموضع المحدد.
type: docs
weight: 50
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| position | Double | الموقف المرجعي (بالنقاط). |

### قيمة الإرجاع

كائن توقف جدولة أو فارغ إذا لم يتم العثور على علامة جدولة مناسبة.

### ملاحظات

تخطي توقف علامة التبويب مع **محاذاة** ضبط ل`TabAlignment.Bar`.
