...
description: اكتشف طريقة TabStopCollection Equals لمقارنة TabStopCollections بسهولة من أجل المساواة، مما يعزز كفاءة ودقة الترميز لديك.
type: docs
weight: 70
...
يحدد ما إذا كان المحدد[`TabStopCollection`](../) يساوي القيمة الحالية[`TabStopCollection`](../) .
