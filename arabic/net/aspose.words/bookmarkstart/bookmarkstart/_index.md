...
description: اكتشف مُنشئ BookmarkStart! هيئ بسهولة نماذج BookmarkStart جديدة لإضافة إشارات مرجعية فعّالة إلى تطبيقاتك. حسّن إنتاجيتك اليوم!
type: docs
weight: 10
...
يقوم بتهيئة مثيل جديد لـ[`BookmarkStart`](../) الصف.
