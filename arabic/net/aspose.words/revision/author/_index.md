...
description: Revision ملكية. الحصول على أو تعيين كاتب هذه المراجعة. لا يمكن أن تكون سلسلة فارغة أو خالية.
type: docs
weight: 10
...
الحصول على أو تعيين كاتب هذه المراجعة. لا يمكن أن تكون سلسلة فارغة أو خالية.
