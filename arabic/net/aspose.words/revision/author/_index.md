...
description: أدر مؤلف المراجعة بسهولة. حدّد أو حدّث بيانات المؤلف لكل مراجعة بسهولة، مما يضمن الوضوح والمسؤولية في مستنداتك.
type: docs
weight: 10
...
يحصل على مؤلف هذه المراجعة أو يعيّنه. لا يمكن أن يكون سلسلة فارغة أو`باطل` .
