...
description: اكتشف خاصية Revision ParentNode، التي تُحدد العقدة الأصلية المباشرة لأي نوع مراجعة، باستثناء StyleDefinitionChange. حسّن كفاءة ترميزك!
type: docs
weight: 40
...
يحصل على العقدة الأصلية المباشرة (المالك) لهذه المراجعة. ستعمل هذه الخاصية مع أي نوع مراجعة آخر غيرStyleDefinitionChange .
...
إذا كان هذا التعديل يتعلق بتغيير تنسيق النمط، استخدم[`ParentStyle`](../parentstyle/) بدلا من ذلك.
