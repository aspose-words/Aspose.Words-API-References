...
description: الحصول على العقدة الأصلية المباشرة المالك لهذه المراجعة . ستعمل هذه الخاصية مع أي نوع مراجعة بخلافStyleDefinitionChange .
type: docs
weight: 40
...
إذا كانت هذه المراجعة تتعلق بتغيير تنسيق النمط ، فاستخدم[`ParentStyle`](../parentstyle) بدلاً من ذلك ._ x000d_
