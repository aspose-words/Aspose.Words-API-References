...
description: Revision ملكية. يحصل على مجموعة المراجعة. إرجاع القيمة فارغة إذا كانت المراجعة لا تنتمي إلى أي مجموعة.
type: docs
weight: 30
...
يحصل على مجموعة المراجعة. إرجاع القيمة فارغة إذا كانت المراجعة لا تنتمي إلى أي مجموعة.
...
لا تحتوي المراجعة على مجموعة إذا كان نوع المراجعة هو RevisionType.StyleDefinitionChange أو إذا لم تعد المراجعة موجودة في سياق المستند (مقبول / مرفوض).
