...
description: يحدد وضع التخطيط لقسم يسمح بتعريف سلوك شبكة الوثيقة.
type: docs
weight: 5460
...
| Grid | `1` | يحدد أن القسم المقابل يجب أن يحتوي على كل من خطوة الخط الإضافية والحرف_ملاحظة مضافًا إلى كل سطر وحرف بداخله من أجل الحفاظ على عدد معين_ x000d_ من الأسطر في الصفحة والأحرف في كل سطر. _ x000d_ لن يتم محاذاة الأحرف تلقائيًا مع خطوط الشبكة على كتابة ._ x000d_ |
...
| SnapToChars | `3` | يحدد أن القسم المقابل يجب أن يحتوي على كل من خطوة السطر الإضافية والحرف Pitch مضافًا إلى كل سطر وحرف بداخله من أجل الحفاظ على عدد معين_ x000d_ من الأسطر في الصفحة والأحرف في كل سطر. ستتم محاذاة الأحرف تلقائيًا مع خطوط الشبكة عند الكتابة. |
