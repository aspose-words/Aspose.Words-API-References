...
description: يمثل مجموعة من العقد من نوع معين.
type: docs
weight: 3960
...
**NodeCollection** لا تمتلك العقد التي تحتوي عليها ، بل هي مجرد مجموعة مختارة من العقد_ x000d_ من النوع المحدد ، ولكن يتم تخزين العقد في الشجرة تحت العقد الأصلية الخاصة بها.
...
**NodeCollection** يمكن أن تكون "مسطحة" وتحتوي فقط على توابع مباشرة للعقدة التي تم إنشاؤها_ x000d_ منها ، أو يمكن أن تكون "عميقة" وتحتوي على جميع التوابع التابعة.
