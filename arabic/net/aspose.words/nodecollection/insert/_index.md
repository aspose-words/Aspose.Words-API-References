...
| معامل | يكتب | وصف |
| --- | --- | --- |
| index | Int32 | الفهرس الصفري للعقدة. الفهارس السالبة مسموح بها وتشير إلى الوصول من الجزء الخلفي من القائمة ._ x000d_ على سبيل المثال -1 تعني العقدة الأخيرة ، -2 تعني الثانية قبل الأخيرة وهكذا. |
