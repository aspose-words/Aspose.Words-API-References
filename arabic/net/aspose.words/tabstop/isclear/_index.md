...
description: اكتشف كيف تعمل خاصية TabStop IsClear على تعزيز واجهة المستخدم الخاصة بك من خلال ضمان إدارة سلسة لعلامات التبويب، ومسح التوقفات الموجودة للحصول على تجربة مستخدم أكثر سلاسة.
type: docs
weight: 30
...
إرجاع`حقيقي` إذا كانت علامة التبويب هذه تمسح أي علامات تبويب موجودة في هذا الموضع.
