...
description: مجموعة من الجزء كائنات في المستند ._ x000d_
type: docs
weight: 5450
...
مجموعة من **الجزء** كائنات في المستند ._ x000d_
...
يمكن استخدام إدراج الأقسام وإزالتها برمجيًا لتخصيص المستندات المنتجة_ x000d_ أثناء دمج البريد. إذا كان المستند يحتاج إلى محتوى أو أجزاء مختلفة من محتوى بناءً على بعض المعايير ، فيمكنك إنشاء مستند "رئيسي" يحتوي على أقسام متعددة_x000d وحذف بعض الأقسام قبل دمج البريد أو بعده.
