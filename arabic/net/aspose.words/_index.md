...
| [Bookmark](./bookmark) | يمثل إشارة مرجعية واحدة ._ x000d_ |
...
| [BorderCollection](./bordercollection) | مجموعة من الكائنات الحدودية ._ x000d_ |
...
| [CommentCollection](./commentcollection) | يوفر وصولاً مكتوبًا إلى مجموعة من[`Comment`](../aspose.words/comment) العقد ._ x000d_ |
...
| [ConditionalStyleCollection](./conditionalstylecollection) | يمثل مجموعة من[`ConditionalStyle`](../aspose.words/conditionalstyle) الكائنات ._ x000d_ |
...
| [EditableRange](./editablerange) | يمثل نطاقًا واحدًا قابلاً للتحرير ._ x000d_ |
| [EditableRangeEnd](./editablerangeend) | يمثل نهاية نطاق قابل للتحرير في مستند Word. |
...
| [NodeChangingArgs](./nodechangingargs) | توفير بيانات لأساليب ملف[`INodeChangingCallback`](../aspose.words/inodechangingcallback) الواجهة ._ x000d_ |
...
| [NodeList](./nodelist) | يمثل مجموعة من العقد المطابقة لاستعلام XPath المنفذ باستخدام امتداد[`SelectNodes`](../aspose.words/compositenode/selectnodes) طريقة ._ x000d_ |
| [PageSetup](./pagesetup) | يمثل خصائص إعداد الصفحة لأحد الأقسام. |
| [Paragraph](./paragraph) | يمثل فقرة من النص . |
| [ParagraphCollection](./paragraphcollection) | يوفر وصولاً مكتوبًا إلى مجموعة من[`Paragraph`](../aspose.words/paragraph) العقد ._ x000d_ |
...
| [RevisionGroup](./revisiongroup) | يمثل مجموعة متسلسلة[`Revision`](../aspose.words/revision) الكائنات ._ x000d_ |
...
| [RunCollection](./runcollection) | يوفر وصولاً مكتوبًا إلى مجموعة من[`Run`](../aspose.words/run) العقد ._ x000d_ |
| [Section](./section) | يمثل قسمًا واحدًا في مستند. |
| [SectionCollection](./sectioncollection) | مجموعة من **الجزء** كائنات في المستند ._ x000d_ |
| [Shading](./shading) | يحتوي على سمات تظليل لكائن . |
...
| [SubDocument](./subdocument) | يمثل أ **مستند ثانوي** - وهي إشارة إلى مستند مخزن خارجيًا ._ x000d_ |
| [TableStyle](./tablestyle) | يمثل نمط الجدول ._ x000d_ |
...
| [WarningInfoCollection](./warninginfocollection) | يمثل مجموعة مكتوبة من[`WarningInfo`](../aspose.words/warninginfo) الكائنات ._ x000d_ |
...
| [IWarningCallback](./iwarningcallback) | قم بتنفيذ هذه الواجهة إذا كنت تريد أن يكون لديك أسلوب مخصص خاص بك يسمى التقاط تحذيرات فقدان الدقة التي يمكن أن تحدث أثناء تحميل المستند أو حفظه ._ x000d_ |
## تعداد

| تعداد | وصف |
| --- | --- |
| [BorderType](./bordertype) | تحديد جوانب الحد ._ x000d_ |
| [BreakType](./breaktype) | يحدد نوع الفاصل داخل المستند. |
| [CalendarType](./calendartype) | يحدد نوع التقويم ._ x000d_ |
...
| [EmphasisMark](./emphasismark) | تحديد الأنواع الممكنة لعلامة التوكيد ._ x000d_ |
...
| [HtmlInsertOptions](./htmlinsertoptions) | تحديد خيارات لـ[`InsertHtml`](../aspose.words/documentbuilder/inserthtml) طريقة ._ x000d_ |
...
| [LineSpacingRule](./linespacingrule) | تحديد قيم تباعد الأسطر للفقرة ._ x000d_ |
...
| [MeasurementUnits](./measurementunits) | يحدد وحدة القياس ._ x000d_ |
...
| [Orientation](./orientation) | يحدد اتجاه الصفحة ._ x000d_ |
...
| [ParagraphAlignment](./paragraphalignment) | يحدد محاذاة النص في فقرة ._ x000d_ |
| [ProtectionType](./protectiontype) | نوع الحماية للمستند ._ x000d_ |
...
| [StyleIdentifier](./styleidentifier) | معرّف نمط مستقل للإعدادات المحلية ._ x000d_ |
...
| [TextEffect](./texteffect) | تأثير الحركة لتشغيل النص. x000d_ |
| [TextOrientation](./textorientation) | يحدد اتجاه النص على الصفحة ، في خلية جدول أو إطار نص. |
| [TextureIndex](./textureindex) | يحدد نسيج التظليل ._ x000d_ |
