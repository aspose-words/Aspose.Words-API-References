...
description: INodeChangingCallback طريقة. يتم استدعائها عند إزالة عقدة تنتمي إلى هذا المستند من أصلها .
type: docs
weight: 30
...
يتم استدعائها عند إزالة عقدة تنتمي إلى هذا المستند من أصلها .
