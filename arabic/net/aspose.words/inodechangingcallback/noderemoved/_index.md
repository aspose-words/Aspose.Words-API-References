...
description: INodeChangingCallback NodeRemoved طريقة. يتم استدعاؤه عند إزالة العقدة التي تنتمي إلى هذا المستند من الأصل في C#.
type: docs
weight: 30
...
يتم استدعاؤه عند إزالة العقدة التي تنتمي إلى هذا المستند من الأصل.
