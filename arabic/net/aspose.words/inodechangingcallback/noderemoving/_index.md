...
description: اكتشف طريقة INodeChangingCallback NodeRemoving، التي يتم تشغيلها قبل إزالة عقدة المستند، مما يضمن إدارة سلسة للمستندات.
type: docs
weight: 40
...
يتم استدعاؤها قبل إزالة العقدة التي تنتمي إلى هذا المستند من المستند.
