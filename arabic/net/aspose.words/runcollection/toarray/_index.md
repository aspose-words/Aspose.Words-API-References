...
description: قم بتحويل RunCollection إلى مصفوفة بسهولة باستخدام طريقة ToArray، مما يضمن إدارة سلسة للبيانات وتحسين الأداء.
type: docs
weight: 20
...
نسخ جميع عمليات التشغيل من المجموعة إلى مجموعة جديدة من عمليات التشغيل.
