...
description: RunCollection طريقة. يتم تشغيل جميع النسخ من المجموعة إلى مجموعة جديدة من عمليات التشغيل.
type: docs
weight: 20
...
يتم تشغيل جميع النسخ من المجموعة إلى مجموعة جديدة من عمليات التشغيل.
