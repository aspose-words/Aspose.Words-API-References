...
description: حقيقي إذا تمت طباعة التعليقات الختامية في نهاية القسم التالي الذي لا يمنع التعليقات الختامية . تتم طباعة التعليقات الختامية قبل التعليقات الختامية في هذا القسم.
type: docs
weight: 400
