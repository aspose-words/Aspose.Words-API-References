...
description: PageSetup ملكية. الحصول على أو تحديد مقدار المساحة الإضافية المضافة إلى الهامش لربط المستندات.
type: docs
weight: 160
...
الحصول على أو تحديد مقدار المساحة الإضافية المضافة إلى الهامش لربط المستندات.
