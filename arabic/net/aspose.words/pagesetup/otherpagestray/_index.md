...
description: PageSetup ملكية. الحصول على أو تعيين علبة الورق حاوية لاستخدامها للجميع ما عدا الصفحة الأولى من القسم . القيمة خاصة بالتنفيذ الطابعة .
type: docs
weight: 290
...
الحصول على أو تعيين علبة الورق (حاوية) لاستخدامها للجميع ما عدا الصفحة الأولى من القسم . القيمة خاصة بالتنفيذ (الطابعة) .
