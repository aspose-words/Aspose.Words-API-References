...
description: اكتشف خاصية Range FormFields، وقم بالوصول إلى مجموعة FormFields الكاملة لإدارة جميع حقول النموذج ضمن النطاق المحدد بكفاءة.
type: docs
weight: 30
...
يعيد`FormFields` مجموعة تمثل جميع حقول النموذج في النطاق.
