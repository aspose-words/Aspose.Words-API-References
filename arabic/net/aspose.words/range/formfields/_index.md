...
description: إرجاع أFormFieldsaspose.words/range/formfields المجموعة التي تمثل جميع حقول النموذج في النطاق.
type: docs
weight: 30
...
إرجاع أ`FormFields` المجموعة التي تمثل جميع حقول النموذج في النطاق.
