...
لا تقوم هذه الطريقة بتحديث الحقول المرتبطة بخوارزميات تخطيط الصفحة (مثل PAGE و PAGES و PAGEREF) ._ x000d_ يتم تحديث الحقول المتعلقة بتخطيط الصفحة عند عرض مستند أو استدعاء[`UpdatePageLayout`](../../document/updatepagelayout).
