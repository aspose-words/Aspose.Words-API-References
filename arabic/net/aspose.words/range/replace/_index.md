...
لن يتم استخدام النمط كتعبير عادي . الرجاء استخدام[`Replace`](./replace/) إذا كنت بحاجة إلى تعبيرات عادية.
...
طريقة الاستخدام[`Replace`](./replace/) للحصول على تخصيص أكثر مرونة.
