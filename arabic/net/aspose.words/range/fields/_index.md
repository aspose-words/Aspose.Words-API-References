...
description: اكتشف خاصية "حقول النطاق"، واحصل بسهولة على مجموعة شاملة من الحقول لتلبية جميع احتياجاتك من البيانات. حسّن سير عملك اليوم!
type: docs
weight: 20
...
يعيد`Fields` مجموعة تمثل جميع الحقول في النطاق.
