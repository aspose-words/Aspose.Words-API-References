...
description: اكتشف خاصية Range Bookmarks للوصول إلى مجموعة شاملة من الإشارات المرجعية، مما يعزز التنقل في مستنداتك وتنظيمها بسهولة.
type: docs
weight: 10
...
يعيد`Bookmarks` مجموعة تمثل جميع الإشارات المرجعية في النطاق.
