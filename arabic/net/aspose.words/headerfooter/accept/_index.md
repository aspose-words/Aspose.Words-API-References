...
description: اكتشف طريقة قبول HeaderFooter لتعزيز تفاعل الزوار وتبسيط التفاعلات على موقع الويب الخاص بك بسهولة.
type: docs
weight: 70
...
مكالمات [`VisitHeaderFooterStart`](../../documentvisitor/visitheaderfooterstart/) ، ثم يدعو[`Accept`](../../node/accept/) لجميع العقد الفرعية لقسم والمكالمات[`VisitHeaderFooterEnd`](../../documentvisitor/visitheaderfooterend/) في النهاية.
