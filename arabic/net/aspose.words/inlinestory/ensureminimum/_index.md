...
description: قم بتحسين المحتوى الخاص بك باستخدام طريقة EnsureMinimum في InlineStory، والتي تضيف فقرة إذا لم يكن الطفل الأخير هو أحدها، مما يعزز قابلية القراءة والبنية.
type: docs
weight: 120
