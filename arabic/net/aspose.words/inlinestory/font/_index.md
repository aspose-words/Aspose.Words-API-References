...
description: اكتشف خاصية الخط InlineStory لتنسيق الخطوط بسلاسة لأحرف المرساة، مما يعزز تصميمك بخيارات طباعة فريدة.
type: docs
weight: 20
...
يوفر الوصول إلى تنسيق الخط لحرف المرساة لهذا الكائن.
