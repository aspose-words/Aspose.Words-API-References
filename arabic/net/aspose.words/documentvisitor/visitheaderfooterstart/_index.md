...
description: اكتشف طريقة DocumentVisitor VisitHeaderFooterStart، وهي أساسية لتتبع تعداد الرؤوس والتذييلات في الأقسام. حسّن إدارة مستنداتك!
type: docs
weight: 290
...
يتم استدعاؤها عند بدء تعداد الرأس أو التذييل في قسم.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| headerFooter | HeaderFooter | الشيء الذي يتم زيارته. |
