...
description: اكتشف طريقة DocumentVisitor VisitBodyEnd—إدارة تعداد القصة النصية بكفاءة وتعزيز قدرات معالجة المستندات لديك.
type: docs
weight: 20
...
يتم استدعاؤها عند انتهاء تعداد القصة النصية الرئيسية في قسم ما.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| body | Body | الشيء الذي يتم زيارته. |
