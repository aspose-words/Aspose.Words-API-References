...
description: DocumentVisitor طريقة. يتم الاستدعاء عند انتهاء تعداد القصة النصية الرئيسية في أحد الأقسام.
type: docs
weight: 20
...
يتم الاستدعاء عند انتهاء تعداد القصة النصية الرئيسية في أحد الأقسام.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| body | Body | الكائن الذي تتم زيارته. |
