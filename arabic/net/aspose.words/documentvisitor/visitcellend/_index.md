...
description: اكتشف طريقة DocumentVisitor VisitCellEnd، وهي أساسية لإدارة تعداد خلايا الجدول في تطبيقاتك. حسّن كفاءة البرمجة لديك اليوم!
type: docs
weight: 80
...
يتم استدعاؤها عند انتهاء تعداد خلايا الجدول.
