...
description: استكشف طريقة DocumentVisitor VisitCommentEnd، المصممة لتحسين تعداد نص التعليق في مشاريعك لمعالجة المستندات بسلاسة.
type: docs
weight: 100
...
يتم استدعاؤها عند انتهاء تعداد نص التعليق.
