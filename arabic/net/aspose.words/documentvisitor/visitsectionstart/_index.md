...
description: اكتشف طريقة DocumentVisitor VisitSectionStart، وهي أساسية لتتبع تعداد الأقسام. حسّن كفاءة ترميزك باستخدام هذه الأداة الفعّالة!
type: docs
weight: 380
...
يتم استدعاؤها عند بدء تعداد القسم.
