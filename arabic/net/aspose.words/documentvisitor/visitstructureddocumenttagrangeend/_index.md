...
description: اكتشف طريقة DocumentVisitor VisitStructuredDocumentTagRangeEnd، وهي ضرورية للتعامل مع علامات المستندات المنظمة بشكل فعال في تطبيقاتك.
type: docs
weight: 450
...
يتم استدعاؤها عند مواجهة StructuredDocumentTagRangeEnd.
