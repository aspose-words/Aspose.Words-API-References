...
description: اكتشف دالة DocumentVisitor VisitGroupShapeStart، وهي أساسية لتعداد أشكال المجموعات بكفاءة في تطبيقاتك. حسّن سير عملك البرمجي اليوم!
type: docs
weight: 270
...
يتم استدعاؤها عند بدء تعداد شكل المجموعة.
