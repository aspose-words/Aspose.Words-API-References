...
description: عند استدعائهاSpecialCharaspose.words/specialchar تم مصادفة العقدة في المستند.
type: docs
weight: 430
...
عند استدعائها[`SpecialChar`](../../specialchar) تم مصادفة العقدة في المستند.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| specialChar | SpecialChar | الكائن الذي تتم زيارته. |
