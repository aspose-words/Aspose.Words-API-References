...
description: استكشف طريقة VisitSubDocument في DocumentVisitor، المصممة للتعامل بكفاءة مع المستندات الفرعية في تطبيقاتك. حسّن كفاءة ترميزك!
type: docs
weight: 480
...
يتم استدعاؤها عند مواجهة مستند فرعي.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| subDocument | SubDocument | الشيء الذي يتم زيارته. |
