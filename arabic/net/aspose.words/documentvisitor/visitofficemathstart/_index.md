...
description: اكتشف طريقة DocumentVisitor VisitOfficeMathStart، وهي أساسية لبدء تعداد كائنات Office Math. حسّن كفاءة ترميزك اليوم!
type: docs
weight: 310
...
يتم استدعاؤها عند بدء تعداد كائن Office Math.
