...
description: اكتشف دالة DocumentVisitor VisitTableStart، وهي أساسية لإدارة تعداد الجداول بكفاءة في تطبيقاتك. طوّر مهاراتك البرمجية اليوم!
type: docs
weight: 500
...
يتم استدعاؤها عند بدء تعداد الجدول.
