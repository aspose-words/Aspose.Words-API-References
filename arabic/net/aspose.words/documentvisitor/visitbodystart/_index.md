...
description: اكتشف طريقة DocumentVisitor VisitBodyStart، وهي أساسية لترقيم النصوص الرئيسية في أقسامك بكفاءة. حسّن سير عمل الترميز لديك اليوم!
type: docs
weight: 30
url: /ar/net/aspose.words/documentvisitor/visitbodystart/
---
## DocumentVisitor.VisitBodyStart method

يتم استدعاؤها عند بدء تعداد القصة النصية الرئيسية في قسم ما.
