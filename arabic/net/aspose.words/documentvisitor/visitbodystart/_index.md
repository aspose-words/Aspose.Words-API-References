...
description: DocumentVisitor VisitBodyStart طريقة. يتم استدعاؤه عند بدء تعداد القصة النصية الرئيسية في القسم في C#.
type: docs
weight: 30
...
يتم استدعاؤه عند بدء تعداد القصة النصية الرئيسية في القسم.
