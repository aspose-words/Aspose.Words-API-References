...
description: DocumentVisitor طريقة. يتم الاستدعاء عند بدء تعداد القصة النصية الرئيسية في أحد الأقسام.
type: docs
weight: 30
...
يتم الاستدعاء عند بدء تعداد القصة النصية الرئيسية في أحد الأقسام.
