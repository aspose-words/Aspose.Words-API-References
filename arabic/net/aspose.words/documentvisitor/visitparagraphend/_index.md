...
description: اكتشف طريقة DocumentVisitor VisitParagraphEnd—تعامل بكفاءة مع إكمال تعداد الفقرات في تطبيقاتك لتحسين الأداء.
type: docs
weight: 320
...
يتم استدعاؤها عند انتهاء تعداد الفقرة.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| paragraph | Paragraph | الشيء الذي يتم زيارته. |
