...
description: اكتشف طريقة DocumentVisitor VisitStructuredDocumentTagRangeStart، وهي ضرورية للتعامل مع علامات المستندات المنظمة بكفاءة في تطبيقاتك.
type: docs
weight: 460
...
يتم استدعاؤها عند مواجهة StructuredDocumentTagRangeStart.
