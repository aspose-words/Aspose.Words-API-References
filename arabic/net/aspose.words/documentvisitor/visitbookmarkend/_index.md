...
description: DocumentVisitor طريقة. يتم استدعاؤه عند مواجهة نهاية إشارة مرجعية في المستند.
type: docs
weight: 40
...
يتم استدعاؤه عند مواجهة نهاية إشارة مرجعية في المستند.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| bookmarkEnd | BookmarkEnd | الكائن الذي تتم زيارته. |
