...
description: استكشف طريقة VisitGlossaryDocumentEnd في DocumentVisitor. تعرّف على كيفية تحسينها لحصر مستندات المسرد لإدارة البيانات بكفاءة.
type: docs
weight: 240
...
يتم استدعاؤها عند انتهاء تعداد مستند المصطلحات.
