...
description: اكتشف طريقة DocumentVisitor VisitFormField، التي تُفعّل عند اكتشاف حقل نموذج في مستندك. حسّن معالجة مستنداتك اليوم!
type: docs
weight: 230
...
يتم استدعاؤها عند مواجهة حقل نموذج في المستند.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| formField | FormField | الشيء الذي يتم زيارته. |
