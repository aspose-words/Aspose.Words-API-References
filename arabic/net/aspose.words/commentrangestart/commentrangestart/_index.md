...
متي[`CommentRangeStart`](../../commentrangestart) تم إنشاؤه ، فهو ينتمي إلى المستند المحدد ، ولكنه ليس بعد جزءًا من المستند و[`ParentNode`](../../node/parentnode) باطل.

لإلحاق أ[`CommentRangeStart`](../../commentrangestart) في المستند ، استخدم InsertAfter أو InsertBefore في الفقرة التي تريد إدراج التعليق فيها.
