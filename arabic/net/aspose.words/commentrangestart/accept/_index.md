...
description: اكتشف طريقة قبول CommentRangeStart لتعزيز تفاعل الزوار وتبسيط التفاعلات على موقعك. حسّن تجربة المستخدم اليوم!
type: docs
weight: 40
url: /ar/net/aspose.words/commentrangestart/accept/
---
...
المكالمات[`VisitCommentRangeStart`](../../documentvisitor/visitcommentrangestart/).
