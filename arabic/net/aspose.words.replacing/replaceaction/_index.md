...
description: يسمح للمستخدم بتحديد ما يحدث للمطابقة الحالية أثناء عملية الاستبدال.
type: docs
weight: 4380
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Replace | `0` | استبدال المطابقة الحالية ._ x000d_ |
| Skip | `1` | تخطي المباراة الحالية ._ x000d_ |
