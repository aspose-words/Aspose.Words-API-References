...
description: OfficeMath ملكية. الحصول على/تعيين نوع تنسيق عرض Office Math الذي يمثل ما إذا كانت المعادلة معروضة سطريًا مع text أو معروضة على السطر الخاص بها.
type: docs
weight: 10
