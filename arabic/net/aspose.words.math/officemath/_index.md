...
description: Aspose.Words.Math.OfficeMath فصل. يمثل كائن Office Math مثل الوظيفة أو المعادلة أو المصفوفة أو ما شابه. يمكن أن تحتوي على عناصر فرعية بما في ذلك مجموعة من النصوص الرياضية والإشارات المرجعية والتعليقات وغيرهاOfficeMath مثيلات وبعض العقد الأخرى.
type: docs
weight: 3880
