...
description: الوصول إلى خلايا محددة بسهولة باستخدام خاصية عنصر مجموعة الخلايا. استرجع أي خلية حسب الفهرس لإدارة بيانات مبسطة وأداء مُحسّن.
type: docs
weight: 10
...
يسترجع[`Cell`](../../cell/) عند الفهرس المعطى.
