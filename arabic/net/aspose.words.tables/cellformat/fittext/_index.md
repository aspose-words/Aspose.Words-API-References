...
description: CellFormat ملكية. إذا كان صحيحًا  يناسب النص الموجود في الخلية  وضغط كل فقرة على عرض الخلية.
type: docs
weight: 30
...
إذا كان صحيحًا ، يناسب النص الموجود في الخلية ، وضغط كل فقرة على عرض الخلية.
