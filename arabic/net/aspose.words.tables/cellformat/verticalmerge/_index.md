...
لا يمكن دمج الخلايا عموديًا إلا إذا كانت حدودها اليمنى واليسرى متطابقة.

عندما يتم دمج الخلايا عموديًا ، يتم دمج مناطق العرض الخاصة بالخلايا المدمجة. يتم استخدام المنطقة المدمجة لعرض محتويات أول خلية مدمجة رأسياً ويجب أن تكون جميع الخلايا الأخرى المدمجة عموديًا فارغة.
