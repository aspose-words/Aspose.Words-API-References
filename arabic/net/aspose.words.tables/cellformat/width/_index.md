...
لا يوصى بتعيين هذه الخاصية . لا يوجد ضمان بأن الخلية سيكون لها بالفعل العرض المحدد . يمكن تعديل العرض لاستيعاب محتويات الخلية في تخطيط جدول الاحتواء التلقائي ._ x000d_ قد يكون للخلايا الموجودة في صفوف أخرى عرض متعارض الإعدادات. _ x000d_ يمكن تغيير حجم الجدول ليناسب الحاوية أو لتلبية إعدادات عرض الجدول ._ x000d_ جرب استخدام[`PreferredWidth`](../preferredwidth) لتعيين عرض الخلية. تعيين مجموعات هذه الخاصية[`PreferredWidth`](../preferredwidth)ضمنيًا منذ الإصدار 15.8.
