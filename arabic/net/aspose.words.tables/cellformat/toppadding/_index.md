...
description: CellFormat ملكية. إرجاع أو تعيين مقدار المسافة بالنقاط للإضافة فوق محتويات الخلية.
type: docs
weight: 100
...
إرجاع أو تعيين مقدار المسافة (بالنقاط) للإضافة فوق محتويات الخلية.
