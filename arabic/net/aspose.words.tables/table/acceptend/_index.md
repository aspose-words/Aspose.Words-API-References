...
description: اكتشف طريقة Table AcceptEnd، وقم بدمج الزائرين في نهاية الجدول بسلاسة لتحسين تجربة المستخدم والتعامل الفعال مع البيانات.
type: docs
weight: 360
url: /ar/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

يقبل زائرًا لزيارة نهاية الجدول.
