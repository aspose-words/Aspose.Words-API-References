...
description: اكتشف طريقة قبول الجدول لإدارة الزوار بسلاسة. حسّن تجربة المستخدم وتفاعلاته بسلاسة!
type: docs
weight: 350
url: /ar/net/aspose.words.tables/table/accept/
---
## Table.Accept method
...
مكالمات [`VisitTableStart`](../../../aspose.words/documentvisitor/visittablestart/) ، ثم يدعو[`Accept`](../../../aspose.words/node/accept/) لجميع العقد الفرعية لقسم والمكالمات[`VisitTableEnd`](../../../aspose.words/documentvisitor/visittableend/) في النهاية.
