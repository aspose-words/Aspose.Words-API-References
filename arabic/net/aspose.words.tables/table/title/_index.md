...
description: Table ملكية. الحصول على عنوان هذا الجدول أو تعيينه . يوفر تمثيلًا نصيًا بديلاً للمعلومات الواردة في الجدول.
type: docs
weight: 320
...
الحصول على عنوان هذا الجدول أو تعيينه . يوفر تمثيلًا نصيًا بديلاً للمعلومات الواردة في الجدول.
