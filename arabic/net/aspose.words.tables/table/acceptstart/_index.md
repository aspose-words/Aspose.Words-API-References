...
description: اكتشف طريقة Table AcceptStart للترحيب بالزائرين بسلاسة في بداية الجدول، مما يعزز تجربة المستخدم والمشاركة.
type: docs
weight: 370
url: /ar/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

يقبل زائرًا لزيارة بداية الجدول.
