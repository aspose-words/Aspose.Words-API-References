...
description: اكتشف طريقة Cell AcceptStart للترحيب بالزائرين بسلاسة عند نقطة دخول هاتفك المحمول، مما يعزز تجربة المستخدم وتفاعله.
type: docs
weight: 150
url: /ar/net/aspose.words.tables/cell/acceptstart/
---
## Cell.AcceptStart method

يقبل زائرًا لزيارة بداية الخلية.
