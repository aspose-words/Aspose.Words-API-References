...
description: اكتشف طريقة Cell AcceptEnd لإدارة وصول الزائرين إلى نقاط نهاية الخلية بسلاسة، مما يعزز تجربة المستخدم ويحسن التدفق.
type: docs
weight: 140
url: /ar/net/aspose.words.tables/cell/acceptend/
---
## Cell.AcceptEnd method

يقبل زائرًا لزيارة نهاية الخلية.
