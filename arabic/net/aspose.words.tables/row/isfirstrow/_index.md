...
description: اكتشف خاصية "الصف هو الصف الأول"، وحدد الصف الأول في الجدول بسهولة. حسّن تنظيم بياناتك بهذه الميزة الأساسية!
type: docs
weight: 40
...
صحيح إذا كان هذا هو الصف الأول في الجدول؛ وإلا فهو خطأ.
