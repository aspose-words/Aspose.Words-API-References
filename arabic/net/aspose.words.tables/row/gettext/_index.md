...
description: Row طريقة. الحصول على نص جميع الخلايا في هذا الصف بما في ذلك نهاية حرف الصف.
type: docs
weight: 120
...
الحصول على نص جميع الخلايا في هذا الصف بما في ذلك نهاية حرف الصف.
...
إرجاع نص متسلسل لجميع العقد الفرعية بنهاية الصف character [`ControlChar.Cell`](../../../aspose.words/controlchar/cell/) ملحق في النهاية.

تتضمن السلسلة التي تم إرجاعها كل عناصر التحكم والأحرف الخاصة كما هو موضح في[`ControlChar`](../../../aspose.words/controlchar/).
