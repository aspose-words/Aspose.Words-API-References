...
description: PreferredWidth طريقة. تحديد ما إذا كان PreferredWidth المحدد مساويًا في القيمة لـ PreferredWidth الحالي.
type: docs
weight: 60
...
تحديد ما إذا كان PreferredWidth المحدد مساويًا في القيمة لـ PreferredWidth الحالي.
