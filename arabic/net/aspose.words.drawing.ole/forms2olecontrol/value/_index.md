...
description: يحصل على خاصية القيمة الأساسية التي غالبًا ما تمثل حالة التحكم . على سبيل المثال  يحتوي زر الخيار المحدد على قيمة 1 بينما لم يتم تحديده يحتوي على 0 . القيمة الافتراضية هي سلسلة فارغة .
type: docs
weight: 60
