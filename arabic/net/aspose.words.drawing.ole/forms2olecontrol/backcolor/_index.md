...
description: اكتشف خاصية BackColor في Forms2OleControl لتخصيص لون خلفية عنصر التحكم. حسّن واجهة المستخدم لديك بخيارات ألوان مرنة اليوم!
type: docs
weight: 10
url: /ar/net/aspose.words.drawing.ole/forms2olecontrol/backcolor/
---
## Forms2OleControl.BackColor property

يحصل على لون الخلفية لعنصر التحكم أو يعينه. تعتمد القيمة الافتراضية على نوع عنصر التحكم.
