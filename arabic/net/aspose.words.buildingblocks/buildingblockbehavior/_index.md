...
description: Aspose.Words.BuildingBlocks.BuildingBlockBehavior تعداد. يحدد السلوك الذي يجب تطبيقه على محتويات الكتلة البرمجية الإنشائية عند إدراجه في المستند الرئيسي.
type: docs
weight: 130
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Content | `0` | تحديد أنه يجب إدراج الكتلة البرمجية الإنشائية كمحتوى مضمن. |
| Paragraph | `1` | تحديد أنه يجب إدراج الكتلة البرمجية الإنشائية في الفقرة الخاصة بها. |
| Page | `2` | تحديد إضافة الكتلة البرمجية الإنشائية إلى الصفحة الخاصة بها. |
