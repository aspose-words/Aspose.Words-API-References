...
description: البحث عن كتلة إنشاء باستخدام المعرض والفئة والاسم المحدد.
type: docs
weight: 70
...
هذه طريقة ملائمة تتكرر عبر جميع كتل الإنشاء_ x000d_ في هذه المجموعة وتُرجع أول كتلة إنشاء تتطابق مع_ x000d_ المعرض والفئة والاسم المحدد.
