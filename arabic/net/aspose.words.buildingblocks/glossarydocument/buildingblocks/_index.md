...
description: اكتشف خاصية BuildingBlocks في GlossaryDocument، التي توفر مجموعة مطبوعة من جميع إدخالات القاموس لتحسين التنظيم وسهولة الوصول.
type: docs
weight: 20
...
يعيد مجموعة مكتوبة تمثل جميع كتل البناء في مستند المصطلحات.
