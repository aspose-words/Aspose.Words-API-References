...
description: اكتشف خاصية FirstBuildingBlock في GlossaryDocument. تمتع بسهولة الوصول إلى كتلة البناء الأولية لإدارة مستنداتك بشكل مبسط.
type: docs
weight: 30
...
يحصل على كتلة البناء الأولى في مستند المصطلحات.
