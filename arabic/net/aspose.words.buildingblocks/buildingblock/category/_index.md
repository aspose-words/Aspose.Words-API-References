...
description: اكتشف خصائص فئة BuildingBlock الخاصة بنا لتحسين التصنيف على المستوى الثاني وتبسيط مشاريعك وتعزيز كفاءة مؤسستك.
type: docs
weight: 30
...
يحدد تصنيف المستوى الثاني لكتلة البناء.
...
يتم ترتيب كتل البناء في واجهة مستخدم Microsoft Word في المعارض. كل[`Gallery`](../gallery/) يمكن أن تحتوي على فئات متعددة. كل كتلة ضمن x000d_`Category` لديه[`Name`](../name/).

لا يمكن أن يكون`باطل` ولا يمكن أن تكون سلسلة فارغة.

يتوافق مع**docPartPr.category.name** عنصر في OOXML.
