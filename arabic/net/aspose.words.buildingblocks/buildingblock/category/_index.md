...
يحدد تصنيف المستوى الثاني للكتلة البرمجية الإنشائية.
...
يتم ترتيب الكتل البرمجية الإنشائية في واجهة مستخدم Microsoft Word في المعارض. كل[`Gallery`](../gallery/) يمكن أن تحتوي على فئات متعددة. كل كتلة within a`Category` لديه[`Name`](../name/).

لا يمكن`لا شيء` ولا يمكن أن تكون سلسلة فارغة.

يتوافق مع **docPartPr.category.name** عنصر OOXML.
