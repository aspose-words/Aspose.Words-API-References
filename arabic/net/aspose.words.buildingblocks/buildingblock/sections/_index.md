...
description: اكتشف أقسام BuildingBlock. تمتع بسهولة الوصول إلى جميع الأقسام داخل BuildingBlock وإدارتها، مما يُحسّن التنظيم والكفاءة.
type: docs
weight: 110
...
يعيد مجموعة تمثل جميع الأقسام في كتلة البناء.
