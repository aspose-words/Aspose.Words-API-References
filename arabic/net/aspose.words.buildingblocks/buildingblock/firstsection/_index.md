...
description: اكتشف القسم الأول من BuildingBlock. تمتع بسهولة الوصول إلى القسم الأول من BuildingBlock الخاص بك لتنظيم مبسط وكفاءة أعلى.
type: docs
weight: 50
...
يحصل على القسم الأول في كتلة البناء.
