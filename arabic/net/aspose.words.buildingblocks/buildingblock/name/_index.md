...
description: اكتشف خاصية اسم كتلة البناء، وقم بإدارة كتل البناء الخاصة بك وتخصيصها بسهولة من خلال تعيين اسم بسيط لتحسين التنظيم.
type: docs
weight: 90
...
يحصل على اسم كتلة البناء هذه أو يعينه.
...
يمكن أن يحتوي الاسم على أي محتوى سلسلة، وعادةً ما يكون معرفًا وديًا. يمكن أن يكون للعديد من كتل البناء نفس الاسم.

لا يمكن أن يكون`باطل` ولا يمكن أن تكون سلسلة فارغة.

يتوافق مع**اسم الجزء الخاص بالوثيقة** عنصر في OOXML.
