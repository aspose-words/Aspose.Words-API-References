...
description: اكتشف ميزة BuildingBlock Gallery الفريدة للتصنيف الفعّال وترتيب واجهة المستخدم بسلاسة. حسّن تنظيمك اليوم!
type: docs
weight: 60
...
يحدد تصنيف المستوى الأول لكتلة البناء لأغراض تصنيف أو فرز واجهة المستخدم.
...
يتم ترتيب كتل البناء في واجهة مستخدم Microsoft Word في المعارض. كل`Gallery` يمكن أن تحتوي على فئات متعددة. كل كتلة ضمن x000d_[`Category`](../category/) لديه[`Name`](../name/).

يتوافق مع**docPartPr.category.gallery** عنصر في OOXML.
