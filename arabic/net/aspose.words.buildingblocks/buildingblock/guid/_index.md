...
description: BuildingBlock ملكية. الحصول على أو تعيين معرّف 128 بت GUID يعرّف بشكل فريد كتلة الإنشاء هذه.
type: docs
weight: 70
...
الحصول على أو تعيين معرّف (128 بت GUID) يعرّف بشكل فريد كتلة الإنشاء هذه.
...
يمكن استخدامها من قبل تطبيق للإشارة بشكل فريد إلى كتلة الإنشاء بغض النظر عن تسمية مختلفة بسبب الترجمة.

يتوافق مع **docPartPr.guid** عنصر OOXML.
