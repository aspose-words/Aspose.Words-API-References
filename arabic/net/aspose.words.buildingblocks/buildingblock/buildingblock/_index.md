...
متي[`BuildingBlock`](../../buildingblock) تم إنشاؤه ، وهو ينتمي إلى مستند المسرد المحدد ، ولكنه لم يعد جزءًا من مستند المسرد و[`ParentNode`](../../../aspose.words/node/parentnode) هو`لا شيء`.

لإلحاق[`BuildingBlock`](../../buildingblock) إلى أ[`GlossaryDocument`](../../glossarydocument) استخدم [`AppendChild`](../../../aspose.words/compositenode/appendchild).
