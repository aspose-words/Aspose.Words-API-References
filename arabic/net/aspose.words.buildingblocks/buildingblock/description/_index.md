...
description: BuildingBlock ملكية. الحصول على الوصف المرتبط بهذه الكتلة البرمجية الإنشائية أو تعيينه.
type: docs
weight: 40
...
الحصول على الوصف المرتبط بهذه الكتلة البرمجية الإنشائية أو تعيينه.
...
لا يمكن`لا شيء`، ولكن يمكن أن تكون سلسلة فارغة.

يتوافق مع **docPartPr.description** عنصر OOXML.
