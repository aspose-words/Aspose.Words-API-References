...
description: BuildingBlock ملكية. يحدد السلوك الذي يجب تطبيقه عند إدراج محتويات block في المستند الرئيسي.
type: docs
weight: 20
...
يحدد السلوك الذي يجب تطبيقه عند إدراج محتويات block في المستند الرئيسي.
