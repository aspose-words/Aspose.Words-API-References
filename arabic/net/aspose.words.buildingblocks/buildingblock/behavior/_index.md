...
description: اكتشف كيف يعمل BuildingBlock Behavior على تعزيز مستندك من خلال تحديد طرق إدراج المحتوى لتحقيق التكامل السلس وتحسين سير العمل.
type: docs
weight: 20
...
يحدد السلوك الذي سيتم تطبيقه عند إدراج محتويات كتلة البناء في المستند الرئيسي.
