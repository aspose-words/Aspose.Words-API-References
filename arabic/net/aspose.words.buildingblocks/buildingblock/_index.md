...
description: Aspose.Words.BuildingBlocks.BuildingBlock فصل. يمثل إدخال مستند المعجم مثل Building Block أو النص التلقائي أو إدخال التصحيح التلقائي في C#.
type: docs
weight: 130
...
| اسم | وصف |
| --- | --- |
| [BuildingBlock](buildingblock/)(*[GlossaryDocument](../glossarydocument/)*) | تهيئة مثيل جديد لهذه الفئة. |
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.words.buildingblocks/buildingblock/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | يقبل الزائر. |
