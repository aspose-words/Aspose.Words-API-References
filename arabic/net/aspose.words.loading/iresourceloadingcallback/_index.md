...
description: قم بتنفيذ هذه الواجهة إذا كنت تريد التحكم في كيفية تحميل Aspose.Words مورد خارجي عند استيراد مستند وإدراج الصور باستخدامDocumentBuilder../aspose.words/documentbuilder/ .
type: docs
weight: 3440
