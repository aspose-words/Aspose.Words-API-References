...
description: اكتشف خاصية Aspose.Words.TxtTrailingSpacesOptions لإدارة المساحات الزائدة بكفاءة عند استيراد ملفات النصوص. حسّن معالجة مستنداتك اليوم!
type: docs
weight: 4200
...
يحدد الخيارات المتاحة للتعامل مع المسافات الزائدة أثناء الاستيراد منText الملف.
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Trim | `0` | تم تقليص المسافات الزائدة. |
| Preserve | `1` | يتم الحفاظ على المسافات الزائدة. |
