...
قد تتعامل إصدارات Word المختلفة مع جوانب معينة من محتوى المستند والتنسيق بشكل مختلف قليلاً_ x000d_ أثناء عملية التحميل ، مما قد يؤدي إلى اختلافات طفيفة في نموذج كائن المستند.
