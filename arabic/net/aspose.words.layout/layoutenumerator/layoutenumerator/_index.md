...
description: LayoutEnumerator البناء. تهيئة مثيل جديد لهذه الفئة.
type: docs
weight: 10
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| document | Document | وثيقة يتم تعداد نموذج تخطيط الصفحة الخاص بها. |

### ملاحظات

إذا لم يتم إنشاء نموذج تخطيط الصفحة للمستند ، يستدعي العداد[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) لبنائه.

عند تحديث المستند وإنشاء نموذج تخطيط صفحة جديد ، يجب استخدام عداد جديد للوصول إليه.
