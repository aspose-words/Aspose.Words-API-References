...
description: اكتشف كيف تقوم طريقة LayoutEnumerator MovePrevious بالتنقل بكفاءة إلى الكيان الشقيق السابق، مما يعزز سير عمل الترميز الخاص بك.
type: docs
weight: 150
...
ينتقل إلى الكيان الشقيق السابق.
