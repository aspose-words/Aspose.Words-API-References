...
description: اكتشف خاصية LayoutEnumerator Rectangle. احصل على حدود دقيقة للمستطيلات للكيانات بالنسبة للزاوية العلوية اليسرى للصفحة بالنقاط.
type: docs
weight: 70
...
يعيد المستطيل المحيط بالكيان الحالي بالنسبة إلى الزاوية العلوية اليسرى للصفحة (بالنقاط).
