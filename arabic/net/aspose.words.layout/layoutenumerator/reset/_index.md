...
description: إعادة تعيين LayoutEnumerator إلى الصفحة الأولى من المستند، مما يعزز التنقل والكفاءة لإدارة المستندات بسلاسة.
type: docs
weight: 170
...
ينقل المُعدِّد إلى الصفحة الأولى من المستند.
