...
description: ينتقل إلى الكيان الشقيق التالي بالترتيب المرئي ._ x000d_ عند تكرار سطور فقرة مقسمة عبر الصفحات  لن تنتقل هذه الطريقة_ x000d_ إلى الصفحة التالية بل تنتقل إلى الكيان التالي في نفس الصفحة.
type: docs
weight: 110
...
ينتقل إلى الكيان الشقيق التالي بالترتيب المرئي ._ x000d_ عند تكرار سطور فقرة مقسمة عبر الصفحات ، لن تنتقل هذه الطريقة_ x000d_ إلى الصفحة التالية بل تنتقل إلى الكيان التالي في نفس الصفحة.
