...
description: اكتشف طريقة LayoutEnumerator MoveNext للتنقل بين الكيانات الشقيقة بصريًا. كرر سطور الفقرات بكفاءة دون الحاجة إلى تجاوز الصفحات.
type: docs
weight: 120
...
ينتقل إلى الكيان الشقيق التالي بالترتيب المرئي. عند تكرار أسطر فقرة مقسمة عبر الصفحات، لن تنتقل هذه الطريقة إلى الصفحة التالية، بل ستنتقل إلى الكيان التالي على نفس الصفحة.
