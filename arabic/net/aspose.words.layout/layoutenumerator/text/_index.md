...
description: اكتشف خاصية LayoutEnumerator Text لاسترجاع نص كيان النطاق الحالي بسهولة. بسّط معالجة بياناتك مع هذه الميزة الفعّالة!
type: docs
weight: 80
url: /ar/net/aspose.words.layout/layoutenumerator/text/
---
## LayoutEnumerator.Text property

يسترجع نص كيان النطاق الحالي. يُرمى لأنواع الكيانات الأخرى.
