...
description: اكتشف كيف تقوم طريقة LayoutEnumerator MoveFirstChild بالتنقل بكفاءة إلى الكيان الفرعي الأول، مما يعزز مهاراتك في معالجة البيانات.
type: docs
weight: 100
url: /ar/net/aspose.words.layout/layoutenumerator/movefirstchild/
---
## LayoutEnumerator.MoveFirstChild method

ينتقل إلى الكيان الفرعي الأول.
