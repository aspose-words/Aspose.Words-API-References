...
description: اكتشف خاصية LayoutEnumerator PageIndex. استرجاع فهرس الصفحة التي تحتوي على الكيان الحالي بسهولة، مما يضمن سهولة التنقل.
type: docs
weight: 60
...
يحصل على الفهرس القائم على 1 للصفحة التي تحتوي على الكيان الحالي.
