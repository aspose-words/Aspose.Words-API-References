...
description: اكتشف طريقة LayoutEnumerator MovePreviousLogical للتنقل بكفاءة بين الكيانات الشقيقة والتعامل مع أسطر الفقرات عبر الصفحات بسلاسة.
type: docs
weight: 160
...
ينتقل إلى الكيان الشقيق السابق بترتيب منطقي. عند تكرار أسطر فقرة مقسمة عبر الصفحات، ستنتقل هذه الطريقة إلى السطر السابق حتى لو كان موجودًا في صفحة أخرى.
