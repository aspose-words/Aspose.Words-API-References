...
description: ينتقل إلى الكيان الشقيق السابق بترتيب منطقي . عند تكرار سطور فقرة مقطوعة عبر الصفحات  ستنتقل هذه الطريقة إلى السطر السابق حتى إذا كانت موجودة في صفحة أخرى.
type: docs
weight: 150
