...
description: اكتشف كيف تقوم طريقة LayoutEnumerator MoveLastChild بالتنقل بكفاءة إلى الكيان الفرعي الأخير، مما يعزز قدرات إدارة البيانات لديك.
type: docs
weight: 110
...
ينتقل إلى الكيان الفرعي الأخير.
