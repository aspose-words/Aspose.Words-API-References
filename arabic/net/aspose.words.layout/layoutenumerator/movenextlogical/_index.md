...
description: ينتقل إلى الكيان الشقيق التالي بترتيب منطقي ._ x000d_ عند تكرار سطور فقرة مقطوعة عبر الصفحات  ستنتقل هذه الطريقة_ x000d_ إلى السطر التالي حتى إذا كانت موجودة في صفحة أخرى.
type: docs
weight: 120
...
ينتقل إلى الكيان الشقيق التالي بترتيب منطقي ._ x000d_ عند تكرار سطور فقرة مقطوعة عبر الصفحات ، ستنتقل هذه الطريقة_ x000d_ إلى السطر التالي حتى إذا كانت موجودة في صفحة أخرى.
...
لاحظ أن كل شيءSpan ترتبط الكيانات معًا وبالتالي إذا[`Current`](../current) كيان يمتد على امتداد استدعاء متكرر لهذه الطريقة سوف يكرر القصة الكاملة للمستند.
