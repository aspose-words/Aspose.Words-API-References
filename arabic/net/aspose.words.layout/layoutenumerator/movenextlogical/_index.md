...
description: اكتشف كيف تقوم طريقة LayoutEnumerator MoveNextLogical بالتنقل بسلاسة بين الكيانات الشقيقة، مما يضمن تكرارًا سلسًا لأسطر الفقرات عبر الصفحات.
type: docs
weight: 130
...
ينتقل إلى الكيان الشقيق التالي بترتيب منطقي. عند تكرار أسطر فقرة مقسمة عبر الصفحات، ستنتقل هذه الطريقة إلى السطر التالي حتى لو كان موجودًا في صفحة أخرى.
...
لاحظ أن كلSpan الكيانات مرتبطة ببعضها البعض وبالتالي إذا[`Current`](../current/) الكيان هو استدعاء متكرر لهذه الطريقة سيؤدي إلى تكرار القصة الكاملة للمستند.
