...
description: LayoutEnumerator طريقة. ينتقل إلى الكيان الشقيق التالي بترتيب منطقي . عند تكرار سطور فقرة مقطوعة عبر الصفحات  ستنتقل هذه الطريقة إلى السطر التالي حتى إذا كانت موجودة في صفحة أخرى.
type: docs
weight: 120
...
ينتقل إلى الكيان الشقيق التالي بترتيب منطقي . عند تكرار سطور فقرة مقطوعة عبر الصفحات ، ستنتقل هذه الطريقة إلى السطر التالي حتى إذا كانت موجودة في صفحة أخرى.
