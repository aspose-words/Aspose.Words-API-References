...
description: LayoutEnumerator ملكية. الحصول على نوع الكيان الحالي. يمكن أن تكون هذه سلسلة فارغة ولكنها ليست فارغة أبدًا.
type: docs
weight: 40
...
الحصول على نوع الكيان الحالي. يمكن أن تكون هذه سلسلة فارغة ولكنها ليست فارغة أبدًا.
...
هذا هو نوع أكثر تحديدًا للكيان الحالي ، على سبيل المثال ، نطاق الإشارة المرجعيةSpan اكتب and قد يكون من النوع BOOKMARKSTART أو BOOKMARKEND.
