...
description: اكتشف خاصية LayoutEnumerator Kind، التي تُحدد نوع الكيان الحالي. حسّن بياناتك باستخدام هذه الميزة الأساسية.
type: docs
weight: 50
...
يحصل على نوع الكيان الحالي. يمكن أن يكون سلسلة فارغة، ولكن لا`باطل` .
...
هذا نوع أكثر تحديدًا للكيان الحالي، على سبيل المثال، يحتوي نطاق الإشارة المرجعية علىSpan قد يكون النوع and من النوع BOOKMARKSTART أو BOOKMARKEND.
