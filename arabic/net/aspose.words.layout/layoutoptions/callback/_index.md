...
description: اكتشف خاصية Callback LayoutOptions لإدارة IPageLayoutCallback بسهولة لتحسين تخصيص تخطيط الصفحة وتحسين تجربة المستخدم.
type: docs
weight: 20
...
يحصل أو يعين[`IPageLayoutCallback`](../../ipagelayoutcallback/) التنفيذ المستخدم بواسطة نموذج تخطيط الصفحة.
