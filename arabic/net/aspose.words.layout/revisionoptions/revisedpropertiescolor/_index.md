...
description: خصّص محتواك باستخدام RevisedPropertiesColor من RevisionOptions. ميّز تغييرات التنسيق بسهولة وحسّن قابلية القراءة باستخدام هذه الميزة سهلة الاستخدام.
type: docs
weight: 130
...
يسمح بتحديد اللون الذي سيتم استخدامه للمحتوى مع تغييرات خصائص التنسيقFormatChange القيمة الافتراضية هيNoHighlight .
