...
description: تحكم في رؤية المراجعات باستخدام خاصية ShowRevisionMarks. نسّق نص المراجعة بسهولة لزيادة الوضوح، مما يُحسّن التعاون في المستندات. القيمة الافتراضية هي "صحيح".
type: docs
weight: 210
...
يسمح بتحديد ما إذا كان يجب وضع علامة على نص المراجعة باستخدام تنسيق خاص. القيمة الافتراضية هي`حقيقي` .
