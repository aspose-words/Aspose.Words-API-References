...
description: RevisionOptions ملكية. يسمح بتحديد تأثير مناطق المحتوى بتغييرات خصائص التنسيقFormatChange القيمة الافتراضية هيNone
type: docs
weight: 120
...
يسمح بتحديد تأثير مناطق المحتوى بتغييرات خصائص التنسيقFormatChange القيمة الافتراضية هيNone
...
Hidden غير مسموح وسوف يسببArgumentOutOfRangeException.
