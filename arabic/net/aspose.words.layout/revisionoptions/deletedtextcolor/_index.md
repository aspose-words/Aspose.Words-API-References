...
description: خصّص خيارات المراجعة (RevisionOptions) باستخدام خاصية DeletedTextColor لإبراز المحتوى المحذوف. الإعداد الافتراضي هو ByAuthor. حسّن وضوح مستندك!
type: docs
weight: 30
