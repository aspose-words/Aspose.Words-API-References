...
description: اكتشف طريقة LayoutCollector GetNumPagesSpanned لتحديد عدد الصفحات التي تغطيها العقدة بكفاءة. بسّط إدارة مستنداتك اليوم!
type: docs
weight: 60
...
يحصل على عدد الصفحات التي تمتد إليها العقدة المحددة. 0 إذا كانت العقدة ضمن صفحة واحدة. هذا هو نفس[`GetEndPageIndex`](../getendpageindex/) -[`GetStartPageIndex`](../getstartpageindex/) .
