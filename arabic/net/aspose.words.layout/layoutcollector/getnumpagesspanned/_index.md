...
description: LayoutCollector طريقة. الحصول على عدد الصفحات التي تمتد العقدة المحددة إليها. 0 إذا كانت العقدة داخل صفحة واحدة . هذا هو نفسهGetEndPageIndex GetStartPageIndex .
type: docs
weight: 60
