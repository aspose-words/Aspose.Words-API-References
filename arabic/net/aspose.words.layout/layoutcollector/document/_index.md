...
description: اكتشف خاصية Document في LayoutCollector لإدارة مرفقات المستندات وتخصيصها بسهولة لتحسين كفاءة سير العمل.
type: docs
weight: 20
...
يحصل على المستند الذي تم إرفاق مثيل المجمع به أو يعينه.
...
إذا كنتَ بحاجة للوصول إلى فهارس صفحات عقد المستند، فعليكَ ضبط هذه الخاصية للإشارة إلى مثيل المستند، قبل إنشاء تخطيط صفحة المستند. يُفضّل ضبط هذه الخاصية على`باطل` بعد ذلك، وإلا يستمر المجمع في تجميع المعلومات من عمليات إعادة البناء اللاحقة لتخطيط صفحة المستند.
