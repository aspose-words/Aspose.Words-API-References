...
description: LayoutCollector طريقة. الحصول على فهرس يستند إلى 1 للصفحة حيث تبدأ العقدة. تُرجع القيمة 0 إذا تعذر تعيين العقدة إلى الصفحة.
type: docs
weight: 70
...
الحصول على فهرس يستند إلى 1 للصفحة حيث تبدأ العقدة. تُرجع القيمة 0 إذا تعذر تعيين العقدة إلى الصفحة.
