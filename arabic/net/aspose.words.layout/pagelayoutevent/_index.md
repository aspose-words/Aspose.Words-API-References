...
| اسم | قيمة | وصف |
| --- | --- | --- |
| None | `0` | القيمة الافتراضية_ x000d_ |
...
| ConversionStarted | `4` | بدأ تحويل نموذج المستند إلى تخطيط الصفحة. تم التشغيل مرة واحدة ._ x000d_ يحدث هذا عندما يبدأ نموذج التخطيط في سحب محتوى المستند. |
| ConversionFinished | `5` | تم الانتهاء من تحويل نموذج المستند إلى تخطيط الصفحة. تم التشغيل مرة واحدة ._ x000d_ يحدث هذا عندما يتوقف نموذج التخطيط عن سحب محتوى المستند. |
| ReflowStarted | `6` | بدأ إعادة تدفق تخطيط الصفحة. تم التشغيل مرة واحدة ._ x000d_ يحدث هذا عندما يبدأ نموذج التخطيط في إعادة تدفق محتوى المستند. |
| ReflowFinished | `7` | انتهى إعادة تدفق تخطيط الصفحة. تم التشغيل مرة واحدة ._ x000d_ يحدث هذا عندما يتوقف نموذج التخطيط عن إعادة تدفق محتوى المستند. |
| PartReflowStarted | `8` | بدأ إعادة تدفق الصفحة. _ x000d_ لاحظ أن الصفحة قد تتدفق عدة مرات وأن إعادة التدفق قد تبدأ قبل أن تنتهي. |
| PartReflowFinished | `9` | انتهى إعادة تدفق الصفحة. _ x000d_ لاحظ أن الصفحة قد تتدفق عدة مرات وأن إعادة التدفق قد تتم إعادة تشغيلها قبل أن تنتهي. |
