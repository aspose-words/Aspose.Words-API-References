...
description: ال Aspose. Words.Renderingتوفر مساحة الاسم فئات تسمح لـ_ x000d_ بتخصيص طباعة المستندات أو عرضها.
type: docs
weight: 190
url: /ar/net/aspose.words.rendering/
---
ال **Aspose. Words.Rendering**توفر مساحة الاسم فئات تسمح لـ_ x000d_ بتخصيص طباعة المستندات أو عرضها.
...
| [PrinterSettingsContainer](./printersettingscontainer) | تمثل مخزنًا لبعض معلماتPrinterSettings الكائن ._ x000d_ |
