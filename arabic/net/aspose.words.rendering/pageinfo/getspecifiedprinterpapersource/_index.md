...
description: يحصل على ملفPaperSource كائن مناسب للطباعة الصفحة التي يمثلها هذاPageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
يحصل على ملفPaperSource كائن مناسب للطباعة الصفحة التي يمثلها هذا[`PageInfo`](../../pageinfo) .
