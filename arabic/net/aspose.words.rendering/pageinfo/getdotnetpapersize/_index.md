...
description: يحصل على ملفPaperSize كائن مناسب للطباعة الصفحة التي يمثلها هذاPageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 70
...
يحصل على ملفPaperSize كائن مناسب للطباعة الصفحة التي يمثلها هذا[`PageInfo`](../../pageinfo) .
