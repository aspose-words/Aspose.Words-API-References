...
description: NodeRendererBase ملكية. يحصل على الحدود المعتمة للشكل بالنقاط .
type: docs
weight: 20
...
تقوم هذه الخاصية بإرجاع الصندوق المحيط بالشكل المعتم (أي يتم تجاهل الأجزاء الشفافة من الشكل). تأخذ الحدود دوران الشكل في الاعتبار.
