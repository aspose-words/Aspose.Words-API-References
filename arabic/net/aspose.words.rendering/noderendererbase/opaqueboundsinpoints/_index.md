...
description: اكتشف خاصية NodeRendererBase OpaqueBoundsInPoints للوصول بسهولة إلى حدود الشكل بالنقاط، مما يعزز دقة التصميم وكفاءته.
type: docs
weight: 20
...
تعيد هذه الخاصية المربع المحيط المعتم (أي يتم تجاهل الأجزاء الشفافة من الشكل). تأخذ الحدود دوران الشكل في الاعتبار.
