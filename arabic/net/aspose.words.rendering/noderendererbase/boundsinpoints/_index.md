...
description: اكتشف خاصية NodeRendererBase BoundsInPoints للوصول إلى أبعاد الشكل الدقيقة بالنقاط، مما يعزز دقة التصميم وكفاءته.
type: docs
weight: 10
...
تعيد هذه الخاصية المربع المحدد الفعلي (كما تم تقديمه على الصفحة) للشكل. تأخذ الحدود في الاعتبار دوران الشكل (إن وجد).
