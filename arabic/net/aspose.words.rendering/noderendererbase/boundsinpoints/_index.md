...
description: NodeRendererBase ملكية. يحصل على الحدود الفعلية للشكل بالنقاط .
type: docs
weight: 10
...
تقوم هذه الخاصية بإرجاع المربع المحيط الفعلي للشكل (كما يظهر في الصفحة). تأخذ الحدود في الاعتبار دوران الشكل (إن وجد).
