...
description: اكتشف كيف تقوم طريقة NodeRendererBase GetOpaqueBoundsInPixels بحساب حدود الشكل بالبكسل بكفاءة، وتحسينها للتكبير والدقة.
type: docs
weight: 50
...
يحسب الحدود المعتمة للشكل بالبكسل لعامل تكبير ودقة محددين.
...
| dpi | Single | الدقة لتحويل النقاط إلى بكسل (نقطة لكل بوصة). |
...
هذه الطريقة تحول[`OpaqueBoundsInPoints`](../opaqueboundsinpoints/) إلى مستطيل بالبكسل، ومن المفيد استخدام x000d_ عندما تريد إنشاء خريطة نقطية لعرض الشكل مع جزء معتم فقط من الشكل.
