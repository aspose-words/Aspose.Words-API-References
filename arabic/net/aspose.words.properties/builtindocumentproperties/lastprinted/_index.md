...
description: BuiltInDocumentProperties ملكية. الحصول على أو تحديد تاريخ آخر طباعة للمستند بالتوقيت العالمي المنسق.
type: docs
weight: 150
...
الحصول على أو تحديد تاريخ آخر طباعة للمستند بالتوقيت العالمي المنسق.
