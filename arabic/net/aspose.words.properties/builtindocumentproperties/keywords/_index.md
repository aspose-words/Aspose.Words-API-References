...
description: حسّن مستنداتك باستخدام BuiltInDocumentProperties. أدر الكلمات المفتاحية بسهولة لتحسين إمكانية البحث والتنظيم، مما يزيد من الإنتاجية.
type: docs
weight: 150
...
يحصل على كلمات البحث الخاصة بالمستند أو يعينها.
