...
description: أدر خصائص المستندات المُدمجة بسهولة. احصل على خصائص الشركة أو عيّنها بسهولة لتحسين تنظيم المستندات وتبسيط سير العمل.
type: docs
weight: 70
...
يحصل على خاصية الشركة أو يعينها.
