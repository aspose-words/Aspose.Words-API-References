...
| اسم | وصف |
| --- | --- |
| [Author](../../aspose.words.properties/builtindocumentproperties/author/) { get; set; } | الحصول على أو تحديد اسم مؤلف المستند. |
| [Bytes](../../aspose.words.properties/builtindocumentproperties/bytes/) { get; set; } | يمثل تقديرًا لعدد البايت في المستند. |
...
| [LastSavedTime](../../aspose.words.properties/builtindocumentproperties/lastsavedtime/) { get; set; } | الحصول على أو تحديد وقت آخر حفظ بالتوقيت العالمي المنسق . |
| [Lines](../../aspose.words.properties/builtindocumentproperties/lines/) { get; set; } | يمثل تقديرًا لعدد الأسطر في المستند. |
| [LinksUpToDate](../../aspose.words.properties/builtindocumentproperties/linksuptodate/) { get; set; } | يشير إلى ما إذا كانت الارتباطات التشعبية في مستند محدثة أم لا. |
| [Manager](../../aspose.words.properties/builtindocumentproperties/manager/) { get; set; } | الحصول على خاصية المدير أو تعيينها. |
| [NameOfApplication](../../aspose.words.properties/builtindocumentproperties/nameofapplication/) { get; set; } | الحصول على أو تحديد اسم التطبيق. |
...
| [RevisionNumber](../../aspose.words.properties/builtindocumentproperties/revisionnumber/) { get; set; } | الحصول على أو تحديد رقم مراجعة المستند. |
| [Security](../../aspose.words.properties/builtindocumentproperties/security/) { get; set; } | يحدد مستوى الأمان للمستند كقيمة عددية. |
| [Subject](../../aspose.words.properties/builtindocumentproperties/subject/) { get; set; } | الحصول على أو تحديد موضوع المستند. |
| [Template](../../aspose.words.properties/builtindocumentproperties/template/) { get; set; } | الحصول على أو تحديد الاسم المعلوماتي لقالب المستند. |
| [Thumbnail](../../aspose.words.properties/builtindocumentproperties/thumbnail/) { get; set; } | الحصول على أو تحديد مصغر المستند. |
| [Title](../../aspose.words.properties/builtindocumentproperties/title/) { get; set; } | الحصول على عنوان المستند أو تحديده. |
| [TitlesOfParts](../../aspose.words.properties/builtindocumentproperties/titlesofparts/) { get; set; } | تحدد كل سلسلة في المصفوفة اسم جزء في المستند. |
| [TotalEditingTime](../../aspose.words.properties/builtindocumentproperties/totaleditingtime/) { get; set; } | الحصول على أو تحديد إجمالي وقت التحرير بالدقائق. |
