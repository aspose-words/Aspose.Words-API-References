...
description: أنشئ روابط امتدادات ويب قوية بسهولة باستخدام مُنشئ WebExtensionBinding. خصّص المعلمات لضمان تكامل سلس ووظائف مُحسّنة.
type: docs
weight: 10
...
ينشئ ربط ملحق الويب بالمعلمات المحددة.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| id | String | معرف الربط. |
| bindingType | WebExtensionBindingType | نوع الربط. |
| appRef | String | مفتاح الربط المستخدم لربط إدخال الربط في هذه القائمة بالبيانات المرتبطة في المستند. |
