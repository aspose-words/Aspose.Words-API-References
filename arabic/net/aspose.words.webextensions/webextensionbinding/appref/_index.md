...
description: اكتشف كيف تقوم خاصية WebExtensionBinding AppRef بربط مفاتيح الربط ببيانات المستند، مما يعزز وظائف تطبيق الويب لديك وأدائه.
type: docs
weight: 20
...
يحدد مفتاح الربط المستخدم لربط إدخال الربط في هذه القائمة بالبيانات المرتبطة في المستند.
