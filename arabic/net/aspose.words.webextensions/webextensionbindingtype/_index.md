...
description: Aspose.Words.WebExtensions.WebExtensionBindingType تعداد. تعداد أنواع الربط المتاحة بين امتداد الويب والبيانات الموجودة في المستند.
type: docs
weight: 6460
...
تعداد أنواع الربط المتاحة بين امتداد الويب والبيانات الموجودة في المستند.
...
| Table | `1` | بيانات جدولة مع صف رأس. |
| Text | `2` | نص عادي . |
| Default | `0` |  |
