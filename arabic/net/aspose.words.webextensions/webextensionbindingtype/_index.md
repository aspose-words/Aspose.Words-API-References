...
description: اكتشف Aspose.Words WebExtensionBindingType enum، الذي يحدد أنواع الربط للتكامل السلس لإضافات الويب مع بيانات المستند لديك.
type: docs
weight: 7620
...
يقوم بإحصاء أنواع الربط المتاحة بين ملحق الويب والبيانات الموجودة في المستند.
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Matrix | `0` | بيانات جدولية بدون صف رأس. |
| Table | `1` | بيانات جدولية مع صف رأسي. |
| Text | `2` | نص عادي. |
| Default | `0` | المصفوفة المستخدمة افتراضيًا. |
