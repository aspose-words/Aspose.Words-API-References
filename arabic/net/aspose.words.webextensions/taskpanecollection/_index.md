...
description: اكتشف فئة Aspose.Words.WebExtensions.TaskPaneCollection، الحل الأمثل لإدارة عناصر لوحة المهام الدائمة بكفاءة. حسّن تطبيقات الويب لديك اليوم!
type: docs
weight: 7570
...
يحدد قائمة من كائنات جزء المهام المستمرة.
