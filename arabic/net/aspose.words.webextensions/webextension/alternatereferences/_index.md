...
description: اكتشف خاصية WebExtension AlternateReferences لتعزيز ملحق الويب الخاص بك باستخدام خيارات مرجعية متعددة الاستخدامات لتحسين الوظائف.
type: docs
weight: 10
...
يحدد مراجع بديلة لامتداد الويب.
