...
description: اكتشف فئة Aspose.Words.WebExtensions.WebExtension، الحل الأمثل لإنشاء إضافات ويب ديناميكية في المستندات. حسّن وظائفها بسهولة!
type: docs
weight: 7590
...
| [Bindings](../../aspose.words.webextensions/webextension/bindings/) { get; } | يحدد قائمة ارتباطات امتداد الويب. |
| [Id](../../aspose.words.webextensions/webextension/id/) { get; set; } | يحدد بشكل فريد مثيل ملحق الويب في المستند الحالي. |
| [IsFrozen](../../aspose.words.webextensions/webextension/isfrozen/) { get; set; } | يحدد ما إذا كان بإمكان المستخدم التفاعل مع ملحق الويب أم لا. |
| [Properties](../../aspose.words.webextensions/webextension/properties/) { get; } | يمثل مجموعة من خصائص ملحق الويب المخصصة. |
