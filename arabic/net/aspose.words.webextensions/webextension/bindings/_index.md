...
description: اكتشف ارتباطات WebExtension، وقم بتبسيط عملية التطوير لديك باستخدام اتصالات ملحق الويب القابلة للتخصيص لتحسين الوظائف وتجربة المستخدم.
type: docs
weight: 20
...
يحدد قائمة ارتباطات امتداد الويب.
