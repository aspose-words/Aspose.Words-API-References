...
description: اكتشف Aspose.Words.WebExtensions.TaskPaneDockState enum، الذي يحدد مواقع جزء المهام لتحسين تحرير المستندات وتجربة المستخدم.
type: docs
weight: 7580
...
يقوم بإحصاء المواقع المتاحة لكائن جزء المهام.
