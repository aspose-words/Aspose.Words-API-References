...
description: TaskPane ملكية. يحدد الفهرس  الذي يتم تعداده من الخارج إلى الداخل  لجزء المهام هذا بين أجزاء المهام المستمرة الأخرى التي تم إرساؤها في نفس الموقع الافتراضي.
type: docs
weight: 50
url: /ar/net/aspose.words.webextensions/taskpane/row/
---
## TaskPane.Row property

يحدد الفهرس ، الذي يتم تعداده من الخارج إلى الداخل ، لجزء المهام هذا بين أجزاء المهام المستمرة الأخرى التي تم إرساؤها في نفس الموقع الافتراضي.
