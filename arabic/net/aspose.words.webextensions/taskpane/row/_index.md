...
description: اكتشف خاصية صف TaskPane، وقم بإدارة فهرسة جزء المهام بسهولة لتحقيق تنظيم مبسط وإنتاجية محسنة في تطبيقاتك.
type: docs
weight: 50
...
يحدد الفهرس، من الخارج إلى الداخل، لجزء المهام هذا بين أجزاء المهام الأخرى الثابتة الموجودة في نفس الموقع الافتراضي.
