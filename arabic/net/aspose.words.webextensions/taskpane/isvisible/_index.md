...
description: TaskPane ملكية. يحدد ما إذا كان جزء المهام سيظهر على أنه مرئي افتراضيًا عند فتح المستند.
type: docs
weight: 40
...
يحدد ما إذا كان جزء المهام سيظهر على أنه مرئي افتراضيًا عند فتح المستند.
