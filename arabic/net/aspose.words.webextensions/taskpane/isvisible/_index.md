...
description: اكتشف كيف تتحكم خاصية TaskPane IsVisible في الرؤية الافتراضية، مما يعمل على تحسين تجربة المستخدم وتبسيط تفاعلات المستندات.
type: docs
weight: 40
...
يحدد ما إذا كان جزء المهام يظهر بشكل مرئي افتراضيًا عند فتح المستند.
