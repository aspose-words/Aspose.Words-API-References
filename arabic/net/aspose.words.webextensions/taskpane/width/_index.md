...
description: اكتشف خاصية عرض TaskPane لتخصيص العرض الافتراضي لجزء المهام بسهولة، مما يعزز تجربة المستخدم والوظائف.
type: docs
weight: 70
...
يحدد قيمة العرض الافتراضية لنسخة جزء المهام هذه.
