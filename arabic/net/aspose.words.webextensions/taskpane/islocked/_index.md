...
description: اكتشف خاصية TaskPane IsLocked، وتحكم في إمكانية الوصول إلى جزء المهام في واجهة المستخدم الخاصة بك، مما يضمن عدم تمكن المستخدمين من إغلاق الميزات الأساسية لتحسين الإنتاجية.
type: docs
weight: 30
...
يحدد ما إذا كان جزء المهام مقفلاً على المستند في واجهة المستخدم ولا يمكن للمستخدم إغلاقه.
