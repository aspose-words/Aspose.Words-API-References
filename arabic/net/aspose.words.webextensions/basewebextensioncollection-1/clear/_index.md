...
description: قم بمسح BaseWebExtensionCollection الخاص بك بسهولة باستخدام طريقة Clear الخاصة بنا، والتي تعمل على إزالة جميع العناصر لتحسين الإدارة وتحسين الأداء.
type: docs
weight: 40
