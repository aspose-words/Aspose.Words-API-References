...
description: اكتشف مجموعة Aspose.Words.WebExtensions.WebExtensionPropertyCollection لإدارة خصائص ملحقات الويب المخصصة بكفاءة. حسّن أتمتة مستنداتك اليوم!
type: docs
weight: 7640
...
يحدد مجموعة من خصائص ملحق الويب المخصصة.
