...
description: OutlineOptions ملكية. يحدد عدد المستويات في مخطط المستند لإظهاره موسعًا عند عرض الملف.
type: docs
weight: 60
...
يحدد عدد المستويات في مخطط المستند لإظهاره موسعًا عند عرض الملف.
...
حدد 0 وسيتم طي مخطط المستند التفصيلي ؛ حدد 1 وسيتم توسيع عناصر المستوى الأول في المخطط التفصيلي وهكذا.
