...
description: اكتشف طريقة ICssSavingCallback CssSaving في Aspose.Words، مما يعمل على تحسين إدارة CSS لديك لتحقيق كفاءة تصميم ويب أفضل.
type: docs
weight: 10
...
يتم استدعاؤها عندما يحفظ Aspose.Words ملف CSS (ورقة الأنماط المتتالية).
