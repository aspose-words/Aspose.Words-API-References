...
description: Aspose.Words.Saving.SvgSaveOptions فصل. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفSvg التنسيق .
type: docs
weight: 5320
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفSvg التنسيق .
...
| [FitToViewPort](../../aspose.words.saving/svgsaveoptions/fittoviewport/) { get; set; } | يحدد ما إذا كان يجب أن يملأ SVG الناتج منطقة منفذ العرض المتاحة (نافذة المتصفح أو الحاوية) . عند التعيين على العرض الحقيقي وارتفاع الناتج SVG يتم تعيينه على 100٪. |
