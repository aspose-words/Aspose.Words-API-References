...
description: يحدد كيفية عرض مستند PDF عند فتحه في قارئ PDF.
type: docs
weight: 5220
...
| UseOutlines | `1` | مخطط المستند مرئي. _ x000d_ لاحظ أنه في حالة عدم وجود مخططات في مستند PDF ، فلن يكون جزء التنقل بالخطوط الخارجية مرئيًا على أي حال. |
| UseThumbs | `2` | الصور المصغرة مرئية ._ x000d_ |
| FullScreen | `3` | وضع ملء الشاشة ، مع عدم وجود شريط قوائم أو عناصر تحكم في النافذة أو أي نافذة أخرى مرئية. |
| UseOC | `4` | لوحة مجموعة المحتوى الاختيارية مرئية ._ x000d_ |
| UseAttachments | `5` | لوحة المرفقات مرئية ._ x000d_ |
