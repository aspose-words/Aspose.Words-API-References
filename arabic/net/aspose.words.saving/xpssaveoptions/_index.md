...
description: يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفXps التنسيق ._ x000d_
type: docs
weight: 5430
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفXps التنسيق ._ x000d_
...
| اسم | وصف |
| --- | --- |
| [XpsSaveOptions](xpssaveoptions#constructor)() | تهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ document فيXps التنسيق ._ x000d_ |
| [XpsSaveOptions](xpssaveoptions#constructor_1)(SaveFormat) | تهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ document فيXps أوOpenXps التنسيق ._ x000d_ |
