...
description: يحدد كيفية تصدير Aspose.Words عروض وارتفاعات العناصر إلى HTML و MHTML و EPUB.
type: docs
weight: 4800
...
| RelativeOnly | `1` | يتم تصدير أحجام العناصر فقط إذا كانت محددة بوحدات نسبية في المستند. لا يتم تصدير الأحجام الثابتة في هذا الوضع. سيحسب الوكلاء المرئيون الأحجام المفقودة لجعل تخطيط المستند أكثر طبيعية ._ x000d_ |
