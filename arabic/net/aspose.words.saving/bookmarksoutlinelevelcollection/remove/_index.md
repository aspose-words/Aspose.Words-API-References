...
description: BookmarksOutlineLevelCollection طريقة. يزيل إشارة مرجعية بالاسم المحدد من المجموعة.
type: docs
weight: 90
...
يزيل إشارة مرجعية بالاسم المحدد من المجموعة.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| name | String | الاسم غير الحساس لحالة الأحرف للإشارة المرجعية. |
