...
description: TxtSaveOptions ملكية. الحصول على أو تعيين قيمة عدد صحيح تحدد الحد الأقصى لعدد الأحرف في كل سطر. القيمة الافتراضية هي 0  وهذا يعني عدم وجود حد.
type: docs
weight: 40
