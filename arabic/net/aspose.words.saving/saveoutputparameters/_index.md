...
description: يتم إرجاع هذا الكائن إلى المستدعي بعد حفظ مستند ويحتوي على معلومات إضافية تم إنشاؤها أو حسابها أثناء عملية الحفظ. يمكن للمتصل استخدام هذا الكائن أو تجاهله.
type: docs
weight: 5310
