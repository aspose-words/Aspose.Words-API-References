...
يعمل هذا الإعداد فقط مع النص في ترميز ANSI (Windows-1252). إذا كان المستند يحتوي على نص غير ANSI_x000d ، فسيتم تضمين الخطوط المقابلة بغض النظر عن هذا الإعداد.

يتطلب التوافق مع PDF / A و PDF / UA دمج جميع الخطوط ._ x000d_EmbedAll سيتم استخدام القيمة تلقائيًا عند الحفظ في PDF / A و PDF / UA.
