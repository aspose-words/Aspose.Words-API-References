...
description: علامة تشير إلى ما إذا كان يجب إجراء استكمال الصورة بواسطة قارئ مطابق. متىخاطئة لم يتم تحديد العلامة إلى مستند الإخراج و_ x000d_ يتم استخدام السلوك الافتراضي للقارئ بدلاً من ذلك.
type: docs
weight: 180
...
علامة تشير إلى ما إذا كان يجب إجراء استكمال الصورة بواسطة قارئ مطابق. متى`خاطئة` لم يتم تحديد العلامة إلى مستند الإخراج و_ x000d_ يتم استخدام السلوك الافتراضي للقارئ بدلاً من ذلك.
