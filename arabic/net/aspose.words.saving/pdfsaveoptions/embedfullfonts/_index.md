...
عندما يتم تعيين هذه القيمة على`حقيقي`، يتم تضمين ملف خط كامل في PDF بدون تقسيم_ x000d_. سينتج عن ذلك ملفات إخراج أكبر ، ولكن يمكن أن يكون خيارًا مفيدًا عندما تريد_ x000d_ تحرير ملف PDF الناتج لاحقًا (على سبيل المثال ، إضافة المزيد من النص).
