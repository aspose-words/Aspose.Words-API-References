...
description: الحصول على أو تعيين قيمة تحدد ما إذا كانت الارتباطات التشعبية الموجودة في ملف PDF الناتج document مفروضة على الفتح في نافذة أو علامة تبويب جديدة من المستعرض.
type: docs
weight: 200
