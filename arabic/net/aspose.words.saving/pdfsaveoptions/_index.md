...
description: يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفPdf التنسيق ._ x000d_
type: docs
weight: 5240
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفPdf التنسيق ._ x000d_
...
| اسم | وصف |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions)() | تهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند في Pdf التنسيق ._ x000d_ |
...
| [HeaderFooterBookmarksExportMode](../../aspose.words.saving/pdfsaveoptions/headerfooterbookmarksexportmode) { get; set; } | يحدد كيفية تصدير الإشارات المرجعية في الرؤوس / التذييلات ._ x000d_ |
...
| [InterpolateImages](../../aspose.words.saving/pdfsaveoptions/interpolateimages) { get; set; } | علامة تشير إلى ما إذا كان يجب إجراء استكمال الصورة بواسطة قارئ مطابق. متى`خاطئة` لم يتم تحديد العلامة إلى مستند الإخراج و_ x000d_ يتم استخدام السلوك الافتراضي للقارئ بدلاً من ذلك. |
