...
description: IDocumentPartSavingCallback طريقة. يتم الاستدعاء عند Aspose. كلمات على وشك حفظ جزء من المستند.
type: docs
weight: 10
...
يتم الاستدعاء عند Aspose. كلمات على وشك حفظ جزء من المستند.
