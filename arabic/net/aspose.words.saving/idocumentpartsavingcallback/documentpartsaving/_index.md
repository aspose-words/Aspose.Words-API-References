...
description: قم بتحسين إدارة المستندات لديك باستخدام طريقة DocumentPartSaving في Aspose.Words، مما يضمن الحفظ السلس لأجزاء المستند لتحسين الكفاءة.
type: docs
weight: 10
...
يتم استدعاؤها عندما يكون Aspose.Words على وشك حفظ جزء من المستند.
