...
description: Aspose.Words.Saving.FontSavingArgs فصل. توفير بيانات لملفFontSaving الحدث .
type: docs
weight: 4770
...
`FontSavingArgs` يتحكم في ما إذا كان يجب تصدير مورد خط معين وكيفية ذلك.

`FontSavingArgs`يسمح أيضًا بإعادة تعريف كيفية إنشاء أسماء ملفات الخطوط أو التحايل تمامًا على حفظ الخطوط في الملفات من خلال توفير كائنات البث الخاصة بك.
