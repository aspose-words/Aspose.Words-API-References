...
description: اكتشف خاصية FontSavingArgs Bold لتحديد ما إذا كان خطك عريضًا بسهولة. حسّن أسلوب الطباعة لديك لتحسين قابلية القراءة والتصميم.
type: docs
weight: 10
...
يشير إلى ما إذا كان الخط الحالي غامقًا.
