...
description: يشير إلى مجموعة الرموز المستخدمة لتمثيل number أثناء التقديم إلى تنسيقات الصفحة الثابتة.
type: docs
weight: 5030
...
| Context | `3` | تم تحديد مجموعة الرموز من السياق (الخاصية المحلية وخاصية RTL) ._ x000d_ |
