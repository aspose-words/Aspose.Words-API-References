...
description: Aspose.Words.Saving.TxtSaveOptionsBase فصل. الفئة الأساسية لتحديد الخيارات الإضافية عند حفظ مستند في تنسيقات نصية في C#.
type: docs
weight: 5670
...
الفئة الأساسية لتحديد الخيارات الإضافية عند حفظ مستند في تنسيقات نصية.
