...
description: يحدد كيفية عرض كائنات الحبر InkML لتنسيقات الصفحات الثابتة.
type: docs
weight: 4990
...
| InkML | `1` | Aspose.Words يتجاهل الشكل الخلفي لكائن الحبر (InkML) ويعرض InkML نفسه . هذا هو الوضع الافتراضي ._ x000d_ |
