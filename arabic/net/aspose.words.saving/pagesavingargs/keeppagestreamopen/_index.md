...
description: يحدد ما إذا كان يجب على Aspose.Words إبقاء الدفق مفتوحًا أو إغلاقه بعد حفظ صفحة المستند.
type: docs
weight: 20
...
الافتراضي هو`خاطئة` و Aspose.Words ستغلق الدفق الذي قدمته في[`PageStream`](../pagestream) الخاصية بعد كتابة صفحة المستند فيها ._ x000d_ تحديد`حقيقي` لإبقاء الدفق مفتوحًا.
