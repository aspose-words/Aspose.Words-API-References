...
الافتراضي هو`خاطئة` و Aspose.Words ستغلق الدفق الذي قدمته في[`PageStream`](../pagestream/) الخاصية بعد كتابة صفحة المستند فيها . تحديد`حقيقي` لإبقاء الدفق مفتوحًا.
