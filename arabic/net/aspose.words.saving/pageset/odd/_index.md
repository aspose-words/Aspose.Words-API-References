...
description: اكتشف خاصية PageSet Odd لاسترجاع كل الصفحات الفردية في مستندك بسهولة بالترتيب الأصلي لإدارة المستندات بكفاءة.
type: docs
weight: 40
...
يحصل على مجموعة من جميع الصفحات الفردية للمستند بالترتيب الأصلي.
...
تحتوي الصفحات الفردية على فهرس زوجي لأن فهرس الصفحات يعتمد على الصفر.
