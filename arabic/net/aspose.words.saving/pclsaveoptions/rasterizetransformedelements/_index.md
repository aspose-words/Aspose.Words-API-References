...
لا تدعم PCL نوعًا من التحويلات التي تستخدمها Aspose Words . على سبيل المثال ، الصور المستديرة والمنحرفة وفرش النسيج. لتصيير هذه العناصر يتم استخدام عملية التنقيط بشكل صحيح ، أي الحفظ على الصورة والقص . يمكن أن تستغرق هذه العملية وقتًا وذاكرة إضافية.`خاطئة`، قد يكون بعض المحتوى في المخرجات مختلفًا_ x000d_ مقارنة بالمستند المصدر.
