...
// فيما يلي ثلاث خصائص لـ PageSet يمكننا استخدامها لتصفية مجموعة من الصفحات منها
// وثيقتنا لحفظها في مستند PDF الناتج بناءً على تكافؤ أرقام الصفحات الخاصة بها.
