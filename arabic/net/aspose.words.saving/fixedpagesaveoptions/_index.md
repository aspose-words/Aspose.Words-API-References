...
description: يحتوي على الخيارات الشائعة التي يمكن تحديدها عند حفظ مستند في تنسيقات صفحة ثابتة PDF  XPS  صور  إلخ ._ x000d_
type: docs
weight: 4760
...
يحتوي على الخيارات الشائعة التي يمكن تحديدها عند حفظ مستند في تنسيقات صفحة ثابتة (PDF ، XPS ، صور ، إلخ) ._ x000d_
