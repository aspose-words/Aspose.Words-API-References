...
description: اكتشف خيارات حفظ Aspose.Words.Saving.Xlsx لتحسين تحويل مستنداتك إلى Xlsx. استخدم خيارات الحفظ المتقدمة لتحقيق أفضل النتائج!
type: docs
weight: 6520
...
يمكن استخدامه لتحديد خيارات إضافية عند حفظ مستند فيXlsx تنسيق .
...
| [DateTimeParsingMode](../../aspose.words.saving/xlsxsaveoptions/datetimeparsingmode/) { get; set; } | يحصل على الوضع الذي يحدد كيفية تحليل نص المستند لتحديد قيم التاريخ والوقت أو يعينه. القيمة الافتراضية هيUseCurrentLocale . |
...
| override [SaveFormat](../../aspose.words.saving/xlsxsaveoptions/saveformat/) { get; set; } | يحدد التنسيق الذي سيتم حفظ المستند به إذا تم استخدام كائن خيارات الحفظ هذا. لا يمكن أن يكون إلاXlsx . |
| [SectionMode](../../aspose.words.saving/xlsxsaveoptions/sectionmode/) { get; set; } | يحصل على أو يحدد الطريقة التي يتم بها التعامل مع الأقسام عند الحفظ في مستند XLSX الناتج. القيمة الافتراضية هيMultipleWorksheets . |
