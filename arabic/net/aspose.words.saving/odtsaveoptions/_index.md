...
description: Aspose.Words.Saving.OdtSaveOptions فصل. يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفOdt أو Ott التنسيق .
type: docs
weight: 5050
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفOdt أو Ott التنسيق .
...
| اسم | وصف |
| --- | --- |
| [OdtSaveOptions](odtsaveoptions/#constructor)() | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقOdt التنسيق . |
| [OdtSaveOptions](odtsaveoptions/#constructor_1)(SaveFormat) | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقOdt أو Ott التنسيق . |
| [OdtSaveOptions](odtsaveoptions/#constructor_2)(string) | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقOdt format مشفر بكلمة مرور. |
