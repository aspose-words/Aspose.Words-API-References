...
description: اكتشف خاصية ShowPageBorder في HtmlFixedSaveOptions، وتحكم في حدود الصفحات بسهولة. حسّن مظهر مستندك بإعدادات قابلة للتخصيص.
type: docs
weight: 200
...
يحدد ما إذا كان يجب إظهار الحدود حول الصفحات. الافتراضي هو`حقيقي` .
