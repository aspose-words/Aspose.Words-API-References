...
description: تشير العلامة إلى ما إذا كان يجب وضع قواعد CSS  fontface في ملف منفصل fontFaces.css عندما يتم حفظ مستند مع ورقة أنماط خارجية أي عندماExportEmbeddedCssaspose.words.saving/htmlfixedsaveoptions/exportembeddedcss/ هوخاطئة  . القيمة الافتراضية هيخاطئة  جميع قواعد CSS مكتوبة في ملف واحد styles.css .
type: docs
weight: 160
