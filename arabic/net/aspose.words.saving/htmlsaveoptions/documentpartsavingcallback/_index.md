...
description: تحكم في حفظ أجزاء المستند باستخدام DocumentPartSavingCallback من HtmlSaveOptions. حسّن تصديرات HTML أو EPUB لتجربة مستخدم سلسة.
type: docs
weight: 70
...
يسمح بالتحكم في كيفية حفظ أجزاء المستند عند حفظ المستند بتنسيق HTML أو EPUB.
