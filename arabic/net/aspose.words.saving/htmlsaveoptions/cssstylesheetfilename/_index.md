...
description: يحدد المسار واسم ملف ورقة الأنماط المتتالية CSS المكتوب عند تصدير document إلى HTML. الافتراضي هو سلسلة فارغة.
type: docs
weight: 50
...
إذا تم تحديد مسار فقط ولكن لم يتم تحديد اسم ملف في هذه الخاصية ، فسيتم حفظ ملف CSS في المجلد المحدد x000d وسيكون له نفس اسم مستند HTML ولكن بامتداد ".css".
