...
description: تحكم في حفظ الصور باستخدام ImageSavingCallback من HtmlSaveOptions. حسّن تصدير المستندات إلى HTML أو MHTML أو EPUB لتجربة مستخدم سلسة.
type: docs
weight: 350
...
يسمح بالتحكم في كيفية حفظ الصور عند حفظ مستند بتنسيق HTML أو MHTML أو EPUB.
