...
description: HtmlSaveOptions ملكية. يسمح بالتحكم في كيفية حفظ الصور عند حفظ المستند بتنسيق HTML أو MHTML أو EPUB.
type: docs
weight: 360
...
يسمح بالتحكم في كيفية حفظ الصور عند حفظ المستند بتنسيق HTML أو MHTML أو EPUB.
