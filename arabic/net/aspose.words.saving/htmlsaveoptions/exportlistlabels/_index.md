...
description: HtmlSaveOptions ملكية. يتحكم في كيفية إخراج تسميات القوائم إلى HTML أو MHTML أو EPUB. القيمة الافتراضية هيAuto .
type: docs
weight: 200
...
يتحكم في كيفية إخراج تسميات القوائم إلى HTML أو MHTML أو EPUB. القيمة الافتراضية هيAuto .
