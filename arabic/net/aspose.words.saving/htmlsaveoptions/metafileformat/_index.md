...
description: يحدد التنسيق الذي يتم حفظ ملفات التعريف به عند التصدير إلى HTML أو MHTML أو EPUB. القيمة الافتراضية هيPng  مما يعني أنه يتم تقديم ملفات التعريف إلى صور PNG نقطية.
type: docs
weight: 390
