...
description: يحدد ما إذا كان يجب إخراج أحجام الخطوط بوحدات نسبية عند الحفظ بتنسيق HTML أو MHTML أو EPUB . الافتراضي هوخاطئة .
type: docs
weight: 240
