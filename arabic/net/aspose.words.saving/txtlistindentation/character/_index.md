...
description: TxtListIndentation Character ملكية. الحصول على أو تعيين الحرف الذي سيتم استخدامه لوضع مسافة بادئة على مستويات القائمة. القيمة الافتراضية هي 0 وهذا يعني عدم وجود مسافة بادئة في C#.
type: docs
weight: 20
