...
description: Aspose.Words.Saving.IImageSavingCallback واجهه المستخدم. قم بتنفيذ هذه الواجهة إذا كنت تريد التحكم في كيفية حفظ Aspose.Words الصور عند حفظ مستند إلى HTML. يمكن استخدامها بواسطة تنسيقات أخرى.
type: docs
weight: 4910
