...
description: اكتشف خاصية ImageSavingCallback في Aspose.Words، المصممة لتحسين معالجة الصور عند حفظها بتنسيق HTML. حسّن سير عملك اليوم!
type: docs
weight: 10
...
يتم استدعاؤها عندما يحفظ Aspose.Words صورة في HTML.
