...
description: يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفDoc أو x000d_Dot التنسيق ._ x000d_
type: docs
weight: 4670
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في ملفDoc أو x000d_Dot التنسيق ._ x000d_
...
| اسم | وصف |
| --- | --- |
| [DocSaveOptions](docsaveoptions#constructor)() | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقDoc التنسيق ._ x000d_ |
| [DocSaveOptions](docsaveoptions#constructor_1)(SaveFormat) | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقDoc أو x000d_Dot التنسيق ._ x000d_ |
...
| [AlwaysCompressMetafiles](../../aspose.words.saving/docsaveoptions/alwayscompressmetafiles) { get; set; } | متى`خاطئة` ، لا يتم ضغط ملفات التعريف الصغيرة لسبب الأداء. _ x000d_ القيمة الافتراضية هي **حقيقي** ، يتم ضغط كافة ملفات التعريف بغض النظر عن حجمها. |
...
| override [SaveFormat](../../aspose.words.saving/docsaveoptions/saveformat) { get; set; } | يحدد التنسيق الذي سيتم حفظ المستند به إذا تم استخدام كائن خيارات الحفظ هذا ._ x000d_ يمكن أن يكونDoc أوDot . |
