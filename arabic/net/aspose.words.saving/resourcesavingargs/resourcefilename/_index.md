...
description: الحصول على أو تحديد اسم الملف بدون مسار حيث سيتم حفظ المورد فيه.
type: docs
weight: 30
...
تتيح لك هذه الخاصية إعادة تعريف كيفية إنشاء أسماء ملفات المصدر_ x000d_ أثناء التصدير إلى صفحة ثابتة بتنسيق HTML أو SVG.
