...
[`ResourceSavingArgs`](../resourcesavingargs) يسمح بإعادة تعريف كيفية إنشاء أسماء ملفات الموارد أو التحايل تمامًا على حفظ الموارد في الملفات من خلال توفير كائنات الدفق الخاصة بك.
