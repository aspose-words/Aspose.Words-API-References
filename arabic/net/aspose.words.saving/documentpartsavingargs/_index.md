...
فصل[`DocumentPartSavingArgs`](./documentpartsavingargs/) يسمح لك بالتحكم في كيفية حفظ كل جزء من المستند. يسمح بإعادة تعريف كيفية إنشاء أسماء الملفات أو التحايل تمامًا على حفظ أجزاء المستند في ملفات من خلال توفير كائنات البث الخاصة بك.
