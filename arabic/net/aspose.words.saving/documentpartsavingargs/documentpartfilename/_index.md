...
description: الحصول على أو تحديد اسم الملف بدون مسار حيث سيتم حفظ جزء المستند فيه.
type: docs
weight: 20
...
تتيح لك هذه الخاصية إعادة تعريف كيفية إنشاء أسماء ملفات جزء المستند_ x000d_ أثناء التصدير إلى HTML أو EPUB.
