...
description: يحدد ما إذا كان يجب على Aspose.Words إبقاء الدفق مفتوحًا أو إغلاقه بعد حفظ الصورة.
type: docs
weight: 60
...
الافتراضي هو`خاطئة` و Aspose.Words ستغلق الدفق الذي قدمته في[`ImageStream`](../imagestream) الخاصية بعد كتابة صورة فيها ._ x000d_ حدد`حقيقي` لإبقاء الدفق مفتوحًا.
