...
description: OoxmlSaveOptions ملكية. يحدد التنسيق الذي سيتم حفظ المستند به إذا تم استخدام كائن خيارات الحفظ هذا . يمكن أن يكونDocx وDocm  Dotx وDotm أوFlatOpc .
type: docs
weight: 60
