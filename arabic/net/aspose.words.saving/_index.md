...
| [PdfSaveOptions](./pdfsaveoptions/) | يمكن استخدامه لتحديد خيارات إضافية عند حفظ مستند في ملفPdf التنسيق. |
...
| [ExportListLabels](./exportlistlabels/) | يحدد كيفية تصدير تسميات القائمة إلى HTML وMHTML وEPUB. |
