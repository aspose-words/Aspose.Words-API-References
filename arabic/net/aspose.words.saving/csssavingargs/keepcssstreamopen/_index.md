...
description: يحدد ما إذا كان يجب على Aspose.Words إبقاء الدفق مفتوحًا أو إغلاقه بعد حفظ معلومات CSS.
type: docs
weight: 40
...
الافتراضي هو`خاطئة` و Aspose.Words ستغلق الدفق الذي قدمته في[`CssStream`](../cssstream) الخاصية بعد كتابة معلومات CSS فيها ._ x000d_ حدد`حقيقي` لإبقاء الدفق مفتوحًا.
