...
description: يسمح بتحديد ما إذا كان سيتم تصدير CSS إلى ملف وتضمينه في مستند HTML. الافتراضي هوحقيقي . عندما تكون هذه الخاصيةخاطئة  لن يتم حفظ معلومات CSS في ملف CSS ولن يتم تضمينها في مستند HTML.
type: docs
weight: 30
