...
description: يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في XamlFlow أوXamlFlowPack التنسيق ._ x000d_
type: docs
weight: 5420
...
يمكن استخدامها لتحديد خيارات إضافية عند حفظ مستند في XamlFlow أوXamlFlowPack التنسيق ._ x000d_
...
| اسم | وصف |
| --- | --- |
| [XamlFlowSaveOptions](xamlflowsaveoptions#constructor)() | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقXamlFlow التنسيق ._ x000d_ |
| [XamlFlowSaveOptions](xamlflowsaveoptions#constructor_1)(SaveFormat) | يقوم بتهيئة مثيل جديد من هذه الفئة يمكن استخدامه لحفظ مستند بتنسيقXamlFlow أوXamlFlowPack التنسيق ._ x000d_ |
