...
"القراء القدامى" هم تطبيقات ما قبل Microsoft Word 97 وكذلك الدفتر . عندما يكون هذا الخيار`حقيقي` يكتب Aspose.Words كلمات رئيسية إضافية لـ RTF . تسمح هذه الكلمات الرئيسية بعرض المستند بشكل صحيح عند فتحه في تطبيق "قارئ قديم" _x000d ، ولكن يمكن أن يزيد حجم المستند بشكل ملحوظ.
