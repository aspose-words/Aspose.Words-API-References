...
description: قم بتنفيذ هذه الواجهة إذا كنت تريد التحكم في كيفية قيام Aspose.Words بحفظ الموارد الخارجية الصور والخطوط و css عند حفظ مستند إلى صفحة ثابتة بتنسيق HTML أو SVG.
type: docs
weight: 4930
