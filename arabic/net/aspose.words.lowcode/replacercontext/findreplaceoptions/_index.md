...
description: اكتشف خاصية FindReplaceOptions في ReplacerContext لتحسين وظيفة البحث والاستبدال باستخدام خيارات قابلة للتخصيص للحصول على نتائج أفضل.
type: docs
weight: 20
url: /ar/net/aspose.words.lowcode/replacercontext/findreplaceoptions/
---
