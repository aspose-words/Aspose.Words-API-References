...
description: قم بتعزيز سير عملك باستخدام معالجنا الذي يتعامل بكفاءة مع مستندات الإدخال لضمان معالجة سلسة وتحسين الإنتاجية.
type: docs
weight: 20
url: /ar/net/aspose.words.lowcode/processor/from/
---
...
إذا كان المعالج يقبل ملفًا واحدًا فقط كمدخل، فسيتم معالجة الملف المحدد الأخير فقط. [`Merger`](../../merger/) يقبل المعالج ملفات متعددة كمدخلات، ونتيجة لذلك سيتم دمج جميع المستندات المحددة. [`Converter`](../../converter/) يقبل المعالج ملفًا واحدًا فقط كمدخل، لذا سيتم تحويل الملف المحدد الأخير فقط.
