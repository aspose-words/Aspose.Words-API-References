...
description: قم بإنشاء تقارير قوية بكل سهولة باستخدام طريقة Create في ReportBuilder، المصممة لتبسيط عملية إنشاء التقارير لديك وتعزيز الإنتاجية.
type: docs
weight: 10
url: /ar/net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}

ينشئ مثيلًا جديدًا لمعالج إنشاء التقارير.
