...
description: اكتشف خاصية TextPosition ListLevel لتعديل موضع السطر الثاني بالنقاط بسهولة لتحسين تنسيق القائمة ووضوحها.
type: docs
weight: 130
...
يعيد أو يعين الموضع (بالنقاط) للسطر الثاني من النص الملتف لمستوى القائمة.
...
`TextPosition` يتوافق مع LeftIndent للفقرة.
