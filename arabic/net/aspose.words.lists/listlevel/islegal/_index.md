...
description: اكتشف ListLevel IsLegal. تحكّم في أنماط الأرقام الموروثة بسهولة. اختر اللغة العربية لمظهر عصري، أو حافظ على الأنماط الأصلية لإضفاء لمسة كلاسيكية.
type: docs
weight: 50
...
صحيح إذا قام المستوى بتحويل جميع الأرقام الموروثة إلى اللغة العربية، خطأ إذا حافظ على نمط أرقامها.
