...
description: ListLevel ملكية. تعيين أو إرجاع مستوى القائمة الذي يجب أن يظهر قبل أن يقوم مستوى القائمة المحدد بإعادة تشغيل الترقيم.
type: docs
weight: 100
...
تعيين أو إرجاع مستوى القائمة الذي يجب أن يظهر قبل أن يقوم مستوى القائمة المحدد بإعادة تشغيل الترقيم.
...
تعني القيمة -1 أن الترقيم سيستمر.
