...
description: يمكنك الوصول إلى مستويات القائمة بسهولة باستخدام خاصية ListLevelCollection Item. استرجع أي مستوى حسب الفهرس لتنسيق مستند سلس.
type: docs
weight: 20
...
يحصل على مستوى القائمة حسب الفهرس.
