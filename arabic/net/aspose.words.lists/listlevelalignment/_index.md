...
description: Aspose.Words.Lists.ListLevelAlignment تعداد. يحدد المحاذاة لرقم القائمة أو الرمز النقطي.
type: docs
weight: 3310
...
يحدد المحاذاة لرقم القائمة أو الرمز النقطي.
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Left | `0` | تمت محاذاة تسمية القائمة إلى يسار موضع الرقم. |
| Center | `1` | يتم توسيط تسمية القائمة في موضع الرقم. |
| Right | `2` | تمت محاذاة تسمية القائمة هذه إلى يمين موضع الرقم. |

### ملاحظات

تستخدم كقيمة لـ[`Alignment`](../listlevel/alignment/) منشأه.
