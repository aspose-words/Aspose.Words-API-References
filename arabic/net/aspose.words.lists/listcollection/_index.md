...
description: Aspose.Words.Lists.ListCollection فصل. يخزن ويدير تنسيق قوائم التعداد النقطي والرقمي المستخدمة في المستند.
type: docs
weight: 3270
...
القائمة في مستند Microsoft Word عبارة عن مجموعة من خصائص تنسيق القائمة. يتم تخزين تنسيق القوائم في`ListCollection` جمع بشكل منفصل من فقرات النص.

لا تقوم بإنشاء كائنات من هذه الفئة. هناك دائما واحد فقط`ListCollection` كائن لكل مستند ويمكن الوصول إليه عبر ملف[`Lists`](../../aspose.words/documentbase/lists/) منشأه.
