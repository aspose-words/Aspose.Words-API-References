...
description: إرجاع صحيح عندما تحتوي القائمة على 9 مستويات  خطأ عند المستوى الأول ._ x000d_
type: docs
weight: 40
...
إرجاع صحيح عندما تحتوي القائمة على 9 مستويات ؛ خطأ عند المستوى الأول ._ x000d_
...
يقوم Microsoft Word 2003 والإصدارات الأحدث دائمًا بإنشاء قوائم متعددة المستويات مع 9 مستويات ._ x000d_ لكن في بعض المستندات ، التي تم إنشاؤها باستخدام إصدارات سابقة من Microsoft Word ، قد تواجه قوائم تحتوي على مستوى واحد فقط.
