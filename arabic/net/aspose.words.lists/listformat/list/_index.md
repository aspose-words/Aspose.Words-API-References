...
description: الحصول على أو تعيين القائمة التي تكون هذه الفقرة عضوًا فيها.
type: docs
weight: 20
...
يؤدي تعيين هذه الخاصية إلى قيمة خالية إلى إزالة الرموز النقطية والترقيم من الفقرة وتعيين رقم مستوى القائمة على صفر. تعيين هذه الخاصية على قيمة خالية يكافئ_ x000d_ الاستدعاء[`RemoveNumbers`](../removenumbers).
