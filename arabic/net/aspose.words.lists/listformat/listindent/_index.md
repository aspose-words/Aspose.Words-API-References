...
description: قم بتعزيز بنية مستندك باستخدام طريقة ListFormat ListIndent، مما يؤدي إلى رفع مستوى قائمة فقراتك بسهولة لتحسين الوضوح.
type: docs
weight: 70
...
تقوم هذه الطريقة بتغيير مستوى القائمة وتطبيق خصائص التنسيق الخاصة بالمستوى الجديد.

في مستندات Word، قد تتكون القوائم من تسعة مستويات كحد أقصى. يُحدد تنسيق القائمة (x000d_) لكل مستوى النقطة أو الرقم المستخدم، والمسافة البادئة اليسرى، والمسافة بين النقطة والنص، إلخ.
