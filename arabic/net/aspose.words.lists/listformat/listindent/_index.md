...
description: زيادة مستوى قائمة الفقرة الحالية بمقدار مستوى واحد.
type: docs
weight: 70
...
في مستندات Word ، قد تتكون القوائم من تسعة مستويات كحد أقصى. يحدد تنسيق القائمة x000d_ لكل مستوى التعداد النقطي أو الرقم المستخدم ، والمسافة البادئة اليسرى ، والمسافة بين الرمز النقطي والنص ، إلخ.
