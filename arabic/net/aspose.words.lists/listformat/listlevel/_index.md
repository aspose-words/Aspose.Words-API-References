...
description: ListFormat ملكية. إرجاع تنسيق مستوى القائمة بالإضافة إلى أي تجاوزات تنسيق مطبقة على الفقرة الحالية.
type: docs
weight: 30
...
إرجاع تنسيق مستوى القائمة بالإضافة إلى أي تجاوزات تنسيق مطبقة على الفقرة الحالية.
