...
description: ListFormat طريقة. يبدأ قائمة مرقمة افتراضية جديدة ويطبقها على الفقرة.
type: docs
weight: 60
...
هذه طريقة مختصرة تنشئ قائمة جديدة باستخدام القالب الافتراضي numbered ، ويطبقها على الفقرة ويختار مستوى القائمة الأول.
