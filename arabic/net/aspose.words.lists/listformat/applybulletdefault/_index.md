...
description: اكتشف كيفية استخدام طريقة ApplyBulletDefault لإنشاء قوائم نقطية أنيقة بسهولة في مستنداتك، مما يعزز قابلية القراءة والتنظيم.
type: docs
weight: 50
...
هذه طريقة اختصار تقوم بإنشاء قائمة جديدة باستخدام قالب bulleted الافتراضي، وتطبقه على الفقرة وتحدد مستوى القائمة الأول.
