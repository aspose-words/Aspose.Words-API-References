...
باستخدام هذا التحميل الزائد ، يمكنك الرجوع إلى أعضاء مصدر البيانات وكائن مصدر البيانات نفسه في القالب. إذا كنت لا تنوي الرجوع إلى كائن مصدر البيانات نفسه ، فيمكنك حذفه*dataSourceName* تمرير فارغ أو استخدام[`BuildReport`](../buildreport) الزائد ._ x000d_
