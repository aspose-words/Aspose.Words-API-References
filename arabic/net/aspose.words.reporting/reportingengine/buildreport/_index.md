...
description: ReportingEngine طريقة. يملأ مستند النموذج المحدد بالبيانات من المصدر المحدد مما يجعله تقريرًا جاهزًا.
type: docs
weight: 40
...
باستخدام هذا التحميل الزائد ، يمكنك الرجوع إلى أعضاء مصدر البيانات في مستند القالب ، ولكن لا يمكنك الإشارة إلى كائن مصدر البيانات نفسه. يجب عليك استخدام ملف`BuildReport` الزائد لتحقيق ذلك.
...
باستخدام هذا التحميل الزائد ، يمكنك الرجوع إلى أعضاء مصدر البيانات وكائن مصدر البيانات نفسه في القالب. إذا كنت لا تنوي الرجوع إلى كائن مصدر البيانات نفسه ، فيمكنك حذفه*dataSourceName* تمرير فارغ أو استخدام`BuildReport` الزائد .
...
إذا كنت ستستخدم مصدر بيانات واحدًا ، ففكر في استخدام`BuildReport` و`BuildReport` الزائدة بدلا من ذلك.
