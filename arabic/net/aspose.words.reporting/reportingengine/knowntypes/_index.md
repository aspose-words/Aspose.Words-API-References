...
description: يحصل على مجموعة غير مرتبة أي مجموعة من العناصر الفريدة تحتوي علىTypeكائنات التي يمكن استخدامها بأسماء مؤهلة كليًا أو جزئيًا ضمن قوالب التقارير التي تتم معالجتها بواسطة مثيل المحرك هذا لاستدعاء الأعضاء الساكنين للأنواع المقابلة  وأداء مجموعات النوع  إلخ.
type: docs
weight: 20
