...
في مستندات النموذج ، أ[`CsvDataSource`](../csvdatasource) يجب معاملة المثيل بنفس الطريقة كما لو كان aDataTable مثيل. لمزيد من المعلومات ، راجع مرجع بناء الجملة (https://docs.aspose.com/display/wordsnet/Template+Syntax).
