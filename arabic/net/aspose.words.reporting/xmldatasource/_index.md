...
في مستندات النموذج ، إذا كان عنصر XML عالي المستوى يحتوي فقط على قائمة من العناصر من نفس النوع ، [`XmlDataSource`](./xmldatasource/) يجب معاملة المثيل بنفس الطريقة كما لو كان أDataTable مثيل. خلاف ذلك ، فإن ملف[`XmlDataSource`](./xmldatasource/) يجب معاملة المثيل بنفس الطريقة كما لو كان أDataRow مثيل. لمزيد من المعلومات ، راجع مرجع بناء الجملة (https://docs.aspose.com/display/wordsnet/Template+Syntax).
