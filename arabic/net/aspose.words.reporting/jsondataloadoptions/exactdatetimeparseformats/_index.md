...
description: الحصول على أو تعيين تنسيقات دقيقة لتحليل قيم JSON للتاريخ والوقت أثناء تحميل JSON. الافتراضي هو لا شيء .
type: docs
weight: 30
...
* متى`ExactDateTimeParseFormats` هو **لا شيء** ، يتم استخدام تنسيق ISO-8601 وجميع تنسيقات التاريخ والوقت المدعومة للثقافات الحالية والإنجليزية في الولايات المتحدة الأمريكية والإنجليزية في نيوزيلندا بالإضافة إلى ذلك في الترتيب المذكور ._ x000d_
* متى`ExactDateTimeParseFormats` يحتوي على سلاسل ، يتم استخدامها كتنسيقات إضافية للتاريخ والوقت_ x000d_ باستخدام الثقافة الحالية.
