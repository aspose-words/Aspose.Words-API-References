...
| اسم | قيمة | وصف |
| --- | --- | --- |
| None | `0` | تحديد الخيارات الافتراضية ._ x000d_ |
...
| UseLegacyHeaderFooterVisiting | `8` | يحدد أن المحرك يجب أن يزور العقد الفرعية للقسم (الرؤوس والتذييلات والنصوص) بترتيب_ x000d_ متوافق مع إصدارات Aspose.Words السابقة 21.9. |
