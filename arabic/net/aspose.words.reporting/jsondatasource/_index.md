...
description: يوفر الوصول إلى بيانات ملف JSON أو دفق لاستخدامه في تقرير .
type: docs
weight: 4430
...
في مستندات النموذج ، إذا كان عنصر JSON ذو المستوى الأعلى عبارة عن مصفوفة ، أ[`JsonDataSource`](../jsondatasource) يجب معاملة المثال be بنفس الطريقة كما لو كان ملفDataTable مثيل. إذا كان عنصر JSON عالي المستوى كائنًا ، فإن ملف[`JsonDataSource`](../jsondatasource) يجب معاملة المثيل بنفس الطريقة كما لو كان أDataRow مثيل. لمزيد من المعلومات ، راجع مرجع بناء الجملة (https://docs.aspose.com/display/wordsnet/Template+Syntax).
