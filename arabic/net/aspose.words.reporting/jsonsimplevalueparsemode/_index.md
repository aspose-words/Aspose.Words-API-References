...
description: Aspose.Words.Reporting.JsonSimpleValueParseMode تعداد. يحدد وضعًا لتحليل قيم JSON البسيطة فارغ  منطقي  رقم  عدد صحيح  وسلسلة أثناء تحميل JSON. مثل هذا الوضع لا يؤثر على تحليل قيم التاريخ والوقت.
type: docs
weight: 4440
