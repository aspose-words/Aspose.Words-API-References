...
description: اكتشف ميزة CustomXmlProperty Value لإدارة سمات XML المخصصة وخصائص العلامة الذكية بسهولة لتحسين التحكم في البيانات.
type: docs
weight: 40
url: /ar/net/aspose.words.markup/customxmlproperty/value/
---
## CustomXmlProperty.Value property

يحصل على قيمة سمة XML المخصصة أو خاصية العلامة الذكية أو يعينها.
