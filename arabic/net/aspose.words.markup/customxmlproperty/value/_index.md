...
description: CustomXmlProperty Value ملكية. الحصول على قيمة سمة XML المخصصة أو خاصية العلامة الذكية أو تعيينها في C#.
type: docs
weight: 40
...
الحصول على قيمة سمة XML المخصصة أو خاصية العلامة الذكية أو تعيينها.
