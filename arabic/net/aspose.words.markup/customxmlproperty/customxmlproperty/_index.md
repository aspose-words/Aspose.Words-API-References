...
description: اكتشف مُنشئ CustomXmlProperty. أنشئ وفعّل مثيلات جديدة بسهولة لإدارة خصائص XML بسلاسة في مشاريعك.
type: docs
weight: 10
...
| uri | String | عنوان URI لمساحة اسم الخاصية. لا يمكن`باطل`. |
