...
description: CustomXmlProperty ملكية. الحصول على أو تحديد URI لمساحة الاسم لسمة XML المخصصة أو خاصية العلامة الذكية.
type: docs
weight: 30
...
الحصول على أو تحديد URI لمساحة الاسم لسمة XML المخصصة أو خاصية العلامة الذكية.
