...
description: ال Aspose.Words.Markup تحتوي مساحة الاسم على الفئات التي_ x000d_ تمثل دلالات يحددها العميل في مستند العلامات الذكية و XML المخصص و_ x000d_ علامات المستندات المنظمة عناصر التحكم في المحتوى.
type: docs
weight: 150
url: /ar/net/aspose.words.markup/
---
ال **Aspose.Words.Markup** تحتوي مساحة الاسم على الفئات التي_ x000d_ تمثل دلالات يحددها العميل في مستند: العلامات الذكية و XML المخصص و_ x000d_ علامات المستندات المنظمة (عناصر التحكم في المحتوى).
...
| [CustomPartCollection](./custompartcollection) | يمثل مجموعة من[`CustomPart`](../aspose.words.markup/custompart) الكائنات ._ x000d_ |
| [CustomXmlPart](./customxmlpart) | يمثل جزء تخزين بيانات XML مخصص (بيانات XML مخصصة داخل حزمة) ._ x000d_ |
| [CustomXmlPartCollection](./customxmlpartcollection) | يمثل مجموعة من أجزاء XML المخصصة. العناصر[`CustomXmlPart`](../aspose.words.markup/customxmlpart) الكائنات ._ x000d_ |
...
| [SmartTag](./smarttag) | يحدد هذا العنصر وجود علامة ذكية حول واحد أو أكثر من الهياكل المضمنة_ x000d_ (عمليات التشغيل ، الصور ، الحقول ، إلخ) داخل فقرة. |
