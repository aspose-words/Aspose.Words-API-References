...
description: Aspose.Words.Markup.SdtListItemCollection فصل. يوفر الوصول إلى ملفاتSdtListItemعناصر علامة مستند منظم.
type: docs
weight: 3790
...
يوفر الوصول إلى ملفات[`SdtListItem`](../sdtlistitem/)عناصر علامة مستند منظم.
...
| اسم | وصف |
| --- | --- |
| [Count](../../aspose.words.markup/sdtlistitemcollection/count/) { get; } | الحصول على عدد العناصر في المجموعة. |
| [Item](../../aspose.words.markup/sdtlistitemcollection/item/) { get; } | إرجاع أ[`SdtListItem`](../sdtlistitem/) كائن نظرًا لمؤشره الصفري في المجموعة. |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.words.markup/sdtlistitemcollection/add/)(SdtListItem) | يضيف عنصرًا إلى هذه المجموعة . |
| [Clear](../../aspose.words.markup/sdtlistitemcollection/clear/)() | مسح كافة العناصر من هذه المجموعة. |
| [GetEnumerator](../../aspose.words.markup/sdtlistitemcollection/getenumerator/)() | إرجاع كائن العداد الذي يمكن استخدامه للتكرار على كافة العناصر في المجموعة. |
| [RemoveAt](../../aspose.words.markup/sdtlistitemcollection/removeat/)(int) | يزيل عنصر قائمة في الفهرس المحدد. |
