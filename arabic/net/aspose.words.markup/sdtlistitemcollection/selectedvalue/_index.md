...
description: اكتشف خاصية SelectedValue في SdtListItemCollection، التي تُحدد التحديد الحالي في قائمتك، مع السماح بـ null لعدم وجود تحديد. حسّن إدارة بياناتك!
type: docs
weight: 30
