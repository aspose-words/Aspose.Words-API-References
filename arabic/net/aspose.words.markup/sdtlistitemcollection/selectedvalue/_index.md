...
description: SdtListItemCollection ملكية. يحدد القيمة المحددة حاليًا في هذه القائمة. القيمة الفارغة مسموح بها  مما يعني أنه لا يوجد إدخال محدد حاليًا مرتبط بمجموعة عناصر القائمة هذه.
type: docs
weight: 30
...
يحدد القيمة المحددة حاليًا في هذه القائمة. القيمة الفارغة مسموح بها ، مما يعني أنه لا يوجد إدخال محدد حاليًا مرتبط بمجموعة عناصر القائمة هذه.
