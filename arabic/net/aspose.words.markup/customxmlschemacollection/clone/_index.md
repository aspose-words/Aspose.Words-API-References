...
description: انسخ مجموعة CustomXmlSchemaCollection الخاصة بك بسهولة باستخدام طريقة الاستنساخ لدينا لتجربة نسخ عميقة سلسة. حسّن إدارة XML لديك اليوم!
type: docs
weight: 50
...
يصنع استنساخًا عميقًا لهذا الكائن.
