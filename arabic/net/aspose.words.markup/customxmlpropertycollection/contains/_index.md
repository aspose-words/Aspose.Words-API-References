...
description: CustomXmlPropertyCollection طريقة. لتحديد ما إذا كانت المجموعة تحتوي على خاصية بالاسم المحدد.
type: docs
weight: 50
...
لتحديد ما إذا كانت المجموعة تحتوي على خاصية بالاسم المحدد.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| name | String | اسم حساس لحالة الأحرف للخاصية المراد تحديد موقعها. |
