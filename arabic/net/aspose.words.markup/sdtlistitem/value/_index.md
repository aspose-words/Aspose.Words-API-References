...
description: اكتشف خاصية SdtListItem Value للوصول بسهولة إلى قيم عناصر القائمة وإدارتها لتحسين التعامل مع البيانات في تطبيقاتك.
type: docs
weight: 30
...
يحصل على قيمة عنصر القائمة هذا.
