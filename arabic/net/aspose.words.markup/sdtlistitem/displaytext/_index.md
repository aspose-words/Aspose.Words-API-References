...
description: SdtListItem ملكية. الحصول على النص الذي سيتم عرضه في محتوى التشغيل بدلاً من ملفValue محتويات السمة لعنصر القائمة هذا.
type: docs
weight: 20
...
الحصول على النص الذي سيتم عرضه في محتوى التشغيل بدلاً من ملف[`Value`](../value/) محتويات السمة لعنصر القائمة هذا.
