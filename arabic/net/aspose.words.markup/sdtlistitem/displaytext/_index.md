...
description: اكتشف كيف تعمل خاصية SdtListItem DisplayText على تحسين المحتوى الخاص بك عن طريق تخصيص النص المعروض وتحسين تفاعل المستخدم والوضوح.
type: docs
weight: 20
...
يحصل على النص الذي سيتم عرضه في محتوى التشغيل بدلاً من[`Value`](../value/) محتويات السمة لهذا العنصر من القائمة.
