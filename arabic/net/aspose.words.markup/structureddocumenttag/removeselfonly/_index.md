...
description: StructuredDocumentTag طريقة. يزيل فقط عقدة SDT نفسها  ولكن يحتفظ بمحتواها داخل شجرة المستند.
type: docs
weight: 340
...
يزيل فقط عقدة SDT نفسها ، ولكن يحتفظ بمحتواها داخل شجرة المستند.
