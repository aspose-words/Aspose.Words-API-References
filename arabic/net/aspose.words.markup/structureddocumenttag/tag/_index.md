...
description: اكتشف خاصية StructuredDocumentTag التي تحدد العلامات الأساسية لعقد SDT، مما يضمن إدارة المستندات وتنظيمها بكفاءة.
type: docs
weight: 280
...
يحدد علامة مرتبطة بعقدة SDT الحالية. لا يمكن`باطل` .
...
العلامة عبارة عن سلسلة عشوائية يمكن للتطبيقات ربطها بـ SDT من أجل تحديدها دون توفير اسم ودود مرئي.
