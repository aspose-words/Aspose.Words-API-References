...
description: اكتشف خاصية EndCharacterFont في StructuredDocumentTags لتحسين تنسيق النص. حسّن الحرف الأخير من مستندك باستخدام خطوط مخصصة!
type: docs
weight: 120
...
تنسيق الخط الذي سيتم تطبيقه على آخر حرف من النص المدخل**SDT** .
