...
description: اكتشف خاصية StructuredDocumentTag ListItems، التي توفر سهولة الوصول إلى SdtListItemCollection لتحسين إدارة المستندات وتنظيمها.
type: docs
weight: 180
...
يحصل[`SdtListItemCollection`](../../sdtlistitemcollection/) مرتبط بهذا**SDT** .
...
سيتم الوصول إلى هذه الخاصية فقط لـComboBox أوDropDownList أنواع SDT.
