...
description: StructuredDocumentTag ملكية. تنسيق الخط الذي سيتم تطبيقه على النص الذي تم إدخاله فيه المعاملة الخاصة والتفضيلية .
type: docs
weight: 80
...
تنسيق الخط الذي سيتم تطبيقه على النص الذي تم إدخاله فيه **المعاملة الخاصة والتفضيلية** .
