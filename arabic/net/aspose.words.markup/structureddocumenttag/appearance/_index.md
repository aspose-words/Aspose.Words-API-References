...
description: اكتشف خاصية مظهر StructuredDocumentTag لتخصيص وتعزيز النمط المرئي لعلامات المستند المنظم لديك بسهولة.
type: docs
weight: 20
...
يحصل على/يحدد مظهر علامة المستند المنظمة.
