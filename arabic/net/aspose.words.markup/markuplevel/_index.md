...
description: يحدد المستوى في شجرة الوثيقة حيث يوجدStructuredDocumentTag./structureddocumenttag يمكن أن يحدث.
type: docs
weight: 3740
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Unknown | `0` | يحدد القيمة غير المعروفة أو غير الصالحة ._ x000d_ |
| Inline | `1` | يظهر العنصر على المستوى المضمن (على سبيل المثال بين عمليات تشغيل النص) ._ x000d_ |
| Block | `2` | يظهر العنصر على مستوى الكتلة (على سبيل المثال بين الجداول والفقرات) ._ x000d_ |
| Row | `3` | يظهر العنصر بين صفوف في جدول . |
| Cell | `4` | يظهر العنصر بين الخلايا المتتالية ._ x000d_ |
