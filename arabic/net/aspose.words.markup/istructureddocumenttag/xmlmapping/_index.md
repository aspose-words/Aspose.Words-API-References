...
description: اكتشف كيف تقوم خاصية IStructuredDocumentTag XmlMapping بربط العلامات المنظمة ببيانات XML، مما يعزز تخصيص المستندات وتكاملها.
type: docs
weight: 160
...
يمكنك استخدام[`SetMapping`](../../xmlmapping/setmapping/)طريقة هذا الكائن لربط علامة مستند منظمة ببيانات XML.
