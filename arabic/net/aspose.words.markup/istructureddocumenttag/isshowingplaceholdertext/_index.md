...
description: IStructuredDocumentTag ملكية. يحدد ما إذا كان محتوى هذا المعاملة الخاصة والتفضيلية يجب أن يتم تفسيره على أنه يحتوي على عنصر نائب text على عكس محتويات النص العادي داخل SDT.
type: docs
weight: 30
