...
description: اكتشف خاصية IStructuredDocumentTag التي تحدد علامة فريدة لعقدة SDT الخاصة بك، مما يعمل على تحسين بنية المستند وضمان الوضوح.
type: docs
weight: 130
...
يحدد علامة مرتبطة بعقدة SDT الحالية. لا يمكن أن تكون فارغة.
