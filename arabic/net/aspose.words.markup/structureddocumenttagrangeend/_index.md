...
description: Aspose.Words.Markup.StructuredDocumentTagRangeEnd فصل. يمثل نهاية تراوحت علامة المستند المهيكلة التي تقبل المحتوى متعدد الأقسام. راجع أيضًاStructuredDocumentTagRangeStart العقدة .
type: docs
weight: 3840
