...
description: تحديد معرف رقمي فريد ومستمر للقراءة فقط لهذا الغرض StructuredDocumentTagRange node. المقابلةStructuredDocumentTagRangeStartaspose.words.markup/structureddocumenttagrangestart العقدة لها نفس الشيءIdaspose.words.markup/structureddocumenttagrangestart/id .
type: docs
weight: 20
