...
description: يمكنك بسهولة تكرار CustomXmlPartCollection الخاص بك باستخدام طريقة Clone الخاصة بنا، مما يضمن الحصول على نسخة عميقة كاملة لجميع العناصر لإدارة البيانات بسلاسة.
type: docs
weight: 60
