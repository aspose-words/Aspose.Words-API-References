...
description: CustomXmlPartCollection طريقة. البحث عن جزء XML المخصص وإرجاعه بواسطة معرفه.
type: docs
weight: 70
...
البحث عن جزء XML المخصص وإرجاعه بواسطة معرفه.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| id | String | سلسلة حساسة لحالة الأحرف تحدد جزء XML المخصص. |

### قيمة الإرجاع

عائدات`لا شيء` إذا لم يتم العثور على جزء XML مخصص بالمعرف المحدد.
