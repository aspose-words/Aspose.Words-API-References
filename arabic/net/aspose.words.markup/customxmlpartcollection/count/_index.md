...
description: اكتشف خاصية Count الخاصة بـ CustomXmlPartCollection لاسترداد العدد الإجمالي للعناصر في مجموعة XML الخاصة بك بسهولة لتحسين إدارة البيانات.
type: docs
weight: 20
url: /ar/net/aspose.words.markup/customxmlpartcollection/count/
---
