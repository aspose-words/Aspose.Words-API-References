...
| اسم | وصف |
| --- | --- |
| [Clone](../../aspose.words.markup/custompart/clone)() | عمل نسخة "عميقة بدرجة كافية" من الكائن. لا يكرر بايتات ملف[`Data`](./data) القيمة ._ x000d_ |

### ملاحظات

تمثل هذه الفئة جزء OOXML الذي يعد هدفًا لـ "علاقة غير معروفة". _ x000d_ تعتبر جميع العلاقات غير المحددة في ISO / IEC 29500 "علاقات غير معروفة" ._ x000d_ العلاقات غير المعروفة مسموح بها ضمن مستند Office Open XML بشرط أن تكون متوافقة إلى إرشادات ترميز العلاقة.
