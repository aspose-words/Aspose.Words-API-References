...
description: اكتشف طريقة CustomPart Clone لإنشاء نسخ عميقة وفعالة من الكائنات دون تكرار بايتات البيانات. حسّن عملية البرمجة لديك اليوم!
type: docs
weight: 70
...
يقوم بعمل نسخة "عميقة بدرجة كافية" من الكائن. لا يقوم بتكرار بايتات الكائن[`Data`](../data/) القيمة.
