...
description: XmlMapping ملكية. إرجاع تعبير XPath  الذي تم تقييمه للعثور على XML node المخصص الذي تم تعيينه إلى علامة المستند المهيكلة الأصل.
type: docs
weight: 50
...
إرجاع تعبير XPath ، الذي تم تقييمه للعثور على XML node المخصص الذي تم تعيينه إلى علامة المستند المهيكلة الأصل.
