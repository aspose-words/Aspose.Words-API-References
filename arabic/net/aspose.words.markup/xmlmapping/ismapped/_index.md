...
description: XmlMapping ملكية. عوائد حقيقي إذا تم تعيين علامة المستند المهيكل الأصلي بنجاح إلى بيانات XML.
type: docs
weight: 20
...
عوائد **حقيقي** إذا تم تعيين علامة المستند المهيكل الأصلي بنجاح إلى بيانات XML.
