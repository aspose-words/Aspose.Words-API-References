...
description: اكتشف خاصية ThemeColors FollowedHyperlink لتخصيص لون الرابط التشعبي الذي تنقر عليه، مما يعزز المظهر المرئي لموقع الويب الخاص بك وتجربة المستخدم.
type: docs
weight: 90
...
يحدد اللون للرابط التشعبي الذي تم النقر عليه.
