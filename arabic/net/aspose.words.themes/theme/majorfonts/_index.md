...
description: خصّص أسلوب الطباعة في موقعك مع MajorFonts. حدّد خطوطًا متنوعة بسهولة للغات متعددة لتحسين سهولة القراءة وتجربة المستخدم.
type: docs
weight: 30
...
يسمح بتحديد مجموعة الخطوط الرئيسية للغات مختلفة.
