...
description: خصّص أسلوب الطباعة في موقعك باستخدام MinorFonts. حدّد بسهولة خطوطًا فريدة لمختلف اللغات لتحسين تجربة المستخدم وتفاعله.
type: docs
weight: 40
url: /ar/net/aspose.words.themes/theme/minorfonts/
---
## Theme.MinorFonts property

يسمح بتحديد مجموعة الخطوط الثانوية للغات مختلفة.
