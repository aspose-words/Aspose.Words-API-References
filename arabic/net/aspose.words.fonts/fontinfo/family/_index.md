...
description: اكتشف خاصية FontInfo Family لإدارة وتخصيص إعدادات عائلة الخطوط الخاصة بك بسهولة لتحسين مرونة التصميم والأسلوب.
type: docs
weight: 40
...
يحصل على عائلة الخطوط التي ينتمي إليها هذا الخط أو يعينها.
