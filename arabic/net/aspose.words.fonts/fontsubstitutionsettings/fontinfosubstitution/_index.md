...
description: اكتشف كيف تعمل FontSubstitutionSettings على تعزيز أسلوب الطباعة لديك باستخدام قواعد معلومات الخط القابلة للتخصيص لتحسين التصميم وسهولة القراءة.
type: docs
weight: 30
