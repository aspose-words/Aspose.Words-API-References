...
description: اكتشف خاصية "FollowbackSettings" في FontSettings لتحسين آليات الرجوع إلى الخلف للخطوط. حسّن تصميمك مع عرض نص سلس!
type: docs
weight: 30
...
الإعدادات المتعلقة بآلية الرجوع إلى الخط.
