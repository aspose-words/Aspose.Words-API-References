...
القيمة التي تم إرجاعها هي نسخة من البيانات التي يستخدمها Aspose.Words. إذا قمت بتغيير الإدخالات في المصفوفة التي تم إرجاعها ، فلن يكون لها أي تأثير على عرض المستند. لتحديد مصادر خط جديدة_ x000d_ استخدم ملف[`SetFontsSources`](../setfontssources) طريقة.
