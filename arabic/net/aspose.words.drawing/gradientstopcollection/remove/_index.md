...
description: GradientStopCollection طريقة. يزيل ملفGradientStop من المجموعة.
type: docs
weight: 60
...
يزيل ملف[`GradientStop`](../../gradientstop/) من المجموعة.
...
صحيح إذا تمت إزالة توقف التدرج اللوني بنجاح ، وإلا فهو خطأ.
