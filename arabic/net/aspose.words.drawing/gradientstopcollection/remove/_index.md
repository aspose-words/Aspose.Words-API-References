...
description: احذف GradientStop محددًا من مجموعتك بسهولة باستخدام طريقة GradientStopCollection Remove. بسّط عملية تصميمك اليوم!
type: docs
weight: 60
...
يزيل محددًا[`GradientStop`](../../gradientstop/) من المجموعة.
