...
description: GradientStopCollection RemoveAt طريقة. يزيل أGradientStop من المجموعة في فهرس محدد في C#.
type: docs
weight: 70
...
يزيل أ[`GradientStop`](../../gradientstop/) من المجموعة في فهرس محدد.
...
إزالة[`GradientStop`](../../gradientstop/).
