...
description: أضف GradientStop إلى مجموعتك بسهولة باستخدام طريقة إدراج GradientStopCollection. حسّن انتقالات ألوانك بسلاسة!
type: docs
weight: 50
...
يُدرج[`GradientStop`](../../gradientstop/) إلى المجموعة عند فهرس محدد.
