...
description: اضبط سطوع صورتك باستخدام خاصية سطوع ImageData. اضبط القيم من 0.0 (الأقل سطوعًا) إلى 1.0 (الأعلى سطوعًا) للحصول على أفضل تأثير بصري.
type: docs
weight: 30
...
يحصل على سطوع الصورة أو يضبطه. يجب أن تكون قيمة هذه الخاصية رقمًا من 0.0 (الأقل سطوعًا) إلى 1.0 (الأكثر سطوعًا).
