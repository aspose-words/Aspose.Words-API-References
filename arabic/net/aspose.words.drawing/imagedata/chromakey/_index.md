...
description: ImageData ChromaKey ملكية. يحدد قيمة اللون للصورة التي سيتم التعامل معها على أنها شفافة في C#.
type: docs
weight: 40
...
يحدد قيمة اللون للصورة التي سيتم التعامل معها على أنها شفافة.
