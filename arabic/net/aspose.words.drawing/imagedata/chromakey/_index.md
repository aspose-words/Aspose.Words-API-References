...
description: اكتشف خاصية ImageData ChromaKey، حدّد ألوانًا شفافة لصورك، وحسّن تأثيراتها البصرية بسهولة. أطلق العنان لإبداعاتك!
type: docs
weight: 40
url: /ar/net/aspose.words.drawing/imagedata/chromakey/
---
## ImageData.ChromaKey property

يحدد قيمة لون الصورة التي سيتم التعامل معها على أنها شفافة.
