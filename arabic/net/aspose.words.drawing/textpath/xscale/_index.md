...
description: اكتشف كيف تعمل خاصية TextPath XScale على تعزيز تصميمك من خلال تمكين مسارات نصية مستقيمة للحصول على تخطيطات أكثر سلاسة ودقة.
type: docs
weight: 200
...
لو`حقيقي`، يمتد النص على طول المسار من اليسار إلى اليمين على طول قيمة x لـ الحد السفلي للشكل.
