...
description: يحدد ما إذا كان سيتم استخدام مسار نص مستقيم بدلاً من مسار الشكل.
type: docs
weight: 200
...
إذا **حقيقي**، يتم تشغيل النص على طول مسار من اليسار إلى اليمين على طول قيمة x لـ الحد السفلي للشكل.
