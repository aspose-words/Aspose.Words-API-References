...
description: اكتشف خاصية TextPath SameLetterHeights لضمان ارتفاع موحد للحرف، وتحسين قابلية قراءة النص وتناسق التصميم عبر مشروعك.
type: docs
weight: 100
...
يحدد ما إذا كانت جميع الأحرف ستكون بنفس الارتفاع بغض النظر عن الحالة الأولية.
