...
description: اكتشف كيف يعمل TextPath FitPath على تعزيز تصميمك من خلال ضمان أن النص يتبع أي شكل بسلاسة، مما يخلق تأثيرات بصرية مذهلة.
type: docs
weight: 20
url: /ar/net/aspose.words.drawing/textpath/fitpath/
---
## TextPath.FitPath property

يحدد ما إذا كان النص يناسب مسار الشكل.
