...
description: اكتشف خاصية TextPath Trim لتحسين تصميمك عن طريق إزالة المساحة غير المرغوب فيها أعلى وأسفل النص للحصول على مظهر أنظف وأكثر أناقة.
type: docs
weight: 180
url: /ar/net/aspose.words.drawing/textpath/trim/
---
## TextPath.Trim property

يحدد ما إذا كان سيتم إزالة المساحة الزائدة أعلى وأسفل النص.
