...
description: TextPath ملكية. لتحديد ما إذا كانت المساحة الزائدة ستتم إزالتها أعلى النص وأسفله.
type: docs
weight: 180
...
لتحديد ما إذا كانت المساحة الزائدة ستتم إزالتها أعلى النص وأسفله.
