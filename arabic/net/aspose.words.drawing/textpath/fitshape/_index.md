...
description: اكتشف كيف تضمن خاصية TextPath FitShape أن يتناسب النص الخاص بك بشكل مثالي مع مربع محيط الشكل لتحسين مرونة التصميم.
type: docs
weight: 30
url: /ar/net/aspose.words.drawing/textpath/fitshape/
---
## TextPath.FitShape property

يحدد ما إذا كان النص يتناسب مع المربع المحيط بالشكل.
