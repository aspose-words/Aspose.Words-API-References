...
description: اكتشف خاصية Kerning في TextPath لتحسين الطباعة من خلال التحكم في إعدادات Kerning لتحسين قابلية قراءة النص وجودة التصميم.
type: docs
weight: 60
...
يحدد ما إذا كان التباعد بين الأحرف قيد التشغيل.
