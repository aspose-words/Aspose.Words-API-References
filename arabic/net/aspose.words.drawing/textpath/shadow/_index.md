...
description: اكتشف كيف تعمل خاصية الظل في TextPath على تعزيز النص الخاص بك باستخدام الظلال القابلة للتخصيص للحصول على تأثيرات بصرية مذهلة على تصميماتك.
type: docs
weight: 110
url: /ar/net/aspose.words.drawing/textpath/shadow/
---
## TextPath.Shadow property

يحدد ما إذا كان سيتم تطبيق الظل على النص الموجود في مسار النص.
