...
description: اكتشف تباعد مسار النص. تحكم في تباعد النصوص بسهولة. حسّن سهولة القراءة بتعديلات دقيقة - 1 = 100 لمحاذاة مثالية!
type: docs
weight: 140
...
يحدد مقدار المسافة بين السطور للنص. 1 يعني 100%.
