...
description: TextPath ملكية. لتحديد ما إذا كان ترتيب تخطيط الصفوف معكوسًا.
type: docs
weight: 80
...
لتحديد ما إذا كان ترتيب تخطيط الصفوف معكوسًا.
...
إذا **حقيقي**، يتم عكس ترتيب تخطيط الصفوف. تُستخدم هذه السمة لتخطيط النص العمودي.
