...
description: اكتشف خاصية TextPath ReverseRows لتحسين تخطيطك. تحكم في ترتيب الصفوف لتحسين مرونة التصميم وتجربة المستخدم.
type: docs
weight: 80
...
يحدد ما إذا كان ترتيب تخطيط الصفوف معكوسًا.
...
لو`حقيقي`ترتيب الصفوف معكوس. تُستخدم هذه الخاصية لتخطيط النص العمودي.
