...
description: اكتشف مجموعة Aspose.Words.Drawing.EndCap لأنماط تخصيص لحروف السطور. حسّن تصميمات مستنداتك بتأثيرات بصرية فريدة!
type: docs
weight: 1260
...
| Square | `1` | يبرز المربع بمقدار نصف عرض الخط. |
