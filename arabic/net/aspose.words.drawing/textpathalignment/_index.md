...
description: اكتشف مجموعة Aspose.Words.Drawing.TextPathAlignment لمحاذاة WordArt دقيقة. حسّن تصميم مستندك بخيارات نصية متعددة الاستخدامات!
type: docs
weight: 1770
url: /ar/net/aspose.words.drawing/textpathalignment/
---
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Stretch | `0` | قم بتمديد كل سطر من النص ليناسب العرض. |
| Center | `1` | مركز النص على العرض. |
| Left | `2` | محاذاة إلى اليسار. |
| Right | `3` | محاذاة إلى اليمين. |
| LetterJustify | `4` | قم بتوزيع الحروف لتناسب العرض. |
| WordJustify | `5` | قم بتوزيع الكلمات لتناسب العرض. |
