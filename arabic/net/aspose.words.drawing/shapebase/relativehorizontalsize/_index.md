...
description: اكتشف خاصية ShapeBase RelativeHorizontalSize لضبط أحجام الأشكال أفقيًا بسهولة لتحسين مرونة التصميم ودقته.
type: docs
weight: 460
...
يحصل على قيمة الحجم النسبي للشكل في الاتجاه الأفقي أو يعينها.
...
لا يكون له تأثير إلا إذا[`WidthRelative`](../widthrelative/) تم تعيينه.
