...
description: اكتشف خاصية ShapeBase LeftRelative لضبط موضع الأشكال إلى اليسار بسهولة كنسب مئوية. حسّن دقة تصميمك اليوم!
type: docs
weight: 400
...
يحصل على القيمة التي تمثل الموضع النسبي للشكل على اليسار كنسبة مئوية أو يعينها.
