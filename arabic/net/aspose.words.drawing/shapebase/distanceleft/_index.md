...
description: ShapeBase DistanceLeft ملكية. إرجاع أو تعيين المسافة بالنقاط بين نص المستند والحافة اليسرى للشكل في C#.
type: docs
weight: 140
...
إرجاع أو تعيين المسافة (بالنقاط) بين نص المستند والحافة اليسرى للشكل.
