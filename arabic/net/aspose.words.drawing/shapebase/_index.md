...
description: استكشف فئة Aspose.Words.Drawing.ShapeBase، التي تعد الأساس لإنشاء الرسومات الديناميكية، بما في ذلك الأشكال التلقائية، وكائنات OLE، وعناصر التحكم ActiveX.
type: docs
weight: 1650
url: /ar/net/aspose.words.drawing/shapebase/
---
## ShapeBase class

الفئة الأساسية للأشياء الموجودة في طبقة الرسم، مثل الشكل التلقائي، أو الشكل الحر، أو كائن OLE، أو عنصر تحكم ActiveX، أو الصورة.
...
| اسم | وصف |
| --- | --- |
| abstract [Accept](../../aspose.words/node/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | يقبل زائرًا. |
| abstract [AcceptEnd](../../aspose.words/compositenode/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | عند تنفيذه في فئة مشتقة، يتم استدعاء طريقة VisitXXXEnd للزائر المستند المحدد. |
| abstract [AcceptStart](../../aspose.words/compositenode/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | عند تنفيذه في فئة مشتقة، يتم استدعاء طريقة VisitXXXStart للزائر المستند المحدد. |
...
هذه فئة مجردة. الفئتان المشتقتان اللتان يمكنك إنشاء مثيل لهما هما[`Shape`](../shape/) و[`GroupShape`](../groupshape/).

الشكل هو عقدة في شجرة المستند.

إذا كان الشكل طفلاً لـ[`Paragraph`](../../aspose.words/paragraph/) إذا كان الكائن عبارة عن "مستوى أعلى"، فيُقال عن الشكل أنه "مستوى أعلى". يتم قياس الأشكال ذات المستوى الأعلى وتحديد موضعها في نقاط.

يمكن أن يحدث الشكل أيضًا كطفل لـ[`GroupShape`](../groupshape/) الكائن عند تجميع عدة أشكال x000d_. تُوضع الأشكال الفرعية لشكل المجموعة في مساحة الإحداثيات، وتُحدد الوحدات x000d_ بواسطة[`CoordSize`](./coordsize/) و[`CoordOrigin`](./coordorigin/) خصائص شكل المجموعة parent .

يمكن وضع الشكل ضمن النص أو عائمًا. يتم التحكم في طريقة الوضع باستخدام[`WrapType`](./wraptype/) ملكية.

عندما يكون الشكل عائمًا، يُحدَّد موضعه بالنسبة لشيء ما (مثل الفقرة الحالية، أو الهامش، أو الصفحة). يُحدَّد الموضع النسبي للشكل باستخدام الدالة x000d.[`RelativeHorizontalPosition`](./relativehorizontalposition/) و[`RelativeVerticalPosition`](./relativeverticalposition/) ملكيات.

يمكن وضع الشكل العائم بشكل صريح باستخدام[`Left`](./left/) و[`Top`](./top/) خصائص أو محاذاتها بالنسبة إلى بعض الكائنات الأخرى باستخدام[`HorizontalAlignment`](./horizontalalignment/) و[`VerticalAlignment`](./verticalalignment/) ملكيات.
