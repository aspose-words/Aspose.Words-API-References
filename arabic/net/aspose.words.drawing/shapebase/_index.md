...
description: الفئة الأساسية للكائنات الموجودة في طبقة الرسم  مثل شكل تلقائي أو شكل حر أو كائن OLE أو عنصر تحكم ActiveX أو صورة.
type: docs
weight: 1110
...
إذا كان الشكل تابعًا لـ[`Paragraph`](../../aspose.words/paragraph) كائن ، ثم يُقال إن الشكل هو "المستوى الأعلى" ._ x000d_ يتم قياس أشكال المستوى الأعلى ووضعها في نقاط.

يمكن أن يحدث الشكل أيضًا عندما يكون الطفل تابعًا لـ[`GroupShape`](../groupshape) الكائن عند تجميع العديد من الأشكال . يتم وضع الأشكال الفرعية لشكل المجموعة في مساحة الإحداثيات ويتم تحديد الوحدات_ x000d_ بواسطة[`CoordSize`](./coordsize) و[`CoordOrigin`](./coordorigin)خصائص شكل المجموعة parent .
