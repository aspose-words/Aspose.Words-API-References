...
description: اكتشف كيف تعمل خاصية IsMoveToRevision في ShapeBase على تعزيز تجربة Microsoft Word الخاصة بك من خلال تتبع حركات الكائنات بسلاسة أثناء عمليات التحرير.
type: docs
weight: 350
