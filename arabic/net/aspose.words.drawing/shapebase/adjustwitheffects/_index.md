...
description: اكتشف كيف تعمل طريقة ShapeBase AdjustWithEffects على تعزيز مستطيل المصدر الخاص بك عن طريق إضافة امتدادات التأثير، مما يوفر قيمًا نهائية دقيقة للمستطيل.
type: docs
weight: 660
...
يضيف إلى قيم المستطيل المصدر لمدى التأثير ويعيد المستطيل النهائي.
