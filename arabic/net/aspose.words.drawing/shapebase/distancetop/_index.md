...
description: ShapeBase DistanceTop ملكية. إرجاع أو تعيين المسافة بالنقاط بين نص المستند والحافة العلوية للشكل في C#.
type: docs
weight: 160
...
إرجاع أو تعيين المسافة (بالنقاط) بين نص المستند والحافة العلوية للشكل.
