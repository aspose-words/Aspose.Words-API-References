...
description: اكتشف خاصية ShapeBase DistanceTop، واضبط بسهولة المسافة بالنقاط بين نص المستند والحافة العلوية للشكل للتحكم الدقيق في التخطيط.
type: docs
weight: 160
...
يقوم بإرجاع أو تعيين المسافة (بالنقاط) بين نص المستند والحافة العلوية للشكل.
