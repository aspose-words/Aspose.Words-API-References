...
description: اكتشف خاصية ShapeBase CoordOrigin لتحسين تصميماتك. احصل على إحداثيات دقيقة للزاوية العلوية اليسرى من كتلة الشكل.
type: docs
weight: 110
...
الإحداثيات في الزاوية العلوية اليسرى من الكتلة التي تحتوي على هذا الشكل.
