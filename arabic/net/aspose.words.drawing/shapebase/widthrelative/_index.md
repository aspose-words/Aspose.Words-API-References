...
description: اكتشف خاصية ShapeBase WidthRelative لضبط عرض الشكل بسهولة كنسبة مئوية، مما يعزز مرونة التصميم ودقته.
type: docs
weight: 620
...
يحصل على القيمة التي تمثل النسبة المئوية للعرض النسبي للشكل أو يعينها.
