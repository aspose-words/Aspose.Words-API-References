...
description: ShapeBase ملكية. إرجاع أو تحديد المسافة بالنقاط بين نص المستند والحافة السفلية للشكل.
type: docs
weight: 130
...
إرجاع أو تحديد المسافة (بالنقاط) بين نص المستند والحافة السفلية للشكل.
