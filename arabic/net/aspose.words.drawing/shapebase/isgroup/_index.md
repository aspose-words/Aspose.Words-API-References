...
description: اكتشف ShapeBase IsGroup. حدّد بسهولة ما إذا كان الشكل مجموعة. حسّن سير عملك التصميمي باستخدام هذه الخاصية الأساسية لتحسين التنظيم.
type: docs
weight: 280
...
إرجاع`حقيقي` إذا كان هذا شكل المجموعة.
