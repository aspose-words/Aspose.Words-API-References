...
description: ShapeBase ملكية. إرجاع صحيح إذا كان هذا الشكل عبارة عن كائن WordArt.
type: docs
weight: 350
...
إرجاع صحيح إذا كان هذا الشكل عبارة عن كائن WordArt.
...
يعمل حتى وضع التوافق لعام 2007. في عام 2010 ووضع التوافق الأعلى ، يعد WordArt مجرد مربع نص بخطوط رائعة.
