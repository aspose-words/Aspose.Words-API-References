...
description: ShapeBase CoordSize ملكية. عرض وارتفاع مساحة الإحداثيات داخل الكتلة المحتوية على هذا الشكل في C#.
type: docs
weight: 120
...
عرض وارتفاع مساحة الإحداثيات داخل الكتلة المحتوية على هذا الشكل.
