...
description: يمكنك الوصول إلى البايتات الخام لنسيج التعبئة أو النمط الخاص بك باستخدام خاصية ImageBytes لتحقيق تكامل سلس في التصميم وتحسين الجودة المرئية.
type: docs
weight: 140
...
يحصل على البايتات الخام من نسيج التعبئة أو النمط.
