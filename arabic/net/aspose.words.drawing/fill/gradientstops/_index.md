...
description: اكتشف كيفية تعزيز تصميماتك باستخدام خاصية GradientStops، التي تتميز بمجموعة من كائنات GradientStop للحصول على تأثيرات تعبئة مذهلة.
type: docs
weight: 110
...
يحصل على مجموعة من[`GradientStop`](../../gradientstop/) أشياء للتعبئة.
