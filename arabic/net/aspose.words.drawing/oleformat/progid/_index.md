...
description: OleFormat ملكية. الحصول على أو تعيين ProgID الخاص بكائن OLE.
type: docs
weight: 90
...
الحصول على أو تعيين ProgID الخاص بكائن OLE.
...
خاصية ProgID ليست موجودة دائمًا في مستندات Microsoft Word ولا يمكن الاعتماد عليها.
