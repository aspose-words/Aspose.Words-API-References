...
description: اكتشف خاصية Stroke StartArrowWidth لتخصيص عرض رأس السهم لضرباتك، مما يعزز دقة تصميمك وجاذبيته البصرية.
type: docs
weight: 230
url: /ar/net/aspose.words.drawing/stroke/startarrowwidth/
---
## Stroke.StartArrowWidth property

يحدد عرض رأس السهم لبداية الضربة.
