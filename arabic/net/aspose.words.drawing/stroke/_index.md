...
| [Color](../../aspose.words.drawing/stroke/color) { get; set; } | يحدد لون ضربة الفرشاة ._ x000d_ |
...
| [EndArrowType](../../aspose.words.drawing/stroke/endarrowtype) { get; set; } | يحدد رأس السهم لنهاية السكتة الدماغية ._ x000d_ |
...
| [ImageBytes](../../aspose.words.drawing/stroke/imagebytes) { get; } | يحدد الصورة لصورة الحد أو تعبئة النقش ._ x000d_ |
...
| [Transparency](../../aspose.words.drawing/stroke/transparency) { get; set; } | الحصول على أو تعيين قيمة بين 0.0 (معتم) و 1.0 (واضح) تمثل درجة الشفافية_ x000d_ للحد . |
| [Visible](../../aspose.words.drawing/stroke/visible) { get; set; } | الحصول على أو تعيين علامة تشير إلى ما إذا كانت ضربة الفرشاة مرئية ._ x000d_ |
| [Weight](../../aspose.words.drawing/stroke/weight) { get; set; } | يحدد سماكة الفرشاة التي تضرب مسار الشكل بالنقاط. |

### ملاحظات

استخدم ال[`Stroke`](../shape/stroke)للوصول إلى خصائص ضغط الشكل . لا يمكنك إنشاء مثيلات لملف[`Stroke`](../stroke) فئة مباشرة.
