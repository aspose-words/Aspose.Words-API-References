...
description: اكتشف خاصية Stroke BaseForeColor للوصول بسهولة إلى لون المقدمة الأساسي غير المعدل لضربتك للتحكم الدقيق في التصميم.
type: docs
weight: 40
url: /ar/net/aspose.words.drawing/stroke/baseforecolor/
---
## Stroke.BaseForeColor property

يحصل على لون المقدمة الأساسي للخط بدون أي تعديلات.
