...
description: اكتشف كيف تعمل خاصية Shape ShadowEnabled على تعزيز تصميماتك من خلال تمكين تأثيرات الظل للحصول على مظهر بصري أكثر ديناميكية.
type: docs
weight: 160
...
إرجاع`حقيقي` إذا تم تمكين تأثير الظل.
