...
description: يمكنك التحكم في جماليات الشكل باستخدام خاصية Shape Filled، وتحديد ما إذا كانت مساراتك المغلقة مملوءة لتحسين مرونة التصميم والجاذبية البصرية.
type: docs
weight: 60
...
يحدد ما إذا كان سيتم ملء المسار المغلق للشكل.
...
هذا اختصار لـ[`Visible`](../../fill/visible/) ملكية.
