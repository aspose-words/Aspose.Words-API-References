...
description: اكتشف ما إذا كانت ميزة "بثق الشكل" مفعّلة. حسّن تصميماتك بسهولة بتأثيرات ثلاثية الأبعاد مذهلة لإضفاء لمسة احترافية!
type: docs
weight: 40
...
إرجاع`حقيقي` إذا تم تمكين تأثير البثق.
