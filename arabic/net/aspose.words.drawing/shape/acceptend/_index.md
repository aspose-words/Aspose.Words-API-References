...
description: اكتشف طريقة Shape AcceptEnd لتوجيه الزائرين بسلاسة إلى نهاية الشكل، مما يعزز تجربة المستخدم والتفاعل.
type: docs
weight: 260
url: /ar/net/aspose.words.drawing/shape/acceptend/
---
## Shape.AcceptEnd method

يقبل زائرًا لزيارة نهاية الشكل.
