...
description: اكتشف خاصية "شكل الخطوط" لتحسين تصميماتك! تحكم بدقة في تنسيق المسارات لتحصل على تأثيرات بصرية مذهلة. عزز إبداعك!
type: docs
weight: 210
...
هذا اختصار لـ[`On`](../../stroke/on/) ملكية.
