...
description: GradientStop طريقة. يزيل نقطة توقف التدرج من الأصلGradientStopCollection .
type: docs
weight: 50
...
يزيل نقطة توقف التدرج من الأصل[`GradientStopCollection`](../../gradientstopcollection/) .
