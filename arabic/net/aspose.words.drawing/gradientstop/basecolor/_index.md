...
description: اكتشف خاصية GradientStop BaseColor للوصول بسهولة إلى اللون النقي لتوقف التدرج الخاص بك، مما يعزز تصميمك بدقة ووضوح.
type: docs
weight: 20
...
يحصل على قيمة تمثل لون توقف التدرج اللوني بدون أي تعديلات.
