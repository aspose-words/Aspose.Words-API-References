...
description: اكتشف خاصية GradientStop Transparency لضبط شفافية تعبئة التدرج اللوني بسهولة من ٠٪ إلى ١٠٠٪. حسّن تصميماتك بتحكم دقيق!
type: docs
weight: 50
...
يحصل على قيمة تمثل شفافية تعبئة التدرج أو يعينها، معبرًا عنها كنسبة مئوية في نطاق من 0.0 إلى 1.0.
