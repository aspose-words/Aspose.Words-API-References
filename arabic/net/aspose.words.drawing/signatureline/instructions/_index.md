...
description: SignatureLine ملكية. الحصول على التعليمات أو تعيينها للموقِّع التي يتم عرضها عند توقيع سطر التوقيع. يتم تجاهل هذه الخاصية إذاDefaultInstructions تم تعيين. القيمة الافتراضية لهذه الخاصية هي سلسلة فارغة Empty  .
type: docs
weight: 50
