...
description: يكسر الارتباط إلى مربع النص التالي.
type: docs
weight: 120
...
لا يكسر BreakForwardLink () جميع الارتباطات الأخرى في التسلسل الحالي للأشكال. _ x000d_ على سبيل المثال: التسلسل 1-2-3-4 و BreakForwardLink في مربع النص الثاني سينشئ تسلسلين 1-2 ، 3-4.
