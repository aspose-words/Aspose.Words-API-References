...
description: CompareOptions ملكية. صحيح يشير إلى أنه تم تجاهل التنسيق. لا يتم تجاهل تنسيق المستند الافتراضي.
type: docs
weight: 80
...
صحيح يشير إلى أنه تم تجاهل التنسيق. لا يتم تجاهل تنسيق المستند الافتراضي.
