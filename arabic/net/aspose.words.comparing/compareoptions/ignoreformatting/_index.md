...
description: اكتشف كيف تعمل خاصية CompareOptions IgnoreFormatting على تعزيز معالجة النصوص من خلال تجاهل التنسيق لتحقيق مقارنة بيانات أكثر كفاءة.
type: docs
weight: 90
...
يشير True إلى أن التنسيق يتم تجاهله.
