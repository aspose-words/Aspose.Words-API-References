...
description: اكتشف كيف تعمل خاصية CompareOptions IgnoreCaseChanges على تعزيز مقارنة المستندات من خلال تمكين التحليل غير الحساس لحالة الأحرف للحصول على نتائج دقيقة.
type: docs
weight: 50
...
يشير True إلى أن مقارنة المستندات لا تميز بين الأحرف الكبيرة والصغيرة.
