...
description: CompareOptions ملكية. تحديد ما إذا كان سيتم مقارنة الاختلافات في البيانات الموجودة داخل مربعات النص. لا يتم تجاهل مربعات النص افتراضيًا.
type: docs
weight: 110
...
تحديد ما إذا كان سيتم مقارنة الاختلافات في البيانات الموجودة داخل مربعات النص. لا يتم تجاهل مربعات النص افتراضيًا.
