...
description: CompareOptions ملكية. تحديد ما إذا كان سيتم مقارنة الاختلافات في البيانات الموجودة في الجداول. لا يتم تجاهل الجداول الافتراضية .
type: docs
weight: 100
...
تحديد ما إذا كان سيتم مقارنة الاختلافات في البيانات الموجودة في الجداول. لا يتم تجاهل الجداول الافتراضية .
