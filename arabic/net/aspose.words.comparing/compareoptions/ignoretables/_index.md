...
description: اكتشف كيف تعمل خاصية CompareOptions IgnoreTables على تعزيز تحليل البيانات من خلال التحكم في مقارنة بيانات الجدول للحصول على رؤى دقيقة.
type: docs
weight: 110
...
يحدد ما إذا كان سيتم مقارنة الاختلافات في البيانات الموجودة في الجداول.
