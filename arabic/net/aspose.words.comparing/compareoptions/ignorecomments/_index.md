...
description: CompareOptions ملكية. تحديد ما إذا كان سيتم مقارنة الاختلافات في التعليقات. لا يتم تجاهل التعليقات افتراضيًا.
type: docs
weight: 40
...
تحديد ما إذا كان سيتم مقارنة الاختلافات في التعليقات. لا يتم تجاهل التعليقات افتراضيًا.
