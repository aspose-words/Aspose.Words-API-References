...
description: اكتشف كيف تعمل خاصية CompareOptions IgnoreFields على تعزيز الكفاءة من خلال التحكم في مقارنات اختلافات الحقول للحصول على نتائج مثالية.
type: docs
weight: 70
...
يحدد ما إذا كان سيتم مقارنة الاختلافات في الحقول.
