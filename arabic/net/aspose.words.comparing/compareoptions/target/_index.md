...
description: اكتشف كيفية ضبط خاصية "الهدف" في CompareOptions لمقارنة مستندات فعّالة. بسّط عمليتك مع استهداف دقيق اليوم!
type: docs
weight: 130
...
يحدد المستند الذي سيتم استخدامه كهدف أثناء المقارنة.
