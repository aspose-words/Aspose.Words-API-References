...
description: OdsoRecipientData ملكية. يمثل رمز التجزئة لهذا السجل. يستخدم Microsoft Word أحيانًاHash من سجل كامل بدلاً من ملفUniqueTag value. القيمة الافتراضية هي 0.
type: docs
weight: 40
