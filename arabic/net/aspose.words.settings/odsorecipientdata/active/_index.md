...
description: OdsoRecipientData ملكية. يحدد ما إذا كان يجب استيراد السجل من مصدر البيانات إلى مستند عند تنفيذ دمج البريد. القيمة الافتراضية هيحقيقي .
type: docs
weight: 20
...
يحدد ما إذا كان يجب استيراد السجل من مصدر البيانات إلى مستند عند تنفيذ دمج البريد. القيمة الافتراضية هي`حقيقي` .
