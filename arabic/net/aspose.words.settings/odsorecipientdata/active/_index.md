...
description: يحدد ما إذا كان يجب استيراد السجل من مصدر البيانات إلى مستند عند تنفيذ دمج البريد. _ x000d_ القيمة الافتراضية هيحقيقي .
type: docs
weight: 20
...
يحدد ما إذا كان يجب استيراد السجل من مصدر البيانات إلى مستند عند تنفيذ دمج البريد. _ x000d_ القيمة الافتراضية هي`حقيقي` .
