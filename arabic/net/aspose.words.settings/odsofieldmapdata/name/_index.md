...
description: يحدد اسم العمود داخل مصدر بيانات خارجي للعمود الذي تم تحديد فهرسه بواسطةColumnaspose.words.settings/odsofieldmapdata/column/ property. القيمة الافتراضية هي سلسلة فارغة.
type: docs
weight: 40
