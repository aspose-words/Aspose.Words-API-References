...
description: OdsoFieldMapData ملكية. يحدد اسم العمود داخل مصدر بيانات خارجي للعمود الذي تم تحديد فهرسه بواسطةColumn property. القيمة الافتراضية هي سلسلة فارغة.
type: docs
weight: 40
...
يحدد اسم العمود داخل مصدر بيانات خارجي للعمود الذي تم تحديد فهرسه بواسطة[`Column`](../column/) property. القيمة الافتراضية هي سلسلة فارغة.
