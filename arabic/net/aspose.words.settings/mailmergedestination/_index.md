...
| اسم | قيمة | وصف |
| --- | --- | --- |
| NewDocument | `0` | يحدد أن تطبيقات الاستضافة المطابقة يجب أن تنشئ مستندات جديدة عن طريق ملء الحقول_ x000d_ في مستند معين ببيانات من مصدر البيانات الخارجية المحدد. |
| Printer | `1` | يحدد أن تطبيقات الاستضافة المطابقة يجب أن تطبع المستندات الناتجة عن ملء الحقول_ x000d_ داخل مستند معين ببيانات خارجية من مصدر البيانات الخارجية المحدد. |
...
| Default | `0` | يساويNewDocument القيمة ._ x000d_ |
