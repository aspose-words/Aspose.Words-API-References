...
description: MailMergeSettings ملكية. يحدد كيفية إخراج Microsoft Word لنتائج دمج المراسلات. القيمة الافتراضية هيDefault .
type: docs
weight: 80
...
يحدد كيفية إخراج Microsoft Word لنتائج دمج المراسلات. القيمة الافتراضية هيDefault .
