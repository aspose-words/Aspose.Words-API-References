...
description: يحدد أن تطبيق الاستضافة يجب أن يتعامل مع الصف الأول من البيانات في مصدر data الخارجية المحدد كصف رأس يحتوي على أسماء كل عمود في مصدر البيانات. _ x000d_ القيمة الافتراضية هيخاطئة .
type: docs
weight: 60
...
يحدد أن تطبيق الاستضافة يجب أن يتعامل مع الصف الأول من البيانات في مصدر data الخارجية المحدد كصف رأس يحتوي على أسماء كل عمود في مصدر البيانات. _ x000d_ القيمة الافتراضية هي`خاطئة` .
