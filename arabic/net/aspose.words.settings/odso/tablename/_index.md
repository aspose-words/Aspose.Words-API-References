...
description: يحدد مجموعة معينة من البيانات التي يجب أن يتصل بها المصدر داخل مصدر بيانات خارجي. القيمة الافتراضية هي سلسلة فارغة ._ x000d_
type: docs
weight: 80
...
يحدد مجموعة معينة من البيانات التي يجب أن يتصل بها المصدر داخل مصدر بيانات خارجي. القيمة الافتراضية هي سلسلة فارغة ._ x000d_
