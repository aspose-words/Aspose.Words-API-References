...
description: اكتشف خاصية CompatibilityOptions DoNotVertAlignCellWithSp لمنع المحاذاة الرأسية للخلايا ذات الكائنات العائمة للحصول على تخطيطات أنظف.
type: docs
weight: 230
...
لا تقم بمحاذاة الخلايا التي تحتوي على كائنات عائمة عموديًا.
