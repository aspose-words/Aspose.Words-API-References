...
description: حسّن مستنداتك باستخدام طريقة OptimizeFor في خيارات التوافق. خصص سلوك Aspose.Words لإصدارات MS Word محددة للحصول على أفضل النتائج.
type: docs
weight: 720
...
استخدم هذه الطريقة لمنع MS Word من عرض شريط "وضع التوافق" عند تحميل المستند. (لاحظ أنه قد يتعين عليك أيضًا تعيين[`Compliance`](../../../aspose.words.saving/ooxmlsaveoptions/compliance/) الخاصية to Iso29500_2008_Transitional أو أعلى.)
