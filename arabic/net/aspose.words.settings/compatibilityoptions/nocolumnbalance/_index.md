...
description: اكتشف خاصية NoColumnBalance في خيارات التوافق. تحكّم في تخطيط نصك بسهولة من خلال منع توازن الأعمدة في الأقسام!
type: docs
weight: 330
...
لا توازن أعمدة النص داخل القسم.
