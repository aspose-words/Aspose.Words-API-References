...
description: اكتشف كيف تعمل خاصية AutofitToFirstFixedWidthCell على تحسين تخطيطات الجدول من خلال السماح للأعمدة بتجاوز العرض المفضل للحصول على عرض مثالي.
type: docs
weight: 50
...
يُطلق على الخيار اسم "استخدام قواعد ملاءمة الجدول تلقائيًا في Word 2003" في واجهة مستخدم MS Word 2013. وهو يؤثر في الواقع على كيفية حساب الشبكة لجداول التخطيط الثابت أيضًا (في بعض الحالات).
