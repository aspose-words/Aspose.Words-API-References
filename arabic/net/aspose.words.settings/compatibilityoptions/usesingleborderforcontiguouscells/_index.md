...
description: حسّن تصميم جدولك باستخدام خاصية UseSingleBorderForContiguousCells. تخلص من تعارضات الحدود وحسّن المظهر العام بسهولة!
type: docs
weight: 650
...
استخدام قواعد مبسطة لتعارضات حدود الجدول.
