...
description: قم بتحسين عرض النص باستخدام خاصية BalanceSingleByteDoubleByteWidth لتحقيق التكامل السلس بين الأحرف ذات البايت المفرد والمزدوج.
type: docs
weight: 70
...
توازن الأحرف ذات البايت المفرد والبايت المزدوج.
