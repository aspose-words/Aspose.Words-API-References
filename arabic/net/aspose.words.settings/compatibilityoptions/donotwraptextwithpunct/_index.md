...
description: اكتشف خاصية CompatibilityOptions DoNotWrapTextWithPunct لمنع تعليق علامات الترقيم في شبكة الأحرف الخاصة بك للحصول على تخطيطات أنظف واحترافية.
type: docs
weight: 250
...
لا تسمح بعلامات الترقيم المعلقة مع شبكة الأحرف.
