...
description: حسّن تخطيط مستندك باستخدام CompatibilityOptions SuppressSpBfAfterPgBrk. تخلص من المسافات غير المرغوب فيها بعد فواصل الصفحات لتنسيق أدق.
type: docs
weight: 500
...
لا تستخدم المسافة قبل السطر الأول بعد فاصل الصفحة.
