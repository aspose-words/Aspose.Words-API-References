...
description: اكتشف كيف تعمل ميزة CompatibilityOptions SuppressTopSpacingWP على تعزيز تجربة WordPerfect 5.x الخاصة بك من خلال تعديلات المسافة بين السطور بسلاسة للحصول على تنسيق مثالي للمستندات.
type: docs
weight: 520
