...
description: قم بتعزيز نصك في شرق آسيا باستخدام CompatibilityOptions SpaceForUL، مما يضيف مساحة إضافية أسفل خط الأساس لتحسين قابلية القراءة والأسلوب.
type: docs
weight: 440
...
أضف مسافة إضافية أسفل خط الأساس للنص الشرق آسيوي المسطر.
