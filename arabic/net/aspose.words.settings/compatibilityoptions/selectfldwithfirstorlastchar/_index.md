...
description: اكتشف خاصية SelectFldWithFirstOrLastChar لخيارات التوافق. حدد الحقول بسهولة بناءً على الحرف الأول أو الأخير لتحسين الكفاءة.
type: docs
weight: 410
...
تحديد الحقل عند تحديد الحرف الأول أو الأخير.
