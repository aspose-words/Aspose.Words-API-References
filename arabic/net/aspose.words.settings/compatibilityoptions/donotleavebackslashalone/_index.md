...
description: حوّل الخطوط المائلة العكسية إلى علامات ين بسهولة مع ميزة DoNotLeaveBackslashAlone من CompatibilityOptions. حسّن إدخال بياناتك اليوم!
type: docs
weight: 160
...
تحويل الشرطة المائلة للخلف إلى علامة الين عند الإدخال.
