...
description: قم بتعزيز عرض الخط الخاص بك باستخدام خاصية SubFontBySize في CompatibilityOptions، مع إعطاء الأولوية للحجم أثناء استبدال الخط لتحقيق أفضل قابلية للقراءة.
type: docs
weight: 470
