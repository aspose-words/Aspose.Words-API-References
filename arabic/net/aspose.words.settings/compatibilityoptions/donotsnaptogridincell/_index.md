...
description: اكتشف كيفية تعطيل ميزة "عدم الالتقاط على الشبكة" في خلايا الجدول، مما يؤدي إلى تحسين تخطيط المستند ووضع الكائنات للتحكم في التصميم بشكل أفضل.
type: docs
weight: 170
...
لا يتم الالتقاط بشبكة المستندات في خلايا الجدول التي تحتوي على كائنات.
