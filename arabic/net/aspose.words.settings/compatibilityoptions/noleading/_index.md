...
description: اكتشف خاصية NoLeading في CompatibilityOptions لإزالة المسافات غير المرغوب فيها بين أسطر النص للحصول على مظهر أكثر نظافة واحترافية.
type: docs
weight: 350
...
لا تقم بإضافة مسافة بين أسطر النص.
