...
description: حسّن مظهر مستندك باستخدام خاصية "UnderlineTabInNumList" في خيارات التوافق. سطّر الأحرف بعد القوائم المرقمة بدقة لمزيد من الوضوح!
type: docs
weight: 590
...
تسطير الحرف التالي بعد الترقيم.
