...
description: اكتشف خاصية CompatibilityOptions DoNotUseEastAsianBreakRules لتحسين شبكات المستندات دون ضغط الأحرف. حسّن تنسيقك اليوم!
type: docs
weight: 200
...
لا تضغط الأحرف القابلة للضغط عند استخدام شبكة المستندات.
