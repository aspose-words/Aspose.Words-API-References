...
description: حسّن طباعتك باستخدام خاصية UsePrinterMetrics من CompatibilityOptions لعرض المستندات بدقة. حسّن الأداء والجودة بسهولة!
type: docs
weight: 640
...
قد تختلف مقاييس الطابعة وفقًا لبرامج التشغيل المستخدمة. على سبيل المثال، يوفر "Microsoft OpenXPS Class Driver 2" و"Microsoft Print to PDF" في نظام التشغيل Windows مقاييس مختلفة قليلاً. لذلك، قد يتغير تخطيط المستند النهائي إذا تم تمكين هذا الخيار.
