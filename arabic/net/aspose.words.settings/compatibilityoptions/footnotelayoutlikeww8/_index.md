...
description: قم بتحسين مستنداتك باستخدام CompatibilityOptions FootnoteLayoutLikeWW8 لوضع الحواشي السفلية بشكل دقيق، ومحاكاة Word 6.x/95/97 للتنسيق السلس.
type: docs
weight: 260
