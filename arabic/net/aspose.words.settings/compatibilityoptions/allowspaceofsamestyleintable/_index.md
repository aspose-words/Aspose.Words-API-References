...
description: حسّن تخطيطات الجداول باستخدام AllowSpaceOfSameStyleInTable من CompatibilityOptions. استمتع بمسافات فقرات مُحسّنة لتحسين سهولة القراءة والتصميم.
type: docs
weight: 30
