...
description: حسّن تصميم HTML الخاص بك باستخدام خاصية CompatibilityOptions DoNotUseHTMLParagraphAutoSpacing. تأكد من ثبات مسافات الفقرات لتصميم أكثر وضوحًا!
type: docs
weight: 210
...
استخدم مسافة فقرات ثابتة لإعداد HTML التلقائي.
