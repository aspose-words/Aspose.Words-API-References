...
description: حسّن تنسيق نصك باستخدام UseAltKinsokuLineBreakRules من CompatibilityOptions لتحسين كسر الأسطر في شرق آسيا. حسّن سهولة القراءة اليوم!
type: docs
weight: 600
...
استخدم مجموعة بديلة من قواعد كسر الخطوط في شرق آسيا.
