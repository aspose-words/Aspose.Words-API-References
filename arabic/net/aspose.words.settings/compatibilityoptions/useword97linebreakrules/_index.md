...
description: قم بتحسين مستنداتك باستخدام UseWord97LineBreakRules من CompatibilityOptions لتحسين كسر الأسطر في شرق آسيا لتحسين قابلية القراءة والتنسيق.
type: docs
weight: 680
...
محاكاة كسر الأسطر في Word 97 في شرق آسيا.
