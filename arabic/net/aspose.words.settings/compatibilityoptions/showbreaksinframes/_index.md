...
description: حسّن تصميم موقعك الإلكتروني باستخدام ميزة CompatibilityOptions ShowBreaksInFrames. تصوّر بسهولة فواصل الصفحات والأعمدة في الإطارات لتحسين التحكم في التخطيط.
type: docs
weight: 430
