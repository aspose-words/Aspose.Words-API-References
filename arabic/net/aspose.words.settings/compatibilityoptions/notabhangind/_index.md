...
description: اكتشف خاصية NoTabHangInd في CompatibilityOptions لتبسيط تنسيقك. تجنب علامات التبويب المخصصة للحصول على مسافات بادئة معلقة بسلاسة!
type: docs
weight: 370
...
لا تقم بإنشاء علامة تبويب مخصصة للمسافة البادئة المعلقة.
