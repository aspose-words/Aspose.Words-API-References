...
description: قم بتعزيز تنسيق النص في شرق آسيا باستخدام CompatibilityOptions LineWrapLikeWord6، محاكياً التفاف الأسطر في Word 6.0 لتحسين قابلية القراءة والعرض.
type: docs
weight: 310
...
محاكاة التفاف الأسطر في Word 6.0 للنصوص في شرق آسيا.
