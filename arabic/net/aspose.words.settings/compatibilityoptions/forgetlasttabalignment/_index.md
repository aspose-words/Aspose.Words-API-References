...
description: اكتشف كيف تعمل خاصية ForgetLastTabAlignment على تعزيز محاذاة الفقرة عن طريق تجاهل عرض علامة التبويب الأخيرة للنص غير المحاذي لليسار.
type: docs
weight: 270
...
تجاهل عرض آخر علامة تبويب عند محاذاة الفقرة إذا لم تكن محاذية لليسار.
