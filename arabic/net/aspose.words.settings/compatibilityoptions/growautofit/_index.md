...
description: حسّن جداولك باستخدام خيارات التوافق والنمو والتوافق التلقائي. رتّب الجداول بسهولة داخل هوامش الصفحة لمظهر أنيق واحترافي.
type: docs
weight: 280
...
السماح للجداول بالتوافق تلقائيًا مع هوامش الصفحة.
