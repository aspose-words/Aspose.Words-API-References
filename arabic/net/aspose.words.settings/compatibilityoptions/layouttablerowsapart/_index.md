...
description: اكتشف كيف تعمل خاصية LayoutTableRowsApart على تعزيز التوافق من خلال تمكين التغليف المستقل للأشياء المضمنة في صفوف الجدول لتحقيق مرونة أفضل في التصميم.
type: docs
weight: 300
...
السماح لصفوف الجدول بتغليف الكائنات المضمنة بشكل مستقل.
