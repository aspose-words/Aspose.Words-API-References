...
description: قم بتحسين تخطيطك باستخدام خاصية CompatibilityOptions SuppressTopSpacing، وتجاهل إعدادات ارتفاع السطر للحصول على مظهر أكثر نظافة في الصفحة الأولى.
type: docs
weight: 510
...
تجاهل الحد الأدنى والارتفاع الدقيق للسطر الأول في الصفحة.
