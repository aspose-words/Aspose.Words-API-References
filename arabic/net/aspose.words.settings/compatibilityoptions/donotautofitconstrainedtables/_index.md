...
description: حسّن جداولك باستخدام خاصية CompatibilityOptions DoNotAutofitConstrainedTables. محاذاة مثالية للعناصر المُغلّفة بسهولة.
type: docs
weight: 120
...
لا يتم ضبط الجداول تلقائيًا لتلائم الكائنات المغلفة.
