...
description: حسّن واجهة المستخدم لديك باستخدام إعداد CompatibilityOptions UICompat97To2003. عطّل الميزات غير المتوافقة لاستخدام سلس لـ Word 97-2003. حسّن الأداء اليوم!
type: docs
weight: 570
...
صحيح لتعطيل وظيفة واجهة المستخدم غير المتوافقة مع Word97-2003. القيمة الافتراضية هي`خطأ شنيع` .
...
يتحكم في إعداد توافق Word97-2003 الذي يعطل وظيفة واجهة المستخدم والتي غير متوافقة مع Word97-2003. عندما`حقيقي`، يتم كتابة عنصر XML 'w:uiCompat97To2003' إلى '\word\settings.xml' document package part. القيمة الافتراضية هي`خطأ شنيع` . عند ضبطه على`خطأ شنيع` , هذا العنصر غير مكتوب. من الناحية الفنية، هذه الخاصية ليست جزءًا من خيارات التوافق، ولكننا وضعناها هنا لتسهيل استخدام واجهة برمجة التطبيقات.
