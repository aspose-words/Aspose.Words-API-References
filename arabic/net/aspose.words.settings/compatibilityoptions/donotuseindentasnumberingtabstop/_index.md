...
description: حسّن تنسيق مستندك باستخدام خاصية CompatibilityOptions DoNotUseIndentAsNumberingTabStop. حسّن سهولة القراءة بتجاهل المسافات البادئة المعلقة!
type: docs
weight: 220
...
تجاهل المسافة البادئة المعلقة عند إنشاء علامة تبويب بعد الترقيم.
