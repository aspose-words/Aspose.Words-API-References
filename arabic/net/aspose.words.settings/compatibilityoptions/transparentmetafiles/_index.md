...
description: اكتشف كيف تعمل خاصية CompatibilityOptions TransparentMetafiles على تعزيز الرسومات الخاصة بك عن طريق منع إخفاء الخلفية خلف صور الملفات التعريفية.
type: docs
weight: 550
...
يحدد عدم إفراغ المنطقة خلف صور الملف التعريفي.
