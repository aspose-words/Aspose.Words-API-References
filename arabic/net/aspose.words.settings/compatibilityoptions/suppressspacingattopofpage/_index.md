...
description: حسّن تخطيطك باستخدام خاصية CompatibilityOptions SuppressSpacingAtTopOfPage. تحكّم في ارتفاع السطر لعرض أول سطر بسلاسة.
type: docs
weight: 490
...
تجاهل الحد الأدنى لارتفاع السطر للسطر الأول في الصفحة.
