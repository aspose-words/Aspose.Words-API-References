...
description: قم بتحسين مستنداتك باستخدام CompatibilityOptions AutoSpaceLikeWord95 للحصول على مسافة دقيقة بين أحرف FullWidth، مما يعزز قابلية القراءة والأسلوب.
type: docs
weight: 60
...
محاكاة التباعد الكامل للأحرف في Word 95.
