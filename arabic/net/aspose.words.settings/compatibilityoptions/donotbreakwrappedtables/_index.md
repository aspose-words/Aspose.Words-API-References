...
description: اكتشف خاصية CompatibilityOptions DoNotBreakWrappedTables لمنع الجداول العائمة من الانفصال عبر الصفحات للحصول على تخطيط مستند سلس.
type: docs
weight: 140
...
لا تسمح للجداول العائمة بالانقسام عبر الصفحات.
