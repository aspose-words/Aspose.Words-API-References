...
description: اكتشف خاصية CompatibilityOptions SpacingInWholePoints لضبط مسافة النص بسهولة بالنقاط الكاملة لتحسين قابلية القراءة والتصميم.
type: docs
weight: 450
...
توسيع/تكثيف النص بالنقاط الكاملة فقط.
