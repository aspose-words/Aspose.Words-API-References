...
description: حسّن تخطيطك باستخدام خاصية CompatibilityOptions LayoutRawTableWidth. تحكّم في التفاف الجدول وحسّن مرونة التصميم بسهولة!
type: docs
weight: 290
...
تجاهل المسافة قبل الجدول عند تحديد ما إذا كان يجب على الجدول تغليف الكائن العائم.
