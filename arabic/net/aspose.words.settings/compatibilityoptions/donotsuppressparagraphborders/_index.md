...
description: اكتشف خاصية CompatibilityOptions DoNotSuppressParagraphBorders لتحسين تخطيط المستند الخاص بك من خلال إدارة حدود الفقرات بجوار الإطارات بشكل فعال.
type: docs
weight: 190
...
لا تقم بإخفاء حدود الفقرات بجوار الإطارات.
