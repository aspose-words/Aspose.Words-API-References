...
description: اكتشف كيف تعمل خاصية OverrideTableStyleFontSizeAndJustification على تعزيز التسلسل الهرمي لأسلوب المستند لتحسين التنسيق وسهولة القراءة.
type: docs
weight: 380
...
يحدد كيفية تقييم التسلسل الهرمي للأسلوب الخاص بالمستند.
