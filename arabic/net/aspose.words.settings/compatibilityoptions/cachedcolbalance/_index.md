...
description: حسّن تخطيطك باستخدام خاصية CompatibilityOptions CachedColBalance. حسّن توازن الأعمدة باستخدام معلومات الفقرة المخزنة مؤقتًا لتصميم سلس.
type: docs
weight: 80
...
استخدام معلومات الفقرة المخزنة مؤقتًا لموازنة الأعمدة.
