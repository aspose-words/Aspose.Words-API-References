...
description: قم بتحسين تخطيطك باستخدام خاصية SuppressBottomSpacing في CompatibilityOptions، مما يضمن ارتفاع الخط المثالي في الصفحة الأخيرة للحصول على مظهر مصقول.
type: docs
weight: 480
...
تجاهل ارتفاع السطر الدقيق للسطر الأخير في الصفحة.
