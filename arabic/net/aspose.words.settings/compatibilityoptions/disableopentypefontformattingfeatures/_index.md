...
description: تعرف على كيفية تعطيل ميزات تنسيق الخط OpenType باستخدام خاصية CompatibilityOptions لتحسين اتساق المستندات والأداء.
type: docs
weight: 100
...
يحدد تعطيل ميزات تنسيق خط OpenType.
