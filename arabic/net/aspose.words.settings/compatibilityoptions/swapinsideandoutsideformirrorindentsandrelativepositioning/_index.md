...
description: اكتشف خاصية خيارات التوافق (CompatibilityOptions) لخطوط فاصلة متطابقة ومواضع نسبية سلسة. حسّن مرونة تصميمك وتجربة المستخدم اليوم!
type: docs
weight: 540
...
يحدد التبديل بين الداخل والخارج للمسافات البادئة للمرآة والموضع النسبي.
