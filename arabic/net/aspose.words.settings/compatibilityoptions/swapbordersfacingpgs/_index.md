...
description: حسّن تصميم مستندك باستخدام خاصية CompatibilityOptions SwapBordersFacingPgs. بدّل حدود الفقرات بسهولة في الصفحات غير المنتظمة للحصول على مظهر أنيق!
type: docs
weight: 530
...
تبديل حدود الفقرات في الصفحات ذات الأرقام الفردية.
