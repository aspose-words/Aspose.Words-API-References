...
description: Aspose.Words.Settings.CompatibilityOptions فصل. يحتوي على خيارات التوافق أي تفضيلات المستخدم التي تم إدخالها في ملف التوافق من علامة التبويب خيارات مربع حوار في Microsoft Word.
type: docs
weight: 5490
