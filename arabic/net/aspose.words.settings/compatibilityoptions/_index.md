...
description: يحتوي على خيارات التوافق أي تفضيلات المستخدم التي تم إدخالها في ملف التوافق من علامة التبويب خيارات مربع حوار في Microsoft Word.
type: docs
weight: 5490
...
يحتوي على خيارات التوافق (أي تفضيلات المستخدم التي تم إدخالها في ملف **التوافق** من علامة التبويب **خيارات** مربع حوار في Microsoft Word).
...
| [AllowSpaceOfSameStyleInTable](../../aspose.words.settings/compatibilityoptions/allowspaceofsamestyleintable) { get; set; } | السماح بالتباعد السياقي للفقرات في الجداول ._ x000d_ |
| [ApplyBreakingRules](../../aspose.words.settings/compatibilityoptions/applybreakingrules) { get; set; } | استخدام قواعد كسر الأسطر القديمة الإثيوبية والأمهرية ._ x000d_ |
...
| [AutoSpaceLikeWord95](../../aspose.words.settings/compatibilityoptions/autospacelikeword95) { get; set; } | محاكاة تباعد الأحرف بالعرض الكامل في Word 95 ._ x000d_ |
...
| [DoNotSnapToGridInCell](../../aspose.words.settings/compatibilityoptions/donotsnaptogridincell) { get; set; } | عدم الانطباق على شبكة المستند في خلايا الجدول ذات الكائنات ._ x000d_ |
| [DoNotSuppressIndentation](../../aspose.words.settings/compatibilityoptions/donotsuppressindentation) { get; set; } | لا تتجاهل الكائنات العائمة عند حساب المسافة البادئة للفقرة ._ x000d_ |
| [DoNotSuppressParagraphBorders](../../aspose.words.settings/compatibilityoptions/donotsuppressparagraphborders) { get; set; } | لا تلغي حدود الفقرة بجوار الإطارات ._ x000d_ |
...
| [DoNotUseIndentAsNumberingTabStop](../../aspose.words.settings/compatibilityoptions/donotuseindentasnumberingtabstop) { get; set; } | تجاهل المسافة البادئة المعلقة عند إنشاء علامة الجدولة بعد الترقيم ._ x000d_ |
...
| [DoNotWrapTextWithPunct](../../aspose.words.settings/compatibilityoptions/donotwraptextwithpunct) { get; set; } | عدم السماح بتعليق علامات الترقيم بشبكة الأحرف ._ x000d_ |
| [FootnoteLayoutLikeWW8](../../aspose.words.settings/compatibilityoptions/footnotelayoutlikeww8) { get; set; } | محاكاة وضع الحاشية السفلية في Word 6.x / 95/97. _ x000d_ |
...
| [LayoutRawTableWidth](../../aspose.words.settings/compatibilityoptions/layoutrawtablewidth) { get; set; } | تجاهل المساحة الموجودة قبل الجدول عند تحديد ما إذا كان يجب أن يلتف الجدول كائنًا عائمًا ._ x000d_ |
| [LayoutTableRowsApart](../../aspose.words.settings/compatibilityoptions/layouttablerowsapart) { get; set; } | السماح لصفوف الجدول بالتفاف الكائنات المضمنة بشكل مستقل ._ x000d_ |
...
| [PrintBodyTextBeforeHeader](../../aspose.words.settings/compatibilityoptions/printbodytextbeforeheader) { get; set; } | طباعة النص الأساسي قبل محتويات الرأس / التذييل ._ x000d_ |
| [PrintColBlack](../../aspose.words.settings/compatibilityoptions/printcolblack) { get; set; } | طباعة الألوان باللون الأسود والأبيض دون ثبات الألوان ._ x000d_ |
...
| [ShowBreaksInFrames](../../aspose.words.settings/compatibilityoptions/showbreaksinframes) { get; set; } | عرض فواصل الصفحة / الأعمدة في الإطارات ._ x000d_ |
...
| [SuppressTopSpacing](../../aspose.words.settings/compatibilityoptions/suppresstopspacing) { get; set; } | تجاهل الحد الأدنى والضبط لارتفاع السطر للخط الأول في الصفحة ._ x000d_ |
...
| [SwapBordersFacingPgs](../../aspose.words.settings/compatibilityoptions/swapbordersfacingpgs) { get; set; } | تبديل حدود الفقرة على الصفحات المرقمة الفردية ._ x000d_ |
...
| [UlTrailSpace](../../aspose.words.settings/compatibilityoptions/ultrailspace) { get; set; } | تسطير كافة المساحات اللاحقة ._ x000d_ |
| [UnderlineTabInNumList](../../aspose.words.settings/compatibilityoptions/underlinetabinnumlist) { get; set; } | وضع خط تحت الترقيم التالي للحرف ._ x000d_ |
...
| [UseAnsiKerningPairs](../../aspose.words.settings/compatibilityoptions/useansikerningpairs) { get; set; } | استخدم أزواج تقنين الأحرف ANSI من الخطوط ._ x000d_ |
...
| [UseWord97LineBreakRules](../../aspose.words.settings/compatibilityoptions/useword97linebreakrules) { get; set; } | محاكاة Word 97 لكسر الأسطر في شرق آسيا ._ x000d_ |
| [WPJustification](../../aspose.words.settings/compatibilityoptions/wpjustification) { get; set; } | محاكاة WordPerfect 6.x ضبط الفقرة. _ x000d_ |
...
| [WrapTrailSpaces](../../aspose.words.settings/compatibilityoptions/wraptrailspaces) { get; set; } | مسافات زائدة لفاف الأسطر ._ x000d_ |
