...
description: اكتشف خاصية CompatibilityOptions MWSmallCaps لمحاكاة تنسيق الأحرف الصغيرة في Word 5.x بسهولة على جهاز Macintosh. حسّن مستنداتك اليوم!
type: docs
weight: 320
...
محاكاة Word 5.x لتنسيق الأحرف الصغيرة على نظام Macintosh.
