...
description: حسّن تنسيق مستندك باستخدام CompatibilityOptions WPJustification. حسّن محاذاة فقرات WordPerfect 6.x للحصول على نتائج مُحسّنة.
type: docs
weight: 690
...
محاكاة محاذاة الفقرة في WordPerfect 6.x.
