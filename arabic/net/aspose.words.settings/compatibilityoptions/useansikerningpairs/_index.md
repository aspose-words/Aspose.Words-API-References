...
description: قم بتعزيز أسلوب الطباعة لديك باستخدام خاصية CompatibilityOptions UseAnsiKerningPairs لتحسين قابلية قراءة الخط والحصول على تصميم احترافي.
type: docs
weight: 610
...
استخدم أزواج التباعد بين الحروف ANSI من الخطوط.
