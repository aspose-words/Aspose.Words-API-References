...
description: اكتشف خاصية CompatibilityOptions UseFELayout—تأكد من تخطيط النصوص المعقدة في شرق آسيا للحصول على تجربة مستخدم سلسة.
type: docs
weight: 620
...
لا تتجاوز كود تخطيط النصوص المعقدة/الشرق آسيوية.
