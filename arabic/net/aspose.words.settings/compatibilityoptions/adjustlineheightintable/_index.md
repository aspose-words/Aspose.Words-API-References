...
description: حسّن جداولك باستخدام خاصية AdjustLineHeightInTable لضبط مسافات الأسطر بدقة. حسّن وضوح المستند وعرضه بسهولة!
type: docs
weight: 10
...
إضافة ميل خط شبكة المستند إلى الخطوط في خلايا الجدول.
