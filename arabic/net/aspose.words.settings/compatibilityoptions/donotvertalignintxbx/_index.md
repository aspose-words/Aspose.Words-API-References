...
description: اكتشف كيف تعمل خاصية CompatibilityOptions DoNotVertAlignInTxbx على تحسين تنسيق مربع النص من خلال تجاهل المحاذاة الرأسية لتحسين مرونة التصميم.
type: docs
weight: 240
...
تجاهل المحاذاة الرأسية في مربعات النص.
