...
description: حسّن عرضك باستخدام خاصية CompatibilityOptions DisplayHangulFixedWidth. تأكد من استخدام أحرف هانغول ثابتة ومتناسقة لضمان الوضوح والأناقة.
type: docs
weight: 110
...
استخدم دائمًا عرضًا ثابتًا لأحرف الهانغول.
