...
description: اكتشف كيف تعمل خاصية ConvMailMergeEsc على تعزيز التوافق من خلال التعامل مع الخطوط المائلة العكسية كعلامات اقتباس مزدوجة، مما يؤدي إلى تبسيط تنسيق المستندات لديك.
type: docs
weight: 90
...
تعامل مع فاصل علامات الاقتباس العكسية كعلامتي اقتباس.
