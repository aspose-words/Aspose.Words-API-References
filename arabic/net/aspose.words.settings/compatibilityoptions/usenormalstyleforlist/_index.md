...
description: حسّن تنسيق مستنداتك مع خيارات التوافق. تحكّم في أنماط القوائم بسهولة، وتأكد من أن نصك النقطي والمرقم يبدو مثاليًا في كل مرة!
type: docs
weight: 630
...
لا يتم تطبيق نمط فقرة القائمة تلقائيًا على النص المرقّم/المُرقّم.
