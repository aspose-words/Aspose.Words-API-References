...
description: حسّن تخطيط مستندك باستخدام خاصية DoNotSuppressIndentation في CompatibilityOptions. حسّن المسافة البادئة للفقرات دون تجاهل الكائنات العائمة.
type: docs
weight: 180
...
لا تتجاهل الكائنات العائمة عند حساب مسافة بادئة الفقرة.
