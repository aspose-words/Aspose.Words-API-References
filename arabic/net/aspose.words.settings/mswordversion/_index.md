...
description: اكتشف Aspose.Words.Settings.MsWordVersion لتكرار سلوكيات MS Word، مما يعزز معالجة المستندات والتوافق لضمان سير العمل بسلاسة.
type: docs
weight: 6690
...
يسمح لـ Aspose.Wods بمحاكاة سلوك التطبيق الخاص بإصدار MS Word.
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Word2000 | `0` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2000. |
| Word2002 | `1` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2002. |
| Word2003 | `2` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2003. |
| Word2007 | `3` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2007. |
| Word2010 | `4` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2010. |
| Word2013 | `5` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2013. |
| Word2016 | `6` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2016. |
| Word2019 | `7` | تحسين سلوك Aspose.Words ليتوافق مع إصدار MS Word 2019. |
