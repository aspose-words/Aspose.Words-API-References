...
description: استرجع توقيعات المستندات بسهولة مع DigitalSignatureCollection. سجّل وصولك إلى التوقيعات حسب الفهرس لإدارة مستندات مبسطة وكفاءة أعلى.
type: docs
weight: 40
...
يحصل على توقيع مستند في الفهرس المحدد.
...
| معامل | وصف |
| --- | --- |
| index | فهرس التوقيع على أساس الصفر. |
