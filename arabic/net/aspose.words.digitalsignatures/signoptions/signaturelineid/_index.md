...
description: اكتشف خاصية SignatureLineId في SignOptions. حدّد بسهولة أسطر التوقيع باستخدام مُعرِّف GUID فريد، مما يُحسّن كفاءة إدارة مستنداتك.
type: docs
weight: 50
...
معرف سطر التوقيع. القيمة الافتراضية هي**فارغ (كل الأصفار) معرف الدليل** .
...
عند ضبطه، فإنه يرتبط[`SignatureLine`](../../../aspose.words.drawing/signatureline/) مع المقابلة[`DigitalSignature`](../../digitalsignature/) .
