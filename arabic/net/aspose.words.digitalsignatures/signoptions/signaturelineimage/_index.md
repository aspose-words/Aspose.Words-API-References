...
description: اكتشف خاصية SignOptions SignatureLineImage لتحسين توقيعاتك الرقمية بصور مخصصة. ارتقِ باحترافية علامتك التجارية اليوم!
type: docs
weight: 60
...
الصورة التي سيتم عرضها في المرتبطة[`SignatureLine`](../../../aspose.words.drawing/signatureline/) . القيمة الافتراضية هي`باطل` .
