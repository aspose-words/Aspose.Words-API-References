...
description: اكتشف خاصية DigitalSignature SubjectName، التي تكشف عن الاسم المميز لموضوع الشهادة، مما يعزز صحة المستند وأمانه.
type: docs
weight: 80
...
يعيد اسم الموضوع المميز للشهادة التي تم استخدامها لتوقيع المستند.
