...
| static [Sign](../../aspose.words.digitalsignatures/digitalsignatureutil/sign#sign)(Stream, Stream, CertificateHolder) | يوقع المستند المصدر باستخدام معين[`CertificateHolder`](../certificateholder)مع التوقيع الرقمي_ x000d_ ويكتب المستند الموقع إلى تيار الوجهة. |
| static [Sign](../../aspose.words.digitalsignatures/digitalsignatureutil/sign#sign_2)(string, string, CertificateHolder) | يوقع المستند المصدر باستخدام معين[`CertificateHolder`](../certificateholder) مع التوقيع الرقمي_ x000d_ وكتابة المستند الموقع إلى الملف الوجهة. |
