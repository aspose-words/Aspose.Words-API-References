...
description: اكتشف خاصية EndnoteOptions NumberStyle لتخصيص تنسيق أرقام ملاحظاتك الختامية بسهولة. حسّن من احترافية مستندك اليوم!
type: docs
weight: 10
...
يحدد تنسيق الأرقام للملاحظات الختامية المرقمة تلقائيًا.
