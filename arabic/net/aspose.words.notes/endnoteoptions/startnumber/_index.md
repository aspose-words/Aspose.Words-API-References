...
description: اكتشف كيف تعمل خاصية EndnoteOptions StartNumber على تحسين مستندك من خلال تخصيص الملاحظات الختامية المرقمة الأولى لتحقيق الوضوح والتنظيم.
type: docs
weight: 40
...
يحدد الرقم أو الحرف الأولي للملاحظات الختامية المرقمة تلقائيًا.
