...
description: اكتشف طريقة AcceptEnd للحواشي السفلية، المصممة لتحسين تجربة المستخدم من خلال إدارة زيارات الحواشي السفلية بسلاسة. حسّن تجربة تصفحك اليوم!
type: docs
weight: 90
url: /ar/net/aspose.words.notes/footnote/acceptend/
---
## Footnote.AcceptEnd method

يقبل الزائر لزيارة نهاية الحاشية السفلية.
