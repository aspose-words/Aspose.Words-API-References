...
description: يحصل / يحدد علامة مرجعية مخصصة لاستخدامها في هذه الحاشية السفلية. القيمة الافتراضية هي سلسلة فارغة Empty   مما يعني أنه يتم استخدام الحواشي السفلية المرقمة تلقائيًا.
type: docs
weight: 50
