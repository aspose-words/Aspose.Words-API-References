...
description: Footnote ملكية. الحصول على/تعيين علامة مرجعية مخصصة لاستخدامها في هذه الحاشية السفلية. القيمة الافتراضية هي سلسلة فارغة Empty  مما يعني استخدام الحواشي السفلية المرقمة تلقائيًا.
type: docs
weight: 50
