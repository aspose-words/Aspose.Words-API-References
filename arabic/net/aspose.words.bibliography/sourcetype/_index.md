...
description: اكتشف مجموعة Aspose.Words.Bibliography.SourceType لأنواع مصادر المراجع المتنوعة. حسّن إدارة مستنداتك بميزات فعّالة!
type: docs
weight: 210
url: /ar/net/aspose.words.bibliography/sourcetype/
---
## SourceType enumeration

يمثل أنواع مصادر المراجع.
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| ArticleInAPeriodical | `0` | يحدد المقالة في مصدر دوري. |
| Book | `1` | يحدد مصدر الكتاب. |
| BookSection | `2` | يحدد مصدر قسم الكتاب. |
| JournalArticle | `3` | يحدد مصدر المقالة في المجلة. |
| ConferenceProceedings | `4` | يحدد مصدر إجراءات المؤتمر. |
| Report | `5` | يحدد مصدر المراسل. |
| SoundRecording | `6` | يحدد مصدر تسجيل الصوت. |
| Performance | `7` | يحدد مصدر الأداء. |
| Art | `8` | يحدد مصدر الفن. |
| DocumentFromInternetSite | `9` | يحدد المستند من مصدر موقع الإنترنت. |
| InternetSite | `10` | يحدد مصدر موقع الإنترنت. |
| Film | `11` | يحدد مصدر الفيلم. |
| Interview | `12` | يحدد مصدر المقابلة. |
| Patent | `13` | يحدد مصدر براءة الاختراع. |
| Electronic | `14` | يحدد المصدر الإلكتروني. |
| Case | `15` | يحدد مصدر الحالة. |
| Misc | `16` | يحدد المصدر المتنوع. |
