...
description: الوصول إلى شخص معين أو تعديله في PersonCollection حسب الفهرس. بسّط إدارة البيانات باستخدام هذه الخاصية الأساسية للترميز الفعّال!
type: docs
weight: 30
url: /ar/net/aspose.words.bibliography/personcollection/item/
---
## PersonCollection indexer

يحصل على شخص أو يعينه عند الفهرس المحدد.
