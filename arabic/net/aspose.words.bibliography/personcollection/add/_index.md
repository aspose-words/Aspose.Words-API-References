...
description: أضف شخصًا إلى مجموعتك بسهولة باستخدام طريقة إضافة PersonCollection. سهّل إدارة البيانات وحسّن كفاءة مشروعك!
type: docs
weight: 40
url: /ar/net/aspose.words.bibliography/personcollection/add/
---
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| person | Person | الشخص الذي يجب إضافته إلى المجموعة. |
