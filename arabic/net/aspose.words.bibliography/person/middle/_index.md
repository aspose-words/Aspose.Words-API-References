...
description: اكتشف كيفية إدارة الاسم الأوسط لأي شخص بسهولة من خلال خاصية سهلة الاستخدام. بسّط معالجة بياناتك وحسّن تطبيقاتك اليوم!
type: docs
weight: 40
url: /ar/net/aspose.words.bibliography/person/middle/
---
## Person.Middle property

يحصل على الاسم الأوسط للشخص أو يعينه.
