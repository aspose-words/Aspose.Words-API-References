...
description: إدارة بياناتك الشخصية بسهولة مع خاصية "اسم العائلة". احصل على اسم العائلة أو حدّده بسهولة لتسهيل معالجة البيانات.
type: docs
weight: 30
url: /ar/net/aspose.words.bibliography/person/last/
---
## Person.Last property

يحصل على الاسم الأخير للشخص أو يعينه.
