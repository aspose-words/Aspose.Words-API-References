...
description: اكتشف فئة Aspose.Words.Bibliography.Person لإدارة المساهمين في قوائم المراجع. حسّن دقة الاستشهادات في مستندك!
type: docs
weight: 180
url: /ar/net/aspose.words.bibliography/person/
---
## Person class

يمثل مساهمًا فرديًا (شخصًا) في مصدر الببليوغرافيا.
...
| اسم | وصف |
| --- | --- |
| [Person](person/)(*string, string, string*) | قم بتهيئة مثيل جديد لـ`Person` الصف. |

## الخصائص

| اسم | وصف |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | يحصل على الاسم الأول للشخص أو يعينه. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | يحصل على الاسم الأخير للشخص أو يعينه. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | يحصل على الاسم الأوسط للشخص أو يعينه. |
