...
description: اكتشف خاصية Person First، وقم بإدارة وتخصيص الاسم الأول للأفراد بسهولة للحصول على تجارب مخصصة ودقة بيانات محسنة.
type: docs
weight: 20
url: /ar/net/aspose.words.bibliography/person/first/
---
## Person.First property

يحصل على الاسم الأول للشخص أو يعينه.
