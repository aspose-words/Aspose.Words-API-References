...
description: اكتشف خاصية "المُقابل" في ContributorCollection لإدارة وتخصيص تفاصيل المُقابل بكفاءة لمصادرك. حسّن تنظيم بياناتك!
type: docs
weight: 100
url: /ar/net/aspose.words.bibliography/contributorcollection/interviewee/
---
## ContributorCollection.Interviewee property

يحصل على أو يعين الشخص الذي تتم مقابلته مع المصدر.
