...
description: اكتشف خاصية ContributorCollection Translator، وقم بإدارة وتخصيص مترجمي المصدر بسهولة لتحسين إمكانية الوصول إلى المحتوى الخاص بك وتفاعل المستخدمين معه.
type: docs
weight: 150
url: /ar/net/aspose.words.bibliography/contributorcollection/translator/
---
## ContributorCollection.Translator property

يحصل على مترجم المصدر أو يعينه.
