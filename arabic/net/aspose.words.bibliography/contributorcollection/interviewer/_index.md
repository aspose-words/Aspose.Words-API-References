...
description: اكتشف خاصية "المُقابل" في ContributorCollection، وأدِر وخصّص تفاصيل المُقابل لمصادرك بسهولة. عزّز إدارة بياناتك اليوم!
type: docs
weight: 110
url: /ar/net/aspose.words.bibliography/contributorcollection/interviewer/
---
## ContributorCollection.Interviewer property

يحصل على أو يعين المحاور الخاص بالمصدر.
