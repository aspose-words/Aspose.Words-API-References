...
description: اكتشف خاصية Conductor في ContributorCollection، وقم بإدارة وتخصيص الموصل المصدر بسهولة لتحسين تنظيم البيانات والتحكم فيها.
type: docs
weight: 60
url: /ar/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

يحصل على موصل المصدر أو يعينه.
