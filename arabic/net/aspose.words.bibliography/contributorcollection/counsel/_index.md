...
description: اكتشف مستشاري ContributorCollection. أدر مستشاريك بسهولة ووفر لهم الوصول إلى مصادر الاستشارات لتحسين فهمك للعقارات وتبسيط عملية اتخاذ القرارات.
type: docs
weight: 70
url: /ar/net/aspose.words.bibliography/contributorcollection/counsel/
---
## ContributorCollection.Counsel property

يحصل على نصيحة المصدر أو يعينها.
