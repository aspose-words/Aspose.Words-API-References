...
description: اكتشف خاصية ContributorCollection BookAuthor، وقم بإدارة وتخصيص مؤلفي الكتب لمصادر المعلومات الخاصة بك بسهولة، مما يعمل على تحسين تنظيم المحتوى الخاص بك.
type: docs
weight: 30
url: /ar/net/aspose.words.bibliography/contributorcollection/bookauthor/
---
## ContributorCollection.BookAuthor property

يحصل على مؤلف الكتاب للمصدر أو يعينه.
