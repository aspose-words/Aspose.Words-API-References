...
description: أدر مجموعة مساهماتك بسهولة! عيّن أو احصل على مُحرّر المصادر لتحسين سير عملك وتبسيط إدارة المحتوى.
type: docs
weight: 90
url: /ar/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

يحصل على محرر المصدر أو يعينه.
