...
description: أدر مجموعة مساهماتك بسهولة. عيّن أو حدّث مدير كل مصدر بسهولة، مما يُحسّن التنظيم والكفاءة.
type: docs
weight: 80
url: /ar/net/aspose.words.bibliography/contributorcollection/director/
---
## ContributorCollection.Director property

يحصل على مخرج المصدر أو يعينه.
