...
description: اكتشف خاصية مُجمِّع ContributorCollection لإدارة مُجمِّعات المصدر بكفاءة. حسّن تجربة البرمجة لديك بسهولة الوصول والتحكم!
type: docs
weight: 40
url: /ar/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

يحصل على مُجمِّع المصدر أو يُعيِّنه.
