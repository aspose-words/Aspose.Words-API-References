...
description: اكتشف فئة Aspose.Words.Bibliography.ContributorCollection لإدارة المساهمين في المراجع بكفاءة وتحسين مراجع مستندك.
type: docs
weight: 160
url: /ar/net/aspose.words.bibliography/contributorcollection/
---
## ContributorCollection class

يمثل المساهمين في مصدر المراجع.
...
| اسم | وصف |
| --- | --- |
| [Artist](../../aspose.words.bibliography/contributorcollection/artist/) { get; set; } | يحصل على الفنان الخاص بالمصدر أو يعينه. |
| [Author](../../aspose.words.bibliography/contributorcollection/author/) { get; set; } | يحصل على مؤلف المصدر أو يعينه. |
| [BookAuthor](../../aspose.words.bibliography/contributorcollection/bookauthor/) { get; set; } | يحصل على مؤلف الكتاب للمصدر أو يعينه. |
| [Compiler](../../aspose.words.bibliography/contributorcollection/compiler/) { get; set; } | يحصل على مُجمِّع المصدر أو يُعيِّنه. |
| [Composer](../../aspose.words.bibliography/contributorcollection/composer/) { get; set; } | يحصل على مؤلف المصدر أو يعينه. |
| [Conductor](../../aspose.words.bibliography/contributorcollection/conductor/) { get; set; } | يحصل على موصل المصدر أو يعينه. |
| [Counsel](../../aspose.words.bibliography/contributorcollection/counsel/) { get; set; } | يحصل على نصيحة المصدر أو يعينها. |
| [Director](../../aspose.words.bibliography/contributorcollection/director/) { get; set; } | يحصل على مخرج المصدر أو يعينه. |
| [Editor](../../aspose.words.bibliography/contributorcollection/editor/) { get; set; } | يحصل على محرر المصدر أو يعينه. |
| [Interviewee](../../aspose.words.bibliography/contributorcollection/interviewee/) { get; set; } | يحصل على أو يعين الشخص الذي تتم مقابلته مع المصدر. |
| [Interviewer](../../aspose.words.bibliography/contributorcollection/interviewer/) { get; set; } | يحصل على أو يعين المحاور الخاص بالمصدر. |
| [Inventor](../../aspose.words.bibliography/contributorcollection/inventor/) { get; set; } | يحصل على مخترع المصدر أو يعينه. |
| [Performer](../../aspose.words.bibliography/contributorcollection/performer/) { get; set; } | يحصل على أو يعين أداء المصدر. |
| [Producer](../../aspose.words.bibliography/contributorcollection/producer/) { get; set; } | يحصل على منتج المصدر أو يعينه. |
| [Translator](../../aspose.words.bibliography/contributorcollection/translator/) { get; set; } | يحصل على مترجم المصدر أو يعينه. |
| [Writer](../../aspose.words.bibliography/contributorcollection/writer/) { get; set; } | يحصل على كاتب المصدر أو يعينه. |
