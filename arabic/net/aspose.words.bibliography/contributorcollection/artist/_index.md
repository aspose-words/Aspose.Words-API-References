...
description: اكتشف خاصية ContributorCollection Artist لإدارة وتخصيص الفنانين المصدرين بسهولة لتحسين التنظيم والإبداع في مشاريعك.
type: docs
weight: 10
url: /ar/net/aspose.words.bibliography/contributorcollection/artist/
---
## ContributorCollection.Artist property

يحصل على الفنان الخاص بالمصدر أو يعينه.
