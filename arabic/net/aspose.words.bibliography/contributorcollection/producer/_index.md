...
description: قم بإدارة الوسائط الخاصة بك باستخدام خاصية Producer في ContributorCollection—يمكنك بسهولة تعيين منتج المصدر أو استرداده لتنظيم المحتوى بشكل مبسط.
type: docs
weight: 140
url: /ar/net/aspose.words.bibliography/contributorcollection/producer/
---
## ContributorCollection.Producer property

يحصل على منتج المصدر أو يعينه.
