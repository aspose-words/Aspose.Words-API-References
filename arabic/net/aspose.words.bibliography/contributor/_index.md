...
description: اكتشف فئة Aspose.Words.Bibliography.Contributor، الحل الأمثل لإدارة المساهمين في المراجع، بما في ذلك المؤسسات والأفراد.
type: docs
weight: 150
url: /ar/net/aspose.words.bibliography/contributor/
---
## Contributor class

يُمثل مُساهمًا في مصدر ببليوغرافي. يُمكن أن يكون إما شركة (منظمة) أو قائمة أشخاص.
