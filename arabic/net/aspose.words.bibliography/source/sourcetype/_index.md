...
description: اكتشف خاصية SourceType لإدارة مصادر بياناتك بسهولة. احصل على أنواع المصادر أو عيّنها بسهولة لتحسين تنظيم بياناتك.
type: docs
weight: 410
url: /ar/net/aspose.words.bibliography/source/sourcetype/
---
## Source.SourceType property

يحصل على نوع المصدر أو يعينه.
