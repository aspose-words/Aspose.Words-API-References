...
description: اكتشف قائمة شاملة بالمساهمين - مؤلفين ومحررين وكتاب - لتكون مصدرك. عزز بحثك بمعلومات قيّمة!
type: docs
weight: 120
url: /ar/net/aspose.words.bibliography/source/contributors/
---
## Source.Contributors property

يحصل على قائمة المساهمين (المؤلف، المحرر، الكاتب، إلخ) في المصدر.
