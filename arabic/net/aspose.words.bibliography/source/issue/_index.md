...
description: أدر مشكلاتك المصدرية بسهولة. احصل على خصائص المصدر أو عيّنها بسهولة لتبسيط سير عملك وزيادة إنتاجيتك.
type: docs
weight: 240
url: /ar/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

يحصل على مشكلة المصدر أو يعينها.
