...
description: اكتشف خاصية BookTitle لإدارة وتخصيص عناوين كتبك بسهولة. عزّز إدارة مصادرك بهذه الميزة الأساسية!
type: docs
weight: 40
url: /ar/net/aspose.words.bibliography/source/booktitle/
---
## Source.BookTitle property

يحصل على عنوان الكتاب الخاص بالمصدر أو يعينه.
