...
description: اكتشف خاصية "مذيع المصدر"، وأدر مذيع مصدرك بسهولة لتحسين التحكم في البث والأداء. حسّن تجربة الوسائط لديك!
type: docs
weight: 50
url: /ar/net/aspose.words.bibliography/source/broadcaster/
---
## Source.Broadcaster property

يحصل على أو يعين مذيع المصدر.
