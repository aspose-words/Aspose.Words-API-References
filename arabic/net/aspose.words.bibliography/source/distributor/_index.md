...
description: اكتشف خاصية موزع المصدر لإدارة إعدادات موزع المصدر وتخصيصها بسهولة لتحقيق الأداء الأمثل.
type: docs
weight: 180
url: /ar/net/aspose.words.bibliography/source/distributor/
---
## Source.Distributor property

يحصل على موزع المصدر أو يعينه.
