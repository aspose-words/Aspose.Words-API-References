...
description: أدر عنوان بثّ مصدرك بسهولة مع خاصية BroadcastTitle سهلة الاستخدام. عزّز ظهور محتواك وتفاعله اليوم!
type: docs
weight: 60
url: /ar/net/aspose.words.bibliography/source/broadcasttitle/
---
## Source.BroadcastTitle property

يحصل على عنوان البث للمصدر أو يعينه.
