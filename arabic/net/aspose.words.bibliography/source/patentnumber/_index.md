...
description: أدر بيانات براءات الاختراع الخاصة بك بسهولة باستخدام خاصية "رقم براءة الاختراع المصدر". استرجع أو حدّث أرقام براءات الاختراع بسهولة لتبسيط تتبع المصدر.
type: docs
weight: 320
url: /ar/net/aspose.words.bibliography/source/patentnumber/
---
## Source.PatentNumber property

يحصل على رقم براءة الاختراع للمصدر أو يعينه.
