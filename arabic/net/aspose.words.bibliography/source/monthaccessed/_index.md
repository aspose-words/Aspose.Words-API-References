...
description: إدارة شهر الوصول لمصدرك بسهولة. حدّد أو استرجاع شهر الوصول بسهولة لضمان تتبع البيانات وتنظيمها على النحو الأمثل.
type: docs
weight: 290
url: /ar/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

يحصل على الشهر الذي تم الوصول إليه من المصدر أو يعينه.
