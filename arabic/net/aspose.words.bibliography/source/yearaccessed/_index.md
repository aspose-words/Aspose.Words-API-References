...
description: إدارة خاصية الوصول إلى سنة المصدر بسهولة. احصل على سنة الوصول أو حدّدها لضمان دقة الاستشهادات وإدارة بحثية مبسطة.
type: docs
weight: 540
url: /ar/net/aspose.words.bibliography/source/yearaccessed/
---
## Source.YearAccessed property

يحصل على سنة الوصول إلى المصدر أو يعينها.
