...
description: أدر خاصية معرف المصدر (GUID) بسهولة. احصل على معرف المصدر (GUID) أو عيّنه بسهولة لتسهيل معالجة البيانات وتحسين تنظيمها.
type: docs
weight: 210
url: /ar/net/aspose.words.bibliography/source/guid/
---
## Source.Guid property

يحصل على أو يعين معرف المصدر.
