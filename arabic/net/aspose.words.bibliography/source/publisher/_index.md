...
description: أدر خصائص ناشر المصدر بسهولة. حدّد أو استرجاع تفاصيل الناشر بسهولة لإدارة مصادرك بسلاسة.
type: docs
weight: 360
url: /ar/net/aspose.words.bibliography/source/publisher/
---
## Source.Publisher property

يحصل على ناشر المصدر أو يعينه.
