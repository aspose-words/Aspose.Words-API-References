...
description: أدر خاصية "رقم المصدر القياسي" بسهولة. احصل على الرقم القياسي أو عيّنه بسهولة لضمان تكامل البيانات ودقتها بسلاسة.
type: docs
weight: 420
url: /ar/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

يحصل على الرقم القياسي للمصدر أو يعينه.
