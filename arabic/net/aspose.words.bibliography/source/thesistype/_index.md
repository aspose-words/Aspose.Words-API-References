...
description: اكتشف كيفية إدارة أنواع الأطروحات باستخدام خاصية ThesisType. احصل على أنواع الأطروحات المصدرية أو عيّنها بسهولة لإدارة بحثك بشكل مبسط.
type: docs
weight: 470
url: /ar/net/aspose.words.bibliography/source/thesistype/
---
## Source.ThesisType property

يحصل على نوع أطروحة المصدر أو يعينه.
