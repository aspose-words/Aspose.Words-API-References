...
description: أدر عنوان URL المصدر الخاص بك بسهولة. عيّن أو استرجاع عناوين URL بسهولة، مما يُحسّن إدارة بياناتك ويُبسّط سير عملك.
type: docs
weight: 500
url: /ar/net/aspose.words.bibliography/source/url/
---
## Source.Url property

يحصل على عنوان URL للمصدر أو يعينه.
