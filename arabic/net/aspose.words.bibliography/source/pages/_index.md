...
description: أدر صفحات المصدر بسهولة. استرجاع أو ضبط تفاصيل صفحات المصدر بسهولة لتحسين تنظيم المحتوى وكفاءة سير العمل.
type: docs
weight: 310
url: /ar/net/aspose.words.bibliography/source/pages/
---
## Source.Pages property

يحصل على صفحات المصدر أو يعينها.
