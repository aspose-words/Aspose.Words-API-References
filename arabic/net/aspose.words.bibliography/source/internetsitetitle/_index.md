...
description: أدر عنوان موقعك الإلكتروني المصدر بسهولة. حدّث أو استرجاع عنوان موقعك الإلكتروني بسهولة لتحسين ظهوره على الإنترنت وعلامته التجارية.
type: docs
weight: 230
url: /ar/net/aspose.words.bibliography/source/internetsitetitle/
---
## Source.InternetSiteTitle property

يحصل على عنوان موقع الإنترنت الخاص بالمصدر أو يعينه.
