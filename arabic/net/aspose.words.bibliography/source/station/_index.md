...
description: أدر محطة المصدر الخاصة بك بكل سهولة. اضبط أو استرجاع محطة المصدر بسهولة لضمان تكامل سلس للبيانات وزيادة الكفاءة.
type: docs
weight: 440
url: /ar/net/aspose.words.bibliography/source/station/
---
## Source.Station property

يحصل على محطة المصدر أو يعينها.
