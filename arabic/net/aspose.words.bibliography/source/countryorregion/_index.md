...
description: أدر مواقع المصدر بسهولة باستخدام خاصية CountryOrRegion. احصل على بلد أو منطقة مصدرك أو عيّنها بسهولة لتسهيل معالجة البيانات.
type: docs
weight: 130
url: /ar/net/aspose.words.bibliography/source/countryorregion/
---
## Source.CountryOrRegion property

يحصل على البلد أو المنطقة الخاصة بالمصدر أو يعينها.
