...
description: أدر قسمك المصدر بسهولة. احصل على تفاصيل القسم أو حدّدها بسهولة لتحسين التنظيم والكفاءة. اكتشف التكامل السلس اليوم!
type: docs
weight: 170
url: /ar/net/aspose.words.bibliography/source/department/
---
## Source.Department property

يحصل على قسم المصدر أو يعينه.
