...
description: أدر تواريخ مصدرك بسهولة مع Source Day. حدّد أو استرجاع تواريخ المصدر بسهولة لتبسيط سير عملك وتعزيز إنتاجيتك.
type: docs
weight: 150
url: /ar/net/aspose.words.bibliography/source/day/
---
## Source.Day property

يحصل على يوم المصدر أو يعينه.
