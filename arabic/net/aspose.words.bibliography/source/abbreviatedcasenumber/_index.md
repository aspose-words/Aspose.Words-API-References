...
description: أدر رقم قضيتك المختصرة بسهولة باستخدام أداتنا سهلة الاستخدام. سهّل تتبع قضيتك اليوم!
type: docs
weight: 20
url: /ar/net/aspose.words.bibliography/source/abbreviatedcasenumber/
---
## Source.AbbreviatedCaseNumber property

يحصل على رقم الحالة المختصر للمصدر أو يعينه.
