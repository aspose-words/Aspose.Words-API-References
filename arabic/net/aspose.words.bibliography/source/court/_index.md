...
description: اكتشف حلول "سورس كورت" العقارية. أدر موارد المحكمة الخاصة بك وحددها بسهولة لتبسيط الإجراءات القانونية وزيادة الكفاءة.
type: docs
weight: 140
url: /ar/net/aspose.words.bibliography/source/court/
---
## Source.Court property

يحصل على محكمة المصدر أو يضبطها.
