...
description: أدر بيانات شهر المصدر بسهولة. احصل على الشهر أو حدّده بسهولة لأي مصدر، مما يُحسّن تنظيم بياناتك وكفاءتها.
type: docs
weight: 280
url: /ar/net/aspose.words.bibliography/source/month/
---
## Source.Month property

يحصل على شهر المصدر أو يعينه.
