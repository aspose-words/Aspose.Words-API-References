...
description: إدارة خصائص Lcid بسهولة. احصل على مُعرِّف الموقع المحلي لمصدرك أو عيِّنه لضمان توطين سلس وتجربة مستخدم مُحسَّنة.
type: docs
weight: 260
url: /ar/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

يحصل على معرف الإعدادات المحلية للمصدر أو يعينه.
