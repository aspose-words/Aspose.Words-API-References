...
description: يمكنك إدارة رقم الفصل الخاص بمصدرك بسهولة باستخدام خاصية ChapterNumber - سهلة الاستخدام وضرورية للإشارة المنظمة.
type: docs
weight: 80
url: /ar/net/aspose.words.bibliography/source/chapternumber/
---
## Source.ChapterNumber property

يحصل على رقم الفصل الخاص بالمصدر أو يعينه.
