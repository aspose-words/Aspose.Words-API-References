...
description: إدارة أحجام بيانات المصدر بسهولة. اضبط عدد الأحجام لإدارة مثالية للمصادر، وحسّن تنظيم بياناتك بسهولة.
type: docs
weight: 300
url: /ar/net/aspose.words.bibliography/source/numbervolumes/
---
## Source.NumberVolumes property

يحصل على عدد وحدات التخزين الخاصة بالمصدر أو يعينها.
