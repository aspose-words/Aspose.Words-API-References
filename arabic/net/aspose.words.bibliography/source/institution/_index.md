...
description: أدر خصائص مؤسستك المصدرية بسهولة. حدّد أو حدّث تفاصيل مؤسستك بسهولة لتنظيم بياناتك بشكل مبسط وتحسين إمكانية الوصول إليها.
type: docs
weight: 220
url: /ar/net/aspose.words.bibliography/source/institution/
---
## Source.Institution property

يحصل على مؤسسة المصدر أو يعينها.
