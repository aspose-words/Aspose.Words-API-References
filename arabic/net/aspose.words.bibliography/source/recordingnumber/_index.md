...
description: قم بإدارة تسجيلاتك بسهولة باستخدام خاصية Source RecordingNumber—استرداد أو تحديث أرقام التسجيل المصدر بسرعة لإدارة الصوت بسلاسة.
type: docs
weight: 370
url: /ar/net/aspose.words.bibliography/source/recordingnumber/
---
## Source.RecordingNumber property

يحصل على رقم التسجيل للمصدر أو يعينه.
