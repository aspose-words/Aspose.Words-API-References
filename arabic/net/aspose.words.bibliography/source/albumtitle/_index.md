...
description: أدر عنوان ألبومك المصدر بسهولة باستخدام خاصية عنوان الألبوم. احصل على العناوين أو عيّنها بسهولة لتحسين التنظيم وسهولة الوصول.
type: docs
weight: 30
url: /ar/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

يحصل على عنوان الألبوم الخاص بالمصدر أو يعينه.
