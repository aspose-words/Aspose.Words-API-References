...
description: أدر خاصية مُبلّغ المصدر بسهولة. احصل على المُبلّغ أو عيّنه بسهولة لأي مصدر، وحسّن كفاءة إدارة بياناتك.
type: docs
weight: 390
url: /ar/net/aspose.words.bibliography/source/reporter/
---
## Source.Reporter property

يحصل على مُبلّغ المصدر أو يُعيّنه.
