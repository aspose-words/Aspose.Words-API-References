...
description: اكتشف كيفية إدارة خصائص StateOrProvince بسهولة. احصل على الولاية أو المقاطعة أو حدّدها بسهولة لأي مصدر من خلال دليلنا السهل الاستخدام!
type: docs
weight: 430
url: /ar/net/aspose.words.bibliography/source/stateorprovince/
---
## Source.StateOrProvince property

يحصل على حالة أو مقاطعة المصدر أو يعينها.
