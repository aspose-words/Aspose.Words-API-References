...
description: أدر شركة الإنتاج الخاصة بك بكل سهولة مع Source ProductionCompany. حدّد أو حدّث تفاصيل إنتاج مصدرك بسهولة لضمان تعاون سلس.
type: docs
weight: 340
url: /ar/net/aspose.words.bibliography/source/productioncompany/
---
## Source.ProductionCompany property

يحصل على شركة الإنتاج الخاصة بالمصدر أو يعينها.
