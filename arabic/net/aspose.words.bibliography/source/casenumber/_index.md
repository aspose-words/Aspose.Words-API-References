...
description: أدر رقم حالة مصدرك بسهولة باستخدام خاصية "رقم حالة المصدر". بسّط عملية التتبع وحسّن تنظيمك لتحقيق نتائج أفضل.
type: docs
weight: 70
url: /ar/net/aspose.words.bibliography/source/casenumber/
---
## Source.CaseNumber property

يحصل على رقم الحالة للمصدر أو يعينه.
