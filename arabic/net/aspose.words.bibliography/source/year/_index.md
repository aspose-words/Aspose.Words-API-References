...
description: أدر بيانات سنة المصدر بسهولة. احصل على سنة المصدر أو حدّدها بسهولة لتنظيم بياناتك بشكل مبسط ودقة أعلى.
type: docs
weight: 530
url: /ar/net/aspose.words.bibliography/source/year/
---
## Source.Year property

يحصل على سنة المصدر أو يعينها.
