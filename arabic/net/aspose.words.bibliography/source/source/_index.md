...
description: أنشئ بسهولة نسخة جديدة من فئة المصدر باستخدام مُنشئنا. بسّط عملية البرمجة لديك وحسّن كفاءة مشروعك اليوم!
type: docs
weight: 10
url: /ar/net/aspose.words.bibliography/source/source/
---
## Source constructor

قم بتهيئة مثيل جديد لـ[`Source`](../) الصف.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| tag | String | اسم العلامة التعريفية. |
| sourceType | SourceType | نوع المصدر. |
