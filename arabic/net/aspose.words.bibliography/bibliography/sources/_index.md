...
description: اكتشف مجموعة شاملة من مصادر المراجع، مثالية لتعزيز البحث وضمان الاستشهادات الدقيقة في مشاريعك.
type: docs
weight: 20
url: /ar/net/aspose.words.bibliography/bibliography/sources/
---
## Bibliography.Sources property

يحصل على مجموعة تمثل جميع المصادر الموجودة في قائمة المراجع.
