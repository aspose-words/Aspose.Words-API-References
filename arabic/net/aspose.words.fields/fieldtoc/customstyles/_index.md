...
description: خصّص جدول محتوياتك باستخدام خاصية CustomStyles في FieldToc. أضف أنماطًا فريدة بسهولة تتجاوز العناوين المدمجة لعرض محسّن.
type: docs
weight: 40
...
يحصل على قائمة أنماط أخرى غير أنماط العناوين المضمنة لتضمينها في جدول المحتويات أو يعينها.
