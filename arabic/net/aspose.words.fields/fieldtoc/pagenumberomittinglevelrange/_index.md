...
description: اكتشف خاصية FieldToc PageNumberOmittingLevelRange لتخصيص جدول المحتويات الخاص بك عن طريق حذف أرقام الصفحات لمستويات إدخال محددة.
type: docs
weight: 110
...
يحصل على نطاق من مستويات إدخالات جدول المحتويات أو يعينه لحذف أرقام الصفحات منه.
