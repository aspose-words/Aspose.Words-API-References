...
description: اكتشف كيف تعمل خاصية FieldToc PreserveTabs على تعزيز إدارة البيانات لديك من خلال الحفاظ على إدخالات علامات التبويب في إدخالات الجدول لتحسين التنظيم.
type: docs
weight: 140
...
يحصل على أو يحدد ما إذا كان سيتم الاحتفاظ بإدخالات علامة التبويب داخل إدخالات الجدول.
