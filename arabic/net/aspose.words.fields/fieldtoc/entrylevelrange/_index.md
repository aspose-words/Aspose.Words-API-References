...
description: اكتشف خاصية FieldToc EntryLevelRange لتخصيص مستويات جدول المحتويات بسهولة لتحسين التنقل وتجربة المستخدم.
type: docs
weight: 60
...
يحصل على نطاق من مستويات إدخالات جدول المحتويات المراد تضمينها أو يعينه.
