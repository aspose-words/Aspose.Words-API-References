...
description: FieldToc ملكية. الحصول على أو تعيين سلسلة يجب أن تتطابق مع معرفات النوع الخاصة بحقول TC التي يتم تضمينها.
type: docs
weight: 50
...
الحصول على أو تعيين سلسلة يجب أن تتطابق مع معرفات النوع الخاصة بحقول TC التي يتم تضمينها.
