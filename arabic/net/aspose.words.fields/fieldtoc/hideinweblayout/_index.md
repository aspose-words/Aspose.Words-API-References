...
description: FieldToc ملكية. الحصول على أو تحديد ما إذا كان سيتم إخفاء قائد علامة التبويب وأرقام الصفحات في عرض تخطيط الويب.
type: docs
weight: 90
...
الحصول على أو تحديد ما إذا كان سيتم إخفاء قائد علامة التبويب وأرقام الصفحات في عرض تخطيط الويب.
