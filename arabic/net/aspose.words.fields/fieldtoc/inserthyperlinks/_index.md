...
description: تحكّم في الروابط التشعبية في جدول المحتويات باستخدام FieldToc InsertHyperlinks. حسّن تجربة المستخدم وتصفحه بسهولة!
type: docs
weight: 100
...
يحصل على أو يحدد ما إذا كان سيتم جعل إدخالات جدول المحتويات روابط تشعبية.
