...
description: اكتشف خاصية FieldToc TableOfFiguresLabel لتخصيص جدول الأشكال بسهولة. حسّن تنظيم مستندك ووضوحه!
type: docs
weight: 160
...
يحصل على اسم معرف التسلسل المستخدم عند إنشاء جدول الأشكال أو يعينه.
