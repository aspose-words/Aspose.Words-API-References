...
description: اكتشف خاصية FieldToc HeadingLevelRange لإدارة مستويات العناوين بسهولة لتحسين تنظيم المحتوى وتحسين محركات البحث.
type: docs
weight: 80
url: /ar/net/aspose.words.fields/fieldtoc/headinglevelrange/
---
## FieldToc.HeadingLevelRange property

يحصل على نطاق من مستويات العنوان المراد تضمينها أو يعينه.
