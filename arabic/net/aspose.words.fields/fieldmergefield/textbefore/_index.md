...
description: FieldMergeField ملكية. الحصول على أو تعيين النص الذي سيتم إدراجه قبل الحقل إذا لم يكن الحقل فارغًا.
type: docs
weight: 60
...
الحصول على أو تعيين النص الذي سيتم إدراجه قبل الحقل إذا لم يكن الحقل فارغًا.
