...
description: FieldToa ملكية. الحصول على أو تعيين تسلسل الأحرف المستخدم لفصل رقمي صفحتين في قائمة أرقام الصفحات.
type: docs
weight: 50
...
الحصول على أو تعيين تسلسل الأحرف المستخدم لفصل رقمي صفحتين في قائمة أرقام الصفحات.
