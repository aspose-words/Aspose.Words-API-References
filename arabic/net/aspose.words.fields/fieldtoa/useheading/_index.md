...
description: اكتشف كيف تعمل خاصية FieldToa UseHeading على تعزيز جدول السلطات الخاص بك عن طريق إضافة عناوين الفئات لتحسين التنظيم والوضوح.
type: docs
weight: 100
...
يحصل على أو يحدد ما إذا كان سيتم تضمين عنوان الفئة للإدخالات في جدول السلطات.
