...
description: اكتشف خاصية EntryCategory في FieldToa لإدارة وتخصيص الفئات المتكاملة لإدخالات جدولك بكفاءة. حسّن تنظيمك اليوم!
type: docs
weight: 30
url: /ar/net/aspose.words.fields/fieldtoa/entrycategory/
---
## FieldToa.EntryCategory property

يحصل على الفئة المتكاملة للإدخالات المضمنة في الجدول أو يعينها.
