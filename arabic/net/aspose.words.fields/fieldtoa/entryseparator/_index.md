...
description: اكتشف خاصية FieldToa EntrySeparator لتخصيص جدول السلطات الخاص بك بسهولة باستخدام تسلسلات أحرف مرنة لتحسين الوضوح.
type: docs
weight: 40
...
يحصل على أو يعين تسلسل الأحرف المستخدم لفصل إدخال جدول السلطات ورقم الصفحة الخاص به.
