...
description: حسّن استشهاداتك باستخدام FieldToa UsePassim. أدر بسهولة مراجع متعددة لنفس المرجع، مما يعزز الوضوح والدقة في عملك.
type: docs
weight: 110
...
يحصل على أو يحدد ما إذا كان سيتم استبدال خمسة أو أكثر من المراجع المختلفة للصفحات لنفس المرجع بـ "passim"، والذي يستخدم للإشارة إلى أن الكلمة أو المقطع يظهر بشكل متكرر في العمل المذكور.
