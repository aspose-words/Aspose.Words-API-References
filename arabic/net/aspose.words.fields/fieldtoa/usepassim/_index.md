...
description: الحصول على أو تعيين ما إذا كان سيتم استبدال خمسة أو أكثر من مراجع الصفحات المختلفة لنفس المرجع بـ passim  والتي تُستخدم للإشارة إلى أن الكلمة أو المقطع يحدث بشكل متكرر في العمل المذكور.
type: docs
weight: 110
