...
description: اكتشف خاصية FieldToa BookmarkName لإدارة الإشارات المرجعية في مستنداتك بسهولة، وتحسين إنشاء الجدول وتحسين التنقل في المستندات.
type: docs
weight: 20
url: /ar/net/aspose.words.fields/fieldtoa/bookmarkname/
---
## FieldToa.BookmarkName property

يحصل على اسم الإشارة المرجعية التي تحدد الجزء من المستند المستخدم لبناء الجدول أو يعينه.
