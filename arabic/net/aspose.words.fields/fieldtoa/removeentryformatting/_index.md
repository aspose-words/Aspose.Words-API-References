...
description: FieldToa ملكية. الحصول على أو تحديد ما إذا كان سيتم إزالة تنسيق نص الإدخال في المستند من الإدخال في جدول المراجع.
type: docs
weight: 70
...
الحصول على أو تحديد ما إذا كان سيتم إزالة تنسيق نص الإدخال في المستند من الإدخال في جدول المراجع.
