...
description: تحكّم بتنسيق إدخالات النصوص في مستندك باستخدام خاصية RemoveEntryFormatting في FieldToa. حسّن جدول المصادر الخاص بك بسهولة!
type: docs
weight: 70
...
يحصل على أو يحدد ما إذا كان سيتم إزالة تنسيق نص الإدخال في المستند من الإدخال في جدول السلطات.
