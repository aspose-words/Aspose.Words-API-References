...
description: Aspose.Words.Fields.FieldToa فصل. تنفذ حقل TOA .
type: docs
weight: 2370
...
يُنشئ جدول مراجع مصدقة (أي قائمة بالمراجع في مستند قانوني ، مثل المراجع للحالات والقوانين والقواعد ، إلى جانب أرقام الصفحات التي تظهر عليها المراجع) باستخدام الإدخالات المحددة بواسطة TA الحقول.
