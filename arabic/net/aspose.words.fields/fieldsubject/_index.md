...
description: Aspose.Words.Fields.FieldSubject فصل. ينفذ الحقل SUBJECT .
type: docs
weight: 2300
...
| [Text](../../aspose.words.fields/fieldsubject/text/) { get; set; } | الحصول على نص الموضوع أو تحديده. |
...
استرداد ، واختيار موضوع المستند ، كما هو مسجل في ملف **موضوعات**خاصية the خصائص المستند المضمنة .
