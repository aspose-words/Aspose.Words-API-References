...
description: اكتشف فئة Aspose.Words.Fields.FieldNumChars، المصممة لتنفيذ حقل NUMCHARS بكفاءة لتحسين معالجة المستندات.
type: docs
weight: 2620
...
يسترد عدد الأحرف في المستند الحالي، كما هو مسجل في**الشخصيات** خاصية خصائص المستند المضمنة .
