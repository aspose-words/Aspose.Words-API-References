...
description: مجموعة منField./field كائنات تمثل الحقول في النطاق المحدد.
type: docs
weight: 1540
...
ال[`FieldCollection`](../fieldcollection) المجموعة لا تملك الحقول التي تحتوي عليها ، بل هي مجرد مجموعة مختارة من الحقول.

ال[`FieldCollection`](../fieldcollection) المجموعة "حية" ، أي التغييرات التي تم إجراؤها على العناصر الفرعية للعقدة object التي تم إنشاؤها منها تنعكس على الفور في الحقول التي يتم إرجاعها بواسطة[`FieldCollection`](../fieldcollection) الخصائص والأساليب.
