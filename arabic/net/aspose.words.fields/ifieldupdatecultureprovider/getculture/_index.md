...
description: IFieldUpdateCultureProvider طريقة. إرجاع أCultureInfo كائن لاستخدامه أثناء تحديث الحقل .
type: docs
weight: 10
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| culture | String | اسم الثقافة المطلوبة للحقل الجاري تحديثه. |
