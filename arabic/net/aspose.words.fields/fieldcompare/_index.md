...
description: Aspose.Words.Fields.FieldCompare فصل. ينفذ حقل المقارنة.
type: docs
weight: 1710
...
| [RightExpression](../../aspose.words.fields/fieldcompare/rightexpression/) { get; set; } | الحصول على أو تعيين الجزء الأيمن من تعبير المقارنة. |
...
يقارن القيم المعينة بالتعبيرات[`LeftExpression`](./leftexpression/) و[`RightExpression`](./rightexpression/) بالمقارنة باستخدام عامل التشغيل المعين بواسطة[`ComparisonOperator`](./comparisonoperator/) .
