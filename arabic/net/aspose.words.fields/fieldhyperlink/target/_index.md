...
description: FieldHyperlink ملكية. الحصول على أو تحديد الهدف الذي يجب إعادة توجيه الارتباط إليه.
type: docs
weight: 70
...
الحصول على أو تحديد الهدف الذي يجب إعادة توجيه الارتباط إليه.
