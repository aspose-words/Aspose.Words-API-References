...
description: FieldHyperlink ملكية. الحصول على أو تعيين موقع في الملف  مثل إشارة مرجعية  حيث ينتقل هذا الارتباط التشعبي.
type: docs
weight: 60
...
الحصول على أو تعيين موقع في الملف ، مثل إشارة مرجعية ، حيث ينتقل هذا الارتباط التشعبي.
