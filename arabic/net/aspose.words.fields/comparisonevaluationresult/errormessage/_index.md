...
description: اكتشف خاصية ComparisonEvaluationResult ErrorMessage، التي تُقدم تحليلات واضحة لنتائج التقييم الفاشلة. حسّن عملية تصحيح الأخطاء لديك اليوم!
type: docs
weight: 20
...
يحصل على رسالة الخطأ الخاصة بنتيجة تقييم المقارنة الفاشلة.
