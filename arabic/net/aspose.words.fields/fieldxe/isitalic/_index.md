...
description: اكتشف كيف تعمل خاصية IsItalic في FieldXE على تعزيز نمط مستندك من خلال تطبيق التنسيق المائل بسهولة على أرقام الصفحات للحصول على مظهر أنيق.
type: docs
weight: 40
...
يحصل على أو يحدد ما إذا كان سيتم تطبيق التنسيق المائل على رقم صفحة الإدخال.
