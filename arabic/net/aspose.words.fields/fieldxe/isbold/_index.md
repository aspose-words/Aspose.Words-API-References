...
description: FieldXE ملكية. الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق غامق على رقم صفحة الإدخال.
type: docs
weight: 30
...
الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق غامق على رقم صفحة الإدخال.
