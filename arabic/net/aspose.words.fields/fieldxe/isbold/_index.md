...
description: حسّن تجربة FieldXE لديك! تحكّم بتنسيق الأرقام بخط غامق لصفحات الإدخال بسهولة باستخدام خاصية IsBold. حسّن سهولة القراءة وأسلوب العرض!
type: docs
weight: 30
url: /ar/net/aspose.words.fields/fieldxe/isbold/
---
## FieldXE.IsBold property

يحصل على أو يحدد ما إذا كان سيتم تطبيق التنسيق الغامق على رقم صفحة الإدخال.
