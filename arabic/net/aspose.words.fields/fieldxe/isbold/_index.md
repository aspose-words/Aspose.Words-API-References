...
description: FieldXE IsBold ملكية. الحصول على أو تعيين ما إذا كان سيتم تطبيق التنسيق الغامق على رقم صفحة الإدخال في C#.
type: docs
weight: 30
...
الحصول على أو تعيين ما إذا كان سيتم تطبيق التنسيق الغامق على رقم صفحة الإدخال.
