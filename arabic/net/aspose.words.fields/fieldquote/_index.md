...
description: Aspose.Words.Fields.FieldQuote فصل. ينفذ حقل عرض الأسعار في C#.
type: docs
weight: 2310
...
| [Text](../../aspose.words.fields/fieldquote/text/) { get; set; } | الحصول على النص أو تعيينه لاسترداده. |
