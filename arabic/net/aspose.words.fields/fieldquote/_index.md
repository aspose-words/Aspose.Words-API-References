...
description: اكتشف فئة Aspose.Words.Fields.FieldQuote، الحل الأمثل لتطبيق حقول QUOTE بكفاءة في المستندات. حسّن سير عملك اليوم!
type: docs
weight: 2720
...
| [Text](../../aspose.words.fields/fieldquote/text/) { get; set; } | يحصل على النص الذي سيتم استرداده أو يعينه. |
