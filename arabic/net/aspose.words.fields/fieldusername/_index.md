...
description: اكتشف فئة Aspose.Words.Fields.FieldUserName لدمج حقل اسم المستخدم بسلاسة. حسّن أتمتة المستندات بميزات فعّالة اليوم!
type: docs
weight: 3010
...
| [UserName](../../aspose.words.fields/fieldusername/username/) { get; set; } | الإشارة إلى اسم المستخدم الحالي أو تعيينه. |
