...
description: اكتشف فئة Aspose.Words.Fields.FieldDocProperty، المصممة للتكامل السلس لحقول DOCPROPERTY في مستنداتك لتحسين الوظائف.
type: docs
weight: 2220
...
يسترجع معلومات المستند المشار إليها.
