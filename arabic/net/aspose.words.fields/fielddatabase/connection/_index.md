...
description: أدر بياناتك بسهولة باستخدام خاصية "اتصال قاعدة بيانات الحقل". احصل على اتصالات أو عيّنها بسهولة لضمان تكامل البيانات بسلاسة.
type: docs
weight: 20
...
يحصل على اتصال بالبيانات أو يعينه.
