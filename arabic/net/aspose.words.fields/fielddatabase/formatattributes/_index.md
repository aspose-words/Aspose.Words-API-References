...
description: اكتشف خاصية FormatAttributes الخاصة بـ FieldDatabase لتخصيص سمات الجدول بسهولة، مما يعزز إدارة البيانات وعرضها.
type: docs
weight: 50
...
يحصل على أو يعين السمات التي سيتم تطبيقها على الجدول.
