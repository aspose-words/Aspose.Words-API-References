...
description: FieldDatabase ملكية. الحصول على أو تحديد سمات التنسيق التي سيتم تطبيقها على الجدول.
type: docs
weight: 50
...
الحصول على أو تحديد سمات التنسيق التي سيتم تطبيقها على الجدول.
