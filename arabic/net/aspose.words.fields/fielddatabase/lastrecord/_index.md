...
description: اكتشف خاصية LastRecord في FieldDatabase. أدر بسهولة رقم سجل بياناتك الأخير لإدخال البيانات بسلاسة وتحسين كفاءة قاعدة البيانات.
type: docs
weight: 80
...
يحصل على رقم السجل الصحيح لسجل البيانات الأخير المراد إدراجه أو يعينه.
