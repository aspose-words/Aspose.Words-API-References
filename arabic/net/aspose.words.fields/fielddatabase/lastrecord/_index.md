...
description: FieldDatabase ملكية. الحصول على أو تعيين رقم السجل المتكامل لآخر سجل بيانات لإدراجه .
type: docs
weight: 80
...
الحصول على أو تعيين رقم السجل المتكامل لآخر سجل بيانات لإدراجه .
