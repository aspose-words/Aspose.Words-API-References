...
description: FieldDatabase ملكية. الحصول على أو تحديد التنسيق الذي سيتم تطبيقه على نتيجة استعلام قاعدة البيانات.
type: docs
weight: 100
...
الحصول على أو تحديد التنسيق الذي سيتم تطبيقه على نتيجة استعلام قاعدة البيانات.
