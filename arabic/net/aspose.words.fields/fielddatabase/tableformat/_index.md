...
description: اكتشف خاصية TableFormat في FieldDatabase لتخصيص نتائج استعلام قاعدة البيانات الخاصة بك بسهولة باستخدام خيارات التنسيق المرنة لتقديم بيانات محسّنة.
type: docs
weight: 100
...
يحصل على التنسيق الذي سيتم تطبيقه على نتيجة استعلام قاعدة البيانات أو يعينه.
