...
description: اكتشف كيف تعمل خاصية InsertOnceOnMailMerge في FieldDatabase على تعزيز عملية دمج البيانات من خلال السماح بالإدراج السلس في بداية عمليات الدمج.
type: docs
weight: 70
url: /ar/net/aspose.words.fields/fielddatabase/insertonceonmailmerge/
---
## FieldDatabase.InsertOnceOnMailMerge property

يحصل على أو يحدد ما إذا كان سيتم إدراج البيانات في بداية الدمج.
