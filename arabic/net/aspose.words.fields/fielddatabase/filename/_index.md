...
description: اكتشف خاصية FileName في FieldDatabase لإدارة المسار الكامل واسم الملف لقاعدة البيانات الخاصة بك بسهولة، مما يعزز تنظيم البيانات لديك وإمكانية الوصول إليها.
type: docs
weight: 30
...
يحصل على المسار الكامل واسم الملف لقاعدة البيانات أو يعينه
