...
description: أدر قاعدة بياناتك بسهولة باستخدام استعلام FieldDatabase. حدّد واحصل على تعليمات SQL بسهولة لاستعلام بيانات فعال.
type: docs
weight: 90
...
يحصل على مجموعة من تعليمات SQL التي تستفسر عن قاعدة البيانات أو يعينها.
