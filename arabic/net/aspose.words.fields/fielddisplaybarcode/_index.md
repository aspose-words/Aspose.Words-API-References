...
description: تنفذ حقل DISPLAYBARCODE .
type: docs
weight: 1650
...
| [BarcodeType](../../aspose.words.fields/fielddisplaybarcode/barcodetype) { get; set; } | الحصول على نوع الرمز الشريطي أو تعيينه (QR ، وما إلى ذلك) _ x000d_ |
...
| [ErrorCorrectionLevel](../../aspose.words.fields/fielddisplaybarcode/errorcorrectionlevel) { get; set; } | الحصول على أو تعيين مستوى تصحيح الخطأ لرمز الاستجابة السريعة. القيم الصالحة هي [0 ، 3] ._ x000d_ |
...
| [PosCodeStyle](../../aspose.words.fields/fielddisplaybarcode/poscodestyle) { get; set; } | الحصول على أو تعيين نمط الرمز الشريطي لنقطة البيع (أنواع الرموز الشريطية UPCA &#x7C; UPCE &#x7C; EAN13 &#x7C; EAN8). القيم الصالحة (غير حساسة لحالة الأحرف) هي [STD &#x7C; SUP2 &#x7C; SUP5 &#x7C; CASE] ._ x000d_ |
...
| [SymbolHeight](../../aspose.words.fields/fielddisplaybarcode/symbolheight) { get; set; } | الحصول على ارتفاع الرمز أو تحديده. الوحدات في TWIPS (1/1440 بوصة). _ x000d_ |
