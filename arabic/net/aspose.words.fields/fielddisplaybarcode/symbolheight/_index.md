...
description: اضبط خاصية SymbolHeight في FieldDisplayBarcode لتخصيص ارتفاع الباركود في TWIPS. حسّن عرض الباركود بدقة!
type: docs
weight: 130
...
يُحدِّد ارتفاع الرمز أو يُحدِّده. الوحدات بوحدة TWIPS (1/1440 بوصة).
