...
description: اكتشف خاصية FieldStyleRef SearchFromBottom، وتحكم في اتجاه البحث على صفحتك لتحسين تجربة المستخدم وزيادة الكفاءة.
type: docs
weight: 60
...
يحصل على أو يحدد ما إذا كان سيتم البحث من أسفل الصفحة الحالية، بدلاً من الأعلى.
