...
description: FieldStyleRef ملكية. الحصول على أو تحديد ما إذا كان سيتم إدراج رقم الفقرة للفقرة المشار إليها تمامًا كما تظهر في المستند.
type: docs
weight: 20
...
الحصول على أو تحديد ما إذا كان سيتم إدراج رقم الفقرة للفقرة المشار إليها تمامًا كما تظهر في المستند.
