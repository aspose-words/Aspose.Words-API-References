...
description: اكتشف فئة Aspose.Words.Fields.FieldUnknown للتعامل بكفاءة مع الحقول غير المعروفة. حسّن معالجة مستنداتك مع التكامل السلس!
type: docs
weight: 2960
...
ينفذ حقلًا غير معروف أو غير معترف به.
...
// أدخل حقلًا لا يشير إلى نوع حقل موضوعي في رمز الحقل الخاص به.
Field field = builder.InsertField(" NOTAREALFIELD //أ");

// نوع الحقل "FieldNone" مخصص للحقول مثل هذه.
Assert.AreEqual(FieldType.FieldNone, field.Type);

// يمكننا أيضًا العمل مع هذه الحقول وتعيينها كمثيلات لفئة FieldUnknown.
