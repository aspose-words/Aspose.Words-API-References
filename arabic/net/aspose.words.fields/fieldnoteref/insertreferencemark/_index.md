...
description: اكتشف خاصية FieldNoteRef InsertReferenceMark لإدراج علامات مرجعية منسقة بسلاسة، مما يعزز وضوح مستندك واحترافيته.
type: docs
weight: 40
...
يقوم بإدراج علامة مرجعية بنفس تنسيق الأحرف مثل نمط مرجع الحاشية السفلية أو مرجع الحاشية النهائية.
