...
description: FieldFillIn ملكية. الحصول على أو تحديد ما إذا كان يجب تلقي استجابة المستخدم مرة واحدة لكل عملية دمج بريد.
type: docs
weight: 30
...
الحصول على أو تحديد ما إذا كان يجب تلقي استجابة المستخدم مرة واحدة لكل عملية دمج بريد.
