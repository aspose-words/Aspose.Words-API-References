...
description: يمكنك الوصول إلى عناصر القائمة المنسدلة وإدارتها بسهولة باستخدام خاصية DropDownItems في FormField، مما يعمل على تحسين نماذجك من خلال تفاعل سلس للمستخدم.
type: docs
weight: 50
...
يوفر الوصول إلى عناصر حقل نموذج القائمة المنسدلة.
...
يسمح Microsoft Word بوجود 25 عنصرًا كحد أقصى في حقل نموذج القائمة المنسدلة.
