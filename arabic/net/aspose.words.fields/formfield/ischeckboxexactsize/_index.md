...
description: اكتشف خاصية FormField IsCheckBoxExactSize، وتحكم بسهولة في حجم مربع النص باستخدام إعداد منطقي بسيط لتحقيق التخصيص الأمثل.
type: docs
weight: 110
...
يحصل على القيمة المنطقية التي تشير إلى ما إذا كان حجم مربع النص تلقائيًا أو محددًا صراحةً أو يعينها.
