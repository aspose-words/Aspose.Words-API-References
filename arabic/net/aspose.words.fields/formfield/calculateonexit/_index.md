...
description: اكتشف كيف تقوم خاصية FormField CalculateOnExit بتحديث مراجع الحقول تلقائيًا عند الخروج، مما يعزز دقة مستندك وكفاءته.
type: docs
weight: 10
...
جلسة`CalculateOnExit` يؤثر فقط على سلوك حقل النموذج عند فتح المستند في Microsoft Word. لا يُحدِّث Aspose.Words أبدًا references لحقل النموذج.
