...
description: FormField ملكية. إرجاع أو تعيين النص المعروض في شريط الحالة عندما يكون التركيز على حقل نموذج.
type: docs
weight: 180
...
إرجاع أو تعيين النص المعروض في شريط الحالة عندما يكون التركيز على حقل نموذج.
...
إذا تم تعيين الخاصية OwnStatus إلى true ، تحدد الخاصية StatusText نص شريط الحالة. إذا تم تعيين خاصية OwnStatus إلى false ، تحدد الخاصية StatusText اسم إدخال النص التلقائي الذي يحتوي على نص شريط الحالة لحقل النموذج.

يسمح Microsoft Word بسلاسل تتكون من 138 حرفًا كحد أقصى.
