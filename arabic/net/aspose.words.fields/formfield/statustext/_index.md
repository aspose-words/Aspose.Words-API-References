...
description: اكتشف خاصية FormField StatusText لتخصيص رسائل شريط الحالة عند التركيز على حقول النموذج. حسّن تجربة المستخدم بسهولة!
type: docs
weight: 180
...
يقوم بإرجاع أو تعيين النص الذي يتم عرضه في شريط الحالة عندما يكون حقل النموذج هو موضع التركيز.
...
إذا كان[`OwnStatus`](../ownstatus/) تم تعيين الخاصية إلى`حقيقي` ، ال`StatusText` تحدد الخاصية نص شريط الحالة. إذا كان[`OwnStatus`](../ownstatus/) تم تعيين الخاصية إلى`خطأ شنيع` ، ال`StatusText` تحدد الخاصية اسم إدخال AutoText الذي يحتوي على نص شريط الحالة لحقل النموذج.

يسمح Microsoft Word باستخدام سلاسل تحتوي على 138 حرفًا كحد أقصى.
