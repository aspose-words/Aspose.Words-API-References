...
description: إرجاع أو تعيين تنسيق النص لحقل نموذج نصي.
type: docs
weight: 200
...
إرجاع أو تعيين تنسيق النص لحقل نموذج نصي.
...
إذا كان حقل النموذج النصي يحتوي على نص عادي ، فإن سلاسل التنسيق الصالحة هي "" و "UPPERCASE" و "LOWERCASE" و "FIRST CAPITAL" و "TITLE CASE". السلاسل strings غير حساسة لحالة الأحرف.

إذا كان حقل نموذج النص يحتوي على رقم أو قيمة تاريخ / وقت ، فإن سلاسل تنسيق valid هي سلاسل تنسيق رقم أو تاريخ ووقت.

يسمح Microsoft Word بالسلاسل التي تحتوي على 64 حرفًا بحد أقصى.
