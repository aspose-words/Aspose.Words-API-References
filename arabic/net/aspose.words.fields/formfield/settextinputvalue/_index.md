...
description: اكتشف كيف تعمل طريقة FormField SetTextInputValue على تحسين تنسيق النص وتخزين النتائج بكفاءة، مما يؤدي إلى تبسيط عملية إدخال البيانات لديك.
type: docs
weight: 250
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| newValue | Object | يمكن أن تكون سلسلة أو رقم أو**التاريخ والوقت** هدف. |
