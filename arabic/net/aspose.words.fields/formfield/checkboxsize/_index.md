...
description: اكتشف خاصية FormField CheckBoxSize لتخصيص أبعاد مربع الاختيار بالنقاط، مما يعزز نماذجك عند تمكين IsCheckBoxExactSize.
type: docs
weight: 20
...
يحصل على حجم مربع الاختيار بالنقاط أو يضبطه. يسري فقط عند[`IsCheckBoxExactSize`](../ischeckboxexactsize/) يكون`حقيقي` .
