...
description: أدر نموذجك بسهولة باستخدام خاصية "تحديد حقل النموذج". تحكم في حالة مربع الاختيار بسهولة - الوضع الافتراضي هو إلغاء تحديده لتسهيل تجربة المستخدم.
type: docs
weight: 30
url: /ar/net/aspose.words.fields/formfield/checked/
---
## FormField.Checked property

يحصل على حالة التحقق لحقل نموذج مربع الاختيار أو يعينها. القيمة الافتراضية لهذه الخاصية هي`خطأ شنيع` .
...
ينطبق على حقل نموذج مربع الاختيار فقط.
