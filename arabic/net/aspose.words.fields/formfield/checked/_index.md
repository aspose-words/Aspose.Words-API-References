...
description: FormField ملكية. الحصول على أو تعيين الحالة المحددة لحقل نموذج خانة الاختيار. القيمة الافتراضية لهذه الخاصية هي خاطئة .
type: docs
weight: 30
...
الحصول على أو تعيين الحالة المحددة لحقل نموذج خانة الاختيار. القيمة الافتراضية لهذه الخاصية هي **خاطئة** .
