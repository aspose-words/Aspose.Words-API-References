...
description: FormField ملكية. يحدد مصدر النص المعروض في مربع رسالة عندما يكون التركيز على حقل نموذج ويضغط المستخدم على F1.
type: docs
weight: 150
...
يحدد مصدر النص المعروض في مربع رسالة عندما يكون التركيز على حقل نموذج ويضغط المستخدم على F1.
...
إذا كانت True ، فسيتم عرض النص المحدد بواسطة الخاصية HelpText . If False ، يتم عرض النص الموجود في إدخال النص التلقائي المحدد بواسطة الخاصية HelpText.
