...
description: اكتشف خاصية FormField EntryMacro لإدارة وحدات الماكرو الخاصة بالإدخال بسهولة في نماذجك، مما يعزز الوظائف وتجربة المستخدم.
type: docs
weight: 80
url: /ar/net/aspose.words.fields/formfield/entrymacro/
---
## FormField.EntryMacro property

يقوم بإرجاع أو تعيين اسم ماكرو الإدخال لحقل النموذج.
...
يتم تشغيل ماكرو الإدخال عندما يحصل حقل النموذج على التركيز في Microsoft Word.

يسمح Microsoft Word باستخدام سلاسل تحتوي على 32 حرفًا كحد أقصى.
