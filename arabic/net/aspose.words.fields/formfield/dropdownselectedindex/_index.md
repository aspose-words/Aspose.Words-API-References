...
description: اكتشف خاصية FormField DropDownSelectedIndex لإدارة اختيارات القائمة المنسدلة بسهولة، مما يعزز تجربة المستخدم ووظائف النموذج.
type: docs
weight: 60
...
يحصل على الفهرس الذي يحدد العنصر المحدد حاليًا في حقل نموذج القائمة المنسدلة أو يعينه.
