...
description: الحصول على أو تعيين الفهرس الذي يحدد العنصر المحدد حاليًا في حقل نموذج القائمة المنسدلة.
type: docs
weight: 60
...
الحصول على أو تعيين الفهرس الذي يحدد العنصر المحدد حاليًا في حقل نموذج القائمة المنسدلة.
