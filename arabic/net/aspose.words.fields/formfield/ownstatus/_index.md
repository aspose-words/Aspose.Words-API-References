...
description: اكتشف كيف تعمل خاصية FormField OwnStatus على تحسين تجربة المستخدم من خلال تخصيص نص شريط الحالة عند التركيز على حقل النموذج.
type: docs
weight: 160
...
يحدد مصدر النص الذي يتم عرضه في شريط الحالة عندما يكون حقل النموذج هو محور التركيز.
...
لو`حقيقي` ، النص المحدد بواسطة[`StatusText`](../statustext/) يتم عرض الخاصية. إذا`خطأ شنيع` ، نص إدخال النص التلقائي المحدد بواسطة[`StatusText`](../statustext/) يتم عرض الخاصية.
