...
description: FormField ملكية. يحدد مصدر النص الذي يتم عرضه في شريط الحالة عندما يكون التركيز على حقل نموذج.
type: docs
weight: 160
...
يحدد مصدر النص الذي يتم عرضه في شريط الحالة عندما يكون التركيز على حقل نموذج.
...
إذا كان صحيحًا ، يتم عرض النص المحدد بواسطة خاصية نص الحالة.
