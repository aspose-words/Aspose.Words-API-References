...
description: اكتشف كيفية تخصيص خاصية "حقل النموذج الافتراضي" لتعيين القيمة الافتراضية لمربع الاختيار. حسّن تجربة المستخدم بتعديلات سهلة للقيمة!
type: docs
weight: 40
...
يحصل على القيمة الافتراضية لحقل نموذج مربع الاختيار أو يعينها. القيمة الافتراضية لهذه الخاصية هي`خطأ شنيع` .
