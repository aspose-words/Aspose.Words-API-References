...
description: اكتشف خاصية FormField MaxLength لتعيين حدود حقول النص. حسّن تجربة المستخدم بإعدادات طول قابلة للتخصيص لإدخال بيانات مثالي.
type: docs
weight: 120
...
الحد الأقصى لطول حقل النص. صفر عندما لا يكون الطول محدودًا.
