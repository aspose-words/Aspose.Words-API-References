...
description: إرجاع أو تعيين النص المعروض في مربع رسالة عندما يكون التركيز على حقل النموذج ويضغط المستخدم على F1.
type: docs
weight: 100
...
إذا تم تعيين الخاصية OwnHelp إلى True ، فإن HelpText يحدد قيمة السلسلة النصية. _ x000d_ إذا تم تعيين OwnHelp إلى False ، يحدد نص التعليمات اسم إدخال النص التلقائي الذي يحتوي على نص help لحقل النموذج.
