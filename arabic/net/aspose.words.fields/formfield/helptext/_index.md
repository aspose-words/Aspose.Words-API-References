...
description: اكتشف خاصية FormField HelpText، وقم بتحسين تجربة المستخدم من خلال الرسائل المعلوماتية التي يتم عرضها عند الضغط على F1 في الحقول المحددة.
type: docs
weight: 100
...
يعيد أو يعين النص الذي يتم عرضه في مربع الرسالة عندما يكون حقل النموذج هو موضع التركيز ويضغط المستخدم على F1.
...
إذا كان[`OwnHelp`](../ownhelp/) تم تعيين الخاصية إلى`حقيقي` ،`HelpText` يحدد قيمة سلسلة النص. إذا[`OwnHelp`](../ownhelp/) تم ضبطه على`خطأ شنيع` ،`HelpText` يحدد اسم إدخال النص التلقائي الذي يحتوي على نص help لحقل النموذج.
