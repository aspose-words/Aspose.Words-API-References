...
description: اكتشف خاصية "تمكين حقل النموذج". تحقق بسهولة من نشاط حقل النموذج لضمان تفاعل سلس للمستخدم وتحسين وظائف الويب.
type: docs
weight: 70
...
إذا تم تمكين حقل النموذج، فيمكن تغيير محتوياته أثناء ملء النموذج.
