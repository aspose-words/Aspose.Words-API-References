...
description: اكتشف خاصية FieldRef InsertRelativePosition، وقم بإدارة وضع الفقرة بسهولة لتحسين تنسيق المستندات وتحسين إمكانية القراءة.
type: docs
weight: 80
url: /ar/net/aspose.words.fields/fieldref/insertrelativeposition/
---
## FieldRef.InsertRelativePosition property

يحصل على أو يحدد ما إذا كان سيتم إدراج الموضع النسبي للفقرة المشار إليها.
