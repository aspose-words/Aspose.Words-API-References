...
description: الحصول على أو تعيين ما إذا كان سيتم زيادة أرقام الحواشي السفلية والتعليقات الختامية والتعليقات التوضيحية التي تم تمييزها بواسطة الإشارة المرجعية  وإدراج نص التعليق والتعليق الختامي والحاشية السفلية.
type: docs
weight: 30
