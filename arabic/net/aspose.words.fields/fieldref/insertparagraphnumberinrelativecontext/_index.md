...
description: أدر ترقيم الفقرات بسهولة باستخدام خاصية FieldRef InsertParagraphNumberInRelativeContext. حسّن تنظيم المستندات ووضوحها.
type: docs
weight: 70
...
يحصل على أو يحدد ما إذا كان سيتم إدراج رقم الفقرة للفقرة المشار إليها في السياق النسبي.
