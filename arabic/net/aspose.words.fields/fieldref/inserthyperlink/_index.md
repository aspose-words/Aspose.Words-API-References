...
description: اكتشف خاصية FieldRef InsertHyperlink، وقم بإنشاء ارتباطات تشعبية بسهولة إلى الفقرات المرجعية، مما يعزز التنقل وتجربة المستخدم في مستنداتك.
type: docs
weight: 40
url: /ar/net/aspose.words.fields/fieldref/inserthyperlink/
---
## FieldRef.InsertHyperlink property

يحصل على أو يحدد ما إذا كان سيتم إنشاء ارتباط تشعبي إلى الفقرة المرجعية.
