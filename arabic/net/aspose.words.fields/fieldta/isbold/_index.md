...
description: FieldTA ملكية. الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق غامق على رقم الصفحة للإدخال.
type: docs
weight: 30
...
الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق غامق على رقم الصفحة للإدخال.
