...
description: اكتشف خاصية FieldTA EntryCategory. أدر فئات الإدخال المتكاملة بسهولة باستخدام هذه الأداة الفعّالة لتنظيم سلس وفعال.
type: docs
weight: 20
...
يحصل على فئة الإدخال المتكاملة أو يعينها، وهي رقم يتوافق مع ترتيب فئات .
