...
description: اكتشف خاصية FieldTA PageRangeBookmarkName، وقم بإدارة الإشارات المرجعية لنطاقات الصفحات بسهولة وقم بتعزيز التنقل في مستنداتك باستخدام هذه الميزة القوية.
type: docs
weight: 60
