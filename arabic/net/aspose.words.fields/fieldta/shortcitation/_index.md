...
description: أدر استشهادات FieldTA المختصرة بسهولة. احصل على استشهادات مختصرة للمقالات أو عيّنها بسهولة، مما يُحسّن تنظيم البيانات وسهولة الوصول إليها.
type: docs
weight: 70
url: /ar/net/aspose.words.fields/fieldta/shortcitation/
---
## FieldTA.ShortCitation property

يحصل على أو يعين الاستشهاد القصير للإدخال.
