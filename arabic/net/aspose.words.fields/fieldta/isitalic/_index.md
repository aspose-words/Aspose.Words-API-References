...
description: اكتشف كيفية تنسيق أرقام الصفحات بسهولة باستخدام خاصية IsItalic في FieldTA، مما يعزز مستنداتك بنص مائل أنيق لتحسين قابلية القراءة.
type: docs
weight: 40
...
يحصل على أو يحدد ما إذا كان سيتم تطبيق التنسيق المائل على رقم الصفحة للإدخال.
