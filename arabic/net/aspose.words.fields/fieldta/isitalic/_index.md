...
description: FieldTA ملكية. الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق مائل على رقم الصفحة للإدخال.
type: docs
weight: 40
...
الحصول على أو تحديد ما إذا كان سيتم تطبيق تنسيق مائل على رقم الصفحة للإدخال.
