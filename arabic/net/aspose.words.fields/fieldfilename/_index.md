...
description: Aspose.Words.Fields.FieldFileName فصل. تنفيذ حقل FILENAME .
type: docs
weight: 1720
...
| [IncludeFullPath](../../aspose.words.fields/fieldfilename/includefullpath/) { get; set; } | يحصل أو يحدد ما إذا كان سيتم تضمين اسم مسار الملف الكامل. |
...
يسترجع اسم المستند الحالي من موقع التخزين الخاص به.

في التطبيق الحالي ، يستخدم[`OriginalFileName`](../../aspose.words/document/originalfilename/) لاسترداد اسم الملف. إذا تم تحميل المستند من دفق أو تم إنشاؤه فارغًا ، يستخدم اسم الملف الذي يتم حفظه فيه (إذا كان معروفًا).
