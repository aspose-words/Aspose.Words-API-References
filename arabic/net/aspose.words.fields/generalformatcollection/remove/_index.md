...
description: GeneralFormatCollection Remove طريقة. إزالة كافة تكرارات التنسيق العام المحدد من المجموعة في C#.
type: docs
weight: 50
...
إزالة كافة تكرارات التنسيق العام المحدد من المجموعة.
