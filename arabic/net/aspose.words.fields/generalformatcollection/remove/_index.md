...
description: احذف جميع نسخ تنسيق عام معين من مجموعتك بسهولة باستخدام طريقة إزالة GeneralFormatCollection. سهّل إدارة بياناتك!
type: docs
weight: 50
url: /ar/net/aspose.words.fields/generalformatcollection/remove/
---
## GeneralFormatCollection.Remove method

يزيل جميع حالات التنسيق العام المحدد من المجموعة.
