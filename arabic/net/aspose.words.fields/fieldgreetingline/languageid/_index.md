...
description: اكتشف خاصية LanguageId في FieldGreetingLine لإدارة تنسيق الأسماء بسهولة باستخدام إعدادات اللغة القابلة للتخصيص لتحسين تجربة المستخدم.
type: docs
weight: 30
...
يحصل على معرف اللغة المستخدم لتنسيق الاسم أو يعينه.
