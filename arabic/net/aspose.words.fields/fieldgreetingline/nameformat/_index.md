...
description: اكتشف خاصية FieldGreetingLine NameFormat لتخصيص تنسيقات الأسماء في حقولك بسهولة، مما يعزز تجربة المستخدم والتخصيص.
type: docs
weight: 40
...
يحصل على تنسيق الاسم المضمن في الحقل أو يعينه.
