...
description: FieldAdvance ملكية. الحصول على أو تعيين عدد النقاط التي يجب نقل النص الذي يتبع الحقل لأعلى .
type: docs
weight: 60
...
الحصول على أو تعيين عدد النقاط التي يجب نقل النص الذي يتبع الحقل لأعلى .
