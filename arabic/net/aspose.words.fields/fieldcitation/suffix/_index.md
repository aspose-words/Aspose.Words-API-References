...
description: اكتشف خاصية FieldCitation Suffix، وقم بإدارة لاحقات الاستشهاد بسهولة لتحسين دقة بياناتك وتبسيط عملية الإشارة المرجعية الخاصة بك.
type: docs
weight: 70
...
يحصل على أو يعين لاحقة يتم إضافتها إلى الاستشهاد.
