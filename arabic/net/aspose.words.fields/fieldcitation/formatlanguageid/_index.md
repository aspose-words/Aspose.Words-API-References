...
description: FieldCitation ملكية. الحصول على أو تحديد معرّف اللغة المستخدم مع النمط الببليوغرافي المحدد لتنسيق citation في المستند.
type: docs
weight: 30
...
الحصول على أو تحديد معرّف اللغة المستخدم مع النمط الببليوغرافي المحدد لتنسيق citation في المستند.
