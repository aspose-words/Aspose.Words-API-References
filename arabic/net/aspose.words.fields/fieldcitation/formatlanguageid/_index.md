...
description: اكتشف كيف تعمل خاصية FieldCitation FormatLanguageId على تحسين تنسيق الاستشهادات في مستنداتك من خلال إدارة معرفات اللغة للأنماط الببليوغرافية.
type: docs
weight: 30
url: /ar/net/aspose.words.fields/fieldcitation/formatlanguageid/
---
## FieldCitation.FormatLanguageId property

يحصل على معرف اللغة المستخدم مع النمط الببليوغرافي المحدد لتنسيق citation في المستند أو يعينه.
