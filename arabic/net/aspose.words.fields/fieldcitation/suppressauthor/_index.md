...
description: تحكم في رؤية المؤلف باستخدام خاصية FieldCitation SuppressAuthor. أدر تفاصيل الاقتباس بسهولة لتحسين الوضوح والاحترافية.
type: docs
weight: 80
...
يحصل على أو يعين ما إذا كان سيتم حذف معلومات المؤلف من الاستشهاد.
