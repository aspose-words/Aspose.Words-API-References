...
description: اكتشف خاصية FieldCitation SourceTag، وقم بإدارة عناصر العلامة وتخصيصها بسهولة لإدراج البيانات بسلاسة وتعزيز دقة المصدر.
type: docs
weight: 60
...
يحصل على قيمة تطابق أو يعينها**العلامة** قيمة العنصر المصدر للإدراج.
