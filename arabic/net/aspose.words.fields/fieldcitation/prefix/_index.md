...
description: اكتشف خاصية FieldCitation Prefix، وقم بتخصيص الاستشهادات بسهولة باستخدام بادئة فريدة لتحسين الوضوح والتنظيم في مستنداتك.
type: docs
weight: 50
...
يحصل على أو يعين البادئة التي تم إضافتها إلى الاستشهاد.
