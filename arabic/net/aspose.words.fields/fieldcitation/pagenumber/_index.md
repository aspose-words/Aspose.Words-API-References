...
description: أدر استشهاداتك بسهولة باستخدام خاصية "رقم صفحة الاستشهاد" (PageNumber). حدّد أو استرجاع أرقام الصفحات بسهولة لضمان دقة المراجع.
type: docs
weight: 40
...
يحصل على رقم الصفحة المرتبط بالاقتباس أو يعينه.
