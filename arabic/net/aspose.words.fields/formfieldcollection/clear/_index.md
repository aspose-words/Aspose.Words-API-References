...
description: قم بمسح جميع حقول النماذج من مستندك بسهولة باستخدام طريقة Clear FormFieldCollection، مما يضمن مساحة عمل منظمة ومبسطة.
type: docs
weight: 30
url: /ar/net/aspose.words.fields/formfieldcollection/clear/
---
## FormFieldCollection.Clear method

يزيل جميع حقول النموذج من هذه المجموعة ومن المستند.
