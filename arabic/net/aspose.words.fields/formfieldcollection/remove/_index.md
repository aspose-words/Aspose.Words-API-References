...
description: احذف حقول النموذج بالاسم بسهولة باستخدام طريقة إزالة FormFieldCollection. سهّل إدارة بياناتك مع هذه الميزة سهلة الاستخدام!
type: docs
weight: 50
...
يزيل حقل النموذج بالاسم المحدد.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| formField | String | اسم حقل النموذج الذي لا يفرق بين الأحرف الكبيرة والصغيرة والذي سيتم إزالته. |
