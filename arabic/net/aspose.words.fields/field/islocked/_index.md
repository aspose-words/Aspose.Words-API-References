...
description: اكتشف خاصية "IsLocked" للحقول - تحكم في إعادة الحساب وعزز سلامة البيانات. تمتع بإدارة فعّالة لنتائج بياناتك اليوم!
type: docs
weight: 50
...
يحصل على أو يحدد ما إذا كان الحقل مقفلاً (لا ينبغي إعادة حساب نتيجته).
