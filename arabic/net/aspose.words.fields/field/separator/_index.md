...
description: اكتشف خاصية فاصل الحقل للوصول بسهولة إلى العقدة التي تُمثل فاصل الحقل، مما يُحسّن كفاءة إدارة البيانات. تعرّف على المزيد!
type: docs
weight: 80
...
يحصل على العقدة التي تمثل فاصل الحقل. يمكن أن يكون`باطل` .
