...
description: Field ملكية. يحصل على أFieldFormat كائن يوفر وصولاً مكتوبًا إلى تنسيق الحقل.
type: docs
weight: 30
...
يحصل على أ[`FieldFormat`](../../fieldformat/) كائن يوفر وصولاً مكتوبًا إلى تنسيق الحقل.
