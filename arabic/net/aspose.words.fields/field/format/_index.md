...
description: اكتشف خاصية تنسيق الحقل للوصول بشكل سلس إلى كائنات تنسيق الحقل، مما يعزز تنسيق الحقول لديك بدقة وسهولة.
type: docs
weight: 30
...
يحصل على[`FieldFormat`](../../fieldformat/)الكائن الذي يوفر الوصول المكتوب إلى تنسيق الحقل.
