...
إن الحقل في مستند Word عبارة عن بنية معقدة تتكون من عقد متعددة تتضمن بداية الحقل ، وكود الحقل ، وفاصل الحقل ، ونتيجة الحقل ونهاية الحقل. يمكن أن تكون الحقول متداخلة ، وتحتوي على محتوى غني وامتداد عدة فقرات أو أقسام في المستند. ال[`Field`](./field/)الفئة هي كائن "واجهة" يوفر خصائص وطرق تسمح بالعمل مع حقل ككائن واحد.
