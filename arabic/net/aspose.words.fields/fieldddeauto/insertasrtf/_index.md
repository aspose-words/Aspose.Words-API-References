...
description: اكتشف خاصية FieldDdeAuto InsertAsRtf، وقم بإدارة الكائنات المرتبطة بسهولة بتنسيق النص الغني (RTF) لتحسين تكامل المستندات وتعدد استخداماتها.
type: docs
weight: 50
url: /ar/net/aspose.words.fields/fieldddeauto/insertasrtf/
---
## FieldDdeAuto.InsertAsRtf property

يحصل على أو يحدد ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق النص الغني (RTF).
