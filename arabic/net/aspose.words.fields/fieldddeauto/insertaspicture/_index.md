...
description: اكتشف كيف تعمل خاصية FieldDdeAuto InsertAsPicture على تحسين مستنداتك عن طريق ربط الكائنات كصور لتحقيق تكامل سلس وعرض أفضل.
type: docs
weight: 40
url: /ar/net/aspose.words.fields/fieldddeauto/insertaspicture/
---
## FieldDdeAuto.InsertAsPicture property

يحصل على أو يحدد ما إذا كان سيتم إدراج الكائن المرتبط كصورة.
