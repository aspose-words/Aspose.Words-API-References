...
description: اكتشف خاصية FieldDdeAuto InsertAsUnicode، وقم بإدارة الكائنات المرتبطة بسهولة باستخدام نص Unicode لتحسين تكامل البيانات وزيادة الكفاءة.
type: docs
weight: 70
url: /ar/net/aspose.words.fields/fieldddeauto/insertasunicode/
---
