...
description: اكتشف كيف تعمل خاصية FieldDde InsertAsText على تحسين مستنداتك من خلال السماح بإدراج الكائنات المرتبطة بتنسيق نصي فقط لتحقيق توافق أفضل.
type: docs
weight: 70
url: /ar/net/aspose.words.fields/fielddde/insertastext/
---
