...
description: يحدد وحدة أبعاد الصورة أي العرض أو الارتفاع المستخدمة عبر عملية دمج البريد.
type: docs
weight: 2580
...
| اسم | قيمة | وصف |
| --- | --- | --- |
| Point | `0` | النقطة (أي 1/72 بوصة) ._ x000d_ |
| Percent | `1` | النسبة المئوية لقيمة أبعاد الصورة الأصلية ._ x000d_ |
