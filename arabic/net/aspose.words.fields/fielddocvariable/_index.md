...
description: اكتشف فئة Aspose.Words.Fields.FieldDocVariable للتكامل السلس مع حقل DOCVARIABLE، مما يعزز أتمتة المستندات وإدارتها.
type: docs
weight: 2230
...
| [VariableName](../../aspose.words.fields/fielddocvariable/variablename/) { get; set; } | يحصل على اسم متغير المستند الذي سيتم استرداده أو يعينه. |
