...
description: اكتشف فئة Aspose.Words.Fields.FieldTemplate لتنفيذ حقول TEMPLATE بسلاسة. حسّن معالجة مستنداتك بميزات فعّالة!
type: docs
weight: 2900
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | يحصل على أو يحدد ما إذا كان سيتم تضمين اسم مسار الملف الكامل. |
...
يسترجع اسم ملف القالب المستخدم بواسطة المستند الحالي.
