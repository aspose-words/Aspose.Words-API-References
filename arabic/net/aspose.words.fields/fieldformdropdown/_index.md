...
description: اكتشف فئة Aspose.Words.Fields.FieldFormDropDown، المصممة لتعزيز تفاعل المستندات باستخدام حقول القائمة المنسدلة الديناميكية للحصول على تجارب مستخدم سلسة.
type: docs
weight: 2330
...
يقوم بإدراج حقل نموذج على شكل قائمة منسدلة.
