...
description: اكتشف خاصية BarcodeParameters IsBookmark! تعرّف على كيفية مساهمة PostalAddress في تحسين إدارة مستنداتك من خلال حلول فعّالة لإضافة إشارات مرجعية.
type: docs
weight: 120
url: /ar/net/aspose.words.fields/barcodeparameters/isbookmark/
---
## BarcodeParameters.IsBookmark property

سواء[`PostalAddress`](../postaladdress/) هو اسم الإشارة المرجعية.
