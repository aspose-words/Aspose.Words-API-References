...
description: BarcodeParameters ErrorCorrectionLevel ملكية. مستوى تصحيح الخطأ لرمز QR. القيم الصالحة هي 0 3 في C#.
type: docs
weight: 80
...
مستوى تصحيح الخطأ لرمز QR. القيم الصالحة هي [0، 3].
