...
description: تأكد من دقة الباركودات باستخدام خاصية FixCheckDigit. صحح أرقام التحقق غير الصحيحة تلقائيًا لضمان دقة المسح الضوئي وسلامة البيانات.
type: docs
weight: 100
...
ما إذا كان سيتم إصلاح رقم الفحص إذا كان غير صالح.
