...
description: اكتشف خاصية BarcodeParameters DisplayText لتحسين رموز الباركود الخاصة بك عن طريق عرض نص البيانات بجوار الصور لتحسين إمكانية القراءة.
type: docs
weight: 70
url: /ar/net/aspose.words.fields/barcodeparameters/displaytext/
---
## BarcodeParameters.DisplayText property

ما إذا كان سيتم عرض بيانات الباركود (النص) مع الصورة.
