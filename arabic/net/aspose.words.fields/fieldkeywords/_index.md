...
description: اكتشف فئة Aspose.Words.Fields.FieldKeywords لتنفيذ حقل KEYWORDS بكفاءة، مما يعزز بيانات مستندك التعريفية وإمكانية البحث فيه.
type: docs
weight: 2500
...
| [Text](../../aspose.words.fields/fieldkeywords/text/) { get; set; } | يحصل على نص الكلمات الرئيسية أو يعينه. |
...
يسترد، ويحدد بشكل اختياري، الكلمات الرئيسية للمستند، كما هو مسجل في**الكلمات الرئيسية** خاصية خصائص المستند المضمنة .
