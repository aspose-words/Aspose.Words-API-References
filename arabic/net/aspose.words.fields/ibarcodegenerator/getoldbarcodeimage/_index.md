...
description: أنشئ صور باركود قديمة بكل سهولة باستخدام أداة GetOldBarcodeImage من iBarcodeGenerator. خصّصها بسهولة باستخدام المعلمات التي تُفضّلها!
type: docs
weight: 20
...
إنشاء صورة الباركود باستخدام مجموعة المعلمات (لحقل الباركود القديم).
