...
description: Aspose.Words.Fields.FieldBibliography فصل. تنفيذ حقل ببليوغرافيا .
type: docs
weight: 1490
...
| [FormatLanguageId](../../aspose.words.fields/fieldbibliography/formatlanguageid/) { get; set; } | الحصول على أو تحديد معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند. |
...
يُدرج محتويات جزء الببليوغرافيا في المستند بأسلوب ببليوغرافي.
