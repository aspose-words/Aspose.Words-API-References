...
description: اكتشف كيف تعمل خاصية FieldBibliography FormatLanguageId على تعزيز المصادر الببليوغرافية في مستندك من خلال إعدادات اللغة القابلة للتخصيص لتحسين الوضوح.
type: docs
weight: 30
...
يحصل على معرف اللغة المستخدم لتنسيق المصادر الببليوغرافية في المستند أو يعينه.
