...
description: قم بإدارة قائمة المراجع الخاصة بك بسهولة باستخدام خاصية SourceTag—قم بتصفية المصادر عن طريق مطابقة العلامات للحصول على قائمة مرجعية منظمة ومصممة خصيصًا.
type: docs
weight: 40
...
يحصل على قيمة أو يعينها بحيث يتم عرض المصادر التي تتطابق مع قيمة عنصر العلامة فقط في المراجع.
