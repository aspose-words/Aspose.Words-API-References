...
description: اكتشف كيف تعمل خاصية FieldBibliography FilterLanguageId على تحسين إدارة البيانات الببليوغرافية الخاصة بك عن طريق تصفية المصادر حسب اللغة للحصول على نتائج دقيقة.
type: docs
weight: 20
...
يحصل على معرف اللغة أو يعينه، والذي يتم استخدامه لتصفية البيانات الببليوغرافية فقط للمصادر في المستند التي تستخدم تلك اللغة.
