...
description: اكتشف خاصية FieldEnd HasSeparator، وتحقق بسهولة مما إذا كان الحقل الخاص بك يتضمن فاصلًا لتحسين تنظيم البيانات ووضوحها.
type: docs
weight: 10
...
إرجاع`حقيقي` إذا كان هذا الحقل يحتوي على فاصل.
