...
description: Aspose.Words.Fields.FieldAutoText فصل. ينفذ حقل النص التلقائي في C#.
type: docs
weight: 1610
...
| [EntryName](../../aspose.words.fields/fieldautotext/entryname/) { get; set; } | الحصول على اسم إدخال النص التلقائي أو تعيينه. |
