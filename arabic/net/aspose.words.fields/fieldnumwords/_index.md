...
description: Aspose.Words.Fields.FieldNumWords فصل. يطبق الحقل NUMWORDS في C#.
type: docs
weight: 2230
url: /ar/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class
...
استرداد عدد الكلمات في المستند الحالي، كما هو مسجل في ملف**كلمات** خاصية خصائص المستند المضمنة.
