...
description: اكتشف فئة Aspose.Words.Fields.FieldNumWords لإدارة عدد الكلمات في المستندات بسهولة. حسّن معالجة النصوص لديك بهذه الميزة الفعّالة!
type: docs
weight: 2640
...
يسترد عدد الكلمات في المستند الحالي، كما هو مسجل في**كلمات** خاصية خصائص المستند المضمنة .
