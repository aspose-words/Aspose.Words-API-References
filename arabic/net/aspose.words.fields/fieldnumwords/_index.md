...
description: Aspose.Words.Fields.FieldNumWords فصل. تنفذ الحقل NUMWORDS .
type: docs
weight: 2080
...
استرداد عدد الكلمات في المستند الحالي ، كما هو مسجل في ملف **كلمات**خاصية the خصائص المستند المضمنة .
