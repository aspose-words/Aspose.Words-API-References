...
description: FieldSymbol ملكية. الحصول على أو تعيين قيمة نقطة رمز الحرف في النظام العشري أو الست عشري.
type: docs
weight: 20
...
الحصول على أو تعيين قيمة نقطة رمز الحرف في النظام العشري أو الست عشري.
