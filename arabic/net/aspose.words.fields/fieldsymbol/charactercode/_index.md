...
description: اكتشف خاصية FieldSymbol CharacterCode، واسترد قيم رموز الأحرف بسهولة أو قم بتعيينها بالنظام العشري أو السداسي عشر لإدارة البيانات بسلاسة.
type: docs
weight: 20
...
يحصل على قيمة نقطة رمز الحرف أو يعينها بالنظام العشري أو السداسي عشر.
