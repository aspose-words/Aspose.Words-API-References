...
description: اكتشف خاصية FieldSymbol IsUnicode لإدارة رموز الأحرف بسهولة كقيم Unicode، مما يعزز كفاءة الترميز ودقته.
type: docs
weight: 80
...
يحصل على أو يحدد ما إذا كان يتم تفسير رمز الحرف كقيمة لحرف Unicode.
