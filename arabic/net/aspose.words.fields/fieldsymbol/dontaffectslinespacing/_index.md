...
description: FieldSymbol ملكية. الحصول على أو تحديد ما إذا كان الحرف الذي تم استرداده بواسطة الحقل يؤثر على تباعد الأسطر في الفقرة.
type: docs
weight: 30
...
الحصول على أو تحديد ما إذا كان الحرف الذي تم استرداده بواسطة الحقل يؤثر على تباعد الأسطر في الفقرة.
