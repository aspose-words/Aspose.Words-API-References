...
description: FieldSymbol FontName ملكية. الحصول على أو تعيين اسم خط الحرف الذي تم استرداده بواسطة الحقل في C#.
type: docs
weight: 40
...
الحصول على أو تعيين اسم خط الحرف الذي تم استرداده بواسطة الحقل.
