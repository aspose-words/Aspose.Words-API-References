...
description: اكتشف كيفية استخدام خاصية FieldSymbol FontName لإدارة وتخصيص أسماء الخطوط الخاصة بأحرفك في البرمجة بسهولة.
type: docs
weight: 40
url: /ar/net/aspose.words.fields/fieldsymbol/fontname/
---
## FieldSymbol.FontName property

يحصل على اسم الخط الخاص بالحرف الذي تم استرداده بواسطة الحقل أو يعينه.
