...
description: اكتشف خاصية "حجم الخط" في "رمز الحقل"، واضبط حجم الخط بسهولة بالنقاط لعرض أفضل للأحرف في تطبيقاتك. حسّن قابلية القراءة الآن!
type: docs
weight: 50
...
يحصل على أو يعين حجم الخط بالنقاط للحرف الذي تم استرداده بواسطة الحقل.
