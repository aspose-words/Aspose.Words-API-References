...
description: FieldSymbol FontSize ملكية. الحصول على أو تعيين الحجم بنقاط خط الحرف الذي تم استرداده بواسطة الحقل في C#.
type: docs
weight: 50
...
الحصول على أو تعيين الحجم بنقاط خط الحرف الذي تم استرداده بواسطة الحقل.
