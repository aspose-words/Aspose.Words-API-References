...
description: اكتشف خاصية FieldSymbol IsAnsi، وقم بإدارة أكواد أحرف ANSI بسهولة لتحسين التعامل مع البيانات وتحسين كفاءة الترميز.
type: docs
weight: 60
url: /ar/net/aspose.words.fields/fieldsymbol/isansi/
---
## FieldSymbol.IsAnsi property

يحصل على أو يحدد ما إذا كان يتم تفسير رمز الحرف كقيمة لحرف ANSI.
