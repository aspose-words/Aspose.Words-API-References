...
description: اكتشف خاصية FieldListNum ListLevel لتخصيص مستويات القائمة الخاصة بك بسهولة، مما يعزز تنظيم بياناتك والتحكم فيها.
type: docs
weight: 30
...
يحصل على المستوى الموجود في القائمة أو يعينه، متجاوزًا السلوك الافتراضي للحقل.
