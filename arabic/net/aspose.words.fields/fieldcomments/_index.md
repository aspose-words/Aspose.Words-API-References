...
description: Aspose.Words.Fields.FieldComments فصل. ينفذ حقل التعليقات.
type: docs
weight: 1700
...
استرداد التعليقات المتعلقة بالمستند الحالي وتعيينها بشكل اختياري، كما هو مسجل في[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/) property من خصائص المستند المضمنة.
