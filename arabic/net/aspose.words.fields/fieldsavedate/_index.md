...
description: اكتشف فئة Aspose.Words.Fields.FieldSaveDate، المصممة لتنفيذ حقل SAVEDATE بسهولة لإدارة المستندات بشكل مبسط.
type: docs
weight: 2760
...
| [UseLunarCalendar](../../aspose.words.fields/fieldsavedate/uselunarcalendar/) { get; set; } | يحصل على أو يعين ما إذا كان سيتم استخدام التقويم الهجري القمري أو التقويم العبري القمري. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldsavedate/usesakaeracalendar/) { get; set; } | يحصل على أو يحدد ما إذا كان سيتم استخدام تقويم Saka Era. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldsavedate/useumalquracalendar/) { get; set; } | يحصل على أو يحدد ما إذا كان سيتم استخدام تقويم أم القرى. |
...
يسترجع تاريخ ووقت آخر حفظ للمستند. افتراضيًا، يُستخدم التقويم الميلادي.
