...
description: FieldIndex ملكية. يحصل أو يحدد ما إذا كان سيتم تمكين استخدام نص yomi لإدخالات الفهرس.
type: docs
weight: 170
...
يحصل أو يحدد ما إذا كان سيتم تمكين استخدام نص yomi لإدخالات الفهرس.
