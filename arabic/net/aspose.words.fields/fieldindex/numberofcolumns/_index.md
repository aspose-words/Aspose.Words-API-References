...
description: FieldIndex ملكية. الحصول على أو تعيين عدد الأعمدة لكل صفحة مستخدمة عند إنشاء الفهرس.
type: docs
weight: 100
...
الحصول على أو تعيين عدد الأعمدة لكل صفحة مستخدمة عند إنشاء الفهرس.
