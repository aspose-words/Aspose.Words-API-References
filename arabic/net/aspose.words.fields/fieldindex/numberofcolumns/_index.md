...
description: اكتشف خاصية FieldIndex NumberOfColumns لتخصيص تخطيط الفهرس الخاص بك بسهولة باستخدام إعدادات العمود المثالية لتحسين إمكانية القراءة والأداء.
type: docs
weight: 100
...
يحصل على عدد الأعمدة لكل صفحة المستخدمة عند بناء الفهرس أو يعينه.
