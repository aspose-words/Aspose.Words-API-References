...
description: Aspose.Words.Fields.FieldIndex فصل. ينفذ حقل INDEX في C#.
type: docs
weight: 2060
url: /ar/net/aspose.words.fields/fieldindex/
---
## FieldIndex class
...
| اسم | وصف |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldindex/bookmarkname/) { get; set; } | الحصول على أو تعيين اسم الإشارة المرجعية التي تحدد جزء المستند المستخدم لإنشاء الفهرس. |
| [CrossReferenceSeparator](../../aspose.words.fields/fieldindex/crossreferenceseparator/) { get; set; } | الحصول على أو تعيين تسلسل الأحرف المستخدم لفصل المراجع الترافقية والمدخلات الأخرى. |
| [DisplayResult](../../aspose.words.fields/field/displayresult/) { get; } | الحصول على النص الذي يمثل نتيجة الحقل المعروض. |
| [End](../../aspose.words.fields/field/end/) { get; } | يحصل على العقدة التي تمثل نهاية الحقل. |
| [EntryType](../../aspose.words.fields/fieldindex/entrytype/) { get; set; } | الحصول على أو تعيين نوع إدخال الفهرس المستخدم لإنشاء الفهرس. |
| [Format](../../aspose.words.fields/field/format/) { get; } | يحصل على[`FieldFormat`](../fieldformat/) الكائن الذي يوفر الوصول المكتوب إلى تنسيق الحقل. |
| [HasPageNumberSeparator](../../aspose.words.fields/fieldindex/haspagenumberseparator/) { get; } | الحصول على قيمة تشير إلى ما إذا كان قد تم تجاوز فاصل رقم الصفحة من خلال رمز الحقل. |
| [HasSequenceName](../../aspose.words.fields/fieldindex/hassequencename/) { get; } | يحصل على قيمة تشير إلى ما إذا كان ينبغي استخدام التسلسل أثناء بناء نتيجة الحقل. |
| [Heading](../../aspose.words.fields/fieldindex/heading/) { get; set; } | الحصول على أو تعيين العنوان الذي يظهر في بداية كل مجموعة من الإدخالات لأي حرف معين. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | الحصول على أو تعيين ما إذا كانت النتيجة الحالية للحقل لم تعد صحيحة (قديمة) بسبب تعديلات أخرى تم إجراؤها على المستند. |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | الحصول على أو تعيين ما إذا كان الحقل مقفلاً (لا ينبغي إعادة حساب النتيجة). |
| [LanguageId](../../aspose.words.fields/fieldindex/languageid/) { get; set; } | الحصول على أو تعيين معرف اللغة المستخدم لإنشاء الفهرس. |
...
| [NumberOfColumns](../../aspose.words.fields/fieldindex/numberofcolumns/) { get; set; } | الحصول على أو تعيين عدد الأعمدة لكل صفحة المستخدمة عند إنشاء الفهرس. |
| [PageNumberListSeparator](../../aspose.words.fields/fieldindex/pagenumberlistseparator/) { get; set; } | الحصول على أو تعيين تسلسل الأحرف المستخدم للفصل بين رقمي الصفحات في قائمة أرقام الصفحات. |
| [PageNumberSeparator](../../aspose.words.fields/fieldindex/pagenumberseparator/) { get; set; } | الحصول على أو تعيين تسلسل الأحرف المستخدم لفصل إدخال الفهرس ورقم الصفحة الخاصة به. |
| [PageRangeSeparator](../../aspose.words.fields/fieldindex/pagerangeseparator/) { get; set; } | الحصول على أو تعيين تسلسل الأحرف المستخدم للفصل بين بداية نطاق الصفحات ونهايته. |
| [Result](../../aspose.words.fields/field/result/) { get; set; } | الحصول على أو تعيين النص الموجود بين فاصل الحقل ونهاية الحقل. |
| [RunSubentriesOnSameLine](../../aspose.words.fields/fieldindex/runsubentriesonsameline/) { get; set; } | يحصل على أو يحدد ما إذا كان سيتم تشغيل الإدخالات الفرعية في نفس سطر الإدخال الرئيسي. |
| [Separator](../../aspose.words.fields/field/separator/) { get; } | يحصل على العقدة التي تمثل فاصل الحقول. يمكن ان يكون`باطل` . |
| [SequenceName](../../aspose.words.fields/fieldindex/sequencename/) { get; set; } | الحصول على أو تعيين اسم التسلسل الذي تم تضمين رقمه مع رقم الصفحة. |
...
| [UseYomi](../../aspose.words.fields/fieldindex/useyomi/) { get; set; } | الحصول على أو تعيين ما إذا كان سيتم تمكين استخدام نص yomi لإدخالات الفهرس. |
