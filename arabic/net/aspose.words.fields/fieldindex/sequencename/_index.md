...
description: اكتشف خاصية FieldIndex SequenceName لإدارة أسماء التسلسل بسهولة وتعزيز كفاءة الترقيم الصفحي في تطبيقاتك.
type: docs
weight: 150
...
يحصل على اسم التسلسل الذي تم تضمين رقمه مع رقم الصفحة أو يعينه.
