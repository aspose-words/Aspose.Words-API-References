...
description: اكتشف فئة Aspose.Words.Fields.FieldNumPages لتنفيذ حقل NUMPAGES بسهولة، مما يعزز أتمتة المستندات وكفاءتها.
type: docs
weight: 2630
url: /ar/net/aspose.words.fields/fieldnumpages/
---
## FieldNumPages class
...
| اسم | وصف |
| --- | --- |
| [FieldNumPages](fieldnumpages/)() | Default_Constructor |
...
يسترد عدد الصفحات في المستند الحالي، كما هو مسجل في**الصفحات** خاصية خصائص المستند المضمنة .

## أمثلة

يوضح كيفية استخدام الحقول NUMCHARS وNUMWORDS وNUMPAGES وPAGE لتتبع حجم مستنداتنا.
...
// 3 - استخدم كلاً من الحقلين PAGE وNUMPAGES لعرض الصفحة التي يوجد بها الحقل،
...
// لن تحافظ هذه الحقول على القيم الدقيقة في الوقت الفعلي
// أثناء قيامنا بتحرير المستند برمجيًا باستخدام Aspose.Words، أو في Microsoft Word.
 //نحن بحاجة إلى تحديثها كل ما نحتاجه لرؤية قيمة محدثة.
doc.UpdateFields();
