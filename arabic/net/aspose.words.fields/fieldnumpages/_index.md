...
description: Aspose.Words.Fields.FieldNumPages فصل. ينفذ الحقل NUMPAGES .
type: docs
weight: 2070
...
استرداد عدد الصفحات في المستند الحالي ، كما هو مسجل في ملف **الصفحات**خاصية the خصائص المستند المضمنة .
