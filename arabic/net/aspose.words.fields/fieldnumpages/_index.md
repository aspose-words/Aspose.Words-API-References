...
description: Aspose.Words.Fields.FieldNumPages فصل. ينفذ حقل NUMPAGES.
type: docs
weight: 2220
...
استرداد عدد الصفحات في المستند الحالي، كما هو مسجل في ملف **الصفحات** خاصية خصائص المستند المضمنة.
