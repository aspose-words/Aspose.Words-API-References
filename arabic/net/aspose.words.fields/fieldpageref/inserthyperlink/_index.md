...
description: FieldPageRef ملكية. الحصول على أو تحديد ما إذا كان سيتم إدراج ارتباط تشعبي بالفقرة التي تم وضع إشارة مرجعية عليها.
type: docs
weight: 30
...
الحصول على أو تحديد ما إذا كان سيتم إدراج ارتباط تشعبي بالفقرة التي تم وضع إشارة مرجعية عليها.
