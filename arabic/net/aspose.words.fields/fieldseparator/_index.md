...
description: Aspose.Words.Fields.FieldSeparator فصل. يمثل فاصل حقل Word الذي يفصل رمز الحقل عن نتيجة الحقل.
type: docs
weight: 2380
...
| اسم | وصف |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldseparator/accept/)(DocumentVisitor) | يقبل الزائر. |
