...
description: اكتشف فئة Aspose.Words.Fields.FieldFormula لتنفيذ حقول الصيغة وإدارتها بسهولة في مستنداتك لتحسين الوظائف.
type: docs
weight: 2360
...
// استخدم منشئ الحقل لإنشاء معادلة رياضية،
