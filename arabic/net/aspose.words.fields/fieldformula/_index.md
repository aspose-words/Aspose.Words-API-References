...
description: Aspose.Words.Fields.FieldFormula فصل. يطبق حقل  الصيغة.
type: docs
weight: 1950
...
// استخدم أداة إنشاء الحقول لإنشاء معادلة رياضية،
// ثم قم بإنشاء حقل صيغة لعرض نتيجة المعادلة في المستند.
