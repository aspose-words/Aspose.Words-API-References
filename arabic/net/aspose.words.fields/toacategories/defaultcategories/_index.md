...
description: اكتشف خاصية ToaCategories DefaultCategories للوصول بسهولة إلى فئات جدول المصادر الأساسية. بسّط إدارة مستنداتك اليوم!
type: docs
weight: 20
...
يحصل على فئات جدول السلطات الافتراضية.
...
استخدم[`ToaCategories`](../../fieldoptions/toacategories/) خاصية لتحديد فئات جدول السلطات لمستند واحد.
