...
description: اكتشف خاصية التعبير الصحيح في ComparisonExpression. استرجاع التعبير الصحيح بسهولة لتحسين تحليل البيانات وتحسين الأداء.
type: docs
weight: 30
