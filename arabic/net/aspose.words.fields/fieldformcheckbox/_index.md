...
description: Aspose.Words.Fields.FieldFormCheckBox فصل. تنفيذ حقل FORMCHECKBOX في C#.
type: docs
weight: 1910
...
إدراج حقل نموذج نمط خانة الاختيار.

## أمثلة

يوضح كيفية معالجة حقول FORMCHECKBOX وFORMDROPDOWN وFORMTEXT.

```csharp
// هذه الحقول هي مكافئات قديمة لـ FormField. يمكننا قراءة هذه الحقول، ولكن لا يمكننا إنشاؤها باستخدام Aspose.Words.
