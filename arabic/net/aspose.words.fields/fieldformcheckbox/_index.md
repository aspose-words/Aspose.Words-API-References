...
description: اكتشف فئة Aspose.Words.Fields.FieldFormCheckBox، المصممة لتنفيذ حقول FORMCHECKBOX بسهولة لتحسين التفاعل والوظائف في المستندات.
type: docs
weight: 2320
url: /ar/net/aspose.words.fields/fieldformcheckbox/
---
## FieldFormCheckBox class

ينفذ حقل FORMCHECKBOX.
...
يقوم بإدراج حقل نموذج على شكل مربع اختيار.

## أمثلة

يوضح كيفية معالجة الحقول FORMCHECKBOX وFORMDROPDOWN وFORMTEXT.

```csharp
// هذه الحقول هي مكافئات قديمة لحقل النموذج. يمكننا قراءتها، ولكن لا يمكننا إنشاؤها باستخدام Aspose.Words.
