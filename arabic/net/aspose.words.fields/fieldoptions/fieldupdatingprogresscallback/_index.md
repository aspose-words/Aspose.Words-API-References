...
description: اكتشف خاصية FieldUpdatingProgressCallback في FieldOptions. أدر بسهولة تطبيقات IFieldUpdatingProgressCallback لتحسين الأداء!
type: docs
weight: 130
...
يحصل أو يعين[`IFieldUpdatingProgressCallback`](../../ifieldupdatingprogresscallback/) التنفيذ.
