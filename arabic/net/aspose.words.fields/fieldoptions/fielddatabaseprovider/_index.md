...
description: اكتشف خاصية FieldOptions FieldDatabaseProvider، وقم بإدارة واسترداد نتائج الاستعلام بسهولة لتحسين التعامل مع البيانات في تطبيقاتك.
type: docs
weight: 80
...
يحصل على أو يعين موفرًا يعيد نتيجة استعلام لـ[`FieldDatabase`](../../fielddatabase/) الحقل.
