...
description: اكتشف خاصية ترميز FieldIncludeText لإدارة ترميز البيانات في ملفاتك بسهولة. حسّن معالجة بياناتك مع هذه الميزة الأساسية!
type: docs
weight: 30
...
يحصل على أو يعين الترميز المطبق على البيانات داخل الملف المرجعي.
