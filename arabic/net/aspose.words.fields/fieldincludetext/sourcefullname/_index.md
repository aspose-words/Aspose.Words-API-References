...
description: اكتشف خاصية FieldIncludeText SourceFullName لإدارة مواقع المستندات بسهولة باستخدام IRI. حسّن سير عملك وحسّن معالجة بياناتك!
type: docs
weight: 70
...
يحصل على موقع المستند أو يعينه باستخدام IRI.
