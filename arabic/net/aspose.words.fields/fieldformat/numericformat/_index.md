...
description: اكتشف كيف تقوم خاصية FieldFormat NumericFormat بتخصيص نتائج الحقل الرقمي، مما يعزز عرض البيانات وتجربة المستخدم بشكل فعال.
type: docs
weight: 30
...
يحصل على أو يضبط التنسيق المطبق على نتيجة حقل رقمي. يتوافق مع مفتاح \#.
