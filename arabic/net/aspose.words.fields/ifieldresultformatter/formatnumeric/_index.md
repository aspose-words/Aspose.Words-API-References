...
description: اكتشف طريقة iFieldResultFormatter FormatNumeric لـ Aspose.Words. حسّن تنسيق مستنداتك مع إمكانيات تحويل رقمية فعّالة!
type: docs
weight: 30
...
يتم استدعاؤها عندما يطبق Aspose.Words مفتاح تنسيق رقمي، على سبيل المثال \# "#.##".
