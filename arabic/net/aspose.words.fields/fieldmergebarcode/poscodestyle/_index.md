...
description: FieldMergeBarcode ملكية. الحصول على أو تعيين نمط الرمز الشريطي لنقطة البيع أنواع الرموز الشريطية UPCA  UPCE  EAN13  EAN8. القيم الصالحة غير حساسة لحالة الأحرف هي STD  SUP2  SUP5  CASE .
type: docs
weight: 110
