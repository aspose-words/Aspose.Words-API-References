...
description: اكتشف منشئ FieldArgumentBuilder لإنشاء وتخصيص مثيلات FieldArgumentBuilder بكفاءة لتلبية احتياجات التطوير الخاصة بك.
type: docs
weight: 10
...
يقوم بتهيئة مثيل لـ[`FieldArgumentBuilder`](../) الصف.
