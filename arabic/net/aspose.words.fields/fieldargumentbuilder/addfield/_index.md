...
description: حسّن كفاءة ترميزك باستخدام طريقة AddField في FieldArgumentBuilder. تكامل FieldBuilder بسلاسة لبناء حجج قوية.
type: docs
weight: 20
...
يضيف حقلًا يمثله[`FieldBuilder`](../../fieldbuilder/) إلى الحجة.
