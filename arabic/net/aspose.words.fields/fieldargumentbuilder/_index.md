...
description: اكتشف فئة Aspose.Words.Fields.FieldArgumentBuilder لإنشاء وسيطات حقل معقدة بسهولة مع العقد والنص لتحسين أتمتة المستندات.
type: docs
weight: 1960
...
يبني وسيطة حقل معقدة تتكون من الحقول والعقد والنص العادي.
...
| اسم | وصف |
| --- | --- |
| [FieldArgumentBuilder](fieldargumentbuilder/)() | يقوم بتهيئة مثيل لـ`FieldArgumentBuilder` الصف. |

## طُرق

| اسم | وصف |
| --- | --- |
| [AddField](../../aspose.words.fields/fieldargumentbuilder/addfield/)(*[FieldBuilder](../fieldbuilder/)*) | يضيف حقلًا يمثله[`FieldBuilder`](../fieldbuilder/) إلى الحجة. |
| [AddNode](../../aspose.words.fields/fieldargumentbuilder/addnode/)(*[Inline](../../aspose.words/inline/)*) | يضيف عقدة إلى الحجة. |
| [AddText](../../aspose.words.fields/fieldargumentbuilder/addtext/)(*string*) | يضيف نصًا عاديًا إلى الوسيطة. |
