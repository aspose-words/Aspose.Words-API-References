...
description: اكتشف خاصية FieldLink FormatUpdateType لإدارة كيفية تحديث تنسيق الكائنات المرتبطة بكفاءة. حسّن سير عملك اليوم!
type: docs
weight: 30
...
يحصل على طريقة لتحديث تنسيق الكائن المرتبط أو يحددها.
