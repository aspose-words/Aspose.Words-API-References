...
description: FieldLink AutoUpdate ملكية. الحصول على أو تعيين ما إذا كان سيتم تحديث هذا الحقل تلقائيًا في C#.
type: docs
weight: 20
...
الحصول على أو تعيين ما إذا كان سيتم تحديث هذا الحقل تلقائيًا.
