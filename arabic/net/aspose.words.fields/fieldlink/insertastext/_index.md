...
description: اكتشف خاصية FieldLink InsertAsText لإدارة الكائنات المرتبطة بسهولة بتنسيق نصي فقط، مما يعزز وضوح مستندك وكفاءته.
type: docs
weight: 80
url: /ar/net/aspose.words.fields/fieldlink/insertastext/
---
## FieldLink.InsertAsText property

يحصل على أو يحدد ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نصي فقط.
