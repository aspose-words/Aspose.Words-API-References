...
description: الحصول على أو تحديد ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نصي فقط.
type: docs
weight: 80
...
الحصول على أو تحديد ما إذا كان سيتم إدراج الكائن المرتبط بتنسيق نصي فقط.
