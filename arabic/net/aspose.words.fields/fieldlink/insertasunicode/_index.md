...
description: اكتشف خاصية FieldLink InsertAsUnicode لإدارة الكائنات المرتبطة بسهولة كنص Unicode، مما يعزز توافق البيانات ومرونتها.
type: docs
weight: 90
...
يحصل على أو يحدد ما إذا كان سيتم إدراج الكائن المرتبط كنص Unicode.
