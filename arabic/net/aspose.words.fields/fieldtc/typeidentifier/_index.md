...
description: اكتشف خاصية مُعرِّف نوع الحقل FieldTC. أدر مُعرِّفات نوع الحقل بسهولة باستخدام هذه الميزة متعددة الاستخدامات، مما يُحسِّن تنظيم بياناتك وكفاءتها.
type: docs
weight: 50
...
يحصل على معرف نوع لهذا الحقل (وهو عادةً حرف) أو يعينه.
