...
description: حسّن مجموعة عناصر DropDownItemCollection بسهولة باستخدام طريقة الإضافة. أضف سلاسل نصية فورًا لتوسيع مجموعتك وتحسين تجربة المستخدم.
type: docs
weight: 30
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| value | String | السلسلة التي سيتم إضافتها إلى نهاية المجموعة. |

### قيمة الإرجاع

الفهرس المبني على الصفر والذي يتم عنده إدراج العنصر الجديد.
