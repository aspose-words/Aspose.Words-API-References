...
description: DropDownItemCollection طريقة. يضيف سلسلة في نهاية المجموعة.
type: docs
weight: 30
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| value | String | السلسلة المراد إضافتها إلى نهاية المجموعة. |

### قيمة الإرجاع

الفهرس الصفري الذي يتم فيه إدراج العنصر الجديد.
