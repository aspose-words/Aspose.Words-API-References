...
description: DropDownItemCollection طريقة. لتحديد ما إذا كانت المجموعة تحتوي على القيمة المحددة.
type: docs
weight: 50
...
لتحديد ما إذا كانت المجموعة تحتوي على القيمة المحددة.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| value | String | قيمة حساسة لحالة الأحرف لتحديد موقع. |
