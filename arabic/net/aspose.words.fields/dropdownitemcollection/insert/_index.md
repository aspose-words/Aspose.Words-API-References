...
description: أدخل سلاسل نصية بسهولة في DropDownItemCollection عند أي فهرس باستخدام طريقة الإدراج سهلة الاستخدام. حسّن إدارة بياناتك اليوم!
type: docs
weight: 80
...
يقوم بإدراج سلسلة في المجموعة عند الفهرس المحدد.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| index | Int32 | المؤشر المبني على الصفر والذي يتم إدراج القيمة عنده. |
| value | String | السلسلة التي سيتم إدراجها. |
