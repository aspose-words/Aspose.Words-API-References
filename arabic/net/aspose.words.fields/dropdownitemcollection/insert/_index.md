...
description: DropDownItemCollection طريقة. إدراج سلسلة في المجموعة بالفهرس المحدد.
type: docs
weight: 80
...
إدراج سلسلة في المجموعة بالفهرس المحدد.
...
| معامل | يكتب | وصف |
| --- | --- | --- |
| index | Int32 | الفهرس الصفري الذي تُدرج فيه القيمة. |
