...
description: FieldRD ملكية. الحصول على أو تعيين اسم الملف المراد تضمينه عند إنشاء جدول محتويات أو جدول مراجع مصدقة أو فهرس.
type: docs
weight: 20
...
الحصول على أو تعيين اسم الملف المراد تضمينه عند إنشاء جدول محتويات أو جدول مراجع مصدقة أو فهرس.
