...
description: اكتشف فئة Aspose.Words.Fields.FieldData، مفتاحك لتطبيق حقول البيانات بكفاءة في المستندات. حسّن أتمتة مستنداتك اليوم!
type: docs
weight: 2140
...
يوضح كيفية إدراج حقل البيانات في مستند.
