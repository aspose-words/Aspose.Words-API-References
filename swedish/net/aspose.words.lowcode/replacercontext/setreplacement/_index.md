...
description: Förbättra dina sök- och ersättningsåtgärder med metoden ReplacerContext SetReplacement, vilket möjliggör sömlös hantering av mönster och ersättningar för effektivitet.
type: docs
weight: 30
url: /sv/net/aspose.words.lowcode/replacercontext/setreplacement/
---
## SetReplacement(*string, string*) {#setreplacement}

Ställer in mönster och ersättning som används av sök/ersätt-operationen.
...
Med den här metoden åsidosätts tidigare inställt mönster och ersättning.
