...
description: Förbättra ditt arbetsflöde med vår processor som effektivt hanterar inmatade dokument för sömlös bearbetning och förbättrad produktivitet.
type: docs
weight: 20
url: /sv/net/aspose.words.lowcode/processor/from/
---
...
Om processorn bara accepterar en fil som indata kommer endast den senast angivna filen att bearbetas. [`Merger`](../../merger/) Processorn accepterar flera filer som indata, vilket resulterar i att alla angivna dokument slås samman. [`Converter`](../../converter/) Processorn accepterar endast en fil som indata, så endast den senast angivna filen kommer att konverteras.
