...
description: Upptäck egenskapen DataSources i ReportBuilderContext för sömlös rapportgenerering med mångsidiga datakällor skräddarsydda efter dina behov.
type: docs
weight: 20
url: /sv/net/aspose.words.lowcode/reportbuildercontext/datasources/
---
## ReportBuilderContext.DataSources property

Datakällor som använts för att skapa rapporten.
...
Nyckeln representerar datakällan, medan värdet är datakällans namn. Datakällans namn kan vara null eller en tom sträng; I sådana fall kommer rapporteringsmotorn automatiskt att identifiera datakällans namn från den angivna datakällan.
