...
description: Upptäck ReportBuilderContext ReportBuilderOptions för effektiv rapportgenerering med anpassningsbara funktioner och förbättrad funktionalitet för dina projekt.
type: docs
weight: 30
url: /sv/net/aspose.words.lowcode/reportbuildercontext/reportbuilderoptions/
---
## ReportBuilderContext.ReportBuilderOptions property

Alternativ för rapportbyggnation.
