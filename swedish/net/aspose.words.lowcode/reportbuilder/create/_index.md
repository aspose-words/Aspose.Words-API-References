...
description: Skapa kraftfulla rapporter enkelt med ReportBuilder Create-metoden, utformad för att effektivisera din rapportgenereringsprocess och öka produktiviteten.
type: docs
weight: 10
url: /sv/net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}

Skapar en ny instans av rapportbyggarens processor.
