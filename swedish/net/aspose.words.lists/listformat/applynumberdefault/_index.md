...
description: Upptäck hur metoden ApplyNumberDefault skapar en standardnumrerad lista för dina stycken, vilket förbättrar organisationen och tydligheten i dina dokument.
type: docs
weight: 60
...
Startar en ny standardnumrerad lista och tillämpar den på stycket.
...
Detta är en genvägsmetod som skapar en ny lista med standardmallen numbered , tillämpar den på stycket och väljer den första listnivån.
