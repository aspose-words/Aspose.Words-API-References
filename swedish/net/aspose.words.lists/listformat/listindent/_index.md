...
description: Förbättra dokumentets struktur med ListFormat ListIndent-metoden, vilket enkelt höjer styckets listnivå för ökad tydlighet.
type: docs
weight: 70
...
Den här metoden ändrar listnivån och tillämpar formateringsegenskaperna för den nya nivån.

I Word-dokument kan listor bestå av upp till nio nivåer. Listformatering för varje nivå anger vilken punkt eller siffra som används, vänsterindrag, mellanslag mellan punkten och texten etc.
