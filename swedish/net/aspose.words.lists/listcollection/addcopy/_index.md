...
description: Upptäck ListCollection AddCopy-metoden för att enkelt och effektivt duplicera en lista och förbättra din dokumentsamling.
type: docs
weight: 50
...
| --- | --- | --- |
| srcList | List | Källistan att kopiera från. |
...
Om källistan är en referens till eller en definition av en liststil, är den nyskapade listan inte relaterad till den ursprungliga liststilen.
