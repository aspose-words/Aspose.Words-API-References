...
description: Upptäck egenskapen ListLevel LinkedStyle för att enkelt hantera och anpassa styckeformat för dina listor, vilket förbättrar dokumentets formatering och läsbarhet.
type: docs
weight: 60
...
Hämtar eller ställer in styckeformatet som är länkat till den här listnivån.
...
Den här fastigheten är`null` när listnivån inte är länkad till ett styckeformat. Den här egenskapen kan ställas in på`null`.
