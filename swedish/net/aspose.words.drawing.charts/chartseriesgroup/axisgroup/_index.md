...
description: Upptäck egenskapen ChartSeriesGroup AxisGroup och hantera enkelt din seriegrupps axel för förbättrad datavisualisering och analys.
type: docs
weight: 10
url: /sv/net/aspose.words.drawing.charts/chartseriesgroup/axisgroup/
---
## ChartSeriesGroup.AxisGroup property

Hämtar eller ställer in axelgruppen som denna seriegrupp tillhör.
