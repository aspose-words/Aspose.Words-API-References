...
description: Upptäck egenskapen AxisX i ChartSeriesGroup för enkel åtkomst till X-axelns funktioner, vilket förbättrar din datavisualisering och analysupplevelse.
type: docs
weight: 20
url: /sv/net/aspose.words.drawing.charts/chartseriesgroup/axisx/
---
## ChartSeriesGroup.AxisX property

Ger åtkomst till egenskaper för X-axeln i denna seriegrupp.
