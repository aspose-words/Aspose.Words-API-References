...
description: Upptäck egenskapen ChartSeriesGroup Series för att få tillgång till en unik samling relaterade serier, vilket förbättrar din datavisualiseringsupplevelse.
type: docs
weight: 100
url: /sv/net/aspose.words.drawing.charts/chartseriesgroup/series/
---
## ChartSeriesGroup.Series property

Hämtar en samling serier som tillhör den här seriegruppen.
