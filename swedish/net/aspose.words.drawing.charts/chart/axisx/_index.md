...
description: Utforska egenskapen DiagramaxelX för sömlös kontroll över diagrammets primära X-axel, vilket förbättrar datavisualisering och insikter.
type: docs
weight: 20
url: /sv/net/aspose.words.drawing.charts/chart/axisx/
---
## Chart.AxisX property

Ger åtkomst till egenskaper för diagrammets primära X-axel.
