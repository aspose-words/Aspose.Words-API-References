...
description: Upptäck egenskapen ChartDataPoint Index och anpassa enkelt formateringen av datapunkter för förbättrad datavisualisering och insikter i dina diagram.
type: docs
weight: 40
...
Index för datapunkten som detta objekt formaterar.
