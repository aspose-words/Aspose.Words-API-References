...
description: Upptäck hur metoden ChartDataPoint ClearFormat återställer din datapunkts format till standardinställningen, vilket förbättrar tydlighet och konsekvens i dina diagram.
type: docs
weight: 70
...
Rensar formatet för denna datapunkt. Egenskaperna ställs in på standardvärdena som definierats i den överordnade serien.
