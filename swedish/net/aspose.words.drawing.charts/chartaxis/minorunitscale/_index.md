...
description: Upptäck egenskapen ChartAxis MinorUnitScale för att enkelt anpassa mindre skalmarkeringar på din tidskategoriaxel för förbättrad datavisualisering.
type: docs
weight: 190
...
Returnerar eller ställer in skalningsvärdet för mindre skalmärken på tidskategoriaxeln.
