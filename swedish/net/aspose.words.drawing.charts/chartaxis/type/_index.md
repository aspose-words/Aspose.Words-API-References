...
description: Upptäck egenskapen ChartAxis Type för att enkelt identifiera axeltyper och förbättra din datavisualisering för tydligare insikter och bättre analys.
type: docs
weight: 260
