...
description: Upptäck egenskapen ChartAxis TickLabels för att anpassa dina axelmarkeringsetiketter för förbättrad datavisualisering och tydlighet i dina diagram.
type: docs
weight: 230
url: /sv/net/aspose.words.drawing.charts/chartaxis/ticklabels/
---
## ChartAxis.TickLabels property

Ger åtkomst till egenskaperna för axelns tickmarkeringsetiketter.
