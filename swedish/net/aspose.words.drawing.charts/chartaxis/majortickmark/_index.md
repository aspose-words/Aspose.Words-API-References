...
description: Upptäck egenskapen ChartAxis MajorTickMark för att enkelt anpassa diagrammets större skalmarkeringar för förbättrad visuell tydlighet och precision.
type: docs
weight: 120
...
Returnerar eller anger de viktigaste skalmarkeringarna.
