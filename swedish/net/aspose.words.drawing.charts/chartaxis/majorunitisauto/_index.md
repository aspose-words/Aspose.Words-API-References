...
description: Upptäck egenskapen ChartAxis MajorUnitIsAuto och styr enkelt avståndet mellan större skalmarkeringar för förbättrad tydlighet och precision i diagram i dina datavisualiseringar.
type: docs
weight: 140
...
Hämtar eller ställer in en flagga som anger om standardavståndet mellan större skalstreck ska användas.
