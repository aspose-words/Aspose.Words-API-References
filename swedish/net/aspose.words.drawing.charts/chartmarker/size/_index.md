...
description: Justera diagrammarkörens storlek enkelt! Anpassa diagrammets markörstorlek för ökad tydlighet och visuell tilltalning. Standardinställningen är 7.
type: docs
weight: 20
...
Hämtar eller ställer in diagrammarkörstorlek. Standardvärdet är 7.
