...
description: Justera AxisTickLabels justering utan ansträngning. Kontrollera textpositionering för tydligare och mer läsbara grafer och förbättra din datavisualisering.
type: docs
weight: 10
url: /sv/net/aspose.words.drawing.charts/axisticklabels/alignment/
---
## AxisTickLabels.Alignment property

Hämtar eller ställer in textjustering för axeltacketiketterna.
