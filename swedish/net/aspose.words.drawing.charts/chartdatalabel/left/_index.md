...
description: Justera egenskapen ChartDataLabel Left för att styra dataetiketternas placering i diagrammet. Förbättra tydlighet och presentation med exakta avståndsinställningar.
type: docs
weight: 60
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/left/
---
## ChartDataLabel.Left property

Hämtar eller anger avståndet för dataetiketten i punkter från diagrammets vänstra kant eller från positionen som anges av dess[`Position`](../position/) egendom, beroende på värdet av[`LeftMode`](../leftmode/) egenskap.
