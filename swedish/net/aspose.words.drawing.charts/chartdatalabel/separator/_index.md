...
description: ChartDataLabel Separator fast egendom. Hämtar eller ställer in strängseparator som används för dataetiketterna i ett diagram. Standard är ett kommatecken förutom för cirkeldiagram som endast visar kategorinamn och procent då en radbrytning ska användas istället i C#.
type: docs
weight: 70
