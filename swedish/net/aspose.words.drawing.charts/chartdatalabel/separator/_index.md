...
description: Upptäck egenskapen ChartDataLabel Separator för att anpassa diagrammets dataetiketter. Ställ enkelt in strängavgränsare för tydligare visualisering och insikter.
type: docs
weight: 120
...
Hämtar eller ställer in strängavgränsare som används för dataetiketter i ett diagram. Standardvärdet är ett kommatecken, förutom för cirkeldiagram som endast visar kategorinamn och procentandel, då en radbrytning ska användas istället.
