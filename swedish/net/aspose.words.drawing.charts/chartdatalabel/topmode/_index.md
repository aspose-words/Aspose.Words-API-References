...
description: Upptäck egenskapen ChartDataLabel TopMode för att anpassa placeringen av dataetiketter i dina diagram. Förbättra tydligheten och precisionen i dina visuella datapresentationer!
type: docs
weight: 220
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/topmode/
---
## ChartDataLabel.TopMode property

Hämtar eller ställer in tolkningsläget för[`Top`](../top/) egenskapsvärde: om den anger location för dataetiketten från diagrammets överkant eller från den position som anges av dess[`Position`](../position/) egenskap.
