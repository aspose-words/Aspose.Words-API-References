...
description: Upptäck egenskapen ChartDataLabel LeftMode för att anpassa placeringen av dataetiketter i dina diagram. Förbättra tydlighet och presentation med precisionskontroll.
type: docs
weight: 70
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/leftmode/
---
## ChartDataLabel.LeftMode property

Hämtar eller ställer in tolkningsläget för[`Left`](../left/) egenskapsvärde: om den anger location för dataetiketten från diagrammets vänstra kant eller från den position som anges av dess[`Position`](../position/) egenskap.
