...
description: Upptäck egenskapen ChartDataLabel NumberFormat för att enkelt anpassa talformat för förbättrad datavisualisering i dina diagram.
type: docs
weight: 80
...
Returnerar talformatet för det överordnade elementet.
