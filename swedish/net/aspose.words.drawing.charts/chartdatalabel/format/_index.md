...
description: Upptäck egenskapen ChartDataLabel Format för enkel åtkomst till anpassningsbar fyllnings- och linjeformatering, vilket enkelt förbättrar din datavisualisering.
type: docs
weight: 20
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/format/
---
## ChartDataLabel.Format property

Ger åtkomst till fyllnings- och linjeformatering av dataetiketten.
