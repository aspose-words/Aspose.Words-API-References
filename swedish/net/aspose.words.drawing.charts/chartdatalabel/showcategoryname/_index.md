...
description: Förbättra dina diagram med egenskapen ChartDataLabel ShowCategoryName. Visa enkelt kategorinamn på dataetiketter för tydligare insikter och bättre visuella effekter.
type: docs
weight: 140
...
Gör det möjligt att ange om kategorinamnet ska visas för dataetiketterna i ett diagram. Standardvärdet är`falsk` .
