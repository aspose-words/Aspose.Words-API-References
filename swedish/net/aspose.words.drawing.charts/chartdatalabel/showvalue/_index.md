...
description: Upptäck egenskapen ChartDataLabel ShowValue för att förbättra din datavisualisering. Kontrollera värdevisning i etiketter för tydligare insikter. Standardvärde är falskt.
type: docs
weight: 200
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/showvalue/
---
## ChartDataLabel.ShowValue property

Gör det möjligt att ange om värden ska visas i dataetiketterna. Standardvärdet är`falsk` .
