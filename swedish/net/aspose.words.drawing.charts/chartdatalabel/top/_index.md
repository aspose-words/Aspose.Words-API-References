...
description: Justera egenskapen ChartDataLabel Top för att styra positioneringen av dataetiketter för förbättrad tydlighet i diagrammet. Optimera din visuella datarepresentation utan ansträngning!
type: docs
weight: 210
url: /sv/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

Hämtar eller ställer in dataetikettens avstånd i punkter från diagrammets överkant eller från positionen som anges av dess[`Position`](../position/) egendom, beroende på värdet av[`TopMode`](../topmode/) egenskap.
...
Egenskapens värde ändras proportionellt om diagrammets form ändras i storlek.
