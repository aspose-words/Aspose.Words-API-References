...
description: Returnerar eller ställer in en boolesk för att indikera visningsbeteendet för serienamnet för dataetiketterna i ett diagram. Sant för att visa serienamnet. Falskt att dölja. Som standard false.
type: docs
weight: 120
