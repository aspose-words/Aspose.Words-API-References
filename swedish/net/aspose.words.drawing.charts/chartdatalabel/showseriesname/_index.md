...
description: Upptäck egenskapen ChartDataLabel ShowSeriesName, styr enkelt serienamnens synlighet i dina diagram. Förbättra datatydligheten med en enkel boolesk inställning!
type: docs
weight: 190
...
Returnerar eller anger ett booleskt värde för att ange visningsbeteendet för serienamn för dataetiketterna i ett diagram. `sann` för att visa seriens namn;`falsk` att dölja. Som standard`falsk` .
