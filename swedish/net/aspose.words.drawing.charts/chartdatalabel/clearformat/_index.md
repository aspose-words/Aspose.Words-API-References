...
description: Upptäck hur du använder metoden ChartDataLabel ClearFormat för att återställa dina dataetiketter till standardinställningarna, vilket förbättrar tydligheten och konsekvensen i dina diagram.
type: docs
weight: 230
...
Rensar formatet för denna dataetikett. Egenskaperna ställs in på standardvärdena som definierats i den överordnade data etikettsamlingen.
