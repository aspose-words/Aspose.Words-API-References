...
description: Aktivera procentvisning på diagramdataetiketter med egenskapen ChartDataLabel ShowPercentage. Förbättra tydligheten och insikterna i dina visuella data!
type: docs
weight: 180
...
Gör det möjligt att ange om procentvärde ska visas för dataetiketterna i ett diagram. Standardvärdet är`falsk` .
