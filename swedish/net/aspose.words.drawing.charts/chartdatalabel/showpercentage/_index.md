...
description: ChartDataLabel ShowPercentage fast egendom. Gör det möjligt att ange om ett procentvärde ska visas för dataetiketterna i ett diagram. Standardvärdet ärfalsk  i C#.
type: docs
weight: 130
