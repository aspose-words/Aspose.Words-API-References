...
description: Upptäck egenskapen ChartDataLabel ShowDataLabelsRange för att förbättra dina diagram genom att visa dataetikettvärden. Öka tydligheten med den här enkla funktionen!
type: docs
weight: 150
...
Gör det möjligt att ange om värden från dataetikettintervallet ska visas i dataetiketterna. Standardvärdet är`falsk` .
