...
description: Upptäck egenskapen FormatCode i ChartYValueCollection för att enkelt anpassa formateringen av Y-värden. Förbättra din datavisualisering med precision!
type: docs
weight: 20
url: /sv/net/aspose.words.drawing.charts/chartyvaluecollection/formatcode/
---
## ChartYValueCollection.FormatCode property

Hämtar eller ställer in formatkoden som tillämpas på Y-värdena.
