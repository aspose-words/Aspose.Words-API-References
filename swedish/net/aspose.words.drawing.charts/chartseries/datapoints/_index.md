...
description: Upptäck egenskapen ChartSeries DataPoints, som erbjuder en omfattande samling formateringsverktyg för att förbättra varje datapunkt i din serie.
type: docs
weight: 40
...
Returnerar en samling formateringsobjekt för alla datapunkter i den här serien.
