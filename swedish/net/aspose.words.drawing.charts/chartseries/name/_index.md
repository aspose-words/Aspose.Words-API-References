...
description: Hämtar eller ställer in namnet på serien om namnet inte anges explicit genereras det med index. Som standard returnerar Series plus ett baserat index.
type: docs
weight: 100
