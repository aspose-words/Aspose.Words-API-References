...
description: Upptäck egenskapen ChartSeries Name, hantera enkelt serienamn, generera automatiskt med index och förbättra datavisualiseringen utan ansträngning.
type: docs
weight: 110
...
Hämtar eller anger namnet på serien. Om namnet inte anges explicit genereras det med hjälp av index. Returnerar som standard serien plus ett baserat på index.
