...
description: Upptäck AxisScalings Maximum-egenskap för att enkelt ställa in eller hämta axelns maximala värde, vilket förbättrar din datavisualisering med precision.
type: docs
weight: 30
...
Hämtar eller ställer in axelns maximala värde.
