...
description: Upptäck egenskapen AxisScaling Minimum för att enkelt ställa in och anpassa din axels minimivärde för förbättrad datavisualisering.
type: docs
weight: 40
...
Hämtar eller ställer in minimivärdet för axeln.
