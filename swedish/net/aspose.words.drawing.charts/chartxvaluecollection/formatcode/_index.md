...
description: Upptäck egenskapen ChartXValueCollection FormatCode och anpassa enkelt X-värdesformat för förbättrad datavisualisering och tydlighet i dina diagram.
type: docs
weight: 20
url: /sv/net/aspose.words.drawing.charts/chartxvaluecollection/formatcode/
---
## ChartXValueCollection.FormatCode property

Hämtar eller ställer in formatkoden som tillämpas på X-värdena.
