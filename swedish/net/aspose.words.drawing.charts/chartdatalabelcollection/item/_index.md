...
description: Få enkelt åtkomst till specifika ChartDataLabels med egenskapen Item i ChartDataLabelCollection. Förbättra din datavisualisering idag!
type: docs
weight: 40
...
Returer[`ChartDataLabel`](../../chartdatalabel/) för det angivna indexet.
