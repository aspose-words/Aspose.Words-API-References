...
description: Skapar en ny datakälla med data från en JSON-fil med standardalternativ för att tolka JSON-data.
type: docs
weight: 10
...
* namnutrymme [Aspose.Words.Reporting](../../jsondatasource)
