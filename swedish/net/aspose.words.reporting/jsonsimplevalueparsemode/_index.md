...
description: Anger ett läge för att analysera JSON enkla värden null boolean nummer heltal och sträng när JSON laddas. Ett sådant läge påverkar inte analysen av datum-tid-värden.
type: docs
weight: 4440
