...
description: Hämtar eller ställer in ett läge för att analysera JSON enkla värden null boolean nummer heltal och sträng medan JSON laddas. Ett sådant läge påverkar inte analysen av datum-tid-värden. Standard är Loose .
type: docs
weight: 40
