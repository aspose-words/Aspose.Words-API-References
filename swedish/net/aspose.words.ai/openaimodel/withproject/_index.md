...
description: Förbättra dina AI-funktioner med OpenAiModels WithProject-metod – tilldela enkelt projekt för att optimera prestanda och effektivisera ditt arbetsflöde.
type: docs
weight: 20
url: /sv/net/aspose.words.ai/openaimodel/withproject/
---
## OpenAiModel.WithProject method

Ställer in ett angivet projekt till modellen.
