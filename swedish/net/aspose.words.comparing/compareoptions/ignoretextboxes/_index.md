...
description: Upptäck hur egenskapen CompareOptions IgnoreTextboxes förbättrar datajämförelse genom att exkludera skillnader i textrutor för mer exakta resultat.
type: docs
weight: 120
...
Anger om skillnader i data i textrutor ska jämföras.
...
Som standard ignoreras inte textrutor.
