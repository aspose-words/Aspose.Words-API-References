...
description: Upptäck hur egenskapen CompareOptions IgnoreHeadersAndFooters förbättrar dokumentbehandlingen genom att ignorera sidhuvuden och sidfot för en renare dataanalys.
type: docs
weight: 100
...
True anger att innehållet i sidhuvuden och sidfoten ignoreras.
...
Som standard ignoreras inte sidhuvuden och sidfot.
