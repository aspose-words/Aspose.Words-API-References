...
description: Upptäck hur egenskapen CompareOptions IgnoreCaseChanges förbättrar dokumentjämförelse genom att aktivera analys som inte är skiftlägeskänslig för korrekta resultat.
type: docs
weight: 50
...
True indikerar att dokumentjämförelsen är okänslig för versaler och gemener.
...
Som standard är jämförelsen skiftlägeskänslig.
