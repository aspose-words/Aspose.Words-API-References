...
description: Upptäck hur egenskapen CompareOptions IgnoreFields förbättrar effektiviteten genom att styra fältskillnadsjämförelser för optimerade resultat.
type: docs
weight: 70
...
Anger om skillnader i fält ska jämföras.
...
Som standard ignoreras inte fält.
