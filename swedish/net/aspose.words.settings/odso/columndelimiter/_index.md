...
description: Anger tecknet som ska tolkas som kolumnavgränsaren som används för att separera kolumner inom externa datakällor. Standardvärdet är 0 vilket betyder att det inte finns någon kolumnavgränsare definierad.
type: docs
weight: 20
