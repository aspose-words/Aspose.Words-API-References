...
description: Upptäck Odsos UdlConnectString-egenskap för sömlösa kopplingar till externa datakällor med UDL. Lås upp dataintegration enkelt och effektivt!
type: docs
weight: 90
...
Anger den UDL-anslutningssträng (Universal Data Link) som används för att ansluta till en extern datakälla. Standardvärdet är en tom sträng.
