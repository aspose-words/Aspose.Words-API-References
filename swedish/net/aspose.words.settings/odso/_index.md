...
description: Anger ODSO-inställningarna Office Data Source Object för en kopplingsdatakälla.
type: docs
weight: 5580
...
| [FirstRowContainsColumnNames](../../aspose.words.settings/odso/firstrowcontainscolumnnames) { get; set; } | Anger att ett värdprogram ska behandla den första raden med data i den angivna externa data -källan som en rubrikrad som innehåller namnen på varje kolumn i datakällan. Standardvärdet är`falsk` . |
