...
description: Anger det fördefinierade sammanslagningsfältets namn som ska mappas till kolumnnumret som anges avColumnaspose.words.settings/odsofieldmapdata/column/ egenskap inom denna fältmappning. Standardvärdet är en tom sträng.
type: docs
weight: 30
