...
description: Anger det nollbaserade indexet för kolumnen inom en extern datakälla som ska mappas till det lokala namnet på ett specifikt MERGEFIELDfält. Standardvärdet är 0.
type: docs
weight: 20
