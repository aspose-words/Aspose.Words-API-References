...
description: Anger kolumnnamnet inom en extern datakälla för kolumnen vars index anges avColumnaspose.words.settings/odsofieldmapdata/column property. Standardvärdet är en tom sträng.
type: docs
weight: 40
