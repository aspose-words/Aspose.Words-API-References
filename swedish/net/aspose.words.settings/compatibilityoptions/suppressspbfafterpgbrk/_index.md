...
description: Optimera din dokumentlayout med CompatibilityOptions SuppressSpBfAfterPgBrk. Eliminera oönskade mellanslag efter sidbrytningar för en renare formatering.
type: docs
weight: 500
...
Använd inte mellanslag före första raden efter en sidbrytning.
