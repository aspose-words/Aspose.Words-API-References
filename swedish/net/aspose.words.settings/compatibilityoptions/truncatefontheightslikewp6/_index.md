...
description: Optimera teckensnittshöjderna enkelt med CompatibilityOptions TruncateFontHeightsLikeWP6, vilket imiterar WordPerfect 6.x för sömlös dokumentformatering.
type: docs
weight: 560
...
Emulera WordPerfect 6.x teckensnittshöjdsberäkning.
