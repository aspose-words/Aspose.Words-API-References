...
description: Upptäck egenskapen CompatibilityOptions DoNotUseEastAsianBreakRules för att optimera dokumentrutnät utan att komprimera tecken. Förbättra din formatering idag!
type: docs
weight: 200
