...
description: Upptäck hur egenskapen CompatibilityOptions DoNotVertAlignInTxbx förbättrar textruteformatering genom att ignorera vertikal justering för förbättrad designflexibilitet.
type: docs
weight: 240
