...
description: Förbättra dina tabeller med egenskapen AdjustLineHeightInTable för exakt radavstånd. Förbättra dokumentets tydlighet och presentation utan ansträngning!
type: docs
weight: 10
...
Lägg till rutnätsavstånd för dokument till linjer i tabellceller.
