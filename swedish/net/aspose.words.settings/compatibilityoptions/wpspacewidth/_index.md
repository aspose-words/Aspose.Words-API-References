...
description: Upptäck hur egenskapen CompatibilityOptions WPSpaceWidth låter dig anpassa utrymmesbredden precis som i WordPerfect 5.x för förbättrad dokumentformatering.
type: docs
weight: 700
...
Anger om bredden på ett mellanslag ska ställas in som i WordPerfect 5.x.
