...
description: Upptäck egenskapen SelectFldWithFirstOrLastChar för CompatibilityOptions. Välj enkelt fält baserat på det första eller sista tecknet för ökad effektivitet.
type: docs
weight: 410
