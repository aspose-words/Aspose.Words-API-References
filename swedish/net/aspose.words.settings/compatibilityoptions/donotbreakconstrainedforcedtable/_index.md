...
description: Upptäck egenskapen CompatibilityOptions DoNotBreakConstrainedForcedTable för att förhindra radbrytningar runt flytande tabeller för sömlösa layouter.
type: docs
weight: 130
...
Bryt inte tabellrader runt flytande tabeller.
