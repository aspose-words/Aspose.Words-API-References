...
description: Upptäck egenskapen AlignTablesRowByRow för CompatibilityOptions. Justera tabellrader oberoende av varandra för förbättrad layoutkontroll och förbättrad designflexibilitet.
type: docs
weight: 20
...
Justera tabellrader oberoende av varandra.
