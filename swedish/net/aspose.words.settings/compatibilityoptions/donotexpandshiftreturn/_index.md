...
description: Upptäck egenskapen DoNotExpandShiftReturn i CompatibilityOptions för att förhindra oönskad radjustering. Optimera din textformatering utan problem!
type: docs
weight: 150
...
Rader som slutar på mjuk radbrytning ska inte justeras.
