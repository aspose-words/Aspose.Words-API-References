...
description: Upptäck hur egenskapen LayoutTableRowsApart förbättrar kompatibiliteten genom att möjliggöra oberoende radbrytning av inline-objekt i tabellrader för bättre designflexibilitet.
type: docs
weight: 300
...
Tillåt tabellrader att radbryta inbäddade objekt oberoende av varandra.
