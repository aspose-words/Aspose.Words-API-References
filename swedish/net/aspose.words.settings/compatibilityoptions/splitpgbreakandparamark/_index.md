...
description: Upptäck egenskapen SplitPgBreakAndParaMark för CompatibilityOptions. Säkerställ sömlös formatering genom att flytta styckemarkeringar till nästa sida efter brytningar.
type: docs
weight: 460
...
Flytta alltid stycketecknet till sidan efter en sidbrytning.
