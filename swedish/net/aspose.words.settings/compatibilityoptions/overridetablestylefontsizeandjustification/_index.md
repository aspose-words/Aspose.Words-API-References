...
description: Upptäck hur egenskapen OverrideTableStyleFontSizeAndJustification förbättrar dokumentets stilhierarki för förbättrad formatering och läsbarhet.
type: docs
weight: 380
...
Anger hur dokumentets stilhierarki utvärderas.
