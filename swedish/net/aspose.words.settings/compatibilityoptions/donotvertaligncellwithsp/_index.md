...
description: Upptäck egenskapen CompatibilityOptions DoNotVertAlignCellWithSp för att förhindra vertikal justering av celler med flytande objekt för renare layouter.
type: docs
weight: 230
