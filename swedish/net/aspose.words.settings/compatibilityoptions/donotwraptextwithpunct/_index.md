...
description: Upptäck egenskapen DoNotWrapTextWithPunct i CompatibilityOptions för att förhindra att interpunktion hänger sig i teckenrutnätet för renare och professionellare layouter.
type: docs
weight: 250
...
Tillåt inte hängande interpunktion med teckenrutnät.
