...
description: Förbättra din typografi med egenskapen CompatibilityOptions UseAnsiKerningPairs för förbättrad läsbarhet och professionell design.
type: docs
weight: 610
...
Använd ANSI-kerningpar från teckensnitt.
