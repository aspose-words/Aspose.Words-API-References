...
description: Upptäck egenskapen CompatibilityOptions NoSpaceRaiseLower för att bibehålla radhöjden för upphöjd eller sänkt text, vilket säkerställer ett polerat och professionellt utseende.
type: docs
weight: 360
...
Öka inte radhöjden för upphöjd/sänkt text.
