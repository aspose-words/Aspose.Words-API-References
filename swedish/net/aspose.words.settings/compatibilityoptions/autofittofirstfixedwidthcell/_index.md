...
description: Upptäck hur egenskapen AutofitToFirstFixedWidthCell förbättrar tabelllayouter genom att tillåta att kolumner överskrider önskade bredder för optimal visning.
type: docs
weight: 50
...
Tillåt tabellkolumner att överskrida önskad bredd för ingående celler.
...
Alternativet heter "Använd regler för automatisk anpassning av tabeller i Word 2003" i användargränssnittet för MS Word 2013. Det påverkar faktiskt även hur rutnätet beräknas för tabeller med fast layout (i vissa fall).
