...
description: Upptäck egenskapen NoLeading i CompatibilityOptions för att eliminera oönskat avstånd mellan textrader för ett renare och mer professionellt utseende.
type: docs
weight: 350
...
Lägg inte till radavstånd mellan textrader.
