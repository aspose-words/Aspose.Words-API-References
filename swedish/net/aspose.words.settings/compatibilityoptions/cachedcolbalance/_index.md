...
description: Optimera din layout med egenskapen CompatibilityOptions CachedColBalance. Förbättra kolumnbalanseringen med hjälp av cachelagrad styckeinformation för sömlös design.
type: docs
weight: 80
