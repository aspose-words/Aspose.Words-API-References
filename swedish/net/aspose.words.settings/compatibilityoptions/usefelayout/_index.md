...
description: Upptäck egenskapen CompatibilityOptions UseFELayout – säkerställ optimal östasiatisk och komplex skriptlayout för en sömlös användarupplevelse.
type: docs
weight: 620
...
Hoppa inte över östasiatisk/komplex skriptlayoutkod.
