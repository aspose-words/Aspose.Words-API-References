...
description: Upptäck hur du inaktiverar funktionen "Fäst inte mot rutnät" i tabellceller, vilket förbättrar dokumentlayouten och objektplaceringen för bättre designkontroll.
type: docs
weight: 170
...
Fäst inte mot dokumentrutnät i tabellceller med objekt.
