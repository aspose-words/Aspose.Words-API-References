...
description: Optimera din layout med CompatibilityOptions NoExtraLineSpacing. Säkerställ exakt justering utan att centrera innehållet på exakta radhöjder för en renare design.
type: docs
weight: 340
...
Centrera inte innehållet på rader med exakt radhöjd.
