...
description: Upptäck hur egenskapen ForgetLastTabAlignment förbättrar styckejusteringen genom att ignorera den sista tabbstoppsbredden för text som inte är vänsterjusterad.
type: docs
weight: 270
...
Ignorera bredden på sista tabbstoppet vid justering av stycke om det inte är vänsterjusterat.
