...
description: Optimera dina dokument med CompatibilityOptions UseWord97LineBreakRules för att förbättra östasiatisk radbrytning och förbättra läsbarhet och formatering.
type: docs
weight: 680
...
Emulera Word 97 östasiatisk radbrytning.
