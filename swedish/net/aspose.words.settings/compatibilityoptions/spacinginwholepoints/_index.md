...
description: Upptäck egenskapen CompatibilityOptions SpacingInWholePoints för att enkelt justera textavstånd med heltecknen för förbättrad läsbarhet och design.
type: docs
weight: 450
