...
description: Upptäck hur egenskapen ConvMailMergeEsc förbättrar kompatibiliteten genom att behandla bakåtsnedstreck som dubbla citattecken, vilket effektiviserar formateringen av ditt dokument.
type: docs
weight: 90
...
Behandla omvänt snedstreck som två citattecken.
