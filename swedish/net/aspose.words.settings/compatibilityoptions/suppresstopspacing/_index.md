...
description: Optimera din layout med egenskapen CompatibilityOptions SuppressTopSpacing och ignorera radhöjdsinställningarna för ett renare utseende på första sidan.
type: docs
weight: 510
...
Ignorera minsta och exakta radhöjd för första raden på sidan.
