...
description: Optimera dina utskrifter med CompatibilityOptions egenskap UsePrinterMetrics för korrekt dokumentvisning. Förbättra prestanda och kvalitet utan ansträngning!
type: docs
weight: 640
...
Använd skrivarmätvärden för att visa dokument.
...
Skrivarens mätvärden kan variera beroende på vilka drivrutiner som används. Till exempel ger Windows "Microsoft OpenXPS Class Driver 2" och "Microsoft Print to PDF" något olika mätvärden. Därför kan det slutliga dokumentets layout ändras om det här alternativet är aktiverat.
