...
description: Optimera dina dokument med CompatibilityOptions AutoSpaceLikeWord95 för exakt FullWidth-teckenavstånd, vilket förbättrar läsbarhet och stil.
type: docs
weight: 60
...
Emulera Word 95 teckenavstånd med full bredd.
