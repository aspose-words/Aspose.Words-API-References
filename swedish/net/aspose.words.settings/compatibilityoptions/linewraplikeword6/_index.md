...
description: Förbättra östasiatisk textformatering med CompatibilityOptions LineWrapLikeWord6, som emulerar radbrytning i Word 6.0 för förbättrad läsbarhet och presentation.
type: docs
weight: 310
...
Emulera radbrytning i Word 6.0 för östasiatisk text.
