...
description: Optimera din layout med egenskapen CompatibilityOptions SuppressSpacingAtTopOfPage. Kontrollera radhöjden för en sömlös visning på första raden.
type: docs
weight: 490
...
Ignorera minsta radhöjd för första raden på sidan.
