...
description: Upptäck egenskapen PrintBodyTextBeforeHeader för CompatibilityOptions. Förbättra dina dokument genom att skriva ut brödtext före sidhuvud och sidfot!
type: docs
weight: 390
...
Skriv ut brödtext före innehåll i sidhuvud/sidfot.
