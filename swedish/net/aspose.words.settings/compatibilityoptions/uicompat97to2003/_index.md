...
description: Optimera ditt användargränssnitt med inställningen CompatibilityOptions UICompat97To2003. Inaktivera icke-kompatibla funktioner för smidig användning av Word 97-2003. Förbättra prestandan idag!
type: docs
weight: 570
...
True för att inaktivera UI-funktionalitet som inte är kompatibel med Word97-2003. Standardvärdet är`falsk` .
...
Styr kompatibilitetsinställningen för Word97-2003 som inaktiverar UI-funktionalitet som inte är kompatibel med Word97-2003. När`sann` XML-elementet 'w:uiCompat97To2003' skrivs till '\word\settings.xml' dokumentpaket part. Standardvärdet är`falsk` När den är inställd på`falsk` , detta element är inte skrivet. Tekniskt sett är den här egenskapen inte en del av kompatibilitetsalternativen, men vi har lagt den här för API-bekvämlighet.
