...
description: Förbättra din webbdesign med CompatibilityOptions ShowBreaksInFrames. Visualisera enkelt sid- och kolumnbrytningar i ramar för förbättrad layoutkontroll.
type: docs
weight: 430
...
Visa sid-/kolumnbrytningar i ramar.
