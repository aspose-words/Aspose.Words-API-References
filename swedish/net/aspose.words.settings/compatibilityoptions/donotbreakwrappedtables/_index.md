...
description: Upptäck egenskapen CompatibilityOptions DoNotBreakWrappedTables för att förhindra att flytande tabeller bryts över sidor för en sömlös dokumentlayout.
type: docs
weight: 140
...
Tillåt inte att flytande tabeller bryts över sidor.
