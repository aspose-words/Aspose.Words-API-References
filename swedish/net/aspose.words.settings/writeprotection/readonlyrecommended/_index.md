...
description: Upptäck egenskapen WriteProtection ReadOnlyRecommended, som vägleder användare att öppna dokument i skrivskyddat läge för förbättrad säkerhet och integritet.
type: docs
weight: 20
