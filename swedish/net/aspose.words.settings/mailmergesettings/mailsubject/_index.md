...
description: Anpassa din MailMerge med egenskapen MailSubject för att skapa engagerande ämnesrader för e-post eller fax. Förbättra kommunikationen med personligt innehåll.
type: docs
weight: 130
...
Anger texten som ska visas i ämnesraden för e-postmeddelanden eller fax som skapas under dokumentkopplingen. Standardvärdet är en tom sträng.
