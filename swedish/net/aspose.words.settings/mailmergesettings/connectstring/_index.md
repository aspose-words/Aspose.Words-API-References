...
description: Upptäck hur MailMergeSettings ConnectString-egenskapen länkar till externa datakällor. Anpassa enkelt din anslutning för sömlös dataintegration!
type: docs
weight: 50
...
Anger anslutningssträngen som används för att ansluta till en extern datakälla. Standardvärdet är en tom sträng.
