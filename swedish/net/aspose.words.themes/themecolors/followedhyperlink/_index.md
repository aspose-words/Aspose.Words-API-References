...
description: Upptäck egenskapen ThemeColors FollowedHyperlink för att anpassa färgen på din klickade hyperlänk, vilket förbättrar din webbplats visuella attraktionskraft och användarupplevelse.
type: docs
weight: 90
...
Anger färg för en klickad hyperlänk.
