...
description: Anpassa dokumentets utseende med egenskapen Temafärger, vilket möjliggör en unik uppsättning livfulla färger för ett fantastiskt utseende.
type: docs
weight: 20
...
Gör det möjligt att ange uppsättningen temafärger för dokumentet.
