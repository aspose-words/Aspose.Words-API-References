...
description: Anpassa din webbplats typografi med MajorFonts. Ställ enkelt in olika teckensnitt för flera språk för att förbättra läsbarheten och användarupplevelsen.
type: docs
weight: 30
url: /sv/net/aspose.words.themes/theme/majorfonts/
---
## Theme.MajorFonts property

Gör det möjligt att ange de viktigaste teckensnitten för olika språk.
