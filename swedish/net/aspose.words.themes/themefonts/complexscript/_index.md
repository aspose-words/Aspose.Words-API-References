...
description: Upptäck egenskapen ComplexScript i ThemeFonts för att anpassa teckensnittsnamn för förbättrad teckenvisning i ComplexScript. Förbättra din design idag!
type: docs
weight: 10
...
Anger teckensnittsnamn för ComplexScript-tecken.
