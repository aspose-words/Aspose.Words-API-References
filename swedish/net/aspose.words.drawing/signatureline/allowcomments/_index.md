...
description: Upptäck egenskapen AllowComments i SignatureLine, vilket gör det möjligt för undertecknare att lägga till kommentarer i dialogrutan Signera för förbättrad feedback. Standardvärdet är falskt.
type: docs
weight: 10
