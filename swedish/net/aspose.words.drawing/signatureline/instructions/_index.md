...
description: Hämtar eller ställer in instruktioner till undertecknaren som visas när signaturraden signeras. Den här egenskapen ignoreras omDefaultInstructionsaspose.words.drawing/signatureline/defaultinstructions är satt. Standardvärde för den här egenskapen är tom sträng Empty .
type: docs
weight: 50
