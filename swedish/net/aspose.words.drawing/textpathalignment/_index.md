...
description: Upptäck Aspose.Words.Drawing.TextPathAlignment-uppräkningen för exakt WordArt-justering. Förbättra din dokumentdesign med mångsidiga textalternativ!
type: docs
weight: 1770
...
| --- | --- | --- |
| Stretch | `0` | Sträck ut varje textrad så att den passar bredden. |
| Center | `1` | Centrera texten på bredden. |
| Left | `2` | Vänsterjustera. |
| Right | `3` | Högerjustera. |
| LetterJustify | `4` | Sprid ut bokstäverna så att de passar bredden. |
| WordJustify | `5` | Sprid ut orden så att de passar bredden. |
