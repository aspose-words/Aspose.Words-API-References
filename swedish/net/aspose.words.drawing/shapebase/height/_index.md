...
description: ShapeBase Height fast egendom. Hämtar eller ställer in höjden på formens innehållsblock i C#.
type: docs
weight: 200
...
Hämtar eller ställer in höjden på formens innehållsblock.
