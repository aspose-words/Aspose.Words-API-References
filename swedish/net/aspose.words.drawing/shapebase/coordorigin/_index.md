...
description: Upptäck ShapeBase CoordOrigin-egenskapen för att optimera dina designer. Få tillgång till exakta koordinater för det övre vänstra hörnet av formens innehållsblock.
type: docs
weight: 110
...
Koordinaterna i det övre vänstra hörnet av det block som innehåller den här formen.
