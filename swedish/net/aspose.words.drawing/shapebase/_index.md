...
description: Utforska klassen Aspose.Words.Drawing.ShapeBase, din grund för att skapa dynamiska ritningar, inklusive autoformer, OLE-objekt och ActiveX-kontroller.
type: docs
weight: 1650
...
| namn | Beskrivning |
| --- | --- |
| abstract [Accept](../../aspose.words/node/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Tar emot en besökare. |
| abstract [AcceptEnd](../../aspose.words/compositenode/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | När den implementeras i en härledd klass, anropas VisitXXXEnd-metoden för den angivna dokumentbesökaren. |
| abstract [AcceptStart](../../aspose.words/compositenode/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | När den implementeras i en härledd klass, anropas VisitXXXStart-metoden för den angivna dokumentbesökaren. |
...
Detta är en abstrakt klass. De två härledda klasser som du kan instansiera är[`Shape`](../shape/) och[`GroupShape`](../groupshape/).

En form är en nod i dokumentträdet.

Om formen är underordnad en[`Paragraph`](../../aspose.words/paragraph/) objekt, då sägs formen vara "på toppnivå". Former på toppnivå mäts och placeras i punkter.

En form kan också förekomma som underordnad till en[`GroupShape`](../groupshape/) objekt när flera shapes grupperas. Underformer till en gruppform placeras i koordinatrummet och units definieras av[`CoordSize`](./coordsize/) och[`CoordOrigin`](./coordorigin/) egenskaper för gruppformen parent .

En form kan placeras inbäddad i texten eller flytande. Positioneringsmetoden styrs med hjälp av[`WrapType`](./wraptype/) egendom.

När en form är flytande positioneras den i förhållande till något (t.ex. det aktuella stycket, marginalen eller sidan). Formens relativa positionering anges med hjälp av .[`RelativeHorizontalPosition`](./relativehorizontalposition/) och[`RelativeVerticalPosition`](./relativeverticalposition/) egenskaper.

En flytande form kan placeras explicit med hjälp av[`Left`](./left/) och[`Top`](./top/) egenskaper eller justerad i förhållande till något annat objekt med hjälp av[`HorizontalAlignment`](./horizontalalignment/) och[`VerticalAlignment`](./verticalalignment/) egenskaper.
