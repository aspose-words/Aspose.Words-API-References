...
description: Upptäck om din form är ett WordArt-objekt med ShapeBase. Få exakta resultat och förbättra dina designprojekt utan ansträngning!
type: docs
weight: 380
...
Returer`sann` om den här formen är ett WordArt-objekt.
...
Fungerar till kompatibilitetsläge 2007. I kompatibilitetsläge 2010 och högre är WordArt bara en textbox med snygga teckensnitt.
