...
description: Upptäck GradientStopCollections mångsidiga Item-egenskap för att enkelt hantera GradientStop-objekt och förbättra din design med livfulla gradienter.
type: docs
weight: 20
...
Hämtar eller ställer in en[`GradientStop`](../../gradientstop/) objekt i samlingen.
