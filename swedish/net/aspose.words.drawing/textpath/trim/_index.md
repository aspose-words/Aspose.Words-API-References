...
description: Upptäck egenskapen TextPath Trim för att förbättra din design genom att ta bort oönskat utrymme ovanför och under text för ett renare och mer polerat utseende.
type: docs
weight: 180
...
Avgör om extra utrymme tas bort ovanför och under texten.
