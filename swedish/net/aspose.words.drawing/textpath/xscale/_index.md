...
description: Upptäck hur egenskapen TextPath XScale förbättrar din design genom att möjliggöra raka textbanor för jämnare och mer exakta layouter.
type: docs
weight: 200
...
Avgör om en rak textbana ska användas istället för formbanan.
...
Om`sann`, texten löper längs en bana från vänster till höger längs x-värdet för , formens nedre gräns.
