...
description: Upptäck egenskapen TextPath SameLetterHeights för att säkerställa enhetlig bokstavshöjd, vilket förbättrar textläsbarheten och designkonsekvensen i hela projektet.
type: docs
weight: 100
url: /sv/net/aspose.words.drawing/textpath/sameletterheights/
---
## TextPath.SameLetterHeights property

Avgör om alla bokstäver ska ha samma höjd oavsett skiftläge/gemensamma skiftlägen.
