...
description: Upptäck egenskapen TextPath FontFamily för att enkelt definiera och anpassa dina textbanor för fantastisk typografi i webbdesign.
type: docs
weight: 40
...
Definierar familjen för textpath-teckensnittet.
