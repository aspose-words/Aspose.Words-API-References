...
description: Upptäck hur TextPath FitPath förbättrar din design genom att säkerställa att texten sömlöst följer alla former, vilket skapar fantastiska visuella effekter.
type: docs
weight: 20
url: /sv/net/aspose.words.drawing/textpath/fitpath/
---
## TextPath.FitPath property

Definierar om texten passar in i en forms bana.
