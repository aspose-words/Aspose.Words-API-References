...
description: Upptäck hur egenskapen TextPath Shadow förbättrar din text med anpassningsbara skuggor för fantastiska visuella effekter på dina designer.
type: docs
weight: 110
url: /sv/net/aspose.words.drawing/textpath/shadow/
---
## TextPath.Shadow property

Definierar om en skugga appliceras på texten på en textbana.
