...
description: Upptäck egenskapen TextPath ReverseRows för att förbättra din layout. Kontrollera radordningen för förbättrad designflexibilitet och användarupplevelse.
type: docs
weight: 80
...
Avgör om layoutordningen för raderna är omvänd.
...
Om`sann`, radernas layoutordning är omvänd. Detta attribut används för vertikal textlayout.
