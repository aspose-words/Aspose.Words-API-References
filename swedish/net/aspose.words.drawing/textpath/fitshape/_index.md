...
description: Upptäck hur egenskapen TextPath FitShape säkerställer att din text passar perfekt inom en forms avgränsningsram för ökad designflexibilitet.
type: docs
weight: 30
url: /sv/net/aspose.words.drawing/textpath/fitshape/
---
## TextPath.FitShape property

Definierar om texten passar in i en forms avgränsningsram.
