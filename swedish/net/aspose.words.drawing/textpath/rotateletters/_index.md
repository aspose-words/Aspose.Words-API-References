...
description: Upptäck egenskapen TextPath RotateLetters för att förbättra dina designer genom att styra textrotation för en dynamisk visuell effekt. Förhöj din kreativitet!
type: docs
weight: 90
url: /sv/net/aspose.words.drawing/textpath/rotateletters/
---
## TextPath.RotateLetters property

Avgör om bokstäverna i texten roteras.
