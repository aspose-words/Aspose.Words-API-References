...
description: Upptäck TextPath Kerning-egenskapen för att förbättra typografin genom att styra kerninginställningarna för förbättrad textläsbarhet och designkvalitet.
type: docs
weight: 60
