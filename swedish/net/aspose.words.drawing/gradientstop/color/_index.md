...
description: Upptäck egenskapen GradientStop Color för att enkelt ställa in och anpassa gradientstoppfärger för fantastiska visuella effekter i dina designer.
type: docs
weight: 30
url: /sv/net/aspose.words.drawing/gradientstop/color/
---
## GradientStop.Color property

Hämtar eller ställer in ett värde som representerar färgen på gradientstoppet.
