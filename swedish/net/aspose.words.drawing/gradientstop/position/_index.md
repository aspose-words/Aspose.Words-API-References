...
description: Upptäck egenskapen GradientStop Position, ställ enkelt in och justera gradientstopppositioner från 0 % till 100 % för fantastiska visuella effekter i dina designer.
type: docs
weight: 40
...
Hämtar eller ställer in ett värde som representerar positionen för ett stopp inom lutningen uttryckt som en procentandel i intervallet 0,0 till 1,0.
