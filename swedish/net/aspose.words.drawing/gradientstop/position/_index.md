...
description: Hämtar eller ställer in ett värde som representerar positionen för ett stopp inom gradient uttryckt som en procent i intervallet 00 till 10.
type: docs
weight: 30
