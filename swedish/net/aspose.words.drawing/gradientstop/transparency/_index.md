...
description: Upptäck egenskapen GradientStop Transparency för att enkelt justera transparensen för gradientfyllning från 0 % till 100 %. Förbättra dina designer med exakt kontroll!
type: docs
weight: 50
...
Hämtar eller ställer in ett värde som representerar transparensen för gradientfyllningen uttryckt som en procentandel i intervallet 0,0 till 1,0.
