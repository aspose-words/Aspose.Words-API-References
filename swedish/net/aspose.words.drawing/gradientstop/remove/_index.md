...
description: Hantera enkelt dina övertoningar med metoden GradientStop Remove, vilket förenklar borttagningen av övertoningar från valfri GradientStopCollection.
type: docs
weight: 60
url: /sv/net/aspose.words.drawing/gradientstop/remove/
---
## GradientStop.Remove method

Tar bort gradientstoppet från föräldern[`GradientStopCollection`](../../gradientstopcollection/) .
