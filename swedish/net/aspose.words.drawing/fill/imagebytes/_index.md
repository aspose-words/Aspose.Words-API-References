...
description: Få tillgång till råa byte för din fyllnadstextur eller ditt mönster med ImageBytes-egenskapen för sömlös designintegration och förbättrad visuell kvalitet.
type: docs
weight: 140
...
Hämtar råa byte av fyllnadstexturen eller mönstret.
