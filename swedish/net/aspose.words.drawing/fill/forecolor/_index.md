...
description: Ställ in egenskapen ForeColor för att anpassa fyllningens förgrundsfärg med ett Color-objekt, vilket förbättrar den visuella attraktionskraften och designflexibiliteten.
type: docs
weight: 70
...
Den här egenskapen återställer alfakomponenten iColor till helt ogenomskinlig färg till skillnad från[`Color`](../color/) egendom, som bevarar den.
