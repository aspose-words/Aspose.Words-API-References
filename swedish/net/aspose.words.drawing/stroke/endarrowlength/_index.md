...
description: Upptäck egenskapen Stroke EndArrowLength för att anpassa din design med exakta pilspetslängder, vilket förbättrar visuell tydlighet och stil.
type: docs
weight: 80
...
Definierar pilspetslängden för slutet av ett penseldrag.
