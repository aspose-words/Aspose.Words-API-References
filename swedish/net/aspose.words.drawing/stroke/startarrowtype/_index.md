...
description: Upptäck egenskapen Stroke StartArrowType för att anpassa pilspetsar i början av penseldrag, vilket förbättrar din designs visuella attraktionskraft och tydlighet.
type: docs
weight: 220
...
Definierar pilspetsen för början av ett streck.
