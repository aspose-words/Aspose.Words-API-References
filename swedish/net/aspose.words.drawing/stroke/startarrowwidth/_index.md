...
description: Upptäck egenskapen Stroke StartArrowWidth för att anpassa pilspetsbredden för dina penseldrag, vilket förbättrar din designs precision och visuella attraktionskraft.
type: docs
weight: 230
...
Definierar pilspetsbredden för början av ett streck.
