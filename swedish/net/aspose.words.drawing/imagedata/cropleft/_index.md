...
description: Upptäck egenskapen ImageData CropLeft för att enkelt justera bildinramningen genom att ta bort oönskade delar från vänster sida för perfekt passform.
type: docs
weight: 70
...
Definierar andelen bildborttagning från vänster sida.
