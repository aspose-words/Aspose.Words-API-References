...
description: Upptäck egenskapen ImageData IsLinkOnly. Den indikerar om en bild är externt länkad, vilket förbättrar dokumenteffektiviteten och lagringshanteringen.
type: docs
weight: 160
...
Returer`sann` om bilden är länkad och inte lagrad i dokumentet.
