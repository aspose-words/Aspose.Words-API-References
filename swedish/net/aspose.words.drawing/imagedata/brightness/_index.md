...
description: Justera bildens ljusstyrka med egenskapen Ljusstyrka i ImageData. Ställ in värden från 0,0 (ljusast) till 1,0 (ljusast) för optimal visuell effekt.
type: docs
weight: 30
...
Hämtar eller ställer in bildens ljusstyrka. Värdet för den här egenskapen måste vara ett tal från 0,0 (svagast) till 1,0 (ljusast).
