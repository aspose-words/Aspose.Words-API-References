...
description: Upptäck egenskapen ImageData CropBottom för att enkelt anpassa dina bilder genom att ta bort oönskade delar från botten för perfekt passform.
type: docs
weight: 60
url: /sv/net/aspose.words.drawing/imagedata/cropbottom/
---
## ImageData.CropBottom property

Definierar andelen av bilden som ska tas bort från undersidan.
