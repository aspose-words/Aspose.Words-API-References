...
description: Upptäck ImageData BiLevel-egenskapen för att enkelt styra svartvit bildvisning och förbättra ditt visuella innehåll med precision.
type: docs
weight: 10
...
Avgör om en bild ska visas i svartvitt.
