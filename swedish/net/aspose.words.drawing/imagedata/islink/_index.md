...
description: Upptäck hur egenskapen ImageData IsLink förbättrar din design genom att länka bilder till former sömlöst när SourceFullName är inställt. Öka din kreativitet!
type: docs
weight: 150
...
Returer`sann` om bilden är länkad till formen (när[`SourceFullName`](../sourcefullname/) är specificerad).
