...
description: Upptäck ImageData GrayScale-egenskapen för att förbättra dina bilder. Kontrollera gråskalevisning för fantastiska visuella effekter och förbättrat användarengagemang.
type: docs
weight: 100
...
Avgör om en bild ska visas i gråskaleläge.
