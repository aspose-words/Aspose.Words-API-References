...
description: Hämtar eller ställer in kontrasten för den angivna bilden. Värdet för den här egenskapen måste vara ett tal från 00 den minsta kontrasten till 10 den största kontrasten.
type: docs
weight: 50
