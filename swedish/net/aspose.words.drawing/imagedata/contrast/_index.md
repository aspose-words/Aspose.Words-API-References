...
description: Justera enkelt bildkontrasten med egenskapen ImageData Contrast. Ställ in värden från 0,0 (låg) till 1,0 (hög) för optimal bildskärpa och kvalitet.
type: docs
weight: 50
...
Hämtar eller ställer in kontrasten för den angivna bilden. Värdet för den här egenskapen måste vara ett tal från 0,0 (minsta kontrast) till 1,0 (största kontrast).
