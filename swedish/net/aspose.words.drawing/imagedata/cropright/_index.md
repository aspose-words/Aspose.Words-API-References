...
description: Upptäck ImageData CropRight-egenskapen, styr bildbeskärning från höger sida för exakt bildredigering och förbättrad visuell attraktionskraft.
type: docs
weight: 80
...
Definierar andelen bildborttagning från höger sida.
