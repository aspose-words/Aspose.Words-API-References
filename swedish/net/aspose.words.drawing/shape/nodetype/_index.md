...
description: Upptäck egenskapen Shape NodeType som returnerar en form, vilket förbättrar din designflexibilitet och optimerar ditt projekts visuella attraktionskraft.
type: docs
weight: 140
