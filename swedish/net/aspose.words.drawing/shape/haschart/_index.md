...
description: Ta reda på om din form har ett diagram med egenskapen HasChart. Förbättra din datavisualisering utan ansträngning!
type: docs
weight: 80
...
Returer`sann` om detta[`Shape`](../) har en[`Chart`](../../../aspose.words.drawing.charts/chart/) .
