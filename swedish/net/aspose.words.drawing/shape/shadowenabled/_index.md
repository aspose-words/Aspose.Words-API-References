...
description: Upptäck hur egenskapen Shape ShadowEnabled förbättrar dina designer genom att aktivera skuggeffekter för en mer dynamisk visuell intrycksfullhet.
type: docs
weight: 160
...
Returer`sann` om en skuggeffekt är aktiverad.
