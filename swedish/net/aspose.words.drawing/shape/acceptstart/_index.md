...
description: Upptäck Shape AcceptStart-metoden, vägled besökare sömlöst till början av din design, vilket förbättrar engagemanget och användarupplevelsen.
type: docs
weight: 270
url: /sv/net/aspose.words.drawing/shape/acceptstart/
---
## Shape.AcceptStart method

Accepterar en besökare för att besöka början av formen.
