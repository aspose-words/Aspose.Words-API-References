...
description: Anpassa ditt WordArt-arkiv med egenskapen Shape TextPath för att förbättra det visuella intrycket och enkelt skapa fantastiska texteffekter.
type: docs
weight: 240
...
Definierar texten i textbanan (för ett WordArt-objekt).
