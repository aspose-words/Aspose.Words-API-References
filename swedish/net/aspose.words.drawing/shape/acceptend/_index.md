...
description: Upptäck Shape AcceptEnd-metoden för att smidigt vägleda besökare till formens slut, vilket förbättrar användarupplevelsen och interaktionen.
type: docs
weight: 260
url: /sv/net/aspose.words.drawing/shape/acceptend/
---
## Shape.AcceptEnd method

Accepterar en besökare för att besöka slutet av formen.
