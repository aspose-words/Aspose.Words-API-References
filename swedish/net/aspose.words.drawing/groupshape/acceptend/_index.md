...
description: Upptäck GroupShape AcceptEnd-metoden, hantera besökarinteraktioner sömlöst och förbättra din applikations användarupplevelse med denna kraftfulla funktion.
type: docs
weight: 40
url: /sv/net/aspose.words.drawing/groupshape/acceptend/
---
## GroupShape.AcceptEnd method

Accepterar en besökare för att besöka slutet av gruppformen.
