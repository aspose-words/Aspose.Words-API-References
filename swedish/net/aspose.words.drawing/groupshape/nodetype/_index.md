...
description: Upptäck egenskapen GroupShape NodeType som effektivt returnerar GroupShape, vilket förbättrar din designflexibilitet och funktionalitet i projekt.
type: docs
weight: 20
