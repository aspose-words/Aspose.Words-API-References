...
description: Upptäck OfficeMaths AcceptEnd-metod – hantera besökarnas åtkomst smidigt och förbättra din matteupplevelse på kontoret. Öka effektiviteten idag!
type: docs
weight: 70
url: /sv/net/aspose.words.math/officemath/acceptend/
---
## OfficeMath.AcceptEnd method

Tar emot en besökare för att besöka slutet av kontorets matematik.
