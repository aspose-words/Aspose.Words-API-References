...
description: Hämtar/ställer in en kodning som användes för att koda ekvations-XML om detta matematiska kontorsobjekt läses från -ekvations-XML. Vi använder kodningen när vi sparar ett dokument för att skriva i samma kodning som det lästes.
type: docs
weight: 20
