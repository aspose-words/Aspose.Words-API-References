...
description: Upptäck OfficeMaths AcceptStart-metod, utformad för att smidigt välkomna besökare och förbättra din matteupplevelse på kontoret. Öka produktiviteten idag!
type: docs
weight: 80
url: /sv/net/aspose.words.math/officemath/acceptstart/
---
## OfficeMath.AcceptStart method

Tar emot en besökare för att besöka början av kontorsmaten.
