...
Kapslar in kodpunkter och glyfer som utgör ett grafem.
...
| namn | Beskrivning |
| --- | --- |
| [Codepoints](../../aspose.words.shaping/cluster/codepoints/) { get; } | Hämtar kodpunkter för klustret. |
| [CodepointsLength](../../aspose.words.shaping/cluster/codepointslength/) { get; } | Får totalt antal kodpunkter i`Cluster` . |
| [Glyphs](../../aspose.words.shaping/cluster/glyphs/) { get; } | Hämtar glyfer för klustret. |
