...
description: Implementera detta gränssnitt för att tillåta sammanslagning av e-post från en anpassad datakälla till exempel en lista med objekt. Master-detalj data stöds också.
type: docs
weight: 3590
