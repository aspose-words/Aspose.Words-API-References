...
description: Returnerar namnet på datakällan.
type: docs
weight: 10
...
Om du implementerar[`IMailMergeDataSource`](../../imailmergedatasource), returnera namnet på data -källan från den här egenskapen.
