...
description: Upptäck egenskapen MailMergeRegionInfo EndField, som effektivt returnerar slutfältet för dina dataregioner och förbättrar din dokumentautomation.
type: docs
weight: 10
