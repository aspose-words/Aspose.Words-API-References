...
description: Upptäck egenskapen MailMergeRegionInfo Regions, som effektivt returnerar en omfattande lista över underordnade regioner för sömlös datahantering.
type: docs
weight: 80
