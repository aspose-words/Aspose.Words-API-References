...
description: Upptäck egenskapen MailMergeRegionInfo Name, som effektivt hämtar namnet på en angiven region för sömlös dokumentautomatisering.
type: docs
weight: 60
