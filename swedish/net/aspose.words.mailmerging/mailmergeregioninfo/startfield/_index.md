...
description: Upptäck egenskapen MailMergeRegionInfo StartField – hämta effektivt startfältet för dina sammanslagningsområden och effektivisera din dokumentautomation.
type: docs
weight: 90
...
Returnerar ett startfält för regionen.
