...
description: Upptäck MailMerge GetRegionsByName-metoden för att enkelt hämta en samling av kopplingsområden efter namn, vilket förbättrar din dokumentautomation.
type: docs
weight: 240
...
Returnerar en samling av kopplingsområden för dokument med det angivna namnet.
