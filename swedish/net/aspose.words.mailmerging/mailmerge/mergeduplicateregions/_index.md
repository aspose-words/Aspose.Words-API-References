...
description: Hämtar eller ställer in ett värde som indikerar om alla dokumentkopplingsregioner med namnet på en datakälla ska slås samman under körning av en epostkoppling med regioner mot datakällan eller bara den första.
type: docs
weight: 60
