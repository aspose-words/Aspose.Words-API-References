...
description: MappedDataFieldCollection fast egendom. Hämtar eller ställer in namnet på fältet i datakällan som är kopplad till det angivna kopplingsfältet.
type: docs
weight: 20
