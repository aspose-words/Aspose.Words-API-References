...
description: Upptäck egenskapen MappedDataFieldCollection Item för att enkelt hantera fältnamn i din datakälla för sömlös integrering av dokumentkoppling.
type: docs
weight: 20
url: /sv/net/aspose.words.mailmerging/mappeddatafieldcollection/item/
---
## MappedDataFieldCollection indexer

Hämtar eller anger namnet på fältet i datakällan som är associerat med det angivna fältet för koppling av dokument.
