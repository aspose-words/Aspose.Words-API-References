...
description: Hämta enkelt dokumentsignaturer med DigitalSignatureCollection. Få åtkomst till signaturer via index för effektiv dokumenthantering och förbättrad effektivitet.
type: docs
weight: 40
...
Hämtar en dokumentsignatur vid det angivna indexet.
