...
description: Upptäck egenskapen DigitalSignature IssuerName, som anger utfärdarens unika namn för förbättrad säkerhet och förtroende för dina digitala certifikat.
type: docs
weight: 30
...
Returnerar certifikatutfärdarens ämnesnamn.
