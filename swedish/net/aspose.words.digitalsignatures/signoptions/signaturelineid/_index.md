...
description: Upptäck egenskapen SignatureLineId i SignOptions. Identifiera enkelt signaturrader med ett unikt GUID, vilket förbättrar effektiviteten i din dokumenthantering.
type: docs
weight: 50
...
Signaturradsidentifierare. Standardvärdet är**Tom (bara nollor) Guid** .
...
När den är inställd associerar den[`SignatureLine`](../../../aspose.words.drawing/signatureline/) med motsvarande[`DigitalSignature`](../../digitalsignature/) .
