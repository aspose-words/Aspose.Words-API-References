...
description: Bilden som kommer att visas i tillhörandeSignatureLineaspose.words.drawing/signatureline/ . Standardvärdet ärnull .
type: docs
weight: 60
...
Bilden som kommer att visas i tillhörande[`SignatureLine`](../../../aspose.words.drawing/signatureline/) . Standardvärdet är`null` .
