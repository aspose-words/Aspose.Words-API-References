...
description: Upptäck GlossaryDocument AcceptStart-metoden för att smidigt välkomna besökare och förbättra deras upplevelse från början av din ordlista.
type: docs
weight: 80
url: /sv/net/aspose.words.buildingblocks/glossarydocument/acceptstart/
---
## GlossaryDocument.AcceptStart method

Accepterar en besökare för att besöka början av ordlistadokumentet.
