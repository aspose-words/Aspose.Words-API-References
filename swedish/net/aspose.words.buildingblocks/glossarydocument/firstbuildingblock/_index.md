...
description: Upptäck egenskapen FirstBuildingBlock i GlossaryDocument. Få enkel åtkomst till den inledande byggstenen för effektiv dokumenthantering.
type: docs
weight: 30
...
Hämtar den första byggstenen i ordlistadokumentet.
