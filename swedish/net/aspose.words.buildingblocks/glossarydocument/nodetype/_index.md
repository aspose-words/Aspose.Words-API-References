...
description: Upptäck egenskapen GlossaryDocument NodeType, som effektivt hämtar GlossaryDocument-värdet för förbättrad innehållshantering.
type: docs
weight: 50
...
ReturnerarGlossaryDocument värde.
