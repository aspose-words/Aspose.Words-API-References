...
description: Utforska Aspose.Words BuildingBlockType-enum för att förbättra dokumentfunktionaliteten i Microsoft Word. Lås upp unik synlighet och beteende för byggblock!
type: docs
weight: 360
...
Anger en byggstenstyp. Typen kan påverka synligheten och beteendet för byggstenen i Microsoft Word.
...
| --- | --- | --- |
| None | `0` | Ingen typinformation har angetts för byggblocket. |
| AutomaticallyReplaceNameWithContent | `1` | Tillåter att byggblocket automatiskt infogas i dokumentet när dess namn anges i ett program. |
| StructuredDocumentTagPlaceholderText | `2` | Byggstenen är en strukturerad platshållartext för dokumenttaggar. |
| FormFieldHelpText | `3` | Byggstenen är en hjälptext för ett formulärfält. |
| Normal | `4` | Byggstenen är en vanlig (dvs. regelbunden) ordlistadokumentpost. |
| AutoCorrect | `5` | Byggstenen är associerad med stavnings- och grammatikverktygen. |
| AutoText | `6` | Byggstenen är en AutoText-post. |
| All | `7` | Byggstenen är associerad med alla typer. |
| Default | `0` | Spara somNone . |

## Anmärkningar

Motsvarar den**ST_Dokumentdeltyp** skriv in OOXML.
