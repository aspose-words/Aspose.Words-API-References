...
description: Få enkelt tillgång till specifika byggstenar med vår BuildingBlockCollection. Hämta objekt via index för sömlös integration i dina projekt.
type: docs
weight: 10
...
Hämtar ett byggblock vid det angivna indexet.
...
| --- | --- |
| index | Ett index till listan över byggstenar. |
