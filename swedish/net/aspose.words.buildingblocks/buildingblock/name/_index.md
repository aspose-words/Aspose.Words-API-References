...
description: Upptäck egenskapen Byggblocksnamn, hantera och anpassa enkelt dina byggblock med en enkel namngivning för förbättrad organisation.
type: docs
weight: 90
...
Hämtar eller anger namnet på detta byggblock.
...
Namnet kan innehålla valfri sträng, vanligtvis en vänlig identifierare. Flera byggstenar kan ha samma namn.

Kan inte vara`null` och kan inte vara en tom sträng.

Motsvarar den**docPartPr.namn** element i OOXML.
