...
description: Upptäck BuildingBlock AcceptEnd-metoden – hantera besökarnas åtkomst sömlöst och förbättra deras upplevelse i slutet av ditt BuildingBlock.
type: docs
weight: 140
url: /sv/net/aspose.words.buildingblocks/buildingblock/acceptend/
---
## BuildingBlock.AcceptEnd method

Accepterar en besökare för att besöka slutet av byggblocket.
