...
description: Upptäck våra egenskaper för BuildingBlock-kategorin för förbättrad kategorisering på andra nivån, effektivisera dina projekt och öka organisationens effektivitet.
type: docs
weight: 30
url: /sv/net/aspose.words.buildingblocks/buildingblock/category/
---
## BuildingBlock.Category property

Anger kategoriseringen på andra nivån för byggblocket.
...
Byggstenar i Microsoft Words användargränssnitt är ordnade i gallerier. Varje[`Gallery`](../gallery/) kan ha flera kategorier. Varje block inom a`Category` har en[`Name`](../name/).

Kan inte vara`null` och kan inte vara en tom sträng.

Motsvarar den**docPartPr.kategori.namn** element i OOXML.
