...
description: Upptäck BuildingBlock GUID-egenskapen. Hantera enkelt en unik 128-bitars identifierare för dina byggblock, vilket säkerställer sömlös organisation och identifiering.
type: docs
weight: 70
...
Hämtar eller ställer in en identifierare (ett 128-bitars GUID) som unikt identifierar detta byggblock.
...
Kan användas av en applikation för att unikt referera till ett byggblock oavsett olika namngivningar på grund av lokalisering.

Motsvarar den**docPartPr.guid** element i OOXML.
