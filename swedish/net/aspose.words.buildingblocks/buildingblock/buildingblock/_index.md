...
description: Upptäck BuildingBlock-konstruktorn, skapa enkelt nya instanser. Lås upp kraftfulla funktioner för sömlös utveckling och förbättrad prestanda!
type: docs
weight: 10
...
När[`BuildingBlock`](../) skapas, tillhör den det angivna ordlistadokumentet, men är ännu inte en del av ordlistadokumentet och[`ParentNode`](../../../aspose.words/node/parentnode/) är`null`.

Att lägga till[`BuildingBlock`](../)till en[`GlossaryDocument`](../../glossarydocument/) använd [`AppendChild`](../../../aspose.words/compositenode/appendchild/).
