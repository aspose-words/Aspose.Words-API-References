...
När[`BuildingBlock`](../../buildingblock) skapas, det tillhör det angivna ordlistadokumentet, men är ännu inte en del av ordlistasdokumentet och[`ParentNode`](../../../aspose.words/node/parentnode) är`null`.

Att lägga till[`BuildingBlock`](../../buildingblock) till a[`GlossaryDocument`](../../glossarydocument) använd [`AppendChild`](../../../aspose.words/compositenode/appendchild).
