...
description: Upptäck BuildingBlock Gallerys unika egenskap för effektiv kategorisering och sömlös sortering i användargränssnittet. Förbättra din organisation idag!
type: docs
weight: 60
...
Anger den första kategoriseringen för byggblocket i syfte att klassificera eller sortera användargränssnittet.
...
Motsvarar den**docPartPr.kategori.galleri** element i OOXML.
