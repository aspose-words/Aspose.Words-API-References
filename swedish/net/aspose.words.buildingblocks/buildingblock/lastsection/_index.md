...
description: Upptäck egenskapen LastSection i BuildingBlock, som effektivt hämtar den sista sektionen, vilket förbättrar din kodningsupplevelse och projektorganisation.
type: docs
weight: 80
...
Hämtar den sista sektionen i byggblocket.
