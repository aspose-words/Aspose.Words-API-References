...
description: Upptäck BuildingBlock FirstSection. Få enkel åtkomst till den första delen av ditt byggblock för effektiv organisation och ökad effektivitet.
type: docs
weight: 50
url: /sv/net/aspose.words.buildingblocks/buildingblock/firstsection/
---
## BuildingBlock.FirstSection property

Hämtar den första sektionen i byggblocket.
