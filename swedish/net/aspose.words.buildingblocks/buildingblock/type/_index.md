...
description: Upptäck egenskapen Byggblockstyp, viktig för att definiera byggblockstyper i dina projekt. Förbättra din design med tydlighet och precision!
type: docs
weight: 120
...
Byggblockstypen kan påverka synligheten och beteendet för byggblocket i Microsoft Word.

Motsvarar den**docPartPr.typer** element i OOXML.
