...
description: Upptäck CustomXmlProperty-konstruktorn. Skapa och initiera enkelt nya instanser för sömlös XML-egenskapshantering i dina projekt.
type: docs
weight: 10
...
| --- | --- | --- |
| name | String | Fastighetens namn. Kan inte vara`null`. |
| uri | String | Egenskapens namnrymds-URI. Kan inte vara`null`. |
| value | String | Fastighetens värde. Kan inte`null`. |
