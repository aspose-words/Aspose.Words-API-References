...
description: Upptäck egenskapen IStructuredDocumentTag Color för att enkelt anpassa och ställa in färger för strukturerade dokumenttaggar, vilket förbättrar dokumentets visuella attraktionskraft.
type: docs
weight: 20
