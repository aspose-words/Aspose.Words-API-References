...
description: FårBuildingBlockaspose.words.buildingblocks/buildingblock/ som innehåller platshållartext som ska visas när innehållet i denna SDTkörning är tomt det associerade mappade XMLelementet är tomt som specificerats viaXmlMappingaspose.words.markup/istructureddocumenttag/xmlmapping/ element ellerIsShowingPlaceholderTextaspose.words.markup/istructureddocumenttag/isshowingplaceholdertext/ element är sant.
type: docs
weight: 70
