...
description: Upptäck SdtListItemCollections SelectedValue-egenskap, som definierar det aktuella urvalet i din lista och tillåter null för ingen urval. Förbättra din datahantering!
type: docs
weight: 30
...
Anger det valda värdet i den här listan. Nullvärde tillåtet, vilket innebär att ingen vald post är associerad med den här listobjektsamlingen.
