...
description: Upptäck metoden SdtListItemCollection GetEnumerator för att effektivt iterera genom samlingsobjekt, vilket förbättrar din kodningseffektivitet och produktivitet.
type: docs
weight: 60
