...
description: Upptäck egenskapen SdtListItem Value för att enkelt komma åt och hantera listobjektvärden för förbättrad datahantering i dina applikationer.
type: docs
weight: 30
...
Hämtar värdet för detta listobjekt.
