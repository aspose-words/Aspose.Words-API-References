...
description: Upptäck klassen Aspose.Words.Markup.StructuredDocumentTagRangeEnd, utformad för sömlös innehållshantering med flera sektioner i strukturerade dokument.
type: docs
weight: 4770
...
Representerar slutet på**avståndsbestämd** strukturerad dokumenttagg som accepterar innehåll i flera sektioner. Se även[`StructuredDocumentTagRangeStart`](../structureddocumenttagrangestart/) nod.
...
| namn | Beskrivning |
| --- | --- |
| [StructuredDocumentTagRangeEnd](structureddocumenttagrangeend/)(*[DocumentBase](../../aspose.words/documentbase/), int*) | Initierar en ny instans av**Slut på intervallet för taggar för strukturerat dokument** klass. |
...
| [Id](../../aspose.words.markup/structureddocumenttagrangeend/id/) { get; } | Anger ett unikt skrivskyddat, beständigt numeriskt ID för detta**Strukturerat dokumenttaggintervall** nod. Motsvarande[`StructuredDocumentTagRangeStart`](../structureddocumenttagrangestart/) noden har samma[`Id`](../structureddocumenttagrangestart/id/) . |
...
| override [NodeType](../../aspose.words.markup/structureddocumenttagrangeend/nodetype/) { get; } | ReturerStructuredDocumentTagRangeEnd . |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.words.markup/structureddocumenttagrangeend/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Tar emot en besökare. |
