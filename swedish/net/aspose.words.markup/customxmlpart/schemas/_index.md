...
description: Upptäck egenskapen CustomXmlPart Schemas för att enkelt hantera XML-scheman länkade till dina anpassade XML-delar, vilket förbättrar dataorganisation och effektivitet.
type: docs
weight: 50
...
Anger den uppsättning XML-scheman som är associerade med denna anpassade XML-del.
