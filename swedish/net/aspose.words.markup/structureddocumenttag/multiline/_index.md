...
description: Upptäck StructuredDocumentTag Multiline-egenskapen, som möjliggör flera textrader för förbättrad dokumentflexibilitet och användarupplevelse.
type: docs
weight: 210
...
Anger om detta**SDT** tillåter flera rader text.
...
Åtkomst till den här egendomen fungerar endast förRichText ochPlainText SDT-typ.
