...
description: Aspose.Words.Markup.StructuredDocumentTag klass. Representerar en strukturerad dokumenttagg SDT eller innehållskontroll i ett dokument i C#.
type: docs
weight: 4060
...
| namn | Beskrivning |
| --- | --- |
| [StructuredDocumentTag](structureddocumenttag/)(*[DocumentBase](../../aspose.words/documentbase/), [SdtType](../sdttype/), [MarkupLevel](../markuplevel/)*) | Initierar en ny instans av**Strukturerad dokumenttagg** class. |
...
| [Checked](../../aspose.words.markup/structureddocumenttag/checked/) { get; set; } | Hämtar/ställer in aktuell status för kryssrutan**SDT** . Standardvärdet för den här egenskapen är`falsk` . |
...
| [LockContentControl](../../aspose.words.markup/structureddocumenttag/lockcontentcontrol/) { get; set; } | När inställd på`Sann` , kommer den här egenskapen att förbjuda en användare att ta bort detta**SDT** . |
| [LockContents](../../aspose.words.markup/structureddocumenttag/lockcontents/) { get; set; } | När inställd på`Sann` , kommer den här egenskapen att förbjuda en användare från att redigera innehållet i denna**SDT** . |
...
| override [NodeType](../../aspose.words.markup/structureddocumenttag/nodetype/) { get; } | ReturnerarStructuredDocumentTag . |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.words.markup/structureddocumenttag/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Accepterar en besökare. |
...
I denna version tillhandahåller Aspose.Words ett antal offentliga metoder och egenskaper för att manipulera beteendet och innehållet i`StructuredDocumentTag` . Mappning av SDT-noder till anpassade XML-paket i ett dokument kan utföras med hjälp av [`XmlMapping`](./xmlmapping/) fast egendom.
