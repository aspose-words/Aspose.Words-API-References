...
description: Upptäck egenskapen StructuredDocumentTag ContentsFont för sömlös textformatering i SDT. Förbättra dina dokument med anpassningsbara teckensnittsalternativ!
type: docs
weight: 80
...
Teckensnittsformatering som kommer att tillämpas på text som matas in i**SDT** .
