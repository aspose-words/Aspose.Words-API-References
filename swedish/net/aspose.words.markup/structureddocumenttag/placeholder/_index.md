...
description: FårBuildingBlockaspose.words.buildingblocks/buildingblock/ som innehåller platshållartext som ska visas när innehållet i denna SDTkörning är tomt det associerade mappade XMLelementet är tomt som specificerats viaXmlMappingaspose.words.markup/structureddocumenttag/xmlmapping/ element ellerIsShowingPlaceholderTextaspose.words.markup/structureddocumenttag/isshowingplaceholdertext/ element är sant.
type: docs
weight: 230
