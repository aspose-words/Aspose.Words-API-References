...
description: Upptäck egenskapen StructuredDocumentTag Appearance för att enkelt anpassa och förbättra den visuella stilen på dina strukturerade dokumenttaggar.
type: docs
weight: 20
...
Hämtar/ställer in utseendet på en strukturerad dokumenttagg.
