...
description: Upptäck egenskapen StructuredDocumentTag ListItems, som ger enkel åtkomst till SdtListItemCollection för förbättrad dokumenthantering och organisation.
type: docs
weight: 180
...
Får[`SdtListItemCollection`](../../sdtlistitemcollection/) i samband med detta**SDT** .
...
Åtkomst till den här egendomen fungerar endast förComboBox ellerDropDownList SDT-typer.
