...
description: Upptäck egenskapen StructuredDocumentTag PlaceholderName för att enkelt hantera BuildingBlock-namn och förbättra dokumentets platshållartext.
type: docs
weight: 240
