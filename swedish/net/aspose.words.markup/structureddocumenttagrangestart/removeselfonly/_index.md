...
description: Tar bort det här intervallets start och lämpliga intervallslutnoder för den strukturerade dokumenttaggen men behåller dess innehåll i dokumentträdet.
type: docs
weight: 240
