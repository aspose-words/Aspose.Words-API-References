...
description: När den är inställd på true kommer den här egenskapen att förbjuda en användare att redigera innehållet i denna strukturerade dokumenttagg.
type: docs
weight: 90
