...
description: Aspose.Words.Markup.StructuredDocumentTagRangeStart klass. Representerar en början på varierade strukturerad dokumenttagg som accepterar innehåll i flera sektioner. Se ävenStructuredDocumentTagRangeEnd .
type: docs
weight: 3850
...
| namn | Beskrivning |
| --- | --- |
| [StructuredDocumentTagRangeStart](structureddocumenttagrangestart/)(DocumentBase, SdtType) | Initierar en ny instans av **Structured document tag range start** class. |
...
| [LockContentControl](../../aspose.words.markup/structureddocumenttagrangestart/lockcontentcontrol/) { get; set; } | När den är inställd på true kommer den här egenskapen att förbjuda en användare att ta bort den här strukturerade dokumenttaggen. |
| [LockContents](../../aspose.words.markup/structureddocumenttagrangestart/lockcontents/) { get; set; } | När den är inställd på true kommer den här egenskapen att förbjuda en användare att redigera innehållet i denna strukturerade dokumenttagg. |
...
| [RangeEnd](../../aspose.words.markup/structureddocumenttagrangestart/rangeend/) { get; } | Anger slutet av intervallet om StructuredDocumentTag är en strukturerad dokumenttagg med intervall. returnerar annars null. |
...
| [Title](../../aspose.words.markup/structureddocumenttagrangestart/title/) { get; set; } | Anger det vänliga namnet som är kopplat till denna strukturerade dokumenttagg. Kan inte vara null. |
...
| [AppendChild](../../aspose.words.markup/structureddocumenttagrangestart/appendchild/)(Node) | Lägger till den angivna noden i slutet av stdContent-intervallet. |
...
| [GetChildNodes](../../aspose.words.markup/structureddocumenttagrangestart/getchildnodes/)(NodeType, bool) | Returnerar en livesamling av underordnade noder som matchar de angivna typerna. |
