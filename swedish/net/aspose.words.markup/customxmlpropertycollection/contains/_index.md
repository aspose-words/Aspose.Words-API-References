...
description: Upptäck om CustomXmlPropertyCollection innehåller en egenskap med namn. Hantera dina XML-data effektivt med våra pålitliga metoder för sömlös integration.
type: docs
weight: 50
...
| --- | --- | --- |
| name | String | Skiftlägeskänsligt namn på egenskapen som ska hittas. |
