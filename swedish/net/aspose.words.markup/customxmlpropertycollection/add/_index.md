...
description: Förbättra enkelt din CustomXmlPropertyCollection med Add-metoden, så att du sömlöst kan integrera egenskaper för optimerad datahantering.
type: docs
weight: 30
url: /sv/net/aspose.words.markup/customxmlpropertycollection/add/
---
...
| --- | --- | --- |
| property | CustomXmlProperty | Egenskapen som ska läggas till. |
