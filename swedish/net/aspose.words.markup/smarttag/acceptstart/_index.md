...
description: Upptäck SmartTag AcceptStart-metoden – välkomna besökare sömlöst till din SmartTag-upplevelse och förbättra användarengagemanget idag!
type: docs
weight: 80
url: /sv/net/aspose.words.markup/smarttag/acceptstart/
---
## SmartTag.AcceptStart method

Accepterar en besökare för att besöka början av SmartTag.
