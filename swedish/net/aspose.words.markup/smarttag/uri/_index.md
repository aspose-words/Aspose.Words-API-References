...
description: Upptäck egenskapen SmartTag URI – definiera din smarttaggs namnrymds-URI för förbättrad funktionalitet och sömlös integration i dina applikationer.
type: docs
weight: 50
...
Anger namnrymds-URI:n för smarttaggen.
