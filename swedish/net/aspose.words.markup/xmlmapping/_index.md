...
description: Anger informationen som används för att upprätta en mappning mellan den strukturerade dokumenttaggen parent och ett XML-element lagrat i en anpassad XML-datadel i dokumentet.
type: docs
weight: 3860
