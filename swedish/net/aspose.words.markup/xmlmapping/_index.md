...
description: Anger informationen som används för att upprätta en mappning mellan den strukturerade dokumenttaggen parent och ett XMLelement lagrat i en anpassad XMLdatadel i dokumentet.
type: docs
weight: 3860
