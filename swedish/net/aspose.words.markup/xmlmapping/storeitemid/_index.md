...
description: Anger den anpassade XMLdataidentifieraren för den anpassade XMLdatadelen som ska användas för att utvärderaXPathaspose.words.markup/xmlmapping/xpath/ expression.
type: docs
weight: 40
