...
description: Upptäck egenskapen XmlMapping CustomXmlPart, som länkar dina strukturerade dokumenttaggar till anpassade XML-datadelar för förbättrad dokumentintegration.
type: docs
weight: 10
