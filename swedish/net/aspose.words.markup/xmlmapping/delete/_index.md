...
description: Ta enkelt bort XML-datamappningar med XmlMapping Delete-metoden. Effektivisera dina strukturerade dokument för förbättrad effektivitet och organisation.
type: docs
weight: 60
...
Tar bort mappningen av det överordnade strukturerade dokumentet till XML-data.
