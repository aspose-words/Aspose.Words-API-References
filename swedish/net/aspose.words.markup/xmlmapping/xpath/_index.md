...
description: Returnerar XPathuttrycket som utvärderas för att hitta den anpassade XMLnoden som är mappad till den överordnade strukturerade dokumenttaggen.
type: docs
weight: 50
