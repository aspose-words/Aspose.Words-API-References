...
description: Returnerar XPath-uttrycket som utvärderas för att hitta den anpassade XML-noden som är mappad till den överordnade strukturerade dokumenttaggen.
type: docs
weight: 50
