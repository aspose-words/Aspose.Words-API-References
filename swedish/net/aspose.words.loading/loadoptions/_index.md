...
description: Gör det möjligt att ange ytterligare alternativ som lösenord eller bas-URI när laddar ett dokument i enDocument../aspose.words/document objekt.
type: docs
weight: 3460
