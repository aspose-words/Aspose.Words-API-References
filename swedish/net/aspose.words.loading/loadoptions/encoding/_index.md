...
description: Hämtar eller ställer in kodningen som ska användas för att ladda ett HTML- TXT- eller CHM-dokument om kodningen inte är specificerad inuti dokumentet. Kan vara null. Standard är null.
type: docs
weight: 50
