...
description: Aspose.Words.Loading.RtfLoadOptions klass. Tillåter att ange ytterligare alternativ vid laddningRtf dokument till enDocument objekt.
type: docs
weight: 3510
...
| [RecognizeUtf8Text](../../aspose.words.loading/rtfloadoptions/recognizeutf8text/) { get; set; } | När satt till sant,CharsetDetectorkommer att försöka upptäcka UTF8-tecken, de kommer att bevaras under import. |
