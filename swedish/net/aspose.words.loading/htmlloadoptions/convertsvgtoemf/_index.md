...
description: Hämtar eller ställer in ett värde som anger om laddade SVG-bilder ska konverteras till EMF-formatet. Standardvärdet ärfalsk och om möjligt lagras inlästa SVG-bilder som de är utan konvertering.
type: docs
weight: 30
