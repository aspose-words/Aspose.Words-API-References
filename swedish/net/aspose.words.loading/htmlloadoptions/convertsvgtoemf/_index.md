...
description: Hämtar eller ställer in ett värde som anger om laddade SVGbilder ska konverteras till EMFformatet. Standardvärdet ärfalsk och om möjligt lagras inlästa SVGbilder som de är utan konvertering.
type: docs
weight: 30
