...
description: BarcodeParameters FixCheckDigit fast egendom. Om kontrollsiffran ska åtgärdas om den är ogiltig i C#.
type: docs
weight: 100
...
Om kontrollsiffran ska åtgärdas om den är ogiltig.
