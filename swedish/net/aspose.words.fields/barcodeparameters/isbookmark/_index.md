...
description: Upptäck egenskapen BarcodeParameters IsBookmark! Lär dig hur PostalAddress kan förbättra din dokumenthantering med effektiva bokmärkeslösningar.
type: docs
weight: 120
...
Huruvida[`PostalAddress`](../postaladdress/) är namnet på ett bokmärke.
