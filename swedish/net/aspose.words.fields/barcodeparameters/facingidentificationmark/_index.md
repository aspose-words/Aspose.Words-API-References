...
description: Upptäck egenskapen BarcodeParameters FacingIdentificationMark, som är avgörande för att optimera FIM-integrationen och förbättra noggrannheten vid streckkodsskanning.
type: docs
weight: 90
