...
description: Upptäck egenskapen BarcodeParameters ScalingFactor, som möjliggör exakt symbolskalning i hela procentenheter (10–1000) för optimal streckkodsprestanda.
type: docs
weight: 160
...
Skalningsfaktor för symbolen. Värdet är i hela procentenheter och de giltiga värdena är [10, 1000].
