...
description: Upptäck CaseCodeStyle-egenskapen för ITF14-streckkoder. Utforska giltiga alternativ som STDEXTADD för att förbättra din streckkodsdesign och funktionalitet.
type: docs
weight: 60
...
Stil för en ärendekod för streckkodstypen ITF14. Giltiga värden är [STD&#x7C;EXT&#x7C;ADD]
