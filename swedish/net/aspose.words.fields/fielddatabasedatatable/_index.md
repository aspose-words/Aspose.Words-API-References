...
description: Upptäck klassen Aspose.Words.Fields.FieldDatabaseDataTable, din lösning för effektiva FieldDatabase-fältresultat. Lås upp sömlös dataintegration idag!
type: docs
weight: 2170
...
Tillhandahåller data för[`FieldDatabase`](../fielddatabase/) fältresultat. SeDataTable instans.
...
| namn | Beskrivning |
| --- | --- |
| [FieldDatabaseDataTable](fielddatabasedatatable/)(*params string[]*) | Initierar en ny instans av`FieldDatabaseDataTable` klass. |
...
| namn | Beskrivning |
| --- | --- |
| static [CreateFrom](../../aspose.words.fields/fielddatabasedatatable/createfrom/)(*DataTable*) | Initierar en ny instans av`FieldDatabaseDataTable` klass frånDataTable instans. |
