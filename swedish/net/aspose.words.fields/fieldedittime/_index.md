...
description: Upptäck klassen Aspose.Words.Fields.FieldEditTime för effektiv dokumentredigering. Förenkla ditt arbetsflöde med kraftfull EDITTIME-fälthantering.
type: docs
weight: 2250
...
// Fältet EDITTIME visas i minuter,
// den tid som dokumentet spenderas med öppet i ett Microsoft Word-fönster.
...
// för att spåra tiden som dokumentet har varit öppet. Vi kan också redigera det själva.
...
// Fältet uppdateras inte självt i realtid och måste också
// uppdateras manuellt i Microsoft Word när vi behöver ett korrekt värde.
doc.UpdateFields();
