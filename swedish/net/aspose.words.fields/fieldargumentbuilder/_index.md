...
description: Upptäck klassen Aspose.Words.Fields.FieldArgumentBuilder för att enkelt skapa komplexa fältargument med noder och text för förbättrad dokumentautomation.
type: docs
weight: 1960
...
Bygger ett komplext fältargument bestående av fält, noder och vanlig text.
...
| namn | Beskrivning |
| --- | --- |
| [FieldArgumentBuilder](fieldargumentbuilder/)() | Initierar en instans av`FieldArgumentBuilder` klass. |
...
| [AddNode](../../aspose.words.fields/fieldargumentbuilder/addnode/)(*[Inline](../../aspose.words/inline/)*) | Lägger till en nod i argumentet. |
| [AddText](../../aspose.words.fields/fieldargumentbuilder/addtext/)(*string*) | Lägger till vanlig text i argumentet. |
