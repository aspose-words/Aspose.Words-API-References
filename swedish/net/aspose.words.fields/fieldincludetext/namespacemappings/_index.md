...
description: Upptäck egenskapen FieldIncludeText NamespaceMappings för att enkelt hantera namnrymdsmappningar för XPath-frågor, vilket förbättrar effektiviteten i din datahantering.
type: docs
weight: 60
...
Hämtar eller ställer in namnrymdsmappningar för XPath-frågor.
