...
description: Upptäck hur FieldXE:s IsItalic-egenskap förbättrar ditt dokuments stil genom att enkelt tillämpa kursiv formatering på sidnummer för ett elegant utseende.
type: docs
weight: 40
...
Hämtar eller anger om kursiv formatering ska tillämpas på postens sidnummer.
