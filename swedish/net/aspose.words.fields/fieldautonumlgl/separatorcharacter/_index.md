...
description: Upptäck hur du anpassar egenskapen FieldAutoNumLgl SeparatorCharacter för att förbättra din dataformatering med ett flexibelt avgränsningstecken.
type: docs
weight: 30
