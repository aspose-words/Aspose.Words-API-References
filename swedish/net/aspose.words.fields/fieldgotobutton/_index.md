...
description: Upptäck klassen Aspose.Words.Fields.FieldGoToButton för sömlös navigering med GOTOBUTTON-fält. Förbättra din dokumentinteraktivitet idag!
type: docs
weight: 2380
...
Implementerar GOTOBUTTON-fältet.
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | Hämtar eller anger namnet på ett bokmärke, ett sidnummer eller något annat objekt att hoppa till. |
...
Infogar ett hoppkommando, så att när det aktiveras flyttas dokumentets insättningspunkt till den angivna platsen.
