...
description: Upptäck klassen Aspose.Words.Fields.FieldUserInitials för att enkelt implementera USERINITIALS-fält, vilket förbättrar dokumentanpassning och användarengagemang.
type: docs
weight: 3000
...
Implementerar fältet ANVÄNDARINITIALS.
...
| [UserInitials](../../aspose.words.fields/fielduserinitials/userinitials/) { get; set; } | Hämtar eller ställer in den aktuella användarens initialer. |
