...
description: Upptäck klassen Aspose.Words.Fields.FieldNumChars, utformad för att effektivt implementera NUMCHARS-fältet för förbättrad dokumentbehandling.
type: docs
weight: 2620
...
Hämtar antalet tecken i det aktuella dokumentet, så som det registrerats i**Tecken** egenskapen för de inbyggda dokumentegenskaperna .
