...
description: Upptäck egenskapen InsertAsUnicode i FieldDde och hantera enkelt länkade objekt genom att infoga dem som Unicode-text för förbättrad kompatibilitet och prestanda.
type: docs
weight: 80
url: /sv/net/aspose.words.fields/fielddde/insertasunicode/
---
## FieldDde.InsertAsUnicode property

Hämtar eller anger om det länkade objektet ska infogas som Unicode-text.
