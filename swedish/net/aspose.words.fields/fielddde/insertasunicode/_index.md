...
description: FieldDde InsertAsUnicode fast egendom. Hämtar eller ställer in om det länkade objektet ska infogas som Unicodetext i C#.
type: docs
weight: 80
...
Hämtar eller ställer in om det länkade objektet ska infogas som Unicode-text.
