...
description: Upptäck hur du använder egenskapen InsertAsBitmap i FieldDde för att enkelt infoga länkade objekt som bitmappar, vilket förbättrar dokumentets visuella attraktionskraft.
type: docs
weight: 30
url: /sv/net/aspose.words.fields/fielddde/insertasbitmap/
---
## FieldDde.InsertAsBitmap property

Hämtar eller anger om det länkade objektet ska infogas som en bitmapp.
