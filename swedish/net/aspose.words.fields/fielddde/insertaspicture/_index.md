...
description: FieldDde InsertAsPicture fast egendom. Hämtar eller ställer in om det länkade objektet ska infogas som en bild i C#.
type: docs
weight: 50
...
Hämtar eller ställer in om det länkade objektet ska infogas som en bild.
