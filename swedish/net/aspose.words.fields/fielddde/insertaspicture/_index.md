...
description: Upptäck hur egenskapen FieldDde InsertAsPicture förbättrar dokumentlänkning genom att möjliggöra sömlös integrering av objekt som bilder. Optimera ditt arbetsflöde idag!
type: docs
weight: 50
url: /sv/net/aspose.words.fields/fielddde/insertaspicture/
---
## FieldDde.InsertAsPicture property

Hämtar eller anger om det länkade objektet ska infogas som en bild.
