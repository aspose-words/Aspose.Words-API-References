...
description: Upptäck hur du använder egenskapen FieldSymbol FontName för att enkelt hantera och anpassa teckensnittsnamn för dina tecken i programmering.
type: docs
weight: 40
...
Hämtar eller anger namnet på teckensnittet för det tecken som hämtas av fältet.
