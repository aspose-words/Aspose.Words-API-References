...
description: Upptäck egenskapen FieldSymbol IsShiftJis – hantera enkelt SHIFTJIS-teckenkoder för förbättrad datahantering och sömlös teckentolkning.
type: docs
weight: 70
...
Hämtar eller anger om teckenkoden ska tolkas som värdet för ett SHIFT-JIS-tecken.
