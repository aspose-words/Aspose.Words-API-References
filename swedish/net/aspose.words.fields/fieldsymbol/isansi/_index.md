...
description: Upptäck FieldSymbol IsAnsi-egenskapen och hantera enkelt ANSI-teckenkoder för förbättrad datahantering och förbättrad kodningseffektivitet.
type: docs
weight: 60
...
Hämtar eller anger om teckenkoden ska tolkas som värdet för ett ANSI-tecken.
