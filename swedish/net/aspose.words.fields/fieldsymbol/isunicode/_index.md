...
description: Upptäck egenskapen FieldSymbol IsUnicode för att enkelt hantera teckenkoder som Unicode-värden, vilket förbättrar din kodningseffektivitet och noggrannhet.
type: docs
weight: 80
url: /sv/net/aspose.words.fields/fieldsymbol/isunicode/
---
## FieldSymbol.IsUnicode property

Hämtar eller anger om teckenkoden ska tolkas som värdet för ett Unicode-tecken.
