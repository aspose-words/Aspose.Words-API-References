...
description: FieldSymbol IsUnicode fast egendom. Hämtar eller ställer in om teckenkoden ska tolkas som värdet av ett Unicodetecken i C#.
type: docs
weight: 80
...
Hämtar eller ställer in om teckenkoden ska tolkas som värdet av ett Unicode-tecken.
