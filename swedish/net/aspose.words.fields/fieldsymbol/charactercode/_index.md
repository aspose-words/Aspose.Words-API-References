...
description: Upptäck egenskapen FieldSymbol CharacterCode, hämta eller ställ enkelt in teckenkodvärden i decimal- eller hexadecimalt format för sömlös datahantering.
type: docs
weight: 20
...
Hämtar eller ställer in karaktärens kodpunktvärde i decimalt eller hexadecimalt.
