...
description: Upptäck egenskapen FieldSymbol FontSize, justera enkelt teckenstorleken i punkter för förbättrad teckenvisning i dina applikationer. Optimera läsbarheten nu!
type: docs
weight: 50
...
Hämtar eller ställer in storleken i punkter på teckensnittet för det tecken som hämtas av fältet.
