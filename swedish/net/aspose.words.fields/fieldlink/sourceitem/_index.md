...
description: Upptäck egenskapen FieldLink SourceItem för att effektivt hantera källfilslänkar. Förbättra ditt arbetsflöde genom att enkelt hämta eller ställa in länkat innehåll.
type: docs
weight: 130
url: /sv/net/aspose.words.fields/fieldlink/sourceitem/
---
## FieldLink.SourceItem property

Hämtar eller anger den del av källfilen som länkas.
