...
description: Upptäck FieldLink InsertAsHtml-egenskapen för att enkelt hantera länkade objekt i HTML-format. Förbättra ditt webbinnehåll med sömlös integration!
type: docs
weight: 50
url: /sv/net/aspose.words.fields/fieldlink/insertashtml/
---
## FieldLink.InsertAsHtml property

Hämtar eller anger om det länkade objektet ska infogas som text i HTML-format.
