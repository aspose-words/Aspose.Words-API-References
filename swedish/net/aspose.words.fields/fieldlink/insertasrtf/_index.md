...
description: Upptäck egenskapen FieldLink InsertAsRtf för att enkelt hantera länkade objekt i RTF-format (rich text format) för förbättrad dokumentintegration och flexibilitet.
type: docs
weight: 70
url: /sv/net/aspose.words.fields/fieldlink/insertasrtf/
---
