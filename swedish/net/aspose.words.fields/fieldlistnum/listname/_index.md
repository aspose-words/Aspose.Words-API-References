...
description: Upptäck egenskapen FieldListNum ListName för att enkelt hantera definitioner av abstrakta numreringar för förbättrad dokumentorganisation och tydlighet.
type: docs
weight: 40
