...
description: Upptäck egenskapen FieldListNum StartingNumber för att enkelt hantera ditt fälts startvärde för förbättrad dataorganisation och effektivitet.
type: docs
weight: 50
