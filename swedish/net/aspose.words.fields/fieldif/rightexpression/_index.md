...
description: Upptäck egenskapen FieldIf RightExpression och hantera enkelt rätt segment av dina jämförelseuttryck för förbättrad datanoggrannhet och effektivitet.
type: docs
weight: 50
