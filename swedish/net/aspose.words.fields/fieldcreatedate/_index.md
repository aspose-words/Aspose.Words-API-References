...
description: Upptäck klassen Aspose.Words.Fields.FieldCreateDate för sömlös dokumenthantering. Implementera enkelt fältet CREATEDATE och förbättra dina arbetsflöden.
type: docs
weight: 2130
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Hämtar eller anger om Hijri-månkalendern eller den hebreiska månkalendern ska användas. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Hämtar eller anger om Saka-erans kalender ska användas. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldcreatedate/useumalquracalendar/) { get; set; } | Hämtar eller anger om Um-al-Qura-kalendern ska användas. |
