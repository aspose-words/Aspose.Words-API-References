...
description: Upptäck klassen Aspose.Words.Fields.FieldNumWords för enkel hantering av ordantal i dokument. Förbättra din textbehandling med den här kraftfulla funktionen!
type: docs
weight: 2640
url: /sv/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class

Implementerar fältet NUMWORDS.
...
Hämtar antalet ord i det aktuella dokumentet, så som det registrerats i**Ord** egenskapen för de inbyggda dokumentegenskaperna .
