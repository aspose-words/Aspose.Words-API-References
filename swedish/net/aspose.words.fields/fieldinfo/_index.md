...
description: Upptäck klassen Aspose.Words.Fields.FieldInfo, din lösning för att effektivt implementera INFO-fältet i dokumentbehandling. Lås upp kraftfulla funktioner idag!
type: docs
weight: 2490
...
| [InfoType](../../aspose.words.fields/fieldinfo/infotype/) { get; set; } | Hämtar eller anger typen av dokumentegenskapen som ska infogas. |
...
| [NewValue](../../aspose.words.fields/fieldinfo/newvalue/) { get; set; } | Hämtar eller anger ett valfritt värde som uppdaterar egenskapen. |
