...
description: Upptäck FieldToas EntryCategory-egenskap för att effektivt hantera och anpassa integrerade kategorier för dina tabellposter. Förbättra organisationen idag!
type: docs
weight: 30
...
Hämtar eller ställer in integralkategorin för poster som ingår i tabellen.
