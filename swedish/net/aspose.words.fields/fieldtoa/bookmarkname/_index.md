...
description: Upptäck egenskapen FieldToa BookmarkName för att enkelt hantera bokmärken i dina dokument, vilket förbättrar skapandet av tabeller och dokumentnavigeringen.
type: docs
weight: 20
...
Hämtar eller anger namnet på bokmärket som markerar den del av dokumentet som används för att bygga tabellen.
