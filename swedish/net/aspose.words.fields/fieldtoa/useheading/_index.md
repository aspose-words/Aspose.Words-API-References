...
description: Upptäck hur egenskapen FieldToa UseHeading förbättrar din auktoritetsförteckning genom att lägga till kategorirubriker för bättre organisation och tydlighet.
type: docs
weight: 100
...
Hämtar eller anger om kategorirubriken ska inkluderas för posterna i en auktoritetstabell.
