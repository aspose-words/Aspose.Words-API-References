...
description: FieldToa fast egendom. Hämtar eller ställer in teckensekvensen som används för att separera en tabell över behörighetsposter och dess sidnummer.
type: docs
weight: 40
