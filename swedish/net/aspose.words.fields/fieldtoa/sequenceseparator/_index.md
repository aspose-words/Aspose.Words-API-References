...
description: FieldToa SequenceSeparator fast egendom. Hämtar eller ställer in teckensekvensen som används för att separera sekvensnummer och sidnummer i C#.
type: docs
weight: 90
url: /sv/net/aspose.words.fields/fieldtoa/sequenceseparator/
---
## FieldToa.SequenceSeparator property

Hämtar eller ställer in teckensekvensen som används för att separera sekvensnummer och sidnummer.
