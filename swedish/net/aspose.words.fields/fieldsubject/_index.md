...
description: Upptäck klassen Aspose.Words.Fields.FieldSubject för enkel implementering av SUBJECT-fältet, vilket förbättrar dokumentautomation och formateringseffektivitet.
type: docs
weight: 2860
...
| [Text](../../aspose.words.fields/fieldsubject/text/) { get; set; } | Hämtar eller ställer in ämnestexten. |
...
Hämtar, och anger valfritt, dokumentets ämne, så som det är registrerat i**Ämne** egenskapen för de inbyggda dokumentegenskaperna .
