...
description: Upptäck klassen Aspose.Words.Fields.FieldDocProperty, utformad för sömlös integration av DOCPROPERTY-fält i dina dokument för förbättrad funktionalitet.
type: docs
weight: 2220
url: /sv/net/aspose.words.fields/fielddocproperty/
---
## FieldDocProperty class

Implementerar DOCPROPERTY-fältet.
