...
description: Upptäck egenskapen FieldMergeBarcode ErrorCorrectionLevel för att optimera din QR-kods tillförlitlighet. Ställ in värden från 0 till 3 för förbättrad felkorrigering.
type: docs
weight: 80
