...
description: DropDownItemCollection Insert metod. Infogar en sträng i samlingen vid det angivna indexet i C#.
type: docs
weight: 80
...
| --- | --- | --- |
| index | Int32 | Det nollbaserade indexet där värdet infogas. |
| value | String | Strängen att infoga. |
