...
description: Upptäck DropDownItemCollection IndexOf-metoden, hitta effektivt det nollbaserade indexet för valfritt värde i din samling för effektiv datahantering.
type: docs
weight: 70
