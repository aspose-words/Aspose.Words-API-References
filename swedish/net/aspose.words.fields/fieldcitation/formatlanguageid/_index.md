...
description: Upptäck hur egenskapen FieldCitation FormatLanguageId förbättrar citeringsformateringen i dina dokument genom att hantera språk-ID:n för bibliografiska stilar.
type: docs
weight: 30
...
Hämtar eller anger språk-ID:t som används tillsammans med den angivna bibliografiska stilen för att formatera hänvisningen i dokumentet.
