...
description: Upptäck egenskapen FieldCitation Suffix, hantera enkelt citeringssuffix för att förbättra din datanoggrannhet och effektivisera din referensprocess.
type: docs
weight: 70
...
Hämtar eller anger ett suffix som läggs till i hänvisningen.
