...
description: Hämtar eller ställer in om det aktuella resultatet av fältet inte längre är korrekt inaktuellt på grund av andra ändringar som gjorts i dokumentet.
type: docs
weight: 40
