...
description: Få enkel åtkomst till och hantera listruteobjekt med egenskapen FormField DropDownItems, vilket förbättrar dina formulär med sömlös användarinteraktion.
type: docs
weight: 50
...
Ger åtkomst till objekten i ett rullgardinsmenyfält.
...
Microsoft Word tillåter maximalt 25 objekt i ett rullgardinsmenyfält.
