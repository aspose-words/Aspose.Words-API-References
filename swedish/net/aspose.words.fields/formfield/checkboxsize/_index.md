...
description: Upptäck egenskapen FormField CheckBoxSize för att anpassa kryssrutornas dimensioner i punkter, vilket förbättrar dina formulär när IsCheckBoxExactSize är aktiverat.
type: docs
weight: 20
...
Hämtar eller ställer in storleken på kryssrutan i punkter. Gäller endast när[`IsCheckBoxExactSize`](../ischeckboxexactsize/) är`sann` .
...
Gäller endast för ett kryssruteformulärfält.
