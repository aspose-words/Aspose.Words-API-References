...
description: Hämtar eller ställer in storleken på kryssrutan i poäng. Har effekt endast närIsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsize är sant.
type: docs
weight: 20
...
Hämtar eller ställer in storleken på kryssrutan i poäng. Har effekt endast när[`IsCheckBoxExactSize`](../ischeckboxexactsize) är sant.
