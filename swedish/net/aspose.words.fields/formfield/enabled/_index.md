...
description: Upptäck egenskapen FormField Enabled. Kontrollera enkelt om ett formulärfält är aktivt för sömlösa användarinteraktioner och förbättrad webbfunktionalitet.
type: docs
weight: 70
url: /sv/net/aspose.words.fields/formfield/enabled/
---
## FormField.Enabled property

Sant om ett formulärfält är aktiverat.
...
Om ett formulärfält är aktiverat kan dess innehåll ändras allt eftersom formuläret fylls i.
