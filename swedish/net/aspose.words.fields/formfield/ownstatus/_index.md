...
description: Anger källan till texten som visas i statusfältet när ett formulärfält har fokus.
type: docs
weight: 160
...
Anger källan till texten som visas i statusfältet när ett formulärfält har fokus.
