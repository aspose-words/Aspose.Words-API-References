...
description: Upptäck egenskapen FormField ExitMacro för att enkelt hantera avslutningsmakron för dina formulär. Förbättra användarupplevelsen och effektivisera datainmatningen idag!
type: docs
weight: 90
url: /sv/net/aspose.words.fields/formfield/exitmacro/
---
## FormField.ExitMacro property

Returnerar eller anger ett avslutningsmakronamn för formulärfältet.
...
Avslutningsmakrot körs när formulärfältet förlorar fokus i Microsoft Word.
