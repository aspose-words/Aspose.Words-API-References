...
description: Hämtar eller ställer in indexet som anger det för närvarande valda objektet i ett rullgardinsfält.
type: docs
weight: 60
...
Hämtar eller ställer in indexet som anger det för närvarande valda objektet i ett rullgardinsfält.
