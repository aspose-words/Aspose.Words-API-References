...
description: Upptäck egenskapen FormField DropDownSelectedIndex för att enkelt hantera listruteval, vilket förbättrar användarupplevelsen och formulärets funktionalitet.
type: docs
weight: 60
...
Hämtar eller ställer in indexet som anger det valda objektet i ett rullgardinsmenyfält.
