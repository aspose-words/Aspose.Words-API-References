...
description: Upptäck egenskapen FormField MaxLength för att ställa in gränser för textfält. Förbättra användarupplevelsen med anpassningsbara längdinställningar för optimal datainmatning.
type: docs
weight: 120
...
Maximal längd för textfältet. Noll när längden inte är begränsad.
