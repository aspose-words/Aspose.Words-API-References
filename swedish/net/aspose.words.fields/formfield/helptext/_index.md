...
description: Upptäck egenskapen FormField HelpText och förbättra användarupplevelsen med informativa meddelanden som visas när F1 trycks ner på fokuserade fält.
type: docs
weight: 100
...
Returnerar eller anger texten som visas i en meddelanderuta när formulärfältet har fokus och användaren trycker på F1.
...
Om[`OwnHelp`](../ownhelp/) egendomen är inställd på`sann` ,`HelpText` anger textsträngens värde. Om[`OwnHelp`](../ownhelp/) är inställd på`falsk` ,`HelpText` anger namnet på en AutoText-post som innehåller texten help för formulärfältet.
