...
description: Returnerar eller ställer in texten som visas i en meddelanderuta när formulärfältet har fokus och användaren trycker på F1.
type: docs
weight: 100
...
Returnerar eller ställer in texten som visas i en meddelanderuta när formulärfältet har fokus och användaren trycker på F1.
