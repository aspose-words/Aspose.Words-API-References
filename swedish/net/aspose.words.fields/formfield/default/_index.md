...
description: FormField Default fast egendom. Hämtar eller ställer in standardvärdet för kryssrutans formulärfält. Standardvärdet för den här egenskapen ärfalsk  i C#.
type: docs
weight: 40
