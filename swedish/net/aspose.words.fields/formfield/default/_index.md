...
description: Upptäck hur du anpassar egenskapen FormField Default för att ställa in din kryssrutas standardvärde. Förbättra användarupplevelsen med enkla värdejusteringar!
type: docs
weight: 40
...
Hämtar eller ställer in standardvärdet för kryssrutefältet. Standardvärdet för den här egenskapen är`falsk` .
