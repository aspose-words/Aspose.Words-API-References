...
description: Hämtar eller ställer in det booleska värdet som indikerar om storleken på textrutan är automatisk eller specificerad explicit.
type: docs
weight: 110
...
Hämtar eller ställer in det booleska värdet som indikerar om storleken på textrutan är automatisk eller specificerad explicit.
