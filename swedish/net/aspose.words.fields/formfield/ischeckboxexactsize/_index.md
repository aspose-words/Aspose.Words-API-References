...
description: Upptäck egenskapen FormField IsCheckBoxExactSize och styr enkelt textrutans storlek med en enkel boolesk inställning för optimal anpassning.
type: docs
weight: 110
...
Hämtar eller ställer in det booleska värdet som anger om textrutans storlek är automatisk eller explicit angiven.
