...
description: Upptäck egenskapen FormField TextInputType för att enkelt anpassa textfält i formuläret. Förbättra användarupplevelsen genom att enkelt ställa in specifika inmatningstyper.
type: docs
weight: 210
...
Hämtar eller anger typen av ett textformulärfält.
