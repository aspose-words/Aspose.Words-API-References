...
description: Upptäck hur metoden FormField SetTextInputValue förbättrar textformatering och effektivt lagrar resultat, vilket effektiviserar din datainmatningsprocess.
type: docs
weight: 250
...
Tillämpar textformatet som anges i[`TextInputFormat`](../textinputformat/) och lagrar värdet i[`Result`](../result/) .
...
| --- | --- | --- |
| newValue | Object | Kan vara en sträng, ett tal eller en**Datum och tid** objekt. |
