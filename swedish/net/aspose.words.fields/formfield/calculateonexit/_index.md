...
description: Upptäck hur egenskapen FormField CalculateOnExit automatiskt uppdaterar fältreferenser vid utgång, vilket förbättrar dokumentets noggrannhet och effektivitet.
type: docs
weight: 10
...
Sant om referenser till det angivna formulärfältet uppdateras automatiskt varje gång fältet lämnas.
...
Miljö`CalculateOnExit` påverkar bara formulärfältets beteende när dokumentet öppnas i Microsoft Word. Aspose.Words uppdaterar aldrig references till formulärfältet.
