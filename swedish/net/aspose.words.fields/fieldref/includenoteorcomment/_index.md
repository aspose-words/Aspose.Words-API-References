...
description: Upptäck egenskapen FieldRef IncludeNoteOrComment för att enkelt hantera numrering av fotnoter och slutnoter och förbättra dina dokument med sömlösa anteckningar.
type: docs
weight: 30
...
Hämtar eller anger om fotnots-, slutnots- och anteckningsnummer som är markerade av bokmärket ska ökas, och motsvarande fotnots-, slutnots- och kommentartext ska infogas.
