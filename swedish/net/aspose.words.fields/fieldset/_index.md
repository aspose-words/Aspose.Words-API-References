...
description: Upptäck klassen Aspose.Words.Fields.FieldSet, utformad för att effektivt implementera SET-fältet för förbättrad dokumentbehandling och automatisering.
type: docs
weight: 2810
url: /sv/net/aspose.words.fields/fieldset/
---
## FieldSet class

Implementerar SET-fältet.
...
| namn | Beskrivning |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldset/bookmarkname/) { get; set; } | Hämtar eller anger namnet på bokmärket. |
| [BookmarkText](../../aspose.words.fields/fieldset/bookmarktext/) { get; set; } | Hämtar eller ställer in den nya texten för bokmärket. |
...
Tilldelar ny text till ett bokmärke.
