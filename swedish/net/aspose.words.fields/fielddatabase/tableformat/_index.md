...
description: Upptäck egenskapen FieldDatabase TableFormat för att enkelt anpassa dina databasfrågeresultat med flexibla formateringsalternativ för förbättrad datapresentation.
type: docs
weight: 100
url: /sv/net/aspose.words.fields/fielddatabase/tableformat/
---
## FieldDatabase.TableFormat property

Hämtar eller anger formatet som ska tillämpas på resultatet av databasfrågan.
