...
description: Upptäck FirstRecord-egenskapen i FieldDatabase och hantera enkelt ditt initiala datapostnummer för sömlös datainsättning och förbättrad effektivitet.
type: docs
weight: 40
...
Hämtar eller ställer in integralpostnumret för den första dataposten som ska infogas.
