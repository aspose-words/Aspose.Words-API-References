...
description: Upptäck egenskapen FieldDatabase FileName för att enkelt hantera din databas fullständiga sökväg och filnamn, vilket förbättrar din dataorganisation och åtkomst.
type: docs
weight: 30
url: /sv/net/aspose.words.fields/fielddatabase/filename/
---
## FieldDatabase.FileName property

Hämtar eller anger den fullständiga sökvägen och filnamnet för databasen
