...
description: FieldDatabase FileName fast egendom. Hämtar eller ställer in hela sökvägen och filnamnet för databasen i C#.
type: docs
weight: 30
...
Hämtar eller ställer in hela sökvägen och filnamnet för databasen
