...
description: FieldDatabase fast egendom. Hämtar eller ställer in en uppsättning SQLinstruktioner som frågar databasen.
type: docs
weight: 90
...
Hämtar eller ställer in en uppsättning SQL-instruktioner som frågar databasen.
