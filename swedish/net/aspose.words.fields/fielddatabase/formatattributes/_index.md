...
description: Upptäck egenskapen FieldDatabase FormatAttributes för att enkelt anpassa tabellattribut och förbättra din datahantering och presentation.
type: docs
weight: 50
...
Hämtar eller anger vilka attribut för formatet som ska tillämpas på tabellen.
