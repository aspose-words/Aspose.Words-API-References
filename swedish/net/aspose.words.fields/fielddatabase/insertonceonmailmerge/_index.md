...
description: Upptäck hur egenskapen InsertOnceOnMailMerge i FieldDatabase förbättrar din datasammanfogning genom att möjliggöra sömlös infogning i början av sammanfogningar.
type: docs
weight: 70
url: /sv/net/aspose.words.fields/fielddatabase/insertonceonmailmerge/
---
## FieldDatabase.InsertOnceOnMailMerge property

Hämtar eller anger om data ska infogas i början av en sammanslagning.
