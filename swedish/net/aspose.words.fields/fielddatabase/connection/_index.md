...
description: Hantera dina data enkelt med egenskapen FieldDatabase Connection. Hämta eller konfigurera enkelt kopplingar för sömlös dataintegration.
type: docs
weight: 20
...
Hämtar eller upprättar en koppling till data.
