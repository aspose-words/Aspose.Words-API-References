...
description: Upptäck klassen Aspose.Words.Fields.FieldEnd, som effektivt hanterar Word-fältändelser i dokument och förbättrar dina dokumentbehandlingsmöjligheter.
type: docs
weight: 2270
...
| [HasSeparator](../../aspose.words.fields/fieldend/hasseparator/) { get; } | Returer`sann` om det här fältet har en avgränsare. |
...
| override [NodeType](../../aspose.words.fields/fieldend/nodetype/) { get; } | ReturerFieldEnd . |
...
| namn | Beskrivning |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldend/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Tar emot en besökare. |
...
`FieldEnd` är en nod på inline-nivå och representeras av [`FieldEndChar`](../../aspose.words/controlchar/fieldendchar/) kontrolltecknet i dokumentet.
