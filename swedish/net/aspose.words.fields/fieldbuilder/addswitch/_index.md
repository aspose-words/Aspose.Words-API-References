...
description: Upptäck FieldBuilder AddSwitch-metoden för att enkelt lägga till fältväxlar, vilket förbättrar din applikations funktionalitet och användarupplevelse.
type: docs
weight: 30
url: /sv/net/aspose.words.fields/fieldbuilder/addswitch/
---
...
| --- | --- | --- |
| switchName | String | Växelns namn. |

## Anmärkningar

Denna överbelastning lägger till en flagga (växel utan argument).
...
| --- | --- | --- |
| switchName | String | Växelns namn. |
| switchArgument | String | Växelvärdet. |
...
| --- | --- | --- |
| switchName | String | Växelns namn. |
| switchArgument | Int32 | Växelvärdet. |
...
| --- | --- | --- |
| switchName | String | Växelns namn. |
| switchArgument | Double | Växelvärdet. |
