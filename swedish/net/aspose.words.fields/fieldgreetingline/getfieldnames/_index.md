...
description: Upptäck GetFieldNames-metoden i FieldGreetingLine, som effektivt hämtar en samling namn på fält för koppling av dokument för sömlös dataintegration.
type: docs
weight: 50
