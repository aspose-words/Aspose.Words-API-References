...
description: Upptäck egenskapen FieldGreetingLine LanguageId för att enkelt hantera namnformatering med anpassningsbara språkinställningar för förbättrad användarupplevelse.
type: docs
weight: 30
url: /sv/net/aspose.words.fields/fieldgreetingline/languageid/
---
## FieldGreetingLine.LanguageId property

Hämtar eller anger språk-ID:t som används för att formatera namnet.
