...
description: FieldGreetingLine LanguageId fast egendom. Hämtar eller ställer in språkid som används för att formatera namnet i C#.
type: docs
weight: 30
...
Hämtar eller ställer in språk-id som används för att formatera namnet.
