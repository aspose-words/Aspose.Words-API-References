...
description: Upptäck hur egenskapen FieldDdeAuto InsertAsText effektiviserar hanteringen av länkade objekt genom att tillåta infogning av endast textformat för ökad tydlighet.
type: docs
weight: 60
url: /sv/net/aspose.words.fields/fieldddeauto/insertastext/
---
## FieldDdeAuto.InsertAsText property

Hämtar eller anger om det länkade objektet ska infogas i endast textformat.
