...
description: Upptäck egenskapen FieldDdeAuto InsertAsRtf och hantera enkelt länkade objekt i RTF-format (rich text format) för förbättrad dokumentintegration och mångsidighet.
type: docs
weight: 50
url: /sv/net/aspose.words.fields/fieldddeauto/insertasrtf/
---
## FieldDdeAuto.InsertAsRtf property

Hämtar eller anger om det länkade objektet ska infogas i RTF-format (rich text).
