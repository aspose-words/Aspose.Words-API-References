...
description: FieldDdeAuto InsertAsRtf fast egendom. Hämtar eller ställer in om det länkade objektet ska infogas i richtextformat RTF i C#.
type: docs
weight: 50
...
Hämtar eller ställer in om det länkade objektet ska infogas i rich-text-format (RTF).
