...
description: Upptäck egenskapen ComparisonEvaluationResult för att enkelt komma åt och analysera utvärderingsresultat, vilket förbättrar dina datainsikter och ditt beslutsfattande.
type: docs
weight: 30
...
Hämtar resultatet av jämförelseutvärderingen.
