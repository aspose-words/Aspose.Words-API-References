...
description: Aspose.Words.Fields.FieldRD klass. Implementerar RDfältet i C#.
type: docs
weight: 2320
...
| [FileName](../../aspose.words.fields/fieldrd/filename/) { get; set; } | Hämtar eller ställer in namnet på filen som ska inkluderas när en innehållsförteckning, behörighetsförteckning eller index genereras. |
