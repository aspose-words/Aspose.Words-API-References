...
description: Upptäck Aspose.Words.Fields.FieldRD-klassen – implementera RD-fält effektivt för förbättrad dokumentbehandling och automatisering i dina projekt.
type: docs
weight: 2730
...
| [FileName](../../aspose.words.fields/fieldrd/filename/) { get; set; } | Hämtar eller anger namnet på den fil som ska inkluderas när en innehållsförteckning, auktoritetsförteckning eller index genereras. |
...
| [IsPathRelative](../../aspose.words.fields/fieldrd/ispathrelative/) { get; set; } | Hämtar eller anger om sökvägen är relativ till det aktuella dokumentet. |
...
Identifierar en fil som ska inkluderas när du skapar en innehållsförteckning, en auktoritetsförteckning eller ett index med fältet TOC, TOA eller INDEX
