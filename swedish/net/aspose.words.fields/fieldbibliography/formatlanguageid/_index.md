...
description: Upptäck hur egenskapen FieldBibliography FormatLanguageId förbättrar ditt dokuments bibliografiska källor med anpassningsbara språkinställningar för förbättrad tydlighet.
type: docs
weight: 30
...
Hämtar eller anger språk-ID:t som används för att formatera de bibliografiska källorna i dokumentet.
