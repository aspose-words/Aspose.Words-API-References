...
description: Upptäck egenskapen FieldNextIf RightExpression för att enkelt hantera och anpassa höger sida av dina jämförelseuttryck för förbättrad datahantering.
type: docs
weight: 40
