...
description: FieldTA ShortCitation fast egendom. Hämtar eller ställer in det korta citatet för posten i C#.
type: docs
weight: 70
...
Hämtar eller ställer in det korta citatet för posten.
