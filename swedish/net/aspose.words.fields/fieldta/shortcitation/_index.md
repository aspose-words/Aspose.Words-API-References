...
description: Hantera dina FieldTA ShortCitation-hänvisningar utan ansträngning. Hämta eller ställ enkelt in korta hänvisningar för poster, vilket förbättrar dataorganisation och tillgänglighet.
type: docs
weight: 70
url: /sv/net/aspose.words.fields/fieldta/shortcitation/
---
## FieldTA.ShortCitation property

Hämtar eller ställer in den korta hänvisningen för posten.
