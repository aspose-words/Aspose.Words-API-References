...
description: Upptäck Aspose.Words.Fields.FieldTA-klassen för sömlös implementering av TA-fält, vilket förbättrar dina dokumentautomatiserings- och formateringsmöjligheter.
type: docs
weight: 2880
...
| [EntryCategory](../../aspose.words.fields/fieldta/entrycategory/) { get; set; } | Hämtar eller ställer in integralpostkategorin, vilket är ett tal som motsvarar ordningen på kategorier. |
...
| [IsBold](../../aspose.words.fields/fieldta/isbold/) { get; set; } | Hämtar eller anger om fetstil ska användas för sidnumret för posten. |
...
| [IsItalic](../../aspose.words.fields/fieldta/isitalic/) { get; set; } | Hämtar eller anger om kursiv formatering ska tillämpas på sidnumret för posten. |
...
| [PageRangeBookmarkName](../../aspose.words.fields/fieldta/pagerangebookmarkname/) { get; set; } | Hämtar eller anger namnet på bokmärket som markerar ett sidintervall som infogas som postens sidnummer. |
...
| [ShortCitation](../../aspose.words.fields/fieldta/shortcitation/) { get; set; } | Hämtar eller ställer in den korta hänvisningen för posten. |
