...
description: Upptäck hur du enkelt formaterar sidnummer med FieldTAs IsItalic-egenskap och förbättrar dina dokument med snygg kursiv text för bättre läsbarhet.
type: docs
weight: 40
url: /sv/net/aspose.words.fields/fieldta/isitalic/
---
## FieldTA.IsItalic property

Hämtar eller anger om kursiv formatering ska tillämpas på sidnumret för posten.
