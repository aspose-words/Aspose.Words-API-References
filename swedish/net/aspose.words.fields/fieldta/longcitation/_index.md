...
description: Hantera din FieldTA LongCitation-egenskap utan ansträngning. Hämta eller ställ enkelt in långa hänvisningar för poster, vilket förbättrar din dataorganisation och tillgänglighet.
type: docs
weight: 50
url: /sv/net/aspose.words.fields/fieldta/longcitation/
---
## FieldTA.LongCitation property

Hämtar eller ställer in den långa hänvisningen för posten.
