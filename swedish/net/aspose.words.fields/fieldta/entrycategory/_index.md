...
description: Upptäck egenskapen FieldTA EntryCategory. Hantera enkelt dina integrerade entrékategorier med detta kraftfulla verktyg för sömlös organisation och effektivitet.
type: docs
weight: 20
url: /sv/net/aspose.words.fields/fieldta/entrycategory/
---
## FieldTA.EntryCategory property

Hämtar eller ställer in integralpostkategorin, vilket är ett tal som motsvarar ordningen på kategorier.
