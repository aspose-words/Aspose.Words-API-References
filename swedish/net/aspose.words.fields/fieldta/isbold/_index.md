...
description: Hämtar eller ställer in om fet formatering ska tillämpas på sidnumret för posten.
type: docs
weight: 30
...
Hämtar eller ställer in om fet formatering ska tillämpas på sidnumret för posten.
