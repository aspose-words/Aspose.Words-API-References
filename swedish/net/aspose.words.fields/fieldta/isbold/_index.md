...
description: Förbättra din FieldTA-upplevelse! Kontrollera enkelt fetstil för sidnummer i ingången, vilket säkerställer tydlighet och betoning i dina dokument.
type: docs
weight: 30
...
Hämtar eller anger om fetstil ska användas för sidnumret för posten.
