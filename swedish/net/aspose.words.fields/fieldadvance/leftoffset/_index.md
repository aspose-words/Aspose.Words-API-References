...
description: Upptäck egenskapen FieldAdvance LeftOffset för att enkelt justera textjusteringen genom att sätta punkter för exakt vänsterförflyttning. Förbättra din dokumentlayout!
type: docs
weight: 40
...
Hämtar eller anger antalet punkter som texten som följer fältet ska flyttas åt vänster med.
