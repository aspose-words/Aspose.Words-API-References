...
description: Upptäck egenskapen FieldToc HeadingLevelRange för att enkelt hantera rubriknivåer för förbättrad innehållsorganisation och SEO-optimering.
type: docs
weight: 80
url: /sv/net/aspose.words.fields/fieldtoc/headinglevelrange/
---
## FieldToc.HeadingLevelRange property

Hämtar eller ställer in ett intervall av rubriknivåer att inkludera.
