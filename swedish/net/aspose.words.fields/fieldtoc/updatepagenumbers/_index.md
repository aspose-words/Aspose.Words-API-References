...
description: Uppdatera enkelt din innehållsförteckning med FieldTocs UpdatePageNumbers-metod, vilket säkerställer korrekt navigering och förbättrad dokumentanvändbarhet.
type: docs
weight: 180
...
Uppdaterar sidnumren för objekt i innehållsförteckningen.
...
`sann` om operationen lyckas. Om något av de relaterade bokmärkena i innehållsförteckningen har tagits bort,`falsk` kommer att returneras.
