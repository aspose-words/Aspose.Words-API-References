...
description: Upptäck hur du använder egenskapen FieldToc UseParagraphOutlineLevel för att förbättra dokumentorganisationen genom att effektivt ställa in styckedispositionsnivåer.
type: docs
weight: 170
url: /sv/net/aspose.words.fields/fieldtoc/useparagraphoutlinelevel/
---
## FieldToc.UseParagraphOutlineLevel property

Hämtar eller anger om den tillämpade styckedispositionsnivån ska användas.
