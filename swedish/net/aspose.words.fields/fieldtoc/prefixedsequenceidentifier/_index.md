...
description: Upptäck egenskapen FieldToc PrefixedSequenceIdentifier – hantera sekvensidentifierare effektivt och förbättra din posts sidnummer med unika prefix.
type: docs
weight: 120
...
Hämtar eller anger identifieraren för en sekvens för vilken ett prefix ska läggas till postens sidnummer.
