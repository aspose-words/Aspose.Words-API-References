...
description: Upptäck hur egenskapen FieldToc PreserveLineBreaks förbättrar tabellposter genom att bevara nyradstecken för förbättrad läsbarhet och formatering.
type: docs
weight: 130
...
Hämtar eller anger om nyradstecken ska bevaras i tabellposter.
