...
description: Upptäck egenskapen FieldToc EntrySeparator, anpassa teckensekvenser för att förbättra navigeringen på startsidan och förbättra dokumentorganisationen.
type: docs
weight: 70
...
Hämtar eller anger en teckensekvens som separerar en post och dess sidnummer.
