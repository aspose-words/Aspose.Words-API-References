...
description: Använd egenskapen FieldToc PageNumberOmittingLevelRange för att anpassa innehållsförteckningen genom att utelämna sidnummer för specifika ingångsnivåer.
type: docs
weight: 110
...
Hämtar eller anger ett intervall av nivåer i innehållsförteckningen från vilka sidnummer ska utelämnas.
