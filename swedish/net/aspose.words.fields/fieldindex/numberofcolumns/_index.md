...
description: Upptäck egenskapen FieldIndex NumberOfColumns för att enkelt anpassa din indexlayout med optimala kolumninställningar för förbättrad läsbarhet och prestanda.
type: docs
weight: 100
...
Hämtar eller anger antalet kolumner per sida som används vid uppbyggnad av indexet.
