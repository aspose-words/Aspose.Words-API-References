...
description: Upptäck FieldIndex LanguageId-egenskapen för att enkelt hantera språk-ID:n för optimerad indexering. Förbättra dina sökfunktioner idag!
type: docs
weight: 80
...
Hämtar eller anger språk-ID:t som används för att generera indexet.
