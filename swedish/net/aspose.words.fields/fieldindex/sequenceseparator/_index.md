...
description: Upptäck egenskapen FieldIndex SequenceSeparator och hantera enkelt teckensekvenser för att separera sekvens- och sidnummer i dina applikationer.
type: docs
weight: 160
