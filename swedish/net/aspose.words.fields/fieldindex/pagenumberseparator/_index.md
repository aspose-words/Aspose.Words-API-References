...
description: Upptäck egenskapen FieldIndex PageNumberSeparator och anpassa enkelt tecknet som separerar indexposter från sidnummer för ökad tydlighet.
type: docs
weight: 120
...
Hämtar eller anger teckensekvensen som används för att separera en indexpost och dess sidnummer.
