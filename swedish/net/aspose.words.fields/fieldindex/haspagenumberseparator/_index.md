...
description: Upptäck egenskapen FieldIndex HasPageNumberSeparator, som visar om en sidnummeravgränsare är anpassad via fältkod för förbättrad dokumentformatering.
type: docs
weight: 50
...
Hämtar ett värde som anger om en sidnummeravgränsare åsidosätts genom fältets kod.
