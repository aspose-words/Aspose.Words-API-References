...
description: Upptäck egenskapen FieldStyleRef InsertParagraphNumberInRelativeContext för att enkelt hantera styckenumrering i dina dokument för ökad tydlighet.
type: docs
weight: 40
...
Hämtar eller anger om styckenumret för det refererade stycket ska infogas i relativ kontext.
