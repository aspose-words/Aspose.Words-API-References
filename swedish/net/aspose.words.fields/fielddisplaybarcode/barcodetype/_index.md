...
description: Upptäck FieldDisplayBarcodes egenskap BarcodeType – hantera och anpassa enkelt streckkodstyper som QR för förbättrad datavisning och funktionalitet.
type: docs
weight: 40
