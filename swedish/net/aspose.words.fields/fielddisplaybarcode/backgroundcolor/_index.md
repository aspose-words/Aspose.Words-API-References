...
description: Anpassa din streckkods utseende med egenskapen FieldDisplayBarcode BackgroundColor. Ställ in livfulla färger för förbättrad synlighet och varumärkesbyggande.
type: docs
weight: 30
...
Hämtar eller ställer in bakgrundsfärgen för streckkodssymbolen. Giltiga värden är inom intervallet [0, 0xFFFFFF]
