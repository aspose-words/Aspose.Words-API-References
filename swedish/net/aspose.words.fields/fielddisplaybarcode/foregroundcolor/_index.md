...
description: Anpassa din streckkods utseende med egenskapen FieldDisplayBarcode ForegroundColor. Ställ enkelt in livfulla färger för förbättrad synlighet!
type: docs
weight: 100
...
Hämtar eller ställer in förgrundsfärgen för streckkodssymbolen. Giltiga värden är inom intervallet [0, 0xFFFFFF]
