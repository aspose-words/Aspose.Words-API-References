...
description: Upptäck iFieldDatabaseProviders GetQueryResult-metod för effektiv datainsamling. Effektivisera dina frågor och förbättra databasens prestanda idag!
type: docs
weight: 10
...
| connection | String | Anslutningen till de data som anges i fältväxeln \c. |
| query | String | Den uppsättning SQL-instruktioner som frågar databasen som anges i fältväxeln \s. |
