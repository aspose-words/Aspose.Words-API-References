...
description: Upptäck egenskapen UpdatedFieldsCount i FieldUpdatingProgressArgs för att enkelt spåra antalet uppdaterade fält i din applikation.
type: docs
weight: 30
...
Hämtar antalet uppdaterade fält.
