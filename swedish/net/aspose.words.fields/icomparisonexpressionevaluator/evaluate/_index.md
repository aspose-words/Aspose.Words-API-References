...
description: Upptäck IComparisonExpressionEvaluators Evaluate-metod för exakta jämförelseutvärderingar. Öka din kodningseffektivitet med vårt kraftfulla verktyg!
type: docs
weight: 10
...
Implementeringen ska returnera`null` för att indikera att standardutvärderingen ska utföras.
