...
description: Upptäck klassen Aspose.Words.Fields.FieldImport, utformad för att effektivisera dokumenthantering med effektiv implementering av IMPORT-fält för ökad produktivitet.
type: docs
weight: 2430
...
| [GraphicFilter](../../aspose.words.fields/fieldimport/graphicfilter/) { get; set; } | Hämtar eller anger namnet på filtret för formatet på den grafik som ska infogas. |
...
| [IsLinked](../../aspose.words.fields/fieldimport/islinked/) { get; set; } | Hämtar eller anger om filstorleken ska minskas genom att inte lagra grafikdata med dokumentet. |
...
| [SourceFullName](../../aspose.words.fields/fieldimport/sourcefullname/) { get; set; } | Hämtar eller anger bildens plats. |
...
Hämtar bilden som finns i dokumentet.
