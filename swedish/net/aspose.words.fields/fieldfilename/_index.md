...
description: Aspose.Words.Fields.FieldFileName klass. Implementerar fältet FILENAME i C#.
type: docs
weight: 1870
url: /sv/net/aspose.words.fields/fieldfilename/
---
## FieldFileName class

Implementerar fältet FILENAME.
...
| [IncludeFullPath](../../aspose.words.fields/fieldfilename/includefullpath/) { get; set; } | Hämtar eller ställer in om det fullständiga sökvägsnamnet ska inkluderas. |
...
I den nuvarande implementeringen, använder[`OriginalFileName`](../../aspose.words/document/originalfilename/) egenskapen för att hämta filnamnet. Om dokumentet laddades från en ström eller skapades tomt, används namnet på filen som sparas till (om känt).
