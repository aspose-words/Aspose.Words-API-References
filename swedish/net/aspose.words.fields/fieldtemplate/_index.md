...
description: Upptäck klassen Aspose.Words.Fields.FieldTemplate för sömlös implementering av TEMPLATE-fält. Förbättra din dokumenthantering med kraftfulla funktioner!
type: docs
weight: 2900
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | Hämtar eller anger om hela sökvägen till filen ska inkluderas. |
