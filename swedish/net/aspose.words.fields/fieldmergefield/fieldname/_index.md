...
description: Upptäck egenskapen FieldMergeField FieldName för att enkelt hantera och anpassa dina datafält för förbättrad dataintegration och effektivitet.
type: docs
weight: 10
...
Hämtar eller anger namnet på ett datafält.
