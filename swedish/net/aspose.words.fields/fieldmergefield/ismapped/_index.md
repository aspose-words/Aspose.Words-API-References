...
description: Upptäck egenskapen FieldMergeField IsMapped för att enkelt hantera mappade fält, vilket förbättrar din dataintegration och arbetsflödeseffektivitet.
type: docs
weight: 30
...
Hämtar eller anger om detta fält är ett mappat fält.
