...
description: FieldBarcode IsBookmark fast egendom. Hämtar eller ställer in omPostalAddress är namnet på ett bokmärke i C#.
type: docs
weight: 30
...
Hämtar eller ställer in om[`PostalAddress`](../postaladdress/) är namnet på ett bokmärke.
