...
description: Upptäck FieldOptions CurrentUser-egenskapen för att enkelt hantera och anpassa användarinformation för förbättrad funktionalitet i dina applikationer.
type: docs
weight: 50
...
Hämtar eller ställer in aktuell användarinformation.
