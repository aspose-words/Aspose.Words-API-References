...
description: Upptäck FieldOptions FieldDatabaseProvider-egenskapen, hantera och hämta enkelt frågeresultat för förbättrad datahantering i dina applikationer.
type: docs
weight: 80
...
Hämtar eller ställer in en provider som returnerar ett frågeresultat för[`FieldDatabase`](../../fielddatabase/) fält.
