...
description: Hämtar eller ställer in standarddokumentets författares namn. Om författarens namn redan är specificerat i inbyggda dokumentegenskaper övervägs inte detta alternativ.
type: docs
weight: 60
