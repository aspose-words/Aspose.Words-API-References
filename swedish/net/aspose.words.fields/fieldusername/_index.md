...
description: Upptäck klassen Aspose.Words.Fields.FieldUserName för sömlös integration av USERNAME-fält. Förbättra dokumentautomationen med kraftfulla funktioner idag!
type: docs
weight: 3010
...
Implementerar fältet ANVÄNDARNAMN.
...
| [UserName](../../aspose.words.fields/fieldusername/username/) { get; set; } | Gest eller anger den aktuella användarens namn. |
