...
description: Upptäck klassen Aspose.Words.Fields.FieldAutoText för att enkelt hantera AUTOTEXT-fält, vilket förbättrar dokumentautomation och effektivitet.
type: docs
weight: 2020
...
| [EntryName](../../aspose.words.fields/fieldautotext/entryname/) { get; set; } | Hämtar eller anger namnet på AutoText-posten. |
