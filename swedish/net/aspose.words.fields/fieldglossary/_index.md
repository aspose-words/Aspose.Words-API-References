...
description: Utforska klassen Aspose.Words.Fields.FieldGlossary för sömlös implementering av GLOSSARY-fält. Förbättra din dokumenthantering med kraftfulla funktioner!
type: docs
weight: 2370
url: /sv/net/aspose.words.fields/fieldglossary/
---
## FieldGlossary class

Implementerar ORDLISTA-fältet.
...
| [EntryName](../../aspose.words.fields/fieldglossary/entryname/) { get; set; } | Hämtar eller anger namnet på ordlistaposten som ska infogas. |
