...
description: Upptäck hur du använder egenskapen ContentType i BuiltInDocumentProperties för att effektivt hantera dokumentets innehållstyp och förbättra organisationen.
type: docs
weight: 90
