...
description: Upptäck egenskapen BuiltInDocumentProperties Bytes, ett viktigt verktyg för att uppskatta dokumentstorlek, förbättra filhantering och effektivitet.
type: docs
weight: 20
...
Representerar en uppskattning av antalet byte i dokumentet.
