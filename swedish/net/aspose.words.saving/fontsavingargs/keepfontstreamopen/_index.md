...
description: Upptäck hur egenskapen KeepFontStreamOpen i FontSavingArgs låter Aspose.Words hantera teckensnittsströmmar effektivt, vilket förbättrar din dokumentbehandlingsupplevelse.
type: docs
weight: 90
...
Anger om Aspose.Words ska hålla strömmen öppen eller stänga den efter att ett teckensnitt har sparats.
...
Standard är`falsk` och Aspose.Words kommer att stänga strömmen du angav i[`FontStream`](../fontstream/) egenskap efter att ha skrivit ett teckensnitt i den. Ange`sann` för att hålla strömmen öppen.
