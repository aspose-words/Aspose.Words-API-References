...
description: Upptäck egenskapen FontSavingArgs IsExportNeeded för att styra export av teckensnittsresurser. Maximera effektiviteten med anpassningsbara inställningar för dina projekt!
type: docs
weight: 60
...
Gör det möjligt att ange om det aktuella teckensnittet ska exporteras som en teckensnittsresurs. Standard är`sann` .
