...
description: Upptäck egenskapen FontSavingArgs för att komma åt dokumentobjektet under sparningsåtgärder, vilket förbättrar din dokumenthanterings effektivitet.
type: docs
weight: 20
...
Hämtar dokumentobjektet som sparas.
