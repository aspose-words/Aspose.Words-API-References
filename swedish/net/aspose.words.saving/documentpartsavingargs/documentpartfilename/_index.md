...
description: Upptäck egenskapen DocumentPartFileName för DocumentPartSavingArgs. Hantera enkelt filnamn för sömlös sparning av dokumentdelar utan sökvägar.
type: docs
weight: 20
...
Den här egenskapen låter dig omdefiniera hur dokumentdelarnas filnamn genereras vid export till HTML eller EPUB.

När återanropet anropas innehåller den här egenskapen filnamnet som genererades av Aspose.Words. Du kan ändra värdet på den här egenskapen för att spara dokumentdelen i en annan fil. Observera att filnamnet för varje del måste vara unikt.

`DocumentPartFileName` måste endast innehålla filnamnet utan sökvägen. Aspose.Words bestämmer sökvägen för sparning med hjälp av dokumentets filnamn. Om utdatadokumentets filnamn inte angavs, till exempel när man sparar till en ström, används detta filnamn endast för att referera till dokumentdelar. Detsamma gäller när man sparar i EPUB-format.
