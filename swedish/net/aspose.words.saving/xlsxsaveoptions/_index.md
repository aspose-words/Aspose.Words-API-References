...
description: Aspose.Words.Saving.XlsxSaveOptions klass. Kan användas för att ange ytterligare alternativ när du sparar ett dokument iXlsx format.
type: docs
weight: 5710
...
Kan användas för att ange ytterligare alternativ när du sparar ett dokument iXlsx format.

För att lära dig mer, besök[Specificera Spara alternativ](https://docs.aspose.com/words/net/specify-save-options/) dokumentationsartikel.
...
| [CompressionLevel](../../aspose.words.saving/xlsxsaveoptions/compressionlevel/) { get; set; } | Anger komprimeringsnivån som används för att spara dokument. Standardvärdet ärNormal . |
...
| override [SaveFormat](../../aspose.words.saving/xlsxsaveoptions/saveformat/) { get; set; } | Anger formatet som dokumentet kommer att sparas i om detta sparaalternativ-objekt används. Kan endastXlsx . |
