...
| [ListIndentation](../../aspose.words.saving/txtsaveoptions/listindentation/) { get; } | Hämtar ett ListIndentation-objekt som anger hur många och vilket tecken som ska användas för indrag av listnivåer. Som standard är det nollantal av tecknet '\0', det betyder ingen indrag. |
