...
description: MarkdownSaveOptions fast egendom. Hämtar eller ställer in ett värde som anger hur innehåll ska justeras i tables vid export tillMarkdown format. Standardvärdet ärAuto .
type: docs
weight: 60
