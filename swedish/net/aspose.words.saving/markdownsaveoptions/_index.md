...
description: Aspose.Words.Saving.MarkdownSaveOptions klass. Klass för att ange ytterligare alternativ när du sparar ett dokument iMarkdown format i C#.
type: docs
weight: 5280
...
| [ImagesFolderAlias](../../aspose.words.saving/markdownsaveoptions/imagesfolderalias/) { get; set; } | Anger namnet på mappen som används för att konstruera bild-URI:er inskrivna i ett dokument. Standard är en tom sträng. |
