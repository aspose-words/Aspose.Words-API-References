...
description: Upptäck egenskapen BookmarksOutlineLevels i OutlineOptions för att anpassa dina bokmärkens hierarki för förbättrad navigering och användarupplevelse.
type: docs
weight: 20
...
Om bokmärkesnivå inte anges i den här samlingen då[`DefaultBookmarksOutlineLevel`](../defaultbookmarksoutlinelevel/) värde används.
