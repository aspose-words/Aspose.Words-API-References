...
description: Tillåter att ange om CSS ska exporteras till fil och bäddas in i HTML-dokument. Standard ärSann . När den här egenskapen ärfalsk  kommer CSS-informationen inte att sparas i en CSS-fil och kommer inte att bäddas in i HTML-dokument.
type: docs
weight: 30
