...
description: Tillåter att ange om CSS ska exporteras till fil och bäddas in i HTMLdokument. Standard ärSann . När den här egenskapen ärfalsk  kommer CSSinformationen inte att sparas i en CSSfil och kommer inte att bäddas in i HTMLdokument.
type: docs
weight: 30
