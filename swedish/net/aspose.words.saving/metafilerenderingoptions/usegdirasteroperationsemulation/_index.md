...
description: MetafileRenderingOptions fast egendom. Hämtar eller ställer in ett värde som avgör om GDI ska användas eller inte för emulering av rasteroperationer.
type: docs
weight: 80
