...
description: Aspose.Words.Saving.PdfCompliance uppräkning. Anger överensstämmelsenivån för PDFstandarder i C#.
type: docs
weight: 5410
...
| PdfA1b | `3` | Utdatafilen kommer att överensstämma med standarden PDF/A-1b (ISO 19005-1). PDF/A-1b har som mål att säkerställa tillförlitlig återgivning av dokumentets visuella utseende. |
| PdfA2a | `4` | Utdatafilen kommer att följa standarden PDF/A-2a (ISO 19005-2). Denna nivå inkluderar alla krav i PDF/A-2u och kräver dessutom att dokumentstrukturen inkluderas (även känd som "taggad" ), med målet att säkerställa att dokumentinnehåll kan sökas i och återanvändas. |
...
| PdfUa1 | `7` | Utdatafilen kommer att följa standarden PDF/UA-1 (ISO 14289-1). Det primära syftet med PDF/UA är att definiera hur elektroniska dokument ska representeras i PDF-formatet på ett sätt som gör att filen kan vara tillgänglig. |
