...
description: PdfSaveOptions ZoomBehavior fast egendom. Hämtar eller ställer in ett värde som bestämmer vilken typ av zoom som ska användas när ett dokument öppnas med en PDFvisare i C#.
type: docs
weight: 320
