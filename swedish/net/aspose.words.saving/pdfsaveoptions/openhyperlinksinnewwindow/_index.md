...
description: PdfSaveOptions OpenHyperlinksInNewWindow fast egendom. Hämtar eller ställer in ett värde som avgör om hyperlänkar i utdata Pdf document tvingas öppnas i ett nytt fönster eller flik i en webbläsare i C#.
type: docs
weight: 230
