...
description: Implementera detta gränssnitt om du vill kontrollera hur Aspose.Words sparar bilder när sparar ett dokument till HTML. Kan användas av andra format.
type: docs
weight: 4910
...
| namn | Beskrivning |
| --- | --- |
| [ImageSaving](../../aspose.words.saving/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | Anropas när Aspose.Words sparar en bild i HTML. |
