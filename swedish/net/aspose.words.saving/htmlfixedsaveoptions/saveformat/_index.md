...
description: Upptäck egenskapen HtmlFixedSaveOptions SaveFormat för att säkerställa att dina dokument sparas i det exklusiva HtmlFixed-formatet för optimal kvalitet.
type: docs
weight: 190
...
Anger formatet som dokumentet sparas i om detta objekt för sparade alternativ används. Kan endast varaHtmlFixed .
