...
description: Flagga anger om font-face CSS-regler ska placeras i en separat fil fontFaces.css när ett dokument sparas med extern stilmall det vill säga närExportEmbeddedCssaspose.words.saving/htmlfixedsaveoptions/exportembeddedcss ärfalsk . Standardvärdet ärfalsk  alla CSS-regler skrivs i en enda fil styles.css.
type: docs
weight: 160
