...
description: Hämtar eller ställer in en indikation på om formulärfält exporteras som interactive objekt som inputtagg snarare än omvandlas till text eller grafik.
type: docs
weight: 80
