...
description: Gör det möjligt att göra utmatade RTF-dokument mindre i storlek men om de innehåller RTL höger-till-vänster text kommer den inte att visas korrekt. Standardvärdet ärfalsk .
type: docs
weight: 20
