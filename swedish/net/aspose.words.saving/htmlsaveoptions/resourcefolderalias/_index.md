...
description: Anger namnet på mappen som används för att konstruera URIer för alla resurser som skrivits in i ett HTML-dokument. Standard är en tom sträng.
type: docs
weight: 430
