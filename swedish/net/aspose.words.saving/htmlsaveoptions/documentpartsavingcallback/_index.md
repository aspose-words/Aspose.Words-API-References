...
description: Kontrollera sparandet av dokumentdelar med HtmlSaveOptions DocumentPartSavingCallback. Optimera dina HTML- eller EPUB-exporter för en smidig användarupplevelse.
type: docs
weight: 70
url: /sv/net/aspose.words.saving/htmlsaveoptions/documentpartsavingcallback/
---
## HtmlSaveOptions.DocumentPartSavingCallback property

Gör det möjligt att styra hur dokumentdelar sparas när ett dokument sparas i HTML eller EPUB.
