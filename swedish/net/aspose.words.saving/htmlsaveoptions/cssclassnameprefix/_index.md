...
description: Anger ett prefix som läggs till i alla CSSklassnamn. Standardvärdet är en tom sträng och genererade CSSklassnamn har inget gemensamt prefix.
type: docs
weight: 30
