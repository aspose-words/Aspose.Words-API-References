...
description: Anger om CIDwebbadresser ContentID ska användas för att referera till resurser bilder teckensnitt CSS som ingår i MHTML dokument. Standardvärdet ärfalsk .
type: docs
weight: 120
