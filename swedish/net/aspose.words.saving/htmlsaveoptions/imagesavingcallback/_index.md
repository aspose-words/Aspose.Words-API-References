...
description: HtmlSaveOptions ImageSavingCallback fast egendom. Gör det möjligt att styra hur bilder sparas när ett dokument sparas i HTML MHTML eller EPUB i C#.
type: docs
weight: 350
...
Gör det möjligt att styra hur bilder sparas när ett dokument sparas i HTML, MHTML eller EPUB.
