...
description: Anger om teckensnittsfamiljnamn som används i dokumentet löses och ersätts enligt FontSettingsaspose.words/document/fontsettings när de skrivs i HTML-baserade format.
type: docs
weight: 410
