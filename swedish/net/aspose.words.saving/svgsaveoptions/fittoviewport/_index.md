...
description: Anger om utdata-SVG ska fylla det tillgängliga viewportområdet webbläsarfönster eller behållare. När den är inställd på sann bredd och höjd på utdata är SVG inställda på 100.
type: docs
weight: 30
