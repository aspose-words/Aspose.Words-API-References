...
description: Aspose.Words.Saving.SvgSaveOptions klass. Kan användas för att ange ytterligare alternativ när du sparar ett dokument iSvg format i C#.
type: docs
weight: 5600
...
| [FitToViewPort](../../aspose.words.saving/svgsaveoptions/fittoviewport/) { get; set; } | Anger om utdata SVG ska fylla det tillgängliga visningsområdet (webbläsarfönster eller behållare). När inställt på`Sann` bredd och höjd på utdata SVG är inställda på 100%. |
