...
description: Upptäck Aspose.Words.PclSaveOptions för att förbättra din dokumentsparning med anpassningsbara funktioner för PCL-format. Optimera ditt arbetsflöde idag!
type: docs
weight: 6180
...
Kan användas för att ange ytterligare alternativ när ett dokument sparas iPcl format.
...
| [FallbackFontName](../../aspose.words.saving/pclsaveoptions/fallbackfontname/) { get; set; } | Namn på det teckensnitt som ska användas om inget förväntat teckensnitt hittas i skrivarens och de inbyggda teckensnittssamlingarna. |
...
| [RasterizeTransformedElements](../../aspose.words.saving/pclsaveoptions/rasterizetransformedelements/) { get; set; } | Hämtar eller anger ett värde som avgör om komplexa transformerade element ska rastreras innan de sparas till PCL-dokumentet. Standard är`sann` . |
| override [SaveFormat](../../aspose.words.saving/pclsaveoptions/saveformat/) { get; set; } | Anger formatet som dokumentet sparas i om detta objekt för sparade alternativ används. Kan endast varaPcl . |
