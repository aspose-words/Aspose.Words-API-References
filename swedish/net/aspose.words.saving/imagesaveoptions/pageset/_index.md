...
description: Upptäck egenskapen ImageSaveOptions PageSet för att anpassa din dokumentrendering. Styr vilka sidor som ska sparas för optimerad utdata. Utforska nu!
type: docs
weight: 100
...
Den här egenskapen har endast effekt vid rendering av dokumentsidor. Den här egenskapen ignoreras vid rendering av former till bilder.
...
// När vi sparar dokumentet som en bild, renderar Aspose.Words bara den första sidan som standard.
// Vi kan skicka ett SaveOptions-objekt för att ange en annan sida som ska renderas.
