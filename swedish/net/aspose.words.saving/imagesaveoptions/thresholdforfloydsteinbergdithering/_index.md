...
description: ImageSaveOptions fast egendom. Hämtar eller ställer in tröskeln som bestämmer värdet för binariseringsfelet i FloydSteinbergmetoden. närImageBinarizationMethod är ImageBinarizationMethod.FloydSteinbergDithering.
type: docs
weight: 150
...
Hämtar eller ställer in tröskeln som bestämmer värdet för binariseringsfelet i Floyd-Steinberg-metoden. när[`ImageBinarizationMethod`](../../imagebinarizationmethod/) är ImageBinarizationMethod.FloydSteinbergDithering.
