...
description: Hämtar eller ställer in värde som avgör om innehållet iStructuredDocumentTagaspose.words.markup/structureddocumenttag uppdateras innan du sparar.
type: docs
weight: 200
