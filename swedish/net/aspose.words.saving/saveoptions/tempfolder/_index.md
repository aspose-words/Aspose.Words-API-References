...
description: Anger mappen för temporära filer som används när du sparar till en DOC eller DOCXfil. Som standard är denna egenskapnull och inga temporära filer används.
type: docs
weight: 150
