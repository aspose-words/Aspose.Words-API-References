...
description: Hämtar eller ställer in ett booleskt värde som indikerar om man ska tillåta inbäddning av teckensnitt med PostScript outlines när inbäddning av TrueTypeteckensnitt i ett dokument på det sparas. Standardvärdet är falsk .
type: docs
weight: 20
