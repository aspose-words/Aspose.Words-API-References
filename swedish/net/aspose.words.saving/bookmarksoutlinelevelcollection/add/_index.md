...
description: Upptäck hur du kan förbättra ditt projekt med BookmarksOutlineLevelCollection Add-metoden, och enkelt lägga till bokmärken i din samling för bättre organisering.
type: docs
weight: 40
...
| --- | --- | --- |
| name | String | Det skiftlägeskänsliga namnet på bokmärket som ska läggas till. |
| outlineLevel | Int32 | Bokmärkets dispositionsnivå. Giltigt intervall är 0 till 9. |
