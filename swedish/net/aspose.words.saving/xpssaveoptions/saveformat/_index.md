...
description: Upptäck egenskapen XpsSaveOptions SaveFormat, som definierar hur ditt dokument sparas. Säkerställ optimalt XPS-format för smidig dokumenthantering!
type: docs
weight: 40
...
Anger formatet som dokumentet sparas i om detta objekt för sparade alternativ används. Kan endast varaXps .
