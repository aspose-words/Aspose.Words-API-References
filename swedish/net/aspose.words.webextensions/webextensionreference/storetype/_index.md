...
description: Upptäck egenskapen WebExtensionReference StoreType, som definierar marknadsplatstyper för att förbättra dina webbutvecklingsprojekt med skräddarsydda lösningar.
type: docs
weight: 40
