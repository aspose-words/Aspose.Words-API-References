...
description: Upptäck WebExtensionReference Store-egenskapen – din inkörsport till att effektivt komma åt och hantera webbtillägg på marknaden.
type: docs
weight: 30
...
Anger instansen av marknadsplatsen där webbtillägget lagras.
