...
description: Identifiera egenskapen WebExtensionReference Version för att definiera din webbtilläggs version, vilket säkerställer kompatibilitet och förbättrad prestanda.
type: docs
weight: 50
