...
description: Upptäck enumerationen Aspose.Words.WebExtensionStoreType, med olika typer av webbtillägg för sömlös integration och förbättrad funktionalitet.
type: docs
weight: 7670
...
Listar upp tillgängliga typer av webbtilläggsbutiker.
...
| Exchange | `3` | Anger att lagringstypen är en Exchange-server. |
| FileSystem | `4` | Anger att lagringstypen är en filsystemresurs. |
| Registry | `5` | Anger att arkivtypen är systemregistret. |
