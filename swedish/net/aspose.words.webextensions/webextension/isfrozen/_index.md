...
description: Upptäck WebExtension IsFrozen-egenskapen, som styr användarinteraktion med ditt webbtillägg. Förbättra användbarheten och optimera användarupplevelsen idag!
type: docs
weight: 40
