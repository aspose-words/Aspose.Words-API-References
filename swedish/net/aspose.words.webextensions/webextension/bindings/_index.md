...
description: Upptäck WebExtension Bindings, effektivisera din utveckling med anpassningsbara webbtilläggskopplingar för förbättrad funktionalitet och användarupplevelse.
type: docs
weight: 20
...
Anger en lista över bindningar för webbtillägg.
