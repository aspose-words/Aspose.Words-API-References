...
description: Upptäck egenskapen WebExtension AlternateReferences för att förbättra ditt webbtillägg med mångsidiga referensalternativ för förbättrad funktionalitet.
type: docs
weight: 10
