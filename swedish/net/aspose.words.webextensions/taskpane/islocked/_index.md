...
description: Upptäck egenskapen TaskPane IsLocked, styr åtkomst till aktivitetsfönstret i ditt användargränssnitt och säkerställ att användare inte kan stänga viktiga funktioner för ökad produktivitet.
type: docs
weight: 30
url: /sv/net/aspose.words.webextensions/taskpane/islocked/
---
