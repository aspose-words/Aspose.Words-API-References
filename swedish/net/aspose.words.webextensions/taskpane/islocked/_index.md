...
description: TaskPane IsLocked fast egendom. Anger om aktivitetsfönstret är låst till dokumentet i användargränssnittet och inte kan stängas av användaren i C#.
type: docs
weight: 30
