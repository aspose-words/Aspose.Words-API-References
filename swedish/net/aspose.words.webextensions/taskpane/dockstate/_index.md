...
description: Upptäck egenskapen TaskPane DockState för att enkelt hantera aktivitetsfönstrets senast dockade position för förbättrat arbetsflöde och effektivitet.
type: docs
weight: 20
url: /sv/net/aspose.words.webextensions/taskpane/dockstate/
---
## TaskPane.DockState property

Anger den senast dockade platsen för detta aktivitetsfönsterobjekt.
