...
description: Upptäck egenskapen TaskPane Row och hantera enkelt indexering av aktivitetsfönster för effektiv organisation och förbättrad produktivitet i dina applikationer.
type: docs
weight: 50
...
Anger indexet, uppräknat från utsidan till insidan, för den här åtgärdsrutan bland andra bestående åtgärdsrutor som är dockade på samma standardplats.
