...
description: Upptäck egenskapen TaskPane Width för att enkelt anpassa åtgärdsfönstrets standardbredd, vilket förbättrar användarupplevelsen och funktionaliteten.
type: docs
weight: 70
...
Anger standardbredden för den här aktivitetsfönstrets instans.
