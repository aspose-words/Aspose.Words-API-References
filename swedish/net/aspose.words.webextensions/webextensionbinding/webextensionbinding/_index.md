...
description: Skapa kraftfulla webbtilläggsbindningar enkelt med WebExtensionBinding-konstruktorn. Anpassa parametrar för sömlös integration och förbättrad funktionalitet.
type: docs
weight: 10
...
Skapar webbtilläggsbindning med angivna parametrar.
...
| --- | --- | --- |
| id | String | Bindande identifierare. |
| bindingType | WebExtensionBindingType | Bindningstyp. |
| appRef | String | Bindningsnyckel som används för att mappa bindningsposten i den här listan med de bundna data i dokumentet. |
