...
| namn | Beskrivning |
| --- | --- |
| [AppRef](../../aspose.words.webextensions/webextensionbinding/appref/) { get; set; } | Anger bindningsnyckeln som används för att mappa bindningsposten i den här listan med bundna data i dokumentet. |
| [BindingType](../../aspose.words.webextensions/webextensionbinding/bindingtype/) { get; set; } | Anger bindningstypen. |
| [Id](../../aspose.words.webextensions/webextensionbinding/id/) { get; set; } | Anger bindningsidentifieraren. |
