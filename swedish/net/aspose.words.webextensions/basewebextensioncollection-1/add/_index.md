...
description: Upptäck hur du kan förbättra dina projekt med BaseWebExtensionCollections tilläggsmetod. Lägg enkelt till objekt i din samling för sömlös integration.
type: docs
weight: 30
