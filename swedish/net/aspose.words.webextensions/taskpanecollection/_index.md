...
description: Upptäck klassen Aspose.Words.WebExtensions.TaskPaneCollection, din lösning för att effektivt hantera beständiga objekt i aktivitetsfönstret. Förbättra dina webbapplikationer idag!
type: docs
weight: 7570
