...
description: Upptäck hur du använder WebExtensionProperty Name för att skapa anpassade egenskapsnamn som förbättrar dina webbtillägg och förbättrar funktionaliteten.
type: docs
weight: 20
