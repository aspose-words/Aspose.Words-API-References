...
description: Upptäck enumereringen Aspose.Words.WebExtensions.TaskPaneDockState, som definierar platser i aktivitetsfönster för förbättrad dokumentredigering och användarupplevelse.
type: docs
weight: 7580
...
Räknar upp tillgängliga platser för åtgärdsfönsterobjekt.
...
| --- | --- | --- |
| Right | `0` | Docka aktivitetsfönstret till höger om dokumentfönstret. |
