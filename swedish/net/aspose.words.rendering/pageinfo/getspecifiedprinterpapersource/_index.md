...
description: FårPaperSource objekt som är lämpligt för utskrift sidan som representeras av dettaPageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
FårPaperSource objekt som är lämpligt för utskrift sidan som representeras av detta[`PageInfo`](../../pageinfo) .
