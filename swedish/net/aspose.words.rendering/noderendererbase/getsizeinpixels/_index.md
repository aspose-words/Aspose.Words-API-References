...
description: Upptäck NodeRendererBase GetSizeInPixels-metoden för att exakt beräkna formens dimensioner i pixlar baserat på zoomfaktor och upplösning. Optimera dina designer!
type: docs
weight: 60
...
Den här metoden konverterar[`SizeInPoints`](../sizeinpoints/) till storlek i pixlar och det är användbart när du vill skapa en bitmapp för att återge formen snyggt på bitmappen.
