...
description: Hämtar antal sidor som den angivna noden sträcker sig över. 0 om noden är inom en enda sida. Detta är samma sak somGetEndPageIndexaspose.words.layout/layoutcollector/getendpageindex -GetStartPageIndexaspose.words.layout/layoutcollector/getstartpageindex .
type: docs
weight: 60
