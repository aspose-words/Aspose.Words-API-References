...
description: Returnerar en ogenomskinlig position förLayoutEnumeratoraspose.words.layout/layoutenumerator/ som motsvarar den angivna noden. Du kan använda returnerat värde som ett argument tillCurrentaspose.words.layout/layoutenumerator/current/ givet att dokumentet som räknas upp och dokumentet för noden är desamma.
type: docs
weight: 50
