...
description: Anpassa dina RevisionOptions med egenskapen MovedFromTextColor. Markera flyttat innehåll enkelt, vilket förbättrar tydligheten och användarupplevelsen.
type: docs
weight: 90
...
Gör det möjligt att ange färgen som ska användas för områden där innehåll flyttades frånMoving . Standardvärdet ärByAuthor .
