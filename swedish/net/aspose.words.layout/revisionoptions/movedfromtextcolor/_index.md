...
description: RevisionOptions MovedFromTextColor fast egendom. Tillåter att ange färgen som ska användas för områden där innehållet har flyttats frånMoving . Standardvärdet ärByAuthor  i C#.
type: docs
weight: 70
