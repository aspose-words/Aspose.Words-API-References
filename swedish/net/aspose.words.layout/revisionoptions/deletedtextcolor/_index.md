...
description: Anpassa dina RevisionOptions med egenskapen DeletedTextColor för att markera borttaget innehåll. Standardinställningen är ByAuthor. Förbättra dokumentets tydlighet!
type: docs
weight: 30
...
Gör det möjligt att ange färgen som ska användas för borttaget innehållDeletion . Standardvärdet ärByAuthor .
