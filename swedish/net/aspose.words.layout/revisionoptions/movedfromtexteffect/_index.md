...
description: Tillåter att specificera effekten som ska tillämpas på de områden där innehållet flyttades frånMoving . Standardvärdet ärDoubleStrikeThrough
type: docs
weight: 80
