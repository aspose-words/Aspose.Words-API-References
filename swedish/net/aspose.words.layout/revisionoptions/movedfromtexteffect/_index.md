...
description: Utforska RevisionOptions MovedFromTextEffect-egenskap för att anpassa synligheten av innehållsförflyttningar med effekter som DoubleStrikeThrough. Förbättra dokumentets tydlighet!
type: docs
weight: 100
...
Gör det möjligt att ange effekten som ska tillämpas på de områden där innehåll flyttades frånMoving . Standardvärdet ärDoubleStrikeThrough
