...
description: Upptäck egenskapen DeletedTextEffect i RevisionOptions. Anpassa hur borttaget innehåll visas med effekter som StrikeThrough för ökad tydlighet.
type: docs
weight: 40
...
Gör det möjligt att ange vilken effekt som ska tillämpas på det borttagna innehålletDeletion . Standardvärdet ärStrikeThrough
