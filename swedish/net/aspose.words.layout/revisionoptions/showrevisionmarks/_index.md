...
description: Styr synligheten av revisioner med egenskapen ShowRevisionMarks. Formatera enkelt revisionstext för tydlighet, vilket förbättrar dokumentsamarbetet. Standardinställningen är sant.
type: docs
weight: 210
...
Tillåter att ange om revisionstext ska markeras med speciell formateringsmarkering. Standardvärdet är`sann` .
