...
description: Anpassa ditt innehåll med RevisionOptions RevisedPropertiesColor. Markera enkelt formateringsändringar och förbättra läsbarheten med den här användarvänliga funktionen.
type: docs
weight: 130
...
Gör det möjligt att ange färgen som ska användas för innehåll med ändringar i formateringsegenskaper.FormatChange Standardvärdet ärNoHighlight .
