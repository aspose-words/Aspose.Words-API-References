...
description: Får 0-baserat index för sidan i dokumentet som denna händelse relaterar till. Returnerar negativt värde om det inte finns någon associerad sida eller om sidan togs bort under återflöde.
type: docs
weight: 30
