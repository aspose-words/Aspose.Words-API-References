...
description: Upptäck egenskapen LayoutEnumerator Kind, som identifierar den aktuella entitetstypen. Säkerställ tydlighet i dina data med denna viktiga funktion.
type: docs
weight: 50
...
Hämtar typen av den aktuella entiteten. Detta kan vara en tom sträng men aldrig`null` .
...
Detta är en mer specifik typ av aktuell entitet, t.ex. bokmärkesintervallet harSpan typen och kan ha antingen en BOOKMARKSTART- eller BOOKMARKEND-typ.
