...
description: Upptäck egenskapen LayoutEnumerator PageIndex. Hämta enkelt det 1-baserade indexet för sidan som innehåller din aktuella entitet för sömlös navigering.
type: docs
weight: 60
...
Hämtar det 1-baserade indexet för en sida som innehåller den aktuella entiteten.
