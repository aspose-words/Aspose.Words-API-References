...
description: Upptäck LayoutEnumerator-metoden MovePreviousLogical för att effektivt navigera bland syskonenheter och hantera styckerader över sidor sömlöst.
type: docs
weight: 160
...
Flyttar till föregående syskonenhet i en logisk ordning. När rader i ett stycke itereras över sidor kommer den här metoden att flyttas till föregående rad även om den finns på en annan sida.
