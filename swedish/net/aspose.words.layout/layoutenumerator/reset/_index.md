...
description: Återställ LayoutEnumerator till dokumentets första sida, vilket förbättrar navigeringen och effektiviteten för sömlös dokumenthantering.
type: docs
weight: 170
...
Flyttar uppräknaren till dokumentets första sida.
