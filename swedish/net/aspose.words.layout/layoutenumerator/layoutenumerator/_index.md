...
description: Upptäck LayoutEnumerator-konstruktorn och skapa enkelt nya instanser av den här klassen för effektiv layouthantering i dina applikationer.
type: docs
weight: 10
...
| --- | --- | --- |
| document | Document | Ett dokument vars sidlayoutmodell ska räknas upp. |

## Anmärkningar

Om dokumentets sidlayoutmodell inte har byggts anropar enumeratorn[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) att bygga den.

Närhelst ett dokument uppdateras och en ny sidlayoutmodell skapas måste en ny uppräknare användas för att komma åt det.
