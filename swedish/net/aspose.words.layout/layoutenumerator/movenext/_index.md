...
description: Upptäck LayoutEnumerator MoveNext-metoden för att navigera visuellt mellan syskonenheter. Iterera effektivt genom styckerader utan att korsa sidor.
type: docs
weight: 120
...
Flyttar till nästa syskonenhet i visuell ordning. När rader i ett stycke itereras över sidor kommer den här metoden inte att flyttas till nästa sida utan snarare till nästa entitet på samma sida.
