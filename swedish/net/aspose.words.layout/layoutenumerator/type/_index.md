...
description: Upptäck egenskapen LayoutEnumerator Type och få enkel åtkomst till den aktuella entitetens typ för effektiv datahantering och förbättrad programprestanda.
type: docs
weight: 90
...
Hämtar typen för den aktuella entiteten.
