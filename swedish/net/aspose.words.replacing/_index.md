...
| Klass | Beskrivning |
| --- | --- |
| [FindReplaceOptions](./findreplaceoptions/) | Anger alternativ för sök-/ersätt-operationer. |
| [ReplacingArgs](./replacingargs/) | Tillhandahåller data för en anpassad ersättningsoperation. |
## Gränssnitt

| Gränssnitt | Beskrivning |
| --- | --- |
| [IReplacingCallback](./ireplacingcallback/) | Implementera detta gränssnitt om du vill ha din egen anpassade metod anropad under en sök- och ersätt-operation. |
## Uppräkning
