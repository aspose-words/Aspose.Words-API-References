...
description: Upptäck klassen Aspose.Words.Bibliography, ditt viktiga verktyg för att hantera bibliografiska källor i dokument effektivt och enkelt.
type: docs
weight: 140
url: /sv/net/aspose.words.bibliography/bibliography/
---
## Bibliography class

Representerar listan över bibliografiska källor som finns tillgängliga i dokumentet.
...
| namn | Beskrivning |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Hämtar eller anger en sträng som representerar namnet på den aktiva stilen som ska användas för en bibliografi. |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | Hämtar en samling som representerar alla källor som finns i en bibliografi. |
