...
description: Upptäck en omfattande samling av bibliografiska källor, perfekta för att förbättra forskning och säkerställa korrekta citat i dina projekt.
type: docs
weight: 20
url: /sv/net/aspose.words.bibliography/bibliography/sources/
---
## Bibliography.Sources property

Hämtar en samling som representerar alla källor som finns i en bibliografi.
