...
description: Upptäck egenskapen ContributorCollection Artist för att enkelt hantera och anpassa källartister för förbättrad organisation och kreativitet i dina projekt.
type: docs
weight: 10
url: /sv/net/aspose.words.bibliography/contributorcollection/artist/
---
## ContributorCollection.Artist property

Hämtar eller ställer in artisten för en källa.
