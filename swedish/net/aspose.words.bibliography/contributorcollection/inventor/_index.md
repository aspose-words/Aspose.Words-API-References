...
description: Upptäck egenskapen ContributorCollection Inventor för att enkelt hantera och identifiera uppfinnaren av dina källor, vilket förbättrar projektets organisation.
type: docs
weight: 120
url: /sv/net/aspose.words.bibliography/contributorcollection/inventor/
---
## ContributorCollection.Inventor property

Hämtar eller anger uppfinnaren av en källa.
