...
description: Upptäck egenskapen ContributorCollection Compiler för att effektivt hantera källkodskompilatorer. Förbättra din kodningsupplevelse med enkel åtkomst och kontroll!
type: docs
weight: 40
url: /sv/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

Hämtar eller ställer in kompilatorn för en källkod.
