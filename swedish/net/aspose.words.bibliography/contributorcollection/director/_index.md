...
description: Hantera din ContributorCollection utan ansträngning. Ställ enkelt in eller uppdatera katalogen för varje källa, vilket förbättrar organisationen och effektiviteten.
type: docs
weight: 80
url: /sv/net/aspose.words.bibliography/contributorcollection/director/
---
## ContributorCollection.Director property

Hämtar eller ställer in direktören för en källa.
