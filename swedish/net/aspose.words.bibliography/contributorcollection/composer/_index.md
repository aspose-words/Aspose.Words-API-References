...
description: Upptäck egenskapen ContributorCollection Composer för att enkelt hantera och anpassa källkompositörer för förbättrad dataorganisation och effektivitet.
type: docs
weight: 50
url: /sv/net/aspose.words.bibliography/contributorcollection/composer/
---
## ContributorCollection.Composer property

Hämtar eller ställer in kompositören för en källkod.
