...
description: Upptäck egenskapen ContributorCollection Translator, hantera och anpassa enkelt källkodsöversättare för att förbättra ditt innehålls tillgänglighet och engagemang.
type: docs
weight: 150
url: /sv/net/aspose.words.bibliography/contributorcollection/translator/
---
## ContributorCollection.Translator property

Hämtar eller ställer in översättaren för en källa.
