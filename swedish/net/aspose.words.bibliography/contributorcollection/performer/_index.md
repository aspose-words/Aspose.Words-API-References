...
description: Upptäck egenskapen ContributorCollection Performer, hantera och anpassa enkelt källutförare för förbättrad dataorganisation och hämtning.
type: docs
weight: 130
url: /sv/net/aspose.words.bibliography/contributorcollection/performer/
---
## ContributorCollection.Performer property

Hämtar eller ställer in utföraren för en källa.
