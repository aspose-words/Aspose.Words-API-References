...
description: Hantera din ContributorCollection enkelt. Ange eller hämta enkelt författaren för valfri källa för att förbättra din innehållsorganisation.
type: docs
weight: 20
url: /sv/net/aspose.words.bibliography/contributorcollection/author/
---
## ContributorCollection.Author property

Hämtar eller anger författaren till en källa.
