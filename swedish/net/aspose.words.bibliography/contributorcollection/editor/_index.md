...
description: Hantera din ContributorCollection enkelt! Ställ in eller skaffa redigeraren för källor för att förbättra ditt arbetsflöde och effektivisera innehållshanteringen.
type: docs
weight: 90
url: /sv/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

Hämtar eller ställer in redigeraren för en källa.
