...
description: Upptäck egenskapen ContributorCollection BookAuthor, hantera och anpassa enkelt bokförfattare för dina källor och förbättra organiseringen av ditt innehåll.
type: docs
weight: 30
url: /sv/net/aspose.words.bibliography/contributorcollection/bookauthor/
---
## ContributorCollection.BookAuthor property

Hämtar eller anger bokens författare till en källa.
