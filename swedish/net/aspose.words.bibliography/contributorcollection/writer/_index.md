...
description: Upptäck egenskapen ContributorCollection Writer, få enkel åtkomst till och hantera källkodsförfattaren för förbättrad innehållsorganisation och effektivitet.
type: docs
weight: 160
url: /sv/net/aspose.words.bibliography/contributorcollection/writer/
---
## ContributorCollection.Writer property

Hämtar eller anger författaren till en källkod.
