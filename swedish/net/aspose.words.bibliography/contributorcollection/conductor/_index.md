...
description: Upptäck egenskapen ContributorCollection Conductor, hantera och anpassa enkelt källledaren för förbättrad dataorganisation och kontroll.
type: docs
weight: 60
url: /sv/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Hämtar eller ställer in ledaren för en källa.
