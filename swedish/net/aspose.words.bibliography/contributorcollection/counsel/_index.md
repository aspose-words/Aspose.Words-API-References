...
description: Upptäck ContributorCollection Counsel. Hantera och få enkelt tillgång till källrådgivning för förbättrad insikt om fastigheter och effektiviserat beslutsfattande.
type: docs
weight: 70
url: /sv/net/aspose.words.bibliography/contributorcollection/counsel/
---
## ContributorCollection.Counsel property

Hämtar eller ställer in råd från en källa.
