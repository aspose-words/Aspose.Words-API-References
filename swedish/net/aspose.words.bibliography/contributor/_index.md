...
description: Upptäck klassen Aspose.Words.Bibliography.Contributor, din lösning för att hantera bibliografiska bidragsgivare, inklusive organisationer och individer.
type: docs
weight: 150
url: /sv/net/aspose.words.bibliography/contributor/
---
## Contributor class

Representerar en bidragsgivare till en bibliografisk källa. Kan vara antingen ett företag (en organisation) eller en lista över personer.
