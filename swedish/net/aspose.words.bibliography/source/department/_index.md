...
description: Hantera din källavdelning utan ansträngning. Hämta eller ställ enkelt in avdelningsuppgifter för förbättrad organisation och effektivitet. Upptäck sömlös integration idag!
type: docs
weight: 170
url: /sv/net/aspose.words.bibliography/source/department/
---
## Source.Department property

Hämtar eller anger avdelningen för en källa.
