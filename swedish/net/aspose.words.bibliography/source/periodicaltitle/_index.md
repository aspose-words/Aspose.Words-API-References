...
description: Hantera enkelt din källas tidskriftstitel. Hämta eller ställ enkelt in titlar för förbättrad organisation och korrekt referenshantering.
type: docs
weight: 330
url: /sv/net/aspose.words.bibliography/source/periodicaltitle/
---
## Source.PeriodicalTitle property

Hämtar eller ställer in den periodiska titeln på en källa.
