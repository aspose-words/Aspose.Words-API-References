...
description: Hantera källtypsegenskaper utan ansträngning. Hämta eller ställ enkelt in källtyper för förbättrad dataorganisation och effektivitet i dina projekt.
type: docs
weight: 490
url: /sv/net/aspose.words.bibliography/source/type/
---
## Source.Type property

Hämtar eller anger typen av en källa.
