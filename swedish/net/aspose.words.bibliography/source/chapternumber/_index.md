---
title: Source.ChapterNumber
linktitle: ChapterNumber
articleTitle: ChapterNumber
second_title: Aspose.Words för .NET
description: Hantera din källas kapitelnummer enkelt med egenskapen ChapterNumber – enkel att använda och viktig för organiserad referenshantering.
type: docs
weight: 80
url: /sv/net/aspose.words.bibliography/source/chapternumber/
---
## Source.ChapterNumber property

Hämtar eller ställer in kapitelnumret för en källa.
