...
description: Hantera källkommentarer enkelt – hämta eller ställ in kommentarer för valfri källa för att förbättra ditt innehålls tydlighet och engagemang. Optimera ditt arbetsflöde idag!
type: docs
weight: 100
url: /sv/net/aspose.words.bibliography/source/comments/
---
## Source.Comments property

Hämtar eller ställer in kommentarer från en källa.
