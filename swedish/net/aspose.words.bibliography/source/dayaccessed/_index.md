...
description: Hantera din källas åtkomstdatum enkelt med Source DayAccessed. Spåra och uppdatera enkelt när din källa användes för bättre organisering.
type: docs
weight: 160
url: /sv/net/aspose.words.bibliography/source/dayaccessed/
---
## Source.DayAccessed property

Hämtar eller ställer in dagen då en källa nåddes.
