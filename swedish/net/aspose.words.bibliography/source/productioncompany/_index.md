...
description: Hantera ditt produktionsbolag enkelt med Source ProductionCompany. Ställ enkelt in eller uppdatera din källas produktionsdetaljer för sömlöst samarbete.
type: docs
weight: 340
url: /sv/net/aspose.words.bibliography/source/productioncompany/
---
## Source.ProductionCompany property

Hämtar eller ställer in produktionsbolaget för en källa.
