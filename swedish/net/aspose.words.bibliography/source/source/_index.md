...
description: Skapa enkelt en ny Source-klassinstans med vår konstruktor. Förenkla din kodningsprocess och förbättra ditt projekts effektivitet idag!
type: docs
weight: 10
url: /sv/net/aspose.words.bibliography/source/source/
---
## Source constructor

Initiera en ny instans av[`Source`](../) klass.
...
| --- | --- | --- |
| tag | String | Det identifierande taggnamnet. |
| sourceType | SourceType | Källtypen. |
