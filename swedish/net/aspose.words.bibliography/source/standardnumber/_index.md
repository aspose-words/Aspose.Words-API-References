...
description: Hantera egenskapen Source StandardNumber enkelt. Hämta eller ställ enkelt in standardnumret för sömlös dataintegration och noggrannhet.
type: docs
weight: 420
url: /sv/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

Hämtar eller ställer in standardnumret för en källa.
