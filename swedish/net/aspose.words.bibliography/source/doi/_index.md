...
description: Upptäck hur du effektivt hanterar DOI-egenskaper för sömlös hantering av digitala objektidentifierare. Öka din forsknings synlighet idag!
type: docs
weight: 190
url: /sv/net/aspose.words.bibliography/source/doi/
---
## Source.Doi property

Hämtar eller ställer in den digitala objektidentifieraren.
