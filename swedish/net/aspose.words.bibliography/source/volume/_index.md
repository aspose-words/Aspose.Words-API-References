...
description: Justera källvolymen enkelt för att förbättra din ljudupplevelse. Kontrollera ljudnivåerna för optimal klarhet och njutning i dina projekt.
type: docs
weight: 520
url: /sv/net/aspose.words.bibliography/source/volume/
---
## Source.Volume property

Hämtar eller ställer in volymen för en källa.
