...
description: Upptäck egenskapen Källtitel, hantera och anpassa enkelt dina källtitlar för förbättrad organisation och tydlighet i dina projekt.
type: docs
weight: 480
url: /sv/net/aspose.words.bibliography/source/title/
---
## Source.Title property

Hämtar eller anger titeln på en källa.
