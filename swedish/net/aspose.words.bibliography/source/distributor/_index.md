...
description: Upptäck egenskapen Källdistributör för att enkelt hantera och anpassa din källs distributörsinställningar för optimal prestanda.
type: docs
weight: 180
url: /sv/net/aspose.words.bibliography/source/distributor/
---
## Source.Distributor property

Hämtar eller ställer in distributören för en källa.
