...
description: Hantera din källstationsegenskap utan ansträngning. Ställ enkelt in eller hämta din källstation för sömlös dataintegration och förbättrad effektivitet.
type: docs
weight: 440
url: /sv/net/aspose.words.bibliography/source/station/
---
## Source.Station property

Hämtar eller ställer in källans station.
