...
description: Hantera Lcid-egenskapen utan ansträngning. Hämta eller ställ in ditt källkods språk-ID för sömlös lokalisering och förbättrad användarupplevelse.
type: docs
weight: 260
url: /sv/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

Hämtar eller anger språk-ID för en källa.
