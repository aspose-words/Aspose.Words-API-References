...
description: Upptäck hur du hanterar avhandlingstyper med egenskapen ThesisType. Hämta eller ställ enkelt in källavhandlingstyper för effektiv forskningshantering.
type: docs
weight: 470
url: /sv/net/aspose.words.bibliography/source/thesistype/
---
## Source.ThesisType property

Hämtar eller anger testypen för en källa.
