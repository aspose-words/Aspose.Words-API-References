...
description: Hantera din källårsegenskap utan ansträngning. Hämta eller ställ enkelt in året för en källa för effektiv dataorganisation och förbättrad noggrannhet.
type: docs
weight: 530
url: /sv/net/aspose.words.bibliography/source/year/
---
## Source.Year property

Hämtar eller ställer in året för en källa.
