...
description: Hantera din Source Reporter-egenskap utan ansträngning. Hämta eller ställ enkelt in rapporten för valfri källa och effektivisera din datahantering.
type: docs
weight: 390
url: /sv/net/aspose.words.bibliography/source/reporter/
---
## Source.Reporter property

Hämtar eller ställer in rapportören för en källa.
