...
description: Hantera enkelt din källas albumtitel med egenskapen AlbumTitle. Hämta eller ställ enkelt in titlar för bättre organisation och tillgänglighet.
type: docs
weight: 30
url: /sv/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

Hämtar eller ställer in albumtiteln för en källa.
