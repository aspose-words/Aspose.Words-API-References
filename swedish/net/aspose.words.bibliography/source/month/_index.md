...
description: Hantera din källmånadsegenskap utan ansträngning. Hämta eller ställ enkelt in månaden för valfri källa, vilket förbättrar din dataorganisation och effektivitet.
type: docs
weight: 280
url: /sv/net/aspose.words.bibliography/source/month/
---
## Source.Month property

Hämtar eller ställer in månaden för en källa.
