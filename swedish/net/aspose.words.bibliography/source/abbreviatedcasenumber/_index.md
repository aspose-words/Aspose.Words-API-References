...
description: Hantera enkelt din källas förkortade ärendenummer med vårt användarvänliga verktyg. Förenkla din ärendeuppföljning idag!
type: docs
weight: 20
url: /sv/net/aspose.words.bibliography/source/abbreviatedcasenumber/
---
## Source.AbbreviatedCaseNumber property

Hämtar eller ställer in det förkortade ärendenumret för en källa.
