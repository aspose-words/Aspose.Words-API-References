...
description: Upptäck en omfattande lista över bidragsgivare – författare, redaktörer och skribenter – för din källa. Förbättra din forskning med värdefulla insikter!
type: docs
weight: 120
url: /sv/net/aspose.words.bibliography/source/contributors/
---
## Source.Contributors property

Hämtar lista över bidragsgivare (författare, redaktör, skribent etc.) för en källa.
