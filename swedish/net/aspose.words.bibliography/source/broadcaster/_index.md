...
description: Upptäck egenskapen Source Broadcaster, hantera enkelt din källs sändare för förbättrad streamingkontroll och prestanda. Optimera din medieupplevelse!
type: docs
weight: 50
url: /sv/net/aspose.words.bibliography/source/broadcaster/
---
## Source.Broadcaster property

Hämtar eller ställer in sändaren för en källa.
