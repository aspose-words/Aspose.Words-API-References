...
description: Hantera källsidor utan ansträngning. Hämta eller ange enkelt information om källsidor för att förbättra din innehållsorganisation och effektivisera arbetsflödet.
type: docs
weight: 310
url: /sv/net/aspose.words.bibliography/source/pages/
---
## Source.Pages property

Hämtar eller ställer in sidorna för en källa.
