...
description: Hantera enkelt din källas sändningstitel med vår användarvänliga BroadcastTitle-egenskap. Förbättra ditt innehålls synlighet och engagemang idag!
type: docs
weight: 60
url: /sv/net/aspose.words.bibliography/source/broadcasttitle/
---
## Source.BroadcastTitle property

Hämtar eller ställer in sändningstiteln för en källa.
