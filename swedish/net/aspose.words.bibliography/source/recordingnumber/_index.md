...
description: Hantera dina inspelningar enkelt med egenskapen Source RecordingNumber – hämta eller uppdatera snabbt källinspelningsnummer för sömlös ljudhantering.
type: docs
weight: 370
url: /sv/net/aspose.words.bibliography/source/recordingnumber/
---
## Source.RecordingNumber property

Hämtar eller ställer in inspelningsnumret för en källa.
