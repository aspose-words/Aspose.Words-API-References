...
description: Hantera dina källdatum enkelt med Källdag. Ställ in eller hämta enkelt källdagar för att effektivisera ditt arbetsflöde och öka produktiviteten.
type: docs
weight: 150
url: /sv/net/aspose.words.bibliography/source/day/
---
## Source.Day property

Hämtar eller ställer in dagen för en källa.
