...
description: Upptäck Source Court-lösningar för fastigheter. Hantera och konfigurera enkelt dina domstolskällor för effektiva juridiska processer och ökad effektivitet.
type: docs
weight: 140
url: /sv/net/aspose.words.bibliography/source/court/
---
## Source.Court property

Hämtar eller ställer in källans hov.
