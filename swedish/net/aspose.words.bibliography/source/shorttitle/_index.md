...
description: Hantera din källkods korta titel utan ansträngning. Hämta eller ställ enkelt in egenskapen ShortTitle för effektiv organisation och förbättrad tydlighet.
type: docs
weight: 400
url: /sv/net/aspose.words.bibliography/source/shorttitle/
---
## Source.ShortTitle property

Hämtar eller ställer in den korta titeln på en källa.
