...
description: Hantera din källas åtkomstmånad enkelt. Ställ enkelt in eller hämta den åtkomna månaden för optimal dataspårning och organisation.
type: docs
weight: 290
url: /sv/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

Hämtar eller ställer in den månad då en källa åtkom.
