...
description: Hantera din käll-URL utan ansträngning. Ställ in eller hämta URL:er enkelt, vilket förbättrar din datahantering och effektiviserar ditt arbetsflöde.
type: docs
weight: 500
url: /sv/net/aspose.words.bibliography/source/url/
---
## Source.Url property

Hämtar eller anger URL:en till en källa.
