...
description: Hantera din källårsåtkomst-egenskap enkelt. Hämta eller ställ in det åtkomna året för korrekta citat och effektiv forskningshantering.
type: docs
weight: 540
url: /sv/net/aspose.words.bibliography/source/yearaccessed/
---
## Source.YearAccessed property

Hämtar eller ställer in året då en källa öppnades.
