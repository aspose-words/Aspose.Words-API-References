...
description: Hantera källvolymer enkelt. Justera volymantalet för optimal källhantering och förbättra din dataorganisation utan ansträngning.
type: docs
weight: 300
url: /sv/net/aspose.words.bibliography/source/numbervolumes/
---
## Source.NumberVolumes property

Hämtar eller ställer in antalet volymer för en källa.
