...
description: Hantera din källguide-egenskap enkelt. Hämta eller ställ enkelt in GUID för effektiv datahantering och förbättrad organisation.
type: docs
weight: 210
url: /sv/net/aspose.words.bibliography/source/guid/
---
## Source.Guid property

Hämtar eller ställer in guid för en källkod.
