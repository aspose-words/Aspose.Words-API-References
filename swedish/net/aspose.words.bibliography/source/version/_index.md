...
description: Hantera din källversion utan ansträngning. Ställ in eller hämta versionen enkelt för förbättrad kontroll och effektivitet i dina projekt.
type: docs
weight: 510
url: /sv/net/aspose.words.bibliography/source/version/
---
## Source.Version property

Hämtar eller anger versionen av en källa.
