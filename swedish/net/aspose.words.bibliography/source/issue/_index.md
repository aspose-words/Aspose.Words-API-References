...
description: Hantera dina källproblem utan ansträngning. Hämta eller ställ enkelt in källegenskaper för att effektivisera ditt arbetsflöde och öka produktiviteten.
type: docs
weight: 240
url: /sv/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

Hämtar eller ställer in problemet för en källa.
