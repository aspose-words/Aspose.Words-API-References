...
description: Hantera enkelt dina patentdata med egenskapen Source PatentNumber. Hämta eller uppdatera enkelt patentnummer för effektiv källspårning.
type: docs
weight: 320
url: /sv/net/aspose.words.bibliography/source/patentnumber/
---
## Source.PatentNumber property

Hämtar eller ställer in patentnumret för en källa.
