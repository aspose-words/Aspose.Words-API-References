...
description: Upptäck klassen Aspose.Words.Bibliography.Person för att hantera enskilda bidragsgivare i bibliografier. Förbättra ditt dokuments citeringsnoggrannhet!
type: docs
weight: 180
url: /sv/net/aspose.words.bibliography/person/
---
## Person class

Representerar en individuell (person) bidragsgivare till bibliografikällan.
...
| namn | Beskrivning |
| --- | --- |
| [Person](person/)(*string, string, string*) | Initiera en ny instans av`Person` klass. |

## Egenskaper

| namn | Beskrivning |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Hämtar eller anger förnamnet på en person. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Hämtar eller ställer in en persons efternamn. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Hämtar eller ställer in en persons mellannamn. |
