...
description: Skapa enkelt en ny Person-instans med vår användarvänliga konstruktor. Förenkla din kodning och förbättra dina projekt idag!
type: docs
weight: 10
url: /sv/net/aspose.words.bibliography/person/person/
---
## Person constructor

Initiera en ny instans av[`Person`](../) klass.
...
| --- | --- | --- |
| last | String | Efternamnet. |
| first | String | Efternamnet. |
| middle | String | Efternamnet. |
