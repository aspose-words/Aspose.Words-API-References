...
description: Upptäck Aspose.Words.Bibliography.SourceType-enum för olika typer av bibliografikällor. Förbättra din dokumenthantering med kraftfulla funktioner!
type: docs
weight: 210
url: /sv/net/aspose.words.bibliography/sourcetype/
---
## SourceType enumeration

Representerar källtyper för bibliografi.
...
| --- | --- | --- |
| ArticleInAPeriodical | `0` | Anger artikeln i en periodisk källa. |
| Book | `1` | Anger bokens källa. |
| BookSection | `2` | Anger källan för bokavsnittet. |
| JournalArticle | `3` | Anger källan för tidskriftsartikeln. |
| ConferenceProceedings | `4` | Anger källan för konferensprotokollet. |
| Report | `5` | Anger rapportörens källa. |
| SoundRecording | `6` | Anger ljudinspelningskällan. |
| Performance | `7` | Anger prestandakällan. |
| Art | `8` | Anger källan till bilden. |
| DocumentFromInternetSite | `9` | Anger dokumentet från webbplatsens källa. |
| InternetSite | `10` | Anger webbplatsens källa. |
| Film | `11` | Anger filmkällan. |
| Interview | `12` | Anger intervjukällan. |
| Patent | `13` | Anger patentkällan. |
| Electronic | `14` | Anger den elektroniska källan. |
| Case | `15` | Anger ärendets källa. |
| Misc | `16` | Anger den diverse källan. |
