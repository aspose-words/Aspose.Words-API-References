...
description: Få åtkomst till eller ändra en specifik person i PersonCollection via index. Förenkla datahanteringen med denna viktiga egenskap för effektiv kodning!
type: docs
weight: 30
url: /sv/net/aspose.words.bibliography/personcollection/item/
---
## PersonCollection indexer

Hämtar eller ställer in en person vid det angivna indexet.
