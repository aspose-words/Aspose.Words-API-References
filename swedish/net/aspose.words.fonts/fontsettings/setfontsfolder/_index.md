...
description: Ställer in mappen där Aspose.Words söker efter TrueType-teckensnitt vid rendering av dokument eller inbäddning av teckensnitt. Detta är en genväg tillSetFontsFoldersaspose.words.fonts/fontsettings/setfontsfolders för att endast ställa in en teckensnittskatalog.
type: docs
weight: 80
