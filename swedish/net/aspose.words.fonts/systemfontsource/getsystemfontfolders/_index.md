...
description: Upptäck GetSystemFontFolders-metoden i SystemFontSource. Få enkelt åtkomst till systemteckensnittsmappar eller få en tom array om den inte är tillgänglig.
type: docs
weight: 30
...
Returnerar systemfontmappar eller en tom array om mapparna inte är tillgängliga.
...
På vissa plattformar kan Aspose.Words söka efter systemteckensnitt inte bara via mappar utan även i andra källor. Till exempel, på Windows-plattformen söker Aspose.Words även efter teckensnitt i registret.
