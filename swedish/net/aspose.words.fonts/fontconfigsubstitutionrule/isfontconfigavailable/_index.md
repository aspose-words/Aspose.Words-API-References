...
description: Ta reda på om verktyget FontConfig är tillgängligt med metoden IsFontConfigAvailable. Säkerställ optimal teckensnittshantering för dina applikationer.
type: docs
weight: 20
