...
description: Får underliggande värdeegenskap som ofta representerar kontrolltillstånd. Till exempel har markerad alternativknapp 1-värde medan omarkerad har 0. Standardvärdet är en tom sträng.
type: docs
weight: 60
