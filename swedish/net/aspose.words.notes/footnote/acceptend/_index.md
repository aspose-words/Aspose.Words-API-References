...
description: Upptäck metoden Footnote AcceptEnd, utformad för att förbättra användarupplevelsen genom att smidigt hantera fotnotsbesök. Förbättra navigeringen idag!
type: docs
weight: 90
url: /sv/net/aspose.words.notes/footnote/acceptend/
---
## Footnote.AcceptEnd method

Accepterar en besökare för att besöka slutet av fotnoten.
