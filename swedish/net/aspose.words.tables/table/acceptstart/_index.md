...
description: Upptäck Table AcceptStart-metoden för att smidigt välkomna besökare vid bordets början, vilket förbättrar användarupplevelsen och engagemanget.
type: docs
weight: 370
url: /sv/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Accepterar en besökare för att besöka början av bordet.
