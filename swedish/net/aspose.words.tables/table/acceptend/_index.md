...
description: Upptäck Table AcceptEnd-metoden, integrera sömlöst besökare vid bordets ände för förbättrad användarupplevelse och effektiv datahantering.
type: docs
weight: 360
url: /sv/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

Accepterar en besökare för att besöka slutet av bordet.
