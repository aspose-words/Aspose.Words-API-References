...
description: Upptäck egenskapen Row NodeType som effektivt returnerar raddata, vilket förbättrar din datahantering och förbättrar applikationens prestanda.
type: docs
weight: 80
