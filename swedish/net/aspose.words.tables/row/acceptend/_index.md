...
description: Upptäck Row AcceptEnd-metoden för att förbättra din besökarupplevelse genom att sömlöst vägleda dem till slutet av raden. Öka engagemanget idag!
type: docs
weight: 130
url: /sv/net/aspose.words.tables/row/acceptend/
---
## Row.AcceptEnd method

Accepterar en besökare för att besöka slutet av raden.
