...
description: Upptäck PreferredWidth ToString-metoden, som genererar en användarvänlig sträng som visar ditt objekts värde för ökad tydlighet och användbarhet.
type: docs
weight: 80
