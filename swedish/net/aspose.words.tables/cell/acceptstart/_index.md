...
description: Upptäck Cell AcceptStart-metoden för att smidigt välkomna besökare till din cells ingångspunkt, vilket förbättrar användarupplevelsen och engagemanget.
type: docs
weight: 150
url: /sv/net/aspose.words.tables/cell/acceptstart/
---
## Cell.AcceptStart method

Accepterar en besökare för att besöka början av cellen.
