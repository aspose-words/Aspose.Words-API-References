...
description: Upptäck Cell-konstruktorn för att enkelt skapa nya Cell-klassinstanser. Effektivisera din kodningsprocess och förbättra din utvecklingseffektivitet!
type: docs
weight: 10
...
Initierar en ny instans av[`Cell`](../) klass.
...
När[`Cell`](../) skapas, tillhör den det angivna dokumentet, men är ännu inte en del av dokumentet och[`ParentNode`](../../../aspose.words/node/parentnode/) är`null`.
