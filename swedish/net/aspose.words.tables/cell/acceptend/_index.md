...
description: Upptäck Cell AcceptEnd-metoden för att sömlöst hantera besökares åtkomst vid cellslutpunkter, vilket förbättrar användarupplevelsen och optimerar flödet.
type: docs
weight: 140
url: /sv/net/aspose.words.tables/cell/acceptend/
---
## Cell.AcceptEnd method

Accepterar en besökare för att besöka slutet av cellen.
