...
description: Upptäck egenskapen Cell IsFirstCell, identifiera enkelt den första cellen i raden och förbättra din dataorganisation och effektivitet.
type: docs
weight: 40
...
Sant om detta är den första cellen i en rad; annars falskt.
