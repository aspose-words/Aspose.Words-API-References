...
description: Aspose.Words.InlineStory klass. Basklass för noder på inlinenivå som kan innehålla stycken och tabeller.
type: docs
weight: 3070
...
De klasser som härrör från **InlineStory** är noder på inline-nivå som kan innehålla sin egen text (stycken och tabeller). Till exempel, en **Kommentar** noden innehåller text av en kommentar och en **Fotnot** innehåller text till en fotnot.
