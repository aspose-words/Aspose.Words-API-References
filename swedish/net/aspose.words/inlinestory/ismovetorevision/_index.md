...
description: Upptäck InlineStorys IsMoveToRevision-egenskap, spåra enkelt ändringar i Microsoft Word med sant/falskt-status för sömlös dokumentredigering.
type: docs
weight: 60
