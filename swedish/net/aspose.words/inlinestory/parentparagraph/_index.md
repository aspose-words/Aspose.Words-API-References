...
description: Upptäck InlineStory ParentParagraph-egenskapen för att enkelt komma åt överordnat stycke för valfri nod, vilket förbättrar din innehållshanteringsupplevelse.
type: docs
weight: 90
url: /sv/net/aspose.words/inlinestory/parentparagraph/
---
## InlineStory.ParentParagraph property

Hämtar föräldern[`Paragraph`](../../paragraph/) av denna nod.
