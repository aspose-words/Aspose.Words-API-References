...
description: Upptäck egenskapen ConditionalStyle TopPadding för att enkelt justera utrymmet ovanför tabellcellernas innehåll, vilket förbättrar layout och läsbarhet för bättre design.
type: docs
weight: 80
