...
description: Upptäck egenskapen ConditionalStyle RightPadding för att enkelt justera cellavståndet i tabellen. Förbättra din layout med exakt kontroll för bättre design.
type: docs
weight: 60
