...
description: Upptäck egenskapen ConditionalStyle Type som definierar det relaterade tabellområdet, vilket förbättrar din designflexibilitet och stilhantering.
type: docs
weight: 90
...
Hämtar tabellområdet som denna villkorsstyrda stil relaterar till.
