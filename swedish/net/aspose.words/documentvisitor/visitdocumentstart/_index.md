...
description: Upptäck VisitDocumentStart-metoden i DocumentVisitor. Förbättra din dokumenthantering med effektiva uppräkningsfunktioner för optimal prestanda.
type: docs
weight: 150
url: /sv/net/aspose.words/documentvisitor/visitdocumentstart/
---
## DocumentVisitor.VisitDocumentStart method

Anropas när uppräkningen av dokumentet har påbörjats.
...
| --- | --- | --- |
| doc | Document | Objektet som besöks. |
