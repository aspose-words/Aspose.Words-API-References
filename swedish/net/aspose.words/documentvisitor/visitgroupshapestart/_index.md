...
description: Upptäck DocumentVisitor VisitGroupShapeStart-metoden, avgörande för effektiv uppräkning av gruppformer i dina applikationer. Förbättra ditt kodningsarbetsflöde idag!
type: docs
weight: 270
...
Anropas när uppräkningen av en gruppform har påbörjats.
