...
description: Upptäck DocumentVisitor VisitSectionStart-metoden, viktig för att spåra sektionsuppräkning. Förbättra din kodningseffektivitet med detta kraftfulla verktyg!
type: docs
weight: 380
url: /sv/net/aspose.words/documentvisitor/visitsectionstart/
---
## DocumentVisitor.VisitSectionStart method

Anropas när uppräkningen av ett avsnitt har påbörjats.
...
| --- | --- | --- |
| section | Section | Objektet som besöks. |
