...
description: Upptäck VisitCellStart-metoden i DocumentVisitor, avgörande för att effektivt hantera uppräkning av tabellceller. Förbättra dina kodningskunskaper idag!
type: docs
weight: 90
...
Anropas när uppräkningen av en tabellcell har påbörjats.
