...
description: Utforska DocumentVisitors VisitSubDocument-metod, utformad för effektiv hantering av underdokument i dina applikationer. Öka din kodningseffektivitet!
type: docs
weight: 480
...
Anropas när ett deldokument påträffas.
...
| --- | --- | --- |
| subDocument | SubDocument | Objektet som besöks. |
