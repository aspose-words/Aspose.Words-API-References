...
description: Upptäck DocumentVisitor VisitBodyStart-metoden – avgörande för att effektivt räkna upp huvudtexter i dina avsnitt. Förbättra ditt kodningsarbetsflöde idag!
type: docs
weight: 30
url: /sv/net/aspose.words/documentvisitor/visitbodystart/
---
## DocumentVisitor.VisitBodyStart method

Anropas när uppräkningen av huvudtextens berättelse i ett avsnitt har påbörjats.
