...
description: Konvertera enkelt din RunCollection till en array med ToArray-metoden, vilket säkerställer sömlös datahantering och förbättrad prestanda.
type: docs
weight: 20
...
Kopierar alla körningar från samlingen till en ny array med körningar.
