...
description: Returnerar eller ställer in ett alias eller redigeringsgrupp som ska användas för att avgöra om den aktuella användaren ska tillåtas redigera detta redigerbara intervall.
type: docs
weight: 30
