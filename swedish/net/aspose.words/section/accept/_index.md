...
description: Upptäck Section Accept-metoden för att förbättra besökarnas engagemang och effektivisera interaktioner. Förbättra din webbplats prestanda idag!
type: docs
weight: 70
...
Samtal[`VisitSectionStart`](../../documentvisitor/visitsectionstart/) , ringer sedan[`Accept`](../../node/accept/) för alla underordnade noder till section och anrop[`VisitSectionEnd`](../../documentvisitor/visitsectionend/) i slutet.
