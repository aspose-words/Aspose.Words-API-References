...
description: Representerar en revision spårad ändring i en dokumentnod eller stil. AnvändRevisionType./revision/revisiontype för att kontrollera typen av denna version.
type: docs
weight: 4500
