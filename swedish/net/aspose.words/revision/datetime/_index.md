...
description: Hantera din revisionsdatum- och tidtabell enkelt. Hämta eller ställ enkelt in datum och tid för revisioner för förbättrad spårning och organisation.
type: docs
weight: 20
...
Hämtar eller ställer in datum/tid för denna revision.
