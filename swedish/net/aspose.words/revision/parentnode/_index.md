...
description: Upptäck egenskapen Revision ParentNode, som identifierar den direkta föräldranoden för alla revisionstyper – förutom StyleDefinitionChange. Öka din kodningseffektivitet!
type: docs
weight: 40
...
Hämtar den omedelbara föräldranoden (ägaren) för denna revision. Den här egenskapen fungerar för alla revisionstyper utomStyleDefinitionChange .
...
Om denna revision avser en ändring av stilformatering, använd[`ParentStyle`](../parentstyle/) istället.
