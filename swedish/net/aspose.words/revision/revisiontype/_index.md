...
description: Upptäck egenskapen RevisionType för att enkelt komma åt och förstå typen av varje revision, vilket förbättrar ditt arbetsflöde och din projektledningseffektivitet.
type: docs
weight: 60
...
Hämtar typen av denna revision.
