...
description: Upptäck klassen Aspose.Words.CompositeNode, ditt viktiga verktyg för att skapa komplexa dokumentstrukturer med lätthet och effektivitet.
type: docs
weight: 500
...
* Ger åtkomst till undernoderna.
* Implementerar sammansatta operationer som att infoga och ta bort underordnade.
