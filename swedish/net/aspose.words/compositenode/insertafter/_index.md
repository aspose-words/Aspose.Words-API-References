...
description: CompositeNode InsertAfter metod. Infogar den angivna noden omedelbart efter den angivna referensnoden i C#.
type: docs
weight: 130
...
| refChild | Node | De[`Node`](../../node/) det är referensnoden. De*newChild* placeras efter*refChild*. |
