...
description: CompositeNode InsertBefore metod. Infogar den angivna noden omedelbart före den angivna referensnoden i C#.
type: docs
weight: 140
...
| --- | --- | --- |
| newChild | Node | De[`Node`](../../node/) att sätta in. |
| refChild | Node | De[`Node`](../../node/) det är referensnoden. De*newChild* placeras före denna nod. |
...
Om*refChild* är`null` , infogar*newChild* i slutet av listan över underordnade noder.
