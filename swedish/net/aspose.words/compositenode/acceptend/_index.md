...
description: Upptäck hur du kan förbättra dokumenthanteringen med CompositeNodes AcceptEnd-metod. Effektivisera implementeringen av besöksmönster för optimal prestanda.
type: docs
weight: 60
...
När den implementeras i en härledd klass, anropas VisitXXXEnd-metoden för den angivna dokumentbesökaren.
