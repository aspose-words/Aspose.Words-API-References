...
description: Upptäck egenskapen EditableRangeStart NodeType – förbättra din dokumentredigering med sömlös områdeshantering och förbättrad användarupplevelse!
type: docs
weight: 30
url: /sv/net/aspose.words/editablerangestart/nodetype/
---
## EditableRangeStart.NodeType property

ReturerEditableRangeStart .
