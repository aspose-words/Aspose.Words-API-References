...
description: Upptäck WarningInfoCollection-metoden som förbättrar din applikation genom att implementera IWarningCallback, och enkelt lägga till varningar i din samling.
type: docs
weight: 60
...
Implementerar[`IWarningCallback`](../../iwarningcallback/) gränssnitt. Lägger till en varning i den här samlingen.
