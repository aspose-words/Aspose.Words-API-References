...
description: Hämtar eller ställer in instruktioner till undertecknaren som visas när signaturraden signeras. Standardvärdet för den här egenskapen är tom sträng Empty .
type: docs
weight: 50
