...
description: Upptäck metoden Paragraph AcceptEnd, utformad för att förbättra dokumentnavigering genom att effektivt acceptera besökare i slutet av stycken.
type: docs
weight: 240
url: /sv/net/aspose.words/paragraph/acceptend/
---
## Paragraph.AcceptEnd method

Accepterar en besökare för att besöka slutet av dokumentets stycke.
