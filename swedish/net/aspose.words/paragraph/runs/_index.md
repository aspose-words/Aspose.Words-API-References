...
description: Upptäck egenskapen Styckekörningar för enkel åtkomst till formaterade textsamlingar inom stycken, vilket förbättrar dokumentets struktur och läsbarhet.
type: docs
weight: 220
...
Ger åtkomst till den maskinskrivna samlingen av textbitar inuti stycket.
