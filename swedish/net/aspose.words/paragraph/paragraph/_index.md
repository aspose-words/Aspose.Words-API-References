...
description: Skapa dynamiskt innehåll enkelt med vår styckekonstruktor. Initiera och anpassa enkelt din styckeklass för förbättrad läsbarhet.
type: docs
weight: 10
...
Initierar en ny instans av[`Paragraph`](../) klass.
...
När[`Paragraph`](../) skapas, tillhör den det angivna dokumentet, men är ännu inte en del av dokumentet och[`ParentNode`](../../node/parentnode/) är`null`.

Att lägga till[`Paragraph`](../) till dokumentanvändningen[`InsertAfter`](../../compositenode/insertafter/) eller[`InsertBefore`](../../compositenode/insertbefore/) på artikeln där du vill infoga stycket.
