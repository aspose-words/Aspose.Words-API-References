...
description: Upptäck metoden Paragraph AcceptStart för att smidigt välkomna besökare i början av dokumentets stycken för ökat engagemang.
type: docs
weight: 250
url: /sv/net/aspose.words/paragraph/acceptstart/
---
## Paragraph.AcceptStart method

Accepterar en besökare för att besöka början av dokumentets stycke.
