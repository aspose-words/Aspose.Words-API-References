...
description: Anger uppsättningen av möjliga alias eller redigeringsgrupper som kan användas som alias för att avgöra om den aktuella användaren ska tillåtas redigera ett enstaka intervall definierat av ett redigerbart intervall inom ett dokument.
type: docs
weight: 1300
