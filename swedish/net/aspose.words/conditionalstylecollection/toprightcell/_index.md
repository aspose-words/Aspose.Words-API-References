...
description: Upptäck ConditionalStyleCollections TopRightCell-egenskap för att enkelt anpassa dina cellformat för övre högra celler för förbättrad datapresentation.
type: docs
weight: 140
url: /sv/net/aspose.words/conditionalstylecollection/toprightcell/
---
## ConditionalStyleCollection.TopRightCell property

Hämtar cellformatet överst till höger.
