...
description: Upptäck ConditionalStyleCollections BottomLeftCell-egenskap för att enkelt anpassa dina cellstilar längst ner till vänster för förbättrad visuell tilltalning.
type: docs
weight: 10
url: /sv/net/aspose.words/conditionalstylecollection/bottomleftcell/
---
## ConditionalStyleCollection.BottomLeftCell property

Hämtar cellformatet längst ner till vänster.
