...
description: Upptäck egenskapen ConditionalStyleCollection FirstColumn för att enkelt anpassa stilen för din första kolumn för förbättrad designflexibilitet och användarupplevelse.
type: docs
weight: 60
