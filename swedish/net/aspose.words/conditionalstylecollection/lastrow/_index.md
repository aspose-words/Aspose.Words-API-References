...
description: Upptäck LastRow-egenskapen i ConditionalStyleCollection för att enkelt anpassa den sista radens stil för förbättrad visuell attraktionskraft i din applikation.
type: docs
weight: 100
...
Hämtar stilen för den sista raden.
