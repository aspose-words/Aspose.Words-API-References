...
description: Font fast egendom. Anger om innehållet i denna körning ska behandlas som komplex skripttext oavsett deras Unicodeteckenvärden när formateringen för denna körning bestäms.
type: docs
weight: 80
