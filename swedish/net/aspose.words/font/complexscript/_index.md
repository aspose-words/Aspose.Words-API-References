...
description: Anger om innehållet i denna körning ska behandlas som komplex skripttext oavsett deras Unicode-teckenvärden när formateringen för denna körning bestäms.
type: docs
weight: 80
