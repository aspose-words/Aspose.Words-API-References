...
description: Ta enkelt bort dokumentvariabler med hjälp av metoden VariableCollection Remove. Effektivisera din datahantering med denna effektiva lösning.
type: docs
weight: 80
...
| --- | --- | --- |
| name | String | Variabelns namn, som inte är skiftlägeskänsligt. |
