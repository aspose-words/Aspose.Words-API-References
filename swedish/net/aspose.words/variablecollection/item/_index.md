...
description: Hämtar eller ställer in en dokumentvariabel med det skiftlägesokänsliga namnet. nullvärden är inte tillåtna som höger sida av tilldelningen och kommer att ersättas av en tom sträng.
type: docs
weight: 20
