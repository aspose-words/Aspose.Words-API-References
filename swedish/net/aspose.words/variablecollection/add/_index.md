...
description: Upptäck hur du effektivt lägger till dokumentvariabler i din VariableCollection med vår lättförståeliga guide. Förbättra din datahantering idag!
type: docs
weight: 30
...
| --- | --- | --- |
| name | String | Det skiftlägeskänsliga namnet på den variabel som ska läggas till. |
| value | String | Variabelns värde. Värdet kan inte vara`null`, om värdet är null kommer en tom sträng att användas istället. |
