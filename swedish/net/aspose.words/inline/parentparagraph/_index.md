...
description: Upptäck egenskapen Inline ParentParagraph för att enkelt komma åt överordnat stycke för valfri nod, vilket förbättrar din kodningseffektivitet och struktur.
type: docs
weight: 70
