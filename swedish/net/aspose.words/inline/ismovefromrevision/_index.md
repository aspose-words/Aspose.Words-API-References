...
description: Upptäck egenskapen Inline IsMoveFromRevision i Microsoft Word. Lär dig hur den spårar borttagna objekt för effektiv dokumenthantering och redigering.
type: docs
weight: 50
