...
description: Upptäck egenskapen Inline IsDeleteRevision i Microsoft Word, som indikerar om ett objekt togs bort under ändringsspårning. Förbättra din dokumenthantering!
type: docs
weight: 20
