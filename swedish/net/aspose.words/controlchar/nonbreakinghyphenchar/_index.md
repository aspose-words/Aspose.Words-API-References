...
description: Upptäck NonBreaking HyphenChar i Microsoft Word. Förbättra dina dokument med sömlöst textflöde med char30 för professionella resultat.
type: docs
weight: 160
...
Hårdt bindestreck i Microsoft Word är (char)30.
...
Hårdt bindestreck i Microsoft Word motsvarar inte det hårda bindestrecket i Unicode-tecknet U+2011 utan representerar istället intern information som anger att Microsoft Word ska visa ett bindestreck och inte bryta en rad.

Användbar information: http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks.
