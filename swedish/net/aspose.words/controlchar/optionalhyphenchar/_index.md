...
description: Upptäck hur du använder det valfria bindestrecket i Microsoft Word (char31) för att förbättra formateringen och läsbarheten i ditt dokument. Läs mer nu!
type: docs
weight: 190
...
Valfritt bindestreck i Microsoft Word är (char)31.
...
Valfritt bindestreck i Microsoft Word motsvarar inte Unicode-tecknet U+00AD mjukt bindestreck. Istället infogar det intern information som informerar Word om en möjlig bindestreckpunkt.
