...
description: Upptäck ControlChar CellChar-fältet för sömlös tabellhantering. Förbättra din dataorganisation med effektiva tecken för cellslut och rader.
type: docs
weight: 20
...
Slutet av en tabellcell eller slutet av en tabellrad tecken: (char)7 eller "\a".
