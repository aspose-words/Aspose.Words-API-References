...
description: Upptäck fältet ControlChar LineBreakChar, hantera enkelt radbrytningar med char11 eller v för smidigare textformatering och förbättrad läsbarhet.
type: docs
weight: 130
...
Radbrytningstecken: (char)11 eller "\v".
