...
description: Upptäck fältet ControlChar SectionBreakChar och optimera din dokumentformatering med det viktiga avsnittsslutstecknet för ett smidigt textflöde.
type: docs
weight: 250
...
Tecken för slutet av avsnittet: (char)12 eller "\f".
