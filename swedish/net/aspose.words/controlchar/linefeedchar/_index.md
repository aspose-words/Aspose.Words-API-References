...
description: Upptäck fältet ControlChar LineFeedChar – optimera din textbehandling med det viktiga radmatningstecknet (char10 eller n) för sömlös datahantering.
type: docs
weight: 150
url: /sv/net/aspose.words/controlchar/linefeedchar/
---
## ControlChar.LineFeedChar field

Radmatningstecken: (char)10 eller "\n".
