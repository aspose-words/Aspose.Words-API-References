...
description: Upptäck fältet ControlChar SectionBreak, hantera dokumentavsnitt effektivt med tecknet x000c, vilket förbättrar formatering och läsbarhet.
type: docs
weight: 240
...
Sluttecken för avsnitt: "\x000c" eller "\f". Observera att det har samma värde som[`PageBreak`](../pagebreak/) .
