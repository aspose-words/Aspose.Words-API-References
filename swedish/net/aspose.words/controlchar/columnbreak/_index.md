...
description: Upptäck fältet ControlChar ColumnBreak och effektivisera din dokumentlayout med tecknet x000e för kolumnslut för förbättrad formateringskontroll.
type: docs
weight: 30
