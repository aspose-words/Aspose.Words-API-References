...
description: Upptäck hur ControlChar FieldSeparatorChar förbättrar datahanteringen genom att effektivt separera fältkoder från värden, vilket optimerar ditt arbetsflöde utan ansträngning.
type: docs
weight: 90
...
Fältavgränsare separerar fältkod från fältvärde. Valfritt i vissa fält. Värde: (char)20.
