...
description: Upptäck fältet ControlChar ParagraphBreak. Hantera enkelt styckebrytningar med tecknet x000d för sömlös textformatering och förbättrad läsbarhet.
type: docs
weight: 220
...
Sluttecken för stycke: "\x000d" eller "\r". Samma som[`Cr`](../cr/)
