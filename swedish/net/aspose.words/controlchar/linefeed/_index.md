...
description: Upptäck fältet ControlChar LineFeed, förstå radmatningstecknet (x000a) för sömlös textformatering och förbättrad datahantering.
type: docs
weight: 140
url: /sv/net/aspose.words/controlchar/linefeed/
---
## ControlChar.LineFeed field

Radmatningstecken: "\x000a" eller "\n". Samma som[`Lf`](../lf/) .
