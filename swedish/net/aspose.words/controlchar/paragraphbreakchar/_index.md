...
description: Upptäck fältet ControlChar ParagraphBreakChar och effektivisera din textformatering med det viktiga styckeslutstecknet för effektiv dokumentredigering.
type: docs
weight: 230
...
Sluttecken för stycke: (char)13 eller "\r".
