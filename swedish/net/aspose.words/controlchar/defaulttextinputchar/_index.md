...
description: Upptäck fältet ControlChar DefaultTextInputChar, med tecknet 'o' som den perfekta standarden för dina textinmatningsformulär. Förbättra användarupplevelsen!
type: docs
weight: 70
...
Detta är tecknet "o" som används som standardvärde i textinmatningsfält.
