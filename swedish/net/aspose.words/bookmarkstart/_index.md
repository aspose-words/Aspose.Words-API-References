...
description: Representerar början på ett bokmärke i ett Worddokument.
type: docs
weight: 60
...
| namn | Beskrivning |
| --- | --- |
| [BookmarkStart](bookmarkstart/)(DocumentBase, string) | Initierar en ny instans av`BookmarkStart` class. |
