...
description: Upptäck SpecialChar GetText-metoden för att enkelt hämta specialtecken för förbättrad textbehandling i dina applikationer. Frigör dess potential idag!
type: docs
weight: 30
...
Hämtar specialtecknet som denna nod representerar.
...
Strängen som innehåller tecknet som den här noden representerar.
