...
description: Upptäck metoden RevisionCollection Reject för att effektivt filtrera bort oönskade revisioner baserat på dina kriterier för effektiv projektledning.
type: docs
weight: 70
url: /sv/net/aspose.words/revisioncollection/reject/
---
## RevisionCollection.Reject method

Avvisar revisioner som matchar angivna kriterier.
