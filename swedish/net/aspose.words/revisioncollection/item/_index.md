...
description: Få enkel åtkomst till specifika revisioner med egenskapen RevisionCollection Item. Hämta snabbt revisioner via index för effektiv datahantering.
type: docs
weight: 30
...
Returnerar en[`Revision`](../../revision/) vid det angivna indexet.
