...
När[`CommentRangeStart`](../../commentrangestart) skapas, det tillhör det angivna dokumentet, men är inte ännu en del av dokumentet och[`ParentNode`](../../node/parentnode) är inget.

Att lägga till en[`CommentRangeStart`](../../commentrangestart) till dokumentet använd InsertAfter eller InsertBefore på stycket där du vill infoga kommentaren.
