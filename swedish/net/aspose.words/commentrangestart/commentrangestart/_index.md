...
description: Upptäck CommentRangeStart-konstruktorn. Skapa enkelt nya instanser av den här klassen för förbättrad kodningseffektivitet och strömlinjeformad utveckling.
type: docs
weight: 10
...
| id | Int32 | Kommentar-ID:n som det här objektet är länkat till. |

## Anmärkningar

När[`CommentRangeStart`](../) skapas, tillhör den det angivna dokumentet, men är ännu inte en del av dokumentet och[`ParentNode`](../../node/parentnode/) är`null`.

Att lägga till en[`CommentRangeStart`](../) i dokumentet, använd InsertAfter eller InsertBefore på stycket där du vill infoga kommentaren.
