...
description: Upptäck Aspose.Words.RevisionType-enum för att effektivt spåra och hantera dokumentändringar. Förbättra din dokumentredigering med precision!
type: docs
weight: 5540
...
Anger vilken typ av ändring som spåras i[`Revision`](../revision/) .
...
| --- | --- | --- |
| Insertion | `0` | Nytt innehåll har lagts till i dokumentet. |
| Deletion | `1` | Innehållet togs bort från dokumentet. |
| FormatChange | `2` | Formateringsändring tillämpades på den överordnade noden. |
| StyleDefinitionChange | `3` | Formateringsändring tillämpades på den överordnade stilen. |
| Moving | `4` | Innehållet i dokumentet flyttades. |
