...
description: Upptäck HeaderFooter AcceptStart-metoden, utformad för att smidigt välkomna besökare i början av sidhuvudet, vilket förbättrar användarupplevelsen och engagemanget.
type: docs
weight: 90
url: /sv/net/aspose.words/headerfooter/acceptstart/
---
## HeaderFooter.AcceptStart method

Accepterar en besökare för att besöka början av rubriken.
