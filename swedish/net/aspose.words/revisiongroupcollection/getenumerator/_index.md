...
description: Upptäck metoden GetEnumerator i RevisionGroupCollection – hämta effektivt uppräknarobjekt för effektiv datahantering och förbättrad prestanda.
type: docs
weight: 30
