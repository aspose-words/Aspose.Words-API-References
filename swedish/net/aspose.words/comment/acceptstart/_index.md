...
description: Upptäck AcceptStart-metoden för att smidigt välkomna besökare i början av kommentarer, vilket förbättrar användarengagemang och interaktion.
type: docs
weight: 150
url: /sv/net/aspose.words/comment/acceptstart/
---
## Comment.AcceptStart method

Accepterar en besökare för att besöka början av kommentaren.
