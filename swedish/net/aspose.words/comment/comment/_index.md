...
description: Skapa engagerande kommentarer enkelt med vår kommentarkonstruktor. Initiera en ny kommentarklassinstans och förbättra användarinteraktionen sömlöst!
type: docs
weight: 10
...
Initierar en ny instans av[`Comment`](../) klass.
...
När[`Comment`](../) skapas, tillhör den det angivna dokumentet, men är ännu inte en del av dokumentet och[`ParentNode`](../../node/parentnode/) är`null`.

Att lägga till[`Comment`](../) till dokumentanvändningen[`InsertAfter`](../../compositenode/insertafter/) eller[`InsertBefore`](../../compositenode/insertbefore/) på stycket där du vill infoga kommentaren.

Glöm inte att ange kommentaren efter att du skapat den.[`Author`](../author/) , [`Initial`](../initial/) och[`DateTime`](../datetime/) egenskaper.
...
| initial | String | Författarens initialer för kommentaren. Kan inte vara`null`. |
