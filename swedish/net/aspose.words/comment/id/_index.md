...
description: Hantera kommentaridentifierare enkelt med egenskapen Kommentar-ID – vilket förenklar din dataorganisation och förbättrar användarengagemang.
type: docs
weight: 70
...
Hämtar eller ställer in kommentaridentifieraren.
...
Kommentaridentifieraren gör det möjligt att förankra en kommentar till ett textområde i dokumentet. Området måste avgränsas med hjälp av[`CommentRangeStart`](../../commentrangestart/) och[`CommentRangeEnd`](../../commentrangeend/) -objekt som delar samma identifierarvärde som[`Comment`](../) objekt.

Du skulle använda detta värde när du letar efter[`CommentRangeStart`](../../commentrangestart/) och [`CommentRangeEnd`](../../commentrangeend/) noder som är länkade till den här kommentaren.

Kommentaridentifierare ska vara unika i ett dokument och Aspose.Words automatically behåller kommentaridentifierare när dokument laddas, sparas och kombineras.
