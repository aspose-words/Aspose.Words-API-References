...
description: Returnerar eller ställer in initialerna för användaren som är kopplad till en specifik kommentar.
type: docs
weight: 70
...
Returnerar eller ställer in initialerna för användaren som är kopplad till en specifik kommentar.
