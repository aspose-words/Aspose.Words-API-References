...
description: Upptäck hur du enkelt hanterar användarinitialer i kommentarer. Öka engagemanget och personifiera interaktioner med vår lättanvända egenskapsfunktion.
type: docs
weight: 80
...
Returnerar eller anger initialerna för den användare som är associerad med en specifik kommentar.
