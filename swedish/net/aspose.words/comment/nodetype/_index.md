...
description: Upptäck egenskapen Comment NodeType som effektivt returnerar kommentarer och förbättrar din innehållshanteringsupplevelse med sömlös integration.
type: docs
weight: 90
