...
description: Lär dig hur AcceptEnd-metoden förbättrar användarupplevelsen genom att effektivt hantera kommentarsbesök. Öka engagemanget med sömlös besökaracceptans!
type: docs
weight: 140
url: /sv/net/aspose.words/comment/acceptend/
---
## Comment.AcceptEnd method

Accepterar en besökare för att besöka slutet av kommentaren.
