...
description: Upptäck egenskapen Bokmärken för att få tillgång till en omfattande samling bokmärken, vilket enkelt förbättrar din dokumentnavigering och organisation.
type: docs
weight: 10
...
Returnerar en`Bookmarks` samling som representerar alla bokmärken i intervallet.
