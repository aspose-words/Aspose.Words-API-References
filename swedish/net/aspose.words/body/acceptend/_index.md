...
description: Förbättra din webbupplevelse med metoden Body AcceptEnd, utformad för att sömlöst acceptera besökare i slutet av dokumentet för förbättrad navigering.
type: docs
weight: 50
url: /sv/net/aspose.words/body/acceptend/
---
## Body.AcceptEnd method

Accepterar en besökare för att besöka slutet av dokumentets brödtext.
