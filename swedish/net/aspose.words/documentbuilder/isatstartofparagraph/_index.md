...
description: Upptäck DocumentBuilders IsAtStartOfParagraph-egenskap. Kontrollera enkelt om markören är i styckets början för effektiv textredigering.
type: docs
weight: 130
...
Returer`sann`om markören är i början av det aktuella stycket (ingen text före markören).
