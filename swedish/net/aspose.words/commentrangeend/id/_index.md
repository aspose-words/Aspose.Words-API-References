...
description: Upptäck CommentRangeEnd Id-egenskapen som länkar dina kommentarer sömlöst. Förbättra din innehållshantering med denna viktiga identifierare för bättre organisation.
type: docs
weight: 20
url: /sv/net/aspose.words/commentrangeend/id/
---
## CommentRangeEnd.Id property

Anger identifieraren för den kommentar som denna region är länkad till.
