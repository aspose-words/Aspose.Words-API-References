...
description: Utforska egenskapen WebExtensionTaskPanes för att få tillgång till en värdefull samling tillägg för aktivitetsfönster, vilket förbättrar dokumentets funktionalitet och användarupplevelse.
type: docs
weight: 510
...
Returnerar en samling som representerar en lista med tillägg i åtgärdsfönstret.
