...
description: Hämtar eller ställer in ordlistans dokument i detta dokument eller mall. Ett ordlistadokument är en storage för AutoText AutoCorrect och Building Block-poster definierade i ett dokument.
type: docs
weight: 170
...
Hämtar eller ställer in ordlistans dokument i detta dokument eller mall. Ett ordlistadokument är en storage för AutoText, AutoCorrect och Building Block-poster definierade i ett dokument.
