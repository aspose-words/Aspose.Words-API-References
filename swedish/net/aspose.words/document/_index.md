...
| [FieldOptions](../../aspose.words/document/fieldoptions/) { get; } | Får en[`FieldOptions`](../../aspose.words.fields/fieldoptions/) objekt som representerar alternativ för att styra fälthanteringen i dokumentet. |
...
| [IncludeTextboxesFootnotesEndnotesInStat](../../aspose.words/document/includetextboxesfootnotesendnotesinstat/) { get; set; } | Anger om textrutor, fotnoter och slutnoter ska inkluderas i statistiken över antalet ord. |
...
| [JustificationMode](../../aspose.words/document/justificationmode/) { get; set; } | Hämtar eller ställer in teckenavståndsjusteringen för ett dokument. |
...
| [MailMerge](../../aspose.words/document/mailmerge/) { get; } | Returnerar en[`MailMerge`](../../aspose.words.mailmerging/mailmerge/) objekt som representerar kopplingsfunktionen för dokumentet. |
...
| override [NodeType](../../aspose.words/document/nodetype/) { get; } | ReturnerarDocument . |
...
| [TrackRevisions](../../aspose.words/document/trackrevisions/) { get; set; } | Sant om ändringar spåras när detta dokument redigeras i Microsoft Word. |
...
För att ladda ett befintligt dokument i någon av[`LoadFormat`](../loadformat/) format, skicka ett filnamn eller en ström till en av`Document`konstruktörer. För att skapa ett tomt dokument, anropa konstruktorn utan parametrar.
...
De`Document` är en rotnod i ett träd som innehåller alla andra noder i dokumentet. Trädet är ett sammansatt designmönster och på många sätt liknar XmlDocument. Innehållet i dokumentet kan manipuleras fritt programmatiskt:
