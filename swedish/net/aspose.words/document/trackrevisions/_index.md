...
description: Aktivera Document TrackRevisions för att automatiskt spåra redigeringar i Microsoft Word, vilket säkerställer sömlöst samarbete och exakt versionskontroll.
type: docs
weight: 450
...
Sant om ändringar spåras när dokumentet redigeras i Microsoft Word.
...
Om du anger det här alternativet anger du bara huruvida spårning av ändringar är aktiverad eller avaktiverad. Den här egenskapen påverkar inte ändringar i dokumentet som du gör programmatiskt via Aspose.Words.

Om du vill automatiskt spåra ändringar när de görs programmatiskt av Aspose.Words i det här dokumentet, använd[`StartTrackRevisions`](../starttrackrevisions/) metod.
