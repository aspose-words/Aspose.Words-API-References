...
description: Utforska metoden Document AcceptEnd för att effektivt hantera besökares åtkomst i slutet av dokumentet. Förbättra användarupplevelsen med sömlös navigering.
type: docs
weight: 550
url: /sv/net/aspose.words/document/acceptend/
---
## Document.AcceptEnd method

Accepterar en besökare för att besöka slutet av dokumentet.
