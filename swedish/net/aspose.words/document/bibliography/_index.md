...
description: Gå till egenskapen Dokumentbibliografi för att hämta en omfattande källlista, vilket förbättrar din forskning och citeringsnoggrannhet.
type: docs
weight: 40
url: /sv/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Hämtar`Bibliography`objekt som representerar listan över källor som finns tillgängliga i dokumentet.
