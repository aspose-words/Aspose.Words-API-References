...
description: Upptäck hur metoden TabStopCollection Add effektivt lägger till eller uppdaterar tabbstopp, vilket förbättrar dokumentets layout och formatering.
type: docs
weight: 30
...
// Nedan följer två sätt att lägga till tabbstopp till ett styckes samling av tabbstopp via egenskapen "ParagraphFormat".
...
// 2 - Skicka värdena för egenskaperna för ett nytt tabbstopp till metoden "Lägg till":
paragraph.ParagraphFormat.TabStops.Add(ConvertUtil.MillimeterToPoint(100), TabAlignment.Left,
    TabLeader.Dashes);

// Lägg till tabbstopp vid 5 cm i alla stycken.
...
| alignment | TabAlignment | En[`TabAlignment`](../../tabalignment/) Värdet that anger justeringen av texten vid tabbstoppet. |
| leader | TabLeader | En[`TabLeader`](../../tableader/)värdet that anger typen av hänvisningslinje som visas under tabbtecknet. |
