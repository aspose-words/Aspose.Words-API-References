...
description: Hämtar eller ställer in pappersfacket fack som ska användas för den första sidan i ett avsnitt. Värdet är implementeringsspecifikt skrivaren.
type: docs
weight: 130
