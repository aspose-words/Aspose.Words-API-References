...
description: Upptäck hur du anpassar första sidfacket med egenskapen PageSetup FirstPageTray för optimal utskrift. Skräddarsy dina utskriftsinställningar för effektivitet!
type: docs
weight: 130
...
Hämtar eller ställer in vilket pappersfack (fack) som ska användas för den första sidan i ett avsnitt. Värdet är implementeringsspecifikt (skrivarspecifikt).
