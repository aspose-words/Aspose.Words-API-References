...
description: Upptäck hur du använder egenskapen PageSetup LineStartingNumber för att enkelt anpassa dokumentets startradsnummer för förbättrad formatering.
type: docs
weight: 250
