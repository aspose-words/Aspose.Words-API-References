...
description: Hämtar eller ställer in återuppringningsgränssnitt som används för att begära ordlistor när sidlayout för dokumentet byggs. Detta tillåter fördröjning av laddning av ordböcker vilket kan vara användbart vid bearbetning av dokument på många språk.
type: docs
weight: 10
