...
description: "Aspose::Words::Comparing::ComparisonTargetType enum. Tillåter att specificera basdokument som kommer att användas under jämförelsen. Standardvärdet är Current i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


Tillåter att specificera basdokument som kommer att användas under jämförelsen. Standardvärdet är [Current](./).
...
| --- | --- | --- |
| Aktuell | 0 | Detta dokument används som bas under jämförelsen. |
| Ny | 1 | Ett annat dokument används som grund under jämförelsen. |
