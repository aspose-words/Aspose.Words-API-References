---
title: "Aspose::Words::Layout::LayoutOptions::get_KeepOriginalFontMetrics metod"
linktitle: "get_KeepOriginalFontMetrics"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::LayoutOptions::get_KeepOriginalFontMetrics metod. Hämtar eller anger en indikation på huruvida de ursprungliga teckensnittsmåtten ska användas efter teckensnittssubstitution. Standard är true i C++."
type: docs
weight: 6500
url: /sv/cpp/aspose.words.layout/layoutoptions/get_keeporiginalfontmetrics/
---
## LayoutOptions::get_KeepOriginalFontMetrics method


Hämtar eller sätter en indikation på om de ursprungliga teckensnittsmåtten ska användas efter teckensnittssubstitution. Standard är **true**.
