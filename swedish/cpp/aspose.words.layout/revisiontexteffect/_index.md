...
description: "Aspose::Words::Layout::RevisionTextEffect enum. Tillåter att ange dekorationseffekt för revisioner av dokumenttext i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.layout/revisiontexteffect/
---
## RevisionTextEffect enum


Tillåter att ange dekorationseffekt för revisioner av dokumenttext.
...
| --- | --- | --- |
| None | 0 | Reviderat innehåll har inga speciella effekter tillämpade. Detta motsvarar [NoHighlight](../revisioncolor/). |
| Färg | 1 | Reviderat innehåll är markerat enbart med färg. |
| Bold | 2 | Reviderat innehåll görs fetstilat och färgat. |
| Italic | 3 | Reviderat innehåll görs kursivt och färgat. |
| Understrykning | 4 | Reviderat innehåll är understruket och färgat. |
| DoubleUnderline | 5 | Reviderat innehåll är dubbelt understruket och färgat. |
| StrikeThrough | 6 | Reviderat innehåll är genomstruket och färgat. |
| DoubleStrikeThrough | 7 | Reviderat innehåll är dubbelt genomstruket och färgat. |
