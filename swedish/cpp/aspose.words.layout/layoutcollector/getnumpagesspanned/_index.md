---
title: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned metod"
linktitle: "GetNumPagesSpanned"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned metod. Hämtar antalet sidor som den angivna noden sträcker sig över. 0 om noden ligger inom en enda sida. Detta är samma som GetEndPageIndex() - GetStartPageIndex() i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


Hämtar antalet sidor som den angivna noden sträcker sig över. 0 om noden är inom en enda sida. Detta är samma som [GetEndPageIndex()](../) - [GetStartPageIndex()](../).
