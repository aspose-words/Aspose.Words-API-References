---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor metod"
linktitle: "get_RevisionBarsColor"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor metod. Tillåter att ange färgen som ska användas för sidofält som identifierar dokumentrader som innehåller reviderad information. Standardvärdet är Red i C++."
type: docs
weight: 14000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


Tillåter att ange färgen som ska användas för sidofält som identifierar dokumentrader som innehåller reviderad information. Standardvärdet är [Red](../../revisioncolor/).
