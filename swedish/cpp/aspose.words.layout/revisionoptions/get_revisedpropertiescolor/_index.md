---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor metod"
linktitle: "get_RevisedPropertiesColor"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor metod. Tillåter att ange färgen som ska användas för innehåll med ändringar av formateringsegenskaper FormatChange. Standardvärdet är NoHighlight i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_revisedpropertiescolor/
---
## RevisionOptions::get_RevisedPropertiesColor method


Tillåter att ange färgen som ska användas för innehåll med ändringar av formateringsegenskaper [FormatChange](../../../aspose.words/revisiontype/) Standardvärdet är [NoHighlight](../../revisioncolor/).
