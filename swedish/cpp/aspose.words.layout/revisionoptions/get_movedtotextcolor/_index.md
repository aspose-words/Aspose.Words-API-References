---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor metod"
linktitle: "get_MovedToTextColor"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor metod. Tillåter att ange färgen som ska användas för områden där innehåll har flyttats till Moving. Standardvärdet är ByAuthor i C++."
type: docs
weight: 10000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


Tillåter att ange färgen som ska användas för områden där innehåll har flyttats till [Moving](../../../aspose.words/revisiontype/). Standardvärdet är [ByAuthor](../../revisioncolor/).
