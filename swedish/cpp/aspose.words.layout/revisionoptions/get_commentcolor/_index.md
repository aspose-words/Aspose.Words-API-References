---
title: "Aspose::Words::Layout::RevisionOptions::get_CommentColor metod"
linktitle: "get_CommentColor"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_CommentColor metod. Tillåter att ange färgen som ska användas för kommentarer. Standardvärdet är Red i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


Tillåter att ange färgen som ska användas för kommentarer. Standardvärdet är [Red](../../revisioncolor/).
