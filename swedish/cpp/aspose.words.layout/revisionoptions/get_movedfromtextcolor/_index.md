---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor metod"
linktitle: "get_MovedFromTextColor"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor metod. Tillåter att ange färgen som ska användas för områden där innehåll har flyttats från Moving. Standardvärdet är ByAuthor i C++."
type: docs
weight: 8000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Tillåter att ange färgen som ska användas för områden där innehåll har flyttats från [Moving](../../../aspose.words/revisiontype/). Standardvärdet är [ByAuthor](../../revisioncolor/).
