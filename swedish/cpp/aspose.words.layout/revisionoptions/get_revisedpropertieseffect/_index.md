---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect metod"
linktitle: "get_RevisedPropertiesEffect"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect metod. Tillåter att ange effekten för innehållsområden med ändringar av formateringsegenskaper FormatChange. Standardvärdet är None i C++."
type: docs
weight: 13000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


Tillåter att ange effekten för innehållsområden med ändringar av formateringsegenskaper [FormatChange](../../../aspose.words/revisiontype/) Standardvärdet är [None](../../revisiontexteffect/)
