---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect metod"
linktitle: "get_DeletedTextEffect"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect metod. Tillåter att ange den effekt som ska tillämpas på det borttagna innehållet Deletion. Standardvärdet är StrikeThrough i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


Tillåter att ange den effekt som ska tillämpas på det borttagna innehållet [Deletion](../../../aspose.words/revisiontype/). Standardvärdet är [StrikeThrough](../../revisiontexteffect/).
