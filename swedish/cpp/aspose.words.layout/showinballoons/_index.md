...
description: "Aspose::Words::Layout::ShowInBalloons enum. Anger vilka revisioner som renderas i ballonger i C++."
type: docs
weight: 13000
url: /sv/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Anger vilka revisioner som renderas i ballonger.
...
| --- | --- | --- |
| None | 0 | Renderar infogning-, raderings- och formateringsrevisioner inline. |
| Format | 1 | Renderar infognings- och raderingsrevisioner inline, formateringsrevisioner i ballonger. |
| FormatAndDelete | 2 | Renderar infogningsrevisioner inline, raderings- och formateringsrevisioner i ballonger. |
