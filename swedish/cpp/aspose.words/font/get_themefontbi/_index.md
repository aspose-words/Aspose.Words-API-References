...
description: "Aspose::Words::Font::get_ThemeFontBi method. Hämtar eller anger temateckensnittet i det tillämpade teckensnittsschemat som är associerat med detta Font‑objekt i ett dokument med språk som skrivs från höger till vänster i C++."
type: docs
weight: 51000
url: /sv/cpp/aspose.words/font/get_themefontbi/
---
## Font::get_ThemeFontBi method


Hämtar eller anger temateckensnittet i det tillämpade teckensnittsschemat som är associerat med detta [Font](../)-objekt i ett dokument med språk som skrivs från höger till vänster.
