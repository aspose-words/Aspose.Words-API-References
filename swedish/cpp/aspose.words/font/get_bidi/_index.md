---
title: "Aspose::Words::Font::get_Bidi metod"
linktitle: "get_Bidi"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Font::get_Bidi metod. Anger om innehållet i detta körsegment ska ha högra‑till‑vänster‑karaktäristik i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words/font/get_bidi/
---
## Font::get_Bidi method


Anger om innehållet i detta körningssegment ska ha höger-till-vänster-egenskaper.
...
Denna egenskap, när den är på, får inte användas med starkt vänster‑till‑höger‑text. Allt beteende under den förutsättningen är ospecificerat. Denna egenskap, när den är av, får inte användas med starkt höger‑till‑vänster‑text. Allt beteende under den förutsättningen är ospecificerat.

När innehållet i detta körsegment visas ska alla tecken behandlas som komplexa skripttecken för formateringsändamål. Detta innebär att [BoldBi](../get_boldbi/), [ItalicBi](../get_italicbi/), [SizeBi](../get_sizebi/) och ett motsvarande typsnittsnamn kommer att användas vid rendering av detta körsegment.

Dessutom, när innehållet i detta körsegment visas, fungerar denna egenskap som en högra‑till‑vänster‑överskuggning för tecken som klassificeras som \"svaga typer\" och \"neutrala typer\".
