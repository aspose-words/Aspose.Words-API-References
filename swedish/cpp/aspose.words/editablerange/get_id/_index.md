---
title: "Aspose::Words::EditableRange::get_Id-metoden"
linktitle: "get_Id"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::EditableRange::get_Id-metoden. Hämtar identifieraren för det redigerbara området i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words/editablerange/get_id/
---
## EditableRange::get_Id method


Hämtar identifieraren för det redigerbara området.
...
Området måste avgränsas med hjälp av [EditableRangeStart](../get_editablerangestart/) och [EditableRangeEnd](../get_editablerangeend/)

Identifierare för redigerbara områden ska vara unika i ett dokument och Aspose.Words hanterar automatiskt identifierare för redigerbara områden vid inläsning, sparande och sammanslagning av dokument.
