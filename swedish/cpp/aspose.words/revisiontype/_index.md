...
description: "Aspose::Words::RevisionType enum. Anger vilken typ av förändring som spåras i Revision i C++."
type: docs
weight: 113000
url: /sv/cpp/aspose.words/revisiontype/
---
## RevisionType enum


Anger vilken typ av förändring som spåras i [Revision](../revision/).
...
| --- | --- | --- |
| Infogning | 0 | Nytt innehåll har infogats i dokumentet. |
| Radering | 1 | Innehållet togs bort från dokumentet. |
| Formateringsändring | 2 | Formateringsändring tillämpades på föräldranoden. |
| Stildefinitionsändring | 3 | Formateringsändring tillämpades på förälderstilen. |
| Flyttning | 4 | Innehållet flyttades i dokumentet. |
