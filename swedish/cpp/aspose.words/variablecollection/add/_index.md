---
title: "Aspose::Words::VariableCollection::Add metod"
linktitle: "Add"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::VariableCollection::Add metod. Lägger till en dokumentvariabel i samlingen i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words/variablecollection/add/
---
## VariableCollection::Add method


Lägger till en dokumentvariabel i samlingen.
...
| --- | --- | --- |
| namn | const System::String\& | Det skiftlägesokänsliga namnet på variabeln som ska läggas till. |
| value | const System::String\& | Variabelns värde. Värdet kan inte vara **null**, om värdet är null används en tom sträng istället. |
