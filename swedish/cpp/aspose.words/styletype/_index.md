...
description: "Aspose::Words::StyleType enum. Representerar typ av stilen i C++."
type: docs
weight: 119000
url: /sv/cpp/aspose.words/styletype/
---
## StyleType enum
...
| --- | --- | --- |
| Paragraph | 1 | Stilen är en stycke‑stil. |
| Character | 2 | Stilen är en tecken‑stil. |
| Table | 3 | Stilen är en tabell‑stil. |
| Lista | 4 | Stilen är en list‑stil. |
