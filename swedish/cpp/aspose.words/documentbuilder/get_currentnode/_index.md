---
title: "Aspose::Words::DocumentBuilder::get_CurrentNode metod"
linktitle: "get_CurrentNode"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::DocumentBuilder::get_CurrentNode metod. Hämtar noden som för närvarande är markerad i denna DocumentBuilder i C++."
type: docs
weight: 11000
url: /sv/cpp/aspose.words/documentbuilder/get_currentnode/
---
## DocumentBuilder::get_CurrentNode method


Hämtar noden som för närvarande är markerad i detta [DocumentBuilder](../).
...
När det aktuella stycket är tomt eller markören är placerad precis före slutet av ett stycke eller en strukturerad dokumenttagg, returnerar [CurrentNode](./) **null**.
