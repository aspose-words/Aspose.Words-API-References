---
title: "Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph metod"
linktitle: "get_IsAtStartOfParagraph"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph metod. Returnerar true om markören är i början av det aktuella stycket (ingen text före markören) i C++."
type: docs
weight: 20000
url: /sv/cpp/aspose.words/documentbuilder/get_isatstartofparagraph/
---
## DocumentBuilder::get_IsAtStartOfParagraph method


Returnerar **true** om markören är i början av det aktuella stycket (ingen text före markören).
