...
description: "Aspose::Words::DocumentBuilder::EndTable‑metod. Avslutar en tabell i dokumentet i C++."
type: docs
weight: 8000
url: /sv/cpp/aspose.words/documentbuilder/endtable/
---
...
Tabellnoden som just avslutades.
## Anmärkningar


Denna metod bör anropas endast en gång efter att [EndRow](../endrow/) har anropats. När den anropas flyttar [EndTable](./) markören från den aktuella cellen till positionen precis efter tabellen.
