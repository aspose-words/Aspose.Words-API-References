---
title: "Aspose::Words::Document::Cleanup metod"
linktitle: "Cleanup"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Document::Cleanup metod. Rensar oanvända format och listor från dokumentet i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words/document/cleanup/
---
...
// Ett anpassat format räknas som "använt" när det tillämpas på någon del av dokumentet,
// vilket betyder att de fyra format vi lade till för närvarande är oanvända.
ASSERT_EQ(8, doc->get_Styles()->get_Count());

// Applicera ett anpassat teckenformat och sedan ett anpassat listformat. Att göra så markerar formaten som "använda".
...
Rensar oanvända format och listor från dokumentet beroende på angivna [CleanupOptions](../../cleanupoptions/).
