---
title: "Aspose::Words::Document::get_TrackRevisions metod"
linktitle: "get_TrackRevisions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Document::get_TrackRevisions metod. True om ändringar spåras när detta dokument redigeras i Microsoft Word i C++."
type: docs
weight: 54000
url: /sv/cpp/aspose.words/document/get_trackrevisions/
---
...
Att ställa in detta alternativ instruerar bara Microsoft Word om spårningsändringar är på eller av. Denna egenskap har ingen effekt på ändringar i dokumentet som du gör programmässigt via Aspose.Words.

Om du vill spåra ändringar automatiskt när de görs programmässigt av [Aspose.Words](../../) till detta dokument, använd [StartTrackRevisions()](../) metoden.
