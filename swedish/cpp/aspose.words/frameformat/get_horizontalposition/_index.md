---
title: "Aspose::Words::FrameFormat::get_HorizontalPosition‑metod"
linktitle: "get_HorizontalPosition"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::FrameFormat::get_HorizontalPosition‑metod. Hämtar horisontellt avstånd mellan ramens kant och objektet som anges av egenskapen RelativeHorizontalPosition i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words/frameformat/get_horizontalposition/
---
## FrameFormat::get_HorizontalPosition method


Hämtar horisontellt avstånd mellan ramens kant och objektet som anges av egenskapen [RelativeHorizontalPosition](../get_relativehorizontalposition/).
