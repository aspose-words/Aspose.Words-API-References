...
description: "Aspose::Words::SectionStart enum. Typen av avbrott i början av sektionen i C++."
type: docs
weight: 116000
url: /sv/cpp/aspose.words/sectionstart/
---
## SectionStart enum


Typen av radbrytning i början av avsnittet.
...
| --- | --- | --- |
| Continuous | 0 | Den nya sektionen börjar på samma sida som föregående sektion. |
| NewColumn | 1 | Sektionen börjar i en ny kolumn. |
| NewPage | 2 | Sektionen börjar på en ny sida. |
| EvenPage | 3 | Sektionen börjar på en ny jämn sida. |
| UddaSida | 4 | Avsnittet börjar på en ny udda sida. |
