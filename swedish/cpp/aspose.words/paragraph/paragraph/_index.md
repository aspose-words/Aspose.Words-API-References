...
description: "Aspose::Words::Paragraph::Paragraph konstruktor. Initierar en ny instans av Paragraph‑klassen i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words/paragraph/paragraph/
---
## Paragraph::Paragraph constructor


Initierar en ny instans av klassen [Paragraph](../).
...
När [Paragraph](../) skapas tillhör den det angivna dokumentet, men är ännu inte en del av dokumentet och [ParentNode](../../node/get_parentnode/) är **null**.

För att lägga till [Paragraph](../) i dokumentet, använd [InsertAfter1()</see> eller <see cref="Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\>, System::SharedPtr\<Aspose::Words::Node\>)">InsertBefore1()](../) på berättelsen där du vill infoga stycket.
