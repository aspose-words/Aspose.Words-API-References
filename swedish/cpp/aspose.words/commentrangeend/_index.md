...
description: "Aspose::Words::CommentRangeEnd class. Anger slutet på ett textområde som har en kommentar kopplad till sig. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 13000
url: /sv/cpp/aspose.words/commentrangeend/
---
## CommentRangeEnd class


Anger slutet på ett textområde som har en kommentar kopplad till sig. För att läsa mer, besök dokumentationsartikeln [Arbeta med kommentarer](https://docs.aspose.com/words/cpp/working-with-comments/).
...
| [CommentRangeEnd](./commentrangeend/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | Initierar en ny instans av den här klassen. |
...
| [get_NodeType](./get_nodetype/)() const override | Returnerar [CommentRangeEnd](../nodetype/). |
...
För att skapa en kommentar förankrad i ett textområde måste du skapa ett [Comment](../comment/) och sedan skapa [CommentRangeStart](../commentrangestart/) och [CommentRangeEnd](./) och sätta deras identifierare till samma [Id](../comment/get_id/) värde.
