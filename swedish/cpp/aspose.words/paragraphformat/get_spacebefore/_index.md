---
title: "Aspose::Words::ParagraphFormat::get_SpaceBefore metod"
linktitle: "get_SpaceBefore"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::ParagraphFormat::get_SpaceBefore metod. Hämtar eller anger mängden avstånd (i punkter) före stycket i C++."
type: docs
weight: 33000
url: /sv/cpp/aspose.words/paragraphformat/get_spacebefore/
---
## ParagraphFormat::get_SpaceBefore method


Hämtar eller anger mängden avstånd (i punkter) före stycket.
...
Har ingen effekt när [SpaceBeforeAuto](../get_spacebeforeauto/) är **true**.

Giltiga värden ligger mellan 0 och 1584 inklusive.
