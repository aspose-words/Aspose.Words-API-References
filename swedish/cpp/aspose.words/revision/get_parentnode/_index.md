---
title: "Aspose::Words::Revision::get_ParentNode metod"
linktitle: "get_ParentNode"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Revision::get_ParentNode metod. Hämtar den omedelbara föräldranoden (ägaren) för den här revisionen. Denna egenskap fungerar för alla revisionstyper förutom StyleDefinitionChange i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


Hämtar den omedelbara föräldranoden (ägaren) för den här revisionen. Denna egenskap fungerar för alla revisionstyper förutom [StyleDefinitionChange](../../revisiontype/).
