---
title: "Aspose::Words::TabStopCollection::Before metod"
linktitle: "Before"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::TabStopCollection::Before metod. Hämtar det första tabbstoppet till vänster om den angivna positionen i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words/tabstopcollection/before/
---
## TabStopCollection::Before method


Hämtar det första tabbstoppet till vänster om den angivna positionen.
...
Ett tabbstopp-objekt eller **null** om ett lämpligt tabbstopp inte hittades.
## Anmärkningar


Hoppar över tabbstopp med [Alignment](../../tabstop/get_alignment/) inställd på [Bar](../../tabalignment/).
