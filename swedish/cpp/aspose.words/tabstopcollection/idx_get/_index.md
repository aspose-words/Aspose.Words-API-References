---
title: "Aspose::Words::TabStopCollection::idx_get metod"
linktitle: "idx_get"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::TabStopCollection::idx_get metod. Hämtar ett tabbstopp på den angivna positionen i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words/tabstopcollection/idx_get/
---
## TabStopCollection::idx_get(double) method


Hämtar ett tabbstopp på den angivna positionen.
...
| --- | --- | --- |
| position | double | Positionen (i punkter) för tabbstoppet. |
...
Hämtar ett tabbstopp på det angivna indexet.
