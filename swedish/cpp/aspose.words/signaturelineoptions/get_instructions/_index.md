---
title: "Aspose::Words::SignatureLineOptions::get_Instructions metod"
linktitle: "get_Instructions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::SignatureLineOptions::get_Instructions metod. Hämtar eller anger instruktioner till undertecknaren som visas när signaturlinjen signeras. Standardvärdet för denna egenskap är en tom sträng i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


Hämtar eller anger instruktioner till undertecknaren som visas vid signering av signaturlinjen. Standardvärdet för denna egenskap är **empty string**.
