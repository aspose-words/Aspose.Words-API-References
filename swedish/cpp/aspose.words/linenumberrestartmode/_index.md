...
description: "Aspose::Words::LineNumberRestartMode enum. Bestämmer när automatisk radnumrering startar om i C++."
type: docs
weight: 94000
url: /sv/cpp/aspose.words/linenumberrestartmode/
---
## LineNumberRestartMode enum


Bestämmer när automatisk radnumrering startas om.
...
| --- | --- | --- |
| RestartPage | 0 | Radnumrering startar om i början av varje sida. |
| RestartSection | 1 | Radnumrering startar om i sektionens början. |
| Continuous | 2 | Radnumrering fortsätter från föregående sektion. |
