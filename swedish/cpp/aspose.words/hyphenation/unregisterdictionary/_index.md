...
description: "Aspose::Words::Hyphenation::UnregisterDictionary method. Avregistrerar en bindestrecksordbok för det angivna språket. Detta skiljer sig från att registrera en Null-ordbok. Att avregistrera en ordbok möjliggör återanrop för det angivna språket i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words/hyphenation/unregisterdictionary/
---
## Hyphenation::UnregisterDictionary method


Avregistrerar en avstavningsordbok för det angivna språket. Detta skiljer sig från att registrera en Null-ordbok. Att avregistrera en ordbok möjliggör återuppringning för det angivna språket.
...
| --- | --- | --- |
| språk | const System::String\& | Ett språknamn, t.ex. "en-US". Se .NET-dokumentationen för "culture name" och RFC 4646 för detaljer. Om **null** eller tom sträng så avregistreras alla ordböcker. |
