---
title: "Aspose::Words::EditableRangeEnd klass"
linktitle: "EditableRangeEnd"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::EditableRangeEnd klass. Representerar slutet på ett redigerbart område i ett Word-dokument. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 25000
url: /sv/cpp/aspose.words/editablerangeend/
---
## EditableRangeEnd class


Representerar slutet på ett redigerbart område i ett Word-dokument. För att läsa mer, besök artikeln [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/) i dokumentationen.
...
| [get_EditableRangeStart](./get_editablerangestart/)() | Motsvarande [EditableRangeStart](../editablerangestart/), mottagen via ID. |
...
| [get_NodeType](./get_nodetype/)() const override | Returnerar [EditableRangeEnd](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | Inställning för [Aspose::Words::EditableRangeEnd::get_Id](./get_id/). |
...
Ett komplett redigerbart område i ett Word-dokument består av en [EditableRangeStart](./get_editablerangestart/) och ett matchande [EditableRangeEnd](./) med samma Id.
...
Använd klassen [EditableRange](../editablerange/) som en "facade" för att arbeta med ett redigerbart område som ett enda objekt.
