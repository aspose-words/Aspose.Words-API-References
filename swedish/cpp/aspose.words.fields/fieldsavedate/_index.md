---
title: "Aspose::Words::Fields::FieldSaveDate klass"
linktitle: "FieldSaveDate"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldSaveDate klass. Implementerar SAVEDATE-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 87000
url: /sv/cpp/aspose.words.fields/fieldsavedate/
---
## FieldSaveDate class


Implementerar SAVEDATE-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | Inställare för [Aspose::Words::Fields::FieldSaveDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | Inställare för [Aspose::Words::Fields::FieldSaveDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | Inställare för [Aspose::Words::Fields::FieldSaveDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
