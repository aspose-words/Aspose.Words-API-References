---
title: "Aspose::Words::Fields::FieldFormat-klass"
linktitle: "FieldFormat"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldFormat-klass. Tillhandahåller typad åtkomst till fältets numeriska, datum- och tids- samt allmänna formatering. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 45000
url: /sv/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Tillhandahåller typad åtkomst till fältets numeriska, datum- och tids- samt allmänna formatering. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Hämtar eller anger en formatering som tillämpas på ett datum- och tidsfältresultat. Motsvarar \@-växeln. |
| [get_GeneralFormats](./get_generalformats/)() | Hämtar en samling av allmänna format som tillämpas på ett numeriskt, text- eller vilket fältresultat som helst. Motsvarar \*-växlarna. |
| [get_NumericFormat](./get_numericformat/)() | Hämtar eller anger en formatering som tillämpas på ett numeriskt fältresultat. Motsvarar \#-växeln. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
