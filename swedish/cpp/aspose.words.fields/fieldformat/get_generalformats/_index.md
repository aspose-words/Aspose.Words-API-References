---
title: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats metod"
linktitle: "get_GeneralFormats"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats metod. Hämtar en samling av allmänna format som tillämpas på ett numeriskt, text- eller vilket fältresultat som helst. Motsvarar \\*-växlarna i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.fields/fieldformat/get_generalformats/
---
## FieldFormat::get_GeneralFormats method


Hämtar en samling av allmänna format som tillämpas på ett numeriskt, text- eller vilket fältresultat som helst. Motsvarar \*-växlarna.
