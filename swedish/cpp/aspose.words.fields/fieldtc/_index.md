---
title: "Aspose::Words::Fields::FieldTC klass"
linktitle: "FieldTC"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldTC klass. Implementerar TC-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 100000
url: /sv/cpp/aspose.words.fields/fieldtc/
---
## FieldTC class


Implementerar TC-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| [get_EntryLevel](./get_entrylevel/)() | Hämtar nivå för posten. |
...
| [get_OmitPageNumber](./get_omitpagenumber/)() override | Hämtar om sidnumret i innehållsförteckningen ska utelämnas för detta fält. |
...
| [get_Text](./get_text/)() | Hämtar texten för posten. |
| virtual [get_Type](../field/get_type/)() const | Hämtar Microsoft Word-fälttypen. |
| [get_TypeIdentifier](./get_typeidentifier/)() | Hämtar en typidentifierare för detta fält (som vanligtvis är en bokstav). |
...
| [set_EntryLevel](./set_entrylevel/)(const System::String\&) | Ställer in nivå för posten. |
...
| [set_OmitPageNumber](./set_omitpagenumber/)(bool) | Ställer in om sidnumret i innehållsförteckningen ska utelämnas för detta fält. |
| [set_Result](../field/set_result/)(const System::String\&) | Sättare för [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_Text](./set_text/)(const System::String\&) | Ställer in texten för posten. |
| [set_TypeIdentifier](./set_typeidentifier/)(const System::String\&) | Ställer in en typidentifierare för detta fält (som vanligtvis är en bokstav). |
| static [Type](./type/)() |  |
