---
title: "Aspose::Words::Fields::FieldCreateDate klass"
linktitle: "FieldCreateDate"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldCreateDate klass. Implementerar CREATEDATE-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 26000
url: /sv/cpp/aspose.words.fields/fieldcreatedate/
---
## FieldCreateDate class


Implementerar CREATEDATE-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | Sättare för [Aspose::Words::Fields::FieldCreateDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | Sättare för [Aspose::Words::Fields::FieldCreateDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | Sättare för [Aspose::Words::Fields::FieldCreateDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
