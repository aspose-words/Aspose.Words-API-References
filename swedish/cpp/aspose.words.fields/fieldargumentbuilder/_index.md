---
title: "Aspose::Words::Fields::FieldArgumentBuilder klass"
linktitle: "FieldArgumentBuilder"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldArgumentBuilder klass. Bygger ett komplext fältargument bestående av fält, noder och vanlig text. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


Bygger ett komplext fältargument bestående av fält, noder och vanlig text. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| Metod | Beskrivning |
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Lägger till ett fält som representeras av en [FieldBuilder](../fieldbuilder/) till argumentet. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Lägger till en nod till argumentet. |
| [AddText](./addtext/)(const System::String\&) | Lägger till en vanlig text till argumentet. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | Initierar en instans av klassen [FieldArgumentBuilder](./). |
