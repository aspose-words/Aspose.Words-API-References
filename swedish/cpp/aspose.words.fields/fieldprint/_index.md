---
title: "Aspose::Words::Fields::FieldPrint-klass"
linktitle: "FieldPrint"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldPrint-klass. Implementerar PRINT-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 80000
url: /sv/cpp/aspose.words.fields/fieldprint/
---
## FieldPrint class


Implementerar PRINT-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_PostScriptGroup](./get_postscriptgroup/)() | Hämtar eller anger ritningsrektangeln som PostScript‑instruktionerna arbetar på. |
| [get_PrinterInstructions](./get_printerinstructions/)() | Hämtar eller anger skrivar‑specifika kontrollkodstecken eller PostScript‑instruktioner. |
...
| [set_PostScriptGroup](./set_postscriptgroup/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldPrint::get_PostScriptGroup](./get_postscriptgroup/). |
| [set_PrinterInstructions](./set_printerinstructions/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldPrint::get_PrinterInstructions](./get_printerinstructions/). |
