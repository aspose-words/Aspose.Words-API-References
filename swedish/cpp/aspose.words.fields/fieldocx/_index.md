---
title: "Aspose::Words::Fields::FieldOcx klass"
linktitle: "FieldOcx"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldOcx klass. Implementerar OCX‑fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 76000
url: /sv/cpp/aspose.words.fields/fieldocx/
---
## FieldOcx class


Implementerar OCX-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Visar hur man infogar ett OCX‑fält.
```cpp
