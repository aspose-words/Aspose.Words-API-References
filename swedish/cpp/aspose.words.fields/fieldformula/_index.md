...
description: "Aspose::Words::Fields::FieldFormula class. Implementerar = (formel) fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 49000
url: /sv/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


Implementerar = (formel)-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// och skapa sedan ett formelfält för att visa ekvationens resultat i dokumentet.
