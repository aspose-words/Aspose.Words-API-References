...
description: "Aspose::Words::Fields::FieldChar class. Basklass för noder som representerar fälttecken i ett dokument. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 21000
url: /sv/cpp/aspose.words.fields/fieldchar/
---
## FieldChar class


Basklass för noder som representerar fälttecken i ett dokument. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| Metod | Beskrivning |
| --- | --- |
| [Accept](../../aspose.words/specialchar/accept/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Accepterar en besökare. |
...
| [get_FieldType](./get_fieldtype/)() const | Returnerar fältets typ. |
...
| [get_IsDirty](./get_isdirty/)() const | Hämtar eller anger om det aktuella resultatet av fältet inte längre är korrekt (föråldrat) på grund av andra ändringar som gjorts i dokumentet. |
...
| [get_IsLocked](./get_islocked/)() const | Hämtar eller anger om föräldrafältet är låst (bör inte beräkna om sitt resultat). |
...
| [get_NodeType](../../aspose.words/specialchar/get_nodetype/)() const override | Returnerar [SpecialChar](../../aspose.words/nodetype/). |
...
| [GetField](./getfield/)() | Returnerar ett fält för fälttecknet. |
...
| [set_IsDirty](./set_isdirty/)(bool) | Sättare för [Aspose::Words::Fields::FieldChar::get_IsDirty](./get_isdirty/). |
| [set_IsLocked](./set_islocked/)(bool) | Sättare för [Aspose::Words::Fields::FieldChar::get_IsLocked](./get_islocked/). |
