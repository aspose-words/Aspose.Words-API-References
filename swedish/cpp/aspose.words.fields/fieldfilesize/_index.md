---
title: "Aspose::Words::Fields::FieldFileSize klass"
linktitle: "FieldFileSize"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldFileSize klass. Implementerar FILESIZE-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 42000
url: /sv/cpp/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class


Implementerar FILESIZE-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_IsInKilobytes](./get_isinkilobytes/)() | Hämtar eller anger om filstorleken ska visas i kilobyte. |
| [get_IsInMegabytes](./get_isinmegabytes/)() | Hämtar eller anger om filstorleken ska visas i megabyte. |
...
| [set_IsInKilobytes](./set_isinkilobytes/)(bool) | Inställare för [Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes](./get_isinkilobytes/). |
| [set_IsInMegabytes](./set_isinmegabytes/)(bool) | Inställare för [Aspose::Words::Fields::FieldFileSize::get_IsInMegabytes](./get_isinmegabytes/). |
...
Hämtar storleken på den aktuella dokumentfilen eller 0 om storleken inte kan bestämmas.

I den aktuella implementeringen används egenskapen [OriginalFileName](../../aspose.words/document/get_originalfilename/) för att hämta filnamnet som används för att bestämma filstorleken.
