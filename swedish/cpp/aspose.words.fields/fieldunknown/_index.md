...
description: "Aspose::Words::Fields::FieldUnknown class. Implementerar ett okänt eller oigenkänt fält. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 106000
url: /sv/cpp/aspose.words.fields/fieldunknown/
---
## FieldUnknown class


Implementerar ett okänt eller oigenkänt fält. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
// Infoga ett fält som inte betecknar en objektiv fälttyp i dess fältkod.
