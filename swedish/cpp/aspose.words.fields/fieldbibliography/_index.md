...
description: "Aspose::Words::Fields::FieldBibliography-klass. Implementerar BIBLIOGRAPHY-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 18000
url: /sv/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


Implementerar BIBLIOGRAPHY-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Hämtar språk-ID:t som används för att filtrera de bibliografiska data så att endast källorna i dokumentet som använder det språket inkluderas. |
| [get_Format](../field/get_format/)() | Hämtar ett [FieldFormat](../fieldformat/) objekt som ger typad åtkomst till fältets formatering. |
| [get_FormatLanguageId](./get_formatlanguageid/)() | Hämtar språk-ID:t som används för att formatera de bibliografiska källorna i dokumentet. |
...
| [get_SourceTag](./get_sourcetag/)() | Hämtar ett värde så att endast de källor med matchande Tag-elementvärde visas i bibliografin. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Ställer in språk-ID:t som används för att filtrera de bibliografiska data så att endast källorna i dokumentet som använder det språket inkluderas. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Ställer in språk-ID:t som används för att formatera de bibliografiska källorna i dokumentet. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Ställer in ett värde så att endast de källor med matchande Tag-elementvärde visas i bibliografin. |
| static [Type](./type/)() |  |
