---
title: "Aspose::Words::Fields::FieldOptions::get_BuiltInTemplatesPaths‑metod"
linktitle: "get_BuiltInTemplatesPaths"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldOptions::get_BuiltInTemplatesPaths‑metod. Hämtar eller anger sökvägar för MS Words inbyggda mallar i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.fields/fieldoptions/get_builtintemplatespaths/
---
## FieldOptions::get_BuiltInTemplatesPaths method


Hämtar eller anger sökvägar till MS Words inbyggda mallar.
...
Denna egenskap används av fälten [FieldAutoText](../../fieldautotext/) och [FieldGlossary](../../fieldglossary/), om den refererade autotext‑posten inte hittas i mallen [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/).

Som standard lagrar MS Word inbyggda mallar i c:\Users\<username>\AppData\Roaming\**Microsoft**\[Document](../../../aspose.words/document/) Building Blocks\1033\16\Built-In Building Blocks.dotx och C:\Users\<username>\AppData\Roaming\**Microsoft**\Templates\Normal.dotm‑filer.
