---
title: "Aspose::Words::Fields::DropDownItemCollection::Insert-metod"
linktitle: "Infoga"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::DropDownItemCollection::Insert-metod. Infogar en sträng i samlingen på det angivna indexet i C++."
type: docs
weight: 15000
url: /sv/cpp/aspose.words.fields/dropdownitemcollection/insert/
---
## DropDownItemCollection::Insert method


Infogar en sträng i samlingen på det angivna indexet.
...
| --- | --- | --- |
| index | int32_t | Det nollbaserade indexet där värdet infogas. |
| value | const System::String\& | Strängen att infoga. |
