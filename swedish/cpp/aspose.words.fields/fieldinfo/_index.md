---
title: "Aspose::Words::Fields::FieldInfo-klass"
linktitle: "FieldInfo"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldInfo-klass. Implementerar INFO-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 60000
url: /sv/cpp/aspose.words.fields/fieldinfo/
---
## FieldInfo class


Implementerar INFO-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_InfoType](./get_infotype/)() | Hämtar eller anger typen av dokumentegenskap som ska infogas. |
...
| [get_NewValue](./get_newvalue/)() | Hämtar eller anger ett valfritt värde som uppdaterar egenskapen. |
...
| [set_InfoType](./set_infotype/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldInfo::get_InfoType](./get_infotype/). |
...
| [set_NewValue](./set_newvalue/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldInfo::get_NewValue](./get_newvalue/). |
