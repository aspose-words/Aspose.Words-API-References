---
title: "Aspose::Words::Fields::FieldSet klass"
linktitle: "FieldSet"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldSet klass. Implementerar SET-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 92000
url: /sv/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


Implementerar SET-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Hämtar eller anger namnet på bokmärket. |
| [get_BookmarkText](./get_bookmarktext/)() | Hämtar eller anger den nya texten för bokmärket. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/). |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/). |
