...
description: "Aspose::Words::Fields::FieldIfComparisonResult enum. Anger resultatet av IF-fältets villkorsutvärdering i C++."
type: docs
weight: 128000
url: /sv/cpp/aspose.words.fields/fieldifcomparisonresult/
---
## FieldIfComparisonResult enum


Anger resultatet av IF-fältets villkorsutvärdering.
...
| --- | --- | --- |
| Fel | 0 | Det finns ett fel i villkoret. |
| Sant | 1 | Villkoret är **true**. |
| Falskt | 2 | Villkoret är **false**. |
