---
title: "Aspose::Words::Fields::FieldSkipIf klass"
linktitle: "FieldSkipIf"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldSkipIf klass. Implementerar SKIPIF-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 94000
url: /sv/cpp/aspose.words.fields/fieldskipif/
---
## FieldSkipIf class


Implementerar SKIPIF-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_ComparisonOperator](./get_comparisonoperator/)() | Hämtar jämförelseoperatorn. |
...
| [get_LeftExpression](./get_leftexpression/)() | Hämtar den vänstra delen av jämförelseuttrycket. |
...
| [get_RightExpression](./get_rightexpression/)() | Hämtar den högra delen av jämförelseuttrycket. |
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | Anger jämförelsesoperatorn. |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | Anger den vänstra delen av jämförelseuttrycket. |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | Anger den högra delen av jämförelseuttrycket. |
| static [Type](./type/)() |  |
