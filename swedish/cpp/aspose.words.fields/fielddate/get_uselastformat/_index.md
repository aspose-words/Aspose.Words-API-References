---
title: "Aspose::Words::Fields::FieldDate::get_UseLastFormat-metoden"
linktitle: "get_UseLastFormat"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldDate::get_UseLastFormat-metoden. Hämtar eller anger om ett format som senast användes av den värdande applikationen ska användas vid infogning av ett nytt DATE-fält i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.fields/fielddate/get_uselastformat/
---
## FieldDate::get_UseLastFormat method


Hämtar eller anger om ett format som senast användes av värdprogrammet ska användas när ett nytt DATE-fält infogas.
