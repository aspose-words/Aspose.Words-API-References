---
title: "Aspose::Words::Fields::FieldNumChars-klass"
linktitle: "FieldNumChars"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldNumChars-klass. Implementerar NUMCHARS-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 73000
url: /sv/cpp/aspose.words.fields/fieldnumchars/
---
## FieldNumChars class


Implementerar NUMCHARS-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Nedan är tre typer av fält som vi kan använda för att spåra storleken på våra dokument.
...
// Dessa fält kommer inte att hålla korrekta värden i realtid
