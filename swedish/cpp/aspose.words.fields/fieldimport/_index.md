---
title: "Aspose::Words::Fields::FieldImport-klass"
linktitle: "FieldImport"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldImport-klass. Implementerar IMPORT-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 55000
url: /sv/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


Implementerar IMPORT-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_SourceFullName](./get_sourcefullname/)() override | Hämtar eller anger bildens plats. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | Sättare för [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | Sättare för [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/). |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
