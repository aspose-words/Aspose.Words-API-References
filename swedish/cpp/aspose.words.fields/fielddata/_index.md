---
title: "Aspose::Words::Fields::FieldData klass"
linktitle: "FieldData"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldData klass. Implementerar DATA-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 27000
url: /sv/cpp/aspose.words.fields/fielddata/
---
## FieldData class


Implementerar DATA-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
Visar hur man infogar ett DATA-fält i ett dokument.
```cpp
