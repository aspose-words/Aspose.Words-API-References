---
title: "Aspose::Words::Fields::FieldDocVariable klass"
linktitle: "FieldDocVariable"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldDocVariable klass. Implementerar DOCVARIABLE-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 36000
url: /sv/cpp/aspose.words.fields/fielddocvariable/
---
## FieldDocVariable class


Implementerar DOCVARIABLE-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| [get_VariableName](./get_variablename/)() | Hämtar eller anger namnet på dokumentvariabeln som ska hämtas. |
...
| [set_VariableName](./set_variablename/)(const System::String\&) | Inställare för [Aspose::Words::Fields::FieldDocVariable::get_VariableName](./get_variablename/). |
| static [Type](./type/)() |  |
