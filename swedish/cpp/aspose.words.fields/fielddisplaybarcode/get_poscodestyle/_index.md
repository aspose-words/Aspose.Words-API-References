---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle metod"
linktitle: "get_PosCodeStyle"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle metod. Hämtar eller anger stilen för en Point of Sale-streckkod (streckkodstyperna UPCA|UPCE|EAN13|EAN8). Giltiga värden (skiftlägesokänsliga) är [STD|SUP2|SUP5|CASE] i C++."
type: docs
weight: 11000
url: /sv/cpp/aspose.words.fields/fielddisplaybarcode/get_poscodestyle/
---
## FieldDisplayBarcode::get_PosCodeStyle method


Hämtar eller anger stilen för en Point of Sale-streckkod (streckkodstyperna UPCA|UPCE|EAN13|EAN8). Giltiga värden (skiftlägesokänsliga) är [STD|SUP2|SUP5|CASE].
...
// Nedan finns fyra typer av streckkoder, dekorerade på olika sätt, som DISPLAYBARCODE-fältet kan visa.
...
// 2 -  EAN13-streckkod, med siffrorna visade under staplarna:
...
// 4 -  ITF4-streckkod, med en specificerad case-kod:
field = System::ExplicitCast<Aspose::Words::Fields::FieldDisplayBarcode>(builder->InsertField(Aspose::Words::Fields::FieldType::FieldDisplayBarcode, true));
