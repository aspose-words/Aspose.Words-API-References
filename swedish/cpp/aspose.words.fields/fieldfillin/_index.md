---
title: "Aspose::Words::Fields::FieldFillIn klass"
linktitle: "FieldFillIn"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldFillIn klass. Implementerar FILLIN-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 43000
url: /sv/cpp/aspose.words.fields/fieldfillin/
---
## FieldFillIn class


Implementerar FILLIN-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_DefaultResponse](./get_defaultresponse/)() | Hämtar standardanvändarsvaret (initialvärdet som finns i promptfönstret). |
...
| [get_PromptOnceOnMailMerge](./get_promptonceonmailmerge/)() | Hämtar om användarens svar ska tas emot en gång per en mail merge‑operation. |
| [get_PromptText](./get_prompttext/)() | Hämtar prompttexten (titeln på promptfönstret). |
...
| [set_DefaultResponse](./set_defaultresponse/)(const System::String\&) | Ställer in standardanvändarsvaret (initialvärdet som finns i promptfönstret). |
...
| [set_PromptOnceOnMailMerge](./set_promptonceonmailmerge/)(bool) | Ställer in om användarens svar ska tas emot en gång per en mail merge‑operation. |
| [set_PromptText](./set_prompttext/)(const System::String\&) | Ställer in prompttexten (titeln på promptfönstret). |
