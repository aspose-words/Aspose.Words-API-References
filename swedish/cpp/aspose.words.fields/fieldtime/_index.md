...
description: "Aspose::Words::Fields::FieldTime class. Implementerar TIME-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 102000
url: /sv/cpp/aspose.words.fields/fieldtime/
---
## FieldTime class


Implementerar TIME-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
