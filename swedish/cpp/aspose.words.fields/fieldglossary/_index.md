---
title: "Aspose::Words::Fields::FieldGlossary-klass"
linktitle: "FieldGlossary"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldGlossary-klass. Implementerar GLOSSARY-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 50000
url: /sv/cpp/aspose.words.fields/fieldglossary/
---
## FieldGlossary class


Implementerar GLOSSARY-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() override | Hämtar eller anger namnet på den ordlistapost som ska infogas. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Sättare för [Aspose::Words::Fields::FieldGlossary::get_EntryName](./get_entryname/). |
