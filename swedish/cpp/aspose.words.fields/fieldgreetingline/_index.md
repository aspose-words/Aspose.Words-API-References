---
title: "Aspose::Words::Fields::FieldGreetingLine-klass"
linktitle: "FieldGreetingLine"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldGreetingLine-klass. Implementerar GREETINGLINE-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 52000
url: /sv/cpp/aspose.words.fields/fieldgreetingline/
---
## FieldGreetingLine class


Implementerar GREETINGLINE-fältet. För att lära dig mer, besök dokumentationsartikeln [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_AlternateText](./get_alternatetext/)() | Hämtar texten som ska inkluderas i fältet om namnet är tomt. |
...
| [get_LanguageId](./get_languageid/)() | Hämtar språk-ID:t som används för att formatera namnet. |
| [get_LocaleId](../field/get_localeid/)() | Hämtar eller anger LCID för fältet. |
| [get_NameFormat](./get_nameformat/)() | Hämtar formatet på namnet som inkluderas i fältet. |
...
| [set_AlternateText](./set_alternatetext/)(const System::String\&) | Ställer in texten som ska inkluderas i fältet om namnet är tomt. |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | Ställer in språk-ID:t som används för att formatera namnet. |
| [set_LocaleId](../field/set_localeid/)(int32_t) | Sättare för [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NameFormat](./set_nameformat/)(const System::String\&) | Ställer in formatet på namnet som inkluderas i fältet. |
