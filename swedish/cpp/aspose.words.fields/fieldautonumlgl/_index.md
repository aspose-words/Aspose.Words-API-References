---
title: "Aspose::Words::Fields::FieldAutoNumLgl klass"
linktitle: "FieldAutoNumLgl"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fields::FieldAutoNumLgl klass. Implementerar AUTONUMLGL-fältet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 13000
url: /sv/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Implementerar AUTONUMLGL-fältet. För att lära dig mer, besök [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokumentationsartikel.
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Hämtar om numret ska visas utan en avslutande punkt. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Hämtar separatortecknet som ska användas. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Ställer in om numret ska visas utan en avslutande punkt. |
| [set_Result](../field/set_result/)(const System::String\&) | Sättare för [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Ställer in separatortecknet som ska användas. |
| static [Type](./type/)() |  |
