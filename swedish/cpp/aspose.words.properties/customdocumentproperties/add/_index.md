---
title: "Aspose::Words::Properties::CustomDocumentProperties::Add metod"
linktitle: "Add"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Properties::CustomDocumentProperties::Add metod. Skapar en ny anpassad dokumentegenskap av datatypen Boolean i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.properties/customdocumentproperties/add/
---
## CustomDocumentProperties::Add(const System::String\&, bool) method


Skapar en ny anpassad dokumentegenskap av datatypen [Boolean](../../propertytype/).
...
| value | bool | Värdet på egenskapen. |

### ReturnValue

Det nyss skapade egenskapsobjektet.
...
Skapar en ny anpassad dokumentegenskap av datatypen [String](../../propertytype/).
...
| --- | --- | --- |
| namn | const System::String\& | Namnet på egenskapen. |
| value | const System::String\& | Värdet på egenskapen. |
...
Skapar en ny anpassad dokumentegenskap av datatypen [Double](../../propertytype/).
...
Skapar en ny anpassad dokumentegenskap av datatypen [Number](../../propertytype/).
...
| --- | --- | --- |
| namn | const System::String\& | Namnet på egenskapen. |
| value | int32_t | Värdet på egenskapen. |
...
Skapar en ny anpassad dokumentegenskap av datatypen [DateTime](../../propertytype/).
...
| --- | --- | --- |
| namn | const System::String\& | Namnet på egenskapen. |
| value | System::DateTime | Värdet på egenskapen. |
