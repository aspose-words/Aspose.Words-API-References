...
description: "Aspose::Words::Properties::PropertyType enum. Anger datatypen för en dokumentegenskap i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.properties/propertytype/
---
## PropertyType enum
...
| DateTime | 1 | Egenskapen är ett datum/tid‑värde. |
| Dubbel | 2 | Egenskapen är ett flyttal. |
...
| Other | 8 | Egenskapen är av någon annan typ. |
