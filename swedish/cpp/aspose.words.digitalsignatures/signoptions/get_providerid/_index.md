---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ProviderId metod"
linktitle: "get_ProviderId"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ProviderId metod. Anger klass-ID för signaturleverantören. Standardvärdet är Empty (alla nollor) Guid i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words.digitalsignatures/signoptions/get_providerid/
---
## SignOptions::get_ProviderId method


Anger klass‑ID för signaturleverantören. Standardvärdet är **Empty (all zeroes) Guid**.
