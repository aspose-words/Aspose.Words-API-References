...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureType enum. Anger typen av en digital signatur i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.digitalsignatures/digitalsignaturetype/
---
## DigitalSignatureType enum


Anger typen av en digital signatur.
...
| --- | --- | --- |
| Okänd | 0 | Indikerar ett fel, okänd digital signaturtyp. |
| CryptoApi | 1 | Crypto API‑signeringsmetoden som används i Microsoft Word 97‑2003 .DOC‑binärdokument. |
| XmlDsig | 2 | XmlDsig‑signeringsmetoden som används i OOXML‑ och OpenDocument‑dokument. |
