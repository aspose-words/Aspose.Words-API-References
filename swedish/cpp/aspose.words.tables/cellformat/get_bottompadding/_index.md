---
title: "Aspose::Words::Tables::CellFormat::get_BottomPadding metod"
linktitle: "get_BottomPadding"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Tables::CellFormat::get_BottomPadding metod. Returnerar eller anger mängden utrymme (i punkter) som ska läggas till under cellens innehåll i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.tables/cellformat/get_bottompadding/
---
## CellFormat::get_BottomPadding method


Returnerar eller anger mängden utrymme (i punkter) som ska läggas till under cellens innehåll.
