...
description: "Aspose::Words::Tables::CellCollection class. Tillhandahåller typad åtkomst till en samling av Cell-noder. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.tables/cellcollection/
---
## CellCollection class


Tillhandahåller typad åtkomst till en samling av [Cell](../cell/) noder. För att lära dig mer, besök [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/) dokumentationsartikel.
...
| [idx_get](./idx_get/)(int32_t) | Hämtar en [Cell](../cell/) på det angivna indexet. |
...
| [ToArray](./toarray/)() | Kopierar alla celler från samlingen till en ny array av celler. |
| static [Type](./type/)() |  |
