...
description: "Aspose::Words::Themes::Theme class. Representerar dokumenttema och ger åtkomst till huvuddelarna i temat inklusive MajorFonts, MinorFonts och Colors. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 1000
url: /sv/cpp/aspose.words.themes/theme/
---
## Theme class


Representerar dokumentet [Theme](./) och ger åtkomst till huvuddelarna i temat inklusive [MajorFonts](./get_majorfonts/), [MinorFonts](./get_minorfonts/) och [Colors](./get_colors/). För att lära dig mer, besök dokumentationsartikeln [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_Colors](./get_colors/)() const | Tillåter att ange uppsättningen av temafärger för dokumentet. |
| [get_MajorFonts](./get_majorfonts/)() const | Tillåter att ange uppsättningen av huvudtypsnitt för olika språk. |
| [get_MinorFonts](./get_minorfonts/)() const | Tillåter att ange uppsättningen av sekundära typsnitt för olika språk. |
