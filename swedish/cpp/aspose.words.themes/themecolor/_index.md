...
description: "Aspose::Words::Themes::ThemeColor enum. Anger temafärgerna för dokumentteman. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.themes/themecolor/
---
## ThemeColor enum


Anger temafärgerna för dokumentteman. För att lära dig mer, besök [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/) dokumentationsartikel.
...
| Hyperlänk | 10 | Hyperlänkfärg. |
| FollowedHyperlink | 11 | Följd hyperlänkfärg. |
| Text1 | 12 | Textfärg 1. |
| Text2 | 13 | Textfärg 2. |
