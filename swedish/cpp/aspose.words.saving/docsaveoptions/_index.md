...
description: "Aspose::Words::Saving::DocSaveOptions class. Kan användas för att ange ytterligare alternativ när ett dokument sparas i Doc- eller Dot-format. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.saving/docsaveoptions/
---
## DocSaveOptions class


Kan användas för att ange ytterligare alternativ när ett dokument sparas i [Doc](../../aspose.words/saveformat/) eller [Dot](../../aspose.words/saveformat/) format. För att lära dig mer, besök dokumentationsartikeln [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [DocSaveOptions](./docsaveoptions/)() | Initierar en ny instans av denna klass som kan användas för att spara ett dokument i [Doc](../../aspose.words/saveformat/) format. |
| [DocSaveOptions](./docsaveoptions/)(Aspose::Words::SaveFormat) | Initierar en ny instans av denna klass som kan användas för att spara ett dokument i [Doc](../../aspose.words/saveformat/) eller [Dot](../../aspose.words/saveformat/) format. |
...
| [get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/)() const | När **false** komprimeras inte små metafiler av prestandaskäl. Standardvärdet är **true**, alla metafiler komprimeras oavsett storlek. |
...
| [get_Password](./get_password/)() const | Hämtar/anger ett lösenord för att kryptera dokumentet med RC4‑krypteringsmetoden. |
...
| [get_SaveFormat](./get_saveformat/)() override | Anger det format som dokumentet ska sparas i om detta spara‑alternativ‑objekt används. Kan vara [Doc](../../aspose.words/saveformat/) eller [Dot](../../aspose.words/saveformat/). |
| [get_SavePictureBullet](./get_savepicturebullet/)() const | När **false** sparas inte PictureBullet‑data till utdata‑dokumentet. Standardvärdet är **true**. |
| [get_SaveRoutingSlip](./get_saveroutingslip/)() const | När **false** sparas inte RoutingSlip‑data till utdata‑dokumentet. Standardvärdet är **true**. |
...
| [set_AlwaysCompressMetafiles](./set_alwayscompressmetafiles/)(bool) | Sättare för [Aspose::Words::Saving::DocSaveOptions::get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/). |
...
| [set_Password](./set_password/)(const System::String\&) | Sättare för [Aspose::Words::Saving::DocSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Sättare för [Aspose::Words::Saving::DocSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SavePictureBullet](./set_savepicturebullet/)(bool) | Sättare för [Aspose::Words::Saving::DocSaveOptions::get_SavePictureBullet](./get_savepicturebullet/). |
| [set_SaveRoutingSlip](./set_saveroutingslip/)(bool) | Sättare för [Aspose::Words::Saving::DocSaveOptions::get_SaveRoutingSlip](./get_saveroutingslip/). |
