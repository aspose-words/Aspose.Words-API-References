---
title: "Aspose::Words::Saving::DoclingSaveOptions-klass"
linktitle: "DoclingSaveOptions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::DoclingSaveOptions-klass. Kan användas för att ange ytterligare alternativ när ett dokument sparas i Docling-formatet. För att läsa mer, besök dokumentationsartikeln i C++."
type: docs
weight: 2750
url: /sv/cpp/aspose.words.saving/doclingsaveoptions/
---
## DoclingSaveOptions class


Kan användas för att ange ytterligare alternativ när ett dokument sparas i [Docling](../../aspose.words/saveformat/)‑formatet. För att läsa mer, besök [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) dokumentationsartikel.
...
| [get_RenderNonImageShapes](./get_rendernonimageshapes/)() const | Hämtar eller anger ett värde som indikerar om icke‑bildformer ska renderas och skrivas till utdata Docling JSON‑dokumentet. |
| [get_SaveFormat](./get_saveformat/)() override | Anger formatet som dokumentet kommer att sparas i om detta sparaalternativobjekt används. Kan endast vara [Docling](../../aspose.words/saveformat/). |
...
| [set_RenderNonImageShapes](./set_rendernonimageshapes/)(bool) | Inställare för [Aspose::Words::Saving::DoclingSaveOptions::get_RenderNonImageShapes](./get_rendernonimageshapes/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Inställare för [Aspose::Words::Saving::DoclingSaveOptions::get_SaveFormat](./get_saveformat/). |
