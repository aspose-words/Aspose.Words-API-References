...
description: "Aspose::Words::Saving::Zip64Mode enum. Anger när ZIP64-formatutökningar ska användas för OOXML-filer i C++."
type: docs
weight: 88000
url: /sv/cpp/aspose.words.saving/zip64mode/
---
## Zip64Mode enum


Anger när ZIP64-formatutökningar ska användas för OOXML-filer.
...
| --- | --- | --- |
| Aldrig | 0 | Använd inte ZIP64-formatutökningar. |
| IfNecessary | 1 | Om nödvändigt använd ZIP64-formatutökningar. |
| Alltid | 2 | Använd alltid ZIP64-formatutökningar. |
