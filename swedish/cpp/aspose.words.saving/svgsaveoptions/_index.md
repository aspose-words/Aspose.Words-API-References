---
title: "Aspose::Words::Saving::SvgSaveOptions klass"
linktitle: "SvgSaveOptions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::SvgSaveOptions klass. Kan användas för att ange ytterligare alternativ när ett dokument sparas i Svg-formatet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 31000
url: /sv/cpp/aspose.words.saving/svgsaveoptions/
---
## SvgSaveOptions class


Kan användas för att ange ytterligare alternativ när ett dokument sparas i [Svg](../../aspose.words/saveformat/) formatet. För att lära dig mer, besök dokumentationsartikeln [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportEmbeddedImages](./get_exportembeddedimages/)() const | Anger om bilder ska bäddas in i SVG-dokumentet som base64. Observera att aktivering av detta alternativ kan leda till en betydande ökning av storleken på den exporterade SVG-filen. |
...
| [get_FitToViewPort](./get_fittoviewport/)() const | Anger om den exporterade SVG:n ska fylla det tillgängliga visningsområdet (webbläsarfönster eller behållare). När den är satt till **true** sätts bredd och höjd på den exporterade SVG:n till 100 %. Standardvärdet är **false**. |
...
| [get_MaxImageResolution](./get_maximageresolution/)() const | Hämtar eller anger ett värde i pixlar per tum som begränsar upplösningen för exporterade rasterbilder. Standardvärdet är noll. |
...
| [get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/)() const | Anger om JavaScript ska tas bort från länkar. Standard är **false**. Om detta alternativ är aktiverat ersätts alla länkar som innehåller JavaScript med "javascript:void(0)". |
| [get_ResourceSavingCallback](./get_resourcesavingcallback/)() const | Tillåter att styra hur resurser (bilder) sparas när ett dokument exporteras till SVG-format. |
| [get_ResourcesFolder](./get_resourcesfolder/)() const | Anger den fysiska mappen där resurser (bilder) sparas när ett dokument exporteras till Svg-format. Standard är **null**. |
| [get_ResourcesFolderAlias](./get_resourcesfolderalias/)() const | Anger namnet på mappen som används för att konstruera bild-URI:er som skrivs in i ett SVG-dokument. Standard är **null**. |
| [get_SaveFormat](./get_saveformat/)() override | Anger det format som dokumentet sparas i om detta spara-alternativobjekt används. Kan endast vara [Svg](../../aspose.words/saveformat/). |
| [get_ShowPageBorder](./get_showpageborder/)() const | Styr om en ram läggs till runt sidans kontur. Standard är **true**. |
...
| [get_TextOutputMode](./get_textoutputmode/)() const | Hämtar eller anger ett värde som bestämmer hur text ska renderas i SVG. |
...
| [set_ExportEmbeddedImages](./set_exportembeddedimages/)(bool) | Anger om bilder ska bäddas in i SVG-dokumentet som base64. Observera att aktivering av detta alternativ kan leda till en betydande ökning av storleken på den exporterade SVG-filen. |
...
| [set_FitToViewPort](./set_fittoviewport/)(bool) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_FitToViewPort](./get_fittoviewport/). |
| [set_IdPrefix](./set_idprefix/)(const System::String\&) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_IdPrefix](./get_idprefix/). |
...
| [set_MaxImageResolution](./set_maximageresolution/)(int32_t) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_MaxImageResolution](./get_maximageresolution/). |
...
| [set_RemoveJavaScriptFromLinks](./set_removejavascriptfromlinks/)(bool) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/). |
| [set_ResourceSavingCallback](./set_resourcesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IResourceSavingCallback\>\&) | Tillåter att styra hur resurser (bilder) sparas när ett dokument exporteras till SVG-format. |
| [set_ResourcesFolder](./set_resourcesfolder/)(const System::String\&) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolder](./get_resourcesfolder/). |
| [set_ResourcesFolderAlias](./set_resourcesfolderalias/)(const System::String\&) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolderAlias](./get_resourcesfolderalias/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Anger det format som dokumentet sparas i om detta spara-alternativobjekt används. Kan endast vara [Svg](../../aspose.words/saveformat/). |
| [set_ShowPageBorder](./set_showpageborder/)(bool) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_ShowPageBorder](./get_showpageborder/). |
...
| [set_TextOutputMode](./set_textoutputmode/)(Aspose::Words::Saving::SvgTextOutputMode) | Sättare för [Aspose::Words::Saving::SvgSaveOptions::get_TextOutputMode](./get_textoutputmode/). |
