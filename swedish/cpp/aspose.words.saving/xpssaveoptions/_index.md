---
title: "Aspose::Words::Saving::XpsSaveOptions‑klass"
linktitle: "XpsSaveOptions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::XpsSaveOptions‑klass. Kan användas för att ange ytterligare alternativ när ett dokument sparas i Xps‑formatet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 38000
url: /sv/cpp/aspose.words.saving/xpssaveoptions/
---
## XpsSaveOptions class


Kan användas för att ange ytterligare alternativ när ett dokument sparas i [Xps](../../aspose.words/saveformat/) format. För att lära dig mer, besök dokumentationsartikeln [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Anger det format som dokumentet ska sparas i om detta spara-alternativobjekt används. Kan endast vara [Xps](../../aspose.words/saveformat/). |
...
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Sättare för [Aspose::Words::Saving::XpsSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Sättare för [Aspose::Words::Saving::XpsSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Sättare för [Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | Sättare för [Aspose::Words::Saving::XpsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/). |
...
| static [Type](./type/)() |  |
| [XpsSaveOptions](./xpssaveoptions/)() | Initierar en ny instans av denna klass som kan användas för att spara ett dokument i [Xps](../../aspose.words/saveformat/) format. |
| [XpsSaveOptions](./xpssaveoptions/)(Aspose::Words::SaveFormat) | Initierar en ny instans av denna klass som kan användas för att spara ett dokument i [Xps](../../aspose.words/saveformat/) eller [OpenXps](../../aspose.words/saveformat/) format. |
