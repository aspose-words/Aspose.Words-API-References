---
title: "Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat metod"
linktitle: "get_SaveFormat"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat metod. Anger det format i vilket dokumentet kommer att sparas om detta sparaalternativobjekt används. Kan endast vara Xps i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.saving/xpssaveoptions/get_saveformat/
---
## XpsSaveOptions::get_SaveFormat method


Anger det format i vilket dokumentet kommer att sparas om detta sparaalternativobjekt används. Kan endast vara [Xps](../../../aspose.words/saveformat/).
