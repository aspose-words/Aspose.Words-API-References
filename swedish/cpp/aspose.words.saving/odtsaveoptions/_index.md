...
description: "Aspose::Words::Saving::OdtSaveOptions class. Kan användas för att ange ytterligare alternativ när du sparar ett dokument i Odt- eller Ott-format. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 15000
url: /sv/cpp/aspose.words.saving/odtsaveoptions/
---
## OdtSaveOptions class


Kan användas för att ange ytterligare alternativ när du sparar ett dokument i [Odt](../../aspose.words/saveformat/) eller [Ott](../../aspose.words/saveformat/) format. För att lära dig mer, besök dokumentationsartikeln [Ange sparalternativ](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_DigitalSignatureDetails](./get_digitalsignaturedetails/)() const | Hämtar [DigitalSignatureDetails](../digitalsignaturedetails/)‑objektet som används för att signera ett dokument. |
...
| [get_IsStrictSchema11](./get_isstrictschema11/)() const | Anger om exporten ska följa ODT-specifikationen 1.1 strikt. OOo 3.0 visar filer korrekt när de innehåller element och attribut från ODT 1.2. Använd "false" för detta ändamål, eller "true" för strikt överensstämmelse med specifikation 1.1. Standardvärdet är **false**. |
| [get_MeasureUnit](./get_measureunit/)() const | Tillåter att ange måttenheter som ska tillämpas på dokumentinnehållet. Standardvärdet är [Centimeters](../odtsavemeasureunit/) |
...
| [get_Password](./get_password/)() const | Hämtar eller anger ett lösenord för att kryptera dokumentet. |
...
| [get_SaveFormat](./get_saveformat/)() override | Anger det format som dokumentet kommer att sparas i om detta spara‑alternativ‑objekt används. Kan vara [Odt](../../aspose.words/saveformat/) eller [Ott](../../aspose.words/saveformat/). |
...
| [OdtSaveOptions](./odtsaveoptions/)() | Initierar en ny instans av den här klassen som kan användas för att spara ett dokument i [Odt](../../aspose.words/saveformat/)‑formatet. |
| [OdtSaveOptions](./odtsaveoptions/)(const System::String\&) | Initierar en ny instans av den här klassen som kan användas för att spara ett dokument i [Odt](../../aspose.words/saveformat/)‑formatet krypterat med ett lösenord. |
| [OdtSaveOptions](./odtsaveoptions/)(Aspose::Words::SaveFormat) | Initierar en ny instans av den här klassen som kan användas för att spara ett dokument i [Odt](../../aspose.words/saveformat/)‑ eller [Ott](../../aspose.words/saveformat/)‑formatet. |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Anger [DigitalSignatureDetails](../digitalsignaturedetails/)‑objektet som används för att signera ett dokument. |
...
| [set_IsStrictSchema11](./set_isstrictschema11/)(bool) | Sättare för [Aspose::Words::Saving::OdtSaveOptions::get_IsStrictSchema11](./get_isstrictschema11/). |
| [set_MeasureUnit](./set_measureunit/)(Aspose::Words::Saving::OdtSaveMeasureUnit) | Sättare för [Aspose::Words::Saving::OdtSaveOptions::get_MeasureUnit](./get_measureunit/). |
...
| [set_Password](./set_password/)(const System::String\&) | Sättare för [Aspose::Words::Saving::OdtSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Sättare för [Aspose::Words::Saving::OdtSaveOptions::get_SaveFormat](./get_saveformat/). |
...
För närvarande tillhandahåller den endast egenskapen [SaveFormat](./get_saveformat/), men i framtiden kommer andra alternativ att läggas till, såsom ett krypteringslösenord eller inställningar för digital signatur.
