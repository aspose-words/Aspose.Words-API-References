---
title: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat metod"
linktitle: "get_PrettyFormat"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat metod. När true formateras utdata på ett läsbart sätt där det är tillämpligt. Standardvärdet är false i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.saving/saveoptions/get_prettyformat/
---
## SaveOptions::get_PrettyFormat method


När **true**, formaterar output snyggt där det är tillämpligt. Standardvärdet är **false**.
...
Ställ in på **true** för att göra HTML-, MHTML-, EPUB-, WordML-, RTF-, DOCX- och ODT-utdata läsbara för människor. Användbart för testning eller felsökning.

## Exempel



Visar hur man förbättrar läsbarheten av den råa koden i ett sparat .html-dokument.
```cpp
...
// Att aktivera pretty format gör den råa html-koden mer läsbar genom att lägga till tabbstopp och radbrytningstecken.
