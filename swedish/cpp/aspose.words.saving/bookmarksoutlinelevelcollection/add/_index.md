---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add metod"
linktitle: "Add"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add metod. Lägger till ett bokmärke i samlingen i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
## BookmarksOutlineLevelCollection::Add method


Lägger till ett bokmärke i samlingen.
...
| --- | --- | --- |
| namn | const System::String\& | Det skiftlägesokänsliga namnet på bokmärket som ska läggas till. |
| outlineLevel | int32_t | Outlinenivån för bokmärket. Giltigt intervall är 0 till 9. |
