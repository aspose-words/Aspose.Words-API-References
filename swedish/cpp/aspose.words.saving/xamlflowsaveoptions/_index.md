---
title: "Aspose::Words::Saving::XamlFlowSaveOptions klass"
linktitle: "XamlFlowSaveOptions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Saving::XamlFlowSaveOptions klass. Kan användas för att ange ytterligare alternativ när ett dokument sparas i XamlFlow‑ eller XamlFlowPack‑formatet. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 37000
url: /sv/cpp/aspose.words.saving/xamlflowsaveoptions/
---
## XamlFlowSaveOptions class


Kan användas för att ange ytterligare alternativ när ett dokument sparas i [XamlFlow](../../aspose.words/saveformat/) eller [XamlFlowPack](../../aspose.words/saveformat/) formatet. För att lära dig mer, besök dokumentationsartikeln [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ImageSavingCallback](./get_imagesavingcallback/)() const | Gör det möjligt att kontrollera hur bilder sparas när ett dokument sparas till XAML. |
| [get_ImagesFolder](./get_imagesfolder/)() const | Anger den fysiska mappen där bilder sparas när ett dokument exporteras till XAML-format. Standardvärdet är en tom sträng. |
| [get_ImagesFolderAlias](./get_imagesfolderalias/)() const | Anger namnet på den mapp som används för att konstruera bild‑URI:er som skrivs in i ett XAML-dokument. Standardvärdet är en tom sträng. |
...
| [get_SaveFormat](./get_saveformat/)() override | Anger det format som dokumentet kommer att sparas i om detta sparalternativ‑objekt används. Kan endast vara [XamlFlow](../../aspose.words/saveformat/). |
...
| [set_ImageSavingCallback](./set_imagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IImageSavingCallback\>\&) | Gör det möjligt att kontrollera hur bilder sparas när ett dokument sparas till XAML. |
| [set_ImagesFolder](./set_imagesfolder/)(const System::String\&) | Inställare för [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolder](./get_imagesfolder/). |
| [set_ImagesFolderAlias](./set_imagesfolderalias/)(const System::String\&) | Inställare för [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolderAlias](./get_imagesfolderalias/). |
...
| [set_ReplaceBackslashWithYenSign](./set_replacebackslashwithyensign/)(bool) | Inställare för [Aspose::Words::Saving::XamlFlowSaveOptions::get_ReplaceBackslashWithYenSign](./get_replacebackslashwithyensign/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Anger det format som dokumentet kommer att sparas i om detta sparalternativ‑objekt används. Kan endast vara [XamlFlow](../../aspose.words/saveformat/). |
...
| static [Type](./type/)() |  |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)() | Initierar en ny instans av denna klass som kan användas för att spara ett dokument i [XamlFlow](../../aspose.words/saveformat/) formatet. |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)(Aspose::Words::SaveFormat) | Initierar en ny instans av den här klassen som kan användas för att spara ett dokument i formatet [XamlFlow](../../aspose.words/saveformat/) eller [XamlFlowPack](../../aspose.words/saveformat/). |
## Se även
