---
title: "Aspose::Words::WebExtensions::BaseWebExtensionCollection::Add metod"
linktitle: "Add"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::WebExtensions::BaseWebExtensionCollection::Add metod. Lägger till angivet objekt i samlingen i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.webextensions/basewebextensioncollection/add/
---
## BaseWebExtensionCollection::Add method


Lägger till angivet objekt i samlingen.
...
| --- | --- | --- |
| objekt | T | Objekt för att lägga till. |
