...
description: "Aspose::Words::WebExtensions::WebExtensionStoreType enum. Enumererar tillgängliga typer av en web extension store i C++."
type: docs
weight: 13000
url: /sv/cpp/aspose.words.webextensions/webextensionstoretype/
---
## WebExtensionStoreType enum


Enumererar tillgängliga typer av en webb‑tilläggsbutik.
...
| --- | --- | --- |
| SPCatalog | 0 | Anger att lagertypen är SharePoint corporate catalog. |
| OMEX | 1 | Anger att lagertypen är Office.com. |
| SPApp | 2 | Anger att lagertypen är en SharePoint web application. |
| Exchange | 3 | Anger att lagertypen är en Exchange server. |
| FileSystem | 4 | Anger att lagertypen är en filsystemsdela. |
| Registry | 5 | Anger att lagertypen är systemregistret. |
| ExCatalog | 6 | Anger att lagertypen är Centralized Deployment via Exchange. |
