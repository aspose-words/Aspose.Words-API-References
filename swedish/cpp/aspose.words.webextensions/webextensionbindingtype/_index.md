...
description: "Aspose::Words::WebExtensions::WebExtensionBindingType enum. Enumererar tillgängliga typer av bindning mellan en webbutökning och data i dokumentet i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.webextensions/webextensionbindingtype/
---
## WebExtensionBindingType enum


Enumererar tillgängliga typer av bindning mellan ett webb‑tillägg och data i dokumentet.
...
| --- | --- | --- |
| Matrix | 0 | Tabulär data utan rubrikrad. |
| Table | 1 | Tabulär data med en rubrikrad. |
| Text | 2 | Oformaterad text. |
| Standard | n/a | Matris som används som standard. |
