---
title: "Aspose::Words::WebExtensions::WebExtensionReference klass"
linktitle: "WebExtensionReference"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::WebExtensions::WebExtensionReference klass. Representerar referensen till en web extension. Referensen används för att identifiera leverantörens plats och version av tillägget. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.webextensions/webextensionreference/
---
## WebExtensionReference class


Representerar referensen till ett webb‑tillägg. Referensen används för att identifiera leverantörens plats och version av tillägget. För att lära dig mer, besök dokumentationsartikeln [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_Id](./get_id/)() const | Identifierare associerad med web extension inom en katalogleverantör. |
| [get_Store](./get_store/)() const | Anger instansen av marknadsplatsen där web extension lagras. |
| [get_StoreType](./get_storetype/)() const | Anger typen av marknadsplats. |
| [get_Version](./get_version/)() const | Anger versionen av web extension. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Sättare för [Aspose::Words::WebExtensions::WebExtensionReference::get_Id](./get_id/). |
| [set_Store](./set_store/)(const System::String\&) | Sättare för [Aspose::Words::WebExtensions::WebExtensionReference::get_Store](./get_store/). |
| [set_StoreType](./set_storetype/)(Aspose::Words::WebExtensions::WebExtensionStoreType) | Sättare för [Aspose::Words::WebExtensions::WebExtensionReference::get_StoreType](./get_storetype/). |
| [set_Version](./set_version/)(const System::String\&) | Sättare för [Aspose::Words::WebExtensions::WebExtensionReference::get_Version](./get_version/). |
| static [Type](./type/)() |  |
