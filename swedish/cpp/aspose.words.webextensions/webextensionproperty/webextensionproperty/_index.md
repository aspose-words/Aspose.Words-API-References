...
description: "Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty konstruktor. Skapar en anpassad egenskap för webb‑tillägg med angivet namn och värde i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.webextensions/webextensionproperty/webextensionproperty/
---
## WebExtensionProperty::WebExtensionProperty constructor


Skapar en anpassad egenskap för webbläsartillägg med angivet namn och värde.
...
| --- | --- | --- |
| namn | const System::String\& | Egenskapsnamn. |
| value | const System::String\& | Egenskapsvärde. |
