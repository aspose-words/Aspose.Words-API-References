---
title: "Aspose::Words::WebExtensions::TaskPane klass"
linktitle: "TaskPane"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::WebExtensions::TaskPane klass. Representerar ett tilläggs‑uppgiftsfönsterobjekt. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.webextensions/taskpane/
---
## TaskPane class


Representerar ett tilläggs-uppgiftspanel-objekt. För att lära dig mer, besök dokumentationsartikeln [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_DockState](./get_dockstate/)() const | Anger den senast dockade platsen för detta uppgiftsfönsterobjekt. |
| [get_IsLocked](./get_islocked/)() const | Anger om uppgiftsfönstret är låst till dokumentet i UI och inte kan stängas av användaren. |
| [get_IsVisible](./get_isvisible/)() const | Anger om uppgiftsfönstret visas som synligt som standard när dokumentet öppnas. |
| [get_Row](./get_row/)() const | Anger index, räknat från utsidan till insidan, för detta uppgiftsfönster bland andra bestående uppgiftsfönster som är dockade på samma standardplats. |
| [get_WebExtension](./get_webextension/)() const | Representerar ett webbläsartilläggsobjekt. |
| [get_Width](./get_width/)() const | Anger standardbreddvärdet för denna uppgiftsfönsterinstans. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DockState](./set_dockstate/)(Aspose::Words::WebExtensions::TaskPaneDockState) | Settare för [Aspose::Words::WebExtensions::TaskPane::get_DockState](./get_dockstate/). |
| [set_IsLocked](./set_islocked/)(bool) | Settare för [Aspose::Words::WebExtensions::TaskPane::get_IsLocked](./get_islocked/). |
| [set_IsVisible](./set_isvisible/)(bool) | Settare för [Aspose::Words::WebExtensions::TaskPane::get_IsVisible](./get_isvisible/). |
| [set_Row](./set_row/)(int32_t) | Settare för [Aspose::Words::WebExtensions::TaskPane::get_Row](./get_row/). |
| [set_Width](./set_width/)(double) | Settare för [Aspose::Words::WebExtensions::TaskPane::get_Width](./get_width/). |
| [TaskPane](./taskpane/)() |  |
| static [Type](./type/)() |  |
