---
title: "Aspose::Words::Replacing::FindReplaceOptions::get_IgnoreShapes metod"
linktitle: "get_IgnoreShapes"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Replacing::FindReplaceOptions::get_IgnoreShapes metod. Hämtar eller anger ett booleskt värde som indikerar om former ska ignoreras inom en text. Standardvärdet är false i C++."
type: docs
weight: 11500
url: /sv/cpp/aspose.words.replacing/findreplaceoptions/get_ignoreshapes/
---
## FindReplaceOptions::get_IgnoreShapes method


Hämtar eller anger ett booleskt värde som indikerar om former inom en text ska ignoreras. Standardvärdet är **false**.
...
Visar hur man ignorerar former medan man ersätter text.
```cpp
