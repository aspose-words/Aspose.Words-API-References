...
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition method. Returnerar true om denna lista är en definition av en liststil i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
## List::get_IsListStyleDefinition method


Returnerar **true** om den här listan är en definition av en liststil.
...
När den här egenskapen är **true**, returnerar [Style](../get_style/) egenskapen den liststil som denna lista definierar.

Genom att ändra egenskaperna för en lista som definierar en liststil, ändrar du egenskaperna för liststilen.

En lista som är en definition av en liststil kan inte tillämpas direkt på stycken för att numrera dem.
