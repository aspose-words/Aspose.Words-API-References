...
description: "Aspose::Words::Lists::List::get_IsMultiLevel method. Returnerar true när listan innehåller 9 nivåer; false när den har 1 nivå i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words.lists/list/get_ismultilevel/
---
## List::get_IsMultiLevel method


Returnerar **true** när listan innehåller 9 nivåer; **false** när den har 1 nivå.
...
Microsoft Word 2003 och senare skapar alltid flernivålistor med 9 nivåer. Men i vissa dokument, skapade med tidigare versioner av Microsoft Word, kan du stöta på listor som bara har 1 nivå.
