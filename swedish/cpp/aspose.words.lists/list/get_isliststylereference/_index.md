...
description: "Aspose::Words::Lists::List::get_IsListStyleReference metod. Returnerar true om denna lista är en referens till en liststil i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.lists/list/get_isliststylereference/
---
## List::get_IsListStyleReference method


Returnerar **true** om den här listan är en referens till en liststil.
...
Observera att ändring av egenskaper för en lista som är en referens till en liststil inte har någon effekt. Formateringen av listan som anges i själva liststilen har alltid företräde.
