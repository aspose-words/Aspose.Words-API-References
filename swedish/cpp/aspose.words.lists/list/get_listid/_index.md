...
description: "Aspose::Words::Lists::List::get_ListId method. Hämtar listans unika identifierare i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.lists/list/get_listid/
---
...
Du behöver normalt inte använda den här egenskapen. Men om du använder den, gör du det normalt i samband med metoden [GetListByListId()](../../listcollection/getlistbylistid/) för att hitta en lista efter dess identifierare.
