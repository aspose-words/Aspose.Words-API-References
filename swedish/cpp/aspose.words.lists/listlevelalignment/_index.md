...
description: "Aspose::Words::Lists::ListLevelAlignment enum. Anger justering för listnumret eller punkttecknet i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words.lists/listlevelalignment/
---
## ListLevelAlignment enum


Anger justering för listnumret eller punkttecknet.
...
| --- | --- | --- |
| Vänster | 0 | Listetiketten är justerad till vänster om nummerpositionen. |
| Centrerad | 1 | Listetiketten är centrerad vid nummerpositionen. |
| Höger | 2 | Denna listetikett är justerad till höger om nummerpositionen. |

## Anmärkningar


Används som ett värde för egenskapen [Alignment](../listlevel/get_alignment/).
