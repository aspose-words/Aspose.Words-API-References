---
title: "Aspose::Words::Lists::ListLabel-klass"
linktitle: "ListLabel"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Lists::ListLabel-klass. Definierar egenskaper som är specifika för en listetikett. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.lists/listlabel/
---
## ListLabel class


Definierar egenskaper specifika för en listetikett. För att lära dig mer, besök dokumentationsartikeln [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/).
...
| Metod | Beskrivning |
| --- | --- |
| [get_Font](./get_font/)() | Hämtar listetikettens teckensnitt. |
| [get_LabelString](./get_labelstring/)() | Hämtar en strängrepresentation av listetiketten. |
| [get_LabelValue](./get_labelvalue/)() | Hämtar ett numeriskt värde för denna etikett. |
