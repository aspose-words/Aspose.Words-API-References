...
description: "Aspose::Words::Lists::ListTrailingCharacter enum. Anger tecknet som separerar listetiketten från styckets text i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.lists/listtrailingcharacter/
---
...
| --- | --- | --- |
| Tabb | 0 | Ett tabbtecken placeras mellan listetiketten och styckets text. |
| Mellanslag | 1 | Ett mellanslag placeras mellan listetiketten och styckets text. |
| Ingenting | 2 | Det finns inget separator-tecken mellan listetiketten och texten i stycket. |

## Anmärkningar


Används som ett värde för egenskapen [TrailingCharacter](../listlevel/get_trailingcharacter/).
