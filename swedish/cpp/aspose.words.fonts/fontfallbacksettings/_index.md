---
title: "Aspose::Words::Fonts::FontFallbackSettings-klass"
linktitle: "FontFallbackSettings"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Fonts::FontFallbackSettings-klass. Anger inställningar för typsnittsfallback‑mekanism. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words.fonts/fontfallbacksettings/
---
## FontFallbackSettings class


Anger inställningar för teckensnittets reservmekanism. För att lära dig mer, besök dokumentationsartikeln [Working with Fonts](https://docs.aspose.com/words/cpp/working-with-fonts/).
...
| Metod | Beskrivning |
| --- | --- |
| [BuildAutomatic](./buildautomatic/)() | Bygger automatiskt fallback‑inställningarna genom att skanna tillgängliga typsnitt. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Load](./load/)(const System::String\&) | Läser in typsnittsfallback‑inställningar från XML‑fil. |
| [Load](./load/)(const System::SharedPtr\<System::IO::Stream\>\&) | Läser in fallback‑inställningar från XML‑ström. |
| [Load](./load/)(std::basic_istream\<CharType, Traits\>\&) |  |
| [LoadMsOfficeFallbackSettings](./loadmsofficefallbacksettings/)() | Läser in fördefinierade fallback‑inställningar som efterliknar Microsoft Word-fallback och använder Microsoft Office‑typsnitt. |
| [LoadNotoFallbackSettings](./loadnotofallbacksettings/)() | Läser in fördefinierade fallback‑inställningar som använder Google Noto‑typsnitt. |
| [Save](./save/)(const System::SharedPtr\<System::IO::Stream\>\&) | Sparar de aktuella fallback‑inställningarna till strömmen. |
| [Save](./save/)(const System::String\&) | Sparar de aktuella fallback‑inställningarna till filen. |
