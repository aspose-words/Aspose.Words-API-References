...
description: "Aspose::Words::Fonts::FontPitch enum. Representerar teckensnittets pitch i C++."
type: docs
weight: 22000
url: /sv/cpp/aspose.words.fonts/fontpitch/
---
## FontPitch enum


Representerar teckensnittets pitch.
...
| --- | --- | --- |
| Standard | 0 | Anger att ingen information är tillgänglig om ett teckensnittets pitch. |
| Fast | 1 | Anger att detta är ett teckensnitt med fast bredd. |
| Variabel | 2 | Anger att detta är ett teckensnitt med proportionell bredd. |
