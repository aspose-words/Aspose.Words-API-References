...
description: "Aspose::Words::Loading::PdfLoadOptions-klass. Tillåter att ange ytterligare alternativ när en Pdf-dokument laddas in i ett Document-objekt. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.loading/pdfloadoptions/
---
## PdfLoadOptions class


Tillåter att ange ytterligare alternativ när ett Pdf-dokument laddas in i ett [Document](../../aspose.words/document/)-objekt. För att lära dig mer, besök dokumentationsartikeln [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_PageCount](./get_pagecount/)() const | Hämtar antalet sidor som ska läsas. Standard är MaxValue vilket betyder att alla dokumentets sidor kommer att läsas. |
| [get_PageIndex](./get_pageindex/)() const | Hämtar det 0-baserade indexet för den första sidan som ska läsas. Standard är 0. |
...
| [get_SkipPdfImages](./get_skippdfimages/)() const | Hämtar flaggan som indikerar om bilder måste hoppas över vid inläsning av PDF-dokument. Standard är **false**. |
...
| [set_PageCount](./set_pagecount/)(int32_t) | Ställer in antalet sidor som ska läsas. Standard är MaxValue vilket betyder att alla dokumentets sidor kommer att läsas. |
| [set_PageIndex](./set_pageindex/)(int32_t) | Ställer in det 0-baserade indexet för den första sidan som ska läsas. Standard är 0. |
...
| [set_SkipPdfImages](./set_skippdfimages/)(bool) | Ställer in flaggan som indikerar om bilder måste hoppas över vid inläsning av PDF-dokument. Standard är **false**. |
