...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. Anger tillgängliga alternativ för hantering av inledande mellanslag vid import från en Text-fil i C++."
type: docs
weight: 18000
url: /sv/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Anger tillgängliga alternativ för hantering av inledande mellanslag vid import från [Text](../../aspose.words/loadformat/)-fil.
...
| --- | --- | --- |
| ConvertToIndent | 0 | Inledande mellanslag tas bort och konverteras till vänster indrag. |
| Trimma | 1 | Inledande mellanslag trimmas. |
| Bevara | 2 | Inledande mellanslag bevaras. |
