---
title: "Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions-metod"
linktitle: "get_TrailingSpacesOptions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions-metod. Hämtar eller anger föredragen inställning för hantering av efterföljande mellanslag. Standardvärdet är Trim i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words.loading/txtloadoptions/get_trailingspacesoptions/
---
## TxtLoadOptions::get_TrailingSpacesOptions method


Hämtar eller anger föredragen inställning för hantering av efterföljande mellanslag. Standardvärdet är [Trim](../../txttrailingspacesoptions/).
