...
description: "Aspose::Words::Markup::CustomXmlPartCollection::GetById method. Hittar och returnerar en anpassad XML-del med dess identifierare i C++."
type: docs
weight: 11000
url: /sv/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
...
| --- | --- | --- |
| id | const System::String\& | Skiftlägeskänslig sträng som identifierar den anpassade XML-delen. |
