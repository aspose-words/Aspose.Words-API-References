...
description: "Aspose::Words::Markup::CustomXmlPartCollection::Add method. Lägger till ett objekt i samlingen i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| --- | --- | --- |
| del | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Den anpassade XML-delen att lägga till. |
...
Skapar en ny XML-del med den angivna XML:n och lägger till den i samlingen.
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| id | const System::String\& | Identifierare för en ny anpassad XML-del. |
| xml | const System::String\& | XML-data för delen. |
