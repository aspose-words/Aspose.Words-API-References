---
title: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue metod"
linktitle: "get_SelectedValue"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue metod. Anger det för närvarande valda värdet i den här listan. Nullvärde tillåtet, vilket betyder att ingen för närvarande vald post är associerad med denna SdtListItem-samling i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


Anger det för närvarande valda värdet i denna lista. Null‑värde tillåtet, vilket betyder att ingen för närvarande vald post är associerad med denna listobjektsamling.
