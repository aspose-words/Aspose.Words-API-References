---
title: "Aspose::Words::Markup::CustomXmlProperty::get_Uri‑metod"
linktitle: "get_Uri"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Markup::CustomXmlProperty::get_Uri‑metod. Hämtar eller anger namnrymd‑URI för det anpassade XML‑attributet eller smart‑taggens egenskap i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.markup/customxmlproperty/get_uri/
---
## CustomXmlProperty::get_Uri method


Hämtar eller anger namnrymdens URI för det anpassade XML‑attributet eller smart‑tagg‑egenskapen.
