---
title: "Aspose::Words::Markup::XmlMapping::SetMapping‑metod"
linktitle: "SetMapping"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Markup::XmlMapping::SetMapping‑metod. Ställer in en mappning mellan den överordnade structured document tag och en XML‑nod i en anpassad XML‑datadel i C++."
type: docs
weight: 10000
url: /sv/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


Ställer in en mappning mellan det överordnade strukturerade dokumenttagget och en XML-nod i en anpassad XML-datadelfil.
...
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | En anpassad XML‑datadel att mappa till. |
| xPath | const System::String\& | Ett XPath‑uttryck för att hitta XML‑noden. |
| prefixMapping | const System::String\& | XML-namnrymdsprefixmappningar för att utvärdera XPath. |

### ReturnValue

En flagga som indikerar om den överordnade strukturerade dokumenttaggen har mappats framgångsrikt till XML-noden.
