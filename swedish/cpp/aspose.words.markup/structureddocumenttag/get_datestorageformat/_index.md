...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat method. Hämtar/anger formatet i vilket datum för ett datum‑SDT lagras när SDT är bunden till en XML‑nod i dokumentets datalager. Standardvärdet är DateTime i C++."
type: docs
weight: 14000
url: /sv/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


Hämtar/anger formatet i vilket datum för ett datum‑SDT lagras när **SDT** är bunden till en XML‑nod i dokumentets datalager. Standardvärdet är [DateTime](../../sdtdatestorageformat/)
