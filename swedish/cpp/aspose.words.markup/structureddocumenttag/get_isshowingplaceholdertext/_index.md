...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText method. Anger om innehållet i detta SDT ska tolkas som att det innehåller platshållartext (i motsats till vanlig textinnehåll inom SDT). Om den är satt till true återupptas detta tillstånd (visar platshållartext) när dokumentet öppnas i C++."
type: docs
weight: 18000
url: /sv/cpp/aspose.words.markup/structureddocumenttag/get_isshowingplaceholdertext/
---
## StructuredDocumentTag::get_IsShowingPlaceholderText method


Anger om innehållet i detta **SDT** ska tolkas som att det innehåller platshållartext (i motsats till vanlig textinnehåll i SDT). om den är satt till **true** återupptas detta tillstånd (visar platshållartext) när dokumentet öppnas.
