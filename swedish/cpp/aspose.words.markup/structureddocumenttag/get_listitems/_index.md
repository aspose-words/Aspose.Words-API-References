---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems metod"
linktitle: "get_ListItems"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems metod. Hämtar SdtListItemCollection associerad med detta SDT i C++."
type: docs
weight: 21000
url: /sv/cpp/aspose.words.markup/structureddocumenttag/get_listitems/
---
## StructuredDocumentTag::get_ListItems method


Hämtar [SdtListItemCollection](../../sdtlistitemcollection/) som är associerad med detta **SDT**.
...
Att komma åt den här egenskapen fungerar endast för [ComboBox](../../sdttype/) eller [DropDownList](../../sdttype/) SDT-typer.
