...
description: "Aspose::Words::Drawing::ShapeBase::get_Left method. Hämtar eller anger positionen för den vänstra kanten av den innehållande blocket för formen i C++."
type: docs
weight: 38000
url: /sv/cpp/aspose.words.drawing/shapebase/get_left/
---
## ShapeBase::get_Left method


Hämtar eller anger positionen för den vänstra kanten av den omgivande blocket för formen.
