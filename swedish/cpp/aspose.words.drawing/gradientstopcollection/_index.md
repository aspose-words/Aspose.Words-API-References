...
description: "Aspose::Words::Drawing::GradientStopCollection-klass. Innehåller en samling av GradientStop-objekt. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.drawing/gradientstopcollection/
---
## GradientStopCollection class


Innehåller en samling av [GradientStop](../gradientstop/) objekt. För att lära dig mer, besök dokumentationsartikeln [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/).
...
| Metod | Beskrivning |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Lägger till en specificerad [GradientStop](../gradientstop/) till en gradient. |
| [get_Count](./get_count/)() | Hämtar ett heltalsvärde som indikerar antalet objekt i samlingen. |
| [GetEnumerator](./getenumerator/)() override | Returnerar en enumerator som itererar genom samlingen. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Hämtar eller anger ett [GradientStop](../gradientstop/) objekt i samlingen. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Hämtar eller anger ett [GradientStop](../gradientstop/) objekt i samlingen. |
| [Insert](./insert/)(int32_t, const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Infogar ett [GradientStop](../gradientstop/) i samlingen på ett specificerat index. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Tar bort ett specificerat [GradientStop](../gradientstop/) från samlingen. |
| [RemoveAt](./removeat/)(int32_t) | Tar bort ett [GradientStop](../gradientstop/) från samlingen på ett specificerat index. |
| static [Type](./type/)() |  |
