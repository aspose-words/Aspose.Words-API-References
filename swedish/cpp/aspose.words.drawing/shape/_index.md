...
description: "Aspose::Words::Drawing::Shape class. Representerar ett objekt i ritlagret, såsom en AutoShape, textruta, friform, OLE-objekt, ActiveX-kontroll eller bild. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 11000
url: /sv/cpp/aspose.words.drawing/shape/
---
## Shape class


Representerar ett objekt i ritlagret, såsom en AutoShape, textruta, frihandsform, OLE‑objekt, ActiveX‑kontroll eller bild. För att lära dig mer, besök dokumentationsartikeln [Working with Shapes](https://docs.aspose.com/words/cpp/working-with-shapes/).
...
| [AcceptEnd](./acceptend/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Accepterar en besökare för att besöka formens slut. |
| [AcceptStart](./acceptstart/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Accepterar en besökare för att besöka formens början. |
...
| [get_Adjustments](./get_adjustments/)() | Tillhandahåller åtkomst till justeringsråvärdena för en form. För en form som inte innehåller några justeringsråvärden returneras en tom samling. |
...
| [get_Chart](./get_chart/)() | Tillhandahåller åtkomst till diagrammets egenskaper om denna form har ett [Chart](../../aspose.words.drawing.charts/chart/). |
...
| [get_ExtrusionEnabled](./get_extrusionenabled/)() | Returnerar **true** om en extruderings‑effekt är aktiverad. |
| [get_Fill](../shapebase/get_fill/)() | Hämtar fyllningsformatering för formen. |
| [get_FillColor](./get_fillcolor/)() | Definierar penselfärgen som fyller den slutna banan för formen. |
| [get_Filled](./get_filled/)() | Bestämmer om den slutna banan för formen ska fyllas. |
| [get_FirstChild](../../aspose.words/compositenode/get_firstchild/)() const | Hämtar det första barnet till noden. |
| [get_FirstParagraph](./get_firstparagraph/)() | Hämtar det första stycket i formen. |
...
| [get_HasChart](./get_haschart/)() | Returnerar **true** om detta [Shape](./) har ett [Chart](../../aspose.words.drawing.charts/chart/). |
...
| [get_HasSmartArt](./get_hassmartart/)() | Returnerar **true** om detta [Shape](./) har ett SmartArt‑objekt. |
...
| [get_HorizontalRuleFormat](./get_horizontalruleformat/)() | Tillhandahåller åtkomst till egenskaperna för den horisontella linjeformen. För en form som inte är en horisontell linje returneras **null**. |
| [get_HRef](../shapebase/get_href/)() | Hämtar eller anger den fullständiga hyperlänkadressen för en form. |
| [get_ImageData](./get_imagedata/)() | Tillhandahåller åtkomst till bilden för formen. Returnerar **null** om formen inte kan ha en bild. |
...
| [get_LastParagraph](./get_lastparagraph/)() | Hämtar det sista stycket i formen. |
...
| [get_NodeType](./get_nodetype/)() const override | Returnerar [Shape](../../aspose.words/nodetype/). |
| [get_OleFormat](./get_oleformat/)() | Tillhandahåller åtkomst till OLE‑data för en form. För en form som inte är ett OLE‑objekt eller ActiveX‑kontroll returneras **null**. |
...
| [get_ShadowEnabled](./get_shadowenabled/)() | Returnerar **true** om en skuggeffekt är aktiverad. |
...
| [get_SignatureLine](./get_signatureline/)() | Hämtar [SignatureLine](../signatureline/)-objektet om formen är en signaturlinje. Returnerar **null** annars. |
...
| [get_StoryType](./get_storytype/)() | Returnerar [Textbox](../../aspose.words/storytype/). |
| [get_Stroke](./get_stroke/)() | Definierar en linje för en form. |
| [get_StrokeColor](./get_strokecolor/)() | Definierar färgen på ett streck. |
| [get_Stroked](./get_stroked/)() | Definierar om vägen ska streckas. |
| [get_StrokeWeight](./get_strokeweight/)() | Definierar penselns tjocklek som streckar en formens bana i punkter. |
| [get_Target](../shapebase/get_target/)() | Hämtar eller anger målramen för formens hyperlänk. |
| [get_TextBox](./get_textbox/)() | Definierar attribut som anger hur text visas i en form. |
| [get_TextPath](./get_textpath/)() | Definierar texten för textvägen (för ett WordArt‑objekt). |
...
| [set_FillColor](./set_fillcolor/)(System::Drawing::Color) | Sättare för [Aspose::Words::Drawing::Shape::get_FillColor](./get_fillcolor/). |
| [set_Filled](./set_filled/)(bool) | Sättare för [Aspose::Words::Drawing::Shape::get_Filled](./get_filled/). |
...
| [set_StrokeColor](./set_strokecolor/)(System::Drawing::Color) | Sättare för [Aspose::Words::Drawing::Shape::get_StrokeColor](./get_strokecolor/). |
| [set_Stroked](./set_stroked/)(bool) | Sättare för [Aspose::Words::Drawing::Shape::get_Stroked](./get_stroked/). |
| [set_StrokeWeight](./set_strokeweight/)(double) | Sättare för [Aspose::Words::Drawing::Shape::get_StrokeWeight](./get_strokeweight/). |
...
| [Shape](./shape/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, Aspose::Words::Drawing::ShapeType) | Skapar ett nytt form‑objekt. |
...
| static [Type](./type/)() |  |
| [UpdateSmartArtDrawing](./updatesmartartdrawing/)() | Uppdaterar förrenderad SmartArt‑ritning genom att använda [Aspose.Words](../../aspose.words/)'s SmartArt‑kalla renderingsmotor. |
## Anmärkningar


Genom att använda [Shape](./)-klassen kan du skapa eller ändra former i ett Microsoft Word‑dokument.

En viktig egenskap hos en form är dess [ShapeType](../shapebase/get_shapetype/). Former av olika typer kan ha olika funktioner i ett Word‑dokument. Till exempel kan endast bild‑ och OLE‑former ha bilder inuti dem. De flesta former kan ha text, men inte alla.
...
// Infoga två former tillsammans med en gruppform som innehåller en annan form.
...
// Alla former är borta, men gruppformen finns fortfarande i dokumentet.
ASSERT_EQ(1, doc->GetChildNodes(Aspose::Words::NodeType::GroupShape, true)->get_Count());
