---
title: "Aspose::Words::Drawing::ImageData::get_Brightness‑metod"
linktitle: "get_Brightness"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::ImageData::get_Brightness‑metod. Hämtar eller anger bildens ljusstyrka. Värdet för denna egenskap måste vara ett tal mellan 0,0 (mörkast) och 1,0 (ljusast) i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.drawing/imagedata/get_brightness/
---
## ImageData::get_Brightness method


Hämtar eller anger bildens ljusstyrka. Värdet för denna egenskap måste vara ett tal mellan 0.0 (mörkast) till 1.0 (ljusast).
