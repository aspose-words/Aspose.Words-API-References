---
title: "Aspose::Words::Drawing::ImageData::get_Contrast metod"
linktitle: "get_Contrast"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::ImageData::get_Contrast metod. Hämtar eller anger kontrasten för den angivna bilden. Värdet för denna egenskap måste vara ett tal mellan 0.0 (minsta kontrast) och 1.0 (största kontrast) i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.drawing/imagedata/get_contrast/
---
## ImageData::get_Contrast method


Hämtar eller anger kontrasten för den angivna bilden. Värdet för denna egenskap måste vara ett tal mellan 0.0 (minsta kontrast) till 1.0 (största kontrast).
