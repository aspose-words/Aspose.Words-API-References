---
title: "Aspose::Words::Drawing::ImageData::get_CropLeft metod"
linktitle: "get_CropLeft"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::ImageData::get_CropLeft metod. Definierar andelen av bildborttagning från vänstra sidan i C++."
type: docs
weight: 8000
url: /sv/cpp/aspose.words.drawing/imagedata/get_cropleft/
---
## ImageData::get_CropLeft method


Definierar andelen av bildens borttagning från den vänstra sidan.
...
Mängden beskärning kan variera från -1,0 till 1,0. Standardvärdet är 0. Observera att ett värde på 1 kommer att visa ingen bild alls. Negativa värden gör att bilden pressas inåt från den kant som beskärs (det tomma utrymmet mellan bilden och den beskärda kanten fylls med figurens fyllningsfärg). Positiva värden mindre än 1 gör att den återstående bilden sträcks för att passa figuren.
