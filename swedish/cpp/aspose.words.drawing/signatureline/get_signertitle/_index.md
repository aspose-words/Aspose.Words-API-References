---
title: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle metod"
linktitle: "get_SignerTitle"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle metod. Hämtar eller anger föreslagen signerares titel (till exempel Manager). Standardvärdet för denna egenskap är en tom sträng i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.drawing/signatureline/get_signertitle/
---
## SignatureLine::get_SignerTitle method


Hämtar eller anger föreslagen undertecknares titel (till exempel Chef). Standardvärdet för denna egenskap är **empty string**.
