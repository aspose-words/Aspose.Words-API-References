---
title: "Aspose::Words::Drawing::SignatureLine::get_Instructions‑metod"
linktitle: "get_Instructions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::SignatureLine::get_Instructions‑metod. Hämtar eller anger instruktioner till undertecknaren som visas när signaturlinjen signeras. Denna egenskap ignoreras om DefaultInstructions är angivet. Standardvärdet för denna egenskap är en tom sträng i C++."
type: docs
weight: 6000
url: /sv/cpp/aspose.words.drawing/signatureline/get_instructions/
---
## SignatureLine::get_Instructions method


Hämtar eller anger instruktioner till undertecknaren som visas när signaturlinjen signeras. Denna egenskap ignoreras om [DefaultInstructions](../get_defaultinstructions/) är angivet. Standardvärdet för denna egenskap är **empty string**.
