---
title: "Aspose::Words::Drawing::SignatureLine::get_Signer‑metod"
linktitle: "get_Signer"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::SignatureLine::get_Signer‑metod. Hämtar eller anger föreslagen undertecknare för signaturlinjen. Standardvärdet för denna egenskap är en tom sträng i C++."
type: docs
weight: 11000
url: /sv/cpp/aspose.words.drawing/signatureline/get_signer/
---
## SignatureLine::get_Signer method


Hämtar eller anger föreslagen undertecknare för signaturlinjen. Standardvärdet för denna egenskap är **empty string**.
