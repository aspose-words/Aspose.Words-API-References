---
title: "Aspose::Words::Drawing::SignatureLine::get_DefaultInstructions metod"
linktitle: "get_DefaultInstructions"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::SignatureLine::get_DefaultInstructions metod. Hämtar eller anger ett värde som indikerar att standardinstruktioner visas i Sign‑dialogen. Standardvärdet för denna egenskap är true i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.drawing/signatureline/get_defaultinstructions/
---
## SignatureLine::get_DefaultInstructions method


Hämtar eller anger ett värde som indikerar att standardinstruktioner visas i Sign-dialogen. Standardvärdet för denna egenskap är **true**.
