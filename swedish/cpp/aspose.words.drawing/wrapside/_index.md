...
description: "Aspose::Words::Drawing::WrapSide enum. Anger vilken/vilka sida/er av formen eller bilden som texten flödar runt i C++."
type: docs
weight: 44000
url: /sv/cpp/aspose.words.drawing/wrapside/
---
## WrapSide enum


Anger vilken(a) sida(or) av formen eller bilden som texten omsluter.
...
| --- | --- | --- |
| Both | 0 | Dokumenttexten flödar runt på båda sidor av formen. |
| Vänster | 1 | Dokumenttexten flödar runt endast på vänstra sidan av formen. Det finns ett textfritt område på högra sidan av formen. |
| Höger | 2 | Dokumenttexten flödar runt endast på högra sidan av formen. Det finns ett textfritt område på vänstra sidan av formen. |
| Störst | 3 | Dokumenttexten flödar runt på den sida av formen som är längst bort från sidmarginalen, vilket lämnar ett textfritt område på den andra sidan av formen. |
| Default | n/a | Standardvärdet är [Both](./). |
