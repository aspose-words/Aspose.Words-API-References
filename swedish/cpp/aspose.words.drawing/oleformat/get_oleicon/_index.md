...
description: "Aspose::Words::Drawing::OleFormat::get_OleIcon method. Hämtar ritaspekten för OLE-objektet. När true visas OLE-objektet som en ikon. När false visas OLE-objektet som innehåll i C++."
type: docs
weight: 8000
url: /sv/cpp/aspose.words.drawing/oleformat/get_oleicon/
---
## OleFormat::get_OleIcon method


Hämtar ritningsaspekten för OLE-objektet. När **true** visas OLE-objektet som en ikon. När **false** visas OLE-objektet som innehåll.
...
Aspose.Words tillåter inte att denna egenskap sätts för att undvika förvirring. Om du kunde ändra ritaspekten i Aspose.Words skulle Microsoft Word fortfarande visa OLE-objektet i dess ursprungliga ritaspekt tills du redigerar eller uppdaterar OLE-objektet i Microsoft Word.
