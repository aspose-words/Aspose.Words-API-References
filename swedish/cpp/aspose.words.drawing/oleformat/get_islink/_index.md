---
title: "Aspose::Words::Drawing::OleFormat::get_IsLink metod"
linktitle: "get_IsLink"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::OleFormat::get_IsLink metod. Returnerar true om OLE-objektet är länkat (när SourceFullName är angivet) i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words.drawing/oleformat/get_islink/
---
## OleFormat::get_IsLink method


Returnerar **true** om OLE-objektet är länkat (när [SourceFullName](../get_sourcefullname/) är angivet).
