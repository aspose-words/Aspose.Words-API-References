---
title: "Aspose::Words::Drawing::OleFormat::get_SourceItem metod"
linktitle: "get_SourceItem"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::OleFormat::get_SourceItem metod. Hämtar eller anger en sträng som används för att identifiera den del av källfilen som länkas i C++."
type: docs
weight: 12000
url: /sv/cpp/aspose.words.drawing/oleformat/get_sourceitem/
---
...
Till exempel, om källfilen är en Microsoft Excel‑arbetsbok, kan egenskapen [SourceItem](./) returnera "Workbook1!R3C1:R4C2" om OLE‑objektet bara innehåller några celler från kalkylbladet.
