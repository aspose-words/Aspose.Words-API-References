...
description: "Aspose::Words::Drawing::GradientStop::GradientStop konstruktor. Initierar en ny instans av GradientStop-klassen i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
## GradientStop::GradientStop(System::Drawing::Color, double) constructor


Initierar en ny instans av klassen [GradientStop](../).
...
| --- | --- | --- |
| color | System::Drawing::Color | Representerar färgen på gradientstoppet. |
...
| color | System::Drawing::Color | Representerar färgen på gradientstoppet. |
| position | double | Representerar positionen för ett stopp inom gradienten uttryckt som en procent i intervallet 0.0 till 1.0. |
| transparens | double | Representerar transparensen för ett stopp inom gradienten uttryckt som en procent i intervallet 0.0 till 1.0. |
