...
description: "Aspose::Words::Drawing::FillType enum. Anger fyllningstyp för ett fyllbart objekt i C++."
type: docs
weight: 22000
url: /sv/cpp/aspose.words.drawing/filltype/
---
## FillType enum


Anger fyllnadstyp för ett fyllbart objekt.
...
| --- | --- | --- |
| Solid | 1 | Solid fyllning. |
| Mönstrad | 2 | Mönstrad fyllning. |
| Gradient | 3 | Gradient fyllning. |
| Texturerad | 4 | Texturerad fyllning. |
| Background | 5 | [Fill](../fill/) är samma som bakgrunden. |
| Bild | 6 | Bildfyllning. |
