...
description: "Aspose::Words::Bibliography::Person class. Representerar en individuell (en person) bibliografikällas bidragsgivare i C++."
type: docs
weight: 625
url: /sv/cpp/aspose.words.bibliography/person/
---
## Person class


Representerar en individuell (person) bibliografisk källbidragsgivare.
...
| [get_First](./get_first/)() const | Hämtar eller anger förnamnet på en person. |
| [get_Last](./get_last/)() const | Hämtar eller anger efternamnet på en person. |
| [get_Middle](./get_middle/)() const | Hämtar eller anger mellannamnet på en person. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Initierar en ny instans av klassen [Person](./). |
| [set_First](./set_first/)(const System::String\&) | Sättare för [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | Sättare för [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | Sättare för [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
