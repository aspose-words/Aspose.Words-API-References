...
description: "Aspose::Words::Bibliography::SourceType enum. Representerar bibliografiska källtyper i C++."
type: docs
weight: 1000
url: /sv/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum


Representerar typer av bibliografiska källor.
...
| --- | --- | --- |
| ArticleInAPeriodical | 0 | Anger artikeln i en tidskriftskälla. |
| Book | 1 | Anger bokkällan. |
| BookSection | 2 | Anger källan för bokavsnittet. |
| JournalArticle | 3 | Anger källan för tidskriftsartikeln. |
| ConferenceProceedings | 4 | Anger källan för konferenshandlingarna. |
| Report | 5 | Anger källan för rapportören. |
| SoundRecording | 6 | Anger källan för ljudinspelningen. |
| Performance | 7 | Anger källan för föreställningen. |
| Art | 8 | Anger källan för konsten. |
| DocumentFromInternetSite | 9 | Anger källan för dokumentet från webbplatsen. |
| InternetSite | 10 | Anger källan för webbplatsen. |
| Film | 11 | Anger källan för filmen. |
| Interview | 12 | Anger källan för intervjun. |
| Patent | 13 | Anger källan för patentet. |
| Elektronisk | 14 | Anger den elektroniska källan. |
| Fall | 15 | Anger källan för fall. |
| Övrigt | 16 | Anger den blandade källan. |
