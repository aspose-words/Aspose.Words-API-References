...
description: "Aspose::Words::Bibliography::PersonCollection class. Representerar en lista över personer som är bidragsgivare till bibliografikällor i C++."
type: docs
weight: 750
url: /sv/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Representerar en lista över personer som är bibliografiska källbidragsgivare.
...
| Metod | Beskrivning |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Lägger till en [Person](../person/) i samlingen. |
| [Clear](./clear/)() | Tar bort alla objekt från samlingen. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Avgör om samlingen innehåller en specifik person. |
| [get_Count](./get_count/)() | Hämtar antalet personer som finns i samlingen. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Hämtar eller anger en person på det angivna indexet. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Hämtar eller anger en person på det angivna indexet. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Initierar en ny instans av klassen [PersonCollection](./). |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Initierar en ny instans av klassen [PersonCollection](./). |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Tar bort personen från samlingen. |
| [RemoveAt](./removeat/)(int32_t) | Tar bort personen på det angivna indexet. |
