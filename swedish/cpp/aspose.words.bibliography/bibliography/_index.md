---
title: "Aspose::Words::Bibliography::Bibliography klass"
linktitle: "Bibliografi"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Bibliography::Bibliography klass. Representerar listan över bibliografikällor som finns i dokumentet i C++."
type: docs
weight: 125
url: /sv/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class


Representerar listan över bibliografikällor som finns i dokumentet.
...
| Metod | Beskrivning |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Hämtar en sträng som representerar namnet på den aktiva stilen att använda för en bibliografi. |
| [get_Sources](./get_sources/)() const | Hämtar en samling som representerar alla källor som ingår i en bibliografi. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Ställer in en sträng som representerar namnet på den aktiva stilen att använda för en bibliografi. |
| static [Type](./type/)() |  |
