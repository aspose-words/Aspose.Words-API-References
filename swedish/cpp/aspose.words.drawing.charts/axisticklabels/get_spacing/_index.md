---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing metod"
linktitle: "get_Spacing"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing metod. Hämtar eller anger intervallet då tick‑etiketterna ritas i C++."
type: docs
weight: 9000
url: /sv/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


Hämtar eller anger intervallet då tick-etiketterna ritas.
...
Egenskapen har effekt för textkategorier och serieaxlar. Den stöds inte av de nya diagrammen i MS Office 2016. Giltigt värdeintervall är större än eller lika med 1.

Att ställa in den här egenskapen sätter egenskapen [IsAutoSpacing](../get_isautospacing/) till **false**.
