...
description: "Aspose::Words::Drawing::Charts::AxisCategoryType enum. Anger typen av en kategori-axel i C++."
type: docs
weight: 21000
url: /sv/cpp/aspose.words.drawing.charts/axiscategorytype/
---
## AxisCategoryType enum


Anger typen av en kategorisk axel.
...
| --- | --- | --- |
| Automatisk | 0 | Anger att typen av en kategori-axel bestäms automatiskt baserat på data. |
| Kategori | 1 | Anger en axel för en godtycklig mängd kategorier. |
| Tid | 2 | Anger en tidskategori-axel. |
