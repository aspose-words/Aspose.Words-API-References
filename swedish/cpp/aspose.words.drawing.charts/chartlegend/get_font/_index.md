---
title: "Aspose::Words::Drawing::Charts::ChartLegend::get_Font‑metod"
linktitle: "get_Font"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::ChartLegend::get_Font‑metod. Ger åtkomst till standardteckensnittsformatering för legendposter. För att åsidosätta teckensnittsformateringen för en specifik legendpost, använd Font‑egenskapen i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.drawing.charts/chartlegend/get_font/
---
## ChartLegend::get_Font method


Ger åtkomst till standardteckensnittsformatering för legendposter. För att åsidosätta teckensnittsformateringen för en specifik legendpost, använd [Font](../../chartlegendentry/get_font/)‑egenskapen.
