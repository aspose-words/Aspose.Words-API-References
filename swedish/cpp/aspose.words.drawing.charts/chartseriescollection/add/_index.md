---
title: "Aspose::Words::Drawing::Charts::ChartSeriesCollection::Add‑metod"
linktitle: "Add"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::ChartSeriesCollection::Add‑metod. Lägger till en ny ChartSeries i denna samling. Använd denna metod för att lägga till serier i histogramdiagram i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.drawing.charts/chartseriescollection/add/
---
## ChartSeriesCollection::Add(const System::String\&, const System::ArrayPtr\<double\>\&) method


Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier i histogramdiagram.
...
Nyligen tillagt [ChartSeries](../../chartseries/)‑objekt.
...
Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier i alla typer av spridningsdiagram.
...
Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier i alla typer av bubbeldiagram.
...
Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier i alla typer av ytdiagram, radardiagram och aktiediagram.
...
Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier som har flernivåkategorier för data.
...
Visar hur man skapar ett solstråle‑diagram.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Infoga ett solstråle‑diagram.
...
Lägger till en ny [ChartSeries](../../chartseries/) i denna samling. Använd denna metod för att lägga till serier i alla typer av stapel‑, kolumn‑, linje‑ och ytdiagram.
...
Visar hur man skapar ett pareto‑diagram.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);
...
Visar hur man skapar ett låddiagram.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Infoga ett låddiagram.
...
Visar hur man skapar ett tratt‑diagram.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Infoga ett tratt‑diagram.
