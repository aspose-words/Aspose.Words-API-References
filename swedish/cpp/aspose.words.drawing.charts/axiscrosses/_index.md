...
description: "Aspose::Words::Drawing::Charts::AxisCrosses‑enum. Anger de möjliga korsningspunkterna för en axel i C++."
type: docs
weight: 22000
url: /sv/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum


Anger de möjliga korsningspunkterna för en axel.
...
| --- | --- | --- |
| Automatisk | 0 | Kategorinäxeln korsar vid nollpunkten på värdeaxeln (om möjligt), eller vid minimivärdet om minimum är större än noll, eller vid maximum om maximum är mindre än noll. |
| Maximum | 1 | En vinkelrät axel korsar vid axelns maximivärde. |
| Minimum | 2 | En vinkelrät axel korsar vid axelns minimivärde. |
| Anpassad | 3 | En vinkelrät axel korsar vid det angivna värdet på axeln. |
