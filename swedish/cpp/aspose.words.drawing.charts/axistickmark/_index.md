...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. Anger de möjliga positionerna för markeringar i C++."
type: docs
weight: 25000
url: /sv/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum


Anger de möjliga positionerna för tick‑markeringar.
...
| --- | --- | --- |
| Kors | 0 | Anger att markeringarna ska korsa axeln. |
| Inuti | 1 | Anger att markeringarna ska vara inne i plotområdet. |
| Utom | 2 | Anger att markeringarna ska vara utanför plotområdet. |
| None | 3 | Anger att det inte ska finnas några markeringar. |
