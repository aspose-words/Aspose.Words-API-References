---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit metod"
linktitle: "get_MinorUnit"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit metod. Returnerar eller anger avståndet mellan mindre tickmarkeringar i C++."
type: docs
weight: 17000
url: /sv/cpp/aspose.words.drawing.charts/chartaxis/get_minorunit/
---
## ChartAxis::get_MinorUnit method


Returnerar eller anger avståndet mellan sekundära tick‑markeringar.
...
Giltigt värdeintervall är större än noll. Egenskapen har effekt för tidskategorins och värdeaxlarna.

Att ställa in den här egenskapen sätter egenskapen [MinorUnitIsAuto](../get_minorunitisauto/) till **false**.
