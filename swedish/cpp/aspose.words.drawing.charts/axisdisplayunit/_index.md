---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit klass"
linktitle: "AxisDisplayUnit"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit klass. Tillhandahåller åtkomst till skalningsalternativen för displayenheterna för värdeaxeln. För att lära dig mer, besök dokumentationsartikeln i C++."
type: docs
weight: 2000
url: /sv/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Ger åtkomst till skalningsalternativen för visningsenheterna för värdeaxeln. För att lära dig mer, besök dokumentationsartikeln [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | Hämtar eller anger en användardefinierad divisor för att skala displayenheter på värdeaxeln. |
| [get_Document](./get_document/)() | Returnerar dokumentet som innehåller det överordnade diagrammet. |
| [get_Unit](./get_unit/)() const | Hämtar eller anger skalningsvärdet för visningsenheterna som ett av de fördefinierade värdena. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | Sättare för [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | Sättare för [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
