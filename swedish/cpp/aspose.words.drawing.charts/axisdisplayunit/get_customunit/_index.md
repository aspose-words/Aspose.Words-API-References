---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metod"
linktitle: "get_CustomUnit"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metod. Hämtar eller anger en användardefinierad divisor för att skala displayenheterna på värdeaxeln i C++."
type: docs
weight: 3000
url: /sv/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


Hämtar eller anger en användardefinierad divisor för att skala displayenheter på värdeaxeln.
...
Genom att ställa in denna egenskap sätts [Unit](../get_unit/) egenskapen till [Custom](../../axisbuiltinunit/).
