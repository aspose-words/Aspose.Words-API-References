...
description: "Aspose::Words::Drawing::Charts::AxisBuiltInUnit enum. Anger visningsenheterna för en axel i C++."
type: docs
weight: 20000
url: /sv/cpp/aspose.words.drawing.charts/axisbuiltinunit/
---
## AxisBuiltInUnit enum


Anger displayenheterna för en axel.
...
| Anpassad | 1 | Anger att värdena i diagrammet ska divideras med en användardefinierad divisor. Detta värde stöds inte av de nya diagramtyperna i MS Office 2016. |
| Miljarder | 2 | Anger att värdena i diagrammet ska divideras med 1 000 000 000. |
| HundredMillions | 3 | Anger att värdena i diagrammet ska divideras med 100 000 000. |
| Hundratal | 4 | Anger att värdena i diagrammet ska divideras med 100. |
| HundredThousands | 5 | Anger att värdena i diagrammet ska divideras med 100 000. |
| Miljoner | 6 | Anger att värdena i diagrammet ska divideras med 1,000,000. |
...
| Trillions | 10 | Anger att värdena i diagrammet ska divideras med 1,000,000,000,0000. |
| Percentage | 11 | Anger att värdena i diagrammet ska divideras med 0,01. Detta värde stöds endast av de nya diagramtyperna i MS Office 2016. |
