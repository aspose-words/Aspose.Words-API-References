---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metod"
linktitle: "get_LeftMode"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metod. Hämtar eller sätter tolkningsläget för Left-egenskapens värde: om den anger placeringen av datamärket från diagrammets vänstra kant eller från den position som anges av dess Position-egenskap i C++."
type: docs
weight: 6667
url: /sv/cpp/aspose.words.drawing.charts/chartdatalabel/get_leftmode/
---
## ChartDataLabel::get_LeftMode method


Hämtar eller sätter tolkningsläget för [Left](../get_left/) egenskapens värde: om den anger placeringen av datamärket från diagrammets vänstra kant eller från den position som anges av dess [Position](../get_position/) egenskap.
