---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show metod"
linktitle: "get_Show"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show metod. Hämtar eller anger en flagga som indikerar om datatabellen ska visas för diagrammet. Standardvärdet är falskt i C++."
type: docs
weight: 8000
url: /sv/cpp/aspose.words.drawing.charts/chartdatatable/get_show/
---
## ChartDataTable::get_Show method


Hämtar eller anger en flagga som visar om datatabellen ska visas för diagrammet. Standardvärdet är **false**.
