...
description: "Aspose::Words::Drawing::Charts::AxisTimeUnit enum. Anger tidsenheten för axlar i C++."
type: docs
weight: 26000
url: /sv/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum


Anger tidsenheten för axlarna.
...
| --- | --- | --- |
| Automatisk | 0 | Anger att enheten inte sattes explicit och standardvärdet ska användas. |
| Dagar | 1 | Anger att diagramdata ska visas i dagar. |
| Månader | 2 | Anger att diagramdata ska visas i månader. |
| År | 3 | Anger att diagramdata ska visas i år. |
