...
description: "Aspose::Words::Rendering::NodeRendererBase::GetOpaqueBoundsInPixels method. Beräknar den ogenomskinliga omslutningsrutan för formen i pixlar för en angiven zoomfaktor och upplösning i C++."
type: docs
weight: 7000
url: /sv/cpp/aspose.words.rendering/noderendererbase/getopaqueboundsinpixels/
---
...
| dpi | float | Upplösningen för att konvertera från punkter till pixlar (punkter per tum). |

### ReturnValue

Den ogenomskinliga rektangeln för formen i pixlar.
## Anmärkningar


Denna metod konverterar [OpaqueBoundsInPoints](../get_opaqueboundsinpoints/) till en rektangel i pixlar och den är användbar när du vill skapa en bitmap för att rendera formen med endast den ogenomskinliga delen av formen.
