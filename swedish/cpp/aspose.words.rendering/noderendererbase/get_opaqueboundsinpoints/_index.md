---
title: "Aspose::Words::Rendering::NodeRendererBase::get_OpaqueBoundsInPoints‑metod"
linktitle: "get_OpaqueBoundsInPoints"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Rendering::NodeRendererBase::get_OpaqueBoundsInPoints‑metod. Hämtar de ogenomskinliga gränserna för formen i punkter i C++."
type: docs
weight: 4000
url: /sv/cpp/aspose.words.rendering/noderendererbase/get_opaqueboundsinpoints/
---
## NodeRendererBase::get_OpaqueBoundsInPoints method


Hämtar de ogenomskinliga gränserna för formen i punkter.
...
Denna egenskap returnerar den ogenomskinliga (dvs. transparenta delar av formen ignoreras) omslutningsrutan för formen. Omslutningsrutan tar hänsyn till formens rotation.
