---
title: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints‑metod"
linktitle: "get_SizeInPoints"
second_title: "Aspose.Words för C++ API‑referens"
description: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints‑metod. Hämtar den faktiska storleken på formen i punkter i C++."
type: docs
weight: 5000
url: /sv/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
## NodeRendererBase::get_SizeInPoints method


Hämtar den faktiska storleken på formen i punkter.
...
Denna egenskap returnerar storleken på den faktiska (så som den renderas på sidan) omgivande rutan för formen. Storleken tar hänsyn till formens rotation (om någon).
