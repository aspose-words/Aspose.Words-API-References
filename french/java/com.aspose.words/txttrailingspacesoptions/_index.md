...
description: "Spécifie les options disponibles pour la gestion des espaces de fin lors de l'importation d'un fichier LoadFormat.TEXT en Java."
type: docs
weight: 697
url: /fr/java/com.aspose.words/txttrailingspacesoptions/
---
...
Spécifie les options disponibles pour la gestion des espaces de fin lors de l'importation depuis le fichier [LoadFormat.TEXT](../../com.aspose.words/loadformat/#TEXT).
...
| Champ | Description |
| --- | --- |
| [PRESERVE](#PRESERVE) | Les espaces de fin sont conservés. |
| [TRIM](#TRIM) | Les espaces de fin sont supprimés. |
| [length](#length) |  |
## Méthodes
...
Les espaces de fin sont conservés.
...
Les espaces de fin sont supprimés.
