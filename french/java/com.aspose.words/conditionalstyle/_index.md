...
description: "Représente un formatage spécial appliqué à une zone d'un tableau avec un style de tableau assigné en Java."
type: docs
weight: 123
url: /fr/java/com.aspose.words/conditionalstyle/
---
...
Représente le formatage spécial appliqué à une zone d'un tableau avec un style de tableau attribué.
...
| [equals(Object obj)](#equals-java.lang.Object) | Compare ce style conditionnel avec l'objet spécifié. |
...
| [getBorders()](#getBorders) | Obtient la collection des bordures de cellules par défaut pour le style conditionnel. |
...
| [getFont()](#getFont) | Obtient le formatage des caractères du style conditionnel. |
...
| [getParagraphFormat()](#getParagraphFormat) | Obtient le formatage du paragraphe du style conditionnel. |
...
| [getShading()](#getShading) | Obtient un objet [Shading](../../com.aspose.words/shading/) qui fait référence au formatage d’ombrage pour ce style conditionnel. |
...
| [getType()](#getType) | Obtient la zone du tableau à laquelle ce style conditionnel se rapporte. |
| [hashCode()](#hashCode) |  |
...
Compare ce style conditionnel avec l'objet spécifié.
...
Obtient la collection des bordures de cellules par défaut pour le style conditionnel.
...
Obtient le formatage des caractères du style conditionnel.
...
Obtient le formatage du paragraphe du style conditionnel.
...
Obtient un objet [Shading](../../com.aspose.words/shading/) qui fait référence au formatage d’ombrage pour ce style conditionnel.
...
**Returns:**
int - Zone du tableau à laquelle ce style conditionnel se rapporte. La valeur retournée est l'une des constantes [ConditionalStyleType](../../com.aspose.words/conditionalstyletype/).
### hashCode() {#hashCode}
```
public int hashCode()
```
