...
description: "Représente un seul attribut XML personnalisé ou une propriété de balise intelligente en Java."
type: docs
weight: 145
url: /fr/java/com.aspose.words/customxmlproperty/
---
...
Représente un attribut XML personnalisé unique ou une propriété de balise intelligente.
...
Utilisé comme élément d'une collection [CustomXmlPropertyCollection](../../com.aspose.words/customxmlpropertycollection/).
...
| --- | --- |
| [CustomXmlProperty(String name, String uri, String value)](#CustomXmlProperty-java.lang.String-java.lang.String-java.lang.String) | Initialise une nouvelle instance de cette classe. |
## Méthodes

| Méthode | Description |
| --- | --- |
| [getName()](#getName) | Spécifie le nom de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
| [getUri()](#getUri) | Obtient l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
| [getValue()](#getValue) | Obtient la valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
| [setUri(String value)](#setUri-java.lang.String) | Définit l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
| [setValue(String value)](#setValue-java.lang.String) | Définit la valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
...
| --- | --- | --- |
| nom | java.lang.String | Le nom de la propriété. Ne peut pas être nul. |
| uri | java.lang.String | L'URI d'espace de noms de la propriété. Ne peut pas être nul. |
| valeur | java.lang.String | La valeur de la propriété. Ne peut pas être nul. |
...
Spécifie le nom de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
Obtient l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
**Returns:**
java.lang.String - L'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente.
### getValue() {#getValue}
```
...
Obtient la valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
**Returns:**
java.lang.String - La valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
Définit l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
...
Définit la valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La valeur de l'attribut XML personnalisé ou de la propriété de balise intelligente. |
