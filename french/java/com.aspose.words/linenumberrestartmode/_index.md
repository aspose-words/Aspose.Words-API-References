...
description: "Détermine quand le renumérotage automatique des lignes redémarre en Java."
type: docs
weight: 422
url: /fr/java/com.aspose.words/linenumberrestartmode/
---
...
| Champ | Description |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | Numérotation des lignes continue depuis la section précédente. |
| [RESTART_PAGE](#RESTART-PAGE) | La numérotation des lignes redémarre au début de chaque page. |
| [RESTART_SECTION](#RESTART-SECTION) | La numérotation des lignes redémarre au début de la section. |
| [length](#length) |  |
## Méthodes
...
Numérotation des lignes continue depuis la section précédente.
...
La numérotation des lignes redémarre au début de chaque page.
...
La numérotation des lignes redémarre au début de la section.
