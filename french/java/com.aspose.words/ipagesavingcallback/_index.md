...
description: "Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les pages séparées lors de la sauvegarde d'un document aux formats de pages fixes en Java."
type: docs
weight: 780
url: /fr/java/com.aspose.words/ipagesavingcallback/
---
```
public interface IPageSavingCallback
```

Implémentez cette interface si vous souhaitez contrôler la façon dont **Aspose.Words** enregistre les pages séparées lors de l'enregistrement d'un document aux formats de page fixe.
...
| Méthode | Description |
| --- | --- |
| [pageSaving(PageSavingArgs args)](#pageSaving-com.aspose.words.PageSavingArgs) | Appelé lorsque Aspose.Words enregistre une page séparée aux formats de pages fixes. |
...
Appelé lorsque Aspose.Words enregistre une page séparée aux formats de pages fixes.
