...
description: "Implémente le champ IMPORT en Java."
type: docs
weight: 245
url: /fr/java/com.aspose.words/fieldimport/
---
...
Implémente le champ IMPORT.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Récupère l'image contenue dans le document.

 **Examples:** 

Montre comment insérer des images en utilisant les champs IMPORT et INCLUDEPICTURE.
...
| [getGraphicFilter()](#getGraphicFilter) | Obtient le nom du filtre pour le format du graphique qui doit être inséré. |
...
| [getSourceFullName()](#getSourceFullName) | Obtient l'emplacement de l'image. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Définit le nom du filtre pour le format du graphique qui doit être inséré. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Définit l'emplacement de l'image. |
...
Obtient le nom du filtre pour le format du graphique qui doit être inséré.
...
**Returns:**
java.lang.String - Le nom du filtre pour le format du graphique qui doit être inséré.
...
**Returns:**
java.lang.String - L'emplacement de l'image.
### getStart() {#getStart}
```
...
Définit le nom du filtre pour le format du graphique qui doit être inséré.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du filtre pour le format du graphique à insérer. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'emplacement de l'image. |
