...
description: "Implémente le champ COMMENTS en Java."
type: docs
weight: 213
url: /fr/java/com.aspose.words/fieldcomments/
---
...
Implémente le champ COMMENTS.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Récupère, et éventuellement définit, les commentaires relatifs au document actuel, tels qu’enregistrés dans la propriété [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) des propriétés de document intégrées.
...
| [getText()](#getText) | Récupère le texte des commentaires. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte des commentaires. |
...
Récupère le texte des commentaires.
...
**Returns:**
java.lang.String - Le texte des commentaires.
### getType() {#getType}
```
public int getType()
```
...
Définit le texte des commentaires.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte des commentaires. |
