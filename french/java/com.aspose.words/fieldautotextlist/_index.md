...
description: "Implémente le champ AUTOTEXTLIST en Java."
type: docs
weight: 205
url: /fr/java/com.aspose.words/fieldautotextlist/
---
...
Crée un menu contextuel basé sur les entrées AutoText du modèle actif.

 **Examples:** 

Montre comment utiliser un champ AUTOTEXTLIST pour sélectionner parmi une liste d'entrées AutoText.
...
| [getEntryName()](#getEntryName) | Obtient le nom de l'entrée AutoText. |
...
| [getListStyle()](#getListStyle) | Obtient le nom du style sur lequel la liste contenant les entrées est basée. |
...
| [getScreenTip()](#getScreenTip) | Obtient le texte de l'infobulle à afficher. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | Définit le nom de l'entrée AutoText. |
| [setListStyle(String value)](#setListStyle-java.lang.String) | Définit le nom du style sur lequel la liste contenant les entrées est basée. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Définit le texte de l'infobulle à afficher. |
...
Obtient le nom de l'entrée AutoText.
...
**Returns:**
java.lang.String - Le nom de l'entrée AutoText.
...
Obtient le nom du style sur lequel la liste contenant les entrées est basée.
...
**Returns:**
java.lang.String - Le nom du style sur lequel la liste contenant les entrées est basée.
...
Obtient le texte de l'infobulle à afficher.
...
**Returns:**
java.lang.String - Le texte de l'infobulle à afficher.
...
Définit le nom de l'entrée AutoText.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom de l'entrée AutoText. |
...
Définit le nom du style sur lequel la liste contenant les entrées est basée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du style sur lequel la liste contenant les entrées est basée. |
...
Définit le texte de l'infobulle à afficher.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte de l'infobulle à afficher. |
