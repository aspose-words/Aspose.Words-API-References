...
description: "Représente un SubDocument - qui est une référence à un document stocké à l'extérieur en Java."
type: docs
weight: 645
url: /fr/java/com.aspose.words/subdocument/
---
...
Représente un **SubDocument** \- qui est une référence à un document stocké à l'extérieur.
...
Dans cette version d'Aspose.Words, les nœuds [SubDocument](../../com.aspose.words/subdocument/) ne fournissent pas de méthodes publiques ni de propriétés pour créer ou modifier un sous-document. Dans cette version, vous ne pouvez pas instancier les nœuds [SubDocument](../../com.aspose.words/subdocument/) ni modifier les existants, sauf les supprimer.
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). |
...
Renvoie [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT).
...
**Returns:**
int - [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
