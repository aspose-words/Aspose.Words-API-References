...
description: "Représente le début d'un signet dans un document Word en Java."
type: docs
weight: 44
url: /fr/java/com.aspose.words/bookmarkstart/
---
...
Utilisez la classe [getBookmark()](../../com.aspose.words/bookmarkstart/\#getBookmark) comme une \"façade\" pour travailler avec un signet en tant qu'objet unique.
...
| --- | --- |
| [BookmarkStart(DocumentBase doc, String name)](#BookmarkStart-com.aspose.words.DocumentBase-java.lang.String) | Initialise une nouvelle instance de la classe [BookmarkStart](../../com.aspose.words/bookmarkstart/). |
## Méthodes
...
| [getBookmark()](#getBookmark) | Obtient l'objet façade qui encapsule le début et la fin de ce signet. |
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START). |
...
| [getText()](#getText) | Renvoie une chaîne vide. |
...
Initialise une nouvelle instance de la classe [BookmarkStart](../../com.aspose.words/bookmarkstart/).
...
Appelle [DocumentVisitor.visitBookmarkStart(com.aspose.words.BookmarkStart)](../../com.aspose.words/documentvisitor/\#visitBookmarkStart-com.aspose.words.BookmarkStart).
...
Renvoie [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START).
...
**Returns:**
int - [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START). La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
...
**Returns:**
java.lang.String - Une chaîne vide.
