...
description: "Spécifie la direction des opérations de remplacement en Java."
type: docs
weight: 313
url: /fr/java/com.aspose.words/findreplacedirection/
---
...
Spécifie la direction pour les opérations de remplacement.
...
| Champ | Description |
| --- | --- |
| [BACKWARD](#BACKWARD) | Les éléments correspondants sont remplacés du dernier au premier. |
| [FORWARD](#FORWARD) | Les éléments correspondants sont remplacés du premier au dernier. |
| [length](#length) |  |
## Méthodes
...
Les éléments correspondants sont remplacés du dernier au premier.
...
Les éléments correspondants sont remplacés du premier au dernier.
