...
description: "Spécifie la texture d’ombrage en Java."
type: docs
weight: 681
url: /fr/java/com.aspose.words/textureindex/
---
...
| [TEXTURE_NIL](#TEXTURE-NIL) | Spécifie qu'aucun motif ne doit être utilisé sur la région ombrée actuelle (c.-à-d. |
...
Spécifie qu'aucun motif ne doit être utilisé sur la région ombrée actuelle (c.-à-d. le motif doit être un remplissage complet avec la couleur d'arrière-plan).
