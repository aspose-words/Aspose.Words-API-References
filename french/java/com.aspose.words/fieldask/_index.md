...
description: "Implémente le champ ASK en Java."
type: docs
weight: 199
url: /fr/java/com.aspose.words/fieldask/
---
...
| Méthode | Description |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtient le nom du signet. |
| [getDefaultResponse()](#getDefaultResponse) | Obtient la réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | Obtient si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage. |
| [getPromptText()](#getPromptText) | Obtient le texte de l'invite (le titre de la fenêtre d'invite). |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Définit le nom du signet. |
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | Définit la réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite). |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | Définit si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | Définit le texte de l'invite (le titre de la fenêtre d'invite). |
...
Obtient la réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite).
...
**Returns:**
java.lang.String - Réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite).
...
Obtient si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage.
...
**Returns:**
boolean - Indique si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage.
...
Obtient le texte de l'invite (le titre de la fenêtre d'invite).
...
**Returns:**
java.lang.String - Le texte de l'invite (le titre de la fenêtre d'invite).
### getResult() {#getResult}
```
...
Définit la réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Réponse utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite). |
...
Définit si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si la réponse de l'utilisateur doit être reçue une fois par opération de fusion et publipostage. |
...
Définit le texte de l'invite (le titre de la fenêtre d'invite).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte de l'invite (le titre de la fenêtre d'invite). |
