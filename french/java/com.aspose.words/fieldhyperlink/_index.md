...
description: "Implémente le champ HYPERLINK en Java."
type: docs
weight: 242
url: /fr/java/com.aspose.words/fieldhyperlink/
---
...
Lorsqu'il est sélectionné, provoque le saut du contrôle vers l'emplacement tel qu'un signet ou une URL.
...
| Méthode | Description |
| --- | --- |
| [getAddress()](#getAddress) | Obtient un emplacement vers lequel ce lien hypertexte saute. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Obtient si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web. |
| [getResult()](#getResult) | Obtient le texte qui se trouve entre le séparateur du champ et la fin du champ. |
| [getScreenTip()](#getScreenTip) | Obtient le texte d'infobulle pour le lien hypertexte. |
...
| [getSubAddress()](#getSubAddress) | Obtient un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | Obtient la cible vers laquelle le lien doit être redirigé. |
...
| [isImageMap()](#isImageMap) | Obtient si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Définit si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Définit un emplacement où ce lien hypertexte saute. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | Définit si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Définit le texte d'infobulle pour le lien hypertexte. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | Définit un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute. |
| [setTarget(String value)](#setTarget-java.lang.String) | Définit la cible vers laquelle le lien doit être redirigé. |
...
Obtient un emplacement vers lequel ce lien hypertexte saute.
...
**Returns:**
java.lang.String - Un emplacement où ce lien hypertexte saute.
...
Obtient si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web.
...
**Returns:**
boolean - Indique si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web.
### getResult() {#getResult}
```
...
Obtient le texte d'infobulle pour le lien hypertexte.
...
**Returns:**
java.lang.String - Le texte d'infobulle pour le lien hypertexte.
...
Obtient un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute.
...
**Returns:**
java.lang.String - Un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Obtient la cible vers laquelle le lien doit être redirigé.
...
**Returns:**
java.lang.String - La cible vers laquelle le lien doit être redirigé.
### getType() {#getType}
```
public int getType()
```
...
Obtient si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur.
...
**Returns:**
boolean - Indique si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur.
...
Définit si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si des coordonnées doivent être ajoutées au lien hypertexte pour une carte d'image côté serveur. |
...
Définit un emplacement où ce lien hypertexte saute.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un emplacement où ce lien hypertexte saute. |
...
Définit si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web. |
...
Définit le texte d'infobulle pour le lien hypertexte.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte d'infobulle pour le lien hypertexte. |
...
Définit un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un emplacement dans le fichier, tel qu'un signet, où ce lien hypertexte saute. |
...
Définit la cible vers laquelle le lien doit être redirigé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La cible vers laquelle le lien doit être redirigé. |
