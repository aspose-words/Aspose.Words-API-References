...
description: "Implémentez cette interface si vous souhaitez contrôler la façon dont le résultat du champ est formaté en Java."
type: docs
weight: 766
url: /fr/java/com.aspose.words/ifieldresultformatter/
---
```
...
| [formatNumeric(double value, String format)](#formatNumeric-double-java.lang.String) | Appelé lorsque Aspose.Words applique un commutateur de format numérique, c.-à-d. |
### format(double value, int format) {#format-double-int}
```
...
Appelé lorsque Aspose.Words applique un commutateur de format numérique, c.-à-d. \\\# "\#.\#".

 **Remarks:** 

L'implémentation doit renvoyer  null  pour indiquer que le formatage par défaut doit être appliqué.
