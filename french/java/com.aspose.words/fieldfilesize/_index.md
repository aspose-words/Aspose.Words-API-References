...
description: "Implémente le champ FILESIZE en Java."
type: docs
weight: 231
url: /fr/java/com.aspose.words/fieldfilesize/
---
...
Dans l'implémentation actuelle, utilise la propriété [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) pour récupérer le nom de fichier utilisé pour déterminer la taille du fichier.
...
| [isInKilobytes()](#isInKilobytes) | Obtient si la taille du fichier doit être affichée en kilo-octets. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Définit si la taille du fichier doit être affichée en kilo-octets. |
| [isInMegabytes()](#isInMegabytes) | Obtient si la taille du fichier doit être affichée en mégaoctets. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Définit si la taille du fichier doit être affichée en mégaoctets. |
...
Obtient si la taille du fichier doit être affichée en kilo-octets.
...
**Returns:**
booléen - Indique si la taille du fichier doit être affichée en kilo-octets.
...
Définit si la taille du fichier doit être affichée en kilo-octets.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si la taille du fichier doit être affichée en kilo-octets. |
...
Obtient si la taille du fichier doit être affichée en mégaoctets.
...
**Returns:**
booléen - Indique si la taille du fichier doit être affichée en mégaoctets.
...
Définit si la taille du fichier doit être affichée en mégaoctets.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si la taille du fichier doit être affichée en mégaoctets. |
