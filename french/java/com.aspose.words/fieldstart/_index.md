...
description: "Représente le début d'un champ Word dans un document en Java."
type: docs
weight: 288
url: /fr/java/com.aspose.words/fieldstart/
---
...
| [getFieldData()](#getFieldData) | Obtient les données personnalisées du champ qui sont associées au champ. |
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). |
...
Appelle [DocumentVisitor.visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
Obtient les données personnalisées du champ qui sont associées au champ.
...
**Returns:**
byte[] - Données personnalisées du champ qui sont associées au champ.
...
Renvoie [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START).
...
**Returns:**
int - [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). La valeur renvoyée est l'une des constantes de [NodeType](../../com.aspose.words/nodetype/).
