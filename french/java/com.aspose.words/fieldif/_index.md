...
description: "Implémente le champ IF en Java."
type: docs
weight: 243
url: /fr/java/com.aspose.words/fieldif/
---
...
Compare les valeurs désignées par les expressions [getLeftExpression()](../../com.aspose.words/fieldif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setLeftExpression-java.lang.String) et [getRightExpression()](../../com.aspose.words/fieldif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setRightExpression-java.lang.String) lors de la comparaison en utilisant l'opérateur désigné par [getComparisonOperator()](../../com.aspose.words/fieldif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldif/\#setComparisonOperator-java.lang.String).

Un champ au format suivant sera utilisé comme source de fusion de courrier : \{ IF 0 = 0 "\{PatientsNameFML\}" "" \\\* MERGEFORMAT \}
...
| [getComparisonOperator()](#getComparisonOperator) | Obtient l'opérateur de comparaison. |
...
| [getFalseText()](#getFalseText) | Obtient le texte affiché si l'expression de comparaison est fausse. |
...
| [getLeftExpression()](#getLeftExpression) | Obtient la partie gauche de l'expression de comparaison. |
...
| [getRightExpression()](#getRightExpression) | Obtient la partie droite de l'expression de comparaison. |
...
| [getTrueText()](#getTrueText) | Obtient le texte affiché si l'expression de comparaison est vraie. |
...
| [setComparisonOperator(String value)](#setComparisonOperator-java.lang.String) | Définit l'opérateur de comparaison. |
| [setFalseText(String value)](#setFalseText-java.lang.String) | Définit le texte affiché si l'expression de comparaison est fausse. |
| [setLeftExpression(String value)](#setLeftExpression-java.lang.String) | Définit la partie gauche de l'expression de comparaison. |
...
| [setRightExpression(String value)](#setRightExpression-java.lang.String) | Définit la partie droite de l'expression de comparaison. |
| [setTrueText(String value)](#setTrueText-java.lang.String) | Définit le texte affiché si l'expression de comparaison est vraie. |
...
**Returns:**
int - Une valeur [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/) qui représente le résultat de l'évaluation de la condition. La valeur retournée est l'une des constantes [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/).
...
**Returns:**
java.lang.String - L'opérateur de comparaison.
...
Obtient le texte affiché si l'expression de comparaison est fausse.
...
**Returns:**
java.lang.String - Le texte affiché si l'expression de comparaison est fausse.
...
Obtient la partie gauche de l'expression de comparaison.
...
**Returns:**
java.lang.String - La partie gauche de l'expression de comparaison.
...
Obtient la partie droite de l'expression de comparaison.
...
**Returns:**
java.lang.String - La partie droite de l'expression de comparaison.
...
Obtient le texte affiché si l'expression de comparaison est vraie.
...
**Returns:**
java.lang.String - Le texte affiché si l'expression de comparaison est vraie.
### getType() {#getType}
```
public int getType()
```
...
Définit l'opérateur de comparaison.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'opérateur de comparaison. |
...
Définit le texte affiché si l'expression de comparaison est fausse.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte affiché si l'expression de comparaison est fausse. |
...
Définit la partie gauche de l'expression de comparaison.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La partie gauche de l'expression de comparaison. |
...
Définit la partie droite de l'expression de comparaison.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La partie droite de l'expression de comparaison. |
...
Définit le texte affiché si l'expression de comparaison est vraie.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte affiché si l'expression de comparaison est vraie. |
