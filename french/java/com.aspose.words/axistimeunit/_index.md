...
description: "Spécifie l'unité de temps pour les axes en Java."
type: docs
weight: 33
url: /fr/java/com.aspose.words/axistimeunit/
---
...
| Champ | Description |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Spécifie que l'unité n'a pas été définie explicitement et que la valeur par défaut doit être utilisée. |
| [DAYS](#DAYS) | Spécifie que les données du graphique doivent être affichées en jours. |
| [MONTHS](#MONTHS) | Spécifie que les données du graphique doivent être affichées en mois. |
| [YEARS](#YEARS) | Spécifie que les données du graphique doivent être affichées en années. |
| [length](#length) |  |
## Méthodes
...
Spécifie que l'unité n'a pas été définie explicitement et que la valeur par défaut doit être utilisée.
...
Spécifie que les données du graphique doivent être affichées en jours.
...
Spécifie que les données du graphique doivent être affichées en mois.
...
Spécifie que les données du graphique doivent être affichées en années.
