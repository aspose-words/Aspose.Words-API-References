...
description: "Implémente le champ USERINITIALS en Java."
type: docs
weight: 304
url: /fr/java/com.aspose.words/fielduserinitials/
---
...
| [getUserInitials()](#getUserInitials) | Obtient les initiales de l'utilisateur actuel. |
...
| [setUserInitials(String value)](#setUserInitials-java.lang.String) | Définit les initiales de l'utilisateur actuel. |
...
Obtient les initiales de l'utilisateur actuel.
...
**Returns:**
java.lang.String - Les initiales de l'utilisateur actuel.
### isDirty() {#isDirty}
```
...
Définit les initiales de l'utilisateur actuel.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Les initiales de l'utilisateur actuel. |
