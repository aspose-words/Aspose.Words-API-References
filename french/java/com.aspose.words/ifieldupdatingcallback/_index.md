...
description: "Implémentez cette interface si vous souhaitez disposer de vos propres méthodes personnalisées appelées lors d'une mise à jour de champ en Java."
type: docs
weight: 768
url: /fr/java/com.aspose.words/ifieldupdatingcallback/
---
```
public interface IFieldUpdatingCallback
```

Implémentez cette interface si vous souhaitez que vos propres méthodes personnalisées soient appelées pendant la mise à jour d'un champ.
...
| Méthode | Description |
| --- | --- |
| [fieldUpdated(Field field)](#fieldUpdated-com.aspose.words.Field) | Une méthode définie par l'utilisateur qui est appelée juste après la mise à jour d'un champ. |
| [fieldUpdating(Field field)](#fieldUpdating-com.aspose.words.Field) | Une méthode définie par l'utilisateur qui est appelée juste avant la mise à jour d'un champ. |
