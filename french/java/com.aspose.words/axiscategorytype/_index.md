...
description: "Spécifie le type d'un axe de catégorie en Java."
type: docs
weight: 24
url: /fr/java/com.aspose.words/axiscategorytype/
---
...
Spécifie le type d'un axe de catégorie.
...
| Champ | Description |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Spécifie que le type d'un axe de catégorie est déterminé automatiquement en fonction des données. |
| [CATEGORY](#CATEGORY) | Spécifie un axe d'un ensemble arbitraire de catégories. |
| [TIME](#TIME) | Spécifie un axe de catégorie temporelle. |
| [length](#length) |  |
## Méthodes
...
Spécifie que le type d'un axe de catégorie est déterminé automatiquement en fonction des données.
...
Spécifie un axe d'un ensemble arbitraire de catégories.
...
Spécifie un axe de catégorie temporelle.
