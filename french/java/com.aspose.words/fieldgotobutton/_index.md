...
description: "Implémente le champ GOTOBUTTON en Java."
type: docs
weight: 240
url: /fr/java/com.aspose.words/fieldgotobutton/
---
...
Implémente le champ GOTOBUTTON.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Insère une commande de saut, de sorte que lorsqu'elle est activée, le point d'insertion du document est déplacé vers l'emplacement spécifié.
...
| [getDisplayText()](#getDisplayText) | Obtient le texte du "bouton" qui apparaît dans le document, afin qu'il puisse être sélectionné pour activer le saut. |
...
| [getLocation()](#getLocation) | Obtient le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Définit le texte du "bouton" qui apparaît dans le document, afin qu'il puisse être sélectionné pour activer le saut. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setLocation(String value)](#setLocation-java.lang.String) | Définit le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter. |
...
Obtient le texte du "bouton" qui apparaît dans le document, afin qu'il puisse être sélectionné pour activer le saut.
...
**Returns:**
java.lang.String - Le texte du "button" qui apparaît dans le document, de sorte qu'il puisse être sélectionné pour activer le saut.
### getEnd() {#getEnd}
```
...
Obtient le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter.
...
**Returns:**
java.lang.String - Le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter.
### getResult() {#getResult}
```
...
### setDisplayText(String value) {#setDisplayText-java.lang.String}
```
public void setDisplayText(String value)
```


Définit le texte du "bouton" qui apparaît dans le document, afin qu'il puisse être sélectionné pour activer le saut.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte du "button" qui apparaît dans le document, de sorte qu'il puisse être sélectionné pour activer le saut. |
...
Définit le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom d'un signet, d'un numéro de page ou d'un autre élément vers lequel sauter. |
