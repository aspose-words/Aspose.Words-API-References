...
description: "Le contrôle TextBox affiche du texte provenant d’un ensemble organisé de données ou d’une saisie utilisateur en Java."
type: docs
weight: 668
url: /fr/java/com.aspose.words/textboxcontrol/
---
...
Le contrôle TextBox affiche du texte provenant d'un ensemble organisé de données ou d'une saisie utilisateur.
...
| [getText()](#getText) | Obtient le texte du contrôle. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte du contrôle. |
...
**Returns:**
java.lang.String - Un texte du contrôle.
### getType() {#getType}
```
public int getType()
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un texte du contrôle. |
