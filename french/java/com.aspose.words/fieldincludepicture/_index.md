...
description: "Implémente le champ INCLUDEPICTURE en Java."
type: docs
weight: 247
url: /fr/java/com.aspose.words/fieldincludepicture/
---
...
| [getResizeHorizontally()](#getResizeHorizontally) | Obtient si l'image doit être redimensionnée horizontalement à partir de la source. |
| [getResizeVertically()](#getResizeVertically) | Obtient si l'image doit être redimensionnée verticalement à partir de la source. |
...
| [getSourceFullName()](#getSourceFullName) | Obtient l'emplacement de l'image en utilisant un IRI. |
...
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Définit si l'image doit être redimensionnée horizontalement à partir de la source. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Définit si l'image doit être redimensionnée verticalement à partir de la source. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Définit l'emplacement de l'image en utilisant un IRI. |
...
Obtient si l'image doit être redimensionnée horizontalement à partir de la source.
...
**Returns:**
boolean - Si l'image doit être redimensionnée horizontalement à partir de la source.
...
Obtient si l'image doit être redimensionnée verticalement à partir de la source.
...
**Returns:**
boolean - Si l'image doit être redimensionnée verticalement à partir de la source.
### getResult() {#getResult}
```
...
Obtient l'emplacement de l'image en utilisant un IRI.
...
**Returns:**
java.lang.String - L'emplacement de l'image en utilisant un IRI.
### getStart() {#getStart}
```
...
Définit si l'image doit être redimensionnée horizontalement à partir de la source.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut redimensionner l'image horizontalement à partir de la source. |
...
Définit si l'image doit être redimensionnée verticalement à partir de la source.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut redimensionner l'image verticalement à partir de la source. |
...
Définit l'emplacement de l'image en utilisant un IRI.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'emplacement de l'image utilisant un IRI. |
