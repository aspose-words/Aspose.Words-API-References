...
description: "Fournit des méthodes pour signer un document en Java."
type: docs
weight: 154
url: /fr/java/com.aspose.words/digitalsignatureutil/
---
...
Fournit des méthodes pour signer le document.

Pour en savoir plus, consultez l'article de documentation [ Work with Digital Signatures ][Work with Digital Signatures].

 **Remarks:** 

Étant donné que la signature numérique fonctionne avec le contenu du fichier plutôt qu'avec le modèle d'objet de document, ces méthodes sont placées dans une classe séparée.

Les formats pris en charge sont : [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
| [loadSignatures(String fileName)](#loadSignatures-java.lang.String) | Charge les signatures numériques du document. |
...
| [removeAllSignatures(String srcFileName, String dstFileName)](#removeAllSignatures-java.lang.String-java.lang.String) | Supprime toutes les signatures numériques du fichier source et écrit le fichier non signé dans le fichier de destination. |
...
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder) | Signe le document source en utilisant le [CertificateHolder](../../com.aspose.words/certificateholder/) fourni avec une signature numérique et écrit le document signé dans le fichier de destination. |
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder, SignOptions signOptions)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder-com.aspose.words.SignOptions) | Signe le document source en utilisant le [CertificateHolder](../../com.aspose.words/certificateholder/) et le [SignOptions](../../com.aspose.words/signoptions/) fournis avec une signature numérique et écrit le document signé dans le fichier de destination. |
### loadSignatures(InputStream stream) {#loadSignatures-java.io.InputStream}
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| fileName | java.lang.String | Chemin vers le document. |
...
Les formats suivants sont compatibles pour la suppression de signature numérique : [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
Signe le document source en utilisant le [CertificateHolder](../../com.aspose.words/certificateholder/) fourni avec une signature numérique et écrit le document signé dans le fichier de destination.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| srcFileName | java.lang.String | Le nom de fichier du document à signer. |
| dstFileName | java.lang.String | Le nom de fichier du document signé en sortie. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | Objet [CertificateHolder](../../com.aspose.words/certificateholder/) avec le certificat utilisé pour signer le fichier. |
...
Signe le document source en utilisant le [CertificateHolder](../../com.aspose.words/certificateholder/) et le [SignOptions](../../com.aspose.words/signoptions/) fournis avec une signature numérique et écrit le document signé dans le fichier de destination.
...
| dstFileName | java.lang.String | Le nom de fichier du document signé en sortie. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | Objet [CertificateHolder](../../com.aspose.words/certificateholder/) avec le certificat utilisé pour signer le fichier. |
| signOptions | [SignOptions](../../com.aspose.words/signoptions/) | Objet [SignOptions](../../com.aspose.words/signoptions/) avec diverses options de signature. |
