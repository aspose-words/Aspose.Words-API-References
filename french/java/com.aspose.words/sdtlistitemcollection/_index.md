...
description: "Fournit l’accès aux éléments SdtListItem d’une balise de document structuré en Java."
type: docs
weight: 603
url: /fr/java/com.aspose.words/sdtlistitemcollection/
---
...
Fournit l’accès aux éléments [SdtListItem](../../com.aspose.words/sdtlistitem/) d’une balise de document structuré.
...
| Méthode | Description |
| --- | --- |
| [add(SdtListItem item)](#add-com.aspose.words.SdtListItem) | Ajoute un élément à cette collection. |
| [clear()](#clear) | Efface tous les éléments de cette collection. |
| [get(int index)](#get-int) | Renvoie un objet [SdtListItem](../../com.aspose.words/sdtlistitem/) donné son indice basé sur zéro dans la collection. |
| [getCount()](#getCount) | Obtient le nombre d'éléments dans la collection. |
| [getSelectedValue()](#getSelectedValue) | Spécifie la valeur actuellement sélectionnée dans cette liste. |
| [iterator()](#iterator) | Renvoie un objet itérateur qui peut être utilisé pour parcourir tous les éléments de la collection. |
| [removeAt(int index)](#removeAt-int) | Supprime un élément de la liste à l’indice spécifié. |
| [setSelectedValue(SdtListItem value)](#setSelectedValue-com.aspose.words.SdtListItem) | Spécifie la valeur actuellement sélectionnée dans cette liste. |
...
Efface tous les éléments de cette collection.
...
Renvoie un objet [SdtListItem](../../com.aspose.words/sdtlistitem/) donné son indice basé sur zéro dans la collection.
...
Spécifie la valeur actuellement sélectionnée dans cette liste. Valeur nulle autorisée, signifiant qu’aucune entrée actuellement sélectionnée n’est associée à cette collection d’éléments de liste.
...
Supprime un élément de la liste à l’indice spécifié.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | [SdtListItem](../../com.aspose.words/sdtlistitem/) | La valeur correspondante du [SdtListItem](../../com.aspose.words/sdtlistitem/). |
