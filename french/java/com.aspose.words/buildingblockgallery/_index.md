...
description: "Spécifie la galerie prédéfinie dans laquelle un bloc de construction est classé en Java."
type: docs
weight: 55
url: /fr/java/com.aspose.words/buildingblockgallery/
---
...
Spécifie la galerie prédéfinie dans laquelle un building block est classé.

 **Remarks:** 

Correspond au type **ST\_DocPartGallery** dans OOXML.

 **Examples:** 

Présente les méthodes d'accès aux blocs de construction dans un document de glossaire.
...
| Champ | Description |
| --- | --- |
| [ALL](#ALL) | Spécifie que cette entrée de document de glossaire doit être associée à toutes les valeurs de classification de galerie possibles. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | Identique à [ALL](../../com.aspose.words/buildingblockgallery/\#ALL). |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
Spécifie que cette entrée de document de glossaire doit être associée à toutes les valeurs de classification de galerie possibles.
...
Identique à [ALL](../../com.aspose.words/buildingblockgallery/\#ALL).
