...
description: "Implémente le champ MACROBUTTON en Java."
type: docs
weight: 256
url: /fr/java/com.aspose.words/fieldmacrobutton/
---
...
| [getDisplayText()](#getDisplayText) | Obtient le texte à afficher comme le "bouton" sélectionné pour exécuter la macro ou la commande. |
...
| [getMacroName()](#getMacroName) | Obtient le nom de la macro ou de la commande à exécuter. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Définit le texte à afficher comme le "bouton" sélectionné pour exécuter la macro ou la commande. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Définit le nom de la macro ou de la commande à exécuter. |
...
Obtient le texte à afficher comme le "bouton" sélectionné pour exécuter la macro ou la commande.
...
**Returns:**
java.lang.String - Le texte à afficher comme le "bouton" sélectionné pour exécuter la macro ou la commande.
### getEnd() {#getEnd}
```
...
Obtient le nom de la macro ou de la commande à exécuter.
...
**Returns:**
java.lang.String - Le nom de la macro ou de la commande à exécuter.
### getMergeFieldName() {#getMergeFieldName}
```
...
Définit le texte à afficher comme le "bouton" sélectionné pour exécuter la macro ou la commande.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte à afficher comme le "bouton" qui est sélectionné pour exécuter la macro ou la commande. |
...
Définit le nom de la macro ou de la commande à exécuter.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom de la macro ou de la commande à exécuter. |
