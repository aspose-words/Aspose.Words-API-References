...
description: "Fournit un accès typé à une collection de nœuds Table en Java."
type: docs
weight: 658
url: /fr/java/com.aspose.words/tablecollection/
---
...
Fournit un accès typé à une collection de nœuds [Table](../../com.aspose.words/table/).
...
| [get(int index)](#get-int) | Récupère un [Table](../../com.aspose.words/table/) à l'index donné. |
...
Récupère un [Table](../../com.aspose.words/table/) à l'index donné.
...
**Returns:**
com.aspose.words.Node[] - Un tableau de tables.
