...
description: "Implémente le champ FILENAME en Java."
type: docs
weight: 230
url: /fr/java/com.aspose.words/fieldfilename/
---
...
Dans l'implémentation actuelle, utilise la propriété [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) pour récupérer le nom du fichier. Si le document a été chargé depuis un flux ou créé vierge, utilise le nom du fichier dans lequel il est enregistré (si connu).
