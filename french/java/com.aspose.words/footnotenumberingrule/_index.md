...
description: "Détermine quand le numérotage automatique des notes de bas de page ou des notes de fin redémarre en Java."
type: docs
weight: 340
url: /fr/java/com.aspose.words/footnotenumberingrule/
---
...
Détermine quand le numérotage automatique des notes de bas de page ou des notes de fin redémarre.
...
| Champ | Description |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | Numérotation continue tout au long du document. |
| [DEFAULT](#DEFAULT) | Égal à [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS). |
| [RESTART_PAGE](#RESTART-PAGE) | Le numérotage redémarre à chaque page. |
| [RESTART_SECTION](#RESTART-SECTION) | Le numérotage redémarre à chaque section. |
| [length](#length) |  |
## Méthodes
...
Numérotation continue tout au long du document.
...
Égal à [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
Le numérotage redémarre à chaque page. Valide uniquement pour les notes de bas de page.
...
Le numérotage redémarre à chaque section.
