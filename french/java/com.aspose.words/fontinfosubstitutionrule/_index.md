...
description: "Règle de substitution d'informations de police en Java."
type: docs
weight: 328
url: /fr/java/com.aspose.words/fontinfosubstitutionrule/
---
...
Règle de substitution d'informations de police.

Pour en savoir plus, consultez l’article de documentation [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Selon cette règle, Aspose.Words évalue tous les champs associés dans [FontInfo](../../com.aspose.words/fontinfo/) (Panose, Sig, etc.) pour la police manquante et trouve la correspondance la plus proche parmi les sources de polices disponibles. Si [FontInfo](../../com.aspose.words/fontinfo/) n'est pas disponible pour la police manquante, aucune action ne sera effectuée.
