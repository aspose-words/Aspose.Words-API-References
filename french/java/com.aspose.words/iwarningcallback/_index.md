...
description: "Implémentez cette interface si vous souhaitez disposer de votre propre méthode personnalisée appelée pour capturer les avertissements de perte de fidélité pouvant survenir lors du chargement ou de l'enregistrement d'un document en Java."
type: docs
weight: 788
url: /fr/java/com.aspose.words/iwarningcallback/
---
```
public interface IWarningCallback
```

Implémentez cette interface si vous souhaitez avoir votre propre méthode personnalisée appelée pour capturer les avertissements de perte de fidélité pouvant survenir lors du chargement ou de l'enregistrement d'un document.
...
| Méthode | Description |
| --- | --- |
| [warning(WarningInfo info)](#warning-com.aspose.words.WarningInfo) | Aspose.Words invoque cette méthode lorsqu'il rencontre un problème lors du chargement ou de l'enregistrement d'un document qui pourrait entraîner une perte de mise en forme ou d'intégrité des données. |
...
Aspose.Words invoque cette méthode lorsqu'il rencontre un problème lors du chargement ou de l'enregistrement d'un document qui pourrait entraîner une perte de mise en forme ou d'intégrité des données.
