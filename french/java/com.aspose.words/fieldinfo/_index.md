...
description: "Implémente le champ INFO en Java."
type: docs
weight: 251
url: /fr/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Obtient le type de la propriété de document à insérer. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getNewValue()](#getNewValue) | Obtient une valeur optionnelle qui met à jour la propriété. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Définit le type de la propriété de document à insérer. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Définit une valeur optionnelle qui met à jour la propriété. |
...
Obtient le type de la propriété de document à insérer.
...
**Returns:**
java.lang.String - Le type de la propriété du document à insérer.
...
Obtient une valeur optionnelle qui met à jour la propriété.
...
**Returns:**
java.lang.String - Une valeur optionnelle qui met à jour la propriété.
### getResult() {#getResult}
```
...
Définit le type de la propriété de document à insérer.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le type de la propriété du document à insérer. |
...
Définit une valeur optionnelle qui met à jour la propriété.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une valeur optionnelle qui met à jour la propriété. |
