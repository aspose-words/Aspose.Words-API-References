...
description: "Spécifie les paramètres du mécanisme de secours de police en Java."
type: docs
weight: 323
url: /fr/java/com.aspose.words/fontfallbacksettings/
---
...
Spécifie les paramètres du mécanisme de secours de police.
...
| Méthode | Description |
| --- | --- |
| [buildAutomatic()](#buildAutomatic) | Construit automatiquement les paramètres de secours en analysant les polices disponibles. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | Charge les paramètres de secours de police depuis un fichier XML. |
| [loadMsOfficeFallbackSettings()](#loadMsOfficeFallbackSettings) | Charge les paramètres de secours prédéfinis qui imitent le secours de Microsoft Word et utilisent les polices Microsoft Office. |
| [loadNotoFallbackSettings()](#loadNotoFallbackSettings) | Charge les paramètres de secours prédéfinis qui utilisent les polices Google Noto. |
| [save(OutputStream outputStream)](#save-java.io.OutputStream) |  |
| [save(String fileName)](#save-java.lang.String) | Enregistre les paramètres de secours actuels dans un fichier. |
...
Construit automatiquement les paramètres de secours en analysant les polices disponibles.

 **Remarks:** 

Cette méthode peut produire des paramètres de secours non optimaux. Les polices sont vérifiées par les champs [ Unicode Character Range ][Unicode Character Range] et non par la présence réelle des glyphes. De plus, les plages Unicode sont vérifiées individuellement et plusieurs plages liées à une même langue/script peuvent utiliser différentes polices de secours.
...
Charge les paramètres de secours de police depuis un fichier XML.

 **Examples:** 

Montre comment charger et enregistrer les paramètres de secours de police vers/depuis un document XML dans le système de fichiers local.
...
Montre comment charger les paramètres de police de secours pré‑définis.
