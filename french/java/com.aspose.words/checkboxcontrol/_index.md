...
description: "Le contrôle CheckBox bascule une valeur en Java."
type: docs
weight: 100
url: /fr/java/com.aspose.words/checkboxcontrol/
---
...
Il possède trois états possibles : sélectionné, effacé et ni sélectionné ni effacé, ce qui signifie une combinaison d'états activé et désactivé.
...
| [getChecked()](#getChecked) | Obtient une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Définit une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non. |
...
Obtient une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non. La valeur par défaut est  false .
...
**Returns:**
boolean - Une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non.
...
Définit une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non. La valeur par défaut est  false .
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | boolean | Une valeur booléenne indiquant si ce [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) est coché ou non. |
