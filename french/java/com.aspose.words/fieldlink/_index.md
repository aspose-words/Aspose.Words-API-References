...
description: "Implémente le champ LINK en Java."
type: docs
weight: 254
url: /fr/java/com.aspose.words/fieldlink/
---
...
Pour les informations copiées depuis une autre application, ce champ lie ces informations à leur fichier source original.

 **Examples:** 

Montre comment utiliser différents types de champs pour lier à d'autres documents dans le système de fichiers local et afficher leur contenu.
...
| Méthode | Description |
| --- | --- |
| [getAutoUpdate()](#getAutoUpdate) | Obtient si ce champ doit être mis à jour automatiquement. |
...
| [getFormatUpdateType()](#getFormatUpdateType) | Obtient une façon dont l'objet lié met à jour son formatage. |
| [getInsertAsBitmap()](#getInsertAsBitmap) | Obtient si l'objet lié doit être inséré en tant que bitmap. |
| [getInsertAsHtml()](#getInsertAsHtml) | Obtient si l'objet lié doit être inséré en texte au format HTML. |
| [getInsertAsPicture()](#getInsertAsPicture) | Obtient si l'objet lié doit être inséré en tant qu'image. |
| [getInsertAsRtf()](#getInsertAsRtf) | Obtient si l'objet lié doit être inséré au format texte enrichi (RTF). |
| [getInsertAsText()](#getInsertAsText) | Obtient si l'objet lié doit être inséré au format texte uniquement. |
| [getInsertAsUnicode()](#getInsertAsUnicode) | Obtient si l'objet lié doit être inséré en texte Unicode. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getProgId()](#getProgId) | Obtient le type d'application des informations de lien. |
...
| [getSourceFullName()](#getSourceFullName) | Obtient le nom et l'emplacement du fichier source. |
| [getSourceItem()](#getSourceItem) | Obtient la partie du fichier source qui est liée. |
...
| [isLinked()](#isLinked) | Obtient si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document. |
| [isLinked(boolean value)](#isLinked-boolean) | Définit si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document. |
...
| [setAutoUpdate(boolean value)](#setAutoUpdate-boolean) | Définit si ce champ doit être mis à jour automatiquement. |
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String) | Définit une façon dont l'objet lié met à jour son formatage. |
| [setInsertAsBitmap(boolean value)](#setInsertAsBitmap-boolean) | Définit si l'objet lié doit être inséré en tant que bitmap. |
| [setInsertAsHtml(boolean value)](#setInsertAsHtml-boolean) | Définit si l'objet lié doit être inséré en texte au format HTML. |
| [setInsertAsPicture(boolean value)](#setInsertAsPicture-boolean) | Définit si l'objet lié doit être inséré en tant qu'image. |
| [setInsertAsRtf(boolean value)](#setInsertAsRtf-boolean) | Définit si l'objet lié doit être inséré au format texte enrichi (RTF). |
| [setInsertAsText(boolean value)](#setInsertAsText-boolean) | Définit si l'objet lié doit être inséré au format texte uniquement. |
| [setInsertAsUnicode(boolean value)](#setInsertAsUnicode-boolean) | Définit si l'objet lié doit être inséré en texte Unicode. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setProgId(String value)](#setProgId-java.lang.String) | Définit le type d'application des informations de lien. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Définit le nom et l'emplacement du fichier source. |
| [setSourceItem(String value)](#setSourceItem-java.lang.String) | Définit la partie du fichier source qui est liée. |
...
Obtient si ce champ doit être mis à jour automatiquement.
...
**Returns:**
booléen - Si ce champ doit être mis à jour automatiquement.
...
Obtient une façon dont l'objet lié met à jour son formatage.
...
**Returns:**
java.lang.String - Une façon dont l'objet lié met à jour son formatage.
...
**Returns:**
boolean - Si l'objet lié doit être inséré en tant que bitmap.
...
Obtient si l'objet lié doit être inséré en texte au format HTML.
...
**Returns:**
boolean - Si l'objet lié doit être inséré en texte au format HTML.
...
Obtient si l'objet lié doit être inséré en tant qu'image.
...
**Returns:**
boolean - Si l'objet lié doit être inséré en tant qu'image.
...
Obtient si l'objet lié doit être inséré au format texte enrichi (RTF).
...
**Returns:**
boolean - Si l'objet lié doit être inséré au format texte enrichi (RTF).
...
Obtient si l'objet lié doit être inséré au format texte uniquement.
...
**Returns:**
boolean - Si l'objet lié doit être inséré au format texte uniquement.
...
Obtient si l'objet lié doit être inséré en texte Unicode.
...
**Returns:**
boolean - Si l'objet lié doit être inséré en texte Unicode.
...
Obtient le type d'application des informations de lien.
...
**Returns:**
java.lang.String - Le type d'application des informations de lien.
### getResult() {#getResult}
```
...
Obtient le nom et l'emplacement du fichier source.
...
**Returns:**
java.lang.String - Le nom et l'emplacement du fichier source.
...
Obtient la partie du fichier source qui est liée.
...
**Returns:**
java.lang.String - La partie du fichier source qui est liée.
### getStart() {#getStart}
```
...
Obtient si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document.
...
**Returns:**
boolean - Si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document.
...
Définit si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document. |
...
Définit si ce champ doit être mis à jour automatiquement.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Si ce champ doit être mis à jour automatiquement. |
...
Définit une façon dont l'objet lié met à jour son formatage.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une façon dont l'objet lié met à jour son formatage. |
...
Définit si l'objet lié doit être inséré en tant que bitmap.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié sous forme de bitmap. |
...
Définit si l'objet lié doit être inséré en texte au format HTML.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié sous forme de texte au format HTML. |
...
Définit si l'objet lié doit être inséré en tant qu'image.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié sous forme d'image. |
...
Définit si l'objet lié doit être inséré au format texte enrichi (RTF).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié au format texte enrichi (RTF). |
...
Définit si l'objet lié doit être inséré au format texte uniquement.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié au format texte uniquement. |
...
Définit si l'objet lié doit être inséré en texte Unicode.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut insérer l'objet lié sous forme de texte Unicode. |
...
Définit le type d'application des informations de lien.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le type d'application des informations de lien. |
...
Définit le nom et l'emplacement du fichier source.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom et l'emplacement du fichier source. |
...
Définit la partie du fichier source qui est liée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La partie du fichier source qui est liée. |
