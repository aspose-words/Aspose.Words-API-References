...
description: "Implémente le champ INCLUDETEXT en Java."
type: docs
weight: 248
url: /fr/java/com.aspose.words/fieldincludetext/
---
...
| Méthode | Description |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtient le nom du signet dans le document à inclure. |
| [getDisplayResult()](#getDisplayResult) | Obtient le texte qui représente le résultat du champ affiché. |
| [getEncoding()](#getEncoding) | Obtient l'encodage appliqué aux données du fichier référencé. |
...
| [getLockFields()](#getLockFields) | Obtient si les champs du document inclus doivent être empêchés d'être mis à jour. |
| [getMimeType()](#getMimeType) | Obtient le type MIME du fichier référencé. |
| [getNamespaceMappings()](#getNamespaceMappings) | Obtient les mappages d'espaces de noms pour les requêtes XPath. |
...
| [getSourceFullName()](#getSourceFullName) | Obtient l'emplacement du document en utilisant un IRI. |
| [getStart()](#getStart) | Obtient le nœud qui représente le début du champ. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTextConverter()](#getTextConverter) | Obtient le nom du convertisseur de texte pour le format du fichier inclus. |
| [getType()](#getType) | Obtient le type de champ Microsoft Word. |
| [getXPath()](#getXPath) | Obtient le XPath pour la partie souhaitée du fichier XML. |
| [getXslTransformation()](#getXslTransformation) | Obtient l'emplacement de la transformation XSL pour formater les données XML. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Définit le nom du signet dans le document à inclure. |
| [setEncoding(String value)](#setEncoding-java.lang.String) | Définit l'encodage appliqué aux données du fichier référencé. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setLockFields(boolean value)](#setLockFields-boolean) | Définit si les champs du document inclus doivent être empêchés d'être mis à jour. |
| [setMimeType(String value)](#setMimeType-java.lang.String) | Définit le type MIME du fichier référencé. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | Définit les mappages d'espaces de noms pour les requêtes XPath. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Définit l'emplacement du document en utilisant un IRI. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | Définit le nom du convertisseur de texte pour le format du fichier inclus. |
| [setXPath(String value)](#setXPath-java.lang.String) | Définit le XPath pour la partie souhaitée du fichier XML. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | Définit l'emplacement de la transformation XSL pour formater les données XML. |
...
Obtient le nom du signet dans le document à inclure.
...
**Returns:**
java.lang.String - Le nom du signet dans le document à inclure.
...
Obtient l'encodage appliqué aux données du fichier référencé.
...
**Returns:**
java.lang.String - L'encodage appliqué aux données du fichier référencé.
### getEnd() {#getEnd}
```
...
Obtient si les champs du document inclus doivent être empêchés d'être mis à jour.
...
**Returns:**
boolean - Indique si les champs du document inclus doivent être empêchés d'être mis à jour.
...
Obtient le type MIME du fichier référencé.
...
**Returns:**
java.lang.String - Le type MIME du fichier référencé.
...
Obtient les mappages d'espaces de noms pour les requêtes XPath.
...
**Returns:**
java.lang.String - Les mappages d'espace de noms pour les requêtes XPath.
### getResult() {#getResult}
```
...
Obtient l'emplacement du document en utilisant un IRI.
...
**Returns:**
java.lang.String - L'emplacement du document utilisant un IRI.
### getStart() {#getStart}
```
...
Obtient le nom du convertisseur de texte pour le format du fichier inclus.
...
**Returns:**
java.lang.String - Le nom du convertisseur de texte pour le format du fichier inclus.
### getType() {#getType}
```
public int getType()
```
...
Obtient le XPath pour la partie souhaitée du fichier XML.
...
**Returns:**
java.lang.String - XPath pour la partie souhaitée du fichier XML.
...
Obtient l'emplacement de la transformation XSL pour formater les données XML.
...
**Returns:**
java.lang.String - L'emplacement de la transformation XSL pour formater les données XML.
### isDirty() {#isDirty}
```
...
Définit le nom du signet dans le document à inclure.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du signet dans le document à inclure. |
...
Définit l'encodage appliqué aux données du fichier référencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'encodage appliqué aux données du fichier référencé. |
...
Définit si les champs du document inclus doivent être empêchés d'être mis à jour.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut empêcher la mise à jour des champs dans le document inclus. |
...
Définit le type MIME du fichier référencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le type MIME du fichier référencé. |
...
Définit les mappages d'espaces de noms pour les requêtes XPath.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Les mappages d'espace de noms pour les requêtes XPath. |
...
Définit l'emplacement du document en utilisant un IRI.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'emplacement du document utilisant un IRI. |
...
Définit le nom du convertisseur de texte pour le format du fichier inclus.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du convertisseur de texte pour le format du fichier inclus. |
...
Définit le XPath pour la partie souhaitée du fichier XML.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | XPath pour la partie souhaitée du fichier XML. |
...
Définit l'emplacement de la transformation XSL pour formater les données XML.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'emplacement de la transformation XSL pour formater les données XML. |
