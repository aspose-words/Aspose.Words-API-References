...
description: "Implémente le champ LISTNUM en Java."
type: docs
weight: 255
url: /fr/java/com.aspose.words/fieldlistnum/
---
...
| [getListLevel()](#getListLevel) | Obtient le niveau dans la liste, en remplaçant le comportement par défaut du champ. |
| [getListName()](#getListName) | Obtient le nom de la définition de numérotation abstraite utilisée pour la numérotation. |
...
| [getStartingNumber()](#getStartingNumber) | Obtient la valeur de départ pour ce champ. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Obtient le type de champ Microsoft Word. |
| [hasListName()](#hasListName) | Renvoie une valeur indiquant si le nom d'une définition de numérotation abstraite est fourni par le code du champ. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | Définit le niveau dans la liste, en remplaçant le comportement par défaut du champ. |
| [setListName(String value)](#setListName-java.lang.String) | Définit le nom de la définition de numérotation abstraite utilisée pour la numérotation. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | Définit la valeur de départ pour ce champ. |
...
Obtient le niveau dans la liste, en remplaçant le comportement par défaut du champ.
...
**Returns:**
java.lang.String - Le niveau dans la liste, en remplaçant le comportement par défaut du champ.
...
Obtient le nom de la définition de numérotation abstraite utilisée pour la numérotation.
...
**Returns:**
java.lang.String - Le nom de la définition de numérotation abstraite utilisée pour la numérotation.
...
Obtient la valeur de départ pour ce champ.
...
**Returns:**
java.lang.String - La valeur de départ pour ce champ.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Renvoie une valeur indiquant si le nom d'une définition de numérotation abstraite est fourni par le code du champ.
...
**Returns:**
boolean - Une valeur indiquant si le nom d'une définition de numérotation abstraite est fourni par le code du champ.
### isDirty() {#isDirty}
```
...
Définit le niveau dans la liste, en remplaçant le comportement par défaut du champ.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le niveau dans la liste, en remplaçant le comportement par défaut du champ. |
...
Définit le nom de la définition de numérotation abstraite utilisée pour la numérotation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom de la définition de numérotation abstraite utilisée pour la numérotation. |
...
Définit la valeur de départ pour ce champ.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La valeur de départ pour ce champ. |
