...
description: "Fournit un accès typé à une collection de nœuds Run en Java."
type: docs
weight: 594
url: /fr/java/com.aspose.words/runcollection/
---
...
Fournit un accès typé à une collection de nœuds [Run](../../com.aspose.words/run/).
...
| [get(int index)](#get-int) | Récupère un [Run](../../com.aspose.words/run/) à l'index donné. |
...
Récupère un [Run](../../com.aspose.words/run/) à l'index donné.
...
Copie tous les runs de la collection dans un nouveau tableau de runs.
...
**Returns:**
com.aspose.words.Node[] - Un tableau de runs.
