...
description: "Implémente le champ BIBLIOGRAPHY en Java."
type: docs
weight: 207
url: /fr/java/com.aspose.words/fieldbibliography/
---
...
Implémente le champ BIBLIOGRAPHY.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Insère le contenu de la partie Bibliographie du document dans un style bibliographique.

 **Examples:** 

Montre comment travailler avec les champs CITATION et BIBLIOGRAPHY.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Obtient l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Obtient l'ID de langue utilisé pour formater les sources bibliographiques dans le document. |
...
| [getSourceTag()](#getSourceTag) | Obtient une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Définit l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Définit l'ID de langue utilisé pour formater les sources bibliographiques dans le document. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Définit une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie. |
...
Obtient l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue.
...
**Returns:**
java.lang.String - L'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue.
### getFormat() {#getFormat}
```
...
Obtient l'ID de langue utilisé pour formater les sources bibliographiques dans le document.
...
**Returns:**
java.lang.String - L'ID de langue utilisé pour formater les sources bibliographiques dans le document.
...
Obtient une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie.
...
**Returns:**
java.lang.String - Une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie.
### getStart() {#getStart}
```
...
Définit l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue. |
...
Définit l'ID de langue utilisé pour formater les sources bibliographiques dans le document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'ID de langue utilisé pour formater les sources bibliographiques dans le document. |
...
Définit une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie. |
