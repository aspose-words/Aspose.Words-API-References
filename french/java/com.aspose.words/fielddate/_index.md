...
description: "Implémente le champ DATE en Java."
type: docs
weight: 220
url: /fr/java/com.aspose.words/fielddate/
---
...
| [getUseLastFormat()](#getUseLastFormat) | Obtient si l'on doit utiliser un format utilisé en dernier par l'application hôte lors de l'insertion d'un nouveau champ DATE. |
| [getUseLunarCalendar()](#getUseLunarCalendar) | Obtient si l'on doit utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | Obtient si l'on doit utiliser le calendrier de l'ère Saka. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | Obtient si l'on doit utiliser le calendrier Um‑al‑Qura. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Définit si l'on doit utiliser un format utilisé en dernier par l'application hôte lors de l'insertion d'un nouveau champ DATE. |
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | Définit si l'on doit utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | Définit si l'on doit utiliser le calendrier de l'ère Saka. |
| [setUseUmAlQuraCalendar(boolean value)](#setUseUmAlQuraCalendar-boolean) | Définit si l'on doit utiliser le calendrier Um‑al‑Qura. |
...
Obtient si l'on doit utiliser un format utilisé en dernier par l'application hôte lors de l'insertion d'un nouveau champ DATE.
...
**Returns:**
booléen - Indique si l'on doit utiliser un format utilisé en dernier par l'application hôte lors de l'insertion d'un nouveau champ DATE.
...
Obtient si l'on doit utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu.
...
**Returns:**
boolean - Indique s'il faut utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu.
...
Obtient si l'on doit utiliser le calendrier de l'ère Saka.
...
**Returns:**
boolean - Indique s'il faut utiliser le calendrier de l'ère Saka.
...
Obtient si l'on doit utiliser le calendrier Um‑al‑Qura.
...
**Returns:**
boolean - Indique s'il faut utiliser le calendrier Um‑al‑Qura.
### isDirty() {#isDirty}
```
...
Définit si l'on doit utiliser un format utilisé en dernier par l'application hôte lors de l'insertion d'un nouveau champ DATE.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut utiliser un format dernier utilisé par l'application hôte lors de l'insertion d'un nouveau champ DATE. |
...
Définit si l'on doit utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut utiliser le calendrier lunaire hijri ou le calendrier lunaire hébreu. |
...
Définit si l'on doit utiliser le calendrier de l'ère Saka.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut utiliser le calendrier de l'ère Saka. |
...
Définit si l'on doit utiliser le calendrier Um‑al‑Qura.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut utiliser le calendrier Um-al-Qura. |
