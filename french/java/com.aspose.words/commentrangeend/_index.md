...
description: "Désigne la fin d’une région de texte à laquelle un commentaire est associé en Java."
type: docs
weight: 111
url: /fr/java/com.aspose.words/commentrangeend/
---
...
Indique la fin d'une région de texte associée à un commentaire.
...
| --- | --- |
| [CommentRangeEnd(DocumentBase doc, int id)](#CommentRangeEnd-com.aspose.words.DocumentBase-int) | Initialise une nouvelle instance de cette classe. |
## Méthodes
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). |
...
Lorsque [CommentRangeEnd](../../com.aspose.words/commentrangeend/) est créé, il appartient au document spécifié, mais ne fait pas encore partie du document et [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) est  null .

Pour ajouter un [CommentRangeEnd](../../com.aspose.words/commentrangeend/) au document, utilisez InsertAfter ou InsertBefore sur le paragraphe où vous souhaitez insérer le commentaire.
...
Appelle [DocumentVisitor.visitCommentRangeEnd(com.aspose.words.CommentRangeEnd)](../../com.aspose.words/documentvisitor/\#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd).
...
Renvoie [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). La valeur retournée est l’une des constantes de [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
