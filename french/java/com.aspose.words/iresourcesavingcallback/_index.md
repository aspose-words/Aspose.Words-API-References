...
description: "Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les ressources externes images polices et CSS lors de l'enregistrement d'un document au format HTML ou SVG à pages fixes en Java."
type: docs
weight: 783
url: /fr/java/com.aspose.words/iresourcesavingcallback/
---
```
public interface IResourceSavingCallback
```

Implémentez cette interface si vous souhaitez contrôler la façon dont **Aspose.Words** enregistre les ressources externes (images, polices et CSS) lors de l'enregistrement d'un document au format HTML ou SVG à page fixe.
...
Montre comment utiliser un rappel pour modifier l'URI de la ressource.
...
| Méthode | Description |
| --- | --- |
| [resourceSaving(ResourceSavingArgs args)](#resourceSaving-com.aspose.words.ResourceSavingArgs) | Appelé lorsque Aspose.Words enregistre une ressource externe au format HTML ou SVG à pages fixes. |
...
Appelé lorsque Aspose.Words enregistre une ressource externe au format HTML ou SVG à pages fixes.
