...
description: "Implémente le champ DOCVARIABLE en Java."
type: docs
weight: 225
url: /fr/java/com.aspose.words/fielddocvariable/
---
...
Montre comment utiliser les champs DOCPROPERTY pour afficher les propriétés et variables du document.
...
| [getVariableName()](#getVariableName) | Obtient le nom de la variable de document à récupérer. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Définit le nom de la variable de document à récupérer. |
...
Obtient le nom de la variable de document à récupérer.
...
**Returns:**
java.lang.String - Le nom de la variable de document à récupérer.
### isDirty() {#isDirty}
```
...
Définit le nom de la variable de document à récupérer.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom de la variable de document à récupérer. |
