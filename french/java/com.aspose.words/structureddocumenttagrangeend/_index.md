...
description: "Représente la fin d'une balise de document structuré à portée qui accepte du contenu multi‑sections en Java."
type: docs
weight: 639
url: /fr/java/com.aspose.words/structureddocumenttagrangeend/
---
...
Représente la fin d'une balise de document structuré **ranged** qui accepte du contenu multi‑sections. Voir également le nœud [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).
...
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int) | Initialise une nouvelle instance de la classe **Structured document tag range end**. |
## Méthodes
...
| [getId()](#getId) | Spécifie un identifiant numérique persistant en lecture seule et unique pour ce nœud **StructuredDocumentTagRange**. |
| [getNextSibling()](#getNextSibling) | Obtient le nœud immédiatement suivant ce nœud. |
| [getNodeType()](#getNodeType) | Renvoie [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). |
...
Initialise une nouvelle instance de la classe **Structured document tag range end**.
...
| id | int | Identifiant du début de la plage de balise de document structuré correspondant. |
...
Spécifie un identifiant numérique unique en lecture seule et persistant pour ce nœud **StructuredDocumentTagRange**. Le nœud [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/) correspondant possède le même [StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart/\#getId).
...
Renvoie [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END).

**Returns:**
int - [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
