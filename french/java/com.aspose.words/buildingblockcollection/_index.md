...
description: "Une collection d'objets BuildingBlock dans le document en Java."
type: docs
weight: 54
url: /fr/java/com.aspose.words/buildingblockcollection/
---
...
Une collection d'objets [BuildingBlock](../../com.aspose.words/buildingblock/) dans le document.
...
Vous ne créez pas d'instances de cette classe directement. Pour accéder à une collection de blocs de construction, utilisez la propriété [GlossaryDocument.getBuildingBlocks()](../../com.aspose.words/glossarydocument/\#getBuildingBlocks).
...
| [get(int index)](#get-int) | Récupère un bloc de construction à l'index donné. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | Un index dans la liste des blocs de construction. |
...
**Returns:**
com.aspose.words.Node[] - Un tableau de blocs de construction.
