...
description: "Implémente le champ SUBJECT en Java."
type: docs
weight: 290
url: /fr/java/com.aspose.words/fieldsubject/
---
...
Récupère, et éventuellement définit, le sujet du document, tel qu'enregistré dans la propriété **Subject** des propriétés intégrées du document.
...
| [getText()](#getText) | Obtient le texte du sujet. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte du sujet. |
...
**Returns:**
java.lang.String - Le texte du sujet.
### getType() {#getType}
```
public int getType()
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte du sujet. |
