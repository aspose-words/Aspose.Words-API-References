...
description: "Fournit des méthodes pour rendre une Shape ou GroupShape individuelle en image raster ou vectorielle ou dans un objet Graphics en Java."
type: docs
weight: 616
url: /fr/java/com.aspose.words/shaperenderer/
---
...
Fournit des méthodes pour rendre une [Shape](../../com.aspose.words/shape/) ou [GroupShape](../../com.aspose.words/groupshape/) individuelle en image raster ou vectorielle ou dans un objet Graphics.
...
| --- | --- |
| [ShapeRenderer(ShapeBase shape)](#ShapeRenderer-com.aspose.words.ShapeBase) | Initialise une nouvelle instance de cette classe. |
## Méthodes
...
| --- | --- | --- |
| shape | [ShapeBase](../../com.aspose.words/shapebase/) | L'objet shape DrawinML que vous souhaitez rendre. |
