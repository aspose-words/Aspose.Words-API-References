...
description: "Représente un type de groupe d'axes de graphique en Java."
type: docs
weight: 27
url: /fr/java/com.aspose.words/axisgroup/
---
...
| Champ | Description |
| --- | --- |
| [PRIMARY](#PRIMARY) | Spécifie le groupe d'axes principal. |
| [SECONDARY](#SECONDARY) | Spécifie le groupe d'axes secondaire. |
| [length](#length) |  |
## Méthodes
...
Spécifie le groupe d'axes principal.
...
Spécifie le groupe d'axes secondaire.
