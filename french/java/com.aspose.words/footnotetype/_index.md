...
description: "Spécifie s'il s'agit d'une note de bas de page ou d'une note de fin en Java."
type: docs
weight: 346
url: /fr/java/com.aspose.words/footnotetype/
---
...
Les notes de bas de page et les notes de fin sont toutes deux représentées par des objets de la classe [FOOTNOTE](../../com.aspose.words/footnotetype/\#FOOTNOTE). Utilisez [Footnote.getFootnoteType()](../../com.aspose.words/footnote/\#getFootnoteType) pour distinguer les notes de bas de page des notes de fin.
...
| Champ | Description |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | L'objet est une note de fin. |
| [FOOTNOTE](#FOOTNOTE) | L'objet est une note de bas de page. |
| [length](#length) |  |
## Méthodes
...
L'objet est une note de bas de page.
