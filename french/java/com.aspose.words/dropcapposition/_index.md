...
description: "Spécifie la position du texte en lettrine en Java."
type: docs
weight: 177
url: /fr/java/com.aspose.words/dropcapposition/
---
...
| Champ | Description |
| --- | --- |
| [MARGIN](#MARGIN) | La lettrine est positionnée à l’extérieur de la marge du texte dans le paragraphe d’ancrage. |
| [NONE](#NONE) | Le paragraphe ne possède pas de lettrine. |
| [NORMAL](#NORMAL) | La lettrine est positionnée à l’intérieur de la marge du texte dans le paragraphe d’ancrage. |
| [length](#length) |  |
## Méthodes
...
La lettrine est positionnée à l’extérieur de la marge du texte dans le paragraphe d’ancrage.
...
Le paragraphe ne possède pas de lettrine.
...
La lettrine est positionnée à l’intérieur de la marge du texte dans le paragraphe d’ancrage.
