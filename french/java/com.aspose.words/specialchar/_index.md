...
description: "Classe de base pour les caractères spéciaux dans le document en Java."
type: docs
weight: 628
url: /fr/java/com.aspose.words/specialchar/
---
...
Un document Microsoft Word peut contenir un certain nombre de caractères spéciaux qui représentent des champs, des champs de formulaire, des formes, des objets OLE, des notes de bas de page, etc. Pour la liste des caractères spéciaux, voir [ControlChar](../../com.aspose.words/controlchar/).
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). |
...
Appelle [DocumentVisitor.visitSpecialChar(com.aspose.words.SpecialChar)](../../com.aspose.words/documentvisitor/\#visitSpecialChar-com.aspose.words.SpecialChar).
...
Renvoie [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR).
...
**Returns:**
int - [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). La valeur renvoyée est l'une des constantes de [NodeType](../../com.aspose.words/nodetype/).
