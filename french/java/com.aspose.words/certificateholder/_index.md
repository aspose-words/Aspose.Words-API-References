...
description: "Représente un détenteur d'une instance X509Certificate2 en Java."
type: docs
weight: 64
url: /fr/java/com.aspose.words/certificateholder/
---
...
Représente un conteneur d'instance **X509Certificate2**.
...
| Méthode | Description |
| --- | --- |
| [create(byte[] certBytes, String password)](#create-byte---java.lang.String) | Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le tableau d'octets du magasin PKCS12 et son mot de passe. |
| [create(String fileName, String password)](#create-java.lang.String-java.lang.String) | Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le chemin du magasin PKCS12 et son mot de passe. |
| [create(String fileName, String password, String alias)](#create-java.lang.String-java.lang.String-java.lang.String) | Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le chemin du magasin PKCS12, son mot de passe et l'alias permettant de trouver la clé privée et le certificat. |
| [getCertificate()](#getCertificate) | Renvoie l'instance de **X509Certificate2Wrapper** qui contient **X509Certificate2**, laquelle possède les clés privées, publiques et la chaîne de certificats. |
...
Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le tableau d'octets du magasin PKCS12 et son mot de passe. **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  certBytes  est  null  **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  password  est  null

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| certBytes | byte[] | Un tableau d'octets contenant les données d'un certificat X.509. |
| mot de passe | java.lang.String | Le mot de passe requis pour accéder aux données du certificat X.509. |
...
Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le chemin du magasin PKCS12 et son mot de passe. **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  fileName  est  null  **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  password  est  null

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| fileName | java.lang.String | Le nom d'un fichier de certificat. |
| mot de passe | java.lang.String | Le mot de passe requis pour accéder aux données du certificat X.509. |
...
Crée l'objet [CertificateHolder](../../com.aspose.words/certificateholder/) en utilisant le chemin du magasin PKCS12, son mot de passe et l'alias permettant de trouver la clé privée et le certificat. **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  fileName  est  null  **T:Org.BouncyCastle.Security.InvalidParameterException** Levée si  password  est  null
...
| fileName | java.lang.String | Le nom d'un fichier de certificat. |
| mot de passe | java.lang.String | Le mot de passe requis pour accéder aux données du certificat X.509. |
| alias | java.lang.String | L'alias associé à un certificat et à sa clé privée |
...
Renvoie l'instance de **X509Certificate2Wrapper** qui contient **X509Certificate2**, laquelle possède les clés privées, publiques et la chaîne de certificats.
