...
description: "Spécifie le type de modification suivi dans Revision en Java."
type: docs
weight: 586
url: /fr/java/com.aspose.words/revisiontype/
---
...
Spécifie le type de modification suivi dans [Revision](../../com.aspose.words/revision/).
...
| Champ | Description |
| --- | --- |
| [DELETION](#DELETION) | Le contenu a été supprimé du document. |
| [FORMAT_CHANGE](#FORMAT-CHANGE) | Un changement de formatage a été appliqué au nœud parent. |
| [INSERTION](#INSERTION) | Du nouveau contenu a été inséré dans le document. |
| [MOVING](#MOVING) | Le contenu a été déplacé dans le document. |
| [STYLE_DEFINITION_CHANGE](#STYLE-DEFINITION-CHANGE) | Un changement de formatage a été appliqué au style parent. |
| [length](#length) |  |
## Méthodes
...
Le contenu a été supprimé du document.
...
Un changement de formatage a été appliqué au nœud parent.
...
Du nouveau contenu a été inséré dans le document.
...
Le contenu a été déplacé dans le document.
...
Un changement de formatage a été appliqué au style parent.
