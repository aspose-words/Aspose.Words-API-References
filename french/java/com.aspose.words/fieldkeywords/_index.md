...
description: "Implémente le champ KEYWORDS en Java."
type: docs
weight: 252
url: /fr/java/com.aspose.words/fieldkeywords/
---
...
Implémente le champ KEYWORDS.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Récupère, et éventuellement définit, les mots‑clés du document, tels qu'enregistrés dans la propriété **Keywords** des propriétés intégrées du document.
...
| [getText()](#getText) | Obtient le texte des mots‑clés. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte des mots‑clés. |
...
Obtient le texte des mots‑clés.
...
**Returns:**
java.lang.String - Le texte des mots‑clés.
### getType() {#getType}
```
public int getType()
```
...
Définit le texte des mots‑clés.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte des mots‑clés. |
