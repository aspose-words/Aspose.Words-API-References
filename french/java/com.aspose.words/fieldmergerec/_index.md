...
description: "Implémente le champ MERGEREC en Java."
type: docs
weight: 259
url: /fr/java/com.aspose.words/fieldmergerec/
---
...
Implémente le champ MERGEREC.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Pour le moment, les champs MERGEREC et MERGESEQ implémentent la même fonctionnalité car nous ne savons pas avec certitude comment ignorer des enregistrements dans la fusion de courrier Aspose.Words.
