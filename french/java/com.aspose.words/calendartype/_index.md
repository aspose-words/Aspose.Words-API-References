...
description: "Spécifie le type d'un calendrier en Java."
type: docs
weight: 58
url: /fr/java/com.aspose.words/calendartype/
---
...
| Champ | Description |
| --- | --- |
| [GREGORIAN](#GREGORIAN) | Le calendrier grégorien. |
| [HEBREW](#HEBREW) | Le calendrier lunaire hébreu. |
| [HIJRI](#HIJRI) | Le calendrier lunaire hijri. |
| [SAKA_ERA](#SAKA-ERA) | Le calendrier de l'ère Saka. |
| [UM_AL_QURA](#UM-AL-QURA) | Le calendrier Um-al-Qura. |
| [length](#length) |  |
## Méthodes
