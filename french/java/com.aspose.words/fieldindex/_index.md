...
description: "Implémente le champ INDEX en Java."
type: docs
weight: 249
url: /fr/java/com.aspose.words/fieldindex/
---
...
Construit un index en utilisant les entrées d'index spécifiées par les champs XE, et insère cet index à cet emplacement dans le document.
...
| Méthode | Description |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtient le nom du signet qui marque la portion du document utilisée pour construire l'index. |
| [getCrossReferenceSeparator()](#getCrossReferenceSeparator) | Obtient la séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées. |
...
| [getEntryType()](#getEntryType) | Obtient un type d'entrée d'index utilisé pour construire l'index. |
...
| [getHeading()](#getHeading) | Obtient un titre qui apparaît au début de chaque ensemble d'entrées pour une lettre donnée. |
| [getLanguageId()](#getLanguageId) | Obtient l'ID de langue utilisé pour générer l'index. |
| [getLetterRange()](#getLetterRange) | Obtient une plage de lettres à laquelle limiter l'index. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getNumberOfColumns()](#getNumberOfColumns) | Obtient le nombre de colonnes par page utilisé lors de la création de l'index. |
| [getPageNumberListSeparator()](#getPageNumberListSeparator) | Obtient la séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page. |
| [getPageNumberSeparator()](#getPageNumberSeparator) | Obtient la séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page. |
| [getPageRangeSeparator()](#getPageRangeSeparator) | Obtient la séquence de caractères utilisée pour séparer le début et la fin d’une plage de pages. |
| [getResult()](#getResult) | Obtient le texte qui se trouve entre le séparateur du champ et la fin du champ. |
| [getRunSubentriesOnSameLine()](#getRunSubentriesOnSameLine) | Obtient si les sous‑entrées sont placées sur la même ligne que l'entrée principale. |
| [getSeparator()](#getSeparator) | Obtient le nœud qui représente le séparateur de champ. |
| [getSequenceName()](#getSequenceName) | Obtient le nom d’une séquence dont le numéro est inclus avec le numéro de page. |
...
| [getUseYomi()](#getUseYomi) | Obtient s'il faut activer l'utilisation du texte yomi pour les entrées d'index. |
| [hasPageNumberSeparator()](#hasPageNumberSeparator) | Obtient une valeur indiquant si le séparateur de numéro de page est remplacé via le code du champ. |
| [hasSequenceName()](#hasSequenceName) | Obtient une valeur indiquant si une séquence doit être utilisée lors de la construction du résultat du champ. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Définit le nom du signet qui marque la partie du document utilisée pour créer l'index. |
| [setCrossReferenceSeparator(String value)](#setCrossReferenceSeparator-java.lang.String) | Définit la séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées. |
| [setEntryType(String value)](#setEntryType-java.lang.String) | Définit un type d'entrée d'index utilisé pour créer l'index. |
| [setHeading(String value)](#setHeading-java.lang.String) | Définit un titre qui apparaît au début de chaque ensemble d'entrées pour une lettre donnée. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Définit l'ID de langue utilisé pour générer l'index. |
| [setLetterRange(String value)](#setLetterRange-java.lang.String) | Définit une plage de lettres à laquelle limiter l'index. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setNumberOfColumns(String value)](#setNumberOfColumns-java.lang.String) | Définit le nombre de colonnes par page utilisé lors de la création de l'index. |
| [setPageNumberListSeparator(String value)](#setPageNumberListSeparator-java.lang.String) | Définit la séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page. |
| [setPageNumberSeparator(String value)](#setPageNumberSeparator-java.lang.String) | Définit la séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page. |
| [setPageRangeSeparator(String value)](#setPageRangeSeparator-java.lang.String) | Définit la séquence de caractères utilisée pour séparer le début et la fin d’une plage de pages. |
...
| [setRunSubentriesOnSameLine(boolean value)](#setRunSubentriesOnSameLine-boolean) | Définit si les sous‑entrées sont placées sur la même ligne que l'entrée principale. |
| [setSequenceName(String value)](#setSequenceName-java.lang.String) | Définit le nom d’une séquence dont le numéro est inclus avec le numéro de page. |
...
| [setUseYomi(boolean value)](#setUseYomi-boolean) | Définit s'il faut activer l'utilisation du texte yomi pour les entrées d'index. |
...
Obtient le nom du signet qui marque la portion du document utilisée pour construire l'index.
...
**Returns:**
java.lang.String - Le nom du signet qui marque la partie du document utilisée pour créer l'index.
...
Obtient la séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées.
...
**Returns:**
java.lang.String - La séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées.
...
Obtient un type d'entrée d'index utilisé pour construire l'index.
...
**Returns:**
java.lang.String - Un type d'entrée d'index utilisé pour créer l'index.
...
Obtient un titre qui apparaît au début de chaque ensemble d'entrées pour une lettre donnée.
...
**Returns:**
java.lang.String - Un titre qui apparaît au début de chaque ensemble d'entrées pour une lettre donnée.
...
Obtient l'ID de langue utilisé pour générer l'index.
...
**Returns:**
java.lang.String - L'ID de langue utilisé pour générer l'index.
...
Obtient une plage de lettres à laquelle limiter l'index.
...
**Returns:**
java.lang.String - Une plage de lettres à laquelle limiter l'index.
...
Obtient le nombre de colonnes par page utilisé lors de la création de l'index.
...
**Returns:**
java.lang.String - Le nombre de colonnes par page utilisé lors de la création de l'index.
...
Obtient la séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page.
...
**Returns:**
java.lang.String - La séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page.
...
Obtient la séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page.
...
**Returns:**
java.lang.String - La séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page.
...
Obtient la séquence de caractères utilisée pour séparer le début et la fin d’une plage de pages.
...
**Returns:**
java.lang.String - La séquence de caractères utilisée pour séparer le début et la fin d’une plage de pages.
### getResult() {#getResult}
```
...
Obtient si les sous‑entrées sont placées sur la même ligne que l'entrée principale.
...
**Returns:**
boolean - Indique si les sous‑entrées sont placées sur la même ligne que l'entrée principale.
...
Obtient le nom d’une séquence dont le numéro est inclus avec le numéro de page.
...
**Returns:**
java.lang.String - Le nom d'une séquence dont le numéro est inclus avec le numéro de page.
...
Obtient s'il faut activer l'utilisation du texte yomi pour les entrées d'index.
...
**Returns:**
boolean - Indique s'il faut activer l'utilisation du texte yomi pour les entrées d'index.
...
**Returns:**
boolean - Valeur indiquant si le séparateur de numéro de page est remplacé via le code du champ.
...
**Returns:**
boolean - Valeur indiquant si une séquence doit être utilisée lors de la génération du résultat du champ.
### isDirty() {#isDirty}
```
...
Définit le nom du signet qui marque la partie du document utilisée pour créer l'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du signet qui marque la partie du document utilisée pour créer l'index. |
...
Définit la séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La séquence de caractères utilisée pour séparer les renvois croisés et les autres entrées. |
...
Définit un type d'entrée d'index utilisé pour créer l'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un type d'entrée d'index utilisé pour créer l'index. |
...
Définit un titre qui apparaît au début de chaque ensemble d'entrées pour une lettre donnée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un titre qui apparaît au début de chaque groupe d'entrées pour une lettre donnée. |
...
Définit l'ID de langue utilisé pour générer l'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'ID de langue utilisé pour générer l'index. |
...
Définit une plage de lettres à laquelle limiter l'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une plage de lettres à laquelle limiter l'index. |
...
Définit le nombre de colonnes par page utilisé lors de la création de l'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de colonnes par page utilisé lors de la création de l'index. |
...
Définit la séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La séquence de caractères utilisée pour séparer deux numéros de page dans une liste de numéros de page. |
...
Définit la séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La séquence de caractères utilisée pour séparer une entrée d'index et son numéro de page. |
...
Définit la séquence de caractères utilisée pour séparer le début et la fin d’une plage de pages.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La séquence de caractères utilisée pour séparer le début et la fin d'une plage de pages. |
...
Définit si les sous‑entrées sont placées sur la même ligne que l'entrée principale.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si les sous‑entrées sont placées sur la même ligne que l'entrée principale. |
...
Définit le nom d’une séquence dont le numéro est inclus avec le numéro de page.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom d'une séquence dont le numéro est inclus avec le numéro de page. |
...
Définit s'il faut activer l'utilisation du texte yomi pour les entrées d'index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut activer l'utilisation du texte yomi pour les entrées d'index. |
