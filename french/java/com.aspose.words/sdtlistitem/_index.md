...
description: "Cet élément spécifie un seul élément de liste au sein d'une balise de document structuré parent SdtType.COMBO_BOX ou SdtType.DROP_DOWN_LIST en Java."
type: docs
weight: 602
url: /fr/java/com.aspose.words/sdtlistitem/
---
...
Cet élément spécifie un seul élément de liste au sein d'une balise de document structuré parent [SdtType.COMBO_BOX](../../com.aspose.words/sdttype/#COMBO-BOX) ou [SdtType.DROP_DOWN_LIST](../../com.aspose.words/sdttype/#DROP-DOWN-LIST).
...
| --- | --- |
| [SdtListItem(String displayText, String value)](#SdtListItem-java.lang.String-java.lang.String) | Initialise une nouvelle instance de cette classe. |
| [SdtListItem(String value)](#SdtListItem-java.lang.String) | Initialise une nouvelle instance de cette classe. |
## Méthodes

| Méthode | Description |
| --- | --- |
| [getDisplayText()](#getDisplayText) | Obtient le texte à afficher dans le contenu d'exécution à la place du contenu de l'attribut [getValue()](../../com.aspose.words/sdtlistitem/#getValue) pour cet élément de liste. |
| [getValue()](#getValue) | Obtient la valeur de cet élément de liste. |
...
Obtient le texte à afficher dans le contenu d'exécution à la place du contenu de l'attribut [getValue()](../../com.aspose.words/sdtlistitem/#getValue) pour cet élément de liste.
...
**Returns:**
java.lang.String - Le texte à afficher dans le contenu d'exécution à la place du contenu de l'attribut [getValue()](../../com.aspose.words/sdtlistitem/#getValue) pour cet élément de liste.
### getValue() {#getValue}
```
...
**Returns:**
java.lang.String - La valeur de cet élément de liste.
