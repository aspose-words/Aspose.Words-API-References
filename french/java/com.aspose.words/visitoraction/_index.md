...
description: "Permet au visiteur de contrôler l'énumération des nœuds en Java."
type: docs
weight: 716
url: /fr/java/com.aspose.words/visitoraction/
---
...
| Champ | Description |
| --- | --- |
| [CONTINUE](#CONTINUE) | Le visiteur demande que l'énumération continue. |
| [SKIP_THIS_NODE](#SKIP-THIS-NODE) | Le visiteur demande d'ignorer le nœud actuel et de poursuivre l'énumération. |
| [STOP](#STOP) | Le visiteur demande d'arrêter l'énumération des nœuds. |
| [length](#length) |  |
## Méthodes
...
Le visiteur demande que l'énumération continue.
...
Le visiteur demande d'ignorer le nœud actuel et de poursuivre l'énumération.
...
Le visiteur demande d'arrêter l'énumération des nœuds.
