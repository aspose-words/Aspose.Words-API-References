...
description: "Implémente le champ AUTONUMLGL en Java."
type: docs
weight: 202
url: /fr/java/com.aspose.words/fieldautonumlgl/
---
...
Insère un numéro automatique au format juridique.

 **Examples:** 

Montre comment organiser un document en utilisant les champs AUTONUMLGL.
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Obtient si le numéro doit être affiché sans point final. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Obtient le caractère séparateur à utiliser. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Définit si le numéro doit être affiché sans point final. |
...
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Définit le caractère séparateur à utiliser. |
...
Obtient si le numéro doit être affiché sans point final.
...
**Returns:**
boolean - Indique si le numéro doit être affiché sans point final.
### getResult() {#getResult}
```
...
Obtient le caractère séparateur à utiliser.
...
**Returns:**
java.lang.String - Le caractère séparateur à utiliser.
### getStart() {#getStart}
```
...
Définit si le numéro doit être affiché sans point final.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si le numéro doit être affiché sans point final. |
...
Définit le caractère séparateur à utiliser.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le caractère séparateur à utiliser. |
