...
description: "Indique le début d'une région de texte à laquelle un commentaire est associé en Java."
type: docs
weight: 112
url: /fr/java/com.aspose.words/commentrangestart/
---
...
Indique le début d'une région de texte associée à un commentaire.

Pour en savoir plus, consultez l'article de documentation [ Working with Comments ][Working with Comments].

 **Remarks:** 

Pour créer un commentaire ancré à une région de texte, vous devez créer un [Comment](../../com.aspose.words/comment/) puis créer [CommentRangeStart](../../com.aspose.words/commentrangestart/) et [CommentRangeEnd](../../com.aspose.words/commentrangeend/) et définir leurs identifiants sur la même valeur [Comment.getId()](../../com.aspose.words/comment/\\#getId) / [Comment.setId(int)](../../com.aspose.words/comment/\\#setId-int).
...
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | Initialise une nouvelle instance de cette classe. |
## Méthodes
...
| [getId()](#getId) | Spécifie l'identifiant du commentaire auquel cette région est liée. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Obtient le nœud immédiatement suivant ce nœud. |
| [getNodeType()](#getNodeType) | Renvoie [NodeType.COMMENT\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#COMMENT-RANGE-START). |
...
| [setId(int value)](#setId-int) | Spécifie l'identifiant du commentaire auquel cette région est liée. |
...
Lorsque [CommentRangeStart](../../com.aspose.words/commentrangestart/) est créé, il appartient au document spécifié, mais n'en fait pas encore partie et [Node.getParentNode()](../../com.aspose.words/node/\\#getParentNode) est nul.

Pour ajouter un [CommentRangeStart](../../com.aspose.words/commentrangestart/) au document, utilisez InsertAfter ou InsertBefore sur le paragraphe où vous souhaitez insérer le commentaire.
...
| id | int | L'identifiant du commentaire auquel cet objet est lié. |
...
Appelle [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\\#visitCommentRangeStart-com.aspose.words.CommentRangeStart).
...
Renvoie [NodeType.COMMENT\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#COMMENT-RANGE-START).
...
**Returns:**
int - [NodeType.COMMENT\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#COMMENT-RANGE-START). La valeur retournée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
