...
description: "Représente la fin d'une plage modifiable dans un document Word en Java."
type: docs
weight: 180
url: /fr/java/com.aspose.words/editablerangeend/
---
...
Une plage modifiable complète dans un document Word se compose d'un [getEditableRangeStart()](../../com.aspose.words/editablerangeend/\#getEditableRangeStart) et d'un [EditableRangeEnd](../../com.aspose.words/editablerangeend/) correspondant avec le même Id.
...
Utilisez la classe [EditableRange](../../com.aspose.words/editablerange/) comme une "façade" pour travailler avec une plage modifiable en tant qu'objet unique.

Actuellement, les plages modifiables ne sont prises en charge qu'au niveau en ligne, c'est‑à‑dire à l'intérieur du [Paragraph](../../com.aspose.words/paragraph/), mais le début et la fin d'une plage modifiable peuvent se trouver dans des paragraphes différents.
...
| [getEditableRangeStart()](#getEditableRangeStart) | [EditableRangeStart](../../com.aspose.words/editablerangestart/) correspondant, reçu par ID. |
| [getId()](#getId) | Spécifie l'identifiant de la plage modifiable. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Obtient le nœud immédiatement suivant ce nœud. |
| [getNodeType()](#getNodeType) | Renvoie [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). |
...
| [setId(int value)](#setId-int) | Spécifie l'identifiant de la plage modifiable. |
...
Appelle [DocumentVisitor.visitEditableRangeEnd(com.aspose.words.EditableRangeEnd)](../../com.aspose.words/documentvisitor/\#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd).
...
[EditableRangeStart](../../com.aspose.words/editablerangestart/) correspondant, reçu par ID.
...
Renvoie [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END).
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). La valeur renvoyée fait partie des constantes [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
