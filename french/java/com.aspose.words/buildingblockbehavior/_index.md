...
description: "Spécifie le comportement qui doit être appliqué au contenu du bloc de construction lorsqu'il est inséré dans le document principal en Java."
type: docs
weight: 53
url: /fr/java/com.aspose.words/buildingblockbehavior/
---
...
Spécifie le comportement qui doit être appliqué au contenu du building block lorsqu'il est inséré dans le document principal.

 **Remarks:** 

Correspond au type **ST\_DocPartBehavior** dans OOXML.
...
| Champ | Description |
| --- | --- |
| [CONTENT](#CONTENT) | Spécifie que le bloc de construction doit être inséré en tant que contenu en ligne. |
| [DEFAULT](#DEFAULT) | Identique à [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT). |
| [PAGE](#PAGE) | Spécifie que le bloc de construction doit être ajouté sur sa propre page. |
| [PARAGRAPH](#PARAGRAPH) | Spécifie que le bloc de construction doit être inséré dans son propre paragraphe. |
| [length](#length) |  |
## Méthodes
...
Spécifie que le bloc de construction doit être inséré en tant que contenu en ligne.
...
Identique à [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT).
...
Spécifie que le bloc de construction doit être ajouté sur sa propre page.
...
Spécifie que le bloc de construction doit être inséré dans son propre paragraphe.
