...
description: "Spécifie les positions possibles des marques de graduation en Java."
type: docs
weight: 32
url: /fr/java/com.aspose.words/axistickmark/
---
...
Spécifie les positions possibles pour les marques de graduation.
...
| Champ | Description |
| --- | --- |
| [CROSS](#CROSS) | Spécifie que les marques de graduation doivent traverser l'axe. |
| [INSIDE](#INSIDE) | Spécifie que les marques de graduation doivent être à l'intérieur de la zone du tracé. |
| [NONE](#NONE) | Spécifie qu'il ne doit y avoir aucune marque de graduation. |
| [OUTSIDE](#OUTSIDE) | Spécifie que les marques de graduation doivent être à l'extérieur de la zone du tracé. |
| [length](#length) |  |
## Méthodes
...
Spécifie que les marques de graduation doivent traverser l'axe.
...
Spécifie que les marques de graduation doivent être à l'intérieur de la zone du tracé.
...
Spécifie qu'il ne doit y avoir aucune marque de graduation.
...
Spécifie que les marques de graduation doivent être à l'extérieur de la zone du tracé.
