...
description: "Indique la version de HTML utilisée lors de l'enregistrement du document aux formats SaveFormat.HTML et SaveFormat.MHTML en Java."
type: docs
weight: 386
url: /fr/java/com.aspose.words/htmlversion/
---
...
Indique la version de HTML utilisée lors de l'enregistrement du document aux formats [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) et [SaveFormat.MHTML](../../com.aspose.words/saveformat/\#MHTML).
...
// Notre document ne contiendra qu'un en-tête de déclaration DOCTYPE si nous avons défini le drapeau "ExportXhtmlTransitional" sur "true".
