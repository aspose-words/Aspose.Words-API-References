...
description: "Représente un séparateur de champ Word qui sépare le code du champ du résultat du champ en Java."
type: docs
weight: 283
url: /fr/java/com.aspose.words/fieldseparator/
---
...
Représente un séparateur de champ Word qui sépare le code du champ du résultat du champ.
...
Un champ complet dans un document Microsoft Word est une structure complexe composée d'un caractère de début de champ, d'un code de champ, d'un caractère de séparateur de champ, d'un résultat de champ et d'un caractère de fin de champ. Certains champs n'ont que le caractère de début de champ, le code de champ et le caractère de fin de champ.

Pour insérer facilement un nouveau champ dans un document, utilisez la méthode [DocumentBuilder.insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String).
...
| [getFieldType()](#getFieldType) | Renvoie le type du champ. |
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype/\#FIELD-SEPARATOR). |
...
| [isLocked()](#isLocked) | Obtient si le champ parent est verrouillé (ne doit pas recalculer son résultat). |
| [isLocked(boolean value)](#isLocked-boolean) | Définit si le champ parent est verrouillé (ne doit pas recalculer son résultat). |
...
Appelle [DocumentVisitor.visitFieldSeparator(com.aspose.words.FieldSeparator)](../../com.aspose.words/documentvisitor/\#visitFieldSeparator-com.aspose.words.FieldSeparator).
...
**Returns:**
boolean - **False** si le visiteur a demandé l'arrêt de l'énumération.
### clearRunAttrs() {#clearRunAttrs}
```
...
Un nouvel objet [Field](../../com.aspose.words/field/) est créé chaque fois que la méthode est appelée.
...
**Returns:**
int - Le type du champ. La valeur renvoyée est l'une des constantes [FieldType](../../com.aspose.words/fieldtype/).
### getFont() {#getFont}
```
public Font getFont()
```
...
Renvoie [NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype/\#FIELD-SEPARATOR).
...
**Returns:**
int - [NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype/\#FIELD-SEPARATOR). La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
...
Obtient si le champ parent est verrouillé (ne doit pas recalculer son résultat).
...
**Returns:**
booléen - Indique si le champ parent est verrouillé (ne doit pas recalculer son résultat).
...
Définit si le champ parent est verrouillé (ne doit pas recalculer son résultat).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si le champ parent est verrouillé (ne doit pas recalculer son résultat). |
