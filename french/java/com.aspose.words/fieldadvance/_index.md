...
description: "Implémente le champ ADVANCE en Java."
type: docs
weight: 197
url: /fr/java/com.aspose.words/fieldadvance/
---
...
Déplace le point de départ où le texte qui suit lexicalement le champ est affiché vers la droite ou la gauche, vers le haut ou le bas, ou vers une position horizontale ou verticale spécifique.
...
| [getDownOffset()](#getDownOffset) | Obtient le nombre de points de déplacement du texte qui suit le champ vers le bas. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Obtient le nombre de points de déplacement du texte qui suit le champ horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte. |
| [getLeftOffset()](#getLeftOffset) | Obtient le nombre de points de déplacement du texte qui suit le champ vers la gauche. |
...
| [getRightOffset()](#getRightOffset) | Obtient le nombre de points de déplacement du texte qui suit le champ vers la droite. |
...
| [getUpOffset()](#getUpOffset) | Obtient le nombre de points de déplacement du texte qui suit le champ vers le haut. |
| [getVerticalPosition()](#getVerticalPosition) | Obtient le nombre de points de déplacement du texte qui suit le champ verticalement depuis le bord supérieur de la page. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Définit le nombre de points de déplacement du texte qui suit le champ vers le bas. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la gauche. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la droite. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le haut. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé verticalement depuis le bord supérieur de la page. |
...
Obtient le nombre de points de déplacement du texte qui suit le champ vers le bas.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le bas.
### getEnd() {#getEnd}
```
...
Obtient le nombre de points de déplacement du texte qui suit le champ horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte.
...
Obtient le nombre de points de déplacement du texte qui suit le champ vers la gauche.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la gauche.
...
Obtient le nombre de points de déplacement du texte qui suit le champ vers la droite.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la droite.
...
Obtient le nombre de points de déplacement du texte qui suit le champ vers le haut.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le haut.
...
Obtient le nombre de points de déplacement du texte qui suit le champ verticalement depuis le bord supérieur de la page.
...
**Returns:**
java.lang.String - Le nombre de points selon lequel le texte qui suit le champ doit être déplacé verticalement depuis le bord supérieur de la page.
### isDirty() {#isDirty}
```
...
Définit le nombre de points de déplacement du texte qui suit le champ vers le bas.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le bas. |
...
Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé horizontalement depuis le bord gauche de la colonne, du cadre ou de la zone de texte. |
...
Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la gauche.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la gauche. |
...
Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la droite.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers la droite. |
...
Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le haut.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé vers le haut. |
...
Définit le nombre de points selon lequel le texte qui suit le champ doit être déplacé verticalement depuis le bord supérieur de la page.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nombre de points selon lequel le texte qui suit le champ doit être déplacé verticalement depuis le bord supérieur de la page. |
