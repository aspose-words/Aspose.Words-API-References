...
description: "Énumère les types de liaison disponibles entre une extension web et les données du document en Java."
type: docs
weight: 729
url: /fr/java/com.aspose.words/webextensionbindingtype/
---
...
Énumère les types disponibles de liaison entre une extension web et les données du document.
...
| Champ | Description |
| --- | --- |
| [DEFAULT](#DEFAULT) | Matrice utilisée par défaut. |
| [MATRIX](#MATRIX) | Données tabulaires sans ligne d’en-tête. |
| [TABLE](#TABLE) | Données tabulaires avec une ligne d’en-tête. |
...
Données tabulaires sans ligne d’en-tête.
...
Données tabulaires avec une ligne d’en-tête.
