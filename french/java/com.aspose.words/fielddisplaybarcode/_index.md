...
description: "Implémente le champ DISPLAYBARCODE en Java."
type: docs
weight: 223
url: /fr/java/com.aspose.words/fielddisplaybarcode/
---
...
Montre comment effectuer une fusion de courrier sur des codes-barres QR.
...
| Méthode | Description |
| --- | --- |
| [getAddStartStopChar()](#getAddStartStopChar) | Obtient si l'on doit ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39. |
| [getBackgroundColor()](#getBackgroundColor) | Obtient la couleur d'arrière-plan du symbole du code-barres. |
| [getBarcodeType()](#getBarcodeType) | Obtient le type de code-barres (QR, etc.) |
| [getBarcodeValue()](#getBarcodeValue) | Obtient la valeur du code-barres. |
| [getCaseCodeStyle()](#getCaseCodeStyle) | Obtient le style d'un Code de cas pour le type de code-barres ITF14. |
| [getDisplayResult()](#getDisplayResult) | Obtient le texte qui représente le résultat du champ affiché. |
| [getDisplayText()](#getDisplayText) | Obtient si l'on doit afficher les données du code-barres (texte) avec l'image. |
| [getEnd()](#getEnd) | Obtient le nœud qui représente la fin du champ. |
| [getErrorCorrectionLevel()](#getErrorCorrectionLevel) | Obtient le niveau de correction d'erreur du QR Code. |
...
| [getFixCheckDigit()](#getFixCheckDigit) | Obtient si l’on doit corriger le chiffre de contrôle s\u2019il est invalide. |
| [getForegroundColor()](#getForegroundColor) | Obtient la couleur de premier plan du symbole du code-barres. |
...
| [getScalingFactor()](#getScalingFactor) | Obtient un facteur d'échelle pour le symbole. |
...
| [getSymbolHeight()](#getSymbolHeight) | Obtient la hauteur du symbole. |
| [getSymbolRotation()](#getSymbolRotation) | Obtient la rotation du symbole du code-barres. |
...
| [setAddStartStopChar(boolean value)](#setAddStartStopChar-boolean) | Définit si l'on doit ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39. |
| [setBackgroundColor(String value)](#setBackgroundColor-java.lang.String) | Définit la couleur d'arrière-plan du symbole du code-barres. |
| [setBarcodeType(String value)](#setBarcodeType-java.lang.String) | Définit le type de code-barres (QR, etc.) |
| [setBarcodeValue(String value)](#setBarcodeValue-java.lang.String) | Définit la valeur du code-barres. |
| [setCaseCodeStyle(String value)](#setCaseCodeStyle-java.lang.String) | Définit le style d’un Case Code pour le type de code-barres ITF14. |
| [setDisplayText(boolean value)](#setDisplayText-boolean) | Définit s’il faut afficher les données du code-barres (texte) avec l’image. |
| [setErrorCorrectionLevel(String value)](#setErrorCorrectionLevel-java.lang.String) | Définit un niveau de correction d’erreur du QR Code. |
| [setFixCheckDigit(boolean value)](#setFixCheckDigit-boolean) | Définit s’il faut corriger le chiffre de contrôle s’il est invalide. |
| [setForegroundColor(String value)](#setForegroundColor-java.lang.String) | Définit la couleur de premier plan du symbole du code-barres. |
...
| [setScalingFactor(String value)](#setScalingFactor-java.lang.String) | Définit un facteur d’échelle pour le symbole. |
| [setSymbolHeight(String value)](#setSymbolHeight-java.lang.String) | Définit la hauteur du symbole. |
| [setSymbolRotation(String value)](#setSymbolRotation-java.lang.String) | Définit la rotation du symbole du code-barres. |
...
Obtient si l'on doit ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39.
...
**Returns:**
booléen - Indique s’il faut ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39.
...
Obtient la couleur d’arrière-plan du symbole du code-barres. Les valeurs valides sont dans la plage [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - La couleur d’arrière-plan du symbole du code-barres.
...
Obtient le type de code-barres (QR, etc.)
...
**Returns:**
java.lang.String - Le type de code-barres (QR, etc.)
...
**Returns:**
java.lang.String - La valeur du code-barres.
...
Obtient le style d’un Case Code pour le type de code-barres ITF14. Les valeurs valides sont [STD|EXT|ADD]
...
**Returns:**
java.lang.String - Le style d’un Case Code pour le type de code-barres ITF14.
...
Obtient si l'on doit afficher les données du code-barres (texte) avec l'image.
...
**Returns:**
booléen - Indique s’il faut afficher les données du code-barres (texte) avec l’image.
### getEnd() {#getEnd}
```
...
Obtient un niveau de correction d’erreur du QR Code. Les valeurs valides sont [0, 3].
...
**Returns:**
java.lang.String - Un niveau de correction d’erreur du QR Code.
...
Obtient si l’on doit corriger le chiffre de contrôle s\u2019il est invalide.
...
**Returns:**
booléen - Indique s’il faut corriger le chiffre de contrôle s’il est invalide.
...
Obtient la couleur de premier plan du symbole du code-barres. Les valeurs valides sont dans la plage [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - La couleur de premier plan du symbole du code-barres.
### getFormat() {#getFormat}
```
...
Obtient le style d’un code-barres Point de Vente (types de code-barres UPCA|UPCE|EAN13|EAN8). Les valeurs valides (insensibles à la casse) sont [STD|SUP2|SUP5|CASE].
...
**Returns:**
java.lang.String - Le style d’un code-barres Point de Vente (types de code-barres UPCA|UPCE|EAN13|EAN8).
### getResult() {#getResult}
```
...
Obtient un facteur d'échelle pour le symbole. La valeur est en points de pourcentage entiers et les valeurs valides sont [10, 1000]
...
**Returns:**
java.lang.String - Un facteur d'échelle pour le symbole.
...
Obtient la hauteur du symbole. Les unités sont en TWIPS (1/1440 pouce).
...
**Returns:**
java.lang.String - La hauteur du symbole.
...
Obtient la rotation du symbole de code-barres. Les valeurs valides sont [0, 3]
...
**Returns:**
java.lang.String - La rotation du symbole de code-barres.
### getType() {#getType}
```
public int getType()
```
...
Définit si l'on doit ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut ajouter les caractères de début/fin pour les types de code-barres NW7 et CODE39. |
...
Définit la couleur d'arrière-plan du symbole de code-barres. Les valeurs valides sont dans la plage [0, 0xFFFFFF]
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La couleur d'arrière-plan du symbole de code-barres. |
...
Définit le type de code-barres (QR, etc.)
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le type de code-barres (QR, etc.) |
...
Définit la valeur du code-barres.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La valeur du code-barres. |
...
Définit le style d'un Code de Boîtier pour le type de code-barres ITF14. Les valeurs valides sont [STD|EXT|ADD]
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le style d'un Code de Boîtier pour le type de code-barres ITF14. |
...
Définit s’il faut afficher les données du code-barres (texte) avec l’image.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut afficher les données du code-barres (texte) avec l'image. |
...
Définit un niveau de correction d'erreur du QR Code. Les valeurs valides sont [0, 3].
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un niveau de correction d'erreur du QR Code. |
...
Définit s’il faut corriger le chiffre de contrôle s’il est invalide.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut corriger le chiffre de contrôle s'il est invalide. |
...
Définit la couleur de premier plan du symbole de code-barres. Les valeurs valides sont dans la plage [0, 0xFFFFFF]
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La couleur de premier plan du symbole de code-barres. |
...
Définit le style d'un code-barres Point de Vente (types de code-barres UPCA|UPCE|EAN13|EAN8). Les valeurs valides (insensibles à la casse) sont [STD|SUP2|SUP5|CASE].
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le style d'un code-barres Point de Vente (types de code-barres UPCA | UPCE | EAN13 | EAN8). |
...
Définit un facteur d'échelle pour le symbole. La valeur est en points de pourcentage entiers et les valeurs valides sont [10, 1000]
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un facteur d'échelle pour le symbole. |
...
Définit la hauteur du symbole. Les unités sont en TWIPS (1/1440 pouce).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La hauteur du symbole. |
...
Définit la rotation du symbole de code-barres. Les valeurs valides sont [0, 3]
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La rotation du symbole de code-barres. |
