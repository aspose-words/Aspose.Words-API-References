...
description: "Implémente le champ TA en Java."
type: docs
weight: 292
url: /fr/java/com.aspose.words/fieldta/
---
...
Définit le texte et le numéro de page d'une entrée de table des autorités, qui est utilisée par un champ TOA.
...
| [getEntryCategory()](#getEntryCategory) | Obtient la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories. |
...
| [getLongCitation()](#getLongCitation) | Obtient la citation longue de l'entrée. |
...
| [getShortCitation()](#getShortCitation) | Obtient la citation courte de l'entrée. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Définit la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String) | Définit la citation longue de l'entrée. |
...
| [setShortCitation(String value)](#setShortCitation-java.lang.String) | Définit la citation courte de l'entrée. |
...
Obtient la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories.
...
**Returns:**
java.lang.String - La catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories.
...
Obtient la citation longue de l'entrée.
...
**Returns:**
java.lang.String - La citation longue de l'entrée.
...
Obtient la citation courte de l'entrée.
...
**Returns:**
java.lang.String - La citation courte de l'entrée.
### getStart() {#getStart}
```
...
**Returns:**
boolean - Si le format gras doit être appliqué au numéro de page de l'entrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Si le format gras doit être appliqué au numéro de page de l'entrée. |
...
**Returns:**
boolean - Si le format italique doit être appliqué au numéro de page de l'entrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Si le format italique doit être appliqué au numéro de page de l'entrée. |
...
Définit la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories. |
...
Définit la citation longue de l'entrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La citation longue de l'entrée. |
...
Définit la citation courte de l'entrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La citation courte de l'entrée. |
