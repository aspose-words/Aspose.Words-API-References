...
description: "Représente une collection de nœuds correspondant à une requête XPath exécutée à l'aide de la méthode CompositeNode.selectNodesjava.lang.String en Java."
type: docs
weight: 481
url: /fr/java/com.aspose.words/nodelist/
---
...
Représente une collection de nœuds correspondant à une requête XPath exécutée à l'aide de la méthode [CompositeNode.selectNodes(java.lang.String)](../../com.aspose.words/compositenode/\#selectNodes-java.lang.String).
...
| Méthode | Description |
| --- | --- |
| [get(int index)](#get-int) | Récupère un nœud à l'index donné. |
| [getCount()](#getCount) | Obtient le nombre de nœuds dans la liste. |
...
Montre comment utiliser les XPaths pour parcourir un NodeList.
...
| --- | --- | --- |
| index | int | Un indice dans la liste de nœuds. |
...
**Returns:**
int - Le nombre de nœuds dans la liste.
### iterator() {#iterator}
```
