...
description: "Représente un objet d'extension web en Java."
type: docs
weight: 726
url: /fr/java/com.aspose.words/webextension/
---
...
| Méthode | Description |
| --- | --- |
| [getAlternateReferences()](#getAlternateReferences) | Spécifie des références alternatives à une extension web. |
| [getBindings()](#getBindings) | Spécifie une liste de liaisons d'extension web. |
| [getId()](#getId) | Identifie de manière unique l'instance d'extension web dans le document actuel. |
| [getProperties()](#getProperties) | Représente un ensemble de propriétés personnalisées d'extension web. |
| [getReference()](#getReference) | Spécifie la référence principale à une extension web. |
| [isFrozen()](#isFrozen) | Spécifie si l'utilisateur peut interagir avec l'extension web ou non. |
| [isFrozen(boolean value)](#isFrozen-boolean) | Spécifie si l'utilisateur peut interagir avec l'extension web ou non. |
| [setId(String value)](#setId-java.lang.String) | Identifie de manière unique l'instance d'extension web dans le document actuel. |
