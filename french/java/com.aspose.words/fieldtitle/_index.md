...
description: "Implémente le champ TITLE en Java."
type: docs
weight: 296
url: /fr/java/com.aspose.words/fieldtitle/
---
...
Récupère, et éventuellement définit, le titre du document, tel qu'enregistré dans la propriété **Title** des propriétés intégrées du document.
...
| [getText()](#getText) | Obtient le texte du titre. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte du titre. |
...
**Returns:**
java.lang.String - Le texte du titre.
### getType() {#getType}
```
public int getType()
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte du titre. |
