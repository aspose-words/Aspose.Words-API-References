...
description: "Implémente le champ PRIVATE en Java."
type: docs
weight: 275
url: /fr/java/com.aspose.words/fieldprivate/
---
...
Implémente le champ PRIVATE.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Fournit une zone de stockage privée. Ce champ est utilisé pour stocker des données pour les documents convertis à partir d'autres formats de fichier.
