...
description: "Implémente le champ USERADDRESS en Java."
type: docs
weight: 303
url: /fr/java/com.aspose.words/fielduseraddress/
---
...
| [getUserAddress()](#getUserAddress) | Obtient l'adresse postale de l'utilisateur actuel. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | Définit l'adresse postale de l'utilisateur actuel. |
...
Obtient l'adresse postale de l'utilisateur actuel.
...
**Returns:**
java.lang.String - L'adresse postale de l'utilisateur actuel.
### isDirty() {#isDirty}
```
...
Définit l'adresse postale de l'utilisateur actuel.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'adresse postale de l'utilisateur actuel. |
