...
description: "Contient des informations sur un avertissement de substitution de police que Aspose.Words a émis lors du chargement ou de l’enregistrement d’un document en Java."
type: docs
weight: 338
url: /fr/java/com.aspose.words/fontsubstitutionwarninginfo/
---
...
| [getReason()](#getReason) | Raison de la substitution de police. |
| [getRequestedBold()](#getRequestedBold) | Indique si le style gras a été demandé. |
| [getRequestedFamilyName()](#getRequestedFamilyName) | Nom de la famille de polices demandé. |
| [getRequestedItalic()](#getRequestedItalic) | Indique si le style italique a été demandé. |
| [getResolvedFont()](#getResolvedFont) | Police résolue. |
...
Raison de la substitution de police.
...
**Returns:**
int - La valeur int correspondante. La valeur retournée est l'une des constantes [FontSubstitutionReason](../../com.aspose.words/fontsubstitutionreason/).
...
Nom de la famille de polices demandé.
...
Indique si le style italique a été demandé.
