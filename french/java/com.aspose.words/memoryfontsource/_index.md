...
description: "Représente le fichier de police TrueType unique stocké en mémoire en Java."
type: docs
weight: 461
url: /fr/java/com.aspose.words/memoryfontsource/
---
...
| [getFontData()](#getFontData) | Données de police binaires. |
...
| fontData | byte[] | Données de police binaires. |
| priority | int | Priorité de la source de police. Voir la description de la propriété [FontSourceBase.getPriority()](../../com.aspose.words/fontsourcebase/\#getPriority) pour plus d’informations. |
| cacheKey | java.lang.String | La clé de cette source dans le cache. Voir la description de la propriété [getCacheKey()](../../com.aspose.words/memoryfontsource/\#getCacheKey) pour plus d'informations. |
