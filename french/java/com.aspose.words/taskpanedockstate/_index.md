...
description: "Énumère les emplacements disponibles de l'objet volet de tâches en Java."
type: docs
weight: 665
url: /fr/java/com.aspose.words/taskpanedockstate/
---
...
Énumère les emplacements disponibles de l'objet de volet de tâche.
...
| Champ | Description |
| --- | --- |
| [LEFT](#LEFT) | Ancre le volet de tâches sur le côté gauche de la fenêtre du document. |
| [RIGHT](#RIGHT) | Ancre le volet de tâches sur le côté droit de la fenêtre du document. |
| [length](#length) |  |
## Méthodes
...
Ancre le volet de tâches sur le côté gauche de la fenêtre du document.
...
Ancre le volet de tâches sur le côté droit de la fenêtre du document.
