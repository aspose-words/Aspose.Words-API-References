...
description: "Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les feuilles de style CSS lors de la sauvegarde d'un document au format HTML en Java."
type: docs
weight: 756
url: /fr/java/com.aspose.words/icsssavingcallback/
---
```
public interface ICssSavingCallback
```

Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre le CSS (Cascading Style Sheet) lors de l'enregistrement d'un document en HTML.
...
| Méthode | Description |
| --- | --- |
| [cssSaving(CssSavingArgs args)](#cssSaving-com.aspose.words.CssSavingArgs) | Appelé lorsque Aspose.Words enregistre un CSS (Cascading Style Sheet). |
...
Appelé lorsque Aspose.Words enregistre un CSS (Cascading Style Sheet).
