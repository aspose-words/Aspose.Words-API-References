...
description: "Implémente le champ PRINT en Java."
type: docs
weight: 273
url: /fr/java/com.aspose.words/fieldprint/
---
...
| [getPostScriptGroup()](#getPostScriptGroup) | Obtient le rectangle de dessin sur lequel les instructions PostScript opèrent. |
| [getPrinterInstructions()](#getPrinterInstructions) | Obtient les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | Définit le rectangle de dessin sur lequel les instructions PostScript opèrent. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Définit les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript. |
...
Obtient le rectangle de dessin sur lequel les instructions PostScript opèrent.
...
**Returns:**
java.lang.String - Le rectangle de dessin sur lequel les instructions PostScript opèrent.
...
Obtient les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript.
...
**Returns:**
java.lang.String - Les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript.
### getResult() {#getResult}
```
...
Définit le rectangle de dessin sur lequel les instructions PostScript opèrent.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le rectangle de dessin sur lequel les instructions PostScript opèrent. |
...
Définit les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Les caractères de code de contrôle spécifiques à l'imprimante ou les instructions PostScript. |
