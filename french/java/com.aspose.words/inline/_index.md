...
description: "Classe de base pour les nœuds de niveau inline qui peuvent avoir un formatage de caractères associé, mais qui ne peuvent pas avoir de nœuds enfants propres en Java."
type: docs
weight: 403
url: /fr/java/com.aspose.words/inline/
---
...
Classe de base pour les nœuds de niveau en ligne qui peuvent avoir un formatage de caractères associé, mais ne peuvent pas avoir de nœuds enfants.

Pour en savoir plus, consultez l'article de documentation [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document].

 **Remarks:** 

Une classe dérivée de [Inline](../../com.aspose.words/inline/) peut être un enfant de [Paragraph](../../com.aspose.words/paragraph/).
...
| [getNodeType()](#getNodeType) | Obtient le type de ce nœud. |
...
**Returns:**
int - Le type de ce nœud. La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
