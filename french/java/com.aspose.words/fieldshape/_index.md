...
description: "Implémente le champ SHAPE en Java."
type: docs
weight: 286
url: /fr/java/com.aspose.words/fieldshape/
---
...
Montre comment certains champs Microsoft Word plus anciens tels que SHAPE et EMBED sont gérés lors du chargement.
...
| [getText()](#getText) | Obtient le texte à récupérer. |
...
| [setText(String value)](#setText-java.lang.String) | Définit le texte à récupérer. |
...
**Returns:**
java.lang.String - Le texte à récupérer.
### getType() {#getType}
```
public int getType()
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte à récupérer. |
