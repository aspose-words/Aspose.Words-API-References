...
description: "Spécifie les positions possibles pour les étiquettes de graduation en Java."
type: docs
weight: 30
url: /fr/java/com.aspose.words/axisticklabelposition/
---
...
| Champ | Description |
| --- | --- |
| [DEFAULT](#DEFAULT) | Spécifie la valeur par défaut de la position des étiquettes de graduation. |
| [HIGH](#HIGH) | Spécifie que les étiquettes d'axe doivent être à l'extrémité supérieure de l'axe perpendiculaire. |
| [LOW](#LOW) | Spécifie que les étiquettes d'axe doivent être à l'extrémité inférieure de l'axe perpendiculaire. |
| [NEXT_TO_AXIS](#NEXT-TO-AXIS) | Spécifie que les étiquettes d'axe doivent être à côté de l'axe. |
| [NONE](#NONE) | Spécifie que les étiquettes d'axe ne sont pas dessinées. |
| [length](#length) |  |
## Méthodes
...
Spécifie la valeur par défaut de la position des étiquettes de graduation.
...
Spécifie que les étiquettes d'axe doivent être à l'extrémité supérieure de l'axe perpendiculaire.
...
Spécifie que les étiquettes d'axe doivent être à l'extrémité inférieure de l'axe perpendiculaire.
...
Spécifie que les étiquettes d'axe doivent être à côté de l'axe.
...
Spécifie que les étiquettes d'axe ne sont pas dessinées.
