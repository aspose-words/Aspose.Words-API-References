...
description: "Permet de spécifier des options supplémentaires lors du chargement d'un document HTML dans un objet Document en Java."
type: docs
weight: 382
url: /fr/java/com.aspose.words/htmlloadoptions/
---
...
Permet de spécifier des options supplémentaires lors du chargement d'un document HTML dans un objet [Document](../../com.aspose.words/document/).
...
| [HtmlLoadOptions(String password)](#HtmlLoadOptions-java.lang.String) | Un raccourci pour initialiser une nouvelle instance de cette classe avec le mot de passe spécifié afin de charger un document chiffré. |
| [HtmlLoadOptions(int loadFormat, String password, String baseUri)](#HtmlLoadOptions-int-java.lang.String-java.lang.String) | Initialise une nouvelle instance de cette classe. |
## Méthodes
...
| [getBlockImportMode()](#getBlockImportMode) | Obtient une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. |
...
| [getConvertSvgToEmf()](#getConvertSvgToEmf) | Obtient une valeur indiquant s'il faut convertir les images SVG chargées au format EMF. |
...
| [getIgnoreNoscriptElements()](#getIgnoreNoscriptElements) | Obtient une valeur indiquant s'il faut ignorer les éléments HTML. |
...
| [getPreferredControlType()](#getPreferredControlType) | Obtient le type préféré des nœuds de document qui représenteront les éléments importés  et  . |
...
| [getSupportFontFaceRules()](#getSupportFontFaceRules) | Obtient une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées. |
| [getSupportVml()](#getSupportVml) | Obtient une valeur indiquant s'il faut prendre en charge les images VML. |
...
| [getWebRequestTimeout()](#getWebRequestTimeout) | Le nombre de millisecondes à attendre avant que la requête Web n'expire. |
...
| [setBlockImportMode(int value)](#setBlockImportMode-int) | Définit une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. |
...
| [setConvertSvgToEmf(boolean value)](#setConvertSvgToEmf-boolean) | Définit une valeur indiquant s'il faut convertir les images SVG chargées au format EMF. |
...
| [setIgnoreNoscriptElements(boolean value)](#setIgnoreNoscriptElements-boolean) | Définit une valeur indiquant s'il faut ignorer  les éléments HTML. |
...
| [setPreferredControlType(int value)](#setPreferredControlType-int) | Définit le type préféré des nœuds de document qui représenteront les éléments importés  et  . |
...
| [setSupportFontFaceRules(boolean value)](#setSupportFontFaceRules-boolean) | Définit une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées. |
| [setSupportVml(boolean value)](#setSupportVml-boolean) | Définit une valeur indiquant s'il faut prendre en charge les images VML. |
...
| [setWebRequestTimeout(int value)](#setWebRequestTimeout-int) | Le nombre de millisecondes à attendre avant que la requête Web n'expire. |
...
| --- | --- | --- |
| mot de passe | java.lang.String | Le mot de passe pour ouvrir un document chiffré. Peut être  null  ou une chaîne vide. |
...
Obtient une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. La valeur par défaut est [BlockImportMode.MERGE](../../com.aspose.words/blockimportmode/\#MERGE).
...
**Returns:**
int - Une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. La valeur retournée est l'une des constantes [BlockImportMode](../../com.aspose.words/blockimportmode/).
...
**Returns:**
boolean - Une valeur indiquant s'il faut convertir les images SVG chargées au format EMF.
...
Obtient une valeur indiquant s'il faut ignorer les éléments  HTML. La valeur par défaut est  false .

 **Remarks:** 

Comme MS Word, Aspose.Words ne prend pas en charge les scripts et, par défaut, charge le contenu des éléments  dans le document résultant. Cependant, la plupart des navigateurs prennent en charge les scripts et le contenu des  n'est pas visible. Définir cette propriété sur  true  force Aspose.Words à ignorer tous les éléments  et aide à produire des documents qui ressemblent davantage à ce qui est vu dans les navigateurs.

 **Examples:** 

Montre comment ignorer les éléments  HTML.
...
**Returns:**
boolean - Une valeur indiquant s'il faut ignorer les éléments  HTML.
...
Obtient le type préféré des nœuds de document qui représenteront les éléments  et  importés. La valeur par défaut est [HtmlControlType.FORM\_FIELD](../../com.aspose.words/htmlcontroltype/\#FORM-FIELD). Remarques : Veuillez noter que la définition de cette propriété ne garantit pas que tous les contrôles importés seront du type spécifié. Si un contrôle HTML ne peut pas être représenté avec des nœuds de document du type préféré, Aspose.Words utilisera un [HtmlControlType](../../com.aspose.words/htmlcontroltype/) compatible pour ce contrôle. Exemples : Montre comment définir le type préféré des nœuds de document qui représenteront les éléments  et  importés.   final String html = "\\r\\n\\r\\n\\r\\n" + "item1\\r\\n\\r\\n\\r\\n\\r\\n"; HtmlLoadOptions htmlLoadOptions = new HtmlLoadOptions(); htmlLoadOptions.setPreferredControlType(HtmlControlType.STRUCTURED\_DOCUMENT\_TAG); Document doc = new Document(new ByteArrayInputStream(html.getBytes(StandardCharsets.UTF\_8)), htmlLoadOptions); NodeCollection nodes = doc.getChildNodes(NodeType.STRUCTURED\_DOCUMENT\_TAG, true); StructuredDocumentTag tag = (StructuredDocumentTag) nodes.get(0);

**Returns:**
int - Type préféré des nœuds de document qui représenteront les éléments  et  importés. La valeur retournée est l'une des constantes [HtmlControlType](../../com.aspose.words/htmlcontroltype/).
...
Obtient une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées. La valeur par défaut est false.

 **Remarks:** 

Si cette option est activée, les polices déclarées dans les règles @font-face sont chargées et intégrées dans les définitions de polices du document résultant (voir [DocumentBase.getFontInfos()](../../com.aspose.words/documentbase/\#getFontInfos)). Cela rend les polices chargées disponibles pour le rendu mais n'active pas automatiquement l'intégration des polices lors de l'enregistrement. Pour enregistrer le document avec les polices chargées, la propriété [FontInfoCollection.getEmbedTrueTypeFonts()](../../com.aspose.words/fontinfocollection/\#getEmbedTrueTypeFonts) / [FontInfoCollection.setEmbedTrueTypeFonts(boolean)](../../com.aspose.words/fontinfocollection/\#setEmbedTrueTypeFonts-boolean) de la collection [DocumentBase.getFontInfos()](../../com.aspose.words/documentbase/\#getFontInfos) doit être définie sur true.

Les formats de police pris en charge sont TTF, EOT et WOFF.

**Returns:**
booléen - Une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées.
...
Obtient une valeur indiquant s'il faut prendre en charge les images VML.
...
**Returns:**
booléen - Une valeur indiquant s'il faut prendre en charge les images VML.
...
Le nombre de millisecondes à attendre avant que la requête web n'expire. La valeur par défaut est 100000 millisecondes (100 secondes).

 **Remarks:** 

Le nombre de millisecondes que Aspose.Words attend pour une réponse lors du chargement de ressources externes (images, feuilles de style) liées dans les documents HTML et MHTML.
...
Définit une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. La valeur par défaut est [BlockImportMode.MERGE](../../com.aspose.words/blockimportmode/\#MERGE).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | int | Une valeur qui spécifie comment les propriétés des éléments de niveau bloc sont importées. La valeur doit être l'une des constantes [BlockImportMode](../../com.aspose.words/blockimportmode/). |
...
Définit une valeur indiquant s'il faut convertir les images SVG chargées au format EMF. La valeur par défaut est  false  et, si possible, les images SVG chargées sont conservées telles quelles sans conversion.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Une valeur indiquant s'il faut convertir les images SVG chargées au format EMF. |
...
Définit une valeur indiquant s'il faut ignorer les éléments HTML. La valeur par défaut est  false .
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Une valeur indiquant s'il faut ignorer les éléments HTML. |
...
Définit le type préféré des nœuds de document qui représenteront les éléments importés  et  . La valeur par défaut est [HtmlControlType.FORM\_FIELD](../../com.aspose.words/htmlcontroltype/\#FORM-FIELD). Remarques : Veuillez noter que la définition de cette propriété ne garantit pas que tous les contrôles importés seront du type spécifié. Si un contrôle HTML ne peut pas être représenté avec des nœuds de document du type préféré, Aspose.Words utilisera un [HtmlControlType](../../com.aspose.words/htmlcontroltype/) compatible pour ce contrôle. Exemples : montre comment définir le type préféré des nœuds de document qui représenteront les éléments importés  et  .   final String html = "\\r\\n\\r\\n\\r\\n" + "item1\\r\\n\\r\\n\\r\\n\\r\\n"; HtmlLoadOptions htmlLoadOptions = new HtmlLoadOptions(); htmlLoadOptions.setPreferredControlType(HtmlControlType.STRUCTURED\_DOCUMENT\_TAG); Document doc = new Document(new ByteArrayInputStream(html.getBytes(StandardCharsets.UTF\_8)), htmlLoadOptions); NodeCollection nodes = doc.getChildNodes(NodeType.STRUCTURED\_DOCUMENT\_TAG, true); StructuredDocumentTag tag = (StructuredDocumentTag) nodes.get(0);

**Parameters:**
| Paramètre | Type | Description |
| --- | --- | --- |
| value | int | Type préféré des nœuds de document qui représenteront les éléments importés  et  . La valeur doit être l'une des constantes [HtmlControlType](../../com.aspose.words/htmlcontroltype/). |
...
Définit une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées. La valeur par défaut est  false .
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Une valeur indiquant s'il faut prendre en charge les règles @font-face et charger les polices déclarées. |
...
Définit une valeur indiquant s'il faut prendre en charge les images VML.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Une valeur indiquant s'il faut prendre en charge les images VML. |
