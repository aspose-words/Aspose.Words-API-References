...
description: "Implémente le champ TC en Java."
type: docs
weight: 293
url: /fr/java/com.aspose.words/fieldtc/
---
...
Définit le texte et le numéro de page pour une entrée de table des matières (y compris une table des figures), qui est utilisée par un champ TOC.
...
| [getEntryLevel()](#getEntryLevel) | Obtient le niveau de l'entrée. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | Obtient si le numéro de page dans le TOC doit être omis pour ce champ. |
...
| [getTypeIdentifier()](#getTypeIdentifier) | Obtient un identifiant de type pour ce champ (qui est généralement une lettre). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Définit le niveau de l'entrée. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Définit si le numéro de page dans le TOC doit être omis pour ce champ. |
...
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Définit un identifiant de type pour ce champ (qui est généralement une lettre). |
...
**Returns:**
java.lang.String - Le niveau de l'entrée.
...
Obtient si le numéro de page dans le TOC doit être omis pour ce champ.
...
**Returns:**
boolean - Si le numéro de page dans le TOC doit être omis pour ce champ.
### getPageNumber() {#getPageNumber}
```
...
Obtient un identifiant de type pour ce champ (qui est généralement une lettre).
...
**Returns:**
java.lang.String - Un identifiant de type pour ce champ (qui est généralement une lettre).
### hasBookmark() {#hasBookmark}
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le niveau de l'entrée. |
...
Définit si le numéro de page dans le TOC doit être omis pour ce champ.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indiquer si le numéro de page dans la table des matières doit être omis pour ce champ. |
...
Définit un identifiant de type pour ce champ (qui est généralement une lettre).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un identifiant de type pour ce champ (qui est généralement une lettre). |
