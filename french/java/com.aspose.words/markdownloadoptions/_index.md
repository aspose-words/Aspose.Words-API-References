...
description: "Permet de spécifier des options supplémentaires lors du chargement d'un document LoadFormat.MARKDOWN dans un objet Document en Java."
type: docs
weight: 454
url: /fr/java/com.aspose.words/markdownloadoptions/
---
...
Permet de spécifier des options supplémentaires lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) dans un objet [Document](../../com.aspose.words/document/).
...
| --- | --- |
| [MarkdownLoadOptions()](#MarkdownLoadOptions) | Initialise une nouvelle instance de la classe [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/). |
## Méthodes
...
| [getImportUnderlineFormatting()](#getImportUnderlineFormatting) | Obtient une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. |
...
| [getPreserveEmptyLines()](#getPreserveEmptyLines) | Obtient une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [getSoftLineBreakCharacter()](#getSoftLineBreakCharacter) | Obtient une valeur de caractère représentant un saut de ligne souple. |
...
| [setImportUnderlineFormatting(boolean value)](#setImportUnderlineFormatting-boolean) | Définit une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. |
...
| [setPreserveEmptyLines(boolean value)](#setPreserveEmptyLines-boolean) | Définit une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [setSoftLineBreakCharacter(char value)](#setSoftLineBreakCharacter-char) | Définit une valeur de caractère représentant un saut de ligne souple. |
...
Initialise une nouvelle instance de la classe [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/).

 **Remarks:** 

Définit automatiquement [LoadFormat](../../com.aspose.words/loadformat/) sur [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
Obtient une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. La valeur par défaut est false.
...
**Returns:**
booléen - Une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné.
...
Obtient une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). La valeur par défaut est false.

Normalement, les lignes vides entre les éléments de niveau bloc en Markdown sont ignorées. Les lignes vides au début et à la fin du document sont également ignorées. Cette option permet d'importer ces lignes vides.
...
**Returns:**
booléen - Une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
Obtient une valeur de caractère représentant un saut de ligne souple. La valeur par défaut est ESPACE (U+0020).

 **Remarks:** 

Remarque, définir cette option sur [ControlChar.LINE\_BREAK\_CHAR](../../com.aspose.words/controlchar/\#LINE-BREAK-CHAR) vous permet de charger les sauts de ligne souples comme des sauts de ligne durs.

 **Examples:** 

Montre comment définir le caractère de saut de ligne souple.
...
**Returns:**
char - Une valeur de caractère représentant un saut de ligne souple.
...
Définit une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. La valeur par défaut est false.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. |
...
Définit une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). La valeur par défaut est false.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | boolean | Une valeur booléenne indiquant s'il faut préserver les lignes vides lors du chargement d'un document [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
Définit une valeur de caractère représentant un saut de ligne doux. La valeur par défaut est  SPACE (U+0020) .
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | char | Une valeur de caractère représentant un saut de ligne doux. |
