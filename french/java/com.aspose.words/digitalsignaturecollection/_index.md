...
description: "Fournit une collection en lecture seule de signatures numériques attachées à un document en Java."
type: docs
weight: 151
url: /fr/java/com.aspose.words/digitalsignaturecollection/
---
...
| Méthode | Description |
| --- | --- |
| [get(int index)](#get-int) | Obtient une signature de document à l'index spécifié. |
| [getCount()](#getCount) | Obtient le nombre d'éléments contenus dans la collection. |
| [isValid()](#isValid) | Renvoie  true  si toutes les signatures numériques de cette collection sont valides et que le document n'a pas été altéré. Renvoie également  true  s'il n'y a aucune signature numérique. |
...
| --- | --- | --- |
| index | int | Index basé sur zéro de la signature. |
...
Renvoie  true  si toutes les signatures numériques de cette collection sont valides et que le document n’a pas été altéré. Renvoie également  true  s’il n’y a aucune signature numérique. Renvoie  false  si au moins une signature numérique est invalide.
...
**Returns:**
boolean -  true  si toutes les signatures numériques de cette collection sont valides et que le document n’a pas été altéré. Renvoie également  true  s’il n’y a aucune signature numérique.
### iterator() {#iterator}
```
