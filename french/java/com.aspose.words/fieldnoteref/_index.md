...
description: "Implémente le champ NOTEREF en Java."
type: docs
weight: 265
url: /fr/java/com.aspose.words/fieldnoteref/
---
...
Insère la marque de la note de bas de page ou de fin qui est marquée par le signet spécifié.
...
Montre comment faire une référence croisée des notes de bas de page avec le champ NOTEREF.
...
| [getInsertHyperlink()](#getInsertHyperlink) | Obtient si l'on doit insérer un hyperlien vers le paragraphe signeté. |
| [getInsertReferenceMark()](#getInsertReferenceMark) | Insère la marque de référence avec le même formatage de caractères que le style Footnote Reference ou Endnote Reference. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Obtient si l'on doit insérer une position relative du paragraphe signeté. |
...
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Définit s'il faut insérer un hyperlien vers le paragraphe marqué. |
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Insère la marque de référence avec le même formatage de caractères que le style Footnote Reference ou Endnote Reference. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Définit s'il faut insérer une position relative du paragraphe marqué. |
...
Obtient si l'on doit insérer un hyperlien vers le paragraphe signeté.
...
**Returns:**
booléen - S'il faut insérer un hyperlien vers le paragraphe marqué.
### getInsertReferenceMark() {#getInsertReferenceMark}
```
public boolean getInsertReferenceMark()
```


Insère la marque de référence avec le même formatage de caractères que le style Footnote Reference ou Endnote Reference.
...
Obtient si l'on doit insérer une position relative du paragraphe signeté.
...
**Returns:**
booléen - S'il faut insérer une position relative du paragraphe marqué.
...
Définit s'il faut insérer un hyperlien vers le paragraphe marqué.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | S'il faut insérer un hyperlien vers le paragraphe marqué. |

### setInsertReferenceMark(boolean value) {#setInsertReferenceMark-boolean}
```
public void setInsertReferenceMark(boolean value)
```
...
Définit s'il faut insérer une position relative du paragraphe marqué.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | S'il faut insérer une position relative du paragraphe marqué. |
