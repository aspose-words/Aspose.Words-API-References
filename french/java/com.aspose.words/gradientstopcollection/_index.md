...
description: "Contient une collection d'objets GradientStop en Java."
type: docs
weight: 363
url: /fr/java/com.aspose.words/gradientstopcollection/
---
...
Contient une collection d'objets [GradientStop](../../com.aspose.words/gradientstop/).

Pour en savoir plus, consultez l'article de documentation [ Working with Graphic Elements ][Working with Graphic Elements].

 **Remarks:** 

Vous ne créez pas d'instances de cette classe directement. Utilisez la propriété [Fill.getGradientStops()](../../com.aspose.words/fill/\#getGradientStops) pour accéder aux points d'arrêt de dégradé des objets de remplissage.
...
| Méthode | Description |
| --- | --- |
| [add(GradientStop gradientStop)](#add-com.aspose.words.GradientStop) | Ajoute un [GradientStop](../../com.aspose.words/gradientstop/) spécifié à un dégradé. |
| [get(int index)](#get-int) | Obtient un objet [GradientStop](../../com.aspose.words/gradientstop/) dans la collection. |
| [getCount()](#getCount) | Obtient une valeur entière indiquant le nombre d'éléments dans la collection. |
| [insert(int index, GradientStop gradientStop)](#insert-int-com.aspose.words.GradientStop) | Insère un [GradientStop](../../com.aspose.words/gradientstop/) dans la collection à un indice spécifié. |
| [iterator()](#iterator) | Renvoie un énumérateur qui parcourt la collection. |
| [remove(GradientStop gradientStop)](#remove-com.aspose.words.GradientStop) | Supprime un [GradientStop](../../com.aspose.words/gradientstop/) spécifié de la collection. |
| [removeAt(int index)](#removeAt-int) | Supprime un [GradientStop](../../com.aspose.words/gradientstop/) de la collection à un indice spécifié. |
| [set(int index, GradientStop value)](#set-int-com.aspose.words.GradientStop) | Définit un objet [GradientStop](../../com.aspose.words/gradientstop/) dans la collection. |
...
Ajoute un [GradientStop](../../com.aspose.words/gradientstop/) spécifié à un dégradé.
...
Obtient un objet [GradientStop](../../com.aspose.words/gradientstop/) dans la collection.
...
**Returns:**
int - Une valeur entière indiquant le nombre d'éléments dans la collection.
...
Insère un [GradientStop](../../com.aspose.words/gradientstop/) dans la collection à un indice spécifié.
...
Supprime un [GradientStop](../../com.aspose.words/gradientstop/) spécifié de la collection.
...
**Returns:**
boolean -  true  si le point d'arrêt de dégradé a été supprimé avec succès, sinon  false .
...
Supprime un [GradientStop](../../com.aspose.words/gradientstop/) de la collection à un indice spécifié.
...
Définit un objet [GradientStop](../../com.aspose.words/gradientstop/) dans la collection.
...
| --- | --- | --- |
| index | int |  |
| value | [GradientStop](../../com.aspose.words/gradientstop/) | Un objet [GradientStop](../../com.aspose.words/gradientstop/) dans la collection. |
