...
description: "Spécifie le type d'une interruption à l'intérieur d'un document en Java."
type: docs
weight: 49
url: /fr/java/com.aspose.words/breaktype/
---
...
| Champ | Description |
| --- | --- |
| [COLUMN_BREAK](#COLUMN-BREAK) | Saut de colonne explicite. |
| [LINE_BREAK](#LINE-BREAK) | Saut de ligne explicite. |
| [PAGE_BREAK](#PAGE-BREAK) | Saut de page explicite. |
| [PARAGRAPH_BREAK](#PARAGRAPH-BREAK) | Saut entre les paragraphes. |
| [SECTION_BREAK_CONTINUOUS](#SECTION-BREAK-CONTINUOUS) | Spécifie le début d'une nouvelle section sur la même page que la section précédente. |
| [SECTION_BREAK_EVEN_PAGE](#SECTION-BREAK-EVEN-PAGE) | Spécifie le début d'une nouvelle section sur une nouvelle page paire. |
| [SECTION_BREAK_NEW_COLUMN](#SECTION-BREAK-NEW-COLUMN) | Spécifie le début d'une nouvelle section dans la nouvelle colonne. |
| [SECTION_BREAK_NEW_PAGE](#SECTION-BREAK-NEW-PAGE) | Spécifie le début d'une nouvelle section sur une nouvelle page. |
| [SECTION_BREAK_ODD_PAGE](#SECTION-BREAK-ODD-PAGE) | Spécifie le début d'une nouvelle section sur une page impaire. |
| [length](#length) |  |
## Méthodes
...
Spécifie le début d'une nouvelle section sur la même page que la section précédente.
...
Spécifie le début d'une nouvelle section sur une nouvelle page paire.
...
Spécifie le début d'une nouvelle section dans la nouvelle colonne.
...
Spécifie le début d'une nouvelle section sur une nouvelle page.
...
Spécifie le début d'une nouvelle section sur une page impaire.
