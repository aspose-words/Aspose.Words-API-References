...
description: "Style de jointure de ligne en Java."
type: docs
weight: 407
url: /fr/java/com.aspose.words/joinstyle/
---
...
| Champ | Description |
| --- | --- |
| [BEVEL](#BEVEL) | Joindre les arêtes par une ligne droite. |
| [MITER](#MITER) | Étendre les arêtes jusqu'à ce qu'elles se rejoignent. |
| [ROUND](#ROUND) | Dessiner un arc entre les deux arêtes. |
| [length](#length) |  |
## Méthodes
...
Joindre les arêtes par une ligne droite.
...
Étendre les arêtes jusqu'à ce qu'elles se rejoignent.
...
Dessiner un arc entre les deux arêtes.
