...
description: "Classe de base pour les visiteurs de documents personnalisés en Java."
type: docs
weight: 175
url: /fr/java/com.aspose.words/documentvisitor/
---
...
Avec [DocumentVisitor](../../com.aspose.words/documentvisitor/) vous pouvez définir et exécuter des opérations personnalisées qui nécessitent une énumération de l'arborescence du document.

Par exemple, Aspose.Words utilise [DocumentVisitor](../../com.aspose.words/documentvisitor/) en interne pour enregistrer [Document](../../com.aspose.words/document/) dans différents formats et pour d'autres opérations comme la recherche de champs ou de signets dans un fragment de document.

Pour utiliser [DocumentVisitor](../../com.aspose.words/documentvisitor/) :

1.  Créez une classe dérivée de [DocumentVisitor](../../com.aspose.words/documentvisitor/).
2.  Surchargez et fournissez des implémentations pour certaines ou toutes les méthodes VisitXXX afin d'effectuer des opérations personnalisées.
3.  Appelez [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/\#accept-com.aspose.words.DocumentVisitor) sur le [Node](../../com.aspose.words/node/) à partir duquel vous souhaitez démarrer l'énumération.
...
| Méthode | Description |
| --- | --- |
| [visitAbsolutePositionTab(AbsolutePositionTab tab)](#visitAbsolutePositionTab-com.aspose.words.AbsolutePositionTab) | Appelé lorsqu'un nœud [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) est rencontré dans le document. |
| [visitBodyEnd(Body body)](#visitBodyEnd-com.aspose.words.Body) | Appelé lorsque l'énumération de l'histoire principale du texte dans une section est terminée. |
| [visitBodyStart(Body body)](#visitBodyStart-com.aspose.words.Body) | Appelé lorsque l'énumération de l'histoire principale du texte dans une section a commencé. |
| [visitBookmarkEnd(BookmarkEnd bookmarkEnd)](#visitBookmarkEnd-com.aspose.words.BookmarkEnd) | Appelé lorsqu'une fin de signet est rencontrée dans le document. |
| [visitBookmarkStart(BookmarkStart bookmarkStart)](#visitBookmarkStart-com.aspose.words.BookmarkStart) | Appelé lorsqu'un début de signet est rencontré dans le document. |
| [visitBuildingBlockEnd(BuildingBlock block)](#visitBuildingBlockEnd-com.aspose.words.BuildingBlock) | Appelé lorsque l'énumération d'un bloc de construction est terminée. |
| [visitBuildingBlockStart(BuildingBlock block)](#visitBuildingBlockStart-com.aspose.words.BuildingBlock) | Appelé lorsque l'énumération d'un bloc de construction a commencé. |
| [visitCellEnd(Cell cell)](#visitCellEnd-com.aspose.words.Cell) | Appelé lorsque l'énumération d'une cellule de tableau est terminée. |
| [visitCellStart(Cell cell)](#visitCellStart-com.aspose.words.Cell) | Appelé lorsque l'énumération d'une cellule de tableau a commencé. |
| [visitCommentEnd(Comment comment)](#visitCommentEnd-com.aspose.words.Comment) | Appelé lorsque l'énumération d'un texte de commentaire est terminée. |
| [visitCommentRangeEnd(CommentRangeEnd commentRangeEnd)](#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd) | Appelé lorsqu'une fin d'une plage de texte commentée est rencontrée. |
| [visitCommentRangeStart(CommentRangeStart commentRangeStart)](#visitCommentRangeStart-com.aspose.words.CommentRangeStart) | Appelé lorsqu'un début d'une plage de texte commentée est rencontré. |
| [visitCommentStart(Comment comment)](#visitCommentStart-com.aspose.words.Comment) | Appelé lorsque l'énumération d'un texte de commentaire a commencé. |
| [visitDocumentEnd(Document doc)](#visitDocumentEnd-com.aspose.words.Document) | Appelé lorsque l'énumération du document est terminée. |
| [visitDocumentStart(Document doc)](#visitDocumentStart-com.aspose.words.Document) | Appelé lorsque l'énumération du document a commencé. |
| [visitEditableRangeEnd(EditableRangeEnd editableRangeEnd)](#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd) | Appelé lorsqu'une fin de plage modifiable est rencontrée dans le document. |
| [visitEditableRangeStart(EditableRangeStart editableRangeStart)](#visitEditableRangeStart-com.aspose.words.EditableRangeStart) | Appelé lorsqu'un début de plage modifiable est rencontré dans le document. |
| [visitFieldEnd(FieldEnd fieldEnd)](#visitFieldEnd-com.aspose.words.FieldEnd) | Appelé lorsqu'un champ se termine dans le document. |
| [visitFieldSeparator(FieldSeparator fieldSeparator)](#visitFieldSeparator-com.aspose.words.FieldSeparator) | Appelé lorsqu'un séparateur de champ est rencontré dans le document. |
| [visitFieldStart(FieldStart fieldStart)](#visitFieldStart-com.aspose.words.FieldStart) | Appelé lorsqu'un champ démarre dans le document. |
| [visitFootnoteEnd(Footnote footnote)](#visitFootnoteEnd-com.aspose.words.Footnote) | Appelé lorsque l'énumération du texte d'une note de bas de page ou de fin a pris fin. |
| [visitFootnoteStart(Footnote footnote)](#visitFootnoteStart-com.aspose.words.Footnote) | Appelé lorsque l'énumération du texte d'une note de bas de page ou de fin a commencé. |
| [visitFormField(FormField formField)](#visitFormField-com.aspose.words.FormField) | Appelé lorsqu'un champ de formulaire est rencontré dans le document. |
| [visitGlossaryDocumentEnd(GlossaryDocument glossary)](#visitGlossaryDocumentEnd-com.aspose.words.GlossaryDocument) | Appelé lorsque l'énumération d'un document de glossaire a pris fin. |
| [visitGlossaryDocumentStart(GlossaryDocument glossary)](#visitGlossaryDocumentStart-com.aspose.words.GlossaryDocument) | Appelé lorsque l'énumération d'un document de glossaire a commencé. |
| [visitGroupShapeEnd(GroupShape groupShape)](#visitGroupShapeEnd-com.aspose.words.GroupShape) | Appelé lorsque l'énumération d'une forme groupée a pris fin. |
| [visitGroupShapeStart(GroupShape groupShape)](#visitGroupShapeStart-com.aspose.words.GroupShape) | Appelé lorsque l'énumération d'une forme groupée a commencé. |
| [visitHeaderFooterEnd(HeaderFooter headerFooter)](#visitHeaderFooterEnd-com.aspose.words.HeaderFooter) | Appelé lorsque l'énumération d'un en-tête ou pied de page dans une section a pris fin. |
| [visitHeaderFooterStart(HeaderFooter headerFooter)](#visitHeaderFooterStart-com.aspose.words.HeaderFooter) | Appelé lorsque l'énumération d'un en-tête ou pied de page dans une section a commencé. |
| [visitOfficeMathEnd(OfficeMath officeMath)](#visitOfficeMathEnd-com.aspose.words.OfficeMath) | Appelé lorsque l'énumération d'un objet Office Math a pris fin. |
| [visitOfficeMathStart(OfficeMath officeMath)](#visitOfficeMathStart-com.aspose.words.OfficeMath) | Appelé lorsque l'énumération d'un objet Office Math a commencé. |
| [visitParagraphEnd(Paragraph paragraph)](#visitParagraphEnd-com.aspose.words.Paragraph) | Appelé lorsque l'énumération d'un paragraphe a pris fin. |
| [visitParagraphStart(Paragraph paragraph)](#visitParagraphStart-com.aspose.words.Paragraph) | Appelé lorsque l'énumération d'un paragraphe a commencé. |
| [visitRowEnd(Row row)](#visitRowEnd-com.aspose.words.Row) | Appelé lorsque l'énumération d'une ligne de tableau a pris fin. |
| [visitRowStart(Row row)](#visitRowStart-com.aspose.words.Row) | Appelé lorsque l'énumération d'une ligne de tableau a commencé. |
| [visitRun(Run run)](#visitRun-com.aspose.words.Run) | Appelé lorsqu'un fragment de texte dans le est rencontré. |
| [visitSectionEnd(Section section)](#visitSectionEnd-com.aspose.words.Section) | Appelé lorsque l'énumération d'une section a pris fin. |
| [visitSectionStart(Section section)](#visitSectionStart-com.aspose.words.Section) | Appelé lorsque l'énumération d'une section a commencé. |
| [visitShapeEnd(Shape shape)](#visitShapeEnd-com.aspose.words.Shape) | Appelé lorsque l'énumération d'une forme a pris fin. |
| [visitShapeStart(Shape shape)](#visitShapeStart-com.aspose.words.Shape) | Appelé lorsque l'énumération d'une forme a commencé. |
| [visitSmartTagEnd(SmartTag smartTag)](#visitSmartTagEnd-com.aspose.words.SmartTag) | Appelé lorsque l'énumération d'une balise intelligente est terminée. |
| [visitSmartTagStart(SmartTag smartTag)](#visitSmartTagStart-com.aspose.words.SmartTag) | Appelé lorsque l'énumération d'une balise intelligente a commencé. |
| [visitSpecialChar(SpecialChar specialChar)](#visitSpecialChar-com.aspose.words.SpecialChar) | Appelé lorsqu'un nœud [SpecialChar](../../com.aspose.words/specialchar/) est rencontré dans le document. |
| [visitStructuredDocumentTagEnd(StructuredDocumentTag sdt)](#visitStructuredDocumentTagEnd-com.aspose.words.StructuredDocumentTag) | Appelé lorsque l'énumération d'une balise de document structuré est terminée. |
| [visitStructuredDocumentTagRangeEnd(StructuredDocumentTagRangeEnd sdtRangeEnd)](#visitStructuredDocumentTagRangeEnd-com.aspose.words.StructuredDocumentTagRangeEnd) | Appelé lorsqu'un StructuredDocumentTagRangeEnd est rencontré. |
| [visitStructuredDocumentTagRangeStart(StructuredDocumentTagRangeStart sdtRangeStart)](#visitStructuredDocumentTagRangeStart-com.aspose.words.StructuredDocumentTagRangeStart) | Appelé lorsqu'un StructuredDocumentTagRangeStart est rencontré. |
| [visitStructuredDocumentTagStart(StructuredDocumentTag sdt)](#visitStructuredDocumentTagStart-com.aspose.words.StructuredDocumentTag) | Appelé lorsque l'énumération d'une balise de document structuré a commencé. |
| [visitSubDocument(SubDocument subDocument)](#visitSubDocument-com.aspose.words.SubDocument) | Appelé lorsqu'un sous-document est rencontré. |
| [visitTableEnd(Table table)](#visitTableEnd-com.aspose.words.Table) | Appelé lorsque l'énumération d'un tableau est terminée. |
| [visitTableStart(Table table)](#visitTableStart-com.aspose.words.Table) | Appelé lorsque l'énumération d'un tableau a commencé. |
...
Appelé lorsqu'un nœud [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) est rencontré dans le document.

 **Examples:** 

Montre comment traiter les caractères de tabulation à position absolue avec un visiteur de document.
...
| --- | --- | --- |
| tab | [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) | L'objet qui est visité. |

**Returns:**
int - Une valeur [VisitorAction](../../com.aspose.words/visitoraction/) qui spécifie comment poursuivre l'énumération. La valeur retournée est l'une des constantes [VisitorAction](../../com.aspose.words/visitoraction/).
...
Appelé lorsque l'énumération de l'histoire principale du texte dans une section est terminée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| body | [Body](../../com.aspose.words/body/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération de l'histoire principale du texte dans une section a commencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| bookmarkEnd | [BookmarkEnd](../../com.aspose.words/bookmarkend/) | L'objet qui est visité. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| bookmarkStart | [BookmarkStart](../../com.aspose.words/bookmarkstart/) | L'objet qui est visité. |
...
Remarque : Un nœud de bloc de construction et ses enfants ne sont pas visités lorsque vous exécutez un Visitor sur un [Document](../../com.aspose.words/document/). Si vous souhaitez exécuter un Visitor sur un bloc de construction, vous devez exécuter le visiteur sur un [GlossaryDocument](../../com.aspose.words/glossarydocument/) ou appeler [BuildingBlock.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/buildingblock/\#accept-com.aspose.words.DocumentVisitor).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| block | [BuildingBlock](../../com.aspose.words/buildingblock/) | L'objet qui est visité. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| cell | [Cell](../../com.aspose.words/cell/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une cellule de tableau a commencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| comment | [Comment](../../com.aspose.words/comment/) | L'objet qui est visité. |
...
Appelé lorsqu'une fin d'une plage de texte commentée est rencontrée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| commentRangeEnd | [CommentRangeEnd](../../com.aspose.words/commentrangeend/) | L'objet qui est visité. |
...
Appelé lorsqu'un début d'une plage de texte commentée est rencontré.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| commentRangeStart | [CommentRangeStart](../../com.aspose.words/commentrangestart/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération du document est terminée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération du document a commencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| editableRangeEnd | [EditableRangeEnd](../../com.aspose.words/editablerangeend/) | L'objet qui est visité. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| editableRangeStart | [EditableRangeStart](../../com.aspose.words/editablerangestart/) | L'objet qui est visité. |
...
Pour plus d'informations, voir [visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart)

 **Examples:** 

Montre comment imprimer la structure des nœuds de chaque champ dans un document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| fieldEnd | [FieldEnd](../../com.aspose.words/fieldend/) | L'objet qui est visité. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| fieldSeparator | [FieldSeparator](../../com.aspose.words/fieldseparator/) | L'objet qui est visité. |
...
Appelé lorsqu'un champ démarre dans le document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| fieldStart | [FieldStart](../../com.aspose.words/fieldstart/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération du texte d'une note de bas de page ou de fin a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| footnote | [Footnote](../../com.aspose.words/footnote/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération du texte d'une note de bas de page ou de fin a commencé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| formField | [FormField](../../com.aspose.words/formfield/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'un document de glossaire a pris fin.

 **Remarks:** 

Remarque : Un nœud de document de glossaire et ses enfants ne sont pas parcourus lorsque vous exécutez un Visitor sur un [Document](../../com.aspose.words/document/). Si vous souhaitez exécuter un Visitor sur un document de glossaire, vous devez appeler [GlossaryDocument.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/glossarydocument/\\#accept-com.aspose.words.DocumentVisitor).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| glossary | [GlossaryDocument](../../com.aspose.words/glossarydocument/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une forme groupée a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| groupShape | [GroupShape](../../com.aspose.words/groupshape/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une forme groupée a commencé.
...
Appelé lorsque l'énumération d'un en-tête ou pied de page dans une section a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| headerFooter | [HeaderFooter](../../com.aspose.words/headerfooter/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'un en-tête ou pied de page dans une section a commencé.
...
Appelé lorsque l'énumération d'un objet Office Math a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| officeMath | [OfficeMath](../../com.aspose.words/officemath/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'un paragraphe a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| paragraph | [Paragraph](../../com.aspose.words/paragraph/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une ligne de tableau a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| row | [Row](../../com.aspose.words/row/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une ligne de tableau a commencé.
...
Appelé lorsqu'un fragment de texte dans le est rencontré.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| run | [Run](../../com.aspose.words/run/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une section a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| section | [Section](../../com.aspose.words/section/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'une forme a pris fin.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| shape | [Shape](../../com.aspose.words/shape/) | L'objet qui est visité. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| smartTag | [SmartTag](../../com.aspose.words/smarttag/) | L'objet qui est visité. |
...
Appelé lorsqu'un nœud [SpecialChar](../../com.aspose.words/specialchar/) est rencontré dans le document.

 **Remarks:** 

Cette méthode ne doit pas être appelée pour les caractères de contrôle génériques (voir [ControlChar](../../com.aspose.words/controlchar/)) qui peuvent être présents dans le document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| specialChar | [SpecialChar](../../com.aspose.words/specialchar/) | L'objet qui est visité. |
...
Montre comment imprimer la structure des nœuds de chaque balise de document structuré dans un document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| sdt | [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) | L'objet qui est visité. |
...
Appelé lorsqu'un StructuredDocumentTagRangeEnd est rencontré.
...
Appelé lorsqu'un StructuredDocumentTagRangeStart est rencontré.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| subDocument | [SubDocument](../../com.aspose.words/subdocument/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'un tableau est terminée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| table | [Table](../../com.aspose.words/table/) | L'objet qui est visité. |
...
Appelé lorsque l'énumération d'un tableau a commencé.
