...
description: "Implémente le champ MERGEFIELD en Java."
type: docs
weight: 258
url: /fr/java/com.aspose.words/fieldmergefield/
---
...
| [getFieldName()](#getFieldName) | Obtient le nom d'un champ de données. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | Renvoie uniquement le nom du champ de données. |
...
| [getTextAfter()](#getTextAfter) | Obtient le texte à insérer après le champ si le champ n'est pas vide. |
| [getTextBefore()](#getTextBefore) | Obtient le texte à insérer avant le champ si le champ n'est pas vide. |
...
| [isMapped()](#isMapped) | Obtient si ce champ est un champ mappé. |
| [isMapped(boolean value)](#isMapped-boolean) | Définit si ce champ est un champ mappé. |
| [isVerticalFormatting()](#isVerticalFormatting) | Obtient s'il faut activer la conversion de caractères pour le formatage vertical. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | Définit s'il faut activer la conversion de caractères pour le formatage vertical. |
| [remove()](#remove) | Supprime le champ du document. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | Définit le nom d'un champ de données. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | Définit le texte à insérer après le champ si le champ n'est pas vide. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | Définit le texte à insérer avant le champ si le champ n'est pas vide. |
...
Obtient le nom d'un champ de données.
...
**Returns:**
java.lang.String - Le nom d'un champ de données.
...
Renvoie uniquement le nom du champ de données. Tout préfixe est supprimé dans la propriété prefix.
...
**Returns:**
java.lang.String - Seulement le nom du champ de données.
### getFormat() {#getFormat}
```
...
Obtient le texte à insérer après le champ si le champ n'est pas vide.
...
**Returns:**
java.lang.String - Le texte à insérer après le champ si le champ n'est pas vide.
...
Obtient le texte à insérer avant le champ si le champ n'est pas vide.
...
**Returns:**
java.lang.String - Le texte à insérer avant le champ si le champ n'est pas vide.
### getType() {#getType}
```
public int getType()
```
...
Obtient si ce champ est un champ mappé.
...
**Returns:**
boolean - Indique si ce champ est un champ mappé.
...
Définit si ce champ est un champ mappé.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si ce champ est un champ mappé. |
...
Obtient s'il faut activer la conversion de caractères pour le formatage vertical.
...
**Returns:**
boolean - Indique s'il faut activer la conversion de caractères pour le formatage vertical.
...
Définit s'il faut activer la conversion de caractères pour le formatage vertical.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut activer la conversion de caractères pour le formatage vertical. |
...
Définit le nom d'un champ de données.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom d'un champ de données. |
...
Définit le texte à insérer après le champ si le champ n'est pas vide.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte à insérer après le champ si le champ n'est pas vide. |
...
Définit le texte à insérer avant le champ si le champ n'est pas vide.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte à insérer avant le champ si le champ n'est pas vide. |
