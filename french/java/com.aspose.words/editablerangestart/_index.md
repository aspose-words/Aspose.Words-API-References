...
description: "Représente le début d'une plage modifiable dans un document Word en Java."
type: docs
weight: 181
url: /fr/java/com.aspose.words/editablerangestart/
---
...
Une plage modifiable complète dans un document Word se compose d'un [EditableRangeStart](../../com.aspose.words/editablerangestart/) et d'un [EditableRangeEnd](../../com.aspose.words/editablerangeend/) correspondants avec le même Id.
...
Utilisez la classe [getEditableRange()](../../com.aspose.words/editablerangestart/\\#getEditableRange) comme une "façade" pour travailler avec une plage modifiable en tant qu'objet unique.
...
| [getEditableRange()](#getEditableRange) | Obtient l'objet façade qui encapsule ce début et cette fin de plage modifiable. |
...
| [getNodeType()](#getNodeType) | Renvoie [NodeType.EDITABLE\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#EDITABLE-RANGE-START). |
...
Appelle [DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor/\\#visitEditableRangeStart-com.aspose.words.EditableRangeStart).
...
Obtient l'objet façade qui encapsule ce début et cette fin de plage modifiable.
...
Renvoie [NodeType.EDITABLE\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#EDITABLE-RANGE-START).
...
**Returns:**
int - [NodeType.EDITABLE\\_RANGE\\_START](../../com.aspose.words/nodetype/\\#EDITABLE-RANGE-START). La valeur renvoyée est l'une des constantes [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
