...
description: "Implémente le champ TOA en Java."
type: docs
weight: 297
url: /fr/java/com.aspose.words/fieldtoa/
---
...
Construit une table des autorités (c’est‑à‑dire une liste des références dans un document juridique, telles que les références à des affaires, des lois et des règles, ainsi que les numéros de pages où apparaissent ces références) en utilisant les entrées spécifiées par les champs TA.

 **Examples:** 

Montre comment créer et personnaliser une table des autorités en utilisant les champs TOA et TA.
...
| [getEntryCategory()](#getEntryCategory) | Obtient la catégorie intégrale des entrées incluses dans le tableau. |
| [getEntrySeparator()](#getEntrySeparator) | Obtient la séquence de caractères utilisée pour séparer une entrée de table des autorités et son numéro de page. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Obtient si l’on doit supprimer le formatage du texte de l’entrée dans le document de l’entrée de la table des autorités. |
...
| [getUseHeading()](#getUseHeading) | Obtient si l’on doit inclure l’en-tête de catégorie pour les entrées d’une table des autorités. |
| [getUsePassim()](#getUsePassim) | Obtient si l’on doit remplacer cinq références de page différentes ou plus vers la même autorité par "passim", qui est utilisé pour indiquer qu’un mot ou un passage apparaît fréquemment dans l’œuvre citée. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Définit la catégorie intégrale des entrées incluses dans le tableau. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Définit la séquence de caractères utilisée pour séparer une entrée de table des autorités et son numéro de page. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Définit si l’on doit supprimer le formatage du texte de l’entrée dans le document de l’entrée de la table des autorités. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Définit si l’on doit inclure l’en-tête de catégorie pour les entrées d’une table des autorités. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Définit si l’on doit remplacer cinq références de page différentes ou plus vers la même autorité par "passim", qui est utilisé pour indiquer qu’un mot ou un passage apparaît fréquemment dans l’œuvre citée. |
...
Obtient la catégorie intégrale des entrées incluses dans le tableau.
...
**Returns:**
java.lang.String - La catégorie intégrale des entrées incluses dans le tableau.
...
Obtient la séquence de caractères utilisée pour séparer une entrée de table des autorités et son numéro de page.
...
**Returns:**
java.lang.String - La séquence de caractères utilisée pour séparer une entrée de table des autorités et son numéro de page.
...
Obtient si l’on doit supprimer le formatage du texte de l’entrée dans le document de l’entrée de la table des autorités.
...
**Returns:**
boolean - Indique s'il faut supprimer le formatage du texte de l'entrée dans le document de l'entrée dans la table des autorités.
### getResult() {#getResult}
```
...
Obtient si l’on doit inclure l’en-tête de catégorie pour les entrées d’une table des autorités.
...
**Returns:**
boolean - Indique s'il faut inclure l'en-tête de catégorie pour les entrées dans une table des autorités.
...
Obtient si l’on doit remplacer cinq références de page différentes ou plus vers la même autorité par "passim", qui est utilisé pour indiquer qu’un mot ou un passage apparaît fréquemment dans l’œuvre citée.
...
**Returns:**
boolean - Indique s'il faut remplacer cinq références de page différentes ou plus vers la même autorité par \"passim\", qui est utilisé pour indiquer qu'un mot ou un passage apparaît fréquemment dans l'ouvrage cité.
### isDirty() {#isDirty}
```
...
Définit la catégorie intégrale des entrées incluses dans le tableau.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La catégorie intégrale pour les entrées incluses dans la table. |
...
Définit la séquence de caractères utilisée pour séparer une entrée de table des autorités et son numéro de page.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | La séquence de caractères utilisée pour séparer une entrée de la table des autorités et son numéro de page. |
...
Définit si l’on doit supprimer le formatage du texte de l’entrée dans le document de l’entrée de la table des autorités.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut supprimer le formatage du texte de l'entrée dans le document de l'entrée dans la table des autorités. |
...
Définit si l’on doit inclure l’en-tête de catégorie pour les entrées d’une table des autorités.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut inclure l'en-tête de catégorie pour les entrées dans une table des autorités. |
...
Définit si l’on doit remplacer cinq références de page différentes ou plus vers la même autorité par "passim", qui est utilisé pour indiquer qu’un mot ou un passage apparaît fréquemment dans l’œuvre citée.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique s'il faut remplacer cinq références de page différentes ou plus vers la même autorité par \"passim\", qui est utilisé pour indiquer qu'un mot ou un passage apparaît fréquemment dans l'ouvrage cité. |
