...
description: "Implémente le champ DATABASE en Java."
type: docs
weight: 217
url: /fr/java/com.aspose.words/fielddatabase/
---
...
Insère les résultats d'une requête de base de données dans un tableau WordprocessingML.
...
| Méthode | Description |
| --- | --- |
| [getConnection()](#getConnection) | Obtient une connexion aux données. |
...
| [getFileName()](#getFileName) | Obtient le chemin complet et le nom de fichier de la base de données |
| [getFirstRecord()](#getFirstRecord) | Obtient le numéro d'enregistrement entier du premier enregistrement de données à insérer. |
...
| [getFormatAttributes()](#getFormatAttributes) | Obtient quels attributs du format doivent être appliqués au tableau. |
| [getInsertHeadings()](#getInsertHeadings) | Obtient s'il faut insérer les noms de champs de la base de données comme en-têtes de colonnes dans le tableau résultant. |
| [getInsertOnceOnMailMerge()](#getInsertOnceOnMailMerge) | Obtient s'il faut insérer les données au début d'une fusion. |
| [getLastRecord()](#getLastRecord) | Obtient le numéro d'enregistrement entier du dernier enregistrement de données à insérer. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getQuery()](#getQuery) | Obtient un ensemble d'instructions SQL qui interrogent la base de données. |
...
| [getTableFormat()](#getTableFormat) | Obtient le format qui doit être appliqué au résultat de la requête de la base de données. |
...
| [setConnection(String value)](#setConnection-java.lang.String) | Définit une connexion aux données. |
| [setFileName(String value)](#setFileName-java.lang.String) | Définit le chemin complet et le nom de fichier de la base de données |
| [setFirstRecord(String value)](#setFirstRecord-java.lang.String) | Définit le numéro d'enregistrement entier du premier enregistrement de données à insérer. |
| [setFormatAttributes(String value)](#setFormatAttributes-java.lang.String) | Définit quels attributs du format doivent être appliqués à la table. |
| [setInsertHeadings(boolean value)](#setInsertHeadings-boolean) | Définit s'il faut insérer les noms de champs de la base de données comme en-têtes de colonne dans la table résultante. |
| [setInsertOnceOnMailMerge(boolean value)](#setInsertOnceOnMailMerge-boolean) | Définit s'il faut insérer les données au début d'une fusion. |
| [setLastRecord(String value)](#setLastRecord-java.lang.String) | Définit le numéro d'enregistrement entier du dernier enregistrement de données à insérer. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setQuery(String value)](#setQuery-java.lang.String) | Définit un ensemble d'instructions SQL qui interrogent la base de données. |
...
| [setTableFormat(String value)](#setTableFormat-java.lang.String) | Définit le format qui doit être appliqué au résultat de la requête de la base de données. |
...
Obtient une connexion aux données.
...
**Returns:**
java.lang.String - Une connexion aux données.
...
Obtient le chemin complet et le nom de fichier de la base de données
...
**Returns:**
java.lang.String - Le chemin complet et le nom de fichier de la base de données
...
Obtient le numéro d'enregistrement entier du premier enregistrement de données à insérer.
...
**Returns:**
java.lang.String - Le numéro d'enregistrement entier du premier enregistrement de données à insérer.
### getFormat() {#getFormat}
```
...
Obtient quels attributs du format doivent être appliqués au tableau.
...
**Returns:**
java.lang.String - Quels attributs du format doivent être appliqués à la table.
...
Obtient s'il faut insérer les noms de champs de la base de données comme en-têtes de colonnes dans le tableau résultant.
...
**Returns:**
boolean - S'il faut insérer les noms de champs de la base de données comme en-têtes de colonne dans la table résultante.
...
Obtient s'il faut insérer les données au début d'une fusion.
...
**Returns:**
boolean - S'il faut insérer les données au début d'une fusion.
...
Obtient le numéro d'enregistrement entier du dernier enregistrement de données à insérer.
...
**Returns:**
java.lang.String - Le numéro d'enregistrement entier du dernier enregistrement de données à insérer.
...
Obtient un ensemble d'instructions SQL qui interrogent la base de données.
...
**Returns:**
java.lang.String - Un ensemble d'instructions SQL qui interrogent la base de données.
### getResult() {#getResult}
```
...
Obtient le format qui doit être appliqué au résultat de la requête de la base de données.
...
**Returns:**
java.lang.String - Le format qui doit être appliqué au résultat de la requête de la base de données.
### getType() {#getType}
```
public int getType()
```
...
Définit une connexion aux données.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une connexion aux données. |
...
Définit le chemin complet et le nom de fichier de la base de données
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le chemin complet et le nom de fichier de la base de données |
...
Définit le numéro d'enregistrement entier du premier enregistrement de données à insérer.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le numéro d'enregistrement entier du premier enregistrement de données à insérer. |
...
Définit quels attributs du format doivent être appliqués à la table.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Quels attributs du format doivent être appliqués à la table. |
...
Définit s'il faut insérer les noms de champs de la base de données comme en-têtes de colonne dans la table résultante.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | S'il faut insérer les noms de champs de la base de données comme en-têtes de colonne dans la table résultante. |
...
Définit s'il faut insérer les données au début d'une fusion.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | S'il faut insérer les données au début d'une fusion. |
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le numéro d'enregistrement entier du dernier enregistrement de données à insérer. |
...
Définit un ensemble d'instructions SQL qui interrogent la base de données.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un ensemble d'instructions SQL qui interrogent la base de données. |
...
Définit le format qui doit être appliqué au résultat de la requête de la base de données.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le format qui doit être appliqué au résultat de la requête de la base de données. |
