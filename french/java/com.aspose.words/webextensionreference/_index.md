...
description: "Représente la référence à une extension web en Java."
type: docs
weight: 732
url: /fr/java/com.aspose.words/webextensionreference/
---
...
| Méthode | Description |
| --- | --- |
| [getId()](#getId) | Identifiant associé à l'extension web au sein d'un fournisseur de catalogue. |
| [getStore()](#getStore) | Spécifie l'instance du marché où l'extension web est stockée. |
| [getStoreType()](#getStoreType) | Spécifie le type de marché. |
| [getVersion()](#getVersion) | Spécifie la version de l'extension web. |
| [setId(String value)](#setId-java.lang.String) | Identifiant associé à l'extension web au sein d'un fournisseur de catalogue. |
| [setStore(String value)](#setStore-java.lang.String) | Spécifie l'instance du marché où l'extension web est stockée. |
| [setStoreType(int value)](#setStoreType-int) | Spécifie le type de marché. |
| [setVersion(String value)](#setVersion-java.lang.String) | Spécifie la version de l'extension web. |
### getId() {#getId}
```
public String getId()
```
...
**Returns:**
int - La valeur  int  correspondante. La valeur retournée est l'une des constantes [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | int | La valeur  int  correspondante. La valeur doit être l'une des constantes [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/). |
