...
description: "Représente toute la mise en forme d'une ligne de tableau en Java."
type: docs
weight: 590
url: /fr/java/com.aspose.words/rowformat/
---
...
| Méthode | Description |
| --- | --- |
| [clearFormatting()](#clearFormatting) | Réinitialise le formatage de ligne par défaut. |
| [fetchInheritedBorderAttr(int key)](#fetchInheritedBorderAttr-int) |  |
| [getAllowBreakAcrossPages()](#getAllowBreakAcrossPages) | Vrai si le texte d’une ligne de tableau est autorisé à se diviser lors d’un saut de page. |
| [getBorders()](#getBorders) | Obtient la collection des bordures de cellule par défaut pour la ligne. |
| [getDirectBorderAttr(int key)](#getDirectBorderAttr-int) |  |
| [getHeadingFormat()](#getHeadingFormat) | Vrai si la ligne est répétée comme en-tête de tableau sur chaque page lorsque le tableau s’étend sur plusieurs pages. |
| [getHeight()](#getHeight) | Obtient la hauteur de la ligne de tableau en points. |
| [getHeightRule()](#getHeightRule) | Obtient la règle de détermination de la hauteur de la ligne de tableau. |
| [setAllowBreakAcrossPages(boolean value)](#setAllowBreakAcrossPages-boolean) | Vrai si le texte d’une ligne de tableau est autorisé à se diviser lors d’un saut de page. |
| [setBorderAttr(int key, Object value)](#setBorderAttr-int-java.lang.Object) |  |
| [setHeadingFormat(boolean value)](#setHeadingFormat-boolean) | Vrai si la ligne est répétée comme en-tête de tableau sur chaque page lorsque le tableau s’étend sur plusieurs pages. |
| [setHeight(double value)](#setHeight-double) | Définit la hauteur de la ligne de tableau en points. |
| [setHeightRule(int value)](#setHeightRule-int) | Définit la règle de détermination de la hauteur de la ligne de tableau. |
...
Réinitialise le formatage de ligne par défaut.
...
Vrai si le texte d’une ligne de tableau est autorisé à se diviser lors d’un saut de page.
...
Obtient la collection des bordures de cellule par défaut pour la ligne.
...
Obtient la hauteur de la ligne de tableau en points.
...
**Returns:**
double - La hauteur de la ligne de tableau en points.
...
Obtient la règle de détermination de la hauteur de la ligne de tableau.
...
**Returns:**
int - La règle de détermination de la hauteur de la ligne de tableau. La valeur retournée est l’une des constantes [HeightRule](../../com.aspose.words/heightrule/).
...
Définit la hauteur de la ligne de tableau en points.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | double | La hauteur de la ligne de tableau en points. |
...
Définit la règle de détermination de la hauteur de la ligne de tableau.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | int | La règle de détermination de la hauteur de la ligne de tableau. La valeur doit être l’une des constantes [HeightRule](../../com.aspose.words/heightrule/). |
