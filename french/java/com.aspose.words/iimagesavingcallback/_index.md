...
description: "Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les images lors de l'enregistrement d'un document au format HTML en Java."
type: docs
weight: 773
url: /fr/java/com.aspose.words/iimagesavingcallback/
---
```
public interface IImageSavingCallback
```

Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les images lors de l'enregistrement d'un document au format HTML. Peut être utilisé par d'autres formats.
...
| Méthode | Description |
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | Appelé lorsque Aspose.Words enregistre une image en HTML. |
...
Appelé lorsque Aspose.Words enregistre une image en HTML.
