...
description: "Implémente le champ ADDRESSBLOCK en Java."
type: docs
weight: 196
url: /fr/java/com.aspose.words/fieldaddressblock/
---
...
Représente un bloc d'adresse. Un *bloc d'adresse* est un bloc de texte spécifiant les informations appropriées pour une adresse postale, dans l'ordre requis par le pays de destination.

 **Examples:** 

Montre comment obtenir les noms des champs de fusion utilisés par le champ.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Obtient le nom du pays/région exclu. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Obtient si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Obtient si le nom du pays/la région doit être inclus. |
| [getLanguageId()](#getLanguageId) | Obtient l'ID de langue utilisé pour formater l'adresse. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Obtient le format du nom et de l'adresse. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Définit le nom du pays/région exclu. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Définit si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006). |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Définit si le nom du pays/la région doit être inclus. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Définit l'ID de langue utilisé pour formater l'adresse. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Définit le format du nom et de l'adresse. |
...
Obtient le nom du pays/région exclu.
...
**Returns:**
java.lang.String - Le nom du pays/région exclu.
...
Obtient si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006).
...
**Returns:**
boolean - Si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006).
...
Obtient si le nom du pays/la région doit être inclus.
...
**Returns:**
java.lang.String - Si le nom du pays/la région doit être inclus.
...
Obtient l'ID de langue utilisé pour formater l'adresse.
...
**Returns:**
java.lang.String - L'ID de langue utilisé pour formater l'adresse.
...
Obtient le format du nom et de l'adresse.
...
**Returns:**
java.lang.String - Le format du nom et de l'adresse.
### getResult() {#getResult}
```
...
Définit le nom du pays/région exclu.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du pays/région exclu. |
...
Définit si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006).
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Si l'adresse doit être formatée selon le pays/la région du destinataire tel que défini par POST\*CODE (Universal Postal Union 2006). |
...
Définit si le nom du pays/la région doit être inclus.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Si le nom du pays/la région doit être inclus. |
...
Définit l'ID de langue utilisé pour formater l'adresse.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'ID de langue utilisé pour formater l'adresse. |
...
Définit le format du nom et de l'adresse.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le format du nom et de l'adresse. |
