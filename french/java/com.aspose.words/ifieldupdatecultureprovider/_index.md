...
description: "Lorsqu'il est implémenté, fournit un objet CultureInfo qui doit être utilisé lors de la mise à jour d'un champ particulier en Java."
type: docs
weight: 767
url: /fr/java/com.aspose.words/ifieldupdatecultureprovider/
---
```
public interface IFieldUpdateCultureProvider
```

Lorsqu'il est implémenté, fournit un objet [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) qui doit être utilisé lors de la mise à jour d'un champ particulier.
...
| Méthode | Description |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | Renvoie un objet [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) à utiliser lors de la mise à jour du champ. |
...
Renvoie un objet [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) à utiliser lors de la mise à jour du champ.
...
| --- | --- | --- |
| culture | java.lang.String | Le nom de la culture demandée pour le champ en cours de mise à jour. |
| field | [Field](../../com.aspose.words/field/) | Le champ en cours de mise à jour. |
