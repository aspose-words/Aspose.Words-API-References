...
description: "Spécifie le format de pixel pour les images générées des pages de document en Java."
type: docs
weight: 393
url: /fr/java/com.aspose.words/imagepixelformat/
---
...
Montre comment sélectionner un taux de bits par pixel avec lequel rendre un document en image.
...
| Champ | Description |
| --- | --- |
| [FORMAT_16_BPP_ARGB_1555](#FORMAT-16-BPP-ARGB-1555) | 16 bits par pixel, ARGB. |
| [FORMAT_16_BPP_RGB_555](#FORMAT-16-BPP-RGB-555) | 16 bits par pixel, RGB. |
| [FORMAT_16_BPP_RGB_565](#FORMAT-16-BPP-RGB-565) | 16 bits par pixel, RGB. |
| [FORMAT_1_BPP_INDEXED](#FORMAT-1-BPP-INDEXED) | 1 bit par pixel, Indexed. |
| [FORMAT_24_BPP_RGB](#FORMAT-24-BPP-RGB) | 24 bits par pixel, RGB. |
| [FORMAT_32_BPP_ARGB](#FORMAT-32-BPP-ARGB) | 32 bits par pixel, ARGB. |
| [FORMAT_32_BPP_P_ARGB](#FORMAT-32-BPP-P-ARGB) | 32 bits par pixel, ARGB, alpha prémultiplié. |
| [FORMAT_32_BPP_RGB](#FORMAT-32-BPP-RGB) | 32 bits par pixel, RGB. |
| [FORMAT_48_BPP_RGB](#FORMAT-48-BPP-RGB) | 48 bits par pixel, RGB. |
| [FORMAT_64_BPP_ARGB](#FORMAT-64-BPP-ARGB) | 64 bits par pixel, ARGB. |
| [FORMAT_64_BPP_P_ARGB](#FORMAT-64-BPP-P-ARGB) | 64 bits par pixel, ARGB, alpha prémultiplié. |
| [length](#length) |  |
## Méthodes
...
32 bits par pixel, ARGB, alpha prémultiplié.
...
64 bits par pixel, ARGB, alpha prémultiplié.
