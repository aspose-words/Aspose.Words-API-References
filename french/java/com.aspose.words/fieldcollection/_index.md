...
description: "Une collection d’objets Field qui représente les champs dans la plage spécifiée en Java."
type: docs
weight: 212
url: /fr/java/com.aspose.words/fieldcollection/
---
...
Une collection de [Field](../../com.aspose.words/field/) objets qui représente les champs dans la plage spécifiée.

Pour en savoir plus, consultez l'article de documentation [ Working with Fields ][Working with Fields].

 **Remarks:** 

Une instance de cette collection parcourt les champs qui commencent dans la plage spécifiée.

La collection [FieldCollection](../../com.aspose.words/fieldcollection/) ne possède pas les champs qu’elle contient, mais n’est qu’une sélection de champs.

La collection [FieldCollection](../../com.aspose.words/fieldcollection/) est "live", c.-à-d. les modifications apportées aux enfants de l'objet nœud à partir duquel elle a été créée sont immédiatement reflétées dans les champs renvoyés par les propriétés et méthodes de [FieldCollection](../../com.aspose.words/fieldcollection/).
...
| [get(int index)](#get-int) | Renvoie un champ à l'index spécifié. |
| [getCount()](#getCount) | Renvoie le nombre de champs dans la collection. |
| [iterator()](#iterator) | Renvoie un objet énumérateur. |
| [remove(Field field)](#remove-com.aspose.words.Field) | Supprime le champ spécifié de cette collection et du document. |
| [removeAt(int index)](#removeAt-int) | Supprime un champ à l'index spécifié de cette collection et du document. |
### clear() {#clear}
```
public void clear()
```
...
**Returns:**
int - Le nombre de champs dans la collection.
### iterator() {#iterator}
```
...
| Paramètre | Type | Description |
| --- | --- | --- |
| field | [Field](../../com.aspose.words/field/) | Un champ à supprimer. |
