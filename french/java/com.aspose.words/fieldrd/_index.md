...
description: "Implémente le champ RD en Java."
type: docs
weight: 277
url: /fr/java/com.aspose.words/fieldrd/
---
...
Identifie un fichier à inclure lorsque vous créez une table des matières, une table des autorités ou un index avec les champs TOC, TOA ou INDEX.
...
| [getFileName()](#getFileName) | Obtient le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index. |
...
| [isPathRelative()](#isPathRelative) | Obtient si le chemin est relatif au document actuel. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Définit si le chemin est relatif au document actuel. |
| [remove()](#remove) | Supprime le champ du document. |
| [setFileName(String value)](#setFileName-java.lang.String) | Définit le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index. |
...
Obtient le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index.
...
**Returns:**
java.lang.String - Le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index.
### getFormat() {#getFormat}
```
...
Obtient si le chemin est relatif au document actuel.
...
**Returns:**
boolean - Indique si le chemin est relatif au document actuel.
...
Définit si le chemin est relatif au document actuel.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si le chemin est relatif au document actuel. |
...
Définit le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nom du fichier à inclure lors de la génération d'une table des matières, d'une table des autorités ou d'un index. |
