...
description: "Spécifie comment les valeurs u200bu200bqui spécifient l'emplacement d'une étiquette de données - les propriétés ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble et ChartDataLabel.getTop / ChartDataLabel.setTopdouble - sont interprétées en Java."
type: docs
weight: 73
url: /fr/java/com.aspose.words/chartdatalabellocationmode/
---
...
| Champ | Description |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | L'emplacement d'une étiquette de données est spécifié à l'aide de coordonnées absolues, en partant du coin supérieur gauche d'un graphique. |
| [OFFSET](#OFFSET) | L'emplacement d'une étiquette de données est spécifié par un décalage par rapport à la position définie par sa propriété [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int). |
| [length](#length) |  |
## Méthodes
...
L'emplacement d'une étiquette de données est spécifié à l'aide de coordonnées absolues, en partant du coin supérieur gauche d'un graphique.
...
L'emplacement d'une étiquette de données est spécifié par un décalage par rapport à la position définie par sa propriété [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int).
