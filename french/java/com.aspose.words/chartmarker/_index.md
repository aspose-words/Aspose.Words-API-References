...
description: "Représente un marqueur de données de graphique en Java."
type: docs
weight: 82
url: /fr/java/com.aspose.words/chartmarker/
---
...
| Méthode | Description |
| --- | --- |
| [getFormat()](#getFormat) | Fournit un accès au remplissage et au format de ligne de ce marqueur. |
| [getShapeType()](#getShapeType) |  |
| [getSize()](#getSize) | Obtient la taille du marqueur de graphique. |
| [getSymbol()](#getSymbol) | Obtient le symbole du marqueur de graphique. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSize(int value)](#setSize-int) | Définit la taille du marqueur de graphique. |
| [setSymbol(int value)](#setSymbol-int) | Définit le symbole du marqueur de graphique. |
### getFormat() {#getFormat}
```
...
Fournit un accès au remplissage et au format de ligne de ce marqueur.
...
Obtient la taille du marqueur de graphique. La valeur par défaut est 7.
...
**Returns:**
int - Taille du marqueur de graphique.
### getSymbol() {#getSymbol}
```
...
Obtient le symbole du marqueur de graphique.
...
**Returns:**
int - Symbole du marqueur de graphique. La valeur renvoyée est l'une des constantes [MarkerSymbol](../../com.aspose.words/markersymbol/).
### isFillSupported() {#isFillSupported}
```
...
Définit la taille du marqueur de graphique. La valeur par défaut est 7.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | int | Taille du marqueur de graphique. |
...
Définit le symbole du marqueur de graphique.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| value | int | Symbole du marqueur de graphique. La valeur doit être l'une des constantes [MarkerSymbol](../../com.aspose.words/markersymbol/). |
