...
description: "Alignement WordArt en Java."
type: docs
weight: 677
url: /fr/java/com.aspose.words/textpathalignment/
---
...
| Champ | Description |
| --- | --- |
| [CENTER](#CENTER) | Centrer le texte sur la largeur. |
| [LEFT](#LEFT) | Justifier à gauche. |
| [LETTER_JUSTIFY](#LETTER-JUSTIFY) | Écarter les lettres pour ajuster à la largeur. |
| [RIGHT](#RIGHT) | Justifier à droite. |
| [STRETCH](#STRETCH) | Étendre chaque ligne de texte pour l'ajuster à la largeur. |
| [WORD_JUSTIFY](#WORD-JUSTIFY) | Écarter les mots pour ajuster à la largeur. |
| [length](#length) |  |
## Méthodes
...
Centrer le texte sur la largeur.
...
Écarter les lettres pour ajuster à la largeur.
...
Étendre chaque ligne de texte pour l'ajuster à la largeur.
...
Écarter les mots pour ajuster à la largeur.
