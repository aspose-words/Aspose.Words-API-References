...
description: "Fournit un accès typé à une collection de nœuds Paragraph en Java."
type: docs
weight: 524
url: /fr/java/com.aspose.words/paragraphcollection/
---
...
Fournit un accès typé à une collection de nœuds [Paragraph](../../com.aspose.words/paragraph/).
...
| [get(int index)](#get-int) | Récupère un [Paragraph](../../com.aspose.words/paragraph/) à l'index donné. |
...
Récupère un [Paragraph](../../com.aspose.words/paragraph/) à l'index donné.
...
**Returns:**
com.aspose.words.Node[] - Un tableau de paragraphes.
