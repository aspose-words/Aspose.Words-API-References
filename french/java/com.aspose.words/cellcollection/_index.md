...
description: "Fournit un accès typé à une collection de nœuds Cell en Java."
type: docs
weight: 60
url: /fr/java/com.aspose.words/cellcollection/
---
...
Fournit un accès typé à une collection de nœuds [Cell](../../com.aspose.words/cell/).
...
| [get(int index)](#get-int) | Récupère une [Cell](../../com.aspose.words/cell/) à l'index donné. |
...
Récupère une [Cell](../../com.aspose.words/cell/) à l'index donné.
...
**Returns:**
com.aspose.words.Node[] - Un tableau de cellules.
