...
description: "Implémente le champ TEMPLATE en Java."
type: docs
weight: 294
url: /fr/java/com.aspose.words/fieldtemplate/
---
...
| [getIncludeFullPath()](#getIncludeFullPath) | Obtient si le chemin complet du fichier doit être inclus. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Définit si le chemin complet du fichier doit être inclus. |
...
Obtient si le chemin complet du fichier doit être inclus.
...
**Returns:**
boolean - Indique si le chemin complet du fichier doit être inclus.
...
Définit si le chemin complet du fichier doit être inclus.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si le chemin complet du fichier doit être inclus. |
