...
description: "Représente une collection de ChartSeries en Java."
type: docs
weight: 86
url: /fr/java/com.aspose.words/chartseriescollection/
---
...
Représente une collection de [ChartSeries](../../com.aspose.words/chartseries/).
...
| Méthode | Description |
| --- | --- |
| [add(String seriesName, ChartMultilevelValue[] categories, double[] values)](#add-java.lang.String-com.aspose.words.ChartMultilevelValue---double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, double[] xValues)](#add-java.lang.String-double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, double[] xValues, double[] yValues)](#add-java.lang.String-double---double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, double[] xValues, double[] yValues, double[] bubbleSizes)](#add-java.lang.String-double---double---double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, String[] categories, double[] values)](#add-java.lang.String-java.lang.String---double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, String[] categories, double[] values, boolean[] isSubtotal)](#add-java.lang.String-java.lang.String---double---boolean) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [add(String seriesName, Date[] dates, double[] values)](#add-java.lang.String-java.util.Date---double) | Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. |
| [clear()](#clear) | Supprime tous les [ChartSeries](../../com.aspose.words/chartseries/) de cette collection. |
| [get(int index)](#get-int) | Renvoie un [ChartSeries](../../com.aspose.words/chartseries/) à l'index spécifié. |
| [getCount()](#getCount) | Renvoie le nombre de [ChartSeries](../../com.aspose.words/chartseries/) dans cette collection. |
| [iterator()](#iterator) | Renvoie un objet énumérateur. |
| [removeAt(int index)](#removeAt-int) | Supprime un [ChartSeries](../../com.aspose.words/chartseries/) à l'index spécifié. |
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries qui ont des catégories de données à plusieurs niveaux.

 **Examples:** 

Montre comment créer un graphique en arbre.
...
Montre comment créer un graphique sunburst.
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries aux graphiques Histogramme.

 **Remarks:** 

Pour les types de graphiques autres que Histogramme, cette méthode ajoute une série avec des valeurs Y vides.
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries à tout type de graphiques en nuage de points.
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries à tout type de graphiques à bulles.
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries à tout type de graphiques à barres, en colonnes, en lignes et de surface.
...
Montre comment créer un diagramme à boîte et moustaches.
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries aux graphiques en cascade.

 **Remarks:** 

Pour les types de graphiques autres que la cascade, les valeurs  isSubtotal  sont ignorées.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| seriesName | java.lang.String | Un nom de la série à ajouter. |
| categories | java.lang.String[] | Noms de catégorie pour l'axe X. |
| valeurs | double[] | Valeurs de l'axe Y. |
...
Ajoute un nouveau [ChartSeries](../../com.aspose.words/chartseries/) à cette collection. Utilisez cette méthode pour ajouter des séries à tout type de graphiques en aires, radar et boursiers.
...
Supprime tous les [ChartSeries](../../com.aspose.words/chartseries/) de cette collection.
...
Renvoie un [ChartSeries](../../com.aspose.words/chartseries/) à l'index spécifié.
...
Renvoie le nombre de [ChartSeries](../../com.aspose.words/chartseries/) dans cette collection.
...
**Returns:**
int - Le nombre de [ChartSeries](../../com.aspose.words/chartseries/) dans cette collection.
### iterator() {#iterator}
```
...
Supprime un [ChartSeries](../../com.aspose.words/chartseries/) à l'index spécifié.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| index | int | L'index basé sur zéro du [ChartSeries](../../com.aspose.words/chartseries/) à supprimer. |
