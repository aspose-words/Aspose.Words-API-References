...
description: "Spécifie un type de bloc de construction en Java."
type: docs
weight: 56
url: /fr/java/com.aspose.words/buildingblocktype/
---
...
Correspond au type **ST\\_DocPartType** dans OOXML.
...
| Champ | Description |
| --- | --- |
| [ALL](#ALL) | Le bloc de construction est associé à tous les types. |
| [AUTOMATICALLY_REPLACE_NAME_WITH_CONTENT](#AUTOMATICALLY-REPLACE-NAME-WITH-CONTENT) | Permet au bloc de construction d'être automatiquement inséré dans le document chaque fois que son nom est saisi dans une application. |
| [AUTO_CORRECT](#AUTO-CORRECT) | Le bloc de construction est associé aux outils d'orthographe et de grammaire. |
| [AUTO_TEXT](#AUTO-TEXT) | Le bloc de construction est une entrée AutoText. |
| [DEFAULT](#DEFAULT) | Enregistrer sous [NONE](../../com.aspose.words/buildingblocktype/\\#NONE). |
| [FORM_FIELD_HELP_TEXT](#FORM-FIELD-HELP-TEXT) | Le bloc de construction est un texte d'aide de champ de formulaire. |
| [NONE](#NONE) | Aucune information de type n'est spécifiée pour le bloc de construction. |
| [NORMAL](#NORMAL) | Le bloc de construction est un normal (c.-à-d. |
| [STRUCTURED_DOCUMENT_TAG_PLACEHOLDER_TEXT](#STRUCTURED-DOCUMENT-TAG-PLACEHOLDER-TEXT) | Le bloc de construction est un texte d'espace réservé de balise de document structuré. |
| [length](#length) |  |
## Méthodes
...
Le bloc de construction est associé à tous les types.
...
Permet au bloc de construction d'être automatiquement inséré dans le document chaque fois que son nom est saisi dans une application.
...
Le bloc de construction est associé aux outils d'orthographe et de grammaire.
...
Le bloc de construction est une entrée AutoText.
...
Enregistrer sous [NONE](../../com.aspose.words/buildingblocktype/\\#NONE).
...
Le bloc de construction est un texte d'aide de champ de formulaire.
...
Aucune information de type n'est spécifiée pour le bloc de construction.
...
Le bloc de construction est une entrée de document de glossaire normale (c.-à-d. régulière).
...
Le bloc de construction est un texte d'espace réservé de balise de document structuré.
