...
description: "Permet de spécifier des options supplémentaires lors du chargement d'un document CHM dans un objet Document en Java."
type: docs
weight: 102
url: /fr/java/com.aspose.words/chmloadoptions/
---
...
Permet de spécifier des options supplémentaires lors du chargement d'un document CHM dans un objet [Document](../../com.aspose.words/document/).

Pour en savoir plus, visitez l'article de documentation [ Specify Load Options ][Specify Load Options].

 **Examples:** 

Montre comment résoudre des URL comme "ms-its:myfile.chm::/index.htm".
...
| [getOriginalFileName()](#getOriginalFileName) | Le nom du fichier CHM. |
...
| [setOriginalFileName(String value)](#setOriginalFileName-java.lang.String) | Le nom du fichier CHM. |
...
Les documents CHM peuvent contenir des liens qui font référence au même document par son nom de fichier. Aspose.Words prend en charge ces liens et utilise généralement [Document.getOriginalFileName()](../../com.aspose.words/document/\\#getOriginalFileName) pour vérifier si le fichier référencé par un lien est le fichier en cours de chargement. Si un document est chargé depuis un flux, son nom de fichier d'origine doit être spécifié explicitement via cette propriété, car il ne peut pas être déterminé automatiquement.

Si un document CHM est chargé depuis un fichier et qu'une valeur non nulle pour cette propriété est spécifiée, cette valeur aura priorité sur le nom réel du fichier stocké dans [Document.getOriginalFileName()](../../com.aspose.words/document/\\#getOriginalFileName).
