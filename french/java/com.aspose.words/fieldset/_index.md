...
description: "Implémente le champ SET en Java."
type: docs
weight: 285
url: /fr/java/com.aspose.words/fieldset/
---
...
Montre comment créer du texte avec un signet à l'aide d'un champ SET, puis l'afficher dans le document en utilisant un champ REF.
...
| [getBookmarkText()](#getBookmarkText) | Obtient le nouveau texte du signet. |
...
| [setBookmarkText(String value)](#setBookmarkText-java.lang.String) | Définit le nouveau texte du signet. |
...
Obtient le nouveau texte du signet.
...
**Returns:**
java.lang.String - Le nouveau texte du signet.
...
Définit le nouveau texte du signet.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le nouveau texte du signet. |
