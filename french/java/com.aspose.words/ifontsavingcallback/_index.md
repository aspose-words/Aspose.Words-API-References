...
description: "Implémentez cette interface si vous souhaitez recevoir des notifications et contrôler la façon dont Aspose.Words enregistre les polices lors de l'exportation d'un document au format HTML en Java."
type: docs
weight: 771
url: /fr/java/com.aspose.words/ifontsavingcallback/
---
```
...
| Méthode | Description |
| --- | --- |
| [fontSaving(FontSavingArgs args)](#fontSaving-com.aspose.words.FontSavingArgs) | Appelé lorsque Aspose.Words est sur le point d'enregistrer une ressource de police. |
