...
description: "Implémente le champ GREETINGLINE en Java."
type: docs
weight: 241
url: /fr/java/com.aspose.words/fieldgreetingline/
---
...
Insère une ligne de salutation de fusion de courrier.
...
| Méthode | Description |
| --- | --- |
| [getAlternateText()](#getAlternateText) | Obtient le texte à inclure dans le champ si le nom est vide. |
...
| [getFieldNames()](#getFieldNames) | Renvoie une collection de noms de champs de fusion de courrier utilisés par le champ. |
...
| [getLanguageId()](#getLanguageId) | Obtient l’identifiant de langue utilisé pour formater le nom. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | Obtient le format du nom inclus dans le champ. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | Définit le texte à inclure dans le champ si le nom est vide. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Définit l’identifiant de langue utilisé pour formater le nom. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Définit le format du nom inclus dans le champ. |
...
Obtient le texte à inclure dans le champ si le nom est vide.
...
**Returns:**
java.lang.String - Le texte à inclure dans le champ si le nom est vide.
...
Renvoie une collection de noms de champs de fusion de courrier utilisés par le champ.
...
Obtient l’identifiant de langue utilisé pour formater le nom.
...
**Returns:**
java.lang.String - L’identifiant de langue utilisé pour formater le nom.
...
Obtient le format du nom inclus dans le champ.
...
**Returns:**
java.lang.String - Le format du nom inclus dans le champ.
### getResult() {#getResult}
```
...
Définit le texte à inclure dans le champ si le nom est vide.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le texte à inclure dans le champ si le nom est vide. |
...
Définit l’identifiant de langue utilisé pour formater le nom.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L’identifiant de langue utilisé pour formater le nom. |
...
Définit le format du nom inclus dans le champ.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Le format du nom inclus dans le champ. |
