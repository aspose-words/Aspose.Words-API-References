...
description: "Implémente le champ AUTHOR en Java."
type: docs
weight: 200
url: /fr/java/com.aspose.words/fieldauthor/
---
...
Récupère, et éventuellement définit, le nom de l'auteur du document, tel qu'enregistré dans la propriété **Author** des propriétés intégrées du document.
...
| Méthode | Description |
| --- | --- |
| [getAuthorName()](#getAuthorName) | Obtient le nom de l'auteur du document. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Définit le nom de l'auteur du document. |
