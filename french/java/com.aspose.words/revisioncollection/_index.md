...
description: "Une collection d'objets Revision qui représentent les révisions du document en Java."
type: docs
weight: 580
url: /fr/java/com.aspose.words/revisioncollection/
---
...
Une collection d'objets [Revision](../../com.aspose.words/revision/) qui représentent les révisions du document.

Pour en savoir plus, consultez l'article de documentation [ Track Changes in a Document ][Track Changes in a Document].

 **Remarks:** 

Vous ne créez pas d'instances de cette classe directement. Utilisez la propriété [Document.getRevisions()](../../com.aspose.words/document/\\#getRevisions) pour obtenir les révisions présentes dans un document.
...
| Méthode | Description |
| --- | --- |
| [accept(IRevisionCriteria criteria)](#accept-com.aspose.words.IRevisionCriteria) | Accepte les révisions qui correspondent aux critères spécifiés. |
| [acceptAll()](#acceptAll) | Accepte toutes les révisions de cette collection. |
| [get(int index)](#get-int) | Renvoie un [Revision](../../com.aspose.words/revision/) à l'index spécifié. |
| [getCount()](#getCount) | Renvoie le nombre de révisions dans la collection. |
| [getGroups()](#getGroups) | Collection de groupes de révisions. |
| [iterator()](#iterator) | Renvoie un objet énumérateur. |
| [reject(IRevisionCriteria criteria)](#reject-com.aspose.words.IRevisionCriteria) | Rejette les révisions qui correspondent aux critères spécifiés. |
...
| --- | --- | --- |
| criteria | [IRevisionCriteria](../../com.aspose.words/irevisioncriteria/) | L'implémentation de [IRevisionCriteria](../../com.aspose.words/irevisioncriteria/). |

**Returns:**
int - Le nombre de révisions acceptées.
### acceptAll() {#acceptAll}
```
...
Renvoie un [Revision](../../com.aspose.words/revision/) à l'index spécifié.
...
Renvoie le nombre de révisions dans la collection.
...
**Returns:**
int - Le nombre de révisions dans la collection.
### getGroups() {#getGroups}
```
...
Collection de groupes de révisions.
...
**Returns:**
int - Le nombre de révisions rejetées.
### rejectAll() {#rejectAll}
```
...
Rejette toutes les révisions de cette collection.
