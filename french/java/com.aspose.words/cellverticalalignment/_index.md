...
description: "Spécifie l'alignement vertical du texte à l'intérieur d'une cellule de tableau en Java."
type: docs
weight: 63
url: /fr/java/com.aspose.words/cellverticalalignment/
---
...
| Champ | Description |
| --- | --- |
| [BOTTOM](#BOTTOM) | Le texte est aligné en bas de la cellule. |
| [CENTER](#CENTER) | Le texte est aligné au centre d'une cellule. |
| [TOP](#TOP) | Le texte est aligné en haut d'une cellule. |
| [length](#length) |  |
## Méthodes
...
Le texte est aligné en bas de la cellule.
...
Le texte est aligné au centre d'une cellule.
...
Le texte est aligné en haut d'une cellule.
