...
description: "Implémente le champ CITATION en Java."
type: docs
weight: 211
url: /fr/java/com.aspose.words/fieldcitation/
---
...
Insère le contenu de l'élément **Source** avec un élément **Tag** spécifié en utilisant un style bibliographique.
...
| Méthode | Description |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | Obtient une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Obtient l'ID de langue utilisé conjointement avec le style bibliographique spécifié pour formater la citation dans le document. |
| [getLocaleId()](#getLocaleId) | Obtient le LCID du champ. |
| [getPageNumber()](#getPageNumber) | Obtient un numéro de page associé à la citation. |
| [getPrefix()](#getPrefix) | Obtient un préfixe qui est ajouté avant la citation. |
...
| [getSourceTag()](#getSourceTag) | Obtient une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer. |
| [getStart()](#getStart) | Obtient le nœud qui représente le début du champ. |
| [getSuffix()](#getSuffix) | Obtient un suffixe qui est ajouté après la citation. |
| [getSuppressAuthor()](#getSuppressAuthor) | Obtient si les informations sur l'auteur sont supprimées de la citation. |
| [getSuppressTitle()](#getSuppressTitle) | Obtient si les informations sur le titre sont supprimées de la citation. |
| [getSuppressYear()](#getSuppressYear) | Obtient si les informations sur l'année sont supprimées de la citation. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Obtient le type de champ Microsoft Word. |
| [getVolumeNumber()](#getVolumeNumber) | Obtient un numéro de volume associé à la citation. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | Définit une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Définit l'ID de langue utilisé en conjonction avec le style bibliographique spécifié pour formater la citation dans le document. |
| [setLocaleId(int value)](#setLocaleId-int) | Définit le LCID du champ. |
| [setPageNumber(String value)](#setPageNumber-java.lang.String) | Définit un numéro de page associé à la citation. |
| [setPrefix(String value)](#setPrefix-java.lang.String) | Définit un préfixe qui est ajouté au début de la citation. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Définit une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | Définit un suffixe qui est ajouté à la fin de la citation. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | Définit si les informations sur l'auteur sont supprimées de la citation. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | Définit si les informations sur le titre sont supprimées de la citation. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | Définit si les informations sur l'année sont supprimées de la citation. |
| [setVolumeNumber(String value)](#setVolumeNumber-java.lang.String) | Définit un numéro de volume associé à la citation. |
...
Obtient une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation.
...
**Returns:**
java.lang.String - Une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation.
...
Obtient l'ID de langue utilisé conjointement avec le style bibliographique spécifié pour formater la citation dans le document.
...
**Returns:**
java.lang.String - L'ID de langue utilisé en conjonction avec le style bibliographique spécifié pour formater la citation dans le document.
...
Obtient un numéro de page associé à la citation.
...
**Returns:**
java.lang.String - Un numéro de page associé à la citation.
### getPrefix() {#getPrefix}
```
...
Obtient un préfixe qui est ajouté avant la citation.
...
**Returns:**
java.lang.String - Un préfixe qui est ajouté au début de la citation.
### getResult() {#getResult}
```
...
Obtient une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer.
...
**Returns:**
java.lang.String - Une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer.
### getStart() {#getStart}
```
...
Obtient un suffixe qui est ajouté après la citation.
...
**Returns:**
java.lang.String - Un suffixe qui est ajouté à la fin de la citation.
...
Obtient si les informations sur l'auteur sont supprimées de la citation.
...
**Returns:**
boolean - Si les informations sur l'auteur sont supprimées de la citation.
...
Obtient si les informations sur le titre sont supprimées de la citation.
...
**Returns:**
boolean - Si les informations sur le titre sont supprimées de la citation.
...
Obtient si les informations sur l'année sont supprimées de la citation.
...
**Returns:**
boolean - Si les informations sur l'année sont supprimées de la citation.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Obtient un numéro de volume associé à la citation.
...
**Returns:**
java.lang.String - Un numéro de volume associé à la citation.
### isDirty() {#isDirty}
```
...
Définit une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une valeur qui correspond à la valeur de l'élément **Tag** d'une autre source à inclure dans la citation. |
...
Définit l'ID de langue utilisé en conjonction avec le style bibliographique spécifié pour formater la citation dans le document.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | L'ID de langue qui est utilisé en conjonction avec le style bibliographique spécifié pour formater la citation dans le document. |
...
Définit un numéro de page associé à la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un numéro de page associé à la citation. |
...
Définit un préfixe qui est ajouté au début de la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un préfixe qui est ajouté avant la citation. |
...
Définit une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Une valeur qui correspond à la valeur de l'élément **Tag** de la source à insérer. |
...
Définit un suffixe qui est ajouté à la fin de la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un suffixe qui est ajouté après la citation. |
...
Définit si les informations sur l'auteur sont supprimées de la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si les informations d'auteur sont supprimées de la citation. |
...
Définit si les informations sur le titre sont supprimées de la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si les informations de titre sont supprimées de la citation. |
...
Définit si les informations sur l'année sont supprimées de la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | boolean | Indique si les informations d'année sont supprimées de la citation. |
...
Définit un numéro de volume associé à la citation.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| valeur | java.lang.String | Un numéro de volume associé à la citation. |
