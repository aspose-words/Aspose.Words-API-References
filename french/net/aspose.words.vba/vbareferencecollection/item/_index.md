...
description: Accédez facilement à l'objet VbaReference grâce à la propriété Item. Récupérez efficacement les références par index pour un développement VBA simplifié.
type: docs
weight: 20
