...
description: Découvrez la propriété VbaReference Type pour identifier et utiliser efficacement les objets VbaReferenceType, améliorant ainsi l'efficacité de votre programmation VBA.
type: docs
weight: 20
...
Obtient[`VbaReferenceType`](../../vbareferencetype/) objet qui indique le type de référence qu'un[`VbaReference`](../) l'objet représente.
