...
description: Découvrez l'énumération Aspose.Words.AI.Language pour une traduction de texte fluide et optimisée par l'IA. Améliorez vos documents grâce à une assistance multilingue précise dès aujourd'hui !
type: docs
weight: 80
url: /fr/net/aspose.words.ai/language/
---
## Language enumeration

Spécifie la langue dans laquelle le texte sera traduit à l'aide de l'IA.  .
