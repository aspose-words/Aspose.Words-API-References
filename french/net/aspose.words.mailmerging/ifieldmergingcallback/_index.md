...
description: Implémentez cette interface si vous souhaitez contrôler la manière dont les données sont insérées dans les champs de fusion lors dune opération de publipostage.
type: docs
weight: 3570
