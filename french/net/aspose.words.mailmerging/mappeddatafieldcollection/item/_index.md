...
description: Découvrez la propriété d'élément MappedDataFieldCollection pour gérer facilement les noms de champs dans votre source de données pour une intégration transparente du publipostage.
type: docs
weight: 20
