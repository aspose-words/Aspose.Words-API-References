...
description: Permet de mapper automatiquement les noms des champs de votre source de données et les noms des champs de fusion et publipostage du document.
type: docs
weight: 3650
