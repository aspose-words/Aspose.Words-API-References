...
description: Découvrez Aspose.Words.MailMerging.MappedDataFieldCollection pour un mappage transparent des champs de source de données aux champs de publipostage, améliorant ainsi l'automatisation des documents.
type: docs
weight: 4560
...
Permet de mapper automatiquement les noms des champs de votre source de données et les noms des champs de publipostage dans le document.
...
Ceci est implémenté comme une collection de clés de chaîne dans des valeurs de chaîne. Les clés sont les noms des champs de publipostage dans le document et les valeurs sont les noms des champs de votre source de données.
