...
description: MappedDataFieldCollection méthode. Renvoie un objet énumérateur de dictionnaire qui peut être utilisé pour parcourir tous les éléments de la collection.
type: docs
weight: 70
