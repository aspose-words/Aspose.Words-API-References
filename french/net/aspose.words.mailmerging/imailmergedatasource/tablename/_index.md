...
description: Renvoie le nom de la source de données.
type: docs
weight: 10
...
Si vous mettez en œuvre[`IMailMergeDataSource`](../../imailmergedatasource), renvoie le nom de la source data à partir de cette propriété.
