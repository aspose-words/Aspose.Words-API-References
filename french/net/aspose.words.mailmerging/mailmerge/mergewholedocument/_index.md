...
description: Obtient ou définit une valeur indiquant si les champs du document entier sont mis à jour lors de lexécution dun publipostage avec des régions.
type: docs
weight: 70
