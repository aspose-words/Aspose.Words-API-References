...
description: Découvrez la propriété MailMerge MappedDataFields, accédez à une puissante collection de champs de données mappés pour améliorer vos opérations de publipostage sans effort.
type: docs
weight: 50
...
Les champs de données mappés permettent de mapper automatiquement les noms des champs de votre source de données et les noms des champs de publipostage dans le document.
