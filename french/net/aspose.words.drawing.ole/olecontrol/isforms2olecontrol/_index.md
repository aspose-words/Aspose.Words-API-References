...
description: Découvrez la propriété IsForms2OleControl d'OleControl, qui identifie si votre contrôle est un Forms2OleControl, améliorant ainsi l'efficacité de votre développement.
type: docs
weight: 10
