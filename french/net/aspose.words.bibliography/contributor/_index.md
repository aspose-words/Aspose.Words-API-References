...
description: Découvrez la classe Aspose.Words.Bibliography.Contributor, votre solution de référence pour gérer les contributeurs de bibliographie, y compris les organisations et les particuliers.
type: docs
weight: 150
url: /fr/net/aspose.words.bibliography/contributor/
---
## Contributor class

Représente un contributeur à la source bibliographique. Il peut s'agir d'une entreprise (une organisation) ou d'une liste de personnes.
