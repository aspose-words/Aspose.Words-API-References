...
description: Découvrez la classe Aspose.Words.Bibliography.PersonCollection, conçue pour rationaliser la gestion de la bibliographie en répertoriant efficacement les contributeurs sources.
type: docs
weight: 190
url: /fr/net/aspose.words.bibliography/personcollection/
---
...
| Nom | La description |
| --- | --- |
| [PersonCollection](personcollection/#constructor)() | Initialiser une nouvelle instance du`PersonCollection` classe. |
| [PersonCollection](personcollection/#constructor_2)(*IEnumerable&lt;Person&gt;*) |  |
| [PersonCollection](personcollection/#constructor_1)(*params Person[]*) | Initialiser une nouvelle instance du`PersonCollection` classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [Count](../../aspose.words.bibliography/personcollection/count/) { get; } | Obtient le nombre de personnes contenues dans la collection. |
| [Item](../../aspose.words.bibliography/personcollection/item/) { get; set; } | Obtient ou définit une personne à l'index spécifié. |

## Méthodes

| Nom | La description |
| --- | --- |
| [Add](../../aspose.words.bibliography/personcollection/add/)(*[Person](../person/)*) | Ajoute un[`Person`](../person/) à la collection. |
| [Clear](../../aspose.words.bibliography/personcollection/clear/)() | Supprime tous les éléments de la collection. |
| [Contains](../../aspose.words.bibliography/personcollection/contains/)(*[Person](../person/)*) | Détermine si la collection contient une personne spécifique. |
| [Remove](../../aspose.words.bibliography/personcollection/remove/)(*[Person](../person/)*) | Supprime la personne de la collection. |
| [RemoveAt](../../aspose.words.bibliography/personcollection/removeat/)(*int*) | Supprime la personne à l'index spécifié. |
