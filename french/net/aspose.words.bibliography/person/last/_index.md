...
description: Gérez vos données personnelles en toute simplicité grâce à la propriété Nom de famille. Obtenez ou définissez facilement le nom de famille d'une personne pour une gestion simplifiée des données.
type: docs
weight: 30
url: /fr/net/aspose.words.bibliography/person/last/
---
## Person.Last property

Obtient ou définit le nom de famille d'une personne.
