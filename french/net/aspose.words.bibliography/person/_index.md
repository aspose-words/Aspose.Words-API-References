...
description: Découvrez la classe Aspose.Words.Bibliography.Person pour gérer les contributeurs individuels dans les bibliographies. Améliorez la précision des citations de votre document !
type: docs
weight: 180
url: /fr/net/aspose.words.bibliography/person/
---
## Person class

Représente le contributeur individuel (une personne) à la source de la bibliographie.
...
| Nom | La description |
| --- | --- |
| [Person](person/)(*string, string, string*) | Initialiser une nouvelle instance du`Person` classe. |

## Propriétés

| Nom | La description |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Obtient ou définit le prénom d'une personne. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Obtient ou définit le nom de famille d'une personne. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Obtient ou définit le deuxième prénom d'une personne. |
