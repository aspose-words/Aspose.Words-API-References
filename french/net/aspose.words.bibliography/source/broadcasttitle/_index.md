...
description: Gérez facilement le titre de diffusion de votre source grâce à notre propriété intuitive BroadcastTitle. Améliorez la visibilité et l'engagement de votre contenu dès aujourd'hui !
type: docs
weight: 60
url: /fr/net/aspose.words.bibliography/source/broadcasttitle/
---
## Source.BroadcastTitle property

Obtient ou définit le titre de diffusion d'une source.
