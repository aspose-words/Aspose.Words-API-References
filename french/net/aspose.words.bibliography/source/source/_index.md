...
description: Créez facilement une instance de classe Source avec notre constructeur. Simplifiez votre développement et optimisez l'efficacité de votre projet dès aujourd'hui !
type: docs
weight: 10
url: /fr/net/aspose.words.bibliography/source/source/
---
## Source constructor

Initialiser une nouvelle instance du[`Source`](../) classe.
...
| --- | --- | --- |
| tag | String | Le nom de l'étiquette d'identification. |
