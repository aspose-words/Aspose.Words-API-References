...
description: Gérez facilement votre propriété « Année source ». Obtenez ou définissez facilement l'année d'une source pour une organisation simplifiée des données et une précision accrue.
type: docs
weight: 530
url: /fr/net/aspose.words.bibliography/source/year/
---
## Source.Year property

Obtient ou définit l'année d'une source.
