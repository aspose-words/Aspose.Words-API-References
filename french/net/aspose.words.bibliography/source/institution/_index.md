...
description: Gérez facilement les propriétés de votre établissement source. Définissez ou mettez à jour facilement les informations de votre établissement pour une organisation simplifiée des données et une meilleure accessibilité.
type: docs
weight: 220
url: /fr/net/aspose.words.bibliography/source/institution/
---
## Source.Institution property

Obtient ou définit l'institution d'une source.
