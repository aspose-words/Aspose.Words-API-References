...
description: Gérez facilement les dates d'accès à vos sources avec Source DayAccessed. Suivez et mettez à jour facilement les dates d'accès à vos sources pour une meilleure organisation.
type: docs
weight: 160
url: /fr/net/aspose.words.bibliography/source/dayaccessed/
---
## Source.DayAccessed property

Obtient ou définit le jour d'accès à une source.
