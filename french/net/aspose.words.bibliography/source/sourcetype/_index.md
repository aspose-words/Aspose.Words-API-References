...
description: Découvrez la propriété SourceType pour gérer facilement vos sources de données. Obtenez ou définissez facilement des types de sources pour une organisation optimisée des données.
type: docs
weight: 410
url: /fr/net/aspose.words.bibliography/source/sourcetype/
---
## Source.SourceType property

Obtient ou définit le type de source d'une source.
