...
description: Gérez facilement le numéro de dossier abrégé de votre source grâce à notre outil convivial. Simplifiez le suivi de vos dossiers dès aujourd'hui !
type: docs
weight: 20
url: /fr/net/aspose.words.bibliography/source/abbreviatedcasenumber/
---
## Source.AbbreviatedCaseNumber property

Obtient ou définit le numéro de cas abrégé d'une source.
