...
description: Gérez facilement les propriétés des types de sources. Obtenez ou définissez facilement des types de sources pour une organisation des données et une efficacité optimales dans vos projets.
type: docs
weight: 490
url: /fr/net/aspose.words.bibliography/source/type/
---
## Source.Type property

Obtient ou définit le type d'une source.
