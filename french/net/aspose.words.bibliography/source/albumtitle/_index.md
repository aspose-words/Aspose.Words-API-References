...
description: Gérez facilement le titre de l'album de votre source grâce à la propriété AlbumTitle. Obtenez ou définissez facilement des titres pour une meilleure organisation et une meilleure accessibilité.
type: docs
weight: 30
url: /fr/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

Obtient ou définit le titre de l'album d'une source.
