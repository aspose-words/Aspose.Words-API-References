...
description: Gérez facilement le numéro de dossier de votre source grâce à la propriété Source CaseNumber. Simplifiez le suivi et optimisez l'organisation pour de meilleurs résultats.
type: docs
weight: 70
url: /fr/net/aspose.words.bibliography/source/casenumber/
---
## Source.CaseNumber property

Obtient ou définit le numéro de cas d'une source.
