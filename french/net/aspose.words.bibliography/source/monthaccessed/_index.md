...
description: Gérez facilement le mois d'accès à votre source. Définissez ou récupérez facilement le mois d'accès pour un suivi et une organisation optimaux des données.
type: docs
weight: 290
url: /fr/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

Obtient ou définit le mois d'accès d'une source.
