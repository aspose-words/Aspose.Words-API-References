...
description: Gérez facilement la propriété LCID. Obtenez ou définissez l'ID de localisation de votre source pour une localisation fluide et une expérience utilisateur améliorée.
type: docs
weight: 260
url: /fr/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

Obtient ou définit l'ID de paramètres régionaux d'une source.
