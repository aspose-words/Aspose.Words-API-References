...
description: Gérez facilement la propriété Source StandardNumber. Obtenez ou définissez facilement le numéro standard pour une intégration et une précision optimales des données.
type: docs
weight: 420
url: /fr/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

Obtient ou définit le numéro standard d'une source.
