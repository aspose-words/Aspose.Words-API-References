...
description: Gérez votre station source en toute simplicité. Configurez ou récupérez facilement votre station source pour une intégration fluide des données et une efficacité accrue.
type: docs
weight: 440
url: /fr/net/aspose.words.bibliography/source/station/
---
## Source.Station property

Obtient ou définit la station d'une source.
