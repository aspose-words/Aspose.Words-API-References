...
description: Découvrez comment gérer les types de thèses avec la propriété ThesisType. Obtenez ou définissez facilement les types de thèses sources pour une gestion de recherche simplifiée.
type: docs
weight: 470
url: /fr/net/aspose.words.bibliography/source/thesistype/
---
## Source.ThesisType property

Obtient ou définit le type de thèse d'une source.
