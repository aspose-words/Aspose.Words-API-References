...
description: Gérez facilement votre propriété Source Guid. Obtenez ou définissez facilement le GUID pour une gestion simplifiée des données et une organisation optimisée.
type: docs
weight: 210
url: /fr/net/aspose.words.bibliography/source/guid/
---
## Source.Guid property

Obtient ou définit le GUID d'une source.
