...
description: Découvrez la propriété de compilateur ContributorCollection pour gérer efficacement les compilateurs sources. Améliorez votre expérience de codage grâce à un accès et un contrôle simplifiés !
type: docs
weight: 40
url: /fr/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

Obtient ou définit le compilateur d'une source.
