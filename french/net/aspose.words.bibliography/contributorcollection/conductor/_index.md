...
description: Découvrez la propriété Conductor ContributorCollection, gérez et personnalisez facilement le conducteur source pour une organisation et un contrôle améliorés des données.
type: docs
weight: 60
url: /fr/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Obtient ou définit le conducteur d'une source.
