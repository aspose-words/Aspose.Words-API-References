---
title: ContributorCollection.BookAuthor
linktitle: BookAuthor
articleTitle: BookAuthor
second_title: Aspose.Words pour .NET
description: Découvrez la propriété ContributorCollection BookAuthor, gérez et personnalisez facilement les auteurs de livres pour vos sources, améliorant ainsi l'organisation de votre contenu.
type: docs
weight: 30
url: /fr/net/aspose.words.bibliography/contributorcollection/bookauthor/
---
## ContributorCollection.BookAuthor property

Obtient ou définit l'auteur du livre d'une source.

```csharp
public Contributor BookAuthor { get; set; }
```
