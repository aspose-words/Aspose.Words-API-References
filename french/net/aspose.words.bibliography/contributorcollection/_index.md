...
description: Découvrez la classe Aspose.Words.Bibliography.ContributorCollection pour gérer efficacement les contributeurs de bibliographie et enrichir les références de votre document.
type: docs
weight: 160
url: /fr/net/aspose.words.bibliography/contributorcollection/
---
## ContributorCollection class

Représente les contributeurs de la source bibliographique.
...
| Nom | La description |
| --- | --- |
| [Artist](../../aspose.words.bibliography/contributorcollection/artist/) { get; set; } | Obtient ou définit l'artiste d'une source. |
| [Author](../../aspose.words.bibliography/contributorcollection/author/) { get; set; } | Obtient ou définit l'auteur d'une source. |
| [BookAuthor](../../aspose.words.bibliography/contributorcollection/bookauthor/) { get; set; } | Obtient ou définit l'auteur du livre d'une source. |
| [Compiler](../../aspose.words.bibliography/contributorcollection/compiler/) { get; set; } | Obtient ou définit le compilateur d'une source. |
| [Composer](../../aspose.words.bibliography/contributorcollection/composer/) { get; set; } | Obtient ou définit le compositeur d'une source. |
| [Conductor](../../aspose.words.bibliography/contributorcollection/conductor/) { get; set; } | Obtient ou définit le conducteur d'une source. |
| [Counsel](../../aspose.words.bibliography/contributorcollection/counsel/) { get; set; } | Obtient ou définit le conseil d'une source. |
| [Director](../../aspose.words.bibliography/contributorcollection/director/) { get; set; } | Obtient ou définit le directeur d'une source. |
| [Editor](../../aspose.words.bibliography/contributorcollection/editor/) { get; set; } | Obtient ou définit l'éditeur d'une source. |
| [Interviewee](../../aspose.words.bibliography/contributorcollection/interviewee/) { get; set; } | Obtient ou définit la personne interrogée d'une source. |
| [Interviewer](../../aspose.words.bibliography/contributorcollection/interviewer/) { get; set; } | Obtient ou définit l'intervieweur d'une source. |
| [Inventor](../../aspose.words.bibliography/contributorcollection/inventor/) { get; set; } | Obtient ou définit l'inventeur d'une source. |
| [Performer](../../aspose.words.bibliography/contributorcollection/performer/) { get; set; } | Obtient ou définit l'interprète d'une source. |
| [Producer](../../aspose.words.bibliography/contributorcollection/producer/) { get; set; } | Obtient ou définit le producteur d'une source. |
| [Translator](../../aspose.words.bibliography/contributorcollection/translator/) { get; set; } | Obtient ou définit le traducteur d'une source. |
| [Writer](../../aspose.words.bibliography/contributorcollection/writer/) { get; set; } | Obtient ou définit l'auteur d'une source. |
