...
description: Découvrez la classe Aspose.Words.Bibliography, votre outil indispensable pour gérer efficacement et sans effort les sources bibliographiques dans les documents.
type: docs
weight: 140
url: /fr/net/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| Nom | La description |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Obtient ou définit une chaîne qui représente le nom du style actif à utiliser pour une bibliographie. |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | Obtient une collection qui représente toutes les sources contenues dans une bibliographie. |
