...
description: Obtient ou définit le type préféré de nœuds de document qui représenteront les éléments ltinputgt et ltselectgt importés. La valeur par défaut estFormField .
type: docs
weight: 50
