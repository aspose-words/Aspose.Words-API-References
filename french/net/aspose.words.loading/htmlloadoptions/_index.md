...
description: Aspose.Words.Loading.HtmlLoadOptions classe. Permet de spécifier des options supplémentaires lors du chargement dun document HTML dans unDocument objet.
type: docs
weight: 3620
