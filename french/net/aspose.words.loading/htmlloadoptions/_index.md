...
description: Aspose.Words.Loading.HtmlLoadOptions classe. Permet de spécifier des options supplémentaires lors du chargement dun document HTML dans unDocument objet en C#.
type: docs
weight: 3620
...
| [BlockImportMode](../../aspose.words.loading/htmlloadoptions/blockimportmode/) { get; set; } | Obtient ou définit une valeur qui spécifie la manière dont les propriétés des éléments de niveau bloc sont importées. La valeur par défaut estMerge . |
...
| [WebRequestTimeout](../../aspose.words.loading/htmlloadoptions/webrequesttimeout/) { get; set; } | Le nombre de millisecondes à attendre avant l'expiration de la requête Web. La valeur par défaut est 100 000 milliseconds (100 secondes). |
