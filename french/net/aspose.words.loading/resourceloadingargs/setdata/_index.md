...
description: ResourceLoadingArgs méthode. Définit les données fournies par lutilisateur de la ressource qui est utilisée siResourceLoading renvoieUserProvided .
type: docs
weight: 40
...
Définit les données fournies par l'utilisateur de la ressource qui est utilisée si[`ResourceLoading`](../../iresourceloadingcallback/resourceloading/) renvoieUserProvided .
