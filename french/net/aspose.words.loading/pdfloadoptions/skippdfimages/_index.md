...
description: Obtient ou définit lindicateur indiquant si les images doivent être ignorées lors du chargement du document PDF. La valeur par défaut est False.
type: docs
weight: 40
