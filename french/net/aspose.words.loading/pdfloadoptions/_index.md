...
description: Découvrez Aspose.Words.PdfLoadOptions pour un chargement PDF optimisé. Personnalisez vos conversions de documents grâce à des options flexibles pour des résultats optimaux.
type: docs
weight: 4130
...
| [PageCount](../../aspose.words.loading/pdfloadoptions/pagecount/) { get; set; } | Récupère ou définit le nombre de pages à lire. La valeur par défaut est MaxValue, ce qui signifie que toutes les pages du document seront lues. |
| [PageIndex](../../aspose.words.loading/pdfloadoptions/pageindex/) { get; set; } | Obtient ou définit l'index (à partir de 0) de la première page à lire. La valeur par défaut est 0. |
