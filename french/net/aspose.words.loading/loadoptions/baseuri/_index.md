...
description: LoadOptions propriété. Obtient ou définit la chaîne qui sera utilisée pour résoudre les URI relatifs trouvés dans le document en URI absolus si nécessaire. Peut être une chaîne nulle ou vide. La valeur par défaut est null.
type: docs
weight: 20
...
Obtient ou définit la chaîne qui sera utilisée pour résoudre les URI relatifs trouvés dans le document en URI absolus si nécessaire. Peut être une chaîne nulle ou vide. La valeur par défaut est null.
...
2. Lors de l'enregistrement d'un document au format PDF et dans d'autres formats, pour récupérer des images liées à l'aide d'URI relatifs afin que les images puissent être enregistrées dans le document de sortie.
