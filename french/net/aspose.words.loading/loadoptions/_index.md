...
description: Aspose.Words.Loading.LoadOptions classe. Permet de spécifier des options supplémentaires telles que le mot de passe ou lURI de base lorsque charge un document dans unDocument objet.
type: docs
weight: 3660
