...
description: Aspose.Words.Loading.TxtLoadOptions classe. Permet de spécifier des options supplémentaires lors du chargementText document dans unDocument objet.
type: docs
weight: 3530
