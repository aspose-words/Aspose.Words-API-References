...
description: NodeRendererBase GetBoundsInPixels méthode. Calcule les limites de la forme en pixels pour un facteur de zoom et une résolution spécifiés en C#.
type: docs
weight: 40
