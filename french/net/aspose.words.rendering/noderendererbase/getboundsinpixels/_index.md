...
description: Découvrez la méthode NodeRendererBase GetBoundsInPixels pour calculer avec précision les dimensions de la forme en pixels en fonction du zoom et de la résolution pour une précision améliorée.
type: docs
weight: 40
