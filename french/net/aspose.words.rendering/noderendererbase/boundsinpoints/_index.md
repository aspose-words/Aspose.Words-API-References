...
description: Découvrez la propriété NodeRendererBase BoundsInPoints pour accéder à des dimensions de forme précises en points, améliorant ainsi la précision et l'efficacité de votre conception.
type: docs
weight: 10
...
Cette propriété renvoie la boîte englobante réelle (telle que rendue sur la page) de la forme. Les limites prennent en compte la rotation de la forme (le cas échéant).
