...
description: Obtient lePaperSource objet adapté à limpression la page représentée par cePageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
Obtient lePaperSource objet adapté à l'impression la page représentée par ce[`PageInfo`](../../pageinfo) .
