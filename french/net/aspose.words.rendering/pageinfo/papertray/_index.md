...
description: Découvrez la propriété PageInfo PaperTray pour accéder au bac à papier spécifique à votre document. Améliorez vos performances d'impression grâce à des solutions sur mesure !
type: docs
weight: 50
...
Obtient le bac à papier (bin) pour cette page comme spécifié dans le document. La valeur est spécifique à l'implémentation (imprimante).
