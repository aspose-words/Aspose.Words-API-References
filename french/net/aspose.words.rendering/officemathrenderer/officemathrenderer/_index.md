...
description: Créez facilement des affichages mathématiques dynamiques avec le constructeur OfficeMathRenderer. Améliorez vos documents grâce à un rendu mathématique fluide !
type: docs
weight: 10
...
| --- | --- | --- |
| math | OfficeMath | Le[`OfficeMath`](../../../aspose.words.math/officemath/) objet que vous souhaitez restituer. |
