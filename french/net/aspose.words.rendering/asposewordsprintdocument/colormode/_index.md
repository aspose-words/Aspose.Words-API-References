...
description: AsposeWordsPrintDocument ColorMode propriété. Obtient ou définit la façon dont les pages non colorées sont imprimées si le périphérique prend en charge limpression couleur en C#.
type: docs
weight: 20
