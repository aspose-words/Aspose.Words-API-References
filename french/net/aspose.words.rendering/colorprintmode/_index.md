...
description: Aspose.Words.Rendering.ColorPrintMode énumération. Spécifie la façon dont les pages non colorées sont imprimées si le périphérique prend en charge limpression couleur en C#.
type: docs
weight: 4540
