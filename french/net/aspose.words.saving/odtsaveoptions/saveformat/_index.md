...
description: OdtSaveOptions propriété. Spécifie le format dans lequel le document sera enregistré si cet objet doptions denregistrement est utilisé. Peut êtreOdt ouOtt .
type: docs
weight: 50
