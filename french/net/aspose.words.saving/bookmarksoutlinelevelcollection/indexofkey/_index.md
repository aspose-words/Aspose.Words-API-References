...
description: Découvrez la méthode BookmarksOutlineLevelCollection IndexOfKey, qui récupère efficacement l'index de base zéro d'un signet spécifié dans votre collection.
type: docs
weight: 80
