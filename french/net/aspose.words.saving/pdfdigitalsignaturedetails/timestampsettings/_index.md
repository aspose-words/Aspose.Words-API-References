...
description: Découvrez la propriété PdfDigitalSignatureDetails TimestampSettings pour gérer facilement les horodatages de signature numérique pour une sécurité et une conformité améliorées des documents.
type: docs
weight: 70
...
La valeur par défaut est`nul` et la signature numérique ne sera pas horodatée. Lorsque cette propriété est définie sur une valeur valide[`PdfDigitalSignatureTimestampSettings`](../../pdfdigitalsignaturetimestampsettings/) objet, alors la signature numérique dans le document PDF sera horodatée.
