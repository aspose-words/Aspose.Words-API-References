...
description: Découvrez la méthode iFontSavingCallback dans Aspose.Words, conçue pour optimiser l'économie de ressources de police pour des performances de document améliorées.
type: docs
weight: 10
...
Appelé lorsque Aspose.Words est sur le point d'enregistrer une ressource de police.
