...
description: Flag indique si les règles CSS fontface doivent être placées dans un fichier séparé fontFaces.css lorsquun document est enregistré avec une feuille de style externe cestàdire lorsqueExportEmbeddedCssaspose.words.saving/htmlfixedsaveoptions/exportembeddedcss/ estfaux . La valeur par défaut estfaux  toutes les règles CSS sont écrites dans un seul fichier styles.css.
type: docs
weight: 160
