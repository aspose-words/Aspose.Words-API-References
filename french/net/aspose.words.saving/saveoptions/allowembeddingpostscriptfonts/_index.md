...
description: Obtient ou définit une valeur booléenne indiquant sil faut autoriser lincorporation de polices avec contours PostScript lors de lincorporation de polices TrueType dans un document lors de son enregistrement. La valeur par défaut est faux .
type: docs
weight: 20
