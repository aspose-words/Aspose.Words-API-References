...
description: Obtient ou définit la valeur déterminant si loptimisation de la mémoire doit être effectuée avant denregistrer le document. La valeur par défaut de cette propriété est faux .
type: docs
weight: 110
