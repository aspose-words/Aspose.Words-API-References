...
Cette propriété est utilisée lorsque le document est exporté aux formats suivants : Tiff ,Png ,Bmp , Jpeg ,Emf . Lorsque le document est exporté vers le Html ,Mhtml etEpub formats cette option est utilisée pour les images raster.
