...
description: Découvrez la classe Aspose.Words.Saving.SaveOptions, la clé pour personnaliser l'enregistrement de vos documents grâce à des options avancées pour différents formats. Optimisez votre flux de travail dès aujourd'hui !
type: docs
weight: 6380
...
Une instance de la`SaveOptions` la classe ou toute classe dérivée est transmise au flux[`Save`](../../aspose.words/document/save/) ou chaîne[`Save`](../../aspose.words/document/save/) surcharges permettant à l'utilisateur de définir des options personnalisées lors de l'enregistrement d'un document.
