...
description: Aspose.Words.Saving.TxtSaveOptionsBase classe. La classe de base pour spécifier des options supplémentaires lors de lenregistrement dun document dans un format texte.
type: docs
weight: 5670
