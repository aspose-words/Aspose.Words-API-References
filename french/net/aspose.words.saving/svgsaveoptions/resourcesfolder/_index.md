...
description: Spécifie le dossier physique dans lequel les ressources images sont enregistrées lors de lexportation dun document au format Svg. La valeur par défaut estnul .
type: docs
weight: 50
