...
description: SvgSaveOptions propriété. Spécifie le nom du dossier utilisé pour construire les URI dimage écrites dans un document SVG. La valeur par défaut estnul .
type: docs
weight: 60
