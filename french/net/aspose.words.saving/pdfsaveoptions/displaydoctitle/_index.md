...
Un indicateur spécifiant si la barre de titre de la fenêtre doit afficher le titre du document tiré de l'entrée Titre du dictionnaire d'informations sur le document.
...
Cet indicateur est requis par la conformité PDF/UA.`vrai` La valeur sera utilisée automatiquement lors de l'enregistrement de au format PDF/UA.
