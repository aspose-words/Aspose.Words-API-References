...
description: PdfSaveOptions propriété. Un indicateur spécifiant si la barre de titre de la fenêtre doit afficher le titre du document extrait de lentrée Titre du dictionnaire dinformations sur le document.
type: docs
weight: 70
