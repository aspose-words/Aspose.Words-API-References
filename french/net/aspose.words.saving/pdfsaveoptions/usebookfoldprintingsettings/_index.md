...
description: PdfSaveOptions UseBookFoldPrintingSettings propriété. Obtient ou définit une valeur booléenne indiquant si le document doit être enregistré à laide dune mise en page dimpression en livret sil est spécifié viaMultiplePages  en C#.
type: docs
weight: 300
