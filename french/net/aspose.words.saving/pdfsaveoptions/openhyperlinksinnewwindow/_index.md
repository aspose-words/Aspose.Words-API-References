...
description: PdfSaveOptions propriété. Obtient ou définit une valeur déterminant si les hyperliens dans le document PDF de sortie sont forcés à souvrir dans une nouvelle fenêtre ou onglet dun navigateur.
type: docs
weight: 200
