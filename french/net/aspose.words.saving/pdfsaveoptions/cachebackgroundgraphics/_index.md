...
description: PdfSaveOptions propriété. Obtient ou définit une valeur déterminant sil faut ou non mettre en cache les graphiques placés en arrièreplan du document.
type: docs
weight: 30
