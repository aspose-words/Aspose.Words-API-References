...
description: MarkdownSaveOptions propriété. Permet de contrôler la manière dont les images sont enregistrées lorsquun document est enregistré dans Markdown format.
type: docs
weight: 30
