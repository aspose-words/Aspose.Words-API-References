...
description: Découvrez la propriété SaveFormat de XpsSaveOptions, qui définit le mode d'enregistrement de votre document. Assurez un format XPS optimal pour une gestion fluide des documents !
type: docs
weight: 40
