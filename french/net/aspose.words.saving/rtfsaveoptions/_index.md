...
description: Aspose.Words.Saving.RtfSaveOptions classe. Peut être utilisé pour spécifier des options supplémentaires lors de lenregistrement dun document dans leRtf format en C#.
type: docs
weight: 5570
