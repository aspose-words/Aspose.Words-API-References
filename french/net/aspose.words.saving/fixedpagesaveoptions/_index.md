...
description: Aspose.Words.Saving.FixedPageSaveOptions classe. Contient les options courantes qui peuvent être spécifiées lors de lenregistrement dun document dans des formats de page fixes PDF XPS images etc en C#.
type: docs
weight: 5020
