...
description: Aspose.Words.Saving.FixedPageSaveOptions classe. Contient des options communes qui peuvent être spécifiées lors de lenregistrement dun document dans des formats de page fixes PDF XPS images etc..
type: docs
weight: 4760
