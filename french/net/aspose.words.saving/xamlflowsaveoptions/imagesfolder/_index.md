...
description: Spécifie le dossier physique dans lequel les images sont enregistrées lors de lexportation dun document au format XAML. La valeur par défaut est une chaîne vide.
type: docs
weight: 30
