...
description: XamlFlowSaveOptions propriété. Permet de contrôler la manière dont les images sont enregistrées lorsquun document est enregistré au format XAML.
type: docs
weight: 20
