...
description: XamlFlowSaveOptions propriété. Permet de contrôler la manière dont les images sont enregistrées lorsquun document est enregistré en XAML.
type: docs
weight: 20
...
Permet de contrôler la manière dont les images sont enregistrées lorsqu'un document est enregistré en XAML.
