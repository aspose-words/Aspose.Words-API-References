...
description: PdfEncryptionDetails Permissions propriété. Spécifie les opérations autorisées à un utilisateur sur un document PDF crypté. La valeur par défaut estDisallowAll  en C#.
type: docs
weight: 30
