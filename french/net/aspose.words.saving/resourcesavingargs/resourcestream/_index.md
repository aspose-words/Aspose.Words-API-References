...
description: ResourceSavingArgs propriété. Permet de spécifier le flux dans lequel la ressource sera enregistrée.
type: docs
weight: 50
...
Permet de spécifier le flux dans lequel la ressource sera enregistrée.
