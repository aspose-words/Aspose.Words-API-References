...
description: Quandfaux  les petits métafichiers ne sont pas compressés pour des raisons de performances. La valeur par défaut est vrai  tous les métafichiers sont compressés quelle que soit leur taille.
type: docs
weight: 20
