...
description: Aspose.Words.Saving.XamlFixedSaveOptions classe. Peut être utilisé pour spécifier des options supplémentaires lors de lenregistrement dun document dans leXamlFixed format en C#.
type: docs
weight: 5690
