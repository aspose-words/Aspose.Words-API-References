...
description: XamlFixedSaveOptions propriété. Permet de contrôler la manière dont les ressources images et polices sont enregistrées lorsquun document est exporté au format Xaml à page fixe.
type: docs
weight: 20
