...
description: Spécifie le dossier physique dans lequel les ressources images et polices sont enregistrées lors de lexportation dun document au format Xaml à page fixe. La valeur par défaut estnul .
type: docs
weight: 30
