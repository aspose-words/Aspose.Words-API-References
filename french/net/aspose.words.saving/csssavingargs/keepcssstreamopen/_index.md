...
description: Découvrez la propriété KeepCssStreamOpen dans CssSavingArgs. Contrôlez le comportement du flux d'Aspose.Words pour une sauvegarde CSS efficace et des performances améliorées.
type: docs
weight: 40
url: /fr/net/aspose.words.saving/csssavingargs/keepcssstreamopen/
---
## CssSavingArgs.KeepCssStreamOpen property

Spécifie si Aspose.Words doit garder le flux ouvert ou le fermer après avoir enregistré une information CSS.
...
La valeur par défaut est`FAUX` et Aspose.Words fermera le flux que vous avez fourni dans le[`CssStream`](../cssstream/) propriété après avoir écrit une information CSS dedans. Spécifier`vrai` pour garder le ruisseau ouvert.
