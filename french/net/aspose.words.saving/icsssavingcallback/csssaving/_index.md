...
description: ICssSavingCallback méthode. Appelé quand Aspose.Words enregistre un CSS Cascading Style Sheet.
type: docs
weight: 10
...
Appelé quand Aspose.Words enregistre un CSS (Cascading Style Sheet).
