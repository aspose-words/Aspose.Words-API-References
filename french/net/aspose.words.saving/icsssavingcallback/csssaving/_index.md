...
description: Découvrez la méthode ICssSavingCallback CssSaving dans Aspose.Words, améliorant votre gestion CSS pour une meilleure efficacité de conception Web.
type: docs
weight: 10
...
Appelé lorsque Aspose.Words enregistre une feuille de style CSS (Cascading Style Sheet).
