...
description: Implémentez cette interface si vous souhaitez contrôler la manière dont Aspose.Words enregistre le CSS feuille de style en cascade lors de lenregistrement dun document au format HTML.
type: docs
weight: 4870
