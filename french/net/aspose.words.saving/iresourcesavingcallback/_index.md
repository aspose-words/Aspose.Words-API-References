...
description: Implémentez cette interface si vous souhaitez contrôler la façon dont Aspose.Words enregistre les ressources externes images polices et css lors de lenregistrement dun document en HTML ou SVG à page fixe.
type: docs
weight: 4930
