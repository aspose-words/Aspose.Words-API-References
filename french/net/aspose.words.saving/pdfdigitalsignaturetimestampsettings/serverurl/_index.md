...
description: Découvrez la propriété ServerUrl de PdfDigitalSignatureTimestampSettings pour un horodatage sécurisé. Assurez l'intégrité de vos documents grâce à des URL de serveur d'horodatage fiables.
type: docs
weight: 30
