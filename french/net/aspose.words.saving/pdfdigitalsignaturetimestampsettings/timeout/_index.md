...
description: Optimisez votre signature numérique PDF avec des paramètres de délai d'expiration personnalisables pour un accès fluide aux serveurs d'horodatage. Améliorez votre sécurité et votre efficacité dès aujourd'hui !
type: docs
weight: 40
...
Valeur du délai d'attente pour accéder au serveur d'horodatage.
