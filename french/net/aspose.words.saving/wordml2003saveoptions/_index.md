...
description: Aspose.Words.Saving.WordML2003SaveOptions classe. Peut être utilisé pour spécifier des options supplémentaires lors de lenregistrement dun document dans leWordML format en C#.
type: docs
weight: 5680
...
| override [SaveFormat](../../aspose.words.saving/wordml2003saveoptions/saveformat/) { get; set; } | Spécifie le format dans lequel le document sera enregistré si cet objet d'options de sauvegarde est utilisé. Ne peut êtreWordML . |
...
// Définit l'indicateur "MemoryOptimization" sur "true" pour diminuer la consommation de mémoire
