...
description: Découvrez la propriété DocumentPartSavingArgs pour accéder et gérer l'objet document pendant le processus d'enregistrement, améliorant ainsi l'efficacité de votre flux de travail.
type: docs
weight: 10
