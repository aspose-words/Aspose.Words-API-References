...
description: Contrôlez l'enregistrement de vos documents avec Aspose.Words.Saving.IDocumentPartSavingCallback. Recevez des notifications et personnalisez facilement vos exportations au format HTML ou EPUB.
type: docs
weight: 5890
...
Implémentez cette interface si vous souhaitez recevoir des notifications et contrôler comment Aspose.Words enregistre les parties du document lors de l'exportation d'un document versHtml ouEpub format.
...
| Nom | La description |
| --- | --- |
| [DocumentPartSaving](../../aspose.words.saving/idocumentpartsavingcallback/documentpartsaving/)(*[DocumentPartSavingArgs](../documentpartsavingargs/)*) | Appelé lorsque Aspose.Words est sur le point d'enregistrer une partie du document. |
