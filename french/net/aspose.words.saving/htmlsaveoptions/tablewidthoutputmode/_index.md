...
description: Contrôle la manière dont les largeurs de tableau de ligne et de cellule sont exportées vers HTML MHTML ou EPUB. La valeur par défaut estAll .
type: docs
weight: 460
