...
description: Contrôlez l'enregistrement des parties de documents avec DocumentPartSavingCallback de HtmlSaveOptions. Optimisez vos exportations HTML ou EPUB pour une expérience utilisateur fluide.
type: docs
weight: 70
