...
description: Spécifie sil faut écrire les numéros de page dans la table des matières lors de lenregistrement HTML MHTML et EPUB. La valeur par défaut estfaux .
type: docs
weight: 280
