...
description: Spécifie comment les en-têtes et pieds de page sont sortis en HTML MHTML ou EPUB. La valeur par défaut estPerSection pour HTML/MHTML etNone pour EPUB.
type: docs
weight: 170
