...
description: Découvrez comment la propriété HtmlSaveOptions ExportHeadersFootersMode optimise la sortie des en-têtes et pieds de page pour les formats HTML, MHTML et EPUB. Optimisez la présentation de votre document !
type: docs
weight: 160
...
Il est difficile de générer de manière significative des en-têtes et des pieds de page au format HTML, car le HTML n'est pas paginé.
...
Quand c'est le casFirstSectionHeaderLastSectionFooter seuls le premier en-tête principal et le dernier pied de page principal (y compris ceux liés au précédent) sont exportés.
