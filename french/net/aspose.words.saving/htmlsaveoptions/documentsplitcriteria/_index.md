...
description: Spécifie comment le document doit être divisé lors de lenregistrement dansHtml ouEpub format. La valeur par défaut estNone pour HTML et HeadingParagraph pour EPUB.
type: docs
weight: 80
