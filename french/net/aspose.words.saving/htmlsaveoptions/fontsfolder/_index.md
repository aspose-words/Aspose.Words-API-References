...
description: Spécifie le dossier physique dans lequel les polices sont enregistrées lors de lexportation dun document au format HTML. La valeur par défaut est une chaîne vide.
type: docs
weight: 320
