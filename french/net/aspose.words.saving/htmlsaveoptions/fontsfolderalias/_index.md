...
description: Spécifie le nom du dossier utilisé pour construire les URI des polices écrites dans un document HTML. La valeur par défaut est une chaîne vide.
type: docs
weight: 330
