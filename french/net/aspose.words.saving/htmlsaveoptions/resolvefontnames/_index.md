...
description: Spécifie si les noms de famille de polices utilisés dans le document sont résolus et remplacés selon FontSettingsaspose.words/document/fontsettings/ lors de lécriture dans des formats basés sur HTML.
type: docs
weight: 410
