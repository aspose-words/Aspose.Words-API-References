...
description: HtmlSaveOptions propriété. Permet de contrôler la façon dont les images sont enregistrées lorsquun document est enregistré au format HTML MHTML ou EPUB.
type: docs
weight: 350
