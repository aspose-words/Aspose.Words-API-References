...
description: Contrôlez l'enregistrement des images avec ImageSavingCallback de HtmlSaveOptions. Optimisez l'exportation de vos documents au format HTML, MHTML ou EPUB pour une expérience utilisateur fluide.
type: docs
weight: 350
url: /fr/net/aspose.words.saving/htmlsaveoptions/imagesavingcallback/
---
## HtmlSaveOptions.ImageSavingCallback property

Permet de contrôler la manière dont les images sont enregistrées lorsqu'un document est enregistré au format HTML, MHTML ou EPUB.
