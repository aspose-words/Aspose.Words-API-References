...
description: Spécifie un dossier physique dans lequel toutes les ressources telles que les images les polices et les CSS externes sont enregistrées lorsquun document est exporté au format HTML. La valeur par défaut est une chaîne vide.
type: docs
weight: 420
