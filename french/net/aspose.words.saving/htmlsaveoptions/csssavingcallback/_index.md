...
description: HtmlSaveOptions propriété. Permet de contrôler la manière dont les styles CSS sont enregistrés lorsquun document est enregistré au format HTML MHTML ou EPUB.
type: docs
weight: 40
