...
description: HtmlSaveOptions propriété. Permet de contrôler la façon dont les styles CSS sont enregistrés lorsquun document est enregistré au format HTML MHTML ou EPUB.
type: docs
weight: 40
