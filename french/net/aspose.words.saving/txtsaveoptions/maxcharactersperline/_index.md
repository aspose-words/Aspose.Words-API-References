...
Obtient ou définit une valeur entière qui spécifie le nombre maximum de caractères par ligne. La valeur par défaut est 0, ce qui signifie aucune limite.
...
// Définit 30 caractères comme maximum autorisé par ligne.
