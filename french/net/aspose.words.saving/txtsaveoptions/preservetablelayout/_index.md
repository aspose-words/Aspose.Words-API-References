...
description: Spécifie si le programme doit tenter de préserver la mise en page des tableaux lors de lenregistrement au format texte brut. La valeur par défaut est faux .
type: docs
weight: 50
