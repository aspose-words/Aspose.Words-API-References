...
description: Peut être utilisé pour spécifier des options supplémentaires lors de lenregistrement dun document dans leDocx  Docm Dotx Dotm ou FlatOpc format.
type: docs
weight: 5070
