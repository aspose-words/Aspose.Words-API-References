...
description: RevisionOptions propriété. Permet de spécifier si le texte de révision doit être marqué avec un balisage de formatage spécial. La valeur par défaut est True.
type: docs
weight: 190
...
Permet de spécifier si le texte de révision doit être marqué avec un balisage de formatage spécial. La valeur par défaut est True.
