...
description: Permet de spécifier la couleur à utiliser pour le contenu avec des changements de propriétés de formatageFormatChange La valeur par défaut estNoHighlight .
type: docs
weight: 110
