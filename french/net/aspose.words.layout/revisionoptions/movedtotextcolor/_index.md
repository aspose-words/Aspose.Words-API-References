...
description: RevisionOptions MovedToTextColor propriété. Permet de spécifier la couleur à utiliser pour les zones vers lesquelles le contenu a été déplacéMoving . La valeur par défaut estByAuthor  en C#.
type: docs
weight: 90
