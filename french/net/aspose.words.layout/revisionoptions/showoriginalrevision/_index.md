...
description: RevisionOptions propriété. Permet de spécifier si le texte original doit être affiché au lieu du texte révisé. La valeur par défaut est False.
type: docs
weight: 170
