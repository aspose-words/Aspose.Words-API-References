...
description: Découvrez la propriété DeletedTextEffect dans RevisionOptions. Personnalisez l'apparence du contenu supprimé avec des effets comme StrikeThrough pour une meilleure clarté.
type: docs
weight: 40
...
Permet de spécifier l'effet à appliquer au contenu suppriméDeletion . La valeur par défaut estStrikeThrough
