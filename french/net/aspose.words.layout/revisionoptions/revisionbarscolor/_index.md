...
description: RevisionOptions propriété. Permet de spécifier la couleur à utiliser pour les barres latérales qui identifient les lignes de document contenant des informations révisées. La valeur par défaut estRed .
type: docs
weight: 130
...
Permet de spécifier la couleur à utiliser pour les barres latérales qui identifient les lignes de document contenant des informations révisées. La valeur par défaut estRed .
