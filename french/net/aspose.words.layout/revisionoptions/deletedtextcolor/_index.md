...
description: Personnalisez vos options de révision avec la propriété DeletedTextColor pour mettre en évidence le contenu supprimé. La valeur par défaut est ByAuthor. Améliorez la clarté de votre document !
type: docs
weight: 30
...
Permet de spécifier la couleur à utiliser pour le contenu suppriméDeletion . La valeur par défaut estByAuthor .
