...
description: LayoutOptions propriété. Obtient ou définit une indication indiquant si loption de compatibilité Utiliser les mesures de limprimante pour mettre en page le document est ignorée. La valeur par défaut est True.
type: docs
weight: 50
