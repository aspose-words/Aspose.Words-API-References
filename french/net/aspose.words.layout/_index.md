...
| [RevisionOptions](./revisionoptions/) | Permet de contrôler la façon dont les révisions du document sont gérées pendant le processus de mise en page. |
## Interfaces
...
| --- | --- |
| [CommentDisplayMode](./commentdisplaymode/) | Spécifie le mode de rendu des commentaires du document. |
...
| [LayoutEntityType](./layoutentitytype/) | Types d'entités de mise en page. |
