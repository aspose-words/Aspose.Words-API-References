...
| HeaderFooter | `400` | Représente un espace réservé pour le contenu de l'en-tête/pied de page d'une page. HeaderFooter peut avoirLine etRow entités enfants. |
| TextBox | `800` | Représente une zone de texte à l'intérieur d'une forme. La zone de texte peut avoirLine etRow entités enfants. |
