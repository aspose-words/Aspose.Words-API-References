...
description: Découvrez la propriété Kind de LayoutEnumerator, qui identifie le type d'entité actuel. Assurez la clarté de vos données grâce à cette fonctionnalité essentielle.
type: docs
weight: 50
...
Récupère le type de l'entité courante. Il peut s'agir d'une chaîne vide, mais jamais`nul` .
...
Il s'agit d'un type plus spécifique de l'entité actuelle, par exemple, l'étendue du signet aSpan le type and peut avoir un type BOOKMARKSTART ou BOOKMARKEND.
