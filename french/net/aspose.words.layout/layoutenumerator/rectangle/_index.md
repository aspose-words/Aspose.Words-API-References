...
description: Découvrez la propriété Rectangle de LayoutEnumerator. Obtenez des rectangles de délimitation précis des entités par rapport au coin supérieur gauche de la page, en points.
type: docs
weight: 70
url: /fr/net/aspose.words.layout/layoutenumerator/rectangle/
---
## LayoutEnumerator.Rectangle property

Renvoie le rectangle de délimitation de l'entité actuelle par rapport au coin supérieur gauche de la page (en points).
