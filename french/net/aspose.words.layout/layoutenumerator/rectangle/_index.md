...
description: LayoutEnumerator propriété. Renvoie le rectangle de délimitation de lentité courante par rapport au coin supérieur gauche de la page en points.
type: docs
weight: 60
...
Renvoie le rectangle de délimitation de l'entité courante par rapport au coin supérieur gauche de la page (en points).
