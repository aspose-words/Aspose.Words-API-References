...
description: Découvrez la méthode MoveNext de LayoutEnumerator pour naviguer visuellement entre les entités sœurs. Parcourez efficacement les lignes de paragraphe sans traverser les pages.
type: docs
weight: 120
...
Passe à l'entité sœur suivante dans l'ordre visuel. Lors de l'itération des lignes d'un paragraphe réparties sur plusieurs pages, cette méthode ne passera pas à la page suivante mais plutôt à l'entité suivante sur la même page.
