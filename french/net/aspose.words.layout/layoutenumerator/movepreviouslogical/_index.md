...
description: Découvrez la méthode LayoutEnumerator MovePreviousLogical pour naviguer efficacement dans les entités sœurs et gérer les lignes de paragraphe sur plusieurs pages de manière transparente.
type: docs
weight: 160
...
Passe à l'entité sœur précédente dans un ordre logique. Lors de l'itération des lignes d'un paragraphe réparties sur plusieurs pages, cette méthode passera à la ligne précédente même si elle réside sur une autre page.
