...
description: Découvrez le constructeur LayoutEnumerator, créez facilement de nouvelles instances de cette classe pour une gestion efficace de la mise en page dans vos applications.
type: docs
weight: 10
...
| --- | --- | --- |
| document | Document | Un document dont le modèle de mise en page est à énumérer. |

## Remarques

Si le modèle de mise en page du document n'a pas été construit, l'énumérateur appelle[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) pour le construire.

Chaque fois qu'un document est mis à jour et qu'un nouveau modèle de mise en page est créé, un nouvel énumérateur doit être utilisé pour y accéder.
