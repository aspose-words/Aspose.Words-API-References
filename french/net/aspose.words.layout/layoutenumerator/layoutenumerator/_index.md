...
description: LayoutEnumerator constructeur. Initialise la nouvelle instance de cette classe.
type: docs
weight: 10
...
Initialise la nouvelle instance de cette classe.
...
| --- | --- | --- |
| document | Document | Document dont le modèle de mise en page doit être énuméré. |

### Remarques

Si le modèle de mise en page du document n'a pas été créé, l'énumérateur appelle[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) pour le construire.
