...
description: Passe à lentité sœur suivante dans un ordre logique. Lors de litération des lignes dun paragraphe sur plusieurs pages cette méthode passera à la ligne suivante même si elle réside sur une autre page.
type: docs
weight: 120
