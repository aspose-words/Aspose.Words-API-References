...
description: Découvrez comment la méthode MoveNextLogical de LayoutEnumerator navigue de manière transparente entre les entités sœurs, garantissant une itération fluide des lignes de paragraphe sur les pages.
type: docs
weight: 130
...
Passe à l'entité sœur suivante dans un ordre logique. Lors de l'itération des lignes d'un paragraphe réparties sur plusieurs pages, cette méthode passera à la ligne suivante même si elle réside sur une autre page.
...
Notez que tousSpan les entités sont liées entre elles donc si[`Current`](../current/) L'entité est un appel répété de cette méthode qui parcourra l'histoire complète du document.
