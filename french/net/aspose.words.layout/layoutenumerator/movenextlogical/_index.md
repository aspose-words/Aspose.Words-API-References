...
description: LayoutEnumerator méthode. Passe à lentité sœur suivante dans un ordre logique. Lors de litération des lignes dun paragraphe sur plusieurs pages cette méthode passera à la ligne suivante même si elle réside sur une autre page.
type: docs
weight: 120
...
Passe à l'entité sœur suivante dans un ordre logique. Lors de l'itération des lignes d'un paragraphe sur plusieurs pages, cette méthode passera à la ligne suivante même si elle réside sur une autre page.
...
Notez que tousSpan les entités sont liées entre elles donc si[`Current`](../current/) l'entité est étendue, l'appel répété de cette méthode itérera l'histoire complète du document.
