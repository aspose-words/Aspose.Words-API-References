...
description: Découvrez la propriété Texte de LayoutEnumerator pour récupérer facilement le texte de l'entité span actuelle. Simplifiez la gestion de vos données grâce à cette fonctionnalité puissante !
type: docs
weight: 80
...
Récupère le texte de l'entité span actuelle. Lève la requête pour les autres types d'entités.
