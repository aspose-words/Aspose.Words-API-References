...
description: LayoutEnumerator propriété. Obtient le texte de lentité span actuelle. Jette pour dautres types dentités.
type: docs
weight: 70
...
Obtient le texte de l'entité span actuelle. Jette pour d'autres types d'entités.
