...
description: Réinitialisez le LayoutEnumerator sur la première page du document, améliorant ainsi la navigation et l'efficacité pour une gestion transparente des documents.
type: docs
weight: 170
url: /fr/net/aspose.words.layout/layoutenumerator/reset/
---
## LayoutEnumerator.Reset method

Déplace l'énumérateur vers la première page du document.
