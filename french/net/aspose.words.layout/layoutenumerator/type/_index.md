...
description: Découvrez la propriété Type LayoutEnumerator, accédez facilement au type de l'entité actuelle pour une gestion simplifiée des données et des performances d'application améliorées.
type: docs
weight: 90
