...
description: LayoutCollector méthode. Obtient lindex de base 1 de la page où commence le nœud. Renvoie 0 si le nœud ne peut pas être mappé sur une page.
type: docs
weight: 70
...
Obtient l'index de base 1 de la page où commence le nœud. Renvoie 0 si le nœud ne peut pas être mappé sur une page.
