...
description: Découvrez la méthode GetStartPageIndex de LayoutCollector pour trouver facilement l'index de base 1 de la page de démarrage d'un nœud. Simplifiez votre processus de mappage dès aujourd'hui !
type: docs
weight: 70
...
Obtient l'index de base 1 de la page où commence le nœud. Renvoie 0 si le nœud ne peut être mappé à une page.
