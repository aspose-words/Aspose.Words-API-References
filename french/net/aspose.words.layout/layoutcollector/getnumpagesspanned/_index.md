...
description: Obtient le nombre de pages que le nœud spécifié sétend. 0 si le nœud se trouve dans une seule page. Cest la même chose queGetEndPageIndexaspose.words.layout/layoutcollector/getendpageindex/ GetStartPageIndexaspose.words.layout/layoutcollector/getstartpageindex/ .
type: docs
weight: 60
