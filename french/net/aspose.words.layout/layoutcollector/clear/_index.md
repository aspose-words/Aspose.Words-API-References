...
description: LayoutCollector méthode. Efface toutes les données de mise en page collectées. Appelez cette méthode après la mise à jour manuelle du document ou la reconstruction de la mise en page.
type: docs
weight: 30
