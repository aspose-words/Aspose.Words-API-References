...
description: Découvrez comment la propriété CompareOptions IgnoreTables améliore l'analyse des données en contrôlant la comparaison des données des tables pour des informations précises.
type: docs
weight: 110
