...
description: Découvrez comment la propriété IgnoreFormatting de CompareOptions améliore le traitement du texte en ignorant la mise en forme pour une comparaison de données plus efficace.
type: docs
weight: 90
...
True indique que le formatage est ignoré.
