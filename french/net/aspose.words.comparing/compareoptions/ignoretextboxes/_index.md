...
description: Spécifie sil faut comparer les différences dans les données contenues dans les zones de texte. Par défaut les zones de texte ne sont pas ignorées.
type: docs
weight: 110
