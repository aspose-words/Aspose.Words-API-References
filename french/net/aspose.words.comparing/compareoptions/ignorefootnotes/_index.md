...
description: Spécifie sil faut comparer les différences dans les notes de bas de page et les notes de fin. Par défaut les notes de bas de page ne sont pas ignorées.
type: docs
weight: 70
