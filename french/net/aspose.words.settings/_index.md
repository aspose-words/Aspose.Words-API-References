...
| [ViewOptions](./viewoptions/) | Fournit diverses options qui contrôlent la façon dont un document est affiché dans Microsoft Word. |
...
| [JustificationMode](./justificationmode/) | Spécifie l'ajustement de l'espacement des caractères pour un document. La valeur par défaut est`Développer` . |
