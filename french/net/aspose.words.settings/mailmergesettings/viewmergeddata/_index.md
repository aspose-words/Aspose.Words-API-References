...
description: MailMergeSettings propriété. Spécifie que Microsoft Word doit afficher les données de la source de données externe spécifiée où les champs de fusion ont été insérés par exemple prévisualiser les données fusionnées. La valeur par défaut estfaux .
type: docs
weight: 170
