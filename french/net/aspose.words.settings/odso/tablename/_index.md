...
description: Spécifie lensemble de données particulier auquel une source doit être connectée au sein dune source de données externe. La valeur par défaut est une chaîne vide.
type: docs
weight: 80
