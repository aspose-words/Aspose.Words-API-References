...
description: Gérez votre publipostage en toute simplicité avec Odso RecipientDatas. Contrôlez l'inclusion/exclusion d'enregistrements grâce à une collection fiable et toujours disponible.
type: docs
weight: 70
...
Obtient ou définit une collection d'objets qui spécifient l'inclusion/l'exclusion d'enregistrements individuels dans le publipostage. Cet objet n'est jamais`nul` .
