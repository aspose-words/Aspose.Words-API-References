...
description: Odso propriété. Spécifie le caractère qui doit être interprété comme le délimiteur de colonne utilisé pour séparer les colonnes dans les sources de données externes. La valeur par défaut est 0 ce qui signifie quaucun délimiteur de colonne nest défini.
type: docs
weight: 20
...
RK Je n'ai jamais vu cela en cours d'utilisation.
