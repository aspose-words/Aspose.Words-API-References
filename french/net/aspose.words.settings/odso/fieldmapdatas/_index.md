...
description: Obtient ou définit une collection dobjets qui spécifient comment les colonnes de la source de données externe sont mappées aux noms de champs de fusion prédéfinis dans le document. Cet objet nest jamais null.
type: docs
weight: 50
