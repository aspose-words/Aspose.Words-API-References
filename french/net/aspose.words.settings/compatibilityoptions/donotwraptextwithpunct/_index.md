...
description: Découvrez la propriété DoNotWrapTextWithPunct de CompatibilityOptions pour éviter la ponctuation suspendue dans votre grille de caractères pour des mises en page plus propres et professionnelles.
type: docs
weight: 250
...
Ne pas autoriser la ponctuation suspendue avec la grille de caractères.
