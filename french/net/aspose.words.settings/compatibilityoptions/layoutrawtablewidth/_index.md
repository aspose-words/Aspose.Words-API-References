...
description: Optimisez votre mise en page avec la propriété LayoutRawTableWidth de CompatibilityOptions. Contrôlez l'habillage des tableaux et optimisez la flexibilité de votre conception en toute simplicité !
type: docs
weight: 290
...
Ignorer l'espace avant le tableau pour décider si le tableau doit envelopper un objet flottant.
