...
description: Découvrez comment la propriété CompatibilityOptions TransparentMetafiles améliore vos graphiques en empêchant l'effacement de l'arrière-plan derrière les images de métafichiers.
type: docs
weight: 550
...
Spécifie de ne pas effacer la zone derrière les images du métafichier.
