...
description: Découvrez comment désactiver la fonctionnalité « Ne pas aligner sur la grille » dans les cellules du tableau, améliorant ainsi la mise en page de votre document et le placement des objets pour un meilleur contrôle de la conception.
type: docs
weight: 170
...
Ne pas aligner sur la grille du document dans les cellules de tableau contenant des objets.
