...
description: Optimisez vos impressions grâce à la propriété UsePrinterMetrics de CompatibilityOptions pour un affichage précis des documents. Améliorez les performances et la qualité sans effort !
type: docs
weight: 640
...
Utiliser les métriques de l'imprimante pour afficher les documents.
...
Les paramètres d'impression peuvent varier selon les pilotes utilisés. Par exemple, les pilotes Windows « Microsoft OpenXPS Class Driver 2 » et « Microsoft Print to PDF » fournissent des paramètres légèrement différents. Par conséquent, la mise en page du document final peut changer si cette option est activée.
