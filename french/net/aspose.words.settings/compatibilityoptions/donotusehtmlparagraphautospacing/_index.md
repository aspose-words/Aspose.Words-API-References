...
description: Optimisez votre code HTML avec la propriété DoNotUseHTMLParagraphAutoSpacing de CompatibilityOptions. Assurez un espacement fixe entre les paragraphes pour une mise en page plus nette !
type: docs
weight: 210
...
Utilisez un espacement de paragraphe fixe pour le paramètre automatique HTML.
