...
description: Découvrez la propriété DoNotUseEastAsianBreakRules de CompatibilityOptions pour optimiser les grilles de documents sans compresser les caractères. Améliorez votre mise en forme dès aujourd'hui !
type: docs
weight: 200
...
Ne compressez pas les caractères compressibles lors de l'utilisation de la grille de document.
