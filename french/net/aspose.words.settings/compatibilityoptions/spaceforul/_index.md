...
description: Améliorez votre texte est-asiatique avec CompatibilityOptions SpaceForUL, en ajoutant un espace supplémentaire sous la ligne de base pour une meilleure lisibilité et un meilleur style.
type: docs
weight: 440
...
Ajouter un espace supplémentaire sous la ligne de base pour le texte est-asiatique souligné.
