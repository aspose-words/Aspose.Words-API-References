...
description: Découvrez comment la propriété LayoutTableRowsApart améliore la compatibilité en permettant l'encapsulation indépendante des objets en ligne dans les lignes de tableau pour une meilleure flexibilité de conception.
type: docs
weight: 300
