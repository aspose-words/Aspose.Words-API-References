...
description: Optimisez votre mise en page avec CompatibilityOptions NoExtraLineSpacing. Assurez un alignement précis sans centrer le contenu sur des hauteurs de ligne précises pour un design plus épuré.
type: docs
weight: 340
...
Ne centrez pas le contenu sur les lignes avec une hauteur de ligne exacte.
