...
description: Découvrez comment la propriété CompatibilityOptions WPSpaceWidth vous permet de personnaliser la largeur de l'espace comme dans WordPerfect 5.x pour une mise en forme améliorée des documents.
type: docs
weight: 700
...
Spécifie s'il faut définir la largeur d'un espace comme cela est fait dans WordPerfect 5.x.
