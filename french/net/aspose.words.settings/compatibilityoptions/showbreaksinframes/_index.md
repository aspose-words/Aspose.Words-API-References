...
description: Améliorez la conception de votre site web avec CompatibilityOptions ShowBreaksInFrames. Visualisez facilement les sauts de page et de colonne dans les cadres pour un meilleur contrôle de la mise en page.
type: docs
weight: 430
