...
description: Découvrez comment CompatibilityOptions SuppressTopSpacingWP améliore votre expérience WordPerfect 5.x avec des ajustements d'espacement de ligne transparents pour une mise en forme optimale des documents.
type: docs
weight: 520
...
Émuler l'espacement des lignes de WordPerfect 5.x.
