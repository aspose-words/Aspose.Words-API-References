...
description: Optimisez la mise en forme de vos documents avec la propriété DoNotUseIndentAsNumberingTabStop de CompatibilityOptions. Améliorez la lisibilité en ignorant les retraits négatifs !
type: docs
weight: 220
