...
description: Aspose.Words.Settings.CompatibilityOptions classe. Contient les options de compatibilité cestàdire les préférences utilisateur saisies sur le Compatibilité onglet de la Choix boîte de dialogue dans Microsoft Word.
type: docs
weight: 5490
...
Contient les options de compatibilité (c'est-à-dire les préférences utilisateur saisies sur le **Compatibilité** onglet de la **Choix** boîte de dialogue dans Microsoft Word).
