...
description: Optimisez vos documents avec CompatibilityOptions FootnoteLayoutLikeWW8 pour un placement précis des notes de bas de page, émulant Word 6.x/95/97 pour une mise en forme transparente.
type: docs
weight: 260
...
Émuler le placement des notes de bas de page de Word 6.x/95/97.
