...
description: Découvrez comment la propriété CompatibilityOptions DoNotVertAlignInTxbx améliore la mise en forme de la zone de texte en ignorant l'alignement vertical pour une meilleure flexibilité de conception.
type: docs
weight: 240
