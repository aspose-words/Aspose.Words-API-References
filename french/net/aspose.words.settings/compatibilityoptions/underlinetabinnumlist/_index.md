...
description: Améliorez l'apparence de votre document grâce à la propriété UnderlineTabInNumList de CompatibilityOptions. Soulignez parfaitement les caractères après les listes numérotées pour plus de clarté !
type: docs
weight: 590
