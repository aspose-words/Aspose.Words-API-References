...
description: Optimisez votre affichage avec la propriété DisplayHangulFixedWidth de CompatibilityOptions. Assurez-vous que les caractères Hangul sont cohérents et de largeur fixe pour plus de clarté et de style.
type: docs
weight: 110
url: /fr/net/aspose.words.settings/compatibilityoptions/displayhangulfixedwidth/
---
## CompatibilityOptions.DisplayHangulFixedWidth property

Utilisez toujours une largeur fixe pour les caractères Hangul.
