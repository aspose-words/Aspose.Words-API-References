...
description: Découvrez la propriété NoColumnBalance dans CompatibilityOptions. Contrôlez facilement la mise en page de votre texte en empêchant l'équilibrage des colonnes dans les sections !
type: docs
weight: 330
