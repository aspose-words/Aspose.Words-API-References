...
description: Découvrez la propriété AlignTablesRowByRow pour CompatibilityOptions. Alignez les lignes de tableau indépendamment pour un meilleur contrôle de la mise en page et une plus grande flexibilité de conception.
type: docs
weight: 20
