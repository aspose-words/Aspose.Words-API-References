...
description: Découvrez comment la propriété AutofitToFirstFixedWidthCell améliore les dispositions de tableau en permettant aux colonnes de dépasser les largeurs préférées pour un affichage optimal.
type: docs
weight: 50
...
L'option s'appelle « Utiliser les règles d'ajustement automatique des tableaux Word 2003 » dans l'interface utilisateur de MS Word 2013. Elle affecte également la façon dont la grille est calculée pour les tableaux à disposition fixe (dans certains cas).
