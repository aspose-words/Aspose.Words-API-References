...
description: Découvrez la propriété CompatibilityOptions ShapeLayoutLikeWW8 pour émuler l'habillage de texte de Word 97 pour un formatage de document et un contrôle de mise en page améliorés.
type: docs
weight: 420
...
Émuler l'habillage de texte Word 97 autour d'objets flottants.
