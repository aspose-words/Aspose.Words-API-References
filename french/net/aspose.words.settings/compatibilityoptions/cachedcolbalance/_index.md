...
description: Optimisez votre mise en page avec la propriété CachedColBalance de CompatibilityOptions. Améliorez l'équilibrage des colonnes grâce aux informations de paragraphe mises en cache pour une conception fluide.
type: docs
weight: 80
