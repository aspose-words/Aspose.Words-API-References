...
description: Optimisez la mise en page de votre document avec CompatibilityOptions SuppressSpBfAfterPgBrk. Supprimez les espaces indésirables après les sauts de page pour une mise en forme plus nette.
type: docs
weight: 500
...
N'utilisez pas d'espace avant la première ligne après un saut de page.
