...
description: Découvrez comment la propriété ForgetLastTabAlignment améliore l'alignement des paragraphes en ignorant la largeur du dernier taquet de tabulation pour le texte non aligné à gauche.
type: docs
weight: 270
...
Ignorer la largeur du dernier taquet de tabulation lors de l'alignement du paragraphe s'il n'est pas aligné à gauche.
