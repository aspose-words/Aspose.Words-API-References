...
description: Optimisez votre mise en page avec la propriété CompatibilityOptions SuppressSpacingAtTopOfPage. Contrôlez la hauteur des lignes pour un affichage fluide de la première ligne.
type: docs
weight: 490
...
Ignorer la hauteur de ligne minimale pour la première ligne de la page.
