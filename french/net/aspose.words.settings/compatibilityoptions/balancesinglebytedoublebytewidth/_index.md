...
description: Optimisez l'affichage du texte avec la propriété BalanceSingleByteDoubleByteWidth pour une intégration transparente des caractères à un et deux octets.
type: docs
weight: 70
...
Équilibrer les caractères à un octet et à deux octets.
