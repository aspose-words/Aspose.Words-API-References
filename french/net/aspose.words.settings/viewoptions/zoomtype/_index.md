...
description: Découvrez la propriété ViewOptions ZoomType pour ajuster facilement les niveaux de zoom en fonction de la taille de la fenêtre, améliorant ainsi l'expérience utilisateur et la flexibilité de l'interface.
type: docs
weight: 60
