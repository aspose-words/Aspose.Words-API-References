...
description: Découvrez la classe Aspose.Words.Settings.ViewOptions pour personnaliser l'affichage des documents dans Microsoft Word, améliorant ainsi votre expérience d'édition et votre productivité.
type: docs
weight: 6780
...
Pour en savoir plus, visitez le[Travailler avec les options et l'apparence des documents Word](https://docs.aspose.com/words/net/work-with-word-document-options-and-appearance/) article de documentation.
...
| Nom | La description |
| --- | --- |
| [DisplayBackgroundShape](../../aspose.words.settings/viewoptions/displaybackgroundshape/) { get; set; } | Contrôle l'affichage de la forme d'arrière-plan dans la vue de mise en page d'impression. |
...
| [FormsDesign](../../aspose.words.settings/viewoptions/formsdesign/) { get; set; } | Spécifie si le document est en mode de conception de formulaires. |
| [ViewType](../../aspose.words.settings/viewoptions/viewtype/) { get; set; } | Contrôle le mode d'affichage dans Microsoft Word. |
| [ZoomPercent](../../aspose.words.settings/viewoptions/zoompercent/) { get; set; } | Obtient ou définit le pourcentage auquel vous souhaitez afficher votre document. |
