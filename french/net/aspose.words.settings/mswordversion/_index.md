...
description: Découvrez l'énumération Aspose.Words.Settings.MsWordVersion pour reproduire les comportements de MS Word, améliorant ainsi le traitement et la compatibilité des documents pour des flux de travail transparents.
type: docs
weight: 6690
...
Permet à Aspose.Wods d'imiter le comportement d'une application spécifique à la version MS Word.
...
| --- | --- | --- |
| Word2000 | `0` | Optimiser le comportement d'Aspose.Words pour qu'il corresponde à la version MS Word 2000. |
| Word2002 | `1` | Optimiser le comportement d'Aspose.Words pour qu'il corresponde à la version MS Word 2002. |
| Word2003 | `2` | Optimiser le comportement d'Aspose.Words pour qu'il corresponde à la version MS Word 2003. |
| Word2007 | `3` | Optimiser le comportement d'Aspose.Words pour qu'il corresponde à la version MS Word 2007. |
| Word2010 | `4` | Optimiser le comportement d'Aspose.Words pour qu'il corresponde à la version MS Word 2010. |
| Word2013 | `5` | Optimiser le comportement d'Aspose.Words pour correspondre à la version MS Word 2013. |
| Word2016 | `6` | Optimiser le comportement d'Aspose.Words pour correspondre à la version MS Word 2016. |
| Word2019 | `7` | Optimiser le comportement d'Aspose.Words pour correspondre à la version MS Word 2019. |
