...
Représente le code de hachage de cet enregistrement. Parfois, Microsoft Word utilise`Hash` d'un enregistrement entier au lieu d'un[`UniqueTag`](../uniquetag/) valeur. La valeur par défaut est 0.
