...
description: Spécifie lindex de base zéro de la colonne dans une source de données externe qui doit être mappé au nom local dun champ MERGEFIELD spécifique. La valeur par défaut est 0.
type: docs
weight: 20
