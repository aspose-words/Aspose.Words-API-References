...
description: Spécifie le nom de la colonne dans une source de données externe pour la colonne dont lindex est spécifié par leColumnaspose.words.settings/odsofieldmapdata/column propriété. La valeur par défaut est une chaîne vide.
type: docs
weight: 40
