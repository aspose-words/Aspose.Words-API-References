...
description: Assurez l'intégrité des documents grâce à la propriété IsValid de DigitalSignatureCollection. Elle vérifie que toutes les signatures sont valides et non falsifiées, renforçant ainsi la sécurité.
type: docs
weight: 30
