...
description: Découvrez la propriété DigitalSignature IssuerName, fournissant le nom distinctif de l'émetteur pour une sécurité et une confiance renforcées dans vos certificats numériques.
type: docs
weight: 30
...
Renvoie le nom distinctif du sujet de l'émetteur du certificat.
