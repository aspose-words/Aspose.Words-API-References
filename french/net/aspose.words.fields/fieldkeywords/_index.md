...
description: Aspose.Words.Fields.FieldKeywords classe. Implémente le champ KEYWORDS en C#.
type: docs
weight: 2090
url: /fr/net/aspose.words.fields/fieldkeywords/
---
## FieldKeywords class
...
| [Text](../../aspose.words.fields/fieldkeywords/text/) { get; set; } | Obtient ou définit le texte des mots-clés. |
...
Récupère et définit éventuellement les mots-clés du document, tels qu'enregistrés dans le**Mots clés** propriété des propriétés du document intégré .
