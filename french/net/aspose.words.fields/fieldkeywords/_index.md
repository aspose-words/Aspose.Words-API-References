...
description: Découvrez la classe Aspose.Words.Fields.FieldKeywords pour implémenter efficacement le champ KEYWORDS, améliorant ainsi les métadonnées et la capacité de recherche de votre document.
type: docs
weight: 2500
...
Récupère et définit éventuellement les mots-clés du document, tels qu'enregistrés dans le**Mots-clés** propriété des propriétés de document intégrées .
