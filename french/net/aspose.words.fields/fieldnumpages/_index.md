...
description: Aspose.Words.Fields.FieldNumPages classe. Implémente le champ NUMPAGES.
type: docs
weight: 2070
...
Récupère le nombre de pages du document courant, tel qu'enregistré dans le **pages**propriété des propriétés de document intégrées .
