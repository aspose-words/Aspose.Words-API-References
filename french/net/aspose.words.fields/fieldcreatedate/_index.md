...
description: Découvrez la classe Aspose.Words.Fields.FieldCreateDate pour une gestion documentaire fluide. Implémentez facilement le champ CREATEDATE et optimisez vos flux de travail.
type: docs
weight: 2130
url: /fr/net/aspose.words.fields/fieldcreatedate/
---
## FieldCreateDate class

Implémente le champ CREATEDATE.
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Obtient ou définit s'il faut utiliser le calendrier lunaire hégirien ou lunaire hébreu. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Obtient ou définit s'il faut utiliser le calendrier de l'ère Saka. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldcreatedate/useumalquracalendar/) { get; set; } | Obtient ou définit s'il faut utiliser le calendrier Um-al-Qura. |
...
Récupère la date et l'heure de création du document. Par défaut, le calendrier grégorien est utilisé.
