...
description: Aspose.Words.Fields.FieldCreateDate classe. Implémente le champ CREATEDATE en C#.
type: docs
weight: 1720
...
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Obtient ou définit s'il faut utiliser le calendrier Saka Era. |
...
Récupère la date et l'heure auxquelles le document a été créé. Par défaut, le calendrier grégorien est utilisé.
