...
description: Construit un argument de champ complexe composé de champs de nœuds et de texte brut.
type: docs
weight: 1400
...
| Nom | La description |
| --- | --- |
| [FieldArgumentBuilder](fieldargumentbuilder)() | Initialise une instance du[`FieldArgumentBuilder`](../fieldargumentbuilder) classe. |
