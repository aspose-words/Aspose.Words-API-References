...
description: Découvrez la classe Aspose.Words.Fields.FieldSymbol pour une implémentation efficace du champ SYMBOL, améliorant vos capacités de traitement de documents.
type: docs
weight: 2870
...
| Nom | La description |
| --- | --- |
| [CharacterCode](../../aspose.words.fields/fieldsymbol/charactercode/) { get; set; } | Obtient ou définit la valeur du point de code du caractère en décimal ou en hexadécimal. |
