...
description: Découvrez comment la propriété FieldSymbol DontAffectsLineSpacing contrôle l'impact des caractères sur l'espacement des paragraphes. Optimisez la mise en forme de vos documents dès aujourd'hui !
type: docs
weight: 30
