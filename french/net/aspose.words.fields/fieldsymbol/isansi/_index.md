...
description: Découvrez la propriété FieldSymbol IsAnsi, gérez facilement les codes de caractères ANSI pour une gestion améliorée des données et une efficacité de codage améliorée.
type: docs
weight: 60
url: /fr/net/aspose.words.fields/fieldsymbol/isansi/
---
## FieldSymbol.IsAnsi property

Obtient ou définit si le code de caractère est interprété comme la valeur d'un caractère ANSI.
