...
description: Découvrez comment utiliser la propriété FontName FieldSymbol pour gérer et personnaliser facilement les noms de polices de vos caractères dans la programmation.
type: docs
weight: 40
...
Obtient ou définit le nom de la police du caractère récupéré par le champ.
