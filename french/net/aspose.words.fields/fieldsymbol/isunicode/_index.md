...
description: Découvrez la propriété FieldSymbol IsUnicode pour gérer facilement les codes de caractères en tant que valeurs Unicode, améliorant ainsi l'efficacité et la précision de votre codage.
type: docs
weight: 80
url: /fr/net/aspose.words.fields/fieldsymbol/isunicode/
---
## FieldSymbol.IsUnicode property

Obtient ou définit si le code de caractère est interprété comme la valeur d'un caractère Unicode.
