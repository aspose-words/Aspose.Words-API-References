...
description: Obtient ou définit sil faut remplacer cinq références de page différentes ou plus à la même autorité par passim qui est utilisé pour indiquer quun mot ou un passage apparaît fréquemment dans louvrage cité.
type: docs
weight: 110
