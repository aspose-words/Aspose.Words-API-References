...
description: Optimisez vos citations avec FieldToa UsePassim. Gérez facilement plusieurs références à une même autorité, améliorant ainsi la clarté et la précision de votre travail.
type: docs
weight: 110
...
Obtient ou définit s'il faut remplacer cinq références de page ou plus différentes à la même autorité par « passim », qui est utilisé pour indiquer qu'un mot ou un passage apparaît fréquemment dans l'ouvrage cité.
