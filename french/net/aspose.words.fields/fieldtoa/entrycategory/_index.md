...
description: Découvrez la propriété EntryCategory de FieldToa pour gérer et personnaliser efficacement les catégories intégrales de vos entrées de table. Améliorez votre organisation dès aujourd'hui !
type: docs
weight: 30
...
Obtient ou définit la catégorie intégrale pour les entrées incluses dans la table.
