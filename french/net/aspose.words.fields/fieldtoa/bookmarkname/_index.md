...
description: Découvrez la propriété FieldToa BookmarkName pour gérer facilement les signets dans vos documents, améliorant ainsi la création de tableaux et la navigation dans les documents.
type: docs
weight: 20
...
Obtient ou définit le nom du signet qui marque la partie du document utilisée pour créer le tableau.
