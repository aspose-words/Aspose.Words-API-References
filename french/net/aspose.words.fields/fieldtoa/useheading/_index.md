...
description: Découvrez comment la propriété FieldToa UseHeading améliore votre table des références en ajoutant des en-têtes de catégorie pour une meilleure organisation et clarté.
type: docs
weight: 100
url: /fr/net/aspose.words.fields/fieldtoa/useheading/
---
## FieldToa.UseHeading property

Obtient ou définit s'il faut inclure l'en-tête de catégorie pour les entrées dans une table d'autorités.
