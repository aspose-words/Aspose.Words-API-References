...
description: Contrôlez la mise en forme du texte de votre document grâce à la propriété RemoveEntryFormatting de FieldToa. Améliorez votre table des références sans effort !
type: docs
weight: 70
...
Obtient ou définit s'il faut supprimer la mise en forme du texte d'entrée dans le document de l'entrée dans la table des autorités.
