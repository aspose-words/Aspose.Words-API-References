...
description: Découvrez la propriété FieldToa PageNumberListSeparator pour personnaliser les listes de numéros de page avec votre séparateur préféré. Améliorez la lisibilité de votre document dès aujourd'hui !
type: docs
weight: 50
