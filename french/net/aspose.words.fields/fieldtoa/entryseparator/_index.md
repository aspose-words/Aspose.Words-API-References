...
description: Découvrez la propriété FieldToa EntrySeparator pour personnaliser facilement votre table d'autorités avec des séquences de caractères flexibles pour une clarté accrue.
type: docs
weight: 40
url: /fr/net/aspose.words.fields/fieldtoa/entryseparator/
---
## FieldToa.EntrySeparator property

Obtient ou définit la séquence de caractères utilisée pour séparer une entrée de table d'autorités et son numéro de page.
