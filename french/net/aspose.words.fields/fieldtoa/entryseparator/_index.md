...
description: FieldToa EntrySeparator propriété. Obtient ou définit la séquence de caractères utilisée pour séparer une entrée de table de références et son numéro de page en C#.
type: docs
weight: 40
...
Obtient ou définit la séquence de caractères utilisée pour séparer une entrée de table de références et son numéro de page.
