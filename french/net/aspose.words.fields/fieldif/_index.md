...
description: Découvrez la classe Aspose.Words.Fields.FieldIf  implémentez efficacement les champs IF pour améliorer l'automatisation des documents et rationaliser votre flux de travail.
type: docs
weight: 2410
...
| [FalseText](../../aspose.words.fields/fieldif/falsetext/) { get; set; } | Obtient ou définit le texte affiché si l'expression de comparaison est`FAUX` . |
...
Compare les valeurs désignées par les expressions[`LeftExpression`](./leftexpression/) et[`RightExpression`](./rightexpression/) en comparaison en utilisant l'opérateur désigné par[`ComparisonOperator`](./comparisonoperator/).
