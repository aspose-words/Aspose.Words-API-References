...
description: Aspose.Words.Fields.FieldGoToButton classe. Implémente le champ GOTOBUTTON en C#.
type: docs
weight: 1970
...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Obtient ou définit le texte du "bouton" qui apparaît dans le document, de telle sorte qu'il puisse être sélectionné pour activer le saut. |
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | Obtient ou définit le nom d'un signet, un numéro de page ou un autre élément auquel accéder. |
...
Insère une commande de saut, de telle sorte que lorsqu'elle est activée, le point d'insertion du document est déplacé vers l'emplacement spécifié.
