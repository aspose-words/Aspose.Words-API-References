...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Obtient ou définit le texte du "bouton" qui apparaît dans le document, de sorte qu'il peut être sélectionné pour activer le saut. |
