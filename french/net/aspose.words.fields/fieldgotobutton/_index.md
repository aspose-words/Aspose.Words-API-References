...
description: Découvrez la classe Aspose.Words.Fields.FieldGoToButton pour une navigation fluide avec les champs GOTOBUTTON. Améliorez l'interactivité de vos documents dès aujourd'hui !
type: docs
weight: 2380
url: /fr/net/aspose.words.fields/fieldgotobutton/
---
...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Obtient ou définit le texte du « bouton » qui apparaît dans le document, de sorte qu'il puisse être sélectionné pour activer le saut. |
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | Obtient ou définit le nom d'un signet, un numéro de page ou un autre élément vers lequel accéder. |
