...
description: Découvrez la classe Aspose.Words.Fields.FieldPrivate pour une intégration transparente des champs PRIVÉS, améliorant l'automatisation et la personnalisation des documents.
type: docs
weight: 2710
...
Fournit un espace de stockage privé. Ce champ permet de stocker les données des documents convertis à partir d'autres formats de fichiers.
