...
description: Implémente le champ FILENAME.
type: docs
weight: 1720
url: /fr/net/aspose.words.fields/fieldfilename/
---
## FieldFileName class
...
| [IncludeFullPath](../../aspose.words.fields/fieldfilename/includefullpath) { get; set; } | Obtient ou définit s'il faut inclure le nom complet du chemin d'accès au fichier. |
...
Récupère le nom du document courant à partir de son emplacement de stockage.

Dans l'implémentation actuelle, utilise le[`OriginalFileName`](../../aspose.words/document/originalfilename) propriété pour récupérer le nom du fichier. Si le document a été chargé à partir d'un flux ou créé vierge, utilise le nom du fichier dans lequel il est enregistré (s'il est connu).
