...
description: Découvrez la classe Aspose.Words.Fields.FieldFileSize pour implémenter sans effort le champ FILESIZE, améliorant ainsi la gestion des documents en toute simplicité.
type: docs
weight: 2290
url: /fr/net/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class
...
| [IsInKilobytes](../../aspose.words.fields/fieldfilesize/isinkilobytes/) { get; set; } | Obtient ou définit s'il faut afficher la taille du fichier en kilo-octets. |
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes/) { get; set; } | Obtient ou définit s'il faut afficher la taille du fichier en mégaoctets. |
...
Dans l'implémentation actuelle, utilise le[`OriginalFileName`](../../aspose.words/document/originalfilename/) propriété permettant de récupérer le nom du fichier utilisé pour déterminer la taille du fichier.
