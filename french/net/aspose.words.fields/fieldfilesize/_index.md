...
description: Aspose.Words.Fields.FieldFileSize classe. Implémente le champ FILESIZE en C#.
type: docs
weight: 1880
...
Dans l'implémentation actuelle, utilise le[`OriginalFileName`](../../aspose.words/document/originalfilename/) propriété pour récupérer le nom de fichier utilisé pour déterminer la taille du fichier.
