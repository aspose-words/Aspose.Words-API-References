...
description: Découvrez la propriété FieldNextIf LeftExpression. Gérez facilement le côté gauche de vos expressions de comparaison pour une manipulation et une analyse optimisées des données.
type: docs
weight: 30
