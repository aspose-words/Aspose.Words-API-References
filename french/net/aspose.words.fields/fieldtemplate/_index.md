...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | Obtient ou définit s'il faut inclure le nom complet du chemin d'accès au fichier. |
...
Récupère le nom de fichier du modèle utilisé par le document courant.
