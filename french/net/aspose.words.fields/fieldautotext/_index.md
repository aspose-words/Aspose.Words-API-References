...
description: Aspose.Words.Fields.FieldAutoText classe. Implémente le champ AUTOTEXTE en C#.
type: docs
weight: 1610
...
| [EntryName](../../aspose.words.fields/fieldautotext/entryname/) { get; set; } | Obtient ou définit le nom de l'entrée d'insertion automatique. |
...
Insère une entrée d'insertion automatique.
