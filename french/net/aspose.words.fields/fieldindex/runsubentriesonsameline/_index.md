...
// en-têtes, le champ INDEX les sous-regroupera davantage en fonction des valeurs de ces en-têtes.
...
// Par défaut, un groupe d'entrée de champ INDEX créera une nouvelle ligne pour chaque sous-titre de ce groupe.
// On peut mettre le flag RunSubentriesOnSameLine à true pour conserver le titre,
// et chaque sous-titre du groupe sur une seule ligne, ce qui rendra le champ INDEX plus compact.
...
// Insère deux champs XE, chacun sur une nouvelle page, et avec la même rubrique nommée "Titre 1",
