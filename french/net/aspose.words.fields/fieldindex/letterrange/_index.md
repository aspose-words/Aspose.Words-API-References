...
description: Découvrez la propriété FieldIndex LetterRange pour définir ou récupérer efficacement une plage de lettres spécifique, optimisant ainsi vos performances d'indexation.
type: docs
weight: 90
...
Obtient ou définit une plage de lettres à laquelle limite l'index.
