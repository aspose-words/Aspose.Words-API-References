...
description: Découvrez la propriété FieldIndex SequenceName pour gérer facilement les noms de séquences et améliorer l'efficacité de la pagination dans vos applications.
type: docs
weight: 150
...
Obtient ou définit le nom d'une séquence dont le numéro est inclus avec le numéro de page.
