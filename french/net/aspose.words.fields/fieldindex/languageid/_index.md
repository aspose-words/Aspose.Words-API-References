...
description: Découvrez la propriété FieldIndex LanguageId pour gérer facilement les identifiants de langue et optimiser l'indexation. Améliorez vos capacités de recherche dès aujourd'hui !
type: docs
weight: 80
url: /fr/net/aspose.words.fields/fieldindex/languageid/
---
## FieldIndex.LanguageId property

Obtient ou définit l'ID de langue utilisé pour générer l'index.
