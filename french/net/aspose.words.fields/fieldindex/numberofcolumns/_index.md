...
description: Découvrez la propriété FieldIndex NumberOfColumns pour personnaliser facilement la disposition de votre index avec des paramètres de colonnes optimaux pour une lisibilité et des performances améliorées.
type: docs
weight: 100
...
Obtient ou définit le nombre de colonnes par page utilisées lors de la création de l'index.
