...
description: Aspose.Words.Fields.FieldIndex classe. Implémente le champ INDEX en C#.
type: docs
weight: 2060
...
| [HasPageNumberSeparator](../../aspose.words.fields/fieldindex/haspagenumberseparator/) { get; } | Obtient une valeur indiquant si un séparateur de numéro de page est remplacé via le code du champ. |
