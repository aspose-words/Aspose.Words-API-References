...
Obtient ou définit la séquence de caractères utilisée pour séparer les références croisées et les autres entrées.
...
// Insère un champ XE, qui crée une entrée INDEX normale qui affiche le numéro de page de ce champ,
...
// et la valeur CrossReferenceSeparator du champ INDEX apparaîtra devant.
// L'entrée pour ce champ XE affichera "Banane, voir : Fruits tropicaux".
builder.InsertBreak(BreakType.PageBreak);
