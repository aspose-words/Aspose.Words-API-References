...
description: Aspose.Words.Fields.FieldFormula classe. Implémente le champ  formule en C#.
type: docs
weight: 1950
...
// Utiliser un générateur de champs pour construire une équation mathématique,
// puis crée un champ de formule pour afficher le résultat de l'équation dans le document.
