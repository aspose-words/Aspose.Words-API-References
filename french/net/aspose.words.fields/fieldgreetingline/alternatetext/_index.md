...
description: Découvrez comment utiliser la propriété FieldGreetingLine AlternateText pour améliorer l'expérience utilisateur en affichant du texte personnalisé lorsque les noms sont manquants.
type: docs
weight: 20
...
Obtient ou définit le texte à inclure dans le champ si le nom est vide.
