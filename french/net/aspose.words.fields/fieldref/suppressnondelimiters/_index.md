...
description: Contrôlez la propriété FieldRef SuppressNonDelimiters pour gérer facilement les caractères non délimiteurs dans vos données. Améliorez la précision et simplifiez le traitement !
type: docs
weight: 100
...
Obtient ou définit s'il faut supprimer les caractères non délimiteurs.
