...
description: Obtient ou définit sil faut incrémenter les numéros de note de bas de page de note de fin et dannotation qui sont marqués par le signet et insérer la note de bas de page la note de fin et le texte de commentaire correspondants.
type: docs
weight: 30
