...
description: Découvrez la classe Aspose.Words.Fields.FieldEQ pour une implémentation fluide des champs EQ. Optimisez l'automatisation de vos documents grâce à des fonctionnalités puissantes et flexibles.
type: docs
weight: 2240
...
| Nom | La description |
| --- | --- |
| [AsOfficeMath](../../aspose.words.fields/fieldeq/asofficemath/)() | L'objet mathématique du bureau des retours correspond au champ EQ. |
...
Montre comment utiliser le champ EQ pour afficher une variété d'équations mathématiques.
...
public void FieldEQ()
{
    ...
    // Ici, nous utilisons un générateur de documents pour insérer un champ EQ, avec un commutateur "\f", qui correspond à "Fraction".
    ...
    // Nous pouvons également imbriquer des éléments les uns dans les autres en plaçant les éléments intérieurs
    // à l'intérieur des crochets d'argument des éléments externes.
    ...
    // 2 - Commutateur de crochet "\b", caractère de crochet "[", pour enfermer le contenu dans un ensemble d'accolades carrées :
    // Notez que nous imbriquons un tableau à l'intérieur des crochets, ce qui ressemblera globalement à une matrice dans la sortie.
    InsertFieldEQ(builder, @"\b \bc\[ (\a \al \co3 \vs3 \hs3(1,0,0,0,1,0,0,0,1))");

    // 3 - Commutateur de déplacement "\d", déplaçant le texte "B" de 30 espaces à droite de "A", affichant l'espace sous forme de soulignement :
...
/// <summary>
/// Utilisez un générateur de documents pour insérer un champ EQ, définir ses arguments et démarrer un nouveau paragraphe.
/// </summary>
