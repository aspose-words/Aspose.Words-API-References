...
description: Découvrez comment utiliser la propriété Initiales UserInformation pour gérer et personnaliser facilement les initiales des utilisateurs pour une personnalisation et une expérience utilisateur améliorées.
type: docs
weight: 40
