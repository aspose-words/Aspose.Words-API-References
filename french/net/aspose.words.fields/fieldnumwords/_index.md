...
description: Découvrez la classe Aspose.Words.Fields.FieldNumWords pour gérer facilement le nombre de mots dans vos documents. Améliorez votre traitement de texte grâce à cette puissante fonctionnalité !
type: docs
weight: 2640
url: /fr/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class

Implémente le champ NUMWORDS.
...
Récupère le nombre de mots dans le document actuel, tel qu'enregistré dans le**Mots** propriété des propriétés de document intégrées .
