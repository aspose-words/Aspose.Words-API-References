...
description: Découvrez la classe Aspose.Words.Fields.FieldFormDropDown, conçue pour améliorer l'interactivité des documents avec des champs déroulants dynamiques pour des expériences utilisateur fluides.
type: docs
weight: 2330
url: /fr/net/aspose.words.fields/fieldformdropdown/
---
## FieldFormDropDown class

Implémente le champ FORMDROPDOWN.
...
Insère un champ de formulaire de style liste déroulante.
...
```csharp
// Ces champs sont des équivalents hérités du FormField. Nous pouvons les lire, mais pas les créer avec Aspose.Words.
