...
description: Aspose.Words.Fields.FieldTime classe. Implémente le champ TIME en C#.
type: docs
weight: 2500
...
/// <summary>
/// Utilisez un générateur de documents pour insérer un champ TIME, insérez un nouveau paragraphe et renvoyez le champ.
/// </summary>
