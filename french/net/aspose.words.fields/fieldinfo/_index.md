...
description: Aspose.Words.Fields.FieldInfo classe. Implémente le champ INFO.
type: docs
weight: 2080
url: /fr/net/aspose.words.fields/fieldinfo/
---
## FieldInfo class
...
| [InfoType](../../aspose.words.fields/fieldinfo/infotype/) { get; set; } | Obtient ou définit le type de propriété de document à insérer. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Obtient ou définit si le résultat actuel du champ n'est plus correct (périmé) en raison d'autres modifications apportées au document. |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | Obtient ou définit si le champ est verrouillé (ne doit pas recalculer son résultat). |
| [LocaleId](../../aspose.words.fields/field/localeid/) { get; set; } | Obtient ou définit le LCID du champ. |
| [NewValue](../../aspose.words.fields/fieldinfo/newvalue/) { get; set; } | Obtient ou définit une valeur facultative qui met à jour la propriété. |
