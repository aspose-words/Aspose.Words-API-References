...
description: Découvrez la classe Aspose.Words.Fields.FieldInfo, votre solution idéale pour implémenter efficacement le champ INFO dans le traitement de documents. Bénéficiez de puissantes fonctionnalités dès aujourd'hui !
type: docs
weight: 2490
...
| [InfoType](../../aspose.words.fields/fieldinfo/infotype/) { get; set; } | Obtient ou définit le type de la propriété du document à insérer. |
