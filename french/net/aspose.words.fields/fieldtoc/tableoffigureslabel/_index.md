...
description: Découvrez la propriété FieldToc TableOfFiguresLabel pour personnaliser facilement votre table des illustrations. Améliorez l'organisation et la clarté de votre document !
type: docs
weight: 160
...
Obtient ou définit le nom de l'identifiant de séquence utilisé lors de la création d'un tableau des figures.
