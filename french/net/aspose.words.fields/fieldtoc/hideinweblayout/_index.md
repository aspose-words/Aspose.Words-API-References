...
description: Découvrez la propriété FieldToc HideInWebLayout pour contrôler facilement les onglets de suivi et les numéros de page dans la vue de mise en page Web pour une présentation plus claire.
type: docs
weight: 90
...
Obtient ou définit s'il faut masquer le leader des tabulations et les numéros de page dans la vue de mise en page Web.
