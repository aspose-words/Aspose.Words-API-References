...
description: Contrôlez les hyperliens dans votre table des matières avec FieldToc InsertHyperlinks. Améliorez la navigation et l'expérience utilisateur sans effort !
type: docs
weight: 100
...
Obtient ou définit s'il faut transformer les entrées de la table des matières en hyperliens.
