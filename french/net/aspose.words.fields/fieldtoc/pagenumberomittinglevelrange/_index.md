...
description: Découvrez la propriété FieldToc PageNumberOmittingLevelRange pour personnaliser votre table des matières en omettant les numéros de page pour des niveaux d'entrée spécifiques.
type: docs
weight: 110
url: /fr/net/aspose.words.fields/fieldtoc/pagenumberomittinglevelrange/
---
## FieldToc.PageNumberOmittingLevelRange property

Obtient ou définit une plage de niveaux d'entrées de table des matières à partir de laquelle omettre les numéros de page.
