...
description: Personnalisez votre table des matières avec la propriété CustomStyles de FieldToc. Ajoutez facilement des styles uniques au-delà des titres intégrés pour une présentation optimisée.
type: docs
weight: 40
...
Obtient ou définit une liste de styles autres que les styles de titre intégrés à inclure dans la table des matières.
