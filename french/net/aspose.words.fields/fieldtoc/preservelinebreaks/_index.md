...
description: Découvrez comment la propriété FieldToc PreserveLineBreaks améliore les entrées de table en préservant les caractères de nouvelle ligne pour une meilleure lisibilité et un meilleur formatage.
type: docs
weight: 130
url: /fr/net/aspose.words.fields/fieldtoc/preservelinebreaks/
---
## FieldToc.PreserveLineBreaks property

Obtient ou définit s'il faut conserver les caractères de nouvelle ligne dans les entrées de table.
