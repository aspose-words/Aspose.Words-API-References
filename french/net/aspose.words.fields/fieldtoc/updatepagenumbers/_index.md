...
description: Mettez à jour votre table des matières sans effort avec la méthode UpdatePageNumbers de FieldToc, garantissant une navigation précise et une meilleure convivialité du document.
type: docs
weight: 180
...
`vrai` si l'opération réussit. Si l'un des signets de la table des matières a été supprimé,`FAUX` sera retourné.
