...
description: FieldToc propriété. Obtient ou définit sil faut conserver les entrées de tabulation dans les entrées de table.
type: docs
weight: 140
...
Obtient ou définit s'il faut conserver les entrées de tabulation dans les entrées de table.
