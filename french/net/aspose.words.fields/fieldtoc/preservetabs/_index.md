...
description: Découvrez comment la propriété FieldToc PreserveTabs améliore la gestion de vos données en préservant les entrées d'onglets dans les entrées de table pour une meilleure organisation.
type: docs
weight: 140
