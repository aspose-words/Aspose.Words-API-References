...
description: FieldToc propriété. Obtient ou définit le nom de lidentifiant de séquence utilisé lors de la création dun tableau de figures qui ninclut pas létiquette et le numéro de la légende .
type: docs
weight: 30
