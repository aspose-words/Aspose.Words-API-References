...
description: FieldBuilder méthode. Ajoute un commutateur de champ.
type: docs
weight: 30
...
| --- | --- | --- |
| switchName | String | Le nom du commutateur. |

### Remarques

Cette surcharge ajoute un indicateur (commutateur sans argument).
...
| --- | --- | --- |
| switchName | String | Le nom du commutateur. |
| switchArgument | String | La valeur de commutation. |
...
| --- | --- | --- |
| switchName | String | Le nom du commutateur. |
| switchArgument | Int32 | La valeur de commutation. |
...
| --- | --- | --- |
| switchName | String | Le nom du commutateur. |
| switchArgument | Double | La valeur de commutation. |
