...
description: Ajoute largument dun champ.
type: docs
weight: 20
...
Ajoute un champ enfant représenté par un autre[`FieldBuilder`](../../fieldbuilder) au code du champ.
...
Cette surcharge est utilisée lorsque l'argument consiste en un seul champ enfant.
...
Cette surcharge est utilisée lorsque l'argument consiste en un mélange de différentes parties telles que des champs enfants, des nœuds et du texte brut.
