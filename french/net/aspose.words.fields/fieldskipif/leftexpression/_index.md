...
description: Découvrez la propriété FieldSkipIf LeftExpression, gérez facilement le côté gauche de vos expressions de comparaison pour un contrôle et une flexibilité des données améliorés.
type: docs
weight: 30
