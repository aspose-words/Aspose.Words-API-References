...
description: Renvoie le texte entre le début du champ et le séparateur de champ ou la fin du champ sil ny a pas de séparateur. Le code de champ et le résultat du champ des champs enfants sont inclus.
type: docs
weight: 110
