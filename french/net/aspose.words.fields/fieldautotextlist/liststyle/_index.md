...
description: Découvrez la propriété FieldAutoTextList ListStyle pour personnaliser facilement vos listes d'entrées. Améliorez votre contenu avec des styles personnalisés dès aujourd'hui !
type: docs
weight: 30
...
Obtient ou définit le nom du style sur lequel la liste contenant les entrées est basée.
