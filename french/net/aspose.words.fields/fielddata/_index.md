...
description: Découvrez la classe Aspose.Words.Fields.FieldData, la clé pour implémenter efficacement des champs de données dans vos documents. Optimisez l'automatisation de vos documents dès aujourd'hui !
type: docs
weight: 2140
url: /fr/net/aspose.words.fields/fielddata/
---
## FieldData class
...
Montre comment insérer un champ DONNÉES dans un document.
