...
description: FieldAdvance propriété. Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers le haut.
type: docs
weight: 60
...
Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers le haut.
