...
description: Aspose.Words.Fields.FieldAdvance classe. Implémente le champ ADVANCE en C#.
type: docs
weight: 1540
...
Déplace le point de départ auquel le texte qui suit lexicalement le champ est affiché vers la droite ou la gauche, vers le haut ou vers le bas, ou vers une position horizontale ou verticale spécifique.
