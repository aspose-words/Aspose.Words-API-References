...
description: FieldAdvance propriété. Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers la gauche.
type: docs
weight: 40
...
Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers la gauche.
