...
description: Le Aspose.Words.Fields Lespace de noms contient des classes qui représentent les champs Microsoft Word dans un document.
type: docs
weight: 80
...
| [FieldSeparator](./fieldseparator/) | Représente un séparateur de champ Word qui sépare le code du champ du résultat du champ. |
...
| [FieldUpdatingProgressArgs](./fieldupdatingprogressargs/) | Fournit des données pour l'événement de progression de la mise à jour du champ. |
...
| [IFieldUpdateCultureProvider](./ifieldupdatecultureprovider/) | Une fois implémenté, fournit unCultureInfo objet qui doit être utilisé lors de la mise à jour d'un champ particulier. |
...
| [IFieldUpdatingProgressCallback](./ifieldupdatingprogresscallback/) | Implémentez cette interface si vous souhaitez suivre la progression de la mise à jour des champs. |
