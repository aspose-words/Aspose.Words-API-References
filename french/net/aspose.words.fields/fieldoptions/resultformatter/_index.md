...
description: Découvrez comment la propriété ResultFormatter dans FieldOptions améliore la présentation de vos données en personnalisant les formats de résultats de champ pour plus de clarté et d'impact.
type: docs
weight: 180
...
Permet de contrôler la façon dont le résultat du champ est formaté.
