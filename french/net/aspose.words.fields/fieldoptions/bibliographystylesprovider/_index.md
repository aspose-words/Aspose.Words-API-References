...
description: FieldOptions propriété. Obtient ou définit un fournisseur qui renvoie un style de bibliographie pour leFieldBibliography etFieldCitation champs.
type: docs
weight: 20
