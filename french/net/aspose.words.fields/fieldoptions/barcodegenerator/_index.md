...
description: FieldOptions propriété. Obtient ou définit un générateur de codebarres personnalisé.
type: docs
weight: 10
...
Obtient ou définit un générateur de code-barres personnalisé.
...
Le générateur de code-barres personnalisé doit implémenter une interface publique[`IBarcodeGenerator`](../../ibarcodegenerator/) .
