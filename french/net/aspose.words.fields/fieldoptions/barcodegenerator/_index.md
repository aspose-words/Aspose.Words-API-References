...
description: Créez facilement des codes-barres personnalisés avec FieldOptions BarcodeGenerator. Améliorez votre gestion des stocks et rationalisez vos opérations dès aujourd'hui !
type: docs
weight: 10
url: /fr/net/aspose.words.fields/fieldoptions/barcodegenerator/
---
## FieldOptions.BarcodeGenerator property

Obtient ou définit un générateur de codes-barres personnalisé.
...
Le générateur de codes-barres personnalisé doit implémenter une interface publique[`IBarcodeGenerator`](../../ibarcodegenerator/) .
