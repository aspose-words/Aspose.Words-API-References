...
Par défaut, les styles personnalisés définis par le commutateur \t dans le[`FieldToc`](../../fieldtoc/) sont séparés par un délimiteur tiré de la culture actuelle. Cette propriété remplace ce comportement en spécifiant un délimiteur défini par l'utilisateur.
