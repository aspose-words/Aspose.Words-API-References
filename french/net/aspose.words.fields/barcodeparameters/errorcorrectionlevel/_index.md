...
description: Découvrez la propriété ErrorCorrectionLevel pour les codes QR. Améliorez vos codes-barres avec des options de correction d'erreur optimales, avec des valeurs de 0 et 3 pour plus de fiabilité.
type: docs
weight: 80
...
Niveau de correction d'erreur du code QR. Les valeurs valides sont [0, 3].
