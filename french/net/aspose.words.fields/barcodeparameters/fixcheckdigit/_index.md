...
description: Assurez l'exactitude des codes-barres grâce à la propriété FixCheckDigit. Corrigez automatiquement les chiffres de contrôle invalides pour une numérisation fiable et l'intégrité des données.
type: docs
weight: 100
...
S'il faut corriger le chiffre de contrôle s'il n'est pas valide.
