...
description: Découvrez la propriété BarcodeParameters FacingIdentificationMark, essentielle pour optimiser l'intégration FIM et améliorer la précision de la lecture des codes-barres.
type: docs
weight: 90
url: /fr/net/aspose.words.fields/barcodeparameters/facingidentificationmark/
---
## BarcodeParameters.FacingIdentificationMark property

Type de marque d'identification de façade (FIM).
