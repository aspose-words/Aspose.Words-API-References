...
description: Découvrez la classe Aspose.Words.Fields.FieldBarcode pour générer facilement des codes-barres dans vos documents. Optimisez votre flux de travail grâce à une intégration fluide et à des fonctionnalités puissantes.
type: docs
weight: 2040
...
| [FacingIdentificationMark](../../aspose.words.fields/fieldbarcode/facingidentificationmark/) { get; set; } | Obtient ou définit le type d'une marque d'identification de face (FIM) à insérer. |
...
| [IsUSPostalAddress](../../aspose.words.fields/fieldbarcode/isuspostaladdress/) { get; set; } | Obtient ou définit si[`PostalAddress`](./postaladdress/) est une adresse postale américaine. |
