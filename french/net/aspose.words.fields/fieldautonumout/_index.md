...
description: Découvrez la classe Aspose.Words.Fields.FieldAutoNumOut pour une implémentation transparente du champ AUTONUMOUT, améliorant l'automatisation et l'efficacité des documents.
type: docs
weight: 2010
...
Insère un numéro automatique au format hiérarchique.
...
// Les champs AUTONUMOUT affichent un numéro qui s'incrémente à chaque champ AUTONUMOUT.
// Contrairement aux champs AUTONUM, les champs AUTONUMOUT utilisent le schéma de numérotation hiérarchique,
// que nous pouvons définir dans Microsoft Word via Format -> Puces et numérotation -> "Plan numéroté".
