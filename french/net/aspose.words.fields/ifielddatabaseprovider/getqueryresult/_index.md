...
description: Découvrez la méthode GetQueryResult d'IFieldDatabaseProvider pour une récupération efficace des données. Simplifiez vos requêtes et améliorez les performances de votre base de données dès aujourd'hui !
type: docs
weight: 10
...
| query | String | L'ensemble des instructions SQL qui interrogent la base de données spécifiée dans le commutateur de champ \s. |
