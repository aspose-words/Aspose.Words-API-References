...
description: Découvrez la propriété FieldDde InsertAsUnicode, gérez facilement les objets liés en les insérant sous forme de texte Unicode pour une compatibilité et des performances améliorées.
type: docs
weight: 80
url: /fr/net/aspose.words.fields/fielddde/insertasunicode/
---
## FieldDde.InsertAsUnicode property

Obtient ou définit s'il faut insérer l'objet lié sous forme de texte Unicode.
