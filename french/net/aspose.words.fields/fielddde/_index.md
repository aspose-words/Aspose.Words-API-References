...
description: Aspose.Words.Fields.FieldDde classe. Implémente le champ DDE en C#.
type: docs
weight: 1780
...
| [InsertAsRtf](../../aspose.words.fields/fielddde/insertasrtf/) { get; set; } | Obtient ou définit s'il faut insérer l'objet lié au format de texte enrichi (RTF). |
