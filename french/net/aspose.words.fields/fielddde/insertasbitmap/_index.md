...
description: Découvrez comment utiliser la propriété FieldDde InsertAsBitmap pour insérer facilement des objets liés sous forme de bitmaps, améliorant ainsi l'attrait visuel de votre document.
type: docs
weight: 30
