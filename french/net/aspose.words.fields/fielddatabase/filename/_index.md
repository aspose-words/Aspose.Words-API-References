...
description: Découvrez la propriété FieldDatabase FileName pour gérer facilement le chemin complet et le nom de fichier de votre base de données, améliorant ainsi l'organisation et l'accès à vos données.
type: docs
weight: 30
url: /fr/net/aspose.words.fields/fielddatabase/filename/
---
## FieldDatabase.FileName property

Obtient ou définit le chemin complet et le nom du fichier de la base de données
