...
description: Découvrez la propriété FieldDatabase TableFormat pour personnaliser facilement les résultats de votre requête de base de données avec des options de formatage flexibles pour une présentation améliorée des données.
type: docs
weight: 100
url: /fr/net/aspose.words.fields/fielddatabase/tableformat/
---
## FieldDatabase.TableFormat property

Obtient ou définit le format à appliquer au résultat de la requête de base de données.
