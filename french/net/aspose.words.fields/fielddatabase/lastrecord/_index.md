...
description: Découvrez la propriété LastRecord de FieldDatabase. Gérez facilement le numéro de votre dernier enregistrement pour une insertion fluide et une efficacité accrue de votre base de données.
type: docs
weight: 80
url: /fr/net/aspose.words.fields/fielddatabase/lastrecord/
---
## FieldDatabase.LastRecord property

Obtient ou définit le numéro d'enregistrement intégral du dernier enregistrement de données à insérer.
