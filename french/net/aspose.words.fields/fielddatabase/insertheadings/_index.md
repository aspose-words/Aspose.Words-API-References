...
description: FieldDatabase propriété. Obtient ou définit sil faut insérer les noms de champ de la base de données en tant quentêtes de colonne dans la table résultante.
type: docs
weight: 60
...
Obtient ou définit s'il faut insérer les noms de champ de la base de données en tant qu'en-têtes de colonne dans la table résultante.
