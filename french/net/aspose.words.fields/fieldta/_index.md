...
description: Découvrez la classe Aspose.Words.Fields.FieldTA pour une implémentation transparente des champs TA, améliorant ainsi vos capacités d'automatisation et de formatage de documents.
type: docs
weight: 2880
...
| [EntryCategory](../../aspose.words.fields/fieldta/entrycategory/) { get; set; } | Obtient ou définit la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories. |
...
| [IsItalic](../../aspose.words.fields/fieldta/isitalic/) { get; set; } | Obtient ou définit s'il faut appliquer la mise en forme italique au numéro de page de l'entrée. |
...
| [PageRangeBookmarkName](../../aspose.words.fields/fieldta/pagerangebookmarkname/) { get; set; } | Obtient ou définit le nom du signet qui marque une plage de pages qui est insérée comme numéro de page de l'entrée. |
...
| [ShortCitation](../../aspose.words.fields/fieldta/shortcitation/) { get; set; } | Obtient ou définit la citation courte de l'entrée. |
