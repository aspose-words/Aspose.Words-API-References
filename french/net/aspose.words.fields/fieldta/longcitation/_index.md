...
description: Gérez facilement votre propriété FieldTA LongCitation. Obtenez ou définissez facilement des citations longues pour vos entrées, améliorant ainsi l'organisation et l'accessibilité de vos données.
type: docs
weight: 50
...
Obtient ou définit la citation longue de l'entrée.
