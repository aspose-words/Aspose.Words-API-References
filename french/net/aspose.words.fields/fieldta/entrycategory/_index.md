...
description: Découvrez la propriété FieldTA EntryCategory. Gérez facilement vos catégories d'entrée intégrales grâce à cet outil puissant pour une organisation et une efficacité optimales.
type: docs
weight: 20
url: /fr/net/aspose.words.fields/fieldta/entrycategory/
---
## FieldTA.EntryCategory property

Obtient ou définit la catégorie d'entrée intégrale, qui est un nombre correspondant à l'ordre des catégories.
