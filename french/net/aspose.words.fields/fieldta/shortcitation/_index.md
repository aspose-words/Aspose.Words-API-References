...
description: Gérez vos citations courtes FieldTA en toute simplicité. Obtenez ou définissez facilement des citations courtes pour vos entrées, améliorant ainsi l'organisation et l'accessibilité des données.
type: docs
weight: 70
url: /fr/net/aspose.words.fields/fieldta/shortcitation/
---
## FieldTA.ShortCitation property

Obtient ou définit la citation courte de l'entrée.
