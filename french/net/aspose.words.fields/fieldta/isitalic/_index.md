...
description: Découvrez comment formater facilement les numéros de page avec la propriété IsItalic de FieldTA, en améliorant vos documents avec un texte italique élégant pour une meilleure lisibilité.
type: docs
weight: 40
url: /fr/net/aspose.words.fields/fieldta/isitalic/
---
## FieldTA.IsItalic property

Obtient ou définit s'il faut appliquer la mise en forme italique au numéro de page de l'entrée.
