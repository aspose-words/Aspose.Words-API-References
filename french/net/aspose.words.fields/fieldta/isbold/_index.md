...
description: Améliorez votre expérience FieldTA ! Contrôlez facilement la mise en gras des numéros de page d'entrée, garantissant clarté et mise en valeur dans vos documents.
type: docs
weight: 30
...
Obtient ou définit s'il faut appliquer une mise en forme en gras au numéro de page de l'entrée.
