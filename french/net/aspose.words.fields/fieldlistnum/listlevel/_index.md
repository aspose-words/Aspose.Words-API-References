...
description: Découvrez la propriété FieldListNum ListLevel pour personnaliser vos niveaux de liste sans effort, améliorant ainsi l'organisation et le contrôle de vos données.
type: docs
weight: 30
