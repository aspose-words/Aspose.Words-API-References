...
description: IFieldResultFormatter méthode. Appelé lorsque Aspose.Words applique un changement de format de capitalisation cestàdire  Upper.
type: docs
weight: 10
...
Appelé lorsque Aspose.Words applique un changement de format de capitalisation, c'est-à-dire \* Upper.
...
Appelé lorsque Aspose.Words applique un commutateur de format numérique, c'est-à-dire \* Ordinal.
