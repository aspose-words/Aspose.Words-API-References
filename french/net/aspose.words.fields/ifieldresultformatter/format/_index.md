...
description: Découvrez la méthode de format iFieldResultFormatter dans Aspose.Words qui améliore la mise en forme du document avec des options de majuscules personnalisables comme les majuscules.
type: docs
weight: 10
...
Appelé lorsque Aspose.Words applique un commutateur de format de nombre, c'est-à-dire \* Ordinal.
