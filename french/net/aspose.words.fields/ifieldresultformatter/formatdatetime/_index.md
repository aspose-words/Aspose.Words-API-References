...
description: Découvrez la méthode iFieldResultFormatter FormatDateTime pour Aspose.Words. Formatez facilement les dates grâce au commutateur jj.MM.aaaa !
type: docs
weight: 20
url: /fr/net/aspose.words.fields/ifieldresultformatter/formatdatetime/
---
## IFieldResultFormatter.FormatDateTime method

Appelé lorsque Aspose.Words applique un commutateur de format date/heure, c'est-à-dire \@ "dd.MM.yyyy".
...
L'implémentation doit renvoyer`nul` pour indiquer que la mise en forme par défaut doit être appliquée.
