...
description: Aspose.Words.Fields.FieldTitle classe. Implémente le champ TITLE.
type: docs
weight: 2360
...
Récupère et éventuellement définit le titre du document, tel qu'il est enregistré dans le **Titre**propriété des propriétés de document intégrées .
