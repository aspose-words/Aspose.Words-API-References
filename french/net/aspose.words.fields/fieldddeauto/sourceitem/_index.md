...
description: Découvrez la propriété FieldDdeAuto SourceItem pour gérer facilement les sections de fichiers sources liés. Améliorez l'intégration de vos données grâce à un contrôle et une flexibilité transparents.
type: docs
weight: 110
url: /fr/net/aspose.words.fields/fieldddeauto/sourceitem/
---
## FieldDdeAuto.SourceItem property

Obtient ou définit la partie du fichier source qui est liée.
