...
description: FieldDdeAuto propriété. Obtient ou définit sil faut réduire la taille du fichier en ne stockant pas les données graphiques avec le document.
type: docs
weight: 80
