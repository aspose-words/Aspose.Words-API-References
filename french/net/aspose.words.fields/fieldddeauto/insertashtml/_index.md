...
description: Obtient ou définit sil faut insérer lobjet lié en tant que texte au format HTML.
type: docs
weight: 30
...
Obtient ou définit s'il faut insérer l'objet lié en tant que texte au format HTML.
