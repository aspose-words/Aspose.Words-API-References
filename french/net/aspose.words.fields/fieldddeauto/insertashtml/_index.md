...
description: Découvrez la propriété FieldDdeAuto InsertAsHtml. Gérez facilement les objets liés en les insérant sous forme de texte HTML pour une intégration fluide et des fonctionnalités améliorées.
type: docs
weight: 30
url: /fr/net/aspose.words.fields/fieldddeauto/insertashtml/
---
## FieldDdeAuto.InsertAsHtml property

Obtient ou définit s'il faut insérer l'objet lié sous forme de texte au format HTML.
