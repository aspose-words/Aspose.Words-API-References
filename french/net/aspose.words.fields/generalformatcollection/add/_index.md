...
description: Découvrez comment améliorer votre collection avec la méthode GeneralFormatCollection Add  ajoutez efficacement des formats polyvalents pour une meilleure gestion des données !
type: docs
weight: 30
