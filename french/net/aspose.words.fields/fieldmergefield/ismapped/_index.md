...
description: Découvrez la propriété FieldMergeField IsMapped pour gérer facilement les champs mappés, améliorant ainsi l'intégration de vos données et l'efficacité de votre flux de travail.
type: docs
weight: 30
