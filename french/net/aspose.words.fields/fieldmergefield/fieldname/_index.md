...
description: Découvrez la propriété FieldMergeField FieldName pour gérer et personnaliser facilement vos champs de données pour une intégration et une efficacité des données améliorées.
type: docs
weight: 10
...
Obtient ou définit le nom d'un champ de données.
