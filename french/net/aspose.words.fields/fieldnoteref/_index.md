...
description: Découvrez la classe Aspose.Words.Fields.FieldNoteRef pour une intégration transparente des champs NOTEREF, améliorant le référencement et la gestion des documents.
type: docs
weight: 2610
...
| [InsertReferenceMark](../../aspose.words.fields/fieldnoteref/insertreferencemark/) { get; set; } | Insère la marque de référence avec le même formatage de caractères que le style Référence de note de bas de page ou Référence de note de fin. |
...
Montre comment référencer les notes de bas de page avec le champ NOTEREF.
