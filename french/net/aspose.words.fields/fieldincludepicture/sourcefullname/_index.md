...
description: Découvrez la propriété FieldIncludePicture SourceFullName. Gérez facilement l'emplacement des images avec l'IRI pour une meilleure intégration multimédia et une expérience utilisateur fluide.
type: docs
weight: 60
url: /fr/net/aspose.words.fields/fieldincludepicture/sourcefullname/
---
## FieldIncludePicture.SourceFullName property

Obtient ou définit l'emplacement de l'image à l'aide d'un IRI.
