...
description: Aspose.Words.Fields.FieldIncludePicture classe. Implémente le champ INCLUDEPICTURE en C#.
type: docs
weight: 2040
...
| [IsLinked](../../aspose.words.fields/fieldincludepicture/islinked/) { get; set; } | Obtient ou définit s'il faut réduire la taille du fichier en ne stockant pas les données graphiques avec le document. |
