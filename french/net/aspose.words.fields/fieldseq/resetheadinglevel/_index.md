...
description: FieldSeq propriété. Obtient ou définit un nombre entier représentant un niveau de titre auquel réinitialiser le numéro de séquence. Renvoie 1 si le numéro est absent.
type: docs
weight: 40
...
Obtient ou définit un nombre entier représentant un niveau de titre auquel réinitialiser le numéro de séquence. Renvoie -1 si le numéro est absent.
