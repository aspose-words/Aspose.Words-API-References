...
description: Implémente le champ SEQ.
type: docs
weight: 2240
...
| [ResetHeadingLevel](../../aspose.words.fields/fieldseq/resetheadinglevel) { get; set; } | Obtient ou définit un nombre entier représentant un niveau de titre auquel réinitialiser le numéro de séquence. Renvoie -1 si le numéro est absent. |
| [ResetNumber](../../aspose.words.fields/fieldseq/resetnumber) { get; set; } | Obtient ou définit un nombre entier sur lequel réinitialiser le numéro de séquence. Renvoie -1 si le numéro est absent. |
