...
description: Découvrez la classe Aspose.Words.Fields.FieldDocProperty, conçue pour une intégration transparente des champs DOCPROPERTY dans vos documents pour des fonctionnalités améliorées.
type: docs
weight: 2220
url: /fr/net/aspose.words.fields/fielddocproperty/
---
## FieldDocProperty class

Implémente le champ DOCPROPERTY.
...
Récupère les informations du document indiquées.
