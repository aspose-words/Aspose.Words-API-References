...
description: Renvoie ou définit le texte affiché dans la barre détat lorsquun champ de formulaire a le focus.
type: docs
weight: 180
...
Si la propriété OwnStatus est définie sur true, la propriété StatusText spécifie le texte de la barre d'état. Si la propriété OwnStatus est définie sur false, la propriété StatusText spécifie le nom d'une entrée AutoText qui contient le texte de la barre d'état pour le champ de formulaire.

Microsoft Word autorise les chaînes d'au plus 138 caractères.
