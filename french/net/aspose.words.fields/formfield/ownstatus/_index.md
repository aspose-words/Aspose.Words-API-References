...
description: Spécifie la source du texte affiché dans la barre détat lorsquun champ de formulaire a le focus.
type: docs
weight: 160
...
Si true, le texte spécifié par la propriété StatusText est affiché. Si false, le texte de l'insertion automatique spécifiée par la propriété StatusText est affiché.
