...
description: FormField propriété. Obtient ou définit létat coché du champ de formulaire de case à cocher. La valeur par défaut de cette propriété est faux .
type: docs
weight: 30
...
Obtient ou définit l'état coché du champ de formulaire de case à cocher. La valeur par défaut de cette propriété est **faux** .
