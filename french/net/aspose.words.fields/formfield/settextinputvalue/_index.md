...
description: Applique le format de texte spécifié dansTextInputFormataspose.words.fields/formfield/textinputformat/ et stocke la valeur dansResultaspose.words.fields/formfield/result/ .
type: docs
weight: 250
...
Applique le format de texte spécifié dans[`TextInputFormat`](../textinputformat/) et stocke la valeur dans[`Result`](../result/) .
...
| --- | --- | --- |
| newValue | Object | Peut être une chaîne, un nombre ou un objet DateTime. |

### Remarques

La[`TextInputDefault`](../textinputdefault/) la valeur est appliquée si*newValue* est`nul`.
