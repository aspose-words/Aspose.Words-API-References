...
description: Découvrez comment la méthode FormField SetTextInputValue améliore la mise en forme du texte et stocke efficacement les résultats, simplifiant ainsi votre processus de saisie de données.
type: docs
weight: 250
...
| --- | --- | --- |
| newValue | Object | Peut être une chaîne, un nombre ou un**Date et heure** objet. |
