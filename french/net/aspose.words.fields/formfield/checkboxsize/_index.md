...
description: Obtient ou définit la taille de la case à cocher en points. Na deffet que lorsqueIsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsize/ est vrai.
type: docs
weight: 20
...
Obtient ou définit la taille de la case à cocher en points. N'a d'effet que lorsque[`IsCheckBoxExactSize`](../ischeckboxexactsize/) est vrai.
...
Applicable pour un champ de formulaire de case à cocher uniquement.
