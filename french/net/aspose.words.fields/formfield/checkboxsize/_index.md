...
description: Découvrez la propriété FormField CheckBoxSize pour personnaliser les dimensions des cases à cocher en points, améliorant ainsi vos formulaires lorsque IsCheckBoxExactSize est activé.
type: docs
weight: 20
...
Obtient ou définit la taille de la case à cocher en points. Effet uniquement lorsque[`IsCheckBoxExactSize`](../ischeckboxexactsize/) est`vrai` .
