...
description: FormField propriété. Spécifie la source du texte affiché dans une boîte de message lorsquun champ de formulaire a le focus et que lutilisateur appuie sur F1.
type: docs
weight: 150
...
Si True, le texte spécifié par la propriété HelpText s'affiche. Si False, le texte de l'insertion automatique spécifiée par la propriété HelpText s'affiche.
