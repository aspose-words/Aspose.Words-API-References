...
description: Découvrez comment personnaliser la propriété « Par défaut » du champ de formulaire pour définir la valeur par défaut de votre case à cocher. Améliorez l'expérience utilisateur grâce à des ajustements de valeur faciles !
type: docs
weight: 40
...
Obtient ou définit la valeur par défaut du champ de formulaire de case à cocher. La valeur par défaut de cette propriété est`FAUX` .
