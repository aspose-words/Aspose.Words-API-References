...
description: Découvrez la propriété FormField MaxLength pour définir les limites des champs de texte. Améliorez l'expérience utilisateur grâce à des paramètres de longueur personnalisables pour une saisie de données optimale.
type: docs
weight: 120
...
Longueur maximale du champ de texte. Zéro si la longueur n'est pas limitée.
