...
description: Découvrez la propriété FormField DropDownSelectedIndex pour gérer facilement les sélections déroulantes, améliorant ainsi l'expérience utilisateur et les fonctionnalités du formulaire.
type: docs
weight: 60
...
Obtient ou définit l'index spécifiant l'élément actuellement sélectionné dans un champ de formulaire déroulant.
