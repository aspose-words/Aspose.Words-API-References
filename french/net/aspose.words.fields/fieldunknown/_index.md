...
description: Aspose.Words.Fields.FieldUnknown classe. Implémente un champ inconnu ou non reconnu en C#.
type: docs
weight: 2550
...
Montre comment utiliser le champ « FieldNone » dans un document.

```csharp
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);

// Insère un champ qui ne désigne pas de type de champ objectif dans son code de champ.
...
// Nous pouvons également continuer à travailler avec ces champs et les affecter comme instances de la classe FieldUnknown.
