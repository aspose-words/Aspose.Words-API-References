...
description: Découvrez la classe Aspose.Words.Fields.FieldImport, conçue pour rationaliser le traitement des documents avec une implémentation efficace du champ IMPORT pour une productivité améliorée.
type: docs
weight: 2430
url: /fr/net/aspose.words.fields/fieldimport/
---
## FieldImport class
...
| [GraphicFilter](../../aspose.words.fields/fieldimport/graphicfilter/) { get; set; } | Obtient ou définit le nom du filtre pour le format du graphique à insérer. |
...
| [IsLinked](../../aspose.words.fields/fieldimport/islinked/) { get; set; } | Obtient ou définit s'il faut réduire la taille du fichier en ne stockant pas de données graphiques avec le document. |
...
| [SourceFullName](../../aspose.words.fields/fieldimport/sourcefullname/) { get; set; } | Obtient ou définit l'emplacement de l'image. |
