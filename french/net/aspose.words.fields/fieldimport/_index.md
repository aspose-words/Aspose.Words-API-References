...
description: Aspose.Words.Fields.FieldImport classe. Implémente le champ IMPORT en C#.
type: docs
weight: 2020
...
| [IsLinked](../../aspose.words.fields/fieldimport/islinked/) { get; set; } | Obtient ou définit s'il faut réduire la taille du fichier en ne stockant pas les données graphiques avec le document. |
