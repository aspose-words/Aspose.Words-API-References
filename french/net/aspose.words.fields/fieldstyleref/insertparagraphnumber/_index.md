...
description: Découvrez la propriété FieldStyleRef InsertParagraphNumber pour gérer facilement la numérotation des paragraphes dans vos documents, garantissant des références précises et une mise en forme améliorée.
type: docs
weight: 20
url: /fr/net/aspose.words.fields/fieldstyleref/insertparagraphnumber/
---
## FieldStyleRef.InsertParagraphNumber property

Obtient ou définit s'il faut insérer le numéro de paragraphe du paragraphe référencé exactement tel qu'il apparaît dans le document.
