...
description: Découvrez la propriété FieldFormat DateTimeFormat pour personnaliser facilement les résultats des champs de date et d'heure pour une présentation et une clarté des données améliorées.
type: docs
weight: 10
url: /fr/net/aspose.words.fields/fieldformat/datetimeformat/
---
## FieldFormat.DateTimeFormat property

Obtient ou définit une mise en forme appliquée au résultat d'un champ de date et d'heure. Correspond à l'option \@.
