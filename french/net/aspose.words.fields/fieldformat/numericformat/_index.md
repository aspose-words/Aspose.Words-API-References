...
description: Découvrez comment la propriété FieldFormat NumericFormat personnalise les résultats des champs numériques, améliorant ainsi efficacement la présentation des données et l'expérience utilisateur.
type: docs
weight: 30
...
Obtient ou définit une mise en forme appliquée au résultat d'un champ numérique. Correspond à l'option \#.
