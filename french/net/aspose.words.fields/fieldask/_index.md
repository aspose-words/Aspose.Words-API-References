...
description: Implémente le champ ASK.
type: docs
weight: 1410
...
| [DefaultResponse](../../aspose.words.fields/fieldask/defaultresponse) { get; set; } | Obtient ou définit la réponse de l'utilisateur par défaut (valeur initiale contenue dans la fenêtre d'invite). |
...
| [PromptText](../../aspose.words.fields/fieldask/prompttext) { get; set; } | Obtient ou définit le texte de l'invite (le titre de la fenêtre d'invite). |
...
Invite l'utilisateur à entrer des informations et attribue un signet pour représenter la réponse de l'utilisateur.
