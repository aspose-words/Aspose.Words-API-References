...
description: Découvrez la classe Aspose.Words.Fields.FieldLink pour une implémentation fluide des champs LINK. Améliorez le traitement de vos documents grâce à de puissantes fonctionnalités dès aujourd'hui !
type: docs
weight: 2520
...
| Nom | La description |
| --- | --- |
| [AutoUpdate](../../aspose.words.fields/fieldlink/autoupdate/) { get; set; } | Obtient ou définit si ce champ doit être mis à jour automatiquement. |
| [DisplayResult](../../aspose.words.fields/field/displayresult/) { get; } | Obtient le texte qui représente le résultat du champ affiché. |
| [End](../../aspose.words.fields/field/end/) { get; } | Obtient le nœud qui représente la fin du champ. |
| [Format](../../aspose.words.fields/field/format/) { get; } | Obtient un[`FieldFormat`](../fieldformat/)objet qui fournit un accès typé au formatage du champ. |
| [FormatUpdateType](../../aspose.words.fields/fieldlink/formatupdatetype/) { get; set; } | Obtient ou définit la manière dont l'objet lié met à jour sa mise en forme. |
| [InsertAsBitmap](../../aspose.words.fields/fieldlink/insertasbitmap/) { get; set; } | Obtient ou définit s'il faut insérer l'objet lié sous forme de bitmap. |
| [InsertAsHtml](../../aspose.words.fields/fieldlink/insertashtml/) { get; set; } | Obtient ou définit s'il faut insérer l'objet lié sous forme de texte au format HTML. |
...
| [InsertAsUnicode](../../aspose.words.fields/fieldlink/insertasunicode/) { get; set; } | Obtient ou définit s'il faut insérer l'objet lié sous forme de texte Unicode. |
...
| [IsLinked](../../aspose.words.fields/fieldlink/islinked/) { get; set; } | Obtient ou définit s'il faut réduire la taille du fichier en ne stockant pas de données graphiques avec le document. |
...
Pour les informations copiées à partir d'une autre application, ce champ relie ces informations à leur fichier source d'origine .
