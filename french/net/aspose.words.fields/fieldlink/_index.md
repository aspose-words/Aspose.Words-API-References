...
description: Aspose.Words.Fields.FieldLink classe. Implémente le champ LINK en C#.
type: docs
weight: 2110
...
| [InsertAsRtf](../../aspose.words.fields/fieldlink/insertasrtf/) { get; set; } | Obtient ou définit s'il faut insérer l'objet lié au format de texte enrichi (RTF). |
...
Pour les informations copiées à partir d'une autre application, ce champ lie ces informations à son fichier source original .
