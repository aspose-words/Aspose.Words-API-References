...
description: CustomDocumentProperties méthode. Crée une nouvelle propriété de document personnalisée liée au contenu.
type: docs
weight: 20
...
L'objet de propriété nouvellement créé ou null lorsque le linkSource n'est pas valide.
