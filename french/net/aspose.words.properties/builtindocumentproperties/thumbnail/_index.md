...
Pour l'instant, cette propriété est utilisée uniquement lorsqu'un document est exporté vers ePub, il n'est pas lu ni écrit dans d'autres formats de document.

Une image au format arbitraire peut être définie sur cette propriété, mais le format est vérifié lors de l'exportation. InvalidOperationException est lancé si l'image n'est pas valide ou si son format n'est pas pris en charge pour format spécifique du document.
