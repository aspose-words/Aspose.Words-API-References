...
description: Découvrez la méthode Row AcceptEnd pour améliorer l'expérience de vos visiteurs en les guidant facilement jusqu'à la fin d'une ligne. Boostez l'engagement dès aujourd'hui !
type: docs
weight: 130
url: /fr/net/aspose.words.tables/row/acceptend/
---
## Row.AcceptEnd method

Accepte un visiteur pour visiter la fin de la ligne.
