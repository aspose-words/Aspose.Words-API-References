...
description: Découvrez la propriété Row NodeType qui renvoie efficacement les données Row, améliorant ainsi la gestion de vos données et les performances de vos applications.
type: docs
weight: 80
