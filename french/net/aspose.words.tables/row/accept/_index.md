...
description: Découvrez la méthode Row Accept, conçue pour améliorer l'engagement des visiteurs et rationaliser les interactions des utilisateurs pour le succès de votre site Web.
type: docs
weight: 120
url: /fr/net/aspose.words.tables/row/accept/
---
## Row.Accept method
...
Appels[`VisitRowStart`](../../../aspose.words/documentvisitor/visitrowstart/) , puis appelle[`Accept`](../../../aspose.words/node/accept/) pour tous les nœuds enfants de la section et les appels[`VisitRowEnd`](../../../aspose.words/documentvisitor/visitrowend/) à la fin.
