...
description: Découvrez la propriété Row IsFirstRow pour identifier facilement la première ligne d'un tableau. Améliorez l'organisation de vos données grâce à cette fonctionnalité essentielle !
type: docs
weight: 40
...
Vrai s'il s'agit de la première ligne d'un tableau ; faux sinon.
