...
description: Découvrez la propriété Row FirstCell, accédez sans effort à la première cellule d'une ligne pour une gestion simplifiée des données et une productivité améliorée.
type: docs
weight: 30
...
Renvoie le premier[`Cell`](../../cell/) dans la rangée.
