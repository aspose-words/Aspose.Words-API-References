...
description: Aspose.Words.Tables.RowCollection classe. Fournit un accès typé à une collection deRow nœuds en C#.
type: docs
weight: 6320
...
| [ToArray](../../aspose.words.tables/rowcollection/toarray/#toarray_1)() | Copie toutes les lignes de la collection vers un nouveau tableau de lignes. (2 methods) |
