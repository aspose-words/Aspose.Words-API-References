...
| [Value](../../aspose.words.tables/preferredwidth/value/) { get; } | Obtient la valeur de largeur préférée. L'unité de mesure est précisée dans le[`Type`](./type/) propriété. |
...
| [Equals](../../aspose.words.tables/preferredwidth/equals/#equals)(PreferredWidth) | Détermine si le PreferredWidth spécifié est égal en valeur au PreferredWidth actuel. |
