...
description: Découvrez la méthode PreferredWidth ToString, qui génère une chaîne conviviale présentant la valeur de votre objet pour une clarté et une convivialité améliorées.
type: docs
weight: 80
