...
Montre comment créer un tableau imbriqué à l'aide d'un générateur de document.
...
// Déplacez-vous vers la première cellule de la table externe, puis créez une autre table à l'intérieur de la cellule.
