...
description: Cell constructeur. Initialise une nouvelle instance duCell classe en C#.
type: docs
weight: 10
...
À ajouter[`Cell`](../) à l'utilisation du document[`InsertAfter`](../../../aspose.words/compositenode/insertafter/) ou[`InsertBefore`](../../../aspose.words/compositenode/insertbefore/) sur la ligne où vous souhaitez insérer la cellule.
