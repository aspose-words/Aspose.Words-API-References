...
description: Découvrez la propriété Cell IsFirstCell, identifiez facilement la première cellule d'une ligne, améliorant ainsi l'organisation et l'efficacité de votre gestion des données.
type: docs
weight: 40
...
Vrai s'il s'agit de la première cellule d'une ligne ; faux sinon.
