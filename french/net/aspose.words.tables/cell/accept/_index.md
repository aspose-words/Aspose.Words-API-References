...
description: Découvrez la méthode Cell Accept : améliorez l'engagement des visiteurs et simplifiez les interactions pour une expérience fluide. Libérez le potentiel de votre site dès aujourd'hui !
type: docs
weight: 130
...
Appels[`VisitCellStart`](../../../aspose.words/documentvisitor/visitcellstart/) , puis appelle[`Accept`](../../../aspose.words/node/accept/) pour tous les nœuds enfants de la section et les appels[`VisitCellEnd`](../../../aspose.words/documentvisitor/visitcellend/) à la fin.
