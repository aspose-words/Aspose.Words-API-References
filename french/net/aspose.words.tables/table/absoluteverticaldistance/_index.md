...
description: Table propriété. Obtient ou définit la position verticale absolue du tableau flottant spécifiée par les propriétés du tableau en points. La valeur par défaut est 0.
type: docs
weight: 30
