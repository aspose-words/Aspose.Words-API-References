---
title: Table.AcceptEnd
linktitle: AcceptEnd
articleTitle: AcceptEnd
second_title: Aspose.Words pour .NET
description: Découvrez la méthode Table AcceptEnd, intégrez de manière transparente les visiteurs à la fin de la table pour une expérience utilisateur améliorée et une gestion efficace des données.
type: docs
weight: 360
url: /fr/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

Accepte un visiteur pour visiter la fin de la table.
