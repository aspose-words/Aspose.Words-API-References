...
description: Découvrez la méthode Table AcceptStart pour accueillir de manière transparente les visiteurs au début de la table, améliorant ainsi l'expérience et l'engagement des utilisateurs.
type: docs
weight: 370
url: /fr/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Accepte un visiteur pour visiter le début de la table.
