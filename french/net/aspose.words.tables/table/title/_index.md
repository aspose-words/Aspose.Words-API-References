...
description: Table propriété. Obtient ou définit le titre de cette table. Il fournit une représentation textuelle alternative des informations contenues dans la table.
type: docs
weight: 320
