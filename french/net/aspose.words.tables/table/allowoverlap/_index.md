...
description: Obtient si une table flottante doit autoriser dautres objets flottants dans le document à chevaucher ses étendues lorsquil est affiché. La valeur par défaut estvrai .
type: docs
weight: 70
