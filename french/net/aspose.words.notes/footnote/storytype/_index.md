...
description: Découvrez la propriété Footnote StoryType pour accéder facilement aux notes de bas de page ou aux notes de fin, améliorant ainsi la clarté et la profondeur de votre contenu pour les lecteurs.
type: docs
weight: 70
