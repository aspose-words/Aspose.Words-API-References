...
description: Obtient/définit la marque de référence personnalisée à utiliser pour cette note de bas de page. La valeur par défaut est chaîne vide Empty  ce qui signifie que des notes de bas de page numérotées automatiquement sont utilisées.
type: docs
weight: 50
