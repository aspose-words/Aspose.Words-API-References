...
description: Découvrez la propriété ChartDataPoint Index, personnalisez facilement la mise en forme des points de données pour une visualisation et des informations améliorées sur les données dans vos graphiques.
type: docs
weight: 40
...
Index du point de données auquel cet objet applique la mise en forme.
