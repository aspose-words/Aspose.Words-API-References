...
description: Découvrez comment la méthode ChartDataPoint ClearFormat réinitialise le format par défaut de vos points de données, améliorant ainsi la clarté et la cohérence de vos graphiques.
type: docs
weight: 70
...
Efface le format de ce point de données. Les propriétés sont définies sur les valeurs par défaut définies dans la série parente.
