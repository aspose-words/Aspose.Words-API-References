...
description: ChartSeriesCollection méthode. Supprime unChartSeries à lindex spécifié.
type: docs
weight: 60
...
Supprime un[`ChartSeries`](../../chartseries/) à l'index spécifié.
...
| --- | --- | --- |
| index | Int32 | Index de base zéro du ChartSeries à supprimer. |
