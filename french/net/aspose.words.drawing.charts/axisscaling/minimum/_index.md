...
description: Découvrez la propriété AxisScaling Minimum pour définir et personnaliser facilement la valeur minimale de votre axe pour une visualisation améliorée des données.
type: docs
weight: 40
