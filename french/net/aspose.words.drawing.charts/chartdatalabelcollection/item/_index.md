...
description: Accédez facilement à des ChartDataLabel spécifiques grâce à la propriété Item de ChartDataLabelCollection. Améliorez votre visualisation de données dès aujourd'hui !
type: docs
weight: 40
url: /fr/net/aspose.words.drawing.charts/chartdatalabelcollection/item/
---
## ChartDataLabelCollection indexer

Retours[`ChartDataLabel`](../../chartdatalabel/) pour l'index spécifié.
