...
description: Découvrez comment utiliser la méthode ClearFormat dans ChartDataLabelCollection pour réinitialiser sans effort tous les formats d'étiquettes de données de graphique pour des visuels plus nets.
type: docs
weight: 180
url: /fr/net/aspose.words.drawing.charts/chartdatalabelcollection/clearformat/
---
## ChartDataLabelCollection.ClearFormat method

Efface le format de tous[`ChartDataLabel`](../../chartdatalabel/) dans cette collection.
