...
description: ChartDataLabelCollection propriété. Permet de spécifier si la clé de légende doit être affichée pour les étiquettes de données de toute la série. La valeur par défaut est faux .
type: docs
weight: 90
...
La valeur définie pour cette propriété peut être remplacée pour une étiquette de données individuelle à l'aide de the [`ShowLegendKey`](../../chartdatalabel/showlegendkey/) propriété.
