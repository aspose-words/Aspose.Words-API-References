...
description: Permet de spécifier si la taille des bulles doit être affichée pour les étiquettes de données de toute la série. Sapplique uniquement aux graphiques à bulles. La valeur par défaut est faux .
type: docs
weight: 50
