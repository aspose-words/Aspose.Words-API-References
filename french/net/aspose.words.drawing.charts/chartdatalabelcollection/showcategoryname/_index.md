...
description: ChartDataLabelCollection propriété. Permet de spécifier si le nom de la catégorie doit être affiché pour les étiquettes de données de toute la série. La valeur par défaut est faux .
type: docs
weight: 60
...
La valeur définie pour cette propriété peut être remplacée pour une étiquette de données individuelle à l'aide de the [`ShowCategoryName`](../../chartdatalabel/showcategoryname/) propriété.
