...
La valeur par défaut estNone . LaCustom et Percentage les valeurs ne sont pas disponibles dans certains types de graphiques ; voir [`AxisBuiltInUnit`](../../axisbuiltinunit/) pour plus d'informations.
