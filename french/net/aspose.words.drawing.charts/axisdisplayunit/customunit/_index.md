...
description: Découvrez la propriété AxisDisplayUnit CustomUnit pour personnaliser facilement les unités d'affichage de votre axe de valeur avec une mise à l'échelle définie par l'utilisateur pour une clarté des données améliorée.
type: docs
weight: 20
...
Cette propriété n'est pas prise en charge par les nouveaux graphiques de MS Office 2016. La valeur par défaut est 1.

La définition de cette propriété définit le[`Unit`](../unit/) propriété to Custom.
