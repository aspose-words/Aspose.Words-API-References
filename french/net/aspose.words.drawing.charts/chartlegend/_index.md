...
| [Overlay](../../aspose.words.drawing.charts/chartlegend/overlay/) { get; set; } | Détermine si d'autres éléments du graphique doivent être autorisés à chevaucher la légende. La valeur par défaut est false. |
