...
description: AxisBound propriété. Renvoie la valeur de laxe lié représenté sous la forme datetime.
type: docs
weight: 40
...
Renvoie la valeur de l'axe lié représenté sous la forme datetime.
