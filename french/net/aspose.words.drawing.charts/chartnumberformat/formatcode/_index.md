...
Le formatage des nombres est utilisé pour modifier la façon dont une valeur apparaît dans l'étiquette de données et peut être utilisé de manière très créative. Les exemples de formats de nombre :
