...
description: Découvrez comment la propriété ChartAxis DisplayUnit améliore la visualisation de vos données en optimisant la mise à l'échelle de l'axe des valeurs pour des informations plus claires.
type: docs
weight: 60
