...
description: ChartAxis propriété. Spécifie la valeur déchelle des unités daffichage pour laxe des ordonnées.
type: docs
weight: 60
...
Spécifie la valeur d'échelle des unités d'affichage pour l'axe des ordonnées.
...
La propriété n'a d'effet que pour les axes de valeur.
