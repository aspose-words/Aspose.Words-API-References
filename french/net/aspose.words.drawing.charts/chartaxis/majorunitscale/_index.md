...
description: ChartAxis MajorUnitScale propriété. Renvoie ou définit la valeur déchelle pour les graduations principales sur laxe des catégories de temps en C#.
type: docs
weight: 140
...
Renvoie ou définit la valeur d'échelle pour les graduations principales sur l'axe des catégories de temps.
