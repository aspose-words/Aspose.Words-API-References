...
description: Découvrez comment la propriété ChartAxis MinorUnitIsAuto optimise les graduations de votre graphique pour une visualisation plus claire des données. Améliorez vos graphiques sans effort !
type: docs
weight: 180
...
Obtient ou définit un indicateur indiquant si la distance par défaut entre les graduations mineures doit être utilisée.
...
La propriété a un effet sur les axes de catégorie de temps et de valeur.
