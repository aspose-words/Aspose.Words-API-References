...
description: ChartAxis propriété. Obtient ou définit un indicateur indiquant si la distance par défaut entre les principales graduations doit être utilisée.
type: docs
weight: 130
