...
description: ChartAxis propriété. Obtient ou définit un indicateur indiquant si la distance par défaut entre les graduations principales doit être utilisée.
type: docs
weight: 110
