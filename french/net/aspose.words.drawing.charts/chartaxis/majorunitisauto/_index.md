...
description: Découvrez la propriété ChartAxis MajorUnitIsAuto, contrôlez facilement l'espacement des graduations principales pour une clarté et une précision accrues du graphique dans vos visualisations de données.
type: docs
weight: 140
url: /fr/net/aspose.words.drawing.charts/chartaxis/majorunitisauto/
---
## ChartAxis.MajorUnitIsAuto property

Obtient ou définit un indicateur indiquant si la distance par défaut entre les graduations principales doit être utilisée.
