...
description: ChartAxis MajorUnitIsAuto propriété. Obtient ou définit un indicateur indiquant si la distance par défaut entre les principales graduations doit être utilisée en C#.
type: docs
weight: 130
...
Obtient ou définit un indicateur indiquant si la distance par défaut entre les principales graduations doit être utilisée.
