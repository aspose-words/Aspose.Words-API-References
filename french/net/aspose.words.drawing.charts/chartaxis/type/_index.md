...
description: Découvrez la propriété ChartAxis Type pour identifier facilement les types d'axes et améliorer la visualisation de vos données pour des informations plus claires et une meilleure analyse.
type: docs
weight: 260
