...
description: Découvrez la propriété ChartAxis MinorUnitScale pour personnaliser facilement les graduations mineures sur votre axe de catégorie temporelle pour une visualisation améliorée des données.
type: docs
weight: 190
...
Renvoie ou définit la valeur d'échelle pour les graduations mineures sur l'axe des catégories temporelles.
...
La propriété n'a d'effet que sur les axes de catégorie de temps.
