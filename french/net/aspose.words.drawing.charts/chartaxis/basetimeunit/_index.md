...
description: Découvrez la propriété ChartAxis BaseTimeUnit pour définir facilement la plus petite unité de temps sur votre axe de catégorie de temps pour une visualisation améliorée des données.
type: docs
weight: 20
