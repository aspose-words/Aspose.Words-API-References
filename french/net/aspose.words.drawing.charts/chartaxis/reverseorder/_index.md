...
description: Découvrez la propriété ChartAxis ReverseOrder pour afficher facilement les valeurs des axes à l'envers, améliorant ainsi la clarté des données du maximum au minimum.
type: docs
weight: 210
...
La propriété n'est pas prise en charge par les nouveaux graphiques de MS Office 2016. La valeur par défaut est`FAUX` .
