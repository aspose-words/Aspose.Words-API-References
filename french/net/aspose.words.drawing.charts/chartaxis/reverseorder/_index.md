...
description: ChartAxis propriété. Renvoie ou définit un indicateur indiquant si les valeurs de laxe doivent être affichées dans lordre inverse cestàdire de max à min.
type: docs
weight: 200
