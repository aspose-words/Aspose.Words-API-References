...
description: Découvrez l'énumération Aspose.Words.Drawing.Charts.AxisCrosses pour définir les points de croisement des axes, améliorant ainsi vos capacités de création de graphiques sans effort.
type: docs
weight: 780
...
| --- | --- | --- |
| Automatic | `0` | L'axe des catégories croise le point zéro de l'axe des valeurs (si possible), ou à la valeur minimale si le minimum est supérieur à zéro, ou au maximum si le maximum est inférieur à zéro. |
| Maximum | `1` | Un axe perpendiculaire croise à la valeur maximale de l'axe. |
| Minimum | `2` | Un axe perpendiculaire croise la valeur minimale de l'axe. |
| Custom | `3` | Un axe perpendiculaire croise la valeur spécifiée de l'axe. |
