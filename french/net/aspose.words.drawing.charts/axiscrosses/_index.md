...
| --- | --- | --- |
| Automatic | `0` | L'axe des catégories se croise au point zéro de l'axe des valeurs (si possible), ou à la valeur minimale si le minimum est supérieur à zéro, ou au maximum si le maximum est inférieur à zéro. |
| Maximum | `1` | Un axe perpendiculaire se croise à la valeur maximale de l'axe. |
