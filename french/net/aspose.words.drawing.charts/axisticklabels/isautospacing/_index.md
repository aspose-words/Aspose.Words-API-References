...
description: Découvrez la propriété AxisTickLabels IsAutoSpacing pour gérer sans effort les intervalles automatiques des étiquettes de graduation pour une visualisation précise des données dans vos projets.
type: docs
weight: 30
url: /fr/net/aspose.words.drawing.charts/axisticklabels/isautospacing/
---
## AxisTickLabels.IsAutoSpacing property

Obtient ou définit un indicateur indiquant s'il faut utiliser l'intervalle automatique pour dessiner les étiquettes de graduation.
