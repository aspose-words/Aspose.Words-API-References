...
description: Ajustez facilement l'alignement des AxisTickLabels. Contrôlez le positionnement du texte pour des graphiques plus clairs et lisibles et améliorez la visualisation de vos données.
type: docs
weight: 10
url: /fr/net/aspose.words.drawing.charts/axisticklabels/alignment/
---
## AxisTickLabels.Alignment property

Obtient ou définit l'alignement du texte des étiquettes de graduation des axes.
