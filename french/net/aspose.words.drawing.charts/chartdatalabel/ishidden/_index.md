...
description: Découvrez la propriété ChartDataLabel IsHidden pour contrôler facilement la visibilité des étiquettes dans vos graphiques. Améliorez la présentation de vos données grâce à cette fonctionnalité simple !
type: docs
weight: 40
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/ishidden/
---
## ChartDataLabel.IsHidden property

Obtient/définit un indicateur indiquant si cette étiquette est masquée. La valeur par défaut est`FAUX` .
