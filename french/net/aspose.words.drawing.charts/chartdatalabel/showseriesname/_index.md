...
description: ChartDataLabel propriété. Renvoie ou définit un booléen pour indiquer le comportement daffichage du nom de la série pour les étiquettes de données sur un graphique. True pour afficher le nom de la série. Faux pour cacher. Par défaut faux.
type: docs
weight: 120
...
Renvoie ou définit un booléen pour indiquer le comportement d'affichage du nom de la série pour les étiquettes de données sur un graphique. True pour afficher le nom de la série. Faux pour cacher. Par défaut faux.
