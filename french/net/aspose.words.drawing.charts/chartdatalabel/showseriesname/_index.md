...
description: Renvoie ou définit un booléen pour indiquer le comportement daffichage du nom de la série pour les étiquettes de données sur un graphique. True pour afficher le nom de la série. Faux pour cacher. Par défaut faux.
type: docs
weight: 120
