...
description: Découvrez la propriété ChartDataLabel TopMode pour personnaliser le positionnement des étiquettes de données sur vos graphiques. Améliorez la clarté et la précision de vos présentations visuelles de données !
type: docs
weight: 220
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/topmode/
---
## ChartDataLabel.TopMode property

Obtient ou définit le mode d'interprétation du[`Top`](../top/) valeur de la propriété : si elle définit l'emplacement de l'étiquette de données à partir du bord supérieur du graphique ou à partir de la position spécifiée par son[`Position`](../position/) Propriété .
