...
description: Découvrez la propriété ChartDataLabel ShowDataLabelsRange pour améliorer vos graphiques en affichant les valeurs des étiquettes de données. Gagnez en clarté grâce à cette fonctionnalité simple !
type: docs
weight: 150
...
Permet de spécifier si les valeurs des étiquettes de données doivent être affichées dans les étiquettes de données. La valeur par défaut est`FAUX` .
