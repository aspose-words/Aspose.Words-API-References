...
description: Découvrez comment utiliser la méthode ChartDataLabel ClearFormat pour réinitialiser vos étiquettes de données aux paramètres par défaut, améliorant ainsi la clarté et la cohérence de vos graphiques.
type: docs
weight: 230
...
Efface le format de cette étiquette de données. Les propriétés sont définies sur les valeurs par défaut définies dans la collection d'étiquettes parente data .
