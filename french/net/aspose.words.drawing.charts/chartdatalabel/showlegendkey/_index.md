...
description: Découvrez la propriété ShowLegendKey de ChartDataLabel pour contrôler facilement la visibilité des légendes sur vos graphiques. Améliorez la clarté et la présentation des données sans effort !
type: docs
weight: 170
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/showlegendkey/
---
## ChartDataLabel.ShowLegendKey property

Permet de spécifier si la clé de légende doit être affichée pour les étiquettes de données sur un graphique. La valeur par défaut est`FAUX` .
