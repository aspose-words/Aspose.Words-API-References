...
description: Découvrez la propriété Format ChartDataLabel pour un accès facile au remplissage et au formatage de ligne personnalisables, améliorant ainsi la visualisation de vos données sans effort.
type: docs
weight: 20
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/format/
---
## ChartDataLabel.Format property

Donne accès au remplissage et au formatage des lignes de l'étiquette de données.
