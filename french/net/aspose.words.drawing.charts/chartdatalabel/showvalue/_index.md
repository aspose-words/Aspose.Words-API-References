...
description: ChartDataLabel propriété. Permet de spécifier si les valeurs doivent être affichées dans les étiquettes de données. La valeur par défaut estFAUX .
type: docs
weight: 150
