...
description: Activez l'affichage en pourcentage sur les étiquettes de données des graphiques grâce à la propriété ShowPercentage de ChartDataLabel. Améliorez la clarté et la visibilité de vos données visuelles !
type: docs
weight: 180
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/showpercentage/
---
## ChartDataLabel.ShowPercentage property

Permet de spécifier si la valeur en pourcentage doit être affichée pour les étiquettes de données sur un graphique. La valeur par défaut est`FAUX` .
