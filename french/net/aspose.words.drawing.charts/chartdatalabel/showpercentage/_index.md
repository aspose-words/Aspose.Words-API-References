...
description: ChartDataLabel propriété. Permet de spécifier si une valeur en pourcentage doit être affichée pour les étiquettes de données sur un graphique. La valeur par défaut estFAUX .
type: docs
weight: 130
