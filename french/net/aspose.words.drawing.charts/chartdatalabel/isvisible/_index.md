...
description: Découvrez comment la propriété ChartDataLabel IsVisible améliore la visualisation des données en confirmant quand les étiquettes sont prêtes à afficher des informations précieuses.
type: docs
weight: 50
url: /fr/net/aspose.words.drawing.charts/chartdatalabel/isvisible/
---
## ChartDataLabel.IsVisible property

Retours`vrai` si cette étiquette de données a quelque chose à afficher.
