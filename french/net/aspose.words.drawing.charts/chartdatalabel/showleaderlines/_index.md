...
description: Améliorez vos graphiques avec la propriété ShowLeaderLines de ChartDataLabel. Affichez facilement les lignes de repère des étiquettes de données pour une visualisation plus claire des données.
type: docs
weight: 160
