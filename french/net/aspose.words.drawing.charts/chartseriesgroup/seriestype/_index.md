...
description: Découvrez la propriété SeriesType de ChartSeriesGroup pour identifier facilement les types de séries de graphiques dans vos visualisations de données pour une analyse et des informations améliorées.
type: docs
weight: 110
url: /fr/net/aspose.words.drawing.charts/chartseriesgroup/seriestype/
---
## ChartSeriesGroup.SeriesType property

Obtient le type de série de graphiques inclus dans ce groupe.
