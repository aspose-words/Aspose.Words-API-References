...
description: Découvrez la propriété ChartSeriesGroup AxisX pour un accès facile aux fonctionnalités de l'axe X, améliorant ainsi votre expérience de visualisation et d'analyse des données.
type: docs
weight: 20
url: /fr/net/aspose.words.drawing.charts/chartseriesgroup/axisx/
---
## ChartSeriesGroup.AxisX property

Donne accès aux propriétés de l'axe X de ce groupe de séries.
