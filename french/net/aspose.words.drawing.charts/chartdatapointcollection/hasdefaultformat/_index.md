...
description: Découvrez si le point de données d'un index spécifique dans ChartDataPointCollection utilise le format par défaut. Améliorez votre visualisation de données dès aujourd'hui !
type: docs
weight: 60
url: /fr/net/aspose.words.drawing.charts/chartdatapointcollection/hasdefaultformat/
---
## ChartDataPointCollection.HasDefaultFormat method

Obtient un indicateur indiquant si le point de données à l'index spécifié a un format par défaut.
