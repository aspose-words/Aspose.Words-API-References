...
description: Obtient ou définit le nom de la série si le nom nest pas défini explicitement il est généré à laide de lindex. Par défaut renvoie la série plus un index basé.
type: docs
weight: 100
