...
description: ChartSeries propriété. Permet de spécifier si la ligne reliant les points sur le graphique doit être lissée à laide de splines CatmullRom.
type: docs
weight: 110
...
Permet de spécifier si la ligne reliant les points sur le graphique doit être lissée à l'aide de splines Catmull-Rom.
