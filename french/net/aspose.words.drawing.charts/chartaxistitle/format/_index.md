...
description: Découvrez la propriété Format ChartAxisTitle pour une personnalisation facile du remplissage du titre de l'axe et des styles de ligne, améliorant ainsi la visualisation de vos données.
type: docs
weight: 20
url: /fr/net/aspose.words.drawing.charts/chartaxistitle/format/
---
## ChartAxisTitle.Format property

Donne accès au remplissage et au formatage des lignes du titre de l'axe.
