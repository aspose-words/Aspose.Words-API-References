...
description: Accédez à des fonctionnalités avancées de mise en forme de graphiques grâce à notre outil ! Personnalisez facilement les styles de remplissage et de ligne pour des visuels professionnels et époustouflants qui sublimeront la présentation de vos données.
type: docs
weight: 60
url: /fr/net/aspose.words.drawing.charts/chart/format/
---
## Chart.Format property

Donne accès au remplissage et au formatage des lignes du graphique.
