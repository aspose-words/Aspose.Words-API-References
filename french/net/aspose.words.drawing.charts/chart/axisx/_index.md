...
description: Explorez la propriété Chart AxisX pour un contrôle transparent sur l'axe X principal de votre graphique, améliorant ainsi la visualisation et les informations sur les données.
type: docs
weight: 20
...
Donne accès aux propriétés de l'axe X principal du graphique.
