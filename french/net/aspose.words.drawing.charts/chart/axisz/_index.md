...
description: Explorez la propriété Chart AxisZ pour déverrouiller les options de personnalisation de l'axe Z, améliorant ainsi la visualisation de vos données pour des informations plus claires et des présentations percutantes.
type: docs
weight: 40
...
Donne accès aux propriétés de l'axe Z du graphique.
