...
description: Découvrez la propriété Chart Series pour un accès exclusif à une collection unique de séries. Améliorez votre expérience de visualisation de données dès aujourd'hui !
type: docs
weight: 80
...
Donne accès à la collection de séries.
