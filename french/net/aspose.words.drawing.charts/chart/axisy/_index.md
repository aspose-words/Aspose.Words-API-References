...
description: Explorez la propriété Axe Y du graphique pour accéder facilement à l'axe Y principal de votre graphique et le personnaliser pour une visualisation et des informations de données améliorées.
type: docs
weight: 30
...
Donne accès aux propriétés de l'axe Y principal du graphique.
