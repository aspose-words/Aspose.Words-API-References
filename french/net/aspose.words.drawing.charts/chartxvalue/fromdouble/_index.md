...
description: Découvrez la méthode ChartXValue FromDouble pour créer sans effort des instances ChartXValue de type Double, améliorant ainsi vos capacités de visualisation de données.
type: docs
weight: 20
url: /fr/net/aspose.words.drawing.charts/chartxvalue/fromdouble/
---
## ChartXValue.FromDouble method

Crée un[`ChartXValue`](../) exemple de laDouble type.
