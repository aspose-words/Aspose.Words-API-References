...
description: Découvrez l'énumération Aspose.Words.ChartDataLabelLocationMode pour personnaliser efficacement le positionnement des étiquettes de données avec des paramètres de propriétés intuitifs Gauche et Haut.
type: docs
weight: 950
url: /fr/net/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enumeration

Spécifie comment les valeurs qui spécifient l'emplacement d'une étiquette de données - le[`Left`](../chartdatalabel/left/) et [`Top`](../chartdatalabel/top/) propriétés - sont interprétées.
...
| --- | --- | --- |
| Offset | `0` | L'emplacement d'une étiquette de données est spécifié par un décalage par rapport à la position définie par its [`Position`](../chartdatalabel/position/) propriété. |
| Absolute | `1` | L'emplacement d'une étiquette de données est spécifié à l'aide de coordonnées absolues, en commençant par le coin supérieur gauche d'un graphique. |
