...
description: CommentRangeEnd constructeur. Initialise une nouvelle instance de cette classe.
type: docs
weight: 10
...
Lorsque[`CommentRangeEnd`](../) est créé, il appartient au document spécifié, mais ne fait pas encore partie du document et[`ParentNode`](../../node/parentnode/) est nul.
