...
description: Découvrez le constructeur CommentRangeEnd, créez sans effort de nouvelles instances de cette classe pour une intégration de code transparente et des fonctionnalités améliorées.
type: docs
weight: 10
url: /fr/net/aspose.words/commentrangeend/commentrangeend/
---
...
Quand[`CommentRangeEnd`](../) est créé, il appartient au document spécifié, mais ne fait pas encore partie du document et[`ParentNode`](../../node/parentnode/) est`nul`.

Pour ajouter un[`CommentRangeEnd`](../) dans le document, utilisez InsertAfter ou InsertBefore sur le paragraphe où vous souhaitez insérer le commentaire.
