...
description: Classe de base pour les éléments contenant des nœuds de niveau blocParagraph./paragraph etTable../aspose.words.tables/table .
type: docs
weight: 5810
...
On dit que le texte d'un document Word est composé de plusieurs histoires. Le texte principal est stocké dans l'histoire du texte principal représentée par[`Body`](../body) , chaque en-tête et pied de page est stocké dans un article séparé représenté par[`HeaderFooter`](../headerfooter).
