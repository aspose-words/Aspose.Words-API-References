...
description: Découvrez la méthode Story AppendParagraph, créez et ajoutez sans effort un objet Paragraph avec du texte personnalisable pour une amélioration transparente du document.
type: docs
weight: 60
...
Une méthode de raccourci qui crée un[`Paragraph`](../../paragraph/) objet avec texte facultatif et l'ajoute à la fin de cet objet.
...
| --- | --- | --- |
| text | String | Le texte du paragraphe. Peut être`nul` ou chaîne vide. |
