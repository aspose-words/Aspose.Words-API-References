...
description: Aspose.Words.FileFormatUtil classe. Fournit des méthodes utilitaires pour travailler avec des formats de fichiers telles que la détection du format de fichier ou la conversion dextensions de fichier vers/depuis des énumérations de format de fichier en C#.
type: docs
weight: 2820
...
| static [ImageTypeToExtension](../../aspose.words/fileformatutil/imagetypetoextension/)(*[ImageType](../../aspose.words.drawing/imagetype/)*) | Convertit une valeur énumérée de type d'image Aspose.Words en une extension de fichier. L'extension renvoyée est une chaîne minuscule précédée d'un point. |
| static [LoadFormatToExtension](../../aspose.words/fileformatutil/loadformattoextension/)(*[LoadFormat](../loadformat/)*) | Convertit une valeur énumérée au format de chargement en une extension de fichier. L'extension renvoyée est une chaîne minuscule précédée d'un point. |
...
| static [SaveFormatToExtension](../../aspose.words/fileformatutil/saveformattoextension/)(*[SaveFormat](../saveformat/)*) | Convertit une valeur énumérée au format de sauvegarde en une extension de fichier. L'extension renvoyée est une chaîne minuscule précédée d'un point. |
