...
description: Représente une révision modification suivie dans un nœud ou un style de document. UtilisationRevisionType./revision/revisiontype/ pour vérifier le type de cette révision.
type: docs
weight: 4500
