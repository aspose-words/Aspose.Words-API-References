...
description: Revision propriété. Obtient le groupe de révision. Renvoie null si la révision nappartient à aucun groupe.
type: docs
weight: 30
...
Obtient le groupe de révision. Renvoie null si la révision n'appartient à aucun groupe.
...
La révision n'a pas de groupe si le type de révision est RevisionType.StyleDefinitionChange ou si la révision n'existe plus dans le contexte du document (acceptée/rejetée).
