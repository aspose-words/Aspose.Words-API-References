...
description: Gérez facilement l'auteur de vos révisions. Définissez ou mettez à jour facilement les informations de l'auteur pour chaque révision, garantissant clarté et transparence dans vos documents.
type: docs
weight: 10
...
Obtient ou définit l'auteur de cette révision. Ne peut pas être une chaîne vide ou`nul` .
