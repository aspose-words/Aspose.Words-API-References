...
description: Aspose.Words.ConditionalStyleType énumération. Représente les zones de tableau possibles pour lesquelles une mise en forme conditionnelle peut être définie dans un style de tableau.
type: docs
weight: 320
...
| OddColumnBanding | `5` | Spécifie le formatage de la bande de colonne impaire. |
...
| BottomRightCell | `11` | Spécifie le formatage de la cellule en bas à droite d'un tableau. |
