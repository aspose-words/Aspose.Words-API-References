...
description: Aspose.Words.ConditionalStyleType énumération. Représente les zones de tableau possibles dans lesquelles une mise en forme conditionnelle peut être définie dans un style de tableau.
type: docs
weight: 330
