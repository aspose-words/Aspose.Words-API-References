...
description: Optimisez vos documents avec la propriété UnusedBuiltinStyles de CleanupOptions, garantissant que les styles BuiltIn inutilisés sont supprimés efficacement pour des résultats plus propres et professionnels.
type: docs
weight: 30
...
Spécifie que non utilisé[`BuiltIn`](../../style/builtin/) les styles doivent être supprimés du document.
