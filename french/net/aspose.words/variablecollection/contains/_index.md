...
description: VariableCollection méthode. Détermine si la collection contient une variable de document avec le nom donné.
type: docs
weight: 50
...
| --- | --- | --- |
| name | String | Nom insensible à la casse de la variable de document à localiser. |
