...
description: VariableCollection méthode. Ajoute une variable de document à la collection.
type: docs
weight: 30
...
| value | String | La valeur de la variable. La valeur ne peut pas être nulle, si la valeur est nulle, une chaîne vide sera utilisée à la place. |
