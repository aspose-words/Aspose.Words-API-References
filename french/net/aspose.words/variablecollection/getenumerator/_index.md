...
description: VariableCollection méthode. Renvoie un objet énumérateur qui peut être utilisé pour itérer sur toutes les variables de la collection.
type: docs
weight: 60
...
Renvoie un objet énumérateur qui peut être utilisé pour itérer sur toutes les variables de la collection.
