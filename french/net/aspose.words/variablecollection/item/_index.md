...
description: Obtient ou définit une variable de document par le nom insensible à la casse. les valeurs nulles ne sont pas autorisées comme côté droit de laffectation et seront remplacées par une chaîne vide.
type: docs
weight: 20
