...
description: StyleCollection propriété. Récupère la mise en forme du texte par défaut du document.
type: docs
weight: 20
...
Récupère la mise en forme du texte par défaut du document.
...
Notez que les valeurs par défaut à l'échelle du document ont été introduites dans Microsoft Word 2007 et sont entièrement prises en charge dans les formats OOXML (Docx) uniquement. Les formats de document antérieurs ont une prise en charge limitée de cette fonctionnalité et seuls les noms de police peuvent être stockés.
