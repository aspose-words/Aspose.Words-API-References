...
description: Aspose.Words appelle cette méthode lorsquil rencontre un problème lors du chargement du document ou de lenregistrement qui peut entraîner une perte de formatage ou de fidélité des données.
type: docs
weight: 10
