...
description: Implémentez l'interface Aspose.Words.IWarningCallback pour personnaliser les méthodes de capture des avertissements de fidélité lors du chargement et de l'enregistrement des documents. Améliorez l'intégrité des documents !
type: docs
weight: 3660
...
Implémentez cette interface si vous souhaitez avoir votre propre méthode personnalisée appelée pour capturer les avertissements de perte de fidélité qui peuvent survenir lors du chargement ou de l'enregistrement du document.
...
| Nom | La description |
| --- | --- |
| [Warning](../../aspose.words/iwarningcallback/warning/)(*[WarningInfo](../warninginfo/)*) | Aspose.Words invoque cette méthode lorsqu'il rencontre un problème lors du chargement ou de l'enregistrement d'un document qui pourrait entraîner une perte de formatage ou de fidélité des données. |
