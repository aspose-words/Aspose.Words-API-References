...
Lorsque[`CommentRangeStart`](../../commentrangestart) est créé, il appartient au document spécifié, mais ne fait pas encore partie du document et[`ParentNode`](../../node/parentnode) est nul.

Pour ajouter un[`CommentRangeStart`](../../commentrangestart) au document, utilisez InsertAfter ou InsertBefore sur le paragraphe où vous souhaitez insérer le commentaire.
