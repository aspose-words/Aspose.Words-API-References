...
description: Indique le début dune zone de texte à laquelle un commentaire est associé.
type: docs
weight: 250
...
| Nom | La description |
| --- | --- |
| [CommentRangeStart](commentrangestart)(DocumentBase, int) | Initialise une nouvelle instance de cette classe. |
...
[`CommentRangeStart`](../commentrangestart) est un nœud de niveau en ligne et ne peut être qu'un enfant de[`Paragraph`](../paragraph).
