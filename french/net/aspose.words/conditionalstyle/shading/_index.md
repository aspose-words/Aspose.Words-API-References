...
description: Découvrez la propriété ConditionalStyle Shading pour accéder au formatage de vos styles. Améliorez vos créations avec des effets visuels sur mesure dès aujourd'hui !
type: docs
weight: 70
url: /fr/net/aspose.words/conditionalstyle/shading/
---
## ConditionalStyle.Shading property

Obtient un[`Shading`](../../shading/) objet qui fait référence à la mise en forme d'ombrage pour ce style conditionnel.
