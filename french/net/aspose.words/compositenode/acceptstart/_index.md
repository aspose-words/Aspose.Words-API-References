...
description: Découvrez comment la méthode CompositeNode AcceptStart améliore le traitement des documents en appelant la méthode VisitXXXStart pour une intégration transparente des visiteurs.
type: docs
weight: 70
url: /fr/net/aspose.words/compositenode/acceptstart/
---
## CompositeNode.AcceptStart method

Lorsqu'il est implémenté dans une classe dérivée, appelle la méthode VisitXXXStart du visiteur du document spécifié.
