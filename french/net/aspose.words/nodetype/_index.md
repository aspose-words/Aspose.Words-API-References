...
description: Spécifie le type dun nœud de document Word.
type: docs
weight: 3990
...
| BookmarkEnd | `10` | Une extrémité d'un marque-page. |
| EditableRangeStart | `11` | Début d'une plage modifiable. |
...
| MoveToRangeStart | `15` | Début d'une plage MoveTo. |
...
| FieldSeparator | `23` | Un caractère spécial qui sépare le code de champ du résultat du champ. |
| FieldEnd | `24` | Un caractère spécial qui désigne la fin d'un champ Word. |
| FormField | `25` | Un champ de formulaire. |
| SpecialChar | `26` | Un caractère spécial qui ne fait pas partie des types de caractères spéciaux plus spécifiques. |
| SmartTag | `27` | Une balise active autour d'une ou plusieurs structures en ligne (séries, images, champs, etc.) dans un paragraphe |
| StructuredDocumentTag | `28` | Permet de définir les informations propres au client et ses moyens de présentation. |
| StructuredDocumentTagRangeStart | `29` | Un début de **à distance** balise de document structurée qui accepte le contenu multi-sections. |
| StructuredDocumentTagRangeEnd | `30` | Une fin de **à distance** balise de document structurée qui accepte le contenu multi-sections. |
| GlossaryDocument | `31` | Un glossaire dans le document principal. |
| BuildingBlock | `32` | Bloc de construction dans un document de glossaire (par exemple, entrée de document de glossaire). |
