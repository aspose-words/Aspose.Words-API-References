...
description: Renvoie vrai si ce document contient une signature numérique. Cette propriété informe simplement quune signature numérique est présente sur un document mais elle ne précise pas si la signature est valide ou non.
type: docs
weight: 20
