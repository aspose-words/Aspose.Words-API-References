...
description: Découvrez la propriété HeaderFooter ParentSection pour accéder facilement à la section parent de votre histoire, améliorant ainsi la structure et l'organisation de votre document.
type: docs
weight: 60
