...
description: TableStyle RowStripe propriété. Obtient ou définit un nombre de lignes à inclure dans la bande lorsque le style spécifie une bande de ligne paire/impaire en C#.
type: docs
weight: 120
...
// Créez un tableau dans lequel les colonnes et les lignes simples seront regroupées par trois.
...
// Définit une couleur à appliquer à chaque colonne paire, qui remplacera toute coloration de ligne personnalisée.
...
// La propriété "StyleOptions" active le regroupement de lignes par défaut.
