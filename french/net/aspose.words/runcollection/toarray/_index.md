...
description: Convertissez sans effort votre RunCollection en tableau avec la méthode ToArray, garantissant une gestion transparente des données et des performances améliorées.
type: docs
weight: 20
...
Copie toutes les exécutions de la collection vers un nouveau tableau d'exécutions.
