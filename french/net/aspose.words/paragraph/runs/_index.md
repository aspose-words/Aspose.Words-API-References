...
description: Découvrez la propriété Paragraph Runs pour un accès facile aux collections de texte formatées dans les paragraphes, améliorant ainsi la structure et la lisibilité de votre document.
type: docs
weight: 220
...
Donne accès à la collection tapée de morceaux de texte à l'intérieur du paragraphe.
