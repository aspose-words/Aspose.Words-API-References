...
Cette méthode permet de définir rapidement le texte d'un commentaire à partir d'une chaîne. La chaîne peut contenir sauts de paragraphe, cela créera des paragraphes de texte dans le commentaire en conséquence. Si vous souhaitez insérer des éléments plus complexes dans le commentaire, par exemple des signets ou des tableaux ou appliquer une mise en forme enrichie, vous devez utiliser les classes de nœud appropriées pour créer le texte du commentaire.
