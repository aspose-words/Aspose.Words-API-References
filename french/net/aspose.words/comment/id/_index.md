...
L'identifiant de commentaire permet d'ancrer un commentaire à une zone de texte dans le document. La zone doit être délimitée à l'aide de la[`CommentRangeStart`](../../commentrangestart) et[`CommentRangeEnd`](../../commentrangeend) objet partageant la même valeur d'identifiant que le[`Comment`](../../comment) objet.
