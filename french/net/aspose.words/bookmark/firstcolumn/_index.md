...
description: Découvrez la propriété FirstColumn. Accédez facilement à l'index de base zéro de la première colonne de la plage de signets de votre table pour une gestion efficace des données.
type: docs
weight: 30
