...
description: Découvrez les listes DocumentBase pour une gestion efficace de vos propriétés. Accédez à des formats de liste personnalisables pour améliorer la présentation et la clarté de vos documents.
type: docs
weight: 50
...
Pour plus d'informations, consultez la description du[`ListCollection`](../../../aspose.words.lists/listcollection/) classe.
