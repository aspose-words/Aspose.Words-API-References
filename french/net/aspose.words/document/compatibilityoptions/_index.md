...
description: Accédez aux options de compatibilité des documents de Word pour personnaliser les préférences utilisateur et améliorer votre expérience d'édition avec des paramètres personnalisés pour une collaboration transparente.
type: docs
weight: 60
...
Donne accès aux options de compatibilité des documents (c'est-à-dire aux préférences utilisateur saisies sur le**Compatibilité** onglet du**Options**dialogue dans Word).
