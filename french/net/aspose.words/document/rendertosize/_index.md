...
description: Document RenderToSize méthode. Rend une page de document dans unGraphics objet à une taille spécifiée en C#.
type: docs
weight: 690
...
| width | Single | La largeur maximale (en unités mondiales) pouvant être occupée par la page rendue. |
| height | Single | La hauteur maximale (en unités mondiales) pouvant être occupée par la page rendue. |
