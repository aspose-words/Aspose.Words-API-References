...
description: Document propriété. Retours vrai si le document contient des modifications suivies.
type: docs
weight: 200
...
Retours **vrai** si le document contient des modifications suivies.
