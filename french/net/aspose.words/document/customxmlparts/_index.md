...
description: Document propriété. Obtient ou définit la collection de parties de stockage de données XML personnalisées.
type: docs
weight: 80
...
Aspose.Words charge et enregistre les parties XML personnalisées uniquement dans les documents OOXML et DOC.
