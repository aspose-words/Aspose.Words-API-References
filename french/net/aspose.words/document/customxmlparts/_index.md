...
description: Explorez la propriété Document CustomXmlParts pour gérer efficacement les parties de stockage de données XML personnalisées. Améliorez les fonctionnalités de votre document dès aujourd'hui !
type: docs
weight: 90
url: /fr/net/aspose.words/document/customxmlparts/
---
## Document.CustomXmlParts property

Obtient ou définit la collection de parties de stockage de données XML personnalisées.
...
Aspose.Words charge et enregistre les parties XML personnalisées dans les documents OOXML et DOC uniquement.
