...
description: Explorez la propriété Document FootnoteOptions pour personnaliser la numérotation et le positionnement des notes de bas de page, améliorant ainsi la clarté et le professionnalisme de votre document.
type: docs
weight: 160
