...
description: Document propriété. Obtient ou définit le document de glossaire dans ce document ou modèle. Un document de glossaire est un stockage pour les entrées dinsertion automatique de correction automatique et de bloc de construction définies dans un document.
type: docs
weight: 170
