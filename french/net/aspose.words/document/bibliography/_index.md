...
description: Accédez à la propriété Bibliographie du document pour récupérer une liste complète de sources, améliorant ainsi la précision de vos recherches et de vos citations.
type: docs
weight: 40
url: /fr/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Obtient le`Bibliography`objet qui représente la liste des sources disponibles dans le document.
