...
description: Découvrez les variables de document. Accédez à une puissante collection de variables personnalisables pour vos documents et modèles, améliorant ainsi votre efficacité et votre flexibilité.
type: docs
weight: 460
...
Renvoie la collection de variables ajoutées à un document ou à un modèle.
