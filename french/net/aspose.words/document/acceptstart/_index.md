...
description: Découvrez la méthode AcceptStart, accueillez en toute transparence les visiteurs au début de votre document pour une expérience utilisateur améliorée et une navigation plus fluide.
type: docs
weight: 560
url: /fr/net/aspose.words/document/acceptstart/
---
## Document.AcceptStart method

Accepte un visiteur pour visiter le début du document.
