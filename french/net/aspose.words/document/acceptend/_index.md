...
description: Découvrez la méthode Document AcceptEnd pour gérer efficacement l'accès des visiteurs à la fin du document. Améliorez l'expérience utilisateur grâce à une navigation fluide.
type: docs
weight: 550
url: /fr/net/aspose.words/document/acceptend/
---
## Document.AcceptEnd method

Accepte un visiteur pour visiter la fin du document.
