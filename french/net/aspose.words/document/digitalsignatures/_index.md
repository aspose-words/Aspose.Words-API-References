...
Cette collection contient des signatures numériques qui ont été chargées à partir du document d'origine. Ces signatures numériques ne seront pas enregistrées lorsque vous enregistrez ce[`Document`](../../document) object dans un fichier ou un flux, car l'enregistrement ou la conversion produira un document différent de l'original et les signatures numériques d'origine ne seront plus valides.
