...
Cette propriété permet de récupérer le type de protection de document actuellement défini. Pour modifier le type de protection de document, utilisez la[`Protect`](../protect/) et[`Unprotect`](../unprotect/)méthodes.
