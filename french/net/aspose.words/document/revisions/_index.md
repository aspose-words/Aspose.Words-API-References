...
description: Document propriété. Obtient une collection de révisions modifications suivies qui existent dans ce document.
type: docs
weight: 330
url: /fr/net/aspose.words/document/revisions/
---
...
La collection renvoyée est une collection "active", ce qui signifie que si vous supprimez des parties d'un document qui contiennent révisions, les révisions supprimées disparaîtront automatiquement de cette collection.
