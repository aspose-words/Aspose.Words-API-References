...
description: PageSetup propriété. Obtient ou définit le bac à papier bac à utiliser pour toutes les pages sauf la première dune section. La valeur est spécifique à limplémentation imprimante.
type: docs
weight: 290
