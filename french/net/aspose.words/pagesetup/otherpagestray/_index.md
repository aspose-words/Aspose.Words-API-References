...
description: PageSetup propriété. Obtient ou définit le bac à papier à utiliser pour toutes les pages dune section sauf la première. La valeur est spécifique à limplémentation imprimante.
type: docs
weight: 300
