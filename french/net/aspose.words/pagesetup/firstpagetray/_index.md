...
description: Obtient ou définit le bac à papier bac à utiliser pour la première page dune section. La valeur est spécifique à limplémentation imprimante.
type: docs
weight: 130
