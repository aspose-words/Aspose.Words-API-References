...
description: Découvrez comment utiliser le trait d'union facultatif dans Microsoft Word (caractère 31) pour améliorer la mise en forme et la lisibilité de vos documents. En savoir plus !
type: docs
weight: 190
...
Le trait d'union facultatif dans Microsoft Word est (char)31.
