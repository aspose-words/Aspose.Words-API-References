...
description: Découvrez le champ ControlChar CellChar pour une gestion fluide des tableaux. Améliorez l'organisation de vos données grâce à des caractères de fin de cellule et de ligne efficaces.
type: docs
weight: 20
...
Caractère de fin de cellule ou de fin de ligne de tableau : (char)7 ou "\a".
