...
description: ControlChar champ. Fin dune cellule de tableau ou fin dun caractère de ligne de tableau  x0007 ou a.
type: docs
weight: 10
...
Fin d'une cellule de tableau ou fin d'un caractère de ligne de tableau : "\x0007" ou "\a".
