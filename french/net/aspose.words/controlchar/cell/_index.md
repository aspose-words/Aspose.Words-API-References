...
description: ControlChar Cell champ. Fin de cellule dun tableau ou caractère de fin de ligne dun tableau  x0007 ou a en C#.
type: docs
weight: 10
...
Fin de cellule d'un tableau ou caractère de fin de ligne d'un tableau : "\x0007" ou "\a".
