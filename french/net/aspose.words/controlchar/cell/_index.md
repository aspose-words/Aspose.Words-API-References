...
description: Découvrez le champ ControlChar Cell, la clé pour définir les fins de cellule et de ligne d'un tableau avec le caractère x0007. Optimisez l'organisation de vos données sans effort !
type: docs
weight: 10
url: /fr/net/aspose.words/controlchar/cell/
---
## ControlChar.Cell field

Caractère de fin de cellule ou de fin de ligne de tableau : « \x0007 » ou « \a ».
