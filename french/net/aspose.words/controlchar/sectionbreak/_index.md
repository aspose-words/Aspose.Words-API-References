...
description: Découvrez le champ ControlChar SectionBreak, gérez efficacement les sections de documents avec le caractère x000c, améliorant la mise en forme et la lisibilité.
type: docs
weight: 240
url: /fr/net/aspose.words/controlchar/sectionbreak/
---
## ControlChar.SectionBreak field

Caractère de fin de section : « \x000c » ou « \f ». Notez que sa valeur est identique à[`PageBreak`](../pagebreak/) .
