...
description: Découvrez le champ ControlChar DefaultTextInputChar, avec le caractère « o » comme valeur par défaut idéale pour vos formulaires de saisie de texte. Améliorez l'expérience utilisateur !
type: docs
weight: 70
...
Il s'agit du caractère « o » utilisé comme valeur par défaut dans les champs de formulaire de saisie de texte.
