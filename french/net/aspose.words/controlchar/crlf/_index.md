...
description: Retour chariot suivi dun caractère de saut de ligne  x000dx000a ou rn. Non utilisé en tant que tel dans les documents Microsoft Word mais couramment utilisé dans les fichiers texte pour les sauts de paragraphe.
type: docs
weight: 60
