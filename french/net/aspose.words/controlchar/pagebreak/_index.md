...
description: Découvrez le champ ControlChar PageBreak et gérez efficacement les sauts de page grâce au caractère x000c. Simplifiez la mise en forme de vos documents dès aujourd'hui !
type: docs
weight: 200
url: /fr/net/aspose.words/controlchar/pagebreak/
---
## ControlChar.PageBreak field

Caractère de saut de page : « \x000c » ou « \f ». Notez que sa valeur est identique à[`SectionBreak`](../sectionbreak/) .
