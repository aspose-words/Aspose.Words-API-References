...
description: Découvrez comment ControlChar FieldSeparatorChar améliore la gestion des données en séparant efficacement les codes de champ des valeurs, optimisant ainsi votre flux de travail sans effort.
type: docs
weight: 90
url: /fr/net/aspose.words/controlchar/fieldseparatorchar/
---
## ControlChar.FieldSeparatorChar field

Le caractère séparateur de champ sépare le code du champ de sa valeur. Facultatif dans certains champs. Valeur : (car)20.
