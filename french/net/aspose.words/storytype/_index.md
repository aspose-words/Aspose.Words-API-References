...
description: Aspose.Words.StoryType énumération. Le texte dun document Word est stocké dans des histoires. Type dhistoire identifie une histoire.
type: docs
weight: 5820
...
Le texte d'un document Word est stocké dans des histoires. **Type d'histoire** identifie une histoire.
...
| FirstPageFooter | `11` | Contient le texte du premier pied de page, représenté par[`HeaderFooter`](../headerfooter/) . |
| FootnoteSeparator | `12` | Contient le texte du séparateur de note de bas de page, représenté parFootnoteSeparator . |
| FootnoteContinuationSeparator | `13` | Contient le texte du séparateur de suite de la note de bas de page, représenté parFootnoteSeparator . |
| FootnoteContinuationNotice | `14` | Contient le texte du séparateur d'avis de continuation de la note de bas de page, représenté parFootnoteSeparator . |
| EndnoteSeparator | `15` | Contient le texte du séparateur de note de fin, représenté parFootnoteSeparator . |
| EndnoteContinuationSeparator | `16` | Contient le texte du séparateur de continuation de la note de fin, représenté parFootnoteSeparator . |
| EndnoteContinuationNotice | `17` | Contient le texte du séparateur d'avis de continuation de la note de fin, représenté parFootnoteSeparator . |
