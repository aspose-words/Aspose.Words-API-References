...
description: Optimisez votre contenu avec la méthode EnsureMinimum d'InlineStory, qui ajoute un paragraphe si le dernier enfant n'en est pas un, améliorant ainsi la lisibilité et la structure.
type: docs
weight: 120
