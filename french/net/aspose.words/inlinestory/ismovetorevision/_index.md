...
description: InlineStory IsMoveToRevision propriété. Retoursvrai si cet objet a été déplacé inséré dans Microsoft Word alors que le suivi des modifications était activé en C#.
type: docs
weight: 60
