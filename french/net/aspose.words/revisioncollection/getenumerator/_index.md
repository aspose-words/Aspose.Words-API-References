...
description: Découvrez la méthode GetEnumerator de RevisionCollection ! Récupérez efficacement les objets énumérateurs pour une gestion fluide des données et des performances améliorées.
type: docs
weight: 60
