...
description: Lie ou dissocie tous les en-têtes et pieds de page aux en-têtes et pieds de page correspondants dans la section précédente.
type: docs
weight: 20
...
| isLinkToPrevious | Boolean | True pour lier l'en-tête ou le pied de page à la section précédente ; false pour dissocier. |
