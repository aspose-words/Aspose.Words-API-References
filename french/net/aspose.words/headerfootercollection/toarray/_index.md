...
description: Convertissez facilement votre collection HeaderFooter en un nouveau tableau grâce à la méthode ToArray. Simplifiez la gestion de vos données dès aujourd'hui !
type: docs
weight: 30
...
Copie tout`En-têtePied de page` s de la collection à une nouvelle gamme de`En-têtePied de page` s.
...
Un éventail de`En-têtePied de page`s.
