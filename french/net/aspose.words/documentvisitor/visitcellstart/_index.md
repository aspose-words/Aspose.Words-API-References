...
description: Découvrez la méthode VisitCellStart dans DocumentVisitor, essentielle pour gérer efficacement l'énumération des cellules d'un tableau. Améliorez vos compétences en codage dès aujourd'hui !
type: docs
weight: 90
