...
description: Découvrez comment la méthode DocumentVisitor VisitSpecialChar améliore le traitement de vos documents en gérant efficacement les nœuds SpecialChar pour de meilleures performances.
type: docs
weight: 430
url: /fr/net/aspose.words/documentvisitor/visitspecialchar/
---
## DocumentVisitor.VisitSpecialChar method

Appelé lorsqu'un[`SpecialChar`](../../specialchar/) le nœud est rencontré dans le document.
...
| --- | --- | --- |
| specialChar | SpecialChar | L'objet qui est visité. |
...
Cette méthode ne doit pas être appelée pour les caractères de contrôle génériques (voir[`ControlChar`](../../controlchar/) ) qui peuvent être présents dans le document.
