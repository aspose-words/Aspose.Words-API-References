...
description: Découvrez la méthode DocumentVisitor VisitCommentRangeEnd, conçue pour améliorer le traitement de texte en gérant efficacement les fins de plage de commentaires dans vos documents.
type: docs
weight: 110
...
| --- | --- | --- |
| commentRangeEnd | CommentRangeEnd | L'objet qui est visité. |
