...
description: DocumentVisitor méthode. Appelé lorsque lénumération de larticle de texte principal dans une section est terminée.
type: docs
weight: 20
...
Appelé lorsque l'énumération de l'article de texte principal dans une section est terminée.
