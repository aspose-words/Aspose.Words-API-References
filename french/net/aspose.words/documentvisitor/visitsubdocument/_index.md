...
description: Découvrez la méthode VisitSubDocument de DocumentVisitor, conçue pour une gestion efficace des sous-documents dans vos applications. Améliorez votre efficacité de codage !
type: docs
weight: 480
url: /fr/net/aspose.words/documentvisitor/visitsubdocument/
---
## DocumentVisitor.VisitSubDocument method

Appelé lorsqu'un sous-document est rencontré.
...
| --- | --- | --- |
| subDocument | SubDocument | L'objet qui est visité. |
