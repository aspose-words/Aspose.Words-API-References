...
description: DocumentVisitor méthode. Appelé lorsque lénumération dune note de bas de page ou dun texte de note de fin a commencé.
type: docs
weight: 220
...
Appelé lorsque l'énumération d'une note de bas de page ou d'un texte de note de fin a commencé.
