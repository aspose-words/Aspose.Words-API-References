...
description: DocumentVisitor méthode. Appelé lorsquune suite de texte dans le est rencontrée.
type: docs
weight: 360
...
Appelé lorsqu'une suite de texte dans le est rencontrée.
