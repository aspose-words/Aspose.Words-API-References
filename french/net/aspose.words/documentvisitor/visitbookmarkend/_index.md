...
description: DocumentVisitor méthode. Appelé lorsquune fin de signet est rencontrée dans le document.
type: docs
weight: 40
...
Appelé lorsqu'une fin de signet est rencontrée dans le document.
...
| --- | --- | --- |
| bookmarkEnd | BookmarkEnd | L'objet qui est visité. |
