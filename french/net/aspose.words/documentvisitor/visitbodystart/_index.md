...
description: Découvrez la méthode DocumentVisitor VisitBodyStart, essentielle pour énumérer efficacement les principaux articles de vos sections. Améliorez votre flux de travail de codage dès aujourd'hui !
type: docs
weight: 30
url: /fr/net/aspose.words/documentvisitor/visitbodystart/
---
## DocumentVisitor.VisitBodyStart method

Appelé lorsque l'énumération de l'histoire du texte principal dans une section a commencé.
...
| --- | --- | --- |
| body | Body | L'objet qui est visité. |
