...
description: Explorez la méthode DocumentVisitor VisitBuildingBlockEnd, déclenchée à la fin de l'énumération des blocs de construction pour un traitement efficace des documents.
type: docs
weight: 60
