...
description: DocumentVisitor méthode. Appelé lorsque lénumération dun bloc de construction est terminée.
type: docs
weight: 60
...
| --- | --- | --- |
| block | BuildingBlock | L'objet visité. |
