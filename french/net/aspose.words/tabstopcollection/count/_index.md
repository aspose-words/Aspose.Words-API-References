...
description: Découvrez la propriété TabStopCollection Count pour accéder facilement au nombre total de taquets de tabulation, améliorant ainsi la conception de votre interface utilisateur et l'expérience utilisateur.
type: docs
weight: 10
