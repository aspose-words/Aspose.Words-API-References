...
description: Accédez facilement aux tabulations grâce à la propriété d'élément TabStopCollection. Récupérez des tabulations spécifiques par index pour une navigation efficace dans l'interface utilisateur.
type: docs
weight: 20
url: /fr/net/aspose.words/tabstopcollection/item/
---
## TabStopCollection indexer (1 of 2)

Obtient un taquet de tabulation à l'index donné.
...
| --- | --- |
| index | Un index dans la collection des taquets de tabulation. |
...
Obtient un taquet de tabulation à la position spécifiée.
...
| Paramètre | La description |
| --- | --- |
| position | La position (en points) du taquet de tabulation. |

## Remarques

Retours`nul` si aucun taquet de tabulation n'est trouvé à la position spécifiée.
