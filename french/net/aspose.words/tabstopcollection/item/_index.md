...
description: TabStopCollection Item propriété. Obtient un taquet de tabulation à lindex donné en C#.
type: docs
weight: 20
...
| --- | --- |
| index | Un index dans la collection de taquets de tabulation. |
