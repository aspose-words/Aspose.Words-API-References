...
description: Aspose.Words.TabStopCollection classe. Une collection deTabStopobjets qui représentent des tabulations personnalisées pour un paragraphe ou un style.
type: docs
weight: 5910
