...
description: Aspose.Words.Inline classe. Classe de base pour les nœuds de niveau en ligne qui peuvent être associés à un formatage de caractères mais ne peuvent pas avoir de nœuds enfants.
type: docs
weight: 3060
