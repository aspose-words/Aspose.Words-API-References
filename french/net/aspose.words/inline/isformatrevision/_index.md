...
description: Découvrez la propriété Inline IsFormatRevision dans Microsoft Word. Elle indique si la mise en forme d'un objet a été modifiée avec le suivi des modifications activé, améliorant ainsi la gestion des documents.
type: docs
weight: 30
