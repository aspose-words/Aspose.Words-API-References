...
description: Découvrez la méthode Body AcceptStart pour intégrer de manière transparente les visiteurs au début du corps de votre document pour une expérience utilisateur améliorée.
type: docs
weight: 60
url: /fr/net/aspose.words/body/acceptstart/
---
## Body.AcceptStart method

Accepte un visiteur pour visiter le début du corps du document.
