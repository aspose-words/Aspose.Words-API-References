...
description: Body constructeur. Initialise une nouvelle instance duBody classe.
type: docs
weight: 10
...
À ajouter[`Body`](../)à un[`Section`](../../section/) utiliserAjouterEnfant , InsérerAprès ouInsérer avant méthodes.
