...
description: Enregistre et charge un dictionnaire de césure pour la langue spécifiée à partir dun flux. Lance si le dictionnaire ne peut pas être lu ou a un format invalide.
type: docs
weight: 40
