...
description: Découvrez la méthode Section Accept pour améliorer l'engagement des visiteurs et fluidifier les interactions. Boostez les performances de votre site dès aujourd'hui !
type: docs
weight: 70
...
Appels[`VisitSectionStart`](../../documentvisitor/visitsectionstart/) , puis appelle[`Accept`](../../node/accept/) pour tous les nœuds enfants de la section et les appels[`VisitSectionEnd`](../../documentvisitor/visitsectionend/) à la fin.
