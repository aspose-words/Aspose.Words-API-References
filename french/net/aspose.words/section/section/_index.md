...
Inclure[`Section`](../) dans une utilisation de documentNode) et Node) méthodes du[`Document`](../../document/) OU [`Add`](../../nodecollection/add/) et[`Insert`](../../nodecollection/insert/) méthodes du[`Sections`](../../document/sections/) propriété.
