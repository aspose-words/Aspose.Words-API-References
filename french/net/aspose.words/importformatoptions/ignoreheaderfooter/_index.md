...
description: Obtient ou définit une valeur booléenne qui spécifie que la mise en forme source du contenu des entêtes/pieds de page est ignorée siKeepSourceFormatting mode est utilisé. La valeur par défaut estvrai .
type: docs
weight: 30
