...
description: ParagraphFormat propriété. Vrai si lespacement avant le paragraphe est défini automatiquement.
type: docs
weight: 320
...
Vrai si l'espacement avant le paragraphe est défini automatiquement.
...
Lorsqu'il est défini sur true, remplace l'effet de[`SpaceBefore`](../spacebefore/).
