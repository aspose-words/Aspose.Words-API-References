...
description: Obtient ou définit un indicateur indiquant si lespacement entre les caractères est automatiquement ajusté entre les régions de texte latin et les régions de texte dAsie de lEst dans le paragraphe actuel.
type: docs
weight: 10
