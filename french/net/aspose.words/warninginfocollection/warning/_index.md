...
description: Découvrez la méthode WarningInfoCollection qui améliore votre application en implémentant IWarningCallback, ajoutant sans effort des avertissements à votre collection.
type: docs
weight: 60
...
Implémente le[`IWarningCallback`](../../iwarningcallback/) interface. Ajoute un avertissement à cette collection.
