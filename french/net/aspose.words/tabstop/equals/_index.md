...
description: Découvrez la méthode TabStop Equals pour comparer efficacement les instances TabStop. Améliorez la précision de votre codage et rationalisez votre processus de développement !
type: docs
weight: 60
...
Compare avec le spécifié[`TabStop`](../) .
