...
description: DocumentBuilder InsertShape méthode. Insère une forme en ligne avec le type et la taille spécifiés en C#.
type: docs
weight: 430
...
| vertPos | RelativeVerticalPosition | Spécifie l'endroit à partir duquel la distance verticale jusqu'à la forme est mesurée. |
...
| wrapType | WrapType | Spécifie comment enrouler le texte autour de la forme. |
