...
description: Explorez la propriété ListFormat de DocumentBuilder pour accéder et personnaliser vos paramètres de formatage de liste actuels pour une conception de document améliorée.
type: docs
weight: 150
