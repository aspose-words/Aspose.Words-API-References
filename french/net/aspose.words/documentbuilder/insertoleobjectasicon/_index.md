...
description: DocumentBuilder méthode. Insère un objet OLE intégré ou lié en tant quicône dans le document. Permet de spécifier le fichier dicône et la légende. Détecte le type dobjet OLE à laide de lextension de fichier.
type: docs
weight: 380
...
Insère un objet OLE intégré ou lié en tant qu'icône dans le document. Permet de spécifier le fichier d'icône et la légende. Détecte le type d'objet OLE à l'aide de l'extension de fichier.
...
| isLinked | Boolean | Si vrai, l'objet OLE lié est inséré, sinon l'objet OLE intégré est inséré. |
| iconFile | String | Chemin d'accès complet au fichier ICO. Si la valeur est nulle, Aspose.Words utilisera une image prédéfinie. |
| iconCaption | String | Légende de l'icône. Si la valeur est nulle, Aspose.Words utilisera le nom de fichier. |
...
Insère un objet OLE intégré ou lié en tant qu'icône dans le document. Permet de spécifier le fichier d'icône et la légende. Détecte le type d'objet OLE à l'aide du paramètre progID donné.
...
Montre comment insérer un objet OLE incorporé ou lié en tant qu'icône dans le document.
...
Insère un objet OLE intégré en tant qu'icône d'un flux dans le document. Permet de spécifier le fichier d'icône et la légende. Détecte le type d'objet OLE à l'aide du paramètre progID donné.
...
| progId | String | ProgId de l'objet OLE. |
| iconFile | String | Chemin d'accès complet au fichier ICO. Si la valeur est nulle, Aspose.Words utilisera une image prédéfinie. |
| iconCaption | String | Légende de l'icône. Si la valeur est nulle, Aspose.Words utilisera une légende d'icône prédéfinie. |
