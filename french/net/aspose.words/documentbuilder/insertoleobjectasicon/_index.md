...
description: Insère un objet OLE intégré ou lié en tant quicône dans le document. Permet de spécifier le fichier dicône et la légende. Détecte le type dobjet OLE à laide de lextension de fichier.
type: docs
weight: 380
