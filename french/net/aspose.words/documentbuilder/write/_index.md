...
description: Insère une chaîne dans le document à la position dinsertion actuelle.
type: docs
weight: 620
...
Format de police actuel spécifié par le[`Font`](../font/)propriété est utilisée.
