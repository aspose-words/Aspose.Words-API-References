...
description: Concluez sans effort vos tableaux de documents avec la méthode EndTable de DocumentBuilder, garantissant une mise en forme transparente et une présentation professionnelle.
type: docs
weight: 250
...
Cette méthode ne doit être appelée qu'une seule fois après[`EndRow`](../endrow/) a été appelé. Lorsqu'il a été appelé, `EndTable` déplace le curseur hors de la cellule actuelle pour pointer juste après le tableau.
