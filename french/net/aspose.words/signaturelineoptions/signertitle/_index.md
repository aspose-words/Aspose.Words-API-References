...
description: SignatureLineOptions propriété. Obtient ou définit le titre suggéré du signataire. La valeur par défaut de cette propriété est chaîne vide Empty.
type: docs
weight: 80
