...
description: SignatureLineOptions propriété. Obtient ou définit le titre du signataire suggéré. La valeur par défaut de cette propriété est chaîne vide Empty .
type: docs
weight: 80
...
Obtient ou définit le titre du signataire suggéré. La valeur par défaut de cette propriété est **chaîne vide** (Empty ).
