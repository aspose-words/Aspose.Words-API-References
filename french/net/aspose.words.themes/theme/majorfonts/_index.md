...
description: Personnalisez la typographie de votre site avec MajorFonts. Définissez facilement des polices différentes pour plusieurs langues afin d'améliorer la lisibilité et l'expérience utilisateur.
type: docs
weight: 30
