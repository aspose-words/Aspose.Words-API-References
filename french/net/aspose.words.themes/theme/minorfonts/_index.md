...
description: Personnalisez la typographie de votre site avec MinorFonts. Définissez facilement des polices uniques pour différentes langues afin d'améliorer l'expérience utilisateur et l'engagement.
type: docs
weight: 40
url: /fr/net/aspose.words.themes/theme/minorfonts/
---
## Theme.MinorFonts property

Permet de spécifier l'ensemble des polices mineures pour différentes langues.
