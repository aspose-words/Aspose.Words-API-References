...
description: Theme propriété. Permet de spécifier le jeu de polices mineures pour différentes langues.
type: docs
weight: 40
...
Permet de spécifier le jeu de polices mineures pour différentes langues.
