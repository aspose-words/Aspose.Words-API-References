...
description: Renvoie un tableau contenant des noms de police de remplacement pour le nom de police dorigine spécifié.
type: docs
weight: 20
...
Renvoie un tableau contenant des noms de police de remplacement pour le nom de police d'origine spécifié.
...
Liste des noms de polices alternatives.
