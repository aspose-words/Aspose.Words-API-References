...
description: TableSubstitutionRule méthode. Remplacer les noms de police de remplacement pour le nom de police dorigine donné.
type: docs
weight: 80
...
Remplacer les noms de police de remplacement pour le nom de police d'origine donné.
