...
Selon cette règle Aspose.Words évalue tous les champs liés dans[`FontInfo`](../fontinfo/) (Panose, Sig, etc.) for la police manquante et trouve la correspondance la plus proche parmi les sources de polices disponibles. Si[`FontInfo`](../fontinfo/) n'est pas disponible pour la police manquante, rien ne sera fait.
