...
description: Découvrez la méthode StreamFontSource OpenFontDataStream pour accéder efficacement aux flux de données de polices à la demande, améliorant ainsi votre flux de travail de conception.
type: docs
weight: 30
