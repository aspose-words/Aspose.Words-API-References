...
description: Découvrez la classe Aspose.Words.Lists.ListCollection pour une gestion efficace des listes à puces et numérotées, améliorant la mise en forme et l'organisation des documents.
type: docs
weight: 3920
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.words.lists/listcollection/add/#add)(*[ListTemplate](../listtemplate/)*) | Crée une nouvelle liste basée sur un modèle prédéfini et l'ajoute à la collection de listes dans le document. |
| [Add](../../aspose.words.lists/listcollection/add/#add_1)(*[Style](../../aspose.words/style/)*) | Crée une nouvelle liste qui fait référence à un style de liste et l'ajoute à la collection de listes dans le document. |
| [AddCopy](../../aspose.words.lists/listcollection/addcopy/)(*[List](../list/)*) | Crée une nouvelle liste en copiant la liste spécifiée et en l'ajoutant à la collection de listes dans le document. |
| [AddSingleLevelList](../../aspose.words.lists/listcollection/addsinglelevellist/)(*[ListTemplate](../listtemplate/)*) | Crée une nouvelle liste à un seul niveau basée sur le modèle prédéfini et l'ajoute à la collection de listes dans le document. |
...
Vous ne créez pas d'objets de cette classe. Il n'y en a toujours qu'un seul.`ListCollection` objet par document et il est accessible via le[`Lists`](../../aspose.words/documentbase/lists/) propriété.
...
Pour créer un paragraphe à puces ou numéroté, vous devez appliquer le formatage de liste à un paragraphe en attribuant un[`List`](../list/)objet à the [`List`](../listformat/list/) propriété de[`ListFormat`](../listformat/).

Pour supprimer la mise en forme de la liste d'un paragraphe, utilisez le[`RemoveNumbers`](../listformat/removenumbers/) Méthode .
