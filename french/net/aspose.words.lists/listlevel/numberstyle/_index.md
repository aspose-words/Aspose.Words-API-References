...
description: ListLevel propriété. Renvoie ou définit le style de numérotation pour ce niveau de liste.
type: docs
weight: 90
...
Renvoie ou définit le style de numérotation pour ce niveau de liste.
