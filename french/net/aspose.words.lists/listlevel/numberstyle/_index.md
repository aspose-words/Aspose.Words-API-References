...
description: ListLevel NumberStyle propriété. Renvoie ou définit le style numérique pour ce niveau de liste en C#.
type: docs
weight: 90
...
Renvoie ou définit le style numérique pour ce niveau de liste.
