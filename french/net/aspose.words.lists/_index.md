...
| [ListFormat](./listformat/) | Permet de contrôler quel formatage de liste est appliqué à un paragraphe. |
...
| [ListLevelCollection](./listlevelcollection/) | Une collection de formats de liste pour chaque niveau d'une liste. |
## Énumération
