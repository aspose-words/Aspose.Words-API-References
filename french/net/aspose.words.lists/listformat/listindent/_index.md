...
description: Améliorez la structure de votre document avec la méthode ListFormat ListIndent, élevant sans effort le niveau de liste de votre paragraphe pour une meilleure clarté.
type: docs
weight: 70
