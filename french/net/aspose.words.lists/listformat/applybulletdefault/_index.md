...
description: Découvrez comment utiliser la méthode ApplyBulletDefault pour créer sans effort des listes à puces élégantes dans vos documents, améliorant ainsi la lisibilité et l'organisation.
type: docs
weight: 50
url: /fr/net/aspose.words.lists/listformat/applybulletdefault/
---
...
Il s'agit d'une méthode de raccourci qui crée une nouvelle liste en utilisant le modèle bulleted par défaut, l'applique au paragraphe et sélectionne le 1er niveau de liste.
