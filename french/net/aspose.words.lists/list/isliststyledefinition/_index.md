...
description: List propriété. Renvoie true si cette liste est une définition dun style de liste.
type: docs
weight: 20
...
Lorsque cette propriété est vraie, le[`Style`](../style/)La propriété renvoie le style de liste que cette liste définit.
