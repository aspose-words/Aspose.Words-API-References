...
description: Accédez facilement aux niveaux de liste grâce à la propriété Item ListLevelCollection. Récupérez n'importe quel niveau par index pour une mise en forme fluide des documents.
type: docs
weight: 20
url: /fr/net/aspose.words.lists/listlevelcollection/item/
---
## ListLevelCollection indexer

Obtient un niveau de liste par index.
