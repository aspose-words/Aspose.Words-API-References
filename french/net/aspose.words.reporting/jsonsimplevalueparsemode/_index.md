...
description: Spécifie un mode danalyse des valeurs simples JSON nulle booléenne nombre entier et chaîne lors du chargement de JSON. Un tel mode naffecte pas lanalyse des valeurs date-heure.
type: docs
weight: 4440
