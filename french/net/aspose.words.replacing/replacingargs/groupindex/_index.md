...
description: Identifie par index un groupe capturé dans laMatchaspose.words.replacing/replacingargs/match/ qui doit être remplacé par leReplacementaspose.words.replacing/replacingargs/replacement/ chaîne.
type: docs
weight: 10
