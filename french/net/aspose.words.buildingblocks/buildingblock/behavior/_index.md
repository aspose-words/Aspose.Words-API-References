...
description: BuildingBlock Behavior propriété. Spécifie le comportement qui doit être appliqué lorsque le contenu du bloc de construction est inséré dans le document principal en C#.
type: docs
weight: 20
