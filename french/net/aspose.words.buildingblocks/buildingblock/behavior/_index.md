...
description: Découvrez comment BuildingBlock Behavior améliore votre document en définissant des méthodes d'insertion de contenu pour une intégration transparente et un flux de travail amélioré.
type: docs
weight: 20
url: /fr/net/aspose.words.buildingblocks/buildingblock/behavior/
---
## BuildingBlock.Behavior property

Spécifie le comportement qui doit être appliqué lorsque le contenu du bloc de construction est inséré dans le document principal.
