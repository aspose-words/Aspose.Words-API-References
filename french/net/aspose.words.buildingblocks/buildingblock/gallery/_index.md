...
description: Découvrez la fonctionnalité unique de BuildingBlock Gallery pour une catégorisation efficace et un tri fluide de l'interface utilisateur. Optimisez votre organisation dès aujourd'hui !
type: docs
weight: 60
...
Spécifie la catégorisation de premier niveau pour le bloc de construction à des fins de classification ou de tri de l'interface utilisateur.
...
Les blocs de construction de l'interface utilisateur de Microsoft Word sont organisés en galeries.`Gallery` peut avoir plusieurs catégories. Chaque bloc dans a[`Category`](../category/) a un[`Name`](../name/).

Correspond à la**docPartPr.category.gallery** élément dans OOXML.
