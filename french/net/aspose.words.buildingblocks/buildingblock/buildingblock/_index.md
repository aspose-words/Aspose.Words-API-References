...
description: BuildingBlock constructeur. Initialise une nouvelle instance de cette classe.
type: docs
weight: 10
...
Lorsque[`BuildingBlock`](../) est créé, il appartient au document de glossaire spécifié, mais ne fait pas encore partie du document de glossaire et[`ParentNode`](../../../aspose.words/node/parentnode/) est`nul`.

À ajouter[`BuildingBlock`](../) à un[`GlossaryDocument`](../../glossarydocument/) utiliser [`AppendChild`](../../../aspose.words/compositenode/appendchild/).
