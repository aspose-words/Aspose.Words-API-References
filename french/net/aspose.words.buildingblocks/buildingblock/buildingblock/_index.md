...
Lorsque[`BuildingBlock`](../../buildingblock) est créé, il appartient au document de glossaire spécifié, mais ne fait pas encore partie du document de glossaire et[`ParentNode`](../../../aspose.words/node/parentnode) est`nul`.

À ajouter[`BuildingBlock`](../../buildingblock) à un[`GlossaryDocument`](../../glossarydocument) utiliser [`AppendChild`](../../../aspose.words/compositenode/appendchild).
