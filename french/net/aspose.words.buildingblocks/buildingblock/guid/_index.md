...
description: Découvrez la propriété GUID BuildingBlock. Gérez facilement un identifiant unique de 128 bits pour vos blocs de construction, garantissant ainsi une organisation et une identification fluides.
type: docs
weight: 70
url: /fr/net/aspose.words.buildingblocks/buildingblock/guid/
---
## BuildingBlock.Guid property

Obtient ou définit un identifiant (un GUID 128 bits) qui identifie de manière unique ce bloc de construction.
...
Peut être utilisé par une application pour référencer de manière unique un bloc de construction, indépendamment de la dénomination différente due à la localisation.

Correspond à la**docPartPr.guid** élément dans OOXML.
