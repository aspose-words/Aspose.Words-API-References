...
description: BuildingBlock propriété. Obtient ou définit un identifiant un GUID 128 bits qui identifie de manière unique ce bloc de construction.
type: docs
weight: 70
...
Peut être utilisé par une application pour référencer de manière unique un bloc de construction indépendamment des noms différents en raison de la localisation.
