...
description: Gérez facilement la description de vos BuildingBlocks. Définissez ou mettez à jour facilement vos descriptions pour une organisation et une clarté accrues dans vos projets.
type: docs
weight: 40
url: /fr/net/aspose.words.buildingblocks/buildingblock/description/
---
## BuildingBlock.Description property

Obtient ou définit la description associée à ce bloc de construction.
...
La description peut contenir n'importe quel contenu de chaîne, généralement des informations supplémentaires.

Ne peut pas être`nul`, mais peut être une chaîne vide.

Correspond à la**docPartPr.description** élément dans OOXML.
