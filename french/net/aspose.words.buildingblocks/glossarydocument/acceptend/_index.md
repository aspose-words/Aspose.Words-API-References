...
description: Découvrez la méthode AcceptEnd de GlossaryDocument, qui gère efficacement l'accès des visiteurs à la fin de votre glossaire. Améliorez l'expérience utilisateur dès aujourd'hui !
type: docs
weight: 70
url: /fr/net/aspose.words.buildingblocks/glossarydocument/acceptend/
---
## GlossaryDocument.AcceptEnd method

Accepte un visiteur pour visiter la fin du document Glossaire.
