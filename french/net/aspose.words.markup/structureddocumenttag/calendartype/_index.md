...
description: StructuredDocumentTag propriété. Spécifie le type de calendrier pour ce TDS . La valeur par défaut estDefault
type: docs
weight: 50
...
Spécifie le type de calendrier pour ce **TDS** . La valeur par défaut estDefault
