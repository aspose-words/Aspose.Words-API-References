...
description: StructuredDocumentTag propriété. Spécifie le type de bloc de construction pour ce TDS . Ne peut pas être nul.
type: docs
weight: 40
...
Spécifie le type de bloc de construction pour ce **TDS** . Ne peut pas être nul.
