...
description: Découvrez la propriété StructuredDocumentTag ListItems, offrant un accès facile à SdtListItemCollection pour une gestion et une organisation améliorées des documents.
type: docs
weight: 180
...
Obtient[`SdtListItemCollection`](../../sdtlistitemcollection/) associé à cela**SDT** .
