...
description: StructuredDocumentTag propriété. Formatage de la police qui sera appliqué au texte saisi dans TDS .
type: docs
weight: 80
...
Formatage de la police qui sera appliqué au texte saisi dans **TDS** .
