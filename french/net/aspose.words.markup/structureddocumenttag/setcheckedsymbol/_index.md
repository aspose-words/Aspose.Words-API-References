...
description: Découvrez comment utiliser la méthode SetCheckedSymbol dans StructuredDocumentTag pour personnaliser les visuels des cases à cocher et améliorer l'expérience utilisateur.
type: docs
weight: 380
url: /fr/net/aspose.words.markup/structureddocumenttag/setcheckedsymbol/
---
## StructuredDocumentTag.SetCheckedSymbol method

Définit le symbole utilisé pour représenter l'état coché d'un contrôle de contenu de case à cocher.
