...
description: Personnalisez les formats de date avec la propriété DateDisplayLocale de StructuredDocumentTag. Améliorez l'expérience utilisateur en définissant facilement vos formats de langue préférés.
type: docs
weight: 100
...
Permet de définir/obtenir le format de langue pour la date affichée dans ce**SDT** .
