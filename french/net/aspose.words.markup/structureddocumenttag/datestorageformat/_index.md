...
description: Découvrez la propriété StructuredDocumentTag DateStorageFormat pour gérer facilement les formats de date dans les SDT liés à XML, améliorant ainsi l'organisation des données de votre document.
type: docs
weight: 110
...
Obtient/définit le format dans lequel la date d'un SDT de date est stockée lorsque le**SDT** est lié à un nœud XML dans le magasin de données du document. La valeur par défaut estDateTime
