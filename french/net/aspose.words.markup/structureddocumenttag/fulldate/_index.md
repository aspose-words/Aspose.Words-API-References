...
description: StructuredDocumentTag propriété. Spécifie la date et lheure complètes saisies pour la dernière fois dans ce TDS .
type: docs
weight: 130
...
Spécifie la date et l'heure complètes saisies pour la dernière fois dans ce **TDS** .
