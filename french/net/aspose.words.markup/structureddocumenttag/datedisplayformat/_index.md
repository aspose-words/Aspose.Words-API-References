...
description: StructuredDocumentTag propriété. Chaîne qui représente le format dans lequel les dates sont affichées. Ne peut pas être nul. Les dates pour langlais US sont mm/dd/yyyy
type: docs
weight: 90
...
Chaîne qui représente le format dans lequel les dates sont affichées. Ne peut pas être nul. Les dates pour l'anglais (US) sont "mm/dd/yyyy"
