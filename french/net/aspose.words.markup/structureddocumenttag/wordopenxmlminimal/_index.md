...
description: Découvrez la propriété StructuredDocumentTag WordOpenXMLMinimal, qui fournit une chaîne XML propre au format FlatOpc, excluant les éléments non liés au contenu pour un traitement simplifié des documents.
type: docs
weight: 310
