...
description: Aspose.Words.Markup.SmartTag classe. Cet élément spécifie la présence dune balise active autour dune ou plusieurs structures en ligne séries images champs etc. dans un paragraphe.
type: docs
weight: 3810
