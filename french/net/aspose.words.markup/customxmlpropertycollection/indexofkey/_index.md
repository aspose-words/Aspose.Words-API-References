...
description: Découvrez la méthode IndexOfKey de CustomXmlPropertyCollection pour trouver facilement l'index de base zéro de n'importe quelle propriété de votre collection. Améliorez votre efficacité de codage !
type: docs
weight: 70
