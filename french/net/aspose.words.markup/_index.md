...
| [CustomXmlSchemaCollection](./customxmlschemacollection/) | Une collection de chaînes qui représentent les schémas XML associés à une partie XML personnalisée. |
| [SdtListItem](./sdtlistitem/) | Cet élément spécifie un seul élément de liste au sein d'un parentComboBox ouDropDownList balise de document structuré. |
...
| --- | --- |
| [IStructuredDocumentTag](./istructureddocumenttag/) | Interface pour définir des données communes pour[`StructuredDocumentTag`](../aspose.words.markup/structureddocumenttag/) et[`StructuredDocumentTagRangeStart`](../aspose.words.markup/structureddocumenttagrangestart/) . |
## Énumération
