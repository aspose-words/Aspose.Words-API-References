...
description: Découvrez la classe Aspose.Words.Markup.CustomXmlPart pour une gestion efficace du stockage de données XML personnalisées au sein des packages. Optimisez le traitement de vos documents dès aujourd'hui !
type: docs
weight: 4610
...
| [Schemas](../../aspose.words.markup/customxmlpart/schemas/) { get; } | Spécifie l'ensemble des schémas XML associés à cette partie XML personnalisée. |

## Méthodes

| Nom | La description |
| --- | --- |
| [Clone](../../aspose.words.markup/customxmlpart/clone/)() | Effectue une copie « suffisamment profonde » de l'objet. Ne duplique pas les octets de l'objet.[`Data`](./data/) valeur. |
