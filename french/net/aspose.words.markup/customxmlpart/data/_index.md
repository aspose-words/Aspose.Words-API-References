...
description: Accédez et gérez facilement votre stockage de données XML personnalisé grâce à la propriété de données CustomXmlPart. Obtenez ou définissez facilement du contenu XML pour des flux de travail optimisés.
type: docs
weight: 20
