...
description: Supprimez facilement les balises de documents structurés tout en préservant le contenu. Optimisez la structure de vos documents dès aujourd'hui grâce à la méthode RemoveSelfOnly !
type: docs
weight: 250
...
Supprime ces nœuds de début de plage et de fin de plage appropriés de la balise de document structuré, mais conserve son contenu dans l'arborescence du document.
