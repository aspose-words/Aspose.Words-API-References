...
description: StructuredDocumentTagRangeStart propriété. Obtient leBuildingBlock contenant le texte de lespace réservé qui doit être affiché lorsque le contenu de lexécution de cette balise de document structuré est vide lélément XML mappé associé est vide comme spécifié via leXmlMapping élément ou leIsShowingPlaceholderText lélément est vrai.
type: docs
weight: 110
