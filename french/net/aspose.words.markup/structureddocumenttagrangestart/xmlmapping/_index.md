...
description: Obtient un objet qui représente le mappage de cette plage de balises de document structuré aux données XML dans une partie XML personnalisée du document actuel.
type: docs
weight: 180
