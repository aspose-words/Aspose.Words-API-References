...
description: Découvrez la méthode GetById de CustomXmlPartCollection pour récupérer sans effort des parties XML personnalisées par leurs identifiants uniques pour une gestion améliorée des données.
type: docs
weight: 70
...
Recherche et renvoie une partie XML personnalisée par son identifiant.
...
| --- | --- | --- |
| id | String | Chaîne sensible à la casse qui identifie la partie XML personnalisée. |

### Return_Value

Retours`nul` si une partie XML personnalisée avec l'identifiant spécifié n'est pas trouvée.
