...
description: XmlMapping propriété. Renvoie lexpression XPath qui est évaluée pour trouver le nœud XML personnalisé qui est mappé à la balise de document structuré parent.
type: docs
weight: 50
