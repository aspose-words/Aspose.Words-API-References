...
description: Découvrez la propriété XmlMapping CustomXmlPart, qui relie vos balises de document structurées à des parties de données XML personnalisées pour une intégration de document améliorée.
type: docs
weight: 10
