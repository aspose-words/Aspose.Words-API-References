...
description: Spécifie lidentifiant de données XML personnalisé pour la partie de données XML personnalisée qui doit être utilisée pour évaluer leXPathaspose.words.markup/xmlmapping/xpath expression.
type: docs
weight: 40
