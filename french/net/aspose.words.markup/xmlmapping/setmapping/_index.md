...
| --- | --- | --- |
| customXmlPart | CustomXmlPart | Une partie de données XML personnalisée à mapper. |
...
Un indicateur indiquant si la balise de document structuré parent est mappée avec succès sur le nœud XML.
