...
description: Découvrez comment la propriété IStructuredDocumentTag XmlMapping connecte les balises structurées aux données XML, améliorant ainsi la personnalisation et l'intégration des documents.
type: docs
weight: 160
