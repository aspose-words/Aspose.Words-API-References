...
description: Aspose.Words.Markup.SdtCalendarType énumération. Spécifie les types possibles de calendriers qui peuvent être utilisés pour spécifierCalendarType dans un document Office Open XML.
type: docs
weight: 4000
