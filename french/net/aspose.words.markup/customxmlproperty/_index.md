...
description: Représente un seul attribut XML personnalisé ou une propriété de balise active.
type: docs
weight: 3700
...
Utilisé comme élément d'un[`CustomXmlPropertyCollection`](../customxmlpropertycollection/) le recueil.
