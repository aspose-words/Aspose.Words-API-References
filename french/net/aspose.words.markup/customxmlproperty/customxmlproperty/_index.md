...
| --- | --- | --- |
| name | String | Le nom de la propriété. Ne peut pas être nulle. |
| uri | String | URI de l'espace de noms de la propriété. Ne peut pas être nulle. |
| value | String | La valeur de la propriété. Ne peut pas être nulle. |
