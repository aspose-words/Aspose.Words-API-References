...
description: Découvrez la propriété SelectedValue de SdtListItemCollection, qui définit la sélection actuelle dans votre liste, en attribuant la valeur null pour l'absence de sélection. Optimisez votre gestion des données !
type: docs
weight: 30
