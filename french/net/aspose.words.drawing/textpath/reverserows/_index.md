...
description: Découvrez la propriété TextPath ReverseRows pour améliorer votre mise en page. Contrôlez l'ordre des lignes pour une flexibilité de conception et une expérience utilisateur améliorées.
type: docs
weight: 80
url: /fr/net/aspose.words.drawing/textpath/reverserows/
---
...
Si`vrai`L'ordre de disposition des lignes est inversé. Cet attribut est utilisé pour la disposition verticale du texte.
