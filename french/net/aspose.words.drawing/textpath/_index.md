...
description: Aspose.Words.Drawing.TextPath classe. Définit le texte et le formatage du chemin du texte dun objet WordArt en C#.
type: docs
weight: 1350
...
| Nom | La description |
| --- | --- |
| [Bold](../../aspose.words.drawing/textpath/bold/) { get; set; } | True si la police est formatée en gras. |
| [FitPath](../../aspose.words.drawing/textpath/fitpath/) { get; set; } | Définit si le texte correspond au chemin d'une forme. |
| [FitShape](../../aspose.words.drawing/textpath/fitshape/) { get; set; } | Définit si le texte s'adapte au cadre de délimitation d'une forme. |
| [FontFamily](../../aspose.words.drawing/textpath/fontfamily/) { get; set; } | Définit la famille de la police Textpath. |
| [Italic](../../aspose.words.drawing/textpath/italic/) { get; set; } | True si la police est au format italique. |
