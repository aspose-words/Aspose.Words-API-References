...
description: Découvrez la propriété TextPath SameLetterHeights pour garantir une hauteur de lettre uniforme, améliorant ainsi la lisibilité du texte et la cohérence de la conception dans l'ensemble de votre projet.
type: docs
weight: 100
url: /fr/net/aspose.words.drawing/textpath/sameletterheights/
---
## TextPath.SameLetterHeights property

Détermine si toutes les lettres auront la même hauteur quelle que soit la casse initiale.
