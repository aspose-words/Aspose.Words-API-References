...
description: Découvrez la propriété FontFamily TextPath pour définir et personnaliser sans effort vos chemins de texte pour une typographie époustouflante dans la conception Web.
type: docs
weight: 40
url: /fr/net/aspose.words.drawing/textpath/fontfamily/
---
## TextPath.FontFamily property

Définit la famille de polices du chemin de texte.
