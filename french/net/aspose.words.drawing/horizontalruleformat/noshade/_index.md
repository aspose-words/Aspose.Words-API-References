...
description: Indique la présence dun ombrage 3D pour la règle horizontale. Si vrai alors la règle horizontale est sans ombrage 3D et une couleur unie est utilisée.
type: docs
weight: 40
