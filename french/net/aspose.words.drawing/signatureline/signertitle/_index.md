...
description: SignatureLine propriété. Obtient ou définit le titre du signataire suggéré par exemple Manager. La valeur par défaut de cette propriété est chaîne vide Empty .
type: docs
weight: 110
...
Obtient ou définit le titre du signataire suggéré (par exemple, Manager). La valeur par défaut de cette propriété est **chaîne vide** (Empty ).
