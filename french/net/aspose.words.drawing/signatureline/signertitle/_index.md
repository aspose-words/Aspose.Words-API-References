...
description: SignatureLine propriété. Obtient ou définit le titre suggéré du signataire par exemple Manager. La valeur par défaut de cette propriété est chaîne vide Empty.
type: docs
weight: 110
