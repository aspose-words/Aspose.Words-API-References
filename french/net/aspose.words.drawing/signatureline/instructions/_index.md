...
description: Obtient ou définit les instructions au signataire qui sont affichées lors de la signature de la ligne de signature. Cette propriété est ignorée siDefaultInstructionsaspose.words.drawing/signatureline/defaultinstructions est défini. La valeur par défaut de cette propriété est chaîne vide Empty .
type: docs
weight: 50
