...
description: Découvrez la méthode GroupShape AcceptEnd, gérez de manière transparente les interactions des visiteurs et améliorez l'expérience utilisateur de votre application avec cette fonctionnalité puissante.
type: docs
weight: 40
url: /fr/net/aspose.words.drawing/groupshape/acceptend/
---
## GroupShape.AcceptEnd method

Accepte un visiteur pour visiter la fin du GroupShape.
