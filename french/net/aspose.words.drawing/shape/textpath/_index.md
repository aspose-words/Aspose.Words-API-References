...
description: Personnalisez votre WordArt avec la propriété Shape TextPath pour améliorer l'attrait visuel et créer facilement des effets de texte époustouflants.
type: docs
weight: 240
url: /fr/net/aspose.words.drawing/shape/textpath/
---
## Shape.TextPath property

Définit le texte du chemin de texte (d'un objet WordArt).
