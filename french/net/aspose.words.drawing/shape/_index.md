...
description: Découvrez la classe Aspose.Words.Drawing.Shape pour créer sans effort des objets de dessin polyvalents tels que des formes automatiques, des zones de texte et des images dans vos projets.
type: docs
weight: 1640
...
| Nom | La description |
| --- | --- |
| [Adjustments](../../aspose.words.drawing/shape/adjustments/) { get; } | Donne accès aux valeurs brutes de réglage d'une forme. Pour une forme qui ne contient aucune valeur brute de réglage, elle renvoie une collection vide. |
...
| [Chart](../../aspose.words.drawing/shape/chart/) { get; } | Fournit l'accès aux propriétés du graphique si cette forme a un[`Chart`](../../aspose.words.drawing.charts/chart/) . |
...
| [FillColor](../../aspose.words.drawing/shape/fillcolor/) { get; set; } | Définit la couleur du pinceau qui remplit le tracé fermé de la forme. |
...
| [HasChart](../../aspose.words.drawing/shape/haschart/) { get; } | Retours`vrai` si cela`Shape` a un[`Chart`](../../aspose.words.drawing.charts/chart/) . |
...
| [HasSmartArt](../../aspose.words.drawing/shape/hassmartart/) { get; } | Retours`vrai` si cela`Shape` a un objet SmartArt. |
...
| [ImageData](../../aspose.words.drawing/shape/imagedata/) { get; } | Donne accès à l'image de la forme. Renvoie`nul` si la forme ne peut pas avoir d'image. |
...
| [OleFormat](../../aspose.words.drawing/shape/oleformat/) { get; } | Donne accès aux données OLE d'une forme. Pour une forme autre qu'un objet OLE ou un contrôle ActiveX, renvoie`nul` . |
...
| [SignatureLine](../../aspose.words.drawing/shape/signatureline/) { get; } | Obtient[`SignatureLine`](../signatureline/) objet si la forme est une ligne de signature. Renvoie`nul` sinon. |
...
| [StrokeWeight](../../aspose.words.drawing/shape/strokeweight/) { get; set; } | Définit l'épaisseur du pinceau qui parcourt le chemin d'une forme en points. |
...
| override [AcceptEnd](../../aspose.words.drawing/shape/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Accepte un visiteur pour visiter la fin de la forme. |
| override [AcceptStart](../../aspose.words.drawing/shape/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Accepte un visiteur pour visiter le début de la forme. |
...
Les formes qui peuvent contenir du texte peuvent contenir[`Paragraph`](../../aspose.words/paragraph/) et [`Table`](../../aspose.words.tables/table/) nœuds comme enfants.
...
// Insérer deux formes avec une forme de groupe avec une autre forme à l'intérieur.
...
// Supprimez tous les nœuds de forme du document.
NodeCollection shapes = doc.GetChildNodes(NodeType.Shape, true);
shapes.Clear();
...
// Supprimez toutes les formes de groupe séparément.
