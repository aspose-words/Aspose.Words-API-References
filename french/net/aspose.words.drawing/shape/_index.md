...
description: Aspose.Words.Drawing.Shape classe. Représente un objet dans la couche de dessin tel quune forme automatique une zone de texte une forme libre un objet OLE un contrôle ActiveX ou une image.
type: docs
weight: 1100
