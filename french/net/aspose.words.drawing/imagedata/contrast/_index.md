...
description: Réglez facilement le contraste de l'image grâce à la propriété Contraste d'ImageData. Définissez des valeurs de 0,0 (faible) à 1,0 (élevé) pour une clarté et une qualité d'image optimales.
type: docs
weight: 50
...
Récupère ou définit le contraste de l'image spécifiée. La valeur de cette propriété doit être un nombre compris entre 0,0 (contraste le plus faible) et 1,0 (contraste le plus élevé).
