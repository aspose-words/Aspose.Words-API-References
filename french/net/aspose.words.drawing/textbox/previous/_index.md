...
description: TextBox propriété. Renvoie un TextBox qui représente le TextBox précédent dans une séquence de formes.
type: docs
weight: 90
...
Renvoie un TextBox qui représente le TextBox précédent dans une séquence de formes.
