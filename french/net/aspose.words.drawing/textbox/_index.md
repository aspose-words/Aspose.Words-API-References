...
| Nom | La description |
| --- | --- |
| [FitShapeToText](../../aspose.words.drawing/textbox/fitshapetotext/) { get; set; } | Détermine si Microsoft Word agrandira la forme pour l'adapter au texte. |
...
| [Next](../../aspose.words.drawing/textbox/next/) { get; set; } | Renvoie ou définit un`TextBox` cela représente le prochain`TextBox` dans une séquence de formes. |
| [NoTextRotation](../../aspose.words.drawing/textbox/notextrotation/) { get; set; } | Obtient ou définit une valeur booléenne indiquant que le texte de TextBox ne doit pas pivoter lorsque la forme est pivotée. |
