...
description: GradientStop propriété. Obtient ou définit une valeur représentant la position dun arrêt dans le gradient exprimée en pourcentage dans la plage 00 à 10.
type: docs
weight: 40
