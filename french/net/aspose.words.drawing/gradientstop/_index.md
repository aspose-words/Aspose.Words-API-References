...
description: Découvrez la classe Aspose.Words.Drawing.GradientStop, votre solution pour créer des dégradés époustouflants avec des arrêts personnalisables pour des visuels de documents améliorés.
type: docs
weight: 1310
...
| Nom | La description |
| --- | --- |
| [BaseColor](../../aspose.words.drawing/gradientstop/basecolor/) { get; } | Obtient une valeur représentant la couleur de l'arrêt du dégradé sans aucun modificateur. |
