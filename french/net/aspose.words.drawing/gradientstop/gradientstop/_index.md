...
description: Initialise une nouvelle instance duGradientStopaspose.words.drawing/gradientstop classe.
type: docs
weight: 10
...
Initialise une nouvelle instance du[`GradientStop`](../../gradientstop) classe.
...
| color | Color | Représente la couleur de l'arrêt du dégradé. |
| position | Double | Représente la position d'un arrêt dans le gradient exprimé en pourcentage dans la plage de 0,0 à 1,0. |
| transparency | Double | Représente la transparence d'un stop dans le gradient exprimé en pourcentage dans la plage de 0,0 à 1,0. |
