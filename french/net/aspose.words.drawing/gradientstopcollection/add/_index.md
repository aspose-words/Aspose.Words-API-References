...
description: Améliorez vos dégradés sans effort grâce à la méthode d'ajout de GradientStopCollection. Ajoutez facilement des GradientStops personnalisés pour des designs éclatants.
type: docs
weight: 30
