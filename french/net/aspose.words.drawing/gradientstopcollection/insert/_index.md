...
description: Ajoutez facilement un GradientStop à votre collection grâce à la méthode d'insertion GradientStopCollection. Améliorez vos transitions de couleurs en toute fluidité !
type: docs
weight: 50
...
Insère un[`GradientStop`](../../gradientstop/) à la collection à un index spécifié.
