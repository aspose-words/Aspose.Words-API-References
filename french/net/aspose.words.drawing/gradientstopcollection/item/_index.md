...
description: Découvrez la propriété Item polyvalente de GradientStopCollection pour gérer facilement les objets GradientStop, améliorant ainsi votre conception avec des dégradés dynamiques.
type: docs
weight: 20
...
Obtient ou définit un[`GradientStop`](../../gradientstop/) objet dans la collection.
