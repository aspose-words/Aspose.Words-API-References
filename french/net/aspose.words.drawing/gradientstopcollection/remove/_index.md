...
description: Supprimez facilement un GradientStop spécifique de votre collection grâce à la méthode GradientStopCollection Remove. Simplifiez votre processus de création dès aujourd'hui !
type: docs
weight: 60
url: /fr/net/aspose.words.drawing/gradientstopcollection/remove/
---
## GradientStopCollection.Remove method

Supprime un spécifié[`GradientStop`](../../gradientstop/) de la collection.
...
`vrai` si l'arrêt du gradient a été supprimé avec succès, sinon`FAUX`.
