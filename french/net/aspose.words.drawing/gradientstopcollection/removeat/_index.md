...
description: Gérez facilement votre GradientStopCollection avec la méthode RemoveAt. Supprimez facilement les GradientStops par index pour un contrôle de conception simplifié.
type: docs
weight: 70
url: /fr/net/aspose.words.drawing/gradientstopcollection/removeat/
---
## GradientStopCollection.RemoveAt method

Supprime un[`GradientStop`](../../gradientstop/) de la collection à un index spécifié.
