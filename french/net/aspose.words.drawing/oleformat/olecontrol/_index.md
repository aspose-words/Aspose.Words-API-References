...
description: ObtientOleControlaspose.words.drawing/oleformat/olecontrol objets si cet objet OLE est un contrôle ActiveX. Sinon cette propriété est nulle.
type: docs
weight: 60
