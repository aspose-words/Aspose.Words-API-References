...
description: Découvrez la propriété Stroke StartArrowWidth pour personnaliser la largeur de la pointe de flèche de vos traits, améliorant ainsi la précision et l'attrait visuel de votre conception.
type: docs
weight: 230
url: /fr/net/aspose.words.drawing/stroke/startarrowwidth/
---
## Stroke.StartArrowWidth property

Définit la largeur de la pointe de flèche pour le début d'un trait.
