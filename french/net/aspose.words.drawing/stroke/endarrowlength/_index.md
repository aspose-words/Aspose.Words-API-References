...
description: Découvrez la propriété Stroke EndArrowLength pour personnaliser votre conception avec des longueurs de pointe de flèche précises, améliorant ainsi la clarté visuelle et le style.
type: docs
weight: 80
url: /fr/net/aspose.words.drawing/stroke/endarrowlength/
---
## Stroke.EndArrowLength property

Définit la longueur de la pointe de flèche pour la fin d'un trait.
