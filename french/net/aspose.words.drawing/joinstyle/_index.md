...
description: Découvrez l'énumération Aspose.Words.Drawing.JoinStyle pour des styles de jointure de lignes polyvalents. Améliorez les graphismes de vos documents avec une qualité et une flexibilité professionnelles.
type: docs
weight: 1420
url: /fr/net/aspose.words.drawing/joinstyle/
---
## JoinStyle enumeration

Style de jonction de ligne.
...
| --- | --- | --- |
| Bevel | `0` | Joignez les bords par une ligne droite. |
| Miter | `1` | Étendez les bords jusqu'à ce qu'ils se rejoignent. |
| Round | `2` | Tracez un arc entre les deux bords. |
