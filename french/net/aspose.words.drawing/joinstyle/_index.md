...
description: Aspose.Words.Drawing.JoinStyle énumération. Style de jointure de ligne en C#.
type: docs
weight: 1090
...
| --- | --- | --- |
| Bevel | `0` | Joindre les bords par une ligne droite. |
| Miter | `1` | Étendre les bords jusqu'à ce qu'ils se rejoignent. |
