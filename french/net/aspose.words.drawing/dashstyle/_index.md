...
description: Découvrez l'énumération Aspose.Words.Drawing.DashStyle pour des styles de lignes pointillées polyvalents. Améliorez la conception de vos documents avec des éléments visuels personnalisables.
type: docs
weight: 1250
...
| ShortDash | `1` | Style de tableau de bord système. |
| ShortDot | `2` | Style de tableau de bord système. |
| ShortDashDot | `3` | Style de tableau de bord système. |
| ShortDashDotDot | `4` | Style de tableau de bord système. |
| Dot | `5` | Style de point carré. |
| Dash | `6` | Style de tiret. |
| LongDash | `7` | Style tiret long. |
| DashDot | `8` | Tiret court. |
