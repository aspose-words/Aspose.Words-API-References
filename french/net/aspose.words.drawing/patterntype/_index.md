...
| DarkHorizontal | `15` | Horizontal sombre. |
| DarkUpwardDiagonal | `16` | Diagonale ascendante sombre. |
| DarkVertical | `17` | Vertical sombre. |
| DashedDownwardDiagonal | `18` | Diagonale pointillée vers le bas. |
| DashedHorizontal | `19` | Pointillé horizontal. |
| DashedUpwardDiagonal | `20` | Diagonale vers le haut en pointillés. |
| DashedVertical | `21` | Vertical en pointillés. |
...
| OutlinedDiamond | `40` | Diamant décrit. |
| Plaid | `41` | Plaid. |
| Shingle | `42` | Bardeau. |
