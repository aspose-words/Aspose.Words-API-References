...
description: Découvrez la propriété ShapeBase DistanceLeft pour ajuster facilement la distance en points entre le texte de votre document et le bord gauche des formes pour un contrôle de mise en page amélioré.
type: docs
weight: 140
