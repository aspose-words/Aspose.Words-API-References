...
description: Découvrez la propriété ShapeBase DistanceRight, ajustez facilement l'espacement des points entre le texte de votre document et le bord droit d'une forme pour un contrôle de mise en page amélioré.
type: docs
weight: 150
