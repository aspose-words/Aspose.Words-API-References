...
description: Découvrez la propriété ShapeBase Bottom pour accéder facilement à la position du bord inférieur du bloc contenant votre forme pour un contrôle de conception précis.
type: docs
weight: 60
