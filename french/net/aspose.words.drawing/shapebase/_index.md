...
description: Aspose.Words.Drawing.ShapeBase classe. Classe de base pour les objets du calque de dessin tels quune forme automatique une forme libre un objet OLE un contrôle ActiveX ou une image en C#.
type: docs
weight: 1260
