...
description: Aspose.Words.Drawing.ShapeBase classe. Classe de base pour les objets de la couche de dessin tels quune forme automatique une forme libre un objet OLE un contrôle ActiveX ou une image.
type: docs
weight: 1110
