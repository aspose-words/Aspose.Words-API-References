...
description: Découvrez si votre forme est un objet WordArt avec ShapeBase. Obtenez des résultats précis et améliorez vos projets de conception sans effort !
type: docs
weight: 380
url: /fr/net/aspose.words.drawing/shapebase/iswordart/
---
## ShapeBase.IsWordArt property

Retours`vrai` si cette forme est un objet WordArt.
...
Fonctionne jusqu'au mode de compatibilité 2007. En mode de compatibilité 2010 et supérieur, WordArt n'est qu'une zone de texte avec des polices fantaisistes.
