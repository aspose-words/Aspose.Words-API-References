...
description: Découvrez la propriété ShapeBase BoundsWithEffects pour obtenir l'étendue finale de votre forme après avoir appliqué des effets de dessin, mesurée en points pour plus de précision.
type: docs
weight: 90
url: /fr/net/aspose.words.drawing/shapebase/boundswitheffects/
---
## ShapeBase.BoundsWithEffects property

Obtient l'étendue finale de cet objet de forme après l'application des effets de dessin. La valeur est mesurée en points.
...
// Créer un objet RectangleF, représentant un rectangle,
...
// Étant donné que la forme n'a aucun effet de modification de bordure, ses dimensions de limite ne sont pas affectées.
...
// Vérifier l'étendue finale de la première forme, en points.
