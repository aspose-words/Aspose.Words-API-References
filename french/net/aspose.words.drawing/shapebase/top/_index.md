...
description: ShapeBase propriété. Obtient ou définit la position du bord supérieur du bloc conteneur de la forme.
type: docs
weight: 500
...
Obtient ou définit la position du bord supérieur du bloc conteneur de la forme.
