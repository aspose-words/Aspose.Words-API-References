...
description: Définissez la propriété ForeColor pour personnaliser la couleur de premier plan de votre remplissage avec un objet Color, améliorant ainsi l'attrait visuel et la flexibilité de conception.
type: docs
weight: 70
...
Cette propriété réinitialise la composante alpha duColor à une couleur totalement opaque contrairement à la[`Color`](../color/) propriété, qui la préserve.
