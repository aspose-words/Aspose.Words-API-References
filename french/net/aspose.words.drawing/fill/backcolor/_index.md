...
description: Personnalisez facilement la couleur d'arrière-plan de votre remplissage grâce à la propriété BackColor. Définissez ou obtenez facilement un objet Color pour un design dynamique.
type: docs
weight: 10
