...
description: Explorez la classe Aspose.Words.Drawing.Fill pour des options de formatage de remplissage avancées, améliorant la conception et l'attrait visuel de votre document sans effort.
type: docs
weight: 1270
...
Représente le formatage de remplissage d'un objet.
...
| [BaseForeColor](../../aspose.words.drawing/fill/baseforecolor/) { get; } | Obtient un objet Color qui représente la couleur de premier plan de base pour le remplissage sans aucun modificateur. |
| [Color](../../aspose.words.drawing/fill/color/) { get; set; } | Obtient ou définit un objet Color qui représente la couleur de premier plan pour le remplissage. |
...
| [ForeThemeColor](../../aspose.words.drawing/fill/forethemecolor/) { get; set; } | Obtient ou définit un objet ThemeColor qui représente la couleur de premier plan pour le remplissage. |
...
| [GradientAngle](../../aspose.words.drawing/fill/gradientangle/) { get; set; } | Obtient ou définit l'angle du remplissage du dégradé. |
...
| [TextureAlignment](../../aspose.words.drawing/fill/texturealignment/) { get; set; } | Obtient ou définit l'alignement pour le remplissage de la texture des tuiles. |
...
| Nom | La description |
| --- | --- |
| [OneColorGradient](../../aspose.words.drawing/fill/onecolorgradient/#onecolorgradient)(*[GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/), double*) | Définit le remplissage spécifié sur un dégradé d'une couleur. |
| [OneColorGradient](../../aspose.words.drawing/fill/onecolorgradient/#onecolorgradient_1)(*Color, [GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/), double*) | Définit le remplissage spécifié sur un dégradé d'une couleur en utilisant la couleur spécifiée. |
...
| [TwoColorGradient](../../aspose.words.drawing/fill/twocolorgradient/#twocolorgradient)(*[GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/)*) | Définit le remplissage spécifié sur un dégradé de deux couleurs. |
| [TwoColorGradient](../../aspose.words.drawing/fill/twocolorgradient/#twocolorgradient_1)(*Color, Color, [GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/)*) | Définit le remplissage spécifié sur un dégradé de deux couleurs. |

## Remarques

Utilisez le[`Fill`](../shapebase/fill/) ou[`Fill`](../../aspose.words/font/fill/) propriété pour accéder aux propriétés de remplissage d'un objet. Vous ne créez pas d'instances de la`Fill` classe directement.
