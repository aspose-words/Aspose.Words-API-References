...
description: Créez facilement des liaisons d'extensions Web puissantes avec le constructeur WebExtensionBinding. Personnalisez les paramètres pour une intégration fluide et des fonctionnalités améliorées.
type: docs
weight: 10
...
| --- | --- | --- |
| id | String | Identifiant de liaison. |
| bindingType | WebExtensionBindingType | Type de reliure. |
| appRef | String | Clé de liaison utilisée pour mapper l'entrée de liaison dans cette liste avec les données liées dans le document. |
