...
description: Découvrez comment la propriété WebExtensionBinding AppRef lie les clés de liaison aux données du document, améliorant ainsi les fonctionnalités et les performances de votre application Web.
type: docs
weight: 20
