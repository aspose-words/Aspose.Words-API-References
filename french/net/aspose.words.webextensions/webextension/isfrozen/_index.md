...
description: Découvrez la propriété WebExtension IsFrozen, qui contrôle l'interaction utilisateur avec votre extension web. Améliorez l'ergonomie et optimisez l'expérience utilisateur dès aujourd'hui !
type: docs
weight: 40
url: /fr/net/aspose.words.webextensions/webextension/isfrozen/
---
## WebExtension.IsFrozen property

Spécifie si l'utilisateur peut interagir avec l'extension Web ou non.
