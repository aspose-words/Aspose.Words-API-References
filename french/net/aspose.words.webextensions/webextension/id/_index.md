...
description: Découvrez la propriété WebExtension Id, votre clé pour identifier de manière unique les instances d'extension Web dans les documents pour des fonctionnalités améliorées et une intégration transparente.
type: docs
weight: 30
