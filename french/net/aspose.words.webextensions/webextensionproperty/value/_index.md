...
description: Découvrez la fonctionnalité WebExtensionProperty Value, vous permettant de définir des valeurs de propriété personnalisées pour des fonctionnalités et une flexibilité améliorées dans vos applications Web.
type: docs
weight: 30
