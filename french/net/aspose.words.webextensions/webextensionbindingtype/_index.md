...
description: Découvrez l'énumération Aspose.Words WebExtensionBindingType, qui définit les types de liaison pour une intégration transparente des extensions Web avec les données de votre document.
type: docs
weight: 7620
url: /fr/net/aspose.words.webextensions/webextensionbindingtype/
---
...
| --- | --- | --- |
| Matrix | `0` | Données tabulaires sans ligne d'en-tête. |
| Table | `1` | Données tabulaires avec une ligne d'en-tête. |
| Text | `2` | Texte brut. |
| Default | `0` | Matrice utilisée par défaut. |
