...
description: Découvrez la propriété TaskPane IsLocked, contrôlez l'accessibilité du volet des tâches dans votre interface utilisateur, garantissant que les utilisateurs ne peuvent pas fermer les fonctionnalités essentielles pour une productivité améliorée.
type: docs
weight: 30
...
Spécifie si le volet Office est verrouillé sur le document dans l'interface utilisateur et ne peut pas être fermé par l'utilisateur.
