...
description: Découvrez comment la propriété TaskPane IsVisible contrôle la visibilité par défaut, améliorant ainsi l'expérience utilisateur et simplifiant les interactions avec les documents.
type: docs
weight: 40
...
Spécifie si le volet Office s'affiche comme visible par défaut lorsque le document s'ouvre.
