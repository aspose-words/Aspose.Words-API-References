...
description: Découvrez la propriété TaskPane Row, gérez facilement l'indexation du volet des tâches pour une organisation simplifiée et une productivité améliorée dans vos applications.
type: docs
weight: 50
...
Spécifie l'index, énumérant de l'extérieur vers l'intérieur, de ce volet de tâches parmi d'autres volets de tâches persistants ancrés dans le même emplacement par défaut.
