...
description: Découvrez la propriété DockState de TaskPane pour gérer facilement la dernière position ancrée de votre volet des tâches pour un flux de travail et une efficacité améliorés.
type: docs
weight: 20
url: /fr/net/aspose.words.webextensions/taskpane/dockstate/
---
## TaskPane.DockState property

Spécifie le dernier emplacement ancré de cet objet du volet Office.
