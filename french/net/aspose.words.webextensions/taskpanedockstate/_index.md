...
description: Découvrez l'énumération Aspose.Words.WebExtensions.TaskPaneDockState, qui définit les emplacements du volet des tâches pour une édition de documents et une expérience utilisateur améliorées.
type: docs
weight: 7580
...
| Left | `1` | Ancrez le volet Office sur le côté gauche de la fenêtre du document. |
