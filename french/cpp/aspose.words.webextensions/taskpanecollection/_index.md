---
title: "Aspose::Words::WebExtensions::TaskPaneCollection classe"
linktitle: "TaskPaneCollection"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::WebExtensions::TaskPaneCollection classe. Spécifie une liste d'objets de volet de tâche persistants. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Spécifie une liste d'objets de volet de tâche persistés. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
