...
description: "Aspose::Words::WebExtensions::WebExtensionBindingCollection classe. Spécifie une liste de liaisons d'extension web. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.webextensions/webextensionbindingcollection/
---
## WebExtensionBindingCollection class


Spécifie une liste de liaisons d'extension web. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
