---
title: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding constructeur"
linktitle: "WebExtensionBinding"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding constructeur. Crée une liaison d'extension web avec les paramètres spécifiés en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.webextensions/webextensionbinding/webextensionbinding/
---
...
| --- | --- | --- |
| id | const System::String\& | Identifiant de liaison. |
| bindingType | Aspose::Words::WebExtensions::WebExtensionBindingType | Type de liaison. |
| appRef | const System::String\& | Clé de liaison utilisée pour associer l'entrée de liaison dans cette liste aux données liées dans le document. |
