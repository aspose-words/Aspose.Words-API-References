...
description: "Aspose::Words::WebExtensions::WebExtension classe. Représente un objet d'extension web. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Représente un objet d'extension web. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Méthode | Description |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Spécifie des références alternatives à une extension web. |
| [get_Bindings](./get_bindings/)() const | Spécifie une liste de liaisons d'extension web. |
| [get_Id](./get_id/)() const | Identifie de manière unique l'instance d'extension web dans le document actuel. |
| [get_IsFrozen](./get_isfrozen/)() const | Spécifie si l'utilisateur peut interagir avec l'extension web ou non. |
| [get_Properties](./get_properties/)() const | Représente un ensemble de propriétés personnalisées d'extension web. |
| [get_Reference](./get_reference/)() const | Spécifie la référence principale à une extension web. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Mutateur pour [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Mutateur pour [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
