...
description: "Aspose::Words::WebExtensions::WebExtensionReference class. Représente la référence à une extension web. La référence est utilisée pour identifier l'emplacement du fournisseur et la version de l'extension. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 9000
url: /fr/cpp/aspose.words.webextensions/webextensionreference/
---
## WebExtensionReference class


Représente la référence à une extension web. La référence est utilisée pour identifier l'emplacement du fournisseur et la version de l'extension. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Méthode | Description |
| --- | --- |
| [get_Id](./get_id/)() const | Identifiant associé à l'extension web au sein d'un fournisseur de catalogue. |
| [get_Store](./get_store/)() const | Spécifie l'instance du marketplace où l'extension web est stockée. |
| [get_StoreType](./get_storetype/)() const | Spécifie le type de marketplace. |
| [get_Version](./get_version/)() const | Spécifie la version de l'extension web. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Définisseur pour [Aspose::Words::WebExtensions::WebExtensionReference::get_Id](./get_id/). |
| [set_Store](./set_store/)(const System::String\&) | Définisseur pour [Aspose::Words::WebExtensions::WebExtensionReference::get_Store](./get_store/). |
| [set_StoreType](./set_storetype/)(Aspose::Words::WebExtensions::WebExtensionStoreType) | Définisseur pour [Aspose::Words::WebExtensions::WebExtensionReference::get_StoreType](./get_storetype/). |
| [set_Version](./set_version/)(const System::String\&) | Définisseur pour [Aspose::Words::WebExtensions::WebExtensionReference::get_Version](./get_version/). |
| static [Type](./type/)() |  |
