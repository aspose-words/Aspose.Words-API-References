...
description: "Aspose::Words::WebExtensions::TaskPane classe. Représente un objet de volet de tâche d'add-in. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.webextensions/taskpane/
---
## TaskPane class


Représente un objet de volet de tâche d'add-in. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Méthode | Description |
| --- | --- |
| [get_DockState](./get_dockstate/)() const | Spécifie le dernier emplacement ancré de cet objet de volet de tâche. |
| [get_IsLocked](./get_islocked/)() const | Spécifie si le volet de tâche est verrouillé au document dans l'interface utilisateur et ne peut pas être fermé par l'utilisateur. |
| [get_IsVisible](./get_isvisible/)() const | Spécifie si le volet de tâche est affiché visible par défaut lorsque le document s'ouvre. |
| [get_Row](./get_row/)() const | Spécifie l'index, en énumérant de l'extérieur vers l'intérieur, de ce volet de tâche parmi les autres volets de tâche persistants ancrés au même emplacement par défaut. |
| [get_WebExtension](./get_webextension/)() const | Représente un objet d'extension web. |
| [get_Width](./get_width/)() const | Spécifie la valeur de largeur par défaut pour cette instance de volet de tâche. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DockState](./set_dockstate/)(Aspose::Words::WebExtensions::TaskPaneDockState) | Définisseur pour [Aspose::Words::WebExtensions::TaskPane::get_DockState](./get_dockstate/). |
| [set_IsLocked](./set_islocked/)(bool) | Définisseur pour [Aspose::Words::WebExtensions::TaskPane::get_IsLocked](./get_islocked/). |
| [set_IsVisible](./set_isvisible/)(bool) | Définisseur pour [Aspose::Words::WebExtensions::TaskPane::get_IsVisible](./get_isvisible/). |
| [set_Row](./set_row/)(int32_t) | Définisseur pour [Aspose::Words::WebExtensions::TaskPane::get_Row](./get_row/). |
| [set_Width](./set_width/)(double) | Définisseur pour [Aspose::Words::WebExtensions::TaskPane::get_Width](./get_width/). |
| [TaskPane](./taskpane/)() |  |
| static [Type](./type/)() |  |
