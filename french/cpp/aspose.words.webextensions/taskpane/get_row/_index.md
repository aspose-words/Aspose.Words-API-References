---
title: "Aspose::Words::WebExtensions::TaskPane::get_Row méthode"
linktitle: "get_Row"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::WebExtensions::TaskPane::get_Row méthode. Spécifie l'index, en énumérant de l'extérieur vers l'intérieur, de ce volet de tâche parmi les autres volets de tâche persistants ancrés au même emplacement par défaut en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.webextensions/taskpane/get_row/
---
## TaskPane::get_Row method


Spécifie l'index, en énumérant de l'extérieur vers l'intérieur, de ce volet de tâche parmi les autres volets de tâche persistants ancrés au même emplacement par défaut.
