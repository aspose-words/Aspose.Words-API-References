---
title: "Aspose::Words::WebExtensions::WebExtensionBindingType énum"
linktitle: "WebExtensionBindingType"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::WebExtensions::WebExtensionBindingType énum. Énumère les types disponibles de liaison entre une extension Web et les données du document en C++."
type: docs
weight: 12000
url: /fr/cpp/aspose.words.webextensions/webextensionbindingtype/
---
## WebExtensionBindingType enum


Énumère les types de liaison disponibles entre une extension web et les données du document.
...
| --- | --- | --- |
| Matrice | 0 | Données tabulaires sans ligne d'en-tête. |
| Table | 1 | Données tabulaires avec une ligne d'en-tête. |
| Texte | 2 | Texte brut. |
| Default | n/a | Matrice utilisée par défaut. |
