---
title: "Classe Aspose::Words::WebExtensions::WebExtensionPropertyCollection"
linktitle: "WebExtensionPropertyCollection"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Classe Aspose::Words::WebExtensions::WebExtensionPropertyCollection. Spécifie un ensemble de propriétés personnalisées d'extension web. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Spécifie un ensemble de propriétés personnalisées d'extension web. Pour en savoir plus, consultez l'article de documentation [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
