---
title: "Aspose::Words::Fields::DropDownItemCollection::Insert méthode"
linktitle: "Insérer"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::DropDownItemCollection::Insert méthode. Insère une chaîne dans la collection à l'index spécifié en C++."
type: docs
weight: 15000
url: /fr/cpp/aspose.words.fields/dropdownitemcollection/insert/
---
...
| --- | --- | --- |
| index | int32_t | L'index basé sur zéro où la valeur est insérée. |
| value | const System::String\& | La chaîne à insérer. |
