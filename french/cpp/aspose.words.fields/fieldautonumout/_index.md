...
description: "Aspose::Words::Fields::FieldAutoNumOut classe. Implémente le champ AUTONUMOUT. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 14000
url: /fr/cpp/aspose.words.fields/fieldautonumout/
---
## FieldAutoNumOut class


Implémente le champ AUTONUMOUT. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Montre comment numéroter les paragraphes en utilisant les champs AUTONUMOUT.
```cpp
...
// que nous pouvons définir dans Microsoft Word via Format -> Puces et numérotation -> "Outline Numbered".
// Cela nous permet de numéroter automatiquement les éléments comme dans une liste numérotée.
// Les champs LISTNUM sont une alternative plus récente aux champs AUTONUMOUT.
