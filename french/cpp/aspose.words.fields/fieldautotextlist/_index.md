...
description: "Aspose::Words::Fields::FieldAutoTextList classe. Implémente le champ AUTOTEXTLIST. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 16000
url: /fr/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


Implémente le champ AUTOTEXTLIST. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() | Obtient le nom de l'entrée AutoText. |
...
| [get_ListStyle](./get_liststyle/)() | Obtient le nom du style sur lequel la liste contenant les entrées est basée. |
...
| [get_ScreenTip](./get_screentip/)() | Obtient le texte de l'infobulle à afficher. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Définit le nom de l'entrée AutoText. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | Définit le nom du style sur lequel la liste contenant les entrées est basée. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | Définit le texte de l'infobulle à afficher. |
| static [Type](./type/)() |  |
