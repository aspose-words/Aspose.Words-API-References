---
title: "Aspose::Words::Fields::FieldDocVariable classe"
linktitle: "FieldDocVariable"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldDocVariable classe. Implémente le champ DOCVARIABLE. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 36000
url: /fr/cpp/aspose.words.fields/fielddocvariable/
---
## FieldDocVariable class


Implémente le champ DOCVARIABLE. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_VariableName](./get_variablename/)() | Obtient ou définit le nom de la variable de document à récupérer. |
...
| [set_VariableName](./set_variablename/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldDocVariable::get_VariableName](./get_variablename/). |
| static [Type](./type/)() |  |
