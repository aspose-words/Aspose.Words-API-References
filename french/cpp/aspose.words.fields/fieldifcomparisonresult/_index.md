...
description: "Aspose::Words::Fields::FieldIfComparisonResult enum. Spécifie le résultat de l'évaluation de la condition du champ IF en C++."
type: docs
weight: 128000
url: /fr/cpp/aspose.words.fields/fieldifcomparisonresult/
---
...
| --- | --- | --- |
| Erreur | 0 | Il y a une erreur dans la condition. |
| Vrai | 1 | La condition est **true**. |
| Faux | 2 | La condition est **false**. |
