---
title: "Méthode Aspose::Words::Fields::FieldHyperlink::get_OpenInNewWindow"
linktitle: "get_OpenInNewWindow"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Fields::FieldHyperlink::get_OpenInNewWindow. Obtient ou définit si le site de destination doit s'ouvrir dans une nouvelle fenêtre du navigateur web en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.fields/fieldhyperlink/get_openinnewwindow/
---
## FieldHyperlink::get_OpenInNewWindow method


Obtient ou définit si le site de destination doit s'ouvrir dans une nouvelle fenêtre de navigateur web.
