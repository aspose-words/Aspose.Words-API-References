---
title: "Méthode Aspose::Words::Fields::FieldSeq::get_ResetNumber"
linktitle: "get_ResetNumber"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Fields::FieldSeq::get_ResetNumber. Obtient ou définit un nombre entier pour réinitialiser le numéro de séquence. Retourne -1 si le nombre est absent en C++."
type: docs
weight: 5000
url: /fr/cpp/aspose.words.fields/fieldseq/get_resetnumber/
---
## FieldSeq::get_ResetNumber method


Obtient ou définit un nombre entier auquel réinitialiser le numéro de séquence. Retourne -1 si le nombre est absent.
