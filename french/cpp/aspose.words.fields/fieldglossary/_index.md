...
description: "Classe Aspose::Words::Fields::FieldGlossary. Implémente le champ GLOSSARY. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 50000
url: /fr/cpp/aspose.words.fields/fieldglossary/
---
## FieldGlossary class


Implémente le champ GLOSSARY. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() override | Obtient ou définit le nom de l'entrée du glossaire à insérer. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldGlossary::get_EntryName](./get_entryname/). |
