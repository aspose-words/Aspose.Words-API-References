---
title: "Classe Aspose::Words::Fields::FieldBibliography"
linktitle: "FieldBibliography"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Classe Aspose::Words::Fields::FieldBibliography. Implémente le champ BIBLIOGRAPHY. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 18000
url: /fr/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


Implémente le champ BIBLIOGRAPHY. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Obtient l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue. |
| [get_Format](../field/get_format/)() | Obtient un objet [FieldFormat](../fieldformat/) qui fournit un accès typé au format du champ. |
| [get_FormatLanguageId](./get_formatlanguageid/)() | Obtient l'ID de langue utilisé pour formater les sources bibliographiques dans le document. |
...
| [get_SourceTag](./get_sourcetag/)() | Obtient une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Définit l'ID de langue utilisé pour filtrer les données bibliographiques afin de ne conserver que les sources du document qui utilisent cette langue. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Définit l'ID de langue utilisé pour formater les sources bibliographiques dans le document. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Définit une valeur afin que seules les sources dont la valeur de l'élément Tag correspondante soient affichées dans la bibliographie. |
| static [Type](./type/)() |  |
