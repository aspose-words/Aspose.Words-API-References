...
description: "Aspose::Words::Fields::FieldEnd class. Représente la fin d'un champ Word dans un document. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 39000
url: /fr/cpp/aspose.words.fields/fieldend/
---
## FieldEnd class


Représente la fin d'un champ Word dans un document. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_HasSeparator](./get_hasseparator/)() const | Renvoie **true** si ce champ possède un séparateur. |
...
| [get_NodeType](./get_nodetype/)() const override | Renvoie [FieldEnd](../../aspose.words/nodetype/). |
