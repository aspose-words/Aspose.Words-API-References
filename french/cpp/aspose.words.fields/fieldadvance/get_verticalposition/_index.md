---
title: "Aspose::Words::Fields::FieldAdvance::get_VerticalPosition méthode"
linktitle: "get_VerticalPosition"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldAdvance::get_VerticalPosition méthode. Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé verticalement depuis le bord supérieur de la page en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.fields/fieldadvance/get_verticalposition/
---
## FieldAdvance::get_VerticalPosition method


Obtient ou définit le nombre de points de déplacement vertical du texte qui suit le champ depuis le bord supérieur de la page.
