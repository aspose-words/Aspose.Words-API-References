---
title: "Aspose::Words::Fields::FieldAdvance::get_DownOffset méthode"
linktitle: "get_DownOffset"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldAdvance::get_DownOffset méthode. Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers le bas en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.fields/fieldadvance/get_downoffset/
---
## FieldAdvance::get_DownOffset method


Obtient ou définit le nombre de points de déplacement vers le bas du texte qui suit le champ.
