---
title: "Méthode Aspose::Words::Fields::FieldAdvance::get_UpOffset"
linktitle: "get_UpOffset"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Fields::FieldAdvance::get_UpOffset. Obtient ou définit le nombre de points par lesquels le texte qui suit le champ doit être déplacé vers le haut en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.fields/fieldadvance/get_upoffset/
---
## FieldAdvance::get_UpOffset method


Obtient ou définit le nombre de points de déplacement vers le haut du texte qui suit le champ.
