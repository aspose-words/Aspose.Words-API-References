---
title: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset méthode"
linktitle: "get_LeftOffset"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset méthode. Obtient ou définit le nombre de points par lequel le texte qui suit le champ doit être déplacé vers la gauche en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.fields/fieldadvance/get_leftoffset/
---
## FieldAdvance::get_LeftOffset method


Obtient ou définit le nombre de points de déplacement vers la gauche du texte qui suit le champ.
