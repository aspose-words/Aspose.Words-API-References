---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle méthode"
linktitle: "get_PosCodeStyle"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle méthode. Obtient ou définit le style d'un code-barres Point de Vente (types de code-barres UPCA|UPCE|EAN13|EAN8). Les valeurs valides (insensibles à la casse) sont [STD|SUP2|SUP5|CASE] en C++."
type: docs
weight: 11000
url: /fr/cpp/aspose.words.fields/fielddisplaybarcode/get_poscodestyle/
---
## FieldDisplayBarcode::get_PosCodeStyle method


Obtient ou définit le style d'un code-barres Point de Vente (types de code-barres UPCA|UPCE|EAN13|EAN8). Les valeurs valides (insensibles à la casse) sont [STD|SUP2|SUP5|CASE].
