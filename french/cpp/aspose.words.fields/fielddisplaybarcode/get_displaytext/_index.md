---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText méthode"
linktitle: "get_DisplayText"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText méthode. Obtient ou définit si les données du code-barres (texte) doivent être affichées avec l'image en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.fields/fielddisplaybarcode/get_displaytext/
---
## FieldDisplayBarcode::get_DisplayText method


Obtient ou définit si les données du code-barres (texte) doivent être affichées avec l'image.
