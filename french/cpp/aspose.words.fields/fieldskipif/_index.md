---
title: "Aspose::Words::Fields::FieldSkipIf classe"
linktitle: "FieldSkipIf"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldSkipIf classe. Implémente le champ SKIPIF. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 94000
url: /fr/cpp/aspose.words.fields/fieldskipif/
---
## FieldSkipIf class


Implémente le champ SKIPIF. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [get_ComparisonOperator](./get_comparisonoperator/)() | Obtient l'opérateur de comparaison. |
...
| [get_LeftExpression](./get_leftexpression/)() | Obtient la partie gauche de l'expression de comparaison. |
...
| [get_RightExpression](./get_rightexpression/)() | Obtient la partie droite de l'expression de comparaison. |
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | Définit l'opérateur de comparaison. |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | Définit la partie gauche de l'expression de comparaison. |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | Définit la partie droite de l'expression de comparaison. |
| static [Type](./type/)() |  |
