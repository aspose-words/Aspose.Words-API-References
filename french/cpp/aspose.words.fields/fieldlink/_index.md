---
title: "Aspose::Words::Fields::FieldLink classe"
linktitle: "FieldLink"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldLink classe. Implémente le champ LINK. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 63000
url: /fr/cpp/aspose.words.fields/fieldlink/
---
## FieldLink class


Implémente le champ LINK. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [get_AutoUpdate](./get_autoupdate/)() | Obtient si ce champ doit être mis à jour automatiquement. |
...
| [get_FormatUpdateType](./get_formatupdatetype/)() | Obtient la manière dont l'objet lié met à jour son formatage. |
...
| [set_AutoUpdate](./set_autoupdate/)(bool) | Définit si ce champ doit être mis à jour automatiquement. |
| [set_FormatUpdateType](./set_formatupdatetype/)(const System::String\&) | Définit la manière dont l'objet lié met à jour son formatage. |
