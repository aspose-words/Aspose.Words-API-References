---
title: "Aspose::Words::Fields::FieldAutoNumLgl classe"
linktitle: "FieldAutoNumLgl"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldAutoNumLgl classe. Implémente le champ AUTONUMLGL. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Implémente le champ AUTONUMLGL. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Obtient si le nombre doit être affiché sans point final. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Obtient le caractère séparateur à utiliser. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Définit si le nombre doit être affiché sans point final. |
| [set_Result](../field/set_result/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Définit le caractère séparateur à utiliser. |
| static [Type](./type/)() |  |
