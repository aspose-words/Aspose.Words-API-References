...
description: "Aspose::Words::Fields::FieldKeywords classe. Implémente le champ KEYWORDS. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 61000
url: /fr/cpp/aspose.words.fields/fieldkeywords/
---
## FieldKeywords class


Implémente le champ KEYWORDS. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_Text](./get_text/)() | Obtient ou définit le texte des mots‑clés. |
...
| [set_Text](./set_text/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldKeywords::get_Text](./get_text/). |
| static [Type](./type/)() |  |
