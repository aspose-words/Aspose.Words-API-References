...
description: "Aspose::Words::Fields::FieldBuilder classe. Construit un champ à partir des jetons du code de champ (arguments et commutateurs). Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 20000
url: /fr/cpp/aspose.words.fields/fieldbuilder/
---
## FieldBuilder class


Construit un champ à partir des jetons de code de champ (arguments et commutateurs). Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [AddArgument](./addargument/)(const System::String\&) | Ajoute un argument de champ. |
| [AddArgument](./addargument/)(int32_t) | Ajoute un argument de champ. |
| [AddArgument](./addargument/)(double) | Ajoute un argument de champ. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Ajoute un champ enfant représenté par un autre [FieldBuilder](./) au code du champ. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldArgumentBuilder\>\&) | Ajoute un argument de champ représenté par [FieldArgumentBuilder](../fieldargumentbuilder/) au code du champ. |
| [AddSwitch](./addswitch/)(const System::String\&) | Ajoute un commutateur de champ. |
| [AddSwitch](./addswitch/)(const System::String\&, const System::String\&) | Ajoute un commutateur de champ. |
| [AddSwitch](./addswitch/)(const System::String\&, int32_t) | Ajoute un commutateur de champ. |
| [AddSwitch](./addswitch/)(const System::String\&, double) | Ajoute un commutateur de champ. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Construit et insère un champ dans le document avant le nœud en ligne spécifié. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Paragraph\>\&) | Construit et insère un champ dans le document à la fin du paragraphe spécifié. |
| [FieldBuilder](./fieldbuilder/)(Aspose::Words::Fields::FieldType) | Initialise une instance de la classe [FieldBuilder](./). |
