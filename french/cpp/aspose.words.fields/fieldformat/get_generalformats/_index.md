---
title: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats méthode"
linktitle: "get_GeneralFormats"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats méthode. Obtient une collection de formats généraux qui sont appliqués à un résultat numérique, texte ou tout autre champ. Correspond aux commutateurs \\* en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.fields/fieldformat/get_generalformats/
---
## FieldFormat::get_GeneralFormats method


Obtient une collection de formats généraux appliqués à un résultat de champ numérique, texte ou quelconque. Correspond aux commutateurs \* switches.
