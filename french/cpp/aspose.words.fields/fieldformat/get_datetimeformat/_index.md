---
title: "Méthode get_DateTimeFormat de Aspose::Words::Fields::FieldFormat"
linktitle: "get_DateTimeFormat"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode get_DateTimeFormat de Aspose::Words::Fields::FieldFormat. Obtient ou définit un format appliqué au résultat d'un champ date et heure. Correspond au \\@ commutateur en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.fields/fieldformat/get_datetimeformat/
---
## FieldFormat::get_DateTimeFormat method


Obtient ou définit un format appliqué au résultat d'un champ de date et d'heure. Correspond au commutateur \@ switch.
