...
description: "Aspose::Words::Fields::FieldFormat classe. Fournit un accès typé aux formats numériques, de date et d'heure, ainsi qu'aux formats généraux du champ''. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 45000
url: /fr/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Fournit un accès typé aux formats numériques, de date et d'heure, ainsi qu'au formatage général du champ. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Obtient ou définit un format appliqué au résultat d'un champ de date et d'heure. Correspond au commutateur \@ switch. |
| [get_GeneralFormats](./get_generalformats/)() | Obtient une collection de formats généraux appliqués à un résultat de champ numérique, texte ou quelconque. Correspond aux commutateurs \* switches. |
| [get_NumericFormat](./get_numericformat/)() | Obtient ou définit un format appliqué au résultat d'un champ numérique. Correspond au commutateur \# switch. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
