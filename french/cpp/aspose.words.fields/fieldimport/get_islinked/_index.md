---
title: "Aspose::Words::Fields::FieldImport::get_IsLinked méthode"
linktitle: "get_IsLinked"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldImport::get_IsLinked méthode. Obtient ou définit si l’on doit réduire la taille du fichier en ne stockant pas les données graphiques avec le document dans C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.fields/fieldimport/get_islinked/
---
## FieldImport::get_IsLinked method


Obtient ou définit si la taille du fichier doit être réduite en ne stockant pas les données graphiques avec le document.
