...
description: "Aspose::Words::Fields::FieldComments classe. Implémente le champ COMMENTS. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 24000
url: /fr/cpp/aspose.words.fields/fieldcomments/
---
## FieldComments class


Implémente le champ COMMENTS. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_Text](./get_text/)() | Obtient ou définit le texte des commentaires. |
...
| [set_Text](./set_text/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldComments::get_Text](./get_text/). |
| static [Type](./type/)() |  |
