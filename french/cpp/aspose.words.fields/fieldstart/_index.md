---
title: "Aspose::Words::Fields::FieldStart classe"
linktitle: "FieldStart"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldStart classe. Représente le début d'un champ Word dans un document. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 95000
url: /fr/cpp/aspose.words.fields/fieldstart/
---
## FieldStart class


Représente le début d'un champ Word dans un document. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FieldData](./get_fielddata/)() const | Obtient les données de champ personnalisées associées au champ. |
...
| [get_NodeType](./get_nodetype/)() const override | Renvoie [FieldStart](../../aspose.words/nodetype/). |
