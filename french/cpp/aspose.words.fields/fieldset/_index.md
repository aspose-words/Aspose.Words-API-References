...
description: "Aspose::Words::Fields::FieldSet class. Implémente le champ SET. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 92000
url: /fr/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


Implémente le champ SET. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Obtient ou définit le nom du signet. |
| [get_BookmarkText](./get_bookmarktext/)() | Obtient ou définit le nouveau texte du signet. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/). |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/). |
