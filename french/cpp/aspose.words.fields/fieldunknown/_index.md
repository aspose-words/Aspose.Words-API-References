...
description: "Aspose::Words::Fields::FieldUnknown class. Implémente un champ inconnu ou non reconnu. Pour en savoir plus, consultez l'article de documentation  en C++."
type: docs
weight: 106000
url: /fr/cpp/aspose.words.fields/fieldunknown/
---
## FieldUnknown class


Implémente un champ inconnu ou non reconnu. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Insérez un champ qui ne désigne pas un type de champ objectif dans son code de champ.
System::SharedPtr<Aspose::Words::Fields::Field> field = builder->InsertField(u" NOTAREALFIELD //a");

// Le type de champ "FieldNone" est réservé aux champs comme ceux-ci.
ASSERT_EQ(Aspose::Words::Fields::FieldType::FieldNone, field->get_Type());

// Nous pouvons également travailler avec ces champs et les assigner comme instances de la classe FieldUnknown.
