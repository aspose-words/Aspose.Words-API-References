---
title: "Aspose::Words::Fields::FieldBarcode::get_FacingIdentificationMark méthode"
linktitle: "get_FacingIdentificationMark"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldBarcode::get_FacingIdentificationMark méthode. Obtient ou définit le type d'un Facing Identification Mark (FIM) à insérer en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.fields/fieldbarcode/get_facingidentificationmark/
---
## FieldBarcode::get_FacingIdentificationMark method


Obtient ou définit le type d'une marque d'identification d'orientation (FIM) à insérer.
