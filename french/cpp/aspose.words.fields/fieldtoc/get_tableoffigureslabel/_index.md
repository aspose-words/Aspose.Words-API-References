---
title: "Aspose::Words::Fields::FieldToc::get_TableOfFiguresLabel méthode"
linktitle: "get_TableOfFiguresLabel"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldToc::get_TableOfFiguresLabel méthode. Obtient ou définit le nom de l'identifiant de séquence utilisé lors de la création d'une table des figures dans C++."
type: docs
weight: 19000
url: /fr/cpp/aspose.words.fields/fieldtoc/get_tableoffigureslabel/
---
## FieldToc::get_TableOfFiguresLabel method


Obtient ou définit le nom de l'identifiant de séquence utilisé lors de la création d'une table des figures.
