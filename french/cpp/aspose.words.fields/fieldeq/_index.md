...
description: "Classe Aspose::Words::Fields::FieldEQ. Implémente le champ EQ. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 40000
url: /fr/cpp/aspose.words.fields/fieldeq/
---
## FieldEQ class


Implémente le champ EQ. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Méthode | Description |
| --- | --- |
| [AsOfficeMath](./asofficemath/)() | Renvoie l'objet Office [Math](../../aspose.words.math/) correspondant au champ EQ. |
