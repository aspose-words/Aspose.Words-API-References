---
title: "Classe Aspose::Words::Fields::FieldFormText"
linktitle: "FieldFormText"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Classe Aspose::Words::Fields::FieldFormText. Implémente le champ FORMTEXT. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 48000
url: /fr/cpp/aspose.words.fields/fieldformtext/
---
## FieldFormText class


Implémente le champ FORMTEXT. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
```cpp
// Ces champs sont les équivalents hérités du FormField. Nous pouvons les lire, mais pas les créer avec Aspose.Words.
// Dans Microsoft Word, nous pouvons insérer ces champs via le menu Outils hérités dans l'onglet Développeur.
