---
title: "classe Aspose::Words::Fields::FieldInfo"
linktitle: "FieldInfo"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "classe Aspose::Words::Fields::FieldInfo. Implémente le champ INFO. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 60000
url: /fr/cpp/aspose.words.fields/fieldinfo/
---
## FieldInfo class


Implémente le champ INFO. Pour en savoir plus, consultez l'article de documentation [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_InfoType](./get_infotype/)() | Obtient ou définit le type de la propriété du document à insérer. |
...
| [get_NewValue](./get_newvalue/)() | Obtient ou définit une valeur facultative qui met à jour la propriété. |
...
| [set_InfoType](./set_infotype/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldInfo::get_InfoType](./get_infotype/). |
...
| [set_NewValue](./set_newvalue/)(const System::String\&) | Définisseur pour [Aspose::Words::Fields::FieldInfo::get_NewValue](./get_newvalue/). |
