---
title: "Aspose::Words::Fields::FieldInclude::get_LockFields méthode"
linktitle: "get_LockFields"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fields::FieldInclude::get_LockFields méthode. Obtient ou définit si les champs dans le document inclus doivent être empêchés d'être mis à jour en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.fields/fieldinclude/get_lockfields/
---
## FieldInclude::get_LockFields method


Obtient ou définit si les champs du document inclus doivent être empêchés d'être mis à jour.
