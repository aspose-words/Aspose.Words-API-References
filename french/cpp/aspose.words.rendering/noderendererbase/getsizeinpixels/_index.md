...
description: "Aspose::Words::Rendering::NodeRendererBase::GetSizeInPixels method. Calcule la taille de la forme en pixels pour un facteur de zoom et une résolution spécifiés en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.rendering/noderendererbase/getsizeinpixels/
---
...
Cette méthode convertit [SizeInPoints](../get_sizeinpoints/) en taille en pixels et elle est utile lorsque vous souhaitez créer un bitmap pour rendre la forme proprement sur le bitmap.
