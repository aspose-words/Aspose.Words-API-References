...
description: "Aspose::Words::Rendering::NodeRendererBase::GetOpaqueBoundsInPixels method. Calcule les limites opaques de la forme en pixels pour un facteur de zoom et une résolution spécifiés en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.rendering/noderendererbase/getopaqueboundsinpixels/
---
...
Cette méthode convertit [OpaqueBoundsInPoints](../get_opaqueboundsinpoints/) en rectangle en pixels et elle est utile lorsque vous souhaitez créer un bitmap pour rendre la forme avec uniquement la partie opaque de la forme.
