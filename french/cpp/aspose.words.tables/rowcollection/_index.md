---
title: "Aspose::Words::Tables::RowCollection classe"
linktitle: "RowCollection"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Tables::RowCollection classe. Fournit un accès typé à une collection de nœuds Row. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.tables/rowcollection/
---
## RowCollection class


Fournit un accès typé à une collection de nœuds [Row](../row/). Pour en savoir plus, consultez l'article de documentation [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [idx_get](./idx_get/)(int32_t) | Récupère un [Row](../row/) à l'index donné. |
