...
description: "Aspose::Words::Bibliography::Bibliography classe. Représente la liste des sources bibliographiques disponibles dans le document en C++."
type: docs
weight: 125
url: /fr/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class


Représente la liste des sources bibliographiques disponibles dans le document.
...
| Méthode | Description |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Obtient une chaîne qui représente le nom du style actif à utiliser pour une bibliographie. |
| [get_Sources](./get_sources/)() const | Obtient une collection qui représente toutes les sources contenues dans une bibliographie. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Définit une chaîne qui représente le nom du style actif à utiliser pour une bibliographie. |
| static [Type](./type/)() |  |
