...
description: "Aspose::Words::Bibliography::SourceType enum. Représente les types de sources bibliographiques en C++."
type: docs
weight: 1000
url: /fr/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum
...
| ConferenceProceedings | 4 | Spécifie la source des actes de conférence. |
| Report | 5 | Spécifie la source du reporter. |
| SoundRecording | 6 | Spécifie la source de l'enregistrement sonore. |
| Performance | 7 | Spécifie la source de la performance. |
| Art | 8 | Spécifie la source de l'art. |
| DocumentFromInternetSite | 9 | Spécifie la source du document provenant du site Internet. |
| InternetSite | 10 | Spécifie la source du site Internet. |
| Film | 11 | Spécifie la source du film. |
| Interview | 12 | Spécifie la source de l'entretien. |
| Patent | 13 | Spécifie la source du brevet. |
| Electronic | 14 | Spécifie la source électronique. |
| Case | 15 | Spécifie la source du cas. |
| Divers | 16 | Spécifie la source divers. |
