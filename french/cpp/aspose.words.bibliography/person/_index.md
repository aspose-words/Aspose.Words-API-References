---
title: "Aspose::Words::Bibliography::Person classe"
linktitle: "Person"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Bibliography::Person classe. Représente un contributeur individuel (une personne) de sources bibliographiques en C++."
type: docs
weight: 625
url: /fr/cpp/aspose.words.bibliography/person/
---
## Person class


Représente un contributeur individuel (une personne) à la source bibliographique.
...
| [get_First](./get_first/)() const | Obtient ou définit le prénom d'une personne. |
| [get_Last](./get_last/)() const | Obtient ou définit le nom de famille d'une personne. |
| [get_Middle](./get_middle/)() const | Obtient ou définit le deuxième prénom d'une personne. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Initialise une nouvelle instance de la classe [Person](./). |
| [set_First](./set_first/)(const System::String\&) | Mutateur pour [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | Mutateur pour [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | Mutateur pour [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
