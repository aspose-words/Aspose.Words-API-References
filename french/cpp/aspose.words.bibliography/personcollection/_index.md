...
description: "Aspose::Words::Bibliography::PersonCollection classe. Représente une liste de personnes qui sont des contributeurs de sources bibliographiques en C++."
type: docs
weight: 750
url: /fr/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Représente une liste de personnes qui sont des contributeurs à la source bibliographique.
...
| Méthode | Description |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Ajoute un [Person](../person/) à la collection. |
| [Clear](./clear/)() | Supprime tous les éléments de la collection. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Détermine si la collection contient une personne spécifique. |
| [get_Count](./get_count/)() | Obtient le nombre de personnes contenues dans la collection. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtient ou définit une personne à l'index spécifié. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Obtient ou définit une personne à l'index spécifié. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Initialise une nouvelle instance de la classe [PersonCollection](./). |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Initialise une nouvelle instance de la classe [PersonCollection](./). |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Supprime la personne de la collection. |
| [RemoveAt](./removeat/)(int32_t) | Supprime la personne à l'index spécifié. |
