...
description: "Classe Aspose::Words::Saving::PsSaveOptions. Peut être utilisée pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format Ps. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 26000
url: /fr/cpp/aspose.words.saving/pssaveoptions/
---
## PsSaveOptions class


Peut être utilisée pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format [Ps](../../aspose.words/saveformat/). Pour en savoir plus, consultez l'article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. Ne peut être que [Ps](../../aspose.words/saveformat/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Définisseur pour [Aspose::Words::Saving::PsSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | Définisseur pour [Aspose::Words::Saving::PsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/). |
