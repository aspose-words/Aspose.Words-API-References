---
title: "Aspose::Words::Saving::HtmlFixedSaveOptions::get_ResourcesFolder méthode"
linktitle: "get_ResourcesFolder"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Saving::HtmlFixedSaveOptions::get_ResourcesFolder méthode. Spécifie le dossier physique où les ressources (images, polices, css) sont enregistrées lors de l'exportation d'un document au format Html. La valeur par défaut est null en C++."
type: docs
weight: 15000
url: /fr/cpp/aspose.words.saving/htmlfixedsaveoptions/get_resourcesfolder/
---
## HtmlFixedSaveOptions::get_ResourcesFolder method


Spécifie le dossier physique où les ressources (images, polices, css) sont enregistrées lors de l'exportation d'un document au format Html. La valeur par défaut est **null**.
