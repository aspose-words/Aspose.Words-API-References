---
title: "Aspose::Words::Saving::HtmlFixedSaveOptions::get_PageHorizontalAlignment méthode"
linktitle: "get_PageHorizontalAlignment"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Saving::HtmlFixedSaveOptions::get_PageHorizontalAlignment méthode. Spécifie l'alignement horizontal des pages dans un document HTML. La valeur par défaut est Center en C++."
type: docs
weight: 12000
url: /fr/cpp/aspose.words.saving/htmlfixedsaveoptions/get_pagehorizontalalignment/
---
## HtmlFixedSaveOptions::get_PageHorizontalAlignment method


Spécifie l'alignement horizontal des pages dans un document HTML. La valeur par défaut est [Center](../../htmlfixedpagehorizontalalignment/).
