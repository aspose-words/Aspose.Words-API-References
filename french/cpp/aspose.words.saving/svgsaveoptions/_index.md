---
title: "Aspose::Words::Saving::SvgSaveOptions classe"
linktitle: "SvgSaveOptions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Saving::SvgSaveOptions classe. Peut être utilisé pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format Svg. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 31000
url: /fr/cpp/aspose.words.saving/svgsaveoptions/
---
## SvgSaveOptions class


Peut être utilisé pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format [Svg](../../aspose.words/saveformat/). Pour en savoir plus, consultez l'article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportEmbeddedImages](./get_exportembeddedimages/)() const | Spécifie si les images doivent être intégrées dans le document SVG en base64. Notez que l'activation de cette option peut entraîner une augmentation significative de la taille du fichier SVG de sortie. |
...
| [get_FitToViewPort](./get_fittoviewport/)() const | Spécifie si le SVG de sortie doit remplir la zone de visualisation disponible (fenêtre du navigateur ou conteneur). Lorsqu'il est défini sur **true**, la largeur et la hauteur du SVG de sortie sont réglées à 100 %. La valeur par défaut est **false**. |
...
| [get_MaxImageResolution](./get_maximageresolution/)() const | Obtient ou définit une valeur en pixels par pouce qui limite la résolution des images raster exportées. La valeur par défaut est zéro. |
...
| [get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/)() const | Spécifie si le JavaScript sera supprimé des liens. La valeur par défaut est **false**. Si cette option est activée, tous les liens contenant du JavaScript seront remplacés par "javascript:void(0)". |
| [get_ResourceSavingCallback](./get_resourcesavingcallback/)() const | Permet de contrôler la façon dont les ressources (images) sont enregistrées lorsqu'un document est exporté au format SVG. |
| [get_ResourcesFolder](./get_resourcesfolder/)() const | Spécifie le dossier physique où les ressources (images) sont enregistrées lors de l'exportation d'un document au format SVG. La valeur par défaut est **null**. |
| [get_ResourcesFolderAlias](./get_resourcesfolderalias/)() const | Spécifie le nom du dossier utilisé pour construire les URI d'images écrites dans un document SVG. La valeur par défaut est **null**. |
| [get_SaveFormat](./get_saveformat/)() override | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. Ne peut être que [Svg](../../aspose.words/saveformat/). |
| [get_ShowPageBorder](./get_showpageborder/)() const | Contrôle si une bordure est ajoutée au contour de la page. La valeur par défaut est **true**. |
...
| [get_TextOutputMode](./get_textoutputmode/)() const | Obtient ou définit une valeur déterminant comment le texte doit être rendu dans le SVG. |
...
| [set_ExportEmbeddedImages](./set_exportembeddedimages/)(bool) | Spécifie si les images doivent être intégrées dans le document SVG en base64. Notez que l'activation de cette option peut entraîner une augmentation significative de la taille du fichier SVG de sortie. |
...
| [set_FitToViewPort](./set_fittoviewport/)(bool) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_FitToViewPort](./get_fittoviewport/). |
| [set_IdPrefix](./set_idprefix/)(const System::String\&) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_IdPrefix](./get_idprefix/). |
...
| [set_MaxImageResolution](./set_maximageresolution/)(int32_t) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_MaxImageResolution](./get_maximageresolution/). |
...
| [set_RemoveJavaScriptFromLinks](./set_removejavascriptfromlinks/)(bool) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_RemoveJavaScriptFromLinks](./get_removejavascriptfromlinks/). |
| [set_ResourceSavingCallback](./set_resourcesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IResourceSavingCallback\>\&) | Permet de contrôler la façon dont les ressources (images) sont enregistrées lorsqu'un document est exporté au format SVG. |
| [set_ResourcesFolder](./set_resourcesfolder/)(const System::String\&) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolder](./get_resourcesfolder/). |
| [set_ResourcesFolderAlias](./set_resourcesfolderalias/)(const System::String\&) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_ResourcesFolderAlias](./get_resourcesfolderalias/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. Ne peut être que [Svg](../../aspose.words/saveformat/). |
| [set_ShowPageBorder](./set_showpageborder/)(bool) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_ShowPageBorder](./get_showpageborder/). |
...
| [set_TextOutputMode](./set_textoutputmode/)(Aspose::Words::Saving::SvgTextOutputMode) | Définisseur pour [Aspose::Words::Saving::SvgSaveOptions::get_TextOutputMode](./get_textoutputmode/). |
