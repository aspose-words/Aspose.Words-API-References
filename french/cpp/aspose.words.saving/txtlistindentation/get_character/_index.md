---
title: "Méthode Aspose::Words::Saving::TxtListIndentation::get_Character"
linktitle: "get_Character"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Saving::TxtListIndentation::get_Character. Obtient ou définit le caractère à utiliser pour indenter les niveaux de liste. La valeur par défaut est ''\\\\0'', ce qui signifie qu'il n'y a aucune indentation en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.saving/txtlistindentation/get_character/
---
## TxtListIndentation::get_Character method


Obtient ou définit le caractère à utiliser pour l'indentation des niveaux de liste. La valeur par défaut est '\0', ce qui signifie qu'il n'y a aucune indentation.
