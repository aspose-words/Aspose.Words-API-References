...
description: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels méthode. Contrôle la façon dont les étiquettes de listes sont exportées vers HTML, MHTML ou EPUB. La valeur par défaut est Auto en C++."
type: docs
weight: 21000
url: /fr/cpp/aspose.words.saving/htmlsaveoptions/get_exportlistlabels/
---
## HtmlSaveOptions::get_ExportListLabels method


Contrôle la façon dont les étiquettes de listes sont exportées vers HTML, MHTML ou EPUB. La valeur par défaut est [Auto](../../exportlistlabels/).
