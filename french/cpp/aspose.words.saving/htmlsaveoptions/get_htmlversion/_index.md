---
title: "Aspose::Words::Saving::HtmlSaveOptions::get_HtmlVersion méthode"
linktitle: "get_HtmlVersion"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Saving::HtmlSaveOptions::get_HtmlVersion méthode. Spécifie la version de la norme HTML qui doit être utilisée lors de l'enregistrement du document au format HTML ou MHTML. La valeur par défaut est Xhtml en C++."
type: docs
weight: 35000
url: /fr/cpp/aspose.words.saving/htmlsaveoptions/get_htmlversion/
---
## HtmlSaveOptions::get_HtmlVersion method


Spécifie la version de la norme HTML qui doit être utilisée lors de l'enregistrement du document au format HTML ou MHTML. La valeur par défaut est [Xhtml](../../htmlversion/).
