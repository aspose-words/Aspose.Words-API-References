...
description: "Classe Aspose::Words::Saving::OoxmlSaveOptions. Peut être utilisée pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format Docx, Docm, Dotx, Dotm ou FlatOpc. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 16000
url: /fr/cpp/aspose.words.saving/ooxmlsaveoptions/
---
## OoxmlSaveOptions class


Peut être utilisée pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) ou [FlatOpc](../../aspose.words/saveformat/). Pour en savoir plus, consultez l'article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_Compliance](./get_compliance/)() | Spécifie la version OOXML du document de sortie. La valeur par défaut est [Ecma376_2006](../ooxmlcompliance/). |
...
| [get_KeepLegacyControlChars](./get_keeplegacycontrolchars/)() const | Conserve la représentation originale des caractères de contrôle hérités. |
...
| [get_Password](./get_password/)() const | Obtient/définit un mot de passe pour chiffrer le document en utilisant l'algorithme de chiffrement ECMA376 Standard. |
...
| [get_SaveFormat](./get_saveformat/)() override | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. Peut être [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) ou [FlatOpc](../../aspose.words/saveformat/). |
...
| [get_Zip64Mode](./get_zip64mode/)() const | Spécifie s'il faut ou non utiliser les extensions de format ZIP64 pour le document de sortie. La valeur par défaut est [Never](../zip64mode/). |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)() | Initialise une nouvelle instance de cette classe qui peut être utilisée pour enregistrer un document au format [Docx](../../aspose.words/saveformat/). |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)(Aspose::Words::SaveFormat) | Initialise une nouvelle instance de cette classe qui peut être utilisée pour enregistrer un document aux formats [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) ou [FlatOpc](../../aspose.words/saveformat/). |
...
| [set_Compliance](./set_compliance/)(Aspose::Words::Saving::OoxmlCompliance) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_Compliance](./get_compliance/). |
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_KeepLegacyControlChars](./set_keeplegacycontrolchars/)(bool) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_KeepLegacyControlChars](./get_keeplegacycontrolchars/). |
...
| [set_Password](./set_password/)(const System::String\&) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_Zip64Mode](./set_zip64mode/)(Aspose::Words::Saving::Zip64Mode) | Définisseur pour [Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode](./get_zip64mode/). |
| static [Type](./type/)() |  |
