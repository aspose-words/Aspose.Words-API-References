...
description: "Aspose::Words::Saving::XlsxSaveOptions class. Peut être utilisé pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format Xlsx. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 37500
url: /fr/cpp/aspose.words.saving/xlsxsaveoptions/
---
## XlsxSaveOptions class


Peut être utilisé pour spécifier des options supplémentaires lors de l'enregistrement d'un document au format [Xlsx](../../aspose.words/saveformat/). Pour en savoir plus, consultez l'article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_DateTimeParsingMode](./get_datetimeparsingmode/)() const | Obtient ou définit le mode qui spécifie comment le texte du document est analysé pour identifier les valeurs de date et d'heure. La valeur par défaut est [UseCurrentLocale](../xlsxdatetimeparsingmode/). |
...
| [get_SaveFormat](./get_saveformat/)() override | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. Ne peut être que [Xlsx](../../aspose.words/saveformat/). |
| [get_SectionMode](./get_sectionmode/)() const | Obtient ou définit la manière dont les sections sont traitées lors de l'enregistrement du document XLSX de sortie. La valeur par défaut est [MultipleWorksheets](../xlsxsectionmode/). |
...
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Mutateur pour [Aspose::Words::Saving::XlsxSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DateTimeParsingMode](./set_datetimeparsingmode/)(Aspose::Words::Saving::XlsxDateTimeParsingMode) | Définisseur pour [Aspose::Words::Saving::XlsxSaveOptions::get_DateTimeParsingMode](./get_datetimeparsingmode/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Définisseur pour [Aspose::Words::Saving::XlsxSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SectionMode](./set_sectionmode/)(Aspose::Words::Saving::XlsxSectionMode) | Définisseur pour [Aspose::Words::Saving::XlsxSaveOptions::get_SectionMode](./get_sectionmode/). |
