...
description: "Méthode Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains. Détermine si la collection contient un signet avec le nom donné en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/contains/
---
...
| --- | --- | --- |
| name | const System::String\& | Nom du signet à localiser, insensible à la casse. |
