---
title: "Aspose::Words::Saving::FixedPageSaveOptions classe"
linktitle: "FixedPageSaveOptions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Classe Aspose::Words::Saving::FixedPageSaveOptions. Contient des options communes qui peuvent être spécifiées lors de l'enregistrement d'un document dans des formats de page fixe (PDF, XPS, images, etc.). Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.saving/fixedpagesaveoptions/
---
## FixedPageSaveOptions class


Contient des options communes qui peuvent être spécifiées lors de l'enregistrement d'un document dans des formats de pages fixes (PDF, XPS, images, etc.). Pour en savoir plus, consultez l'article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ColorMode](./get_colormode/)() const | Obtient une valeur déterminant la façon dont les couleurs sont rendues. |
...
| [get_JpegQuality](./get_jpegquality/)() const | Obtient ou définit une valeur déterminant la qualité des images JPEG dans le document Html. |
...
| [get_MetafileRenderingOptions](./get_metafilerenderingoptions/)() const | Permet de spécifier les options de rendu des métafichiers. |
| [get_NumeralFormat](./get_numeralformat/)() const | Obtient le [NumeralFormat](../numeralformat/) utilisé pour le rendu des chiffres. Les chiffres européens sont utilisés par défaut. |
| virtual [get_OptimizeOutput](./get_optimizeoutput/)() | Le drapeau indique s'il est nécessaire d'optimiser la sortie. Si ce drapeau est activé, les canevas imbriqués redondants et les canevas vides sont supprimés, de même que les glyphes voisins ayant le même formatage sont concaténés. Remarque : la précision de l'affichage du contenu peut être affectée si cette propriété est définie sur **true**. La valeur par défaut est **false**. |
| [get_PageSavingCallback](./get_pagesavingcallback/)() const | Permet de contrôler la façon dont les pages séparées sont enregistrées lorsqu'un document est exporté au format page fixe. |
| [get_PageSet](./get_pageset/)() const | Obtient ou définit les pages à rendre. La valeur par défaut est toutes les pages du document. |
...
| virtual [get_SaveFormat](../saveoptions/get_saveformat/)() | Spécifie le format dans lequel le document sera enregistré si cet objet d'options d'enregistrement est utilisé. |
...
| [set_ColorMode](./set_colormode/)(Aspose::Words::Saving::ColorMode) | Définit une valeur déterminant comment les couleurs sont rendues. |
...
| [set_JpegQuality](./set_jpegquality/)(int32_t) | Mutateur pour [Aspose::Words::Saving::FixedPageSaveOptions::get_JpegQuality](./get_jpegquality/). |
...
| [set_MetafileRenderingOptions](./set_metafilerenderingoptions/)(const System::SharedPtr\<Aspose::Words::Saving::MetafileRenderingOptions\>\&) | Permet de spécifier les options de rendu des métafichiers. |
| [set_NumeralFormat](./set_numeralformat/)(Aspose::Words::Saving::NumeralFormat) | Définit [NumeralFormat](../numeralformat/) utilisé pour le rendu des chiffres. Les chiffres européens sont utilisés par défaut. |
| virtual [set_OptimizeOutput](./set_optimizeoutput/)(bool) | Mutateur pour [Aspose::Words::Saving::FixedPageSaveOptions::get_OptimizeOutput](./get_optimizeoutput/). |
| [set_PageSavingCallback](./set_pagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IPageSavingCallback\>\&) | Permet de contrôler la façon dont les pages séparées sont enregistrées lorsqu'un document est exporté au format page fixe. |
| [set_PageSet](./set_pageset/)(const System::SharedPtr\<Aspose::Words::Saving::PageSet\>\&) | Mutateur pour [Aspose::Words::Saving::FixedPageSaveOptions::get_PageSet](./get_pageset/). |
...
| virtual [set_SaveFormat](../saveoptions/set_saveformat/)(Aspose::Words::SaveFormat) | Définisseur pour [Aspose::Words::Saving::SaveOptions::get_SaveFormat](../saveoptions/get_saveformat/). |
