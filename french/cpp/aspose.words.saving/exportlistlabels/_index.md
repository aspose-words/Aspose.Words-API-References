...
description: "Aspose::Words::Saving::ExportListLabels enum. Spécifie comment les libellés de liste sont exportés vers HTML, MHTML et EPUB en C++."
type: docs
weight: 56000
url: /fr/cpp/aspose.words.saving/exportlistlabels/
---
## ExportListLabels enum


Spécifie comment les libellés de liste sont exportés vers HTML, MHTML et EPUB.
...
| --- | --- | --- |
| Auto | 0 | Produit les libellés de liste en mode automatique. Utilise les éléments natifs HTML lorsque c'est possible. |
| AsInlineText | 1 | Produit tous les libellés de liste en texte en ligne. |
| ByHtmlTags | 2 | Produit tous les libellés de liste en tant qu'éléments natifs HTML. |
...
// Définir la propriété "ExportListLabels" sur "ExportListLabels.AsInlineText"
// créera des listes en formatant des spans.
// Définir la propriété "ExportListLabels" sur "ExportListLabels.Auto" utilisera la balise <p>
// pour créer des listes dans les cas où l'utilisation des balises <ol> et <li> peut entraîner une perte de mise en forme.
// Définir la propriété "ExportListLabels" sur "ExportListLabels.ByHtmlTags"
