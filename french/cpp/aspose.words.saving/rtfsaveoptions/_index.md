---
title: "Aspose::Words::Saving::RtfSaveOptions classe"
linktitle: "RtfSaveOptions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Saving::RtfSaveOptions classe. Peut être utilisé pour spécifier des options supplémentaires lors de l’enregistrement d’un document au format Rtf. Pour en savoir plus, consultez l’article de documentation en C++."
type: docs
weight: 28000
url: /fr/cpp/aspose.words.saving/rtfsaveoptions/
---
## RtfSaveOptions class


Peut être utilisé pour spécifier des options supplémentaires lors de l’enregistrement d’un document au format [Rtf](../../aspose.words/saveformat/). Pour en savoir plus, consultez l’article de documentation [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportCompactSize](./get_exportcompactsize/)() const | Permet de réduire la taille des documents RTF en sortie, mais s’ils contiennent du texte RTL (de droite à gauche), il ne sera pas affiché correctement. La valeur par défaut est **false**. |
...
| [get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/)() const | Spécifie si les mots‑clés pour "old readers" sont écrits dans le RTF ou non. Cela peut affecter significativement la taille du document RTF. La valeur par défaut est **true**. |
...
| [get_SaveFormat](./get_saveformat/)() override | Spécifie le format dans lequel le document sera enregistré si cet objet d’options d’enregistrement est utilisé. Ne peut être que [Rtf](../../aspose.words/saveformat/). |
| [get_SaveImagesAsWmf](./get_saveimagesaswmf/)() const | Lorsque **true** toutes les images seront enregistrées au format WMF. |
...
| [set_ExportCompactSize](./set_exportcompactsize/)(bool) | Définisseur de [Aspose::Words::Saving::RtfSaveOptions::get_ExportCompactSize](./get_exportcompactsize/). |
...
| [set_ExportImagesForOldReaders](./set_exportimagesforoldreaders/)(bool) | Définisseur pour [Aspose::Words::Saving::RtfSaveOptions::get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Définisseur pour [Aspose::Words::Saving::RtfSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SaveImagesAsWmf](./set_saveimagesaswmf/)(bool) | Définisseur pour [Aspose::Words::Saving::RtfSaveOptions::get_SaveImagesAsWmf](./get_saveimagesaswmf/). |
