---
title: "Aspose::Words::Loading::MarkdownLoadOptions::get_ImportUnderlineFormatting méthode"
linktitle: "get_ImportUnderlineFormatting"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Loading::MarkdownLoadOptions::get_ImportUnderlineFormatting méthode. Obtient ou définit une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus \"++\" comme formatage de texte souligné. La valeur par défaut est false en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.loading/markdownloadoptions/get_importunderlineformatting/
---
## MarkdownLoadOptions::get_ImportUnderlineFormatting method


Obtient ou définit une valeur booléenne indiquant s'il faut reconnaître une séquence de deux caractères plus "++" comme formatage de texte souligné. La valeur par défaut est **false**.
