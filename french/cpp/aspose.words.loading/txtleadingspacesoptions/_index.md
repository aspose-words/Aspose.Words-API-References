...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. Spécifie les options disponibles pour la gestion des espaces de début lors de l'importation depuis un fichier texte en C++."
type: docs
weight: 18000
url: /fr/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Spécifie les options disponibles pour la gestion des espaces de début lors de l'importation depuis le fichier [Text](../../aspose.words/loadformat/).
...
| --- | --- | --- |
| ConvertToIndent | 0 | Les espaces de début sont supprimés et convertis en retrait gauche. |
| Rogner | 1 | Les espaces de début sont tronqués. |
| Conserver | 2 | Les espaces de début sont conservés. |
