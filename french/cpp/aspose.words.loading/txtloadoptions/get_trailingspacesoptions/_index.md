---
title: "Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions méthode"
linktitle: "get_TrailingSpacesOptions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions méthode. Obtient ou définit l'option préférée de gestion des espaces de fin. La valeur par défaut est Trim en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.loading/txtloadoptions/get_trailingspacesoptions/
---
## TxtLoadOptions::get_TrailingSpacesOptions method


Obtient ou définit l'option préférée de gestion des espaces de fin. La valeur par défaut est [Trim](../../txttrailingspacesoptions/).
