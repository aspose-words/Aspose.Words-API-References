---
title: "Aspose::Words::Notes::FootnoteOptions::get_StartNumber méthode"
linktitle: "get_StartNumber"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Notes::FootnoteOptions::get_StartNumber méthode. Spécifie le numéro ou le caractère de départ pour les premières notes de bas de page numérotées automatiquement en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.notes/footnoteoptions/get_startnumber/
---
## FootnoteOptions::get_StartNumber method


Spécifie le numéro ou le caractère de départ pour la première note de bas de page numérotée automatiquement.
