---
title: "Classe Aspose::Words::Notes::EndnoteOptions"
linktitle: "EndnoteOptions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Classe Aspose::Words::Notes::EndnoteOptions. Représente les options de numérotation des notes de fin pour un document ou une section. Pour en savoir plus, consultez l’article de documentation en C++."
type: docs
weight: 1000
url: /fr/cpp/aspose.words.notes/endnoteoptions/
---
## EndnoteOptions class


Représente les options de numérotation des notes de fin pour un document ou une section. Pour en savoir plus, consultez l'article de documentation [Working with Footnote and Endnote](https://docs.aspose.com/words/cpp/working-with-footnote-and-endnote/).
...
| Méthode | Description |
| --- | --- |
| [get_NumberStyle](./get_numberstyle/)() override | Spécifie le format de nombre pour les notes de fin auto‑numérotées. |
| [get_Position](./get_position/)() | Spécifie la position des notes de fin. |
| [get_RestartRule](./get_restartrule/)() override | Détermine quand le numéro automatique redémarre. |
| [get_StartNumber](./get_startnumber/)() override | Spécifie le numéro ou le caractère de départ pour les premières notes de fin automatiquement numérotées. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_NumberStyle](./set_numberstyle/)(Aspose::Words::NumberStyle) override | Définisseur pour [Aspose::Words::Notes::EndnoteOptions::get_NumberStyle](./get_numberstyle/). |
| [set_Position](./set_position/)(Aspose::Words::Notes::EndnotePosition) | Définisseur pour [Aspose::Words::Notes::EndnoteOptions::get_Position](./get_position/). |
| [set_RestartRule](./set_restartrule/)(Aspose::Words::Notes::FootnoteNumberingRule) override | Définisseur pour [Aspose::Words::Notes::EndnoteOptions::get_RestartRule](./get_restartrule/). |
| [set_StartNumber](./set_startnumber/)(int32_t) override | Définisseur pour [Aspose::Words::Notes::EndnoteOptions::get_StartNumber](./get_startnumber/). |
| static [Type](./type/)() |  |
