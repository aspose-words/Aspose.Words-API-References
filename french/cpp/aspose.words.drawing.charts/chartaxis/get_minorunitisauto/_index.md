---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto méthode"
linktitle: "get_MinorUnitIsAuto"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto méthode. Obtient ou définit un indicateur indiquant si la distance par défaut entre les petites marques de graduation doit être utilisée en C++."
type: docs
weight: 18000
url: /fr/cpp/aspose.words.drawing.charts/chartaxis/get_minorunitisauto/
---
## ChartAxis::get_MinorUnitIsAuto method


Obtient ou définit un indicateur indiquant si la distance par défaut entre les marques de graduation mineures doit être utilisée.
