---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto méthode"
linktitle: "get_MajorUnitIsAuto"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto méthode. Obtient ou définit un indicateur indiquant si la distance par défaut entre les marques principales doit être utilisée en C++."
type: docs
weight: 14000
url: /fr/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitisauto/
---
## ChartAxis::get_MajorUnitIsAuto method


Obtient ou définit un indicateur indiquant si la distance par défaut entre les marques de graduation majeures doit être utilisée.
