---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder méthode"
linktitle: "get_ReverseOrder"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder méthode. Retourne ou définit un indicateur indiquant si les valeurs de l'axe doivent être affichées dans l'ordre inverse, c.-à-d. du maximum au minimum en C++."
type: docs
weight: 21000
url: /fr/cpp/aspose.words.drawing.charts/chartaxis/get_reverseorder/
---
## ChartAxis::get_ReverseOrder method


Obtient ou définit un indicateur indiquant si les valeurs de l'axe doivent être affichées dans l'ordre inverse, c.-à-d. du maximum au minimum.
