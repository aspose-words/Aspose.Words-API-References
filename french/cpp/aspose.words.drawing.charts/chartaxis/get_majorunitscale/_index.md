---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitScale méthode"
linktitle: "get_MajorUnitScale"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitScale méthode. Retourne ou définit la valeur d'échelle pour les graduations majeures sur l'axe de catégorie temporelle en C++."
type: docs
weight: 15000
url: /fr/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitscale/
---
## ChartAxis::get_MajorUnitScale method


Obtient ou définit la valeur d'échelle pour les marques de graduation majeures sur l'axe des catégories temporelles.
