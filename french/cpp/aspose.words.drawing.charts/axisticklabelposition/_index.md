---
title: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition énumération"
linktitle: "AxisTickLabelPosition"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition énumération. Spécifie les positions possibles pour les étiquettes de repère en C++."
type: docs
weight: 24000
url: /fr/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
...
| --- | --- | --- |
| Haut | 0 | Spécifie que les étiquettes d'axe doivent être à l'extrémité haute de l'axe perpendiculaire. |
| Bas | 1 | Spécifie que les étiquettes d'axe doivent être à l'extrémité basse de l'axe perpendiculaire. |
| NextToAxis | 2 | Spécifie que les étiquettes d'axe doivent être à côté de l'axe. |
| None | 3 | Spécifie que les étiquettes d'axe ne sont pas dessinées. |
| Default | n/a | Spécifie la valeur par défaut de la position des étiquettes de repère. |
