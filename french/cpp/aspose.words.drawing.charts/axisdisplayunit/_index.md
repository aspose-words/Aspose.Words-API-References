---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit classe"
linktitle: "AxisDisplayUnit"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit classe. Fournit un accès aux options de mise à l'échelle des unités d'affichage pour l'axe des valeurs. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Fournit l’accès aux options de mise à l’échelle des unités d’affichage pour l’axe des valeurs. Pour en savoir plus, consultez l’article de documentation [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | Obtient ou définit un diviseur défini par l'utilisateur pour mettre à l'échelle les unités d'affichage sur l'axe des valeurs. |
| [get_Document](./get_document/)() | Renvoie le document contenant le graphique parent. |
| [get_Unit](./get_unit/)() const | Obtient ou définit la valeur de mise à l'échelle des unités d'affichage parmi les valeurs prédéfinies. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | Définisseur pour [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | Définisseur pour [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
