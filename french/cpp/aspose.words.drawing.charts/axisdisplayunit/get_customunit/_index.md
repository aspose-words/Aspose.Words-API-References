---
title: "Méthode Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit"
linktitle: "get_CustomUnit"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit. Obtient ou définit un diviseur personnalisé pour mettre à l'échelle les unités d'affichage sur l'axe des valeurs en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


Obtient ou définit un diviseur défini par l'utilisateur pour mettre à l'échelle les unités d'affichage sur l'axe des valeurs.
...
La définition de cette propriété définit la propriété [Unit](../get_unit/) sur [Custom](../../axisbuiltinunit/).
