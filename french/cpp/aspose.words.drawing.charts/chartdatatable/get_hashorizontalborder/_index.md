---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder méthode"
linktitle: "get_HasHorizontalBorder"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder. Obtient ou définit un indicateur indiquant si une bordure horizontale du tableau de données est affichée. La valeur par défaut est true en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.drawing.charts/chartdatatable/get_hashorizontalborder/
---
## ChartDataTable::get_HasHorizontalBorder method


Obtient ou définit un indicateur indiquant si une bordure horizontale du tableau de données est affichée. La valeur par défaut est **true**.
