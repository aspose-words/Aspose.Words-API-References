---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys méthode"
linktitle: "get_HasLegendKeys"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys méthode. Obtient ou définit un indicateur indiquant si les clés de légende sont affichées dans le tableau de données. La valeur par défaut est true en C++."
type: docs
weight: 5000
url: /fr/cpp/aspose.words.drawing.charts/chartdatatable/get_haslegendkeys/
---
## ChartDataTable::get_HasLegendKeys method


Obtient ou définit un indicateur indiquant si les clés de légende sont affichées dans le tableau de données. La valeur par défaut est **true**.
