---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show méthode"
linktitle: "get_Show"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show méthode. Obtient ou définit un indicateur indiquant si le tableau de données sera affiché pour le graphique. La valeur par défaut est false en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.drawing.charts/chartdatatable/get_show/
---
## ChartDataTable::get_Show method


Obtient ou définit un indicateur indiquant si le tableau de données sera affiché pour le graphique. La valeur par défaut est **false**.
