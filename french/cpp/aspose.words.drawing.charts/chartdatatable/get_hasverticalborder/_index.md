---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder méthode"
linktitle: "get_HasVerticalBorder"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder méthode. Obtient ou définit un indicateur indiquant si une bordure verticale du tableau de données est affichée. La valeur par défaut est true en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.drawing.charts/chartdatatable/get_hasverticalborder/
---
## ChartDataTable::get_HasVerticalBorder method


Obtient ou définit un indicateur indiquant si une bordure verticale du tableau de données est affichée. La valeur par défaut est **true**.
