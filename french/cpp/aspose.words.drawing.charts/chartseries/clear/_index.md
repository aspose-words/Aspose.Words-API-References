...
description: "Aspose::Words::Drawing::Charts::ChartSeries::Clear method. Supprime toutes les valeurs de données de la série de graphique. Le format de tous les points de données individuels et des étiquettes de données est réinitialisé en C++."
type: docs
weight: 1500
url: /fr/cpp/aspose.words.drawing.charts/chartseries/clear/
---
## ChartSeries::Clear method


Supprime toutes les valeurs de données de la série du graphique. Le format de tous les points de données individuels et des étiquettes de données est réinitialisé.
