...
description: "Aspose::Words::Drawing::Charts::ChartSeries::Add method. Ajoute la valeur X spécifiée à la série de graphique. Si la série prend en charge les valeurs Y et les tailles de bulles, elles seront vides pour la valeur X en C++."
type: docs
weight: 1250
url: /fr/cpp/aspose.words.drawing.charts/chartseries/add/
---
## ChartSeries::Add(const System::SharedPtr\<Aspose::Words::Drawing::Charts::ChartXValue\>\&) method


Ajoute la valeur X spécifiée à la série du graphique. Si la série prend en charge les valeurs Y et les tailles de bulles, elles seront vides pour la valeur X.
...
Ajoute la valeur X spécifiée, la valeur Y et la taille de la bulle à la série du graphique.
