...
description: "Aspose::Words::Drawing::Charts::ChartSeries::ClearValues method. Supprime toutes les valeurs de données de la série de graphique tout en préservant le format des points de données et des étiquettes de données en C++."
type: docs
weight: 1750
url: /fr/cpp/aspose.words.drawing.charts/chartseries/clearvalues/
---
## ChartSeries::ClearValues method


Supprime toutes les valeurs de données de la série du graphique tout en préservant le format des points de données et des étiquettes de données.
