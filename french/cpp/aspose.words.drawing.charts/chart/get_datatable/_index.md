---
title: "Méthode Aspose::Words::Drawing::Charts::Chart::get_DataTable"
linktitle: "get_DataTable"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::Chart::get_DataTable. Fournit l'accès aux propriétés d'un tableau de données de ce graphique. Le tableau de données peut être affiché en utilisant la propriété Show en C++."
type: docs
weight: 4500
url: /fr/cpp/aspose.words.drawing.charts/chart/get_datatable/
---
## Chart::get_DataTable method


Fournit l'accès aux propriétés d'un tableau de données de ce graphique. Le tableau de données peut être affiché en utilisant la propriété [Show](../../chartdatatable/get_show/).
