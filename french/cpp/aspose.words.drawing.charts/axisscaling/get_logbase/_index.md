---
title: "Méthode Aspose::Words::Drawing::Charts::AxisScaling::get_LogBase"
linktitle: "get_LogBase"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::AxisScaling::get_LogBase. Obtient ou définit la base logarithmique d'un axe logarithmique en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.drawing.charts/axisscaling/get_logbase/
---
...
La plage valide d'une valeur à virgule flottante est supérieure ou égale à 2 et inférieure ou égale à 1000. La propriété n'a d'effet que si [Type](../get_type/) est défini sur [Logarithmic](../../axisscaletype/).

La définition de cette propriété définit la propriété [Type](../get_type/) sur [Logarithmic](../../axisscaletype/).
