---
title: "Méthode Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode"
linktitle: "get_LeftMode"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode. Obtient ou définit le mode d'interprétation de la valeur de la propriété Left : si elle définit la position de l'étiquette de données depuis le bord gauche du graphique ou depuis la position spécifiée par sa propriété Position en C++."
type: docs
weight: 6667
url: /fr/cpp/aspose.words.drawing.charts/chartdatalabel/get_leftmode/
---
## ChartDataLabel::get_LeftMode method


Obtient ou définit le mode d'interprétation de la valeur de la propriété [Left](../get_left/) : si elle définit la position de l'étiquette de données depuis le bord gauche du graphique ou depuis la position spécifiée par sa propriété [Position](../get_position/).
