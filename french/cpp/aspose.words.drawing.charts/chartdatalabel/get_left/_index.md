---
title: "Méthode Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left"
linktitle: "get_Left"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left. Obtient ou définit la distance de l'étiquette de données en points depuis le bord gauche du graphique ou depuis la position spécifiée par sa propriété Position, selon la valeur de la propriété LeftMode en C++."
type: docs
weight: 6334
url: /fr/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


Obtient ou définit la distance de l'étiquette de données en points depuis le bord gauche du graphique ou depuis la position spécifiée par sa propriété [Position](../get_position/), selon la valeur de la propriété [LeftMode](../get_leftmode/).
