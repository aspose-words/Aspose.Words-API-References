---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode méthode"
linktitle: "get_TopMode"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode méthode. Obtient ou définit le mode d'interprétation de la valeur de la propriété Top : si elle définit la position de l'étiquette de données à partir du bord supérieur du graphique ou à partir de la position spécifiée par sa propriété Position en C++."
type: docs
weight: 16667
url: /fr/cpp/aspose.words.drawing.charts/chartdatalabel/get_topmode/
---
## ChartDataLabel::get_TopMode method


Obtient ou définit le mode d'interprétation de la valeur de la propriété [Top](../get_top/) : si elle définit la position de l'étiquette de données à partir du bord supérieur du graphique ou à partir de la position spécifiée par sa propriété [Position](../get_position/).
