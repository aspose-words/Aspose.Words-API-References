---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Rotation méthode"
linktitle: "get_Rotation"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Rotation méthode. Obtient ou définit la rotation de l'étiquette en degrés en C++."
type: docs
weight: 7667
url: /fr/cpp/aspose.words.drawing.charts/chartdatalabel/get_rotation/
---
...
Si la valeur [Orientation](../get_orientation/) est [Horizontal](../../../aspose.words.drawing/shapetextorientation/), la forme de l'étiquette, si elle existe, est tournée avec le texte de l'étiquette. Sinon, seul le texte de l'étiquette est tourné.
