---
title: "Aspose::Words::Drawing::Charts::AxisTimeUnit énumération"
linktitle: "AxisTimeUnit"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::AxisTimeUnit enum. Spécifie l'unité de temps pour les axes en C++."
type: docs
weight: 26000
url: /fr/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum
...
| --- | --- | --- |
| Automatique | 0 | Spécifie que l'unité n'a pas été définie explicitement et que la valeur par défaut doit être utilisée. |
| Jours | 1 | Spécifie que les données du graphique doivent être affichées en jours. |
| Mois | 2 | Spécifie que les données du graphique doivent être affichées en mois. |
| Années | 3 | Spécifie que les données du graphique doivent être affichées en années. |
