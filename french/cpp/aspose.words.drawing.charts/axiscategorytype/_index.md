---
title: "Énumération Aspose::Words::Drawing::Charts::AxisCategoryType"
linktitle: "AxisCategoryType"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Énumération Aspose::Words::Drawing::Charts::AxisCategoryType. Spécifie le type d'un axe de catégorie en C++."
type: docs
weight: 21000
url: /fr/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| --- | --- | --- |
| Automatique | 0 | Spécifie que le type d'un axe de catégorie est déterminé automatiquement en fonction des données. |
| Catégorie | 1 | Spécifie un axe d'un ensemble arbitraire de catégories. |
| Temps | 2 | Spécifie un axe de catégorie temporelle. |
