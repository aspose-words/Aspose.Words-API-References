---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowSeriesName méthode"
linktitle: "get_ShowSeriesName"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowSeriesName méthode. Retourne ou définit un booléen indiquant le comportement d’affichage du nom de la série pour les étiquettes de données de l’ensemble de la série. true pour afficher le nom de la série ; false pour le masquer. Par défaut, false en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showseriesname/
---
## ChartDataLabelCollection::get_ShowSeriesName method


Renvoie ou définit un booléen indiquant le comportement d'affichage du nom de la série pour les étiquettes de données de la série entière. **true** pour afficher le nom de la série ; **false** pour le masquer. Par défaut **false**.
