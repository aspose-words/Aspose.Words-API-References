---
title: "Aspose::Words::Drawing::Charts::ChartDataPoint::get_Explosion méthode"
linktitle: "get_Explosion"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::ChartDataPoint::get_Explosion méthode. Spécifie la distance à laquelle le point de données doit être déplacé du centre du secteur. Peut être négatif, un valeur négative signifie que la propriété n'est pas définie et qu'aucune explosion ne doit être appliquée. S'applique uniquement aux graphiques circulaires en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.drawing.charts/chartdatapoint/get_explosion/
---
