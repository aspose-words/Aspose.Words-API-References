...
description: "Aspose::Words::Drawing::Charts::AxisCrosses enum. Spécifie les points d'intersection possibles pour un axe en C++."
type: docs
weight: 22000
url: /fr/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum


Spécifie les points d'intersection possibles pour un axe.
...
| --- | --- | --- |
| Automatique | 0 | L'axe des catégories croise le point zéro de l'axe des valeurs (si possible), ou la valeur minimale si le minimum est supérieur à zéro, ou la valeur maximale si le maximum est inférieur à zéro. |
| Maximum | 1 | Un axe perpendiculaire croise la valeur maximale de l'axe. |
| Minimum | 2 | Un axe perpendiculaire croise la valeur minimale de l'axe. |
| Personnalisé | 3 | Un axe perpendiculaire croise la valeur spécifiée de l'axe. |
