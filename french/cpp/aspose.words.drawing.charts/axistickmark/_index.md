...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. Spécifie les positions possibles des marques de graduation en C++."
type: docs
weight: 25000
url: /fr/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum
...
| --- | --- | --- |
| Croix | 0 | Spécifie que les marques de graduation doivent traverser l'axe. |
| À l'intérieur | 1 | Spécifie que les marques de graduation doivent être à l'intérieur de la zone du tracé. |
| À l'extérieur | 2 | Spécifie que les marques de graduation doivent être à l'extérieur de la zone du tracé. |
| None | 3 | Spécifie qu'il ne doit y avoir aucune marque de graduation. |
