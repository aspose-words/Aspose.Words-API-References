---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing méthode"
linktitle: "get_Spacing"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing méthode. Obtient ou définit l'intervalle auquel les étiquettes de repère sont dessinées en C++."
type: docs
weight: 9000
url: /fr/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


Obtient ou définit l'intervalle auquel les étiquettes de repère sont dessinées.
...
La propriété a un effet sur les axes de catégorie de texte et de séries. Elle n'est pas prise en charge par les nouveaux graphiques de MS Office 2016. La plage valide d'une valeur est supérieure ou égale à 1.

La définition de cette propriété définit la propriété [IsAutoSpacing](../get_isautospacing/) sur **false**.
