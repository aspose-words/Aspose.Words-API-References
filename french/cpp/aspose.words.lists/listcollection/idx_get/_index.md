...
description: "Aspose::Words::Lists::ListCollection::idx_get method. Obtient une liste par indice en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words.lists/listcollection/idx_get/
---
...
Montre comment appliquer le format de liste d'une liste existante à un ensemble de paragraphes.
```cpp
