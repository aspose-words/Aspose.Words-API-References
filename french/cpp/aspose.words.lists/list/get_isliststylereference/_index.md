---
title: "Aspose::Words::Lists::List::get_IsListStyleReference méthode"
linktitle: "get_IsListStyleReference"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Lists::List::get_IsListStyleReference méthode. Retourne true si cette liste est une référence à un style de liste en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.lists/list/get_isliststylereference/
---
## List::get_IsListStyleReference method


Renvoie **true** si cette liste est une référence à un style de liste.
...
Remarque, la modification des propriétés d’une liste qui est une référence au style de liste n’a aucun effet. Le formatage de la liste spécifié dans le style de liste lui‑même l’emporte toujours.
