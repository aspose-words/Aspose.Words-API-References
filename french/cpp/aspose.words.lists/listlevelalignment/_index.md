...
description: "Aspose::Words::Lists::ListLevelAlignment enum. Spécifie l'alignement du numéro ou du puce de la liste en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.lists/listlevelalignment/
---
## ListLevelAlignment enum


Spécifie l’alignement du numéro ou de la puce de la liste.
...
| --- | --- | --- |
| Gauche | 0 | L'étiquette de la liste est alignée à gauche de la position du numéro. |
| Centre | 1 | L'étiquette de la liste est centrée à la position du numéro. |
| Droite | 2 | Cette étiquette de liste est alignée à droite de la position du numéro. |

## Remarques


Utilisé comme valeur pour la propriété [Alignment](../listlevel/get_alignment/).
