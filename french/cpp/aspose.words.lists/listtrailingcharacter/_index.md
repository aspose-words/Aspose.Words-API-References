...
description: "Aspose::Words::Lists::ListTrailingCharacter enum. Spécifie le caractère qui sépare l’étiquette de la liste du texte du paragraphe en C++."
type: docs
weight: 9000
url: /fr/cpp/aspose.words.lists/listtrailingcharacter/
---
...
| Space | 1 | Un caractère d’espace est placé entre l’étiquette de la liste et le texte du paragraphe. |
| Nothing | 2 | Il n’y a aucun caractère séparateur entre l’étiquette de la liste et le texte du paragraphe. |

## Remarques


Utilisé comme valeur pour la propriété [TrailingCharacter](../listlevel/get_trailingcharacter/).
