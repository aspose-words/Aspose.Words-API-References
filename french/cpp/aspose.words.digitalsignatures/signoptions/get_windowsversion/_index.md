---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion méthode"
linktitle: "get_WindowsVersion"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion méthode. Obtient ou définit la version Windows pour la signature numérique. La valeur par défaut est \"6.1\" en C++."
type: docs
weight: 8334
url: /fr/cpp/aspose.words.digitalsignatures/signoptions/get_windowsversion/
---
## SignOptions::get_WindowsVersion method


Obtient ou définit la version de Windows pour la signature numérique. La valeur par défaut est "6.1".
