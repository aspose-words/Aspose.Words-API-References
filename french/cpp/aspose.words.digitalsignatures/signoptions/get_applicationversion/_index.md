---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion méthode"
linktitle: "get_ApplicationVersion"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion méthode. Obtient ou définit la version de l'application pour la signature numérique. La valeur par défaut est \"12.0\" en C++."
type: docs
weight: 2334
url: /fr/cpp/aspose.words.digitalsignatures/signoptions/get_applicationversion/
---
## SignOptions::get_ApplicationVersion method


Obtient ou définit la version de l'application pour la signature numérique. La valeur par défaut est "12.0".
