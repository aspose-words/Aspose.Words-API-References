---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_OfficeVersion méthode"
linktitle: "get_OfficeVersion"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_OfficeVersion méthode. Obtient ou définit la version Office pour la signature numérique. La valeur par défaut est \"12.0\" en C++."
type: docs
weight: 4667
url: /fr/cpp/aspose.words.digitalsignatures/signoptions/get_officeversion/
---
## SignOptions::get_OfficeVersion method


Obtient ou définit la version d'Office pour la signature numérique. La valeur par défaut est "12.0".
