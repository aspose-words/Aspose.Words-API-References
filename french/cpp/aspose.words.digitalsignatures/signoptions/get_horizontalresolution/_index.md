---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution méthode"
linktitle: "get_HorizontalResolution"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution méthode. Obtient ou définit la résolution horizontale pour la signature numérique. La valeur par défaut est 1920 en C++."
type: docs
weight: 4334
url: /fr/cpp/aspose.words.digitalsignatures/signoptions/get_horizontalresolution/
---
## SignOptions::get_HorizontalResolution method


Obtient ou définit la résolution horizontale pour la signature numérique. La valeur par défaut est 1920.

```cpp
int32_t Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution() const
```
