...
description: "Aspose::Words::Comparing::ComparisonTargetType enum. Permet de spécifier le document de base qui sera utilisé pendant la comparaison. La valeur par défaut est Current en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


Permet de spécifier le document de base qui sera utilisé pendant la comparaison. La valeur par défaut est [Current](./).
...
| --- | --- | --- |
| Actuel | 0 | Ce document est utilisé comme base pendant la comparaison. |
| Nouveau | 1 | L'autre document est utilisé comme base pendant la comparaison. |
