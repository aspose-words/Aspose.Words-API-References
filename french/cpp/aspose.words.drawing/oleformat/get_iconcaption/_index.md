---
title: "Aspose::Words::Drawing::OleFormat::get_IconCaption méthode"
linktitle: "get_IconCaption"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::OleFormat::get_IconCaption. Obtient la légende de l'icône de l'objet OLE. Dans le cas où l'objet OLE n'a pas d'icône ou qu'une légende ne peut pas être récupérée, renvoie une chaîne vide en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.drawing/oleformat/get_iconcaption/
---
## OleFormat::get_IconCaption method


Obtient la légende de l'icône de l'objet OLE. Dans le cas où l'objet OLE n'a pas d'icône ou qu'une légende ne peut pas être récupérée, renvoie une chaîne vide.
