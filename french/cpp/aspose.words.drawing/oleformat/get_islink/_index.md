---
title: "Aspose::Words::Drawing::OleFormat::get_IsLink méthode"
linktitle: "get_IsLink"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::OleFormat::get_IsLink méthode. Retourne true si l'objet OLE est lié (lorsque SourceFullName est spécifié) en C++."
type: docs
weight: 5000
url: /fr/cpp/aspose.words.drawing/oleformat/get_islink/
---
## OleFormat::get_IsLink method


Renvoie **true** si l'objet OLE est lié (lorsque [SourceFullName](../get_sourcefullname/) est spécifié).
