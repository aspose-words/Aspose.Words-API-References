---
title: "Aspose::Words::Drawing::ReflectionFormat::get_Transparency méthode"
linktitle: "get_Transparency"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Drawing::ReflectionFormat::get_Transparency. Obtient ou définit une valeur double entre 0.0 (opaque) et 1.0 (transparent) représentant le degré de transparence de l'effet de réflexion. La valeur par défaut est 0.0 en C++."
type: docs
weight: 5000
url: /fr/cpp/aspose.words.drawing/reflectionformat/get_transparency/
---
## ReflectionFormat::get_Transparency method


Obtient ou définit une valeur double entre 0,0 (opaque) et 1,0 (transparent) représentant le degré de transparence de l'effet de réflexion. La valeur par défaut est 0,0.
