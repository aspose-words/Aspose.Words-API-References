---
title: "Aspose::Words::Drawing::ReflectionFormat::get_Distance méthode"
linktitle: "get_Distance"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::ReflectionFormat::get_Distance méthode. Obtient ou définit une valeur double qui spécifie la quantité de séparation de l'image reflétée par rapport à l'objet en points. La valeur par défaut est 0.0 en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.drawing/reflectionformat/get_distance/
---
## ReflectionFormat::get_Distance method


Obtient ou définit une valeur double qui spécifie la quantité de séparation de l'image réfléchie par rapport à l'objet en points. La valeur par défaut est 0,0.
