...
description: "Aspose::Words::Drawing::ShapeLineStyle enum. Spécifie le style de ligne composé d’une forme en C++."
type: docs
weight: 36000
url: /fr/cpp/aspose.words.drawing/shapelinestyle/
---
## ShapeLineStyle enum
...
| --- | --- | --- |
| Simple | 0 | Ligne simple. |
| Double | 1 | Double lignes de largeur égale. |
| ThickThin | 2 | Double lignes, une épaisse, une fine. |
| ThinThick | 3 | Double lignes, une fine, une épaisse. |
| Triple | 4 | Trois lignes, fine, épaisse, fine. |
| Default | n/a | La valeur par défaut est [Single](./). |
