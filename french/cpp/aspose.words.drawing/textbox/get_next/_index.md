---
title: "Aspose::Words::Drawing::TextBox::get_Next méthode"
linktitle: "get_Next"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::TextBox::get_Next méthode. Retourne ou définit un TextBox qui représente le TextBox suivant dans une séquence de formes en C++."
type: docs
weight: 9000
url: /fr/cpp/aspose.words.drawing/textbox/get_next/
---
## TextBox::get_Next method


Retourne ou définit un [TextBox](../) qui représente le [TextBox](../) suivant dans une séquence de formes.
