---
title: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle méthode"
linktitle: "get_SignerTitle"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle méthode. Obtient ou définit le titre du signataire suggéré (par exemple, Manager). La valeur par défaut de cette propriété est une chaîne vide en C++."
type: docs
weight: 12000
url: /fr/cpp/aspose.words.drawing/signatureline/get_signertitle/
---
## SignatureLine::get_SignerTitle method


Obtient ou définit le titre du signataire suggéré (par exemple, Manager). La valeur par défaut de cette propriété est **empty string**.
