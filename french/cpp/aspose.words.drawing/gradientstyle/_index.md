...
description: "Aspose::Words::Drawing::GradientStyle enum. Spécifie le style d'un remplissage en dégradé en C++."
type: docs
weight: 24000
url: /fr/cpp/aspose.words.drawing/gradientstyle/
---
## GradientStyle enum
...
| Horizontal | 1 | Dégradé s'étendant horizontalement à travers un objet. |
...
| FromCorner | 5 | Dégradé partant d'un coin vers les trois autres coins. |
| FromCenter | 6 | Dégradé partant du centre vers les coins. |
