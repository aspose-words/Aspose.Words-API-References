---
title: "Aspose::Words::Drawing::GradientStop::GradientStop constructeur"
linktitle: "GradientStop"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Drawing::GradientStop::GradientStop constructeur. Initialise une nouvelle instance de la classe GradientStop en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
## GradientStop::GradientStop(System::Drawing::Color, double) constructor


Initialise une nouvelle instance de la classe [GradientStop](../).
...
| --- | --- | --- |
| color | System::Drawing::Color | Représente la couleur du point d'arrêt du gradient. |
| position | double | Représente la position d'un point d'arrêt dans le dégradé exprimée en pourcentage dans la plage 0.0 à 1.0. |
...
| color | System::Drawing::Color | Représente la couleur du point d'arrêt du gradient. |
| position | double | Représente la position d'un point d'arrêt dans le dégradé exprimée en pourcentage dans la plage 0.0 à 1.0. |
| transparence | double | Représente la transparence d'un point d'arrêt dans le dégradé exprimée en pourcentage dans la plage 0.0 à 1.0. |
