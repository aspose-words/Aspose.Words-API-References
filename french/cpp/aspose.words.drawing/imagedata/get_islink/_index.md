...
description: "Aspose::Words::Drawing::ImageData::get_IsLink method. Retourne true si l'image est liée à la forme (lorsque SourceFullName est spécifié) en C++."
type: docs
weight: 16000
url: /fr/cpp/aspose.words.drawing/imagedata/get_islink/
---
## ImageData::get_IsLink method


Retourne **true** si l'image est liée à la forme (lorsque [SourceFullName](../get_sourcefullname/) est spécifié).
