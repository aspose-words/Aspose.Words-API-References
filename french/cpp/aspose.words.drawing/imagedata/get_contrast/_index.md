...
description: "Méthode Aspose::Words::Drawing::ImageData::get_Contrast. Obtient ou définit le contraste de l'image spécifiée. La valeur de cette propriété doit être un nombre compris entre 0.0 (le contraste le plus faible) et 1.0 (le contraste le plus élevé) en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.drawing/imagedata/get_contrast/
---
## ImageData::get_Contrast method


Obtient ou définit le contraste de l'image spécifiée. La valeur de cette propriété doit être un nombre compris entre 0.0 (le contraste le plus faible) et 1.0 (le contraste le plus élevé).
