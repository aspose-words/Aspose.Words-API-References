...
description: "Aspose::Words::Themes::Theme classe. Représente le thème du document et fournit l'accès aux principales parties du thème, y compris MajorFonts, MinorFonts et Colors. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 1000
url: /fr/cpp/aspose.words.themes/theme/
---
## Theme class


Représente le document [Theme](./) et fournit l'accès aux principales parties du thème, y compris [MajorFonts](./get_majorfonts/), [MinorFonts](./get_minorfonts/) et [Colors](./get_colors/). Pour en savoir plus, consultez l'article de documentation [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Méthode | Description |
| --- | --- |
| [get_Colors](./get_colors/)() const | Permet de spécifier l'ensemble des couleurs du thème pour le document. |
| [get_MajorFonts](./get_majorfonts/)() const | Permet de spécifier l'ensemble des polices principales pour différentes langues. |
| [get_MinorFonts](./get_minorfonts/)() const | Permet de spécifier l'ensemble des polices secondaires pour différentes langues. |
