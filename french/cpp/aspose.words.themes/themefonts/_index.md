...
description: "Aspose::Words::Themes::ThemeFonts class. Représente une collection de polices dans le schéma de polices, permettant de spécifier différentes polices pour les langues Latin, EastAsian et ComplexScript. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.themes/themefonts/
---
## ThemeFonts class


Représente une collection de polices dans le schéma de polices, permettant de spécifier différentes polices pour les langues [Latin](./get_latin/), [EastAsian](./get_eastasian/) et [ComplexScript](./get_complexscript/). Pour en savoir plus, consultez l'article de documentation [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Méthode | Description |
| --- | --- |
| [get_ComplexScript](./get_complexscript/)() | Spécifie le nom de police pour les caractères ComplexScript. |
| [get_EastAsian](./get_eastasian/)() | Spécifie le nom de police pour les caractères EastAsian. |
| [get_Latin](./get_latin/)() | Spécifie le nom de police pour les caractères Latin. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_ComplexScript](./set_complexscript/)(const System::String\&) | Mutateur pour [Aspose::Words::Themes::ThemeFonts::get_ComplexScript](./get_complexscript/). |
| [set_EastAsian](./set_eastasian/)(const System::String\&) | Mutateur pour [Aspose::Words::Themes::ThemeFonts::get_EastAsian](./get_eastasian/). |
| [set_Latin](./set_latin/)(const System::String\&) | Mutateur pour [Aspose::Words::Themes::ThemeFonts::get_Latin](./get_latin/). |
| static [Type](./type/)() |  |
