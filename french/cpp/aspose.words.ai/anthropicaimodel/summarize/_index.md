...
description: "Aspose::Words::AI::AnthropicAiModel::Summarize method. Génère des résumés pour un tableau de documents, avec des options pour contrôler la longueur du résumé et d'autres paramètres. Cette méthode utilise le modèle d'IA connecté pour traiter chaque document du tableau en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.ai/anthropicaimodel/summarize/
---
