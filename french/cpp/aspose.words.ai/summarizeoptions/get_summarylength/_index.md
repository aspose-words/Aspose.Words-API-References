...
description: "Aspose::Words::AI::SummarizeOptions::get_SummaryLength méthode. Permet de spécifier la longueur du résumé. La valeur par défaut est Medium en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.ai/summarizeoptions/get_summarylength/
---
## SummarizeOptions::get_SummaryLength method


Permet de spécifier la longueur du résumé. La valeur par défaut est [Medium](../../summarylength/).
