...
description: "Aspose::Words::Properties::PropertyType enum. Spécifie le type de données d'une propriété de document en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.properties/propertytype/
---
## PropertyType enum
...
| DateTime | 1 | La propriété est une valeur de date et heure. |
| Double | 2 | La propriété est un nombre à virgule flottante. |
| Nombre | 3 | La propriété est un nombre entier. |
...
| Autre | 8 | La propriété est d'un autre type. |
