---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Template méthode"
linktitle: "get_Template"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Template méthode. Obtient ou définit le nom informatif du modèle de document en C++."
type: docs
weight: 27000
url: /fr/cpp/aspose.words.properties/builtindocumentproperties/get_template/
---
...
Dans Microsoft Word, cette propriété n’est destinée qu’à des fins d’information et contient généralement uniquement le nom du fichier du modèle sans le chemin.

Une chaîne vide signifie que le document est attaché au modèle Normal.

Pour obtenir ou définir le nom réel du modèle attaché, utilisez la propriété [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/).
