---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor méthode"
linktitle: "get_RevisionBarsColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor method. Permet de spécifier la couleur à utiliser pour les barres latérales qui identifient les lignes du document contenant des informations révisées. La valeur par défaut est Red en C++."
type: docs
weight: 14000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


Permet de spécifier la couleur à utiliser pour les barres latérales qui identifient les lignes du document contenant des informations révisées. La valeur par défaut est [Red](../../revisioncolor/).
