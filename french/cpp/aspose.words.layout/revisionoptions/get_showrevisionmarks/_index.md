---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks méthode"
linktitle: "get_ShowRevisionMarks"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks méthode. Permet de spécifier si le texte de révision doit être marqué avec une mise en forme spéciale. La valeur par défaut est true en C++."
type: docs
weight: 20000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_showrevisionmarks/
---
## RevisionOptions::get_ShowRevisionMarks method


Permet de spécifier si le texte de révision doit être marqué avec une mise en forme spéciale. La valeur par défaut est **true**.
