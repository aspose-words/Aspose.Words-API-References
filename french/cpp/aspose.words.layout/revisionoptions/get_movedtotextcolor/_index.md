---
title: "Méthode Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor method"
linktitle: "get_MovedToTextColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor. Permet de spécifier la couleur à utiliser pour les zones où le contenu a été déplacé vers Moving. La valeur par défaut est ByAuthor en C++."
type: docs
weight: 10000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


Permet de spécifier la couleur à utiliser pour les zones où le contenu a été déplacé vers [Moving](../../../aspose.words/revisiontype/). La valeur par défaut est [ByAuthor](../../revisioncolor/).
