---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor méthode"
linktitle: "get_DeletedTextColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor méthode. Permet de spécifier la couleur à utiliser pour le contenu supprimé Deletion. La valeur par défaut est ByAuthor en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


Permet de spécifier la couleur à utiliser pour le contenu supprimé [Deletion](../../../aspose.words/revisiontype/). La valeur par défaut est [ByAuthor](../../revisioncolor/).
