---
title: "Méthode Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor"
linktitle: "get_MovedFromTextColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor. Permet de spécifier la couleur à utiliser pour les zones où le contenu a été déplacé depuis Moving. La valeur par défaut est ByAuthor en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Permet de spécifier la couleur à utiliser pour les zones où le contenu a été déplacé depuis [Moving](../../../aspose.words/revisiontype/). La valeur par défaut est [ByAuthor](../../revisioncolor/).
