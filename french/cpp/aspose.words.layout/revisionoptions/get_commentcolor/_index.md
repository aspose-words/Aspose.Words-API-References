---
title: "Aspose::Words::Layout::RevisionOptions::get_CommentColor méthode"
linktitle: "get_CommentColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Layout::RevisionOptions::get_CommentColor méthode. Permet de spécifier la couleur à utiliser pour les commentaires. La valeur par défaut est Red en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


Permet de spécifier la couleur à utiliser pour les commentaires. La valeur par défaut est [Red](../../revisioncolor/).
