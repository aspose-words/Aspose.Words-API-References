---
title: "Méthode Aspose::Words::Layout::LayoutCollector::GetStartPageIndex"
linktitle: "GetStartPageIndex"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Layout::LayoutCollector::GetStartPageIndex. Obtient l'index de la page (basé sur 1) où le nœud commence. Retourne 0 si le nœud ne peut pas être associé à une page en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.layout/layoutcollector/getstartpageindex/
---
## LayoutCollector::GetStartPageIndex method


Obtient l'index basé sur 1 de la page où le nœud commence. Retourne 0 si le nœud ne peut pas être mappé à une page.
