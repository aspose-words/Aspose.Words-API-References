...
description: "Aspose::Words::Layout::RevisionTextEffect enum. Permet de spécifier l'effet de décoration pour les révisions du texte du document en C++."
type: docs
weight: 12000
url: /fr/cpp/aspose.words.layout/revisiontexteffect/
---
...
| --- | --- | --- |
| None | 0 | Le contenu révisé n'a aucun effet spécial appliqué. Cela correspond à [NoHighlight](../revisioncolor/). |
| Couleur | 1 | Le contenu révisé est uniquement mis en évidence avec une couleur. |
| Gras | 2 | Le contenu révisé est mis en gras et coloré. |
| Italique | 3 | Le contenu révisé est mis en italique et coloré. |
| Soulignement | 4 | Le contenu révisé est souligné et coloré. |
...
| Masqué | 8 | Le contenu révisé est masqué. |
