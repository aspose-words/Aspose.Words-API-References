---
title: "Aspose::Words::Fonts::FontInfo::get_Pitch méthode"
linktitle: "get_Pitch"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Fonts::FontInfo::get_Pitch méthode. Le pitch indique si la police est à chasse fixe, à espacement proportionnel, ou repose sur un réglage par défaut en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.fonts/fontinfo/get_pitch/
---
## FontInfo::get_Pitch method


Le pitch indique si la police est à chasse fixe, à espacement proportionnel, ou dépend d'un paramètre par défaut.
