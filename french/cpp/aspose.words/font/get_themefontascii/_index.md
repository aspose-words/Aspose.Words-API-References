---
title: "Aspose::Words::Font::get_ThemeFontAscii méthode"
linktitle: "get_ThemeFontAscii"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Font::get_ThemeFontAscii méthode. Obtient ou définit la police thématique utilisée pour le texte latin (caractères dont les codes sont compris entre 0 (zéro) et 127) dans le jeu de polices appliqué qui est associé à cet objet Font en C++."
type: docs
weight: 50000
url: /fr/cpp/aspose.words/font/get_themefontascii/
---
## Font::get_ThemeFontAscii method


Obtient ou définit la police thématique utilisée pour le texte latin (caractères dont les codes sont compris entre 0 (zéro) et 127) dans le jeu de polices appliqué qui est associé à cet objet [Font](../).
