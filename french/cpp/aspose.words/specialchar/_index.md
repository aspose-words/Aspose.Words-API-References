...
description: "Aspose::Words::SpecialChar classe. Classe de base pour les caractères spéciaux dans le document. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 62000
url: /fr/cpp/aspose.words/specialchar/
---
## SpecialChar class


Classe de base pour les caractères spéciaux dans le document. Pour en savoir plus, consultez l'article de documentation [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_NodeType](./get_nodetype/)() const override | Renvoie [SpecialChar](../nodetype/). |
...
| [GetText](./gettext/)() override | Obtient le caractère spécial que ce nœud représente. |
