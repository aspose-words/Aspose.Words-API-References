...
description: "Aspose::Words::TextWatermarkOptions::get_IsSemitrasparent method. Obtient ou définit une valeur booléenne qui détermine l'opacité du filigrane. La valeur par défaut est true en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words/textwatermarkoptions/get_issemitrasparent/
---
## TextWatermarkOptions::get_IsSemitrasparent method


Obtient ou définit une valeur booléenne qui détermine l'opacité du filigrane. La valeur par défaut est **true**.
