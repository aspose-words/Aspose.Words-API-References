---
title: "Méthode Aspose::Words::Revision::get_ParentNode"
linktitle: "get_ParentNode"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Revision::get_ParentNode. Obtient le nœud parent immédiat (propriétaire) de cette révision. Cette propriété fonctionnera pour tout type de révision autre que StyleDefinitionChange en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


Obtient le nœud parent immédiat (propriétaire) de cette révision. Cette propriété fonctionnera pour tout type de révision autre que [StyleDefinitionChange](../../revisiontype/).
