---
title: "Aspose::Words::SignatureLineOptions::get_Instructions méthode"
linktitle: "get_Instructions"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::SignatureLineOptions::get_Instructions. Obtient ou définit les instructions destinées au signataire qui sont affichées lors de la signature de la ligne de signature. La valeur par défaut de cette propriété est une chaîne vide en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


Obtient ou définit les instructions destinées au signataire qui sont affichées lors de la signature de la ligne de signature. La valeur par défaut de cette propriété est **empty string**.
