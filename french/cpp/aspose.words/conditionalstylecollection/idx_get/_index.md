---
title: "Aspose::Words::ConditionalStyleCollection::idx_get méthode"
linktitle: "idx_get"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::ConditionalStyleCollection::idx_get méthode. Récupère un objet ConditionalStyle par type de style conditionnel en C++."
type: docs
weight: 18000
url: /fr/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


Récupère un objet [ConditionalStyle](../../conditionalstyle/) par type de style conditionnel.
...
Récupère un objet [ConditionalStyle](../../conditionalstyle/) par index.
...
| --- | --- | --- |
| index | int32_t | Indice basé sur zéro du style conditionnel à récupérer. |
