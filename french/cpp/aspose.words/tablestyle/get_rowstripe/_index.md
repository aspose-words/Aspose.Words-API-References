---
title: "Méthode Aspose::Words::TableStyle::get_RowStripe"
linktitle: "get_RowStripe"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::TableStyle::get_RowStripe. Obtient ou définit le nombre de lignes à inclure dans le banding lorsque le style spécifie un banding de lignes impaires/paires en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words/tablestyle/get_rowstripe/
---
## TableStyle::get_RowStripe method


Obtient ou définit le nombre de lignes à inclure dans le banding lorsque le style spécifie le banding des lignes impaires/paires.
