...
description: "Classe Aspose::Words::EditableRangeEnd. Représente la fin d'une plage modifiable dans un document Word. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 25000
url: /fr/cpp/aspose.words/editablerangeend/
---
## EditableRangeEnd class


Représente la fin d'une plage modifiable dans un document Word. Pour en savoir plus, consultez l'article de documentation [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_EditableRangeStart](./get_editablerangestart/)() | Correspondant [EditableRangeStart](../editablerangestart/), reçu par ID. |
...
| [get_NodeType](./get_nodetype/)() const override | Renvoie [EditableRangeEnd](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | Mutateur pour [Aspose::Words::EditableRangeEnd::get_Id](./get_id/). |
...
Une plage modifiable complète dans un document Word se compose d'un [EditableRangeStart](./get_editablerangestart/) et d'un [EditableRangeEnd](./) correspondant avec le même Id.
...
Utilisez la classe [EditableRange](../editablerange/) comme une « façade » pour travailler avec une plage modifiable en tant qu'objet unique.
