---
title: "Aspose::Words::Shading::get_ForegroundPatternThemeColor méthode"
linktitle: "get_ForegroundPatternThemeColor"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Shading::get_ForegroundPatternThemeColor méthode. Obtient ou définit la couleur du thème du motif de premier plan dans le schéma de couleurs appliqué associé à cet objet Shading en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words/shading/get_foregroundpatternthemecolor/
---
## Shading::get_ForegroundPatternThemeColor method


Obtient ou définit la couleur du thème du motif de premier plan dans le schéma de couleurs appliqué associé à cet objet [Shading](../).
