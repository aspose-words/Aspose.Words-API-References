---
title: "Aspose::Words::Style::get_Aliases méthode"
linktitle: "get_Aliases"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Style::get_Aliases méthode. Obtient tous les alias de ce style. Si le style n'a aucun alias, un tableau vide de chaînes est renvoyé en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words/style/get_aliases/
---
## Style::get_Aliases method


Obtient tous les alias de ce style. Si le style n’a aucun alias, un tableau vide de chaînes est retourné.
