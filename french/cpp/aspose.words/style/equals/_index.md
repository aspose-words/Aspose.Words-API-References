---
title: "Aspose::Words::Style::Equals méthode"
linktitle: "Equals"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Style::Equals méthode. Compare avec le style spécifié. Les Istds de styles sont comparés uniquement pour les styles intégrés. Les valeurs par défaut des styles ne sont pas incluses dans la comparaison. Le style de base, le style lié et le style du paragraphe suivant sont comparés de manière récursive en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words/style/equals/
---
## Style::Equals method


Compare avec le style spécifié. Les Istds de styles sont comparés uniquement pour les styles intégrés. Les valeurs par défaut des styles ne sont pas incluses dans la comparaison. Le style de base, le style lié et le style du paragraphe suivant sont comparés de manière récursive.
