...
description: "Aspose::Words::CommentRangeEnd class. Désigne la fin d'une région de texte à laquelle un commentaire est associé. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words/commentrangeend/
---
## CommentRangeEnd class


Indique la fin d'une région de texte associée à un commentaire. Pour en savoir plus, consultez l'article de documentation [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/).
...
| [CommentRangeEnd](./commentrangeend/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | Initialise une nouvelle instance de cette classe. |
...
| [get_NodeType](./get_nodetype/)() const override | Renvoie [CommentRangeEnd](../nodetype/). |
...
Pour créer un commentaire ancré à une région de texte, vous devez créer un [Comment](../comment/) puis créer [CommentRangeStart](../commentrangestart/) et [CommentRangeEnd](./) et définir leurs identifiants sur la même valeur [Id](../comment/get_id/).
