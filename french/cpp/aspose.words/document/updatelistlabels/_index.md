---
title: "Aspose::Words::Document::UpdateListLabels méthode"
linktitle: "UpdateListLabels"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Document::UpdateListLabels méthode. Met à jour les libellés de liste pour tous les éléments de liste du document en C++."
type: docs
weight: 97000
url: /fr/cpp/aspose.words/document/updatelistlabels/
---
## Document::UpdateListLabels method


Met à jour les libellés de liste pour tous les éléments de liste dans le document.
...
Cette méthode met à jour les propriétés d'étiquette de liste telles que [LabelValue](../../../aspose.words.lists/listlabel/get_labelvalue/) et [LabelString](../../../aspose.words.lists/listlabel/get_labelstring/) pour chaque objet [ListLabel](../../paragraph/get_listlabel/) dans le document.

De plus, cette méthode est parfois appelée implicitement lors de la mise à jour des champs du document. Cela est nécessaire car certains champs qui peuvent référencer des numéros de liste (comme TOC ou REF) doivent être à jour.
