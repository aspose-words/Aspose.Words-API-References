---
title: "Aspose::Words::Document::get_CustomXmlParts méthode"
linktitle: "get_CustomXmlParts"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Document::get_CustomXmlParts méthode. Obtient ou définit la collection des parties de stockage de données XML personnalisées en C++."
type: docs
weight: 19000
url: /fr/cpp/aspose.words/document/get_customxmlparts/
---
## Document::get_CustomXmlParts method


Obtient ou définit la collection des parties de stockage de données XML personnalisées.
...
Aspose.Words charge et enregistre uniquement les parties XML personnalisées dans les documents OOXML et DOC.
