---
title: "Aspose::Words::TabStopCollection::RemoveByPosition méthode"
linktitle: "RemoveByPosition"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::TabStopCollection::RemoveByPosition méthode. Supprime un arrêt de tabulation à la position spécifiée de la collection en C++."
type: docs
weight: 15000
url: /fr/cpp/aspose.words/tabstopcollection/removebyposition/
---
## TabStopCollection::RemoveByPosition method


Supprime une tabulation à la position spécifiée de la collection.
...
| --- | --- | --- |
| position | double | La position (en points) de l'arrêt de tabulation à supprimer. |
