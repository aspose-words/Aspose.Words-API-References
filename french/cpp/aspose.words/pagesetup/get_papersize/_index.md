---
title: "Méthode Aspose::Words::PageSetup::get_PaperSize"
linktitle: "get_PaperSize"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::PageSetup::get_PaperSize. Retourne ou définit la taille du papier en C++."
type: docs
weight: 37000
url: /fr/cpp/aspose.words/pagesetup/get_papersize/
---
...
Définir cette propriété met à jour les valeurs [PageWidth](../get_pagewidth/) et [PageHeight](../get_pageheight/). Définir cette valeur à [Custom](../../papersize/) ne modifie pas les valeurs existantes.
...
Montre comment définir la taille du papier de JisB4 ou JisB5.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>(get_MyDir() + u"Big document.docx");

System::SharedPtr<Aspose::Words::PageSetup> pageSetup = doc->get_FirstSection()->get_PageSetup();
// Définissez la taille du papier à JisB4 (257x364mm).
pageSetup->set_PaperSize(Aspose::Words::PaperSize::JisB4);
// Alternativement, définissez la taille du papier à JisB5. (182x257mm).
