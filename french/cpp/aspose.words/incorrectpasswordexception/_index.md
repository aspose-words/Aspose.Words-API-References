---
title: "Typedef Aspose::Words::IncorrectPasswordException"
linktitle: "IncorrectPasswordException"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Typedef Aspose::Words::IncorrectPasswordException. Lancée si un document est chiffré avec un mot de passe et que le mot de passe spécifié lors de l'ouverture du document est incorrect ou manquant. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 134000
url: /fr/cpp/aspose.words/incorrectpasswordexception/
---
## IncorrectPasswordException typedef


Lancé si un document est chiffré avec un mot de passe et que le mot de passe spécifié lors de l'ouverture du document est incorrect ou manquant. Pour en savoir plus, consultez l'article de documentation [Programming with Documents](https://docs.aspose.com/words/cpp/programming-with-documents/).
