...
description: "Aspose::Words::DocumentBuilder::EndTable method. Termine une table dans le document en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words/documentbuilder/endtable/
---
...
Cette méthode ne doit être appelée qu'une seule fois après que [EndRow](../endrow/) a été appelée. Lorsqu'elle est appelée, [EndTable](./) déplace le curseur hors de la cellule actuelle pour pointer juste après la table.
