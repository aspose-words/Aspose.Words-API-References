---
title: "Méthode Aspose::Words::DocumentBuilder::EndEditableRange"
linktitle: "EndEditableRange"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::DocumentBuilder::EndEditableRange. Marque la position actuelle dans le document comme la fin d’une plage modifiable en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words/documentbuilder/endeditablerange/
---
...
Une plage modifiable dans un document peut se chevaucher et couvrir n’importe quelle plage. Pour créer une plage modifiable valide, vous devez appeler les méthodes [StartEditableRange](../starteditablerange/) et [EndEditableRange](./) ou [EndEditableRange()](../).
...
| --- | --- | --- |
| début | const System::SharedPtr\<Aspose::Words::EditableRangeStart\>\& | Ce début de plage modifiable. |
