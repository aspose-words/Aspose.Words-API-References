---
title: "Aspose::Words::Body::Body constructeur"
linktitle: "Body"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Body::Body constructeur. Initialise une nouvelle instance de la classe Body en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words/body/body/
---
## Body::Body constructor


Initialise une nouvelle instance de la classe [Body](../).
...
Lorsque [Body](../) est créé, il appartient au document spécifié, mais ne fait pas encore partie du document et [ParentNode](../../node/get_parentnode/) est **null**.

Pour ajouter [Body](../) à une [Section](../../section/), utilisez les méthodes [AppendChild](../)[InsertAfter](../) ou [InsertBefore](../).
