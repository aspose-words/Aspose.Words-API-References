---
title: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent méthode"
linktitle: "get_CharacterUnitFirstLineIndent"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent méthode. Obtient ou définit la valeur (en caractères) pour le retrait de première ligne ou le retrait suspendu. Utilisez des valeurs positives pour définir le retrait de première ligne, et des valeurs négatives pour définir le retrait suspendu en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words/paragraphformat/get_characterunitfirstlineindent/
---
## ParagraphFormat::get_CharacterUnitFirstLineIndent method


Obtient ou définit la valeur (en caractères) pour le retrait de première ligne ou le retrait suspendu. Utilisez des valeurs positives pour définir le retrait de première ligne, et des valeurs négatives pour définir le retrait suspendu.
