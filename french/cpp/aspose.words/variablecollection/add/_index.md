---
title: "Méthode Aspose::Words::VariableCollection::Add"
linktitle: "Add"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::VariableCollection::Add. Ajoute une variable de document à la collection en C++."
type: docs
weight: 2000
url: /fr/cpp/aspose.words/variablecollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Le nom de la variable à ajouter, insensible à la casse. |
| value | const System::String\& | La valeur de la variable. La valeur ne peut pas être **null**, si la valeur est nulle une chaîne vide sera utilisée à la place. |
