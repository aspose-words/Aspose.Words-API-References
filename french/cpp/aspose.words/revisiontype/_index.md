...
description: "Aspose::Words::RevisionType enum. Spécifie le type de modification suivi dans Revision en C++."
type: docs
weight: 113000
url: /fr/cpp/aspose.words/revisiontype/
---
## RevisionType enum


Spécifie le type de modification suivi dans [Revision](../revision/).
...
| FormatChange | 2 | Une modification du formatage a été appliquée au nœud parent. |
| StyleDefinitionChange | 3 | Une modification du formatage a été appliquée au style parent. |
| Déplacement | 4 | Le contenu a été déplacé dans le document. |
