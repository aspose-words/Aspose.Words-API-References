...
description: "Aspose::Words::Markup::SdtListItem class. Cet élément spécifie un seul élément de liste au sein d'une balise de document structuré ComboBox ou DropDownList parent. Pour en savoir plus, consultez l'article de documentation en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.markup/sdtlistitem/
---
## SdtListItem class


Cet élément spécifie un seul élément de liste au sein d'une balise de document structuré parent [ComboBox](../sdttype/) ou [DropDownList](../sdttype/). Pour en savoir plus, visitez l'article de documentation [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| Méthode | Description |
| --- | --- |
| [get_DisplayText](./get_displaytext/)() const | Obtient le texte à afficher dans le contenu du run à la place du contenu de l'attribut [Value](./get_value/) pour cet élément de liste. |
| [get_Value](./get_value/)() const | Obtient la valeur de cet élément de liste. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [SdtListItem](./sdtlistitem/)(const System::String\&, const System::String\&) | Initialise une nouvelle instance de cette classe. |
| [SdtListItem](./sdtlistitem/)(const System::String\&) | Initialise une nouvelle instance de cette classe. |
| static [Type](./type/)() |  |
