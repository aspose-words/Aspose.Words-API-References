---
title: "Aspose::Words::Markup::SdtListItem::get_DisplayText méthode"
linktitle: "get_DisplayText"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::SdtListItem::get_DisplayText méthode. Obtient le texte à afficher dans le contenu du run à la place du contenu de l'attribut Value pour cet élément de liste en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.markup/sdtlistitem/get_displaytext/
---
## SdtListItem::get_DisplayText method


Obtient le texte à afficher dans le contenu du run à la place du contenu de l'attribut [Value](../get_value/) pour cet élément de liste.
