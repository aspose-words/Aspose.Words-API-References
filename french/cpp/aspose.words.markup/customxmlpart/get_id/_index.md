---
title: "Aspose::Words::Markup::CustomXmlPart::get_Id méthode"
linktitle: "get_Id"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Id méthode. Obtient ou définit la chaîne qui identifie cette partie XML personnalisée dans un document OOXML en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.markup/customxmlpart/get_id/
---
...
ISO/IEC 29500 spécifie que cette valeur est un GUID, mais les anciennes versions de Microsoft Word autorisaient n'importe quelle chaîne ici. Aspose.Words fait de même pour le format ECMA-376. Mais notez que Microsoft Word Online ne parvient pas à ouvrir un document créé avec une valeur non GUID. Ainsi, un GUID est la valeur préférée pour cette propriété.

Une valeur valide doit être un identifiant unique parmi toutes les parties de données XML personnalisées de ce document.

La valeur par défaut est une chaîne vide. La valeur ne peut pas être **null**.
