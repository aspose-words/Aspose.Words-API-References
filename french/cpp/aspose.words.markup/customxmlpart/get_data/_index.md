---
title: "Aspose::Words::Markup::CustomXmlPart::get_Data méthode"
linktitle: "get_Data"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Data méthode. Obtient ou définit le contenu XML de cette partie de stockage de données XML personnalisées en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.markup/customxmlpart/get_data/
---
## CustomXmlPart::get_Data method


Obtient ou définit le contenu XML de cette partie de stockage de données XML personnalisées.
...
La valeur par défaut est un tableau d'octets vide. La valeur ne peut pas être **null**.
