---
title: "Aspose::Words::Markup::CustomXmlProperty::get_Uri méthode"
linktitle: "get_Uri"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::CustomXmlProperty::get_Uri méthode. Obtient ou définit l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente en C++."
type: docs
weight: 4000
url: /fr/cpp/aspose.words.markup/customxmlproperty/get_uri/
---
## CustomXmlProperty::get_Uri method


Obtient ou définit l'URI d'espace de noms de l'attribut XML personnalisé ou de la propriété de balise intelligente.
