---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_LockContentControl méthode"
linktitle: "get_LockContentControl"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_LockContentControl méthode. Lorsqu'elle est définie sur true, cette propriété empêchera un utilisateur de supprimer ce SDT en C++."
type: docs
weight: 6000
url: /fr/cpp/aspose.words.markup/istructureddocumenttag/get_lockcontentcontrol/
---
## IStructuredDocumentTag::get_LockContentControl method


Lorsque la valeur est true, cette propriété empêchera un utilisateur de supprimer ce **SDT**.
