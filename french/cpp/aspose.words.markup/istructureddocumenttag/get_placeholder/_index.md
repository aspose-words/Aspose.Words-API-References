---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_Placeholder méthode"
linktitle: "get_Placeholder"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_Placeholder méthode. Obtient le BuildingBlock contenant le texte de substitution qui doit être affiché lorsque le contenu de ce SDT est vide, que l'élément XML mappé associé est vide tel que spécifié via l'élément XmlMapping ou que l'élément IsShowingPlaceholderText est vrai en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.markup/istructureddocumenttag/get_placeholder/
---
## IStructuredDocumentTag::get_Placeholder method


Obtient le [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) contenant le texte de substitution qui doit être affiché lorsque le contenu de ce SDT est vide, que l'élément XML mappé associé est vide tel que spécifié via l'élément [XmlMapping](../get_xmlmapping/) ou que l'élément [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) est vrai.
