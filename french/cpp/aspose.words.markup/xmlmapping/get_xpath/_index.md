---
title: "Méthode get_XPath de Aspose::Words::Markup::XmlMapping"
linktitle: "get_XPath"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode get_XPath de Aspose::Words::Markup::XmlMapping. Retourne l'expression XPath, qui est évaluée pour trouver le nœud XML personnalisé mappé à la balise de document structuré parent en C++."
type: docs
weight: 7000
url: /fr/cpp/aspose.words.markup/xmlmapping/get_xpath/
---
## XmlMapping::get_XPath method


Renvoie l'expression XPath, qui est évaluée pour trouver le nœud XML personnalisé mappé à la balise de document structuré parent.
