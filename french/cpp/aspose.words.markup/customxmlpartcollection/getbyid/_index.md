---
title: "Méthode Aspose::Words::Markup::CustomXmlPartCollection::GetById"
linktitle: "GetById"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Markup::CustomXmlPartCollection::GetById. Recherche et renvoie une partie XML personnalisée par son identifiant en C++."
type: docs
weight: 11000
url: /fr/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
...
| --- | --- | --- |
| id | const System::String\& | Chaîne sensible à la casse qui identifie la partie XML personnalisée. |

### ReturnValue

Renvoie **null** si aucune partie XML personnalisée avec l'identifiant spécifié n'est trouvée.
