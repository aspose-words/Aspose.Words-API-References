---
title: "Méthode Add de Aspose::Words::Markup::CustomXmlPartCollection"
linktitle: "Add"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Add de Aspose::Words::Markup::CustomXmlPartCollection. Ajoute un élément à la collection en C++."
type: docs
weight: 3000
url: /fr/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| --- | --- | --- |
| partie | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | La partie XML personnalisée à ajouter. |
...
Crée une nouvelle partie XML avec le XML spécifié et l'ajoute à la collection.
...
| Paramètre | Type | Description |
| --- | --- | --- |
| id | const System::String\& | Identifiant d'une nouvelle partie XML personnalisée. |
| xml | const System::String\& | Données XML de la partie. |
