---
title: "Méthode Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_LockContents"
linktitle: "get_LockContents"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_LockContents. Lorsqu'elle est définie sur true, cette propriété empêchera un utilisateur de modifier le contenu de ce tag de document structuré en C++."
type: docs
weight: 12000
url: /fr/cpp/aspose.words.markup/structureddocumenttagrangestart/get_lockcontents/
---
## StructuredDocumentTagRangeStart::get_LockContents method


Lorsque la valeur est **true**, cette propriété empêchera un utilisateur de modifier le contenu de cette balise de document structuré.
