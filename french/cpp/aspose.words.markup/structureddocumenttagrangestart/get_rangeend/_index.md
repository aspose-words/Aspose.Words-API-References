---
title: "Méthode Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd"
linktitle: "get_RangeEnd"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Méthode Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd. Spécifie la fin de la plage si le StructuredDocumentTag est un tag de document structuré à portée. Sinon retourne null en C++."
type: docs
weight: 16000
url: /fr/cpp/aspose.words.markup/structureddocumenttagrangestart/get_rangeend/
---
## StructuredDocumentTagRangeStart::get_RangeEnd method


Spécifie la fin de la plage si le [StructuredDocumentTag](../../structureddocumenttag/) est un tag de document structuré à portée. Sinon retourne **null**.
