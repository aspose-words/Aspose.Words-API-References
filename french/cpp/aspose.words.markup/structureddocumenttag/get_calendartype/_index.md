---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_CalendarType méthode"
linktitle: "get_CalendarType"
second_title: "Référence de l'API Aspose.Words pour C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_CalendarType méthode. Spécifie le type de calendrier pour ce **SDT**. La valeur par défaut est Default en C++."
type: docs
weight: 8000
url: /fr/cpp/aspose.words.markup/structureddocumenttag/get_calendartype/
---
## StructuredDocumentTag::get_CalendarType method


Spécifie le type de calendrier pour ce **SDT**. La valeur par défaut est [Default](../../sdtcalendartype/)
