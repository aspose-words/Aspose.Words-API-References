...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateDisplayLocale method. Permet de définir/obtenir le format linguistique de la date affichée dans ce SDT en C++."
type: docs
weight: 13000
url: /fr/cpp/aspose.words.markup/structureddocumenttag/get_datedisplaylocale/
---
## StructuredDocumentTag::get_DateDisplayLocale method


Permet de définir/obtenir le format linguistique pour la date affichée dans ce **SDT**.
