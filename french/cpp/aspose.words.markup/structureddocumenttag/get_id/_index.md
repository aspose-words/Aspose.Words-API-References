...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Id method. Spécifie un identifiant numérique unique, en lecture seule et persistant, pour ce SDT en C++."
type: docs
weight: 17000
url: /fr/cpp/aspose.words.markup/structureddocumenttag/get_id/
---
...
L'attribut Id doit suivre ces règles:* Le document ne conservera les ids SDT que si le document entier est cloné [Clone](../../../aspose.words/document/clone/).
