...
description: Представляет конструкции Out/Ref для структуры SizeF.
type: docs
weight: 21
url: /ru/java/com.aspose.words.ref/refsizef/
---
...
Представляет конструкции Out/Ref для структуры SizeF.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [RefSizeF(long value)](#RefSizeF-long-) | Имитирует инициализацию параметра Out/Ref с заданным значением. |
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [set(long anotherValue)](#set-long-) | Устанавливает значение параметра Out/Ref. Следует использовать внутри метода с конструкциями Out/Ref. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
| [wait(long arg0)](#wait-long-) |  |
| [wait(long arg0, int arg1)](#wait-long-int-) |  |
### RefSizeF(long value) {#RefSizeF-long-}
```
public RefSizeF(long value)
```
