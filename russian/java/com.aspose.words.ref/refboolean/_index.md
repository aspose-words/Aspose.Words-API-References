...
description: Представляет конструкции Out/Ref для логического примитивного типа.
type: docs
weight: 11
url: /ru/java/com.aspose.words.ref/refboolean/
---
...
Представляет конструкции Out/Ref для логического примитивного типа.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [RefBoolean(boolean value)](#RefBoolean-boolean-) | Имитирует инициализацию параметра Out/Ref с заданным значением. |
## Методы
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [set(boolean anotherValue)](#set-boolean-) | Устанавливает значение параметра Out/Ref. Следует использовать внутри метода с конструкциями Out/Ref. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
