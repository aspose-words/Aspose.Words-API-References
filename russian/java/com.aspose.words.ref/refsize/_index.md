...
description: Представляет конструкции Out/Ref для структуры Size.
type: docs
weight: 20
url: /ru/java/com.aspose.words.ref/refsize/
---
...
Представляет конструкции Out/Ref для структуры Size.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [RefSize(long value)](#RefSize-long-) | Имитирует инициализацию параметра Out/Ref с заданным значением. |
## Методы
