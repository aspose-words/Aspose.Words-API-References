...
description: "Указывает возможные позиции для делений оси в Java."
type: docs
weight: 32
url: /ru/java/com.aspose.words/axistickmark/
---
...
| Поле | Описание |
| --- | --- |
| [CROSS](#CROSS) | Указывает, что деления оси должны пересекать ось. |
| [INSIDE](#INSIDE) | Указывает, что деления оси должны находиться внутри области построения. |
| [NONE](#NONE) | Указывает, что делений оси не будет. |
| [OUTSIDE](#OUTSIDE) | Указывает, что деления оси должны находиться за пределами области построения. |
| [length](#length) |  |
## Методы
...
Указывает, что деления оси должны пересекать ось.
...
Указывает, что деления оси должны находиться внутри области построения.
...
Указывает, что делений оси не будет.
...
Указывает, что деления оси должны находиться за пределами области построения.
