...
description: "Содержит информацию о предупреждении о замене шрифта, выданном Aspose.Words во время загрузки или сохранения документа в Java."
type: docs
weight: 338
url: /ru/java/com.aspose.words/fontsubstitutionwarninginfo/
---
...
Содержит информацию о предупреждении о замене шрифта, выданном Aspose.Words во время загрузки или сохранения документа.
...
| [getReason()](#getReason) | Причина замены шрифта. |
| [getRequestedBold()](#getRequestedBold) | Указывает, был ли запрошен полужирный стиль. |
| [getRequestedFamilyName()](#getRequestedFamilyName) | Запрошенное название семейства шрифтов. |
| [getRequestedItalic()](#getRequestedItalic) | Указывает, был ли запрошен курсивный стиль. |
| [getResolvedFont()](#getResolvedFont) | Разрешённый шрифт. |
...
**Returns:**
int — соответствующее значение типа int. Возвращаемое значение является одной из констант [FontSubstitutionReason](../../com.aspose.words/fontsubstitutionreason/).
