...
description: "Реализует поле TOC в Java."
type: docs
weight: 298
...
Создаёт оглавление (которое также может быть списком иллюстраций), используя записи, указанные полями TC, их уровни заголовков и заданные стили, и вставляет эту таблицу в указанное место документа.

 **Examples:** 

Показывает, как вставить TOC и заполнить его записями на основе стилей заголовков.
...
| [getCaptionlessTableOfFiguresLabel()](#getCaptionlessTableOfFiguresLabel) | Получает имя идентификатора последовательности, используемого при построении списка иллюстраций, который не включает метку и номер подписи. |
...
| [getEntryIdentifier()](#getEntryIdentifier) | Получает строку, которая должна соответствовать идентификаторам типов полей TC, включаемых в документ. |
| [getEntryLevelRange()](#getEntryLevelRange) | Получает диапазон уровней записей оглавления, которые будут включены. |
| [getEntrySeparator()](#getEntrySeparator) | Получает последовательность символов, разделяющих запись и её номер страницы. |
...
| [getHideInWebLayout()](#getHideInWebLayout) | Получает, следует ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки. |
| [getInsertHyperlinks()](#getInsertHyperlinks) | Получает, следует ли делать записи оглавления гиперссылками. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getPageNumberOmittingLevelRange()](#getPageNumberOmittingLevelRange) | Получает диапазон уровней записей оглавления, для которых следует опустить номера страниц. |
| [getPrefixedSequenceIdentifier()](#getPrefixedSequenceIdentifier) | Получает идентификатор последовательности, к номеру страницы записи которой следует добавить префикс. |
| [getPreserveLineBreaks()](#getPreserveLineBreaks) | Получает, следует ли сохранять символы новой строки внутри записей таблицы. |
| [getPreserveTabs()](#getPreserveTabs) | Получает, следует ли сохранять табуляцию внутри записей таблицы. |
...
| [getTableOfFiguresLabel()](#getTableOfFiguresLabel) | Получает имя идентификатора последовательности, используемого при построении списка иллюстраций. |
| [getType()](#getType) | Получает тип поля Microsoft Word. |
| [getUseParagraphOutlineLevel()](#getUseParagraphOutlineLevel) | Получает, следует ли использовать применённый уровень структуры абзаца. |
...
| [setCaptionlessTableOfFiguresLabel(String value)](#setCaptionlessTableOfFiguresLabel-java.lang.String) | Устанавливает имя идентификатора последовательности, используемого при построении списка иллюстраций без метки и номера подписи. |
| [setCustomStyles(String value)](#setCustomStyles-java.lang.String) | Устанавливает список стилей, отличных от встроенных стилей заголовков, для включения в оглавление. |
| [setEntryIdentifier(String value)](#setEntryIdentifier-java.lang.String) | Устанавливает строку, которая должна соответствовать идентификаторам типов полей TC, включаемых в документ. |
| [setEntryLevelRange(String value)](#setEntryLevelRange-java.lang.String) | Устанавливает диапазон уровней записей оглавления, которые будут включены. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Устанавливает последовательность символов, разделяющих запись и её номер страницы. |
...
| [setHideInWebLayout(boolean value)](#setHideInWebLayout-boolean) | Устанавливает, следует ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки. |
...
| [setPageNumberOmittingLevelRange(String value)](#setPageNumberOmittingLevelRange-java.lang.String) | Устанавливает диапазон уровней записей оглавления, для которых следует опустить номера страниц. |
| [setPrefixedSequenceIdentifier(String value)](#setPrefixedSequenceIdentifier-java.lang.String) | Устанавливает идентификатор последовательности, к номеру страницы записи которой следует добавить префикс. |
| [setPreserveLineBreaks(boolean value)](#setPreserveLineBreaks-boolean) | Устанавливает, следует ли сохранять символы новой строки внутри записей таблицы. |
| [setPreserveTabs(boolean value)](#setPreserveTabs-boolean) | Устанавливает, следует ли сохранять табуляцию внутри записей таблицы. |
...
| [setTableOfFiguresLabel(String value)](#setTableOfFiguresLabel-java.lang.String) | Устанавливает имя идентификатора последовательности, используемого при построении списка иллюстраций. |
| [setUseParagraphOutlineLevel(boolean value)](#setUseParagraphOutlineLevel-boolean) | Устанавливает, использовать ли применённый уровень структуры абзаца. |
...
Получает имя идентификатора последовательности, используемого при построении списка иллюстраций, который не включает метку и номер подписи.

 **Examples:** 

Показывает, как установить имя идентификатора последовательности.
...
**Returns:**
java.lang.String - Имя идентификатора последовательности, используемого при построении списка иллюстраций, который не включает метку и номер подписи.
...
**Returns:**
java.lang.String - Список стилей, отличных от встроенных стилей заголовков, которые следует включить в оглавление.
...
Получает строку, которая должна соответствовать идентификаторам типов полей TC, включаемых в документ.
...
**Returns:**
java.lang.String - Строка, которая должна соответствовать типовым идентификаторам полей TC, включаемых в документ.
...
Получает диапазон уровней записей оглавления, которые будут включены.
...
**Returns:**
java.lang.String - Диапазон уровней записей оглавления, которые следует включить.
...
Получает последовательность символов, разделяющих запись и её номер страницы.
...
**Returns:**
java.lang.String - Последовательность символов, разделяющих запись и её номер страницы.
...
Получает, следует ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки.
...
**Returns:**
boolean - Нужно ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки.
...
Получает, следует ли делать записи оглавления гиперссылками.
...
**Returns:**
boolean - Нужно ли делать записи оглавления гиперссылками.
...
Получает диапазон уровней записей оглавления, для которых следует опустить номера страниц.
...
**Returns:**
java.lang.String - Диапазон уровней записей оглавления, из которых следует опустить номера страниц.
...
Получает идентификатор последовательности, к номеру страницы записи которой следует добавить префикс.
...
**Returns:**
java.lang.String - Идентификатор последовательности, к номеру страницы которой следует добавить префикс.
...
Получает, следует ли сохранять символы новой строки внутри записей таблицы.
...
**Returns:**
boolean - Нужно ли сохранять символы новой строки внутри записей таблицы.
...
Получает, следует ли сохранять табуляцию внутри записей таблицы.
...
**Returns:**
boolean - Нужно ли сохранять табуляцию внутри записей таблицы.
### getResult() {#getResult}
```
...
Получает имя идентификатора последовательности, используемого при построении списка иллюстраций.
...
**Returns:**
java.lang.String - Имя идентификатора последовательности, используемого при построении списка иллюстраций.
### getType() {#getType}
```
public int getType()
```
...
Получает, следует ли использовать применённый уровень структуры абзаца.
...
**Returns:**
boolean - Нужно ли использовать применённый уровень структуры абзаца.
### isDirty() {#isDirty}
```
...
Устанавливает имя идентификатора последовательности, используемого при построении списка иллюстраций без метки и номера подписи.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя идентификатора последовательности, используемого при построении списка иллюстраций, который не включает метку и номер подписи. |
...
Устанавливает список стилей, отличных от встроенных стилей заголовков, для включения в оглавление.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Список стилей, отличных от встроенных стилей заголовков, которые следует включить в оглавление. |
...
Устанавливает строку, которая должна соответствовать идентификаторам типов полей TC, включаемых в документ.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Строка, которая должна соответствовать типовым идентификаторам включаемых полей TC. |
...
Устанавливает диапазон уровней записей оглавления, которые будут включены.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Диапазон уровней записей оглавления, которые следует включить. |
...
Устанавливает последовательность символов, разделяющих запись и её номер страницы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Последовательность символов, разделяющих запись и её номер страницы. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Диапазон уровней заголовков для включения. |
...
Устанавливает, следует ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли скрывать лидеры табуляции и номера страниц в представлении веб‑разметки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли делать записи оглавления гиперссылками. |
...
Устанавливает диапазон уровней записей оглавления, для которых следует опустить номера страниц.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Диапазон уровней записей оглавления, для которых следует опускать номера страниц. |
...
Устанавливает идентификатор последовательности, к номеру страницы записи которой следует добавить префикс.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор последовательности, для которой к номеру страницы записи следует добавить префикс. |
...
Устанавливает, следует ли сохранять символы новой строки внутри записей таблицы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли сохранять символы переноса строки внутри записей таблицы. |
...
Устанавливает, следует ли сохранять табуляцию внутри записей таблицы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли сохранять табуляцию внутри записей таблицы. |
...
Устанавливает имя идентификатора последовательности, используемого при построении списка иллюстраций.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя идентификатора последовательности, используемого при построении списка иллюстраций. |
...
Устанавливает, использовать ли применённый уровень структуры абзаца.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли использовать применённый уровень структуры абзаца. |
...
**Returns:**
boolean -  true  если операция успешна. Если любой из связанных закладок ОГС был удалён,  false  будет возвращено.
