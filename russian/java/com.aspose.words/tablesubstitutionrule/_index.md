...
description: "Правило замены шрифтов таблицы в Java."
type: docs
weight: 662
...
Правило замены шрифтов в таблице.

Чтобы узнать больше, посетите статью документации [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Это правило определяет список заменяющих названий шрифтов, которые будут использоваться, если оригинальный шрифт недоступен. Замены будут проверяться по названию шрифта и методу [FontInfo.getAltName()](../../com.aspose.words/fontinfo/\#getAltName) / [FontInfo.setAltName(java.lang.String)](../../com.aspose.words/fontinfo/\#setAltName-java.lang.String) (если таковые имеются).
...
| Метод | Описание |
| --- | --- |
| [addSubstitutes(String originalFontName, String[] substituteFontNames)](#addSubstitutes-java.lang.String-java.lang.String...) | Добавляет заменяющие названия шрифтов для указанного оригинального названия шрифта. |
| [getEnabled()](#getEnabled) | Указывает, включено ли правило. |
| [getSubstitutes(String originalFontName)](#getSubstitutes-java.lang.String) | Возвращает массив, содержащий заменяющие названия шрифтов для указанного оригинального названия шрифта. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | Загружает настройки замены таблицы из XML‑файла. |
...
| [save(String fileName)](#save-java.lang.String) | Сохраняет текущие настройки замены таблицы в файл. |
| [setEnabled(boolean value)](#setEnabled-boolean) | Указывает, включено ли правило. |
| [setSubstitutes(String originalFontName, String[] substituteFontNames)](#setSubstitutes-java.lang.String-java.lang.String...) | Переопределяет заменяющие названия шрифтов для указанного оригинального названия шрифта. |
...
Добавляет заменяющие названия шрифтов для указанного оригинального названия шрифта.
...
Возвращает массив, содержащий заменяющие названия шрифтов для указанного оригинального названия шрифта.
...
**Returns:**
java.lang.Iterable - Список альтернативных названий шрифтов.
### load(InputStream stream) {#load-java.io.InputStream}
```
...
Загружает предопределённые настройки замены таблицы для платформы Android.
...
Загружает предопределённые настройки замены таблицы для платформы Linux.
...
Переопределяет заменяющие названия шрифтов для указанного оригинального названия шрифта.
