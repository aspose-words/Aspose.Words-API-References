...
| [getText()](#getText--) | Получает текст для извлечения. |
...
| [setText(String value)](#setText-java.lang.String-) | Устанавливает текст для извлечения. |
| [toString()](#toString--) |  |
...
Получает текст для извлечения.

**Возвращает:**
java.lang.String — текст для извлечения.
### getType() {#getType--}
```
public int getType()
```
...
Устанавливает текст для извлечения.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст, который необходимо получить. |
