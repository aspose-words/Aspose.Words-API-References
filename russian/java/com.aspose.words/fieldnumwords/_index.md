...
description: Реализует поле NUMWORDS.
type: docs
weight: 225
url: /ru/java/com.aspose.words/fieldnumwords/
---
...
Реализует поле NUMWORDS.

 Чтобы узнать больше, посетите**Working with Fields** документальная статья.

 Извлекает количество слов в текущем документе, записанное в**Words** свойство встроенных свойств документа.
## Методы
