...
description: Предоставляет методы для рендеринга человека в растровое или векторное изображение или в объект Graphics.
type: docs
weight: 423
...
```
 ...
 Предоставляет методы для отображения отдельных[OfficeMath](../../com.aspose.words/officemath) в растровое или векторное изображение или в объект Graphics.
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath) | Объект OfficeMath, который вы хотите визуализировать. |
