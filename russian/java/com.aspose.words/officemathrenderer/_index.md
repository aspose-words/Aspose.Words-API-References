...
description: "Предоставляет методы для рендеринга отдельного OfficeMath в растровое или векторное изображение или в объект Graphics в Java."
type: docs
weight: 499
url: /ru/java/com.aspose.words/officemathrenderer/
---
...
Предоставляет методы для рендеринга отдельного [OfficeMath](../../com.aspose.words/officemath/) в растровое или векторное изображение или в объект Graphics.

Чтобы узнать больше, посетите статью документации [ Working with OfficeMath ][Working with OfficeMath].
...
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | Объект [OfficeMath](../../com.aspose.words/officemath/), который вы хотите отобразить. |
