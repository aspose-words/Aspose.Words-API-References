...
description: "Указывает тип календаря в Java."
type: docs
weight: 58
url: /ru/java/com.aspose.words/calendartype/
---
...
Показывает, как автоматически применять пользовательский формат к результатам полей при их обновлении.
...
| Поле | Описание |
| --- | --- |
| [GREGORIAN](#GREGORIAN) | Григорианский календарь. |
| [HEBREW](#HEBREW) | Еврейский лунный календарь. |
| [HIJRI](#HIJRI) | Хиджра (исламский) лунный календарь. |
| [SAKA_ERA](#SAKA-ERA) | Календарь Сака эры. |
| [UM_AL_QURA](#UM-AL-QURA) | Календарь Ум-аль-Кура. |
| [length](#length) |  |
## Методы
...
Хиджра (исламский) лунный календарь.
