...
type: docs
weight: 471
url: /ru/java/com.aspose.words/pssaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.PS](../../com.aspose.words/saveformat\#PS) формат.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть только[SaveFormat.PS](../../com.aspose.words/saveformat\#PS).
