...
description: "Когда реализовано, предоставляет объект CultureInfo, который следует использовать при обновлении конкретного поля в Java."
type: docs
weight: 767
...
Когда реализовано, предоставляет объект [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/), который следует использовать при обновлении конкретного поля.

 **Examples:** 

Показывает, как указать культуру, которая разбирает формат даты/времени для каждого поля.
...
| Метод | Описание |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | Возвращает объект [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/), который будет использоваться при обновлении поля. |
...
Возвращает объект [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/), который будет использоваться при обновлении поля.
...
| --- | --- | --- |
| culture | java.lang.String | Имя культуры, запрашиваемой для обновляемого поля. |
| field | [Field](../../com.aspose.words/field/) | Поле, которое обновляется. |
