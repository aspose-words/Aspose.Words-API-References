...
description: "Реализует поле USERADDRESS в Java."
type: docs
weight: 303
url: /ru/java/com.aspose.words/fielduseraddress/
---
...
| [getUserAddress()](#getUserAddress) | Получает почтовый адрес текущего пользователя. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | Устанавливает почтовый адрес текущего пользователя. |
...
**Returns:**
java.lang.String - Почтовый адрес текущего пользователя.
### isDirty() {#isDirty}
```
...
Устанавливает почтовый адрес текущего пользователя.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Почтовый адрес текущего пользователя. |
