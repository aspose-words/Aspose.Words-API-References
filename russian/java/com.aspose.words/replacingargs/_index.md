...
description: "Предоставляет данные для пользовательской операции замены в Java."
type: docs
weight: 569
...
| Метод | Описание |
| --- | --- |
| [getGroupIndex()](#getGroupIndex) | Определяет, по индексу, захваченную группу в [getMatch()](../../com.aspose.words/replacingargs/\#getMatch), которую следует заменить строкой, получаемой из [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String). |
| [getMatch()](#getMatch) | Объект java.util.regex.Matcher, полученный в результате одного совпадения регулярного выражения во время **Replace**. |
| [getMatchEndNode()](#getMatchEndNode) | Получает узел, содержащий конец совпадения. |
| [getMatchNode()](#getMatchNode) | Получает узел, содержащий начало совпадения. |
| [getMatchOffset()](#getMatchOffset) | Получает начальную позицию, отсчитываемую с нуля, совпадения от начала узла, содержащего начало совпадения. |
| [getReplacement()](#getReplacement) | Получает строку замены. |
| [setGroupIndex(int value)](#setGroupIndex-int) | Определяет, по индексу, захваченную группу в [getMatch()](../../com.aspose.words/replacingargs/\#getMatch), которую следует заменить строкой, получаемой из [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String). |
...
Определяет, по индексу, захваченную группу в [getMatch()](../../com.aspose.words/replacingargs/\#getMatch), которую следует заменить строкой, получаемой из [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String).
...
Объект java.util.regex.Matcher, полученный в результате одного совпадения регулярного выражения во время **Replace**.

 **Remarks:** 

Matcher.start() получает начальную позицию, отсчитываемую с нуля, совпадения от начала диапазона поиска и замены.
...
Получает узел, содержащий конец совпадения.

 **Examples:** 

Показывает, как получить конечный узел совпадения.
...
Получает начальную позицию, отсчитываемую с нуля, совпадения от начала узла, содержащего начало совпадения.
...
**Returns:**
int - Нулевой (нумерация с нуля) начальная позиция совпадения от начала узла, содержащего начало совпадения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Строка замены. |
