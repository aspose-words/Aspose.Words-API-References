...
description: "Представляет конец закладки в документе Word на Java."
type: docs
weight: 43
...
Используйте класс [Bookmark](../../com.aspose.words/bookmark/) в качестве "фасада" для работы с закладкой как с единым объектом.
...
| --- | --- |
| [BookmarkEnd(DocumentBase doc, String name)](#BookmarkEnd-com.aspose.words.DocumentBase-java.lang.String) | Инициализирует новый экземпляр класса [BookmarkEnd](../../com.aspose.words/bookmarkend/). |
## Методы
...
Инициализирует новый экземпляр класса [BookmarkEnd](../../com.aspose.words/bookmarkend/).
...
Вызывает [DocumentVisitor.visitBookmarkEnd(com.aspose.words.BookmarkEnd)](../../com.aspose.words/documentvisitor/\#visitBookmarkEnd-com.aspose.words.BookmarkEnd).
...
**Returns:**
int — [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
