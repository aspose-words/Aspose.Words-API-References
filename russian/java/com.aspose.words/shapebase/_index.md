...
description: Базовый класс для объектов в слое рисования, таких как элемент управления ActiveX OLE-объекта произвольной формы AutoShape или изображение.
type: docs
weight: 517
url: /ru/java/com.aspose.words/shapebase/
---
...
Базовый класс для объектов на уровне рисования, таких как AutoShape, произвольная форма, объект OLE, элемент управления ActiveX или изображение.

 Чтобы узнать больше, посетите**Working with Shapes** документальная статья.

 Это абстрактный класс. Два производных класса, которые вы можете создать:[Shape](../../com.aspose.words/shape) а также[GroupShape](../../com.aspose.words/groupshape).

Фигура — это узел в дереве документа.

 Если фигура является потомком[Paragraph](../../com.aspose.words/paragraph)объекта, то говорят, что фигура находится на «верхнем уровне». Фигуры верхнего уровня измеряются и располагаются в точках.

 Фигура также может быть потомком[GroupShape](../../com.aspose.words/groupshape) объект, когда несколько фигур сгруппированы. Дочерние фигуры групповой фигуры располагаются в координатном пространстве и единицах измерения, определенных[getCoordSize()](../../com.aspose.words/shapebase\#getCoordSize--) / [setCoordSize(java.awt.Dimension)](../../com.aspose.words/shapebase\#setCoordSize-java.awt.Dimension-) а также[getCoordOrigin()](../../com.aspose.words/shapebase\#getCoordOrigin--) / [setCoordOrigin(java.awt.Point)](../../com.aspose.words/shapebase\#setCoordOrigin-java.awt.Point-) свойства формы родительской группы.

 Фигура может быть встроена в текст или плавать. Метод позиционирования управляется с помощью[getWrapType()](../../com.aspose.words/shapebase\#getWrapType--) / [setWrapType(int)](../../com.aspose.words/shapebase\#setWrapType-int-) имущество.

 Когда фигура плавает, она позиционируется относительно чего-либо (например, текущего абзаца, поля или страницы). Относительное расположение фигуры задается с помощью[getRelativeHorizontalPosition()](../../com.aspose.words/shapebase\#getRelativeHorizontalPosition--) / [setRelativeHorizontalPosition(int)](../../com.aspose.words/shapebase\#setRelativeHorizontalPosition-int-) а также[getRelativeVerticalPosition()](../../com.aspose.words/shapebase\#getRelativeVerticalPosition--) / [setRelativeVerticalPosition(int)](../../com.aspose.words/shapebase\#setRelativeVerticalPosition-int-) характеристики.

 Плавающая фигура может быть позиционирована явно с помощью[getLeft()](../../com.aspose.words/shapebase\#getLeft--) / [setLeft(double)](../../com.aspose.words/shapebase\#setLeft-double-) а также[getTop()](../../com.aspose.words/shapebase\#getTop--) / [setTop(double)](../../com.aspose.words/shapebase\#setTop-double-) свойства или выровнены относительно какого-либо другого объекта с помощью[getHorizontalAlignment()](../../com.aspose.words/shapebase\#getHorizontalAlignment--) / [setHorizontalAlignment(int)](../../com.aspose.words/shapebase\#setHorizontalAlignment-int-) а также[getVerticalAlignment()](../../com.aspose.words/shapebase\#getVerticalAlignment--) / [setVerticalAlignment(int)](../../com.aspose.words/shapebase\#setVerticalAlignment-int-) характеристики.
## Методы
