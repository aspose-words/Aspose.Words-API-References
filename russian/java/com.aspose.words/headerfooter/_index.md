...
description: Представляет контейнер для текста верхнего или нижнего колонтитула раздела.
type: docs
weight: 315
url: /ru/java/com.aspose.words/headerfooter/
---
...
**HeaderFooter** может содержать**Paragraph** а также**Table** дочерние узлы.

**HeaderFooter** является узлом уровня раздела и может быть только потомком**Section** . Может быть только один**HeaderFooter** или каждый[getHeaderFooterType()](../../com.aspose.words/headerfooter\#getHeaderFooterType--) в**Section**.

 Если**Section** не имеет**HeaderFooter** определенного вида или**HeaderFooter**не имеет дочерних узлов, этот верхний/нижний колонтитул считается связанным с верхним/нижним колонтитулом того же типа, что и предыдущий раздел в Microsoft Word.

 Когда**HeaderFooter** содержит по крайней мере один**Paragraph**, он больше не считается связанным с предыдущим в Microsoft Word.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [HeaderFooter(DocumentBase doc, int headerFooterType)](#HeaderFooter-com.aspose.words.DocumentBase-int-) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [appendParagraph(String text)](#appendParagraph-java.lang.String-) |  Быстрый метод, который создает[Paragraph](../../com.aspose.words/paragraph)объект с необязательным текстом и добавляет его в конец этого объекта. |
| [dd()](#dd--) |  |
...
| [getHeaderFooterType()](#getHeaderFooterType--) | Получает тип этого верхнего/нижнего колонтитула. |
...
| [getNodeType()](#getNodeType--) |  Возвращает**NodeType.HeaderFooter**. |
...
| [getParentSection()](#getParentSection--) | Получает родительский раздел этой истории. |
...
| [getStoryType()](#getStoryType--) | Получает тип этой истории. |
...
| [isHeader()](#isHeader--) |  Правда, если это**HeaderFooter** объект является заголовком. |
| [isLinkedToPrevious()](#isLinkedToPrevious--) | Истинно, если этот верхний или нижний колонтитул связан с соответствующим верхним или нижним колонтитулом в предыдущем разделе. |
| [isLinkedToPrevious(boolean value)](#isLinkedToPrevious-boolean-) | Истинно, если этот верхний или нижний колонтитул связан с соответствующим верхним или нижним колонтитулом в предыдущем разделе. |
...
**Возвращает:**
boolean - Истинно, если были посещены все узлы; false, если DocumentVisitor остановил операцию перед посещением всех узлов. Вызывает DocumentVisitor.VisitHeaderFooterStart, затем вызывает Accept для всех дочерних узлов раздела и в конце вызывает DocumentVisitor.VisitHeaderFooterEnd.
...
```
 ...
 Быстрый метод, который создает[Paragraph](../../com.aspose.words/paragraph)объект с необязательным текстом и добавляет его в конец этого объекта.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| text | java.lang.String | Текст для абзаца. Может быть нулевой или пустой строкой. |

**Возвращает:**
[Paragraph](../../com.aspose.words/paragraph) - Вновь созданный и добавленный абзац.
### dd() {#dd--}
```
public void dd()
```
...
**Возвращает:**
 int - Тип этого верхнего/нижнего колонтитула. Возвращаемое значение является одним из[HeaderFooterType](../../com.aspose.words/headerfootertype) константы.
...
**Возвращает:**
 инт -**NodeType.HeaderFooter** . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
...
**ParentSection** эквивалентен (Section)ParentNode .

**Возвращает:**
[Section](../../com.aspose.words/section) - Родительский раздел этой истории.
...
**Возвращает:**
 int - Тип этой истории. Возвращаемое значение является одним из[StoryType](../../com.aspose.words/storytype) константы.
### getTables() {#getTables--}
```
...
```
 ...
 Правда, если это**HeaderFooter** объект является заголовком.
