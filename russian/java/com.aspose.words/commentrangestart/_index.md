...
description: Обозначает начало области текста, с которой связан комментарий.
type: docs
weight: 80
url: /ru/java/com.aspose.words/commentrangestart/
---
...
[CommentRangeStart](../../com.aspose.words/commentrangestart) является узлом встроенного уровня и может быть только потомком[Paragraph](../../com.aspose.words/paragraph).
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int-) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [getNodeType()](#getNodeType--) |  Возвращает[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START). |
...
Инициализирует новый экземпляр этого класса.
 ...
 Когда[CommentRangeStart](../../com.aspose.words/commentrangestart) создан, он принадлежит указанному документу, но еще не является его частью и[Node.getParentNode()](../../com.aspose.words/node\#getParentNode--) нулевой.

 Чтобы добавить[CommentRangeStart](../../com.aspose.words/commentrangestart) к документу используйте InsertAfter или InsertBefore для абзаца, в который вы хотите вставить комментарий.
...
Принимает посетителя.
 ...
 Звонки[DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor\#visitCommentRangeStart-com.aspose.words.CommentRangeStart-).
...
```
 ...
 Возвращает[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START).

**Возвращает:**
 инт -\{[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START) . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
### getParentIdInternal() {#getParentIdInternal--}
```
