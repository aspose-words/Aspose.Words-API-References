...
description: "Реализует поле AUTHOR в Java."
type: docs
weight: 200
url: /ru/java/com.aspose.words/fieldauthor/
---
...
Получает и, при необходимости, задает имя автора документа, как записано в свойстве **Author** встроенных свойств документа.
...
| Метод | Описание |
| --- | --- |
| [getAuthorName()](#getAuthorName) | Получает имя автора документа. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Устанавливает имя автора документа. |
