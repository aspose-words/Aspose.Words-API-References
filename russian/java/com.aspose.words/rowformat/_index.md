...
description: "Представляет все форматирование строки таблицы в Java."
type: docs
weight: 590
...
Представляет всё форматирование строки таблицы.
...
| Метод | Описание |
| --- | --- |
| [clearFormatting()](#clearFormatting) | Сбрасывает форматирование строки до значений по умолчанию. |
| [fetchInheritedBorderAttr(int key)](#fetchInheritedBorderAttr-int) |  |
| [getAllowBreakAcrossPages()](#getAllowBreakAcrossPages) | Истина, если текст в строке таблицы разрешено разбивать при разрыве страницы. |
| [getBorders()](#getBorders) | Получает коллекцию границ ячеек по умолчанию для строки. |
| [getDirectBorderAttr(int key)](#getDirectBorderAttr-int) |  |
| [getHeadingFormat()](#getHeadingFormat) | Истина, если строка повторяется в качестве заголовка таблицы на каждой странице, когда таблица занимает более одной страницы. |
...
| [setAllowBreakAcrossPages(boolean value)](#setAllowBreakAcrossPages-boolean) | Истина, если текст в строке таблицы разрешено разбивать при разрыве страницы. |
| [setBorderAttr(int key, Object value)](#setBorderAttr-int-java.lang.Object) |  |
| [setHeadingFormat(boolean value)](#setHeadingFormat-boolean) | Истина, если строка повторяется в качестве заголовка таблицы на каждой странице, когда таблица занимает более одной страницы. |
| [setHeight(double value)](#setHeight-double) | Устанавливает высоту строки таблицы в пунктах. |
| [setHeightRule(int value)](#setHeightRule-int) | Устанавливает правило определения высоты строки таблицы. |
...
Сбрасывает форматирование строки до значений по умолчанию.
...
Истина, если текст в строке таблицы разрешено разбивать при разрыве страницы.

 **Examples:** 

Показывает, как отключить разбиение строк таблицы по страницам для каждой строки.
...
**Returns:**
int - Правило определения высоты строки таблицы. Возвращаемое значение является одним из констант [HeightRule](../../com.aspose.words/heightrule/).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | double | Высота строки таблицы в пунктах. |
...
Устанавливает правило определения высоты строки таблицы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Правило определения высоты строки таблицы. Значение должно быть одной из констант [HeightRule](../../com.aspose.words/heightrule/). |
