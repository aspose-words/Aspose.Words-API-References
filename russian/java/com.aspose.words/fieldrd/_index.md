...
Идентифицирует файл, который необходимо включить при создании оглавления, авторитетной таблицы или указателя с полем TOC, TOA или INDEX.
## Методы
...
| [getFileName()](#getFileName--) | Получает имя файла для включения при создании оглавления, авторитетной таблицы или указателя. |
...
| [isPathRelative()](#isPathRelative--) | Получает, является ли путь относительным к текущему документу. |
...
| [setFileName(String value)](#setFileName-java.lang.String-) | Устанавливает имя файла для включения при создании оглавления, авторитетной таблицы или указателя. |
...
Получает имя файла для включения при создании оглавления, авторитетной таблицы или указателя.

**Возвращает:**
java.lang.String — имя файла для включения при создании оглавления, авторитетной таблицы или указателя.
### getFormat() {#getFormat--}
```
...
Получает, является ли путь относительным к текущему документу.

**Возвращает:**
boolean — Относится ли путь к текущему документу.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Относится ли путь к текущему документу. |
...
Устанавливает имя файла для включения при создании оглавления, авторитетной таблицы или указателя.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя файла для включения при создании оглавления, авторитетной таблицы или указателя. |
