...
description: "Реализует поле RD в Java."
type: docs
weight: 277
url: /ru/java/com.aspose.words/fieldrd/
---
...
Определяет файл, который следует включить при создании оглавления, списка ссылок или указателя с помощью полей TOC, TOA или INDEX.
...
| [getFileName()](#getFileName) | Возвращает имя файла, который следует включить при генерации оглавления, списка ссылок или указателя. |
...
| [isPathRelative()](#isPathRelative) | Возвращает, является ли путь относительным к текущему документу. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Устанавливает, является ли путь относительным к текущему документу. |
| [remove()](#remove) | Удаляет поле из документа. |
| [setFileName(String value)](#setFileName-java.lang.String) | Устанавливает имя файла, который следует включить при генерации оглавления, списка ссылок или указателя. |
...
Возвращает имя файла, который следует включить при генерации оглавления, списка ссылок или указателя.
...
**Returns:**
java.lang.String — Имя файла, который следует включить при генерации оглавления, списка ссылок или указателя.
### getFormat() {#getFormat}
```
...
Возвращает, является ли путь относительным к текущему документу.
...
**Returns:**
boolean — Является ли путь относительным к текущему документу.
### isPathRelative(boolean value) {#isPathRelative-boolean}
```
public void isPathRelative(boolean value)
```


Устанавливает, является ли путь относительным к текущему документу.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Является ли путь относительным к текущему документу? |
...
Устанавливает имя файла, который следует включить при генерации оглавления, списка ссылок или указателя.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя файла, который следует включить при генерации оглавления, списка ссылок или указателя. |
