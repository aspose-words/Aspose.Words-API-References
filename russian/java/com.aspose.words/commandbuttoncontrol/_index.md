...
description: "Элемент управления CommandButton запускает макрос, который выполняет действие, когда пользователь нажимает его в Java."
type: docs
weight: 107
url: /ru/java/com.aspose.words/commandbuttoncontrol/
---
...
Элемент управления CommandButton запускает макрос, выполняющий действие при щелчке пользователя.
...
| --- | --- |
| [CommandButtonControl()](#CommandButtonControl) | Инициализирует новый экземпляр класса [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/). |
## Методы
...
Инициализирует новый экземпляр класса [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/).
