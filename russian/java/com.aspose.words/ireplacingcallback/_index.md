...
description: "Реализуйте этот интерфейс, если вы хотите иметь собственный пользовательский метод, вызываемый во время операции поиска и замены в Java."
type: docs
weight: 781
...
Реализуйте этот интерфейс, если вы хотите иметь собственный пользовательский метод, вызываемый во время операции поиска и замены.
...
| Метод | Описание |
| --- | --- |
| [replacing(ReplacingArgs args)](#replacing-com.aspose.words.ReplacingArgs) | Пользовательский метод, вызываемый во время операции замены для каждого найденного совпадения непосредственно перед выполнением замены. |
...
Пользовательский метод, вызываемый во время операции замены для каждого найденного совпадения непосредственно перед выполнением замены.
...
**Returns:**
int — значение [ReplaceAction](../../com.aspose.words/replaceaction/), указывающее действие, которое следует выполнить для текущего совпадения. Возвращаемое значение является одной из констант [ReplaceAction](../../com.aspose.words/replaceaction/).
