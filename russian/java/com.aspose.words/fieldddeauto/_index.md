...
Для информации, скопированной из другого приложения, это поле связывает эту информацию с исходным исходным файлом с помощью DDE и автоматически обновляется.
## Методы
