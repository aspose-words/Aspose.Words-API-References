...
description: "Реализует поле DDEAUTO в Java."
type: docs
weight: 222
url: /ru/java/com.aspose.words/fieldddeauto/
---
...
Реализует поле DDEAUTO.

Чтобы узнать больше, посетите статью документации [ Working with Fields ][Working with Fields].

 **Remarks:** 

Для информации, скопированной из другого приложения, это поле связывает её с оригинальным файлом‑источником с помощью DDE и обновляется автоматически.
