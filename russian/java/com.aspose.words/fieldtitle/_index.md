...
description: "Реализует поле TITLE в Java."
type: docs
weight: 296
url: /ru/java/com.aspose.words/fieldtitle/
---
...
Получает и, при необходимости, задает заголовок документа, как записано в свойстве **Title** встроенных свойств документа.
...
| [getText()](#getText) | Получает текст заголовка. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст заголовка. |
...
**Returns:**
java.lang.String — Текст заголовка.
### getType() {#getType}
```
public int getType()
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст заголовка. |
