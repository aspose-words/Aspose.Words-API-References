...
description: Реализует поле TITLE.
type: docs
weight: 253
...
Реализует поле TITLE.
 ...
 Извлекает и, при необходимости, устанавливает заголовок документа, записанный в**Title** свойство встроенных свойств документа.
## Методы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст заголовка. |
