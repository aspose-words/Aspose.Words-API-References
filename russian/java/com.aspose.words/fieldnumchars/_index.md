...
description: "Реализует поле NUMCHARS в Java."
type: docs
weight: 266
url: /ru/java/com.aspose.words/fieldnumchars/
---
...
Получает количество символов в текущем документе, как записано в свойстве **Characters** встроенных свойств документа.
