...
description: "Реализует поле BIDIOUTLINE в Java."
type: docs
weight: 208
url: /ru/java/com.aspose.words/fieldbidioutline/
---
...
Это поле идентично полю AUTONUMLGL, за исключением разделителя, который ограничивает каждый уровень нумерации абзацев.
