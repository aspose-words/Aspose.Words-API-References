...
type: docs
weight: 137
url: /ru/java/com.aspose.words/editablerangeend/
---
...
Представляет конец редактируемого диапазона в документе Word.
 ...
 Полный редактируемый диапазон в документе Word состоит из[getEditableRangeStart()](../../com.aspose.words/editablerangeend\#getEditableRangeStart--) и соответствие[EditableRangeEnd](../../com.aspose.words/editablerangeend) с тем же идентификатором.

[getEditableRangeStart()](../../com.aspose.words/editablerangeend\#getEditableRangeStart--) а также[EditableRangeEnd](../../com.aspose.words/editablerangeend) являются просто маркерами внутри документа, которые указывают, где начинается и заканчивается редактируемый диапазон.

 Использовать[EditableRange](../../com.aspose.words/editablerange) class как «фасад» для работы с редактируемым диапазоном как с единым объектом.
...
| [getEditableRangeStart()](#getEditableRangeStart--) | Соответствующий EditableRangeStart, полученный по идентификатору. |
...
| [getNodeType()](#getNodeType--) |  Возвращает[NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype\#EDITABLE-RANGE-END). |
...
Принимает посетителя.
 ...
 Звонки[DocumentVisitor.visitEditableRangeEnd(com.aspose.words.EditableRangeEnd)](../../com.aspose.words/documentvisitor\#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd-).
...
Соответствующий EditableRangeStart, полученный по идентификатору.

**Возвращает:**
[EditableRangeStart](../../com.aspose.words/editablerangestart) - соответствующий[EditableRangeStart](../../com.aspose.words/editablerangestart) ценность.
### getId() {#getId--}
```
public int getId()
```
...
```
 ...
 Возвращает[NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype\#EDITABLE-RANGE-END).

**Возвращает:**
 инт -\{[NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype\#EDITABLE-RANGE-END) . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
### getParentIdInternal() {#getParentIdInternal--}
```
