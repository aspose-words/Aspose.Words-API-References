...
description: "Представляет конец редактируемого диапазона в документе Word на Java."
type: docs
weight: 180
...
Полный редактируемый диапазон в документе Word состоит из [getEditableRangeStart()](../../com.aspose.words/editablerangeend/\#getEditableRangeStart) и соответствующего [EditableRangeEnd](../../com.aspose.words/editablerangeend/) с тем же Id.
...
Используйте класс [EditableRange](../../com.aspose.words/editablerange/) как "фасад" для работы с редактируемым диапазоном как с единым объектом.
...
| [getEditableRangeStart()](#getEditableRangeStart) | Соответствующий [EditableRangeStart](../../com.aspose.words/editablerangestart/), полученный по ID. |
...
Вызывает [DocumentVisitor.visitEditableRangeEnd(com.aspose.words.EditableRangeEnd)](../../com.aspose.words/documentvisitor/\#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd).
...
Соответствующий [EditableRangeStart](../../com.aspose.words/editablerangestart/), полученный по ID.
...
**Returns:**
int — [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
