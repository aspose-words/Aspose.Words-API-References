...
description: "Обеспечивает типизированный доступ к коллекции узлов Table в Java."
type: docs
weight: 658
...
Обеспечивает типизированный доступ к коллекции узлов [Table](../../com.aspose.words/table/).
...
| [get(int index)](#get-int) | Получает [Table](../../com.aspose.words/table/) по заданному индексу. |
...
Получает [Table](../../com.aspose.words/table/) по заданному индексу.
