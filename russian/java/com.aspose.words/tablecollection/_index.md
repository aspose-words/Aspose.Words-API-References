...
type: docs
weight: 550
url: /ru/java/com.aspose.words/tablecollection/
---
...
```
 ...
 Предоставляет типизированный доступ к коллекции[Table](../../com.aspose.words/table) узлы.
...
| [get(int index)](#get-int-) |  Получает**Table** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
```
 ...
 Получает**Table** по заданному индексу.
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Table](../../com.aspose.words/table) ценность.
### getClass() {#getClass--}
```
...
**Возвращает:**
com.aspose.words.Node[] - Массив таблиц.
### toString() {#toString--}
```
