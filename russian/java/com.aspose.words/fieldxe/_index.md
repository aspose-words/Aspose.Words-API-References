...
description: "Реализует поле XE в Java."
type: docs
weight: 306
...
Определяет текст и номер страницы для записи индекса, которые используются полем INDEX.
...
| [getYomi()](#getYomi) | Получает йоми (первый фонетический символ для сортировки индексов) для записи индекса. |
...
| [setEntryType(String value)](#setEntryType-java.lang.String) | Устанавливает тип записи индекса. |
...
| [setYomi(String value)](#setYomi-java.lang.String) | Устанавливает йоми (первый фонетический символ для сортировки индексов) для записи индекса. |
...
Получает йоми (первый фонетический символ для сортировки индексов) для записи индекса.
...
**Returns:**
java.lang.String - yomi (первый фонетический символ для сортировки индексов) для записи индекса
### isBold() {#isBold}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Применять ли полужирное форматирование к номеру страницы записи. |
...
**Returns:**
boolean - Применять ли курсивное форматирование к номеру страницы записи.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Применять ли курсивное форматирование к номеру страницы записи. |
...
Устанавливает тип записи индекса.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Тип записи индекса. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст, используемый вместо номера страницы. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст записи. |
...
Устанавливает йоми (первый фонетический символ для сортировки индексов) для записи индекса.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | yomi (первый фонетический символ для сортировки индексов) для записи индекса |
