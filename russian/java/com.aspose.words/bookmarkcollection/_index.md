...
description: "Коллекция объектов Bookmark, представляющих закладки в указанном диапазоне в Java."
type: docs
weight: 42
...
Коллекция объектов [Bookmark](../../com.aspose.words/bookmark/) , представляющих закладки в указанном диапазоне.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| bookmark | [Bookmark](../../com.aspose.words/bookmark/) | Закладка для удаления. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| bookmarkName | java.lang.String | Имя закладки без учёта регистра для удаления. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| индекс | int | Нулевой индекс закладки, которую нужно удалить. |
