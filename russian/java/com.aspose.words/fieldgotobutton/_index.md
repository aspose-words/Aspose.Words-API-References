...
| [getDisplayText()](#getDisplayText--) | Получает текст «кнопки», которая появляется в документе, чтобы ее можно было выбрать для активации прыжка. |
...
| [getLocation()](#getLocation--) | Получает имя закладки, номер страницы или другой элемент для перехода. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String-) | Устанавливает текст «кнопки», отображаемой в документе, таким образом, чтобы ее можно было выбрать для активации прыжка. |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setLocation(String value)](#setLocation-java.lang.String-) | Устанавливает имя закладки, номер страницы или какой-либо другой элемент для перехода. |
...
Получает текст «кнопки», которая появляется в документе, чтобы ее можно было выбрать для активации прыжка.

**Возвращает:**
java.lang.String — текст «кнопки», которая появляется в документе, чтобы ее можно было выбрать для активации прыжка.
### getEnd() {#getEnd--}
```
...
Получает имя закладки, номер страницы или другой элемент для перехода.

**Возвращает:**
java.lang.String — имя закладки, номер страницы или какой-либо другой элемент для перехода.
### getResult() {#getResult--}
```
...
Устанавливает текст «кнопки», отображаемой в документе, таким образом, чтобы ее можно было выбрать для активации прыжка.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст «кнопки», которая появляется в документе, чтобы ее можно было выбрать для активации прыжка. |
...
Устанавливает имя закладки, номер страницы или какой-либо другой элемент для перехода.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя закладки, номер страницы или какой-либо другой элемент для перехода. |
