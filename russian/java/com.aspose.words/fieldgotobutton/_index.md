...
description: "Реализует поле GOTOBUTTON в Java."
type: docs
weight: 240
url: /ru/java/com.aspose.words/fieldgotobutton/
---
...
Вставляет команду перехода, так что при её активации точка вставки документа перемещается в указанное место.
...
| [getDisplayText()](#getDisplayText) | Получает текст "кнопки", отображаемой в документе, чтобы её можно было выбрать для активации перехода. |
...
| [getLocation()](#getLocation) | Получает имя закладки, номера страницы или другого элемента для перехода. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Устанавливает текст "кнопки", отображаемой в документе, чтобы её можно было выбрать для активации перехода. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setLocation(String value)](#setLocation-java.lang.String) | Устанавливает имя закладки, номера страницы или другого элемента для перехода. |
...
Получает текст "кнопки", отображаемой в документе, чтобы её можно было выбрать для активации перехода.
...
**Returns:**
java.lang.String - Текст "кнопки", который появляется в документе, так что его можно выбрать для активации перехода.
### getEnd() {#getEnd}
```
...
Получает имя закладки, номера страницы или другого элемента для перехода.
...
**Returns:**
java.lang.String - Имя закладки, номера страницы или другого элемента для перехода.
### getResult() {#getResult}
```
...
Устанавливает текст "кнопки", отображаемой в документе, чтобы её можно было выбрать для активации перехода.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст "кнопки", который появляется в документе, так что его можно выбрать для активации перехода. |
...
Устанавливает имя закладки, номера страницы или другого элемента для перехода.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя закладки, номера страницы или другого элемента для перехода. |
