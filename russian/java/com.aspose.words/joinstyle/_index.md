...
description: "Стиль соединения линий в Java."
type: docs
weight: 407
url: /ru/java/com.aspose.words/joinstyle/
---
...
| Поле | Описание |
| --- | --- |
| [BEVEL](#BEVEL) | Соединять ребра прямой линией. |
| [MITER](#MITER) | Продлевать ребра до их соединения. |
| [ROUND](#ROUND) | Рисовать дугу между двумя ребрами. |
| [length](#length) |  |
## Методы
...
Продлевать ребра до их соединения.
...
Рисовать дугу между двумя ребрами.
