...
description: Реализует поле ССЫЛКА.
type: docs
weight: 211
...
Для информации, скопированной из другого приложения, это поле связывает эту информацию с исходным исходным файлом.
## Методы
...
| [getFormatUpdateType()](#getFormatUpdateType--) | Получает способ, которым связанный объект обновляет свое форматирование. |
...
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String-) | Задает способ обновления форматирования связанного объекта. |
...
Получает способ, которым связанный объект обновляет свое форматирование.

**Возвращает:**
java.lang.String — Способ, которым связанный объект обновляет свое форматирование.
...
Задает способ обновления форматирования связанного объекта.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Способ, которым связанный объект обновляет свое форматирование. |
