...
description: "Реализует поле LINK в Java."
type: docs
weight: 254
url: /ru/java/com.aspose.words/fieldlink/
---
...
Для информации, скопированной из другого приложения, это поле связывает её с оригинальным файлом‑источником.
...
| Метод | Описание |
| --- | --- |
| [getAutoUpdate()](#getAutoUpdate) | Получает, следует ли автоматически обновлять это поле. |
...
| [getFormatUpdateType()](#getFormatUpdateType) | Получает способ, которым связанный объект обновляет своё форматирование. |
| [getInsertAsBitmap()](#getInsertAsBitmap) | Возвращает, следует ли вставлять связанный объект как bitmap. |
| [getInsertAsHtml()](#getInsertAsHtml) | Возвращает, следует ли вставлять связанный объект как текст в формате HTML. |
| [getInsertAsPicture()](#getInsertAsPicture) | Возвращает, следует ли вставлять связанный объект как изображение. |
| [getInsertAsRtf()](#getInsertAsRtf) | Возвращает, следует ли вставлять связанный объект в формате RTF. |
| [getInsertAsText()](#getInsertAsText) | Возвращает, следует ли вставлять связанный объект в текстовом формате. |
| [getInsertAsUnicode()](#getInsertAsUnicode) | Возвращает, следует ли вставлять связанный объект как Unicode‑текст. |
...
| [isLinked()](#isLinked) | Получает, следует ли уменьшить размер файла, не сохраняя графические данные в документе. |
| [isLinked(boolean value)](#isLinked-boolean) | Устанавливает, следует ли уменьшить размер файла, не сохраняя графические данные в документе. |
...
| [setAutoUpdate(boolean value)](#setAutoUpdate-boolean) | Устанавливает, следует ли автоматически обновлять это поле. |
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String) | Устанавливает способ, которым связанный объект обновляет своё форматирование. |
| [setInsertAsBitmap(boolean value)](#setInsertAsBitmap-boolean) | Устанавливает, следует ли вставлять связанный объект как растровое изображение. |
...
| [setInsertAsPicture(boolean value)](#setInsertAsPicture-boolean) | Устанавливает, следует ли вставлять связанный объект как изображение. |
| [setInsertAsRtf(boolean value)](#setInsertAsRtf-boolean) | Устанавливает, следует ли вставлять связанный объект в формате RTF (rich-text). |
| [setInsertAsText(boolean value)](#setInsertAsText-boolean) | Устанавливает, следует ли вставлять связанный объект в текстовом формате без разметки. |
| [setInsertAsUnicode(boolean value)](#setInsertAsUnicode-boolean) | Устанавливает, следует ли вставлять связанный объект как Unicode‑текст. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setProgId(String value)](#setProgId-java.lang.String) | Устанавливает тип приложения информации о ссылке. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Устанавливает имя и расположение исходного файла. |
| [setSourceItem(String value)](#setSourceItem-java.lang.String) | Устанавливает часть исходного файла, которая связывается. |
...
Получает, следует ли автоматически обновлять это поле.
...
**Returns:**
boolean — следует ли автоматически обновлять это поле.
...
Получает способ, которым связанный объект обновляет своё форматирование.
...
**Returns:**
java.lang.String - Способ, которым связанный объект обновляет своё форматирование.
...
Возвращает, следует ли вставлять связанный объект как bitmap.
...
**Returns:**
boolean — Вставлять связанный объект как растровое изображение.
...
Возвращает, следует ли вставлять связанный объект как текст в формате HTML.
...
**Returns:**
boolean — Вставлять связанный объект как текст в формате HTML.
...
Возвращает, следует ли вставлять связанный объект как изображение.
...
**Returns:**
boolean — Вставлять связанный объект как изображение.
...
Возвращает, следует ли вставлять связанный объект в формате RTF.
...
**Returns:**
boolean — Вставлять связанный объект в формате RTF (rich-text).
...
Возвращает, следует ли вставлять связанный объект в текстовом формате.
...
**Returns:**
boolean — Вставлять связанный объект в текстовом формате без разметки.
...
Возвращает, следует ли вставлять связанный объект как Unicode‑текст.
...
**Returns:**
boolean — Вставлять связанный объект как Unicode‑текст.
...
**Returns:**
java.lang.String — Часть исходного файла, которая связывается.
### getStart() {#getStart}
```
...
Получает, следует ли уменьшить размер файла, не сохраняя графические данные в документе.
...
**Returns:**
boolean — Уменьшать размер файла, не сохраняя графические данные в документе.
...
Устанавливает, следует ли уменьшить размер файла, не сохраняя графические данные в документе.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Уменьшать размер файла, не сохраняя графические данные в документе. |
...
Устанавливает, следует ли автоматически обновлять это поле.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли автоматически обновлять это поле. |
...
Устанавливает способ, которым связанный объект обновляет своё форматирование.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Способ, которым связанный объект обновляет своё форматирование. |
...
Устанавливает, следует ли вставлять связанный объект как растровое изображение.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект в виде растрового изображения. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект как текст в формате HTML. |
...
Устанавливает, следует ли вставлять связанный объект как изображение.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект как изображение. |
...
Устанавливает, следует ли вставлять связанный объект в формате RTF (rich-text).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект в формате Rich Text (RTF). |
...
Устанавливает, следует ли вставлять связанный объект в текстовом формате без разметки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект в формате только текста. |
...
Устанавливает, следует ли вставлять связанный объект как Unicode‑текст.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Вставлять ли связанный объект как Unicode‑текст. |
...
Устанавливает тип приложения информации о ссылке.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Тип применения информации о ссылке. |
...
Устанавливает имя и расположение исходного файла.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя и расположение исходного файла. |
...
Устанавливает часть исходного файла, которая связывается.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Часть исходного файла, которая связывается. |
