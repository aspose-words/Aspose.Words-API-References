...
description: "Реализует поле SHAPE на Java."
type: docs
weight: 286
url: /ru/java/com.aspose.words/fieldshape/
---
...
| [getText()](#getText) | Получает текст для получения. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст для получения. |
...
**Returns:**
java.lang.String - Текст для получения.
### getType() {#getType}
```
public int getType()
```
...
Устанавливает текст для получения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст для получения. |
