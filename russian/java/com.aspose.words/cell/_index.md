...
type: docs
weight: 48
url: /ru/java/com.aspose.words/cell/
---
...
**Cell** может быть только ребенком**Row**.

**Cell** может содержать узлы блочного уровня**Paragraph** а также**Table**.

 Минимальная допустимая ячейка должна иметь хотя бы один**Paragraph**.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [Cell(DocumentBase doc)](#Cell-com.aspose.words.DocumentBase-) |  Инициализирует новый экземпляр**Cell** учебный класс. |
## Методы
...
| [getCellFormat()](#getCellFormat--) | Предоставляет доступ к свойствам форматирования ячейки. |
...
| [getFirstParagraph()](#getFirstParagraph--) | Получает первый абзац среди непосредственных потомков. |
| [getLastChild()](#getLastChild--) | Получает последний дочерний элемент узла. |
| [getLastParagraph()](#getLastParagraph--) | Получает последний абзац среди непосредственных потомков. |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node-) |  |
| [getNextSibling()](#getNextSibling--) | Получает узел, следующий сразу за этим узлом. |
| [getNodeType()](#getNodeType--) |  Возвращает**NodeType.Cell**. |
| [getParagraphs()](#getParagraphs--) | Получает коллекцию абзацев, которые являются непосредственными дочерними элементами ячейки. |
| [getParentNode()](#getParentNode--) | Получает непосредственного родителя этого узла. |
| [getParentRow()](#getParentRow--) | Возвращает родительскую строку ячейки. |
...
| [getTables()](#getTables--) | Получает коллекцию таблиц, которые являются непосредственными дочерними элементами ячейки. |
...
| [isFirstCell()](#isFirstCell--) | Истинно, если это первая ячейка в строке; ложно в противном случае. |
| [isLastCell()](#isLastCell--) | Истинно, если это последняя ячейка в строке; ложно в противном случае. |
...
```
 ...
 Инициализирует новый экземпляр**Cell** учебный класс.

 Когда**Cell** создан, он принадлежит указанному документу, но еще не является его частью и**ParentNode** нулевой.

 Чтобы добавить**Cell** в документе используйте InsertAfter или InsertBefore в строке, в которую вы хотите вставить ячейку.
...
**Возвращает:**
boolean - Истинно, если были посещены все узлы; false, если DocumentVisitor остановил операцию перед посещением всех узлов. Вызывает DocumentVisitor.VisitCellStart, затем вызывает Accept для всех дочерних узлов раздела и в конце вызывает DocumentVisitor.VisitCellEnd.
...
**Возвращает:**
[CellFormat](../../com.aspose.words/cellformat) - соответствующий[CellFormat](../../com.aspose.words/cellformat) ценность.
### getChild(int nodeType, int index, boolean isDeep) {#getChild-int-int-boolean-}
```
...
**Возвращает:**
[Paragraph](../../com.aspose.words/paragraph) - Первый абзац среди ближайших детей.
...
**Возвращает:**
[Paragraph](../../com.aspose.words/paragraph) - Последний абзац среди ближайших детей.
### getNextMatchingNode(Node curNode) {#getNextMatchingNode-com.aspose.words.Node-}
```
...
```
 ...
 Возвращает**NodeType.Cell**.

**Возвращает:**
 инт -**NodeType.Cell** . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
...
**Возвращает:**
[ParagraphCollection](../../com.aspose.words/paragraphcollection) - Набор абзацев, которые являются непосредственными дочерними элементами ячейки.
...
Возвращает родительскую строку ячейки. Эквивалентно (Row)FirstNonMarkupParentNode .

**Возвращает:**
[Row](../../com.aspose.words/row) - Родительская строка ячейки.
...
**Возвращает:**
[TableCollection](../../com.aspose.words/tablecollection) Набор таблиц, которые являются непосредственными дочерними элементами ячейки.
### getText() {#getText--}
```
...
Истинно, если это первая ячейка в строке; ложно в противном случае.
...
Истинно, если это последняя ячейка в строке; ложно в противном случае.
