...
description: "Представляет все шрифты TrueType, установленные в системе в Java."
type: docs
weight: 651
...
| [SystemFontSource(int priority)](#SystemFontSource-int) | Конструктор. |
## Методы
...
На некоторых платформах Aspose.Words может искать системные шрифты не только через папки, но и в других источниках. Например, на платформе Windows Aspose.Words ищет шрифты также в реестре.
