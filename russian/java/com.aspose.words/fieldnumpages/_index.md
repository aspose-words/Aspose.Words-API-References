...
description: "Реализует поле NUMPAGES в Java."
type: docs
weight: 267
url: /ru/java/com.aspose.words/fieldnumpages/
---
...
Получает количество страниц в текущем документе, как записано в свойстве **Pages** встроенных свойств документа.
