...
Реализует поле ADDRESSBLOCK.
 ...
 Представляет адресный блок. Ан*address block* блок текста, определяющий информацию, соответствующую почтовому почтовому адресу, в порядке, требуемом страной назначения.
## Методы
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName--) | Получает название исключенной страны/региона. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion--) | Получает, следует ли форматировать адрес в соответствии со страной/регионом получателя, как определено POST.\*КОД (Всемирный почтовый союз 2006 г.). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName--) | Определяет, следует ли включать название страны/региона. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String-) | Задает название исключенной страны/региона. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean-) | Устанавливает, следует ли форматировать адрес в соответствии со страной/регионом получателя, как определено POST.\*КОД (Всемирный почтовый союз 2006 г.). |
...
| [setLanguageId(String value)](#setLanguageId-java.lang.String-) | Задает идентификатор языка, используемый для форматирования адреса. |
...
Получает название исключенной страны/региона.

**Возвращает:**
java.lang.String — исключенное название страны/региона.
...
Получает, следует ли форматировать адрес в соответствии со страной/регионом получателя, как определено POST.\*КОД (Всемирный почтовый союз 2006 г.).

**Возвращает:**
boolean — форматировать ли адрес в соответствии со страной/регионом получателя, как определено POST\*КОД (Всемирный почтовый союз 2006 г.).
...
Определяет, следует ли включать название страны/региона.

**Возвращает:**
java.lang.String — включать ли название страны/региона.
...
Задает название исключенной страны/региона.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Исключенное название страны/региона. |
...
Устанавливает, следует ли форматировать адрес в соответствии со страной/регионом получателя, как определено POST.\*КОД (Всемирный почтовый союз 2006 г.).

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли форматировать адрес в соответствии со страной/регионом получателя, как определено POST\*КОД (Всемирный почтовый союз 2006 г.). |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Включать ли название страны/региона. |
...
Задает идентификатор языка, используемый для форматирования адреса.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Идентификатор языка, используемый для форматирования адреса. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Формат имени и адреса. |
