...
description: "Реализует поле ADDRESSBLOCK в Java."
type: docs
weight: 196
url: /ru/java/com.aspose.words/fieldaddressblock/
---
...
Представляет блок адреса. *Блок адреса* — это блок текста, содержащий информацию, подходящую для почтового адреса, в порядке, требуемом страной назначения.

 **Examples:** 

Показывает, как получить имена полей слияния, используемых полем.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Получает название исключённой страны/региона. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Получает, следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Получает, следует ли включать название страны/региона. |
| [getLanguageId()](#getLanguageId) | Получает идентификатор языка, используемый для форматирования адреса. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Получает формат имени и адреса. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Устанавливает название исключённой страны/региона. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Устанавливает, следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006). |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Устанавливает, следует ли включать название страны/региона. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Устанавливает идентификатор языка, используемый для форматирования адреса. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Устанавливает формат имени и адреса. |
...
Получает название исключённой страны/региона.
...
**Returns:**
java.lang.String - Название исключённой страны/региона.
...
Получает, следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006).
...
**Returns:**
boolean - Следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006).
...
Получает, следует ли включать название страны/региона.
...
**Returns:**
java.lang.String - Следует ли включать название страны/региона.
...
Получает идентификатор языка, используемый для форматирования адреса.
...
**Returns:**
java.lang.String - Идентификатор языка, используемый для форматирования адреса.
...
Получает формат имени и адреса.
...
**Returns:**
java.lang.String - Формат имени и адреса.
### getResult() {#getResult}
```
...
Устанавливает название исключённой страны/региона.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Название исключённой страны/региона. |
...
Устанавливает, следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли форматировать адрес в соответствии со страной/регионом получателя, определённым по POST\*CODE (Универсальный почтовый союз 2006). |
...
Устанавливает, следует ли включать название страны/региона.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Следует ли включать название страны/региона. |
...
Устанавливает идентификатор языка, используемый для форматирования адреса.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор языка, используемый для форматирования адреса. |
...
Устанавливает формат имени и адреса.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Формат имени и адреса. |
