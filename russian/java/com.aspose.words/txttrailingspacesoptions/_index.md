...
description: "Указывает доступные параметры обработки завершающих пробелов при импорте из файла LoadFormat.TEXT в Java."
type: docs
weight: 697
url: /ru/java/com.aspose.words/txttrailingspacesoptions/
---
...
Указывает доступные параметры обработки конечных пробелов при импорте из файла [LoadFormat.TEXT](../../com.aspose.words/loadformat/\\#TEXT).
...
| Поле | Описание |
| --- | --- |
| [PRESERVE](#PRESERVE) | Конечные пробелы сохраняются. |
| [TRIM](#TRIM) | Конечные пробелы обрезаются. |
| [length](#length) |  |
## Методы
