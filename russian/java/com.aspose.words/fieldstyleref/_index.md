...
type: docs
weight: 246
url: /ru/java/com.aspose.words/fieldstyleref/
---
...
| [getSearchFromBottom()](#getSearchFromBottom--) | Получает, следует ли искать снизу текущей страницы, а не сверху. |
...
| [getStyleName()](#getStyleName--) | Получает имя стиля, по которому форматируется искомый текст. |
...
| [setSearchFromBottom(boolean value)](#setSearchFromBottom-boolean-) | Устанавливает, следует ли искать снизу текущей страницы, а не сверху. |
| [setStyleName(String value)](#setStyleName-java.lang.String-) | Задает имя стиля, по которому форматируется искомый текст. |
...
Получает, следует ли искать снизу текущей страницы, а не сверху.

**Возвращает:**
boolean — искать ли снизу текущей страницы, а не сверху.
...
Получает имя стиля, по которому форматируется искомый текст.

**Возвращает:**
java.lang.String — имя стиля, по которому форматируется искомый текст.
...
Устанавливает, следует ли искать снизу текущей страницы, а не сверху.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли искать снизу текущей страницы, а не сверху. |
...
Задает имя стиля, по которому форматируется искомый текст.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя стиля, по которому форматируется искомый текст. |
