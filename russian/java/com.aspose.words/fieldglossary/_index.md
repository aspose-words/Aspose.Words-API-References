...
description: "Реализует поле GLOSSARY в Java."
type: docs
weight: 239
url: /ru/java/com.aspose.words/fieldglossary/
---
...
| [getEntryName()](#getEntryName) | Получает имя записи глоссария для вставки. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | Устанавливает имя записи глоссария для вставки. |
...
Получает имя записи глоссария для вставки.
...
**Returns:**
java.lang.String — имя записи глоссария для вставки.
...
Устанавливает имя записи глоссария для вставки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя записи глоссария для вставки. |
