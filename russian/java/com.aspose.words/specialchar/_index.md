...
Базовый класс для специальных символов в документе.
 ...
 Документ Microsoft Word может содержать ряд специальных символов, представляющих поля, поля форм, фигуры, объекты OLE, сноски и т. д. Список специальных символов см.[ControlChar](../../com.aspose.words/controlchar).

**SpecialChar** является встроенным узлом и может быть только потомком**Paragraph**.

**SpecialChar** char используется в качестве базового класса для более конкретных классов, представляющих специальные символы, для которых Aspose.Words предоставляет программный доступ.**SpecialChar** класс также используется для представления специального символа, для которого Aspose.Words не предоставляет детальный программный доступ.
## Методы
...
| [getNodeType()](#getNodeType--) |  Возвращает**NodeType.SpecialChar**. |
...
```
 ...
 Возвращает**NodeType.SpecialChar**.

**Возвращает:**
 инт -**NodeType.SpecialChar** . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
