...
description: "Базовый класс для специальных символов в документе на Java."
type: docs
weight: 628
url: /ru/java/com.aspose.words/specialchar/
---
...
Документ Microsoft Word может содержать множество специальных символов, представляющих поля, поля формы, фигуры, OLE‑объекты, сноски и т.д. Список специальных символов см. в [ControlChar](../../com.aspose.words/controlchar/).
...
| [getNodeType()](#getNodeType) | Возвращает [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). |
...
Вызывает [DocumentVisitor.visitSpecialChar(com.aspose.words.SpecialChar)](../../com.aspose.words/documentvisitor/\#visitSpecialChar-com.aspose.words.SpecialChar).
...
Возвращает [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR).
...
**Returns:**
int - [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
