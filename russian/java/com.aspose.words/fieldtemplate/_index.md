...
description: "Реализует поле TEMPLATE в Java."
type: docs
weight: 294
url: /ru/java/com.aspose.words/fieldtemplate/
---
...
Показывает, как использовать поле TEMPLATE для отображения локального пути к шаблону документа в файловой системе.
