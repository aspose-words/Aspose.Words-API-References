...
description: "Реализует поле TOA в Java."
type: docs
weight: 297
url: /ru/java/com.aspose.words/fieldtoa/
---
...
Создаёт таблицу указателей (то есть список ссылок в юридическом документе, таких как ссылки на дела, статуты и правила, вместе с номерами страниц, на которых эти ссылки встречаются), используя записи, указанные полями TA.
...
| Метод | Описание |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Получает имя закладки, отмечающей часть документа, используемую для построения таблицы. |
...
| [getEntryCategory()](#getEntryCategory) | Получает целую категорию для записей, включенных в таблицу. |
| [getEntrySeparator()](#getEntrySeparator) | Получает последовательность символов, используемую для разделения записи таблицы указателей и её номера страницы. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Получает, следует ли удалять форматирование текста записи в документе из записи в таблице указателей. |
...
| [getUseHeading()](#getUseHeading) | Получает, следует ли включать заголовок категории для записей в таблице указателей. |
| [getUsePassim()](#getUsePassim) | Получает, следует ли заменять пять или более разных ссылок на страницы к одному и тому же указателю на "passim", которое используется для указания того, что слово или отрывок встречается часто в цитируемом произведении. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Устанавливает имя закладки, отмечающей часть документа, используемую для построения таблицы. |
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Устанавливает целую категорию для записей, включенных в таблицу. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Устанавливает последовательность символов, используемую для разделения записи таблицы указателей и её номера страницы. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Устанавливает, следует ли удалять форматирование текста записи в документе из записи в таблице указателей. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Устанавливает, следует ли включать заголовок категории для записей в таблице указателей. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Устанавливает, следует ли заменять пять или более разных ссылок на страницы к одному и тому же указателю на "passim", которое используется для указания того, что слово или отрывок встречается часто в цитируемом произведении. |
...
Получает имя закладки, отмечающей часть документа, используемую для построения таблицы.
...
**Returns:**
java.lang.String - Имя закладки, отмечающей часть документа, используемую для построения таблицы.
...
Получает целую категорию для записей, включенных в таблицу.
...
**Returns:**
java.lang.String - Целая категория для записей, включенных в таблицу.
...
Получает последовательность символов, используемую для разделения записи таблицы указателей и её номера страницы.
...
**Returns:**
java.lang.String - Последовательность символов, используемая для разделения записи таблицы указателей и её номера страницы.
...
Получает, следует ли удалять форматирование текста записи в документе из записи в таблице указателей.
...
**Returns:**
boolean - Нужно ли удалить форматирование текста записи в документе из записи в таблице указателей.
### getResult() {#getResult}
```
...
Получает, следует ли включать заголовок категории для записей в таблице указателей.
...
**Returns:**
boolean - Нужно ли включать заголовок категории для записей в таблице указателей.
...
Получает, следует ли заменять пять или более разных ссылок на страницы к одному и тому же указателю на "passim", которое используется для указания того, что слово или отрывок встречается часто в цитируемом произведении.
...
**Returns:**
boolean - Нужно ли заменять пять и более разных ссылок на страницы одного и того же указателя на "passim", что используется для указания, что слово или отрывок встречается часто в цитируемом произведении.
### isDirty() {#isDirty}
```
...
Устанавливает имя закладки, отмечающей часть документа, используемую для построения таблицы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя закладки, отмечающей часть документа, используемую для построения таблицы. |
...
Устанавливает целую категорию для записей, включенных в таблицу.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Интегральная категория для записей, включённых в таблицу. |
...
Устанавливает последовательность символов, используемую для разделения записи таблицы указателей и её номера страницы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Последовательность символов, используемая для разделения записи таблицы указателей и её номера страницы. |
...
Устанавливает, следует ли удалять форматирование текста записи в документе из записи в таблице указателей.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли удалить форматирование текста записи в документе из записи в таблице указателей. |
...
Устанавливает, следует ли включать заголовок категории для записей в таблице указателей.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли включать заголовок категории для записей в таблице указателей. |
...
Устанавливает, следует ли заменять пять или более разных ссылок на страницы к одному и тому же указателю на "passim", которое используется для указания того, что слово или отрывок встречается часто в цитируемом произведении.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли заменять пять и более разных ссылок на страницы одного и того же указателя на "passim", что используется для указания, что слово или отрывок встречается часто в цитируемом произведении. |
