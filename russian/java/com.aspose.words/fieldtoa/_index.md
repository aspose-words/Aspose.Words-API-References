...
Создает таблицу полномочий (то есть список ссылок в юридическом документе, таких как ссылки на дела, уставы и правила, а также номера страниц, на которых появляются ссылки), используя записи, указанные в полях ТА. .
## Методы
...
| [getEntryCategory()](#getEntryCategory--) | Получает интегральную категорию для записей, включенных в таблицу. |
| [getEntrySeparator()](#getEntrySeparator--) | Получает последовательность символов, используемую для разделения записи таблицы авторитетных источников и ее номера страницы. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting--) | Получает, следует ли удалить форматирование текста записи в документе из записи в таблице авторитетов. |
...
| [getUseHeading()](#getUseHeading--) | Определяет, следует ли включать заголовок категории для записей в авторитетной таблице. |
| [getUsePassim()](#getUsePassim--) | Получает, следует ли заменить пять или более разных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе. |
| [hashCode()](#hashCode--) |  |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String-) | Устанавливает интегральную категорию для записей, включенных в таблицу. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String-) | Устанавливает последовательность символов, используемую для разделения записи таблицы авторитетных источников и ее номера страницы. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean-) | Устанавливает, следует ли удалять форматирование текста записи в документе из записи в таблице авторитетов. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean-) | Устанавливает, включать ли заголовок категории для записей в авторитетной таблице. |
| [setUsePassim(boolean value)](#setUsePassim-boolean-) | Устанавливает, заменять ли пять или более различных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе. |
| [toString()](#toString--) |  |
...
Получает интегральную категорию для записей, включенных в таблицу.

**Возвращает:**
java.lang.String — интегральная категория для записей, включенных в таблицу.
...
Получает последовательность символов, используемую для разделения записи таблицы авторитетных источников и ее номера страницы.

**Возвращает:**
java.lang.String — последовательность символов, используемая для разделения записи в таблице авторитетных источников и номера ее страницы.
...
Получает, следует ли удалить форматирование текста записи в документе из записи в таблице авторитетов.

**Возвращает:**
boolean - Удалять ли форматирование текста записи в документе из записи в таблице авторитетов.
### getResult() {#getResult--}
```
...
Определяет, следует ли включать заголовок категории для записей в авторитетной таблице.

**Возвращает:**
boolean - Включать ли заголовок категории для записей в авторитетной таблице.
...
Получает, следует ли заменить пять или более разных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе.

**Возвращает:**
boolean — следует ли заменять пять или более различных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе.
### hashCode() {#hashCode--}
```
...
Устанавливает интегральную категорию для записей, включенных в таблицу.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Интегральная категория для записей, включенных в таблицу. |
...
Устанавливает последовательность символов, используемую для разделения записи таблицы авторитетных источников и ее номера страницы.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Последовательность символов, используемая для разделения записи в таблице авторитетных источников и номера ее страницы. |
...
Устанавливает, следует ли удалять форматирование текста записи в документе из записи в таблице авторитетов.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Удалять ли форматирование текста записи в документе из записи в таблице авторитетов. |
...
Устанавливает, включать ли заголовок категории для записей в авторитетной таблице.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Включать ли заголовок категории для записей в авторитетной таблице. |
...
Устанавливает, заменять ли пять или более различных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли заменять пять или более разных ссылок на один и тот же источник словом «passim», которое используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе. |
