...
description: "Реализует поле BIBLIOGRAPHY в Java."
type: docs
weight: 207
...
Реализует поле BIBLIOGRAPHY.

Чтобы узнать больше, посетите статью документации [ Working with Fields ][Working with Fields].

 **Remarks:** 

Вставляет содержимое части Bibliography документа в библиографическом стиле.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Получает идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык. |
...
| [getSourceTag()](#getSourceTag) | Получает значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Устанавливает идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Устанавливает идентификатор языка, используемый для форматирования библиографических источников в документе. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Устанавливает значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag. |
...
Получает идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык.
...
**Returns:**
java.lang.String - Идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык.
### getFormat() {#getFormat}
```
...
Получает значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag.
...
**Returns:**
java.lang.String - Значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag.
### getStart() {#getStart}
```
...
Устанавливает идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор языка, используемый для фильтрации библиографических данных, оставляя только источники в документе, использующие этот язык. |
...
Устанавливает идентификатор языка, используемый для форматирования библиографических источников в документе.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор языка, используемый для форматирования библиографических источников в документе. |
...
Устанавливает значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Значение, чтобы в библиографии отображались только источники с соответствующим значением элемента Tag. |
