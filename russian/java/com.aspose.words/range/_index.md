...
description: "Представляет непрерывный участок в документе на Java."
type: docs
weight: 558
...
Чтобы узнать больше, посетите статью документации [ Working with Ranges ][Working with Ranges].

 **Remarks:** 

Документ представлен в виде дерева узлов, и узлы предоставляют операции для работы с деревом, однако некоторые операции проще выполнить, если документ рассматривать как непрерывную последовательность текста.
...
Показывает, как получить текстовое содержимое всех узлов, охваченных диапазоном.
...
| [getBookmarks()](#getBookmarks) | Возвращает коллекцию [getBookmarks()](../../com.aspose.words/range/\#getBookmarks), представляющую все закладки в диапазоне. |
| [getFields()](#getFields) | Возвращает коллекцию [getFields()](../../com.aspose.words/range/\#getFields), представляющую все поля в диапазоне. |
| [getFormFields()](#getFormFields) | Возвращает коллекцию [getFormFields()](../../com.aspose.words/range/\#getFormFields), представляющую все поля формы в диапазоне. |
| [getRevisions()](#getRevisions) | Получает коллекцию ревизий (отслеживаемых изменений), существующих в этом диапазоне. |
| [getStructuredDocumentTags()](#getStructuredDocumentTags) | Возвращает коллекцию [getStructuredDocumentTags()](../../com.aspose.words/range/\#getStructuredDocumentTags), представляющую все структурированные теги документа в диапазоне. |
| [getText()](#getText) | Получает текст диапазона. |
| [iterator()](#iterator) |  |
| [normalizeFieldTypes()](#normalizeFieldTypes) | Изменяет значения типа полей [FieldChar.getFieldType()](../../com.aspose.words/fieldchar/\#getFieldType) у [FieldStart](../../com.aspose.words/fieldstart/), [FieldSeparator](../../com.aspose.words/fieldseparator/), [FieldEnd](../../com.aspose.words/fieldend/) в этом диапазоне, чтобы они соответствовали типам полей, содержащимся в кодах полей. |
| [replace(String pattern, String replacement)](#replace-java.lang.String-java.lang.String) | Заменяет все вхождения указанного шаблона строкового символа на строку‑заменитель. |
| [replace(String pattern, String replacement, FindReplaceOptions options)](#replace-java.lang.String-java.lang.String-com.aspose.words.FindReplaceOptions) | Заменяет все вхождения указанного шаблона строкового символа на строку‑заменитель. |
...
| [unlinkFields()](#unlinkFields) | Отвязывает поля в этом диапазоне. |
...
Возвращает коллекцию [getBookmarks()](../../com.aspose.words/range/\#getBookmarks), представляющую все закладки в диапазоне.
...
Возвращает коллекцию [getFields()](../../com.aspose.words/range/\#getFields), представляющую все поля в диапазоне.
...
Возвращает коллекцию [getFormFields()](../../com.aspose.words/range/\#getFormFields), представляющую все поля формы в диапазоне.
...
Получает коллекцию ревизий (отслеживаемых изменений), существующих в этом диапазоне.

 **Remarks:** 

Возвращаемая коллекция является "живой" коллекцией, что означает, что если вы удалите части документа, содержащие изменения, удалённые изменения автоматически исчезнут из этой коллекции.
...
Возвращает коллекцию [getStructuredDocumentTags()](../../com.aspose.words/range/\#getStructuredDocumentTags), представляющую все структурированные теги документа в диапазоне.
...
Изменяет значения типа полей [FieldChar.getFieldType()](../../com.aspose.words/fieldchar/\#getFieldType) у [FieldStart](../../com.aspose.words/fieldstart/), [FieldSeparator](../../com.aspose.words/fieldseparator/), [FieldEnd](../../com.aspose.words/fieldend/) в этом диапазоне, чтобы они соответствовали типам полей, содержащимся в кодах полей.

 **Remarks:** 

Используйте этот метод после изменений документа, влияющих на типы полей.

Чтобы изменить значения типов полей во всём документе, используйте [Document.normalizeFieldTypes()](../../com.aspose.words/document/\#normalizeFieldTypes).
...
Метод может обрабатывать разрывы как в шаблоне, так и в строке замены.

Вам следует использовать специальные мета-символы, если нужно работать с разрывами:
...
Используйте метод [replace(java.lang.String, java.lang.String, com.aspose.words.FindReplaceOptions)](../../com.aspose.words/range/\#replace-java.lang.String--java.lang.String--com.aspose.words.FindReplaceOptions) для более гибкой настройки.
...
Заменяет всё совпадение, захваченное регулярным выражением.
...
Используйте метод [replace(java.util.regex.Pattern, java.lang.String, com.aspose.words.FindReplaceOptions)](../../com.aspose.words/range/\#replace-java.util.regex.Pattern--java.lang.String--com.aspose.words.FindReplaceOptions) для более гибкой настройки.
...
Создаёт новый полностью сформированный документ, содержащий диапазон.
...
Отвязывает поля в этом диапазоне.

 **Remarks:** 

Заменяет все поля в этом диапазоне их последними результатами.

Чтобы отсоединить поля во всём документе, используйте [unlinkFields()](../../com.aspose.words/range/\#unlinkFields).
...
Когда вы открываете, изменяете и затем сохраняете документ, Aspose.Words не обновляет поля автоматически, а оставляет их неизменными. Поэтому обычно следует вызвать этот метод перед сохранением, если вы программно изменили документ и хотите убедиться, что в сохранённом документе отображаются правильные (вычисленные) значения полей.

Нет необходимости обновлять поля после выполнения слияния почты, потому что слияние почты является видом обновления полей и автоматически обновляет все поля в документе.

Этот метод не обновляет все типы полей. Для подробного списка поддерживаемых типов полей см. Руководство программиста.

Этот метод не обновляет поля, связанные с алгоритмами разметки страниц (например, PAGE, PAGES, PAGEREF). Поля, связанные с разметкой страниц, обновляются при рендеринге документа или вызове [Document.updatePageLayout()](../../com.aspose.words/document/\#updatePageLayout).

Чтобы обновить поля во всём документе, используйте [Document.updateFields()](../../com.aspose.words/document/\#updateFields).
