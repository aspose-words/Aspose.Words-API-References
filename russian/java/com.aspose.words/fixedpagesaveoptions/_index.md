...
description: Содержит общие параметры, которые можно указать при сохранении документа в фиксированные форматы страниц, изображения PDF, XPS и т. д.
type: docs
weight: 272
url: /ru/java/com.aspose.words/fixedpagesaveoptions/
---
