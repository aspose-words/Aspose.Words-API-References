...
description: "Представляет коллекцию узлов определённого типа в Java."
type: docs
weight: 479
...
Представляет коллекцию узлов определённого типа.
...
Коллекция [NodeCollection](../../com.aspose.words/nodecollection/) является "live", т.е. изменения в дочерних элементах объекта узла, из которого она была создана, сразу отражаются в узлах, возвращаемых свойствами и методами [NodeCollection](../../com.aspose.words/nodecollection/).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| индекс | int | Индекс в коллекции узлов. |
