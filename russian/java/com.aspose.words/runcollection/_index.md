...
description: Предоставляет типизированный доступ к коллекции узлов.
type: docs
weight: 498
url: /ru/java/com.aspose.words/runcollection/
---
...
```
 ...
 Предоставляет типизированный доступ к коллекции[Run](../../com.aspose.words/run) узлы.
...
| [get(int index)](#get-int-) |  Получает**Run** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
| [toArray()](#toArray--) | Копирует все прогоны из коллекции в новый массив прогонов. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Run](../../com.aspose.words/run) ценность.
### getClass() {#getClass--}
```
...
**Возвращает:**
com.aspose.words.Node[] - Массив прогонов.
### toString() {#toString--}
```
