...
description: "Обеспечивает типизированный доступ к коллекции узлов Run в Java."
type: docs
weight: 594
...
Обеспечивает типизированный доступ к коллекции узлов [Run](../../com.aspose.words/run/).
...
| [get(int index)](#get-int) | Получает [Run](../../com.aspose.words/run/) по заданному индексу. |
...
| [toArray()](#toArray) | Копирует все run из коллекции в новый массив run. |
...
Получает [Run](../../com.aspose.words/run/) по заданному индексу.
...
Копирует все run из коллекции в новый массив run.
...
**Returns:**
com.aspose.words.Node[] — массив run.
