...
Реализует поле КОММЕНТАРИИ.
 ...
 Извлекает и, при необходимости, устанавливает комментарии, относящиеся к текущему документу, как записано в**Comments** свойство встроенных свойств документа.
## Методы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст комментариев. |
