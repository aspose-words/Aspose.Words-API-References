...
description: "Реализует поле COMMENTS в Java."
type: docs
weight: 213
url: /ru/java/com.aspose.words/fieldcomments/
---
...
Реализует поле COMMENTS.

Чтобы узнать больше, посетите статью документации [ Working with Fields ][Working with Fields].

 **Remarks:** 

Получает и, при необходимости, задает комментарии, относящиеся к текущему документу, как записано в свойстве [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) встроенных свойств документа.
...
| [getText()](#getText) | Получает текст комментариев. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст комментариев. |
...
**Returns:**
java.lang.String - Текст комментариев.
### getType() {#getType}
```
public int getType()
```
...
Устанавливает текст комментариев.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст комментариев. |
