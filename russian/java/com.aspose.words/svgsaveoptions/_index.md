...
type: docs
weight: 541
url: /ru/java/com.aspose.words/svgsaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.SVG](../../com.aspose.words/saveformat\#SVG) формат.
...
| [getExportEmbeddedImages()](#getExportEmbeddedImages--) | Указано, следует ли встраивать изображения в документ SVG в формате base64. |
...
| [getFitToViewPort()](#getFitToViewPort--) | Указывает, должен ли выходной SVG заполнять доступную область просмотра (окно браузера или контейнер). |
...
| [getResourceSavingCallback()](#getResourceSavingCallback--) | Позволяет управлять сохранением ресурсов (изображений) при экспорте документа в формат SVG. |
| [getResourcesFolder()](#getResourcesFolder--) | Указывает физическую папку, в которой сохраняются ресурсы (изображения) при экспорте документа в формат Svg. |
| [getResourcesFolderAlias()](#getResourcesFolderAlias--) | Указывает имя папки, используемой для создания URI изображений, записываемых в документ SVG. |
...
| [getShowPageBorder()](#getShowPageBorder--) | Определяет, добавляется ли граница к контуру страницы. |
| [getTempFolder()](#getTempFolder--) | Указывает папку для временных файлов, используемых при сохранении в файл DOC или DOCX. |
| [getTextOutputMode()](#getTextOutputMode--) | Получает значение, определяющее способ отображения текста в SVG. |
...
| [setExportEmbeddedImages(boolean value)](#setExportEmbeddedImages-boolean-) | Указано, следует ли встраивать изображения в документ SVG в формате base64. |
...
| [setFitToViewPort(boolean value)](#setFitToViewPort-boolean-) | Указывает, должен ли выходной SVG заполнять доступную область просмотра (окно браузера или контейнер). |
...
| [setResourceSavingCallback(IResourceSavingCallback value)](#setResourceSavingCallback-com.aspose.words.IResourceSavingCallback-) | Позволяет управлять сохранением ресурсов (изображений) при экспорте документа в формат SVG. |
| [setResourcesFolder(String value)](#setResourcesFolder-java.lang.String-) | Указывает физическую папку, в которой сохраняются ресурсы (изображения) при экспорте документа в формат Svg. |
| [setResourcesFolderAlias(String value)](#setResourcesFolderAlias-java.lang.String-) | Указывает имя папки, используемой для создания URI изображений, записываемых в документ SVG. |
...
| [setShowPageBorder(boolean value)](#setShowPageBorder-boolean-) | Определяет, добавляется ли граница к контуру страницы. |
...
| [setTextOutputMode(int value)](#setTextOutputMode-int-) | Задает значение, определяющее способ отображения текста в SVG. |
...
Указано, следует ли встраивать изображения в документ SVG в формате base64. Обратите внимание, что установка этого флага может значительно увеличить размер выходного файла SVG.
...
Указывает, должен ли выходной SVG заполнять доступную область просмотра (окно браузера или контейнер). Если установлено значение true, ширина и высота выходного SVG устанавливаются на 100%.
...
Указывает физическую папку, в которой сохраняются ресурсы (изображения) при экспорте документа в формат Svg. Значение по умолчанию равно нулю.

 Имеет эффект, только если[getExportEmbeddedImages()](../../com.aspose.words/svgsaveoptions\#getExportEmbeddedImages--) / [setExportEmbeddedImages(boolean)](../../com.aspose.words/svgsaveoptions\#setExportEmbeddedImages-boolean-) свойство ложно.

 Когда вы сохраняете[Document](../../com.aspose.words/document)в формате SVG Aspose.Words должен сохранять все изображения, встроенные в документ, как отдельные файлы.[getResourcesFolder()](../../com.aspose.words/svgsaveoptions\#getResourcesFolder--) / [setResourcesFolder(java.lang.String)](../../com.aspose.words/svgsaveoptions\#setResourcesFolder-java.lang.String-) позволяет указать, где изображения будут сохранены и[getResourcesFolderAlias()](../../com.aspose.words/svgsaveoptions\#getResourcesFolderAlias--) / [setResourcesFolderAlias(java.lang.String)](../../com.aspose.words/svgsaveoptions\#setResourcesFolderAlias-java.lang.String-) позволяет указать, как будут создаваться URI изображения.

Если вы сохраняете документ в файл и указываете имя файла, Aspose.Words по умолчанию сохраняет изображения в той же папке, где сохранен файл документа. Использовать[getResourcesFolder()](../../com.aspose.words/svgsaveoptions\#getResourcesFolder--) / [setResourcesFolder(java.lang.String)](../../com.aspose.words/svgsaveoptions\#setResourcesFolder-java.lang.String-) переопределить это поведение.

 Если вы сохраняете документ в потоке, Aspose.Words не имеет папки для сохранения изображений, но все же необходимо где-то сохранять изображения. В этом случае необходимо указать доступную папку в[getResourcesFolder()](../../com.aspose.words/svgsaveoptions\#getResourcesFolder--) / [setResourcesFolder(java.lang.String)](../../com.aspose.words/svgsaveoptions\#setResourcesFolder-java.lang.String-) имущество
...
Указывает имя папки, используемой для создания URI изображений, записываемых в документ SVG. Значение по умолчанию равно нулю.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть только[SaveFormat.SVG](../../com.aspose.words/saveformat\#SVG).
...
Определяет, добавляется ли граница к контуру страницы. По умолчанию верно.
...
Получает значение, определяющее способ отображения текста в SVG.
...
Используйте это свойство, чтобы получить или установить режим отображения текста внутри документа при сохранении в формате SVG.
 ...
 Значение по умолчанию[SvgTextOutputMode.USE\_TARGET\_MACHINE\_FONTS](../../com.aspose.words/svgtextoutputmode\#USE-TARGET-MACHINE-FONTS).

**Возвращает:**
 int — значение, определяющее, как текст должен отображаться в SVG. Возвращаемое значение является одним из[SvgTextOutputMode](../../com.aspose.words/svgtextoutputmode) константы.
...
Задает значение, определяющее способ отображения текста в SVG.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int |  Значение, определяющее способ отображения текста в SVG. Значение должно быть одним из[SvgTextOutputMode](../../com.aspose.words/svgtextoutputmode) константы. |
