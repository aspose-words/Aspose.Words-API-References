...
description: "Позволяет указать дополнительные параметры, такие как пароль или базовый URI, при загрузке документа в объект Document в Java."
type: docs
weight: 435
url: /ru/java/com.aspose.words/loadoptions/
---
...
Позволяет указать дополнительные параметры (например, пароль или базовый URI) при загрузке документа в объект [Document](../../com.aspose.words/document/).
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | Сокращение для инициализации нового экземпляра этого класса с указанным паролем для загрузки зашифрованного документа. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | Инициализирует новый экземпляр этого класса. |
## Методы
