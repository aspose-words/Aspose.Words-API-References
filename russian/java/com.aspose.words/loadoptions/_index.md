...
description: Позволяет указать дополнительные параметры, такие как пароль или базовый URI, при загрузке документа в объект.
type: docs
weight: 378
...
```
 ...
 Позволяет указать дополнительные параметры (например, пароль или базовый URI) при загрузке документа в[Document](../../com.aspose.words/document) объект.
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String-) | Ярлык для инициализации нового экземпляра этого класса с указанным паролем для загрузки зашифрованного документа. |
