...
description: "Реализует поле PAGEREF в Java."
type: docs
weight: 272
url: /ru/java/com.aspose.words/fieldpageref/
---
...
Показывает, как вставлять поля PAGEREF для отображения относительного расположения закладок.
...
| Метод | Описание |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Получает имя закладки. |
...
| [getInsertHyperlink()](#getInsertHyperlink) | Получает, следует ли вставлять гиперссылку на абзац с закладкой. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Получает, следует ли вставлять относительное положение абзаца с закладкой. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Устанавливает имя закладки. |
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Устанавливает, следует ли вставлять гиперссылку в закладочный абзац. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Устанавливает, следует ли вставлять относительное положение закладочного абзаца. |
...
Получает, следует ли вставлять гиперссылку на абзац с закладкой.
...
**Returns:**
boolean - Следует ли вставлять гиперссылку в закладочный абзац.
...
Получает, следует ли вставлять относительное положение абзаца с закладкой.
...
**Returns:**
boolean - Следует ли вставлять относительное положение закладочного абзаца.
...
Устанавливает, следует ли вставлять гиперссылку в закладочный абзац.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли вставлять гиперссылку в закладочный абзац. |
...
Устанавливает, следует ли вставлять относительное положение закладочного абзаца.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли вставлять относительное положение закладочного абзаца. |
