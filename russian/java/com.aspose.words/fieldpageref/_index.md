...
| [getInsertHyperlink()](#getInsertHyperlink--) | Получает, следует ли вставить гиперссылку на отмеченный закладкой абзац. |
| [getInsertRelativePosition()](#getInsertRelativePosition--) | Получает, следует ли вставить относительное положение абзаца с закладкой. |
...
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean-) | Устанавливает, следует ли вставлять гиперссылку на отмеченный закладкой абзац. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean-) | Устанавливает, следует ли вставлять относительное положение отмеченного закладкой абзаца. |
...
Получает, следует ли вставить гиперссылку на отмеченный закладкой абзац.

**Возвращает:**
boolean - Вставлять ли гиперссылку на абзац с закладкой.
...
Получает, следует ли вставить относительное положение абзаца с закладкой.

**Возвращает:**
boolean - Вставлять ли относительную позицию абзаца с закладкой.
...
Устанавливает, следует ли вставлять гиперссылку на отмеченный закладкой абзац.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Вставлять ли гиперссылку на отмеченный закладкой абзац. |
...
Устанавливает, следует ли вставлять относительное положение отмеченного закладкой абзаца.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Вставлять ли относительное положение отмеченного закладкой абзаца. |
