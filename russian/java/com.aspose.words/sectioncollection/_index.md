...
description: "Коллекция объектов Section в документе на Java."
type: docs
weight: 606
url: /ru/java/com.aspose.words/sectioncollection/
---
...
Коллекция объектов [Section](../../com.aspose.words/section/) в документе.

Чтобы узнать больше, посетите статью документации [ Working with Sections ][Working with Sections].

 **Remarks:** 

Документ Microsoft Word может содержать несколько разделов. Чтобы создать раздел в Microsoft Word, выберите команду Вставка/Разрыв и укажите тип разрыва. Разрыв определяет, начинается ли раздел на новой странице или на той же странице.

Программное вставление и удаление разделов можно использовать для настройки документов, создаваемых при слиянии почты. Если документ должен иметь различное содержание или его части в зависимости от определённых критериев, можно создать "master" документ, содержащий несколько разделов, и удалить некоторые из разделов до или после слияния почты.
...
| [get(int index)](#get-int) | Возвращает раздел по указанному индексу. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| индекс | int | Индекс в списке разделов. |
...
**Returns:**
com.aspose.words.Node[] — массив разделов.
