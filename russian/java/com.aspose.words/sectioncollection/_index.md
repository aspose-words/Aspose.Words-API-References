...
description: Коллекция объектов Section в документе.
type: docs
weight: 510
...
```
 ...
 Коллекция**Section** объекты в документе.
...
| [get(int index)](#get-int-) | Извлекает раздел по заданному индексу. |
| [getClass()](#getClass--) |  |
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Section](../../com.aspose.words/section) ценность.
### getClass() {#getClass--}
```
