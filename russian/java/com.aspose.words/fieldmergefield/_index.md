...
description: "Реализует поле MERGEFIELD в Java."
type: docs
weight: 258
url: /ru/java/com.aspose.words/fieldmergefield/
---
...
Получает имя поля данных внутри символов слияния в основном документе слияния почты. Когда основной документ объединяется с выбранным источником данных, информация из указанного поля данных вставляется вместо поля слияния.
...
| [getFieldName()](#getFieldName) | Получает имя поля данных. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | Возвращает только имя поля данных. |
...
| [getTextAfter()](#getTextAfter) | Получает текст, который будет вставлен после поля, если поле не пустое. |
| [getTextBefore()](#getTextBefore) | Получает текст, который будет вставлен перед полем, если поле не пустое. |
...
| [isMapped()](#isMapped) | Получает, является ли это поле сопоставленным. |
| [isMapped(boolean value)](#isMapped-boolean) | Устанавливает, является ли это поле сопоставленным. |
| [isVerticalFormatting()](#isVerticalFormatting) | Получает, включено ли преобразование символов для вертикального форматирования. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | Устанавливает, включено ли преобразование символов для вертикального форматирования. |
| [remove()](#remove) | Удаляет поле из документа. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | Устанавливает имя поля данных. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | Устанавливает текст, который будет вставлен после поля, если поле не пустое. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | Устанавливает текст, который будет вставлен перед полем, если поле не пустое. |
...
**Returns:**
java.lang.String - Имя поля данных.
...
Возвращает только имя поля данных. Любой префикс удаляется в свойстве prefix.
...
**Returns:**
java.lang.String - Только имя поля данных.
### getFormat() {#getFormat}
```
...
Получает текст, который будет вставлен после поля, если поле не пустое.
...
**Returns:**
java.lang.String - Текст, который будет вставлен после поля, если поле не пустое.
...
Получает текст, который будет вставлен перед полем, если поле не пустое.
...
**Returns:**
java.lang.String - Текст, который будет вставлен перед полем, если поле не пустое.
### getType() {#getType}
```
public int getType()
```
...
Получает, является ли это поле сопоставленным.
...
**Returns:**
boolean - Является ли это поле сопоставленным.
...
Устанавливает, является ли это поле сопоставленным.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Является ли это поле сопоставленным. |
...
Получает, включено ли преобразование символов для вертикального форматирования.
...
**Returns:**
boolean - Включено ли преобразование символов для вертикального форматирования.
...
Устанавливает, включено ли преобразование символов для вертикального форматирования.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Включено ли преобразование символов для вертикального форматирования. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя поля данных. |
...
Устанавливает текст, который будет вставлен после поля, если поле не пустое.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст, который будет вставлен после поля, если поле не пустое. |
...
Устанавливает текст, который будет вставлен перед полем, если поле не пустое.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст, который будет вставлен перед полем, если поле не пустое. |
