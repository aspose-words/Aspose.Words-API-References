...
| [isMapped()](#isMapped--) | Получает, является ли это поле сопоставленным полем. |
| [isMapped(boolean value)](#isMapped-boolean-) | Устанавливает, является ли это поле сопоставленным полем. |
| [isVerticalFormatting()](#isVerticalFormatting--) | Получает, следует ли включить преобразование символов для вертикального форматирования. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean-) | Устанавливает, следует ли включить преобразование символов для вертикального форматирования. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove()](#remove--) | Удаляет поле из документа. |
| [setFieldName(String value)](#setFieldName-java.lang.String-) | Задает имя поля данных. |
...
**Возвращает:**
java.lang.String — Просто имя поля данных.
### getFormat() {#getFormat--}
```
...
Получает, является ли это поле сопоставленным полем.

**Возвращает:**
boolean — является ли это поле сопоставленным полем.
...
Устанавливает, является ли это поле сопоставленным полем.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Является ли это поле сопоставленным полем. |
...
Получает, следует ли включить преобразование символов для вертикального форматирования.

**Возвращает:**
boolean — включить ли преобразование символов для вертикального форматирования.
...
Устанавливает, следует ли включить преобразование символов для вертикального форматирования.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Включить ли преобразование символов для вертикального форматирования. |
...
Задает имя поля данных.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя поля данных. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст, который будет вставлен после поля, если поле не пустое. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст, который будет вставлен перед полем, если поле не пустое. |
