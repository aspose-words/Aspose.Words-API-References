...
description: "Реализует поле IMPORT в Java."
type: docs
weight: 245
url: /ru/java/com.aspose.words/fieldimport/
---
...
| [getSourceFullName()](#getSourceFullName) | Получает расположение изображения. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Устанавливает расположение изображения. |
...
Получает расположение изображения.
...
**Returns:**
java.lang.String — Расположение изображения.
### getStart() {#getStart}
```
...
Устанавливает расположение изображения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Расположение изображения. |
