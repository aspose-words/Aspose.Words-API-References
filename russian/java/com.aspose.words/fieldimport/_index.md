...
| [getSourceFullName()](#getSourceFullName--) | Получает местоположение изображения. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String-) | Устанавливает местоположение изображения. |
| [toString()](#toString--) |  |
...
Устанавливает местоположение изображения.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Расположение картины. |
