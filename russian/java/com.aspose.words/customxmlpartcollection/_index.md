...
description: "Представляет коллекцию пользовательских XML‑частей в Java."
type: docs
weight: 144
...
Представляет коллекцию пользовательских XML‑частей. Элементами являются объекты [CustomXmlPart](../../com.aspose.words/customxmlpart/).
...
Обычно вам не требуется создавать экземпляры этого класса. Вы можете получить доступ к пользовательским XML‑данным, хранящимся в документе, через свойство [Document.getCustomXmlParts()](../../com.aspose.words/document/\#getCustomXmlParts) / [Document.setCustomXmlParts(com.aspose.words.CustomXmlPartCollection)](../../com.aspose.words/document/\#setCustomXmlParts-com.aspose.words.CustomXmlPartCollection).
...
| [add(String id, String xml)](#add-java.lang.String-java.lang.String) | Создаёт новую XML‑часть с указанным XML и добавляет её в коллекцию. |
| [clear()](#clear) | Удаляет все элементы из коллекции. |
| [deepClone()](#deepClone) | Создает глубокую копию этой коллекции и её элементов. |
| [get(int index)](#get-int) | Получает элемент по указанному индексу. |
| [getById(String id)](#getById-java.lang.String) | Находит и возвращает пользовательскую часть XML по её идентификатору. |
...
| [set(int index, CustomXmlPart value)](#set-int-com.aspose.words.CustomXmlPart) | Устанавливает элемент с указанным индексом. |
...
| --- | --- | --- |
| part | [CustomXmlPart](../../com.aspose.words/customxmlpart/) | Пользовательская часть XML для добавления. |
...
Создаёт новую XML‑часть с указанным XML и добавляет её в коллекцию.
...
| xml | java.lang.String | Данные XML части. |
...
Создает глубокую копию этой коллекции и её элементов.
...
Находит и возвращает пользовательскую часть XML по её идентификатору.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| id | java.lang.String | Регистрозависимая строка, идентифицирующая пользовательскую часть XML. |
