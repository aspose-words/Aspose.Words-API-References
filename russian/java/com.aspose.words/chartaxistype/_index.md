...
description: "Указывает тип оси диаграммы в Java."
type: docs
weight: 70
url: /ru/java/com.aspose.words/chartaxistype/
---
...
| Поле | Описание |
| --- | --- |
| [CATEGORY](#CATEGORY) | Ось категорий диаграммы. |
| [SERIES](#SERIES) | Ось серий диаграммы. |
| [VALUE](#VALUE) | Ось значений диаграммы. |
| [length](#length) |  |
## Методы
