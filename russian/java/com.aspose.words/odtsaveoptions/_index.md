...
type: docs
weight: 419
url: /ru/java/com.aspose.words/odtsaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) или же[SaveFormat.OTT](../../com.aspose.words/saveformat\#OTT) формат.

 Чтобы узнать больше, посетите**Specify Save Options** документальная статья.

 На данный момент предоставляет только[getSaveFormat()](../../com.aspose.words/odtsaveoptions\#getSaveFormat--) / [setSaveFormat(int)](../../com.aspose.words/odtsaveoptions\#setSaveFormat-int-) свойство, но в будущем будут добавлены другие параметры, такие как пароль шифрования или настройки цифровой подписи.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [OdtSaveOptions()](#OdtSaveOptions--) |  Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) формат. |
| [OdtSaveOptions(String password)](#OdtSaveOptions-java.lang.String-) |  Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) формате, зашифрованном паролем. |
| [OdtSaveOptions(int saveFormat)](#OdtSaveOptions-int-) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [getMeasureUnit()](#getMeasureUnit--) | Позволяет указать единицы измерения для применения к содержимому документа. |
...
| [getPassword()](#getPassword--) | Получает пароль для шифрования документа. |
...
| [hashCode()](#hashCode--) |  |
| [isStrictSchema11()](#isStrictSchema11--) | Указывает, должен ли экспорт строго соответствовать спецификации ODT 1.1. |
| [isStrictSchema11(boolean value)](#isStrictSchema11-boolean-) | Указывает, должен ли экспорт строго соответствовать спецификации ODT 1.1. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setMeasureUnit(int value)](#setMeasureUnit-int-) | Позволяет указать единицы измерения для применения к содержимому документа. |
...
| [setPassword(String value)](#setPassword-java.lang.String-) | Устанавливает пароль для шифрования документа. |
...
```
 ...
 Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) формат.
...
```
 ...
 Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) формате, зашифрованном паролем.
...
Позволяет указать единицы измерения для применения к содержимому документа. Значение по умолчанию[OdtSaveMeasureUnit.CENTIMETERS](../../com.aspose.words/odtsavemeasureunit\#CENTIMETERS) Open Office использует сантиметры при указании длины, ширины и других измеримых свойств форматирования и содержимого в документах, тогда как MS Office использует дюймы.

**Возвращает:**
 int - соответствующее значение int. Возвращаемое значение является одним из[OdtSaveMeasureUnit](../../com.aspose.words/odtsavemeasureunit) константы.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT) или же[SaveFormat.OTT](../../com.aspose.words/saveformat\#OTT).
...
```
 ...
 Указывает, должен ли экспорт строго соответствовать спецификации ODT 1.1. OOo 3.0 правильно отображает файлы, если они содержат элементы и атрибуты ODT 1.2. Используйте «false» для этой цели или «true» для строгого соответствия спецификации 1.1. Значение по умолчанию**false**.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int |  Соответствующее целочисленное значение. Значение должно быть одним из[OdtSaveMeasureUnit](../../com.aspose.words/odtsavemeasureunit) константы. |
...
Устанавливает пароль для шифрования документа.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Пароль для шифрования документа. |
