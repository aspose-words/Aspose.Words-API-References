...
description: "Представляет форматирование элемента диаграммы в Java."
type: docs
weight: 78
url: /ru/java/com.aspose.words/chartformat/
---
...
| [getEndCap()](#getEndCap) |  |
| [getFill()](#getFill) | Получает форматирование заливки для родительского элемента диаграммы. |
...
| [getShapeType()](#getShapeType) | Получает тип формы родительского элемента диаграммы. |
| [getStartArrowLength()](#getStartArrowLength) |  |
| [getStartArrowType()](#getStartArrowType) |  |
| [getStartArrowWidth()](#getStartArrowWidth) |  |
| [getStroke()](#getStroke) | Получает форматирование линии для родительского элемента диаграммы. |
...
| [getWeight()](#getWeight) |  |
| [isDefined()](#isDefined) | Получает флаг, указывающий, определено ли какое-либо форматирование. |
...
| [setShapeType(int value)](#setShapeType-int) | Устанавливает тип формы родительского элемента диаграммы. |
...
Получает тип формы родительского элемента диаграммы.

 **Remarks:** 

В настоящее время это свойство может использоваться только для подписей данных.
...
**Returns:**
int - Тип формы родительского элемента диаграммы. Возвращаемое значение является одной из констант [ChartShapeType](../../com.aspose.words/chartshapetype/) constants.
### getStartArrowLength() {#getStartArrowLength}
```
...
Получает форматирование линии для родительского элемента диаграммы.
...
Получает флаг, указывающий, определено ли какое-либо форматирование.
...
**Returns:**
boolean - Флаг, указывающий, определено ли какое-либо форматирование.
### oneColorGradient(int style, int variant, double degree) {#oneColorGradient-int-int-double}
```
...
Устанавливает тип формы родительского элемента диаграммы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Тип формы родительского элемента диаграммы. Значение должно быть одним из констант [ChartShapeType](../../com.aspose.words/chartshapetype/). |
