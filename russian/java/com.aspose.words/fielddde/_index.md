...
description: "Реализует поле DDE в Java."
type: docs
weight: 221
...
Для информации, скопированной из другого приложения, это поле связывает её с оригинальным файлом-источником с помощью DDE.
