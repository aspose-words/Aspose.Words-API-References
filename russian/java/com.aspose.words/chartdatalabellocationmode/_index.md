...
description: "Указывает, как значения u200bu200bthat, определяющие расположение метки данных — свойства ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble и ChartDataLabel.getTop / ChartDataLabel.setTopdouble — интерпретируются в Java."
type: docs
weight: 73
url: /ru/java/com.aspose.words/chartdatalabellocationmode/
---
...
| Поле | Описание |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | Расположение метки данных задаётся с помощью абсолютных координат, начиная с верхнего левого угла диаграммы. |
| [OFFSET](#OFFSET) | Расположение метки данных задаётся смещением от позиции, определённой её свойством [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int). |
| [length](#length) |  |
## Методы
...
Расположение метки данных задаётся с помощью абсолютных координат, начиная с верхнего левого угла диаграммы.
...
Расположение метки данных задаётся смещением от позиции, определённой её свойством [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int).
