...
type: docs
weight: 350
url: /ru/java/com.aspose.words/inlinestory/
---
...
**InlineStory** является контейнером для узлов блочного уровня[Paragraph](../../com.aspose.words/paragraph) а также[Table](../../com.aspose.words/table).

 Классы, происходящие от**InlineStory** являются узлами встроенного уровня, которые могут содержать собственный текст (абзацы и таблицы). Например,**Comment** узел содержит текст комментария и**Footnote** содержит текст сноски.
## Конструкторы
...
| [getStoryType()](#getStoryType--) | Возвращает тип истории. |
...
**Возвращает:**
 int - Тип истории. Возвращаемое значение является одним из[StoryType](../../com.aspose.words/storytype) константы.
### getTables() {#getTables--}
```
