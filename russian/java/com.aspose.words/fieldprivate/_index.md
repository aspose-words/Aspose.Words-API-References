...
description: Реализует поле PRIVATE.
type: docs
weight: 232
...
Предоставляется личная кладовая. Это поле используется для хранения данных для документов, преобразованных из файлов других форматов.
## Методы
