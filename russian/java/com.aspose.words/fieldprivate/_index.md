...
description: "Реализует поле PRIVATE в Java."
type: docs
weight: 275
url: /ru/java/com.aspose.words/fieldprivate/
---
...
Предоставляет приватную область хранения. Это поле используется для сохранения данных документов, преобразованных из других форматов файлов.
