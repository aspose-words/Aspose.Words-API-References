...
description: "Представляет начало поля Word в документе на Java."
type: docs
weight: 288
...
| [getFieldData()](#getFieldData) | Получает пользовательские данные поля, связанные с полем. |
...
Вызывает [DocumentVisitor.visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
**Returns:**
byte[] - Пользовательские данные поля, связанные с полем.
...
**Returns:**
int - [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
