...
description: "Реализует поле TIME в Java."
type: docs
weight: 295
url: /ru/java/com.aspose.words/fieldtime/
---
...
Вставляет текущие дату и время.

 **Examples:** 

Показывает, как отобразить текущее время с помощью поля TIME.
