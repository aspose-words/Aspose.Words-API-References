...
description: "Реализует поле USERINITIALS в Java."
type: docs
weight: 304
url: /ru/java/com.aspose.words/fielduserinitials/
---
...
Получает инициалы текущего пользователя.
...
| [getUserInitials()](#getUserInitials) | Получает инициалы текущего пользователя. |
...
| [setUserInitials(String value)](#setUserInitials-java.lang.String) | Устанавливает инициалы текущего пользователя. |
...
**Returns:**
java.lang.String - Инициалы текущего пользователя.
### isDirty() {#isDirty}
```
...
Устанавливает инициалы текущего пользователя.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Инициалы текущего пользователя. |
