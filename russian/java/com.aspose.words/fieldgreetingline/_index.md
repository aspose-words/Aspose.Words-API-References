...
description: "Реализует поле GREETINGLINE в Java."
type: docs
weight: 241
...
Вставляет строку приветствия при слиянии почты.
...
| Метод | Описание |
| --- | --- |
| [getAlternateText()](#getAlternateText) | Получает текст, который будет включён в поле, если имя пусто. |
...
| [getFieldNames()](#getFieldNames) | Возвращает коллекцию имён полей слияния почты, используемых полем. |
...
| [getNameFormat()](#getNameFormat) | Получает формат имени, включённого в поле. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | Устанавливает текст, который будет включён в поле, если имя пусто. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Устанавливает идентификатор языка, используемый для форматирования имени. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Устанавливает формат имени, включённого в поле. |
...
Получает текст, который будет включён в поле, если имя пусто.
...
**Returns:**
java.lang.String - Текст, который будет включён в поле, если имя пусто.
...
Возвращает коллекцию имён полей слияния почты, используемых полем.
...
Получает формат имени, включённого в поле.
...
**Returns:**
java.lang.String - Формат имени, включённого в поле.
### getResult() {#getResult}
```
...
Устанавливает текст, который будет включён в поле, если имя пусто.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст, который будет включён в поле, если имя пусто. |
...
Устанавливает идентификатор языка, используемый для форматирования имени.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор языка, используемый для форматирования имени. |
...
Устанавливает формат имени, включённого в поле.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Формат имени, включённого в поле. |
