...
type: docs
weight: 626
url: /ru/java/com.aspose.words/xamlflowsaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.XAML\_FLOW](../../com.aspose.words/saveformat\#XAML-FLOW) или же[SaveFormat.XAML\_FLOW\_PACK](../../com.aspose.words/saveformat\#XAML-FLOW-PACK) формат.
...
| --- | --- |
| [XamlFlowSaveOptions()](#XamlFlowSaveOptions--) |  Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.XAML\_FLOW](../../com.aspose.words/saveformat\#XAML-FLOW) формат. |
| [XamlFlowSaveOptions(int saveFormat)](#XamlFlowSaveOptions-int-) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [getImageSavingCallback()](#getImageSavingCallback--) | Позволяет управлять способом сохранения изображений при сохранении документа в XAML. |
| [getImagesFolder()](#getImagesFolder--) | Указывает физическую папку, в которой сохраняются изображения при экспорте документа в формат XAML. |
| [getImagesFolderAlias()](#getImagesFolderAlias--) | Задает имя папки, используемой для создания URI изображений, записываемых в документ XAML. |
...
| [setImageSavingCallback(IImageSavingCallback value)](#setImageSavingCallback-com.aspose.words.IImageSavingCallback-) | Позволяет управлять способом сохранения изображений при сохранении документа в XAML. |
| [setImagesFolder(String value)](#setImagesFolder-java.lang.String-) | Указывает физическую папку, в которой сохраняются изображения при экспорте документа в формат XAML. |
| [setImagesFolderAlias(String value)](#setImagesFolderAlias-java.lang.String-) | Задает имя папки, используемой для создания URI изображений, записываемых в документ XAML. |
...
```
 ...
 Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.XAML\_FLOW](../../com.aspose.words/saveformat\#XAML-FLOW) формат.
...
Позволяет управлять способом сохранения изображений при сохранении документа в XAML.
...
Указывает физическую папку, в которой сохраняются изображения при экспорте документа в формат XAML. По умолчанию это пустая строка.

 Когда вы сохраняете[Document](../../com.aspose.words/document) в формате XAML Aspose.Words должен сохранять все изображения, встроенные в документ, как отдельные файлы.[getImagesFolder()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolder-java.lang.String-) позволяет указать, где изображения будут сохранены и[getImagesFolderAlias()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolderAlias--) / [setImagesFolderAlias(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolderAlias-java.lang.String-) позволяет указать, как будут создаваться URI изображения.

Если вы сохраняете документ в файл и указываете имя файла, Aspose.Words по умолчанию сохраняет изображения в той же папке, где сохранен файл документа. Использовать[getImagesFolder()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolder-java.lang.String-) переопределить это поведение.

 Если вы сохраняете документ в потоке, Aspose.Words не имеет папки для сохранения изображений, но все же необходимо где-то сохранять изображения. В этом случае необходимо указать доступную папку в[getImagesFolder()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolder-java.lang.String-) свойство или предоставлять пользовательские потоки через[getImageSavingCallback()](../../com.aspose.words/xamlflowsaveoptions\#getImageSavingCallback--) / [setImageSavingCallback(com.aspose.words.IImageSavingCallback)](../../com.aspose.words/xamlflowsaveoptions\#setImageSavingCallback-com.aspose.words.IImageSavingCallback-) обработчик события.
...
Задает имя папки, используемой для создания URI изображений, записываемых в документ XAML. По умолчанию это пустая строка.

 Когда вы сохраняете[Document](../../com.aspose.words/document) в формате XAML Aspose.Words должен сохранять все изображения, встроенные в документ, как отдельные файлы.[getImagesFolder()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolder-java.lang.String-) позволяет указать, где изображения будут сохранены и[getImagesFolderAlias()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolderAlias--) / [setImagesFolderAlias(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolderAlias-java.lang.String-) позволяет указать, как будут создаваться URI изображения.

 Если[getImagesFolderAlias()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolderAlias--) / [setImagesFolderAlias(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolderAlias-java.lang.String-) не является пустой строкой, то URI изображения, записанный в XAML, будет*ImagesFolderAlias + ![Image 1][]*.

 Если[getImagesFolderAlias()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolderAlias--) / [setImagesFolderAlias(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolderAlias-java.lang.String-)является пустой строкой, то URI изображения, записанный в XAML, будет*ImagesFolder + ![Image 1][]*.

 Если[getImagesFolderAlias()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolderAlias--) / [setImagesFolderAlias(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolderAlias-java.lang.String-) установлен в '.' (точка), то имя файла изображения будет записано в XAML без пути независимо от других параметров.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть только[SaveFormat.XAML\_FLOW](../../com.aspose.words/saveformat\#XAML-FLOW).
