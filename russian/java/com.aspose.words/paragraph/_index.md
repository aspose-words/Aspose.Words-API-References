...
description: "Представляет абзац текста в Java."
type: docs
weight: 522
...
Корректный абзац в Microsoft Word всегда заканчивается символом разрыва абзаца, а минимальный корректный абзац состоит только из разрыва абзаца. Класс [Paragraph](../../com.aspose.words/paragraph/) автоматически добавляет соответствующий символ разрыва абзаца в конце, и этот символ не является частью дочерних узлов [Paragraph](../../com.aspose.words/paragraph/), поэтому [Paragraph](../../com.aspose.words/paragraph/) может быть пустым.

Не включайте символ конца абзаца [ControlChar.PARAGRAPH\_BREAK](../../com.aspose.words/controlchar/\#PARAGRAPH-BREAK) или символ конца ячейки [ControlChar.CELL](../../com.aspose.words/controlchar/\#CELL) в текст абзаца, так как это может сделать абзац недействительным при открытии документа в Microsoft Word.
...
| --- | --- |
| [Paragraph(DocumentBase doc)](#Paragraph-com.aspose.words.DocumentBase) | Инициализирует новый экземпляр класса [Paragraph](../../com.aspose.words/paragraph/). |
## Методы

| Метод | Описание |
| --- | --- |
| [accept(DocumentVisitor visitor)](#accept-com.aspose.words.DocumentVisitor) | Принимает посетителя. |
| [acceptEnd(DocumentVisitor visitor)](#acceptEnd-com.aspose.words.DocumentVisitor) | Принимает посетителя для посещения конца абзаца документа. |
| [acceptStart(DocumentVisitor visitor)](#acceptStart-com.aspose.words.DocumentVisitor) | Принимает посетителя для посещения начала абзаца документа. |
...
| [appendField(String fieldCode)](#appendField-java.lang.String) | Добавляет поле к этому абзацу. |
| [appendField(String fieldCode, String fieldValue)](#appendField-java.lang.String-java.lang.String) | Добавляет поле к этому абзацу. |
...
| [getBreakIsStyleSeparator()](#getBreakIsStyleSeparator) | Истина, если разрыв абзаца является разделителем стилей. |
...
| [getEffectiveTabStops()](#getEffectiveTabStops) | Возвращает массив всех табуляций, применённых к этому абзацу, включая применённые косвенно стилями или списками. |
| [getFirstChild()](#getFirstChild) | Получает первый дочерний элемент узла. |
| [getFrameFormat()](#getFrameFormat) | Предоставляет доступ к свойствам форматирования рамки. |
...
| [getListLabel()](#getListLabel) | Получает объект [getListLabel()](../../com.aspose.words/paragraph/\#getListLabel), который предоставляет доступ к значению нумерации списка и его форматированию для этого абзаца. |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node) |  |
| [getNextSibling()](#getNextSibling) | Получает узел, непосредственно следующий за этим узлом. |
| [getNodeType()](#getNodeType) | Возвращает [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH). |
...
| [getParentSection()](#getParentSection) | Получает родительский [Section](../../com.aspose.words/section/) абзаца. |
| [getParentStory()](#getParentStory) | Получает родительскую историю уровня раздела, которой может быть [Body](../../com.aspose.words/body/) или [HeaderFooter](../../com.aspose.words/headerfooter/). |
...
| [insertField(String fieldCode, Node refNode, boolean isAfter)](#insertField-java.lang.String-com.aspose.words.Node-boolean) | Вставляет поле в этот абзац. |
| [insertField(String fieldCode, String fieldValue, Node refNode, boolean isAfter)](#insertField-java.lang.String-java.lang.String-com.aspose.words.Node-boolean) | Вставляет поле в этот абзац. |
...
| [isEndOfCell()](#isEndOfCell) | Истина, если этот абзац является последним абзацем в [Cell](../../com.aspose.words/cell/); иначе — ложь. |
| [isEndOfDocument()](#isEndOfDocument) | Истина, если этот абзац является последним абзацем в последнем разделе документа. |
| [isEndOfHeaderFooter()](#isEndOfHeaderFooter) | Истина, если этот абзац является последним абзацем в [HeaderFooter](../../com.aspose.words/headerfooter/) (основная текстовая история) [Section](../../com.aspose.words/section/); иначе — ложь. |
| [isEndOfSection()](#isEndOfSection) | Истина, если этот абзац является последним абзацем в [Body](../../com.aspose.words/body/) (основная текстовая история) [Section](../../com.aspose.words/section/); иначе — ложь. |
...
| [isInCell()](#isInCell) | Истина, если этот абзац является непосредственным дочерним элементом [Cell](../../com.aspose.words/cell/); иначе — ложь. |
...
| [isListItem()](#isListItem) | Истина, когда абзац является элементом маркированного или нумерованного списка в оригинальной ревизии. |
...
| [joinRunsWithSameFormatting(JoinRunsOptions options)](#joinRunsWithSameFormatting-com.aspose.words.JoinRunsOptions) | Объединяет участки текста с одинаковым форматированием в абзаце. |
...
Инициализирует новый экземпляр класса [Paragraph](../../com.aspose.words/paragraph/).

 **Remarks:** 

Когда создаётся [Paragraph](../../com.aspose.words/paragraph/), он принадлежит указанному документу, но ещё не является частью документа, и [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) равно null.

Чтобы добавить [Paragraph](../../com.aspose.words/paragraph/) в документ, используйте [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertAfter-com.aspose.words.Node--com.aspose.words.Node) или [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertBefore-com.aspose.words.Node--com.aspose.words.Node) в истории, где вы хотите вставить абзац.
...
Вызывает [DocumentVisitor.visitParagraphStart(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/\#visitParagraphStart-com.aspose.words.Paragraph), затем вызывает [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/\#accept-com.aspose.words.DocumentVisitor) для всех дочерних узлов абзаца и вызывает [DocumentVisitor.visitParagraphEnd(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/\#visitParagraphEnd-com.aspose.words.Paragraph) в конце.
...
| --- | --- | --- |
| fieldCode | java.lang.String | Код поля для добавления (без фигурных скобок). |
| fieldValue | java.lang.String | Значение поля для добавления. Передайте  null  для полей, у которых нет значения. |
...
True, если разрыв абзаца является разделителем стилей. Разделитель стилей позволяет одному абзацу состоять из частей с разными стилями абзаца.

 **Examples:** 

Показывает, как записать текст в той же строке, что и заголовок оглавления (TOC), и чтобы он не отображался в оглавлении.
...
Возвращает массив всех табуляций, применённых к этому абзацу, включая применённые косвенно стилями или списками.
...
Получает объект [getListLabel()](../../com.aspose.words/paragraph/\#getListLabel), который предоставляет доступ к значению нумерации списка и его форматированию для этого абзаца.
...
Возвращает [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH).
...
**Returns:**
int - [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\\#PARAGRAPH). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
...
Получает родительский [Section](../../com.aspose.words/section/) абзаца.
...
Получает родительскую историю уровня раздела, которой может быть [Body](../../com.aspose.words/body/) или [HeaderFooter](../../com.aspose.words/headerfooter/).
...
| refNode | [Node](../../com.aspose.words/node/) | Ссылка‑узел внутри этого абзаца (если  refNode  равен  null , то добавляется в конец абзаца). |
| isAfter | boolean | Определяет, вставлять поле после или перед ссылкой‑узлом. |
...
Истина, если этот абзац является последним абзацем в [Cell](../../com.aspose.words/cell/); иначе — ложь.
...
Истина, если этот абзац является последним абзацем в [HeaderFooter](../../com.aspose.words/headerfooter/) (основная текстовая история) [Section](../../com.aspose.words/section/); иначе — ложь.
...
Истина, если этот абзац является последним абзацем в [Body](../../com.aspose.words/body/) (основная текстовая история) [Section](../../com.aspose.words/section/); иначе — ложь.
...
Показывает, как проверить, является ли абзац ревизией формата.
...
Истина, если этот абзац является непосредственным дочерним элементом [Cell](../../com.aspose.words/cell/); иначе — ложь.
...
Истина, когда абзац является элементом маркированного или нумерованного списка в оригинальной ревизии.
...
Показывает, как проверить, является ли абзац перемещённым изменением.
...
Показывает, как упростить абзацы, объединяя избыточные участки текста.
...
**Returns:**
int - Количество выполненных объединений. Когда **N** соседних участков объединяются, они считаются как **N - 1** объединений.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| options | [JoinRunsOptions](../../com.aspose.words/joinrunsoptions/) | Дополнительные параметры |
