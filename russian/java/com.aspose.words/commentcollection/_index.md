...
```
 ...
 Предоставляет типизированный доступ к коллекции[Comment](../../com.aspose.words/comment) узлы.
...
| [get(int index)](#get-int-) |  Получает**Comment** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
```
 ...
 Получает**Comment** по заданному индексу.
...
**Возвращает:**
[Comment](../../com.aspose.words/comment) - соответствующий[Comment](../../com.aspose.words/comment) ценность.
### getClass() {#getClass--}
```
