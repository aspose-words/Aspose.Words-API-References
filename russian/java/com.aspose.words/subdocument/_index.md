...
description: "Представляет SubDocument — ссылку на внешний документ, хранящийся в Java."
type: docs
weight: 645
url: /ru/java/com.aspose.words/subdocument/
---
...
Представляет **SubDocument** \- который является ссылкой на внешний документ.
...
В этой версии Aspose.Words узлы [SubDocument](../../com.aspose.words/subdocument/) не предоставляют публичных методов и свойств для создания или изменения субдокумента. В этой версии вы не можете создавать экземпляры узлов [SubDocument](../../com.aspose.words/subdocument/) или изменять существующие, за исключением их удаления.

[SubDocument](../../com.aspose.words/subdocument/) can only be a child of [Paragraph](../../com.aspose.words/paragraph/).

 **Examples:** 

Показывает, как получить доступ к субдокументу главного документа.
...
| [getNodeType()](#getNodeType) | Возвращает [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). |
...
Возвращает [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT).
...
**Returns:**
int - [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
