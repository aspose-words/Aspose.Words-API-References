...
description: "Реализует поле LASTSAVEDBY в Java."
type: docs
weight: 253
url: /ru/java/com.aspose.words/fieldlastsavedby/
---
...
Получает имя пользователя, который последним изменил и сохранил текущий документ, как записано в свойстве **LastModifiedBy** встроенных свойств документа.
