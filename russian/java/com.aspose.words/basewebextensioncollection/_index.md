...
description: "Базовый класс для коллекций TaskPaneCollection, WebExtensionBindingCollection, WebExtensionPropertyCollection и WebExtensionReferenceCollection в Java."
type: docs
weight: 35
url: /ru/java/com.aspose.words/basewebextensioncollection/
---
...
| [iterator()](#iterator) | Возвращает перечислитель, который может проходить по коллекции. |
| [remove(int index)](#remove-int) | Удаляет элемент с указанным индексом из коллекции. |
| [set(int index, Object value)](#set-int-java.lang.Object) | Устанавливает элемент с указанным индексом. |
### BaseWebExtensionCollection() {#BaseWebExtensionCollection}
```
...
**Returns:**
java.lang.Object - Элемент с указанным индексом.
### getCount() {#getCount}
```
public int getCount()
```
...
Возвращает перечислитель, который может проходить по коллекции.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| индекс | int | Нулевой индекс элемента коллекции. |
...
Устанавливает элемент с указанным индексом.
...
| --- | --- | --- |
| индекс | int | Нулевой (начинающий с нуля) индекс элемента. |
| значение | java.lang.Object | Элемент по указанному индексу. |
