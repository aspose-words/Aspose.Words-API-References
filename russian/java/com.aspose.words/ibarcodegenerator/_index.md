...
description: "Публичный интерфейс для пользовательского генератора штрих‑кодов в Java."
type: docs
weight: 752
...
Публичный интерфейс для пользовательского генератора штрих‑кодов. Реализацию должен предоставить пользователь.

 **Remarks:** 

Экземпляр генератора должен быть передан через свойство [FieldOptions.getBarcodeGenerator()](../../com.aspose.words/fieldoptions/\#getBarcodeGenerator) / [FieldOptions.setBarcodeGenerator(com.aspose.words.IBarcodeGenerator)](../../com.aspose.words/fieldoptions/\#setBarcodeGenerator-com.aspose.words.IBarcodeGenerator).
...
| Метод | Описание |
| --- | --- |
| [getBarcodeImage(BarcodeParameters parameters)](#getBarcodeImage-com.aspose.words.BarcodeParameters) | Создайте изображение штрих‑кода, используя набор параметров (для поля DisplayBarcode). |
| [getOldBarcodeImage(BarcodeParameters parameters)](#getOldBarcodeImage-com.aspose.words.BarcodeParameters) | Создайте изображение штрих‑кода, используя набор параметров (для традиционного поля Barcode). |
...
Создайте изображение штрих‑кода, используя набор параметров (для поля DisplayBarcode).

 **Remarks:** 

Поддерживаемые форматы изображений: Bmp, Emf, Gif, Jpeg, Png, Tiff, Wmf, Pict, Ico, WebP, Svg.
...
**Returns:**
java.awt.image.BufferedImage — поток данных изображения, представляющий сгенерированный штрих‑код.
...
Создайте изображение штрих‑кода, используя набор параметров (для традиционного поля Barcode).
