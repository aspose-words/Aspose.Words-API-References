...
Определяет текст и номер страницы для записи в таблице полномочий, которая используется полем TOA.
## Методы
...
| [getEntryCategory()](#getEntryCategory--) | Получает целочисленную категорию записи, которая представляет собой число, соответствующее порядку категорий. |
...
| [getLongCitation()](#getLongCitation--) | Получает длинную цитату для записи. |
...
| [getShortCitation()](#getShortCitation--) | Получает краткую цитату для записи. |
| [getStart()](#getStart--) | Получает узел, представляющий начало поля. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String-) |  |
| [getType()](#getType--) | Получает тип поля Microsoft Word. |
| [hashCode()](#hashCode--) |  |
| [isBold()](#isBold--) | Определяет, следует ли применять полужирное форматирование к номеру страницы для записи. |
| [isBold(boolean value)](#isBold-boolean-) | Устанавливает, следует ли применять полужирное форматирование к номеру страницы для записи. |
...
| [isItalic()](#isItalic--) | Определяет, следует ли применять курсивное форматирование к номеру страницы для записи. |
| [isItalic(boolean value)](#isItalic-boolean-) | Устанавливает, следует ли применять курсивное форматирование к номеру страницы для записи. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String-) | Устанавливает целостную категорию записи, которая представляет собой число, соответствующее порядку категорий. |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String-) | Устанавливает длинную цитату для записи. |
...
| [setShortCitation(String value)](#setShortCitation-java.lang.String-) | Устанавливает краткую цитату для записи. |
| [toString()](#toString--) |  |
...
Получает целочисленную категорию записи, которая представляет собой число, соответствующее порядку категорий.

**Возвращает:**
java.lang.String — интегральная категория записи, представляющая собой число, соответствующее порядку категорий.
...
Получает длинную цитату для записи.

**Возвращает:**
java.lang.String — длинная цитата для записи.
...
Получает краткую цитату для записи.

**Возвращает:**
java.lang.String — краткая цитата для записи.
### getStart() {#getStart--}
```
...
Определяет, следует ли применять полужирное форматирование к номеру страницы для записи.

**Возвращает:**
boolean — применять ли полужирное форматирование к номеру страницы для записи.
...
Устанавливает, следует ли применять полужирное форматирование к номеру страницы для записи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли применять полужирное форматирование к номеру страницы для записи. |
...
Определяет, следует ли применять курсивное форматирование к номеру страницы для записи.

**Возвращает:**
boolean — применять ли курсив к номеру страницы для записи.
...
Устанавливает, следует ли применять курсивное форматирование к номеру страницы для записи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли применять курсивное форматирование к номеру страницы для записи. |
...
Устанавливает целостную категорию записи, которая представляет собой число, соответствующее порядку категорий.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Интегральная категория записи, представляющая собой число, соответствующее порядку категорий. |
...
Устанавливает длинную цитату для записи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Длинная цитата для записи. |
...
Устанавливает краткую цитату для записи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Краткая цитата для записи. |
