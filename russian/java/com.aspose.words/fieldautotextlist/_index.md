...
description: "Реализует поле AUTOTEXTLIST в Java."
type: docs
weight: 205
url: /ru/java/com.aspose.words/fieldautotextlist/
---
...
Создаёт контекстное меню на основе записей AutoText в активном шаблоне.

 **Examples:** 

Показывает, как использовать поле AUTOTEXTLIST для выбора из списка записей AutoText.
...
| [getEntryName()](#getEntryName) | Получает имя записи AutoText. |
...
| [getListStyle()](#getListStyle) | Получает имя стиля, на основе которого формируется список содержащих записи. |
...
| [getScreenTip()](#getScreenTip) | Получает текст всплывающей подсказки ScreenTip. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | Устанавливает имя записи AutoText. |
| [setListStyle(String value)](#setListStyle-java.lang.String) | Устанавливает имя стиля, на основе которого формируется список содержащих записи. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Устанавливает текст всплывающей подсказки ScreenTip. |
...
**Returns:**
java.lang.String - Имя записи AutoText.
...
Получает имя стиля, на основе которого формируется список содержащих записи.
...
**Returns:**
java.lang.String - Имя стиля, на основе которого формируется список содержащих записи.
...
Получает текст всплывающей подсказки ScreenTip.
...
**Returns:**
java.lang.String - Текст всплывающей подсказки ScreenTip.
...
Устанавливает имя записи AutoText.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя записи AutoText. |
...
Устанавливает имя стиля, на основе которого формируется список содержащих записи.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя стиля, на основе которого формируется список содержащих записи. |
...
Устанавливает текст всплывающей подсказки ScreenTip.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст всплывающей подсказки ScreenTip. |
