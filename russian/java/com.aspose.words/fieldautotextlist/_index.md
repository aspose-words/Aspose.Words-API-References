...
description: Реализует поле АВТОТЕКСТЛИСТ.
type: docs
weight: 162
...
| [getEntryName()](#getEntryName--) | Получает имя записи автотекста. |
...
| [getListStyle()](#getListStyle--) | Получает имя стиля, на котором основан список, содержащий записи. |
...
| [getScreenTip()](#getScreenTip--) | Получает текст всплывающей подсказки для отображения. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String-) | Задает имя записи автотекста. |
| [setListStyle(String value)](#setListStyle-java.lang.String-) | Задает имя стиля, на котором основан список, содержащий записи. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String-) | Устанавливает отображаемый текст всплывающей подсказки. |
| [toString()](#toString--) |  |
...
Получает имя записи автотекста.

**Возвращает:**
java.lang.String — имя записи автотекста.
...
Получает имя стиля, на котором основан список, содержащий записи.

**Возвращает:**
java.lang.String — имя стиля, на котором основан список, содержащий записи.
...
Получает текст всплывающей подсказки для отображения.

**Возвращает:**
java.lang.String — текст отображаемой всплывающей подсказки.
...
Задает имя записи автотекста.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя записи автотекста. |
...
Задает имя стиля, на котором основан список, содержащий записи.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя стиля, на котором основан список, содержащий записи. |
...
Устанавливает отображаемый текст всплывающей подсказки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст всплывающей подсказки для отображения. |
