...
```
 ...
 Предоставляет типизированный доступ к коллекции[Cell](../../com.aspose.words/cell) узлы.
...
| [get(int index)](#get-int-) |  Получает**Cell** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
```
 ...
 Получает**Cell** по заданному индексу.
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Cell](../../com.aspose.words/cell) ценность.
### getClass() {#getClass--}
```
