...
description: "Реализует поле NOTEREF в Java."
type: docs
weight: 265
url: /ru/java/com.aspose.words/fieldnoteref/
---
...
Вставляет метку сноски или концевой сноски, помеченной указанной закладкой.

 **Examples:** 

Показывает, как вставлять поля NOTEREF и изменять их внешний вид.
...
Показывает, как создавать перекрёстные ссылки на сноски с помощью поля NOTEREF.
...
| [getInsertReferenceMark()](#getInsertReferenceMark) | Вставляет ссылочную метку с тем же форматированием символов, что и стиль ссылки на сноску или концевую сноску. |
...
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Вставляет ссылочную метку с тем же форматированием символов, что и стиль ссылки на сноску или концевую сноску. |
...
Вставляет ссылочную метку с тем же форматированием символов, что и стиль ссылки на сноску или концевую сноску.
