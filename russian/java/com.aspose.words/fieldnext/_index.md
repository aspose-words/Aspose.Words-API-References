...
description: "Реализует поле NEXT в Java."
type: docs
weight: 263
url: /ru/java/com.aspose.words/fieldnext/
---
...
Объединяет следующую запись данных с текущим результирующим объединённым документом, вместо создания нового объединённого документа.

 **Examples:** 

Показывает, как использовать поля NEXT/NEXTIF для объединения нескольких строк в одну страницу во время слияния писем.
