...
description: Реализует поле NEXT.
type: docs
weight: 220
...
Слияние следующей записи данных с текущим результирующим объединенным документом вместо создания нового объединенного документа.
## Методы
