...
description: "Реализует поле LISTNUM в Java."
type: docs
weight: 255
url: /ru/java/com.aspose.words/fieldlistnum/
---
...
| [getListLevel()](#getListLevel) | Получает уровень в списке, переопределяя поведение поля по умолчанию. |
| [getListName()](#getListName) | Получает имя определения абстрактной нумерации, используемого для нумерации. |
...
| [getStartingNumber()](#getStartingNumber) | Получает начальное значение для этого поля. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Получает тип поля Microsoft Word. |
| [hasListName()](#hasListName) | Возвращает значение, указывающее, предоставлено ли имя определения абстрактной нумерации кодом поля. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | Устанавливает уровень в списке, переопределяя поведение поля по умолчанию. |
| [setListName(String value)](#setListName-java.lang.String) | Устанавливает имя определения абстрактной нумерации, используемого для нумерации. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | Устанавливает начальное значение для этого поля. |
...
Получает уровень в списке, переопределяя поведение поля по умолчанию.
...
**Returns:**
java.lang.String — уровень в списке, переопределяющий поведение поля по умолчанию.
...
Получает имя определения абстрактной нумерации, используемого для нумерации.
...
**Returns:**
java.lang.String — имя определения абстрактной нумерации, используемого для нумерации.
...
Получает начальное значение для этого поля.
...
**Returns:**
java.lang.String — начальное значение для этого поля.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Возвращает значение, указывающее, предоставлено ли имя определения абстрактной нумерации кодом поля.
...
**Returns:**
boolean — значение, указывающее, предоставлено ли имя определения абстрактной нумерации кодом поля.
### isDirty() {#isDirty}
```
...
Устанавливает уровень в списке, переопределяя поведение поля по умолчанию.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Уровень в списке, переопределяющий поведение поля по умолчанию. |
...
Устанавливает имя определения абстрактной нумерации, используемого для нумерации.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя определения абстрактной нумерации, используемого для нумерации. |
...
Устанавливает начальное значение для этого поля.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Начальное значение для этого поля. |
