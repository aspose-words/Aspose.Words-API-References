...
| [hasListName()](#hasListName--) | Возвращает значение, указывающее, предоставляется ли имя определения абстрактной нумерации кодом поля. |
| [hashCode()](#hashCode--) |  |
...
| [setListLevel(String value)](#setListLevel-java.lang.String-) | Задает уровень в списке, переопределяя поведение поля по умолчанию. |
| [setListName(String value)](#setListName-java.lang.String-) | Задает имя определения абстрактной нумерации, используемого для нумерации. |
...
**Возвращает:**
boolean — значение, указывающее, предоставляется ли имя определения абстрактной нумерации кодом поля.
### hashCode() {#hashCode--}
```
...
Задает уровень в списке, переопределяя поведение поля по умолчанию.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Уровень в списке, переопределяющий поведение поля по умолчанию. |
...
Задает имя определения абстрактной нумерации, используемого для нумерации.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя определения абстрактной нумерации, используемого для нумерации. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Начальное значение для этого поля. |
