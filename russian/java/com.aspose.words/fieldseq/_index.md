...
description: "Реализует поле SEQ в Java."
type: docs
weight: 284
...
Последовательно нумерует главы, таблицы, рисунки и другие пользовательские списки элементов в документе.

 **Examples:** 

Показывает, как заполнить поле оглавления (TOC) записями, используя поля SEQ.
...
Показывает, как создать нумерацию, используя поля SEQ.
...
| Метод | Описание |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Получает имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении. |
...
| [getInsertNextNumber()](#getInsertNextNumber) | Получает, следует ли вставлять следующий номер последовательности для указанного элемента. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getResetHeadingLevel()](#getResetHeadingLevel) | Получает целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. |
| [getResetNumber()](#getResetNumber) | Получает целое число, к которому следует сбросить номер последовательности. |
...
| [getSequenceIdentifier()](#getSequenceIdentifier) | Получает имя, назначенное серии элементов, которые должны быть пронумерованы. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Устанавливает имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении. |
| [setInsertNextNumber(boolean value)](#setInsertNextNumber-boolean) | Устанавливает, следует ли вставлять следующий номер последовательности для указанного элемента. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setResetHeadingLevel(String value)](#setResetHeadingLevel-java.lang.String) | Устанавливает целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. |
| [setResetNumber(String value)](#setResetNumber-java.lang.String) | Устанавливает целое число, к которому следует сбросить номер последовательности. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSequenceIdentifier(String value)](#setSequenceIdentifier-java.lang.String) | Устанавливает имя, назначенное серии элементов, которые должны быть пронумерованы. |
...
Получает имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении.
...
**Returns:**
java.lang.String - Имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении.
...
Получает, следует ли вставлять следующий номер последовательности для указанного элемента.
...
**Returns:**
boolean - Нужно ли вставлять следующий номер последовательности для указанного элемента.
...
Получает целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
...
**Returns:**
java.lang.String - Целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности.
...
Получает целое число, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
...
**Returns:**
java.lang.String - Целое число, к которому следует сбросить номер последовательности.
### getResult() {#getResult}
```
...
Получает имя, назначенное серии элементов, которые должны быть пронумерованы.
...
**Returns:**
java.lang.String - Имя, назначенное серии элементов, которые должны быть пронумерованы.
### getStart() {#getStart}
```
...
Устанавливает имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя закладки, которое ссылается на элемент в другом месте документа, а не в текущем расположении. |
...
Устанавливает, следует ли вставлять следующий номер последовательности для указанного элемента.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли вставлять следующий номер последовательности для указанного элемента. |
...
Устанавливает целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. |
...
Устанавливает целое число, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Целое число, к которому следует сбросить номер последовательности. |
...
Устанавливает имя, назначенное серии элементов, которые должны быть пронумерованы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя, назначенное серии элементов, которые должны быть пронумерованы. |
