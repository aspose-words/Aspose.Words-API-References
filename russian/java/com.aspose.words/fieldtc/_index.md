...
description: "Реализует поле TC в Java."
type: docs
weight: 293
...
Определяет текст и номер страницы для записи оглавления (включая список иллюстраций), которая используется полем TOC.
...
| [getOmitPageNumber()](#getOmitPageNumber) | Определяет, следует ли опустить номер страницы в TOC для этого поля. |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Устанавливает уровень записи. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Устанавливает, следует ли опустить номер страницы в TOC для этого поля. |
...
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Устанавливает идентификатор типа для этого поля (обычно это буква). |
...
Определяет, следует ли опустить номер страницы в TOC для этого поля.
...
**Returns:**
boolean - Нужно ли опустить номер страницы в TOC для этого поля.
### getPageNumber() {#getPageNumber}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Уровень записи. |
...
Устанавливает, следует ли опустить номер страницы в TOC для этого поля.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли опустить номер страницы в Оглавлении для этого поля. |
...
Устанавливает идентификатор типа для этого поля (обычно это буква).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор типа для этого поля (обычно это буква). |
