...
description: "Базовый класс для узлов уровня inline, которые могут иметь связанную символьную форматировку, но не могут иметь собственных дочерних узлов в Java."
type: docs
weight: 403
...
Базовый класс для узлов уровня inline, которые могут иметь связанную символьную форматировку, но не могут иметь собственных дочерних узлов.

Чтобы узнать больше, посетите статью документации [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document].

 **Remarks:** 

Класс, производный от [Inline](../../com.aspose.words/inline/), может быть дочерним элементом [Paragraph](../../com.aspose.words/paragraph/).
