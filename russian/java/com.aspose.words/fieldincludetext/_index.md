...
| [getEncoding()](#getEncoding--) | Получает кодировку, применяемую к данным в указанном файле. |
...
| [getMimeType()](#getMimeType--) | Получает тип MIME указанного файла. |
| [getNamespaceMappings()](#getNamespaceMappings--) | Получает сопоставления пространств имен для запросов XPath. |
...
| [getSourceFullName()](#getSourceFullName--) | Получает расположение документа с помощью IRI. |
...
| [getXslTransformation()](#getXslTransformation--) | Получает расположение XSL-преобразования для форматирования XML-данных. |
| [hashCode()](#hashCode--) |  |
...
| [setEncoding(String value)](#setEncoding-java.lang.String-) | Устанавливает кодировку, применяемую к данным в указанном файле. |
...
| [setMimeType(String value)](#setMimeType-java.lang.String-) | Задает тип MIME для файла, на который указывает ссылка. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String-) | Задает сопоставления пространств имен для запросов XPath. |
| [setResult(String value)](#setResult-java.lang.String-) | Задает текст, который находится между разделителем полей и концом поля. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String-) | Устанавливает местоположение документа с помощью IRI. |
...
| [setXPath(String value)](#setXPath-java.lang.String-) | Задает XPath для нужной части XML-файла. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String-) | Задает расположение преобразования XSL для форматирования данных XML. |
| [toString()](#toString--) |  |
...
Получает кодировку, применяемую к данным в указанном файле.

**Возвращает:**
java.lang.String — кодировка, применяемая к данным в указанном файле.
### getEnd() {#getEnd--}
```
...
Получает тип MIME указанного файла.

**Возвращает:**
java.lang.String — тип MIME файла, на который указывает ссылка.
...
Получает сопоставления пространств имен для запросов XPath.

**Возвращает:**
java.lang.String — сопоставления пространств имен для запросов XPath.
### getResult() {#getResult--}
```
...
Получает расположение документа с помощью IRI.
...
Получает расположение XSL-преобразования для форматирования XML-данных.

**Возвращает:**
java.lang.String — расположение преобразования XSL для форматирования данных XML.
### hashCode() {#hashCode--}
```
...
Устанавливает кодировку, применяемую к данным в указанном файле.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Кодировка, применяемая к данным в указанном файле. |
...
Задает тип MIME для файла, на который указывает ссылка.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Тип MIME файла, на который указывает ссылка. |
...
Задает сопоставления пространств имен для запросов XPath.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Сопоставления пространств имен для запросов XPath. |
...
Устанавливает местоположение документа с помощью IRI.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Расположение документа с использованием IRI. |
...
Задает XPath для нужной части XML-файла.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | XPath для нужной части файла XML. |
...
Задает расположение преобразования XSL для форматирования данных XML.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Расположение преобразования XSL для форматирования данных XML. |
