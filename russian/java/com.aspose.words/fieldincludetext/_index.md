...
description: "Реализует поле INCLUDETEXT в Java."
type: docs
weight: 248
url: /ru/java/com.aspose.words/fieldincludetext/
---
...
| [getEncoding()](#getEncoding) | Получает кодировку, применяемую к данным в ссылочном файле. |
...
| [getMimeType()](#getMimeType) | Получает MIME‑тип ссылочного файла. |
| [getNamespaceMappings()](#getNamespaceMappings) | Получает сопоставления пространств имён для запросов XPath. |
...
| [getSourceFullName()](#getSourceFullName) | Получает расположение документа с использованием IRI. |
...
| [getXPath()](#getXPath) | Получает XPath для нужной части XML‑файла. |
| [getXslTransformation()](#getXslTransformation) | Получает расположение XSL‑трансформации для форматирования XML‑данных. |
...
| [setEncoding(String value)](#setEncoding-java.lang.String) | Устанавливает кодировку, применяемую к данным в ссылочном файле. |
...
| [setMimeType(String value)](#setMimeType-java.lang.String) | Устанавливает MIME‑тип ссылочного файла. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | Устанавливает сопоставления пространств имён для запросов XPath. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Устанавливает расположение документа с использованием IRI. |
...
| [setXPath(String value)](#setXPath-java.lang.String) | Устанавливает XPath для нужной части XML‑файла. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | Устанавливает расположение XSL‑трансформации для форматирования XML‑данных. |
...
Получает кодировку, применяемую к данным в ссылочном файле.
...
**Returns:**
java.lang.String - Кодировка, применяемая к данным в ссылочном файле.
### getEnd() {#getEnd}
```
...
Получает MIME‑тип ссылочного файла.
...
**Returns:**
java.lang.String - MIME‑тип ссылочного файла.
...
Получает сопоставления пространств имён для запросов XPath.
...
**Returns:**
java.lang.String - Сопоставления пространств имён для запросов XPath.
### getResult() {#getResult}
```
...
Получает расположение документа с использованием IRI.
...
**Returns:**
java.lang.String - Расположение документа с использованием IRI.
### getStart() {#getStart}
```
...
Получает XPath для нужной части XML‑файла.
...
**Returns:**
java.lang.String - XPath для нужной части XML‑файла.
...
Получает расположение XSL‑трансформации для форматирования XML‑данных.
...
**Returns:**
java.lang.String - Расположение XSL‑трансформации для форматирования XML‑данных.
### isDirty() {#isDirty}
```
...
Устанавливает кодировку, применяемую к данным в ссылочном файле.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Кодировка, применяемая к данным в ссылочном файле. |
...
Устанавливает MIME‑тип ссылочного файла.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | MIME‑тип ссылочного файла. |
...
Устанавливает сопоставления пространств имён для запросов XPath.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Сопоставления пространств имён для запросов XPath. |
...
Устанавливает расположение документа с использованием IRI.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Расположение документа с использованием IRI. |
...
Устанавливает XPath для нужной части XML‑файла.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | XPath для нужной части XML‑файла. |
...
Устанавливает расположение XSL‑трансформации для форматирования XML‑данных.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Расположение XSL‑трансформации для форматирования XML‑данных. |
