...
description: Реализует поле ШТРИХ-КОД.
type: docs
weight: 163
...
| [getFacingIdentificationMark()](#getFacingIdentificationMark--) | Получает тип метки идентификации лицевой стороны (FIM) для вставки. |
...
| [getPostalAddress()](#getPostalAddress--) | Получает почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается. |
...
| [hashCode()](#hashCode--) |  |
| [isBookmark()](#isBookmark--) |  Получает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки. |
| [isBookmark(boolean value)](#isBookmark-boolean-) |  Устанавливает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки. |
...
| [isUSPostalAddress()](#isUSPostalAddress--) |  Получает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) США |
| [isUSPostalAddress(boolean value)](#isUSPostalAddress-boolean-) |  Устанавливает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) США |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove()](#remove--) | Удаляет поле из документа. |
| [setFacingIdentificationMark(String value)](#setFacingIdentificationMark-java.lang.String-) | Устанавливает тип метки идентификации лицевой стороны (FIM) для вставки. |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setPostalAddress(String value)](#setPostalAddress-java.lang.String-) | Устанавливает почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается. |
...
Получает тип метки идентификации лицевой стороны (FIM) для вставки.

**Возвращает:**
java.lang.String — тип вставляемой идентификационной метки лицевой стороны (FIM).
...
Получает почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается.

**Возвращает:**
java.lang.String — почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается.
### getResult() {#getResult--}
```
...
```
 ...
 Получает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки.

**Возвращает:**
 логическое значение - ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки.
...
```
 ...
 Устанавливает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean |  Будь то[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) это имя закладки. |
...
```
 ...
 Получает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) является почтовым адресом США.

**Возвращает:**
 логическое значение - ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) США
...
```
 ...
 Устанавливает ли[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) является почтовым адресом США.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean |  Будь то[getPostalAddress()](../../com.aspose.words/fieldbarcode\#getPostalAddress--) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode\#setPostalAddress-java.lang.String-) США |
...
Устанавливает тип метки идентификации лицевой стороны (FIM) для вставки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Тип вставляемой идентификационной метки лицевой стороны (FIM). |
...
Устанавливает почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Почтовый адрес, используемый для создания штрих-кода, или название закладки, которая на него ссылается. |
