...
description: "Реализует поле BARCODE в Java."
type: docs
weight: 206
url: /ru/java/com.aspose.words/fieldbarcode/
---
...
Показывает, как использовать поле BARCODE для отображения почтовых индексов США в виде штрих‑кода.
...
| [getFacingIdentificationMark()](#getFacingIdentificationMark) | Получает тип маркировки Facing Identification Mark (FIM) для вставки. |
...
| [getPostalAddress()](#getPostalAddress) | Получает почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него. |
...
| [isBookmark()](#isBookmark) | Получает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки. |
| [isBookmark(boolean value)](#isBookmark-boolean) | Устанавливает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки. |
...
| [isUSPostalAddress()](#isUSPostalAddress) | Получает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) США. |
| [isUSPostalAddress(boolean value)](#isUSPostalAddress-boolean) | Устанавливает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) США. |
| [remove()](#remove) | Удаляет поле из документа. |
| [setFacingIdentificationMark(String value)](#setFacingIdentificationMark-java.lang.String) | Устанавливает тип маркировки Facing Identification Mark (FIM) для вставки. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setPostalAddress(String value)](#setPostalAddress-java.lang.String) | Устанавливает почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него. |
...
Получает тип маркировки Facing Identification Mark (FIM) для вставки.
...
**Returns:**
java.lang.String — тип маркировки Facing Identification Mark (FIM) для вставки.
...
Получает почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него.
...
**Returns:**
java.lang.String — почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него.
### getResult() {#getResult}
```
...
Получает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки.
...
**Returns:**
boolean — является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки.
...
Устанавливает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) именем закладки. |
...
Получает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) почтовым адресом США.
...
**Returns:**
boolean — является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) США.
...
Устанавливает, является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) почтовым адресом США.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Является ли [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String) США. |
...
Устанавливает тип маркировки Facing Identification Mark (FIM) для вставки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Тип маркировки Facing Identification Mark (FIM) для вставки. |
...
Устанавливает почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Почтовый адрес, используемый для создания штрих‑кода, или имя закладки, ссылающейся на него. |
