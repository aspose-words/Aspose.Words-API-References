...
description: "Представляет коллекцию объектов ChartSeries в Java."
type: docs
weight: 86
...
Представляет коллекцию объектов [ChartSeries](../../com.aspose.words/chartseries/).
...
| Метод | Описание |
| --- | --- |
| [add(String seriesName, ChartMultilevelValue[] categories, double[] values)](#add-java.lang.String-com.aspose.words.ChartMultilevelValue---double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, double[] xValues)](#add-java.lang.String-double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, double[] xValues, double[] yValues)](#add-java.lang.String-double---double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, double[] xValues, double[] yValues, double[] bubbleSizes)](#add-java.lang.String-double---double---double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, String[] categories, double[] values)](#add-java.lang.String-java.lang.String---double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, String[] categories, double[] values, boolean[] isSubtotal)](#add-java.lang.String-java.lang.String---double---boolean) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
| [add(String seriesName, Date[] dates, double[] values)](#add-java.lang.String-java.util.Date---double) | Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. |
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод для добавления серий, имеющих многоуровневые категории данных.
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод для добавления серий в диаграммы Histogram.

 **Remarks:** 

Для типов диаграмм, отличных от Histogram, этот метод добавляет серию с пустыми значениями Y.

 **Examples:** 

Показывает, как создать диаграмму histogram.
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любому типу диаграмм Scatter.
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любому типу диаграмм Bubble.
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любому типу диаграмм Bar, Column, Line и Surface.
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к диаграммам Waterfall.

 **Remarks:** 

Для типов диаграмм, отличных от Waterfall, значения  isSubtotal  игнорируются.

 **Examples:** 

Показывает, как создать диаграмму Waterfall.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| seriesName | java.lang.String | Имя серии, которую нужно добавить. |
| categories | java.lang.String[] | Имена категорий для оси X. |
| значения | double[] | Значения оси Y. |
...
Добавляет новый [ChartSeries](../../com.aspose.words/chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любому типу диаграмм Area, Radar и Stock.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Нулевой индекс [ChartSeries](../../com.aspose.words/chartseries/) для удаления. |
