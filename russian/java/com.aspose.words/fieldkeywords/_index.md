...
description: "Реализует поле KEYWORDS в Java."
type: docs
weight: 252
url: /ru/java/com.aspose.words/fieldkeywords/
---
...
Получает и при необходимости задаёт ключевые слова документа, как они записаны в свойстве **Keywords** встроенных свойств документа.
...
| [getText()](#getText) | Получает текст ключевых слов. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст ключевых слов. |
...
**Returns:**
java.lang.String - Текст ключевых слов.
### getType() {#getType}
```
public int getType()
```
...
Устанавливает текст ключевых слов.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст ключевых слов. |
