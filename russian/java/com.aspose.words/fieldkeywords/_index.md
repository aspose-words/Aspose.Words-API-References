...
Реализует поле KEYWORDS.
 ...
 Извлекает и, при необходимости, устанавливает ключевые слова документа, записанные в**Keywords** свойство встроенных свойств документа.
## Методы
...
| [setText(String value)](#setText-java.lang.String-) | Задает текст ключевых слов. |
| [toString()](#toString--) |  |
...
Задает текст ключевых слов.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст ключевых слов. |
