...
type: docs
weight: 493
url: /ru/java/com.aspose.words/rowcollection/
---
...
```
 ...
 Предоставляет типизированный доступ к коллекции[Row](../../com.aspose.words/row) узлы.
...
| [get(int index)](#get-int-) |  Получает**Row** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
```
 ...
 Получает**Row** по заданному индексу.
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Row](../../com.aspose.words/row) ценность.
### getClass() {#getClass--}
```
...
**Возвращает:**
com.aspose.words.Node[] — массив строк.
### toString() {#toString--}
```
