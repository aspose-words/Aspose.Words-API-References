...
description: "Обеспечивает типизированный доступ к коллекции узлов Row в Java."
type: docs
weight: 589
...
Обеспечивает типизированный доступ к коллекции узлов [Row](../../com.aspose.words/row/).
...
| [get(int index)](#get-int) | Получает [Row](../../com.aspose.words/row/) по заданному индексу. |
...
Получает [Row](../../com.aspose.words/row/) по заданному индексу.
