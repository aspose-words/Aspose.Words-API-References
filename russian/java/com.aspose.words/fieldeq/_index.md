...
description: Реализует поле эквалайзера.
type: docs
weight: 183
url: /ru/java/com.aspose.words/fieldeq/
---
...
| Метод | Описание |
| --- | --- |
| [asOfficeMath()](#asOfficeMath--) | Возвращает объект Office Math, соответствующий полю EQ. |
...
**Возвращает:**
[OfficeMath](../../com.aspose.words/officemath) - Возвращает null, если код поля пуст или недействителен, в противном случае[OfficeMath](../../com.aspose.words/officemath) пример.
### equals(Object arg0) {#equals-java.lang.Object-}
```
