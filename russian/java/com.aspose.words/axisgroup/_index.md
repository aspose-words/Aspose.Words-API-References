...
description: "Представляет тип группы осей диаграммы в Java."
type: docs
weight: 27
url: /ru/java/com.aspose.words/axisgroup/
---
...
| Поле | Описание |
| --- | --- |
| [PRIMARY](#PRIMARY) | Указывает основную группу осей. |
| [SECONDARY](#SECONDARY) | Указывает вторичную группу осей. |
| [length](#length) |  |
## Методы
...
Указывает основную группу осей.
...
Указывает вторичную группу осей.
