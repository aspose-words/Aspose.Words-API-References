...
description: "Реализует поле FILENAME в Java."
type: docs
weight: 230
url: /ru/java/com.aspose.words/fieldfilename/
---
...
В текущей реализации используется свойство [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) для получения имени файла. Если документ был загружен из потока или создан пустым, используется имя файла, в который сохраняется документ (если известно).

 **Examples:** 

Показывает, как использовать FieldOptions для переопределения значения по умолчанию поля FILENAME.
...
| [getIncludeFullPath()](#getIncludeFullPath) | Получает, следует ли включать полное имя пути к файлу. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Устанавливает, следует ли включать полное имя пути к файлу. |
...
Получает, следует ли включать полное имя пути к файлу.
...
**Returns:**
boolean — следует ли включать полное имя пути к файлу.
...
Устанавливает, следует ли включать полное имя пути к файлу.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли включать полное имя пути к файлу. |
