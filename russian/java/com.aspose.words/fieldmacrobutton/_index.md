...
description: "Реализует поле MACROBUTTON в Java."
type: docs
weight: 256
url: /ru/java/com.aspose.words/fieldmacrobutton/
---
...
Показывает, как использовать поля MACROBUTTON, чтобы запускать макросы документа щелчком.
...
| [getDisplayText()](#getDisplayText) | Возвращает текст, отображаемый как "button", выбранный для запуска макроса или команды. |
...
| [getMacroName()](#getMacroName) | Возвращает имя макроса или команды для запуска. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Устанавливает текст, отображаемый как "button", выбранный для запуска макроса или команды. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Устанавливает имя макроса или команды для запуска. |
...
Возвращает текст, отображаемый как "button", выбранный для запуска макроса или команды.
...
**Returns:**
java.lang.String - Текст, отображаемый как "button", выбранный для запуска макроса или команды.
### getEnd() {#getEnd}
```
...
Возвращает имя макроса или команды для запуска.
...
**Returns:**
java.lang.String - Имя макроса или команды для выполнения.
### getMergeFieldName() {#getMergeFieldName}
```
...
Устанавливает текст, отображаемый как "button", выбранный для запуска макроса или команды.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст, который будет отображаться как "кнопка", выбранная для выполнения макроса или команды. |
...
Устанавливает имя макроса или команды для запуска.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя макроса или команды для выполнения. |
