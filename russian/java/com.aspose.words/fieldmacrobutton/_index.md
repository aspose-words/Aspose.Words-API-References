...
| [getDisplayText()](#getDisplayText--) | Получает текст, отображаемый как «кнопка», выбранная для запуска макроса или команды. |
...
| [getMacroName()](#getMacroName--) | Получает имя макроса или команды для запуска. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String-) | Задает отображение текста в виде «кнопки», выбранной для запуска макроса или команды. |
...
Получает текст, отображаемый как «кнопка», выбранная для запуска макроса или команды.

**Возвращает:**
java.lang.String — текст, отображаемый как «кнопка», выбранная для запуска макроса или команды.
### getEnd() {#getEnd--}
```
...
Получает имя макроса или команды для запуска.

**Возвращает:**
java.lang.String — имя макроса или команды для запуска.
### getMergeFieldName() {#getMergeFieldName--}
```
...
Задает отображение текста в виде «кнопки», выбранной для запуска макроса или команды.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст, который будет отображаться как «кнопка», выбранная для запуска макроса или команды. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя макроса или команды для запуска. |
