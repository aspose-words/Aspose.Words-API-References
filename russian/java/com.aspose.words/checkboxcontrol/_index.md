...
description: "Элемент управления CheckBox переключает значение в Java."
type: docs
weight: 100
url: /ru/java/com.aspose.words/checkboxcontrol/
---
...
Он имеет три возможных состояния: выбранное, очищенное и ни выбранное, ни очищенное, что означает комбинацию состояний включено и выключено.
...
| [getChecked()](#getChecked) | Получает логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Устанавливает логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет. |
...
Получает логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет. Значение по умолчанию —  false .
...
**Returns:**
boolean - Логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет.
...
Устанавливает логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет. Значение по умолчанию —  false .
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Логическое значение, указывающее, отмечен ли данный [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) или нет. |
