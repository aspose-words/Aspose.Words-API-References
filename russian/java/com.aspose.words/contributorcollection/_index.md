...
description: "Представляет участников библиографического источника в Java."
type: docs
weight: 129
url: /ru/java/com.aspose.words/contributorcollection/
---
...
| Метод | Описание |
| --- | --- |
| [getArtist()](#getArtist) | Получает исполнителя источника. |
| [getAuthor()](#getAuthor) | Получает автора источника. |
| [getBookAuthor()](#getBookAuthor) | Получает автора книги источника. |
| [getCompiler()](#getCompiler) | Получает компилятора источника. |
| [getComposer()](#getComposer) | Получает композитора источника. |
| [getConductor()](#getConductor) | Получает дирижёра источника. |
| [getCounsel()](#getCounsel) | Получает советника источника. |
| [getDirector()](#getDirector) | Получает режиссёра источника. |
| [getEditor()](#getEditor) | Получает редактора источника. |
| [getInterviewee()](#getInterviewee) | Получает интервьюируемого источника. |
| [getInterviewer()](#getInterviewer) | Получает интервьюера источника. |
| [getInventor()](#getInventor) | Получает изобретателя источника. |
| [getPerformer()](#getPerformer) | Получает исполнителя источника. |
| [getProducer()](#getProducer) | Получает продюсера источника. |
| [getTranslator()](#getTranslator) | Получает переводчика источника. |
| [getWriter()](#getWriter) | Получает писателя источника. |
| [iterator()](#iterator) |  |
| [setArtist(Contributor value)](#setArtist-com.aspose.words.Contributor) | Устанавливает художника источника. |
| [setAuthor(Contributor value)](#setAuthor-com.aspose.words.Contributor) | Устанавливает автора источника. |
| [setBookAuthor(Contributor value)](#setBookAuthor-com.aspose.words.Contributor) | Устанавливает автора книги источника. |
| [setCompiler(Contributor value)](#setCompiler-com.aspose.words.Contributor) | Устанавливает составителя источника. |
| [setComposer(Contributor value)](#setComposer-com.aspose.words.Contributor) | Устанавливает композитора источника. |
| [setConductor(Contributor value)](#setConductor-com.aspose.words.Contributor) | Устанавливает дирижёра источника. |
| [setCounsel(Contributor value)](#setCounsel-com.aspose.words.Contributor) | Устанавливает советника источника. |
| [setDirector(Contributor value)](#setDirector-com.aspose.words.Contributor) | Устанавливает режиссёра источника. |
| [setEditor(Contributor value)](#setEditor-com.aspose.words.Contributor) | Устанавливает редактора источника. |
| [setInterviewee(Contributor value)](#setInterviewee-com.aspose.words.Contributor) | Устанавливает интервьюируемого источника. |
| [setInterviewer(Contributor value)](#setInterviewer-com.aspose.words.Contributor) | Устанавливает интервьюера источника. |
| [setInventor(Contributor value)](#setInventor-com.aspose.words.Contributor) | Устанавливает изобретателя источника. |
| [setPerformer(Contributor value)](#setPerformer-com.aspose.words.Contributor) | Устанавливает исполнителя источника. |
| [setProducer(Contributor value)](#setProducer-com.aspose.words.Contributor) | Устанавливает производителя источника. |
| [setTranslator(Contributor value)](#setTranslator-com.aspose.words.Contributor) | Устанавливает переводчика источника. |
| [setWriter(Contributor value)](#setWriter-com.aspose.words.Contributor) | Устанавливает писателя источника. |
### getArtist() {#getArtist}
```
...
Получает исполнителя источника.
...
Получает автора книги источника.
...
Получает компилятора источника.
...
Получает композитора источника.
...
Получает интервьюируемого источника.
...
Получает интервьюера источника.
...
Получает изобретателя источника.
...
Получает переводчика источника.
...
Устанавливает художника источника.
...
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Художник источника. |
...
Устанавливает автора источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Автор источника. |
...
Устанавливает автора книги источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Автор книги источника. |
...
Устанавливает составителя источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Компилятор источника. |
...
Устанавливает композитора источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Композитор источника. |
...
Устанавливает дирижёра источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Дирижёр источника. |
...
Устанавливает советника источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Советник источника. |
...
Устанавливает режиссёра источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Режиссёр источника. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Редактор источника. |
...
Устанавливает интервьюируемого источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Интервьюируемый источника. |
...
Устанавливает интервьюера источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Интервьюер источника. |
...
Устанавливает изобретателя источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Изобретатель источника. |
...
Устанавливает исполнителя источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Исполнитель источника. |
...
Устанавливает производителя источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Производитель источника. |
...
Устанавливает переводчика источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Переводчик источника. |
...
Устанавливает писателя источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Contributor](../../com.aspose.words/contributor/) | Писатель источника. |
