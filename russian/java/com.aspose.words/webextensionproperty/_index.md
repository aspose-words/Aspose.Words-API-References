...
description: "Указывает пользовательское свойство веб‑расширения в Java."
type: docs
weight: 730
url: /ru/java/com.aspose.words/webextensionproperty/
---
...
| --- | --- |
| [WebExtensionProperty(String name, String value)](#WebExtensionProperty-java.lang.String-java.lang.String) | Создаёт пользовательское свойство веб‑расширения с указанным именем и значением. |
## Методы

| Метод | Описание |
| --- | --- |
| [getName()](#getName) | Указывает имя пользовательского свойства |
| [getValue()](#getValue) | Указывает значение пользовательского свойства. |
| [setName(String value)](#setName-java.lang.String) | Указывает имя пользовательского свойства |
| [setValue(String value)](#setValue-java.lang.String) | Указывает значение пользовательского свойства. |
...
Создаёт пользовательское свойство веб‑расширения с указанным именем и значением.
