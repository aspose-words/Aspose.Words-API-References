...
description: "Представляет список источников библиографии, доступных в документе, в Java."
type: docs
weight: 38
url: /ru/java/com.aspose.words/bibliography/
---
...
| Метод | Описание |
| --- | --- |
| [getBibliographyStyle()](#getBibliographyStyle) | Получает строку, представляющую имя активного стиля, используемого для библиографии. |
| [getSources()](#getSources) | Получает коллекцию, представляющую все источники, содержащиеся в библиографии. |
| [setBibliographyStyle(String value)](#setBibliographyStyle-java.lang.String) | Устанавливает строку, представляющую имя активного стиля, используемого для библиографии. |
...
Получает строку, представляющую имя активного стиля, используемого для библиографии.
...
**Returns:**
java.lang.String - Строка, представляющая имя активного стиля, используемого для библиографии.
...
Получает коллекцию, представляющую все источники, содержащиеся в библиографии.
...
**Returns:**
java.util.ArrayList - Коллекция, представляющая все источники, содержащиеся в библиографии.
...
Устанавливает строку, представляющую имя активного стиля, используемого для библиографии.
...
| --- | --- | --- |
| значение | java.lang.String | Строка, представляющая имя активного стиля, используемого для библиографии. |
