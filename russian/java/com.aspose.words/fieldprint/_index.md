...
description: "Реализует поле PRINT в Java."
type: docs
weight: 273
url: /ru/java/com.aspose.words/fieldprint/
---
...
Инструкция для отправки специфичных для принтера управляющих символов выбранному принтеру при печати документа.

 **Examples:** 

Показывает вставку поля PRINT.
...
| [getPostScriptGroup()](#getPostScriptGroup) | Получает прямоугольник рисования, на котором работают инструкции PostScript. |
| [getPrinterInstructions()](#getPrinterInstructions) | Получает специфичные для принтера управляющие символы или инструкции PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | Устанавливает прямоугольник рисования, на котором работают инструкции PostScript. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Устанавливает специфичные для принтера управляющие символы или инструкции PostScript. |
...
Получает прямоугольник рисования, на котором работают инструкции PostScript.
...
**Returns:**
java.lang.String — прямоугольник рисования, на котором работают инструкции PostScript.
...
Получает специфичные для принтера управляющие символы или инструкции PostScript.
...
**Returns:**
java.lang.String — специфичные для принтера управляющие символы или инструкции PostScript.
### getResult() {#getResult}
```
...
Устанавливает прямоугольник рисования, на котором работают инструкции PostScript.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Прямоугольник рисования, на котором работают инструкции PostScript. |
...
Устанавливает специфичные для принтера управляющие символы или инструкции PostScript.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Специфичные для принтера управляющие символы или инструкции PostScript. |
