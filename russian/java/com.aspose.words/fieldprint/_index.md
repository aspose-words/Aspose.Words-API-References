...
description: Реализует поле PRINT.
type: docs
weight: 230
...
| [getPostScriptGroup()](#getPostScriptGroup--) | Получает прямоугольник рисования, с которым работают инструкции PostScript. |
| [getPrinterInstructions()](#getPrinterInstructions--) | Получает характерные для принтера символы управляющего кода или инструкции PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String-) | Задает прямоугольник рисования, с которым работают инструкции PostScript. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String-) | Задает символы управляющего кода или инструкции PostScript для конкретного принтера. |
...
Получает прямоугольник рисования, с которым работают инструкции PostScript.

**Возвращает:**
java.lang.String — прямоугольник рисования, с которым работают инструкции PostScript.
...
Получает характерные для принтера символы управляющего кода или инструкции PostScript.

**Возвращает:**
java.lang.String — символы управляющего кода принтера или инструкции PostScript.
### getResult() {#getResult--}
```
...
Задает прямоугольник рисования, с которым работают инструкции PostScript.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Прямоугольник рисования, с которым работают инструкции PostScript. |
...
Задает символы управляющего кода или инструкции PostScript для конкретного принтера.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Символы управляющего кода принтера или инструкции PostScript. |
