...
description: "Абсолютная позиционная табуляция — это символ, который используется для перемещения позиции на текущей строке текста при отображении этого содержимого WordprocessingML в Java."
type: docs
weight: 10
url: /ru/java/com.aspose.words/absolutepositiontab/
---
...
Табуляция абсолютной позиции — это символ, используемый для перемещения позиции на текущей строке текста при отображении этого содержимого WordprocessingML.
...
Вызывает [DocumentVisitor.visitAbsolutePositionTab(com.aspose.words.AbsolutePositionTab)](../../com.aspose.words/documentvisitor/\#visitAbsolutePositionTab-com.aspose.words.AbsolutePositionTab).
