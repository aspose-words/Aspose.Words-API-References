...
description: Представляет разделитель полей Word, который отделяет код поля от результата поля.
type: docs
weight: 240
...
[FieldSeparator](../../com.aspose.words/fieldseparator) является узлом встроенного уровня и представлен[ControlChar.FIELD\_SEPARATOR\_CHAR](../../com.aspose.words/controlchar\#FIELD-SEPARATOR-CHAR) управляющий символ в документе.

[FieldSeparator](../../com.aspose.words/fieldseparator) может быть только ребенком[Paragraph](../../com.aspose.words/paragraph).
...
Принимает посетителя.
 ...
 Звонки[DocumentVisitor.visitFieldSeparator(com.aspose.words.FieldSeparator)](../../com.aspose.words/documentvisitor\#visitFieldSeparator-com.aspose.words.FieldSeparator-).
...
**Возвращает:**
 инт -\{[NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype\#FIELD-SEPARATOR) . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
