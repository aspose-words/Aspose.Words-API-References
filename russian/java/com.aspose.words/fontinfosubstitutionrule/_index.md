...
description: "Правило подстановки информации о шрифте в Java."
type: docs
weight: 328
url: /ru/java/com.aspose.words/fontinfosubstitutionrule/
---
...
Согласно этому правилу Aspose.Words оценивает все связанные поля в [FontInfo](../../com.aspose.words/fontinfo/) (Panose, Sig и др.) для отсутствующего шрифта и находит наиболее подходящее совпадение среди доступных источников шрифтов. Если [FontInfo](../../com.aspose.words/fontinfo/) недоступен для отсутствующего шрифта, ничего не будет сделано.
