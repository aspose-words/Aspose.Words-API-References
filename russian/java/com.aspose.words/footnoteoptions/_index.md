...
| Метод | Описание |
| --- | --- |
| [getColumns()](#getColumns) | Указывает количество колонок, с которым форматируется область сносок. |
| [getLocation()](#getLocation) |  |
| [getNumberStyle()](#getNumberStyle) | Указывает формат номера для автоматически нумерованных сносок. |
| [getPosition()](#getPosition) | Указывает позицию сносок. |
...
| [setColumns(int value)](#setColumns-int) | Указывает количество колонок, с которым форматируется область сносок. |
...
| [setPosition(int value)](#setPosition-int) | Указывает позицию сносок. |
...
Указывает количество колонок, с которым форматируется область сносок.

 **Remarks:** 

Если это свойство имеет значение 0, область сносок форматируется с количеством колонок, основанным на числе колонок на отображаемой странице. Значение по умолчанию — 0.
...
**Returns:**
int — соответствующее значение типа int. Возвращаемое значение является одной из констант [FootnotePosition](../../com.aspose.words/footnoteposition/).
...
Это свойство действует только когда [getRestartRule()](../../com.aspose.words/footnoteoptions/\#getRestartRule) / [setRestartRule(int)](../../com.aspose.words/footnoteoptions/\#setRestartRule-int) установлено в значение [FootnoteNumberingRule.CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Соответствующее целочисленное значение. Значение должно быть одним из констант [FootnotePosition](../../com.aspose.words/footnoteposition/). |
