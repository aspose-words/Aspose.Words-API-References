...
description: "Предоставляет методы для вставки текста, изображений и другого контента, а также указания форматирования шрифтов, абзацев и разделов в Java."
type: docs
weight: 163
...
Предоставляет методы вставки текста, изображений и другого содержимого, указания шрифта, форматирования абзацев и разделов.

Чтобы узнать больше, посетите статью документации [ Обзор Document Builder ][Document Builder Overview].
...
Создайте [DocumentBuilder](../../com.aspose.words/documentbuilder/) и свяжите его с [Document](../../com.aspose.words/document/).

У [DocumentBuilder](../../com.aspose.words/documentbuilder/) есть внутренний курсор, в который будет вставлен текст при вызове [write(java.lang.String)](../../com.aspose.words/documentbuilder/\#write-java.lang.String), [writeln(java.lang.String)](../../com.aspose.words/documentbuilder/\#writeln-java.lang.String), **M:Aspose.Words.DocumentBuilder.InsertBreak(Aspose.Words.BreakType)** и других методов. Вы можете переместить курсор [DocumentBuilder](../../com.aspose.words/documentbuilder/) в другое место документа, используя различные методы MoveToXXX.

Используйте свойство [getFont()](../../com.aspose.words/documentbuilder/\#getFont) для указания форматирования символов, которое будет применяться ко всему тексту, вставленному начиная с текущей позиции в документе.

Используйте свойство [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat) для указания форматирования абзацев для текущего и всех последующих вставляемых абзацев.

Используйте свойство [getPageSetup()](../../com.aspose.words/documentbuilder/\#getPageSetup) для указания параметров страницы и раздела для текущего раздела и всех последующих вставляемых разделов.

Используйте свойства [getCellFormat()](../../com.aspose.words/documentbuilder/\#getCellFormat) и [getRowFormat()](../../com.aspose.words/documentbuilder/\#getRowFormat) для указания параметров форматирования ячеек таблицы и строк. Используйте методы [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell) и [endRow()](../../com.aspose.words/documentbuilder/\#endRow) для построения таблицы.

Обратите внимание, что свойства [getFont()](../../com.aspose.words/documentbuilder/\#getFont), [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat) и [getPageSetup()](../../com.aspose.words/documentbuilder/\#getPageSetup) обновляются каждый раз, когда вы перемещаетесь в другое место документа, чтобы отразить доступные в новой позиции параметры форматирования.
...
| [DocumentBuilder(DocumentBuilderOptions options)](#DocumentBuilder-com.aspose.words.DocumentBuilderOptions) | Инициализирует новый экземпляр этого класса. |
| [DocumentBuilder(Document doc)](#DocumentBuilder-com.aspose.words.Document) | Инициализирует новый экземпляр этого класса. |
| [DocumentBuilder(Document doc, DocumentBuilderOptions options)](#DocumentBuilder-com.aspose.words.Document-com.aspose.words.DocumentBuilderOptions) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [endBookmark(String bookmarkName)](#endBookmark-java.lang.String) | Помечает текущую позицию в документе как конец закладки. |
| [endColumnBookmark(String bookmarkName)](#endColumnBookmark-java.lang.String) | Помечает текущую позицию в документе как конец закладки столбца. |
| [endEditableRange()](#endEditableRange) | Помечает текущую позицию в документе как конец редактируемого диапазона. |
| [endEditableRange(EditableRangeStart start)](#endEditableRange-com.aspose.words.EditableRangeStart) | Помечает текущую позицию в документе как конец редактируемого диапазона. |
...
| [getCellFormat()](#getCellFormat) | Возвращает объект, представляющий текущие свойства форматирования ячеек таблицы. |
| [getCurrentNode()](#getCurrentNode) | Получает узел, который в данный момент выбран в этом DocumentBuilder. |
| [getCurrentParagraph()](#getCurrentParagraph) | Получает абзац, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/). |
| [getCurrentSection()](#getCurrentSection) | Получает раздел, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/). |
| [getCurrentStory()](#getCurrentStory) | Получает историю, которая в данный момент выбрана в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/). |
| [getCurrentStructuredDocumentTag()](#getCurrentStructuredDocumentTag) | Получает структурированный тег документа, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/). |
...
| [getDocument()](#getDocument) | Получает объект [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document), к которому привязан данный объект. |
...
| [getPageSetup()](#getPageSetup) | Возвращает объект, представляющий текущие параметры страницы и свойства раздела. |
...
| [insertCheckBox(String name, boolean defaultValue, boolean checkedValue, int size)](#insertCheckBox-java.lang.String-boolean-boolean-int) | Вставляет поле формы с флажком в текущей позиции. |
| [insertCheckBox(String name, boolean checkedValue, int size)](#insertCheckBox-java.lang.String-boolean-int) | Вставляет поле формы с флажком в текущей позиции. |
| [insertComboBox(String name, String[] items, int selectedIndex)](#insertComboBox-java.lang.String-java.lang.String---int) | Вставляет поле формы с комбобоксом в текущей позиции. |
...
| [insertField(String fieldCode)](#insertField-java.lang.String) | Вставляет поле Word в документ и обновляет результат поля. |
...
| [insertForms2OleControl(Forms2OleControl forms2OleControl)](#insertForms2OleControl-com.aspose.words.Forms2OleControl) | Вставляет объект [Forms2OleControl](../../com.aspose.words/forms2olecontrol/) в текущую позицию. |
| [insertGroupShape(ShapeBase[] shapes)](#insertGroupShape-com.aspose.words.ShapeBase...) | Группирует переданные в качестве параметра фигуры в новый узел GroupShape, который вставляется в текущую позицию. |
| [insertGroupShape(double left, double top, double width, double height, ShapeBase[] shapes)](#insertGroupShape-double-double-double-double-com.aspose.words.ShapeBase...) | Группирует переданные в качестве параметра фигуры в новый узел GroupShape указанного размера, который вставляется в указанную позицию. |
...
| [insertImage(BufferedImage image, double width, double height)](#insertImage-java.awt.image.BufferedImage-double-double) | Вставляет встроенное изображение из объекта java.awt.image.BufferedImage в документ и масштабирует его до указанного размера. |
...
| [insertImage(String fileName)](#insertImage-java.lang.String) | Вставляет изображение из файла или URL в документ. |
| [insertImage(String fileName, double width, double height)](#insertImage-java.lang.String-double-double) | Вставляет встроенное изображение из файла или URL в документ и масштабирует его до указанного размера. |
...
| [insertOleObjectAsIcon(String fileName, boolean isLinked, String iconFile, String iconCaption)](#insertOleObjectAsIcon-java.lang.String-boolean-java.lang.String-java.lang.String) | Вставляет встроенный или связанный OLE-объект в виде значка в документ. |
| [insertOleObjectAsIcon(String fileName, String progId, boolean isLinked, String iconFile, String iconCaption)](#insertOleObjectAsIcon-java.lang.String-java.lang.String-boolean-java.lang.String-java.lang.String) | Вставляет встроенный или связанный OLE-объект в виде значка в документ. |
...
| [insertTableOfContents(String switches)](#insertTableOfContents-java.lang.String) | Вставляет поле Оглавления (таблица содержимого) в документ. |
...
| [isAtEndOfStructuredDocumentTag()](#isAtEndOfStructuredDocumentTag) | Возвращает **true**, если курсор находится в конце структурированного тега документа. |
| [isAtStartOfParagraph()](#isAtStartOfParagraph) | Возвращает  true  если курсор находится в начале текущего абзаца (до курсора нет текста). |
| [moveTo(Node node)](#moveTo-com.aspose.words.Node) | Перемещает курсор к встроенному узлу или в конец абзаца. |
| [moveToBookmark(String bookmarkName)](#moveToBookmark-java.lang.String) | Перемещает курсор к закладке. |
...
| [moveToCell(int tableIndex, int rowIndex, int columnIndex, int characterIndex)](#moveToCell-int-int-int-int) | Перемещает курсор к ячейке таблицы в текущем разделе. |
...
| [moveToField(Field field, boolean isAfter)](#moveToField-com.aspose.words.Field-boolean) | Перемещает курсор к полю в документе. |
| [moveToHeaderFooter(int headerFooterType)](#moveToHeaderFooter-int) |  |
| [moveToMergeField(String fieldName)](#moveToMergeField-java.lang.String) | Перемещает курсор к указанному полю слияния. |
| [moveToMergeField(String fieldName, boolean isAfter, boolean isDeleteField)](#moveToMergeField-java.lang.String-boolean-boolean) | Перемещает поле слияния к указанному полю слияния. |
| [moveToParagraph(int paragraphIndex, int characterIndex)](#moveToParagraph-int-int) | Перемещает курсор к абзацу в текущем разделе. |
| [moveToSection(int sectionIndex)](#moveToSection-int) | Перемещает курсор в начало тела в указанном разделе. |
| [moveToStructuredDocumentTag(StructuredDocumentTag structuredDocumentTag, int characterIndex)](#moveToStructuredDocumentTag-com.aspose.words.StructuredDocumentTag-int) | Перемещает курсор к структурированному тегу документа. |
| [moveToStructuredDocumentTag(int structuredDocumentTagIndex, int characterIndex)](#moveToStructuredDocumentTag-int-int) | Перемещает курсор к структурированному тегу документа в текущем разделе. |
| [popFont()](#popFont) | Извлекает форматирование символов, ранее сохранённое в стеке. |
...
| [setDocument(Document value)](#setDocument-com.aspose.words.Document) | Устанавливает объект [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document), к которому привязан данный объект. |
...
| [startBookmark(String bookmarkName)](#startBookmark-java.lang.String) | Помечает текущую позицию в документе как начало закладки. |
| [startColumnBookmark(String bookmarkName)](#startColumnBookmark-java.lang.String) | Помечает текущую позицию в документе как начало колонковой закладки. |
| [startEditableRange()](#startEditableRange) | Помечает текущую позицию в документе как начало редактируемого диапазона. |
| [startTable()](#startTable) | Создаёт таблицу в документе. |
| [write(String text)](#write-java.lang.String) | Вставляет строку в документ в текущую позицию вставки. |
...
Создаёт новый объект [DocumentBuilder](../../com.aspose.words/documentbuilder/) и привязывает его к новому объекту [Document](../../com.aspose.words/document/).
...
Создаёт новый объект [DocumentBuilder](../../com.aspose.words/documentbuilder/) и привязывает его к новому объекту [Document](../../com.aspose.words/document/). Можно указать дополнительные параметры построения документа.
...
Создаёт новый объект [DocumentBuilder](../../com.aspose.words/documentbuilder/), привязывает к указанному объекту [Document](../../com.aspose.words/document/). Курсор позиционируется в начале документа.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | Объект [Document](../../com.aspose.words/document/), к которому нужно привязаться. |
...
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | Объект [Document](../../com.aspose.words/document/), к которому нужно привязаться. |
| options | [DocumentBuilderOptions](../../com.aspose.words/documentbuilderoptions/) | Дополнительные параметры процесса построения документа. |
...
Для параметров индекса: когда индекс больше или равен 0, он указывает индекс от начала, где 0 — первый элемент. Когда индекс меньше 0, он указывает индекс от конца, где -1 — последний элемент.
...
Закладки в документе могут перекрываться и охватывать любой диапазон. Чтобы создать корректную закладку, необходимо вызвать как [startBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#startBookmark-java.lang.String), так и [endBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#endBookmark-java.lang.String) с тем же параметром bookmarkName.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| bookmarkName | java.lang.String | Имя закладки. |
...
Помечает текущую позицию в документе как конец столбцовой закладки. Позиция должна находиться в ячейке таблицы.

 **Remarks:** 

Столбцовая закладка охватывает один или несколько столбцов в диапазоне строк. Чтобы создать корректную закладку, необходимо вызвать как [startColumnBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#startColumnBookmark-java.lang.String), так и [endColumnBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#endColumnBookmark-java.lang.String) с тем же параметром bookmarkName.

Некорректно сформированные закладки или закладки с дублирующимися именами будут игнорироваться при сохранении документа.

Фактическое положение вставленного узла [BookmarkEnd](../../com.aspose.words/bookmarkend/) может отличаться от текущего положения построителя документа.
...
Редактируемый диапазон в документе может перекрываться и охватывать любой диапазон. Чтобы создать корректный редактируемый диапазон, необходимо вызвать оба метода [startEditableRange()](../../com.aspose.words/documentbuilder/\#startEditableRange) и [endEditableRange()](../../com.aspose.words/documentbuilder/\#endEditableRange) или [endEditableRange(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentbuilder/\#endEditableRange-com.aspose.words.EditableRangeStart).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| start | [EditableRangeStart](../../com.aspose.words/editablerangestart/) | Начало этого редактируемого диапазона. |
...
Вызовите [endRow()](../../com.aspose.words/documentbuilder/\#endRow), чтобы завершить строку таблицы. Если сразу после этого вызвать [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell), таблица продолжится в новой строке.

Используйте свойство [getRowFormat()](../../com.aspose.words/documentbuilder/\#getRowFormat) для указания форматирования строки.
...
Этот метод следует вызывать только один раз после вызова [endRow()](../../com.aspose.words/documentbuilder/\#endRow). При вызове [endTable()](../../com.aspose.words/documentbuilder/\#endTable) перемещает курсор из текущей ячейки к позиции сразу после таблицы.
...
Показывает, как заполнять MERGEFIELDы данными с помощью построителя документа вместо слияния почты.
...
Возвращает объект, представляющий текущие свойства форматирования ячеек таблицы.
...
Когда текущий абзац пуст или курсор находится непосредственно перед концом абзаца или структурного тега документа, [getCurrentNode()](../../com.aspose.words/documentbuilder/\#getCurrentNode) возвращает null.

 **Examples:** 

Показывает, как переместить курсор построителя документа к различным узлам в документе.
...
Получает абзац, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
Получает раздел, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
Получает историю, которая в данный момент выбрана в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/).

 **Examples:** 

Показывает, как работать с текущей историей построителя документа.
...
Получает структурированный тег документа, который в данный момент выбран в этом [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
Получает объект [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document), к которому привязан данный объект.
...
Используйте [getFont()](../../com.aspose.words/documentbuilder/\#getFont) для доступа и изменения свойств форматирования шрифта.
...
Возвращает объект, представляющий текущие параметры страницы и свойства раздела.
...
**Returns:**
int — соответствующее значение int. Возвращаемое значение является одной из констант [Underline](../../com.aspose.words/underline/).
### insertBreak(int breakType) {#insertBreak-int}
```
...
Чтобы начать таблицу, просто вызовите [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell). После этого любой контент, добавляемый с помощью других методов класса [DocumentBuilder](../../com.aspose.words/documentbuilder/) будет добавлен в текущую ячейку.

Чтобы начать новую ячейку в той же строке, снова вызовите [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell).

Чтобы завершить строку таблицы, вызовите [endRow()](../../com.aspose.words/documentbuilder/\#endRow).

Используйте свойство [getCellFormat()](../../com.aspose.words/documentbuilder/\#getCellFormat) для указания форматирования ячейки.
...
Вставляет поле формы с флажком в текущей позиции.

 **Remarks:** 

Если вы укажете имя для поля формы, то закладка будет автоматически создана с тем же именем.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| name | java.lang.String | Имя поля формы. Может быть пустой строкой. Значение длинее 20 символов будет усечено. |
| defaultValue | boolean | Значение по умолчанию для поля формы с флажком. |
| checkedValue | boolean | Текущее состояние отмеченности поля формы с флажком. |
| size | int | Указывает размер флажка в пунктах. Укажите 0, чтобы MS Word автоматически вычислил размер флажка. |
...
| --- | --- | --- |
| name | java.lang.String | Имя поля формы. Может быть пустой строкой. Значение длинее 20 символов будет усечено. |
| checkedValue | boolean | Состояние отмеченности поля формы с флажком. |
| size | int | Указывает размер флажка в пунктах. Укажите 0, чтобы MS Word автоматически вычислил размер флажка. |
...
Вставляет поле формы с комбобоксом в текущей позиции.
...
Показывает, как вставить поле формы с комбинированным списком в документ.
...
| --- | --- | --- |
| name | java.lang.String | Имя поля формы. Может быть пустой строкой. Значение длинее 20 символов будет усечено. |
| items | java.lang.String[] | Элементы ComboBox. Максимум — 25 элементов. |
...
Этот метод вставляет поле в документ и сразу обновляет результат поля. Aspose.Words может обновлять поля большинства типов, но не всех. Для получения более подробной информации см. перегрузку [insertField(java.lang.String, java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String--java.lang.String).

 **Examples:** 

Показывает, как вставлять поля и перемещать курсор DocumentBuilder к ним.
...
Поля в документах Microsoft Word состоят из кода поля и результата поля. Код поля похож на формулу, а результат поля — на значение, которое формула производит. Код поля также может содержать переключатели полей, которые являются дополнительными инструкциями для выполнения конкретного действия.

Вы можете переключаться между отображением кодов полей и их результатов в документе Microsoft Word, используя сочетание клавиш Alt+F9. Коды полей отображаются между фигурными скобками ( \{ \} ).
...
Aspose.Words может вычислять результаты полей для большинства типов полей, но этот метод не обновляет результат поля автоматически. Поскольку результат поля не вычисляется автоматически, от вас ожидается передать строковое значение (или даже пустую строку), которое будет вставлено в результат поля. Это значение останется в результате поля как заполнитель, пока поле не будет обновлено. Чтобы обновить результат поля, вы можете вызвать [Field.update()](../../com.aspose.words/field/\#update) у возвращённого вам объекта поля или [Document.updateFields()](../../com.aspose.words/document/\#updateFields) для обновления полей во всём документе.
...
Вставляет объект [Forms2OleControl](../../com.aspose.words/forms2olecontrol/) в текущую позицию.
...
Группирует переданные в качестве параметра фигуры в новый узел GroupShape, который вставляется в текущую позицию.

 **Remarks:** 

Позиция и размеры новой GroupShape будут рассчитаны автоматически.

Фигуры VML и DML нельзя объединять в группу.

 **Examples:** 

Показывает, как вставить групповую форму DML.
...
Показывает, как объединить групповую форму с фигурой.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| shapes | [ShapeBase\[\]](../../com.aspose.words/shapebase/) | Список фигур, которые будут объединены в группу. |
...
Группирует переданные в качестве параметра фигуры в новый узел GroupShape указанного размера, который вставляется в указанную позицию.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| слева | double | Расстояние в пунктах от начала координат до левой стороны групповой формы. |
| верх | double | Расстояние в пунктах от начала координат до верхней стороны групповой формы. |
| ширина | double | Ширина групповой формы в пунктах. Отрицательное значение не допускается. |
| высота | double | Высота групповой формы в пунктах. Отрицательное значение не допускается. |
| shapes | [ShapeBase\[\]](../../com.aspose.words/shapebase/) | Список фигур, которые будут объединены в группу. |
...
Показывает, как использовать DocumentBuilder для вставки HTML‑контента в документ.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| html | java.lang.String | HTML‑строка для вставки в документ. |
...
Когда  useBuilderFormatting  равно  false , форматирование [DocumentBuilder](../../com.aspose.words/documentbuilder/) игнорируется, и форматирование вставленного текста основывается на форматировании HTML по умолчанию. В результате текст выглядит так, как он отображается в браузерах.

Когда  useBuilderFormatting  равно  true , форматирование вставленного текста основано на форматировании [DocumentBuilder](../../com.aspose.words/documentbuilder/), и текст выглядит так, как будто он был вставлен с помощью [write(java.lang.String)](../../com.aspose.words/documentbuilder/\#write-java.lang.String).

 **Examples:** 

Показывает, как применять форматирование document builder при вставке HTML‑контента.
...
| --- | --- | --- |
| html | java.lang.String | HTML‑строка для вставки в документ. |
| useBuilderFormatting | boolean | Значение, указывающее, используется ли форматирование, указанное в [DocumentBuilder](../../com.aspose.words/documentbuilder/), в качестве базового форматирования для текста, импортированного из HTML. |
...
Обратите внимание, что вам необходимо явно указать форматирование шрифта для отображаемого текста гиперссылки, используя свойство [getFont()](../../com.aspose.words/documentbuilder/\#getFont).

Этот метод внутренне вызывает [insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String), чтобы вставить поле HYPERLINK MS Word в документ.
...
Показывает, как использовать стек форматирования document builder.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| displayText | java.lang.String | Текст ссылки, который будет отображаться в документе. |
| urlOrBookmark | java.lang.String | Назначение ссылки. Может быть URL или имя закладки внутри документа. Этот метод всегда добавляет апострофы в начале и в конце URL. |
| isBookmark | boolean | true  если предыдущий параметр является именем закладки внутри документа;  false  если предыдущий параметр является URL. |
...
Вставляет изображение из массива байтов в документ. Изображение вставляется встроенно и в масштабе 100%.

 **Remarks:** 

Вы можете изменить размер изображения, его расположение, метод позиционирования и другие параметры, используя объект [Shape](../../com.aspose.words/shape/), возвращаемый этим методом.
...
| --- | --- | --- |
| imageBytes | byte[] | Массив байтов, содержащий изображение. |
| ширина | double | Ширина изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
| высота | double | Высота изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
...
Вставляет изображение в документ.  Вставляет изображение из объекта java.awt.image.BufferedImage в документ. Изображение вставляется встроенно и в масштабе 100%.

 **Remarks:** 

Вы можете изменить размер изображения, его расположение, метод позиционирования и другие параметры, используя объект [Shape](../../com.aspose.words/shape/), возвращаемый этим методом.

Aspose.Words вставит изображение в формате PNG с настройками по умолчанию. Если вы хотите вставить  BufferedImage  в другом формате или с другими настройками, вам нужно сохранить изображение в массив байтов и использовать [insertImage(byte[])](../../com.aspose.words/documentbuilder/\#insertImage-byte).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| изображение | java.awt.image.BufferedImage | Изображение для вставки в документ. |
...
Вставляет встроенное изображение из объекта java.awt.image.BufferedImage в документ и масштабирует его до указанного размера.
...
Вставляет изображение из файла или URL в документ. Изображение вставляется встроенно и в масштабе 100%.

 **Remarks:** 

Эта перегрузка автоматически загрузит изображение перед вставкой в документ, если вы укажете удалённый URI.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fileName | java.lang.String | Файл с изображением. Может быть любой действительный локальный или удалённый URI. |
...
Вставляет встроенный или связанный OLE‑объект в виде значка в документ. Позволяет указать файл значка и подпись. Определяет тип OLE‑объекта по расширению файла.
...
| isLinked | boolean | Если  true  тогда вставляется связанный OLE‑объект, иначе вставляется встроенный OLE‑объект. |
| iconFile | java.lang.String | Полный путь к ICO‑файлу. Если значение равно  null , Aspose.Words будет использовать предопределённое изображение. |
| iconCaption | java.lang.String | Подпись значка. Если значение равно  null , Aspose.Words будет использовать имя файла. |
...
Вставляет встроенный или связанный OLE‑объект в виде значка в документ. Позволяет указать файл значка и подпись. Определяет тип OLE‑объекта по заданному параметру progID.
...
| --- | --- | --- |
| fileName | java.lang.String | Полный путь к файлу. |
| progId | java.lang.String | ProgId OLE‑объекта. |
| isLinked | boolean | Если  true  тогда вставляется связанный OLE‑объект, иначе вставляется встроенный OLE‑объект. |
| iconFile | java.lang.String | Полный путь к ICO‑файлу. Если значение равно  null , Aspose.Words будет использовать предопределённое изображение. |
| iconCaption | java.lang.String | Подпись значка. Если значение равно  null , Aspose.Words будет использовать имя файла. |
...
Если ваше онлайн‑видео отображается некорректно, используйте [insertOnlineVideo(java.lang.String, java.lang.String, byte[], double, double)](../../com.aspose.words/documentbuilder/\#insertOnlineVideo-java.lang.String--java.lang.String--byte----double--double), который принимает пользовательский встроенный HTML‑код.

Код для встраивания видео может различаться у разных провайдеров, обратитесь к выбранному вами провайдеру за подробностями.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| videoUrl | java.lang.String | URL к видео. |
| ширина | double | Ширина изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
| высота | double | Высота изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
...
| --- | --- | --- |
| videoUrl | java.lang.String | URL к видео. |
| videoEmbedCode | java.lang.String | Код вставки для видео. |
| thumbnailImageBytes | byte[] | Байты изображения миниатюры. |
| ширина | double | Ширина изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
| высота | double | Высота изображения в пунктах. Может быть отрицательным или нулевым значением для запроса масштаба 100%. |
...
Используется текущий формат абзаца, указанный свойством [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| signatureLineOptions | [SignatureLineOptions](../../com.aspose.words/signaturelineoptions/) | Объект, который хранит параметры создания строки подписи. |
...
Этот метод позволяет применить разные стили абзаца к двум различным частям строки текста.
...
Вставляет поле Оглавления (таблица содержимого) в документ.

 **Remarks:** 

Этот метод вставляет поле TOC (table of contents) в документ в текущей позиции.

Оглавление в документе Word можно создать несколькими способами и отформатировать с помощью различных параметров. Способ построения и отображения оглавления в Microsoft Word контролируется переключателями полей.

Самый простой способ указать переключатели — вставить и настроить оглавление в документ Word, используя меню Insert->Reference->Index and Tables, затем включить отображение кодов полей, чтобы увидеть переключатели. Вы можете нажать Alt+F9 в Microsoft Word, чтобы включать или отключать отображение кодов полей.

Например, после создания оглавления в документ вставляется следующее поле: **\{ TOC \\o \"1-3\" \\h \\z \}**. Вы можете скопировать **\\o \"1-3\" \\h \\z** и использовать его в качестве параметра переключателей.

Обратите внимание, что [insertTableOfContents(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertTableOfContents-java.lang.String) только вставит поле TOC, но фактически не построит оглавление. Оглавление создаётся Microsoft Word при обновлении поля.

Если вы вставите оглавление с помощью этого метода и затем откроете файл в Microsoft Word, вы не увидите оглавление, потому что поле TOC ещё не обновлено.

В Microsoft Word поля не обновляются автоматически при открытии документа, но вы можете обновить поля в документе в любой момент, нажав F9.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| переключатели | java.lang.String | Переключатели поля TOC. |
...
**Returns:**
boolean — true, если курсор находится в конце текущего абзаца.
...
**Returns:**
boolean - **true**, если курсор находится в конце структурированного тега документа.
...
Возвращает  true  если курсор находится в начале текущего абзаца (до курсора нет текста).
...
**Returns:**
boolean -  true  если курсор находится в начале текущего абзаца (текст перед курсором отсутствует).
...
Когда *node* является встроенным узлом, курсор перемещается к этому узлу, и дальнейшее содержимое будет вставлено перед этим узлом.

Когда *node* является [Paragraph](../../com.aspose.words/paragraph/), курсор перемещается в конец абзаца, и дальнейшее содержимое будет вставлено непосредственно перед разрывом абзаца.

Когда *node* является блочным узлом, но не [Paragraph](../../com.aspose.words/paragraph/), курсор перемещается в конец первого абзаца внутри блочного узла, и дальнейшее содержимое будет вставлено непосредственно перед разрывом абзаца.
...
Сравнение не чувствительно к регистру. Если закладка не найдена,  false  возвращается, и курсор не перемещается.

Вставка нового текста не заменяет существующий текст закладки.

Обратите внимание, что некоторые закладки в документе привязаны к полям формы. Переход к такой закладке и вставка текста туда помещает текст в код поля формы. Хотя это не делает поле формы недействительным, вставленный текст не будет виден, так как становится частью кода поля.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| bookmarkName | java.lang.String | Имя закладки, к которой нужно переместить курсор. |

**Returns:**
boolean -  true  если закладка найдена;  false  иначе.
...
Если желаемая позиция не находится на уровне встроенного элемента, перемещается к следующему абзацу.

Сравнение не чувствительно к регистру. Если закладка не найдена,  false  возвращается, и курсор не перемещается.

 **Examples:** 

Показывает, как переместить курсор точки вставки узла document builder к закладке.
...
| --- | --- | --- |
| bookmarkName | java.lang.String | Имя закладки, к которой нужно переместить курсор. |
| isStart | boolean | Когда  true , курсор перемещается в начало закладки. Когда  false , курсор перемещается в конец закладки. |
| isAfter | boolean | Когда  true , курсор перемещается после позиции начала или конца закладки. Когда  false , курсор перемещается перед позицией начала или конца закладки. |
...
Показывает, как переместить курсор document builder к ячейке в таблице.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| tableIndex | int | Индекс таблицы, к которой нужно переместиться. |
| rowIndex | int | Индекс строки в таблице. |
| columnIndex | int | Индекс столбца в таблице. |
| characterIndex | int | Индекс символа внутри ячейки. Отрицательное значение позволяет указать позицию с конца ячейки. Используйте -1, чтобы переместиться в конец ячейки. |
...
Показывает, как переместить курсор точки вставки узла построителя документа к конкретному полю.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| field | [Field](../../com.aspose.words/field/) | Поле, к которому нужно переместить курсор. |
| isAfter | boolean | When  true , курсор перемещается после окончания поля. When  false , курсор перемещается перед началом поля. |
...
Перемещает курсор к указанному полю слияния.  Перемещает курсор в позицию сразу за указанным полем слияния и удаляет поле слияния.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fieldName | java.lang.String | Регистронезависимое имя поля почтовой рассылки. |

**Returns:**
boolean -  true  если поле слияния найдено и курсор перемещён;  false  в противном случае.
...
Перемещает поле слияния к указанному полю слияния.
...
| fieldName | java.lang.String | Регистронезависимое имя поля почтовой рассылки. |
| isAfter | boolean | When  true , курсор перемещается после окончания поля. When  false , курсор перемещается перед началом поля. |
| isDeleteField | boolean | When  true , удаляет поле слияния. |
...
Навигация выполняется внутри текущей истории текущего раздела. То есть, если вы переместили курсор в основной заголовок первого раздела, то  paragraphIndex  указывает индекс абзаца внутри этого заголовка данного раздела.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| paragraphIndex | int | Индекс абзаца, к которому нужно переместиться. |
| characterIndex | int | Индекс символа внутри абзаца. Отрицательное значение позволяет указать позицию с конца абзаца. Используйте -1, чтобы переместиться в конец абзаца. |
...
Курсор перемещается к первому абзацу в [Body](../../com.aspose.words/body/) указанного раздела.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| sectionIndex | int | Индекс раздела, к которому нужно переместиться. |
...
Перемещает курсор к структурированному тегу документа.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| structuredDocumentTag | [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) | Структурированный тег документа, к которому нужно переместиться. |
| characterIndex | int | Индекс символа внутри структурированного тега документа. Отрицательное значение позволяет указать позицию с конца структурированного тега документа. Используйте -1, чтобы переместиться в конец структурированного тега документа. Если структурированный тег находится на уровне блока и вы хотите переместить курсор в конец его последнего абзаца, укажите -2. |
...
Перемещает курсор к структурированному тегу документа в текущем разделе.

 **Remarks:** 

Навигация выполняется внутри текущей истории текущего раздела. То есть, если вы переместили курсор в основной заголовок первого раздела, то  structuredDocumentTagIndex  указывает индекс структурированного тега документа внутри этого заголовка данного раздела.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| structuredDocumentTagIndex | int | Индекс структурированного тега документа, к которому нужно перейти. |
| characterIndex | int | Индекс символа внутри структурированного тега документа. Отрицательное значение позволяет указать позицию с конца структурированного тега документа. Используйте -1, чтобы переместиться в конец структурированного тега документа. Если структурированный тег находится на уровне блока и вы хотите переместить курсор в конец его последнего абзаца, укажите -2. |
...
Извлекает форматирование символов, ранее сохранённое в стеке.
...
Устанавливает объект [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document), к которому привязан данный объект.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | [Document](../../com.aspose.words/document/) | Объект [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document), к которому прикреплен данный объект. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Соответствующее значение типа int. Значение должно быть одним из констант [Underline](../../com.aspose.words/underline/). |
...
Фактическая позиция вставленного узла [BookmarkStart](../../com.aspose.words/bookmarkstart/) может отличаться от текущей позиции построителя документа.
...
Создаёт таблицу в документе.

 **Remarks:** 

Следующим вызываемым методом является [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell).

Этот метод начинает вложенную таблицу, когда вызывается внутри ячейки.
...
Используется текущий формат шрифта, указанный свойством [getFont()](../../com.aspose.words/documentbuilder/\#getFont).
...
Вызывает [insertParagraph()](../../com.aspose.words/documentbuilder/\#insertParagraph).
...
Используются текущие форматирование шрифта и абзаца, указанные свойствами [getFont()](../../com.aspose.words/documentbuilder/\#getFont) и [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat).
