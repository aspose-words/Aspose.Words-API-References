...
description: "Представляет участника источника библиографии в Java."
type: docs
weight: 128
url: /ru/java/com.aspose.words/contributor/
---
...
Представляет участника источника библиографии. Может быть как корпоративным (организацией), так и списком лиц.
