...
description: "Указывает язык, на который будет переводиться текст с использованием ИИ. в Java."
type: docs
weight: 413
url: /ru/java/com.aspose.words/language/
---
...
Указывает язык, на который будет переведен текст с использованием ИИ.
