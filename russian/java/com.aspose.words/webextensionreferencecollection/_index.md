...
Задает список ссылок на веб-расширения.
...
| [hashCode()](#hashCode--) |  |
| [iterator()](#iterator--) | Возвращает перечислитель, который может перебирать коллекцию. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(int index)](#remove-int-) | Удаляет элемент по указанному индексу из коллекции. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**Возвращает:**
java.lang.Object — элемент по указанному индексу.
### getClass() {#getClass--}
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int | Отсчитываемый от нуля индекс элемента коллекции. |
