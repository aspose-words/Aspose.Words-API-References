...
description: "Реализует поле MERGESEQ в Java."
type: docs
weight: 260
url: /ru/java/com.aspose.words/fieldmergeseq/
---
...
В данный момент поля MERGEREC и MERGESEQ реализуют одинаковую функциональность, потому что мы точно не знаем, как пропустить записи в слиянии почты Aspose.Words.
