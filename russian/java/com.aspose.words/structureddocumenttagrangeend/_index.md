...
description: Представляет конец ранжированного структурированного тега документа, который принимает содержимое, состоящее из нескольких разделов.
type: docs
weight: 534
...
```
 ...
 Представляет собой конец**ranged** тег структурированного документа, который принимает содержимое из нескольких разделов. Смотрите также[StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart) узел.
...
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int-) |  Инициализирует новый экземпляр**Structured document tag range end** учебный класс. |
## Методы
...
| [getId()](#getId--) |  Указывает уникальный постоянный числовой идентификатор только для чтения для этого**StructuredDocumentTagRange** узел. |
...
```
 ...
 Инициализирует новый экземпляр**Structured document tag range end** учебный класс.
...
| id | int | Идентификатор начала диапазона тегов соответствующего структурированного документа. |
...
```
 ...
 Указывает уникальный постоянный числовой идентификатор только для чтения для этого**StructuredDocumentTagRange** узел. Соответствующий[StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart) узел такой же[StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart\#getId--).
