...
description: "Реализует поле INCLUDE в Java."
type: docs
weight: 246
...
Вставляет весь текст и графику или их часть, содержащиеся в другом документе.
...
| [getLockFields()](#getLockFields) | Получает, следует ли предотвращать обновление полей во включённом документе. |
...
| [getTextConverter()](#getTextConverter) | Получает имя текстового конвертера для формата включённого файла. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Устанавливает имя закладки в документе для включения. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setLockFields(boolean value)](#setLockFields-boolean) | Устанавливает, следует ли предотвращать обновление полей во включённом документе. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Устанавливает расположение документа. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | Устанавливает имя текстового конвертера для формата включённого файла. |
...
Получает, следует ли предотвращать обновление полей во включённом документе.
...
**Returns:**
boolean - Нужно ли предотвращать обновление полей во включённом документе.
### getNamespaceMappings() {#getNamespaceMappings}
```
...
Получает имя текстового конвертера для формата включённого файла.
...
**Returns:**
java.lang.String - Имя текстового конвертера для формата включённого файла.
### getType() {#getType}
```
public int getType()
```
...
Устанавливает имя закладки в документе для включения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя закладки в документе для включения. |
...
Устанавливает, следует ли предотвращать обновление полей во включённом документе.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли предотвращать обновление полей во включённом документе. |
...
Устанавливает расположение документа.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Расположение документа. |
...
Устанавливает имя текстового конвертера для формата включённого файла.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя текстового конвертера для формата включённого файла. |
