...
description: "Выбрасывается при загрузке документа, когда документ кажется повреждённым и его невозможно загрузить в Java."
type: docs
weight: 307
url: /ru/java/com.aspose.words/filecorruptedexception/
---
...
Выбрасывается при загрузке документа, когда документ кажется повреждённым и его невозможно загрузить.
