...
description: "Базовый класс для всех узлов документа Word в Java."
type: docs
weight: 476
...
Класс [Node](../../com.aspose.words/node/):
...
**Returns:**
int - Тип этого узла. Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
