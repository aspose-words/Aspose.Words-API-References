...
description: Базовый класс для элементов, содержащих узлы блочного уровня и файлы .
type: docs
weight: 528
url: /ru/java/com.aspose.words/story/
---
...
```
 ...
 Базовый класс для элементов, содержащих узлы блочного уровня.[Paragraph](../../com.aspose.words/paragraph) а также[Table](../../com.aspose.words/table).

 Чтобы узнать больше, посетите**Logical Levels of Nodes in a Document** документальная статья.

 Говорят, что текст документа Word состоит из нескольких историй. Основной текст хранится в основной текстовой истории, представленной[Body](../../com.aspose.words/body) , каждый верхний и нижний колонтитулы хранятся в отдельной истории, представленной[HeaderFooter](../../com.aspose.words/headerfooter).
## Конструкторы
