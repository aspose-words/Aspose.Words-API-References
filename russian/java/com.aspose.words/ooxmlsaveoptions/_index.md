...
type: docs
weight: 428
url: /ru/java/com.aspose.words/ooxmlsaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX), [SaveFormat.DOCM](../../com.aspose.words/saveformat\#DOCM), [SaveFormat.DOTX](../../com.aspose.words/saveformat\#DOTX), [SaveFormat.DOTM](../../com.aspose.words/saveformat\#DOTM) или же[SaveFormat.FLAT\_OPC](../../com.aspose.words/saveformat\#FLAT-OPC) формат.
...
| --- | --- |
| [OoxmlSaveOptions()](#OoxmlSaveOptions--) |  Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX) формат. |
| [OoxmlSaveOptions(int saveFormat)](#OoxmlSaveOptions-int-) | Инициализирует новый экземпляр этого класса. |
## Методы
...
| [getClass()](#getClass--) |  |
| [getCompliance()](#getCompliance--) | Указывает версию OOXML для выходного документа. |
| [getCompressionLevel()](#getCompressionLevel--) | Указывает уровень сжатия, используемый для сохранения документа. |
...
| [getKeepLegacyControlChars()](#getKeepLegacyControlChars--) | Сохраняет исходное представление устаревших управляющих символов. |
...
| [getPassword()](#getPassword--) | Получает/задает пароль для шифрования документа с использованием стандартного алгоритма шифрования ECMA376. |
...
| [setCompliance(int value)](#setCompliance-int-) | Указывает версию OOXML для выходного документа. |
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | Указывает уровень сжатия, используемый для сохранения документа. |
...
| [setKeepLegacyControlChars(boolean value)](#setKeepLegacyControlChars-boolean-) | Сохраняет исходное представление устаревших управляющих символов. |
...
| [setPassword(String value)](#setPassword-java.lang.String-) | Получает/задает пароль для шифрования документа с использованием стандартного алгоритма шифрования ECMA376. |
...
```
 ...
 Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX) формат.
...
```
 ...
 Указывает версию OOXML для выходного документа. Значение по умолчанию[OoxmlCompliance.ECMA\_376\_2006](../../com.aspose.words/ooxmlcompliance\#ECMA-376-2006).

**Возвращает:**
 int - соответствующее значение int. Возвращаемое значение является одним из[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance) константы.
...
```
 ...
 Указывает уровень сжатия, используемый для сохранения документа. Значение по умолчанию[CompressionLevel.NORMAL](../../com.aspose.words/compressionlevel\#NORMAL).

**Возвращает:**
 int - соответствующее значение int. Возвращаемое значение является одним из[CompressionLevel](../../com.aspose.words/compressionlevel) константы.
...
Получает/задает пароль для шифрования документа с использованием стандартного алгоритма шифрования ECMA376.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX), [SaveFormat.DOCM](../../com.aspose.words/saveformat\#DOCM), [SaveFormat.DOTX](../../com.aspose.words/saveformat\#DOTX), [SaveFormat.DOTM](../../com.aspose.words/saveformat\#DOTM) или же[SaveFormat.FLAT\_OPC](../../com.aspose.words/saveformat\#FLAT-OPC).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int |  Соответствующее целочисленное значение. Значение должно быть одним из[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance) константы. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int |  Соответствующее целочисленное значение. Значение должно быть одним из[CompressionLevel](../../com.aspose.words/compressionlevel) константы. |
