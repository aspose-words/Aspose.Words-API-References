...
description: "Представляет маркер данных диаграммы в Java."
type: docs
weight: 82
url: /ru/java/com.aspose.words/chartmarker/
---
...
| Метод | Описание |
| --- | --- |
| [getFormat()](#getFormat) | Обеспечивает доступ к заполнению и форматированию линий этого маркера. |
| [getShapeType()](#getShapeType) |  |
| [getSize()](#getSize) | Получает размер маркера диаграммы. |
| [getSymbol()](#getSymbol) | Получает символ маркера диаграммы. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSize(int value)](#setSize-int) | Устанавливает размер маркера диаграммы. |
| [setSymbol(int value)](#setSymbol-int) | Устанавливает символ маркера диаграммы. |
### getFormat() {#getFormat}
```
...
Обеспечивает доступ к заполнению и форматированию линий этого маркера.
...
Получает размер маркера диаграммы. Значение по умолчанию — 7.
...
Получает символ маркера диаграммы.
...
**Returns:**
int — символ маркера диаграммы. Возвращаемое значение является одной из констант [MarkerSymbol](../../com.aspose.words/markersymbol/).
### isFillSupported() {#isFillSupported}
```
...
Устанавливает размер маркера диаграммы. Значение по умолчанию — 7.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Размер маркера диаграммы. |
...
Устанавливает символ маркера диаграммы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Символ маркера диаграммы. Значение должно быть одной из констант [MarkerSymbol](../../com.aspose.words/markersymbol/). |
