...
description: "Реализуйте этот интерфейс, если хотите иметь собственные пользовательские методы, вызываемые во время обновления поля в Java."
type: docs
weight: 768
...
Реализуйте этот интерфейс, если вы хотите иметь собственные пользовательские методы, вызываемые во время обновления поля.
...
| Метод | Описание |
| --- | --- |
| [fieldUpdated(Field field)](#fieldUpdated-com.aspose.words.Field) | Пользовательский метод, вызываемый сразу после обновления поля. |
| [fieldUpdating(Field field)](#fieldUpdating-com.aspose.words.Field) | Пользовательский метод, вызываемый непосредственно перед обновлением поля. |
...
Пользовательский метод, вызываемый сразу после обновления поля.
...
Пользовательский метод, вызываемый непосредственно перед обновлением поля.
