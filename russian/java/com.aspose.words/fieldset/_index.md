...
description: "Реализует поле SET в Java."
type: docs
weight: 285
url: /ru/java/com.aspose.words/fieldset/
---
...
| [getBookmarkText()](#getBookmarkText) | Получает новый текст закладки. |
...
| [setBookmarkText(String value)](#setBookmarkText-java.lang.String) | Устанавливает новый текст закладки. |
...
**Returns:**
java.lang.String — Новый текст закладки.
...
Устанавливает новый текст закладки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Новый текст закладки. |
