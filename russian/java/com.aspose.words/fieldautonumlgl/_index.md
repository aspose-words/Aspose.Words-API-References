...
description: "Реализует поле AUTONUMLGL в Java."
type: docs
weight: 202
url: /ru/java/com.aspose.words/fieldautonumlgl/
---
...
Вставляет автоматический номер в юридическом формате.
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Получает, следует ли отображать номер без завершающей точки. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Получает символ-разделитель, который будет использоваться. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Устанавливает, следует ли отображать номер без завершающей точки. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Устанавливает символ-разделитель, который будет использоваться. |
...
Получает, следует ли отображать номер без завершающей точки.
...
**Returns:**
boolean - Нужно ли отображать номер без завершающей точки.
### getResult() {#getResult}
```
...
Получает символ-разделитель, который будет использоваться.
...
**Returns:**
java.lang.String - Символ-разделитель, который будет использоваться.
### getStart() {#getStart}
```
...
Устанавливает, следует ли отображать номер без завершающей точки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли отображать номер без завершающей точки. |
...
Устанавливает символ-разделитель, который будет использоваться.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Символ-разделитель, который будет использоваться. |
