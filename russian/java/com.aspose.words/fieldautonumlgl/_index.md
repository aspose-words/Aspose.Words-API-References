...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod--) | Определяет, отображать ли число без конечной точки. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter--) | Возвращает используемый символ-разделитель. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean-) | Устанавливает, отображать ли число без конечной точки. |
| [setResult(String value)](#setResult-java.lang.String-) | Задает текст, который находится между разделителем полей и концом поля. |
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String-) | Устанавливает используемый символ-разделитель. |
| [toString()](#toString--) |  |
...
Определяет, отображать ли число без конечной точки.

**Возвращает:**
boolean — отображать ли число без точки в конце.
### getResult() {#getResult--}
```
...
Возвращает используемый символ-разделитель.

**Возвращает:**
java.lang.String — используемый символ-разделитель.
### getStart() {#getStart--}
```
...
Устанавливает, отображать ли число без конечной точки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Отображать ли число без конечной точки. |
...
Устанавливает используемый символ-разделитель.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Используемый символ-разделитель. |
