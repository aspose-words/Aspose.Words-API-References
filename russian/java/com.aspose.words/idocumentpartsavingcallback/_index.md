...
description: "Реализуйте этот интерфейс, если хотите получать уведомления и управлять тем, как Aspose.Words сохраняет части документа при экспорте документа в формат SaveFormat.HTML или SaveFormat.EPUB на Java."
type: docs
weight: 760
...
Реализуйте этот интерфейс, если хотите получать уведомления и управлять тем, как Aspose.Words сохраняет части документа при экспорте документа в формат [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) или [SaveFormat.EPUB](../../com.aspose.words/saveformat/\#EPUB) .
