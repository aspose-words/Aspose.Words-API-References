...
description: "Реализует поле FILLIN в Java."
type: docs
weight: 232
url: /ru/java/com.aspose.words/fieldfillin/
---
...
Показывает, как использовать поле FILLIN, чтобы запросить у пользователя ответ.
