...
| [getClass()](#getClass--) |  |
| [getDefaultResponse()](#getDefaultResponse--) | Получает ответ пользователя по умолчанию (начальное значение, содержащееся в окне подсказки). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge--) | Определяет, должен ли ответ пользователя быть получен один раз на операцию слияния почты. |
| [getPromptText()](#getPromptText--) | Получает текст подсказки (заголовок окна подсказки). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String-) | Задает ответ пользователя по умолчанию (начальное значение содержится в окне подсказки). |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean-) | Устанавливает, должен ли ответ пользователя быть получен один раз на операцию слияния. |
| [setPromptText(String value)](#setPromptText-java.lang.String-) | Задает текст подсказки (заголовок окна подсказки). |
...
Получает ответ пользователя по умолчанию (начальное значение, содержащееся в окне подсказки).

**Возвращает:**
java.lang.String — ответ пользователя по умолчанию (начальное значение содержится в окне подсказки).
...
Определяет, должен ли ответ пользователя быть получен один раз на операцию слияния почты.

**Возвращает:**
boolean — следует ли получать ответ пользователя один раз за операцию слияния почты.
...
Получает текст подсказки (заголовок окна подсказки).

**Возвращает:**
java.lang.String — Текст подсказки (заголовок окна подсказки).
### getResult() {#getResult--}
```
...
Задает ответ пользователя по умолчанию (начальное значение содержится в окне подсказки).

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Ответ пользователя по умолчанию (начальное значение, содержащееся в окне подсказки). |
...
Устанавливает, должен ли ответ пользователя быть получен один раз на операцию слияния.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли получать ответ пользователя один раз за операцию слияния. |
...
Задает текст подсказки (заголовок окна подсказки).

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст подсказки (заголовок окна подсказки). |
