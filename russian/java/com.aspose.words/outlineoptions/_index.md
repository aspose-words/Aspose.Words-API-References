...
description: "Позволяет указать параметры оглавления в Java."
type: docs
weight: 509
...
Позволяет указать параметры структуры.
...
| Метод | Описание |
| --- | --- |
| [getBookmarksOutlineLevels()](#getBookmarksOutlineLevels) | Позволяет указать уровень оглавления отдельных закладок. |
| [getCreateMissingOutlineLevels()](#getCreateMissingOutlineLevels) | Получает или задает значение, определяющее, создавать ли отсутствующие уровни оглавления при экспорте документа. |
| [getCreateOutlinesForHeadingsInTables()](#getCreateOutlinesForHeadingsInTables) | Указывает, создавать ли оглавления для заголовков (абзацев, отформатированных стилями Heading) внутри таблиц. |
| [getDefaultBookmarksOutlineLevel()](#getDefaultBookmarksOutlineLevel) | Указывает уровень по умолчанию в оглавлении документа, на котором отображаются закладки Word. |
| [getExpandedOutlineLevels()](#getExpandedOutlineLevels) | Указывает, сколько уровней в оглавлении документа показывать развернутыми при просмотре файла. |
| [getHeadingsOutlineLevels()](#getHeadingsOutlineLevels) | Указывает, сколько уровней заголовков (абзацев, отформатированных стилями Heading) включать в оглавление документа. |
| [setCreateMissingOutlineLevels(boolean value)](#setCreateMissingOutlineLevels-boolean) | Получает или задает значение, определяющее, создавать ли отсутствующие уровни оглавления при экспорте документа. |
| [setCreateOutlinesForHeadingsInTables(boolean value)](#setCreateOutlinesForHeadingsInTables-boolean) | Указывает, создавать ли оглавления для заголовков (абзацев, отформатированных стилями Heading) внутри таблиц. |
| [setDefaultBookmarksOutlineLevel(int value)](#setDefaultBookmarksOutlineLevel-int) | Указывает уровень по умолчанию в оглавлении документа, на котором отображаются закладки Word. |
| [setExpandedOutlineLevels(int value)](#setExpandedOutlineLevels-int) | Указывает, сколько уровней в оглавлении документа показывать развернутыми при просмотре файла. |
| [setHeadingsOutlineLevels(int value)](#setHeadingsOutlineLevels-int) | Указывает, сколько уровней заголовков (абзацев, отформатированных стилями Heading) включать в оглавление документа. |
...
Позволяет указать уровень оглавления отдельных закладок.

 **Remarks:** 

Если уровень закладки не указан в этой коллекции, используется значение [getDefaultBookmarksOutlineLevel()](../../com.aspose.words/outlineoptions/\#getDefaultBookmarksOutlineLevel) / [setDefaultBookmarksOutlineLevel(int)](../../com.aspose.words/outlineoptions/\#setDefaultBookmarksOutlineLevel-int).
...
Получает или задает значение, определяющее, создавать ли отсутствующие уровни оглавления при экспорте документа.

Значение по умолчанию для этого свойства — false.

 **Examples:** 

Показывает, как работать с уровнями оглавления, не содержащими соответствующих заголовков, при сохранении PDF‑документа.
...
Указывает, создавать ли оглавления для заголовков (абзацев, отформатированных стилями Heading) внутри таблиц.
...
Показывает, как создавать записи оглавления PDF‑документа для заголовков внутри таблиц.
...
Указывает уровень по умолчанию в оглавлении документа, на котором отображаются закладки Word.

 **Remarks:** 

Уровень отдельных закладок можно указать с помощью свойства [getBookmarksOutlineLevels()](../../com.aspose.words/outlineoptions/\#getBookmarksOutlineLevels).

Укажите 0, и закладки Word не будут отображаться в оглавлении документа. Укажите 1, и закладки Word будут отображаться в оглавлении на уровне 1; 2 — на уровне 2 и т.д.
...
Указывает, сколько уровней в оглавлении документа показывать развернутыми при просмотре файла.

 **Remarks:** 

Обратите внимание, что эти параметры не работают при сохранении в XPS.
...
Указывает, сколько уровней заголовков (абзацев, отформатированных стилями Heading) включать в оглавление документа.

 **Remarks:** 

Укажите 0, чтобы в структуре не было заголовков; укажите 1, чтобы в структуре был один уровень заголовков и так далее.
