...
description: "Позволяет управлять тем, какое форматирование списка применяется к абзацу в Java."
type: docs
weight: 427
...
Вы не создаёте объекты класса [ListFormat](../../com.aspose.words/listformat/) напрямую. Вы получаете доступ к [ListFormat](../../com.aspose.words/listformat/) как к свойству другого объекта, которому может быть сопоставлено форматирование списка. В данный момент объектами, которые могут иметь форматирование списка, являются: [Paragraph](../../com.aspose.words/paragraph/), [Style](../../com.aspose.words/style/) и [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
Само форматирование списка хранится внутри объекта [List](../../com.aspose.words/list/), который хранится отдельно от абзацев. Объекты списка хранятся внутри коллекции [ListCollection](../../com.aspose.words/listcollection/). Для каждого [Document](../../com.aspose.words/document/) существует единственная коллекция [ListCollection](../../com.aspose.words/listcollection/).

Абзацы физически не принадлежат списку. Абзацы лишь ссылаются на конкретный объект списка через свойства [getList()](../../com.aspose.words/listformat/\#getList) / [setList(com.aspose.words.List)](../../com.aspose.words/listformat/\#setList-com.aspose.words.List) и на конкретный уровень в списке через свойства [getListLevelNumber()](../../com.aspose.words/listformat/\#getListLevelNumber) / [setListLevelNumber(int)](../../com.aspose.words/listformat/\#setListLevelNumber-int). Устанавливая эти два свойства, вы контролируете, какие маркеры и нумерация применяются к абзацу.
...
| Метод | Описание |
| --- | --- |
| [applyBulletDefault()](#applyBulletDefault) | Создаёт новый список с маркерами по умолчанию и применяет его к абзацу. |
| [applyNumberDefault()](#applyNumberDefault) | Создаёт новый нумерованный список по умолчанию и применяет его к абзацу. |
| [getList()](#getList) | Получает список, членом которого является данный абзац. |
| [getListLevel()](#getListLevel) | Возвращает форматирование уровня списка плюс любые переопределения форматирования, применённые к текущему абзацу. |
| [getListLevelNumber()](#getListLevelNumber) | Получает номер уровня списка (от 0 до 8) для абзаца. |
| [isListItem()](#isListItem) | Истина, когда к абзацу применено маркированное или нумерованное форматирование. |
...
| [setList(List value)](#setList-com.aspose.words.List) | Устанавливает список, членом которого является данный абзац. |
| [setListLevelNumber(int value)](#setListLevelNumber-int) | Устанавливает номер уровня списка (от 0 до 8) для абзаца. |
...
Создаёт новый список с маркерами по умолчанию и применяет его к абзацу.

 **Remarks:** 

Это метод‑сокращение, который создаёт новый список, используя шаблон маркеров по умолчанию, применяет его к абзацу и выбирает первый уровень списка.
...
Создаёт новый нумерованный список по умолчанию и применяет его к абзацу.

 **Remarks:** 

Это метод‑сокращение, который создаёт новый список, используя шаблон нумерации по умолчанию, применяет его к абзацу и выбирает первый уровень списка.
...
Получает список, членом которого является данный абзац.
...
Установка этого свойства в  null  удаляет маркеры и нумерацию из абзаца и устанавливает номер уровня списка в ноль. Установка этого свойства в  null  эквивалентна вызову [removeNumbers()](../../com.aspose.words/listformat/\#removeNumbers).
...
Имеет эффект только когда свойство [getList()](../../com.aspose.words/listformat/\#getList) / [setList(com.aspose.words.List)](../../com.aspose.words/listformat/\#setList-com.aspose.words.List) установлено для ссылки на действительный список.
...
В документах Word списки могут состоять до девяти уровней. Форматирование списка для каждого уровня определяет, какой маркер или номер используется, левый отступ, расстояние между маркером и текстом и т.д.
...
Вызов этого метода эквивалентен установке свойства [getList()](../../com.aspose.words/listformat/\#getList) / [setList(com.aspose.words.List)](../../com.aspose.words/listformat/\#setList-com.aspose.words.List) в  null .
...
Устанавливает список, членом которого является данный абзац.
...
| --- | --- | --- |
| value | [List](../../com.aspose.words/list/) | Список, членом которого является данный абзац. |
...
Устанавливает номер уровня списка (от 0 до 8) для абзаца.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Номер уровня списка (от 0 до 8) для абзаца. |
