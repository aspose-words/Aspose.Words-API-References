...
description: Реализует поле DATE.
type: docs
weight: 177
...
| [getUseLastFormat()](#getUseLastFormat--) | Определяет, следует ли использовать формат, последний раз использовавшийся хост-приложением, при вставке нового поля ДАТА. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean-) | Устанавливает, следует ли использовать формат, последний раз использовавшийся хост-приложением, при вставке нового поля ДАТА. |
...
Определяет, следует ли использовать формат, последний раз использовавшийся хост-приложением, при вставке нового поля ДАТА.

**Возвращает:**
boolean — использовать ли последний формат, использовавшийся хост-приложением, при вставке нового поля DATE.
...
Устанавливает, следует ли использовать формат, последний раз использовавшийся хост-приложением, при вставке нового поля ДАТА.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Следует ли использовать формат, последний раз использовавшийся хост-приложением, при вставке нового поля ДАТА. |
