...
description: "Реализует поле DATE в Java."
type: docs
weight: 220
url: /ru/java/com.aspose.words/fielddate/
---
...
Вставляет текущие дату и время. По умолчанию используется григорианский календарь.
...
| [getUseLastFormat()](#getUseLastFormat) | Получает, использовать ли формат, последний раз применённый хост‑приложением при вставке нового поля DATE. |
| [getUseLunarCalendar()](#getUseLunarCalendar) | Возвращает, использовать ли лунный календарь Хиджры или еврейский лунный календарь. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | Возвращает, использовать ли календарь эпохи Сака. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | Возвращает, использовать ли календарь Ум-аль-Кура. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Устанавливает, использовать ли формат, последний раз применённый хост‑приложением при вставке нового поля DATE. |
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | Устанавливает, использовать ли лунный календарь Хиджры или еврейский лунный календарь. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | Устанавливает, использовать ли календарь эпохи Сака. |
...
Получает, использовать ли формат, последний раз применённый хост‑приложением при вставке нового поля DATE.
...
**Returns:**
boolean — использовать ли формат, последний раз применённый хост‑приложением при вставке нового поля DATE.
...
Возвращает, использовать ли лунный календарь Хиджры или еврейский лунный календарь.
...
**Returns:**
boolean — использовать ли лунный календарь Хиджры или еврейский лунный календарь.
...
Возвращает, использовать ли календарь эпохи Сака.
...
**Returns:**
boolean — использовать ли календарь эпохи Сака.
...
Возвращает, использовать ли календарь Ум-аль-Кура.
...
Устанавливает, использовать ли формат, последний раз применённый хост‑приложением при вставке нового поля DATE.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Использовать ли формат, последний раз использованный хост‑приложением, при вставке нового поля DATE. |
...
Устанавливает, использовать ли лунный календарь Хиджры или еврейский лунный календарь.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Использовать ли лунный календарь Хиджры или еврейский лунный календарь. |
...
Устанавливает, использовать ли календарь эпохи Сака.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Использовать ли календарь Сака Эра. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Использовать ли календарь Ум-аль-Кура. |
