...
description: "Предоставляет данные для события прогресса обновления полей в Java."
type: docs
weight: 302
url: /ru/java/com.aspose.words/fieldupdatingprogressargs/
---
...
Предоставляет данные для события прогресса обновления поля.
...
| Метод | Описание |
| --- | --- |
| [getTotalFieldsCount()](#getTotalFieldsCount) | Возвращает общее количество полей, подлежащих обновлению. |
| [getUpdateCompleted()](#getUpdateCompleted) | Возвращает значение, указывающее, завершено ли обновление полей. |
| [getUpdatedFieldsCount()](#getUpdatedFieldsCount) | Возвращает количество обновлённых полей. |
...
Возвращает общее количество полей, подлежащих обновлению.

 **Remarks:** 

Значение не является константой и может увеличиваться в процессе обновления.
...
**Returns:**
int - Общее количество полей, которое будет обновлено.
...
Возвращает значение, указывающее, завершено ли обновление полей.
...
**Returns:**
boolean - Значение, указывающее, завершено ли обновление полей.
...
**Returns:**
int - Количество обновлённых полей.
