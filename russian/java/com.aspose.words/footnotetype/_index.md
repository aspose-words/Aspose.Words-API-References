...
description: "Указывает, является ли это сноской или концевой сноской в Java."
type: docs
weight: 346
url: /ru/java/com.aspose.words/footnotetype/
---
...
Сноски и концевые сноски представлены объектами класса [FOOTNOTE](../../com.aspose.words/footnotetype/\#FOOTNOTE). Используйте [Footnote.getFootnoteType()](../../com.aspose.words/footnote/\#getFootnoteType) для различения сносок и концевых сносок.
...
| Поле | Описание |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | Объект является концевой сноской. |
| [FOOTNOTE](#FOOTNOTE) | Объект является сноской. |
| [length](#length) |  |
## Методы
...
Объект является концевой сноской.
