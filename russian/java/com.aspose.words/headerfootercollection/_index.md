...
description: "Обеспечивает типизированный доступ к узлам HeaderFooter раздела в Java."
type: docs
weight: 371
url: /ru/java/com.aspose.words/headerfootercollection/
---
...
Обеспечивает типизированный доступ к узлам [HeaderFooter](../../com.aspose.words/headerfooter/) раздела [Section](../../com.aspose.words/section/).

Чтобы узнать больше, посетите статью документации [ Working with Headers and Footers ][Working with Headers and Footers].

 **Remarks:** 

Может быть максимум один [HeaderFooter](../../com.aspose.words/headerfooter/)

для каждого [HeaderFooterType](../../com.aspose.words/headerfootertype/) на каждый [Section](../../com.aspose.words/section/).
...
Показывает, как удалить все колонтитулы из документа.
...
| [get(int index)](#get-int) | Получает [HeaderFooter](../../com.aspose.words/headerfooter/) по заданному индексу. |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean) | Связывает или разрывает связь всех верхних и нижних колонтитулов с соответствующими колонтитулами в предыдущем разделе. |
...
Получает [HeaderFooter](../../com.aspose.words/headerfooter/) по заданному индексу.
...
Связывает или разрывает связь всех верхних и нижних колонтитулов с соответствующими колонтитулами в предыдущем разделе.

 **Remarks:** 

Если какой‑либо из верхних или нижних колонтитулов не существует, он создаётся автоматически.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| isLinkToPrevious | boolean | true  — связать верхние и нижние колонтитулы с предыдущим разделом;  false  — разорвать связь. |
...
Копирует все  HeaderFooter  s из коллекции в новый массив  HeaderFooter  s.
...
**Returns:**
com.aspose.words.HeaderFooter[] - массив  HeaderFooter  s.
