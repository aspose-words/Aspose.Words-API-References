...
description: Предоставляет типизированный доступ к узлам раздела.
type: docs
weight: 317
...
```
 ...
 Предоставляет типизированный доступ к[HeaderFooter](../../com.aspose.words/headerfooter) узлы**Section**.

 Чтобы узнать больше, посетите**Working with Headers and Footers** документальная статья.

 Может быть максимум один**HeaderFooter**

 каждого[HeaderFooterType](../../com.aspose.words/headerfootertype) за**Section**.
...
| [get(int index)](#get-int-) |  Получает**HeaderFooter** по заданному индексу. |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean-) | Связывает или разъединяет все верхние и нижние колонтитулы с соответствующими верхними и нижними колонтитулами в предыдущем разделе. |
...
| [toArray()](#toArray--) | Копирует все объекты HeaderFoorter из коллекции в новый массив объектов HeaderFoorter. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
```
 ...
 Получает**HeaderFooter** по заданному индексу.
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[HeaderFooter](../../com.aspose.words/headerfooter) ценность.
### getByHeaderFooterType(int headerFooterType) {#getByHeaderFooterType-int-}
```
...
Копирует все объекты HeaderFoorter из коллекции в новый массив объектов HeaderFoorter.
