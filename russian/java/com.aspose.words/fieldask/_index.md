...
description: "Реализует поле ASK в Java."
type: docs
weight: 199
url: /ru/java/com.aspose.words/fieldask/
---
...
Запрашивает у пользователя ввод информации и назначает закладку, представляющую ответ пользователя.
...
| [getDefaultResponse()](#getDefaultResponse) | Получает ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | Получает, должен ли ответ пользователя получаться один раз за операцию слияния писем. |
| [getPromptText()](#getPromptText) | Получает текст подсказки (заголовок окна запроса). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | Устанавливает ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса). |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | Устанавливает, должен ли ответ пользователя получаться один раз за операцию слияния писем. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | Устанавливает текст подсказки (заголовок окна запроса). |
...
Получает ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса).
...
**Returns:**
java.lang.String - Ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса).
...
Получает, должен ли ответ пользователя получаться один раз за операцию слияния писем.
...
**Returns:**
boolean - Должен ли ответ пользователя получаться один раз за операцию слияния писем.
...
Получает текст подсказки (заголовок окна запроса).
...
**Returns:**
java.lang.String - Текст подсказки (заголовок окна запроса).
### getResult() {#getResult}
```
...
Устанавливает ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Ответ пользователя по умолчанию (начальное значение, содержащееся в окне запроса). |
...
Устанавливает, должен ли ответ пользователя получаться один раз за операцию слияния писем.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Должен ли ответ пользователя получаться один раз за операцию слияния писем. |
...
Устанавливает текст подсказки (заголовок окна запроса).
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст подсказки (заголовок окна запроса). |
