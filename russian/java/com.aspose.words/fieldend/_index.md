...
description: "Представляет конец поля Word в документе на Java."
type: docs
weight: 229
...
| [hasSeparator()](#hasSeparator) | Возвращает  true  если у этого поля есть разделитель. |
...
Вызывает [DocumentVisitor.visitFieldEnd(com.aspose.words.FieldEnd)](../../com.aspose.words/documentvisitor/\#visitFieldEnd-com.aspose.words.FieldEnd).
...
**Returns:**
int — [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). Возвращаемое значение является одной из констант [NodeType](../../com.aspose.words/nodetype/).
...
Возвращает  true  если у этого поля есть разделитель.
...
**Returns:**
boolean —  true  если у этого поля есть разделитель.
