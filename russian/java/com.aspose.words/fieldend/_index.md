...
type: docs
weight: 186
url: /ru/java/com.aspose.words/fieldend/
---
...
[FieldEnd](../../com.aspose.words/fieldend) является узлом встроенного уровня и представлен[ControlChar.FIELD\_END\_CHAR](../../com.aspose.words/controlchar\#FIELD-END-CHAR) управляющий символ в документе.

[FieldEnd](../../com.aspose.words/fieldend) может быть только ребенком[Paragraph](../../com.aspose.words/paragraph).
...
| [getNodeType()](#getNodeType--) |  Возвращает[NodeType.FIELD\_END](../../com.aspose.words/nodetype\#FIELD-END). |
...
| [hasSeparator()](#hasSeparator--) |  Возвращает**true** если это поле имеет разделитель. |
| [hashCode()](#hashCode--) |  |
...
Принимает посетителя.
 ...
 Звонки[DocumentVisitor.visitFieldEnd(com.aspose.words.FieldEnd)](../../com.aspose.words/documentvisitor\#visitFieldEnd-com.aspose.words.FieldEnd-).
...
```
 ...
 Возвращает[NodeType.FIELD\_END](../../com.aspose.words/nodetype\#FIELD-END).

**Возвращает:**
 инт -\{[NodeType.FIELD\_END](../../com.aspose.words/nodetype\#FIELD-END) . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
...
**Возвращает:**
 логический -**true** если это поле имеет разделитель.
### hashCode() {#hashCode--}
```
