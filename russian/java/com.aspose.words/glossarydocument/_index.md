...
description: Представляет корневой элемент документа глоссария в документе Word.
type: docs
weight: 306
url: /ru/java/com.aspose.words/glossarydocument/
---
...
Представляет корневой элемент документа глоссария в документе Word. Глоссарий — это хранилище для записей автотекста, автозамены и стандартных блоков.
 ...
 Некоторые документы, обычно шаблоны, могут содержать элементы автотекста, автозамены и/или стандартные блоки (также известные как*glossary document entries*, *document parts* или же*building blocks*).

 Чтобы получить доступ к стандартным блокам, вам необходимо загрузить документ в[Document](../../com.aspose.words/document) объект. Строительные блоки будут доступны через[Document.getGlossaryDocument()](../../com.aspose.words/document\#getGlossaryDocument--) / [Document.setGlossaryDocument(com.aspose.words.GlossaryDocument)](../../com.aspose.words/document\#setGlossaryDocument-com.aspose.words.GlossaryDocument-) имущество.

[GlossaryDocument](../../com.aspose.words/glossarydocument) может содержать любое количество[BuildingBlock](../../com.aspose.words/buildingblock) объекты. Каждый[BuildingBlock](../../com.aspose.words/buildingblock) представляет собой часть документа.

 Соответствует**glossaryDocument** а также**docParts** элементы в OOXML.
## Методы
...
| [getBuildingBlocks()](#getBuildingBlocks--) | Возвращает типизированную коллекцию, которая представляет все стандартные блоки в документе глоссария. |
...
| [getFirstBuildingBlock()](#getFirstBuildingBlock--) | Получает первый стандартный блок в документе глоссария. |
...
| [getLastBuildingBlock()](#getLastBuildingBlock--) | Получает последний стандартный блок в документе глоссария. |
...
| [getNodeType()](#getNodeType--) |  Возвращает[NodeType.GLOSSARY\_DOCUMENT](../../com.aspose.words/nodetype\#GLOSSARY-DOCUMENT) ценность. |
...
**Возвращает:**
[BuildingBlockCollection](../../com.aspose.words/buildingblockcollection) - Типизированная коллекция, которая представляет все стандартные блоки в документе глоссария.
### getChild(int nodeType, int index, boolean isDeep) {#getChild-int-int-boolean-}
```
...
**Возвращает:**
[BuildingBlock](../../com.aspose.words/buildingblock) - Первый стандартный блок в документе глоссария.
...
**Возвращает:**
[BuildingBlock](../../com.aspose.words/buildingblock) - Последний стандартный блок в документе глоссария.
...
```
 ...
 Возвращает[NodeType.GLOSSARY\_DOCUMENT](../../com.aspose.words/nodetype\#GLOSSARY-DOCUMENT) ценность.

**Возвращает:**
 интервал -[NodeType.GLOSSARY\_DOCUMENT](../../com.aspose.words/nodetype\#GLOSSARY-DOCUMENT) ценность. Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
