...
description: "Реализует поле INCLUDEPICTURE в Java."
type: docs
weight: 247
url: /ru/java/com.aspose.words/fieldincludepicture/
---
...
| [getGraphicFilter()](#getGraphicFilter) | Получает имя фильтра для формата графики, который будет вставлен. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getResizeHorizontally()](#getResizeHorizontally) | Получает, следует ли изменять ширину изображения по горизонтали из источника. |
| [getResizeVertically()](#getResizeVertically) | Получает, следует ли изменять высоту изображения по вертикали из источника. |
...
| [getSourceFullName()](#getSourceFullName) | Получает расположение изображения с использованием IRI. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Устанавливает имя фильтра для формата графики, который будет вставлен. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Устанавливает, следует ли изменять ширину изображения по горизонтали из источника. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Устанавливает, следует ли изменять высоту изображения по вертикали из источника. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Устанавливает расположение изображения с использованием IRI. |
...
Получает имя фильтра для формата графики, который будет вставлен.
...
**Returns:**
java.lang.String — имя фильтра для формата графики, который будет вставлен.
...
Получает, следует ли изменять ширину изображения по горизонтали из источника.
...
**Returns:**
boolean — следует ли изменять ширину изображения по горизонтали из источника.
...
Получает, следует ли изменять высоту изображения по вертикали из источника.
...
**Returns:**
boolean — следует ли изменять высоту изображения по вертикали из источника.
### getResult() {#getResult}
```
...
Получает расположение изображения с использованием IRI.
...
**Returns:**
java.lang.String — расположение изображения с использованием IRI.
### getStart() {#getStart}
```
...
```
public void setGraphicFilter(String value)
```


Устанавливает имя фильтра для формата графики, который будет вставлен.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя фильтра для формата графики, который будет вставлен. |
...
### setResizeHorizontally(boolean value) {#setResizeHorizontally-boolean}
```
public void setResizeHorizontally(boolean value)
```


Устанавливает, следует ли изменять ширину изображения по горизонтали из источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли изменять ширину изображения относительно источника. |
...
Устанавливает, следует ли изменять высоту изображения по вертикали из источника.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли изменять высоту изображения относительно источника. |
...
Устанавливает расположение изображения с использованием IRI.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Расположение изображения с использованием IRI. |
