...
| [getGraphicFilter()](#getGraphicFilter--) | Получает имя фильтра для формата вставляемого изображения. |
| [getLocaleId()](#getLocaleId--) | Получает LCID поля. |
| [getResizeHorizontally()](#getResizeHorizontally--) | Получает, следует ли изменять размер изображения по горизонтали из источника. |
| [getResizeVertically()](#getResizeVertically--) | Получает, следует ли изменять размер изображения по вертикали из источника. |
...
| [getSourceFullName()](#getSourceFullName--) | Получает местоположение изображения с помощью IRI. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String-) | Задает имя фильтра для формата вставляемой графики. |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean-) | Устанавливает, следует ли изменять размер изображения по горизонтали от источника. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean-) | Устанавливает, следует ли изменять размер изображения по вертикали от источника. |
| [setResult(String value)](#setResult-java.lang.String-) | Задает текст, который находится между разделителем полей и концом поля. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String-) | Устанавливает местоположение изображения с помощью IRI. |
| [toString()](#toString--) |  |
...
Получает имя фильтра для формата вставляемого изображения.

**Возвращает:**
java.lang.String — имя фильтра для формата вставляемой графики.
...
Получает, следует ли изменять размер изображения по горизонтали из источника.

**Возвращает:**
boolean - Изменять ли размер изображения по горизонтали из источника.
...
Получает, следует ли изменять размер изображения по вертикали из источника.

**Возвращает:**
boolean - Изменять ли размер изображения по вертикали от источника.
### getResult() {#getResult--}
```
...
Получает местоположение изображения с помощью IRI.
...
Задает имя фильтра для формата вставляемой графики.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя фильтра для формата вставляемой графики. |
...
Устанавливает, следует ли изменять размер изображения по горизонтали от источника.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Изменять ли размер изображения по горизонтали из источника. |
...
Устанавливает, следует ли изменять размер изображения по вертикали от источника.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Изменять ли размер изображения по вертикали от источника. |
...
Устанавливает местоположение изображения с помощью IRI.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Расположение изображения с использованием IRI. |
