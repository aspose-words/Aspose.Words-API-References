...
Получает размер файла текущего документа или 0, если размер не может быть определен.
 ...
 В текущей реализации используется[Document.getOriginalFileName()](../../com.aspose.words/document\#getOriginalFileName--) свойство для получения имени файла, используемого для определения размера файла.
## Методы
...
| [isInKilobytes()](#isInKilobytes--) | Получает, следует ли отображать размер файла в килобайтах. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean-) | Устанавливает, отображать ли размер файла в килобайтах. |
| [isInMegabytes()](#isInMegabytes--) | Получает, следует ли отображать размер файла в мегабайтах. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean-) | Устанавливает, отображать ли размер файла в мегабайтах. |
...
Получает, следует ли отображать размер файла в килобайтах.

**Возвращает:**
boolean — отображать ли размер файла в килобайтах.
...
Устанавливает, отображать ли размер файла в килобайтах.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Отображать ли размер файла в килобайтах. |
...
Получает, следует ли отображать размер файла в мегабайтах.

**Возвращает:**
boolean — отображать ли размер файла в мегабайтах.
...
Устанавливает, отображать ли размер файла в мегабайтах.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | boolean | Отображать ли размер файла в мегабайтах. |
