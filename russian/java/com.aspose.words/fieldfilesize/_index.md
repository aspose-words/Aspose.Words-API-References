...
description: "Реализует поле FILESIZE в Java."
type: docs
weight: 231
url: /ru/java/com.aspose.words/fieldfilesize/
---
...
В текущей реализации используется свойство [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) для получения имени файла, используемого при определении его размера.
...
| [isInKilobytes()](#isInKilobytes) | Получает, нужно ли отображать размер файла в килобайтах. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Устанавливает, нужно ли отображать размер файла в килобайтах. |
| [isInMegabytes()](#isInMegabytes) | Получает, нужно ли отображать размер файла в мегабайтах. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Устанавливает, нужно ли отображать размер файла в мегабайтах. |
...
Получает, нужно ли отображать размер файла в килобайтах.
...
**Returns:**
boolean - Нужно ли отображать размер файла в килобайтах.
...
Устанавливает, нужно ли отображать размер файла в килобайтах.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли отображать размер файла в килобайтах. |
...
Получает, нужно ли отображать размер файла в мегабайтах.
...
**Returns:**
boolean - Нужно ли отображать размер файла в мегабайтах.
...
Устанавливает, нужно ли отображать размер файла в мегабайтах.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Нужно ли отображать размер файла в мегабайтах. |
