...
description: "Реализует поле ADVANCE в Java."
type: docs
weight: 197
...
Перемещает начальную точку, в которой отображается текст, следующий за полем, вправо или влево, вверх или вниз, либо в определённое горизонтальное или вертикальное положение.
...
| [getDownOffset()](#getDownOffset) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вниз. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён горизонтально от левого края колонки, рамки или текстового блока. |
| [getLeftOffset()](#getLeftOffset) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён влево. |
...
| [getRightOffset()](#getRightOffset) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вправо. |
...
| [getUpOffset()](#getUpOffset) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вверх. |
| [getVerticalPosition()](#getVerticalPosition) | Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вертикально от верхнего края страницы. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть смещён вниз. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён горизонтально от левого края колонки, рамки или текстового блока. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён влево. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вправо. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вверх. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вертикально от верхнего края страницы. |
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вниз.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вниз.
### getEnd() {#getEnd}
```
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён горизонтально от левого края колонки, рамки или текстового блока.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён горизонтально от левого края колонки, рамки или текстового блока.
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён влево.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён влево.
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вправо.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вправо.
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вверх.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вверх.
...
Возвращает количество пунктов, на которое текст, следующий за полем, должен быть смещён вертикально от верхнего края страницы.
...
**Returns:**
java.lang.String - Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вертикально от верхнего края страницы.
### isDirty() {#isDirty}
```
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть смещён вниз.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вниз. |
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён горизонтально от левого края колонки, рамки или текстового блока.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён горизонтально от левого края колонки, рамки или текстового блока. |
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён влево.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён влево. |
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вправо.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вправо. |
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вверх.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вверх. |
...
Устанавливает количество пунктов, на которое текст, следующий за полем, должен быть перемещён вертикально от верхнего края страницы.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Количество пунктов, на которое текст, следующий за полем, должен быть перемещён вертикально от верхнего края страницы. |
