...
type: docs
weight: 585
url: /ru/java/com.aspose.words/txtsaveoptions/
---
...
```
 ...
 Может использоваться для указания дополнительных параметров при сохранении документа в[SaveFormat.TEXT](../../com.aspose.words/saveformat\#TEXT) формат.
...
| [getAddBidiMarks()](#getAddBidiMarks--) | Указывает, следует ли добавлять двунаправленные метки перед каждым запуском BiDi при экспорте в формате обычного текста. |
...
| [getListIndentation()](#getListIndentation--) | Получает объект ListIndentation, указывающий, сколько и какой символ использовать для отступа уровней списка. |
| [getMaxCharactersPerLine()](#getMaxCharactersPerLine--) | Получает целочисленное значение, указывающее максимальное количество символов в одной строке. |
...
| [getPreserveTableLayout()](#getPreserveTableLayout--) | Указывает, должна ли программа сохранять расположение таблиц при сохранении в текстовом формате. |
...
| [getSimplifyListLabels()](#getSimplifyListLabels--) | Указывает, должна ли программа упрощать метки списков в случае, если сложное форматирование меток не может быть надлежащим образом представлено обычным текстом. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setAddBidiMarks(boolean value)](#setAddBidiMarks-boolean-) | Указывает, следует ли добавлять двунаправленные метки перед каждым запуском BiDi при экспорте в формате обычного текста. |
...
| [setMaxCharactersPerLine(int value)](#setMaxCharactersPerLine-int-) | Задает целочисленное значение, указывающее максимальное количество символов в одной строке. |
...
| [setPreserveTableLayout(boolean value)](#setPreserveTableLayout-boolean-) | Указывает, должна ли программа сохранять расположение таблиц при сохранении в текстовом формате. |
...
| [setSimplifyListLabels(boolean value)](#setSimplifyListLabels-boolean-) | Указывает, должна ли программа упрощать метки списков в случае, если сложное форматирование меток не может быть надлежащим образом представлено обычным текстом. |
...
Получает объект ListIndentation, указывающий, сколько и какой символ использовать для отступа уровней списка. По умолчанию это нулевое количество символов '\\0', что означает отсутствие отступа.

**Возвращает:**
[TxtListIndentation](../../com.aspose.words/txtlistindentation) - Объект ListIndentation, указывающий, сколько и какой символ использовать для отступа уровней списка.
...
Получает целочисленное значение, указывающее максимальное количество символов в одной строке. Значение по умолчанию равно 0, что означает отсутствие ограничений.

**Возвращает:**
int — целочисленное значение, указывающее максимальное количество символов в одной строке.
...
```
 ...
 Указывает, должна ли программа сохранять расположение таблиц при сохранении в текстовом формате. Значение по умолчанию**false**.
...
```
 ...
 Указывает формат, в котором будет сохранен документ, если используется этот объект параметров сохранения. Может быть только[SaveFormat.TEXT](../../com.aspose.words/saveformat\#TEXT).
...
Указывает, должна ли программа упрощать метки списков в случае, если сложное форматирование меток не может быть надлежащим образом представлено обычным текстом.

 Если установлено**true** , метки нумерованных списков записываются в простом числовом формате, а метки поэлементных списков — в виде простых символов ASCII. Значение по умолчанию**false**.
...
Задает целочисленное значение, указывающее максимальное количество символов в одной строке. Значение по умолчанию равно 0, что означает отсутствие ограничений.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | int | Целочисленное значение, указывающее максимальное количество символов в одной строке. |
