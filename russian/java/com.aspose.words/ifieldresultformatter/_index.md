...
description: "Реализуйте этот интерфейс, если хотите контролировать, как результат поля форматируется в Java."
type: docs
weight: 766
...
Реализуйте этот интерфейс, если хотите контролировать, как форматируется результат поля.
...
Вызывается, когда Aspose.Words применяет переключатель числового формата, т.е. \\\# "\#.\#".

 **Remarks:** 

Реализация должна возвращать  null  чтобы указать, что следует применить форматирование по умолчанию.
