...
description: "Реализует поле HYPERLINK в Java."
type: docs
weight: 242
...
При выборе заставляет элемент управления перейти к месту, например к закладке или URL.
...
| Метод | Описание |
| --- | --- |
| [getAddress()](#getAddress) | Получает место, куда переходит эта гиперссылка. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Получает, открывать ли целевой сайт в новом окне веб‑браузера. |
| [getResult()](#getResult) | Получает текст, находящийся между разделителем поля и концом поля. |
| [getScreenTip()](#getScreenTip) | Получает текст подсказки (ScreenTip) для гиперссылки. |
...
| [isImageMap()](#isImageMap) | Получает, следует ли добавлять координаты к гиперссылке для серверной карты изображений. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Устанавливает, следует ли добавлять координаты к гиперссылке для серверной карты изображений. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Устанавливает место, куда переходит эта гиперссылка. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Устанавливает текст подсказки (ScreenTip) для гиперссылки. |
...
Получает место, куда переходит эта гиперссылка.
...
**Returns:**
java.lang.String — место, куда переходит эта гиперссылка.
...
Получает, открывать ли целевой сайт в новом окне веб‑браузера.
...
Получает текст подсказки (ScreenTip) для гиперссылки.
...
**Returns:**
java.lang.String — текст подсказки (ScreenTip) для гиперссылки.
...
Получает, следует ли добавлять координаты к гиперссылке для серверной карты изображений.
...
**Returns:**
boolean — следует ли добавлять координаты к гиперссылке для серверной карты изображений.
...
Устанавливает, следует ли добавлять координаты к гиперссылке для серверной карты изображений.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Следует ли добавлять координаты к гиперссылке для серверной карты изображений. |
...
Устанавливает место, куда переходит эта гиперссылка.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Место, куда переходит эта гиперссылка. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Открывать ли целевой сайт в новом окне веб‑браузера. |
...
Устанавливает текст подсказки (ScreenTip) для гиперссылки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст подсказки (ScreenTip) для гиперссылки. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Место в файле, например закладка, куда переходит эта гиперссылка. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Цель, на которую должна быть перенаправлена ссылка. |
