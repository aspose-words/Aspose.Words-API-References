...
description: "Элемент управления TextBox отображает текст из упорядоченного набора данных или ввода пользователя в Java."
type: docs
weight: 668
url: /ru/java/com.aspose.words/textboxcontrol/
---
...
Элемент управления TextBox отображает текст из упорядоченного набора данных или ввода пользователя.

 **Examples:** 

Показывает, как изменить текст элемента управления TextBox OLE.
...
| [getText()](#getText) | Получает текст элемента управления. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст элемента управления. |
...
**Returns:**
java.lang.String - Текст элемента управления.
### getType() {#getType}
```
public int getType()
```
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст элемента управления. |
