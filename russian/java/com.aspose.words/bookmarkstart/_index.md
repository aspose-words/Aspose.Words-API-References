...
type: docs
weight: 34
url: /ru/java/com.aspose.words/bookmarkstart/
---
...
[BookmarkStart](../../com.aspose.words/bookmarkstart) а также[BookmarkEnd](../../com.aspose.words/bookmarkend) — это просто маркеры внутри документа, которые указывают, где начинается и заканчивается закладка.
 ...
 Использовать[getBookmark()](../../com.aspose.words/bookmarkstart\#getBookmark--) класс как «фасад» для работы с закладкой как с единым объектом.
## Конструкторы

| Конструктор | Описание |
| --- | --- |
| [BookmarkStart(DocumentBase doc, String name)](#BookmarkStart-com.aspose.words.DocumentBase-java.lang.String-) |  Инициализирует новый экземпляр[BookmarkStart](../../com.aspose.words/bookmarkstart) учебный класс. |
## Методы
...
| [getBookmark()](#getBookmark--) | Получает объект фасада, который инкапсулирует начало и конец этой закладки. |
| [getClass()](#getClass--) |  |
...
| [getNodeType()](#getNodeType--) |  Возвращает[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START). |
...
| [getText()](#getText--) | Возвращает пустую строку. |
| [hashCode()](#hashCode--) |  |
...
```
 ...
 Инициализирует новый экземпляр[BookmarkStart](../../com.aspose.words/bookmarkstart) учебный класс.
...
Принимает посетителя.
 ...
 Звонки[DocumentVisitor.visitBookmarkStart(com.aspose.words.BookmarkStart)](../../com.aspose.words/documentvisitor\#visitBookmarkStart-com.aspose.words.BookmarkStart-).
...
**Возвращает:**
[Bookmark](../../com.aspose.words/bookmark) - Фасадный объект, который инкапсулирует начало и конец этой закладки.
### getClass() {#getClass--}
```
...
```
 ...
 Возвращает[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START).

**Возвращает:**
 инт -\{[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START) . Возвращаемое значение является одним из[NodeType](../../com.aspose.words/nodetype) константы.
...
**Возвращает:**
java.lang.String — пустая строка.
### hashCode() {#hashCode--}
```
