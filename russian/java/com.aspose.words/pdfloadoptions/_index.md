...
description: "Позволяет указать дополнительные параметры при загрузке Pdf документа в объект Document в Java."
type: docs
weight: 538
...
Позволяет указать дополнительные параметры при загрузке Pdf документа в объект [Document](../../com.aspose.words/document/).
...
| [getPageIndex()](#getPageIndex) | Получает 0‑based индекс первой страницы для чтения. |
...
| [getSkipPdfImages()](#getSkipPdfImages) | Получает флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа. |
...
| [setPageIndex(int value)](#setPageIndex-int) | Устанавливает 0‑based индекс первой страницы для чтения. |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean) | Устанавливает флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа. |
...
Получает количество страниц для чтения. По умолчанию — MaxValue, что означает чтение всех страниц документа.
...
Получает 0‑based индекс первой страницы для чтения. По умолчанию 0.
...
**Returns:**
int — 0‑based индекс первой страницы для чтения.
...
Получает флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа. По умолчанию false.
...
**Returns:**
boolean — флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа.
...
Устанавливает количество страниц для чтения. По умолчанию — MaxValue, что означает чтение всех страниц документа.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | Количество страниц для чтения. |
...
Устанавливает 0‑based индекс первой страницы для чтения. По умолчанию 0.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | int | 0‑based индекс первой страницы для чтения. |
...
Устанавливает флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа. По умолчанию — false.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Флаг, указывающий, следует ли пропускать изображения при загрузке PDF‑документа. |
