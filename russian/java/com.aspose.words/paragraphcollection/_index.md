...
description: "Предоставляет типизированный доступ к коллекции узлов Paragraph в Java."
type: docs
weight: 524
url: /ru/java/com.aspose.words/paragraphcollection/
---
...
Предоставляет типизированный доступ к коллекции узлов [Paragraph](../../com.aspose.words/paragraph/).
...
| [get(int index)](#get-int) | Получает [Paragraph](../../com.aspose.words/paragraph/) по заданному индексу. |
...
Получает [Paragraph](../../com.aspose.words/paragraph/) по заданному индексу.
...
**Returns:**
com.aspose.words.Node[] - массив абзацев.
