...
```
 ...
 Предоставляет типизированный доступ к коллекции[Paragraph](../../com.aspose.words/paragraph) узлы.
...
| [get(int index)](#get-int-) |  Получает**Paragraph** по заданному индексу. |
| [getClass()](#getClass--) |  |
...
```
 ...
 Получает**Paragraph** по заданному индексу.
...
**Возвращает:**
[Node](../../com.aspose.words/node) - соответствующий[Paragraph](../../com.aspose.words/paragraph) ценность.
### getClass() {#getClass--}
```
