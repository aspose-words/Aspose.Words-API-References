...
| [setVariableName(String value)](#setVariableName-java.lang.String-) | Задает имя переменной документа для извлечения. |
| [toString()](#toString--) |  |
...
**Возвращает:**
java.lang.String — имя переменной документа, которую необходимо получить.
### hashCode() {#hashCode--}
```
...
Задает имя переменной документа для извлечения.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Имя переменной документа для извлечения. |
