...
description: "Реализует поле DOCVARIABLE в Java."
type: docs
weight: 225
url: /ru/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | Получает имя переменной документа для извлечения. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Устанавливает имя переменной документа для извлечения. |
...
Получает имя переменной документа для извлечения.
...
**Returns:**
java.lang.String - Имя переменной документа для извлечения.
### isDirty() {#isDirty}
```
...
Устанавливает имя переменной документа для извлечения.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Имя переменной документа для извлечения. |
