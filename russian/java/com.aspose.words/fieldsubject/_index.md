...
Реализует поле SUBJECT.
 ...
 Извлекает и, при необходимости, устанавливает тему документа, записанную в**Subject** свойство встроенных свойств документа.
## Методы
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Текст темы. |
