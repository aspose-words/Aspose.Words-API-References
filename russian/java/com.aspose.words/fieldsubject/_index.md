...
description: "Реализует поле SUBJECT в Java."
type: docs
weight: 290
url: /ru/java/com.aspose.words/fieldsubject/
---
...
Получает и, при необходимости, задает тему документа, как записано в свойстве **Subject** встроенных свойств документа.
...
| [getText()](#getText) | Получает текст темы. |
...
| [setText(String value)](#setText-java.lang.String) | Устанавливает текст темы. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Текст темы. |
