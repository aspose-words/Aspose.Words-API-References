...
description: "Реализует поле REVNUM в Java."
type: docs
weight: 279
url: /ru/java/com.aspose.words/fieldrevnum/
---
...
Получает номер ревизии документа, как записано в свойстве **Revision** встроенных свойств документа.
