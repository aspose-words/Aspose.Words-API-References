...
description: "Реализует поле CITATION в Java."
type: docs
weight: 211
...
Вставляет содержимое элемента **Source** с указанным элементом **Tag**, используя библиографический стиль.

 **Examples:** 

Показывает, как работать с полями CITATION и BIBLIOGRAPHY.
...
| Метод | Описание |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | Получает значение, соответствующее значению элемента **Tag** другого источника, которое будет включено в цитату. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Получает идентификатор языка, используемый вместе с указанным библиографическим стилем для форматирования цитаты в документе. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getPageNumber()](#getPageNumber) | Получает номер страницы, связанный с цитатой. |
| [getPrefix()](#getPrefix) | Получает префикс, который добавляется перед цитатой. |
...
| [getSourceTag()](#getSourceTag) | Получает значение, соответствующее значению элемента **Tag** источника для вставки. |
...
| [getSuppressAuthor()](#getSuppressAuthor) | Получает, подавлена ли информация об авторе в цитате. |
| [getSuppressTitle()](#getSuppressTitle) | Получает, подавлена ли информация о заголовке в цитате. |
| [getSuppressYear()](#getSuppressYear) | Получает, подавлена ли информация о годе в цитате. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | Устанавливает значение, совпадающее со значением элемента **Tag** другого источника, которое будет включено в цитату. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Устанавливает идентификатор языка, используемый совместно с указанным библиографическим стилем для форматирования цитаты в документе. |
...
| [setPrefix(String value)](#setPrefix-java.lang.String) | Устанавливает префикс, добавляемый перед цитатой. |
| [setResult(String value)](#setResult-java.lang.String) | Устанавливает текст, находящийся между разделителем поля и его концом. |
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Устанавливает значение, совпадающее со значением элемента **Tag** источника для вставки. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | Устанавливает суффикс, добавляемый к цитате. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | Устанавливает, подавлена ли информация об авторе в цитате. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | Устанавливает, подавлена ли информация о заголовке в цитате. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | Устанавливает, подавлена ли информация о годе в цитате. |
...
Получает значение, соответствующее значению элемента **Tag** другого источника, которое будет включено в цитату.
...
**Returns:**
java.lang.String - Значение, совпадающее со значением элемента **Tag** другого источника, которое будет включено в цитату.
...
Получает идентификатор языка, используемый вместе с указанным библиографическим стилем для форматирования цитаты в документе.
...
**Returns:**
java.lang.String - Идентификатор языка, используемый совместно с указанным библиографическим стилем для форматирования цитаты в документе.
...
Получает префикс, который добавляется перед цитатой.
...
**Returns:**
java.lang.String - Префикс, добавляемый перед цитатой.
### getResult() {#getResult}
```
...
Получает значение, соответствующее значению элемента **Tag** источника для вставки.
...
**Returns:**
java.lang.String - Значение, совпадающее со значением элемента **Tag** источника для вставки.
### getStart() {#getStart}
```
...
**Returns:**
java.lang.String - Суффикс, добавляемый к цитате.
...
Получает, подавлена ли информация об авторе в цитате.
...
**Returns:**
boolean - Подавлена ли информация об авторе в цитате.
...
Получает, подавлена ли информация о заголовке в цитате.
...
**Returns:**
boolean - Подавлена ли информация о заголовке в цитате.
...
Получает, подавлена ли информация о годе в цитате.
...
**Returns:**
boolean - Подавлена ли информация о годе в цитате.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Устанавливает значение, совпадающее со значением элемента **Tag** другого источника, которое будет включено в цитату.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Значение, совпадающее со значением элемента **Tag** другого источника, которое будет включено в цитату. |
...
Устанавливает идентификатор языка, используемый совместно с указанным библиографическим стилем для форматирования цитаты в документе.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Идентификатор языка, который используется совместно с указанным библиографическим стилем для форматирования ссылки в документе. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Номер страницы, связанный со ссылкой. |
...
Устанавливает префикс, добавляемый перед цитатой.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Префикс, который добавляется перед ссылкой. |
...
Устанавливает значение, совпадающее со значением элемента **Tag** источника для вставки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Значение, которое соответствует значению элемента **Tag** источника для вставки. |
...
Устанавливает суффикс, добавляемый к цитате.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Суффикс, который добавляется к ссылке. |
...
Устанавливает, подавлена ли информация об авторе в цитате.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Указывает, подавляется ли информация об авторе в ссылке. |
...
Устанавливает, подавлена ли информация о заголовке в цитате.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Указывает, подавляется ли информация о заголовке в ссылке. |
...
Устанавливает, подавлена ли информация о годе в цитате.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | boolean | Указывает, подавляется ли информация о годе в ссылке. |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Номер тома, связанный со ссылкой. |
