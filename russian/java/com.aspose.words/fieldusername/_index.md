...
description: "Реализует поле USERNAME в Java."
type: docs
weight: 305
...
| [getUserName()](#getUserName) | Получает или задает имя текущего пользователя. |
...
| [setUserName(String value)](#setUserName-java.lang.String) | Получает или задает имя текущего пользователя. |
