...
type: docs
weight: 261
url: /ru/java/com.aspose.words/fieldusername/
---
...
| [getUserName()](#getUserName--) | Принимает или устанавливает имя текущего пользователя. |
| [hashCode()](#hashCode--) |  |
...
| [setUserName(String value)](#setUserName-java.lang.String-) | Принимает или устанавливает имя текущего пользователя. |
| [toString()](#toString--) |  |
