...
description: "Реализует поле INFO в Java."
type: docs
weight: 251
url: /ru/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Получает тип свойства документа для вставки. |
| [getLocaleId()](#getLocaleId) | Получает LCID поля. |
| [getNewValue()](#getNewValue) | Получает необязательное значение, которое обновляет свойство. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Устанавливает тип свойства документа для вставки. |
| [setLocaleId(int value)](#setLocaleId-int) | Устанавливает LCID поля. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Устанавливает необязательное значение, которое обновляет свойство. |
...
Получает тип свойства документа для вставки.
...
**Returns:**
java.lang.String - Тип свойства документа для вставки.
...
Получает необязательное значение, которое обновляет свойство.
...
**Returns:**
java.lang.String - Необязательное значение, которое обновляет свойство.
### getResult() {#getResult}
```
...
Устанавливает тип свойства документа для вставки.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Тип свойства документа для вставки. |
...
Устанавливает необязательное значение, которое обновляет свойство.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| значение | java.lang.String | Необязательное значение, которое обновляет свойство. |
