...
description: Реализует поле INFO.
type: docs
weight: 208
...
| [setInfoType(String value)](#setInfoType-java.lang.String-) | Задает тип свойства документа для вставки. |
| [setLocaleId(int value)](#setLocaleId-int-) | Устанавливает LCID поля. |
| [setNewValue(String value)](#setNewValue-java.lang.String-) | Задает необязательное значение, которое обновляет свойство. |
...
**Возвращает:**
java.lang.String — тип вставляемого свойства документа.
...
Задает тип свойства документа для вставки.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Тип свойства документа для вставки. |
...
Задает необязательное значение, которое обновляет свойство.

**Параметры:**

| Параметр | Тип | Описание |
| --- | --- | --- |
| value | java.lang.String | Необязательное значение, которое обновляет свойство. |
