...
description: Откройте для себя свойство WebExtensionBinding Id — ключ к определению уникальных идентификаторов привязки для расширенной функциональности веб-расширений.
type: docs
weight: 40
