...
description: Узнайте, как свойство WebExtensionBinding AppRef связывает ключи привязки с данными документа, улучшая функциональность и производительность вашего веб-приложения.
type: docs
weight: 20
...
Указывает ключ привязки, используемый для сопоставления записи привязки в этом списке с привязанными данными в документе.
