...
| Имя | Описание |
| --- | --- |
| [WebExtensionBinding](webextensionbinding/)(*string, [WebExtensionBindingType](../webextensionbindingtype/), string*) | Создает привязку веб-расширения с указанными параметрами. |
