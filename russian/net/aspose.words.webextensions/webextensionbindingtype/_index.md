...
description: Откройте для себя перечисление Aspose.Words WebExtensionBindingType, которое определяет типы привязки для бесшовной интеграции веб-расширений с данными вашего документа.
type: docs
weight: 7620
...
| Default | `0` | Матрица, используемая по умолчанию. |
