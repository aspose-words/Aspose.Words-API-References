...
description: Откройте для себя класс Aspose.Words.WebExtensions.TaskPaneCollection, ваше решение для эффективного управления постоянными объектами панели задач. Улучшите свои веб-приложения сегодня!
type: docs
weight: 7570
...
Указывает список сохраненных объектов области задач.
