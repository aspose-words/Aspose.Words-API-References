...
description: Откройте для себя Aspose.Words.WebExtensions.WebExtensionPropertyCollection для эффективного управления пользовательскими свойствами веб-расширений. Улучшите автоматизацию документов сегодня!
type: docs
weight: 7640
...
Указывает набор пользовательских свойств веб-расширения.
