...
description: Откройте для себя ресурс WebExtensionReference Store — ваш шлюз для эффективного доступа и управления веб-расширениями на рынке.
type: docs
weight: 30
...
Указывает экземпляр торговой площадки, где хранится веб-расширение.
