...
description: Откройте для себя свойство WebExtensionReference StoreType, определяющее типы торговых площадок для улучшения ваших проектов веб-разработки с помощью индивидуальных решений.
type: docs
weight: 40
