...
description: Откройте для себя свойство WebExtensionReference Version, чтобы определить версию вашего веб-расширения, гарантируя совместимость и повышенную производительность.
type: docs
weight: 50
