...
description: Откройте для себя свойство TaskPane WebExtension — ваш ключ к улучшению функциональности веб-расширений и пользовательского опыта. Откройте новые возможности сегодня!
type: docs
weight: 60
