...
description: Откройте для себя свойство TaskPane IsLocked, управляйте доступом к панели задач в вашем пользовательском интерфейсе, гарантируя, что пользователи не смогут закрыть важные функции, что повысит производительность.
type: docs
weight: 30
...
Указывает, заблокирована ли область задач для документа в пользовательском интерфейсе и не может ли пользователь закрыть ее.
