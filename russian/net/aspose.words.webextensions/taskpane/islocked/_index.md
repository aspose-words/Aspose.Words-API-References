...
description: TaskPane свойство. Указывает привязана ли область задач к документу в пользовательском интерфейсе и не может быть закрыта пользователем.
type: docs
weight: 30
...
Указывает, привязана ли область задач к документу в пользовательском интерфейсе и не может быть закрыта пользователем.
