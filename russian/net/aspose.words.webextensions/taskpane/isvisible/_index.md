...
description: Узнайте, как свойство TaskPane IsVisible управляет видимостью по умолчанию, улучшая взаимодействие с пользователем и оптимизируя взаимодействие с документами.
type: docs
weight: 40
