...
description: Определяет индекс этой панели задач перечисляемый снаружи внутрь среди других сохраненных панелей задач закрепленных в том же расположении по умолчанию.
type: docs
weight: 50
...
Определяет индекс этой панели задач, перечисляемый снаружи внутрь, среди других сохраненных панелей задач, закрепленных в том же расположении по умолчанию.
