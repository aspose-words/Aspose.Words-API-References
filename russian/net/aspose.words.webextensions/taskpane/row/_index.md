...
description: TaskPane свойство. Определяет индекс этой области задач начиная от внешней к внутренней среди других областей задач persisted  закрепленных в том же расположении по умолчанию.
type: docs
weight: 50
...
Определяет индекс этой области задач, начиная от внешней к внутренней, среди других областей задач persisted , закрепленных в том же расположении по умолчанию.
