...
description: Откройте для себя свойство TaskPane Row, легко управляйте индексацией панели задач для упрощения организации и повышения производительности ваших приложений.
type: docs
weight: 50
...
Указывает индекс, перечисляя снаружи внутрь, этой области задач среди других сохраняемых областей задач, закрепленных в том же месте по умолчанию.
