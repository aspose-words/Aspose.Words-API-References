...
description: Откройте для себя свойство TaskPane DockState, которое позволяет легко управлять последним закрепленным положением панели задач для улучшения рабочего процесса и повышения эффективности.
type: docs
weight: 20
...
Указывает последнее закрепленное местоположение этого объекта области задач.
