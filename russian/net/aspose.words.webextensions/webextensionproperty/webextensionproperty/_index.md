...
description: Создавайте пользовательские свойства веб-расширений без усилий с помощью конструктора WebExtensionProperty. Улучшайте свои проекты с помощью индивидуальных пар имя-значение!
type: docs
weight: 10
