...
description: Узнайте, как использовать имя WebExtensionProperty для создания пользовательских имен свойств, которые улучшат ваши веб-расширения и улучшат функциональность.
type: docs
weight: 20
