...
description: Откройте для себя свойство WebExtension Id — ваш ключ к уникальной идентификации экземпляров веб-расширений в документах для улучшения функциональности и бесшовной интеграции.
type: docs
weight: 30
