...
description: Откройте для себя WebExtension Properties, мощный набор настраиваемых функций для улучшения ваших веб-расширений. Откройте для себя уникальную функциональность сегодня!
type: docs
weight: 50
...
Представляет набор пользовательских свойств веб-расширения.
