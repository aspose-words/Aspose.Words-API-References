...
description: Откройте для себя свойство WebExtension Reference, ваш ключ к определению основных ссылок для веб-расширений. Улучшите функциональность и оптимизируйте разработку!
type: docs
weight: 60
