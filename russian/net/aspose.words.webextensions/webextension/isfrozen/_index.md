...
description: Откройте для себя свойство WebExtension IsFrozen, которое управляет взаимодействием пользователя с вашим веб-расширением. Повысьте удобство использования и оптимизируйте пользовательский опыт сегодня!
type: docs
weight: 40
