...
description: Откройте для себя свойство WebExtension AlternateReferences, чтобы улучшить свое веб-расширение с помощью универсальных вариантов ссылок для улучшения функциональности.
type: docs
weight: 10
