...
description: Откройте для себя перечисление Aspose.Words.WebExtensions.TaskPaneDockState, которое определяет расположение панелей задач для расширенного редактирования документов и удобства использования.
type: docs
weight: 7580
...
Перечисляет доступные расположения объекта области задач.
...
| --- | --- | --- |
| Right | `0` | Закрепить панель задач на правой стороне окна документа. |
| Left | `1` | Закрепить панель задач в левой части окна документа. |
