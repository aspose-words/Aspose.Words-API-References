...
description: Получает базовое свойство Value которое часто представляет состояние элемента управления. Например отмеченная кнопка имеет значение 1 а неотмеченная  0. Значение по умолчанию  пустая строка.
type: docs
weight: 60
