...
description: Откройте для себя перечисление Aspose.Words.AI.Language для бесшовного перевода текста с помощью ИИ. Улучшите свои документы с помощью точной многоязычной поддержки уже сегодня!
type: docs
weight: 80
url: /ru/net/aspose.words.ai/language/
---
## Language enumeration

Указывает язык, на который будет переведен текст с помощью AI.  .
