...
description: Позволяет указать цвет который будет использоваться для областей содержимое которых было перемещено изMoving. Значение по умолчаниюByAuthor.
type: docs
weight: 70
...
Позволяет указать цвет, который будет использоваться для областей, содержимое которых было перемещено изMoving. Значение по умолчанию:ByAuthor.
