...
description: RevisionOptions свойство. Позволяет указать цвет который будет использоваться для областей из которых было перемещено содержимое.Moving . Значение по умолчаниюByAuthor .
type: docs
weight: 70
...
Позволяет указать цвет, который будет использоваться для областей, из которых было перемещено содержимое.Moving . Значение по умолчанию:ByAuthor .
