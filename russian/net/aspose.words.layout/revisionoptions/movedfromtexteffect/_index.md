...
description: Позволяет указать эффект который будет применяться к областям куда был перемещен контент изMoving. Значение по умолчаниюDoubleStrikeThrough
type: docs
weight: 80
...
Позволяет указать эффект, который будет применяться к областям, куда был перемещен контент изMoving. Значение по умолчанию:DoubleStrikeThrough
