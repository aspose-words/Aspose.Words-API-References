...
description: RevisionOptions свойство. Позволяет указать эффект который будет применяться к областям из которых был перемещен контентMoving . Значение по умолчаниюDoubleStrikeThrough
type: docs
weight: 80
...
Позволяет указать эффект, который будет применяться к областям, из которых был перемещен контентMoving . Значение по умолчанию:DoubleStrikeThrough
