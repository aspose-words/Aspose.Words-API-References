...
description: Настройте свой контент с помощью свойства MovedToTextColor RevisionOptions. Легко выделяйте перемещенные области выбранным цветом для лучшей видимости.
type: docs
weight: 110
...
Позволяет указать цвет, который будет использоваться для областей, куда был перемещен контентMoving . Значение по умолчанию:ByAuthor .
