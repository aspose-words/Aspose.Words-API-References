...
description: RevisionOptions свойство. Позволяет указать цвет который будет использоваться для областей в которые было перемещено содержимое.Moving . Значение по умолчаниюByAuthor .
type: docs
weight: 90
...
Позволяет указать цвет, который будет использоваться для областей, в которые было перемещено содержимое.Moving . Значение по умолчанию:ByAuthor .
