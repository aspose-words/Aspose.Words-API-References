...
description: RevisionOptions свойство. Позволяет указать цвет который будет использоваться для областей куда был перемещен контент.Moving . Значение по умолчаниюByAuthor .
type: docs
weight: 90
