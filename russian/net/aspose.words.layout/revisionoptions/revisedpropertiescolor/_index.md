...
description: Позволяет указать цвет который будет использоваться для содержимого с изменением свойств форматированияFormatChange Значение по умолчаниюNoHighlight.
type: docs
weight: 110
...
Позволяет указать цвет, который будет использоваться для содержимого с изменением свойств форматированияFormatChange Значение по умолчанию:NoHighlight.
