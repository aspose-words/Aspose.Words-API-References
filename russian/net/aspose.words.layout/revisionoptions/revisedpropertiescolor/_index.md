...
description: RevisionOptions свойство. Позволяет указать цвет который будет использоваться для содержимого с изменением свойств форматирования.FormatChange Значение по умолчаниюNoHighlight .
type: docs
weight: 110
...
Позволяет указать цвет, который будет использоваться для содержимого с изменением свойств форматирования.FormatChange Значение по умолчанию:NoHighlight .
