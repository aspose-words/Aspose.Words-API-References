...
description: Настройте свой контент с помощью RevisedPropertiesColor от RevisionOptions. Легко выделяйте изменения форматирования и улучшайте читаемость с помощью этой удобной функции.
type: docs
weight: 130
...
Позволяет указать цвет, который будет использоваться для содержимого при изменении свойств форматирования.FormatChange Значение по умолчанию:NoHighlight .
