...
description: Позволяет указать цвет который будет использоваться для удаленного содержимогоDeletion. Значение по умолчаниюByAuthor.
type: docs
weight: 20
...
Позволяет указать цвет, который будет использоваться для удаленного содержимогоDeletion. Значение по умолчанию:ByAuthor.
