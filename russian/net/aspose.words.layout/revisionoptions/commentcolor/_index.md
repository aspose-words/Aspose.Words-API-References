...
description: Позволяет указать цвет комментариев. Значение по умолчаниюRed.
type: docs
weight: 10
...
Если для этого свойства установлено значениеByAuthorилиNoHighlightvalues, в результате для этого свойства будет установлен цвет по умолчанию.
