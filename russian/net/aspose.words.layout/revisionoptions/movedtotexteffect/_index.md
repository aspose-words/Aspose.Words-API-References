...
description: RevisionOptions свойство. Позволяет указать эффект который будет применяться к областям куда был перемещен контентMoving . Значение по умолчаниюDoubleUnderline
type: docs
weight: 100
...
Позволяет указать эффект, который будет применяться к областям, куда был перемещен контентMoving . Значение по умолчанию:DoubleUnderline
...
значенияHidden а такжеDoubleStrikeThrough не разрешены и вызовутArgumentOutOfRangeException.
