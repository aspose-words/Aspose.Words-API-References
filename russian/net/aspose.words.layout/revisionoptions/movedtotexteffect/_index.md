...
description: Позволяет указать эффект который будет применяться к областям куда содержимое было перемещено вMoving. Значение по умолчаниюDoubleUnderline
type: docs
weight: 100
...
Позволяет указать эффект, который будет применяться к областям, куда содержимое было перемещено вMoving. Значение по умолчанию:DoubleUnderline
...
ЗначенияHiddenиDoubleStrikeThrough не допускаются и вызываютArgumentOutOfRangeException.
