...
description: Откройте для себя свойство RevisionOptions MovedToTextEffect, которое настраивает текстовые эффекты для перемещенного содержимого. Улучшите ясность с помощью стиля DoubleUnderline по умолчанию!
type: docs
weight: 120
...
Позволяет указать эффект, который будет применен к областям, куда был перемещен контентMoving . Значение по умолчанию:DoubleUnderline
...
| исключение | условие |
| --- | --- |
| ArgumentOutOfRangeException | ЦенностиHidden иDoubleStrikeThrough не допускаются. |
