...
description: RevisionOptions свойство. Позволяет указать должен ли отображаться исходный текст вместо исправленного. Значение по умолчанию  False.
type: docs
weight: 170
...
Позволяет указать, должен ли отображаться исходный текст вместо исправленного. Значение по умолчанию — False.
