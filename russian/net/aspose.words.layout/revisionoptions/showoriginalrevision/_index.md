...
description: Контролируйте ревизии документов с помощью свойства ShowOriginalRevision. Легко переключайтесь между исходным и измененным текстом для более четкого понимания. По умолчанию — false.
type: docs
weight: 190
...
Позволяет указать, следует ли отображать исходный текст вместо измененного. Значение по умолчанию:`ЛОЖЬ` .
