...
description: Откройте для себя свойство RevisionOptions InsertedTextEffect, чтобы настроить ваш контент с помощью уникальных эффектов. По умолчанию, Подчеркивание. Улучшите воздействие вашего текста!
type: docs
weight: 70
...
Позволяет указать эффект, который будет применен к вставленному контентуInsertion . Значение по умолчанию:Underline .
