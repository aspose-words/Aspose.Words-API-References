...
description: RevisionOptions InsertedTextEffect свойство. Позволяет указать эффект который будет применяться к вставленному содержимому.Insertion . Значение по умолчаниюUnderline  на С#.
type: docs
weight: 50
