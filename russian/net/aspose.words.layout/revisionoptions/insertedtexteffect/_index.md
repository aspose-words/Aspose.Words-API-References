...
description: Позволяет указать эффект который будет применяться к вставленному содержимомуInsertion. Значение по умолчаниюUnderline.
type: docs
weight: 50
...
Позволяет указать эффект, который будет применяться к вставленному содержимомуInsertion. Значение по умолчанию:Underline.
