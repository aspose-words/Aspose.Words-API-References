...
description: RevisionOptions свойство. Позволяет указать следует ли помечать текст редакции специальной разметкой форматирования. Значение по умолчаниюистинный .
type: docs
weight: 190
