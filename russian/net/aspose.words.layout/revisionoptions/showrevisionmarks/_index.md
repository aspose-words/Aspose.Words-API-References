...
description: Позволяет указать следует ли помечать текст ревизии специальной разметкой форматирования. Значение по умолчанию  True.
type: docs
weight: 190
...
Позволяет указать, следует ли помечать текст ревизии специальной разметкой форматирования. Значение по умолчанию — True.
