...
description: Узнайте, как метод LayoutEnumerator MovePrevious эффективно переходит к предыдущей одноуровневой сущности, улучшая рабочий процесс кодирования.
type: docs
weight: 150
...
Перемещает к предыдущему родственному объекту.
