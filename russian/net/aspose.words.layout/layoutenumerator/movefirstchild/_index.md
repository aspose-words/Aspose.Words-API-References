...
description: Узнайте, как метод MoveFirstChild LayoutEnumerator эффективно переходит к первой дочерней сущности, расширяя ваши навыки манипулирования данными.
type: docs
weight: 100
...
Перемещает к первой дочерней сущности.
