...
description: Узнайте, как метод LayoutEnumerator MoveLastChild эффективно переходит к последнему дочернему объекту, расширяя ваши возможности управления данными.
type: docs
weight: 110
url: /ru/net/aspose.words.layout/layoutenumerator/movelastchild/
---
## LayoutEnumerator.MoveLastChild method

Перемещает к последнему дочернему объекту.
