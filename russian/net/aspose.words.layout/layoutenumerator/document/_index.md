...
description: Откройте для себя свойство LayoutEnumerator Document для эффективного перечисления документов. Улучшите свой рабочий процесс с помощью этой мощной функции!
type: docs
weight: 30
...
Получает документ, который этот экземпляр перечисляет.
