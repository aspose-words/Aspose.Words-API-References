...
description: LayoutEnumerator Document свойство. Получает документ который перечисляет этот экземпляр на С#.
type: docs
weight: 30
...
Получает документ, который перечисляет этот экземпляр.
