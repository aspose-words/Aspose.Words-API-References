...
description: Переходит к предыдущему родственному объекту в логическом порядке. При повторении строк абзаца разбитых на страницы этот метод переместится на предыдущую строку даже если она находится на другой странице.
type: docs
weight: 150
