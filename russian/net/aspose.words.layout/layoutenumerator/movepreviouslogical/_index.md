...
description: LayoutEnumerator метод. Переходит к предыдущему родственному объекту в логическом порядке. При повторении строк абзаца разбитых на страницы этот метод переместится на предыдущую строку даже если она находится на другой странице.
type: docs
weight: 150
...
Переходит к предыдущему родственному объекту в логическом порядке. При повторении строк абзаца, разбитых на страницы, этот метод переместится на предыдущую строку, даже если она находится на другой странице.
...
Обратите внимание, что всеSpan объекты связаны друг с другом таким образом, если[`Current`](../current/) Объект охватывает повторный вызов этого метода, который будет повторять полную историю документа.
