...
description: Переход к предыдущему одноуровневому объекту в логическом порядке. При переборе строк абзаца разбитых на страницы этот метод переместится на предыдущую строку даже если она находится на другой странице.
type: docs
weight: 150
...
Переход к предыдущему одноуровневому объекту в логическом порядке. При переборе строк абзаца, разбитых на страницы, этот метод переместится на предыдущую строку, даже если она находится на другой странице.
...
Обратите внимание, что всеSpanСущности связаны друг с другом таким образом, если[`Current`](../current) сущность охватывает повторный вызов этого метода, который будет повторять полную историю документа.
