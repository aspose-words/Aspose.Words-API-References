...
description: Откройте для себя свойство PageIndex LayoutEnumerator. Легко извлеките индекс страницы, начинающийся с 1, содержащей вашу текущую сущность, для бесперебойной навигации.
type: docs
weight: 60
...
Возвращает индекс страницы, содержащей текущую сущность, начиная с 1.
