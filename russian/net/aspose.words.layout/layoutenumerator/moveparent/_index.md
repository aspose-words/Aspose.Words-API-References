...
description: Переход к родительскому объекту.
type: docs
weight: 130
...
Переход к родительскому объекту указанного типа.
...
| --- | --- | --- |
| types | LayoutEntityType | Тип родительского объекта, к которому необходимо перейти. Используйте побитовое ИЛИ, чтобы указать несколько родительских типов. |

### Примечания

Этот метод полезен, если вам нужно найти родительскую ячейку, столбец или верхний/нижний колонтитул объекта.
