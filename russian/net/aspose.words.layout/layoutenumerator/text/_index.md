...
description: Откройте для себя свойство LayoutEnumerator Text, чтобы легко получить текст текущей сущности span. Упростите обработку данных с помощью этой мощной функции!
type: docs
weight: 80
...
Получает текст текущей сущности span. Выдает для других типов сущностей.
