...
description: LayoutEnumerator Text свойство. Получает текст текущего объекта диапазона. Выдает для других типов объектов на С#.
type: docs
weight: 80
...
Получает текст текущего объекта диапазона. Выдает для других типов объектов.
