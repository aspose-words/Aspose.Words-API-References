...
description: Переходит к следующему родственному объекту в логическом порядке. При повторении строк абзаца разбитых на страницах этот метод перейдет к следующей строке даже если она находится на другой странице.
type: docs
weight: 120
