...
description: Переход к следующему родственному объекту в логическом порядке. При переборе строк абзаца разбитого на страницы этот метод перейдет к следующей строке даже если она находится на другой странице.
type: docs
weight: 120
...
Переход к следующему родственному объекту в логическом порядке. При переборе строк абзаца, разбитого на страницы, этот метод перейдет к следующей строке, даже если она находится на другой странице.
