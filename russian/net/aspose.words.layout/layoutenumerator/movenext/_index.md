...
description: Переход к следующему родственному объекту в визуальном порядке. При повторении строк абзаца разбитых на страницы этот метод не будет переходить на следующую страницу а скорее перейдет к следующему объекту на той же странице. .
type: docs
weight: 110
...
Переход к следующему родственному объекту в визуальном порядке. При повторении строк абзаца, разбитых на страницы, этот метод не будет переходить на следующую страницу, а скорее перейдет к следующему объекту на той же странице. .
