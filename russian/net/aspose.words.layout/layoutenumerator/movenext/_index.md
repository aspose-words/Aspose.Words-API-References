...
description: LayoutEnumerator метод. Переходит к следующему родственному объекту в визуальном порядке. При повторении строк абзаца разбитых на страницах этот метод не будет перемещаться на следующую страницу а скорее перейдет к следующему объекту на той же странице.
type: docs
weight: 110
...
Переходит к следующему родственному объекту в визуальном порядке. При повторении строк абзаца, разбитых на страницах, этот метод не будет перемещаться на следующую страницу, а скорее перейдет к следующему объекту на той же странице.
