...
description: Откройте для себя свойство LayoutEnumerator Type, легко получите доступ к текущему типу сущности для оптимизированной обработки данных и повышения производительности приложения.
type: docs
weight: 90
