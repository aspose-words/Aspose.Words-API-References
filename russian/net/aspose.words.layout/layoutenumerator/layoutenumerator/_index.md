...
description: Откройте для себя конструктор LayoutEnumerator, легко создавайте новые экземпляры этого класса для эффективного управления макетом в ваших приложениях.
type: docs
weight: 10
...
Если модель макета страницы документа не была построена, перечислитель вызывает[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) чтобы построить его.
