...
description: Получает тип текущего объекта. Это может быть пустая строка но не null.
type: docs
weight: 40
...
Получает тип текущего объекта. Это может быть пустая строка, но не null.
...
Это более конкретный тип текущего объекта, например, диапазон закладок имеетSpantype и могут иметь тип BOOKMARKSTART или BOOKMARKEND.
