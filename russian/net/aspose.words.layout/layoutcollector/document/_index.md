...
Если вам нужно получить доступ к индексам страниц узлов документа, вам нужно установить это свойство так, чтобы оно указывало на экземпляр документа, до построения макета страницы документа. Лучше всего установить это свойство в` null` потом, иначе сборщик продолжит накапливать информацию от последующих перестроений макета страницы документа.
