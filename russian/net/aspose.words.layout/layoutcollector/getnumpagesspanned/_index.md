...
description: Получает количество страниц которые охватывает указанный узел. 0 если узел находится на одной странице. Это то же самое что иGetEndPageIndexaspose.words.layout/layoutcollector/getendpageindex/ GetStartPageIndexaspose.words.layout/layoutcollector/getstartpageindex/ .
type: docs
weight: 60
