...
description: LayoutCollector GetStartPageIndex метод. Получает индекс страницы отсчитываемый от 1 где начинается узел. Возвращает 0 если узел не может быть сопоставлен со страницей на С#.
type: docs
weight: 70
...
Получает индекс страницы, отсчитываемый от 1, где начинается узел. Возвращает 0, если узел не может быть сопоставлен со страницей.
