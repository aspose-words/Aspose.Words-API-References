...
description: LayoutCollector метод. Получает индекс страницы отсчитываемый от 1 где начинается узел. Возвращает 0 если узел не может быть сопоставлен со страницей.
type: docs
weight: 70
