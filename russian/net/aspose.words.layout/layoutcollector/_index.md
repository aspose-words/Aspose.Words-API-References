...
Когда вы создаете`LayoutCollector` и указать[`Document`](../../aspose.words/document/)объект документа для присоединения, сборщик запишет сопоставление узлов документа с объектами макета, когда документ отформатирован в страницы.
