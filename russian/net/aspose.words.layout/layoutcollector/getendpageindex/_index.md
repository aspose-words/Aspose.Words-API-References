...
description: LayoutCollector метод. Получает отсчитываемый от 1 индекс страницы на которой заканчивается узел. Возвращает 0 если узел не может быть сопоставлен со страницей.
type: docs
weight: 40
