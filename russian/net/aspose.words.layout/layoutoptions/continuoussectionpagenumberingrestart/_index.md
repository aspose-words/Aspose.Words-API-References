...
Значение по умолчанию:Always. Это соответствует поведению MS Word 2019, который был последней версией на момент введения этой опции. С помощью этой опции доступна старая логика нумерации страниц, продемонстрированная в MS Word 2016. Пожалуйста[`ContinuousSectionRestart`](../../continuoussectionrestart)для описания поведения.
