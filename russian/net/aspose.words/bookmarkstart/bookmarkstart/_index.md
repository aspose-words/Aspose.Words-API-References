...
description: Инициализирует новый экземплярBookmarkStartaspose.words/bookmarkstart класс.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`BookmarkStart`](../../bookmarkstart) класс.
