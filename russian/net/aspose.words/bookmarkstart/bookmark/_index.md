...
description: Откройте для себя уникальное свойство BookmarkStart для доступа к объекту фасада, упрощающее управление закладками с помощью бесшовной инкапсуляции начала и конца.
type: docs
weight: 20
