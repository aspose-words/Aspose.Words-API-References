...
description: Откройте для себя метод BookmarkStart GetText — эффективно и легко извлекайте текст. Упростите кодирование и улучшите функциональность уже сегодня!
type: docs
weight: 60
