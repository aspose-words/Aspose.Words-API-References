...
description: Получает расстояние по горизонтали между краем кадра и элементом указаннымRelativeHorizontalPositionaspose.words/frameformat/relativehorizontalposition/ свойство.
type: docs
weight: 50
