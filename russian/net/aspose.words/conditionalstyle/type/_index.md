...
description: Откройте для себя свойство ConditionalStyle Type, которое определяет связанную область таблицы, повышая гибкость дизайна и управление стилями.
type: docs
weight: 90
url: /ru/net/aspose.words/conditionalstyle/type/
---
