...
description: ConditionalStyle свойство. Получает или задает количество места в пунктах для добавления над содержимым ячеек таблицы.
type: docs
weight: 80
...
Получает или задает количество места (в пунктах) для добавления над содержимым ячеек таблицы.
