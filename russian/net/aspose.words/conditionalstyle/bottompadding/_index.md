...
description: ConditionalStyle свойство. Получает или задает количество места в пунктах для добавления под содержимым ячеек таблицы.
type: docs
weight: 20
url: /ru/net/aspose.words/conditionalstyle/bottompadding/
---
## ConditionalStyle.BottomPadding property

Получает или задает количество места (в пунктах) для добавления под содержимым ячеек таблицы.
