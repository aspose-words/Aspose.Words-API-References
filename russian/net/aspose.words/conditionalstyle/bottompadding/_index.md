...
description: Отрегулируйте свойство BottomPadding в ConditionalStyle, чтобы настроить интервал между ячейками таблицы. Улучшите свой дизайн с помощью точного контроля над макетом и эстетикой.
type: docs
weight: 20
