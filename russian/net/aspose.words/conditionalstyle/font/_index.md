...
description: Откройте для себя свойство шрифта ConditionalStyle, чтобы легко получать доступ к форматированию символов и настраивать его для улучшенного представления текста в ваших проектах.
type: docs
weight: 30
