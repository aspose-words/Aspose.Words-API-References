...
description: Откройте для себя свойство ConditionalStyle Shading для доступа к форматированию затенения для ваших стилей. Улучшите свои проекты с помощью индивидуальных визуальных эффектов сегодня!
type: docs
weight: 70
url: /ru/net/aspose.words/conditionalstyle/shading/
---
## ConditionalStyle.Shading property

Получает[`Shading`](../../shading/) объект, который ссылается на форматирование штриховки для этого условного стиля.
