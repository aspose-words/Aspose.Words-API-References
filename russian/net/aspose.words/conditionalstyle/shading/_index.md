...
description: ConditionalStyle свойство. ПолучаетShading объект который ссылается на форматирование заливки для этого условного стиля.
type: docs
weight: 70
...
Получает[`Shading`](../../shading/) объект, который ссылается на форматирование заливки для этого условного стиля.
