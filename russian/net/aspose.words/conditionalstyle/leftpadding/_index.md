...
description: ConditionalStyle свойство. Получает или задает количество места в пунктах для добавления слева от содержимого ячеек таблицы.
type: docs
weight: 40
...
Получает или задает количество места (в пунктах) для добавления слева от содержимого ячеек таблицы.
