...
description: Откройте для себя свойство ConditionalStyle RightPadding, чтобы легко настроить интервал между ячейками таблицы. Улучшите свой макет с помощью точного управления для лучшего дизайна.
type: docs
weight: 60
url: /ru/net/aspose.words/conditionalstyle/rightpadding/
---
## ConditionalStyle.RightPadding property

Возвращает или задает размер пространства (в пунктах), добавляемого справа от содержимого ячеек таблицы.
