...
description: Получает документ которому принадлежит данный узел.
type: docs
weight: 20
...
Получает документ, которому принадлежит данный узел.
...
Узел всегда принадлежит документу, даже если он только что создан и еще не добавленный в дерево, или если он был удален из дерева.
