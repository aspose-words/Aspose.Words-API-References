...
description: Получает первого предка указанного типа объекта.
type: docs
weight: 110
...
| --- | --- | --- |
| ancestorType | Type | Тип объекта предка для получения. |

### Возвращаемое значение

Предок указанного типа или ноль, если предок этого типа не найден.

### Примечания

Тип предка соответствует, если он равен ancestorType или является производным от ancestorType.
