...
description: Истинно если этот абзац является последним абзацем вCellaspose.words.tables/cell ложно в противном случае.
type: docs
weight: 50
...
Истинно, если этот абзац является последним абзацем в[`Cell`](../../../aspose.words.tables/cell); ложно в противном случае.
