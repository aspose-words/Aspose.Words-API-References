...
Вызывает DocumentVisitor.VisitParagraphStart, затем вызывает Accept для всех дочерних узлов абзаца и вызывает DocumentVisitor.VisitParagraphEnd в конце.
