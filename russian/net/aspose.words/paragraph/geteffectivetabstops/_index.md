...
description: Возвращает массив всех позиций табуляции примененных к этому абзацу в том числе примененных косвенно стилями или списками.
type: docs
weight: 250
...
Возвращает массив всех позиций табуляции, примененных к этому абзацу, в том числе примененных косвенно стилями или списками.
...
Assert.AreEqual(0, doc.FirstSection.Body.FirstParagraph.GetEffectiveTabStops().Length);
 ...
 // Мы можем добавить собственные позиции табуляции в Microsoft Word, если включим линейку через вкладку «Вид». 
...
Assert.AreEqual(3, para.GetEffectiveTabStops().Length);
 ...
 // в зависимости от значения ведущей вкладки оставляем линию между пунктами отправления и прибытия вкладки.
