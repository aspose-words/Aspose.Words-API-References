...
description: Инициализирует новый экземпляр класса Paragraph .
type: docs
weight: 10
...
Когда **Параграф** есть создан, он принадлежит указанному документу, но не является частью документа и **ParentNode** имеет значение null.

Чтобы добавить **к абзацу** к документу, используйте InsertAfter или InsertBefore on рассказ, в который вы хотите вставить абзац.
