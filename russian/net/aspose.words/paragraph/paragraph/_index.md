...
description: Создавайте динамический контент без усилий с помощью нашего конструктора Paragraph. Легко инициализируйте и настройте свой класс Paragraph для улучшения читаемости.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`Paragraph`](../) класс.
...
Чтобы добавить[`Paragraph`](../) к использованию документа[`InsertAfter`](../../compositenode/insertafter/) или[`InsertBefore`](../../compositenode/insertbefore/) в той истории, куда вы хотите вставить абзац.
