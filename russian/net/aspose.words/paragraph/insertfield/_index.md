...
| --- | --- | --- |
| fieldType | FieldType | Тип вставляемого поля. |
...
| isAfter | Boolean | Вставлять ли поле после или перед ссылочным узлом. |
...
Field field = para.InsertField(" QUOTE \" Real value\" ", run, true);
 ...
 // 3 - Вставить поле QUOTE перед одним из дочерних узлов абзаца, 
