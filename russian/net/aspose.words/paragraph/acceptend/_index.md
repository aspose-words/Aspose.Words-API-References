...
description: Откройте для себя метод Paragraph AcceptEnd, разработанный для улучшения навигации по документу за счет эффективного приема посетителей в конце абзацев.
type: docs
weight: 240
url: /ru/net/aspose.words/paragraph/acceptend/
---
## Paragraph.AcceptEnd method

Принимает посетителя для посещения конца абзаца документа.
