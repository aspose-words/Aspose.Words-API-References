...
description: Предоставляет доступ к типизированному набору фрагментов текста внутри абзаца.
type: docs
weight: 220
...
Предоставляет доступ к типизированному набору фрагментов текста внутри абзаца.
