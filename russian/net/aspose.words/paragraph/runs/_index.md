...
description: Откройте для себя свойство Paragraph Runs для легкого доступа к отформатированным текстовым коллекциям внутри абзацев, что улучшает структуру и читабельность вашего документа.
type: docs
weight: 220
...
Предоставляет доступ к набору фрагментов текста внутри абзаца.
