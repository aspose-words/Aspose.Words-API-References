...
description: Paragraph свойство. Предоставляет доступ к набранному набору фрагментов текста внутри абзаца.
type: docs
weight: 220
...
Предоставляет доступ к набранному набору фрагментов текста внутри абзаца.
