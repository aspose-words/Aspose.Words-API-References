...
description: Получает объектListLabelaspose.words/paragraph/listlabel предоставляющий доступ к значению нумерации и форматированию списка для этого абзаца.
type: docs
weight: 160
...
Получает объект`ListLabel`, предоставляющий доступ к значению нумерации и форматированию списка для этого абзаца.
