...
description: Откройте для себя свойство Paragraph IsInCell. Легко определите, является ли абзац прямым потомком ячейки, улучшив структуру и форматирование документа.
type: docs
weight: 100
...
Истина, если этот абзац является непосредственным потомком[`Cell`](../../../aspose.words.tables/cell/) ; в противном случае ложно.
