...
description: Откройте для себя метод Paragraph AcceptStart, который позволяет незаметно приветствовать посетителей в начале абзацев вашего документа для повышения вовлеченности.
type: docs
weight: 250
url: /ru/net/aspose.words/paragraph/acceptstart/
---
## Paragraph.AcceptStart method

Принимает посетителя для посещения начала абзаца документа.
