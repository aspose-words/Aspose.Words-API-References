...
description: Предоставляет типизированный доступ к набору узловParagraph./paragraph.
type: docs
weight: 4120
...
Предоставляет типизированный доступ к набору узлов[`Paragraph`](../paragraph).
...
| [Item](../../aspose.words/paragraphcollection/item) { get; } | Извлекает абзац по заданному индексу. (2 indexers) |
