...
description: Откройте для себя свойство SignatureLineOptions Signer для настройки строки подписи. Легко задайте предлагаемых подписчиков для повышения ясности документа.
type: docs
weight: 70
