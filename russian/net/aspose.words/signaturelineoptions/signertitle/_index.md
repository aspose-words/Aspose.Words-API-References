...
description: SignatureLineOptions свойство. Получает или задает предлагаемый титул подписывающей стороны. Значение по умолчанию для этого свойства пустой строки Empty .
type: docs
weight: 80
