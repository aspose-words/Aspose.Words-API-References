...
Минимальное значение свойства равно 1. Максимальное значение зависит от ширины страницы и размера шрифта Нормальный стиль. Минимальный шаг символов составляет 90 процентов от размера шрифта. Например, максимальное количество символов в строке страницы Letter с полями в один дюйм равно 43.
