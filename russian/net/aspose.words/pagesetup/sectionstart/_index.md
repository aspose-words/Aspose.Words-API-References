...
description: Откройте для себя свойство PageSetup SectionStart, чтобы легко управлять разрывами разделов в документе. Улучшите форматирование и улучшите контроль макета уже сегодня!
type: docs
weight: 390
