...
description: Откройте для себя свойство PageSetup LineNumberRestartMode для управления нумерацией строк — выбирайте между перезапуском на новых страницах или непрерывной нумерацией для бесшовных документов.
type: docs
weight: 230
...
Возвращает или задает способ нумерации строк, то есть, начинается ли она заново в начале новой страницы или раздела или выполняется непрерывно.
