...
description: Получает или задает способ выполнения нумерации строк т. е. начинается ли она с начала новой страницы или раздела или выполняется непрерывно.
type: docs
weight: 230
...
Получает или задает способ выполнения нумерации строк, т. е. начинается ли она с начала новой страницы или раздела или выполняется непрерывно.
