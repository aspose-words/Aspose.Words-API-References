...
description: Откройте для себя свойство PageSetup LineNumberCountBy, позволяющее легко настраивать приращение номеров строк для улучшенного форматирования и удобства чтения документа.
type: docs
weight: 210
