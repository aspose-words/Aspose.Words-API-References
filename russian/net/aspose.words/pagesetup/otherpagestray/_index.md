...
description: Получает или задает лоток для бумаги лоток который будет использоваться для всех страниц раздела кроме первой. Значение зависит от реализации принтера.
type: docs
weight: 290
