...
description: Получает или задает номер начальной страницы раздела.
type: docs
weight: 320
...
Свойство[`RestartPageNumbering`](../restartpagenumbering), если установлено значение **false** , будет переопределять свойство  **PageStartingNumber** , поэтому эта нумерация страниц может продолжаться с предыдущего раздела.
