...
description: Откройте для себя свойство ConditionalStyleCollection OddRowBanding, чтобы улучшить дизайн вашей таблицы с помощью стильного разделения нечетных строк для лучшей читаемости.
type: docs
weight: 120
