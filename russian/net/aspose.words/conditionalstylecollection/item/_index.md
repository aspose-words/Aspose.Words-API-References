...
description: Извлекает объектConditionalStyleaspose.words/conditionalstyleпо условному тип стиля.
type: docs
weight: 80
...
Извлекает объект[`ConditionalStyle`](../../conditionalstyle)по условному тип стиля.
...
Извлекает объект[`ConditionalStyle`](../../conditionalstyle)по индексу.
