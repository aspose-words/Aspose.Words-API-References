...
description: Откройте для себя свойство EvenColumnBanding в ConditionalStyleCollection для улучшения эстетики таблиц. Улучшите представление данных без усилий!
type: docs
weight: 40
...
Получает стиль полос четных столбцов.
