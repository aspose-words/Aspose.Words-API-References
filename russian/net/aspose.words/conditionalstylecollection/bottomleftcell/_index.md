...
description: Откройте для себя свойство BottomLeftCell класса ConditionalStyleCollection, которое позволит легко настраивать стили ячеек нижнего левого угла для повышения визуальной привлекательности.
type: docs
weight: 10
