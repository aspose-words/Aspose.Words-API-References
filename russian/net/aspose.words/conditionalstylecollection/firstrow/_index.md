...
description: Откройте для себя свойство ConditionalStyleCollection FirstRow, чтобы легко настроить стиль первой строки для повышения визуальной привлекательности и удобства использования.
type: docs
weight: 70
