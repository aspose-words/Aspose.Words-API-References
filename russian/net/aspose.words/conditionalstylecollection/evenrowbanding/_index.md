...
description: Откройте для себя свойство EvenRowBanding в ConditionalStyleCollection для улучшения читаемости с помощью стильных чередующихся цветов строк. Поднимите представление данных на новый уровень!
type: docs
weight: 50
url: /ru/net/aspose.words/conditionalstylecollection/evenrowbanding/
---
## ConditionalStyleCollection.EvenRowBanding property

Получает стиль полос четных строк.
