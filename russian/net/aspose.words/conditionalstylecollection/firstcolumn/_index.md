...
description: Откройте для себя свойство ConditionalStyleCollection FirstColumn, которое позволит легко настроить стиль первого столбца для повышения гибкости дизайна и удобства использования.
type: docs
weight: 60
...
Получает стиль первого столбца.
