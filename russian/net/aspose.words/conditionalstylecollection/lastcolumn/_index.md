...
description: Откройте для себя свойство ConditionalStyleCollection LastColumn, которое позволит легко настраивать стили последнего столбца для повышения гибкости дизайна и визуальной привлекательности.
type: docs
weight: 90
url: /ru/net/aspose.words/conditionalstylecollection/lastcolumn/
---
## ConditionalStyleCollection.LastColumn property

Получает последний стиль столбца.
