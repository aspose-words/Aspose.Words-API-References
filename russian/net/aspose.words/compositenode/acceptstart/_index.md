...
description: Узнайте, как метод CompositeNode AcceptStart улучшает обработку документов, вызывая метод VisitXXXStart для бесшовной интеграции посетителей.
type: docs
weight: 70
url: /ru/net/aspose.words/compositenode/acceptstart/
---
## CompositeNode.AcceptStart method

При реализации в производном классе вызывает метод VisitXXXStart указанного посетителя документа.
