...
description: Откройте для себя свойство CompositeNode FirstChild для легкого доступа к первому дочернему узлу, что повысит эффективность кодирования и упростит управление данными.
type: docs
weight: 20
