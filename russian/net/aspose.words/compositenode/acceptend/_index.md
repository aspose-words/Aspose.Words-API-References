...
description: Узнайте, как улучшить обработку документов с помощью метода AcceptEnd CompositeNode. Оптимизируйте реализацию шаблона посетителя для оптимальной производительности.
type: docs
weight: 60
url: /ru/net/aspose.words/compositenode/acceptend/
---
## CompositeNode.AcceptEnd method

При реализации в производном классе вызывает метод VisitXXXEnd указанного посетителя документа.
