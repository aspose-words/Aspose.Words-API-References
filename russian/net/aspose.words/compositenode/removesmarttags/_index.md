...
description: Удаляет всеSmartTagaspose.words.markup/smarttagузлы-потомки текущего узла.
type: docs
weight: 190
...
Удаляет все[`SmartTag`](../../../aspose.words.markup/smarttag)узлы-потомки текущего узла.
