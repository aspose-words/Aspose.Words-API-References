...
description: Откройте для себя свойство CompositeNode Count, легко извлеките количество непосредственных дочерних узлов для эффективного управления данными и оптимизированной обработки.
type: docs
weight: 10
...
Получает количество непосредственных потомков этого узла.
