...
description: Aspose.Words.DocumentReaderPluginLoadException сорт. Выдается при загрузке документа когда не удается загрузить плагин необходимый для чтения формата документа.
type: docs
weight: 450
