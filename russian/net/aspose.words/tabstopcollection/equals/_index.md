...
description: TabStopCollection метод. Определяет равна ли указанная коллекция TabStopCollection по значению текущей коллекции TabStopCollection.
type: docs
weight: 70
...
Определяет, равна ли указанная коллекция TabStopCollection по значению текущей коллекции TabStopCollection.
