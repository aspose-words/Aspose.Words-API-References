...
description: Откройте для себя метод TabStopCollection Equals, который позволяет легко сравнивать TabStopCollections на предмет равенства, повышая эффективность и точность кодирования.
type: docs
weight: 70
...
Определяет, является ли указанный[`TabStopCollection`](../) равен по значению текущему[`TabStopCollection`](../) .
