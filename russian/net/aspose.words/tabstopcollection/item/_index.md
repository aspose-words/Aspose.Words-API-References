...
description: Получает позицию табуляции по заданному индексу.
type: docs
weight: 20
...
| Параметр | Описание |
| --- | --- |
| position | Позиция (в пунктах) позиции табуляции. |

### Примечания

Возвращает ноль, если в указанной позиции не найдена табуляция.
