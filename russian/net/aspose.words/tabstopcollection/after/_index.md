...
description: Получает первую позицию табуляции справа от указанной позиции.
type: docs
weight: 40
...
| --- | --- | --- |
| position | Double | Базовая позиция (в пунктах). |

### Возвращаемое значение

Объект табуляции или ноль, если подходящая табуляция не найдена.

### Примечания

Пропускает позиции табуляции с **Выравнивание** установлен в` TabAlignment.Bar` .
