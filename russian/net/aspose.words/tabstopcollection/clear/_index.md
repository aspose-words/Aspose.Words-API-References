...
description: Легко очищайте все позиции табуляции с помощью метода TabStopCollection Clear. Оптимизируйте макет для более чистого и организованного интерфейса.
type: docs
weight: 60
