...
description: Aspose.Words.ControlChar сорт. Управляющие символы часто встречаются в документах.
type: docs
weight: 340
...
| const [FieldSeparatorChar](../../aspose.words/controlchar/fieldseparatorchar/) | Знак-разделитель полей отделяет код поля от значения поля. Необязательный в некоторых полях. Значение: (char)20. |
| const [FieldStartChar](../../aspose.words/controlchar/fieldstartchar/) | Знак начала поля MS Word: (char)19. |
