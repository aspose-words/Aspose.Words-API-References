...
Чтобы узнать больше, посетите[Работа с управляющими персонажами](https://docs.aspose.com/words/net/working-with-control-characters/) статья документации.
...
| Имя | Описание |
| --- | --- |
| static readonly [Cell](../../aspose.words/controlchar/cell/) | Конец ячейки таблицы или символ конца строки таблицы: «\x0007» или «\a». |
| const [CellChar](../../aspose.words/controlchar/cellchar/) | Конец ячейки таблицы или символ конца строки таблицы: (char)7 или "\a". |
...
| static readonly [Cr](../../aspose.words/controlchar/cr/) | Символ возврата каретки: «\x000d» или «\r». Такой же как[`ParagraphBreak`](./paragraphbreak/) . |
...
| const [DefaultTextInputChar](../../aspose.words/controlchar/defaulttextinputchar/) | Это символ «о», используемый в качестве значения по умолчанию в полях формы ввода текста. |
| const [FieldEndChar](../../aspose.words/controlchar/fieldendchar/) | Символ конца поля MS Word: (char)21. |
| const [FieldSeparatorChar](../../aspose.words/controlchar/fieldseparatorchar/) | Символ-разделитель полей отделяет код поля от значения поля. Необязательно в некоторых полях. Значение: (символ)20. |
...
| static readonly [LineBreak](../../aspose.words/controlchar/linebreak/) | Символ разрыва строки: «\x000b» или «\v». |
| const [LineBreakChar](../../aspose.words/controlchar/linebreakchar/) | Символ разрыва строки: (char)11 или "\v". |
...
| static readonly [PageBreak](../../aspose.words/controlchar/pagebreak/) | Символ разрыва страницы: «\x000c» или «\f». Обратите внимание, что оно имеет то же значение, что и[`SectionBreak`](./sectionbreak/) . |
| const [PageBreakChar](../../aspose.words/controlchar/pagebreakchar/) | Символ разрыва страницы: (char)12 или "\f". |
| static readonly [ParagraphBreak](../../aspose.words/controlchar/paragraphbreak/) | Символ конца абзаца: «\x000d» или «\r». Такой же как[`Cr`](./cr/) |
| const [ParagraphBreakChar](../../aspose.words/controlchar/paragraphbreakchar/) | Символ конца абзаца: (char)13 или "\r". |
| static readonly [SectionBreak](../../aspose.words/controlchar/sectionbreak/) | Символ конца раздела: «\x000c» или «\f». Обратите внимание, что оно имеет то же значение, что и[`PageBreak`](./pagebreak/) . |
