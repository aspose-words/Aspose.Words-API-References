...
description: Откройте для себя поле ControlChar PageBreakChar для эффективного форматирования документов. Улучшите свой рабочий процесс с помощью настраиваемых параметров разрыва страницы!
type: docs
weight: 210
url: /ru/net/aspose.words/controlchar/pagebreakchar/
---
