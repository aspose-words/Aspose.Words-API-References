...
description: Освойте MS Word с ControlChar и FieldEndChar! Улучшите форматирование документов и оптимизируйте рабочий процесс без особых усилий.
type: docs
weight: 80
...
Конец символа поля MS Word: (char)21.
