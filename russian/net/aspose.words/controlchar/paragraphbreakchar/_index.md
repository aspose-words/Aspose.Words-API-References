...
description: Откройте для себя поле ControlChar ParagraphBreakChar, оптимизируйте форматирование текста с помощью необходимого символа конца абзаца для эффективного редактирования документов.
type: docs
weight: 230
url: /ru/net/aspose.words/controlchar/paragraphbreakchar/
---
