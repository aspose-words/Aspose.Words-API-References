...
description: Откройте для себя поле ControlChar LineBreak для бесшовного форматирования текста с помощью символа x000b или v. Повысьте читабельность своего контента уже сегодня!
type: docs
weight: 120
...
Символ переноса строки: "\x000b" или "\v".
