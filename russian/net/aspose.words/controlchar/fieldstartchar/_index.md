...
description: Откройте для себя ControlChar FieldStartChar для MS Word. Легко управляйте символами полей и улучшайте форматирование документов с точностью!
type: docs
weight: 100
...
Начало символа поля MS Word: (char)19.
