...
description: Узнайте, как использовать необязательный дефис в Microsoft Word (char31) для улучшения форматирования документа и повышения его читабельности. Узнайте больше прямо сейчас!
type: docs
weight: 190
...
Необязательный дефис в Microsoft Word не соответствует символу Unicode U+00AD (мягкий дефис). Вместо этого он вставляет внутреннюю информацию, сообщающую Word о возможной точке переноса.
