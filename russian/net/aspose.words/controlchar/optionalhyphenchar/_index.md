...
description: Необязательный дефис в Microsoft Wordchar31.
type: docs
weight: 190
...
Необязательный дефис в Microsoft Word не соответствует мягкому дефису Unicode U+00AD. Вместо этого он вставляет внутреннюю информацию, которая сообщает Word о возможной точке переноса.
