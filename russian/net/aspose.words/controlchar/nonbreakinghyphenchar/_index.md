...
description: Неразрывный дефис в Microsoft Word равен char30.
type: docs
weight: 160
...
Неразрывный дефис в Microsoft Word не соответствует символу Unicode U+2011 неразрывный дефис, но вместо этого представляет внутреннюю информацию, которая указывает Microsoft Word отображать дефис, а не разрывать строку.
