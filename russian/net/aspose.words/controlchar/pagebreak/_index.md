...
description: Откройте для себя поле ControlChar PageBreak, эффективно управляйте разрывами страниц с помощью символа x000c. Упростите форматирование документов сегодня!
type: docs
weight: 200
