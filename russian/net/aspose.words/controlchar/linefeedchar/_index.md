...
description: Откройте для себя поле ControlChar LineFeedChar — оптимизируйте обработку текста с помощью основного символа перевода строки (char10 или n) для бесперебойной обработки данных.
type: docs
weight: 150
