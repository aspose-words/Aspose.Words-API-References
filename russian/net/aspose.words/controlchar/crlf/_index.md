...
description: ControlChar поле. Возврат каретки за которым следует символ перевода строки x000dx000a или rn. Не используется как таковой в документах Microsoft Word но обычно используется в текстовых файлах для разрывов абзаца.
type: docs
weight: 60
