...
description: Возврат каретки с последующим символом перевода строкиx000dx000a или rn. Не используется как таковой в документах Microsoft Word но обычно используется в текстовых файлах для разрывов абзаца.
type: docs
weight: 60
