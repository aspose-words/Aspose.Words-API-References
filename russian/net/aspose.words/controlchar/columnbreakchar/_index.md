...
description: Откройте для себя поле ControlChar ColumnBreakChar — оптимизируйте свои данные с помощью мощного символа конца столбца char14 для бесшовного форматирования!
type: docs
weight: 40
