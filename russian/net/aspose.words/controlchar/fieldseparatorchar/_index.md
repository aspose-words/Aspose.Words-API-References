...
description: ControlChar поле. Знакразделитель полей отделяет код поля от значения поля. Необязательный в некоторых полях. Значение char20.
type: docs
weight: 90
...
Знак-разделитель полей отделяет код поля от значения поля. Необязательный в некоторых полях. Значение: (char)20.
