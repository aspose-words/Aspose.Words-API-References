...
description: Узнайте, как ControlChar FieldSeparatorChar улучшает управление данными, эффективно отделяя коды полей от значений, что позволяет легко оптимизировать рабочий процесс.
type: docs
weight: 90
url: /ru/net/aspose.words/controlchar/fieldseparatorchar/
---
## ControlChar.FieldSeparatorChar field

Символ-разделитель полей отделяет код поля от значения поля. Необязательно в некоторых полях. Значение: (char)20.
