...
description: Откройте для себя поле ControlChar ColumnBreak, оптимизируйте макет документа с помощью символа конца столбца x000e для улучшенного управления форматированием.
type: docs
weight: 30
url: /ru/net/aspose.words/controlchar/columnbreak/
---
