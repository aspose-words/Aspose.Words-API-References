...
description: Откройте для себя поле ControlChar DefaultTextInputChar, в котором символ «o» является идеальным значением по умолчанию для ваших форм ввода текста. Улучшите пользовательский опыт!
type: docs
weight: 70
