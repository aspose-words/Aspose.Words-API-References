...
description: Откройте для себя поле ControlChar SectionBreakChar, оптимизируйте форматирование документа с помощью необходимого символа конца раздела для обеспечения бесперебойного потока текста.
type: docs
weight: 250
