...
description: Откройте для себя поле ControlChar SectionBreak, эффективно управляйте разделами документа с помощью символа x000c, улучшая форматирование и удобочитаемость.
type: docs
weight: 240
