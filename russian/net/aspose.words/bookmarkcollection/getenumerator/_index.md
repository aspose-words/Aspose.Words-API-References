...
description: Откройте для себя метод BookmarkCollection GetEnumerator. Эффективно извлекайте объекты перечислителя для бесперебойной обработки данных и повышения производительности.
type: docs
weight: 40
