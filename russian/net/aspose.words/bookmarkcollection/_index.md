...
description: Набор объектовBookmark./bookmark представляющих закладки в указанном диапазоне.
type: docs
weight: 40
...
Набор объектов[`Bookmark`](../bookmark), представляющих закладки в указанном диапазоне.
