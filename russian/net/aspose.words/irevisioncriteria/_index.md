...
description: Легко контролируйте изменения документов с помощью Aspose.Words.IRevisionCriteria. Настройте принятие и отклонение изменений для точного управления документами.
type: docs
weight: 3650
url: /ru/net/aspose.words/irevisioncriteria/
---
## IRevisionCriteria interface

Реализуйте этот интерфейс, если вы хотите контролировать, когда определенные[`Revision`](../revision/) должен быть принят/отклонен или нет[`Accept`](../revisioncollection/accept/)/[`Reject`](../revisioncollection/reject/) методы.
...
| Имя | Описание |
| --- | --- |
| [IsMatch](../../aspose.words/irevisioncriteria/ismatch/)(*[Revision](../revision/)*) | Проверяет, указано ли*revision* соответствует критериям. |
