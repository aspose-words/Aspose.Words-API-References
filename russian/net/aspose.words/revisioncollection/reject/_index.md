...
description: Откройте для себя метод отклонения RevisionCollection, позволяющий эффективно отфильтровывать нежелательные изменения на основе ваших критериев для оптимизации управления проектами.
type: docs
weight: 70
url: /ru/net/aspose.words/revisioncollection/reject/
---
...
Количество отклоненных ревизий.
