...
description: Откройте для себя свойство RevisionCollection Count, которое эффективно отображает общее количество ревизий, улучшая управление данными и их отслеживание.
type: docs
weight: 10
