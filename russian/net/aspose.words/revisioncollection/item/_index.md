...
description: Легко получайте доступ к определенным ревизиям с помощью свойства RevisionCollection Item. Быстро извлекайте ревизии по индексу для оптимизированного управления данными.
type: docs
weight: 30
