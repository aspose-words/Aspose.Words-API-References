...
description: Откройте для себя метод RevisionCollection GetEnumerator! Эффективно извлекайте объекты перечислителя для бесперебойного управления данными и повышения производительности.
type: docs
weight: 60
