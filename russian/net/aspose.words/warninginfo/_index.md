...
description: Содержит информацию о предупреждении выдаваемом Aspose.Words при загрузке или сохранении документа.
type: docs
weight: 6270
...
Содержит информацию о предупреждении, выдаваемом Aspose.Words при загрузке или сохранении документа.
...
Экземпляры этого класса не создаются. Объекты этого класса создаются и передаются Aspose.Words в метод[`Warning`](../iwarningcallback/warning).

### Примеры

Показывает, как установить свойство для поиска ближайшего совпадения для отсутствующего шрифта из доступных источников шрифтов.
