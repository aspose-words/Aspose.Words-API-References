...
description: Aspose.Words вызывает этот метод когда во время загрузки документа или сохранения возникает проблема которая может привести к потере форматирования или точности данных.
type: docs
weight: 10
