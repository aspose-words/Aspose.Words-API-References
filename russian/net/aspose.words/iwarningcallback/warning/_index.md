...
description: Aspose.Words вызывает этот метод когда во время загрузки документа или сохранения возникают проблемы которые могут привести к потере форматирования или точности данных.
type: docs
weight: 10
...
Aspose.Words вызывает этот метод, когда во время загрузки документа или сохранения возникают проблемы, которые могут привести к потере форматирования или точности данных.
