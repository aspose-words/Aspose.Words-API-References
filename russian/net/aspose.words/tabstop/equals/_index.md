...
description: Откройте для себя метод TabStop Equals для эффективного сравнения экземпляров TabStop. Повысьте точность кодирования и оптимизируйте процесс разработки!
type: docs
weight: 60
url: /ru/net/aspose.words/tabstop/equals/
---
## TabStop.Equals method

Сравнивает с указанным[`TabStop`](../) .
