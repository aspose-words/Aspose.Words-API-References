...
description: Узнайте, как свойство TabStop IsClear улучшает ваш пользовательский интерфейс, обеспечивая бесперебойное управление вкладками и очищая существующие остановки для более удобной работы пользователя.
type: docs
weight: 30
...
Возврат`истинный` если эта позиция табуляции очищает все существующие позиции табуляции в этой позиции.
