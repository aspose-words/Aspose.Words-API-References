...
description: Откройте для себя свойство TableStyle CellSpacing, позволяющее легко настраивать интервал между ячейками в пунктах, улучшая внешний вид и читабельность таблицы.
type: docs
weight: 60
