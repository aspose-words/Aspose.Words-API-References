...
description: Откройте для себя свойство TableStyle RightPadding, настройте макет ячеек таблицы, установив точные отступы справа для улучшения читаемости и наглядности.
type: docs
weight: 110
