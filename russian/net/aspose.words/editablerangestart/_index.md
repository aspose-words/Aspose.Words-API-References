...
[`EditableRangeStart`](../editablerangestart)и[`EditableRangeEnd`](../editablerangeend)являются просто маркерами внутри документа которые указывают, где начинается и заканчивается редактируемый диапазон.
