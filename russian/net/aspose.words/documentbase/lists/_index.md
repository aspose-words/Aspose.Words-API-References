...
description: Предоставляет доступ к форматированию списка используемому в документе.
type: docs
weight: 40
...
Для получения дополнительной информации см. описаниеСписокКоллекциякласс.
