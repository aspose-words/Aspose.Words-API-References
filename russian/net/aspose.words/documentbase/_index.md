...
| [ImportNode](../../aspose.words/documentbase/importnode#importnode_1)(Node, bool, ImportFormatMode) | Импорт узла из другого документа в текущий документ с возможностью управления форматированием. |
...
Aspose.Words представляет документ Word в виде дерева узлов.[`DocumentBase`](../documentbase)— это корневой узел дерева, содержащий все остальные узлы документа.
