...
description: Откройте для себя свойство BookmarkEnd, легко получайте доступ к узлу, отмечающему конец вашей закладки, для эффективной навигации и управления документами.
type: docs
weight: 10
url: /ru/net/aspose.words/bookmark/bookmarkend/
---
