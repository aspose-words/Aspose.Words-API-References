...
description: Откройте для себя свойство LastColumn, легко получите доступ к нулевому индексу последнего столбца в диапазоне закладок вашей таблицы для эффективного управления данными.
type: docs
weight: 50
...
Возвращает отсчитываемый от нуля индекс последнего столбца диапазона столбцов таблицы, связанного с закладкой.
