...
description: Откройте для себя свойство BookmarkStart, чтобы легко получить доступ к узлу, отмечающему начало вашей закладки, что улучшит навигацию и эффективность вашего проекта.
type: docs
weight: 20
url: /ru/net/aspose.words/bookmark/bookmarkstart/
---
