...
description: Откройте для себя свойство Inline IsMoveFromRevision в Microsoft Word. Узнайте, как оно отслеживает удаленные объекты для эффективного управления документами и их редактирования.
type: docs
weight: 50
