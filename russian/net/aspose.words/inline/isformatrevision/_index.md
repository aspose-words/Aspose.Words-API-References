...
description: Откройте для себя свойство Inline IsFormatRevision в Microsoft Word. Оно указывает, изменилось ли форматирование объекта при включенном отслеживании изменений, что улучшает управление документами.
type: docs
weight: 30
