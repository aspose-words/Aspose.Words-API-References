...
description: Узнайте, как свойство IsMoveToRevision в Microsoft Word отслеживает перемещения объектов. Обеспечьте точное отслеживание изменений для бесперебойного редактирования документов!
type: docs
weight: 60
url: /ru/net/aspose.words/inline/ismovetorevision/
---
