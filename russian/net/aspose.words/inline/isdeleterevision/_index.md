...
description: Откройте для себя свойство Inline IsDeleteRevision в Microsoft Word, которое указывает, был ли объект удален во время отслеживания изменений. Улучшите управление документами!
type: docs
weight: 20
