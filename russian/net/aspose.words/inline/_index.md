...
description: Aspose.Words.Inline сорт. Базовый класс для узлов встроенного уровня которые могут иметь связанное с ними форматирование символов но не могут иметь собственных дочерних узлов.
type: docs
weight: 3060
