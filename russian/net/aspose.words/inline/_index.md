...
description: Aspose.Words.Inline сорт. Базовый класс для узлов строчного уровня с которыми может быть связано форматирование символов но не может иметь собственных дочерних узлов на С#.
type: docs
weight: 3260
