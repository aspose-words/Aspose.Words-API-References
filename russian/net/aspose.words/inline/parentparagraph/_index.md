...
description: Откройте для себя свойство Inline ParentParagraph, которое позволяет легко получить доступ к родительскому абзацу любого узла, повышая эффективность и структуру кодирования.
type: docs
weight: 70
