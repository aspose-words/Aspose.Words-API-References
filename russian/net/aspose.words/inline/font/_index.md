...
description: Откройте для себя свойство Inline Font для бесшовного управления форматированием шрифта. Улучшите свой дизайн с помощью легкого доступа к настраиваемым стилям и эффектам текста.
type: docs
weight: 10
