...
description: Откройте для себя свойство Inline IsInsertRevision. Легко проверяйте, был ли добавлен объект в Word с активным отслеживанием изменений. Улучшите управление документами!
type: docs
weight: 40
url: /ru/net/aspose.words/inline/isinsertrevision/
---
