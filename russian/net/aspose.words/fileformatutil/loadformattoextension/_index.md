...
description: Преобразуйте значения формата загрузки в расширения файлов без усилий с помощью метода LoadFormatToExtension FileFormatUtil. Получайте точные, строчные расширения с легкостью!
type: docs
weight: 60
...
Преобразует значение формата загрузки в расширение файла. Возвращаемое расширение — это строка в нижнем регистре с точкой в начале.
