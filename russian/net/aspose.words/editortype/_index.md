...
description: Задает набор возможных псевдонимов или групп редактирования которые можно использовать в качестве псевдонимов для определения того разрешено ли текущему пользователю редактировать один диапазон  определяемый редактируемым диапазоном в документе.
type: docs
weight: 1300
