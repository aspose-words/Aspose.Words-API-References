...
description: INodeChangingCallback NodeRemoving метод. Вызывается непосредственно перед тем как узел принадлежащий этому документу будет удален из документа на С#.
type: docs
weight: 40
