...
description: Откройте для себя метод INodeChangingCallback NodeRemoving, который срабатывает перед удалением узла документа, обеспечивая бесперебойное управление документами.
type: docs
weight: 40
