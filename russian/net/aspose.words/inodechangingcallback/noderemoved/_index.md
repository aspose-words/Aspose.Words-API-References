...
description: Откройте для себя метод INodeChangingCallback NodeRemoved, который активируется при удалении узла документа, повышая эффективность кодирования и управления документами.
type: docs
weight: 30
...
Вызывается, когда узел, принадлежащий данному документу, был удален из своего родителя.
