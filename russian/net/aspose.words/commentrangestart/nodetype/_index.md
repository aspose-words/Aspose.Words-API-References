...
description: Откройте для себя свойство CommentRangeStart NodeType, которое эффективно извлекает начальную точку комментариев для улучшенного управления данными.
type: docs
weight: 30
url: /ru/net/aspose.words/commentrangestart/nodetype/
---
## CommentRangeStart.NodeType property

ВозвратCommentRangeStart .
