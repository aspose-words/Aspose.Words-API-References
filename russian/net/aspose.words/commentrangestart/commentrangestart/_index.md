...
Когда[`CommentRangeStart`](../../commentrangestart) создан, он принадлежит указанному документу, но не является частью документа и[`ParentNode`](../../node/parentnode) нулевой.

Чтобы добавить[`CommentRangeStart`](../../commentrangestart) к документу используйте InsertAfter или InsertBefore в абзаце, куда вы хотите вставить комментарий.
