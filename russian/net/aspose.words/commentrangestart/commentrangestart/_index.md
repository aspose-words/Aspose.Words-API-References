...
Когда[`CommentRangeStart`](../../commentrangestart)создается, он принадлежит указанному документу, но не является частью документа, а[`ParentNode`](../../node/parentnode)равен null.

Чтобы добавить[`CommentRangeStart`](../../commentrangestart)к документу, используйте InsertAfter или InsertBefore на абзац, в который вы хотите вставить комментарий.
