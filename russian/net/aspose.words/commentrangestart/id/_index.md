...
description: CommentRangeStart свойство. Указывает идентификатор комментария к которому привязан этот регион.
type: docs
weight: 20
...
Указывает идентификатор комментария, к которому привязан этот регион.
