...
description: Откройте для себя метод CommentRangeStart Accept для повышения вовлеченности посетителей и оптимизации взаимодействия на вашем сайте. Повысьте пользовательский опыт сегодня!
type: docs
weight: 40
url: /ru/net/aspose.words/commentrangestart/accept/
---
...
Звонки[`VisitCommentRangeStart`](../../documentvisitor/visitcommentrangestart/).
