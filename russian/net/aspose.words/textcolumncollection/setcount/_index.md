...
Когда[`EvenlySpaced`](../evenlyspaced) **false** и вы увеличиваете количество столбцов, новый[`TextColumn`](../../textcolumn)объекты создан с нулевой шириной и интервалом. Вам необходимо установить ширину и интервал для новых столбцов.
