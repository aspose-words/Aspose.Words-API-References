...
description: Возвращает или задает псевдоним или группу редактирования который будет использоваться для определения того разрешено ли текущему пользователю редактировать этот редактируемый диапазон .
type: docs
weight: 30
...
Отдельный пользователь и группа редакторов не могут быть установлены одновременно для определенного редактируемого диапазона, если один установлен, другой будет понятен.
