...
description: Инициализирует новый экземпляр класса Body .
type: docs
weight: 10
...
Инициализирует новый экземпляр класса **Body** .
...
Когда **Тело** есть создан, он принадлежит указанному документу, но не является частью документа и **ParentNode** имеет значение null.

Добавить **Тело** к **Раздел** используйте Section.InsertAfter или Section.InsertBefore.
