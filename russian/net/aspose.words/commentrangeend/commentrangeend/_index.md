...
description: Откройте для себя конструктор CommentRangeEnd, легко создавайте новые экземпляры этого класса для бесшовной интеграции кода и расширенной функциональности.
type: docs
weight: 10
...
Чтобы добавить[`CommentRangeEnd`](../) в документе используйте InsertAfter или InsertBefore в абзаце, куда вы хотите вставить комментарий.
