...
Когда[`CommentRangeEnd`](../../commentrangeend)создается, он принадлежит указанному документу, но не является частью документа, а[`ParentNode`](../../node/parentnode)равен null.

Чтобы добавить[`CommentRangeEnd`](../../commentrangeend)к документу, используйте InsertAfter или InsertBefore на абзац, в который вы хотите вставить комментарий.
