...
Чтобы начать стол, просто позвоните **Вставить ячейку** . После этого любой контент, который вы добавляете с помощью других методов[`DocumentBuilder`](../../documentbuilder) класс будет добавлен в текущую ячейку.
