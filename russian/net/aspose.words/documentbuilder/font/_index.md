...
description: Возвращает объект представляющий текущие свойства форматирования шрифта.
type: docs
weight: 90
...
Использовать шрифт для доступ и изменение свойств форматирования шрифта.
