...
description: Вставляет встроенный или связанный объект OLE в качестве значка в документ. Позволяет указать файл значка и заголовок. Определяет тип объекта OLE используя расширение файла.
type: docs
weight: 380
