...
Если ваше онлайн-видео не отображается правильно используйте[`InsertOnlineVideo`](../insertonlinevideo), который принимает пользовательский встроенный HTML-код .

Код для встраивания видео может варьироваться в зависимости от провайдера, за подробностями обращайтесь к соответствующему провайдеру.
