...
**CurrentNode** является курсор **DocumentBuilder** и указывает на узел который является прямой потомок **Параграф** . Любые операции вставки, которые вы выполняете с помощью  **DocumentBuilder** , будут вставлены перед **CurrentNode** .

Когда текущий абзац пуст или курсор стоит перед концом абзаца, **CurrentNode** возвращает ноль.

### Примеры

Показывает, как переместить курсор конструктора документов в различные узлы в документе.
