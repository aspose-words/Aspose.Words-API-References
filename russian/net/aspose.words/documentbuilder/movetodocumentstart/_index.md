...
description: Откройте для себя метод MoveToDocumentStart в DocumentBuilder, который позволяет легко перейти к началу документа и повысить эффективность редактирования.
type: docs
weight: 560
