...
Перемещает курсор в позицию сразу после начала закладки с указанное имя.

При сравнении не учитывается регистр. Если закладка не найдена, возвращается false и курсор не перемещается.
...
| isAfter | Boolean | При значении true курсор перемещается после закладки начальная или конечная позиция. При значении false перемещает курсор перед закладкой начальная или конечная позиция. |
...
Если нужная позиция не на встроенном уровне, переходит к следующему абзацу.
