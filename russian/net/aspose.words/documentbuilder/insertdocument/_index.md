...
Этот метод имитирует поведение MS Word, как если бы были нажаты CTRL+'A' (выделить все содержимое), затем CTRL+'C' (скопировать выбранное в буфер) внутри одного документа , а затем CTRL+'V' (вставить содержимое из буфер) внутри другого документа.
