...
description: DocumentBuilder метод. Вставляет разделитель стилей в документ.
type: docs
weight: 430
...
// который может иметь стиль, отличный от предыдущего. Между абзацами не будет разрыва.
