...
description: Отмечает текущую позицию в документе как начало закладки.
type: docs
weight: 580
...
Закладки в документе могут перекрываться и охватывать любой диапазон. Чтобы создать действительную закладку, вам нужно вызвать как`StartBookmark`, так и[`EndBookmark`](../endbookmark)с тем же параметром **bookmarkName** .
