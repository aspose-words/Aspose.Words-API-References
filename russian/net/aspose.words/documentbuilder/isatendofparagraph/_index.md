...
description: Откройте для себя свойство IsAtEndOfParagraph в DocumentBuilder, которое эффективно проверяет, находится ли курсор в конце абзаца, обеспечивая бесперебойное редактирование документа.
type: docs
weight: 110
...
Возврат`истинный` если курсор находится в конце текущего абзаца.
