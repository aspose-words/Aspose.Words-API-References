...
description: Завершает строку таблицы в документе.
type: docs
weight: 220
...
Вызов **EndRow** в конец строки таблицы. Если вы вызовете[`InsertCell`](../insertcell)немедленно после этого, то таблица продолжится с новой строки.

Используйте свойство[`RowFormat`](../rowformat)для указания форматирования строки.
