...
description: Откройте для себя свойство Revision Group, легко извлеките группы ревизий или получите null, если группы не существует. Упростите управление данными сегодня!
type: docs
weight: 30
...
Получает группу ревизий. Возвращает`нулевой` если ревизия не принадлежит ни к одной группе.
...
Ревизия не имеет группы, если тип ревизииStyleDefinitionChange или , если редакция больше не существует в контексте документа (принята/отклонена).
