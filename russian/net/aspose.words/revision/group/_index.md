...
Ревизия не имеет группы, если тип ревизии - RevisionType.StyleDefinitionChange или если редакция больше не существует в контексте документа (принята/отклонена).
