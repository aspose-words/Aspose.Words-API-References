...
description: Revision свойство. Получает группу ревизий. Возвращает null если ревизия не принадлежит ни к одной группе.
type: docs
weight: 30
...
Получает группу ревизий. Возвращает null, если ревизия не принадлежит ни к одной группе.
...
Редакция не имеет группы, если тип редакции — RevisionType.StyleDefinitionChange или , если редакция больше не существует в контексте документа (принята/отклонена).
