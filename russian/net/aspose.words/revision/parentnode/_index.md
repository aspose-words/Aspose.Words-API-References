...
description: Получает непосредственный родительский узел владелец этой ревизии. Это свойство будет работать для любого типа ревизии кромеStyleDefinitionChange.
type: docs
weight: 40
...
Если эта редакция связана с изменением форматирования стиля, используйте[`ParentStyle`](../parentstyle)вместо этого.
