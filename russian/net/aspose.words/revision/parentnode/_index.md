...
description: Откройте для себя свойство Revision ParentNode, которое определяет прямой родительский узел любого типа ревизии, за исключением StyleDefinitionChange. Повысьте эффективность кодирования!
type: docs
weight: 40
...
Получает непосредственный родительский узел (владельца) этой ревизии. Это свойство будет работать для любого типа ревизии, кромеStyleDefinitionChange .
...
Если эта редакция касается изменения форматирования стиля, используйте[`ParentStyle`](../parentstyle/) вместо этого.
