...
description: Управляйте своим автором редакции без усилий. Легко устанавливайте или обновляйте данные автора для каждой редакции, обеспечивая ясность и подотчетность в ваших документах.
type: docs
weight: 10
url: /ru/net/aspose.words/revision/author/
---
## Revision.Author property

Возвращает или задает автора этой ревизии. Не может быть пустой строкой или`нулевой` .
