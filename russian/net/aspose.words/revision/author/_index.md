...
description: Revision свойство. Получает или задает автора этой версии. Не может быть пустой строкой или нулевым значением.
type: docs
weight: 10
...
Получает или задает автора этой версии. Не может быть пустой строкой или нулевым значением.
