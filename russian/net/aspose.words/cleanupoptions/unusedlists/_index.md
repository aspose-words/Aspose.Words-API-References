...
description: CleanupOptions свойство. Указывает следует ли удалять из документа неиспользуемый список и определения списков. Значение по умолчанию истинный .
type: docs
weight: 40
