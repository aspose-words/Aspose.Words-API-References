...
description: CleanupOptions DuplicateStyle свойство. Получает/устанавливает флаг указывающий следует ли удалять повторяющиеся стили из документа. Значение по умолчаниюЛОЖЬ  на С#.
type: docs
weight: 20
