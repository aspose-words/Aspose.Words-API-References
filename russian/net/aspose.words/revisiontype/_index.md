...
description: Откройте для себя перечисление Aspose.Words.RevisionType для эффективного отслеживания и управления изменениями документов. Улучшите редактирование документов с точностью!
type: docs
weight: 5540
...
Указывает тип отслеживаемых изменений[`Revision`](../revision/) .
...
| --- | --- | --- |
| Insertion | `0` | В документ вставлен новый контент. |
| Deletion | `1` | Содержимое было удалено из документа. |
...
| Moving | `4` | Содержимое было перемещено в документе. |
