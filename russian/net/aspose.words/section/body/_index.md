...
description: Возвращает дочерний узел Body раздела.
type: docs
weight: 20
...
Возвращает дочерний узел **Body** раздела.
...
Возвращает ноль, если раздел не имеет узла **Body** среди дочерних элементов.
