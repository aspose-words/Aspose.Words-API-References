...
description: Вызывается во время загрузки шаблонов расстановки переносов когда обнаруживается проблема которая может привести к потере точности форматирования.
type: docs
weight: 20
