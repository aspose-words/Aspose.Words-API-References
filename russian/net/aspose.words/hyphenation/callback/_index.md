...
description: Hyphenation свойство. Получает или задает интерфейс обратного вызова используемый для запроса словарей при построении макета страницы документа. Позволяет отложить загрузку словарей что может быть полезно при обработке документов на многих языках.
type: docs
weight: 10
...
Получает или задает интерфейс обратного вызова, используемый для запроса словарей при построении макета страницы документа. Позволяет отложить загрузку словарей, что может быть полезно при обработке документов на многих языках.
