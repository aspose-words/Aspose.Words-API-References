...
description: Aspose.Words.Hyphenation сорт. Предоставляет методы для работы со словарями переносов. Эти словари предписывают где слова определенного языка могут быть расставлены через дефис.
type: docs
weight: 2970
