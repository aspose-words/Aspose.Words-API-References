...
description: Откройте для себя свойство HeaderFooter ParentSection, чтобы легко получить доступ к родительскому разделу вашей истории, улучшив структуру и организацию вашего документа.
type: docs
weight: 60
