...
description: Повысьте удобство использования вашего веб-сайта с помощью метода HeaderFooter AcceptEnd, разработанного для беспрепятственного управления взаимодействиями посетителей в конце заголовка.
type: docs
weight: 80
url: /ru/net/aspose.words/headerfooter/acceptend/
---
## HeaderFooter.AcceptEnd method

Принимает посетителя для посещения конца заголовка.
