...
description: Откройте для себя метод HeaderFooter AcceptStart, разработанный для незаметного приветствия посетителей в начале заголовка, что улучшает пользовательский опыт и вовлеченность.
type: docs
weight: 90
url: /ru/net/aspose.words/headerfooter/acceptstart/
---
## HeaderFooter.AcceptStart method

Принимает посетителя для посещения начала заголовка.
