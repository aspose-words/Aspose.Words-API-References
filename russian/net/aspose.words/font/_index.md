...
| Имя | Описание |
| --- | --- |
| [AllCaps](../../aspose.words/font/allcaps) { get; set; } | Истинно, если шрифт отформатирован как все заглавные буквы. |
| [AutoColor](../../aspose.words/font/autocolor) { get; } | Возвращает текущий рассчитанный цвет текста (черный или белый), который будет использоваться для «автоцвета». Если цвет не "авто", то возвращается[`Color`](./color). |
...
| [BoldBi](../../aspose.words/font/boldbi) { get; set; } | Истинно, если текст справа налево выделен жирным шрифтом. |
...
| [ComplexScript](../../aspose.words/font/complexscript) { get; set; } | Указывает, должно ли содержимое этого цикла рассматриваться как сложный текст сценария независимо от их значений символов Unicode при определении форматирования для этого цикла. |
...
| [ItalicBi](../../aspose.words/font/italicbi) { get; set; } | Истинно, если текст справа налево выделен курсивом. |
...
| [LocaleIdBi](../../aspose.words/font/localeidbi) { get; set; } | Получает или задает идентификатор локали (язык) отформатированных символов, написанных справа налево. |
...
| [NoProofing](../../aspose.words/font/noproofing) { get; set; } | Истинно, если отформатированные символы не требуют проверки орфографии. |
| [Outline](../../aspose.words/font/outline) { get; set; } | Истинно, если шрифт отформатирован как контур. |
| [Position](../../aspose.words/font/position) { get; set; } | Получает или задает положение текста (в пунктах) относительно базовой линии. Положительное число поднимает текст, отрицательное — опускает. |
...
| [SnapToGrid](../../aspose.words/font/snaptogrid) { get; set; } | Указывает, должен ли текущий шрифт использовать символы сетки документа в настройках строки при размещении. |
...
| [StyleName](../../aspose.words/font/stylename) { get; set; } | Получает или задает имя стиля символов, примененного к данному форматированию. |
...
| [ThemeFontAscii](../../aspose.words/font/themefontascii) { get; set; } | Получает или задает шрифт темы, используемый для латинского текста (символы с кодами от 0 (ноль) до 127) в применяемой схеме шрифтов который связан с этим объектом Font. |
| [ThemeFontBi](../../aspose.words/font/themefontbi) { get; set; } | Получает или задает шрифт темы в применяемой схеме шрифтов, связанной с этим объектом Font в документе на языке с письмом справа налево. |
...
| [ThemeFontOther](../../aspose.words/font/themefontother) { get; set; } | Получает или задает шрифт темы, используемый для символов с кодами символов от 128 до 255 в применяемой схеме шрифта, связанной с этим объектом Font. . |
...
| [Underline](../../aspose.words/font/underline) { get; set; } | Получает или задает тип подчеркивания, примененного к шрифту. |
...
| Имя | Описание |
| --- | --- |
| [ClearFormatting](../../aspose.words/font/clearformatting)() | Сбрасывает форматирование шрифта по умолчанию. |
