...
description: Легко настройте размер шрифта в пунктах для документов с письмом справа налево. Улучшите читаемость и дизайн с помощью нашего простого в использовании свойства Font SizeBi!
type: docs
weight: 360
...
Возвращает или задает размер шрифта в пунктах, используемый в документе с письмом справа налево.
