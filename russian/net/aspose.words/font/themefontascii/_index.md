...
description: Получает или задает шрифт темы используемый для латинского текста символы с кодами от 0 ноль до 127 в применяемой схеме шрифтов который связан с этим объектом Font.
type: docs
weight: 480
...
Получает или задает шрифт темы, используемый для латинского текста (символы с кодами от 0 (ноль) до 127) в применяемой схеме шрифтов который связан с этим объектом Font.
