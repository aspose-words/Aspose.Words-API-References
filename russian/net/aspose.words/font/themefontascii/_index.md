...
description: Получает или задает шрифт темы используемый для латинского текста символы с кодами символов от 0 ноль до 127 в применяемой схеме шрифтов связанной с этим объектом Font.
type: docs
weight: 480
