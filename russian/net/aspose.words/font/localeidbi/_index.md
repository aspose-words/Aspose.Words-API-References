...
description: Font свойство. Получает или задает идентификатор локали язык отформатированных символов с письмом справа налево.
type: docs
weight: 210
...
Получает или задает идентификатор локали (язык) отформатированных символов с письмом справа налево.
