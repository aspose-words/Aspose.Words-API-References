...
description: Возвращает или задает имя шрифта в документе с письмом справа налево.
type: docs
weight: 250
...
Показывает, как определить отдельные наборы настроек шрифта для текст справа налево и справа налево.
