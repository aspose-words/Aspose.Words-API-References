...
Это свойство, если оно включено, не должно использоваться с текстом, написанным строго слева направо. Любое поведение в этом состоянии не определено. Это свойство, если оно выключено, не должно использоваться с сильным текстом справа налево. Любое поведение в этом состоянии не определено.

Когда отображается содержимое этого цикла, все символы должны рассматриваться как сложные символы сценария для целей форматирования . Это означает, что[`BoldBi`](../boldbi),[`ItalicBi`](../italicbi),[`SizeBi`](../sizebi)и соответствующее имя шрифта будут использоваться при рендеринге этого прогона.
