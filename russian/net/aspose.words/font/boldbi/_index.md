...
description: Откройте для себя свойство BoldBi, которое обеспечивает отображение жирным шрифтом текста, написанного справа налево, что повышает удобство чтения и удобство использования для различных языков.
type: docs
weight: 50
...
True, если текст, написанный справа налево, отформатирован как полужирный.
