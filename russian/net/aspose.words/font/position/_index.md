...
description: Получает или задает положение текста в пунктах относительно базовой линии. Положительное число поднимает текст а отрицательное число опускает его.
type: docs
weight: 300
