...
description: Получает или задает шрифт темы в применяемой схеме шрифтов связанной с этим объектом Font в документе на языке с письмом справа налево.
type: docs
weight: 490
...
Получает или задает шрифт темы в применяемой схеме шрифтов, связанной с этим объектом Font в документе на языке с письмом справа налево.
