...
description: Font свойство. Возвращает текущий рассчитанный цвет текста черный или белый который будет использоваться для автоматического цвета. Если цвет не авто то возвращаетсяColor .
type: docs
weight: 20
