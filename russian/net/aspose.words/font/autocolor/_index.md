...
description: Возвращает текущий рассчитанный цвет текста черный или белый который будет использоваться для автоцвета. Если цвет не авто то возвращаетColoraspose.words/font/color/ .
type: docs
weight: 20
