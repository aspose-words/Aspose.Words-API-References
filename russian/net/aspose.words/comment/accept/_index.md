...
description: Откройте для себя метод Comment Accept, чтобы повысить вовлеченность посетителей и создать осмысленные взаимодействия на вашем сайте. Расширьте свое онлайн-сообщество сегодня!
type: docs
weight: 130
...
Звонки[`VisitCommentStart`](../../documentvisitor/visitcommentstart/) , затем звонит[`Accept`](../../node/accept/)для всех дочерних узлов комментария и вызовов[`VisitCommentEnd`](../../documentvisitor/visitcommentend/) в конце.
