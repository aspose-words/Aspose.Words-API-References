...
description: Comment свойство. Возвращает или задает инициалы пользователя связанного с конкретным комментарием.
type: docs
weight: 70
...
Возвращает или задает инициалы пользователя, связанного с конкретным комментарием.
