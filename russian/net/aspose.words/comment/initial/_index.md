...
description: Возвращает или устанавливает инициалы пользователя связанные с конкретным комментарием.
type: docs
weight: 70
...
Возвращает или устанавливает инициалы пользователя, связанные с конкретным комментарием.
