...
description: Инициализирует новый экземпляр класса Комментарий .
type: docs
weight: 10
...
Инициализирует новый экземпляр класса **Комментарий** .
...
Когда **Комментарий** есть создан, он принадлежит указанному документу, но не является частью документа и **ParentNode** имеет значение null.

Чтобы добавить **Комментарий** к документу, используйте InsertAfter или InsertBefore on абзац, в который вы хотите вставить комментарий.

После создания комментария не забудьте установить его[`Author`](../author), [`Initial`](../initial)и[`DateTime`](../datetime)свойства.
