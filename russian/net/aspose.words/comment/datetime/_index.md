...
description: Откройте для себя свойство Comment DateTime, которое фиксирует точную дату и время публикации комментария, улучшая ваш опыт управления контентом.
type: docs
weight: 40
