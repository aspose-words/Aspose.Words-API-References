...
description: Узнайте, как метод AcceptEnd улучшает пользовательский опыт, эффективно управляя посещениями комментариев. Повышайте вовлеченность с помощью бесперебойного принятия посетителей!
type: docs
weight: 140
url: /ru/net/aspose.words/comment/acceptend/
---
## Comment.AcceptEnd method

Принимает посетителя для посещения конца комментария.
