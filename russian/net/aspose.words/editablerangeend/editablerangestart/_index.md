...
description: Откройте для себя свойства EditableRangeEnd и EditableRangeStart. Легко управляйте диапазонами данных с помощью уникальных идентификаторов для улучшенного контроля и эффективности.
type: docs
weight: 10
...
Соответствующий[`EditableRangeStart`](../../editablerangestart/) , получено ID.
