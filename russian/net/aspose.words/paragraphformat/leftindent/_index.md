...
description: ParagraphFormat свойство. Получает или задает значение в пунктах представляющее отступ слева для абзаца.
type: docs
weight: 170
...
Получает или задает значение (в пунктах), представляющее отступ слева для абзаца.
