...
description: Управляйте интервалом между абзацами с помощью свойства SpaceAfter. Легко настраивайте интервал в пунктах, чтобы улучшить читаемость и презентацию документа.
type: docs
weight: 310
...
Возвращает или задает величину интервала (в пунктах) после абзаца.
...
Не имеет никакого эффекта, когда[`SpaceAfterAuto`](../spaceafterauto/) является`истинный`.
