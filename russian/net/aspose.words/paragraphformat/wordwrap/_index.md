...
description: ParagraphFormat свойство. Если это свойство ЛОЖЬ латинский текст в середине слова можно переносить на текущего абзаца. В противном случае латинский текст переносится целыми словами.
type: docs
weight: 400
