...
description: Откройте для себя свойство ParagraphFormat SpaceAfterAuto. Автоматически настраивайте интервалы между абзацами для более чистого и профессионального оформления документа.
type: docs
weight: 320
...
True, если величина интервала после абзаца устанавливается автоматически.
...
При установке на`истинный` , отменяет эффект[`SpaceAfter`](../spaceafter/).
