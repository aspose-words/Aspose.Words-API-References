...
description: Откройте для себя свойство ParagraphFormat StyleName, чтобы легко управлять стилями абзацев и настраивать их для улучшенного форматирования и представления документа.
type: docs
weight: 370
...
Возвращает или задает имя стиля абзаца, примененного к данному форматированию.
