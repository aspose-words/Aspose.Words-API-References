...
description: ParagraphFormat StyleName свойство. Получает или задает имя стиля абзаца примененного к этому форматированию на С#.
type: docs
weight: 360
...
Получает или задает имя стиля абзаца, примененного к этому форматированию.
