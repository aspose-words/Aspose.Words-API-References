...
description: Создайте новый экземпляр BookmarkEnd без усилий. Улучшите свой проект с помощью этого важного инструмента для эффективного управления закладками.
type: docs
weight: 10
...
Инициализирует новый экземпляр[`BookmarkEnd`](../) класс.
