...
description: Получает или задает коэффициент масштабирования выраженный в виде доли изображения. Значение по умолчанию0  автоматически.
type: docs
weight: 30
...
Получает или задает коэффициент масштабирования, выраженный в виде доли изображения. Значение по умолчанию:0 — автоматически.
...
Допустимые значения от 0 до 65,5 включительно.
