...
description: Style метод. Сравнивается с указанным стилем. Стандартные стили сравниваются только для встроенных стилей. Стили по умолчанию не учитываются при сравнении. Базовый стиль связанный стиль и стиль следующего абзаца сравниваются рекурсивно.
type: docs
weight: 170
