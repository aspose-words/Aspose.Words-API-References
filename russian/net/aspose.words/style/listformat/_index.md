...
description: Узнайте, как настроить свойство ListFormat для стилей абзацев, улучшив организацию и визуальную привлекательность документа.
type: docs
weight: 110
...
Это свойство действительно только для стилей абзацев. Для других типов стилей это свойство возвращает`нулевой`.
