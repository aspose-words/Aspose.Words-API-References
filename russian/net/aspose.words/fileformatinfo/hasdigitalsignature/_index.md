...
description: Возвращает true если этот документ содержит цифровую подпись. Это свойство просто информирует о наличии цифровой подписи в документе  но не указывает является ли подпись действительной или нет.
type: docs
weight: 20
