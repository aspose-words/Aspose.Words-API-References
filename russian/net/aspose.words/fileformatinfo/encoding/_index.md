...
description: Получает обнаруженную кодировку если она применима к текущему формату документа. На данный момент определяет кодировку только для документов HTML.
type: docs
weight: 10
