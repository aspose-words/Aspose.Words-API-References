...
description: Возвращает коллекциюBookmarksaspose.words/range/bookmarks которая представляет все закладки в диапазоне.
type: docs
weight: 10
...
Возвращает коллекцию`Bookmarks`, которая представляет все закладки в диапазоне.
