...
description: Возвращает коллекциюFormFieldsaspose.words/range/formfields которая представляет все поля формы в диапазоне.
type: docs
weight: 30
...
Возвращает коллекцию`FormFields`, которая представляет все поля формы в диапазоне.
