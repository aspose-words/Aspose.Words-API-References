...
description: Откройте для себя свойство Range FormFields, получите доступ к полной коллекции FormFields для эффективного управления всеми полями формы в указанном диапазоне.
type: docs
weight: 30
...
Возвращает`FormFields` коллекция, представляющая все поля формы в диапазоне .
