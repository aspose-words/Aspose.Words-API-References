...
description: Откройте для себя свойство IsMoveFromRevision в InlineStory. Легко отслеживайте перемещенный или удаленный контент в Microsoft Word с включенным отслеживанием изменений для бесперебойного редактирования.
type: docs
weight: 50
