...
description: Откройте для себя свойство InlineStory LastParagraph, которое позволит легко получить доступ к последнему абзацу вашей истории и улучшит ваш опыт управления контентом.
type: docs
weight: 70
