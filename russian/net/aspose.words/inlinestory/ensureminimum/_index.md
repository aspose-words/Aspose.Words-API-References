...
description: Оптимизируйте свой контент с помощью метода EnsureMinimum от InlineStory, который добавляет абзац, если последний дочерний элемент не является таковым, что улучшает читаемость и структуру.
type: docs
weight: 120
