...
description: Откройте для себя свойство InlineStory ParentParagraph, которое позволяет легко получить доступ к родительскому абзацу любого узла и улучшить процесс управления контентом.
type: docs
weight: 90
...
Возвращает родителя[`Paragraph`](../../paragraph/) этого узла.
