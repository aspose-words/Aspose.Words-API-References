...
description: Откройте для себя свойство IsMoveToRevision в InlineStory, легко отслеживайте изменения в Microsoft Word со статусом true/false для беспрепятственного редактирования документов.
type: docs
weight: 60
