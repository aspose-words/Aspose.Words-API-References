...
description: Откройте для себя свойство InlineStory StoryType, которое раскрывает уникальный тип вашей истории. Улучшите свое повествование с помощью точной категоризации!
type: docs
weight: 100
