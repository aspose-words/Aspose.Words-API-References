...
description: DocumentVisitor метод. Вызывается когда начинается перечисление строительного блока.
type: docs
weight: 70
...
Вызывается, когда начинается перечисление строительного блока.
...
Примечание. Узел стандартного блока и его дочерние элементы не посещаются при выполнении a Visitor над[`Document`](../../document/) Если вы хотите выполнить посетителя над строительным блоком , вам нужно выполнить посетителя над[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument/) или звонок[`Accept`](../../../aspose.words.buildingblocks/buildingblock/accept/) .
