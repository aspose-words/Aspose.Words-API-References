...
Примечание. Узел стандартного блока и его потомки не посещаются когда вы выполняете Посетитель поверх[`Document`](../../document). Если вы хотите выполнить посетителя над строительным блоком , вам нужно выполнить посетителя над[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument)или call[`Accept`](../../../aspose.words.buildingblocks/buildingblock/accept).
