...
description: Изучите метод DocumentVisitor VisitSubDocument, разработанный для эффективной обработки поддокументов в ваших приложениях. Повысьте эффективность кодирования!
type: docs
weight: 480
...
Вызывается при обнаружении поддокумента.
...
| --- | --- | --- |
| subDocument | SubDocument | Посещаемый объект. |
