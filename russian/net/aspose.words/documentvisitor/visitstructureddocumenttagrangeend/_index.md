...
description: Откройте для себя метод DocumentVisitor VisitStructuredDocumentTagRangeEnd, необходимый для эффективной обработки структурированных тегов документов в ваших приложениях.
type: docs
weight: 450
...
Вызывается при обнаружении StructuredDocumentTagRangeEnd.
