...
description: Откройте для себя метод DocumentVisitor VisitHeaderFooterStart, необходимый для отслеживания перечисления заголовков и нижних колонтитулов в разделах. Улучшите управление документами!
type: docs
weight: 290
