...
description: Откройте для себя метод DocumentVisitor VisitStructuredDocumentTagRangeStart, необходимый для эффективной обработки структурированных тегов документов в ваших приложениях.
type: docs
weight: 460
...
Вызывается при обнаружении StructuredDocumentTagRangeStart.
