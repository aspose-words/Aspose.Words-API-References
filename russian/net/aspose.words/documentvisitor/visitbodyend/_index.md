...
description: Откройте для себя метод DocumentVisitor VisitBodyEnd — эффективно управляйте перечислением текстовых историй и расширяйте возможности обработки документов.
type: docs
weight: 20
...
Вызывается, когда перечисление основного текста истории в разделе завершено.
