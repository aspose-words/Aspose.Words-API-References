...
description: DocumentVisitor метод. Вызывается когда начался перебор основного текста в разделе.
type: docs
weight: 30
...
Вызывается, когда начался перебор основного текста в разделе.
