...
description: Откройте для себя метод VisitDocumentStart в DocumentVisitor. Улучшите обработку документов с помощью эффективных возможностей перечисления для оптимальной производительности.
type: docs
weight: 150
url: /ru/net/aspose.words/documentvisitor/visitdocumentstart/
---
## DocumentVisitor.VisitDocumentStart method

Вызывается, когда началось перечисление документа.
...
| --- | --- | --- |
| doc | Document | Посещаемый объект. |
