...
description: DocumentVisitor метод. Вызывается после завершения перечисления строительного блока.
type: docs
weight: 60
...
Вызывается после завершения перечисления строительного блока.
