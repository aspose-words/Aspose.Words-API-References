...
description: DocumentVisitor VisitBookmarkStart метод. Вызывается когда в документе встречается начало закладки на С#.
type: docs
weight: 50
...
| --- | --- | --- |
| bookmarkStart | BookmarkStart | Объект, который посещается. |
