...
description: Откройте для себя метод DocumentVisitor VisitBookmarkStart, который запускается в начале закладки в вашем документе. Повысьте эффективность кодирования сегодня!
type: docs
weight: 50
url: /ru/net/aspose.words/documentvisitor/visitbookmarkstart/
---
...
| --- | --- | --- |
| bookmarkStart | BookmarkStart | Посещаемый объект. |
