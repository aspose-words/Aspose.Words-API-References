...
description: Откройте для себя метод DocumentVisitor VisitOfficeMathStart, необходимый для инициирования перечисления объектов Office Math. Повысьте эффективность кодирования сегодня!
type: docs
weight: 310
...
Вызывается, когда начинается перечисление объекта Office Math.
