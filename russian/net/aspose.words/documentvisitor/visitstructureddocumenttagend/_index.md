...
description: DocumentVisitor метод. Вызывается после завершения перечисления тега структурированного документа.
type: docs
weight: 440
...
Вызывается после завершения перечисления тега структурированного документа.
