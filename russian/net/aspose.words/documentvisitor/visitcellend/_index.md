...
description: Откройте для себя метод DocumentVisitor VisitCellEnd, необходимый для управления перечислением ячеек таблиц в ваших приложениях. Повысьте эффективность кодирования сегодня!
type: docs
weight: 80
...
Вызывается, когда перечисление ячейки таблицы завершено.
