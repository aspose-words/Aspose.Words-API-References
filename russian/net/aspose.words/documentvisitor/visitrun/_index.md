...
description: Изучите метод DocumentVisitor VisitRun для эффективной обработки текста в ваших приложениях. Улучшите свой код с помощью этого необходимого инструмента!
type: docs
weight: 360
...
Вызывается при обнаружении последовательности текста в .
