...
description: DocumentVisitor метод. Вызывается когда перечисление текста комментария завершено.
type: docs
weight: 100
...
Вызывается, когда перечисление текста комментария завершено.
