...
description: Document свойство. Получает коллекцию ревизий отслеживаемых изменений существующих в этом документе.
type: docs
weight: 330
...
Получает коллекцию ревизий (отслеживаемых изменений), существующих в этом документе.
