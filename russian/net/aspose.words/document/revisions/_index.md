...
description: Получает коллекцию ревизий отслеживаемых изменений существующих в этом документе.
type: docs
weight: 330
...
Возвращаемая коллекция является «живой» коллекцией, что означает, что если вы удалите части документа которые содержат ревизии , удаленные ревизии автоматически исчезнут из этой коллекции.
