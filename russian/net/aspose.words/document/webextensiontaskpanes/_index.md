...
description: Изучите свойство WebExtensionTaskPanes, чтобы получить доступ к ценной коллекции надстроек панели задач, расширяющих функциональность вашего документа и удобство использования.
type: docs
weight: 510
