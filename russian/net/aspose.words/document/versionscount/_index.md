...
description: Document свойство. Получает количество версий документа сохраненных в документе DOC.
type: docs
weight: 440
...
Это свойство позволяет определить, были ли версии документа сохранены в этом document до того, как он был открыт в Aspose.Words. Aspose.Words не предоставляет никакой другой поддержки версий документа. Если вы сохраните этот документ с помощью Aspose.Words, документ будет сохранен без версий.
