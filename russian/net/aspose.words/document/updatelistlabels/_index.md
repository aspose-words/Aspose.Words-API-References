...
Также этот метод иногда неявно вызывается при обновлении полей в документе. Это required , потому что некоторые поля, которые могут ссылаться на номера списка (такие как TOC или REF), требуют их актуальности.
