...
Вызывает DocumentVisitor.VisitDocumentStart, затем вызывает Accept для всех дочерних узлов документа и вызывает DocumentVisitor.VisitDocumentEnd в конце.
