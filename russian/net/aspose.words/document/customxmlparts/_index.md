...
description: Изучите свойство Document CustomXmlParts для эффективного управления Custom XML Data Storage Parts. Расширьте функциональность вашего документа сегодня!
type: docs
weight: 90
...
Возвращает или задает коллекцию пользовательских частей хранилища XML-данных.
