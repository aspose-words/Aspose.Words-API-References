...
description: Узнайте, отслеживаются ли изменения в вашем документе с помощью свойства HasRevisions. Легко управляйте правками и повышайте эффективность рабочего процесса.
type: docs
weight: 210
url: /ru/net/aspose.words/document/hasrevisions/
---
## Document.HasRevisions property

Возврат`истинный` если в документе есть отслеживаемые изменения.
...
Это свойство является сокращением для сравнения[`Count`](../../revisioncollection/count/) к нулю.
