...
description: Document свойство. Возвращает истинный есть ли в документе отслеживаемые изменения.
type: docs
weight: 200
...
Возвращает **истинный** есть ли в документе отслеживаемые изменения.
