...
description: Воспользуйтесь параметрами совместимости документов Word, чтобы настроить пользовательские параметры и улучшить процесс редактирования с помощью индивидуальных настроек для бесперебойной совместной работы.
type: docs
weight: 60
...
Предоставляет доступ к параметрам совместимости документа (то есть к пользовательским настройкам, введенным в**Совместимость** вкладка**Параметры**диалог в Word).
