...
description: Откройте для себя метод AcceptStart, который позволяет легко приветствовать посетителей в начале вашего документа, обеспечивая улучшенный пользовательский опыт и более плавную навигацию.
type: docs
weight: 560
url: /ru/net/aspose.words/document/acceptstart/
---
