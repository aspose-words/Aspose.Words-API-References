...
description: Воспользуйтесь функцией «Библиография документа», чтобы получить полный список источников, что повысит точность ваших исследований и цитирования.
type: docs
weight: 40
url: /ru/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Получает`Bibliography`объект, представляющий список источников, доступных в документе.
