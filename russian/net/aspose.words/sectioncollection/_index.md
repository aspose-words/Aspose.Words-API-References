...
description: Набор объектов Section в документе.
type: docs
weight: 5400
...
Набор объектов **Section** в документе.
...
Программная вставка и удаление разделов может использоваться для настройки документов, созданных во время слияния. Если документ должен иметь различное содержимое или части содержимого в зависимости от некоторых критериев, вы можете создать «главный» документ, который содержит несколько разделов и удалить некоторые из них. разделы до или после слияния почты.
