...
description: Легко настройте цвет темы фона с помощью свойства BackgroundTintAndShade. Осветлите или затемните цвета для идеального дизайнерского штриха!
type: docs
weight: 30
...
Возвращает или задает двойное значение, которое осветляет или затемняет цвет фоновой темы.
