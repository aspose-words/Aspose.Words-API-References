...
description: Доступ к определенным элементам RunCollection без усилий. Извлечение любого Run по индексу для оптимизированного управления данными и повышения производительности.
type: docs
weight: 10
...
Извлекает[`Run`](../../run/) по данному индексу.
