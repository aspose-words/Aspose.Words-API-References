...
description: FieldMergingArgsBase свойство. ВозвращаетDocument объект для которого выполняется слияние.
type: docs
weight: 10
...
Возвращает`Document` объект, для которого выполняется слияние.
