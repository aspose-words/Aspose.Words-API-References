...
description: Возвращает полную иерархию областей с полями доступных в документе.
type: docs
weight: 250
...
Иерархия возвращается в виде[`MailMergeRegionInfo`](../../mailmergeregioninfo)class.
