...
description: Узнайте, как использовать метод MappedDataFieldCollection Add, чтобы легко создавать новые сопоставления полей и повышать эффективность управления данными.
type: docs
weight: 30
...
| --- | --- | --- |
| documentFieldName | String | Имя поля слияния в документе с учетом регистра. |
