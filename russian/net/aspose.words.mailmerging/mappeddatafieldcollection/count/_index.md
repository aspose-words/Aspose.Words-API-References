...
description: Откройте для себя свойство MappedDataFieldCollection Count, которое эффективно отображает общее количество элементов в вашей коллекции данных для оптимизированного управления.
type: docs
weight: 10
