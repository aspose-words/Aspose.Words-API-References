...
description: Откройте для себя метод MappedDataFieldCollection GetEnumerator, эффективно просматривайте свои данные с помощью мощного словарного перечислителя для бесперебойного доступа.
type: docs
weight: 70
