...
description: Определяет существует ли в коллекции отображение из указанного поля в документе.
type: docs
weight: 50
...
Определяет, существует ли в коллекции отображение из указанного поля в документе.
