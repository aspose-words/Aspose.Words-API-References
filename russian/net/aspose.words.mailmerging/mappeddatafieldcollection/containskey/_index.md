...
description: Узнайте, существует ли определенное сопоставление полей документа в MappedDataFieldCollection с помощью метода ContainsKey. Оптимизируйте управление данными без усилий!
type: docs
weight: 50
...
Определяет, существует ли сопоставление из указанного поля в документе в коллекции.
