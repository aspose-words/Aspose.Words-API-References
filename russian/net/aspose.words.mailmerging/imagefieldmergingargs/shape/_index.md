...
Когда указано это свойство, механизм слияния игнорирует все другие свойства, такие как[`ImageFileName`](../imagefilename)или[`ImageStream`](../imagestream) и просто вставляет фигуру в документ .
