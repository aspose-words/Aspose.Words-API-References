...
description: Откройте для себя свойство MailMergeRegionInfo Level, которое показывает уровень вложенности ваших регионов, повышая автоматизацию и эффективность работы с документами.
type: docs
weight: 40
