...
description: Откройте для себя свойство MailMergeRegionInfo Fields, легко получайте доступ к дочерним полям и управляйте ими для эффективной автоматизации документов и повышения производительности.
type: docs
weight: 30
