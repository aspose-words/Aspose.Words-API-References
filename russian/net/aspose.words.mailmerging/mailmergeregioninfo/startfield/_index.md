...
description: Откройте для себя свойство MailMergeRegionInfo StartField — эффективно извлекайте начальное поле для областей слияния и оптимизируйте автоматизацию документов.
type: docs
weight: 90
