...
description: Откройте для себя свойство MailMergeRegionInfo EndField, которое эффективно возвращает конечное поле для областей данных, улучшая автоматизацию документов.
type: docs
weight: 10
