...
description: IFieldMergingCallback FieldMerging метод. Вызывается когда механизм слияния почты Aspose.Words собирается вставить данные в поле слияния в документе на С#.
type: docs
weight: 10
