...
description: Откройте для себя метод AcceptStart от OfficeMath, разработанный для беспрепятственного приветствия посетителей и улучшения вашего опыта работы с математикой в офисе. Повысьте производительность сегодня!
type: docs
weight: 80
url: /ru/net/aspose.words.math/officemath/acceptstart/
---
## OfficeMath.AcceptStart method

Принимает посетителя для посещения начала офиса math.
