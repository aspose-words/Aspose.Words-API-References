...
Вызовы[`VisitOfficeMathStart`](../../../aspose.words/documentvisitor/visitofficemathstart), затем вызывает[`Accept`](../../../aspose.words/node/accept)для всех дочерних узлов Office Math и вызывает[`VisitOfficeMathEnd`](../../../aspose.words/documentvisitor/visitofficemathend)в конце.
