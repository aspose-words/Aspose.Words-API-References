...
description: Получает/задает кодировку которая использовалась для кодирования XML-уравнения если этот офисный математический объект считывается из XML-уравнения. Мы используем кодировку при сохранении документа для записи в той же кодировке в которой он был прочитан.
type: docs
weight: 20
