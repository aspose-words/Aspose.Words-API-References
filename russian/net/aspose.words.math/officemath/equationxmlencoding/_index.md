...
description: Получает/задает кодировку которая использовалась для кодирования XMLуравнения если этот офисный математический объект считывается из XMLуравнения. Мы используем кодировку при сохранении документа для записи в той же кодировке в которой он был прочитан.
type: docs
weight: 20
