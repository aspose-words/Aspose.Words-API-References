...
description: Aspose.Words.Math.OfficeMath сорт. Представляет объект Office Math например функцию уравнение матрицу и т. д. Может содержать дочерние элементы  включая фрагменты математического текста закладки комментарии и т. д.OfficeMathэкземпляры и некоторые другие узлы на С#.
type: docs
weight: 4120
