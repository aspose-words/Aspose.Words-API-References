...
description: Задает выравнивание для номера списка или маркера.
type: docs
weight: 3260
...
| Center | `1` | Метка списка центрируется на позиции числа. |
| Right | `2` | Метка этого списка выравнивается справа от позиции номера. |
