...
description: Откройте для себя ListLevel IsLegal. Легко управляйте унаследованными стилями чисел. Выберите арабский для современного вида или сохраните оригинальные стили для классического прикосновения.
type: docs
weight: 50
...
True, если уровень преобразует все унаследованные числа в арабские, false, если он сохраняет их числовой стиль.
