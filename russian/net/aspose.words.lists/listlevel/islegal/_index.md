...
description: ListLevel свойство. Истина если уровень превращает все унаследованные числа в арабские и ложь если сохраняется стиль их чисел.
type: docs
weight: 50
...
Истина, если уровень превращает все унаследованные числа в арабские, и ложь, если сохраняется стиль их чисел.
