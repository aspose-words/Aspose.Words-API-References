...
description: Получает или задает стиль абзаца связанный с этим уровнем списка.
type: docs
weight: 60
...
Это свойство имеет значение null, если уровень списка не связан со стилем абзаца. Этому свойству можно присвоить значение null.
