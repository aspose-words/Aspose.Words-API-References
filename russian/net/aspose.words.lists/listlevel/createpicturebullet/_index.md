...
Обратите внимание, что NumberStyle будет установлен на Bullet, а NumberFormat на "\xF0B7" для правильного отображения изображения пуля. Изображение красного креста будет установлено в качестве изображения маркера при создании. Чтобы изменить его, используйте[`ImageData`](../imagedata).
