...
description: Откройте для себя свойство ListLevel RestartAfterLevel, чтобы легко управлять нумерацией списков в ваших документах. Упростите организацию и повысьте ясность уже сегодня!
type: docs
weight: 100
...
Устанавливает или возвращает уровень списка, который должен появиться до того, как указанный уровень списка перезапустит нумерацию.
