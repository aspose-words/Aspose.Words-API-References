...
description: Задает или возвращает уровень списка который должен появиться до того как указанный уровень списка перезапустит нумерацию.
type: docs
weight: 100
...
Показывает расширенные способы настройки меток списков.
