...
description: Откройте для себя свойство шрифта ListLevel, которое позволит улучшить подписи списков с помощью настраиваемого форматирования символов, придав им изысканный и профессиональный вид.
type: docs
weight: 30
...
Задает форматирование символов, используемое для метки списка.
