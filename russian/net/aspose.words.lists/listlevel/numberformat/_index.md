...
description: ListLevel свойство. Возвращает или задает числовой формат для уровня списка.
type: docs
weight: 70
...
Например, строка "\x0000.\x0001)" создаст список label , который будет выглядеть примерно как "1.5)". Цифра "1" - текущий номер из 1-го уровня списка, цифра "5" - текущий номер из 2-го уровня списка.
