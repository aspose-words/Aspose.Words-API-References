...
description: Возвращает или задает позицию в пунктах второй строки переноса текста для уровня списка.
type: docs
weight: 130
...
Возвращает или задает позицию (в пунктах) второй строки переноса текста для уровня списка.
