...
description: ListLevel свойство. Возвращает или задает положение в пунктах второй строки переноса текста для уровня списка.
type: docs
weight: 130
...
Возвращает или задает положение (в пунктах) второй строки переноса текста для уровня списка.
