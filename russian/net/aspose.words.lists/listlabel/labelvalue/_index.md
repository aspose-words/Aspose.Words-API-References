...
description: Получает числовое значение для этой метки.
type: docs
weight: 30
...
Используйте метод[`UpdateListLabels`](../../../aspose.words/document/updatelistlabels)для обновления значения этого свойства.
