...
description: С легкостью удаляйте номера или маркеры из абзацев с помощью метода ListFormat RemoveNumbers, сбрасывая уровень списка до нуля для чистого форматирования.
type: docs
weight: 90
...
Удаляет номера или маркеры из текущего абзаца и устанавливает уровень списка на ноль.
