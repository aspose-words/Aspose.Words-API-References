...
description: Начинает новый маркированный список по умолчанию и применяет его к абзацу.
type: docs
weight: 50
...
Это сокращенный метод, который создает новый список, используя маркированный по умолчанию шаблон, применяет его к абзацу и выбирает 1-й уровень списка.
