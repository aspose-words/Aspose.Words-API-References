...
Это сокращенный метод, который создает новый список с использованием стандартного шаблона bulleted , применяет его к абзацу и выбирает 1-й уровень списка.
