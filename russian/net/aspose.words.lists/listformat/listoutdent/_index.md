...
description: ListFormat метод. Уменьшает уровень списка текущего абзаца на один уровень.
type: docs
weight: 80
...
В документах Word списки могут состоять из девяти уровней. Список formatting для каждого уровня указывает, какой маркер или номер используется, левый отступ, пробел между маркером и текстом и т. д.
