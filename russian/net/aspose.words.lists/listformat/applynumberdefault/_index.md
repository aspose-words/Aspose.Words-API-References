...
description: Начинает новый нумерованный список по умолчанию и применяет его к абзацу.
type: docs
weight: 60
...
Это метод быстрого доступа, который создает новый список, используя нумерацию по умолчанию шаблон, применяет его к абзацу и выбирает 1-й уровень списка.
