...
description: Узнайте, как метод ApplyNumberDefault создает нумерованный список по умолчанию для ваших абзацев, улучшая организацию и ясность ваших документов.
type: docs
weight: 60
...
Начинает новый нумерованный список по умолчанию и применяет его к абзацу.
...
Это сокращенный метод, который создает новый список с использованием шаблона по умолчанию numbered , применяет его к абзацу и выбирает 1-й уровень списка.
