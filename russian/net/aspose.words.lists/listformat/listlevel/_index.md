...
description: ListFormat свойство. Возвращает форматирование на уровне списка плюс любые изменения форматирования примененные к текущему абзацу.
type: docs
weight: 30
...
Возвращает форматирование на уровне списка плюс любые изменения форматирования, примененные к текущему абзацу.
