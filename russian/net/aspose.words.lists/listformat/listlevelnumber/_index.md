...
description: Получает или задает номер уровня списка от 0 до 8 для абзаца.
type: docs
weight: 40
...
Имеет эффект только при[`List`](../list/) свойство установлено для ссылки на действительный список.
