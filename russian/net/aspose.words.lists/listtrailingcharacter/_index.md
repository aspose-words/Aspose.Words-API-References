...
description: Aspose.Words.Lists.ListTrailingCharacter перечисление. Задает символ отделяющий метку списка от текста абзаца.
type: docs
weight: 3340
...
Задает символ, отделяющий метку списка от текста абзаца.
...
Используется как значение для[`TrailingCharacter`](../listlevel/trailingcharacter/) имущество.
