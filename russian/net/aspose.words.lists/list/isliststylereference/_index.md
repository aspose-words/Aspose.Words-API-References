...
description: Откройте для себя свойство IsListStyleReference, оно указывает, ссылается ли список на определенный стиль, улучшая форматирование и организацию вашего документа.
type: docs
weight: 30
...
Возврат`истинный` если этот список является ссылкой на список style.
