...
Если этот список не связан со стилем списка, свойство возвращает значение null.

Список может быть ссылкой на стиль списка, в данном случае[`IsListStyleReference`](../isliststylereference) будет истинным.

Список может быть определением стиля списка, в данном случае[`IsListStyleDefinition`](../isliststyledefinition) будет истинным. Такой список нельзя применить к абзацам документа напрямую.
