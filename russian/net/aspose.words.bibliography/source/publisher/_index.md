...
description: Управляйте свойствами Source Publisher без усилий. Легко устанавливайте или извлекайте данные издателя для оптимизированного управления источником.
type: docs
weight: 360
url: /ru/net/aspose.words.bibliography/source/publisher/
---
## Source.Publisher property

Возвращает или задает издателя источника.
