...
description: Управляйте своим исходным URL без усилий. С легкостью устанавливайте или извлекайте URL, улучшая управление данными и оптимизируя рабочий процесс.
type: docs
weight: 500
url: /ru/net/aspose.words.bibliography/source/url/
---
## Source.Url property

Получает или задает URL-адрес источника.
