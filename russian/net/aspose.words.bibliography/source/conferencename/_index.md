...
description: Узнайте, как легко управлять названиями конференций с помощью Source ConferenceName. Упростите свои исследования и повысьте точность цитирования уже сегодня!
type: docs
weight: 110
url: /ru/net/aspose.words.bibliography/source/conferencename/
---
## Source.ConferenceName property

Возвращает или задает имя конференции или протокола источника.
