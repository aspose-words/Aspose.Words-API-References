---
title: Source.Distributor
linktitle: Distributor
articleTitle: Distributor
second_title: Aspose.Words для .NET
description: Откройте для себя свойство Source Distributor, чтобы легко управлять и настраивать параметры дистрибьютора вашего источника для достижения оптимальной производительности.
type: docs
weight: 180
url: /ru/net/aspose.words.bibliography/source/distributor/
---
## Source.Distributor property

Получает или задает дистрибьютора источника.
