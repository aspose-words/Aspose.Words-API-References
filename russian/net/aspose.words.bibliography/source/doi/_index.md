...
description: Узнайте, как эффективно управлять свойствами Doi для бесперебойной обработки идентификаторов цифровых объектов. Повысьте видимость своих исследований сегодня!
type: docs
weight: 190
url: /ru/net/aspose.words.bibliography/source/doi/
---
## Source.Doi property

Получает или задает идентификатор цифрового объекта.
