...
description: Откройте для себя свойство Source Broadcaster, легко управляйте вещателем вашего источника для улучшенного управления потоковой передачей и производительности. Оптимизируйте свой медиа-опыт!
type: docs
weight: 50
url: /ru/net/aspose.words.bibliography/source/broadcaster/
---
## Source.Broadcaster property

Получает или задает вещателя источника.
