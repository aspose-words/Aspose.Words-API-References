...
description: Легко создайте новый экземпляр класса Source с помощью нашего конструктора. Упростите процесс кодирования и повысьте эффективность своего проекта уже сегодня!
type: docs
weight: 10
url: /ru/net/aspose.words.bibliography/source/source/
---
## Source constructor

Инициализирует новый экземпляр[`Source`](../) класс.
...
| --- | --- | --- |
| tag | String | Имя идентификационного тега. |
