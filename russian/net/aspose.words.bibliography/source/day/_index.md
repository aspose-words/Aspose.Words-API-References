...
description: Управляйте исходными датами без усилий с помощью Source Day. Легко устанавливайте или извлекайте исходные дни, чтобы оптимизировать рабочий процесс и повысить производительность.
type: docs
weight: 150
url: /ru/net/aspose.words.bibliography/source/day/
---
## Source.Day property
