...
description: Управляйте периодическим названием вашего источника без усилий. Легко получайте или устанавливайте названия для улучшенной организации и точных ссылок.
type: docs
weight: 330
url: /ru/net/aspose.words.bibliography/source/periodicaltitle/
---
## Source.PeriodicalTitle property

Получает или задает периодическое название источника.
