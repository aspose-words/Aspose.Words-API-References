...
description: Легко настройте громкость источника, чтобы улучшить качество звука. Управляйте уровнями звука для оптимальной четкости и удовольствия от ваших проектов.
type: docs
weight: 520
url: /ru/net/aspose.words.bibliography/source/volume/
---
## Source.Volume property

Получает или задает громкость источника.
