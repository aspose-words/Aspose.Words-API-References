...
description: Управляйте своим свойством Source Year без усилий. Легко получайте или устанавливайте год источника для упрощенной организации данных и повышения точности.
type: docs
weight: 530
url: /ru/net/aspose.words.bibliography/source/year/
---
## Source.Year property

Возвращает или задает год источника.
