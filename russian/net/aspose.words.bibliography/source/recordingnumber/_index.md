...
description: Управляйте своими записями без усилий с помощью свойства Source RecordingNumber — быстро извлекайте или обновляйте номера исходных записей для бесперебойного управления звуком.
type: docs
weight: 370
url: /ru/net/aspose.words.bibliography/source/recordingnumber/
---
