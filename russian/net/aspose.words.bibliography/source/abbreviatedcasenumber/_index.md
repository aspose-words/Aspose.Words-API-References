...
description: Легко управляйте сокращенным номером дела вашего источника с помощью нашего удобного инструмента. Упростите отслеживание вашего дела сегодня!
type: docs
weight: 20
url: /ru/net/aspose.words.bibliography/source/abbreviatedcasenumber/
---
## Source.AbbreviatedCaseNumber property

Возвращает или задает сокращенный номер дела источника.
