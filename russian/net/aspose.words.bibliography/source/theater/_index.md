---
title: Source.Theater
linktitle: Theater
articleTitle: Theater
second_title: Aspose.Words для .NET
description: Откройте для себя собственность Source Theater, легко управляйте и настраивайте параметры вашего кинотеатра для улучшенного развлекательного опыта. Раскройте свой творческий потенциал!
type: docs
weight: 460
url: /ru/net/aspose.words.bibliography/source/theater/
---
## Source.Theater property

Возвращает или задает театр источника.
