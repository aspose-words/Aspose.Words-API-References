...
description: Управляйте своим свойством Source Tag без усилий. Легко получайте или устанавливайте уникальное имя тега для вашего источника, улучшая организацию и эффективность.
type: docs
weight: 450
url: /ru/net/aspose.words.bibliography/source/tag/
---
## Source.Tag property

Получает или задает идентификационное имя тега источника.
