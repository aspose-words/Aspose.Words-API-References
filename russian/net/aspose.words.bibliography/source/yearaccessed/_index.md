...
description: Легко управляйте своим свойством Source YearAccessed. Получите или установите доступный год для точных цитат и оптимизированного управления исследованиями.
type: docs
weight: 540
url: /ru/net/aspose.words.bibliography/source/yearaccessed/
---
## Source.YearAccessed property

Возвращает или задает год доступа к источнику.
