...
description: Откройте для себя свойство BookTitle, чтобы легко управлять и настраивать названия книг. Улучшите управление источниками с помощью этой важной функции!
type: docs
weight: 40
url: /ru/net/aspose.words.bibliography/source/booktitle/
---
## Source.BookTitle property

Получает или задает название книги источника.
