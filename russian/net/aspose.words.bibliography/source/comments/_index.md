...
description: Легко управляйте комментариями к источнику — получайте или устанавливайте комментарии для любого источника, чтобы повысить ясность и вовлеченность вашего контента. Оптимизируйте свой рабочий процесс сегодня!
type: docs
weight: 100
url: /ru/net/aspose.words.bibliography/source/comments/
---
## Source.Comments property

Получает или задает комментарии источника.
