...
description: Управляйте месяцем доступа к источнику без усилий. Легко устанавливайте или извлекайте месяц доступа для оптимального отслеживания и организации данных.
type: docs
weight: 290
url: /ru/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

Возвращает или задает месяц доступа к источнику.
