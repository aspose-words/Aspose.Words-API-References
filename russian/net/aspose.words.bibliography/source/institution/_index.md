...
description: Управляйте свойствами вашего исходного учреждения без усилий. Легко устанавливайте или обновляйте данные учреждения для оптимизированной организации данных и улучшенной доступности.
type: docs
weight: 220
url: /ru/net/aspose.words.bibliography/source/institution/
---
## Source.Institution property

Возвращает или задает учреждение источника.
