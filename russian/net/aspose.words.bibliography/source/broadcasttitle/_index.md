...
description: Легко управляйте заголовком трансляции вашего источника с помощью нашего удобного свойства BroadcastTitle. Повысьте видимость и вовлеченность вашего контента сегодня!
type: docs
weight: 60
url: /ru/net/aspose.words.bibliography/source/broadcasttitle/
---
## Source.BroadcastTitle property

Получает или задает заголовок трансляции источника.
