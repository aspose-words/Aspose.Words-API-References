...
description: Узнайте, как управлять типами тезисов с помощью свойства ThesisType. Легко получайте или устанавливайте исходные типы тезисов для оптимизированного управления исследованиями.
type: docs
weight: 470
url: /ru/net/aspose.words.bibliography/source/thesistype/
---
## Source.ThesisType property

Получает или задает тип тезиса источника.
