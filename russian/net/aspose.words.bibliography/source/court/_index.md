...
description: Откройте для себя решения Source Court по недвижимости. Легко управляйте и настраивайте свои судебные источники для упрощения юридических процессов и повышения эффективности.
type: docs
weight: 140
url: /ru/net/aspose.words.bibliography/source/court/
---
## Source.Court property

Получает или задает суд источника.
