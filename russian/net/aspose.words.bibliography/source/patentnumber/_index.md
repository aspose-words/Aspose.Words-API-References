...
description: Легко управляйте данными патентов с помощью свойства Source PatentNumber. Легко извлекайте или обновляйте номера патентов для оптимизированного отслеживания источника.
type: docs
weight: 320
url: /ru/net/aspose.words.bibliography/source/patentnumber/
---
