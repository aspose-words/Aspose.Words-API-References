...
description: Узнайте, как легко управлять названием журнала вашего источника с помощью свойства JournalName. Упростите свои исследования и улучшите свои цитирования сегодня!
type: docs
weight: 250
url: /ru/net/aspose.words.bibliography/source/journalname/
---
## Source.JournalName property

Получает или задает имя журнала источника.
