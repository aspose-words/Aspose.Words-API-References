...
description: Управляйте своим исходным порядком ссылок без усилий с помощью RefOrder. Оптимизируйте организацию данных для повышения эффективности и ясности.
type: docs
weight: 380
url: /ru/net/aspose.words.bibliography/source/reforder/
---
## Source.RefOrder property

Получает или задает порядок ссылок источника.
