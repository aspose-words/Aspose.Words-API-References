...
description: Узнайте, как управлять свойствами StateOrProvince без усилий. Легко получайте или устанавливайте штат или провинцию для любого источника с помощью нашего удобного руководства!
type: docs
weight: 430
url: /ru/net/aspose.words.bibliography/source/stateorprovince/
---
## Source.StateOrProvince property

Возвращает или задает штат или провинцию источника.
