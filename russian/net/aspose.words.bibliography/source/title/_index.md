...
description: Откройте для себя свойство «Название источника», легко управляйте и настраивайте названия источников для лучшей организации и ясности ваших проектов.
type: docs
weight: 480
url: /ru/net/aspose.words.bibliography/source/title/
---
## Source.Title property

Получает или задает заголовок источника.
