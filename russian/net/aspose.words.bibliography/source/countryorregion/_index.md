...
description: Управляйте местоположениями источников без усилий с помощью свойства CountryOrRegion. Легко получайте или устанавливайте страну или регион источника для оптимизированной обработки данных.
type: docs
weight: 130
url: /ru/net/aspose.words.bibliography/source/countryorregion/
---
