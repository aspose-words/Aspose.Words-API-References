...
description: Управляйте своей производственной компанией без усилий с помощью Source ProductionCompany. Легко настраивайте или обновляйте производственные данные вашего источника для бесперебойного сотрудничества.
type: docs
weight: 340
url: /ru/net/aspose.words.bibliography/source/productioncompany/
---
## Source.ProductionCompany property

Возвращает или задает компанию-производителя источника.
