...
description: Управляйте своим свойством Source Guid без усилий. Легко получайте или устанавливайте GUID для упрощенной обработки данных и улучшенной организации.
type: docs
weight: 210
url: /ru/net/aspose.words.bibliography/source/guid/
---
## Source.Guid property

Получает или задает guid источника.
