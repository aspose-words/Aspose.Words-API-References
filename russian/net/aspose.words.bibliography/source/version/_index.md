...
description: Управляйте своей исходной версией без усилий. Устанавливайте или извлекайте версию с легкостью для улучшенного контроля и эффективности в ваших проектах.
type: docs
weight: 510
url: /ru/net/aspose.words.bibliography/source/version/
---
## Source.Version property

Получает или задает версию источника.
