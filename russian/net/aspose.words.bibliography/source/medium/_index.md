...
description: Управляйте средой вашего источника без усилий с помощью нашего интуитивно понятного инструмента. Улучшите организацию данных и оптимизируйте рабочий процесс уже сегодня!
type: docs
weight: 270
url: /ru/net/aspose.words.bibliography/source/medium/
---
## Source.Medium property

Получает или задает среду источника.
