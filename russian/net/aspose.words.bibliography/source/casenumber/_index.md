...
description: Управляйте номером дела вашего источника без усилий с помощью свойства Source CaseNumber. Упростите отслеживание и улучшите организацию для лучших результатов.
type: docs
weight: 70
url: /ru/net/aspose.words.bibliography/source/casenumber/
---
## Source.CaseNumber property

Получает или задает номер случая источника.
