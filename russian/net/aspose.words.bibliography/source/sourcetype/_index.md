...
description: Откройте для себя свойство SourceType, чтобы легко управлять источниками данных. Легко получайте или устанавливайте типы источников для улучшенной организации данных.
type: docs
weight: 410
url: /ru/net/aspose.words.bibliography/source/sourcetype/
---
## Source.SourceType property

Возвращает или задает тип источника источника.
