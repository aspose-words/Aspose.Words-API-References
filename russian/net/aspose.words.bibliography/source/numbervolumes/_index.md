...
description: Легко управляйте количеством томов источника. Отрегулируйте количество томов для оптимального управления источником и улучшите организацию данных без усилий.
type: docs
weight: 300
url: /ru/net/aspose.words.bibliography/source/numbervolumes/
---
## Source.NumberVolumes property

Возвращает или задает количество томов источника.
