...
description: Управляйте свойством Source StandardNumber без усилий. Легко получайте или устанавливайте стандартный номер для бесшовной интеграции данных и точности.
type: docs
weight: 420
url: /ru/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

Получает или задает стандартный номер источника.
