...
description: Управляйте своими исходными проблемами без усилий. Легко получайте или устанавливайте исходные свойства, чтобы оптимизировать рабочий процесс и повысить производительность.
type: docs
weight: 240
url: /ru/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

Получает или задает проблему источника.
