...
description: Управляйте своим свойством Source Month без усилий. Легко получайте или устанавливайте месяц для любого источника, улучшая организацию и эффективность данных.
type: docs
weight: 280
url: /ru/net/aspose.words.bibliography/source/month/
---
## Source.Month property

Возвращает или задает месяц источника.
