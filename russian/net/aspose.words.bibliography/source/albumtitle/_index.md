...
description: Управляйте названием альбома вашего источника без усилий с помощью свойства AlbumTitle. Легко получайте или устанавливайте названия для лучшей организации и доступности.
type: docs
weight: 30
url: /ru/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

Получает или задает название альбома источника.
