...
description: Управляйте номером главы вашего источника с легкостью с помощью свойства ChapterNumber — оно просто в использовании и необходимо для организованных ссылок.
type: docs
weight: 80
url: /ru/net/aspose.words.bibliography/source/chapternumber/
---
