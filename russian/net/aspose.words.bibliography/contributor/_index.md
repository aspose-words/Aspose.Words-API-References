...
description: Откройте для себя класс Aspose.Words.Bibliography.Contributor — ваше универсальное решение для управления участниками библиографии, включая организации и отдельных лиц.
type: docs
weight: 150
url: /ru/net/aspose.words.bibliography/contributor/
---
## Contributor class

Представляет автора источника библиографии. Может быть как корпорацией (организацией), так и списком лиц.
