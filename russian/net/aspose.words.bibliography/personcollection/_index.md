...
description: Откройте для себя класс Aspose.Words.Bibliography.PersonCollection, разработанный для оптимизации управления библиографией путем эффективного перечисления авторов источников.
type: docs
weight: 190
url: /ru/net/aspose.words.bibliography/personcollection/
---
## PersonCollection class

Представляет список лиц, которые являются авторами библиографических источников.
...
| Имя | Описание |
| --- | --- |
| [PersonCollection](personcollection/#constructor)() | Инициализирует новый экземпляр`PersonCollection` класс. |
| [PersonCollection](personcollection/#constructor_2)(*IEnumerable&lt;Person&gt;*) |  |
| [PersonCollection](personcollection/#constructor_1)(*params Person[]*) | Инициализирует новый экземпляр`PersonCollection` класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [Count](../../aspose.words.bibliography/personcollection/count/) { get; } | Получает количество лиц, содержащихся в коллекции. |
| [Item](../../aspose.words.bibliography/personcollection/item/) { get; set; } | Возвращает или задает человека по указанному индексу. |

## Методы

| Имя | Описание |
| --- | --- |
| [Add](../../aspose.words.bibliography/personcollection/add/)(*[Person](../person/)*) | Добавляет[`Person`](../person/) в коллекцию. |
| [Clear](../../aspose.words.bibliography/personcollection/clear/)() | Удаляет все элементы из коллекции. |
| [Contains](../../aspose.words.bibliography/personcollection/contains/)(*[Person](../person/)*) | Определяет, содержит ли коллекция конкретного человека. |
| [Remove](../../aspose.words.bibliography/personcollection/remove/)(*[Person](../person/)*) | Удаляет человека из коллекции. |
| [RemoveAt](../../aspose.words.bibliography/personcollection/removeat/)(*int*) | Удаляет человека по указанному индексу. |
