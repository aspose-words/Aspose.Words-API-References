...
description: Легко очистите PersonCollection с помощью нашего метода Clear, мгновенно удалив все элементы для нового старта. Упростите управление данными сегодня!
type: docs
weight: 50
url: /ru/net/aspose.words.bibliography/personcollection/clear/
---
