...
description: Доступ или изменение конкретного человека в PersonCollection по индексу. Упростите управление данными с помощью этого важного свойства для эффективного кодирования!
type: docs
weight: 30
url: /ru/net/aspose.words.bibliography/personcollection/item/
---
## PersonCollection indexer

Возвращает или задает человека по указанному индексу.
