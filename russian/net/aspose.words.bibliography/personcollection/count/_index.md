...
description: Откройте для себя свойство PersonCollection Count, чтобы легко получить общее количество людей в вашей коллекции для эффективного управления данными.
type: docs
weight: 20
url: /ru/net/aspose.words.bibliography/personcollection/count/
---
