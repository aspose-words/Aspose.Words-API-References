...
description: Откройте для себя класс Aspose.Words.Bibliography — ваш важнейший инструмент для эффективного и легкого управления источниками библиографии в документах.
type: docs
weight: 140
url: /ru/net/aspose.words.bibliography/bibliography/
---
## Bibliography class

Представляет список источников библиографии, доступных в документе.
...
| Имя | Описание |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Возвращает или задает строку, представляющую имя активного стиля для использования в библиографии. |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | Получает коллекцию, которая представляет все источники, содержащиеся в библиографии. |
