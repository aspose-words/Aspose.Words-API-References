...
description: Откройте для себя полную коллекцию библиографических источников, которая идеально подходит для улучшения исследований и обеспечения точности ссылок в ваших проектах.
type: docs
weight: 20
url: /ru/net/aspose.words.bibliography/bibliography/sources/
---
## Bibliography.Sources property

Получает коллекцию, которая представляет все источники, содержащиеся в библиографии.
