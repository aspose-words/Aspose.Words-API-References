...
description: Управляйте персональными данными без усилий с помощью свойства Person Last. Легко получайте или устанавливайте фамилию человека для упрощения обработки данных.
type: docs
weight: 30
url: /ru/net/aspose.words.bibliography/person/last/
---
