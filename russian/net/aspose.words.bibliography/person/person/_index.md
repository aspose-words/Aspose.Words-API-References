...
description: Создайте новый экземпляр Person без усилий с помощью нашего удобного конструктора. Упростите кодирование и улучшите свои проекты сегодня!
type: docs
weight: 10
url: /ru/net/aspose.words.bibliography/person/person/
---
## Person constructor

Инициализирует новый экземпляр[`Person`](../) класс.
...
| --- | --- | --- |
| last | String | Фамилия. |
| first | String | Фамилия. |
| middle | String | Фамилия. |
