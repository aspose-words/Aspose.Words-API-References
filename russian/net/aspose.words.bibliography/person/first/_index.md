...
description: Откройте для себя свойство Person First, легко управляйте и настраивайте имена людей для персонализированного взаимодействия и повышения точности данных.
type: docs
weight: 20
url: /ru/net/aspose.words.bibliography/person/first/
---
