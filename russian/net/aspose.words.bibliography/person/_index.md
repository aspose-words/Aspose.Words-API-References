...
description: Откройте для себя класс Aspose.Words.Bibliography.Person для управления отдельными авторами в библиографиях. Повысьте точность цитирования вашего документа!
type: docs
weight: 180
url: /ru/net/aspose.words.bibliography/person/
---
## Person class

Представляет индивидуального (человека) автора источника библиографии.
...
| Имя | Описание |
| --- | --- |
| [Person](person/)(*string, string, string*) | Инициализирует новый экземпляр`Person` класс. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Возвращает или задает имя человека. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Возвращает или задает фамилию человека. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Возвращает или задает отчество человека. |
