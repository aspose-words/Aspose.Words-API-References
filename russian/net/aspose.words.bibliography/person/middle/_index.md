...
description: Узнайте, как легко управлять вторым именем человека с помощью нашего удобного свойства. Упростите обработку данных и улучшите свои приложения сегодня!
type: docs
weight: 40
url: /ru/net/aspose.words.bibliography/person/middle/
---
## Person.Middle property

Возвращает или задает отчество человека.
