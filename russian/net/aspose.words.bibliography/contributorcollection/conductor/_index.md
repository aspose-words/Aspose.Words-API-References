...
description: Откройте для себя свойство ContributorCollection Conductor, легко управляйте и настраивайте исходный проводник для улучшенной организации и контроля данных.
type: docs
weight: 60
url: /ru/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Получает или задает проводник источника.
