...
description: Откройте для себя свойство ContributorCollection Inventor, чтобы легко управлять и идентифицировать изобретателя ваших источников, улучшая организацию вашего проекта.
type: docs
weight: 120
url: /ru/net/aspose.words.bibliography/contributorcollection/inventor/
---
## ContributorCollection.Inventor property

Возвращает или задает изобретателя источника.
