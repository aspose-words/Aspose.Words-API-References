...
description: Управляйте своей ContributorCollection без усилий. Легко устанавливайте или обновляйте директора для каждого источника, улучшая организацию и эффективность.
type: docs
weight: 80
url: /ru/net/aspose.words.bibliography/contributorcollection/director/
---
## ContributorCollection.Director property

Возвращает или задает директора источника.
