...
description: Откройте для себя свойство ContributorCollection Compiler для эффективного управления исходными компиляторами. Улучшите свой опыт кодирования с помощью простого доступа и управления!
type: docs
weight: 40
url: /ru/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

Возвращает или задает компилятор источника.
