...
description: Управляйте своими медиафайлами с помощью свойства Producer в ContributorCollection — легко устанавливайте или извлекайте производителя источника для оптимизированной организации контента.
type: docs
weight: 140
url: /ru/net/aspose.words.bibliography/contributorcollection/producer/
---
## ContributorCollection.Producer property

Получает или задает производителя источника.
