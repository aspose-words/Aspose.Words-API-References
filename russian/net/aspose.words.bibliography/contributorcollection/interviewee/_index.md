...
description: Откройте для себя свойство ContributorCollection Interviewee для эффективного управления и настройки данных интервьюируемых для ваших источников. Улучшите организацию ваших данных!
type: docs
weight: 100
url: /ru/net/aspose.words.bibliography/contributorcollection/interviewee/
---
## ContributorCollection.Interviewee property

Получает или задает интервьюируемого источника.
