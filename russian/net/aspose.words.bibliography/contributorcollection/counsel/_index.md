...
description: Откройте для себя ContributorCollection Counsel. Легко управляйте и получайте доступ к источникам консультаций для расширенного понимания недвижимости и оптимизированного принятия решений.
type: docs
weight: 70
url: /ru/net/aspose.words.bibliography/contributorcollection/counsel/
---
## ContributorCollection.Counsel property

Получает или задает совет источника.
