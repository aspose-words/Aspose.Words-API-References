...
description: Откройте для себя свойство ContributorCollection Translator, легко управляйте и настраивайте исходные переводчики для повышения доступности и вовлеченности вашего контента.
type: docs
weight: 150
url: /ru/net/aspose.words.bibliography/contributorcollection/translator/
---
## ContributorCollection.Translator property

Получает или задает транслятор источника.
