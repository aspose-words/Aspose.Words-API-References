...
description: Откройте для себя свойство ContributorCollection BookAuthor, с легкостью управляйте и настраивайте авторов книг для своих источников, улучшая организацию вашего контента.
type: docs
weight: 30
url: /ru/net/aspose.words.bibliography/contributorcollection/bookauthor/
---
## ContributorCollection.BookAuthor property

Возвращает или задает автора книги источника.
