...
description: Управляйте своей ContributorCollection с легкостью! Установите или получите редактор для источников, чтобы улучшить свой рабочий процесс и оптимизировать управление контентом.
type: docs
weight: 90
url: /ru/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

Получает или задает редактор источника.
