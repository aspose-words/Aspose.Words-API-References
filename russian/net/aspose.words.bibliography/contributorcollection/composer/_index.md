...
description: Откройте для себя свойство ContributorCollection Composer, позволяющее легко управлять исходными компоновщиками и настраивать их для улучшения организации данных и повышения эффективности.
type: docs
weight: 50
url: /ru/net/aspose.words.bibliography/contributorcollection/composer/
---
