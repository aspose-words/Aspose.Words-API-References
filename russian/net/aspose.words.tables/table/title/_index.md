...
description: Откройте для себя свойство «Заголовок таблицы», с легкостью задайте или измените заголовок таблицы для улучшения доступности и улучшенного представления данных.
type: docs
weight: 320
