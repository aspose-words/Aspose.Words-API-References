...
description: Откройте для себя метод Table AcceptStart, позволяющий плавно приветствовать посетителей в начале стола, улучшая пользовательский опыт и вовлеченность.
type: docs
weight: 370
url: /ru/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Принимает посетителя для посещения начала таблицы.
