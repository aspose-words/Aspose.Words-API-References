...
description: Получает или задает количество места в пунктах которое добавляется слева от содержимого ячеек.
type: docs
weight: 200
...
Получает или задает количество места (в пунктах), которое добавляется слева от содержимого ячеек.
