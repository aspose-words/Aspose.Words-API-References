...
description: Table свойство. Получает или задает количество места в пунктах для добавления слева от содержимого ячеек.
type: docs
weight: 200
...
Получает или задает количество места (в пунктах) для добавления слева от содержимого ячеек.
