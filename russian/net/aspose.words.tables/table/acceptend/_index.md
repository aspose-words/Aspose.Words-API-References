...
description: Откройте для себя метод Table AcceptEnd, который позволяет легко интегрировать посетителей в конец таблицы для улучшения пользовательского опыта и эффективной обработки данных.
type: docs
weight: 360
url: /ru/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

Принимает посетителя для посещения конца таблицы.
