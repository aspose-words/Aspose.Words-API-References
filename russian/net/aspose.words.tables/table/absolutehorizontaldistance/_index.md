...
description: Получает или задает абсолютную позицию плавающей таблицы по горизонтали указанную в свойствах таблицы в пунктах. Значение по умолчанию0.
type: docs
weight: 20
...
Получает или задает абсолютную позицию плавающей таблицы по горизонтали, указанную в свойствах таблицы, в пунктах. Значение по умолчанию:0.
