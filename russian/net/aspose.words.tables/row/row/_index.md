...
description: Инициализирует новый экземпляр класса Row .
type: docs
weight: 10
...
Когда **Строка** есть создан, он принадлежит указанному документу, но не является частью документа и **ParentNode** имеет значение null.

Чтобы добавить строку к документу, используйте InsertAfter или InsertBefore on таблицу, в которую вы хотите вставить строку.
