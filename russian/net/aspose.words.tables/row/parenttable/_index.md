...
description: Откройте для себя свойство Row ParentTable, чтобы легко получить доступ к непосредственной родительской таблице любой строки, улучшив управление данными и их анализ.
type: docs
weight: 90
