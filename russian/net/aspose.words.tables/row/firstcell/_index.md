...
description: Откройте для себя свойство Row FirstCell, легко получайте доступ к первой ячейке в строке для оптимизированного управления данными и повышения производительности.
type: docs
weight: 30
...
Возвращает первый[`Cell`](../../cell/) в строке.
