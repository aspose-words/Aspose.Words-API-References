...
description: Откройте для себя метод Row AcceptStart, позволяющий легко принимать посетителей в начале строки для улучшения пользовательского опыта и эффективной навигации.
type: docs
weight: 140
url: /ru/net/aspose.words.tables/row/acceptstart/
---
