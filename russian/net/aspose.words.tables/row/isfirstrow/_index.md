...
description: Откройте для себя свойство Row IsFirstRow, легко определите первую строку в таблице. Улучшите организацию данных с помощью этой важной функции!
type: docs
weight: 40
...
True, если это первая строка в таблице; в противном случае false.
