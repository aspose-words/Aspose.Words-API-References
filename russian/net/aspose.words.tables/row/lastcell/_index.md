...
description: Откройте для себя свойство Row LastCell, которое позволяет легко получить доступ к последней ячейке в строке, повышая эффективность управления данными и анализа.
type: docs
weight: 60
...
Возвращает последний[`Cell`](../../cell/) в строке.
