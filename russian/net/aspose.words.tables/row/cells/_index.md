...
description: Row свойство. Предоставляет типизированный доступ к Клетка дочерние узлы строки.
type: docs
weight: 20
...
Предоставляет типизированный доступ к **Клетка** дочерние узлы строки.
