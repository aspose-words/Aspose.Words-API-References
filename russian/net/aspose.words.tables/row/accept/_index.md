...
description: Откройте для себя метод Row Accept, разработанный для повышения вовлеченности посетителей и оптимизации взаимодействия с пользователем для успеха вашего веб-сайта.
type: docs
weight: 120
...
Звонки[`VisitRowStart`](../../../aspose.words/documentvisitor/visitrowstart/) , затем звонит[`Accept`](../../../aspose.words/node/accept/) для всех дочерних узлов section и вызовов[`VisitRowEnd`](../../../aspose.words/documentvisitor/visitrowend/) в конце.
