...
description: Откройте для себя метод Row AcceptEnd, чтобы улучшить опыт посетителей, плавно направляя их к концу ряда. Повысьте вовлеченность сегодня!
type: docs
weight: 130
url: /ru/net/aspose.words.tables/row/acceptend/
---
## Row.AcceptEnd method

Принимает посетителя для посещения конца ряда.
