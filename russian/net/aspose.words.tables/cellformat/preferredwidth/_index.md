...
Предпочтительная ширина (вместе с опцией Auto Fit таблицы) определяет, как фактическая ширина ячейки вычисляется по алгоритму верстки таблицы. Макет таблицы может быть выполнен с помощью Aspose.Words при сохранении документа или с помощью Microsoft Word при отображении документа.
