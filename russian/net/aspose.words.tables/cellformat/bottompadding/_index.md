...
description: Откройте для себя свойство CellFormat BottomPadding для настройки интервалов в ячейках. Улучшите свои макеты с помощью точной корректировки точек для лучшей презентации.
type: docs
weight: 20
...
Возвращает или задает размер пространства (в пунктах), добавляемого под содержимым ячейки.
