...
description: CellFormat свойство. Возвращает или задает количество места в пунктах для добавления над содержимым ячейки.
type: docs
weight: 100
...
Возвращает или задает количество места (в пунктах) для добавления над содержимым ячейки.
