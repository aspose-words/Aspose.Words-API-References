...
description: Откройте для себя свойство CellFormat VerticalAlignment, которое позволяет легко устанавливать и настраивать выравнивание текста в ячейках для улучшенного представления данных.
type: docs
weight: 120
