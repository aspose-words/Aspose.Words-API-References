...
description: Откройте для себя свойство RowFormat Height, которое позволяет легко настроить высоту строки таблицы в пунктах, улучшив макет и читабельность документа.
type: docs
weight: 40
...
Возвращает или задает высоту строки таблицы в пунктах.
