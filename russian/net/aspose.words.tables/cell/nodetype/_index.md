...
description: Откройте для себя свойство Cell NodeType, которое эффективно возвращает данные Cell. Улучшите свой код с помощью нашего всеобъемлющего руководства и раскройте его полный потенциал!
type: docs
weight: 80
