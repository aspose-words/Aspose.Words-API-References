...
description: Откройте для себя метод Cell AcceptStart, который позволяет легко приветствовать посетителей на входе в вашу ячейку, улучшая пользовательский опыт и взаимодействие с ней.
type: docs
weight: 150
url: /ru/net/aspose.words.tables/cell/acceptstart/
---
## Cell.AcceptStart method

Принимает посетителя для посещения начала ячейки.
