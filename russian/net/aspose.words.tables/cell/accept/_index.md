...
description: Cell метод. Принимает посетителя.
type: docs
weight: 110
...
Вызывает DocumentVisitor.VisitCellStart, затем вызывает Accept для всех дочерних узлов section и вызывает DocumentVisitor.VisitCellEnd в конце.
