...
description: Откройте для себя свойство Cell IsLastCell. Легко определяйте, является ли ячейка последней в строке, улучшая стратегии управления данными и оптимизации.
type: docs
weight: 50
...
True, если это последняя ячейка в строке; в противном случае false.
