...
description: Истинно если это первая ячейка внутри строки ложно в противном случае.
type: docs
weight: 40
...
Истинно, если это первая ячейка внутри строки; ложно в противном случае.
...
Показывает, как напечатать структуру узлов каждой таблицы в документе.
