...
description: С легкостью преобразуйте TableCollection в массив с помощью метода ToArray, упрощая управление данными и повышая производительность вашего приложения.
type: docs
weight: 20
