...
description: PreferredWidth метод. Метод создания который возвращает новый экземпляр представляющий предпочтительную ширину указанную с помощью количества точек.
type: docs
weight: 30
