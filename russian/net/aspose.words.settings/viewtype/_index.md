...
| PageLayout | `1` | Документ должен быть открыт в представлении, которое отображает документ в том виде, в каком он будет напечатан. |
| Outline | `3` | Документ должен отображаться в виде, оптимизированном для структурирования или создания длинных документов. |
