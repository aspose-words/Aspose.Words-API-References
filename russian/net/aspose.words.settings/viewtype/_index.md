...
| Outline | `3` | Документ должен быть представлен в виде, оптимизированном для выделения или создания длинных документов. |
| Normal | `4` | Документ должен быть представлен в виде, оптимизированном для выделения или создания длинных документов. |
