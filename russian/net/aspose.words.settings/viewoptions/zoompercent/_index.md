...
description: Получает или задает процент от 10 до 500 в котором вы хотите просмотреть документ.
type: docs
weight: 50
...
Получает или задает процент (от 10 до 500), в котором вы хотите просмотреть документ.
...
Если значение равно 0, то это свойство вместо этого использует 100, иначе, если значение меньше 10 или больше чем 500 это свойство бросает.
