...
description: Отключает отображение пространства между верхом текста и верхним краем страницы.
type: docs
weight: 20
...
DocumentBuilder builder = new DocumentBuilder(doc);
 ...
 // Вставляем содержимое, занимающее 3 страницы.
...
// Этот документ содержит небольшое количество контента, занимающего несколько полных страниц.
 ...
 // нижние колонтитулы и большая часть вертикального пробела при отображении нашего документа.
