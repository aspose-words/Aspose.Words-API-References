...
description: OdsoRecipientData свойство. Указывает должна ли запись из источника данных быть импортирована в документ при выполнении слияния почты. Значение по умолчаниюистинный .
type: docs
weight: 20
