...
description: OdsoRecipientData свойство. Указывает будет ли запись из источника данных импортироваться в документ при выполнении слияния. Значение по умолчаниюистинный .
type: docs
weight: 20
