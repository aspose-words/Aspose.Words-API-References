...
description: Управляйте импортом слияния почты с помощью свойства OdsoRecipientData Active. Легко управляйте записями данных для бесперебойного создания документов. Значение по умолчанию — true.
type: docs
weight: 20
...
Указывает, будет ли запись из источника данных импортирована в документ при выполнении слияния почты. Значение по умолчанию:`истинный` .
