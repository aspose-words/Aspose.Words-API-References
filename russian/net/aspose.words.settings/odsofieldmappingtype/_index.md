...
description: Задает возможные типы используемые для указания сопоставлено ли данное поле слияния со столбцом в данном внешнем источнике данных.
type: docs
weight: 5570
...
Задает возможные типы, используемые для указания, сопоставлено ли данное поле слияния со столбцом в данном внешнем источнике данных.
...
Показывает, как получить доступ к коллекции данных который сопоставляет столбцы источника данных с полями слияния.
