...
description: Откройте для себя свойство CompatibilityOptions DoNotUseEastAsianBreakRules для оптимизации сеток документа без сжатия символов. Улучшите свое форматирование сегодня!
type: docs
weight: 200
