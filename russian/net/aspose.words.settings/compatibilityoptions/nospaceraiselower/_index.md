...
description: Откройте для себя свойство CompatibilityOptions NoSpaceRaiseLower, позволяющее сохранить высоту строки для приподнятого или опущенного текста, обеспечивая изысканный и профессиональный вид.
type: docs
weight: 360
