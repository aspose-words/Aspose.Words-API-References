...
description: Откройте для себя свойство CompatibilityOptions DoNotVertAlignCellWithSp, которое предотвращает вертикальное выравнивание ячеек с плавающими объектами для создания более чистых макетов.
type: docs
weight: 230
