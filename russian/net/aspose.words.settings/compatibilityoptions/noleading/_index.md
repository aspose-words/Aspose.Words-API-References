...
description: Откройте для себя свойство NoLeading в CompatibilityOptions, которое позволяет устранить нежелательные интервалы между строками текста и добиться более чистого и профессионального вида.
type: docs
weight: 350
...
Не добавлять межстрочный интервал между строками текста.
