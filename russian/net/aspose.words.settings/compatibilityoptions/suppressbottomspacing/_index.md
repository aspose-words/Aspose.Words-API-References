...
description: Оптимизируйте макет с помощью свойства SuppressBottomSpacing в CompatibilityOptions, обеспечивающего идеальную высоту строки на последней странице и придания ей изысканного вида.
type: docs
weight: 480
