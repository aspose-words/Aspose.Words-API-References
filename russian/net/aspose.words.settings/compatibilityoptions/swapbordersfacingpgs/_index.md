...
description: Улучшите макет документа с помощью свойства CompatibilityOptions SwapBordersFacingPgs. Легко меняйте границы абзацев на нечетных страницах для придания изысканного вида!
type: docs
weight: 530
...
Поменять местами границы абзацев на нечетных страницах.
