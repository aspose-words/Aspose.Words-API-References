...
description: Оптимизируйте дизайн таблицы с помощью свойства UseSingleBorderForContiguousCells. Упростите конфликты границ и улучшите визуальную привлекательность без усилий!
type: docs
weight: 650
...
Использовать упрощенные правила для конфликтов границ таблиц.
