...
description: Откройте для себя свойство CompatibilityOptions UseFELayout — обеспечьте оптимальную компоновку восточноазиатских и сложных шрифтов для удобного взаимодействия с пользователем.
type: docs
weight: 620
...
Не обходить код макета восточноазиатских/сложных шрифтов.
