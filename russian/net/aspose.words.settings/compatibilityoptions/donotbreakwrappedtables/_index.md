...
description: Откройте для себя свойство CompatibilityOptions DoNotBreakWrappedTables, которое предотвращает разрыв плавающих таблиц на разных страницах и обеспечивает бесшовную компоновку документа.
type: docs
weight: 140
...
Не допускайте разрыва плавающих таблиц между страницами.
