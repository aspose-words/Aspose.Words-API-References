...
description: Узнайте, как свойство CompatibilityOptions WPSpaceWidth позволяет настраивать ширину пробелов, как в WordPerfect 5.x, для улучшенного форматирования документов.
type: docs
weight: 700
...
Указывает, следует ли устанавливать ширину пробела, как это сделано в WordPerfect 5.x.
