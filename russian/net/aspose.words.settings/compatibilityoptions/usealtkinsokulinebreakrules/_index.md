...
description: Улучшите форматирование текста с помощью CompatibilityOptions' UseAltKinsokuLineBreakRules для улучшенного переноса строк в восточноазиатском стиле. Оптимизируйте читаемость сегодня!
type: docs
weight: 600
...
Использовать альтернативный набор восточноазиатских правил разрыва линий.
