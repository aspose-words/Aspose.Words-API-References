...
description: Оптимизируйте макет с помощью свойства CompatibilityOptions SuppressTopSpacing, игнорируя настройки высоты строки, чтобы первая страница выглядела более аккуратно.
type: docs
weight: 510
