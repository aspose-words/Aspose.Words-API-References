...
description: Оптимизируйте макет с помощью CompatibilityOptions NoExtraLineSpacing. Обеспечьте точное выравнивание без центрирования контента на точной высоте строк для более чистого дизайна.
type: docs
weight: 340
