...
description: Откройте для себя свойство CompatibilityOptions для бесшовных зеркальных отступов и относительного позиционирования. Повысьте гибкость своего дизайна и пользовательский опыт сегодня!
type: docs
weight: 540
...
Указывает на необходимость поменять местами внутреннюю и внешнюю части для зеркальных отступов и относительного позиционирования.
