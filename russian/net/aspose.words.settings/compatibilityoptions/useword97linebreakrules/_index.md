...
description: Оптимизируйте свои документы с помощью UseWord97LineBreakRules из CompatibilityOptions, чтобы улучшить перенос строк в восточноазиатских языках для улучшения читаемости и форматирования.
type: docs
weight: 680
...
Эмулировать Word 97 Восточноазиатский перенос строк.
