...
description: Оптимизируйте форматирование документа с помощью CompatibilityOptions. Управляйте стилями списков без усилий, гарантируя, что ваш маркированный и нумерованный текст всегда будет выглядеть идеально!
type: docs
weight: 630
