...
description: Узнайте, как свойство ConvMailMergeEsc улучшает совместимость, обрабатывая обратные косые черты как двойные кавычки, оптимизируя форматирование документа.
type: docs
weight: 90
