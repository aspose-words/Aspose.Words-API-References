...
description: Узнайте, как свойство LayoutTableRowsApart улучшает совместимость, обеспечивая независимое размещение встроенных объектов в строках таблицы для большей гибкости дизайна.
type: docs
weight: 300
...
Разрешить строкам таблицы независимо переносить встроенные объекты.
