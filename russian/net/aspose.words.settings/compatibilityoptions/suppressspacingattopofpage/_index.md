...
description: Оптимизируйте макет с помощью свойства CompatibilityOptions SuppressSpacingAtTopOfPage. Управляйте высотой строки для бесшовного отображения первой строки.
type: docs
weight: 490
