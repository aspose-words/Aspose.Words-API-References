...
description: Узнайте, как отключить функции форматирования шрифтов OpenType с помощью свойства CompatibilityOptions для повышения согласованности и производительности документа.
type: docs
weight: 100
...
Указывает на необходимость отключения функций форматирования шрифтов OpenType.
