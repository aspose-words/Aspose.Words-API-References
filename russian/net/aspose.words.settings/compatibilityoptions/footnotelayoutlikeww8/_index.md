...
description: Оптимизируйте свои документы с помощью CompatibilityOptions FootnoteLayoutLikeWW8 для точного размещения сносок, эмулируя Word 6.x/95/97 для бесшовного форматирования.
type: docs
weight: 260
...
Эмуляция размещения сносок Word 6.x/95/97.
