...
description: Узнайте, как свойство CompatibilityOptions UseWord2010TableStyleRules улучшает форматирование документа с помощью расширенных стилей таблиц Word 2010.
type: docs
weight: 670
...
Указывает на необходимость использования правил стиля таблиц Word2010.
