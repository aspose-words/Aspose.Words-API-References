...
description: Откройте для себя свойство CompatibilityOptions ShapeLayoutLikeWW8, позволяющее эмулировать перенос текста Word 97 для улучшенного форматирования документа и управления макетом.
type: docs
weight: 420
...
Эмуляция обтекания текстом Word 97 плавающих объектов.
