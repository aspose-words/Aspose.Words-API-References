...
description: Оптимизируйте макет документа с помощью CompatibilityOptions SuppressSpBfAfterPgBrk. Устраните нежелательные пробелы после разрывов страниц для более чистого форматирования.
type: docs
weight: 500
