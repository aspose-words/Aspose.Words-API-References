...
description: Откройте для себя свойство CompatibilityOptions DoNotBreakConstrainedForcedTable, которое позволяет предотвратить разрывы строк таблицы вокруг плавающих таблиц для создания бесшовных макетов.
type: docs
weight: 130
...
Не разрывайте строки таблиц вокруг плавающих таблиц.
