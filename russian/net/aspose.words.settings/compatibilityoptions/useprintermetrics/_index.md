...
description: Оптимизируйте печать с помощью свойства UsePrinterMetrics в CompatibilityOptions для точного отображения документа. Улучшайте производительность и качество без усилий!
type: docs
weight: 640
...
Использовать метрики принтера для отображения документов.
...
Показатели принтера могут различаться в зависимости от используемых драйверов. Например, Windows «Microsoft OpenXPS Class Driver 2» и «Microsoft Print to PDF» предоставляют немного разные показатели. Поэтому макет окончательного документа может измениться, если эта опция включена.
