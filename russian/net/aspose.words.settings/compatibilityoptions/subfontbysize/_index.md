...
description: Улучшите отображение шрифтов с помощью свойства CompatibilityOptions SubFontBySize, отдавая приоритет размеру при замене шрифта для оптимальной читабельности.
type: docs
weight: 470
