...
description: Откройте для себя свойство CompatibilityOptions NoTabHangInd, чтобы оптимизировать форматирование. Избегайте пользовательских позиций табуляции для бесшовных висячих отступов!
type: docs
weight: 370
...
Не создавать пользовательскую позицию табуляции для выступа.
