...
description: Оптимизируйте свои таблицы с помощью CompatibilityOptions GrowAutofit. Легко вписывайте таблицы в поля страницы для более чистого и профессионального вида.
type: docs
weight: 280
...
Разрешить таблицам автоматически подходить к полям страницы.
