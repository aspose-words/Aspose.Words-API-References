...
description: Откройте для себя свойство SelectFldWithFirstOrLastChar для CompatibilityOptions. Легко выбирайте поля на основе первого или последнего символа для повышения эффективности.
type: docs
weight: 410
...
Выбор поля при выборе первого или последнего символа.
