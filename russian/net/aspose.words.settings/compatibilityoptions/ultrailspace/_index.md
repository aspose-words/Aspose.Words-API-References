...
description: Оптимизируйте свойство UlTrailSpace с помощью CompatibilityOptions. Легко выделяйте все конечные пробелы для более чистого и эффективного кода.
type: docs
weight: 580
