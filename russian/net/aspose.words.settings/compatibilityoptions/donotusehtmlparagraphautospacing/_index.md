...
description: Оптимизируйте свой HTML с помощью свойства CompatibilityOptions DoNotUseHTMLParagraphAutoSpacing. Обеспечьте фиксированный интервал между абзацами для более чистого макета!
type: docs
weight: 210
