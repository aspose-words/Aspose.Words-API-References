...
description: Оптимизируйте макет с помощью свойства CompatibilityOptions LayoutRawTableWidth. Управляйте переносом таблиц и повышайте гибкость дизайна без усилий!
type: docs
weight: 290
...
Игнорировать пробел перед таблицей при принятии решения о том, должна ли таблица обтекать плавающий объект.
