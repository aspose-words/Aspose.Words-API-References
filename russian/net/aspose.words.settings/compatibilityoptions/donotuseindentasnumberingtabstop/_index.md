...
description: Оптимизируйте форматирование документа с помощью свойства CompatibilityOptions DoNotUseIndentAsNumberingTabStop. Улучшите читаемость, игнорируя висячие отступы!
type: docs
weight: 220
...
Игнорировать отступ при создании позиции табуляции после нумерации.
