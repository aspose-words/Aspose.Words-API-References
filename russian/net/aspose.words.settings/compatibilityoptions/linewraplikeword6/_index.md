...
description: Улучшите форматирование текста на восточноазиатских языках с помощью CompatibilityOptions LineWrapLikeWord6, эмулируя перенос строк Word 6.0 для улучшения читаемости и представления.
type: docs
weight: 310
...
Эмулировать перенос строк Word 6.0 для восточноазиатского текста.
