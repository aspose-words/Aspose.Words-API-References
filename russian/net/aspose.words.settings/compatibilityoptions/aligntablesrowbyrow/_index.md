...
description: Откройте для себя свойство AlignTablesRowByRow для CompatibilityOptions. Независимо выравнивайте строки таблицы для улучшенного управления макетом и повышения гибкости дизайна.
type: docs
weight: 20
...
Выровнять строки таблицы независимо.
