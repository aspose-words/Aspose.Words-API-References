...
description: Оптимизируйте свои документы с помощью CompatibilityOptions AutoSpaceLikeWord95 для точного интервала между символами по всей ширине, улучшения читаемости и стиля.
type: docs
weight: 60
...
Эмулировать интервал между символами полной ширины Word 95.
