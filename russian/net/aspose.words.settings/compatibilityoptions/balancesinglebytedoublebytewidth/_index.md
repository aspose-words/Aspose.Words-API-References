...
description: Оптимизируйте отображение текста с помощью свойства BalanceSingleByteDoubleByteWidth для бесшовной интеграции однобайтовых и двухбайтовых символов.
type: docs
weight: 70
