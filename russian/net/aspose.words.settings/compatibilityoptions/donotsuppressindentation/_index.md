...
description: Оптимизируйте макет документа с помощью свойства CompatibilityOptions DoNotSuppressIndentation. Улучшите отступ абзаца, не игнорируя плавающие объекты.
type: docs
weight: 180
