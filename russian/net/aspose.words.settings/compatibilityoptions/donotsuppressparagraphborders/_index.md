...
description: Откройте для себя свойство CompatibilityOptions DoNotSuppressParagraphBorders, чтобы улучшить макет документа за счет эффективного управления границами абзацев рядом с фреймами.
type: docs
weight: 190
...
Не подавлять границы абзацев рядом с фреймами.
