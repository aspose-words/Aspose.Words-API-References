...
description: Откройте для себя свойство CompatibilityOptions DoNotExpandShiftReturn, чтобы предотвратить нежелательное выравнивание строк. Оптимизируйте форматирование текста без усилий!
type: docs
weight: 150
...
Не выравнивайте строки, заканчивающиеся мягким переносом строки.
