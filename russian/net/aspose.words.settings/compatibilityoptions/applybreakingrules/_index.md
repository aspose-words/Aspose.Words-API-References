...
description: Оптимизируйте макет текста с помощью CompatibilityOptions ApplyBreakingRules. Улучшите читаемость с помощью устаревших эфиопских и амхарских правил переноса строк.
type: docs
weight: 40
...
Используйте устаревшие эфиопские и амхарские правила переноса строк.
