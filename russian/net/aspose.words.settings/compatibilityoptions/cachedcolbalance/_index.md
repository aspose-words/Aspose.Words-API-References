...
description: Оптимизируйте макет с помощью свойства CompatibilityOptions CachedColBalance. Улучшите балансировку столбцов с помощью кэшированной информации о абзацах для бесшовного дизайна.
type: docs
weight: 80
...
Использовать кэшированную информацию абзацев для балансировки столбцов.
