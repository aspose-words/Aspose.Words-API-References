...
description: Узнайте, как свойство AutofitToFirstFixedWidthCell улучшает макеты таблиц, позволяя столбцам превышать предпочтительную ширину для оптимального отображения.
type: docs
weight: 50
...
В пользовательском интерфейсе MS Word 2013 эта опция называется «Использовать правила автоподбора таблиц Word 2003». Она также фактически влияет на то, как рассчитывается сетка для таблиц с фиксированным макетом (в некоторых случаях).
