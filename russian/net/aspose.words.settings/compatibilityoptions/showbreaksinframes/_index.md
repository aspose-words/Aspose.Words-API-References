...
description: Улучшите свой веб-дизайн с помощью CompatibilityOptions ShowBreaksInFrames. Легко визуализируйте разрывы страниц и столбцов во фреймах для улучшенного управления макетом.
type: docs
weight: 430
...
Отображать разрывы страниц/столбцов, присутствующие в кадрах.
