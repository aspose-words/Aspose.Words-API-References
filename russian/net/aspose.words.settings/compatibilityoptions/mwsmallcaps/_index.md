...
description: Откройте для себя свойство CompatibilityOptions MWSmallCaps, чтобы без усилий эмулировать форматирование Word 5.x Small Caps на вашем Macintosh. Улучшите свои документы сегодня!
type: docs
weight: 320
...
Эмуляция Word 5.x для форматирования малых заглавных букв на Macintosh.
