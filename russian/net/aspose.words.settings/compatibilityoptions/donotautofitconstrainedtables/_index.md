...
description: Оптимизируйте свои таблицы с помощью свойства CompatibilityOptions DoNotAutofitConstrainedTables. Обеспечьте идеальное выравнивание рядом с обернутыми объектами без усилий.
type: docs
weight: 120
...
Не применять автоподбор таблиц для размещения рядом с обернутыми объектами.
