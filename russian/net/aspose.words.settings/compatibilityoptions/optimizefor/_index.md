...
description: Улучшите свои документы с помощью метода OptimizeFor в CompatibilityOptions. Настройте поведение Aspose.Words для определенных версий MS Word для получения оптимальных результатов.
type: docs
weight: 720
...
Используйте этот метод, чтобы предотвратить отображение ленты «Режим совместимости» в MS Word при загрузке документа. (Обратите внимание, что вам также может потребоваться установить[`Compliance`](../../../aspose.words.saving/ooxmlsaveoptions/compliance/) свойство to Iso29500_2008_Transitional или выше.)
