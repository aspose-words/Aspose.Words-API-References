...
description: Откройте для себя свойство CompatibilityOptions WrapTrailSpaces, чтобы улучшить форматирование текста, эффективно управляя переносом строк и конечными пробелами.
type: docs
weight: 710
...
Перенос строки Завершающие пробелы.
