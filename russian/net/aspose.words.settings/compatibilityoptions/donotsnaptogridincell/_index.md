...
description: Узнайте, как отключить функцию «Не привязываться к сетке» в ячейках таблицы, улучшив макет документа и размещение объектов для лучшего контроля над дизайном.
type: docs
weight: 170
