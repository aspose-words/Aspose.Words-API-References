...
description: Улучшите форматирование документа с помощью CompatibilityOptions WPJustification. Идеально эмулируйте выравнивание абзацев WordPerfect 6.x для получения отточенных результатов.
type: docs
weight: 690
...
Эмулировать выравнивание абзаца WordPerfect 6.x.
