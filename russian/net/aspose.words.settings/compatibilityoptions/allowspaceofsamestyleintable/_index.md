...
description: Улучшите макеты таблиц с помощью CompatibilityOptions' AllowSpaceOfSameStyleInTable. Наслаждайтесь улучшенным интервалом между абзацами для лучшей читаемости и дизайна.
type: docs
weight: 30
...
Разрешить контекстное размещение абзацев в таблицах.
