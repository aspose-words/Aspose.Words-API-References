...
description: Откройте для себя свойство NoColumnBalance в CompatibilityOptions. Управляйте макетом текста без усилий, предотвращая балансировку столбцов в разделах!
type: docs
weight: 330
