...
description: Оптимизируйте высоту шрифтов без особых усилий с помощью CompatibilityOptions TruncateFontHeightsLikeWP6, имитируя WordPerfect 6.x для бесшовного форматирования документов.
type: docs
weight: 560
...
Эмуляция расчета высоты шрифта WordPerfect 6.x.
