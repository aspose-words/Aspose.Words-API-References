...
description: Откройте для себя свойство CompatibilityOptions SpacingInWholePoints, позволяющее легко настраивать интервалы между текстами по целым точкам для улучшения читабельности и дизайна.
type: docs
weight: 450
...
Расширять/Сжимать текст только целыми точками.
