...
description: Узнайте, как свойство CompatibilityOptions TransparentMetafiles улучшает графику, предотвращая затемнение фона за изображениями метафайлов.
type: docs
weight: 550
...
Указывает, что область позади изображений метафайла не должна очищаться.
