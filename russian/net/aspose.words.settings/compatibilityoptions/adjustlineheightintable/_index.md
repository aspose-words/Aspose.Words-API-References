...
description: Улучшите свои таблицы с помощью свойства AdjustLineHeightInTable для точного межстрочного интервала. Улучшите ясность и презентацию документа без усилий!
type: docs
weight: 10
