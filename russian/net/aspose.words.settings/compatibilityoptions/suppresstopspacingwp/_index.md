...
description: Узнайте, как CompatibilityOptions SuppressTopSpacingWP улучшает работу с WordPerfect 5.x с помощью плавной настройки межстрочного интервала для оптимального форматирования документа.
type: docs
weight: 520
...
Эмулировать межстрочный интервал WordPerfect 5.x.
