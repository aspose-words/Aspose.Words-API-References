...
description: Откройте для себя свойство CompatibilityOptions DoNotWrapTextWithPunct, которое позволяет предотвратить висячие знаки препинания в сетке символов и получить более чистые и профессиональные макеты.
type: docs
weight: 250
