...
description: Откройте для себя свойство SplitPgBreakAndParaMark для CompatibilityOptions. Обеспечьте бесшовное форматирование, перемещая знаки абзацев на следующую страницу после разрывов.
type: docs
weight: 460
...
Всегда перемещать знак абзаца на страницу после разрыва страницы.
