...
description: Узнайте, как задать свойство MailMergeSettings DataSource для бесшовной интеграции слияния почты. Легко укажите путь к источнику данных для оптимальных результатов!
type: docs
weight: 60
...
Указывает путь к источнику данных для слияния почты. Значение по умолчанию — пустая строка.
