...
description: Указывает что Microsoft Word должен отображать данные из указанного внешнего источника данных в который были вставлены поля слияния например предварительный просмотр объединенных данных. Значение по умолчанию false .
type: docs
weight: 170
...
Указывает, что Microsoft Word должен отображать данные из указанного внешнего источника данных, в который были вставлены поля слияния (например, предварительный просмотр объединенных данных). Значение по умолчанию:` false` .
