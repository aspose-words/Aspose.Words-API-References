...
description: Узнайте, как свойство ViewMergedData MailMergeSettings в Microsoft Word улучшает процесс создания документов за счет предварительного просмотра объединенных данных из внешних источников.
type: docs
weight: 170
