...
description: Указывает как приложение выполняющее слияние должно обрабатывать пустые строки в объединенных документах полученных в результате слияния. Значение по умолчаниюЛОЖЬ .
type: docs
weight: 90
