...
description: Указывает индекс с отсчетом от единицы записи из источника данных которая должна отображаться в Microsoft Word. Значение по умолчанию  1.
type: docs
weight: 20
...
Указывает индекс с отсчетом от единицы записи из источника данных, которая должна отображаться в Microsoft Word. Значение по умолчанию — 1.
