...
description: Откройте для себя свойство MailMergeSettings DataType, определяющее тип источника данных для слияния почты и метод доступа. Оптимизируйте свой рабочий процесс без усилий!
type: docs
weight: 70
...
Указывает тип источника данных для слияния почты и метод доступа к данным. Значение по умолчанию:Default .
