...
description: Указывает что документы созданные во время операции слияния должны отправляться по электронной почте в виде вложения а не в виде  а не тела фактического сообщения электронной почты. Значение по умолчаниюЛОЖЬ .
type: docs
weight: 120
