...
description: MailMergeSettings свойство. Указывает тип отчета об ошибках который должен создаваться Microsoft Word при выполнении слияния. Значение по умолчаниюDefault .
type: docs
weight: 40
...
Указывает тип отчета об ошибках, который должен создаваться Microsoft Word при выполнении слияния. Значение по умолчанию:Default .
