...
description: Очищает настройки слияния таким образом что при сохранении документа никакие настройки слияния не сохраняются и он становится нормальный документ.
type: docs
weight: 180
...
Очищает настройки слияния таким образом, что при сохранении документа никакие настройки слияния не сохраняются, и он становится нормальный документ.
