...
description: Откройте для себя метод GetEnumerator OdsoRecipientDataCollection — эффективно и легко перебирайте элементы коллекции и расширяйте возможности обработки данных.
type: docs
weight: 60
