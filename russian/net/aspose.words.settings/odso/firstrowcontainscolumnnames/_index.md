...
description: Указывает что хост-приложение должно обрабатывать первую строку данных в указанных внешних данных source как строку заголовка содержащую имена каждого столбца. в источнике данных. Значение по умолчанию false .
type: docs
weight: 60
...
Указывает, что хост-приложение должно обрабатывать первую строку данных в указанных внешних данных source как строку заголовка, содержащую имена каждого столбца. в источнике данных. Значение по умолчанию:` false` .
