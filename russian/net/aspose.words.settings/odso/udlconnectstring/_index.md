...
description: Указывает строку подключения к универсальному каналу передачи данных UDL используемую для подключения к внешнему источнику данных. Значение по умолчанию  пустая строка.
type: docs
weight: 90
...
Указывает строку подключения к универсальному каналу передачи данных (UDL), используемую для подключения к внешнему источнику данных. Значение по умолчанию — пустая строка.
