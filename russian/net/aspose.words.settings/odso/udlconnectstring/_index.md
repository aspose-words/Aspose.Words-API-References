...
description: Задает строку подключения к универсальному каналу передачи данных UDL используемую для подключения к внешнему источнику данных. Значение по умолчанию  пустая строка.
type: docs
weight: 90
