...
description: Указывает расположение внешнего источника данных который необходимо подключить к документу для выполнения слияния. Значение по умолчанию  пустая строка.
type: docs
weight: 30
