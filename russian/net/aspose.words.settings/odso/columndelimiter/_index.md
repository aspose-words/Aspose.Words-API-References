...
description: Указывает символ который должен интерпретироваться как разделитель столбцов используемый для разделения столбцов во внешних источниках данных. Значение по умолчанию равно 0 что означает отсутствие определенного разделителя столбцов.
type: docs
weight: 20
...
Указывает символ, который должен интерпретироваться как разделитель столбцов, используемый для разделения столбцов во внешних источниках данных. Значение по умолчанию равно 0, что означает отсутствие определенного разделителя столбцов.
...
RK Я никогда не видел этого в использовании.
