...
| --- | --- | --- |
| NewDocument | `0` | Указывает, что соответствующие хост-приложения должны генерировать новые документы, заполняя поля в заданном документе данными из указанного внешнего источника данных. |
...
| Email | `2` | Указывает, что соответствующие приложения хостинга должны генерировать электронные письма с использованием документов, полученных в результате заполнения полей в данном документе данными из указанных внешних данных. источник. |
| Fax | `4` | Указывает, что соответствующие приложения хостинга должны генерировать факсы, используя документы, полученные в результате заполнения полей в данном документе данными из указанных внешних данных источник. |
| Default | `0` | Равен значениюNewDocument. |
