...
| --- | --- | --- |
| NewDocument | `0` | Указывает, что соответствующие хост-приложения должны создавать новые документы, заполняя поля в данном документе данными из указанного внешнего источника данных. |
| Printer | `1` | Указывает, что соответствующие хост-приложения должны печатать документы, полученные в результате заполнения полей в данном документе внешними данными из указанного внешнего источника данных. |
| Email | `2` | Указывает, что соответствующие хост-приложения должны генерировать электронные письма, используя документы, полученные в результате , заполняя поля в данном документе данными из указанного внешнего источника данных. |
