...
description: Откройте для себя свойство FileFontSource CacheKey — ваш ключ к эффективному управлению шрифтами и оптимизированному кэшированию для повышения производительности.
type: docs
weight: 20
...
Если ключ не указан, то[`FilePath`](../filepath/) будет использоваться как ключ.
