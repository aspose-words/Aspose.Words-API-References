...
description: Переопределить замещающие имена шрифтов для данного оригинального имени шрифта.
type: docs
weight: 80
...
Переопределить замещающие имена шрифтов для данного оригинального имени шрифта.
...
| substituteFontNames | String[] | Список альтернативных имен шрифтов. |
