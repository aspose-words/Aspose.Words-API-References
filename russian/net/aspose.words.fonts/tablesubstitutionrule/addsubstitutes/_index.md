...
description: Улучшите свою типографику с помощью метода TableSubstitutionRule AddSubstitutes, позволяющего легко интегрировать замещающие шрифты для любого исходного шрифта.
type: docs
weight: 10
...
Добавляет заменяющие имена шрифтов для указанного исходного имени шрифта.
