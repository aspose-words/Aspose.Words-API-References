...
description: Aspose.Words.Fonts.FontSourceBase сорт. Это абстрактный базовый класс для классов которые позволяют пользователю указывать различные источники шрифтов на С#.
type: docs
weight: 2980
