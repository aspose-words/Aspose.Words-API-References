...
description: Шаг указывает является ли шрифт фиксированным шагом с пропорциональным интервалом или зависит от настройки по умолчанию.
type: docs
weight: 70
...
Шаг указывает, является ли шрифт фиксированным шагом, с пропорциональным интервалом или зависит от настройки по умолчанию.
