...
| Roman | `1` | Определяет пропорциональный шрифт с засечками. Пример: Times New Roman. |
...
| Script | `4` | Задает шрифт, похожий на рукописный; примеры включают Script и Cursive. |
| Decorative | `5` | Определяет новый шрифт. Примером является древнеанглийский. |
