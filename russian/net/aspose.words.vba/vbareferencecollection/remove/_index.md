...
description: VbaReferenceCollection метод. Удаляет первое вхождение указанного элемента VbaReference из коллекции.
type: docs
weight: 30
...
Удаляет первое вхождение указанного элемента VbaReference из коллекции.
