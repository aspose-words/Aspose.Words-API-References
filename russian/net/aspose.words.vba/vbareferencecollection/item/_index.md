...
description: Легко получить доступ к объекту VbaReference с помощью свойства Item. Эффективно извлекайте ссылки по индексу для упрощенной разработки VBA.
type: docs
weight: 20
...
| Параметр | Описание |
| --- | --- |
| index | Отсчитываемый от нуля индекс ссылки, которую необходимо получить. |
