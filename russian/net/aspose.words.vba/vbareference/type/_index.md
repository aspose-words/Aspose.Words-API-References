...
description: Откройте для себя свойство VbaReference Type, чтобы эффективно определять и использовать объекты VbaReferenceType, повышая эффективность программирования на VBA.
type: docs
weight: 20
...
Получает[`VbaReferenceType`](../../vbareferencetype/) объект, который указывает тип ссылки, которую[`VbaReference`](../) объект представляет.
