...
description: Когда false небольшие метафайлы не сжимаются по соображениям производительности. Значение по умолчанию true  все метафайлы сжимаются независимо от их размера.
type: docs
weight: 20
...
```csharp
 // Открытие документа, содержащего формулу Microsoft Equation 3.0.
