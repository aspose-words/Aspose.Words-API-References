...
description: Управляйте сохранением частей документа с помощью DocumentPartSavingCallback HtmlSaveOptions. Оптимизируйте экспорт HTML или EPUB для бесперебойного взаимодействия с пользователем.
type: docs
weight: 70
...
Позволяет контролировать, как сохраняются части документа при сохранении документа в формате HTML или EPUB.
