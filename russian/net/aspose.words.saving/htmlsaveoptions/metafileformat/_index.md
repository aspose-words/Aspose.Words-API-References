...
description: HtmlSaveOptions свойство. Указывает в каком формате сохраняются метафайлы при экспорте в HTML MHTML или EPUB. Значение по умолчаниюPng  что означает что метафайлы преобразуются в растровые изображения PNG.
type: docs
weight: 390
