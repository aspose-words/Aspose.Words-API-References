...
description: HtmlSaveOptions свойство. Управляет тем какие ресурсы шрифтов необходимо подмножество при сохранении в HTML MHTML или EPUB. Значение по умолчанию0 .
type: docs
weight: 290
