...
description: HtmlSaveOptions ExportFontsAsBase64 свойство. Указывает должны ли ресурсы шрифтов быть встроены в HTML в кодировке Base64. Значение по умолчаниюЛОЖЬ  на С#.
type: docs
weight: 150
