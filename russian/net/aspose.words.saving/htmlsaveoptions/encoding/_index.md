...
description: Указывает кодировку используемую при экспорте в HTML MHTML или EPUB. Значение по умолчаниюновое кодирование UTF8 ложь UTF8 без спецификации.
type: docs
weight: 100
