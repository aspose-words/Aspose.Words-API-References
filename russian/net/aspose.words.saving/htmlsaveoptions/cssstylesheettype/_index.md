...
description: Указывает как стили CSS каскадные таблицы стилей экспортируются в HTML MHTML или EPUB. Значение по умолчаниюInline для HTML/MHTML и External для EPUB.
type: docs
weight: 60
