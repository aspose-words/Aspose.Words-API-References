...
description: Управляйте сохранением изображений с помощью HtmlSaveOptions' ImageSavingCallback. Оптимизируйте экспорт документов в HTML, MHTML или EPUB для бесперебойной работы пользователя.
type: docs
weight: 350
...
Позволяет контролировать способ сохранения изображений при сохранении документа в формате HTML, MHTML или EPUB.
