...
description: HtmlSaveOptions OfficeMathOutputMode свойство. Управляет экспортом объектов OfficeMath в HTML MHTML или EPUB. Значение по умолчаниюImage  на С#.
type: docs
weight: 400
