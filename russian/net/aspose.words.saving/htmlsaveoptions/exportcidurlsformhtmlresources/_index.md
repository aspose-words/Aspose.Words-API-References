...
description: Указывает следует ли использовать URLадреса CID ContentID для ссылок на ресурсы изображения шрифты CSS включенные в документы MHTML . Значение по умолчаниюЛОЖЬ .
type: docs
weight: 120
