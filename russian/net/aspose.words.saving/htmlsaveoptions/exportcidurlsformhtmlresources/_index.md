...
description: Указывает следует ли использовать URL-адреса CID Content-ID для ссылок на ресурсы изображения шрифты CSS включенные в документы MHTML . Значение по умолчаниюЛОЖЬ .
type: docs
weight: 120
