...
description: Указывает нормализуются ли отрицательные левый и правый отступы абзацев при сохранении в HTML MHTML или EPUB. Значение по умолчанию false .
type: docs
weight: 20
...
Указывает, нормализуются ли отрицательные левый и правый отступы абзацев при сохранении в HTML, MHTML или EPUB. Значение по умолчанию:` false` .
...
Если отрицательный отступ не разрешен, он экспортируется как нулевое поле в HTML. Если разрешен отрицательный отступ, абзац может оказаться частично за пределами окна браузера .
