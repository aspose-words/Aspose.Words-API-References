...
description: Указывает записывать ли информацию о пути туда и обратно при сохранении в HTML MHTML или EPUB. Значение по умолчаниюистинный для HTML иЛОЖЬ для MHTML и EPUB.
type: docs
weight: 250
