...
description: HtmlSaveOptions свойство. Указывает записывать ли информацию о пути туда и обратно при сохранении в HTML MHTML или EPUB. Значение по умолчаниюистинный для HTML иЛОЖЬ для MHTML и EPUB.
type: docs
weight: 250
...
Указывает, записывать ли информацию о пути туда и обратно при сохранении в HTML, MHTML или EPUB. Значение по умолчанию:`истинный` для HTML и`ЛОЖЬ` для MHTML и EPUB.
...
Сохранение информации об обходе позволяет восстанавливать свойства документа, такие как позиции табуляции, комментарии, верхние и нижние колонтитулы, во время загрузки HTML-документов обратно в[`Document`](../../../aspose.words/document/) объект.

Когда`истинный`, информация о циклическом обходе экспортируется как -aw-* CSS properties соответствующих HTML-элементов.

Когда`ЛОЖЬ`, приводит к тому, что информация о циклическом обходе не выводится в создаваемые файлы.
