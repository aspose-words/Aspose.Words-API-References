...
description: Задает максимальный уровень заголовков на котором можно разделить документ. Значение по умолчанию 2 .
type: docs
weight: 90
...
Задает максимальный уровень заголовков, на котором можно разделить документ. Значение по умолчанию:` 2` .
...
По умолчанию только **Заголовок 1** и **Заголовок 2** абзацев приводят к разделению документа. Установка этого свойства в ноль приведет к тому, что документ вообще не будет разбиваться на абзацы заголовков.

### Примеры

Показывает, как разбить выходной HTML-документ по заголовкам на несколько частей.
