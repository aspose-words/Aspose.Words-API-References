...
description: Указывает максимальный уровень заголовков заполняемых навигационной картой при экспорте в формат IDPF EPUB. Значение по умолчанию 3 .
type: docs
weight: 110
...
Навигационная карта в формате IDPF EPUB позволяет агентам пользователя обеспечивать простой способ навигации через структуру документа. Обычно точки навигации соответствуют заголовкам в документе. Для заполнения заголовков до уровня **N** присвойте это значение`EpubNavigationMapLevel`.

По умолчанию заполняются три уровня заголовков:абзацы стилей **Заголовок 1** , **Заголовок 2** и **Заголовок 3** . Вы можете установить для этого свойства значение от 1 до 9, чтобы запросить соответствующий максимальный уровень. Установка его в ноль уменьшит карту навигации только до корня документа или корней частей документа.
