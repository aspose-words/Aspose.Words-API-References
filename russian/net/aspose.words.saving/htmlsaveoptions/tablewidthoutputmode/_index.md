...
description: HtmlSaveOptions TableWidthOutputMode свойство. Управляет экспортом ширины таблицы строк и ячеек в HTML MHTML или EPUB. Значение по умолчаниюAll  на С#.
type: docs
weight: 460
