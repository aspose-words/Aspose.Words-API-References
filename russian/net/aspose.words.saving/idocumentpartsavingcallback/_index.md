...
description: Управляйте сохранением документов с помощью Aspose.Words.Saving.IDocumentPartSavingCallback. Получайте уведомления и настраивайте экспорт в HTML или EPUB без особых усилий.
type: docs
weight: 5890
