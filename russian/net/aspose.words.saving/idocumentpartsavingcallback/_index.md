...
description: Реализуйте этот интерфейс если вы хотите получать уведомления и управлять тем как Aspose.Words сохраняет части документа при экспорте документа вФорматFAspose.Words.SaveFormat.Html илиEpub.
type: docs
weight: 4830
...
Реализуйте этот интерфейс, если вы хотите получать уведомления и управлять тем, как Aspose.Words сохраняет части документа при экспорте документа вФорматF:Aspose.Words.SaveFormat.Html илиEpub.
