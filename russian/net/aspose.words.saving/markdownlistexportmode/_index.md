...
description: Aspose.Words.Saving.MarkdownListExportMode перечисление. Указывает как списки экспортируются в Markdown на С#.
type: docs
weight: 5270
...
| PlainText | `1` | Экспортировать элементы списка в виде обычного текста. |
