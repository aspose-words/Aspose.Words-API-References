...
description: OdtSaveOptions свойство. Позволяет указать единицы измерения для применения к содержимому документа. Значение по умолчаниюCentimeters
type: docs
weight: 30
...
Open Office использует сантиметры при указании длины, ширины и других измеримых свойств форматирования и содержимого в документах, тогда как MS Office использует дюймы.
