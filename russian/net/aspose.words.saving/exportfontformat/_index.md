...
description: Aspose.Words.Saving.ExportFontFormat перечисление. Указывает формат который используется для экспорта шрифтов при рендеринге в фиксированный формат HTML на С#.
type: docs
weight: 4990
