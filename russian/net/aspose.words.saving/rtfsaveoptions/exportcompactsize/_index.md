...
description: Позволяет уменьшить размер выходных RTFдокументов но если они содержат RTL справа налево текст он не будет отображаться корректно. Значение по умолчаниюЛОЖЬ .
type: docs
weight: 20
