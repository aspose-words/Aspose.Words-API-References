...
description: Aspose.Words.Saving.RtfSaveOptions сорт. Может использоваться для указания дополнительных параметров при сохранении документа вRtf формат на С#.
type: docs
weight: 5570
