...
description: Указывает сколько уровней заголовков абзацев отформатированных с помощью стилей заголовков включать в структуру документа .
type: docs
weight: 70
...
Указывает, сколько уровней заголовков (абзацев, отформатированных с помощью стилей заголовков) включать в структуру документа .
...
Укажите 0, если нет заголовков в структуре; указать 1 для одного уровня заголовков в структуре и т.д.
