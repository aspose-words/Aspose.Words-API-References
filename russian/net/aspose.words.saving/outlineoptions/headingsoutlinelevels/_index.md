...
description: Откройте для себя свойство HeadingsOutlineLevels в OutlineOptions. Управляйте уровнями заголовков для структурированных документов и улучшайте навигацию с легкостью.
type: docs
weight: 70
...
Указывает, сколько уровней заголовков (абзацев, отформатированных с использованием стилей заголовков) следует включить в структуру документа .
...
Укажите 0, если в структуре нет заголовков; укажите 1, если в структуре есть один уровень заголовков и т. д.
