...
description: Откройте для себя свойство BookmarksOutlineLevels в OutlineOptions, чтобы настроить иерархию закладок для улучшенной навигации и удобства пользователя.
type: docs
weight: 20
...
Позволяет указать индивидуальный уровень структуры закладок.
