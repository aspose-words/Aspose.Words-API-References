...
description: OutlineOptions свойство. Указывает сколько уровней в структуре документа должно отображаться в расширенном виде при просмотре файла.
type: docs
weight: 60
...
Указывает, сколько уровней в структуре документа должно отображаться в расширенном виде при просмотре файла.
...
Укажите 0, и структура документа будет свернута; укажите 1 и элементы первого уровня в структуре будут расширены и так далее.
