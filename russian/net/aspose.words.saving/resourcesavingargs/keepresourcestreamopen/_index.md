...
По умолчанию:` false` и Aspose.Words закроет предоставленный вами поток в свойстве[`ResourceStream`](../resourcestream)после записи в него ресурса. Укажите` true` , чтобы поток оставался открытым.
