...
description: Указывает следует ли встраивать изображения в документ SVG в формате base64. Обратите внимание что установка этого флага может значительно увеличить размер выходного файла SVG.
type: docs
weight: 20
