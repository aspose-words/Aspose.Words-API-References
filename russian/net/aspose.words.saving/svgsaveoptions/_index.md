...
description: Aspose.Words.Saving.SvgSaveOptions сорт. Может использоваться для указания дополнительных параметров при сохранении документа вSvg формат на С#.
type: docs
weight: 5600
