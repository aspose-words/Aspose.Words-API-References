...
description: Реализуйте этот интерфейс если вы хотите управлять тем как Aspose.Words сохраняет отдельные страницы при сохранении документа в фиксированных форматах страниц.
type: docs
weight: 4920
