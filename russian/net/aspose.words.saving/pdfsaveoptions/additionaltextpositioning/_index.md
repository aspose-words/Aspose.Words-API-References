...
Если` true` дополнительные операторы позиционирования текста записываются в выходной PDF. Это может помочь преодолеть проблемы с неточным позиционированием текста на некоторых принтерах. Недостатком является увеличенный размер PDF-документа.
