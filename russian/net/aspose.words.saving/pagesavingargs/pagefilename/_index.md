...
description: Получает или задает имя файла в котором будет сохранена страница документа.
type: docs
weight: 30
...
Если не указано, то имя файла страницы и путь будут сгенерированы автоматически, используя исходное имя файла.
