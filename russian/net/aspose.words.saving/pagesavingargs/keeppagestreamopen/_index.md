...
description: Указывает должен ли Aspose.Words оставить поток открытым или закрыть его после сохранения страницы документа.
type: docs
weight: 20
...
По умолчанию:` false` и Aspose.Words закроет предоставленный вами поток в свойстве[`PageStream`](../pagestream)после записи в него страницы документа. Укажите` true` , чтобы поток оставался открытым.

### Примеры

Показывает, как использовать обратный вызов для сохранить документ в формате HTML страница за страницей.
