...
description: Откройте для себя свойство XamlFixedSaveOptions SaveFormat, позволяющее легко сохранять документы в формате XamlFixed, обеспечивая оптимальное качество и совместимость.
type: docs
weight: 50
