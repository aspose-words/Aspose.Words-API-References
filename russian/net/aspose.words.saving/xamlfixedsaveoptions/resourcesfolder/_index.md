...
description: Указывает физическую папку в которой сохраняются ресурсы изображения и шрифты при экспорте документа в формат фиксированной страницы Xaml. Значение по умолчаниюнулевой .
type: docs
weight: 30
