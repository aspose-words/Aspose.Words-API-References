...
description: XamlFixedSaveOptions свойство. Позволяет управлять сохранением ресурсов изображений и шрифтов при экспорте документа в фиксированный формат страницы Xaml.
type: docs
weight: 20
...
Позволяет управлять сохранением ресурсов (изображений и шрифтов) при экспорте документа в фиксированный формат страницы Xaml.
