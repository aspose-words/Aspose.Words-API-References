...
description: Предоставляет данные дляImageSaving./iimagesavingcallback/imagesaving/ событие.
type: docs
weight: 4980
...
[`ImageSavingArgs`](./imagesavingargs/) позволяет переопределить, как генерируются имена файлов изображений, или полностью обойти сохранение изображений в файлы, предоставив свои собственные потоковые объекты.
