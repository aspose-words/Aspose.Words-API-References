...
Значение по умолчанию:` null` . Когда это свойство равно` null` , изображение будет сохранено в файл, указанный вWordsсвойство.

Используя[`IImageSavingCallback`](../../iimagesavingcallback)вы не можете заменить одно изображение другим. Он предназначен только для контроля над местом сохранения изображений.
