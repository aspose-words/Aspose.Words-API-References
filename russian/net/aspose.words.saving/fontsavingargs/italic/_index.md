...
description: Откройте для себя свойство FontSavingArgs Italic, которое позволит легко проверить, выделен ли ваш шрифт курсивом, что повысит гибкость стиля текста и дизайна.
type: docs
weight: 80
