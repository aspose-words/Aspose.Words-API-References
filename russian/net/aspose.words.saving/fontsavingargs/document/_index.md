...
description: Откройте для себя свойство FontSavingArgs для доступа к объекту документа во время операций сохранения, что повысит эффективность управления документами.
type: docs
weight: 20
