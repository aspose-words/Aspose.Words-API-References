...
description: FontSavingArgs свойство. Позволяет указать будет ли текущий шрифт подмножаться перед экспортом в качестве ресурса шрифта.
type: docs
weight: 70
...
По умолчанию Aspose.Words решает, выполнять подмножество или нет, сравнивая исходный размер файла шрифта с размером, указанным в[`FontResourcesSubsettingSizeThreshold`](../../htmlsaveoptions/fontresourcessubsettingsizethreshold/) . Вы можете переопределить это поведение для отдельных шрифтов, установив`IsSubsettingNeeded` имущество.
