...
description: Позволяет указать поток в который будет сохранен шрифт.
type: docs
weight: 50
...
Значение по умолчанию:` null` . Когда это свойство равно` null` , шрифт будет сохранен в файл, указанный вWordsсвойство.
