...
description: Откройте для себя свойство FontSavingArgs IsExportNeeded для управления экспортом ресурсов шрифтов. Максимизируйте эффективность с помощью настраиваемых параметров для ваших проектов!
type: docs
weight: 60
