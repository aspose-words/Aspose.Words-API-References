...
description: Откройте для себя свойство FontSavingArgs Bold, чтобы легко определить, является ли ваш шрифт жирным. Улучшите типографику для лучшей читаемости и дизайна.
type: docs
weight: 10
