...
[`FontSavingArgs`](./fontsavingargs/) определяет, следует ли экспортировать конкретный ресурс шрифта и каким образом.

[`FontSavingArgs`](./fontsavingargs/)также позволяет переопределить, как генерируются имена файлов шрифтов, или полностью обойти сохранение шрифтов в файлы, предоставив свои собственные потоковые объекты.
