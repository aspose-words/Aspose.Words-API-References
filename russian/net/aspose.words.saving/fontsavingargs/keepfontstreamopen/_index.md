...
description: Узнайте, как свойство KeepFontStreamOpen в FontSavingArgs позволяет Aspose.Words эффективно управлять потоками шрифтов, улучшая процесс обработки документов.
type: docs
weight: 90
...
Указывает, должен ли Aspose.Words держать поток открытым или закрыть его после сохранения шрифта.
...
По умолчанию`ЛОЖЬ` и Aspose.Words закроет предоставленный вами поток в[`FontStream`](../fontstream/) свойство после записи в него шрифта. Укажите`истинный` чтобы поток оставался открытым.
