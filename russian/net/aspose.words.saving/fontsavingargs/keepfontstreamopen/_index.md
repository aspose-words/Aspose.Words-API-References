...
description: FontSavingArgs свойство. Указывает должен ли Aspose.Words оставить поток открытым или закрыть его после сохранения шрифта.
type: docs
weight: 90
...
По умолчанию`ЛОЖЬ` и Aspose.Words закроет предоставленный вами поток в[`FontStream`](../fontstream/) свойство после записи в него шрифта. Указать`истинный` чтобы поток оставался открытым.
