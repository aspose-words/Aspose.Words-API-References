...
description: Aspose.Words.Saving.XlsxSaveOptions сорт. Может использоваться для указания дополнительных параметров при сохранении документа вXlsx формат.
type: docs
weight: 5710
