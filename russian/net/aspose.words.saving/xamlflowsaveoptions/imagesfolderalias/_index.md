...
description: XamlFlowSaveOptions свойство. Указывает имя папки используемой для создания URI изображений записанных в документ XAML. По умолчанию  пустая строка.
type: docs
weight: 40
