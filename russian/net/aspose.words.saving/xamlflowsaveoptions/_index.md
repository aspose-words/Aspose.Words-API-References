...
description: Aspose.Words.Saving.XamlFlowSaveOptions сорт. Может использоваться для указания дополнительных параметров при сохранении документа в папку .XamlFlow или жеXamlFlowPack формат.
type: docs
weight: 5420
