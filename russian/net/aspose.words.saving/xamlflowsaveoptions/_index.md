...
description: Aspose.Words.Saving.XamlFlowSaveOptions сорт. Может использоваться для указания дополнительных параметров при сохранении документа в .XamlFlow илиXamlFlowPack формат.
type: docs
weight: 5700
