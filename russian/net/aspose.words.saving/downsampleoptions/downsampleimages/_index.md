...
description: Узнайте, как свойство DownsampleImages оптимизирует качество изображения, управляя понижением разрешения для повышения производительности и сокращения времени загрузки.
type: docs
weight: 20
