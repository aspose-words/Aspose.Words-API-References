...
description: Aspose.Words.Saving.DmlEffectsRenderingMode перечисление. Указывает как эффекты DrawingML отображаются в фиксированных форматах страниц на С#.
type: docs
weight: 4910
