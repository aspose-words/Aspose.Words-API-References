...
description: Откройте для себя свойство DocumentPartSavingArgs для доступа к объекту документа и управления им в процессе сохранения, что повысит эффективность вашего рабочего процесса.
type: docs
weight: 10
