...
Учебный класс`DocumentPartSavingArgs` позволяет вам контролировать, как каждая часть документа будет сохранена. Позволяет переопределить способ генерации имен файлов или полностью обойти сохранение частей документа в файлы , предоставив собственные объекты потока.
