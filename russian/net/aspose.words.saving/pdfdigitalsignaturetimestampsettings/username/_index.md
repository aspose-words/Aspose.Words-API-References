...
description: Откройте для себя свойство PdfDigitalSignatureTimestampSettings UserName для безопасного временного штампа. Улучшите целостность вашего документа с помощью надежной аутентификации сервера.
type: docs
weight: 50
...
Имя пользователя сервера временных меток.
