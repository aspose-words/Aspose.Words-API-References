...
description: Aspose.Words.Saving.TxtSaveOptionsBase сорт. Базовый класс для указания дополнительных параметров при сохранении документа в текстовых форматах.
type: docs
weight: 5670
