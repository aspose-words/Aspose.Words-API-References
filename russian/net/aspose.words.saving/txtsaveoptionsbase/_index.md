...
description: Базовый класс для указания дополнительных опций при сохранении документа в текстовые форматы.
type: docs
weight: 5340
...
Базовый класс для указания дополнительных опций при сохранении документа в текстовые форматы.
