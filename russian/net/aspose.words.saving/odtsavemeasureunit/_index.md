...
description: Aspose.Words.Saving.OdtSaveMeasureUnit перечисление. Указанные единицы измерения применяемые к измеряемому содержимому документа например форме ширине и т. д. во время сохранения.
type: docs
weight: 5320
