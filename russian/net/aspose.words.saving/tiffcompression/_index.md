...
description: Aspose.Words.Saving.TiffCompression перечисление. Указывает какой тип сжатия следует применять при сохранении изображений страниц в файл TIFF.
type: docs
weight: 5350
