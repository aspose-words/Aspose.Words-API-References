...
description: HtmlFixedSaveOptions свойство. Флаг указывает требуется ли оптимизация вывода. этому свойству присвоено значение true. Значение по умолчанию  true.
type: docs
weight: 100
