...
description: HtmlFixedSaveOptions свойство. Позволяет управлять сохранением ресурсов изображений шрифтов и css при экспорте документа в фиксированный формат страницы Html.
type: docs
weight: 130
