...
description: Указывает следует ли встраивать изображения в HTMLдокумент в формате Base64. Обратите внимание что установка этого флага может значительно увеличить размер выходного HTMLфайла.
type: docs
weight: 60
