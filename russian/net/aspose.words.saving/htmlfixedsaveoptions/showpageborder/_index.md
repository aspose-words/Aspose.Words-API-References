...
description: Откройте для себя свойство HtmlFixedSaveOptions ShowPageBorder, легко управляйте границами страниц. Улучшите внешний вид вашего документа с помощью настраиваемых параметров.
type: docs
weight: 200
...
Указывает, следует ли отображать границу вокруг страниц. Значение по умолчанию:`истинный` .
