...
description: HtmlFixedSaveOptions ResourcesFolderAlias свойство. Указывает имя папки используемой для создания URI изображений записанных в HTMLдокумент. Значение по умолчаниюнулевой  на С#.
type: docs
weight: 150
