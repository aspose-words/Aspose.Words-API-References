...
description: Отслеживайте ход выполнения DocumentSavingArgs с легкостью с помощью свойства EstimatedProgress, предоставляя процентные обновления в режиме реального времени для повышения эффективности.
type: docs
weight: 10
