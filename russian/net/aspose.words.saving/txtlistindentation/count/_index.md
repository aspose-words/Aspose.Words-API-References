...
description: TxtListIndentation свойство. Получает или устанавливает количествоCharacter для использования в качестве отступа на один уровень списка. Значение по умолчанию равно 0 что означает отсутствие отступа.
type: docs
weight: 30
