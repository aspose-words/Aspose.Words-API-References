...
description: Откройте для себя Aspose.Words.Saving.XpsSaveOptions для улучшенного сохранения документов в формате XPS. Настройте параметры для оптимального вывода и качества.
type: docs
weight: 6540
...
| [XpsSaveOptions](xpssaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа вXps илиOpenXps формат. |
...
| [DigitalSignatureDetails](../../aspose.words.saving/xpssaveoptions/digitalsignaturedetails/) { get; set; } | Получает или устанавливает[`DigitalSignatureDetails`](../digitalsignaturedetails/) объект, используемый для подписи документа. |
...
| [UseBookFoldPrintingSettings](../../aspose.words.saving/xpssaveoptions/usebookfoldprintingsettings/) { get; set; } | Возвращает или задает логическое значение, указывающее, следует ли сохранять документ с использованием макета печати буклета, , если он указан через[`MultiplePages`](../../aspose.words/pagesetup/multiplepages/) . |
