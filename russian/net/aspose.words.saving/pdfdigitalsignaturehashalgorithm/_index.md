...
description: Aspose.Words.Saving.PdfDigitalSignatureHashAlgorithm перечисление. Определяет алгоритм цифрового хеширования используемый цифровой подписью.
type: docs
weight: 5160
