...
description: Указывает пароль пользователя необходимый для открытия зашифрованного PDF-документа.
type: docs
weight: 40
...
Для открытия зашифрованного документа PDF для просмотра потребуется пароль пользователя. Разрешения, указанные в [`Permissions`](../permissions), будут применяться программой чтения.
