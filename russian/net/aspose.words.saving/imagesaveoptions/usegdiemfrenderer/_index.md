...
description: Получает или задает значение определяющее следует ли использовать средство визуализации метафайлов GDI или Aspose.Words при сохранении в EMF.
type: docs
weight: 180
