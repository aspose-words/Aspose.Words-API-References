...
description: Получает или задает пороговое значение определяющее значение ошибки бинаризации в методе ФлойдаСтейнберга. приImageBinarizationMethodaspose.words.saving/imagebinarizationmethod/ это ImageBinarizationMethod.FloydSteinbergDithering.
type: docs
weight: 150
