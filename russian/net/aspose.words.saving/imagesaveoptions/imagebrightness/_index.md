...
description: Легко настраивайте яркость изображений с помощью свойства ImageSaveOptions. Улучшайте визуальные эффекты для получения потрясающих результатов!
type: docs
weight: 40
...
Получает или задает яркость для созданных изображений.
