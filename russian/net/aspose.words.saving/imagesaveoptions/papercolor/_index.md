...
description: Получает или задает цвет фона бумаги для сгенерированных изображений.
type: docs
weight: 100
...
При рендеринге страниц документа, который указывает собственный цвет фона, тогда цвет фона документа переопределит цвет, заданный этим свойством.
