...
description: Получает или задает вертикальное разрешение для сгенерированных изображений в точках на дюйм.
type: docs
weight: 190
...
Это свойство действует только при сохранении в растровые форматы изображения и влияет на выходной размер в пикселях.

Значение по умолчанию:96.

### Примеры

Показывает, как редактировать изображение, в то время как Aspose.Words преобразует документ в один.
