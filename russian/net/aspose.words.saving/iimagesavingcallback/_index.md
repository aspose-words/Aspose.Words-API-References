...
description: Aspose.Words.Saving.IImageSavingCallback интерфейс. Реализуйте этот интерфейс если вы хотите управлять тем как Aspose.Words сохраняет изображения при сохранении документа в HTML. Может использоваться другими форматами.
type: docs
weight: 4910
...
| Имя | Описание |
| --- | --- |
| [ImageSaving](../../aspose.words.saving/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | Вызывается, когда Aspose.Words сохраняет изображение в формате HTML. |
...
```csharp
{
    ...
    // Если мы преобразуем документ, содержащий изображения, в формат Markdown, мы получим один файл Markdown, который ссылается на несколько изображений.
