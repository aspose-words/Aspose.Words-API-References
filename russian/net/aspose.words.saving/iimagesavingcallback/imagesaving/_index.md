...
description: IImageSavingCallback метод. Вызывается когда Aspose.Words сохраняет изображение в формате HTML.
type: docs
weight: 10
url: /ru/net/aspose.words.saving/iimagesavingcallback/imagesaving/
---
## IImageSavingCallback.ImageSaving method

Вызывается, когда Aspose.Words сохраняет изображение в формате HTML.
...
* пространство имен [Aspose.Words.Saving](../../iimagesavingcallback/)
* сборка [Aspose.Words](../../../)
