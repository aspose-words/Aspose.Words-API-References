...
Когда для этого значения установлено значение` true` , Aspose.Words эмулирует растровые операции. Полученный результат может быть частично растрирован, и производительность может быть ниже.
...
Шоу добавлен резервный вариант рендеринга растрового изображения и изменен тип предупреждений о неподдерживаемых записях метафайла.
