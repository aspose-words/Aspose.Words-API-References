...
EMF+ Двойные метафайлы содержат части EMF+ и EMF. MS Word и GDI+ всегда отображают часть EMF+. Aspose.Words в настоящее время не полностью поддерживает все записи EMF+, и в некоторых случаях результат рендеринга части EMF выглядит лучше, чем результат рендеринга части EMF+.

Эта опция используется только тогда, когда метафайл визуализируется как векторная графика. При рендеринге метафайла в растровое изображение всегда используется часть EMF+.
