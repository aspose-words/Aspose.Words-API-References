...
description: Вызывается когда Aspose.Words сохраняет внешний ресурс в формате HTML или SVG с фиксированной страницей.
type: docs
weight: 10
...
Вызывается, когда Aspose.Words сохраняет внешний ресурс в формате HTML или SVG с фиксированной страницей.
...
* пространство имен [Aspose.Words.Saving](../../iresourcesavingcallback)
* сборка [Aspose.Words](../../../)
