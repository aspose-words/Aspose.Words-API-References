...
description: Реализуйте этот интерфейс если вы хотите контролировать как Aspose.Words сохраняет внешние ресурсы изображения шрифты и css при сохранении документа на фиксированную страницу HTML или SVG.
type: docs
weight: 4930
