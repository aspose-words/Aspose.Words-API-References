...
description: Указывает как документ разбивается на части при сохранении вHtml илиEpub формат.
type: docs
weight: 4700
...
[`DocumentSplitCriteria`](./documentsplitcriteria/)представляет собой набор флагов, которые можно комбинировать. Например, вы можете разделить document на разрывы страниц и абзацы заголовков в одной и той же операции экспорта.
