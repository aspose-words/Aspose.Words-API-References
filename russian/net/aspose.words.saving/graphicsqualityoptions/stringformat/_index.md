...
description: GraphicsQualityOptions свойство. Получает или задает информацию о макете текста например выравнивание ориентация и позиции табуляции операции отображения например вставка многоточия и замена национальных цифр и функции OpenType.
type: docs
weight: 60
