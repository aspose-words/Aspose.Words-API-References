...
Значение по умолчанию:` null` . Это свойство не препятствует сохранению информации CSS в файл или внедрению в HTML-документ. Чтобы запретить экспорт CSS, используйте свойство[`IsExportNeeded`](../isexportneeded).

Используя[`ICssSavingCallback`](../../icsssavingcallback)вы не можете заменить CSS на другой. Он предназначен только для сохранения CSS в поток.
