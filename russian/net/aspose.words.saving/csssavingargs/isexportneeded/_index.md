...
description: Позволяет указать будет ли CSS экспортироваться в файл и внедряться в HTML-документ. Значение по умолчанию true . Когда это свойство равно false  информация CSS не будет сохранена в файле CSS и не будет встроена в документ HTML.
type: docs
weight: 30
...
Позволяет указать, будет ли CSS экспортироваться в файл и внедряться в HTML-документ. Значение по умолчанию:` true` . Когда это свойство равно` false` , информация CSS не будет сохранена в файле CSS и не будет встроена в документ HTML.
