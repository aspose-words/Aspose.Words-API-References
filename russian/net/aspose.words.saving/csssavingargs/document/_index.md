...
description: Откройте для себя свойство CssSavingArgs Document для доступа к текущему сохраняемому документу, что повысит эффективность рабочего процесса и управления документами.
type: docs
weight: 20
