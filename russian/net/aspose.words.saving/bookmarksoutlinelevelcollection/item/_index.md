...
description: Получает или устанавливает уровень структуры закладки по имени закладки.
type: docs
weight: 30
...
Получает или устанавливает уровень структуры закладки по имени закладки.
