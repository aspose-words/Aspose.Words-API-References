...
description: Откройте для себя метод BookmarksOutlineLevelCollection IndexOfKey, который эффективно извлекает отсчитываемый от нуля индекс указанной закладки в вашей коллекции.
type: docs
weight: 80
...
Возвращает индекс указанной закладки в коллекции (начиная с нуля).
