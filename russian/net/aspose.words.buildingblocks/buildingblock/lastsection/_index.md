...
description: Откройте для себя свойство LastSection класса BuildingBlock, которое эффективно извлекает последний раздел, улучшая ваш опыт кодирования и организацию проекта.
type: docs
weight: 80
url: /ru/net/aspose.words.buildingblocks/buildingblock/lastsection/
---
## BuildingBlock.LastSection property

Получает последний раздел в строительном блоке.
