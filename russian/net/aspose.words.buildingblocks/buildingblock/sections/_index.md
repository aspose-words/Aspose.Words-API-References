...
description: BuildingBlock свойство. Возвращает коллекцию представляющую все разделы в стандартном блоке.
type: docs
weight: 110
...
Возвращает коллекцию, представляющую все разделы в стандартном блоке.
