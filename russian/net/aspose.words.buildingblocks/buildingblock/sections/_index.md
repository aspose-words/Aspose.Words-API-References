...
description: Откройте для себя разделы BuildingBlock. Легко получайте доступ и управляйте всеми разделами в вашем строительном блоке для упрощения организации и повышения эффективности.
type: docs
weight: 110
url: /ru/net/aspose.words.buildingblocks/buildingblock/sections/
---
## BuildingBlock.Sections property

Возвращает коллекцию, которая представляет все разделы в строительном блоке.
