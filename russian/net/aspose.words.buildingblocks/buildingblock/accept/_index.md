...
Примечание. Узел стандартного блока и его дочерние элементы не посещаются при выполнении a Visitor над[`Document`](../../../aspose.words/document/) Если вы хотите выполнить посетителя над строительным блоком , вам нужно выполнить посетителя над[`GlossaryDocument`](../../glossarydocument/) или звонок`Accept` .
