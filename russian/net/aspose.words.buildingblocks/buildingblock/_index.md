...
description: Aspose.Words.BuildingBlocks.BuildingBlock сорт. Представляет запись документа глоссария такую как стандартный блок автотекст или запись автозамены на С#.
type: docs
weight: 130
