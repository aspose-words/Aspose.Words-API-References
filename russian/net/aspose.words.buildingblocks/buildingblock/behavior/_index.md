...
description: Узнайте, как BuildingBlock Behavior улучшает ваш документ, определяя методы вставки контента для бесшовной интеграции и улучшения рабочего процесса.
type: docs
weight: 20
...
Указывает поведение, которое должно применяться при вставке содержимого строительного блока в основной документ.
