...
description: Откройте для себя BuildingBlock FirstSection. Легко получайте доступ к первому разделу вашего строительного блока для упрощения организации и повышения эффективности.
type: docs
weight: 50
...
Получает первый раздел в строительном блоке.
