...
description: BuildingBlock свойство. Получает или задает идентификатор 128битный GUID однозначно идентифицирующий этот строительный блок.
type: docs
weight: 70
...
Получает или задает идентификатор (128-битный GUID), однозначно идентифицирующий этот строительный блок.
...
Может использоваться приложением для уникальной ссылки на строительный блок независимо от отличных имен из-за локализации.
