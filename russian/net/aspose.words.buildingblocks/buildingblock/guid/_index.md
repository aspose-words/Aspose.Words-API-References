...
description: Получает или задает идентификатор 128-разрядный GUID однозначно идентифицирующий этот стандартный блок.
type: docs
weight: 70
...
Получает или задает идентификатор (128-разрядный GUID), однозначно идентифицирующий этот стандартный блок.
...
Может использоваться приложением для уникальной ссылки на стандартный блок независимо от другое название из-за локализации.

Соответствует элементу **docPartPr.guid** в OOXML.
