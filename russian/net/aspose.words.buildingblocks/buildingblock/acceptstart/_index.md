...
description: Откройте для себя метод BuildingBlock AcceptStart, приветствуйте посетителей и улучшайте их впечатления с момента прибытия.
type: docs
weight: 150
url: /ru/net/aspose.words.buildingblocks/buildingblock/acceptstart/
---
## BuildingBlock.AcceptStart method

Принимает посетителя для посещения начала BuildingBlock.
