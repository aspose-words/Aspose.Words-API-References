...
description: BuildingBlock свойство. Задает категоризацию второго уровня для стандартного блока.
type: docs
weight: 30
...
Задает категоризацию второго уровня для стандартного блока.
...
Стандартные блоки в пользовательском интерфейсе Microsoft Word организованы в Галереи. Каждый[`Gallery`](../gallery/) может иметь несколько категорий. Каждый блок внутри a`Category` имеет[`Name`](../name/).
