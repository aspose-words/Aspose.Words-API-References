...
description: Откройте для себя наши свойства категории BuildingBlock для улучшенной категоризации второго уровня, оптимизации ваших проектов и повышения эффективности организации.
type: docs
weight: 30
...
Указывает категоризацию второго уровня для строительного блока.
...
Строительные блоки в пользовательском интерфейсе Microsoft Word организованы в Галереи. Каждая[`Gallery`](../gallery/) может иметь несколько категорий. Каждый блок within a`Category` имеет[`Name`](../name/).
