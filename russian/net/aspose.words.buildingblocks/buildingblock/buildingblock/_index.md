...
Когда[`BuildingBlock`](../../buildingblock) создан, он принадлежит указанному документу глоссария, , но еще не является частью документа глоссария и[`ParentNode`](../../../aspose.words/node/parentnode) является`нулевой`.

Чтобы добавить[`BuildingBlock`](../../buildingblock) к[`GlossaryDocument`](../../glossarydocument) используйте [`AppendChild`](../../../aspose.words/compositenode/appendchild).
