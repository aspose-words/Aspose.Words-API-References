...
Когда[`BuildingBlock`](../../buildingblock)создан, он принадлежит указанному документу глоссария, но еще не является частью документа глоссария и[`ParentNode`](../../../aspose.words/node/parentnode)is` null` .

Чтобы добавить[`BuildingBlock`](../../buildingblock)кГлоссарийДокументuse [`AppendChild`](../../../aspose.words/compositenode/appendchild).
