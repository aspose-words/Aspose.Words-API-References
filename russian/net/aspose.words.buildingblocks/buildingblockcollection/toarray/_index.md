...
description: Откройте для себя метод BuildingBlockCollection ToArray, который позволяет легко переносить все строительные блоки в новый массив для оптимизированного управления данными.
type: docs
weight: 20
