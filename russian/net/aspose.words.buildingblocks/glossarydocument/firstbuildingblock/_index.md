...
description: Откройте для себя свойство FirstBuildingBlock в GlossaryDocument. Легко получайте доступ к начальному строительному блоку для оптимизированного управления документами.
type: docs
weight: 30
...
Получает первый строительный блок в документе глоссария.
...
Возврат`нулевой` если нет доступных строительных блоков.
