...
description: Откройте для себя свойство BuildingBlocks в GlossaryDocument, предлагающее типизированную коллекцию всех записей глоссария для улучшенной организации и легкого доступа.
type: docs
weight: 20
...
Возвращает типизированную коллекцию, которая представляет все строительные блоки в документе глоссария.
