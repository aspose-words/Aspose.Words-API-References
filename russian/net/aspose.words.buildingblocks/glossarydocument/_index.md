...
description: Aspose.Words.BuildingBlocks.GlossaryDocument сорт. Представляет корневой элемент для документа глоссария в документе Word. Документ глоссария является хранилищем для автотекста записей автозамены и стандартных блоков.
type: docs
weight: 170
