...
description: Откройте для себя метод AcceptStart GlossaryDocument, который поможет вам приветствовать посетителей и улучшить их взаимодействие с вашим глоссарием с самого начала.
type: docs
weight: 80
url: /ru/net/aspose.words.buildingblocks/glossarydocument/acceptstart/
---
## GlossaryDocument.AcceptStart method

Принимает посетителя для посещения начала документа Глоссария.
