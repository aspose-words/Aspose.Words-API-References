...
description: Откройте для себя свойство GlossaryDocument NodeType, которое эффективно извлекает значение GlossaryDocument для улучшенного управления контентом.
type: docs
weight: 50
