...
description: GlossaryDocument LastBuildingBlock свойство. Получает последний стандартный блок в документе глоссария на С#.
type: docs
weight: 40
...
Получает последний стандартный блок в документе глоссария.
