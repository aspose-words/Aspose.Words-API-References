...
description: Откройте для себя свойство LastBuildingBlock в GlossaryDocument, обеспечивающее легкий доступ к последнему строительному блоку для улучшенного управления документами.
type: docs
weight: 40
url: /ru/net/aspose.words.buildingblocks/glossarydocument/lastbuildingblock/
---
## GlossaryDocument.LastBuildingBlock property

Получает последний строительный блок в документе глоссария.
