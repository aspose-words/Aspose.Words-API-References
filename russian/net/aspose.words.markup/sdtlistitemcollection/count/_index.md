...
description: Откройте для себя свойство SdtListItemCollection Count, чтобы легко получить общее количество элементов в вашей коллекции для эффективного управления данными.
type: docs
weight: 10
