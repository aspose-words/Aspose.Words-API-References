...
description: Определяет текущее выбранное значение в этом списке. Допустимо нулевое значение означающее что никакая выбранная в данный момент запись не связана с этой коллекцией элементов списка.
type: docs
weight: 30
