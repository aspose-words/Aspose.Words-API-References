...
description: Откройте для себя метод SdtListItemCollection GetEnumerator для эффективного перебора элементов коллекции, что повышает эффективность и производительность вашего кодирования.
type: docs
weight: 60
