...
description: Получите доступ к объектам SdtListItem без усилий с помощью свойства SdtListItemCollection Item. Извлекайте элементы, используя их индекс, начинающийся с нуля, для бесперебойного управления данными.
type: docs
weight: 20
...
Возвращает[`SdtListItem`](../../sdtlistitem/) объект, учитывая его индекс в коллекции, начинающийся с нуля.
