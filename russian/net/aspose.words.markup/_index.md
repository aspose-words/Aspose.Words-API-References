...
description: Aspose.Words.Разметка пространство имен содержит классы которые представляют определяемую пользователем семантику в документе смарт-теги пользовательский XML и теги структурированного документа элементы управления содержимым.
type: docs
weight: 150
