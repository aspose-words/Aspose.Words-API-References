...
description: Представляет конец дальнобойный тег структурированного документа который принимает содержимое из нескольких разделов. См. такжеStructuredDocumentTagRangeStart./structureddocumenttagrangestart/ узел.
type: docs
weight: 3840
