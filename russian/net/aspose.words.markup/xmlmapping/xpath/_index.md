...
description: Возвращает выражение XPath которое оценивается для поиска пользовательского узла XML node  сопоставленного с тегом родительского структурированного документа.
type: docs
weight: 50
