...
description: Управляйте своими пользовательскими атрибутами XML без усилий с помощью CustomXmlProperty Uri. Легко устанавливайте или извлекайте URI пространства имен для улучшенной функциональности.
type: docs
weight: 30
...
Возвращает или задает URI пространства имен пользовательского атрибута XML или свойства смарт-тега.
