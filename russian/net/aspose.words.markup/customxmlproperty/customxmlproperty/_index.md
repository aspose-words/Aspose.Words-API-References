...
| --- | --- | --- |
| name | String | Имя свойства. Не может быть нулевым. |
| uri | String | URI пространства имен свойства. Не может быть нулевым. |
| value | String | Стоимость имущества. Не может быть нулевым. |
