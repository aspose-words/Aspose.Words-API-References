...
description: Определите ваши пользовательские атрибуты XML без усилий с помощью свойства CustomXmlProperty Name. Улучшите свои документы с помощью смарт-тегов для лучшей организации.
type: docs
weight: 20
url: /ru/net/aspose.words.markup/customxmlproperty/name/
---
## CustomXmlProperty.Name property

Указывает имя настраиваемого атрибута XML или свойства смарт-тега.
