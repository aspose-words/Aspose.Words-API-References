...
description: CustomXmlProperty свойство. Задает имя пользовательского атрибута XML или свойства смарттега.
type: docs
weight: 20
...
Задает имя пользовательского атрибута XML или свойства смарт-тега.
