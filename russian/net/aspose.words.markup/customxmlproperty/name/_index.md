...
description: CustomXmlProperty Name свойство. Указывает имя пользовательского атрибута XML или свойства смарттега на С#.
type: docs
weight: 20
...
Указывает имя пользовательского атрибута XML или свойства смарт-тега.
