...
description: Узнайте, как свойство SdtListItem DisplayText улучшает ваш контент, настраивая отображаемый текст, повышая вовлеченность пользователей и ясность.
type: docs
weight: 20
...
Получает текст, который будет отображаться в содержимом выполнения вместо[`Value`](../value/) содержимое атрибута для этого элемента списка.
