...
description: Aspose.Words.Markup.SdtDateStorageFormat перечисление. Указывает как дата для SDT даты сохраняется/извлекается когда SDT привязан к узлу XML в хранилище данных документа на С#.
type: docs
weight: 4010
...
| --- | --- | --- |
| Date | `0` | Значение даты для SDT даты сохраняется как дата в стандартном формате даты XML-схемы. |
| DateTime | `1` | Значение даты для SDT даты сохраняется как дата в стандартном формате XML-схемы DateTime. |
