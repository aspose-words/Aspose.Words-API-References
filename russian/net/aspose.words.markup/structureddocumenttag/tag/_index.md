...
description: Откройте для себя свойство StructuredDocumentTag, которое определяет основные теги для узлов SDT, обеспечивая эффективное управление и организацию документов.
type: docs
weight: 280
...
Тег — это произвольная строка, которую приложения могут связать с SDT , чтобы идентифицировать его без предоставления видимого понятного имени.
