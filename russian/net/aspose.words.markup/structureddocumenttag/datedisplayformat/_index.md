...
description: StructuredDocumentTag свойство. Строка представляющая формат отображения дат. Не может быть нулевым. Даты для английского языка США мм/дд/гггг.
type: docs
weight: 90
...
Строка, представляющая формат отображения дат. Не может быть нулевым. Даты для английского языка (США): «мм/дд/гггг».
