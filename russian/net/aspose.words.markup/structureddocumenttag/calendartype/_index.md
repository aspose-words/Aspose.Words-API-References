...
description: StructuredDocumentTag свойство. Указывает тип календаря для этого СДТ . По умолчаниюDefault
type: docs
weight: 50
...
Указывает тип календаря для этого **СДТ** . По умолчаниюDefault
