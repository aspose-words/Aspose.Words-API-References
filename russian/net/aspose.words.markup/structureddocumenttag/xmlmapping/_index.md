...
description: StructuredDocumentTag свойство. Получает объект представляющий сопоставление этого тега структурированного документа с XML data в пользовательской XMLчасти текущего документа.
type: docs
weight: 310
