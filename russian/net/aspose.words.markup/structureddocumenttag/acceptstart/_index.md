...
description: Откройте для себя метод StructuredDocumentTag AcceptStart для улучшения управления документами. Оптимизируйте взаимодействие посетителей для оптимальной производительности!
type: docs
weight: 350
url: /ru/net/aspose.words.markup/structureddocumenttag/acceptstart/
---
## StructuredDocumentTag.AcceptStart method

Принимает посетителя для посещения начала StructuredDocumentTag.
