...
description: Получает или задает стиль тега структурированного документа.
type: docs
weight: 260
...
ТолькоCharacterстиль илиParagraphможно установить стиль со связанным стилем символов.
