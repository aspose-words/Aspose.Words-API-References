...
description: StructuredDocumentTag свойство. Указывает будет ли содержимое этого СДТ должен интерпретироваться как содержащий заполнитель text в отличие от обычного текстового содержимого в SDT.
type: docs
weight: 150
...
Указывает, будет ли содержимое этого **СДТ** должен интерпретироваться как содержащий заполнитель text (в отличие от обычного текстового содержимого в SDT).
