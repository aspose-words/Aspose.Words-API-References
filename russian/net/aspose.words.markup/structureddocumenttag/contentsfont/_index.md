...
description: Откройте для себя свойство StructuredDocumentTag ContentsFont для бесшовного форматирования текста в SDT. Улучшите свои документы с помощью настраиваемых параметров шрифта!
type: docs
weight: 80
...
Форматирование шрифта, которое будет применено к тексту, введенному в**СДТ** .
