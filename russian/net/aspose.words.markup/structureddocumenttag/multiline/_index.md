...
description: Откройте для себя свойство StructuredDocumentTag Multiline, позволяющее использовать несколько строк текста для повышения гибкости документа и удобства использования.
type: docs
weight: 210
...
Указывает, является ли это**СДТ** позволяет вводить несколько строк текста.
...
Доступ к этому свойству будет возможен только дляRichText иPlainText Тип СДТ.
