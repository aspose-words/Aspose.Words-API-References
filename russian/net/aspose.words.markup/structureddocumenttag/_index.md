...
description: Aspose.Words.Markup.StructuredDocumentTag сорт. Представляет структурированный тег документа SDT или элемент управления содержимым в документе.
type: docs
weight: 4060
