...
description: Откройте для себя свойство StructuredDocumentTag Appearance, чтобы легко настраивать и улучшать визуальный стиль структурированных тегов документа.
type: docs
weight: 20
...
Получает/задает внешний вид структурированного тега документа.
