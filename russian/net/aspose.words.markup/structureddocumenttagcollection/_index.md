...
description: Aspose.Words.Markup.StructuredDocumentTagCollection сорт. КоллекцияIStructuredDocumentTag экземпляры представляющие теги структурированного документа в указанном диапазоне на С#.
type: docs
weight: 4070
