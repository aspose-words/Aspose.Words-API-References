...
description: Aspose.Words.Markup.StructuredDocumentTagCollection сорт. КоллекцияIStructuredDocumentTag экземпляры представляющие теги структурированного документа в указанном диапазоне.
type: docs
weight: 3830
