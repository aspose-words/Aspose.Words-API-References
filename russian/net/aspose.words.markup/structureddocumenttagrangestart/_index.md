...
description: Aspose.Words.Markup.StructuredDocumentTagRangeStart сорт. Представляет начало дальнобойный тег структурированного документа который принимает содержимое из нескольких разделов. См. такжеStructuredDocumentTagRangeEnd .
type: docs
weight: 3850
