...
description: Указывает конец диапазона если StructuredDocumentTag является ранжированным тегом структурированного документа. В противном случае возвращает null.
type: docs
weight: 130
