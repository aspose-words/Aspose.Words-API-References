...
description: StructuredDocumentTagRangeStart свойство. Если установлено значениеистинный  это свойство запретит пользователю удалять этот тег структурированного документа.
type: docs
weight: 80
