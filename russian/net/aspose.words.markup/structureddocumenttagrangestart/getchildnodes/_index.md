...
description: Откройте для себя метод StructuredDocumentTagRangeStart GetChildNodes, который предоставляет динамическую коллекцию дочерних узлов, соответствующих указанным вами типам.
type: docs
weight: 220
