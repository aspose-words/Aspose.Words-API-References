...
description: StructuredDocumentTagRangeStart свойство. Указывает должно ли содержимое этого тега структурированного документа интерпретироваться как текстзаполнитель в отличие от обычного текстового содержимого в теге структурированного документа.
type: docs
weight: 50
