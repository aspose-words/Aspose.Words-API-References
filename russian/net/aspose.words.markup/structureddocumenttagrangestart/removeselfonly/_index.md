...
description: Удаляет этот начальный и конечный узлы диапазона тега структурированного документа но сохраняет его содержимое внутри дерева документа.
type: docs
weight: 240
...
Удаляет этот начальный и конечный узлы диапазона тега структурированного документа, но сохраняет его содержимое внутри дерева документа.
