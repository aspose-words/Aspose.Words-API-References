...
description: Откройте для себя свойство CustomXmlPart Schemas, позволяющее легко управлять схемами XML, связанными с вашими пользовательскими частями XML, улучшая организацию и эффективность данных.
type: docs
weight: 50
...
Указывает набор схем XML, связанных с этой пользовательской частью XML.
