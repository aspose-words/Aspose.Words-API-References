...
description: CustomXmlPart свойство. Получает или задает строку идентифицирующую эту пользовательскую часть XML в документе OOXML.
type: docs
weight: 40
...
Получает или задает строку, идентифицирующую эту пользовательскую часть XML в документе OOXML.
