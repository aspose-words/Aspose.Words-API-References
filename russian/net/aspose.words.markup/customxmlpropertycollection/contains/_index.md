...
description: Узнайте, содержит ли CustomXmlPropertyCollection свойство по имени. Эффективно управляйте своими XML-данными с помощью наших надежных методов для бесшовной интеграции.
type: docs
weight: 50
...
Определяет, содержит ли коллекция свойство с указанным именем.
...
| --- | --- | --- |
| name | String | Имя свойства, которое необходимо найти, чувствительно к регистру. |
