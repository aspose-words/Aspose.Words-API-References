...
description: Представляет набор пользовательских атрибутов XML или свойств смарт-тегов.
type: docs
weight: 3660
...
Представляет набор пользовательских атрибутов XML или свойств смарт-тегов.
...
Элементы[`CustomXmlProperty`](../customxmlproperty)объекты.
