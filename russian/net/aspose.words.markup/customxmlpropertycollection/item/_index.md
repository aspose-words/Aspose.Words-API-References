...
description: Получает свойство с указанным именем.
type: docs
weight: 20
...
| Параметр | Описание |
| --- | --- |
| name | С учетом регистра имя свойства, которое необходимо найти. |
...
| Параметр | Описание |
| --- | --- |
| index | Отсчитываемый от нуля индекс свойства. |
