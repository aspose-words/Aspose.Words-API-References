...
description: Откройте для себя свойство IStructuredDocumentTag PlaceholderName, чтобы легко управлять именами BuildingBlock и улучшать текст заполнителя вашего документа.
type: docs
weight: 110
