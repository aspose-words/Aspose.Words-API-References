...
description: Откройте для себя свойство IStructuredDocumentTag, которое определяет уникальный тег для вашего узла SDT, улучшая структуру документа и обеспечивая ясность.
type: docs
weight: 130
...
Указывает тег, связанный с текущим узлом SDT. Не может быть пустым.
