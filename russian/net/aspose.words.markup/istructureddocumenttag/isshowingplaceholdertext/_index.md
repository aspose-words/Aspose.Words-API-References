...
description: Откройте для себя свойство IStructuredDocumentTag IsShowingPlaceholderText, чтобы легко идентифицировать текст-заполнитель в вашем SDT, повышая ясность и управляемость контента.
type: docs
weight: 50
...
если установлено значение true, это состояние будет возобновлено (с отображением текста-заполнителя) при открытии этого документа.
