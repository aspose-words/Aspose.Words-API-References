...
description: Откройте для себя свойство IStructuredDocumentTag Level, чтобы легко определить его положение в дереве документа, улучшить структуру документа и удобство его использования.
type: docs
weight: 60
