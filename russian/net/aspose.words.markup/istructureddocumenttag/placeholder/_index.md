...
description: Откройте для себя свойство IStructuredDocumentTag Placeholder. Легко управляйте текстом-заполнителем для пустого содержимого SDT и повышайте удобство использования документа.
type: docs
weight: 100
...
Может быть пустым, что означает, что заполнитель неприменим для этого Sdt.
