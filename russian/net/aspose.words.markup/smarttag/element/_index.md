...
description: Откройте для себя свойство SmartTag Element, которое позволяет легко определять и управлять именами смарт-тегов в документах для улучшения организации и эффективности.
type: docs
weight: 20
