...
description: Aspose.Words.Markup.SmartTag сорт. Этот элемент определяет наличие смарттега вокруг одной или нескольких встроенных структур прогонов изображений полей и т. д. внутри абзаца.
type: docs
weight: 4050
