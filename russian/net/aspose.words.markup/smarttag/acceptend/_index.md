...
description: Узнайте, как метод SmartTag AcceptEnd повышает вовлеченность посетителей, легко управляя событиями в конце посещения. Повысьте взаимодействие вашего сайта сегодня!
type: docs
weight: 70
url: /ru/net/aspose.words.markup/smarttag/acceptend/
---
## SmartTag.AcceptEnd method

Принимает посетителя для посещения конца SmartTag.
