...
description: Откройте для себя метод SmartTag AcceptStart — легко приветствуйте посетителей на вашем сайте SmartTag и повышайте вовлеченность пользователей уже сегодня!
type: docs
weight: 80
url: /ru/net/aspose.words.markup/smarttag/acceptstart/
---
## SmartTag.AcceptStart method

Принимает посетителя для посещения начала SmartTag.
