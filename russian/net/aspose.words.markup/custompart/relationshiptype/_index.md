...
description: Получает или задает тип отношения родительской части к этой пользовательской части.
type: docs
weight: 60
...
Получает или задает тип отношения родительской части к этой пользовательской части.
...
Тип связи для пользовательской детали должен быть "неизвестен", например, тип пользовательской связи не один из типов отношений, определенных в ISO/IEC 29500.
