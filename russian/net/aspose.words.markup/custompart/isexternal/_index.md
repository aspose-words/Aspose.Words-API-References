...
description:  False  если эта пользовательская часть хранится внутри пакета OOXML. True  если эта пользовательская часть является внешней целью.
type: docs
weight: 40
...
Показывает, как получить доступ к произвольному коллекция пользовательских запчастей.
