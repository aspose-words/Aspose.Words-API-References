...
description: Откройте для себя метод CustomXmlPartCollection Add, который позволит вам легко и эффективно расширять свои коллекции, добавляя новые элементы.
type: docs
weight: 40
