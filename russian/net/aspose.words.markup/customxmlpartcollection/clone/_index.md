...
description: С легкостью дублируйте CustomXmlPartCollection с помощью нашего метода Clone, гарантируя полную глубокую копию всех элементов для бесперебойного управления данными.
type: docs
weight: 60
