...
description: Находит и возвращает пользовательскую часть XML по ее идентификатору.
type: docs
weight: 70
...
| --- | --- | --- |
| id | String | Строка с учетом регистра, определяющая пользовательскую часть XML. |

### Возвращаемое значение

Возвращает` null` , если пользовательская часть XML с указанным идентификатором не найдена.
