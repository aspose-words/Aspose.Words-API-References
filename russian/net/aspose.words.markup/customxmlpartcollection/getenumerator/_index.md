...
description: Изучите метод GetEnumerator класса CustomXmlPartCollection, который позволяет легко перебирать все элементы коллекции и улучшать управление XML-данными.
type: docs
weight: 80
