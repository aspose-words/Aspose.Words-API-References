...
description: Откройте для себя метод Footnote AcceptEnd, разработанный для улучшения пользовательского опыта путем бесперебойного управления посещениями сносок. Улучшите навигацию сегодня!
type: docs
weight: 90
url: /ru/net/aspose.words.notes/footnote/acceptend/
---
## Footnote.AcceptEnd method

Принимает посетителя для посещения конца сноски.
