...
description: Содержит значение указывающее является ли это сноской с автоматической нумерацией или сноской с определяемой пользователем пользовательской отметкой.
type: docs
weight: 30
