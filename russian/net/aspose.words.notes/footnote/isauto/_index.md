...
description: Footnote свойство. Содержит значение указывающее является ли это сноской с автоматической нумерацией или сноской с определяемой пользователем пользовательской отметкой.
type: docs
weight: 30
...
Содержит значение, указывающее, является ли это сноской с автоматической нумерацией или сноской с определяемой пользователем пользовательской отметкой.
...
[`ReferenceMark`](../referencemark/) инициализируется пустой строкой, если для IsAuto установлено значение false.
