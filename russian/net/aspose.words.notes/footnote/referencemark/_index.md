...
description: Footnote свойство. Получает/устанавливает пользовательскую контрольную метку которая будет использоваться для этой сноски. Значение по умолчанию пустой строки Empty  что означает использование сносок с автоматической нумерацией.
type: docs
weight: 50
