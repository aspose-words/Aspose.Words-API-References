...
description: Откройте для себя метод Footnote AcceptStart, разработанный для повышения вовлеченности посетителей путем плавного перехода к началу сноски.
type: docs
weight: 100
url: /ru/net/aspose.words.notes/footnote/acceptstart/
---
## Footnote.AcceptStart method

Принимает посетителя для посещения начала сноски.
