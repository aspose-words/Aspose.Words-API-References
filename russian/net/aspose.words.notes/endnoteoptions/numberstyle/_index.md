...
description: Откройте для себя свойство EndnoteOptions NumberStyle, чтобы без труда настроить формат номеров концевых сносок. Повысьте профессионализм вашего документа сегодня!
type: docs
weight: 10
...
Указывает формат чисел для автоматически нумеруемых концевых сносок.
