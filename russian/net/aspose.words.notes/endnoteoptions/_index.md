...
| Имя | Описание |
| --- | --- |
| [NumberStyle](../../aspose.words.notes/endnoteoptions/numberstyle) { get; set; } | Задает числовой формат для автоматически нумерованных концевых сносок. |
...
| [StartNumber](../../aspose.words.notes/endnoteoptions/startnumber) { get; set; } | Задает начальный номер или символ для первых автоматически нумерованных концевых сносок. |
