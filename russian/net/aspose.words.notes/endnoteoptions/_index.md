...
| Имя | Описание |
| --- | --- |
| [NumberStyle](../../aspose.words.notes/endnoteoptions/numberstyle/) { get; set; } | Определяет числовой формат для автоматически нумерованных сносок. |
| [Position](../../aspose.words.notes/endnoteoptions/position/) { get; set; } | Указывает положение концевых сносок. |
