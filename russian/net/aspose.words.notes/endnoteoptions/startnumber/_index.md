...
description: EndnoteOptions свойство. Определяет начальный номер или символ для первых автоматически нумерованных концевых сносок.
type: docs
weight: 40
...
Определяет начальный номер или символ для первых автоматически нумерованных концевых сносок.
