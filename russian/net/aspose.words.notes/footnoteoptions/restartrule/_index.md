...
description: Откройте для себя свойство FootnoteOptions RestartRule для управления автоматическим сбросом нумерации, что улучшает организацию и ясность документа. Оптимизируйте свой рабочий процесс сегодня!
type: docs
weight: 40
