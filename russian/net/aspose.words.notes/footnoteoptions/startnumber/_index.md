...
description: Указывает начальный номер или символ для первых автоматически нумерованных сносок.
type: docs
weight: 50
...
Это свойство действует, только когда[`RestartRule`](../restartrule)имеет значение Continuous.
...
Assert.AreEqual(1, doc.EndnoteOptions.StartNumber);
 ...
 // Мы можем использовать свойство StartNumber, чтобы получить документ to
