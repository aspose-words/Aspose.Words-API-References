...
description: Откройте для себя свойство FootnoteOptions StartNumber, позволяющее настраивать нумерацию сносок, что позволяет без труда повысить ясность и организованность документа.
type: docs
weight: 50
...
Указывает начальный номер или символ для первых автоматически пронумерованных сносок.
