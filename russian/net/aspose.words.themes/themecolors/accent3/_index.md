...
description: Откройте для себя свойство ThemeColors Accent3, легко персонализируйте свой дизайн с помощью ярких цветов Accent 3 для создания уникального, привлекающего внимание вида.
type: docs
weight: 30
url: /ru/net/aspose.words.themes/themecolors/accent3/
---
## ThemeColors.Accent3 property

Указывает цветовой акцент 3.
