...
description: Откройте для себя свойство ThemeColors Accent2, чтобы улучшить свой дизайн с помощью ярких цветовых вариантов. Поднимите свои проекты с помощью потрясающей визуальной привлекательности!
type: docs
weight: 20
url: /ru/net/aspose.words.themes/themecolors/accent2/
---
## ThemeColors.Accent2 property

Указывает цветовой акцент 2.
