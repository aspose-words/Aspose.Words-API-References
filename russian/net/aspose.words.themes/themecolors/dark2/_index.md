...
description: Откройте для себя ThemeColors Dark2. Легко дополните свой дизайн насыщенным цветом Dark 2 для потрясающих визуальных эффектов и захватывающего пользовательского опыта.
type: docs
weight: 80
