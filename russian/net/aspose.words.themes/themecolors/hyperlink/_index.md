...
description: Откройте для себя свойство ThemeColors Hyperlink, позволяющее настраивать цвета гиперссылок, что позволит без труда улучшить дизайн вашего веб-сайта и удобство использования.
type: docs
weight: 100
