...
description: Откройте для себя свойство ThemeColors FollowedHyperlink, чтобы настроить цвет гиперссылки, по которой вы щелкаете, повысив тем самым визуальную привлекательность вашего веб-сайта и удобство использования.
type: docs
weight: 90
...
Задает цвет для нажатой гиперссылки.
