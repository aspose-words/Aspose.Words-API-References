...
description: Откройте для себя свойство ThemeColors Accent5, чтобы легко персонализировать свои проекты с помощью ярких цветов Accent 5 для создания потрясающего визуального эффекта.
type: docs
weight: 50
url: /ru/net/aspose.words.themes/themecolors/accent5/
---
## ThemeColors.Accent5 property

Указывает цветовой акцент 5.
