...
description: Откройте для себя ThemeColors Accent6. Легко создавайте свой дизайн с яркими цветовыми вариантами для потрясающего визуального эффекта. Поднимите свои проекты на новый уровень без усилий!
type: docs
weight: 60
url: /ru/net/aspose.words.themes/themecolors/accent6/
---
## ThemeColors.Accent6 property

Указывает цветовой акцент 6.
