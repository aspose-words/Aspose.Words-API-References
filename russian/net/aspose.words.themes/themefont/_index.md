...
description: Задает типы имен шрифтов тем для тем документов.
type: docs
weight: 6140
...
Задает типы имен шрифтов тем для тем документов.
...
| Major | `1` | Основной шрифт темы. |
| Minor | `2` | Второстепенный шрифт темы. |

### Примечания

Задает тип шрифта темы, на который можно ссылаться как на шрифт темы в свойствах родительского объекта. Этот шрифт темы является ссылкой на один из предопределенных шрифтов темы, расположенных в части документа Theme, что позволяет централизованно задавать информацию о шрифте в документе.
