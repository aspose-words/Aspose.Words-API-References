...
description: Указывает цвета темы для тем документа.
type: docs
weight: 6120
...
| FollowedHyperlink | `11` | Цвет следующей гиперссылки. |
...
Указанный цвет темы является ссылкой на один из предопределенных цветов темы, расположенных в Часть темы документа, позволяющая централизованно задавать информацию о цвете в документе.
