...
description: Настройте типографику вашего сайта с помощью MajorFonts. Легко устанавливайте различные шрифты для нескольких языков, чтобы улучшить читаемость и пользовательский опыт.
type: docs
weight: 30
