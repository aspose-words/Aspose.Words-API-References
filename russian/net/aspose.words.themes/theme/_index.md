...
description: Представляет тему документа и обеспечивает доступ к основным частям темы включаяMajorFonts./theme/majorfonts MinorFonts./theme/minorfonts а такжеColors./theme/colors
type: docs
weight: 6160
