...
description: Представляет тему документа и обеспечивает доступ к основным частям темы включаяMajorFonts./theme/majorfontsMinorFonts./theme/minorfontsиColors./theme/colors
type: docs
weight: 6110
