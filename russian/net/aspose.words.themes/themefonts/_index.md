...
description: Представляет набор шрифтов в схеме шрифтов позволяя указывать разные шрифты для разных языковLatin./themefonts/latinEastAsian./themefonts/eastasianиComplexScript./themefonts/complexscript.
type: docs
weight: 6150
...
Представляет набор шрифтов в схеме шрифтов, позволяя указывать разные шрифты для разных языков[`Latin`](./latin),[`EastAsian`](./eastasian)и[`ComplexScript`](./complexscript).
...
| [EastAsian](../../aspose.words.themes/themefonts/eastasian) { get; set; } | Задает имя шрифта для восточноазиатских символов. |
| [Latin](../../aspose.words.themes/themefonts/latin) { get; set; } | Задает имя шрифта для латинских символов. |
