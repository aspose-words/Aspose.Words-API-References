...
description: Представляет набор шрифтов в схеме шрифтов позволяя указывать разные шрифты для разных языков.Latin./themefonts/latin/ EastAsian./themefonts/eastasian/ а такжеComplexScript./themefonts/complexscript/ .
type: docs
weight: 6200
