...
description: Определяет доступные параметры обработки конечных пробелов при импорте из файлаText.
type: docs
weight: 3490
...
Определяет доступные параметры обработки конечных пробелов при импорте из файлаText.
