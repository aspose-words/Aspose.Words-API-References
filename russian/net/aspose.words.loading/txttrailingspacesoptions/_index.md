...
description: Aspose.Words.Loading.TxtTrailingSpacesOptions перечисление. Указывает доступные параметры обработки конечных пробелов при импорте изText файл.
type: docs
weight: 3540
