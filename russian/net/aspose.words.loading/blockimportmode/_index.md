...
description: Aspose.Words.Loading.BlockImportMode перечисление. Указывает как свойства элементов уровня блока импортируются из документов на основе HTML на С#.
type: docs
weight: 3560
