...
description: ResourceLoadingArgs SetData метод. Устанавливает предоставленные пользователем данные ресурса который используется  еслиResourceLoading возвращаетUserProvided  на С#.
type: docs
weight: 40
