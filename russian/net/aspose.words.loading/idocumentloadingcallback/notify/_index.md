...
description: Вызывается для уведомления о ходе загрузки документа.
type: docs
weight: 10
...
Основное использование этого интерфейса — позволить коду приложения получить статус выполнения и прервать процесс загрузки.
