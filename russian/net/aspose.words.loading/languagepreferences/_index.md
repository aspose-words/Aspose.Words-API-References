...
description: Откройте для себя класс Aspose.Words.LanguagePreferences, чтобы легко настраивать и управлять языковыми параметрами для улучшенной обработки документов.
type: docs
weight: 4100
