...
description: RtfLoadOptions свойство. Если установлено значениеистинный CharsetDetector попытается обнаружить символы UTF8 они сохранятся во время импорта.
type: docs
weight: 20
