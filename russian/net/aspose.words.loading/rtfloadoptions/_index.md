...
description: Позволяет указать дополнительные параметры при загрузкеRtfдокумента вDocument../aspose.words/documentобъект.
type: docs
weight: 3460
...
Позволяет указать дополнительные параметры при загрузкеRtfдокумента в[`Document`](../../aspose.words/document)объект.
