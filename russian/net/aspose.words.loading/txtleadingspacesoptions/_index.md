...
description: Aspose.Words.Loading.TxtLeadingSpacesOptions перечисление. Задает доступные параметры для обработки начального пробела при импорте изText файл.
type: docs
weight: 3520
...
Задает доступные параметры для обработки начального пробела при импорте изText файл.
