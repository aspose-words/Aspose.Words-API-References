...
description: Откройте для себя перечисление Aspose.Words TxtLeadingSpacesOptions для эффективной обработки начальных пробелов при импорте текстовых файлов. Оптимизируйте обработку документов сегодня!
type: docs
weight: 4180
...
Указывает доступные параметры обработки начального пробела во время импорта изText файл.
