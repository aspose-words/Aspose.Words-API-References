...
description: Позволяет указать дополнительные параметры такие как пароль или базовый URI при загрузке документа вДокументобъект.
type: docs
weight: 3410
...
Позволяет указать дополнительные параметры (такие как пароль или базовый URI) при загрузке документа вДокументобъект.
