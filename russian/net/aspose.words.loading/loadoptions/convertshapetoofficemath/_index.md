...
description: LoadOptions ConvertShapeToOfficeMath свойство. Получает или задает необходимость преобразования фигур с помощью EquationXML в объекты Office Math на С#.
type: docs
weight: 40
