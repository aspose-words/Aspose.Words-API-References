...
description: Получает или задает кодировку которая будет использоваться для загрузки документа HTML TXT или CHM если кодировка не указана внутри документа . Может быть нулевым. Значение по умолчанию равно нулю.
type: docs
weight: 50
...
Получает или задает кодировку, которая будет использоваться для загрузки документа HTML, TXT или CHM, если кодировка не указана внутри документа . Может быть нулевым. Значение по умолчанию равно нулю.
...
Если внутри документа не указана кодировка и это свойство равно` null` , то система попробуйте автоматически определить кодировку.
