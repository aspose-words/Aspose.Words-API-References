...
| [PageCount](../../aspose.words.loading/pdfloadoptions/pagecount/) { get; set; } | Получает или задает количество страниц для чтения. По умолчанию установлено значение MaxValue, что означает, что все страницы документа будут прочитаны. |
| [PageIndex](../../aspose.words.loading/pdfloadoptions/pageindex/) { get; set; } | Получает или задает отсчитываемый от 0 индекс первой читаемой страницы. По умолчанию — 0. . |
...
| [SkipPdfImages](../../aspose.words.loading/pdfloadoptions/skippdfimages/) { get; set; } | Получает или задает флаг, указывающий, следует ли пропускать изображения при загрузке PDF-документа. По умолчанию`ЛОЖЬ` . |
