...
description: Получает или задает значение указывающее является ли имя файла вебстраницы или документа указанным в параметре .FrameDefaultUrlaspose.words.framesets/frameset/framedefaulturl/ свойство  это внешний ресурс с которым связан фрейм.
type: docs
weight: 40
