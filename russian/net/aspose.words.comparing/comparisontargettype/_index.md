...
description: Позволяет указать базовый документ который будет использоваться при сравнении. Значение по умолчаниюCurrent.
type: docs
weight: 270
...
| --- | --- | --- |
| Current | `0` | Этот документ используется в качестве базы при сравнении. |
| New | `1` | В качестве базы при сравнении используется другой документ. |
