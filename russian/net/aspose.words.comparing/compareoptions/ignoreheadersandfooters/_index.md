...
description: Узнайте, как свойство CompareOptions IgnoreHeadersAndFooters улучшает обработку документов, игнорируя верхние и нижние колонтитулы для более точного анализа данных.
type: docs
weight: 100
...
По умолчанию верхние и нижние колонтитулы не игнорируются.
