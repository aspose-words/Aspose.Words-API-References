...
description: CompareOptions IgnoreDmlUniqueId свойство. Указывает следует ли игнорировать разницу в уникальном идентификаторе DrawingML. Значение по умолчаниюЛОЖЬ  на С#.
type: docs
weight: 60
