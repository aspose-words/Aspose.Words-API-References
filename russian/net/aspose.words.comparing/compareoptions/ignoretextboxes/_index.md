...
description: Узнайте, как свойство CompareOptions IgnoreTextboxes улучшает сравнение данных, исключая различия в текстовых полях для получения более точных результатов.
type: docs
weight: 120
