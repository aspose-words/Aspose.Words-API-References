...
description: Узнайте, как свойство IgnoreFootnotes в CompareOptions улучшает сравнение документов, исключая обычные и концевые сноски для получения более понятных результатов.
type: docs
weight: 80
url: /ru/net/aspose.words.comparing/compareoptions/ignorefootnotes/
---
