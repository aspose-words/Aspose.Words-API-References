...
description: Узнайте, как задать свойство Target в CompareOptions для эффективного сравнения документов. Оптимизируйте свой процесс с помощью точного нацеливания уже сегодня!
type: docs
weight: 130
...
Указывает, какой документ будет использоваться в качестве цели при сравнении.
