...
description: CompareOptions свойство. Указывает какой документ будет использоваться в качестве эталона при сравнении.
type: docs
weight: 120
...
Указывает, какой документ будет использоваться в качестве эталона при сравнении.
