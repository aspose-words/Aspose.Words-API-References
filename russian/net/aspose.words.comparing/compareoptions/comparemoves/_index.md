...
description: Легко сравнивайте различия в документах с CompareOptions CompareMoves. Откройте для себя ключевые идеи и оптимизируйте свой рабочий процесс сегодня!
type: docs
weight: 30
...
По умолчанию ревизии перемещения не производятся.
