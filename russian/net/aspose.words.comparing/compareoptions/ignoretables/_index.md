...
description: CompareOptions IgnoreTables свойство. Указывает следует ли сравнивать различия в данных содержащихся в таблицах. По умолчанию таблицы не игнорируются на С#.
type: docs
weight: 110
