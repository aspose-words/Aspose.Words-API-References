...
description: Узнайте, как свойство CompareOptions IgnoreCaseChanges улучшает сравнение документов, позволяя выполнять анализ без учета регистра для получения точных результатов.
type: docs
weight: 50
