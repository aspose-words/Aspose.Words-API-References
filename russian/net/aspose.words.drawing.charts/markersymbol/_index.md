...
| --- | --- | --- |
| Default | `0` | Указывает символ маркера по умолчанию, который должен быть нарисован в каждой точке данных. |
...
| None | `5` | Указывает, что ничего не должно быть нарисовано в каждой точке данных. |
