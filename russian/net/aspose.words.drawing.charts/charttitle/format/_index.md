...
description: Изучите свойство «Формат заголовка диаграммы» для улучшенной заливки и стиля линий, придавая вашим диаграммам профессиональный и изысканный вид.
type: docs
weight: 20
url: /ru/net/aspose.words.drawing.charts/charttitle/format/
---
## ChartTitle.Format property

Предоставляет доступ к заполнению и форматированию строк заголовка диаграммы.
