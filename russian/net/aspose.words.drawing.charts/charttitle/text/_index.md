...
description: ChartTitle свойство. Получает или задает текст заголовка диаграммы. Если указано нулевое или пустое значение будет показан автоматически сгенерированный заголовок.
type: docs
weight: 30
