...
description: AxisBound свойство. Возвращает значение привязки оси представленное как datetime.
type: docs
weight: 40
...
Возвращает значение привязки оси, представленное как datetime.
