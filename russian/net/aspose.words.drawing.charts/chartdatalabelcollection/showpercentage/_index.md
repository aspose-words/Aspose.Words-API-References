...
description: Позволяет указать будет ли отображаться процентное значение для меток данных всего ряда. Значение по умолчанию ЛОЖЬ . Применяется только к круговым диаграммам.
type: docs
weight: 100
