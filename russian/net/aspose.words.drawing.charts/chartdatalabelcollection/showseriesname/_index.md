...
description: Возвращает или задает логическое значение указывающее поведение отображения имени ряда для меток данных всего ряда.  Истинныйчтобы показать название серии. ЛОЖЬ прятаться. По умолчанию ЛОЖЬ .
type: docs
weight: 110
