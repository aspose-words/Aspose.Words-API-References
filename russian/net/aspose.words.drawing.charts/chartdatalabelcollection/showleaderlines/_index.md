...
description: Позволяет указать нужно ли отображать линии выноски меток данных для меток данных всего ряда. Значение по умолчанию false .
type: docs
weight: 80
...
Позволяет указать, нужно ли отображать линии выноски меток данных для меток данных всего ряда. Значение по умолчанию: **false** .
...
Значение, определенное для этого свойства, может быть переопределено для отдельной метки данных с помощью [`ShowLeaderLines`](../../chartdatalabel/showleaderlines)свойство.
