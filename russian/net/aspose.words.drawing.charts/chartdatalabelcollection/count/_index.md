...
description: Откройте для себя свойство Count объекта ChartDataLabelCollection, обеспечивающее быстрый доступ к общему количеству объектов ChartDataLabels для улучшенной визуализации данных.
type: docs
weight: 10
url: /ru/net/aspose.words.drawing.charts/chartdatalabelcollection/count/
---
## ChartDataLabelCollection.Count property

Возвращает количество[`ChartDataLabel`](../../chartdatalabel/) в этой коллекции.
