...
description: Легко получить доступ к определенным ChartDataLabel с помощью свойства Item в ChartDataLabelCollection. Улучшите визуализацию данных сегодня!
type: docs
weight: 40
url: /ru/net/aspose.words.drawing.charts/chartdatalabelcollection/item/
---
## ChartDataLabelCollection indexer

Возврат[`ChartDataLabel`](../../chartdatalabel/) для указанного индекса.
