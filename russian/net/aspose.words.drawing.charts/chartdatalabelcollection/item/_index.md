...
description: ChartDataLabelCollection Item свойство. ВозвращаетChartDataLabel для указанного индекса на С#.
type: docs
weight: 40
...
Возвращает[`ChartDataLabel`](../../chartdatalabel/) для указанного индекса.
