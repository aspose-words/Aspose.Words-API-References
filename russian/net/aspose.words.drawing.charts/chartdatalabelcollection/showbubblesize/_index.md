...
description: Позволяет указать должен ли отображаться размер пузырьков для меток данных всего ряда. Применяется только к пузырьковым диаграммам. Значение по умолчанию false .
type: docs
weight: 50
...
Позволяет указать, должен ли отображаться размер пузырьков для меток данных всего ряда. Применяется только к пузырьковым диаграммам. Значение по умолчанию: **false** .
