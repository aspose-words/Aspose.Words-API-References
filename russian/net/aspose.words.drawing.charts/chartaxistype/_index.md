...
description: Откройте для себя перечисление Aspose.Words.Drawing.Charts.ChartAxisType, чтобы легко определять типы осей диаграммы и улучшать визуализацию данных вашего документа.
type: docs
weight: 920
