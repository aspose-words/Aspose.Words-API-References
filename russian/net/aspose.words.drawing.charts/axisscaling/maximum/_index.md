...
description: Откройте для себя свойство Maximum в AxisScaling, позволяющее легко устанавливать или извлекать максимальное значение оси, повышая точность визуализации данных.
type: docs
weight: 30
