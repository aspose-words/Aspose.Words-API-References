...
description: Откройте для себя свойство формата ChartAxisTitle для легкой настройки заливки заголовков осей и стилей линий, что улучшит визуализацию данных.
type: docs
weight: 20
url: /ru/net/aspose.words.drawing.charts/chartaxistitle/format/
---
## ChartAxisTitle.Format property

Предоставляет доступ к заполнению и форматированию строк заголовка оси.
