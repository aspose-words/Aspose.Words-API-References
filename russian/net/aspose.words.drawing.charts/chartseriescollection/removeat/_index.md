...
description: Легко управляйте данными диаграмм с помощью метода ChartSeriesCollection RemoveAt — быстро удаляйте любые ChartSeries по индексу для упрощения анализа.
type: docs
weight: 60
...
| --- | --- | --- |
| index | Int32 | Нулевой индекс[`ChartSeries`](../../chartseries/) удалить. |
