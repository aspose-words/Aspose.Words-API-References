...
description: Откройте для себя свойство ChartSeriesGroup AxisY, чтобы легко получать доступ к функциям оси Y и настраивать их для улучшенной визуализации данных на ваших диаграммах.
type: docs
weight: 30
url: /ru/net/aspose.words.drawing.charts/chartseriesgroup/axisy/
---
## ChartSeriesGroup.AxisY property

Предоставляет доступ к свойствам оси Y этой группы серий.
