...
description: Откройте для себя свойство ChartSeriesGroup AxisX для легкого доступа к функциям оси X, что расширяет возможности визуализации и анализа данных.
type: docs
weight: 20
url: /ru/net/aspose.words.drawing.charts/chartseriesgroup/axisx/
---
## ChartSeriesGroup.AxisX property

Предоставляет доступ к свойствам оси X этой группы серий.
