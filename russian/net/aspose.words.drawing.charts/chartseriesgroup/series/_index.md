...
description: Откройте для себя свойство ChartSeriesGroup Series, чтобы получить доступ к уникальной коллекции связанных рядов, расширяя возможности визуализации данных.
type: docs
weight: 100
url: /ru/net/aspose.words.drawing.charts/chartseriesgroup/series/
---
