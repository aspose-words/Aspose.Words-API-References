...
| [DataLabels](../../aspose.words.drawing.charts/chartseries/datalabels) { get; } | Задает настройки меток данных для всего ряда. |
| [DataPoints](../../aspose.words.drawing.charts/chartseries/datapoints) { get; } | Возвращает набор объектов форматирования для всех точек данных в этом ряду. |
...
| [Name](../../aspose.words.drawing.charts/chartseries/name) { get; set; } | Получает или задает имя серии, если имя не указано явно, оно генерируется с использованием индекса. По умолчанию возвращает серию плюс один основанный индекс. |
| [Smooth](../../aspose.words.drawing.charts/chartseries/smooth) { get; set; } | Позволяет указать, будет ли линия, соединяющая точки на графике, сглаживаться с помощью сплайнов Катмулла-Рома. |
