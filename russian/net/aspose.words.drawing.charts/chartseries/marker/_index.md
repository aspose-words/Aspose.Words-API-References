...
description: Откройте для себя свойство ChartSeries Marker, чтобы легко настраивать маркеры данных для ваших диаграмм. Улучшите визуализацию с помощью автоматического создания маркеров!
type: docs
weight: 100
