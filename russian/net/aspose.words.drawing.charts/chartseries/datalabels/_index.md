...
description: Откройте для себя свойство ChartSeries DataLabels для настройки параметров меток данных для всей серии. Улучшите визуализацию данных сегодня!
type: docs
weight: 30
