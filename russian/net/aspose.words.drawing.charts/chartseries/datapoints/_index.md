...
description: Откройте для себя свойство ChartSeries DataPoints, предлагающее комплексный набор инструментов форматирования для улучшения каждой точки данных в вашей серии.
type: docs
weight: 40
