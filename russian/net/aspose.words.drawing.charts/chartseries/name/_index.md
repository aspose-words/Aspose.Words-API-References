...
Получает или задает имя серии. Если имя не задано явно, оно генерируется с использованием индекса. По умолчанию возвращает серию плюс один индекс на основе индекса.
