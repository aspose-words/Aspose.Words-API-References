...
description: Получает или задает имя серии если имя не указано явно оно генерируется с использованием индекса. По умолчанию возвращает серию плюс один основанный индекс.
type: docs
weight: 100
...
Получает или задает имя серии, если имя не указано явно, оно генерируется с использованием индекса. По умолчанию возвращает серию плюс один основанный индекс.
