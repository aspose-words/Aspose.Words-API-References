...
description: Откройте для себя свойство ChartSeries Name, легко управляйте именами серий, автоматически генерируйте индексы и улучшайте визуализацию данных без особых усилий.
type: docs
weight: 110
...
Возвращает или задает имя серии, если имя не задано явно, оно генерируется с использованием индекса. По умолчанию возвращает серию плюс один основанный индекс.
