...
description: Откройте для себя свойство IsAutoSpacing класса AxisTickLabels, позволяющее легко управлять интервалами между автоматическими метками для точной визуализации данных в ваших проектах.
type: docs
weight: 30
url: /ru/net/aspose.words.drawing.charts/axisticklabels/isautospacing/
---
## AxisTickLabels.IsAutoSpacing property

Возвращает или задает флаг, указывающий, следует ли использовать автоматический интервал для рисования меток делений.
