...
description: Отрегулируйте смещение AxisTickLabels, чтобы настроить расстояние между метками делений и осью для повышения четкости и визуальной привлекательности визуализации данных.
type: docs
weight: 40
url: /ru/net/aspose.words.drawing.charts/axisticklabels/offset/
---
## AxisTickLabels.Offset property

Возвращает или задает расстояние между метками делений и осью.
...
Свойство действует только для осей категорий. Оно не поддерживается новыми диаграммами MS Office 2016.
