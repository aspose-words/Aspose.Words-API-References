...
description: Улучшите свои диаграммы с помощью свойства шрифта AxisTickLabels, позволяющего настраивать форматирование шрифта для более четких и эффектных меток делений.
type: docs
weight: 20
url: /ru/net/aspose.words.drawing.charts/axisticklabels/font/
---
## AxisTickLabels.Font property

Предоставляет доступ к форматированию шрифта меток делений.
