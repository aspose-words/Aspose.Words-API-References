...
| [ChartYValue](./chartyvalue/) | Представляет значение Y для серии диаграмм. |
| [ChartYValueCollection](./chartyvaluecollection/) | Представляет коллекцию значений Y для серии диаграмм. |
## Интерфейсы
