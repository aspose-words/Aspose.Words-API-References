...
description: Откройте для себя свойство AxisDisplayUnit, легко получайте доступ к документу, связанному с родительской диаграммой, для бесперебойного управления данными и улучшенной визуализации.
type: docs
weight: 30
