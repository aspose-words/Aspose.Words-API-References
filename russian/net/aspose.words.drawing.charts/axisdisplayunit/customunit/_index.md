...
description: AxisDisplayUnit свойство. Получает или задает определяемый пользователем делитель для масштабирования отображаемых единиц на оси значений.
type: docs
weight: 20
...
Получает или задает определяемый пользователем делитель для масштабирования отображаемых единиц на оси значений.
...
Установка этого свойства устанавливает[`Unit`](../unit/) собственность на Custom.
