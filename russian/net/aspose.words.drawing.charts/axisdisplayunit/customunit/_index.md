...
description: Получает или задает определяемый пользователем делитель для масштабирования отображаемых единиц на оси значений.
type: docs
weight: 20
...
Установка этого свойства устанавливает для свойства[`Unit`](../unit)значение Custom.
