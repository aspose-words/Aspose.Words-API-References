...
| Имя | Описание |
| --- | --- |
| [CustomUnit](../../aspose.words.drawing.charts/axisdisplayunit/customunit/) { get; set; } | Получает или задает определяемый пользователем делитель для масштабирования отображаемых единиц на оси значений. |
| [Document](../../aspose.words.drawing.charts/axisdisplayunit/document/) { get; } | Возвращает документ, принадлежащий владельцу титула. |
