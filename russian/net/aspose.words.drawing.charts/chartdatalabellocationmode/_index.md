...
description: Откройте для себя перечисление Aspose.Words.ChartDataLabelLocationMode для эффективной настройки положения меток данных с помощью интуитивно понятных настроек свойств Left и Top.
type: docs
weight: 950
url: /ru/net/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enumeration

Указывает, как значения, указывающие местоположение метки данных -[`Left`](../chartdatalabel/left/) и [`Top`](../chartdatalabel/top/) свойства - интерпретируются.
...
| --- | --- | --- |
| Offset | `0` | Местоположение метки данных указывается смещением от позиции, определенной its [`Position`](../chartdatalabel/position/) свойство. |
| Absolute | `1` | Местоположение метки данных указывается с помощью абсолютных координат, начиная с верхнего левого угла диаграммы. |
