...
description: Откройте для себя свойство ChartDataLabel IsHidden, чтобы легко управлять видимостью меток в ваших диаграммах. Улучшите представление данных с помощью этой простой функции!
type: docs
weight: 40
...
Возвращает/устанавливает флаг, указывающий, скрыта ли эта метка. Значение по умолчанию:`ЛОЖЬ` .
