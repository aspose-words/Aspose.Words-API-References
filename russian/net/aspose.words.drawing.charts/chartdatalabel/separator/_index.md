...
description: Откройте для себя свойство ChartDataLabel Separator для настройки меток данных вашей диаграммы. Легко устанавливайте разделители строк для более четкой визуализации и понимания.
type: docs
weight: 120
...
Возвращает или задает разделитель строк, используемый для меток данных на диаграмме. По умолчанию используется запятая, за исключением круговых диаграмм, показывающих только название категории и процент, когда вместо этого следует использовать разрыв строки .
