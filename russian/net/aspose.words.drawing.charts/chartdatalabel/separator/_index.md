...
description: Получает или задает разделитель строк используемый для меток данных на диаграмме. По умолчанию используется запятая за исключением круговых диаграмм показывающих только название категории и процентное соотношение когда вместо нее должен использоваться разрыв строки .
type: docs
weight: 50
...
Получает или задает разделитель строк, используемый для меток данных на диаграмме. По умолчанию используется запятая, за исключением круговых диаграмм, показывающих только название категории и процентное соотношение, когда вместо нее должен использоваться разрыв строки .
