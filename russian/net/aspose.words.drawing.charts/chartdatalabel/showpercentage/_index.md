...
description: Включите отображение процентов на метках данных диаграммы с помощью свойства ChartDataLabel ShowPercentage. Повысьте ясность и понимание ваших визуальных данных!
type: docs
weight: 180
...
Позволяет указать, следует ли отображать процентное значение для меток данных на диаграмме. Значение по умолчанию:`ЛОЖЬ` .
