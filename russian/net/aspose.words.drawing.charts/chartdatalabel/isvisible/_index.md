...
description: ChartDataLabel свойство. Возвращает true если эта метка данных имеет чтото для отображения.
type: docs
weight: 30
...
Возвращает true, если эта метка данных имеет что-то для отображения.
