...
description: Откройте для себя свойство ChartDataLabel TopMode для настройки расположения меток данных на ваших диаграммах. Повысьте ясность и точность в ваших визуальных презентациях данных!
type: docs
weight: 220
url: /ru/net/aspose.words.drawing.charts/chartdatalabel/topmode/
---
## ChartDataLabel.TopMode property

Возвращает или задает режим интерпретации[`Top`](../top/) значение свойства: задает ли оно location метки данных от верхнего края диаграммы или от позиции, указанной его[`Position`](../position/) свойство.
