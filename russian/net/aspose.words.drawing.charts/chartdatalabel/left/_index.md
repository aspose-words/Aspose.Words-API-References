...
description: Настройте свойство ChartDataLabel Left, чтобы контролировать расположение меток данных на диаграмме. Улучшите ясность и презентацию с помощью точных настроек расстояния.
type: docs
weight: 60
url: /ru/net/aspose.words.drawing.charts/chartdatalabel/left/
---
## ChartDataLabel.Left property

Возвращает или задает расстояние метки данных в пунктах от левого края диаграммы или от позиции , указанной ее[`Position`](../position/) имущества, в зависимости от стоимости[`LeftMode`](../leftmode/) свойство.
