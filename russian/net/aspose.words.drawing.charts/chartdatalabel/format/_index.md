...
description: Откройте для себя свойство ChartDataLabel Format для легкого доступа к настраиваемым параметрам заливки и форматирования линий, что позволит без труда улучшить визуализацию данных.
type: docs
weight: 20
...
Предоставляет доступ к заполнению и форматированию строк метки данных.
