...
description: ChartDataLabel свойство. Позволяет указать будет ли отображаться название категории для меток данных на диаграмме. Значение по умолчанию  false.
type: docs
weight: 70
