...
description: Улучшите свои диаграммы с помощью свойства ChartDataLabel ShowCategoryName. Легко отображайте названия категорий на метках данных для более четкого понимания и лучшей визуализации.
type: docs
weight: 140
...
Позволяет указать, будет ли отображаться название категории для меток данных на диаграмме. Значение по умолчанию:`ЛОЖЬ` .
