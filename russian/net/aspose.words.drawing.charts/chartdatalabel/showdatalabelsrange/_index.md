...
description: ChartDataLabel свойство. Позволяет указать будут ли значения из диапазона меток данных отображаться в метках данных. Значение по умолчаниюЛОЖЬ .
type: docs
weight: 100
