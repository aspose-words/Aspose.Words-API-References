...
description: Откройте для себя свойство ChartDataLabel ShowLegendKey, чтобы легко управлять видимостью ключей легенды на ваших диаграммах. Улучшите ясность и представление данных без усилий!
type: docs
weight: 170
...
Позволяет указать, следует ли отображать ключ легенды для меток данных на диаграмме. Значение по умолчанию:`ЛОЖЬ` .
