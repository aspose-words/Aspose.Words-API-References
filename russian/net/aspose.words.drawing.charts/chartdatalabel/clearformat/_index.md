...
description: Узнайте, как использовать метод ChartDataLabel ClearFormat для сброса меток данных до настроек по умолчанию, что повысит ясность и согласованность ваших диаграмм.
type: docs
weight: 230
...
Очищает формат этой метки данных. Свойства устанавливаются на значения по умолчанию, определенные в родительской коллекции меток data .
