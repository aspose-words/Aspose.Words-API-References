...
description: Откройте для себя свойство ChartDataLabel NumberFormat, позволяющее легко настраивать числовые форматы для улучшенной визуализации данных на диаграммах.
type: docs
weight: 80
