...
| --- | --- | --- |
| Automatic | `0` | Ось категорий пересекается в нулевой точке оси значений (если возможно) или на минимальном значении если минимальное значение больше ноль или максимум, если максимум меньше нуля. |
