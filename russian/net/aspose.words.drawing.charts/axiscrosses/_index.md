...
description: Aspose.Words.Drawing.Charts.AxisCrosses перечисление. Определяет возможные точки пересечения для оси.
type: docs
weight: 530
...
Определяет возможные точки пересечения для оси.
...
| Maximum | `1` | Перпендикулярная ось пересекается при максимальном значении оси. |
| Minimum | `2` | Перпендикулярная ось пересекается при минимальном значении оси. |
| Custom | `3` | Перпендикулярная ось пересекает заданное значение оси. |
