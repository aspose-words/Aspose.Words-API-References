...
description: Задает единицы отображения для оси.
type: docs
weight: 510
...
Задает единицы отображения для оси.
...
| Custom | `1` | Указывает, что значения на диаграмме должны делиться на заданный пользователем делитель. Это значение не поддерживается новыми типами диаграмм MS Office 2016. |
...
| Percentage | `11` | Указывает, что значения на диаграмме должны быть разделены на 0,01. Это значение поддерживается только новыми диаграммами типов MS Office 2016. |
