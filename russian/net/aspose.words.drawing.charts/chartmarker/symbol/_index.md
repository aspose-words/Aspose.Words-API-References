...
description: Откройте для себя свойство ChartMarker Symbol, чтобы легко настраивать маркеры диаграмм. Улучшите визуализацию данных с помощью уникальных символов для лучшего понимания.
type: docs
weight: 30
...
Получает или задает символ маркера диаграммы.
