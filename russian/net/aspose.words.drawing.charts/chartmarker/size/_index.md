...
description: Легко настройте размер ChartMarker! Настройте размер маркера вашей диаграммы для большей ясности и визуальной привлекательности. По умолчанию 7.
type: docs
weight: 20
...
Возвращает или задает размер маркера диаграммы. Значение по умолчанию — 7.
