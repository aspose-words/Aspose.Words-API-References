...
| [ValueType](../../aspose.words.drawing.charts/chartxvalue/valuetype/) { get; } | Получает тип значения X, хранящегося в объекте. |
...
Все ненулевые значения X серии диаграмм должны иметь одно и то же значение.[`ChartXValueType`](../chartxvaluetype/) тип.
