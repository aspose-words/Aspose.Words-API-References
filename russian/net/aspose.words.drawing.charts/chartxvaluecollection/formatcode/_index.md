...
description: Откройте для себя свойство FormatCode ChartXValueCollection, легко настраивайте форматы значений X для улучшенной визуализации данных и ясности ваших диаграмм.
type: docs
weight: 20
url: /ru/net/aspose.words.drawing.charts/chartxvaluecollection/formatcode/
---
## ChartXValueCollection.FormatCode property

Возвращает или задает код формата, применяемый к значениям X.
