...
description: Узнайте, как свойство ChartDataPoint InvertIfNegative улучшает визуализацию данных, инвертируя цвета для отрицательных значений, повышая ясность и воздействие.
type: docs
weight: 50
