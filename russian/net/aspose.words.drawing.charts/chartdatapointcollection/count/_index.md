...
description: Откройте для себя свойство Count объекта ChartDataPointCollection, которое эффективно возвращает общее количество ChartDataPoints, улучшая визуализацию данных.
type: docs
weight: 10
