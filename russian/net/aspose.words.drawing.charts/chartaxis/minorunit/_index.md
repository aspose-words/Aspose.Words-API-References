...
description: Возвращает или задает расстояние между второстепенными делениями.
type: docs
weight: 140
...
Установка этого свойства устанавливает для свойства[`MinorUnitIsAuto`](../minorunitisauto)значение **ложь** .
