...
description: ChartAxis свойство. Возвращает или задает расстояние между второстепенными делениями.
type: docs
weight: 140
...
Установка этого свойства устанавливает[`MinorUnitIsAuto`](../minorunitisauto/) собственность на **ЛОЖЬ**.
