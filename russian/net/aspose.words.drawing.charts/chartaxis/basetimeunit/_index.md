...
description: Откройте для себя свойство ChartAxis BaseTimeUnit, чтобы легко определить наименьшую единицу времени на оси временных категорий для улучшенной визуализации данных.
type: docs
weight: 20
