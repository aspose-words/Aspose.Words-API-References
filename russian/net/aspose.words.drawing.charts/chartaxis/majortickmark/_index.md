...
description: Откройте для себя свойство ChartAxis MajorTickMark, которое позволит легко настроить основные деления диаграммы для повышения визуальной ясности и точности.
type: docs
weight: 120
