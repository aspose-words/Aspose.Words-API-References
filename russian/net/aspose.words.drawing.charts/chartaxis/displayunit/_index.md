...
description: ChartAxis DisplayUnit свойство. Определяет значение масштабирования единиц отображения для оси значений на С#.
type: docs
weight: 60
...
Определяет значение масштабирования единиц отображения для оси значений.
