...
description: Получает или устанавливает флаг указывающий следует ли использовать автоматический интервал отрисовки тиковых меток.
type: docs
weight: 240
...
Свойство действует для текстовых категорий и осей серий. Не поддерживается MS Office 2016 новые графики.
