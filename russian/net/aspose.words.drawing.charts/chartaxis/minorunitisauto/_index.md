...
description: Узнайте, как свойство ChartAxis MinorUnitIsAuto оптимизирует отметки делений вашей диаграммы для более четкой визуализации данных. Улучшайте свои графики без усилий!
type: docs
weight: 180
...
Возвращает или задает флаг, указывающий, следует ли использовать расстояние по умолчанию между второстепенными делениями.
