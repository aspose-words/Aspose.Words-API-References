...
description: Откройте для себя свойство ChartAxis HasMajorGridlines, которое позволяет легко управлять основными линиями сетки на ваших диаграммах, улучшая визуализацию и ясность данных.
type: docs
weight: 90
...
Возвращает или задает флаг, указывающий, имеет ли ось основные линии сетки.
