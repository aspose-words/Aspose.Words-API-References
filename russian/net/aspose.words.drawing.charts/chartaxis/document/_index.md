...
description: Откройте для себя свойство документа ChartAxis, легко получите доступ к документу родительской диаграммы для улучшенной визуализации и анализа данных.
type: docs
weight: 70
