...
description: Откройте для себя свойство ChartAxis Type, чтобы легко определять типы осей и улучшать визуализацию данных для более четкого понимания и лучшего анализа.
type: docs
weight: 260
