...
description: Возвращает или устанавливает флаг указывающий должны ли значения оси отображаться в обратном порядке т.е. от максимального к минимальному.
type: docs
weight: 180
...
Возвращает или устанавливает флаг, указывающий, должны ли значения оси отображаться в обратном порядке, т.е. от максимального к минимальному.
...
Свойство не поддерживается новыми диаграммами MS Office 2016. Значение по умолчанию: **false** .
