...
description: Откройте для себя свойство ChartAxis MajorUnitScale, позволяющее легко настраивать основные деления на оси временных категорий для улучшенной визуализации данных.
type: docs
weight: 150
...
Возвращает или задает значение шкалы для основных делений на оси категории времени.
