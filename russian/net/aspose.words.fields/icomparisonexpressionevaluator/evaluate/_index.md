...
description: Откройте для себя метод Evaluate IComparisonExpressionEvaluator для точных сравнительных оценок. Повысьте эффективность кодирования с помощью нашего мощного инструмента!
type: docs
weight: 10
...
Реализация должна вернуть`нулевой` чтобы указать, что должна быть выполнена оценка по умолчанию.
