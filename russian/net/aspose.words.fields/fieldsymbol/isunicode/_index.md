...
description: Откройте для себя свойство FieldSymbol IsUnicode, которое позволяет легко управлять кодами символов как значениями Unicode, повышая эффективность и точность кодирования.
type: docs
weight: 80
...
Возвращает или задает, интерпретируется ли код символа как значение символа Unicode.
