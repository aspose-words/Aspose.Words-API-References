...
description: FieldSymbol FontSize свойство. Получает или задает размер в пунктах шрифта символа полученного по полю на С#.
type: docs
weight: 50
...
Получает или задает размер в пунктах шрифта символа, полученного по полю.
