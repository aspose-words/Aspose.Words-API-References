...
description: Откройте для себя свойство FieldSymbol FontSize, легко настройте размер шрифта в пунктах для улучшенного отображения символов в ваших приложениях. Оптимизируйте читаемость сейчас!
type: docs
weight: 50
...
Возвращает или задает размер в пунктах шрифта символа, извлеченного полем.
