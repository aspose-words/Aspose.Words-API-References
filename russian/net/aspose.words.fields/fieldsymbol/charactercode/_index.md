...
description: Откройте для себя свойство FieldSymbol CharacterCode, легко извлекайте или устанавливайте значения кодов символов в десятичном или шестнадцатеричном формате для бесперебойного управления данными.
type: docs
weight: 20
...
Возвращает или задает значение кодовой точки символа в десятичном или шестнадцатеричном формате.
