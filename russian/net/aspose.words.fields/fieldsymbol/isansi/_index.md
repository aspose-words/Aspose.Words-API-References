...
description: Откройте для себя свойство FieldSymbol IsAnsi, легко управляйте кодами символов ANSI для улучшенной обработки данных и повышения эффективности кодирования.
type: docs
weight: 60
...
Возвращает или задает, интерпретируется ли код символа как значение символа ANSI.
