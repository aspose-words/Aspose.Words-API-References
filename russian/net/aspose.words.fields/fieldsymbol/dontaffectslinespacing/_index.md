...
description: FieldSymbol свойство. Получает или задает влияет ли символ извлеченный полем на межстрочный интервал абзаца.
type: docs
weight: 30
...
Получает или задает, влияет ли символ, извлеченный полем, на межстрочный интервал абзаца.
