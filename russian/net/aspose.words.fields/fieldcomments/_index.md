...
Извлекает и, при необходимости, устанавливает комментарии, относящиеся к текущему документу, как записано в **Комментарии** свойство встроенных свойств документа.
