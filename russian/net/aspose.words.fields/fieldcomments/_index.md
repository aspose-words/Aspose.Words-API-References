...
description: Откройте для себя класс Aspose.Words.Fields.FieldComments для эффективной реализации и управления полями COMMENTS в ваших документах. Улучшите обработку документов сегодня!
type: docs
weight: 2110
...
Извлекает и, при необходимости, задает комментарии, относящиеся к текущему документу, как записано в[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/)property встроенных свойств документа.
