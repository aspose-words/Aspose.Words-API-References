...
description: Откройте для себя класс Aspose.Words.Fields.FieldUserAddress для бесшовной интеграции полей USERADDRESS, улучшая автоматизацию и персонализацию документов.
type: docs
weight: 2990
...
| [UserAddress](../../aspose.words.fields/fielduseraddress/useraddress/) { get; set; } | Возвращает или задает почтовый адрес текущего пользователя. |
...
Возвращает почтовый адрес текущего пользователя.
