...
description: Откройте для себя свойство FieldStyleRef SearchFromBottom, управляйте направлением поиска на своей странице для улучшения пользовательского опыта и эффективности.
type: docs
weight: 60
url: /ru/net/aspose.words.fields/fieldstyleref/searchfrombottom/
---
## FieldStyleRef.SearchFromBottom property

Возвращает или задает, следует ли выполнять поиск с нижней части текущей страницы, а не с верхней.
