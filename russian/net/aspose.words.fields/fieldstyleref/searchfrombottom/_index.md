...
description: FieldStyleRef свойство. Получает или задает следует ли искать снизу текущей страницы а не сверху.
type: docs
weight: 60
...
Получает или задает, следует ли искать снизу текущей страницы, а не сверху.
