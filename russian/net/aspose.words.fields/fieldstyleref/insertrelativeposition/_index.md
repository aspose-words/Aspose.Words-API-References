...
description: Узнайте, как свойство InsertRelativePosition объекта FieldStyleRef может улучшить форматирование документа за счет эффективного управления ссылками на абзацы.
type: docs
weight: 50
