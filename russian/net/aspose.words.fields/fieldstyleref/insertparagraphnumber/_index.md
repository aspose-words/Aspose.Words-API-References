...
description: FieldStyleRef свойство. Получает или задает следует ли вставлять номер абзаца на который указывает ссылка точно так как он отображается в документе.
type: docs
weight: 20
