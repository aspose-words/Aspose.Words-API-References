...
// Вставьте поле, которое не обозначает тип целевого поля в его коде поля.
...
// Мы также можем работать с этими полями и назначать их экземплярами класса FieldUnknown.
