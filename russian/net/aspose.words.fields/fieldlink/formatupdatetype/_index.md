...
description: FieldLink FormatUpdateType свойство. Получает или задает способ обновления форматирования связанного объекта на С#.
type: docs
weight: 30
...
Получает или задает способ обновления форматирования связанного объекта.
