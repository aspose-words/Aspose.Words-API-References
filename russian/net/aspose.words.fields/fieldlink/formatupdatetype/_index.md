...
description: Откройте для себя свойство FieldLink FormatUpdateType для эффективного управления тем, как связанные объекты обновляют свое форматирование. Улучшите свой рабочий процесс сегодня!
type: docs
weight: 30
url: /ru/net/aspose.words.fields/fieldlink/formatupdatetype/
---
## FieldLink.FormatUpdateType property

Возвращает или задает способ обновления форматирования связанного объекта.
