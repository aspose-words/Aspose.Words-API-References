...
description: Откройте для себя свойство FieldLink InsertAsRtf, позволяющее легко управлять связанными объектами в формате RTF для улучшенной интеграции документов и повышения гибкости.
type: docs
weight: 70
url: /ru/net/aspose.words.fields/fieldlink/insertasrtf/
---
## FieldLink.InsertAsRtf property

Возвращает или задает, следует ли вставлять связанный объект в формате RTF.
