...
description: Оптимизируйте свои документы с помощью свойства FieldLink IsLinked, чтобы уменьшить размер файла, исключив графические данные. Повысьте эффективность и сэкономьте место для хранения!
type: docs
weight: 100
url: /ru/net/aspose.words.fields/fieldlink/islinked/
---
