...
description: Откройте для себя свойство FieldLink InsertAsBitmap, легко управляйте связанными объектами, вставляя их как высококачественные растровые изображения для повышения визуальной четкости.
type: docs
weight: 40
url: /ru/net/aspose.words.fields/fieldlink/insertasbitmap/
---
