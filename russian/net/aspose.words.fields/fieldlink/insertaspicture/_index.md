...
description: Узнайте, как свойство FieldLink InsertAsPicture улучшает ваши документы, позволяя легко вставлять связанные объекты в качестве изображений.
type: docs
weight: 60
...
Возвращает или задает, следует ли вставлять связанный объект как изображение.
