...
description: Откройте для себя свойство FieldLink SourceFullName, позволяющее легко управлять именами и местоположениями исходных файлов и настраивать их для улучшенной организации данных.
type: docs
weight: 120
