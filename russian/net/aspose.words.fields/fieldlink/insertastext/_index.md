...
description: Откройте для себя свойство FieldLink InsertAsText, которое позволяет легко управлять связанными объектами в текстовом формате, повышая ясность и эффективность вашего документа.
type: docs
weight: 80
url: /ru/net/aspose.words.fields/fieldlink/insertastext/
---
## FieldLink.InsertAsText property

Возвращает или задает, следует ли вставлять связанный объект в текстовом формате.
