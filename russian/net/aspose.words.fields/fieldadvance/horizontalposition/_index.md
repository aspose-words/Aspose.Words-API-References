...
description: Получает или задает число точек на которое текст следующий за полем должен быть перемещен горизонтально от левого края столбца фрейма или текстового поля.
type: docs
weight: 30
