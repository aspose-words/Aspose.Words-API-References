...
description: Получает или задает количество пунктов на которое текст следующий за полем должен быть перемещен по горизонтали от левого края столбца фрейма или текстовое поле.
type: docs
weight: 30
...
Получает или задает количество пунктов, на которое текст, следующий за полем, должен быть перемещен по горизонтали от левого края столбца, фрейма или текстовое поле.
