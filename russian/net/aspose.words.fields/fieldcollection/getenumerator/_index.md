...
description: Откройте для себя метод FieldCollection GetEnumerator — эффективно возвращайте объект перечислителя и расширяйте возможности обработки данных.
type: docs
weight: 40
