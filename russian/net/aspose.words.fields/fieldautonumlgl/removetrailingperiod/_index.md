...
description: Управляйте свойством RemoveTrailingPeriod объекта FieldAutoNumLgl, чтобы настроить отображение чисел — удалите конечные точки для более четкого и профессионального форматирования.
type: docs
weight: 20
...
Возвращает или задает, отображать ли число без конечной точки.
