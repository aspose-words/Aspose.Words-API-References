...
description: FieldDate свойство. Получает или задает следует ли использовать формат который последний раз использовался хостприложением при вставке нового поля ДАТА.
type: docs
weight: 20
...
Получает или задает, следует ли использовать формат, который последний раз использовался хост-приложением при вставке нового поля ДАТА.
