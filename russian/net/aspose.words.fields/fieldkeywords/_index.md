...
description: Откройте для себя класс Aspose.Words.Fields.FieldKeywords для эффективной реализации поля KEYWORDS, улучшения метаданных и возможностей поиска вашего документа.
type: docs
weight: 2500
...
Извлекает и, при необходимости, задает ключевые слова документа, записанные в**Ключевые слова** свойство встроенных свойств документа the .
