...
description: Задает типы полей Microsoft Word.
type: docs
weight: 2350
...
Задает типы полей Microsoft Word.
...
| FieldAdvance | `84` | Указывает поле ДОПОЛНИТЕЛЬНО. |
| FieldAsk | `38` | Задает поле ASK. |
| FieldAuthor | `17` | Задает поле AUTHOR. |
| FieldAutoNum | `54` | Задает поле AUTONUM. |
| FieldAutoNumLegal | `53` | Задает поле AUTONUMLGL. |
...
| FieldBarcode | `63` | Задает поле ШТРИХ-КОД. |
| FieldBibliography | `100500` | Задает поле БИБЛИОГРАФИЯ. |
| FieldBidiOutline | `92` | Задает поле BIDIOUTLINE. |
...
| FieldMergeBarcode | `6302` | Задает поле MERGEBARCODE. |
...
| FieldEditTime | `25` | Задает поле EDITTIME. |
| FieldEmbed | `58` | Задает поле EMBED. |
| FieldEquation | `49` | Определяет поле EQ. |
| FieldFileName | `29` | Задает поле FILENAME. |
| FieldFileSize | `69` | Задает поле FILESIZE. |
| FieldFillIn | `39` | Задает поле FILLIN. |
| FieldFootnoteRef | `5` | Задает поле FOOTNOTEREF. |
...
| FieldGoToButton | `50` | Задает поле GOTOBUTTON. |
| FieldHtmlActiveX | `91` | Указывает поле, представляющее элемент управления HTML. |
| FieldHyperlink | `88` | Задает поле HYPERLINK. |
| FieldIf | `7` | Задает поле ЕСЛИ. |
| FieldInclude | `36` | Задает поле INCLUDE. |
| FieldIncludePicture | `67` | Задает поле INCLUDEPICTURE. |
| FieldIncludeText | `68` | Задает поле INCLUDETEXT. |
| FieldIndex | `8` | Задает поле INDEX. |
| FieldIndexEntry | `4` | Задает поле XE. |
| FieldInfo | `14` | Задает поле INFO. |
| FieldImport | `55` | Задает поле ИМПОРТ. |
| FieldKeyword | `18` | Задает поле KEYWORDS. |
| FieldLastSavedBy | `20` | Задает поле LASTSAVEDBY. |
| FieldLink | `56` | Задает поле LINK. |
...
| FieldMergeSeq | `75` | Задает поле MERGESEQ. |
| FieldNext | `41` | Задает поле NEXT. |
| FieldNextIf | `42` | Задает поле NEXTIF. |
| FieldNoteRef | `72` | Задает поле NOTEREF. |
...
| FieldTOAEntry | `74` | Задает поле TA. |
| FieldTOC | `13` | Задает поле TOC. |
| FieldTOCEntry | `9` | Задает поле TC. |
