...
description: Откройте для себя класс Aspose.Words.Fields.FieldUserName для бесшовной интеграции полей USERNAME. Улучшите автоматизацию документов с помощью мощных функций сегодня!
type: docs
weight: 3010
...
| [UserName](../../aspose.words.fields/fieldusername/username/) { get; set; } | Указывает или устанавливает имя текущего пользователя. |
