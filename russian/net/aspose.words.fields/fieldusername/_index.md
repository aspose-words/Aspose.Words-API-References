...
description: Aspose.Words.Fields.FieldUserName сорт. Реализует поле USERNAME на С#.
type: docs
weight: 2600
...
| [UserName](../../aspose.words.fields/fieldusername/username/) { get; set; } | Присвоение или установка имени текущего пользователя. |
