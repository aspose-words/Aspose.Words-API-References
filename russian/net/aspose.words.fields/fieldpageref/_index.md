...
description: Aspose.Words.Fields.FieldPageRef сорт. Реализует поле PAGEREF.
type: docs
weight: 2120
...
| [InsertRelativePosition](../../aspose.words.fields/fieldpageref/insertrelativeposition/) { get; set; } | Получает или задает, следует ли вставлять относительное положение отмеченного закладкой абзаца. |
