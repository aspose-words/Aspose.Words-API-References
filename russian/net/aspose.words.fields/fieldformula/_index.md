...
description: Откройте для себя класс Aspose.Words.Fields.FieldFormula, который поможет вам легко реализовывать и управлять полями формул в документах для повышения функциональности.
type: docs
weight: 2360
