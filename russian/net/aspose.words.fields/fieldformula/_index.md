...
description: Aspose.Words.Fields.FieldFormula сорт. Реализует поле  формула на С#.
type: docs
weight: 1950
...
// Используйте конструктор полей для построения математического уравнения,
// затем создаем поле формулы для отображения результата уравнения в документе.
