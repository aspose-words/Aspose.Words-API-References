...
description: Aspose.Words.Fields.GeneralFormat перечисление. Определяет общий формат который применяется к числовому текстовому или любому результату поля. Поле может иметь комбинацию общих форматов.
type: docs
weight: 2480
