...
description: Указывает общий формат который применяется к числовому текстовому или любому результату поля. Поле может иметь комбинацию общих форматов.
type: docs
weight: 2440
...
| Aiueo | `1` | Числовое форматирование. Форматирует числовой результат, используя символы хираганы в традиционном порядке айуэо. |
...
| Arabic | `4` | Числовое форматирование. Форматирует числовой результат, используя арабские количественные цифры. |
| ArabicAbjad | `5` | Числовое форматирование. Форматирует числовой результат, используя восходящие числа Абджада. |
...
| CircleNum | `14` | Числовое форматирование. Форматирует числовой результат, используя десятичную нумерацию, заключенную в круг, используя заключенный буквенно-цифровой глиф для чисел в диапазоне от 1 до 20. |
...
| GB2 | `23` | Числовое форматирование. Форматирует числовой результат, используя десятичную нумерацию, заключенную в круглые скобки, используя заключенный буквенно-цифровой глиф. |
...
| UppercaseRoman | `39` | Числовое форматирование. Прописная римская (I, II, III, ...). |
...
| ThaiCardText | `43` | Числовое форматирование. Форматирует числовой результат, используя последовательные числа из тайской системы счета. |
