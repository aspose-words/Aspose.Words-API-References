...
description: Получает или задает стиль штрихкода торговой точки типы штрихкода UPCAx7CUPCEx7CEAN13x7CEAN8. Допустимые значения без учета регистра STDx7CSUP2x7CSUP5x7CCASE.
type: docs
weight: 110
