...
description: Откройте для себя свойство FieldMergeBarcode SymbolRotation, чтобы легко настроить вращение символов штрихкода. Улучшите представление данных с помощью допустимых значений, таких как 0 и 3.
type: docs
weight: 140
