...
description: Откройте для себя возможности FieldTC EntryLevel, легко управляйте и настраивайте начальные уровни для повышения эффективности и оптимизации рабочих процессов.
type: docs
weight: 20
...
Возвращает или задает уровень записи.
