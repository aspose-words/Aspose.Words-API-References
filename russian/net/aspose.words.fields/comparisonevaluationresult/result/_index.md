...
description: Откройте для себя свойство ComparisonEvaluationResult, чтобы легко получать доступ к результатам оценки и анализировать их, улучшая понимание данных и принятие решений.
type: docs
weight: 30
