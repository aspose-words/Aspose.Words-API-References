...
description: Aspose.Words.Fields.FieldNumPages сорт. Реализует поле NUMPAGES.
type: docs
weight: 2070
...
Извлекает количество страниц в текущем документе, записанное в **Страницы**свойство встроенных свойств документа .
