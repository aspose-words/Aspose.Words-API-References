...
description: Aspose.Words.Fields.FieldQuote сорт. Реализует поле ЦИТАТЫ на С#.
type: docs
weight: 2310
...
| [Text](../../aspose.words.fields/fieldquote/text/) { get; set; } | Получает или задает извлекаемый текст. |
