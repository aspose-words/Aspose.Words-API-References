...
description: Aspose.Words.Fields.FieldNoteRef сорт. Реализует поле NOTEREF.
type: docs
weight: 2050
...
| [InsertRelativePosition](../../aspose.words.fields/fieldnoteref/insertrelativeposition/) { get; set; } | Получает или задает, следует ли вставлять относительное положение отмеченного закладкой абзаца. |
