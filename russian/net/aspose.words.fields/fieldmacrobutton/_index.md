...
description: Откройте для себя класс Aspose.Words.Fields.FieldMacroButton для бесшовной интеграции полей MACROBUTTON, повышения автоматизации и функциональности документов.
type: docs
weight: 2540
...
| [DisplayText](../../aspose.words.fields/fieldmacrobutton/displaytext/) { get; set; } | Возвращает или задает текст, который будет отображаться в качестве «кнопки», выбранной для запуска макроса или команды. |
...
| [MacroName](../../aspose.words.fields/fieldmacrobutton/macroname/) { get; set; } | Возвращает или задает имя макроса или команды для запуска. |
