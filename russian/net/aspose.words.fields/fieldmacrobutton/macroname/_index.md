...
description: Откройте для себя свойство FieldMacroButton MacroName, чтобы легко управлять макросами или командами и настраивать их для повышения функциональности и эффективности.
type: docs
weight: 30
...
Возвращает или задает имя макроса или команды для запуска.
