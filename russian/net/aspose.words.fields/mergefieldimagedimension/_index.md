...
description: Представляет размер изображения то есть ширину или высоту используемый в процессе слияния.
type: docs
weight: 2520
...
Представляет размер изображения (то есть ширину или высоту), используемый в процессе слияния.
...
Чтобы указать, что изображение должно быть вставлено с исходным размером во время слияния, необходимо присвоить отрицательное значение свойству[`Value`](./value).

### Примеры

Показывает, как установить размеры изображений как MERGEFIELDS принимает их во время слияния почты.
