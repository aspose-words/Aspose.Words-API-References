...
description: MergeFieldImageDimension свойство. Значение.
type: docs
weight: 30
...
Вы должны использовать отрицательное значение, чтобы указать, что должно быть применено исходное значение соответствующего размера изображения .
