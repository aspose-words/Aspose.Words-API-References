...
description: Получает или устанавливает заблокировано ли родительское поле не должно пересчитывать его результат.
type: docs
weight: 30
...
Получает или устанавливает, заблокировано ли родительское поле (не должно пересчитывать его результат).
