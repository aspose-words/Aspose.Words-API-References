...
description: Откройте для себя класс Aspose.Words.Fields.FieldDocVariable для бесшовной интеграции полей DOCVARIABLE, улучшающей автоматизацию и управление документами.
type: docs
weight: 2230
...
| [VariableName](../../aspose.words.fields/fielddocvariable/variablename/) { get; set; } | Возвращает или задает имя переменной документа для извлечения. |
