...
| [PrinterInstructions](../../aspose.words.fields/fieldprint/printerinstructions) { get; set; } | Получает или задает характерные для принтера символы управляющего кода или инструкции PostScript. |
