...
description: FieldRef свойство. Получает или задает следует ли создавать гиперссылку на отмеченный закладкой абзац.
type: docs
weight: 40
...
Получает или задает, следует ли создавать гиперссылку на отмеченный закладкой абзац.
