...
description: Откройте для себя свойство FieldRef IncludeNoteOrComment, которое позволяет легко управлять нумерацией сносок и концевых сносок, улучшая ваши документы с помощью бесшовных аннотаций.
type: docs
weight: 30
...
Возвращает или задает, следует ли увеличивать номера сносок, концевых сносок и аннотаций, отмеченных закладкой, и вставлять соответствующий текст сноски, концевой сноски и комментария.
