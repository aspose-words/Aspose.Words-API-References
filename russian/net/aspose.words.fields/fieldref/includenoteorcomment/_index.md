...
description: Получает или задает нужно ли увеличивать номера сносок концевых сносок и аннотаций которые помечены закладкой и вставлять соответствующие сноски концевые сноски и текст комментариев.
type: docs
weight: 30
