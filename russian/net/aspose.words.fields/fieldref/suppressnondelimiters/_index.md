...
description: Управляйте свойством FieldRef SuppressNonDelimiters, чтобы легко управлять символами без разделителей в ваших данных. Повышайте точность и оптимизируйте обработку!
type: docs
weight: 100
...
Возвращает или задает необходимость подавления символов, не являющихся разделителями.
