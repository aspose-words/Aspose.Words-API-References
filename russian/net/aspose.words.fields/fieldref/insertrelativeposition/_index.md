...
description: Откройте для себя свойство FieldRef InsertRelativePosition, с легкостью управляйте позиционированием абзацев для улучшенного форматирования документа и повышения его читабельности.
type: docs
weight: 80
...
Возвращает или задает, следует ли вставлять относительное положение указанного абзаца.
