...
description: FieldRef свойство. Получает или задает следует ли вставлять номер абзаца на который указывает ссылка точно так как он отображается в документе.
type: docs
weight: 50
url: /ru/net/aspose.words.fields/fieldref/insertparagraphnumber/
---
## FieldRef.InsertParagraphNumber property

Получает или задает, следует ли вставлять номер абзаца, на который указывает ссылка, точно так, как он отображается в документе.
