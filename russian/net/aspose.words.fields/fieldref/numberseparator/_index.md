...
description: Откройте для себя свойство FieldRef NumberSeparator, чтобы легко настроить форматирование последовательности и номеров страниц с помощью предпочитаемой вами последовательности символов.
type: docs
weight: 90
