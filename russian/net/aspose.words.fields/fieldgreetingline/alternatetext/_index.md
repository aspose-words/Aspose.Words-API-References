...
description: Узнайте, как использовать свойство FieldGreetingLine AlternateText для улучшения пользовательского опыта путем отображения пользовательского текста при отсутствии имен.
type: docs
weight: 20
...
Возвращает или задает текст, который необходимо включить в поле, если имя пустое.
