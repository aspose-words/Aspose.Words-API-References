...
description: FieldGreetingLine NameFormat свойство. Получает или задает формат имени включенного в поле на С#.
type: docs
weight: 40
...
Получает или задает формат имени, включенного в поле.
