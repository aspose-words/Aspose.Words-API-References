...
| [GraphicFilter](../../aspose.words.fields/fieldimport/graphicfilter/) { get; set; } | Получает или задает имя фильтра для формата вставляемой графики. |
...
| [SourceFullName](../../aspose.words.fields/fieldimport/sourcefullname/) { get; set; } | Получает или задает расположение изображения. |
...
Получает изображение, содержащееся в документе.
