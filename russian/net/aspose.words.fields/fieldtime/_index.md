...
description: Откройте для себя класс Aspose.Words.Fields.FieldTime для бесшовной реализации поля TIME. Улучшите автоматизацию документов с помощью мощных функций!
type: docs
weight: 2910
...
/// <summary>
/// Используйте конструктор документов для вставки поля ВРЕМЯ, вставьте новый абзац и верните поле.
/// </summary>
