...
description: Откройте для себя свойство FieldFormat DateTimeFormat, позволяющее легко настраивать результаты полей даты и времени для улучшения представления данных и ясности.
type: docs
weight: 10
...
Возвращает или задает форматирование, применяемое к результату поля даты и времени. Соответствует переключателю \@.
