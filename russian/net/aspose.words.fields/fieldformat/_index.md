...
description: Предоставляет типизированный доступ к числовым полям дате и времени и общему форматированию.
type: docs
weight: 1750
...
Предоставляет типизированный доступ к числовым полям, дате и времени и общему форматированию.
