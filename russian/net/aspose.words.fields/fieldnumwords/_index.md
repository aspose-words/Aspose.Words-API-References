...
description: Откройте для себя класс Aspose.Words.Fields.FieldNumWords для простого управления количеством слов в документах. Улучшите обработку текста с помощью этой мощной функции!
type: docs
weight: 2640
url: /ru/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class
...
| Имя | Описание |
| --- | --- |
| [FieldNumWords](fieldnumwords/)() | Конструктор по умолчанию. |
...
Возвращает количество слов в текущем документе, записанное в**Слова** свойство встроенных свойств документа the .
