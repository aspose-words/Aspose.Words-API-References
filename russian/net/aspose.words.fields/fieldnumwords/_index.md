...
description: Aspose.Words.Fields.FieldNumWords сорт. Реализует поле NUMWORDS на С#.
type: docs
weight: 2230
...
Получает количество слов в текущем документе, записанное в**Слова** свойство встроенных свойств документа the .
