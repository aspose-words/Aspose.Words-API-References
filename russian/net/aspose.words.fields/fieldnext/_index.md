...
description: Aspose.Words.Fields.FieldNext сорт. Реализует поле NEXT.
type: docs
weight: 2030
...
Объединяет следующую запись данных с текущим результирующим объединенным документом вместо того, чтобы начинать новый объединенный документ a .
