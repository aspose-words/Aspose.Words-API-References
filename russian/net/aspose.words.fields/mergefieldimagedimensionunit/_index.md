...
description: Откройте для себя перечисление Aspose.Words.Fields.MergeFieldImageDimensionUnit для точного управления размерами изображений в слияниях. Улучшите автоматизацию документов сегодня!
type: docs
weight: 3170
