...
description: Aspose.Words.Fields.MergeFieldImageDimensionUnit перечисление. Определяет единицу измерения изображения т. е. ширину или высоту используемую в процессе слияния.
type: docs
weight: 2580
