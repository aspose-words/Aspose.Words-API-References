...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Получает или задает текст «кнопки», которая появляется в документе, чтобы ее можно было выбрать для активации перехода. |
