...
description: Откройте для себя класс Aspose.Words.Fields.FieldFormCheckBox, разработанный для простой реализации полей FORMCHECKBOX для повышения интерактивности и функциональности документа.
type: docs
weight: 2320
