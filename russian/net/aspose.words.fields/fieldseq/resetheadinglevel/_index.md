...
description: Получает или задает целое число представляющее уровень заголовка для сброса порядкового номера. Возвращает -1 если число отсутствует.
type: docs
weight: 40
...
Получает или задает целое число, представляющее уровень заголовка для сброса порядкового номера. Возвращает -1, если число отсутствует.
