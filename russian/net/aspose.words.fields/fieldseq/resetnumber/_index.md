...
description: FieldSeq свойство. Получает или задает целое число для сброса порядкового номера. Возвращает 1 если число отсутствует.
type: docs
weight: 50
...
Получает или задает целое число для сброса порядкового номера. Возвращает -1, если число отсутствует.
