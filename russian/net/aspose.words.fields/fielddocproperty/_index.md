...
description: Aspose.Words.Fields.FieldDocProperty сорт. Реализует поле DOCPROPERTY на С#.
type: docs
weight: 1810
url: /ru/net/aspose.words.fields/fielddocproperty/
---
...
| Имя | Описание |
| --- | --- |
| [FieldDocProperty](fielddocproperty/)() | Конструктор по умолчанию. |
