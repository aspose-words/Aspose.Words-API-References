...
description: FormField свойство. Возвращает или задает текст отображаемый в строке состояния когда поле формы находится в фокусе.
type: docs
weight: 180
...
Если для свойства OwnStatus установлено значение true, свойство StatusText определяет текст строки состояния. Если для свойства OwnStatus установлено значение false, свойство StatusText указывает имя записи AutoText , которая содержит текст строки состояния для поля формы.
