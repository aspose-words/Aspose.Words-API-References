...
description: Получает или задает логическое значение указывающее является ли размер текстового поля автоматическим или заданным явно.
type: docs
weight: 110
...
Получает или задает логическое значение, указывающее, является ли размер текстового поля автоматическим или заданным явно.
...
Показывает, как вставлять различные виды форм поля в документ и обрабатывать их с помощью реализации посетителя документа.
