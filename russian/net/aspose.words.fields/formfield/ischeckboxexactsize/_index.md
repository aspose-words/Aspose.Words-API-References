...
description: Откройте для себя свойство FormField IsCheckBoxExactSize, легко управляйте размером текстового поля с помощью простой логической настройки для оптимальной настройки.
type: docs
weight: 110
...
Возвращает или задает логическое значение, указывающее, является ли размер текстового поля автоматическим или задан явно.
