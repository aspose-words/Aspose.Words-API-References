...
description: Откройте для себя свойство FormField EntryMacro, позволяющее легко управлять макросами ввода для ваших форм, улучшая функциональность и удобство использования.
type: docs
weight: 80
...
Возвращает или задает имя макроса записи для поля формы.
