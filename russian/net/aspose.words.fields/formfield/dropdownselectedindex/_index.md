...
description: Получает или задает индекс определяющий текущий выбранный элемент в поле раскрывающейся формы.
type: docs
weight: 60
...
Получает или задает индекс, определяющий текущий выбранный элемент в поле раскрывающейся формы.
