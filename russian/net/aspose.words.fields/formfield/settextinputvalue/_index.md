...
description: Узнайте, как метод FormField SetTextInputValue улучшает форматирование текста и эффективно сохраняет результаты, оптимизируя процесс ввода данных.
type: docs
weight: 250
...
| --- | --- | --- |
| newValue | Object | Может быть строкой, числом или**ДатаВремя** объект. |

## Примечания

The[`TextInputDefault`](../textinputdefault/) значение применяется, если*newValue* является`нулевой`.
