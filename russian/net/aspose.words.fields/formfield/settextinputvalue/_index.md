...
description: Применяет текстовый формат указанный вTextInputFormataspose.words.fields/formfield/textinputformat и сохраняет значение вResultaspose.words.fields/formfield/result .
type: docs
weight: 250
url: /ru/net/aspose.words.fields/formfield/settextinputvalue/
---
## FormField.SetTextInputValue method

Применяет текстовый формат, указанный в[`TextInputFormat`](../textinputformat) и сохраняет значение в[`Result`](../result) .
...
| --- | --- | --- |
| newValue | Object | Может быть строкой, числом или объектом DateTime. |

### Примечания

[`TextInputDefault`](../textinputdefault) значение применяется, если*newValue* является`нулевой`.
