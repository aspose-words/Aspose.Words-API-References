...
description: Откройте для себя свойство FormField ExitMacro, чтобы легко управлять макросами выхода для ваших форм. Улучшите пользовательский опыт и оптимизируйте ввод данных сегодня!
type: docs
weight: 90
...
Возвращает или задает имя макроса выхода для поля формы.
