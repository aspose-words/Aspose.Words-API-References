...
description: FormField свойство. Возвращает или задает текст отображаемый в окне сообщения когда поле формы находится в фокусе и пользователь нажимает F1.
type: docs
weight: 100
...
Если для свойства OwnHelp установлено значение True, HelpText указывает значение текстовой строки. Если для OwnHelp установлено значение False, HelpText указывает имя записи автотекста, которая содержит текст help для поля формы.
