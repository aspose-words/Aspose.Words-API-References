...
description: Указывает источник текста который отображается в окне сообщения когда поле формы находится в фокусе и пользователь нажимает F1.
type: docs
weight: 150
...
При значении True отображается текст, заданный свойством HelpText. Если False, отображается текст в записи автотекста, заданный свойством HelpText.
