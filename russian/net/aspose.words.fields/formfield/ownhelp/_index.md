...
description: FormField свойство. Указывает источник текста отображаемого в окне сообщения когда поле формы находится в фокусе и пользователь нажимает F1.
type: docs
weight: 150
...
Указывает источник текста, отображаемого в окне сообщения, когда поле формы находится в фокусе и пользователь нажимает F1.
...
При значении True отображается текст, заданный свойством HelpText. При значении False отображается текст в записи автотекста, указанный свойством HelpText.
