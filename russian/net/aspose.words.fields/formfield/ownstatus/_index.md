...
description: FormField свойство. Указывает источник текста отображаемого в строке состояния когда поле формы находится в фокусе.
type: docs
weight: 160
...
При значении true отображается текст, заданный свойством StatusText. При значении false отображается текст записи автотекста, указанный свойством StatusText.
