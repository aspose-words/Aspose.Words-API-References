...
description: Узнайте, как свойство FormField OwnStatus улучшает взаимодействие с пользователем, настраивая текст строки состояния, когда поле формы находится в фокусе.
type: docs
weight: 160
...
Указывает источник текста, отображаемого в строке состояния, когда поле формы находится в фокусе.
...
Если`истинный` , текст, указанный[`StatusText`](../statustext/) свойство отображается. Если`ЛОЖЬ` , текст записи Автотекста, указанный[`StatusText`](../statustext/) свойство отображается.
