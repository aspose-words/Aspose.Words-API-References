...
description: Откройте для себя свойство FormField MaxLength для установки ограничений текстового поля. Улучшите пользовательский опыт с помощью настраиваемых параметров длины для оптимального ввода данных.
type: docs
weight: 120
url: /ru/net/aspose.words.fields/formfield/maxlength/
---
