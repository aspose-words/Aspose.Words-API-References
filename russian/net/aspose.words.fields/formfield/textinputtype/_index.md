...
description: Откройте для себя свойство FormField TextInputType для легкой настройки полей текстовой формы. Улучшите пользовательский опыт, легко устанавливая определенные типы ввода.
type: docs
weight: 210
...
Возвращает или задает тип поля текстовой формы.
