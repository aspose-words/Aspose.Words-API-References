...
Настройка **CalculateOnExit**только влияет на поведение поля формы, когда документ открыт в Microsoft Word. Aspose.Words никогда не обновляет ссылки на поле формы.
