...
description: Получает или задает размер флажка в пунктах. Имеет эффект только тогда когдаIsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsize верно.
type: docs
weight: 20
...
Получает или задает размер флажка в пунктах. Имеет эффект только тогда, когда[`IsCheckBoxExactSize`](../ischeckboxexactsize) верно.
