...
description: Получает или задает размер флажка в пунктах. Имеет эффект только когдаIsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsizeимеет значение true.
type: docs
weight: 20
...
Получает или задает размер флажка в пунктах. Имеет эффект, только когда[`IsCheckBoxExactSize`](../ischeckboxexactsize)имеет значение true.
