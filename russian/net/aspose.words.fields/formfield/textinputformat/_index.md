...
description: Возвращает или задает форматирование текста для поля текстовой формы.
type: docs
weight: 200
...
Если поле текстовой формы содержит обычный текст, то допустимые строки формата: "", "ПРОПИСНЫЕ", "СТРОЧНЫЕ", "ПЕРВАЯ ЗАГЛАВНАЯ" и "ТИТУЛЬНЫЙ РЕГИСТР". Строки нечувствительны к регистру.

Если поле текстовой формы содержит число или значение даты/времени, то допустимыми строками формата являются числа или строки формата даты и времени. .
