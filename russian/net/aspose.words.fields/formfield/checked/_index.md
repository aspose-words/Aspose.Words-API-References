...
description: Управляйте формой с легкостью, используя свойство FormField Checked. Легко контролируйте состояние флажка — по умолчанию флажок не установлен для упрощения пользовательского опыта.
type: docs
weight: 30
url: /ru/net/aspose.words.fields/formfield/checked/
---
## FormField.Checked property

Возвращает или задает отмеченный статус поля формы флажка. Значение по умолчанию для этого свойства:`ЛОЖЬ` .
