...
description: Получает или задает проверенный статус поля формы флажка. Значение по умолчанию для этого свойства false .
type: docs
weight: 30
...
Получает или задает проверенный статус поля формы флажка. Значение по умолчанию для этого свойства: **false** .
