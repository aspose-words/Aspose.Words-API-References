...
description: Aspose.Words.Fields.FieldCreateDate сорт. Реализует поле CREATEDATE.
type: docs
weight: 1570
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Получает или задает использование лунного календаря по хиджре или лунного календаря на иврите. |
