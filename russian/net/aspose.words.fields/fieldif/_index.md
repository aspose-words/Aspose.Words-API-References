...
| [FalseText](../../aspose.words.fields/fieldif/falsetext) { get; set; } | Получает или задает отображаемый текст, если выражение сравнения ложно. |
...
Сравнивает значения, обозначенные выражениями[`LeftExpression`](./leftexpression)и[`RightExpression`](./rightexpression) по сравнению с использованием оператора, обозначенного[`ComparisonOperator`](./comparisonoperator).
