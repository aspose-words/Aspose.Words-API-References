...
| [FalseText](../../aspose.words.fields/fieldif/falsetext/) { get; set; } | Получает или задает текст, отображаемый, если выражение сравнения`ЛОЖЬ` . |
...
| [TrueText](../../aspose.words.fields/fieldif/truetext/) { get; set; } | Получает или задает текст, отображаемый, если выражение сравнения истинно. |
