...
description: Узнайте, как свойство FieldBibliography FormatLanguageId расширяет библиографические источники вашего документа с помощью настраиваемых языковых параметров для повышения ясности.
type: docs
weight: 30
...
Возвращает или задает идентификатор языка, который используется для форматирования библиографических источников в документе.
