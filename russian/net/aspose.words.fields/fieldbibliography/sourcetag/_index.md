...
description: Управляйте своей библиографией без усилий с помощью свойства SourceTag — фильтруйте источники, сопоставляя теги, для создания индивидуального, организованного списка литературы.
type: docs
weight: 40
url: /ru/net/aspose.words.fields/fieldbibliography/sourcetag/
---
## FieldBibliography.SourceTag property

Возвращает или задает значение, чтобы в библиографии отображались только источники с соответствующим значением элемента тега.
