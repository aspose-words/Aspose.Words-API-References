...
description: Узнайте, как свойство FieldBibliography FilterLanguageId улучшает управление библиографическими данными за счет фильтрации источников по языку для получения точных результатов.
type: docs
weight: 20
...
Возвращает или задает идентификатор языка, который используется для фильтрации библиографических данных только для тех источников в документе, которые используют этот язык.
