...
description: Откройте для себя свойство FieldCitation SourceTag, легко управляйте и настраивайте элементы тега для бесперебойной вставки данных и повышения точности источника.
type: docs
weight: 60
...
Возвращает или задает значение, соответствующее**Ярлык** значение элемента источника для вставки.
