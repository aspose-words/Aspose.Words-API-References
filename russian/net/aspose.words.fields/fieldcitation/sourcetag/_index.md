...
description: Получает или задает значение соответствующее значению элемента Tag источника для вставки.
type: docs
weight: 60
...
Получает или задает значение, соответствующее значению элемента **Tag** источника для вставки.
