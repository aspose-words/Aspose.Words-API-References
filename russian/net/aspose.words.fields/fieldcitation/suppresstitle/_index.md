...
description: Управляйте видимостью заголовка в цитатах с помощью свойства FieldCitation SuppressTitle. Легко управляйте тем, как отображается информация, для оптимальной ясности.
type: docs
weight: 90
...
Возвращает или задает, будет ли информация о заголовке скрыта из цитаты.
