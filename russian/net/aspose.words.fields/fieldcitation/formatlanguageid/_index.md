...
description: Узнайте, как свойство FieldCitation FormatLanguageId улучшает форматирование цитат в ваших документах за счет управления идентификаторами языков для библиографических стилей.
type: docs
weight: 30
...
Возвращает или задает идентификатор языка, который используется вместе с указанным библиографическим стилем для форматирования цитаты в документе.
