...
description: Управляйте данными цитирования с помощью свойства FieldCitation SuppressYear. Легко контролируйте видимость года для большей ясности в ваших ссылках.
type: docs
weight: 100
...
Возвращает или задает, будет ли информация о годе скрыта из цитаты.
