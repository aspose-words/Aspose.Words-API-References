...
description: FieldCitation свойство. Получает или задает будет ли информация о годе скрыта из цитирования.
type: docs
weight: 100
...
Получает или задает, будет ли информация о годе скрыта из цитирования.
