...
description: Получает или задает значение указывающее будет ли информация о году скрыта в цитировании.
type: docs
weight: 100
...
Получает или задает значение, указывающее, будет ли информация о году скрыта в цитировании.
