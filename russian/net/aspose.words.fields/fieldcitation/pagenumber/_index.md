...
description: Управляйте цитатами без усилий с помощью свойства FieldCitation PageNumber. Легко устанавливайте или извлекайте номера страниц для точного указания ссылок.
type: docs
weight: 40
...
Возвращает или задает номер страницы, связанный с цитатой.
