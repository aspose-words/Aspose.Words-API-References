...
description: Получает или задает значение соответствующее значению элемента Tag другого источника которое будет включено в цитата.
type: docs
weight: 20
...
Получает или задает значение, соответствующее значению элемента **Tag** другого источника, которое будет включено в цитата.
