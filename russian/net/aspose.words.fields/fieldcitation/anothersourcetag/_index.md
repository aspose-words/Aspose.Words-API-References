...
description: FieldCitation свойство. Получает или задает значение соответствующее Ярлык значение элемента другого источника для включения в цитату.
type: docs
weight: 20
...
Получает или задает значение, соответствующее **Ярлык** значение элемента другого источника для включения в цитату.
