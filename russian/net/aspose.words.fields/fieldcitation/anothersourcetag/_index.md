...
description: Узнайте, как свойство FieldCitation AnotherSourceTag улучшает ваши цитаты, связывая значения из нескольких источников для точной ссылки.
type: docs
weight: 20
...
Возвращает или задает значение, соответствующее**Ярлык** значение элемента другого источника, которое будет включено в цитату.
