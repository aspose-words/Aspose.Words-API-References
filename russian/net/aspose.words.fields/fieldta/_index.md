...
description: Откройте для себя класс Aspose.Words.Fields.FieldTA для бесшовной реализации полей TA, расширяя возможности автоматизации и форматирования документов.
type: docs
weight: 2880
...
| [EntryCategory](../../aspose.words.fields/fieldta/entrycategory/) { get; set; } | Возвращает или задает интегральную категорию записи, которая представляет собой число, соответствующее порядку категорий. |
| [Format](../../aspose.words.fields/field/format/) { get; } | Получает[`FieldFormat`](../fieldformat/)объект, который обеспечивает типизированный доступ к форматированию поля. |
| [IsBold](../../aspose.words.fields/fieldta/isbold/) { get; set; } | Возвращает или задает необходимость применения полужирного форматирования к номеру страницы для записи. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Возвращает или задает, является ли текущий результат поля более неверным (устаревшим) из-за других изменений, внесенных в документ. |
| [IsItalic](../../aspose.words.fields/fieldta/isitalic/) { get; set; } | Возвращает или задает, следует ли применять курсивное форматирование к номеру страницы для записи. |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | Возвращает или задает, заблокировано ли поле (не следует пересчитывать его результат). |
| [LocaleId](../../aspose.words.fields/field/localeid/) { get; set; } | Получает или задает LCID поля. |
| [LongCitation](../../aspose.words.fields/fieldta/longcitation/) { get; set; } | Получает или задает длинную цитату для записи. |
| [PageRangeBookmarkName](../../aspose.words.fields/fieldta/pagerangebookmarkname/) { get; set; } | Возвращает или задает имя закладки, которая отмечает диапазон страниц, вставляемых как номер страницы записи. |
| [Result](../../aspose.words.fields/field/result/) { get; set; } | Возвращает или задает текст, который находится между разделителем полей и концом поля. |
| [Separator](../../aspose.words.fields/field/separator/) { get; } | Получает узел, представляющий разделитель полей. Может быть`нулевой` . |
| [ShortCitation](../../aspose.words.fields/fieldta/shortcitation/) { get; set; } | Получает или задает краткую цитату для записи. |
...
Определяет текст и номер страницы для записи таблицы авторитетных источников, которая используется полем TOA.
