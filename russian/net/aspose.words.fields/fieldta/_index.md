...
description: Aspose.Words.Fields.FieldTA сорт. Реализует поле ТА.
type: docs
weight: 2320
...
| [EntryCategory](../../aspose.words.fields/fieldta/entrycategory/) { get; set; } | Получает или задает целостную категорию записи, которая представляет собой число, соответствующее порядку категорий . |
...
| [IsBold](../../aspose.words.fields/fieldta/isbold/) { get; set; } | Получает или задает, следует ли применять полужирное форматирование к номеру страницы для записи. |
...
| [IsItalic](../../aspose.words.fields/fieldta/isitalic/) { get; set; } | Получает или задает, следует ли применять курсивное форматирование к номеру страницы для записи. |
...
| [LongCitation](../../aspose.words.fields/fieldta/longcitation/) { get; set; } | Получает или задает длинную ссылку для записи. |
| [PageRangeBookmarkName](../../aspose.words.fields/fieldta/pagerangebookmarkname/) { get; set; } | Получает или задает имя закладки, помечающей диапазон страниц, который вставляется в качестве номера страницы записи. |
