...
description: Откройте для себя свойство FieldTA EntryCategory. Легко управляйте своими интегральными категориями записей с помощью этого мощного инструмента для бесшовной организации и эффективности.
type: docs
weight: 20
url: /ru/net/aspose.words.fields/fieldta/entrycategory/
---
## FieldTA.EntryCategory property

Возвращает или задает интегральную категорию записи, которая представляет собой число, соответствующее порядку категорий.
