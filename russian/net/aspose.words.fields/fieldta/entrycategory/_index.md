...
description: FieldTA свойство. Получает или задает целостную категорию записи которая представляет собой число соответствующее порядку категорий .
type: docs
weight: 20
...
Получает или задает целостную категорию записи, которая представляет собой число, соответствующее порядку категорий .
