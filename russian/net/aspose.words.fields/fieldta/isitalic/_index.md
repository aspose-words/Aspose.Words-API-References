...
description: Узнайте, как легко форматировать номера страниц с помощью свойства IsItalic от FieldTA, добавляя в документы стильный курсивный текст для лучшей читаемости.
type: docs
weight: 40
...
Возвращает или задает, следует ли применять курсивное форматирование к номеру страницы для записи.
