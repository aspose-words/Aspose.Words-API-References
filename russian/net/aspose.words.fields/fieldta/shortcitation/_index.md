...
description: Управляйте FieldTA ShortCitation без усилий. Легко получайте или устанавливайте краткие цитаты для записей, улучшая организацию и доступность данных.
type: docs
weight: 70
...
Получает или задает краткую цитату для записи.
