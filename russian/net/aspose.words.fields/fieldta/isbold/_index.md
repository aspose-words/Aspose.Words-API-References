...
description: Улучшите свой опыт работы с FieldTA! Легко управляйте жирным шрифтом для номеров страниц ввода, обеспечивая ясность и выразительность в ваших документах.
type: docs
weight: 30
...
Возвращает или задает необходимость применения полужирного форматирования к номеру страницы для записи.
