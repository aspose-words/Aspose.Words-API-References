...
description: Откройте для себя класс Aspose.Words.Fields.FieldEnd, который эффективно обрабатывает окончания полей Word в документах, расширяя возможности обработки документов.
type: docs
weight: 2270
...
Обозначает конец поля Word в документе.
...
| [HasSeparator](../../aspose.words.fields/fieldend/hasseparator/) { get; } | Возврат`истинный` если в этом поле есть разделитель. |
...
| override [NodeType](../../aspose.words.fields/fieldend/nodetype/) { get; } | ВозвратFieldEnd . |
