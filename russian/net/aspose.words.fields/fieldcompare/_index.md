...
description: Aspose.Words.Fields.FieldCompare сорт. Реализует поле СРАВНЕНИЕ на С#.
type: docs
weight: 1710
...
Сравнивает значения, указанные в выражениях.[`LeftExpression`](./leftexpression/) и[`RightExpression`](./rightexpression/) в сравнении с использованием оператора, обозначенного[`ComparisonOperator`](./comparisonoperator/) .
