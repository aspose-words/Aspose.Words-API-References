...
description: Откройте для себя свойство FieldBarcode IsUSPostalAddress. Легко управляйте проверкой почтового адреса США для точной обработки данных и повышения эффективности.
type: docs
weight: 40
...
Возвращает или задает,[`PostalAddress`](../postaladdress/) почтовый адрес в США.
