...
description: Aspose.Words.Fields.FieldBarcode сорт. Реализует поле BARCODE.
type: docs
weight: 1480
...
| [IsBookmark](../../aspose.words.fields/fieldbarcode/isbookmark/) { get; set; } | Получает или устанавливает,[`PostalAddress`](./postaladdress/) имя закладки. |
...
| [IsUSPostalAddress](../../aspose.words.fields/fieldbarcode/isuspostaladdress/) { get; set; } | Получает или устанавливает,[`PostalAddress`](./postaladdress/) почтовый адрес в США. |
...
Вставляет почтовый штрих-код в машиночитаемую форму адреса, используемого почтовой службой США.
