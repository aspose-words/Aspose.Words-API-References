...
description: Получает или задает почтовый адрес используемый для создания штрих-кода или имя закладки которая на него ссылается.
type: docs
weight: 50
...
Получает или задает почтовый адрес, используемый для создания штрих-кода, или имя закладки, которая на него ссылается.
