...
description: Откройте для себя класс Aspose.Words.Fields.FieldDatabaseDataTable, ваше решение для эффективных результатов полей FieldDatabase. Откройте для себя бесшовную интеграцию данных сегодня!
type: docs
weight: 2170
...
Предоставляет данные для[`FieldDatabase`](../fielddatabase/) результат поля. Пожалуйста, смотритеDataTable экземпляр.
