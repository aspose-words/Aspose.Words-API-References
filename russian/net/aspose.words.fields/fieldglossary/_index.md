...
description: Aspose.Words.Fields.FieldGlossary сорт. Реализует поле ГЛОССАРИЙ.
type: docs
weight: 1810
...
| [EntryName](../../aspose.words.fields/fieldglossary/entryname/) { get; set; } | Получает или задает имя записи глоссария для вставки. |
