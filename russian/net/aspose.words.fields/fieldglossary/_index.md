...
description: Aspose.Words.Fields.FieldGlossary сорт. Реализует поле ГЛОССАРИЙ на С#.
type: docs
weight: 1960
url: /ru/net/aspose.words.fields/fieldglossary/
---
## FieldGlossary class
...
| Имя | Описание |
| --- | --- |
| [FieldGlossary](fieldglossary/)() | Конструктор по умолчанию. |
...
| [EntryName](../../aspose.words.fields/fieldglossary/entryname/) { get; set; } | Получает или задает имя вставляемой записи глоссария. |
