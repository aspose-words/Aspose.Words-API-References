...
description: Исследуйте класс Aspose.Words.Fields.FieldGlossary для бесшовной реализации поля GLOSSARY. Улучшите обработку документов с помощью мощных функций!
type: docs
weight: 2370
...
| [EntryName](../../aspose.words.fields/fieldglossary/entryname/) { get; set; } | Возвращает или задает имя записи глоссария для вставки. |
