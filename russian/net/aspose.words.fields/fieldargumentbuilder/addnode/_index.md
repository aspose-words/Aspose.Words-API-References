...
description: Улучшите свой код с помощью метода FieldArgumentBuilder AddNode. Легко добавляйте узлы к аргументам для улучшения функциональности и производительности.
type: docs
weight: 30
...
В данный момент поддерживаются только узлы текстового уровня.
