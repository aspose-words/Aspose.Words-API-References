...
description: Улучшите свои аргументы с помощью метода AddText в FieldArgumentBuilder. Легко добавляйте простой текст для улучшения ясности и функциональности.
type: docs
weight: 40
url: /ru/net/aspose.words.fields/fieldargumentbuilder/addtext/
---
