...
description: Откройте для себя свойство FieldNextIf ComparisonOperator, которое позволит легко управлять операторами сравнения и настраивать их для расширения функциональности.
type: docs
weight: 20
