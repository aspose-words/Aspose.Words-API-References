...
description: Откройте для себя свойство LeftExpression выражения ComparisonExpression. Легко получайте доступ и используйте левое выражение для улучшенной обработки и анализа данных.
type: docs
weight: 20
