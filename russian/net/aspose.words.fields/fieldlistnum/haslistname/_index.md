...
description: Узнайте, как свойство FieldListNum HasListName указывает, включено ли абстрактное имя определения нумерации в код поля для расширенного форматирования документа.
type: docs
weight: 20
...
Возвращает значение, указывающее, указано ли имя определения абстрактной нумерации в коде поля.
