...
description: Откройте для себя свойство FieldListNum ListLevel, которое позволит легко настраивать уровни списков, улучшая организацию и контроль данных.
type: docs
weight: 30
...
Возвращает или задает уровень в списке, переопределяя поведение поля по умолчанию.
