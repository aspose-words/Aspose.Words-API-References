...
description: Откройте для себя свойство FieldListNum StartingNumber, чтобы легко управлять начальным значением поля для улучшения организации данных и повышения эффективности.
type: docs
weight: 50
