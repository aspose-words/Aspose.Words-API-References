...
description: При реализации возвращает ответ пользователя на запрос. Ваша реализация должна возвращать null  чтобы указать что пользователь не ответил на приглашение т.е. нажал кнопку Отмена в окне подсказки.
type: docs
weight: 10
...
При реализации возвращает ответ пользователя на запрос. Ваша реализация должна возвращать **null** , чтобы указать, что пользователь не ответил на приглашение (т.е. нажал кнопку «Отмена» в окне подсказки).
