...
description: Откройте для себя свойство DropDownItemCollection Count, которое эффективно извлекает общее количество элементов в вашей коллекции для оптимизированного управления данными.
type: docs
weight: 10
