...
description: Получайте доступ и управляйте элементами без усилий с помощью свойства DropDownItemCollection Item. Устанавливайте или извлекайте элементы по индексу для бесперебойной обработки данных.
type: docs
weight: 20
