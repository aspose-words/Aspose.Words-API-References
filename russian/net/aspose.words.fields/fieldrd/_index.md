...
description: Aspose.Words.Fields.FieldRD сорт. Реализует поле RD.
type: docs
weight: 2170
...
| [IsPathRelative](../../aspose.words.fields/fieldrd/ispathrelative/) { get; set; } | Получает или задает, является ли путь относительным к текущему документу. |
...
Идентифицирует файл, который необходимо включить при создании оглавления, авторитетной таблицы или индекса с полем TOC, TOA или INDEX
