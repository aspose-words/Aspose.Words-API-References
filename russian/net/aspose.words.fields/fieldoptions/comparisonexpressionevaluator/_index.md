...
description: FieldOptions свойство. Получает или задает средство оценки выражений сравнения полей.
type: docs
weight: 30
...
Получает или задает средство оценки выражений сравнения полей.
