...
description: Откройте для себя свойство FieldOptions ComparisonExpressionEvaluator, позволяющее легко управлять и настраивать выражения сравнения полей для расширенного анализа данных.
type: docs
weight: 40
...
Возвращает или задает оценщик выражений сравнения полей.
