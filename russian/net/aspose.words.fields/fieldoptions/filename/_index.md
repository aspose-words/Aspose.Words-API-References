...
description: Получает или задает имя файла документа.
type: docs
weight: 110
...
Это свойство используется[`FieldFileName`](../../fieldfilename)поле с более высоким приоритетом, чем свойство[`OriginalFileName`](../../../aspose.words/document/originalfilename).
