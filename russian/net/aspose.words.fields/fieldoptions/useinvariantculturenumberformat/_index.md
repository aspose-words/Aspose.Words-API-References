...
description: FieldOptions свойство. Получает или задает значение указывающее что числовой формат анализируется с использованием инвариантного языка и региональных параметров или not
type: docs
weight: 190
