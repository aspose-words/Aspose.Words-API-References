...
description: Получает или задает имя автора документа по умолчанию. Если имя автора уже указано во встроенных свойствах документа этот параметр не учитывается.
type: docs
weight: 60
