...
description: Получает или задаетFieldIndexFormataspose.words.fields/fieldoptions/fieldindexformat который представляет форматирование дляFieldIndexaspose.words.fields/fieldindexполя в документе.
type: docs
weight: 80
