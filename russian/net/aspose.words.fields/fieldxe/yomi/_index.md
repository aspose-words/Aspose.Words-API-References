...
description: FieldXE свойство. Получает или задает ёми первый фонетический символ для сортировки индексов для индекса entry
type: docs
weight: 80
...
Получает или задает ёми (первый фонетический символ для сортировки индексов) для индекса entry
