...
description: Получает или задает ёми первый фонетический символ для сортировки индексов для записи индекса
type: docs
weight: 80
...
Получает или задает ёми (первый фонетический символ для сортировки индексов) для записи индекса
...
// в то время как версия слова "Ёми" будет произноситься точно так же, как произносится с помощью хираганы.
