...
description: FieldXE свойство. Получает или задает следует ли применять курсивное форматирование к номеру страницы записи.
type: docs
weight: 40
...
Получает или задает, следует ли применять курсивное форматирование к номеру страницы записи.
