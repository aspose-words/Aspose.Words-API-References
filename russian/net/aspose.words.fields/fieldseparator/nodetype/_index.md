...
description: Откройте для себя свойство FieldSeparator NodeType, которое эффективно возвращает FieldSeparator, улучшая управление данными и оптимизируя производительность.
type: docs
weight: 10
