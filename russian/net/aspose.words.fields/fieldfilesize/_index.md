...
description: Реализует поле FILESIZE.
type: docs
weight: 1690
...
| [IsInKilobytes](../../aspose.words.fields/fieldfilesize/isinkilobytes) { get; set; } | Получает или задает, следует ли отображать размер файла в килобайтах. |
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes) { get; set; } | Получает или задает, следует ли отображать размер файла в мегабайтах. |
...
В текущей реализации использует свойство[`OriginalFileName`](../../aspose.words/document/originalfilename)для извлечения имя файла, используемое для определения размера файла.
