...
description: FieldFileSize свойство. Получает или задает следует ли отображать размер файла в мегабайтах.
type: docs
weight: 30
...
Получает или задает, следует ли отображать размер файла в мегабайтах.
