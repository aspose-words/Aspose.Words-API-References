...
description: Aspose.Words.Fields.FieldSubject сорт. Реализует поле ТЕМА.
type: docs
weight: 2450
...
Извлекает и, при необходимости, устанавливает тему документа, как записано в **Предмет** свойство встроенных свойств документа the .
