...
description: Откройте для себя класс Aspose.Words.Fields.FieldSubject для простой реализации поля SUBJECT, повышения автоматизации документов и эффективности форматирования.
type: docs
weight: 2860
...
Извлекает и, при необходимости, задает тему документа, как записано в**Предмет** свойство встроенных свойств документа the .
