...
description: Откройте для себя класс Aspose.Words.Fields.FieldBuilder, чтобы без усилий создавать поля с использованием токенов кода и переключателей. Улучшите автоматизацию документов сегодня!
type: docs
weight: 2070
