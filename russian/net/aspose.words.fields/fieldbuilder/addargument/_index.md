...
description: Добавляет аргумент поля.
type: docs
weight: 20
...
Эта перегрузка используется, когда аргумент состоит из смеси различных частей, таких как дочерние поля, узлы и обычный текст.
