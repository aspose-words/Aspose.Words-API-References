...
description: Откройте для себя свойство PageRangeSeparator FieldToa. Легко настройте последовательность символов для бесшовного разделения диапазонов страниц. Оптимизируйте управление документами!
type: docs
weight: 60
