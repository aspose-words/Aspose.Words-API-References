...
description: FieldToa свойство. Получает или задает следует ли заменить пять или более различных ссылок на один и тот же источник на passim который используется для обозначения того что слово или отрывок часто встречается в цитируемой работе.
type: docs
weight: 110
...
Получает или задает, следует ли заменить пять или более различных ссылок на один и тот же источник на «passim», который используется для обозначения того, что слово или отрывок часто встречается в цитируемой работе.
