...
description: Возвращает или задает заменять ли пять или более разных ссылок на один и тот же авторитет passim который используется для указания того что слово или отрывок часто встречается в цитируемой работе.
type: docs
weight: 110
...
Возвращает или задает, заменять ли пять или более разных ссылок на один и тот же авторитет "passim", который используется для указания того, что слово или отрывок часто встречается в цитируемой работе.
