...
Получает или задает необходимость замены пяти или более различных ссылок на страницы одного и того же авторитетного источника на «passim», который используется для указания того, что слово или отрывок часто встречается в цитируемой работе.
