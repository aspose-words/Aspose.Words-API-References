...
description: Оптимизируйте свои цитаты с помощью FieldToa UsePassim. Легко управляйте несколькими ссылками на один и тот же авторитетный источник, повышая ясность и точность своей работы.
type: docs
weight: 110
...
Возвращает или задает, следует ли заменить пять или более различных ссылок на страницы с одним и тем же авторитетным источником на «passim», который используется для указания того, что слово или отрывок часто встречается в цитируемой работе.
