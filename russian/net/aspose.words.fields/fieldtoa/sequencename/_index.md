...
description: Откройте для себя свойство FieldToa SequenceName, чтобы легко управлять именами последовательностей и улучшить нумерацию страниц в ваших приложениях. Оптимизируйте свой рабочий процесс сегодня!
type: docs
weight: 80
url: /ru/net/aspose.words.fields/fieldtoa/sequencename/
---
## FieldToa.SequenceName property

Возвращает или задает имя последовательности, номер которой включен в номер страницы.
