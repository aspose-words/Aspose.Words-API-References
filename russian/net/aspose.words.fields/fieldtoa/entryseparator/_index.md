...
description: Откройте для себя свойство FieldToa EntrySeparator, которое позволит легко настроить таблицу авторитетных источников с помощью гибких последовательностей символов для большей ясности.
type: docs
weight: 40
...
Возвращает или задает последовательность символов, которая используется для разделения записи таблицы авторитетных источников и номера ее страницы.
