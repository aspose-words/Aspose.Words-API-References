...
description: FieldToa свойство. Получает или задает последовательность символов используемую для разделения записи таблицы авторитетных источников и ее номера страницы.
type: docs
weight: 40
...
Получает или задает последовательность символов, используемую для разделения записи таблицы авторитетных источников и ее номера страницы.
