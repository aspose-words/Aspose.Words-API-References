...
description: FieldToa свойство. Получает или задает следует ли включать заголовок категории для записей в таблице авторитетных источников.
type: docs
weight: 100
...
Получает или задает, следует ли включать заголовок категории для записей в таблице авторитетных источников.
