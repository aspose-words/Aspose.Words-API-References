...
description: Получает или задает следует ли включать заголовок категории для записей в авторитетной таблице.
type: docs
weight: 100
...
Получает или задает, следует ли включать заголовок категории для записей в авторитетной таблице.
