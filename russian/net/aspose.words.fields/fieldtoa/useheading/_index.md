...
description: Узнайте, как свойство FieldToa UseHeading расширяет вашу таблицу авторитетных источников, добавляя заголовки категорий для лучшей организации и ясности.
type: docs
weight: 100
url: /ru/net/aspose.words.fields/fieldtoa/useheading/
---
## FieldToa.UseHeading property

Возвращает или задает, следует ли включать заголовок категории для записей в таблице авторитетных источников.
