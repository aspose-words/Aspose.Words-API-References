...
description: Управляйте форматированием текста записи в вашем документе с помощью свойства RemoveEntryFormatting FieldToa. Улучшайте свою таблицу авторитетов без усилий!
type: docs
weight: 70
...
Возвращает или задает, следует ли удалить форматирование текста записи в документе из записи в таблице авторитетных источников.
