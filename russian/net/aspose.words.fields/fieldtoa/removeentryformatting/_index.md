...
description: Получает или задает следует ли удалять форматирование текста записи в документе из записи в таблице авторитетов.
type: docs
weight: 70
...
Получает или задает, следует ли удалять форматирование текста записи в документе из записи в таблице авторитетов.
