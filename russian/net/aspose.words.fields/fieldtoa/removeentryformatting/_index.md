...
description: FieldToa свойство. Получает или задает следует ли удалить форматирование текста записи в документе из записи в таблице авторитетных источников.
type: docs
weight: 70
...
Получает или задает, следует ли удалить форматирование текста записи в документе из записи в таблице авторитетных источников.
