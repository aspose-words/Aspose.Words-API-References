...
description: FieldToa свойство. Получает или задает имя закладки которая отмечает часть документа используемую для построения таблицы.
type: docs
weight: 20
...
Получает или задает имя закладки, которая отмечает часть документа, используемую для построения таблицы.
