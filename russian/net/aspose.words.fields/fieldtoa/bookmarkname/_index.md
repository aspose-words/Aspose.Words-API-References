...
description: Откройте для себя свойство FieldToa BookmarkName, которое позволяет легко управлять закладками в документах, улучшая создание таблиц и навигацию по документам.
type: docs
weight: 20
url: /ru/net/aspose.words.fields/fieldtoa/bookmarkname/
---
## FieldToa.BookmarkName property

Возвращает или задает имя закладки, которая отмечает часть документа, используемую для построения таблицы.
