...
description: Откройте для себя свойство FieldToa SequenceSeparator — легко настройте последовательность символов для разделения последовательностей и номеров страниц для большей ясности.
type: docs
weight: 90
