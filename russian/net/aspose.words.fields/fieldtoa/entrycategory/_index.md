...
description: Откройте для себя свойство EntryCategory в FieldToa для эффективного управления и настройки интегральных категорий для записей в таблице. Улучшите организацию сегодня!
type: docs
weight: 30
...
Возвращает или задает интегральную категорию для записей, включенных в таблицу.
