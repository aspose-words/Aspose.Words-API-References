...
description: FieldToa свойство. Получает или задает интегральную категорию для записей включенных в таблицу.
type: docs
weight: 30
...
Получает или задает интегральную категорию для записей, включенных в таблицу.
