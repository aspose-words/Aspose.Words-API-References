...
description: Откройте для себя свойство FieldToa PageNumberListSeparator для настройки списков номеров страниц с вашим предпочтительным разделителем. Улучшите читаемость вашего документа сегодня!
type: docs
weight: 50
