...
description: Узнайте, как свойство FieldDde InsertAsText улучшает ваши документы, позволяя вставлять связанные объекты в текстовом формате для лучшей совместимости.
type: docs
weight: 70
url: /ru/net/aspose.words.fields/fielddde/insertastext/
---
