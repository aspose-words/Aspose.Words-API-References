...
description: Откройте для себя свойство FieldDde InsertAsUnicode, легко управляйте связанными объектами, вставляя их как текст Unicode для повышения совместимости и производительности.
type: docs
weight: 80
