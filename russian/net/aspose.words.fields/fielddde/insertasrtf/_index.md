...
description: FieldDde InsertAsRtf свойство. Получает или задает следует ли вставлять связанный объект в расширенном текстовом формате RTF на С#.
type: docs
weight: 60
url: /ru/net/aspose.words.fields/fielddde/insertasrtf/
---
