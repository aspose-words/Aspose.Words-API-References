...
description: Оптимизируйте свои документы с помощью свойства FieldDde IsLinked. Контролируйте размер файла, исключая графику, обеспечивая эффективное хранение и более быстрый доступ.
type: docs
weight: 90
