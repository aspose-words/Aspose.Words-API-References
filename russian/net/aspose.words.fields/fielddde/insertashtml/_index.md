...
description: FieldDde свойство. Получает или задает следует ли вставлять связанный объект как текст в формате HTML.
type: docs
weight: 40
url: /ru/net/aspose.words.fields/fielddde/insertashtml/
---
## FieldDde.InsertAsHtml property

Получает или задает, следует ли вставлять связанный объект как текст в формате HTML.
