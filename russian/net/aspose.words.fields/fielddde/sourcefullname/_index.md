...
description: Откройте для себя свойство FieldDde SourceFullName, чтобы легко управлять именем и местоположением исходного файла. Оптимизируйте обработку данных сегодня!
type: docs
weight: 110
url: /ru/net/aspose.words.fields/fielddde/sourcefullname/
---
