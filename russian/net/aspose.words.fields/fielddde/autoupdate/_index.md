...
description: FieldDde свойство. Получает или задает следует ли обновлять это поле автоматически.
type: docs
weight: 20
...
Получает или задает, следует ли обновлять это поле автоматически.
