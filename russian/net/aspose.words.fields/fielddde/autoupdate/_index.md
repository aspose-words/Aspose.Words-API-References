...
description: FieldDde AutoUpdate свойство. Получает или задает необходимость автоматического обновления этого поля на С#.
type: docs
weight: 20
...
Получает или задает необходимость автоматического обновления этого поля.
