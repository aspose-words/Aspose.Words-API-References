...
description: Узнайте, как использовать свойство FieldDde InsertAsBitmap для простой вставки связанных объектов в виде растровых изображений, что повышает визуальную привлекательность вашего документа.
type: docs
weight: 30
