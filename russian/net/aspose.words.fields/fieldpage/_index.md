...
description: Откройте для себя класс Aspose.Words.Fields.FieldPage для бесшовной реализации поля PAGE. Улучшите автоматизацию документов с помощью мощных функций уже сегодня!
type: docs
weight: 2670
...
| Имя | Описание |
| --- | --- |
| [FieldPage](fieldpage/)() | Конструктор по умолчанию. |
