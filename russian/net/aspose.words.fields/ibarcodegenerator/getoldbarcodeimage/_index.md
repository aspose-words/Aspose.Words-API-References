...
description: Сгенерировать изображение штрих-кода используя набор параметров для поля Штрих-код по старинке.
type: docs
weight: 20
...
Сгенерировать изображение штрих-кода, используя набор параметров (для поля «Штрих-код» по старинке).
