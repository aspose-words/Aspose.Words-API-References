...
description: Aspose.Words.Fields.FieldNumChars сорт. Реализует поле NUMCHARS.
type: docs
weight: 2060
...
Извлекает количество символов в текущем документе, записанное в **Персонажи**свойство встроенных свойств документа .
