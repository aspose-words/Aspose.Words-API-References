...
description: Откройте для себя класс Aspose.Words.Fields.FieldNumChars, разработанный для эффективной реализации поля NUMCHARS для улучшенной обработки документов.
type: docs
weight: 2620
...
| Имя | Описание |
| --- | --- |
| [FieldNumChars](fieldnumchars/)() | Конструктор по умолчанию. |
...
Возвращает количество символов в текущем документе, записанное в**Персонажи** свойство встроенных свойств документа the .
