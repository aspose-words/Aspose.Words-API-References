...
description: Откройте для себя свойство FieldToc HeadingLevelRange, позволяющее легко управлять уровнями заголовков для улучшенной организации контента и SEO-оптимизации.
type: docs
weight: 80
...
Возвращает или задает диапазон уровней заголовков для включения.
