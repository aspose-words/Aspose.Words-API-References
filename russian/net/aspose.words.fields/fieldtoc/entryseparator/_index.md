...
description: Откройте для себя свойство FieldToc EntrySeparator, настройте последовательности символов для улучшения навигации по странице ввода и организации документа.
type: docs
weight: 70
...
Возвращает или задает последовательность символов, разделяющих запись и ее номер страницы.
