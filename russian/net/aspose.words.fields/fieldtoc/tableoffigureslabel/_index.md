...
description: Откройте для себя свойство FieldToc TableOfFiguresLabel, чтобы с легкостью настроить таблицу рисунков. Улучшите организацию и ясность вашего документа!
type: docs
weight: 160
...
Возвращает или задает имя идентификатора последовательности, используемого при построении таблицы рисунков.
