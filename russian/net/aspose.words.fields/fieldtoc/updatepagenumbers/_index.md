...
description: Обновляет номера страниц для элементов в этом оглавлении.
type: docs
weight: 180
...
Истинно, если операция выполнена успешно. Если какая-либо из связанных закладок TOC была удалена, будет возвращено значение false.
