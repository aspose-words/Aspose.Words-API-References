...
description: Обновляйте оглавление без усилий с помощью метода FieldToc UpdatePageNumbers, обеспечивающего точную навигацию и повышенное удобство использования документа.
type: docs
weight: 180
...
`истинный` если операция прошла успешно. Если какая-либо из связанных закладок TOC была удалена,`ЛОЖЬ` будет возвращен.
