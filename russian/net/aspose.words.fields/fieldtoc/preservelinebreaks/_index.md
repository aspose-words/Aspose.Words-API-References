...
description: FieldToc свойство. Получает или задает следует ли сохранять символы новой строки в записях таблицы.
type: docs
weight: 130
...
Получает или задает, следует ли сохранять символы новой строки в записях таблицы.
