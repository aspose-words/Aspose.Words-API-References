...
description: Узнайте, как свойство FieldToc PreserveLineBreaks улучшает записи таблицы, сохраняя символы новой строки для улучшения читаемости и форматирования.
type: docs
weight: 130
...
Возвращает или задает, следует ли сохранять символы новой строки в записях таблицы.
