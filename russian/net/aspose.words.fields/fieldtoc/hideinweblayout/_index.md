...
description: Откройте для себя свойство FieldToc HideInWebLayout, позволяющее легко управлять закладками вкладок и номерами страниц в представлении веб-макета для более четкого представления.
type: docs
weight: 90
...
Возвращает или задает необходимость скрыть заполнитель вкладок и номера страниц в представлении веб-макета.
