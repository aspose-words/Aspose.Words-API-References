...
description: Настройте свое оглавление с помощью свойства CustomStyles FieldToc. Легко добавляйте уникальные стили помимо встроенных заголовков для улучшения представления.
type: docs
weight: 40
url: /ru/net/aspose.words.fields/fieldtoc/customstyles/
---
## FieldToc.CustomStyles property

Возвращает или задает список стилей, отличных от встроенных стилей заголовков, для включения в оглавление.
