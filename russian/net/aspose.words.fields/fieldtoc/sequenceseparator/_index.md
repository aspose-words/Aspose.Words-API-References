...
description: Откройте для себя свойство FieldToc SequenceSeparator, чтобы без труда настроить форматирование последовательности и номеров страниц вашего документа. Повысьте ясность и организацию!
type: docs
weight: 150
