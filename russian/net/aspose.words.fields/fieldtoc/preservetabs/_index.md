...
description: FieldToc PreserveTabs свойство. Получает или задает сохранять ли записи вкладок в записях таблицы на С#.
type: docs
weight: 140
...
Получает или задает, сохранять ли записи вкладок в записях таблицы.
