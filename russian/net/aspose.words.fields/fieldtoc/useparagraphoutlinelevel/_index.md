...
description: Узнайте, как использовать свойство FieldToc UseParagraphOutlineLevel для улучшения организации документа путем эффективной установки уровней структуры абзацев.
type: docs
weight: 170
...
Возвращает или задает, следует ли использовать примененный уровень структуры абзаца.
