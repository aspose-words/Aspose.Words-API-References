...
description: FieldToc InsertHyperlinks свойство. Получает или задает следует ли создавать гиперссылки на записи оглавления на С#.
type: docs
weight: 100
...
Получает или задает, следует ли создавать гиперссылки на записи оглавления.
