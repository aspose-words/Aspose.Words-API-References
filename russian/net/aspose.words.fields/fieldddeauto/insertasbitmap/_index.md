...
description: Узнайте, как свойство FieldDdeAuto InsertAsBitmap улучшает ваши связанные объекты, позволяя вставлять растровые изображения. Оптимизируйте свои документы без усилий!
type: docs
weight: 20
url: /ru/net/aspose.words.fields/fieldddeauto/insertasbitmap/
---
## FieldDdeAuto.InsertAsBitmap property

Возвращает или задает, следует ли вставлять связанный объект как растровое изображение.
