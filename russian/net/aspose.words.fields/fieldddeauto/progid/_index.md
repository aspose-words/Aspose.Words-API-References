...
description: Откройте для себя свойство FieldDdeAuto ProgId для простого управления типами приложений для информации о ссылках. Повысьте эффективность программирования сегодня!
type: docs
weight: 90
url: /ru/net/aspose.words.fields/fieldddeauto/progid/
---
## FieldDdeAuto.ProgId property

Возвращает или задает тип приложения для информации о ссылке.
