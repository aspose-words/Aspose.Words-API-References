...
description: FieldDdeAuto ProgId свойство. Получает или задает тип приложения информации о ссылке на С#.
type: docs
weight: 90
...
Получает или задает тип приложения информации о ссылке.
