...
description: FieldDdeAuto IsLinked свойство. Получает или задает следует ли уменьшать размер файла не сохраняя графические данные вместе с документом на С#.
type: docs
weight: 80
