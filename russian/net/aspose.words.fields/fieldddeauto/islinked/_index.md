...
description: Оптимизируйте свои документы с помощью FieldDdeAuto IsLinked. Контролируйте размер файла, исключая графические данные для эффективного хранения и более быстрой загрузки.
type: docs
weight: 80
url: /ru/net/aspose.words.fields/fieldddeauto/islinked/
---
