...
description: Откройте для себя свойство FieldDdeAuto SourceFullName, которое позволит легко управлять именем и местоположением исходного файла для оптимизированной обработки данных.
type: docs
weight: 100
url: /ru/net/aspose.words.fields/fieldddeauto/sourcefullname/
---
## FieldDdeAuto.SourceFullName property

Возвращает или задает имя и местоположение исходного файла.
