...
description: FieldDdeAuto SourceFullName свойство. Получает или задает имя и расположение исходного файла на С#.
type: docs
weight: 100
...
Получает или задает имя и расположение исходного файла.
