...
description: Узнайте, как свойство FieldDdeAuto InsertAsText оптимизирует управление связанными объектами, позволяя вставлять только текстовый формат для большей ясности.
type: docs
weight: 60
url: /ru/net/aspose.words.fields/fieldddeauto/insertastext/
---
