...
description: Улучшите функциональность штрихкода с помощью свойства FieldDisplayBarcode AddStartStopChar. Легко управляйте символами Start/Stop для типов NW7 и CODE39.
type: docs
weight: 20
