...
description: Откройте для себя свойство FieldDisplayBarcode PosCodeStyle для настройки штрихкодов точек продаж. Поддерживает UPCA, EAN13 и другие для оптимальной эффективности.
type: docs
weight: 110
