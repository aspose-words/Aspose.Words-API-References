...
description: FieldDisplayBarcode свойство. Получает или задает стиль штрихкода торговой точки типы штрихкода UPCAUPCEEAN13EAN8. Допустимые значения без учета регистра STDSUP2SUP5CASE.
type: docs
weight: 110
