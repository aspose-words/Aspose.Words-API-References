...
description: FieldDisplayBarcode BackgroundColor свойство. Получает или задает цвет фона символа штрихкода. Допустимые значения находятся в диапазоне 0 0xFFFFFF  на С#.
type: docs
weight: 30
url: /ru/net/aspose.words.fields/fielddisplaybarcode/backgroundcolor/
---
## FieldDisplayBarcode.BackgroundColor property

Получает или задает цвет фона символа штрих-кода. Допустимые значения находятся в диапазоне [0, 0xFFFFFF] .
