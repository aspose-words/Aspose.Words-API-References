...
description: FieldDisplayBarcode свойство. Получает или задает масштабный коэффициент для символа. Значение указано в целых процентах допустимые значения 10 1000 .
type: docs
weight: 120
