...
description: Откройте для себя свойство FieldDisplayBarcode ScalingFactor, чтобы легко настроить размер символа в целых процентах от 10% до 1000%. Оптимизируйте отображение штрихкодов!
type: docs
weight: 120
