...
description: Откройте для себя свойство BarcodeType объекта FieldDisplayBarcode — легко управляйте и настраивайте типы штрихкодов, такие как QR, для улучшенного отображения данных и функциональности.
type: docs
weight: 40
...
Получает или задает тип штрихкода (QR и т. д.)
