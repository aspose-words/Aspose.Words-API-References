...
description: Откройте для себя свойство BarcodeValue объекта FieldDisplayBarcode, позволяющее легко управлять значениями штрихкодов и настраивать их для повышения точности и эффективности данных.
type: docs
weight: 50
