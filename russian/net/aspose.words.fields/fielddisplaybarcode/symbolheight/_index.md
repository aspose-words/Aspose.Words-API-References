...
description: Отрегулируйте свойство SymbolHeight FieldDisplayBarcode, чтобы настроить высоту штрихкода в TWIPS. Улучшите отображение штрихкода с точностью!
type: docs
weight: 130
