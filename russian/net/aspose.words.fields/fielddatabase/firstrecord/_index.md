...
description: Откройте для себя свойство FirstRecord в FieldDatabase, легко управляйте номером исходной записи данных для бесперебойной вставки данных и повышения эффективности.
type: docs
weight: 40
...
Возвращает или задает целочисленный номер первой записи данных для вставки.
