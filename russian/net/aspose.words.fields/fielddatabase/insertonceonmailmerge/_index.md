...
description: Узнайте, как свойство InsertOnceOnMailMerge в FieldDatabase улучшает слияние данных, обеспечивая бесперебойную вставку в начале слияний.
type: docs
weight: 70
url: /ru/net/aspose.words.fields/fielddatabase/insertonceonmailmerge/
---
## FieldDatabase.InsertOnceOnMailMerge property

Возвращает или задает, следует ли вставлять данные в начале слияния.
