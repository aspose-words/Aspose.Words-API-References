...
description: FieldDatabase InsertOnceOnMailMerge свойство. Получает или задает необходимость вставки данных в начале слияния на С#.
type: docs
weight: 70
...
Получает или задает необходимость вставки данных в начале слияния.
