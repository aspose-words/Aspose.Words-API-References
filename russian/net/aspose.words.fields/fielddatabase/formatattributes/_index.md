...
description: Откройте для себя свойство FieldDatabase FormatAttributes, позволяющее легко настраивать атрибуты таблиц и улучшать управление данными и их представление.
type: docs
weight: 50
url: /ru/net/aspose.words.fields/fielddatabase/formatattributes/
---
## FieldDatabase.FormatAttributes property

Возвращает или задает атрибуты формата, которые должны быть применены к таблице.
