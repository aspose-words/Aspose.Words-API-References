...
description: FieldDatabase свойство. Получает или задает какие атрибуты формата должны применяться к таблице.
type: docs
weight: 50
...
Получает или задает, какие атрибуты формата должны применяться к таблице.
