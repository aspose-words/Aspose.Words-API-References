...
description: Легко управляйте своей базой данных с помощью FieldDatabase Query. Легко устанавливайте и извлекайте инструкции SQL для эффективного запроса данных.
type: docs
weight: 90
...
Возвращает или задает набор инструкций SQL, которые запрашивают базу данных.
