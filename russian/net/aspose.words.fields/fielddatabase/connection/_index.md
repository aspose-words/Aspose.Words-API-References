...
description: Управляйте данными без усилий с помощью свойства FieldDatabase Connection. Легко получайте или устанавливайте соединения для бесшовной интеграции данных.
type: docs
weight: 20
url: /ru/net/aspose.words.fields/fielddatabase/connection/
---
## FieldDatabase.Connection property

Получает или задает соединение с данными.
