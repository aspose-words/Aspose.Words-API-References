...
description: Откройте для себя свойство FieldDatabase TableFormat, чтобы легко настраивать результаты запросов к базе данных с помощью гибких параметров форматирования для улучшенного представления данных.
type: docs
weight: 100
...
Возвращает или задает формат, который должен применяться к результату запроса к базе данных.
