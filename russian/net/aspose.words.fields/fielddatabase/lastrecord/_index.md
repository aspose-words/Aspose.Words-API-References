...
description: Откройте для себя свойство FieldDatabase LastRecord. Легко управляйте номером последней записи данных для бесперебойной вставки данных и повышения эффективности базы данных.
type: docs
weight: 80
...
Возвращает или задает целочисленный номер последней записи данных для вставки.
