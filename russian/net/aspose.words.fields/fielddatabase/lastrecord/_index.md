...
description: FieldDatabase LastRecord свойство. Получает или задает целый номер последней вставляемой записи данных на С#.
type: docs
weight: 80
...
Получает или задает целый номер последней вставляемой записи данных.
