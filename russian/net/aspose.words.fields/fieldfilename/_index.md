...
description: Aspose.Words.Fields.FieldFileName сорт. Реализует поле FILENAME на С#.
type: docs
weight: 1870
...
| [IncludeFullPath](../../aspose.words.fields/fieldfilename/includefullpath/) { get; set; } | Получает или задает необходимость включения полного пути к файлу. |
