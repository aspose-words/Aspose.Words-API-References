...
description: Aspose.Words.Fields.FieldFormDropDown сорт. Реализует поле FORMDROPDOWN на С#.
type: docs
weight: 1920
...
Вставляет поле формы раскрывающегося списка.
...
```csharp
// Эти поля являются устаревшими эквивалентами FormField. Мы можем читать, но не создавать эти поля, используя Aspose.Words.
