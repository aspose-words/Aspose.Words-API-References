...
description: Откройте для себя класс Aspose.Words.Fields.FieldFormDropDown, разработанный для улучшения интерактивности документа с помощью динамических раскрывающихся полей для удобного взаимодействия с пользователем.
type: docs
weight: 2330
...
Вставляет поле формы в стиле раскрывающегося списка.
