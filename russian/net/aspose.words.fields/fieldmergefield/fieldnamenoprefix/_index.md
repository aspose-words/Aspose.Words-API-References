...
description: Откройте для себя свойство FieldMergeField FieldNameNoPrefix, которое упрощает обработку данных, возвращая только имя поля, опуская любые префиксы для ясности.
type: docs
weight: 20
