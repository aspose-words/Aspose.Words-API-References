...
description: Откройте для себя свойство FieldMergeField IsMapped, которое позволяет легко управлять сопоставленными полями, улучшая интеграцию данных и эффективность рабочего процесса.
type: docs
weight: 30
...
Возвращает или задает, является ли это поле сопоставленным полем.
