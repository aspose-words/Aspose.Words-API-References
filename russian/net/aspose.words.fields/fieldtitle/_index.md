...
description: Aspose.Words.Fields.FieldTitle сорт. Реализует поле НАЗВАНИЕ.
type: docs
weight: 2360
...
Извлекает и, при необходимости, устанавливает название документа, записанное в **Заголовок**свойство встроенных свойств документа .
