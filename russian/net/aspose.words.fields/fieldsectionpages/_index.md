...
description: Откройте для себя класс Aspose.Words.Fields.FieldSectionPages для эффективной реализации поля SECTIONPAGES и расширения возможностей обработки документов.
type: docs
weight: 2780
