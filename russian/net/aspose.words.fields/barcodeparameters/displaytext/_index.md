...
description: Откройте для себя свойство BarcodeParameters DisplayText, которое позволит улучшить ваши штрихкоды, отображая текстовые данные рядом с изображениями для улучшения читаемости.
type: docs
weight: 70
