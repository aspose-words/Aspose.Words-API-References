...
description: Откройте для себя свойство BarcodeParameters SymbolHeight, позволяющее легко настроить высоту изображения штрихкода в твипах (1/1440 дюйма) для оптимальной производительности сканирования.
type: docs
weight: 170
