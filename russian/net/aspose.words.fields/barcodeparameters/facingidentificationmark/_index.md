...
description: Откройте для себя свойство BarcodeParameters FacingIdentificationMark, необходимое для оптимизации интеграции FIM и повышения точности сканирования штрихкодов.
type: docs
weight: 90
...
Тип лицевого опознавательного знака (ЛИМ).
