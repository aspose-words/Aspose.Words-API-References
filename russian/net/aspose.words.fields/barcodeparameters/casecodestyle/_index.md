...
description: Откройте для себя свойство CaseCodeStyle для штрихкодов ITF14. Изучите допустимые параметры, такие как STDEXTADD, чтобы улучшить дизайн и функциональность вашего штрихкода.
type: docs
weight: 60
...
Стиль кода корпуса для типа штрих-кода ITF14. Допустимые значения: [STD&#x7C;EXT&#x7C;ADD]
