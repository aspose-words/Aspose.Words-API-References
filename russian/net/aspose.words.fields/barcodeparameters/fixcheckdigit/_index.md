...
description: Обеспечьте точность штрихкодов с помощью свойства FixCheckDigit. Автоматически исправляйте недействительные контрольные цифры для надежного сканирования и целостности данных.
type: docs
weight: 100
