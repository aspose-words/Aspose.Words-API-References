...
description: Откройте для себя свойство BarcodeParameters IsBookmark! Узнайте, как PostalAddress может улучшить управление документами с помощью эффективных решений для закладок.
type: docs
weight: 120
...
Будь то[`PostalAddress`](../postaladdress/) это имя закладки.
