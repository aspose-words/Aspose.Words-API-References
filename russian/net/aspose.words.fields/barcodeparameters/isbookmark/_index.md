...
description: Является лиPostalAddressaspose.words.fields/barcodeparameters/postaladdressименем закладки.
type: docs
weight: 120
...
Является ли[`PostalAddress`](../postaladdress)именем закладки.
