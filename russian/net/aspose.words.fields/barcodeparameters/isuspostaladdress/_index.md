...
description: Является лиPostalAddressaspose.words.fields/barcodeparameters/postaladdressпочтовым адресом в США.
type: docs
weight: 130
...
Является ли[`PostalAddress`](../postaladdress)почтовым адресом в США.
