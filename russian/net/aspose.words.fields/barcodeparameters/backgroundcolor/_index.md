...
description: Откройте для себя свойство BarcodeParameters BackgroundColor для создания собственных дизайнов штрихкодов. Легко устанавливайте цвета фона от 0x000000 до 0xFFFFFF для оптимальной видимости!
type: docs
weight: 30
url: /ru/net/aspose.words.fields/barcodeparameters/backgroundcolor/
---
