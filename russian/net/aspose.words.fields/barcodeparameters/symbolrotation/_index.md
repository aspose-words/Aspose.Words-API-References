...
description: Откройте для себя свойство BarcodeParameters SymbolRotation для оптимального вращения символов штрихкода. Выберите из допустимых значений 0 и 3 для точного сканирования.
type: docs
weight: 180
