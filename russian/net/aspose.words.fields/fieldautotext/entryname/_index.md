...
description: Откройте для себя свойство FieldAutoText EntryName, которое позволяет легко управлять именами записей AutoText, повышая автоматизацию и эффективность работы с документами.
type: docs
weight: 20
