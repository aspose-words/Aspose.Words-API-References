...
| [UseLunarCalendar](../../aspose.words.fields/fieldsavedate/uselunarcalendar) { get; set; } | Получает или задает, следует ли использовать лунный календарь по хиджре или лунный календарь на иврите. |
