...
description: Откройте для себя класс Aspose.Words.Fields.FieldTemplate для бесшовной реализации поля TEMPLATE. Улучшите обработку документов с помощью мощных функций!
type: docs
weight: 2900
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | Возвращает или задает, следует ли включать полное имя пути к файлу. |
...
Возвращает имя файла шаблона, используемого текущим документом.
