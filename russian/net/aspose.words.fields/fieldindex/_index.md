...
| [PageNumberSeparator](../../aspose.words.fields/fieldindex/pagenumberseparator) { get; set; } | Получает или задает последовательность символов, которая используется для разделения записи указателя и ее номера страницы. |
...
| [RunSubentriesOnSameLine](../../aspose.words.fields/fieldindex/runsubentriesonsameline) { get; set; } | Получает или задает, запускать ли подзаписи в ту же строку, что и основную запись. |
...
| [UseYomi](../../aspose.words.fields/fieldindex/useyomi) { get; set; } | Получает или задает, следует ли включить использование текста yomi для записей указателя. |
...
Создает индекс, используя записи индекса, указанные в полях XE, и вставляет этот индекс в это место в документ.
