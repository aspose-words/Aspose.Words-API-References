...
description: Откройте для себя свойство FieldIndex Heading, позволяющее настраивать заголовки записей по буквам, улучшая организацию и удобство использования вашего приложения.
type: docs
weight: 70
...
Возвращает или задает заголовок, который отображается в начале каждого набора записей для любой заданной буквы.
