...
description: Откройте для себя свойство FieldIndex SequenceName, которое позволит легко управлять именами последовательностей и повысить эффективность разбиения на страницы в ваших приложениях.
type: docs
weight: 150
