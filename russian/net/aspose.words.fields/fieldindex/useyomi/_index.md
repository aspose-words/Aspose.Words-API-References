...
description: Получает или задает следует ли включить использование текста yomi для записей указателя.
type: docs
weight: 170
...
Получает или задает, следует ли включить использование текста yomi для записей указателя.
