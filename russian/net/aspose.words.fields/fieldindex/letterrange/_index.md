...
description: Откройте для себя свойство FieldIndex LetterRange, позволяющее эффективно задавать или извлекать определенный диапазон букв, оптимизируя производительность индексации.
type: docs
weight: 90
...
Возвращает или задает диапазон букв, которым ограничивается индекс.
