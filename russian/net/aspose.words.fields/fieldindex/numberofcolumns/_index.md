...
description: FieldIndex свойство. Получает или задает количество столбцов на странице используемых при построении индекса.
type: docs
weight: 100
...
Получает или задает количество столбцов на странице, используемых при построении индекса.
