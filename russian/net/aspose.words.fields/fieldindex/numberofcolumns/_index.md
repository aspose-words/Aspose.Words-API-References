...
description: Откройте для себя свойство FieldIndex NumberOfColumns, чтобы легко настроить макет индекса с оптимальными параметрами столбцов для повышения читабельности и производительности.
type: docs
weight: 100
url: /ru/net/aspose.words.fields/fieldindex/numberofcolumns/
---
## FieldIndex.NumberOfColumns property

Возвращает или задает количество столбцов на страницу, используемых при построении индекса.
