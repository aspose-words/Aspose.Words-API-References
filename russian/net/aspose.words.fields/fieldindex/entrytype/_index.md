...
description: Откройте для себя свойство FieldIndex EntryType для эффективного управления типами записей индекса для оптимизации индексации и повышения производительности поиска.
type: docs
weight: 40
...
Возвращает или задает тип записи индекса, используемый для построения индекса.
