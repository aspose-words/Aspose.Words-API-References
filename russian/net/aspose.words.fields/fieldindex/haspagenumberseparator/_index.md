...
description: FieldIndex HasPageNumberSeparator свойство. Получает значение указывающее переопределен ли разделитель номеров страниц с помощью кода поля на С#.
type: docs
weight: 50
