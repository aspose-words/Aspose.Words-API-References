...
description: Управляйте файлами без усилий с помощью свойства FieldIncludeText MimeType, позволяющего легко получать или задавать тип MIME для бесшовной интеграции.
type: docs
weight: 50
...
Возвращает или задает тип MIME указанного файла.
