...
description: Откройте для себя свойство FieldIncludeText Encoding, чтобы легко управлять кодировкой данных в ваших файлах. Улучшите обработку данных с помощью этой важной функции!
type: docs
weight: 30
url: /ru/net/aspose.words.fields/fieldincludetext/encoding/
---
## FieldIncludeText.Encoding property

Возвращает или задает кодировку, применяемую к данным в указанном файле.
