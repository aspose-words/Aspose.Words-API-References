...
description: FieldIncludeText Encoding свойство. Получает или задает кодировку применяемую к данным в указанном файле на С#.
type: docs
weight: 30
...
Получает или задает кодировку, применяемую к данным в указанном файле.
