...
description: Откройте для себя свойство FieldIncludeText SourceFullName для легкого управления расположениями документов с помощью IRI. Улучшите свой рабочий процесс и оптимизируйте обработку данных!
type: docs
weight: 70
...
Получает или задает местоположение документа с помощью IRI.
