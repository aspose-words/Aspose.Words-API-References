...
| Имя | Описание |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldincludetext/bookmarkname/) { get; set; } | Получает или задает имя закладки в документе, который необходимо включить. |
...
| [MimeType](../../aspose.words.fields/fieldincludetext/mimetype/) { get; set; } | Получает или задает тип MIME указанного файла. |
...
| [TextConverter](../../aspose.words.fields/fieldincludetext/textconverter/) { get; set; } | Получает или задает имя преобразователя текста для формата включенного файла. |
