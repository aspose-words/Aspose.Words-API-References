...
| [MimeType](../../aspose.words.fields/fieldincludetext/mimetype) { get; set; } | Получает или задает тип MIME файла, на который указывает ссылка. |
...
| [TextConverter](../../aspose.words.fields/fieldincludetext/textconverter) { get; set; } | Получает или задает имя преобразователя текста для формата включаемого файла. |
