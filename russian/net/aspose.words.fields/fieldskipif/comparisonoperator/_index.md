...
description: Откройте для себя свойство FieldSkipIf ComparisonOperator, легко управляйте и настраивайте операторы сравнения для улучшенной обработки данных.
type: docs
weight: 20
