...
description: Набор объектов FormField  которые представляют все поля формы в диапазоне.
type: docs
weight: 2430
...
Набор объектов **FormField** , которые представляют все поля формы в диапазоне.
...
| Имя | Описание |
| --- | --- |
| [Count](../../aspose.words.fields/formfieldcollection/count) { get; } | Возвращает количество полей формы в коллекции. |
| [Item](../../aspose.words.fields/formfieldcollection/item) { get; } | Возвращает поле формы по указанному индексу. (2 indexers) |
