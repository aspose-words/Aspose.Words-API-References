...
description: Легко удаляйте поля формы по имени с помощью метода FormFieldCollection Remove. Оптимизируйте управление данными с помощью этой простой в использовании функции!
type: docs
weight: 50
...
Удаляет поле формы с указанным именем.
...
| --- | --- | --- |
| formField | String | Нечувствительное к регистру имя поля формы, которое необходимо удалить. |
