...
description: Откройте для себя свойство FormFieldCollection Count, легко получайте доступ к общему количеству полей формы, улучшая управление данными и пользовательский интерфейс.
type: docs
weight: 10
