...
description: Создавайте эффективные отчеты без усилий с помощью метода ReportBuilder Create, разработанного для оптимизации процесса создания отчетов и повышения производительности.
type: docs
weight: 10
url: /ru/net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}

Создает новый экземпляр процессора построителя отчетов.
