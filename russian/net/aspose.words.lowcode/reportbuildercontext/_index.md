...
description: Откройте для себя класс Aspose.Words LowCode ReportBuilderContext для бесшовной генерации документов с помощью LINQ Reporting Engine. Улучшите свой рабочий процесс сегодня.
type: docs
weight: 4370
url: /ru/net/aspose.words.lowcode/reportbuildercontext/
---
## ReportBuilderContext class

Контекст LINQ Reporting Engine.
...
| Имя | Описание |
| --- | --- |
| [ReportBuilderContext](reportbuildercontext/)() | Конструктор по умолчанию. |

## Характеристики

| Имя | Описание |
| --- | --- |
| [DataSources](../../aspose.words.lowcode/reportbuildercontext/datasources/) { get; } | Источники данных, использованные для построения отчета. |
...
| [ReportBuilderOptions](../../aspose.words.lowcode/reportbuildercontext/reportbuilderoptions/) { get; } | Параметры построения отчета. |
