...
description: Откройте для себя свойство DataSources ReportBuilderContext для удобного создания отчетов с использованием универсальных источников данных, соответствующих вашим потребностям.
type: docs
weight: 20
url: /ru/net/aspose.words.lowcode/reportbuildercontext/datasources/
---
## ReportBuilderContext.DataSources property

Источники данных, использованные для построения отчета.
...
Ключ представляет источник данных, а значение — имя источника данных. Имя источника данных может быть нулевым или пустой строкой; в таких случаях механизм создания отчетов автоматически определит имя источника данных из указанного источника данных.
