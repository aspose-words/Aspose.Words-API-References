...
description: Откройте для себя ReportBuilderContext ReportBuilderOptions для эффективного создания отчетов с настраиваемыми функциями и расширенной функциональностью для ваших проектов.
type: docs
weight: 30
url: /ru/net/aspose.words.lowcode/reportbuildercontext/reportbuilderoptions/
---
