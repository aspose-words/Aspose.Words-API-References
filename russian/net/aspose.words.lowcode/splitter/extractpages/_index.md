...
description: Легко извлекайте определенные страницы из любого документа с помощью нашего метода Splitter ExtractPages. Сохраняйте их в желаемом формате для легкого доступа!
type: docs
weight: 20
url: /ru/net/aspose.words.lowcode/splitter/extractpages/
---
