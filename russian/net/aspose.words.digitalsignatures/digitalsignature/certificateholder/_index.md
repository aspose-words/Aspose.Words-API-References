...
description: Откройте для себя свойство DigitalSignature CertificateHolder, которое извлекает объект владельца сертификата для повышения безопасности и проверки подписи документов.
type: docs
weight: 10
