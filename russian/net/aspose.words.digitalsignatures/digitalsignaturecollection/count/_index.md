...
description: Откройте для себя свойство DigitalSignatureCollection Count, эффективно извлекайте общее количество элементов, улучшая управление цифровыми подписями.
type: docs
weight: 20
url: /ru/net/aspose.words.digitalsignatures/digitalsignaturecollection/count/
---
