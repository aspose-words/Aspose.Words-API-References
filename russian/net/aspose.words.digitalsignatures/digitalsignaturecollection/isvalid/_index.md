...
description: Возвращает true  если все цифровые подписи в этой коллекции действительны и документ не был подделан Также возвращает true  если нет цифровых подписей. Возвращает false  если хотя бы одна цифровая подпись недействительна.
type: docs
weight: 30
...
Возвращает` true` , если все цифровые подписи в этой коллекции действительны и документ не был подделан Также возвращает` true` , если нет цифровых подписей. Возвращает` false` , если хотя бы одна цифровая подпись недействительна.
