...
description: Обеспечьте целостность документа с помощью свойства IsValid DigitalSignatureCollection. Оно проверяет, что все подписи действительны и не подделаны, что повышает безопасность.
type: docs
weight: 30
...
Возврат`истинный`если все цифровые подписи в этой коллекции действительны и документ не был подделан Также возвращает`истинный` если нет цифровых подписей. Возвращает`ЛОЖЬ` если хотя бы одна цифровая подпись недействительна.
