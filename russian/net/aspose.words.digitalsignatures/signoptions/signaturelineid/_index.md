...
description: Откройте для себя свойство SignatureLineId в SignOptions. Легко идентифицируйте строки подписи с помощью уникального GUID, повышая эффективность управления документами.
type: docs
weight: 50
...
Идентификатор строки подписи. Значение по умолчанию:**Пусто (все нули) Guid** .
...
При установке он ассоциируется[`SignatureLine`](../../../aspose.words.drawing/signatureline/) с соответствующим[`DigitalSignature`](../../digitalsignature/) .
