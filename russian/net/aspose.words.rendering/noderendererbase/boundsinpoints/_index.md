...
description: Получает фактические границы фигуры в точках.
type: docs
weight: 10
...
Это свойство возвращает фактический (отображаемый на странице) ограничивающий прямоугольник фигуры. Границы учитывают вращение фигуры (если есть).
