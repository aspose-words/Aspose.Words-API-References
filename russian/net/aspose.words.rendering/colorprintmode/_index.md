...
description: Aspose.Words.Rendering.ColorPrintMode перечисление. Указывает как печатаются нецветные страницы если устройство поддерживает цветную печать.
type: docs
weight: 4540
