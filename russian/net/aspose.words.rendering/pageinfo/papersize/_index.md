...
description: Откройте для себя свойство PageInfo PaperSize, чтобы легко получить размеры бумаги в виде перечисления. Расширьте свои возможности печати сегодня!
type: docs
weight: 40
...
Получает размер бумаги как перечисление.
