...
description: Откройте для себя свойство HeightInPoints PageInfo, чтобы легко получить доступ к высоте страницы в пунктах. Улучшите макет документа с помощью точных измерений!
type: docs
weight: 20
