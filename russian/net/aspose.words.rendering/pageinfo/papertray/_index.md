...
description: Откройте для себя свойство PageInfo PaperTray для доступа к определенному лотку для бумаги для вашего документа. Повысьте эффективность печати с помощью индивидуальных решений!
type: docs
weight: 50
