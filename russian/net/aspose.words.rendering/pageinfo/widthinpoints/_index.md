...
description: Откройте для себя свойство PageInfo WidthInPoints, которое позволяет легко получить ширину страницы в пунктах, улучшая форматирование документа и точность макета.
type: docs
weight: 70
url: /ru/net/aspose.words.rendering/pageinfo/widthinpoints/
---
