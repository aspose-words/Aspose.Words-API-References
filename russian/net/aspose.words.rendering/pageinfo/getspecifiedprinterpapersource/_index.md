...
description: ПолучаетPaperSource объект подходящий для печати страницы представленной этимPageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
ПолучаетPaperSource объект, подходящий для печати страницы, представленной этим[`PageInfo`](../../pageinfo) .
