...
description: Указывает на наличие трехмерного затенения для горизонтальной линейки. Если true то горизонтальная линейка не имеет трехмерного затенения и используется сплошной цвет.
type: docs
weight: 40
