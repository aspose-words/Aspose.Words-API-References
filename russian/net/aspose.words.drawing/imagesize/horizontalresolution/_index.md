...
description: Откройте для себя свойство ImageSize HorizontalResolution, чтобы легко получить разрешение DPI для ваших изображений, повысив качество и точность ваших проектов.
type: docs
weight: 40
