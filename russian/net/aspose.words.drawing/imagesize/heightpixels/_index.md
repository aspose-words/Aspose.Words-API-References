...
description: Откройте для себя свойство ImageSize HeightPixels, чтобы легко получить доступ к высоте изображения в пикселях и оптимизировать ее для повышения производительности и качества.
type: docs
weight: 20
