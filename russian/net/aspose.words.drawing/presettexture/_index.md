...
description: Указывает текстуру которая будет использоваться для заполнения формы.
type: docs
weight: 1050
...
| --- | --- | --- |
| None | `-1` | Нет текстуры. |
| BlueTissuePaper | `1` | Синяя текстура папиросной бумаги. |
