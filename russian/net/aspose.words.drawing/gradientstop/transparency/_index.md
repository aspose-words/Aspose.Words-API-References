...
description: Получает или задает значение представляющее прозрачность градиентной заливки  выраженную в процентах в диапазоне от 00 до 10.
type: docs
weight: 40
...
Получает или задает значение, представляющее прозрачность градиентной заливки , выраженную в процентах в диапазоне от 0,0 до 1,0.
