...
description: Получает или задает значение представляющее положение остановки в пределах градиента  выраженное в процентах в диапазоне от 00 до 10.
type: docs
weight: 30
...
Получает или задает значение, представляющее положение остановки в пределах градиента , выраженное в процентах в диапазоне от 0,0 до 1,0.
