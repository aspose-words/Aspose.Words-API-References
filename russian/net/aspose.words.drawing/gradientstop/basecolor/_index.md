...
description: Откройте для себя свойство GradientStop BaseColor, чтобы легко получить доступ к чистому цвету остановки градиента, улучшая ваш дизайн за счет точности и четкости.
type: docs
weight: 20
...
Получает значение, представляющее цвет остановки градиента без каких-либо модификаторов.
