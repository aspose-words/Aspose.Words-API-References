...
description: Управляйте градиентами без усилий с помощью метода GradientStop Remove, упрощающего удаление точек остановки градиента из любой коллекции GradientStopCollection.
type: docs
weight: 60
...
Удаляет точку остановки градиента из родительского объекта[`GradientStopCollection`](../../gradientstopcollection/) .
