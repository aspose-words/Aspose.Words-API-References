...
description: Откройте для себя свойство GradientStop Color, позволяющее легко устанавливать и настраивать цвета остановок градиента для создания потрясающих визуальных эффектов в ваших проектах.
type: docs
weight: 30
...
Возвращает или задает значение, представляющее цвет остановки градиента.
