...
description: GradientStop Color свойство. Получает или задает значение представляющее цвет остановки градиента на С#.
type: docs
weight: 30
...
Получает или задает значение, представляющее цвет остановки градиента.
