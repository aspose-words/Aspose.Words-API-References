...
description: Предоставляет доступ к свойствам диаграммы если эта фигура имеет диаграмму.
type: docs
weight: 20
...
Предоставляет доступ к свойствам диаграммы, если эта фигура имеет диаграмму.
...
Это свойство возвращает объект`Chart`, только если[`HasChart`](../haschart) имеет значение true для этой фигуры, в противном случае будет выдано исключение.
