...
description: Откройте для себя свойство Shape NodeType, которое возвращает Shape, повышая гибкость вашего дизайна и оптимизируя визуальную привлекательность вашего проекта.
type: docs
weight: 140
