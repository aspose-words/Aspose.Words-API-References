...
description: Откройте для себя метод Shape AcceptStart, который плавно направляет посетителей к началу вашего дизайна, повышая вовлеченность и пользовательский опыт.
type: docs
weight: 270
url: /ru/net/aspose.words.drawing/shape/acceptstart/
---
## Shape.AcceptStart method

Принимает посетителя для посещения начала фигуры.
