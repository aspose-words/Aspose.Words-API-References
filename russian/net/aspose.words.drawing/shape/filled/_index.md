...
description: Управляйте эстетикой формы с помощью свойства «Заливка формы», определяя, будут ли заполнены замкнутые контуры, что повышает гибкость дизайна и визуальную привлекательность.
type: docs
weight: 60
