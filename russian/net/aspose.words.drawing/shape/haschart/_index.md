...
description: Узнайте, есть ли у вашей формы диаграмма со свойством HasChart. Улучшите визуализацию данных без усилий!
type: docs
weight: 80
...
Возврат`истинный` если это[`Shape`](../) имеет[`Chart`](../../../aspose.words.drawing.charts/chart/) .
