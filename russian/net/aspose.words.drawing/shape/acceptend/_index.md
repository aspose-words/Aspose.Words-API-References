...
description: Откройте для себя метод Shape AcceptEnd, который позволяет плавно направлять посетителей к концу фигуры, улучшая пользовательский опыт и взаимодействие.
type: docs
weight: 260
url: /ru/net/aspose.words.drawing/shape/acceptend/
---
## Shape.AcceptEnd method

Принимает посетителя для посещения конца фигуры.
