...
description: Настройте свой WordArt с помощью свойства Shape TextPath, чтобы улучшить визуальную привлекательность и легко создавать потрясающие текстовые эффекты.
type: docs
weight: 240
url: /ru/net/aspose.words.drawing/shape/textpath/
---
