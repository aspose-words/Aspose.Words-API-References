...
description: Откройте для себя свойство GroupShape NodeType, которое эффективно возвращает GroupShape, повышая гибкость проектирования и функциональность проектов.
type: docs
weight: 20
