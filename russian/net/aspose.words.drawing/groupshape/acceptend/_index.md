...
description: Откройте для себя метод GroupShape AcceptEnd, легко управляйте взаимодействиями посетителей и улучшайте пользовательский опыт вашего приложения с помощью этой мощной функции.
type: docs
weight: 40
url: /ru/net/aspose.words.drawing/groupshape/acceptend/
---
## GroupShape.AcceptEnd method

Принимает посетителя для посещения конца GroupShape.
