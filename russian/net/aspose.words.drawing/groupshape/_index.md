...
description: Откройте для себя класс Aspose.Words.Drawing.GroupShape, который позволит вам легко управлять сгруппированными фигурами в документах и манипулировать ими для повышения визуальной привлекательности.
type: docs
weight: 1350
...
Чтобы узнать больше, посетите[Как добавить групповую фигуру в документ Word](https://docs.aspose.com/words/net/how-to-add-group-shape-into-a-word-document/) документальная статья.
...
| Имя | Описание |
| --- | --- |
| [GroupShape](groupshape/)(*[DocumentBase](../../aspose.words/documentbase/)*) | Создает новую групповую фигуру. |
...
| override [NodeType](../../aspose.words.drawing/groupshape/nodetype/) { get; } | ВозвратGroupShape . |
...
| override [AcceptEnd](../../aspose.words.drawing/groupshape/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Принимает посетителя для посещения конца GroupShape. |
| override [AcceptStart](../../aspose.words.drawing/groupshape/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Принимает посетителя для посещения начала GroupShape. |
...
А`GroupShape` является составным узлом и может иметь[`Shape`](../shape/) и `GroupShape` узлы как дочерние.
