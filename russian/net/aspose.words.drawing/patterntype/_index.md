...
description: Задает шаблон заливки который будет использоваться для заливки фигуры.
type: docs
weight: 1040
...
Задает шаблон заливки, который будет использоваться для заливки фигуры.
...
| --- | --- | --- |
| None | `-1` | Нет шаблона. |
| Percent10 | `1` | 10% основного цвета. |
| Percent20 | `2` | 20% основного цвета. |
| Percent25 | `3` | 25% основного цвета. |
| Percent30 | `4` | 30% основного цвета. |
| Percent40 | `5` | 40% основного цвета |
| Percent50 | `6` | 50% основного цвета |
...
| DashedDownwardDiagonal | `18` | Начертано по диагонали вниз. |
...
| LightVertical | `37` | Светлый вертикальный. |
| NarrowHorizontal | `38` | Узкая горизонтальная. |
