...
description: Откройте для себя свойство ShapeBase TopRelative для легкого управления позиционированием фигур. Настройте свой дизайн с точными верхними процентными значениями для оптимальной компоновки.
type: docs
weight: 590
url: /ru/net/aspose.words.drawing/shapebase/toprelative/
---
## ShapeBase.TopRelative property

Возвращает или задает значение, представляющее относительное верхнее положение фигуры в процентах.
