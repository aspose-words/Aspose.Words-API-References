...
description: Откройте для себя свойство ShapeBase BoundsWithEffects, чтобы получить окончательные размеры вашей фигуры после применения эффектов рисования, измеренные в точках для большей точности.
type: docs
weight: 90
...
Получает окончательную протяженность объекта-фигуры после применения эффектов рисования. Значение измеряется в точках.
