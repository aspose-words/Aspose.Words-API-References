...
description: Откройте для себя свойство ShapeBase HeightRelative, которое позволяет легко управлять высотой фигуры в процентах, повышая гибкость и точность вашего дизайна.
type: docs
weight: 220
...
Возвращает или задает значение, представляющее процент относительной высоты фигуры.
