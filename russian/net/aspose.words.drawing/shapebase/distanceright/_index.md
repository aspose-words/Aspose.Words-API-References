...
description: Откройте для себя свойство ShapeBase DistanceRight, с легкостью настройте расстояние в точках между текстом документа и правым краем фигуры для улучшенного управления макетом.
type: docs
weight: 150
url: /ru/net/aspose.words.drawing/shapebase/distanceright/
---
