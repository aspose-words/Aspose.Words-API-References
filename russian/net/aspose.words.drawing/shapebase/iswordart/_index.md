...
description: Узнайте, является ли ваша фигура объектом WordArt с помощью ShapeBase. Получайте точные результаты и улучшайте свои дизайн-проекты без усилий!
type: docs
weight: 380
...
Возврат`истинный` если эта фигура является объектом WordArt.
...
Работает до режима совместимости с 2007. В режиме совместимости с 2010 и выше WordArt — это просто TextBox с красивыми шрифтами.
