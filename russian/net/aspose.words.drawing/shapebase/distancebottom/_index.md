...
description: Откройте для себя свойство ShapeBase DistanceBottom, с легкостью устанавливайте и корректируйте зазор в точках между текстом документа и нижним краем фигуры для оптимальной компоновки.
type: docs
weight: 130
