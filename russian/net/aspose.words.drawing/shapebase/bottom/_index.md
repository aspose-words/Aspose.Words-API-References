...
description: Откройте для себя свойство ShapeBase Bottom, чтобы легко получить доступ к положению нижнего края содержащего блока вашей фигуры для точного управления дизайном.
type: docs
weight: 60
