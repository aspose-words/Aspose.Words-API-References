...
description: Откройте для себя свойство ShapeBase LeftRelative, чтобы легко настроить относительное левое положение фигур в процентах. Повысьте точность своего дизайна сегодня!
type: docs
weight: 400
...
Возвращает или задает значение, представляющее относительное левое положение фигуры в процентах.
