...
description: Откройте для себя свойство ShapeBase CoordSize, определяющее ширину и высоту координатного пространства для оптимального управления компоновкой в ваших дизайн-проектах.
type: docs
weight: 120
