...
description: Возвращает или задает расстояние в пунктах между текстом документа и верхним краем фигуры.
type: docs
weight: 160
...
Показывает, как установить расстояние переноса текста, окружающего фигуру.
