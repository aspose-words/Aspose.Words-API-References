...
description: Откройте для себя свойство ShapeBase DistanceTop, легко настройте расстояние в точках между текстом документа и верхним краем фигуры для точного управления макетом.
type: docs
weight: 160
