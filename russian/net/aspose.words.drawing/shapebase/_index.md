...
description: Aspose.Words.Drawing.ShapeBase сорт. Базовый класс для объектов в слое рисования таких как AutoShape произвольная форма объект OLE элемент управления ActiveX или изображение.
type: docs
weight: 1110
