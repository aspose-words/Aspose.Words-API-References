...
description: Aspose.Words.Drawing.ShapeBase сорт. Базовый класс для объектов в слое рисования таких как автофигура произвольная форма объект OLE элемент управления ActiveX или изображение на С#.
type: docs
weight: 1260
