...
description: Оптимизируйте свои изображения с помощью ImageData CropTop, контролируя удаление изображения сверху для идеального кадрирования и повышения визуальной привлекательности.
type: docs
weight: 90
