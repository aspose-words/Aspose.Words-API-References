...
description: Отрегулируйте яркость изображения с помощью свойства ImageData Brightness. Установите значения от 0,0 (самый тусклый) до 1,0 (самый яркий) для оптимального визуального воздействия.
type: docs
weight: 30
...
Возвращает или задает яркость изображения. Значение этого свойства должно быть числом от 0,0 (самый тусклый) до 1,0 (самый яркий).
