...
description: Откройте для себя свойство ImageData IsLinkOnly, которое указывает, имеет ли изображение внешнюю ссылку, что повышает эффективность работы с документами и управление хранилищем.
type: docs
weight: 160
url: /ru/net/aspose.words.drawing/imagedata/islinkonly/
---
## ImageData.IsLinkOnly property

Возврат`истинный` если изображение связано и не сохранено в документе.
