...
description: ImageData IsLinkOnly свойство. Возвращаетистинный если изображение связано и не сохранено в документе на С#.
type: docs
weight: 160
...
Возвращает`истинный` если изображение связано и не сохранено в документе.
