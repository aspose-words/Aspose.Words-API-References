...
description: Откройте для себя свойство ImageData CropBottom, которое позволяет легко настраивать изображения, удаляя ненужные части в нижней части для идеальной подгонки.
type: docs
weight: 60
url: /ru/net/aspose.words.drawing/imagedata/cropbottom/
---
