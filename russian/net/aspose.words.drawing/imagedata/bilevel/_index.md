...
description: Откройте для себя свойство ImageData BiLevel, позволяющее легко управлять отображением черно-белых изображений и точно улучшать визуальный контент.
type: docs
weight: 10
...
Определяет, будет ли изображение отображаться в черно-белом варианте.
