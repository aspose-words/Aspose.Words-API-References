...
description: ImageData свойство. Получает набор границ изображения. Границы действуют только для встроенных изображений.
type: docs
weight: 20
...
Получает набор границ изображения. Границы действуют только для встроенных изображений.
