...
description: Откройте для себя свойство ImageData GrayScale для улучшения ваших изображений. Управляйте отображением оттенков серого для потрясающих визуальных эффектов и улучшения взаимодействия с пользователем.
type: docs
weight: 100
url: /ru/net/aspose.words.drawing/imagedata/grayscale/
---
## ImageData.GrayScale property

Определяет, будет ли изображение отображаться в оттенках серого.
