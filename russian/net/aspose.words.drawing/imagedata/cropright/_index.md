...
description: Откройте для себя свойство ImageData CropRight, управляйте обрезкой изображений с правой стороны для точного редактирования изображений и повышения их визуальной привлекательности.
type: docs
weight: 80
