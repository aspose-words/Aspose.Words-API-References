...
description: Узнайте, как свойство ImageData IsLink улучшает ваш дизайн, бесшовно связывая изображения с фигурами, когда установлено SourceFullName. Повысьте свою креативность!
type: docs
weight: 150
...
Возврат`истинный` если изображение связано с формой (когда[`SourceFullName`](../sourcefullname/) указано).
