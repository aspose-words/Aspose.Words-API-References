...
description: Легко настройте контрастность изображения с помощью свойства ImageData Contrast. Установите значения от 0,0 (низкий) до 1,0 (высокий) для оптимальной четкости и качества изображения.
type: docs
weight: 50
...
Возвращает или задает контрастность для указанного изображения. Значение для этого свойства должно быть числом от 0,0 (наименьший контраст) до 1,0 (наибольший контраст).
