...
description: Получает или задает контраст для указанного изображения. Значение для этого свойства должно быть числом от 00 наименьший контраст до 10 наибольший контраст.
type: docs
weight: 50
