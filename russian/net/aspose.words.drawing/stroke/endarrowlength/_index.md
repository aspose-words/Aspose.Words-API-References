...
description: Откройте для себя свойство Stroke EndArrowLength, чтобы настроить свой дизайн с помощью точной длины наконечника стрелы, повысив визуальную четкость и стиль.
type: docs
weight: 80
url: /ru/net/aspose.words.drawing/stroke/endarrowlength/
---
## Stroke.EndArrowLength property

Определяет длину наконечника стрелки в конце штриха.
