...
description: SignatureLine свойство. Получает или задает предлагаемый титул подписавшего например Менеджер. Значение по умолчанию для этого свойства пустой строки Empty .
type: docs
weight: 110
...
Получает или задает предлагаемый титул подписавшего (например, Менеджер). Значение по умолчанию для этого свойства: **пустой строки** (Empty ).
