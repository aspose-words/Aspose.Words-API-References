...
description: Настройте SignerTitle в SignatureLine, чтобы улучшить документооборот. Задайте предлагаемые заголовки, например «Менеджер», для упрощения процесса подписания.
type: docs
weight: 110
...
Возвращает или задает предлагаемую должность подписчика (например, Менеджер). Значение по умолчанию для этого свойства:**пустая строка** (Empty ).
