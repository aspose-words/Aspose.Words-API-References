...
description: SignatureLine свойство. Получает или задает идентификатор поставщика подписи для этой строки подписи. Значение по умолчанию 00000000000000000000000000000000.
type: docs
weight: 80
