...
description: Откройте для себя свойство SignatureLine ProviderId для простого управления идентификаторами поставщиков подписей. Упростите свой рабочий процесс с помощью нашей настройки по умолчанию.
type: docs
weight: 80
...
Возвращает или задает идентификатор поставщика подписи для этой строки подписи. Значение по умолчанию: "{00000000-0000-0000-0000-0000000000000}".
