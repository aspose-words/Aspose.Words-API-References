...
description: Улучшите свои документы с помощью свойства SignatureLine Signer. Легко задавайте предлагаемых подписчиков для строк подписи, оптимизируя процесс подписания без усилий.
type: docs
weight: 100
...
Возвращает или задает предлагаемого подписчика строки подписи. Значение по умолчанию для этого свойства:**пустая строка** (Empty ).
