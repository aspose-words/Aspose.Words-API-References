...
description: Получает аспект отрисовки объекта OLE. Когда истинный  объект OLE отображается в виде значка. Когда ЛОЖЬ  объект OLE отображается как содержимое.
type: docs
weight: 70
