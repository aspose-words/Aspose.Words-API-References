...
description: Получает заголовок значка объекта OLE.
type: docs
weight: 30
...
В случае, если объект OLE не встроен, так как невозможно получить значок или заголовок, возвращает пустую строку.
