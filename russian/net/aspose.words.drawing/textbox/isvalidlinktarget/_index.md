...
description: Узнайте, может ли ваш TextBox ссылаться на цель с помощью метода IsValidLinkTarget. Улучшите функциональность вашего пользовательского интерфейса без усилий!
type: docs
weight: 140
...
Определяет, является ли это[`TextBox`](../) может быть связан с целью[`TextBox`](../) .
