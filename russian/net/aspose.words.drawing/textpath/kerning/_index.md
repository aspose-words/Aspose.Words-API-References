...
description: Откройте для себя свойство TextPath Kerning, позволяющее улучшить типографику путем управления параметрами кернинга для повышения читаемости текста и качества дизайна.
type: docs
weight: 60
url: /ru/net/aspose.words.drawing/textpath/kerning/
---
