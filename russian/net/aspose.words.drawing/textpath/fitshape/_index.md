...
description: TextPath FitShape свойство. Определяет помещается ли текст в ограничивающую рамку фигуры на С#.
type: docs
weight: 30
...
Определяет, помещается ли текст в ограничивающую рамку фигуры.
