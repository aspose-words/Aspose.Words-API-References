...
description: Узнайте, как свойство TextPath FitShape обеспечивает идеальное вписывание текста в ограничивающую рамку фигуры, повышая гибкость дизайна.
type: docs
weight: 30
url: /ru/net/aspose.words.drawing/textpath/fitshape/
---
## TextPath.FitShape property

Определяет, вписывается ли текст в ограничивающую рамку фигуры.
