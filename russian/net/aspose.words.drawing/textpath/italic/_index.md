...
description: Откройте для себя свойство TextPath Italic. Легко проверьте, имеет ли ваш шрифт курсивное начертание для улучшения дизайна и читаемости текста. Улучшите свою типографику сегодня!
type: docs
weight: 50
