...
description: Откройте для себя свойство TextPath Trim, которое поможет вам улучшить свой дизайн, удалив ненужное пространство над и под текстом, чтобы получить более чистый и изысканный вид.
type: docs
weight: 180
