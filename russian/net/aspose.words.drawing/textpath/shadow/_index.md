...
description: TextPath Shadow свойство. Определяет применяется ли тень к тексту на пути к тексту на С#.
type: docs
weight: 110
...
Определяет, применяется ли тень к тексту на пути к тексту.
