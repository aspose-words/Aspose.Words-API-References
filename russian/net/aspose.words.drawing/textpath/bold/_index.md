...
description: Откройте для себя свойство TextPath Bold. Легко форматируйте текст жирным шрифтом для улучшения читаемости и визуального эффекта в ваших проектах.
type: docs
weight: 10
url: /ru/net/aspose.words.drawing/textpath/bold/
---
