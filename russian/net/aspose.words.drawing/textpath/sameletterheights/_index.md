...
description: Откройте для себя свойство TextPath SameLetterHeights, которое обеспечивает одинаковую высоту букв, улучшает читаемость текста и единообразие дизайна во всем проекте.
type: docs
weight: 100
