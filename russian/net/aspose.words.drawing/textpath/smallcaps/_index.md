...
description: Откройте для себя свойство TextPath SmallCaps, легко форматируйте шрифты, превращая их в маленькие заглавные буквы, для улучшения читаемости и стильного оформления текста.
type: docs
weight: 130
url: /ru/net/aspose.words.drawing/textpath/smallcaps/
---
