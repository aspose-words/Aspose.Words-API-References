...
description: Изучите свойство Text класса TextPath, чтобы с легкостью определять и настраивать текстовые контуры для создания потрясающих визуальных эффектов в ваших проектах.
type: docs
weight: 160
