...
description: Узнайте, как свойство TextPath XScale улучшает ваш дизайн, позволяя создавать прямые текстовые пути для более плавных и точных макетов.
type: docs
weight: 200
...
Определяет, будет ли использоваться прямой текстовый контур вместо контура фигуры.
...
Если`истинный`, текст располагается слева направо вдоль значения x нижней границы фигуры.
