...
description: TextPath свойство. Определяет будет ли использоваться прямой текстовый путь вместо контура формы.
type: docs
weight: 200
...
Если **истинный**, текст проходит по пути слева направо вдоль значения x нижней границы фигуры.
