...
description: Определяет будет ли использоваться прямой текстовый путь вместо контура фигуры.
type: docs
weight: 200
...
Определяет, будет ли использоваться прямой текстовый путь вместо контура фигуры.
...
Если **true** , текст проходит по пути слева направо по значению x нижняя граница формы.
