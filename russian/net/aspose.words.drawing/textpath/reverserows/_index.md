...
description: Откройте для себя свойство TextPath ReverseRows, чтобы улучшить свой макет. Управляйте порядком строк для повышения гибкости дизайна и удобства для пользователя.
type: docs
weight: 80
