...
description: Откройте для себя свойство TextPath FontFamily, которое позволит вам легко определять и настраивать текстовые контуры для создания потрясающей типографики в веб-дизайне.
type: docs
weight: 40
