...
description: Откройте для себя свойство GradientStopCollection Count, которое отображает общее количество элементов, улучшая управление данными и эффективность проектирования пользовательского интерфейса.
type: docs
weight: 10
