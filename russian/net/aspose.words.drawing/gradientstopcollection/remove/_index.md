...
description: Легко удалите определенный GradientStop из вашей коллекции с помощью метода GradientStopCollection Remove. Оптимизируйте свой процесс проектирования сегодня!
type: docs
weight: 60
