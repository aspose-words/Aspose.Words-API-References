...
description: Легко управляйте GradientStopCollection с помощью метода RemoveAt. Легко удаляйте GradientStops по индексу для упрощенного управления дизайном.
type: docs
weight: 70
