...
description: Получает или задает значение которое равно true  если форматирование примененное к этому экземпляру видимо.
type: docs
weight: 150
...
Получает или задает значение, которое равно` true` , если форматирование, примененное к этому экземпляру, видимо.
