...
description: Узнайте, как улучшить свои проекты с помощью свойства GradientStops, включающего коллекцию объектов GradientStop для создания потрясающих эффектов заливки.
type: docs
weight: 110
