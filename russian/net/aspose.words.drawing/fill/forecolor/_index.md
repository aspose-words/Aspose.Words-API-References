...
description: Fill свойство. Получает или задает объект Color представляющий цвет переднего плана для заливки.
type: docs
weight: 30
...
Получает или задает объект Color, представляющий цвет переднего плана для заливки.
