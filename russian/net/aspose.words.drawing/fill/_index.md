...
| [ForeThemeColor](../../aspose.words.drawing/fill/forethemecolor/) { get; set; } | Получает или задает объект ThemeColor, который представляет цвет переднего плана для заливки. |
| [ForeTintAndShade](../../aspose.words.drawing/fill/foretintandshade/) { get; set; } | Получает или задает двойное значение, которое осветляет или затемняет цвет переднего плана. |
...
| [Opacity](../../aspose.words.drawing/fill/opacity/) { get; set; } | Получает или задает степень непрозрачности указанной заливки как значение от 0,0 (прозрачный) до 1,0 (непрозрачный). |
...
| [RotateWithObject](../../aspose.words.drawing/fill/rotatewithobject/) { get; set; } | Получает или задает, вращается ли заливка вместе с указанным объектом. |
...
| [Transparency](../../aspose.words.drawing/fill/transparency/) { get; set; } | Получает или задает степень прозрачности указанной заливки как значение от 0,0 (непрозрачный) до 1,0 (прозрачный). |
| [Visible](../../aspose.words.drawing/fill/visible/) { get; set; } | Получает или задает значение,`истинный` если форматирование, примененное к этому экземпляру, видимо. |
