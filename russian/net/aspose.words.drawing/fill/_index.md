...
description: Aspose.Words.Drawing.Fill сорт. Представляет форматирование заливки для объекта.
type: docs
weight: 820
...
Использовать[`Fill`](../shapebase/fill/) или же[`Fill`](../../aspose.words/font/fill/) свойство для доступа к свойствам заливки объекта. Вы не создаете экземпляры`Fill` класс напрямую.
