...
description: Узнайте, как улучшить свои проекты с помощью свойства GradientStyle для потрясающих эффектов заливки. Поднимите свои проекты на новый уровень с помощью ярких градиентов!
type: docs
weight: 120
...
Получает стиль градиента[`GradientStyle`](../../gradientstyle/) для заполнения.
