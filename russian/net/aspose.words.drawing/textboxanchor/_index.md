...
description: Задает значения используемые для вертикального выравнивания фигурного текста.
type: docs
weight: 1160
...
Задает значения, используемые для вертикального выравнивания фигурного текста.
