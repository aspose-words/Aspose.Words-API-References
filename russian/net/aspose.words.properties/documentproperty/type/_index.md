...
description: Откройте для себя тип DocumentProperty, чтобы эффективно извлекать и использовать типы данных свойств для улучшенного управления документами и автоматизации.
type: docs
weight: 40
