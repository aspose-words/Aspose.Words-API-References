...
description: Откройте для себя свойство BuiltInDocumentProperties Lines — ваш ключ к эффективной оценке количества строк документа для лучшего управления контентом.
type: docs
weight: 190
url: /ru/net/aspose.words.properties/builtindocumentproperties/lines/
---
## BuiltInDocumentProperties.Lines property

Представляет собой оценку количества строк в документе.
