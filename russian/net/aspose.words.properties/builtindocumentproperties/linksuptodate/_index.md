...
description: Откройте для себя функцию BuiltInDocumentProperties LinksUpToDate, обеспечивающую актуальность гиперссылок вашего документа и повышающую надежность вашего контента.
type: docs
weight: 200
