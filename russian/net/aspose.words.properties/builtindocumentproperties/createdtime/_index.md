...
description: Откройте для себя функцию BuiltInDocumentProperties CreatedTime, которая позволяет легко получать доступ к дате создания документа в формате UTC и управлять ею для лучшей организации.
type: docs
weight: 100
...
Возвращает или задает дату создания документа в формате UTC.
...
Для документов, созданных в формате RTF, это свойство возвращает локальное время компьютера автора на момент создания документа.
