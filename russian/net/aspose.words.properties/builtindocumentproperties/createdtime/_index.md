...
description: BuiltInDocumentProperties свойство. Получает или устанавливает дату создания документа в формате UTC.
type: docs
weight: 100
...
Получает или устанавливает дату создания документа в формате UTC.
