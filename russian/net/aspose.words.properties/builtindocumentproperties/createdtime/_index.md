...
description: Получает или устанавливает дату создания документа в формате UTC.
type: docs
weight: 100
...
Для документов, созданных в формате RTF, это свойство возвращает местное время машины автора на момент создание документа.
