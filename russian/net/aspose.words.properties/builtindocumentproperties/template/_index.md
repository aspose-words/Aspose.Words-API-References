...
Чтобы получить или задать фактическое имя прикрепленного шаблона, используйте СвойствоAttachedTemplate.

### Примеры

Показывает, как работать со свойствами документа в Категория «Происхождение».
