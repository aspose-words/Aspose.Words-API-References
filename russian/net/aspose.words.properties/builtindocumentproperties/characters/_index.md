...
description: Откройте для себя свойство BuiltInDocumentProperties Characters, обеспечивающее точную оценку количества символов для улучшения управления документами и повышения эффективности.
type: docs
weight: 40
...
Представляет собой оценку количества символов в документе.
