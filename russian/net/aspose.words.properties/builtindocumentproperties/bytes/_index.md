...
description: Откройте для себя свойство BuiltInDocumentProperties Bytes — важный инструмент для оценки размера документа, улучшения управления файлами и повышения эффективности.
type: docs
weight: 20
