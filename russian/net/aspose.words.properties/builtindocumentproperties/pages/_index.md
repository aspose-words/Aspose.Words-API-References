...
description: Откройте для себя свойство BuiltInDocumentProperties Pages, предлагающее точную оценку количества страниц вашего документа для эффективного управления и организации.
type: docs
weight: 230
...
Представляет собой оценку количества страниц в документе.
