...
description: Узнайте, как эффективно управлять свойством BuiltInDocumentProperties Subject, чтобы легко задать или получить тему документа для лучшей организации.
type: docs
weight: 290
