...
description: Откройте для себя свойство BuiltInDocumentProperties Words, предлагающее точную оценку количества слов в ваших документах для повышения эффективности редактирования.
type: docs
weight: 360
...
Представляет собой оценку количества слов в документе.
