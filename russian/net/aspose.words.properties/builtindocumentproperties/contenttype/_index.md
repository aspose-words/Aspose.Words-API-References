...
description: Узнайте, как использовать свойство BuiltInDocumentProperties ContentType для эффективного управления типом содержимого документа и улучшения его организации.
type: docs
weight: 90
...
Возвращает или задает тип содержимого документа.
