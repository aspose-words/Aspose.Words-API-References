...
description: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints method. Получает фактический размер формы в пунктах в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
...
Это свойство возвращает размер фактической (как отрисованной на странице) ограничивающей рамки формы. Размер учитывает вращение формы (если есть).
