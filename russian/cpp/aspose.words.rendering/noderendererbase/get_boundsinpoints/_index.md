...
description: "Aspose::Words::Rendering::NodeRendererBase::get_BoundsInPoints method. Получает фактические границы формы в пунктах в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.rendering/noderendererbase/get_boundsinpoints/
---
...
Это свойство возвращает фактическую (как отрисованную на странице) ограничивающую рамку формы. Границы учитывают вращение формы (если есть).
