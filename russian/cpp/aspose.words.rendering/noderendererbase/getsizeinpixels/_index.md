...
description: "Aspose::Words::Rendering::NodeRendererBase::GetSizeInPixels method. Вычисляет размер фигуры в пикселях для указанного коэффициента масштабирования и разрешения в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.rendering/noderendererbase/getsizeinpixels/
---
...
Этот метод преобразует [SizeInPoints](../get_sizeinpoints/) в размер в пикселях и полезен, когда вы хотите создать растровое изображение для аккуратного рендеринга фигуры на битмапе.
