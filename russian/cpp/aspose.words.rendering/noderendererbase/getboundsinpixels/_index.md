...
description: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels method. Вычисляет границы фигуры в пикселях для указанного коэффициента масштабирования и разрешения в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.rendering/noderendererbase/getboundsinpixels/
---
...
Фактическая (как отображается на странице) ограничивающая рамка фигуры в пикселях.
## Примечания


Этот метод преобразует [BoundsInPoints](../get_boundsinpoints/) в прямоугольник в пикселях.
