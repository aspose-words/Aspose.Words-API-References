...
description: "Aspose::Words::Rendering::NodeRendererBase::get_OpaqueBoundsInPoints method. Получает непрозрачные границы формы в пунктах в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.rendering/noderendererbase/get_opaqueboundsinpoints/
---
...
Это свойство возвращает непрозрачную (т.е. игнорируются прозрачные части формы) ограничивающую рамку формы. Границы учитывают вращение формы.
