---
title: "Перечисление Aspose::Words::Themes::ThemeFont"
linktitle: "ThemeFont"
second_title: "Справочник API Aspose.Words для C++"
description: "Перечисление Aspose::Words::Themes::ThemeFont. Указывает типы названий шрифтов темы для тем документов в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.themes/themefont/
---
## ThemeFont enum
...
| Major | 1 | Шрифт темы Major. |
| Minor | 2 | Шрифт темы Minor. |
