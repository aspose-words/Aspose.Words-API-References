---
title: "Aspose::Words::Themes::ThemeFonts::get_EastAsian метод"
linktitle: "get_EastAsian"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Themes::ThemeFonts::get_EastAsian метод. Указывает имя шрифта для восточноазиатских символов в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.themes/themefonts/get_eastasian/
---
## ThemeFonts::get_EastAsian method


Указывает имя шрифта для символов EastAsian.
