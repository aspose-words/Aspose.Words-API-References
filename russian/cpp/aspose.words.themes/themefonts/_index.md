---
title: "Класс Aspose::Words::Themes::ThemeFonts"
linktitle: "ThemeFonts"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Themes::ThemeFonts. Представляет коллекцию шрифтов в схеме шрифтов, позволяя указывать разные шрифты для разных языков: Latin, EastAsian и ComplexScript. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.themes/themefonts/
---
## ThemeFonts class


Представляет коллекцию шрифтов в схеме шрифтов, позволяя указывать разные шрифты для разных языков [Latin](./get_latin/), [EastAsian](./get_eastasian/) и [ComplexScript](./get_complexscript/). Чтобы узнать больше, посетите статью документации [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Метод | Описание |
| --- | --- |
| [get_ComplexScript](./get_complexscript/)() | Указывает имя шрифта для символов ComplexScript. |
| [get_EastAsian](./get_eastasian/)() | Указывает имя шрифта для символов EastAsian. |
| [get_Latin](./get_latin/)() | Указывает имя шрифта для символов Latin. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_ComplexScript](./set_complexscript/)(const System::String\&) | Сеттер для [Aspose::Words::Themes::ThemeFonts::get_ComplexScript](./get_complexscript/). |
| [set_EastAsian](./set_eastasian/)(const System::String\&) | Сеттер для [Aspose::Words::Themes::ThemeFonts::get_EastAsian](./get_eastasian/). |
| [set_Latin](./set_latin/)(const System::String\&) | Сеттер для [Aspose::Words::Themes::ThemeFonts::get_Latin](./get_latin/). |
| static [Type](./type/)() |  |
