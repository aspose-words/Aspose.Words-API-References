---
title: "Aspose::Words::Markup::SdtListItemCollection::Add метод"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::SdtListItemCollection::Add метод. Добавляет элемент в эту коллекцию в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.markup/sdtlistitemcollection/add/
---
## SdtListItemCollection::Add method


Добавляет элемент в эту коллекцию.
