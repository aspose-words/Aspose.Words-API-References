---
title: "Метод Aspose::Words::Markup::SdtListItemCollection::GetEnumerator"
linktitle: "GetEnumerator"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::SdtListItemCollection::GetEnumerator. Возвращает объект перечислителя, который можно использовать для перебора всех элементов в коллекции в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.markup/sdtlistitemcollection/getenumerator/
---
