---
title: "Метод Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue"
linktitle: "get_SelectedValue"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue. Указывает текущие выбранное значение в этом списке. Допускается значение null, что означает отсутствие выбранного элемента, связанного с этой коллекцией элементов списка, в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


Указывает текущо выбранное значение в этом списке. Допускается значение null, что означает, что ни одна текущо выбранная запись не связана с этой коллекцией элементов списка.
