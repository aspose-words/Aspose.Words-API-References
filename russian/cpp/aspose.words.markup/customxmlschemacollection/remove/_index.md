---
title: "Aspose::Words::Markup::CustomXmlSchemaCollection::Remove метод"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomXmlSchemaCollection::Remove метод. Удаляет указанное значение из коллекции в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.markup/customxmlschemacollection/remove/
---
...
| --- | --- | --- |
| name | const System::String\& | Чувствительное к регистру значение для удаления. |
