---
title: "Aspose::Words::Markup::CustomXmlSchemaCollection::IndexOf метод"
linktitle: "IndexOf"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomXmlSchemaCollection::IndexOf метод. Возвращает нулевой индекс указанного значения в коллекции в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.markup/customxmlschemacollection/indexof/
---
## CustomXmlSchemaCollection::IndexOf method


Возвращает нулевой индекс указанного значения в коллекции.
...
| --- | --- | --- |
| value | const System::String\& | Чувствительное к регистру значение для поиска. |
