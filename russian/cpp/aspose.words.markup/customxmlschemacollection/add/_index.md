---
title: "Aspose::Words::Markup::CustomXmlSchemaCollection::Add метод"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomXmlSchemaCollection::Add метод. Добавляет элемент в коллекцию в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.markup/customxmlschemacollection/add/
---
...
| --- | --- | --- |
| value | const System::String\& | Элемент для добавления. |
