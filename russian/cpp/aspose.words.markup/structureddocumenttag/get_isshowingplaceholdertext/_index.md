---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText метод"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText метод. Указывает, следует ли интерпретировать содержимое этого SDT как содержащий текст-заполнитель (в отличие от обычного текста внутри SDT). Если установить значение true, это состояние будет восстановлено (отображение текста-заполнителя) при открытии этого документа в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_isshowingplaceholdertext/
---
