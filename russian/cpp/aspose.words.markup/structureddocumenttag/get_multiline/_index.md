---
title: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_Multiline"
linktitle: "get_Multiline"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_Multiline. Указывает, позволяет ли этот SDT несколько строк текста в C++."
type: docs
weight: 24000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_multiline/
---
## StructuredDocumentTag::get_Multiline method


Указывает, позволяет ли этот **SDT** несколько строк текста.
...
Доступ к этому свойству будет работать только для типов SDT [RichText](../../sdttype/) и [PlainText](../../sdttype/).
