...
description: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder. Получает BuildingBlock, содержащий текст-заполнитель, который должен отображаться, когда содержимое этого SDT пусто, связанный сопоставленный элемент XML пуст, как указано в элементе XmlMapping, или элемент IsShowingPlaceholderText имеет значение true в C++."
type: docs
weight: 26000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_placeholder/
---
## StructuredDocumentTag::get_Placeholder method


Получает [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/), содержащий текст-заполнитель, который должен отображаться, когда содержимое этого SDT пусто, связанный сопоставленный элемент XML пуст, как указано в элементе [XmlMapping](../get_xmlmapping/), или элемент [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) имеет **true**.
