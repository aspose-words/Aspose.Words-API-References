---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat метод"
linktitle: "get_DateStorageFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat метод. Получает/устанавливает формат, в котором дата для SDT даты хранится, когда SDT привязан к узлу XML в хранилище данных документа. Значение по умолчанию — DateTime в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


Получает/устанавливает формат, в котором дата для SDT даты хранится, когда **SDT** привязан к узлу XML в хранилище данных документа. Значение по умолчанию — [DateTime](../../sdtdatestorageformat/)
