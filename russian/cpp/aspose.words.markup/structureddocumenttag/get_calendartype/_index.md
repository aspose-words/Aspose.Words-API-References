---
title: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_CalendarType"
linktitle: "get_CalendarType"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_CalendarType. Указывает тип календаря для этого **SDT**. По умолчанию — Default в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_calendartype/
---
## StructuredDocumentTag::get_CalendarType method


Указывает тип календаря для этого **SDT**. По умолчанию — [Default](../../sdtcalendartype/)
