---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_XmlMapping метод"
linktitle: "get_XmlMapping"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_XmlMapping метод. Возвращает объект, представляющий сопоставление этого структурного тега документа с данными XML в пользовательской части XML текущего документа в C++."
type: docs
weight: 34000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_xmlmapping/
---
