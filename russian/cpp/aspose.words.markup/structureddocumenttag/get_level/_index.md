...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Level method. Получает уровень, на котором этот SDT находится в дереве документа в C++."
type: docs
weight: 20000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_level/
---
