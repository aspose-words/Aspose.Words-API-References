---
title: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_LockContents"
linktitle: "get_LockContents"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_LockContents. При установке в true это свойство запрещает пользователю редактировать содержимое этого SDT в C++."
type: docs
weight: 23000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_lockcontents/
---
