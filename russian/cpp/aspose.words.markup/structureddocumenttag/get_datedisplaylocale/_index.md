...
description: "Метод Aspose::Words::Markup::StructuredDocumentTag::get_DateDisplayLocale. Позволяет установить/получить языковой формат даты, отображаемой в этом SDT, в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.markup/structureddocumenttag/get_datedisplaylocale/
---
## StructuredDocumentTag::get_DateDisplayLocale method


Позволяет установить/получить языковой формат даты, отображаемой в этом **SDT**.
