---
title: "Aspose::Words::Markup::CustomPart::get_ContentType метод"
linktitle: "get_ContentType"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomPart::get_ContentType метод. Указывает тип содержимого этой пользовательской части в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.markup/custompart/get_contenttype/
---
...
Это свойство применимо только когда [IsExternal](../get_isexternal/) равно **false**.
