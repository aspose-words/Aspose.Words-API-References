---
title: "Метод Aspose::Words::Markup::CustomXmlPartCollection::Add"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomXmlPartCollection::Add. Добавляет элемент в коллекцию в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| --- | --- | --- |
| часть | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Пользовательская XML‑часть для добавления. |
...
Создаёт новую часть XML с указанным XML и добавляет её в коллекцию.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| id | const System::String\& | Идентификатор новой пользовательской XML‑части. |
| xml | const System::String\& | XML‑данные части. |
