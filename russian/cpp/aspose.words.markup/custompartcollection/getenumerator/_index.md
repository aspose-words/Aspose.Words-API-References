---
title: "Метод Aspose::Words::Markup::CustomPartCollection::GetEnumerator"
linktitle: "GetEnumerator"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomPartCollection::GetEnumerator. Возвращает объект перечислителя, который можно использовать для перебора всех элементов в коллекции в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.markup/custompartcollection/getenumerator/
---
