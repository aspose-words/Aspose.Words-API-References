---
title: "Метод Aspose::Words::Markup::CustomXmlProperty::get_Uri"
linktitle: "get_Uri"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomXmlProperty::get_Uri. Получает или задает URI пространства имен пользовательского XML‑атрибута или свойства смарт‑тега в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.markup/customxmlproperty/get_uri/
---
## CustomXmlProperty::get_Uri method


Получает или задаёт URI пространства имён пользовательского XML-атрибута или свойства смарт‑тега.
