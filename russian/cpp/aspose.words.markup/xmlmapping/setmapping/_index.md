---
title: "Метод Aspose::Words::Markup::XmlMapping::SetMapping"
linktitle: "SetMapping"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::XmlMapping::SetMapping. Устанавливает сопоставление между родительским тегом структурированного документа и узлом XML пользовательской части XML‑данных в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


Устанавливает сопоставление между родительским структурированным тегом документа и узлом XML пользовательской части XML‑данных.
...
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Пользовательская часть XML‑данных для сопоставления. |
| xPath | const System::String\& | Выражение XPath для поиска узла XML. |
| prefixMapping | const System::String\& | Префиксы пространств имён XML для оценки XPath. |

### ReturnValue

Флаг, указывающий, успешно ли родительский тег структурированного документа сопоставлен с узлом XML.
