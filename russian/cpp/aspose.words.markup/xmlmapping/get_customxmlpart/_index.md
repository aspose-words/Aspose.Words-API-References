---
title: "Метод Aspose::Words::Markup::XmlMapping::get_CustomXmlPart"
linktitle: "get_CustomXmlPart"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::XmlMapping::get_CustomXmlPart. Возвращает пользовательскую часть XML‑данных, к которой сопоставлен родительский тег структурированного документа в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.markup/xmlmapping/get_customxmlpart/
---
## XmlMapping::get_CustomXmlPart method


Возвращает пользовательскую часть XML‑данных, к которой сопоставлен родительский структурированный тег документа.
