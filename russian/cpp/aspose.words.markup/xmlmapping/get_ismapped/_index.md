---
title: "Метод Aspose::Words::Markup::XmlMapping::get_IsMapped"
linktitle: "get_IsMapped"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::XmlMapping::get_IsMapped. Возвращает true, если родительский тег структурированного документа успешно сопоставлен с XML‑данными в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.markup/xmlmapping/get_ismapped/
---
## XmlMapping::get_IsMapped method


Возвращает **true**, если родительский структурированный тег документа успешно сопоставлен с XML‑данными.
