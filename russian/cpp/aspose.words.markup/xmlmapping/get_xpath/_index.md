---
title: "Метод Aspose::Words::Markup::XmlMapping::get_XPath"
linktitle: "get_XPath"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::XmlMapping::get_XPath. Возвращает выражение XPath, которое оценивается для поиска пользовательского XML‑узла, сопоставленного с родительским тегом структурированного документа в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.markup/xmlmapping/get_xpath/
---
## XmlMapping::get_XPath method


Возвращает выражение XPath, которое оценивается для поиска пользовательского узла XML, сопоставленного с родительским структурированным тегом документа.
