---
title: "Метод Aspose::Words::Markup::XmlMapping::get_PrefixMappings"
linktitle: "get_PrefixMappings"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::XmlMapping::get_PrefixMappings. Возвращает сопоставления префиксов пространств имён XML для оценки XPath в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.markup/xmlmapping/get_prefixmappings/
---
## XmlMapping::get_PrefixMappings method


Возвращает сопоставления префиксов пространств имён XML для оценки [XPath](../get_xpath/).
