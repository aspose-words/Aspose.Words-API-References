---
title: "Aspose::Words::Markup::CustomXmlPart::get_Schemas метод"
linktitle: "get_Schemas"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Schemas метод. Указывает набор XML‑схем, связанных с этой пользовательской XML‑частью в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.markup/customxmlpart/get_schemas/
---
