---
title: "Aspose::Words::Markup::CustomXmlPart::Clone метод"
linktitle: "Клонировать"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::CustomXmlPart::Clone метод. Создаёт «достаточно глубокую» копию объекта. Не дублирует байты значения Data в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.markup/customxmlpart/clone/
---
## CustomXmlPart::Clone method


Создает "достаточно глубокую" копию объекта. Не дублирует байты значения [Data](../get_data/).
