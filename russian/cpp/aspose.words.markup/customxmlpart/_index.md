...
description: "Aspose::Words::Markup::CustomXmlPart class. Представляет часть хранилища пользовательских XML‑данных (пользовательские XML‑данные внутри пакета). Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.markup/customxmlpart/
---
## CustomXmlPart class


Представляет часть хранилища пользовательских XML‑данных (пользовательские XML‑данные внутри пакета). Чтобы узнать больше, посетите статью документации [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| [get_Data](./get_data/)() const | Получает или задает XML‑содержимое этой части хранилища пользовательских XML‑данных. |
| [get_DataChecksum](./get_datachecksum/)() | Указывает контрольную сумму циклического избыточного кода (CRC) содержимого [Data](./get_data/). |
| [get_Id](./get_id/)() const | Получает или задает строку, идентифицирующую эту пользовательскую XML‑часть в документе OOXML. |
| [get_Schemas](./get_schemas/)() const | Указывает набор XML‑схем, связанных с этой пользовательской XML‑частью. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Data](./set_data/)(const System::ArrayPtr\<uint8_t\>\&) | Сеттер для [Aspose::Words::Markup::CustomXmlPart::get_Data](./get_data/). |
| [set_Id](./set_id/)(const System::String\&) | Сеттер для [Aspose::Words::Markup::CustomXmlPart::get_Id](./get_id/). |
| static [Type](./type/)() |  |
## Примечания


DOCX или DOC документ может содержать одну или несколько частей Custom XML Data Storage. Aspose.Words сохраняет и позволяет создавать и извлекать Custom XML Data через коллекцию [CustomXmlParts](../../aspose.words/document/get_customxmlparts/).
