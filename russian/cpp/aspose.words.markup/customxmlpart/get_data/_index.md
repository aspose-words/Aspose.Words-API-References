---
title: "Метод Aspose::Words::Markup::CustomXmlPart::get_Data"
linktitle: "get_Data"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomXmlPart::get_Data. Получает или задает XML‑содержимое этой части хранилища пользовательских XML‑данных в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.markup/customxmlpart/get_data/
---
## CustomXmlPart::get_Data method


Получает или задает XML‑содержимое этой части хранилища пользовательских XML‑данных.
