---
title: "Aspose::Words::Markup::CustomXmlPropertyCollection::idx_get метод"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomXmlPropertyCollection::idx_get. Получает свойство с указанным именем в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.markup/customxmlpropertycollection/idx_get/
---
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| index | int32_t | Нулевой (отсчет с нуля) индекс свойства. |
