---
title: "Aspose::Words::Markup::CustomXmlPropertyCollection::IndexOfKey метод"
linktitle: "IndexOfKey"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::CustomXmlPropertyCollection::IndexOfKey. Возвращает нулевой (отсчет с нуля) индекс указанного свойства в коллекции в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.markup/customxmlpropertycollection/indexofkey/
---
## CustomXmlPropertyCollection::IndexOfKey method


Возвращает нулевой индекс указанного свойства в коллекции.
...
| --- | --- | --- |
| name | const System::String\& | Чувствительное к регистру имя свойства. |

### ReturnValue

Нулевой индекс. Отрицательное значение, если не найдено.
