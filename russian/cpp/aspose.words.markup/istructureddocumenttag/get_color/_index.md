...
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_Color method. Получает или задает цвет структурированного тега документа в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.markup/istructureddocumenttag/get_color/
---
## IStructuredDocumentTag::get_Color method


Получает или задает цвет структурированного тега документа.
