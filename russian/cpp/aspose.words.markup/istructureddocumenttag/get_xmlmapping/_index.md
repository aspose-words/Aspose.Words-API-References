---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_XmlMapping метод"
linktitle: "get_XmlMapping"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_XmlMapping метод. Получает объект, представляющий сопоставление этого структурированного тега документа с данными XML в пользовательской части XML текущего документа в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.markup/istructureddocumenttag/get_xmlmapping/
---
