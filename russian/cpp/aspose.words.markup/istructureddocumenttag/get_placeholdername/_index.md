---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_PlaceholderName метод"
linktitle: "get_PlaceholderName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_PlaceholderName метод. Получает или задает имя BuildingBlock, содержащего текст‑заполнитель в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.markup/istructureddocumenttag/get_placeholdername/
---
