---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText метод"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText метод. Указывает, следует ли интерпретировать содержимое этого структурированного тега документа как содержащий текст‑заполнитель (в отличие от обычного текста внутри структурированного тега документа). Если установлено в true, это состояние будет восстановлено (отображение текста‑заполнителя) при открытии этого документа в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_isshowingplaceholdertext/
---
## StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText method


Указывает, следует ли интерпретировать содержимое этого структурированного тега документа как содержащие текст‑заполнитель (в отличие от обычного текста внутри тега). Если установлено в **true**, это состояние будет восстановлено (отображая текст‑заполнитель) при открытии документа.
