---
title: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_LockContentControl"
linktitle: "get_LockContentControl"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_LockContentControl. При установке в true это свойство запрещает пользователю удалять этот структурированный тег документа в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_lockcontentcontrol/
---
## StructuredDocumentTagRangeStart::get_LockContentControl method


Когда установлено в **true**, это свойство запретит пользователю удалять этот структурированный тег документа.
