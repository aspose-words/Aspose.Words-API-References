---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Title метод"
linktitle: "get_Title"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Title метод. Указывает удобочитаемое имя, связанное с этим структурированным тегом документа. Не может быть null в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_title/
---
## StructuredDocumentTagRangeStart::get_Title method


Указывает удобочитаемое имя, связанное с этим структурированным тегом документа. Не может быть **null**.
