---
title: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Level"
linktitle: "get_Level"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Level. Получает уровень, на котором начинается диапазон этого структурированного тега документа в дереве документа в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_level/
---
## StructuredDocumentTagRangeStart::get_Level method


Получает уровень, на котором начинается диапазон этого структурированного тега документа в дереве документа.
