---
title: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id"
linktitle: "get_Id"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id. Указывает уникальный только для чтения постоянный числовой идентификатор для этого структурированного тега документа в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_id/
---
## StructuredDocumentTagRangeStart::get_Id method


Указывает уникальный только для чтения постоянный числовой Id для этого структурированного тега документа.
...
Атрибут Id должен соответствовать следующим правилам:* Документ сохраняет идентификаторы структурированных тегов только в случае клонирования всего документа [Clone](../../../aspose.words/document/clone/).
