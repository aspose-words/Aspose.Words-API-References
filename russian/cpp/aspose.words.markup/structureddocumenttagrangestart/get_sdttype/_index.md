---
title: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_SdtType"
linktitle: "get_SdtType"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_SdtType. Возвращает тип этого структурированного тега документа в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_sdttype/
---
## StructuredDocumentTagRangeStart::get_SdtType method


Получает тип этого структурированного тега документа.
