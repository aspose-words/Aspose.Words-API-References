---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_PlaceholderName метод"
linktitle: "get_PlaceholderName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_PlaceholderName метод. Получает или задает имя BuildingBlock, содержащего текст-заполнитель, в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.markup/structureddocumenttagrangestart/get_placeholdername/
---
## StructuredDocumentTagRangeStart::get_PlaceholderName method


Получает или задает имя [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) , содержащего текст‑заполнитель.
