---
title: "метод Aspose::Words::Bibliography::Source::get_ConferenceName"
linktitle: "get_ConferenceName"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_ConferenceName. Получает или задает название конференции или сборника источника в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.bibliography/source/get_conferencename/
---
## Source::get_ConferenceName method


Возвращает или задает название конференции или сборника статей источника.
