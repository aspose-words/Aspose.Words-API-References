---
title: "Aspose::Words::Bibliography::Source::get_StateOrProvince метод"
linktitle: "get_StateOrProvince"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_StateOrProvince метод. Получает или задает штат или провинцию источника в C++."
type: docs
weight: 44000
url: /ru/cpp/aspose.words.bibliography/source/get_stateorprovince/
---
## Source::get_StateOrProvince method


Получает или задает штат или провинцию источника.
