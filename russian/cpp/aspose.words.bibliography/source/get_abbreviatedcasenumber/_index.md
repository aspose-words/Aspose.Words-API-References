---
title: "метод Aspose::Words::Bibliography::Source::get_AbbreviatedCaseNumber"
linktitle: "get_AbbreviatedCaseNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_AbbreviatedCaseNumber. Получает или задает сокращенный номер дела источника в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.bibliography/source/get_abbreviatedcasenumber/
---
## Source::get_AbbreviatedCaseNumber method


Возвращает или задает сокращённый номер дела источника.
