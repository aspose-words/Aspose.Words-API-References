---
title: "Aspose::Words::Bibliography::Source::get_ShortTitle метод"
linktitle: "get_ShortTitle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_ShortTitle метод. Получает или задает короткое название источника в C++."
type: docs
weight: 41000
url: /ru/cpp/aspose.words.bibliography/source/get_shorttitle/
---
## Source::get_ShortTitle method


Получает или задает краткое название источника.
