---
title: "Aspose::Words::Bibliography::Source::get_Distributor метод"
linktitle: "get_Distributor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Distributor метод. Получает или задает дистрибьютора источника в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.bibliography/source/get_distributor/
---
## Source::get_Distributor method


Возвращает или задает дистрибьютора источника.
