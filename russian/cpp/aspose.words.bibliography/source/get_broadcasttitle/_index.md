---
title: "Aspose::Words::Bibliography::Source::get_BroadcastTitle метод"
linktitle: "get_BroadcastTitle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_BroadcastTitle метод. Получает или задает название трансляции источника в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.bibliography/source/get_broadcasttitle/
---
## Source::get_BroadcastTitle method


Возвращает или задает название трансляции источника.
