---
title: "Aspose::Words::Bibliography::Source::get_RecordingNumber метод"
linktitle: "get_RecordingNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_RecordingNumber метод. Получает или задает номер записи источника на C++."
type: docs
weight: 38000
url: /ru/cpp/aspose.words.bibliography/source/get_recordingnumber/
---
## Source::get_RecordingNumber method


Получает или задает номер записи источника.
