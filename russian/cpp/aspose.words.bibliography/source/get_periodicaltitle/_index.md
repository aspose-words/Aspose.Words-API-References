---
title: "метод Aspose::Words::Bibliography::Source::get_PeriodicalTitle method"
linktitle: "get_PeriodicalTitle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_PeriodicalTitle метод. Получает или задает название периодического издания источника в C++."
type: docs
weight: 34000
url: /ru/cpp/aspose.words.bibliography/source/get_periodicaltitle/
---
## Source::get_PeriodicalTitle method


Получает или задает название периодического издания источника.
