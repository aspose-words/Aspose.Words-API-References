---
title: "метод Aspose::Words::Bibliography::Source::get_Volume"
linktitle: "get_Volume"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_Volume. Получает или задает том источника в C++."
type: docs
weight: 53000
url: /ru/cpp/aspose.words.bibliography/source/get_volume/
---
## Source::get_Volume method


Получает или задает том источника.
