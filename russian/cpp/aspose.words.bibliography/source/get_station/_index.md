---
title: "метод Aspose::Words::Bibliography::Source::get_Station"
linktitle: "get_Station"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_Station. Получает или задает станцию источника в C++."
type: docs
weight: 45000
url: /ru/cpp/aspose.words.bibliography/source/get_station/
---
## Source::get_Station method


Получает или задает станцию источника.
