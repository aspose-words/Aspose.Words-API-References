---
title: "Aspose::Words::Bibliography::Source::get_AlbumTitle метод"
linktitle: "get_AlbumTitle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_AlbumTitle метод. Получает или задает название альбома источника в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.bibliography/source/get_albumtitle/
---
## Source::get_AlbumTitle method


Возвращает или задает название альбома источника.
