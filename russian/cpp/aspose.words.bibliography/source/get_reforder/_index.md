---
title: "Aspose::Words::Bibliography::Source::get_RefOrder метод"
linktitle: "get_RefOrder"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_RefOrder метод. Получает или задает порядок ссылки источника в C++."
type: docs
weight: 39000
url: /ru/cpp/aspose.words.bibliography/source/get_reforder/
---
## Source::get_RefOrder method


Получает или задает порядок ссылки источника.
