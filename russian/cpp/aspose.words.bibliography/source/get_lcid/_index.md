---
title: "Метод Aspose::Words::Bibliography::Source::get_Lcid"
linktitle: "get_Lcid"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Lcid метод. Получает или задает идентификатор локали источника на C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words.bibliography/source/get_lcid/
---
## Source::get_Lcid method


Получает или задает идентификатор локали источника.
