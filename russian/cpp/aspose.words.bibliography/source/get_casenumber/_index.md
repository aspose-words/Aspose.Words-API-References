---
title: "Aspose::Words::Bibliography::Source::get_CaseNumber метод"
linktitle: "get_CaseNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_CaseNumber метод. Получает или задает номер дела источника в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.bibliography/source/get_casenumber/
---
## Source::get_CaseNumber method


Возвращает или задает номер дела источника.
