---
title: "Aspose::Words::Bibliography::Source::get_ProductionCompany метод"
linktitle: "get_ProductionCompany"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_ProductionCompany метод. Получает или задает производственную компанию источника в C++."
type: docs
weight: 35000
url: /ru/cpp/aspose.words.bibliography/source/get_productioncompany/
---
## Source::get_ProductionCompany method


Получает или задает компанию‑производитель источника.
