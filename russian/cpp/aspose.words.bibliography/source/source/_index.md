---
title: "конструктор Aspose::Words::Bibliography::Source::Source"
linktitle: "Источник"
second_title: "Справочник API Aspose.Words для C++"
description: "конструктор Aspose::Words::Bibliography::Source::Source. Инициализирует новый экземпляр класса Source в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.bibliography/source/source/
---
## Source::Source constructor


Инициализировать новый экземпляр класса [Source](../).
...
| --- | --- | --- |
| tag | const System::String\& | Определяющее имя тега. |
| sourceType | Aspose::Words::Bibliography::SourceType | Тип источника. |
