---
title: "метод Aspose::Words::Bibliography::Source::get_Publisher"
linktitle: "get_Publisher"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Publisher метод. Получает или задает издателя источника в C++."
type: docs
weight: 37000
url: /ru/cpp/aspose.words.bibliography/source/get_publisher/
---
## Source::get_Publisher method


Получает или задает издателя источника.
