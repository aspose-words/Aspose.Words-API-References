---
title: "Aspose::Words::Bibliography::Source::get_NumberVolumes метод"
linktitle: "get_NumberVolumes"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_NumberVolumes. Получает или задает количество томов источника в C++."
type: docs
weight: 31000
url: /ru/cpp/aspose.words.bibliography/source/get_numbervolumes/
---
## Source::get_NumberVolumes method


Получает или задает количество томов источника.
