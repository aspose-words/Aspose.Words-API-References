---
title: "Aspose::Words::Bibliography::Source::get_Contributors метод"
linktitle: "get_Contributors"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Contributors метод. Получает список участников (author, editor, writer etc) источника в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.bibliography/source/get_contributors/
---
## Source::get_Contributors method


Возвращает список участников (автор, редактор, писатель и т.д.) источника.
