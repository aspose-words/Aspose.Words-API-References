---
title: "Метод Aspose::Words::Bibliography::Source::get_StandardNumber"
linktitle: "get_StandardNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::Source::get_StandardNumber. Получает или задает стандартный номер источника в C++."
type: docs
weight: 43000
url: /ru/cpp/aspose.words.bibliography/source/get_standardnumber/
---
## Source::get_StandardNumber method


Получает или задает номер стандарта источника.
