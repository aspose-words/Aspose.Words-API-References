---
title: "метод Aspose::Words::Bibliography::Source::get_PublicationTitle"
linktitle: "get_PublicationTitle"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_PublicationTitle. Получает или задает название публикации источника в C++."
type: docs
weight: 36000
url: /ru/cpp/aspose.words.bibliography/source/get_publicationtitle/
---
## Source::get_PublicationTitle method


Получает или задает название публикации источника.
