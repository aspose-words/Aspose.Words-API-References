---
title: "Aspose::Words::Bibliography::Source::get_Reporter метод"
linktitle: "get_Reporter"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Reporter метод. Получает или задает репортера источника в C++."
type: docs
weight: 40000
url: /ru/cpp/aspose.words.bibliography/source/get_reporter/
---
## Source::get_Reporter method


Получает или задает репортера источника.
