---
title: "Метод Aspose::Words::Bibliography::Source::get_DayAccessed"
linktitle: "get_DayAccessed"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::Source::get_DayAccessed. Получает или задает день доступа к источнику в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.bibliography/source/get_dayaccessed/
---
## Source::get_DayAccessed method


Возвращает или задает день доступа к источнику.
