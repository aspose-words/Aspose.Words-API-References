---
title: "метод Aspose::Words::Bibliography::Source::get_MonthAccessed"
linktitle: "get_MonthAccessed"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Bibliography::Source::get_MonthAccessed. Получает или задает месяц доступа к источнику в C++."
type: docs
weight: 30000
url: /ru/cpp/aspose.words.bibliography/source/get_monthaccessed/
---
## Source::get_MonthAccessed method


Получает или задает месяц доступа источника.
