---
title: "Aspose::Words::Bibliography::Source::get_Comments метод"
linktitle: "get_Comments"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Source::get_Comments метод. Получает или задает комментарии источника в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.bibliography/source/get_comments/
---
## Source::get_Comments method


Возвращает или задает комментарии к источнику.
