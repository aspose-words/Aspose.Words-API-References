---
title: "Aspose::Words::Bibliography::PersonCollection::Add метод"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::PersonCollection::Add метод. Добавляет объект Person в коллекцию в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.bibliography/personcollection/add/
---
...
| --- | --- | --- |
| человек | const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\& | Человек, который будет добавлен в коллекцию. |
