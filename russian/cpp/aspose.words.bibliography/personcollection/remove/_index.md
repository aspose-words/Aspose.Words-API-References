---
title: "Aspose::Words::Bibliography::PersonCollection::Remove метод"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::PersonCollection::Remove метод. Удаляет лицо из коллекции в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.bibliography/personcollection/remove/
---
...
| --- | --- | --- |
| человек | const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\& | Лицо, которое нужно удалить из коллекции. |
