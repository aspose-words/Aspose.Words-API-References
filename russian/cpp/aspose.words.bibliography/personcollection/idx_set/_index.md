---
title: "Aspose::Words::Bibliography::PersonCollection::idx_set метод"
linktitle: "idx_set"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::PersonCollection::idx_set метод. Получает или задает лицо по указанному индексу в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.bibliography/personcollection/idx_set/
---
## PersonCollection::idx_set method


Получает или задает лицо по указанному индексу.
