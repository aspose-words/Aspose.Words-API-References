---
title: "Aspose::Words::Bibliography::PersonCollection класс"
linktitle: "PersonCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::PersonCollection класс. Представляет список лиц, являющихся участниками источника библиографии в C++."
type: docs
weight: 750
url: /ru/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Представляет список лиц, являющихся участниками источника библиографии.
...
| Метод | Описание |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Добавляет [Person](../person/) в коллекцию. |
| [Clear](./clear/)() | Удаляет все элементы из коллекции. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Определяет, содержит ли коллекция конкретного человека. |
| [get_Count](./get_count/)() | Получает количество лиц, содержащихся в коллекции. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Получает или задает лицо по указанному индексу. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Получает или задает лицо по указанному индексу. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Инициализирует новый экземпляр класса [PersonCollection](./). |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Инициализирует новый экземпляр класса [PersonCollection](./). |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Удаляет лицо из коллекции. |
| [RemoveAt](./removeat/)(int32_t) | Удаляет лицо по указанному индексу. |
