---
title: "Перечисление Aspose::Words::Bibliography::SourceType"
linktitle: "SourceType"
second_title: "Справочник API Aspose.Words для C++"
description: "Перечисление Aspose::Words::Bibliography::SourceType. Представляет типы источников библиографии в C++."
type: docs
weight: 1000
url: /ru/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum
...
| --- | --- | --- |
| ArticleInAPeriodical | 0 | Указывает статью в периодическом источнике. |
| Book | 1 | Указывает книжный источник. |
...
| Report | 5 | Указывает источник отчета. |
| SoundRecording | 6 | Указывает источник звуковой записи. |
| Performance | 7 | Указывает источник выступления. |
| Art | 8 | Указывает источник искусства. |
| DocumentFromInternetSite | 9 | Указывает источник документа с интернет‑сайта. |
...
| Разное | 16 | Указывает прочий источник. |
