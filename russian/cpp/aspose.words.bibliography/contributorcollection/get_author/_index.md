---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Author метод"
linktitle: "get_Author"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Author метод. Получает или задает автора источника в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_author/
---
## ContributorCollection::get_Author method


Получает или задает автора источника.
