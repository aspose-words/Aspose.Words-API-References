---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Counsel метод"
linktitle: "get_Counsel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Counsel метод. Получает или задает консультанта источника в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_counsel/
---
## ContributorCollection::get_Counsel method


Получает или задает консультанта источника.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Counsel()
```
