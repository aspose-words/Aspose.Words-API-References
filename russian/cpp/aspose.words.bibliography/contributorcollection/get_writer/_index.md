---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Writer метод"
linktitle: "get_Writer"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Writer метод. Получает или задает автора источника в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_writer/
---
## ContributorCollection::get_Writer method


Получает или задает писателя источника.
