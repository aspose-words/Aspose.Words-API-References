---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Translator метод"
linktitle: "get_Translator"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Translator метод. Получает или задает переводчика источника в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_translator/
---
## ContributorCollection::get_Translator method


Получает или задает переводчика источника.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Translator()
```
