---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Director метод"
linktitle: "get_Director"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Director метод. Получает или задает режиссера источника в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_director/
---
## ContributorCollection::get_Director method


Получает или задает режиссера источника.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Director()
```
