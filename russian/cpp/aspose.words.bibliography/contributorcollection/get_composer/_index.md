---
title: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Composer"
linktitle: "get_Composer"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Composer. Получает или задает композитора источника в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_composer/
---
## ContributorCollection::get_Composer method


Получает или задает композитора источника.
