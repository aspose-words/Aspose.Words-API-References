---
title: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Compiler"
linktitle: "get_Compiler"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Compiler. Получает или задает компилятора источника в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_compiler/
---
## ContributorCollection::get_Compiler method


Получает или задает компилятора источника.
