---
title: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Inventor"
linktitle: "get_Inventor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Inventor. Получает или задает изобретателя источника в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_inventor/
---
## ContributorCollection::get_Inventor method


Получает или задает изобретателя источника.
