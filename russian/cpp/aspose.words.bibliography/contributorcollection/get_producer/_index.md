---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Producer метод"
linktitle: "get_Producer"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Producer метод. Получает или задает продюсера источника в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_producer/
---
## ContributorCollection::get_Producer method


Получает или задает продюсера источника.
