---
title: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Artist"
linktitle: "get_Artist"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::ContributorCollection::get_Artist. Получает или задает художника источника в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_artist/
---
## ContributorCollection::get_Artist method


Получает или задает исполнителя источника.
