---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Conductor метод"
linktitle: "get_Conductor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Conductor метод. Получает или задает дирижера источника в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.bibliography/contributorcollection/get_conductor/
---
## ContributorCollection::get_Conductor method


Получает или задает дирижера источника.
