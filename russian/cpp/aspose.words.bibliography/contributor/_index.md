...
description: "Aspose::Words::Bibliography::Contributor class. Представляет автора библиографического источника. Может быть либо корпоративным (организацией), либо списком лиц в C++."
type: docs
weight: 250
url: /ru/cpp/aspose.words.bibliography/contributor/
---
## Contributor class
