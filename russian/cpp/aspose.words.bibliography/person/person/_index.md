---
title: "Aspose::Words::Bibliography::Person::Person конструктор"
linktitle: "Person"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Person::Person конструктор. Инициализировать новый экземпляр класса Person в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.bibliography/person/person/
---
## Person::Person constructor


Инициализировать новый экземпляр класса [Person](../).
...
| --- | --- | --- |
| last | const System::String\& | Фамилия. |
| first | const System::String\& | Фамилия. |
| middle | const System::String\& | Фамилия. |
