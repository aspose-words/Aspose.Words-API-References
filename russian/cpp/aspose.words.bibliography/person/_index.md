---
title: "Aspose::Words::Bibliography::Person класс"
linktitle: "Person"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Person класс. Представляет отдельного (человека) участника источника библиографии в C++."
type: docs
weight: 625
url: /ru/cpp/aspose.words.bibliography/person/
---
## Person class


Представляет индивидуального (человека) участника источника библиографии.
...
| [get_First](./get_first/)() const | Получает или задает имя человека. |
| [get_Last](./get_last/)() const | Получает или задает фамилию человека. |
| [get_Middle](./get_middle/)() const | Получает или задает отчество человека. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Инициализирует новый экземпляр класса [Person](./). |
| [set_First](./set_first/)(const System::String\&) | Сеттер для [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | Сеттер для [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | Сеттер для [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
