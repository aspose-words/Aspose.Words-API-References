---
title: "Aspose::Words::Bibliography::Bibliography класс"
linktitle: "Библиография"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Bibliography::Bibliography класс. Представляет список источников библиографии, доступных в документе, в C++."
type: docs
weight: 125
url: /ru/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class


Представляет список библиографических источников, доступных в документе.
...
| Метод | Описание |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Возвращает строку, представляющую имя активного стиля, используемого для библиографии. |
| [get_Sources](./get_sources/)() const | Возвращает коллекцию, представляющую все источники, содержащиеся в библиографии. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Устанавливает строку, представляющую имя активного стиля, используемого для библиографии. |
| static [Type](./type/)() |  |
