---
title: "Метод Aspose::Words::Bibliography::Bibliography::get_Sources"
linktitle: "get_Sources"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bibliography::Bibliography::get_Sources. Возвращает коллекцию, представляющую все источники, содержащиеся в библиографии, в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.bibliography/bibliography/get_sources/
---
## Bibliography::get_Sources method


Возвращает коллекцию, представляющую все источники, содержащиеся в библиографии.
