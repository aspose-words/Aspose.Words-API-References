---
title: "Класс Aspose::Words::Framesets::FramesetCollection"
linktitle: "FramesetCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Framesets::FramesetCollection. Представляет коллекцию экземпляров класса Frameset. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.framesets/framesetcollection/
---
## FramesetCollection class


Представляет коллекцию экземпляров класса [Frameset](../frameset/). Чтобы узнать больше, посетите статью документации [Programming with Documents](https://docs.aspose.com/words/cpp/programming-with-documents/).
...
| [get_Count](./get_count/)() | Получает количество фреймов или страниц фреймов, содержащихся в коллекции. |
| [GetEnumerator](./getenumerator/)() override | Возвращает перечислитель, который проходит по элементам коллекции. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Получает фрейм или страницу фрейма по указанному индексу. |
