...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. Указывает доступные варианты обработки начальных пробелов при импорте из текстового файла в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Указывает доступные варианты обработки начальных пробелов при импорте из файла [Text](../../aspose.words/loadformat/).
...
| --- | --- | --- |
| ConvertToIndent | 0 | Начальные пробелы удаляются и преобразуются в левый отступ. |
| Trim | 1 | Начальные пробелы обрезаются. |
| Preserve | 2 | Начальные пробелы сохраняются. |
