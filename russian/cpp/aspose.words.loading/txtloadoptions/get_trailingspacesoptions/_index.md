---
title: "Метод Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions"
linktitle: "get_TrailingSpacesOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions. Получает или задает предпочтительный вариант обработки конечных пробелов. Значение по умолчанию — Trim в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.loading/txtloadoptions/get_trailingspacesoptions/
---
## TxtLoadOptions::get_TrailingSpacesOptions method


Получает или задает предпочтительный вариант обработки конечных пробелов. Значение по умолчанию — [Trim](../../txttrailingspacesoptions/).
