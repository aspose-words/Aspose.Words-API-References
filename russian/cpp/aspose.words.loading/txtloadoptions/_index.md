---
title: "Aspose::Words::Loading::TxtLoadOptions класс"
linktitle: "TxtLoadOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Loading::TxtLoadOptions класс. Позволяет указать дополнительные параметры при загрузке текстового документа в объект Document. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.loading/txtloadoptions/
---
## TxtLoadOptions class


Позволяет указать дополнительные параметры при загрузке документа [Text](../../aspose.words/loadformat/) в объект [Document](../../aspose.words/document/). Чтобы узнать больше, посетите статью документации [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_AutoNumberingDetection](./get_autonumberingdetection/)() const | Получает или задает логическое значение, указывающее, будет ли выполнено автоматическое обнаружение нумерации при загрузке документа. Значение по умолчанию — **true**. |
...
| [get_DetectHyperlinks](./get_detecthyperlinks/)() const | Указывает, следует ли обнаруживать гиперссылки в тексте. Значение по умолчанию — **false**. |
| [get_DetectNumberingWithWhitespaces](./get_detectnumberingwithwhitespaces/)() const | Позволяет указать, как распознавать элементы нумерованных списков при импорте документа из формата простого текста. Значение по умолчанию — **true**. |
| [get_DocumentDirection](./get_documentdirection/)() const | Получает или задает направление документа. Значение по умолчанию — [LeftToRight](../documentdirection/). |
...
| [get_LeadingSpacesOptions](./get_leadingspacesoptions/)() const | Получает или задает предпочтительный вариант обработки начальных пробелов. Значение по умолчанию — [ConvertToIndent](../txtleadingspacesoptions/). |
...
| [get_TrailingSpacesOptions](./get_trailingspacesoptions/)() const | Получает или задает предпочтительный вариант обработки конечных пробелов. Значение по умолчанию — [Trim](../txttrailingspacesoptions/). |
...
| [set_AutoNumberingDetection](./set_autonumberingdetection/)(bool) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_AutoNumberingDetection](./get_autonumberingdetection/). |
...
| [set_DetectHyperlinks](./set_detecthyperlinks/)(bool) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_DetectHyperlinks](./get_detecthyperlinks/). |
| [set_DetectNumberingWithWhitespaces](./set_detectnumberingwithwhitespaces/)(bool) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_DetectNumberingWithWhitespaces](./get_detectnumberingwithwhitespaces/). |
| [set_DocumentDirection](./set_documentdirection/)(Aspose::Words::Loading::DocumentDirection) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_DocumentDirection](./get_documentdirection/). |
...
| [set_LeadingSpacesOptions](./set_leadingspacesoptions/)(Aspose::Words::Loading::TxtLeadingSpacesOptions) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_LeadingSpacesOptions](./get_leadingspacesoptions/). |
...
| [set_TrailingSpacesOptions](./set_trailingspacesoptions/)(Aspose::Words::Loading::TxtTrailingSpacesOptions) | Сеттер для [Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions](./get_trailingspacesoptions/). |
