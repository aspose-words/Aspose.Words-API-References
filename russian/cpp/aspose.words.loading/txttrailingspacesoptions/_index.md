---
title: "Перечисление Aspose::Words::Loading::TxtTrailingSpacesOptions"
linktitle: "TxtTrailingSpacesOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Перечисление Aspose::Words::Loading::TxtTrailingSpacesOptions. Указывает доступные варианты обработки конечных пробелов при импорте из текстового файла в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.loading/txttrailingspacesoptions/
---
## TxtTrailingSpacesOptions enum


Указывает доступные варианты обработки конечных пробелов при импорте из файла [Text](../../aspose.words/loadformat/).
