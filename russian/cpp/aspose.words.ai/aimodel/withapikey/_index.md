---
title: "Метод Aspose::Words::AI::AiModel::WithApiKey"
linktitle: "WithApiKey"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::AI::AiModel::WithApiKey. Устанавливает указанный API‑ключ для модели на C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.ai/aimodel/withapikey/
---
## AiModel::WithApiKey method


Задаёт указанный API‑ключ для модели.
