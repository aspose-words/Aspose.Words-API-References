...
description: "Метод Aspose::Words::AI::AiModel::Create. Создает новый экземпляр класса AiModel на C++."
type: docs
weight: 1000
url: /ru/cpp/aspose.words.ai/aimodel/create/
---
## AiModel::Create method


Создает новый экземпляр класса [AiModel](../).
