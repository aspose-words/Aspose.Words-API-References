---
title: "Метод Aspose::Words::AI::AnthropicAiModel::Summarize"
linktitle: "Summarize"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::AI::AnthropicAiModel::Summarize. Генерирует резюме для массива документов, с параметрами для управления длиной резюме и другими настройками. Этот метод использует подключённую модель AI для обработки каждого документа в массиве в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.ai/anthropicaimodel/summarize/
---
