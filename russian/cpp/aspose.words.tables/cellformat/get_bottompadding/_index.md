---
title: "Aspose::Words::Tables::CellFormat::get_BottomPadding метод"
linktitle: "get_BottomPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_BottomPadding метод. Возвращает или задает количество пространства (в пунктах), добавляемого ниже содержимого ячейки в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.tables/cellformat/get_bottompadding/
---
## CellFormat::get_BottomPadding method


Возвращает или задает количество пространства (в пунктах), добавляемое ниже содержимого ячейки.
