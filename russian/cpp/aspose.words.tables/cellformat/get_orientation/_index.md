---
title: "Aspose::Words::Tables::CellFormat::get_Orientation метод"
linktitle: "get_Orientation"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_Orientation метод. Возвращает или задает ориентацию текста в ячейке таблицы в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.tables/cellformat/get_orientation/
---
