---
title: "Aspose::Words::Tables::CellFormat::get_LeftPadding метод"
linktitle: "get_LeftPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_LeftPadding метод. Возвращает или задает количество пространства (в пунктах), которое добавляется слева от содержимого ячейки в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.tables/cellformat/get_leftpadding/
---
## CellFormat::get_LeftPadding method


Возвращает или задает количество пространства (в пунктах), добавляемое слева от содержимого ячейки.
