---
title: "Aspose::Words::Tables::CellFormat::get_TopPadding метод"
linktitle: "get_TopPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_TopPadding метод. Возвращает или задает количество пространства (в пунктах), которое добавляется над содержимым ячейки в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.tables/cellformat/get_toppadding/
---
## CellFormat::get_TopPadding method


Возвращает или задает количество пространства (в пунктах), добавляемое выше содержимого ячейки.
