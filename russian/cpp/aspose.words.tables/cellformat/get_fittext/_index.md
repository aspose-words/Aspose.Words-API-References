---
title: "Aspose::Words::Tables::CellFormat::get_FitText метод"
linktitle: "get_FitText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_FitText метод. Если true, помещает текст в ячейку, сжимая каждый абзац до ширины ячейки в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.tables/cellformat/get_fittext/
---
