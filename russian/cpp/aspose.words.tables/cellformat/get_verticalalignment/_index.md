---
title: "Aspose::Words::Tables::CellFormat::get_VerticalAlignment метод"
linktitle: "get_VerticalAlignment"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellFormat::get_VerticalAlignment метод. Возвращает или задает вертикальное выравнивание текста в ячейке в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.tables/cellformat/get_verticalalignment/
---
## CellFormat::get_VerticalAlignment method


Возвращает или задает вертикальное выравнивание текста в ячейке.
