---
title: "Aspose::Words::Tables::Table::get_DistanceRight метод"
linktitle: "get_DistanceRight"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::Table::get_DistanceRight метод. Получает или задает расстояние между правой стороной таблицы и окружающим текстом, в пунктах в C++."
type: docs
weight: 21000
url: /ru/cpp/aspose.words.tables/table/get_distanceright/
---
## Table::get_DistanceRight method


Получает или задаёт расстояние между правой границей таблицы и окружающим текстом, в пунктах.
