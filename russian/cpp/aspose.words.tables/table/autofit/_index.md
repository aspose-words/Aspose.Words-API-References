---
title: "Aspose::Words::Tables::Table::AutoFit метод"
linktitle: "Автоподгонка"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::Table::AutoFit метод. Изменяет размер таблицы и ячеек в соответствии с указанным поведением автоподгонки в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.tables/table/autofit/
---
## Table::AutoFit method


Изменяет размер таблицы и ячеек в соответствии с указанным поведением автоматической подгонки.
...
| --- | --- | --- |
| поведение | Aspose::Words::Tables::AutoFitBehavior | Указывает, как автоматически подгонять таблицу. |
## Примечания


Этот метод имитирует команды, доступные в меню Автоподгонки таблицы в Microsoft Word. Доступные команды: "Автоподгонка по содержимому", "Автоподгонка по окну" и "Фиксированная ширина столбца". В Microsoft Word эти команды задают соответствующие свойства таблицы, затем обновляют её макет, и Aspose.Words делает то же самое для вас.
