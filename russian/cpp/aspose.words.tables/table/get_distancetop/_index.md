---
title: "Aspose::Words::Tables::Table::get_DistanceTop метод"
linktitle: "get_DistanceTop"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::Table::get_DistanceTop метод. Получает или задает расстояние между верхом таблицы и окружающим текстом, в пунктах, в C++."
type: docs
weight: 22000
url: /ru/cpp/aspose.words.tables/table/get_distancetop/
---
## Table::get_DistanceTop method


Получает или задаёт расстояние между верхней границей таблицы и окружающим текстом, в пунктах.
