---
title: "Aspose::Words::Tables::Table::get_StyleName метод"
linktitle: "get_StyleName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Tables::Table::get_StyleName. Получает или задает имя стиля таблицы, применяемого к этой таблице в C++."
type: docs
weight: 36000
url: /ru/cpp/aspose.words.tables/table/get_stylename/
---
## Table::get_StyleName method


Получает или задает имя стиля таблицы, применяемого к этой таблице.
