---
title: "Метод Aspose::Words::Tables::Table::get_VerticalAnchor"
linktitle: "get_VerticalAnchor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Tables::Table::get_VerticalAnchor. Получает базовый объект, из которого рассчитывается вертикальное позиционирование плавающей таблицы. Значение по умолчанию — Margin в C++."
type: docs
weight: 41000
url: /ru/cpp/aspose.words.tables/table/get_verticalanchor/
---
## Table::get_VerticalAnchor method


Получает базовый объект, из которого рассчитывается вертикальное позиционирование плавающей таблицы. Значение по умолчанию — [Margin](../../../aspose.words.drawing/relativeverticalposition/).
