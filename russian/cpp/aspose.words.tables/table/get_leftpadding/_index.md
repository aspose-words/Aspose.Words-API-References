---
title: "Aspose::Words::Tables::Table::get_LeftPadding метод"
linktitle: "get_LeftPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::Table::get_LeftPadding метод. Получает или задает количество пространства (в пунктах), добавляемого слева от содержимого ячеек в C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words.tables/table/get_leftpadding/
---
## Table::get_LeftPadding method


Получает или задает количество пространства (в пунктах), добавляемого слева от содержимого ячеек.
