---
title: "Aspose::Words::Tables::RowFormat::get_Height метод"
linktitle: "get_Height"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::RowFormat::get_Height метод. Получает или задает высоту строки таблицы в пунктах в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.tables/rowformat/get_height/
---
