---
title: "Aspose::Words::Tables::CellCollection класс"
linktitle: "CellCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Tables::CellCollection класс. Предоставляет типизированный доступ к коллекции узлов Cell. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.tables/cellcollection/
---
## CellCollection class


Предоставляет типизированный доступ к коллекции узлов [Cell](../cell/). Чтобы узнать больше, посетите статью документации [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [idx_get](./idx_get/)(int32_t) | Получает [Cell](../cell/) по заданному индексу. |
