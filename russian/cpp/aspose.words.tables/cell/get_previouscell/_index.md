...
description: "Aspose::Words::Tables::Cell::get_PreviousCell method. Получает предыдущий узел Cell в C++."
type: docs
weight: 12500
url: /ru/cpp/aspose.words.tables/cell/get_previouscell/
---
## Cell::get_PreviousCell method


Получает предыдущий узел [Cell](../).
