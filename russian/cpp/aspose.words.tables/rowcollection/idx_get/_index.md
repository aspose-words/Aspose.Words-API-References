---
title: "Метод Aspose::Words::Tables::RowCollection::idx_get"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Tables::RowCollection::idx_get. Получает объект Row по заданному индексу в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.tables/rowcollection/idx_get/
---
## RowCollection::idx_get method


Получает [Row](../../row/) по заданному индексу.
