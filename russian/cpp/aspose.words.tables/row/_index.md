...
description: "Aspose::Words::Tables::Row class. Представляет строку таблицы. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.tables/row/
---
## Row class


Представляет строку таблицы. Чтобы узнать больше, посетите статью документации [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [AcceptEnd](./acceptend/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Принимает посетителя для обхода конца строки. |
| [AcceptStart](./acceptstart/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Принимает посетителя для обхода начала строки. |
| [AppendChild](../../aspose.words/compositenode/appendchild/)(T) |  |
| [Clone](../../aspose.words/node/clone/)(bool) | Создаёт дубликат узла. |
| [EnsureMinimum](./ensureminimum/)() | Если у [Row](./) нет ячеек, создает и добавляет одну [Cell](../cell/). |
| [get_Cells](./get_cells/)() | Обеспечивает типизированный доступ к дочерним узлам [Cell](../cell/) строки. |
...
| [get_FirstCell](./get_firstcell/)() | Возвращает первую [Cell](../cell/) в строке. |
...
| [get_Hidden](./get_hidden/)() | Получает или задает флаг, указывающий, скрыта ли эта строка. |
...
| [get_IsFirstRow](./get_isfirstrow/)() | True, если это первая строка в таблице; иначе false. |
| [get_IsLastRow](./get_islastrow/)() | True, если это последняя строка в таблице; иначе false. |
| [get_LastCell](./get_lastcell/)() | Возвращает последний [Cell](../cell/) в строке. |
| [get_LastChild](../../aspose.words/compositenode/get_lastchild/)() const | Возвращает последнего дочернего узла. |
| [get_NextNode](../../aspose.words/node/get_nextnode/)() const |  |
| [get_NextRow](./get_nextrow/)() | Получает следующий [Row](./) узел. |
| [get_NextSibling](../../aspose.words/node/get_nextsibling/)() | Возвращает узел, непосредственно следующий за этим узлом. |
| [get_NodeType](./get_nodetype/)() const override | Возвращает [Row](../../aspose.words/nodetype/). |
| [get_ParentNode](../../aspose.words/node/get_parentnode/)() | Возвращает непосредственного родителя этого узла. |
| [get_ParentTable](./get_parenttable/)() | Возвращает непосредственную родительскую таблицу строки. |
| [get_PreviousRow](./get_previousrow/)() | Получает предыдущий [Row](./) узел. |
...
| [get_RowFormat](./get_rowformat/)() | Предоставляет доступ к свойствам форматирования строки. |
...
| [GetText](./gettext/)() override | Получает текст всех ячеек в этой строке, включая символ конца строки. |
...
| [Row](./row/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&) | Инициализирует новый экземпляр класса [Row](./). |
...
| [set_Hidden](./set_hidden/)(bool) | Сеттер для [Aspose::Words::Tables::Row::get_Hidden](./get_hidden/). |
...
Минимальная корректная строка должна содержать как минимум одну [Cell](../cell/).
