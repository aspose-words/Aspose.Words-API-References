---
title: "Метод Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit"
linktitle: "get_Unit"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit. Получает или задает значение масштабирования единиц отображения как одно из предопределенных значений в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing.charts/axisdisplayunit/get_unit/
---
