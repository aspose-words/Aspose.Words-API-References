---
title: "Метод Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit"
linktitle: "get_CustomUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit. Получает или задает пользовательский делитель для масштабирования единиц отображения по оси значений в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


Получает или задает пользовательский делитель для масштабирования единиц отображения на оси значений.
...
Установка этого свойства задает свойство [Unit](../get_unit/) как [Custom](../../axisbuiltinunit/).
