...
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit класс. Предоставляет доступ к параметрам масштабирования единиц отображения для оси значений. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Обеспечивает доступ к параметрам масштабирования единиц отображения для оси значений. Чтобы узнать больше, посетите статью документации [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | Получает или задает пользовательский делитель для масштабирования единиц отображения на оси значений. |
| [get_Document](./get_document/)() | Возвращает документ, содержащий родительскую диаграмму. |
| [get_Unit](./get_unit/)() const | Получает или задает значение масштабирования единиц отображения как одно из предопределенных значений. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | Сеттер для [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | Сеттер для [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
