---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode перечисление"
linktitle: "ChartDataLabelLocationMode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode перечисление. Указывает, как значения, задающие расположение подписи данных — свойства Left и Top — интерпретируются в C++."
type: docs
weight: 27167
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


Указывает, как значения, задающие расположение подписи данных — свойства [Left](../chartdatalabel/get_left/) и [Top](../chartdatalabel/get_top/) — интерпретируются.
...
| --- | --- | --- |
| Offset | 0 | Расположение подписи данных задаётся смещением от позиции, определённой её свойством [Position](../chartdatalabel/get_position/). |
| Абсолютный | 1 | Расположение подписи данных задаётся с использованием абсолютных координат, начиная с верхнего левого угла диаграммы. |
