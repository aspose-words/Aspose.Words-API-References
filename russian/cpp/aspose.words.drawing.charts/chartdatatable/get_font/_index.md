---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Font метод"
linktitle: "get_Font"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Font метод. Предоставляет доступ к форматированию шрифта таблицы данных в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_font/
---
## ChartDataTable::get_Font method


Обеспечивает доступ к форматированию шрифта таблицы данных.
