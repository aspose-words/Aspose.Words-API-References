---
title: "метод Aspose::Words::Drawing::Charts::ChartDataTable::get_Show"
linktitle: "get_Show"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Drawing::Charts::ChartDataTable::get_Show. Получает или задает флаг, указывающий, будет ли таблица данных отображаться для диаграммы. Значение по умолчанию — false в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_show/
---
## ChartDataTable::get_Show method


Получает или задает флаг, указывающий, будет ли таблица данных отображаться для диаграммы. Значение по умолчанию — **false**.
