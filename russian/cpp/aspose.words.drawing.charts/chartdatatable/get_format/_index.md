---
title: "Метод Aspose::Words::Drawing::Charts::ChartDataTable::get_Format"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartDataTable::get_Format. Предоставляет доступ к заполнению фона текста и форматированию границ таблицы данных в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_format/
---
## ChartDataTable::get_Format method


Обеспечивает доступ к заливке фона текста и форматированию границы таблицы данных.
