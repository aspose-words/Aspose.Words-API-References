---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder метод"
linktitle: "get_HasOutlineBorder"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder метод. Получает или задает флаг, указывающий, отображается ли контурная граница, то есть граница вокруг названий рядов и категорий. Значение по умолчанию — true в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_hasoutlineborder/
---
## ChartDataTable::get_HasOutlineBorder method


Получает или задает флаг, указывающий, отображается ли контурная граница, то есть граница вокруг названий рядов и категорий. Значение по умолчанию — **true**.
