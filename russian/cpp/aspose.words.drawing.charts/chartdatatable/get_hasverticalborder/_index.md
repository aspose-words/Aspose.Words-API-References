---
title: "метод Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder"
linktitle: "get_HasVerticalBorder"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder. Получает или задает флаг, указывающий, отображается ли вертикальная граница таблицы данных. Значение по умолчанию — true в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_hasverticalborder/
---
## ChartDataTable::get_HasVerticalBorder method


Получает или задает флаг, указывающий, отображается ли вертикальная граница таблицы данных. Значение по умолчанию — **true**.
