---
title: "метод Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder"
linktitle: "get_HasHorizontalBorder"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder метод. Получает или задает флаг, указывающий, отображается ли горизонтальная граница таблицы данных. Значение по умолчанию — true в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing.charts/chartdatatable/get_hashorizontalborder/
---
## ChartDataTable::get_HasHorizontalBorder method


Получает или задает флаг, указывающий, отображается ли горизонтальная граница таблицы данных. Значение по умолчанию — **true**.
