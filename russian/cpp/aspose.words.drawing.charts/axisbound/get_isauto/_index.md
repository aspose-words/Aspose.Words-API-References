---
title: "Метод Aspose::Words::Drawing::Charts::AxisBound::get_IsAuto"
linktitle: "get_IsAuto"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisBound::get_IsAuto. Возвращает флаг, указывающий, что граница оси должна определяться автоматически в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing.charts/axisbound/get_isauto/
---
## AxisBound::get_IsAuto method


Возвращает флаг, указывающий, что ограничение оси должно определяться автоматически.
