---
title: "Метод Aspose::Words::Drawing::Charts::ChartTitle::get_Orientation"
linktitle: "get_Orientation"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartTitle::get_Orientation. Получает или задает ориентацию текста заголовка диаграммы в C++."
type: docs
weight: 1875
url: /ru/cpp/aspose.words.drawing.charts/charttitle/get_orientation/
---
## ChartTitle::get_Orientation method


Возвращает или задаёт ориентацию текста заголовка диаграммы.
