---
title: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Position"
linktitle: "get_Position"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Position. Получает или задает положение меток делений на оси в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabels/get_position/
---
## AxisTickLabels::get_Position method


Получает или задает позицию меток делений на оси.
