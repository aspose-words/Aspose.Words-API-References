---
title: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing"
linktitle: "get_Spacing"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing. Получает или задает интервал, с которым рисуются метки делений, в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


Получает или задает интервал, с которым рисуются подписи делений.
...
Это свойство влияет на оси категорий текста и серии. Оно не поддерживается новыми диаграммами MS Office 2016. Допустимый диапазон значения — больше или равно 1.

Установка этого свойства задает свойство [IsAutoSpacing](../get_isautospacing/) в значение **false**.
