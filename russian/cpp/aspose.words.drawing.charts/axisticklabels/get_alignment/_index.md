---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Alignment метод"
linktitle: "get_Alignment"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Alignment метод. Получает или задает выравнивание текста меток делений оси в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabels/get_alignment/
---
## AxisTickLabels::get_Alignment method


Получает или задает выравнивание текста меток делений оси.
...
Значение по умолчанию — [Center](../../../aspose.words/paragraphalignment/).
