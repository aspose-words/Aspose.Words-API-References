---
title: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Offset"
linktitle: "get_Offset"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_Offset. Получает или задает расстояние меток делений от оси в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabels/get_offset/
---
## AxisTickLabels::get_Offset method


Получает или задает расстояние меток делений от оси.
...
Свойство представляет собой процент от стандартного смещения метки.

Допустимый диапазон от 0 до 1000 процентов включительно. Значение по умолчанию — 100%.

Свойство действует только для категориальных осей. Оно не поддерживается новыми диаграммами MS Office 2016.
