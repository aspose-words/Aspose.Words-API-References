---
title: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing"
linktitle: "get_IsAutoSpacing"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing. Получает или задает флаг, указывающий, использовать ли автоматический интервал для рисования меток делений в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabels/get_isautospacing/
---
## AxisTickLabels::get_IsAutoSpacing method


Получает или задает флаг, указывающий, использовать ли автоматический интервал при отрисовке меток делений.
...
Это свойство влияет на оси категорий текста и серии. Оно не поддерживается новыми диаграммами MS Office 2016.
