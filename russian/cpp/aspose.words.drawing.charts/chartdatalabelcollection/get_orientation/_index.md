---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_Orientation метод"
linktitle: "get_Orientation"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_Orientation метод. Получает или задает ориентацию текста подписи данных всей серии в C++."
type: docs
weight: 5334
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_orientation/
---
## ChartDataLabelCollection::get_Orientation method


Получает или задает ориентацию текста подписей данных всей серии.
