---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat метод"
linktitle: "get_NumberFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat метод. Возвращает экземпляр ChartNumberFormat, позволяющий задать числовой формат для подписей данных всей серии в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_numberformat/
---
## ChartDataLabelCollection::get_NumberFormat method


Возвращает экземпляр [ChartNumberFormat](../../chartnumberformat/), позволяющий задать числовой формат для подписей данных всей серии.
