---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowValue метод"
linktitle: "get_ShowValue"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowValue метод. Позволяет указать, следует ли отображать значения в подписи данных всей серии. Значение по умолчанию — false в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showvalue/
---
## ChartDataLabelCollection::get_ShowValue method


Позволяет указать, следует ли отображать значения в подписях данных всей серии. Значение по умолчанию — **false**.
