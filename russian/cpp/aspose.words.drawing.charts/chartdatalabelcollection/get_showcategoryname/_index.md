---
title: "Метод Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowCategoryName"
linktitle: "get_ShowCategoryName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowCategoryName. Позволяет указать, следует ли отображать название категории для подписей данных всей серии. Значение по умолчанию — false в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showcategoryname/
---
