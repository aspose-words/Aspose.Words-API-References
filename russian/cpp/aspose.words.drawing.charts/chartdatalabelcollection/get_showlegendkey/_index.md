---
title: "Метод Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowLegendKey"
linktitle: "get_ShowLegendKey"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowLegendKey. Позволяет указать, следует ли отображать ключ легенды для подписей данных всей серии. Значение по умолчанию — false в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showlegendkey/
---
## ChartDataLabelCollection::get_ShowLegendKey method


Позволяет указать, следует ли отображать ключ легенды в подписях данных всей серии. Значение по умолчанию — **false**.
