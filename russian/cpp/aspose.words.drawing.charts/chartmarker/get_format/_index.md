---
title: "Aspose::Words::Drawing::Charts::ChartMarker::get_Format метод"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartMarker::get_Format метод. Обеспечивает доступ к заполнению и форматированию линий этого маркера в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/chartmarker/get_format/
---
## ChartMarker::get_Format method


Предоставляет доступ к настройкам заливки и линии этого маркера.
