---
title: "Aspose::Words::Drawing::Charts::ChartSeriesGroup::get_AxisGroup метод"
linktitle: "get_AxisGroup"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartSeriesGroup::get_AxisGroup метод. Получает или задает группу осей, к которой принадлежит эта группа рядов, в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/chartseriesgroup/get_axisgroup/
---
## ChartSeriesGroup::get_AxisGroup method


Получает или задает группу осей, к которой относится эта группа рядов.
