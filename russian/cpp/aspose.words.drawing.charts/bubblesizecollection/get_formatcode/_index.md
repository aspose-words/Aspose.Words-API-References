---
title: "Метод Aspose::Words::Drawing::Charts::BubbleSizeCollection::get_FormatCode"
linktitle: "get_FormatCode"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::BubbleSizeCollection::get_FormatCode. Получает или задает код формата, применяемый к размерам пузырей в C++."
type: docs
weight: 2500
url: /ru/cpp/aspose.words.drawing.charts/bubblesizecollection/get_formatcode/
---
## BubbleSizeCollection::get_FormatCode method


Получает или задает код формата, применяемый к размерам пузырей.
