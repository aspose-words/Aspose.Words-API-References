...
description: "Метод Aspose::Words::Drawing::Charts::ChartSeriesGroupCollection::Add. Добавляет новую группу серий указанного типа в эту коллекцию в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/chartseriesgroupcollection/add/
---
## ChartSeriesGroupCollection::Add method


Добавляет новую группу серий указанного типа серий в эту коллекцию.
