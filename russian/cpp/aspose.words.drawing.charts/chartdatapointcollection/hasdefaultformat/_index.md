---
title: "Метод Aspose::Words::Drawing::Charts::ChartDataPointCollection::HasDefaultFormat"
linktitle: "HasDefaultFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartDataPointCollection::HasDefaultFormat. Получает флаг, указывающий, имеет ли точка данных в указанном индексе формат по умолчанию, в C++."
type: docs
weight: 5500
url: /ru/cpp/aspose.words.drawing.charts/chartdatapointcollection/hasdefaultformat/
---
