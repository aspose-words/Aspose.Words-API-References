---
title: "Aspose::Words::Drawing::Charts::ChartSeries::get_Marker метод"
linktitle: "get_Marker"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartSeries::get_Marker метод. Указывает маркер данных. Маркер автоматически создаётся при запросе в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.drawing.charts/chartseries/get_marker/
---
## ChartSeries::get_Marker method


Указывает маркер данных. Маркер автоматически создаётся по запросу.
