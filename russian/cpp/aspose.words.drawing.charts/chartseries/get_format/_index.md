---
title: "Метод Aspose::Words::Drawing::Charts::ChartSeries::get_Format"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartSeries::get_Format. Предоставляет доступ к настройкам заливки и линий серии в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.drawing.charts/chartseries/get_format/
---
## ChartSeries::get_Format method


Обеспечивает доступ к форматированию заливки и линий серии.
...
// Добавление новых серий. Массивы значений и категорий должны быть одинакового размера.
