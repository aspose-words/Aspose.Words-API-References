---
title: "Aspose::Words::Drawing::Charts::ChartSeries::Clear метод"
linktitle: "Clear"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartSeries::Clear метод. Удаляет все значения данных из серии диаграммы. Формат всех отдельных точек данных и подписей к данным очищается в C++."
type: docs
weight: 1500
url: /ru/cpp/aspose.words.drawing.charts/chartseries/clear/
---
## ChartSeries::Clear method


Удаляет все данные из серии диаграммы. Формат всех отдельных точек данных и подписей данных очищается.
