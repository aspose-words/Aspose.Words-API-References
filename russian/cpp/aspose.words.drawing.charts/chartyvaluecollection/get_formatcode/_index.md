---
title: "Метод Aspose::Words::Drawing::Charts::ChartYValueCollection::get_FormatCode"
linktitle: "get_FormatCode"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartYValueCollection::get_FormatCode. Получает или задает код формата, применяемый к значениям Y в C++."
type: docs
weight: 2500
url: /ru/cpp/aspose.words.drawing.charts/chartyvaluecollection/get_formatcode/
---
## ChartYValueCollection::get_FormatCode method


Получает или задает код формата, применяемый к значениям Y.
