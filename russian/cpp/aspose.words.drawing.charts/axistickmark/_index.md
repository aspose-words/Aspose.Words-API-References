...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. Указывает возможные положения меток делений в C++."
type: docs
weight: 25000
url: /ru/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum


Указывает возможные позиции отметок делений.
...
| --- | --- | --- |
| Крест | 0 | Указывает, что метки делений должны пересекать ось. |
| Внутри | 1 | Указывает, что метки делений должны находиться внутри области построения. |
| Снаружи | 2 | Указывает, что метки делений должны находиться за пределами области построения. |
| None | 3 | Указывает, что метки делений отсутствуют. |
