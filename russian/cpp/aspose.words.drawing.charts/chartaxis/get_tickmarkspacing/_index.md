---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_TickMarkSpacing метод"
linktitle: "get_TickMarkSpacing"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_TickMarkSpacing метод. Получает или задает интервал, с которым рисуются деления в C++."
type: docs
weight: 28000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_tickmarkspacing/
---
...
Допустимый диапазон значения — больше или равно 1.
