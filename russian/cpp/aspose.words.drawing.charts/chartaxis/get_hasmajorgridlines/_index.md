---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_HasMajorGridlines метод"
linktitle: "get_HasMajorGridlines"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_HasMajorGridlines метод. Получает или задает флаг, указывающий, имеет ли ось основные линии сетки в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_hasmajorgridlines/
---
## ChartAxis::get_HasMajorGridlines method


Получает или задает флаг, указывающий, имеет ли ось основные линии сетки.
