---
title: "Метод Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit"
linktitle: "get_MinorUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnit. Возвращает или задает расстояние между вспомогательными делениями шкалы в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_minorunit/
---
## ChartAxis::get_MinorUnit method


Возвращает или задает расстояние между вспомогательными делениями.
...
Допустимый диапазон значения больше нуля. Это свойство влияет на оси временной категории и значения.

Установка этого свойства задает значение свойства [MinorUnitIsAuto](../get_minorunitisauto/) в **false**.
