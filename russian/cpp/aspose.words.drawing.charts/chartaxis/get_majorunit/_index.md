---
title: "Метод Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnit"
linktitle: "get_MajorUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnit. Возвращает или задает расстояние между основными делениями шкалы в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_majorunit/
---
...
Установка этого свойства задает значение свойства [MajorUnitIsAuto](../get_majorunitisauto/) в **false**.
