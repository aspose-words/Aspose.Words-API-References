---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_BaseTimeUnit метод"
linktitle: "get_BaseTimeUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_BaseTimeUnit метод. Возвращает или задает наименьшую единицу времени, представленную на оси временной категории в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_basetimeunit/
---
## ChartAxis::get_BaseTimeUnit method


Возвращает или задает наименьшую единицу времени, отображаемую на оси временных категорий.
