---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_DisplayUnit метод"
linktitle: "get_DisplayUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_DisplayUnit метод. Указывает масштабное значение отображаемых единиц для оси значений в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_displayunit/
---
