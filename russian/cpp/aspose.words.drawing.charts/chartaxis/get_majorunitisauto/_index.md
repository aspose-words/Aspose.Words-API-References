---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto метод"
linktitle: "get_MajorUnitIsAuto"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto метод. Получает или задает флаг, указывающий, следует ли использовать расстояние по умолчанию между основными делениями в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitisauto/
---
