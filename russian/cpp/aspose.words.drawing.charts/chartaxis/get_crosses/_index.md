---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_Crosses метод"
linktitle: "get_Crosses"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_Crosses метод. Указывает, как эта ось пересекает перпендикулярную ось в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_crosses/
---
...
Значение по умолчанию — [Automatic](../../axiscrosses/).
