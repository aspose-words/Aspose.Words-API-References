---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto метод"
linktitle: "get_MinorUnitIsAuto"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto метод. Получает или задаёт флаг, указывающий, следует ли использовать расстояние по умолчанию между небольшими делениями шкалы в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_minorunitisauto/
---
## ChartAxis::get_MinorUnitIsAuto method


Получает или задает флаг, указывающий, следует ли использовать расстояние по умолчанию между вспомогательными делениями.
