---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitScale метод"
linktitle: "get_MinorUnitScale"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitScale метод. Возвращает или задает значение масштаба для небольших делений на оси категорий времени в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_minorunitscale/
---
## ChartAxis::get_MinorUnitScale method


Возвращает или задает значение масштаба для вспомогательных делений на оси временных категорий.
