---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_Format метод"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_Format метод. Предоставляет доступ к форматированию линий оси и заливке меток делений в C++."
type: docs
weight: 8500
url: /ru/cpp/aspose.words.drawing.charts/chartaxis/get_format/
---
## ChartAxis::get_Format method


Обеспечивает доступ к форматированию линий оси и заливке меток делений.
