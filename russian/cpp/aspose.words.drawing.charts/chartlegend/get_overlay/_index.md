---
title: "Метод Aspose::Words::Drawing::Charts::ChartLegend::get_Overlay"
linktitle: "get_Overlay"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartLegend::get_Overlay. Определяет, разрешено ли другим элементам диаграммы перекрывать легенду. Значение по умолчанию — false в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing.charts/chartlegend/get_overlay/
---
