---
title: "Метод Aspose::Words::Drawing::Charts::ChartLegend::get_LegendEntries"
linktitle: "get_LegendEntries"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartLegend::get_LegendEntries. Возвращает коллекцию записей легенды для всех рядов и линий тренда родительской диаграммы в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.drawing.charts/chartlegend/get_legendentries/
---
## ChartLegend::get_LegendEntries method


Возвращает коллекцию элементов легенды для всех серий и трендовых линий родительской диаграммы.
