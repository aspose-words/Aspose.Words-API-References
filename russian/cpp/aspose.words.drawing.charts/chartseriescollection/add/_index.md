---
title: "Метод Aspose::Words::Drawing::Charts::ChartSeriesCollection::Add"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Charts::ChartSeriesCollection::Add. Добавляет новый ChartSeries в эту коллекцию. Используйте этот метод, чтобы добавить серии к гистограммам в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing.charts/chartseriescollection/add/
---
## ChartSeriesCollection::Add(const System::String\&, const System::ArrayPtr\<double\>\&) method


Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к гистограммам.
...
Недавно добавленный объект [ChartSeries](../../chartseries/).
...
Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любым типам диаграмм разброса.
...
Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любым типам пузырьковых диаграмм.
...
Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любым типам областных, радиальных и биржевых диаграмм.
...
Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии с многоуровневыми категориями данных.
...
Показывает, как создать диаграмму Sunburst.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Вставить диаграмму Sunburst.
...
Добавляет новый [ChartSeries](../../chartseries/) в эту коллекцию. Используйте этот метод, чтобы добавить серии к любым типам столбчатых, колонных, линейных и поверхностных диаграмм.
...
Показывает, как создать ящик с усами.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Вставить диаграмму Box & Whisker.
...
// Вставить воронкообразную диаграмму.
