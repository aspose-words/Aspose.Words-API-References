...
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition enum. Указывает возможные положения меток делений в C++."
type: docs
weight: 24000
url: /ru/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
## AxisTickLabelPosition enum


Указывает возможные позиции меток делений.
...
| --- | --- | --- |
| High | 0 | Указывает, что подписи оси должны находиться в верхнем конце перпендикулярной оси. |
| Low | 1 | Указывает, что подписи оси должны находиться в нижнем конце перпендикулярной оси. |
| NextToAxis | 2 | Указывает, что подписи оси должны располагаться рядом с осью. |
| None | 3 | Указывает, что подписи оси не рисуются. |
| Default | н/д | Указывает значение позиции меток делений по умолчанию. |
