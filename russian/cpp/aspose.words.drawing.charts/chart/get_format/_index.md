---
title: "Aspose::Words::Drawing::Charts::Chart::get_Format метод"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::Chart::get_Format метод. Предоставляет доступ к заполнению и форматированию линий диаграммы в C++."
type: docs
weight: 4750
url: /ru/cpp/aspose.words.drawing.charts/chart/get_format/
---
## Chart::get_Format method


Обеспечивает доступ к форматированию заливки и линий диаграммы.
