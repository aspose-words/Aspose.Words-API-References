...
description: "Aspose::Words::Drawing::Charts::AxisGroup enum. Представляет тип группы осей диаграммы в C++."
type: docs
weight: 22500
url: /ru/cpp/aspose.words.drawing.charts/axisgroup/
---
## AxisGroup enum
...
| --- | --- | --- |
| Основной | 0 | Указывает основную группу осей. |
| Вторичный | 1 | Указывает вторичную группу осей. |
