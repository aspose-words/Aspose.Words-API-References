---
title: "Aspose::Words::Drawing::Charts::AxisCategoryType перечисление"
linktitle: "AxisCategoryType"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::AxisCategoryType перечисление. Указывает тип категориальной оси в C++."
type: docs
weight: 21000
url: /ru/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| --- | --- | --- |
| Автоматически | 0 | Указывает, что тип категориальной оси определяется автоматически на основе данных. |
| Категория | 1 | Указывает ось произвольного набора категорий. |
| Время | 2 | Указывает временную категориальную ось. |
