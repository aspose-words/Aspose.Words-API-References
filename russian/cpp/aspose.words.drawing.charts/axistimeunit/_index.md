---
title: "Перечисление Aspose::Words::Drawing::Charts::AxisTimeUnit"
linktitle: "AxisTimeUnit"
second_title: "Справочник API Aspose.Words для C++"
description: "Перечисление Aspose::Words::Drawing::Charts::AxisTimeUnit. Указывает единицу времени для осей в C++."
type: docs
weight: 26000
url: /ru/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum
...
| --- | --- | --- |
| Автоматически | 0 | Указывает, что единица не была задана явно и следует использовать значение по умолчанию. |
| Дни | 1 | Указывает, что данные диаграммы должны отображаться в днях. |
| Месяцы | 2 | Указывает, что данные диаграммы должны отображаться в месяцах. |
| Годы | 3 | Указывает, что данные диаграммы должны отображаться в годах. |
