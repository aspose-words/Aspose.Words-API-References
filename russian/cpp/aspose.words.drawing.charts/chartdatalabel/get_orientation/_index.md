---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Orientation метод"
linktitle: "get_Orientation"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Orientation метод. Получает или задает ориентацию текста метки в C++."
type: docs
weight: 7334
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabel/get_orientation/
---
## ChartDataLabel::get_Orientation method


Получает или устанавливает ориентацию текста подписи.
