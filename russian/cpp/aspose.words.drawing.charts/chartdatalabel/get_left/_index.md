---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left метод"
linktitle: "get_Left"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left метод. Получает или задает расстояние метки данных в пунктах от левого края диаграммы или от позиции, указанной в свойстве Position, в зависимости от значения свойства LeftMode в C++."
type: docs
weight: 6334
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


Получает или задает расстояние метки данных в пунктах от левого края диаграммы или от позиции, указанной в свойстве [Position](../get_position/), в зависимости от значения свойства [LeftMode](../get_leftmode/).
