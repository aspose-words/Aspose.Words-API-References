---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Position метод"
linktitle: "get_Position"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Position метод. Получает или задает позицию подписи данных в C++."
type: docs
weight: 7501
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabel/get_position/
---
## ChartDataLabel::get_Position method


Получает или устанавливает позицию подписи данных.
