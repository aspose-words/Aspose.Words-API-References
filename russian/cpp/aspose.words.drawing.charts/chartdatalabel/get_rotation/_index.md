---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Rotation метод"
linktitle: "get_Rotation"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Rotation метод. Получает или задает вращение метки в градусах в C++."
type: docs
weight: 7667
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabel/get_rotation/
---
## ChartDataLabel::get_Rotation method


Получает или устанавливает вращение подписи в градусах.
...
Если значение [Orientation](../get_orientation/) равно [Horizontal](../../../aspose.words.drawing/shapetextorientation/), форма метки, если она существует, вращается вместе с текстом метки. В противном случае вращается только текст метки.
