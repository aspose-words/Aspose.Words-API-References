---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode метод"
linktitle: "get_TopMode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode метод. Получает или задает режим интерпретации значения свойства Top: определяет, устанавливает ли он расположение подписи данных от верхнего края диаграммы или от позиции, указанной в свойстве Position, в C++."
type: docs
weight: 16667
url: /ru/cpp/aspose.words.drawing.charts/chartdatalabel/get_topmode/
---
## ChartDataLabel::get_TopMode method


Получает или задает режим интерпретации значения свойства [Top](../get_top/): определяет, устанавливает ли он расположение подписи данных от верхнего края диаграммы или от позиции, указанной в свойстве [Position](../get_position/).
