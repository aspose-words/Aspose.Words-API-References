...
description: "Aspose::Words::Layout::RevisionTextEffect enum. Позволяет указать эффект декорирования для правок текста документа в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.layout/revisiontexteffect/
---
## RevisionTextEffect enum


Позволяет задать эффект декорирования для ревизий текста документа.
...
| --- | --- | --- |
| None | 0 | Для исправленного содержимого не применяются специальные эффекты. Это соответствует [NoHighlight](../revisioncolor/). |
| Цвет | 1 | Исправленное содержимое выделяется только цветом. |
| Полужирный | 2 | Пересмотренный контент сделан полужирным и окрашен. |
| Курсив | 3 | Пересмотренный контент сделан курсивом и окрашен. |
| Подчеркивание | 4 | Пересмотренный контент подчеркнут и окрашен. |
| ДвойноеПодчеркивание | 5 | Пересмотренный контент двойным подчеркиванием и окрашен. |
| Зачёркивание | 6 | Пересмотренный контент зачёркнут и окрашен. |
| ДвойноеЗачёркивание | 7 | Пересмотренный контент двойным зачёркиванием и окрашен. |
| Скрытый | 8 | Пересмотренный контент скрыт. |
