---
title: "Aspose::Words::Layout::ShowInBalloons перечисление"
linktitle: "ShowInBalloons"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::ShowInBalloons перечисление. Указывает, какие ревизии отображаются в баллонах в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Указывает, какие ревизии отображаются в виде баллонов.
...
| --- | --- | --- |
| None | 0 | Отображает вставки, удаления и форматные ревизии встроенно. |
| Формат | 1 | Отображает вставки и удаления встроенно, форматные ревизии в баллонах. |
| FormatAndDelete | 2 | Отображает вставленные правки встроенно, а удаления и форматирования правок — в облачках. |
