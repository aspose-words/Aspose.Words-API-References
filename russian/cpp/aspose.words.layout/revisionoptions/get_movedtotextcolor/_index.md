---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor метод"
linktitle: "get_MovedToTextColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor. Позволяет указать цвет, используемый для областей, куда был перемещён контент при перемещении. Значение по умолчанию — ByAuthor в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


Позволяет указать цвет, используемый для областей, куда был перемещён контент при [Moving](../../../aspose.words/revisiontype/). Значение по умолчанию — [ByAuthor](../../revisioncolor/).
