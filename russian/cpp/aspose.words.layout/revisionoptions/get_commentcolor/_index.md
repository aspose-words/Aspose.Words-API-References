---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_CommentColor"
linktitle: "get_CommentColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_CommentColor. Позволяет указать цвет, используемый для комментариев. Значение по умолчанию — Red в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


Позволяет указать цвет, используемый для комментариев. Значение по умолчанию — [Red](../../revisioncolor/).
