---
title: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect метод"
linktitle: "get_InsertedTextEffect"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect метод. Позволяет указать эффект, применяемый к вставленному содержимому Insertion. Значение по умолчанию — Underline в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_insertedtexteffect/
---
## RevisionOptions::get_InsertedTextEffect method


Позволяет указать эффект, применяемый к вставленному содержимому [Insertion](../../../aspose.words/revisiontype/). Значение по умолчанию — [Underline](../../revisiontexteffect/).
