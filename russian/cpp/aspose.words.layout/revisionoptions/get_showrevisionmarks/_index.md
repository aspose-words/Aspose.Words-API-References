---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks"
linktitle: "get_ShowRevisionMarks"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks. Позволяет указать, следует ли помечать текст исправлений специальным форматированием. Значение по умолчанию — true в C++."
type: docs
weight: 20000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_showrevisionmarks/
---
## RevisionOptions::get_ShowRevisionMarks method


Позволяет указать, следует ли помечать текст исправлений специальной разметкой форматирования. Значение по умолчанию — **true**.
