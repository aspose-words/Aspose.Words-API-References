---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_RevisionBarsWidth"
linktitle: "get_RevisionBarsWidth"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_RevisionBarsWidth. Получает или задает ширину линий исправлений в пунктах в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_revisionbarswidth/
---
## RevisionOptions::get_RevisionBarsWidth method


Получает или задаёт ширину полос исправлений, в пунктах.
