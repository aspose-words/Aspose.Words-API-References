---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect"
linktitle: "get_MovedToTextEffect"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect. Позволяет указать эффект, применяемый к областям, куда был перемещён контент при перемещении. Значение по умолчанию — DoubleUnderline в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_movedtotexteffect/
---
## RevisionOptions::get_MovedToTextEffect method


Позволяет указать эффект, применяемый к областям, куда был перемещён контент [Moving](../../../aspose.words/revisiontype/). Значение по умолчанию — [DoubleUnderline](../../revisiontexteffect/)
