---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect"
linktitle: "get_DeletedTextEffect"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect. Позволяет указать эффект, применяемый к удаленному содержимому Deletion. Значение по умолчанию — StrikeThrough в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


Позволяет указать эффект, применяемый к удаленному содержимому [Deletion](../../../aspose.words/revisiontype/). Значение по умолчанию — [StrikeThrough](../../revisiontexteffect/)
