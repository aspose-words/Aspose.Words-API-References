---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect метод"
linktitle: "get_RevisedPropertiesEffect"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect метод. Позволяет указать эффект для областей содержимого с изменениями свойств форматирования FormatChange. Значение по умолчанию — None в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


Позволяет указать эффект для областей содержимого с изменениями свойств форматирования [FormatChange](../../../aspose.words/revisiontype/) Значение по умолчанию — [None](../../revisiontexteffect/)
