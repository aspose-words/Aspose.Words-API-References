---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor"
linktitle: "get_RevisionBarsColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor. Позволяет указать цвет, используемый для боковых полос, идентифицирующих строки документа, содержащие исправленную информацию. Значение по умолчанию — Red в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


Позволяет указать цвет, используемый для боковых полос, идентифицирующих строки документа, содержащие исправленную информацию. Значение по умолчанию — [Red](../../revisioncolor/).
