---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons метод"
linktitle: "get_ShowInBalloons"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons метод. Позволяет указать, отображаются ли ревизии в облачках. Значение по умолчанию — None в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_showinballoons/
---
## RevisionOptions::get_ShowInBalloons method


Позволяет указать, отображаются ли ревизии в облачках. Значение по умолчанию — [None](../../showinballoons/).
...
Показывает, как отображать ревизии в облачках.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>(get_MyDir() + u"Revisions.docx");

// По умолчанию текст, являющийся ревизией, имеет другой цвет, чтобы отличать его от обычного текста.
// Установите параметр ревизии, чтобы показывать более подробную информацию о каждой ревизии в облачке на правом поле страницы.
