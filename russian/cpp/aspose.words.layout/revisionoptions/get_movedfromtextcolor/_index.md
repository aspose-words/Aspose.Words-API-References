---
title: "Метод Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor"
linktitle: "get_MovedFromTextColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor. Позволяет указать цвет, используемый для областей, откуда был перемещён контент при перемещении. Значение по умолчанию — ByAuthor в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Позволяет указать цвет, используемый для областей, откуда был перемещён контент при [Moving](../../../aspose.words/revisiontype/). Значение по умолчанию — [ByAuthor](../../revisioncolor/).
