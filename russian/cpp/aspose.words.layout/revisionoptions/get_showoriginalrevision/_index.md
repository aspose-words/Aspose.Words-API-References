---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowOriginalRevision метод"
linktitle: "get_ShowOriginalRevision"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowOriginalRevision метод. Позволяет указать, следует ли показывать оригинальный текст вместо исправленного. Значение по умолчанию — false в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_showoriginalrevision/
---
