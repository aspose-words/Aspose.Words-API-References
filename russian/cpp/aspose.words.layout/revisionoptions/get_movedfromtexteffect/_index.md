---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect метод"
linktitle: "get_MovedFromTextEffect"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect метод. Позволяет указать эффект, применяемый к областям, из которых перемещён контент Moving. Значение по умолчанию — DoubleStrikeThrough в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.layout/revisionoptions/get_movedfromtexteffect/
---
## RevisionOptions::get_MovedFromTextEffect method


Позволяет указать эффект, применяемый к областям, из которых перемещён контент [Moving](../../../aspose.words/revisiontype/). Значение по умолчанию — [DoubleStrikeThrough](../../revisiontexteffect/)
