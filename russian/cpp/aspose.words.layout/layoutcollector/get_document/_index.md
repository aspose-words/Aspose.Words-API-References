---
title: "Aspose::Words::Layout::LayoutCollector::get_Document метод"
linktitle: "get_Document"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::LayoutCollector::get_Document метод. Получает или задаёт документ, к которому привязан данный экземпляр сборщика, в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.layout/layoutcollector/get_document/
---
## LayoutCollector::get_Document method


Получает или задаёт документ, к которому привязан этот экземпляр сборщика.
