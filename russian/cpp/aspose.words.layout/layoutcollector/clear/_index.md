---
title: "Aspose::Words::Layout::LayoutCollector::Clear метод"
linktitle: "Clear"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::LayoutCollector::Clear метод. Очищает все собранные данные макета. Вызовите этот метод после ручного обновления документа или после перестройки макета в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.layout/layoutcollector/clear/
---
## LayoutCollector::Clear method


Очищает все собранные данные макета. Вызовите этот метод после того, как документ был обновлён вручную или макет был перестроен.
