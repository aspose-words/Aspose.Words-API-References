---
title: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex метод"
linktitle: "GetStartPageIndex"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex метод. Получает индекс страницы, начинающийся с 1, где начинается узел. Возвращает 0, если узел нельзя сопоставить со страницей в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.layout/layoutcollector/getstartpageindex/
---
## LayoutCollector::GetStartPageIndex method


Получает индекс страницы, где начинается узел, начиная с 1. Возвращает 0, если узел нельзя сопоставить со страницей.
