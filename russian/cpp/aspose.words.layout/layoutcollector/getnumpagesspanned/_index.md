---
title: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned метод"
linktitle: "GetNumPagesSpanned"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned метод. Получает количество страниц, охватываемых указанным узлом. 0, если узел находится на одной странице. Это то же самое, что GetEndPageIndex() - GetStartPageIndex() в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


Получает количество страниц, охватываемых указанным узлом. 0, если узел находится на одной странице. Это то же самое, что [GetEndPageIndex()](../) - [GetStartPageIndex()](../).
