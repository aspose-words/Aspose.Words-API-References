---
title: "Aspose::Words::Settings::WriteProtection::get_IsWriteProtected метод"
linktitle: "get_IsWriteProtected"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Settings::WriteProtection::get_IsWriteProtected метод. Возвращает true, когда установлен пароль защиты от записи в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.settings/writeprotection/get_iswriteprotected/
---
## WriteProtection::get_IsWriteProtected method


Возвращает **true**, когда установлен пароль защиты записи.
