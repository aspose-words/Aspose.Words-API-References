---
title: "Aspose::Words::Drawing::SignatureLine::get_ShowDate метод"
linktitle: "get_ShowDate"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_ShowDate метод. Получает или задает значение, указывающее, что дата подписи отображается в строке подписи. Значение по умолчанию для этого свойства — true в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.drawing/signatureline/get_showdate/
---
