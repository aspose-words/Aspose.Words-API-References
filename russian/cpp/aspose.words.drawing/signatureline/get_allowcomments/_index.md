---
title: "Aspose::Words::Drawing::SignatureLine::get_AllowComments метод"
linktitle: "get_AllowComments"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_AllowComments метод. Получает или задает значение, указывающее, что подписант может добавлять комментарии в диалоговом окне Подписи. Значение по умолчанию для этого свойства — false в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/signatureline/get_allowcomments/
---
## SignatureLine::get_AllowComments method


Получает или задаёт значение, указывающее, что подписант может добавлять комментарии в диалоговом окне Sign. Значение свойства по умолчанию — **false**.
