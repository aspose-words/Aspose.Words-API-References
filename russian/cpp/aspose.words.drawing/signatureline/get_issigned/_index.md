---
title: "Aspose::Words::Drawing::SignatureLine::get_IsSigned метод"
linktitle: "get_IsSigned"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_IsSigned метод. Указывает, что строка подписи подписана цифровой подписью в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.drawing/signatureline/get_issigned/
---
