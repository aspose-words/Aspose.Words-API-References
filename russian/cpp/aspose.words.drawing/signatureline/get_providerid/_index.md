---
title: "Aspose::Words::Drawing::SignatureLine::get_ProviderId метод"
linktitle: "get_ProviderId"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_ProviderId метод. Получает или задает идентификатор поставщика подписи для этой строки подписи. Значение по умолчанию — \"{00000000-0000-0000-0000-000000000000}\" в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.drawing/signatureline/get_providerid/
---
