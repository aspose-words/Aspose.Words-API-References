---
title: "Aspose::Words::Drawing::SignatureLine::get_Email метод"
linktitle: "get_Email"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_Email метод. Получает или задает предлагаемый адрес электронной почты подписанта. Значение по умолчанию для этого свойства — пустая строка в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing/signatureline/get_email/
---
