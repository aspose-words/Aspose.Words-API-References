---
title: "Aspose::Words::Drawing::SignatureLine::get_Instructions метод"
linktitle: "get_Instructions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::SignatureLine::get_Instructions метод. Получает или задает инструкции подписанту, которые отображаются при подписании строки подписи. Это свойство игнорируется, если установлено DefaultInstructions. Значение по умолчанию для этого свойства — пустая строка в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.drawing/signatureline/get_instructions/
---
## SignatureLine::get_Instructions method


Получает или задает инструкции подписанту, которые отображаются при подписании строки подписи. Это свойство игнорируется, если [DefaultInstructions](../get_defaultinstructions/) установлено. Значение по умолчанию для этого свойства — **пустая строка**.
