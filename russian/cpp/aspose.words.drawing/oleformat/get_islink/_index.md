---
title: "Aspose::Words::Drawing::OleFormat::get_IsLink метод"
linktitle: "get_IsLink"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::OleFormat::get_IsLink метод. Возвращает true, если объект OLE связан (когда указано SourceFullName) в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing/oleformat/get_islink/
---
## OleFormat::get_IsLink method


Возвращает **true**, если объект OLE связан (когда указано [SourceFullName](../get_sourcefullname/)).
