---
title: "Метод Aspose::Words::Drawing::OleFormat::get_AutoUpdate"
linktitle: "get_AutoUpdate"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::OleFormat::get_AutoUpdate. Указывает, обновляется ли ссылка на объект OLE автоматически или нет в Microsoft Word на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/oleformat/get_autoupdate/
---
## OleFormat::get_AutoUpdate method


Указывает, автоматически обновляется ссылка на OLE-объект в Microsoft Word или нет.
