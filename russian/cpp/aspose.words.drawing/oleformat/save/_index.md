---
title: "Aspose::Words::Drawing::OleFormat::Save метод"
linktitle: "Save"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::OleFormat::Save метод. Сохраняет данные внедрённого объекта в указанный поток в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.drawing/oleformat/save/
---
...
| --- | --- | --- |
| stream | const System::SharedPtr\<System::IO::Stream\>\& | Где сохранять данные объекта. |
## Примечания


Ответственность за освобождение потока лежит на вызывающем.
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| fileName | const System::String\& | Имя файла для сохранения данных OLE‑объекта. |
