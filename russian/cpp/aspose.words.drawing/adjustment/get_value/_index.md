---
title: "Aspose::Words::Drawing::Adjustment::get_Value метод"
linktitle: "get_Value"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Adjustment::get_Value метод. Получает или задает сырое значение настройки в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.drawing/adjustment/get_value/
---
## Adjustment::get_Value method


Получает или задаёт необработанное значение корректировки.
