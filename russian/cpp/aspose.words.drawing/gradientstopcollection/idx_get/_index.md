---
title: "Aspose::Words::Drawing::GradientStopCollection::idx_get метод"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::GradientStopCollection::idx_get метод. Получает или задает объект GradientStop в коллекции в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.drawing/gradientstopcollection/idx_get/
---
