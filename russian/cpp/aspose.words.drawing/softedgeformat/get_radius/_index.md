---
title: "Метод Aspose::Words::Drawing::SoftEdgeFormat::get_Radius"
linktitle: "get_Radius"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::SoftEdgeFormat::get_Radius. Получает или задает значение типа double, представляющее длину радиуса для эффекта мягкого края в пунктах (pt). Значение по умолчанию — 0.0 в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/softedgeformat/get_radius/
---
## SoftEdgeFormat::get_Radius method


Получает или задаёт значение типа double, которое представляет длину радиуса эффекта мягкого края в пунктах (pt). Значение по умолчанию — 0,0.
