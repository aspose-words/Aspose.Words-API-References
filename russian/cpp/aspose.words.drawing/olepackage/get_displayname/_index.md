---
title: "Метод Aspose::Words::Drawing::OlePackage::get_DisplayName"
linktitle: "get_DisplayName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::OlePackage::get_DisplayName. Получает или задаёт отображаемое имя OLE Package в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/olepackage/get_displayname/
---
## OlePackage::get_DisplayName method


Получает или задаёт отображаемое имя OLE Package.
