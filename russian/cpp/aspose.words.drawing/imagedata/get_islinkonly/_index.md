---
title: "Aspose::Words::Drawing::ImageData::get_IsLinkOnly метод"
linktitle: "get_IsLinkOnly"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ImageData::get_IsLinkOnly метод. Возвращает true, если изображение связано и не хранится в документе в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.drawing/imagedata/get_islinkonly/
---
## ImageData::get_IsLinkOnly method


Возвращает **true**, если изображение связано и не хранится в документе.
