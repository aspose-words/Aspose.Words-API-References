...
description: "Aspose::Words::Drawing::ImageData::get_ImageBytes method. Получает или задает необработанные байты изображения, хранящегося в форме, в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.drawing/imagedata/get_imagebytes/
---
## ImageData::get_ImageBytes method


Получает или задает необработанные байты изображения, хранящиеся в фигуре.
...
Установка значения в **null** или пустой массив удалит изображение из формы.

Возвращает **null**, если изображение не хранится в документе (например, в этом случае изображение, вероятно, связано).
