---
title: "Aspose::Words::Drawing::ImageData::get_ImageSize метод"
linktitle: "get_ImageSize"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ImageData::get_ImageSize метод. Получает информацию о размере изображения и разрешении в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.drawing/imagedata/get_imagesize/
---
## ImageData::get_ImageSize method


Получает информацию о размере изображения и разрешении.
...
Если изображение только связано и не хранится в документе, возвращает нулевой размер.
