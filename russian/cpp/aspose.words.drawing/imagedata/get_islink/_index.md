...
description: "Aspose::Words::Drawing::ImageData::get_IsLink method. Возвращает true если изображение связано с формой (когда SourceFullName указано) в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.drawing/imagedata/get_islink/
---
## ImageData::get_IsLink method


Возвращает **true**, если изображение связано с формой (когда [SourceFullName](../get_sourcefullname/) указано).
