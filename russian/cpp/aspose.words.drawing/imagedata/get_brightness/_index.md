---
title: "Aspose::Words::Drawing::ImageData::get_Brightness метод"
linktitle: "get_Brightness"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ImageData::get_Brightness метод. Получает или задает яркость изображения. Значение этого свойства должно быть числом от 0.0 (самый темный) до 1.0 (самый яркий) в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing/imagedata/get_brightness/
---
## ImageData::get_Brightness method


Получает или задаёт яркость изображения. Значение этого свойства должно быть числом от 0,0 (самое тёмное) до 1,0 (самое яркое).
