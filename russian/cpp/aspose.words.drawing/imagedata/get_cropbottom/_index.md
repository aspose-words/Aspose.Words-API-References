---
title: "Aspose::Words::Drawing::ImageData::get_CropBottom метод"
linktitle: "get_CropBottom"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ImageData::get_CropBottom метод. Определяет долю обрезки изображения с нижней стороны в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.drawing/imagedata/get_cropbottom/
---
...
Величина обрезки может варьироваться от -1.0 до 1.0. Значение по умолчанию — 0. Обратите внимание, что значение 1 полностью скрывает изображение. Отрицательные значения приводят к сжатию изображения внутрь от обрезаемого края (пустое пространство между изображением и обрезанным краем заполняется цветом заливки фигуры). Положительные значения меньше 1 растягивают оставшееся изображение, чтобы оно заполнило фигуру.
