---
title: "Aspose::Words::Drawing::ImageData::get_ChromaKey метод"
linktitle: "get_ChromaKey"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ImageData::get_ChromaKey метод. Определяет цветовое значение изображения, которое будет рассматриваться как прозрачное в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.drawing/imagedata/get_chromakey/
---
