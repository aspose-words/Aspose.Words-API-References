---
title: "Метод Aspose::Words::Drawing::ReflectionFormat::get_Blur"
linktitle: "get_Blur"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::ReflectionFormat::get_Blur. Получает или задает значение типа double, определяющее степень размытия, применяемого к эффекту отражения, в пунктах. Значение по умолчанию — 0.0 в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/reflectionformat/get_blur/
---
## ReflectionFormat::get_Blur method


Получает или задает значение типа double, которое указывает степень размытия, применяемого к эффекту отражения, в пунктах. Значение по умолчанию равно 0.0.
