---
title: "метод Aspose::Words::Drawing::Stroke::get_BaseForeColor"
linktitle: "get_BaseForeColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Stroke::get_BaseForeColor. Получает базовый цвет переднего плана штриха без каких-либо модификаторов в C++."
type: docs
weight: 2500
url: /ru/cpp/aspose.words.drawing/stroke/get_baseforecolor/
---
## Stroke::get_BaseForeColor method


Возвращает базовый цвет переднего плана обводки без каких-либо модификаторов.
