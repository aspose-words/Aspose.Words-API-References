---
title: "Метод Aspose::Words::Drawing::Stroke::get_Transparency"
linktitle: "get_Transparency"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::Stroke::get_Transparency. Получает или задаёт значение от 0.0 (непрозрачный) до 1.0 (прозрачный), представляющее степень прозрачности обводки в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.drawing/stroke/get_transparency/
---
