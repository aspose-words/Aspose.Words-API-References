---
title: "Aspose::Words::Drawing::GradientStop класс"
linktitle: "GradientStop"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::GradientStop класс. Представляет одну градиентную остановку. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/gradientstop/
---
## GradientStop class


Представляет одну градиентную остановку. Чтобы узнать больше, посетите статью документации [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/).
...
| Метод | Описание |
| --- | --- |
| [get_BaseColor](./get_basecolor/)() | Возвращает значение, представляющее цвет градиентной остановки без каких-либо модификаторов. |
| [get_Color](./get_color/)() | Получает или задаёт значение, представляющее цвет градиентной остановки. |
| [get_Position](./get_position/)() const | Получает или задаёт значение, представляющее положение остановки в градиенте, выраженное в процентах в диапазоне от 0.0 до 1.0. |
| [get_Transparency](./get_transparency/)() const | Получает или задаёт значение, представляющее прозрачность градиентной заливки, выраженную в процентах в диапазоне от 0.0 до 1.0. |
| [GetType](./gettype/)() const override |  |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double) | Инициализирует новый экземпляр класса [GradientStop](./). |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double, double) | Инициализирует новый экземпляр класса [GradientStop](./). |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)() | Удаляет градиентную остановку из родительского [GradientStopCollection](../gradientstopcollection/). |
| [set_Color](./set_color/)(System::Drawing::Color) | Сеттер для [Aspose::Words::Drawing::GradientStop::get_Color](./get_color/). |
| [set_Position](./set_position/)(double) | Сеттер для [Aspose::Words::Drawing::GradientStop::get_Position](./get_position/). |
| [set_Transparency](./set_transparency/)(double) | Сеттер для [Aspose::Words::Drawing::GradientStop::get_Transparency](./get_transparency/). |
| static [Type](./type/)() |  |
