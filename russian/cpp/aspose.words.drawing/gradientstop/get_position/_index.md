---
title: "Метод Aspose::Words::Drawing::GradientStop::get_Position"
linktitle: "get_Position"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::GradientStop::get_Position. Получает или задает значение, представляющее положение остановки в градиенте, выраженное в процентах в диапазоне от 0.0 до 1.0 в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.drawing/gradientstop/get_position/
---
## GradientStop::get_Position method


Получает или задаёт значение, представляющее положение остановки в градиенте, выраженное в процентах в диапазоне от 0.0 до 1.0.
