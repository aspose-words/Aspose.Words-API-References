---
title: "метод Aspose::Words::Drawing::ShapeBase::get_CoordSize"
linktitle: "get_CoordSize"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Drawing::ShapeBase::get_CoordSize. Ширина и высота координатного пространства внутри содержащего блока этой формы в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.drawing/shapebase/get_coordsize/
---
...
Значение по умолчанию равно (1000, 1000).
