---
title: "Aspose::Words::Drawing::ShapeBase::get_Top метод"
linktitle: "get_Top"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::ShapeBase::get_Top метод. Получает или задаёт позицию верхнего края содержащего блока формы в C++."
type: docs
weight: 52000
url: /ru/cpp/aspose.words.drawing/shapebase/get_top/
---
## ShapeBase::get_Top method


Получает или задаёт позицию верхнего края содержащего блока фигуры.
