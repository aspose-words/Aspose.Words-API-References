...
description: "Aspose::Words::Drawing::ShapeBase::get_LeftRelative method. Получает или задаёт значение, представляющее относительное левое положение фигуры в процентах в C++."
type: docs
weight: 38500
url: /ru/cpp/aspose.words.drawing/shapebase/get_leftrelative/
---
## ShapeBase::get_LeftRelative method


Получает или задает значение, представляющее относительное левое положение фигуры в процентах.
