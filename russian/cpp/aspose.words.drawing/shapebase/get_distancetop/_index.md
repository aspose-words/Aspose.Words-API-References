---
title: "метод Aspose::Words::Drawing::ShapeBase::get_DistanceTop"
linktitle: "get_DistanceTop"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Drawing::ShapeBase::get_DistanceTop. Возвращает или задает расстояние (в пунктах) между текстом документа и верхним краем формы в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.drawing/shapebase/get_distancetop/
---
## ShapeBase::get_DistanceTop method


Возвращает или задает расстояние (в пунктах) между текстом документа и верхним краем фигуры.
