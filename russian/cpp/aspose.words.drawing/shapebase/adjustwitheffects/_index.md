---
title: "Метод Aspose::Words::Drawing::ShapeBase::AdjustWithEffects"
linktitle: "AdjustWithEffects"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::ShapeBase::AdjustWithEffects. Добавляет к исходному прямоугольнику значения охвата эффекта и возвращает конечный прямоугольник в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/shapebase/adjustwitheffects/
---
## ShapeBase::AdjustWithEffects method


Добавляет к исходному прямоугольнику значения области эффекта и возвращает конечный прямоугольник.
