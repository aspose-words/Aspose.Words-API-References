---
title: "Метод Aspose::Words::Drawing::ShapeBase::get_DistanceBottom"
linktitle: "get_DistanceBottom"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::ShapeBase::get_DistanceBottom. Возвращает или задаёт расстояние (в пунктах) между текстом документа и нижним краем фигуры в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.drawing/shapebase/get_distancebottom/
---
