---
title: "Метод Aspose::Words::Drawing::ShapeBase::get_RelativeHorizontalSize"
linktitle: "get_RelativeHorizontalSize"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::ShapeBase::get_RelativeHorizontalSize. Получает или задает значение относительного размера фигуры в горизонтальном направлении в C++."
type: docs
weight: 42500
url: /ru/cpp/aspose.words.drawing/shapebase/get_relativehorizontalsize/
---
...
Имеет эффект только если установлен [WidthRelative](../get_widthrelative/).
