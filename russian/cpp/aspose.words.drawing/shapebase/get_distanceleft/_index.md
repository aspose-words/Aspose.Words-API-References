...
description: "Aspose::Words::Drawing::ShapeBase::get_DistanceLeft method. Возвращает или задаёт расстояние (в пунктах) между текстом документа и левым краем фигуры в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.drawing/shapebase/get_distanceleft/
---
