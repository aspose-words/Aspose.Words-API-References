---
title: "Aspose::Words::Drawing::Shape::get_Adjustments метод"
linktitle: "get_Adjustments"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Shape::get_Adjustments метод. Предоставляет доступ к исходным значениям регулировок формы. Для формы, не содержащей никаких исходных значений регулировок, возвращает пустую коллекцию в C++."
type: docs
weight: 3834
url: /ru/cpp/aspose.words.drawing/shape/get_adjustments/
---
## Shape::get_Adjustments method


Предоставляет доступ к исходным значениям регулировки фигуры. Для фигуры, не содержащей никаких исходных значений регулировки, возвращает пустую коллекцию.
