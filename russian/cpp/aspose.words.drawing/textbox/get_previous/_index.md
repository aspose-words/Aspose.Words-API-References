---
title: "Aspose::Words::Drawing::TextBox::get_Previous метод"
linktitle: "get_Previous"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Drawing::TextBox::get_Previous. Возвращает объект TextBox, представляющий предыдущий TextBox в последовательности фигур в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.drawing/textbox/get_previous/
---
...
Показывает, как связать текстовые блоки.
```cpp
...
// Создайте ссылки между некоторыми из текстовых полей.
...
if (textBox3->get_Next() == nullptr && textBox3->get_Previous() != nullptr)
{
    ...
    // Разорвите прямую ссылку между textBox2 и textBox3, а затем проверьте, что они больше не связаны.
