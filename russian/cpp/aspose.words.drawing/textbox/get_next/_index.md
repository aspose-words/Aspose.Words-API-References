...
description: "Aspose::Words::Drawing::TextBox::get_Next method. Возвращает или задает TextBox, представляющий следующий TextBox в последовательности фигур в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.drawing/textbox/get_next/
---
## TextBox::get_Next method


Возвращает или задает [TextBox](../), представляющий следующий [TextBox](../) в последовательности фигур.
