---
title: "Aspose::Words::Drawing::TextBox::get_InternalMarginRight метод"
linktitle: "get_InternalMarginRight"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::TextBox::get_InternalMarginRight метод. Указывает внутренний правый отступ в пунктах для формы в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.drawing/textbox/get_internalmarginright/
---
## TextBox::get_InternalMarginRight method


Указывает внутренний правый отступ в пунктах для формы.
