---
title: "Aspose::Words::Drawing::TextBox::BreakForwardLink метод"
linktitle: "BreakForwardLink"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::TextBox::BreakForwardLink метод. Разрывает связь со следующим TextBox в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/textbox/breakforwardlink/
---
## TextBox::BreakForwardLink method


Разрывает связь со следующим [TextBox](../).
