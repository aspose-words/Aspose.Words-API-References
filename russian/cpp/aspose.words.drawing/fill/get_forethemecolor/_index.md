---
title: "Aspose::Words::Drawing::Fill::get_ForeThemeColor метод"
linktitle: "get_ForeThemeColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Fill::get_ForeThemeColor method. Получает или задает объект ThemeColor, который представляет цвет переднего плана заливки в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.drawing/fill/get_forethemecolor/
---
## Fill::get_ForeThemeColor method


Получает или задает объект ThemeColor, который представляет цвет переднего плана заливки.
