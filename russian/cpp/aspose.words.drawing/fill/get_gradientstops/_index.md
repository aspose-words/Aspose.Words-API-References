---
title: "Aspose::Words::Drawing::Fill::get_GradientStops метод"
linktitle: "get_GradientStops"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Fill::get_GradientStops метод. Получает коллекцию объектов GradientStop для заполнения в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.drawing/fill/get_gradientstops/
---
## Fill::get_GradientStops method


Получает коллекцию объектов [GradientStop](../../gradientstop/) для заполнения.
