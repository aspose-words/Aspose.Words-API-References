---
title: "Aspose::Words::Drawing::Fill::PresetTextured метод"
linktitle: "PresetTextured"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Fill::PresetTextured метод. Устанавливает заполнение в предустановленную текстуру в C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words.drawing/fill/presettextured/
---
## Fill::PresetTextured method


Устанавливает заливку в предустановленную текстуру.
