---
title: "Aspose::Words::Drawing::Fill::get_BaseForeColor метод"
linktitle: "get_BaseForeColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Fill::get_BaseForeColor метод. Получает объект Color, который представляет базовый цвет переднего плана для заливки без каких-либо модификаторов в C++."
type: docs
weight: 4500
url: /ru/cpp/aspose.words.drawing/fill/get_baseforecolor/
---
## Fill::get_BaseForeColor method


Получает объект Color, который представляет базовый цвет переднего плана заливки без каких-либо модификаторов.
