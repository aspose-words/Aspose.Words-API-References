---
title: "Aspose::Words::Drawing::Fill::get_BackColor метод"
linktitle: "get_BackColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Drawing::Fill::get_BackColor method. Получает или задает объект Color, который представляет цвет фона заливки в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.drawing/fill/get_backcolor/
---
## Fill::get_BackColor method


Получает или задает объект Color, который представляет цвет фона заливки.
