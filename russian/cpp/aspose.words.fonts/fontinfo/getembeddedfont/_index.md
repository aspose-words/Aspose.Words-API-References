---
title: "Aspose::Words::Fonts::FontInfo::GetEmbeddedFont метод"
linktitle: "GetEmbeddedFont"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fonts::FontInfo::GetEmbeddedFont метод. Получает конкретный встроенный файл шрифта в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.fonts/fontinfo/getembeddedfont/
---
## FontInfo::GetEmbeddedFont method


Получает конкретный встроенный файл шрифта.
...
| --- | --- | --- |
| формат | Aspose::Words::Fonts::EmbeddedFontFormat | Указывает формат шрифта для получения. |
