---
title: "метод Aspose::Words::Fonts::FontInfo::get_Charset"
linktitle: "get_Charset"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Fonts::FontInfo::get_Charset. Получает или задаёт набор символов для шрифта в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fonts/fontinfo/get_charset/
---
## FontInfo::get_Charset method


Получает или задает набор символов шрифта.
