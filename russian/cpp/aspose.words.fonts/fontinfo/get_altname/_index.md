---
title: "Aspose::Words::Fonts::FontInfo::get_AltName метод"
linktitle: "get_AltName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fonts::FontInfo::get_AltName метод. Получает или задает альтернативное имя шрифта в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fonts/fontinfo/get_altname/
---
## FontInfo::get_AltName method


Получает или задает альтернативное название шрифта.
