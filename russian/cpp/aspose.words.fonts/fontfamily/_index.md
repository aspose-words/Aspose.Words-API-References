...
description: "Aspose::Words::Fonts::FontFamily enum. Представляет семейство шрифтов в C++."
type: docs
weight: 21000
url: /ru/cpp/aspose.words.fonts/fontfamily/
---
## FontFamily enum
...
| --- | --- | --- |
| Авто | 0 | Указывает общее семейное имя. Это имя используется, когда информация о шрифте отсутствует или не важна. Используется шрифт по умолчанию. |
| Roman | 1 | Указывает пропорциональный шрифт с засечками. Примером является Times New Roman. |
| Swiss | 2 | Указывает пропорциональный шрифт без засечек. Примером является Arial. |
| Modern | 3 | Указывает моноширинный шрифт с засечками или без них. Моноширинные шрифты обычно являются современными; примерами являются Pica, Elite и Courier New. |
| Script | 4 | Указывает шрифт, имитирующий рукописный стиль; примерами являются Script и Cursive. |
| Decorative | 5 | Указывает декоративный шрифт. Примером является Old English. |

## Примечания


Шрифтовое семейство — это набор шрифтов с одинаковой толщиной штрихов и характеристиками засечек.
