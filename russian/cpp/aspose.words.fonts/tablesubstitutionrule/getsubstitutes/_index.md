...
description: "Aspose::Words::Fonts::TableSubstitutionRule::GetSubstitutes method. Возвращает массив, содержащий имена заменяющих шрифтов для указанного оригинального имени шрифта в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fonts/tablesubstitutionrule/getsubstitutes/
---
## TableSubstitutionRule::GetSubstitutes method


Возвращает массив, содержащий альтернативные имена шрифтов для указанного оригинального имени шрифта.
