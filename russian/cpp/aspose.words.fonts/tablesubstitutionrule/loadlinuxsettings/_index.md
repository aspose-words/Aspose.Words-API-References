...
description: "Aspose::Words::Fonts::TableSubstitutionRule::LoadLinuxSettings method. Загружает предопределённые настройки подстановки таблицы для платформы Linux в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.fonts/tablesubstitutionrule/loadlinuxsettings/
---
