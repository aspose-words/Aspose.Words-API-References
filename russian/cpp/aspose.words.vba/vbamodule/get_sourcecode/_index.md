---
title: "Aspose::Words::Vba::VbaModule::get_SourceCode метод"
linktitle: "get_SourceCode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Vba::VbaModule::get_SourceCode метод. Получает или задает исходный код модуля проекта VBA в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.vba/vbamodule/get_sourcecode/
---
## VbaModule::get_SourceCode method


Получает или задаёт исходный код модуля проекта VBA.
