---
title: "Aspose::Words::Vba::VbaProject::get_CodePage метод"
linktitle: "get_CodePage"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Vba::VbaProject::get_CodePage метод. Получает или задает кодовую страницу проекта VBA в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.vba/vbaproject/get_codepage/
---
## VbaProject::get_CodePage method


Получает или задает кодовую страницу VBA‑проекта.
