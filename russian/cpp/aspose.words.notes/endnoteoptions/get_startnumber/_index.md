---
title: "Aspose::Words::Notes::EndnoteOptions::get_StartNumber метод"
linktitle: "get_StartNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Notes::EndnoteOptions::get_StartNumber метод. Указывает начальный номер или символ для первой автоматически нумеруемой конечной сноски в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.notes/endnoteoptions/get_startnumber/
---
## EndnoteOptions::get_StartNumber method


Указывает начальный номер или символ для первой автоматически нумеруемой сноски.
