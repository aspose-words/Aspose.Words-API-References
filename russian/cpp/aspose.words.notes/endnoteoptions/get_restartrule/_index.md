---
title: "Aspose::Words::Notes::EndnoteOptions::get_RestartRule метод"
linktitle: "get_RestartRule"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Notes::EndnoteOptions::get_RestartRule метод. Определяет, когда автоматическая нумерация перезапускается в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.notes/endnoteoptions/get_restartrule/
---
...
Не все значения применимы к конечным сноскам. Чтобы определить, какие значения применимы, см. [FootnoteNumberingRule](../../footnotenumberingrule/).
