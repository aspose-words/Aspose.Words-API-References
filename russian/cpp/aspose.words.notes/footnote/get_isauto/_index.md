---
title: "Метод Aspose::Words::Notes::Footnote::get_IsAuto"
linktitle: "get_IsAuto"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Notes::Footnote::get_IsAuto. Содержит значение, указывающее, является ли это автоматически нумерованной сноской или сноской с пользовательским маркером ссылки в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.notes/footnote/get_isauto/
---
## Footnote::get_IsAuto method


Содержит значение, указывающее, является ли это автоматически нумерованной сноской или сноской с пользовательским ссылочным знаком.
