...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureType enum. Указывает тип цифровой подписи в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.digitalsignatures/digitalsignaturetype/
---
...
| --- | --- | --- |
| Неизвестно | 0 | Указывает на ошибку, неизвестный тип цифровой подписи. |
