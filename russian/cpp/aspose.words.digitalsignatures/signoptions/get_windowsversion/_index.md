---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion метод"
linktitle: "get_WindowsVersion"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion метод. Получает или задает версию Windows для цифровой подписи. Значение по умолчанию — \"6.1\" в C++."
type: docs
weight: 8334
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_windowsversion/
---
## SignOptions::get_WindowsVersion method


Получает или задает версию Windows для цифровой подписи. Значение по умолчанию — "6.1".
