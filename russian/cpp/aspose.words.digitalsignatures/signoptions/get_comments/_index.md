---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_Comments метод"
linktitle: "get_Comments"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_Comments метод. Указывает комментарии к цифровой подписи. Значение по умолчанию — пустая строка в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_comments/
---
