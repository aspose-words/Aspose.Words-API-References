---
title: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion"
linktitle: "get_ApplicationVersion"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion. Получает или задает версию приложения для цифровой подписи. Значение по умолчанию — \"12.0\" в C++."
type: docs
weight: 2334
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_applicationversion/
---
## SignOptions::get_ApplicationVersion method


Получает или задает версию приложения для цифровой подписи. Значение по умолчанию — "12.0".
