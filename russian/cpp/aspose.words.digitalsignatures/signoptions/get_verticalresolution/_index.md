---
title: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_VerticalResolution"
linktitle: "get_VerticalResolution"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_VerticalResolution. Получает или задает вертикальное разрешение цифровой подписи. Значение по умолчанию — 1200 в C++."
type: docs
weight: 8167
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_verticalresolution/
---
## SignOptions::get_VerticalResolution method


Получает или задает вертикальное разрешение для цифровой подписи. Значение по умолчанию — 1200.
