---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth метод"
linktitle: "get_ColorDepth"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth метод. Получает или задает глубину цвета для цифровой подписи. Значение по умолчанию — 32 в C++."
type: docs
weight: 2667
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_colordepth/
---
## SignOptions::get_ColorDepth method


Получает или задает глубину цвета для цифровой подписи. Значение по умолчанию — 32.
