---
title: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution"
linktitle: "get_HorizontalResolution"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution. Получает или задает горизонтальное разрешение цифровой подписи. Значение по умолчанию — 1920 в C++."
type: docs
weight: 4334
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_horizontalresolution/
---
## SignOptions::get_HorizontalResolution method


Получает или задает горизонтальное разрешение для цифровой подписи. Значение по умолчанию — 1920.
