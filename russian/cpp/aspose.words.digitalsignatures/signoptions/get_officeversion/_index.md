---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_OfficeVersion метод"
linktitle: "get_OfficeVersion"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_OfficeVersion метод. Получает или задает версию Office для цифровой подписи. Значение по умолчанию — \"12.0\" в C++."
type: docs
weight: 4667
url: /ru/cpp/aspose.words.digitalsignatures/signoptions/get_officeversion/
---
## SignOptions::get_OfficeVersion method


Получает или задает версию Office для цифровой подписи. Значение по умолчанию — "12.0".
