---
title: "Метод Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid"
linktitle: "get_IsValid"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid. Возвращает true, если все цифровые подписи в этой коллекции действительны и документ не был изменён. Также возвращает true, если в коллекции нет цифровых подписей. Возвращает false, если хотя бы одна цифровая подпись недействительна в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/get_isvalid/
---
## DigitalSignatureCollection::get_IsValid method


Возвращает **true**, если все цифровые подписи в этой коллекции действительны и документ не был изменён. Также возвращает **true**, если цифровых подписей нет. Возвращает **false**, если хотя бы одна цифровая подпись недействительна.
