---
title: "Метод Aspose::Words::DigitalSignatures::DigitalSignatureCollection::idx_get"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::DigitalSignatureCollection::idx_get. Получает подпись документа по указанному индексу в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/idx_get/
---
...
| --- | --- | --- |
| index | int32_t | Нулевой (начинающийся с нуля) индекс подписи. |
