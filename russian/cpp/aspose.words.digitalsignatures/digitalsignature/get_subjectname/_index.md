---
title: "Aspose::Words::DigitalSignatures::DigitalSignature::get_SubjectName метод"
linktitle: "get_SubjectName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DigitalSignatures::DigitalSignature::get_SubjectName метод. Возвращает отличительное имя субъекта сертификата, использованного для подписи документа, в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.digitalsignatures/digitalsignature/get_subjectname/
---
## DigitalSignature::get_SubjectName method


Возвращает отличительное имя субъекта сертификата, использованного для подписи документа.
