---
title: "Метод Aspose::Words::DigitalSignatures::DigitalSignature::get_CertificateHolder"
linktitle: "get_CertificateHolder"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::DigitalSignatures::DigitalSignature::get_CertificateHolder. Возвращает объект держателя сертификата, содержащий сертификат, использованный для подписи документа на C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.digitalsignatures/digitalsignature/get_certificateholder/
---
