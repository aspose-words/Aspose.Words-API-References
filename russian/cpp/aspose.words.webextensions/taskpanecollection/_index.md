---
title: "Aspose::Words::WebExtensions::TaskPaneCollection класс"
linktitle: "TaskPaneCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::TaskPaneCollection класс. Указывает список сохраненных объектов панелей задач. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Указывает список сохранённых объектов панелей задач. Чтобы узнать больше, посетите статью документации [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
