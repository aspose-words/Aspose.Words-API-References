---
title: "Aspose::Words::WebExtensions::TaskPaneDockState перечисление"
linktitle: "TaskPaneDockState"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::TaskPaneDockState перечисление. Перечисляет доступные расположения объекта области задач в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.webextensions/taskpanedockstate/
---
...
| --- | --- | --- |
| Справа | 0 | Закрепите область задач с правой стороны окна документа. |
| Слева | 1 | Закрепите область задач с левой стороны окна документа. |
