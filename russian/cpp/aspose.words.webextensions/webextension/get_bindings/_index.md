---
title: "Aspose::Words::WebExtensions::WebExtension::get_Bindings метод"
linktitle: "get_Bindings"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtension::get_Bindings метод. Указывает список привязок веб-расширения в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.webextensions/webextension/get_bindings/
---
## WebExtension::get_Bindings method


Указывает список привязок веб-расширения.
