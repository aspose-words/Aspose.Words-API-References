---
title: "Aspose::Words::WebExtensions::WebExtension класс"
linktitle: "WebExtension"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtension класс. Представляет объект веб-расширения. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Представляет объект веб‑надстройки. Чтобы узнать больше, посетите статью документации [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Метод | Описание |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Указывает альтернативные ссылки на веб-расширение. |
| [get_Bindings](./get_bindings/)() const | Указывает список привязок веб-расширения. |
| [get_Id](./get_id/)() const | Уникально идентифицирует экземпляр веб-расширения в текущем документе. |
| [get_IsFrozen](./get_isfrozen/)() const | Указывает, может ли пользователь взаимодействовать с веб-расширением или нет. |
| [get_Properties](./get_properties/)() const | Представляет набор пользовательских свойств веб-расширения. |
| [get_Reference](./get_reference/)() const | Указывает основную ссылку на веб-расширение. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Сеттер для [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Сеттер для [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
