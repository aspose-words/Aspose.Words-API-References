---
title: "Aspose::Words::WebExtensions::WebExtension::get_IsFrozen метод"
linktitle: "get_IsFrozen"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtension::get_IsFrozen метод. Указывает, может ли пользователь взаимодействовать с веб‑расширением или нет в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.webextensions/webextension/get_isfrozen/
---
