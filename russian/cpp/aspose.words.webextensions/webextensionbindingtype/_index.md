---
title: "Aspose::Words::WebExtensions::WebExtensionBindingType перечисление"
linktitle: "WebExtensionBindingType"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtensionBindingType перечисление. Перечисляет доступные типы привязки между веб‑расширением и данными в документе на C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.webextensions/webextensionbindingtype/
---
...
| --- | --- | --- |
| Матрица | 0 | Табличные данные без строки заголовка. |
| Table | 1 | Табличные данные со строкой заголовка. |
| Text | 2 | Простой текст. |
| Default | н/д | Матрица, используемая по умолчанию. |
