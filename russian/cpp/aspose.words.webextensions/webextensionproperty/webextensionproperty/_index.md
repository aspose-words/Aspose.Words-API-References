---
title: "конструктор Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty"
linktitle: "WebExtensionProperty"
second_title: "Справочник API Aspose.Words для C++"
description: "Конструктор Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty. Создает пользовательское свойство веб‑расширения с указанным именем и значением в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.webextensions/webextensionproperty/webextensionproperty/
---
## WebExtensionProperty::WebExtensionProperty constructor


Создаёт пользовательское свойство веб-расширения с указанными именем и значением.
