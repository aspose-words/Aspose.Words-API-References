---
title: "метод Aspose::Words::WebExtensions::TaskPane::get_IsVisible"
linktitle: "get_IsVisible"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::TaskPane::get_IsVisible. Указывает, отображается ли панель задач как видимая по умолчанию при открытии документа в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.webextensions/taskpane/get_isvisible/
---
