---
title: "Метод Aspose::Words::WebExtensions::TaskPane::get_Width"
linktitle: "get_Width"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::TaskPane::get_Width. Указывает значение ширины по умолчанию для данного экземпляра панели задач в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.webextensions/taskpane/get_width/
---
