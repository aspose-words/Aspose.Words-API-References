---
title: "метод Aspose::Words::WebExtensions::TaskPane::get_DockState"
linktitle: "get_DockState"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::TaskPane::get_DockState. Указывает последнее закрепленное положение этого объекта панели задач в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.webextensions/taskpane/get_dockstate/
---
## TaskPane::get_DockState method


Указывает последнее закреплённое положение этого объекта панели задач.
