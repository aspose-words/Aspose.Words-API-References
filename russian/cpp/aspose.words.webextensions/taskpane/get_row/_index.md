---
title: "метод Aspose::Words::WebExtensions::TaskPane::get_Row"
linktitle: "get_Row"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::TaskPane::get_Row. Указывает индекс, считающийся от внешнего к внутреннему, этой панели задач среди других сохранённых панелей, закреплённых в том же месте по умолчанию, в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.webextensions/taskpane/get_row/
---
## TaskPane::get_Row method


Указывает индекс, считающийся от внешнего к внутреннему, этой панели задач среди других сохранённых панелей, закреплённых в том же месте по умолчанию.
