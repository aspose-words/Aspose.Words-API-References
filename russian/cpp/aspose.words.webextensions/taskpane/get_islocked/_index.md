---
title: "Метод Aspose::Words::WebExtensions::TaskPane::get_IsLocked"
linktitle: "get_IsLocked"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::TaskPane::get_IsLocked. Указывает, заблокирована ли панель задач к документу в пользовательском интерфейсе и не может ли пользователь закрыть её в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.webextensions/taskpane/get_islocked/
---
## TaskPane::get_IsLocked method


Указывает, закреплена ли панель задач за документом в пользовательском интерфейсе и не может ли пользователь её закрыть.
