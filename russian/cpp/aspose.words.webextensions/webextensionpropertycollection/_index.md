---
title: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection класс"
linktitle: "WebExtensionPropertyCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection класс. Указывает набор пользовательских свойств веб‑расширения. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Указывает набор пользовательских свойств веб‑расширения. Чтобы узнать больше, посетите статью документации [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
