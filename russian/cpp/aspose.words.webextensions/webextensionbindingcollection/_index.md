---
title: "Aspose::Words::WebExtensions::WebExtensionBindingCollection класс"
linktitle: "WebExtensionBindingCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::WebExtensionBindingCollection класс. Указывает список привязок веб-расширения. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.webextensions/webextensionbindingcollection/
---
## WebExtensionBindingCollection class


Указывает список привязок веб‑расширения. Чтобы узнать больше, посетите статью документации [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
