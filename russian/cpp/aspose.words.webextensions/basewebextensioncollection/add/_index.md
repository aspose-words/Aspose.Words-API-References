---
title: "Aspose::Words::WebExtensions::BaseWebExtensionCollection::Add метод"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::WebExtensions::BaseWebExtensionCollection::Add метод. Добавляет указанный элемент в коллекцию в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.webextensions/basewebextensioncollection/add/
---
