---
title: "Метод Aspose::Words::WebExtensions::WebExtensionReference::get_Id"
linktitle: "get_Id"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::WebExtensionReference::get_Id. Идентификатор, связанный с веб‑расширением в рамках поставщика каталога, в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.webextensions/webextensionreference/get_id/
---
## WebExtensionReference::get_Id method


Идентификатор, связанный с веб-расширением в рамках поставщика каталога.
