---
title: "Метод Aspose::Words::WebExtensions::WebExtensionReference::get_Store"
linktitle: "get_Store"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::WebExtensions::WebExtensionReference::get_Store. Указывает экземпляр магазина, где хранится веб‑расширение, в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.webextensions/webextensionreference/get_store/
---
## WebExtensionReference::get_Store method


Указывает экземпляр магазина, где хранится веб-расширение.
