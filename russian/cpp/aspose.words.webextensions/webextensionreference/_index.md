...
description: "Aspose::Words::WebExtensions::WebExtensionReference class. Представляет ссылку на веб-расширение. Ссылка используется для определения местоположения поставщика и версии расширения. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.webextensions/webextensionreference/
---
## WebExtensionReference class


Представляет ссылку на веб‑расширение. Ссылка используется для определения местоположения поставщика и версии расширения. Чтобы узнать больше, посетите статью документации [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Метод | Описание |
| --- | --- |
| [get_Id](./get_id/)() const | Идентификатор, связанный с веб-расширением в рамках поставщика каталога. |
| [get_Store](./get_store/)() const | Указывает экземпляр магазина, где хранится веб-расширение. |
| [get_StoreType](./get_storetype/)() const | Указывает тип магазина. |
| [get_Version](./get_version/)() const | Указывает версию веб-расширения. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Сеттер для [Aspose::Words::WebExtensions::WebExtensionReference::get_Id](./get_id/). |
| [set_Store](./set_store/)(const System::String\&) | Сеттер для [Aspose::Words::WebExtensions::WebExtensionReference::get_Store](./get_store/). |
| [set_StoreType](./set_storetype/)(Aspose::Words::WebExtensions::WebExtensionStoreType) | Сеттер для [Aspose::Words::WebExtensions::WebExtensionReference::get_StoreType](./get_storetype/). |
| [set_Version](./set_version/)(const System::String\&) | Сеттер для [Aspose::Words::WebExtensions::WebExtensionReference::get_Version](./get_version/). |
| static [Type](./type/)() |  |
