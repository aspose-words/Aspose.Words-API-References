...
description: "Aspose::Words::WebExtensions::WebExtensionStoreType enum. Перечисляет доступные типы хранилища веб‑расширений в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.webextensions/webextensionstoretype/
---
...
| OMEX | 1 | Указывает, что тип хранилища — Office.com. |
| SPApp | 2 | Указывает, что тип хранилища — веб‑приложение SharePoint. |
| Exchange | 3 | Указывает, что тип хранилища — сервер Exchange. |
| FileSystem | 4 | Указывает, что тип хранилища — общая папка файловой системы. |
| Registry | 5 | Указывает, что тип хранилища — системный реестр. |
