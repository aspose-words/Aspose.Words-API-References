---
title: "Aspose::Words::Fields::FieldUserName класс"
linktitle: "FieldUserName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldUserName класс. Реализует поле USERNAME. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 110000
url: /ru/cpp/aspose.words.fields/fieldusername/
---
## FieldUserName class


Реализует поле USERNAME. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_UserName](./get_username/)() | Получает или задает имя текущего пользователя. |
...
| [set_UserName](./set_username/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldUserName::get_UserName](./get_username/). |
| static [Type](./type/)() |  |
