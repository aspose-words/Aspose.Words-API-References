---
title: "Aspose::Words::Fields::FieldNext класс"
linktitle: "FieldNext"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldNext класс. Реализует поле NEXT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 70000
url: /ru/cpp/aspose.words.fields/fieldnext/
---
## FieldNext class


Реализует поле NEXT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
