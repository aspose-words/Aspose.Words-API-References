---
title: "Aspose::Words::Fields::FieldFormula класс"
linktitle: "FieldFormula"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFormula класс. Реализует поле = (формула). Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 49000
url: /ru/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


Реализует поле = (формула). Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
// Используйте построитель полей для создания математического уравнения,
// затем создайте поле формулы, чтобы отобразить результат уравнения в документе.
