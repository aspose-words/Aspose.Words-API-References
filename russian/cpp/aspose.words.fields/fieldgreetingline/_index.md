---
title: "Aspose::Words::Fields::FieldGreetingLine класс"
linktitle: "FieldGreetingLine"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldGreetingLine класс. Реализует поле GREETINGLINE. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 52000
url: /ru/cpp/aspose.words.fields/fieldgreetingline/
---
## FieldGreetingLine class


Реализует поле GREETINGLINE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_AlternateText](./get_alternatetext/)() | Получает текст, который будет включён в поле, если имя пусто. |
...
| [get_LanguageId](./get_languageid/)() | Получает идентификатор языка, используемый для форматирования имени. |
| [get_LocaleId](../field/get_localeid/)() | Получает или задает LCID поля. |
| [get_NameFormat](./get_nameformat/)() | Получает формат имени, включённого в поле. |
...
| [set_AlternateText](./set_alternatetext/)(const System::String\&) | Устанавливает текст, который будет включён в поле, если имя пусто. |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | Устанавливает идентификатор языка, используемый для форматирования имени. |
| [set_LocaleId](../field/set_localeid/)(int32_t) | Сеттер для [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NameFormat](./set_nameformat/)(const System::String\&) | Устанавливает формат имени, включённого в поле. |
