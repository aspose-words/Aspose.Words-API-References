---
title: "Класс Aspose::Words::Fields::FieldSeparator"
linktitle: "FieldSeparator"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldSeparator. Представляет разделитель полей Word, который разделяет код поля и результат поля. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 90000
url: /ru/cpp/aspose.words.fields/fieldseparator/
---
## FieldSeparator class


Представляет разделитель полей Word, который отделяет код поля от результата поля. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_NodeType](./get_nodetype/)() const override | Возвращает [FieldSeparator](../../aspose.words/nodetype/). |
