---
title: "Aspose::Words::Fields::FieldOptions::get_CurrentUser метод"
linktitle: "get_CurrentUser"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldOptions::get_CurrentUser метод. Получает или задает информацию о текущем пользователе в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldoptions/get_currentuser/
---
