---
title: "Метод Aspose::Words::Fields::FieldOptions::get_FieldIndexFormat"
linktitle: "get_FieldIndexFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldOptions::get_FieldIndexFormat. Получает или задает объект FieldIndexFormat, представляющий форматирование полей FieldIndex в документе в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.fields/fieldoptions/get_fieldindexformat/
---
## FieldOptions::get_FieldIndexFormat method


Получает или задает [FieldIndexFormat](./), представляющий форматирование полей [FieldIndex](../../fieldindex/) в документе.
