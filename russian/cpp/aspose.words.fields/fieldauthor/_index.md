---
title: "Aspose::Words::Fields::FieldAuthor класс"
linktitle: "FieldAuthor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldAuthor класс. Реализует поле AUTHOR. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.fields/fieldauthor/
---
## FieldAuthor class


Реализует поле AUTHOR. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Метод | Описание |
| --- | --- |
| [get_AuthorName](./get_authorname/)() | Получает или задает имя автора документа. |
...
| [set_AuthorName](./set_authorname/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldAuthor::get_AuthorName](./get_authorname/). |
