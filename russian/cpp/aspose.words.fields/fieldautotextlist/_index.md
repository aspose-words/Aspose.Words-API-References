...
description: "Aspose::Words::Fields::FieldAutoTextList class. Реализует поле AUTOTEXTLIST. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


Реализует поле AUTOTEXTLIST. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() | Получает имя записи AutoText. |
...
| [get_ListStyle](./get_liststyle/)() | Получает имя стиля, на основе которого формируется список, содержащий записи. |
...
| [get_ScreenTip](./get_screentip/)() | Получает текст подсказки ScreenTip для отображения. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Устанавливает имя записи AutoText. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | Устанавливает имя стиля, на основе которого формируется список, содержащий записи. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | Устанавливает текст подсказки ScreenTip для отображения. |
| static [Type](./type/)() |  |
