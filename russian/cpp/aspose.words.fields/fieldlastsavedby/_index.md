---
title: "Класс Aspose::Words::Fields::FieldLastSavedBy"
linktitle: "FieldLastSavedBy"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldLastSavedBy. Реализует поле LASTSAVEDBY. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 62000
url: /ru/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


Реализует поле LASTSAVEDBY. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Если мы создаём документ в Microsoft Word, в встроенном свойстве "Last saved by" будет имя пользователя.
// Если мы создаём документ программно, это свойство будет null, и нам потребуется присвоить значение.
