---
title: "Aspose::Words::Fields::FieldFormDropDown класс"
linktitle: "FieldFormDropDown"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFormDropDown класс. Реализует поле FORMDROPDOWN. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 47000
url: /ru/cpp/aspose.words.fields/fieldformdropdown/
---
## FieldFormDropDown class


Реализует поле FORMDROPDOWN. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
