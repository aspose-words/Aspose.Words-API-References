---
title: "Aspose::Words::Fields::UserInformation::get_DefaultUser метод"
linktitle: "get_DefaultUser"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::UserInformation::get_DefaultUser метод. Информация о пользователе по умолчанию в C++."
type: docs
weight: 1000
url: /ru/cpp/aspose.words.fields/userinformation/get_defaultuser/
---
## UserInformation::get_DefaultUser method


Информация пользователя по умолчанию.
