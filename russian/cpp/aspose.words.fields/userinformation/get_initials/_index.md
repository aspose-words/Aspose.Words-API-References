---
title: "Aspose::Words::Fields::UserInformation::get_Initials метод"
linktitle: "get_Initials"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::UserInformation::get_Initials метод. Получает или задает инициалы пользователя в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/userinformation/get_initials/
---
## UserInformation::get_Initials method


Получает или задаёт инициалы пользователя.
