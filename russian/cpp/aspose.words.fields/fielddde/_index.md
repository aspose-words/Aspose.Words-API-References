---
title: "класс Aspose::Words::Fields::FieldDde"
linktitle: "FieldDde"
second_title: "Справочник API Aspose.Words для C++"
description: "класс Aspose::Words::Fields::FieldDde. Реализует поле DDE. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 32000
url: /ru/cpp/aspose.words.fields/fielddde/
---
## FieldDde class


Реализует поле DDE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Метод | Описание |
| --- | --- |
| [get_AutoUpdate](./get_autoupdate/)() | Получает, следует ли автоматически обновлять это поле. |
...
| [set_AutoUpdate](./set_autoupdate/)(bool) | Устанавливает, следует ли автоматически обновлять это поле. |
