---
title: "Aspose::Words::Fields::FieldNumChars класс"
linktitle: "FieldNumChars"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldNumChars. Реализует поле NUMCHARS. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 73000
url: /ru/cpp/aspose.words.fields/fieldnumchars/
---
## FieldNumChars class


Реализует поле NUMCHARS. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
