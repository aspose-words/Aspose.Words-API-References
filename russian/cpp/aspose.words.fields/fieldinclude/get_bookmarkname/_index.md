---
title: "Метод Aspose::Words::Fields::FieldInclude::get_BookmarkName"
linktitle: "Метод Aspose::Words::Fields::FieldAsk::set_DefaultResponse"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldInclude::get_BookmarkName. Получает или задает имя закладки в документе, которую следует включить, в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldinclude/get_bookmarkname/
---
