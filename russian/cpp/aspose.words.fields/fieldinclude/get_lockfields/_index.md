---
title: "Метод Aspose::Words::Fields::FieldInclude::get_LockFields"
linktitle: "get_LockFields"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldInclude::get_LockFields. Получает или задает, следует ли предотвращать обновление полей во включённом документе в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldinclude/get_lockfields/
---
## FieldInclude::get_LockFields method


Получает или задает, следует ли предотвращать обновление полей во включённом документе.
