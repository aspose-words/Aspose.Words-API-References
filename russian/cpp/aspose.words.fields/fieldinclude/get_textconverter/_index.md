---
title: "Метод Aspose::Words::Fields::FieldInclude::get_TextConverter"
linktitle: "get_TextConverter"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldInclude::get_TextConverter. Получает или задает имя текстового конвертера для формата включаемого файла в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldinclude/get_textconverter/
---
## FieldInclude::get_TextConverter method


Получает или задает имя текстового конвертера для формата включённого файла.
