---
title: "Класс Aspose::Words::Fields::FieldGlossary"
linktitle: "FieldGlossary"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldGlossary. Реализует поле GLOSSARY. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 50000
url: /ru/cpp/aspose.words.fields/fieldglossary/
---
## FieldGlossary class


Реализует поле GLOSSARY. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_EntryName](./get_entryname/)() override | Получает или задаёт имя записи глоссария для вставки. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldGlossary::get_EntryName](./get_entryname/). |
