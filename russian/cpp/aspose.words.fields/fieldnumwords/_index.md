---
title: "Класс Aspose::Words::Fields::FieldNumWords"
linktitle: "FieldNumWords"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldNumWords. Реализует поле NUMWORDS. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 75000
url: /ru/cpp/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class


Реализует поле NUMWORDS. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
