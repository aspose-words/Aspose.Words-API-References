---
title: "Класс Aspose::Words::Fields::FieldSet"
linktitle: "FieldSet"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldSet. Реализует поле SET. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 92000
url: /ru/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


Реализует поле SET. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Метод | Описание |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Получает или задает имя закладки. |
| [get_BookmarkText](./get_bookmarktext/)() | Получает или задает новый текст закладки. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/). |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/). |
