---
title: "Класс Aspose::Words::Fields::FieldAutoNumLgl"
linktitle: "FieldAutoNumLgl"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldAutoNumLgl. Реализует поле AUTONUMLGL. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Реализует поле AUTONUMLGL. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Получает, следует ли отображать номер без завершающей точки. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Получает символ разделителя, который будет использоваться. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Устанавливает, следует ли отображать номер без завершающей точки. |
| [set_Result](../field/set_result/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Устанавливает символ разделителя, который будет использоваться. |
| static [Type](./type/)() |  |
