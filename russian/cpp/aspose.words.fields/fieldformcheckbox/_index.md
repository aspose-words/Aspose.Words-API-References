---
title: "Класс Aspose::Words::Fields::FieldFormCheckBox"
linktitle: "FieldFormCheckBox"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldFormCheckBox. Реализует поле FORMCHECKBOX. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 46000
url: /ru/cpp/aspose.words.fields/fieldformcheckbox/
---
## FieldFormCheckBox class


Реализует поле FORMCHECKBOX. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
// В Microsoft Word мы можем вставлять эти поля через меню Legacy Tools на вкладке Developer.
