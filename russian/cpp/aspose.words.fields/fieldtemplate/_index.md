---
title: "Aspose::Words::Fields::FieldTemplate класс"
linktitle: "FieldTemplate"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldTemplate класс. Реализует поле TEMPLATE. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 101000
url: /ru/cpp/aspose.words.fields/fieldtemplate/
---
## FieldTemplate class


Реализует поле TEMPLATE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_IncludeFullPath](./get_includefullpath/)() | Получает или задает, следует ли включать полное имя пути к файлу. |
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | Сеттер для [Aspose::Words::Fields::FieldTemplate::get_IncludeFullPath](./get_includefullpath/). |
