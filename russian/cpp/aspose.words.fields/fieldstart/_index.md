---
title: "Aspose::Words::Fields::FieldStart класс"
linktitle: "FieldStart"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldStart класс. Представляет начало поля Word в документе. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 95000
url: /ru/cpp/aspose.words.fields/fieldstart/
---
## FieldStart class


Представляет начало поля Word в документе. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FieldData](./get_fielddata/)() const | Получает пользовательские данные поля, связанные с полем. |
...
| [get_NodeType](./get_nodetype/)() const override | Возвращает [FieldStart](../../aspose.words/nodetype/). |
