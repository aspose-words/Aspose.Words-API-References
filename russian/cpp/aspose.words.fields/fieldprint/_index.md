---
title: "Aspose::Words::Fields::FieldPrint класс"
linktitle: "FieldPrint"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldPrint класс. Реализует поле PRINT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 80000
url: /ru/cpp/aspose.words.fields/fieldprint/
---
## FieldPrint class


Реализует поле PRINT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_PostScriptGroup](./get_postscriptgroup/)() | Получает или задает прямоугольник рисования, на котором работают инструкции PostScript. |
| [get_PrinterInstructions](./get_printerinstructions/)() | Получает или задает специфичные для принтера символы управляющего кода или инструкции PostScript. |
...
| [set_PostScriptGroup](./set_postscriptgroup/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldPrint::get_PostScriptGroup](./get_postscriptgroup/). |
| [set_PrinterInstructions](./set_printerinstructions/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldPrint::get_PrinterInstructions](./get_printerinstructions/). |
