---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_AddStartStopChar метод"
linktitle: "get_AddStartStopChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_AddStartStopChar метод. Получает или задает, следует ли добавлять символы начала/конца для типов штрихкодов NW7 и CODE39 в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_addstartstopchar/
---
## FieldDisplayBarcode::get_AddStartStopChar method


Получает или задает, следует ли добавлять символы Start/Stop для типов штрихкодов NW7 и CODE39.
