---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_ErrorCorrectionLevel метод"
linktitle: "get_ErrorCorrectionLevel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_ErrorCorrectionLevel метод. Получает или задает уровень коррекции ошибок QR‑кода. Допустимые значения — [0, 3] в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_errorcorrectionlevel/
---
## FieldDisplayBarcode::get_ErrorCorrectionLevel method


Получает или задает уровень коррекции ошибок QR‑кода. Допустимые значения: [0, 3].
