---
title: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_BarcodeType"
linktitle: "get_BarcodeType"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_BarcodeType. Получает или задает тип штрихкода (QR и др.) в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_barcodetype/
---
## FieldDisplayBarcode::get_BarcodeType method


Получает или задает тип штрихкода (QR и др.).
