---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_BackgroundColor метод"
linktitle: "get_BackgroundColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_BackgroundColor. Получает или задает цвет фона символа штрихкода. Допустимые значения находятся в диапазоне [0, 0xFFFFFF] в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_backgroundcolor/
---
## FieldDisplayBarcode::get_BackgroundColor method


Получает или задает цвет фона символа штрихкода. Допустимые значения находятся в диапазоне [0, 0xFFFFFF].
