---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_FixCheckDigit метод"
linktitle: "get_FixCheckDigit"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_FixCheckDigit метод. Получает или задает, следует ли исправлять контрольную цифру, если она недействительна, в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_fixcheckdigit/
---
## FieldDisplayBarcode::get_FixCheckDigit method


Получает или задает, исправлять ли контрольную цифру, если она недействительна.
