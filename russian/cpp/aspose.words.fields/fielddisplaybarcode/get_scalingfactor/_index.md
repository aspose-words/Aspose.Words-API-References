---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_ScalingFactor метод"
linktitle: "Aspose::Words::Fields::FieldMergeBarcode::get_End метод"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_ScalingFactor метод. Получает или задает коэффициент масштабирования символа. Значение задаётся в целых процентных пунктах, допустимые значения — [10, 1000] в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_scalingfactor/
---
## FieldDisplayBarcode::get_ScalingFactor method


Получает или задает коэффициент масштабирования символа. Значение задаётся в целых процентах, допустимые значения: [10, 1000].
