---
title: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_ForegroundColor"
linktitle: "get_ForegroundColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_ForegroundColor method. Получает или задает цвет переднего плана символа штрих‑кода. Допустимые значения находятся в диапазоне [0, 0xFFFFFF] в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_foregroundcolor/
---
## FieldDisplayBarcode::get_ForegroundColor method


Получает или задает цвет переднего плана символа штрихкода. Допустимые значения находятся в диапазоне [0, 0xFFFFFF].
