---
title: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText"
linktitle: "get_DisplayText"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText. Получает или задает, отображать ли данные штрихкода (текст) вместе с изображением в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_displaytext/
---
## FieldDisplayBarcode::get_DisplayText method


Получает или задает, отображать ли данные штрихкода (текст) вместе с изображением.
