---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_BarcodeValue метод"
linktitle: "get_BarcodeValue"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_BarcodeValue метод. Получает или задает значение штрих‑кода в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_barcodevalue/
---
## FieldDisplayBarcode::get_BarcodeValue method


Получает или задает значение штрихкода.
