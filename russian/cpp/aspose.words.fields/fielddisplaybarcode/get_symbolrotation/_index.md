---
title: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_SymbolRotation"
linktitle: "get_SymbolRotation"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldDisplayBarcode::get_SymbolRotation. Получает или задает вращение символа штрихкода. Допустимые значения — [0, 3] в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.fields/fielddisplaybarcode/get_symbolrotation/
---
## FieldDisplayBarcode::get_SymbolRotation method


Получает или задает вращение символа штрихкода. Допустимые значения: [0, 3].
