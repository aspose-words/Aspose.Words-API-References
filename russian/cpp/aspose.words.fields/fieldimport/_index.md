---
title: "Класс Aspose::Words::Fields::FieldImport"
linktitle: "FieldImport"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldImport. Реализует поле IMPORT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 55000
url: /ru/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


Реализует поле IMPORT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_SourceFullName](./get_sourcefullname/)() override | Получает или задает расположение изображения. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | Сеттер для [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | Сеттер для [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/). |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
