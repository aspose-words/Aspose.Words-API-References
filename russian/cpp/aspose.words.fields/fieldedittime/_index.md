---
title: "Класс Aspose::Words::Fields::FieldEditTime"
linktitle: "FieldEditTime"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldEditTime. Реализует поле EDITTIME. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 37000
url: /ru/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


Реализует поле EDITTIME. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
// время, проведённое с открытым документом в окне Microsoft Word.
...
// для отслеживания времени, проведённого с открытым документом. Мы также можем редактировать его вручную.
...
// Поле не обновляется в реальном времени и также должно быть
// обновлено вручную в Microsoft Word каждый раз, когда нам требуется точное значение.
doc->UpdateFields();
