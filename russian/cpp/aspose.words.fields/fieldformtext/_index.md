---
title: "Класс Aspose::Words::Fields::FieldFormText"
linktitle: "FieldFormText"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldFormText. Реализует поле FORMTEXT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 48000
url: /ru/cpp/aspose.words.fields/fieldformtext/
---
## FieldFormText class


Реализует поле FORMTEXT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
