---
title: "Метод Aspose::Words::Fields::ToaCategories::idx_get"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::ToaCategories::idx_get. Получает или задает заголовок категории по номеру категории в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/toacategories/idx_get/
---
