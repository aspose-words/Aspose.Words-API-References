---
title: "Aspose::Words::Fields::FieldMergeRec класс"
linktitle: "FieldMergeRec"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldMergeRec класс. Реализует поле MERGEREC. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 68000
url: /ru/cpp/aspose.words.fields/fieldmergerec/
---
## FieldMergeRec class


Реализует поле MERGEREC. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
