---
title: "Класс Aspose::Words::Fields::FieldSkipIf"
linktitle: "FieldSkipIf"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldSkipIf. Реализует поле SKIPIF. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 94000
url: /ru/cpp/aspose.words.fields/fieldskipif/
---
## FieldSkipIf class


Реализует поле SKIPIF. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Метод | Описание |
| --- | --- |
| [get_ComparisonOperator](./get_comparisonoperator/)() | Получает оператор сравнения. |
...
| [get_LeftExpression](./get_leftexpression/)() | Получает левую часть выражения сравнения. |
...
| [get_RightExpression](./get_rightexpression/)() | Получает правую часть выражения сравнения. |
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | Устанавливает оператор сравнения. |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | Устанавливает левую часть выражения сравнения. |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | Устанавливает правую часть выражения сравнения. |
| static [Type](./type/)() |  |
