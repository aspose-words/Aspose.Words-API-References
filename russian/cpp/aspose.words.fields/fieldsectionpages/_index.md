---
title: "Aspose::Words::Fields::FieldSectionPages класс"
linktitle: "FieldSectionPages"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSectionPages класс. Реализует поле SECTIONPAGES. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 89000
url: /ru/cpp/aspose.words.fields/fieldsectionpages/
---
## FieldSectionPages class


Реализует поле SECTIONPAGES. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
