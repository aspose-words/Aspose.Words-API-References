---
title: "Класс Aspose::Words::Fields::FieldDocVariable"
linktitle: "FieldDocVariable"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldDocVariable. Реализует поле DOCVARIABLE. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 36000
url: /ru/cpp/aspose.words.fields/fielddocvariable/
---
## FieldDocVariable class


Реализует поле DOCVARIABLE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_VariableName](./get_variablename/)() | Получает или задает имя переменной документа для получения. |
...
| [set_VariableName](./set_variablename/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldDocVariable::get_VariableName](./get_variablename/). |
| static [Type](./type/)() |  |
