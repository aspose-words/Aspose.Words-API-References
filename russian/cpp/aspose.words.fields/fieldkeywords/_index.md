---
title: "Класс Aspose::Words::Fields::FieldKeywords"
linktitle: "FieldKeywords"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldKeywords. Реализует поле KEYWORDS. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 61000
url: /ru/cpp/aspose.words.fields/fieldkeywords/
---
## FieldKeywords class


Реализует поле KEYWORDS. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_Text](./get_text/)() | Получает или задаёт текст ключевых слов. |
...
| [set_Text](./set_text/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldKeywords::get_Text](./get_text/). |
| static [Type](./type/)() |  |
