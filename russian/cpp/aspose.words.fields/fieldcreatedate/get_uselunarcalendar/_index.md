---
title: "Метод Aspose::Words::Fields::FieldCreateDate::get_UseLunarCalendar"
linktitle: "get_UseLunarCalendar"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldCreateDate::get_UseLunarCalendar. Получает или задает, использовать ли лунный календарь Хиджры или еврейский лунный календарь в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldcreatedate/get_uselunarcalendar/
---
## FieldCreateDate::get_UseLunarCalendar method


Получает или задает, использовать ли календарь Hijri Lunar или календарь Hebrew Lunar.
