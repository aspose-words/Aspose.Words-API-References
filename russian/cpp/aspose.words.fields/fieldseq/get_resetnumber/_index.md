---
title: "Метод Aspose::Words::Fields::FieldSeq::get_ResetNumber"
linktitle: "get_ResetNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldSeq::get_ResetNumber. Получает или задает целое число, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует, в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldseq/get_resetnumber/
---
## FieldSeq::get_ResetNumber method


Получает или задаёт целое число, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
