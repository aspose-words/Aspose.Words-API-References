---
title: "Метод Aspose::Words::Fields::FieldSeq::get_ResetHeadingLevel"
linktitle: "get_ResetHeadingLevel"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldSeq::get_ResetHeadingLevel. Получает или задает целое число, представляющее уровень заголовка, к которому сбрасывается номер последовательности. Возвращает -1, если число отсутствует, в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldseq/get_resetheadinglevel/
---
## FieldSeq::get_ResetHeadingLevel method


Получает или задаёт целое число, представляющее уровень заголовка, к которому следует сбросить номер последовательности. Возвращает -1, если число отсутствует.
