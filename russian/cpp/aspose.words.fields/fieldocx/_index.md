...
description: "Aspose::Words::Fields::FieldOcx class. Реализует поле OCX. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 76000
url: /ru/cpp/aspose.words.fields/fieldocx/
---
## FieldOcx class


Реализует поле OCX. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
