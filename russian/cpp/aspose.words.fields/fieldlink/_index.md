---
title: "Класс Aspose::Words::Fields::FieldLink"
linktitle: "FieldLink"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldLink. Реализует поле LINK. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 63000
url: /ru/cpp/aspose.words.fields/fieldlink/
---
## FieldLink class


Реализует поле LINK. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FormatUpdateType](./get_formatupdatetype/)() | Получает способ, которым связанный объект обновляет своё форматирование. |
...
| [set_FormatUpdateType](./set_formatupdatetype/)(const System::String\&) | Устанавливает способ, которым связанный объект обновляет своё форматирование. |
