---
title: "метод Aspose::Words::Fields::FieldXE::get_IsBold"
linktitle: "get_IsBold"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldXE::get_IsBold method. Получает или задает, следует ли применять полужирное форматирование к номеру страницы записи в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldxe/get_isbold/
---
## FieldXE::get_IsBold method


Получает или задает, применять ли полужирное форматирование к номеру страницы записи.
