---
title: "Метод Aspose::Words::Fields::FieldXE::get_IsItalic"
linktitle: "get_IsItalic"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldXE::get_IsItalic method. Получает или задает, следует ли применять курсивное форматирование к номеру страницы записи в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldxe/get_isitalic/
---
## FieldXE::get_IsItalic method


Получает или задает, применять ли курсивное форматирование к номеру страницы записи.
