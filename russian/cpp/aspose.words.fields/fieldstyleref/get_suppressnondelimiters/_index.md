---
title: "Метод Aspose::Words::Fields::FieldStyleRef::get_SuppressNonDelimiters"
linktitle: "get_SuppressNonDelimiters"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldStyleRef::get_SuppressNonDelimiters. Получает или задает, следует ли подавлять символы, не являющиеся разделителями, в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_suppressnondelimiters/
---
## FieldStyleRef::get_SuppressNonDelimiters method


Получает или задаёт, следует ли подавлять символы, не являющиеся разделителями.
