---
title: "Метод Aspose::Words::Fields::FieldStyleRef::get_InsertRelativePosition"
linktitle: "get_InsertRelativePosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldStyleRef::get_InsertRelativePosition. Получает или задает, следует ли вставлять относительное положение ссылочного абзаца в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_insertrelativeposition/
---
## FieldStyleRef::get_InsertRelativePosition method


Получает или задаёт, следует ли вставлять относительное положение ссылочного абзаца.
