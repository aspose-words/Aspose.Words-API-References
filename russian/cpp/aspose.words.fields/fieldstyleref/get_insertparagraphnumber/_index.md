---
title: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber метод"
linktitle: "get_InsertParagraphNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber метод. Получает или задает, следует ли вставлять номер абзаца ссылочного абзаца точно так, как он отображается в документе, в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_insertparagraphnumber/
---
## FieldStyleRef::get_InsertParagraphNumber method


Получает или задаёт, следует ли вставлять номер абзаца ссылочного абзаца точно так, как он отображается в документе.
