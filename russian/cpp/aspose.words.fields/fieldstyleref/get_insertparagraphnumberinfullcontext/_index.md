---
title: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInFullContext метод"
linktitle: "get_InsertParagraphNumberInFullContext"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInFullContext метод. Получает или задает, следует ли вставлять номер абзаца ссылочного абзаца в полном контексте, в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_insertparagraphnumberinfullcontext/
---
## FieldStyleRef::get_InsertParagraphNumberInFullContext method


Получает или задаёт, следует ли вставлять номер абзаца ссылочного абзаца в полном контексте.
