---
title: "Метод Aspose::Words::Fields::FieldStyleRef::get_StyleName"
linktitle: "get_StyleName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldStyleRef::get_StyleName. Получает или задает имя стиля, которым отформатирован искомый текст, в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_stylename/
---
## FieldStyleRef::get_StyleName method


Получает или задаёт имя стиля, в котором отформатирован искомый текст.
