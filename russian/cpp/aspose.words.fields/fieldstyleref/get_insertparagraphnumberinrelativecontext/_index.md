---
title: "Метод Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInRelativeContext"
linktitle: "get_InsertParagraphNumberInRelativeContext"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInRelativeContext. Получает или задает, следует ли вставлять номер абзаца ссылочного абзаца в относительном контексте в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldstyleref/get_insertparagraphnumberinrelativecontext/
---
## FieldStyleRef::get_InsertParagraphNumberInRelativeContext method


Получает или задаёт, следует ли вставлять номер абзаца ссылочного абзаца в относительном контексте.
