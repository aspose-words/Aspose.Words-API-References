---
title: "Класс Aspose::Words::Fields::FieldSubject"
linktitle: "FieldSubject"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldSubject. Реализует поле SUBJECT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 97000
url: /ru/cpp/aspose.words.fields/fieldsubject/
---
## FieldSubject class


Реализует поле SUBJECT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_Text](./get_text/)() | Получает или задаёт текст темы. |
...
| [set_Text](./set_text/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldSubject::get_Text](./get_text/). |
| static [Type](./type/)() |  |
