---
title: "Метод Remove класса Aspose::Words::Fields::FieldListNum"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldListNum::Remove method. Удаляет поле из документа. Возвращает узел, расположенный сразу после поля. Если конец поля является последним дочерним элементом его родительского узла, возвращает абзац‑родитель. Если поле уже удалено, возвращает null в C++."
type: docs
weight: 7500
url: /ru/cpp/aspose.words.fields/fieldlistnum/remove/
---
