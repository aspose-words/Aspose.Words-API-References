---
title: "Метод get_StartingNumber класса Aspose::Words::Fields::FieldListNum"
linktitle: "get_StartingNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод get_StartingNumber класса Aspose::Words::Fields::FieldListNum. Получает или задает начальное значение для этого поля в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldlistnum/get_startingnumber/
---
## FieldListNum::get_StartingNumber method


Получает или задает начальное значение для этого поля.
