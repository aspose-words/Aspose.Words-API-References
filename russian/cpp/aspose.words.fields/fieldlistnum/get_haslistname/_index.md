---
title: "Метод get_HasListName класса Aspose::Words::Fields::FieldListNum"
linktitle: "get_HasListName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод get_HasListName класса Aspose::Words::Fields::FieldListNum. Возвращает значение, указывающее, предоставлено ли имя абстрактного определения нумерации в коде поля в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldlistnum/get_haslistname/
---
## FieldListNum::get_HasListName method


Возвращает значение, указывающее, предоставлено ли имя определения абстрактной нумерации в коде поля.
