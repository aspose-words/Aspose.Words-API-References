...
description: "Aspose::Words::Fields::FieldListNum::get_ListName method. Получает или задает имя абстрактного определения нумерации, используемого для нумерации в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldlistnum/get_listname/
---
