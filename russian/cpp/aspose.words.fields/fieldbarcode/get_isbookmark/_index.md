---
title: "метод Aspose::Words::Fields::FieldBarcode::get_IsBookmark"
linktitle: "get_IsBookmark"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::Fields::FieldBarcode::get_IsBookmark. Получает или задает, является ли PostalAddress именем закладки в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldbarcode/get_isbookmark/
---
## FieldBarcode::get_IsBookmark method


Получает или задает, является ли [PostalAddress](../get_postaladdress/) именем закладки.
