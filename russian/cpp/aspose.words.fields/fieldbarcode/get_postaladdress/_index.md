---
title: "Метод Aspose::Words::Fields::FieldBarcode::get_PostalAddress"
linktitle: "get_PostalAddress"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldBarcode::get_PostalAddress. Получает или задает почтовый адрес, используемый для генерации штрихкода, или имя закладки, ссылающейся на него, в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldbarcode/get_postaladdress/
---
## FieldBarcode::get_PostalAddress method


Получает или задает почтовый адрес, используемый для генерации штрихкода, или имя закладки, ссылающейся на него.
