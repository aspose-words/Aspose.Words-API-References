---
title: "Метод Aspose::Words::Fields::FieldAdvance::get_VerticalPosition"
linktitle: "get_VerticalPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldAdvance::get_VerticalPosition. Получает или задает количество пунктов, на которое текст, следующий за полем, должен быть смещён вертикально от верхнего края страницы в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fieldadvance/get_verticalposition/
---
## FieldAdvance::get_VerticalPosition method


Получает или задаёт количество пунктов, на которое текст, следующий за полем, должен быть смещён вертикально от верхнего края страницы.
