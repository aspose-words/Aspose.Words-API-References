---
title: "Aspose::Words::Fields::FieldAdvance::get_RightOffset метод"
linktitle: "get_RightOffset"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldAdvance::get_RightOffset метод. Получает или задает количество пунктов, на которое следует сдвинуть вправо текст, следующий за полем, в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldadvance/get_rightoffset/
---
## FieldAdvance::get_RightOffset method


Получает или задаёт количество пунктов, на которое текст, следующий за полем, должен быть смещён вправо.
