---
title: "Метод Aspose::Words::Fields::FieldAdvance::get_UpOffset"
linktitle: "get_UpOffset"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldAdvance::get_UpOffset. Получает или задает количество пунктов, на которое следует поднять текст, следующий за полем, в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/fieldadvance/get_upoffset/
---
## FieldAdvance::get_UpOffset method


Получает или задаёт количество пунктов, на которое текст, следующий за полем, должен быть смещён вверх.
