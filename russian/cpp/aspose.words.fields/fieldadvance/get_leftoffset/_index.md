---
title: "Метод Aspose::Words::Fields::FieldAdvance::get_LeftOffset"
linktitle: "get_LeftOffset"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldAdvance::get_LeftOffset. Получает или задает количество пунктов, на которое текст, следующий за полем, должен быть смещён влево в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldadvance/get_leftoffset/
---
## FieldAdvance::get_LeftOffset method


Получает или задаёт количество пунктов, на которое текст, следующий за полем, должен быть смещён влево.
