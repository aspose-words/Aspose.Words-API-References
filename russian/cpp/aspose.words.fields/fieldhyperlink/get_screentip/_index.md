---
title: "Aspose::Words::Fields::FieldHyperlink::get_ScreenTip метод"
linktitle: "get_ScreenTip"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldHyperlink::get_ScreenTip метод. Получает или задает текст подсказки ScreenTip для гиперссылки в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldhyperlink/get_screentip/
---
## FieldHyperlink::get_ScreenTip method


Получает или задает текст подсказки ScreenTip для гиперссылки.
