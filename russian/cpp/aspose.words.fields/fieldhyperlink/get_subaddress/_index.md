---
title: "Aspose::Words::Fields::FieldHyperlink::get_SubAddress метод"
linktitle: "get_SubAddress"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldHyperlink::get_SubAddress метод. Получает или задает расположение в файле, например закладку, куда переходит эта гиперссылка в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/fieldhyperlink/get_subaddress/
---
## FieldHyperlink::get_SubAddress method


Получает или задает расположение в файле, например закладку, куда переходит эта гиперссылка.
