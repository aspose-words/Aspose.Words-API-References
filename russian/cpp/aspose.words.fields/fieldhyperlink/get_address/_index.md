---
title: "Aspose::Words::Fields::FieldHyperlink::get_Address метод"
linktitle: "get_Address"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldHyperlink::get_Address метод. Получает или задает расположение, куда переходит эта гиперссылка в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldhyperlink/get_address/
---
## FieldHyperlink::get_Address method


Получает или задает расположение, куда переходит эта гиперссылка.
