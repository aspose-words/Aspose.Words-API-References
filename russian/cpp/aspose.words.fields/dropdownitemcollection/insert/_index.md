---
title: "Aspose::Words::Fields::DropDownItemCollection::Insert метод"
linktitle: "Insert"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::DropDownItemCollection::Insert метод. Вставляет строку в коллекцию по указанному индексу в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.fields/dropdownitemcollection/insert/
---
...
| --- | --- | --- |
| index | int32_t | Нулевой индекс, по которому вставляется значение. |
| value | const System::String\& | Строка для вставки. |
