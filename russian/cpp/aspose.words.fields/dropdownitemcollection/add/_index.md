---
title: "Aspose::Words::Fields::DropDownItemCollection::Add метод"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::DropDownItemCollection::Add метод. Добавляет строку в конец коллекции в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/dropdownitemcollection/add/
---
...
| --- | --- | --- |
| value | const System::String\& | Строка для добавления в конец коллекции. |

### ReturnValue

Нулевой индекс, по которому вставляется новый элемент.
