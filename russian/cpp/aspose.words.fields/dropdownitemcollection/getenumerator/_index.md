...
description: "Aspose::Words::Fields::DropDownItemCollection::GetEnumerator method. Возвращает объект перечислителя, который можно использовать для обхода всех элементов коллекции в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.fields/dropdownitemcollection/getenumerator/
---
