---
title: "Aspose::Words::Fields::FieldIf::get_TrueText метод"
linktitle: "get_TrueText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIf::get_TrueText метод. Получает или задает текст, отображаемый, если выражение сравнения истинно в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.fields/fieldif/get_truetext/
---
## FieldIf::get_TrueText method


Получает или задает текст, отображаемый, если выражение сравнения true.
