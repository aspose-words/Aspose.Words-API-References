---
title: "Aspose::Words::Fields::FieldIf::get_RightExpression метод"
linktitle: "get_RightExpression"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIf::get_RightExpression метод. Получает или задает правую часть выражения сравнения в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fieldif/get_rightexpression/
---
## FieldIf::get_RightExpression method


Получает или задаёт правую часть выражения сравнения.
