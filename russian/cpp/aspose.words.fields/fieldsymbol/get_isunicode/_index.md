---
title: "Aspose::Words::Fields::FieldSymbol::get_IsUnicode метод"
linktitle: "get_IsUnicode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_IsUnicode метод. Получает или задает, интерпретируется ли код символа как значение символа Unicode в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_isunicode/
---
## FieldSymbol::get_IsUnicode method


Получает или задает, интерпретируется ли код символа как значение Unicode‑символа.
