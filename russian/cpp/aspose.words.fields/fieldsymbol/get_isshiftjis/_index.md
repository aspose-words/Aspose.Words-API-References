---
title: "Aspose::Words::Fields::FieldSymbol::get_IsShiftJis метод"
linktitle: "get_IsShiftJis"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_IsShiftJis метод. Получает или задает, интерпретируется ли код символа как значение символа SHIFT-JIS в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_isshiftjis/
---
## FieldSymbol::get_IsShiftJis method


Получает или задает, интерпретируется ли код символа как значение символа SHIFT-JIS.
