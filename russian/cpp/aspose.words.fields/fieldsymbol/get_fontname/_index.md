---
title: "Aspose::Words::Fields::FieldSymbol::get_FontName метод"
linktitle: "get_FontName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_FontName метод. Получает или задает название шрифта символа, полученного полем, в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_fontname/
---
## FieldSymbol::get_FontName method


Получает или задает название шрифта символа, полученного полем.
