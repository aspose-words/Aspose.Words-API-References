---
title: "Aspose::Words::Fields::FieldSymbol::get_CharacterCode метод"
linktitle: "get_CharacterCode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_CharacterCode метод. Получает или задает значение кодовой точки символа в десятичном или шестнадцатеричном виде в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_charactercode/
---
## FieldSymbol::get_CharacterCode method


Получает или задает значение кодовой точки символа в десятичном или шестнадцатеричном виде.
