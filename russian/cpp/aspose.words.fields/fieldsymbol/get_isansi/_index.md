---
title: "Aspose::Words::Fields::FieldSymbol::get_IsAnsi метод"
linktitle: "get_IsAnsi"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_IsAnsi метод. Получает или задает, интерпретируется ли код символа как значение ANSI‑символа в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_isansi/
---
## FieldSymbol::get_IsAnsi method


Получает или задает, интерпретируется ли код символа как значение ANSI‑символа.
