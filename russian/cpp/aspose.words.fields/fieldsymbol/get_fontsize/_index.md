---
title: "Aspose::Words::Fields::FieldSymbol::get_FontSize метод"
linktitle: "get_FontSize"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldSymbol::get_FontSize метод. Получает или задает размер шрифта в пунктах символа, полученного полем, в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fieldsymbol/get_fontsize/
---
## FieldSymbol::get_FontSize method


Получает или задает размер шрифта символа, полученного полем, в пунктах.
