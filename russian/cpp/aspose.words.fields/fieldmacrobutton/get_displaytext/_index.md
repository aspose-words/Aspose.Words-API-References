---
title: "Aspose::Words::Fields::FieldMacroButton::get_DisplayText метод"
linktitle: "get_DisplayText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldMacroButton::get_DisplayText метод. Получает или задает текст, который будет отображаться как «кнопка», выбранная для выполнения макроса или команды в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldmacrobutton/get_displaytext/
---
## FieldMacroButton::get_DisplayText method


Получает или задает текст, который будет отображаться как "кнопка", выбранная для запуска макроса или команды.
