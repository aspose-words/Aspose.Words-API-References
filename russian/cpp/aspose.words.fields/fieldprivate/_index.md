---
title: "Aspose::Words::Fields::FieldPrivate класс"
linktitle: "FieldPrivate"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldPrivate класс. Реализует ПРИВАТНОЕ поле. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 82000
url: /ru/cpp/aspose.words.fields/fieldprivate/
---
## FieldPrivate class


Реализует поле PRIVATE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
