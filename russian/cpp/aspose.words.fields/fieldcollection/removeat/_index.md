---
title: "Метод Aspose::Words::Fields::FieldCollection::RemoveAt"
linktitle: "RemoveAt"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldCollection::RemoveAt. Удаляет поле с указанным индексом из этой коллекции и из документа в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.fields/fieldcollection/removeat/
---
