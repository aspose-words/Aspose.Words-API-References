---
title: "Aspose::Words::Fields::Field::get_Format метод"
linktitle: "get_Format"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::Field::get_Format метод. Получает объект FieldFormat, который предоставляет типизированный доступ к форматированию поля в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/field/get_format/
---
## Field::get_Format method


Получает объект [FieldFormat](../../fieldformat/), который предоставляет типизированный доступ к форматированию поля.
