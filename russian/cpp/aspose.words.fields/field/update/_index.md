---
title: "Aspose::Words::Fields::Field::Update метод"
linktitle: "Обновить"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::Field::Update метод. Выполняет обновление поля. Вызывает исключение, если поле уже обновляется в C++."
type: docs
weight: 23000
url: /ru/cpp/aspose.words.fields/field/update/
---
## Field::Update() method


Выполняет обновление поля. Вызывает исключение, если поле уже обновляется.
...
| --- | --- | --- |
| ignoreMergeFormat | bool | Если **true**, то прямое форматирование результата поля отменяется, независимо от переключателя MERGEFORMAT, иначе выполняется обычное обновление. |
