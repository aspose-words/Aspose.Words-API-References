---
title: "Aspose::Words::Fields::FieldMergeSeq класс"
linktitle: "FieldMergeSeq"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldMergeSeq класс. Реализует поле MERGESEQ. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 69000
url: /ru/cpp/aspose.words.fields/fieldmergeseq/
---
## FieldMergeSeq class


Реализует поле MERGESEQ. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
