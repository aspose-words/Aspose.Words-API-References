---
title: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat метод"
linktitle: "get_DateTimeFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat метод. Получает или задает форматирование, применяемое к результату поля даты и времени. Соответствует переключателю \\@ в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldformat/get_datetimeformat/
---
## FieldFormat::get_DateTimeFormat method


Получает или задаёт форматирование, применяемое к результату поля даты и времени. Соответствует переключателю \\@.
