---
title: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats метод"
linktitle: "get_GeneralFormats"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats метод. Возвращает коллекцию общих форматов, применяемых к числовому, текстовому или любому результату поля. Соответствует переключателям \\* в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldformat/get_generalformats/
---
## FieldFormat::get_GeneralFormats method


Получает коллекцию общих форматов, применяемых к числовому, текстовому или любому результату поля. Соответствует переключателям \\*.
