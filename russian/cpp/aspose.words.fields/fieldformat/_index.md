---
title: "Aspose::Words::Fields::FieldFormat класс"
linktitle: "FieldFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFormat класс. Предоставляет типизированный доступ к field''s числовому, датному и временному, а также общему форматированию. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 45000
url: /ru/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Обеспечивает типизированный доступ к числовому, датному и временному, а также общему форматированию поля. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Метод | Описание |
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Получает или задаёт форматирование, применяемое к результату поля даты и времени. Соответствует переключателю \\@. |
| [get_GeneralFormats](./get_generalformats/)() | Получает коллекцию общих форматов, применяемых к числовому, текстовому или любому результату поля. Соответствует переключателям \\*. |
| [get_NumericFormat](./get_numericformat/)() | Получает или задаёт форматирование, применяемое к результату числового поля. Соответствует переключателю \\#. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
