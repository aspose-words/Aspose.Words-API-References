---
title: "Метод Aspose::Words::Fields::FieldIncludePicture::get_IsLinked"
linktitle: "get_IsLinked"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldIncludePicture::get_IsLinked. Получает или задает, следует ли уменьшать размер файла, не сохраняя графические данные в документе, в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldincludepicture/get_islinked/
---
