---
title: "Aspose::Words::Fields::FieldIncludePicture::get_ResizeHorizontally метод"
linktitle: "get_ResizeHorizontally"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIncludePicture::get_ResizeHorizontally метод. Получает или задает, следует ли изменять размер изображения по горизонтали из источника в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldincludepicture/get_resizehorizontally/
---
## FieldIncludePicture::get_ResizeHorizontally method


Получает или задает, следует ли изменять размер изображения по горизонтали из исходного файла.
