---
title: "Aspose::Words::Fields::FieldIncludePicture::get_SourceFullName метод"
linktitle: "get_SourceFullName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIncludePicture::get_SourceFullName метод. Получает или задает расположение изображения с использованием IRI в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/fieldincludepicture/get_sourcefullname/
---
## FieldIncludePicture::get_SourceFullName method


Получает или задает расположение изображения с использованием IRI.
