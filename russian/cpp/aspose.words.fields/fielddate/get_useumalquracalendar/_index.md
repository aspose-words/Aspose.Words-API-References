---
title: "Aspose::Words::Fields::FieldDate::get_UseUmAlQuraCalendar метод"
linktitle: "get_UseUmAlQuraCalendar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldDate::get_UseUmAlQuraCalendar метод. Получает или задает, использовать ли календарь Um-al-Qura в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.fields/fielddate/get_useumalquracalendar/
---
