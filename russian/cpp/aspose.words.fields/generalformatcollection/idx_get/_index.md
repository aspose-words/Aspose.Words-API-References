---
title: "Aspose::Words::Fields::GeneralFormatCollection::idx_get метод"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::GeneralFormatCollection::idx_get метод. Получает общий формат по указанному индексу в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/generalformatcollection/idx_get/
---
## GeneralFormatCollection::idx_get method


Возвращает общий формат по указанному индексу.
...
| --- | --- | --- |
| index | int32_t | Индекс общего формата. |
