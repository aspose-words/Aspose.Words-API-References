---
title: "Aspose::Words::Fields::GeneralFormatCollection класс"
linktitle: "GeneralFormatCollection"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::GeneralFormatCollection class. Представляет типизированную коллекцию общих форматов. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 114000
url: /ru/cpp/aspose.words.fields/generalformatcollection/
---
## GeneralFormatCollection class


Представляет типизированную коллекцию общих форматов. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Метод | Описание |
| --- | --- |
| [Add](./add/)(Aspose::Words::Fields::GeneralFormat) | Добавляет общий формат в коллекцию. |
| [get_Count](./get_count/)() | Возвращает общее количество элементов в коллекции. |
| [GetEnumerator](./getenumerator/)() override | Возвращает объект перечислителя. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Возвращает общий формат по указанному индексу. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)(Aspose::Words::Fields::GeneralFormat) | Удаляет все вхождения указанного общего формата из коллекции. |
| [RemoveAt](./removeat/)(int32_t) | Удаляет вхождение общего формата по указанному индексу. |
| static [Type](./type/)() |  |
