---
title: "Aspose::Words::Fields::FieldRevNum класс"
linktitle: "FieldRevNum"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldRevNum класс. Реализует поле REVNUM. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 86000
url: /ru/cpp/aspose.words.fields/fieldrevnum/
---
## FieldRevNum class


Реализует поле REVNUM. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
