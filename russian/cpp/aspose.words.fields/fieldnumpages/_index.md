---
title: "Класс Aspose::Words::Fields::FieldNumPages"
linktitle: "FieldNumPages"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldNumPages. Реализует поле NUMPAGES. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 74000
url: /ru/cpp/aspose.words.fields/fieldnumpages/
---
## FieldNumPages class


Реализует поле NUMPAGES. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
