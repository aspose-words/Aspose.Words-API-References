---
title: "Aspose::Words::Fields::FieldNextIf класс"
linktitle: "FieldNextIf"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldNextIf класс. Реализует поле NEXTIF. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 71000
url: /ru/cpp/aspose.words.fields/fieldnextif/
---
## FieldNextIf class


Реализует поле NEXTIF. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
