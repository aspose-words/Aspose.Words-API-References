---
title: "класс Aspose::Words::Fields::FieldTime"
linktitle: "FieldTime"
second_title: "Справочник API Aspose.Words для C++"
description: "класс Aspose::Words::Fields::FieldTime. Реализует поле TIME. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 102000
url: /ru/cpp/aspose.words.fields/fieldtime/
---
## FieldTime class


Реализует поле TIME. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
