...
description: "Aspose::Words::Fields::FieldFootnoteRef class. Реализует поле FOOTNOTEREF. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 44000
url: /ru/cpp/aspose.words.fields/fieldfootnoteref/
---
## FieldFootnoteRef class


Реализует поле FOOTNOTEREF. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
