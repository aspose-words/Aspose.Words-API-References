---
title: "Aspose::Words::Fields::FieldAutoText класс"
linktitle: "FieldAutoText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldAutoText класс. Реализует поле AUTOTEXT. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.fields/fieldautotext/
---
## FieldAutoText class


Реализует поле AUTOTEXT. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() override | Получает или задаёт имя записи AutoText. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Сеттер для [Aspose::Words::Fields::FieldAutoText::get_EntryName](./get_entryname/). |
