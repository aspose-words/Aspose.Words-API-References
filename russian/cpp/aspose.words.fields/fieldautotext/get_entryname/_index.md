---
title: "Метод Aspose::Words::Fields::FieldAutoText::get_EntryName"
linktitle: "get_EntryName"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldAutoText::get_EntryName. Получает или задает имя записи AutoText в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldautotext/get_entryname/
---
## FieldAutoText::get_EntryName method


Получает или задаёт имя записи AutoText.
