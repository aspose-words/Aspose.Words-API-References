---
title: "Aspose::Words::Fields::FieldGoToButton::get_Location метод"
linktitle: "get_Location"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldGoToButton::get_Location метод. Получает или задает имя закладки, номер страницы или другой элемент для перехода в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.fields/fieldgotobutton/get_location/
---
## FieldGoToButton::get_Location method


Получает или задает имя закладки, номера страницы или другого элемента для перехода.
