---
title: "Класс Aspose::Words::Fields::FieldPageRef"
linktitle: "FieldPageRef"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Fields::FieldPageRef. Реализует поле PAGEREF. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 79000
url: /ru/cpp/aspose.words.fields/fieldpageref/
---
## FieldPageRef class


Реализует поле PAGEREF. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
