---
title: "Aspose::Words::Fields::FieldIndex::get_Heading метод"
linktitle: "get_Heading"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_Heading метод. Получает или задает заголовок, который появляется в начале каждой группы записей для любой заданной буквы в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.fields/fieldindex/get_heading/
---
## FieldIndex::get_Heading method


Получает или задает заголовок, который появляется в начале каждого набора записей для заданной буквы.
