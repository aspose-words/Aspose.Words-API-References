---
title: "Aspose::Words::Fields::FieldIndex::get_SequenceName метод"
linktitle: "get_SequenceName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_SequenceName метод. Получает или задает имя последовательности, номер которой включается в номер страницы в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.fields/fieldindex/get_sequencename/
---
## FieldIndex::get_SequenceName method


Получает или задает имя последовательности, номер которой включается в номер страницы.
