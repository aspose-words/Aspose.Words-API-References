---
title: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator метод"
linktitle: "get_PageNumberListSeparator"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator метод. Получает или задает последовательность символов, используемую для разделения двух номеров страниц в списке номеров страниц в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.fields/fieldindex/get_pagenumberlistseparator/
---
## FieldIndex::get_PageNumberListSeparator method


Получает или задает последовательность символов, используемую для разделения двух номеров страниц в списке номеров страниц.
