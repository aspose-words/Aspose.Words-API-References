---
title: "Aspose::Words::Fields::FieldIndex::get_EntryType метод"
linktitle: "get_EntryType"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_EntryType метод. Получает или задает тип записи указателя, используемый при построении указателя в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.fields/fieldindex/get_entrytype/
---
## FieldIndex::get_EntryType method


Получает или задает тип записи указателя, используемый при построении указателя.
