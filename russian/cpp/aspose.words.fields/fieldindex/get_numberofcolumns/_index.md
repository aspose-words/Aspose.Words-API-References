---
title: "Aspose::Words::Fields::FieldIndex::get_NumberOfColumns метод"
linktitle: "get_NumberOfColumns"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_NumberOfColumns метод. Получает или задает количество колонок на страницу, используемых при построении индекса в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.fields/fieldindex/get_numberofcolumns/
---
## FieldIndex::get_NumberOfColumns method


Получает или задает количество колонок на страницу, используемое при построении указателя.
