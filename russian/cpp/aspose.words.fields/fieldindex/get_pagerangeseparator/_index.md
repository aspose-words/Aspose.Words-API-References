---
title: "Aspose::Words::Fields::FieldIndex::get_PageRangeSeparator метод"
linktitle: "get_PageRangeSeparator"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldIndex::get_PageRangeSeparator метод. Получает или задает последовательность символов, используемую для разделения начала и конца диапазона страниц в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.fields/fieldindex/get_pagerangeseparator/
---
