---
title: "Aspose::Words::Fields::FieldUnknown класс"
linktitle: "FieldUnknown"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldUnknown класс. Реализует неизвестное или нераспознанное поле. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 106000
url: /ru/cpp/aspose.words.fields/fieldunknown/
---
## FieldUnknown class


Реализует неизвестное или нераспознанное поле. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Вставьте поле, которое не обозначает конкретный тип поля в его коде.
System::SharedPtr<Aspose::Words::Fields::Field> field = builder->InsertField(u" NOTAREALFIELD //a");

// Тип поля \"FieldNone\" зарезервирован для подобных полей.
ASSERT_EQ(Aspose::Words::Fields::FieldType::FieldNone, field->get_Type());

// Мы также всё ещё можем работать с этими полями и назначать их как экземпляры класса FieldUnknown.
