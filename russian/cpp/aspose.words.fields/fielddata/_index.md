---
title: "Aspose::Words::Fields::FieldData класс"
linktitle: "FieldData"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldData класс. Реализует поле DATA. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words.fields/fielddata/
---
## FieldData class


Реализует поле DATA. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Показывает, как вставить поле DATA в документ.
```cpp
