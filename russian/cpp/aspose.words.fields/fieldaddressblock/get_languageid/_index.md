---
title: "Метод Aspose::Words::Fields::FieldAddressBlock::get_LanguageId"
linktitle: "get_LanguageId"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldAddressBlock::get_LanguageId. Получает или задает идентификатор языка, используемый для форматирования адреса в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.fields/fieldaddressblock/get_languageid/
---
