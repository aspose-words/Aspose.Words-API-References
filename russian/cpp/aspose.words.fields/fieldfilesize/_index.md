---
title: "Aspose::Words::Fields::FieldFileSize класс"
linktitle: "FieldFileSize"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Fields::FieldFileSize класс. Реализует поле FILESIZE. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 42000
url: /ru/cpp/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class


Реализует поле FILESIZE. Чтобы узнать больше, посетите статью документации [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_IsInKilobytes](./get_isinkilobytes/)() | Получает или задаёт, отображать ли размер файла в килобайтах. |
| [get_IsInMegabytes](./get_isinmegabytes/)() | Получает или задаёт, отображать ли размер файла в мегабайтах. |
...
| [set_IsInKilobytes](./set_isinkilobytes/)(bool) | Сеттер для [Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes](./get_isinkilobytes/). |
| [set_IsInMegabytes](./set_isinmegabytes/)(bool) | Сеттер для [Aspose::Words::Fields::FieldFileSize::get_IsInMegabytes](./get_isinmegabytes/). |
...
Получает размер файла текущего документа или 0, если размер определить невозможно.

В текущей реализации используется свойство [OriginalFileName](../../aspose.words/document/get_originalfilename/) для получения имени файла, используемого для определения его размера.
