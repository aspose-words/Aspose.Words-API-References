---
title: "Метод Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes"
linktitle: "get_IsInKilobytes"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes. Получает или задает, отображать ли размер файла в килобайтах в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.fields/fieldfilesize/get_isinkilobytes/
---
## FieldFileSize::get_IsInKilobytes method


Получает или задаёт, отображать ли размер файла в килобайтах.
