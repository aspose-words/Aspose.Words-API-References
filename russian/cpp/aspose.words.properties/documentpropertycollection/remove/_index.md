---
title: "Aspose::Words::Properties::DocumentPropertyCollection::Remove метод"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Properties::DocumentPropertyCollection::Remove метод. Удаляет свойство с указанным именем из коллекции в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.properties/documentpropertycollection/remove/
---
## DocumentPropertyCollection::Remove method


Удаляет из коллекции свойство с указанным именем.
