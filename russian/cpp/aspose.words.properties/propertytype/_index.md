...
description: "Aspose::Words::Properties::PropertyType enum. Указывает тип данных свойства документа в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.properties/propertytype/
---
## PropertyType enum
...
| --- | --- | --- |
| Boolean | 0 | Это свойство имеет логическое значение. |
| DateTime | 1 | Это свойство имеет значение даты и времени. |
| Double | 2 | Это свойство имеет значение с плавающей точкой. |
| Number | 3 | Это свойство имеет целочисленное значение. |
| String | 4 | Это свойство имеет строковое значение. |
| StringArray | 5 | Это свойство представляет массив строк. |
| ObjectArray | 6 | Это свойство представляет массив объектов. |
| ByteArray | 7 | Свойство представляет собой массив байтов. |
| Другое | 8 | Свойство имеет другой тип. |
