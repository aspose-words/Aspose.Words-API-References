---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_CreatedTime метод"
linktitle: "get_CreatedTime"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_CreatedTime метод. Получает или задаёт дату создания документа в UTC в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.properties/builtindocumentproperties/get_createdtime/
---
...
Для документов, возникших из формата RTF, это свойство возвращает локальное время машины автора в момент создания документа.
