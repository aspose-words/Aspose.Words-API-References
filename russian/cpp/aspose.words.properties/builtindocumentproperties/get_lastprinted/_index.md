---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_LastPrinted метод"
linktitle: "get_LastPrinted"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_LastPrinted метод. Получает или задаёт дату последней печати документа в UTC в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.properties/builtindocumentproperties/get_lastprinted/
---
...
Для документов, возникших из формата RTF, это свойство возвращает локальное время последней операции печати.
