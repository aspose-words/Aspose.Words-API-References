---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Version метод"
linktitle: "get_Version"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Version метод. Представляет номер версии приложения, создавшего документ, в C++."
type: docs
weight: 32000
url: /ru/cpp/aspose.words.properties/builtindocumentproperties/get_version/
---
...
Когда документ был создан Microsoft Word, старшие 16 бит представляют основную версию, а младшие 16 бит — номер сборки.
