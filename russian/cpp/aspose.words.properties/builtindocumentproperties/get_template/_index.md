...
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Template method. Получает или задает информационное имя шаблона документа в C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words.properties/builtindocumentproperties/get_template/
---
## BuiltInDocumentProperties::get_Template method


Получает или задает информационное название шаблона документа.
...
Чтобы получить или установить фактическое имя присоединённого шаблона, используйте свойство [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/).
