---
title: "Aspose::Words::Saving::OoxmlSaveOptions::get_Compliance метод"
linktitle: "get_Compliance"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Saving::OoxmlSaveOptions::get_Compliance метод. Указывает версию OOXML для выходного документа. Значение по умолчанию — Ecma376_2006 в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.saving/ooxmlsaveoptions/get_compliance/
---
## OoxmlSaveOptions::get_Compliance method


Указывает версию OOXML для выходного документа. Значение по умолчанию — [Ecma376_2006](../../ooxmlcompliance/).
