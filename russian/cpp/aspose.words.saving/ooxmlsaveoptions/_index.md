---
title: "Класс Aspose::Words::Saving::OoxmlSaveOptions"
linktitle: "OoxmlSaveOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Saving::OoxmlSaveOptions. Может использоваться для указания дополнительных параметров при сохранении документа в форматах Docx, Docm, Dotx, Dotm или FlatOpc. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words.saving/ooxmlsaveoptions/
---
## OoxmlSaveOptions class


Может использоваться для указания дополнительных параметров при сохранении документа в форматах [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) или [FlatOpc](../../aspose.words/saveformat/). Чтобы узнать больше, посетите статью документации [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_Compliance](./get_compliance/)() | Указывает версию OOXML для выходного документа. Значение по умолчанию — [Ecma376_2006](../ooxmlcompliance/). |
...
| [get_KeepLegacyControlChars](./get_keeplegacycontrolchars/)() const | Сохраняет оригинальное представление устаревших управляющих символов. |
...
| [get_Password](./get_password/)() const | Получает/задает пароль для шифрования документа с использованием алгоритма шифрования ECMA376 Standard. |
...
| [get_SaveFormat](./get_saveformat/)() override | Указывает формат, в котором будет сохранён документ, если используется этот объект параметров сохранения. Может быть [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) или [FlatOpc](../../aspose.words/saveformat/). |
...
| [get_Zip64Mode](./get_zip64mode/)() const | Указывает, использовать ли расширения формата ZIP64 для выходного документа. Значение по умолчанию — [Never](../zip64mode/). |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)() | Инициализирует новый экземпляр этого класса, который может использоваться для сохранения документа в формате [Docx](../../aspose.words/saveformat/). |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)(Aspose::Words::SaveFormat) | Инициализирует новый экземпляр этого класса, который может использоваться для сохранения документа в форматах [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) или [FlatOpc](../../aspose.words/saveformat/). |
...
| [set_Compliance](./set_compliance/)(Aspose::Words::Saving::OoxmlCompliance) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_Compliance](./get_compliance/). |
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_KeepLegacyControlChars](./set_keeplegacycontrolchars/)(bool) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_KeepLegacyControlChars](./get_keeplegacycontrolchars/). |
...
| [set_Password](./set_password/)(const System::String\&) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_Zip64Mode](./set_zip64mode/)(Aspose::Words::Saving::Zip64Mode) | Сеттер для [Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode](./get_zip64mode/). |
| static [Type](./type/)() |  |
