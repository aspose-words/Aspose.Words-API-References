---
title: "Класс Aspose::Words::Saving::DoclingSaveOptions"
linktitle: "DoclingSaveOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Saving::DoclingSaveOptions. Может использоваться для указания дополнительных параметров при сохранении документа в формате Docling. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 2750
url: /ru/cpp/aspose.words.saving/doclingsaveoptions/
---
## DoclingSaveOptions class


Может использоваться для указания дополнительных параметров при сохранении документа в формат [Docling](../../aspose.words/saveformat/). Чтобы узнать больше, посетите статью документации [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_RenderNonImageShapes](./get_rendernonimageshapes/)() const | Получает или задает значение, указывающее, должны ли не графические формы быть отрисованы и записаны в выходной JSON‑документ Docling. |
| [get_SaveFormat](./get_saveformat/)() override | Указывает формат, в котором будет сохранён документ, если используется этот объект параметров сохранения. Может быть только [Docling](../../aspose.words/saveformat/). |
...
| [set_RenderNonImageShapes](./set_rendernonimageshapes/)(bool) | Сеттер для [Aspose::Words::Saving::DoclingSaveOptions::get_RenderNonImageShapes](./get_rendernonimageshapes/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Сеттер для [Aspose::Words::Saving::DoclingSaveOptions::get_SaveFormat](./get_saveformat/). |
