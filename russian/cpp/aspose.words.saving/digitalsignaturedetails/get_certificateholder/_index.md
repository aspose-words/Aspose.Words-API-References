---
title: "Aspose::Words::Saving::DigitalSignatureDetails::get_CertificateHolder метод"
linktitle: "get_CertificateHolder"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Saving::DigitalSignatureDetails::get_CertificateHolder метод. Получает или задает объект CertificateHolder, содержащий сертификат, используемый для подписи документа в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.saving/digitalsignaturedetails/get_certificateholder/
---
## DigitalSignatureDetails::get_CertificateHolder method


Получает или задает объект [CertificateHolder](./), содержащий сертификат, используемый для подписи документа.
