...
description: "Метод Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains. Определяет, содержит ли коллекция закладку с заданным именем в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/contains/
---
...
| --- | --- | --- |
| name | const System::String\& | Имя закладки без учёта регистра для поиска. |
