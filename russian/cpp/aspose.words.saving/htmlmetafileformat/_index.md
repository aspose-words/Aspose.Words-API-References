---
title: "Перечисление Aspose::Words::Saving::HtmlMetafileFormat"
linktitle: "HtmlMetafileFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Перечисление Aspose::Words::Saving::HtmlMetafileFormat. Указывает формат, в котором метафайлы сохраняются в HTML‑документы в C++."
type: docs
weight: 60000
url: /ru/cpp/aspose.words.saving/htmlmetafileformat/
---
...
| --- | --- | --- |
| Png | 0 | Метафайлы рендерятся в растровые PNG‑изображения. |
| Svg | 1 | Метафайлы конвертируются в векторные SVG‑изображения. |
