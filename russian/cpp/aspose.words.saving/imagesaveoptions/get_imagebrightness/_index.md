---
title: "Метод Aspose::Words::Saving::ImageSaveOptions::get_ImageBrightness"
linktitle: "get_ImageBrightness"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Saving::ImageSaveOptions::get_ImageBrightness. Получает или задает яркость сгенерированных изображений в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.saving/imagesaveoptions/get_imagebrightness/
---
## ImageSaveOptions::get_ImageBrightness method


Получает или задаёт яркость генерируемых изображений.
