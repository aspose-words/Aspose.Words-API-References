---
title: "Aspose::Words::Saving::ImageSaveOptions::get_VerticalResolution метод"
linktitle: "get_VerticalResolution"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Saving::ImageSaveOptions::get_VerticalResolution метод. Получает или задает вертикальное разрешение генерируемых изображений в точках на дюйм в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.saving/imagesaveoptions/get_verticalresolution/
---
## ImageSaveOptions::get_VerticalResolution method


Получает или задает вертикальное разрешение сгенерированных изображений в точках на дюйм.
