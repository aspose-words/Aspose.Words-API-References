...
description: "Aspose::Words::Saving::HtmlSaveOptions::get_OfficeMathOutputMode method. Управляет тем, как объекты OfficeMath экспортируются в HTML, MHTML или EPUB. Значение по умолчанию — Image в C++."
type: docs
weight: 41000
url: /ru/cpp/aspose.words.saving/htmlsaveoptions/get_officemathoutputmode/
---
## HtmlSaveOptions::get_OfficeMathOutputMode method


Управляет тем, как объекты OfficeMath экспортируются в HTML, MHTML или EPUB. Значение по умолчанию — [Image](../../htmlofficemathoutputmode/).
