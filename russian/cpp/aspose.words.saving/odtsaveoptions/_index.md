---
title: "класс Aspose::Words::Saving::OdtSaveOptions"
linktitle: "OdtSaveOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Класс Aspose::Words::Saving::OdtSaveOptions. Может использоваться для указания дополнительных параметров при сохранении документа в формат Odt или Ott. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words.saving/odtsaveoptions/
---
## OdtSaveOptions class


Можно использовать для указания дополнительных параметров при сохранении документа в формат [Odt](../../aspose.words/saveformat/) или [Ott](../../aspose.words/saveformat/). Чтобы узнать больше, посетите статью документации [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_IsStrictSchema11](./get_isstrictschema11/)() const | Указывает, следует ли экспортировать строго в соответствии со спецификацией ODT 1.1. OOo 3.0 корректно отображает файлы, когда они содержат элементы и атрибуты ODT 1.2. Используйте "false" для этой цели или "true" для строгого соответствия спецификации 1.1. Значение по умолчанию — **false**. |
| [get_MeasureUnit](./get_measureunit/)() const | Позволяет указать единицы измерения, применяемые к содержимому документа. Значение по умолчанию — [Centimeters](../odtsavemeasureunit/) |
...
| [get_Password](./get_password/)() const | Получает или задает пароль для шифрования документа. |
...
| [get_SaveFormat](./get_saveformat/)() override | Указывает формат, в котором будет сохранён документ, если используется этот объект параметров сохранения. Может быть [Odt](../../aspose.words/saveformat/) или [Ott](../../aspose.words/saveformat/). |
...
| [OdtSaveOptions](./odtsaveoptions/)() | Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в формате [Odt](../../aspose.words/saveformat/). |
| [OdtSaveOptions](./odtsaveoptions/)(const System::String\&) | Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в формате [Odt](../../aspose.words/saveformat/) с шифрованием паролем. |
| [OdtSaveOptions](./odtsaveoptions/)(Aspose::Words::SaveFormat) | Инициализирует новый экземпляр этого класса, который можно использовать для сохранения документа в формате [Odt](../../aspose.words/saveformat/) или [Ott](../../aspose.words/saveformat/). |
...
| [set_IsStrictSchema11](./set_isstrictschema11/)(bool) | Сеттер для [Aspose::Words::Saving::OdtSaveOptions::get_IsStrictSchema11](./get_isstrictschema11/). |
| [set_MeasureUnit](./set_measureunit/)(Aspose::Words::Saving::OdtSaveMeasureUnit) | Сеттер для [Aspose::Words::Saving::OdtSaveOptions::get_MeasureUnit](./get_measureunit/). |
...
| [set_Password](./set_password/)(const System::String\&) | Сеттер для [Aspose::Words::Saving::OdtSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Сеттер для [Aspose::Words::Saving::OdtSaveOptions::get_SaveFormat](./get_saveformat/). |
