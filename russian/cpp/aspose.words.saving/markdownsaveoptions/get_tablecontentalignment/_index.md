---
title: "Метод Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment"
linktitle: "get_TableContentAlignment"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment. Получает или задает значение, определяющее, как выравнивать содержимое в таблицах при экспорте в формат Markdown. Значение по умолчанию — Auto в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.saving/markdownsaveoptions/get_tablecontentalignment/
---
## MarkdownSaveOptions::get_TableContentAlignment method


Получает или задает значение, определяющее, как выравнивать содержимое в таблицах при экспорте в формат [Markdown](../../../aspose.words/saveformat/). Значение по умолчанию — [Auto](../../tablecontentalignment/).
