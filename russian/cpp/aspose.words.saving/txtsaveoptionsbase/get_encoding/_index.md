---
title: "Метод Aspose::Words::Saving::TxtSaveOptionsBase::get_Encoding"
linktitle: "get_Encoding"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Saving::TxtSaveOptionsBase::get_Encoding. Указывает кодировку, используемую при экспорте в текстовые форматы. Значение по умолчанию — Encoding.UTF8 в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.saving/txtsaveoptionsbase/get_encoding/
---
...
// Добавьте некоторый текст с символами, не входящими в набор ASCII.
...
// Проверьте, что свойство \"Encoding\" содержит соответствующую кодировку для содержимого нашего документа.
