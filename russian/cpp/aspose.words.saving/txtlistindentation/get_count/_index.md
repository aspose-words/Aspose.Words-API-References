---
title: "Метод Aspose::Words::Saving::TxtListIndentation::get_Count"
linktitle: "get_Count"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Saving::TxtListIndentation::get_Count. Получает или задает количество символов, используемых в качестве отступа для одного уровня списка. Значение по умолчанию — 0, что означает отсутствие отступа в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words.saving/txtlistindentation/get_count/
---
## TxtListIndentation::get_Count method


Получает или задает, сколько [Character](../get_character/) использовать в качестве отступа для одного уровня списка. Значение по умолчанию — 0, что означает отсутствие отступа.
