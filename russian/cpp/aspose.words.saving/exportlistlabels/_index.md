...
description: "Aspose::Words::Saving::ExportListLabels enum. Указывает, как метки списков экспортируются в HTML, MHTML и EPUB в C++."
type: docs
weight: 56000
url: /ru/cpp/aspose.words.saving/exportlistlabels/
---
...
| --- | --- | --- |
| Авто | 0 | Выводит метки списков в автоматическом режиме. При возможности использует нативные элементы HTML. |
| AsInlineText | 1 | Выводит все метки списков как встроенный текст. |
| ByHtmlTags | 2 | Выводит все метки списков как нативные элементы HTML. |
