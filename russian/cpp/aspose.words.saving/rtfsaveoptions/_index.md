---
title: "Aspose::Words::Saving::RtfSaveOptions класс"
linktitle: "RtfSaveOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Saving::RtfSaveOptions класс. Может использоваться для указания дополнительных параметров при сохранении документа в формате Rtf. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 28000
url: /ru/cpp/aspose.words.saving/rtfsaveoptions/
---
## RtfSaveOptions class


Может использоваться для указания дополнительных параметров при сохранении документа в формате [Rtf](../../aspose.words/saveformat/). Чтобы узнать больше, посетите статью документации [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportCompactSize](./get_exportcompactsize/)() const | Позволяет уменьшить размер выходных RTF‑документов, но если они содержат RTL (справа налево) текст, он будет отображаться некорректно. Значение по умолчанию — **false**. |
...
| [get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/)() const | Указывает, записываются ли ключевые слова для «старых читателей» в RTF или нет. Это может существенно влиять на размер RTF‑документа. Значение по умолчанию — **true**. |
...
| [get_SaveFormat](./get_saveformat/)() override | Указывает формат, в котором будет сохранён документ, если используется этот объект параметров сохранения. Может быть только [Rtf](../../aspose.words/saveformat/). |
| [get_SaveImagesAsWmf](./get_saveimagesaswmf/)() const | Когда **true**, все изображения будут сохранены как WMF. |
...
| [set_ExportCompactSize](./set_exportcompactsize/)(bool) | Сеттер для [Aspose::Words::Saving::RtfSaveOptions::get_ExportCompactSize](./get_exportcompactsize/). |
...
| [set_ExportImagesForOldReaders](./set_exportimagesforoldreaders/)(bool) | Сеттер для [Aspose::Words::Saving::RtfSaveOptions::get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Сеттер для [Aspose::Words::Saving::RtfSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SaveImagesAsWmf](./set_saveimagesaswmf/)(bool) | Сеттер для [Aspose::Words::Saving::RtfSaveOptions::get_SaveImagesAsWmf](./get_saveimagesaswmf/). |
