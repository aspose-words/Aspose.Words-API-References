---
title: "Aspose::Words::Paragraph::get_ListLabel метод"
linktitle: "get_ListLabel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Paragraph::get_ListLabel метод. Получает объект ListLabel, который предоставляет доступ к значению нумерации списка и его форматированию для этого абзаца в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words/paragraph/get_listlabel/
---
## Paragraph::get_ListLabel method


Получает объект [ListLabel](./), который предоставляет доступ к значению нумерации списка и его форматированию для этого абзаца.
