...
description: "Aspose::Words::Paragraph::get_Runs method. Предоставляет доступ к типизированной коллекции фрагментов текста внутри абзаца в C++."
type: docs
weight: 25000
url: /ru/cpp/aspose.words/paragraph/get_runs/
---
