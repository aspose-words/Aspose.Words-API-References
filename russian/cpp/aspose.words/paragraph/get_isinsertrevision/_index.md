---
title: "Метод Aspose::Words::Paragraph::get_IsInsertRevision"
linktitle: "get_IsInsertRevision"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Paragraph::get_IsInsertRevision. Возвращает истину, если этот объект был вставлен в Microsoft Word при включённом отслеживании изменений в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words/paragraph/get_isinsertrevision/
---
