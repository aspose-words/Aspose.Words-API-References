---
title: "Перечисление Aspose::Words::LineNumberRestartMode"
linktitle: "LineNumberRestartMode"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::LineNumberRestartMode enum. Определяет, когда автоматическая нумерация строк перезапускается в C++."
type: docs
weight: 94000
url: /ru/cpp/aspose.words/linenumberrestartmode/
---
...
| --- | --- | --- |
| RestartPage | 0 | Нумерация строк перезапускается в начале каждой страницы. |
| RestartSection | 1 | Нумерация строк перезапускается в начале раздела. |
