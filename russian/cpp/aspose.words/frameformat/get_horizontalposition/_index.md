---
title: "Aspose::Words::FrameFormat::get_HorizontalPosition метод"
linktitle: "get_HorizontalPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FrameFormat::get_HorizontalPosition метод. Получает горизонтальное расстояние между краем рамки и элементом, указанным свойством RelativeHorizontalPosition, в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/frameformat/get_horizontalposition/
---
## FrameFormat::get_HorizontalPosition method


Получает горизонтальное расстояние между краем рамки и элементом, указанным свойством [RelativeHorizontalPosition](../get_relativehorizontalposition/).
