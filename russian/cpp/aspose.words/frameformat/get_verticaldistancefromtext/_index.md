---
title: "Aspose::Words::FrameFormat::get_VerticalDistanceFromText метод"
linktitle: "get_VerticalDistanceFromText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FrameFormat::get_VerticalDistanceFromText метод. Указывает вертикальное расстояние (в пунктах) между рамкой и окружающим текстом в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words/frameformat/get_verticaldistancefromtext/
---
