---
title: "Aspose::Words::FrameFormat::get_VerticalPosition метод"
linktitle: "get_VerticalPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FrameFormat::get_VerticalPosition method. Получает вертикальное расстояние между краем кадра и элементом, указанным свойством RelativeVerticalPosition, в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words/frameformat/get_verticalposition/
---
## FrameFormat::get_VerticalPosition method


Получает вертикальное расстояние между краем кадра и элементом, указанным свойством [RelativeVerticalPosition](../get_relativeverticalposition/).
