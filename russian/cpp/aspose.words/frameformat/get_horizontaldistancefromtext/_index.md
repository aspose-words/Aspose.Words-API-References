---
title: "Aspose::Words::FrameFormat::get_HorizontalDistanceFromText метод"
linktitle: "get_HorizontalDistanceFromText"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FrameFormat::get_HorizontalDistanceFromText метод. Получает горизонтальное расстояние между рамкой и окружающим текстом в пунктах в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/frameformat/get_horizontaldistancefromtext/
---
