...
description: "Aspose::Words::ConditionalStyleType enum. Представляет возможные области таблицы, для которых может быть определено условное форматирование в стиле таблицы в C++."
type: docs
weight: 85000
url: /ru/cpp/aspose.words/conditionalstyletype/
---
...
| --- | --- | --- |
| FirstRow | 0 | Указывает форматирование первой строки таблицы. |
| FirstColumn | 1 | Указывает форматирование первого столбца таблицы. |
| LastRow | 2 | Указывает форматирование последней строки таблицы. |
| LastColumn | 3 | Указывает форматирование последнего столбца таблицы. |
| OddRowBanding | 4 | Указывает форматирование полосы строк с нечётными номерами. |
| OddColumnBanding | 5 | Указывает форматирование полосы столбцов с нечётными номерами. |
| EvenRowBanding | 6 | Указывает форматирование полосы строк с чётными номерами. |
| EvenColumnBanding | 7 | Указывает форматирование полосы колонок с чётными номерами. |
| TopLeftCell | 8 | Указывает форматирование верхней левой ячейки таблицы. |
| TopRightCell | 9 | Указывает форматирование верхней правой ячейки таблицы. |
| BottomLeftCell | 10 | Указывает форматирование нижней левой ячейки таблицы. |
| BottomRightCell | 11 | Указывает форматирование нижней правой ячейки таблицы. |
