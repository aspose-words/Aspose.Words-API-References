---
title: "Метод Aspose::Words::TextWatermarkOptions::get_FontFamily"
linktitle: "get_FontFamily"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TextWatermarkOptions::get_FontFamily. Получает или задает название семейства шрифтов. Значение по умолчанию — \"Calibri\" в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/textwatermarkoptions/get_fontfamily/
---
## TextWatermarkOptions::get_FontFamily method


Получает или задаёт название семейства шрифтов. Значение по умолчанию — "Calibri".
