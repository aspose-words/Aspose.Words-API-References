---
title: "Aspose::Words::TextWatermarkOptions::get_Color метод"
linktitle: "get_Color"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::TextWatermarkOptions::get_Color метод. Получает или задает цвет шрифта. Значение по умолчанию — Silver в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/textwatermarkoptions/get_color/
---
## TextWatermarkOptions::get_Color method


Получает или задаёт цвет шрифта. Значение по умолчанию — **Silver**.
