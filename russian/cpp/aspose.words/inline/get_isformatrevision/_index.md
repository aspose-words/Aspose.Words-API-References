---
title: "Метод Aspose::Words::Inline::get_IsFormatRevision"
linktitle: "get_IsFormatRevision"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Inline::get_IsFormatRevision. Возвращает true, если форматирование объекта было изменено в Microsoft Word при включённом отслеживании изменений в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/inline/get_isformatrevision/
---
