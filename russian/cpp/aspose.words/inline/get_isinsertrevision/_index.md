---
title: "Метод Aspose::Words::Inline::get_IsInsertRevision"
linktitle: "get_IsInsertRevision"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Inline::get_IsInsertRevision. Возвращает true, если этот объект был вставлен в Microsoft Word при включённом отслеживании изменений в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/inline/get_isinsertrevision/
---
