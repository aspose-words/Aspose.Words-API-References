---
title: "Aspose::Words::VariableCollection::Remove метод"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::VariableCollection::Remove метод. Удаляет переменную документа с указанным именем из коллекции в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words/variablecollection/remove/
---
