---
title: "Метод Aspose::Words::VariableCollection::Add"
linktitle: "Add"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::VariableCollection::Add. Добавляет переменную документа в коллекцию в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/variablecollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Регистронезависимое имя переменной для добавления. |
| value | const System::String\& | Значение переменной. Значение не может быть **null**, если значение равно null, будет использована пустая строка. |
