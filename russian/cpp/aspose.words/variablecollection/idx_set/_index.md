---
title: "Метод Aspose::Words::VariableCollection::idx_set"
linktitle: "idx_set"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::VariableCollection::idx_set. Получает или задает переменную документа по нечувствительному к регистру имени. Значения null не допускаются в правой части присваивания и будут заменены пустой строкой в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words/variablecollection/idx_set/
---
