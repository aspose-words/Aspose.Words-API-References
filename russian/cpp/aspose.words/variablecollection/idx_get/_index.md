---
title: "Aspose::Words::VariableCollection::idx_get метод"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::VariableCollection::idx_get метод. Получает или задает переменную документа по нечувствительному к регистру имени. Значения null не допускаются в правой части присваивания и будут заменены пустой строкой в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words/variablecollection/idx_get/
---
## VariableCollection::idx_get(const System::String\&) method


Получает или задает переменную документа по нечувствительному к регистру имени. Значения **null** не допускаются в правой части присваивания и будут заменены пустой строкой.
...
Получает или задает переменную документа по указанному индексу. Значения **null** не допускаются в правой части присваивания и будут заменены пустой строкой.
...
| --- | --- | --- |
| index | int32_t | Нулевой индекс переменной документа. |
