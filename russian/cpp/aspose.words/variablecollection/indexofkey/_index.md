---
title: "Aspose::Words::VariableCollection::IndexOfKey метод"
linktitle: "IndexOfKey"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::VariableCollection::IndexOfKey метод. Возвращает нулевой индекс указанной переменной документа в коллекции в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words/variablecollection/indexofkey/
---
## VariableCollection::IndexOfKey method


Возвращает нулевой индекс указанной переменной документа в коллекции.
...
| --- | --- | --- |
| name | const System::String\& | Нечувствительное к регистру имя переменной. |
