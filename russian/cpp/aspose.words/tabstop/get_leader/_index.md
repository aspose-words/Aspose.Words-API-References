---
title: "Метод Aspose::Words::TabStop::get_Leader"
linktitle: "get_Leader"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TabStop::get_Leader. Получает или задает тип линии‑заполнителя, отображаемой под символом табуляции в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/tabstop/get_leader/
---
## TabStop::get_Leader method


Получает или задает тип линий‑заполнителей, отображаемых под символом табуляции.
