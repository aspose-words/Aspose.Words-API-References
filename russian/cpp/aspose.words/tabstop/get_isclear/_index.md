---
title: "Метод Aspose::Words::TabStop::get_IsClear"
linktitle: "get_IsClear"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TabStop::get_IsClear. Возвращает true, если эта табуляция удаляет любые существующие табуляции в этой позиции в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/tabstop/get_isclear/
---
## TabStop::get_IsClear method


Возвращает **true**, если эта табуляция удаляет любые существующие табуляции в этой позиции.
