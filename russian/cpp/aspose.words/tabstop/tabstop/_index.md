---
title: "Конструктор Aspose::Words::TabStop::TabStop"
linktitle: "TabStop"
second_title: "Справочник API Aspose.Words для C++"
description: "Конструктор Aspose::Words::TabStop::TabStop. Инициализирует новый экземпляр этого класса в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/tabstop/tabstop/
---
...
| --- | --- | --- |
| позиция | double | Позиция табуляции в пунктах. |
| alignment | Aspose::Words::TabAlignment | Значение [TabAlignment](../../tabalignment/), которое задает выравнивание текста на этой табуляции. |
