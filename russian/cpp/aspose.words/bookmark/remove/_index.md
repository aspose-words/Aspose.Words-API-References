---
title: "Метод Aspose::Words::Bookmark::Remove"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bookmark::Remove. Удаляет закладку из документа. Не удаляет текст внутри закладки в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words/bookmark/remove/
---
