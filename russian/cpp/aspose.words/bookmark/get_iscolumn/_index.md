---
title: "Метод Aspose::Words::Bookmark::get_IsColumn"
linktitle: "get_IsColumn"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Bookmark::get_IsColumn. Возвращает true, если эта закладка является закладкой столбца таблицы в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/bookmark/get_iscolumn/
---
