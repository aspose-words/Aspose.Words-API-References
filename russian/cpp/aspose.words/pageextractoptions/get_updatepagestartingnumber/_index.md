---
title: "Метод Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber"
linktitle: "get_UpdatePageStartingNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber. Указывает, следует ли обновлять номер начальной страницы в результирующем документе. Значение по умолчанию — true в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/pageextractoptions/get_updatepagestartingnumber/
---
## PageExtractOptions::get_UpdatePageStartingNumber method


Указывает, будет ли обновлен номер начальной страницы в получаемом документе. Значение по умолчанию — **true**.
