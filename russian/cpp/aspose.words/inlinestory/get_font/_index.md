...
description: "Aspose::Words::InlineStory::get_Font method. Предоставляет доступ к форматированию шрифта символа‑якоря этого объекта в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/inlinestory/get_font/
---
## InlineStory::get_Font method


Предоставляет доступ к форматированию шрифта символа‑якоря этого объекта.
