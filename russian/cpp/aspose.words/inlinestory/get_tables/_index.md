---
title: "Метод Aspose::Words::InlineStory::get_Tables"
linktitle: "get_Tables"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::InlineStory::get_Tables. Получает коллекцию таблиц, которые являются непосредственными дочерними элементами истории в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words/inlinestory/get_tables/
---
## InlineStory::get_Tables method


Возвращает коллекцию таблиц, которые являются непосредственными дочерними элементами истории.
