...
description: "Aspose::Words::InlineStory::get_IsMoveToRevision method. Возвращает true, если этот объект был перемещён (вставлен) в Microsoft Word при включённом отслеживании изменений в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words/inlinestory/get_ismovetorevision/
---
