---
title: "Метод Aspose::Words::InlineStory::EnsureMinimum"
linktitle: "EnsureMinimum"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::InlineStory::EnsureMinimum method. Если последний дочерний элемент не является абзацем, создает и добавляет один пустой абзац в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/inlinestory/ensureminimum/
---
