...
description: "Aspose::Words::InlineStory::get_IsDeleteRevision method. Возвращает true, если этот объект был удалён в Microsoft Word при включённом отслеживании изменений в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/inlinestory/get_isdeleterevision/
---
