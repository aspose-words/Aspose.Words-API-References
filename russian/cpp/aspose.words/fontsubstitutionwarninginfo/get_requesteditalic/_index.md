---
title: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedItalic метод"
linktitle: "get_RequestedItalic"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedItalic метод. Указывает, был ли запрошен курсивный стиль в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/fontsubstitutionwarninginfo/get_requesteditalic/
---
## FontSubstitutionWarningInfo::get_RequestedItalic method


Указывает, был ли запрошен курсивный стиль.
