---
title: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedBold метод"
linktitle: "get_RequestedBold"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedBold метод. Указывает, был ли запрошен полужирный стиль в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/fontsubstitutionwarninginfo/get_requestedbold/
---
## FontSubstitutionWarningInfo::get_RequestedBold method


Указывает, был ли запрошен полужирный стиль.
