---
title: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedFamilyName метод"
linktitle: "get_RequestedFamilyName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FontSubstitutionWarningInfo::get_RequestedFamilyName метод. Запрошенное название семейства шрифта в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/fontsubstitutionwarninginfo/get_requestedfamilyname/
---
## FontSubstitutionWarningInfo::get_RequestedFamilyName method


Запрошенное название семейства шрифтов.
