---
title: "Метод Aspose::Words::Style::Equals"
linktitle: "Equals"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Style::Equals. Сравнивает с указанным стилем. Идентификаторы стилей сравниваются только для встроенных стилей. Значения по умолчанию стилей не включаются в сравнение. Базовый стиль, связанный стиль и стиль следующего абзаца сравниваются рекурсивно в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/style/equals/
---
## Style::Equals method
