---
title: "Метод Aspose::Words::Style::get_List"
linktitle: "get_List"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Style::get_List. Получает список, определяющий форматирование этого стиля списка в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words/style/get_list/
---
...
Это свойство действительно только для стилей списков. Для других типов стилей это свойство возвращает **null**.
