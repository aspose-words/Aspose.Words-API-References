...
description: "Aspose::Words::Style::get_Aliases method. Получает все псевдонимы этого стиля. Если у стиля нет псевдонимов, возвращается пустой массив строк в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/style/get_aliases/
---
