---
title: "Aspose::Words::CleanupOptions::get_UnusedLists метод"
linktitle: "get_UnusedLists"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::CleanupOptions::get_UnusedLists метод. Указывает, следует ли удалять из документа неиспользуемые списки и определения списков. Значение по умолчанию — true в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/cleanupoptions/get_unusedlists/
---
