---
title: "Aspose::Words::CleanupOptions::get_UnusedBuiltinStyles метод"
linktitle: "get_UnusedBuiltinStyles"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::CleanupOptions::get_UnusedBuiltinStyles метод. Указывает, что неиспользуемые стили BuiltIn должны быть удалены из документа в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/cleanupoptions/get_unusedbuiltinstyles/
---
## CleanupOptions::get_UnusedBuiltinStyles method


Указывает, что неиспользуемые стили [BuiltIn](../../style/get_builtin/) должны быть удалены из документа.
