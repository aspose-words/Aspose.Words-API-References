---
title: "метод Aspose::Words::EditableRange::Remove"
linktitle: "Remove"
second_title: "Справочник API Aspose.Words для C++"
description: "метод Aspose::Words::EditableRange::Remove. Удаляет редактируемый диапазон из документа. Не удаляет содержимое внутри редактируемого диапазона в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/editablerange/remove/
---
