---
title: "Метод Aspose::Words::EditableRange::get_Id"
linktitle: "get_Id"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::EditableRange::get_Id. Получает идентификатор редактируемого диапазона в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/editablerange/get_id/
---
...
Область должна быть размечена с помощью [EditableRangeStart](../get_editablerangestart/) и [EditableRangeEnd](../get_editablerangeend/).

Идентификаторы редактируемых диапазонов должны быть уникальными в пределах документа, и Aspose.Words автоматически поддерживает их при загрузке, сохранении и объединении документов.
