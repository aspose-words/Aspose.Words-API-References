---
title: "Aspose::Words::Border::get_IsVisible метод"
linktitle: "get_IsVisible"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Border::get_IsVisible метод. Возвращает true, если LineStyle не является None в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/border/get_isvisible/
---
## Border::get_IsVisible method


Возвращает **true**, если [LineStyle](../get_linestyle/) не является [None](../../linestyle/).
