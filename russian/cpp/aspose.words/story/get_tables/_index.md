...
description: "Aspose::Words::Story::get_Tables method. Возвращает коллекцию таблиц, которые являются непосредственными дочерними элементами истории, в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words/story/get_tables/
---
