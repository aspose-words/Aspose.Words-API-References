---
title: "Aspose::Words::SpecialChar класс"
linktitle: "SpecialChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::SpecialChar класс. Базовый класс для специальных символов в документе. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 62000
url: /ru/cpp/aspose.words/specialchar/
---
## SpecialChar class


Базовый класс для специальных символов в документе. Чтобы узнать больше, посетите статью документации [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_NodeType](./get_nodetype/)() const override | Возвращает [SpecialChar](../nodetype/). |
...
| [GetText](./gettext/)() override | Получает специальный символ, который представляет этот узел. |
...
Документ Microsoft Word может включать множество специальных символов, представляющих поля, поля формы, фигуры, объекты OLE, сноски и т.д. Список специальных символов см. в [ControlChar](../controlchar/).
