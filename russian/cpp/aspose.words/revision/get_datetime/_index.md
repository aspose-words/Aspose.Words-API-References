...
description: "Aspose::Words::Revision::get_DateTime method. Получает или задает дату/время этой правки в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/revision/get_datetime/
---
## Revision::get_DateTime method


Получает или задает дату/время этой ревизии.
