...
description: "Метод Aspose::Words::Revision::get_Author. Получает или задает автора этой правки. Не может быть пустой строкой или null в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/revision/get_author/
---
## Revision::get_Author method


Получает или задает автора этой ревизии. Не может быть пустой строкой или **null**.
