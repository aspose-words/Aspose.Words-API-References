---
title: "Метод Aspose::Words::Run::get_Text"
linktitle: "get_Text"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Run::get_Text. Получает или задает текст фрагмента в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/run/get_text/
---
## Run::get_Text method


Получает или задает текст прогона.
