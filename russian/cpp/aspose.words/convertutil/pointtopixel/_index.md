---
title: "Aspose::Words::ConvertUtil::PointToPixel метод"
linktitle: "PointToPixel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ConvertUtil::PointToPixel метод. Преобразует пункты в пиксели при 96 dpi в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/convertutil/pointtopixel/
---
## ConvertUtil::PointToPixel(double) method


Преобразует пункты в пиксели при 96 dpi.
