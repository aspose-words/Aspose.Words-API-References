---
title: "Aspose::Words::Section::Section конструктор"
linktitle: "Раздел"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Section::Section конструктор. Инициализирует новый экземпляр класса Section в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/section/section/
---
...
Когда раздел создаётся, он принадлежит указанному документу, но ещё не является частью документа, и [ParentNode](../../node/get_parentnode/) имеет значение **null**.

Чтобы включить [Section](../) в документ, используйте методы [InsertAfter1()</see> и <see cref="Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\>, System::SharedPtr\<Aspose::Words::Node\>)">InsertBefore1()](../) класса [Document](../../document/) ИЛИ методы [Add()](../) и [Insert()](../) свойства [Sections](../../document/get_sections/).
