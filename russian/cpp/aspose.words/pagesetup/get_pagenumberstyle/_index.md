---
title: "Aspose::Words::PageSetup::get_PageNumberStyle метод"
linktitle: "get_PageNumberStyle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::PageSetup::get_PageNumberStyle метод. Получает или задает формат номера страницы в C++."
type: docs
weight: 34000
url: /ru/cpp/aspose.words/pagesetup/get_pagenumberstyle/
---
## PageSetup::get_PageNumberStyle method


Получает или задает формат номера страницы.
