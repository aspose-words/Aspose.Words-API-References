---
title: "Aspose::Words::PageSetup::get_SectionStart метод"
linktitle: "get_SectionStart"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::PageSetup::get_SectionStart метод. Возвращает или задает тип разрыва раздела для указанного объекта в C++."
type: docs
weight: 41000
url: /ru/cpp/aspose.words/pagesetup/get_sectionstart/
---
