---
title: "Aspose::Words::PageSetup::get_Gutter метод"
linktitle: "get_Gutter"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::PageSetup::get_Gutter метод. Получает или задает количество дополнительного пространства, добавляемого к полю для переплета документа в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words/pagesetup/get_gutter/
---
## PageSetup::get_Gutter method


Получает или задает количество дополнительного пространства, добавляемого к полю для переплёта документа.
