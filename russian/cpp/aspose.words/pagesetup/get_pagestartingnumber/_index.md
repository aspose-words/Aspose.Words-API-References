---
title: "Aspose::Words::PageSetup::get_PageStartingNumber метод"
linktitle: "get_PageStartingNumber"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::PageSetup::get_PageStartingNumber метод. Получает или задает начальный номер страницы раздела в C++."
type: docs
weight: 35000
url: /ru/cpp/aspose.words/pagesetup/get_pagestartingnumber/
---
## PageSetup::get_PageStartingNumber method


Получает или задает начальный номер страницы раздела.
