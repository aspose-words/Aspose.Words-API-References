---
title: "Метод Aspose::Words::PageSetup::get_PaperSize"
linktitle: "get_PaperSize"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::PageSetup::get_PaperSize. Возвращает или задает размер бумаги в C++."
type: docs
weight: 37000
url: /ru/cpp/aspose.words/pagesetup/get_papersize/
---
...
Установка этого свойства обновляет значения [PageWidth](../get_pagewidth/) и [PageHeight](../get_pageheight/). Установка этого значения в [Custom](../../papersize/) не изменяет существующие значения.
...
Показывает, как установить размеры страниц.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Мы можем изменить размер текущей страницы на предопределённый размер
// используя свойство "PaperSize" объекта PageSetup этого раздела.
...
// Каждый раздел имеет свой собственный объект PageSetup. Когда мы используем построитель документа для создания нового раздела,
...
// Установите пользовательский размер для страниц этого раздела.
...
// Установите размер бумаги на JisB4 (257x364 мм).
pageSetup->set_PaperSize(Aspose::Words::PaperSize::JisB4);
// В качестве альтернативы установите размер бумаги на JisB5. (182x257 мм).
