---
title: "Метод Aspose::Words::RunCollection::ToArray"
linktitle: "ToArray"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::RunCollection::ToArray. Копирует все элементы Run из коллекции в новый массив Run в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/runcollection/toarray/
---
## RunCollection::ToArray method


Копирует все узлы run из коллекции в новый массив узлов run.
