---
title: "Aspose::Words::Shading::get_ForegroundTintAndShade метод"
linktitle: "get_ForegroundTintAndShade"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Shading::get_ForegroundTintAndShade метод. Получает или задает значение типа double, которое осветляет или затемняет цвет темы переднего плана в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/shading/get_foregroundtintandshade/
---
## Shading::get_ForegroundTintAndShade method


Получает или задает значение типа double, которое осветляет или затемняет цвет темы переднего плана.
