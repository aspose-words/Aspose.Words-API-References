---
title: "Aspose::Words::Shading::get_ForegroundPatternColor метод"
linktitle: "get_ForegroundPatternColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Shading::get_ForegroundPatternColor метод. Получает или задает цвет, который''применяется к переднему плану объекта Shading в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words/shading/get_foregroundpatterncolor/
---
## Shading::get_ForegroundPatternColor method


Получает или задает цвет, который применяется к переднему плану объекта [Shading](../).
