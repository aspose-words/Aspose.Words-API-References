---
title: "Метод Aspose::Words::Shading::get_ForegroundPatternThemeColor"
linktitle: "get_ForegroundPatternThemeColor"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Shading::get_ForegroundPatternThemeColor. Получает или задает цвет темы шаблона переднего плана в применяемой цветовой схеме, связанной с этим объектом Shading в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words/shading/get_foregroundpatternthemecolor/
---
## Shading::get_ForegroundPatternThemeColor method


Получает или задает цвет темы шаблона переднего плана в применяемой цветовой схеме, связанной с этим объектом [Shading](../).
