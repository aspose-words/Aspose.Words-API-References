---
title: "Aspose::Words::Document::get_Revisions метод"
linktitle: "get_Revisions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_Revisions метод. Получает коллекцию исправлений (отслеживаемых изменений), существующих в этом документе, на C++."
type: docs
weight: 46000
url: /ru/cpp/aspose.words/document/get_revisions/
---
