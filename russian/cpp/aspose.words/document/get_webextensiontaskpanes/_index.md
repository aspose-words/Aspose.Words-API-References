---
title: "Aspose::Words::Document::get_WebExtensionTaskPanes метод"
linktitle: "get_WebExtensionTaskPanes"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_WebExtensionTaskPanes метод. Возвращает коллекцию, представляющую список надстроек панелей задач в C++."
type: docs
weight: 60000
url: /ru/cpp/aspose.words/document/get_webextensiontaskpanes/
---
## Document::get_WebExtensionTaskPanes method


Возвращает коллекцию, представляющую список надстроек панели задач.
