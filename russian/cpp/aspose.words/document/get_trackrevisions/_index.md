---
title: "Aspose::Words::Document::get_TrackRevisions метод"
linktitle: "get_TrackRevisions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_TrackRevisions метод. Истина, если изменения отслеживаются, когда этот документ редактируется в Microsoft Word в C++."
type: docs
weight: 54000
url: /ru/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


True, если изменения отслеживаются, когда этот документ редактируется в Microsoft Word.
...
Установка этой опции только указывает Microsoft Word, включено ли отслеживание изменений. Это свойство не влияет на изменения документа, которые вы вносите программно через Aspose.Words.

Если вы хотите автоматически отслеживать изменения, которые программно вносит [Aspose.Words](../../) в этот документ, используйте метод [StartTrackRevisions()](../).
