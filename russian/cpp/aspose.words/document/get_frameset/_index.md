---
title: "Метод Aspose::Words::Document::get_Frameset"
linktitle: "get_Frameset"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Document::get_Frameset. Возвращает экземпляр Frameset, если данный документ представляет страницу с фреймами в C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words/document/get_frameset/
---
## Document::get_Frameset method


Возвращает экземпляр [Frameset](./), если данный документ представляет страницу с фреймами.
