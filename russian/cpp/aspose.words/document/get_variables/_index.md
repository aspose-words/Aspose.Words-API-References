---
title: "Aspose::Words::Document::get_Variables метод"
linktitle: "get_Variables"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_Variables метод. Возвращает коллекцию переменных, добавленных в документ или шаблон в C++."
type: docs
weight: 55000
url: /ru/cpp/aspose.words/document/get_variables/
---
