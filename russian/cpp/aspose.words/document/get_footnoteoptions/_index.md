---
title: "Aspose::Words::Document::get_FootnoteOptions метод"
linktitle: "get_FootnoteOptions"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_FootnoteOptions метод. Предоставляет параметры, которые управляют нумерацией и расположением сносок в этом документе в C++."
type: docs
weight: 26000
url: /ru/cpp/aspose.words/document/get_footnoteoptions/
---
## Document::get_FootnoteOptions method


Предоставляет параметры, управляющие нумерацией и размещением сносок в этом документе.
