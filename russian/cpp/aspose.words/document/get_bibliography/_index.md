---
title: "Aspose::Words::Document::get_Bibliography метод"
linktitle: "get_Bibliography"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_Bibliography метод. Получает объект Bibliography, представляющий список источников, доступных в документе, в C++."
type: docs
weight: 14500
url: /ru/cpp/aspose.words/document/get_bibliography/
---
## Document::get_Bibliography method


Получает объект [Bibliography](./), представляющий список источников, доступных в документе.
