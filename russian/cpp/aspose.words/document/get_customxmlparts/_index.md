---
title: "Метод Aspose::Words::Document::get_CustomXmlParts"
linktitle: "get_CustomXmlParts"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Document::get_CustomXmlParts. Получает или задает коллекцию частей хранилища пользовательских XML‑данных в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words/document/get_customxmlparts/
---
## Document::get_CustomXmlParts method


Получает или задает коллекцию частей хранилища пользовательских XML‑данных.
...
Aspose.Words загружает и сохраняет пользовательские XML‑части только в документы OOXML и DOC.
