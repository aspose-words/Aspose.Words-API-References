---
title: "Aspose::Words::Document::get_Theme метод"
linktitle: "get_Theme"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Document::get_Theme метод. Получает объект Theme для этого документа в C++."
type: docs
weight: 53000
url: /ru/cpp/aspose.words/document/get_theme/
---
## Document::get_Theme method


Получает объект [Theme](./) для этого документа.
