...
description: "Aspose::Words::Document::get_HyphenationOptions method. Предоставляет доступ к параметрам переноса слов в документе на C++."
type: docs
weight: 32000
url: /ru/cpp/aspose.words/document/get_hyphenationoptions/
---
## Document::get_HyphenationOptions method


Обеспечивает доступ к параметрам переноса слов в документе.
