---
title: "Aspose::Words::ConditionalStyleCollection::idx_get метод"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ConditionalStyleCollection::idx_get метод. Получает объект ConditionalStyle по типу условного стиля в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


Получает объект [ConditionalStyle](../../conditionalstyle/) по типу условного стиля.
...
Получает объект [ConditionalStyle](../../conditionalstyle/) по индексу.
...
| --- | --- | --- |
| index | int32_t | Индекс, начинающийся с нуля, условного стиля для получения. |
