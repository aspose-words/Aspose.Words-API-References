---
title: "Метод Aspose::Words::EditableRangeStart::get_EditableRange"
linktitle: "get_EditableRange"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::EditableRangeStart::get_EditableRange. Получает фасадный объект, который инкапсулирует начало и конец этого редактируемого диапазона в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/editablerangestart/get_editablerange/
---
## EditableRangeStart::get_EditableRange method


Получает объект‑фасад, который инкапсулирует начало и конец этого редактируемого диапазона.
