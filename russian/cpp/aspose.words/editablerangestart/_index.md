...
description: "Aspose::Words::EditableRangeStart class. Представляет начало редактируемого диапазона в документе Word. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 26000
url: /ru/cpp/aspose.words/editablerangestart/
---
## EditableRangeStart class


Представляет начало редактируемого диапазона в документе Word. Чтобы узнать больше, посетите статью документации [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_EditableRange](./get_editablerange/)() | Получает объект‑фасад, который инкапсулирует начало и конец этого редактируемого диапазона. |
| [get_Id](./get_id/)() const | Указывает идентификатор редактируемого диапазона. |
...
| [get_NodeType](./get_nodetype/)() const override | Возвращает [EditableRangeStart](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | Сеттер для [Aspose::Words::EditableRangeStart::get_Id](./get_id/). |
...
Полный редактируемый диапазон в документе Word состоит из [EditableRangeStart](./) и соответствующего [EditableRangeEnd](../editablerangeend/) с тем же Id.
...
Используйте класс [EditableRange](./get_editablerange/) как "фасад" для работы с редактируемым диапазоном как с единым объектом.


В настоящее время редактируемые диапазоны поддерживаются только на уровне встроенного текста, то есть внутри [Paragraph](../paragraph/), но начало и конец редактируемого диапазона могут находиться в разных абзацах.
