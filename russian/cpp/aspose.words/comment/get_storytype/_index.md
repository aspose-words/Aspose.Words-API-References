---
title: "Метод Aspose::Words::Comment::get_StoryType"
linktitle: "get_StoryType"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Comment::get_StoryType. Возвращает Comments в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words/comment/get_storytype/
---
## Comment::get_StoryType method


Возвращает [Comments](../../storytype/).
...
Показывает, как вставить узлы [InlineStory](../../inlinestory/).
```cpp
