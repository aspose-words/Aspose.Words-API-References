---
title: "Метод Aspose::Words::Comment::RemoveReply"
linktitle: "RemoveReply"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Comment::RemoveReply. Удаляет указанный ответ к этому комментарию в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words/comment/removereply/
---
...
| --- | --- | --- |
| ответ | const System::SharedPtr\<Aspose::Words::Comment\>\& | Узел комментария удаляемого ответа. |
