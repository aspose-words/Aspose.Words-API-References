---
title: "Aspose::Words::TableStyle::get_Shading метод"
linktitle: "get_Shading"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::TableStyle::get_Shading метод. Возвращает объект Shading, который относится к форматированию затенения ячеек таблицы в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words/tablestyle/get_shading/
---
## TableStyle::get_Shading method


Возвращает объект [Shading](../../shading/), который относится к форматированию затенения ячеек таблицы.
