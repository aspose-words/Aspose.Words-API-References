---
title: "Aspose::Words::TableStyle::get_RowStripe метод"
linktitle: "get_RowStripe"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::TableStyle::get_RowStripe метод. Получает или задает количество строк, включаемых в полосы, когда стиль указывает чередование нечётных/чётных строк в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words/tablestyle/get_rowstripe/
---
## TableStyle::get_RowStripe method


Получает или задает количество строк, включаемых в чередование, когда стиль указывает чередование нечётных/чётных строк.
