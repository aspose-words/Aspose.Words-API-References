---
title: "Метод Aspose::Words::TableStyle::get_ConditionalStyles"
linktitle: "get_ConditionalStyles"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::TableStyle::get_ConditionalStyles метод. Коллекция условных стилей, которые могут быть определены для этого стиля таблицы в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/tablestyle/get_conditionalstyles/
---
