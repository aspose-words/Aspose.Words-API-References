---
title: "Метод Aspose::Words::TabStopCollection::idx_get"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TabStopCollection::idx_get. Получает табуляцию в указанной позиции в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words/tabstopcollection/idx_get/
---
## TabStopCollection::idx_get(double) method


Получает табуляцию по указанной позиции.
...
Получает табуляцию по заданному индексу.
