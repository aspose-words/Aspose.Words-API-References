---
title: "Aspose::Words::TabStopCollection::Before метод"
linktitle: "Перед"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::TabStopCollection::Before метод. Получает первую табуляцию слева от указанной позиции в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/tabstopcollection/before/
---
...
Объект табуляции или **null**, если подходящая табуляция не найдена.
## Примечания


Пропускает табуляции с [Alignment](../../tabstop/get_alignment/) установленным в [Bar](../../tabalignment/).
