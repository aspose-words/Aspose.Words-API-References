---
title: "Метод Aspose::Words::TabStopCollection::Equals"
linktitle: "Equals"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TabStopCollection::Equals. Определяет, равна ли указанная TabStopCollection по значению текущей TabStopCollection в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/tabstopcollection/equals/
---
## TabStopCollection::Equals(const System::SharedPtr\<Aspose::Words::TabStopCollection\>\&) method


Определяет, равна ли указанная [TabStopCollection](../) по значению текущей [TabStopCollection](../).
