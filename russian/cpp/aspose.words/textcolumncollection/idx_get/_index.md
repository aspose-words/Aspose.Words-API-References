---
title: "Метод Aspose::Words::TextColumnCollection::idx_get"
linktitle: "idx_get"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TextColumnCollection::idx_get. Возвращает текстовую колонку по указанному индексу в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words/textcolumncollection/idx_get/
---
## TextColumnCollection::idx_get method


Возвращает колонку текста по указанному индексу.
