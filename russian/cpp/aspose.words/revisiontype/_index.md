...
description: "Aspose::Words::RevisionType enum. Указывает тип изменения, отслеживаемого в Revision в C++."
type: docs
weight: 113000
url: /ru/cpp/aspose.words/revisiontype/
---
## RevisionType enum


Указывает тип изменения, отслеживаемого в [Revision](../revision/).
...
| --- | --- | --- |
| Вставка | 0 | Новый контент был вставлен в документ. |
| Удаление | 1 | Контент был удалён из документа. |
...
| Перемещение | 4 | Содержимое было перемещено в документе. |
