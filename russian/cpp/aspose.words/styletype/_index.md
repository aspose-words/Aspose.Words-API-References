---
title: "Aspose::Words::StyleType перечисление"
linktitle: "StyleType"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::StyleType enum. Представляет тип стиля в C++."
type: docs
weight: 119000
url: /ru/cpp/aspose.words/styletype/
---
## StyleType enum
...
| --- | --- | --- |
| Paragraph | 1 | Стиль является абзацным стилем. |
| Character | 2 | Стиль является символьным стилем. |
| Table | 3 | Стиль является табличным стилем. |
| Список | 4 | Стиль является списковым стилем. |
