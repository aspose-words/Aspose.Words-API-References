---
title: "Метод Aspose::Words::SignatureLineOptions::get_ShowDate"
linktitle: "get_ShowDate"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::SignatureLineOptions::get_ShowDate. Получает или задает значение, указывающее, что дата подписи отображается в строке подписи. Значение по умолчанию для этого свойства — true в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words/signaturelineoptions/get_showdate/
---
