---
title: "Aspose::Words::SignatureLineOptions::get_Instructions метод"
linktitle: "get_Instructions"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::SignatureLineOptions::get_Instructions. Получает или задает инструкции подписанту, которые отображаются при подписании строки подписи. Значение по умолчанию для этого свойства — пустая строка в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


Получает или задает инструкции подписанту, которые отображаются при подписании строки подписи. Значение по умолчанию для этого свойства — **empty string**.
