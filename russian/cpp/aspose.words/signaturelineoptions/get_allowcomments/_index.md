---
title: "Aspose::Words::SignatureLineOptions::get_AllowComments метод"
linktitle: "get_AllowComments"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::SignatureLineOptions::get_AllowComments. Получает или задает значение, указывающее, что подписант может добавлять комментарии в диалоговом окне подписи. Значение по умолчанию для этого свойства — false в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words/signaturelineoptions/get_allowcomments/
---
