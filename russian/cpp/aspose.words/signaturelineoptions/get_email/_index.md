---
title: "Метод Aspose::Words::SignatureLineOptions::get_Email"
linktitle: "get_Email"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::SignatureLineOptions::get_Email. Получает или задает предложенный адрес электронной почты подписанта. Значение по умолчанию для этого свойства — пустая строка в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/signaturelineoptions/get_email/
---
## SignatureLineOptions::get_Email method


Получает или задает предложенный адрес электронной почты подписанта. Значение по умолчанию для этого свойства — **empty string**.
