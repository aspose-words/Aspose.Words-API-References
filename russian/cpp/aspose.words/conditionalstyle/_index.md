...
description: "Класс Aspose::Words::ConditionalStyle. Представляет специальное форматирование, применяемое к некоторой области таблицы с назначенным стилем таблицы. Чтобы узнать больше, посетите статью документации на C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words/conditionalstyle/
---
## ConditionalStyle class


Представляет специальное форматирование, применяемое к некоторой области таблицы с назначенным стилем таблицы. Чтобы узнать больше, посетите статью документации [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [Equals](./equals/)(System::SharedPtr\<System::Object\>) override | Сравнивает этот условный стиль с указанным объектом. |
| [get_Borders](./get_borders/)() | Возвращает коллекцию границ ячеек по умолчанию для условного стиля. |
...
| [get_Font](./get_font/)() | Получает форматирование символов условного стиля. |
...
| [get_ParagraphFormat](./get_paragraphformat/)() | Получает форматирование абзаца условного стиля. |
...
| [get_Shading](./get_shading/)() | Возвращает объект [Shading](../shading/), который относится к форматированию затенения для этого условного стиля. |
...
| [get_Type](./get_type/)() | Возвращает область таблицы, к которой относится этот условный стиль. |
| [GetHashCode](./gethashcode/)() const override | Вычисляет хеш-код для этого объекта. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BottomPadding](./set_bottompadding/)(double) | Сеттер для [Aspose::Words::ConditionalStyle::get_BottomPadding](./get_bottompadding/). |
| [set_LeftPadding](./set_leftpadding/)(double) | Сеттер для [Aspose::Words::ConditionalStyle::get_LeftPadding](./get_leftpadding/). |
| [set_RightPadding](./set_rightpadding/)(double) | Сеттер для [Aspose::Words::ConditionalStyle::get_RightPadding](./get_rightpadding/). |
| [set_TopPadding](./set_toppadding/)(double) | Сеттер для [Aspose::Words::ConditionalStyle::get_TopPadding](./get_toppadding/). |
| static [Type](./type/)() |  |
