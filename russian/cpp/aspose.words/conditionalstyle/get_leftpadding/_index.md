---
title: "Метод Aspose::Words::ConditionalStyle::get_LeftPadding"
linktitle: "get_LeftPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_LeftPadding. Получает или задает количество пространства (в пунктах), добавляемого слева от содержимого ячеек таблицы в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words/conditionalstyle/get_leftpadding/
---
## ConditionalStyle::get_LeftPadding method


Получает или задает количество пространства (в пунктах), добавляемого слева от содержимого ячеек таблицы.
