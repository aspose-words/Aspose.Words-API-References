---
title: "Метод Aspose::Words::ConditionalStyle::get_Type"
linktitle: "get_Type"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_Type. Возвращает область таблицы, к которой относится данный условный стиль, в C++."
type: docs
weight: 12000
url: /ru/cpp/aspose.words/conditionalstyle/get_type/
---
## ConditionalStyle::get_Type method


Возвращает область таблицы, к которой относится этот условный стиль.
