---
title: "Метод Aspose::Words::ConditionalStyle::get_TopPadding"
linktitle: "get_TopPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_TopPadding. Получает или задает количество пространства (в пунктах), добавляемого над содержимым ячеек таблицы в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words/conditionalstyle/get_toppadding/
---
