---
title: "Метод Aspose::Words::ConditionalStyle::get_RightPadding"
linktitle: "get_RightPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_RightPadding. Получает или задает количество пространства (в пунктах), добавляемого справа от содержимого ячеек таблицы в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/conditionalstyle/get_rightpadding/
---
