---
title: "Метод Aspose::Words::ConditionalStyle::get_BottomPadding"
linktitle: "get_BottomPadding"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_BottomPadding. Получает или задает количество пространства (в пунктах), добавляемого под содержимое ячеек таблицы в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/conditionalstyle/get_bottompadding/
---
## ConditionalStyle::get_BottomPadding method


Получает или задает количество пространства (в пунктах), добавляемого под содержимым ячеек таблицы.
