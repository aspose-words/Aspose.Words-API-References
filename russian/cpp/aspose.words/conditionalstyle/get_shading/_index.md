---
title: "Метод Aspose::Words::ConditionalStyle::get_Shading"
linktitle: "get_Shading"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::ConditionalStyle::get_Shading. Получает объект Shading, который относится к форматированию затенения для этого условного стиля в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words/conditionalstyle/get_shading/
---
## ConditionalStyle::get_Shading method


Получает объект [Shading](../../shading/), который относится к форматированию затенения для этого условного стиля.
