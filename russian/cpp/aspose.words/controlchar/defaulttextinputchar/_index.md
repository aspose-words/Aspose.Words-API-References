---
title: "Aspose::Words::ControlChar::DefaultTextInputChar поле"
linktitle: "DefaultTextInputChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::DefaultTextInputChar поле. Это символ \"o\", используемый в качестве значения по умолчанию в полях ввода текста в формах в C++."
type: docs
weight: 16000
url: /ru/cpp/aspose.words/controlchar/defaulttextinputchar/
---
## DefaultTextInputChar field


Это символ "o", используемый в качестве значения по умолчанию в полях ввода текста формы.
