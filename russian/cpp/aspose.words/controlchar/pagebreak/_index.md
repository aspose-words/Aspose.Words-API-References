---
title: "Aspose::Words::ControlChar::PageBreak метод"
linktitle: "PageBreak"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::PageBreak метод. Символ разрыва страницы: \"\\x000c\" или \"\\f\". Обратите внимание, что он имеет то же значение, что и SectionBreak в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/controlchar/pagebreak/
---
## ControlChar::PageBreak method


Символ разрыва страницы: "\x000c" или "\f". Обратите внимание, что он имеет то же значение, что и [SectionBreak](../sectionbreak/).
