---
title: "Aspose::Words::ControlChar::FieldSeparatorChar поле"
linktitle: "FieldSeparatorChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::FieldSeparatorChar поле. Символ‑разделитель полей разделяет код поля и значение поля. Необязательно в некоторых полях. Значение: (char)20 в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words/controlchar/fieldseparatorchar/
---
## FieldSeparatorChar field


Символ-разделитель поля разделяет код поля и значение поля. Необязательно в некоторых полях. Значение: (char)20.
