---
title: "Aspose::Words::ControlChar::CrLf метод"
linktitle: "CrLf"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::CrLf метод. Символ возврата каретки, за которым следует перевод строки: \"\\x000d\\x000a\" или \"\\r\\n\". Не используется таким образом в документах Microsoft Word, но часто применяется в текстовых файлах для разрывов абзацев в C++."
type: docs
weight: 4000
url: /ru/cpp/aspose.words/controlchar/crlf/
---
## ControlChar::CrLf method


Символ возврата каретки, за которым следует перевод строки: "\x000d\x000a" или "\r\n". Не используется так в документах Microsoft Word, но часто применяется в текстовых файлах для разрывов абзацев.
