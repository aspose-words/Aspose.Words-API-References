---
title: "Aspose::Words::ControlChar::NonBreakingHyphenChar поле"
linktitle: "NonBreakingHyphenChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::NonBreakingHyphenChar поле. Неразрывный дефис в Microsoft Word имеет значение (char)30 в C++."
type: docs
weight: 22000
url: /ru/cpp/aspose.words/controlchar/nonbreakinghyphenchar/
---
## NonBreakingHyphenChar field


Неразрывный дефис в Microsoft Word имеет код (char)30.
...
Неразрывный дефис в Microsoft Word не соответствует символу Unicode U+2011 (неразрывный дефис), а представляет собой внутреннюю информацию, указывающую Microsoft Word отображать дефис и не разрывать строку.

Полезная информация: [http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks](http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks).
