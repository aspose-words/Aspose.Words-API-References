---
title: "Aspose::Words::ControlChar::OptionalHyphenChar поле"
linktitle: "OptionalHyphenChar"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ControlChar::OptionalHyphenChar поле. Необязательный дефис в Microsoft Word имеет значение (char)31 в C++."
type: docs
weight: 24000
url: /ru/cpp/aspose.words/controlchar/optionalhyphenchar/
---
## OptionalHyphenChar field


Опциональный дефис в Microsoft Word имеет код (char)31.
...
Необязательный дефис в Microsoft Word не соответствует Unicode‑символу U+00AD мягкий дефис. Вместо этого он вставляет внутреннюю информацию, которая сообщает Word о возможной точке переноса.
