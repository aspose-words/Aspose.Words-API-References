---
title: "Метод Aspose::Words::TextColumn::get_SpaceAfter"
linktitle: "get_SpaceAfter"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::TextColumn::get_SpaceAfter. Получает или задаёт расстояние между этой колонкой и следующей колонкой в пунктах. Не требуется для последней колонки в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/textcolumn/get_spaceafter/
---
## TextColumn::get_SpaceAfter method


Получает или задает расстояние между этой колонкой и следующей колонкой в пунктах. Не требуется для последней колонки.
