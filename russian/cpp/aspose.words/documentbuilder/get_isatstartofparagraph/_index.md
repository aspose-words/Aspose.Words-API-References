...
description: "Метод Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph. Возвращает true, если курсор находится в начале текущего абзаца (нет текста перед курсором) в C++."
type: docs
weight: 20000
url: /ru/cpp/aspose.words/documentbuilder/get_isatstartofparagraph/
---
## DocumentBuilder::get_IsAtStartOfParagraph method


Возвращает **true**, если курсор находится в начале текущего абзаца (текст перед курсором отсутствует).
