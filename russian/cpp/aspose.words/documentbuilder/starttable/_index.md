---
title: "Aspose::Words::DocumentBuilder::StartTable метод"
linktitle: "StartTable"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DocumentBuilder::StartTable метод. Начинает таблицу в документе в C++."
type: docs
weight: 71000
url: /ru/cpp/aspose.words/documentbuilder/starttable/
---
...
Узел таблицы, который только что был создан.
## Примечания


Следующий вызываемый метод — [InsertCell](../insertcell/).
