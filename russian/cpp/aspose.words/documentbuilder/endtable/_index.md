---
title: "Aspose::Words::DocumentBuilder::EndTable метод"
linktitle: "EndTable"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DocumentBuilder::EndTable метод. Завершает таблицу в документе на C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words/documentbuilder/endtable/
---
...
Узел таблицы, который только что завершён.
## Примечания


Этот метод следует вызывать только один раз после вызова [EndRow](../endrow/). При вызове [EndTable](./) перемещает курсор из текущей ячейки к позиции сразу после таблицы.
