---
title: "Aspose::Words::DocumentBuilder::get_ParagraphFormat метод"
linktitle: "get_ParagraphFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::DocumentBuilder::get_ParagraphFormat метод. Возвращает объект, представляющий текущие свойства форматирования абзаца в C++."
type: docs
weight: 24000
url: /ru/cpp/aspose.words/documentbuilder/get_paragraphformat/
---
