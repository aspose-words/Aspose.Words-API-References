---
title: "Aspose::Words::ParagraphFormat::get_StyleName метод"
linktitle: "get_StyleName"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ParagraphFormat::get_StyleName метод. Получает или задает имя стиля абзаца, применяемого к этому форматированию в C++."
type: docs
weight: 37000
url: /ru/cpp/aspose.words/paragraphformat/get_stylename/
---
## ParagraphFormat::get_StyleName method


Получает или задает имя стиля абзаца, применяемого к этому форматированию.
