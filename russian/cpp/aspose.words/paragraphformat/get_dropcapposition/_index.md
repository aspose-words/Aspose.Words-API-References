---
title: "Aspose::Words::ParagraphFormat::get_DropCapPosition метод"
linktitle: "get_DropCapPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ParagraphFormat::get_DropCapPosition method. Получает или задает позицию текста с большой первой буквой в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words/paragraphformat/get_dropcapposition/
---
## ParagraphFormat::get_DropCapPosition method


Получает или задает позицию текста с броской буквой.
