---
title: "Aspose::Words::ParagraphFormat::get_SpaceAfter метод"
linktitle: "get_SpaceAfter"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::ParagraphFormat::get_SpaceAfter метод. Получает или задает величину интервала (в пунктах) после абзаца в C++."
type: docs
weight: 31000
url: /ru/cpp/aspose.words/paragraphformat/get_spaceafter/
---
...
Не оказывает влияния, когда [SpaceAfterAuto](../get_spaceafterauto/) **true**.
