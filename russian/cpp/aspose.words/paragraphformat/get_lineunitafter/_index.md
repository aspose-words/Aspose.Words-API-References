...
description: "Aspose::Words::ParagraphFormat::get_LineUnitAfter method. Получает или задает величину отступа (в сеточных линиях) после абзацев в C++."
type: docs
weight: 23000
url: /ru/cpp/aspose.words/paragraphformat/get_lineunitafter/
---
## ParagraphFormat::get_LineUnitAfter method


Получает или задает величину интервала (в сеточных линиях) после абзацев.
