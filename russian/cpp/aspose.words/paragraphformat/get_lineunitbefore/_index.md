...
description: "Aspose::Words::ParagraphFormat::get_LineUnitBefore method. Получает или задает величину отступа (в сеточных линиях) перед абзацами в C++."
type: docs
weight: 24000
url: /ru/cpp/aspose.words/paragraphformat/get_lineunitbefore/
---
## ParagraphFormat::get_LineUnitBefore method


Получает или задает величину интервала (в сеточных линиях) перед абзацами.
