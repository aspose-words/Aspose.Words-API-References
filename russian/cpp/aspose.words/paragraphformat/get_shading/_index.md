...
description: "Aspose::Words::ParagraphFormat::get_Shading method. Возвращает объект Shading, который относится к форматированию затенения абзаца в C++."
type: docs
weight: 29000
url: /ru/cpp/aspose.words/paragraphformat/get_shading/
---
## ParagraphFormat::get_Shading method


Возвращает объект [Shading](../../shading/), который относится к форматированию затенения абзаца.
