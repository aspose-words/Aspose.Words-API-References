---
title: "Aspose::Words::Body::Body конструктор"
linktitle: "Body"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Body::Body конструктор. Инициализирует новый экземпляр класса Body в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/body/body/
---
...
Когда создаётся [Body](../), он принадлежит указанному документу, но ещё не является частью документа, и [ParentNode](../../node/get_parentnode/) имеет значение **null**.

Чтобы добавить [Body](../) к [Section](../../section/), используйте методы [AppendChild](../)[InsertAfter](../) или [InsertBefore](../).
