---
title: "Метод Aspose::Words::Range::get_StructuredDocumentTags"
linktitle: "get_StructuredDocumentTags"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Range::get_StructuredDocumentTags. Возвращает коллекцию StructuredDocumentTags, представляющую все структурированные теги документа в диапазоне в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words/range/get_structureddocumenttags/
---
## Range::get_StructuredDocumentTags method


Возвращает коллекцию [StructuredDocumentTags](./), представляющую все структурированные теги документа в диапазоне.
