---
title: "Метод Aspose::Words::BookmarkCollection::RemoveAt"
linktitle: "RemoveAt"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::BookmarkCollection::RemoveAt. Удаляет закладку по указанному индексу в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words/bookmarkcollection/removeat/
---
...
| --- | --- | --- |
| index | int32_t | Индекс закладки, которую нужно удалить, нумерация начинается с нуля. |
