---
title: "Aspose::Words::FileFormatUtil::ImageTypeToExtension метод"
linktitle: "ImageTypeToExtension"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::FileFormatUtil::ImageTypeToExtension метод. Преобразует перечисленное значение типа изображения Aspose.Words в расширение файла. Возвращаемое расширение — строка в нижнем регистре с ведущей точкой в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words/fileformatutil/imagetypetoextension/
---
## FileFormatUtil::ImageTypeToExtension method


Преобразует перечисляемое значение типа изображения Aspose.Words в расширение файла. Возвращаемое расширение — строка в нижнем регистре с ведущей точкой.
