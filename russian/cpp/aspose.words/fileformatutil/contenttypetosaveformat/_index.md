---
title: "Метод Aspose::Words::FileFormatUtil::ContentTypeToSaveFormat"
linktitle: "ContentTypeToSaveFormat"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::FileFormatUtil::ContentTypeToSaveFormat. Преобразует тип контента IANA в перечислимое значение формата сохранения в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words/fileformatutil/contenttypetosaveformat/
---
