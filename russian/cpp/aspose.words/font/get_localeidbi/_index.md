---
title: "Метод Aspose::Words::Font::get_LocaleIdBi"
linktitle: "get_LocaleIdBi"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_LocaleIdBi. Получает или задаёт идентификатор локали (язык) отформатированных символов справа налево в C++."
type: docs
weight: 23000
url: /ru/cpp/aspose.words/font/get_localeidbi/
---
## Font::get_LocaleIdBi method


Получает или задаёт идентификатор локали (язык) отформатированных символов справа налево.
