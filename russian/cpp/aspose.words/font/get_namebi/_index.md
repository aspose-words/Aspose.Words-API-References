---
title: "Метод Aspose::Words::Font::get_NameBi"
linktitle: "get_NameBi"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_NameBi. Возвращает или задает имя шрифта в документе на языке с написанием справа налево в C++."
type: docs
weight: 27000
url: /ru/cpp/aspose.words/font/get_namebi/
---
## Font::get_NameBi method


Возвращает или задаёт название шрифта в документе на языке с направлением справа налево.
