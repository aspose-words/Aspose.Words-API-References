---
title: "Метод Aspose::Words::Font::get_ThemeFont"
linktitle: "get_ThemeFont"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_ThemeFont. Получает или задает шрифт темы в применяемой схеме шрифтов, связанной с этим объектом Font в C++."
type: docs
weight: 49000
url: /ru/cpp/aspose.words/font/get_themefont/
---
