---
title: "Aspose::Words::Font::get_SizeBi метод"
linktitle: "get_SizeBi"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Font::get_SizeBi метод. Получает или задает размер шрифта в пунктах, используемый в документе с направлением справа налево, в C++."
type: docs
weight: 37000
url: /ru/cpp/aspose.words/font/get_sizebi/
---
## Font::get_SizeBi method


Получает или задает размер шрифта в пунктах, используемый в документе с направлением справа налево.
