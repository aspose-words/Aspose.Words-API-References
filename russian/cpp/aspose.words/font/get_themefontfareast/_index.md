---
title: "Aspose::Words::Font::get_ThemeFontFarEast метод"
linktitle: "get_ThemeFontFarEast"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Font::get_ThemeFontFarEast метод. Получает или задает шрифт восточноазиатской темы в применённой схеме шрифтов, связанной с этим объектом Font в C++."
type: docs
weight: 52000
url: /ru/cpp/aspose.words/font/get_themefontfareast/
---
## Font::get_ThemeFontFarEast method


Получает или задает шрифт восточноазиатской темы в применённой схеме шрифтов, связанной с этим объектом [Font](../) объектом.
