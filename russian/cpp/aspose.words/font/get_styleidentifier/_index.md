---
title: "Метод Aspose::Words::Font::get_StyleIdentifier"
linktitle: "get_StyleIdentifier"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_StyleIdentifier. Получает или задает независимый от локали идентификатор стиля символов, применяемый к этому форматированию в C++."
type: docs
weight: 43000
url: /ru/cpp/aspose.words/font/get_styleidentifier/
---
## Font::get_StyleIdentifier method


Получает или задает независимый от локали идентификатор стиля символов, применяемый к этому форматированию.
