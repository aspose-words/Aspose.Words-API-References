---
title: "Метод Aspose::Words::Font::get_Fill"
linktitle: "get_Fill"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_Fill. Получает параметры заливки для Font в C++."
type: docs
weight: 15000
url: /ru/cpp/aspose.words/font/get_fill/
---
## Font::get_Fill method


Получает параметры заливки для [Font](../).
