---
title: "Aspose::Words::Font::get_ThemeFontBi метод"
linktitle: "get_ThemeFontBi"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Font::get_ThemeFontBi метод. Получает или задает шрифт темы в применяемой схеме шрифтов, связанной с этим объектом Font в документе с языком справа налево в C++."
type: docs
weight: 51000
url: /ru/cpp/aspose.words/font/get_themefontbi/
---
## Font::get_ThemeFontBi method


Получает или задает шрифт темы в применяемой схеме шрифтов, связанной с этим объектом [Font](../) в документе с языком справа налево.
