---
title: "Метод Aspose::Words::Font::get_BoldBi"
linktitle: "get_BoldBi"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Font::get_BoldBi. Истина, если текст справа налево отформатирован полужирным в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words/font/get_boldbi/
---
## Font::get_BoldBi method


Истина, если текст справа налево отформатирован полужирным.
