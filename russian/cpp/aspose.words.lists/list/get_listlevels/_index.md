---
title: "Aspose::Words::Lists::List::get_ListLevels метод"
linktitle: "get_ListLevels"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::List::get_ListLevels метод. Получает коллекцию уровней списка для этого списка в C++."
type: docs
weight: 10000
url: /ru/cpp/aspose.words.lists/list/get_listlevels/
---
## List::get_ListLevels method


Получает коллекцию уровней списка для данного списка.
...
Используйте это свойство для доступа и изменения форматирования, индивидуального для каждого уровня списка.
