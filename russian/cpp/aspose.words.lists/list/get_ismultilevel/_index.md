---
title: "Aspose::Words::Lists::List::get_IsMultiLevel метод"
linktitle: "get_IsMultiLevel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::List::get_IsMultiLevel метод. Возвращает true, когда список содержит 9 уровней; false, когда 1 уровень в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.lists/list/get_ismultilevel/
---
## List::get_IsMultiLevel method


Возвращает **true**, когда список содержит 9 уровней; **false**, когда 1 уровень.
...
Списки, которые вы создаёте с помощью Aspose.Words, всегда являются многоуровневыми и содержат 9 уровней.

Microsoft Word 2003 и более поздние версии всегда создают многоуровневые списки с 9 уровнями. Но в некоторых документах, созданных более ранними версиями Microsoft Word, вы можете встретить списки, содержащие только 1 уровень.
