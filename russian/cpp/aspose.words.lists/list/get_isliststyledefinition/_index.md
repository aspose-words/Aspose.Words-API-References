---
title: "Aspose::Words::Lists::List::get_IsListStyleDefinition метод"
linktitle: "get_IsListStyleDefinition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition метод. Возвращает true, если этот список является определением стиля списка в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
...
Когда это свойство имеет значение **true**, свойство [Style](../get_style/) возвращает стиль списка, который определяет этот список.

Изменяя свойства списка, определяющего стиль списка, вы изменяете свойства самого стиля списка.

Список, являющийся определением стиля списка, нельзя применять напрямую к абзацам, чтобы пронумеровать их.
