---
title: "Aspose::Words::Lists::List::get_ListId метод"
linktitle: "get_ListId"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::List::get_ListId метод. Получает уникальный идентификатор списка в C++."
type: docs
weight: 9000
url: /ru/cpp/aspose.words.lists/list/get_listid/
---
...
Обычно вам не требуется использовать это свойство. Но если вы используете его, обычно это делается в сочетании с методом [GetListByListId()](../../listcollection/getlistbylistid/) для поиска списка по его идентификатору.
