---
title: "Метод Aspose::Words::Lists::ListFormat::ApplyNumberDefault"
linktitle: "ApplyNumberDefault"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Lists::ListFormat::ApplyNumberDefault. Запускает новый список с нумерацией по умолчанию и применяет его к абзацу в C++."
type: docs
weight: 3000
url: /ru/cpp/aspose.words.lists/listformat/applynumberdefault/
---
## ListFormat::ApplyNumberDefault method


Начинает новый список с нумерацией по умолчанию и применяет его к абзацу.
...
Это метод‑ярлык, который создает новый список, используя шаблон нумерации по умолчанию, применяет его к абзацу и выбирает первый уровень списка.
