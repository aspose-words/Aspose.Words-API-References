---
title: "Aspose::Words::Lists::ListFormat::get_ListLevel метод"
linktitle: "get_ListLevel"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListFormat::get_ListLevel method. Возвращает форматирование уровня списка плюс любые переопределения форматирования, применённые к текущему абзацу в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.lists/listformat/get_listlevel/
---
## ListFormat::get_ListLevel method


Возвращает форматирование уровня списка плюс любые переопределения форматирования, применённые к текущему абзацу.
