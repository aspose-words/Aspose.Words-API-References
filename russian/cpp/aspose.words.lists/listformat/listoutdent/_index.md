...
description: "Aspose::Words::Lists::ListFormat::ListOutdent method. Уменьшает уровень списка текущего абзаца на один уровень в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.lists/listformat/listoutdent/
---
...
В документах Word списки могут состоять до девяти уровней. Форматирование [List](../../list/) для каждого уровня указывает, какой маркер или номер используется, левый отступ, расстояние между маркером и текстом и т.д.
