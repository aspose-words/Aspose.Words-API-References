---
title: "Метод Aspose::Words::Lists::ListFormat::ApplyBulletDefault"
linktitle: "ApplyBulletDefault"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Lists::ListFormat::ApplyBulletDefault. Запускает новый список с маркерами по умолчанию и применяет его к абзацу в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.lists/listformat/applybulletdefault/
---
## ListFormat::ApplyBulletDefault method


Создаёт новый стандартный маркированный список и применяет его к абзацу.
...
Это метод‑сокращение, который создает новый список, используя шаблон маркеров по умолчанию, применяет его к абзацу и выбирает первый уровень списка.
