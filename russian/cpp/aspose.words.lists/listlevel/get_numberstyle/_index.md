---
title: "Aspose::Words::Lists::ListLevel::get_NumberStyle метод"
linktitle: "get_NumberStyle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_NumberStyle метод. Возвращает или задает стиль нумерации для этого уровня списка в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.lists/listlevel/get_numberstyle/
---
