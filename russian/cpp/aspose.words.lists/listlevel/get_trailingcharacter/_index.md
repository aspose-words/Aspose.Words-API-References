---
title: "Метод Aspose::Words::Lists::ListLevel::get_TrailingCharacter"
linktitle: "get_TrailingCharacter"
second_title: "Справочник API Aspose.Words для C++"
description: "Метод Aspose::Words::Lists::ListLevel::get_TrailingCharacter. Возвращает или задает символ, вставляемый после номера уровня списка в C++."
type: docs
weight: 19000
url: /ru/cpp/aspose.words.lists/listlevel/get_trailingcharacter/
---
## ListLevel::get_TrailingCharacter method


Возвращает или задает символ, вставляемый после номера для уровня списка.
