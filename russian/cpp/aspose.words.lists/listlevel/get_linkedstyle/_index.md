---
title: "Aspose::Words::Lists::ListLevel::get_LinkedStyle метод"
linktitle: "get_LinkedStyle"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_LinkedStyle метод. Получает или задает стиль абзаца, связанный с этим уровнем списка в C++."
type: docs
weight: 11000
url: /ru/cpp/aspose.words.lists/listlevel/get_linkedstyle/
---
## ListLevel::get_LinkedStyle method


Получает или задает стиль абзаца, связанный с этим уровнем списка.
...
Это свойство **null**, когда уровень списка не связан со стилем абзаца. Это свойство можно установить в **null**.
