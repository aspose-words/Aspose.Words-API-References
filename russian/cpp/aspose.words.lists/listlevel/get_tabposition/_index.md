---
title: "Aspose::Words::Lists::ListLevel::get_TabPosition метод"
linktitle: "get_TabPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_TabPosition метод. Возвращает или задает позицию табуляции (в пунктах) для уровня списка в C++."
type: docs
weight: 17000
url: /ru/cpp/aspose.words.lists/listlevel/get_tabposition/
---
...
Имеет эффект только когда [TrailingCharacter](../get_trailingcharacter/) является табуляцией.
