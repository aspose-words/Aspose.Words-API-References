---
title: "Aspose::Words::Lists::ListLevel::get_TextPosition метод"
linktitle: "get_TextPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_TextPosition метод. Возвращает или задает позицию (в пунктах) для второй строки переносимого текста уровня списка в C++."
type: docs
weight: 18000
url: /ru/cpp/aspose.words.lists/listlevel/get_textposition/
---
## ListLevel::get_TextPosition method


Возвращает или задает позицию (в пунктах) второй строки перенесённого текста для уровня списка.
