---
title: "Aspose::Words::Lists::ListLevel::get_Alignment метод"
linktitle: "get_Alignment"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_Alignment метод. Получает или задает выравнивание фактического номера элемента списка в C++."
type: docs
weight: 6000
url: /ru/cpp/aspose.words.lists/listlevel/get_alignment/
---
...
Метка списка выравнивается относительно свойства [NumberPosition](../get_numberposition/).
