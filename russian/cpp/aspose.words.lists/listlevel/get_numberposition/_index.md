---
title: "Aspose::Words::Lists::ListLevel::get_NumberPosition метод"
linktitle: "get_NumberPosition"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Lists::ListLevel::get_NumberPosition метод. Возвращает или задает позицию (в пунктах) номера или маркера для уровня списка в C++."
type: docs
weight: 13000
url: /ru/cpp/aspose.words.lists/listlevel/get_numberposition/
---
## ListLevel::get_NumberPosition method


Возвращает или задает позицию (в пунктах) номера или маркера для уровня списка.
