...
description: "Aspose::Words::Lists::ListLevelAlignment enum. Указывает выравнивание номера списка или маркера в C++."
type: docs
weight: 7000
url: /ru/cpp/aspose.words.lists/listlevelalignment/
---
## ListLevelAlignment enum


Указывает выравнивание номера списка или маркера.
...
| --- | --- | --- |
| Слева | 0 | Метка списка выровнена слева от позиции номера. |
| По центру | 1 | Метка списка центрирована в позиции номера. |
| Справа | 2 | Эта метка списка выровнена справа от позиции номера. |

## Примечания


Используется в качестве значения для свойства [Alignment](../listlevel/get_alignment/).
