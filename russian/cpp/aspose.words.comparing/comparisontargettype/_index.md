...
description: "Aspose::Words::Comparing::ComparisonTargetType enum. Позволяет указать базовый документ, который будет использоваться при сравнении. Значение по умолчанию — Current в C++."
type: docs
weight: 2000
url: /ru/cpp/aspose.words.comparing/comparisontargettype/
---
...
| --- | --- | --- |
| Текущие | 0 | Этот документ используется в качестве базы при сравнении. |
| Новый | 1 | Другой документ используется в качестве базы при сравнении. |
