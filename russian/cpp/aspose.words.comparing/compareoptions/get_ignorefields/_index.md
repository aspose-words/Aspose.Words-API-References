---
title: "Aspose::Words::Comparing::CompareOptions::get_IgnoreFields метод"
linktitle: "get_IgnoreFields"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Comparing::CompareOptions::get_IgnoreFields метод. Указывает, следует ли сравнивать различия в полях в C++."
type: docs
weight: 8000
url: /ru/cpp/aspose.words.comparing/compareoptions/get_ignorefields/
---
