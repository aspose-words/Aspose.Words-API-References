---
title: "Aspose::Words::Comparing::CompareOptions::get_Target метод"
linktitle: "get_Target"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Comparing::CompareOptions::get_Target метод. Указывает, какой документ будет использоваться в качестве цели при сравнении в C++."
type: docs
weight: 14000
url: /ru/cpp/aspose.words.comparing/compareoptions/get_target/
---
## CompareOptions::get_Target method


Указывает, какой документ будет использоваться в качестве цели во время сравнения.
