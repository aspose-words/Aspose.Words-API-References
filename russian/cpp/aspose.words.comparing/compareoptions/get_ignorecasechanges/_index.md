---
title: "Aspose::Words::Comparing::CompareOptions::get_IgnoreCaseChanges метод"
linktitle: "get_IgnoreCaseChanges"
second_title: "Справочник API Aspose.Words для C++"
description: "Aspose::Words::Comparing::CompareOptions::get_IgnoreCaseChanges метод. Значение true указывает, что сравнение документов нечувствительно к регистру в C++."
type: docs
weight: 5000
url: /ru/cpp/aspose.words.comparing/compareoptions/get_ignorecasechanges/
---
## CompareOptions::get_IgnoreCaseChanges method


True указывает, что сравнение документов не учитывает регистр.
