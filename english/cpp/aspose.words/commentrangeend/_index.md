...
description: 'Aspose::Words::CommentRangeEnd class. Denotes the end of a region of text that has a comment associated with it. To learn more, visit the  documentation article in C++.'
type: docs
weight: 13000
...
Denotes the end of a region of text that has a comment associated with it. To learn more, visit the [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/) documentation article.
...
| [set_Id](./set_id/)(int32_t) | Specifies the identifier of the comment to which this region is linked to. |
