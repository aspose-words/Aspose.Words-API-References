...
description: 'Aspose::Words::Saving::RtfSaveOptions class. Can be used to specify additional options when saving a document into the Rtf format. To learn more, visit the  documentation article in C++.'
type: docs
weight: 28000
...
Can be used to specify additional options when saving a document into the [Rtf](../../aspose.words/saveformat/) format. To learn more, visit the [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) documentation article.
