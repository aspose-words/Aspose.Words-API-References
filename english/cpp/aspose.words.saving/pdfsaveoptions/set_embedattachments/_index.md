...
Setter for [Aspose::Words::Saving::PdfSaveOptions::get_EmbedAttachments](../get_embedattachments/).

```cpp
void Aspose::Words::Saving::PdfSaveOptions::set_EmbedAttachments(bool value)
```
