...
Setter for [Aspose::Words::Saving::MetafileRenderingOptions::get_UseGdiRasterOperationsEmulation](../get_usegdirasteroperationsemulation/).

```cpp
void Aspose::Words::Saving::MetafileRenderingOptions::set_UseGdiRasterOperationsEmulation(bool value)
```
