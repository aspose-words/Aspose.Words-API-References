...
| [get_KeepOriginalFontMetrics](./get_keeporiginalfontmetrics/)() const | Gets or sets an indication of whether the original font metrics should be used after font substitution. Default is **true**. |
...
| [set_KeepOriginalFontMetrics](./set_keeporiginalfontmetrics/)(bool) | Setter for [Aspose::Words::Layout::LayoutOptions::get_KeepOriginalFontMetrics](./get_keeporiginalfontmetrics/). |
