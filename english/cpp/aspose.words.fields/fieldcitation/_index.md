...
| Method | Description |
| --- | --- |
| [get_AnotherSourceTag](./get_anothersourcetag/)() | Gets or sets a value that matches the **Tag** element's value of another source to be included in the citation. |
...
| [get_SourceTag](./get_sourcetag/)() | Gets or sets a value that matches the **Tag** element's value of the source to insert. |
