...
description: 'Aspose::Words::Fields::FieldInfo class. Implements the INFO field. To learn more, visit the  documentation article in C++.'
type: docs
weight: 60000
...
Implements the INFO field. To learn more, visit the [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) documentation article.
