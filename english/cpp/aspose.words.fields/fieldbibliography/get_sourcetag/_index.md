...
description: 'Aspose::Words::Fields::FieldBibliography::get_SourceTag method. Gets or sets a value so that only the sources with matching Tag element value are displayed in the bibliography in C++.'
type: docs
weight: 2500
