...
description: 'Aspose::Words::WebExtensions::WebExtensionReferenceCollection class. Specifies a list of web extension references. To learn more, visit the  documentation article in C++.'
type: docs
weight: 10000
...
Specifies a list of web extension references. To learn more, visit the [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) documentation article.
