...
description: 'Aspose::Words::Properties::BuiltInDocumentProperties::get_ContentType method. Gets or sets the ContentType of the document in C++.'
type: docs
weight: 10000
...
Gets or sets the [ContentType](../) of the document.
