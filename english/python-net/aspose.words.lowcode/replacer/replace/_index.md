...
## replace(input_file_name, output_file_name, save_options, pattern, replacement) {#str_str_saveoptions_str_str}
...
## replace(input_stream, output_stream, save_options, pattern, replacement) {#bytesio_bytesio_saveoptions_str_str}
