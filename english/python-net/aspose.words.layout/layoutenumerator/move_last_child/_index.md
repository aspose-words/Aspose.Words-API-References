---
title: LayoutEnumerator.move_last_child method
linktitle: move_last_child method
articleTitle: move_last_child method
...
## move_last_child() {#default}

Moves to the last child entity.


```python
def move_last_child(self):
    ...
```
