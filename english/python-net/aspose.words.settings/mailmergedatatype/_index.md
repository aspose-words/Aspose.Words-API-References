...
| TEXT_FILE | Specifies that a given document has been connected to a text file via the Dynamic Data Exchange (DDE) system. |
...
* property [MailMergeSettings.data_type](../mailmergesettings/data_type/)
