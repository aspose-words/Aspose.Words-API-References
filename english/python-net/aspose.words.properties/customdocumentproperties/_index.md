...
| Name | Description |
| --- | --- |
|[ add(name, value)](./add/#str_str) | Creates a new custom document property of the [PropertyType.STRING](../propertytype/#STRING) data type. |
|[ add(name, value)](./add/#str_int) | Creates a new custom document property of the [PropertyType.NUMBER](../propertytype/#NUMBER) data type. |
|[ add(name, value)](./add/#str_datetime) | Creates a new custom document property of the [PropertyType.DATE_TIME](../propertytype/#DATE_TIME) data type. |
|[ add(name, value)](./add/#str_bool) | Creates a new custom document property of the [PropertyType.BOOLEAN](../propertytype/#BOOLEAN) data type. |
|[ add(name, value)](./add/#str_float) | Creates a new custom document property of the [PropertyType.DOUBLE](../propertytype/#DOUBLE) data type. |
