---
title: DoclingSaveOptions class
linktitle: DoclingSaveOptions class
articleTitle: DoclingSaveOptions class
second_title: Aspose.Words for Python
description: "aspose.words.saving.DoclingSaveOptions class. Can be used to specify additional options when saving a document into the [SaveFormat.DOCLING](../../aspose.words/saveformat/#DOCLING) format"
type: docs
weight: 110
url: /python-net/aspose.words.saving/doclingsaveoptions/
---

## DoclingSaveOptions class

Can be used to specify additional options when saving a document into the [SaveFormat.DOCLING](../../aspose.words/saveformat/#DOCLING)
format.
...
**Inheritance:** [DoclingSaveOptions](./) → [SaveOptions](../saveoptions/)

### Constructors
| Name | Description |
| --- | --- |
| [DoclingSaveOptions()](./__init__/#default) | The default constructor. |
...
| [render_non_image_shapes](./render_non_image_shapes/) | Gets or sets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
| [save_format](./save_format/) | Specifies the format in which the document will be saved if this save options object is used. Can only be [SaveFormat.DOCLING](../../aspose.words/saveformat/#DOCLING). |
