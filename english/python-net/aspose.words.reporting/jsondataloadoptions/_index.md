...
| Name | Description |
| --- | --- |
| [JsonDataLoadOptions()](./__init__/#default) | Initializes a new instance of this class with default options. |
...
| [exact_date_time_parse_format](./exact_date_time_parse_format/) | Gets or sets an exact format for parsing JSON date-time values while loading JSON. The default is **null**. |
| [exact_date_time_parse_formats](./exact_date_time_parse_formats/) | Gets or sets exact formats for parsing JSON date-time values while loading JSON. The default is **null**. |
