...
|[ import_node(src_node, is_import_children, import_format_mode, import_format_options)](../documentbase/import_node/#node_bool_importformatmode_importformatoptions) | Imports a node from another document to the current document with an option to control formatting.<br>(Inherited from [DocumentBase](../documentbase/)) |
...
|[ remove_customizations()](./remove_customizations/#default) | Removes toolbar and keyboard command customizations from the document. |
