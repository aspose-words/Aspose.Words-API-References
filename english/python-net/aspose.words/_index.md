...
Aspose.Words library is written completely in C#, CLS compliant and contains only safe managed code. Microsoft Word is not required in order to use Aspose.Words.
...
* [CompositeNode](./compositenode/)
  ...
  [Paragraph](./paragraph/),
  [Section](./section/) and
  [Table](../aspose.words.tables/table/) and
  .
...
| [NodeList](./nodelist/) | Represents a collection of nodes matching an XPath query executed using the [CompositeNode.select_nodes()](./compositenode/select_nodes/#str) method. |
...
| [Revision](./revision/) | Represents a revision (tracked change) in a document node or style. Use [Revision.revision_type](./revision/revision_type/) to check the type of this revision. |
