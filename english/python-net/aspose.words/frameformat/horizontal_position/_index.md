...
## FrameFormat.horizontal_position property

Gets horizontal distance between the edge of the frame and the item specified by the [FrameFormat.relative_horizontal_position](../relative_horizontal_position/) property.
