...
**Section** can have one [Section.body](./body/) and maximum one [HeaderFooter](../headerfooter/)
of each [HeaderFooterType](../headerfootertype/). **Body** and **HeaderFooter** nodes
...
| Name | Description |
| --- | --- |
| [body](./body/) | Returns the **Body** child node of the section. |
...
| [node_type](./node_type/) | Returns **NodeType.Section**. |
...
|[ ensure_minimum()](./ensure_minimum/#default) | Ensures that the section has Body with one Paragraph. |
