...
| [soft_edge](../shapebase/soft_edge/) | Gets soft edge formatting for the shape.<br>(Inherited from [ShapeBase](../shapebase/)) |
...
|[ accept_end(visitor)](./accept_end/#documentvisitor) | Accepts a visitor for visiting the end of the GroupShape. |
|[ accept_start(visitor)](./accept_start/#documentvisitor) | Accepts a visitor for visiting the start of the GroupShape. |
