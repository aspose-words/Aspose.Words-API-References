...
| Name | Description |
| --- | --- |
| [ChartMultilevelValue(level1, level2, level3)](./__init__/#str_str_str) | Initializes a new instance of this class that represents a three-level value. |
| [ChartMultilevelValue(level1, level2)](./__init__/#str_str) | Initializes a new instance of this class that represents a two-level value. |
| [ChartMultilevelValue(level1)](./__init__/#str) | Initializes a new instance of this class that represents a single-level value. |
