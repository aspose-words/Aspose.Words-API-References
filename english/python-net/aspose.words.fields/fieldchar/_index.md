...
| [field_type](./field_type/) | Returns the type of the field. |
...
| [is_locked](./is_locked/) | Gets or sets whether the parent field is locked (should not recalculate its result). |
...
|[ get_field()](./get_field/#default) | Returns a field for the field char. |
