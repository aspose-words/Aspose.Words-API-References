...
field = builder.insert_field(field_type=aw.fields.FieldType.FIELD_LAST_SAVED_BY, update_field=True).as_field_last_saved_by()
self.assertEqual(' LASTSAVEDBY ', field.get_field_code())
self.assertEqual('John Doe', field.result)
doc.save(file_name=ARTIFACTS_DIR + 'Field.LASTSAVEDBY.docx')
```
