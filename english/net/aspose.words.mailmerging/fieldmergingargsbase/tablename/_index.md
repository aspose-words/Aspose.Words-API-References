...
description: FieldMergingArgsBase TableName property. Gets the name of the data table for the current merge operation or empty string if the name is not available in C#.
type: docs
weight: 70
