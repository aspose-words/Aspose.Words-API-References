...
description: ChartDataLabel ShowLegendKey property. Allows to specify if legend key is to be displayed for the data labels on a chart. Default value is false in C#.
type: docs
weight: 110
