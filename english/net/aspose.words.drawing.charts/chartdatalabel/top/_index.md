...
Gets or sets the distance of the data label in points from the top edge of the chart or from the position specified by its [`Position`](../position/) property, depending on the value of the [`TopMode`](../topmode/) property.
