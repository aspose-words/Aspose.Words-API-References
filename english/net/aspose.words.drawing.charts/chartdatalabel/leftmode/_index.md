...
Gets or sets the interpretation mode of the [`Left`](../left/) property value: whether it sets the location of the data label from the left edge of the chart of from the position specified by its [`Position`](../position/) property.
