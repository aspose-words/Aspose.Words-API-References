...
Gets or sets the interpretation mode of the [`Top`](../top/) property value: whether it sets the location of the data label from the top edge of the chart of from the position specified by its [`Position`](../position/) property.
