...
| [DoughnutHoleSize](../../aspose.words.drawing.charts/chartseriesgroup/doughnutholesize/) { get; set; } | Gets or sets the hole size of the parent doughnut chart as a percentage. |
| [FirstSliceAngle](../../aspose.words.drawing.charts/chartseriesgroup/firstsliceangle/) { get; set; } | Gets or sets the angle, in degrees, of the first slice of the parent pie chart. |
...
| [SecondSectionSize](../../aspose.words.drawing.charts/chartseriesgroup/secondsectionsize/) { get; set; } | Gets or sets the size of the pie chart secondary section as a percentage. |
