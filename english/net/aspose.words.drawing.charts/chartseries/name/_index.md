...
description: Gets or sets the name of the series if name is not set explicitly it is generated using index. By default returns Series plus one based index in C#
type: docs
weight: 100
