...
description: Explore Aspose.Words.Tables.RowCollection for efficient access to Row nodes. Enhance document processing with our powerful, typed collection features.
type: docs
weight: 7190
...
| [Item](../../aspose.words.tables/rowcollection/item/) { get; } | Retrieves a [`Row`](../row/) at the given index. (2 indexers) |
...
| [ToArray](../../aspose.words.tables/rowcollection/toarray/#toarray_1)() | Copies all rows from the collection to a new array of rows. (2 methods) |
