...
---
## Sign(Stream, Stream, CertificateHolder, SignOptions) {#1}
...
## Sign(string, string, CertificateHolder, SignOptions) {#2}
...
## Sign(Stream, Stream, CertificateHolder) {#3}
...
## Sign(string, string, CertificateHolder) {#4}
