...
description: Represents the root element for a glossary document within a Word document. A glossary document is a storage for AutoText AutoCorrect entries and Building Blocks in C#
type: docs
weight: 170
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.words.buildingblocks/glossarydocument/accept/)(DocumentVisitor) | Accepts a visitor. |
