...
When [`BuildingBlock`](../) is created, it belongs to the specified glossary document, but is not yet part of the glossary document and [`ParentNode`](../../../aspose.words/node/parentnode/) is `null`.

To append [`BuildingBlock`](../) to a [`GlossaryDocument`](../../glossarydocument/) use [`AppendChild`](../../../aspose.words/compositenode/appendchild/).
