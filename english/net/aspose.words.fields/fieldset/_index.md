...
| Name | Description |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldset/bookmarkname/) { get; set; } | Gets or sets the name of the bookmark. |
| [BookmarkText](../../aspose.words.fields/fieldset/bookmarktext/) { get; set; } | Gets or sets the new text of the bookmark. |
