...
description: Manage your form with ease using the FormField Checked property. Control checkbox status effortlessly—default is unchecked for streamlined user experience.
type: docs
weight: 30
