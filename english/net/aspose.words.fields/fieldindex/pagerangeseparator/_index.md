...
description: FieldIndex PageRangeSeparator property. Gets or sets the character sequence that is used to separate the start and end of a page range in C#.
type: docs
weight: 130
