...
| Name | Description |
| --- | --- |
| [Format](../../aspose.words.fields/ifieldresultformatter/format#1)(double, GeneralFormat) | Called when Aspose.Words applies a number format switch, i.e. \* Ordinal. |
| [Format](../../aspose.words.fields/ifieldresultformatter/format#2)(string, GeneralFormat) | Called when Aspose.Words applies a capitalization format switch, i.e. \* Upper. |
