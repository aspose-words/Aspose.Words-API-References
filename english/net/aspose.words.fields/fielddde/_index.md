...
description: Implements the DDE field in C#
type: docs
weight: 1630
...
| Name | Description |
| --- | --- |
| [AutoUpdate](../../aspose.words.fields/fielddde/autoupdate/) { get; set; } | Gets or sets whether to update this field automatically. |
| [DisplayResult](../../aspose.words.fields/field/displayresult/) { get; } | Gets the text that represents the displayed field result. |
| [End](../../aspose.words.fields/field/end/) { get; } | Gets the node that represents the field end. |
| [Format](../../aspose.words.fields/field/format/) { get; } | Gets a [`FieldFormat`](../fieldformat/) object that provides typed access to field's formatting. |
| [InsertAsBitmap](../../aspose.words.fields/fielddde/insertasbitmap/) { get; set; } | Gets or sets whether to insert the linked object as a bitmap. |
| [InsertAsHtml](../../aspose.words.fields/fielddde/insertashtml/) { get; set; } | Gets or sets whether to insert the linked object as HTML format text. |
| [InsertAsPicture](../../aspose.words.fields/fielddde/insertaspicture/) { get; set; } | Gets or sets whether to insert the linked object as a picture. |
| [InsertAsRtf](../../aspose.words.fields/fielddde/insertasrtf/) { get; set; } | Gets or sets whether to insert the linked object in rich-text format (RTF). |
| [InsertAsText](../../aspose.words.fields/fielddde/insertastext/) { get; set; } | Gets or sets whether to insert the linked object in text-only format. |
| [InsertAsUnicode](../../aspose.words.fields/fielddde/insertasunicode/) { get; set; } | Gets or sets whether to insert the linked object as Unicode text. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Gets or sets whether the current result of the field is no longer correct (stale) due to other modifications made to the document. |
| [IsLinked](../../aspose.words.fields/fielddde/islinked/) { get; set; } | Gets or sets whether to reduce the file size by not storing graphics data with the document. |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | Gets or sets whether the field is locked (should not recalculate its result). |
| [LocaleId](../../aspose.words.fields/field/localeid/) { get; set; } | Gets or sets the LCID of the field. |
| [ProgId](../../aspose.words.fields/fielddde/progid/) { get; set; } | Gets or sets the application type of the link information. |
| [Result](../../aspose.words.fields/field/result/) { get; set; } | Gets or sets text that is between the field separator and field end. |
| [Separator](../../aspose.words.fields/field/separator/) { get; } | Gets the node that represents the field separator. Can be `null`. |
| [SourceFullName](../../aspose.words.fields/fielddde/sourcefullname/) { get; set; } | Gets or sets the name and location of the source file. |
| [SourceItem](../../aspose.words.fields/fielddde/sourceitem/) { get; set; } | Gets or sets the portion of the source file that's being linked. |
