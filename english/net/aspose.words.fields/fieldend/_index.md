...
description: Represents an end of a Word field in a document in C#
type: docs
weight: 1710
...
| [HasSeparator](../../aspose.words.fields/fieldend/hasseparator/) { get; } | Returns `true` if this field has a separator. |
...
| override [NodeType](../../aspose.words.fields/fieldend/nodetype/) { get; } | Returns FieldEnd. |
...
| Name | Description |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldend/accept/)(DocumentVisitor) | Accepts a visitor. |
