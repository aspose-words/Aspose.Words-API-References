...
| Name | Description |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Gets or sets a string that represents the name of the active style to use for a bibliography. |
