...
| [Load](../../aspose.words.fonts/tablesubstitutionrule/load#2)(Stream) | Loads table substitution settings from XML stream. |
| [Load](../../aspose.words.fonts/tablesubstitutionrule/load#1)(string) | Loads table substitution settings from XML file. |
...
| [Save](../../aspose.words.fonts/tablesubstitutionrule/save#2)(Stream) | Saves the current table substitution settings to stream. |
| [Save](../../aspose.words.fonts/tablesubstitutionrule/save#1)(string) | Saves the current table substitution settings to file. |
