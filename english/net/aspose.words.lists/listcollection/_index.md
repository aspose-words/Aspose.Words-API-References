...
| Name | Description |
| --- | --- |
| [Add](add)(ListTemplate) | Creates a new list based on a predefined template and adds it to the collection of lists in the document. |
| [Add](add)(Style) | Creates a new list that references a list style and adds it to the collection of lists in the document. |
| [AddCopy](addcopy)(List) | Creates a new list by copying the specified list and adding it to the collection of lists in the document. |
| [GetEnumerator](getenumerator)() | Gets the enumerator object that will enumerate lists in the document. |
| [GetListByListId](getlistbylistid)(int) | Gets a list by a list identifier. |
