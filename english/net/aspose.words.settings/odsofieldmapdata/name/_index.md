...
description: Specifies the column name within an external data source for the column whose index is specified by the Column property. The default value is an empty string in C#
type: docs
weight: 40
