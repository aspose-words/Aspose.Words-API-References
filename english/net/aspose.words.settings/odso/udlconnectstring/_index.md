...
description: Specifies the Universal Data Link UDL connection string used to connect to an external data source. The default value is an empty string in C#
type: docs
weight: 90
