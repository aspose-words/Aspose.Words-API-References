...
description: Discover the CompatibilityOptions DoNotBreakWrappedTables property to prevent floating tables from breaking across pages for a seamless document layout.
type: docs
weight: 140
