...
description: Discover the CompatibilityOptions DoNotWrapTextWithPunct property to prevent hanging punctuation in your character grid for cleaner, professional layouts.
type: docs
weight: 250
