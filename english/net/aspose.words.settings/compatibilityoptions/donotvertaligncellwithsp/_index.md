...
description: Discover the CompatibilityOptions DoNotVertAlignCellWithSp property to prevent vertical alignment of cells with floating objects for cleaner layouts.
type: docs
weight: 230
