...
description: Specifies that the documents produced during a mail merge operation should be emailed as an attachment rather than the body of the actual email. The default value is false in C#
type: docs
weight: 120
