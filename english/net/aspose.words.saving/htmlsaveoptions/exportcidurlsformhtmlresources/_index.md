...
description: Specifies whether to use CID ContentID URLs to reference resources images fonts CSS included in MHTML documents. Default value is false in C#
type: docs
weight: 120
