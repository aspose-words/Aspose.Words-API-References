...
description: HtmlSaveOptions property. Specifies whether font sizes should be output in relative units when saving to HTML MHTML or EPUB. Default is false in C#.
type: docs
weight: 240
