...
Aspose.Words automatically generates a unique file name for every embedded image when exporting to HTML format. How the image file name is generated depends on whether you save the document to a file or to a stream.When saving a document to a file, the generated image file name looks like &lt;document base file name&gt;.&lt;image number&gt;.&lt;extension&gt;.When saving a document to a stream, the generated image file name looks like Aspose.Words.&lt;document guid&gt;.&lt;image number&gt;.&lt;extension&gt;.
