...
description: Discover how the XamlFlowSaveOptions ImagesFolder property allows you to easily specify a folder for saving images when exporting documents to XAML format.
type: docs
weight: 30
