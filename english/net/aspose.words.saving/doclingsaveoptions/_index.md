...
| Name | Description |
| --- | --- |
| [DoclingSaveOptions](doclingsaveoptions/)() | The default constructor. |
...
| [RenderNonImageShapes](../../aspose.words.saving/doclingsaveoptions/rendernonimageshapes/) { get; set; } | Gets or sets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
| override [SaveFormat](../../aspose.words.saving/doclingsaveoptions/saveformat/) { get; set; } | Specifies the format in which the document will be saved if this save options object is used. Can only be Docling. |
