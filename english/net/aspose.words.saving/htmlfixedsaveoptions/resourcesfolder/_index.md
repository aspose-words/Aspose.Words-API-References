...
description: HtmlFixedSaveOptions property. Specifies the physical folder where resources images fonts css are saved when exporting a document to Html format. Default is null in C#.
type: docs
weight: 140
