...
description: Specifies if the output SVG should fill the available viewport area browser window or container. When set to true width and height of output SVG are set to 100 in C#
type: docs
weight: 30
