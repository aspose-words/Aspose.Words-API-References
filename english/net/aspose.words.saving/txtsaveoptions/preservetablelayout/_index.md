...
description: TxtSaveOptions property. Specifies whether the program should attempt to preserve layout of tables when saving in the plain text format. The default value is false in C#.
type: docs
weight: 50
