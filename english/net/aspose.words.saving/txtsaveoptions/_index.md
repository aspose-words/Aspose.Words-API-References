...
| [ListIndentation](../../aspose.words.saving/txtsaveoptions/listindentation) { get; } | Gets a ListIndentation object that specifies how many and which character to use for indentation of list levels. By default it is zero count of character '\0', that means no indentation. |
