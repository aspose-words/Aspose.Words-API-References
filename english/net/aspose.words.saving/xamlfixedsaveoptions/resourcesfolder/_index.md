...
description: Specifies the physical folder where resources images and fonts are saved when exporting a document to fixed page Xaml format. Default is null in C#
type: docs
weight: 30
