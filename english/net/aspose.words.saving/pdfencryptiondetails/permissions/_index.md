...
description: PdfEncryptionDetails property. Specifies the operations that are allowed to a user on an encrypted PDF document. The default value is DisallowAll in C#.
type: docs
weight: 30
