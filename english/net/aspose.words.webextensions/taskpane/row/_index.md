...
description: TaskPane property. Specifies the index enumerating from the outside to the inside of this task pane among other persisted task panes docked in the same default location in C#.
type: docs
weight: 50
