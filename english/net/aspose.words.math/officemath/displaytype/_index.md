...
description: Gets/sets Office Math display format type which represents whether an equation is displayed inline with the text or displayed on its own line in C#
type: docs
weight: 10
