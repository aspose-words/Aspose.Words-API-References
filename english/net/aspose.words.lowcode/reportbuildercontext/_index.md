...
| Name | Description |
| --- | --- |
| [ReportBuilderContext](reportbuildercontext/)() | The default constructor. |

## Properties

| Name | Description |
| --- | --- |
| [DataSources](../../aspose.words.lowcode/reportbuildercontext/datasources/) { get; } | Data sources used to build the report. |
...
| [ReportBuilderOptions](../../aspose.words.lowcode/reportbuildercontext/reportbuilderoptions/) { get; } | Report build options. |
