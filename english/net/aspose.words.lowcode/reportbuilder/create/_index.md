...
description: Create powerful reports effortlessly with the ReportBuilder Create method, designed to streamline your report generation process and enhance productivity.
type: docs
weight: 10
url: /net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}
