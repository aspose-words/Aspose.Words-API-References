...
description: StructuredDocumentTagRangeStart property. Gets an object that represents the mapping of this structured document tag range to XML data in a custom XML part of the current document in C#.
type: docs
weight: 180
