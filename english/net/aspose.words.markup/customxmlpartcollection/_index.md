...
| Name | Description |
| --- | --- |
| [Add](../../aspose.words.markup/customxmlpartcollection/add#2)(CustomXmlPart) | Adds an item to the collection. |
| [Add](../../aspose.words.markup/customxmlpartcollection/add#1)(string, string) | Creates a new XML part with the specified XML and adds it to the collection. |
