...
description: Gets/sets format in which the date for a date SDT is stored when the SDT is bound to an XML node in the documents data store. Default value is DateTime
type: docs
weight: 110
