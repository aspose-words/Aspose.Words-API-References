...
| [SetCheckedSymbol](setcheckedsymbol)(int, string) | Sets the symbol used to represent the checked state of a check box content control. |
| [SetUncheckedSymbol](setuncheckedsymbol)(int, string) | Sets the symbol used to represent the unchecked state of a check box content control. |
