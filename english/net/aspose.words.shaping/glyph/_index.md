...
description: Discover the Aspose.Words.Shaping.Glyph class—your key to advanced typography and precise glyph representation for seamless document formatting.
type: docs
weight: 6930
...
| Name | Description |
| --- | --- |
| virtual [AdditionalAdvance](../../aspose.words.shaping/glyph/additionaladvance/) { get; } | Additional advance width which may be used to adjust placement for the subsequent glyph. |
| virtual [Advance](../../aspose.words.shaping/glyph/advance/) { get; } | Advance width indicating placement for the subsequent glyph. |
