...
## XmlDataSource(string, XmlDataLoadOptions) {#6}
...
## XmlDataSource(Stream, XmlDataLoadOptions) {#2}
...
## XmlDataSource(string, string, XmlDataLoadOptions) {#8}
...
## XmlDataSource(Stream, Stream, XmlDataLoadOptions) {#4}
