...
---
## InsertOleObjectAsIcon(string, bool, string, string) {#1}
...
## InsertOleObjectAsIcon(string, string, bool, string, string) {#2}
...
## InsertOleObjectAsIcon(Stream, string, string, string) {#3}
