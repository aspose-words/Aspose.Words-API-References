...
---
## InsertOleObjectAsIcon(string, bool, string, string) {#2}
...
## InsertOleObjectAsIcon(string, string, bool, string, string) {#3}
...
## InsertOleObjectAsIcon(Stream, string, string, string) {#1}
