...
| [Item](../../aspose.words/runcollection/item) { get; } | Retrieves a **Run** at the given index. (2 indexers) |
...
| [ToArray](../../aspose.words/runcollection/toarray#2)() | Copies all runs from the collection to a new array of runs. (2 methods) |
