...
The pattern will not be used as regular expression. Please use [`Replace`](../replace) if you need regular expressions.Used case-insensitive comparison.Method is able to process breaks in both pattern and replacement strings. You should use special meta-characters if you need to work with breaks:
...
The pattern will not be used as regular expression. Please use [`Replace`](../replace) if you need regular expressions.Method is able to process breaks in both pattern and replacement strings. You should use special meta-characters if you need to work with breaks:
