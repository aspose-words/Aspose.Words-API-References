...
description: PageSetup property. For multiple page documents gets or sets how a document is printed or rendered so that it can be bound as a booklet in C#.
type: docs
weight: 270
