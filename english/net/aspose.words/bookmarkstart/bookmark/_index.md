...
description: Discover BookmarkStart's unique property to access the facade object, simplifying your bookmark management with seamless start and end encapsulation.
type: docs
weight: 20
