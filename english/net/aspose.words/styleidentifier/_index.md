...
description: Locale independent style identifier in C#
type: docs
weight: 5920
...
| DefaultParagraphFont | `65` | The Default Paragraph Font style. |
| Emphasis | `88` |  |
...
| SubtleReference | `262` |  |
| BalloonText | `153` |  |
| BodyText | `66` | The Body Text style. |
| BodyText2 | `80` |  |
| BodyText3 | `81` |  |
| BodyText1I | `77` |  |
| BodyText1I2 | `78` |  |
...
| Closing | `63` |  |
| CommentSubject | `106` |  |
| CommentText | `30` | The Annotation (Comment) Text style. |
| Date | `76` |  |
| DocumentMap | `89` |  |
| EmailSignature | `91` |  |
...
| OutlineList3 | `110` | The Article / Section style. |
| NoList | `107` |  |
| ColorfulGrid | `171` |  |
