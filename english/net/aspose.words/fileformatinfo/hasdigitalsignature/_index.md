...
description: Returns true if this document contains a digital signature. This property merely informs that a digital signature is present on a document but it does not specify whether the signature is valid or not in C#
type: docs
weight: 20
