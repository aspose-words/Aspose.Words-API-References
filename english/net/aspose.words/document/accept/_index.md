...
Calls [`VisitDocumentStart`](../../documentvisitor/visitdocumentstart/), then calls [`Accept`](../../node/accept/) for all child nodes of the document and calls [`VisitDocumentEnd`](../../documentvisitor/visitdocumentend/) at the end.
