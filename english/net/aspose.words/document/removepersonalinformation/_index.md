...
description: Document property. Gets or sets a flag indicating that Microsoft Word will remove all user information from comments revisions and document properties upon saving the document in C#.
type: docs
weight: 340
