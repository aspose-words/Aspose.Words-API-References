...
| [GetAncestor](../../aspose.words/node/getancestor#2)(NodeType) | Gets the first ancestor of the specified [`NodeType`](../nodetype). |
| [GetAncestor](../../aspose.words/node/getancestor#1)(Type) | Gets the first ancestor of the specified object type. |
...
| [ToString](../../aspose.words/node/tostring#1)(SaveFormat) | Exports the content of the node into a string in the specified format. |
| [ToString](../../aspose.words/node/tostring#2)(SaveOptions) | Exports the content of the node into a string using the specified save options. |
