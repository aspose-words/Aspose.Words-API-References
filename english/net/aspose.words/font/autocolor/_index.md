...
description: Returns the present calculated color of the text black or white to be used for auto color. If the color is not auto then returns Color in C#
type: docs
weight: 20
