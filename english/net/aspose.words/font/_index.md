...
description: Contains font attributes font name font size color and so on for an object in C#
type: docs
weight: 2670
...
| Name | Description |
| --- | --- |
| [AllCaps](../../aspose.words/font/allcaps/) { get; set; } | True if the font is formatted as all capital letters. |
| [AutoColor](../../aspose.words/font/autocolor/) { get; } | Returns the present calculated color of the text (black or white) to be used for 'auto color'. If the color is not 'auto' then returns [`Color`](./color/). |
| [Bidi](../../aspose.words/font/bidi/) { get; set; } | Specifies whether the contents of this run shall have right-to-left characteristics. |
| [Bold](../../aspose.words/font/bold/) { get; set; } | True if the font is formatted as bold. |
| [BoldBi](../../aspose.words/font/boldbi/) { get; set; } | True if the right-to-left text is formatted as bold. |
| [Border](../../aspose.words/font/border/) { get; } | Returns a [`Border`](../border/) object that specifies border for the font. |
| [Color](../../aspose.words/font/color/) { get; set; } | Gets or sets the color of the font. |
| [ComplexScript](../../aspose.words/font/complexscript/) { get; set; } | Specifies whether the contents of this run shall be treated as complex script text regardless of their Unicode character values when determining the formatting for this run. |
| [DoubleStrikeThrough](../../aspose.words/font/doublestrikethrough/) { get; set; } | True if the font is formatted as double strikethrough text. |
...
| [ItalicBi](../../aspose.words/font/italicbi/) { get; set; } | True if the right-to-left text is formatted as italic. |
| [Kerning](../../aspose.words/font/kerning/) { get; set; } | Gets or sets the font size at which kerning starts. |
| [LineSpacing](../../aspose.words/font/linespacing/) { get; } | Returns line spacing of this font (in points). |
| [LocaleId](../../aspose.words/font/localeid/) { get; set; } | Gets or sets the locale identifier (language) of the formatted characters. |
| [LocaleIdBi](../../aspose.words/font/localeidbi/) { get; set; } | Gets or sets the locale identifier (language) of the formatted right-to-left characters. |
| [LocaleIdFarEast](../../aspose.words/font/localeidfareast/) { get; set; } | Gets or sets the locale identifier (language) of the formatted Asian characters. |
| [Name](../../aspose.words/font/name/) { get; set; } | Gets or sets the name of the font. |
| [NameAscii](../../aspose.words/font/nameascii/) { get; set; } | Returns or sets the font used for Latin text (characters with character codes from 0 (zero) through 127). |
| [NameBi](../../aspose.words/font/namebi/) { get; set; } | Returns or sets the name of the font in a right-to-left language document. |
...
| [Shading](../../aspose.words/font/shading/) { get; } | Returns a [`Shading`](../shading/) object that refers to the shading formatting for the font. |
| [Shadow](../../aspose.words/font/shadow/) { get; set; } | True if the font is formatted as shadowed. |
| [Size](../../aspose.words/font/size/) { get; set; } | Gets or sets the font size in points. |
| [SizeBi](../../aspose.words/font/sizebi/) { get; set; } | Gets or sets the font size in points used in a right-to-left document. |
| [SmallCaps](../../aspose.words/font/smallcaps/) { get; set; } | True if the font is formatted as small capital letters. |
| [SnapToGrid](../../aspose.words/font/snaptogrid/) { get; set; } | Specifies whether the current font should use the document grid characters per line settings when laying out. |
| [Spacing](../../aspose.words/font/spacing/) { get; set; } | Returns or sets the spacing (in points) between characters . |
| [StrikeThrough](../../aspose.words/font/strikethrough/) { get; set; } | True if the font is formatted as strikethrough text. |
| [Style](../../aspose.words/font/style/) { get; set; } | Gets or sets the character style applied to this formatting. |
| [StyleIdentifier](../../aspose.words/font/styleidentifier/) { get; set; } | Gets or sets the locale independent style identifier of the character style applied to this formatting. |
| [StyleName](../../aspose.words/font/stylename/) { get; set; } | Gets or sets the name of the character style applied to this formatting. |
