...
description: 表示 Byte 原始类型的 Out/Ref 构造
type: docs
weight: 12
url: /zh/java/com.aspose.words.ref/refbyte/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [RefByte(byte value)](#RefByte-byte-) | 使用给定值模拟 Out/Ref 参数初始化。 |
## 方法s
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [set(byte anotherValue)](#set-byte-) | 设置 Out/Ref 参数值 应在具有 Out/Ref 结构的方法内部使用 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
