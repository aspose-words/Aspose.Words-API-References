...
| [getResizeVertically()](#getResizeVertically--) | 获取是否从源垂直调整图片大小。 |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String-) | 为要插入的图形格式设置过滤器的名称。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean-) | 设置是否从源水平调整图片大小。 |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean-) | 设置是否从源垂直调整图片大小。 |
| [setResult(String value)](#setResult-java.lang.String-) | 设置字段分隔符和字段结尾之间的文本。 |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String-) | 使用 IRI 设置图片的位置。 |
| [toString()](#toString--) |  |
