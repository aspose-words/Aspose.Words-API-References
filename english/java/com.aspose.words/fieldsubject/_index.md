...
description: 实现 SUBJECT 字段。
type: docs
weight: 247
url: /zh/java/com.aspose.words/fieldsubject/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段Subject extends 字段
```
...
检索并选择性地设置文档的主题，如记录在**Subject**内置文档属性的属性。
## 方法s
...
| [setText(String value)](#setText-java.lang.String-) | 设置主题的文本。 |
| [toString()](#toString--) |  |
