...
To append [Row](../../com.aspose.words/row/) to the document use **M:Aspose.Words.CompositeNode.InsertAfter1(0,Aspose.Words.Node)** or **M:Aspose.Words.CompositeNode.InsertBefore1(0,Aspose.Words.Node)** on the table where you want the row inserted.
