...
type: docs
weight: 213
url: /zh/java/com.aspose.words/fieldmacrobutton/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段MacroButton extends 字段
```
...
| [getDisplayText()](#getDisplayText--) | 获取显示为选择以运行宏或命令的“按钮”的文本。 |
...
| [getMacroName()](#getMacroName--) | 获取要运行的宏或命令的名称。 |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String-) | 将文本设置为显示为选择以运行宏或命令的“按钮”。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setMacroName(String value)](#setMacroName-java.lang.String-) | 设置要运行的宏或命令的名称。 |
...
获取显示为选择以运行宏或命令的“按钮”的文本。

**退货:**
java.lang.String - 显示为“按钮”的文本，选择运行宏或命令。
### getEnd() {#getEnd--}
```
public 字段End getEnd()
```
...
将文本设置为显示为选择以运行宏或命令的“按钮”。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 显示为选择运行宏或命令的“按钮”的文本。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要运行的宏或命令的名称。 |
