...
| [getChecked()](#getChecked) | Gets a boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Sets a boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not. |
...
Gets a boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not. The default value is  false .
...
**Returns:**
boolean - A boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not.
...
Sets a boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not. The default value is  false .
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | boolean | A boolean value indicating either this [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) is checked or not. |
