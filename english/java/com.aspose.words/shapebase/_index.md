...
如果形状是 a 的孩子[Paragraph](../../com.aspose.words/paragraph)对象，则该形状被称为“顶级”。顶级形状以点为单位进行测量和定位。

形状也可以作为 a 的子级出现[GroupShape](../../com.aspose.words/groupshape)多个形状组合在一起时的对象。组形状的子形状位于由定义的坐标空间和单位中[getCoordSize()](../../com.aspose.words/shapebase\#getCoordSize--) / [setCoordSize(java.awt.Dimension)](../../com.aspose.words/shapebase\#setCoordSize-java.awt.Dimension-)和[getCoordOrigin()](../../com.aspose.words/shapebase\#getCoordOrigin--) / [setCoordOrigin(java.awt.Point)](../../com.aspose.words/shapebase\#setCoordOrigin-java.awt.Point-)父组形状的属性。

形状可以与文本内联或浮动定位。定位方法是使用控制[getWrap类型()](../../com.aspose.words/shapebase\#getWrap类型--) / [setWrap类型(int)](../../com.aspose.words/shapebase\#setWrap类型-int-)财产。
