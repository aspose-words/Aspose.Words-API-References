...
description: 实现 USERNAME 字段。
type: docs
weight: 261
url: /zh/java/com.aspose.words/fieldusername/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段UserName extends 字段
```
...
| [getUserName()](#getUserName--) | 获取或设置当前用户的名称。 |
| [hashCode()](#hashCode--) |  |
...
| [setUserName(String value)](#setUserName-java.lang.String-) | 获取或设置当前用户的名称。 |
| [toString()](#toString--) |  |
