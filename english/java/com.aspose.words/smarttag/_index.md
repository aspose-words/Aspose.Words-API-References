...
When a node is created, it belongs to a document, but is not yet part of the document tree and [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) is null. To insert a node into the document, use the **M:Aspose.Words.CompositeNode.InsertAfter1(0,Aspose.Words.Node)** or **M:Aspose.Words.CompositeNode.InsertBefore1(0,Aspose.Words.Node)** methods on the parent node.
