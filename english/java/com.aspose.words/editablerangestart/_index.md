...
type: docs
weight: 138
url: /zh/java/com.aspose.words/editablerangestart/
---
...
| [getEditableRange()](#getEditableRange--) | 获取封装此可编辑范围开始和结束的外观对象。 |
...
| [setId(int value)](#setId-int-) | 指定可编辑范围的标识符。 |
...
来电[DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor\#visitEditableRangeStart-com.aspose.words.EditableRangeStart-).
...
**退货:**
[EditableRange](../../com.aspose.words/editablerange) - 封装此可编辑范围开始和结束的外观对象。
### getId() {#getId--}
```
public int getId()
```
