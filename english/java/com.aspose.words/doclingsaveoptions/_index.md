...
```
public class DoclingSaveOptions extends SaveOptions
```

Can be used to specify additional options when saving a document into the [SaveFormat.DOCLING](../../com.aspose.words/saveformat/\#DOCLING) format.
...
| [getRenderNonImageShapes()](#getRenderNonImageShapes) | Gets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
...
| [setRenderNonImageShapes(boolean value)](#setRenderNonImageShapes-boolean) | Sets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
...
### getRenderNonImageShapes() {#getRenderNonImageShapes}
```
public boolean getRenderNonImageShapes()
```


Gets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document.
...
**Returns:**
boolean - A value indicating whether non-image shapes should be rendered and written to the output Docling JSON document.
...
Specifies the format in which the document will be saved if this save options object is used. Can only be [SaveFormat.DOCLING](../../com.aspose.words/saveformat/\#DOCLING).
...
### setRenderNonImageShapes(boolean value) {#setRenderNonImageShapes-boolean}
```
public void setRenderNonImageShapes(boolean value)
```


Sets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document.
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | boolean | A value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
