...
| [get班级()](#get班级--) |  |
| [getDefaultResponse()](#getDefaultResponse--) | 获取默认用户响应（提示窗口中包含的初始值）。 |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge--) | 获取是否应在每个邮件合并操作中接收一次用户响应。 |
| [getPromptText()](#getPromptText--) | 获取提示文本（提示窗口的标题）。 |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String-) | 设置默认用户响应（初始值包含在提示窗口中）。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean-) | 设置每次邮件合并操作是否应接收一次用户响应。 |
| [setPromptText(String value)](#setPromptText-java.lang.String-) | 设置提示文本（提示窗口的标题）。 |
...
获取默认用户响应（提示窗口中包含的初始值）。

**退货:**
java.lang.String - 默认用户响应（初始值包含在提示窗口中）。
...
获取是否应在每个邮件合并操作中接收一次用户响应。

**退货:**
boolean - 每次邮件合并操作是否应接收一次用户响应。
...
设置默认用户响应（初始值包含在提示窗口中）。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 默认用户响应（初始值包含在提示窗口中）。 |
...
设置每次邮件合并操作是否应接收一次用户响应。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 每个邮件合并操作是否应接收一次用户响应。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 提示文本（提示窗口的标题）。 |
