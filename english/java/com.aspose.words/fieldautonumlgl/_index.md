...
```
public class 字段AutoNumLgl extends 字段
```
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod--) | 获取是否显示没有尾随句点的数字。 |
| [getResult()](#getResult--) | 获取字段分隔符和字段结尾之间的文本。 |
| [getSeparator()](#getSeparator--) | 获取表示字段分隔符的节点。 |
| [getSeparatorCharacter()](#getSeparatorCharacter--) | 获取要使用的分隔符。 |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean-) | 设置是否显示没有尾随句点的数字。 |
| [setResult(String value)](#setResult-java.lang.String-) | 设置字段分隔符和字段结尾之间的文本。 |
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String-) | 设置要使用的分隔符。 |
| [toString()](#toString--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要使用的分隔符。 |
