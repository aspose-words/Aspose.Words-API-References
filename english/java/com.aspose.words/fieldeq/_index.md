...
type: docs
weight: 183
url: /zh/java/com.aspose.words/fieldeq/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段EQ extends 字段
```
...
| 方法 | 描述 |
| --- | --- |
| [asOfficeMath()](#asOfficeMath--) | 返回与 EQ 字段对应的 Office Math 对象。 |
...
**退货:**
[OfficeMath](../../com.aspose.words/officemath) - 如果域代码为空或无效，则返回 null，否则返回[OfficeMath](../../com.aspose.words/officemath)实例。
### equals(Object arg0) {#equals-java.lang.Object-}
```
