---
title: 字段UserInitials
second_title: Aspose.Words for Java API 参考
description: 实现 USERINITIALS 字段。
type: docs
weight: 260
url: /zh/java/com.aspose.words/fielduserinitials/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段UserInitials extends 字段
```
...
| [getUserInitials()](#getUserInitials--) | 获取当前用户的姓名首字母。 |
| [hashCode()](#hashCode--) |  |
...
| [setUserInitials(String value)](#setUserInitials-java.lang.String-) | 设置当前用户的姓名首字母。 |
| [toString()](#toString--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 当前用户的姓名缩写。 |
