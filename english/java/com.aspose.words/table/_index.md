...
To append [Table](../../com.aspose.words/table/) to the document use **M:Aspose.Words.CompositeNode.InsertAfter1(0,Aspose.Words.Node)** or **M:Aspose.Words.CompositeNode.InsertBefore1(0,Aspose.Words.Node)** on the story where you want the table inserted.
