...
| [getPageCount()](#getPageCount--) | 获取要阅读的页数。 |
| [getPageIndex()](#getPageIndex--) | 获取要读取的第一页的从 0 开始的索引。 |
...
| [getSkipPdfImages()](#getSkipPdfImages--) | 获取指示在加载 PDF 文档时是否必须跳过图像的标志。 |
...
| [setPageCount(int value)](#setPageCount-int-) | 设置要阅读的页数。 |
| [setPageIndex(int value)](#setPageIndex-int-) | 设置要读取的第一页的从 0 开始的索引。 |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean-) | 设置标志，指示在加载 PDF 文档时是否必须跳过图像。 |
...
获取要读取的第一页的从 0 开始的索引。默认值为 0。

**退货:**
int - 要读取的第一页的从 0 开始的索引。
...
**退货:**
boolean - 指示在加载 PDF 文档时是否必须跳过图像的标志。
...
设置要读取的第一页的从 0 开始的索引。默认值为 0。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 要读取的第一页的从 0 开始的索引。 |
...
设置标志，指示在加载 PDF 文档时是否必须跳过图像。默认为假。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 指示在加载 PDF 文档时是否必须跳过图像的标志。 |
