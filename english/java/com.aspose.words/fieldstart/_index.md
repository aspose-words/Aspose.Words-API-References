...
```
public class 字段Start extends 字段Char
```
...
[字段Start](../../com.aspose.words/fieldstart)是一个内联级节点，由[ControlChar.FIELD\_START\_CHAR](../../com.aspose.words/controlchar\#FIELD-START-CHAR)文档中的控制字符。

[字段Start](../../com.aspose.words/fieldstart)只能是[Paragraph](../../com.aspose.words/paragraph).
...
| [get字段Data()](#get字段Data--) | 获取与字段关联的自定义字段数据。 |
| [get字段类型()](#get字段类型--) | 返回字段的类型。 |
| [getFont()](#getFont--) | 提供对此对象的字体格式的访问。 |
| [getNextSibling()](#getNextSibling--) | 获取紧跟此节点的节点。 |
| [getNode类型()](#getNode类型--) | 退货[Node类型.FIELD\_START](../../com.aspose.words/nodetype\#FIELD-START). |
...
来电[DocumentVisitor.visit字段Start(com.aspose.words.字段Start)](../../com.aspose.words/documentvisitor\#visit字段Start-com.aspose.words.字段Start-).
...
退货[Node类型.FIELD\_START](../../com.aspose.words/nodetype\#FIELD-START).

**退货:**
诠释 -\{[Node类型.FIELD\_START](../../com.aspose.words/nodetype\#FIELD-START) .返回值是以下之一[Node类型](../../com.aspose.words/nodetype)常数。
