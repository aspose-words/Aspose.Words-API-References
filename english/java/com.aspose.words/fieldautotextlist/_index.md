...
```
public class 字段AutoTextList extends 字段
```
...
| [getListStyle()](#getListStyle--) | 获取包含条目的列表所基于的样式的名称。 |
| [getLocaleId()](#getLocaleId--) | 获取字段的 LCID。 |
| [getResult()](#getResult--) | 获取字段分隔符和字段结尾之间的文本。 |
| [getScreenTip()](#getScreenTip--) | 获取要显示的屏幕提示文本。 |
...
| [setEntryName(String value)](#setEntryName-java.lang.String-) | 设置自动图文集条目的名称。 |
| [setListStyle(String value)](#setListStyle-java.lang.String-) | 设置包含条目的列表所基于的样式的名称。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setResult(String value)](#setResult-java.lang.String-) | 设置字段分隔符和字段结尾之间的文本。 |
| [setScreenTip(String value)](#setScreenTip-java.lang.String-) | 设置要显示的屏幕提示文本。 |
| [toString()](#toString--) |  |
...
**退货:**
java.lang.String - 包含条目的列表所基于的样式的名称。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 自动图文集条目的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 包含条目的列表所基于的样式的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要显示的屏幕提示文本。 |
