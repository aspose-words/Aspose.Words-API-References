...
| [ArrowLength](../com.aspose.words/arrowlength) | A utility class providing constants. |
| [ArrowType](../com.aspose.words/arrowtype) | A utility class providing constants. |
| [ArrowWidth](../com.aspose.words/arrowwidth) | A utility class providing constants. |
...
| [AutoFitBehavior](../com.aspose.words/autofitbehavior) | A utility class providing constants. |
| [AxisBound](../com.aspose.words/axisbound) | Represents minimum or maximum bound of axis values. |
| [AxisBuiltInUnit](../com.aspose.words/axisbuiltinunit) | A utility class providing constants. |
| [AxisCategoryType](../com.aspose.words/axiscategorytype) | A utility class providing constants. |
| [AxisCrosses](../com.aspose.words/axiscrosses) | A utility class providing constants. |
...
| [AxisScaleType](../com.aspose.words/axisscaletype) | A utility class providing constants. |
| [AxisScaling](../com.aspose.words/axisscaling) | Represents the scaling options of the axis. |
| [AxisTickLabelPosition](../com.aspose.words/axisticklabelposition) | A utility class providing constants. |
| [AxisTickMark](../com.aspose.words/axistickmark) | A utility class providing constants. |
| [AxisTimeUnit](../com.aspose.words/axistimeunit) | A utility class providing constants. |
...
| [BlockImportMode](../com.aspose.words/blockimportmode) | A utility class providing constants. |
...
| [BorderType](../com.aspose.words/bordertype) | A utility class providing constants. |
| [BreakType](../com.aspose.words/breaktype) | A utility class providing constants. |
...
| [BuildingBlockBehavior](../com.aspose.words/buildingblockbehavior) | A utility class providing constants. |
...
| [BuildingBlockGallery](../com.aspose.words/buildingblockgallery) | A utility class providing constants. |
| [BuildingBlockType](../com.aspose.words/buildingblocktype) | A utility class providing constants. |
| [BuiltInDocumentProperties](../com.aspose.words/builtindocumentproperties) | A collection of built-in document properties. |
| [CalendarType](../com.aspose.words/calendartype) | A utility class providing constants. |
...
| [CellMerge](../com.aspose.words/cellmerge) | A utility class providing constants. |
| [CellVerticalAlignment](../com.aspose.words/cellverticalalignment) | A utility class providing constants. |
| [CertificateHolder](../com.aspose.words/certificateholder) | Represents a holder of **X509Certificate2** instance. |
| [ChapterPageSeparator](../com.aspose.words/chapterpageseparator) | A utility class providing constants. |
...
| [ChartAxisType](../com.aspose.words/chartaxistype) | A utility class providing constants. |
...
| [ChartType](../com.aspose.words/charttype) | A utility class providing constants. |
...
| [ColorMode](../com.aspose.words/colormode) | A utility class providing constants. |
...
| [CommentDisplayMode](../com.aspose.words/commentdisplaymode) | A utility class providing constants. |
...
| [ComparisonTargetType](../com.aspose.words/comparisontargettype) | A utility class providing constants. |
| [Compatibility](../com.aspose.words/compatibility) | A utility class providing constants. |
...
| [CompressionLevel](../com.aspose.words/compressionlevel) | A utility class providing constants. |
...
| [ConditionalStyleType](../com.aspose.words/conditionalstyletype) | A utility class providing constants. |
| [ContentDisposition](../com.aspose.words/contentdisposition) | A utility class providing constants. |
| [ContinuousSectionRestart](../com.aspose.words/continuoussectionrestart) | A utility class providing constants. |
...
| [CssStyleSheetType](../com.aspose.words/cssstylesheettype) | A utility class providing constants. |
...
| [DashStyle](../com.aspose.words/dashstyle) | A utility class providing constants. |
...
| [DigitalSignatureType](../com.aspose.words/digitalsignaturetype) | A utility class providing constants. |
...
| [Dml3DEffectsRenderingMode](../com.aspose.words/dml3deffectsrenderingmode) | A utility class providing constants. |
| [DmlEffectsRenderingMode](../com.aspose.words/dmleffectsrenderingmode) | A utility class providing constants. |
| [DmlRenderingMode](../com.aspose.words/dmlrenderingmode) | A utility class providing constants. |
...
| [DocumentDirection](../com.aspose.words/documentdirection) | A utility class providing constants. |
...
| [DocumentSecurity](../com.aspose.words/documentsecurity) | A utility class providing constants. |
| [DocumentSplitCriteria](../com.aspose.words/documentsplitcriteria) | A utility class providing constants. |
...
| [DropCapPosition](../com.aspose.words/dropcapposition) | A utility class providing constants. |
...
| [EditingLanguage](../com.aspose.words/editinglanguage) | A utility class providing constants. |
| [EditorType](../com.aspose.words/editortype) | A utility class providing constants. |
| [EmbeddedFontFormat](../com.aspose.words/embeddedfontformat) | A utility class providing constants. |
| [EmbeddedFontStyle](../com.aspose.words/embeddedfontstyle) | A utility class providing constants. |
| [EmfPlusDualRenderingMode](../com.aspose.words/emfplusdualrenderingmode) | A utility class providing constants. |
| [EmphasisMark](../com.aspose.words/emphasismark) | A utility class providing constants. |
| [EndCap](../com.aspose.words/endcap) | A utility class providing constants. |
| [EndnoteOptions](../com.aspose.words/endnoteoptions) | Represents the endnote numbering options for a document or section. |
| [EndnotePosition](../com.aspose.words/endnoteposition) | A utility class providing constants. |
| [ExportFontFormat](../com.aspose.words/exportfontformat) | A utility class providing constants. |
| [ExportHeadersFootersMode](../com.aspose.words/exportheadersfootersmode) | A utility class providing constants. |
| [ExportListLabels](../com.aspose.words/exportlistlabels) | A utility class providing constants. |
...
| [FieldIfComparisonResult](../com.aspose.words/fieldifcomparisonresult) | A utility class providing constants. |
...
| [FieldIndexFormat](../com.aspose.words/fieldindexformat) | A utility class providing constants. |
...
| [FieldType](../com.aspose.words/fieldtype) | A utility class providing constants. |
| [FieldUnknown](../com.aspose.words/fieldunknown) | Implements an unknown or unrecognized field. |
| [FieldUpdateCultureSource](../com.aspose.words/fieldupdateculturesource) | A utility class providing constants. |
...
| [FillType](../com.aspose.words/filltype) | A utility class providing constants. |
| [FindReplaceDirection](../com.aspose.words/findreplacedirection) | A utility class providing constants. |
...
| [FlipOrientation](../com.aspose.words/fliporientation) | A utility class providing constants. |
...
| [FontFamily](../com.aspose.words/fontfamily) | A utility class providing constants. |
...
| [FontPitch](../com.aspose.words/fontpitch) | A utility class providing constants. |
...
| [FontSourceType](../com.aspose.words/fontsourcetype) | A utility class providing constants. |
...
| [FootnoteNumberingRule](../com.aspose.words/footnotenumberingrule) | A utility class providing constants. |
| [FootnoteOptions](../com.aspose.words/footnoteoptions) | Represents the footnote numbering options for a document or section. |
| [FootnotePosition](../com.aspose.words/footnoteposition) | A utility class providing constants. |
| [FootnoteType](../com.aspose.words/footnotetype) | A utility class providing constants. |
...
| [GeneralFormat](../com.aspose.words/generalformat) | A utility class providing constants. |
...
| [GradientStyle](../com.aspose.words/gradientstyle) | A utility class providing constants. |
| [GradientVariant](../com.aspose.words/gradientvariant) | A utility class providing constants. |
| [Granularity](../com.aspose.words/granularity) | A utility class providing constants. |
...
| [HeaderFooterBookmarksExportMode](../com.aspose.words/headerfooterbookmarksexportmode) | A utility class providing constants. |
...
| [HeaderFooterType](../com.aspose.words/headerfootertype) | A utility class providing constants. |
| [HeightRule](../com.aspose.words/heightrule) | A utility class providing constants. |
| [HorizontalAlignment](../com.aspose.words/horizontalalignment) | A utility class providing constants. |
| [HorizontalRuleAlignment](../com.aspose.words/horizontalrulealignment) | A utility class providing constants. |
| [HorizontalRuleFormat](../com.aspose.words/horizontalruleformat) | Represents horizontal rule formatting. |
| [HtmlControlType](../com.aspose.words/htmlcontroltype) | A utility class providing constants. |
| [HtmlElementSizeOutputMode](../com.aspose.words/htmlelementsizeoutputmode) | A utility class providing constants. |
| [HtmlFixedPageHorizontalAlignment](../com.aspose.words/htmlfixedpagehorizontalalignment) | A utility class providing constants. |
...
| [HtmlInsertOptions](../com.aspose.words/htmlinsertoptions) | A utility class providing constants. |
...
| [HtmlMetafileFormat](../com.aspose.words/htmlmetafileformat) | A utility class providing constants. |
| [HtmlOfficeMathOutputMode](../com.aspose.words/htmlofficemathoutputmode) | A utility class providing constants. |
...
| [HtmlVersion](../com.aspose.words/htmlversion) | A utility class providing constants. |
...
| [ImageBinarizationMethod](../com.aspose.words/imagebinarizationmethod) | A utility class providing constants. |
| [ImageColorMode](../com.aspose.words/imagecolormode) | A utility class providing constants. |
...
| [ImagePixelFormat](../com.aspose.words/imagepixelformat) | A utility class providing constants. |
...
| [ImageType](../com.aspose.words/imagetype) | A utility class providing constants. |
...
| [ImlRenderingMode](../com.aspose.words/imlrenderingmode) | A utility class providing constants. |
| [ImportFormatMode](../com.aspose.words/importformatmode) | A utility class providing constants. |
...
| [JoinStyle](../com.aspose.words/joinstyle) | A utility class providing constants. |
...
| [JsonSimpleValueParseMode](../com.aspose.words/jsonsimplevalueparsemode) | A utility class providing constants. |
...
| [LayoutEntityType](../com.aspose.words/layoutentitytype) | A utility class providing constants. |
| [LayoutEnumerator](../com.aspose.words/layoutenumerator) | Enumerates page layout entities of a document. |
| [LayoutFlow](../com.aspose.words/layoutflow) | A utility class providing constants. |
| [LayoutOptions](../com.aspose.words/layoutoptions) | Holds the options that allow controlling the document layout process. |
| [LegendPosition](../com.aspose.words/legendposition) | A utility class providing constants. |
| [License](../com.aspose.words/license) | Provides methods to license the component. |
| [LineNumberRestartMode](../com.aspose.words/linenumberrestartmode) | A utility class providing constants. |
| [LineSpacingRule](../com.aspose.words/linespacingrule) | A utility class providing constants. |
| [LineStyle](../com.aspose.words/linestyle) | A utility class providing constants. |
...
| [ListLevelAlignment](../com.aspose.words/listlevelalignment) | A utility class providing constants. |
| [ListLevelCollection](../com.aspose.words/listlevelcollection) | A collection of list formatting for each level in a list. |
| [ListTemplate](../com.aspose.words/listtemplate) | A utility class providing constants. |
| [ListTrailingCharacter](../com.aspose.words/listtrailingcharacter) | A utility class providing constants. |
| [LoadFormat](../com.aspose.words/loadformat) | A utility class providing constants. |
...
| [MailMergeCheckErrors](../com.aspose.words/mailmergecheckerrors) | A utility class providing constants. |
| [MailMergeCleanupOptions](../com.aspose.words/mailmergecleanupoptions) | A utility class providing constants. |
| [MailMergeDataType](../com.aspose.words/mailmergedatatype) | A utility class providing constants. |
| [MailMergeDestination](../com.aspose.words/mailmergedestination) | A utility class providing constants. |
| [MailMergeMainDocumentType](../com.aspose.words/mailmergemaindocumenttype) | A utility class providing constants. |
...
| [MarkerSymbol](../com.aspose.words/markersymbol) | A utility class providing constants. |
| [MarkupLevel](../com.aspose.words/markuplevel) | A utility class providing constants. |
| [MathObjectType](../com.aspose.words/mathobjecttype) | A utility class providing constants. |
| [MeasurementUnits](../com.aspose.words/measurementunits) | A utility class providing constants. |
...
| [MergeFieldImageDimensionUnit](../com.aspose.words/mergefieldimagedimensionunit) | A utility class providing constants. |
| [MetafileRenderingMode](../com.aspose.words/metafilerenderingmode) | A utility class providing constants. |
...
| [MsWordVersion](../com.aspose.words/mswordversion) | A utility class providing constants. |
| [MultiplePagesType](../com.aspose.words/multiplepagestype) | A utility class providing constants. |
| [Node](../com.aspose.words/node) | Base class for all nodes of a Word document. |
| [NodeChangingAction](../com.aspose.words/nodechangingaction) | A utility class providing constants. |
...
| [NodeType](../com.aspose.words/nodetype) | A utility class providing constants. |
| [NumberStyle](../com.aspose.words/numberstyle) | A utility class providing constants. |
| [NumeralFormat](../com.aspose.words/numeralformat) | A utility class providing constants. |
| [Odso](../com.aspose.words/odso) | Specifies the Office Data Source Object (ODSO) settings for a mail merge data source. |
| [OdsoDataSourceType](../com.aspose.words/odsodatasourcetype) | A utility class providing constants. |
...
| [OdsoFieldMappingType](../com.aspose.words/odsofieldmappingtype) | A utility class providing constants. |
...
| [OdtSaveMeasureUnit](../com.aspose.words/odtsavemeasureunit) | A utility class providing constants. |
...
| [OfficeMathDisplayType](../com.aspose.words/officemathdisplaytype) | A utility class providing constants. |
| [OfficeMathJustification](../com.aspose.words/officemathjustification) | A utility class providing constants. |
...
| [OoxmlCompliance](../com.aspose.words/ooxmlcompliance) | A utility class providing constants. |
...
| [Orientation](../com.aspose.words/orientation) | A utility class providing constants. |
| [OutlineLevel](../com.aspose.words/outlinelevel) | A utility class providing constants. |
| [OutlineOptions](../com.aspose.words/outlineoptions) | Allows to specify outline options. |
| [PageBorderAppliesTo](../com.aspose.words/pageborderappliesto) | A utility class providing constants. |
| [PageBorderDistanceFrom](../com.aspose.words/pageborderdistancefrom) | A utility class providing constants. |
...
| [PageLayoutEvent](../com.aspose.words/pagelayoutevent) | A utility class providing constants. |
...
| [PageVerticalAlignment](../com.aspose.words/pageverticalalignment) | A utility class providing constants. |
| [PaperSize](../com.aspose.words/papersize) | A utility class providing constants. |
| [Paragraph](../com.aspose.words/paragraph) | Represents a paragraph of text. |
| [ParagraphAlignment](../com.aspose.words/paragraphalignment) | A utility class providing constants. |
...
| [PatternType](../com.aspose.words/patterntype) | A utility class providing constants. |
...
| [PdfCompliance](../com.aspose.words/pdfcompliance) | A utility class providing constants. |
| [PdfCustomPropertiesExport](../com.aspose.words/pdfcustompropertiesexport) | A utility class providing constants. |
...
| [PdfDigitalSignatureHashAlgorithm](../com.aspose.words/pdfdigitalsignaturehashalgorithm) | A utility class providing constants. |
...
| [PdfFontEmbeddingMode](../com.aspose.words/pdffontembeddingmode) | A utility class providing constants. |
| [PdfImageColorSpaceExportMode](../com.aspose.words/pdfimagecolorspaceexportmode) | A utility class providing constants. |
| [PdfImageCompression](../com.aspose.words/pdfimagecompression) | A utility class providing constants. |
...
| [PdfPageMode](../com.aspose.words/pdfpagemode) | A utility class providing constants. |
| [PdfPermissions](../com.aspose.words/pdfpermissions) | A utility class providing constants. |
...
| [PdfTextCompression](../com.aspose.words/pdftextcompression) | A utility class providing constants. |
| [PdfZoomBehavior](../com.aspose.words/pdfzoombehavior) | A utility class providing constants. |
...
| [PreferredWidthType](../com.aspose.words/preferredwidthtype) | A utility class providing constants. |
| [PresetTexture](../com.aspose.words/presettexture) | A utility class providing constants. |
| [PropertyType](../com.aspose.words/propertytype) | A utility class providing constants. |
| [ProtectionType](../com.aspose.words/protectiontype) | A utility class providing constants. |
...
| [RelativeHorizontalPosition](../com.aspose.words/relativehorizontalposition) | A utility class providing constants. |
| [RelativeVerticalPosition](../com.aspose.words/relativeverticalposition) | A utility class providing constants. |
| [ReplaceAction](../com.aspose.words/replaceaction) | A utility class providing constants. |
| [ReplacingArgs](../com.aspose.words/replacingargs) | Provides data for a custom replace operation. |
| [ReportBuildOptions](../com.aspose.words/reportbuildoptions) | A utility class providing constants. |
...
| [ResourceLoadingAction](../com.aspose.words/resourceloadingaction) | A utility class providing constants. |
...
| [ResourceType](../com.aspose.words/resourcetype) | A utility class providing constants. |
...
| [RevisionColor](../com.aspose.words/revisioncolor) | A utility class providing constants. |
...
| [RevisionTextEffect](../com.aspose.words/revisiontexteffect) | A utility class providing constants. |
| [RevisionType](../com.aspose.words/revisiontype) | A utility class providing constants. |
| [RevisionsView](../com.aspose.words/revisionsview) | A utility class providing constants. |
...
| [SaveFormat](../com.aspose.words/saveformat) | A utility class providing constants. |
...
| [SdtAppearance](../com.aspose.words/sdtappearance) | A utility class providing constants. |
| [SdtCalendarType](../com.aspose.words/sdtcalendartype) | A utility class providing constants. |
| [SdtDateStorageFormat](../com.aspose.words/sdtdatestorageformat) | A utility class providing constants. |
...
| [SdtType](../com.aspose.words/sdttype) | A utility class providing constants. |
...
| [SectionLayoutMode](../com.aspose.words/sectionlayoutmode) | A utility class providing constants. |
| [SectionStart](../com.aspose.words/sectionstart) | A utility class providing constants. |
...
| [ShadowType](../com.aspose.words/shadowtype) | A utility class providing constants. |
...
| [ShapeLineStyle](../com.aspose.words/shapelinestyle) | A utility class providing constants. |
| [ShapeMarkupLanguage](../com.aspose.words/shapemarkuplanguage) | A utility class providing constants. |
...
| [ShapeType](../com.aspose.words/shapetype) | A utility class providing constants. |
| [ShowInBalloons](../com.aspose.words/showinballoons) | A utility class providing constants. |
...
| [StoryType](../com.aspose.words/storytype) | A utility class providing constants. |
...
| [StyleIdentifier](../com.aspose.words/styleidentifier) | A utility class providing constants. |
| [StyleType](../com.aspose.words/styletype) | A utility class providing constants. |
...
| [SvgTextOutputMode](../com.aspose.words/svgtextoutputmode) | A utility class providing constants. |
| [SystemFontSource](../com.aspose.words/systemfontsource) | Represents all TrueType fonts installed to the system. |
| [TabAlignment](../com.aspose.words/tabalignment) | A utility class providing constants. |
| [TabLeader](../com.aspose.words/tableader) | A utility class providing constants. |
...
| [TableAlignment](../com.aspose.words/tablealignment) | A utility class providing constants. |
...
| [TableContentAlignment](../com.aspose.words/tablecontentalignment) | A utility class providing constants. |
| [TableStyle](../com.aspose.words/tablestyle) | Represents a table style. |
| [TableStyleOptions](../com.aspose.words/tablestyleoptions) | A utility class providing constants. |
...
| [TaskPaneDockState](../com.aspose.words/taskpanedockstate) | A utility class providing constants. |
| [TextBox](../com.aspose.words/textbox) | Defines attributes that specify how a text is displayed inside a shape. |
| [TextBoxAnchor](../com.aspose.words/textboxanchor) | A utility class providing constants. |
| [TextBoxWrapMode](../com.aspose.words/textboxwrapmode) | A utility class providing constants. |
...
| [TextDmlEffect](../com.aspose.words/textdmleffect) | A utility class providing constants. |
| [TextEffect](../com.aspose.words/texteffect) | A utility class providing constants. |
| [TextFormFieldType](../com.aspose.words/textformfieldtype) | A utility class providing constants. |
| [TextOrientation](../com.aspose.words/textorientation) | A utility class providing constants. |
| [TextPath](../com.aspose.words/textpath) | Defines the text and formatting of the text path (of a WordArt object). |
| [TextPathAlignment](../com.aspose.words/textpathalignment) | A utility class providing constants. |
...
| [TextWrapping](../com.aspose.words/textwrapping) | A utility class providing constants. |
| [TextureAlignment](../com.aspose.words/texturealignment) | A utility class providing constants. |
| [TextureIndex](../com.aspose.words/textureindex) | A utility class providing constants. |
...
| [ThemeColor](../com.aspose.words/themecolor) | A utility class providing constants. |
| [ThemeColors](../com.aspose.words/themecolors) | Represents the color scheme of the document theme which contains twelve colors. |
| [ThemeFont](../com.aspose.words/themefont) | A utility class providing constants. |
...
| [TiffCompression](../com.aspose.words/tiffcompression) | A utility class providing constants. |
| [ToaCategories](../com.aspose.words/toacategories) | Represents a table of authorities categories. |
| [TxtExportHeadersFootersMode](../com.aspose.words/txtexportheadersfootersmode) | A utility class providing constants. |
| [TxtLeadingSpacesOptions](../com.aspose.words/txtleadingspacesoptions) | A utility class providing constants. |
...
| [TxtTrailingSpacesOptions](../com.aspose.words/txttrailingspacesoptions) | A utility class providing constants. |
| [Underline](../com.aspose.words/underline) | A utility class providing constants. |
...
| [VbaModuleType](../com.aspose.words/vbamoduletype) | A utility class providing constants. |
...
| [VbaReferenceType](../com.aspose.words/vbareferencetype) | A utility class providing constants. |
| [VerticalAlignment](../com.aspose.words/verticalalignment) | A utility class providing constants. |
| [ViewOptions](../com.aspose.words/viewoptions) | Provides various options that control how a document is shown in Microsoft Word. |
| [ViewType](../com.aspose.words/viewtype) | A utility class providing constants. |
| [VisitorAction](../com.aspose.words/visitoraction) | A utility class providing constants. |
...
| [WarningSource](../com.aspose.words/warningsource) | A utility class providing constants. |
| [WarningType](../com.aspose.words/warningtype) | A utility class providing constants. |
| [Watermark](../com.aspose.words/watermark) | Represents class to work with document watermark. |
| [WatermarkLayout](../com.aspose.words/watermarklayout) | A utility class providing constants. |
| [WatermarkType](../com.aspose.words/watermarktype) | A utility class providing constants. |
...
| [WebExtensionBindingType](../com.aspose.words/webextensionbindingtype) | A utility class providing constants. |
...
| [WebExtensionStoreType](../com.aspose.words/webextensionstoretype) | A utility class providing constants. |
...
| [WrapSide](../com.aspose.words/wrapside) | A utility class providing constants. |
| [WrapType](../com.aspose.words/wraptype) | A utility class providing constants. |
...
| [ZoomType](../com.aspose.words/zoomtype) | A utility class providing constants. |
