...
Retrieves, and optionally sets, the comments relating to the current document, as recorded in the [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) property of the built-in document properties.
...
| [getText()](#getText) | Gets the text of the comments. |
...
| [setText(String value)](#setText-java.lang.String) | Sets the text of the comments. |
| [toString()](#toString) |  |
...
**Returns:**
java.lang.String - The text of the comments.
### getType() {#getType}
```
public int getType()
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | java.lang.String | The text of the comments. |
