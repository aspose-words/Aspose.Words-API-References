...
| [getKeepLegacyControlChars()](#getKeepLegacyControlChars--) | 保留旧版控制字符的原始表示。 |
| [getMemoryOptimization()](#getMemoryOptimization--) | 获取确定是否应在保存文档之前执行内存优化的值。 |
| [getPassword()](#getPassword--) | 获取/设置密码以使用 ECMA376 标准加密算法加密文档。 |
...
| [setKeepLegacyControlChars(boolean value)](#setKeepLegacyControlChars-boolean-) | 保留旧版控制字符的原始表示。 |
| [setMemoryOptimization(boolean value)](#setMemoryOptimization-boolean-) | 设置值确定是否应在保存文档之前执行内存优化。 |
| [setPassword(String value)](#setPassword-java.lang.String-) | 获取/设置密码以使用 ECMA376 标准加密算法加密文档。 |
