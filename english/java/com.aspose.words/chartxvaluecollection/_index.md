...
| [getFormatCode()](#getFormatCode) | Gets the format code applied to the X values. |
| [iterator()](#iterator) | Returns an enumerator object. |
| [set(int index, ChartXValue value)](#set-int-com.aspose.words.ChartXValue) | Sets the X value at the specified index. |
| [setFormatCode(String value)](#setFormatCode-java.lang.String) | Sets the format code applied to the X values. |
...
**Returns:**
java.lang.String - The format code applied to the X values.
### iterator() {#iterator}
```
