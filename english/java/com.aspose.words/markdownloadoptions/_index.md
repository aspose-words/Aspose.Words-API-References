...
Allows to specify additional options when loading [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document into a [Document](../../com.aspose.words/document/) object.
...
| --- | --- |
| [MarkdownLoadOptions()](#MarkdownLoadOptions) | Initializes a new instance of [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/) class. |
## Methods
...
| [getPreserveEmptyLines()](#getPreserveEmptyLines) | Gets a boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document. |
...
| [setPreserveEmptyLines(boolean value)](#setPreserveEmptyLines-boolean) | Sets a boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document. |
...
Initializes a new instance of [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/) class.
...
Gets a boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document. The default value is  false .
...
**Returns:**
boolean - A boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document.
...
Sets a boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document. The default value is  false .
...
| Parameter | Type | Description |
| --- | --- | --- |
| value | boolean | A boolean value indicating whether to preserve empty lines while load a [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) document. |
