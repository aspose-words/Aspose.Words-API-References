...
Gets the information about image size and resolution. (31795,6)
...
Gets the type of the image. (31841,6)
...
Returns  true  if the shape has image bytes or links an image. (31757,6)
...
Returns  true  if the image is linked to the shape (when [getSourceFullName()](../../com.aspose.words/imagedata/\#getSourceFullName) / [setSourceFullName(java.lang.String)](../../com.aspose.words/imagedata/\#setSourceFullName-java.lang.String) is specified). (31865,6)
...
Returns  true  if the image is linked and not stored in the document. (31927,6)
