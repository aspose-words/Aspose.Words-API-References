...
Gets the information about image size and resolution. (33291,6)
...
Gets the type of the image. (33337,6)
...
Returns  true  if the shape has image bytes or links an image. (33253,6)
...
Returns  true  if the image is linked to the shape (when [getSourceFullName()](../../com.aspose.words/imagedata/\#getSourceFullName) / [setSourceFullName(java.lang.String)](../../com.aspose.words/imagedata/\#setSourceFullName-java.lang.String) is specified). (33361,6)
...
Returns  true  if the image is linked and not stored in the document. (33423,6)
