...
Gets the information about image size and resolution. (21469,6)
...
Gets the type of the image. (21515,6)
...
Returns  true  if the shape has image bytes or links an image. (21431,6)
...
Returns  true  if the image is linked to the shape (when [getSourceFullName()](../../com.aspose.words/imagedata/\#getSourceFullName) / [setSourceFullName(java.lang.String)](../../com.aspose.words/imagedata/\#setSourceFullName-java.lang.String) is specified). (21539,6)
...
Returns  true  if the image is linked and not stored in the document. (21601,6)
