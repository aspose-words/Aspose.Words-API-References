...
To append [Cell](../../com.aspose.words/cell/) to the document use **M:Aspose.Words.CompositeNode.InsertAfter1(0,Aspose.Words.Node)** or **M:Aspose.Words.CompositeNode.InsertBefore1(0,Aspose.Words.Node)** on the row where you want the cell inserted.
