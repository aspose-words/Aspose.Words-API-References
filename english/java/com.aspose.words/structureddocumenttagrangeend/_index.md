...
代表结束**ranged**接受多节内容的结构化文档标签。也可以看看[StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart)节点。
...
| [getId()](#getId--) | 为此指定一个唯一的只读持久数字 ID**StructuredDocumentTagRange**节点。 |
...
初始化一个新的实例**Structured document tag range end**班级。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| doc | [DocumentBase](../../com.aspose.words/documentbase) | 所有者文件。 |
| id | int | 相应结构化文档标记范围开始的标识符。 |
...
为此指定一个唯一的只读持久数字 ID**StructuredDocumentTagRange**节点。相应的[StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart)节点具有相同的[StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart\#getId--).
