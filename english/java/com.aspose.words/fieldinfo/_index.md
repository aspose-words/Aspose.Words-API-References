...
description: 实现 INFO 字段。
type: docs
weight: 208
url: /zh/java/com.aspose.words/fieldinfo/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段Info extends 字段
```
...
| [getInfo类型()](#getInfo类型--) | 获取要插入的文档属性的类型。 |
| [getLocaleId()](#getLocaleId--) | 获取字段的 LCID。 |
| [getNewValue()](#getNewValue--) | 获取更新属性的可选值。 |
...
| [setInfo类型(String value)](#setInfo类型-java.lang.String-) | 设置要插入的文档属性的类型。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setNewValue(String value)](#setNewValue-java.lang.String-) | 设置更新属性的可选值。 |
...
### setInfo类型(String value) {#setInfo类型-java.lang.String-}
```
public void setInfo类型(String value)
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要插入的文档属性的类型。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 更新属性的可选值。 |
