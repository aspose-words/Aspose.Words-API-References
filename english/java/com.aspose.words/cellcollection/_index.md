...
type: docs
weight: 49
url: /zh/java/com.aspose.words/cellcollection/
---
...
提供对集合的类型化访问[Cell](../../com.aspose.words/cell)节点。
...
| [get(int index)](#get-int-) | 检索一个**Cell**在给定的索引处。 |
| [get班级()](#get班级--) |  |
...
| [toArray()](#toArray--) | 将集合中的所有单元格复制到新的单元格数组中。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货:**
[Node](../../com.aspose.words/node) - 相应的[Cell](../../com.aspose.words/cell)价值。
### get班级() {#get班级--}
```
