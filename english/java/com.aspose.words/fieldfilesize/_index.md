...
```
public class 字段FileSize extends 字段
```
...
| [isInKilobytes()](#isInKilobytes--) | 获取是否以千字节为单位显示文件大小。 |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean-) | 设置是否以千字节为单位显示文件大小。 |
| [isInMegabytes()](#isInMegabytes--) | 获取是否以兆字节显示文件大小。 |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean-) | 设置是否以兆字节显示文件大小。 |
