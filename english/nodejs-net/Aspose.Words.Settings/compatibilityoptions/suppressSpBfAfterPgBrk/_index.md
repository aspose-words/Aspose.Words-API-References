---
title: CompatibilityOptions.suppressSpBfAfterPgBrk property
linktitle: suppressSpBfAfterPgBrk property
articleTitle: suppressSpBfAfterPgBrk property
...
```js
get suppressSpBfAfterPgBrk(): boolean
```
