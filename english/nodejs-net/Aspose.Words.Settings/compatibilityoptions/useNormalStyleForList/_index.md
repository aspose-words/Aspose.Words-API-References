---
title: CompatibilityOptions.useNormalStyleForList property
linktitle: useNormalStyleForList property
articleTitle: useNormalStyleForList property
...
```js
get useNormalStyleForList(): boolean
```
