---
title: CompatibilityOptions.truncateFontHeightsLikeWP6 property
linktitle: truncateFontHeightsLikeWP6 property
articleTitle: truncateFontHeightsLikeWP6 property
...
```js
get truncateFontHeightsLikeWP6(): boolean
```
