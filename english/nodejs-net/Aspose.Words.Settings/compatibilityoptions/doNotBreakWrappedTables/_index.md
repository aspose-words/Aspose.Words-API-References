---
title: CompatibilityOptions.doNotBreakWrappedTables property
linktitle: doNotBreakWrappedTables property
articleTitle: doNotBreakWrappedTables property
...
```js
get doNotBreakWrappedTables(): boolean
```
