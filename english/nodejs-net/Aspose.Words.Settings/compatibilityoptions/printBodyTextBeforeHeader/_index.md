---
title: CompatibilityOptions.printBodyTextBeforeHeader property
linktitle: printBodyTextBeforeHeader property
articleTitle: printBodyTextBeforeHeader property
...
```js
get printBodyTextBeforeHeader(): boolean
```
