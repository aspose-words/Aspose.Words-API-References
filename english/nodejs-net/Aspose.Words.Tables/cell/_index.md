...
type: docs
weight: 20
url: /nodejs-net/aspose.words.tables/cell/
---
...
[Cell](./) can contain block-level nodes [Paragraph](../../aspose.words/paragraph/) and [Table](../../aspose.words/table/).
...
| Name | Description |
| --- | --- |
| [cellFormat](./cellFormat/) | Provides access to the formatting properties of the cell. |
...
| [firstParagraph](./firstParagraph/) | Gets the first paragraph among the immediate children. |
...
| [lastParagraph](./lastParagraph/) | Gets the last paragraph among the immediate children. |
| [nextCell](./nextCell/) | Gets the next [Cell](./) node. |
...
| [nodeType](./nodeType/) | Returns [NodeType.Cell](../../aspose.words/nodetype/#Cell). |
...
| [parentRow](./parentRow/) | Returns the parent row of the cell. |
| [previousCell](./previousCell/) | Gets the previous [Cell](./) node. |
...
|[ acceptEnd(visitor)](./acceptEnd/#documentvisitor) | Accepts a visitor for visiting the end of the cell. |
|[ acceptStart(visitor)](./acceptStart/#documentvisitor) | Accepts a visitor for visiting the start of the cell. |
...
|[ asCell()](../../aspose.words/node/asCell/#default) | Cast node to [Cell](./).<br>(Inherited from [Node](../../aspose.words/node/)) |
...
|[ asRow()](../../aspose.words/node/asRow/#default) | Cast node to [Row](../row/).<br>(Inherited from [Node](../../aspose.words/node/)) |
