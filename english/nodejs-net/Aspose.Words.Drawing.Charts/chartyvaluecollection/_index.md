...
All items of the collection other than **null** must have the same [ChartYValue.valueType](../chartyvalue/valueType/).
...
| [formatCode](./formatCode/) | Gets or sets the format code applied to the Y values. |
| [this[]](./this[]/) |  |
...
* method [ChartSeries.insert()](../chartseries/insert/#number_chartxvalue)
