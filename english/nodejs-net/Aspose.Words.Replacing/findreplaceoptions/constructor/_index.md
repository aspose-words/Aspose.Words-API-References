...
## FindReplaceOptions(replacingCallback) {#ireplacingcallback}
...
| Parameter | Type | Description |
| --- | --- | --- |
| replacingCallback | [IReplacingCallback](../../ireplacingcallback/) | The callback to use for replacing found text. |

## FindReplaceOptions(direction, replacingCallback) {#findreplacedirection_ireplacingcallback}
