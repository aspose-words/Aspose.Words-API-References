...
A collection of [Field](../../Aspose.Words/field/) objects that represents the fields in the specified range.
...
|[ removeAt(index)](./removeAt/#number) | Removes a field at the specified index from this collection and from the document. |
