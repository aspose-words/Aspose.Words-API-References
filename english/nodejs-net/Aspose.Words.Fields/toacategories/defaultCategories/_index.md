...
type: docs
weight: 20
url: /nodejs-net/aspose.words.fields/toacategories/defaultCategories/
---
...
```js
get defaultCategories(): Aspose.Words.Fields.ToaCategories
```

### Remarks

Use the [FieldOptions.toaCategories](../../fieldoptions/toaCategories/) property to specify table of authorities categories for a single document.
