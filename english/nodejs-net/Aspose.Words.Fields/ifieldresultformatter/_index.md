...
| Name | Description |
| --- | --- |
|[ format(value, format)](./format/#string_generalformat) | Called when Aspose.Words applies a capitalization format switch, i.e. \\\* Upper. |
|[ format(value, format)](./format/#number_generalformat) | Called when Aspose.Words applies a number format switch, i.e. \\\* Ordinal. |
|[ formatDateTime(value, format, calendarType)](./formatDateTime/#date_string_calendartype) | Called when Aspose.Words applies a date/time format switch, i.e. \\@ "dd.MM.yyyy". |
|[ formatNumeric(value, format)](./formatNumeric/#number_string) | Called when Aspose.Words applies a numeric format switch, i.e. \\# "#.##". |
