...
type: docs
weight: 60
url: /nodejs-net/aspose.words.loading/txtloadoptions/leadingSpacesOptions/
---

## TxtLoadOptions.leadingSpacesOptions property

Gets or sets preferred option of a leading space handling.
Default value is [TxtLeadingSpacesOptions.ConvertToIndent](../../txtleadingspacesoptions/#ConvertToIndent).



```js
get leadingSpacesOptions(): Aspose.Words.Loading.TxtLeadingSpacesOptions
```
