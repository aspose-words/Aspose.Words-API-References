---
title: PageInfo.getSizeInPixels2 method
linktitle: getSizeInPixels2 method
articleTitle: getSizeInPixels2 method
...
```js
getSizeInPixels2(scale: numberdpi: number)
```
...
```js
getSizeInPixels2(scale: numberhorizontalDpi: numberverticalDpi: number)
```
