...
description: "Aspose.Words.Rendering.PageInfo class. Wraps ``Size`` for public API Node.js porting."
type: docs
weight: 30
...
| [sizeInPoints2](./sizeInPoints2/) | Gets the page size in points. |
...
| Name | Description |
| --- | --- |
|[ getSizeInPixels2(scale, dpi)](./getSizeInPixels2/#number_number) | Calculates the page size in pixels for a specified zoom factor and resolution. |
|[ getSizeInPixels2(scale, horizontalDpi, verticalDpi)](./getSizeInPixels2/#number_number_number) | Calculates the page size in pixels for a specified zoom factor and resolution. |
