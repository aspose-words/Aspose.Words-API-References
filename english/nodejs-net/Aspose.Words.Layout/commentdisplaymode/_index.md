...
| ShowInBalloons | Renders document comments in balloons in the margin. This is the default value. |
| ShowInAnnotations | Renders document comments in annotations. This is only available for Pdf format. |
