...
type: docs
weight: 790
url: /nodejs-net/aspose.words.saving/saveoutputparameters/
---
...
| Name | Description |
| --- | --- |
| [contentType](./contentType/) | Returns the Content-Type string (Internet Media Type) that identifies the type of the saved document. |
