...
type: docs
weight: 110
url: /nodejs-net/aspose.words.saving/doclingsaveoptions/
---
...
| Name | Description |
| --- | --- |
| [DoclingSaveOptions()](./constructor/#default) | The default constructor. |
...
| [renderNonImageShapes](./renderNonImageShapes/) | Gets or sets a value indicating whether non-image shapes should be rendered and written to the output Docling JSON document. |
| [saveFormat](./saveFormat/) | Specifies the format in which the document will be saved if this save options object is used. Can only be [SaveFormat.Docling](../../aspose.words/saveformat/#Docling). |
