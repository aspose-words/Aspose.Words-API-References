...
type: docs
weight: 10
url: /nodejs-net/aspose.words.saving/bookmarksoutlinelevelcollection/
---
...
| Name | Description |
| --- | --- |
|[ add(name, outlineLevel)](./add/#string_number) | Adds a bookmark to the collection. |
|[ clear()](./clear/#default) | Removes all elements from the collection. |
|[ contains(name)](./contains/#string) | Determines whether the collection contains a bookmark with the given name. |
|[ indexOfKey(name)](./indexOfKey/#string) | Returns the zero-based index of the specified bookmark in the collection. |
|[ remove(name)](./remove/#string) | Removes a bookmark with the specified name from the collection. |
