---
title: BuiltInDocumentProperties.charactersWithSpaces property
linktitle: charactersWithSpaces property
articleTitle: charactersWithSpaces property
...
```js
get charactersWithSpaces(): number
```
