...
| [newParent](./newParent/) | Gets the node's parent that will be set after the operation completes. |
| [node](./node/) | Gets the [NodeChangingArgs.node](./node/) that is being added or removed. |
| [oldParent](./oldParent/) | Gets the node's parent before the operation began. |
