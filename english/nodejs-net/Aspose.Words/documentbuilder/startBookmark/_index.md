...
type: docs
weight: 650
url: /nodejs-net/Aspose.Words/documentbuilder/startBookmark/
---

## startBookmark(bookmarkName) {#string}
...
call both [DocumentBuilder.startBookmark()](./#string) and [DocumentBuilder.endBookmark()](../endBookmark/#string) with the same *bookmarkName*
parameter.
