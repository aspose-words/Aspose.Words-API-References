...
This method should be called only once after [DocumentBuilder.endRow()](../endRow/#default) was called. When called,
[DocumentBuilder.endTable()](./#default) moves the cursor out of the current cell to point just after the table.
