...
type: docs
weight: 30
url: /nodejs-net/Aspose.Words/range/formFields/
---

## Range.formFields property

Returns a [Range.formFields](./) collection that represents all form fields in the range.



```js
get formFields(): Aspose.Words.Fields.FormFieldCollection
```
