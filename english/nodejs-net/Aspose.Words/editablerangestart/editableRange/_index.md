---
title: EditableRangeStart.editableRange property
linktitle: editableRange property
articleTitle: editableRange property
...
```js
get editableRange(): Aspose.Words.EditableRange
```
