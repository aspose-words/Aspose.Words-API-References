...
Use the [EditableRangeStart.editableRange](./editableRange/) class as a "facade" to work with an editable range
as a single object.
...
|[ asEditableRangeStart()](../node/asEditableRangeStart/#default) | Cast node to [EditableRangeStart](./).<br>(Inherited from [Node](../node/)) |
