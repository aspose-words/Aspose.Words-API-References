...
linktitle: BookmarkStart class
articleTitle: BookmarkStart class
...
| Name | Description |
| --- | --- |
| [BookmarkStart(doc, name)](./BookmarkStart/#documentbase_string) | Initializes a new instance of the [BookmarkStart](./) class. |
...
| [nodeType](./nodeType/) | Returns [NodeType.BookmarkStart](../nodetype/#BookmarkStart). |
...
|[ asBookmarkStart()](../node/asBookmarkStart/#default) | Cast node to [BookmarkStart](./).<br>(Inherited from [Node](../node/)) |
...
|[ getText()](./getText/#default) | Returns an empty string. |
