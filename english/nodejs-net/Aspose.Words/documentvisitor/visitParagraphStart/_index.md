---
title: DocumentVisitor.visitParagraphStart method
linktitle: visitParagraphStart method
articleTitle: visitParagraphStart method
...
```js
visitParagraphStart(paragraph: Aspose.Words.Paragraph)
```
