...
type: docs
weight: 280
url: /nodejs-net/aspose.words/documentvisitor/visitHeaderFooterEnd/
---
...
```js
visitHeaderFooterEnd(headerFooter: Aspose.Words.HeaderFooter)
```

| Parameter | Type | Description |
| --- | --- | --- |
| headerFooter | [HeaderFooter](../../headerfooter/) | The object that is being visited. |
