---
title: DocumentVisitor.visitCellStart method
linktitle: visitCellStart method
articleTitle: visitCellStart method
...
```js
visitCellStart(cell: Aspose.Words.Tables.Cell)
```
