---
title: DocumentVisitor.visitSmartTagEnd method
linktitle: visitSmartTagEnd method
articleTitle: visitSmartTagEnd method
...
```js
visitSmartTagEnd(smartTag: Aspose.Words.Markup.SmartTag)
```
