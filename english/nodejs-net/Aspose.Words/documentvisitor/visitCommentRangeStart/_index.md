---
title: DocumentVisitor.visitCommentRangeStart method
linktitle: visitCommentRangeStart method
articleTitle: visitCommentRangeStart method
...
```js
visitCommentRangeStart(commentRangeStart: Aspose.Words.CommentRangeStart)
```

| Parameter | Type | Description |
| --- | --- | --- |
| commentRangeStart | [CommentRangeStart](../../commentrangestart/) | The object that is being visited. |
