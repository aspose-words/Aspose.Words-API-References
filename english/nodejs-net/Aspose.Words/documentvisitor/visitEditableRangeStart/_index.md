...
```js
visitEditableRangeStart(editableRangeStart: Aspose.Words.EditableRangeStart)
```

| Parameter | Type | Description |
| --- | --- | --- |
| editableRangeStart | [EditableRangeStart](../../editablerangestart/) | The object that is being visited. |
