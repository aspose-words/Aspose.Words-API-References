---
title: DocumentVisitor.visitSectionStart method
linktitle: visitSectionStart method
articleTitle: visitSectionStart method
...
```js
visitSectionStart(section: Aspose.Words.Section)
```
