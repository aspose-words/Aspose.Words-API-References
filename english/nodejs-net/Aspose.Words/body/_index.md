---
title: Body class
linktitle: Body class
articleTitle: Body class
...
[Body](./) can contain [Paragraph](../paragraph/) and [Table](../table/) child nodes.
...
| [nodeType](./nodeType/) | Returns [NodeType.Body](../nodetype/#Body). |
...
|[ acceptEnd(visitor)](./acceptEnd/#documentvisitor) | Accepts a visitor for visiting the end of the document's body. |
|[ acceptStart(visitor)](./acceptStart/#documentvisitor) | Accepts a visitor for visiting the start of the document's body. |
...
|[ asBody()](../node/asBody/#default) | Cast node to [Body](./).<br>(Inherited from [Node](../node/)) |
