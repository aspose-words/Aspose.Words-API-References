...
A complete editable range  in a Word document consists of a [EditableRangeEnd.editableRangeStart](./editableRangeStart/)
and a matching [EditableRangeEnd](./) with the same Id.

[EditableRangeEnd.editableRangeStart](./editableRangeStart/) and [EditableRangeEnd](./) are just markers inside a document
...
| [editableRangeStart](./editableRangeStart/) | Corresponding [EditableRangeStart](../editablerangestart/), received by ID. |
...
| [nodeType](./nodeType/) | Returns [NodeType.EditableRangeEnd](../nodetype/#EditableRangeEnd). |
...
|[ asEditableRangeEnd()](../node/asEditableRangeEnd/#default) | Cast node to [EditableRangeEnd](./).<br>(Inherited from [Node](../node/)) |
