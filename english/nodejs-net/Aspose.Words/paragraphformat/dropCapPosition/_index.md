---
title: ParagraphFormat.dropCapPosition property
linktitle: dropCapPosition property
articleTitle: dropCapPosition property
...
```js
get dropCapPosition(): Aspose.Words.DropCapPosition
```
