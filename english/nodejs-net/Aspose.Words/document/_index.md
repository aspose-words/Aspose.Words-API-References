...
| [readabilityStatistics](./readabilityStatistics/) | Provides readability score information for the document. |
...
|[ importNode(srcNode, isImportChildren, importFormatMode, importFormatOptions)](../documentbase/importNode/#node_boolean_importformatmode_importformatoptions) | Imports a node from another document to the current document with an option to control formatting.<br>(Inherited from [DocumentBase](../documentbase/)) |
