...
type: docs
weight: 40
url: /nodejs-net/aspose.words/revision/parentNode/
---

## Revision.parentNode property

Gets the immediate parent node (owner) of this revision.
This property will work for any revision type other than [RevisionType.StyleDefinitionChange](../../revisiontype/#StyleDefinitionChange).



```js
get parentNode(): Aspose.Words.Node
```

### Remarks

If this revision relates to change of Style formatting, use [Revision.parentStyle](../parentStyle/) instead.
