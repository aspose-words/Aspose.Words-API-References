...
| [nodeType](./nodeType/) | Returns [NodeType.SubDocument](../nodetype/#SubDocument). |
...
|[ asSubDocument()](../node/asSubDocument/#default) | Cast node to [SubDocument](./).<br>(Inherited from [Node](../node/)) |
