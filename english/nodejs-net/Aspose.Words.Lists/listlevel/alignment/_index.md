...
type: docs
weight: 10
url: /nodejs-net/aspose.words.lists/listlevel/alignment/
---
...
```js
get alignment(): Aspose.Words.Lists.ListLevelAlignment
```

### Remarks

The list label is justified relative to the [ListLevel.numberPosition](../numberPosition/) property.
