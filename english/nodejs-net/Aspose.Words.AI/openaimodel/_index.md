...
|[ withApiKey(apiKey)](../aimodel/withApiKey/#string) | Sets a specified API key to the model.<br>(Inherited from [AiModel](../aimodel/)) |
|[ withOrganization(organizationId)](./withOrganization/#string) | Sets a specified Organization to the model. |
|[ withProject(projectId)](./withProject/#string) | Sets a specified Project to the model. |
