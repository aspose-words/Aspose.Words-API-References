...
| [preserveFormatting](./preserveFormatting/) | Allows to specify either Aspose.Words.AI.IAiModelText.CheckGrammar(Aspose.Words.Document,Aspose.Words.AI.CheckGrammarOptions) will try to preserve layout and formatting of the original document, or not. Default value is ``true``. |
