...
type: docs
weight: 60
url: /nodejs-net/Aspose.Words.Fonts/fontconfigsubstitutionrule/
---
...
| Name | Description |
| --- | --- |
|[ isFontConfigAvailable()](./isFontConfigAvailable/#default) | Check if fontconfig utility is available or not. |
|[ resetCache()](./resetCache/#default) | Resets the cache of fontconfig calling results. |
