...
| Name | Description |
| --- | --- |
| [StructuredDocumentTagRangeEnd(doc, id)](./StructuredDocumentTagRangeEnd/#documentbase_number) | Initializes a new instance of the **Structured document tag range end** class. |
...
| [nodeType](./nodeType/) | Returns [NodeType.StructuredDocumentTagRangeEnd](../../Aspose.Words/nodetype/#StructuredDocumentTagRangeEnd). |
...
|[ asStructuredDocumentTagRangeEnd()](../../Aspose.Words/node/asStructuredDocumentTagRangeEnd/#default) | Cast node to [StructuredDocumentTagRangeEnd](./).<br>(Inherited from [Node](../../Aspose.Words/node/)) |
