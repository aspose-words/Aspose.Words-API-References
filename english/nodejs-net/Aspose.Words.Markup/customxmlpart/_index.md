...
type: docs
weight: 30
url: /nodejs-net/aspose.words.markup/customxmlpart/
---
...
| [dataChecksum](./dataChecksum/) | Specifies a cyclic redundancy check (CRC) checksum of the [CustomXmlPart.data](./data/) content. |
