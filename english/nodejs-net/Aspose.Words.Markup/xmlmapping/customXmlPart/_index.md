---
title: XmlMapping.customXmlPart property
linktitle: customXmlPart property
articleTitle: customXmlPart property
...
```js
get customXmlPart(): Aspose.Words.Markup.CustomXmlPart
```
