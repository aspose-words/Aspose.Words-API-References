---
title: SdtListItemCollection.selectedValue property
linktitle: selectedValue property
articleTitle: selectedValue property
...
```js
get selectedValue(): Aspose.Words.Markup.SdtListItem
```
