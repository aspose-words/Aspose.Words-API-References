---
title: "Aspose::Words::WebExtensions::TaskPane::get_Row metodo"
linktitle: "get_Row"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::WebExtensions::TaskPane::get_Row metodo. Specifica l'indice, enumerato dall'esterno verso l'interno, di questo pannello attività tra gli altri pannelli attività persistenti agganciati nella stessa posizione predefinita in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.webextensions/taskpane/get_row/
---
## TaskPane::get_Row method


Specifica l'indice, enumerato dall'esterno verso l'interno, di questo task pane rispetto agli altri task pane persistenti ancorati nella stessa posizione predefinita.
