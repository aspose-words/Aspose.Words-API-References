...
description: "Aspose::Words::WebExtensions::TaskPaneCollection classe. Specifica un elenco di oggetti task pane persistenti. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Specifica un elenco di oggetti task pane persistenti. Per saperne di più, visita l'articolo di documentazione [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
