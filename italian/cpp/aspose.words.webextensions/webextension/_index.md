---
title: "Aspose::Words::WebExtensions::WebExtension classe"
linktitle: "WebExtension"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::WebExtensions::WebExtension classe. Rappresenta un oggetto di estensione web. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 4000
url: /it/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Rappresenta un oggetto web extension. Per saperne di più, visita l'articolo di documentazione [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Metodo | Descrizione |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Specifica riferimenti alternativi a un'estensione web. |
| [get_Bindings](./get_bindings/)() const | Specifica un elenco di binding di estensioni web. |
| [get_Id](./get_id/)() const | Identifica in modo univoco l'istanza dell'estensione web nel documento corrente. |
| [get_IsFrozen](./get_isfrozen/)() const | Specifica se l'utente può interagire con l'estensione web o meno. |
| [get_Properties](./get_properties/)() const | Rappresenta un insieme di proprietà personalizzate dell'estensione web. |
| [get_Reference](./get_reference/)() const | Specifica il riferimento principale a un'estensione web. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Metodo impostatore per [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Metodo impostatore per [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
