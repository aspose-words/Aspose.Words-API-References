...
description: "Aspose::Words::WebExtensions::WebExtensionStoreType enum. Elenca i tipi disponibili di un archivio di estensioni web in C++."
type: docs
weight: 13000
url: /it/cpp/aspose.words.webextensions/webextensionstoretype/
---
...
| --- | --- | --- |
| SPCatalog | 0 | Specifica che il tipo di archivio è il catalogo aziendale SharePoint. |
| OMEX | 1 | Specifica che il tipo di archivio è Office.com. |
| SPApp | 2 | Specifica che il tipo di archivio è un'applicazione web SharePoint. |
...
| ExCatalog | 6 | Specifica che il tipo di archivio è la distribuzione centralizzata tramite Exchange. |
