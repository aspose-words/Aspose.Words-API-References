...
description: "Classe Aspose::Words::WebExtensions::WebExtensionPropertyCollection. Specifica un insieme di proprietà personalizzate dell'estensione web. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 8000
url: /it/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Specifica un insieme di proprietà personalizzate dell'estensione web. Per saperne di più, visita l'articolo di documentazione [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
