...
description: "Aspose::Words::Markup::MarkupLevel enum. Specifica il livello nell'albero del documento in cui può comparire un particolare StructuredDocumentTag in C++."
type: docs
weight: 17000
url: /it/cpp/aspose.words.markup/markuplevel/
---
## MarkupLevel enum


Specifica il livello nell'albero del documento in cui può comparire un particolare [StructuredDocumentTag](../structureddocumenttag/).
...
| --- | --- | --- |
| Sconosciuto | 0 | Specifica un valore sconosciuto o non valido. |
| Inline | 1 | L'elemento si trova a livello inline (ad es. tra sequenze di testo). |
| Blocco | 2 | L'elemento si trova a livello di blocco (ad es. tra tabelle e paragrafi). |
| Row | 3 | L'elemento si trova tra le righe in una tabella. |
| Cella | 4 | L'elemento si trova tra le celle in una riga. |
