---
title: "Aspose::Words::Markup::CustomXmlPart::get_Id metodo"
linktitle: "get_Id"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Markup::CustomXmlPart::get_Id metodo. Ottiene o imposta la stringa che identifica questa parte XML personalizzata all'interno di un documento OOXML in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.markup/customxmlpart/get_id/
---
...
ISO/IEC 29500 specifica che questo valore è un GUID, ma le versioni precedenti di Microsoft Word consentivano qualsiasi stringa qui. Aspose.Words fa lo stesso per il formato ECMA-376. Tuttavia, nota che Microsoft Word Online non riesce ad aprire un documento creato con un valore non GUID. Quindi, un GUID è il valore consigliato per questa proprietà.

Un valore valido deve essere un identificatore che è unico tra tutte le parti di dati XML personalizzate in questo documento.
