---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat metodo"
linktitle: "get_DateStorageFormat"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat metodo. Ottiene/imposta il formato in cui la data per un SDT data è memorizzata quando lo SDT è associato a un nodo XML nel data store del documento. Il valore predefinito è DateTime in C++."
type: docs
weight: 14000
url: /it/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


Ottiene/imposta il formato in cui la data per un SDT data è memorizzata quando il **SDT** è associato a un nodo XML nel data store del documento. Il valore predefinito è [DateTime](../../sdtdatestorageformat/)
