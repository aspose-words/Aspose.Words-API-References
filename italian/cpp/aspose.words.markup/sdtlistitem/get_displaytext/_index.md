---
title: "Metodo get_DisplayText di Aspose::Words::Markup::SdtListItem"
linktitle: "get_DisplayText"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo get_DisplayText di Aspose::Words::Markup::SdtListItem. Ottiene il testo da visualizzare nel contenuto del run al posto del contenuto dell'attributo Value per questo elemento di elenco in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.markup/sdtlistitem/get_displaytext/
---
## SdtListItem::get_DisplayText method


Ottiene il testo da visualizzare nel contenuto del run al posto del contenuto dell'attributo [Value](../get_value/) per questo elemento di elenco.
