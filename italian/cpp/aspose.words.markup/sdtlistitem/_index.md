...
description: "Aspose::Words::Markup::SdtListItem class. Questo elemento specifica un singolo elemento di elenco all'interno di un tag di documento strutturato ComboBox o DropDownList padre. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 8000
url: /it/cpp/aspose.words.markup/sdtlistitem/
---
## SdtListItem class


Questo elemento specifica un singolo elemento di elenco all'interno di un tag di documento strutturato [ComboBox](../sdttype/) o [DropDownList](../sdttype/) padre. Per saperne di più, visita l'articolo di documentazione [Tag di documento strutturato o controllo del contenuto](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| Metodo | Descrizione |
| --- | --- |
| [get_DisplayText](./get_displaytext/)() const | Ottiene il testo da visualizzare nel contenuto del run al posto del contenuto dell'attributo [Value](./get_value/) per questo elemento di elenco. |
| [get_Value](./get_value/)() const | Ottiene il valore di questo elemento di elenco. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [SdtListItem](./sdtlistitem/)(const System::String\&, const System::String\&) | Inizializza una nuova istanza di questa classe. |
| [SdtListItem](./sdtlistitem/)(const System::String\&) | Inizializza una nuova istanza di questa classe. |
| static [Type](./type/)() |  |
