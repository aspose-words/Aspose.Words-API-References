---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id metodo"
linktitle: "get_Id"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id. Specifica un Id numerico unico, persistente, di sola lettura per questo tag di documento strutturato in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.markup/structureddocumenttagrangestart/get_id/
---
## StructuredDocumentTagRangeStart::get_Id method


Specifica un Id numerico persistente, univoco e di sola lettura per questo tag di documento strutturato.
...
L'attributo Id deve seguire queste regole:* Il documento deve conservare gli Id dei tag di documento strutturato solo se l'intero documento è clonato [Clone](../../../aspose.words/document/clone/).
