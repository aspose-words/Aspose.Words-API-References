---
title: "Metodo Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Tag"
linktitle: "get_Tag"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Tag. Specifica un tag associato al nodo corrente del tag di documento strutturato. Non può essere nullo in C++."
type: docs
weight: 18000
url: /it/cpp/aspose.words.markup/structureddocumenttagrangestart/get_tag/
---
## StructuredDocumentTagRangeStart::get_Tag method


Specifica un tag associato al nodo corrente del tag di documento strutturato. Non può essere **null**.
