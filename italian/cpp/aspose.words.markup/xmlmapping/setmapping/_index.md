---
title: "Aspose::Words::Markup::XmlMapping::SetMapping metodo"
linktitle: "SetMapping"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Markup::XmlMapping::SetMapping metodo. Imposta una mappatura tra l'etichetta di documento strutturato padre e un nodo XML di una parte di dati XML personalizzata in C++."
type: docs
weight: 10000
url: /it/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


Imposta una mappatura tra il tag di documento strutturato padre e un nodo XML di una parte di dati XML personalizzata.
...
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Una parte di dati XML personalizzata a cui mappare. |
| xPath | const System::String\& | Un'espressione XPath per trovare il nodo XML. |
| prefixMapping | const System::String\& | Mappature dei prefissi di spazio dei nomi XML per valutare l'XPath. |

### ReturnValue

Un flag che indica se l'etichetta di documento strutturato padre è mappata correttamente al nodo XML.
