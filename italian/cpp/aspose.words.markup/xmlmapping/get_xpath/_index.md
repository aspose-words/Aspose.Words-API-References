---
title: "Aspose::Words::Markup::XmlMapping::get_XPath metodo"
linktitle: "get_XPath"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Markup::XmlMapping::get_XPath metodo. Restituisce l'espressione XPath, che viene valutata per trovare il nodo XML personalizzato mappato al tag di documento strutturato genitore in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.markup/xmlmapping/get_xpath/
---
## XmlMapping::get_XPath method


Restituisce l'espressione XPath, che viene valutata per trovare il nodo XML personalizzato mappato al tag di documento strutturato padre.
