...
description: "Aspose::Words::Fonts::FontPitch enum. Rappresenta il pitch del carattere in C++."
type: docs
weight: 22000
url: /it/cpp/aspose.words.fonts/fontpitch/
---
## FontPitch enum
...
| --- | --- | --- |
| Default | 0 | Specifica che non sono disponibili informazioni sul pitch di un carattere. |
| Fixed | 1 | Specifica che questo è un carattere a larghezza fissa. |
| Variabile | 2 | Specifica che questo è un carattere a larghezza proporzionale. |
