...
description: "Aspose::Words::Bibliography::Person classe. Rappresenta un individuo (una persona) contributore della fonte bibliografica in C++."
type: docs
weight: 625
url: /it/cpp/aspose.words.bibliography/person/
---
## Person class


Rappresenta un contributore individuale (una persona) di una fonte bibliografica.
...
| [get_First](./get_first/)() const | Ottiene o imposta il nome di una persona. |
| [get_Last](./get_last/)() const | Ottiene o imposta il cognome di una persona. |
| [get_Middle](./get_middle/)() const | Ottiene o imposta il secondo nome di una persona. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Inizializza una nuova istanza della classe [Person](./). |
| [set_First](./set_first/)(const System::String\&) | Setter per [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | Setter per [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | Setter per [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
