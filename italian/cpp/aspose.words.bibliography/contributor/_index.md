...
linktitle: "Contributore"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Bibliography::Contributor class. Rappresenta un contributore di una fonte bibliografica. Può essere sia un'entità aziendale (un'organizzazione) sia un elenco di persone in C++."
type: docs
weight: 250
url: /it/cpp/aspose.words.bibliography/contributor/
---
## Contributor class


Rappresenta un contributore di una fonte bibliografica. Può essere sia un soggetto aziendale (un'organizzazione) sia un elenco di persone.
