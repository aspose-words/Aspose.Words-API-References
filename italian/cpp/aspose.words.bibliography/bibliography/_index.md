---
title: "Aspose::Words::Bibliography::Bibliography classe"
linktitle: "Bibliografia"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Bibliography::Bibliography classe. Rappresenta l'elenco delle fonti bibliografiche disponibili nel documento in C++."
type: docs
weight: 125
url: /it/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| Metodo | Descrizione |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Restituisce una stringa che rappresenta il nome dello stile attivo da utilizzare per una bibliografia. |
| [get_Sources](./get_sources/)() const | Restituisce una collezione che rappresenta tutte le fonti contenute in una bibliografia. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Imposta una stringa che rappresenta il nome dello stile attivo da utilizzare per una bibliografia. |
| static [Type](./type/)() |  |
