---
title: "Metodo Aspose::Words::DocumentBuilder::InsertGroupShape"
linktitle: "InsertGroupShape"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::DocumentBuilder::InsertGroupShape. Raggruppa le forme passate come parametro in un nuovo nodo GroupShape che viene inserito nella posizione corrente in C++."
type: docs
weight: 35500
url: /it/cpp/aspose.words/documentbuilder/insertgroupshape/
---
...
| --- | --- | --- |
| forme | const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Drawing::ShapeBase\>\>\& | L'elenco delle forme da raggruppare. |
## Note


La posizione e le dimensioni del nuovo GroupShape verranno calcolate automaticamente.
...
double width = 200;
double height = 300;
// Inserisci un nodo GroupShape per la dimensione specificata, che viene inserito nella posizione specificata.
...
// Inserisci un nodo GroupShape la cui posizione e dimensione verranno calcolate automaticamente.
...
// Combina nodi Shape e GroupShape.
auto shape3 = System::ExplicitCast<Aspose::Words::Drawing::Shape>(System::ExplicitCast<Aspose::Words::Node>(shape1)->Clone(true));
...
| superiore | double | Distanza in punti dall'origine al lato superiore della forma di gruppo. |
