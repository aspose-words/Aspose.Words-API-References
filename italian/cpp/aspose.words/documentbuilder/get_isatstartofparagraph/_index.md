...
description: "Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph method. Restituisce true se il cursore è all'inizio del paragrafo corrente (nessun testo prima del cursore) in C++."
type: docs
weight: 20000
url: /it/cpp/aspose.words/documentbuilder/get_isatstartofparagraph/
---
## DocumentBuilder::get_IsAtStartOfParagraph method


Restituisce **true** se il cursore si trova all'inizio del paragrafo corrente (nessun testo prima del cursore).
