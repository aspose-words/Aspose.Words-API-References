---
title: "Aspose::Words::ConditionalStyleCollection::idx_get metodo"
linktitle: "idx_get"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::ConditionalStyleCollection::idx_get metodo. Recupera un oggetto ConditionalStyle per tipo di stile condizionale in C++."
type: docs
weight: 18000
url: /it/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


Recupera un oggetto [ConditionalStyle](../../conditionalstyle/) per tipo di stile condizionale.
...
Recupera un oggetto [ConditionalStyle](../../conditionalstyle/) per indice.
...
| --- | --- | --- |
| index | int32_t | Indice basato su zero dello stile condizionale da recuperare. |
