...
description: "Aspose::Words::RunCollection class. Fornisce accesso tipizzato a una collezione di nodi Run. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 57000
url: /it/cpp/aspose.words/runcollection/
---
## RunCollection class


Fornisce accesso tipizzato a una collezione di nodi [Run](../run/). Per saperne di più, visita l'articolo di documentazione [Programming with Documents](https://docs.aspose.com/words/cpp/programming-with-documents/).
...
| [idx_get](./idx_get/)(int32_t) | Recupera un [Run](../run/) all'indice specificato. |
...
| [ToArray](./toarray/)() | Copia tutti i run dalla collezione in un nuovo array di run. |
| static [Type](./type/)() |  |
