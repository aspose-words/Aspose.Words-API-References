---
title: "Metodo Aspose::Words::RunCollection::ToArray"
linktitle: "ToArray"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::RunCollection::ToArray. Copia tutti i run dalla collezione in un nuovo array di run in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words/runcollection/toarray/
---
## RunCollection::ToArray method


Copia tutti i run dalla collezione in un nuovo array di run.
