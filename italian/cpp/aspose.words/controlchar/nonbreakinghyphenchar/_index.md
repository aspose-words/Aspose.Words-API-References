---
title: "Campo Aspose::Words::ControlChar::NonBreakingHyphenChar"
linktitle: "NonBreakingHyphenChar"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::ControlChar::NonBreakingHyphenChar campo. Il trattino non interrotto in Microsoft Word è (char)30 in C++."
type: docs
weight: 22000
url: /it/cpp/aspose.words/controlchar/nonbreakinghyphenchar/
---
## NonBreakingHyphenChar field


Il trattino non separabile in Microsoft Word è (char)30.
...
Il trattino non interrotto in Microsoft Word non corrisponde al carattere Unicode U+2011 trattino non interrotto, ma rappresenta invece informazioni interne che indicano a Microsoft Word di visualizzare un trattino e di non interrompere la riga.

Informazioni utili: [http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks](http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks).
