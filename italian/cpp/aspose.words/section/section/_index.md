---
title: "Aspose::Words::Section::Section costruttore"
linktitle: "Sezione"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Section::Section costruttore. Inizializza una nuova istanza della classe Section in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words/section/section/
---
...
Quando la sezione viene creata, appartiene al documento specificato, ma non fa ancora parte del documento e [ParentNode](../../node/get_parentnode/) è **null**.

Per includere [Section](../) in un documento usa i metodi [InsertAfter1()</see> e <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\>, System::SharedPtr\<Aspose::Words::Node\>)\">InsertBefore1()](../) del [Document](../../document/) O i metodi [Add()](../) e [Insert()](../) della proprietà [Sections](../../document/get_sections/).
