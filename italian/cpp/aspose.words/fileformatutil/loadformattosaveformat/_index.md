...
description: "Aspose::Words::FileFormatUtil::LoadFormatToSaveFormat method. Converte un valore LoadFormat in un valore SaveFormat, se possibile, in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words/fileformatutil/loadformattosaveformat/
---
## FileFormatUtil::LoadFormatToSaveFormat method


Converte un valore [LoadFormat](../../loadformat/) in un valore [SaveFormat](../../saveformat/) se possibile.
