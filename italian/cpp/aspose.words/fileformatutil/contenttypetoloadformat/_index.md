---
title: "Aspose::Words::FileFormatUtil::ContentTypeToLoadFormat metodo"
linktitle: "ContentTypeToLoadFormat"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::FileFormatUtil::ContentTypeToLoadFormat metodo. Converte il tipo di contenuto IANA in un valore enumerato di formato di caricamento in C++."
type: docs
weight: 1000
url: /it/cpp/aspose.words/fileformatutil/contenttypetoloadformat/
---
...
Mostra come trovare il corrispondente formato di caricamento/salvataggio **Aspose** da ogni stringa di tipo media.
```cpp
// I metodi ContentTypeToSaveFormat/ContentTypeToLoadFormat accettano solo i nomi ufficiali dei tipi media IANA, noti anche come tipi MIME.
// Tutti i tipi media validi sono elencati qui: https://www.iana.org/assignments/media-types/media-types.xhtml.

// Tentare di associare un SaveFormat a una stringa di tipo media parziale non funzionerà.
ASSERT_THROW(static_cast<std::function<void()>>([]() -> void
{
    Aspose::Words::FileFormatUtil::ContentTypeToSaveFormat(u"jpeg");
})(), System::ArgumentException);

// Se Aspose.Words non dispone di un formato di salvataggio/caricamento corrispondente per un tipo di contenuto, verrà sollevata anche un'eccezione.
ASSERT_THROW(static_cast<std::function<void()>>([]() -> void
{
...
// Per i tipi di file che possono essere salvati e caricati, possiamo associare un tipo media sia a un formato di caricamento sia a un formato di salvataggio.
