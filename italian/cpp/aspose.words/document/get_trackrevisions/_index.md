---
title: "Aspose::Words::Document::get_TrackRevisions metodo"
linktitle: "get_TrackRevisions"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Document::get_TrackRevisions metodo. Vero se le modifiche sono tracciate quando questo documento è modificato in Microsoft Word in C++."
type: docs
weight: 54000
url: /it/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


Vero se le modifiche sono tracciate quando questo documento viene modificato in Microsoft Word.
...
Impostare questa opzione indica a Microsoft Word solo se il tracciamento delle modifiche è attivato o disattivato. Questa proprietà non ha effetto sulle modifiche al documento che vengono apportate programmaticamente tramite Aspose.Words.

Se desideri tracciare automaticamente le modifiche man mano che vengono apportate programmaticamente da [Aspose.Words](../../) a questo documento, usa il metodo [StartTrackRevisions()](../).
