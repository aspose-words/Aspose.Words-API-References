---
title: "Classe Aspose::Words::AbsolutePositionTab"
linktitle: "AbsolutePositionTab"
second_title: "Riferimento API Aspose.Words per C++"
description: "Classe Aspose::Words::AbsolutePositionTab. Un tabulatore a posizione assoluta è un carattere che viene usato per avanzare la posizione sulla riga corrente di testo quando si visualizza questo contenuto WordprocessingML. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 1000
url: /it/cpp/aspose.words/absolutepositiontab/
---
## AbsolutePositionTab class


Una tabulazione di posizione assoluta è un carattere utilizzato per avanzare la posizione sulla riga corrente di testo quando si visualizza questo contenuto WordprocessingML. Per saperne di più, visita l'articolo di documentazione [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_NodeType](../specialchar/get_nodetype/)() const override | Restituisce [SpecialChar](../nodetype/). |
...
| [GetText](../specialchar/gettext/)() override | Ottiene il carattere speciale che questo nodo rappresenta. |
