...
description: "Aspose::Words::LineNumberRestartMode enum. Determina quando la numerazione automatica delle righe riprende in C++."
type: docs
weight: 94000
url: /it/cpp/aspose.words/linenumberrestartmode/
---
...
| --- | --- | --- |
| RestartPage | 0 | La numerazione delle righe riprende all'inizio di ogni pagina. |
| RestartSection | 1 | La numerazione delle righe riprende all'inizio della sezione. |
| Continuous | 2 | La numerazione delle righe è continua dalla sezione precedente. |
