---
title: "Metodo Aspose::Words::Font::get_ThemeFontAscii"
linktitle: "get_ThemeFontAscii"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Font::get_ThemeFontAscii. Ottiene o imposta il font del tema usato per il testo latino (caratteri con codici da 0 (zero) a 127) nello schema di caratteri applicato che è associato a questo oggetto Font in C++."
type: docs
weight: 50000
url: /it/cpp/aspose.words/font/get_themefontascii/
---
## Font::get_ThemeFontAscii method


Ottiene o imposta il font del tema usato per il testo latino (caratteri con codici da 0 (zero) a 127) nello schema di caratteri applicato che è associato a questo oggetto [Font](../).
