---
title: "Metodo Aspose::Words::SignatureLineOptions::get_Email"
linktitle: "get_Email"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::SignatureLineOptions::get_Email. Ottiene o imposta l'indirizzo e‑mail suggerito del firmatario. Il valore predefinito per questa proprietà è una stringa vuota in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words/signaturelineoptions/get_email/
---
## SignatureLineOptions::get_Email method


Ottiene o imposta l'indirizzo e‑mail del firmatario suggerito. Il valore predefinito per questa proprietà è **empty string**.
