---
title: "Metodo Aspose::Words::SignatureLineOptions::get_DefaultInstructions"
linktitle: "get_DefaultInstructions"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::SignatureLineOptions::get_DefaultInstructions. Ottiene o imposta un valore che indica se le istruzioni predefinite sono mostrate nella finestra di dialogo Sign. Il valore predefinito per questa proprietà è true in C++."
type: docs
weight: 4000
url: /it/cpp/aspose.words/signaturelineoptions/get_defaultinstructions/
---
## SignatureLineOptions::get_DefaultInstructions method


Ottiene o imposta un valore che indica se le istruzioni predefinite sono visualizzate nella finestra di dialogo Firma. Il valore predefinito per questa proprietà è **true**.
