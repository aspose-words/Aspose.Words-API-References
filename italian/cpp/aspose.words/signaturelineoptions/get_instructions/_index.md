---
title: "Aspose::Words::SignatureLineOptions::get_Instructions metodo"
linktitle: "get_Instructions"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::SignatureLineOptions::get_Instructions. Ottiene o imposta le istruzioni per il firmatario che vengono visualizzate durante la firma della linea di firma. Il valore predefinito per questa proprietà è una stringa vuota in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


Ottiene o imposta le istruzioni per il firmatario visualizzate durante la firma della riga della firma. Il valore predefinito per questa proprietà è **empty string**.
