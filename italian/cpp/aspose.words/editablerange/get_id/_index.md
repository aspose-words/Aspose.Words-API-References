---
title: "Metodo Aspose::Words::EditableRange::get_Id"
linktitle: "get_Id"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::EditableRange::get_Id. Ottiene l'identificatore dell'intervallo modificabile in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words/editablerange/get_id/
---
...
L'area deve essere delimitata usando [EditableRangeStart](../get_editablerangestart/) e [EditableRangeEnd](../get_editablerangeend/).

Gli identificatori degli intervalli modificabili dovrebbero essere unici all'interno di un documento e Aspose.Words mantiene automaticamente gli identificatori degli intervalli modificabili durante il caricamento, il salvataggio e la combinazione dei documenti.
