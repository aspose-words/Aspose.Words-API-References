---
title: "Costruttore Aspose::Words::Run::Run"
linktitle: "Run"
second_title: "Riferimento API Aspose.Words per C++"
description: "Costruttore Aspose::Words::Run::Run. Inizializza una nuova istanza della classe Run in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words/run/run/
---
...
Quando [Run](../) viene creato, appartiene al documento specificato, ma non è ancora parte del documento e [ParentNode](../../node/get_parentnode/) è **null**.

Per aggiungere [Run](../) al documento usa [InsertAfter1()</see> o <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) nel paragrafo dove desideri inserire il run.
...
| --- | --- | --- |
| doc | const System::SharedPtr\<Aspose::Words::DocumentBase\>\& | Il documento proprietario. |
| testo | const System::String\& | Il testo del run. |
## Note
