...
type: docs
weight: 6000
url: /it/cpp/aspose.words.digitalsignatures/digitalsignaturetype/
---
...
| --- | --- | --- |
| Sconosciuto | 0 | Indica un errore, tipo di firma digitale sconosciuto. |
| CryptoApi | 1 | Il metodo di firma Crypto API utilizzato nei documenti binari .DOC di Microsoft Word 97-2003. |
