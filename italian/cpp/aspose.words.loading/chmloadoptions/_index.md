...
description: "Aspose::Words::Loading::ChmLoadOptions class. Consente di specificare opzioni aggiuntive durante il caricamento di un documento CHM in un oggetto Document. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 1000
url: /it/cpp/aspose.words.loading/chmloadoptions/
---
## ChmLoadOptions class


Consente di specificare opzioni aggiuntive durante il caricamento di un documento CHM in un oggetto [Document](../../aspose.words/document/). Per saperne di più, visita l'articolo di documentazione [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_OriginalFileName](./get_originalfilename/)() const | Il nome del file CHM. Il valore predefinito è **null**. |
...
| [set_OriginalFileName](./set_originalfilename/)(const System::String\&) | Metodo setter per [Aspose::Words::Loading::ChmLoadOptions::get_OriginalFileName](./get_originalfilename/). |
