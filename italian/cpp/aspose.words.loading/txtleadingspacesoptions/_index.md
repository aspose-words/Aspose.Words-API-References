...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. Specifica le opzioni disponibili per la gestione degli spazi iniziali durante l'importazione da file di testo in C++."
type: docs
weight: 18000
url: /it/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Specifica le opzioni disponibili per la gestione degli spazi iniziali durante l'importazione da file [Testo](../../aspose.words/loadformat/).
...
| --- | --- | --- |
| ConvertToIndent | 0 | Gli spazi iniziali vengono rimossi e convertiti in rientro a sinistra. |
| Trim | 1 | Gli spazi iniziali vengono tagliati. |
| Preserve | 2 | Gli spazi iniziali vengono preservati. |
