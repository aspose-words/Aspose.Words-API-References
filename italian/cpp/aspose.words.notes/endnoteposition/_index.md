...
description: "Aspose::Words::Notes::EndnotePosition enum. Definisce la posizione della nota a pié di pagina in C++."
type: docs
weight: 4000
url: /it/cpp/aspose.words.notes/endnoteposition/
---
...
| --- | --- | --- |
| EndOfSection | 0 | Le note a piè di pagina vengono generate alla fine della sezione. |
| EndOfDocument | 3 | Le note a piè di pagina vengono generate alla fine del documento. |
