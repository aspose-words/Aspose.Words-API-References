...
description: "Aspose::Words::Drawing::GradientStop classe. Rappresenta un punto di gradiente. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.drawing/gradientstop/
---
## GradientStop class


Rappresenta una fermata di gradiente. Per saperne di più, visita l'articolo di documentazione [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/).
...
| Metodo | Descrizione |
| --- | --- |
| [get_BaseColor](./get_basecolor/)() | Restituisce un valore che rappresenta il colore del punto di gradiente senza alcun modificatore. |
| [get_Color](./get_color/)() | Ottiene o imposta un valore che rappresenta il colore del punto di gradiente. |
| [get_Position](./get_position/)() const | Ottiene o imposta un valore che rappresenta la posizione di un punto all'interno del gradiente espresso come percentuale nell'intervallo da 0.0 a 1.0. |
| [get_Transparency](./get_transparency/)() const | Ottiene o imposta un valore che rappresenta la trasparenza del riempimento del gradiente espresso come percentuale nell'intervallo da 0.0 a 1.0. |
| [GetType](./gettype/)() const override |  |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double) | Inizializza una nuova istanza della classe [GradientStop](./). |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double, double) | Inizializza una nuova istanza della classe [GradientStop](./). |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)() | Rimuove il punto di gradiente dal genitore [GradientStopCollection](../gradientstopcollection/). |
| [set_Color](./set_color/)(System::Drawing::Color) | Setter per [Aspose::Words::Drawing::GradientStop::get_Color](./get_color/). |
| [set_Position](./set_position/)(double) | Setter per [Aspose::Words::Drawing::GradientStop::get_Position](./get_position/). |
| [set_Transparency](./set_transparency/)(double) | Setter per [Aspose::Words::Drawing::GradientStop::get_Transparency](./get_transparency/). |
| static [Type](./type/)() |  |
