---
title: "Aspose::Words::Drawing::GradientStop::GradientStop costruttore"
linktitle: "GradientStop"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::GradientStop::GradientStop costruttore. Inizializza una nuova istanza della classe GradientStop in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
## GradientStop::GradientStop(System::Drawing::Color, double) constructor


Inizializza una nuova istanza della classe [GradientStop](../).
...
| --- | --- | --- |
| color | System::Drawing::Color | Rappresenta il colore dello stop gradiente. |
| posizione | double | Rappresenta la posizione di uno stop all'interno del gradiente espresso come percentuale nell'intervallo 0.0 a 1.0. |
...
| color | System::Drawing::Color | Rappresenta il colore dello stop gradiente. |
| posizione | double | Rappresenta la posizione di uno stop all'interno del gradiente espresso come percentuale nell'intervallo 0.0 a 1.0. |
| trasparenza | double | Rappresenta la trasparenza di uno stop all'interno del gradiente espresso come percentuale nell'intervallo 0.0 a 1.0. |
