---
title: "Aspose::Words::Drawing::GradientStop::get_Position metodo"
linktitle: "get_Position"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::GradientStop::get_Position metodo. Ottiene o imposta un valore che rappresenta la posizione di uno stop all'interno del gradiente espresso come percentuale nell'intervallo 0.0 a 1.0 in C++."
type: docs
weight: 4000
url: /it/cpp/aspose.words.drawing/gradientstop/get_position/
---
## GradientStop::get_Position method


Ottiene o imposta un valore che rappresenta la posizione di un punto all'interno del gradiente espresso come percentuale nell'intervallo da 0.0 a 1.0.
