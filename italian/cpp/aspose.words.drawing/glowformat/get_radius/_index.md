---
title: "Metodo Aspose::Words::Drawing::GlowFormat::get_Radius"
linktitle: "get_Radius"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Drawing::GlowFormat::get_Radius. Ottiene o imposta un valore double che rappresenta la lunghezza del raggio per un effetto bagliore in punti (pt). Il valore predefinito è 0.0 in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.drawing/glowformat/get_radius/
---
## GlowFormat::get_Radius method


Ottiene o imposta un valore double che rappresenta la lunghezza del raggio per un effetto di bagliore in punti (pt). Il valore predefinito è 0.0.
