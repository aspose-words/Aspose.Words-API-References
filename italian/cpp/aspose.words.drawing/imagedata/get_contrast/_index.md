---
title: "Aspose::Words::Drawing::ImageData::get_Contrast metodo"
linktitle: "get_Contrast"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Drawing::ImageData::get_Contrast. Ottiene o imposta il contrasto per l'immagine specificata. Il valore di questa proprietà deve essere un numero da 0.0 (il contrasto più basso) a 1.0 (il contrasto più alto) in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.drawing/imagedata/get_contrast/
---
## ImageData::get_Contrast method


Ottiene o imposta il contrasto per l'immagine specificata. Il valore di questa proprietà deve essere un numero compreso tra 0.0 (meno contrasto) e 1.0 (massimo contrasto).
