...
description: "Aspose::Words::Drawing::GradientVariant enum. Specifica la variante per un riempimento gradiente in C++."
type: docs
weight: 25000
url: /it/cpp/aspose.words.drawing/gradientvariant/
---
...
| --- | --- | --- |
| None | 0 | Variante di gradiente 'None'. |
| Variant1 | 1 | Variante di gradiente 1. |
| Variant2 | 2 | Variante di gradiente 2. |
| Variant3 | 3 | Variante di gradiente 3. |
| Variant4 | 4 | Variante di gradiente 4. |
