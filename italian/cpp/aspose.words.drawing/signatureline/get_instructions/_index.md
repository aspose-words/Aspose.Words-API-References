---
title: "Aspose::Words::Drawing::SignatureLine::get_Instructions metodo"
linktitle: "get_Instructions"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::SignatureLine::get_Instructions metodo. Ottiene o imposta le istruzioni per il firmatario che vengono visualizzate durante la firma della riga di firma. Questa proprietà è ignorata se DefaultInstructions è impostata. Il valore predefinito per questa proprietà è stringa vuota in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.drawing/signatureline/get_instructions/
---
## SignatureLine::get_Instructions method


Ottiene o imposta le istruzioni per il firmatario che vengono visualizzate durante la firma della riga di firma. Questa proprietà è ignorata se [DefaultInstructions](../get_defaultinstructions/) è impostata. Il valore predefinito per questa proprietà è **stringa vuota**.
