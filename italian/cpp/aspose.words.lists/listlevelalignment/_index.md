...
description: "Aspose::Words::Lists::ListLevelAlignment enum. Specifica l'allineamento per il numero o il pallino dell'elenco in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.lists/listlevelalignment/
---
## ListLevelAlignment enum


Specifica l'allineamento per il numero o il simbolo dell'elenco.
...
| --- | --- | --- |
| Sinistra | 0 | L'etichetta dell'elenco è allineata a sinistra della posizione del numero. |
| Centro | 1 | L'etichetta dell'elenco è centrata nella posizione del numero. |
| Destra | 2 | Questa etichetta dell'elenco è allineata a destra della posizione del numero. |

## Note


Usato come valore per la proprietà [Alignment](../listlevel/get_alignment/).
