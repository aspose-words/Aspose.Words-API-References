---
title: "Metodo Aspose::Words::Lists::ListLevel::get_NumberFormat"
linktitle: "get_NumberFormat"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Lists::ListLevel::get_NumberFormat. Restituisce o imposta il formato numerico per il livello dell'elenco in C++."
type: docs
weight: 12000
url: /it/cpp/aspose.words.lists/listlevel/get_numberformat/
---
## ListLevel::get_NumberFormat method


Restituisce o imposta il formato del numero per il livello di elenco.
...
Tra i caratteri di testo normali, la stringa può contenere caratteri segnaposto \x0000 a \x0008 che rappresentano i numeri dei corrispondenti livelli dell'elenco.

Ad esempio, la stringa "\x0000.\x0001)" genererà un'etichetta di elenco che appare più o meno così "1.5)". Il numero "1" è il numero corrente dal primo livello dell'elenco, il numero "5" è il numero corrente dal secondo livello dell'elenco.

Null non è consentito, ma una stringa vuota che indica nessun numero è valida.
