---
title: "Aspose::Words::Lists::List::get_IsListStyleDefinition metodo"
linktitle: "get_IsListStyleDefinition"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition metodo. Restituisce true se questo elenco è una definizione di uno stile di elenco in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
## List::get_IsListStyleDefinition method


Restituisce **true** se questo elenco è una definizione di uno stile di elenco.
...
Quando questa proprietà è **true**, la proprietà [Style](../get_style/) restituisce lo stile di elenco che questo elenco definisce.

Modificando le proprietà di un elenco che definisce uno stile di elenco, si modificano le proprietà dello stile di elenco.

Un elenco che è una definizione di uno stile di elenco non può essere applicato direttamente ai paragrafi per numerarli.
