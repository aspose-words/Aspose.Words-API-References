...
description: "Classe Aspose::Words::Lists::ListLevelCollection. Una collezione di formattazione di elenco per ogni livello in un elenco. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.lists/listlevelcollection/
---
## ListLevelCollection class


Una raccolta di formattazioni di elenco per ogni livello in un elenco. Per saperne di più, visita l'articolo di documentazione [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/).
...
| [end](./end/)() |  |
| [end](./end/)() const |  |
| [get_Count](./get_count/)() | Ottiene il numero di livelli in questo elenco. |
| [GetEnumerator](./getenumerator/)() override | Ottiene l'oggetto enumeratore che elencherà i livelli in questo elenco. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Ottiene un livello dell'elenco per indice. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Lists::ListLevel\>\&) | Ottiene un livello dell'elenco per indice. |
