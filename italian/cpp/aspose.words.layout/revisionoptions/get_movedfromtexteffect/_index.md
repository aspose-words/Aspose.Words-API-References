...
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect method. Consente di specificare l'effetto da applicare alle aree da cui il contenuto è stato spostato Moving. Il valore predefinito è DoubleStrikeThrough in C++."
type: docs
weight: 9000
url: /it/cpp/aspose.words.layout/revisionoptions/get_movedfromtexteffect/
---
## RevisionOptions::get_MovedFromTextEffect method


Consente di specificare l'effetto da applicare alle aree da cui il contenuto è stato spostato [Moving](../../../aspose.words/revisiontype/). Il valore predefinito è [DoubleStrikeThrough](../../revisiontexteffect/)
