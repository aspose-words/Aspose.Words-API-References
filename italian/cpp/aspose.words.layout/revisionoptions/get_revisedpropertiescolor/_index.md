---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor metodo"
linktitle: "get_RevisedPropertiesColor"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor metodo. Consente di specificare il colore da utilizzare per il contenuto con modifiche delle proprietà di formattazione FormatChange. Il valore predefinito è NoHighlight in C++."
type: docs
weight: 12000
url: /it/cpp/aspose.words.layout/revisionoptions/get_revisedpropertiescolor/
---
## RevisionOptions::get_RevisedPropertiesColor method


Consente di specificare il colore da utilizzare per il contenuto con modifiche delle proprietà di formattazione [FormatChange](../../../aspose.words/revisiontype/). Il valore predefinito è [NoHighlight](../../revisioncolor/).
