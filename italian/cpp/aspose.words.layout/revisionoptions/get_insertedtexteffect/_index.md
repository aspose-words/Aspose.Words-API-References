...
description: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect method. Consente di specificare l'effetto da applicare al contenuto inserito Insertion. Il valore predefinito è Underline in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.layout/revisionoptions/get_insertedtexteffect/
---
## RevisionOptions::get_InsertedTextEffect method


Consente di specificare l'effetto da applicare al contenuto inserito [Insertion](../../../aspose.words/revisiontype/). Il valore predefinito è [Underline](../../revisiontexteffect/).
