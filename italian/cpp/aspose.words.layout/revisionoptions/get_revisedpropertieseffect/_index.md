---
title: "metodo Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect"
linktitle: "get_RevisedPropertiesEffect"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect method. Consente di specificare l'effetto per le aree di contenuto con modifiche delle proprietà di formattazione FormatChange. Il valore predefinito è None in C++."
type: docs
weight: 13000
url: /it/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


Consente di specificare l'effetto per le aree di contenuto con modifiche delle proprietà di formattazione [FormatChange](../../../aspose.words/revisiontype/) Il valore predefinito è [None](../../revisiontexteffect/)
