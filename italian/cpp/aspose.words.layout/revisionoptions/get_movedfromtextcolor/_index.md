---
title: "Metodo Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor"
linktitle: "get_MovedFromTextColor"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor. Consente di specificare il colore da utilizzare per le aree in cui il contenuto è stato spostato da Moving. Il valore predefinito è ByAuthor in C++."
type: docs
weight: 8000
url: /it/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Consente di specificare il colore da utilizzare per le aree in cui il contenuto è stato spostato da [Moving](../../../aspose.words/revisiontype/). Il valore predefinito è [ByAuthor](../../revisioncolor/).
