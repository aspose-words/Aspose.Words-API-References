---
title: "Metodo Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor"
linktitle: "get_RevisionBarsColor"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor. Consente di specificare il colore da utilizzare per le barre laterali che identificano le righe del documento contenenti informazioni revisionate. Il valore predefinito è Red in C++."
type: docs
weight: 14000
url: /it/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


Consente di specificare il colore da utilizzare per le barre laterali che identificano le righe del documento contenenti informazioni revisionate. Il valore predefinito è [Red](../../revisioncolor/).
