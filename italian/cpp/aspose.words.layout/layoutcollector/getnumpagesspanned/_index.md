---
title: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned metodo"
linktitle: "GetNumPagesSpanned"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned metodo. Ottiene il numero di pagine che il nodo specificato occupa. 0 se il nodo è all'interno di una singola pagina. Questo è lo stesso di GetEndPageIndex() - GetStartPageIndex() in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


Ottiene il numero di pagine che il nodo specificato occupa. 0 se il nodo è all'interno di una singola pagina. Questo è lo stesso di [GetEndPageIndex()](../) - [GetStartPageIndex()](../).
