---
title: "Aspose::Words::Layout::ShowInBalloons enumerazione"
linktitle: "ShowInBalloons"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Layout::ShowInBalloons enumerazione. Specifica quali revisioni sono renderizzate in balloons in C++."
type: docs
weight: 13000
url: /it/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Specifica quali revisioni sono renderizzate in balloon.
...
| --- | --- | --- |
| None | 0 | Renderizza le revisioni di inserimento, eliminazione e formattazione in linea. |
| Formato | 1 | Renderizza le revisioni di inserimento e eliminazione in linea, le revisioni di formattazione in balloons. |
| FormatAndDelete | 2 | Esegue il rendering delle revisioni di inserimento in linea, delle revisioni di eliminazione e di formattazione nei balloon. |
