...
description: "Aspose::Words::Saving::WordML2003SaveOptions class. Può essere usato per specificare opzioni aggiuntive quando si salva un documento nel formato WordML. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 35000
url: /it/cpp/aspose.words.saving/wordml2003saveoptions/
---
## WordML2003SaveOptions class


Può essere usato per specificare opzioni aggiuntive durante il salvataggio di un documento nel formato [WordML](../../aspose.words/saveformat/). Per saperne di più, visita l'articolo di documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere solo [WordML](../../aspose.words/saveformat/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter per [Aspose::Words::Saving::WordML2003SaveOptions::get_SaveFormat](./get_saveformat/). |
...
Al momento fornisce solo la proprietà [SaveFormat](./get_saveformat/), ma in futuro potrebbero essere aggiunte altre opzioni.
...
// durante l'operazione di salvataggio del documento a costo di un tempo di salvataggio più lungo.
