---
title: "metodo Aspose::Words::Saving::SaveOptions::get_PrettyFormat"
linktitle: "get_PrettyFormat"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat metodo. Quando è true, formatta in modo leggibile l'output dove applicabile. Il valore predefinito è false in C++."
type: docs
weight: 12000
url: /it/cpp/aspose.words.saving/saveoptions/get_prettyformat/
---
## SaveOptions::get_PrettyFormat method


Quando **true**, formatta in modo leggibile l'output dove applicabile. Il valore predefinito è **false**.
...
Imposta su **true** per rendere l'output HTML, MHTML, EPUB, WordML, RTF, DOCX e ODT leggibile dall'uomo. Utile per test o debug.
...
// Abilitare il formato leggibile rende il codice html grezzo più leggibile aggiungendo tabulazioni e caratteri di nuova riga.
