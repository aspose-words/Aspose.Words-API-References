...
description: "Classe Aspose::Words::Saving::XpsSaveOptions. Può essere usata per specificare opzioni aggiuntive quando si salva un documento nel formato Xps. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 38000
url: /it/cpp/aspose.words.saving/xpssaveoptions/
---
## XpsSaveOptions class


Può essere usata per specificare opzioni aggiuntive quando si salva un documento nel formato [Xps](../../aspose.words/saveformat/). Per saperne di più, visita l'articolo di documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere solo [Xps](../../aspose.words/saveformat/). |
...
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Imposta [Aspose::Words::Saving::XpsSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Imposta [Aspose::Words::Saving::XpsSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Imposta [Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | Imposta [Aspose::Words::Saving::XpsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/). |
...
| static [Type](./type/)() |  |
| [XpsSaveOptions](./xpssaveoptions/)() | Inizializza una nuova istanza di questa classe che può essere usata per salvare un documento nel formato [Xps](../../aspose.words/saveformat/). |
| [XpsSaveOptions](./xpssaveoptions/)(Aspose::Words::SaveFormat) | Inizializza una nuova istanza di questa classe che può essere usata per salvare un documento nel formato [Xps](../../aspose.words/saveformat/) o [OpenXps](../../aspose.words/saveformat/). |
