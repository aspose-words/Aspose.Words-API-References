...
description: "Metodo Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains. Determina se la collezione contiene un segnalibro con il nome specificato in C++."
type: docs
weight: 8000
url: /it/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/contains/
---
## BookmarksOutlineLevelCollection::Contains method


Determina se la raccolta contiene un segnalibro con il nome specificato.
...
| --- | --- | --- |
| name | const System::String\& | Nome del segnalibro da individuare, senza distinzione tra maiuscole e minuscole. |
