---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add metodo"
linktitle: "Add"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add metodo. Aggiunge un segnalibro alla collezione in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Il nome del segnalibro da aggiungere, senza distinzione tra maiuscole e minuscole. |
| outlineLevel | int32_t | Il livello di outline del segnalibro. L'intervallo valido è da 0 a 9. |
