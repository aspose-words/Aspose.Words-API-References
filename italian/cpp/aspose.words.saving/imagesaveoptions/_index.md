...
description: "Aspose::Words::Saving::ImageSaveOptions class. Consente di specificare opzioni aggiuntive durante il rendering di pagine di documento o forme in immagini. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 11000
url: /it/cpp/aspose.words.saving/imagesaveoptions/
---
## ImageSaveOptions class


Consente di specificare opzioni aggiuntive durante il rendering di pagine o forme del documento in immagini. Per saperne di più, visita l'articolo di documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_GraphicsQualityOptions](./get_graphicsqualityoptions/)() const | Consente di specificare la modalità di rendering e la qualità per l'oggetto **Graphics**. |
| [get_HorizontalResolution](./get_horizontalresolution/)() const | Ottiene o imposta la risoluzione orizzontale per le immagini generate, in punti per pollice. |
| [get_ImageBrightness](./get_imagebrightness/)() const | Ottiene o imposta la luminosità per le immagini generate. |
| [get_ImageColorMode](./get_imagecolormode/)() const | Ottiene o imposta la modalità colore per le immagini generate. |
| [get_ImageContrast](./get_imagecontrast/)() const | Ottiene o imposta il contrasto per le immagini generate. |
| [get_ImageSize](./get_imagesize/)() const | Ottiene o imposta le dimensioni di un'immagine generata in pixel. |
...
| [get_JpegQuality](./get_jpegquality/)() | Ottiene o imposta un valore che determina la qualità delle immagini JPEG generate. |
...
| [get_MetafileRenderingOptions](./get_metafilerenderingoptions/)() | Consente di specificare come i metafile vengono trattati nell'output renderizzato. |
...
| [get_PageLayout](./get_pagelayout/)() const | Ottiene o imposta il layout utilizzato durante il rendering di più pagine in un unico output. |
...
| [get_PageSet](./get_pageset/)() | Ottiene o imposta le pagine da renderizzare. Il valore predefinito è tutte le pagine del documento. |
...
| [get_PaperColor](./get_papercolor/)() | Ottiene o imposta il colore di sfondo (carta) per le immagini generate. Il valore predefinito è **White**. |
| [get_PixelFormat](./get_pixelformat/)() const | Ottiene o imposta il formato pixel per le immagini generate. |
...
| [get_ThresholdForFloydSteinbergDithering](./get_thresholdforfloydsteinbergdithering/)() const | Ottiene o imposta la soglia che determina il valore dell'errore di binarizzazione nel metodo Floyd-Steinberg quando [ImageBinarizationMethod](../imagebinarizationmethod/) è [FloydSteinbergDithering](../imagebinarizationmethod/). |
| [get_TiffBinarizationMethod](./get_tiffbinarizationmethod/)() const | Ottiene o imposta il metodo utilizzato durante la conversione delle immagini in formato a 1 bpp quando [SaveFormat](./get_saveformat/) è [Tiff](../../aspose.words/saveformat/) e [TiffCompression](./get_tiffcompression/) è uguale a [Ccitt3](../tiffcompression/) o [Ccitt4](../tiffcompression/). |
| [get_TiffCompression](./get_tiffcompression/)() const | Ottiene o imposta il tipo di compressione da applicare durante il salvataggio delle immagini generate nel formato TIFF. |
...
| [get_UseGdiEmfRenderer](./get_usegdiemfrenderer/)() const | Ottiene o imposta un valore che determina se utilizzare GDI+ o Aspose.Words metafile renderer durante il salvataggio in EMF. |
...
| [get_VerticalResolution](./get_verticalresolution/)() const | Ottiene o imposta la risoluzione verticale per le immagini generate, in punti per pollice. |
| [GetType](./gettype/)() const override |  |
| [ImageSaveOptions](./imagesaveoptions/)(Aspose::Words::SaveFormat) | Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare le immagini renderizzate nei formati [Tiff](../../aspose.words/saveformat/), [Png](../../aspose.words/saveformat/), [Bmp](../../aspose.words/saveformat/), [Jpeg](../../aspose.words/saveformat/), [Emf](../../aspose.words/saveformat/), [Eps](../../aspose.words/saveformat/), [WebP](../) o [Svg](../../aspose.words/saveformat/). |
...
| [set_GraphicsQualityOptions](./set_graphicsqualityoptions/)(const System::SharedPtr\<Aspose::Words::Saving::GraphicsQualityOptions\>\&) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_GraphicsQualityOptions](./get_graphicsqualityoptions/). |
| [set_HorizontalResolution](./set_horizontalresolution/)(float) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_HorizontalResolution](./get_horizontalresolution/). |
| [set_ImageBrightness](./set_imagebrightness/)(float) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_ImageBrightness](./get_imagebrightness/). |
| [set_ImageColorMode](./set_imagecolormode/)(Aspose::Words::Saving::ImageColorMode) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_ImageColorMode](./get_imagecolormode/). |
| [set_ImageContrast](./set_imagecontrast/)(float) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_ImageContrast](./get_imagecontrast/). |
| [set_ImageSize](./set_imagesize/)(System::Drawing::Size) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_ImageSize](./get_imagesize/). |
...
| [set_JpegQuality](./set_jpegquality/)(int32_t) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_JpegQuality](./get_jpegquality/). |
...
| [set_PageLayout](./set_pagelayout/)(const System::SharedPtr\<Aspose::Words::Saving::MultiPageLayout\>\&) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_PageLayout](./get_pagelayout/). |
...
| [set_PageSet](./set_pageset/)(const System::SharedPtr\<Aspose::Words::Saving::PageSet\>\&) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_PageSet](./get_pageset/). |
| [set_PaperColor](./set_papercolor/)(System::Drawing::Color) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_PaperColor](./get_papercolor/). |
| [set_PixelFormat](./set_pixelformat/)(Aspose::Words::Saving::ImagePixelFormat) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_PixelFormat](./get_pixelformat/). |
...
| [set_Resolution](./set_resolution/)(float) | Imposta sia la risoluzione orizzontale che quella verticale per le immagini generate, in punti per pollice. |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_Scale](./set_scale/)(float) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_Scale](./get_scale/). |
...
| [set_ThresholdForFloydSteinbergDithering](./set_thresholdforfloydsteinbergdithering/)(uint8_t) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_ThresholdForFloydSteinbergDithering](./get_thresholdforfloydsteinbergdithering/). |
| [set_TiffBinarizationMethod](./set_tiffbinarizationmethod/)(Aspose::Words::Saving::ImageBinarizationMethod) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_TiffBinarizationMethod](./get_tiffbinarizationmethod/). |
| [set_TiffCompression](./set_tiffcompression/)(Aspose::Words::Saving::TiffCompression) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_TiffCompression](./get_tiffcompression/). |
...
| [set_UseGdiEmfRenderer](./set_usegdiemfrenderer/)(bool) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_UseGdiEmfRenderer](./get_usegdiemfrenderer/). |
...
| [set_VerticalResolution](./set_verticalresolution/)(float) | Impostatore per [Aspose::Words::Saving::ImageSaveOptions::get_VerticalResolution](./get_verticalresolution/). |
| static [Type](./type/)() |  |
