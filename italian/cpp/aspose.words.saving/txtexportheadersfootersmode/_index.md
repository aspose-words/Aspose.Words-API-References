...
description: "Aspose::Words::Saving::TxtExportHeadersFootersMode enum. Specifica il modo in cui intestazioni e piè di pagina vengono esportati nel formato di testo semplice in C++."
type: docs
weight: 86000
url: /it/cpp/aspose.words.saving/txtexportheadersfootersmode/
---
...
| --- | --- | --- |
| None | 0 | Nessuna intestazione o piè di pagina viene esportato. |
| PrimaryOnly | 1 | Solo le intestazioni e i piè di pagina primari vengono esportati all'inizio e alla fine di ogni sezione. |
| AllAtEnd | 2 | Tutte le intestazioni e i piè di pagina sono posizionati dopo tutti i corpi delle sezioni alla fine del documento. |
