...
description: "Aspose::Words::Saving::PclSaveOptions class. Può essere utilizzata per specificare opzioni aggiuntive quando si salva un documento nel formato Pcl. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 21000
url: /it/cpp/aspose.words.saving/pclsaveoptions/
---
## PclSaveOptions class


Può essere utilizzata per specificare opzioni aggiuntive quando si salva un documento nel formato [Pcl](../../aspose.words/saveformat/) . Per saperne di più, visita l'articolo della documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| Metodo | Descrizione |
| --- | --- |
| [AddPrinterFont](./addprinterfont/)(const System::String\&, const System::String\&) | Aggiunge informazioni sul font che viene caricato nella stampante dal produttore. |
...
| [get_FallbackFontName](./get_fallbackfontname/)() const | Nome del font che verrà utilizzato se non viene trovato alcun font previsto nella stampante e nelle raccolte di font integrati. |
...
| [get_RasterizeTransformedElements](./get_rasterizetransformedelements/)() const | Ottiene o imposta un valore che determina se gli elementi trasformati complessi debbano o meno essere rasterizzati prima di salvare il documento PCL. Il valore predefinito è **true**. |
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere solo [Pcl](../../aspose.words/saveformat/). |
...
| [set_FallbackFontName](./set_fallbackfontname/)(const System::String\&) | Impostatore per [Aspose::Words::Saving::PclSaveOptions::get_FallbackFontName](./get_fallbackfontname/). |
...
| [set_RasterizeTransformedElements](./set_rasterizetransformedelements/)(bool) | Impostatore per [Aspose::Words::Saving::PclSaveOptions::get_RasterizeTransformedElements](./get_rasterizetransformedelements/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Impostatore per [Aspose::Words::Saving::PclSaveOptions::get_SaveFormat](./get_saveformat/). |
