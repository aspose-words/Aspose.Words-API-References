...
description: "Aspose::Words::Saving::DocSaveOptions::DocSaveOptions constructor. Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nel formato Doc in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.saving/docsaveoptions/docsaveoptions/
---
## DocSaveOptions::DocSaveOptions() constructor


Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nel formato [Doc](../../../aspose.words/saveformat/).
...
Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nel formato [Doc](../../../aspose.words/saveformat/) o [Dot](../../../aspose.words/saveformat/).
...
| --- | --- | --- |
| saveFormat | Aspose::Words::SaveFormat | Può essere [Doc](../../../aspose.words/saveformat/) o [Dot](../../../aspose.words/saveformat/). |
