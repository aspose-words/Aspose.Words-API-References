...
description: "Aspose::Words::Saving::OdtSaveOptions classe. Può essere usata per specificare opzioni aggiuntive quando si salva un documento nei formati Odt o Ott. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 15000
url: /it/cpp/aspose.words.saving/odtsaveoptions/
---
## OdtSaveOptions class


Può essere usata per specificare opzioni aggiuntive quando si salva un documento nei formati [Odt](../../aspose.words/saveformat/) o [Ott](../../aspose.words/saveformat/). Per saperne di più, visita l'articolo della documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_IsStrictSchema11](./get_isstrictschema11/)() const | Specifica se l'esportazione deve corrispondere strettamente alla specifica ODT 1.1. OOo 3.0 visualizza correttamente i file quando contengono elementi e attributi di ODT 1.2. Usa "false" a questo scopo, o "true" per la conformità rigorosa alla specifica 1.1. Il valore predefinito è **false**. |
| [get_MeasureUnit](./get_measureunit/)() const | Consente di specificare le unità di misura da applicare al contenuto del documento. Il valore predefinito è [Centimeters](../odtsavemeasureunit/) |
...
| [get_Password](./get_password/)() const | Ottiene o imposta una password per crittografare il documento. |
...
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento verrà salvato se viene usato questo oggetto di opzioni di salvataggio. Può essere [Odt](../../aspose.words/saveformat/) o [Ott](../../aspose.words/saveformat/). |
...
| [OdtSaveOptions](./odtsaveoptions/)() | Inizializza una nuova istanza di questa classe che può essere usata per salvare un documento nel formato [Odt](../../aspose.words/saveformat/). |
| [OdtSaveOptions](./odtsaveoptions/)(const System::String\&) | Inizializza una nuova istanza di questa classe che può essere usata per salvare un documento nel formato [Odt](../../aspose.words/saveformat/) crittografato con una password. |
| [OdtSaveOptions](./odtsaveoptions/)(Aspose::Words::SaveFormat) | Inizializza una nuova istanza di questa classe che può essere usata per salvare un documento nei formati [Odt](../../aspose.words/saveformat/) o [Ott](../../aspose.words/saveformat/). |
...
| [set_IsStrictSchema11](./set_isstrictschema11/)(bool) | Impostatore per [Aspose::Words::Saving::OdtSaveOptions::get_IsStrictSchema11](./get_isstrictschema11/). |
| [set_MeasureUnit](./set_measureunit/)(Aspose::Words::Saving::OdtSaveMeasureUnit) | Impostatore per [Aspose::Words::Saving::OdtSaveOptions::get_MeasureUnit](./get_measureunit/). |
...
| [set_Password](./set_password/)(const System::String\&) | Impostatore per [Aspose::Words::Saving::OdtSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Metodo setter per [Aspose::Words::Saving::OdtSaveOptions::get_SaveFormat](./get_saveformat/). |
