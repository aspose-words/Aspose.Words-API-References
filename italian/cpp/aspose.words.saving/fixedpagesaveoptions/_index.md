...
description: "Aspose::Words::Saving::FixedPageSaveOptions classe. Contiene opzioni comuni che possono essere specificate quando si salva un documento in formati a pagina fissa (PDF, XPS, immagini ecc.). Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.saving/fixedpagesaveoptions/
---
## FixedPageSaveOptions class


Contiene opzioni comuni che possono essere specificate durante il salvataggio di un documento in formati a pagina fissa (PDF, XPS, immagini ecc.). Per saperne di più, visita l'articolo di documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ColorMode](./get_colormode/)() const | Restituisce un valore che determina come vengono renderizzati i colori. |
...
| [get_JpegQuality](./get_jpegquality/)() const | Ottiene o imposta un valore che determina la qualità delle immagini JPEG all'interno del documento Html. |
...
| [get_MetafileRenderingOptions](./get_metafilerenderingoptions/)() const | Consente di specificare le opzioni di rendering dei metafile. |
| [get_NumeralFormat](./get_numeralformat/)() const | Ottiene il [NumeralFormat](../numeralformat/) utilizzato per il rendering dei numeri. Per impostazione predefinita vengono usati i numeri europei. |
| virtual [get_OptimizeOutput](./get_optimizeoutput/)() | Il flag indica se è necessario ottimizzare l'output. Se questo flag è impostato, le tele nidificate ridondanti e le tele vuote vengono rimosse, inoltre i glifi vicini con la stessa formattazione vengono concatenati. Nota: la precisione della visualizzazione del contenuto potrebbe essere influenzata se questa proprietà è impostata su **true**. Il valore predefinito è **false**. |
| [get_PageSavingCallback](./get_pagesavingcallback/)() const | Consente di controllare come le pagine separate vengono salvate quando un documento è esportato in formato a pagina fissa. |
| [get_PageSet](./get_pageset/)() const | Ottiene o imposta le pagine da renderizzare. Il valore predefinito è tutte le pagine del documento. |
...
| [set_ColorMode](./set_colormode/)(Aspose::Words::Saving::ColorMode) | Imposta un valore che determina come vengono renderizzati i colori. |
...
| [set_JpegQuality](./set_jpegquality/)(int32_t) | Impostatore per [Aspose::Words::Saving::FixedPageSaveOptions::get_JpegQuality](./get_jpegquality/). |
...
| [set_MetafileRenderingOptions](./set_metafilerenderingoptions/)(const System::SharedPtr\<Aspose::Words::Saving::MetafileRenderingOptions\>\&) | Consente di specificare le opzioni di rendering dei metafile. |
| [set_NumeralFormat](./set_numeralformat/)(Aspose::Words::Saving::NumeralFormat) | Imposta [NumeralFormat](../numeralformat/) usato per il rendering dei numeri. Per impostazione predefinita vengono utilizzati i numeri europei. |
| virtual [set_OptimizeOutput](./set_optimizeoutput/)(bool) | Impostatore per [Aspose::Words::Saving::FixedPageSaveOptions::get_OptimizeOutput](./get_optimizeoutput/). |
| [set_PageSavingCallback](./set_pagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IPageSavingCallback\>\&) | Consente di controllare come le pagine separate vengono salvate quando un documento è esportato in formato a pagina fissa. |
| [set_PageSet](./set_pageset/)(const System::SharedPtr\<Aspose::Words::Saving::PageSet\>\&) | Impostatore per [Aspose::Words::Saving::FixedPageSaveOptions::get_PageSet](./get_pageset/). |
