---
title: "classe Aspose::Words::Saving::DoclingSaveOptions"
linktitle: "DoclingSaveOptions"
second_title: "Riferimento API Aspose.Words per C++"
description: "classe Aspose::Words::Saving::DoclingSaveOptions. Può essere usata per specificare opzioni aggiuntive durante il salvataggio di un documento nel formato Docling. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 2750
url: /it/cpp/aspose.words.saving/doclingsaveoptions/
---
## DoclingSaveOptions class


Può essere usata per specificare opzioni aggiuntive durante il salvataggio di un documento nel formato [Docling](../../aspose.words/saveformat/). Per saperne di più, visita l'articolo della documentazione [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_RenderNonImageShapes](./get_rendernonimageshapes/)() const | Ottiene o imposta un valore che indica se le forme non immagine devono essere renderizzate e scritte nel documento JSON Docling di output. |
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento sarà salvato se viene usato questo oggetto di opzioni di salvataggio. Può essere solo [Docling](../../aspose.words/saveformat/). |
...
| [set_RenderNonImageShapes](./set_rendernonimageshapes/)(bool) | Impostatore per [Aspose::Words::Saving::DoclingSaveOptions::get_RenderNonImageShapes](./get_rendernonimageshapes/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Impostatore per [Aspose::Words::Saving::DoclingSaveOptions::get_SaveFormat](./get_saveformat/). |
