...
description: "Aspose::Words::Saving::RtfSaveOptions class. Può essere usato per specificare opzioni aggiuntive durante il salvataggio di un documento nel formato Rtf. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 28000
url: /it/cpp/aspose.words.saving/rtfsaveoptions/
---
## RtfSaveOptions class


Può essere usato per specificare opzioni aggiuntive durante il salvataggio di un documento nel formato [Rtf](../../aspose.words/saveformat/). Per saperne di più, visita l'articolo di documentazione [Specifica opzioni di salvataggio](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ExportCompactSize](./get_exportcompactsize/)() const | Consente di rendere i documenti RTF di output più piccoli in dimensione, ma se contengono testo RTL (right-to-left), non verrà visualizzato correttamente. Il valore predefinito è **false**. |
...
| [get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/)() const | Specifica se le parole chiave per "old readers" vengono scritte nel RTF o meno. Questo può influire significativamente sulla dimensione del documento RTF. Il valore predefinito è **true**. |
...
| [get_SaveFormat](./get_saveformat/)() override | Specifica il formato in cui il documento sarà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere solo [Rtf](../../aspose.words/saveformat/). |
| [get_SaveImagesAsWmf](./get_saveimagesaswmf/)() const | Quando **true** tutte le immagini saranno salvate come WMF. |
...
| [set_ExportCompactSize](./set_exportcompactsize/)(bool) | Impostatore per [Aspose::Words::Saving::RtfSaveOptions::get_ExportCompactSize](./get_exportcompactsize/). |
...
| [set_ExportImagesForOldReaders](./set_exportimagesforoldreaders/)(bool) | Impostatore per [Aspose::Words::Saving::RtfSaveOptions::get_ExportImagesForOldReaders](./get_exportimagesforoldreaders/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Impostatore per [Aspose::Words::Saving::RtfSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SaveImagesAsWmf](./set_saveimagesaswmf/)(bool) | Impostatore per [Aspose::Words::Saving::RtfSaveOptions::get_SaveImagesAsWmf](./get_saveimagesaswmf/). |
