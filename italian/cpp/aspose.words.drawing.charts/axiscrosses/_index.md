...
description: "Aspose::Words::Drawing::Charts::AxisCrosses enum. Specifica i possibili punti di intersezione per un asse in C++."
type: docs
weight: 22000
url: /it/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum
...
| --- | --- | --- |
| Automatico | 0 | L'asse delle categorie si incrocia al punto zero dell'asse dei valori (se possibile), oppure al valore minimo se il minimo è maggiore di zero, oppure al valore massimo se il massimo è inferiore a zero. |
| Maximum | 1 | Un asse perpendicolare si incrocia al valore massimo dell'asse. |
| Minimo | 2 | Un asse perpendicolare si incrocia al valore minimo dell'asse. |
| Personalizzato | 3 | Un asse perpendicolare si incrocia al valore specificato dell'asse. |
