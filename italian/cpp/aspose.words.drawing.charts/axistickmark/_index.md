...
type: docs
weight: 25000
url: /it/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum


Specifica le possibili posizioni per i segni dei tick.
...
| --- | --- | --- |
| Croce | 0 | Specificare che i segni di graduazione devono attraversare l'asse. |
| Interno | 1 | Specifica che i ticchetti devono trovarsi all'interno dell'area del grafico. |
| Esterno | 2 | Specifica che i ticchetti devono trovarsi all'esterno dell'area del grafico. |
| None | 3 | Specifica che non ci devono essere ticchetti. |
