---
title: "Metodo Aspose::Words::Drawing::Charts::Chart::get_DataTable"
linktitle: "get_DataTable"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Drawing::Charts::Chart::get_DataTable. Fornisce l'accesso alle proprietà di una tabella dati di questo grafico. La tabella dati può essere visualizzata usando la proprietà Show in C++."
type: docs
weight: 4500
url: /it/cpp/aspose.words.drawing.charts/chart/get_datatable/
---
## Chart::get_DataTable method


Fornisce l'accesso alle proprietà di una tabella dati di questo grafico. La tabella dati può essere visualizzata usando la proprietà [Show](../../chartdatatable/get_show/).
