...
description: "Aspose::Words::Drawing::Charts::AxisTimeUnit enum. Specifica l'unità di tempo per gli assi in C++."
type: docs
weight: 26000
url: /it/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum
...
| --- | --- | --- |
| Automatico | 0 | Specifica che l'unità non è stata impostata esplicitamente e che dovrebbe essere utilizzato il valore predefinito. |
| Giorni | 1 | Specifica che i dati del grafico devono essere mostrati in giorni. |
| Mesi | 2 | Specifica che i dati del grafico devono essere mostrati in mesi. |
| Anni | 3 | Specifica che i dati del grafico devono essere mostrati in anni. |
