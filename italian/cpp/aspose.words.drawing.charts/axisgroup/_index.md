...
description: "Aspose::Words::Drawing::Charts::AxisGroup enum. Rappresenta un tipo di gruppo di assi del grafico in C++."
type: docs
weight: 22500
url: /it/cpp/aspose.words.drawing.charts/axisgroup/
---
## AxisGroup enum
...
| --- | --- | --- |
| Primario | 0 | Specifica il gruppo di assi primario. |
| Secondario | 1 | Specifica il gruppo di assi secondario. |
