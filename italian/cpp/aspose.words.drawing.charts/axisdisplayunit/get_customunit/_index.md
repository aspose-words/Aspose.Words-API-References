---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metodo"
linktitle: "get_CustomUnit"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metodo. Ottiene o imposta un divisore definito dall'utente per scalare le unità di visualizzazione sull'asse dei valori in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


Ottiene o imposta un divisore definito dall'utente per scalare le unità di visualizzazione sull'asse dei valori.
...
Impostare questa proprietà imposta la proprietà [Unit](../get_unit/) su [Custom](../../axisbuiltinunit/).
