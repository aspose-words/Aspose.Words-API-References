...
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit class. Fornisce l'accesso alle opzioni di scala delle unità di visualizzazione per l'asse dei valori. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Fornisce l'accesso alle opzioni di scala delle unità di visualizzazione per l'asse dei valori. Per saperne di più, visita l'articolo di documentazione [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | Ottiene o imposta un divisore definito dall'utente per scalare le unità di visualizzazione sull'asse dei valori. |
| [get_Document](./get_document/)() | Restituisce il documento che contiene il grafico padre. |
| [get_Unit](./get_unit/)() const | Ottiene o imposta il valore di scala delle unità di visualizzazione come uno dei valori predefiniti. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | Impostatore per [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | Impostatore per [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
