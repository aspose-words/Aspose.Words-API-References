---
title: "Metodo Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing"
linktitle: "get_IsAutoSpacing"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing. Ottiene o imposta un flag che indica se utilizzare un intervallo automatico per disegnare le etichette dei segni in C++."
type: docs
weight: 4000
url: /it/cpp/aspose.words.drawing.charts/axisticklabels/get_isautospacing/
---
## AxisTickLabels::get_IsAutoSpacing method


Ottiene o imposta un flag che indica se utilizzare un intervallo automatico per il disegno delle etichette dei segni di graduazione.
...
La proprietà ha effetto per gli assi di categoria testo e di serie. Non è supportata dai nuovi grafici di MS Office 2016.
