---
title: "Enum Aspose::Words::Drawing::Charts::AxisCategoryType"
linktitle: "AxisCategoryType"
second_title: "Riferimento API Aspose.Words per C++"
description: "Enum Aspose::Words::Drawing::Charts::AxisCategoryType. Specifica il tipo di asse di categoria in C++."
type: docs
weight: 21000
url: /it/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| --- | --- | --- |
| Automatico | 0 | Specifica che il tipo di un asse di categoria è determinato automaticamente in base ai dati. |
| Categoria | 1 | Specifica un asse di un insieme arbitrario di categorie. |
| Tempo | 2 | Specifica un asse di categoria temporale. |
