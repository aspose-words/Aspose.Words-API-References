---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_ShowBubbleSize metodo"
linktitle: "get_ShowBubbleSize"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_ShowBubbleSize metodo. Consente di specificare se la dimensione della bolla deve essere visualizzata per le etichette dati su un grafico. Si applica solo ai grafici a bolle. Il valore predefinito è false in C++."
type: docs
weight: 9000
url: /it/cpp/aspose.words.drawing.charts/chartdatalabel/get_showbubblesize/
---
## ChartDataLabel::get_ShowBubbleSize method


Consente di specificare se la dimensione della bolla deve essere visualizzata per le etichette dati su un grafico. Si applica solo ai grafici a bolle. Il valore predefinito è **false**.
