---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metodo"
linktitle: "get_LeftMode"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metodo. Ottiene o imposta la modalità di interpretazione del valore della proprietà Left: se imposta la posizione dell'etichetta dei dati dal bordo sinistro del grafico o dalla posizione specificata dalla sua proprietà Position in C++."
type: docs
weight: 6667
url: /it/cpp/aspose.words.drawing.charts/chartdatalabel/get_leftmode/
---
## ChartDataLabel::get_LeftMode method


Ottiene o imposta la modalità di interpretazione del valore della proprietà [Left](../get_left/): se imposta la posizione dell'etichetta dei dati dal bordo sinistro del grafico o dalla posizione specificata dalla sua proprietà [Position](../get_position/).
