...
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition enum. Specifica le possibili posizioni per le etichette dei tick in C++."
type: docs
weight: 24000
url: /it/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
## AxisTickLabelPosition enum


Specifica le possibili posizioni per le etichette dei tick.
...
| --- | --- | --- |
| Alto | 0 | Specifica che le etichette dell'asse devono trovarsi all'estremità alta dell'asse perpendicolare. |
| Basso | 1 | Specifica che le etichette dell'asse devono trovarsi all'estremità bassa dell'asse perpendicolare. |
| NextToAxis | 2 | Specifica che le etichette dell'asse devono trovarsi accanto all'asse. |
| None | 3 | Specifica che le etichette dell'asse non vengono disegnate. |
| Default | n/a | Specifica il valore predefinito della posizione delle etichette dei tick. |
