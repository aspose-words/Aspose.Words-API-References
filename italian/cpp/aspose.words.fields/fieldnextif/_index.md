...
description: "Aspose::Words::Fields::FieldNextIf class. Implementa il campo NEXTIF. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 71000
url: /it/cpp/aspose.words.fields/fieldnextif/
---
## FieldNextIf class


Implementa il campo NEXTIF. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
