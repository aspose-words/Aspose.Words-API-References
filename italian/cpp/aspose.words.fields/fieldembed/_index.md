...
description: "Classe Aspose::Words::Fields::FieldEmbed. Implementa il campo EMBED. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 38000
url: /it/cpp/aspose.words.fields/fieldembed/
---
## FieldEmbed class


Implementa il campo EMBED. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
