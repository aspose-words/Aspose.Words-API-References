...
description: "Aspose::Words::Fields::FieldAddressBlock classe. Implementa il campo ADDRESSBLOCK. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.fields/fieldaddressblock/
---
## FieldAddressBlock class


Implementa il campo ADDRESSBLOCK. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_ExcludedCountryOrRegionName](./get_excludedcountryorregionname/)() | Ottiene o imposta il nome del paese/regione escluso. |
...
| [get_FormatAddressOnCountryOrRegion](./get_formataddressoncountryorregion/)() | Ottiene o imposta se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST*CODE (Unione Postale Universale 2006). |
| [get_IncludeCountryOrRegionName](./get_includecountryorregionname/)() | Ottiene o imposta se includere il nome del paese/regione. |
...
| [get_LanguageId](./get_languageid/)() | Ottiene o imposta l'ID lingua usato per formattare l'indirizzo. |
| [get_LocaleId](../field/get_localeid/)() | Ottiene o imposta il LCID del campo. |
| [get_NameAndAddressFormat](./get_nameandaddressformat/)() | Ottiene o imposta il formato del nome e dell'indirizzo. |
...
| [set_ExcludedCountryOrRegionName](./set_excludedcountryorregionname/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldAddressBlock::get_ExcludedCountryOrRegionName](./get_excludedcountryorregionname/). |
| [set_FormatAddressOnCountryOrRegion](./set_formataddressoncountryorregion/)(bool) | Impostatore per [Aspose::Words::Fields::FieldAddressBlock::get_FormatAddressOnCountryOrRegion](./get_formataddressoncountryorregion/). |
| [set_IncludeCountryOrRegionName](./set_includecountryorregionname/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldAddressBlock::get_IncludeCountryOrRegionName](./get_includecountryorregionname/). |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldAddressBlock::get_LanguageId](./get_languageid/). |
| [set_LocaleId](../field/set_localeid/)(int32_t) | Setter per [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NameAndAddressFormat](./set_nameandaddressformat/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldAddressBlock::get_NameAndAddressFormat](./get_nameandaddressformat/). |
