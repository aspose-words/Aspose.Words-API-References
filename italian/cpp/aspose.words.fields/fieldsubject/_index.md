...
description: "Aspose::Words::Fields::FieldSubject class. Implementa il campo SUBJECT. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 97000
url: /it/cpp/aspose.words.fields/fieldsubject/
---
## FieldSubject class


Implementa il campo SUBJECT. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [get_Text](./get_text/)() | Ottiene o imposta il testo del soggetto. |
...
| [set_Text](./set_text/)(const System::String\&) | Setter per [Aspose::Words::Fields::FieldSubject::get_Text](./get_text/). |
| static [Type](./type/)() |  |
