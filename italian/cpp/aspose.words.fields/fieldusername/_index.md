...
description: "Aspose::Words::Fields::FieldUserName classe. Implementa il campo USERNAME. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 110000
url: /it/cpp/aspose.words.fields/fieldusername/
---
## FieldUserName class


Implementa il campo USERNAME. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_UserName](./get_username/)() | Ottiene o imposta il nome dell'utente corrente. |
...
| [set_UserName](./set_username/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldUserName::get_UserName](./get_username/). |
| static [Type](./type/)() |  |
