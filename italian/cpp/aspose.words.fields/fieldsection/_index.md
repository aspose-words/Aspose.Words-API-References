...
description: "Aspose::Words::Fields::FieldSection class. Implementa il campo SECTION. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 88000
url: /it/cpp/aspose.words.fields/fieldsection/
---
## FieldSection class


Implementa il campo SECTION. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
