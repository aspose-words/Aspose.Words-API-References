---
title: "classe Aspose::Words::Fields::FieldSet"
linktitle: "FieldSet"
second_title: "Riferimento API Aspose.Words per C++"
description: "classe Aspose::Words::Fields::FieldSet. Implementa il campo SET. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 92000
url: /it/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


Implementa il campo SET. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Metodo | Descrizione |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Ottiene o imposta il nome del segnalibro. |
| [get_BookmarkText](./get_bookmarktext/)() | Ottiene o imposta il nuovo testo del segnalibro. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/). |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/). |
