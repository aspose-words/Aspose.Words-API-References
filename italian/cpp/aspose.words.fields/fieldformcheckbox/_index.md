---
title: "Classe Aspose::Words::Fields::FieldFormCheckBox"
linktitle: "FieldFormCheckBox"
second_title: "Riferimento API Aspose.Words per C++"
description: "Classe Aspose::Words::Fields::FieldFormCheckBox. Implementa il campo FORMCHECKBOX. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 46000
url: /it/cpp/aspose.words.fields/fieldformcheckbox/
---
## FieldFormCheckBox class


Implementa il campo FORMCHECKBOX. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
```cpp
// Questi campi sono equivalenti legacy del FormField. Possiamo leggerli, ma non crearli usando Aspose.Words.
