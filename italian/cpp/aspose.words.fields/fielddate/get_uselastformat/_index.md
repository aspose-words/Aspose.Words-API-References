---
title: "Aspose::Words::Fields::FieldDate::get_UseLastFormat metodo"
linktitle: "get_UseLastFormat"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Fields::FieldDate::get_UseLastFormat metodo. Ottiene o imposta se utilizzare un formato usato l'ultima volta dall'applicazione host durante l'inserimento di un nuovo campo DATE in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.fields/fielddate/get_uselastformat/
---
## FieldDate::get_UseLastFormat method


Ottiene o imposta se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE.
