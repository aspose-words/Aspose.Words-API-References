...
description: "Aspose::Words::Fields::FieldUserAddress class. Implementa il campo USERADDRESS. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 108000
url: /it/cpp/aspose.words.fields/fielduseraddress/
---
## FieldUserAddress class


Implementa il campo USERADDRESS. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_UserAddress](./get_useraddress/)() | Ottiene o imposta l'indirizzo postale dell'utente corrente. |
...
| [set_UserAddress](./set_useraddress/)(const System::String\&) | Setter per [Aspose::Words::Fields::FieldUserAddress::get_UserAddress](./get_useraddress/). |
| static [Type](./type/)() |  |
