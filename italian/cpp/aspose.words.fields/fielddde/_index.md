...
description: "Aspose::Words::Fields::FieldDde classe. Implementa il campo DDE. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 32000
url: /it/cpp/aspose.words.fields/fielddde/
---
## FieldDde class


Implementa il campo DDE. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
