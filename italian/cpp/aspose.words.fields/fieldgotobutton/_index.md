---
title: "classe Aspose::Words::Fields::FieldGoToButton"
linktitle: "FieldGoToButton"
second_title: "Riferimento API Aspose.Words per C++"
description: "classe Aspose::Words::Fields::FieldGoToButton. Implementa il campo GOTOBUTTON. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 51000
url: /it/cpp/aspose.words.fields/fieldgotobutton/
---
## FieldGoToButton class


Implementa il campo GOTOBUTTON. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_DisplayText](./get_displaytext/)() | Ottiene o imposta il testo del "button" che appare nel documento, in modo che possa essere selezionato per attivare il salto. |
...
| [get_Location](./get_location/)() | Ottiene o imposta il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare. |
...
| [set_DisplayText](./set_displaytext/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldGoToButton::get_DisplayText](./get_displaytext/). |
...
| [set_Location](./set_location/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldGoToButton::get_Location](./get_location/). |
