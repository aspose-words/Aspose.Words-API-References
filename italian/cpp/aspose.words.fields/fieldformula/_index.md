---
title: "Aspose::Words::Fields::FieldFormula classe"
linktitle: "FieldFormula"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Fields::FieldFormula class. Implementa il campo = (formula). Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 49000
url: /it/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


Implementa il campo = (formula). Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Mostra come utilizzare il campo formula per visualizzare il risultato di un'equazione.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();

// Usa un costruttore di campi per creare un'equazione matematica,
// quindi crea un campo formula per visualizzare il risultato dell'equazione nel documento.
