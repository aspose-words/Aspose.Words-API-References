...
description: "Aspose::Words::Fields::FieldNext classe. Implementa il campo NEXT. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 70000
url: /it/cpp/aspose.words.fields/fieldnext/
---
## FieldNext class


Implementa il campo NEXT. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
