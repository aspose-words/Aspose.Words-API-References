---
title: "Aspose::Words::Fields::FieldAutoTextList classe"
linktitle: "FieldAutoTextList"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Fields::FieldAutoTextList classe. Implementa il campo AUTOTEXTLIST. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 16000
url: /it/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


Implementa il campo AUTOTEXTLIST. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() | Ottiene il nome della voce AutoText. |
...
| [get_ListStyle](./get_liststyle/)() | Ottiene il nome dello stile su cui si basa l'elenco che contiene le voci. |
...
| [get_ScreenTip](./get_screentip/)() | Ottiene il testo del suggerimento (ScreenTip) da mostrare. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Imposta il nome della voce AutoText. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | Imposta il nome dello stile su cui si basa l'elenco che contiene le voci. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | Imposta il testo del suggerimento (ScreenTip) da mostrare. |
| static [Type](./type/)() |  |
