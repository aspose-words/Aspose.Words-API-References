...
description: "Aspose::Words::Fields::FieldNumWords classe. Implementa il campo NUMWORDS. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 75000
url: /it/cpp/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class


Implementa il campo NUMWORDS. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
