...
description: "classe Aspose::Words::Fields::FieldBarcode. Implementa il campo BARCODE. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 17000
url: /it/cpp/aspose.words.fields/fieldbarcode/
---
## FieldBarcode class


Implementa il campo BARCODE. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FacingIdentificationMark](./get_facingidentificationmark/)() | Ottiene o imposta il tipo di Facing Identification Mark (FIM) da inserire. |
...
| [get_IsBookmark](./get_isbookmark/)() | Ottiene o imposta se [PostalAddress](./get_postaladdress/) è il nome di un segnalibro. |
...
| [get_IsUSPostalAddress](./get_isuspostaladdress/)() | Ottiene o imposta se [PostalAddress](./get_postaladdress/) è un indirizzo postale statunitense. |
| [get_LocaleId](../field/get_localeid/)() | Ottiene o imposta il LCID del campo. |
| [get_PostalAddress](./get_postaladdress/)() | Ottiene o imposta l'indirizzo postale utilizzato per generare un codice a barre o il nome del segnalibro che vi fa riferimento. |
...
| [set_FacingIdentificationMark](./set_facingidentificationmark/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldBarcode::get_FacingIdentificationMark](./get_facingidentificationmark/). |
| [set_IsBookmark](./set_isbookmark/)(bool) | Impostatore per [Aspose::Words::Fields::FieldBarcode::get_IsBookmark](./get_isbookmark/). |
...
| [set_IsUSPostalAddress](./set_isuspostaladdress/)(bool) | Impostatore per [Aspose::Words::Fields::FieldBarcode::get_IsUSPostalAddress](./get_isuspostaladdress/). |
| [set_LocaleId](../field/set_localeid/)(int32_t) | Setter per [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_PostalAddress](./set_postaladdress/)(const System::String\&) | Impostatore per [Aspose::Words::Fields::FieldBarcode::get_PostalAddress](./get_postaladdress/). |
