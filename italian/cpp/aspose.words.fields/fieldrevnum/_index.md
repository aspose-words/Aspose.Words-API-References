...
description: "Aspose::Words::Fields::FieldRevNum class. Implementa il campo REVNUM. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 86000
url: /it/cpp/aspose.words.fields/fieldrevnum/
---
## FieldRevNum class


Implementa il campo REVNUM. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
// e non è correlata alle revisioni tracciate. Possiamo trovarla facendo clic con il tasto destro sul documento in Windows Explorer
