---
title: "Aspose::Words::Fields::FieldBibliography classe"
linktitle: "FieldBibliography"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Fields::FieldBibliography classe. Implementa il campo BIBLIOGRAPHY. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 18000
url: /it/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


Implementa il campo BIBLIOGRAPHY. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Ottiene l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua. |
...
| [get_FormatLanguageId](./get_formatlanguageid/)() | Ottiene l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento. |
...
| [get_SourceTag](./get_sourcetag/)() | Ottiene un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore dell'elemento Tag corrispondente. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Imposta l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Imposta l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Imposta un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore dell'elemento Tag corrispondente. |
| static [Type](./type/)() |  |
