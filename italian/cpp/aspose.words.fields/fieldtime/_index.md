...
description: "Aspose::Words::Fields::FieldTime class. Implementa il campo TIME. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 102000
url: /it/cpp/aspose.words.fields/fieldtime/
---
## FieldTime class


Implementa il campo TIME. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
