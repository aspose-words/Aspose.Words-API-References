...
description: "Aspose::Words::Fields::FieldBidiOutline classe. Implementa il campo BIDIOUTLINE. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 19000
url: /it/cpp/aspose.words.fields/fieldbidioutline/
---
## FieldBidiOutline class


Implementa il campo BIDIOUTLINE. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
