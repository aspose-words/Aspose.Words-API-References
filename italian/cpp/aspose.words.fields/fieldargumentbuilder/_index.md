...
description: "Aspose::Words::Fields::FieldArgumentBuilder class. Costruisce un argomento di campo complesso composto da campi, nodi e testo semplice. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 9000
url: /it/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


Crea un argomento di campo complesso composto da campi, nodi e testo semplice. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Metodo | Descrizione |
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Aggiunge un campo rappresentato da un [FieldBuilder](../fieldbuilder/) all'argomento. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Aggiunge un nodo all'argomento. |
| [AddText](./addtext/)(const System::String\&) | Aggiunge un testo semplice all'argomento. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | Inizializza un'istanza della classe [FieldArgumentBuilder](./). |
