...
description: "Aspose::Words::Fields::FieldFootnoteRef class. Implementa il campo FOOTNOTEREF. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 44000
url: /it/cpp/aspose.words.fields/fieldfootnoteref/
---
## FieldFootnoteRef class


Implementa il campo FOOTNOTEREF. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
