...
description: "Classe Aspose::Words::Fields::FieldFormText. Implementa il campo FORMTEXT. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 48000
url: /it/cpp/aspose.words.fields/fieldformtext/
---
## FieldFormText class


Implementa il campo FORMTEXT. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
