...
description: "Aspose::Words::Fields::FieldOcx class. Implementa il campo OCX. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 76000
url: /it/cpp/aspose.words.fields/fieldocx/
---
## FieldOcx class


Implementa il campo OCX. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
