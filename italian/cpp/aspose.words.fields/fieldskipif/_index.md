---
title: "Classe Aspose::Words::Fields::FieldSkipIf"
linktitle: "FieldSkipIf"
second_title: "Riferimento API Aspose.Words per C++"
description: "Classe Aspose::Words::Fields::FieldSkipIf. Implementa il campo SKIPIF. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 94000
url: /it/cpp/aspose.words.fields/fieldskipif/
---
## FieldSkipIf class


Implementa il campo SKIPIF. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Metodo | Descrizione |
| --- | --- |
| [get_ComparisonOperator](./get_comparisonoperator/)() | Ottiene l'operatore di confronto. |
...
| [get_LeftExpression](./get_leftexpression/)() | Ottiene la parte sinistra dell'espressione di confronto. |
...
| [get_RightExpression](./get_rightexpression/)() | Ottiene la parte destra dell'espressione di confronto. |
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | Imposta l'operatore di confronto. |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | Imposta la parte sinistra dell'espressione di confronto. |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | Imposta la parte destra dell'espressione di confronto. |
| static [Type](./type/)() |  |
