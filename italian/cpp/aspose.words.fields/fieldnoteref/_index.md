---
title: "classe Aspose::Words::Fields::FieldNoteRef"
linktitle: "FieldNoteRef"
second_title: "Riferimento API Aspose.Words per C++"
description: "classe Aspose::Words::Fields::FieldNoteRef. Implementa il campo NOTEREF. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 72000
url: /it/cpp/aspose.words.fields/fieldnoteref/
---
## FieldNoteRef class


Implementa il campo NOTEREF. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Metodo | Descrizione |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Ottiene il nome del segnalibro. |
...
| [get_InsertHyperlink](./get_inserthyperlink/)() | Ottiene se inserire un collegamento ipertestuale al paragrafo contrassegnato. |
| [get_InsertReferenceMark](./get_insertreferencemark/)() | Inserisce il segno di riferimento con la stessa formattazione dei caratteri dello stile Riferimento Nota a Piè di Pagina o Riferimento Nota di Fine. |
| [get_InsertRelativePosition](./get_insertrelativeposition/)() | Ottiene se inserire una posizione relativa del paragrafo contrassegnato. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Imposta il nome del segnalibro. |
| [set_InsertHyperlink](./set_inserthyperlink/)(bool) | Imposta se inserire un collegamento ipertestuale al paragrafo contrassegnato. |
| [set_InsertReferenceMark](./set_insertreferencemark/)(bool) | Inserisce il segno di riferimento con la stessa formattazione dei caratteri dello stile Riferimento Nota a Piè di Pagina o Riferimento Nota di Fine. |
| [set_InsertRelativePosition](./set_insertrelativeposition/)(bool) | Imposta se inserire una posizione relativa del paragrafo contrassegnato. |
