...
description: "Aspose::Words::Fields::FieldAutoNumLgl classe. Implementa il campo AUTONUMLGL. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 13000
url: /it/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Implementa il campo AUTONUMLGL. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Ottiene se visualizzare il numero senza un punto finale. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Ottiene il carattere separatore da utilizzare. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Imposta se visualizzare il numero senza un punto finale. |
| [set_Result](../field/set_result/)(const System::String\&) | Setter per [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Imposta il carattere separatore da utilizzare. |
| static [Type](./type/)() |  |
