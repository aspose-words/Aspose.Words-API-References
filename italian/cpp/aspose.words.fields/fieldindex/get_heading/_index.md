---
title: "Aspose::Words::Fields::FieldIndex::get_Heading metodo"
linktitle: "get_Heading"
second_title: "Riferimento API Aspose.Words per C++"
description: "Aspose::Words::Fields::FieldIndex::get_Heading method. Ottiene o imposta un'intestazione che appare all'inizio di ogni gruppo di voci per una data lettera in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.fields/fieldindex/get_heading/
---
## FieldIndex::get_Heading method


Ottiene o imposta un'intestazione che appare all'inizio di ogni insieme di voci per una data lettera.
