...
description: "Aspose::Words::Fields::FieldFormDropDown class. Implementa il campo FORMDROPDOWN. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 47000
url: /it/cpp/aspose.words.fields/fieldformdropdown/
---
## FieldFormDropDown class


Implementa il campo FORMDROPDOWN. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
