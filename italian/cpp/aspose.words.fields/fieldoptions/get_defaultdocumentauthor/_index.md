---
title: "Metodo Aspose::Words::Fields::FieldOptions::get_DefaultDocumentAuthor"
linktitle: "get_DefaultDocumentAuthor"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Fields::FieldOptions::get_DefaultDocumentAuthor. Ottiene o imposta il nome dell'autore predefinito del documento. Se il nome dell'autore è già specificato nelle proprietà integrate del documento, questa opzione non viene considerata in C++."
type: docs
weight: 7000
url: /it/cpp/aspose.words.fields/fieldoptions/get_defaultdocumentauthor/
---
## FieldOptions::get_DefaultDocumentAuthor method


Ottiene o imposta il nome dell'autore predefinito del documento. Se il nome dell'autore è già specificato nelle proprietà integrate del documento, questa opzione non viene considerata.
