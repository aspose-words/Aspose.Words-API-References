...
description: "Aspose::Words::Fields::FieldTemplate class. Implementa il campo TEMPLATE. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 101000
url: /it/cpp/aspose.words.fields/fieldtemplate/
---
## FieldTemplate class


Implementa il campo TEMPLATE. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | Impostatore per [Aspose::Words::Fields::FieldTemplate::get_IncludeFullPath](./get_includefullpath/). |
