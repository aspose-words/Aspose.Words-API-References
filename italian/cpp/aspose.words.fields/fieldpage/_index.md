...
description: "Aspose::Words::Fields::FieldPage classe. Implementa il campo PAGE. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 78000
url: /it/cpp/aspose.words.fields/fieldpage/
---
## FieldPage class


Implementa il campo PAGE. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
