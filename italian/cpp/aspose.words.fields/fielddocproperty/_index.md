...
description: "Aspose::Words::Fields::FieldDocProperty class. Implementa il campo DOCPROPERTY. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 35000
url: /it/cpp/aspose.words.fields/fielddocproperty/
---
## FieldDocProperty class


Implementa il campo DOCPROPERTY. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
