...
description: "Aspose::Words::Fields::FieldLink classe. Implementa il campo LINK. Per saperne di più, visita l'articolo della documentazione in C++."
type: docs
weight: 63000
url: /it/cpp/aspose.words.fields/fieldlink/
---
## FieldLink class


Implementa il campo LINK. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
...
| Metodo | Descrizione |
| --- | --- |
| [get_AutoUpdate](./get_autoupdate/)() | Restituisce se aggiornare automaticamente questo campo. |
...
| [get_FormatUpdateType](./get_formatupdatetype/)() | Ottiene il modo in cui l'oggetto collegato aggiorna la sua formattazione. |
...
| [set_AutoUpdate](./set_autoupdate/)(bool) | Imposta se aggiornare automaticamente questo campo. |
| [set_FormatUpdateType](./set_formatupdatetype/)(const System::String\&) | Imposta il modo in cui l'oggetto collegato aggiorna la sua formattazione. |
