---
title: "Metodo Aspose::Words::Fields::FieldFormat::get_GeneralFormats"
linktitle: "get_GeneralFormats"
second_title: "Riferimento API Aspose.Words per C++"
description: "Metodo Aspose::Words::Fields::FieldFormat::get_GeneralFormats. Restituisce una raccolta di formati generali che vengono applicati a un risultato numerico, di testo o di qualsiasi campo. Corrisponde agli switch \\* in C++."
type: docs
weight: 3000
url: /it/cpp/aspose.words.fields/fieldformat/get_generalformats/
---
## FieldFormat::get_GeneralFormats method


Ottiene una raccolta di formati generali applicati a un risultato di campo numerico, di testo o di qualsiasi tipo. Corrisponde alle opzioni \*.
