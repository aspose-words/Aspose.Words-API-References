...
description: "Aspose::Words::Fields::FieldMergeSeq class. Implementa il campo MERGESEQ. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 69000
url: /it/cpp/aspose.words.fields/fieldmergeseq/
---
## FieldMergeSeq class


Implementa il campo MERGESEQ. Per saperne di più, visita l'articolo di documentazione [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) .
