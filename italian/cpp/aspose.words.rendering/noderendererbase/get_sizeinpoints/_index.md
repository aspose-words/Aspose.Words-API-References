...
description: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints method. Ottiene la dimensione reale della forma in punti in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
## NodeRendererBase::get_SizeInPoints method


Restituisce le dimensioni effettive della forma in punti.
...
Questa proprietà restituisce la dimensione della reale (come renderizzata nella pagina) area di delimitazione della forma. La dimensione tiene conto della rotazione della forma (se presente).
