...
description: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels method. Calcola i limiti della forma in pixel per un fattore di zoom e una risoluzione specificati in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.rendering/noderendererbase/getboundsinpixels/
---
...
Il riquadro di delimitazione reale (come renderizzato nella pagina) della forma in pixel.
## Note


Questo metodo converte [BoundsInPoints](../get_boundsinpoints/) in un rettangolo in pixel.
