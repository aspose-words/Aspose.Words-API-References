...
description: "Metodo Aspose::Words::Rendering::NodeRendererBase::GetSizeInPixels. Calcola la dimensione della forma in pixel per un fattore di zoom e una risoluzione specificati in C++."
type: docs
weight: 8000
url: /it/cpp/aspose.words.rendering/noderendererbase/getsizeinpixels/
---
...
Questo metodo converte [SizeInPoints](../get_sizeinpoints/) in dimensione in pixel ed è utile quando si desidera creare una bitmap per renderizzare la forma in modo ordinato sulla bitmap.
