...
description: "Aspose::Words::Tables::RowCollection class. Fornisce accesso tipizzato a una raccolta di nodi Row. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 6000
url: /it/cpp/aspose.words.tables/rowcollection/
---
## RowCollection class


Fornisce accesso tipizzato a una raccolta di nodi [Row](../row/). Per saperne di più, visita l'articolo di documentazione [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [idx_get](./idx_get/)(int32_t) | Recupera un [Row](../row/) all'indice specificato. |
