...
description: "Aspose::Words::Tables::CellCollection class. Fornisce accesso tipizzato a una raccolta di nodi Cell. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 2000
url: /it/cpp/aspose.words.tables/cellcollection/
---
## CellCollection class


Fornisce accesso tipizzato a una raccolta di nodi [Cell](../cell/). Per saperne di più, visita l'articolo di documentazione [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [idx_get](./idx_get/)(int32_t) | Recupera un [Cell](../cell/) all'indice specificato. |
...
| [ToArray](./toarray/)() | Copia tutte le celle dalla raccolta in un nuovo array di celle. |
| static [Type](./type/)() |  |
