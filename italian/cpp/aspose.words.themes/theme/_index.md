...
description: "Aspose::Words::Themes::Theme class. Rappresenta il Tema del documento e fornisce l'accesso alle parti principali del tema, inclusi MajorFonts, MinorFonts e Colors. Per saperne di più, visita l'articolo di documentazione in C++."
type: docs
weight: 1000
url: /it/cpp/aspose.words.themes/theme/
---
## Theme class


Rappresenta il documento [Theme](./) e fornisce l'accesso alle parti principali del tema, inclusi [MajorFonts](./get_majorfonts/), [MinorFonts](./get_minorfonts/) e [Colors](./get_colors/). Per saperne di più, visita l'articolo di documentazione [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Metodo | Descrizione |
| --- | --- |
| [get_Colors](./get_colors/)() const | Consente di specificare l'insieme di colori del tema per il documento. |
| [get_MajorFonts](./get_majorfonts/)() const | Consente di specificare l'insieme di caratteri principali per diverse lingue. |
| [get_MinorFonts](./get_minorfonts/)() const | Consente di specificare l'insieme di caratteri secondari per diverse lingue. |
