...
description: "Aspose::Words::Themes::ThemeFont enum. Specifica i tipi di nomi di caratteri del tema per i temi dei documenti in C++."
type: docs
weight: 5000
url: /it/cpp/aspose.words.themes/themefont/
---
## ThemeFont enum


Specifica i tipi di nomi di caratteri del tema per i temi dei documenti.
...
| Principale | 1 | Carattere del tema principale. |
| Minore | 2 | Carattere del tema minore. |
