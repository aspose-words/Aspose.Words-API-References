...
description: Indica la presenza dellombreggiatura 3D per la riga orizzontale. Se true la riga orizzontale è priva di ombreggiatura 3D e viene utilizzata la tinta unita.
type: docs
weight: 40
