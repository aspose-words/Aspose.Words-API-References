...
description: Scopri il metodo Shape AcceptStart e guida i visitatori in modo fluido all'inizio del tuo progetto, migliorando il coinvolgimento e l'esperienza utente.
type: docs
weight: 270
url: /it/net/aspose.words.drawing/shape/acceptstart/
---
## Shape.AcceptStart method

Accetta un visitatore per aver visitato l'inizio della forma.
