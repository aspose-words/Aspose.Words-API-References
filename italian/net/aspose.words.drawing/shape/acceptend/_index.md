...
description: Scopri il metodo Shape AcceptEnd per guidare senza problemi i visitatori verso la fine della forma, migliorando l'esperienza utente e l'interazione.
type: docs
weight: 260
url: /it/net/aspose.words.drawing/shape/acceptend/
---
## Shape.AcceptEnd method

Accetta un visitatore per aver visitato la fine della forma.
