...
description: Shape proprietà. Definisce il testo del percorso del testo di un oggetto WordArt.
type: docs
weight: 230
...
Definisce il testo del percorso del testo (di un oggetto WordArt).
