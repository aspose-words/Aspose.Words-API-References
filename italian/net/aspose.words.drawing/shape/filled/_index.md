...
description: Controlla l'estetica delle forme con la proprietà Forma riempita, decidendo se i tuoi percorsi chiusi sono riempiti per una maggiore flessibilità di progettazione e un impatto visivo più gradevole.
type: docs
weight: 60
url: /it/net/aspose.words.drawing/shape/filled/
---
## Shape.Filled property

Determina se il percorso chiuso della forma verrà riempito.
