...
description: ImageData proprietà. Ottiene o imposta la luminosità dellimmagine. Il valore per questa proprietà deve essere un numero compreso tra 00 più debole e 10 più luminoso.
type: docs
weight: 30
...
Ottiene o imposta la luminosità dell'immagine. Il valore per questa proprietà deve essere un numero compreso tra 0,0 (più debole) e 1,0 (più luminoso).
