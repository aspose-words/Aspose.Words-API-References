...
description: Scopri la proprietà "ImageData Borders" per migliorare le immagini in linea con bordi personalizzabili. Migliora i tuoi contenuti visivi e il coinvolgimento degli utenti oggi stesso!
type: docs
weight: 20
url: /it/net/aspose.words.drawing/imagedata/borders/
---
## ImageData.Borders property

Ottiene l'insieme dei bordi dell'immagine. I bordi hanno effetto solo sulle immagini in linea.
