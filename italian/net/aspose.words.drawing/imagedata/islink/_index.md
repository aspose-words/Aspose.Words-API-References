...
description: Scopri come la proprietà IsLink di ImageData migliora il tuo design collegando le immagini alle forme in modo fluido quando SourceFullName è impostato. Dai sfogo alla tua creatività!
type: docs
weight: 150
url: /it/net/aspose.words.drawing/imagedata/islink/
---
## ImageData.IsLink property

Restituisce`VERO` se l'immagine è collegata alla forma (quando[`SourceFullName`](../sourcefullname/) è specificato).
