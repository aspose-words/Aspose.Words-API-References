...
description: ImageData proprietà. Ottiene o imposta il contrasto per limmagine specificata. Il valore per questa proprietà deve essere un numero compreso tra 00 il contrasto minimo e 10 il contrasto massimo.
type: docs
weight: 50
