...
description: Regola facilmente il contrasto dell'immagine con la proprietà Contrasto ImageData. Imposta valori da 0,0 (basso) a 1,0 (alto) per una nitidezza e una qualità dell'immagine ottimali.
type: docs
weight: 50
...
Ottiene o imposta il contrasto per l'immagine specificata. Il valore per questa proprietà deve essere un numero compreso tra 0,0 (contrasto minimo) e 1,0 (contrasto massimo).
