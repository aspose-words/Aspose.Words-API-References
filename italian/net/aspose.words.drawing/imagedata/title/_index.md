...
description: Scopri come la proprietà ImageData Title valorizza le tue immagini definendo titoli unici, migliorando la visibilità e l'interazione nei risultati di ricerca.
type: docs
weight: 180
url: /it/net/aspose.words.drawing/imagedata/title/
---
## ImageData.Title property

Definisce il titolo di un'immagine.
