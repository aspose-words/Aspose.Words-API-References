...
description: SignatureLine proprietà. Ottiene o imposta le istruzioni per il firmatario che vengono visualizzate alla firma della riga della firma. Questa proprietà viene ignorata seDefaultInstructions è impostato. Il valore predefinito per questa proprietà è stringa vuota Empty .
type: docs
weight: 50
...
Ottiene o imposta le istruzioni per il firmatario che vengono visualizzate alla firma della riga della firma. Questa proprietà viene ignorata se[`DefaultInstructions`](../defaultinstructions/) è impostato. Il valore predefinito per questa proprietà è **stringa vuota** (Empty ).
