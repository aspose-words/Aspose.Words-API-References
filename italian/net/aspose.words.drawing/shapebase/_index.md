...
description: Aspose.Words.Drawing.ShapeBase classe. Classe di base per oggetti nel livello di disegno ad esempio una forma un oggetto a forma libera un oggetto OLE un controllo ActiveX o unimmagine.
type: docs
weight: 1110
