...
description: Scopri l'enumerazione Aspose.Words.Drawing.ArrowWidth per personalizzare la larghezza delle estremità delle frecce, per migliorare la visualizzazione dei documenti e la precisione nei tuoi progetti.
type: docs
weight: 740
url: /it/net/aspose.words.drawing/arrowwidth/
---
## ArrowWidth enumeration

Larghezza della freccia alla fine di una riga.
