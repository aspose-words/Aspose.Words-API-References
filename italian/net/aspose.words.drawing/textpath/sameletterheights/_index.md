...
description: Scopri la proprietà TextPath SameLetterHeights per garantire un'altezza uniforme delle lettere, migliorando la leggibilità del testo e la coerenza del design nell'intero progetto.
type: docs
weight: 100
url: /it/net/aspose.words.drawing/textpath/sameletterheights/
---
## TextPath.SameLetterHeights property

Determina se tutte le lettere avranno la stessa altezza indipendentemente dalla lettera iniziale.
