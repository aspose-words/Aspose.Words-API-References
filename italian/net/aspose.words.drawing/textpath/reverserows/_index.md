...
description: Scopri la proprietà TextPath ReverseRows per migliorare il tuo layout. Controlla l'ordine delle righe per una maggiore flessibilità di progettazione e un'esperienza utente migliorata.
type: docs
weight: 80
...
Se`VERO`, l'ordine di layout delle righe è invertito. Questo attributo viene utilizzato per il layout verticale del testo.
