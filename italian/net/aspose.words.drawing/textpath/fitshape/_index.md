...
description: Scopri come la proprietà TextPath FitShape garantisce che il testo si adatti perfettamente al riquadro di delimitazione di una forma, per una maggiore flessibilità di progettazione.
type: docs
weight: 30
url: /it/net/aspose.words.drawing/textpath/fitshape/
---
## TextPath.FitShape property

Definisce se il testo si adatta al riquadro di delimitazione di una forma.
