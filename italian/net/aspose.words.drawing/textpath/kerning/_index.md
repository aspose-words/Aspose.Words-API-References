...
description: Scopri la proprietà TextPath Kerning per migliorare la tipografia controllando le impostazioni di kerning, per una migliore leggibilità del testo e una migliore qualità del design.
type: docs
weight: 60
url: /it/net/aspose.words.drawing/textpath/kerning/
---
## TextPath.Kerning property

Determina se la crenatura è attivata.
