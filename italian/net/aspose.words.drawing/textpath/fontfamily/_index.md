...
description: Scopri la proprietà TextPath FontFamily per definire e personalizzare senza sforzo i percorsi di testo per ottenere una tipografia straordinaria nel web design.
type: docs
weight: 40
url: /it/net/aspose.words.drawing/textpath/fontfamily/
---
## TextPath.FontFamily property

Definisce la famiglia del font del percorso di testo.
