...
description: TextPath Shadow proprietà. Definisce se viene applicata unombra al testo su un percorso di testo in C#.
type: docs
weight: 110
...
Definisce se viene applicata un'ombra al testo su un percorso di testo.
