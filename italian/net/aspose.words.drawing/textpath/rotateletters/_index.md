...
description: Scopri la proprietà TextPath RotateLetters per migliorare i tuoi progetti controllando la rotazione del testo e creando un effetto visivo dinamico. Dai sfogo alla tua creatività!
type: docs
weight: 90
url: /it/net/aspose.words.drawing/textpath/rotateletters/
---
## TextPath.RotateLetters property

Determina se le lettere del testo vengono ruotate.
