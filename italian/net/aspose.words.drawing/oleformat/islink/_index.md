...
description: OleFormat proprietà. Restituisce true se loggetto OLE è collegato quandoSourceFullName è specificato.
type: docs
weight: 40
...
Restituisce true se l'oggetto OLE è collegato (quando[`SourceFullName`](../sourcefullname/) è specificato).
