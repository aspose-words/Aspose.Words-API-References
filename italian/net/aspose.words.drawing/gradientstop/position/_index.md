...
Ottiene o imposta un valore che rappresenta la posizione di un arresto all'interno del gradiente espresso come percentuale nell'intervallo da 0,0 a 1,0.
