...
description: Scopri la proprietà GradientStop Position, imposta e regola facilmente le posizioni di arresto del gradiente dallo 0% al 100% per ottenere effetti visivi sorprendenti nei tuoi progetti.
type: docs
weight: 40
...
Ottiene o imposta un valore che rappresenta la posizione di una fermata all'interno del gradiente espresso come percentuale nell'intervallo da 0,0 a 1,0.
