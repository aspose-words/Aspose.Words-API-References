...
description: GradientStop proprietà. Ottiene o imposta un valore che rappresenta la posizione di uno stop allinterno del gradiente espresso come percentuale nellintervallo da 00 a 10.
type: docs
weight: 30
