...
description: Scopri la proprietà GradientStop Color per impostare e personalizzare facilmente i colori di interruzione del gradiente per ottenere effetti visivi sorprendenti nei tuoi progetti.
type: docs
weight: 30
...
Ottiene o imposta un valore che rappresenta il colore del punto di interruzione del gradiente.
