...
description: Scopri il metodo AcceptStart di GroupShape per accogliere senza problemi i visitatori e migliorare la loro esperienza fin dall'inizio della tua candidatura.
type: docs
weight: 50
url: /it/net/aspose.words.drawing/groupshape/acceptstart/
---
## GroupShape.AcceptStart method

Accetta un visitatore per aver visitato l'inizio del GroupShape.
