...
| Center | `1` | Centrare il testo sulla larghezza. |
| Left | `2` | Giustifica a sinistra. |
| Right | `3` | Giustifica a destra. |
| LetterJustify | `4` | Allarga le lettere per adattarle alla larghezza. |
| WordJustify | `5` | Diffondi le parole per adattarle alla larghezza. |
