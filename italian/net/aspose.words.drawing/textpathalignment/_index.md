...
description: Scopri l'enum Aspose.Words.Drawing.TextPathAlignment per un allineamento preciso di WordArt. Migliora il design dei tuoi documenti con opzioni di testo versatili!
type: docs
weight: 1770
url: /it/net/aspose.words.drawing/textpathalignment/
---
## TextPathAlignment enumeration

Allineamento WordArt.
...
| --- | --- | --- |
| Stretch | `0` | Allunga ogni riga di testo per adattarla alla larghezza. |
| Center | `1` | Centra il testo sulla larghezza. |
| Left | `2` | Giustifica a sinistra. |
| Right | `3` | Allineamento a destra. |
| LetterJustify | `4` | Distribuisci le lettere per adattarle alla larghezza. |
| WordJustify | `5` | Distribuisci le parole per adattarle alla larghezza. |
