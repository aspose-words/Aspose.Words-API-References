...
| Horizontal | `1` | Gradiente che scorre orizzontalmente su un oggetto. |
| Vertical | `2` | Gradiente che scorre verticalmente lungo un oggetto. |
| DiagonalUp | `3` | Gradiente diagonale che si sposta da un angolo inferiore fino all'angolo opposto. |
| DiagonalDown | `4` | Gradiente diagonale che si sposta da un angolo superiore fino all'angolo opposto. |
