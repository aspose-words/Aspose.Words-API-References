...
description: GradientStopCollection metodo. Inserisce aGradientStop alla raccolta in un determinato indice.
type: docs
weight: 50
...
Inserisce a[`GradientStop`](../../gradientstop/) alla raccolta in un determinato indice.
