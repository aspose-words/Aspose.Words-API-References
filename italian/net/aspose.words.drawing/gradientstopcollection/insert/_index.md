...
description: Aggiungi facilmente un GradientStop alla tua collezione con il metodo GradientStopCollection Insert. Migliora le tue transizioni di colore in modo impeccabile!
type: docs
weight: 50
...
Inserisce un[`GradientStop`](../../gradientstop/) alla raccolta a un indice specificato.
