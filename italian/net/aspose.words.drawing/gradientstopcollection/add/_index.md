...
description: Migliora senza sforzo i tuoi gradienti con il metodo GradientStopCollection Add. Aggiungi facilmente GradientStop personalizzati per design vivaci.
type: docs
weight: 30
url: /it/net/aspose.words.drawing/gradientstopcollection/add/
---
## GradientStopCollection.Add method

Aggiunge uno specificato[`GradientStop`](../../gradientstop/) a un gradiente.
