...
description: GradientStopCollection Add metodo. Aggiunge un valore specificatoGradientStop a un gradiente in C#.
type: docs
weight: 30
...
Aggiunge un valore specificato[`GradientStop`](../../gradientstop/) a un gradiente.
