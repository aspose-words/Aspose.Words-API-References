...
description: Scopri la proprietà Colore Tratto per personalizzare i tuoi design. Migliora le immagini con colori di tratto precisi per risultati grafici straordinari!
type: docs
weight: 50
url: /it/net/aspose.words.drawing/stroke/color/
---
...
Il valore predefinito per a[`Shape`](../../shape/) è Black .
