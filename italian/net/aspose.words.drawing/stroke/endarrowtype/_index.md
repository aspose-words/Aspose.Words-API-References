...
description: Scopri come la proprietà Stroke EndArrowType migliora i tuoi design definendo eleganti punte di freccia per i tratti. Migliora la tua grafica oggi stesso!
type: docs
weight: 90
url: /it/net/aspose.words.drawing/stroke/endarrowtype/
---
## Stroke.EndArrowType property

Definisce la punta della freccia per la fine di un tratto.
