...
description: Scopri la proprietà Stroke EndArrowWidth per personalizzare la larghezza delle punte delle frecce per i tratti, migliorando la precisione del design e l'attrattiva visiva.
type: docs
weight: 100
...
Definisce la larghezza della punta della freccia per la fine di un tratto.
