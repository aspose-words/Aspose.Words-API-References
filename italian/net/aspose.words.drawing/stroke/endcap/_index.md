...
description: Stroke EndCap proprietà. Definisce lo stile dellestremità per la fine di un tratto in C#.
type: docs
weight: 80
...
Definisce lo stile dell'estremità per la fine di un tratto.
