...
description: Scopri la proprietà Stroke EndCap per personalizzare lo stile finale del tuo tratto, migliorando l'aspetto e la precisione del tuo design. Migliora la tua grafica oggi stesso!
type: docs
weight: 110
url: /it/net/aspose.words.drawing/stroke/endcap/
---
## Stroke.EndCap property

Definisce lo stile del tappo per la fine di un tratto.
