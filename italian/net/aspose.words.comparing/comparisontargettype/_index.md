...
description: Scopri l'enum Aspose.Words ComparisonTargetType per confronti precisi di documenti. Imposta facilmente il tuo documento di base per risultati accurati. Inizia subito a ottimizzare!
type: docs
weight: 480
...
| --- | --- | --- |
| Current | `0` | Questo documento viene utilizzato come base durante il confronto. |
| New | `1` | Un altro documento viene utilizzato come base durante il confronto. |
