...
description: CompareOptions Granularity proprietà. Specifica se le modifiche vengono tracciate per carattere o per parola. Il valore predefinito èWordLevel  in C#.
type: docs
weight: 30
