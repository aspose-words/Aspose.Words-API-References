...
description: Scopri come la proprietà IgnoreFormatting di CompareOptions migliora l'elaborazione del testo ignorando la formattazione per un confronto dei dati più efficiente.
type: docs
weight: 90
...
Vero indica che la formattazione viene ignorata.
...
Per impostazione predefinita, la formattazione del documento non viene ignorata.
