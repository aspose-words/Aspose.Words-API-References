...
description: CompareOptions proprietà. True indica che la formattazione viene ignorata. Per impostazione predefinita la formattazione del documento non viene ignorata.
type: docs
weight: 90
