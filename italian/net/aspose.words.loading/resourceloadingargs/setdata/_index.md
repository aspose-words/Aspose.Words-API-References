...
description: Scopri come il metodo SetData di ResourceLoadingArgs migliora l'esperienza utente gestendo in modo efficiente i dati delle risorse per prestazioni ottimali.
type: docs
weight: 40
...
Imposta i dati forniti dall'utente della risorsa che viene utilizzata se[`ResourceLoading`](../../iresourceloadingcallback/resourceloading/) ritornaUserProvided .
