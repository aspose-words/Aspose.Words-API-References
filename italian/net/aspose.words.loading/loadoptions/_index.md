...
description: Aspose.Words.Loading.LoadOptions classe. Consente di specificare opzioni aggiuntive come password o URI di base quando carica un documento in unDocument oggetto.
type: docs
weight: 3460
