...
description: Ottiene o imposta la codifica che verrà utilizzata per caricare un documento HTML TXT o CHM se la codifica non è specificata allinterno del documento. Può essere nullo. Il valore predefinito è null.
type: docs
weight: 50
