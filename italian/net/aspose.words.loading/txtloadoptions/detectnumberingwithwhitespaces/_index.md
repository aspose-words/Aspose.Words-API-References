...
description: Consente di specificare come vengono riconosciute le voci di elenco numerate quando il documento viene importato dal formato di testo normale. Il valore predefinito è true.
type: docs
weight: 20
