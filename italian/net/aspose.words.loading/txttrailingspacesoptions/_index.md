...
description: Scopri l'enum Aspose.Words.TxtTrailingSpacesOptions per una gestione efficiente degli spazi finali durante l'importazione di file di testo. Migliora l'elaborazione dei tuoi documenti oggi stesso!
type: docs
weight: 4200
...
| --- | --- | --- |
| Trim | `0` | Gli spazi finali vengono tagliati. |
