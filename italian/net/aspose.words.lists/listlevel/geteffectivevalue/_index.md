...
Riporta la rappresentazione di stringa del[`ListLevel`](../../listlevel) oggetto per l'indice specificato della voce di elenco. I parametri specificano il[`NumberStyle`](../../../aspose.words/numberstyle) e un formato opzionale string utilizzato quandoCustom è specificato.
...
| numberStyle | NumberStyle | Il[`NumberStyle`](../../../aspose.words/numberstyle) del[`ListLevel`](../../listlevel) oggetto. |
...
La rappresentazione di stringa di[`ListLevel`](../../listlevel) oggetto, descritto dal parametro numberStyle e dal parametro customNumberStyleFormat, nella voce di elenco nella posizione determinata dal parametro index.
