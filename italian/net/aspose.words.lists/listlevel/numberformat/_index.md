...
description: Scopri la proprietà NumberFormat di ListLevel per personalizzare e impostare facilmente formati numerici univoci per i tuoi elenchi, migliorando la chiarezza e lo stile del tuo documento.
type: docs
weight: 70
...
Ad esempio, la stringa "\x0000.\x0001)" genererà un'etichetta di elenco che assomiglia a "1.5)". Il numero "1" è il numero corrente da il primo livello dell'elenco, il numero "5" è il numero corrente dal secondo livello dell'elenco.

Non è consentito il valore Null, ma è valida una stringa vuota che indica che non esiste alcun numero.
