...
description: List proprietà. Restituisce vero se questo elenco è un riferimento a uno stile di elenco.
type: docs
weight: 30
...
Nota, la modifica delle proprietà di un elenco che è un riferimento allo stile elenco non ha effetto. La formattazione dell'elenco specificata nello stile elenco stesso ha sempre la precedenza.
