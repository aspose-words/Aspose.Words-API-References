...
| Classe | Descrizione |
| --- | --- |
| [List](./list/) | Rappresenta la formattazione di un elenco. |
| [ListCollection](./listcollection/) | Memorizza e gestisce la formattazione degli elenchi puntati e numerati utilizzati in un documento. |
| [ListFormat](./listformat/) | Permette di controllare quale formattazione dell'elenco viene applicata a un paragrafo. |
| [ListLabel](./listlabel/) | Definisce le proprietà specifiche di un'etichetta di elenco. |
| [ListLevel](./listlevel/) | Definisce la formattazione per un livello di elenco. |
| [ListLevelCollection](./listlevelcollection/) | Una raccolta di formattazioni di elenchi per ogni livello in un elenco. |
## Enumerazione
