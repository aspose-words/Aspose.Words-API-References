...
| Classe | Descrizione |
| --- | --- |
| [BuildingBlock](./buildingblock/) | Rappresenta una voce di documento del glossario come un Building Block, un testo automatico o una voce di correzione automatica. |
...
| [GlossaryDocument](./glossarydocument/) | Rappresenta l'elemento radice per un documento di glossario all'interno di un documento Word. Un documento di glossario è un archivio per il glossario, le voci di correzione automatica e i blocchi predefiniti. |
## Enumerazione
