...
description: Aspose.Words.BuildingBlocks.BuildingBlock classe. Rappresenta una voce di documento del glossario come un Building Block un testo automatico o una voce di correzione automatica.
type: docs
weight: 130
