...
quando[`BuildingBlock`](../../buildingblock) viene creato, appartiene al documento del glossario specificato, ma non fa ancora parte del documento del glossario e[`ParentNode`](../../../aspose.words/node/parentnode) è`nullo`.

Aggiungere[`BuildingBlock`](../../buildingblock) ad un[`GlossaryDocument`](../../glossarydocument) usa [`AppendChild`](../../../aspose.words/compositenode/appendchild).
