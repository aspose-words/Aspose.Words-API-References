...
description: BuildingBlock proprietà. Specifica la categorizzazione di primo livello per il building block ai fini della classificazione o dellordinamento dellinterfaccia utente.
type: docs
weight: 60
...
Specifica la categorizzazione di primo livello per il building block ai fini della classificazione o dell'ordinamento dell'interfaccia utente.
...
I blocchi predefiniti nell'interfaccia utente di Microsoft Word sono organizzati in Gallerie. A testa`Gallery` può avere più Categorie. Ogni blocco all'interno di a[`Category`](../category/) ha un[`Name`](../name/).

Corrisponde al **docPartPr.categoria.galleria** elemento in OOXML.
