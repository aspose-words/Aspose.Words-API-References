...
description: BuildingBlock Gallery proprietà. Specifica la categorizzazione di primo livello per il blocco predefinito ai fini della classificazione o dellordinamento dellinterfaccia utente in C#.
type: docs
weight: 60
