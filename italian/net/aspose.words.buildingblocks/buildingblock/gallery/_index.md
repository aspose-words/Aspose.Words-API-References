...
description: Scopri le proprietà uniche di BuildingBlock Gallery per una categorizzazione efficiente e un ordinamento fluido dell'interfaccia utente. Migliora la tua organizzazione oggi stesso!
type: docs
weight: 60
...
Specifica la categorizzazione di primo livello per il blocco di costruzione ai fini della classificazione o dell'ordinamento dell'interfaccia utente.
...
blocchi di costruzione nell'interfaccia utente di Microsoft Word sono organizzati in Gallerie. Ogni`Gallery` può avere più categorie. Ogni blocco entro è[`Category`](../category/) ha un[`Name`](../name/).

Corrisponde al**docPartPr.category.gallery** elemento in OOXML.
