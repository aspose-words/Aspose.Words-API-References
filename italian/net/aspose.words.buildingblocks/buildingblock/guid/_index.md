...
description: Scopri la proprietà GUID di BuildingBlock. Gestisci facilmente un identificatore univoco a 128 bit per i tuoi building block, garantendo un'organizzazione e un'identificazione fluide.
type: docs
weight: 70
...
Ottiene o imposta un identificatore (un GUID a 128 bit) che identifica in modo univoco questo blocco di costruzione.
...
Può essere utilizzato da un'applicazione per fare riferimento in modo univoco a un blocco di base indipendentemente dalla diversa denominazione dovuta alla localizzazione.
