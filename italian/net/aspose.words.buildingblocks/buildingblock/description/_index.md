...
description: BuildingBlock proprietà. Ottiene o imposta la descrizione associata a questo blocco predefinito.
type: docs
weight: 40
...
La descrizione può contenere qualsiasi contenuto di stringa, di solito informazioni aggiuntive.

Non può essere`nullo`, ma può essere una stringa vuota.

Corrisponde al **docPartPr.description** elemento in OOXML.
