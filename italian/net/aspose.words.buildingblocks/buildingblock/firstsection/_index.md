...
description: Scopri BuildingBlock FirstSection. Accedi senza sforzo alla prima sezione del tuo building block per un'organizzazione semplificata e una maggiore efficienza.
type: docs
weight: 50
url: /it/net/aspose.words.buildingblocks/buildingblock/firstsection/
---
## BuildingBlock.FirstSection property

Ottiene la prima sezione nel blocco di costruzione.
