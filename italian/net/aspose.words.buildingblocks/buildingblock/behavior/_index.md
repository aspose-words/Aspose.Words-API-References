...
description: Scopri come BuildingBlock Behavior migliora il tuo documento definendo metodi di inserimento dei contenuti per un'integrazione perfetta e un flusso di lavoro migliorato.
type: docs
weight: 20
...
Specifica il comportamento che deve essere applicato quando il contenuto del blocco di costruzione viene inserito nel documento principale.
