...
description: Scopri la proprietà Nome BuildingBlock, gestisci e personalizza facilmente i tuoi blocchi costitutivi con una semplice assegnazione di nomi per un'organizzazione migliorata.
type: docs
weight: 90
...
Ottiene o imposta il nome di questo blocco di costruzione.
...
Il nome può contenere qualsiasi tipo di stringa, solitamente un identificatore descrittivo. Più blocchi costitutivi possono avere lo stesso nome.

Non può essere`null` e non può essere una stringa vuota.

Corrisponde al**docPartPr.name** elemento in OOXML.
