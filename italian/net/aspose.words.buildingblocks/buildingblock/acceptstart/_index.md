...
description: Scopri il metodo AcceptStart di BuildingBlock, accogli i visitatori in modo fluido e migliora la loro esperienza fin dal loro arrivo.
type: docs
weight: 150
url: /it/net/aspose.words.buildingblocks/buildingblock/acceptstart/
---
## BuildingBlock.AcceptStart method

Accetta un visitatore per aver visitato l'inizio del BuildingBlock.
