...
description: Scopri la proprietà LastBuildingBlock in GlossaryDocument, che consente di accedere facilmente al blocco di costruzione finale per una migliore gestione dei documenti.
type: docs
weight: 40
...
Ottiene l'ultimo blocco di costruzione nel documento del glossario.
...
Restituisce`null` se non sono disponibili blocchi di costruzione.
