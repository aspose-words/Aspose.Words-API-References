...
description: Scopri il metodo AcceptEnd di GlossaryDocument, che gestisce in modo efficiente l'accesso dei visitatori alla fine del tuo glossario. Migliora l'esperienza utente oggi stesso!
type: docs
weight: 70
url: /it/net/aspose.words.buildingblocks/glossarydocument/acceptend/
---
## GlossaryDocument.AcceptEnd method

Accetta un visitatore per aver visitato la fine del documento del Glossario.
