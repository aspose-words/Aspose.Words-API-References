...
description: Scopri il metodo AcceptStart di GlossaryDocument per accogliere i visitatori in modo fluido e migliorare la loro esperienza fin dall'inizio della consultazione del tuo glossario.
type: docs
weight: 80
url: /it/net/aspose.words.buildingblocks/glossarydocument/acceptstart/
---
## GlossaryDocument.AcceptStart method

Accetta un visitatore per aver visitato l'inizio del documento del Glossario.
