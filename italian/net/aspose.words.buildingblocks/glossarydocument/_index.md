...
description: Aspose.Words.BuildingBlocks.GlossaryDocument classe. Rappresenta lelemento radice per un documento di glossario allinterno di un documento di Word. Un documento di glossario è un archivio per glossario voci di correzione automatica e blocchi predefiniti.
type: docs
weight: 170
