...
description: Aspose.Words.BuildingBlocks.GlossaryDocument classe. Rappresenta lelemento radice per un documento di glossario allinterno di un documento Word. Un documento di glossario è un archivio per il glossario le voci di correzione automatica e i blocchi predefiniti.
type: docs
weight: 180
...
| [GetBuildingBlock](../../aspose.words.buildingblocks/glossarydocument/getbuildingblock/)(BuildingBlockGallery, string, string) | Trova un blocco predefinito utilizzando la raccolta, la categoria e il nome specificati. |
