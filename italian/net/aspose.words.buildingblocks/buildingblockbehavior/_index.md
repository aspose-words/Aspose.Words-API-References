...
description: Scopri l'enum BuildingBlockBehavior di Aspose.Words, che definisce il modo in cui i blocchi predefiniti migliorano il contenuto del documento al momento dell'inserimento, per una modifica fluida.
type: docs
weight: 330
...
Specifica il comportamento che deve essere applicato al contenuto del blocco di costruzione quando viene inserito nel documento principale.
...
| --- | --- | --- |
| Content | `0` | Specifica che il blocco di costruzione deve essere inserito come contenuto in linea. |
| Paragraph | `1` | Specifica che il blocco di costruzione deve essere inserito in un paragrafo a sé stante. |
| Page | `2` | Specifica che il blocco di costruzione deve essere aggiunto nella sua pagina. |
| Default | `0` | Lo stesso diContent . |

## Osservazioni

Corrisponde al**ST_DocPartBehavior** digitare OOXML.
