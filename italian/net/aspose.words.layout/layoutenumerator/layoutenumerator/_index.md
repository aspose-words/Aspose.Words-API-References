...
description: Scopri il costruttore LayoutEnumerator e crea facilmente nuove istanze di questa classe per una gestione efficiente del layout nelle tue applicazioni.
type: docs
weight: 10
url: /it/net/aspose.words.layout/layoutenumerator/layoutenumerator/
---
...
| --- | --- | --- |
| document | Document | Un documento di cui enumerare il modello di impaginazione. |

## Osservazioni

Se il modello di layout di pagina del documento non è stato creato, l'enumeratore chiama[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) per costruirlo.

Ogni volta che un documento viene aggiornato e viene creato un nuovo modello di layout di pagina, è necessario utilizzare un nuovo enumeratore per accedervi.
