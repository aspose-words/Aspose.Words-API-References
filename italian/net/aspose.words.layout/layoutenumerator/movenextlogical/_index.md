...
description: Si sposta allentità sorella successiva in un ordine logico. Quando si ripetono le righe di un paragrafo suddivise tra pagine questo metodo si sposterà alla riga successiva anche se risiede su unaltra pagina.
type: docs
weight: 120
