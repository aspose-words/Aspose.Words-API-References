...
description: LayoutEnumerator metodo. Si sposta allentità sorella successiva in un ordine logico. Quando si ripetono le righe di un paragrafo suddivise tra pagine questo metodo si sposterà alla riga successiva anche se risiede su unaltra pagina.
type: docs
weight: 120
url: /it/net/aspose.words.layout/layoutenumerator/movenextlogical/
---
## LayoutEnumerator.MoveNextLogical method

Si sposta all'entità sorella successiva in un ordine logico. Quando si ripetono le righe di un paragrafo suddivise tra pagine, questo metodo si sposterà alla riga successiva anche se risiede su un'altra pagina.
...
Nota che tuttoSpan le entità sono collegate tra loro quindi se[`Current`](../current/) L'entità è estesa la chiamata ripetuta di questo metodo itera la storia completa del documento.
