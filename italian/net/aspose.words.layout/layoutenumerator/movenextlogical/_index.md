...
description: Scopri come il metodo MoveNextLogical di LayoutEnumerator naviga senza problemi tra entità gemelle, garantendo un'iterazione fluida delle righe dei paragrafi tra le pagine.
type: docs
weight: 130
...
Passa all'entità gemella successiva in ordine logico. Quando si ripetono le righe di un paragrafo suddiviso in più pagine, questo metodo passerà alla riga successiva anche se si trova su un'altra pagina.
...
Nota che tuttiSpan le entità sono collegate tra loro quindi se[`Current`](../current/) L'entità è ripetuta. La chiamata di questo metodo itererà la storia completa del documento.
