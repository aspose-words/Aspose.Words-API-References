...
description: Reimposta LayoutEnumerator sulla prima pagina del documento, migliorando la navigazione e l'efficienza per una gestione fluida dei documenti.
type: docs
weight: 170
url: /it/net/aspose.words.layout/layoutenumerator/reset/
---
## LayoutEnumerator.Reset method

Sposta l'enumeratore alla prima pagina del documento.
