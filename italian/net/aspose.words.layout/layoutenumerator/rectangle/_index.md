...
description: Scopri la proprietà LayoutEnumerator Rectangle. Ottieni rettangoli di delimitazione precisi delle entità rispetto all'angolo superiore sinistro della pagina, espressi in punti.
type: docs
weight: 70
url: /it/net/aspose.words.layout/layoutenumerator/rectangle/
---
## LayoutEnumerator.Rectangle property

Restituisce il rettangolo di delimitazione dell'entità corrente rispetto all'angolo superiore sinistro della pagina (in punti).
