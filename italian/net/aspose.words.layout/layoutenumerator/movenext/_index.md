...
description: LayoutEnumerator metodo. Si sposta allentità sorella successiva in ordine visivo. Quando si ripetono le righe di un paragrafo suddivise tra pagine questo metodo non si sposta alla pagina successiva ma si sposta allentità successiva sulla stessa pagina.
type: docs
weight: 110
...
Si sposta all'entità sorella successiva in ordine visivo. Quando si ripetono le righe di un paragrafo suddivise tra pagine, questo metodo non si sposta alla pagina successiva, ma si sposta all'entità successiva sulla stessa pagina.
