...
description: Scopri il metodo MoveParent di LayoutEnumerator per navigare senza sforzo tra le entità padre, migliorando l'efficienza della gestione dei dati.
type: docs
weight: 140
...
Passa all'entità padre del tipo specificato.
...
| --- | --- | --- |
| types | LayoutEntityType | Il tipo di entità padre a cui spostarsi. Utilizzare l'OR bit a bit per specificare più tipi padre. |

## Osservazioni

Questo metodo è utile se è necessario trovare la cella, la colonna o l'intestazione/piè di pagina padre dell'entità.
