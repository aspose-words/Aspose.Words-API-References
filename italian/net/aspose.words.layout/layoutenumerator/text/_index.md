...
description: Scopri la proprietà Text di LayoutEnumerator per recuperare facilmente il testo dell'entità span corrente. Semplifica la gestione dei dati con questa potente funzionalità!
type: docs
weight: 80
...
Recupera il testo dell'entità span corrente. Genera un'eccezione per altri tipi di entità.
