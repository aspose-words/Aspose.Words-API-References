...
description: LayoutEnumerator metodo. Si sposta allentità di pari livello precedente in un ordine logico. Quando si ripetono le righe di un paragrafo suddivise tra pagine questo metodo si sposterà alla riga precedente anche se risiede su unaltra pagina.
type: docs
weight: 150
...
Si sposta all'entità di pari livello precedente in un ordine logico. Quando si ripetono le righe di un paragrafo suddivise tra pagine, questo metodo si sposterà alla riga precedente anche se risiede su un'altra pagina.
