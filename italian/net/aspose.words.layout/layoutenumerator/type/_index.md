...
description: Scopri la proprietà Tipo LayoutEnumerator, accedi facilmente al tipo dell'entità corrente per una gestione semplificata dei dati e prestazioni dell'applicazione migliorate.
type: docs
weight: 90
