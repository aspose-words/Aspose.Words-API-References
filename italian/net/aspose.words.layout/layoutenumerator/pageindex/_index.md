...
description: Scopri la proprietà PageIndex di LayoutEnumerator. Recupera facilmente l'indice a partire da 1 della pagina contenente l'entità corrente per una navigazione fluida.
type: docs
weight: 60
...
Ottiene l'indice basato su 1 di una pagina che contiene l'entità corrente.
