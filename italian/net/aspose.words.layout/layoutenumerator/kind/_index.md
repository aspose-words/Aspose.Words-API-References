...
description: LayoutEnumerator proprietà. Ottiene il tipo dellentità corrente. Può essere una stringa vuota ma mai nulla.
type: docs
weight: 40
...
Ottiene il tipo dell'entità corrente. Può essere una stringa vuota ma mai nulla.
...
Questo è un tipo più specifico dell'entità corrente, ad esempio ha l'estensione del segnalibroSpan type and può avere un tipo BOOKMARKSTART o BOOKMARKEND.
