...
description: Controlla la visibilità delle revisioni con la proprietà ShowRevisionMarks. Formatta facilmente il testo delle revisioni per maggiore chiarezza, migliorando la collaborazione sui documenti. Il valore predefinito è "true".
type: docs
weight: 210
...
Consente di specificare se il testo della revisione deve essere contrassegnato con un markup di formattazione speciale. Il valore predefinito è`VERO` .
