...
description: RevisionOptions ShowRevisionMarks proprietà. Permette di specificare se il testo di revisione deve essere contrassegnato con uno speciale markup di formattazione. Il valore predefinito èVERO  in C#.
type: docs
weight: 190
url: /it/net/aspose.words.layout/revisionoptions/showrevisionmarks/
---
## RevisionOptions.ShowRevisionMarks property

Permette di specificare se il testo di revisione deve essere contrassegnato con uno speciale markup di formattazione. Il valore predefinito è`VERO` .
