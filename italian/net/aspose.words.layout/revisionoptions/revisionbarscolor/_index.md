...
description: RevisionOptions proprietà. Consente di specificare il colore da utilizzare per le barre laterali che identificano le righe del documento contenenti informazioni riviste. Il valore predefinito èRed .
type: docs
weight: 130
...
Impostando questa proprietà suByAuthor oNoHighlight values comporterà l'occultamento delle barre di revisione dal layout.
