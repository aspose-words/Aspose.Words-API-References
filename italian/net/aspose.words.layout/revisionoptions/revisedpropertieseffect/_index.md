...
description: RevisionOptions proprietà. Consente di specificare leffetto per le aree di contenuto con modifiche alle proprietà di formattazioneFormatChange Il valore predefinito èNone
type: docs
weight: 120
...
Consente di specificare l'effetto per le aree di contenuto con modifiche alle proprietà di formattazioneFormatChange Il valore predefinito èNone
...
Hidden non è consentito e causeràArgumentOutOfRangeException.
