...
description: Scopri il metodo GetNumPagesSpanned di LayoutCollector per determinare in modo efficiente quante pagine occupa un nodo. Semplifica la gestione dei tuoi documenti oggi stesso!
type: docs
weight: 60
...
Ottiene il numero di pagine che il nodo specificato occupa. 0 se il nodo è all'interno di una singola pagina. È lo stesso di[`GetEndPageIndex`](../getendpageindex/) -[`GetStartPageIndex`](../getstartpageindex/) .
