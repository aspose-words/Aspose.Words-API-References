...
description: Scopri il metodo GetStartPageIndex di LayoutCollector per trovare facilmente l'indice a partire da 1 della pagina iniziale di un nodo. Semplifica il tuo processo di mappatura oggi stesso!
type: docs
weight: 70
...
Ottiene l'indice a partire da 1 della pagina in cui inizia il nodo. Restituisce 0 se il nodo non può essere mappato a una pagina.
