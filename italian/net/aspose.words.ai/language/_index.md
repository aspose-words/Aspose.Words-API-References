...
description: Scopri l'enum Aspose.Words.AI.Language per una traduzione di testo fluida basata sull'intelligenza artificiale. Migliora i tuoi documenti con un supporto multilingue accurato oggi stesso!
type: docs
weight: 80
url: /it/net/aspose.words.ai/language/
---
## Language enumeration

Specifica la lingua in cui il testo verrà tradotto tramite AI.  .
