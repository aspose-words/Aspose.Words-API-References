...
description: Personalizza la tipografia del tuo sito con MajorFonts. Imposta facilmente diversi font per diverse lingue per migliorare la leggibilità e l'esperienza utente.
type: docs
weight: 30
url: /it/net/aspose.words.themes/theme/majorfonts/
---
## Theme.MajorFonts property

Consente di specificare l'insieme dei caratteri principali per le diverse lingue.
