...
description: Ottimizza i flussi di lavoro dei tuoi documenti con il metodo iFieldMergingCallback. Integra perfettamente i dati nei campi di stampa unione di Aspose.Words per una maggiore efficienza.
type: docs
weight: 10
...
Chiamato quando il motore di stampa unione Aspose.Words sta per inserire dati in un campo di unione nel documento.
