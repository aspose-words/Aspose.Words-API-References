...
description: MappedDataFieldCollection metodo. Restituisce un oggetto enumeratore dizionario che può essere utilizzato per scorrere tutti gli elementi della raccolta.
type: docs
weight: 70
