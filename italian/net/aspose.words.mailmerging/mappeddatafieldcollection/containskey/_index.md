...
description: Scopri se esiste una mappatura specifica dei campi di un documento in MappedDataFieldCollection con il metodo ContainsKey. Semplifica la gestione dei dati senza sforzo!
type: docs
weight: 50
url: /it/net/aspose.words.mailmerging/mappeddatafieldcollection/containskey/
---
## MappedDataFieldCollection.ContainsKey method

Determina se nella raccolta esiste una mappatura dal campo specificato nel documento.
