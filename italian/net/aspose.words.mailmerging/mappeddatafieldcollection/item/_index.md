...
description: Scopri la proprietà MappedDataFieldCollection Item per gestire facilmente i nomi dei campi nella tua origine dati per un'integrazione perfetta della stampa unione.
type: docs
weight: 20
...
Ottiene o imposta il nome del campo nell'origine dati associata al campo di unione di stampa specificato.
