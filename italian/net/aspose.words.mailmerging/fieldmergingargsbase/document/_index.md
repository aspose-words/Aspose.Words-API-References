...
description: FieldMergingArgsBase proprietà. Restituisce ilDocument oggetto per il quale viene eseguita la stampa unione.
type: docs
weight: 10
...
Restituisce il`Document` oggetto per il quale viene eseguita la stampa unione.
