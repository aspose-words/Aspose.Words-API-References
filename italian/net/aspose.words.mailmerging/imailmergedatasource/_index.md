...
description: Implementa questa interfaccia per consentire la stampa unione da unorigine dati personalizzata come un elenco di oggetti. Sono supportati anche i dati di dettaglio principale.
type: docs
weight: 3590
