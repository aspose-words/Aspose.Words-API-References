...
description: Ottiene o imposta un valore che indica se i campi dellintero documento vengono aggiornati durante lesecuzione di una stampa unione con le regioni.
type: docs
weight: 70
