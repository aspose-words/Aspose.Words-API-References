...
description: MailMerge proprietà. Ottiene o imposta un tag di fine regione per la stampa unione.
type: docs
weight: 90
...
Ottiene o imposta un tag di fine regione per la stampa unione.
