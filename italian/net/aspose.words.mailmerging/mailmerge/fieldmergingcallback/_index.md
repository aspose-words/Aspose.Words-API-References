...
description: MailMerge proprietà. Si verifica durante la stampa unione quando viene rilevato un campo di stampa unione nel documento.
type: docs
weight: 30
...
Si verifica durante la stampa unione quando viene rilevato un campo di stampa unione nel documento.
