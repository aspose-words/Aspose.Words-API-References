...
description: Scopri la proprietà MailMergeRegionInfo MustacheTags, che restituisce in modo efficiente un elenco completo di tag mustache secondari per un'integrazione dati ottimale.
type: docs
weight: 50
url: /it/net/aspose.words.mailmerging/mailmergeregioninfo/mustachetags/
---
## MailMergeRegionInfo.MustacheTags property

Restituisce un elenco di tag figlio "baffi".
