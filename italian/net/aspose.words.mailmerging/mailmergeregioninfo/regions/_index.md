...
description: Scopri la proprietà Regions di MailMergeRegionInfo, che restituisce in modo efficiente un elenco completo di regioni figlio per una gestione dei dati ottimale.
type: docs
weight: 80
