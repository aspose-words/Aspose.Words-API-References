...
description: Scopri la proprietà WebExtension Reference, la chiave per definire i link principali per le estensioni web. Migliora le funzionalità e semplifica lo sviluppo!
type: docs
weight: 60
...
Specifica il riferimento primario a un'estensione web.
