...
description: Scopri la proprietà IsFrozen di WebExtension, che controlla l'interazione dell'utente con la tua estensione web. Migliora l'usabilità e ottimizza l'esperienza utente oggi stesso!
type: docs
weight: 40
url: /it/net/aspose.words.webextensions/webextension/isfrozen/
---
## WebExtension.IsFrozen property

Specifica se l'utente può interagire o meno con l'estensione web.
