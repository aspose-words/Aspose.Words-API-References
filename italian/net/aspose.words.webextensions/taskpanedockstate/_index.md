...
description: Scopri l'enum Aspose.Words.WebExtensions.TaskPaneDockState, che definisce le posizioni del riquadro attività per una migliore modifica dei documenti e un'esperienza utente migliorata.
type: docs
weight: 7580
