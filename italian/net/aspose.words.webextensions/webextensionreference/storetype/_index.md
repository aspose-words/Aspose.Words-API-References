...
description: Scopri la proprietà WebExtensionReference StoreType, che definisce i tipi di marketplace per migliorare i tuoi progetti di sviluppo web con soluzioni su misura.
type: docs
weight: 40
