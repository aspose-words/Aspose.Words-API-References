...
description: Scopri come la proprietà AppRef WebExtensionBinding collega le chiavi di associazione ai dati del documento, migliorando le funzionalità e le prestazioni della tua app web.
type: docs
weight: 20
...
Specifica la chiave di associazione utilizzata per mappare la voce di associazione in questo elenco con i dati associati nel documento.
