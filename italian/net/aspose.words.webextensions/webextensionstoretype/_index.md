...
description: Aspose.Words.WebExtensions.WebExtensionStoreType enum. Enumera i tipi disponibili di un negozio di estensioni web.
type: docs
weight: 6510
...
Enumera i tipi disponibili di un negozio di estensioni web.
...
| --- | --- | --- |
| SPCatalog | `0` | Specifica che il tipo di negozio è Catalogo aziendale di SharePoint. |
