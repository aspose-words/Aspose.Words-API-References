...
description: Scopri Aspose.Words.WebExtensions.WebExtensionPropertyCollection per gestire in modo efficiente le proprietà delle estensioni web personalizzate. Migliora l'automazione dei tuoi documenti oggi stesso!
type: docs
weight: 7640
url: /it/net/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class

Specifica un set di proprietà personalizzate dell'estensione web.
