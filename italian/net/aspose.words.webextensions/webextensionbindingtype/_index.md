...
description: Scopri l'enum Aspose.Words WebExtensionBindingType, che definisce i tipi di binding per un'integrazione perfetta delle estensioni web con i dati dei tuoi documenti.
type: docs
weight: 7620
...
Enumera i tipi di associazione disponibili tra un'estensione web e i dati nel documento.
...
| --- | --- | --- |
| Matrix | `0` | Dati tabellari senza riga di intestazione. |
| Table | `1` | Dati tabellari con una riga di intestazione. |
| Text | `2` | Testo normale. |
| Default | `0` | Matrice utilizzata per impostazione predefinita. |
