...
description: Scopri la proprietà Larghezza TaskPane per personalizzare facilmente la larghezza predefinita del riquadro attività, migliorando l'esperienza utente e le funzionalità.
type: docs
weight: 70
url: /it/net/aspose.words.webextensions/taskpane/width/
---
## TaskPane.Width property

Specifica il valore di larghezza predefinito per questa istanza del riquadro attività.
