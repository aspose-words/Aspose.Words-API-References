...
description: Scopri la classe Aspose.Words.WebExtensions.TaskPaneCollection, la soluzione ideale per gestire in modo efficiente gli oggetti persistenti del riquadro attività. Migliora le tue applicazioni web oggi stesso!
type: docs
weight: 7570
...
Specifica un elenco di oggetti persistenti del riquadro attività.
