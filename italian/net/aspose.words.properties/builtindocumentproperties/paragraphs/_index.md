...
description: Scopri la proprietà Paragrafi di BuiltInDocumentProperties, che offre una stima accurata del numero di paragrafi nel tuo documento per una migliore gestione dei contenuti.
type: docs
weight: 240
