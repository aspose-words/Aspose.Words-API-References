...
description: Scopri la proprietà Pagine BuiltInDocumentProperties, che offre una stima accurata del numero di pagine del tuo documento per una gestione e un'organizzazione efficienti.
type: docs
weight: 230
url: /it/net/aspose.words.properties/builtindocumentproperties/pages/
---
## BuiltInDocumentProperties.Pages property

Rappresenta una stima del numero di pagine del documento.
...
Aspose.Words aggiorna questa proprietà quando si chiama[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/).
