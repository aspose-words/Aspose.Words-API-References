...
description: Scopri la proprietà CharactersWithSpaces di BuiltInDocumentProperties, che stima il numero di caratteri, inclusi gli spazi, per una gestione efficiente dei documenti.
type: docs
weight: 50
url: /it/net/aspose.words.properties/builtindocumentproperties/characterswithspaces/
---
## BuiltInDocumentProperties.CharactersWithSpaces property

Rappresenta una stima del numero di caratteri (inclusi gli spazi) nel documento.
