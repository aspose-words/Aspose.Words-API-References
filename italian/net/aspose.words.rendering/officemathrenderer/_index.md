...
description: Fornisce metodi per eseguire il rendering di un individuoOfficeMath../aspose.words.math/officemath/ in unimmagine raster o vettoriale o in un oggetto Graphics.
type: docs
weight: 4300
...
| Nome | Descrizione |
| --- | --- |
| [OfficeMathRenderer](officemathrenderer/)(OfficeMath) | Inizializza una nuova istanza di questa classe. |
