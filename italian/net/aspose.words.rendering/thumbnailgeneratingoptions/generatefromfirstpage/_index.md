...
description: ThumbnailGeneratingOptions proprietà. Specifica se generare una miniatura dalla prima pagina del documento o dalla prima immagine.
type: docs
weight: 20
...
Specifica se generare una miniatura dalla prima pagina del documento o dalla prima immagine.
...
L'impostazione predefinita è`VERO` , il che significa che la miniatura verrà generata dalla prima pagina del documento. Se il valore è`falso` e non ci sono immagini nel documento, la miniatura verrà generata dalla prima pagina del documento.
