...
description: Scopri il metodo "Accetta Sezione" per migliorare il coinvolgimento dei visitatori e semplificare le interazioni. Migliora le prestazioni del tuo sito oggi stesso!
type: docs
weight: 70
...
Chiamate[`VisitSectionStart`](../../documentvisitor/visitsectionstart/) , quindi chiama[`Accept`](../../node/accept/) per tutti i nodi figlio della sezione e chiamate[`VisitSectionEnd`](../../documentvisitor/visitsectionend/) alla fine.
