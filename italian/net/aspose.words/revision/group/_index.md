...
description: Scopri la proprietà Gruppo di revisione, recupera facilmente i gruppi di revisione o ottieni null se non esiste alcun gruppo. Semplifica la gestione dei tuoi dati oggi stesso!
type: docs
weight: 30
...
La revisione non ha gruppo se il tipo di revisione èStyleDefinitionChange oppure se la revisione non esiste più nel contesto del documento (accettata/rifiutata).
