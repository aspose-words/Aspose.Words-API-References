...
description: Esplora la classe Aspose.Words.Revision per gestire le revisioni nei documenti. Identifica facilmente i tipi di revisione per una modifica fluida dei documenti.
type: docs
weight: 5500
...
Rappresenta una revisione (modifica tracciata) in un nodo o stile di documento. Utilizzo[`RevisionType`](./revisiontype/) per controllare il tipo di questa revisione.
...
| [ParentStyle](../../aspose.words/revision/parentstyle/) { get; } | Ottiene lo stile padre immediato (proprietario) di questa revisione. Questa proprietà funzionerà solo perStyleDefinitionChange tipo di revisione. |
