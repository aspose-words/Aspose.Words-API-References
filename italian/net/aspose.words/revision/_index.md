...
description: Rappresenta una revisione modifica rilevata in un nodo o stile del documento. UsaRevisionType./revision/revisiontype/ per verificare il tipo di questa revisione.
type: docs
weight: 4500
