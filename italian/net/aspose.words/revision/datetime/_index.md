...
description: Gestisci la proprietà "Data e ora di revisione" senza sforzo. Ottieni o imposta facilmente la data e l'ora delle revisioni per un monitoraggio e un'organizzazione migliori.
type: docs
weight: 20
url: /it/net/aspose.words/revision/datetime/
---
## Revision.DateTime property

Ottiene o imposta la data/ora di questa revisione.
