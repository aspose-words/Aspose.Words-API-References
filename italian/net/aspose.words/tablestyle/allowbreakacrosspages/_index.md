...
description: TableStyle AllowBreakAcrossPages proprietà. Ottiene o imposta un flag che indica se il testo in una riga di tabella può essere suddiviso in uninterruzione di pagina in C#.
type: docs
weight: 20
