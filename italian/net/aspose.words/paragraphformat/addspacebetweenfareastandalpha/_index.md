...
description: ParagraphFormat proprietà. Ottiene o imposta un flag che indica se la spaziatura tra i caratteri viene regolata automaticamente tra le regioni del testo latino e le regioni del testo dellAsia orientale nel paragrafo corrente.
type: docs
weight: 10
