...
description: Accedi facilmente a revisioni specifiche con la proprietà RevisionCollection Item. Recupera rapidamente le revisioni per indice per una gestione semplificata dei dati.
type: docs
weight: 30
...
Restituisce un[`Revision`](../../revision/) all'indice specificato.
