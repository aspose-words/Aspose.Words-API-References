...
description: Aspose.Words.RevisionType enum. Specifica il tipo di modifica di cui si tiene tracciaRevision .
type: docs
weight: 4540
...
Specifica il tipo di modifica di cui si tiene traccia[`Revision`](../revision/) .
