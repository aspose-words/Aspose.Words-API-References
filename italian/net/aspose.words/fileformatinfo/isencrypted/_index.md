...
description: FileFormatInfo proprietà. Restituisce true se il documento è crittografato e richiede una password per lapertura.
type: docs
weight: 30
...
Questa proprietà esiste per aiutarti a ordinare i documenti crittografati da quelli che non lo sono. Se si tenta di caricare un documento crittografato utilizzando Aspose.Words senza fornire una password verrà generata un'eccezione . È possibile utilizzare questa proprietà per rilevare se un documento richiede una password ed eseguire alcune azioni prima di caricare un documento, ad esempio richiedere all'utente una password.
