...
description: Aspose.Words.AbsolutePositionTab classe. Una scheda di posizione assoluta è un carattere che viene utilizzato per far avanzare la posizione su la riga di testo corrente durante la visualizzazione di questo contenuto di WordprocessingML.
type: docs
weight: 10
