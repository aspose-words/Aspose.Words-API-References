...
description: Scopri il metodo VisitDocumentStart in DocumentVisitor. Migliora l'elaborazione dei tuoi documenti con efficienti funzionalità di enumerazione per prestazioni ottimali.
type: docs
weight: 150
url: /it/net/aspose.words/documentvisitor/visitdocumentstart/
---
## DocumentVisitor.VisitDocumentStart method

Chiamato quando è iniziata l'enumerazione del documento.
...
| --- | --- | --- |
| doc | Document | L'oggetto che viene visitato. |
