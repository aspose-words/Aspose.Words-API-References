...
description: Scopri il metodo VisitBodyStart di DocumentVisitor, essenziale per enumerare in modo efficiente le storie principali del testo nelle tue sezioni. Migliora il tuo flusso di lavoro di codifica oggi stesso!
type: docs
weight: 30
url: /it/net/aspose.words/documentvisitor/visitbodystart/
---
## DocumentVisitor.VisitBodyStart method

Chiamato quando è iniziata l'enumerazione del testo principale della storia in una sezione.
