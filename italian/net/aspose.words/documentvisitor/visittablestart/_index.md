...
description: Scopri il metodo VisitTableStart di DocumentVisitor, essenziale per gestire in modo efficiente l'enumerazione delle tabelle nelle tue applicazioni. Migliora le tue competenze di programmazione oggi stesso!
type: docs
weight: 500
url: /it/net/aspose.words/documentvisitor/visittablestart/
---
## DocumentVisitor.VisitTableStart method

Chiamato quando è iniziata l'enumerazione di una tabella.
...
| --- | --- | --- |
| table | Table | L'oggetto che viene visitato. |
