...
description: Scopri il metodo VisitGroupShapeEnd di DocumentVisitor, che segnala in modo efficiente la fine dell'enumerazione delle forme di gruppo per un'elaborazione fluida dei documenti.
type: docs
weight: 260
...
| --- | --- | --- |
| groupShape | GroupShape | L'oggetto che viene visitato. |
