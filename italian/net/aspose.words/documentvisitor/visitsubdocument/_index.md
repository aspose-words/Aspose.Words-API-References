...
description: Esplora il metodo VisitSubDocument di DocumentVisitor, progettato per la gestione efficiente dei sottodocumenti nelle tue applicazioni. Migliora l'efficienza della tua programmazione!
type: docs
weight: 480
url: /it/net/aspose.words/documentvisitor/visitsubdocument/
---
## DocumentVisitor.VisitSubDocument method

Chiamato quando viene rilevato un sottodocumento.
...
| --- | --- | --- |
| subDocument | SubDocument | L'oggetto che viene visitato. |
