...
description: DocumentVisitor metodo. Chiamato quando è iniziata lenumerazione di una riga di tabella.
type: docs
weight: 350
...
Chiamato quando è iniziata l'enumerazione di una riga di tabella.
