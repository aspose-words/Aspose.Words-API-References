...
description: DocumentVisitor VisitCellStart metodo. Chiamato quando è iniziata lenumerazione di una cella di tabella in C#.
type: docs
weight: 90
...
Chiamato quando è iniziata l'enumerazione di una cella di tabella.
