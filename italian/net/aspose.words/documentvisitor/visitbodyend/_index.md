...
description: DocumentVisitor VisitBodyEnd metodo. Chiamato al termine dellenumerazione della storia di testo principale in una sezione in C#.
type: docs
weight: 20
...
Chiamato al termine dell'enumerazione della storia di testo principale in una sezione.
...
| --- | --- | --- |
| body | Body | L'oggetto che viene visitato. |
