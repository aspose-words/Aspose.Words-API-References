...
description: Esplora il metodo VisitRun di DocumentVisitor per una gestione efficiente del testo nelle tue applicazioni. Migliora la tua programmazione con questo strumento essenziale!
type: docs
weight: 360
...
Chiamato quando viene rilevata una sequenza di testo in .
...
| --- | --- | --- |
| run | Run | L'oggetto che viene visitato. |
