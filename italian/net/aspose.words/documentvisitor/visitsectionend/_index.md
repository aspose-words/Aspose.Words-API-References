...
description: Scopri il metodo VisitSectionEnd di DocumentVisitor, fondamentale per gestire l'enumerazione delle sezioni nelle tue applicazioni. Migliora subito la tua efficienza di programmazione!
type: docs
weight: 370
url: /it/net/aspose.words/documentvisitor/visitsectionend/
---
...
| --- | --- | --- |
| section | Section | L'oggetto che viene visitato. |
