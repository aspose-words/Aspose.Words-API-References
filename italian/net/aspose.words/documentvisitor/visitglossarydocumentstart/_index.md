...
description: Scopri il metodo VisitGlossaryDocumentStart in DocumentVisitor. Gestisci in modo efficiente l'enumerazione dei documenti del glossario, con facilità e precisione.
type: docs
weight: 250
url: /it/net/aspose.words/documentvisitor/visitglossarydocumentstart/
---
## DocumentVisitor.VisitGlossaryDocumentStart method

Chiamato quando è iniziata l'enumerazione di un documento di glossario.
...
Nota: un nodo del documento del glossario e i suoi figli non vengono visitati quando si esegue un Visitatore su un[`Document`](../../document/) Se si desidera eseguire un visitatore su un documento di glossario , è necessario chiamare[`Accept`](../../../aspose.words.buildingblocks/glossarydocument/accept/) .
