...
description: Scopri il metodo VisitFieldStart di DocumentVisitor, attivato all'inizio di un campo nel tuo documento, che migliora l'efficienza della tua codifica e il flusso di lavoro.
type: docs
weight: 200
