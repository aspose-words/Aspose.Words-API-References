...
description: DocumentVisitor VisitCommentStart metodo. Chiamato quando è iniziata lenumerazione del testo di un commento in C#.
type: docs
weight: 130
...
Chiamato quando è iniziata l'enumerazione del testo di un commento.
