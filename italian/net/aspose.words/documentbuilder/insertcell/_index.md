...
description: Inserisce una cella di tabella nel documento.
type: docs
weight: 250
...
Per iniziare un tavolo, chiama **InserisciCell** . Dopodiché, qualsiasi contenuto che aggiungi usando altri metodi di[`DocumentBuilder`](../../documentbuilder) la classe verrà aggiunta alla cella corrente.
