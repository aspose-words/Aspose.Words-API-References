...
description: Inserisce uninterruzione del tipo specificato nel documento.
type: docs
weight: 240
...
Utilizzare questo metodo per inserire paragrafo, pagina, colonna, sezione o interruzione di riga nel documento.
