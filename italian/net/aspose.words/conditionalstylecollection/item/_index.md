...
description: Recupera aConditionalStyleaspose.words/conditionalstyle oggetto per tipo di stile condizionale.
type: docs
weight: 80
...
Recupera a[`ConditionalStyle`](../../conditionalstyle) oggetto per tipo di stile condizionale.
...
Recupera a[`ConditionalStyle`](../../conditionalstyle) oggetto per indice.
