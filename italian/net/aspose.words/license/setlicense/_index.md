...
description: License SetLicense metodo. Concede in licenza il componente in C#.
type: docs
weight: 20
...
**Nota:**In .NET Compact Framework, tenta di trovare la licenza solo in queste posizioni:
