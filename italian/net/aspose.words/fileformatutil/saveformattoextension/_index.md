...
description: Converte un valore enumerato del formato di salvataggio in unestensione di file. Lestensione restituita è una stringa minuscola con un punto iniziale.
type: docs
weight: 80
