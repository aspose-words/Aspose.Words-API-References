...
description: Scopri le proprietà EditableRangeEnd e EditableRangeStart. Gestisci facilmente intervalli di dati con ID univoci per un maggiore controllo ed efficienza.
type: docs
weight: 10
...
Corrispondente[`EditableRangeStart`](../../editablerangestart/) , ricevuto da ID.
