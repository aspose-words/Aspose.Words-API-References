...
description: HeaderFooterCollection metodo. Copia tuttoHeaderFoorter s dalla raccolta a un nuovo array diHeaderFoorter s.
type: docs
weight: 30
...
Copia tutto`HeaderFoorter` s dalla raccolta a un nuovo array di`HeaderFoorter` s.
...
Una matrice di`HeaderFoorter`S.
