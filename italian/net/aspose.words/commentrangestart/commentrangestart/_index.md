...
description: CommentRangeStart costruttore. Inizializza una nuova istanza di questa classe.
type: docs
weight: 10
...
quando[`CommentRangeStart`](../) viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e[`ParentNode`](../../node/parentnode/) è zero.

Per aggiungere un[`CommentRangeStart`](../) al documento utilizzare InsertAfter o InsertBefore nel paragrafo in cui si desidera inserire il commento.
