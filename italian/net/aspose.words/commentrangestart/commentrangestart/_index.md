...
description: Scopri il costruttore CommentRangeStart. Crea facilmente nuove istanze di questa classe per una maggiore efficienza di codifica e uno sviluppo semplificato.
type: docs
weight: 10
url: /it/net/aspose.words/commentrangestart/commentrangestart/
---
...
Quando[`CommentRangeStart`](../) viene creato, appartiene al documento specificato, ma non è ancora parte del documento e[`ParentNode`](../../node/parentnode/) È`null`.

Per aggiungere un[`CommentRangeStart`](../) nel documento utilizzare InsertAfter o InsertBefore sul paragrafo in cui si desidera inserire il commento.
