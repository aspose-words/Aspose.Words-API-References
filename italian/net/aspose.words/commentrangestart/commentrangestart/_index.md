...
quando[`CommentRangeStart`](../../commentrangestart) viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e[`ParentNode`](../../node/parentnode) è zero.

Per aggiungere un[`CommentRangeStart`](../../commentrangestart) al documento utilizzare InsertAfter o InsertBefore nel paragrafo in cui si desidera inserire il commento.
