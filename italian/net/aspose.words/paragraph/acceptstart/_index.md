...
description: Scopri il metodo Paragraph AcceptStart per dare il benvenuto ai visitatori all'inizio dei paragrafi del tuo documento, aumentandone il coinvolgimento.
type: docs
weight: 250
url: /it/net/aspose.words/paragraph/acceptstart/
---
## Paragraph.AcceptStart method

Accetta un visitatore per aver visitato l'inizio del paragrafo del documento.
