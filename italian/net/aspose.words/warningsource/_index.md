...
description: Aspose.Words.WarningSource enum. Specifica il modulo che produce un avviso durante il caricamento o il salvataggio del documento.
type: docs
weight: 6650
...
| Layout | `1` | Modulo che costruisce il layout di un documento. |
...
| Shapes | `4` | Modulo che rende forme ordinarie. |
...
| Nrx | `14` | Moduli comuni condivisi tra moduli di lettura/scrittura DOCX/WML. |
| Odt | `15` | Modulo che legge/scrive file ODT. |
| Html | `16` | Modulo che legge/scrive file HTML/MHTML. |
| Validator | `17` | Modulo che verifica coerenza e validità del modello. |
| Xaml | `18` | Modulo che legge/scrive file Xaml. |
| Svm | `19` | Modulo che legge file Svm. |
| MathML | `20` | Modulo che legge file MathML del W3C. |
