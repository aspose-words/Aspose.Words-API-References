...
description: Migliora la tua esperienza web con il metodo Body AcceptEnd, progettato per accettare senza problemi i visitatori alla fine del documento, per una navigazione migliore.
type: docs
weight: 50
url: /it/net/aspose.words/body/acceptend/
---
## Body.AcceptEnd method

Accetta un visitatore che visita la fine del corpo del documento.
