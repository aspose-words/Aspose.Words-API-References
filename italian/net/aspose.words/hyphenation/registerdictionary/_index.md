...
description: Registra e carica un dizionario di sillabazione per la lingua specificata da un flusso. Genera se il dizionario non può essere letto o ha un formato non valido.
type: docs
weight: 40
