...
description: Chiamato durante un pattern di sillabazione del caricamento quando viene rilevato un problema che potrebbe comportare una perdita di fedeltà di formattazione.
type: docs
weight: 20
