...
Il[`RestartPageNumbering`](../restartpagenumbering/) proprietà, se impostata su **falso** , sovrascriverà il  **Numero di pagina iniziale** proprietà in modo che la numerazione delle pagine possa continuare dalla sezione precedente.
