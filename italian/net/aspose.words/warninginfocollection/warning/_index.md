...
description: Scopri il metodo WarningInfoCollection che potenzia la tua applicazione implementando IWarningCallback, aggiungendo senza sforzo avvisi alla tua raccolta.
type: docs
weight: 60
...
Implementa il[`IWarningCallback`](../../iwarningcallback/) interfaccia. Aggiunge un avviso a questa raccolta.
