...
description: Scopri il campo ControlChar CellChar per una gestione semplificata delle tabelle. Migliora l'organizzazione dei dati con caratteri di fine cella e riga efficienti.
type: docs
weight: 20
...
Carattere di fine di una cella di tabella o di fine di una riga di tabella: (char)7 o "\a".
