...
description: Scopri il campo ControlChar LineFeed e scopri il carattere di avanzamento riga (x000a) per una formattazione del testo ottimale e una migliore gestione dei dati.
type: docs
weight: 140
url: /it/net/aspose.words/controlchar/linefeed/
---
