...
description: Scopri il campo Cella ControlChar, la chiave per definire le terminazioni di cella e riga della tabella con il carattere x0007. Migliora l'organizzazione dei tuoi dati senza sforzo!
type: docs
weight: 10
url: /it/net/aspose.words/controlchar/cell/
---
## ControlChar.Cell field

Carattere di fine di una cella di tabella o di fine di una riga di tabella: "\x0007" o "\a".
