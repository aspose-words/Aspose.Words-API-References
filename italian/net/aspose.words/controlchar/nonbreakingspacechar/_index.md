...
description: Scopri ControlChar NonBreakingSpaceChar per una formattazione del testo impeccabile. Migliora i tuoi documenti con il carattere di spazio non divisibile char160 per una migliore leggibilità.
type: docs
weight: 180
url: /it/net/aspose.words/controlchar/nonbreakingspacechar/
---
## ControlChar.NonBreakingSpaceChar field

Carattere spazio unificatore: (char)160.
