...
description: Scopri il campo ControlChar SectionBreakChar e ottimizza la formattazione del tuo documento con l'essenziale carattere di fine sezione per un flusso di testo fluido.
type: docs
weight: 250
