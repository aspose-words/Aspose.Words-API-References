...
description: Scopri il campo ControlChar ParagraphBreak. Gestisci facilmente le interruzioni di paragrafo con il carattere x000d per una formattazione del testo fluida e una migliore leggibilità.
type: docs
weight: 220
...
Carattere di fine paragrafo: "\x000d" o "\r". Uguale a[`Cr`](../cr/)
