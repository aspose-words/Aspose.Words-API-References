...
description: Scopri come il metodo AcceptEnd migliora l'esperienza utente gestendo in modo efficiente le visite ai commenti. Aumenta il coinvolgimento con un'accettazione fluida dei visitatori!
type: docs
weight: 140
url: /it/net/aspose.words/comment/acceptend/
---
## Comment.AcceptEnd method

Accetta un visitatore che ha visitato la fine del commento.
