...
description: Comment costruttore. Inizializza una nuova istanza di Commento classe.
type: docs
weight: 10
...
Inizializza una nuova istanza di **Commento** classe.
...
quando **Commento** viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e **ParentNode** è zero.

Aggiungere **Commento** al documento utilizzare InsertAfter o InsertBefore nel paragrafo in cui si desidera inserire il commento.
...
| --- | --- | --- |
| doc | DocumentBase | Il documento del proprietario. |
| author | String | Il nome dell'autore per il commento. Non può essere nullo. |
| initial | String | L'autore sigla per il commento. Non può essere nullo. |
