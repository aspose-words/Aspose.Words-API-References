...
L'identificatore di commento consente di ancorare un commento a una regione di testo nel documento. La regione deve essere delimitata utilizzando il[`CommentRangeStart`](../../commentrangestart/) e[`CommentRangeEnd`](../../commentrangeend/) oggetto che condivide lo stesso valore identificatore di[`Comment`](../) oggetto.

Utilizzeresti questo valore quando cerchi il[`CommentRangeStart`](../../commentrangestart/) e [`CommentRangeEnd`](../../commentrangeend/) nodi collegati a questo commento.

Gli identificatori di commento dovrebbero essere univoci in un documento e Aspose.Words automaticamente mantiene gli identificatori di commento durante il caricamento, il salvataggio e la combinazione di documenti.
