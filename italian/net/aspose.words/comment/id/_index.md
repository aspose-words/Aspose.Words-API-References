...
description: Ottiene lidentificatore del commento.
type: docs
weight: 60
...
L'identificatore di commento consente di ancorare un commento a una regione di testo nel documento. La regione deve essere delimitata utilizzando il[`CommentRangeStart`](../../commentrangestart) e[`CommentRangeEnd`](../../commentrangeend) oggetto che condivide lo stesso valore identificatore di[`Comment`](../../comment) oggetto.
