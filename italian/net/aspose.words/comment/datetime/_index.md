...
description: Scopri la proprietà Comment DateTime, che cattura la data e l'ora esatte in cui è stato pubblicato un commento, migliorando la tua esperienza di gestione dei contenuti.
type: docs
weight: 40
url: /it/net/aspose.words/comment/datetime/
---
## Comment.DateTime property

Ottiene la data e l'ora in cui è stato fatto il commento.
