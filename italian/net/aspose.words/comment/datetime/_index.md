...
description: Comment DateTime proprietà. Ottiene la data e lora in cui è stato creato il commento in C#.
type: docs
weight: 40
...
Ottiene la data e l'ora in cui è stato creato il commento.
...
L'impostazione predefinita èMinValue.
