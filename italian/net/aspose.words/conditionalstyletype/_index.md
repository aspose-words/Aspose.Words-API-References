...
description: Aspose.Words.ConditionalStyleType enum. Rappresenta possibili aree di tabella in cui è possibile definire la formattazione condizionale in uno stile di tabella.
type: docs
weight: 320
...
Rappresenta possibili aree di tabella in cui è possibile definire la formattazione condizionale in uno stile di tabella.
...
| OddRowBanding | `4` | Specifica la formattazione della striscia di riga dispari. |
