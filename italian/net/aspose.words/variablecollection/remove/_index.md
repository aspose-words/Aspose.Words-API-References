...
description: VariableCollection metodo. Rimuove una variabile del documento con il nome specificato dalla raccolta.
type: docs
weight: 80
url: /it/net/aspose.words/variablecollection/remove/
---
## VariableCollection.Remove method

Rimuove una variabile del documento con il nome specificato dalla raccolta.
...
| --- | --- | --- |
| name | String | Il nome senza distinzione tra maiuscole e minuscole della variabile. |
