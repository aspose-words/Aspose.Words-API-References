...
description: Rimuovi senza sforzo le variabili dei documenti utilizzando il metodo VariableCollection Remove. Semplifica la gestione dei dati con questa soluzione efficiente.
type: docs
weight: 80
...
| --- | --- | --- |
| name | String | Nome della variabile senza distinzione tra maiuscole e minuscole. |
