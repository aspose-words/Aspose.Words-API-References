...
| --- | --- | --- |
| name | String | Il nome senza distinzione tra maiuscole e minuscole della variabile da aggiungere. |
| value | String | Il valore della variabile. Il valore non può essere null, se value è null verrà utilizzata invece una stringa vuota. |
