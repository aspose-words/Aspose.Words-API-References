...
Ottiene o imposta una variabile di documento in base al nome senza distinzione tra maiuscole e minuscole. `null` valori non sono consentiti come lato destro dell'assegnazione e saranno sostituiti da una stringa vuota.
...
Ottiene o imposta una variabile del documento all'indice specificato. `null` valori non sono consentiti come lato destro dell'assegnazione e saranno sostituiti da una stringa vuota.
...
| --- | --- |
| index | Indice basato su zero della variabile del documento. |
