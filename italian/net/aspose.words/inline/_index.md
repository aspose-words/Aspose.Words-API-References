...
description: Aspose.Words.Inline classe. Classe base per nodi a livello inline a cui può essere associata la formattazione dei caratteri ma non può avere nodi figlio propri.
type: docs
weight: 3260
