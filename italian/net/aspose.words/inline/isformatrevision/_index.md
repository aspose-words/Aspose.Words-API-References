...
description: Scopri la proprietà Inline IsFormatRevision in Microsoft Word. Indica se la formattazione dell'oggetto è stata modificata con il rilevamento delle modifiche abilitato, migliorando la gestione dei documenti.
type: docs
weight: 30
