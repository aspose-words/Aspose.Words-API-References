...
| Nome | Descrizione |
| --- | --- |
| [Action](../../aspose.words/nodechangingargs/action/) { get; } | Ottiene un valore che indica il tipo di evento di modifica del nodo in corso. |
| [NewParent](../../aspose.words/nodechangingargs/newparent/) { get; } | Ottiene il genitore del nodo che verrà impostato al termine dell'operazione. |
