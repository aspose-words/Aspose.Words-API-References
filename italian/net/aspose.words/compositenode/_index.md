...
description: Scopri la classe Aspose.Words.CompositeNode, il tuo strumento essenziale per creare strutture di documenti complesse con facilità ed efficienza.
type: docs
weight: 500
...
Classe base per i nodi che possono contenere altri nodi.
...
* Fornisce accesso ai nodi figlio.
* Implementa operazioni composite come l'inserimento e la rimozione di elementi figlio.
