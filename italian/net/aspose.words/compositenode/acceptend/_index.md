...
description: Scopri come migliorare l'elaborazione dei documenti con il metodo AcceptEnd di CompositeNode. Semplifica l'implementazione del modello visitor per prestazioni ottimali.
type: docs
weight: 60
url: /it/net/aspose.words/compositenode/acceptend/
---
## CompositeNode.AcceptEnd method

Quando implementato in una classe derivata, richiama il metodo VisitXXXEnd del visitatore del documento specificato.
