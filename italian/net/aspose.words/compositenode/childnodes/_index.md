...
description: CompositeNode proprietà. Ottiene tutti i nodi figlio immediati di questo nodo.
type: docs
weight: 10
url: /it/net/aspose.words/compositenode/childnodes/
---
...
Nota,`ChildNodes` equivale a chiamare`GetChildNodes(NodeType.Any, false)` e crea e restituisce una nuova raccolta ogni volta che si accede.
