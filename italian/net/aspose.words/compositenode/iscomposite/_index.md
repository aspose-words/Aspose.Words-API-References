...
description: CompositeNode IsComposite proprietà. RestituisceVERO poiché questo nodo può avere nodi figli in C#.
type: docs
weight: 40
...
Restituisce`VERO` poiché questo nodo può avere nodi figli.
