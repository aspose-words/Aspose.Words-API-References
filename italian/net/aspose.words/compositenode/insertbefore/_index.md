...
description: CompositeNode InsertBefore metodo. Inserisce il nodo specificato immediatamente prima del nodo di riferimento specificato in C#.
type: docs
weight: 140
...
| refChild | Node | IL[`Node`](../../node/) quello è il nodo di riferimento. IL*newChild* è posizionato prima di questo nodo. |
...
Se*refChild* È`nullo` , inserti*newChild* alla fine dell'elenco dei nodi figlio.
