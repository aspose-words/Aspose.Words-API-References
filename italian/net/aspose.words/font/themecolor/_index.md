...
description: Scopri come utilizzare la proprietà Font ThemeColor per migliorare i tuoi design con colori a tema personalizzabili nella tua combinazione di colori.
type: docs
weight: 470
url: /it/net/aspose.words/font/themecolor/
---
## Font.ThemeColor property

Ottiene o imposta il colore del tema nello schema di colori applicato associato a questo[`Font`](../) oggetto.
