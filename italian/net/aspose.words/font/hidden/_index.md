...
description: Vero se il carattere è formattato come testo nascosto.
type: docs
weight: 140
...
// Con il flag Nascosto impostato su true, qualsiasi testo che creiamo utilizzando questo oggetto Font sarà invisibile nel documento.
// Non vedremo o evidenzieremo il testo nascosto a meno che non abilitiamo l'opzione "Testo nascosto".
// trovato in Microsoft Word tramite "File" -> "Opzioni" -> "Schermo". Il testo sarà ancora lì,
// e saremo in grado di accedere a questo testo a livello di codice.
// Non è consigliabile utilizzare questo metodo per nascondere informazioni riservate.
