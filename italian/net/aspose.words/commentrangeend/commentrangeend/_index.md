...
| id | Int32 | L'identificatore di commento a cui è collegato questo oggetto. |

### Osservazioni

quando[`CommentRangeEnd`](../../commentrangeend) viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e[`ParentNode`](../../node/parentnode) è zero.

Per aggiungere un[`CommentRangeEnd`](../../commentrangeend) al documento utilizzare InsertAfter o InsertBefore nel paragrafo in cui si desidera inserire il commento.
