...
description: Scopri la proprietà "Campi Intervallo" e accedi facilmente a una raccolta completa di campi per tutte le tue esigenze di intervallo di dati. Migliora il tuo flusso di lavoro oggi stesso!
type: docs
weight: 20
...
Restituisce un`Fields` raccolta che rappresenta tutti i campi nell'intervallo.
