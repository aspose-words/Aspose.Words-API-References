...
description: Scopri la proprietà Range FormFields e accedi a una raccolta completa di FormFields per gestire in modo efficiente tutti i campi del modulo all'interno dell'intervallo specificato.
type: docs
weight: 30
...
Restituisce un`FormFields` raccolta che rappresenta tutti i campi del modulo nell'intervallo.
