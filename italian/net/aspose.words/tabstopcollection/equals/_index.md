...
description: Scopri il metodo TabStopCollection Equals per confrontare facilmente le TabStopCollection per verificarne l'uguaglianza, migliorando l'efficienza e la precisione della tua codifica.
type: docs
weight: 70
url: /it/net/aspose.words/tabstopcollection/equals/
---
## Equals(*[TabStopCollection](../)*) {#equals}

Determina se il valore specificato[`TabStopCollection`](../) ha un valore uguale a quello attuale[`TabStopCollection`](../) .
