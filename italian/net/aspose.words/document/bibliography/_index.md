...
description: Accedi alla proprietà Bibliografia del documento per recuperare un elenco completo delle fonti, migliorando così la precisione della tua ricerca e delle citazioni.
type: docs
weight: 40
url: /it/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Ottiene il`Bibliography`oggetto che rappresenta l'elenco delle fonti disponibili nel documento.
