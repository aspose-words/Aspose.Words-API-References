...
description: Scopri il metodo AcceptStart e dai il benvenuto ai visitatori all'inizio del tuo documento, per un'esperienza utente migliorata e una navigazione più fluida.
type: docs
weight: 560
url: /it/net/aspose.words/document/acceptstart/
---
## Document.AcceptStart method

Accetta un visitatore per aver visitato l'inizio del documento.
