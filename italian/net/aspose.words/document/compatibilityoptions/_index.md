...
description: Accedi alle Opzioni di compatibilità dei documenti di Word per personalizzare le preferenze utente e migliorare la tua esperienza di modifica con impostazioni su misura per una collaborazione fluida.
type: docs
weight: 60
...
Fornisce accesso alle opzioni di compatibilità dei documenti (ovvero le preferenze dell'utente immesse nel**Compatibilità** scheda del**Opzioni**dialogo in Word).
