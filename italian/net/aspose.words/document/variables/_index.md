...
description: Scopri le variabili dei documenti. Accedi a una potente raccolta di variabili personalizzabili per i tuoi documenti e modelli, migliorando efficienza e flessibilità.
type: docs
weight: 460
url: /it/net/aspose.words/document/variables/
---
## Document.Variables property

Restituisce la raccolta di variabili aggiunte a un documento o a un modello.
