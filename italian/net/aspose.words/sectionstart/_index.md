...
description: Esplora l'enum Aspose.Words.SectionStart per comprendere le interruzioni di sezione e migliorare la formattazione del documento per un controllo e una presentazione migliori.
type: docs
weight: 6590
