...
description: Aspose.Words.BookmarkStart classe. Rappresenta linizio di un segnalibro in un documento di Word.
type: docs
weight: 60
...
Rappresenta l'inizio di un segnalibro in un documento di Word.
