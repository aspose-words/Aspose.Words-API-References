...
description: Scopri il metodo HeaderFooter Accept per migliorare il coinvolgimento dei visitatori e semplificare le interazioni sul tuo sito web senza sforzo.
type: docs
weight: 70
...
Chiamate[`VisitHeaderFooterStart`](../../documentvisitor/visitheaderfooterstart/) , quindi chiama[`Accept`](../../node/accept/) per tutti i nodi figlio della sezione e chiamate[`VisitHeaderFooterEnd`](../../documentvisitor/visitheaderfooterend/) alla fine.
