...
description: Scopri il metodo FormatDateTime di iFieldResultFormatter per Aspose.Words. Formatta le date senza sforzo e con facilità utilizzando l'opzione gg.MM.aaaa!
type: docs
weight: 20
...
Chiamato quando Aspose.Words applica un cambio di formato data/ora, ad esempio \@ "gg.MM.aaaa".
