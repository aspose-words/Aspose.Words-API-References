...
description: Scopri la classe Aspose.Words.Fields.FieldBibliography per gestire facilmente i campi bibliografici nei tuoi documenti. Migliora la tua scrittura con facilità!
type: docs
weight: 2050
...
| [FilterLanguageId](../../aspose.words.fields/fieldbibliography/filterlanguageid/) { get; set; } | Ottiene o imposta l'ID della lingua utilizzata per filtrare i dati bibliografici solo alle fonti nel documento che utilizzano quella lingua. |
...
| [FormatLanguageId](../../aspose.words.fields/fieldbibliography/formatlanguageid/) { get; set; } | Ottiene o imposta l'ID della lingua utilizzata per formattare le fonti bibliografiche nel documento. |
