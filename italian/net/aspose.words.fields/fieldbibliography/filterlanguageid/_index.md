...
description: Scopri come la proprietà FieldBibliography FilterLanguageId migliora la gestione dei dati bibliografici filtrando le fonti in base alla lingua per ottenere risultati precisi.
type: docs
weight: 20
...
Ottiene o imposta l'ID della lingua utilizzata per filtrare i dati bibliografici solo alle fonti nel documento che utilizzano quella lingua.
