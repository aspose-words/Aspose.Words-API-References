...
description: Scopri come la proprietà FieldBibliography FormatLanguageId migliora le fonti bibliografiche del tuo documento con impostazioni di lingua personalizzabili per una maggiore chiarezza.
type: docs
weight: 30
...
Ottiene o imposta l'ID della lingua utilizzata per formattare le fonti bibliografiche nel documento.
