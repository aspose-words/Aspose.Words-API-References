...
description: Aspose.Words.Fields.FieldFormula classe. Implementa il campo  formula in C#.
type: docs
weight: 1950
url: /it/net/aspose.words.fields/fieldformula/
---
## FieldFormula class

Implementa il campo = (formula).
...
| Nome | Descrizione |
| --- | --- |
| [FieldFormula](fieldformula/)() | Default_Costruttore |
...
// Utilizza un generatore di campi per costruire un'equazione matematica,
