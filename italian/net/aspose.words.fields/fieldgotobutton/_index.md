...
description: Aspose.Words.Fields.FieldGoToButton classe. Implementa il campo GOTOBUTTON in C#.
type: docs
weight: 1970
url: /it/net/aspose.words.fields/fieldgotobutton/
---
...
| Nome | Descrizione |
| --- | --- |
| [FieldGoToButton](fieldgotobutton/)() | Default_Costruttore |
...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Ottiene o imposta il testo del "pulsante" che appare nel documento, in modo che possa essere selezionato per attivare il salto. |
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | Ottiene o imposta il nome di un segnalibro, un numero di pagina o qualche altro elemento a cui passare. |
...
Inserisce un comando di salto, in modo tale che quando viene attivato, il punto di inserimento del documento viene spostato nella posizione specificata.
