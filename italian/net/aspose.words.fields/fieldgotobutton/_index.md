...
description: Scopri la classe Aspose.Words.Fields.FieldGoToButton per una navigazione fluida con i campi GOTOBUTTON. Migliora l'interattività dei tuoi documenti oggi stesso!
type: docs
weight: 2380
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | Ottiene o imposta il nome di un segnalibro, un numero di pagina o un altro elemento a cui passare. |
