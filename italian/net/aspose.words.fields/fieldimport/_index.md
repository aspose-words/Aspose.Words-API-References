...
description: Scopri la classe Aspose.Words.Fields.FieldImport, progettata per semplificare l'elaborazione dei documenti con un'implementazione efficiente del campo IMPORT per una maggiore produttività.
type: docs
weight: 2430
url: /it/net/aspose.words.fields/fieldimport/
---
## FieldImport class

Implementa il campo IMPORT.
...
| Nome | Descrizione |
| --- | --- |
| [FieldImport](fieldimport/)() | Default_Costruttore |
...
| [GraphicFilter](../../aspose.words.fields/fieldimport/graphicfilter/) { get; set; } | Ottiene o imposta il nome del filtro per il formato della grafica da inserire. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Ottiene o imposta se il risultato corrente del campo non è più corretto (obsoleto) a causa di altre modifiche apportate al documento. |
| [IsLinked](../../aspose.words.fields/fieldimport/islinked/) { get; set; } | Ottiene o imposta se ridurre le dimensioni del file non memorizzando i dati grafici con il documento. |
...
| [SourceFullName](../../aspose.words.fields/fieldimport/sourcefullname/) { get; set; } | Ottiene o imposta la posizione dell'immagine. |
...
Recupera l'immagine contenuta nel documento.
