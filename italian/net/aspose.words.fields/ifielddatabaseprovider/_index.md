...
description: Migliora l'automazione dei tuoi documenti con l'interfaccia Aspose.Words.Fields.IFieldDatabaseProvider. Fornisci dati senza interruzioni per gli aggiornamenti di FieldDatabase.
type: docs
weight: 3100
...
Implementare questa interfaccia per fornire dati per il[`FieldDatabase`](../fielddatabase/) campo quando viene aggiornato.
