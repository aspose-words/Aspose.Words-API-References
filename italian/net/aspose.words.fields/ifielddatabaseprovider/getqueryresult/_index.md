...
description: Scopri il metodo GetQueryResult di IFieldDatabaseProvider per un recupero dati efficiente. Semplifica le tue query e migliora le prestazioni del database oggi stesso!
type: docs
weight: 10
...
| --- | --- | --- |
| fileName | String | Percorso completo e nome file del database specificato nel campo switch \d. |
| connection | String | La connessione ai dati specificati nell'opzione di campo \c. |
| query | String | Set di istruzioni SQL che interrogano il database specificato nell'opzione di campo \s. |
| field | FieldDatabase | Campo in fase di aggiornamento. |
