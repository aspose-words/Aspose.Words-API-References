...
description: Aspose.Words.Fields.FieldFileName classe. Implementa il campo FILENAME.
type: docs
weight: 1720
...
Recupera il nome del documento corrente dalla posizione di archiviazione.

Nell'attuale implementazione, utilizza il[`OriginalFileName`](../../aspose.words/document/originalfilename/) per recuperare il nome del file. Se il documento è stato caricato da un flusso o è stato creato vuoto, utilizza il nome del file in cui viene salvato (se noto).
