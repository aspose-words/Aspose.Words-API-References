...
description: Aspose.Words.Fields.FieldFileName classe. Implementa il campo FILENAME in C#.
type: docs
weight: 1870
...
Nell'implementazione corrente, utilizza il file[`OriginalFileName`](../../aspose.words/document/originalfilename/) proprietà per recuperare il nome del file. Se il documento è stato caricato da un flusso o creato vuoto, utilizza il nome del file in cui viene salvato (se noto).
