...
description: Scopri la classe Aspose.Words.Fields.FieldSubject per implementare facilmente il campo SUBJECT, migliorando l'automazione dei documenti e l'efficienza della formattazione.
type: docs
weight: 2860
...
Recupera e, facoltativamente, imposta l'oggetto del documento, come registrato nel**Soggetto** proprietà delle proprietà del documento incorporato .
