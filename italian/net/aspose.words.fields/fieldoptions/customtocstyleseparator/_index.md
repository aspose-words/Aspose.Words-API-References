...
description: FieldOptions proprietà. Ottiene o imposta un separatore di stile personalizzato per linterruttore tFieldToc campo.
type: docs
weight: 50
...
Ottiene o imposta un separatore di stile personalizzato per l'interruttore \t[`FieldToc`](../../fieldtoc/) campo.
...
Per impostazione predefinita, gli stili personalizzati definiti dall'opzione \t nel file[`FieldToc`](../../fieldtoc/) sono separati da un delimitatore preso dalle impostazioni cultura correnti. Questa proprietà sovrascrive tale comportamento specificando un delimitatore definito dall'utente.
