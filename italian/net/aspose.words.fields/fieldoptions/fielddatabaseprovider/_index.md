...
description: Scopri la proprietà FieldDatabaseProvider di FieldOptions, gestisci e recupera facilmente i risultati delle query per una migliore gestione dei dati nelle tue applicazioni.
type: docs
weight: 80
...
Ottiene o imposta un provider che restituisce un risultato di query per[`FieldDatabase`](../../fielddatabase/) campo.
