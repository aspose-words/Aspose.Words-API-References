...
description: FieldLink SourceItem proprietà. Ottiene o imposta la parte del file di origine che viene collegata in C#.
type: docs
weight: 130
...
Ottiene o imposta la parte del file di origine che viene collegata.
