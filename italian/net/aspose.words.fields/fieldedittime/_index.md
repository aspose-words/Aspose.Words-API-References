...
description: Scopri la classe Aspose.Words.Fields.FieldEditTime per una modifica efficiente dei documenti. Semplifica il tuo flusso di lavoro con la potente gestione dei campi EDITTIME.
type: docs
weight: 2250
...
Recupera il tempo totale di modifica, in minuti, da quando è stato creato il documento.
...
// Questa proprietà integrata nel documento tiene traccia dei minuti. Microsoft Word utilizza questa proprietà
...
// Il campo non si aggiorna in tempo reale e dovrà essere
// aggiornato manualmente in Microsoft Word ogni volta che abbiamo bisogno di un valore preciso.
doc.UpdateFields();
