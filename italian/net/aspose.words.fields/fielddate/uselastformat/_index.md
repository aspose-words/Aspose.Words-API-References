...
description: FieldDate proprietà. Ottiene o imposta se utilizzare un formato utilizzato per ultimo dallapplicazione di hosting quando si inserisce un nuovo campo DATE.
type: docs
weight: 20
...
Ottiene o imposta se utilizzare un formato utilizzato per ultimo dall'applicazione di hosting quando si inserisce un nuovo campo DATE.
