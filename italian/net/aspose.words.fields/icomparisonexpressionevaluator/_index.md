...
description: Quando implementato consente di ignorare la valutazione delle espressioni di confronto predefinite per ilFieldIf./fieldif eFieldCompare./fieldcompare campi.
type: docs
weight: 2510
...
Quando implementato, consente di ignorare la valutazione delle espressioni di confronto predefinite per il[`FieldIf`](../fieldif) e[`FieldCompare`](../fieldcompare) campi.
