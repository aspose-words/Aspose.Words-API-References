...
description: Scopri la proprietà TextInputType di FormField per personalizzare facilmente i campi di testo dei moduli. Migliora l'esperienza utente impostando tipi di input specifici con la massima semplicità.
type: docs
weight: 210
...
Ottiene o imposta il tipo di un campo di modulo di testo.
