...
description: Vero se i riferimenti al campo modulo specificato vengono aggiornati automaticamente ogni volta che si esce dal campo.
type: docs
weight: 10
...
Vero se i riferimenti al campo modulo specificato vengono aggiornati automaticamente ogni volta che si esce dal campo.
...
Ambientazione **Calcola all'uscita** influisce solo sul comportamento del campo modulo quando il documento viene aperto in Microsoft Word. Aspose.Words non aggiorna mai i riferimenti al campo del modulo.
