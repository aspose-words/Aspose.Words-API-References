...
description: FormField proprietà. Restituisce o imposta un nome di macro di immissione per il campo del modulo.
type: docs
weight: 80
...
Restituisce o imposta un nome di macro di immissione per il campo del modulo.
...
La macro di immissione viene eseguita quando il campo del modulo ottiene lo stato attivo in Microsoft Word.
