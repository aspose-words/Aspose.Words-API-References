...
description: Scopri la proprietà FormField EntryMacro per gestire facilmente le macro di immissione per i tuoi moduli, migliorando così la funzionalità e l'esperienza utente.
type: docs
weight: 80
url: /it/net/aspose.words.fields/formfield/entrymacro/
---
## FormField.EntryMacro property

Restituisce o imposta un nome macro di immissione per il campo del modulo.
...
La macro di immissione viene eseguita quando il campo del modulo ottiene il focus in Microsoft Word.
