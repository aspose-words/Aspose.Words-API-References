...
description: Ottiene o imposta la stringa predefinita o unespressione di calcolo di un campo modulo di testo.
type: docs
weight: 190
...
Il significato di questa proprietà dipende dal valore del[`TextInputType`](../textinputtype) proprietà.

quando[`TextInputType`](../textinputtype) èRegular o Number, questa stringa specifica la stringa predefinita per il campo del modulo di testo. Questa stringa è il contenuto che Microsoft Word visualizzerà nel documento quando il campo del modulo è vuoto.

quando[`TextInputType`](../textinputtype) èCalculated, quindi questa stringa contiene l'espressione da calcolare. L'espressione deve essere una formula valida secondo i requisiti di campo della formula di Microsoft Word. Quando imposti una nuova espressione utilizzando questa proprietà, Aspose.Words calcola automaticamente la formula result e la inserisce nel campo del modulo.
