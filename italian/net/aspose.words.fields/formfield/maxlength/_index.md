...
description: Scopri la proprietà FormField MaxLength per impostare i limiti dei campi di testo. Migliora l'esperienza utente con impostazioni di lunghezza personalizzabili per un inserimento dati ottimale.
type: docs
weight: 120
url: /it/net/aspose.words.fields/formfield/maxlength/
---
## FormField.MaxLength property

Lunghezza massima per il campo di testo. Zero se la lunghezza non è limitata.
