...
description: Scopri la proprietà ExitMacro di FormField per gestire facilmente le macro di uscita dei tuoi moduli. Migliora l'esperienza utente e semplifica l'inserimento dati oggi stesso!
type: docs
weight: 90
...
Restituisce o imposta un nome macro di uscita per il campo del modulo.
...
La macro di uscita viene eseguita quando il campo del modulo perde lo stato attivo in Microsoft Word.

Microsoft Word consente stringhe composte da un massimo di 32 caratteri.
