...
description: Accedi e gestisci senza sforzo gli elementi del menu a discesa con la proprietà FormField DropDownItems, migliorando i tuoi moduli con un'interazione utente fluida.
type: docs
weight: 50
...
Fornisce l'accesso agli elementi di un campo del modulo a discesa.
