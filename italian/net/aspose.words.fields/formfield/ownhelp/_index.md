...
description: FormField proprietà. Specifica lorigine del testo visualizzato in una finestra di messaggio quando un campo modulo ha lo stato attivo e lutente preme F1.
type: docs
weight: 150
...
Specifica l'origine del testo visualizzato in una finestra di messaggio quando un campo modulo ha lo stato attivo e l'utente preme F1.
...
Se True, viene visualizzato il testo specificato dalla proprietà HelpText. Se False, viene visualizzato il testo nella voce di glossario specificata dalla proprietà HelpText.
