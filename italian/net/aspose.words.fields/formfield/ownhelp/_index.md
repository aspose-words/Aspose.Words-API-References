...
description: Scopri la proprietà FormField OwnHelp. Semplifica l'esperienza utente personalizzando i messaggi di aiuto quando gli utenti premono F1 sui campi del modulo con focus.
type: docs
weight: 150
...
Specifica l'origine del testo visualizzato in una finestra di messaggio quando un campo del modulo ha il focus e l'utente preme F1.
...
Se`VERO` , il testo specificato dal[`HelpText`](../helptext/) la proprietà viene visualizzata. Se`falso` , il testo nella voce di testo automatico specificata da[`HelpText`](../helptext/) viene visualizzata la proprietà.
