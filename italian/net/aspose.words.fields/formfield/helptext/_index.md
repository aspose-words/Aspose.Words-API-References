...
description: FormField proprietà. Restituisce o imposta il testo visualizzato in una finestra di messaggio quando il campo del modulo ha lo stato attivo e lutente preme F1.
type: docs
weight: 100
...
Restituisce o imposta il testo visualizzato in una finestra di messaggio quando il campo del modulo ha lo stato attivo e l'utente preme F1.
...
Se la proprietà OwnHelp è impostata su True, HelpText specifica il valore della stringa di testo. Se OwnHelp è impostato su False, HelpText specifica il nome di una voce di glossario che contiene il testo help per il campo del modulo.
