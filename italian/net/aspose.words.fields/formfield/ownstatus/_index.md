...
description: FormField proprietà. Specifica lorigine del testo visualizzato nella barra di stato quando un campo modulo ha lo stato attivo.
type: docs
weight: 160
...
Specifica l'origine del testo visualizzato nella barra di stato quando un campo modulo ha lo stato attivo.
...
Se true, viene visualizzato il testo specificato dalla proprietà StatusText. Se false, viene visualizzato il testo della voce di glossario specificata dalla proprietà StatusText.
