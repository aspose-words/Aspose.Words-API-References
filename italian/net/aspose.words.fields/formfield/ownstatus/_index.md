...
description: Scopri come la proprietà OwnStatus di FormField migliora l'esperienza utente personalizzando il testo della barra di stato quando un campo del modulo è attivo.
type: docs
weight: 160
...
Specifica l'origine del testo visualizzato nella barra di stato quando un campo del modulo è attivo.
...
Se`VERO` , il testo specificato dal[`StatusText`](../statustext/) la proprietà viene visualizzata. Se`falso` , il testo della voce di testo automatico specificata da[`StatusText`](../statustext/) viene visualizzata la proprietà.
