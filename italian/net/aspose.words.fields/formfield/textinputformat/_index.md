...
Se il campo del modulo di testo contiene un numero o un valore di data/ora, le stringhe di formato valid sono stringhe di formato numerico o di data e ora.
