...
description: Restituisce o imposta la formattazione del testo per un campo modulo di testo.
type: docs
weight: 200
...
Se il campo del modulo di testo contiene testo normale, le stringhe di formato valide sono "", "MAIUSCOLA", "MINUSCOLO", "PRIMA MAIUSCOLA" e "TITOLO MAIUSCOLA". Le stringhe non fanno distinzione tra maiuscole e minuscole.

Se il campo del modulo di testo contiene un numero o un valore di data/ora, le stringhe di formato valid sono stringhe di formato numero o data e ora.
