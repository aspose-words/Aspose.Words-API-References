...
description: Scopri la proprietà TextInputFormat di FormField per personalizzare facilmente la formattazione del testo dei tuoi moduli, migliorando l'esperienza utente e la raccolta dati.
type: docs
weight: 200
...
Restituisce o imposta la formattazione del testo per un campo modulo di testo.
...
Se il campo del modulo di testo contiene testo normale, le stringhe di formato valide sono "", "MAIUSCOLO", "MINUSCOLO", "MAIUSCOLO" e "MAIUSCOLO INIZIALE". Le stringhe non distinguono tra maiuscole e minuscole.

Se il campo del modulo di testo contiene un numero o un valore data/ora, le stringhe di formato valid sono stringhe di formato numero o data e ora.

Microsoft Word consente stringhe composte da un massimo di 64 caratteri.
