...
description: Scopri la proprietà FormField CheckBoxSize per personalizzare le dimensioni delle caselle di controllo in punti, migliorando i tuoi moduli quando IsCheckBoxExactSize è abilitato.
type: docs
weight: 20
...
Ottiene o imposta la dimensione della casella di controllo in punti. Ha effetto solo quando[`IsCheckBoxExactSize`](../ischeckboxexactsize/) È`VERO` .
