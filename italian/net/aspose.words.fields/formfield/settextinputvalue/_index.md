...
description: Applica il formato di testo specificato inTextInputFormataspose.words.fields/formfield/textinputformat/ e memorizza il valore inResultaspose.words.fields/formfield/result/ .
type: docs
weight: 250
...
| --- | --- | --- |
| newValue | Object | Può essere una stringa, un numero o un oggetto DateTime. |

### Osservazioni

Il[`TextInputDefault`](../textinputdefault/) il valore viene applicato se*newValue* è`nullo`.
