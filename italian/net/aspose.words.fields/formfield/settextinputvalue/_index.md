...
description: Scopri come il metodo SetTextInputValue di FormField migliora la formattazione del testo e memorizza in modo efficiente i risultati, semplificando il processo di immissione dei dati.
type: docs
weight: 250
url: /it/net/aspose.words.fields/formfield/settextinputvalue/
---
## FormField.SetTextInputValue method

Applica il formato di testo specificato in[`TextInputFormat`](../textinputformat/) e memorizza il valore in[`Result`](../result/) .
...
| --- | --- | --- |
| newValue | Object | Può essere una stringa, un numero o un**Data e ora** oggetto. |

## Osservazioni

IL[`TextInputDefault`](../textinputdefault/) il valore viene applicato se*newValue* È`null`.
