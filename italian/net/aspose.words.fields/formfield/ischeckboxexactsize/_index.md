...
description: Scopri la proprietà IsCheckBoxExactSize di FormField e controlla facilmente le dimensioni della casella di testo con una semplice impostazione booleana per una personalizzazione ottimale.
type: docs
weight: 110
url: /it/net/aspose.words.fields/formfield/ischeckboxexactsize/
---
## FormField.IsCheckBoxExactSize property

Ottiene o imposta il valore booleano che indica se la dimensione della casella di testo è automatica o specificata esplicitamente.
