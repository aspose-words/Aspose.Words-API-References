...
description: Scopri la proprietà FormField DropDownSelectedIndex per gestire facilmente le selezioni a discesa, migliorando l'esperienza utente e la funzionalità del modulo.
type: docs
weight: 60
...
Ottiene o imposta l'indice che specifica l'elemento attualmente selezionato in un campo del modulo a discesa.
