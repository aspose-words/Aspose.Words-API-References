...
description: FieldTA proprietà. Ottiene o imposta se applicare la formattazione in corsivo al numero di pagina per la voce.
type: docs
weight: 40
...
Ottiene o imposta se applicare la formattazione in corsivo al numero di pagina per la voce.
