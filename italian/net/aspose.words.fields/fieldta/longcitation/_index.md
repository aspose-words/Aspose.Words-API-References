...
description: Gestisci la tua proprietà FieldTA LongCitation senza sforzo. Ottieni o imposta facilmente citazioni lunghe per le voci, migliorando l'organizzazione e l'accessibilità dei tuoi dati.
type: docs
weight: 50
url: /it/net/aspose.words.fields/fieldta/longcitation/
---
## FieldTA.LongCitation property

Ottiene o imposta la citazione lunga per la voce.
