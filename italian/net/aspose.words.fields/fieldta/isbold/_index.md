...
description: Migliora la tua esperienza FieldTA! Gestisci facilmente la formattazione in grassetto per i numeri di pagina, garantendo chiarezza ed enfasi nei tuoi documenti.
type: docs
weight: 30
url: /it/net/aspose.words.fields/fieldta/isbold/
---
## FieldTA.IsBold property

Ottiene o imposta se applicare la formattazione in grassetto al numero di pagina per la voce.
