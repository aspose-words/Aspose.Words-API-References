...
description: Gestisci le tue citazioni brevi FieldTA in modo semplice. Ottieni o imposta facilmente citazioni brevi per le voci, migliorando l'organizzazione e l'accessibilità dei dati.
type: docs
weight: 70
url: /it/net/aspose.words.fields/fieldta/shortcitation/
---
## FieldTA.ShortCitation property

Ottiene o imposta la citazione breve per la voce.
