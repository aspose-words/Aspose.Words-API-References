...
description: Scopri la proprietà EntryCategory di FieldTA. Gestisci facilmente le tue categorie di voci complete con questo potente strumento per un'organizzazione impeccabile ed efficiente.
type: docs
weight: 20
...
Ottiene o imposta la categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie .
