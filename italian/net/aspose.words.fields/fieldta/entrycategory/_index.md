...
description: FieldTA EntryCategory proprietà. Ottiene o imposta la categoria di voce integrale ovvero un numero che corrisponde allordine delle categorie in C#.
type: docs
weight: 20
