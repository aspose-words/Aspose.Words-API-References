...
Inserisce un campo modulo stile elenco a discesa.
...
```csharp
// Questi campi sono equivalenti legacy di FormField. Possiamo leggere, ma non creare questi campi usando Aspose.Words.
