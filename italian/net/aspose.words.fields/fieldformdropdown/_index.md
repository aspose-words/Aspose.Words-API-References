...
description: Scopri la classe Aspose.Words.Fields.FieldFormDropDown, progettata per migliorare l'interattività dei documenti con campi a discesa dinamici per esperienze utente fluide.
type: docs
weight: 2330
...
Implementa il campo FORMDROPDOWN.
...
| Nome | Descrizione |
| --- | --- |
| [FieldFormDropDown](fieldformdropdown/)() | Default_Costruttore |
