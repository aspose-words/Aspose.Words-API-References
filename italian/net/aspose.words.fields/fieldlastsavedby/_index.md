...
description: Aspose.Words.Fields.FieldLastSavedBy classe. Implementa il campo LASTSAVEDBY in C#.
type: docs
weight: 2100
...
Recupera il nome dell'utente che ha modificato e salvato per ultimo il documento corrente, come registrato nel**UltimoModificatoDa** proprietà delle proprietà del documento integrate.
...
// Se creiamo un documento in Microsoft Word, avrà il nome dell'utente nella proprietà integrata "Ultimo salvataggio da".
