...
description: Scopri la classe Aspose.Words.Fields.FieldLastSavedBy per migliorare la gestione dei documenti con la funzionalità del campo LASTSAVEDBY. Ottimizza il tuo flusso di lavoro oggi stesso!
type: docs
weight: 2510
...
Recupera il nome dell'utente che ha modificato e salvato per ultimo il documento corrente, come registrato nel**UltimoModificatoDa** Proprietà delle proprietà del documento incorporato.
...
// Se creiamo un documento in Microsoft Word, nella proprietà incorporata "Ultimo salvataggio da" sarà presente il nome dell'utente.
 // Se creiamo un documento a livello di programmazione, questa proprietà sarà null e dovremo assegnare un valore.
doc.BuiltInDocumentProperties.LastSavedBy = "John Doe";

// Possiamo utilizzare il campo LASTSAVEDBY per visualizzare il valore di questa proprietà nel documento.
