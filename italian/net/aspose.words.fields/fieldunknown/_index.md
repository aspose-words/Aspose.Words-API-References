...
description: Scopri la classe Aspose.Words.Fields.FieldUnknown per gestire in modo efficiente i campi non riconosciuti. Migliora l'elaborazione dei tuoi documenti con un'integrazione perfetta!
type: docs
weight: 2960
...
// Inserire un campo che non indica un tipo di campo obiettivo nel suo codice di campo.
