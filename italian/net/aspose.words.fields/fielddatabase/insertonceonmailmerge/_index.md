...
description: Scopri come la proprietà InsertOnceOnMailMerge in FieldDatabase migliora l'unione dei dati consentendo un inserimento fluido all'inizio delle unioni.
type: docs
weight: 70
...
Ottiene o imposta se inserire dati all'inizio di un'unione.
