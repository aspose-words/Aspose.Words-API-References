...
description: FieldDatabase Query proprietà. Ottiene o imposta una serie di istruzioni SQL che interrogano il database in C#.
type: docs
weight: 90
...
Ottiene o imposta una serie di istruzioni SQL che interrogano il database.
