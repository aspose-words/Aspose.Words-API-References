...
description: Gestisci il tuo database senza sforzo con FieldDatabase Query. Imposta e recupera facilmente istruzioni SQL per query di dati efficienti.
type: docs
weight: 90
url: /it/net/aspose.words.fields/fielddatabase/query/
---
## FieldDatabase.Query property

Ottiene o imposta un set di istruzioni SQL che interrogano il database.
