...
description: Scopri la proprietà LastRecord di FieldDatabase. Gestisci facilmente il numero dell'ultimo record dati per un inserimento dati fluido e una maggiore efficienza del database.
type: docs
weight: 80
...
Ottiene o imposta il numero di record integrale dell'ultimo record di dati da inserire.
