...
description: Scopri la proprietà FileName di FieldDatabase per gestire facilmente il percorso completo e il nome file del tuo database, migliorando l'organizzazione e l'accesso ai dati.
type: docs
weight: 30
url: /it/net/aspose.words.fields/fielddatabase/filename/
---
## FieldDatabase.FileName property

Ottiene o imposta il percorso completo e il nome del file del database
