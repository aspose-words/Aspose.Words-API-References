...
description: Scopri la proprietà FirstRecord in FieldDatabase e gestisci facilmente il numero del record dati iniziale per un inserimento dati fluido e una maggiore efficienza.
type: docs
weight: 40
url: /it/net/aspose.words.fields/fielddatabase/firstrecord/
---
## FieldDatabase.FirstRecord property

Ottiene o imposta il numero di record integrale del primo record di dati da inserire.
