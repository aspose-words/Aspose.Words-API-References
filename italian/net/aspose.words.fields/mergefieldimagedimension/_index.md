...
| Nome | Descrizione |
| --- | --- |
| [MergeFieldImageDimension](mergefieldimagedimension/#constructor)(double) | Crea un'istanza della dimensione dell'immagine con il valore specificato in punti. |
| [MergeFieldImageDimension](mergefieldimagedimension/#constructor_1)(double, MergeFieldImageDimensionUnit) | Crea un'istanza della dimensione dell'immagine con il valore specificato e l'unità specificata. |
...
Per indicare che l'immagine deve essere inserita con la sua dimensione originale durante una stampa unione, dovresti assegnare un valore negativo al[`Value`](./value/) proprietà.
