...
description: Implementa il campo MERGEFIELD.
type: docs
weight: 2000
...
| [FieldNameNoPrefix](../../aspose.words.fields/fieldmergefield/fieldnamenoprefix) { get; } | Restituisce solo il nome del campo dati. Qualsiasi prefisso viene rimosso nella proprietà del prefisso. |
...
| [IsMapped](../../aspose.words.fields/fieldmergefield/ismapped) { get; set; } | Ottiene o imposta se questo campo è mappato. |
...
| override [Type](../../aspose.words.fields/fieldmergefield/type) { get; } | Ottiene il tipo di campo di Microsoft Word. |
...
Recupera il nome di un campo di dati all'interno dei caratteri di unione in un documento principale di stampa unione. Quando il documento principale viene unito all'origine dati selezionata, le informazioni dal campo di dati specificato vengono inserite al posto del campo di unione.
