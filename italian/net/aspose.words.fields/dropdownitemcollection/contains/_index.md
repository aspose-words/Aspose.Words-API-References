...
description: DropDownItemCollection Contains metodo. Determina se la raccolta contiene il valore specificato in C#.
type: docs
weight: 50
...
| --- | --- | --- |
| value | String | Valore con distinzione tra maiuscole e minuscole da individuare. |
