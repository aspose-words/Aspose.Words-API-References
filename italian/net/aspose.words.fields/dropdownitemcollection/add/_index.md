...
description: Migliora senza sforzo la tua DropDownItemCollection con il metodo Add. Aggiungi stringhe all'istante per espandere la tua collezione e migliorare l'esperienza utente.
type: docs
weight: 30
...
| --- | --- | --- |
| value | String | Stringa da aggiungere alla fine della raccolta. |

### Valore di ritorno

Indice a partire da zero in cui viene inserito il nuovo elemento.
