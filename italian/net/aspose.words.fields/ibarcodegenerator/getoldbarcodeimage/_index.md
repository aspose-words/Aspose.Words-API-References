...
description: IBarcodeGenerator GetOldBarcodeImage metodo. Genera limmagine del codice a barre utilizzando il set di parametri per il campo Codice a barre vecchio stile in C#.
type: docs
weight: 20
