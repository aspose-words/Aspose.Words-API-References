...
description: Scopri come utilizzare la proprietà FieldDde InsertAsBitmap per inserire facilmente oggetti collegati come bitmap, migliorando l'aspetto visivo del tuo documento.
type: docs
weight: 30
url: /it/net/aspose.words.fields/fielddde/insertasbitmap/
---
## FieldDde.InsertAsBitmap property

Ottiene o imposta se inserire l'oggetto collegato come bitmap.
