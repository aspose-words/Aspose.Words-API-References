...
description: FieldListNum proprietà. Restituisce un valore che indica se il nome di una definizione di numerazione astratta è fornito dal codice del campo.
type: docs
weight: 20
