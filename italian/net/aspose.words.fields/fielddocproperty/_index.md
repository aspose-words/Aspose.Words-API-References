...
description: Scopri la classe Aspose.Words.Fields.FieldDocProperty, progettata per l'integrazione perfetta dei campi DOCPROPERTY nei tuoi documenti per funzionalità avanzate.
type: docs
weight: 2220
url: /it/net/aspose.words.fields/fielddocproperty/
---
## FieldDocProperty class

Implementa il campo DOCPROPERTY.
...
| Nome | Descrizione |
| --- | --- |
| [FieldDocProperty](fielddocproperty/)() | Default_Costruttore |
...
Recupera le informazioni sul documento indicato.
