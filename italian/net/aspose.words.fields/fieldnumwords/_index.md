...
description: Aspose.Words.Fields.FieldNumWords classe. Implementa il campo NUMWORDS in C#.
type: docs
weight: 2230
url: /it/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class
...
| Nome | Descrizione |
| --- | --- |
| [FieldNumWords](fieldnumwords/)() | Default_Costruttore |
...
Recupera il numero di parole nel documento corrente, come registrato nel file**Parole** proprietà delle proprietà del documento integrate.
