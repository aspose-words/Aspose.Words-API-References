...
description: Aspose.Words.Fields.FieldFileSize classe. Implementa il campo FILESIZE.
type: docs
weight: 1880
...
Nell'implementazione corrente, utilizza il file[`OriginalFileName`](../../aspose.words/document/originalfilename/) proprietà per recuperare il nome del file utilizzato per determinare la dimensione del file.
