...
description: Aspose.Words.Fields.FieldRD classe. Implementa il campo RD.
type: docs
weight: 2320
...
| [FileName](../../aspose.words.fields/fieldrd/filename/) { get; set; } | Ottiene o imposta il nome del file da includere durante la generazione di un sommario, un indice delle autorità o un indice. |
...
Identifica un file da includere quando crei un sommario, un indice delle autorità o un indice con il campo TOC, TOA o INDEX
