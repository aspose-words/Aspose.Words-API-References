...
description: Scopri la classe Aspose.Words.Fields.FieldRD: implementa in modo efficiente i campi RD per una migliore elaborazione e automazione dei documenti nei tuoi progetti.
type: docs
weight: 2730
...
| [FileName](../../aspose.words.fields/fieldrd/filename/) { get; set; } | Ottiene o imposta il nome del file da includere durante la generazione di un indice, di una tabella delle autorità o di un indice. |
...
Identifica un file da includere quando si crea un indice, un indice delle autorità o un indice con il campo TOC, TOA o INDEX
