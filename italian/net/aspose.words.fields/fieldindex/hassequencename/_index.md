...
description: Scopri se è necessaria una sequenza per una creazione efficiente dei risultati di campo con la proprietà FieldIndex HasSequenceName. Ottimizza la gestione dei tuoi dati oggi stesso!
type: docs
weight: 60
...
Ottiene un valore che indica se una sequenza deve essere utilizzata durante la creazione del risultato del campo.
