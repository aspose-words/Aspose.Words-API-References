...
description: FieldIndex proprietà. Ottiene o imposta unintestazione che appare allinizio di ogni serie di voci per una determinata lettera.
type: docs
weight: 70
...
Ottiene o imposta un'intestazione che appare all'inizio di ogni serie di voci per una determinata lettera.
