...
description: Scopri la proprietà FieldIndex Heading per personalizzare le intestazioni delle voci in base alla lettera, migliorando l'organizzazione e l'esperienza utente nella tua applicazione.
type: docs
weight: 70
...
Ottiene o imposta un'intestazione che appare all'inizio di ogni set di voci per una data lettera.
