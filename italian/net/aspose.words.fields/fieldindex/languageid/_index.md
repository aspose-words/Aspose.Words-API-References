...
description: FieldIndex proprietà. Ottiene o imposta lID lingua utilizzato per generare lindice.
type: docs
weight: 80
...
Ottiene o imposta l'ID lingua utilizzato per generare l'indice.
