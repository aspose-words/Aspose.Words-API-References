...
description: Scopri la proprietà FieldIndex LanguageId per gestire facilmente gli ID lingua e ottimizzare l'indicizzazione. Migliora le tue capacità di ricerca oggi stesso!
type: docs
weight: 80
...
Ottiene o imposta l'ID della lingua utilizzata per generare l'indice.
