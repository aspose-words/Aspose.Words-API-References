...
description: Scopri la proprietà DisplayText di BarcodeParameters per migliorare i tuoi codici a barre visualizzando il testo dei dati accanto alle immagini per una migliore leggibilità.
type: docs
weight: 70
url: /it/net/aspose.words.fields/barcodeparameters/displaytext/
---
## BarcodeParameters.DisplayText property

Se visualizzare i dati del codice a barre (testo) insieme all'immagine.
