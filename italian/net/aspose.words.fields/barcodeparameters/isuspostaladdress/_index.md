...
description: Scopri la funzione IsUSPostalAddress di BarcodeParameters per verificare facilmente se un indirizzo è un indirizzo postale statunitense valido. Migliora l'accuratezza dei tuoi dati oggi stesso!
type: docs
weight: 130
...
Se[`PostalAddress`](../postaladdress/) è un indirizzo postale degli Stati Uniti.
