...
description: Scopri la proprietà ErrorCorrectionLevel per i codici QR. Migliora i tuoi codici a barre con opzioni di correzione degli errori ottimali, valori 0 e 3 per un'affidabilità ottimale.
type: docs
weight: 80
url: /it/net/aspose.words.fields/barcodeparameters/errorcorrectionlevel/
---
## BarcodeParameters.ErrorCorrectionLevel property

Livello di correzione degli errori del codice QR. I valori validi sono [0, 3].
