...
description: BarcodeParameters FacingIdentificationMark proprietà. Tipo di segno di identificazione del fronte FIM in C#.
type: docs
weight: 90
...
Tipo di segno di identificazione del fronte (FIM).
