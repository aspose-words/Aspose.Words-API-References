...
description: Scopri la proprietà IsBookmark di BarcodeParameters! Scopri come PostalAddress può migliorare la gestione dei tuoi documenti con soluzioni di bookmarking efficienti.
type: docs
weight: 120
...
Se[`PostalAddress`](../postaladdress/) è il nome di un segnalibro.
