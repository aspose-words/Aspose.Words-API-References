...
description: Scopri la classe Aspose.Words.Fields.FieldPageRef per un'implementazione fluida del campo PAGEREF, migliorando l'efficienza e la navigazione nei documenti.
type: docs
weight: 2680
...
| [InsertHyperlink](../../aspose.words.fields/fieldpageref/inserthyperlink/) { get; set; } | Ottiene o imposta se inserire un collegamento ipertestuale al paragrafo aggiunto ai segnalibri. |
