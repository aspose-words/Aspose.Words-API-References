...
description: Scopri la proprietà FieldToc EntrySeparator, personalizza le sequenze di caratteri per migliorare la navigazione nelle pagine di ingresso e l'organizzazione dei documenti.
type: docs
weight: 70
url: /it/net/aspose.words.fields/fieldtoc/entryseparator/
---
## FieldToc.EntrySeparator property

Ottiene o imposta una sequenza di caratteri che separano una voce dal suo numero di pagina.
