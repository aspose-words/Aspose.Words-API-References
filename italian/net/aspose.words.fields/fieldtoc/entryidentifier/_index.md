...
description: Scopri come la proprietà FieldToc EntryIdentifier semplifica la gestione dei campi TC abbinando facilmente gli identificatori di tipo per un'organizzazione efficiente dei dati.
type: docs
weight: 50
url: /it/net/aspose.words.fields/fieldtoc/entryidentifier/
---
## FieldToc.EntryIdentifier property

Ottiene o imposta una stringa che dovrebbe corrispondere agli identificatori di tipo dei campi TC inclusi.
