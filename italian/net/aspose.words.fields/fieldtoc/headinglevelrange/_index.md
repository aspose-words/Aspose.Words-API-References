...
description: Scopri la proprietà FieldToc HeadingLevelRange per gestire facilmente i livelli dei titoli, per una migliore organizzazione dei contenuti e un'ottimizzazione SEO.
type: docs
weight: 80
url: /it/net/aspose.words.fields/fieldtoc/headinglevelrange/
---
## FieldToc.HeadingLevelRange property

Ottiene o imposta un intervallo di livelli di intestazione da includere.
