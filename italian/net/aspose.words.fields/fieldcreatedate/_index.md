...
description: Scopri la classe Aspose.Words.Fields.FieldCreateDate per una gestione semplificata dei documenti. Implementa facilmente il campo CREATEDATE e migliora i tuoi flussi di lavoro.
type: docs
weight: 2130
url: /it/net/aspose.words.fields/fieldcreatedate/
---
...
| Nome | Descrizione |
| --- | --- |
| [FieldCreateDate](fieldcreatedate/)() | Default_Costruttore |
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Ottiene o imposta se utilizzare il calendario lunare Hijri o quello ebraico. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Ottiene o imposta se utilizzare il calendario dell'era Saka. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldcreatedate/useumalquracalendar/) { get; set; } | Ottiene o imposta se utilizzare il calendario Um-al-Qura. |
...
Recupera la data e l'ora di creazione del documento. Per impostazione predefinita, viene utilizzato il calendario gregoriano.
