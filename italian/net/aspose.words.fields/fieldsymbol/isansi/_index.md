...
description: Scopri la proprietà FieldSymbol IsAnsi, gestisci facilmente i codici dei caratteri ANSI per una migliore gestione dei dati e una migliore efficienza di codifica.
type: docs
weight: 60
url: /it/net/aspose.words.fields/fieldsymbol/isansi/
---
## FieldSymbol.IsAnsi property

Ottiene o imposta se il codice del carattere viene interpretato come il valore di un carattere ANSI.
