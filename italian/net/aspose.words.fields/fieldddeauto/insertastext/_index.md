...
description: Scopri come la proprietà FieldDdeAuto InsertAsText semplifica la gestione degli oggetti collegati consentendo l'inserimento di formati solo testo per una maggiore chiarezza.
type: docs
weight: 60
url: /it/net/aspose.words.fields/fieldddeauto/insertastext/
---
## FieldDdeAuto.InsertAsText property

Ottiene o imposta se inserire l'oggetto collegato in formato solo testo.
