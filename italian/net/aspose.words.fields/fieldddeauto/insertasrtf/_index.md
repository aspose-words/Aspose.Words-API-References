...
description: Scopri la proprietà FieldDdeAuto InsertAsRtf e gestisci facilmente gli oggetti collegati in formato RTF (Rich Text Format) per una maggiore integrazione dei documenti e versatilità.
type: docs
weight: 50
url: /it/net/aspose.words.fields/fieldddeauto/insertasrtf/
---
## FieldDdeAuto.InsertAsRtf property

Ottiene o imposta se inserire l'oggetto collegato in formato RTF (rich-text).
