...
description: Scopri la proprietà FieldDdeAuto SourceFullName per gestire facilmente il nome e la posizione del file sorgente per una gestione semplificata dei dati.
type: docs
weight: 100
