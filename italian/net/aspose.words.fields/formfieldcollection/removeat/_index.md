...
description: Rimuovi senza sforzo un campo del modulo utilizzando il metodo RemoveAt di FormFieldCollection. Semplifica i tuoi moduli con questa efficiente soluzione basata su indici.
type: docs
weight: 60
...
Rimuove un campo del modulo all'indice specificato.
...
| --- | --- | --- |
| index | Int32 | Indice a partire da zero del campo del modulo da rimuovere. |
