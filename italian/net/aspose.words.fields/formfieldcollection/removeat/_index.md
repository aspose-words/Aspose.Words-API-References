...
description: FormFieldCollection metodo. Rimuove un campo modulo in corrispondenza dellindice specificato.
type: docs
weight: 60
...
Rimuove un campo modulo in corrispondenza dell'indice specificato.
...
| --- | --- | --- |
| index | Int32 | Indice in base zero del campo modulo da rimuovere. |
