...
description: FormFieldCollection metodo. Rimuove un campo modulo con il nome specificato.
type: docs
weight: 50
...
| --- | --- | --- |
| formField | String | Il nome senza distinzione tra maiuscole e minuscole del campo del modulo da rimuovere. |
