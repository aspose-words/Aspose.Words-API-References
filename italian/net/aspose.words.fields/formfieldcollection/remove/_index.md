...
description: Rimuovi facilmente i campi del modulo in base al nome con il metodo FormFieldCollection Remove. Semplifica la gestione dei dati con questa funzionalità facile da usare!
type: docs
weight: 50
url: /it/net/aspose.words.fields/formfieldcollection/remove/
---
...
| --- | --- | --- |
| formField | String | Nome del campo del modulo da rimuovere, senza distinzione tra maiuscole e minuscole. |
