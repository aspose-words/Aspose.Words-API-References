...
description: FieldGreetingLine proprietà. Ottiene o imposta lid della lingua utilizzato per formattare il nome.
type: docs
weight: 30
...
Ottiene o imposta l'id della lingua utilizzato per formattare il nome.
