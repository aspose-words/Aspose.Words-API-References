...
description: Scopri il metodo GetFieldNames in FieldGreetingLine, che recupera in modo efficiente una raccolta di nomi di campi di stampa unione per un'integrazione dei dati ottimale.
type: docs
weight: 50
