...
description: Scopri la classe Aspose.Words.Fields.FieldNumChars, progettata per implementare in modo efficiente il campo NUMCHARS per un'elaborazione avanzata dei documenti.
type: docs
weight: 2620
...
Recupera il numero di caratteri nel documento corrente, come registrato nel**Caratteri** proprietà delle proprietà del documento incorporato .
