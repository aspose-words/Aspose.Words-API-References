...
description: Ottimizza le tue citazioni con FieldToa UsePassim. Gestisci facilmente più riferimenti alla stessa autorità, migliorando la chiarezza e l'accuratezza del tuo lavoro.
type: docs
weight: 110
...
Ottiene o imposta se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con "passim", che viene utilizzato per indicare che una parola o un passaggio si verifica frequentemente nell'opera citata.
