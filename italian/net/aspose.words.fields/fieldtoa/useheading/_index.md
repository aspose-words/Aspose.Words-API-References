...
description: FieldToa proprietà. Ottiene o imposta se includere lintestazione di categoria per le voci in una tabella di autorizzazioni.
type: docs
weight: 100
...
Ottiene o imposta se includere l'intestazione di categoria per le voci in una tabella di autorizzazioni.
