...
description: Scopri la proprietà FieldToa EntrySeparator per personalizzare facilmente la tabella delle autorità con sequenze di caratteri flessibili per una maggiore chiarezza.
type: docs
weight: 40
...
Ottiene o imposta la sequenza di caratteri utilizzata per separare una voce della tabella delle fonti e il suo numero di pagina.
