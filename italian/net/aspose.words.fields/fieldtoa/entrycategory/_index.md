...
description: Scopri la proprietà EntryCategory di FieldToa per gestire e personalizzare in modo efficiente le categorie integrali per le voci delle tue tabelle. Migliora l'organizzazione oggi stesso!
type: docs
weight: 30
url: /it/net/aspose.words.fields/fieldtoa/entrycategory/
---
## FieldToa.EntryCategory property

Ottiene o imposta la categoria integrale per le voci incluse nella tabella.
