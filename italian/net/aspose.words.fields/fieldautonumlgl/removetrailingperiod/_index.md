...
description: Gestisci la proprietà RemoveTrailingPeriod di FieldAutoNumLgl per personalizzare la visualizzazione dei numeri: elimina i punti finali per una formattazione più pulita e professionale.
type: docs
weight: 20
