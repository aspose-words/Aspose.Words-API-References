...
description: FieldAutoNumLgl RemoveTrailingPeriod proprietà. Ottiene o imposta se visualizzare il numero senza punto finale in C#.
type: docs
weight: 20
...
Ottiene o imposta se visualizzare il numero senza punto finale.
