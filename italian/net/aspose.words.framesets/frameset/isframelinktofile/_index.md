...
description: Frameset proprietà. Ottiene o imposta un valore che indica se la pagina Web o il nome del file del documento specificato in FrameDefaultUrl la proprietà è una risorsa esterna a cui è collegato il frame.
type: docs
weight: 40
