...
description: JsonDataSource costruttore. Crea una nuova origine dati con i dati di un file JSON utilizzando le opzioni predefinite per lanalisi dei dati JSON.
type: docs
weight: 10
