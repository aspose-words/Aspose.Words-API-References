...
description: XmlDataLoadOptions proprietà. Ottiene o imposta un flag che indica se unorigine dati generata conterrà sempre un oggetto per un elemento radice XML . Se un elemento radice XML non ha attributi e tutti i suoi elementi figlio hanno lo stesso nome tale oggetto non viene creato per impostazione predefinita.
type: docs
weight: 20
