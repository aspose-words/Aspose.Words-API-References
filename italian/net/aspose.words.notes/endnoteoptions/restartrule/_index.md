...
description: EndnoteOptions proprietà. Determina quando si riavvia la numerazione automatica.
type: docs
weight: 30
...
Non tutti i valori sono applicabili alle note di chiusura. Per accertare quali valori sono applicabili, vedere[`FootnoteNumberingRule`](../../footnotenumberingrule/).
