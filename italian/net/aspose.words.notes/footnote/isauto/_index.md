...
description: Footnote proprietà. Contiene un valore che specifica se si tratta di una nota a piè di pagina con numerazione automatica o di una nota a piè di pagina con un segno di riferimento personalizzato definito dallutente.
type: docs
weight: 30
...
Contiene un valore che specifica se si tratta di una nota a piè di pagina con numerazione automatica o di una nota a piè di pagina con un segno di riferimento personalizzato definito dall'utente.
...
[`ReferenceMark`](../referencemark/) inizializzato con una stringa vuota se IsAuto è impostato su false.
