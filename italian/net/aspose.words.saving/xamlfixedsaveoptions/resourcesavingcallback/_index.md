...
description: Ottimizza le esportazioni dei tuoi documenti con XamlFixedSaveOptions ResourceSavingCallback. Controlla il salvataggio di immagini e font per una maggiore efficienza nel formato XAML.
type: docs
weight: 20
...
Consente di controllare come vengono salvate le risorse (immagini e caratteri) quando un documento viene esportato nel formato Xaml a pagina fissa.
