...
description: Scopri la proprietà SaveFormat di PdfSaveOptions per salvare facilmente i documenti in formato PDF. Semplifica la gestione dei tuoi file con opzioni di salvataggio efficienti.
type: docs
weight: 300
...
Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere soloPdf .
