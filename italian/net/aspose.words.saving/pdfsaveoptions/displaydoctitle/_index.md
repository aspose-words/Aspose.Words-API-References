...
description: PdfSaveOptions proprietà. Un flag che specifica se la barra del titolo della finestra deve visualizzare il titolo del documento tratto da la voce Titolo del dizionario delle informazioni del documento.
type: docs
weight: 70
...
Un flag che specifica se la barra del titolo della finestra deve visualizzare il titolo del documento tratto da la voce Titolo del dizionario delle informazioni del documento.
...
Questo contrassegno è richiesto dalla conformità PDF/UA.`VERO` il valore verrà utilizzato automaticamente durante il salvataggio di in PDF/UA.
...
// Imposta "DisplayDocTitle" su "false" per fare in modo che tali lettori visualizzino il nome del file del documento.
