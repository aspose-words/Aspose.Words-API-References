...
description: Ottimizza la gestione dei documenti con il metodo DocumentPartSaving in Aspose.Words, che garantisce un salvataggio fluido delle parti del documento per una maggiore efficienza.
type: docs
weight: 10
url: /it/net/aspose.words.saving/idocumentpartsavingcallback/documentpartsaving/
---
## IDocumentPartSavingCallback.DocumentPartSaving method

Chiamato quando Aspose.Words sta per salvare una parte del documento.
