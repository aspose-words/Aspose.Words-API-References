...
description: MetafileRenderingOptions UseGdiRasterOperationsEmulation proprietà. Ottiene o imposta un valore che determina se utilizzare o meno GDI per lemulazione delle operazioni raster in C#.
type: docs
weight: 80
