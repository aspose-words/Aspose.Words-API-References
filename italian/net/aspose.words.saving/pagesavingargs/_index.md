...
Fornisce i dati per il[`PageSaving`](../ipagesavingcallback/pagesaving/) evento.
...
| Nome | Descrizione |
| --- | --- |
| [KeepPageStreamOpen](../../aspose.words.saving/pagesavingargs/keeppagestreamopen/) { get; set; } | Specifica se Aspose.Words deve mantenere lo stream aperto o chiuderlo dopo aver salvato una pagina del documento. |
...
| [PageStream](../../aspose.words.saving/pagesavingargs/pagestream/) { get; set; } | Consente di specificare lo stream in cui verrà salvata la pagina del documento. |
