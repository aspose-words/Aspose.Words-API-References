...
description: Controlla il salvataggio delle parti del documento con DocumentPartSavingCallback di HtmlSaveOptions. Ottimizza le tue esportazioni HTML o EPUB per un'esperienza utente fluida.
type: docs
weight: 70
...
Consente di controllare come vengono salvate le parti del documento quando un documento viene salvato in formato HTML o EPUB.
