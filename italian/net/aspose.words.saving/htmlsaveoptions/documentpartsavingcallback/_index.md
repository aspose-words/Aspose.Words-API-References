...
description: HtmlSaveOptions proprietà. Consente di controllare come vengono salvate le parti del documento quando un documento viene salvato in HTML o EPUB.
type: docs
weight: 70
...
Consente di controllare come vengono salvate le parti del documento quando un documento viene salvato in HTML o EPUB.
