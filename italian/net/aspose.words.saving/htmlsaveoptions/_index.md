...
description: Aspose.Words.Saving.HtmlSaveOptions classe. Può essere utilizzato per specificare opzioni aggiuntive quando si salva un documento in Html Mhtml Epub  Azw3 OMobi formato in C#.
type: docs
weight: 5110
...
| [HtmlSaveOptions](htmlsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nellaHtml ,Mhtml ,Epub , Azw3 OMobi formato. |
