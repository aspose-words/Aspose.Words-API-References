...
description: Controlla il salvataggio delle immagini con ImageSavingCallback di HtmlSaveOptions. Ottimizza le esportazioni dei documenti in HTML, MHTML o EPUB per un'esperienza utente fluida.
type: docs
weight: 350
url: /it/net/aspose.words.saving/htmlsaveoptions/imagesavingcallback/
---
## HtmlSaveOptions.ImageSavingCallback property

Consente di controllare come vengono salvate le immagini quando un documento viene salvato in formato HTML, MHTML o EPUB.
