...
description: Specifica se utilizzare gli URL CID Content-ID per fare riferimento a risorse immagini caratteri CSS incluse nei documenti MHTML . Il valore predefinito èfalso .
type: docs
weight: 120
