...
description: Specifica la modalità di output di intestazioni e piè di pagina in HTML MHTML o EPUB. Il valore predefinito èPerSection per HTML/MHTML eNone per EPUB.
type: docs
weight: 170
