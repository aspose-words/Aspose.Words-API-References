...
description: Specifica il nome della cartella utilizzata per costruire gli URI dei caratteri scritti in un documento HTML. Limpostazione predefinita è una stringa vuota.
type: docs
weight: 330
