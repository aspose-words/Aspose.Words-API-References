...
description: Scopri la proprietà HtmlVersion di HtmlSaveOptions per scegliere facilmente lo standard HTML quando salvi i documenti in HTML o MHTML. Ottimizza il tuo output senza sforzo!
type: docs
weight: 330
...
Specifica la versione dello standard HTML che deve essere utilizzata quando si salva il documento in HTML o MHTML. Il valore predefinito èXhtml .
