...
description: SaveOptions DmlEffectsRenderingMode proprietà. Ottiene o imposta un valore che determina la modalità di rendering degli effetti DrawingML in C#.
type: docs
weight: 60
