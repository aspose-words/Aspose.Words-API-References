...
description: SaveOptions ImlRenderingMode proprietà. Ottiene o imposta un valore che determina la modalità di rendering degli oggetti input penna InkML in C#.
type: docs
weight: 90
