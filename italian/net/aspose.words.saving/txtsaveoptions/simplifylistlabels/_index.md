...
description: Specifica se il programma deve semplificare le etichette degli elenchi nel caso in cui la formattazione di etichette complesse non sia adeguatamente rappresentata da testo normale.
type: docs
weight: 70
