...
description: MarkdownSaveOptions proprietà. Specifica la cartella fisica in cui vengono salvate le immagini durante lesportazione di un documento in Markdown formato. Limpostazione predefinita è una stringa vuota.
type: docs
weight: 40
