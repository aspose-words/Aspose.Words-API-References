...
description: MarkdownSaveOptions costruttore. Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nelMarkdown formato.
type: docs
weight: 10
