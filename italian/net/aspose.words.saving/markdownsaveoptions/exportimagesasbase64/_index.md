...
description: MarkdownSaveOptions proprietà. Specifica se le immagini vengono salvate nel formato Base64 nel file di output. Limpostazione predefinita èfalso .
type: docs
weight: 20
