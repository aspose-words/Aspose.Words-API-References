...
description: Scopri Aspose.Words.Saving.XlsxSaveOptions per migliorare la conversione dei tuoi documenti in formato Xlsx. Sblocca opzioni di salvataggio avanzate per risultati ottimali!
type: docs
weight: 6520
...
Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento inXlsx Formato .

Per saperne di più, visita il[Specificare Opzioni di salvataggio](https://docs.aspose.com/words/net/specify-save-options/) articolo di documentazione.
...
| Nome | Descrizione |
| --- | --- |
| [XlsxSaveOptions](xlsxsaveoptions/)() | Default_Costruttore |
...
| [DateTimeParsingMode](../../aspose.words.saving/xlsxsaveoptions/datetimeparsingmode/) { get; set; } | Ottiene o imposta la modalità che specifica come il testo del documento viene analizzato per identificare i valori di data e ora. Il valore predefinito èUseCurrentLocale . |
...
| override [SaveFormat](../../aspose.words.saving/xlsxsaveoptions/saveformat/) { get; set; } | Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere soloXlsx . |
| [SectionMode](../../aspose.words.saving/xlsxsaveoptions/sectionmode/) { get; set; } | Ottiene o imposta il modo in cui le sezioni vengono gestite durante il salvataggio nel documento XLSX di output. Il valore predefinito èMultipleWorksheets . |
