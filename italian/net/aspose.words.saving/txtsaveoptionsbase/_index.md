...
description: Aspose.Words.Saving.TxtSaveOptionsBase classe. La classe base per specificare opzioni aggiuntive quando si salva un documento in formati basati su testo in C#.
type: docs
weight: 5670
...
La classe base per specificare opzioni aggiuntive quando si salva un documento in formati basati su testo.
