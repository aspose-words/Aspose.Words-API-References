...
description: Scopri Aspose.Words.Saving.TxtSaveOptionsBase per un salvataggio documenti migliorato. Personalizza le opzioni di formattazione del testo per risultati ottimali ed efficienza.
type: docs
weight: 6470
...
La classe base per specificare opzioni aggiuntive quando si salva un documento in un formato basato su testo.
