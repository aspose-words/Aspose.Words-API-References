...
description: Aspose.Words.Saving.TxtSaveOptionsBase classe. La classe base per specificare opzioni aggiuntive quando si salva un documento in formati basati su testo.
type: docs
weight: 5670
