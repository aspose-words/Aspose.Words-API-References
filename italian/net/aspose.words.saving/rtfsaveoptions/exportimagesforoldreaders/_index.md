...
description: Specifica se le parole chiave per vecchi lettori vengono scritte o meno in RTF. Ciò può influire in modo significativo sulla dimensione del documento RTF. Il valore predefinito èVERO .
type: docs
weight: 30
