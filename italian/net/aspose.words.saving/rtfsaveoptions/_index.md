...
description: Aspose.Words.Saving.RtfSaveOptions classe. Può essere utilizzato per specificare opzioni aggiuntive quando si salva un documento nel fileRtf formato in C#.
type: docs
weight: 5570
