...
description: Aspose.Words.Saving.RtfSaveOptions classe. Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento nel fileRtf formato.
type: docs
weight: 5290
...
Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento nel fileRtf formato.
...
| [ExportImagesForOldReaders](../../aspose.words.saving/rtfsaveoptions/exportimagesforoldreaders/) { get; set; } | Specifica se le parole chiave per "vecchi lettori" vengono scritte o meno in RTF. Ciò può influire in modo significativo sulla dimensione del documento RTF. Il valore predefinito è`VERO` . |
...
| override [SaveFormat](../../aspose.words.saving/rtfsaveoptions/saveformat/) { get; set; } | Specifica il formato in cui verrà salvato il documento se viene utilizzato questo oggetto opzioni di salvataggio. Può essereRtf . |
| [SaveImagesAsWmf](../../aspose.words.saving/rtfsaveoptions/saveimagesaswmf/) { get; set; } | Quando true tutte le immagini verranno salvate come WMF. |
