...
description: Aspose.Words.Saving.PsSaveOptions classe. Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento nel filePs formato.
type: docs
weight: 5270
...
Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento nel filePs formato.
...
| override [SaveFormat](../../aspose.words.saving/pssaveoptions/saveformat/) { get; set; } | Specifica il formato in cui verrà salvato il documento se viene utilizzato questo oggetto opzioni di salvataggio. Può esserePs . |
