...
description: Scopri la proprietà UserName di PdfDigitalSignatureTimestampSettings per una marcatura temporale sicura. Migliora l'integrità dei tuoi documenti con un'autenticazione server affidabile.
type: docs
weight: 50
url: /it/net/aspose.words.saving/pdfdigitalsignaturetimestampsettings/username/
---
## PdfDigitalSignatureTimestampSettings.UserName property

Nome utente del server di marcatura temporale.
