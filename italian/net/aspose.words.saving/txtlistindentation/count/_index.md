...
description: TxtListIndentation proprietà. Ottiene o imposta il numeroCharacter da utilizzare come rientro per un livello di elenco. Il valore predefinito è 0 ciò significa nessun rientro.
type: docs
weight: 30
