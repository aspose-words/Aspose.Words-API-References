...
description: Scopri la proprietà FontSavingArgs IsExportNeeded per controllare l'esportazione delle risorse font. Massimizza l'efficienza con impostazioni personalizzabili per i tuoi progetti!
type: docs
weight: 60
...
Consente di specificare se il font corrente verrà esportato come risorsa font. Il valore predefinito è`VERO` .
