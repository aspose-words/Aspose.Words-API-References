...
description: ImageSaveOptions TiffCompression proprietà. Ottiene o imposta il tipo di compressione da applicare quando si salvano le immagini generate nel formato TIFF in C#.
type: docs
weight: 180
