...
description: ImageSaveOptions VerticalResolution proprietà. Ottiene o imposta la risoluzione verticale per le immagini generate in punti per pollice in C#.
type: docs
weight: 200
