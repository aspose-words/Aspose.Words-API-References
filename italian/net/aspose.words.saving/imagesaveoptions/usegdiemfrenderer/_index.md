...
description: ImageSaveOptions UseGdiEmfRenderer proprietà. Ottiene o imposta un valore che determina se utilizzare il renderer di metafile GDI o Aspose.Words durante il salvataggio in EMF in C#.
type: docs
weight: 190
