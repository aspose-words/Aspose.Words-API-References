...
description: Specifica se le immagini devono essere incorporate nel documento HTML in formato Base64. Nota limpostazione di questo flag può aumentare notevolmente le dimensioni del file HTML di output.
type: docs
weight: 60
