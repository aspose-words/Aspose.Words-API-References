...
description: Il flag indica se le regole CSS font-face devono essere inserite in un file separato fontFaces.css quando un documento viene salvato con un foglio di stile esterno ovvero quandoExportEmbeddedCssaspose.words.saving/htmlfixedsaveoptions/exportembeddedcss èfalso . Il valore predefinito èfalso  tutte le regole CSS sono scritte in un unico file styles.css.
type: docs
weight: 160
