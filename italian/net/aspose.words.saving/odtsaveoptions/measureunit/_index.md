...
description: OdtSaveOptions MeasureUnit proprietà. Permette di specificare le unità di misura da applicare al contenuto del documento. Il valore predefinito èCentimeters in C#.
type: docs
weight: 30
