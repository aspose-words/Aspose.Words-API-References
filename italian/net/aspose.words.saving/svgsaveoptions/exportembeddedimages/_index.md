...
description: Specifica se le immagini devono essere incorporate nel documento SVG come base64. Nota limpostazione di questo flag può aumentare significativamente le dimensioni del file SVG di output.
type: docs
weight: 20
