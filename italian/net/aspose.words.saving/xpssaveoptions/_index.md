...
description: Scopri Aspose.Words.Saving.XpsSaveOptions per un salvataggio avanzato dei documenti in formato XPS. Personalizza le impostazioni per un output e una qualità ottimali.
type: docs
weight: 6540
...
Può essere utilizzato per specificare opzioni aggiuntive durante il salvataggio di un documento inXps formato.
...
| [XpsSaveOptions](xpssaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | Inizializza una nuova istanza di questa classe che può essere utilizzata per salvare un documento nelXps OOpenXps formato. |
...
| [DigitalSignatureDetails](../../aspose.words.saving/xpssaveoptions/digitalsignaturedetails/) { get; set; } | Ottiene o imposta[`DigitalSignatureDetails`](../digitalsignaturedetails/) oggetto utilizzato per firmare un documento. |
...
| override [SaveFormat](../../aspose.words.saving/xpssaveoptions/saveformat/) { get; set; } | Specifica il formato in cui il documento verrà salvato se viene utilizzato questo oggetto di opzioni di salvataggio. Può essere soloXps . |
