...
description: Scopri la proprietà Cell IsLastCell. Determina facilmente se una cella è l'ultima di una riga, migliorando le tue strategie di gestione e ottimizzazione dei dati.
type: docs
weight: 50
url: /it/net/aspose.words.tables/cell/islastcell/
---
## Cell.IsLastCell property

Vero se questa è l'ultima cella all'interno di una riga; falso in caso contrario.
