...
description: True se questa è lultima cella allinterno di una riga falso altrimenti.
type: docs
weight: 50
...
True se questa è l'ultima cella all'interno di una riga; falso altrimenti.
