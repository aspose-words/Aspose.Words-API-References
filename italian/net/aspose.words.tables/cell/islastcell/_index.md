...
description: Cell IsLastCell proprietà. Vero se questa è lultima cella allinterno di una riga falso altrimenti in C#.
type: docs
weight: 50
...
Vero se questa è l'ultima cella all'interno di una riga; falso altrimenti.
