...
description: Cell IsFirstCell proprietà. Vero se questa è la prima cella allinterno di una riga falso altrimenti in C#.
type: docs
weight: 40
...
Vero se questa è la prima cella all'interno di una riga; falso altrimenti.
