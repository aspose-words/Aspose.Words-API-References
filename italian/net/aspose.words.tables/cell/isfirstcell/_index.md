...
description: Cell proprietà. True se questa è la prima cella allinterno di una riga falso altrimenti.
type: docs
weight: 40
...
True se questa è la prima cella all'interno di una riga; falso altrimenti.
