...
description: Scopri il metodo Cell AcceptStart per accogliere senza problemi i visitatori nel punto di ingresso della tua cella, migliorando l'esperienza utente e il coinvolgimento.
type: docs
weight: 150
url: /it/net/aspose.words.tables/cell/acceptstart/
---
## Cell.AcceptStart method

Accetta un visitatore per aver visitato l'inizio della cella.
