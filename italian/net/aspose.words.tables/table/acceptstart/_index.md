...
description: Scopri il metodo Table AcceptStart per accogliere senza problemi i visitatori all'inizio del tavolo, migliorando l'esperienza utente e il coinvolgimento.
type: docs
weight: 370
url: /it/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Accetta un visitatore per aver visitato l'inizio della tabella.
