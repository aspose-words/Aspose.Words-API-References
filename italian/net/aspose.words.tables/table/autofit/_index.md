...
description: Table metodo. Ridimensiona la tabella e le celle in base al comportamento di adattamento automatico specificato.
type: docs
weight: 360
...
Questo metodo imita i comandi disponibili nel menu Adatta automaticamente per una tabella in Microsoft Word. I comandi disponibili sono "Adatta automaticamente al contenuto", "Adatta automaticamente alla finestra" e "Larghezza colonna fissa". In Microsoft Word questi comandi impostano le proprietà della tabella rilevanti e quindi aggiornano il layout della tabella e Aspose.Words fa lo stesso per te.
