...
description: Table costruttore. Inizializza una nuova istanza di Tavolo classe.
type: docs
weight: 10
...
Inizializza una nuova istanza di **Tavolo** classe.
...
quando **Tavolo** viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e **ParentNode** è zero.

Aggiungere **Tavolo** nel documento usa InsertAfter o InsertBefore sulla storia in cui vuoi inserire la tabella.
