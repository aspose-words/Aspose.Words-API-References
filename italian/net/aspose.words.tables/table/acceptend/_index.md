...
description: Scopri il metodo Table AcceptEnd, integra perfettamente i visitatori alla fine della tabella per una migliore esperienza utente e una gestione efficiente dei dati.
type: docs
weight: 360
url: /it/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

Accetta un visitatore che raggiunge la fine della tabella.
