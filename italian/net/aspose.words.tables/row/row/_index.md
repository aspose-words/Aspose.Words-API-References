...
description: Row costruttore. Inizializza una nuova istanza di Riga classe.
type: docs
weight: 10
...
Inizializza una nuova istanza di **Riga** classe.
...
quando **Riga** viene creato, appartiene al documento specificato, ma non fa ancora parte del documento e **ParentNode** è zero.

Aggiungere **Riga**al documento utilizzare InsertAfter o InsertBefore nella tabella in cui si desidera inserire la riga.
