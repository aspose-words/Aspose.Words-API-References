...
description: Scopri la proprietà Row ParentTable per accedere facilmente alla tabella padre immediata di qualsiasi riga, migliorando la gestione e l'analisi dei dati.
type: docs
weight: 90
...
Restituisce la tabella padre immediata della riga.
