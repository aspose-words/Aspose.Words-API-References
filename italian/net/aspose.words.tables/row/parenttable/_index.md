...
description: Row proprietà. Restituisce la tabella padre immediato della riga.
type: docs
weight: 80
...
Restituisce la tabella padre immediato della riga.
...
Equivalente a`(Tabella)FirstNonMarkupParentNode`.
