...
description: Scopri il metodo Row AcceptEnd per migliorare l'esperienza dei tuoi visitatori guidandoli senza problemi fino alla fine di una riga. Aumenta il coinvolgimento oggi stesso!
type: docs
weight: 130
url: /it/net/aspose.words.tables/row/acceptend/
---
## Row.AcceptEnd method

Accetta un visitatore per aver visitato la fine della riga.
