...
description: Scopri il metodo Row AcceptStart, accetta senza problemi i visitatori all'inizio della riga per un'esperienza utente migliorata e una navigazione efficiente.
type: docs
weight: 140
url: /it/net/aspose.words.tables/row/acceptstart/
---
## Row.AcceptStart method

Accetta un visitatore per aver visitato l'inizio della riga.
