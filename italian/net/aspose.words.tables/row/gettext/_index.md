...
description: Scopri il metodo Row GetText per recuperare senza sforzo il testo da tutte le celle di una riga, incluso il carattere di fine riga, per una gestione dei dati ottimale.
type: docs
weight: 160
...
Ottiene il testo di tutte le celle in questa riga, incluso il carattere di fine riga.
...
Restituisce il testo concatenato di tutti i nodi figlio con il carattere di fine riga [`Cell`](../../../aspose.words/controlchar/cell/) aggiunto alla fine.
