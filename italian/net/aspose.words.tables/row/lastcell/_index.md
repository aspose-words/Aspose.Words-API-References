...
description: Scopri la proprietà Row LastCell per accedere facilmente all'ultima cella di una riga, migliorando l'efficienza della gestione e dell'analisi dei dati.
type: docs
weight: 60
...
Restituisce l'ultimo[`Cell`](../../cell/) nella riga.
