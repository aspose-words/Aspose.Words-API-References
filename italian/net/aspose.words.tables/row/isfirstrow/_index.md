...
description: Row proprietà. True se questa è la prima riga in una tabella falso altrimenti.
type: docs
weight: 40
...
True se questa è la prima riga in una tabella; falso altrimenti.
