...
description: Fornisce laccesso alle informazioni sul progetto VBA. Un progetto VBA allinterno del documento è definito come una raccolta di moduli VBA.
type: docs
weight: 6270
...
| Nome | Descrizione |
| --- | --- |
| [Clone](../../aspose.words.vba/vbaproject/clone/)() | Esegue una copia di[`VbaProject`](./vbaproject/) . |
