...
description: VbaModule proprietà. Specifica se il modulo è un modulo procedurale un modulo di documento un modulo di classe o un modulo di progettazione.
type: docs
weight: 40
