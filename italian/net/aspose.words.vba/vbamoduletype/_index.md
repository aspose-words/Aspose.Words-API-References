...
| --- | --- | --- |
| DocumentModule | `0` | Un tipo di elemento del progetto VBA che specifica un modulo per le macro incorporate e le operazioni di accesso programmatico associate a un documento. |
| ProceduralModule | `1` | Una raccolta di subroutine e funzioni. |
| ClassModule | `2` | Un modulo che contiene la definizione per un nuovo oggetto. Ogni istanza di una classe crea un nuovo oggetto, e le procedure definite nel modulo diventano proprietà e metodi dell'oggetto. |
| DesignerModule | `3` | Un modulo VBA che estende i metodi e le proprietà di un controllo ActiveX che è stato registrato con il progetto. |
