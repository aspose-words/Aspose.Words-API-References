...
description: Scopri la proprietà DataSources di ReportBuilderContext per una creazione di report fluida con fonti dati versatili e personalizzate in base alle tue esigenze.
type: docs
weight: 20
url: /it/net/aspose.words.lowcode/reportbuildercontext/datasources/
---
## ReportBuilderContext.DataSources property

Fonti dati utilizzate per creare il report.
...
La chiave rappresenta l'origine dati, mentre il valore è il nome dell'origine dati. Il nome dell'origine dati può essere null o una stringa vuota; in questi casi, il motore di reporting rileverà automaticamente il nome dell'origine dati dall'origine dati specificata.
