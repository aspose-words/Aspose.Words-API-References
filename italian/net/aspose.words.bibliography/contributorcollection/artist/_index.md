...
description: Scopri la proprietà Artist di ContributorCollection per gestire e personalizzare facilmente gli artisti di origine, per una migliore organizzazione e creatività nei tuoi progetti.
type: docs
weight: 10
url: /it/net/aspose.words.bibliography/contributorcollection/artist/
---
## ContributorCollection.Artist property

Ottiene o imposta l'artista di una sorgente.
