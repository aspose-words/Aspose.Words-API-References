...
description: Gestisci la tua ContributorCollection con facilità! Imposta o scarica l'editor per le fonti per migliorare il tuo flusso di lavoro e semplificare la gestione dei contenuti.
type: docs
weight: 90
url: /it/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

Ottiene o imposta l'editor di una sorgente.
