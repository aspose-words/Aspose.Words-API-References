...
description: Scopri la proprietà Compiler di ContributorCollection per gestire in modo efficiente i compilatori sorgente. Migliora la tua esperienza di programmazione con accesso e controllo semplificati!
type: docs
weight: 40
url: /it/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

Ottiene o imposta il compilatore di una sorgente.

```csharp
public Contributor Compiler { get; set; }
```
