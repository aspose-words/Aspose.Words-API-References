---
title: ContributorCollection.Interviewer
linktitle: Interviewer
articleTitle: Interviewer
second_title: Aspose.Words per .NET
description: Scopri la proprietà "Intervistatore" di ContributorCollection, gestisci e personalizza facilmente i dettagli dell'intervistatore per le tue fonti. Migliora la tua gestione dei dati oggi stesso!
type: docs
weight: 110
url: /it/net/aspose.words.bibliography/contributorcollection/interviewer/
---
## ContributorCollection.Interviewer property

Ottiene o imposta l'intervistatore di una fonte.

```csharp
public Contributor Interviewer { get; set; }
```
