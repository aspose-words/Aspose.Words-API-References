...
description: Gestisci la tua ContributorCollection senza sforzo. Imposta o aggiorna facilmente il direttore per ogni fonte, migliorando l'organizzazione e l'efficienza.
type: docs
weight: 80
url: /it/net/aspose.words.bibliography/contributorcollection/director/
---
## ContributorCollection.Director property

Ottiene o imposta il direttore di una sorgente.
