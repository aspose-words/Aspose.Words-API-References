...
description: Scopri la proprietà Composer di ContributorCollection per gestire e personalizzare facilmente i compositori di origine per una migliore organizzazione ed efficienza dei dati.
type: docs
weight: 50
url: /it/net/aspose.words.bibliography/contributorcollection/composer/
---
## ContributorCollection.Composer property

Ottiene o imposta il compositore di una sorgente.
