...
description: Scopri la proprietà Conductor di ContributorCollection, gestisci e personalizza facilmente il conduttore di origine per un'organizzazione e un controllo migliori dei dati.
type: docs
weight: 60
url: /it/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Ottiene o imposta il conduttore di una sorgente.
