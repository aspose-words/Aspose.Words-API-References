...
description: Gestisci il tuo ordine di riferimento sorgente senza sforzo con RefOrder. Ottimizza l'organizzazione dei dati per una maggiore efficienza e chiarezza.
type: docs
weight: 380
url: /it/net/aspose.words.bibliography/source/reforder/
---
## Source.RefOrder property

Ottiene o imposta l'ordine di riferimento di una sorgente.
