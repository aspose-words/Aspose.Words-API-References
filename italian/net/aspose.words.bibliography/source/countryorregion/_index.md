...
description: Gestisci le posizioni delle sorgenti senza sforzo con la proprietà CountryOrRegion. Ottieni o imposta facilmente il paese o la regione della sorgente per una gestione semplificata dei dati.
type: docs
weight: 130
url: /it/net/aspose.words.bibliography/source/countryorregion/
---
## Source.CountryOrRegion property

Ottiene o imposta il paese o la regione di una sorgente.
