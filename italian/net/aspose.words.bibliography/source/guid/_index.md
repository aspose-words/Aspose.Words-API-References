...
description: Gestisci la tua proprietà Source Guid senza sforzo. Ottieni o imposta facilmente il GUID per una gestione semplificata dei dati e un'organizzazione migliorata.
type: docs
weight: 210
url: /it/net/aspose.words.bibliography/source/guid/
---
## Source.Guid property

Ottiene o imposta il GUID di una sorgente.
