...
description: Gestisci facilmente i volumi dei numeri sorgente. Regola il numero di volumi per una gestione ottimale delle sorgenti e migliora l'organizzazione dei tuoi dati senza sforzo.
type: docs
weight: 300
url: /it/net/aspose.words.bibliography/source/numbervolumes/
---
## Source.NumberVolumes property

Ottiene o imposta il numero di volumi di una sorgente.
