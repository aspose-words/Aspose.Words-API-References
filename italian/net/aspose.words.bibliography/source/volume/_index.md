...
description: Regola facilmente il volume della sorgente per migliorare la tua esperienza audio. Controlla i livelli audio per una chiarezza e un piacere ottimali durante i tuoi progetti.
type: docs
weight: 520
url: /it/net/aspose.words.bibliography/source/volume/
---
## Source.Volume property

Ottiene o imposta il volume di una sorgente.
