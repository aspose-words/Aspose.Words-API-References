...
description: Gestisci il numero di pratica della tua fonte senza sforzo con la proprietà Source CaseNumber. Semplifica il monitoraggio e migliora l'organizzazione per risultati migliori.
type: docs
weight: 70
url: /it/net/aspose.words.bibliography/source/casenumber/
---
## Source.CaseNumber property

Ottiene o imposta il numero del caso di una sorgente.
