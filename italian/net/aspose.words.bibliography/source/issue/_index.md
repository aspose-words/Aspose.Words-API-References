...
description: Gestisci i tuoi problemi con le sorgenti senza sforzo. Ottieni o imposta facilmente le proprietà delle sorgenti per semplificare il flusso di lavoro e migliorare la produttività.
type: docs
weight: 240
url: /it/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

Ottiene o imposta il problema di una fonte.
