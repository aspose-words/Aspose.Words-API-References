...
description: Scopri un elenco completo di collaboratori – autori, redattori e scrittori – per la tua fonte. Arricchisci la tua ricerca con spunti preziosi!
type: docs
weight: 120
url: /it/net/aspose.words.bibliography/source/contributors/
---
## Source.Contributors property

Ottiene l'elenco dei collaboratori (autore, editore, scrittore ecc.) di una fonte.
