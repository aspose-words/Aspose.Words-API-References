...
description: Gestisci le tue date di origine senza sforzo con Source Day. Imposta o recupera facilmente i giorni di origine per semplificare il flusso di lavoro e migliorare la produttività.
type: docs
weight: 150
url: /it/net/aspose.words.bibliography/source/day/
---
## Source.Day property

Ottiene o imposta il giorno di una sorgente.
