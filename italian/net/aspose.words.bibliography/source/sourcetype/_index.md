...
description: Scopri la proprietà SourceType per gestire facilmente le tue fonti dati. Ottieni o imposta facilmente i tipi di fonte per una migliore organizzazione dei dati.
type: docs
weight: 410
url: /it/net/aspose.words.bibliography/source/sourcetype/
---
## Source.SourceType property

Ottiene o imposta il tipo di sorgente di una sorgente.
