...
description: Gestisci la proprietà Anno sorgente senza sforzo. Ottieni o imposta facilmente l'anno di una fonte per un'organizzazione semplificata dei dati e una maggiore precisione.
type: docs
weight: 530
url: /it/net/aspose.words.bibliography/source/year/
---
## Source.Year property

Ottiene o imposta l'anno di una sorgente.
