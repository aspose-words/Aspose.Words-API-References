...
description: Scopri come gestire in modo efficiente le proprietà Doi per una gestione ottimale degli identificatori di oggetti digitali. Aumenta la visibilità della tua ricerca oggi stesso!
type: docs
weight: 190
url: /it/net/aspose.words.bibliography/source/doi/
---
## Source.Doi property

Ottiene o imposta l'identificatore dell'oggetto digitale.
