...
description: Scopri la proprietà "Source Broadcaster" e gestisci facilmente l'emittente della tua sorgente per un controllo e prestazioni dello streaming migliorati. Ottimizza la tua esperienza multimediale!
type: docs
weight: 50
url: /it/net/aspose.words.bibliography/source/broadcaster/
---
## Source.Broadcaster property

Ottiene o imposta l'emittente di una sorgente.
