...
description: Gestisci la proprietà Source StandardNumber senza sforzo. Ottieni o imposta facilmente il numero standard per un'integrazione dei dati impeccabile e accurata.
type: docs
weight: 420
url: /it/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

Ottiene o imposta il numero standard di una sorgente.
