...
description: Gestisci la proprietà Lcid senza sforzo. Ottieni o imposta l'ID locale della tua fonte per una localizzazione fluida e un'esperienza utente migliorata.
type: docs
weight: 260
url: /it/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

Ottiene o imposta l'ID locale di una sorgente.
