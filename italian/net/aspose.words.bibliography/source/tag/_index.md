...
description: Gestisci la proprietà del tuo tag sorgente senza sforzo. Ottieni o imposta facilmente il nome tag univoco per la tua sorgente, migliorando l'organizzazione e l'efficienza.
type: docs
weight: 450
url: /it/net/aspose.words.bibliography/source/tag/
---
## Source.Tag property

Ottiene o imposta il nome del tag identificativo di una sorgente.
