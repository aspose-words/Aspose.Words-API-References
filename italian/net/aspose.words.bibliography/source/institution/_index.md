...
description: Gestisci le proprietà del tuo istituto di origine senza sforzo. Imposta o aggiorna facilmente i dettagli dell'istituto per un'organizzazione semplificata dei dati e una migliore accessibilità.
type: docs
weight: 220
url: /it/net/aspose.words.bibliography/source/institution/
---
## Source.Institution property

Ottiene o imposta l'istituzione di una fonte.
