...
description: Gestisci il tuo reparto di origine senza sforzo. Ottieni o imposta facilmente i dettagli del reparto per migliorare l'organizzazione e l'efficienza. Scopri oggi stesso un'integrazione perfetta!
type: docs
weight: 170
url: /it/net/aspose.words.bibliography/source/department/
---
## Source.Department property

Ottiene o imposta il dipartimento di una fonte.
