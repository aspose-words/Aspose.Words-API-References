...
description: Gestisci le proprietà del tipo di sorgente senza sforzo. Ottieni o imposta facilmente i tipi di sorgente per migliorare l'organizzazione dei dati e l'efficienza nei tuoi progetti.
type: docs
weight: 490
url: /it/net/aspose.words.bibliography/source/type/
---
## Source.Type property

Ottiene o imposta il tipo di una sorgente.
