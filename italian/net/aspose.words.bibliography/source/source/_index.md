...
description: Crea senza sforzo una nuova istanza della classe Source con il nostro costruttore. Semplifica il tuo processo di codifica e migliora l'efficienza del tuo progetto oggi stesso!
type: docs
weight: 10
url: /it/net/aspose.words.bibliography/source/source/
---
## Source constructor

Inizializza una nuova istanza di[`Source`](../) classe.
...
| --- | --- | --- |
| tag | String | Nome del tag identificativo. |
| sourceType | SourceType | Il tipo di sorgente. |
