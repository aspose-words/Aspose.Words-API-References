...
description: Gestisci le pagine sorgente senza sforzo. Recupera o imposta facilmente i dettagli delle pagine sorgente per migliorare l'organizzazione dei contenuti e l'efficienza del flusso di lavoro.
type: docs
weight: 310
url: /it/net/aspose.words.bibliography/source/pages/
---
## Source.Pages property

Ottiene o imposta le pagine di una sorgente.
