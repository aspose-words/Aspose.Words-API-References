...
description: Gestisci la data di accesso alla tua fonte senza sforzo con Source DayAccessed. Traccia e aggiorna facilmente la data di accesso alla tua fonte per una migliore organizzazione.
type: docs
weight: 160
url: /it/net/aspose.words.bibliography/source/dayaccessed/
---
## Source.DayAccessed property

Ottiene o imposta il giorno di accesso a una sorgente.
