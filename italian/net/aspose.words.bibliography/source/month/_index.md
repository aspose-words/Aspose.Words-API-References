...
description: Gestisci la tua proprietà "Mese sorgente" senza sforzo. Ottieni o imposta facilmente il mese per qualsiasi sorgente, migliorando l'organizzazione e l'efficienza dei tuoi dati.
type: docs
weight: 280
url: /it/net/aspose.words.bibliography/source/month/
---
## Source.Month property

Ottiene o imposta il mese di una sorgente.
