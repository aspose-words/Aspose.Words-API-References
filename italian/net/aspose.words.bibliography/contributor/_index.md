...
description: Scopri la classe Aspose.Words.Bibliography.Contributor, la soluzione ideale per la gestione dei collaboratori della bibliografia, tra cui organizzazioni e singoli individui.
type: docs
weight: 150
url: /it/net/aspose.words.bibliography/contributor/
---
## Contributor class

Rappresenta il contributore di una fonte bibliografica. Può essere un'azienda (un'organizzazione) o un elenco di persone.
