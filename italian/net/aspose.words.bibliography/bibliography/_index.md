...
description: Scopri la classe Aspose.Words.Bibliography, il tuo strumento essenziale per gestire le fonti bibliografiche nei documenti in modo efficiente e senza sforzi.
type: docs
weight: 140
url: /it/net/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| Nome | Descrizione |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Ottiene o imposta una stringa che rappresenta il nome dello stile attivo da utilizzare per una bibliografia. |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | Ottiene una raccolta che rappresenta tutte le fonti contenute in una bibliografia. |
