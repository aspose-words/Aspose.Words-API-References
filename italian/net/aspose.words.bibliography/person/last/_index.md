...
description: Gestisci i dati personali senza sforzo con la proprietà "Cognome della persona". Ottieni o imposta facilmente il cognome di una persona per una gestione semplificata dei dati.
type: docs
weight: 30
url: /it/net/aspose.words.bibliography/person/last/
---
## Person.Last property

Ottiene o imposta il cognome di una persona.
