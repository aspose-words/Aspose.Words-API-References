...
description: Scopri come gestire facilmente il secondo nome di una persona con la nostra intuitiva proprietà. Semplifica la gestione dei dati e migliora le tue applicazioni oggi stesso!
type: docs
weight: 40
url: /it/net/aspose.words.bibliography/person/middle/
---
## Person.Middle property

Ottiene o imposta il secondo nome di una persona.
