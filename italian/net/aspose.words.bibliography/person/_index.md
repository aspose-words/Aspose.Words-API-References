...
description: Scopri la classe Aspose.Words.Bibliography.Person per gestire i singoli collaboratori nelle bibliografie. Migliora l'accuratezza delle citazioni del tuo documento!
type: docs
weight: 180
url: /it/net/aspose.words.bibliography/person/
---
## Person class

Rappresenta il collaboratore della fonte bibliografica individuale (una persona).
...
| Nome | Descrizione |
| --- | --- |
| [Person](person/)(*string, string, string*) | Inizializza una nuova istanza di`Person` classe. |

## Proprietà

| Nome | Descrizione |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Ottiene o imposta il nome di una persona. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Ottiene o imposta il cognome di una persona. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Ottiene o imposta il secondo nome di una persona. |
