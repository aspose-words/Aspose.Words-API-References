...
description: Scopri la proprietà PersonCollection Count per recuperare facilmente il numero totale di individui nella tua raccolta per una gestione efficiente dei dati.
type: docs
weight: 20
url: /it/net/aspose.words.bibliography/personcollection/count/
---
## PersonCollection.Count property

Ottiene il numero di persone contenute nella raccolta.
