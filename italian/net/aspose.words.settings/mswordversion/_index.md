...
description: Scopri l'enum Aspose.Words.Settings.MsWordVersion per replicare i comportamenti di MS Word, migliorando l'elaborazione dei documenti e la compatibilità per flussi di lavoro fluidi.
type: docs
weight: 6690
...
| Word2013 | `5` | Ottimizza il comportamento di Aspose.Words per adattarlo alla versione di MS Word 2013. |
