...
description: Scopri la proprietà AlignTablesRowByRow per CompatibilityOptions. Allinea in modo indipendente le righe delle tabelle per un migliore controllo del layout e una maggiore flessibilità di progettazione.
type: docs
weight: 20
