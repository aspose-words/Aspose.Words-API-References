...
description: Ottimizza il tuo HTML con la proprietà DoNotUseHTMLParagraphAutoSpacing di CompatibilityOptions. Assicurati una spaziatura fissa tra i paragrafi per un layout più pulito!
type: docs
weight: 210
...
Utilizza la spaziatura fissa dei paragrafi per l'impostazione automatica HTML.
