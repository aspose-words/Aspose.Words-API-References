...
description: Ottimizza il tuo layout con la proprietà SuppressBottomSpacing di CompatibilityOptions, assicurando un'altezza perfetta della riga nell'ultima pagina per un aspetto curato.
type: docs
weight: 480
...
Ignora l'altezza esatta della riga per l'ultima riga della pagina.
