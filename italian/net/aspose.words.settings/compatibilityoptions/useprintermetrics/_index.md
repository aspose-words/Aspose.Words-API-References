...
description: Ottimizza la tua stampa con la proprietà UsePrinterMetrics di CompatibilityOptions per una visualizzazione accurata dei documenti. Migliora prestazioni e qualità senza sforzo!
type: docs
weight: 640
...
Utilizza le metriche della stampante per visualizzare i documenti.
...
Le metriche della stampante possono variare a seconda dei driver utilizzati. Ad esempio, "Microsoft OpenXPS Class Driver 2" e "Microsoft Print to PDF" di Windows forniscono metriche leggermente diverse. Pertanto, il layout del documento finale potrebbe cambiare se questa opzione è abilitata.
