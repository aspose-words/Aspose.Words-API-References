...
description: Migliora la visualizzazione del tuo font con la proprietà CompatibilityOptions SubFontBySize, che dà priorità alle dimensioni durante la sostituzione del font per una leggibilità ottimale.
type: docs
weight: 470
...
Aumenta la priorità della dimensione del carattere durante la sostituzione del carattere.
