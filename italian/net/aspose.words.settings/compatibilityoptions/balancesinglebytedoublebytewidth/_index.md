...
description: Ottimizza la visualizzazione del testo con la proprietà BalanceSingleByteDoubleByteWidth per un'integrazione perfetta di caratteri a byte singolo e doppio.
type: docs
weight: 70
...
Bilanciare caratteri a byte singolo e doppio byte.
