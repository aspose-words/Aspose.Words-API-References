...
description: Ottimizza i tuoi documenti con CompatibilityOptions FootnoteLayoutLikeWW8 per un posizionamento preciso delle note a piè di pagina, emulando Word 6.x/95/97 per una formattazione impeccabile.
type: docs
weight: 260
...
Emula il posizionamento delle note a piè di pagina di Word 6.x/95/97.
