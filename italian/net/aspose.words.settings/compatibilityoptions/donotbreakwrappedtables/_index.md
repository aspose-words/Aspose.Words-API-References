...
description: Scopri la proprietà DoNotBreakWrappedTables di CompatibilityOptions per impedire che le tabelle mobili si dividano tra le pagine, garantendo un layout del documento fluido.
type: docs
weight: 140
...
Non consentire alle tabelle mobili di dividersi tra le pagine.
