...
description: Scopri la proprietà DoNotVertAlignCellWithSp di CompatibilityOptions per impedire l'allineamento verticale delle celle con oggetti mobili, ottenendo layout più puliti.
type: docs
weight: 230
