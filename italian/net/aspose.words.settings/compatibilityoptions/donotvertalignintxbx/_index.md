...
description: Scopri come la proprietà DoNotVertAlignInTxbx di CompatibilityOptions migliora la formattazione della casella di testo ignorando l'allineamento verticale, per una maggiore flessibilità di progettazione.
type: docs
weight: 240
