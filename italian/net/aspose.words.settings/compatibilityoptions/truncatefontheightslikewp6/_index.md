...
description: Ottimizza senza sforzo le altezze dei caratteri con CompatibilityOptions TruncateFontHeightsLikeWP6, imitando WordPerfect 6.x per una formattazione impeccabile dei documenti.
type: docs
weight: 560
...
Emula il calcolo dell'altezza del carattere di WordPerfect 6.x.
