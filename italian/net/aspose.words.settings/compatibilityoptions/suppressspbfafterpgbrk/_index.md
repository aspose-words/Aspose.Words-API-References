...
description: Ottimizza il layout del tuo documento con CompatibilityOptions SuppressSpBfAfterPgBrk. Elimina gli spazi indesiderati dopo le interruzioni di pagina per una formattazione più pulita.
type: docs
weight: 500
...
Non usare spazi prima della prima riga dopo un'interruzione di pagina.
