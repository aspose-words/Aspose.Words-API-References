...
description: Ottimizza il layout del testo con CompatibilityOptions ApplyBreakingRules. Migliora la leggibilità utilizzando le regole di interruzione di riga legacy per etiopico e amarico.
type: docs
weight: 40
...
Usa le regole legacy per interrompere le righe in etiopico e amarico.
