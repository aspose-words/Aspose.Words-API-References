...
description: Ottimizza il tuo layout con la proprietà CompatibilityOptions SuppressSpacingAtTopOfPage. Controlla l'altezza delle righe per una visualizzazione fluida della prima riga.
type: docs
weight: 490
...
Ignora l'altezza minima della riga per la prima riga della pagina.
