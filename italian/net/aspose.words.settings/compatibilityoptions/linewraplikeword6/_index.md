...
description: Migliora la formattazione del testo dell'Asia orientale con CompatibilityOptions LineWrapLikeWord6, emulando l'interruzione di riga di Word 6.0 per una migliore leggibilità e presentazione.
type: docs
weight: 310
...
Emula l'interruzione di riga di Word 6.0 per il testo dell'Asia orientale.
