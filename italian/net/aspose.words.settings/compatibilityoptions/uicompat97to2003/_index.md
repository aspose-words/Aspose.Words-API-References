...
description: Ottimizza l'interfaccia utente con l'impostazione CompatibilityOptions UICompat97To2003. Disattiva le funzionalità non compatibili per un utilizzo ottimale di Word 97-2003. Migliora le prestazioni oggi stesso!
type: docs
weight: 570
url: /it/net/aspose.words.settings/compatibilityoptions/uicompat97to2003/
---
## CompatibilityOptions.UICompat97To2003 property

Vero per disabilitare la funzionalità dell'interfaccia utente che non è compatibile con Word97-2003. Il valore predefinito è`falso` .
...
Controlla l'impostazione di compatibilità Word97-2003 che disabilita la funzionalità dell'interfaccia utente che non è compatibile con Word97-2003. Quando`VERO` l'elemento XML 'w:uiCompat97To2003' viene scritto nella parte del pacchetto del documento '\word\settings.xml' . Il valore predefinito è`falso` . Quando impostato su`falso` , questo elemento non è scritto. Tecnicamente questa proprietà non fa parte delle opzioni di compatibilità, ma l'abbiamo inserita qui per comodità dell'API.
