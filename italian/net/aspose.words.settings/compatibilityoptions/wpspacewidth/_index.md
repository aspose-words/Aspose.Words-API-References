...
description: Scopri come la proprietà WPSpaceWidth di CompatibilityOptions ti consente di personalizzare la larghezza dello spazio come in WordPerfect 5.x per una formattazione avanzata dei documenti.
type: docs
weight: 700
