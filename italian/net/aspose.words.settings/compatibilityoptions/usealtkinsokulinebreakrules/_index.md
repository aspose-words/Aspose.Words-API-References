...
description: Migliora la formattazione del testo con UseAltKinsokuLineBreakRules di CompatibilityOptions per migliorare l'interruzione di riga in caratteri dell'Asia orientale. Ottimizza la leggibilità oggi stesso!
type: docs
weight: 600
...
Usa un set alternativo di regole di interruzione di riga dell'Asia orientale.
