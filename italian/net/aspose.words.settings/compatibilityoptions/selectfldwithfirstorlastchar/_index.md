...
description: Scopri la proprietà SelectFldWithFirstOrLastChar per CompatibilityOptions. Seleziona facilmente i campi in base al primo o all'ultimo carattere per una maggiore efficienza.
type: docs
weight: 410
...
Seleziona il campo quando viene selezionato il primo o l'ultimo carattere.
