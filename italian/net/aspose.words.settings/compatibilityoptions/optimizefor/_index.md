...
description: Migliora i tuoi documenti con il metodo OptimizeFor in CompatibilityOptions. Personalizza il comportamento di Aspose.Words per specifiche versioni di MS Word per risultati ottimali.
type: docs
weight: 720
...
Utilizzare questo metodo per impedire a MS Word di visualizzare la barra multifunzione "Modalità compatibilità" durante il caricamento del documento. (Nota che potrebbe essere necessario impostare anche l'[`Compliance`](../../../aspose.words.saving/ooxmlsaveoptions/compliance/) proprietà to Iso29500_2008_Transitional o superiore.)
