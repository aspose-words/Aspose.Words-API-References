...
description: Ottimizza il tuo layout con la proprietà CachedColBalance di CompatibilityOptions. Migliora il bilanciamento delle colonne utilizzando le informazioni sui paragrafi memorizzate nella cache per un design fluido.
type: docs
weight: 80
...
Utilizza le informazioni del paragrafo memorizzate nella cache per il bilanciamento delle colonne.
