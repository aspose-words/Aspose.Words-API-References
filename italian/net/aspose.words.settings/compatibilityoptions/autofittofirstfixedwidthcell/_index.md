...
description: Scopri come la proprietà AutofitToFirstFixedWidthCell migliora i layout delle tabelle consentendo alle colonne di superare le larghezze preferite per una visualizzazione ottimale.
type: docs
weight: 50
url: /it/net/aspose.words.settings/compatibilityoptions/autofittofirstfixedwidthcell/
---
## CompatibilityOptions.AutofitToFirstFixedWidthCell property

Consenti alle colonne della tabella di superare le larghezze preferite delle celle costituenti.
...
L'opzione si chiama "Usa regole di adattamento automatico delle tabelle di Word 2003" nell'interfaccia utente di MS Word 2013. In realtà influisce anche sul modo in cui viene calcolata la griglia per le tabelle a layout fisso (in alcuni casi).
