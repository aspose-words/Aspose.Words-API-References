...
description: Ottimizza il layout con la proprietà SuppressTopSpacing di CompatibilityOptions, ignorando le impostazioni dell'altezza della riga per ottenere un aspetto più pulito della prima pagina.
type: docs
weight: 510
...
Ignora l'altezza minima ed esatta della prima riga della pagina.
