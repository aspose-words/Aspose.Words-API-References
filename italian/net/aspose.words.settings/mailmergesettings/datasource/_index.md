...
description: Scopri come impostare la proprietà DataSource di MailMergeSettings per un'integrazione perfetta con la stampa unione. Specifica facilmente il percorso della tua origine dati per risultati ottimali!
type: docs
weight: 60
...
Specifica il percorso dell'origine dati per la stampa unione. Il valore predefinito è una stringa vuota.
