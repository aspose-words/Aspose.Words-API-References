...
Specifica la modalità di stampa del documento.
...
| --- | --- | --- |
| Normal | `0` | Stampa normale, non sono specificate più pagine. |
| MirrorMargins | `1` | Inverte i margini sinistro e destro sulle pagine affiancate. |
