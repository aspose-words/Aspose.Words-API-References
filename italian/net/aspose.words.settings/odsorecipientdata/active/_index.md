...
description: Specifica se il record dallorigine dati deve essere importato in un documento quando viene eseguita la stampa unione. Il valore predefinito èVERO .
type: docs
weight: 20
