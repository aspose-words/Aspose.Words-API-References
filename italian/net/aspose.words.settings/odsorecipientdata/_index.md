...
description: Aspose.Words.Settings.OdsoRecipientData classe. Rappresenta le informazioni su un singolo record allinterno di unorigine dati esterna che deve essere esclusa dalla stampa unione.
type: docs
weight: 5630
