...
description: Migliora senza sforzo la gestione dei tuoi dati con il metodo Add di OdsoFieldMapDataCollection, progettato per aggiungere oggetti alla tua raccolta in modo semplice.
type: docs
weight: 40
...
| --- | --- | --- |
| value | OdsoFieldMapData | L'oggetto da aggiungere. Non può essere`null`. |
