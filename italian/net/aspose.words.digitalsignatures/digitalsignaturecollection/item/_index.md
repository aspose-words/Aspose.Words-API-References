...
description: Recupera facilmente le firme dei documenti con DigitalSignatureCollection. Accedi alle firme tramite indice per una gestione semplificata dei documenti e una maggiore efficienza.
type: docs
weight: 40
...
| --- | --- |
| index | Indice della firma basato su zero. |
