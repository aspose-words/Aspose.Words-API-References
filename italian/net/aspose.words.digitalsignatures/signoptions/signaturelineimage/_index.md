...
description: Scopri la proprietà SignatureLineImage di SignOptions per migliorare le tue firme digitali con immagini personalizzate. Aumenta la professionalità del tuo brand oggi stesso!
type: docs
weight: 60
url: /it/net/aspose.words.digitalsignatures/signoptions/signaturelineimage/
---
## SignOptions.SignatureLineImage property

L'immagine che verrà mostrata in associazione[`SignatureLine`](../../../aspose.words.drawing/signatureline/) . Il valore predefinito è`null` .
