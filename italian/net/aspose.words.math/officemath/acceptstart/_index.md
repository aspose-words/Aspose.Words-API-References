...
description: Scopri il metodo AcceptStart di OfficeMath, progettato per accogliere i visitatori in modo fluido e migliorare l'esperienza di lavoro in ufficio. Aumenta la produttività oggi stesso!
type: docs
weight: 80
url: /it/net/aspose.words.math/officemath/acceptstart/
---
## OfficeMath.AcceptStart method

Accetta un visitatore per aver visitato l'inizio dell'ufficio matematica.
