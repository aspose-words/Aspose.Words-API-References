...
description: Ottiene/imposta il tipo di formato di visualizzazione di Office Math che rappresenta se unequazione viene visualizzata in linea con il testo o visualizzata su una riga separata.
type: docs
weight: 10
