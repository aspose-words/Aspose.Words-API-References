...
description: XmlMapping proprietà. Restituisce le mappature del prefisso dello spazio dei nomi XML per valutare ilXPath .
type: docs
weight: 30
...
Restituisce le mappature del prefisso dello spazio dei nomi XML per valutare il[`XPath`](../xpath/) .
...
Specifica la serie di mappature dei prefissi, che devono essere utilizzate per interpretare l'espressione XPath quando l'espressione XPath viene valutata rispetto alle parti di dati XML personalizzate nel documento.
