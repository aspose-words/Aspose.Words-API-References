...
description: XmlMapping proprietà. Restituisce lespressione XPath che viene valutata per trovare il nodo XML personalizzato mappato al tag del documento strutturato padre.
type: docs
weight: 50
