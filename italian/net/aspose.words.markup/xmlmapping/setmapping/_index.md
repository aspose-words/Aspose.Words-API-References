...
description: XmlMapping SetMapping metodo. Imposta una mappatura tra il tag del documento strutturato principale e un nodo XML di una parte di dati XML personalizzata in C#.
type: docs
weight: 70
...
Imposta una mappatura tra il tag del documento strutturato principale e un nodo XML di una parte di dati XML personalizzata.
...
| --- | --- | --- |
| customXmlPart | CustomXmlPart | Una parte di dati XML personalizzata a cui eseguire il mapping. |
| xPath | String | Un'espressione XPath per trovare il nodo XML. |
| prefixMapping | String | Mapping dei prefissi dello spazio dei nomi XML per valutare XPath. |

### Valore di ritorno

Un flag che indica se il tag del documento strutturato padre è stato mappato correttamente al nodo XML.
