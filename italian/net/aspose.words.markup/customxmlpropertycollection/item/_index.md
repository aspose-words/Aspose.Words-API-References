...
description: Accedi facilmente a proprietà specifiche con CustomXmlPropertyCollection. Recupera gli elementi per nome per una gestione semplificata dei dati e una maggiore produttività.
type: docs
weight: 20
...
| --- | --- |
| name | Nome della proprietà da individuare, con distinzione tra maiuscole e minuscole. |
...
| Parametro | Descrizione |
| --- | --- |
| index | Indice della proprietà a base zero. |
