...
description: Scopri come il metodo SmartTag AcceptEnd migliora il coinvolgimento dei visitatori gestendo in modo fluido le esperienze di fine visita. Aumenta l'interazione del tuo sito oggi stesso!
type: docs
weight: 70
url: /it/net/aspose.words.markup/smarttag/acceptend/
---
## SmartTag.AcceptEnd method

Accetta un visitatore per aver visitato la fine dello SmartTag.
