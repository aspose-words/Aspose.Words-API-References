...
description: Scopri la proprietà CustomXmlPart Schemas per gestire facilmente gli schemi XML collegati alle tue parti XML personalizzate, migliorando l'organizzazione e l'efficienza dei dati.
type: docs
weight: 50
url: /it/net/aspose.words.markup/customxmlpart/schemas/
---
## CustomXmlPart.Schemas property

Specifica il set di schemi XML associati a questa parte XML personalizzata.
