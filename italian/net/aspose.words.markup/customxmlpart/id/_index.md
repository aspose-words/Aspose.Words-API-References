...
description: CustomXmlPart Id proprietà. Ottiene o imposta la stringa che identifica questa parte XML personalizzata allinterno di un documento OOXML in C#.
type: docs
weight: 40
