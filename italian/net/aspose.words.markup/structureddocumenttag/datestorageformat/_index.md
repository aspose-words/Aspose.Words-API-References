...
description: Ottiene/imposta il formato in cui viene archiviata la data per un SDT di data quando il SDT è associato a un nodo XML nellarchivio dati del documento. Il valore predefinito èDateTime
type: docs
weight: 110
