...
description: StructuredDocumentTag proprietà. Specifica la data e lora complete immesse per lultima volta SDT .
type: docs
weight: 130
...
Specifica la data e l'ora complete immesse per l'ultima volta **SDT** .
