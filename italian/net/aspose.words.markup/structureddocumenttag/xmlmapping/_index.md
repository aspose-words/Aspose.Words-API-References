...
description: StructuredDocumentTag proprietà. Ottiene un oggetto che rappresenta il mapping di questo tag del documento strutturato ai dati XML in una parte XML personalizzata del documento corrente.
type: docs
weight: 310
