...
description: Scopri il metodo AcceptStart di StructuredDocumentTag per migliorare la gestione dei tuoi documenti. Semplifica le interazioni con i visitatori per prestazioni ottimali!
type: docs
weight: 350
url: /it/net/aspose.words.markup/structureddocumenttag/acceptstart/
---
## StructuredDocumentTag.AcceptStart method

Accetta un visitatore per aver visitato l'inizio dello StructuredDocumentTag.
