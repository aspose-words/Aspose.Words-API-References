...
description: Aspose.Words.Markup.StructuredDocumentTag classe. Rappresenta un tag di documento strutturato SDT o controllo del contenuto in un documento in C#.
type: docs
weight: 4060
...
| Nome | Descrizione |
| --- | --- |
| [StructuredDocumentTag](structureddocumenttag/)(*[DocumentBase](../../aspose.words/documentbase/), [SdtType](../sdttype/), [MarkupLevel](../markuplevel/)*) | Inizializza una nuova istanza di**Tag documento strutturato** classe. |
