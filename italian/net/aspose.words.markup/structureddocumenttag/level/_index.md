...
description: Scopri la proprietà Level di StructuredDocumentTag per identificare in modo efficiente la sua posizione nella struttura del documento, migliorando così le tue competenze di gestione dei documenti.
type: docs
weight: 170
...
Ottiene il livello a cui questo**SDT** si verifica nell'albero del documento.
