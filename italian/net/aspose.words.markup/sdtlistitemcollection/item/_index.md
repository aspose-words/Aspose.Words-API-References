...
description: Accedi facilmente agli oggetti SdtListItem con la proprietà Item di SdtListItemCollection. Recupera gli elementi utilizzando il loro indice a base zero per una gestione dei dati fluida.
type: docs
weight: 20
...
Restituisce un[`SdtListItem`](../../sdtlistitem/) oggetto dato il suo indice a base zero nella raccolta.
