...
description: Scopri la classe Aspose.Words.Markup.CustomXmlPartCollection, la soluzione ideale per gestire parti XML personalizzate in modo efficiente e senza sforzi.
type: docs
weight: 4620
...
Rappresenta una raccolta di parti XML personalizzate. Gli elementi sono[`CustomXmlPart`](../customxmlpart/) oggetti.
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.words.markup/customxmlpartcollection/add/#add_1)(*[CustomXmlPart](../customxmlpart/)*) | Aggiunge un elemento alla collezione. |
...
| [GetById](../../aspose.words.markup/customxmlpartcollection/getbyid/)(*string*) | Trova e restituisce una parte XML personalizzata tramite il suo identificatore. |
| [GetEnumerator](../../aspose.words.markup/customxmlpartcollection/getenumerator/)() | Restituisce un oggetto enumeratore che può essere utilizzato per scorrere tutti gli elementi nella raccolta. |
| [RemoveAt](../../aspose.words.markup/customxmlpartcollection/removeat/)(*int*) | Rimuove un elemento all'indice specificato. |

## Osservazioni

Normalmente non è necessario creare istanze di questa classe. È possibile accedere ai dati XML personalizzati data memorizzati in un documento tramite[`CustomXmlParts`](../../aspose.words/document/customxmlparts/) proprietà.
