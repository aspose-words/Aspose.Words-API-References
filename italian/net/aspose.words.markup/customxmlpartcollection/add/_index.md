...
description: Scopri il metodo CustomXmlPartCollection Add per migliorare senza sforzo le tue raccolte aggiungendo nuovi elementi in modo semplice ed efficiente.
type: docs
weight: 40
url: /it/net/aspose.words.markup/customxmlpartcollection/add/
---
...
| --- | --- | --- |
| part | CustomXmlPart | La parte XML personalizzata da aggiungere. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| id | String | Identificatore di una nuova parte XML personalizzata. |
| xml | String | Dati XML della parte. |
