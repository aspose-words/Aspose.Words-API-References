...
description: Scopri il metodo GetById di CustomXmlPartCollection per recuperare senza sforzo parti XML personalizzate tramite i loro identificatori univoci per una migliore gestione dei dati.
type: docs
weight: 70
url: /it/net/aspose.words.markup/customxmlpartcollection/getbyid/
---
## CustomXmlPartCollection.GetById method

Trova e restituisce una parte XML personalizzata tramite il suo identificatore.
...
| --- | --- | --- |
| id | String | Stringa con distinzione tra maiuscole e minuscole che identifica la parte XML personalizzata. |

### Valore di ritorno

Resi`null` se non viene trovata una parte XML personalizzata con l'identificatore specificato.
