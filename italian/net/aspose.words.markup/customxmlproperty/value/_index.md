...
description: Scopri la funzionalità CustomXmlProperty Value per gestire facilmente gli attributi XML personalizzati e le proprietà degli smart tag per un controllo dati avanzato.
type: docs
weight: 40
...
Ottiene o imposta il valore dell'attributo XML personalizzato o della proprietà dello smart tag.
