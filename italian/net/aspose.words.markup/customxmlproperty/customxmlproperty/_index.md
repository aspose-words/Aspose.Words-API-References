...
description: Scopri il costruttore CustomXmlProperty. Crea e inizializza facilmente nuove istanze per una gestione ottimale delle proprietà XML nei tuoi progetti.
type: docs
weight: 10
url: /it/net/aspose.words.markup/customxmlproperty/customxmlproperty/
---
...
| --- | --- | --- |
| name | String | Il nome della proprietà. Non può essere`null`. |
| uri | String | L'URI dello spazio dei nomi della proprietà. Non può essere`null`. |
| value | String | Il valore della proprietà. Non può essere`null`. |
