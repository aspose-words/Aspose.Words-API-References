...
description: Regola la proprietà ChartDataLabel Left per controllare il posizionamento delle etichette dati sul grafico. Migliora la chiarezza e la presentazione con impostazioni di distanza precise.
type: docs
weight: 60
url: /it/net/aspose.words.drawing.charts/chartdatalabel/left/
---
## ChartDataLabel.Left property

Ottiene o imposta la distanza dell'etichetta dati in punti dal bordo sinistro del grafico o dalla posizione specificata dal suo[`Position`](../position/) proprietà, a seconda del valore della[`LeftMode`](../leftmode/) Proprietà .
