...
description: Migliora i tuoi grafici con la proprietà ChartDataLabel ShowCategoryName. Visualizza facilmente i nomi delle categorie sulle etichette dati per informazioni più chiare e una visualizzazione migliore.
type: docs
weight: 140
...
Consente di specificare se il nome della categoria deve essere visualizzato per le etichette dati su un grafico. Il valore predefinito è `falso` .
