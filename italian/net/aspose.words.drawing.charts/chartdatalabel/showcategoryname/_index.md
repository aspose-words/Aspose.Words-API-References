...
description: Consente di specificare se il nome della categoria deve essere visualizzato per le etichette dei dati su un grafico. Il valore predefinito è false.
type: docs
weight: 70
