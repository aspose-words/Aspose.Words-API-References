...
description: Abilita la visualizzazione percentuale sulle etichette dei dati dei grafici con la proprietà ChartDataLabel ShowPercentage. Migliora la chiarezza e la comprensione dei tuoi dati visivi!
type: docs
weight: 180
...
Consente di specificare se il valore percentuale deve essere visualizzato per le etichette dati su un grafico. Il valore predefinito è `falso` .
