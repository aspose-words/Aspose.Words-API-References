...
description: Scopri la proprietà ChartDataLabel Separator per personalizzare le etichette dati del tuo grafico. Imposta facilmente separatori di stringa per una visualizzazione e informazioni più chiare.
type: docs
weight: 120
...
Ottiene o imposta il separatore di stringa utilizzato per le etichette dati su un grafico. Il valore predefinito è una virgola, ad eccezione dei grafici a torta che mostrano solo il nome della categoria e la percentuale, in tal caso deve essere utilizzata un'interruzione di riga .
