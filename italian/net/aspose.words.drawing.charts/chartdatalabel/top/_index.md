...
description: Regola la proprietà ChartDataLabel Top per controllare il posizionamento delle etichette dati e migliorare la chiarezza del grafico. Ottimizza la rappresentazione visiva dei tuoi dati senza sforzo!
type: docs
weight: 210
url: /it/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

Ottiene o imposta la distanza dell'etichetta dati in punti dal bordo superiore del grafico o dalla posizione specificata dal suo[`Position`](../position/) proprietà, a seconda del valore della[`TopMode`](../topmode/) Proprietà .
