...
description: Scopri la proprietà ChartDataLabel TopMode per personalizzare il posizionamento delle etichette dati sui tuoi grafici. Migliora la chiarezza e la precisione delle tue presentazioni visive di dati!
type: docs
weight: 220
url: /it/net/aspose.words.drawing.charts/chartdatalabel/topmode/
---
## ChartDataLabel.TopMode property

Ottiene o imposta la modalità di interpretazione del[`Top`](../top/) valore della proprietà: se imposta la posizione dell'etichetta dati dal bordo superiore del grafico o dalla posizione specificata dal suo[`Position`](../position/) Proprietà .
