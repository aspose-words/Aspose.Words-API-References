...
description: Scopri la proprietà IsAutoSpacing di AxisTickLabels per gestire senza sforzo gli intervalli automatici delle etichette di spunta per una visualizzazione precisa dei dati nei tuoi progetti.
type: docs
weight: 30
url: /it/net/aspose.words.drawing.charts/axisticklabels/isautospacing/
---
## AxisTickLabels.IsAutoSpacing property

Ottiene o imposta un flag che indica se utilizzare l'intervallo automatico per disegnare le etichette di spunta.
...
La proprietà ha effetto sugli assi delle categorie di testo e delle serie. Non è supportata dai nuovi grafici di MS Office 2016 .
