...
description: Esplora la proprietà Chart AxisX per un controllo completo sull'asse X principale del tuo grafico, migliorando la visualizzazione dei dati e le informazioni dettagliate.
type: docs
weight: 20
url: /it/net/aspose.words.drawing.charts/chart/axisx/
---
## Chart.AxisX property

Fornisce l'accesso alle proprietà dell'asse X primario del grafico.
