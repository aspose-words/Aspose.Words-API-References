...
description: Chart AxisY proprietà. Fornisce laccesso alle proprietà dellasse Y del grafico in C#.
type: docs
weight: 30
...
Fornisce l'accesso alle proprietà dell'asse Y del grafico.
