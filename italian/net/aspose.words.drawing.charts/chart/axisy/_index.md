...
description: Esplora la proprietà Asse Y del grafico per accedere facilmente e personalizzare l'asse Y principale del grafico, ottenendo così una visualizzazione dei dati e approfondimenti migliori.
type: docs
weight: 30
...
Fornisce l'accesso alle proprietà dell'asse Y primario del grafico.
