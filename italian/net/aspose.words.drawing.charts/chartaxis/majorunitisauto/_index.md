...
description: Scopri la proprietà ChartAxis MajorUnitIsAuto e controlla facilmente la spaziatura dei segni di spunta principali per una maggiore chiarezza e precisione dei grafici nelle visualizzazioni dei dati.
type: docs
weight: 140
...
Ottiene o imposta un flag che indica se deve essere utilizzata la distanza predefinita tra i segni di graduazione principali.
