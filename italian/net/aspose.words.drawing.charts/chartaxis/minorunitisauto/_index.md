...
description: ChartAxis proprietà. Ottiene o imposta un flag che indica se deve essere utilizzata la distanza predefinita tra segni di graduazione minori.
type: docs
weight: 150
...
Ottiene o imposta un flag che indica se deve essere utilizzata la distanza predefinita tra segni di graduazione minori.
...
La proprietà ha effetto per la categoria temporale e gli assi dei valori.
