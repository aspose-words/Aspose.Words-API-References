...
description: ChartAxis proprietà. Ottiene o imposta un flag che indica se deve essere utilizzata la distanza predefinita tra i segni di graduazione minori.
type: docs
weight: 170
