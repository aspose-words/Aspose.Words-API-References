...
description: Scopri la proprietà ChartAxis CategoryType per personalizzare facilmente l'asse delle categorie, ottenendo così una migliore visualizzazione dei dati e una maggiore chiarezza dei grafici.
type: docs
weight: 30
url: /it/net/aspose.words.drawing.charts/chartaxis/categorytype/
---
## ChartAxis.CategoryType property

Ottiene o imposta il tipo dell'asse della categoria.
...
Solo categorie di testo (Category sono consentiti nei nuovi grafici di MS Office 2016.
