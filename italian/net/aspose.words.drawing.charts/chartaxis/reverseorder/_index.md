...
description: ChartAxis proprietà. Restituisce o imposta un flag che indica se i valori dellasse devono essere visualizzati in ordine inverso cioè da max a min.
type: docs
weight: 180
