...
description: ChartAxis MinorTickMark proprietà. Restituisce o imposta i segni di graduazione minori per lasse in C#.
type: docs
weight: 150
...
Restituisce o imposta i segni di graduazione minori per l'asse.
