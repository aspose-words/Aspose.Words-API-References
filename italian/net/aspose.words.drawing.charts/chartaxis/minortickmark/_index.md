...
description: Personalizza il tuo ChartAxis con la proprietà MinorTickMark per migliorare la precisione degli assi e la visualizzazione dei dati. Imposta o restituisci facilmente i segni di spunta minori!
type: docs
weight: 160
url: /it/net/aspose.words.drawing.charts/chartaxis/minortickmark/
---
## ChartAxis.MinorTickMark property

Restituisce o imposta i segni di spunta minori per l'asse.
