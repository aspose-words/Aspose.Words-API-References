...
description: Scopri la proprietà ChartAxis MinorUnitScale per personalizzare facilmente i segni di spunta minori sull'asse delle categorie temporali per una migliore visualizzazione dei dati.
type: docs
weight: 190
...
Restituisce o imposta il valore della scala per i segni di graduazione minori sull'asse della categoria temporale.
