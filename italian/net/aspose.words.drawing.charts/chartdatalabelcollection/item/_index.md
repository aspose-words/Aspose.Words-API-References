...
description: Accedi facilmente a ChartDataLabel specifiche con la proprietà Item in ChartDataLabelCollection. Migliora la tua visualizzazione dati oggi stesso!
type: docs
weight: 40
...
Restituisce[`ChartDataLabel`](../../chartdatalabel/) per l'indice specificato.
