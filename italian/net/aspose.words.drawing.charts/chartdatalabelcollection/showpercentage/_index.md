...
description: Consente di specificare se il valore percentuale deve essere visualizzato per le etichette dati dellintera serie. Il valore di default è falso . Si applica solo ai grafici a torta.
type: docs
weight: 100
