...
description: ChartDataLabelCollection proprietà. Consente di specificare se il nome della categoria deve essere visualizzato per le etichette dati dellintera serie. Il valore predefinito è falso .
type: docs
weight: 60
