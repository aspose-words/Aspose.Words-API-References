...
description: ChartDataLabelCollection NumberFormat proprietà. Ottiene unChartNumberFormat istanza che consente di impostare il formato numerico per le etichette dati dell intera serie in C#.
type: docs
weight: 50
