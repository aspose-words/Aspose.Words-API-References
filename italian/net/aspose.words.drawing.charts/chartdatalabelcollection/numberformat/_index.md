...
description: ChartDataLabelCollection proprietà. Ottiene unChartNumberFormat istanza che consente di impostare il formato numerico per le etichette dati dell intera serie.
type: docs
weight: 50
