...
description: Restituisce o imposta un valore booleano per indicare il comportamento di visualizzazione del nome della serie per le etichette dei dati dellintera serie.  Veroper mostrare il nome della serie. Falso nascondere. Per impostazione predefinita falso .
type: docs
weight: 110
