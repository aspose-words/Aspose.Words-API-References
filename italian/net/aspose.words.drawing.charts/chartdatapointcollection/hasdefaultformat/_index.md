...
description: Scopri se il punto dati in un indice specifico in ChartDataPointCollection utilizza il formato predefinito. Migliora la tua visualizzazione dati oggi stesso!
type: docs
weight: 60
url: /it/net/aspose.words.drawing.charts/chartdatapointcollection/hasdefaultformat/
---
## ChartDataPointCollection.HasDefaultFormat method

Ottiene un flag che indica se il punto dati all'indice specificato ha un formato predefinito.
