...
description: Ottiene o imposta il nome della serie se il nome non è impostato in modo esplicito viene generato utilizzando index. Per impostazione predefinita restituisce Series più un indice basato.
type: docs
weight: 100
