...
description: Scopri la proprietà Nome ChartSeries, gestisci facilmente i nomi delle serie, genera automaticamente gli indici e migliora la visualizzazione dei dati senza sforzo.
type: docs
weight: 110
...
Ottiene o imposta il nome della serie, se il nome non è impostato esplicitamente viene generato utilizzando l'indice. Per impostazione predefinita, restituisce la serie più un indice basato su.
