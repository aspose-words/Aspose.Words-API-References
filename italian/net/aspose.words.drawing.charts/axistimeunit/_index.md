...
| --- | --- | --- |
| Automatic | `0` | Specifica che l'unità non è stata impostata esplicitamente e deve essere utilizzato il valore predefinito. |
| Days | `1` | Specifica che i dati del grafico verranno visualizzati in giorni. |
