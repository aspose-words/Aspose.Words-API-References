...
description: Scopri la proprietà AxisBound ValueAsDate, che restituisce in modo efficiente i valori associati agli assi come datetime per una visualizzazione e un'analisi dei dati ottimizzate.
type: docs
weight: 40
