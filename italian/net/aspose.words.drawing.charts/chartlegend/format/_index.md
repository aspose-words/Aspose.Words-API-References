...
description: Scopri la proprietà ChartLegend Format per personalizzare facilmente gli stili di riempimento e linea della legenda, migliorando la tua esperienza di visualizzazione dei dati.
type: docs
weight: 20
url: /it/net/aspose.words.drawing.charts/chartlegend/format/
---
## ChartLegend.Format property

Fornisce accesso al riempimento e alla formattazione delle linee della legenda.
