...
description: AxisDisplayUnit proprietà. Ottiene o imposta un divisore definito dallutente per ridimensionare le unità di visualizzazione sullasse dei valori.
type: docs
weight: 20
...
L'impostazione di questa proprietà imposta il[`Unit`](../unit/) proprietà a Custom.
