...
| Nome | Descrizione |
| --- | --- |
| [DateTimeValue](../../aspose.words.drawing.charts/chartxvalue/datetimevalue/) { get; } | Ottiene il valore data/ora memorizzato. |
...
| [StringValue](../../aspose.words.drawing.charts/chartxvalue/stringvalue/) { get; } | Ottiene il valore della stringa memorizzato. |
...
Tutti i valori X diversi da null di una serie di grafici devono essere uguali[`ChartXValueType`](../chartxvaluetype/) tipo.
