...
description: "Specifica come i valori u200bu200bche specificano la posizione di un'etichetta dati - le proprietà ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble e ChartDataLabel.getTop / ChartDataLabel.setTopdouble - vengono interpretati in Java."
type: docs
weight: 73
url: /it/java/com.aspose.words/chartdatalabellocationmode/
---
...
Specifica come i valori \\u200b\\u200bche specificano la posizione di un'etichetta dati - le proprietà [ChartDataLabel.getLeft()](../../com.aspose.words/chartdatalabel/#getLeft) / [ChartDataLabel.setLeft(double)](../../com.aspose.words/chartdatalabel/#setLeft-double) e [ChartDataLabel.getTop()](../../com.aspose.words/chartdatalabel/#getTop) / [ChartDataLabel.setTop(double)](../../com.aspose.words/chartdatalabel/#setTop-double) - vengono interpretate.
...
| Campo | Descrizione |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | La posizione di un'etichetta dati è specificata usando coordinate assolute, a partire dall'angolo superiore sinistro di un grafico. |
| [OFFSET](#OFFSET) | La posizione di un'etichetta dati è specificata mediante uno spostamento dalla posizione definita dalla sua proprietà [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int). |
| [length](#length) |  |
## Metodi
...
La posizione di un'etichetta dati è specificata usando coordinate assolute, a partire dall'angolo superiore sinistro di un grafico.
...
La posizione di un'etichetta dati è specificata mediante uno spostamento dalla posizione definita dalla sua proprietà [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int).
