...
description: "Fornisce metodi per renderizzare un singolo OfficeMath in un'immagine raster o vettoriale o in un oggetto Graphics in Java."
type: docs
weight: 499
url: /it/java/com.aspose.words/officemathrenderer/
---
...
Fornisce metodi per renderizzare un singolo [OfficeMath](../../com.aspose.words/officemath/) in un'immagine raster o vettoriale o in un oggetto Graphics.

Per saperne di più, visita l'articolo di documentazione [ Working with OfficeMath ][Working with OfficeMath].
...
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | Inizializza una nuova istanza di questa classe. |
## Metodi
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | L'oggetto [OfficeMath](../../com.aspose.words/officemath/) che desideri renderizzare. |
