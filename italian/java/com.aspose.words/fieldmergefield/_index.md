...
description: "Implementa il campo MERGEFIELD in Java."
type: docs
weight: 258
url: /it/java/com.aspose.words/fieldmergefield/
---
...
Recupera il nome di un campo dati all'interno dei caratteri di unione in un documento principale di stampa unione. Quando il documento principale viene unito con la fonte dati selezionata, le informazioni del campo dati specificato vengono inserite al posto del campo di unione.
...
| [getFieldName()](#getFieldName) | Ottiene il nome di un campo dati. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | Restituisce solo il nome del campo dati. |
...
| [getTextAfter()](#getTextAfter) | Ottiene il testo da inserire dopo il campo se il campo non è vuoto. |
| [getTextBefore()](#getTextBefore) | Ottiene il testo da inserire prima del campo se il campo non è vuoto. |
...
| [isMapped()](#isMapped) | Ottiene se questo campo è un campo mappato. |
| [isMapped(boolean value)](#isMapped-boolean) | Imposta se questo campo è un campo mappato. |
| [isVerticalFormatting()](#isVerticalFormatting) | Ottiene se abilitare la conversione dei caratteri per la formattazione verticale. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | Imposta se abilitare la conversione dei caratteri per la formattazione verticale. |
| [remove()](#remove) | Rimuove il campo dal documento. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | Imposta il nome di un campo dati. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | Imposta il testo da inserire dopo il campo se il campo non è vuoto. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | Imposta il testo da inserire prima del campo se il campo non è vuoto. |
...
Ottiene il nome di un campo dati.
...
**Returns:**
java.lang.String - Il nome di un campo dati.
...
Restituisce solo il nome del campo dati. Qualsiasi prefisso viene rimosso nella proprietà prefix.
...
**Returns:**
java.lang.String - Solo il nome del campo dati.
### getFormat() {#getFormat}
```
...
Ottiene il testo da inserire dopo il campo se il campo non è vuoto.
...
**Returns:**
java.lang.String - Il testo da inserire dopo il campo se il campo non è vuoto.
...
Ottiene il testo da inserire prima del campo se il campo non è vuoto.
...
**Returns:**
java.lang.String - Il testo da inserire prima del campo se il campo non è vuoto.
### getType() {#getType}
```
public int getType()
```
...
Ottiene se questo campo è un campo mappato.
...
**Returns:**
boolean - Se questo campo è un campo mappato.
...
Imposta se questo campo è un campo mappato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se questo campo è un campo mappato. |
...
Ottiene se abilitare la conversione dei caratteri per la formattazione verticale.
...
**Returns:**
boolean - Se abilitare la conversione dei caratteri per la formattazione verticale.
...
Imposta se abilitare la conversione dei caratteri per la formattazione verticale.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se abilitare la conversione dei caratteri per la formattazione verticale. |
...
Imposta il nome di un campo dati.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome di un campo dati. |
...
Imposta il testo da inserire dopo il campo se il campo non è vuoto.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo da inserire dopo il campo se il campo non è vuoto. |
...
Imposta il testo da inserire prima del campo se il campo non è vuoto.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo da inserire prima del campo se il campo non è vuoto. |
