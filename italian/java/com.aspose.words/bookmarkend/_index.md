...
description: "Rappresenta la fine di un segnalibro in un documento Word in Java."
type: docs
weight: 43
url: /it/java/com.aspose.words/bookmarkend/
---
...
Rappresenta la fine di un segnalibro in un documento Word.
...
Utilizza la classe [Bookmark](../../com.aspose.words/bookmark/) come una "facciata" per lavorare con un segnalibro come un unico oggetto.
...
| --- | --- |
| [BookmarkEnd(DocumentBase doc, String name)](#BookmarkEnd-com.aspose.words.DocumentBase-java.lang.String) | Inizializza una nuova istanza della classe [BookmarkEnd](../../com.aspose.words/bookmarkend/). |
## Metodi
...
| [getNodeType()](#getNodeType) | Restituisce [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). |
...
Inizializza una nuova istanza della classe [BookmarkEnd](../../com.aspose.words/bookmarkend/).
...
Chiama [DocumentVisitor.visitBookmarkEnd(com.aspose.words.BookmarkEnd)](../../com.aspose.words/documentvisitor/\#visitBookmarkEnd-com.aspose.words.BookmarkEnd).
...
Restituisce [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END).
...
**Returns:**
int - [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). Il valore restituito è una delle costanti [NodeType](../../com.aspose.words/nodetype/).
