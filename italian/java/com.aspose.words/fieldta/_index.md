...
description: "Implementa il campo TA in Java."
type: docs
weight: 292
url: /it/java/com.aspose.words/fieldta/
---
...
Definisce il testo e il numero di pagina per una voce della tabella delle autorità, che è utilizzata da un campo TOA.
...
| [getEntryCategory()](#getEntryCategory) | Ottiene la categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie. |
...
| [getLongCitation()](#getLongCitation) | Ottiene la citazione lunga per la voce. |
...
| [getShortCitation()](#getShortCitation) | Ottiene la citazione breve per la voce. |
...
| [isBold()](#isBold) | Ottiene se applicare la formattazione grassetto al numero di pagina per la voce. |
| [isBold(boolean value)](#isBold-boolean) | Imposta se applicare la formattazione grassetto al numero di pagina per la voce. |
...
| [isItalic()](#isItalic) | Ottiene se applicare la formattazione corsivo al numero di pagina per la voce. |
| [isItalic(boolean value)](#isItalic-boolean) | Imposta se applicare la formattazione corsivo al numero di pagina per la voce. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Imposta la categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String) | Imposta la citazione lunga per la voce. |
...
| [setShortCitation(String value)](#setShortCitation-java.lang.String) | Imposta la citazione breve per la voce. |
...
Ottiene la categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie.
...
**Returns:**
java.lang.String - La categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie.
...
Ottiene la citazione lunga per la voce.
...
**Returns:**
java.lang.String - La citazione lunga per la voce.
...
Ottiene la citazione breve per la voce.
...
**Returns:**
java.lang.String - La citazione breve per la voce.
### getStart() {#getStart}
```
...
Ottiene se applicare la formattazione grassetto al numero di pagina per la voce.
...
**Returns:**
boolean - Se applicare la formattazione grassetto al numero di pagina per la voce.
...
Imposta se applicare la formattazione grassetto al numero di pagina per la voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se applicare la formattazione grassetto al numero di pagina per la voce. |
...
Ottiene se applicare la formattazione corsivo al numero di pagina per la voce.
...
**Returns:**
boolean - Se applicare la formattazione corsivo al numero di pagina per la voce.
...
Imposta se applicare la formattazione corsivo al numero di pagina per la voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se applicare la formattazione corsivo al numero di pagina per la voce. |
...
Imposta la categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La categoria di voce integrale, che è un numero che corrisponde all'ordine delle categorie. |
...
Imposta la citazione lunga per la voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La citazione lunga per la voce. |
...
Imposta la citazione breve per la voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La citazione breve per la voce. |
