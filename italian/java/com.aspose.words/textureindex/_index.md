...
description: "Specifica la texture di ombreggiatura in Java."
type: docs
weight: 681
url: /it/java/com.aspose.words/textureindex/
---
...
Specifica la texture di ombreggiatura.
...
| [TEXTURE_NIL](#TEXTURE-NIL) | Specifica che non deve esserci alcun motivo utilizzato nella regione ombreggiata corrente (ad es. |
...
Specifica che non deve esserci alcun motivo utilizzato nella regione ombreggiata corrente (ad es. il motivo deve essere un riempimento completo con il colore di sfondo).
