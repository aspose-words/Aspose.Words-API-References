...
description: "Stile di unione delle linee in Java."
type: docs
weight: 407
url: /it/java/com.aspose.words/joinstyle/
---
...
| Campo | Descrizione |
| --- | --- |
| [BEVEL](#BEVEL) | Unisci i bordi con una linea retta. |
| [MITER](#MITER) | Estendi i bordi finché non si uniscono. |
| [ROUND](#ROUND) | Disegna un arco tra i due bordi. |
| [length](#length) |  |
## Metodi
...
Unisci i bordi con una linea retta.
...
Estendi i bordi finché non si uniscono.
...
Disegna un arco tra i due bordi.
