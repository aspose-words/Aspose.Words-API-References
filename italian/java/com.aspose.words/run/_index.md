...
description: "Rappresenta una sequenza di caratteri con la stessa formattazione del carattere in Java."
type: docs
weight: 593
url: /it/java/com.aspose.words/run/
---
...
Rappresenta una sequenza di caratteri con la stessa formattazione del carattere.
...
| --- | --- |
| [Run(DocumentBase doc)](#Run-com.aspose.words.DocumentBase) | Inizializza una nuova istanza della classe [Run](../../com.aspose.words/run/). |
| [Run(DocumentBase doc, String text)](#Run-com.aspose.words.DocumentBase-java.lang.String) | Inizializza una nuova istanza della classe **Run**. |
## Metodi
...
| [getNodeType()](#getNodeType) | Restituisce [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN). |
...
| [getPhoneticGuide()](#getPhoneticGuide) | Ottiene un oggetto [getPhoneticGuide()](../../com.aspose.words/run/\#getPhoneticGuide). |
...
| [getText()](#getText) | Ottiene il testo della sequenza. |
...
| [isPhoneticGuide()](#isPhoneticGuide) | Ottiene un valore booleano che indica se la sequenza è una guida fonetica. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo della sequenza. |
| [toString()](#toString) |  |
...
Inizializza una nuova istanza della classe [Run](../../com.aspose.words/run/).

 **Remarks:** 

Quando [Run](../../com.aspose.words/run/) viene creato, appartiene al documento specificato, ma non è ancora parte del documento e [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) è null.

Per aggiungere [Run](../../com.aspose.words/run/) al documento, usa [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertAfter-com.aspose.words.Node--com.aspose.words.Node) o [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertBefore-com.aspose.words.Node--com.aspose.words.Node) sul paragrafo in cui desideri inserire la sequenza.
...
Inizializza una nuova istanza della classe **Run**.
...
| --- | --- | --- |
| doc | [DocumentBase](../../com.aspose.words/documentbase/) | Il documento proprietario. |
| text | java.lang.String | Il testo della sequenza. |
...
Chiama [DocumentVisitor.visitRun(com.aspose.words.Run)](../../com.aspose.words/documentvisitor/\#visitRun-com.aspose.words.Run).
...
Restituisce [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN).
...
**Returns:**
int - [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN). Il valore restituito è una delle costanti di [NodeType](../../com.aspose.words/nodetype/).
...
Ottiene un oggetto [getPhoneticGuide()](../../com.aspose.words/run/\#getPhoneticGuide).
...
Ottiene il testo della sequenza.
...
**Returns:**
java.lang.String - Il testo del run.
...
Ottiene un valore booleano che indica se la sequenza è una guida fonetica.
...
**Returns:**
boolean - Un valore booleano che indica se il run è una guida fonetica.
...
Imposta il testo della sequenza.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo della sequenza. |
