...
description: "Implementa il campo DOCVARIABLE in Java."
type: docs
weight: 225
url: /it/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | Ottiene il nome della variabile di documento da recuperare. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Imposta il nome della variabile di documento da recuperare. |
...
Ottiene il nome della variabile di documento da recuperare.
...
**Returns:**
java.lang.String - Il nome della variabile di documento da recuperare.
### isDirty() {#isDirty}
```
...
Imposta il nome della variabile di documento da recuperare.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome della variabile di documento da recuperare. |
