...
description: "Implementa il campo LISTNUM in Java."
type: docs
weight: 255
url: /it/java/com.aspose.words/fieldlistnum/
---
...
| [getListLevel()](#getListLevel) | Ottiene il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo. |
| [getListName()](#getListName) | Ottiene il nome della definizione di numerazione astratta utilizzata per la numerazione. |
...
| [getStartingNumber()](#getStartingNumber) | Ottiene il valore iniziale per questo campo. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Ottiene il tipo di campo di Microsoft Word. |
| [hasListName()](#hasListName) | Restituisce un valore che indica se il nome di una definizione di numerazione astratta è fornito dal codice del campo. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | Imposta il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo. |
| [setListName(String value)](#setListName-java.lang.String) | Imposta il nome della definizione di numerazione astratta utilizzata per la numerazione. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | Imposta il valore iniziale per questo campo. |
...
Ottiene il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo.
...
**Returns:**
java.lang.String - Il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo.
...
Ottiene il nome della definizione di numerazione astratta utilizzata per la numerazione.
...
**Returns:**
java.lang.String - Il nome della definizione di numerazione astratta utilizzata per la numerazione.
...
Ottiene il valore iniziale per questo campo.
...
**Returns:**
java.lang.String - Il valore iniziale per questo campo.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
**Returns:**
boolean - Un valore che indica se il nome di una definizione di numerazione astratta è fornito dal codice del campo.
### isDirty() {#isDirty}
```
...
Imposta il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il livello nell'elenco, sovrascrivendo il comportamento predefinito del campo. |
...
Imposta il nome della definizione di numerazione astratta utilizzata per la numerazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome della definizione di numerazione astratta utilizzata per la numerazione. |
...
Imposta il valore iniziale per questo campo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il valore iniziale per questo campo. |
