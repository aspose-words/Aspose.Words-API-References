...
description: "Rappresenta una modifica tracciata di revisione in un nodo o stile del documento in Java."
type: docs
weight: 579
url: /it/java/com.aspose.words/revision/
---
...
Rappresenta una revisione (modifica tracciata) in un nodo o stile del documento. Usa [getRevisionType()](../../com.aspose.words/revision/\#getRevisionType) per verificare il tipo di questa revisione.
...
| [getAuthor()](#getAuthor) | Ottiene l'autore di questa revisione. |
| [getDateTime()](#getDateTime) | Ottiene la data/ora di questa revisione. |
| [getGroup()](#getGroup) | Ottiene il gruppo di revisione. |
| [getParentNode()](#getParentNode) | Ottiene il nodo genitore immediato (proprietario) di questa revisione. |
| [getParentStyle()](#getParentStyle) | Ottiene lo stile genitore immediato (proprietario) di questa revisione. |
| [getRevisionType()](#getRevisionType) | Ottiene il tipo di questa revisione. |
| [reject()](#reject) | Rifiuta questa revisione. |
| [setAuthor(String value)](#setAuthor-java.lang.String) | Imposta l'autore di questa revisione. |
| [setDateTime(Date value)](#setDateTime-java.util.Date) | Imposta la data/ora di questa revisione. |
### accept() {#accept}
```
public void accept()
```
...
Ottiene l'autore di questa revisione. Non può essere una stringa vuota o null.
...
**Returns:**
java.lang.String - L'autore di questa revisione.
...
Ottiene la data/ora di questa revisione.
...
**Returns:**
java.util.Date - La data/ora di questa revisione.
### getGroup() {#getGroup}
```
...
La revisione non ha gruppo se il tipo di revisione è [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) o se la revisione non esiste più nel contesto del documento (accettata/rifiutata).
...
Ottiene il nodo genitore immediato (proprietario) di questa revisione. Questa proprietà funzionerà per qualsiasi tipo di revisione diverso da [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Se questa revisione riguarda la modifica della formattazione dello Stile, usa [getParentStyle()](../../com.aspose.words/revision/\#getParentStyle) invece.
...
Ottiene lo stile genitore immediato (proprietario) di questa revisione. Questa proprietà funzionerà solo per il tipo di revisione [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Se questa revisione riguarda modifiche ai nodi del documento, usa [getParentNode()](../../com.aspose.words/revision/\#getParentNode) invece.
...
**Returns:**
int - Il tipo di questa revisione. Il valore restituito è una delle costanti di [RevisionType](../../com.aspose.words/revisiontype/).
### reject() {#reject}
```
public void reject()
```
...
Imposta l'autore di questa revisione. Non può essere una stringa vuota o null.
...
| --- | --- | --- |
| valore | java.lang.String | L'autore di questa revisione. |
...
Imposta la data/ora di questa revisione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.util.Date | La data/ora di questa revisione. |
