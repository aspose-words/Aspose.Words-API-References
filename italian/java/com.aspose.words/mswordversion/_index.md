...
description: "Consente a Aspose.Wods di imitare il comportamento dell'applicazione specifico per versione di MS Word in Java."
type: docs
weight: 471
url: /it/java/com.aspose.words/mswordversion/
---
...
Consente ad Aspose.Wods di imitare il comportamento dell'applicazione specifico per versione di MS Word.
...
| Campo | Descrizione |
| --- | --- |
| [WORD_2000](#WORD-2000) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2000. |
| [WORD_2002](#WORD-2002) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2002. |
| [WORD_2003](#WORD-2003) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2003. |
| [WORD_2007](#WORD-2007) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2007. |
| [WORD_2010](#WORD-2010) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2010. |
| [WORD_2013](#WORD-2013) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2013. |
| [WORD_2016](#WORD-2016) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2016. |
| [WORD_2019](#WORD-2019) | Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2019. |
| [length](#length) |  |
## Metodi
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2000.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2002.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2003.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2007.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2010.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2013.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2016.
...
Ottimizza il comportamento di Aspose.Words per corrispondere alla versione MS Word 2019.
