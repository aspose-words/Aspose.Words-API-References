...
description: "Implementa il campo AUTHOR in Java."
type: docs
weight: 200
url: /it/java/com.aspose.words/fieldauthor/
---
...
Implementa il campo AUTHOR.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, e opzionalmente imposta, il nome dell'autore del documento, così come registrato nella proprietà **Author** delle proprietà integrate del documento.
...
| Metodo | Descrizione |
| --- | --- |
| [getAuthorName()](#getAuthorName) | Ottiene il nome dell'autore del documento. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Imposta il nome dell'autore del documento. |
