...
description: "Specifica il comportamento che deve essere applicato al contenuto del blocco di costruzione quando viene inserito nel documento principale in Java."
type: docs
weight: 53
url: /it/java/com.aspose.words/buildingblockbehavior/
---
...
Specifica il comportamento da applicare al contenuto del building block quando viene inserito nel documento principale.

 **Remarks:** 

Corrisponde al tipo **ST\_DocPartBehavior** in OOXML.
...
| Campo | Descrizione |
| --- | --- |
| [CONTENT](#CONTENT) | Specifica che il blocco di costruzione deve essere inserito come contenuto in linea. |
| [DEFAULT](#DEFAULT) | Stesso di [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT). |
| [PAGE](#PAGE) | Specifica che il blocco di costruzione deve essere aggiunto nella sua pagina dedicata. |
| [PARAGRAPH](#PARAGRAPH) | Specifica che il blocco di costruzione deve essere inserito nel suo proprio paragrafo. |
| [length](#length) |  |
## Metodi
...
Specifica che il blocco di costruzione deve essere inserito come contenuto in linea.
...
Stesso di [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT).
...
Specifica che il blocco di costruzione deve essere aggiunto nella sua pagina dedicata.
...
Specifica che il blocco di costruzione deve essere inserito nel suo proprio paragrafo.
