...
description: "Specifica il tipo di asse del grafico in Java."
type: docs
weight: 70
url: /it/java/com.aspose.words/chartaxistype/
---
...
Specifica il tipo di asse del grafico.
...
| Campo | Descrizione |
| --- | --- |
| [CATEGORY](#CATEGORY) | Asse delle categorie di un grafico. |
| [SERIES](#SERIES) | Asse delle serie di un grafico. |
| [VALUE](#VALUE) | Asse dei valori di un grafico. |
| [length](#length) |  |
## Metodi
...
Asse delle categorie di un grafico.
...
Asse delle serie di un grafico.
