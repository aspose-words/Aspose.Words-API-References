...
description: "Fornisce un accesso tipizzato a una collezione di nodi Row in Java."
type: docs
weight: 589
url: /it/java/com.aspose.words/rowcollection/
---
...
Fornisce un accesso tipizzato a una collezione di nodi [Row](../../com.aspose.words/row/).
...
| [get(int index)](#get-int) | Recupera un [Row](../../com.aspose.words/row/) all'indice specificato. |
...
| [toArray()](#toArray) | Copia tutte le righe dalla raccolta in un nuovo array di righe. |
...
Recupera un [Row](../../com.aspose.words/row/) all'indice specificato.
...
**Returns:**
com.aspose.words.Node[] - Un array di righe.
