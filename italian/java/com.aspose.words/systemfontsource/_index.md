...
description: "Rappresenta tutti i font TrueType installati nel sistema in Java."
type: docs
weight: 651
url: /it/java/com.aspose.words/systemfontsource/
---
...
| [getSystemFontFolders()](#getSystemFontFolders) | Restituisce le cartelle dei font di sistema o un array vuoto se le cartelle non sono accessibili. |
...
Su alcune piattaforme Aspose.Words può cercare i font di sistema non solo tramite cartelle ma anche in altre fonti. Ad esempio, sulla piattaforma Windows Aspose.Words cerca i font anche nel registro.
