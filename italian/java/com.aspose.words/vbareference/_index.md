...
description: "Implementa un riferimento a una libreria di tipi Automation o a un progetto VBA in Java."
type: docs
weight: 710
url: /it/java/com.aspose.words/vbareference/
---
...
Implementa un riferimento a una libreria di tipi Automation o a un progetto VBA.
...
| Metodo | Descrizione |
| --- | --- |
| [getLibId()](#getLibId) | Ottiene un valore stringa contenente l'identificatore di una libreria di tipi Automation. |
| [getType()](#getType) | Ottiene l'oggetto [VbaReferenceType](../../com.aspose.words/vbareferencetype/) che indica il tipo di riferimento che rappresenta un oggetto [VbaReference](../../com.aspose.words/vbareference/). |
### VbaReference() {#VbaReference}
```
public VbaReference()
```
...
Ottiene un valore stringa contenente l'identificatore di una libreria di tipi Automation.
...
**Returns:**
java.lang.String - Un valore stringa contenente l'identificatore di una libreria di tipi Automation.
### getType() {#getType}
```
...
Ottiene l'oggetto [VbaReferenceType](../../com.aspose.words/vbareferencetype/) che indica il tipo di riferimento che rappresenta un oggetto [VbaReference](../../com.aspose.words/vbareference/).
...
**Returns:**
int - oggetto [VbaReferenceType](../../com.aspose.words/vbareferencetype/) che indica il tipo di riferimento che rappresenta un oggetto [VbaReference](../../com.aspose.words/vbareference/). Il valore restituito è una delle costanti [VbaReferenceType](../../com.aspose.words/vbareferencetype/).
