...
description: "Implementa il campo PRINT in Java."
type: docs
weight: 273
url: /it/java/com.aspose.words/fieldprint/
---
...
Un'istruzione per inviare i caratteri di codice di controllo specifici della stampante alla stampante selezionata quando il documento viene stampato.
...
| [getPostScriptGroup()](#getPostScriptGroup) | Ottiene il rettangolo di disegno su cui operano le istruzioni PostScript. |
| [getPrinterInstructions()](#getPrinterInstructions) | Ottiene i caratteri di codice di controllo specifici della stampante o le istruzioni PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | Imposta il rettangolo di disegno su cui operano le istruzioni PostScript. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Imposta i caratteri di codice di controllo specifici della stampante o le istruzioni PostScript. |
...
Ottiene il rettangolo di disegno su cui operano le istruzioni PostScript.
...
**Returns:**
java.lang.String - Il rettangolo di disegno su cui operano le istruzioni PostScript.
...
Ottiene i caratteri di codice di controllo specifici della stampante o le istruzioni PostScript.
...
**Returns:**
java.lang.String - I caratteri di codice di controllo specifici della stampante o le istruzioni PostScript.
### getResult() {#getResult}
```
...
Imposta il rettangolo di disegno su cui operano le istruzioni PostScript.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il rettangolo di disegno su cui operano le istruzioni PostScript. |
...
Imposta i caratteri di codice di controllo specifici della stampante o le istruzioni PostScript.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | I caratteri di codice di controllo specifici della stampante o le istruzioni PostScript. |
