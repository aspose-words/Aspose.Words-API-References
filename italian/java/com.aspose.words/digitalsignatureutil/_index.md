...
description: "Fornisce metodi per firmare documenti in Java."
type: docs
weight: 154
url: /it/java/com.aspose.words/digitalsignatureutil/
---
...
Poiché la firma digitale opera sul contenuto del file anziché sul Document Object Model, questi metodi sono inseriti in una classe separata.

I formati supportati sono: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
| [loadSignatures(String fileName)](#loadSignatures-java.lang.String) | Carica le firme digitali dal documento. |
...
| [removeAllSignatures(String srcFileName, String dstFileName)](#removeAllSignatures-java.lang.String-java.lang.String) | Rimuove tutte le firme digitali dal file di origine e scrive il file non firmato nel file di destinazione. |
...
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder) | Firma il documento di origine utilizzando il [CertificateHolder](../../com.aspose.words/certificateholder/) fornito con firma digitale e scrive il documento firmato nel file di destinazione. |
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder, SignOptions signOptions)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder-com.aspose.words.SignOptions) | Firma il documento di origine utilizzando il [CertificateHolder](../../com.aspose.words/certificateholder/) e le [SignOptions](../../com.aspose.words/signoptions/) forniti con firma digitale e scrive il documento firmato nel file di destinazione. |
### loadSignatures(InputStream stream) {#loadSignatures-java.io.InputStream}
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | java.lang.String | Percorso del documento. |
...
I seguenti formati sono compatibili per la rimozione della firma digitale: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
Firma il documento di origine utilizzando il [CertificateHolder](../../com.aspose.words/certificateholder/) fornito con firma digitale e scrive il documento firmato nel file di destinazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| srcFileName | java.lang.String | Il nome file del documento da firmare. |
| dstFileName | java.lang.String | Il nome file del documento firmato in output. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | [CertificateHolder](../../com.aspose.words/certificateholder/) oggetto con il certificato usato per firmare il file. |
...
Firma il documento di origine utilizzando il [CertificateHolder](../../com.aspose.words/certificateholder/) e le [SignOptions](../../com.aspose.words/signoptions/) forniti con firma digitale e scrive il documento firmato nel file di destinazione.
...
| dstFileName | java.lang.String | Il nome file del documento firmato in output. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | [CertificateHolder](../../com.aspose.words/certificateholder/) oggetto con il certificato usato per firmare il file. |
| signOptions | [SignOptions](../../com.aspose.words/signoptions/) | [SignOptions](../../com.aspose.words/signoptions/) oggetto con varie opzioni di firma. |
