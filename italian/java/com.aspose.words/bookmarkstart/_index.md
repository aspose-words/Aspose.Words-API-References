...
description: "Rappresenta l'inizio di un segnalibro in un documento Word in Java."
type: docs
weight: 44
url: /it/java/com.aspose.words/bookmarkstart/
---
...
Un segnalibro completo in un documento Word è costituito da un [BookmarkStart](../../com.aspose.words/bookmarkstart/) e da un corrispondente [BookmarkEnd](../../com.aspose.words/bookmarkend/) con lo stesso nome del segnalibro.
...
Usa la classe [getBookmark()](../../com.aspose.words/bookmarkstart/\#getBookmark) come una "facciata" per lavorare con un segnalibro come un unico oggetto.
...
| --- | --- |
| [BookmarkStart(DocumentBase doc, String name)](#BookmarkStart-com.aspose.words.DocumentBase-java.lang.String) | Inizializza una nuova istanza della classe [BookmarkStart](../../com.aspose.words/bookmarkstart/). |
## Metodi
...
| [getBookmark()](#getBookmark) | Ottiene l'oggetto facciata che incapsula l'inizio e la fine di questo segnalibro. |
...
| [getNodeType()](#getNodeType) | Restituisce [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START). |
...
| [getText()](#getText) | Restituisce una stringa vuota. |
...
Inizializza una nuova istanza della classe [BookmarkStart](../../com.aspose.words/bookmarkstart/).
...
| name | java.lang.String | Il nome del segnalibro. Non può essere null. |
...
Chiama [DocumentVisitor.visitBookmarkStart(com.aspose.words.BookmarkStart)](../../com.aspose.words/documentvisitor/\#visitBookmarkStart-com.aspose.words.BookmarkStart).
...
Ottiene l'oggetto facciata che incapsula l'inizio e la fine di questo segnalibro.
...
Restituisce [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START).
...
**Returns:**
int - [NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype/\#BOOKMARK-START). Il valore restituito è una delle costanti di [NodeType](../../com.aspose.words/nodetype/).
...
**Returns:**
java.lang.String - Una stringa vuota.
