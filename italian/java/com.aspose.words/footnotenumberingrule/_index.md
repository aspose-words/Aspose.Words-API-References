...
description: "Determina quando il conteggio automatico di note a piè di pagina o di note finali riprende in Java."
type: docs
weight: 340
url: /it/java/com.aspose.words/footnotenumberingrule/
---
...
Determina quando il conteggio automatico delle note a piè di pagina o di chiusura viene ripristinato.
...
| Campo | Descrizione |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | Conteggio continuo in tutto il documento. |
| [DEFAULT](#DEFAULT) | Uguale a [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS). |
| [RESTART_PAGE](#RESTART-PAGE) | Il conteggio riprende a ogni pagina. |
| [RESTART_SECTION](#RESTART-SECTION) | Il conteggio riprende a ogni sezione. |
| [length](#length) |  |
## Metodi
...
Conteggio continuo in tutto il documento.
...
Uguale a [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
Il conteggio riprende a ogni pagina. Valido solo per le note a piè di pagina.
...
Il conteggio riprende a ogni sezione.
