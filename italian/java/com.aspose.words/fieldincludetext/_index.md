...
description: "Implementa il campo INCLUDETEXT in Java."
type: docs
weight: 248
url: /it/java/com.aspose.words/fieldincludetext/
---
...
Mostra come creare un campo INCLUDETEXT e impostare le sue proprietà.
...
| Metodo | Descrizione |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Ottiene il nome del segnalibro nel documento da includere. |
| [getDisplayResult()](#getDisplayResult) | Ottiene il testo che rappresenta il risultato del campo visualizzato. |
| [getEncoding()](#getEncoding) | Ottiene la codifica applicata ai dati nel file di riferimento. |
...
| [getLockFields()](#getLockFields) | Ottiene se impedire l'aggiornamento dei campi nel documento incluso. |
| [getMimeType()](#getMimeType) | Ottiene il tipo MIME del file di riferimento. |
| [getNamespaceMappings()](#getNamespaceMappings) | Ottiene le mappature degli spazi dei nomi per le query XPath. |
...
| [getSourceFullName()](#getSourceFullName) | Ottiene l'ubicazione del documento utilizzando un IRI. |
| [getStart()](#getStart) | Ottiene il nodo che rappresenta l'inizio del campo. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTextConverter()](#getTextConverter) | Ottiene il nome del convertitore di testo per il formato del file incluso. |
| [getType()](#getType) | Ottiene il tipo di campo di Microsoft Word. |
| [getXPath()](#getXPath) | Ottiene XPath per la porzione desiderata del file XML. |
| [getXslTransformation()](#getXslTransformation) | Ottiene l'ubicazione della trasformazione XSL per formattare i dati XML. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Imposta il nome del segnalibro nel documento da includere. |
| [setEncoding(String value)](#setEncoding-java.lang.String) | Imposta la codifica applicata ai dati nel file di riferimento. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setLockFields(boolean value)](#setLockFields-boolean) | Imposta se impedire l'aggiornamento dei campi nel documento incluso. |
| [setMimeType(String value)](#setMimeType-java.lang.String) | Imposta il tipo MIME del file di riferimento. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | Imposta le mappature degli spazi dei nomi per le query XPath. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Imposta l'ubicazione del documento utilizzando un IRI. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | Imposta il nome del convertitore di testo per il formato del file incluso. |
| [setXPath(String value)](#setXPath-java.lang.String) | Imposta XPath per la porzione desiderata del file XML. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | Imposta l'ubicazione della trasformazione XSL per formattare i dati XML. |
...
Ottiene il nome del segnalibro nel documento da includere.
...
**Returns:**
java.lang.String - Il nome del segnalibro nel documento da includere.
...
Ottiene la codifica applicata ai dati nel file di riferimento.
...
**Returns:**
java.lang.String - La codifica applicata ai dati nel file di riferimento.
### getEnd() {#getEnd}
```
...
Ottiene se impedire l'aggiornamento dei campi nel documento incluso.
...
**Returns:**
boolean - Se impedire l'aggiornamento dei campi nel documento incluso.
...
Ottiene il tipo MIME del file di riferimento.
...
**Returns:**
java.lang.String - Il tipo MIME del file di riferimento.
...
Ottiene le mappature degli spazi dei nomi per le query XPath.
...
**Returns:**
java.lang.String - Le mappature di namespace per le query XPath.
### getResult() {#getResult}
```
...
Ottiene l'ubicazione del documento utilizzando un IRI.
...
**Returns:**
java.lang.String - La posizione del documento usando un IRI.
### getStart() {#getStart}
```
...
Ottiene il nome del convertitore di testo per il formato del file incluso.
...
**Returns:**
java.lang.String - Il nome del convertitore di testo per il formato del file incluso.
### getType() {#getType}
```
public int getType()
```
...
Ottiene XPath per la porzione desiderata del file XML.
...
**Returns:**
java.lang.String - XPath per la parte desiderata del file XML.
...
Ottiene l'ubicazione della trasformazione XSL per formattare i dati XML.
...
**Returns:**
java.lang.String - La posizione della trasformazione XSL per formattare i dati XML.
### isDirty() {#isDirty}
```
...
Imposta il nome del segnalibro nel documento da includere.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del segnalibro nel documento da includere. |
...
Imposta la codifica applicata ai dati nel file di riferimento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La codifica applicata ai dati nel file di riferimento. |
...
Imposta se impedire l'aggiornamento dei campi nel documento incluso.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se impedire l'aggiornamento dei campi nel documento incluso. |
...
Imposta il tipo MIME del file di riferimento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il tipo MIME del file di riferimento. |
...
Imposta le mappature degli spazi dei nomi per le query XPath.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Le mappature di namespace per le query XPath. |
...
Imposta l'ubicazione del documento utilizzando un IRI.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La posizione del documento usando un IRI. |
...
Imposta il nome del convertitore di testo per il formato del file incluso.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del convertitore di testo per il formato del file incluso. |
...
Imposta XPath per la porzione desiderata del file XML.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | XPath per la parte desiderata del file XML. |
...
Imposta l'ubicazione della trasformazione XSL per formattare i dati XML.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La posizione della trasformazione XSL per formattare i dati XML. |
