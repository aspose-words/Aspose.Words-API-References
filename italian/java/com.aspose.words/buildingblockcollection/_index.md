...
description: "Una raccolta di oggetti BuildingBlock nel documento in Java."
type: docs
weight: 54
url: /it/java/com.aspose.words/buildingblockcollection/
---
...
Una raccolta di oggetti [BuildingBlock](../../com.aspose.words/buildingblock/) nel documento.
...
Non si creano istanze di questa classe direttamente. Per accedere a una raccolta di blocchi di costruzione, utilizzare la proprietà [GlossaryDocument.getBuildingBlocks()](../../com.aspose.words/glossarydocument/\#getBuildingBlocks).
...
| [get(int index)](#get-int) | Recupera un blocco di costruzione all'indice specificato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| indice | int | Un indice nella lista dei blocchi di costruzione. |
...
Copia tutti i blocchi di costruzione dalla raccolta in un nuovo array di blocchi di costruzione.
...
**Returns:**
com.aspose.words.Node[] - Un array di blocchi di costruzione.
