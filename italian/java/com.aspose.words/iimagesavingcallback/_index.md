...
description: "Implementa questa interfaccia se desideri controllare come Aspose.Words salva le immagini durante il salvataggio di un documento in HTML in Java."
type: docs
weight: 773
url: /it/java/com.aspose.words/iimagesavingcallback/
---
```
public interface IImageSavingCallback
```

Implementa questa interfaccia se desideri controllare come Aspose.Words salva le immagini durante il salvataggio di un documento in HTML. Può essere usata da altri formati.

 **Examples:** 

Mostra come rinominare il nome dell'immagine durante il salvataggio in un documento Markdown.
...
| Metodo | Descrizione |
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | Chiamata quando Aspose.Words salva un'immagine in HTML. |
...
Chiamata quando Aspose.Words salva un'immagine in HTML.
