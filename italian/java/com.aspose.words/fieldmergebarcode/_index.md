...
description: "Implementa il campo MERGEBARCODE in Java."
type: docs
weight: 257
url: /it/java/com.aspose.words/fieldmergebarcode/
---
...
Unisci per corrispondenza un codice a barre.

 **Examples:** 

Mostra come eseguire un mail merge su codici a barre QR.
...
Mostra come eseguire un mail merge su codici a barre EAN13.
...
Mostra come eseguire un mail merge su codici a barre CODE39.
...
Mostra come eseguire un mail merge su codici a barre ITF14.
...
| [getAddStartStopChar()](#getAddStartStopChar) | Restituisce se aggiungere i caratteri Start/Stop per i tipi di codice a barre NW7 e CODE39. |
| [getBackgroundColor()](#getBackgroundColor) | Restituisce il colore di sfondo del simbolo del codice a barre. |
| [getBarcodeType()](#getBarcodeType) | Restituisce il tipo di codice a barre (QR, ecc.) |
| [getBarcodeValue()](#getBarcodeValue) | Restituisce il valore del codice a barre. |
| [getCaseCodeStyle()](#getCaseCodeStyle) | Restituisce lo stile di un Case Code per il tipo di codice a barra ITF14. |
| [getDisplayResult()](#getDisplayResult) | Ottiene il testo che rappresenta il risultato del campo visualizzato. |
| [getDisplayText()](#getDisplayText) | Restituisce se visualizzare i dati del codice a barre (testo) insieme all'immagine. |
| [getEnd()](#getEnd) | Ottiene il nodo che rappresenta la fine del campo. |
| [getErrorCorrectionLevel()](#getErrorCorrectionLevel) | Restituisce un livello di correzione errori del QR Code. |
...
| [getFixCheckDigit()](#getFixCheckDigit) | Restituisce se correggere la cifra di controllo se è invalida. |
| [getForegroundColor()](#getForegroundColor) | Restituisce il colore di primo piano del simbolo del codice a barre. |
...
| [getScalingFactor()](#getScalingFactor) | Restituisce un fattore di scala per il simbolo. |
...
| [getSymbolHeight()](#getSymbolHeight) | Restituisce l'altezza del simbolo. |
| [getSymbolRotation()](#getSymbolRotation) | Restituisce la rotazione del simbolo del codice a barre. |
...
| [setAddStartStopChar(boolean value)](#setAddStartStopChar-boolean) | Imposta se aggiungere i caratteri Start/Stop per i tipi di codice a barre NW7 e CODE39. |
| [setBackgroundColor(String value)](#setBackgroundColor-java.lang.String) | Imposta il colore di sfondo del simbolo del codice a barre. |
| [setBarcodeType(String value)](#setBarcodeType-java.lang.String) | Imposta il tipo di codice a barre (QR, ecc.) |
| [setBarcodeValue(String value)](#setBarcodeValue-java.lang.String) | Imposta il valore del codice a barre. |
| [setCaseCodeStyle(String value)](#setCaseCodeStyle-java.lang.String) | Imposta lo stile di un Case Code per il tipo di codice a barre ITF14. |
| [setDisplayText(boolean value)](#setDisplayText-boolean) | Imposta se visualizzare i dati del codice a barre (testo) insieme all'immagine. |
| [setErrorCorrectionLevel(String value)](#setErrorCorrectionLevel-java.lang.String) | Imposta un livello di correzione degli errori per il QR Code. |
| [setFixCheckDigit(boolean value)](#setFixCheckDigit-boolean) | Imposta se correggere la cifra di controllo se è non valida. |
| [setForegroundColor(String value)](#setForegroundColor-java.lang.String) | Imposta il colore di primo piano del simbolo del codice a barre. |
...
| [setScalingFactor(String value)](#setScalingFactor-java.lang.String) | Imposta un fattore di scala per il simbolo. |
| [setSymbolHeight(String value)](#setSymbolHeight-java.lang.String) | Imposta l'altezza del simbolo. |
| [setSymbolRotation(String value)](#setSymbolRotation-java.lang.String) | Imposta la rotazione del simbolo del codice a barre. |
...
Restituisce se aggiungere i caratteri Start/Stop per i tipi di codice a barre NW7 e CODE39.
...
**Returns:**
boolean - Indica se aggiungere i caratteri Inizio/Fine per i tipi di codice a barre NW7 e CODE39.
...
Ottiene il colore di sfondo del simbolo del codice a barre. I valori validi sono nell'intervallo [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - Il colore di sfondo del simbolo del codice a barre.
...
Restituisce il tipo di codice a barre (QR, ecc.)
...
**Returns:**
java.lang.String - Il tipo di codice a barre (QR, ecc.)
...
Restituisce il valore del codice a barre.
...
**Returns:**
java.lang.String - Il valore del codice a barre.
...
Ottiene lo stile di un Case Code per il tipo di codice a barre ITF14. I valori validi sono [STD|EXT|ADD]
...
**Returns:**
java.lang.String - Lo stile di un Case Code per il tipo di codice a barre ITF14.
...
Restituisce se visualizzare i dati del codice a barre (testo) insieme all'immagine.
...
**Returns:**
boolean - Indica se visualizzare i dati del codice a barre (testo) insieme all'immagine.
### getEnd() {#getEnd}
```
...
Ottiene un livello di correzione degli errori per il QR Code. I valori validi sono [0, 3].
...
**Returns:**
java.lang.String - Un livello di correzione degli errori per il QR Code.
...
Restituisce se correggere la cifra di controllo se è invalida.
...
**Returns:**
boolean - Indica se correggere la cifra di controllo se è non valida.
...
Ottiene il colore di primo piano del simbolo del codice a barre. I valori validi sono nell'intervallo [0, 0xFFFFFF]
...
**Returns:**
java.lang.String - Il colore di primo piano del simbolo del codice a barre.
### getFormat() {#getFormat}
```
...
Ottiene lo stile di un codice a barre Point of Sale (tipi di codice a barre UPCA|UPCE|EAN13|EAN8). I valori validi (non sensibili a maiuscole/minuscole) sono [STD|SUP2|SUP5|CASE].
...
**Returns:**
java.lang.String - Lo stile di un codice a barre Point of Sale (tipi di codice a barre UPCA|UPCE|EAN13|EAN8).
### getResult() {#getResult}
```
...
Ottiene un fattore di scala per il simbolo. Il valore è in punti percentuali interi e i valori validi sono [10, 1000]
...
**Returns:**
java.lang.String - Un fattore di scala per il simbolo.
...
Ottiene l'altezza del simbolo. L'unità è in TWIPS (1/1440 di pollice).
...
**Returns:**
java.lang.String - L'altezza del simbolo.
...
Ottiene la rotazione del simbolo del codice a barre. I valori validi sono [0, 3]
...
**Returns:**
java.lang.String - La rotazione del simbolo del codice a barre.
### getType() {#getType}
```
public int getType()
```
...
Imposta se aggiungere i caratteri Start/Stop per i tipi di codice a barre NW7 e CODE39.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se aggiungere i caratteri Start/Stop per i tipi di codice a barre NW7 e CODE39. |
...
Imposta il colore di sfondo del simbolo del codice a barre. I valori validi sono nell'intervallo [0, 0xFFFFFF]
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il colore di sfondo del simbolo del codice a barre. |
...
Imposta il tipo di codice a barre (QR, ecc.)
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il tipo di codice a barre (QR, ecc.) |
...
Imposta il valore del codice a barre.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il valore del codice a barre. |
...
Imposta lo stile di un Case Code per il tipo di codice a barre ITF14. I valori validi sono [STD|EXT|ADD]
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Lo stile di un Case Code per il tipo di codice a barre ITF14. |
...
Imposta se visualizzare i dati del codice a barre (testo) insieme all'immagine.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se visualizzare i dati del codice a barre (testo) insieme all'immagine. |
...
Imposta un livello di correzione errori per il QR Code. I valori validi sono [0, 3].
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un livello di correzione errori per il QR Code. |
...
Imposta se correggere la cifra di controllo se è non valida.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se correggere la cifra di controllo se è non valida. |
...
Imposta il colore di primo piano del simbolo del codice a barre. I valori validi sono nell'intervallo [0, 0xFFFFFF]
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il colore di primo piano del simbolo del codice a barre. |
...
Imposta lo stile di un codice a barre Point of Sale (tipi di codice a barre UPCA|UPCE|EAN13|EAN8). I valori validi (senza distinzione tra maiuscole e minuscole) sono [STD|SUP2|SUP5|CASE].
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Lo stile di un codice a barre Point of Sale (tipi di codice a barre UPCA | UPCE | EAN13 | EAN8). |
...
Imposta un fattore di scala per il simbolo. Il valore è in punti percentuali interi e i valori validi sono [10, 1000]
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un fattore di scala per il simbolo. |
...
Imposta l'altezza del simbolo. L'unità è in TWIPS (1/1440 di pollice).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'altezza del simbolo. |
...
Imposta la rotazione del simbolo del codice a barre. I valori validi sono [0, 3]
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La rotazione del simbolo del codice a barre. |
