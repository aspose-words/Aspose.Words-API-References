...
description: "Regola di sostituzione dei caratteri per l'elaborazione del nome del carattere in Java."
type: docs
weight: 329
url: /it/java/com.aspose.words/fontnamesubstitutionrule/
---
...
Regola di sostituzione del font per l'elaborazione del nome del font.

Per saperne di più, visita l'articolo di documentazione [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Secondo questa regola Aspose.Words tenta di elaborare il nome del carattere per ottenere la sostituzione. In particolare Aspose.Words tenta di rimuovere i suffissi con i separatori '-', ',' e '(' come fa MS Word.
