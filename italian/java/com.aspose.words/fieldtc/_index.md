...
description: "Implementa il campo TC in Java."
type: docs
weight: 293
url: /it/java/com.aspose.words/fieldtc/
---
...
Definisce il testo e il numero di pagina per una voce dell'indice (inclusa l'indice delle figure), che è utilizzata da un campo TOC.
...
| [getEntryLevel()](#getEntryLevel) | Ottiene il livello della voce. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | Ottiene se il numero di pagina nel TOC deve essere omesso per questo campo. |
...
| [getTypeIdentifier()](#getTypeIdentifier) | Ottiene un identificatore di tipo per questo campo (che è tipicamente una lettera). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Imposta il livello della voce. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Imposta se il numero di pagina nel TOC deve essere omesso per questo campo. |
...
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Imposta un identificatore di tipo per questo campo (che è tipicamente una lettera). |
...
**Returns:**
java.lang.String - Il livello della voce.
...
Ottiene se il numero di pagina nel TOC deve essere omesso per questo campo.
...
**Returns:**
boolean - Se il numero di pagina nel TOC deve essere omesso per questo campo.
### getPageNumber() {#getPageNumber}
```
...
Ottiene un identificatore di tipo per questo campo (che è tipicamente una lettera).
...
**Returns:**
java.lang.String - Un identificatore di tipo per questo campo (che è tipicamente una lettera).
### hasBookmark() {#hasBookmark}
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il livello della voce. |
...
Imposta se il numero di pagina nel TOC deve essere omesso per questo campo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se il numero di pagina nell'Indice dovrebbe essere omesso per questo campo. |
...
Imposta un identificatore di tipo per questo campo (che è tipicamente una lettera).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un identificatore di tipo per questo campo (che è tipicamente una lettera). |
