---
title: "Compatibilità"
linktitle: "Compatibilità"
second_title: "Aspose.Words per Java"
description: "Specifica i nomi delle opzioni di compatibilità in Java."
type: docs
weight: 119
url: /it/java/com.aspose.words/compatibility/
---
...
| Campo | Descrizione |
| --- | --- |
| [ADJUST_LINE_HEIGHT_IN_TABLE](#ADJUST-LINE-HEIGHT-IN-TABLE) | Regola l'altezza della riga nella tabella |
| [ALIGN_TABLE_ROW_BY_ROW](#ALIGN-TABLE-ROW-BY-ROW) | Allinea le righe della tabella per regola |
| [ALLOW_SPACE_OF_SAME_STYLE_IN_TABLE](#ALLOW-SPACE-OF-SAME-STYLE-IN-TABLE) | Consenti spazio dello stesso stile nella tabella |
| [APPLY_BREAKING_RULES](#APPLY-BREAKING-RULES) | Applica le regole di interruzione |
| [AUTOFIT_TO_FIRST_FIXED_WIDTH_CELL](#AUTOFIT-TO-FIRST-FIXED-WIDTH-CELL) | AutoFit alla prima cella a larghezza fissa |
| [AUTO_SPACE_LIKE_WORD_95](#AUTO-SPACE-LIKE-WORD-95) | Spazio automatico come Word 95 |
| [BALANCE_SINGLE_BYTE_DOUBLE_BYTE_WIDTH](#BALANCE-SINGLE-BYTE-DOUBLE-BYTE-WIDTH) | Bilancia larghezze a byte singolo e a doppio byte |
| [CACHED_COL_BALANCE](#CACHED-COL-BALANCE) | Bilanciamento colonne in cache |
| [CONV_MAIL_MERGE_ESC](#CONV-MAIL-MERGE-ESC) | Converti le sequenze di escape di Mail Merge |
| [DISABLE_OPEN_TYPE_FONT_FORMATTING_FEATURES](#DISABLE-OPEN-TYPE-FONT-FORMATTING-FEATURES) | Disabilita le funzionalità di formattazione dei font OpenType |
| [DISPLAY_HANGUL_FIXED_WIDTH](#DISPLAY-HANGUL-FIXED-WIDTH) | Visualizza Hangul a larghezza fissa |
| [DO_NOT_AUTOFIT_CONSTRAINED_TABLES](#DO-NOT-AUTOFIT-CONSTRAINED-TABLES) | Non AutoFit tabelle vincolate |
| [DO_NOT_BREAK_CONSTRAINED_FORCED_TABLE](#DO-NOT-BREAK-CONSTRAINED-FORCED-TABLE) | Non interrompere tabelle vincolate forzate |
| [DO_NOT_BREAK_WRAPPED_TABLES](#DO-NOT-BREAK-WRAPPED-TABLES) | Non interrompere tabelle avvolte |
| [DO_NOT_EXPAND_ON_SHIFT_RETURN](#DO-NOT-EXPAND-ON-SHIFT-RETURN) | Non espandere su Shift Return |
| [DO_NOT_LEAVE_BACKSLASH_ALONE](#DO-NOT-LEAVE-BACKSLASH-ALONE) | Non lasciare il backslash da solo |
| [DO_NOT_SNAP_TO_GRID_IN_CELL](#DO-NOT-SNAP-TO-GRID-IN-CELL) | Non agganciare alla griglia nelle celle |
| [DO_NOT_SUPPRESS_INDENTATION](#DO-NOT-SUPPRESS-INDENTATION) | Non sopprimere l'indentazione |
| [DO_NOT_SUPPRESS_PARAGRAPH_BORDER](#DO-NOT-SUPPRESS-PARAGRAPH-BORDER) | Non sopprimere il bordo del paragrafo |
| [DO_NOT_USE_EAST_ASIAN_BREAK_RULES](#DO-NOT-USE-EAST-ASIAN-BREAK-RULES) | Non utilizzare le regole di interruzione East Asian |
| [DO_NOT_USE_HTML_PARAGRAPH_AUTO_SPACING](#DO-NOT-USE-HTML-PARAGRAPH-AUTO-SPACING) | Non utilizzare l'auto-spaziatura dei paragrafi HTML |
| [DO_NOT_USE_INDENT_AS_NUMBERING_TAB_STOP](#DO-NOT-USE-INDENT-AS-NUMBERING-TAB-STOP) | Non utilizzare l'indentazione come tabulazione di numerazione |
| [DO_NOT_VERT_ALIGN_CELL_WITH_SP](#DO-NOT-VERT-ALIGN-CELL-WITH-SP) | Non allineare verticalmente la cella con spaziatura |
| [DO_NOT_VERT_ALIGN_IN_TXBX](#DO-NOT-VERT-ALIGN-IN-TXBX) | Non allineare verticalmente nelle caselle di testo |
| [DO_NOT_WRAP_TEXT_WITH_PUNCT](#DO-NOT-WRAP-TEXT-WITH-PUNCT) | Non a capo il testo con punteggiatura |
| [FOOTNOTE_LAYOUT_LIKE_WW_8](#FOOTNOTE-LAYOUT-LIKE-WW-8) | Layout delle note a piè di pagina come Word 2000 |
| [FORGET_LAST_TAB_ALIGNMENT](#FORGET-LAST-TAB-ALIGNMENT) | Dimentica l'allineamento dell'ultima tabulazione |
| [GROW_AUTOFIT](#GROW-AUTOFIT) | Espandi AutoFit |
| [LAYOUT_RAW_TABLE_WIDTH](#LAYOUT-RAW-TABLE-WIDTH) | Layout larghezza tabella grezza |
| [LAYOUT_TABLE_ROWS_APART](#LAYOUT-TABLE-ROWS-APART) | Layout righe tabella separate |
| [LINE_WRAP_LIKE_WORD_6](#LINE-WRAP-LIKE-WORD-6) | A capo come Word 6 |
| [MW_SMALL_CAPS](#MW-SMALL-CAPS) |  |
| [NO_COLUMN_BALANCE](#NO-COLUMN-BALANCE) | Nessun bilanciamento colonne |
| [NO_EXTRA_LINE_SPACING](#NO-EXTRA-LINE-SPACING) | Nessuna spaziatura extra tra le righe |
| [NO_LEADING](#NO-LEADING) | Nessun interlinea |
| [NO_SPACE_RAISE_LOWER](#NO-SPACE-RAISE-LOWER) | Nessuno spazio di rialzo/abbassamento |
| [NO_TAB_HANG_IND](#NO-TAB-HANG-IND) | Nessuna rientranza di sospensione tabulazione |
| [OVERRIDE_TABLE_STYLE_FONT_SIZE_AND_JUSTIFICATION](#OVERRIDE-TABLE-STYLE-FONT-SIZE-AND-JUSTIFICATION) | Sovrascrivi dimensione carattere e giustificazione dello stile tabella |
| [PRINT_BODY_TEXT_BEFORE_HEADER](#PRINT-BODY-TEXT-BEFORE-HEADER) | Stampa testo del corpo prima dell'intestazione |
| [PRINT_COL_BLACK](#PRINT-COL-BLACK) | Stampa sfondo colonna |
| [SELECT_FLD_WITH_FIRST_OR_LAST_CHAR](#SELECT-FLD-WITH-FIRST-OR-LAST-CHAR) | Seleziona campo con primo o ultimo carattere |
| [SHAPE_LAYOUT_LIKE_WW_8](#SHAPE-LAYOUT-LIKE-WW-8) | Layout forma come Word 2000 |
| [SHOW_BREAKS_IN_FRAMES](#SHOW-BREAKS-IN-FRAMES) | Mostra interruzioni nei riquadri |
| [SPACE_FOR_UL](#SPACE-FOR-UL) | Spazio per sottolineatura |
| [SPACING_IN_WHOLE_POINTS](#SPACING-IN-WHOLE-POINTS) | Spaziatura in punti interi |
| [SPLIT_PG_BREAK_AND_PARA_MARK](#SPLIT-PG-BREAK-AND-PARA-MARK) | Dividi interruzione di pagina e segno di paragrafo |
| [SUB_FONT_BY_SIZE](#SUB-FONT-BY-SIZE) | Sostituisci carattere per dimensione |
| [SUPPRESS_BOTTOM_SPACING](#SUPPRESS-BOTTOM-SPACING) | Sopprimi spaziatura inferiore |
| [SUPPRESS_SP_BF_AFTER_PG_BRK](#SUPPRESS-SP-BF-AFTER-PG-BRK) | Sopprimi spazio prima dell'interruzione di paragrafo |
| [SUPPRESS_TOP_LINE_SPACING_WP](#SUPPRESS-TOP-LINE-SPACING-WP) | Sopprimi spaziatura superiore delle righe in WordPerfect |
| [SUPPRESS_TOP_SPACING](#SUPPRESS-TOP-SPACING) | Sopprimi spaziatura superiore |
| [SUPPRESS_TOP_SPACING_AT_TOP_OF_PAGE](#SUPPRESS-TOP-SPACING-AT-TOP-OF-PAGE) | Sopprimi spaziatura superiore delle righe in WordPerfect |
| [SWAP_BORDERS_ODD_FACING_PGS](#SWAP-BORDERS-ODD-FACING-PGS) | Scambia bordi nelle pagine dispari |
| [SWAP_INSIDE_AND_OUTSIDE_FOR_MIRROR_INDENTS_AND_RELATIVE_POSITIONING](#SWAP-INSIDE-AND-OUTSIDE-FOR-MIRROR-INDENTS-AND-RELATIVE-POSITIONING) | Scambia Interno ed Esterno per rientri a specchio e posizionamento relativo |
| [TRANSPARENT_METAFILES](#TRANSPARENT-METAFILES) | Metafile trasparenti |
| [TRUNCATE_FONT_HEIGHT_LIKE_WP_6](#TRUNCATE-FONT-HEIGHT-LIKE-WP-6) | Tronca l'altezza del carattere come WordPerfect 6 |
| [UI_COMPAT_97_TO_2003](#UI-COMPAT-97-TO-2003) |  |
| [UL_TRAIL_SPACE](#UL-TRAIL-SPACE) | Sottolinea lo spazio finale |
| [UNDERLINE_TAB_IN_NUM_LIST](#UNDERLINE-TAB-IN-NUM-LIST) | Sottolinea la tabulazione nell'elenco numerato |
| [USE_ALT_KINSOKU_LINE_BREAK_RULES](#USE-ALT-KINSOKU-LINE-BREAK-RULES) | Usa le regole di interruzione di riga Alt Kinsoku |
| [USE_ANSI_KERNING_PAIRS](#USE-ANSI-KERNING-PAIRS) | Usa coppie di kerning ANSI |
| [USE_FE_LAYOUT](#USE-FE-LAYOUT) |  |
| [USE_NORMAL_STYLE_FOR_LIST](#USE-NORMAL-STYLE-FOR-LIST) | Usa lo stile Normale per l'elenco |
| [USE_PRINTER_METRICS](#USE-PRINTER-METRICS) | Usa le metriche della stampante |
| [USE_SINGLE_BORDERFOR_CONTIGUOUS_CELLS](#USE-SINGLE-BORDERFOR-CONTIGUOUS-CELLS) | Usa un bordo singolo per le celle contigue |
| [USE_WORD_2002_TABLE_STYLE_RULES](#USE-WORD-2002-TABLE-STYLE-RULES) | Usa le regole di stile tabella di Word 2002 |
| [USE_WORD_2010_TABLE_STYLE_RULES](#USE-WORD-2010-TABLE-STYLE-RULES) | Usa le regole di stile tabella di Word 2010 |
| [USE_WORD_97_LINE_BREAK_RULES](#USE-WORD-97-LINE-BREAK-RULES) | Usa le regole di interruzione di riga di Word 97 |
| [WP_JUSTIFICATION](#WP-JUSTIFICATION) |  |
| [WP_SPACE_WIDTH](#WP-SPACE-WIDTH) |  |
| [WRAP_TRAIL_SPACES](#WRAP-TRAIL-SPACES) | A capo gli spazi finali |
| [length](#length) |  |
## Metodi
...
Regola l'altezza della riga nella tabella
...
Allinea le righe della tabella per regola
...
Consenti spazio dello stesso stile nella tabella
...
Applica le regole di interruzione
...
AutoFit alla prima cella a larghezza fissa
...
Spazio automatico come Word 95
...
Bilancia larghezze a byte singolo e a doppio byte
...
Bilanciamento colonne in cache
...
Converti le sequenze di escape di Mail Merge
...
Disabilita le funzionalità di formattazione dei font OpenType
...
Visualizza Hangul a larghezza fissa
...
Non interrompere tabelle vincolate forzate
...
Non interrompere tabelle avvolte
...
Non lasciare il backslash da solo
...
Non agganciare alla griglia nelle celle
...
Non sopprimere il bordo del paragrafo
...
Non utilizzare le regole di interruzione East Asian
...
Non utilizzare l'auto-spaziatura dei paragrafi HTML
...
Non utilizzare l'indentazione come tabulazione di numerazione
...
Non allineare verticalmente la cella con spaziatura
...
Non allineare verticalmente nelle caselle di testo
...
Non a capo il testo con punteggiatura
...
Layout delle note a piè di pagina come Word 2000
...
Dimentica l'allineamento dell'ultima tabulazione
...
Layout larghezza tabella grezza
...
Nessuna spaziatura extra tra le righe
...
Nessuno spazio di rialzo/abbassamento
...
Nessuna rientranza di sospensione tabulazione
...
Sovrascrivi dimensione carattere e giustificazione dello stile tabella
...
Stampa testo del corpo prima dell'intestazione
...
Seleziona campo con primo o ultimo carattere
...
Mostra interruzioni nei riquadri
...
Dividi interruzione di pagina e segno di paragrafo
...
Sostituisci carattere per dimensione
...
Sopprimi spazio prima dell'interruzione di paragrafo
...
Sopprimi spaziatura superiore delle righe in WordPerfect
...
Scambia bordi nelle pagine dispari
...
Scambia Interno ed Esterno per rientri a specchio e posizionamento relativo
...
Tronca l'altezza del carattere come WordPerfect 6
...
Sottolinea la tabulazione nell'elenco numerato
...
Usa le regole di interruzione di riga Alt Kinsoku
...
Usa lo stile Normale per l'elenco
...
Usa le metriche della stampante
...
Usa un bordo singolo per le celle contigue
...
Usa le regole di stile tabella di Word 2002
...
Usa le regole di stile tabella di Word 2010
...
Usa le regole di interruzione di riga di Word 97
