...
description: "Specifica il tipo di interruzione all'interno di un documento in Java."
type: docs
weight: 49
url: /it/java/com.aspose.words/breaktype/
---
...
| Campo | Descrizione |
| --- | --- |
| [COLUMN_BREAK](#COLUMN-BREAK) | Interruzione di colonna esplicita. |
| [LINE_BREAK](#LINE-BREAK) | Interruzione di riga esplicita. |
| [PAGE_BREAK](#PAGE-BREAK) | Interruzione di pagina esplicita. |
| [PARAGRAPH_BREAK](#PARAGRAPH-BREAK) | Interruzione tra paragrafi. |
| [SECTION_BREAK_CONTINUOUS](#SECTION-BREAK-CONTINUOUS) | Specifica l'inizio di una nuova sezione nella stessa pagina della sezione precedente. |
| [SECTION_BREAK_EVEN_PAGE](#SECTION-BREAK-EVEN-PAGE) | Specifica l'inizio di una nuova sezione su una nuova pagina pari. |
| [SECTION_BREAK_NEW_COLUMN](#SECTION-BREAK-NEW-COLUMN) | Specifica l'inizio di una nuova sezione nella nuova colonna. |
| [SECTION_BREAK_NEW_PAGE](#SECTION-BREAK-NEW-PAGE) | Specifica l'inizio di una nuova sezione su una nuova pagina. |
| [SECTION_BREAK_ODD_PAGE](#SECTION-BREAK-ODD-PAGE) | Specifica l'inizio di una nuova sezione su una pagina dispari. |
| [length](#length) |  |
## Metodi
...
Interruzione di colonna esplicita.
...
Specifica l'inizio di una nuova sezione nella stessa pagina della sezione precedente.
...
Specifica l'inizio di una nuova sezione su una nuova pagina pari.
...
Specifica l'inizio di una nuova sezione nella nuova colonna.
...
Specifica l'inizio di una nuova sezione su una nuova pagina.
...
Specifica l'inizio di una nuova sezione su una pagina dispari.
