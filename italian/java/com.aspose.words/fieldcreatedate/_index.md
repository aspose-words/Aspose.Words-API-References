...
description: "Implementa il campo CREATEDATE in Java."
type: docs
weight: 215
url: /it/java/com.aspose.words/fieldcreatedate/
---
...
Implementa il campo CREATEDATE.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera la data e l'ora in cui il documento è stato creato. Per impostazione predefinita, viene utilizzato il calendario gregoriano.
...
| [getUseLunarCalendar()](#getUseLunarCalendar) | Restituisce se utilizzare il calendario lunare Hijri o quello ebraico. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | Restituisce se utilizzare il calendario dell'Era Saka. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | Restituisce se utilizzare il calendario Um-al-Qura. |
...
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | Imposta se utilizzare il calendario lunare Hijri o quello ebraico. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | Imposta se utilizzare il calendario dell'Era Saka. |
| [setUseUmAlQuraCalendar(boolean value)](#setUseUmAlQuraCalendar-boolean) | Imposta se utilizzare il calendario Um-al-Qura. |
...
Restituisce se utilizzare il calendario lunare Hijri o quello ebraico.

**Returns:**
boolean - Indica se utilizzare il calendario lunare Hijri o quello ebraico.
...
Restituisce se utilizzare il calendario dell'Era Saka.

**Returns:**
boolean - Indica se utilizzare il calendario dell'Era Saka.
...
Restituisce se utilizzare il calendario Um-al-Qura.

**Returns:**
boolean - Indica se utilizzare il calendario Um-al-Qura.
### isDirty() {#isDirty}
```
...
Imposta se utilizzare il calendario lunare Hijri o quello ebraico.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se utilizzare il calendario lunare Hijri o quello ebraico. |
...
Imposta se utilizzare il calendario dell'Era Saka.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Specifica se utilizzare il calendario Saka Era. |
...
Imposta se utilizzare il calendario Um-al-Qura.

**Parameters:**
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Specifica se utilizzare il calendario Um-al-Qura. |
