...
description: "Implementa il campo FILESIZE in Java."
type: docs
weight: 231
url: /it/java/com.aspose.words/fieldfilesize/
---
...
Nell'implementazione corrente, utilizza la proprietà [Document.getOriginalFileName()](../../com.aspose.words/document/\\#getOriginalFileName) per recuperare il nome del file usato per determinare la dimensione del file.
...
| [isInKilobytes()](#isInKilobytes) | Ottiene se visualizzare la dimensione del file in kilobyte. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Imposta se visualizzare la dimensione del file in kilobyte. |
| [isInMegabytes()](#isInMegabytes) | Ottiene se visualizzare la dimensione del file in megabyte. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Imposta se visualizzare la dimensione del file in megabyte. |
...
Ottiene se visualizzare la dimensione del file in kilobyte.
...
**Returns:**
boolean - Indica se visualizzare la dimensione del file in kilobyte.
...
Imposta se visualizzare la dimensione del file in kilobyte.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se visualizzare la dimensione del file in kilobyte. |
...
Ottiene se visualizzare la dimensione del file in megabyte.
...
**Returns:**
boolean - Indica se visualizzare la dimensione del file in megabyte.
...
Imposta se visualizzare la dimensione del file in megabyte.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se visualizzare la dimensione del file in megabyte. |
