...
description: "Fornisce l'accesso alle proprietà della forma del grafico in Java."
type: docs
weight: 66
url: /it/java/com.aspose.words/chart/
---
...
| Metodo | Descrizione |
| --- | --- |
| [getAxes()](#getAxes) | Ottiene una collezione di tutti gli assi di questo grafico. |
| [getAxisX()](#getAxisX) | Fornisce l'accesso alle proprietà dell'asse X primario del grafico. |
| [getAxisY()](#getAxisY) | Fornisce l'accesso alle proprietà dell'asse Y primario del grafico. |
| [getAxisZ()](#getAxisZ) | Fornisce l'accesso alle proprietà dell'asse Z del grafico. |
| [getDataTable()](#getDataTable) | Fornisce l'accesso alle proprietà di una tabella dati di questo grafico. |
| [getFormat()](#getFormat) | Fornisce l'accesso alla formattazione di riempimento e linea del grafico. |
| [getLegend()](#getLegend) | Fornisce l'accesso alle proprietà della legenda del grafico. |
| [getSeries()](#getSeries) | Fornisce l'accesso alla raccolta di serie. |
| [getSeriesGroups()](#getSeriesGroups) | Fornisce l'accesso a una raccolta di gruppi di serie di questo grafico. |
| [getShapeType()](#getShapeType) |  |
| [getSourceFullName()](#getSourceFullName) | Ottiene il percorso e il nome di un file xls/xlsx a cui questo grafico è collegato. |
| [getStyle()](#getStyle) | Ottiene lo stile del grafico. |
| [getTitle()](#getTitle) | Fornisce l'accesso alle proprietà del titolo del grafico. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Ottiene il percorso e il nome di un file xls/xlsx a cui questo grafico è collegato. |
| [setStyle(int value)](#setStyle-int) | Imposta lo stile del grafico. |
### getAxes() {#getAxes}
```
...
Fornisce l'accesso alle proprietà di una tabella dati di questo grafico. La tabella dati può essere visualizzata utilizzando la proprietà [ChartDataTable.getShow()](../../com.aspose.words/chartdatatable/\#getShow) / [ChartDataTable.setShow(boolean)](../../com.aspose.words/chartdatatable/\#setShow-boolean).
...
Fornisce l'accesso alla formattazione di riempimento e linea del grafico.
...
**Returns:**
java.lang.String - Il percorso e il nome di un file xls/xlsx a cui questo grafico è collegato.
### getStyle() {#getStyle}
```
public int getStyle()
```
...
Ottiene lo stile del grafico.

**Returns:**
int - Lo stile del grafico. Il valore restituito è uno dei costanti [ChartStyle](../../com.aspose.words/chartstyle/).
### getTitle() {#getTitle}
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il percorso e il nome di un file xls/xlsx a cui questo grafico è collegato. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Lo stile del grafico. Il valore deve essere uno dei costanti [ChartStyle](../../com.aspose.words/chartstyle/). |
