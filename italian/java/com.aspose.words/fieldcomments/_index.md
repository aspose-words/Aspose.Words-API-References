...
description: "Implementa il campo COMMENTS in Java."
type: docs
weight: 213
url: /it/java/com.aspose.words/fieldcomments/
---
...
Implementa il campo COMMENTS.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, e opzionalmente imposta, i commenti relativi al documento corrente, come registrato nella proprietà [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) delle proprietà del documento integrate.
...
| [getText()](#getText) | Recupera il testo dei commenti. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo dei commenti. |
...
Recupera il testo dei commenti.
...
**Returns:**
java.lang.String - Il testo dei commenti.
### getType() {#getType}
```
public int getType()
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo dei commenti. |
