...
description: "Implementa il campo ADVANCE in Java."
type: docs
weight: 197
url: /it/java/com.aspose.words/fieldadvance/
---
...
Sposta il punto di partenza in cui il testo che segue lessicalmente il campo viene visualizzato a destra o a sinistra, in alto o in basso, o a una posizione orizzontale o verticale specifica.
...
| [getDownOffset()](#getDownOffset) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo. |
| [getLeftOffset()](#getLeftOffset) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra. |
...
| [getRightOffset()](#getRightOffset) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato a destra. |
...
| [getUpOffset()](#getUpOffset) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto. |
| [getVerticalPosition()](#getVerticalPosition) | Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato a destra. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina. |
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso.
### getEnd() {#getEnd}
```
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo.
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra.
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato a destra.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato a destra.
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto.
...
Restituisce il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina.
...
**Returns:**
java.lang.String - Il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina.
### isDirty() {#isDirty}
```
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato verso il basso. |
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato orizzontalmente dal bordo sinistro della colonna, del riquadro o della casella di testo. |
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato a sinistra. |
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato a destra.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato a destra. |
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato verso l'alto. |
...
Imposta il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il numero di punti di cui il testo che segue il campo deve essere spostato verticalmente dal bordo superiore della pagina. |
