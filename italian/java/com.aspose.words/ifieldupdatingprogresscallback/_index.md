...
description: "Implementa questa interfaccia se desideri monitorare l'avanzamento dell'aggiornamento dei campi in Java."
type: docs
weight: 769
url: /it/java/com.aspose.words/ifieldupdatingprogresscallback/
---
```
public interface IFieldUpdatingProgressCallback
```

Implementa questa interfaccia se vuoi monitorare l'avanzamento dell'aggiornamento del campo.
...
| Metodo | Descrizione |
| --- | --- |
| [notify(FieldUpdatingProgressArgs args)](#notify-com.aspose.words.FieldUpdatingProgressArgs) | Un metodo definito dall'utente che viene chiamato quando l'avanzamento dell'aggiornamento cambia. |
...
Un metodo definito dall'utente che viene chiamato quando l'avanzamento dell'aggiornamento cambia.
