...
description: "Implementa il campo SEQ in Java."
type: docs
weight: 284
url: /it/java/com.aspose.words/fieldseq/
---
...
Numera sequenzialmente capitoli, tabelle, figure e altre liste di elementi definite dall'utente in un documento.
...
| Metodo | Descrizione |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Ottiene un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente. |
...
| [getInsertNextNumber()](#getInsertNextNumber) | Ottiene se inserire il prossimo numero di sequenza per l'elemento specificato. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getResetHeadingLevel()](#getResetHeadingLevel) | Ottiene un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza. |
| [getResetNumber()](#getResetNumber) | Ottiene un numero intero a cui ripristinare il numero di sequenza. |
...
| [getSequenceIdentifier()](#getSequenceIdentifier) | Ottiene il nome assegnato alla serie di elementi che devono essere numerati. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Imposta un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente. |
| [setInsertNextNumber(boolean value)](#setInsertNextNumber-boolean) | Imposta se inserire il prossimo numero di sequenza per l'elemento specificato. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setResetHeadingLevel(String value)](#setResetHeadingLevel-java.lang.String) | Imposta un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza. |
| [setResetNumber(String value)](#setResetNumber-java.lang.String) | Imposta un numero intero a cui ripristinare il numero di sequenza. |
...
| [setSequenceIdentifier(String value)](#setSequenceIdentifier-java.lang.String) | Imposta il nome assegnato alla serie di elementi che devono essere numerati. |
...
Ottiene un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente.
...
**Returns:**
java.lang.String - Un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente.
...
Ottiene se inserire il prossimo numero di sequenza per l'elemento specificato.
...
**Returns:**
boolean - Se inserire il prossimo numero di sequenza per l'elemento specificato.
...
Ottiene un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza. Restituisce -1 se il numero è assente.
...
**Returns:**
java.lang.String - Un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza.
...
Ottiene un numero intero a cui ripristinare il numero di sequenza. Restituisce -1 se il numero è assente.
...
**Returns:**
java.lang.String - Un numero intero a cui ripristinare il numero di sequenza.
### getResult() {#getResult}
```
...
Ottiene il nome assegnato alla serie di elementi che devono essere numerati.
...
**Returns:**
java.lang.String - Il nome assegnato alla serie di elementi che devono essere numerati.
### getStart() {#getStart}
```
...
Imposta un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un nome di segnalibro che si riferisce a un elemento altrove nel documento anziché nella posizione corrente. |
...
Imposta se inserire il prossimo numero di sequenza per l'elemento specificato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire il prossimo numero di sequenza per l'elemento specificato. |
...
Imposta un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza. Restituisce -1 se il numero è assente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un numero intero che rappresenta il livello di intestazione a cui ripristinare il numero di sequenza. |
...
Imposta un numero intero a cui ripristinare il numero di sequenza. Restituisce -1 se il numero è assente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un numero intero a cui ripristinare il numero di sequenza. |
...
Imposta il nome assegnato alla serie di elementi che devono essere numerati.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome assegnato alla serie di elementi che devono essere numerati. |
