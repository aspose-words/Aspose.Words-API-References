...
description: "Fornisce metodi per renderizzare una singola Shape o GroupShape in un'immagine raster o vettoriale o in un oggetto Graphics in Java."
type: docs
weight: 616
url: /it/java/com.aspose.words/shaperenderer/
---
...
Fornisce metodi per renderizzare una singola [Shape](../../com.aspose.words/shape/) o [GroupShape](../../com.aspose.words/groupshape/) in un'immagine raster o vettoriale o in un oggetto Graphics.
...
| --- | --- |
| [ShapeRenderer(ShapeBase shape)](#ShapeRenderer-com.aspose.words.ShapeBase) | Inizializza una nuova istanza di questa classe. |
## Metodi
...
| --- | --- | --- |
| shape | [ShapeBase](../../com.aspose.words/shapebase/) | L'oggetto shape DrawinML che desideri renderizzare. |
