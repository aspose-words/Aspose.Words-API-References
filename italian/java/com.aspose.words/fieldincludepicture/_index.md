...
description: "Implementa il campo INCLUDEPICTURE in Java."
type: docs
weight: 247
url: /it/java/com.aspose.words/fieldincludepicture/
---
...
| [getGraphicFilter()](#getGraphicFilter) | Ottiene il nome del filtro per il formato della grafica da inserire. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getResizeHorizontally()](#getResizeHorizontally) | Ottiene se ridimensionare l'immagine orizzontalmente dalla sorgente. |
| [getResizeVertically()](#getResizeVertically) | Ottiene se ridimensionare l'immagine verticalmente dalla sorgente. |
...
| [getSourceFullName()](#getSourceFullName) | Ottiene la posizione dell'immagine usando un IRI. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Imposta il nome del filtro per il formato della grafica da inserire. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Imposta se ridimensionare l'immagine orizzontalmente dalla sorgente. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Imposta se ridimensionare l'immagine verticalmente dalla sorgente. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Imposta la posizione dell'immagine usando un IRI. |
...
Ottiene il nome del filtro per il formato della grafica da inserire.
...
**Returns:**
java.lang.String - Il nome del filtro per il formato della grafica da inserire.
...
Ottiene se ridimensionare l'immagine orizzontalmente dalla sorgente.
...
**Returns:**
boolean - Se ridimensionare l'immagine orizzontalmente dalla sorgente.
...
Ottiene se ridimensionare l'immagine verticalmente dalla sorgente.
...
**Returns:**
boolean - Se ridimensionare l'immagine verticalmente dalla sorgente.
### getResult() {#getResult}
```
...
Ottiene la posizione dell'immagine usando un IRI.
...
**Returns:**
java.lang.String - La posizione dell'immagine usando un IRI.
### getStart() {#getStart}
```
...
Imposta il nome del filtro per il formato della grafica da inserire.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del filtro per il formato della grafica da inserire. |
...
Imposta se ridimensionare l'immagine orizzontalmente dalla sorgente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se ridimensionare l'immagine orizzontalmente dalla sorgente. |
...
Imposta se ridimensionare l'immagine verticalmente dalla sorgente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se ridimensionare l'immagine verticalmente dalla sorgente. |
...
Imposta la posizione dell'immagine usando un IRI.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La posizione dell'immagine utilizzando un IRI. |
