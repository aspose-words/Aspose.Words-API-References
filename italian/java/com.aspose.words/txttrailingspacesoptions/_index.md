...
description: "Specifica le opzioni disponibili per la gestione degli spazi finali durante l'importazione da file LoadFormat.TEXT in Java."
type: docs
weight: 697
url: /it/java/com.aspose.words/txttrailingspacesoptions/
---
...
Specifica le opzioni disponibili per la gestione degli spazi finali durante l'importazione da file [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT).
...
| Campo | Descrizione |
| --- | --- |
| [PRESERVE](#PRESERVE) | Gli spazi finali vengono conservati. |
| [TRIM](#TRIM) | Gli spazi finali vengono rimossi. |
| [length](#length) |  |
## Metodi
...
Gli spazi finali vengono conservati.
...
Gli spazi finali vengono rimossi.
