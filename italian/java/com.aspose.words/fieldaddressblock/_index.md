...
description: "Implementa il campo ADDRESSBLOCK in Java."
type: docs
weight: 196
url: /it/java/com.aspose.words/fieldaddressblock/
---
...
Rappresenta un blocco di indirizzo. Un *address block* è un blocco di testo che specifica le informazioni appropriate per un indirizzo postale, nell'ordine richiesto dal paese di destinazione.

 **Examples:** 

Mostra come ottenere i nomi dei campi di unione di stampa utilizzati dal campo.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Ottiene il nome del paese/regione escluso. |
...
| [getFieldNames()](#getFieldNames) | Restituisce una raccolta di nomi di campi di stampa unione utilizzati dal campo. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Ottiene se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Ottiene se includere il nome del paese/regione. |
| [getLanguageId()](#getLanguageId) | Ottiene l'ID lingua utilizzato per formattare l'indirizzo. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Ottiene il formato del nome e dell'indirizzo. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Imposta il nome del paese/regione escluso. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Imposta se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006). |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Imposta se includere il nome del paese/regione. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Imposta l'ID lingua utilizzato per formattare l'indirizzo. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Imposta il formato del nome e dell'indirizzo. |
...
Ottiene il nome del paese/regione escluso.
...
**Returns:**
java.lang.String - Il nome del paese/regione escluso.
...
Ottiene se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006).
...
**Returns:**
boolean - Se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006).
...
Ottiene se includere il nome del paese/regione.
...
**Returns:**
java.lang.String - Se includere il nome del paese/regione.
...
Ottiene l'ID lingua utilizzato per formattare l'indirizzo.
...
**Returns:**
java.lang.String - L'ID lingua utilizzato per formattare l'indirizzo.
...
Ottiene il formato del nome e dell'indirizzo.
...
**Returns:**
java.lang.String - Il formato del nome e dell'indirizzo.
### getResult() {#getResult}
```
...
Imposta il nome del paese/regione escluso.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del paese/regione escluso. |
...
Imposta se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se formattare l'indirizzo in base al paese/regione del destinatario come definito da POST\*CODE (Universal Postal Union 2006). |
...
Imposta se includere il nome del paese/regione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Se includere il nome del paese/regione. |
...
Imposta l'ID lingua utilizzato per formattare l'indirizzo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'ID lingua utilizzato per formattare l'indirizzo. |
...
Imposta il formato del nome e dell'indirizzo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il formato del nome e dell'indirizzo. |
