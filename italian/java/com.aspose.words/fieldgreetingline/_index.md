...
description: "Implementa il campo GREETINGLINE in Java."
type: docs
weight: 241
url: /it/java/com.aspose.words/fieldgreetingline/
---
...
Inserisce una riga di saluto per l'unione di stampa.
...
| Metodo | Descrizione |
| --- | --- |
| [getAlternateText()](#getAlternateText) | Ottiene il testo da includere nel campo se il nome è vuoto. |
...
| [getLanguageId()](#getLanguageId) | Ottiene l'ID lingua utilizzato per formattare il nome. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | Ottiene il formato del nome incluso nel campo. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | Imposta il testo da includere nel campo se il nome è vuoto. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Imposta l'ID lingua utilizzato per formattare il nome. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Imposta il formato del nome incluso nel campo. |
...
Ottiene il testo da includere nel campo se il nome è vuoto.
...
**Returns:**
java.lang.String - Il testo da includere nel campo se il nome è vuoto.
...
Ottiene l'ID lingua utilizzato per formattare il nome.
...
**Returns:**
java.lang.String - L'ID lingua utilizzato per formattare il nome.
...
Ottiene il formato del nome incluso nel campo.
...
**Returns:**
java.lang.String - Il formato del nome incluso nel campo.
### getResult() {#getResult}
```
...
Imposta il testo da includere nel campo se il nome è vuoto.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo da includere nel campo se il nome è vuoto. |
...
Imposta l'ID lingua utilizzato per formattare il nome.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'ID lingua utilizzato per formattare il nome. |
...
Imposta il formato del nome incluso nel campo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il formato del nome incluso nel campo. |
