...
description: "Tipi di entità di layout in Java."
type: docs
weight: 416
url: /it/java/com.aspose.words/layoutentitytype/
---
...
| [COLUMN](#COLUMN) | Rappresenta una colonna di testo su una pagina. |
| [COMMENT](#COMMENT) | Rappresenta un segnaposto per il contenuto del commento. |
| [ENDNOTE](#ENDNOTE) | Rappresenta un segnaposto per il contenuto della nota finale. |
| [FOOTNOTE](#FOOTNOTE) | Rappresenta un segnaposto per il contenuto della nota a piè di pagina. |
| [HEADER_FOOTER](#HEADER-FOOTER) | Rappresenta un segnaposto per il contenuto dell'intestazione/piè di pagina su una pagina. |
| [LINE](#LINE) | Rappresenta una riga di caratteri di testo e oggetti in linea. |
| [NONE](#NONE) | Valore predefinito. |
| [NOTE](#NOTE) | Rappresenta un segnaposto per il contenuto della nota. |
| [NOTE_SEPARATOR](#NOTE-SEPARATOR) | Rappresenta il separatore della nota a piè di pagina/nota finale. |
| [PAGE](#PAGE) | Rappresenta una pagina di un documento. |
| [ROW](#ROW) | Rappresenta una riga di tabella. |
| [SPAN](#SPAN) | Rappresenta uno o più caratteri in una riga. |
| [TEXT_BOX](#TEXT-BOX) | Rappresenta l'area di testo all'interno di una forma. |
| [length](#length) |  |
## Metodi
...
Rappresenta una cella di tabella. La cella può contenere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW).
...
Rappresenta una colonna di testo su una pagina. La colonna può avere le stesse entità figlio di [CELL](../../com.aspose.words/layoutentitytype/\#CELL), più le entità [FOOTNOTE](../../com.aspose.words/layoutentitytype/\#FOOTNOTE), [ENDNOTE](../../com.aspose.words/layoutentitytype/\#ENDNOTE) e [NOTE\_SEPARATOR](../../com.aspose.words/layoutentitytype/\#NOTE-SEPARATOR).
...
Rappresenta un segnaposto per il contenuto del commento. Comment può avere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW) child entities.
...
Rappresenta un segnaposto per il contenuto della nota finale. Endnote può avere entità figlio [NOTE](../../com.aspose.words/layoutentitytype/\#NOTE) child entities.
...
Rappresenta un segnaposto per il contenuto della nota a piè di pagina. Footnote può avere entità figlio [NOTE](../../com.aspose.words/layoutentitytype/\#NOTE) child entities.
...
Rappresenta un segnaposto per il contenuto dell'intestazione/piè di pagina su una pagina. HeaderFooter può avere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW) child entities.
...
Rappresenta una linea di caratteri di testo e oggetti in linea. Line può avere entità figlio [SPAN](../../com.aspose.words/layoutentitytype/\#SPAN) child entities.
...
Rappresenta un segnaposto per il contenuto della nota. Note può avere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW) child entities.
...
Rappresenta il separatore di nota a piè di pagina/nota finale. NoteSeparator può avere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW) child entities.
...
Rappresenta una pagina di un documento. Page può avere entità figlio [COLUMN](../../com.aspose.words/layoutentitytype/\#COLUMN), [HEADER\_FOOTER](../../com.aspose.words/layoutentitytype/\#HEADER-FOOTER) e [COMMENT](../../com.aspose.words/layoutentitytype/\#COMMENT) child entities.
...
Rappresenta una riga di tabella. Row può avere [CELL](../../com.aspose.words/layoutentitytype/\#CELL) as child entities.
...
Rappresenta uno o più caratteri in una linea. Questo include caratteri speciali come marcatori di inizio/fine campo, segnalibri e commenti. Span may not have child entities.
...
Rappresenta l'area di testo all'interno di una forma. Textbox può avere entità figlio [LINE](../../com.aspose.words/layoutentitytype/\#LINE) e [ROW](../../com.aspose.words/layoutentitytype/\#ROW) child entities.
