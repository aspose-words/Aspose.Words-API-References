...
description: "Implementa il campo KEYWORDS in Java."
type: docs
weight: 252
url: /it/java/com.aspose.words/fieldkeywords/
---
...
Recupera, e opzionalmente imposta, le parole chiave del documento, come registrate nella proprietà **Keywords** delle proprietà incorporate del documento.
...
| [getText()](#getText) | Ottiene il testo delle parole chiave. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo delle parole chiave. |
...
Ottiene il testo delle parole chiave.
...
**Returns:**
java.lang.String - Il testo delle parole chiave.
### getType() {#getType}
```
public int getType()
```
...
Imposta il testo delle parole chiave.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo delle parole chiave. |
