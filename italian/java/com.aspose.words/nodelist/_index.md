...
description: "Rappresenta una raccolta di nodi che corrispondono a una query XPath eseguita utilizzando il metodo CompositeNode.selectNodesjava.lang.String in Java."
type: docs
weight: 481
url: /it/java/com.aspose.words/nodelist/
---
...
Rappresenta una raccolta di nodi che corrispondono a una query XPath eseguita utilizzando il metodo [CompositeNode.selectNodes(java.lang.String)](../../com.aspose.words/compositenode/\#selectNodes-java.lang.String).
...
| [getCount()](#getCount) | Ottiene il numero di nodi nella lista. |
...
Mostra come utilizzare gli XPaths per navigare una NodeList.
...
| --- | --- | --- |
| indice | int | Un indice nella lista dei nodi. |
...
Ottiene il numero di nodi nella lista.
...
**Returns:**
int - Il numero di nodi nella lista.
### iterator() {#iterator}
```
