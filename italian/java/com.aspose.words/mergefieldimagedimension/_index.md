...
description: "Rappresenta una dimensione dell'immagine, ad es. in Java."
type: docs
weight: 462
url: /it/java/com.aspose.words/mergefieldimagedimension/
---
...
Rappresenta una dimensione dell'immagine (cioè la larghezza o l'altezza) utilizzata durante un processo di stampa unione.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Per indicare che l'immagine dovrebbe essere inserita con la sua dimensione originale durante una stampa unione, è necessario assegnare un valore negativo alla proprietà [getValue()](../../com.aspose.words/mergefieldimagedimension/\#getValue) / [setValue(double)](../../com.aspose.words/mergefieldimagedimension/\#setValue-double).
...
| --- | --- |
| [MergeFieldImageDimension(double value)](#MergeFieldImageDimension-double) | Crea un'istanza di dimensione dell'immagine con il valore fornito in punti. |
| [MergeFieldImageDimension(double value, int unit)](#MergeFieldImageDimension-double-int) | Inizializza una nuova istanza di questa classe. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getUnit()](#getUnit) | L'unità. |
| [getValue()](#getValue) | Il valore. |
| [setUnit(int value)](#setUnit-int) | L'unità. |
| [setValue(double value)](#setValue-double) | Il valore. |
...
Crea un'istanza di dimensione dell'immagine con il valore fornito in punti.

 **Remarks:** 

È necessario utilizzare un valore negativo per indicare che il valore originale della dimensione dell'immagine corrispondente deve essere applicato.
...
**Returns:**
int - Il valore int corrispondente. Il valore restituito è una delle costanti [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/).
### getValue() {#getValue}
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Il valore int corrispondente. Il valore deve essere una delle costanti [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/). |
