...
description: "Implementa il campo FILENAME in Java."
type: docs
weight: 230
url: /it/java/com.aspose.words/fieldfilename/
---
...
Nell'implementazione corrente, utilizza la proprietà [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) per recuperare il nome del file. Se il documento è stato caricato da uno stream o creato vuoto, utilizza il nome del file in cui viene salvato (se noto).

 **Examples:** 

Mostra come utilizzare FieldOptions per sovrascrivere il valore predefinito del campo FILENAME.
