...
description: "Specifica la variante per un riempimento gradiente in Java."
type: docs
weight: 365
url: /it/java/com.aspose.words/gradientvariant/
---
...
Specifica la variante per un riempimento a gradiente.

 **Remarks:** 

Corrisponde alle quattro varianti nella scheda Gradient del dialogo Riempimento effetti in Word.
...
| Campo | Descrizione |
| --- | --- |
| [NONE](#NONE) | Variante gradiente 'None'. |
| [VARIANT_1](#VARIANT-1) | Variante gradiente 1. |
| [VARIANT_2](#VARIANT-2) | Variante gradiente 2. |
| [VARIANT_3](#VARIANT-3) | Variante gradiente 3. |
| [VARIANT_4](#VARIANT-4) | Variante gradiente 4. |
| [length](#length) |  |
## Metodi
...
Variante gradiente 3.

 **Remarks:** 

Questa variante non è applicabile al riempimento gradiente con lo stile [GradientStyle.FROM\_CENTER](../../com.aspose.words/gradientstyle/\#FROM-CENTER), se l'oggetto utilizza il linguaggio di markup [ShapeMarkupLanguage.VML](../../com.aspose.words/shapemarkuplanguage/\#VML).
