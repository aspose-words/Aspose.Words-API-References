...
description: "Implementa questa interfaccia se desideri avere un tuo metodo personalizzato chiamato durante un'operazione di ricerca e sostituzione in Java."
type: docs
weight: 781
url: /it/java/com.aspose.words/ireplacingcallback/
---
```
...
| Metodo | Descrizione |
| --- | --- |
| [replacing(ReplacingArgs args)](#replacing-com.aspose.words.ReplacingArgs) | Un metodo definito dall'utente che viene chiamato durante un'operazione di sostituzione per ogni corrispondenza trovata appena prima che la sostituzione venga eseguita. |
...
Un metodo definito dall'utente che viene chiamato durante un'operazione di sostituzione per ogni corrispondenza trovata appena prima che la sostituzione venga eseguita.
...
**Returns:**
int - Un valore [ReplaceAction](../../com.aspose.words/replaceaction/) che specifica l'azione da eseguire per la corrispondenza corrente. Il valore restituito è una delle costanti [ReplaceAction](../../com.aspose.words/replaceaction/).
