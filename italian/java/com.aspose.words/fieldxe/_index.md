...
description: "Implementa il campo XE in Java."
type: docs
weight: 306
url: /it/java/com.aspose.words/fieldxe/
---
...
Definisce il testo e il numero di pagina per una voce di indice, che è utilizzata da un campo INDEX.
...
| [getEntryType()](#getEntryType) | Ottiene un tipo di voce di indice. |
...
| [getPageNumberReplacement()](#getPageNumberReplacement) | Ottiene il testo usato al posto di un numero di pagina. |
| [getPageRangeBookmarkName()](#getPageRangeBookmarkName) | Ottiene il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce. |
...
| [getText()](#getText) | Ottiene il testo della voce. |
| [getType()](#getType) | Ottiene il tipo di campo di Microsoft Word. |
| [getYomi()](#getYomi) | Ottiene lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce di indice |
| [isBold()](#isBold) | Ottiene se applicare la formattazione grassetto al numero di pagina della voce. |
| [isBold(boolean value)](#isBold-boolean) | Imposta se applicare la formattazione grassetto al numero di pagina della voce. |
...
| [isItalic()](#isItalic) | Ottiene se applicare la formattazione corsivo al numero di pagina della voce. |
| [isItalic(boolean value)](#isItalic-boolean) | Imposta se applicare la formattazione corsivo al numero di pagina della voce. |
...
| [setEntryType(String value)](#setEntryType-java.lang.String) | Imposta un tipo di voce di indice. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setPageNumberReplacement(String value)](#setPageNumberReplacement-java.lang.String) | Imposta il testo usato al posto di un numero di pagina. |
| [setPageRangeBookmarkName(String value)](#setPageRangeBookmarkName-java.lang.String) | Imposta il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo della voce. |
| [setYomi(String value)](#setYomi-java.lang.String) | Imposta lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce di indice |
...
Ottiene un tipo di voce di indice.
...
**Returns:**
java.lang.String - Un tipo di voce di indice.
...
Ottiene il testo usato al posto di un numero di pagina.
...
**Returns:**
java.lang.String - Testo usato al posto di un numero di pagina.
...
Ottiene il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce.
...
**Returns:**
java.lang.String - Il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce.
### getResult() {#getResult}
```
...
**Returns:**
java.lang.String - Il testo della voce.
### getType() {#getType}
```
public int getType()
```
...
Ottiene lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce di indice
...
**Returns:**
java.lang.String - Lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce dell'indice
### isBold() {#isBold}
```
...
Ottiene se applicare la formattazione grassetto al numero di pagina della voce.
...
**Returns:**
boolean - Indica se applicare la formattazione grassetto al numero di pagina della voce.
...
Imposta se applicare la formattazione grassetto al numero di pagina della voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se applicare la formattazione grassetto al numero di pagina della voce. |
...
Ottiene se applicare la formattazione corsivo al numero di pagina della voce.
...
**Returns:**
boolean - Indica se applicare la formattazione corsivo al numero di pagina della voce.
...
Imposta se applicare la formattazione corsivo al numero di pagina della voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se applicare la formattazione corsivo al numero di pagina della voce. |
...
Imposta un tipo di voce di indice.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un tipo di voce di indice. |
...
Imposta il testo usato al posto di un numero di pagina.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Testo usato al posto di un numero di pagina. |
...
Imposta il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del segnalibro che indica un intervallo di pagine inserito come numero di pagina della voce. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo della voce. |
...
Imposta lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce di indice
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Lo yomi (primo carattere fonetico per l'ordinamento degli indici) per la voce dell'indice |
