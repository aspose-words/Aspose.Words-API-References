...
description: "Rappresenta un singolo intervallo modificabile in Java."
type: docs
weight: 179
url: /it/java/com.aspose.words/editablerange/
---
...
| Metodo | Descrizione |
| --- | --- |
| [getEditableRangeEnd()](#getEditableRangeEnd) | Ottiene il nodo che rappresenta la fine dell'intervallo modificabile. |
| [getEditableRangeStart()](#getEditableRangeStart) | Ottiene il nodo che rappresenta l'inizio dell'intervallo modificabile. |
| [getEditorGroup()](#getEditorGroup) | Ottiene un alias (o gruppo di modifica) che verrà utilizzato per determinare se l'utente corrente può modificare questo intervallo modificabile. |
| [getId()](#getId) | Ottiene l'identificatore dell'intervallo modificabile. |
| [getSingleUser()](#getSingleUser) | Ottiene l'utente singolo per l'intervallo modificabile. |
| [remove()](#remove) | Rimuove l'intervallo modificabile dal documento. |
| [setEditorGroup(int value)](#setEditorGroup-int) | Imposta un alias (o gruppo di modifica) che verrà utilizzato per determinare se l'utente corrente può modificare questo intervallo modificabile. |
| [setSingleUser(String value)](#setSingleUser-java.lang.String) | Imposta l'utente singolo per l'intervallo modificabile. |
...
Ottiene un alias (o gruppo di modifica) che verrà utilizzato per determinare se l'utente corrente può modificare questo intervallo modificabile.

 **Remarks:** 

L'utente singolo e il gruppo di editor non possono essere impostati simultaneamente per lo specifico intervallo modificabile; se uno è impostato, l'altro verrà cancellato.
...
**Returns:**
int - Un alias (o gruppo di modifica) che verrà utilizzato per determinare se l'utente corrente può modificare questo intervallo modificabile. Il valore restituito è una delle costanti [EditorType](../../com.aspose.words/editortype/).
### getId() {#getId}
```
public int getId()
```
...
La regione deve essere delimitata usando [getEditableRangeStart()](../../com.aspose.words/editablerange/\#getEditableRangeStart) e [getEditableRangeEnd()](../../com.aspose.words/editablerange/\#getEditableRangeEnd)

Gli identificatori degli intervalli modificabili devono essere unici all'interno di un documento e Aspose.Words mantiene automaticamente gli identificatori degli intervalli modificabili durante il caricamento, il salvataggio e la combinazione dei documenti.
...
**Returns:**
int - L'identificatore dell'intervallo modificabile.
...
Ottiene l'utente singolo per l'intervallo modificabile.

 **Remarks:** 

Questo editor può essere memorizzato in una delle seguenti forme:
...
user - per gli utenti il cui accesso deve essere autenticato utilizzando le credenziali della macchina dell'utente corrente.
...
**Returns:**
java.lang.String - L'utente unico per l'intervallo modificabile.
### remove() {#remove}
```
public void remove()
```
...
Imposta un alias (o gruppo di modifica) che verrà utilizzato per determinare se l'utente corrente può modificare questo intervallo modificabile.
...
| --- | --- | --- |
| value | int | Un alias (o gruppo di modifica) che deve essere usato per determinare se all'utente corrente è consentito modificare questo intervallo modificabile. Il valore deve essere una delle costanti [EditorType](../../com.aspose.words/editortype/). |
...
Imposta l'utente singolo per l'intervallo modificabile.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'utente unico per l'intervallo modificabile. |
