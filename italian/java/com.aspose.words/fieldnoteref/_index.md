...
description: "Implementa il campo NOTEREF in Java."
type: docs
weight: 265
url: /it/java/com.aspose.words/fieldnoteref/
---
...
Inserisce il segno della nota a piè di pagina o della nota finale contrassegnato dal segnalibro specificato.

 **Examples:** 

Mostra come inserire campi NOTEREF e modificare il loro aspetto.
...
Mostra come fare riferimenti incrociati alle note a piè di pagina con il campo NOTEREF.
...
| [getInsertHyperlink()](#getInsertHyperlink) | Restituisce se inserire un collegamento ipertestuale al paragrafo con segnalibro. |
| [getInsertReferenceMark()](#getInsertReferenceMark) | Inserisce il segno di riferimento con la stessa formattazione dei caratteri dello stile Riferimento Nota a piè di pagina o Riferimento Nota finale. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Restituisce se inserire una posizione relativa del paragrafo con segnalibro. |
...
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Imposta se inserire un collegamento ipertestuale al paragrafo contrassegnato. |
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Inserisce il segno di riferimento con la stessa formattazione dei caratteri dello stile Riferimento Nota a piè di pagina o Riferimento Nota finale. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Imposta se inserire una posizione relativa del paragrafo contrassegnato. |
...
Restituisce se inserire un collegamento ipertestuale al paragrafo con segnalibro.
...
**Returns:**
boolean - Se inserire un collegamento ipertestuale al paragrafo contrassegnato.
...
Restituisce se inserire una posizione relativa del paragrafo con segnalibro.
...
**Returns:**
boolean - Se inserire una posizione relativa del paragrafo contrassegnato.
...
Imposta se inserire un collegamento ipertestuale al paragrafo contrassegnato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire un collegamento ipertestuale al paragrafo contrassegnato. |
...
Imposta se inserire una posizione relativa del paragrafo contrassegnato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire una posizione relativa del paragrafo contrassegnato. |
