...
description: "Specifica le impostazioni del meccanismo di fallback dei font in Java."
type: docs
weight: 323
url: /it/java/com.aspose.words/fontfallbacksettings/
---
...
Per impostazione predefinita, le impostazioni di fallback sono inizializzate con impostazioni predefinite che imitano il fallback di Microsoft Word.
...
| Metodo | Descrizione |
| --- | --- |
| [buildAutomatic()](#buildAutomatic) | Crea automaticamente le impostazioni di fallback scansionando i font disponibili. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | Carica le impostazioni di fallback dei font da un file XML. |
...
| [save(String fileName)](#save-java.lang.String) | Salva le impostazioni di fallback correnti su file. |
...
Crea automaticamente le impostazioni di fallback scansionando i font disponibili.

 **Remarks:** 

Questo metodo può produrre impostazioni di fallback non ottimali. I font sono controllati tramite i campi [ Unicode Character Range ][Unicode Character Range] e non dalla presenza effettiva dei glifi. Inoltre gli intervalli Unicode sono controllati individualmente e diversi intervalli relativi a una singola lingua/script possono utilizzare font di fallback differenti.
...
Mostra come caricare e salvare le impostazioni di fallback dei font da/a un documento XML nel file system locale.
...
Mostra come aggiungere impostazioni di fallback dei font predefinite per i font Google Noto.
