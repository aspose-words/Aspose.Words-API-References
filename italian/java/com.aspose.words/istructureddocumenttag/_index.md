...
description: "Interfaccia per definire dati comuni per StructuredDocumentTag e StructuredDocumentTagRangeStart in Java."
type: docs
weight: 785
url: /it/java/com.aspose.words/istructureddocumenttag/
---
```
public interface IStructuredDocumentTag
```

Interfaccia per definire dati comuni per [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) e [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).
...
| [getId()](#getId) | Specifica un Id numerico persistente univoco di sola lettura per questo **SDT**. |
| [getLevel()](#getLevel) | Ottiene il livello al quale questo **SDT** si trova nell'albero del documento. |
| [getLockContentControl()](#getLockContentControl) | Quando impostata su true, questa proprietà impedirà a un utente di eliminare questo **SDT**. |
| [getLockContents()](#getLockContents) | Quando impostata su true, questa proprietà impedirà a un utente di modificare il contenuto di questo **SDT**. |
| [getNode()](#getNode) | Restituisce l'oggetto Node che implementa questa interfaccia. |
| [getPlaceholder()](#getPlaceholder) | Ottiene il [BuildingBlock](../../com.aspose.words/buildingblock/) contenente il testo segnaposto che dovrebbe essere visualizzato quando il contenuto di questo SDT è vuoto, l'elemento XML mappato associato è vuoto come specificato tramite l'elemento [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) o l'elemento [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) è true. |
...
| [getSdtType()](#getSdtType) | Ottiene il tipo di questo **Structured document tag**. |
| [getTag()](#getTag) | Specifica un tag associato al nodo SDT corrente. |
| [getTitle()](#getTitle) | Specifica il nome descrittivo associato a questo **SDT**. |
...
| [getXmlMapping()](#getXmlMapping) | Ottiene un oggetto che rappresenta la mappatura di questo tag di documento strutturato ai dati XML in una parte XML personalizzata del documento corrente. |
| [isMultiSection()](#isMultiSection) | Restituisce true se questa istanza è un tag di documento strutturato a intervallo (multi-sezione). |
| [isShowingPlaceholderText()](#isShowingPlaceholderText) | Specifica se il contenuto di questo **SDT** deve essere interpretato come contenente testo segnaposto (invece del contenuto di testo normale all'interno del SDT). |
| [isShowingPlaceholderText(boolean value)](#isShowingPlaceholderText-boolean) | Specifica se il contenuto di questo **SDT** deve essere interpretato come contenente testo segnaposto (invece del contenuto di testo normale all'interno del SDT). |
| [removeSelfOnly()](#removeSelfOnly) | Rimuove solo questo nodo SDT, ma mantiene il suo contenuto all'interno dell'albero del documento. |
...
| [setLockContentControl(boolean value)](#setLockContentControl-boolean) | Quando impostata su true, questa proprietà impedirà a un utente di eliminare questo **SDT**. |
| [setLockContents(boolean value)](#setLockContents-boolean) | Quando impostata su true, questa proprietà impedirà a un utente di modificare il contenuto di questo **SDT**. |
...
| [setTag(String value)](#setTag-java.lang.String) | Specifica un tag associato al nodo SDT corrente. |
| [setTitle(String value)](#setTitle-java.lang.String) | Specifica il nome descrittivo associato a questo **SDT**. |
...
Ottiene il livello al quale questo **SDT** si trova nell'albero del documento.
...
**Returns:**
int - Il livello al quale questo **SDT** si verifica nell'albero del documento. Il valore restituito è una delle costanti [MarkupLevel](../../com.aspose.words/markuplevel/).
...
Quando impostata su true, questa proprietà impedirà a un utente di modificare il contenuto di questo **SDT**.
...
Ottiene il [BuildingBlock](../../com.aspose.words/buildingblock/) contenente il testo segnaposto che dovrebbe essere visualizzato quando il contenuto di questo SDT è vuoto, l'elemento XML mappato associato è vuoto come specificato tramite l'elemento [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) o l'elemento [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) è true.

 **Remarks:** 

Può essere null, il che significa che il segnaposto non è applicabile per questo Sdt.
...
**Returns:**
int - Tipo di questo **Structured document tag**. Il valore restituito è una delle costanti [SdtType](../../com.aspose.words/sdttype/).
### getTag() {#getTag}
```
...
Puoi usare il metodo [XmlMapping.setMapping(com.aspose.words.CustomXmlPart, java.lang.String, java.lang.String)](../../com.aspose.words/xmlmapping/\#setMapping-com.aspose.words.CustomXmlPart--java.lang.String--java.lang.String) di questo oggetto per mappare un tag di documento strutturato ai dati XML.
...
**Returns:**
boolean - True se questa istanza è un tag di documento strutturato a intervallo (multi-sezione).
...
Specifica se il contenuto di questo **SDT** deve essere interpretato come contenente testo segnaposto (invece del contenuto di testo normale all'interno del SDT).
