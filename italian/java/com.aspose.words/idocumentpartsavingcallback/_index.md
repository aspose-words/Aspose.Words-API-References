...
description: "Implementa questa interfaccia se desideri ricevere notifiche e controllare come Aspose.Words salva le parti del documento durante l'esportazione di un documento nei formati SaveFormat.HTML o SaveFormat.EPUB in Java."
type: docs
weight: 760
url: /it/java/com.aspose.words/idocumentpartsavingcallback/
---
```
public interface IDocumentPartSavingCallback
```

Implementa questa interfaccia se desideri ricevere notifiche e controllare come Aspose.Words salva le parti del documento durante l'esportazione di un documento nei formati [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) o [SaveFormat.EPUB](../../com.aspose.words/saveformat/\#EPUB) .
...
| Metodo | Descrizione |
| --- | --- |
| [documentPartSaving(DocumentPartSavingArgs args)](#documentPartSaving-com.aspose.words.DocumentPartSavingArgs) | Chiamata quando Aspose.Words sta per salvare una parte del documento. |
...
Chiamata quando Aspose.Words sta per salvare una parte del documento.
