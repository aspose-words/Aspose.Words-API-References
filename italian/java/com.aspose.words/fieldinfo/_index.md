...
description: "Implementa il campo INFO in Java."
type: docs
weight: 251
url: /it/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Restituisce il tipo della proprietà del documento da inserire. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getNewValue()](#getNewValue) | Restituisce un valore opzionale che aggiorna la proprietà. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Imposta il tipo della proprietà del documento da inserire. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Imposta un valore opzionale che aggiorna la proprietà. |
...
Restituisce il tipo della proprietà del documento da inserire.
...
**Returns:**
java.lang.String - Il tipo della proprietà del documento da inserire.
...
Restituisce un valore opzionale che aggiorna la proprietà.
...
**Returns:**
java.lang.String - Un valore opzionale che aggiorna la proprietà.
### getResult() {#getResult}
```
...
Imposta il tipo della proprietà del documento da inserire.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il tipo della proprietà del documento da inserire. |
...
Imposta un valore opzionale che aggiorna la proprietà.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un valore opzionale che aggiorna la proprietà. |
