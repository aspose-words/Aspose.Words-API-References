...
description: "Specifica l'allineamento orizzontale per le pagine nel documento HTML di output in Java."
type: docs
weight: 379
url: /it/java/com.aspose.words/htmlfixedpagehorizontalalignment/
---
...
| Campo | Descrizione |
| --- | --- |
| [CENTER](#CENTER) | Centra le pagine. |
| [LEFT](#LEFT) | Allinea le pagine a sinistra. |
| [RIGHT](#RIGHT) | Allinea le pagine a destra. |
| [length](#length) |  |
## Metodi
...
Centra le pagine. Questo è il valore predefinito.
