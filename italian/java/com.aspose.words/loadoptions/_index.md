...
description: "Consente di specificare opzioni aggiuntive, come password o URI di base, durante il caricamento di un documento in un oggetto Document in Java."
type: docs
weight: 435
url: /it/java/com.aspose.words/loadoptions/
---
...
Consente di specificare opzioni aggiuntive (come password o URI di base) durante il caricamento di un documento in un oggetto [Document](../../com.aspose.words/document/).
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | Una scorciatoia per inizializzare una nuova istanza di questa classe con la password specificata per caricare un documento crittografato. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | Inizializza una nuova istanza di questa classe. |
## Metodi
