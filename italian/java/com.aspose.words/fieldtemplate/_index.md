...
description: "Implementa il campo TEMPLATE in Java."
type: docs
weight: 294
url: /it/java/com.aspose.words/fieldtemplate/
---
...
Mostra come usare un campo TEMPLATE per visualizzare la posizione nel file system locale del modello di un documento.
...
| [getIncludeFullPath()](#getIncludeFullPath) | Ottiene se includere il percorso completo del file. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Imposta se includere il percorso completo del file. |
...
Ottiene se includere il percorso completo del file.
...
**Returns:**
boolean - Se includere il percorso completo del file.
...
Imposta se includere il percorso completo del file.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se includere il percorso completo del file. |
