...
description: "Implementa questa interfaccia se desideri controllare come i dati vengono inseriti nei campi di unione durante un'operazione di stampa unione in Java."
type: docs
weight: 765
url: /it/java/com.aspose.words/ifieldmergingcallback/
---
```
...
| Metodo | Descrizione |
| --- | --- |
| [fieldMerging(FieldMergingArgs args)](#fieldMerging-com.aspose.words.FieldMergingArgs) | Chiamata quando il motore di stampa unione di Aspose.Words sta per inserire dati in un campo di unione nel documento. |
| [imageFieldMerging(ImageFieldMergingArgs args)](#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs) | Chiamata quando il motore di stampa unione di Aspose.Words sta per inserire un'immagine in un campo di unione. |
...
Chiamata quando il motore di stampa unione di Aspose.Words sta per inserire dati in un campo di unione nel documento.
...
Chiamata quando il motore di stampa unione di Aspose.Words sta per inserire un'immagine in un campo di unione.
