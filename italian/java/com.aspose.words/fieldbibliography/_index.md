...
description: "Implementa il campo BIBLIOGRAPHY in Java."
type: docs
weight: 207
url: /it/java/com.aspose.words/fieldbibliography/
---
...
Implementa il campo BIBLIOGRAPHY.
...
Mostra come lavorare con i campi CITATION e BIBLIOGRAPHY.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Restituisce l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Restituisce l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento. |
...
| [getSourceTag()](#getSourceTag) | Restituisce un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Imposta l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Imposta l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Imposta un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag. |
...
Restituisce l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua.
...
**Returns:**
java.lang.String - L'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua.
### getFormat() {#getFormat}
```
...
Restituisce l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento.
...
**Returns:**
java.lang.String - L'ID lingua utilizzato per formattare le fonti bibliografiche nel documento.
...
Restituisce un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag.
...
**Returns:**
java.lang.String - Un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag.
### getStart() {#getStart}
```
...
Imposta l'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'ID lingua utilizzato per filtrare i dati bibliografici in modo da includere solo le fonti nel documento che usano quella lingua. |
...
Imposta l'ID lingua utilizzato per formattare le fonti bibliografiche nel documento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'ID lingua utilizzato per formattare le fonti bibliografiche nel documento. |
...
Imposta un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un valore in modo che vengano visualizzate nella bibliografia solo le fonti con valore corrispondente dell'elemento Tag. |
