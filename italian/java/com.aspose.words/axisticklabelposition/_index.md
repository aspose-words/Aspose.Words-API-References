...
description: "Specifica le possibili posizioni per le etichette dei tick in Java."
type: docs
weight: 30
url: /it/java/com.aspose.words/axisticklabelposition/
---
...
Specifica le possibili posizioni per le etichette dei tic.
...
| Campo | Descrizione |
| --- | --- |
| [DEFAULT](#DEFAULT) | Specifica il valore predefinito della posizione delle etichette dei tick. |
| [HIGH](#HIGH) | Specifica che le etichette dell'asse devono trovarsi all'estremità superiore dell'asse perpendicolare. |
| [LOW](#LOW) | Specifica che le etichette dell'asse devono trovarsi all'estremità inferiore dell'asse perpendicolare. |
| [NEXT_TO_AXIS](#NEXT-TO-AXIS) | Specifica che le etichette dell'asse devono trovarsi accanto all'asse. |
| [NONE](#NONE) | Specifica che le etichette dell'asse non vengono disegnate. |
| [length](#length) |  |
## Metodi
...
Specifica il valore predefinito della posizione delle etichette dei tick.
...
Specifica che le etichette dell'asse devono trovarsi all'estremità superiore dell'asse perpendicolare.
...
Specifica che le etichette dell'asse devono trovarsi all'estremità inferiore dell'asse perpendicolare.
...
Specifica che le etichette dell'asse devono trovarsi accanto all'asse.
...
Specifica che le etichette dell'asse non vengono disegnate.
