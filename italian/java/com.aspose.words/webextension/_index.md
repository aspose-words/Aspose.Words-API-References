...
description: "Rappresenta un oggetto di estensione web in Java."
type: docs
weight: 726
url: /it/java/com.aspose.words/webextension/
---
...
| Metodo | Descrizione |
| --- | --- |
| [getAlternateReferences()](#getAlternateReferences) | Specifica riferimenti alternativi a un'estensione web. |
| [getBindings()](#getBindings) | Specifica un elenco di binding di estensioni web. |
| [getId()](#getId) | Identifica in modo univoco l'istanza dell'estensione web nel documento corrente. |
| [getProperties()](#getProperties) | Rappresenta un insieme di proprietà personalizzate dell'estensione web. |
| [getReference()](#getReference) | Specifica il riferimento principale a un'estensione web. |
| [isFrozen()](#isFrozen) | Specifica se l'utente può interagire con l'estensione web o meno. |
| [isFrozen(boolean value)](#isFrozen-boolean) | Specifica se l'utente può interagire con l'estensione web o meno. |
| [setId(String value)](#setId-java.lang.String) | Identifica in modo univoco l'istanza dell'estensione web nel documento corrente. |
