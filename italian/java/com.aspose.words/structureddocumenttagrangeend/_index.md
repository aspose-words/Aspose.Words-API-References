...
description: "Rappresenta la fine di un tag di documento strutturato con intervallo che accetta contenuti a più sezioni in Java."
type: docs
weight: 639
url: /it/java/com.aspose.words/structureddocumenttagrangeend/
---
...
Rappresenta la fine di un tag di documento strutturato **ranged** che accetta contenuti a più sezioni. Vedi anche il nodo [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).
...
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int) | Inizializza una nuova istanza della classe **Structured document tag range end**. |
## Metodi
...
| [getId()](#getId) | Specifica un Id numerico persistente, di sola lettura e univoco per questo nodo **StructuredDocumentTagRange**. |
| [getNextSibling()](#getNextSibling) | Ottiene il nodo immediatamente successivo a questo nodo. |
| [getNodeType()](#getNodeType) | Restituisce [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). |
...
Inizializza una nuova istanza della classe **Structured document tag range end**.
...
| id | int | Identificatore dell'inizio dell'intervallo del tag di documento strutturato corrispondente. |
...
Specifica un Id numerico persistente, univoco e di sola lettura per questo nodo **StructuredDocumentTagRange**. Il nodo [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/) corrispondente ha lo stesso [StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart/\#getId).
...
Restituisce [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END).

**Returns:**
int - [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). Il valore restituito è una delle costanti [NodeType](../../com.aspose.words/nodetype/).
