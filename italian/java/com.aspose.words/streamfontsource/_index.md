...
description: "Classe base per la sorgente di font a flusso definita dall'utente in Java."
type: docs
weight: 635
url: /it/java/com.aspose.words/streamfontsource/
---
...
Classe base per la fonte di carattere stream definita dall'utente.

Per saperne di più, visita l'articolo di documentazione [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Per utilizzare la sorgente di font a flusso è necessario creare una classe derivata da [StreamFontSource](../../com.aspose.words/streamfontsource/) e fornire l'implementazione del metodo [openFontDataStream()](../../com.aspose.words/streamfontsource/\#openFontDataStream).
...
Mostra come caricare i font da un flusso.
...
| [openFontDataStream()](#openFontDataStream) | Questo metodo dovrebbe aprire il flusso con i dati del font su richiesta. |
...
**Returns:**
java.io.InputStream - Flusso di dati del font.
