...
description: "Specifica una relazione di binding tra un'estensione web e i dati nel documento in Java."
type: docs
weight: 727
url: /it/java/com.aspose.words/webextensionbinding/
---
...
Specifica una relazione di binding tra un'estensione web e i dati nel documento.
...
| --- | --- |
| [WebExtensionBinding(String id, int bindingType, String appRef)](#WebExtensionBinding-java.lang.String-int-java.lang.String) | Inizializza una nuova istanza di questa classe. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getAppRef()](#getAppRef) | Specifica la chiave di binding utilizzata per mappare la voce di binding in questo elenco con i dati collegati nel documento. |
| [getBindingType()](#getBindingType) | Specifica il tipo di binding. |
| [getId()](#getId) | Specifica l'identificatore di binding. |
| [setAppRef(String value)](#setAppRef-java.lang.String) | Specifica la chiave di binding utilizzata per mappare la voce di binding in questo elenco con i dati collegati nel documento. |
| [setBindingType(int value)](#setBindingType-int) | Specifica il tipo di binding. |
| [setId(String value)](#setId-java.lang.String) | Specifica l'identificatore di binding. |
...
Specifica la chiave di binding utilizzata per mappare la voce di binding in questo elenco con i dati collegati nel documento.
...
**Returns:**
int - Il valore intero corrispondente. Il valore restituito è uno dei costanti [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/).
### getId() {#getId}
```
public String getId()
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Il valore intero corrispondente. Il valore deve essere uno dei costanti [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/). |
