...
description: "Specifica se questo è una nota a piè di pagina o una nota finale in Java."
type: docs
weight: 346
url: /it/java/com.aspose.words/footnotetype/
---
...
Specifica se si tratta di una nota a piè di pagina o di una fine nota.

 **Remarks:** 

Sia le note a piè di pagina che le note finali sono rappresentate da oggetti della classe [FOOTNOTE](../../com.aspose.words/footnotetype/\#FOOTNOTE). Usa [Footnote.getFootnoteType()](../../com.aspose.words/footnote/\#getFootnoteType) per distinguere tra note a piè di pagina e note finali.

 **Examples:** 

Mostra come fare riferimento al testo con una nota a piè di pagina e una nota finale.
...
| Campo | Descrizione |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | L'oggetto è una nota finale. |
| [FOOTNOTE](#FOOTNOTE) | L'oggetto è una nota a piè di pagina. |
| [length](#length) |  |
## Metodi
...
L'oggetto è una nota a piè di pagina.
