...
description: "Rappresenta un singolo segnalibro in Java."
type: docs
weight: 41
url: /it/java/com.aspose.words/bookmark/
---
...
Per saperne di più, visita l'articolo della documentazione [ Working with Bookmarks ][Working with Bookmarks].
...
| Metodo | Descrizione |
| --- | --- |
| [getBookmarkEnd()](#getBookmarkEnd) | Ottiene il nodo che rappresenta la fine del segnalibro. |
| [getBookmarkStart()](#getBookmarkStart) | Ottiene il nodo che rappresenta l'inizio del segnalibro. |
| [getFirstColumn()](#getFirstColumn) | Ottiene l'indice basato su zero della prima colonna dell'intervallo di colonne della tabella associato al segnalibro. |
| [getLastColumn()](#getLastColumn) | Ottiene l'indice basato su zero dell'ultima colonna dell'intervallo di colonne della tabella associato al segnalibro. |
| [getName()](#getName) | Ottiene il nome del segnalibro. |
| [getText()](#getText) | Ottiene il testo racchiuso nel segnalibro. |
| [isColumn()](#isColumn) | Restituisce  true  se questo segnalibro è un segnalibro di colonna di tabella. |
| [remove()](#remove) | Rimuove il segnalibro dal documento. |
| [setName(String value)](#setName-java.lang.String) | Imposta il nome del segnalibro. |
| [setText(String value)](#setText-java.lang.String) | Imposta il testo racchiuso nel segnalibro. |
...
Mostra come ottenere informazioni sui segnalibri di colonna di tabella.
...
**Returns:**
int - L'indice basato su zero della prima colonna dell'intervallo di colonne della tabella associato al segnalibro.
...
**Returns:**
int - L'indice basato su zero dell'ultima colonna dell'intervallo di colonne della tabella associato al segnalibro.
### getName() {#getName}
```
...
Nota che se cambi il nome di un segnalibro con un nome già presente nel documento, non verrà generato alcun errore e solo il primo segnalibro verrà memorizzato quando salvi il documento.
...
Ottiene il testo racchiuso nel segnalibro.
...
**Returns:**
java.lang.String - Il testo racchiuso nel segnalibro.
### isColumn() {#isColumn}
```
...
**Returns:**
boolean -  true  se questo segnalibro è un segnalibro di colonna di tabella.
### remove() {#remove}
```
public void remove()
```
...
Imposta il testo racchiuso nel segnalibro.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo racchiuso nel segnalibro. |
