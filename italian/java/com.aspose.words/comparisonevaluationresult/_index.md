...
description: "Il risultato della valutazione di confronto in Java."
type: docs
weight: 116
url: /it/java/com.aspose.words/comparisonevaluationresult/
---
...
| --- | --- |
| [ComparisonEvaluationResult(boolean result)](#ComparisonEvaluationResult-boolean) | Crea un risultato di valutazione di confronto. |
| [ComparisonEvaluationResult(String errorMessage)](#ComparisonEvaluationResult-java.lang.String) | Crea un risultato di valutazione di confronto fallito con il relativo messaggio di errore. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getErrorMessage()](#getErrorMessage) | Ottiene il messaggio di errore del risultato di valutazione di confronto fallito. |
| [getResult()](#getResult) | Ottiene il risultato della valutazione del confronto. |
...
Crea un risultato di valutazione di confronto.
...
Crea un risultato di valutazione di confronto fallito con il relativo messaggio di errore.
...
Ottiene il messaggio di errore del risultato di valutazione di confronto fallito.
...
**Returns:**
java.lang.String - Il messaggio di errore del risultato della valutazione del confronto fallito.
### getResult() {#getResult}
```
...
**Returns:**
boolean - Il risultato della valutazione del confronto.
