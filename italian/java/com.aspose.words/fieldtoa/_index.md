...
description: "Implementa il campo TOA in Java."
type: docs
weight: 297
url: /it/java/com.aspose.words/fieldtoa/
---
...
Crea una tabella delle autorità (cioè, un elenco dei riferimenti in un documento legale, come riferimenti a casi, statuti e regole, insieme ai numeri delle pagine in cui i riferimenti compaiono) utilizzando le voci specificate dai campi TA.
...
| [getEntryCategory()](#getEntryCategory) | Ottiene la categoria integrale per le voci incluse nella tabella. |
| [getEntrySeparator()](#getEntrySeparator) | Ottiene la sequenza di caratteri utilizzata per separare una voce della tabella delle autorità dal suo numero di pagina. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Ottiene se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità. |
...
| [getUseHeading()](#getUseHeading) | Ottiene se includere l'intestazione di categoria per le voci in una tabella delle autorità. |
| [getUsePassim()](#getUsePassim) | Ottiene se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Imposta la categoria integrale per le voci incluse nella tabella. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Imposta la sequenza di caratteri utilizzata per separare una voce della tabella delle autorità dal suo numero di pagina. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Imposta se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Imposta se includere l'intestazione di categoria per le voci in una tabella delle autorità. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Imposta se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata. |
...
Ottiene la categoria integrale per le voci incluse nella tabella.
...
**Returns:**
java.lang.String - La categoria integrale per le voci incluse nella tabella.
...
Ottiene la sequenza di caratteri utilizzata per separare una voce della tabella delle autorità dal suo numero di pagina.
...
**Returns:**
java.lang.String - La sequenza di caratteri utilizzata per separare una voce della tabella delle autorità dal suo numero di pagina.
...
Ottiene se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità.
...
**Returns:**
boolean - Indica se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità.
### getResult() {#getResult}
```
...
Ottiene se includere l'intestazione di categoria per le voci in una tabella delle autorità.
...
**Returns:**
boolean - Indica se includere l'intestazione della categoria per le voci in una tabella delle autorità.
...
Ottiene se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata.
...
**Returns:**
boolean - Indica se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata.
### isDirty() {#isDirty}
```
...
Imposta la categoria integrale per le voci incluse nella tabella.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La categoria integrale per le voci incluse nella tabella. |
...
Imposta la sequenza di caratteri utilizzata per separare una voce della tabella delle autorità dal suo numero di pagina.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La sequenza di caratteri utilizzata per separare una voce della tabella delle autorità e il suo numero di pagina. |
...
Imposta se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se rimuovere la formattazione del testo della voce nel documento dalla voce nella tabella delle autorità. |
...
Imposta se includere l'intestazione di categoria per le voci in una tabella delle autorità.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se includere l'intestazione della categoria per le voci in una tabella delle autorità. |
...
Imposta se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se sostituire cinque o più riferimenti di pagina diversi alla stessa autorità con \"passim\", che è usato per indicare che una parola o un passaggio compare frequentemente nell'opera citata. |
