...
description: "Implementato da classi che possono registrare dizionari di sillabazione in Java."
type: docs
weight: 772
url: /it/java/com.aspose.words/ihyphenationcallback/
---
```
...
| Metodo | Descrizione |
| --- | --- |
| [requestDictionary(String language)](#requestDictionary-java.lang.String) | Notifica all'applicazione che il dizionario di sillabazione per la lingua specificata non è stato trovato e potrebbe dover essere registrato. |
...
L'implementazione dovrebbe trovare un dizionario e registrarlo usando i metodi **M:Aspose.Words.Hyphenation.RegisterDictionary(System.String,System.IO.Stream)**.

Se il dizionario non è disponibile per la lingua specificata, l'implementazione può rinunciare a ulteriori chiamate per la stessa lingua usando [Hyphenation.registerDictionary(java.lang.String, java.lang.String)](../../com.aspose.words/hyphenation/\#registerDictionary-java.lang.String--java.lang.String) con valore  null  .
