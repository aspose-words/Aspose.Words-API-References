...
description: "Fornisce una collezione di sola lettura di firme digitali allegate a un documento in Java."
type: docs
weight: 151
url: /it/java/com.aspose.words/digitalsignaturecollection/
---
...
| Metodo | Descrizione |
| --- | --- |
| [get(int index)](#get-int) | Ottiene una firma del documento all'indice specificato. |
| [getCount()](#getCount) | Ottiene il numero di elementi contenuti nella collezione. |
| [isValid()](#isValid) | Restituisce  true  se tutte le firme digitali in questa collezione sono valide e il documento non è stato manomesso. Restituisce anche  true  se non ci sono firme digitali. |
...
| --- | --- | --- |
| indice | int | Indice basato su zero della firma. |
...
**Returns:**
boolean -  true  se tutte le firme digitali in questa collezione sono valide e il documento non è stato manomesso. Restituisce anche  true  se non ci sono firme digitali.
### iterator() {#iterator}
```
