...
description: "Implementa il campo SHAPE in Java."
type: docs
weight: 286
url: /it/java/com.aspose.words/fieldshape/
---
...
Mostra come alcuni campi più vecchi di Microsoft Word, come SHAPE ed EMBED, vengono gestiti durante il caricamento.
...
| [getText()](#getText) | Ottiene il testo da recuperare. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo da recuperare. |
...
Ottiene il testo da recuperare.
...
**Returns:**
java.lang.String - Il testo da recuperare.
### getType() {#getType}
```
public int getType()
```
...
Imposta il testo da recuperare.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo da recuperare. |
