...
description: "Specifica il tipo di modifica tracciata in Revision in Java."
type: docs
weight: 586
url: /it/java/com.aspose.words/revisiontype/
---
...
Specifica il tipo di modifica tracciata in [Revision](../../com.aspose.words/revision/).
...
| Campo | Descrizione |
| --- | --- |
| [DELETION](#DELETION) | Il contenuto è stato rimosso dal documento. |
| [FORMAT_CHANGE](#FORMAT-CHANGE) | È stata applicata una modifica di formattazione al nodo genitore. |
| [INSERTION](#INSERTION) | È stato inserito nuovo contenuto nel documento. |
| [MOVING](#MOVING) | Il contenuto è stato spostato nel documento. |
| [STYLE_DEFINITION_CHANGE](#STYLE-DEFINITION-CHANGE) | È stata applicata una modifica di formattazione allo stile genitore. |
| [length](#length) |  |
## Metodi
...
Il contenuto è stato rimosso dal documento.
...
È stata applicata una modifica di formattazione al nodo genitore.
...
È stato inserito nuovo contenuto nel documento.
...
Il contenuto è stato spostato nel documento.
...
È stata applicata una modifica di formattazione allo stile genitore.
