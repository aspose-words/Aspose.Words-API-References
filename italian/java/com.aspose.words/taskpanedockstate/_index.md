...
description: "Elenca le posizioni disponibili dell'oggetto task pane in Java."
type: docs
weight: 665
url: /it/java/com.aspose.words/taskpanedockstate/
---
...
Enumera le posizioni disponibili dell'oggetto pannello attività.
...
| Campo | Descrizione |
| --- | --- |
| [LEFT](#LEFT) | Aggancia il task pane sul lato sinistro della finestra del documento. |
| [RIGHT](#RIGHT) | Aggancia il task pane sul lato destro della finestra del documento. |
| [length](#length) |  |
## Metodi
...
Aggancia il task pane sul lato sinistro della finestra del documento.
...
Aggancia il task pane sul lato destro della finestra del documento.
