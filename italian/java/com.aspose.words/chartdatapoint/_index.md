...
description: "Consente di specificare la formattazione di un singolo punto dati nel grafico in Java."
type: docs
weight: 75
url: /it/java/com.aspose.words/chartdatapoint/
---
...
In una serie, l'oggetto [ChartDataPoint](../../com.aspose.words/chartdatapoint/) è un membro della [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/). La [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/) contiene un oggetto [ChartDataPoint](../../com.aspose.words/chartdatapoint/) per ogni punto.
...
| Metodo | Descrizione |
| --- | --- |
| [clearFormat()](#clearFormat) | Cancella il formato di questo punto dati. |
...
| [getFormat()](#getFormat) | Fornisce l'accesso alla formattazione di riempimento e linea di questo punto dati. |
| [getIndex()](#getIndex) | Indice del punto dati a cui questo oggetto applica la formattazione. |
...
| [getMarker()](#getMarker) | Specifica il marcatore dei dati del grafico. |
...
Cancella il formato di questo punto dati. Le proprietà sono impostate ai valori predefiniti definiti nella serie padre.
