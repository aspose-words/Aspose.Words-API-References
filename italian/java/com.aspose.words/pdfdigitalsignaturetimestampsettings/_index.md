...
description: "Contiene le impostazioni del timestamp della firma digitale in Java."
type: docs
weight: 533
url: /it/java/com.aspose.words/pdfdigitalsignaturetimestampsettings/
---
...
| --- | --- |
| [PdfDigitalSignatureTimestampSettings()](#PdfDigitalSignatureTimestampSettings) | Inizializza un'istanza di questa classe. |
| [PdfDigitalSignatureTimestampSettings(String serverUrl, String userName, String password)](#PdfDigitalSignatureTimestampSettings-java.lang.String-java.lang.String-java.lang.String) | Inizializza un'istanza di questa classe. |
| [PdfDigitalSignatureTimestampSettings(String serverUrl, String userName, String password, long timeout)](#PdfDigitalSignatureTimestampSettings-java.lang.String-java.lang.String-java.lang.String-long) | Inizializza un'istanza di questa classe. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getPassword()](#getPassword) | Password del server di timestamp. |
| [getServerUrl()](#getServerUrl) | URL del server di timestamp. |
| [getTimeout()](#getTimeout) | Valore di timeout in millisecondi per l'accesso al server di timestamp. |
| [getUserName()](#getUserName) | Nome utente del server di timestamp. |
| [setPassword(String value)](#setPassword-java.lang.String) | Password del server di timestamp. |
| [setServerUrl(String value)](#setServerUrl-java.lang.String) | URL del server di timestamp. |
| [setTimeout(long value)](#setTimeout-long) | Valore di timeout in millisecondi per l'accesso al server di timestamp. |
| [setUserName(String value)](#setUserName-java.lang.String) | Nome utente del server di timestamp. |
...
| --- | --- | --- |
| serverUrl | java.lang.String | URL del server di timestamp. |
| userName | java.lang.String | Nome utente del server di timestamp. |
| password | java.lang.String | Password del server di timestamp. |
...
| userName | java.lang.String | Nome utente del server di timestamp. |
| password | java.lang.String | Password del server di timestamp. |
| timeout | long | Valore di timeout in millisecondi per l'accesso al server di timestamp. |
...
Password del server di timestamp.
...
Il valore predefinito è  null . Se  null , la firma digitale non verrà timbrata.
...
Valore di timeout in millisecondi per l'accesso al server di timestamp.
...
Nome utente del server di timestamp.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | long | Il valore long corrispondente. |
