...
description: "Consente di scegliere opzioni aggiuntive per l'operazione di confronto dei documenti in Java."
type: docs
weight: 113
url: /it/java/com.aspose.words/compareoptions/
---
...
Per saperne di più, visita l'articolo di documentazione [ Compare Documents ][Compare Documents].
...
| --- | --- |
| [CompareOptions()](#CompareOptions) | Inizializza una nuova istanza di questa classe. |
## Metodi

| Metodo | Descrizione |
| --- | --- |
| [getAdvancedOptions()](#getAdvancedOptions) | Specifica opzioni avanzate di confronto che potrebbero aiutare a produrre un output di confronto più preciso. |
| [getCompareMoves()](#getCompareMoves) | Specifica se confrontare le differenze tra i due documenti. |
| [getGranularity()](#getGranularity) | Specifica se le modifiche sono tracciate per carattere o per parola. |
| [getIgnoreCaseChanges()](#getIgnoreCaseChanges) | True indica che il confronto dei documenti non distingue tra maiuscole e minuscole. |
| [getIgnoreComments()](#getIgnoreComments) | Specifica se confrontare le differenze nei commenti. |
| [getIgnoreDmlUniqueId()](#getIgnoreDmlUniqueId) | Specifica se ignorare la differenza nell'ID univoco di DrawingML. |
| [getIgnoreFields()](#getIgnoreFields) | Specifica se confrontare le differenze nei campi. |
| [getIgnoreFootnotes()](#getIgnoreFootnotes) | Specifica se confrontare le differenze in note a piè di pagina e note finali. |
| [getIgnoreFormatting()](#getIgnoreFormatting) | True indica che la formattazione è ignorata. |
| [getIgnoreHeadersAndFooters()](#getIgnoreHeadersAndFooters) | True indica che il contenuto di intestazioni e piè di pagina è ignorato. |
| [getIgnoreTables()](#getIgnoreTables) | Specifica se confrontare le differenze nei dati contenuti nelle tabelle. |
| [getIgnoreTextboxes()](#getIgnoreTextboxes) | Specifica se confrontare le differenze nei dati contenuti nelle caselle di testo. |
| [getTarget()](#getTarget) | Specifica quale documento deve essere usato come destinazione durante il confronto. |
| [setCompareMoves(boolean value)](#setCompareMoves-boolean) | Specifica se confrontare le differenze tra i due documenti. |
| [setGranularity(int value)](#setGranularity-int) | Specifica se le modifiche sono tracciate per carattere o per parola. |
| [setIgnoreCaseChanges(boolean value)](#setIgnoreCaseChanges-boolean) | True indica che il confronto dei documenti non distingue tra maiuscole e minuscole. |
| [setIgnoreComments(boolean value)](#setIgnoreComments-boolean) | Specifica se confrontare le differenze nei commenti. |
...
| [setIgnoreFields(boolean value)](#setIgnoreFields-boolean) | Specifica se confrontare le differenze nei campi. |
| [setIgnoreFootnotes(boolean value)](#setIgnoreFootnotes-boolean) | Specifica se confrontare le differenze in note a piè di pagina e note finali. |
| [setIgnoreFormatting(boolean value)](#setIgnoreFormatting-boolean) | True indica che la formattazione è ignorata. |
| [setIgnoreHeadersAndFooters(boolean value)](#setIgnoreHeadersAndFooters-boolean) | True indica che il contenuto di intestazioni e piè di pagina è ignorato. |
| [setIgnoreTables(boolean value)](#setIgnoreTables-boolean) | Specifica se confrontare le differenze nei dati contenuti nelle tabelle. |
| [setIgnoreTextboxes(boolean value)](#setIgnoreTextboxes-boolean) | Specifica se confrontare le differenze nei dati contenuti nelle caselle di testo. |
| [setTarget(int value)](#setTarget-int) | Specifica quale documento deve essere usato come destinazione durante il confronto. |
...
Specifica opzioni avanzate di confronto che potrebbero aiutare a produrre un output di confronto più preciso.
...
Per impostazione predefinita le revisioni di spostamento non vengono generate.
...
Il valore predefinito è [Granularity.WORD\_LEVEL](../../com.aspose.words/granularity/\#WORD-LEVEL).
...
**Returns:**
int - Il valore intero corrispondente. Il valore restituito è una delle costanti di [Granularity](../../com.aspose.words/granularity/).
...
True indica che il confronto dei documenti non distingue tra maiuscole e minuscole.

 **Remarks:** 

Per impostazione predefinita il confronto è sensibile al maiuscolo/minuscolo.
...
**Returns:**
int - Il valore intero corrispondente. Il valore restituito è una delle costanti di [ComparisonTargetType](../../com.aspose.words/comparisontargettype/).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Il valore intero corrispondente. Il valore deve essere una delle costanti di [Granularity](../../com.aspose.words/granularity/). |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Il valore intero corrispondente. Il valore deve essere una delle costanti di [ComparisonTargetType](../../com.aspose.words/comparisontargettype/). |
