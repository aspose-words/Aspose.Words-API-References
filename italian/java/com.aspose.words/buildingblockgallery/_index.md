...
description: "Specifica la galleria predefinita in cui un blocco di costruzione è classificato in Java."
type: docs
weight: 55
url: /it/java/com.aspose.words/buildingblockgallery/
---
...
Corrisponde al tipo **ST\_DocPartGallery** in OOXML.
...
| Campo | Descrizione |
| --- | --- |
| [ALL](#ALL) | Specifica che questa voce del documento glossario deve essere associata a tutti i possibili valori di classificazione della galleria. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | Uguale a [ALL](../../com.aspose.words/buildingblockgallery/\#ALL). |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
Specifica che questa voce del documento glossario deve essere associata a tutti i possibili valori di classificazione della galleria.
...
Uguale a [ALL](../../com.aspose.words/buildingblockgallery/\#ALL).
