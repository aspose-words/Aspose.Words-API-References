...
description: "Regola di sostituzione del font predefinito in Java."
type: docs
weight: 149
url: /it/java/com.aspose.words/defaultfontsubstitutionrule/
---
...
Regola predefinita di sostituzione del carattere.

Per saperne di più, visita l'articolo di documentazione [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Questa regola definisce un unico nome di font predefinito da utilizzare per la sostituzione se il font originale non è disponibile.
...
| Metodo | Descrizione |
| --- | --- |
| [getDefaultFontName()](#getDefaultFontName) | Ottiene il nome del carattere predefinito. |
| [getEnabled()](#getEnabled) | Specifica se la regola è abilitata o meno. |
| [setDefaultFontName(String value)](#setDefaultFontName-java.lang.String) | Imposta il nome del carattere predefinito. |
...
Ottiene il nome del carattere predefinito.
...
**Returns:**
java.lang.String - Il nome del carattere predefinito.
...
| --- | --- | --- |
| valore | java.lang.String | Il nome del carattere predefinito. |
