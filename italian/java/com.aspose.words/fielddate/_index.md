...
description: "Implementa il campo DATE in Java."
type: docs
weight: 220
url: /it/java/com.aspose.words/fielddate/
---
...
| [getUseLastFormat()](#getUseLastFormat) | Ottiene se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Imposta se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE. |
...
Ottiene se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE.
...
**Returns:**
boolean - Indica se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE.
...
Imposta se utilizzare un formato usato per ultimo dall'applicazione host durante l'inserimento di un nuovo campo DATE.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Indica se utilizzare un formato ultimo usato dall'applicazione host durante l'inserimento di un nuovo campo DATE. |
