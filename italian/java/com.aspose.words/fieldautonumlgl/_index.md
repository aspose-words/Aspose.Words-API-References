...
description: "Implementa il campo AUTONUMLGL in Java."
type: docs
weight: 202
url: /it/java/com.aspose.words/fieldautonumlgl/
---
...
Mostra come organizzare un documento usando i campi AUTONUMLGL.
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Ottiene se visualizzare il numero senza un punto finale. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Ottiene il carattere separatore da utilizzare. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Imposta se visualizzare il numero senza un punto finale. |
...
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Imposta il carattere separatore da utilizzare. |
...
Ottiene se visualizzare il numero senza un punto finale.
...
**Returns:**
boolean - Se visualizzare il numero senza un punto finale.
### getResult() {#getResult}
```
...
Ottiene il carattere separatore da utilizzare.
...
**Returns:**
java.lang.String - Il carattere separatore da utilizzare.
### getStart() {#getStart}
```
...
Imposta se visualizzare il numero senza un punto finale.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se visualizzare il numero senza un punto finale. |
...
Imposta il carattere separatore da utilizzare.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il carattere separatore da utilizzare. |
