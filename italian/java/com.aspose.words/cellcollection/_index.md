...
description: "Fornisce accesso tipizzato a una collezione di nodi Cell in Java."
type: docs
weight: 60
url: /it/java/com.aspose.words/cellcollection/
---
...
Fornisce accesso tipizzato a una collezione di nodi [Cell](../../com.aspose.words/cell/).
...
| [get(int index)](#get-int) | Recupera una [Cell](../../com.aspose.words/cell/) all'indice specificato. |
...
| [toArray()](#toArray) | Copia tutte le celle dalla collezione in un nuovo array di celle. |
...
Recupera una [Cell](../../com.aspose.words/cell/) all'indice specificato.
...
Copia tutte le celle dalla collezione in un nuovo array di celle.
...
**Returns:**
com.aspose.words.Node[] - Un array di celle.
