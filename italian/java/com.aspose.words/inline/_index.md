...
description: "Classe base per i nodi a livello inline che possono avere formattazione dei caratteri associata, ma non possono avere nodi figli propri in Java."
type: docs
weight: 403
url: /it/java/com.aspose.words/inline/
---
...
Classe base per nodi a livello inline che possono avere formattazione dei caratteri associata, ma non possono avere nodi figli propri.

Per saperne di più, visita l'articolo di documentazione [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document].

 **Remarks:** 

Una classe derivata da [Inline](../../com.aspose.words/inline/) può essere un figlio di [Paragraph](../../com.aspose.words/paragraph/).
...
| [getNodeType()](#getNodeType) | Ottiene il tipo di questo nodo. |
...
**Returns:**
int - Il tipo di questo nodo. Il valore restituito è una delle costanti [NodeType](../../com.aspose.words/nodetype/).
