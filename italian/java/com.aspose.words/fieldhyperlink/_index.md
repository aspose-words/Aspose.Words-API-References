...
description: "Implementa il campo HYPERLINK in Java."
type: docs
weight: 242
url: /it/java/com.aspose.words/fieldhyperlink/
---
...
Quando selezionato, fa sì che il controllo salti alla posizione, come un segnalibro o un URL.
...
| Metodo | Descrizione |
| --- | --- |
| [getAddress()](#getAddress) | Ottiene una posizione a cui questo hyperlink salta. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Ottiene se aprire il sito di destinazione in una nuova finestra del browser web. |
| [getResult()](#getResult) | Ottiene il testo compreso tra il separatore del campo e la fine del campo. |
| [getScreenTip()](#getScreenTip) | Ottiene il testo ScreenTip per il collegamento ipertestuale. |
...
| [getSubAddress()](#getSubAddress) | Ottiene una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | Ottiene la destinazione a cui il collegamento dovrebbe essere reindirizzato. |
...
| [isImageMap()](#isImageMap) | Ottiene se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Imposta se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Imposta una posizione dove questo collegamento ipertestuale salta. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | Imposta se aprire il sito di destinazione in una nuova finestra del browser web. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Imposta il testo ScreenTip per il collegamento ipertestuale. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | Imposta una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta. |
| [setTarget(String value)](#setTarget-java.lang.String) | Imposta la destinazione a cui il collegamento dovrebbe essere reindirizzato. |
...
Ottiene una posizione a cui questo hyperlink salta.
...
**Returns:**
java.lang.String - Una posizione dove questo collegamento ipertestuale salta.
...
Ottiene se aprire il sito di destinazione in una nuova finestra del browser web.
...
**Returns:**
boolean - Se aprire il sito di destinazione in una nuova finestra del browser web.
### getResult() {#getResult}
```
...
Ottiene il testo ScreenTip per il collegamento ipertestuale.
...
**Returns:**
java.lang.String - Il testo ScreenTip per il collegamento ipertestuale.
...
Ottiene una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta.
...
**Returns:**
java.lang.String - Una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Ottiene la destinazione a cui il collegamento dovrebbe essere reindirizzato.
...
**Returns:**
java.lang.String - La destinazione a cui il collegamento dovrebbe essere reindirizzato.
### getType() {#getType}
```
public int getType()
```
...
Ottiene se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server.
...
**Returns:**
boolean - Se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server.
...
Imposta se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se aggiungere coordinate al collegamento ipertestuale per una mappa immagine lato server. |
...
Imposta una posizione dove questo collegamento ipertestuale salta.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Una posizione dove questo collegamento ipertestuale salta. |
...
Imposta se aprire il sito di destinazione in una nuova finestra del browser web.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se aprire il sito di destinazione in una nuova finestra del browser web. |
...
Imposta il testo ScreenTip per il collegamento ipertestuale.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo ScreenTip per il collegamento ipertestuale. |
...
Imposta una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Una posizione nel file, come un segnalibro, dove questo collegamento ipertestuale salta. |
...
Imposta la destinazione a cui il collegamento dovrebbe essere reindirizzato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La destinazione a cui il collegamento dovrebbe essere reindirizzato. |
