...
description: "Implementa il campo NEXTIF in Java."
type: docs
weight: 264
url: /it/java/com.aspose.words/fieldnextif/
---
...
Confronta i valori designati dalle espressioni [getLeftExpression()](../../com.aspose.words/fieldnextif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldnextif/\#setLeftExpression-java.lang.String) e [getRightExpression()](../../com.aspose.words/fieldnextif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldnextif/\#setRightExpression-java.lang.String) nel confronto usando l'operatore designato da [getComparisonOperator()](../../com.aspose.words/fieldnextif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldnextif/\#setComparisonOperator-java.lang.String). Se il confronto è vero, il prossimo record di dati viene unito al documento di merge corrente. (I campi di merge che seguono il NEXTIF nel documento principale sono sostituiti dai valori del prossimo record di dati anziché dal record corrente.) Se il confronto è falso, il prossimo record di dati viene unito a un nuovo documento di merge.

 **Examples:** 

Mostra come utilizzare i campi NEXT/NEXTIF per unire più righe in una pagina durante un'unione di stampa.
