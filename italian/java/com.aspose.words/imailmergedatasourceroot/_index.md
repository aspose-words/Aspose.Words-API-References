...
description: "Implementa questa interfaccia per consentire il mail merge da una fonte dati personalizzata con dati master-detail in Java."
type: docs
weight: 777
url: /it/java/com.aspose.words/imailmergedatasourceroot/
---
```
public interface IMailMergeDataSourceRoot
```

Implementa questa interfaccia per consentire l'unione di stampa da una fonte dati personalizzata con dati master-detail.

 **Examples:** 

Esegue il mail merge da una fonte dati personalizzata con dati master-detail.
...
| Metodo | Descrizione |
| --- | --- |
| [getDataSource(String tableName)](#getDataSource-java.lang.String) | Il motore di mail merge di Aspose.Words invoca questo metodo quando incontra l'inizio di una regione di mail merge di livello superiore. |
...
Il motore di mail merge di Aspose.Words invoca questo metodo quando incontra l'inizio di una regione di mail merge di livello superiore.

 **Remarks:** 

Quando i motori di mail merge di Aspose.Words popolano un documento con i dati e incontrano MERGEFIELD TableStart:TableName, invocano [getDataSource(java.lang.String)](../../com.aspose.words/imailmergedatasourceroot/\\#getDataSource-java.lang.String) su questo oggetto. La tua implementazione deve restituire un nuovo oggetto fonte dati. Aspose.Words utilizzerà la fonte dati restituita per popolare la regione di mail merge.

Se una fonte dati (tabella) con il nome specificato non esiste, la tua implementazione dovrebbe restituire  null .
