...
description: "Consente di specificare opzioni aggiuntive durante il caricamento del documento LoadFormat.MARKDOWN in un oggetto Document in Java."
type: docs
weight: 454
url: /it/java/com.aspose.words/markdownloadoptions/
---
...
Consente di specificare opzioni aggiuntive durante il caricamento del documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN) in un oggetto [Document](../../com.aspose.words/document/).

 **Examples:** 

Mostra come preservare una linea vuota durante il caricamento di un documento.
...
| --- | --- |
| [MarkdownLoadOptions()](#MarkdownLoadOptions) | Inizializza una nuova istanza della classe [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/). |
## Metodi
...
| [getImportUnderlineFormatting()](#getImportUnderlineFormatting) | Restituisce un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato. |
...
| [getPreserveEmptyLines()](#getPreserveEmptyLines) | Restituisce un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [getSoftLineBreakCharacter()](#getSoftLineBreakCharacter) | Restituisce un valore di tipo carattere che rappresenta un'interruzione di riga morbida. |
...
| [setImportUnderlineFormatting(boolean value)](#setImportUnderlineFormatting-boolean) | Imposta un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato. |
...
| [setPreserveEmptyLines(boolean value)](#setPreserveEmptyLines-boolean) | Imposta un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
| [setSoftLineBreakCharacter(char value)](#setSoftLineBreakCharacter-char) | Imposta un valore di tipo carattere che rappresenta un'interruzione di riga morbida. |
...
Inizializza una nuova istanza della classe [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/).

 **Remarks:** 

Imposta automaticamente [LoadFormat](../../com.aspose.words/loadformat/) su [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
Restituisce un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato. Il valore predefinito è false.
...
**Returns:**
boolean - Un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato.
...
Restituisce un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). Il valore predefinito è false.

Normalmente, le linee vuote tra gli elementi di livello blocco in Markdown vengono ignorate. Le linee vuote all'inizio e alla fine del documento vengono anch'esse ignorate. Questa opzione consente di importare tali linee vuote.
...
**Returns:**
boolean - Un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
Restituisce un valore di tipo carattere che rappresenta un'interruzione di riga morbida. Il valore predefinito è SPAZIO (U+0020).

 **Remarks:** 

Nota, impostare questa opzione su [ControlChar.LINE\_BREAK\_CHAR](../../com.aspose.words/controlchar/\#LINE-BREAK-CHAR) consente di caricare le interruzioni di riga morbide come interruzioni di riga rigide.
...
**Returns:**
char - Un valore di tipo carattere che rappresenta un'interruzione di riga morbida.
...
Imposta un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato. Il valore predefinito è false.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Un valore booleano che indica se riconoscere una sequenza di due caratteri più \"++\" come formattazione del testo sottolineato. |
...
Imposta un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). Il valore predefinito è false.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | boolean | Un valore booleano che indica se preservare le linee vuote durante il caricamento di un documento [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN). |
...
Imposta un valore di carattere che rappresenta un'interruzione di riga morbida. Il valore predefinito è  SPACE (U+0020) .
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | char | Un valore di carattere che rappresenta un'interruzione di riga morbida. |
