...
description: "Rappresenta le proprietà delle serie di grafico in Java."
type: docs
weight: 85
url: /it/java/com.aspose.words/chartseries/
---
...
Rappresenta le proprietà della serie del grafico.
...
| Metodo | Descrizione |
| --- | --- |
| [add(ChartXValue xValue)](#add-com.aspose.words.ChartXValue) | Aggiunge il valore X specificato alla serie di grafico. |
| [add(ChartXValue xValue, ChartYValue yValue)](#add-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue) | Aggiunge i valori X e Y specificati alla serie di grafico. |
| [add(ChartXValue xValue, ChartYValue yValue, double bubbleSize)](#add-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue-double) | Aggiunge il valore X specificato, il valore Y e la dimensione della bolla alla serie del grafico. |
| [clear()](#clear) | Rimuove tutti i valori dei dati dalla serie del grafico. |
...
| [copyFormatFrom(int dataPointIndex)](#copyFormatFrom-int) | Copia il formato predefinito del punto dati dal punto dati con l'indice specificato. |
| [getBubble3D()](#getBubble3D) | Specifica se le bolle nel grafico a bolle devono avere un effetto 3-D applicato. |
| [getBubbleSizes()](#getBubbleSizes) | Ottiene una raccolta di dimensioni delle bolle per questa serie del grafico. |
| [getDataLabels()](#getDataLabels) | Specifica le impostazioni per le etichette dei dati dell'intera serie. |
| [getDataPoints()](#getDataPoints) | Restituisce una raccolta di oggetti di formattazione per tutti i punti dati in questa serie. |
| [getExplosion()](#getExplosion) | Specifica la quantità di spostamento del punto dati dal centro della torta. |
| [getFormat()](#getFormat) | Fornisce l'accesso alla formattazione di riempimento e linea della serie. |
...
| [getLegendEntry()](#getLegendEntry) | Ottiene una voce della legenda per questa serie del grafico. |
| [getMarker()](#getMarker) | Specifica un marcatore dati. |
| [getName()](#getName) | Ottiene il nome della serie; se il nome non è impostato esplicitamente, viene generato usando l'indice. |
| [getSeriesType()](#getSeriesType) | Ottiene il tipo di questa serie del grafico. |
| [getSmooth()](#getSmooth) | Consente di specificare se la linea che collega i punti nel grafico deve essere smussata usando spline Catmull-Rom. |
| [getXValues()](#getXValues) | Ottiene una raccolta di valori X per questa serie del grafico. |
| [getYValues()](#getYValues) | Ottiene una raccolta di valori Y per questa serie del grafico. |
| [hasDataLabels()](#hasDataLabels) | Ottiene un flag che indica se le etichette dei dati sono visualizzate per la serie. |
| [hasDataLabels(boolean value)](#hasDataLabels-boolean) | Imposta un flag che indica se le etichette dei dati sono visualizzate per la serie. |
| [insert(int index, ChartXValue xValue)](#insert-int-com.aspose.words.ChartXValue) | Inserisce il valore X specificato nella serie del grafico all'indice specificato. |
| [insert(int index, ChartXValue xValue, ChartYValue yValue)](#insert-int-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue) | Inserisce i valori X e Y specificati nella serie del grafico all'indice specificato. |
| [insert(int index, ChartXValue xValue, ChartYValue yValue, double bubbleSize)](#insert-int-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue-double) | Inserisce il valore X, il valore Y e la dimensione della bolla specificati nella serie del grafico all'indice specificato. |
| [remove(int index)](#remove-int) | Rimuove il valore X, il valore Y e la dimensione della bolla, se supportati, dalla serie del grafico all'indice specificato. |
...
| [setName(String value)](#setName-java.lang.String) | Imposta il nome della serie; se il nome non è impostato esplicitamente, viene generato usando l'indice. |
| [setSmooth(boolean value)](#setSmooth-boolean) | Consente di specificare se la linea che collega i punti nel grafico deve essere smussata usando spline Catmull-Rom. |
...
Aggiunge i valori X e Y specificati alla serie di grafico.
...
Aggiunge il valore X specificato, il valore Y e la dimensione della bolla alla serie del grafico.
...
Specifica le impostazioni per le etichette dei dati dell'intera serie.
...
Ottiene una voce della legenda per questa serie del grafico.
...
Ottiene il nome della serie; se il nome non è impostato esplicitamente viene generato usando l'indice. Per impostazione predefinita restituisce Series più indice basato su uno.
...
**Returns:**
java.lang.String - Il nome della serie, se il nome non è impostato esplicitamente viene generato usando l'indice.
...
Ottiene il tipo di questa serie del grafico.
...
**Returns:**
int - Il tipo di questa serie di grafico. Il valore restituito è una delle costanti [ChartSeriesType](../../com.aspose.words/chartseriestype/).
### getSmooth() {#getSmooth}
```
...
Consente di specificare se la linea che collega i punti nel grafico deve essere smussata usando spline Catmull-Rom.
...
Ottiene una raccolta di valori X per questa serie del grafico.
...
Ottiene una raccolta di valori Y per questa serie del grafico.
...
Ottiene un flag che indica se le etichette dei dati sono visualizzate per la serie.
...
**Returns:**
boolean - Un flag che indica se le etichette dei dati sono visualizzate per la serie.
...
Imposta un flag che indica se le etichette dei dati sono visualizzate per la serie.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Un flag che indica se le etichette dei dati sono visualizzate per la serie. |
...
Il punto dati corrispondente con formattazione predefinita verrà inserito nella collezione dei punti dati. E, se le etichette dei dati sono visualizzate, anche l'etichetta dati corrispondente con formattazione predefinita verrà inserita.

 **Examples:** 

Mostra come inserire dati in una serie di grafico.
...
Rimuove il valore X, il valore Y e la dimensione della bolla, se supportati, dalla serie del grafico all'indice specificato. Anche il punto dati corrispondente e l'etichetta dati vengono rimossi.
...
Imposta il nome della serie; se il nome non è impostato esplicitamente viene generato usando l'indice. Per impostazione predefinita restituisce Series più indice basato su uno.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome della serie; se il nome non è impostato esplicitamente viene generato usando l'indice. |
