...
description: "Implementa il campo SUBJECT in Java."
type: docs
weight: 290
url: /it/java/com.aspose.words/fieldsubject/
---
...
Recupera e, facoltativamente, imposta l'oggetto del documento, come registrato nella proprietà **Subject** delle proprietà integrate del documento.
...
| [getText()](#getText) | Ottiene il testo dell'oggetto. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo dell'oggetto. |
...
**Returns:**
java.lang.String - Il testo dell'oggetto.
### getType() {#getType}
```
public int getType()
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo dell'oggetto. |
