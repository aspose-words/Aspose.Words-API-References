...
description: "Denota la fine di una regione di testo a cui è associato un commento in Java."
type: docs
weight: 111
url: /it/java/com.aspose.words/commentrangeend/
---
...
Denota la fine di una regione di testo a cui è associato un commento.

Per saperne di più, visita l'articolo di documentazione [ Working with Comments ][Working with Comments].

 **Remarks:** 

Per creare un commento ancorato a una regione di testo, è necessario creare un [Comment](../../com.aspose.words/comment/) e quindi creare [CommentRangeStart](../../com.aspose.words/commentrangestart/) e [CommentRangeEnd](../../com.aspose.words/commentrangeend/) e impostare i loro identificatori allo stesso valore di [Comment.getId()](../../com.aspose.words/comment/\#getId) / [Comment.setId(int)](../../com.aspose.words/comment/\#setId-int).
...
Mostra come stampare il contenuto di tutti i commenti e dei loro intervalli di commento utilizzando un visitatore di documento.
...
| --- | --- |
| [CommentRangeEnd(DocumentBase doc, int id)](#CommentRangeEnd-com.aspose.words.DocumentBase-int) | Inizializza una nuova istanza di questa classe. |
## Metodi
...
| [getId()](#getId) | Specifica l'identificatore del commento a cui questa regione è collegata. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Ottiene il nodo immediatamente successivo a questo nodo. |
| [getNodeType()](#getNodeType) | Restituisce [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). |
...
| [setId(int value)](#setId-int) | Specifica l'identificatore del commento a cui questa regione è collegata. |
...
Quando [CommentRangeEnd](../../com.aspose.words/commentrangeend/) viene creato, appartiene al documento specificato, ma non è ancora parte del documento e [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) è  null .

Per aggiungere un [CommentRangeEnd](../../com.aspose.words/commentrangeend/) al documento, usa InsertAfter o InsertBefore sul paragrafo in cui desideri inserire il commento.
...
| id | int | L'identificatore del commento a cui è collegato questo oggetto. |
...
Chiama [DocumentVisitor.visitCommentRangeEnd(com.aspose.words.CommentRangeEnd)](../../com.aspose.words/documentvisitor/\#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd).
...
Specifica l'identificatore del commento a cui questa regione è collegata.
...
Restituisce [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). Il valore restituito è una delle costanti di [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
