...
description: "Rappresenta un contributore di una fonte bibliografica in Java."
type: docs
weight: 128
url: /it/java/com.aspose.words/contributor/
---
...
Rappresenta un contributore di una fonte bibliografica. Può essere sia un'entità aziendale (un'organizzazione) sia un elenco di persone.
