...
description: "Rappresenta il tipo di stile in Java."
type: docs
weight: 644
url: /it/java/com.aspose.words/styletype/
---
...
| Campo | Descrizione |
| --- | --- |
| [CHARACTER](#CHARACTER) | Lo stile è uno stile di carattere. |
| [LIST](#LIST) | Lo stile è uno stile di elenco. |
| [PARAGRAPH](#PARAGRAPH) | Lo stile è uno stile di paragrafo. |
| [TABLE](#TABLE) | Lo stile è uno stile di tabella. |
| [length](#length) |  |
## Metodi
...
Lo stile è uno stile di carattere.
...
Lo stile è uno stile di elenco.
...
Lo stile è uno stile di paragrafo.
...
Lo stile è uno stile di tabella.
