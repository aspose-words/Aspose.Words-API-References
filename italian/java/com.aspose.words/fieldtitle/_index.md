...
description: "Implementa il campo TITLE in Java."
type: docs
weight: 296
url: /it/java/com.aspose.words/fieldtitle/
---
...
Recupera, e opzionalmente imposta, il titolo del documento, come registrato nella proprietà **Title** delle proprietà incorporate del documento.
...
| [getText()](#getText) | Ottiene il testo del titolo. |
...
| [setText(String value)](#setText-java.lang.String) | Imposta il testo del titolo. |
...
**Returns:**
java.lang.String - Il testo del titolo.
### getType() {#getType}
```
public int getType()
```
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo del titolo. |
