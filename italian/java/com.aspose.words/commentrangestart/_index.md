...
description: "Indica l'inizio di una regione di testo a cui è associato un commento in Java."
type: docs
weight: 112
url: /it/java/com.aspose.words/commentrangestart/
---
...
Denota l'inizio di una regione di testo a cui è associato un commento.
...
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | Inizializza una nuova istanza di questa classe. |
## Metodi
...
| [getId()](#getId) | Specifica l'identificatore del commento a cui è collegata questa regione. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Ottiene il nodo immediatamente successivo a questo nodo. |
| [getNodeType()](#getNodeType) | Restituisce [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). |
...
| [setId(int value)](#setId-int) | Specifica l'identificatore del commento a cui è collegata questa regione. |
...
Quando [CommentRangeStart](../../com.aspose.words/commentrangestart/) viene creato, appartiene al documento specificato, ma non è ancora parte del documento e [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) è null.

Per aggiungere un [CommentRangeStart](../../com.aspose.words/commentrangestart/) al documento, usa InsertAfter o InsertBefore sul paragrafo in cui desideri inserire il commento.
...
Chiama [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\#visitCommentRangeStart-com.aspose.words.CommentRangeStart).
...
Restituisce [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). Il valore restituito è una delle costanti di [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
