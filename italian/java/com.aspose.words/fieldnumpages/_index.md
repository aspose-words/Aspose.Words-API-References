...
description: "Implementa il campo NUMPAGES in Java."
type: docs
weight: 267
url: /it/java/com.aspose.words/fieldnumpages/
---

**Inheritance:**
java.lang.Object, [com.aspose.words.Field](../../com.aspose.words/field/)
```
public class FieldNumPages extends Field
```
...
Recupera il numero di pagine nel documento corrente, come registrato nella proprietà **Pages** delle proprietà incorporate del documento.

 **Examples:** 

Mostra come utilizzare i campi NUMCHARS, NUMWORDS, NUMPAGES e PAGE per monitorare le dimensioni dei nostri documenti.
