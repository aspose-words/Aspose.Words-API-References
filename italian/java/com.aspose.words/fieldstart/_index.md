...
description: "Rappresenta l'inizio di un campo Word in un documento in Java."
type: docs
weight: 288
url: /it/java/com.aspose.words/fieldstart/
---
...
| [getFieldData()](#getFieldData) | Ottiene i dati personalizzati del campo associati al campo. |
...
| [getNodeType()](#getNodeType) | Restituisce [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). |
...
Chiama [DocumentVisitor.visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
Ottiene i dati personalizzati del campo associati al campo.
...
**Returns:**
byte[] - Dati personalizzati del campo associati al campo.
...
Restituisce [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START).
...
**Returns:**
int - [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). Il valore restituito è una delle costanti di [NodeType](../../com.aspose.words/nodetype/).
