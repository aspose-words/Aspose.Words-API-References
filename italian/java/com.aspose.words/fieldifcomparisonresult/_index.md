...
description: "Specifica il risultato della valutazione della condizione del campo IF in Java."
type: docs
weight: 244
url: /it/java/com.aspose.words/fieldifcomparisonresult/
---
...
| Campo | Descrizione |
| --- | --- |
| [ERROR](#ERROR) | C'è un errore nella condizione. |
| [FALSE](#FALSE) | La condizione è  falso . |
| [TRUE](#TRUE) | La condizione è  vero . |
| [length](#length) |  |
## Metodi
...
C'è un errore nella condizione.
