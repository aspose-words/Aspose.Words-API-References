...
description: "Implementa il campo GOTOBUTTON in Java."
type: docs
weight: 240
url: /it/java/com.aspose.words/fieldgotobutton/
---
...
Implementa il campo GOTOBUTTON.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Inserisce un comando di salto, in modo che quando viene attivato, il punto di inserimento del documento venga spostato nella posizione specificata.
...
| [getDisplayText()](#getDisplayText) | Ottiene il testo del \"button\" che appare nel documento, in modo che possa essere selezionato per attivare il salto. |
...
| [getLocation()](#getLocation) | Ottiene il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Imposta il testo del \"button\" che appare nel documento, in modo che possa essere selezionato per attivare il salto. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setLocation(String value)](#setLocation-java.lang.String) | Imposta il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare. |
...
Ottiene il testo del \"button\" che appare nel documento, in modo che possa essere selezionato per attivare il salto.
...
**Returns:**
java.lang.String - Il testo del \"pulsante\" che appare nel documento, in modo che possa essere selezionato per attivare il salto.
### getEnd() {#getEnd}
```
...
Ottiene il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare.
...
**Returns:**
java.lang.String - Il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare.
### getResult() {#getResult}
```
...
Imposta il testo del \"button\" che appare nel documento, in modo che possa essere selezionato per attivare il salto.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo del \"pulsante\" che appare nel documento, in modo che possa essere selezionato per attivare il salto. |
...
Imposta il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome di un segnalibro, di un numero di pagina o di qualche altro elemento a cui saltare. |
