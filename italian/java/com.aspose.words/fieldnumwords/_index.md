...
description: "Implementa il campo NUMWORDS in Java."
type: docs
weight: 268
url: /it/java/com.aspose.words/fieldnumwords/
---
...
Implementa il campo NUMWORDS.

Per saperne di più, visita l'articolo di documentazione [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera il numero di parole nel documento corrente, come registrato nella proprietà **Words** delle proprietà incorporate del documento.
