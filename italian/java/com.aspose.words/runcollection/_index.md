...
description: "Fornisce accesso tipizzato a una raccolta di nodi Run in Java."
type: docs
weight: 594
url: /it/java/com.aspose.words/runcollection/
---
...
Fornisce accesso tipizzato a una raccolta di nodi [Run](../../com.aspose.words/run/) .
...
| [get(int index)](#get-int) | Recupera un [Run](../../com.aspose.words/run/) all'indice specificato. |
...
| [toArray()](#toArray) | Copia tutti i run dalla raccolta in un nuovo array di run. |
...
Recupera un [Run](../../com.aspose.words/run/) all'indice specificato.
...
Copia tutti i run dalla raccolta in un nuovo array di run.
...
**Returns:**
com.aspose.words.Node[] - Un array di run.
