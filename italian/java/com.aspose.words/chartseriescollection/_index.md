...
description: "Rappresenta una collezione di ChartSeries in Java."
type: docs
weight: 86
url: /it/java/com.aspose.words/chartseriescollection/
---
...
Rappresenta una collezione di [ChartSeries](../../com.aspose.words/chartseries/).
...
| Metodo | Descrizione |
| --- | --- |
| [add(String seriesName, ChartMultilevelValue[] categories, double[] values)](#add-java.lang.String-com.aspose.words.ChartMultilevelValue---double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, double[] xValues)](#add-java.lang.String-double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, double[] xValues, double[] yValues)](#add-java.lang.String-double---double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, double[] xValues, double[] yValues, double[] bubbleSizes)](#add-java.lang.String-double---double---double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, String[] categories, double[] values)](#add-java.lang.String-java.lang.String---double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, String[] categories, double[] values, boolean[] isSubtotal)](#add-java.lang.String-java.lang.String---double---boolean) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [add(String seriesName, Date[] dates, double[] values)](#add-java.lang.String-java.util.Date---double) | Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. |
| [clear()](#clear) | Rimuove tutti i [ChartSeries](../../com.aspose.words/chartseries/) da questa collezione. |
| [get(int index)](#get-int) | Restituisce un [ChartSeries](../../com.aspose.words/chartseries/) all'indice specificato. |
| [getCount()](#getCount) | Restituisce il numero di [ChartSeries](../../com.aspose.words/chartseries/) in questa collezione. |
| [iterator()](#iterator) | Restituisce un oggetto enumeratore. |
| [removeAt(int index)](#removeAt-int) | Rimuove un [ChartSeries](../../com.aspose.words/chartseries/) all'indice specificato. |
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie che hanno categorie di dati a più livelli.
...
Mostra come creare un grafico sunburst.
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie ai grafici Istogramma.

 **Remarks:** 

Per i tipi di grafico diversi da Istogramma, questo metodo aggiunge una serie con valori Y vuoti.

 **Examples:** 

Mostra come creare un grafico Istogramma.
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie a qualsiasi tipo di grafico a dispersione.
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie a qualsiasi tipo di grafico a bolle.
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie a qualsiasi tipo di grafico a barre, colonne, linee e superfici.
...
Mostra come creare un grafico Pareto.
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie ai grafici a cascata.

 **Remarks:** 

Per i tipi di grafico diversi da Cascata,  isSubtotal  vengono ignorati.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| seriesName | java.lang.String | Un nome della serie da aggiungere. |
| categories | java.lang.String[] | Nomi delle categorie per l'asse X. |
| valori | double[] | Valori dell'asse Y. |
...
Aggiunge un nuovo [ChartSeries](../../com.aspose.words/chartseries/) a questa collezione. Usa questo metodo per aggiungere serie a qualsiasi tipo di grafico ad area, radar e azionario.
...
Rimuove tutti i [ChartSeries](../../com.aspose.words/chartseries/) da questa collezione.
...
Restituisce un [ChartSeries](../../com.aspose.words/chartseries/) all'indice specificato.
...
Restituisce il numero di [ChartSeries](../../com.aspose.words/chartseries/) in questa collezione.
...
**Returns:**
int - Il numero di [ChartSeries](../../com.aspose.words/chartseries/) in questa collezione.
### iterator() {#iterator}
```
...
Rimuove un [ChartSeries](../../com.aspose.words/chartseries/) all'indice specificato.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| index | int | L'indice basato su zero del [ChartSeries](../../com.aspose.words/chartseries/) da rimuovere. |
