...
description: "Fornisce l'accesso al modulo del progetto VBA in Java."
type: docs
weight: 706
url: /it/java/com.aspose.words/vbamodule/
---
...
| Metodo | Descrizione |
| --- | --- |
| [deepClone()](#deepClone) | Esegue una copia del [VbaModule](../../com.aspose.words/vbamodule/). |
| [getName()](#getName) | Ottiene il nome del modulo del progetto VBA. |
| [getSourceCode()](#getSourceCode) | Ottiene il codice sorgente del modulo del progetto VBA. |
| [getType()](#getType) | Specifica se il modulo è un modulo procedurale, un modulo documento, un modulo classe o un modulo designer. |
| [setName(String value)](#setName-java.lang.String) | Imposta il nome del modulo del progetto VBA. |
| [setSourceCode(String value)](#setSourceCode-java.lang.String) | Imposta il codice sorgente del modulo del progetto VBA. |
| [setType(int value)](#setType-int) | Specifica se il modulo è un modulo procedurale, un modulo documento, un modulo classe o un modulo designer. |
### VbaModule() {#VbaModule}
```
public VbaModule()
```
...
Esegue una copia del [VbaModule](../../com.aspose.words/vbamodule/).
...
Ottiene il nome del modulo del progetto VBA.
...
**Returns:**
java.lang.String - nome del modulo del progetto VBA.
...
Ottiene il codice sorgente del modulo del progetto VBA.
...
**Returns:**
java.lang.String - codice sorgente del modulo del progetto VBA.
### getType() {#getType}
```
public int getType()
```
...
**Returns:**
int - Il valore  int  corrispondente. Il valore restituito è uno dei costanti [VbaModuleType](../../com.aspose.words/vbamoduletype/) constants.
...
Imposta il nome del modulo del progetto VBA.
...
| --- | --- | --- |
| valore | java.lang.String | Nome del modulo del progetto VBA. |
...
Imposta il codice sorgente del modulo del progetto VBA.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Codice sorgente del modulo del progetto VBA. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| value | int | Il valore  int  corrispondente. Il valore deve essere uno dei costanti [VbaModuleType](../../com.aspose.words/vbamoduletype/) constants. |
