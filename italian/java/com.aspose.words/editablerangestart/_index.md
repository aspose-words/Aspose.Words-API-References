...
description: "Rappresenta l'inizio di un intervallo modificabile in un documento Word in Java."
type: docs
weight: 181
url: /it/java/com.aspose.words/editablerangestart/
---
...
Un intervallo modificabile completo in un documento Word è costituito da un [EditableRangeStart](../../com.aspose.words/editablerangestart/) e da un corrispondente [EditableRangeEnd](../../com.aspose.words/editablerangeend/) con lo stesso Id.
...
Utilizza la classe [getEditableRange()](../../com.aspose.words/editablerangestart/\#getEditableRange) come una "facciata" per lavorare con un intervallo modificabile come un unico oggetto.
...
| [getEditableRange()](#getEditableRange) | Restituisce l'oggetto facciata che incapsula l'inizio e la fine di questo intervallo modificabile. |
...
| [getNodeType()](#getNodeType) | Restituisce [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). |
...
Chiama [DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor/\#visitEditableRangeStart-com.aspose.words.EditableRangeStart).
...
Restituisce l'oggetto facciata che incapsula l'inizio e la fine di questo intervallo modificabile.
...
Restituisce [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START).
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). Il valore restituito è una delle costanti [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
