...
description: "Regola di sostituzione delle informazioni di carattere in Java."
type: docs
weight: 328
url: /it/java/com.aspose.words/fontinfosubstitutionrule/
---
...
Regola di sostituzione delle informazioni del font.

Per saperne di più, visita l'articolo di documentazione [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Secondo questa regola Aspose.Words valuta tutti i campi correlati in [FontInfo](../../com.aspose.words/fontinfo/) (Panose, Sig ecc.) per il carattere mancante e trova la corrispondenza più vicina tra le font disponibili. Se [FontInfo](../../com.aspose.words/fontinfo/) non è disponibile per il carattere mancante, non verrà eseguita alcuna operazione.
