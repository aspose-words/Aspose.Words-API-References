...
description: "Implementa il campo CITATION in Java."
type: docs
weight: 211
url: /it/java/com.aspose.words/fieldcitation/
---
...
Inserisce il contenuto dell'elemento **Source** con un elemento **Tag** specificato usando uno stile bibliografico.
...
| Metodo | Descrizione |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | Ottiene un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Ottiene l'ID lingua utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getPageNumber()](#getPageNumber) | Ottiene un numero di pagina associato alla citazione. |
| [getPrefix()](#getPrefix) | Ottiene un prefisso che viene anteposto alla citazione. |
...
| [getSourceTag()](#getSourceTag) | Ottiene un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire. |
| [getStart()](#getStart) | Ottiene il nodo che rappresenta l'inizio del campo. |
| [getSuffix()](#getSuffix) | Ottiene un suffisso che viene aggiunto alla citazione. |
| [getSuppressAuthor()](#getSuppressAuthor) | Ottiene se le informazioni sull'autore sono soppresse dalla citazione. |
| [getSuppressTitle()](#getSuppressTitle) | Ottiene se le informazioni sul titolo sono soppresse dalla citazione. |
| [getSuppressYear()](#getSuppressYear) | Ottiene se le informazioni sull'anno sono soppresse dalla citazione. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Ottiene il tipo di campo di Microsoft Word. |
| [getVolumeNumber()](#getVolumeNumber) | Ottiene un numero di volume associato alla citazione. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | Imposta un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Imposta l'ID lingua utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setPageNumber(String value)](#setPageNumber-java.lang.String) | Imposta un numero di pagina associato alla citazione. |
| [setPrefix(String value)](#setPrefix-java.lang.String) | Imposta un prefisso che viene anteposto alla citazione. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Imposta un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | Imposta un suffisso che viene aggiunto alla citazione. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | Imposta se le informazioni sull'autore sono soppresse dalla citazione. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | Imposta se le informazioni sul titolo sono soppresse dalla citazione. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | Imposta se le informazioni sull'anno sono soppresse dalla citazione. |
| [setVolumeNumber(String value)](#setVolumeNumber-java.lang.String) | Imposta un numero di volume associato alla citazione. |
...
Ottiene un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione.
...
**Returns:**
java.lang.String - Un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione.
...
Ottiene l'ID lingua utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento.
...
**Returns:**
java.lang.String - L'ID lingua utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento.
...
Ottiene un numero di pagina associato alla citazione.
...
**Returns:**
java.lang.String - Un numero di pagina associato alla citazione.
### getPrefix() {#getPrefix}
```
...
Ottiene un prefisso che viene anteposto alla citazione.
...
**Returns:**
java.lang.String - Un prefisso che viene anteposto alla citazione.
### getResult() {#getResult}
```
...
Ottiene un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire.
...
**Returns:**
java.lang.String - Un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire.
### getStart() {#getStart}
```
...
Ottiene un suffisso che viene aggiunto alla citazione.
...
**Returns:**
java.lang.String - Un suffisso che viene aggiunto alla citazione.
...
Ottiene se le informazioni sull'autore sono soppresse dalla citazione.
...
**Returns:**
boolean - Se le informazioni sull'autore sono soppresse dalla citazione.
...
Ottiene se le informazioni sul titolo sono soppresse dalla citazione.
...
**Returns:**
boolean - Se le informazioni sul titolo sono soppresse dalla citazione.
...
Ottiene se le informazioni sull'anno sono soppresse dalla citazione.
...
**Returns:**
boolean - Se le informazioni sull'anno sono soppresse dalla citazione.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Ottiene un numero di volume associato alla citazione.
...
**Returns:**
java.lang.String - Un numero di volume associato alla citazione.
### isDirty() {#isDirty}
```
...
Imposta un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un valore che corrisponde al valore dell'elemento **Tag** di un'altra fonte da includere nella citazione. |
...
Imposta l'ID lingua utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | L'ID lingua che viene utilizzato in combinazione con lo stile bibliografico specificato per formattare la citazione nel documento. |
...
Imposta un numero di pagina associato alla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un numero di pagina associato alla citazione. |
...
Imposta un prefisso che viene anteposto alla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un prefisso che viene anteposto alla citazione. |
...
Imposta un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un valore che corrisponde al valore dell'elemento **Tag** della fonte da inserire. |
...
Imposta un suffisso che viene aggiunto alla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un suffisso che viene aggiunto alla citazione. |
...
Imposta se le informazioni sull'autore sono soppresse dalla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se le informazioni sull'autore sono nascoste nella citazione. |
...
Imposta se le informazioni sul titolo sono soppresse dalla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se le informazioni sul titolo sono nascoste nella citazione. |
...
Imposta se le informazioni sull'anno sono soppresse dalla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se le informazioni sull'anno sono nascoste nella citazione. |
...
Imposta un numero di volume associato alla citazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un numero di volume associato alla citazione. |
