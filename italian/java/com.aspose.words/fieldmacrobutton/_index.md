...
description: "Implementa il campo MACROBUTTON in Java."
type: docs
weight: 256
url: /it/java/com.aspose.words/fieldmacrobutton/
---
...
Mostra come utilizzare i campi MACROBUTTON per consentire l'esecuzione delle macro di un documento con un clic.
...
| [getDisplayText()](#getDisplayText) | Ottiene il testo da visualizzare come "pulsante" selezionato per eseguire la macro o il comando. |
...
| [getMacroName()](#getMacroName) | Ottiene il nome della macro o del comando da eseguire. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Imposta il testo da visualizzare come "pulsante" selezionato per eseguire la macro o il comando. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Imposta il nome della macro o del comando da eseguire. |
...
Ottiene il testo da visualizzare come "pulsante" selezionato per eseguire la macro o il comando.
...
**Returns:**
java.lang.String - Il testo da visualizzare come "pulsante" selezionato per eseguire la macro o il comando.
### getEnd() {#getEnd}
```
...
Ottiene il nome della macro o del comando da eseguire.
...
**Returns:**
java.lang.String - Il nome della macro o del comando da eseguire.
### getMergeFieldName() {#getMergeFieldName}
```
...
Imposta il testo da visualizzare come "pulsante" selezionato per eseguire la macro o il comando.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo da visualizzare come il "pulsante" che viene selezionato per eseguire la macro o il comando. |
...
Imposta il nome della macro o del comando da eseguire.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome della macro o del comando da eseguire. |
