...
description: "Quando implementato fornisce un oggetto CultureInfo che dovrebbe essere usato durante l'aggiornamento di un campo particolare in Java."
type: docs
weight: 767
url: /it/java/com.aspose.words/ifieldupdatecultureprovider/
---
```
public interface IFieldUpdateCultureProvider
```

Quando implementato, fornisce un oggetto [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) che dovrebbe essere usato durante l'aggiornamento di un campo particolare.

 **Examples:** 

Mostra come specificare una cultura che analizza la formattazione data/ora per ogni campo.
...
| Metodo | Descrizione |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | Restituisce un oggetto [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) da utilizzare durante l'aggiornamento del campo. |
...
Restituisce un oggetto [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) da utilizzare durante l'aggiornamento del campo.
...
| --- | --- | --- |
| cultura | java.lang.String | Il nome della cultura richiesta per il campo in aggiornamento. |
| field | [Field](../../com.aspose.words/field/) | Il campo che viene aggiornato. |
