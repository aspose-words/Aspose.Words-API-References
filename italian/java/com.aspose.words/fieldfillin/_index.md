...
description: "Implementa il campo FILLIN in Java."
type: docs
weight: 232
url: /it/java/com.aspose.words/fieldfillin/
---
...
Richiede all'utente di inserire del testo.

 **Examples:** 

Mostra come utilizzare il campo FILLIN per richiedere all'utente una risposta.
...
| Metodo | Descrizione |
| --- | --- |
| [getDefaultResponse()](#getDefaultResponse) | Ottiene la risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | Ottiene se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione. |
| [getPromptText()](#getPromptText) | Ottiene il testo del prompt (il titolo della finestra di prompt). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | Imposta la risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt). |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | Imposta se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | Imposta il testo del prompt (il titolo della finestra di prompt). |
...
Ottiene la risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt).
...
**Returns:**
java.lang.String - Risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt).
...
Ottiene se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione.
...
**Returns:**
boolean - Se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione.
...
Ottiene il testo del prompt (il titolo della finestra di prompt).
...
**Returns:**
java.lang.String - Il testo del prompt (il titolo della finestra di prompt).
### getResult() {#getResult}
```
...
Imposta la risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Risposta predefinita dell'utente (valore iniziale contenuto nella finestra di prompt). |
...
Imposta se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se la risposta dell'utente deve essere ricevuta una sola volta per un'operazione di stampa unione. |
...
Imposta il testo del prompt (il titolo della finestra di prompt).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il testo del prompt (il titolo della finestra di prompt). |
