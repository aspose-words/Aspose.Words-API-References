...
description: "Implementa il campo LINK in Java."
type: docs
weight: 254
url: /it/java/com.aspose.words/fieldlink/
---
...
| Metodo | Descrizione |
| --- | --- |
| [getAutoUpdate()](#getAutoUpdate) | Ottiene se aggiornare automaticamente questo campo. |
...
| [getFormatUpdateType()](#getFormatUpdateType) | Ottiene un modo in cui l'oggetto collegato aggiorna la formattazione. |
| [getInsertAsBitmap()](#getInsertAsBitmap) | Restituisce se inserire l'oggetto collegato come bitmap. |
| [getInsertAsHtml()](#getInsertAsHtml) | Restituisce se inserire l'oggetto collegato come testo in formato HTML. |
| [getInsertAsPicture()](#getInsertAsPicture) | Restituisce se inserire l'oggetto collegato come immagine. |
| [getInsertAsRtf()](#getInsertAsRtf) | Restituisce se inserire l'oggetto collegato in formato rich-text (RTF). |
| [getInsertAsText()](#getInsertAsText) | Restituisce se inserire l'oggetto collegato in formato solo testo. |
| [getInsertAsUnicode()](#getInsertAsUnicode) | Restituisce se inserire l'oggetto collegato come testo Unicode. |
| [getLocaleId()](#getLocaleId) | Ottiene il LCID del campo. |
| [getProgId()](#getProgId) | Ottiene il tipo di applicazione delle informazioni sul collegamento. |
...
| [getSourceFullName()](#getSourceFullName) | Ottiene il nome e la posizione del file di origine. |
| [getSourceItem()](#getSourceItem) | Ottiene la parte del file di origine che viene collegata. |
...
| [isLinked()](#isLinked) | Ottiene se ridurre le dimensioni del file non memorizzando i dati grafici con il documento. |
| [isLinked(boolean value)](#isLinked-boolean) | Imposta se ridurre le dimensioni del file non memorizzando i dati grafici con il documento. |
...
| [setAutoUpdate(boolean value)](#setAutoUpdate-boolean) | Imposta se aggiornare automaticamente questo campo. |
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String) | Imposta un modo in cui l'oggetto collegato aggiorna la formattazione. |
| [setInsertAsBitmap(boolean value)](#setInsertAsBitmap-boolean) | Imposta se inserire l'oggetto collegato come bitmap. |
| [setInsertAsHtml(boolean value)](#setInsertAsHtml-boolean) | Imposta se inserire l'oggetto collegato come testo in formato HTML. |
| [setInsertAsPicture(boolean value)](#setInsertAsPicture-boolean) | Imposta se inserire l'oggetto collegato come immagine. |
| [setInsertAsRtf(boolean value)](#setInsertAsRtf-boolean) | Imposta se inserire l'oggetto collegato in formato rich-text (RTF). |
| [setInsertAsText(boolean value)](#setInsertAsText-boolean) | Imposta se inserire l'oggetto collegato in formato solo testo. |
| [setInsertAsUnicode(boolean value)](#setInsertAsUnicode-boolean) | Imposta se inserire l'oggetto collegato come testo Unicode. |
| [setLocaleId(int value)](#setLocaleId-int) | Imposta il LCID del campo. |
| [setProgId(String value)](#setProgId-java.lang.String) | Imposta il tipo di applicazione delle informazioni sul collegamento. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Imposta il nome e la posizione del file di origine. |
| [setSourceItem(String value)](#setSourceItem-java.lang.String) | Imposta la parte del file di origine che viene collegata. |
...
Ottiene se aggiornare automaticamente questo campo.
...
**Returns:**
boolean - Se aggiornare automaticamente questo campo.
...
Ottiene un modo in cui l'oggetto collegato aggiorna la formattazione.
...
**Returns:**
java.lang.String - Un modo in cui l'oggetto collegato aggiorna la formattazione.
...
Restituisce se inserire l'oggetto collegato come bitmap.
...
**Returns:**
boolean - Se inserire l'oggetto collegato come bitmap.
...
Restituisce se inserire l'oggetto collegato come testo in formato HTML.
...
**Returns:**
boolean - Se inserire l'oggetto collegato come testo in formato HTML.
...
Restituisce se inserire l'oggetto collegato come immagine.
...
**Returns:**
boolean - Se inserire l'oggetto collegato come immagine.
...
Restituisce se inserire l'oggetto collegato in formato rich-text (RTF).
...
**Returns:**
boolean - Se inserire l'oggetto collegato in formato rich-text (RTF).
...
Restituisce se inserire l'oggetto collegato in formato solo testo.
...
**Returns:**
boolean - Se inserire l'oggetto collegato in formato solo testo.
...
Restituisce se inserire l'oggetto collegato come testo Unicode.
...
**Returns:**
boolean - Se inserire l'oggetto collegato come testo Unicode.
...
Ottiene il tipo di applicazione delle informazioni sul collegamento.
...
**Returns:**
java.lang.String - Il tipo di applicazione delle informazioni sul collegamento.
### getResult() {#getResult}
```
...
Ottiene il nome e la posizione del file di origine.
...
**Returns:**
java.lang.String - Il nome e la posizione del file di origine.
...
Ottiene la parte del file di origine che viene collegata.
...
**Returns:**
java.lang.String - La parte del file di origine che viene collegata.
### getStart() {#getStart}
```
...
Ottiene se ridurre le dimensioni del file non memorizzando i dati grafici con il documento.
...
**Returns:**
boolean - Se ridurre le dimensioni del file non memorizzando i dati grafici con il documento.
...
Imposta se ridurre le dimensioni del file non memorizzando i dati grafici con il documento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se ridurre le dimensioni del file non memorizzando i dati grafici con il documento. |
...
Imposta se aggiornare automaticamente questo campo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se aggiornare automaticamente questo campo. |
...
Imposta un modo in cui l'oggetto collegato aggiorna la formattazione.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Un modo in cui l'oggetto collegato aggiorna la formattazione. |
...
Imposta se inserire l'oggetto collegato come bitmap.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato come bitmap. |
...
Imposta se inserire l'oggetto collegato come testo in formato HTML.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato come testo in formato HTML. |
...
Imposta se inserire l'oggetto collegato come immagine.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato come immagine. |
...
Imposta se inserire l'oggetto collegato in formato rich-text (RTF).
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato in formato rich-text (RTF). |
...
Imposta se inserire l'oggetto collegato in formato solo testo.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato in formato solo testo. |
...
Imposta se inserire l'oggetto collegato come testo Unicode.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se inserire l'oggetto collegato come testo Unicode. |
...
Imposta il tipo di applicazione delle informazioni sul collegamento.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il tipo di applicazione delle informazioni del collegamento. |
...
Imposta il nome e la posizione del file di origine.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome e la posizione del file di origine. |
...
Imposta la parte del file di origine che viene collegata.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | La parte del file di origine che viene collegata. |
