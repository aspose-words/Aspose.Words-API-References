...
description: "Implementa il campo RD in Java."
type: docs
weight: 277
url: /it/java/com.aspose.words/fieldrd/
---
...
Identifica un file da includere quando crei un indice, un indice delle autorità o un indice con i campi TOC, TOA o INDEX.
...
| [getFileName()](#getFileName) | Ottiene il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice. |
...
| [isPathRelative()](#isPathRelative) | Ottiene se il percorso è relativo al documento corrente. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Imposta se il percorso è relativo al documento corrente. |
| [remove()](#remove) | Rimuove il campo dal documento. |
| [setFileName(String value)](#setFileName-java.lang.String) | Imposta il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice. |
...
Ottiene il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice.
...
**Returns:**
java.lang.String - Il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice.
### getFormat() {#getFormat}
```
...
Ottiene se il percorso è relativo al documento corrente.
...
**Returns:**
boolean - Se il percorso è relativo al documento corrente.
...
Imposta se il percorso è relativo al documento corrente.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | boolean | Se il percorso è relativo al documento corrente. |
...
Imposta il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| valore | java.lang.String | Il nome del file da includere durante la generazione di un indice, un indice delle autorità o un indice. |
