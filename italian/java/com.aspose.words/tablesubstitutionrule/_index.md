...
description: "Regola di sostituzione dei caratteri della tabella in Java."
type: docs
weight: 662
url: /it/java/com.aspose.words/tablesubstitutionrule/
---
...
Regola di sostituzione del font della tabella.

Per saperne di più, visita l'articolo di documentazione [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Questa regola definisce l'elenco dei nomi di caratteri sostitutivi da utilizzare se il carattere originale non è disponibile. I sostituti verranno controllati per il nome del carattere e il [FontInfo.getAltName()](../../com.aspose.words/fontinfo/\#getAltName) / [FontInfo.setAltName(java.lang.String)](../../com.aspose.words/fontinfo/\#setAltName-java.lang.String) (se presenti).
...
| Metodo | Descrizione |
| --- | --- |
| [addSubstitutes(String originalFontName, String[] substituteFontNames)](#addSubstitutes-java.lang.String-java.lang.String...) | Aggiunge i nomi di caratteri sostitutivi per il nome del carattere originale specificato. |
| [getEnabled()](#getEnabled) | Specifica se la regola è abilitata o meno. |
| [getSubstitutes(String originalFontName)](#getSubstitutes-java.lang.String) | Restituisce un array contenente i nomi di caratteri sostitutivi per il nome del carattere originale specificato. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | Carica le impostazioni di sostituzione della tabella da un file XML. |
...
| [save(String fileName)](#save-java.lang.String) | Salva le impostazioni di sostituzione della tabella correnti su file. |
| [setEnabled(boolean value)](#setEnabled-boolean) | Specifica se la regola è abilitata o meno. |
| [setSubstitutes(String originalFontName, String[] substituteFontNames)](#setSubstitutes-java.lang.String-java.lang.String...) | Sovrascrivi i nomi di caratteri sostitutivi per il nome del carattere originale specificato. |
...
Aggiunge i nomi di caratteri sostitutivi per il nome del carattere originale specificato.
...
| substituteFontNames | java.lang.String[] | Elenco dei nomi di caratteri alternativi. |
...
Restituisce un array contenente i nomi di caratteri sostitutivi per il nome del carattere originale specificato.
...
**Returns:**
java.lang.Iterable - Elenco dei nomi di caratteri alternativi.
### load(InputStream stream) {#load-java.io.InputStream}
```
...
Carica le impostazioni di sostituzione della tabella da un file XML.
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | java.lang.String | Nome del file di input. |
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| fileName | java.lang.String | Nome file di output. |
...
Sovrascrivi i nomi di caratteri sostitutivi per il nome del carattere originale specificato.
