...
description: "Specifica le opzioni disponibili per la gestione degli spazi iniziali durante l'importazione dal file LoadFormat.TEXT in Java."
type: docs
weight: 691
url: /it/java/com.aspose.words/txtleadingspacesoptions/
---
...
Specifica le opzioni disponibili per la gestione degli spazi iniziali durante l'importazione dal file [LoadFormat.TEXT](../../com.aspose.words/loadformat/#TEXT).
...
| Campo | Descrizione |
| --- | --- |
| [CONVERT_TO_INDENT](#CONVERT-TO-INDENT) | Gli spazi iniziali vengono rimossi e convertiti in rientro sinistro. |
| [PRESERVE](#PRESERVE) | Gli spazi iniziali vengono conservati. |
| [TRIM](#TRIM) | Gli spazi iniziali vengono eliminati |
| [length](#length) |  |
## Metodi
...
Gli spazi iniziali vengono rimossi e convertiti in rientro sinistro.
...
Gli spazi iniziali vengono conservati.
