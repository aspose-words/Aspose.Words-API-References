...
description: "Fornisce accesso tipizzato a una raccolta di nodi Paragraph in Java."
type: docs
weight: 524
url: /it/java/com.aspose.words/paragraphcollection/
---
...
Fornisce accesso tipizzato a una raccolta di nodi [Paragraph](../../com.aspose.words/paragraph/).
...
| [get(int index)](#get-int) | Recupera un [Paragrafo](../../com.aspose.words/paragraph/) all'indice specificato. |
...
| [toArray()](#toArray) | Copia tutti i paragrafi dalla collezione in un nuovo array di paragrafi. |
...
Recupera un [Paragrafo](../../com.aspose.words/paragraph/) all'indice specificato.
...
Copia tutti i paragrafi dalla collezione in un nuovo array di paragrafi.

 **Examples:** 

Mostra come creare un array da una NodeCollection.
...
**Returns:**
com.aspose.words.Node[] - Un array di paragrafi.
