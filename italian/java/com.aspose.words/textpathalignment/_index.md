...
description: "Allineamento WordArt in Java."
type: docs
weight: 677
url: /it/java/com.aspose.words/textpathalignment/
---
...
| Campo | Descrizione |
| --- | --- |
| [CENTER](#CENTER) | Centra il testo sulla larghezza. |
| [LEFT](#LEFT) | Allinea a sinistra. |
| [LETTER_JUSTIFY](#LETTER-JUSTIFY) | Distribuisci le lettere per adattarle alla larghezza. |
| [RIGHT](#RIGHT) | Allinea a destra. |
| [STRETCH](#STRETCH) | Allunga ogni riga di testo per adattarla alla larghezza. |
| [WORD_JUSTIFY](#WORD-JUSTIFY) | Distribuisci le parole per adattarle alla larghezza. |
| [length](#length) |  |
## Metodi
...
Centra il testo sulla larghezza.
...
Distribuisci le lettere per adattarle alla larghezza.
...
Allunga ogni riga di testo per adattarla alla larghezza.
...
Distribuisci le parole per adattarle alla larghezza.
