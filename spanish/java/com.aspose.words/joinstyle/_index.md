...
description: "Estilo de unión de líneas en Java."
type: docs
weight: 407
url: /es/java/com.aspose.words/joinstyle/
---
...
| Campo | Descripción |
| --- | --- |
| [BEVEL](#BEVEL) | Une los bordes con una línea recta. |
| [MITER](#MITER) | Extiende los bordes hasta que se unan. |
| [ROUND](#ROUND) | Dibuja un arco entre los dos bordes. |
| [length](#length) |  |
## Métodos
...
Une los bordes con una línea recta.
...
Extiende los bordes hasta que se unan.
...
Dibuja un arco entre los dos bordes.
