...
description: "Implementa el campo CREATEDATE en Java."
type: docs
weight: 215
url: /es/java/com.aspose.words/fieldcreatedate/
---
...
Implementa el campo CREATEDATE.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Obtiene la fecha y hora en que se creó el documento. Por defecto, se utiliza el calendario gregoriano.
...
| [getUseLunarCalendar()](#getUseLunarCalendar) | Obtiene si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | Obtiene si se debe usar el calendario de la era Saka. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | Obtiene si se debe usar el calendario Um-al-Qura. |
...
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | Establece si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | Establece si se debe usar el calendario de la era Saka. |
| [setUseUmAlQuraCalendar(boolean value)](#setUseUmAlQuraCalendar-boolean) | Establece si se debe usar el calendario Um-al-Qura. |
...
Obtiene si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo.

**Returns:**
boolean - Si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo.
...
Obtiene si se debe usar el calendario de la era Saka.

**Returns:**
boolean - Si se debe usar el calendario de la era Saka.
...
Obtiene si se debe usar el calendario Um-al-Qura.

**Returns:**
boolean - Si se debe usar el calendario Um-al-Qura.
### isDirty() {#isDirty}
```
...
Establece si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe usar el calendario lunar Hijri o el calendario lunar Hebreo. |
...
Establece si se debe usar el calendario de la era Saka.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe usar el calendario Saka Era. |
...
Establece si se debe usar el calendario Um-al-Qura.

**Parameters:**
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe usar el calendario Um-al-Qura. |
