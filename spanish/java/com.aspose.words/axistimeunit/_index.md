...
description: "Especifica la unidad de tiempo para los ejes en Java."
type: docs
weight: 33
url: /es/java/com.aspose.words/axistimeunit/
---
...
| Campo | Descripción |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Especifica que la unidad no se estableció explícitamente y se debe usar el valor predeterminado. |
...
Especifica que la unidad no se estableció explícitamente y se debe usar el valor predeterminado.
