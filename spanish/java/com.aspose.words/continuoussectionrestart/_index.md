...
description: "Representa diferentes comportamientos al calcular los números de página en una sección continua que reinicia la numeración de páginas en Java."
type: docs
weight: 127
url: /es/java/com.aspose.words/continuoussectionrestart/
---
...
| Campo | Descripción |
| --- | --- |
| [ALWAYS](#ALWAYS) | La numeración de páginas siempre se reinicia sin importar el flujo del contenido. |
| [FROM_NEW_PAGE_ONLY](#FROM-NEW-PAGE-ONLY) | La numeración de páginas se reinicia solo si no hay otro contenido antes de la sección en la página donde comienza la sección. |
| [length](#length) |  |
## Métodos
...
La numeración de páginas siempre se reinicia sin importar el flujo del contenido.

 **Remarks:** 

Este comportamiento es demostrado por todas las versiones de MS Word, excepto Word 2016.
...
El comportamiento es demostrado por MS Word 2016.
