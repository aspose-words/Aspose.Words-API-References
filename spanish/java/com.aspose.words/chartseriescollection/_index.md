...
description: "Representa una colección de ChartSeries en Java."
type: docs
weight: 86
url: /es/java/com.aspose.words/chartseriescollection/
---
...
Representa una colección de [ChartSeries](../../com.aspose.words/chartseries/).
...
| Método | Descripción |
| --- | --- |
| [add(String seriesName, ChartMultilevelValue[] categories, double[] values)](#add-java.lang.String-com.aspose.words.ChartMultilevelValue---double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, double[] xValues)](#add-java.lang.String-double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, double[] xValues, double[] yValues)](#add-java.lang.String-double---double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, double[] xValues, double[] yValues, double[] bubbleSizes)](#add-java.lang.String-double---double---double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, String[] categories, double[] values)](#add-java.lang.String-java.lang.String---double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, String[] categories, double[] values, boolean[] isSubtotal)](#add-java.lang.String-java.lang.String---double---boolean) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [add(String seriesName, Date[] dates, double[] values)](#add-java.lang.String-java.util.Date---double) | Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. |
| [clear()](#clear) | Elimina todos los [ChartSeries](../../com.aspose.words/chartseries/) de esta colección. |
| [get(int index)](#get-int) | Devuelve un [ChartSeries](../../com.aspose.words/chartseries/) en el índice especificado. |
| [getCount()](#getCount) | Devuelve el número de [ChartSeries](../../com.aspose.words/chartseries/) en esta colección. |
| [iterator()](#iterator) | Devuelve un objeto enumerador. |
| [removeAt(int index)](#removeAt-int) | Elimina un [ChartSeries](../../com.aspose.words/chartseries/) en el índice especificado. |
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Utilice este método para agregar series que tengan categorías de datos multinivel.
...
Muestra cómo crear un gráfico sunburst.
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Utilice este método para agregar series a gráficos de histograma.

 **Remarks:** 

Para tipos de gráfico diferentes a Histograma, este método agrega una serie con valores Y vacíos.
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Use este método para agregar series a cualquier tipo de gráficos de dispersión.
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Use este método para agregar series a cualquier tipo de gráficos de burbujas.
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Use este método para agregar series a cualquier tipo de gráficos de barras, columnas, líneas y superficies.
...
Muestra cómo crear un gráfico de pareto.
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Use este método para agregar series a cualquier tipo de gráficos de cascada.

 **Remarks:** 

Para los tipos de gráfico diferentes a Cascada, los valores de  isSubtotal  se ignoran.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| seriesName | java.lang.String | Un nombre de la serie a agregar. |
| categories | java.lang.String[] | Nombres de categoría para el eje X. |
| valores | double[] | Valores del eje Y. |
...
Agrega un nuevo [ChartSeries](../../com.aspose.words/chartseries/) a esta colección. Use este método para agregar series a cualquier tipo de gráficos de área, radar y de bolsa.
...
Elimina todos los [ChartSeries](../../com.aspose.words/chartseries/) de esta colección.
...
Devuelve un [ChartSeries](../../com.aspose.words/chartseries/) en el índice especificado.
...
Devuelve el número de [ChartSeries](../../com.aspose.words/chartseries/) en esta colección.
...
**Returns:**
int - El número de [ChartSeries](../../com.aspose.words/chartseries/) en esta colección.
### iterator() {#iterator}
```
...
Elimina un [ChartSeries](../../com.aspose.words/chartseries/) en el índice especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int | El índice basado en cero del [ChartSeries](../../com.aspose.words/chartseries/) a eliminar. |
