...
description: "Una colección de objetos BuildingBlock en el documento en Java."
type: docs
weight: 54
url: /es/java/com.aspose.words/buildingblockcollection/
---
...
Una colección de [BuildingBlock](../../com.aspose.words/buildingblock/) objetos en el documento.
...
No crea instancias de esta clase directamente. Para acceder a una colección de bloques de construcción use la propiedad [GlossaryDocument.getBuildingBlocks()](../../com.aspose.words/glossarydocument/\#getBuildingBlocks).
...
| [get(int index)](#get-int) | Recupera un bloque de construcción en el índice dado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | Un índice en la lista de bloques de construcción. |
...
**Returns:**
com.aspose.words.Node[] - Una matriz de bloques de construcción.
