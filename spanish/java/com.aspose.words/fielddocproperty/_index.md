...
description: "Implementa el campo DOCPROPERTY en Java."
type: docs
weight: 224
url: /es/java/com.aspose.words/fielddocproperty/
---
...
Recupera la información del documento indicada.

 **Examples:** 

Muestra cómo usar los campos DOCPROPERTY para mostrar propiedades y variables del documento.
