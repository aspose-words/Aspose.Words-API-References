...
description: "Implementa el campo DATE en Java."
type: docs
weight: 220
url: /es/java/com.aspose.words/fielddate/
---
...
| [getUseLastFormat()](#getUseLastFormat) | Obtiene si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Establece si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE. |
...
Obtiene si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE.
...
**Returns:**
boolean - Indica si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE.
...
Establece si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE. |
