...
description: "Implementa el campo CITATION en Java."
type: docs
weight: 211
url: /es/java/com.aspose.words/fieldcitation/
---
...
Inserta el contenido del elemento **Source** con un elemento **Tag** especificado usando un estilo bibliográfico.

 **Examples:** 

Muestra cómo trabajar con los campos CITATION y BIBLIOGRAPHY.
...
| Método | Descripción |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | Obtiene un valor que coincide con el valor del elemento **Tag** de otra fuente que se incluirá en la citación. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Obtiene el ID de idioma que se usa junto con el estilo bibliográfico especificado para formatear la citación en el documento. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getPageNumber()](#getPageNumber) | Obtiene un número de página asociado con la citación. |
| [getPrefix()](#getPrefix) | Obtiene un prefijo que se antepone a la citación. |
...
| [getSourceTag()](#getSourceTag) | Obtiene un valor que coincide con el valor del elemento **Tag** de la fuente a insertar. |
| [getStart()](#getStart) | Obtiene el nodo que representa el inicio del campo. |
| [getSuffix()](#getSuffix) | Obtiene un sufijo que se agrega a la citación. |
| [getSuppressAuthor()](#getSuppressAuthor) | Obtiene si la información del autor está suprimida de la cita. |
| [getSuppressTitle()](#getSuppressTitle) | Obtiene si la información del título está suprimida de la cita. |
| [getSuppressYear()](#getSuppressYear) | Obtiene si la información del año está suprimida de la cita. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Obtiene el tipo de campo de Microsoft Word. |
| [getVolumeNumber()](#getVolumeNumber) | Obtiene un número de volumen asociado a la cita. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | Establece un valor que coincide con el valor del elemento **Tag** de otra fuente para ser incluido en la cita. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Establece el ID de idioma que se usa junto con el estilo bibliográfico especificado para formatear la cita en el documento. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setPageNumber(String value)](#setPageNumber-java.lang.String) | Establece un número de página asociado a la cita. |
| [setPrefix(String value)](#setPrefix-java.lang.String) | Establece un prefijo que se antepone a la cita. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Establece un valor que coincide con el valor del elemento **Tag** de la fuente a insertar. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | Establece un sufijo que se agrega a la cita. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | Establece si la información del autor está suprimida de la cita. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | Establece si la información del título está suprimida de la cita. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | Establece si la información del año está suprimida de la cita. |
| [setVolumeNumber(String value)](#setVolumeNumber-java.lang.String) | Establece un número de volumen asociado a la cita. |
...
Obtiene un valor que coincide con el valor del elemento **Tag** de otra fuente que se incluirá en la citación.
...
**Returns:**
java.lang.String - Un valor que coincide con el valor del elemento **Tag** de otra fuente para ser incluido en la cita.
...
Obtiene el ID de idioma que se usa junto con el estilo bibliográfico especificado para formatear la citación en el documento.
...
**Returns:**
java.lang.String - El ID de idioma que se usa junto con el estilo bibliográfico especificado para formatear la cita en el documento.
...
Obtiene un número de página asociado con la citación.
...
**Returns:**
java.lang.String - Un número de página asociado a la cita.
### getPrefix() {#getPrefix}
```
...
Obtiene un prefijo que se antepone a la citación.
...
**Returns:**
java.lang.String - Un prefijo que se antepone a la cita.
### getResult() {#getResult}
```
...
Obtiene un valor que coincide con el valor del elemento **Tag** de la fuente a insertar.
...
**Returns:**
java.lang.String - Un valor que coincide con el valor del elemento **Tag** de la fuente a insertar.
### getStart() {#getStart}
```
...
Obtiene un sufijo que se agrega a la citación.
...
**Returns:**
java.lang.String - Un sufijo que se agrega a la cita.
...
Obtiene si la información del autor está suprimida de la cita.
...
**Returns:**
boolean - Si la información del autor está suprimida de la cita.
...
Obtiene si la información del título está suprimida de la cita.
...
**Returns:**
boolean - Si la información del título está suprimida de la cita.
...
Obtiene si la información del año está suprimida de la cita.
...
**Returns:**
boolean - Si la información del año está suprimida de la cita.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Obtiene un número de volumen asociado a la cita.
...
**Returns:**
java.lang.String - Un número de volumen asociado a la cita.
### isDirty() {#isDirty}
```
...
Establece un valor que coincide con el valor del elemento **Tag** de otra fuente para ser incluido en la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un valor que coincide con el valor del elemento **Tag** de otra fuente para ser incluido en la cita. |
...
Establece el ID de idioma que se usa junto con el estilo bibliográfico especificado para formatear la cita en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El ID de idioma que se usa en conjunto con el estilo bibliográfico especificado para formatear la cita en el documento. |
...
Establece un número de página asociado a la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un número de página asociado con la cita. |
...
Establece un prefijo que se antepone a la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un prefijo que se antepone a la cita. |
...
Establece un valor que coincide con el valor del elemento **Tag** de la fuente a insertar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un valor que coincide con el valor del elemento **Tag** de la fuente a insertar. |
...
Establece un sufijo que se agrega a la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un sufijo que se agrega a la cita. |
...
Establece si la información del autor está suprimida de la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si la información del autor se suprime de la cita. |
...
Establece si la información del título está suprimida de la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si la información del título se suprime de la cita. |
...
Establece si la información del año está suprimida de la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si la información del año se suprime de la cita. |
...
Establece un número de volumen asociado a la cita.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un número de volumen asociado con la cita. |
