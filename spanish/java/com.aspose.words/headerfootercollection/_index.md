...
description: "Proporciona acceso tipado a los nodos HeaderFooter de una Section en Java."
type: docs
weight: 371
url: /es/java/com.aspose.words/headerfootercollection/
---
...
Proporciona acceso tipado a los nodos [HeaderFooter](../../com.aspose.words/headerfooter/) de una [Section](../../com.aspose.words/section/).

Para obtener más información, visite el artículo de documentación [ Working with Headers and Footers ][Working with Headers and Footers].

 **Remarks:** 

Puede haber como máximo un [HeaderFooter](../../com.aspose.words/headerfooter/)

de cada [HeaderFooterType](../../com.aspose.words/headerfootertype/) por [Section](../../com.aspose.words/section/).
...
| [get(int index)](#get-int) | Recupera un [HeaderFooter](../../com.aspose.words/headerfooter/) en el índice dado. |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean) | Vincula o desvincula todos los encabezados y pies de página con los encabezados y pies de página correspondientes en la sección anterior. |
...
Recupera un [HeaderFooter](../../com.aspose.words/headerfooter/) en el índice dado.
...
Vincula o desvincula todos los encabezados y pies de página con los encabezados y pies de página correspondientes en la sección anterior.
...
Copia todos los  HeaderFooter  s de la colección a una nueva matriz de  HeaderFooter  s.
...
**Returns:**
com.aspose.words.HeaderFooter[] - Una matriz de  HeaderFooter  s.
