...
description: "Implementa el campo AUTONUMLGL en Java."
type: docs
weight: 202
url: /es/java/com.aspose.words/fieldautonumlgl/
---
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Obtiene si se debe mostrar el número sin un punto final. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Obtiene el carácter separador que se usará. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Establece si se debe mostrar el número sin un punto final. |
...
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Establece el carácter separador que se usará. |
...
Obtiene si se debe mostrar el número sin un punto final.
...
**Returns:**
boolean - Si se debe mostrar el número sin un punto final.
### getResult() {#getResult}
```
...
Obtiene el carácter separador que se usará.
...
**Returns:**
java.lang.String - El carácter separador que se usará.
### getStart() {#getStart}
```
...
Establece si se debe mostrar el número sin un punto final.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe mostrar el número sin un punto final. |
...
Establece el carácter separador que se usará.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El carácter separador que se usará. |
