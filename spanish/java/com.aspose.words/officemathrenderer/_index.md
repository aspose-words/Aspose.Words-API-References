...
description: "Proporciona métodos para renderizar un OfficeMath individual a una imagen raster o vectorial o a un objeto Graphics en Java."
type: docs
weight: 499
url: /es/java/com.aspose.words/officemathrenderer/
---
...
Proporciona métodos para renderizar un [OfficeMath](../../com.aspose.words/officemath/) individual a una imagen raster o vectorial o a un objeto Graphics.

Para obtener más información, visite el [ Working with OfficeMath ][Working with OfficeMath] artículo de documentación.
...
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | Inicializa una nueva instancia de esta clase. |
## Métodos
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | El [OfficeMath](../../com.aspose.words/officemath/) objeto que desea renderizar. |
