...
description: "Implementa el campo SEQ en Java."
type: docs
weight: 284
url: /es/java/com.aspose.words/fieldseq/
---
...
Numera secuencialmente capítulos, tablas, figuras y otras listas definidas por el usuario de elementos en un documento.
...
Muestra cómo crear numeración usando campos SEQ.
...
| Método | Descripción |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtiene un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual. |
...
| [getInsertNextNumber()](#getInsertNextNumber) | Obtiene si se debe insertar el siguiente número de secuencia para el elemento especificado. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getResetHeadingLevel()](#getResetHeadingLevel) | Obtiene un número entero que representa un nivel de encabezado al que restablecer el número de secuencia. |
| [getResetNumber()](#getResetNumber) | Obtiene un número entero al que restablecer el número de secuencia. |
...
| [getSequenceIdentifier()](#getSequenceIdentifier) | Obtiene el nombre asignado a la serie de elementos que deben numerarse. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Establece un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual. |
| [setInsertNextNumber(boolean value)](#setInsertNextNumber-boolean) | Establece si se debe insertar el siguiente número de secuencia para el elemento especificado. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setResetHeadingLevel(String value)](#setResetHeadingLevel-java.lang.String) | Establece un número entero que representa un nivel de encabezado al que restablecer el número de secuencia. |
| [setResetNumber(String value)](#setResetNumber-java.lang.String) | Establece un número entero al que restablecer el número de secuencia. |
...
| [setSequenceIdentifier(String value)](#setSequenceIdentifier-java.lang.String) | Establece el nombre asignado a la serie de elementos que deben numerarse. |
...
Obtiene un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual.
...
**Returns:**
java.lang.String - Un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual.
...
Obtiene si se debe insertar el siguiente número de secuencia para el elemento especificado.
...
**Returns:**
boolean - Si se debe insertar el siguiente número de secuencia para el elemento especificado.
...
Obtiene un número entero que representa un nivel de encabezado al que restablecer el número de secuencia. Devuelve -1 si el número está ausente.
...
**Returns:**
java.lang.String - Un número entero que representa un nivel de encabezado al que restablecer el número de secuencia.
...
Obtiene un número entero al que restablecer el número de secuencia. Devuelve -1 si el número está ausente.
...
**Returns:**
java.lang.String - Un número entero al que restablecer el número de secuencia.
### getResult() {#getResult}
```
...
Obtiene el nombre asignado a la serie de elementos que deben numerarse.
...
**Returns:**
java.lang.String - El nombre asignado a la serie de elementos que deben numerarse.
### getStart() {#getStart}
```
...
Establece un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un nombre de marcador que se refiere a un elemento en otro lugar del documento en lugar de en la ubicación actual. |
...
Establece si se debe insertar el siguiente número de secuencia para el elemento especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe insertar el siguiente número de secuencia para el elemento especificado. |
...
Establece un número entero que representa un nivel de encabezado al que restablecer el número de secuencia. Devuelve -1 si el número está ausente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un número entero que representa un nivel de encabezado al que restablecer el número de secuencia. |
...
Establece un número entero al que restablecer el número de secuencia. Devuelve -1 si el número está ausente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un número entero al que restablecer el número de secuencia. |
...
Establece el nombre asignado a la serie de elementos que deben numerarse.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre asignado a la serie de elementos que deben numerarse. |
