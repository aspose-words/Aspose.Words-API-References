...
description: "Representa todas las fuentes TrueType instaladas en el sistema en Java."
type: docs
weight: 651
url: /es/java/com.aspose.words/systemfontsource/
---
...
| [getSystemFontFolders()](#getSystemFontFolders) | Devuelve las carpetas de fuentes del sistema o una matriz vacía si las carpetas no son accesibles. |
...
En algunas plataformas Aspose.Words puede buscar fuentes del sistema no solo a través de carpetas sino también en otras fuentes. Por ejemplo, en la plataforma Windows Aspose.Words busca fuentes también en el registro.
