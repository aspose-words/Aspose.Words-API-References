...
description: "Proporciona datos para los métodos de la interfaz INodeChangingCallback en Java."
type: docs
weight: 478
url: /es/java/com.aspose.words/nodechangingargs/
---
...
Proporciona datos para los métodos de la interfaz [INodeChangingCallback](../../com.aspose.words/inodechangingcallback/).
...
| Método | Descripción |
| --- | --- |
| [getAction()](#getAction) | Obtiene un valor que indica qué tipo de evento de cambio de nodo está ocurriendo. |
| [getNewParent()](#getNewParent) | Obtiene el nodo padre que se establecerá después de que la operación se complete. |
| [getNode()](#getNode) | Obtiene el [getNode()](../../com.aspose.words/nodechangingargs/\#getNode) que está siendo añadido o eliminado. |
| [getOldParent()](#getOldParent) | Obtiene el nodo padre antes de que la operación comenzara. |
### getAction() {#getAction}
```
...
**Returns:**
int - Un valor que indica qué tipo de evento de cambio de nodo está ocurriendo. El valor devuelto es una de las constantes de [NodeChangingAction](../../com.aspose.words/nodechangingaction/).
...
Obtiene el nodo padre que se establecerá después de que la operación se complete.
...
Obtiene el [getNode()](../../com.aspose.words/nodechangingargs/\#getNode) que está siendo añadido o eliminado.
...
Obtiene el nodo padre antes de que la operación comenzara.
