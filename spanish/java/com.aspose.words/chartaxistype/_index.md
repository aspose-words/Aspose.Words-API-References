...
description: "Especifica el tipo de eje del gráfico en Java."
type: docs
weight: 70
url: /es/java/com.aspose.words/chartaxistype/
---
...
Especifica el tipo de eje del gráfico.
...
| Campo | Descripción |
| --- | --- |
| [CATEGORY](#CATEGORY) | Eje de categoría de un gráfico. |
| [SERIES](#SERIES) | Eje de series de un gráfico. |
| [VALUE](#VALUE) | Eje de valores de un gráfico. |
| [length](#length) |  |
## Métodos
...
Eje de categoría de un gráfico.
