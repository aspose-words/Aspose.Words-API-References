...
description: "Implementa el campo MERGESEQ en Java."
type: docs
weight: 260
url: /es/java/com.aspose.words/fieldmergeseq/
---

**Inheritance:**
java.lang.Object, [com.aspose.words.Field](../../com.aspose.words/field/)
```
public class FieldMergeSeq extends Field
```

Implementa el campo MERGESEQ.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

En este momento los campos MERGEREC y MERGESEQ implementan la misma funcionalidad porque no sabemos con certeza cómo omitir registros en la combinación de correspondencia de Aspose.Words.
