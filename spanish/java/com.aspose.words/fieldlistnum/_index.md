...
description: "Implementa el campo LISTNUM en Java."
type: docs
weight: 255
url: /es/java/com.aspose.words/fieldlistnum/
---
...
| [getListLevel()](#getListLevel) | Obtiene el nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo. |
| [getListName()](#getListName) | Obtiene el nombre de la definición de numeración abstracta utilizada para la numeración. |
...
| [getStartingNumber()](#getStartingNumber) | Obtiene el valor inicial para este campo. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Obtiene el tipo de campo de Microsoft Word. |
| [hasListName()](#hasListName) | Devuelve un valor que indica si el nombre de una definición de numeración abstracta es proporcionado por el código del campo. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | Establece el nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo. |
| [setListName(String value)](#setListName-java.lang.String) | Establece el nombre de la definición de numeración abstracta utilizada para la numeración. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | Establece el valor inicial para este campo. |
...
Obtiene el nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo.
...
**Returns:**
java.lang.String - El nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo.
...
Obtiene el nombre de la definición de numeración abstracta utilizada para la numeración.
...
**Returns:**
java.lang.String - El nombre de la definición de numeración abstracta utilizada para la numeración.
...
Obtiene el valor inicial para este campo.
...
**Returns:**
java.lang.String - El valor inicial para este campo.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
**Returns:**
boolean - Un valor que indica si el nombre de una definición de numeración abstracta es proporcionado por el código del campo.
### isDirty() {#isDirty}
```
...
Establece el nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nivel en la lista, sobrescribiendo el comportamiento predeterminado del campo. |
...
Establece el nombre de la definición de numeración abstracta utilizada para la numeración.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de la definición de numeración abstracta utilizada para la numeración. |
...
Establece el valor inicial para este campo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El valor inicial para este campo. |
