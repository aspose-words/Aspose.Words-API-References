...
description: "El control OptionButton permite una única elección en un conjunto limitado de opciones mutuamente excluyentes en Java."
type: docs
weight: 506
url: /es/java/com.aspose.words/optionbuttoncontrol/
---
...
El control OptionButton permite una única selección en un conjunto limitado de opciones mutuamente excluyentes.
...
| [getSelected()](#getSelected) | Obtiene un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no. |
...
| [setSelected(boolean value)](#setSelected-boolean) | Establece un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no. |
...
Obtiene un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no.

 **Remarks:** 

Nota, esta propiedad le permite seleccionar varios elementos en un grupo de [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) con el mismo [Forms2OleControl.getGroupName()](../../com.aspose.words/forms2olecontrol/\#getGroupName) / [Forms2OleControl.setGroupName(java.lang.String)](../../com.aspose.words/forms2olecontrol/\#setGroupName-java.lang.String). Depende de usted deseleccionar un elemento previamente seleccionado cuando haga que este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) esté seleccionado.
...
**Returns:**
boolean - Un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no.
### getType() {#getType}
```
public int getType()
```
...
Establece un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | boolean | Un valor booleano que indica si este [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) está seleccionado o no. |
