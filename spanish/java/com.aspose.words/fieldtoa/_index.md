...
description: "Implementa el campo TOA en Java."
type: docs
weight: 297
url: /es/java/com.aspose.words/fieldtoa/
---
...
Construye una tabla de autoridades (es decir, una lista de las referencias en un documento legal, como referencias a casos, estatutos y normas, junto con los números de página en los que aparecen las referencias) utilizando las entradas especificadas por los campos TA.

 **Examples:** 

Muestra cómo crear y personalizar una tabla de autoridades usando los campos TOA y TA.
...
| [getEntryCategory()](#getEntryCategory) | Obtiene la categoría integral para las entradas incluidas en la tabla. |
| [getEntrySeparator()](#getEntrySeparator) | Obtiene la secuencia de caracteres que se usa para separar una entrada de tabla de autoridades y su número de página. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Obtiene si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades. |
...
| [getUseHeading()](#getUseHeading) | Obtiene si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades. |
| [getUsePassim()](#getUsePassim) | Obtiene si se debe reemplazar cinco o más referencias de página diferentes a la misma autoridad con \"passim\", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Establece la categoría integral para las entradas incluidas en la tabla. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Establece la secuencia de caracteres que se usa para separar una entrada de tabla de autoridades y su número de página. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Establece si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Establece si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Establece si se debe reemplazar cinco o más referencias de página diferentes a la misma autoridad con \"passim\", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada. |
...
Obtiene la categoría integral para las entradas incluidas en la tabla.
...
**Returns:**
java.lang.String - La categoría integral para las entradas incluidas en la tabla.
...
Obtiene la secuencia de caracteres que se usa para separar una entrada de tabla de autoridades y su número de página.
...
**Returns:**
java.lang.String - La secuencia de caracteres que se usa para separar una entrada de tabla de autoridades y su número de página.
...
Obtiene si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades.
...
**Returns:**
boolean - Indica si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades.
### getResult() {#getResult}
```
...
Obtiene si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades.
...
**Returns:**
boolean - Indica si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades.
...
Obtiene si se debe reemplazar cinco o más referencias de página diferentes a la misma autoridad con \"passim\", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada.
...
**Returns:**
boolean - Indica si se deben reemplazar cinco o más referencias de página diferentes a la misma autoridad con "passim", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada.
### isDirty() {#isDirty}
```
...
Establece la categoría integral para las entradas incluidas en la tabla.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La categoría integral para las entradas incluidas en la tabla. |
...
Establece la secuencia de caracteres que se usa para separar una entrada de tabla de autoridades y su número de página.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La secuencia de caracteres que se usa para separar una entrada de la tabla de autoridades y su número de página. |
...
Establece si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe eliminar el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades. |
...
Establece si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe incluir el encabezado de categoría para las entradas en una tabla de autoridades. |
...
Establece si se debe reemplazar cinco o más referencias de página diferentes a la misma autoridad con \"passim\", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se deben reemplazar cinco o más referencias de página diferentes a la misma autoridad con "passim", que se usa para indicar que una palabra o pasaje ocurre frecuentemente en la obra citada. |
