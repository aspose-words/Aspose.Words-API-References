...
description: "Determina cuándo se reinicia la numeración automática de notas al pie o notas finales en Java."
type: docs
weight: 340
url: /es/java/com.aspose.words/footnotenumberingrule/
---
...
| Campo | Descripción |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | Numeración continua a lo largo del documento. |
| [DEFAULT](#DEFAULT) | Equivale a [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS). |
| [RESTART_PAGE](#RESTART-PAGE) | La numeración se reinicia en cada página. |
| [RESTART_SECTION](#RESTART-SECTION) | La numeración se reinicia en cada sección. |
| [length](#length) |  |
## Métodos
...
Numeración continua a lo largo del documento.
...
Equivale a [CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS).
...
La numeración se reinicia en cada página. Válido solo para notas al pie.
...
La numeración se reinicia en cada sección.
