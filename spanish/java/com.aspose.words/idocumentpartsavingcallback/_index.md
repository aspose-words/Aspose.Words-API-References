...
description: "Implemente esta interfaz si desea recibir notificaciones y controlar cómo Aspose.Words guarda las partes del documento al exportar un documento al formato SaveFormat.HTML o SaveFormat.EPUB en Java."
type: docs
weight: 760
url: /es/java/com.aspose.words/idocumentpartsavingcallback/
---
```
public interface IDocumentPartSavingCallback
```

Implemente esta interfaz si desea recibir notificaciones y controlar cómo Aspose.Words guarda las partes del documento al exportar un documento al formato [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) o [SaveFormat.EPUB](../../com.aspose.words/saveformat/\#EPUB).
...
| Método | Descripción |
| --- | --- |
| [documentPartSaving(DocumentPartSavingArgs args)](#documentPartSaving-com.aspose.words.DocumentPartSavingArgs) | Se llama cuando Aspose.Words está a punto de guardar una parte del documento. |
