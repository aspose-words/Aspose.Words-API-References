...
description: "Proporciona acceso tipado a una colección de nodos Row en Java."
type: docs
weight: 589
url: /es/java/com.aspose.words/rowcollection/
---
...
Proporciona acceso tipado a una colección de nodos [Row](../../com.aspose.words/row/).
...
| [get(int index)](#get-int) | Recupera un [Row](../../com.aspose.words/row/) en el índice dado. |
...
Recupera un [Row](../../com.aspose.words/row/) en el índice dado.
...
Copia todas las filas de la colección a una nueva matriz de filas.
...
**Returns:**
com.aspose.words.Node[] - Una matriz de filas.
