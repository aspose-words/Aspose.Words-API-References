...
description: "Implementa el campo USERADDRESS en Java."
type: docs
weight: 303
url: /es/java/com.aspose.words/fielduseraddress/
---
...
Obtiene la dirección postal del usuario actual.
...
| [getUserAddress()](#getUserAddress) | Obtiene la dirección postal del usuario actual. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | Establece la dirección postal del usuario actual. |
...
**Returns:**
java.lang.String - La dirección postal del usuario actual.
### isDirty() {#isDirty}
```
...
Establece la dirección postal del usuario actual.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La dirección postal del usuario actual. |
