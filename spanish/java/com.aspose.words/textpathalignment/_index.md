...
description: "Alineación de WordArt en Java."
type: docs
weight: 677
url: /es/java/com.aspose.words/textpathalignment/
---
...
| Campo | Descripción |
| --- | --- |
| [CENTER](#CENTER) | Centrar el texto en el ancho. |
| [LEFT](#LEFT) | Justificar a la izquierda. |
| [LETTER_JUSTIFY](#LETTER-JUSTIFY) | Separar las letras para ajustarlas al ancho. |
| [RIGHT](#RIGHT) | Justificar a la derecha. |
| [STRETCH](#STRETCH) | Estirar cada línea de texto para ajustarla al ancho. |
| [WORD_JUSTIFY](#WORD-JUSTIFY) | Separar las palabras para ajustarlas al ancho. |
| [length](#length) |  |
## Métodos
...
Separar las letras para ajustarlas al ancho.
...
Estirar cada línea de texto para ajustarla al ancho.
...
Separar las palabras para ajustarlas al ancho.
