...
description: "Permite especificar opciones adicionales al cargar un documento Pdf en un objeto Document en Java."
type: docs
weight: 538
url: /es/java/com.aspose.words/pdfloadoptions/
---
...
Permite especificar opciones adicionales al cargar un documento Pdf en un objeto [Document](../../com.aspose.words/document/).

Para obtener más información, visite el artículo de documentación [ Specify Load Options ][Specify Load Options].

 **Examples:** 

Muestra cómo omitir imágenes al cargar archivos PDF.
...
| [getPageCount()](#getPageCount) | Obtiene el número de páginas a leer. |
| [getPageIndex()](#getPageIndex) | Obtiene el índice basado en 0 de la primera página a leer. |
...
| [getSkipPdfImages()](#getSkipPdfImages) | Obtiene la bandera que indica si se deben omitir imágenes al cargar el documento PDF. |
...
| [setPageCount(int value)](#setPageCount-int) | Establece el número de páginas a leer. |
| [setPageIndex(int value)](#setPageIndex-int) | Establece el índice basado en 0 de la primera página a leer. |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean) | Establece la bandera que indica si se deben omitir imágenes al cargar el documento PDF. |
...
Obtiene el número de páginas a leer. El valor predeterminado es MaxValue, lo que significa que se leerán todas las páginas del documento.
...
**Returns:**
int - El número de páginas a leer.
...
Obtiene el índice basado en 0 de la primera página a leer. El valor predeterminado es 0.
...
**Returns:**
int - El índice basado en 0 de la primera página a leer.
...
Obtiene la bandera que indica si se deben omitir imágenes al cargar el documento PDF. El valor predeterminado es false.
...
**Returns:**
boolean - La bandera que indica si se deben omitir imágenes al cargar el documento PDF.
...
Establece el número de páginas a leer. El valor predeterminado es MaxValue, lo que significa que se leerán todas las páginas del documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | El número de páginas a leer. |
...
Establece el índice basado en 0 de la primera página a leer. El valor predeterminado es 0.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | int | El índice basado en 0 de la primera página a leer. |
...
Establece la bandera que indica si se deben omitir las imágenes al cargar el documento PDF. El valor predeterminado es `false`.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | La bandera que indica si se deben omitir las imágenes al cargar el documento PDF. |
