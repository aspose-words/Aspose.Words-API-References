...
description: "Representa el formato de un elemento de gráfico en Java."
type: docs
weight: 78
url: /es/java/com.aspose.words/chartformat/
---
...
| [getEndCap()](#getEndCap) |  |
| [getFill()](#getFill) | Obtiene el formato de relleno del elemento de gráfico padre. |
...
| [getShapeType()](#getShapeType) | Obtiene el tipo de forma del elemento de gráfico padre. |
| [getStartArrowLength()](#getStartArrowLength) |  |
| [getStartArrowType()](#getStartArrowType) |  |
| [getStartArrowWidth()](#getStartArrowWidth) |  |
| [getStroke()](#getStroke) | Obtiene el formato de línea del elemento de gráfico padre. |
...
| [getWeight()](#getWeight) |  |
| [isDefined()](#isDefined) | Obtiene una bandera que indica si se ha definido algún formato. |
...
| [setDefaultFill()](#setDefaultFill) | Restablece el relleno del elemento de gráfico para que tenga el valor predeterminado. |
...
| [setShapeType(int value)](#setShapeType-int) | Establece el tipo de forma del elemento de gráfico padre. |
...
Obtiene el formato de relleno del elemento de gráfico padre.
...
Obtiene el tipo de forma del elemento de gráfico padre.

 **Remarks:** 

Actualmente, la propiedad solo puede usarse para etiquetas de datos.
...
**Returns:**
int - El tipo de forma del elemento de gráfico padre. El valor devuelto es una de las constantes de [ChartShapeType](../../com.aspose.words/chartshapetype/).
### getStartArrowLength() {#getStartArrowLength}
```
...
Obtiene el formato de línea del elemento de gráfico padre.
...
**Returns:**
boolean - Una bandera que indica si se ha definido algún formato.
### oneColorGradient(int style, int variant, double degree) {#oneColorGradient-int-int-double}
```
...
Restablece el relleno del elemento de gráfico para que tenga el valor predeterminado.
...
Establece el tipo de forma del elemento de gráfico padre.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El tipo de forma del elemento de gráfico principal. El valor debe ser uno de los constantes [ChartShapeType](../../com.aspose.words/chartshapetype/). |
