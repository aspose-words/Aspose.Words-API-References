...
description: "Proporciona acceso a las propiedades de la forma del gráfico en Java."
type: docs
weight: 66
url: /es/java/com.aspose.words/chart/
---
...
| Método | Descripción |
| --- | --- |
| [getAxes()](#getAxes) | Obtiene una colección de todos los ejes de este gráfico. |
| [getAxisX()](#getAxisX) | Proporciona acceso a las propiedades del eje X principal del gráfico. |
| [getAxisY()](#getAxisY) | Proporciona acceso a las propiedades del eje Y principal del gráfico. |
| [getAxisZ()](#getAxisZ) | Proporciona acceso a las propiedades del eje Z del gráfico. |
| [getDataTable()](#getDataTable) | Proporciona acceso a las propiedades de una tabla de datos de este gráfico. |
| [getFormat()](#getFormat) | Proporciona acceso al formato de relleno y línea del gráfico. |
| [getLegend()](#getLegend) | Proporciona acceso a las propiedades de la leyenda del gráfico. |
| [getSeries()](#getSeries) | Proporciona acceso a la colección de series. |
| [getSeriesGroups()](#getSeriesGroups) | Proporciona acceso a una colección de grupos de series de este gráfico. |
| [getShapeType()](#getShapeType) |  |
| [getSourceFullName()](#getSourceFullName) | Obtiene la ruta y el nombre de un archivo xls/xlsx al que está vinculado este gráfico. |
| [getStyle()](#getStyle) | Obtiene el estilo del gráfico. |
| [getTitle()](#getTitle) | Proporciona acceso a las propiedades del título del gráfico. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Obtiene la ruta y el nombre de un archivo xls/xlsx al que está vinculado este gráfico. |
| [setStyle(int value)](#setStyle-int) | Establece el estilo del gráfico. |
### getAxes() {#getAxes}
```
...
Proporciona acceso a las propiedades del eje X principal del gráfico.
...
Proporciona acceso a las propiedades de una tabla de datos de este gráfico. La tabla de datos puede mostrarse usando la propiedad [ChartDataTable.getShow()](../../com.aspose.words/chartdatatable/\#getShow) / [ChartDataTable.setShow(boolean)](../../com.aspose.words/chartdatatable/\#setShow-boolean).
...
Proporciona acceso al formato de relleno y línea del gráfico.
...
Proporciona acceso a la colección de series.
...
Muestra cómo obtener/establecer el nombre completo del documento externo xls/xlsx si el gráfico está vinculado.
...
**Returns:**
java.lang.String - La ruta y el nombre de un archivo xls/xlsx al que está vinculado este gráfico.
### getStyle() {#getStyle}
```
public int getStyle()
```
...
Obtiene el estilo del gráfico.

**Returns:**
int - El estilo del gráfico. El valor devuelto es una de las constantes [ChartStyle](../../com.aspose.words/chartstyle/).
### getTitle() {#getTitle}
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La ruta y el nombre de un archivo xls/xlsx al que está vinculado este gráfico. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El estilo del gráfico. El valor debe ser una de las constantes [ChartStyle](../../com.aspose.words/chartstyle/). |
