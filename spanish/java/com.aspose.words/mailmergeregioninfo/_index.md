...
description: "Contiene información sobre una región de combinación de correspondencia en Java."
type: docs
weight: 444
url: /es/java/com.aspose.words/mailmergeregioninfo/
---
...
| Método | Descripción |
| --- | --- |
| [getEndField()](#getEndField) | Devuelve un campo de fin para la región. |
| [getEndMustacheTag()](#getEndMustacheTag) | Devuelve una etiqueta "mustache" de fin para la región. |
| [getFields()](#getFields) | Devuelve una lista de campos hijos. |
| [getLevel()](#getLevel) | Devuelve el nivel de anidamiento de la región. |
| [getMustacheTags()](#getMustacheTags) | Devuelve una lista de etiquetas "mustache" hijas. |
| [getName()](#getName) | Devuelve el nombre de la región. |
| [getParentRegion()](#getParentRegion) | Devuelve la información de la región padre (null para la región de nivel superior). |
| [getRegions()](#getRegions) | Devuelve una lista de regiones hijas. |
| [getStartField()](#getStartField) | Devuelve un campo de inicio para la región. |
| [getStartMustacheTag()](#getStartMustacheTag) | Devuelve una etiqueta "mustache" de inicio para la región. |
...
Devuelve un campo de fin para la región.
...
Devuelve una etiqueta "mustache" de fin para la región.
...
Devuelve una lista de campos hijos.
...
**Returns:**
java.util.ArrayList - Una lista de campos hijos.
### getLevel() {#getLevel}
```
public int getLevel()
```
...
**Returns:**
int - El nivel de anidamiento de la región.
...
Devuelve una lista de etiquetas "mustache" hijas.

**Returns:**
java.util.ArrayList - Una lista de etiquetas "mustache" hijas.
### getName() {#getName}
```
...
**Returns:**
java.lang.String - El nombre de la región.
...
Devuelve la información de la región padre (null para la región de nivel superior).

 **Examples:** 

Muestra cómo crear, listar y leer regiones de combinación de correspondencia.
...
Devuelve una lista de regiones hijas.
...
**Returns:**
java.util.ArrayList - Una lista de regiones hijas.
...
Devuelve una etiqueta "mustache" de inicio para la región.
