...
description: "Implementa el campo MACROBUTTON en Java."
type: docs
weight: 256
url: /es/java/com.aspose.words/fieldmacrobutton/
---
...
Permite ejecutar una macro o comando.

En Aspose.Words este campo también puede actuar como un campo de combinación.

 **Examples:** 

Muestra cómo usar campos MACROBUTTON para permitir ejecutar las macros de un documento al hacer clic.
...
| [getDisplayText()](#getDisplayText) | Obtiene el texto que aparecerá como el \"botón\" que se selecciona para ejecutar la macro o el comando. |
...
| [getMacroName()](#getMacroName) | Obtiene el nombre de la macro o comando a ejecutar. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Establece el texto que aparecerá como el \"botón\" que se selecciona para ejecutar la macro o el comando. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Establece el nombre de la macro o comando a ejecutar. |
...
Obtiene el texto que aparecerá como el \"botón\" que se selecciona para ejecutar la macro o el comando.
...
**Returns:**
java.lang.String - El texto que aparecerá como el \"botón\" que se selecciona para ejecutar la macro o el comando.
### getEnd() {#getEnd}
```
...
Obtiene el nombre de la macro o comando a ejecutar.
...
**Returns:**
java.lang.String - El nombre de la macro o comando a ejecutar.
### getMergeFieldName() {#getMergeFieldName}
```
...
Establece el texto que aparecerá como el \"botón\" que se selecciona para ejecutar la macro o el comando.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto que aparecerá como el "botón" que se selecciona para ejecutar la macro o comando. |
...
Establece el nombre de la macro o comando a ejecutar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de la macro o comando a ejecutar. |
