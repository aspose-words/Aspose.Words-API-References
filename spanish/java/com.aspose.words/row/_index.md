...
description: "Representa una fila de tabla en Java."
type: docs
weight: 588
url: /es/java/com.aspose.words/row/
---
...
Una fila mínima válida necesita tener al menos una [Cell](../../com.aspose.words/cell/).
...
Muestra cómo iterar a través de todas las tablas en el documento e imprimir el contenido de cada celda.
...
Muestra cómo crear una tabla anidada sin usar un generador de documentos.
...
| --- | --- |
| [Row(DocumentBase doc)](#Row-com.aspose.words.DocumentBase) | Inicializa una nueva instancia de la clase [Row](../../com.aspose.words/row/). |
## Métodos

| Método | Descripción |
| --- | --- |
| [accept(DocumentVisitor visitor)](#accept-com.aspose.words.DocumentVisitor) | Acepta un visitante. |
| [acceptEnd(DocumentVisitor visitor)](#acceptEnd-com.aspose.words.DocumentVisitor) | Acepta un visitante para visitar el final de la fila. |
| [acceptStart(DocumentVisitor visitor)](#acceptStart-com.aspose.words.DocumentVisitor) | Acepta un visitante para visitar el inicio de la fila. |
...
| [ensureMinimum()](#ensureMinimum) | Si la [Row](../../com.aspose.words/row/) no tiene celdas, crea y agrega una [Cell](../../com.aspose.words/cell/). |
...
| [getCells()](#getCells) | Proporciona acceso tipado a los nodos hijos [Cell](../../com.aspose.words/cell/) de la fila. |
...
| [getFirstCell()](#getFirstCell) | Devuelve la primera [Cell](../../com.aspose.words/cell/) en la fila. |
| [getFirstChild()](#getFirstChild) | Obtiene el primer hijo del nodo. |
| [getHidden()](#getHidden) | Obtiene una bandera que indica si esta fila está oculta o no. |
| [getLastCell()](#getLastCell) | Devuelve la última [Cell](../../com.aspose.words/cell/) en la fila. |
| [getLastChild()](#getLastChild) | Obtiene el último hijo del nodo. |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node) |  |
| [getNextRow()](#getNextRow) | Obtiene el siguiente nodo [Row](../../com.aspose.words/row/). |
| [getNextSibling()](#getNextSibling) | Obtiene el nodo que sigue inmediatamente a este nodo. |
| [getNodeType()](#getNodeType) | Devuelve [NodeType.ROW](../../com.aspose.words/nodetype/\#ROW). |
| [getParentNode()](#getParentNode) | Obtiene el padre inmediato de este nodo. |
| [getParentTable()](#getParentTable) | Devuelve la tabla padre inmediata de la fila. |
| [getPreviousRow()](#getPreviousRow) | Obtiene el nodo [Row](../../com.aspose.words/row/) anterior. |
...
| [getRowFormat()](#getRowFormat) | Proporciona acceso a las propiedades de formato de la fila. |
| [getText()](#getText) | Obtiene el texto de todas las celdas en esta fila, incluido el carácter de fin de fila. |
...
| [isFirstRow()](#isFirstRow) | True si esta es la primera fila en una tabla; false en caso contrario. |
| [isLastRow()](#isLastRow) | True si esta es la última fila en una tabla; false en caso contrario. |
...
| [setHidden(boolean value)](#setHidden-boolean) | Establece una bandera que indica si esta fila está oculta o no. |
...
Inicializa una nueva instancia de la clase [Row](../../com.aspose.words/row/).

 **Remarks:** 

Cuando se crea [Row](../../com.aspose.words/row/), pertenece al documento especificado, pero aún no forma parte del documento y [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) es null.

Para añadir [Row](../../com.aspose.words/row/) al documento, use [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertAfter-com.aspose.words.Node--com.aspose.words.Node) o [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertBefore-com.aspose.words.Node--com.aspose.words.Node) en la tabla donde desea insertar la fila.
...
Llama a [DocumentVisitor.visitRowStart(com.aspose.words.Row)](../../com.aspose.words/documentvisitor/\#visitRowStart-com.aspose.words.Row), luego llama a [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/\#accept-com.aspose.words.DocumentVisitor) para todos los nodos secundarios de la sección y llama a [DocumentVisitor.visitRowEnd(com.aspose.words.Row)](../../com.aspose.words/documentvisitor/\#visitRowEnd-com.aspose.words.Row) al final.
...
Acepta un visitante para visitar el final de la fila.
...
Acepta un visitante para visitar el inicio de la fila.
...
Si la [Row](../../com.aspose.words/row/) no tiene celdas, crea y agrega una [Cell](../../com.aspose.words/cell/).

 **Examples:** 

Muestra cómo garantizar que un nodo de fila contenga los nodos que necesitamos para comenzar a agregar contenido a él.
...
Proporciona acceso tipado a los nodos hijos [Cell](../../com.aspose.words/cell/) de la fila.
...
Devuelve la primera [Cell](../../com.aspose.words/cell/) en la fila.
...
Obtiene una bandera que indica si esta fila está oculta o no.

 **Remarks:** 

La fila oculta no es compatible con documentos WordML y ODT.
...
**Returns:**
boolean - Un indicador que indica si esta fila está oculta o no.
...
Devuelve la última [Cell](../../com.aspose.words/cell/) en la fila.
...
Obtiene el siguiente nodo [Row](../../com.aspose.words/row/).

 **Remarks:** 

El método puede usarse cuando necesita tener acceso tipado a filas de tabla. Si se encuentra un nodo [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) en una tabla en lugar de una fila, se recorre automáticamente para obtener la fila contenida.

 **Examples:** 

Muestra cómo enumerar todas las celdas de tabla.
...
Devuelve [NodeType.ROW](../../com.aspose.words/nodetype/\#ROW).
...
**Returns:**
int - [NodeType.ROW](../../com.aspose.words/nodetype/\#ROW). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
...
Devuelve la tabla padre inmediata de la fila.
...
Obtiene el nodo [Row](../../com.aspose.words/row/) anterior.
...
Obtiene el texto de todas las celdas en esta fila, incluido el carácter de fin de fila.

 **Remarks:** 

Devuelve el texto concatenado de todos los nodos hijos con el carácter de fin de fila [ControlChar.CELL](../../com.aspose.words/controlchar/\#CELL) añadido al final.
...
True si esta es la primera fila en una tabla; false en caso contrario.
...
True si esta es la última fila en una tabla; false en caso contrario.
...
Establece una bandera que indica si esta fila está oculta o no.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Una bandera que indica si esta fila está oculta o no. |
