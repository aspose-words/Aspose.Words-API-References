...
description: "Implementa el campo RD en Java."
type: docs
weight: 277
url: /es/java/com.aspose.words/fieldrd/
---
...
Identifica un archivo para incluir al crear una tabla de contenido, una tabla de autoridades o un índice con los campos TOC, TOA o INDEX.
...
| [getFileName()](#getFileName) | Obtiene el nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice. |
...
| [isPathRelative()](#isPathRelative) | Obtiene si la ruta es relativa al documento actual. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Establece si la ruta es relativa al documento actual. |
| [remove()](#remove) | Elimina el campo del documento. |
| [setFileName(String value)](#setFileName-java.lang.String) | Establece el nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice. |
...
Obtiene el nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice.
...
**Returns:**
java.lang.String - El nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice.
### getFormat() {#getFormat}
```
...
Obtiene si la ruta es relativa al documento actual.
...
**Returns:**
boolean - Si la ruta es relativa al documento actual.
...
Establece si la ruta es relativa al documento actual.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si la ruta es relativa al documento actual. |
...
Establece el nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre del archivo para incluir al generar una tabla de contenido, una tabla de autoridades o un índice. |
