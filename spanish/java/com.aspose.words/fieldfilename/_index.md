...
description: "Implementa el campo FILENAME en Java."
type: docs
weight: 230
url: /es/java/com.aspose.words/fieldfilename/
---
...
Recupera el nombre del documento actual desde su ubicación de almacenamiento.

En la implementación actual, utiliza la propiedad [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) para recuperar el nombre del archivo. Si el documento se cargó desde un flujo o se creó en blanco, utiliza el nombre del archivo al que se está guardando (si se conoce).
...
| [getIncludeFullPath()](#getIncludeFullPath) | Obtiene si se debe incluir la ruta completa del archivo. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Establece si se debe incluir la ruta completa del archivo. |
...
Obtiene si se debe incluir la ruta completa del archivo.
...
**Returns:**
boolean - Si se debe incluir la ruta completa del archivo.
...
Establece si se debe incluir la ruta completa del archivo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe incluir la ruta completa del archivo. |
