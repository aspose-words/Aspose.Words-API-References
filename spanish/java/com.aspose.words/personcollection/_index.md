...
description: "Representa una lista de personas que son colaboradores de fuentes bibliográficas en Java."
type: docs
weight: 546
url: /es/java/com.aspose.words/personcollection/
---
...
Representa una lista de personas que son contribuyentes de la fuente bibliográfica.
...
| --- | --- |
| [PersonCollection()](#PersonCollection) | Inicializa una nueva instancia de la clase [PersonCollection](../../com.aspose.words/personcollection/). |
| [PersonCollection(Iterable persons)](#PersonCollection-java.lang.Iterable) | Inicializa una nueva instancia de esta clase. |
| [PersonCollection(Person[] persons)](#PersonCollection-com.aspose.words.Person...) | Inicializa una nueva instancia de la clase [PersonCollection](../../com.aspose.words/personcollection/). |
## Métodos

| Método | Descripción |
| --- | --- |
| [add(Person person)](#add-com.aspose.words.Person) | Añade un [Person](../../com.aspose.words/person/) a la colección. |
| [clear()](#clear) | Elimina todos los elementos de la colección. |
| [contains(Person person)](#contains-com.aspose.words.Person) | Determina si la colección contiene una persona específica. |
| [get(int index)](#get-int) | Obtiene una persona en el índice especificado. |
| [getCount()](#getCount) | Obtiene el número de personas contenidas en la colección. |
| [iterator()](#iterator) |  |
| [remove(Person person)](#remove-com.aspose.words.Person) | Elimina la persona de la colección. |
| [removeAt(int index)](#removeAt-int) | Elimina la persona en el índice especificado. |
| [set(int index, Person value)](#set-int-com.aspose.words.Person) | Establece una persona en el índice especificado. |
...
Inicializa una nueva instancia de la clase [PersonCollection](../../com.aspose.words/personcollection/).
...
Añade un [Person](../../com.aspose.words/person/) a la colección.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | La persona a añadir a la colección. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | La persona a localizar en la colección. |
...
Obtiene una persona en el índice especificado.
...
Obtiene el número de personas contenidas en la colección.
...
**Returns:**
int - El número de personas contenidas en la colección.
### iterator() {#iterator}
```
...
Elimina la persona de la colección.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | La persona a eliminar de la colección. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | El índice basado en cero de la persona a eliminar. |
...
Establece una persona en el índice especificado.
...
| --- | --- | --- |
| índice | int | Un índice en la colección. |
| value | [Person](../../com.aspose.words/person/) | Una persona en el índice especificado. |
