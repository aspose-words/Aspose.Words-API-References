...
description: "Implementa el campo INDEX en Java."
type: docs
weight: 249
url: /es/java/com.aspose.words/fieldindex/
---
...
Construye un índice usando las entradas de índice especificadas por los campos XE y inserta ese índice en este lugar del documento.

 **Examples:** 

Muestra cómo crear un campo INDEX y luego usar campos XE para completarlo con entradas.
...
Muestra cómo rellenar un campo INDEX con entradas usando campos XE y también modificar su apariencia.
...
| Método | Descripción |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtiene el nombre del marcador que indica la porción del documento utilizada para crear el índice. |
| [getCrossReferenceSeparator()](#getCrossReferenceSeparator) | Obtiene la secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas. |
...
| [getEntryType()](#getEntryType) | Obtiene un tipo de entrada de índice utilizado para crear el índice. |
...
| [getHeading()](#getHeading) | Obtiene un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra. |
| [getLanguageId()](#getLanguageId) | Obtiene el ID de idioma utilizado para generar el índice. |
| [getLetterRange()](#getLetterRange) | Obtiene un rango de letras al que limitar el índice. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getNumberOfColumns()](#getNumberOfColumns) | Obtiene el número de columnas por página utilizado al crear el índice. |
| [getPageNumberListSeparator()](#getPageNumberListSeparator) | Obtiene la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página. |
| [getPageNumberSeparator()](#getPageNumberSeparator) | Obtiene la secuencia de caracteres que se usa para separar una entrada de índice y su número de página. |
| [getPageRangeSeparator()](#getPageRangeSeparator) | Obtiene la secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas. |
| [getResult()](#getResult) | Obtiene el texto que está entre el separador del campo y el final del campo. |
| [getRunSubentriesOnSameLine()](#getRunSubentriesOnSameLine) | Obtiene si se ejecutan subentradas en la misma línea que la entrada principal. |
| [getSeparator()](#getSeparator) | Obtiene el nodo que representa el separador de campo. |
| [getSequenceName()](#getSequenceName) | Obtiene el nombre de una secuencia cuyo número se incluye con el número de página. |
...
| [getUseYomi()](#getUseYomi) | Obtiene si se habilita el uso de texto yomi para las entradas de índice. |
| [hasPageNumberSeparator()](#hasPageNumberSeparator) | Obtiene un valor que indica si el separador de número de página se sobrescribe mediante el código del campo. |
| [hasSequenceName()](#hasSequenceName) | Obtiene un valor que indica si se debe usar una secuencia mientras se construye el resultado del campo. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Establece el nombre del marcador que indica la parte del documento utilizada para crear el índice. |
| [setCrossReferenceSeparator(String value)](#setCrossReferenceSeparator-java.lang.String) | Establece la secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas. |
| [setEntryType(String value)](#setEntryType-java.lang.String) | Establece un tipo de entrada de índice utilizado para crear el índice. |
| [setHeading(String value)](#setHeading-java.lang.String) | Establece un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Establece el ID de idioma utilizado para generar el índice. |
| [setLetterRange(String value)](#setLetterRange-java.lang.String) | Establece un rango de letras al que limitar el índice. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setNumberOfColumns(String value)](#setNumberOfColumns-java.lang.String) | Establece el número de columnas por página utilizado al crear el índice. |
| [setPageNumberListSeparator(String value)](#setPageNumberListSeparator-java.lang.String) | Establece la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página. |
| [setPageNumberSeparator(String value)](#setPageNumberSeparator-java.lang.String) | Establece la secuencia de caracteres que se usa para separar una entrada de índice y su número de página. |
| [setPageRangeSeparator(String value)](#setPageRangeSeparator-java.lang.String) | Establece la secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas. |
...
| [setRunSubentriesOnSameLine(boolean value)](#setRunSubentriesOnSameLine-boolean) | Establece si se ejecutan subentradas en la misma línea que la entrada principal. |
| [setSequenceName(String value)](#setSequenceName-java.lang.String) | Establece el nombre de una secuencia cuyo número se incluye con el número de página. |
...
| [setUseYomi(boolean value)](#setUseYomi-boolean) | Establece si se habilita el uso de texto yomi para las entradas de índice. |
...
Obtiene el nombre del marcador que indica la porción del documento utilizada para crear el índice.
...
**Returns:**
java.lang.String - El nombre del marcador que indica la parte del documento utilizada para crear el índice.
...
Obtiene la secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas.
...
**Returns:**
java.lang.String - La secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas.
...
Obtiene un tipo de entrada de índice utilizado para crear el índice.
...
**Returns:**
java.lang.String - Un tipo de entrada de índice utilizado para crear el índice.
...
Obtiene un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra.
...
**Returns:**
java.lang.String - Un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra.
...
Obtiene el ID de idioma utilizado para generar el índice.
...
**Returns:**
java.lang.String - El ID de idioma utilizado para generar el índice.
...
Obtiene un rango de letras al que limitar el índice.
...
**Returns:**
java.lang.String - Un rango de letras al que limitar el índice.
...
Obtiene el número de columnas por página utilizado al crear el índice.
...
**Returns:**
java.lang.String - El número de columnas por página usado al crear el índice.
...
Obtiene la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página.
...
**Returns:**
java.lang.String - La secuencia de caracteres que se usa para separar dos números de página en una lista de números de página.
...
Obtiene la secuencia de caracteres que se usa para separar una entrada de índice y su número de página.
...
**Returns:**
java.lang.String - La secuencia de caracteres que se usa para separar una entrada de índice y su número de página.
...
Obtiene la secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas.
...
**Returns:**
java.lang.String - La secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas.
### getResult() {#getResult}
```
...
Obtiene si se ejecutan subentradas en la misma línea que la entrada principal.
...
**Returns:**
boolean - Si se deben ejecutar subentradas en la misma línea que la entrada principal.
...
Obtiene el nombre de una secuencia cuyo número se incluye con el número de página.

 **Examples:** 

Muestra cómo dividir un documento en porciones combinando los campos INDEX y SEQ.
...
**Returns:**
java.lang.String - El nombre de una secuencia cuyo número se incluye con el número de página.
...
Obtiene si se habilita el uso de texto yomi para las entradas de índice.

 **Examples:** 

Muestra cómo ordenar fonéticamente las entradas del campo INDEX.
...
**Returns:**
boolean - Si se debe habilitar el uso de texto yomi para las entradas de índice.
...
**Returns:**
boolean - Un valor que indica si el separador de número de página se sobrescribe mediante el código del campo.
...
Obtiene un valor que indica si se debe usar una secuencia mientras se construye el resultado del campo.
...
**Returns:**
boolean - Un valor que indica si se debe usar una secuencia mientras se construye el resultado del campo.
### isDirty() {#isDirty}
```
...
Establece el nombre del marcador que indica la parte del documento utilizada para crear el índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre del marcador que indica la porción del documento usada para crear el índice. |
...
Establece la secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La secuencia de caracteres que se usa para separar referencias cruzadas y otras entradas. |
...
Establece un tipo de entrada de índice utilizado para crear el índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un tipo de entrada de índice usado para crear el índice. |
...
Establece un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un encabezado que aparece al inicio de cada conjunto de entradas para una letra dada. |
...
Establece el ID de idioma utilizado para generar el índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El ID de idioma usado para generar el índice. |
...
Establece un rango de letras al que limitar el índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un rango de letras al que limitar el índice. |
...
Establece el número de columnas por página utilizado al crear el índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de columnas por página usado al crear el índice. |
...
Establece la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La secuencia de caracteres que se usa para separar dos números de página en una lista de números de página. |
...
Establece la secuencia de caracteres que se usa para separar una entrada de índice y su número de página.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La secuencia de caracteres que se usa para separar una entrada de índice y su número de página. |
...
Establece la secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La secuencia de caracteres que se usa para separar el inicio y el fin de un rango de páginas. |
...
Establece si se ejecutan subentradas en la misma línea que la entrada principal.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se deben ejecutar subentradas en la misma línea que la entrada principal. |
...
Establece el nombre de una secuencia cuyo número se incluye con el número de página.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de una secuencia cuyo número se incluye con el número de página. |
...
Establece si se habilita el uso de texto yomi para las entradas de índice.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe habilitar el uso de texto yomi para las entradas de índice. |
