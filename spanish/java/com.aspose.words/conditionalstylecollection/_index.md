...
description: "Representa una colección de objetos ConditionalStyle en Java."
type: docs
weight: 124
url: /es/java/com.aspose.words/conditionalstylecollection/
---
...
Representa una colección de objetos [ConditionalStyle](../../com.aspose.words/conditionalstyle/).

Para obtener más información, visite el artículo de documentación [ Working with Tables ][Working with Tables].

 **Remarks:** 

No es posible agregar o eliminar elementos de esta colección. Contiene un conjunto permanente de elementos: un elemento para cada valor del tipo de enumeración [ConditionalStyleType](../../com.aspose.words/conditionalstyletype/).
...
| [get(int index)](#get-int) | Recupera un objeto [ConditionalStyle](../../com.aspose.words/conditionalstyle/) por índice. |
| [getBottomLeftCell()](#getBottomLeftCell) | Obtiene el estilo de la celda inferior izquierda. |
| [getBottomRightCell()](#getBottomRightCell) | Obtiene el estilo de la celda inferior derecha. |
| [getByConditionalStyleType(int conditionalStyleType)](#getByConditionalStyleType-int) |  |
| [getCount()](#getCount) | Obtiene el número de estilos condicionales en la colección. |
| [getEvenColumnBanding()](#getEvenColumnBanding) | Obtiene el estilo de bandas de columna pares. |
| [getEvenRowBanding()](#getEvenRowBanding) | Obtiene el estilo de bandas de fila pares. |
| [getFirstColumn()](#getFirstColumn) | Obtiene el estilo de la primera columna. |
| [getFirstRow()](#getFirstRow) | Obtiene el estilo de la primera fila. |
| [getLastColumn()](#getLastColumn) | Obtiene el estilo de la última columna. |
| [getLastRow()](#getLastRow) | Obtiene el estilo de la última fila. |
| [getOddColumnBanding()](#getOddColumnBanding) | Obtiene el estilo de bandas de columna impares. |
| [getOddRowBanding()](#getOddRowBanding) | Obtiene el estilo de bandas de fila impares. |
| [getTopLeftCell()](#getTopLeftCell) | Obtiene el estilo de la celda superior izquierda. |
| [getTopRightCell()](#getTopRightCell) | Obtiene el estilo de la celda superior derecha. |
| [iterator()](#iterator) | Devuelve un objeto enumerador que puede usarse para iterar sobre todos los estilos condicionales en la colección. |
...
Recupera un objeto [ConditionalStyle](../../com.aspose.words/conditionalstyle/) por índice.
...
| --- | --- | --- |
| índice | int | Índice basado en cero del estilo condicional a recuperar. |
...
Obtiene el estilo de la celda inferior derecha.
...
Obtiene el número de estilos condicionales en la colección.
...
**Returns:**
int - El número de estilos condicionales en la colección.
...
Obtiene el estilo de bandas de columna pares.
...
Obtiene el estilo de bandas de fila pares.
...
Obtiene el estilo de la primera columna.
...
Obtiene el estilo de la primera fila.
...
Obtiene el estilo de bandas de columna impares.
...
Obtiene el estilo de bandas de fila impares.
...
Obtiene el estilo de la celda superior izquierda.
...
Obtiene el estilo de la celda superior derecha.
...
Devuelve un objeto enumerador que puede usarse para iterar sobre todos los estilos condicionales en la colección.
