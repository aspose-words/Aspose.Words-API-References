...
description: "Implemente esta interfaz si desea tener su propio método personalizado llamado para capturar advertencias de pérdida de fidelidad que pueden ocurrir durante la carga o guardado de documentos en Java."
type: docs
weight: 788
url: /es/java/com.aspose.words/iwarningcallback/
---
```
public interface IWarningCallback
```

Implemente esta interfaz si desea que su propio método personalizado sea llamado para capturar advertencias de pérdida de fidelidad que pueden ocurrir durante la carga o guardado del documento.
...
| Método | Descripción |
| --- | --- |
| [warning(WarningInfo info)](#warning-com.aspose.words.WarningInfo) | Aspose.Words invoca este método cuando encuentra algún problema durante la carga o guardado del documento que podría resultar en pérdida de formato o de fidelidad de los datos. |
...
Aspose.Words invoca este método cuando encuentra algún problema durante la carga o guardado del documento que podría resultar en pérdida de formato o de fidelidad de los datos.
