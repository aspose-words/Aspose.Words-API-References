...
description: "Implementa el campo ADDRESSBLOCK en Java."
type: docs
weight: 196
url: /es/java/com.aspose.words/fieldaddressblock/
---
...
Representa un bloque de dirección. Un *bloque de dirección* es un bloque de texto que especifica la información adecuada para una dirección postal, en el orden requerido por el país de destino.

 **Examples:** 

Muestra cómo obtener los nombres de los campos de combinación de correspondencia utilizados por el campo.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Obtiene el nombre del país/región excluido. |
...
| [getFieldNames()](#getFieldNames) | Devuelve una colección de nombres de campos de combinación de correspondencia utilizados por el campo. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Obtiene si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006). |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Obtiene si se debe incluir el nombre del país/región. |
| [getLanguageId()](#getLanguageId) | Obtiene el ID de idioma utilizado para formatear la dirección. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Obtiene el formato de nombre y dirección. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Establece el nombre del país/región excluido. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Establece si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006). |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Establece si se debe incluir el nombre del país/región. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Establece el ID de idioma utilizado para formatear la dirección. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Establece el formato de nombre y dirección. |
...
Obtiene el nombre del país/región excluido.
...
**Returns:**
java.lang.String - El nombre del país/región excluido.
...
Obtiene si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006).
...
**Returns:**
boolean - Si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006).
...
Obtiene si se debe incluir el nombre del país/región.
...
**Returns:**
java.lang.String - Si se debe incluir el nombre del país/región.
...
Obtiene el ID de idioma utilizado para formatear la dirección.
...
**Returns:**
java.lang.String - El ID de idioma utilizado para formatear la dirección.
...
Obtiene el formato de nombre y dirección.
...
**Returns:**
java.lang.String - El formato de nombre y dirección.
### getResult() {#getResult}
```
...
Establece el nombre del país/región excluido.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre del país/región excluido. |
...
Establece si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe formatear la dirección según el país/región del destinatario según lo definido por POST\*CODE (Unión Postal Universal 2006). |
...
Establece si se debe incluir el nombre del país/región.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Si se debe incluir el nombre del país/región. |
...
Establece el ID de idioma utilizado para formatear la dirección.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El ID de idioma utilizado para formatear la dirección. |
...
Establece el formato de nombre y dirección.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El formato de nombre y dirección. |
