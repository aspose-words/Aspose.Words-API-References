...
description: "Regla de sustitución de fuentes para procesar el nombre de la fuente en Java."
type: docs
weight: 329
url: /es/java/com.aspose.words/fontnamesubstitutionrule/
---
...
Regla de sustitución de fuentes para procesar el nombre de la fuente.

Para obtener más información, visite el artículo de documentación [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Según esta regla, Aspose.Words intenta procesar el nombre de la fuente para obtener la sustitución. En particular, Aspose.Words intenta eliminar los sufijos con los separadores '-', ',' y '(' como lo hace MS Word.
