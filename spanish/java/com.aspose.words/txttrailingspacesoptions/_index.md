...
description: "Especifica las opciones disponibles para el manejo de espacios finales durante la importación desde un archivo LoadFormat.TEXT en Java."
type: docs
weight: 697
url: /es/java/com.aspose.words/txttrailingspacesoptions/
---
...
Especifica las opciones disponibles para el manejo de espacios finales durante la importación desde el archivo [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT).
...
| Campo | Descripción |
| --- | --- |
| [PRESERVE](#PRESERVE) | Los espacios finales se conservan. |
| [TRIM](#TRIM) | Los espacios finales se recortan. |
| [length](#length) |  |
## Métodos
...
Los espacios finales se conservan.
...
Los espacios finales se recortan.
