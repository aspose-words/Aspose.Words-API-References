...
description: "Implemente esta interfaz si desea recibir notificaciones cuando los nodos se insertan o eliminan en el documento en Java."
type: docs
weight: 778
url: /es/java/com.aspose.words/inodechangingcallback/
---
```
public interface INodeChangingCallback
```

Implemente esta interfaz si desea recibir notificaciones cuando se insertan o eliminan nodos en el documento.
...
| Método | Descripción |
| --- | --- |
| [nodeInserted(NodeChangingArgs args)](#nodeInserted-com.aspose.words.NodeChangingArgs) | Se llama cuando un nodo perteneciente a este documento ha sido insertado en otro nodo. |
| [nodeInserting(NodeChangingArgs args)](#nodeInserting-com.aspose.words.NodeChangingArgs) | Se llama justo antes de que un nodo perteneciente a este documento esté a punto de ser insertado en otro nodo. |
| [nodeRemoved(NodeChangingArgs args)](#nodeRemoved-com.aspose.words.NodeChangingArgs) | Se llama cuando un nodo perteneciente a este documento ha sido eliminado de su padre. |
| [nodeRemoving(NodeChangingArgs args)](#nodeRemoving-com.aspose.words.NodeChangingArgs) | Se llama justo antes de que un nodo perteneciente a este documento esté a punto de ser eliminado del documento. |
...
Se llama cuando un nodo perteneciente a este documento ha sido insertado en otro nodo.
...
Se llama justo antes de que un nodo perteneciente a este documento esté a punto de ser insertado en otro nodo.
...
Se llama cuando un nodo perteneciente a este documento ha sido eliminado de su padre.
...
Se llama justo antes de que un nodo perteneciente a este documento esté a punto de ser eliminado del documento.
