...
description: "Representa una colección de un ChartDataPoint en Java."
type: docs
weight: 76
url: /es/java/com.aspose.words/chartdatapointcollection/
---
...
Representa una colección de un [ChartDataPoint](../../com.aspose.words/chartdatapoint/).
...
| Método | Descripción |
| --- | --- |
| [clearFormat()](#clearFormat) | Borra el formato de todos los [ChartDataPoint](../../com.aspose.words/chartdatapoint/) en esta colección. |
| [copyFormat(int sourceIndex, int destinationIndex)](#copyFormat-int-int) | Copia el formato del punto de datos origen al punto de datos destino. |
| [get(int index)](#get-int) | Devuelve el [ChartDataPoint](../../com.aspose.words/chartdatapoint/) para el índice especificado. |
| [getCount()](#getCount) | Devuelve el número de [ChartDataPoint](../../com.aspose.words/chartdatapoint/) en esta colección. |
| [hasDefaultFormat(int dataPointIndex)](#hasDefaultFormat-int) | Obtiene una bandera que indica si el punto de datos en el índice especificado tiene formato predeterminado. |
...
Borra el formato de todos los [ChartDataPoint](../../com.aspose.words/chartdatapoint/) en esta colección.
...
Copia el formato del punto de datos origen al punto de datos destino.

 **Examples:** 

Muestra cómo copiar el formato del punto de datos.
...
Devuelve el [ChartDataPoint](../../com.aspose.words/chartdatapoint/) para el índice especificado.
...
Devuelve el número de [ChartDataPoint](../../com.aspose.words/chartdatapoint/) en esta colección.
...
**Returns:**
int - El número de [ChartDataPoint](../../com.aspose.words/chartdatapoint/) en esta colección.
...
Obtiene una bandera que indica si el punto de datos en el índice especificado tiene formato predeterminado.
