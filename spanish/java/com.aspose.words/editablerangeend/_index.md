...
description: "Representa el final de un rango editable en un documento de Word en Java."
type: docs
weight: 180
url: /es/java/com.aspose.words/editablerangeend/
---
...
Representa el final de un rango editable en un documento Word.
...
Un rango editable completo en un documento de Word consta de un [getEditableRangeStart()](../../com.aspose.words/editablerangeend/\#getEditableRangeStart) y un [EditableRangeEnd](../../com.aspose.words/editablerangeend/) coincidente con el mismo Id.
...
Utilice la clase [EditableRange](../../com.aspose.words/editablerange/) como una "fachada" para trabajar con un rango editable como un único objeto.
...
| [getEditableRangeStart()](#getEditableRangeStart) | [EditableRangeStart](../../com.aspose.words/editablerangestart/) correspondiente, recibido por ID. |
...
| [getNodeType()](#getNodeType) | Devuelve [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). |
...
Llama a [DocumentVisitor.visitEditableRangeEnd(com.aspose.words.EditableRangeEnd)](../../com.aspose.words/documentvisitor/\#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd).
...
[EditableRangeStart](../../com.aspose.words/editablerangestart/) correspondiente, recibido por ID.
...
Devuelve [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END).
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
