...
description: "Implementa el campo FILESIZE en Java."
type: docs
weight: 231
url: /es/java/com.aspose.words/fieldfilesize/
---
...
Implementa el campo FILESIZE.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Obtiene el tamaño del archivo del documento actual o 0 si no se puede determinar el tamaño.

En la implementación actual, utiliza la propiedad [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) para obtener el nombre del archivo usado para determinar el tamaño del archivo.
...
| [isInKilobytes()](#isInKilobytes) | Obtiene si se debe mostrar el tamaño del archivo en kilobytes. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Establece si se debe mostrar el tamaño del archivo en kilobytes. |
| [isInMegabytes()](#isInMegabytes) | Obtiene si se debe mostrar el tamaño del archivo en megabytes. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Establece si se debe mostrar el tamaño del archivo en megabytes. |
...
Obtiene si se debe mostrar el tamaño del archivo en kilobytes.
...
**Returns:**
boolean - Si se debe mostrar el tamaño del archivo en kilobytes.
...
Establece si se debe mostrar el tamaño del archivo en kilobytes.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe mostrar el tamaño del archivo en kilobytes. |
...
Obtiene si se debe mostrar el tamaño del archivo en megabytes.
...
**Returns:**
boolean - Si se debe mostrar el tamaño del archivo en megabytes.
...
Establece si se debe mostrar el tamaño del archivo en megabytes.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe mostrar el tamaño del archivo en megabytes. |
