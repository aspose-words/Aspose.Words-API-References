...
description: "Especifica cómo se combina una celda en una tabla con otras celdas en Java."
type: docs
weight: 62
url: /es/java/com.aspose.words/cellmerge/
---
...
Especifica cómo se combina una celda de tabla con otras celdas.
...
| Campo | Descripción |
| --- | --- |
| [FIRST](#FIRST) | La celda es la primera celda en un rango de celdas combinadas. |
| [NONE](#NONE) | La celda no está combinada. |
| [PREVIOUS](#PREVIOUS) | La celda está combinada con la celda anterior horizontalmente o verticalmente. |
| [length](#length) |  |
## Métodos
...
La celda es la primera celda en un rango de celdas combinadas.
...
La celda está combinada con la celda anterior horizontalmente o verticalmente.
