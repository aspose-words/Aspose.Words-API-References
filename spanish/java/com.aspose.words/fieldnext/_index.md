...
description: "Implementa el campo NEXT en Java."
type: docs
weight: 263
url: /es/java/com.aspose.words/fieldnext/
---
...
Implementa el campo NEXT.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Fusiona el siguiente registro de datos en el documento combinado resultante actual, en lugar de iniciar un nuevo documento combinado.
