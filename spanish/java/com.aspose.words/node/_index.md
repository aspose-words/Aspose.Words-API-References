...
description: "Clase base para todos los nodos de un documento Word en Java."
type: docs
weight: 476
url: /es/java/com.aspose.words/node/
---
...
Clase base para todos los nodos de un documento Word.
...
La clase [Node](../../com.aspose.words/node/):
