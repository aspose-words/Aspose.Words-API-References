...
description: "Especifica la variante para un relleno degradado en Java."
type: docs
weight: 365
url: /es/java/com.aspose.words/gradientvariant/
---
...
Corresponde a las cuatro variantes en la pestaña Degradado del cuadro de diálogo Efectos de relleno en Word.
...
| Campo | Descripción |
| --- | --- |
| [NONE](#NONE) | Variante de degradado 'None'. |
| [VARIANT_1](#VARIANT-1) | Variante de degradado 1. |
| [VARIANT_2](#VARIANT-2) | Variante de degradado 2. |
| [VARIANT_3](#VARIANT-3) | Variante de degradado 3. |
| [VARIANT_4](#VARIANT-4) | Variante de degradado 4. |
| [length](#length) |  |
## Métodos
...
Variante de degradado 3.

 **Remarks:** 

Esta variante no es aplicable al relleno degradado con el estilo [GradientStyle.FROM\_CENTER](../../com.aspose.words/gradientstyle/\#FROM-CENTER), si el objeto tiene el lenguaje de marcado [ShapeMarkupLanguage.VML](../../com.aspose.words/shapemarkuplanguage/\#VML).
