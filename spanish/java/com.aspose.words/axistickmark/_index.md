...
description: "Especifica las posiciones posibles para las marcas de graduación en Java."
type: docs
weight: 32
url: /es/java/com.aspose.words/axistickmark/
---
...
| Campo | Descripción |
| --- | --- |
| [CROSS](#CROSS) | Especifica que las marcas de graduación deben cruzar el eje. |
| [INSIDE](#INSIDE) | Especifica que las marcas de graduación deben estar dentro del área del gráfico. |
| [NONE](#NONE) | Especifica que no debe haber marcas de graduación. |
| [OUTSIDE](#OUTSIDE) | Especifica que las marcas de graduación deben estar fuera del área del gráfico. |
| [length](#length) |  |
## Métodos
...
Especifica que las marcas de graduación deben cruzar el eje.
...
Especifica que las marcas de graduación deben estar dentro del área del gráfico.
...
Especifica que no debe haber marcas de graduación.
...
Especifica que las marcas de graduación deben estar fuera del área del gráfico.
