...
description: "Implementa el campo INCLUDE en Java."
type: docs
weight: 246
url: /es/java/com.aspose.words/fieldinclude/
---
...
| [getSourceFullName()](#getSourceFullName) | Obtiene la ubicación del documento. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Establece la ubicación del documento. |
...
Obtiene la ubicación del documento.
...
**Returns:**
java.lang.String - La ubicación del documento.
### getStart() {#getStart}
```
...
Establece la ubicación del documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La ubicación del documento. |
