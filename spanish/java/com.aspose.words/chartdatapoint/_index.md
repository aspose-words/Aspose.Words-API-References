...
description: "Permite especificar el formato de un único punto de datos en el gráfico en Java."
type: docs
weight: 75
url: /es/java/com.aspose.words/chartdatapoint/
---
...
En una serie, el objeto [ChartDataPoint](../../com.aspose.words/chartdatapoint/) es un miembro de la [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/). La [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/) contiene un objeto [ChartDataPoint](../../com.aspose.words/chartdatapoint/) para cada punto.
...
| Método | Descripción |
| --- | --- |
| [clearFormat()](#clearFormat) | Borra el formato de este punto de datos. |
| [getBubble3D()](#getBubble3D) | Especifica si las burbujas en el gráfico de burbujas deben tener un efecto 3D aplicado. |
| [getExplosion()](#getExplosion) | Especifica la cantidad que el punto de datos debe desplazarse desde el centro del pastel. |
| [getFormat()](#getFormat) | Proporciona acceso al formato de relleno y línea de este punto de datos. |
| [getIndex()](#getIndex) | Índice del punto de datos al que este objeto aplica el formato. |
| [getInvertIfNegative()](#getInvertIfNegative) | Especifica si el elemento padre debe invertir sus colores cuando el valor es negativo. |
| [getMarker()](#getMarker) | Especifica el marcador de datos del gráfico. |
| [getShapeType()](#getShapeType) |  |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setBubble3D(boolean value)](#setBubble3D-boolean) | Especifica si las burbujas en el gráfico de burbujas deben tener un efecto 3D aplicado. |
...
| [setInvertIfNegative(boolean value)](#setInvertIfNegative-boolean) | Especifica si el elemento padre debe invertir sus colores cuando el valor es negativo. |
...
Borra el formato de este punto de datos. Las propiedades se establecen a los valores predeterminados definidos en la serie padre.
...
Especifica la cantidad que el punto de datos debe moverse desde el centro del pastel. Puede ser negativo; un valor negativo indica que la propiedad no está establecida y no se debe aplicar explosión. Se aplica solo a gráficos de pastel.

 **Examples:** 

Muestra cómo mover las porciones de un gráfico circular alejándolas del centro.
...
Muestra cómo establecer un formato individual para las categorías de un gráfico de columnas.
...
Índice del punto de datos al que este objeto aplica el formato.
...
Especifica si el elemento padre debe invertir sus colores cuando el valor es negativo.
...
Especifica el marcador de datos del gráfico.
