...
description: "Proporciona acceso tipado a una colección de nodos Run en Java."
type: docs
weight: 594
url: /es/java/com.aspose.words/runcollection/
---
...
Proporciona acceso tipado a una colección de nodos [Run](../../com.aspose.words/run/).
...
| [get(int index)](#get-int) | Recupera un [Run](../../com.aspose.words/run/) en el índice especificado. |
...
Recupera un [Run](../../com.aspose.words/run/) en el índice especificado.
...
**Returns:**
com.aspose.words.Node[] - Una matriz de runs.
