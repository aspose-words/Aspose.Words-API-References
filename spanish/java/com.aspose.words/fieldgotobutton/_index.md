...
description: "Implementa el campo GOTOBUTTON en Java."
type: docs
weight: 240
url: /es/java/com.aspose.words/fieldgotobutton/
---
...
| [getDisplayText()](#getDisplayText) | Obtiene el texto del "botón" que aparece en el documento, de modo que pueda seleccionarse para activar el salto. |
...
| [getLocation()](#getLocation) | Obtiene el nombre de un marcador, un número de página u otro elemento al que saltar. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Establece el texto del "botón" que aparece en el documento, de modo que pueda seleccionarse para activar el salto. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setLocation(String value)](#setLocation-java.lang.String) | Establece el nombre de un marcador, un número de página u otro elemento al que saltar. |
...
Obtiene el texto del "botón" que aparece en el documento, de modo que pueda seleccionarse para activar el salto.
...
**Returns:**
java.lang.String - El texto del "botón" que aparece en el documento, de modo que pueda ser seleccionado para activar el salto.
### getEnd() {#getEnd}
```
...
Obtiene el nombre de un marcador, un número de página u otro elemento al que saltar.
...
**Returns:**
java.lang.String - El nombre de un marcador, un número de página, o algún otro elemento al que saltar.
### getResult() {#getResult}
```
...
Establece el texto del "botón" que aparece en el documento, de modo que pueda seleccionarse para activar el salto.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto del "botón" que aparece en el documento, de modo que pueda ser seleccionado para activar el salto. |
...
Establece el nombre de un marcador, un número de página u otro elemento al que saltar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de un marcador, un número de página, o algún otro elemento al que saltar. |
