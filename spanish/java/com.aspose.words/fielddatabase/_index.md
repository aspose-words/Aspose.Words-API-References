...
description: "Implementa el campo DATABASE en Java."
type: docs
weight: 217
url: /es/java/com.aspose.words/fielddatabase/
---
...
Implementa el campo DATABASE.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Inserta los resultados de una consulta a la base de datos en una tabla WordprocessingML.
...
| Método | Descripción |
| --- | --- |
| [getConnection()](#getConnection) | Obtiene una conexión a los datos. |
...
| [getFileName()](#getFileName) | Obtiene la ruta completa y el nombre de archivo de la base de datos |
| [getFirstRecord()](#getFirstRecord) | Obtiene el número entero de registro del primer registro de datos a insertar. |
...
| [getFormatAttributes()](#getFormatAttributes) | Obtiene qué atributos del formato se aplicarán a la tabla. |
| [getInsertHeadings()](#getInsertHeadings) | Obtiene si se deben insertar los nombres de campo de la base de datos como encabezados de columna en la tabla resultante. |
| [getInsertOnceOnMailMerge()](#getInsertOnceOnMailMerge) | Obtiene si se deben insertar datos al comienzo de una combinación. |
| [getLastRecord()](#getLastRecord) | Obtiene el número entero de registro del último registro de datos a insertar. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getQuery()](#getQuery) | Obtiene un conjunto de instrucciones SQL que consultan la base de datos. |
...
| [getTableFormat()](#getTableFormat) | Obtiene el formato que se aplicará al resultado de la consulta de la base de datos. |
...
| [setConnection(String value)](#setConnection-java.lang.String) | Establece una conexión a los datos. |
| [setFileName(String value)](#setFileName-java.lang.String) | Establece la ruta completa y el nombre de archivo de la base de datos |
| [setFirstRecord(String value)](#setFirstRecord-java.lang.String) | Establece el número entero de registro del primer registro de datos a insertar. |
| [setFormatAttributes(String value)](#setFormatAttributes-java.lang.String) | Establece qué atributos del formato se aplicarán a la tabla. |
| [setInsertHeadings(boolean value)](#setInsertHeadings-boolean) | Establece si se insertan los nombres de campo de la base de datos como encabezados de columna en la tabla resultante. |
| [setInsertOnceOnMailMerge(boolean value)](#setInsertOnceOnMailMerge-boolean) | Establece si se insertan datos al comienzo de una fusión. |
| [setLastRecord(String value)](#setLastRecord-java.lang.String) | Establece el número entero de registro del último registro de datos a insertar. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setQuery(String value)](#setQuery-java.lang.String) | Establece un conjunto de instrucciones SQL que consultan la base de datos. |
...
| [setTableFormat(String value)](#setTableFormat-java.lang.String) | Establece el formato que se aplicará al resultado de la consulta de la base de datos. |
...
Obtiene una conexión a los datos.
...
**Returns:**
java.lang.String - Una conexión a los datos.
...
Obtiene la ruta completa y el nombre de archivo de la base de datos
...
**Returns:**
java.lang.String - La ruta completa y el nombre de archivo de la base de datos
...
Obtiene el número entero de registro del primer registro de datos a insertar.
...
**Returns:**
java.lang.String - El número entero de registro del primer registro de datos a insertar.
### getFormat() {#getFormat}
```
...
Obtiene qué atributos del formato se aplicarán a la tabla.
...
**Returns:**
java.lang.String - Qué atributos del formato se aplicarán a la tabla.
...
Obtiene si se deben insertar los nombres de campo de la base de datos como encabezados de columna en la tabla resultante.
...
**Returns:**
boolean - Si se insertan los nombres de campo de la base de datos como encabezados de columna en la tabla resultante.
...
Obtiene si se deben insertar datos al comienzo de una combinación.
...
**Returns:**
boolean - Si se insertan datos al comienzo de una fusión.
...
Obtiene el número entero de registro del último registro de datos a insertar.
...
**Returns:**
java.lang.String - El número entero de registro del último registro de datos a insertar.
...
Obtiene un conjunto de instrucciones SQL que consultan la base de datos.
...
**Returns:**
java.lang.String - Un conjunto de instrucciones SQL que consultan la base de datos.
### getResult() {#getResult}
```
...
Obtiene el formato que se aplicará al resultado de la consulta de la base de datos.
...
**Returns:**
java.lang.String - El formato que se aplicará al resultado de la consulta de la base de datos.
### getType() {#getType}
```
public int getType()
```
...
Establece una conexión a los datos.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Una conexión a los datos. |
...
Establece la ruta completa y el nombre de archivo de la base de datos
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La ruta completa y el nombre de archivo de la base de datos |
...
Establece el número entero de registro del primer registro de datos a insertar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número entero de registro del primer registro de datos a insertar. |
...
Establece qué atributos del formato se aplicarán a la tabla.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Qué atributos del formato se aplicarán a la tabla. |
...
Establece si se insertan los nombres de campo de la base de datos como encabezados de columna en la tabla resultante.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se insertan los nombres de campo de la base de datos como encabezados de columna en la tabla resultante. |
...
Establece si se insertan datos al comienzo de una fusión.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se insertan datos al comienzo de una fusión. |
...
Establece el número entero de registro del último registro de datos a insertar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número integral de registro del último registro de datos a insertar. |
...
Establece un conjunto de instrucciones SQL que consultan la base de datos.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un conjunto de instrucciones SQL que consultan la base de datos. |
...
Establece el formato que se aplicará al resultado de la consulta de la base de datos.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El formato que se aplicará al resultado de la consulta a la base de datos. |
