...
description: "Representa una secuencia de caracteres con el mismo formato de fuente en Java."
type: docs
weight: 593
url: /es/java/com.aspose.words/run/
---
...
Representa una secuencia de caracteres con el mismo formato de fuente.

Para obtener más información, visite el artículo de documentación [ Programming with Documents ][Programming with Documents].

 **Remarks:** 

Todo el texto del documento se almacena en secuencias de texto.
...
| --- | --- |
| [Run(DocumentBase doc)](#Run-com.aspose.words.DocumentBase) | Inicializa una nueva instancia de la clase [Run](../../com.aspose.words/run/). |
| [Run(DocumentBase doc, String text)](#Run-com.aspose.words.DocumentBase-java.lang.String) | Inicializa una nueva instancia de la clase **Run**. |
## Métodos
...
| [getNodeType()](#getNodeType) | Devuelve [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN). |
...
| [getPhoneticGuide()](#getPhoneticGuide) | Obtiene un objeto [getPhoneticGuide()](../../com.aspose.words/run/\#getPhoneticGuide). |
...
| [getText()](#getText) | Obtiene el texto de la secuencia. |
...
| [isPhoneticGuide()](#isPhoneticGuide) | Obtiene un valor booleano que indica si la secuencia es una guía fonética. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto de la secuencia. |
| [toString()](#toString) |  |
...
Inicializa una nueva instancia de la clase [Run](../../com.aspose.words/run/).

 **Remarks:** 

Cuando se crea [Run](../../com.aspose.words/run/), pertenece al documento especificado, pero aún no forma parte del documento y [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) es null .

Para agregar [Run](../../com.aspose.words/run/) al documento use [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertAfter-com.aspose.words.Node--com.aspose.words.Node) o [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertBefore-com.aspose.words.Node--com.aspose.words.Node) en el párrafo donde desea insertar la secuencia.
...
| --- | --- | --- |
| doc | [DocumentBase](../../com.aspose.words/documentbase/) | El documento propietario. |
| text | java.lang.String | El texto de la secuencia. |
...
Llama a [DocumentVisitor.visitRun(com.aspose.words.Run)](../../com.aspose.words/documentvisitor/\#visitRun-com.aspose.words.Run).
...
Devuelve [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN).
...
**Returns:**
int - [NodeType.RUN](../../com.aspose.words/nodetype/\#RUN). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
...
Obtiene un objeto [getPhoneticGuide()](../../com.aspose.words/run/\#getPhoneticGuide).
...
Obtiene el texto de la secuencia.
...
**Returns:**
java.lang.String - El texto del fragmento.
...
Obtiene un valor booleano que indica si la secuencia es una guía fonética.
...
**Returns:**
boolean - Un valor booleano que indica si el fragmento es una guía fonética.
...
Establece el texto de la secuencia.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto de la secuencia. |
