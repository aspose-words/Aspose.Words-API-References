...
description: "Implementa el campo AUTHOR en Java."
type: docs
weight: 200
url: /es/java/com.aspose.words/fieldauthor/
---
...
Implementa el campo AUTHOR.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, y opcionalmente establece, el nombre del autor del documento, tal como se registra en la propiedad **Author** de las propiedades integradas del documento.
...
| Método | Descripción |
| --- | --- |
| [getAuthorName()](#getAuthorName) | Obtiene el nombre del autor del documento. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Establece el nombre del autor del documento. |
