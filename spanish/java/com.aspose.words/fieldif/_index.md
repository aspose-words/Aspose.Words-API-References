...
description: "Implementa el campo IF en Java."
type: docs
weight: 243
url: /es/java/com.aspose.words/fieldif/
---
...
Compara los valores designados por las expresiones [getLeftExpression()](../../com.aspose.words/fieldif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setLeftExpression-java.lang.String) y [getRightExpression()](../../com.aspose.words/fieldif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setRightExpression-java.lang.String) en la comparación usando el operador designado por [getComparisonOperator()](../../com.aspose.words/fieldif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldif/\#setComparisonOperator-java.lang.String).
...
| [getFalseText()](#getFalseText) | Obtiene el texto mostrado si la expresión de comparación es falsa. |
...
| [getTrueText()](#getTrueText) | Obtiene el texto mostrado si la expresión de comparación es verdadera. |
...
| [setFalseText(String value)](#setFalseText-java.lang.String) | Establece el texto mostrado si la expresión de comparación es falsa. |
...
| [setTrueText(String value)](#setTrueText-java.lang.String) | Establece el texto mostrado si la expresión de comparación es verdadera. |
...
**Returns:**
int - Un valor [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/) que representa el resultado de la evaluación de la condición. El valor devuelto es una de las constantes [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/).
...
Obtiene el texto mostrado si la expresión de comparación es falsa.
...
**Returns:**
java.lang.String - El texto mostrado si la expresión de comparación es falsa.
...
Obtiene el texto mostrado si la expresión de comparación es verdadera.
...
**Returns:**
java.lang.String - El texto mostrado si la expresión de comparación es verdadera.
### getType() {#getType}
```
public int getType()
```
...
Establece el texto mostrado si la expresión de comparación es falsa.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto mostrado si la expresión de comparación es falsa. |
...
Establece el texto mostrado si la expresión de comparación es verdadera.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto mostrado si la expresión de comparación es verdadera. |
