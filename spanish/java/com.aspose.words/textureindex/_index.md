...
description: "Especifica la textura de sombreado en Java."
type: docs
weight: 681
url: /es/java/com.aspose.words/textureindex/
---
...
| [TEXTURE_NIL](#TEXTURE-NIL) | Especifica que no se debe usar ningún patrón en la región sombreada actual (es decir, |
...
Especifica que no se debe usar ningún patrón en la región sombreada actual (es decir, el patrón debe ser un relleno completo con el color de fondo).
