...
description: "Especifica el estilo de terminación de línea en Java."
type: docs
weight: 188
url: /es/java/com.aspose.words/endcap/
---
...
Especifica el estilo de terminación de línea.
...
| Campo | Descripción |
| --- | --- |
| [DEFAULT](#DEFAULT) | El valor predeterminado es [FLAT](../../com.aspose.words/endcap/\#FLAT). |
| [FLAT](#FLAT) | La línea termina en el punto final. |
| [ROUND](#ROUND) | Terminaciones redondeadas. |
| [SQUARE](#SQUARE) | El cuadrado sobresale medio ancho de línea. |
| [length](#length) |  |
## Métodos
...
El valor predeterminado es [FLAT](../../com.aspose.words/endcap/\#FLAT).
...
La línea termina en el punto final.
...
El cuadrado sobresale medio ancho de línea.
