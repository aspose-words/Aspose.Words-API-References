...
description: "Denota el inicio de una región de texto que tiene un comentario asociado en Java."
type: docs
weight: 112
url: /es/java/com.aspose.words/commentrangestart/
---
...
Denota el inicio de una región de texto que tiene un comentario asociado.

Para obtener más información, visite el artículo de documentación [ Working with Comments ][Working with Comments].

 **Remarks:** 

Para crear un comentario anclado a una región de texto, necesita crear un [Comment](../../com.aspose.words/comment/) y luego crear [CommentRangeStart](../../com.aspose.words/commentrangestart/) y [CommentRangeEnd](../../com.aspose.words/commentrangeend/) y establecer sus identificadores al mismo valor de [Comment.getId()](../../com.aspose.words/comment/\#getId) / [Comment.setId(int)](../../com.aspose.words/comment/\#setId-int).
...
Muestra cómo imprimir el contenido de todos los comentarios y sus rangos de comentario usando un visitante de documento.
...
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | Inicializa una nueva instancia de esta clase. |
## Métodos
...
| [getId()](#getId) | Especifica el identificador del comentario al que está vinculada esta región. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Obtiene el nodo que sigue inmediatamente a este nodo. |
| [getNodeType()](#getNodeType) | Devuelve [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). |
...
| [setId(int value)](#setId-int) | Especifica el identificador del comentario al que está vinculada esta región. |
...
Cuando se crea [CommentRangeStart](../../com.aspose.words/commentrangestart/), pertenece al documento especificado, pero aún no forma parte del documento y [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) es null.

Para añadir un [CommentRangeStart](../../com.aspose.words/commentrangestart/) al documento, use InsertAfter o InsertBefore en el párrafo donde desea que se inserte el comentario.
...
| id | int | El identificador del comentario al que está vinculado este objeto. |
...
Llama a [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\#visitCommentRangeStart-com.aspose.words.CommentRangeStart).
...
Especifica el identificador del comentario al que está vinculada esta región.
...
Devuelve [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
