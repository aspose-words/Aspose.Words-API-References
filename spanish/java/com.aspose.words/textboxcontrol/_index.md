...
description: "El control TextBox muestra texto de un conjunto organizado de datos o entrada del usuario en Java."
type: docs
weight: 668
url: /es/java/com.aspose.words/textboxcontrol/
---
...
El control TextBox muestra texto de un conjunto organizado de datos o de la entrada del usuario.
...
| [getText()](#getText) | Obtiene el texto del control. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto del control. |
...
**Returns:**
java.lang.String - Un texto del control.
### getType() {#getType}
```
public int getType()
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un texto del control. |
