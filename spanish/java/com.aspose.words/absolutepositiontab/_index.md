...
description: "Una tabulación de posición absoluta es un carácter que se utiliza para avanzar la posición en la línea actual de texto al mostrar este contenido WordprocessingML en Java."
type: docs
weight: 10
url: /es/java/com.aspose.words/absolutepositiontab/
---
...
Una tabulación de posición absoluta es un carácter que se utiliza para avanzar la posición en la línea actual de texto al mostrar este contenido WordprocessingML.
...
Llama a [DocumentVisitor.visitAbsolutePositionTab(com.aspose.words.AbsolutePositionTab)](../../com.aspose.words/documentvisitor/\#visitAbsolutePositionTab-com.aspose.words.AbsolutePositionTab).
