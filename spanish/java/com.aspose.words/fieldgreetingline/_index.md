...
description: "Implementa el campo GREETINGLINE en Java."
type: docs
weight: 241
url: /es/java/com.aspose.words/fieldgreetingline/
---
...
| Método | Descripción |
| --- | --- |
| [getAlternateText()](#getAlternateText) | Obtiene el texto que se incluirá en el campo si el nombre está vacío. |
...
| [getLanguageId()](#getLanguageId) | Obtiene el identificador de idioma utilizado para formatear el nombre. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | Obtiene el formato del nombre incluido en el campo. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | Establece el texto que se incluirá en el campo si el nombre está vacío. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Establece el identificador de idioma utilizado para formatear el nombre. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Establece el formato del nombre incluido en el campo. |
...
Obtiene el texto que se incluirá en el campo si el nombre está vacío.
...
**Returns:**
java.lang.String - El texto que se incluirá en el campo si el nombre está vacío.
...
Obtiene el identificador de idioma utilizado para formatear el nombre.
...
**Returns:**
java.lang.String - El identificador de idioma utilizado para formatear el nombre.
...
Obtiene el formato del nombre incluido en el campo.
...
**Returns:**
java.lang.String - El formato del nombre incluido en el campo.
### getResult() {#getResult}
```
...
Establece el texto que se incluirá en el campo si el nombre está vacío.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto que se incluirá en el campo si el nombre está vacío. |
...
Establece el identificador de idioma utilizado para formatear el nombre.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El identificador de idioma utilizado para formatear el nombre. |
...
Establece el formato del nombre incluido en el campo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El formato del nombre incluido en el campo. |
