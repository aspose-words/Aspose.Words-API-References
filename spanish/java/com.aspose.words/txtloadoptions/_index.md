...
description: "Permite especificar opciones adicionales al cargar un documento LoadFormat.TEXT en un objeto Document en Java."
type: docs
weight: 693
url: /es/java/com.aspose.words/txtloadoptions/
---
...
Permite especificar opciones adicionales al cargar un documento [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT) en un objeto [Document](../../com.aspose.words/document/).
...
| [getAutoNumberingDetection()](#getAutoNumberingDetection) | Obtiene un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento. |
...
| [getDetectHyperlinks()](#getDetectHyperlinks) | Especifica si se deben detectar hipervínculos en el texto. |
| [getDetectNumberingWithWhitespaces()](#getDetectNumberingWithWhitespaces) | Permite especificar cómo se reconocen los elementos de listas numeradas cuando el documento se importa desde formato de texto sin formato. |
| [getDocumentDirection()](#getDocumentDirection) | Obtiene la dirección del documento. |
...
| [getLeadingSpacesOptions()](#getLeadingSpacesOptions) | Obtiene la opción preferida para el manejo de espacios iniciales. |
...
| [getTrailingSpacesOptions()](#getTrailingSpacesOptions) | Obtiene la opción preferida para el manejo de espacios finales. |
...
| [setAutoNumberingDetection(boolean value)](#setAutoNumberingDetection-boolean) | Establece un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento. |
...
| [setDetectHyperlinks(boolean value)](#setDetectHyperlinks-boolean) | Especifica si se deben detectar hipervínculos en el texto. |
| [setDetectNumberingWithWhitespaces(boolean value)](#setDetectNumberingWithWhitespaces-boolean) | Permite especificar cómo se reconocen los elementos de listas numeradas cuando el documento se importa desde formato de texto sin formato. |
| [setDocumentDirection(int value)](#setDocumentDirection-int) | Establece la dirección del documento. |
...
| [setLeadingSpacesOptions(int value)](#setLeadingSpacesOptions-int) | Establece la opción preferida para el manejo de espacios iniciales. |
...
| [setTrailingSpacesOptions(int value)](#setTrailingSpacesOptions-int) | Establece la opción preferida para el manejo de espacios finales. |
...
Obtiene un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento. El valor predeterminado es  true .
...
**Returns:**
boolean - Un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento.
...
Especifica si detectar hipervínculos en el texto. El valor predeterminado es false.
...
Permite especificar cómo se reconocen los elementos de listas numeradas cuando el documento se importa desde formato de texto sin formato. El valor predeterminado es true.

 **Remarks:** 

Si esta opción se establece en false, el algoritmo de reconocimiento de listas detecta los párrafos de lista cuando los números de lista terminan con punto, corchete derecho o símbolos de viñeta (como "\\u2022", "\*", "-" o "o").

Si esta opción se establece en true, los espacios en blanco también se utilizan como delimitadores de número de lista: el algoritmo de reconocimiento de listas para numeración de estilo árabe (1., 1.1.2.) usa tanto espacios en blanco como el símbolo punto (".").
...
Obtiene la dirección del documento. El valor predeterminado es [DocumentDirection.LEFT\_TO\_RIGHT](../../com.aspose.words/documentdirection/\#LEFT-TO-RIGHT).
...
**Returns:**
int - Una dirección de documento. El valor devuelto es una de las constantes de [DocumentDirection](../../com.aspose.words/documentdirection/).
...
Obtiene la opción preferida para el manejo de espacios iniciales. El valor predeterminado es [TxtLeadingSpacesOptions.CONVERT\_TO\_INDENT](../../com.aspose.words/txtleadingspacesoptions/\#CONVERT-TO-INDENT).
...
**Returns:**
int - Opción preferida para el manejo de espacios iniciales. El valor devuelto es una de las constantes de [TxtLeadingSpacesOptions](../../com.aspose.words/txtleadingspacesoptions/).
...
Obtiene la opción preferida para el manejo de espacios finales. El valor predeterminado es [TxtTrailingSpacesOptions.TRIM](../../com.aspose.words/txttrailingspacesoptions/\#TRIM).
...
**Returns:**
int - Opción preferida para el manejo de espacios finales. El valor devuelto es una de las constantes de [TxtTrailingSpacesOptions](../../com.aspose.words/txttrailingspacesoptions/).
...
Establece un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento. El valor predeterminado es true.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Un valor booleano que indica si se realizará la detección automática de numeración al cargar un documento. |
...
Establece la dirección del documento. El valor predeterminado es [DocumentDirection.LEFT\_TO\_RIGHT](../../com.aspose.words/documentdirection/\#LEFT-TO-RIGHT).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | Una dirección de documento. El valor debe ser una de las constantes de [DocumentDirection](../../com.aspose.words/documentdirection/). |
...
Establece la opción preferida para el manejo de espacios iniciales. El valor predeterminado es [TxtLeadingSpacesOptions.CONVERT\_TO\_INDENT](../../com.aspose.words/txtleadingspacesoptions/\#CONVERT-TO-INDENT).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | Opción preferida para el manejo de espacios iniciales. El valor debe ser una de las constantes de [TxtLeadingSpacesOptions](../../com.aspose.words/txtleadingspacesoptions/). |
...
Establece la opción preferida para el manejo de espacios finales. El valor predeterminado es [TxtTrailingSpacesOptions.TRIM](../../com.aspose.words/txttrailingspacesoptions/\#TRIM).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | Opción preferida para el manejo de espacios finales. El valor debe ser una de las constantes de [TxtTrailingSpacesOptions](../../com.aspose.words/txttrailingspacesoptions/). |
