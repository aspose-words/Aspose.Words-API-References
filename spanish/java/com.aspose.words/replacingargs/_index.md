...
description: "Proporciona datos para una operación de reemplazo personalizada en Java."
type: docs
weight: 569
url: /es/java/com.aspose.words/replacingargs/
---
...
| Método | Descripción |
| --- | --- |
| [getGroupIndex()](#getGroupIndex) | Identifica, por índice, un grupo capturado en el [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) que debe ser reemplazado con la cadena de [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String). |
| [getMatch()](#getMatch) | El java.util.regex.Matcher resultante de una única coincidencia de expresión regular durante una **Replace**. |
| [getMatchEndNode()](#getMatchEndNode) | Obtiene el nodo que contiene el final de la coincidencia. |
| [getMatchNode()](#getMatchNode) | Obtiene el nodo que contiene el inicio de la coincidencia. |
| [getMatchOffset()](#getMatchOffset) | Obtiene la posición inicial basada en cero de la coincidencia desde el inicio del nodo que contiene el inicio de la coincidencia. |
| [getReplacement()](#getReplacement) | Obtiene la cadena de reemplazo. |
| [setGroupIndex(int value)](#setGroupIndex-int) | Identifica, por índice, un grupo capturado en el [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) que debe ser reemplazado con la cadena de [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String). |
| [setReplacement(String value)](#setReplacement-java.lang.String) | Establece la cadena de reemplazo. |
...
Identifica, por índice, un grupo capturado en el [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) que debe ser reemplazado con la cadena de [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String).
...
El java.util.regex.Matcher resultante de una única coincidencia de expresión regular durante una **Replace**.

 **Remarks:** 

Matcher.start() obtiene la posición inicial basada en cero de la coincidencia desde el inicio del rango de búsqueda y reemplazo.
...
**Returns:**
java.util.regex.Matcher - El valor correspondiente de java.util.regex.Matcher.
...
Obtiene el nodo que contiene el final de la coincidencia.

 **Examples:** 

Muestra cómo obtener el nodo final de la coincidencia.
...
Obtiene la posición inicial basada en cero de la coincidencia desde el inicio del nodo que contiene el inicio de la coincidencia.
...
**Returns:**
int - La posición inicial basada en cero de la coincidencia desde el inicio del nodo que contiene el comienzo de la coincidencia.
...
**Returns:**
java.lang.String - La cadena de reemplazo.
...
Establece la cadena de reemplazo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La cadena de reemplazo. |
