...
description: "Implementa el campo HYPERLINK en Java."
type: docs
weight: 242
url: /es/java/com.aspose.words/fieldhyperlink/
---
...
| Método | Descripción |
| --- | --- |
| [getAddress()](#getAddress) | Obtiene una ubicación a la que salta este hipervínculo. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Obtiene si se debe abrir el sitio de destino en una nueva ventana del navegador web. |
| [getResult()](#getResult) | Obtiene el texto que está entre el separador del campo y el final del campo. |
| [getScreenTip()](#getScreenTip) | Obtiene el texto de ScreenTip del hipervínculo. |
...
| [getSubAddress()](#getSubAddress) | Obtiene una ubicación en el archivo, como un marcador, a la que salta este hipervínculo. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | Obtiene el destino al que debe redirigirse el enlace. |
...
| [isImageMap()](#isImageMap) | Obtiene si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Establece si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Establece una ubicación a la que salta este hipervínculo. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | Establece si se debe abrir el sitio de destino en una nueva ventana del navegador web. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Establece el texto de ScreenTip del hipervínculo. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | Establece una ubicación en el archivo, como un marcador, a la que salta este hipervínculo. |
| [setTarget(String value)](#setTarget-java.lang.String) | Establece el destino al que debe redirigirse el enlace. |
...
Obtiene una ubicación a la que salta este hipervínculo.
...
**Returns:**
java.lang.String - Una ubicación a la que salta este hipervínculo.
...
Obtiene si se debe abrir el sitio de destino en una nueva ventana del navegador web.
...
**Returns:**
boolean - Si se debe abrir el sitio de destino en una nueva ventana del navegador web.
### getResult() {#getResult}
```
...
Obtiene el texto de ScreenTip del hipervínculo.
...
**Returns:**
java.lang.String - El texto de ScreenTip del hipervínculo.
...
Obtiene una ubicación en el archivo, como un marcador, a la que salta este hipervínculo.
...
**Returns:**
java.lang.String - Una ubicación en el archivo, como un marcador, a la que salta este hipervínculo.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Obtiene el destino al que debe redirigirse el enlace.
...
**Returns:**
java.lang.String - El destino al que debe redirigirse el enlace.
### getType() {#getType}
```
public int getType()
```
...
Obtiene si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor.
...
**Returns:**
boolean - Si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor.
...
Establece si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor. |
...
Establece una ubicación a la que salta este hipervínculo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Una ubicación a la que salta este hipervínculo. |
...
Establece si se debe abrir el sitio de destino en una nueva ventana del navegador web.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe abrir el sitio de destino en una nueva ventana del navegador web. |
...
Establece el texto de ScreenTip del hipervínculo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto de ScreenTip del hipervínculo. |
...
Establece una ubicación en el archivo, como un marcador, a la que salta este hipervínculo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Una ubicación en el archivo, como un marcador, a la que salta este hipervínculo. |
...
Establece el destino al que debe redirigirse el enlace.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El destino al que debe redirigirse el enlace. |
