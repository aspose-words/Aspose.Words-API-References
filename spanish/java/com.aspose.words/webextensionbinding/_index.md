...
description: "Especifica una relación de enlace entre una extensión web y los datos en el documento en Java."
type: docs
weight: 727
url: /es/java/com.aspose.words/webextensionbinding/
---
...
Especifica una relación de enlace entre una extensión web y los datos del documento.
...
| --- | --- |
| [WebExtensionBinding(String id, int bindingType, String appRef)](#WebExtensionBinding-java.lang.String-int-java.lang.String) | Inicializa una nueva instancia de esta clase. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getAppRef()](#getAppRef) | Especifica la clave de enlace utilizada para mapear la entrada de enlace en esta lista con los datos vinculados en el documento. |
| [getBindingType()](#getBindingType) | Especifica el tipo de enlace. |
| [getId()](#getId) | Especifica el identificador de enlace. |
| [setAppRef(String value)](#setAppRef-java.lang.String) | Especifica la clave de enlace utilizada para mapear la entrada de enlace en esta lista con los datos vinculados en el documento. |
| [setBindingType(int value)](#setBindingType-int) | Especifica el tipo de enlace. |
| [setId(String value)](#setId-java.lang.String) | Especifica el identificador de enlace. |
...
**Returns:**
int - El valor int correspondiente. El valor devuelto es una de las constantes [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/).
### getId() {#getId}
```
public String getId()
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El valor int correspondiente. El valor debe ser una de las constantes [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/). |
