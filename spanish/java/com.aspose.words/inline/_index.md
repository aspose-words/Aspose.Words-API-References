...
description: "Clase base para nodos de nivel en línea que pueden tener formato de carácter asociado, pero no pueden tener nodos hijos propios en Java."
type: docs
weight: 403
url: /es/java/com.aspose.words/inline/
---
...
Clase base para nodos de nivel en línea que pueden tener formato de carácter asociado, pero no pueden tener nodos hijos propios.

Para obtener más información, visite el artículo de documentación [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document].

 **Remarks:** 

Una clase derivada de [Inline](../../com.aspose.words/inline/) puede ser un hijo de [Paragraph](../../com.aspose.words/paragraph/).
...
| [getNodeType()](#getNodeType) | Obtiene el tipo de este nodo. |
...
**Returns:**
int - El tipo de este nodo. El valor devuelto es uno de los constantes [NodeType](../../com.aspose.words/nodetype/).
