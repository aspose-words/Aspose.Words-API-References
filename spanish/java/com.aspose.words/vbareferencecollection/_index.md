...
description: "Representa una colección de objetos VbaReference en Java."
type: docs
weight: 711
url: /es/java/com.aspose.words/vbareferencecollection/
---
...
Representa una colección de objetos [VbaReference](../../com.aspose.words/vbareference/).
...
| Método | Descripción |
| --- | --- |
| [get(int index)](#get-int) | Obtiene el objeto [VbaReference](../../com.aspose.words/vbareference/) en el índice especificado. |
| [getCount()](#getCount) | Devuelve el número de referencias VBA en la colección. |
| [iterator()](#iterator) |  |
| [remove(VbaReference item)](#remove-com.aspose.words.VbaReference) | Elimina la primera aparición de un elemento [VbaReference](../../com.aspose.words/vbareference/) especificado de la colección. |
| [removeAt(int index)](#removeAt-int) | Elimina el elemento [VbaReference](../../com.aspose.words/vbareference/) en el índice especificado de la colección. |
...
Obtiene el objeto [VbaReference](../../com.aspose.words/vbareference/) en el índice especificado.
...
| --- | --- | --- |
| índice | int | El índice basado en cero de la referencia a obtener. |
...
**Returns:**
int - El número de referencias VBA en la colección.
### iterator() {#iterator}
```
...
Elimina la primera aparición de un elemento [VbaReference](../../com.aspose.words/vbareference/) especificado de la colección.
...
Elimina el elemento [VbaReference](../../com.aspose.words/vbareference/) en el índice especificado de la colección.
