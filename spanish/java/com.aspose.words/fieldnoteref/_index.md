...
description: "Implementa el campo NOTEREF en Java."
type: docs
weight: 265
url: /es/java/com.aspose.words/fieldnoteref/
---
...
Muestra cómo referenciar cruzadamente notas al pie con el campo NOTEREF.
...
| Método | Descripción |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Obtiene el nombre del marcador. |
...
| [getInsertHyperlink()](#getInsertHyperlink) | Obtiene si se debe insertar un hipervínculo al párrafo marcado. |
| [getInsertReferenceMark()](#getInsertReferenceMark) | Inserta la marca de referencia con el mismo formato de carácter que el estilo de Referencia de Nota al Pie o Referencia de Nota Final. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Obtiene si se debe insertar una posición relativa del párrafo marcado. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Establece el nombre del marcador. |
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Establece si se debe insertar un hipervínculo en el párrafo marcado. |
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Inserta la marca de referencia con el mismo formato de carácter que el estilo de Referencia de Nota al Pie o Referencia de Nota Final. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Establece si se debe insertar una posición relativa del párrafo marcado. |
...
Obtiene si se debe insertar un hipervínculo al párrafo marcado.
...
**Returns:**
boolean - Si se debe insertar un hipervínculo en el párrafo marcado.
...
Inserta la marca de referencia con el mismo formato de carácter que el estilo de Referencia de Nota al Pie o Referencia de Nota Final.
...
Obtiene si se debe insertar una posición relativa del párrafo marcado.
...
**Returns:**
boolean - Si se debe insertar una posición relativa del párrafo marcado.
...
Establece si se debe insertar un hipervínculo en el párrafo marcado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe insertar un hipervínculo en el párrafo marcado. |
...
Establece si se debe insertar una posición relativa del párrafo marcado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe insertar una posición relativa del párrafo marcado. |
