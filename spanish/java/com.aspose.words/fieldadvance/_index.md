...
description: "Implementa el campo ADVANCE en Java."
type: docs
weight: 197
url: /es/java/com.aspose.words/fieldadvance/
---
...
Mueve el punto de inicio en el que el texto que sigue léxicamente al campo se muestra a la derecha o izquierda, arriba o abajo, o a una posición horizontal o vertical específica.
...
| [getDownOffset()](#getDownOffset) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse hacia abajo. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse horizontalmente desde el borde izquierdo de la columna, marco o cuadro de texto. |
| [getLeftOffset()](#getLeftOffset) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse a la izquierda. |
...
| [getRightOffset()](#getRightOffset) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse a la derecha. |
...
| [getUpOffset()](#getUpOffset) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse hacia arriba. |
| [getVerticalPosition()](#getVerticalPosition) | Obtiene el número de puntos por los que el texto que sigue al campo debe moverse verticalmente desde el borde superior de la página. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe moverse hacia abajo. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe desplazarse horizontalmente desde el borde izquierdo de la columna, el marco o el cuadro de texto. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la izquierda. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la derecha. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe desplazarse hacia arriba. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Establece el número de puntos por los que el texto que sigue al campo debe desplazarse verticalmente desde el borde superior de la página. |
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse hacia abajo.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse hacia abajo.
### getEnd() {#getEnd}
```
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse horizontalmente desde el borde izquierdo de la columna, marco o cuadro de texto.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse horizontalmente desde el borde izquierdo de la columna, el marco o el cuadro de texto.
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse a la izquierda.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse a la izquierda.
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse a la derecha.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse a la derecha.
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse hacia arriba.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse hacia arriba.
...
Obtiene el número de puntos por los que el texto que sigue al campo debe moverse verticalmente desde el borde superior de la página.
...
**Returns:**
java.lang.String - El número de puntos por los que el texto que sigue al campo debe desplazarse verticalmente desde el borde superior de la página.
### isDirty() {#isDirty}
```
...
Establece el número de puntos por los que el texto que sigue al campo debe moverse hacia abajo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse hacia abajo. |
...
Establece el número de puntos por los que el texto que sigue al campo debe desplazarse horizontalmente desde el borde izquierdo de la columna, el marco o el cuadro de texto.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse horizontalmente desde el borde izquierdo de la columna, el marco o el cuadro de texto. |
...
Establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la izquierda.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse a la izquierda. |
...
Establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la derecha.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse a la derecha. |
...
Establece el número de puntos por los que el texto que sigue al campo debe desplazarse hacia arriba.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse hacia arriba. |
...
Establece el número de puntos por los que el texto que sigue al campo debe desplazarse verticalmente desde el borde superior de la página.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El número de puntos por los que el texto que sigue al campo debe desplazarse verticalmente desde el borde superior de la página. |
