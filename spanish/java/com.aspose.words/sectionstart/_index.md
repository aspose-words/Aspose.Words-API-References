...
description: "El tipo de salto al comienzo de la sección en Java."
type: docs
weight: 608
url: /es/java/com.aspose.words/sectionstart/
---
...
| Campo | Descripción |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | La nueva sección comienza en la misma página que la sección anterior. |
| [EVEN_PAGE](#EVEN-PAGE) | La sección comienza en una nueva página par. |
| [NEW_COLUMN](#NEW-COLUMN) | La sección comienza en una nueva columna. |
| [NEW_PAGE](#NEW-PAGE) | La sección comienza en una nueva página. |
| [ODD_PAGE](#ODD-PAGE) | La sección comienza en una nueva página impar. |
| [length](#length) |  |
## Métodos
...
La nueva sección comienza en la misma página que la sección anterior.
...
La sección comienza en una nueva página par.
...
La sección comienza en una nueva columna.
...
La sección comienza en una nueva página.
...
La sección comienza en una nueva página impar.
