...
description: "Permite especificar opciones para la línea de firma que se inserta en Java."
type: docs
weight: 622
url: /es/java/com.aspose.words/signaturelineoptions/
---
...
Permite especificar opciones para la línea de firma que se inserta. Se usa en [DocumentBuilder](../../com.aspose.words/documentbuilder/).
...
| [getSignerTitle()](#getSignerTitle) | Obtiene el título sugerido del firmante. |
...
| [setSignerTitle(String value)](#setSignerTitle-java.lang.String) | Establece el título sugerido del firmante. |
...
Obtiene las instrucciones para el firmante que se muestran al firmar la línea de firma. El valor predeterminado para esta propiedad es **empty string**.
...
Obtiene el título sugerido del firmante. El valor predeterminado para esta propiedad es **empty string**.
...
**Returns:**
java.lang.String - Título sugerido del firmante.
...
Establece instrucciones para el firmante que se muestran al firmar la línea de firma. El valor predeterminado para esta propiedad es **empty string**.
...
Establece el título sugerido del firmante. El valor predeterminado para esta propiedad es **empty string**.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Título sugerido del firmante. |
