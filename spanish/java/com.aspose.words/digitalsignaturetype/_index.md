...
description: "Especifica el tipo de una firma digital en Java."
type: docs
weight: 153
url: /es/java/com.aspose.words/digitalsignaturetype/
---
...
Especifica el tipo de una firma digital.
...
| Campo | Descripción |
| --- | --- |
| [CRYPTO_API](#CRYPTO-API) | El método de firma Crypto API utilizado en documentos binarios .DOC de Microsoft Word 97-2003. |
| [UNKNOWN](#UNKNOWN) | Indica un error, tipo de firma digital desconocido. |
| [XML_DSIG](#XML-DSIG) | El método de firma XmlDsig utilizado en documentos OOXML y OpenDocument. |
| [length](#length) |  |
## Métodos
...
El método de firma Crypto API utilizado en documentos binarios .DOC de Microsoft Word 97-2003.
...
Indica un error, tipo de firma digital desconocido.
...
El método de firma XmlDsig utilizado en documentos OOXML y OpenDocument.
