...
description: "Clase base para visitantes de documentos personalizados en Java."
type: docs
weight: 175
url: /es/java/com.aspose.words/documentvisitor/
---
...
Con [DocumentVisitor](../../com.aspose.words/documentvisitor/) puedes definir y ejecutar operaciones personalizadas que requieren enumeración sobre el árbol del documento.

Por ejemplo, Aspose.Words usa [DocumentVisitor](../../com.aspose.words/documentvisitor/) internamente para guardar [Document](../../com.aspose.words/document/) en varios formatos y para otras operaciones como buscar campos o marcadores en un fragmento de un documento.

Para usar [DocumentVisitor](../../com.aspose.words/documentvisitor/):

1.  Crea una clase derivada de [DocumentVisitor](../../com.aspose.words/documentvisitor/).
2.  Sobrescribe y proporciona implementaciones para algunos o todos los métodos VisitXXX para realizar operaciones personalizadas.
3.  Llama a [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/\#accept-com.aspose.words.DocumentVisitor) en el [Node](../../com.aspose.words/node/) desde el que deseas iniciar la enumeración.
...
Muestra cómo usar un visitante de documento para imprimir la estructura de nodos de un documento.
...
| Método | Descripción |
| --- | --- |
| [visitAbsolutePositionTab(AbsolutePositionTab tab)](#visitAbsolutePositionTab-com.aspose.words.AbsolutePositionTab) | Se llama cuando se encuentra un nodo [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) en el documento. |
| [visitBodyEnd(Body body)](#visitBodyEnd-com.aspose.words.Body) | Se llama cuando la enumeración de la historia principal de texto en una sección ha finalizado. |
| [visitBodyStart(Body body)](#visitBodyStart-com.aspose.words.Body) | Se llama cuando la enumeración de la historia principal de texto en una sección ha comenzado. |
| [visitBookmarkEnd(BookmarkEnd bookmarkEnd)](#visitBookmarkEnd-com.aspose.words.BookmarkEnd) | Se llama cuando se encuentra el final de un marcador en el documento. |
| [visitBookmarkStart(BookmarkStart bookmarkStart)](#visitBookmarkStart-com.aspose.words.BookmarkStart) | Se llama cuando se encuentra el inicio de un marcador en el documento. |
| [visitBuildingBlockEnd(BuildingBlock block)](#visitBuildingBlockEnd-com.aspose.words.BuildingBlock) | Se llama cuando la enumeración de un bloque de construcción ha finalizado. |
| [visitBuildingBlockStart(BuildingBlock block)](#visitBuildingBlockStart-com.aspose.words.BuildingBlock) | Se llama cuando la enumeración de un bloque de construcción ha comenzado. |
| [visitCellEnd(Cell cell)](#visitCellEnd-com.aspose.words.Cell) | Se llama cuando la enumeración de una celda de tabla ha finalizado. |
| [visitCellStart(Cell cell)](#visitCellStart-com.aspose.words.Cell) | Se llama cuando la enumeración de una celda de tabla ha comenzado. |
| [visitCommentEnd(Comment comment)](#visitCommentEnd-com.aspose.words.Comment) | Se llama cuando la enumeración de un texto de comentario ha finalizado. |
| [visitCommentRangeEnd(CommentRangeEnd commentRangeEnd)](#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd) | Se llama cuando se encuentra el final de un rango de texto comentado. |
| [visitCommentRangeStart(CommentRangeStart commentRangeStart)](#visitCommentRangeStart-com.aspose.words.CommentRangeStart) | Se llama cuando se encuentra el inicio de un rango de texto comentado. |
| [visitCommentStart(Comment comment)](#visitCommentStart-com.aspose.words.Comment) | Se llama cuando la enumeración de un texto de comentario ha comenzado. |
| [visitDocumentEnd(Document doc)](#visitDocumentEnd-com.aspose.words.Document) | Se llama cuando la enumeración del documento ha finalizado. |
| [visitDocumentStart(Document doc)](#visitDocumentStart-com.aspose.words.Document) | Se llama cuando la enumeración del documento ha comenzado. |
| [visitEditableRangeEnd(EditableRangeEnd editableRangeEnd)](#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd) | Se llama cuando se encuentra el final de un rango editable en el documento. |
| [visitEditableRangeStart(EditableRangeStart editableRangeStart)](#visitEditableRangeStart-com.aspose.words.EditableRangeStart) | Se llama cuando se encuentra el inicio de un rango editable en el documento. |
| [visitFieldEnd(FieldEnd fieldEnd)](#visitFieldEnd-com.aspose.words.FieldEnd) | Se llama cuando un campo termina en el documento. |
| [visitFieldSeparator(FieldSeparator fieldSeparator)](#visitFieldSeparator-com.aspose.words.FieldSeparator) | Se llama cuando se encuentra un separador de campo en el documento. |
| [visitFieldStart(FieldStart fieldStart)](#visitFieldStart-com.aspose.words.FieldStart) | Se llama cuando un campo comienza en el documento. |
| [visitFootnoteEnd(Footnote footnote)](#visitFootnoteEnd-com.aspose.words.Footnote) | Se llama cuando la enumeración del texto de una nota al pie o nota final ha terminado. |
| [visitFootnoteStart(Footnote footnote)](#visitFootnoteStart-com.aspose.words.Footnote) | Se llama cuando la enumeración del texto de una nota al pie o nota final ha comenzado. |
| [visitFormField(FormField formField)](#visitFormField-com.aspose.words.FormField) | Se llama cuando se encuentra un campo de formulario en el documento. |
| [visitGlossaryDocumentEnd(GlossaryDocument glossary)](#visitGlossaryDocumentEnd-com.aspose.words.GlossaryDocument) | Se llama cuando la enumeración de un documento de glosario ha terminado. |
| [visitGlossaryDocumentStart(GlossaryDocument glossary)](#visitGlossaryDocumentStart-com.aspose.words.GlossaryDocument) | Se llama cuando la enumeración de un documento de glosario ha comenzado. |
| [visitGroupShapeEnd(GroupShape groupShape)](#visitGroupShapeEnd-com.aspose.words.GroupShape) | Se llama cuando la enumeración de una forma grupal ha terminado. |
| [visitGroupShapeStart(GroupShape groupShape)](#visitGroupShapeStart-com.aspose.words.GroupShape) | Se llama cuando la enumeración de una forma grupal ha comenzado. |
| [visitHeaderFooterEnd(HeaderFooter headerFooter)](#visitHeaderFooterEnd-com.aspose.words.HeaderFooter) | Se llama cuando la enumeración de un encabezado o pie de página en una sección ha terminado. |
| [visitHeaderFooterStart(HeaderFooter headerFooter)](#visitHeaderFooterStart-com.aspose.words.HeaderFooter) | Se llama cuando la enumeración de un encabezado o pie de página en una sección ha comenzado. |
| [visitOfficeMathEnd(OfficeMath officeMath)](#visitOfficeMathEnd-com.aspose.words.OfficeMath) | Se llama cuando la enumeración de un objeto Office Math ha terminado. |
| [visitOfficeMathStart(OfficeMath officeMath)](#visitOfficeMathStart-com.aspose.words.OfficeMath) | Se llama cuando la enumeración de un objeto Office Math ha comenzado. |
| [visitParagraphEnd(Paragraph paragraph)](#visitParagraphEnd-com.aspose.words.Paragraph) | Se llama cuando la enumeración de un párrafo ha terminado. |
| [visitParagraphStart(Paragraph paragraph)](#visitParagraphStart-com.aspose.words.Paragraph) | Se llama cuando la enumeración de un párrafo ha comenzado. |
| [visitRowEnd(Row row)](#visitRowEnd-com.aspose.words.Row) | Se llama cuando la enumeración de una fila de tabla ha terminado. |
| [visitRowStart(Row row)](#visitRowStart-com.aspose.words.Row) | Se llama cuando la enumeración de una fila de tabla ha comenzado. |
| [visitRun(Run run)](#visitRun-com.aspose.words.Run) | Se llama cuando se encuentra una secuencia de texto en el documento. |
| [visitSectionEnd(Section section)](#visitSectionEnd-com.aspose.words.Section) | Se llama cuando la enumeración de una sección ha terminado. |
| [visitSectionStart(Section section)](#visitSectionStart-com.aspose.words.Section) | Se llama cuando la enumeración de una sección ha comenzado. |
| [visitShapeEnd(Shape shape)](#visitShapeEnd-com.aspose.words.Shape) | Se llama cuando la enumeración de una forma ha terminado. |
| [visitShapeStart(Shape shape)](#visitShapeStart-com.aspose.words.Shape) | Se llama cuando la enumeración de una forma ha comenzado. |
| [visitSmartTagEnd(SmartTag smartTag)](#visitSmartTagEnd-com.aspose.words.SmartTag) | Se llama cuando la enumeración de una etiqueta inteligente ha finalizado. |
| [visitSmartTagStart(SmartTag smartTag)](#visitSmartTagStart-com.aspose.words.SmartTag) | Se llama cuando la enumeración de una etiqueta inteligente ha comenzado. |
| [visitSpecialChar(SpecialChar specialChar)](#visitSpecialChar-com.aspose.words.SpecialChar) | Se llama cuando se encuentra un nodo [SpecialChar](../../com.aspose.words/specialchar/) en el documento. |
| [visitStructuredDocumentTagEnd(StructuredDocumentTag sdt)](#visitStructuredDocumentTagEnd-com.aspose.words.StructuredDocumentTag) | Se llama cuando la enumeración de una etiqueta de documento estructurado ha finalizado. |
| [visitStructuredDocumentTagRangeEnd(StructuredDocumentTagRangeEnd sdtRangeEnd)](#visitStructuredDocumentTagRangeEnd-com.aspose.words.StructuredDocumentTagRangeEnd) | Se llama cuando se encuentra un StructuredDocumentTagRangeEnd. |
| [visitStructuredDocumentTagRangeStart(StructuredDocumentTagRangeStart sdtRangeStart)](#visitStructuredDocumentTagRangeStart-com.aspose.words.StructuredDocumentTagRangeStart) | Se llama cuando se encuentra un StructuredDocumentTagRangeStart. |
| [visitStructuredDocumentTagStart(StructuredDocumentTag sdt)](#visitStructuredDocumentTagStart-com.aspose.words.StructuredDocumentTag) | Se llama cuando la enumeración de una etiqueta de documento estructurado ha comenzado. |
| [visitSubDocument(SubDocument subDocument)](#visitSubDocument-com.aspose.words.SubDocument) | Se llama cuando se encuentra un subdocumento. |
| [visitTableEnd(Table table)](#visitTableEnd-com.aspose.words.Table) | Se llama cuando la enumeración de una tabla ha finalizado. |
| [visitTableStart(Table table)](#visitTableStart-com.aspose.words.Table) | Se llama cuando la enumeración de una tabla ha comenzado. |
...
Se llama cuando se encuentra un nodo [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) en el documento.
...
| --- | --- | --- |
| tab | [AbsolutePositionTab](../../com.aspose.words/absolutepositiontab/) | El objeto que está siendo visitado. |

**Returns:**
int - Un valor [VisitorAction](../../com.aspose.words/visitoraction/) que especifica cómo continuar la enumeración. El valor devuelto es una de las constantes [VisitorAction](../../com.aspose.words/visitoraction/).
...
Se llama cuando la enumeración de la historia principal de texto en una sección ha finalizado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| body | [Body](../../com.aspose.words/body/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de la historia principal de texto en una sección ha comenzado.
...
Se llama cuando se encuentra el final de un marcador en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| bookmarkEnd | [BookmarkEnd](../../com.aspose.words/bookmarkend/) | El objeto que está siendo visitado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| bookmarkStart | [BookmarkStart](../../com.aspose.words/bookmarkstart/) | El objeto que está siendo visitado. |
...
Nota: Un nodo de bloque de construcción y sus hijos no son visitados cuando ejecutas un Visitor sobre un [Document](../../com.aspose.words/document/). Si deseas ejecutar un Visitor sobre un bloque de construcción, necesitas ejecutar el visitante sobre [GlossaryDocument](../../com.aspose.words/glossarydocument/) o llamar a [BuildingBlock.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/buildingblock/\#accept-com.aspose.words.DocumentVisitor).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| block | [BuildingBlock](../../com.aspose.words/buildingblock/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una celda de tabla ha finalizado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| cell | [Cell](../../com.aspose.words/cell/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una celda de tabla ha comenzado.
...
Se llama cuando la enumeración de un texto de comentario ha finalizado.

 **Examples:** 

Muestra cómo imprimir la estructura de nodos de cada comentario y rango de comentario en un documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| comment | [Comment](../../com.aspose.words/comment/) | El objeto que está siendo visitado. |
...
Se llama cuando se encuentra el final de un rango de texto comentado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| commentRangeEnd | [CommentRangeEnd](../../com.aspose.words/commentrangeend/) | El objeto que está siendo visitado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| commentRangeStart | [CommentRangeStart](../../com.aspose.words/commentrangestart/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de un texto de comentario ha comenzado.
...
Se llama cuando la enumeración del documento ha finalizado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración del documento ha comenzado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| editableRangeEnd | [EditableRangeEnd](../../com.aspose.words/editablerangeend/) | El objeto que está siendo visitado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| editableRangeStart | [EditableRangeStart](../../com.aspose.words/editablerangestart/) | El objeto que está siendo visitado. |
...
Para más información, consulta [visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fieldEnd | [FieldEnd](../../com.aspose.words/fieldend/) | El objeto que está siendo visitado. |
...
El separador de campo separa el código del campo del valor del campo en el documento. Ten en cuenta que algunos campos solo tienen código de campo y no tienen separador de campo ni valor de campo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fieldSeparator | [FieldSeparator](../../com.aspose.words/fieldseparator/) | El objeto que está siendo visitado. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fieldStart | [FieldStart](../../com.aspose.words/fieldstart/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración del texto de una nota al pie o nota final ha terminado.

 **Examples:** 

Muestra cómo imprimir la estructura de nodos de cada nota al pie en un documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| footnote | [Footnote](../../com.aspose.words/footnote/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración del texto de una nota al pie o nota final ha comenzado.
...
Se llama cuando se encuentra un campo de formulario en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| formField | [FormField](../../com.aspose.words/formfield/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de un documento de glosario ha terminado.

 **Remarks:** 

Nota: Un nodo de documento de glosario y sus hijos no son visitados cuando ejecutas un Visitor sobre un [Document](../../com.aspose.words/document/). Si deseas ejecutar un Visitor sobre un documento de glosario, debes llamar a [GlossaryDocument.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/glossarydocument/\#accept-com.aspose.words.DocumentVisitor).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| glossary | [GlossaryDocument](../../com.aspose.words/glossarydocument/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una forma grupal ha terminado.

 **Examples:** 

Muestra cómo crear un grupo de formas y imprimir su contenido usando un document visitor.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| groupShape | [GroupShape](../../com.aspose.words/groupshape/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una forma grupal ha comenzado.
...
Se llama cuando la enumeración de un encabezado o pie de página en una sección ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| headerFooter | [HeaderFooter](../../com.aspose.words/headerfooter/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de un encabezado o pie de página en una sección ha comenzado.
...
Se llama cuando la enumeración de un objeto Office Math ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| officeMath | [OfficeMath](../../com.aspose.words/officemath/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de un objeto Office Math ha comenzado.
...
Se llama cuando la enumeración de un párrafo ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| paragraph | [Paragraph](../../com.aspose.words/paragraph/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de un párrafo ha comenzado.
...
Se llama cuando la enumeración de una fila de tabla ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| row | [Row](../../com.aspose.words/row/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una fila de tabla ha comenzado.
...
Se llama cuando se encuentra una secuencia de texto en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| run | [Run](../../com.aspose.words/run/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una sección ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| section | [Section](../../com.aspose.words/section/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una sección ha comenzado.
...
Se llama cuando la enumeración de una forma ha terminado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| shape | [Shape](../../com.aspose.words/shape/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una forma ha comenzado.
...
Se llama cuando la enumeración de una etiqueta inteligente ha finalizado.

 **Examples:** 

Muestra cómo imprimir la estructura de nodos de cada smart tag en un documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| smartTag | [SmartTag](../../com.aspose.words/smarttag/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una etiqueta inteligente ha comenzado.
...
Se llama cuando se encuentra un nodo [SpecialChar](../../com.aspose.words/specialchar/) en el documento.

 **Remarks:** 

Este método no debe ser llamado para caracteres de control genéricos (ver [ControlChar](../../com.aspose.words/controlchar/)) que pueden estar presentes en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| specialChar | [SpecialChar](../../com.aspose.words/specialchar/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una etiqueta de documento estructurado ha finalizado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| sdt | [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) | El objeto que está siendo visitado. |
...
Se llama cuando se encuentra un StructuredDocumentTagRangeStart.
...
Se llama cuando la enumeración de una etiqueta de documento estructurado ha comenzado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| subDocument | [SubDocument](../../com.aspose.words/subdocument/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una tabla ha finalizado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| table | [Table](../../com.aspose.words/table/) | El objeto que está siendo visitado. |
...
Se llama cuando la enumeración de una tabla ha comenzado.
