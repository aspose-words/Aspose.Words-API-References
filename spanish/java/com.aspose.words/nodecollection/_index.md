...
description: "Representa una colección de nodos de un tipo específico en Java."
type: docs
weight: 479
url: /es/java/com.aspose.words/nodecollection/
---
...
La colección [NodeCollection](../../com.aspose.words/nodecollection/) es "en vivo", es decir, los cambios en los hijos del objeto nodo del que se creó se reflejan inmediatamente en los nodos devueltos por las propiedades y métodos de [NodeCollection](../../com.aspose.words/nodecollection/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | Un índice dentro de la colección de nodos. |
