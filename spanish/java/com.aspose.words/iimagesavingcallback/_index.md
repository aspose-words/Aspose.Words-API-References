...
description: "Implemente esta interfaz si desea controlar cómo Aspose.Words guarda imágenes al guardar un documento en HTML en Java."
type: docs
weight: 773
url: /es/java/com.aspose.words/iimagesavingcallback/
---
```
...
Muestra cómo renombrar el nombre de la imagen al guardar en un documento Markdown.
...
| Método | Descripción |
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | Se llama cuando Aspose.Words guarda una imagen en HTML. |
...
Se llama cuando Aspose.Words guarda una imagen en HTML.
