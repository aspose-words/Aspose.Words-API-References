...
description: "Indica la versión de HTML que se utiliza al guardar el documento en los formatos SaveFormat.HTML y SaveFormat.MHTML en Java."
type: docs
weight: 386
url: /es/java/com.aspose.words/htmlversion/
---
...
Indica la versión de HTML que se utiliza al guardar el documento en los formatos [SaveFormat.HTML](../../com.aspose.words/saveformat/\\#HTML) y [SaveFormat.MHTML](../../com.aspose.words/saveformat/\\#MHTML).
...
// Nuestro documento solo contendrá un encabezado de declaración DOCTYPE si hemos establecido la bandera \"ExportXhtmlTransitional\" a \"true\".
