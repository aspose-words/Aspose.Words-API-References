...
description: "Denota el final de una región de texto que tiene un comentario asociado en Java."
type: docs
weight: 111
url: /es/java/com.aspose.words/commentrangeend/
---
...
Denota el final de una región de texto que tiene un comentario asociado.
...
| --- | --- |
| [CommentRangeEnd(DocumentBase doc, int id)](#CommentRangeEnd-com.aspose.words.DocumentBase-int) | Inicializa una nueva instancia de esta clase. |
## Métodos
...
| [getNodeType()](#getNodeType) | Devuelve [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). |
...
Cuando se crea [CommentRangeEnd](../../com.aspose.words/commentrangeend/), pertenece al documento especificado, pero aún no forma parte del documento y [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) es  null .

Para añadir un [CommentRangeEnd](../../com.aspose.words/commentrangeend/) al documento, usa InsertAfter o InsertBefore en el párrafo donde deseas insertar el comentario.
...
Llama a [DocumentVisitor.visitCommentRangeEnd(com.aspose.words.CommentRangeEnd)](../../com.aspose.words/documentvisitor/\#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd).
...
Devuelve [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
