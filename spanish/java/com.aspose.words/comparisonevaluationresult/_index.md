...
description: "El resultado de la evaluación de comparación en Java."
type: docs
weight: 116
url: /es/java/com.aspose.words/comparisonevaluationresult/
---
...
El resultado de la evaluación de la comparación.
...
| --- | --- |
| [ComparisonEvaluationResult(boolean result)](#ComparisonEvaluationResult-boolean) | Crea un resultado de evaluación de comparación. |
| [ComparisonEvaluationResult(String errorMessage)](#ComparisonEvaluationResult-java.lang.String) | Crea un resultado de evaluación de comparación fallido con el mensaje de error correspondiente. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getErrorMessage()](#getErrorMessage) | Obtiene el mensaje de error del resultado de evaluación de comparación fallido. |
| [getResult()](#getResult) | Obtiene el resultado de la evaluación de comparación. |
...
Obtiene el mensaje de error del resultado de evaluación de comparación fallido.
...
**Returns:**
java.lang.String - El mensaje de error del resultado de la evaluación de comparación fallida.
### getResult() {#getResult}
```
...
**Returns:**
boolean - El resultado de la evaluación de comparación.
