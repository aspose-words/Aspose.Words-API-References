...
description: "La expresión de comparación en Java."
type: docs
weight: 117
url: /es/java/com.aspose.words/comparisonexpression/
---
...
| [getLeftExpression()](#getLeftExpression) | Obtiene la expresión izquierda. |
| [getRightExpression()](#getRightExpression) | Obtiene la expresión derecha. |
...
**Returns:**
`java.lang.String` - La expresión izquierda.
...
**Returns:**
`java.lang.String` - La expresión derecha.
