...
description: "Implementa el campo PRIVATE en Java."
type: docs
weight: 275
url: /es/java/com.aspose.words/fieldprivate/
---
...
Implementa el campo PRIVATE.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Proporciona un área de almacenamiento privada. Este campo se usa para almacenar datos de documentos convertidos desde otros formatos de archivo.
