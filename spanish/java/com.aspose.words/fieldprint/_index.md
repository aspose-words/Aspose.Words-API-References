...
description: "Implementa el campo PRINT en Java."
type: docs
weight: 273
url: /es/java/com.aspose.words/fieldprint/
---
...
Una instrucción para enviar los caracteres de código de control específicos de la impresora a la impresora seleccionada cuando se imprime el documento.
...
| [getPostScriptGroup()](#getPostScriptGroup) | Obtiene el rectángulo de dibujo en el que operan las instrucciones PostScript. |
| [getPrinterInstructions()](#getPrinterInstructions) | Obtiene los caracteres de código de control específicos de la impresora o las instrucciones PostScript. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | Establece el rectángulo de dibujo en el que operan las instrucciones PostScript. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Establece los caracteres de código de control específicos de la impresora o las instrucciones PostScript. |
...
Obtiene el rectángulo de dibujo en el que operan las instrucciones PostScript.
...
**Returns:**
java.lang.String - El rectángulo de dibujo en el que operan las instrucciones PostScript.
...
Obtiene los caracteres de código de control específicos de la impresora o las instrucciones PostScript.
...
**Returns:**
java.lang.String - Los caracteres de código de control específicos de la impresora o las instrucciones PostScript.
### getResult() {#getResult}
```
...
```
public void setPostScriptGroup(String value)
```


Establece el rectángulo de dibujo en el que operan las instrucciones PostScript.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El rectángulo de dibujo en el que operan las instrucciones PostScript. |

### setPrinterInstructions(String value) {#setPrinterInstructions-java.lang.String}
```
public void setPrinterInstructions(String value)
```


Establece los caracteres de código de control específicos de la impresora o las instrucciones PostScript.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Los caracteres de código de control específicos de la impresora o las instrucciones PostScript. |
