...
description: "Especifica la galería predefinida en la que se clasifica un bloque de construcción en Java."
type: docs
weight: 55
url: /es/java/com.aspose.words/buildingblockgallery/
---
...
Especifica la galería predefinida en la que se clasifica un building block.

 **Remarks:** 

Corresponde al tipo **ST\_DocPartGallery** en OOXML.
...
| Campo | Descripción |
| --- | --- |
| [ALL](#ALL) | Especifica que esta entrada del documento de glosario debe estar asociada con todos los valores posibles de clasificación de la galería. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | Igual que [ALL](../../com.aspose.words/buildingblockgallery/\#ALL). |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
Especifica que esta entrada del documento de glosario debe estar asociada con todos los valores posibles de clasificación de la galería.
...
Igual que [ALL](../../com.aspose.words/buildingblockgallery/\#ALL).
