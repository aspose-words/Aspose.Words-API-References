...
description: "Implementa el campo COMMENTS en Java."
type: docs
weight: 213
url: /es/java/com.aspose.words/fieldcomments/
---
...
Implementa el campo COMMENTS.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, y opcionalmente establece, los comentarios relacionados con el documento actual, tal como se registran en la propiedad [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) de las propiedades de documento incorporadas.
...
| [getText()](#getText) | Obtiene el texto de los comentarios. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto de los comentarios. |
...
Obtiene el texto de los comentarios.
...
**Returns:**
java.lang.String - El texto de los comentarios.
### getType() {#getType}
```
public int getType()
```
...
Establece el texto de los comentarios.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto de los comentarios. |
