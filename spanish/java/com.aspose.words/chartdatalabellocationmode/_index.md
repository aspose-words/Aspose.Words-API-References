...
description: "Especifica cómo se interpretan en Java los valores u200bu200bque especifican la ubicación de una etiqueta de datos - las propiedades ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble y ChartDataLabel.getTop / ChartDataLabel.setTopdouble."
type: docs
weight: 73
url: /es/java/com.aspose.words/chartdatalabellocationmode/
---
...
Especifica cómo se interpretan los valores \\u200b\\u200bque especifican la ubicación de una etiqueta de datos - las propiedades [ChartDataLabel.getLeft()](../../com.aspose.words/chartdatalabel/#getLeft) / [ChartDataLabel.setLeft(double)](../../com.aspose.words/chartdatalabel/#setLeft-double) y [ChartDataLabel.getTop()](../../com.aspose.words/chartdatalabel/#getTop) / [ChartDataLabel.setTop(double)](../../com.aspose.words/chartdatalabel/#setTop-double).
...
| Campo | Descripción |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | La ubicación de una etiqueta de datos se especifica usando coordenadas absolutas, comenzando desde la esquina superior izquierda de un gráfico. |
| [OFFSET](#OFFSET) | La ubicación de una etiqueta de datos se especifica mediante un desplazamiento desde la posición definida por su propiedad [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int). |
| [length](#length) |  |
## Métodos
...
La ubicación de una etiqueta de datos se especifica usando coordenadas absolutas, comenzando desde la esquina superior izquierda de un gráfico.
...
La ubicación de una etiqueta de datos se especifica mediante un desplazamiento desde la posición definida por su propiedad [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/#setPosition-int).
