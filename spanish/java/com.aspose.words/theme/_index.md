...
description: "Representa el Theme del documento y proporciona acceso a las partes principales del tema, incluyendo getMajorFonts getMinorFonts y getColors en Java."
type: docs
weight: 682
url: /es/java/com.aspose.words/theme/
---
...
Representa el Theme del documento y proporciona acceso a las partes principales del tema, incluyendo [getMajorFonts()](../../com.aspose.words/theme/\#getMajorFonts), [getMinorFonts()](../../com.aspose.words/theme/\#getMinorFonts) y [getColors()](../../com.aspose.words/theme/\#getColors)
...
| Método | Descripción |
| --- | --- |
| [getColors()](#getColors) | Permite especificar el conjunto de colores del tema para el documento. |
| [getFontName(int themeFont)](#getFontName-int) |  |
| [getMajorFonts()](#getMajorFonts) | Permite especificar el conjunto de fuentes principales para diferentes idiomas. |
| [getMinorFonts()](#getMinorFonts) | Permite especificar el conjunto de fuentes secundarias para diferentes idiomas. |
| [onChange()](#onChange) |  |
### getColors() {#getColors}
```
