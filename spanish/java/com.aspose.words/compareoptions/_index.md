...
description: "Permite elegir opciones adicionales para la operación de comparación de documentos en Java."
type: docs
weight: 113
url: /es/java/com.aspose.words/compareoptions/
---
...
Para obtener más información, visite el artículo de documentación [ Compare Documents ][Compare Documents].
...
| --- | --- |
| [CompareOptions()](#CompareOptions) | Inicializa una nueva instancia de esta clase. |
## Métodos

| Método | Descripción |
| --- | --- |
| [getAdvancedOptions()](#getAdvancedOptions) | Especifica opciones avanzadas de comparación que pueden ayudar a producir una salida de comparación más precisa. |
| [getCompareMoves()](#getCompareMoves) | Especifica si se deben comparar las diferencias entre los dos documentos. |
| [getGranularity()](#getGranularity) | Especifica si los cambios se rastrean por carácter o por palabra. |
| [getIgnoreCaseChanges()](#getIgnoreCaseChanges) | True indica que la comparación de documentos no distingue entre mayúsculas y minúsculas. |
| [getIgnoreComments()](#getIgnoreComments) | Especifica si se deben comparar las diferencias en los comentarios. |
| [getIgnoreDmlUniqueId()](#getIgnoreDmlUniqueId) | Especifica si se debe ignorar la diferencia en el Id único de DrawingML. |
| [getIgnoreFields()](#getIgnoreFields) | Especifica si se deben comparar las diferencias en los campos. |
| [getIgnoreFootnotes()](#getIgnoreFootnotes) | Especifica si se deben comparar las diferencias en notas al pie y notas finales. |
| [getIgnoreFormatting()](#getIgnoreFormatting) | True indica que el formato se ignora. |
| [getIgnoreHeadersAndFooters()](#getIgnoreHeadersAndFooters) | True indica que el contenido de encabezados y pies de página se ignora. |
| [getIgnoreTables()](#getIgnoreTables) | Especifica si se deben comparar las diferencias en los datos contenidos en tablas. |
| [getIgnoreTextboxes()](#getIgnoreTextboxes) | Especifica si se deben comparar las diferencias en los datos contenidos dentro de cuadros de texto. |
| [getTarget()](#getTarget) | Especifica qué documento se debe usar como objetivo durante la comparación. |
| [setCompareMoves(boolean value)](#setCompareMoves-boolean) | Especifica si se deben comparar las diferencias entre los dos documentos. |
| [setGranularity(int value)](#setGranularity-int) | Especifica si los cambios se rastrean por carácter o por palabra. |
| [setIgnoreCaseChanges(boolean value)](#setIgnoreCaseChanges-boolean) | True indica que la comparación de documentos no distingue entre mayúsculas y minúsculas. |
| [setIgnoreComments(boolean value)](#setIgnoreComments-boolean) | Especifica si se deben comparar las diferencias en los comentarios. |
...
| [setIgnoreFields(boolean value)](#setIgnoreFields-boolean) | Especifica si se deben comparar las diferencias en los campos. |
| [setIgnoreFootnotes(boolean value)](#setIgnoreFootnotes-boolean) | Especifica si se deben comparar las diferencias en notas al pie y notas finales. |
| [setIgnoreFormatting(boolean value)](#setIgnoreFormatting-boolean) | True indica que el formato se ignora. |
| [setIgnoreHeadersAndFooters(boolean value)](#setIgnoreHeadersAndFooters-boolean) | True indica que el contenido de encabezados y pies de página se ignora. |
| [setIgnoreTables(boolean value)](#setIgnoreTables-boolean) | Especifica si se deben comparar las diferencias en los datos contenidos en tablas. |
| [setIgnoreTextboxes(boolean value)](#setIgnoreTextboxes-boolean) | Especifica si se deben comparar las diferencias en los datos contenidos dentro de cuadros de texto. |
| [setTarget(int value)](#setTarget-int) | Especifica qué documento se debe usar como objetivo durante la comparación. |
...
Por defecto, no se generan revisiones de movimiento.
...
El valor predeterminado es [Granularity.WORD\_LEVEL](../../com.aspose.words/granularity/\#WORD-LEVEL).
...
**Returns:**
int - El valor entero correspondiente. El valor devuelto es uno de los constantes de [Granularity](../../com.aspose.words/granularity/).
...
Por defecto, la comparación distingue entre mayúsculas y minúsculas.
...
Especifica si se deben comparar las diferencias en los comentarios.
...
Por defecto, el formato del documento no se ignora.
...
True indica que el contenido de encabezados y pies de página se ignora.

 **Remarks:** 

Por defecto, los encabezados y pies de página no se ignoran.
...
Especifica si se deben comparar las diferencias en los datos contenidos en tablas.
...
Especifica si se deben comparar las diferencias en los datos contenidos dentro de cuadros de texto.

 **Remarks:** 

Por defecto, los cuadros de texto no se ignoran.
...
**Returns:**
int - El valor entero correspondiente. El valor devuelto es uno de los constantes de [ComparisonTargetType](../../com.aspose.words/comparisontargettype/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El valor entero correspondiente. El valor debe ser uno de los constantes de [Granularity](../../com.aspose.words/granularity/). |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El valor entero correspondiente. El valor debe ser uno de los constantes de [ComparisonTargetType](../../com.aspose.words/comparisontargettype/). |
