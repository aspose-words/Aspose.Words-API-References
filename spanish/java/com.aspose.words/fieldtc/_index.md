...
description: "Implementa el campo TC en Java."
type: docs
weight: 293
url: /es/java/com.aspose.words/fieldtc/
---
...
Define el texto y el número de página para una entrada de tabla de contenido (incluyendo una tabla de figuras), que es utilizada por un campo TOC.
...
| [getEntryLevel()](#getEntryLevel) | Obtiene el nivel de la entrada. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | Obtiene si el número de página en el TOC debe omitirse para este campo. |
...
| [getText()](#getText) | Obtiene el texto de la entrada. |
| [getType()](#getType) | Obtiene el tipo de campo de Microsoft Word. |
| [getTypeIdentifier()](#getTypeIdentifier) | Obtiene un identificador de tipo para este campo (que típicamente es una letra). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Establece el nivel de la entrada. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Establece si el número de página en el TOC debe omitirse para este campo. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto de la entrada. |
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Establece un identificador de tipo para este campo (que típicamente es una letra). |
...
Obtiene el nivel de la entrada.
...
**Returns:**
java.lang.String - El nivel de la entrada.
...
Obtiene si el número de página en el TOC debe omitirse para este campo.
...
**Returns:**
boolean - Si el número de página en el TOC debe omitirse para este campo.
### getPageNumber() {#getPageNumber}
```
...
**Returns:**
java.lang.String - El texto de la entrada.
### getType() {#getType}
```
public int getType()
```
...
Obtiene un identificador de tipo para este campo (que típicamente es una letra).
...
**Returns:**
java.lang.String - Un identificador de tipo para este campo (que típicamente es una letra).
### hasBookmark() {#hasBookmark}
```
...
Establece el nivel de la entrada.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nivel de la entrada. |
...
Establece si el número de página en el TOC debe omitirse para este campo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si el número de página en el índice debe omitirse para este campo. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto de la entrada. |
...
Establece un identificador de tipo para este campo (que típicamente es una letra).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un identificador de tipo para este campo (que suele ser una letra). |
