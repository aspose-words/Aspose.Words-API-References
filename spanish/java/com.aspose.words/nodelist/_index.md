...
description: "Representa una colección de nodos que coinciden con una consulta XPath ejecutada usando el método CompositeNode.selectNodesjava.lang.String en Java."
type: docs
weight: 481
url: /es/java/com.aspose.words/nodelist/
---
...
Representa una colección de nodos que coinciden con una consulta XPath ejecutada usando el método [CompositeNode.selectNodes(java.lang.String)](../../com.aspose.words/compositenode/\#selectNodes-java.lang.String).
...
Trata la colección [NodeList](../../com.aspose.words/nodelist/) como una colección de "instantánea". [NodeList](../../com.aspose.words/nodelist/) comienza como una colección "en vivo" porque los nodos no se recuperan realmente cuando se ejecuta la consulta XPath. Los nodos solo se recuperan al acceder y en ese momento el nodo y todos los nodos que lo preceden se almacenan en caché formando una colección de "instantánea".
...
| Método | Descripción |
| --- | --- |
| [get(int index)](#get-int) | Recupera un nodo en el índice dado. |
| [getCount()](#getCount) | Obtiene el número de nodos en la lista. |
...
Muestra cómo usar XPaths para navegar un NodeList.
...
| --- | --- | --- |
| índice | int | Un índice en la lista de nodos. |
...
**Returns:**
com.aspose.words.Node[] - Una matriz de nodos.
