...
description: "Contiene los detalles para firmar un documento PDF con una firma digital en Java."
type: docs
weight: 531
url: /es/java/com.aspose.words/pdfdigitalsignaturedetails/
---
...
En este momento, firmar digitalmente documentos PDF solo está disponible en .NET 3.5 o superior.

Para firmar digitalmente un documento PDF cuando es creado por Aspose.Words, establezca la propiedad [PdfSaveOptions.getDigitalSignatureDetails()](../../com.aspose.words/pdfsaveoptions/\#getDigitalSignatureDetails) / [PdfSaveOptions.setDigitalSignatureDetails(com.aspose.words.PdfDigitalSignatureDetails)](../../com.aspose.words/pdfsaveoptions/\#setDigitalSignatureDetails-com.aspose.words.PdfDigitalSignatureDetails) a un objeto [PdfDigitalSignatureDetails](../../com.aspose.words/pdfdigitalsignaturedetails/) válido y luego guarde el documento en formato PDF pasando el [PdfSaveOptions](../../com.aspose.words/pdfsaveoptions/) como parámetro al método [Document.save(java.lang.String, com.aspose.words.SaveOptions)](../../com.aspose.words/document/\#save-java.lang.String--com.aspose.words.SaveOptions).
...
| [PdfDigitalSignatureDetails(CertificateHolder certificateHolder, String reason, String location, Date signatureDate)](#PdfDigitalSignatureDetails-com.aspose.words.CertificateHolder-java.lang.String-java.lang.String-java.util.Date) | Inicializa una instancia de esta clase. |
## Métodos
...
| [getHashAlgorithm()](#getHashAlgorithm) | Obtiene el algoritmo de hash. |
| [getLocation()](#getLocation) | Obtiene la ubicación de la firma. |
| [getReason()](#getReason) | Obtiene la razón de la firma. |
| [getSignatureDate()](#getSignatureDate) | Obtiene la fecha de la firma. |
| [getTimestampSettings()](#getTimestampSettings) | Obtiene la configuración de marca de tiempo de la firma digital. |
| [setCertificateHolder(CertificateHolder value)](#setCertificateHolder-com.aspose.words.CertificateHolder) | Devuelve el objeto titular del certificado que contiene el certificado utilizado para firmar el documento. |
| [setHashAlgorithm(int value)](#setHashAlgorithm-int) | Establece el algoritmo de hash. |
| [setLocation(String value)](#setLocation-java.lang.String) | Establece la ubicación de la firma. |
| [setReason(String value)](#setReason-java.lang.String) | Establece la razón de la firma. |
| [setSignatureDate(Date value)](#setSignatureDate-java.util.Date) | Establece la fecha de la firma. |
| [setTimestampSettings(PdfDigitalSignatureTimestampSettings value)](#setTimestampSettings-com.aspose.words.PdfDigitalSignatureTimestampSettings) | Establece la configuración de marca de tiempo de la firma digital. |
...
| razón | java.lang.String | La razón de la firma. |
| ubicación | java.lang.String | La ubicación de la firma. |
| signatureDate | java.util.Date | La fecha y hora de la firma. |
...
**Returns:**
`int` - El algoritmo hash. El valor devuelto es una de las constantes [PdfDigitalSignatureHashAlgorithm](../../com.aspose.words/pdfdigitalsignaturehashalgorithm/).
...
Obtiene la ubicación de la firma.
...
**Returns:**
`java.lang.String` - La ubicación de la firma.
### getReason() {#getReason}
```
...
**Returns:**
`java.lang.String` - La razón de la firma.
...
**Returns:**
`java.util.Date` - La fecha de la firma.
...
Obtiene la configuración de marca de tiempo de la firma digital.

 **Remarks:** 

El valor predeterminado es  null  y la firma digital no tendrá sello de tiempo. Cuando esta propiedad se establece en un objeto válido [PdfDigitalSignatureTimestampSettings](../../com.aspose.words/pdfdigitalsignaturetimestampsettings/), la firma digital en el documento PDF tendrá sello de tiempo.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | [CertificateHolder](../../com.aspose.words/certificateholder/) | El objeto titular del certificado que contiene el certificado se utilizó para firmar el documento. |
...
Establece el algoritmo de hash.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El algoritmo hash. El valor debe ser una de las constantes [PdfDigitalSignatureHashAlgorithm](../../com.aspose.words/pdfdigitalsignaturehashalgorithm/). |
...
Establece la ubicación de la firma.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La ubicación de la firma. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La razón de la firma. |
...
Establece la fecha de la firma.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.util.Date | La fecha de la firma. |
...
Establece la configuración de marca de tiempo de la firma digital.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | [PdfDigitalSignatureTimestampSettings](../../com.aspose.words/pdfdigitalsignaturetimestampsettings/) | La configuración del sello de tiempo de la firma digital. |
