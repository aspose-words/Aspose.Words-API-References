...
description: "Implementa el campo MERGEFIELD en Java."
type: docs
weight: 258
url: /es/java/com.aspose.words/fieldmergefield/
---
...
Muestra cómo usar campos MERGEFIELD para realizar una combinación de correspondencia.
...
| [getFieldName()](#getFieldName) | Obtiene el nombre de un campo de datos. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | Devuelve solo el nombre del campo de datos. |
...
| [getTextAfter()](#getTextAfter) | Obtiene el texto que se insertará después del campo si el campo no está vacío. |
| [getTextBefore()](#getTextBefore) | Obtiene el texto que se insertará antes del campo si el campo no está vacío. |
...
| [isMapped()](#isMapped) | Obtiene si este campo es un campo mapeado. |
| [isMapped(boolean value)](#isMapped-boolean) | Establece si este campo es un campo mapeado. |
| [isVerticalFormatting()](#isVerticalFormatting) | Obtiene si se debe habilitar la conversión de caracteres para el formato vertical. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | Establece si se debe habilitar la conversión de caracteres para el formato vertical. |
| [remove()](#remove) | Elimina el campo del documento. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | Establece el nombre de un campo de datos. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | Establece el texto que se insertará después del campo si el campo no está vacío. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | Establece el texto que se insertará antes del campo si el campo no está vacío. |
...
Obtiene el nombre de un campo de datos.
...
**Returns:**
java.lang.String - El nombre de un campo de datos.
...
Devuelve solo el nombre del campo de datos. Cualquier prefijo se elimina en la propiedad prefix.
...
**Returns:**
java.lang.String - Solo el nombre del campo de datos.
### getFormat() {#getFormat}
```
...
Obtiene el texto que se insertará después del campo si el campo no está vacío.
...
**Returns:**
java.lang.String - El texto que se insertará después del campo si el campo no está vacío.
...
Obtiene el texto que se insertará antes del campo si el campo no está vacío.
...
**Returns:**
java.lang.String - El texto que se insertará antes del campo si el campo no está vacío.
### getType() {#getType}
```
public int getType()
```
...
Obtiene si este campo es un campo mapeado.
...
**Returns:**
boolean - Si este campo es un campo mapeado.
...
Establece si este campo es un campo mapeado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si este campo es un campo mapeado. |
...
Obtiene si se debe habilitar la conversión de caracteres para el formato vertical.
...
**Returns:**
boolean - Si se debe habilitar la conversión de caracteres para el formato vertical.
...
Establece si se debe habilitar la conversión de caracteres para el formato vertical.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si se debe habilitar la conversión de caracteres para el formato vertical. |
...
Establece el nombre de un campo de datos.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de un campo de datos. |
...
Establece el texto que se insertará después del campo si el campo no está vacío.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto que se insertará después del campo si el campo no está vacío. |
...
Establece el texto que se insertará antes del campo si el campo no está vacío.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto que se insertará antes del campo si el campo no está vacío. |
