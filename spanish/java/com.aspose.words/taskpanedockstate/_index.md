...
description: "Enumera las ubicaciones disponibles del objeto panel de tareas en Java."
type: docs
weight: 665
url: /es/java/com.aspose.words/taskpanedockstate/
---
...
Enumera las ubicaciones disponibles del objeto de panel de tareas.
...
| Campo | Descripción |
| --- | --- |
| [LEFT](#LEFT) | Ancla el panel de tareas en el lado izquierdo de la ventana del documento. |
| [RIGHT](#RIGHT) | Ancla el panel de tareas en el lado derecho de la ventana del documento. |
| [length](#length) |  |
## Métodos
...
Ancla el panel de tareas en el lado izquierdo de la ventana del documento.
...
Ancla el panel de tareas en el lado derecho de la ventana del documento.
