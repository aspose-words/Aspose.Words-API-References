...
description: "Representa una parte de almacenamiento de datos XML personalizada Custom XML Data Storage Part dentro de un paquete en Java."
type: docs
weight: 143
url: /es/java/com.aspose.words/customxmlpart/
---
...
Representa una Custom XML Data Storage Part (datos XML personalizados dentro de un paquete).
...
Un documento DOCX o DOC puede contener una o más partes de almacenamiento de datos XML personalizados. Aspose.Words conserva y permite crear y extraer datos XML personalizados a través de la colección [Document.getCustomXmlParts()](../../com.aspose.words/document/\#getCustomXmlParts) / [Document.setCustomXmlParts(com.aspose.words.CustomXmlPartCollection)](../../com.aspose.words/document/\#setCustomXmlParts-com.aspose.words.CustomXmlPartCollection).
...
| [getData()](#getData) | Obtiene el contenido XML de esta parte de almacenamiento de datos XML personalizada. |
| [getDataChecksum()](#getDataChecksum) | Especifica una suma de verificación de redundancia cíclica (CRC) del contenido de [getData()](../../com.aspose.words/customxmlpart/\#getData) / [setData(byte[])](../../com.aspose.words/customxmlpart/\#setData-byte). |
| [getId()](#getId) | Obtiene la cadena que identifica esta parte XML personalizada dentro de un documento OOXML. |
| [getSchemas()](#getSchemas) | Especifica el conjunto de esquemas XML que están asociados con esta parte XML personalizada. |
| [setData(byte[] value)](#setData-byte) | Establece el contenido XML de esta parte de almacenamiento de datos XML personalizada. |
| [setId(String value)](#setId-java.lang.String) | Establece la cadena que identifica esta parte XML personalizada dentro de un documento OOXML. |
### deepClone() {#deepClone}
```
...
Crea una copia "suficientemente profunda" del objeto. No duplica los bytes del valor de [getData()](../../com.aspose.words/customxmlpart/\#getData) / [setData(byte[])](../../com.aspose.words/customxmlpart/\#setData-byte).
...
Obtiene el contenido XML de esta parte de almacenamiento de datos XML personalizada.
...
**Returns:**
byte[] - El contenido XML de esta parte de almacenamiento de datos XML personalizada.
...
Especifica una suma de verificación de redundancia cíclica (CRC) del contenido de [getData()](../../com.aspose.words/customxmlpart/\#getData) / [setData(byte[])](../../com.aspose.words/customxmlpart/\#setData-byte).
...
**Returns:**
java.lang.String - La cadena que identifica esta parte XML personalizada dentro de un documento OOXML.
...
Especifica el conjunto de esquemas XML que están asociados con esta parte XML personalizada.
...
Establece el contenido XML de esta parte de almacenamiento de datos XML personalizada.
...
| --- | --- | --- |
| valor | byte[] | El contenido XML de esta parte de almacenamiento de datos XML personalizada. |
...
Establece la cadena que identifica esta parte XML personalizada dentro de un documento OOXML.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La cadena que identifica esta parte XML personalizada dentro de un documento OOXML. |
