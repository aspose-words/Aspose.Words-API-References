...
description: "El control CommandButton ejecuta una macro que realiza una acción cuando el usuario hace clic en él en Java."
type: docs
weight: 107
url: /es/java/com.aspose.words/commandbuttoncontrol/
---
...
El control CommandButton ejecuta una macro que realiza una acción cuando el usuario hace clic en él.
...
| --- | --- |
| [CommandButtonControl()](#CommandButtonControl) | Inicializa una nueva instancia de la clase [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/). |
## Métodos
...
Inicializa una nueva instancia de la clase [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/).
