...
description: "Cuando se implementa, proporciona un objeto CultureInfo que debe usarse durante la actualización de un campo particular en Java."
type: docs
weight: 767
url: /es/java/com.aspose.words/ifieldupdatecultureprovider/
---
```
public interface IFieldUpdateCultureProvider
```

Cuando se implementa, proporciona un [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) objeto que debe usarse durante la actualización de un campo particular.
...
| Método | Descripción |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | Devuelve un [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) objeto que se usará durante la actualización del campo. |
...
Devuelve un [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) objeto que se usará durante la actualización del campo.
...
| --- | --- | --- |
| cultura | java.lang.String | El nombre de la cultura solicitada para el campo que se está actualizando. |
| field | [Field](../../com.aspose.words/field/) | El campo que se está actualizando. |
