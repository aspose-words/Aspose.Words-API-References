...
description: "Proporciona acceso tipado a una colección de nodos Paragraph en Java."
type: docs
weight: 524
url: /es/java/com.aspose.words/paragraphcollection/
---
...
Proporciona acceso tipado a una colección de nodos [Paragraph](../../com.aspose.words/paragraph/).
...
| [get(int index)](#get-int) | Recupera un [Paragraph](../../com.aspose.words/paragraph/) en el índice dado. |
...
Recupera un [Paragraph](../../com.aspose.words/paragraph/) en el índice dado.
...
Muestra cómo crear una matriz a partir de un NodeCollection.
...
**Returns:**
com.aspose.words.Node[] - Una matriz de párrafos.
