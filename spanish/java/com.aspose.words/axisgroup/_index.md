...
description: "Representa un tipo de grupo de ejes de gráfico en Java."
type: docs
weight: 27
url: /es/java/com.aspose.words/axisgroup/
---
...
Representa un tipo de grupo de ejes de gráfico.
...
| Campo | Descripción |
| --- | --- |
| [PRIMARY](#PRIMARY) | Especifica el grupo de ejes primario. |
| [SECONDARY](#SECONDARY) | Especifica el grupo de ejes secundario. |
| [length](#length) |  |
## Métodos
...
Especifica el grupo de ejes primario.
...
Especifica el grupo de ejes secundario.
