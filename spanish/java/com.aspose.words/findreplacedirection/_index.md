...
description: "Especifica la dirección para las operaciones de reemplazo en Java."
type: docs
weight: 313
url: /es/java/com.aspose.words/findreplacedirection/
---
...
Especifica la dirección para operaciones de reemplazo.
...
| Campo | Descripción |
| --- | --- |
| [BACKWARD](#BACKWARD) | Los elementos coincidentes se reemplazan del último al primero. |
| [FORWARD](#FORWARD) | Los elementos coincidentes se reemplazan del primero al último. |
| [length](#length) |  |
## Métodos
...
Los elementos coincidentes se reemplazan del último al primero.
...
Los elementos coincidentes se reemplazan del primero al último.
