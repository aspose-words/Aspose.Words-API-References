...
description: "Implementa el campo AUTOTEXTLIST en Java."
type: docs
weight: 205
url: /es/java/com.aspose.words/fieldautotextlist/
---
...
Crea un menú contextual basado en entradas AutoText en la plantilla activa.

 **Examples:** 

Muestra cómo usar un campo AUTOTEXTLIST para seleccionar de una lista de entradas AutoText.
...
| [getListStyle()](#getListStyle) | Obtiene el nombre del estilo en el que se basa la lista que contiene entradas. |
...
| [getScreenTip()](#getScreenTip) | Obtiene el texto del ScreenTip a mostrar. |
...
| [setListStyle(String value)](#setListStyle-java.lang.String) | Establece el nombre del estilo en el que se basa la lista que contiene entradas. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Establece el texto del ScreenTip a mostrar. |
...
Obtiene el nombre del estilo en el que se basa la lista que contiene entradas.
...
**Returns:**
java.lang.String - El nombre del estilo en el que se basa la lista que contiene entradas.
...
Obtiene el texto del ScreenTip a mostrar.
...
**Returns:**
java.lang.String - El texto del ScreenTip a mostrar.
...
Establece el nombre del estilo en el que se basa la lista que contiene entradas.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre del estilo en el que se basa la lista que contiene entradas. |
...
Establece el texto del ScreenTip a mostrar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto del ScreenTip a mostrar. |
