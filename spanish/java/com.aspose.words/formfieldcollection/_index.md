...
description: "Una colección de objetos FormField que representan todos los campos de formulario en un rango en Java."
type: docs
weight: 348
url: /es/java/com.aspose.words/formfieldcollection/
---
...
Una colección de objetos [FormField](../../com.aspose.words/formfield/) que representan todos los campos de formulario en un rango.
...
| [get(int index)](#get-int) | Devuelve un campo de formulario en el índice especificado. |
| [get(String bookmarkName)](#get-java.lang.String) | Devuelve un campo de formulario por nombre de marcador. |
| [getCount()](#getCount) | Devuelve el número de campos de formulario en la colección. |
| [iterator()](#iterator) | Devuelve un objeto enumerador. |
| [remove(String formField)](#remove-java.lang.String) | Elimina un campo de formulario con el nombre especificado. |
| [removeAt(int index)](#removeAt-int) | Elimina un campo de formulario en el índice especificado. |
### clear() {#clear}
```
public void clear()
```
...
Devuelve  null  si no se puede encontrar el campo de formulario con el nombre de marcador especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| bookmarkName | java.lang.String | Nombre de marcador que no distingue entre mayúsculas y minúsculas. |
...
**Returns:**
int - El número de campos de formulario en la colección.
### iterator() {#iterator}
```
...
Elimina un campo de formulario con el nombre especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| formField | java.lang.String | El nombre del campo de formulario que no distingue entre mayúsculas y minúsculas a eliminar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | El índice basado en cero del campo de formulario a eliminar. |
