...
description: "Representa las propiedades de series de gráficos en Java."
type: docs
weight: 85
url: /es/java/com.aspose.words/chartseries/
---
...
Representa las propiedades de la serie del gráfico.
...
| Método | Descripción |
| --- | --- |
| [add(ChartXValue xValue)](#add-com.aspose.words.ChartXValue) | Agrega el valor X especificado a la serie del gráfico. |
| [add(ChartXValue xValue, ChartYValue yValue)](#add-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue) | Agrega los valores X y Y especificados a la serie del gráfico. |
| [add(ChartXValue xValue, ChartYValue yValue, double bubbleSize)](#add-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue-double) | Agrega el valor X especificado, el valor Y y el tamaño de burbuja a la serie del gráfico. |
| [clear()](#clear) | Elimina todos los valores de datos de la serie del gráfico. |
| [clearValues()](#clearValues) | Elimina todos los valores de datos de la serie del gráfico preservando el formato de los puntos de datos y las etiquetas de datos. |
| [copyFormatFrom(int dataPointIndex)](#copyFormatFrom-int) | Copia el formato predeterminado del punto de datos del punto de datos con el índice especificado. |
| [getBubble3D()](#getBubble3D) | Especifica si las burbujas en el gráfico de burbujas deben tener un efecto 3D aplicado. |
| [getBubbleSizes()](#getBubbleSizes) | Obtiene una colección de tamaños de burbujas para esta serie del gráfico. |
| [getDataLabels()](#getDataLabels) | Especifica la configuración de las etiquetas de datos para toda la serie. |
| [getDataPoints()](#getDataPoints) | Devuelve una colección de objetos de formato para todos los puntos de datos en esta serie. |
| [getExplosion()](#getExplosion) | Especifica la cantidad que el punto de datos debe desplazarse desde el centro del pastel. |
| [getFormat()](#getFormat) | Proporciona acceso al formato de relleno y línea de la serie. |
...
| [getLegendEntry()](#getLegendEntry) | Obtiene una entrada de leyenda para esta serie del gráfico. |
| [getMarker()](#getMarker) | Especifica un marcador de datos. |
| [getName()](#getName) | Obtiene el nombre de la serie; si el nombre no se establece explícitamente, se genera usando el índice. |
| [getSeriesType()](#getSeriesType) | Obtiene el tipo de esta serie del gráfico. |
| [getSmooth()](#getSmooth) | Permite especificar si la línea que conecta los puntos en el gráfico debe suavizarse usando splines Catmull-Rom. |
| [getXValues()](#getXValues) | Obtiene una colección de valores X para esta serie del gráfico. |
| [getYValues()](#getYValues) | Obtiene una colección de valores Y para esta serie del gráfico. |
| [hasDataLabels()](#hasDataLabels) | Obtiene una bandera que indica si las etiquetas de datos se muestran para la serie. |
| [hasDataLabels(boolean value)](#hasDataLabels-boolean) | Establece una bandera que indica si las etiquetas de datos se muestran para la serie. |
| [insert(int index, ChartXValue xValue)](#insert-int-com.aspose.words.ChartXValue) | Inserta el valor X especificado en la serie del gráfico en el índice especificado. |
| [insert(int index, ChartXValue xValue, ChartYValue yValue)](#insert-int-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue) | Inserta los valores X y Y especificados en la serie del gráfico en el índice especificado. |
| [insert(int index, ChartXValue xValue, ChartYValue yValue, double bubbleSize)](#insert-int-com.aspose.words.ChartXValue-com.aspose.words.ChartYValue-double) | Inserta el valor X especificado, el valor Y y el tamaño de burbuja en la serie del gráfico en el índice especificado. |
| [remove(int index)](#remove-int) | Elimina el valor X, el valor Y y el tamaño de burbuja, si es compatible, de la serie del gráfico en el índice especificado. |
...
| [setName(String value)](#setName-java.lang.String) | Establece el nombre de la serie; si el nombre no se establece explícitamente, se genera usando el índice. |
| [setSmooth(boolean value)](#setSmooth-boolean) | Permite especificar si la línea que conecta los puntos en el gráfico debe suavizarse usando splines Catmull-Rom. |
...
Agrega el valor X especificado, el valor Y y el tamaño de burbuja a la serie del gráfico.
...
Elimina todos los valores de datos de la serie del gráfico preservando el formato de los puntos de datos y las etiquetas de datos.
...
Especifica la configuración de las etiquetas de datos para toda la serie.
...
Devuelve una colección de objetos de formato para todos los puntos de datos en esta serie.
...
Obtiene una entrada de leyenda para esta serie del gráfico.
...
Obtiene el nombre de la serie; si el nombre no se establece explícitamente, se genera usando el índice. Por defecto devuelve Serie más un índice basado en uno.
...
**Returns:**
java.lang.String - El nombre de la serie, si el nombre no se establece explícitamente se genera usando el índice.
...
Obtiene el tipo de esta serie del gráfico.
...
**Returns:**
int - El tipo de esta serie de gráfico. El valor devuelto es una de las constantes [ChartSeriesType](../../com.aspose.words/chartseriestype/).
### getSmooth() {#getSmooth}
```
...
Permite especificar si la línea que conecta los puntos en el gráfico debe suavizarse usando splines Catmull-Rom.
...
Obtiene una colección de valores X para esta serie del gráfico.
...
Obtiene una colección de valores Y para esta serie del gráfico.
...
Obtiene una bandera que indica si las etiquetas de datos se muestran para la serie.
...
**Returns:**
boolean - Un indicador que muestra si las etiquetas de datos se muestran para la serie.
...
Establece una bandera que indica si las etiquetas de datos se muestran para la serie.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Un indicador que muestra si las etiquetas de datos se muestran para la serie. |
...
El punto de datos correspondiente con formato predeterminado se insertará en la colección de puntos de datos. Y, si se muestran las etiquetas de datos, también se insertará la etiqueta de datos correspondiente con formato predeterminado.

 **Examples:** 

Muestra cómo insertar datos en una serie de gráfico.
...
Inserta los valores X y Y especificados en la serie del gráfico en el índice especificado.
...
Inserta el valor X especificado, el valor Y y el tamaño de burbuja en la serie del gráfico en el índice especificado.
...
Elimina el valor X, el valor Y y el tamaño de burbuja, si es compatible, de la serie de gráfico en el índice especificado. El punto de datos y la etiqueta de datos correspondientes también se eliminan.
...
Establece el nombre de la serie; si el nombre no se establece explícitamente, se genera usando el índice. Por defecto, devuelve Series más un índice basado en uno.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de la serie; si el nombre no se establece explícitamente, se genera usando el índice. |
