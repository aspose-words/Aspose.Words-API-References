...
description: "Representa una revisión (cambio rastreado) en un nodo o estilo de documento en Java."
type: docs
weight: 579
url: /es/java/com.aspose.words/revision/
---
...
Representa una revisión (cambio rastreado) en un nodo o estilo de documento. Use [getRevisionType()](../../com.aspose.words/revision/\#getRevisionType) para verificar el tipo de esta revisión.
...
| [getAuthor()](#getAuthor) | Obtiene el autor de esta revisión. |
| [getDateTime()](#getDateTime) | Obtiene la fecha/hora de esta revisión. |
| [getGroup()](#getGroup) | Obtiene el grupo de revisión. |
| [getParentNode()](#getParentNode) | Obtiene el nodo padre inmediato (propietario) de esta revisión. |
| [getParentStyle()](#getParentStyle) | Obtiene el estilo padre inmediato (propietario) de esta revisión. |
| [getRevisionType()](#getRevisionType) | Obtiene el tipo de esta revisión. |
| [reject()](#reject) | Rechaza esta revisión. |
| [setAuthor(String value)](#setAuthor-java.lang.String) | Establece el autor de esta revisión. |
| [setDateTime(Date value)](#setDateTime-java.util.Date) | Establece la fecha/hora de esta revisión. |
### accept() {#accept}
```
public void accept()
```
...
Obtiene el autor de esta revisión. No puede ser una cadena vacía o  null .
...
**Returns:**
java.lang.String - El autor de esta revisión.
...
Obtiene la fecha/hora de esta revisión.
...
**Returns:**
java.util.Date - La fecha/hora de esta revisión.
### getGroup() {#getGroup}
```
...
La revisión no tiene grupo si el tipo de revisión es [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) o si la revisión ya no existe en el contexto del documento (aceptada/rechazada).
...
Obtiene el nodo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará para cualquier tipo de revisión que no sea [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Si esta revisión se relaciona con un cambio de formato de Estilo, use [getParentStyle()](../../com.aspose.words/revision/\#getParentStyle) en su lugar.
...
Obtiene el estilo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará solo para el tipo de revisión [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Si esta revisión se relaciona con cambios en los nodos del documento, use [getParentNode()](../../com.aspose.words/revision/\#getParentNode) en su lugar.
...
Obtiene el tipo de esta revisión.
...
**Returns:**
int - El tipo de esta revisión. El valor devuelto es una de las constantes de [RevisionType](../../com.aspose.words/revisiontype/).
### reject() {#reject}
```
public void reject()
```
...
Establece el autor de esta revisión. No puede ser una cadena vacía o  null .
...
| --- | --- | --- |
| valor | java.lang.String | El autor de esta revisión. |
...
Establece la fecha/hora de esta revisión.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.util.Date | La fecha/hora de esta revisión. |
