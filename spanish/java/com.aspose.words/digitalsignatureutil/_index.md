...
description: "Proporciona métodos para firmar documentos en Java."
type: docs
weight: 154
url: /es/java/com.aspose.words/digitalsignatureutil/
---
...
Proporciona métodos para firmar el documento.
...
Dado que la firma digital funciona con el contenido del archivo en lugar del Modelo de Objeto de Documento, estos métodos se colocan en una clase separada.

Los formatos compatibles son: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
| [loadSignatures(String fileName)](#loadSignatures-java.lang.String) | Carga firmas digitales del documento. |
...
| [removeAllSignatures(String srcFileName, String dstFileName)](#removeAllSignatures-java.lang.String-java.lang.String) | Elimina todas las firmas digitales del archivo de origen y escribe el archivo sin firmar en el archivo de destino. |
...
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder) | Firma el documento de origen usando el [CertificateHolder](../../com.aspose.words/certificateholder/) proporcionado con firma digital y escribe el documento firmado en el archivo de destino. |
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder, SignOptions signOptions)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder-com.aspose.words.SignOptions) | Firma el documento de origen usando el [CertificateHolder](../../com.aspose.words/certificateholder/) y [SignOptions](../../com.aspose.words/signoptions/) proporcionados con firma digital y escribe el documento firmado en el archivo de destino. |
### loadSignatures(InputStream stream) {#loadSignatures-java.io.InputStream}
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| fileName | java.lang.String | Ruta al documento. |
...
Los siguientes formatos son compatibles para la eliminación de firmas digitales: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
Firma el documento de origen usando el [CertificateHolder](../../com.aspose.words/certificateholder/) proporcionado con firma digital y escribe el documento firmado en el archivo de destino.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| srcFileName | java.lang.String | El nombre de archivo del documento a firmar. |
| dstFileName | java.lang.String | El nombre de archivo del documento firmado de salida. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | Objeto [CertificateHolder](../../com.aspose.words/certificateholder/) con el certificado que se utilizó para firmar el archivo. |
...
Firma el documento de origen usando el [CertificateHolder](../../com.aspose.words/certificateholder/) y [SignOptions](../../com.aspose.words/signoptions/) proporcionados con firma digital y escribe el documento firmado en el archivo de destino.
...
| dstFileName | java.lang.String | El nombre de archivo del documento firmado de salida. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | Objeto [CertificateHolder](../../com.aspose.words/certificateholder/) con el certificado que se utilizó para firmar el archivo. |
| signOptions | [SignOptions](../../com.aspose.words/signoptions/) | Objeto [SignOptions](../../com.aspose.words/signoptions/) con varias opciones de firma. |
