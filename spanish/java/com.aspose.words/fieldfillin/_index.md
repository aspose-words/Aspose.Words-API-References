...
description: "Implementa el campo FILLIN en Java."
type: docs
weight: 232
url: /es/java/com.aspose.words/fieldfillin/
---
...
Muestra cómo usar el campo FILLIN para solicitar al usuario una respuesta.
...
| Método | Descripción |
| --- | --- |
| [getDefaultResponse()](#getDefaultResponse) | Obtiene la respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | Obtiene si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia. |
| [getPromptText()](#getPromptText) | Obtiene el texto del mensaje (el título de la ventana de solicitud). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | Establece la respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud). |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | Establece si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | Establece el texto del mensaje (el título de la ventana de solicitud). |
...
Obtiene la respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud).
...
**Returns:**
java.lang.String - Respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud).
...
Obtiene si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia.
...
**Returns:**
boolean - Si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia.
...
Obtiene el texto del mensaje (el título de la ventana de solicitud).
...
**Returns:**
java.lang.String - El texto del mensaje (el título de la ventana de solicitud).
### getResult() {#getResult}
```
...
Establece la respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Respuesta predeterminada del usuario (valor inicial contenido en la ventana de solicitud). |
...
Establece si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si la respuesta del usuario debe recibirse una vez por operación de combinación de correspondencia. |
...
Establece el texto del mensaje (el título de la ventana de solicitud).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto del mensaje (el título de la ventana de solicitud). |
