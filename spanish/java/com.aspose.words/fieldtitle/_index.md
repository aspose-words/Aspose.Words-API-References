...
description: "Implementa el campo TITLE en Java."
type: docs
weight: 296
url: /es/java/com.aspose.words/fieldtitle/
---
...
Implementa el campo TITLE.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, y opcionalmente establece, el título del documento, tal como se registra en la propiedad **Title** de las propiedades integradas del documento.
...
| [getText()](#getText) | Obtiene el texto del título. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto del título. |
...
**Returns:**
java.lang.String - El texto del título.
### getType() {#getType}
```
public int getType()
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto del título. |
