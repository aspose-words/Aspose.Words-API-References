...
description: "Una colección de propiedades de documento personalizadas en Java."
type: docs
weight: 140
url: /es/java/com.aspose.words/customdocumentproperties/
---
...
Cada objeto [DocumentProperty](../../com.aspose.words/documentproperty/) representa una propiedad personalizada de un documento contenedor.
...
| Método | Descripción |
| --- | --- |
| [add(String name, boolean value)](#add-java.lang.String-boolean) | Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.BOOLEAN](../../com.aspose.words/propertytype/\#BOOLEAN). |
| [add(String name, double value)](#add-java.lang.String-double) | Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.DOUBLE](../../com.aspose.words/propertytype/\#DOUBLE). |
| [add(String name, int value)](#add-java.lang.String-int) | Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.NUMBER](../../com.aspose.words/propertytype/\#NUMBER). |
| [add(String name, String value)](#add-java.lang.String-java.lang.String) | Crea una nueva propiedad de documento personalizada. |
| [add(String name, Date value)](#add-java.lang.String-java.util.Date) | Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.DATE\_TIME](../../com.aspose.words/propertytype/\#DATE-TIME). |
| [addLinkToContent(String name, String linkSource)](#addLinkToContent-java.lang.String-java.lang.String) | Crea una nueva propiedad de documento personalizada vinculada al contenido. |
...
Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.BOOLEAN](../../com.aspose.words/propertytype/\#BOOLEAN).
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| valor | boolean | El valor de la propiedad. |
...
Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.DOUBLE](../../com.aspose.words/propertytype/\#DOUBLE).
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| valor | double | El valor de la propiedad. |
...
Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.NUMBER](../../com.aspose.words/propertytype/\#NUMBER).
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| valor | int | El valor de la propiedad. |
...
Crea una nueva propiedad de documento personalizada.  Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.STRING](../../com.aspose.words/propertytype/\#STRING).
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| valor | java.lang.String | El valor de la propiedad. |
...
Crea una nueva propiedad de documento personalizada del tipo de datos [PropertyType.DATE\_TIME](../../com.aspose.words/propertytype/\#DATE-TIME).
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| valor | java.util.Date | El valor de la propiedad. |
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre de la propiedad. |
| linkSource | java.lang.String | El origen de la propiedad. |
...
Proporciona acceso a los elementos de la colección.  Devuelve un objeto [DocumentProperty](../../com.aspose.words/documentproperty/) por el nombre de la propiedad.
