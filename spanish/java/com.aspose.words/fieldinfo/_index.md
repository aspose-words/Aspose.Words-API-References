...
description: "Implementa el campo INFO en Java."
type: docs
weight: 251
url: /es/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Obtiene el tipo de la propiedad del documento a insertar. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getNewValue()](#getNewValue) | Obtiene un valor opcional que actualiza la propiedad. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Establece el tipo de la propiedad del documento a insertar. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Establece un valor opcional que actualiza la propiedad. |
...
Obtiene el tipo de la propiedad del documento a insertar.
...
**Returns:**
java.lang.String - El tipo de la propiedad del documento a insertar.
...
Obtiene un valor opcional que actualiza la propiedad.
...
**Returns:**
java.lang.String - Un valor opcional que actualiza la propiedad.
### getResult() {#getResult}
```
...
### setInfoType(String value) {#setInfoType-java.lang.String}
```
public void setInfoType(String value)
```


Establece el tipo de la propiedad del documento a insertar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El tipo de la propiedad del documento a insertar. |
...
### setNewValue(String value) {#setNewValue-java.lang.String}
```
public void setNewValue(String value)
```


Establece un valor opcional que actualiza la propiedad.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un valor opcional que actualiza la propiedad. |
