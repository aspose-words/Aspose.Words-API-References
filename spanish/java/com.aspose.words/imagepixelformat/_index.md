...
description: "Especifica el formato de píxel para las imágenes generadas de las páginas del documento en Java."
type: docs
weight: 393
url: /es/java/com.aspose.words/imagepixelformat/
---
...
Especifica el formato de píxel para las imágenes generadas de las páginas del documento.

 **Examples:** 

Muestra cómo seleccionar una tasa de bits por píxel con la que renderizar un documento a una imagen.
...
| Campo | Descripción |
| --- | --- |
| [FORMAT_16_BPP_ARGB_1555](#FORMAT-16-BPP-ARGB-1555) | 16 bits por píxel, ARGB. |
| [FORMAT_16_BPP_RGB_555](#FORMAT-16-BPP-RGB-555) | 16 bits por píxel, RGB. |
| [FORMAT_16_BPP_RGB_565](#FORMAT-16-BPP-RGB-565) | 16 bits por píxel, RGB. |
| [FORMAT_1_BPP_INDEXED](#FORMAT-1-BPP-INDEXED) | 1 bit por píxel, Indexado. |
| [FORMAT_24_BPP_RGB](#FORMAT-24-BPP-RGB) | 24 bits por píxel, RGB. |
| [FORMAT_32_BPP_ARGB](#FORMAT-32-BPP-ARGB) | 32 bits por píxel, ARGB. |
| [FORMAT_32_BPP_P_ARGB](#FORMAT-32-BPP-P-ARGB) | 32 bits por píxel, ARGB, alfa premultiplicado. |
| [FORMAT_32_BPP_RGB](#FORMAT-32-BPP-RGB) | 32 bits por píxel, RGB. |
| [FORMAT_48_BPP_RGB](#FORMAT-48-BPP-RGB) | 48 bits por píxel, RGB. |
| [FORMAT_64_BPP_ARGB](#FORMAT-64-BPP-ARGB) | 64 bits por píxel, ARGB. |
| [FORMAT_64_BPP_P_ARGB](#FORMAT-64-BPP-P-ARGB) | 64 bits por píxel, ARGB, alfa premultiplicado. |
| [length](#length) |  |
## Métodos
...
32 bits por píxel, ARGB, alfa premultiplicado.
...
64 bits por píxel, ARGB, alfa premultiplicado.
