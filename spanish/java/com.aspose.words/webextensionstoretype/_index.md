...
description: "Enumera los tipos disponibles de una tienda de extensiones web en Java."
type: docs
weight: 734
url: /es/java/com.aspose.words/webextensionstoretype/
---
...
| [EXCHANGE](#EXCHANGE) | Especifica que el tipo de tienda es un servidor Exchange. |
| [EX_CATALOG](#EX-CATALOG) | Especifica que el tipo de almacén es Implementación Centralizada a través de Exchange. |
| [FILE_SYSTEM](#FILE-SYSTEM) | Especifica que el tipo de almacén es un recurso compartido del sistema de archivos. |
| [OMEX](#OMEX) | Especifica que el tipo de almacén es Office.com. |
| [REGISTRY](#REGISTRY) | Especifica que el tipo de almacén es el registro del sistema. |
| [SP_APP](#SP-APP) |  |
...
Especifica que el tipo de tienda es un servidor Exchange.
...
Especifica que el tipo de almacén es Implementación Centralizada a través de Exchange.
...
Especifica que el tipo de almacén es un recurso compartido del sistema de archivos.
...
Especifica que el tipo de almacén es Office.com.
...
Especifica que el tipo de almacén es el registro del sistema.
