...
description: "Implemente esta interfaz si desea tener sus propios métodos personalizados llamados durante una actualización de campo en Java."
type: docs
weight: 768
url: /es/java/com.aspose.words/ifieldupdatingcallback/
---
```
...
| Método | Descripción |
| --- | --- |
| [fieldUpdated(Field field)](#fieldUpdated-com.aspose.words.Field) | Un método definido por el usuario que se llama justo después de que un campo se actualiza. |
| [fieldUpdating(Field field)](#fieldUpdating-com.aspose.words.Field) | Un método definido por el usuario que se llama justo antes de que un campo se actualice. |
...
Un método definido por el usuario que se llama justo después de que un campo se actualiza.
...
Un método definido por el usuario que se llama justo antes de que un campo se actualice.
