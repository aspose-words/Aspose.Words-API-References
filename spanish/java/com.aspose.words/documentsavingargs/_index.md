...
description: "Un argumento pasado a IDocumentSavingCallback.notifycom.aspose.words.DocumentSavingArgs en Java."
type: docs
weight: 172
url: /es/java/com.aspose.words/documentsavingargs/
---
...
Un argumento pasado a [IDocumentSavingCallback.notify(com.aspose.words.DocumentSavingArgs)](../../com.aspose.words/idocumentsavingcallback/\#notify-com.aspose.words.DocumentSavingArgs).

Para obtener más información, visite el artículo de documentación [ Save a Document ][Save a Document].

 **Examples:** 

Muestra cómo gestionar un documento mientras se guarda en html.
...
Muestra cómo gestionar un documento mientras se guarda en docx.
...
Muestra cómo gestionar un documento mientras se guarda en xamlflow.
