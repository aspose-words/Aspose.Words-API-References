...
description: "Representa un SubDocument - que es una referencia a un documento almacenado externamente en Java."
type: docs
weight: 645
url: /es/java/com.aspose.words/subdocument/
---
...
Representa un **SubDocument** \- que es una referencia a un documento almacenado externamente.
...
En esta versión de Aspose.Words, los nodos [SubDocument](../../com.aspose.words/subdocument/) no proporcionan métodos y propiedades públicas para crear o modificar un subdocumento. En esta versión no puedes instanciar nodos [SubDocument](../../com.aspose.words/subdocument/) ni modificar los existentes, excepto eliminarlos.
...
| [getNodeType()](#getNodeType) | Devuelve [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). |
...
Devuelve [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT).
...
**Returns:**
int - [NodeType.SUB\\_DOCUMENT](../../com.aspose.words/nodetype/\\#SUB-DOCUMENT). El valor devuelto es uno de los constantes de [NodeType](../../com.aspose.words/nodetype/).
