...
description: "Implementa el campo INCLUDEPICTURE en Java."
type: docs
weight: 247
url: /es/java/com.aspose.words/fieldincludepicture/
---
...
Recupera una imagen y la muestra como el resultado del campo.
...
| [getGraphicFilter()](#getGraphicFilter) | Obtiene el nombre del filtro para el formato del gráfico que se insertará. |
| [getLocaleId()](#getLocaleId) | Obtiene el LCID del campo. |
| [getResizeHorizontally()](#getResizeHorizontally) | Obtiene si se debe redimensionar la imagen horizontalmente desde la fuente. |
| [getResizeVertically()](#getResizeVertically) | Obtiene si se debe redimensionar la imagen verticalmente desde la fuente. |
...
| [getSourceFullName()](#getSourceFullName) | Obtiene la ubicación de la imagen usando un IRI. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Establece el nombre del filtro para el formato del gráfico que se insertará. |
| [setLocaleId(int value)](#setLocaleId-int) | Establece el LCID del campo. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Establece si se debe redimensionar la imagen horizontalmente desde la fuente. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Establece si se debe redimensionar la imagen verticalmente desde la fuente. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Establece la ubicación de la imagen usando un IRI. |
...
Obtiene el nombre del filtro para el formato del gráfico que se insertará.
...
**Returns:**
java.lang.String - El nombre del filtro para el formato del gráfico que se insertará.
...
Obtiene si se debe redimensionar la imagen horizontalmente desde la fuente.
...
**Returns:**
boolean - Si se debe redimensionar la imagen horizontalmente desde la fuente.
...
Obtiene si se debe redimensionar la imagen verticalmente desde la fuente.
...
**Returns:**
boolean - Si se debe redimensionar la imagen verticalmente desde la fuente.
### getResult() {#getResult}
```
...
Obtiene la ubicación de la imagen usando un IRI.
...
**Returns:**
java.lang.String - La ubicación de la imagen usando un IRI.
### getStart() {#getStart}
```
...
Establece el nombre del filtro para el formato del gráfico que se insertará.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre del filtro para el formato del gráfico que se insertará. |
...
Establece si se debe redimensionar la imagen horizontalmente desde la fuente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe redimensionar la imagen horizontalmente desde la fuente. |
...
Establece si se debe redimensionar la imagen verticalmente desde la fuente.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Indica si se debe redimensionar la imagen verticalmente desde la fuente. |
...
Establece la ubicación de la imagen usando un IRI.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | La ubicación de la imagen usando un IRI. |
