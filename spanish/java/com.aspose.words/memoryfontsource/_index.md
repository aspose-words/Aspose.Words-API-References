...
description: "Representa el único archivo de fuente TrueType almacenado en memoria en Java."
type: docs
weight: 461
url: /es/java/com.aspose.words/memoryfontsource/
---
...
Muestra cómo usar una matriz de bytes con datos de un archivo de fuente como origen de fuente.
...
| [getFontData()](#getFontData) | Datos binarios de la fuente. |
...
| --- | --- | --- |
| fontData | byte[] | Datos binarios de la fuente. |
...
| fontData | byte[] | Datos binarios de la fuente. |
| priority | int | Prioridad de la fuente de fuentes. Consulte la descripción de la propiedad [FontSourceBase.getPriority()](../../com.aspose.words/fontsourcebase/\#getPriority) para obtener más información. |
| cacheKey | java.lang.String | La clave de esta fuente en la caché. Consulte la descripción de la propiedad [getCacheKey()](../../com.aspose.words/memoryfontsource/\#getCacheKey) para obtener más información. |
