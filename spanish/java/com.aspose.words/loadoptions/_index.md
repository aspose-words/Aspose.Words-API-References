...
description: "Permite especificar opciones adicionales, como contraseña o URI base, al cargar un documento en un objeto Document en Java."
type: docs
weight: 435
url: /es/java/com.aspose.words/loadoptions/
---
...
Permite especificar opciones adicionales (como contraseña o URI base) al cargar un documento en un objeto [Document](../../com.aspose.words/document/).
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | Un atajo para inicializar una nueva instancia de esta clase con la contraseña especificada para cargar un documento cifrado. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | Inicializa una nueva instancia de esta clase. |
## Métodos
