...
description: "Cuando se implementa, permite sobrescribir la evaluación predeterminada de expresiones de comparación para los campos FieldIf y FieldCompare en Java."
type: docs
weight: 755
url: /es/java/com.aspose.words/icomparisonexpressionevaluator/
---
```
public interface IComparisonExpressionEvaluator
```

Cuando se implementa, permite sobrescribir la evaluación predeterminada de expresiones de comparación para los campos [FieldIf](../../com.aspose.words/fieldif/) y [FieldCompare](../../com.aspose.words/fieldcompare/).

 **Examples:** 

Muestra cómo implementar la evaluación personalizada para los campos IF y COMPARE.
...
| Método | Descripción |
| --- | --- |
| [evaluate(Field field, ComparisonExpression expression)](#evaluate-com.aspose.words.Field-com.aspose.words.ComparisonExpression) | Evalúa la expresión de comparación. |
...
La implementación debe devolver  null  para indicar que se debe realizar la evaluación predeterminada.
