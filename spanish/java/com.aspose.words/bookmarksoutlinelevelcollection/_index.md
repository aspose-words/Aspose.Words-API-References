...
description: "Una colección de niveles de esquema de marcadores individuales en Java."
type: docs
weight: 45
url: /es/java/com.aspose.words/bookmarksoutlinelevelcollection/
---
...
Una colección del nivel de esquema de marcadores individuales.

Para obtener más información, visite el artículo de documentación [ Working with Bookmarks ][Working with Bookmarks].

 **Remarks:** 

La clave es un nombre de marcador de cadena sin distinción entre mayúsculas y minúsculas. El valor es un nivel de esquema de marcador entero.
...
| Método | Descripción |
| --- | --- |
| [add(String name, int outlineLevel)](#add-java.lang.String-int) | Agrega un marcador a la colección. |
| [clear()](#clear) | Elimina todos los elementos de la colección. |
| [contains(String name)](#contains-java.lang.String) | Determina si la colección contiene un marcador con el nombre dado. |
| [get(int index)](#get-int) | Obtiene un nivel de esquema de marcador en el índice especificado. |
...
| [indexOfKey(String name)](#indexOfKey-java.lang.String) | Devuelve el índice basado en cero del marcador especificado en la colección. |
| [iterator()](#iterator) | Devuelve un objeto iterador que puede usarse para iterar sobre todos los elementos de la colección. |
| [remove(String name)](#remove-java.lang.String) | Elimina un marcador con el nombre especificado de la colección. |
| [removeAt(int index)](#removeAt-int) | Elimina un marcador en el índice especificado. |
| [set(int index, int value)](#set-int-int) | Establece el nivel de esquema de un marcador en el índice especificado. |
| [set(String name, int value)](#set-java.lang.String-int) | Proporciona acceso a los elementos de la colección. |
...
| --- | --- | --- |
| nombre | java.lang.String | El nombre del marcador a agregar, sin distinción de mayúsculas. |
| outlineLevel | int | El nivel de esquema del marcador. El rango válido es de 0 a 9. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | java.lang.String | Nombre del marcador a localizar, sin distinción de mayúsculas. |
...
Obtiene un nivel de esquema de marcador en el índice especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| índice | int | Índice basado en cero del marcador. |

**Returns:**
int - El nivel de esquema del marcador. El rango válido es de 0 a 9.
...
Proporciona acceso a los elementos de la colección. Obtiene o establece el nivel de esquema de un marcador por el nombre del marcador.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | java.lang.String | Nombre del marcador, sin distinción de mayúsculas. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| nombre | java.lang.String | El nombre del marcador, sin distinción de mayúsculas. |
...
Establece el nivel de esquema de un marcador en el índice especificado.
...
| --- | --- | --- |
| índice | int | Índice basado en cero del marcador. |
| valor | int | El nivel de esquema del marcador. El rango válido es de 0 a 9. |
