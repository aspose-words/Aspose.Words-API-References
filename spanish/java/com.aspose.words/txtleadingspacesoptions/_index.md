...
description: "Especifica las opciones disponibles para el manejo de espacios iniciales durante la importación del archivo LoadFormat.TEXT en Java."
type: docs
weight: 691
url: /es/java/com.aspose.words/txtleadingspacesoptions/
---
...
Especifica las opciones disponibles para el manejo de espacios iniciales durante la importación del archivo [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT).
...
| Campo | Descripción |
| --- | --- |
| [CONVERT_TO_INDENT](#CONVERT-TO-INDENT) | Los espacios iniciales se eliminan y se convierten en sangría izquierda. |
| [PRESERVE](#PRESERVE) | Los espacios iniciales se conservan. |
| [TRIM](#TRIM) | Los espacios iniciales se recortan |
| [length](#length) |  |
## Métodos
...
Los espacios iniciales se eliminan y se convierten en sangría izquierda.
...
Los espacios iniciales se recortan
