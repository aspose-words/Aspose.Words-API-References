...
description: "El control CheckBox alterna un valor en Java."
type: docs
weight: 100
url: /es/java/com.aspose.words/checkboxcontrol/
---
...
Tiene tres estados posibles: seleccionado, borrado y ni seleccionado ni borrado, lo que significa una combinación de estados encendido y apagado.
...
| [getChecked()](#getChecked) | Obtiene un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Establece un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no. |
...
Obtiene un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no. El valor predeterminado es  false .
...
**Returns:**
boolean - Un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no.
...
Establece un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no. El valor predeterminado es  false .
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | boolean | Un valor booleano que indica si este [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) está marcado o no. |
