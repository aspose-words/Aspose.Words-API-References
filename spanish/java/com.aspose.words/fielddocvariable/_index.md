...
description: "Implementa el campo DOCVARIABLE en Java."
type: docs
weight: 225
url: /es/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | Obtiene el nombre de la variable del documento a recuperar. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Establece el nombre de la variable del documento a recuperar. |
...
Obtiene el nombre de la variable del documento a recuperar.
...
**Returns:**
java.lang.String - El nombre de la variable del documento a recuperar.
### isDirty() {#isDirty}
```
...
Establece el nombre de la variable del documento a recuperar.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El nombre de la variable del documento a recuperar. |
