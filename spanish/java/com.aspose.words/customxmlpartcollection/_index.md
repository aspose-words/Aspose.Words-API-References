...
description: "Representa una colección de Custom XML Parts en Java."
type: docs
weight: 144
url: /es/java/com.aspose.words/customxmlpartcollection/
---
...
Representa una colección de Custom XML Parts. Los elementos son objetos [CustomXmlPart](../../com.aspose.words/customxmlpart/).
...
Normalmente no necesita crear instancias de esta clase. Puede acceder a los datos XML personalizados almacenados en un documento a través de la propiedad [Document.getCustomXmlParts()](../../com.aspose.words/document/\#getCustomXmlParts) / [Document.setCustomXmlParts(com.aspose.words.CustomXmlPartCollection)](../../com.aspose.words/document/\#setCustomXmlParts-com.aspose.words.CustomXmlPartCollection).
...
| Método | Descripción |
| --- | --- |
| [add(CustomXmlPart part)](#add-com.aspose.words.CustomXmlPart) | Añade un elemento a la colección. |
| [add(String id, String xml)](#add-java.lang.String-java.lang.String) | Crea una nueva parte XML con el XML especificado y la agrega a la colección. |
...
| [getById(String id)](#getById-java.lang.String) | Busca y devuelve una parte XML personalizada por su identificador. |
...
| [set(int index, CustomXmlPart value)](#set-int-com.aspose.words.CustomXmlPart) | Establece un elemento en el índice especificado. |
...
| --- | --- | --- |
| part | [CustomXmlPart](../../com.aspose.words/customxmlpart/) | La parte XML personalizada a agregar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| id | java.lang.String | Identificador de una nueva parte XML personalizada. |
| xml | java.lang.String | Datos XML de la parte. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| id | java.lang.String | Cadena sensible a mayúsculas y minúsculas que identifica la parte XML personalizada. |
...
| --- | --- | --- |
| índice | int | Índice basado en cero del elemento. |
| value | [CustomXmlPart](../../com.aspose.words/customxmlpart/) | Un elemento en el índice especificado. |
