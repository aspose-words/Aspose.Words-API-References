...
description: "Implementa el campo KEYWORDS en Java."
type: docs
weight: 252
url: /es/java/com.aspose.words/fieldkeywords/
---
...
Implementa el campo KEYWORDS.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera, y opcionalmente establece, las palabras clave del documento, según se registran en la propiedad **Keywords** de las propiedades integradas del documento.
...
| [getText()](#getText) | Obtiene el texto de las palabras clave. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto de las palabras clave. |
...
Obtiene el texto de las palabras clave.
...
**Returns:**
java.lang.String - El texto de las palabras clave.
### getType() {#getType}
```
public int getType()
```
...
Establece el texto de las palabras clave.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto de las palabras clave. |
