...
description: "Representa la referencia a una extensión web en Java."
type: docs
weight: 732
url: /es/java/com.aspose.words/webextensionreference/
---
...
| Método | Descripción |
| --- | --- |
| [getId()](#getId) | Identificador asociado con la extensión web dentro de un proveedor de catálogo. |
| [getStore()](#getStore) | Especifica la instancia del mercado donde se almacena la extensión web. |
| [getStoreType()](#getStoreType) | Especifica el tipo de mercado. |
| [getVersion()](#getVersion) | Especifica la versión de la extensión web. |
| [setId(String value)](#setId-java.lang.String) | Identificador asociado con la extensión web dentro de un proveedor de catálogo. |
| [setStore(String value)](#setStore-java.lang.String) | Especifica la instancia del mercado donde se almacena la extensión web. |
| [setStoreType(int value)](#setStoreType-int) | Especifica el tipo de mercado. |
| [setVersion(String value)](#setVersion-java.lang.String) | Especifica la versión de la extensión web. |
### getId() {#getId}
```
public String getId()
```
...
**Returns:**
int - El valor  int  correspondiente. El valor devuelto es uno de los constantes [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| value | int | El valor  int  correspondiente. El valor debe ser uno de los constantes [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/). |
