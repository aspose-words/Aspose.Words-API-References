...
description: "Implementa el campo BIBLIOGRAPHY en Java."
type: docs
weight: 207
url: /es/java/com.aspose.words/fieldbibliography/
---
...
Implementa el campo BIBLIOGRAPHY.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Obtiene el ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Obtiene el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento. |
...
| [getSourceTag()](#getSourceTag) | Obtiene un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Establece el ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Establece el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Establece un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida. |
...
Obtiene el ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma.
...
**Returns:**
java.lang.String - El ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma.
### getFormat() {#getFormat}
```
...
Obtiene el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento.
...
**Returns:**
java.lang.String - El ID de idioma que se usa para formatear las fuentes bibliográficas en el documento.
...
Obtiene un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida.
...
**Returns:**
java.lang.String - Un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida.
### getStart() {#getStart}
```
...
Establece el ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El ID de idioma que se usa para filtrar los datos bibliográficos a solo las fuentes del documento que utilizan ese idioma. |
...
Establece el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El ID de idioma que se usa para formatear las fuentes bibliográficas en el documento. |
...
Establece un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida. |
