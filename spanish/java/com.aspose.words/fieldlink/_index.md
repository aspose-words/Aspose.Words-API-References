...
description: "Implementa el campo LINK en Java."
type: docs
weight: 254
url: /es/java/com.aspose.words/fieldlink/
---
...
Implementa el campo LINK.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Para la información copiada de otra aplicación, este campo enlaza esa información a su archivo fuente original.
...
| [getFormatUpdateType()](#getFormatUpdateType) | Obtiene una forma en que el objeto enlazado actualiza su formato. |
...
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String) | Establece una forma en que el objeto enlazado actualiza su formato. |
...
Obtiene una forma en que el objeto enlazado actualiza su formato.
...
**Returns:**
java.lang.String - Una forma en que el objeto enlazado actualiza su formato.
...
Establece una forma en que el objeto enlazado actualiza su formato.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | Una forma en que el objeto enlazado actualiza su formato. |
