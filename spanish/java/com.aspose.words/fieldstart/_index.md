...
description: "Representa el inicio de un campo de Word en un documento en Java."
type: docs
weight: 288
url: /es/java/com.aspose.words/fieldstart/
---
...
Un campo completo en un documento de Microsoft Word es una estructura compleja que consta de un carácter de inicio de campo, código de campo, carácter separador de campo, resultado del campo y carácter de fin de campo. Algunos campos solo tienen inicio de campo, código de campo y fin de campo.

Para insertar fácilmente un nuevo campo en un documento, use el método [DocumentBuilder.insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String).
...
| [getFieldData()](#getFieldData) | Obtiene los datos personalizados del campo que están asociados al campo. |
| [getFieldType()](#getFieldType) | Devuelve el tipo del campo. |
...
| [getNodeType()](#getNodeType) | Devuelve [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). |
...
| [isLocked()](#isLocked) | Obtiene si el campo padre está bloqueado (no debe recalcular su resultado). |
| [isLocked(boolean value)](#isLocked-boolean) | Establece si el campo padre está bloqueado (no debe recalcular su resultado). |
...
Llama a [DocumentVisitor.visitFieldStart(com.aspose.words.FieldStart)](../../com.aspose.words/documentvisitor/\#visitFieldStart-com.aspose.words.FieldStart).
...
**Returns:**
boolean - **False** si el visitante solicitó que la enumeración se detenga.
### clearRunAttrs() {#clearRunAttrs}
```
...
Se crea un nuevo objeto [Field](../../com.aspose.words/field/) cada vez que se llama al método.
...
Obtiene los datos personalizados del campo que están asociados al campo.

 **Examples:** 

Muestra cómo obtener los datos asociados al campo.
...
**Returns:**
byte[] - Datos personalizados del campo que están asociados al campo.
...
**Returns:**
int - El tipo del campo. El valor devuelto es una de las constantes [FieldType](../../com.aspose.words/fieldtype/).
### getFont() {#getFont}
```
public Font getFont()
```
...
Devuelve [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START).
...
**Returns:**
int - [NodeType.FIELD\_START](../../com.aspose.words/nodetype/\#FIELD-START). El valor devuelto es una de las constantes de [NodeType](../../com.aspose.words/nodetype/).
...
Obtiene si el campo padre está bloqueado (no debe recalcular su resultado).
...
**Returns:**
boolean - Si el campo padre está bloqueado (no debe recalcular su resultado).
...
Establece si el campo padre está bloqueado (no debe recalcular su resultado).
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | boolean | Si el campo padre está bloqueado (no debe recalcular su resultado). |
