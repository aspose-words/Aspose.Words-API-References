...
description: "Interfaz para definir datos comunes para StructuredDocumentTag y StructuredDocumentTagRangeStart en Java."
type: docs
weight: 785
url: /es/java/com.aspose.words/istructureddocumenttag/
---
```
public interface IStructuredDocumentTag
```

Interfaz para definir datos comunes para [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) y [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).

 **Examples:** 

Muestra cómo eliminar la etiqueta de documento estructurado, pero conserva el contenido interno.
...
| [getId()](#getId) | Especifica un Id numérico persistente de solo lectura único para este **SDT**. |
| [getLevel()](#getLevel) | Obtiene el nivel en el que este **SDT** se encuentra en el árbol del documento. |
| [getLockContentControl()](#getLockContentControl) | Cuando se establece en true, esta propiedad impedirá que un usuario elimine este **SDT**. |
| [getLockContents()](#getLockContents) | Cuando se establece en true, esta propiedad impedirá que un usuario edite el contenido de este **SDT**. |
| [getNode()](#getNode) | Devuelve un objeto Node que implementa esta interfaz. |
| [getPlaceholder()](#getPlaceholder) | Obtiene el [BuildingBlock](../../com.aspose.words/buildingblock/) que contiene el texto de marcador de posición que debe mostrarse cuando el contenido de ejecución de este SDT está vacío, el elemento XML mapeado asociado está vacío según lo especificado mediante el elemento [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) o el elemento [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) es true. |
...
| [getSdtType()](#getSdtType) | Obtiene el tipo de este **Structured document tag**. |
| [getTag()](#getTag) | Especifica una etiqueta asociada al nodo SDT actual. |
| [getTitle()](#getTitle) | Especifica el nombre descriptivo asociado a este **SDT**. |
...
| [getXmlMapping()](#getXmlMapping) | Obtiene un objeto que representa el mapeo de esta etiqueta de documento estructurado a datos XML en una parte XML personalizada del documento actual. |
| [isMultiSection()](#isMultiSection) | Devuelve true si esta instancia es una etiqueta de documento estructurado con rango (multi-sección). |
| [isShowingPlaceholderText()](#isShowingPlaceholderText) | Especifica si el contenido de este **SDT** debe interpretarse como texto de marcador de posición (en lugar de contenido de texto regular dentro del SDT). |
| [isShowingPlaceholderText(boolean value)](#isShowingPlaceholderText-boolean) | Especifica si el contenido de este **SDT** debe interpretarse como texto de marcador de posición (en lugar de contenido de texto regular dentro del SDT). |
| [removeSelfOnly()](#removeSelfOnly) | Elimina solo este nodo SDT, pero conserva su contenido dentro del árbol del documento. |
...
| [setLockContentControl(boolean value)](#setLockContentControl-boolean) | Cuando se establece en true, esta propiedad impedirá que un usuario elimine este **SDT**. |
| [setLockContents(boolean value)](#setLockContents-boolean) | Cuando se establece en true, esta propiedad impedirá que un usuario edite el contenido de este **SDT**. |
...
| [setTag(String value)](#setTag-java.lang.String) | Especifica una etiqueta asociada al nodo SDT actual. |
| [setTitle(String value)](#setTitle-java.lang.String) | Especifica el nombre descriptivo asociado a este **SDT**. |
...
Obtiene el nivel en el que este **SDT** se encuentra en el árbol del documento.
...
**Returns:**
int - El nivel en el que ocurre este **SDT** en el árbol del documento. El valor devuelto es uno de los constantes de [MarkupLevel](../../com.aspose.words/markuplevel/).
...
Cuando se establece en true, esta propiedad impedirá que un usuario elimine este **SDT**.
...
Cuando se establece en true, esta propiedad impedirá que un usuario edite el contenido de este **SDT**.
...
Obtiene el [BuildingBlock](../../com.aspose.words/buildingblock/) que contiene el texto de marcador de posición que debe mostrarse cuando el contenido de ejecución de este SDT está vacío, el elemento XML mapeado asociado está vacío según lo especificado mediante el elemento [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) o el elemento [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) es true.
...
Obtiene el tipo de este **Structured document tag**.

**Returns:**
int - Tipo de esta **Structured document tag**. El valor devuelto es uno de los constantes de [SdtType](../../com.aspose.words/sdttype/).
### getTag() {#getTag}
```
...
Especifica una etiqueta asociada al nodo SDT actual. No puede ser nulo.
...
Especifica el nombre descriptivo asociado a este **SDT**. No puede ser nulo.
...
Muestra cómo obtener el XML contenido dentro del nodo en formato FlatOpc.
...
Obtiene un objeto que representa el mapeo de esta etiqueta de documento estructurado a datos XML en una parte XML personalizada del documento actual.

 **Remarks:** 

Puede usar el método [XmlMapping.setMapping(com.aspose.words.CustomXmlPart, java.lang.String, java.lang.String)](../../com.aspose.words/xmlmapping/\#setMapping-com.aspose.words.CustomXmlPart--java.lang.String--java.lang.String) de este objeto para mapear una etiqueta de documento estructurado a datos XML.
...
**Returns:**
boolean - Verdadero si esta instancia es una etiqueta de documento estructurado con rango (multisección).
...
Especifica si el contenido de este **SDT** debe interpretarse como texto de marcador de posición (en lugar de contenido de texto regular dentro del SDT).

si se establece en verdadero, este estado se reanudará (mostrando el texto del marcador de posición) al abrir este documento.
...
Elimina solo este nodo SDT, pero conserva su contenido dentro del árbol del documento.
