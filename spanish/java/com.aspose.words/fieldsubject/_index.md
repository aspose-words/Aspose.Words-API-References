...
description: "Implementa el campo SUBJECT en Java."
type: docs
weight: 290
url: /es/java/com.aspose.words/fieldsubject/
---
...
Implementa el campo SUBJECT.

Para obtener más información, visite el artículo de documentación [ Working with Fields ][Working with Fields].

 **Remarks:** 

Recupera y, opcionalmente, establece el asunto del documento, tal como se registra en la propiedad **Subject** de las propiedades integradas del documento.
...
| [getText()](#getText) | Obtiene el texto del asunto. |
...
| [setText(String value)](#setText-java.lang.String) | Establece el texto del asunto. |
...
**Returns:**
java.lang.String - El texto del asunto.
### getType() {#getType}
```
public int getType()
```
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| valor | java.lang.String | El texto del asunto. |
