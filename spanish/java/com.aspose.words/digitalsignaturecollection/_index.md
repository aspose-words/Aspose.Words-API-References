...
description: "Proporciona una colección de solo lectura de firmas digitales adjuntas a un documento en Java."
type: docs
weight: 151
url: /es/java/com.aspose.words/digitalsignaturecollection/
---
...
| Método | Descripción |
| --- | --- |
| [get(int index)](#get-int) | Obtiene una firma de documento en el índice especificado. |
| [getCount()](#getCount) | Obtiene el número de elementos contenidos en la colección. |
| [isValid()](#isValid) | Devuelve  true  si todas las firmas digitales en esta colección son válidas y el documento no ha sido manipulado. También devuelve  true  si no hay firmas digitales. |
| [iterator()](#iterator) | Devuelve un objeto iterador de diccionario que puede usarse para iterar sobre todos los elementos de la colección. |
...
| --- | --- | --- |
| índice | int | Índice basado en cero de la firma. |
...
**Returns:**
boolean - true si todas las firmas digitales en esta colección son válidas y el documento no ha sido manipulado. También devuelve true si no hay firmas digitales.
### iterator() {#iterator}
```
...
Devuelve un objeto iterador de diccionario que puede usarse para iterar sobre todos los elementos de la colección.
