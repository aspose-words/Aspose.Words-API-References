...
description: Permite especificar opciones adicionales al cargar un documento PDF en unDocument../aspose.words/document objeto.
type: docs
weight: 3470
...
| [SkipPdfImages](../../aspose.words.loading/pdfloadoptions/skippdfimages) { get; set; } | Obtiene o establece el indicador que indica si las imágenes deben omitirse al cargar un documento PDF. El valor predeterminado es Falso. |
