...
description: Descubra la enumeración Aspose.Words.WebExtensions.TaskPaneDockState, que define las ubicaciones del panel de tareas para mejorar la edición de documentos y la experiencia del usuario.
type: docs
weight: 7580
url: /es/net/aspose.words.webextensions/taskpanedockstate/
---
## TaskPaneDockState enumeration

Enumera las ubicaciones disponibles del objeto del panel de tareas.
...
| --- | --- | --- |
| Right | `0` | Acoplar el panel de tareas en el lado derecho de la ventana del documento. |
| Left | `1` | Acoplar el panel de tareas en el lado izquierdo de la ventana del documento. |
