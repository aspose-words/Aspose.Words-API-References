...
description: Descubra la propiedad WebExtension Id, su clave para identificar de forma única instancias de extensión web en documentos para una funcionalidad mejorada y una integración perfecta.
type: docs
weight: 30
...
Identifica de forma única la instancia de extensión web en el documento actual.
