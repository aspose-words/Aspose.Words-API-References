...
description: Descubra Propiedades de WebExtension, un potente conjunto de funciones personalizables para mejorar sus extensiones web. ¡Desbloquee funciones únicas hoy mismo!
type: docs
weight: 50
...
Representa un conjunto de propiedades personalizadas de extensión web.
