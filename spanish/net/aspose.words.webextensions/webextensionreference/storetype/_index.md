...
description: Descubra la propiedad WebExtensionReference StoreType, que define tipos de marketplace para mejorar sus proyectos de desarrollo web con soluciones personalizadas.
type: docs
weight: 40
url: /es/net/aspose.words.webextensions/webextensionreference/storetype/
---
## WebExtensionReference.StoreType property

Especifica el tipo de mercado.
