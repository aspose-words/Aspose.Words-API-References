...
description: Descubra la clase Aspose.Words.WebExtensionReference, la clave para gestionar extensiones web fácilmente. ¡Identifique proveedores y versiones fácilmente!
type: docs
weight: 7650
...
Representa la referencia a una extensión web. Esta referencia se utiliza para identificar la ubicación del proveedor y la versión de la extensión.
...
| [Store](../../aspose.words.webextensions/webextensionreference/store/) { get; set; } | Especifica la instancia del marketplace donde se almacena la extensión web. |
