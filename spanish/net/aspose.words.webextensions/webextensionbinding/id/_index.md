...
description: Descubra la propiedad WebExtensionBinding Id, su clave para definir identificadores de enlace únicos para una funcionalidad mejorada de la extensión web.
type: docs
weight: 40
