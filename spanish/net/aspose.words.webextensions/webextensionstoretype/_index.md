...
description: Descubra la enumeración Aspose.Words.WebExtensionStoreType, que incluye diversos tipos de tiendas de extensiones web para una integración perfecta y una funcionalidad mejorada.
type: docs
weight: 7670
...
| Exchange | `3` | Especifica que el tipo de tienda es un servidor Exchange. |
