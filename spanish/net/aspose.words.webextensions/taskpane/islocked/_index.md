...
description: TaskPane propiedad. Especifica si el panel de tareas está bloqueado para el documento en la interfaz de usuario y el usuario no puede cerrarlo.
type: docs
weight: 30
...
Especifica si el panel de tareas está bloqueado para el documento en la interfaz de usuario y el usuario no puede cerrarlo.
