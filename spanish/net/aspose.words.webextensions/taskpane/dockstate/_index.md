...
description: Descubra la propiedad TaskPane DockState para administrar fácilmente la última posición acoplada de su panel de tareas para mejorar el flujo de trabajo y la eficiencia.
type: docs
weight: 20
...
Especifica la última ubicación acoplada de este objeto del panel de tareas.
