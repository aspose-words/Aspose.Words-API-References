...
description: Descubra la propiedad Fila del panel de tareas, administre fácilmente la indexación del panel de tareas para una organización optimizada y una mayor productividad en sus aplicaciones.
type: docs
weight: 50
...
Especifica el índice, enumerando desde afuera hacia adentro, de este panel de tareas entre otros paneles de tareas persistentes acoplados en la misma ubicación predeterminada.
