...
description: Aspose.Words.AbsolutePositionTab clase. Una pestaña de posición absoluta es un carácter que se utiliza para avanzar la posición en la línea de texto actual cuando se muestra este contenido de WordprocessingML.
type: docs
weight: 10
