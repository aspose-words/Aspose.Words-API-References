...
description: Devuelve Falso si para el idioma especificado no hay ningún diccionario registrado o si el diccionario registrado es Nulo de lo contrario es Verdadero.
type: docs
weight: 30
