...
description: Mejore la experiencia del usuario de su sitio web con el método HeaderFooter AcceptEnd, diseñado para administrar sin problemas las interacciones de los visitantes al final del encabezado.
type: docs
weight: 80
url: /es/net/aspose.words/headerfooter/acceptend/
---
## HeaderFooter.AcceptEnd method

Acepta un visitante por visitar el final del encabezado.
