...
description: Descubra el método AcceptStart de HeaderFooter, diseñado para dar una bienvenida perfecta a los visitantes al inicio del encabezado, mejorando la experiencia y la participación del usuario.
type: docs
weight: 90
url: /es/net/aspose.words/headerfooter/acceptstart/
---
## HeaderFooter.AcceptStart method

Acepta un visitante por visitar el inicio del encabezado.
