...
Inicializa una nueva instancia de la clase Sección.
...
Cuando se crea la sección, pertenece al documento especificado, pero aún no es parte del documento y **Nodo principal** es nulo.

Para incluir una sección en un documento, utilice los métodos Document.InsertAfter, Document.InsertBefore o Sections.Add y Section.Insert.
