...
description: Convierta sin esfuerzo su RunCollection en una matriz con el método ToArray, lo que garantiza una gestión de datos perfecta y un rendimiento mejorado.
type: docs
weight: 20
url: /es/net/aspose.words/runcollection/toarray/
---
## RunCollection.ToArray method

Copia todas las ejecuciones de la colección a una nueva matriz de ejecuciones.
