...
description: Descubra si VariableCollection contiene una variable de documento por nombre. ¡Optimice la gestión de datos y mejore la eficiencia de su codificación hoy mismo!
type: docs
weight: 50
...
Determina si la colección contiene una variable de documento con el nombre especificado.
...
| --- | --- | --- |
| name | String | Nombre sin distinción entre mayúsculas y minúsculas de la variable del documento que se va a localizar. |
