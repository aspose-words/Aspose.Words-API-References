...
description: Descubra la propiedad ConditionalStyle TopPadding para ajustar fácilmente el espacio sobre el contenido de las celdas de la tabla, mejorando el diseño y la legibilidad para un mejor diseño.
type: docs
weight: 80
