...
description: Descubre la propiedad Sombreado ConditionalStyle para acceder al formato de sombreado de tus estilos. ¡Mejora tus diseños con efectos visuales personalizados hoy mismo!
type: docs
weight: 70
...
Obtiene un[`Shading`](../../shading/) objeto que hace referencia al formato de sombreado para este estilo condicional.
