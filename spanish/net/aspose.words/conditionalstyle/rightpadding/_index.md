...
description: Descubra la propiedad ConditionalStyle RightPadding para ajustar fácilmente el espaciado entre celdas de una tabla. Mejore su diseño con un control preciso.
type: docs
weight: 60
