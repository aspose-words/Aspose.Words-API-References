...
description: Optimice sus documentos con la propiedad UnusedBuiltinStyles de CleanupOptions, garantizando que los estilos BuiltIn no utilizados se eliminen de manera eficiente para obtener resultados más limpios y profesionales.
type: docs
weight: 30
...
Especifica que no se utiliza[`BuiltIn`](../../style/builtin/) Los estilos deberían eliminarse del documento.
