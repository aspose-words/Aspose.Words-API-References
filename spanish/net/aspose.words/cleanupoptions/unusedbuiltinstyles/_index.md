...
description: CleanupOptions propiedad. Especifica que no se usaBuiltIn los estilos deben eliminarse de document.
type: docs
weight: 30
...
Especifica que no se usa[`BuiltIn`](../../style/builtin/) los estilos deben eliminarse de document.
