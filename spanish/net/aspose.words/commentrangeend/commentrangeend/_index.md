...
description: Descubra el constructor CommentRangeEnd, cree sin esfuerzo nuevas instancias de esta clase para una integración de código perfecta y una funcionalidad mejorada.
type: docs
weight: 10
...
Para añadir un[`CommentRangeEnd`](../) Para el documento use InsertAfter o InsertBefore en el párrafo donde desea insertar el comentario.
