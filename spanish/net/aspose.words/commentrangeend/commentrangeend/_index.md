...
Cuando[`CommentRangeEnd`](../../commentrangeend) se crea, pertenece al documento especificado, pero aún no es parte del documento y[`ParentNode`](../../node/parentnode) es nulo.

Para anexar un[`CommentRangeEnd`](../../commentrangeend) al documento use InsertAfter o InsertBefore en el párrafo donde desea insertar el comentario.
