...
description: Aspose.Words.CommentRangeEnd clase. Indica el final de una región de texto que tiene un comentario asociado.
type: docs
weight: 240
...
| Nombre | Descripción |
| --- | --- |
| [CommentRangeEnd](commentrangeend/)(DocumentBase, int) | Inicializa una nueva instancia de esta clase. |
...
| override [NodeType](../../aspose.words/commentrangeend/nodetype/) { get; } | DevolucionesCommentRangeEnd . |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.words/commentrangeend/accept/)(DocumentVisitor) | Acepta un visitante. |
...
Para crear un comentario anclado a una región de texto, debe crear un[`Comment`](../comment/) and luego crea[`CommentRangeStart`](../commentrangestart/) y`CommentRangeEnd` establecer sus identificadores al mismo[`Id`](../comment/id/) valor.

`CommentRangeEnd` es un nodo de nivel en línea y solo puede ser un elemento secundario de[`Paragraph`](../paragraph/).
