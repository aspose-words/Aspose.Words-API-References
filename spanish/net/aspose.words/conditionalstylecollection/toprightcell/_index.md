...
description: Descubra la propiedad TopRightCell de ConditionalStyleCollection para personalizar fácilmente sus estilos de celda superior derecha para una mejor presentación de datos.
type: docs
weight: 140
url: /es/net/aspose.words/conditionalstylecollection/toprightcell/
---
## ConditionalStyleCollection.TopRightCell property

Obtiene el estilo de celda superior derecha.
