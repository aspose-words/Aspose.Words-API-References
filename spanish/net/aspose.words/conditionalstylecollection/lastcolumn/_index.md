...
description: Descubra la propiedad ConditionalStyleCollection LastColumn para personalizar fácilmente los estilos de su última columna para lograr una mayor flexibilidad de diseño y atractivo visual.
type: docs
weight: 90
url: /es/net/aspose.words/conditionalstylecollection/lastcolumn/
---
## ConditionalStyleCollection.LastColumn property

Obtiene el estilo de la última columna.
