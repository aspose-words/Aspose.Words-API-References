...
description: Descubra la propiedad BottomLeftCell de ConditionalStyleCollection para personalizar fácilmente sus estilos de celda inferior izquierda para un atractivo visual mejorado.
type: docs
weight: 10
url: /es/net/aspose.words/conditionalstylecollection/bottomleftcell/
---
## ConditionalStyleCollection.BottomLeftCell property

Obtiene el estilo de celda inferior izquierda.
