...
description: Descubra la propiedad Range FormFields, acceda a una colección completa de FormFields para administrar de manera eficiente todos los campos de formulario dentro de su rango especificado.
type: docs
weight: 30
...
Devuelve un`FormFields` colección que representa todos los campos de formulario en el rango.
