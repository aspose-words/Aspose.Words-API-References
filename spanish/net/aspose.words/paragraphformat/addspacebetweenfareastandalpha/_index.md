...
description: Obtiene o establece una marca que indica si el espaciado entre caracteres se ajusta automáticamente entre regiones de texto latino y regiones de texto de Asia oriental en el párrafo actual.
type: docs
weight: 10
