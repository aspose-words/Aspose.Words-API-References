...
description: Descubre la propiedad Sombreado de Formato de Párrafo para mejorar el estilo del texto. Accede a un objeto Sombreado para realzar el atractivo visual de tu párrafo fácilmente.
type: docs
weight: 290
