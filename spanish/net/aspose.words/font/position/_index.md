...
description: Font Position propiedad. Obtiene o establece la posición del texto en puntos en relación con la línea base. Un número positivo eleva el texto y un número negativo lo reduce en C#.
type: docs
weight: 300
