...
description: Devuelve el color actual calculado del texto blanco o negro que se utilizará para el color automático. Si el color no es automático devuelveColoraspose.words/font/color .
type: docs
weight: 20
