...
Esta propiedad, cuando está activada, no se utilizará con texto fuertemente de izquierda a derecha. No se especifica ningún comportamiento bajo esa condición. Esta propiedad, cuando está desactivada, no se utilizará con texto fuerte de derecha a izquierda. Cualquier comportamiento bajo esa condición no está especificado.

Cuando se muestre el contenido de esta ejecución, todos los caracteres se tratarán como caracteres de secuencia de comandos complejos a efectos de formato . Esto significa que[`BoldBi`](../boldbi/) ,[`ItalicBi`](../italicbi/) ,[`SizeBi`](../sizebi/) y se usará un nombre de fuente correspondiente al renderizar esta ejecución.
