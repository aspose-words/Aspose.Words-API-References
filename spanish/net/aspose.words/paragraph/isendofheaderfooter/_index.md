...
description: Paragraph propiedad. Verdadero si este párrafo es el último párrafo del EncabezadoPie de página historia del texto principal de un Sección  falso en caso contrario.
type: docs
weight: 70
