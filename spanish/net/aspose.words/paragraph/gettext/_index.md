...
* Si el párrafo es el último párrafo de[`Body`](../../body/) , entonces [`SectionBreak`](../../controlchar/sectionbreak/) (\x000c) se añade.
* Si el párrafo es el último párrafo de[`Cell`](../../../aspose.words.tables/cell/) , entonces [`Cell`](../../controlchar/cell/) (\x0007) se adjunta.
* Para todos los demás párrafos [`ParagraphBreak`](../../controlchar/paragraphbreak/) (\r) se añade.
