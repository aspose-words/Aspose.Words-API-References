...
description: Paragraph propiedad. Obtiene unListLabel objeto que proporciona acceso al valor de numeración de la lista y formato para este párrafo.
type: docs
weight: 160
...
Obtiene un`ListLabel` objeto que proporciona acceso al valor de numeración de la lista y formato para este párrafo.
