...
description: Descubra la propiedad Ejecuciones de párrafo para acceder fácilmente a colecciones de texto formateadas dentro de los párrafos, mejorando la estructura y la legibilidad de su documento.
type: docs
weight: 220
...
Proporciona acceso a la colección escrita de fragmentos de texto dentro del párrafo.
