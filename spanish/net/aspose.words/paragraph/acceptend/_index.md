...
description: Descubra el método Paragraph AcceptEnd, diseñado para mejorar la navegación del documento al aceptar eficientemente a los visitantes al final de los párrafos.
type: docs
weight: 240
url: /es/net/aspose.words/paragraph/acceptend/
---
## Paragraph.AcceptEnd method

Acepta a un visitante por visitar el final del párrafo del documento.
