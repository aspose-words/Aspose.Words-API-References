...
description: Paragraph constructor. Inicializa una nueva instancia del Párrafo clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del **Párrafo** clase.
...
Cuando **Párrafo** se crea, pertenece al documento especificado, pero aún no es parte del documento y **Nodo principal** es nulo.

Para anexar **Párrafo** al documento use InsertAfter o InsertBefore en la historia donde desea insertar el párrafo.
