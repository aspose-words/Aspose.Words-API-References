...
description: Descubra la propiedad IsDeleteRevision en Microsoft Word. Aprenda cómo indica las eliminaciones durante el seguimiento de cambios para una gestión eficiente de documentos.
type: docs
weight: 40
