...
description: Descubra cómo la propiedad RestartPageNumbering mejora el formato del documento al permitir la numeración de páginas por sección. ¡Optimice su diseño fácilmente!
type: docs
weight: 360
...
Si se establece en`FALSO` , el`RestartPageNumbering` La propiedad anulará la propiedad [`PageStartingNumber`](../pagestartingnumber/) propiedad para que la numeración de páginas pueda continuar desde la sección anterior.
