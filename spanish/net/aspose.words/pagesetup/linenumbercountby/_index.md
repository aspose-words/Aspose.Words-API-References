...
description: Descubra la propiedad LineNumberCountBy de PageSetup para personalizar fácilmente los incrementos del número de línea para mejorar el formato y la legibilidad del documento.
type: docs
weight: 210
