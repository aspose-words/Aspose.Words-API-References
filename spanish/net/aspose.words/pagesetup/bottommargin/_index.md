...
description: Ajuste el diseño de su documento con la propiedad PageSetup BottomMargin, definiendo el espacio entre el borde inferior de la página y el cuerpo del texto para una presentación óptima.
type: docs
weight: 80
