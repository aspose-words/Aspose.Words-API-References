...
description: Obtiene o establece la bandeja de papel bin que se usará para todas las páginas de una sección excepto la primera. El valor es específico de la implementación impresora.
type: docs
weight: 290
