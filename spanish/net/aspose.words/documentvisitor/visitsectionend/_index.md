...
description: Descubra el método VisitSectionEnd de DocumentVisitor, crucial para gestionar la enumeración de secciones en sus aplicaciones. ¡Mejore su eficiencia de codificación hoy mismo!
type: docs
weight: 370
url: /es/net/aspose.words/documentvisitor/visitsectionend/
---
## DocumentVisitor.VisitSectionEnd method

Se llama cuando finaliza la enumeración de una sección.
