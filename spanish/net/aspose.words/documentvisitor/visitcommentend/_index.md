...
description: Explore el método VisitCommentEnd de DocumentVisitor, diseñado para mejorar la enumeración del texto de los comentarios en sus proyectos para un procesamiento perfecto de los documentos.
type: docs
weight: 100
url: /es/net/aspose.words/documentvisitor/visitcommentend/
---
## DocumentVisitor.VisitCommentEnd method

Se llama cuando finaliza la enumeración de un texto de comentario.
