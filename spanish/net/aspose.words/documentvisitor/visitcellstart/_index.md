...
description: DocumentVisitor método. Llamado cuando se ha iniciado la enumeración de una celda de la tabla.
type: docs
weight: 90
...
Llamado cuando se ha iniciado la enumeración de una celda de la tabla.
