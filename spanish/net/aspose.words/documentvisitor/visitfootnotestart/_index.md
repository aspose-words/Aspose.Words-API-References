...
description: DocumentVisitor método. Llamado cuando ha comenzado la enumeración de una nota al pie o al final del texto.
type: docs
weight: 220
...
Llamado cuando ha comenzado la enumeración de una nota al pie o al final del texto.
