...
description: DocumentVisitor método. Llamado cuando se encuentra el final de un marcador en el documento.
type: docs
weight: 40
...
Llamado cuando se encuentra el final de un marcador en el documento.
