...
description: Descubra el método VisitBookmarkEnd de DocumentVisitor, que mejora la navegación del documento al manejar de manera eficiente los finales de los marcadores para una experiencia de usuario perfecta.
type: docs
weight: 40
...
| --- | --- | --- |
| bookmarkEnd | BookmarkEnd | El objeto que se está visitando. |
