...
description: Descubra el método VisitGroupShapeEnd de DocumentVisitor, que señala de manera eficiente el final de la enumeración de formas de grupo para un procesamiento continuo de documentos.
type: docs
weight: 260
