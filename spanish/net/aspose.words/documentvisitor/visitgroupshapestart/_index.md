...
description: Descubra el método DocumentVisitor VisitGroupShapeStart, esencial para la enumeración eficiente de formas de grupo en sus aplicaciones. ¡Mejore su flujo de trabajo de programación hoy mismo!
type: docs
weight: 270
url: /es/net/aspose.words/documentvisitor/visitgroupshapestart/
---
## DocumentVisitor.VisitGroupShapeStart method

Se llama cuando se inicia la enumeración de una forma de grupo.
