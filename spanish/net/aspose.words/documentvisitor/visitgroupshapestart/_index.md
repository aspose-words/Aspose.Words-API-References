...
description: DocumentVisitor VisitGroupShapeStart método. Se llama cuando ha comenzado la enumeración de una forma de grupo en C#.
type: docs
weight: 270
...
Se llama cuando ha comenzado la enumeración de una forma de grupo.
