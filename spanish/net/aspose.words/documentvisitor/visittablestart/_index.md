...
description: DocumentVisitor VisitTableStart método. Se llama cuando ha comenzado la enumeración de una tabla en C#.
type: docs
weight: 500
...
Se llama cuando ha comenzado la enumeración de una tabla.
