...
description: Descubra el método VisitTableStart de DocumentVisitor, esencial para gestionar eficientemente la enumeración de tablas en sus aplicaciones. ¡Mejore sus habilidades de programación hoy mismo!
type: docs
weight: 500
url: /es/net/aspose.words/documentvisitor/visittablestart/
---
## DocumentVisitor.VisitTableStart method

Se llama cuando se ha iniciado la enumeración de una tabla.
...
| --- | --- | --- |
| table | Table | El objeto que se está visitando. |
