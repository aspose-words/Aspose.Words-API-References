...
description: Descubra el método VisitDocumentStart en DocumentVisitor. Optimice el procesamiento de documentos con funciones de enumeración eficientes para un rendimiento óptimo.
type: docs
weight: 150
url: /es/net/aspose.words/documentvisitor/visitdocumentstart/
---
## DocumentVisitor.VisitDocumentStart method

Se llama cuando se ha iniciado la enumeración del documento.
...
| --- | --- | --- |
| doc | Document | El objeto que se está visitando. |
