...
description: DocumentVisitor VisitDocumentStart método. Se llama cuando ha comenzado la enumeración del documento en C#.
type: docs
weight: 150
...
Se llama cuando ha comenzado la enumeración del documento.
