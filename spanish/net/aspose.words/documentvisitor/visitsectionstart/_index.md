...
description: Descubra el método VisitSectionStart de DocumentVisitor, esencial para el seguimiento de la enumeración de secciones. ¡Mejore su eficiencia de codificación con esta potente herramienta!
type: docs
weight: 380
url: /es/net/aspose.words/documentvisitor/visitsectionstart/
---
## DocumentVisitor.VisitSectionStart method

Se llama cuando se ha iniciado la enumeración de una sección.
...
| --- | --- | --- |
| section | Section | El objeto que se está visitando. |
