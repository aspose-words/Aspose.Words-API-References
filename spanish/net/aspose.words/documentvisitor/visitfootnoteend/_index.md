...
description: Descubra el método VisitFootnoteEnd de DocumentVisitor, esencial para gestionar de manera eficiente la enumeración de texto de notas al pie y notas finales en sus aplicaciones.
type: docs
weight: 210
...
Se llama cuando finaliza la enumeración de un texto de nota al pie o nota final.
