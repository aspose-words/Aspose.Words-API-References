...
description: Descubra el método VisitGlossaryDocumentStart en DocumentVisitor. Gestione la enumeración de documentos del glosario de forma eficiente, sencilla y precisa.
type: docs
weight: 250
url: /es/net/aspose.words/documentvisitor/visitglossarydocumentstart/
---
## DocumentVisitor.VisitGlossaryDocumentStart method

Se llama cuando se inicia la enumeración de un documento de glosario.
