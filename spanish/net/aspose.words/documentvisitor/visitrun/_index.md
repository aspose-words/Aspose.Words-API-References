...
description: Explora el método VisitRun de DocumentVisitor para gestionar texto eficientemente en tus aplicaciones. ¡Mejora tu codificación con esta herramienta esencial!
type: docs
weight: 360
url: /es/net/aspose.words/documentvisitor/visitrun/
---
## DocumentVisitor.VisitRun method

Se llama cuando se encuentra una serie de texto en el.
...
| --- | --- | --- |
| run | Run | El objeto que se está visitando. |
