...
description: Explora el método VisitGlossaryDocumentEnd en DocumentVisitor. Descubre cómo mejora la enumeración de documentos del glosario para una gestión eficiente de los datos.
type: docs
weight: 240
url: /es/net/aspose.words/documentvisitor/visitglossarydocumentend/
---
## DocumentVisitor.VisitGlossaryDocumentEnd method

Se llama cuando finaliza la enumeración de un documento de glosario.
...
| --- | --- | --- |
| glossary | GlossaryDocument | El objeto que se está visitando. |
...
Nota: Un nodo de documento de glosario y sus hijos no se visitan cuando se ejecuta un Visitante sobre un[`Document`](../../document/) Si desea ejecutar un Visitante sobre un documento de glosario a , debe llamar[`Accept`](../../../aspose.words.buildingblocks/glossarydocument/accept/) .
