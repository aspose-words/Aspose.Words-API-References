...
description: Descubra el método VisitFormField de DocumentVisitor, que se activa al detectar un campo de formulario en su documento. ¡Mejore su procesamiento de documentos hoy mismo!
type: docs
weight: 230
url: /es/net/aspose.words/documentvisitor/visitformfield/
---
...
| --- | --- | --- |
| formField | FormField | El objeto que se está visitando. |
