...
description: Explore el método VisitBuildingBlockEnd de DocumentVisitor, que se activa al final de la enumeración de bloques de construcción para un procesamiento eficiente de los documentos.
type: docs
weight: 60
