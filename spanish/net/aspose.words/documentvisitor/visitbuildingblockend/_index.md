...
description: DocumentVisitor método. Se llama cuando finaliza la enumeración de un bloque de creación.
type: docs
weight: 60
...
Se llama cuando finaliza la enumeración de un bloque de creación.
