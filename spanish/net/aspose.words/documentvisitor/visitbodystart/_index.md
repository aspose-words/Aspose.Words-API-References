...
description: Descubra el método DocumentVisitor VisitBodyStart, esencial para enumerar eficientemente las historias de texto principales en sus secciones. ¡Mejore su flujo de trabajo de codificación hoy mismo!
type: docs
weight: 30
url: /es/net/aspose.words/documentvisitor/visitbodystart/
---
## DocumentVisitor.VisitBodyStart method

Se llama cuando ha comenzado la enumeración de la historia del texto principal en una sección.
...
| --- | --- | --- |
| body | Body | El objeto que se está visitando. |
