...
description: Descubra el método VisitRowStart de DocumentVisitor. Mejore la enumeración de filas de su tabla con un procesamiento eficiente y optimizado para un rendimiento óptimo.
type: docs
weight: 350
...
Se llama cuando se inicia la enumeración de una fila de la tabla.
