...
description: DocumentVisitor método. Llamado cuando un campo comienza en el documento.
type: docs
weight: 200
...
Llamado cuando un campo comienza en el documento.
...
[FieldStart]PÁGINA[FieldSeparator]98[FieldField]
