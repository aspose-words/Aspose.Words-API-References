...
description: Descubra el método GetChildNodes de CompositeNode: recupere sin esfuerzo una colección en vivo de nodos secundarios adaptados a su tipo específico para un mejor rendimiento.
type: docs
weight: 110
...
| --- | --- | --- |
| nodeType | NodeType | Especifica el tipo de nodos a seleccionar. |
| isDeep | Boolean | `verdadero` para seleccionar entre todos los nodos secundarios de forma recursiva; `FALSO` seleccionar sólo entre los hijos inmediatos. |

### Valor_devuelto

Una colección viva de nodos secundarios del tipo especificado.

## Observaciones

La colección de nodos devuelta por este método siempre está activa.

Una colección activa siempre está sincronizada con el documento. Por ejemplo, si selecciona todas las secciones de un documento y las enumera a través de la colección, eliminándolas, la sección se elimina de la colección inmediatamente después de eliminarse del documento.
