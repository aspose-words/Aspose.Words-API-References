...
description: Descubra cómo optimizar el procesamiento de documentos con el método AcceptEnd de CompositeNode. Optimice la implementación de patrones de visitantes para un rendimiento óptimo.
type: docs
weight: 60
url: /es/net/aspose.words/compositenode/acceptend/
---
## CompositeNode.AcceptEnd method

Cuando se implementa en una clase derivada, llama al método VisitXXXEnd del visitante del documento especificado.
