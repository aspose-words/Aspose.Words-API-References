...
description: CompositeNode método. Inserta el nodo especificado inmediatamente antes del nodo de referencia especificado.
type: docs
weight: 150
...
| refChild | Node | El nodo que es el nodo de referencia. El newChild se coloca antes de este nodo. |
...
Si refChild es nulo, inserta newChild al final de la lista de nodos secundarios.
