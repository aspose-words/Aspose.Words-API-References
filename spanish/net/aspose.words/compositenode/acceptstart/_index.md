...
description: Descubra cómo el método AcceptStart de CompositeNode mejora el procesamiento de documentos al invocar el método VisitXXXStart para una integración perfecta de los visitantes.
type: docs
weight: 70
url: /es/net/aspose.words/compositenode/acceptstart/
---
## CompositeNode.AcceptStart method

Cuando se implementa en una clase derivada, llama al método VisitXXXStart del visitante del documento especificado.
