...
description: Aspose.Words.NumberStyle enumeración. Especifica el estilo numérico de una lista notas al pie y notas finales números de página en C#.
type: docs
weight: 4310
...
| LowercaseRoman | `2` | Minúscula romana (i, ii, iii, ...) |
...
| DecimalFullWidth | `19` | Ancho decimal completo: 1, 2, 3, 4 |
...
| HindiCardinalText | `52` | Hindi descriptivo (cardenales) |
| ThaiLetter | `53` | letras tailandesas |
| ThaiArabic | `54` | números tailandeses |
| ThaiCardinalText | `55` | Descriptivo tailandés (cardenales) |
| VietCardinalText | `56` | Descriptivo vietnamita (cardenales) |
| NumberInDash | `57` | Formato del número de página: - 1 -, - 2 -, - 3 -, - 4 - |
