...
description: Descubra la clase Aspose.Words.PlainTextDocument para extraer y utilizar sin esfuerzo texto sin formato de sus documentos para mejorar la legibilidad y el procesamiento.
type: docs
weight: 5170
...
Para obtener más información, visite el[Trabajar con documentos de texto](https://docs.aspose.com/words/net/working-with-text-document/) Artículo de documentación.
