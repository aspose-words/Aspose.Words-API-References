...
description: ImageWatermarkOptions IsWashout propiedad. Obtiene o establece un valor booleano que es responsable del efecto de eliminación de la marca de agua. El valor predeterminado esverdadero  en C#.
type: docs
weight: 20
