...
description: Descubra el método AcceptStart para dar la bienvenida perfecta a los visitantes al comienzo de los comentarios, mejorando la participación y la interacción del usuario.
type: docs
weight: 150
url: /es/net/aspose.words/comment/acceptstart/
---
## Comment.AcceptStart method

Acepta un visitante por visitar el inicio del comentario.
