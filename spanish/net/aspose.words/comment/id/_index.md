...
El identificador de comentario permite anclar un comentario a una región de texto en el documento. La región debe delimitarse utilizando el[`CommentRangeStart`](../../commentrangestart/) y[`CommentRangeEnd`](../../commentrangeend/) objeto que comparte el mismo valor de identificador que el[`Comment`](../) objeto.
