...
description: Descubra cómo el método AcceptEnd mejora la experiencia del usuario al gestionar eficientemente las visitas a los comentarios. ¡Impulse la interacción con una aceptación fluida de los visitantes!
type: docs
weight: 140
url: /es/net/aspose.words/comment/acceptend/
---
## Comment.AcceptEnd method

Acepta un visitante por visitar el final del comentario.
