...
description: Descubra el método TabStop Equals para comparar instancias de TabStop de forma eficiente. ¡Mejore la precisión de su codificación y agilice su proceso de desarrollo!
type: docs
weight: 60
url: /es/net/aspose.words/tabstop/equals/
---
## TabStop.Equals method

Compara con el especificado[`TabStop`](../) .
