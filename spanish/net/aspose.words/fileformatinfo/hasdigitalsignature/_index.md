...
description: Devuelve verdadero si este documento contiene una firma digital. Esta propiedad simplemente informa que una firma digital está presente en un documento pero no especifica si la firma es válida o no.
type: docs
weight: 20
