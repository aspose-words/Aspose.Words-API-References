...
Cuando[`CommentRangeStart`](../../commentrangestart) se crea, pertenece al documento especificado, pero aún no es parte del documento y[`ParentNode`](../../node/parentnode) es nulo.

Para anexar un[`CommentRangeStart`](../../commentrangestart) al documento use InsertAfter o InsertBefore en el párrafo donde desea insertar el comentario.
