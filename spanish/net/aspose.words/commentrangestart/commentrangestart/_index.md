...
description: Descubra el constructor CommentRangeStart. Cree fácilmente nuevas instancias de esta clase para optimizar la codificación y agilizar el desarrollo.
type: docs
weight: 10
...
Para añadir un[`CommentRangeStart`](../) Para el documento use InsertAfter o InsertBefore en el párrafo donde desea insertar el comentario.
