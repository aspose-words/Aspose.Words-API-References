...
description: Descubra la propiedad TableStyle RowStripe para personalizar fácilmente las bandas de filas pares/impares para mejorar la legibilidad de la tabla y el atractivo visual.
type: docs
weight: 120
...
Obtiene o establece una cantidad de filas para incluir en las bandas cuando el estilo especifica bandas de filas pares/impares.
