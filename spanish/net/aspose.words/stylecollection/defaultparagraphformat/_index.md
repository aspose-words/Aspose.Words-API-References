...
description: Descubra la propiedad DefaultParagraphFormat de StyleCollection para acceder y personalizar fácilmente el formato de párrafo predeterminado de su documento para una mejor legibilidad.
type: docs
weight: 30
...
Tenga en cuenta que los valores predeterminados para todo el documento se introdujeron en Microsoft Word 2007 y son totalmente compatibles con los formatos OOXML (Docx) solamente. Los formatos de documentos anteriores no admiten el formato de párrafo predeterminado del documento.
