...
description: StyleCollection Add método. Crea un nuevo estilo definido por el usuario y lo agrega a la colección en C#.
type: docs
weight: 60
...
| name | String | Nombre que distingue entre mayúsculas y minúsculas del estilo a crear. |
