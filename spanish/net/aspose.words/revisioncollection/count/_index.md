...
description: Descubra la propiedad RevisionCollection Count, que revela de manera eficiente el número total de revisiones, mejorando la gestión y el seguimiento de sus datos.
type: docs
weight: 10
