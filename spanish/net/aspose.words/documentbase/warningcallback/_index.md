...
description: DocumentBase propiedad. Llamado durante varios procedimientos de procesamiento de documentos cuando se detecta un problema que podría resultar en datos o pérdida de fidelidad de formato.
type: docs
weight: 90
