...
description: Obtiene o establece el color de página del documento. Esta propiedad es una versión más simple deBackgroundShapeaspose.words/documentbase/backgroundshape/ .
type: docs
weight: 60
