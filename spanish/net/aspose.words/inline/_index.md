...
description: Aspose.Words.Inline clase. Clase base para nodos de nivel en línea que pueden tener formato de caracteres asociado pero no pueden tener nodos secundarios propios.
type: docs
weight: 3060
...
Clase base para nodos de nivel en línea que pueden tener formato de caracteres asociado, pero no pueden tener nodos secundarios propios.
...
Una clase derivada de **En línea** puede ser hijo de **Párrafo**.
