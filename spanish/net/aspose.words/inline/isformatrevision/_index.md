...
description: Descubra la propiedad IsFormatRevision en línea en Microsoft Word. Indica si el formato del objeto cambió con el seguimiento de cambios habilitado, lo que mejora la gestión de documentos.
type: docs
weight: 30
