...
description: Optimice su contenido con el método EnsureMinimum de InlineStory, que agrega un párrafo si el último hijo no lo es, mejorando la legibilidad y la estructura.
type: docs
weight: 120
