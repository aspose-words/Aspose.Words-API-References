...
description: Descubra la propiedad IsMoveToRevision de InlineStory, realice un seguimiento fácil de los cambios en Microsoft Word con estado verdadero/falso para una edición fluida de documentos.
type: docs
weight: 60
