...
description: Descubre la propiedad StoryType de InlineStory, que revela el tipo único de tu historia. ¡Mejora tu narrativa con una categorización precisa!
type: docs
weight: 100
url: /es/net/aspose.words/inlinestory/storytype/
---
## InlineStory.StoryType property

Devuelve el tipo de historia.
