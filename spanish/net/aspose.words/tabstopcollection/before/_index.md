...
description: TabStopCollection método. Obtiene una primera tabulación a la izquierda de la posición especificada.
type: docs
weight: 50
...
Salta tabulaciones con **Alineación** ajustado a`TabAlignment.Bar`.
