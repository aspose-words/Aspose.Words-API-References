...
description: Habilite Document TrackRevisions para rastrear automáticamente las ediciones en Microsoft Word, lo que garantiza una colaboración fluida y un control de versiones preciso.
type: docs
weight: 450
...
Verdadero si se rastrean los cambios cuando se edita este documento en Microsoft Word.
...
Al configurar esta opción, Microsoft Word solo indica si el control de cambios está activado o desactivado. Esta propiedad no afecta a los cambios realizados en el documento mediante programación mediante Aspose.Words.

Si desea realizar un seguimiento automático de los cambios a medida que Aspose.Words los realiza programáticamente en este documento, utilice el[`StartTrackRevisions`](../starttrackrevisions/) método.
