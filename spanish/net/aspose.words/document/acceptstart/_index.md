...
description: Descubra el método AcceptStart, dé la bienvenida sin problemas a los visitantes al comienzo de su documento para una experiencia de usuario mejorada y una navegación más fluida.
type: docs
weight: 560
url: /es/net/aspose.words/document/acceptstart/
---
## Document.AcceptStart method

Acepta un visitante por visitar el inicio del documento.
