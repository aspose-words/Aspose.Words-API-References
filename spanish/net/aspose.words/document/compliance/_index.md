...
description: Document propiedad. Obtiene la versión de conformidad con OOXML determinada a partir del contenido del documento cargado. Solo tiene sentido para documentos OOXML.
type: docs
weight: 60
