...
description: Document Compliance propiedad. Obtiene la versión de cumplimiento de OOXML determinada a partir del contenido del documento cargado. Tiene sentido sólo para documentos OOXML en C#.
type: docs
weight: 60
