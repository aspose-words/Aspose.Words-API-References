...
description: Explora el método "AcceptEnd" del documento para gestionar eficientemente el acceso de los visitantes al final del documento. Mejora la experiencia del usuario con una navegación fluida.
type: docs
weight: 550
url: /es/net/aspose.words/document/acceptend/
---
## Document.AcceptEnd method

Acepta que un visitante visite el final del documento.
