...
description: Devuelve elDocumentaspose.words/document objeto que representa el rango especificado de páginas.
type: docs
weight: 580
...
Devuelve el[`Document`](../../document) objeto que representa el rango especificado de páginas.
