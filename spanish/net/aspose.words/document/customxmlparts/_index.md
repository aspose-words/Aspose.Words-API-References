...
description: Explora la propiedad Document CustomXmlParts para administrar eficientemente las partes de almacenamiento de datos XML personalizadas. ¡Mejora la funcionalidad de tu documento hoy mismo!
type: docs
weight: 90
url: /es/net/aspose.words/document/customxmlparts/
---
## Document.CustomXmlParts property

Obtiene o establece la colección de partes de almacenamiento de datos XML personalizadas.
...
Aspose.Words carga y guarda partes XML personalizadas únicamente en documentos OOXML y DOC.
