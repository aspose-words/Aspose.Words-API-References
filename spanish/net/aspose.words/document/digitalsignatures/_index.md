...
description: Obtiene la colección de firmas digitales para este documento y sus resultados de validación.
type: docs
weight: 100
...
Esta colección contiene firmas digitales que se cargaron desde el documento original. Estas firmas digitales no se guardarán cuando guarde este[`Document`](../../document) object en un archivo o secuencia porque guardar o convertir producirá un documento que es diferente del original y las firmas digitales originales ya no serán válidas.
