...
Obtiene o establece el documento de glosario dentro de este documento o plantilla. Un documento de glosario es un almacenamiento para entradas de Autotexto, Autocorrección y Bloques de creación definidas en un documento.
