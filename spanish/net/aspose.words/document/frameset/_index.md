...
description: Document Frameset propiedad. Devuelve unFramesetejemplo si este documento representa una página de marcos en C#.
type: docs
weight: 160
...
Devuelve un`Frameset`ejemplo si este documento representa una página de marcos.
