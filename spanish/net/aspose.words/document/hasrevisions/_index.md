...
description: Descubra si su documento tiene seguimiento de cambios con la propiedad HasRevisions. Gestione fácilmente las ediciones y mejore la eficiencia de su flujo de trabajo.
type: docs
weight: 210
url: /es/net/aspose.words/document/hasrevisions/
---
## Document.HasRevisions property

Devuelve`verdadero` si el documento tiene algún cambio registrado.
...
Esta propiedad es un atajo para comparar[`Count`](../../revisioncollection/count/) a cero.
