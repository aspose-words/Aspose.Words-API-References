...
description: Acceda a la propiedad Bibliografía del documento para recuperar una lista completa de fuentes, mejorando su investigación y la precisión de las citas.
type: docs
weight: 40
url: /es/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Obtiene el`Bibliography`objeto que representa la lista de fuentes disponibles en el documento.
