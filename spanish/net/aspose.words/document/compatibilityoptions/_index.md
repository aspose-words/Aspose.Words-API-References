...
description: Acceda a las opciones de compatibilidad de documentos de Word para personalizar las preferencias del usuario y mejorar su experiencia de edición con configuraciones personalizadas para una colaboración perfecta.
type: docs
weight: 60
...
Proporciona acceso a las opciones de compatibilidad de documentos (es decir, las preferencias del usuario ingresadas en el**Compatibilidad** Pestaña de la**Opciones**diálogo en Word).
