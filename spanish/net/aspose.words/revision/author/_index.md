...
description: Gestiona fácilmente a tu autor de revisión. Configura o actualiza fácilmente los datos del autor para cada revisión, garantizando claridad y transparencia en tus documentos.
type: docs
weight: 10
url: /es/net/aspose.words/revision/author/
---
## Revision.Author property

Obtiene o establece el autor de esta revisión. No puede ser una cadena vacía ni`nulo` .
