...
description: Descubra la propiedad ParentNode de Revisión, que identifica el nodo padre directo de cualquier tipo de revisión, excepto StyleDefinitionChange. ¡Mejore su eficiencia de codificación!
type: docs
weight: 40
url: /es/net/aspose.words/revision/parentnode/
---
## Revision.ParentNode property

Obtiene el nodo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará para cualquier tipo de revisión que no seaStyleDefinitionChange .
...
Si esta revisión se relaciona con un cambio de formato de estilo, utilice[`ParentStyle`](../parentstyle/) en su lugar.
