...
description: Revision propiedad. Obtiene el grupo de revisión. Devuelve nulo si la revisión no pertenece a ningún grupo.
type: docs
weight: 30
...
La revisión no tiene grupo si el tipo de revisión es RevisionType.StyleDefinitionChange o si la revisión ya no existe en el contexto del documento (aceptada/rechazada).
