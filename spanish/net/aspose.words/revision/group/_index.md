...
description: Descubra la propiedad Grupo de Revisión, recupere fácilmente grupos de revisión o devuelva el valor nulo si no existe ningún grupo. ¡Simplifique la gestión de sus datos hoy mismo!
type: docs
weight: 30
url: /es/net/aspose.words/revision/group/
---
## Revision.Group property

Obtiene el grupo de revisión. Devuelve`nulo` si la revisión no pertenece a ningún grupo.
...
La revisión no tiene grupo si el tipo de revisión esStyleDefinitionChange o si la revisión ya no existe en el contexto del documento (aceptada/rechazada).
