...
description: Crea y personaliza fácilmente tu instancia de clase Run. Aprovecha funciones potentes para optimizar el rendimiento y mejorar la funcionalidad.
type: docs
weight: 10
...
Para anexar[`Run`](../) al uso del documento[`InsertAfter`](../../compositenode/insertafter/) o[`InsertBefore`](../../compositenode/insertbefore/) en el párrafo donde desea insertar la ejecución.
