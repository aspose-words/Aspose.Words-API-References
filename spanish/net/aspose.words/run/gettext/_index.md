...
description: Recupera texto fácilmente con el método GetText. Simplifica tu codificación con esta herramienta esencial para una gestión de texto eficiente.
type: docs
weight: 70
