...
description: ¡Administra tu texto de ejecución sin esfuerzo! Obtén o configura fácilmente las propiedades del texto de ejecución para una edición fluida de documentos y un mejor control del contenido.
type: docs
weight: 50
url: /es/net/aspose.words/run/text/
---
## Run.Text property

Obtiene o establece el texto de la ejecución.
