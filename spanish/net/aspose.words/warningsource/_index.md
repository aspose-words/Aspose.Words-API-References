...
description: Aspose.Words.WarningSource enumeración. Especifica el módulo que produce una advertencia durante la carga o el guardado del documento.
type: docs
weight: 6650
...
| DrawingML | `2` | Módulo que representa formas de DrawingML. |
| OfficeMath | `3` | Módulo que renderiza OfficeMath. |
| Shapes | `4` | Módulo que renderiza formas ordinarias. |
| Metafile | `5` | Módulo que representa metarchivos. |
...
| Nrx | `14` | Módulos comunes que se comparten entre módulos de lectura/grabación DOCX/WML. |
