...
description: Descubra el método Body AcceptStart para integrar perfectamente a los visitantes al comienzo del cuerpo de su documento para una mejor experiencia del usuario.
type: docs
weight: 60
url: /es/net/aspose.words/body/acceptstart/
---
## Body.AcceptStart method

Acepta un visitante por visitar el inicio del cuerpo del documento.
