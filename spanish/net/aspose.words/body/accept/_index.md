...
description: Body método. Acepta un visitante.
type: docs
weight: 40
...
Llama a DocumentVisitor.VisitBodyStart, luego llama a Accept para todos los nodos secundarios de la sección y llama a DocumentVisitor.VisitBodyEnd al final.
