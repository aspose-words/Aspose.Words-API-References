...
description: Style propiedad. Proporciona acceso a las propiedades de formato de lista de un estilo de párrafo.
type: docs
weight: 100
...
Esta propiedad solo es válida para estilos de párrafo. Para otros tipos de estilo, esta propiedad devuelve nulo.
