...
description: Style ParagraphFormat propiedad. Obtiene el formato de párrafo del estilo en C#.
type: docs
weight: 140
...
Para estilos de carácter y lista, esta propiedad devuelve`nulo`.
