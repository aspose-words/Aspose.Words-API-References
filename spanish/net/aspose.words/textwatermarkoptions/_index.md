...
description: Aspose.Words.TextWatermarkOptions clase. Contiene opciones que se pueden especificar al agregar una marca de agua con texto en C#.
type: docs
weight: 6440
...
| Nombre | Descripción |
| --- | --- |
| [Color](../../aspose.words/textwatermarkoptions/color/) { get; set; } | Obtiene o establece el color de fuente. El valor predeterminado esSilver . |
