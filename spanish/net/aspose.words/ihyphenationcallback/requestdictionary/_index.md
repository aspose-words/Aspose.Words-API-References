...
description: IHyphenationCallback método. Notifica a la aplicación que no se encontró el diccionario de separación de palabras para el idioma especificado y que es posible que sea necesario registrarlo.
type: docs
weight: 10
