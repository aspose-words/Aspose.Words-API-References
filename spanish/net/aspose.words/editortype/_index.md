...
description: Especifica el conjunto de posibles alias o grupos de edición que se pueden usar como alias para determinar si el usuario actual podrá editar un solo rango definido por un rango editable dentro de un documento.
type: docs
weight: 1300
