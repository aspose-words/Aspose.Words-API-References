...
description: Aspose.Words.EditableRangeEnd clase. Representa el final de un rango editable en un documento de Word.
type: docs
weight: 1280
...
| [EditableRangeStart](../../aspose.words/editablerangeend/editablerangestart/) { get; } | EditableRangeStart correspondiente, recibido por ID. |
...
| override [NodeType](../../aspose.words/editablerangeend/nodetype/) { get; } | DevolucionesEditableRangeEnd . |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.words/editablerangeend/accept/)(DocumentVisitor) | Acepta un visitante. |
