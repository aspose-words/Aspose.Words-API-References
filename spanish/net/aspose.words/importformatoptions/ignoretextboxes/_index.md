...
description: Obtiene o establece un valor booleano que especifica que el formato de origen del contenido de los cuadros de texto se ignora siKeepSourceFormatting se utiliza el modo. El valor predeterminado esverdadero .
type: docs
weight: 40
