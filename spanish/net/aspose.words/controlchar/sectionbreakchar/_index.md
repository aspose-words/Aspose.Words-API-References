...
description: Descubra el campo ControlChar SectionBreakChar, optimice el formato de su documento con el carácter esencial de final de sección para un flujo de texto continuo.
type: docs
weight: 250
url: /es/net/aspose.words/controlchar/sectionbreakchar/
---
