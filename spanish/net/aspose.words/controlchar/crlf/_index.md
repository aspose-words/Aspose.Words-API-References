...
description: Retorno de carro seguido de carácter de avance de línea x000dx000a o rn. No se usa como tal en documentos de Microsoft Word pero se usa comúnmente en archivos de texto para saltos de párrafo.
type: docs
weight: 60
