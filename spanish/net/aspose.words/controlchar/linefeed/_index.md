...
description: Descubra el campo ControlChar LineFeed, comprenda el carácter de avance de línea (x000a) para un formato de texto perfecto y un mejor manejo de datos.
type: docs
weight: 140
...
Carácter de avance de línea: "\x000a" o "\n". Igual que[`Lf`](../lf/) .
