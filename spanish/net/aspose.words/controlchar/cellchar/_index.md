...
description: Descubra el campo ControlChar CellChar para una gestión de tablas fluida. Mejore la organización de sus datos con eficientes caracteres de fin de celda y de fila.
type: docs
weight: 20
...
Carácter de fin de celda de tabla o de fin de fila de tabla: (char)7 o "\a".
