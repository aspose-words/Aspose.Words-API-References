...
description: Descubra el campo ControlChar DefaultTextInputChar, que incluye el carácter "o" como valor predeterminado ideal para sus formularios de entrada de texto. ¡Mejore la experiencia del usuario!
type: docs
weight: 70
url: /es/net/aspose.words/controlchar/defaulttextinputchar/
---
## ControlChar.DefaultTextInputChar field

Este es el carácter "o" utilizado como valor predeterminado en los campos de formulario de entrada de texto.
