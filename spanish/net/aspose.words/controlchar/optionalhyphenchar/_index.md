...
description: ControlChar campo. Guión opcional en Microsoft Word es char31.
type: docs
weight: 190
...
Guión opcional en Microsoft Word es (char)31.
...
Guión opcional en Microsoft Word no corresponde al carácter Unicode U+00AD guión suave. En su lugar, inserta información interna que informa a Word sobre un posible punto de partición.
