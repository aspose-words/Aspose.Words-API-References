...
description: Descubra cómo usar el guion opcional en Microsoft Word (char31) para mejorar el formato y la legibilidad de sus documentos. ¡Aprenda más ahora!
type: docs
weight: 190
...
El guión opcional en Microsoft Word es (char)31.
...
El guión opcional en Microsoft Word no corresponde al carácter Unicode U+00AD guión suave. En su lugar, inserta información interna que le indica a Word un posible punto de separación de palabras.
