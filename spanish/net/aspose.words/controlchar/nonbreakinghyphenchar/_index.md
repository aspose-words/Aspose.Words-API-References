...
description: Descubra el carácter de guion indivisible en Microsoft Word. Mejore la fluidez del texto de sus documentos con char30 para obtener resultados profesionales.
type: docs
weight: 160
...
El guión no divisible en Microsoft Word es (char)30.
...
El guión indivisible en Microsoft Word no corresponde al carácter Unicode U+2011 guión indivisible sino que representa información interna que le indica a Microsoft Word que muestre un guión y no divida una línea.
