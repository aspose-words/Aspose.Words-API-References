...
description: Descubra el campo ControlChar ParagraphBreakChar, optimice el formato de su texto con el carácter esencial de final de párrafo para una edición eficiente de documentos.
type: docs
weight: 230
url: /es/net/aspose.words/controlchar/paragraphbreakchar/
---
