...
description: Descubra el campo Celda ControlChar, la clave para definir los finales de celda y fila de una tabla con el carácter x0007. ¡Mejore la organización de sus datos sin esfuerzo!
type: docs
weight: 10
url: /es/net/aspose.words/controlchar/cell/
---
## ControlChar.Cell field

Carácter de fin de celda de tabla o de final de fila de tabla: "\x0007" o "\a".
