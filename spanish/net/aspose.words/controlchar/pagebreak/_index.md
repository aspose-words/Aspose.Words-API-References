...
description: Descubra el campo ControlChar PageBreak y administre los saltos de página eficientemente con el carácter x000c. ¡Simplifique el formato de sus documentos hoy mismo!
type: docs
weight: 200
...
Carácter de salto de página: "\x000c" o "\f". Tenga en cuenta que tiene el mismo valor que[`SectionBreak`](../sectionbreak/) .
