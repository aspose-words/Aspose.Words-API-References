...
description: Descubra el campo Salto de párrafo ControlChar. Gestione fácilmente los saltos de párrafo con el carácter x000d para un formato de texto uniforme y una mejor legibilidad.
type: docs
weight: 220
url: /es/net/aspose.words/controlchar/paragraphbreak/
---
## ControlChar.ParagraphBreak field

Carácter de fin de párrafo: "\x000d" o "\r". Igual que[`Cr`](../cr/)
