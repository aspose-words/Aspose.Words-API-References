...
description: Descubra el campo ControlChar SectionBreak, administre de manera eficiente las secciones del documento con el carácter x000c, mejorando el formato y la legibilidad.
type: docs
weight: 240
...
Carácter de fin de sección: "\x000c" o "\f". Tenga en cuenta que tiene el mismo valor que[`PageBreak`](../pagebreak/) .
