...
description: Mejore sin esfuerzo sus documentos con el método InsertImage de DocumentBuilder, que permite la inserción perfecta de imágenes .NET a escala completa para obtener imágenes sorprendentes.
type: docs
weight: 400
...
| --- | --- | --- |
| image | Image | La imagen para insertar en el documento. |
...
Inserta una imagen desde un archivo o URL en el documento. La imagen se inserta en línea y a una escala del 100%.
...
| Parámetro | Escribe | Descripción |
| --- | --- | --- |
| fileName | String | El archivo con la imagen. Puede ser cualquier URI local o remota válida. |
...
//Podemos insertar una imagen gif usando la ruta o una matriz de bytes.
// Solo funciona si DocumentBuilder está optimizado para Word versión 2010 o superior.
...
// 2 - Pasa una URL que apunta a una imagen.
...
// Aspose.Words inserta una imagen SVG en el documento como PNG con la extensión vectorizada
...
// Aspose.Words inserta una imagen SVG en el documento como PNG, tal como lo hace Microsoft Word con el formato antiguo.
...
Inserta una imagen de una secuencia en el documento. La imagen se inserta en línea y a una escala del 100%.
...
Muestra cómo insertar una forma con una imagen desde una secuencia en un documento.
...
Muestra cómo insertar una imagen desde una secuencia en un documento.
...
Inserta una imagen de una matriz de bytes en el documento. La imagen se inserta en línea y a una escala del 100%.
...
Inserta una imagen en línea desde un .NETImage objeto en el documento y lo escala al tamaño especificado.
...
Inserta una imagen en línea desde una secuencia en el documento y la escala al tamaño especificado.
...
// Pasar valores negativos como dimensiones deseadas definirá automáticamente
// las dimensiones de la forma en función de las dimensiones de su imagen.
...
Inserta una imagen desde una secuencia en la posición y tamaño especificados.
...
Inserta una imagen de una matriz de bytes en la posición y tamaño especificados.
