...
description: Inserta una ruptura del tipo especificado en el documento.
type: docs
weight: 240
...
| --- | --- | --- |
| breakType | BreakType | Especifica el tipo de ruptura a insertar. |

### Observaciones

Utilice este método para insertar saltos de párrafo, página, columna, sección o línea en el documento.
