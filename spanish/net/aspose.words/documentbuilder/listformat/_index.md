...
description: Explore la propiedad ListFormat de DocumentBuilder para acceder y personalizar su configuración de formato de lista actual para un diseño mejorado del documento.
type: docs
weight: 150
