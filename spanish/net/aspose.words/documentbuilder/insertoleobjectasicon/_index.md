...
description: DocumentBuilder método. Inserta un objeto OLE incrustado o vinculado como icono en el documento. Permite especificar el archivo de icono y el título. Detecta el tipo de objeto OLE utilizando la extensión de archivo.
type: docs
weight: 380
