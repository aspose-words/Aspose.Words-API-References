...
description: Acceda fácilmente al párrafo seleccionado en DocumentBuilder con la propiedad CurrentParagraph. ¡Optimice su proceso de edición de documentos hoy mismo!
type: docs
weight: 50
...
Obtiene el párrafo que está seleccionado actualmente en este[`DocumentBuilder`](../) .
