...
description: Descubra la propiedad IsAtStartOfParagraph de DocumentBuilder. Compruebe fácilmente si el cursor está al principio del párrafo para una edición de texto eficiente.
type: docs
weight: 130
...
Devuelve`verdadero`si el cursor está al principio del párrafo actual (no hay texto antes del cursor).
