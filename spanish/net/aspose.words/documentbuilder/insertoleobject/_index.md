...
description: Inserta un objeto OLE incrustado de una secuencia en el documento.
type: docs
weight: 370
...
Muestra cómo usar el generador de documentos para incrustar objetos OLE en un documento.
...
// Esta vez, tendrá una imagen descargada de la web como icono.
...
Inserta un objeto OLE incrustado o vinculado desde un archivo en el documento. Detecta el tipo de objeto OLE utilizando la extensión de archivo.
...
Inserta un objeto OLE incrustado o vinculado desde un archivo en el documento. Detecta el tipo de objeto OLE usando el parámetro progID dado.
