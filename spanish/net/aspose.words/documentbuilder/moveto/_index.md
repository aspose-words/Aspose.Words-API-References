...
description: Descubra el método MoveTo de DocumentBuilder para navegar fácilmente por los nodos en línea y posicionar eficientemente el cursor en los finales de los párrafos para una edición fluida de documentos.
type: docs
weight: 520
...
Cuandonodo es un nodo a nivel de bloque pero no un[`Paragraph`](../../paragraph/), el cursor se mueve al final del primer párrafo al nodo de nivel de bloque y se insertará más contenido justo antes del salto de párrafo.
