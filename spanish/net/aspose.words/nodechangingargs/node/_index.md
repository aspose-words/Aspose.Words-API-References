...
description: Descubre la propiedad NodeChangingArgs para gestionar fácilmente la adición o eliminación de nodos en tu aplicación. ¡Optimiza tu flujo de trabajo hoy mismo!
type: docs
weight: 30
url: /es/net/aspose.words/nodechangingargs/node/
---
## NodeChangingArgs.Node property

Obtiene el`Node` que se está agregando o eliminando.
