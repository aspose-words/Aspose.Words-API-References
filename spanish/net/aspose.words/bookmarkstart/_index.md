...
description: Descubre la clase Aspose.Words.BookmarkStart, esencial para gestionar marcadores en documentos de Word. ¡Mejora tu experiencia de edición de documentos hoy mismo!
type: docs
weight: 260
...
| override [NodeType](../../aspose.words/bookmarkstart/nodetype/) { get; } | DevuelveBookmarkStart . |
...
Un marcador completo en un documento de Word consta de un`BookmarkStart` y un equivalente[`BookmarkEnd`](../bookmarkend/) con el mismo nombre de marcador.
