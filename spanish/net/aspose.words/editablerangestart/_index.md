...
description: Descubra la clase Aspose.Words.EditableRangeStart, su clave para administrar rangos editables en documentos de Word para un mejor control y flexibilidad del documento.
type: docs
weight: 1850
...
| [EditableRange](../../aspose.words/editablerangestart/editablerange/) { get; } | Obtiene el objeto de fachada que encapsula este inicio y final del rango editable. |
...
| override [NodeType](../../aspose.words/editablerangestart/nodetype/) { get; } | DevuelveEditableRangeStart . |
...
Un rango editable completo en un documento de Word consta de una`EditableRangeStart` y un equivalente[`EditableRangeEnd`](../editablerangeend/) con el mismo Id.
...
Utilice el[`EditableRange`](./editablerange/) clase como "fachada" para trabajar con un rango editable como un solo objeto.
