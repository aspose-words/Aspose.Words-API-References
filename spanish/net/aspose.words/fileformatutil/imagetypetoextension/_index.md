...
description: FileFormatUtil método. Convierte un valor enumerado de tipo de imagen de Aspose.Words en una extensión de archivo. La extensión devuelta es una cadena en minúsculas con un punto inicial.
type: docs
weight: 50
