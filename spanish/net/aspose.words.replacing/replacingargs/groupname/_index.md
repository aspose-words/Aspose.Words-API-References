...
description: Identifica por su nombre un grupo capturado en elMatchaspose.words.replacing/replacingargs/match que se va a reemplazar con elReplacementaspose.words.replacing/replacingargs/replacement cadena.
type: docs
weight: 20
