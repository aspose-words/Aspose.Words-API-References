...
description: Descubra el método GetNumPagesSpanned de LayoutCollector para determinar eficientemente cuántas páginas abarca un nodo. ¡Simplifique su gestión documental hoy mismo!
type: docs
weight: 60
