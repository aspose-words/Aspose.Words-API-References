...
description: Descubra el método GetEndPageIndex de LayoutCollector para encontrar fácilmente el índice basado en 1 de la página final de un nodo. ¡Simplifique la asignación de páginas hoy mismo!
type: docs
weight: 40
