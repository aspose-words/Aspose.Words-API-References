...
description: Restablezca LayoutEnumerator a la primera página del documento, lo que mejora la navegación y la eficiencia para una gestión fluida de los documentos.
type: docs
weight: 170
...
Mueve el enumerador a la primera página del documento.
