...
description: Se mueve a la siguiente entidad hermana en un orden lógico. Al iterar líneas de un párrafo dividido en páginas este método se moverá a la siguiente línea incluso si reside en otra página.
type: docs
weight: 120
