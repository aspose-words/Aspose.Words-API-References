...
description: LayoutEnumerator método. Se mueve a la entidad padre.
type: docs
weight: 130
...
| --- | --- | --- |
| types | LayoutEntityType | El tipo de entidad principal al que se va a mover. Utilice OR bit a bit para especificar varios tipos principales. |

### Observaciones

Este método es útil si necesita encontrar la celda, la columna o el encabezado/pie de página principal de la entidad.
