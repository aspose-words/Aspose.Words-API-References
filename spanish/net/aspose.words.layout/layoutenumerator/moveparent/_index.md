...
description: Descubra el método MoveParent de LayoutEnumerator para navegar sin esfuerzo a las entidades principales, mejorando la eficiencia de la gestión de datos.
type: docs
weight: 140
...
| --- | --- | --- |
| types | LayoutEntityType | El tipo de entidad principal al que se moverá. Use OR bit a bit para especificar varios tipos principales. |
