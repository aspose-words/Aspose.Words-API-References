...
description: Descubra el método MovePreviousLogical de LayoutEnumerator para navegar de manera eficiente entre entidades hermanas y manejar líneas de párrafos en diferentes páginas sin problemas.
type: docs
weight: 160
...
Se mueve a la entidad hermana anterior en un orden lógico. Al iterar líneas de un párrafo dividido en varias páginas, este método se moverá a la línea anterior incluso si reside en otra página.
