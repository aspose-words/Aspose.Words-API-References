...
description: Se mueve a la entidad hermana anterior en un orden lógico. Al iterar líneas de un párrafo dividido en páginas este método se moverá a la línea anterior incluso si reside en otra página.
type: docs
weight: 150
