...
description: Se mueve a la siguiente entidad hermana en orden visual. Al iterar líneas de un párrafo dividido en páginas este método no se moverá a la página siguiente sino a la siguiente entidad en la misma página.
type: docs
weight: 110
