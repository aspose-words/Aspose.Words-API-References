...
description: Descubra el método MoveNext de LayoutEnumerator para navegar visualmente entre entidades hermanas. Recorra las líneas de párrafo de forma eficiente sin cruzar páginas.
type: docs
weight: 120
...
Se mueve a la siguiente entidad hermana en orden visual. Al iterar líneas de un párrafo dividido en varias páginas, este método no se moverá a la página siguiente, sino que se moverá a la siguiente entidad en la misma página.
