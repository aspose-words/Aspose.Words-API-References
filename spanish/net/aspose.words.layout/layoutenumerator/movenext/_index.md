...
Se mueve a la siguiente entidad hermana en orden visual. Al iterar líneas de un párrafo divididas en páginas, este método no se moverá a la página siguiente, sino que se moverá a la siguiente entidad en la misma página.
