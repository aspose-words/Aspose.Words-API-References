...
description: Descubra cómo el método LayoutEnumerator MovePrevious navega de manera eficiente a la entidad hermana anterior, mejorando su flujo de trabajo de codificación.
type: docs
weight: 150
url: /es/net/aspose.words.layout/layoutenumerator/moveprevious/
---
## LayoutEnumerator.MovePrevious method

Se mueve a la entidad hermana anterior.
