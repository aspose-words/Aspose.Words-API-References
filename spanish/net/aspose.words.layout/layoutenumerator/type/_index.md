...
description: Descubra la propiedad Tipo LayoutEnumerator, acceda fácilmente al tipo de entidad actual para un manejo optimizado de los datos y un mejor rendimiento de la aplicación.
type: docs
weight: 90
