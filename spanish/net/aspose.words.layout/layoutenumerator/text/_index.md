...
description: Descubra la propiedad Text de LayoutEnumerator para recuperar fácilmente el texto de la entidad de intervalo actual. ¡Simplifique la gestión de datos con esta potente función!
type: docs
weight: 80
...
Obtiene el texto de la entidad de intervalo actual. Se lanza para otros tipos de entidad.
