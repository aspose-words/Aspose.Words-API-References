...
description: Descubra la propiedad PageIndex de LayoutEnumerator. Recupere fácilmente el índice basado en 1 de la página que contiene su entidad actual para una navegación fluida.
type: docs
weight: 60
...
Obtiene el índice basado en 1 de una página que contiene la entidad actual.
