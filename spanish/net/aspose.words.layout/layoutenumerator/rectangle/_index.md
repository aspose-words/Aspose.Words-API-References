...
description: Descubra la propiedad Rectángulo de LayoutEnumerator. Obtenga rectángulos delimitadores precisos de entidades con respecto a la esquina superior izquierda de la página en puntos.
type: docs
weight: 70
...
Devuelve el rectángulo delimitador de la entidad actual en relación con la esquina superior izquierda de la página (en puntos).
