...
description: RevisionOptions propiedad. Permite especificar si se debe mostrar el texto original en lugar del revisado. El valor por defecto es Falso.
type: docs
weight: 170
...
Permite especificar si se debe mostrar el texto original en lugar del revisado. El valor por defecto es Falso.
