...
description: Personaliza tus Opciones de Revisión con la propiedad DeletedTextColor para resaltar el contenido eliminado. El valor predeterminado es PorAutor. ¡Mejora la claridad de tu documento!
type: docs
weight: 30
url: /es/net/aspose.words.layout/revisionoptions/deletedtextcolor/
---
## RevisionOptions.DeletedTextColor property

Permite especificar el color que se utilizará para el contenido eliminadoDeletion . El valor predeterminado esByAuthor .
