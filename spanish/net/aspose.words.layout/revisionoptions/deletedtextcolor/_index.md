...
description: RevisionOptions DeletedTextColor propiedad. Permite especificar el color que se utilizará para el contenido eliminadoDeletion . El valor predeterminado esByAuthor  en C#.
type: docs
weight: 20
