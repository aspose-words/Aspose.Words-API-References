...
| Nombre | Descripción |
| --- | --- |
| [Notify](../../aspose.words.layout/ipagelayoutcallback/notify/)(PageLayoutCallbackArgs) | Esto se llama para notificar la construcción del diseño y el progreso del renderizado. |

### Observaciones

El uso principal de esta interfaz es permitir que el código de la aplicación cancele el proceso de compilación.

Es posible crear un modelo de diseño de página solo para unas pocas páginas al comienzo del documento, luego cancelar el proceso y representar solo lo que ya se ha creado.
