...
description: Aspose.Words.Layout.RevisionTextEffect enumeración. Permite especificar el efecto de decoración para las revisiones del texto del documento.
type: docs
weight: 3200
