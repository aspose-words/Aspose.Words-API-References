...
description: Cree informes potentes sin esfuerzo con el método Create de ReportBuilder, diseñado para agilizar su proceso de generación de informes y mejorar la productividad.
type: docs
weight: 10
url: /es/net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}

Crea una nueva instancia del procesador del generador de informes.
