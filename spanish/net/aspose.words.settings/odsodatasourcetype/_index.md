...
description: Aspose.Words.Settings.OdsoDataSourceType enumeración. Especifica el tipo de fuente de datos externa a la que se conectará como parte de la información de conexión ODSO.
type: docs
weight: 5590
...
Especifica el tipo de fuente de datos externa a la que se conectará como parte de la información de conexión ODSO.
...
| None | `7` | No se especifica el tipo de fuente de datos externa. Posiblemente wdMergeSubTypeWord. |
