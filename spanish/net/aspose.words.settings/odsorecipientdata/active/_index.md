...
description: Especifica si el registro del origen de datos se importará a un documento cuando se realice la combinación de correspondencia. El valor predeterminado esverdadero .
type: docs
weight: 20
