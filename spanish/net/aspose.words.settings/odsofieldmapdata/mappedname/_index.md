...
description: Especifica el nombre de campo de combinación predefinido que se asignará al número de columna especificado por elColumnaspose.words.settings/odsofieldmapdata/column propiedad dentro de esta asignación de campo. El valor predeterminado es una cadena vacía.
type: docs
weight: 30
