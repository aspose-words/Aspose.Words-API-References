...
description: MailMergeSettings propiedad. Especifica que Microsoft Word mostrará los datos de la fuente de datos externa especificada donde se han insertado los campos de combinación por ejemplo obtener una vista previa de los datos combinados. El valor predeterminado esfalso .
type: docs
weight: 170
...
Especifica que Microsoft Word mostrará los datos de la fuente de datos externa especificada donde se han insertado los campos de combinación (por ejemplo, obtener una vista previa de los datos combinados). El valor predeterminado es`falso` .
