...
description: Especifica el tipo de fuente de datos de combinación de correspondencia y el método de acceso a los datos. El valor predeterminado esDefault .
type: docs
weight: 70
