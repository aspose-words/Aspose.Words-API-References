...
description: Mejore el diseño de las tablas con AllowSpaceOfSameStyleInTable de CompatibilityOptions. Disfrute de un espaciado de párrafo mejorado para una mejor legibilidad y un mejor diseño.
type: docs
weight: 30
