...
description: Optimice su interfaz de usuario con la opción CompatibilityOptions UICompat97To2003. Desactive las funciones no compatibles para un uso óptimo de Word 97-2003. ¡Mejore el rendimiento hoy mismo!
type: docs
weight: 570
url: /es/net/aspose.words.settings/compatibilityoptions/uicompat97to2003/
---
## CompatibilityOptions.UICompat97To2003 property

Verdadero para deshabilitar la funcionalidad de la interfaz de usuario que no es compatible con Word97-2003. El valor predeterminado es`FALSO` .
...
Controla la configuración de compatibilidad de Word97-2003 que deshabilita la funcionalidad de la interfaz de usuario que no es compatible con Word97-2003. Cuando`verdadero`El elemento XML 'w:uiCompat97To2003' se escribe en la parte del paquete del documento '\word\settings.xml' . El valor predeterminado es`FALSO` . Cuando se establece en`FALSO` , este elemento no está escrito. Técnicamente, esta propiedad no es parte de las opciones de compatibilidad, pero la hemos puesto aquí para conveniencia de la API.
