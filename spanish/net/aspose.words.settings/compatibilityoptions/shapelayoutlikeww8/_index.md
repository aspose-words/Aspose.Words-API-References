...
description: Descubra la propiedad CompatibilityOptions ShapeLayoutLikeWW8 para emular el ajuste de texto de Word 97 para un mejor control del formato y el diseño del documento.
type: docs
weight: 420
...
Emular el ajuste de texto de Word 97 alrededor de objetos flotantes.
