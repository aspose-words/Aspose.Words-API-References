...
description: Descubra la propiedad CompatibilityOptions SpacingInWholePoints para ajustar sin esfuerzo el espaciado del texto en puntos enteros para mejorar la legibilidad y el diseño.
type: docs
weight: 450
url: /es/net/aspose.words.settings/compatibilityoptions/spacinginwholepoints/
---
## CompatibilityOptions.SpacingInWholePoints property

Solo expandir/condensar texto en puntos enteros.
