...
description: Descubra la propiedad CompatibilityOptions DoNotBreakWrappedTables para evitar que las tablas flotantes se dividan entre páginas para lograr un diseño de documento uniforme.
type: docs
weight: 140
