...
description: Descubra la propiedad SplitPgBreakAndParaMark para CompatibilityOptions. Asegure un formato uniforme moviendo las marcas de párrafo a la página siguiente después de los saltos.
type: docs
weight: 460
...
Siempre mover la marca de párrafo a la página después de un salto de página.
