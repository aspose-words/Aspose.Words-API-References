...
description: Mejore el formato de sus documentos con CompatibilityOptions WPJustification. Emule a la perfección la justificación de párrafos de WordPerfect 6.x para obtener resultados impecables.
type: docs
weight: 690
...
Emular la justificación de párrafos de WordPerfect 6.x.
