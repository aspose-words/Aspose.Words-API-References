...
description: Descubra la propiedad SelectFldWithFirstOrLastChar para CompatibilityOptions. Seleccione fácilmente los campos según el primer o el último carácter para una mayor eficiencia.
type: docs
weight: 410
