...
description: Optimice su diseño con la propiedad CompatibilityOptions CachedColBalance. Mejore el balanceo de columnas con la información de párrafo en caché para un diseño uniforme.
type: docs
weight: 80
...
Utilizar información de párrafo almacenada en caché para equilibrar columnas.
