...
description: Mejore el formato de su texto con UseAltKinsokuLineBreakRules de CompatibilityOptions para mejorar los saltos de línea en Asia Oriental. ¡Optimice la legibilidad hoy mismo!
type: docs
weight: 600
...
Utilice un conjunto alternativo de reglas de salto de línea del este de Asia.
