...
description: Descubra la propiedad AlignTablesRowByRow para CompatibilityOptions. Alinee las filas de la tabla de forma independiente para un mayor control y flexibilidad del diseño.
type: docs
weight: 20
...
Alinear filas de tabla de forma independiente.
