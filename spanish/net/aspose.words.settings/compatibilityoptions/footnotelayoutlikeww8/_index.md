...
description: Optimice sus documentos con CompatibilityOptions FootnoteLayoutLikeWW8 para una colocación precisa de notas al pie, emulando Word 6.x/95/97 para un formato perfecto.
type: docs
weight: 260
...
Emular la ubicación de notas al pie de Word 6.x/95/97.
