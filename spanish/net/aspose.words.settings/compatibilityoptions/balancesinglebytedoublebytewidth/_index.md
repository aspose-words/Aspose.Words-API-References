...
description: Optimice la visualización del texto con la propiedad BalanceSingleByteDoubleByteWidth para una integración perfecta de caracteres de uno y dos bytes.
type: docs
weight: 70
...
Equilibrar caracteres de un solo byte y de dos bytes.
