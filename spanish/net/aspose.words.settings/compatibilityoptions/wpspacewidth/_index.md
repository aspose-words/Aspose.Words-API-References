...
description: Descubra cómo la propiedad CompatibilityOptions WPSpaceWidth le permite personalizar el ancho del espacio como en WordPerfect 5.x para un formato mejorado del documento.
type: docs
weight: 700
...
Especifica si se debe establecer el ancho de un espacio como se hace en WordPerfect 5.x.
