...
description: Descubra cómo la propiedad ForgetLastTabAlignment mejora la alineación del párrafo al ignorar el ancho de la última tabulación para el texto que no está alineado a la izquierda.
type: docs
weight: 270
url: /es/net/aspose.words.settings/compatibilityoptions/forgetlasttabalignment/
---
## CompatibilityOptions.ForgetLastTabAlignment property

Ignorar el ancho de la última tabulación al alinear el párrafo si no está alineado a la izquierda.
