...
description: Mejore el formato de texto del este de Asia con CompatibilityOptions LineWrapLikeWord6, emulando el ajuste de línea de Word 6.0 para mejorar la legibilidad y la presentación.
type: docs
weight: 310
url: /es/net/aspose.words.settings/compatibilityoptions/linewraplikeword6/
---
## CompatibilityOptions.LineWrapLikeWord6 property

Emular el ajuste de línea de Word 6.0 para texto de Asia Oriental.
