...
description: Optimice su impresión con la propiedad UsePrinterMetrics de CompatibilityOptions para una visualización precisa de los documentos. ¡Mejore el rendimiento y la calidad sin esfuerzo!
type: docs
weight: 640
...
Usar las métricas de la impresora para mostrar documentos.
...
Las métricas de la impresora pueden variar según los controladores utilizados. Por ejemplo, "Microsoft OpenXPS Class Driver 2" de Windows y "Microsoft Print to PDF" proporcionan métricas ligeramente diferentes. Por lo tanto, el diseño del documento final puede cambiar si esta opción está habilitada.
