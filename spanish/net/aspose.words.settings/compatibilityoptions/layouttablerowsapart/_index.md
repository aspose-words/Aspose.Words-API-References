...
description: Descubra cómo la propiedad LayoutTableRowsApart mejora la compatibilidad al permitir el ajuste independiente de objetos en línea en las filas de la tabla para una mejor flexibilidad de diseño.
type: docs
weight: 300
