...
description: Aspose.Words.Settings.MultiplePagesType enumeración. Especifica cómo se imprime el documento en C#.
type: docs
weight: 5870
...
| BookFoldPrintingReverse | `4` | Especifica si se debe imprimir el documento como libro plegado inverso. |
