...
description: Obtiene o establece una colección de objetos que especifican cómo se asignan las columnas del origen de datos externo a los nombres de campo de combinación predefinidos en el documento. Este objeto nunca es nulo.
type: docs
weight: 50
