...
description: Especifica el tipo de origen de datos externo al que se conectará como parte de la información de conexión de ODSO para esta combinación de correspondencia. El valor predeterminado esDefault .
type: docs
weight: 40
