...
description: Aspose.Words.Settings.MailMergeDataType enumeración. Especifica el tipo de un origen de datos de combinación de correo externo.
type: docs
weight: 5520
...
Especifica el tipo de un origen de datos de combinación de correo externo.
...
| Native | `5` | Especifica que un documento determinado se ha conectado a una fuente de datos externa a través de la interfaz de Objeto de origen de datos de Office (ODSO). |
