...
description: Optimice sus imágenes con ImageData CropTop, controlando la eliminación de imágenes desde la parte superior para lograr un encuadre perfecto y un atractivo visual mejorado.
type: docs
weight: 90
...
Define la fracción de eliminación de la imagen desde el lado superior.
