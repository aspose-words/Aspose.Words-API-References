...
description: ImageData propiedad. Define la fracción de eliminación de imágenes del lado derecho.
type: docs
weight: 80
...
Define la fracción de eliminación de imágenes del lado derecho.
