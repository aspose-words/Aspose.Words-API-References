...
description: Descubra la propiedad ImageData CropLeft para ajustar fácilmente el encuadre de la imagen eliminando partes no deseadas del lado izquierdo para un ajuste perfecto.
type: docs
weight: 70
url: /es/net/aspose.words.drawing/imagedata/cropleft/
---
## ImageData.CropLeft property

Define la fracción de eliminación de imagen del lado izquierdo.
