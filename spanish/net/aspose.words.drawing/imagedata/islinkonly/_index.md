...
description: Descubra la propiedad ImageData IsLinkOnly, indica si una imagen está vinculada externamente, mejorando la eficiencia del documento y la gestión del almacenamiento.
type: docs
weight: 160
url: /es/net/aspose.words.drawing/imagedata/islinkonly/
---
## ImageData.IsLinkOnly property

Devuelve`verdadero` Si la imagen está vinculada y no almacenada en el documento.
