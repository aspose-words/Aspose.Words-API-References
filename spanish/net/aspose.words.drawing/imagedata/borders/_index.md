...
description: ImageData propiedad. Obtiene la colección de bordes de la imagen. Los bordes solo tienen efecto para las imágenes en línea.
type: docs
weight: 20
...
Obtiene la colección de bordes de la imagen. Los bordes solo tienen efecto para las imágenes en línea.
