...
description: ImageData propiedad. Obtiene o establece el contraste de la imagen especificada. El valor para esta propiedad debe ser un número de 00 el menor contraste a 10 el mayor contraste.
type: docs
weight: 50
...
Obtiene o establece el contraste de la imagen especificada. El valor para esta propiedad debe ser un número de 0,0 (el menor contraste) a 1,0 (el mayor contraste).
