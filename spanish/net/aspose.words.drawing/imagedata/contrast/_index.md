...
description: Ajuste fácilmente el contraste de la imagen con la propiedad Contraste de ImageData. Establezca valores de 0.0 (bajo) a 1.0 (alto) para una claridad y calidad de imagen óptimas.
type: docs
weight: 50
