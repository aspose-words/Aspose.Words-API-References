...
description: Descubra la propiedad Escala de grises de ImageData para mejorar sus imágenes. Controle la visualización en escala de grises para obtener efectos visuales impactantes y una mayor interacción del usuario.
type: docs
weight: 100
