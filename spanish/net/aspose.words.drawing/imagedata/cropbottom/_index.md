...
description: Descubra la propiedad ImageData CropBottom para personalizar fácilmente sus imágenes eliminando partes no deseadas de la parte inferior para un ajuste perfecto.
type: docs
weight: 60
...
Define la fracción de eliminación de la imagen del lado inferior.
