...
description: Ajuste el brillo de su imagen con la propiedad Brillo de ImageData. Establezca valores de 0.0 (más tenue) a 1.0 (más brillante) para un impacto visual óptimo.
type: docs
weight: 30
