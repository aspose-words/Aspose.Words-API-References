...
description: Aspose.Words.Drawing.TextPathAlignment enumeración. alineación WordArt.
type: docs
weight: 1210
...
| Center | `1` | Centrar texto en ancho. |
| Left | `2` | Justificación izquierda. |
| Right | `3` | Justificación a la derecha. |
| LetterJustify | `4` | Extienda las letras para que se ajusten al ancho. |
| WordJustify | `5` | Separa las palabras para que se ajusten al ancho. |
