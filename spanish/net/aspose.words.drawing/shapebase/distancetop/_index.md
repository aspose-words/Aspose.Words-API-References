...
description: Descubra la propiedad DistanceTop de ShapeBase, ajuste fácilmente el espacio en puntos entre el texto de su documento y el borde superior de la forma para un control de diseño preciso.
type: docs
weight: 160
