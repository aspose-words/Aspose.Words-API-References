...
description: Descubra la propiedad ShapeBase DistanceLeft para ajustar fácilmente la distancia en puntos entre el texto de su documento y el borde izquierdo de las formas para un mejor control del diseño.
type: docs
weight: 140
