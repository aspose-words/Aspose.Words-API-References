...
description: Descubra la propiedad Right de ShapeBase para acceder fácilmente a la posición del borde derecho del bloque contenedor de su forma para un control de diseño preciso.
type: docs
weight: 490
