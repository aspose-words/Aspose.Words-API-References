...
description: ShapeBase propiedad. Obtiene o establece un indicador que indica si la figura se muestra dentro o fuera de una tabla.
type: docs
weight: 300
...
Obtiene o establece un indicador que indica si la figura se muestra dentro o fuera de una tabla.
...
Tiene efecto solo para formas de nivel superior, la propiedad[`WrapType`](../wraptype/) de los cuales se establece en value distinto de[`Inline`](../../../aspose.words/inline/).
...
// Establezca la propiedad "IsLayoutInCell" en "false" para mostrar la forma como una forma flotante independiente.
