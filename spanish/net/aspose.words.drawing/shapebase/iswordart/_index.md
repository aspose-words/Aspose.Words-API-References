...
description: Descubre si tu forma es un objeto de WordArt con ShapeBase. ¡Obtén resultados precisos y optimiza tus proyectos de diseño fácilmente!
type: docs
weight: 380
url: /es/net/aspose.words.drawing/shapebase/iswordart/
---
## ShapeBase.IsWordArt property

Devuelve`verdadero` si esta forma es un objeto de WordArt.
...
Funciona hasta el modo de compatibilidad 2007. En el modo de compatibilidad 2010 y superior, WordArt es solo un cuadro de texto con fuentes elegantes.
