...
description: Descubra la propiedad IsDeleteRevision de ShapeBase y aprenda cómo indica la eliminación de objetos en Microsoft Word con el seguimiento de cambios habilitado para una mejor gestión de documentos.
type: docs
weight: 270
