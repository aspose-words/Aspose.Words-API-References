...
description: Descubra la propiedad ShapeBase DistanceBottom, configure y ajuste fácilmente el espacio en puntos entre el texto de su documento y el borde inferior de la forma para lograr un diseño óptimo.
type: docs
weight: 130
