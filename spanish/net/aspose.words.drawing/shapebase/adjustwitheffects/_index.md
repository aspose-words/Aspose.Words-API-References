...
description: Descubra cómo el método AdjustWithEffects de ShapeBase mejora su rectángulo de origen agregando extensiones de efecto y entregando valores de rectángulo finales precisos.
type: docs
weight: 660
...
// La primera forma no tiene efectos y la segunda tiene sombra y un contorno grueso.
//Estos efectos hacen que el tamaño de la silueta de la segunda forma sea más grande que el de la primera.
...
// Verificar la extensión final de la primera forma, en puntos.
...
//Los efectos también han afectado a las dimensiones visibles de la forma.
Assert.AreEqual(1045, rectangleFOut.Width);
Assert.AreEqual(1133.5, rectangleFOut.Height);

// Los efectos también han afectado a los límites visibles de la forma.
