...
description: Descubra la propiedad ShapeBase CoordSize, que define el ancho y la altura del espacio de coordenadas para un control de diseño óptimo en sus proyectos de diseño.
type: docs
weight: 120
url: /es/net/aspose.words.drawing/shapebase/coordsize/
---
## ShapeBase.CoordSize property

El ancho y la altura del espacio de coordenadas dentro del bloque contenedor de esta forma.
...
El valor predeterminado es (1000, 1000).
