...
description: Personalice su WordArt con la propiedad Shape TextPath para mejorar el atractivo visual y crear efectos de texto impresionantes fácilmente.
type: docs
weight: 240
url: /es/net/aspose.words.drawing/shape/textpath/
---
## Shape.TextPath property

Define el texto de la ruta de texto (de un objeto WordArt).
