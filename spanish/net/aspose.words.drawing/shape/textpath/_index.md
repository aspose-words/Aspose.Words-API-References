...
description: Shape TextPath propiedad. Define el texto de la ruta de texto de un objeto de WordArt en C#.
type: docs
weight: 230
...
Define el texto de la ruta de texto (de un objeto de WordArt).
