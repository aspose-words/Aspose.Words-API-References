...
description: Aspose.Words.Drawing.Shape clase. Representa un objeto en la capa de dibujo como una autoforma cuadro de texto forma libre objeto OLE control ActiveX o imagen.
type: docs
weight: 1100
...
Utilizando el`Shape` clase puede crear o modificar formas en un documento de Microsoft Word.
