...
description: Aspose.Words.Drawing.Shape clase. Representa un objeto en la capa de dibujo como una autoforma un cuadro de texto una forma libre un objeto OLE un control ActiveX o una imagen en C#.
type: docs
weight: 1250
