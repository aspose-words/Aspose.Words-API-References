...
description: Descubra la clase Aspose.Words.Drawing.Shape para crear objetos de dibujo versátiles como Autoformas, cuadros de texto e imágenes sin esfuerzo en sus proyectos.
type: docs
weight: 1640
...
| Nombre | Descripción |
| --- | --- |
| [Shape](shape/)(*[DocumentBase](../../aspose.words/documentbase/), [ShapeType](../shapetype/)*) | Crea un nuevo objeto de forma. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [Adjustments](../../aspose.words.drawing/shape/adjustments/) { get; } | Proporciona acceso a los valores brutos de ajuste de una forma. Para una forma que no contiene ningún valor bruto de ajuste, devuelve una colección vacía. |
...
| [Chart](../../aspose.words.drawing/shape/chart/) { get; } | Proporciona acceso a las propiedades del gráfico si esta forma tiene una[`Chart`](../../aspose.words.drawing.charts/chart/) . |
...
| [ExtrusionEnabled](../../aspose.words.drawing/shape/extrusionenabled/) { get; } | Devuelve`verdadero` Si está habilitado un efecto de extrusión. |
| [Fill](../../aspose.words.drawing/shapebase/fill/) { get; } | Obtiene el formato de relleno para la forma. |
| [FillColor](../../aspose.words.drawing/shape/fillcolor/) { get; set; } | Define el color del pincel que rellena la ruta cerrada de la forma. |
...
| [HasChart](../../aspose.words.drawing/shape/haschart/) { get; } | Devuelve`verdadero` Si esto`Shape` tiene una[`Chart`](../../aspose.words.drawing.charts/chart/) . |
...
| [HasSmartArt](../../aspose.words.drawing/shape/hassmartart/) { get; } | Devuelve`verdadero` Si esto`Shape` tiene un objeto SmartArt. |
...
| [HorizontalRuleFormat](../../aspose.words.drawing/shape/horizontalruleformat/) { get; } | Proporciona acceso a las propiedades de la forma de la regla horizontal. Para una forma que no es una regla horizontal, devuelve`nulo` . |
...
| override [NodeType](../../aspose.words.drawing/shape/nodetype/) { get; } | DevuelveShape . |
| [OleFormat](../../aspose.words.drawing/shape/oleformat/) { get; } | Proporciona acceso a los datos OLE de una forma. Para una forma que no sea un objeto OLE ni un control ActiveX, devuelve`nulo` . |
...
| [ShadowEnabled](../../aspose.words.drawing/shape/shadowenabled/) { get; } | Devuelve`verdadero` Si está habilitado un efecto de sombra. |
...
| [SignatureLine](../../aspose.words.drawing/shape/signatureline/) { get; } | Obtiene[`SignatureLine`](../signatureline/) objeto si la forma es una línea de firma. Devuelve`nulo` de lo contrario. |
...
| [StoryType](../../aspose.words.drawing/shape/storytype/) { get; } | DevuelveTextbox . |
...
| [Stroked](../../aspose.words.drawing/shape/stroked/) { get; set; } | Define si se trazará un trazo. |
| [StrokeWeight](../../aspose.words.drawing/shape/strokeweight/) { get; set; } | Define el grosor del pincel que traza la ruta de una forma en puntos. |
...
| [TextPath](../../aspose.words.drawing/shape/textpath/) { get; } | Define el texto de la ruta de texto (de un objeto WordArt). |
...
| Nombre | Descripción |
| --- | --- |
| override [Accept](../../aspose.words.drawing/shape/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Acepta un visitante. |
| override [AcceptEnd](../../aspose.words.drawing/shape/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Acepta un visitante por visitar el final de la forma. |
| override [AcceptStart](../../aspose.words.drawing/shape/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Acepta un visitante por visitar el inicio de la forma. |
...
| [UpdateSmartArtDrawing](../../aspose.words.drawing/shape/updatesmartartdrawing/)() | Actualiza el dibujo pre-renderizado de SmartArt mediante el motor de renderizado en frío de SmartArt de Aspose.Words. |

## Observaciones

Usando el`Shape` Clase que permite crear o modificar formas en un documento de Microsoft Word.

Una propiedad importante de una forma es su[`ShapeType`](../shapebase/shapetype/)Las formas de diferentes tipos pueden tener distintas funciones en un documento de Word. Por ejemplo, solo las formas de imagen y OLE pueden contener imágenes. La mayoría de las formas pueden contener texto, pero no todas.

Las formas que pueden tener texto pueden contener[`Paragraph`](../../aspose.words/paragraph/) y [`Table`](../../aspose.words.tables/table/) nodos como hijos.
