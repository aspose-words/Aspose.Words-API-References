...
description: Inicializa una nueva instancia delGradientStopaspose.words.drawing/gradientstop clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del[`GradientStop`](../../gradientstop) clase.
...
| --- | --- | --- |
| color | Color | Representa el color de la parada de degradado. |
