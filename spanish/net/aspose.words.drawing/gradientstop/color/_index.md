...
description: Descubra la propiedad Color GradientStop para configurar y personalizar fácilmente los colores de los puntos de degradado y así lograr efectos visuales sorprendentes en sus diseños.
type: docs
weight: 30
url: /es/net/aspose.words.drawing/gradientstop/color/
---
## GradientStop.Color property

Obtiene o establece un valor que representa el color del punto de degradado.
