...
description: Descubre la propiedad Transparencia de Detención de Gradiente para ajustar fácilmente la transparencia del relleno de degradado del 0 % al 100 %. ¡Mejora tus diseños con un control preciso!
type: docs
weight: 50
...
Obtiene o establece un valor que representa la transparencia del relleno de degradado expresado como un porcentaje en el rango de 0,0 a 1,0.
