...
description: Descubra la propiedad GradientStop BaseColor para acceder fácilmente al color puro de su parada de degradado, mejorando su diseño con precisión y claridad.
type: docs
weight: 20
url: /es/net/aspose.words.drawing/gradientstop/basecolor/
---
## GradientStop.BaseColor property

Obtiene un valor que representa el color del punto de degradado sin ningún modificador.
