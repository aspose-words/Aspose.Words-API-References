...
description: Administre sin esfuerzo sus degradados con el método GradientStop Remove, simplificando la eliminación de paradas de degradado de cualquier GradientStopCollection.
type: docs
weight: 60
...
Elimina el punto de degradado del elemento principal.[`GradientStopCollection`](../../gradientstopcollection/) .
