...
description: GradientStop Remove método. Elimina la parada de degradado del padre.GradientStopCollection  en C#.
type: docs
weight: 60
...
Elimina la parada de degradado del padre.[`GradientStopCollection`](../../gradientstopcollection/) .
