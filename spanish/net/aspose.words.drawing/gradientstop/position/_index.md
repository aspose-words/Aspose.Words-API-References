...
description: Descubra la propiedad Posición de detención de degradado, configure y ajuste fácilmente las posiciones de detención de degradado del 0 % al 100 % para obtener efectos visuales sorprendentes en sus diseños.
type: docs
weight: 40
...
Obtiene o establece un valor que representa la posición de una parada dentro del gradiente expresado como un porcentaje en el rango de 0,0 a 1,0.
