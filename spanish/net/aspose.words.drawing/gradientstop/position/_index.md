...
description: Obtiene o establece un valor que representa la posición de una parada dentro del gradiente expresado como un porcentaje en el rango de 00 a 10.
type: docs
weight: 30
