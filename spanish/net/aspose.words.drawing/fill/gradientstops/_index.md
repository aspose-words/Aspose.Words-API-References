...
description: Descubra cómo mejorar sus diseños con la propiedad GradientStops, que incluye una colección de objetos GradientStop para lograr efectos de relleno impresionantes.
type: docs
weight: 110
...
Obtiene una colección de[`GradientStop`](../../gradientstop/) objetos para el relleno.
