...
description: Representa el formato de relleno para un objeto.
type: docs
weight: 820
...
| [GradientStyle](../../aspose.words.drawing/fill/gradientstyle/) { get; } | Obtiene el estilo degradado[`GradientStyle`](../gradientstyle/) para el relleno. |
