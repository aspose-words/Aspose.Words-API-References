...
description: Añade fácilmente un GradientStop a tu colección con el método de inserción GradientStopCollection. ¡Mejora tus transiciones de color a la perfección!
type: docs
weight: 50
url: /es/net/aspose.words.drawing/gradientstopcollection/insert/
---
## GradientStopCollection.Insert method

Inserta un[`GradientStop`](../../gradientstop/) a la colección en un índice especificado.
