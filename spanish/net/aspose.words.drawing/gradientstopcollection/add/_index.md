...
description: GradientStopCollection método. Agrega un especificadoGradientStop a un degradado.
type: docs
weight: 30
...
Agrega un especificado[`GradientStop`](../../gradientstop/) a un degradado.
