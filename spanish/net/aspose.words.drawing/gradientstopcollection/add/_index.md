...
description: Mejora fácilmente tus degradados con el método de adición de GradientStopCollection. Añade GradientStops personalizados sin problemas para lograr diseños vibrantes.
type: docs
weight: 30
...
Agrega un valor especificado[`GradientStop`](../../gradientstop/) a un gradiente.
