...
description: Gestiona fácilmente tu Colección de Detenciones de Gradiente con el método RemoveAt. Elimina fácilmente las Detenciones de Gradiente por índice para un control de diseño optimizado.
type: docs
weight: 70
url: /es/net/aspose.words.drawing/gradientstopcollection/removeat/
---
...
Remoto[`GradientStop`](../../gradientstop/).
