...
description: Indica la presencia de sombreado 3D para la regla horizontal. Si es verdadero entonces la regla horizontal no tiene sombreado 3D y se utiliza un color sólido.
type: docs
weight: 40
