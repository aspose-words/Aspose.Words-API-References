...
description: Descubra la propiedad SignatureLine Id para administrar y personalizar fácilmente los identificadores de línea de firma para una integración perfecta de documentos y una mejor experiencia del usuario.
type: docs
weight: 40
...
Este identificador se puede asociar a una firma digital, al firmar un documento utilizando[`DigitalSignatureUtil`](../../../aspose.words.digitalsignatures/digitalsignatureutil/). Este valor debe ser único y por defecto se genera aleatoriamente nuevo Guid (NewGuid).
