...
description: SignatureLine propiedad. Indica que la línea de firma está firmada por firma digital.
type: docs
weight: 60
...
Indica que la línea de firma está firmada por firma digital.
