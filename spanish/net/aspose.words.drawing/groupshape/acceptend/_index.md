...
description: Descubra el método GroupShape AcceptEnd, administre sin problemas las interacciones de los visitantes y mejore la experiencia del usuario de su aplicación con esta poderosa función.
type: docs
weight: 40
url: /es/net/aspose.words.drawing/groupshape/acceptend/
---
## GroupShape.AcceptEnd method

Acepta un visitante por visitar el final de GroupShape.
