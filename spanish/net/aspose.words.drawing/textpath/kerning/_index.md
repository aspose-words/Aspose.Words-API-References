...
description: Descubra la propiedad Kerning de TextPath para mejorar la tipografía controlando la configuración de kerning para mejorar la legibilidad del texto y la calidad del diseño.
type: docs
weight: 60
url: /es/net/aspose.words.drawing/textpath/kerning/
---
## TextPath.Kerning property

Determina si el kerning está activado.
