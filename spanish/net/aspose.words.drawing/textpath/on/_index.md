...
description: Descubra cómo TextPath mejora la visualización del texto de las propiedades, garantizando claridad y atractivo en sus diseños. ¡Optimice sus elementos visuales hoy mismo!
type: docs
weight: 70
url: /es/net/aspose.words.drawing/textpath/on/
---
## TextPath.On property

Define si se muestra el texto.
