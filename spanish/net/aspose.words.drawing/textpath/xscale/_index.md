...
description: Determina si se utilizará una ruta de texto recta en lugar de la ruta de forma.
type: docs
weight: 200
...
Si **verdadero**, el texto se ejecuta a lo largo de una ruta de izquierda a derecha a lo largo del valor x de el límite inferior de la forma.
