...
description: Descubra cómo la propiedad TextPath XScale mejora su diseño al habilitar rutas de texto rectas para diseños más suaves y precisos.
type: docs
weight: 200
...
Determina si se utilizará una ruta de texto recta en lugar de la ruta de forma.
...
Si`verdadero`, el texto recorre una ruta de izquierda a derecha a lo largo del valor x de el límite inferior de la forma.
