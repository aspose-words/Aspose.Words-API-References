...
description: Descubra cómo TextPath FitPath mejora su diseño al garantizar que el texto siga perfectamente cualquier forma, creando efectos visuales impresionantes.
type: docs
weight: 20
url: /es/net/aspose.words.drawing/textpath/fitpath/
---
## TextPath.FitPath property

Define si el texto se ajusta a la ruta de una forma.
