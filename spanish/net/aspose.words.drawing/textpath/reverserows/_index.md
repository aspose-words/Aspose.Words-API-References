...
description: TextPath propiedad. Determina si se invierte el orden de disposición de las filas.
type: docs
weight: 80
...
Determina si se invierte el orden de disposición de las filas.
...
Si **verdadero**, el orden de disposición de las filas se invierte. Este atributo se utiliza para el diseño de texto vertical.
