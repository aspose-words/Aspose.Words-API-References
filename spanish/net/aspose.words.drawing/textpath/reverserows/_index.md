...
description: Descubra la propiedad TextPath ReverseRows para mejorar su diseño. Controle el orden de las filas para una mayor flexibilidad de diseño y una mejor experiencia de usuario.
type: docs
weight: 80
url: /es/net/aspose.words.drawing/textpath/reverserows/
---
## TextPath.ReverseRows property

Determina si el orden de diseño de las filas está invertido.
...
Si`verdadero`El orden de las filas se invierte. Este atributo se utiliza para el diseño de texto vertical.
