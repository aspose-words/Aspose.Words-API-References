...
description: Descubra la propiedad TextBox anterior, acceda sin esfuerzo al TextBox anterior en su secuencia de formas para un diseño optimizado y un flujo de trabajo mejorado.
type: docs
weight: 100
url: /es/net/aspose.words.drawing/textbox/previous/
---
## TextBox.Previous property

Devuelve un[`TextBox`](../) que representa el anterior[`TextBox`](../)en una secuencia de formas.
