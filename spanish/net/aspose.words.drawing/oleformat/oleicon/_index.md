...
description: Obtiene el aspecto de dibujo del objeto OLE. Cuando verdadero  el objeto OLE se muestra como un icono. cuando falso  el objeto OLE se muestra como content.
type: docs
weight: 70
