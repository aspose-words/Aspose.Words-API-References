...
description: Descubra la clase Aspose.Words.Drawing.OleFormat para un acceso perfecto a objetos OLE y controles ActiveX, mejorando sus capacidades de procesamiento de documentos.
type: docs
weight: 1530
...
| Nombre | Descripción |
| --- | --- |
| [AutoUpdate](../../aspose.words.drawing/oleformat/autoupdate/) { get; set; } | Especifica si el vínculo al objeto OLE se actualiza automáticamente o no en Microsoft Word. |
...
| [IsLocked](../../aspose.words.drawing/oleformat/islocked/) { get; set; } | Especifica si el vínculo al objeto OLE está bloqueado para actualizaciones. |
...
| [OleIcon](../../aspose.words.drawing/oleformat/oleicon/) { get; } | Obtiene el aspecto de dibujo del objeto OLE. Cuando`verdadero` el objeto OLE se muestra como un icono. Cuando`FALSO` , el objeto OLE se muestra como contenido. |
...
| [SourceFullName](../../aspose.words.drawing/oleformat/sourcefullname/) { get; set; } | Obtiene o establece la ruta y el nombre del archivo de origen para el objeto OLE vinculado. |
| [SourceItem](../../aspose.words.drawing/oleformat/sourceitem/) { get; set; } | Obtiene o establece una cadena que se utiliza para identificar la parte del archivo de origen que se está vinculando. |
...
Utilice el[`OleFormat`](../shape/oleformat/) propiedad para acceder a los datos de un objeto OLE. No crea instancias de la`OleFormat` clase directamente.
