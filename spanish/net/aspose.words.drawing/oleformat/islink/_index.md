...
description: Descubra la propiedad IsLink de OleFormat. Compruebe fácilmente si su objeto OLE está vinculado con SourceFullName para una integración y gestión de datos fluidas.
type: docs
weight: 40
