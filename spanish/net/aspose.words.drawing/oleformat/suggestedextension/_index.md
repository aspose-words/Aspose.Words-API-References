...
description: Descubra la propiedad OleFormat SuggestedExtension para obtener fácilmente la extensión de archivo ideal para guardar sus objetos incrustados de manera eficiente.
type: docs
weight: 120
