...
description: Descubre la propiedad FrameDefaultUrl del conjunto de marcos para configurar fácilmente las URL de páginas web o archivos de documentos y lograr una visualización fluida de los marcos. ¡Mejora tu experiencia web!
type: docs
weight: 30
