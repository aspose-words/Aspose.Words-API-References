...
description: Obtiene o establece un valor que indica si la página web o el nombre de archivo del documento especificado en el FrameDefaultUrlaspose.words.framesets/frameset/framedefaulturl La propiedad es un recurso externo con el que está vinculado el marco.
type: docs
weight: 40
