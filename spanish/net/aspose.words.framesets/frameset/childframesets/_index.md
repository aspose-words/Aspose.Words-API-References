...
description: Descubra la propiedad Frameset ChildFramesets para acceder y administrar fácilmente colecciones de marcos y páginas secundarias para un diseño web mejorado.
type: docs
weight: 20
