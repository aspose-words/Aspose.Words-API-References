...
description: Descubra la propiedad de hipervínculo ThemeColors para personalizar los colores de los hipervínculos, mejorando el diseño de su sitio web y la experiencia del usuario sin esfuerzo.
type: docs
weight: 100
url: /es/net/aspose.words.themes/themecolors/hyperlink/
---
## ThemeColors.Hyperlink property

Especifica el color de un hipervínculo.
