...
description: Descubra la propiedad FollowedHyperlink de ThemeColors para personalizar el color del hipervínculo en el que hizo clic, mejorando el atractivo visual de su sitio web y la experiencia del usuario.
type: docs
weight: 90
url: /es/net/aspose.words.themes/themecolors/followedhyperlink/
---
## ThemeColors.FollowedHyperlink property

Especifica el color de un hipervínculo en el que se hizo clic.
