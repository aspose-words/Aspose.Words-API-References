...
description: ThemeColors FollowedHyperlink propiedad. Especifica el color de un hipervínculo en el que se hace clic en C#.
type: docs
weight: 90
...
Especifica el color de un hipervínculo en el que se hace clic.
