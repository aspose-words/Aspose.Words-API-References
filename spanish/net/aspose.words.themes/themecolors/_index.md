...
description: Aspose.Words.Themes.ThemeColors clase. Representa la combinación de colores del tema del documento que contiene doce colores en C#.
type: docs
weight: 6480
...
| [Accent2](../../aspose.words.themes/themecolors/accent2/) { get; set; } | Especifica el color Acento 2. |
| [Accent3](../../aspose.words.themes/themecolors/accent3/) { get; set; } | Especifica el color Acento 3. |
| [Accent4](../../aspose.words.themes/themecolors/accent4/) { get; set; } | Especifica el color Acento 4. |
| [Accent5](../../aspose.words.themes/themecolors/accent5/) { get; set; } | Especifica el color Acento 5. |
