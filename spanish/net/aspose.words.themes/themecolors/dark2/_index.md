...
description: Descubre ThemeColors Dark2. Personaliza fácilmente tu diseño con el rico color Dark 2 para lograr imágenes impactantes y una experiencia de usuario cautivadora.
type: docs
weight: 80
url: /es/net/aspose.words.themes/themecolors/dark2/
---
## ThemeColors.Dark2 property

Especifica el color Oscuro 2.
