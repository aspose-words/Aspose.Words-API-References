...
description: ThemeFonts ComplexScript propiedad. Especifica el nombre de fuente para los caracteres ComplexScript en C#.
type: docs
weight: 10
...
Especifica el nombre de fuente para los caracteres ComplexScript.
