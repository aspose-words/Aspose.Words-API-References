...
description: ThemeFonts propiedad. Especifica el nombre de la fuente para los caracteres latinos.
type: docs
weight: 30
...
Especifica el nombre de la fuente para los caracteres latinos.
