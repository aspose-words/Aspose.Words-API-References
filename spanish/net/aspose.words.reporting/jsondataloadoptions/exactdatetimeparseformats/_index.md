...
description: JsonDataLoadOptions propiedad. Obtiene o establece formatos exactos para analizar los valores de fecha y hora de JSON al cargar JSON. El valor predeterminado es nulo .
type: docs
weight: 30
