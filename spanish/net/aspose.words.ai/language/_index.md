...
description: Descubra la enumeración Aspose.Words.AI.Language para una traducción de texto fluida basada en IA. ¡Mejore sus documentos con soporte multilingüe preciso hoy mismo!
type: docs
weight: 80
url: /es/net/aspose.words.ai/language/
---
## Language enumeration

Especifica el idioma al que se traducirá el texto mediante IA.  .
