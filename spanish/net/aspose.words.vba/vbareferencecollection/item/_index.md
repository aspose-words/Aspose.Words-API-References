...
description: Acceda fácilmente al objeto VbaReference con la propiedad Item. Recupere referencias por índice de forma eficiente para optimizar el desarrollo de VBA.
type: docs
weight: 20
...
| --- | --- |
| index | El índice basado en cero de la referencia a obtener. |
