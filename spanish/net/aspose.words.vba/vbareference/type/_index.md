...
description: Descubra la propiedad Tipo VbaReference para identificar y utilizar objetos VbaReferenceType de manera efectiva, mejorando así la eficiencia de su programación VBA.
type: docs
weight: 20
...
Obtiene[`VbaReferenceType`](../../vbareferencetype/) objeto que indica el tipo de referencia que un[`VbaReference`](../) objeto representa.
