...
description: Proporciona acceso a la información del proyecto VBA. Un proyecto VBA dentro del documento se define como una colección de módulos VBA.
type: docs
weight: 6270
...
| Nombre | Descripción |
| --- | --- |
| [Clone](../../aspose.words.vba/vbaproject/clone/)() | Realiza una copia del[`VbaProject`](./vbaproject/) . |
