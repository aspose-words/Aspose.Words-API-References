...
description: Descubra la propiedad Cell IsFirstCell, identifique fácilmente la primera celda de una fila, mejorando la organización de sus datos y la eficiencia de la gestión.
type: docs
weight: 40
url: /es/net/aspose.words.tables/cell/isfirstcell/
---
## Cell.IsFirstCell property

Verdadero si esta es la primera celda dentro de una fila; falso en caso contrario.
