...
description: Descubra el método Row GetText para recuperar sin esfuerzo texto de todas las celdas de una fila, incluido el carácter de final de fila para una gestión de datos perfecta.
type: docs
weight: 160
...
Obtiene el texto de todas las celdas de esta fila, incluido el carácter de final de fila.
...
Devuelve el texto concatenado de todos los nodos secundarios con el carácter de final de fila [`Cell`](../../../aspose.words/controlchar/cell/) adjuntado al final.
