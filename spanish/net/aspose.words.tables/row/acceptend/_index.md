...
description: Descubre el método Row AcceptEnd para mejorar la experiencia de tus visitantes, guiándolos fácilmente hasta el final de la fila. ¡Impulsa la interacción hoy mismo!
type: docs
weight: 130
url: /es/net/aspose.words.tables/row/acceptend/
---
## Row.AcceptEnd method

Acepta un visitante por visitar el final de la fila.
