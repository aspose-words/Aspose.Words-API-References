...
description: Descubra la propiedad Row NodeType que devuelve datos de fila de manera eficiente, mejorando la gestión de datos y el rendimiento de la aplicación.
type: docs
weight: 80
