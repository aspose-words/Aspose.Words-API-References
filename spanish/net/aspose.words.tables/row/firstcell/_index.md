...
description: Descubra la propiedad Row FirstCell, acceda sin esfuerzo a la primera celda de una fila para una gestión optimizada de datos y una mayor productividad.
type: docs
weight: 30
url: /es/net/aspose.words.tables/row/firstcell/
---
## Row.FirstCell property

Devuelve el primer[`Cell`](../../cell/) en la fila.
