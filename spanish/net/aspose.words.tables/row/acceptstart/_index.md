...
description: Descubra el método Row AcceptStart, acepte visitantes sin problemas al comienzo de la fila para una experiencia de usuario mejorada y una navegación eficiente.
type: docs
weight: 140
url: /es/net/aspose.words.tables/row/acceptstart/
---
## Row.AcceptStart method

Acepta un visitante por visitar el inicio de la fila.
