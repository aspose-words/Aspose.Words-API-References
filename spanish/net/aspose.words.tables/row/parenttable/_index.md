...
description: Devuelve la tabla principal inmediata de la fila.
type: docs
weight: 80
...
Devuelve la tabla principal inmediata de la fila.
...
Equivalente a`(Tabla) First NonMarkup Parent Node`.
