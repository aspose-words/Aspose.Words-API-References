...
description: Row constructor. Inicializa una nueva instancia del Fila clase.
type: docs
weight: 10
...
Inicializa una nueva instancia del **Fila** clase.
...
Cuando **Fila** se crea, pertenece al documento especificado, pero aún no es parte del documento y **Nodo principal** es nulo.

Para anexar **Fila**al documento use InsertAfter o InsertBefore en la tabla donde desea insertar la fila.
