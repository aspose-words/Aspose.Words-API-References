...
description: Ajuste la propiedad DistanciaDerechaDeLaTabla para controlar el espaciado entre su tabla y el texto circundante en puntos, mejorando el diseño y la legibilidad.
type: docs
weight: 140
...
Obtiene o establece la distancia entre la tabla derecha y el texto circundante, en puntos.
