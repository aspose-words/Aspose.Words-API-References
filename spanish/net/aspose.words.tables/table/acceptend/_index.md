...
description: Descubra el método Table AcceptEnd, integre sin problemas a los visitantes al final de la tabla para una mejor experiencia del usuario y un manejo eficiente de los datos.
type: docs
weight: 360
url: /es/net/aspose.words.tables/table/acceptend/
---
## Table.AcceptEnd method

Acepta un visitante por visitar el final de la tabla.
