...
description: Table propiedad. Obtiene la distancia entre la parte inferior de la tabla y el texto circundante en puntos.
type: docs
weight: 120
...
Obtiene la distancia entre la parte inferior de la tabla y el texto circundante, en puntos.
