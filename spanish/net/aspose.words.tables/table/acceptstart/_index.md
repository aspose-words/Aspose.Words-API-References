...
description: Descubra el método Table AcceptStart para dar una bienvenida fluida a los visitantes al inicio de la mesa, mejorando la experiencia y la participación del usuario.
type: docs
weight: 370
url: /es/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Acepta un visitante por visitar el inicio de la tabla.
