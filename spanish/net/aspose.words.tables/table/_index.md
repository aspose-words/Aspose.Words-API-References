...
description: Aspose.Words.Tables.Table clase. Representa una tabla en un documento de Word.
type: docs
weight: 6340
...
| Nombre | Descripción |
| --- | --- |
| [Table](table/)(DocumentBase) | Inicializa una nueva instancia del`Table` clase. |
...
| [SetBorder](../../aspose.words.tables/table/setborder/)(BorderType, LineStyle, double, Color, bool) | Establece el borde de la tabla especificado con el estilo, ancho y color de línea especificados. |
| [SetBorders](../../aspose.words.tables/table/setborders/)(LineStyle, double, Color) | Establece todos los bordes de la tabla con el estilo, ancho y color de línea especificados. |
| [SetShading](../../aspose.words.tables/table/setshading/)(TextureIndex, Color, Color) | Establece el sombreado en los valores especificados en toda la tabla. |
