...
description: Obtiene el objeto base a partir del cual se debe calcular el posicionamiento horizontal de la tabla flotante. El valor predeterminado esColumn .
type: docs
weight: 170
