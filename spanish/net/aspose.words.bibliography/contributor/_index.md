...
description: Descubra la clase Aspose.Words.Bibliography.Contributor, su solución ideal para gestionar colaboradores de bibliografías, incluidas organizaciones e individuos.
type: docs
weight: 150
url: /es/net/aspose.words.bibliography/contributor/
---
## Contributor class

Representa al contribuyente de una fuente bibliográfica. Puede ser una empresa (una organización) o una lista de personas.
