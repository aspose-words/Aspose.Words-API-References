...
description: Descubra la propiedad PersonCollection Count para recuperar fácilmente el número total de personas en su colección para una gestión de datos eficiente.
type: docs
weight: 20
url: /es/net/aspose.words.bibliography/personcollection/count/
---
