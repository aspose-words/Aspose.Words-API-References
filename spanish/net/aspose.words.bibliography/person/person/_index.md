...
description: Crea una nueva instancia de Persona fácilmente con nuestro constructor intuitivo. ¡Simplifica tu código y optimiza tus proyectos hoy mismo!
type: docs
weight: 10
url: /es/net/aspose.words.bibliography/person/person/
---
## Person constructor

Inicializar una nueva instancia del[`Person`](../) clase.
...
| --- | --- | --- |
| last | String | El apellido. |
| first | String | El apellido. |
| middle | String | El apellido. |
