...
description: Descubra la clase Aspose.Words.Bibliography.Person para gestionar colaboradores individuales en bibliografías. ¡Mejore la precisión de las citas de sus documentos!
type: docs
weight: 180
url: /es/net/aspose.words.bibliography/person/
---
## Person class
...
| Nombre | Descripción |
| --- | --- |
| [Person](person/)(*string, string, string*) | Inicializar una nueva instancia del`Person` clase. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Obtiene o establece el nombre de una persona. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Obtiene o establece el apellido de una persona. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Obtiene o establece el segundo nombre de una persona. |
