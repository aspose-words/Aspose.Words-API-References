...
description: Administre la propiedad Lcid fácilmente. Obtenga o configure el ID de configuración regional de su fuente para una localización fluida y una mejor experiencia de usuario.
type: docs
weight: 260
url: /es/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

Obtiene o establece el ID de configuración regional de una fuente.
