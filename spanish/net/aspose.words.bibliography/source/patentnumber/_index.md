...
description: Gestione fácilmente sus datos de patentes con la propiedad Source PatentNumber. Recupere o actualice fácilmente los números de patente para un seguimiento optimizado de la fuente.
type: docs
weight: 320
url: /es/net/aspose.words.bibliography/source/patentnumber/
---
## Source.PatentNumber property

Obtiene o establece el número de patente de una fuente.
