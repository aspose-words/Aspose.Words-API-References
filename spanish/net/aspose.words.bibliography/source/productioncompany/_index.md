...
description: Gestiona tu empresa de producción fácilmente con Source ProductionCompany. Configura o actualiza fácilmente los detalles de producción de tu fuente para una colaboración fluida.
type: docs
weight: 340
url: /es/net/aspose.words.bibliography/source/productioncompany/
---
## Source.ProductionCompany property

Obtiene o establece la empresa productora de una fuente.
