...
description: Descubra una lista completa de colaboradores (autores, editores y escritores) para su fuente. ¡Mejore su investigación con información valiosa!
type: docs
weight: 120
url: /es/net/aspose.words.bibliography/source/contributors/
---
## Source.Contributors property

Obtiene la lista de colaboradores (autor, editor, escritor, etc.) de una fuente.
