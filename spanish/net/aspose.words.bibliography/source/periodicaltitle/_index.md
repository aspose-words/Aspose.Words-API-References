...
description: Gestiona fácilmente el título de tus publicaciones periódicas. Obtén o establece títulos fácilmente para una mejor organización y referencias precisas.
type: docs
weight: 330
url: /es/net/aspose.words.bibliography/source/periodicaltitle/
---
## Source.PeriodicalTitle property

Obtiene o establece el título periódico de una fuente.
