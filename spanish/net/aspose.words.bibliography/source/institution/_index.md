...
description: Gestione fácilmente las propiedades de su institución de origen. Configure o actualice fácilmente los detalles de la institución para una organización optimizada de los datos y una mejor accesibilidad.
type: docs
weight: 220
url: /es/net/aspose.words.bibliography/source/institution/
---
## Source.Institution property

Obtiene o establece la institución de una fuente.
