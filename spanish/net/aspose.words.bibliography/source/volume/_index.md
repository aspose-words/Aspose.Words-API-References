...
description: Ajuste fácilmente el volumen de la fuente para mejorar su experiencia de audio. Controle los niveles de sonido para una claridad óptima y disfrute de sus proyectos.
type: docs
weight: 520
url: /es/net/aspose.words.bibliography/source/volume/
---
## Source.Volume property

Obtiene o establece el volumen de una fuente.
