...
description: Descubra cómo gestionar eficientemente las propiedades Doi para una gestión fluida de identificadores de objetos digitales. ¡Mejore la visibilidad de su investigación hoy mismo!
type: docs
weight: 190
url: /es/net/aspose.words.bibliography/source/doi/
---
## Source.Doi property

Obtiene o establece el identificador del objeto digital.
