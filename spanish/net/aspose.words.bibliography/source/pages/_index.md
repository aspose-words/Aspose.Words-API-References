...
description: Gestiona fácilmente las páginas de origen. Recupera o configura fácilmente los detalles de las páginas de origen para optimizar la organización del contenido y la eficiencia del flujo de trabajo.
type: docs
weight: 310
url: /es/net/aspose.words.bibliography/source/pages/
---
## Source.Pages property

Obtiene o establece las páginas de una fuente.
