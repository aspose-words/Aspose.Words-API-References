...
description: Gestiona fácilmente la fecha de acceso a tus fuentes con Source DayAccessed. Registra y actualiza fácilmente cuándo se accedió a tu fuente para una mejor organización.
type: docs
weight: 160
url: /es/net/aspose.words.bibliography/source/dayaccessed/
---
## Source.DayAccessed property

Obtiene o establece el día en que se accedió a una fuente.
