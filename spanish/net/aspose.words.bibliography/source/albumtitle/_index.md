...
description: Administra fácilmente el título del álbum de tu fuente con la propiedad AlbumTitle. Obtén o establece títulos fácilmente para una mejor organización y accesibilidad.
type: docs
weight: 30
url: /es/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

Obtiene o establece el título del álbum de una fuente.
