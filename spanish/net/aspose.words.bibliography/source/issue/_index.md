...
description: Gestione sus problemas de origen sin esfuerzo. Obtenga o configure fácilmente las propiedades de origen para optimizar su flujo de trabajo y mejorar la productividad.
type: docs
weight: 240
url: /es/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

Obtiene o establece el problema de una fuente.
