...
description: Administre su propiedad de etiqueta de origen fácilmente. Obtenga o configure fácilmente el nombre de etiqueta único para su fuente, mejorando la organización y la eficiencia.
type: docs
weight: 450
url: /es/net/aspose.words.bibliography/source/tag/
---
## Source.Tag property

Obtiene o establece el nombre de la etiqueta de identificación de una fuente.
