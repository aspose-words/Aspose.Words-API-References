...
description: Gestiona fácilmente el título de publicación de tu fuente. Obtén o establece fácilmente el título para una mejor organización y claridad en tu investigación.
type: docs
weight: 350
url: /es/net/aspose.words.bibliography/source/publicationtitle/
---
## Source.PublicationTitle property

Obtiene o establece el título de publicación de una fuente.
