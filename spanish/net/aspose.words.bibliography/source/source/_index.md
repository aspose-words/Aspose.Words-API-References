...
description: Crea fácilmente una nueva instancia de la clase Source con nuestro constructor. ¡Simplifica tu proceso de codificación y mejora la eficiencia de tu proyecto hoy mismo!
type: docs
weight: 10
url: /es/net/aspose.words.bibliography/source/source/
---
## Source constructor

Inicializar una nueva instancia del[`Source`](../) clase.
...
| --- | --- | --- |
| tag | String | El nombre de la etiqueta de identificación. |
| sourceType | SourceType | El tipo de fuente. |
