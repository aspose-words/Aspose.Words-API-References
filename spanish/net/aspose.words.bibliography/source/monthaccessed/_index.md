...
description: Gestiona fácilmente el mes de acceso a tus fuentes. Configura o recupera fácilmente el mes de acceso para optimizar el seguimiento y la organización de los datos.
type: docs
weight: 290
url: /es/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

Obtiene o establece el mes en el que se accedió a una fuente.
