...
description: Gestiona fácilmente el título de tu sitio web de origen. Actualiza o recupera fácilmente el título de tu sitio web para mejorar tu visibilidad y marca online.
type: docs
weight: 230
url: /es/net/aspose.words.bibliography/source/internetsitetitle/
---
## Source.InternetSiteTitle property

Obtiene o establece el título del sitio de Internet de una fuente.
