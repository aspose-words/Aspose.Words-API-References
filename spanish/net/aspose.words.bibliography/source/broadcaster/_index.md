...
description: Descubre la propiedad Source Broadcaster y gestiona fácilmente la emisora de tu fuente para un mejor control y rendimiento de la transmisión. ¡Optimiza tu experiencia multimedia!
type: docs
weight: 50
url: /es/net/aspose.words.bibliography/source/broadcaster/
---
## Source.Broadcaster property

Obtiene o establece el transmisor de una fuente.
