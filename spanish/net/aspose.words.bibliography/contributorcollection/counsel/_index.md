...
description: Descubra ContributorCollection Counsel. Gestione y acceda fácilmente a los asesores legales para obtener información más completa sobre las propiedades y optimizar la toma de decisiones.
type: docs
weight: 70
url: /es/net/aspose.words.bibliography/contributorcollection/counsel/
---
## ContributorCollection.Counsel property

Obtiene o establece el consejo de una fuente.

```csharp
public Contributor Counsel { get; set; }
```
