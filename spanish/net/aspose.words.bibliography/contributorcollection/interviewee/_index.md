---
title: ContributorCollection.Interviewee
linktitle: Interviewee
articleTitle: Interviewee
second_title: Aspose.Words para .NET
description: Descubra la propiedad Entrevistado de ContributorCollection para gestionar y personalizar eficientemente los datos de los entrevistados de sus fuentes. ¡Mejore la organización de sus datos!
type: docs
weight: 100
url: /es/net/aspose.words.bibliography/contributorcollection/interviewee/
---
## ContributorCollection.Interviewee property

Obtiene o establece el entrevistado de una fuente.

```csharp
public Contributor Interviewee { get; set; }
```
