...
description: Descubra la propiedad Performer de ContributorCollection, administre y personalice fácilmente los ejecutantes de origen para una mejor organización y recuperación de datos.
type: docs
weight: 130
url: /es/net/aspose.words.bibliography/contributorcollection/performer/
---
## ContributorCollection.Performer property

Obtiene o establece el ejecutante de una fuente.
