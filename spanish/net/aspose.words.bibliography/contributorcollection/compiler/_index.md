...
description: Descubre la propiedad del compilador ContributorCollection para gestionar eficientemente los compiladores de código fuente. ¡Mejora tu experiencia de programación con fácil acceso y control!
type: docs
weight: 40
url: /es/net/aspose.words.bibliography/contributorcollection/compiler/
---
## ContributorCollection.Compiler property

Obtiene o establece el compilador de una fuente.
