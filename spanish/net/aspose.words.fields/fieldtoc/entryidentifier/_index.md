...
description: Descubra cómo la propiedad EntryIdentifier de FieldToc simplifica la gestión de campos de TC al combinar fácilmente identificadores de tipo para una organización de datos eficiente.
type: docs
weight: 50
url: /es/net/aspose.words.fields/fieldtoc/entryidentifier/
---
## FieldToc.EntryIdentifier property

Obtiene o establece una cadena que debe coincidir con los identificadores de tipo de los campos TC que se incluyen.
