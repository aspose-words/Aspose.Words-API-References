...
description: Descubra la propiedad EntrySeparator de FieldToc, personalice las secuencias de caracteres para mejorar la navegación en la página de entrada y mejorar la organización del documento.
type: docs
weight: 70
url: /es/net/aspose.words.fields/fieldtoc/entryseparator/
---
## FieldToc.EntrySeparator property

Obtiene o establece una secuencia de caracteres que separan una entrada y su número de página.
