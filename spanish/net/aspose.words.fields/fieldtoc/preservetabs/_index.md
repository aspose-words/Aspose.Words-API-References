...
description: Descubra cómo la propiedad PreserveTabs de FieldToc mejora la gestión de sus datos al conservar las entradas de pestañas en las entradas de la tabla para una mejor organización.
type: docs
weight: 140
url: /es/net/aspose.words.fields/fieldtoc/preservetabs/
---
## FieldToc.PreserveTabs property

Obtiene o establece si se deben conservar las entradas de tabulación dentro de las entradas de la tabla.
