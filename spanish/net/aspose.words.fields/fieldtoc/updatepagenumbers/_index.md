...
description: Actualice sin esfuerzo su tabla de contenido con el método UpdatePageNumbers de FieldToc, garantizando una navegación precisa y una mejor usabilidad del documento.
type: docs
weight: 180
...
`verdadero` Si la operación es exitosa. Si se eliminó alguno de los marcadores de la tabla de contenidos relacionados,`FALSO` será devuelto.
