...
description: Descubra la propiedad BookmarkName de FieldToc para administrar fácilmente los marcadores en sus documentos, mejorando la creación y organización de tablas sin esfuerzo.
type: docs
weight: 20
url: /es/net/aspose.words.fields/fieldtoc/bookmarkname/
---
## FieldToc.BookmarkName property

Obtiene o establece el nombre del marcador que marca la parte del documento utilizada para crear la tabla.
