...
| Nombre | Descripción |
| --- | --- |
| [AddStartStopChar](../../aspose.words.fields/fieldmergebarcode/addstartstopchar/) { get; set; } | Obtiene o establece si se agregan caracteres de inicio/detención para los tipos de código de barras NW7 y CODE39. |
...
| [DisplayText](../../aspose.words.fields/fieldmergebarcode/displaytext/) { get; set; } | Obtiene o establece si mostrar los datos del código de barras (texto) junto con la imagen. |
...
| [SymbolHeight](../../aspose.words.fields/fieldmergebarcode/symbolheight/) { get; set; } | Obtiene o establece la altura del símbolo. Las unidades están en TWIPS (1/1440 pulgadas). |
...
Combinación de correspondencia de un código de barras.
