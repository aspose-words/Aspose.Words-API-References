...
description: Descubra la propiedad FieldMergeBarcode BarcodeType para administrar y personalizar fácilmente varios tipos de códigos de barras como QR para una mejor integración de datos.
type: docs
weight: 40
