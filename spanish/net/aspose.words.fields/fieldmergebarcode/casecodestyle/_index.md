...
description: FieldMergeBarcode CaseCodeStyle propiedad. Obtiene o establece el estilo de un Código de caso para el tipo de código de barras ITF14. Los valores válidos son STDEXTADD en C#.
type: docs
weight: 60
