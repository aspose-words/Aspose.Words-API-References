...
description: FieldDisplayBarcode propiedad. Obtiene o establece el color de primer plano del símbolo del código de barras. Los valores válidos están en el rango 0 0xFFFFFF
type: docs
weight: 100
