...
description: FieldDisplayBarcode propiedad. Obtiene o establece el color de fondo del símbolo del código de barras. Los valores válidos están en el rango 0 0xFFFFFF
type: docs
weight: 30
