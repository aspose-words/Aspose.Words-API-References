...
description: FieldUpdatingProgressArgs propiedad. Obtiene un valor que indica si se completó la actualización del campo.
type: docs
weight: 20
...
Obtiene un valor que indica si se completó la actualización del campo.
