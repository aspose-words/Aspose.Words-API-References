...
description: FieldIndex propiedad. Obtiene o establece un encabezado que aparece al comienzo de cada conjunto de entradas para cualquier letra determinada.
type: docs
weight: 70
