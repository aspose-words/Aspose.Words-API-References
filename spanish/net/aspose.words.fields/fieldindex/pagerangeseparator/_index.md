...
description: FieldIndex PageRangeSeparator propiedad. Obtiene o establece la secuencia de caracteres que se utiliza para separar el inicio y el final de un rango de páginas en C#.
type: docs
weight: 130
