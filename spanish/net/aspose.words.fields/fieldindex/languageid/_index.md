...
description: Descubra la propiedad FieldIndex LanguageId para gestionar fácilmente los ID de idioma y optimizar la indexación. ¡Mejore sus capacidades de búsqueda hoy mismo!
type: docs
weight: 80
...
Obtiene o establece el ID del idioma utilizado para generar el índice.
