...
description: Descubra la propiedad FieldIndex NumberOfColumns para personalizar fácilmente el diseño de su índice con configuraciones de columnas óptimas para una mejor legibilidad y rendimiento.
type: docs
weight: 100
url: /es/net/aspose.words.fields/fieldindex/numberofcolumns/
---
## FieldIndex.NumberOfColumns property

Obtiene o establece el número de columnas por página utilizadas al crear el índice.
