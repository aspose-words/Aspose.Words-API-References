...
description: Acceda a la propiedad de elemento GeneralFormatCollection para recuperar fácilmente formatos personalizables en cualquier índice, mejorando la presentación de sus datos sin esfuerzo.
type: docs
weight: 20
url: /es/net/aspose.words.fields/generalformatcollection/item/
---
...
| --- | --- |
| index | El índice de un formato general. |
