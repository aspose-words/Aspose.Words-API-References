...
description: IBarcodeGenerator método. Genere una imagen de código de barras utilizando el conjunto de parámetros para el campo de código de barras antiguo.
type: docs
weight: 20
...
Genere una imagen de código de barras utilizando el conjunto de parámetros (para el campo de código de barras antiguo).
