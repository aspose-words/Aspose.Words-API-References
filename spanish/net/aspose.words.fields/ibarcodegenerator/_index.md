...
description: Aspose.Words.Fields.IBarcodeGenerator interfaz. Interfaz pública para generador personalizado de código de barras. La implementación debe ser proporcionada por el usuario.
type: docs
weight: 2500
...
Interfaz pública para generador personalizado de código de barras. La implementación debe ser proporcionada por el usuario.
...
| Nombre | Descripción |
| --- | --- |
| [GetBarcodeImage](../../aspose.words.fields/ibarcodegenerator/getbarcodeimage/)(BarcodeParameters) | Genere una imagen de código de barras utilizando el conjunto de parámetros (para el campo DisplayBarcode). |
| [GetOldBarcodeImage](../../aspose.words.fields/ibarcodegenerator/getoldbarcodeimage/)(BarcodeParameters) | Genere una imagen de código de barras utilizando el conjunto de parámetros (para el campo de código de barras antiguo). |
