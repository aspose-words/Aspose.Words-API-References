...
description: Descubra cómo la propiedad FilterLanguageId de FieldBibliography mejora la gestión de sus datos bibliográficos al filtrar fuentes por idioma para obtener resultados precisos.
type: docs
weight: 20
url: /es/net/aspose.words.fields/fieldbibliography/filterlanguageid/
---
## FieldBibliography.FilterLanguageId property

Obtiene o establece el ID del idioma que se utiliza para filtrar los datos bibliográficos solo para las fuentes del documento que usan ese idioma.
