...
| [FormatLanguageId](../../aspose.words.fields/fieldbibliography/formatlanguageid/) { get; set; } | Obtiene o establece el ID de idioma que se utiliza para formatear las fuentes bibliográficas en el documento. |
