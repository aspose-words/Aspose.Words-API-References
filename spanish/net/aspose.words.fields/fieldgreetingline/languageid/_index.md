...
description: Descubra la propiedad LanguageId de FieldGreetingLine para administrar fácilmente el formato de nombre con configuraciones de idioma personalizables para una mejor experiencia del usuario.
type: docs
weight: 30
...
Obtiene o establece el identificador del idioma utilizado para formatear el nombre.
