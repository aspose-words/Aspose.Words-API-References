...
description: Descubra cómo utilizar la propiedad FieldGreetingLine AlternateText para mejorar la experiencia del usuario mostrando texto personalizado cuando faltan nombres.
type: docs
weight: 20
url: /es/net/aspose.words.fields/fieldgreetingline/alternatetext/
---
## FieldGreetingLine.AlternateText property

Obtiene o establece el texto que se incluirá en el campo si el nombre está en blanco.
