...
description: FieldAsk PromptOnceOnMailMerge propiedad. Obtiene o establece si la respuesta del usuario debe recibirse una vez por cada operación de combinación de correspondencia en C#.
type: docs
weight: 40
