...
description: Descubra la propiedad FieldStyleRef InsertParagraphNumberInRelativeContext para administrar fácilmente la numeración de párrafos en sus documentos para una mayor claridad.
type: docs
weight: 40
...
Obtiene o establece si se debe insertar el número de párrafo del párrafo referenciado en el contexto relativo.
