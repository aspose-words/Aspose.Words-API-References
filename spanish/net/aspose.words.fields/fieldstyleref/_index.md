...
description: Aspose.Words.Fields.FieldStyleRef clase. Implementa el campo STYLEREF en C#.
type: docs
weight: 2440
...
| [InsertParagraphNumberInFullContext](../../aspose.words.fields/fieldstyleref/insertparagraphnumberinfullcontext/) { get; set; } | Obtiene o establece si se debe insertar el número de párrafo del párrafo al que se hace referencia en contexto completo. |
| [InsertParagraphNumberInRelativeContext](../../aspose.words.fields/fieldstyleref/insertparagraphnumberinrelativecontext/) { get; set; } | Obtiene o establece si se debe insertar el número de párrafo del párrafo al que se hace referencia en el contexto relativo. |
| [InsertRelativePosition](../../aspose.words.fields/fieldstyleref/insertrelativeposition/) { get; set; } | Obtiene o establece si se debe insertar la posición relativa del párrafo al que se hace referencia. |
...
| [StyleName](../../aspose.words.fields/fieldstyleref/stylename/) { get; set; } | Obtiene o establece el nombre del estilo por el cual se formatea el texto a buscar. |
...
STYLEREF se utiliza para hacer referencia a un fragmento de texto dentro del documento que tiene el formato del estilo especificado.
