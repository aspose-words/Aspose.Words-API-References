...
description: Descubra la clase Aspose.Words.Fields.FieldSkipIf para implementar eficientemente los campos SKIPIF, mejorando la automatización de documentos y la flexibilidad en sus proyectos.
type: docs
weight: 2830
...
Compara los valores designados por las expresiones[`LeftExpression`](./leftexpression/) y[`RightExpression`](./rightexpression/) en comparación utilizando el operador designado por[`ComparisonOperator`](./comparisonoperator/) Si la comparación es verdadera, SKIPIF cancela el documento de fusión actual, pasa al siguiente registro de datos en la fuente de datos e inicia un nuevo documento de fusión. Si la comparación es falsa, continúa el documento de fusión actual.
