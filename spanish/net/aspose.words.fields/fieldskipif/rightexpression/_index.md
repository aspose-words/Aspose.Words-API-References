...
description: Descubra la propiedad FieldSkipIf RightExpression, administre fácilmente expresiones de comparación para un mejor control de datos y operaciones optimizadas.
type: docs
weight: 40
