...
description: Descubra la propiedad FieldSkipIf LeftExpression, administre fácilmente el lado izquierdo de sus expresiones de comparación para un mejor control y flexibilidad de los datos.
type: docs
weight: 30
