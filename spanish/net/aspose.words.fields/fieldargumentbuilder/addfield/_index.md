...
description: Mejore la eficiencia de su codificación con el método AddField de FieldArgumentBuilder. Integre FieldBuilder a la perfección para una construcción robusta de argumentos.
type: docs
weight: 20
url: /es/net/aspose.words.fields/fieldargumentbuilder/addfield/
---
## FieldArgumentBuilder.AddField method

Agrega un campo representado por un[`FieldBuilder`](../../fieldbuilder/) al argumento.
