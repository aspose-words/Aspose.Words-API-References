...
description: Descubra la propiedad FieldDdeAuto InsertAsHtml. Administre fácilmente los objetos vinculados insertándolos como texto HTML para una integración perfecta y una funcionalidad mejorada.
type: docs
weight: 30
url: /es/net/aspose.words.fields/fieldddeauto/insertashtml/
---
## FieldDdeAuto.InsertAsHtml property

Obtiene o establece si se debe insertar el objeto vinculado como texto en formato HTML.
