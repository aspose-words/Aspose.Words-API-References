...
description: Descubra la clase Aspose.Words.Fields.FieldDdeAuto para una integración perfecta del campo DDEAUTO, mejorando la automatización de documentos y la eficiencia en sus proyectos.
type: docs
weight: 2200
...
| [InsertAsBitmap](../../aspose.words.fields/fieldddeauto/insertasbitmap/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como un mapa de bits. |
