...
description: Descubra la propiedad FieldDdeAuto InsertAsRtf, administre fácilmente objetos vinculados en formato de texto enriquecido (RTF) para una mejor integración y versatilidad de los documentos.
type: docs
weight: 50
url: /es/net/aspose.words.fields/fieldddeauto/insertasrtf/
---
## FieldDdeAuto.InsertAsRtf property

Obtiene o establece si se debe insertar el objeto vinculado en formato de texto enriquecido (RTF).
