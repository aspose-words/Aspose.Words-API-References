...
description: Obtiene o establece si insertar el objeto vinculado en formato de texto enriquecido RTF.
type: docs
weight: 50
...
Obtiene o establece si insertar el objeto vinculado en formato de texto enriquecido (RTF).
