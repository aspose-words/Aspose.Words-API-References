...
description: Descubra la propiedad FieldDdeAuto ProgId para gestionar fácilmente los tipos de aplicación para la información de enlaces. ¡Mejore su eficiencia de programación hoy mismo!
type: docs
weight: 90
url: /es/net/aspose.words.fields/fieldddeauto/progid/
---
## FieldDdeAuto.ProgId property

Obtiene o establece el tipo de aplicación de la información del enlace.
