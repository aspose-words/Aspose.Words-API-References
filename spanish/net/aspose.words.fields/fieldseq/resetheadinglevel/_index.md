...
description: FieldSeq propiedad. Obtiene o establece un número entero que representa un nivel de encabezado para restablecer el número de secuencia a. Devuelve 1 si el número está ausente.
type: docs
weight: 40
