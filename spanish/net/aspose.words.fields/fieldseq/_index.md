...
description: Aspose.Words.Fields.FieldSeq clase. Implementa el campo SEQ.
type: docs
weight: 2240
...
| [ResetHeadingLevel](../../aspose.words.fields/fieldseq/resetheadinglevel/) { get; set; } | Obtiene o establece un número entero que representa un nivel de encabezado para restablecer el número de secuencia a. Devuelve -1 si el número está ausente. |
