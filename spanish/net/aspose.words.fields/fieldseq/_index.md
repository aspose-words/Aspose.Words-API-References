...
description: Aspose.Words.Fields.FieldSeq clase. Implementa el campo SEQ en C#.
type: docs
weight: 2390
...
| [ResetHeadingLevel](../../aspose.words.fields/fieldseq/resetheadinglevel/) { get; set; } | Obtiene o establece un número entero que representa un nivel de encabezado para restablecer el número de secuencia. Devuelve -1 si el número está ausente. |
| [ResetNumber](../../aspose.words.fields/fieldseq/resetnumber/) { get; set; } | Obtiene o establece un número entero para restablecer el número de secuencia. Devuelve -1 si el número está ausente. |
