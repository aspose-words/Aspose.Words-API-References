...
description: Descubra la propiedad FieldCompare LeftExpression, acceda o modifique fácilmente el lado izquierdo de sus expresiones de comparación para un análisis de datos mejorado.
type: docs
weight: 30
