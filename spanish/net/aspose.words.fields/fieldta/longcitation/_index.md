...
description: Gestione su propiedad FieldTA LongCitation fácilmente. Obtenga o configure fácilmente citas largas para las entradas, mejorando la organización y la accesibilidad de sus datos.
type: docs
weight: 50
url: /es/net/aspose.words.fields/fieldta/longcitation/
---
## FieldTA.LongCitation property

Obtiene o establece la cita larga para la entrada.
