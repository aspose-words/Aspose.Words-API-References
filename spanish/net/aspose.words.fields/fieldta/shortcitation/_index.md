...
description: Gestione sus citas cortas de FieldTA fácilmente. Obtenga o configure citas cortas fácilmente para las entradas, mejorando la organización y la accesibilidad de los datos.
type: docs
weight: 70
...
Obtiene o establece la cita corta de la entrada.
