...
description: Descubra la clase Aspose.Words.Fields.FieldRevNum para una implementación fluida del campo REVNUM. ¡Mejore la automatización de documentos y agilice el flujo de trabajo!
type: docs
weight: 2750
...
Recupera el número de revisión del documento, tal como está registrado en el**Revisión** propiedad de las propiedades integradas del documento.
