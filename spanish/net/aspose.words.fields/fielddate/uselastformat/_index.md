...
description: FieldDate propiedad. Obtiene o establece si se debe utilizar un formato utilizado por última vez por la aplicación de hospedaje al insertar un nuevo campo de FECHA.
type: docs
weight: 20
...
Obtiene o establece si se debe utilizar un formato utilizado por última vez por la aplicación de hospedaje al insertar un nuevo campo de FECHA.
