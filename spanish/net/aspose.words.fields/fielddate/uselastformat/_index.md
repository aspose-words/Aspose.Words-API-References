...
description: FieldDate propiedad. Obtiene o establece si se debe utilizar un formato utilizado por última vez por la aplicación de alojamiento al insertar un nuevo campo FECHA.
type: docs
weight: 20
