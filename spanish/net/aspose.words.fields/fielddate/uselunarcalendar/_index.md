...
description: Optimice la gestión de fechas con la propiedad UseLunarCalendar de FieldDate. Cambie fácilmente entre los calendarios lunares hijri y hebreo para una funcionalidad mejorada.
type: docs
weight: 30
