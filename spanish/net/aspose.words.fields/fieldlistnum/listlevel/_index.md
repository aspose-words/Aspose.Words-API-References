...
description: Descubra la propiedad ListLevel FieldListNum para personalizar sus niveles de lista sin esfuerzo, mejorando la organización y el control de sus datos.
type: docs
weight: 30
url: /es/net/aspose.words.fields/fieldlistnum/listlevel/
---
## FieldListNum.ListLevel property

Obtiene o establece el nivel en la lista, anulando el comportamiento predeterminado del campo.
