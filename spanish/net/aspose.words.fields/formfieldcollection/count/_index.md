...
description: Descubra la propiedad FormFieldCollection Count, acceda fácilmente al número total de campos de formulario, mejorando su gestión de datos y la experiencia del usuario.
type: docs
weight: 10
url: /es/net/aspose.words.fields/formfieldcollection/count/
---
## FormFieldCollection.Count property

Devuelve el número de campos de formulario en la colección.
