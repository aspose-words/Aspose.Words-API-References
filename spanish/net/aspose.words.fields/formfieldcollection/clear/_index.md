...
description: Borre sin esfuerzo todos los campos de formulario de su documento con el método FormFieldCollection Clear, lo que garantiza un espacio de trabajo optimizado y organizado.
type: docs
weight: 30
url: /es/net/aspose.words.fields/formfieldcollection/clear/
---
## FormFieldCollection.Clear method

Elimina todos los campos de formulario de esta colección y del documento.
