...
description: Elimine fácilmente un campo de formulario con el método RemoveAt de FormFieldCollection. Optimice sus formularios con esta eficiente solución basada en índices.
type: docs
weight: 60
...
Elimina un campo de formulario en el índice especificado.
...
| --- | --- | --- |
| index | Int32 | El índice basado en cero del campo de formulario que se eliminará. |
