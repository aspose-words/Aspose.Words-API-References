...
description: Descubra la clase Aspose.Words.Fields.FieldSubject para una fácil implementación del campo ASUNTO, mejorando la automatización del documento y la eficiencia del formato.
type: docs
weight: 2860
...
Recupera y, opcionalmente, establece, el asunto del documento, tal como está registrado en el**Sujeto** propiedad de las propiedades integradas del documento.
