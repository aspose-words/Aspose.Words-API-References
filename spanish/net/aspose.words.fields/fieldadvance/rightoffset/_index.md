...
description: Descubra la propiedad FieldAdvance RightOffset, ajuste fácilmente la posición del texto con un control de punto preciso para mejorar el formato y la claridad del documento.
type: docs
weight: 50
...
Obtiene o establece el número de puntos que debe moverse hacia la derecha el texto que sigue al campo.
