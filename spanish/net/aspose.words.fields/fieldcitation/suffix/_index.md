...
description: Descubra la propiedad FieldCitation Suffix, administre fácilmente los sufijos de citas para mejorar la precisión de sus datos y agilizar su proceso de referencias.
type: docs
weight: 70
url: /es/net/aspose.words.fields/fieldcitation/suffix/
---
## FieldCitation.Suffix property

Obtiene o establece un sufijo que se añade a la cita.
