...
description: Descubra la clase Aspose.Words.Fields.FieldMergeRec para una fusión fluida de documentos con el campo MERGEREC. ¡Mejore la automatización de sus documentos hoy mismo!
type: docs
weight: 2570
...
En este momento los campos MERGEREC y MERGESEQ implementan la misma funcionalidad porque no sabemos con seguridad cómo omitir registros en la combinación de correspondencia de Aspose.Words.
