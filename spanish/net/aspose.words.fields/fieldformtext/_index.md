...
description: Descubra la clase Aspose.Words.Fields.FieldFormText para una implementación fluida del campo FORMTEXT. ¡Mejore la automatización de documentos con potentes funciones hoy mismo!
type: docs
weight: 2340
...
| Nombre | Descripción |
| --- | --- |
| [FieldFormText](fieldformtext/)() | Constructor predeterminado |
...
Inserta un campo de formulario de estilo cuadro de texto.
...
```csharp
Estos campos son equivalentes heredados de FormField. Podemos leerlos, pero no crearlos, usando Aspose.Words.
