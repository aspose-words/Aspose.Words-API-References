...
description: Descubra la propiedad FieldNextIf ComparisonOperator para administrar y personalizar fácilmente sus operadores de comparación para una funcionalidad mejorada.
type: docs
weight: 20
