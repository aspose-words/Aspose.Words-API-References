...
description: Descubra la propiedad LastRecord de FieldDatabase. Gestione fácilmente el último número de registro de datos para una inserción de datos fluida y una mayor eficiencia en la base de datos.
type: docs
weight: 80
url: /es/net/aspose.words.fields/fielddatabase/lastrecord/
---
## FieldDatabase.LastRecord property

Obtiene o establece el número de registro integral del último registro de datos a insertar.
