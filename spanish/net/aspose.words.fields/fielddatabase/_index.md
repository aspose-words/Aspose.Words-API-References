...
| [InsertHeadings](../../aspose.words.fields/fielddatabase/insertheadings/) { get; set; } | Obtiene o establece si se deben insertar los nombres de los campos de la base de datos como encabezados de columna en la tabla resultante. |
| [InsertOnceOnMailMerge](../../aspose.words.fields/fielddatabase/insertonceonmailmerge/) { get; set; } | Obtiene o establece si se deben insertar datos al comienzo de una combinación. |
...
| [TableFormat](../../aspose.words.fields/fielddatabase/tableformat/) { get; set; } | Obtiene o establece el formato que se aplicará al resultado de la consulta de la base de datos. |
