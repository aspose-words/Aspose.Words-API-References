...
description: Descubra la propiedad FieldDatabase FormatAttributes para personalizar fácilmente los atributos de tabla, mejorando la gestión y presentación de datos.
type: docs
weight: 50
url: /es/net/aspose.words.fields/fielddatabase/formatattributes/
---
## FieldDatabase.FormatAttributes property

Obtiene o establece qué atributos del formato se aplicarán a la tabla.
