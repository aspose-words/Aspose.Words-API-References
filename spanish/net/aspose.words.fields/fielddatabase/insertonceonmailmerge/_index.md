...
description: Descubra cómo la propiedad InsertOnceOnMailMerge en FieldDatabase mejora la combinación de datos al permitir una inserción perfecta al comienzo de las combinaciones.
type: docs
weight: 70
url: /es/net/aspose.words.fields/fielddatabase/insertonceonmailmerge/
---
## FieldDatabase.InsertOnceOnMailMerge property

Obtiene o establece si se deben insertar datos al comienzo de una fusión.
