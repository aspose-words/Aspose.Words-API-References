...
description: Descubra la propiedad FieldRef InsertRelativePosition, administre fácilmente la posición del párrafo para mejorar el formato del documento y la legibilidad.
type: docs
weight: 80
...
Obtiene o establece si se debe insertar la posición relativa del párrafo referenciado.
