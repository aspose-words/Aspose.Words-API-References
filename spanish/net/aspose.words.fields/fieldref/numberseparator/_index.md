...
description: Descubra la propiedad FieldRef NumberSeparator para personalizar fácilmente el formato de secuencia y número de página con su secuencia de caracteres preferida.
type: docs
weight: 90
