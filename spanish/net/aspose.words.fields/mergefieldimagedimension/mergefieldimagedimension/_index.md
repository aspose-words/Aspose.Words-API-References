...
description: Crea una instancia de dimensión de imagen con el valor dado en puntos.
type: docs
weight: 10
...
Crea una instancia de dimensión de imagen con el valor dado y la unidad dada.
