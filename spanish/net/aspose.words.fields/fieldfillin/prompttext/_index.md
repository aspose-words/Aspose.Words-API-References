...
description: FieldFillIn propiedad. Obtiene o establece el texto de solicitud el título de la ventana de solicitud.
type: docs
weight: 40
...
Obtiene o establece el texto de solicitud (el título de la ventana de solicitud).
