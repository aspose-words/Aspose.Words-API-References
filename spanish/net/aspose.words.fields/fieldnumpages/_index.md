...
description: Aspose.Words.Fields.FieldNumPages clase. Implementa el campo NUMPAGES en C#.
type: docs
weight: 2220
url: /es/net/aspose.words.fields/fieldnumpages/
---
## FieldNumPages class

Implementa el campo NUMPAGES.
...
| Nombre | Descripción |
| --- | --- |
| [FieldNumPages](fieldnumpages/)() | Constructor predeterminado |
...
Recupera el número de páginas del documento actual, tal como está registrado en el**paginas** propiedad de las propiedades del documento incorporado.
