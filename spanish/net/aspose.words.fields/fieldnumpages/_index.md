...
description: Descubra la clase Aspose.Words.Fields.FieldNumPages para implementar sin esfuerzo el campo NUMPAGES, mejorando la automatización y la eficiencia de los documentos.
type: docs
weight: 2630
...
Recupera el número de páginas del documento actual, tal como está registrado en el**Páginas** propiedad de las propiedades integradas del documento.
