...
description: Aspose.Words.Fields.FieldNumPages clase. Implementa el campo NUMPAGES.
type: docs
weight: 2070
...
Recupera el número de páginas del documento actual, según lo registrado en el **Paginas**propiedad de las propiedades del documento incorporado.
