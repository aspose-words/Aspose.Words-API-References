...
description: Descubra la propiedad IsAnsi de FieldSymbol, administre fácilmente los códigos de caracteres ANSI para un mejor manejo de datos y una mayor eficiencia de codificación.
type: docs
weight: 60
...
Obtiene o establece si el código de carácter se interpreta como el valor de un carácter ANSI.
