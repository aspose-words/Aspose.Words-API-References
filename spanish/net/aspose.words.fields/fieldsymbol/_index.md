...
description: Descubra la clase Aspose.Words.Fields.FieldSymbol para una implementación eficiente del campo SYMBOL, mejorando sus capacidades de procesamiento de documentos.
type: docs
weight: 2870
...
| [DontAffectsLineSpacing](../../aspose.words.fields/fieldsymbol/dontaffectslinespacing/) { get; set; } | Obtiene o establece si el carácter recuperado por el campo afecta el espaciado de línea del párrafo. |
