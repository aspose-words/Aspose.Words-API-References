...
description: Descubra la propiedad FieldSymbol CharacterCode, recupere o establezca fácilmente valores de código de carácter en decimal o hexadecimal para una gestión de datos perfecta.
type: docs
weight: 20
url: /es/net/aspose.words.fields/fieldsymbol/charactercode/
---
## FieldSymbol.CharacterCode property

Obtiene o establece el valor del punto de código del carácter en decimal o hexadecimal.
