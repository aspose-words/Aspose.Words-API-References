...
description: Cuando se implementa devuelve una respuesta del usuario al solicitarlo. Su implementación debería devolver nulo para indicar que el usuario no respondió al aviso es decir el usuario presionó el botón Cancelar en la ventana del aviso.
type: docs
weight: 10
