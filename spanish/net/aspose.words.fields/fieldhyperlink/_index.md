...
description: Aspose.Words.Fields.FieldHyperlink clase. Implementa el campo HIPERVÍNCULO en C#.
type: docs
weight: 1990
...
| Nombre | Descripción |
| --- | --- |
| [Address](../../aspose.words.fields/fieldhyperlink/address/) { get; set; } | Obtiene o establece una ubicación a la que salta este hipervínculo. |
...
| [Target](../../aspose.words.fields/fieldhyperlink/target/) { get; set; } | Obtiene o establece el destino al que se debe redirigir el enlace. |
