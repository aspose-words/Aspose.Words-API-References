...
description: FieldBarcode propiedad. Obtiene o establece el tipo de una Marca de identificación de frente FIM para insertar.
type: docs
weight: 20
...
Obtiene o establece el tipo de una Marca de identificación de frente (FIM) para insertar.
