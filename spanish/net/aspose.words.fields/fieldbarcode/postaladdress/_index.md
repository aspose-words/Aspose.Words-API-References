...
description: FieldBarcode propiedad. Obtiene o establece la dirección postal utilizada para generar un código de barras o el nombre del marcador que hace referencia a él.
type: docs
weight: 50
