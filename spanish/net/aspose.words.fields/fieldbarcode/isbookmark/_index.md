...
description: Descubra cómo la propiedad FieldBarcode IsBookmark mejora la funcionalidad de PostalAddress, permitiendo una gestión perfecta de marcadores para una mejor organización de los datos.
type: docs
weight: 30
url: /es/net/aspose.words.fields/fieldbarcode/isbookmark/
---
## FieldBarcode.IsBookmark property

Obtiene o establece si[`PostalAddress`](../postaladdress/) es el nombre de un marcador.
