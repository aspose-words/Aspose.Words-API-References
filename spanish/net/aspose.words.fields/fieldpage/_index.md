...
description: Aspose.Words.Fields.FieldPage clase. Implementa el campo PÁGINA en C#.
type: docs
weight: 2260
url: /es/net/aspose.words.fields/fieldpage/
---
## FieldPage class

Implementa el campo PÁGINA.
...
| Nombre | Descripción |
| --- | --- |
| [FieldPage](fieldpage/)() | Constructor predeterminado |
...
Recupera el número de la página actual.
