...
description: Mejore la automatización de sus documentos con la interfaz Aspose.Words.Fields.IFieldDatabaseProvider. Suministre datos sin problemas para las actualizaciones de FieldDatabase.
type: docs
weight: 3100
...
Implemente esta interfaz para proporcionar datos para el[`FieldDatabase`](../fielddatabase/) campo cuando se actualiza.
...
| Nombre | Descripción |
| --- | --- |
| [GetQueryResult](../../aspose.words.fields/ifielddatabaseprovider/getqueryresult/)(*string, string, string, [FieldDatabase](../fielddatabase/)*) | Devuelve el resultado de la consulta. |
