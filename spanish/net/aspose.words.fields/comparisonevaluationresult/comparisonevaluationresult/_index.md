...
description: Descubra el constructor ComparisonEvaluationResult para generar y analizar de manera eficiente los resultados de la evaluación de comparación para una mejor toma de decisiones.
type: docs
weight: 10
...
Crea un resultado de evaluación de comparación fallida con el mensaje de error correspondiente.
