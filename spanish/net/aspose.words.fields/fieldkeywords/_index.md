...
description: Descubra la clase Aspose.Words.Fields.FieldKeywords para implementar de manera eficiente el campo KEYWORDS, mejorando los metadatos y la capacidad de búsqueda de su documento.
type: docs
weight: 2500
...
Recupera y, opcionalmente, establece las palabras clave del documento, tal como están registradas en el**Palabras clave** propiedad de las propiedades integradas del documento.
