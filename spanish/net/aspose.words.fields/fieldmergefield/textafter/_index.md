...
description: Descubra la propiedad FieldMergeField TextAfter para personalizar fácilmente la salida de su campo con texto dinámico, mejorando la claridad y la participación del documento.
type: docs
weight: 50
url: /es/net/aspose.words.fields/fieldmergefield/textafter/
---
## FieldMergeField.TextAfter property

Obtiene o establece el texto que se insertará después del campo si el campo no está en blanco.
