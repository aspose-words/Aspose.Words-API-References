...
description: FieldMergeField IsVerticalFormatting propiedad. Obtiene o establece si se habilita la conversión de caracteres para el formato vertical en C#.
type: docs
weight: 40
...
Obtiene o establece si se habilita la conversión de caracteres para el formato vertical.
