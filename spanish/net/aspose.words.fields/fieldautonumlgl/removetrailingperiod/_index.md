...
description: FieldAutoNumLgl RemoveTrailingPeriod propiedad. Obtiene o establece si se muestra el número sin un punto final en C#.
type: docs
weight: 20
...
Obtiene o establece si se muestra el número sin un punto final.
