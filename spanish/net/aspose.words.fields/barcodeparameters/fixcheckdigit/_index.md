...
description: Garantice la precisión de los códigos de barras con la propiedad FixCheckDigit. Corrija automáticamente los dígitos de control no válidos para garantizar un escaneo fiable y la integridad de los datos.
type: docs
weight: 100
url: /es/net/aspose.words.fields/barcodeparameters/fixcheckdigit/
---
## BarcodeParameters.FixCheckDigit property

Si se debe corregir el dígito de control si no es válido.
