...
description: Descubra la propiedad IsBookmark de BarcodeParameters. Descubra cómo PostalAddress puede optimizar la gestión de documentos con soluciones de marcadores eficientes.
type: docs
weight: 120
url: /es/net/aspose.words.fields/barcodeparameters/isbookmark/
---
## BarcodeParameters.IsBookmark property

Si[`PostalAddress`](../postaladdress/) es el nombre de un marcador.
