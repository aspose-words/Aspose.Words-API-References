...
description: BarcodeParameters FacingIdentificationMark propiedad. Tipo de marca de identificación de frente FIM en C#.
type: docs
weight: 90
...
Tipo de marca de identificación de frente (FIM).
