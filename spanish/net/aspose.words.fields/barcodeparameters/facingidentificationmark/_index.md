...
description: Descubra la propiedad FacingIdentificationMark de BarcodeParameters, esencial para optimizar la integración de FIM y mejorar la precisión del escaneo de códigos de barras.
type: docs
weight: 90
url: /es/net/aspose.words.fields/barcodeparameters/facingidentificationmark/
---
## BarcodeParameters.FacingIdentificationMark property

Tipo de marca de identificación de cara (FIM).
