...
description: BarcodeParameters propiedad. Si se muestran los datos del código de barras texto junto con la imagen.
type: docs
weight: 70
...
Si se muestran los datos del código de barras (texto) junto con la imagen.
