...
description: Descubra la función IsUSPostalAddress de BarcodeParameters para verificar fácilmente si una dirección es una dirección postal estadounidense válida. ¡Mejore la precisión de sus datos hoy mismo!
type: docs
weight: 130
url: /es/net/aspose.words.fields/barcodeparameters/isuspostaladdress/
---
## BarcodeParameters.IsUSPostalAddress property

Si[`PostalAddress`](../postaladdress/) es una dirección postal de EE. UU.
