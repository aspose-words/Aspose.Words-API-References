...
description: Descubra la propiedad SymbolHeight de BarcodeParameters para ajustar fácilmente la altura de la imagen del código de barras en twips (1/1440 pulgadas) para un rendimiento de escaneo óptimo.
type: docs
weight: 170
