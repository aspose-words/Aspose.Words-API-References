...
description: Mejore la funcionalidad de sus códigos de barras con la propiedad AddStartStopChar para los tipos NW7 y CODE39. ¡Optimice la precisión y la eficiencia del escaneo!
type: docs
weight: 20
...
Si se deben agregar caracteres de inicio/detención para los tipos de código de barras NW7 y CODE39.
