...
description: Descubra la propiedad ErrorCorrectionLevel para códigos QR. Mejore sus códigos de barras con opciones óptimas de corrección de errores, con valores de 0 y 3 para mayor fiabilidad.
type: docs
weight: 80
