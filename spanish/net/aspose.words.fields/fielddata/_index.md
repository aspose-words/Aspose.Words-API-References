...
description: Descubra la clase Aspose.Words.Fields.FieldData, la clave para implementar eficientemente campos DATA en documentos. ¡Mejore la automatización de sus documentos hoy mismo!
type: docs
weight: 2140
url: /es/net/aspose.words.fields/fielddata/
---
## FieldData class

Implementa el campo DATOS.
...
| Nombre | Descripción |
| --- | --- |
| [FieldData](fielddata/)() | Constructor predeterminado |
...
Muestra cómo insertar un campo DATOS en un documento.
