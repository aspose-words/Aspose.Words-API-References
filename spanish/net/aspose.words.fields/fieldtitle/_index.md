...
description: Aspose.Words.Fields.FieldTitle clase. Implementa el campo TÍTULO en C#.
type: docs
weight: 2510
url: /es/net/aspose.words.fields/fieldtitle/
---
## FieldTitle class

Implementa el campo TÍTULO.
...
| Nombre | Descripción |
| --- | --- |
| [FieldTitle](fieldtitle/)() | Constructor predeterminado |
...
| [Text](../../aspose.words.fields/fieldtitle/text/) { get; set; } | Obtiene o establece el texto del título. |
...
Recupera y, opcionalmente, establece el título del documento, tal como está registrado en el**Título** propiedad de las propiedades del documento incorporado.
