...
description: FieldBuilder método. Agrega el interruptor de un campo.
type: docs
weight: 30
...
Agrega el interruptor de un campo.
...
Esta sobrecarga agrega una bandera (interruptor sin argumento).
