...
description: Descubra la propiedad FieldLink SourceItem para gestionar eficientemente los enlaces a archivos fuente. Optimice su flujo de trabajo obteniendo o configurando fácilmente el contenido vinculado.
type: docs
weight: 130
url: /es/net/aspose.words.fields/fieldlink/sourceitem/
---
## FieldLink.SourceItem property

Obtiene o establece la parte del archivo de origen que se está vinculando.
