...
description: Descubra la propiedad FieldLink InsertAsUnicode para administrar fácilmente objetos vinculados como texto Unicode, mejorando la compatibilidad y la flexibilidad de los datos.
type: docs
weight: 90
url: /es/net/aspose.words.fields/fieldlink/insertasunicode/
---
## FieldLink.InsertAsUnicode property

Obtiene o establece si se debe insertar el objeto vinculado como texto Unicode.
