...
description: Descubra la clase Aspose.Words.Fields.FieldLink para una implementación fluida del campo LINK. ¡Mejore su procesamiento de documentos con potentes funciones hoy mismo!
type: docs
weight: 2520
url: /es/net/aspose.words.fields/fieldlink/
---
## FieldLink class
...
| Nombre | Descripción |
| --- | --- |
| [FieldLink](fieldlink/)() | Constructor predeterminado |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [AutoUpdate](../../aspose.words.fields/fieldlink/autoupdate/) { get; set; } | Obtiene o establece si se debe actualizar este campo automáticamente. |
...
| [FormatUpdateType](../../aspose.words.fields/fieldlink/formatupdatetype/) { get; set; } | Obtiene o establece una forma en la que el objeto vinculado actualiza su formato. |
| [InsertAsBitmap](../../aspose.words.fields/fieldlink/insertasbitmap/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como un mapa de bits. |
| [InsertAsHtml](../../aspose.words.fields/fieldlink/insertashtml/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como texto en formato HTML. |
| [InsertAsPicture](../../aspose.words.fields/fieldlink/insertaspicture/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como una imagen. |
| [InsertAsRtf](../../aspose.words.fields/fieldlink/insertasrtf/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado en formato de texto enriquecido (RTF). |
| [InsertAsText](../../aspose.words.fields/fieldlink/insertastext/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado en formato de solo texto. |
| [InsertAsUnicode](../../aspose.words.fields/fieldlink/insertasunicode/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como texto Unicode. |
...
| [IsLinked](../../aspose.words.fields/fieldlink/islinked/) { get; set; } | Obtiene o establece si se debe reducir el tamaño del archivo al no almacenar datos gráficos con el documento. |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | Obtiene o establece si el campo está bloqueado (no debe recalcular su resultado). |
| [LocaleId](../../aspose.words.fields/field/localeid/) { get; set; } | Obtiene o establece el LCID del campo. |
| [ProgId](../../aspose.words.fields/fieldlink/progid/) { get; set; } | Obtiene o establece el tipo de aplicación de la información del enlace. |
...
| [SourceFullName](../../aspose.words.fields/fieldlink/sourcefullname/) { get; set; } | Obtiene o establece el nombre y la ubicación del archivo de origen. |
| [SourceItem](../../aspose.words.fields/fieldlink/sourceitem/) { get; set; } | Obtiene o establece la parte del archivo de origen que se está vinculando. |
...
Para la información copiada de otra aplicación, este campo vincula esa información a su archivo fuente original.
