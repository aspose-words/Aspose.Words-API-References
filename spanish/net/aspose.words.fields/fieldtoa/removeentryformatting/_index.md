...
description: FieldToa propiedad. Obtiene o establece si se elimina el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades.
type: docs
weight: 70
...
Obtiene o establece si se elimina el formato del texto de la entrada en el documento de la entrada en la tabla de autoridades.
