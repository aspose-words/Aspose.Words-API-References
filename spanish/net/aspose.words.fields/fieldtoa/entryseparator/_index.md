...
description: Descubra la propiedad EntrySeparator de FieldToa para personalizar fácilmente su tabla de autoridades con secuencias de caracteres flexibles para una mayor claridad.
type: docs
weight: 40
...
Obtiene o establece la secuencia de caracteres que se utiliza para separar una entrada de tabla de autoridades y su número de página.
