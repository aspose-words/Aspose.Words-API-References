...
description: FieldToa propiedad. Obtiene o establece la secuencia de caracteres que se utiliza para separar la entrada de una tabla de autoridades y su número de página.
type: docs
weight: 40
...
Obtiene o establece la secuencia de caracteres que se utiliza para separar la entrada de una tabla de autoridades y su número de página.
