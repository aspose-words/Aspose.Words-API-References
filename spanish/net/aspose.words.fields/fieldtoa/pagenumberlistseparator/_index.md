...
description: FieldToa PageNumberListSeparator propiedad. Obtiene o establece la secuencia de caracteres que se utiliza para separar dos números de página en una lista de números de página en C#.
type: docs
weight: 50
