...
description: Descubra la clase Aspose.Words.Fields.FieldFileSize para implementar sin esfuerzo el campo FILESIZE, mejorando la gestión de documentos con facilidad.
type: docs
weight: 2290
...
| [IsInKilobytes](../../aspose.words.fields/fieldfilesize/isinkilobytes/) { get; set; } | Obtiene o establece si se debe mostrar el tamaño del archivo en kilobytes. |
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes/) { get; set; } | Obtiene o establece si se debe mostrar el tamaño del archivo en megabytes. |
...
En la implementación actual, se utiliza el[`OriginalFileName`](../../aspose.words/document/originalfilename/) propiedad para recuperar el nombre del archivo utilizado para determinar el tamaño del archivo.
