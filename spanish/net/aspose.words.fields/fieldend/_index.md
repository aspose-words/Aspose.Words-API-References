...
description: Representa el final de un campo de Word en un documento.
type: docs
weight: 1710
...
| [HasSeparator](../../aspose.words.fields/fieldend/hasseparator) { get; } | Devoluciones **verdadero** si este campo tiene un separador. |
...
| override [NodeType](../../aspose.words.fields/fieldend/nodetype) { get; } | DevolucionesFieldEnd . |
...
[`FieldEnd`](../fieldend) es un nodo de nivel en línea y está representado por el[`FieldEndChar`](../../aspose.words/controlchar/fieldendchar) carácter de control en el documento.

[`FieldEnd`](../fieldend) solo puede ser hijo de[`Paragraph`](../../aspose.words/paragraph).
