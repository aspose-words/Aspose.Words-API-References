...
description: FieldEnd propiedad. Devoluciones verdadero si este campo tiene un separador.
type: docs
weight: 10
...
Devoluciones **verdadero** si este campo tiene un separador.
...
* class [FieldEnd](../)
* espacio de nombres [Aspose.Words.Fields](../../fieldend/)
