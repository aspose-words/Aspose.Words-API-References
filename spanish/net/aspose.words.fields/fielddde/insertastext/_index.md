...
description: Descubra cómo la propiedad InsertAsText de FieldDde mejora sus documentos al permitir que los objetos vinculados se inserten en formato de solo texto para una mejor compatibilidad.
type: docs
weight: 70
url: /es/net/aspose.words.fields/fielddde/insertastext/
---
## FieldDde.InsertAsText property

Obtiene o establece si se debe insertar el objeto vinculado en formato de solo texto.
