...
description: Descubra cómo utilizar la propiedad InsertAsBitmap de FieldDde para insertar fácilmente objetos vinculados como mapas de bits, mejorando el atractivo visual de su documento.
type: docs
weight: 30
url: /es/net/aspose.words.fields/fielddde/insertasbitmap/
---
## FieldDde.InsertAsBitmap property

Obtiene o establece si se debe insertar el objeto vinculado como un mapa de bits.
