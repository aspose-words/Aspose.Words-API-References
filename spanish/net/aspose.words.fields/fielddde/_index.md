...
description: Descubra la clase Aspose.Words.Fields.FieldDde para una implementación fluida de campos DDE. ¡Mejore la automatización de sus documentos con potentes funciones hoy mismo!
type: docs
weight: 2190
...
| Nombre | Descripción |
| --- | --- |
| [AutoUpdate](../../aspose.words.fields/fielddde/autoupdate/) { get; set; } | Obtiene o establece si se debe actualizar este campo automáticamente. |
...
| [InsertAsBitmap](../../aspose.words.fields/fielddde/insertasbitmap/) { get; set; } | Obtiene o establece si se debe insertar el objeto vinculado como un mapa de bits. |
...
Para la información copiada de otra aplicación, este campo vincula esa información a su archivo fuente original mediante DDE.
