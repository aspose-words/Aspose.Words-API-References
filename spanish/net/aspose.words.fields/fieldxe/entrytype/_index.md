...
description: Descubra la propiedad EntryType de FieldXE, administre y personalice fácilmente los tipos de entrada de índice para mejorar la organización de datos y la eficiencia de recuperación.
type: docs
weight: 20
