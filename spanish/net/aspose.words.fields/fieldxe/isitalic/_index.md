...
description: Descubra cómo la propiedad IsItalic de FieldXE mejora el estilo de su documento al aplicar fácilmente el formato cursiva a los números de página para lograr una apariencia pulida.
type: docs
weight: 40
