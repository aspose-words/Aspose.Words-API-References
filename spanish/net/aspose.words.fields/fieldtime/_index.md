...
description: Aspose.Words.Fields.FieldTime clase. Implementa el campo HORA en C#.
type: docs
weight: 2500
...
public void FieldTime()
{
    ...
    // Podemos usar la bandera \@ para cambiar el formato de nuestra hora mostrada.
    field = InsertFieldTime(builder, "\\@ HHmm");

    Assert.AreEqual(" TIME \\@ HHmm", field.GetFieldCode());

    // Podemos ajustar el formato para que el campo HORA muestre también la fecha, según el calendario gregoriano.
...
/// <summary>
/// Utilice un generador de documentos para insertar un campo de HORA, insertar un nuevo párrafo y devolver el campo.
/// </summary>
