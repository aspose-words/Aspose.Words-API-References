...
description: Implementa el campo NUMCHARS.
type: docs
weight: 2060
...
Recupera el número de caracteres en el documento actual, según lo registrado en el **Caracteres**propiedad de las propiedades del documento incorporado.
