...
description: Implementa el campo AUTOTEXTLIST.
type: docs
weight: 1470
...
| [ListStyle](../../aspose.words.fields/fieldautotextlist/liststyle) { get; set; } | Obtiene o establece el nombre del estilo en el que se basa la lista que contiene las entradas. |
| [LocaleId](../../aspose.words.fields/field/localeid) { get; set; } | Obtiene o establece el LCID del campo. |
| [Result](../../aspose.words.fields/field/result) { get; set; } | Obtiene o establece el texto que se encuentra entre el separador de campo y el final del campo. |
| [ScreenTip](../../aspose.words.fields/fieldautotextlist/screentip) { get; set; } | Obtiene o establece el texto de la información en pantalla para mostrar. |
