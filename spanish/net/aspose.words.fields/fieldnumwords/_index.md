...
description: Aspose.Words.Fields.FieldNumWords clase. Implementa el campo NUMWORDS en C#.
type: docs
weight: 2230
url: /es/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class

Implementa el campo NUMWORDS.
...
| Nombre | Descripción |
| --- | --- |
| [FieldNumWords](fieldnumwords/)() | Constructor predeterminado |
...
Recupera el número de palabras del documento actual, tal como está registrado en el**Palabras** propiedad de las propiedades del documento incorporado.
...
// 2 - Realiza un seguimiento del recuento de palabras con un campo NUMWORDS:
FieldNumWords fieldNumWords = (FieldNumWords)builder.InsertField(FieldType.FieldNumWords, true);
builder.Writeln(" words");

// 3 - Utilice los campos PÁGINA y NUMPAGES para mostrar en qué página se encuentra el campo,
...
// mientras editamos el documento mediante programación usando Aspose.Words, o en Microsoft Word.
 // Necesitamos actualizarlos cada vez que sea necesario para ver un valor actualizado.
doc.UpdateFields();
