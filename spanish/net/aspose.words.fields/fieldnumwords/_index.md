...
Recupera el número de palabras del documento actual, según lo registrado en el **Palabras**propiedad de las propiedades del documento incorporado.
...
// A continuación hay tres tipos de campos que podemos usar para rastrear el tamaño de nuestros documentos.
// 1 - Rastree el conteo de caracteres con un campo NUMCHARS:
FieldNumChars fieldNumChars = (FieldNumChars)builder.InsertField(FieldType.FieldNumChars, true);       
builder.Writeln(" characters");

// 2 - Seguimiento del conteo de palabras con un campo NUMWORDS:
