...
description: Descubra la clase Aspose.Words.Fields.FieldNumWords para gestionar fácilmente el recuento de palabras en sus documentos. ¡Mejore su procesamiento de texto con esta potente función!
type: docs
weight: 2640
...
Recupera el número de palabras del documento actual, tal como se registra en el**Palabras** propiedad de las propiedades integradas del documento.
