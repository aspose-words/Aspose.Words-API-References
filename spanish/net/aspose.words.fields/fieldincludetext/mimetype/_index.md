...
description: Administre sus archivos sin esfuerzo con la propiedad MimeType FieldIncludeText, que le permite obtener o configurar fácilmente el tipo MIME para una integración perfecta.
type: docs
weight: 50
...
Obtiene o establece el tipo MIME del archivo referenciado.
