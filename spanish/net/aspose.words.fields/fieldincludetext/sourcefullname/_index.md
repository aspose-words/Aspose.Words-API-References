...
description: FieldIncludeText propiedad. Obtiene o establece la ubicación del documento usando un IRI.
type: docs
weight: 70
...
Obtiene o establece la ubicación del documento usando un IRI.
