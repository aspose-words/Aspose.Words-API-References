...
description: FieldIncludePicture propiedad. Obtiene o establece si se debe reducir el tamaño del archivo al no almacenar datos gráficos con el documento.
type: docs
weight: 30
