...
| Nombre | Descripción |
| --- | --- |
| [FieldSet](fieldset/)() | Constructor predeterminado |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldset/bookmarkname/) { get; set; } | Obtiene o establece el nombre del marcador. |
| [BookmarkText](../../aspose.words.fields/fieldset/bookmarktext/) { get; set; } | Obtiene o establece el nuevo texto del marcador. |
