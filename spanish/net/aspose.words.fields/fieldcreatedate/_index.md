...
description: Descubra la clase Aspose.Words.Fields.FieldCreateDate para una gestión documental fluida. Implemente fácilmente el campo CREATEDATE y mejore sus flujos de trabajo.
type: docs
weight: 2130
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Obtiene o establece si se debe utilizar el calendario lunar hijri o el calendario lunar hebreo. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Obtiene o establece si se utilizará el calendario de la Era Saka. |
...
Recupera la fecha y hora de creación del documento. Por defecto, se utiliza el calendario gregoriano.
