...
description: Aspose.Words.Fields.FieldCreateDate clase. Implementa el campo CREATEDATE.
type: docs
weight: 1570
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Obtiene o establece si se usa el calendario Lunar Hijri o el calendario Lunar Hebreo. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Obtiene o establece si usar el calendario Saka Era. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldcreatedate/useumalquracalendar/) { get; set; } | Obtiene o establece si usar el calendario Um-al-Qura. |
