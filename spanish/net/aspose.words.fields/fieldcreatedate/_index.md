...
description: Aspose.Words.Fields.FieldCreateDate clase. Implementa el campo CREADOTE.
type: docs
weight: 1720
url: /es/net/aspose.words.fields/fieldcreatedate/
---
## FieldCreateDate class

Implementa el campo CREADOTE.
...
| Nombre | Descripción |
| --- | --- |
| [FieldCreateDate](fieldcreatedate/)() | Constructor predeterminado |
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | Obtiene o establece si se debe utilizar el calendario lunar Hijri o lunar hebreo. |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | Obtiene o establece si se debe utilizar el calendario de la Era Saka. |
| [UseUmAlQuraCalendar](../../aspose.words.fields/fieldcreatedate/useumalquracalendar/) { get; set; } | Obtiene o establece si se debe utilizar el calendario Um-al-Qura. |
...
Recupera la fecha y hora en que se creó el documento. Por defecto se utiliza el calendario gregoriano.
