...
description: Descubra la clase Aspose.Words.Fields.FieldDocVariable para una integración perfecta del campo DOCVARIABLE, mejorando la automatización y la gestión de sus documentos.
type: docs
weight: 2230
...
| [VariableName](../../aspose.words.fields/fielddocvariable/variablename/) { get; set; } | Obtiene o establece el nombre de la variable del documento a recuperar. |
