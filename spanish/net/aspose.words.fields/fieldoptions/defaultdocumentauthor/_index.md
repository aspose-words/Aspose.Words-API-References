...
description: Obtiene o establece el nombre del autor del documento predeterminado. Si el nombre del autor ya está especificado en las propiedades integradas del documento esta opción no se considera.
type: docs
weight: 60
