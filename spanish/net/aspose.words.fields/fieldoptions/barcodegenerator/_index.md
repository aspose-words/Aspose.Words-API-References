...
description: FieldOptions propiedad. Obtiene o establece un generador de código de barras personalizado.
type: docs
weight: 10
...
Obtiene o establece un generador de código de barras personalizado.
...
El generador de código de barras personalizado debe implementar una interfaz pública[`IBarcodeGenerator`](../../ibarcodegenerator/) .
