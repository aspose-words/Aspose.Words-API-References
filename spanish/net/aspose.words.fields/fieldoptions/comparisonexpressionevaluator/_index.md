...
description: Descubra la propiedad FieldOptions ComparisonExpressionEvaluator para administrar y personalizar fácilmente las expresiones de comparación de campos para un mejor análisis de datos.
type: docs
weight: 40
