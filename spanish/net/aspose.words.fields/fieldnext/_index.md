...
description: Descubra la clase Aspose.Words.Fields.FieldNext para gestionar eficientemente los campos NEXT en sus documentos. ¡Mejore la automatización de sus documentos hoy mismo!
type: docs
weight: 2590
url: /es/net/aspose.words.fields/fieldnext/
---
## FieldNext class

Implementa el campo SIGUIENTE.
...
| Nombre | Descripción |
| --- | --- |
| [FieldNext](fieldnext/)() | Constructor predeterminado |
...
Fusiona el siguiente registro de datos en el documento fusionado resultante actual, en lugar de iniciar un nuevo documento fusionado.
