...
description: Descubra la propiedad FieldFormat DateTimeFormat para personalizar fácilmente los resultados de los campos de fecha y hora para mejorar la presentación y claridad de los datos.
type: docs
weight: 10
...
Obtiene o establece un formato que se aplica al resultado de un campo de fecha y hora. Corresponde al parámetro \@.
