...
description: Descubra cómo la propiedad FieldFormat NumericFormat personaliza los resultados de los campos numéricos, mejorando la presentación de los datos y la experiencia del usuario de manera efectiva.
type: docs
weight: 30
...
Obtiene o establece un formato que se aplica al resultado de un campo numérico. Corresponde al parámetro \#.
