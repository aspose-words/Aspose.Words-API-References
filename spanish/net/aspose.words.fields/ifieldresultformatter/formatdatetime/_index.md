...
description: Descubre el método iFieldResultFormatter FormatDateTime para Aspose.Words. ¡Formatea fechas fácilmente con el parámetro dd.MM.aaaa!
type: docs
weight: 20
...
Se llama cuando Aspose.Words aplica un cambio de formato de fecha/hora, es decir, \@ "dd.MM.aaaa".
