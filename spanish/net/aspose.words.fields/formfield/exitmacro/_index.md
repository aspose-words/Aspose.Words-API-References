...
description: Descubra la propiedad FormField ExitMacro para gestionar fácilmente las macros de salida de sus formularios. ¡Mejore la experiencia del usuario y agilice la entrada de datos hoy mismo!
type: docs
weight: 90
...
Devuelve o establece un nombre de macro de salida para el campo de formulario.
