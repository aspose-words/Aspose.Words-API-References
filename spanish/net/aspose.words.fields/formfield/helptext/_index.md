...
description: FormField propiedad. Devuelve o establece el texto que se muestra en un cuadro de mensaje cuando el campo de formulario tiene el foco y el usuario presiona F1.
type: docs
weight: 100
...
Si la propiedad OwnHelp se establece en True, HelpText especifica el valor de la cadena de texto. Si OwnHelp se establece en False, HelpText especifica el nombre de una entrada de Autotexto que contiene texto de ayuda para el campo de formulario.
