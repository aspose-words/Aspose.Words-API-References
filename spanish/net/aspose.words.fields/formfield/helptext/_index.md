...
description: Descubra la propiedad HelpText de FormField, mejore la experiencia del usuario con mensajes informativos que se muestran cuando se presiona F1 en los campos enfocados.
type: docs
weight: 100
...
Devuelve o establece el texto que se muestra en un cuadro de mensaje cuando el campo de formulario tiene el foco y el usuario presiona F1.
...
Si el[`OwnHelp`](../ownhelp/) La propiedad está establecida en`verdadero` ,`HelpText` especifica el valor de la cadena de texto. Si[`OwnHelp`](../ownhelp/) está configurado para`FALSO` ,`HelpText` especifica el nombre de una entrada de Autotexto que contiene texto help para el campo de formulario.
