...
description: Devuelve o establece el formato de texto para un campo de formulario de texto.
type: docs
weight: 200
...
Si el campo de formulario de texto contiene texto normal, las cadenas de formato válidas son "", "MAYÚSCULAS", "MINÚSCULAS", "PRIMERA MAYÚSCULAS" y "TÍTULO". Las cadenas no distinguen entre mayúsculas y minúsculas.

Si el campo de formulario de texto contiene un número o un valor de fecha/hora, entonces las cadenas de formato valid son cadenas de formato numérico o de fecha y hora.
