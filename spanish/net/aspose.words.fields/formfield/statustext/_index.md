...
description: Devuelve o establece el texto que se muestra en la barra de estado cuando un campo de formulario tiene el foco.
type: docs
weight: 180
...
Devuelve o establece el texto que se muestra en la barra de estado cuando un campo de formulario tiene el foco.
...
Si la propiedad OwnStatus se establece en true, la propiedad StatusText especifica el texto de la barra de estado. Si la propiedad OwnStatus se establece en false, la propiedad StatusText especifica el nombre de una entrada AutoText que contiene el texto de la barra de estado para el campo de formulario.
