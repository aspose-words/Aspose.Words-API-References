...
description: Descubra la propiedad FormField DropDownSelectedIndex para administrar fácilmente las selecciones desplegables, mejorando la experiencia del usuario y la funcionalidad del formulario.
type: docs
weight: 60
...
Obtiene o establece el índice que especifica el elemento seleccionado actualmente en un campo de formulario desplegable.
