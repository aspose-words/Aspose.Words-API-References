...
description: FormField propiedad. Devuelve o establece un nombre de macro de entrada para el campo de formulario.
type: docs
weight: 80
...
Devuelve o establece un nombre de macro de entrada para el campo de formulario.
...
La macro de entrada se ejecuta cuando el campo de formulario recibe el foco en Microsoft Word.
