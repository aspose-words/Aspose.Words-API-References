...
description: FormField propiedad. Especifica la fuente del texto que se muestra en un cuadro de mensaje cuando un campo de formulario tiene el foco y el usuario presiona F1.
type: docs
weight: 150
...
Si es True, se muestra el texto especificado por la propiedad HelpText. Si es False, se muestra el texto de la entrada de Autotexto especificada por la propiedad HelpText.
