...
description: Descubra la propiedad FormField MaxLength para establecer límites en los campos de texto. Mejore la experiencia del usuario con configuraciones de longitud personalizables para una entrada de datos óptima.
type: docs
weight: 120
url: /es/net/aspose.words.fields/formfield/maxlength/
---
## FormField.MaxLength property

Longitud máxima del campo de texto. Cero si la longitud es ilimitada.
