...
description: Descubra la propiedad TextInputType de FormField para personalizar fácilmente los campos de formulario de texto. Mejore la experiencia del usuario configurando tipos de entrada específicos sin esfuerzo.
type: docs
weight: 210
...
Obtiene o establece el tipo de un campo de formulario de texto.
