...
description: Descubra cómo la propiedad OwnStatus de FormField mejora la experiencia del usuario al personalizar el texto de la barra de estado cuando se enfoca un campo de formulario.
type: docs
weight: 160
