...
description: FormField propiedad. Especifica la fuente del texto que se muestra en la barra de estado cuando un campo de formulario tiene el foco.
type: docs
weight: 160
...
Si es verdadero, se muestra el texto especificado por la propiedad StatusText. Si es falso, se muestra el texto de la entrada de Autotexto especificada por la propiedad StatusText.
