...
description: FormField IsCheckBoxExactSize propiedad. Obtiene o establece el valor booleano que indica si el tamaño del cuadro de texto es automático o se especifica explícitamente en C#.
type: docs
weight: 110
