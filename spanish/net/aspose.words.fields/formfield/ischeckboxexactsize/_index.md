...
description: Descubra la propiedad IsCheckBoxExactSize de FormField, controle fácilmente el tamaño del cuadro de texto con una configuración booleana simple para una personalización óptima.
type: docs
weight: 110
url: /es/net/aspose.words.fields/formfield/ischeckboxexactsize/
---
## FormField.IsCheckBoxExactSize property

Obtiene o establece el valor booleano que indica si el tamaño del cuadro de texto es automático o se especifica explícitamente.
