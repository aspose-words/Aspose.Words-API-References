...
description: Aplica el formato de texto especificado enTextInputFormataspose.words.fields/formfield/textinputformat/ y almacena el valor enResultaspose.words.fields/formfield/result/ .
type: docs
weight: 250
...
| --- | --- | --- |
| newValue | Object | Puede ser una cadena, un número o un objeto DateTime. |

### Observaciones

los[`TextInputDefault`](../textinputdefault/) se aplica el valor si*newValue* es`nulo`.
