...
description: Descubra cómo el método SetTextInputValue de FormField mejora el formato del texto y almacena los resultados de manera eficiente, agilizando su proceso de ingreso de datos.
type: docs
weight: 250
url: /es/net/aspose.words.fields/formfield/settextinputvalue/
---
## FormField.SetTextInputValue method

Aplica el formato de texto especificado en[`TextInputFormat`](../textinputformat/) y almacena el valor en[`Result`](../result/) .
...
| --- | --- | --- |
| newValue | Object | Puede ser una cadena, un número o un**Fecha y hora** objeto. |

## Observaciones

El[`TextInputDefault`](../textinputdefault/) El valor se aplica si*newValue* es`nulo`.
