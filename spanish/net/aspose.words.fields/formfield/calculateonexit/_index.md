...
description: FormField propiedad. Verdadero si las referencias al campo de formulario especificado se actualizan automáticamente cada vez que se sale del campo.
type: docs
weight: 10
...
Ajuste **CalcularAlSalir** solo afecta el comportamiento del campo de formulario cuando el documento se abre en Microsoft Word. Aspose.Words nunca actualiza references al campo de formulario.
