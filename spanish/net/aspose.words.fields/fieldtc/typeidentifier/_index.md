...
description: Descubra la propiedad FieldTC TypeIdentifier. Gestione fácilmente los identificadores de tipo de campo con esta versátil función, optimizando la organización y la eficiencia de sus datos.
type: docs
weight: 50
...
Obtiene o establece un identificador de tipo para este campo (que normalmente es una letra).
