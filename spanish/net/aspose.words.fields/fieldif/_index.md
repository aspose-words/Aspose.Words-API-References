...
| [FalseText](../../aspose.words.fields/fieldif/falsetext/) { get; set; } | Obtiene o establece el texto mostrado si la expresión de comparación es`FALSO` . |
...
| [TrueText](../../aspose.words.fields/fieldif/truetext/) { get; set; } | Obtiene o establece el texto mostrado si la expresión de comparación es verdadera. |
