...
description: Se utiliza como valor para elSecurity./builtindocumentproperties/security/ property. Especifica el nivel de seguridad de un documento como un valor numérico.
type: docs
weight: 4240
