...
description: Descubra la propiedad Líneas BuiltInDocumentProperties, su clave para estimar eficientemente el número de líneas de documentos para una mejor gestión del contenido.
type: docs
weight: 190
