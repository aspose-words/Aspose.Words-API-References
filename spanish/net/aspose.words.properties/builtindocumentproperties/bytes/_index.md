...
description: Descubra la propiedad Bytes BuiltInDocumentProperties, una herramienta esencial para estimar el tamaño del documento, mejorar la gestión y la eficiencia de los archivos.
type: docs
weight: 20
url: /es/net/aspose.words.properties/builtindocumentproperties/bytes/
---
## BuiltInDocumentProperties.Bytes property

Representa una estimación del número de bytes del documento.
