...
description: BuiltInDocumentProperties propiedad. Representa una estimación del número de párrafos del documento.
type: docs
weight: 230
url: /es/net/aspose.words.properties/builtindocumentproperties/paragraphs/
---
## BuiltInDocumentProperties.Paragraphs property

Representa una estimación del número de párrafos del documento.
...
Aspose.Words actualiza esta propiedad cuando llama[`UpdateWordCount`](../../../aspose.words/document/updatewordcount/).
