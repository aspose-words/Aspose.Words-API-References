...
// Insertar un hipervínculo relativo a un documento en el sistema de archivos local llamado "Documento.docx".
// Al hacer clic en el enlace en Microsoft Word, se abrirá el documento designado, si está disponible.
builder.InsertHyperlink("Relative hyperlink", "Document.docx", false);

// Este enlace es relativo. Si no hay "Documento.docx" en la misma carpeta
// como el documento que contiene este enlace, el enlace se romperá.
...
// El documento al que estamos tratando de vincular está en un directorio diferente al que estamos planeando guardar el documento.
