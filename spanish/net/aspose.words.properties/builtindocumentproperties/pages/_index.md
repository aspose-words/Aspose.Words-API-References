...
description: Descubra la propiedad Páginas BuiltInDocumentProperties, que ofrece una estimación precisa del número de páginas de su documento para una gestión y organización eficientes.
type: docs
weight: 230
url: /es/net/aspose.words.properties/builtindocumentproperties/pages/
---
...
Aspose.Words actualiza esta propiedad cuando llamas[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/).
