...
description: Gestiona fácilmente la categoría de tus documentos con BuiltInDocumentProperties. Personaliza y optimiza fácilmente la organización de tus documentos para un flujo de trabajo optimizado.
type: docs
weight: 30
