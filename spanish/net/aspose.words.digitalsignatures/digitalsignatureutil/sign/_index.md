...
description: DigitalSignatureUtil método. Firma el documento de origen usando dadoCertificateHolder ySignOptions con firma digital y escribe el documento firmado en el flujo de destino.
type: docs
weight: 30
