...
description: Recupere fácilmente las firmas de sus documentos con DigitalSignatureCollection. Acceda a las firmas por índice para una gestión documental optimizada y una mayor eficiencia.
type: docs
weight: 40
...
Obtiene una firma de documento en el índice especificado.
...
| --- | --- |
| index | Índice basado en cero de la firma. |
