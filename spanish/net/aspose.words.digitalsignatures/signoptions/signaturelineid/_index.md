...
description: SignOptions propiedad. Identificador de línea de firma. El valor predeterminado es Guid vacío todo ceros .
type: docs
weight: 50
...
Identificador de línea de firma. El valor predeterminado es **Guid vacío (todo ceros)** .
