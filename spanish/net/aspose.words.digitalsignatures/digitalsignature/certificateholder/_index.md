...
description: DigitalSignature propiedad. Devuelve el objeto del titular del certificado que contiene el certificado que se utilizó para firmar el documento.
type: docs
weight: 10
