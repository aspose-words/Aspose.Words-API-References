...
description: DigitalSignature SubjectName propiedad. Devuelve el nombre distinguido del sujeto del certificado que se utilizó para firmar el documento en C#.
type: docs
weight: 80
