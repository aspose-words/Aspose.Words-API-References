...
description: BookmarksOutlineLevelCollection método. Determina si la colección contiene un marcador con el nombre dado.
type: docs
weight: 60
...
| --- | --- | --- |
| name | String | Nombre que no distingue entre mayúsculas y minúsculas del marcador que se va a localizar. |
