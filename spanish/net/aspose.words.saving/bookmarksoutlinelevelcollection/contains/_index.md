...
description: Descubre si un marcador existe en BookmarksOutlineLevelCollection. Gestiona fácilmente tus marcadores con este método esencial para una organización eficiente.
type: docs
weight: 60
...
Determina si la colección contiene un marcador con el nombre especificado.
...
| --- | --- | --- |
| name | String | Nombre del marcador que se va a localizar, que no distingue entre mayúsculas y minúsculas. |
