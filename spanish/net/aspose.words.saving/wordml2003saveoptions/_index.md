...
description: Aspose.Words.Saving.WordML2003SaveOptions clase. Se puede utilizar para especificar opciones adicionales al guardar un documento en elWordML formato en C#.
type: docs
weight: 5680
...
| override [SaveFormat](../../aspose.words.saving/wordml2003saveoptions/saveformat/) { get; set; } | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Sólo se puedeWordML . |
...
Por el momento sólo proporciona el[`SaveFormat`](./saveformat/)propiedad, pero en el futuro es posible que se agreguen otras opciones.
...
// Establece el indicador "MemoryOptimization" en "true" para disminuir el consumo de memoria
// durante la operación de guardado del documento a costa de un mayor tiempo de guardado.
// Establece el indicador "MemoryOptimization" en "false" para guardar el documento normalmente.
