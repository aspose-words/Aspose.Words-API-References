...
description: Especifica si las fuentes se deben incrustar en el documento HTML en formato Base64. Tenga en cuenta que establecer este indicador puede aumentar significativamente el tamaño del archivo HTML de salida.
type: docs
weight: 50
