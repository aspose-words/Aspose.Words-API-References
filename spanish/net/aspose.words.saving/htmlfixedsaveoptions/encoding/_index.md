...
description: Especifica la codificación que se utilizará al exportar a HTML. El valor predeterminado esnueva codificación UTF8 verdadero UTF8 con lista de materiales.
type: docs
weight: 30
