...
description: El indicador indica si las reglas CSS fontface deben colocarse en un archivo separado fontFaces.css cuando se guarda un documento con una hoja de estilo externa es decir cuandoExportEmbeddedCssaspose.words.saving/htmlfixedsaveoptions/exportembeddedcss/ esfalso . El valor predeterminado esfalso  todas las reglas CSS se escriben en un solo archivo styles.css.
type: docs
weight: 160
