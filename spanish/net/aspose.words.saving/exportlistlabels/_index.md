...
description: Especifica cómo se exportan las etiquetas de lista a HTML MHTML y EPUB.
type: docs
weight: 4750
...
| --- | --- | --- |
| Auto | `0` | Emite etiquetas de lista en modo automático. Usa elementos HTML nativos cuando es posible. |
| AsInlineText | `1` | Muestra todas las etiquetas de lista como texto en línea. |
| ByHtmlTags | `2` | Muestra todas las etiquetas de lista como elementos HTML nativos. |
