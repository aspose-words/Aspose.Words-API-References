...
description: Obtiene un conjunto con todas las páginas pares del documento en su orden original.
type: docs
weight: 30
...
Las páginas pares tienen índices impares ya que los índices de página están basados en cero.
