...
description: Aspose.Words.Saving.IImageSavingCallback interfaz. Implemente esta interfaz si desea controlar cómo Aspose.Words guarda las imágenes cuando guarda un documento en HTML. Puede ser utilizado por otros formatos.
type: docs
weight: 4910
...
Implemente esta interfaz si desea controlar cómo Aspose.Words guarda las imágenes cuando guarda un documento en HTML. Puede ser utilizado por otros formatos.
...
| Nombre | Descripción |
| --- | --- |
| [ImageSaving](../../aspose.words.saving/iimagesavingcallback/imagesaving/)(ImageSavingArgs) | Llamado cuando Aspose.Words guarda una imagen en HTML. |
