...
description: PdfSaveOptions ImageColorSpaceExportMode propiedad. Especifica cómo se seleccionará el espacio de color para las imágenes en el documento PDF en C#.
type: docs
weight: 190
