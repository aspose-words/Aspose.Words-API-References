...
description: Especifica el nombre de la carpeta utilizada para construir los URI de imagen escritos en un documento Xaml de página fija. El valor predeterminado esnulo .
type: docs
weight: 40
