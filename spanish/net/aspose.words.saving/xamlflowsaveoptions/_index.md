...
description: Aspose.Words.Saving.XamlFlowSaveOptions clase. Se puede utilizar para especificar opciones adicionales al guardar un documento en el XamlFlow oXamlFlowPack formato.
type: docs
weight: 5700
...
| [XamlFlowSaveOptions](xamlflowsaveoptions/#constructor_1)(SaveFormat) | Inicializa una nueva instancia de esta clase que se puede utilizar para guardar un documento en elXamlFlow oXamlFlowPack formato. |
