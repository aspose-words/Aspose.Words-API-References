...
description: Especifica el nombre de la carpeta utilizada para construir los URI de imagen escritos en un documento XAML. El valor predeterminado es una cadena vacía.
type: docs
weight: 40
