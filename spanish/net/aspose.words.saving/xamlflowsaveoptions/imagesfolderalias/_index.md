...
description: XamlFlowSaveOptions propiedad. Especifica el nombre de la carpeta utilizada para construir los URI de imagen escritos en un documento XAML. El valor predeterminado es una cadena vacía.
type: docs
weight: 40
...
Especifica el nombre de la carpeta utilizada para construir los URI de imagen escritos en un documento XAML. El valor predeterminado es una cadena vacía.
...
Si`ImagesFolderAlias` no es una cadena vacía, el URI de la imagen escrito en XAML seráImagesFolderAlias + &lt;nombre de archivo de imagen&gt;.

Si`ImagesFolderAlias` es una cadena vacía, entonces el URI de la imagen escrito en XAML seráImagesFolder + &lt;nombre de archivo de imagen&gt;.
