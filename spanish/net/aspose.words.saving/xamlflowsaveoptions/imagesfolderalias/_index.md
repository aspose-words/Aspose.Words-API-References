...
description: XamlFlowSaveOptions ImagesFolderAlias propiedad. Especifica el nombre de la carpeta utilizada para construir URI de imagen escritos en un documento XAML. El valor predeterminado es una cadena vacía en C#.
type: docs
weight: 40
