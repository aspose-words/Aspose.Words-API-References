...
description: Proporciona datos para elDocumentPartSaving./idocumentpartsavingcallback/documentpartsaving devolución de llamada.
type: docs
weight: 4680
...
| [DocumentPartFileName](../../aspose.words.saving/documentpartsavingargs/documentpartfilename) { get; set; } | Obtiene o establece el nombre del archivo (sin la ruta) donde se guardará la parte del documento. |
| [DocumentPartStream](../../aspose.words.saving/documentpartsavingargs/documentpartstream) { get; set; } | Permite especificar la secuencia en la que se guardará la parte del documento. |
| [KeepDocumentPartStreamOpen](../../aspose.words.saving/documentpartsavingargs/keepdocumentpartstreamopen) { get; set; } | Especifica si Aspose.Words debe mantener el flujo abierto o cerrarlo después de guardar una parte del documento. |
...
Clase[`DocumentPartSavingArgs`](../documentpartsavingargs) le permite controlar cómo se guardará cada parte del documento. Permite redefinir cómo se generan los nombres de archivo o eludir por completo el guardado de partes del documento en archivos proporcionando sus propios objetos de flujo.

Para guardar partes del documento en secuencias en lugar de archivos, use el[`DocumentPartStream`](./documentpartstream) propiedad.
