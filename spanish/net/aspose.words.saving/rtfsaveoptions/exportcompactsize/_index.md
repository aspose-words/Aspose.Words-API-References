...
description: Permite reducir el tamaño de los documentos RTF de salida pero si contienen texto RTL de derecha a izquierda no se mostrará correctamente. El valor predeterminado esfalso .
type: docs
weight: 20
