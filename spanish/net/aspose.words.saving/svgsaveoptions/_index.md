...
description: Se puede utilizar para especificar opciones adicionales al guardar un documento en elSvg formato.
type: docs
weight: 5320
...
| [ExportEmbeddedImages](../../aspose.words.saving/svgsaveoptions/exportembeddedimages) { get; set; } | Especificado si las imágenes deben incrustarse en el documento SVG como base64. Tenga en cuenta que establecer este indicador puede aumentar significativamente el tamaño del archivo SVG de salida. |
...
| [FitToViewPort](../../aspose.words.saving/svgsaveoptions/fittoviewport) { get; set; } | Especifica si el SVG de salida debe llenar el área de la ventana gráfica disponible (ventana del navegador o contenedor). Cuando se establece en verdadero, el ancho y la altura del SVG de salida se establecen en 100%. |
...
| [ResourceSavingCallback](../../aspose.words.saving/svgsaveoptions/resourcesavingcallback) { get; set; } | Permite controlar cómo se guardan los recursos (imágenes) cuando un documento se exporta a formato SVG. |
| [ResourcesFolder](../../aspose.words.saving/svgsaveoptions/resourcesfolder) { get; set; } | Especifica la carpeta física donde se guardan los recursos (imágenes) al exportar un documento a formato Svg. El valor predeterminado es`nulo` . |
| [ResourcesFolderAlias](../../aspose.words.saving/svgsaveoptions/resourcesfolderalias) { get; set; } | Especifica el nombre de la carpeta utilizada para construir los URI de imagen escritos en un documento SVG. El valor predeterminado es`nulo` . |
