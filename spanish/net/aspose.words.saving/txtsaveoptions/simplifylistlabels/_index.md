...
description: Especifica si el programa debe simplificar las etiquetas de lista en caso de que el formato de etiqueta complejo no se represente adecuadamente mediante texto sin formato.
type: docs
weight: 70
