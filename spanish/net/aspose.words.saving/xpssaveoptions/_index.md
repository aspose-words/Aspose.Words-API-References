...
description: Aspose.Words.Saving.XpsSaveOptions clase. Se puede utilizar para especificar opciones adicionales al guardar un documento en elXps formato.
type: docs
weight: 5430
...
| [XpsSaveOptions](xpssaveoptions/#constructor_1)(SaveFormat) | Inicializa una nueva instancia de esta clase que se puede usar para guardar un documento en elXps oOpenXps formato. |
