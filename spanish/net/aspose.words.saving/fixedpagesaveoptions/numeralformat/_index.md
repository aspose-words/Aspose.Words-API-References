...
description: Obtiene o estableceNumeralFormataspose.words.saving/numeralformat se utiliza para representar números. Los números europeos se utilizan de forma predeterminada.
type: docs
weight: 40
