...
description: Descubra la clase Aspose.Words.CssSavingArgs, diseñada para mejorar el procesamiento de sus documentos con datos de eventos CssSaving personalizables para obtener resultados óptimos.
type: docs
weight: 5620
...
Para guardar CSS en una secuencia, utilice el[`CssStream`](./cssstream/) propiedad.
