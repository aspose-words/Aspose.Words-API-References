...
description: Proteja sus documentos PDF con PdfDigitalSignatureTimestampSettings. Administre fácilmente las contraseñas del servidor de marcas de tiempo para una mayor protección y cumplimiento normativo.
type: docs
weight: 20
url: /es/net/aspose.words.saving/pdfdigitalsignaturetimestampsettings/password/
---
## PdfDigitalSignatureTimestampSettings.Password property

Contraseña del servidor de marca de tiempo.
