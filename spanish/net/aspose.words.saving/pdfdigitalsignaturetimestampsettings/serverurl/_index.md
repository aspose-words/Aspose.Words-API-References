...
description: Descubra la propiedad ServerUrl de PdfDigitalSignatureTimestampSettings para un sellado de tiempo seguro. Garantice la integridad de los documentos con URL de servidor de sellado de tiempo fiables.
type: docs
weight: 30
