...
description: Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Puede serDocx Docm  Dotx Dotm oFlatOpc .
type: docs
weight: 60
