...
description: OoxmlSaveOptions CompressionLevel propiedad. Especifica el nivel de compresión utilizado para guardar el documento. El valor predeterminado esNormal  en C#.
type: docs
weight: 30
