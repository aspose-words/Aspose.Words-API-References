...
description: Obtiene o establece el umbral que determina el valor del error de binarización en el método FloydSteinberg. cuandoImageBinarizationMethodaspose.words.saving/imagebinarizationmethod/ es ImageBinarizationMethod.FloydSteinbergDithering.
type: docs
weight: 150
