...
description: Obtiene o establece el umbral que determina el valor del error de binarización en el método Floyd-Steinberg. cuandoImageBinarizationMethodaspose.words.saving/imagebinarizationmethod es ImageBinarizationMethod.FloydSteinbergDithering.
type: docs
weight: 150
