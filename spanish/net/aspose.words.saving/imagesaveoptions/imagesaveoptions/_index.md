...
description: ImageSaveOptions constructor. Inicializa una nueva instancia de esta clase que se puede usar para guardar imágenes renderizadas en Tiff Png Bmp  Jpeg Emf Eps oSvg formato en C#.
type: docs
weight: 10
