...
description: Aspose.Words.Saving.ImageSaveOptions clase. Permite especificar opciones adicionales al representar páginas de documentos o formas en imágenes.
type: docs
weight: 5230
...
| Nombre | Descripción |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions/)(SaveFormat) | Inicializa una nueva instancia de esta clase que se puede usar para guardar imágenes renderizadas en Tiff ,Png ,Bmp , Jpeg ,Emf ,Eps oSvg formato. |
