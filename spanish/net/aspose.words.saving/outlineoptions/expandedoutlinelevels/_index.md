...
description: Descubra la propiedad ExpandedOutlineLevels en OutlineOptions, que le permite personalizar la visibilidad del esquema del documento para mejorar la navegación y la experiencia del usuario.
type: docs
weight: 60
...
Especifica cuántos niveles del esquema del documento se mostrarán expandidos cuando se visualice el archivo.
...
Especifique 0 y el esquema del documento se contraerá; especifique 1 y los elementos del primer nivel items en el esquema se expandirán y así sucesivamente.
