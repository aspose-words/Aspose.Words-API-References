...
description: OutlineOptions propiedad. Especifica si se crean o no esquemas para encabezados párrafos formateados con los estilos de encabezado dentro de las tablas.
type: docs
weight: 40
...
Especifica si se crean o no esquemas para encabezados (párrafos formateados con los estilos de encabezado) dentro de las tablas.
...
// Establecer la propiedad "HeadingsOutlineLevels" en "1" para obtener el esquema
...
// Establecer la propiedad "CreateOutlinesForHeadingsInTables" en "true" para incluir todos los encabezados dentro de las tablas
