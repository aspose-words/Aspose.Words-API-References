...
description: Especifica la resolución de umbral en píxeles por pulgada. Si la resolución de una imagen en el documento es inferior al valor de umbral no se aplicará el algoritmo de reducción de resolución. Un valor de 0 significa que no se utiliza la verificación de umbral y todas las imágenes que se puede reducir el tamaño se reducen.
type: docs
weight: 40
