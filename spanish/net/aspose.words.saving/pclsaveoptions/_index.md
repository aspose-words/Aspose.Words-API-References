...
description: Descubra Aspose.Words.PclSaveOptions para optimizar el guardado de documentos con funciones personalizables para el formato PCL. ¡Optimice su flujo de trabajo hoy mismo!
type: docs
weight: 6180
...
| [FallbackFontName](../../aspose.words.saving/pclsaveoptions/fallbackfontname/) { get; set; } | Nombre de la fuente que se utilizará si no se encuentra la fuente esperada en la impresora y en las colecciones de fuentes integradas. |
...
| [RasterizeTransformedElements](../../aspose.words.saving/pclsaveoptions/rasterizetransformedelements/) { get; set; } | Obtiene o establece un valor que determina si los elementos transformados complejos deben rasterizarse o no antes de guardarlos en el documento PCL. El valor predeterminado es`verdadero` . |
