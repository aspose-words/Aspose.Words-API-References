...
description: Descubra la propiedad MarkdownSaveOptions TableContentAlignment para personalizar la alineación del contenido de la tabla y lograr exportaciones de Markdown fluidas. El valor predeterminado es Automático.
type: docs
weight: 140
...
Obtiene o establece un valor que especifica cómo alinear el contenido en las tablas al exportar a laMarkdown format. El valor predeterminado esAuto .
