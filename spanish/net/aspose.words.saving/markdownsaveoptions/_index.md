...
description: Aspose.Words.Saving.MarkdownSaveOptions clase. Clase para especificar opciones adicionales al guardar un documento en elMarkdown formato en C#.
type: docs
weight: 5280
...
| Nombre | Descripción |
| --- | --- |
| [MarkdownSaveOptions](markdownsaveoptions/)() | Inicializa una nueva instancia de esta clase que se puede utilizar para guardar un documento en elMarkdown formato. |
...
| [ImagesFolderAlias](../../aspose.words.saving/markdownsaveoptions/imagesfolderalias/) { get; set; } | Especifica el nombre de la carpeta utilizada para construir los URI de imágenes escritos en un documento. El valor predeterminado es una cadena vacía. |
...
| override [SaveFormat](../../aspose.words.saving/markdownsaveoptions/saveformat/) { get; set; } | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Sólo se puedeMarkdown . |
| [TableContentAlignment](../../aspose.words.saving/markdownsaveoptions/tablecontentalignment/) { get; set; } | Obtiene o establece un valor que especifica cómo alinear el contenido en las tablas al exportar alMarkdown format. El valor predeterminado esAuto . |
