...
description: Aspose.Words.Saving.XlsxSaveOptions clase. Se puede utilizar para especificar opciones adicionales al guardar un documento en elXlsx formato en C#.
type: docs
weight: 5710
...
| override [SaveFormat](../../aspose.words.saving/xlsxsaveoptions/saveformat/) { get; set; } | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Sólo se puedeXlsx . |
