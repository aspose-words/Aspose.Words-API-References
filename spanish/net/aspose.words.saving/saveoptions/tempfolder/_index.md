...
description: Especifica la carpeta para los archivos temporales utilizados al guardar en un archivo DOC o DOCX. De manera predeterminada esta propiedad esnulo y no se utilizan archivos temporales.
type: docs
weight: 150
