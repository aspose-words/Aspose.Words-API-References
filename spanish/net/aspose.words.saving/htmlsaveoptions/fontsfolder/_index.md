...
description: Descubra la propiedad HtmlSaveOptions FontsFolder para administrar fácilmente el almacenamiento de fuentes para exportaciones HTML, mejorando la presentación y la accesibilidad del documento.
type: docs
weight: 310
...
Si guarda un documento en una secuencia, Aspose.Words no tiene una carpeta donde guardar las fuentes, pero aun así necesita guardarlas en algún lugar. En este caso, debe especificar una carpeta accesible en el archivo.`FontsFolder` propiedad o proporcionar secuencias personalizadas a través de el[`FontSavingCallback`](../fontsavingcallback/) controlador de eventos.
