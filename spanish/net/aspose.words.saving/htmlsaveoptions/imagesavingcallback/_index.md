...
description: Controle el guardado de imágenes con ImageSavingCallback de HtmlSaveOptions. Optimice la exportación de documentos a HTML, MHTML o EPUB para una experiencia de usuario fluida.
type: docs
weight: 350
