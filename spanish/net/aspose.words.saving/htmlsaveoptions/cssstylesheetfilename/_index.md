...
description: Especifica la ruta y el nombre del archivo de hoja de estilo en cascada CSS escrito cuando un documento se exporta a HTML. El valor predeterminado es una cadena vacía.
type: docs
weight: 50
