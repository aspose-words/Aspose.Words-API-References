...
description: Controle el guardado de partes del documento con DocumentPartSavingCallback de HtmlSaveOptions. Optimice sus exportaciones HTML o EPUB para una experiencia de usuario fluida.
type: docs
weight: 70
url: /es/net/aspose.words.saving/htmlsaveoptions/documentpartsavingcallback/
---
## HtmlSaveOptions.DocumentPartSavingCallback property

Permite controlar cómo se guardan las partes del documento cuando un documento se guarda en HTML o EPUB.
