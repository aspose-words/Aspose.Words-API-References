...
description: HtmlSaveOptions DocumentPartSavingCallback propiedad. Permite controlar cómo se guardan las partes del documento cuando un documento se guarda en HTML o EPUB en C#.
type: docs
weight: 70
