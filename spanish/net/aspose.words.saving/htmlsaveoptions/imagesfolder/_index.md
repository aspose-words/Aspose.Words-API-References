...
description: HtmlSaveOptions ImagesFolder propiedad. Especifica la carpeta física donde se guardan las imágenes al exportar un documento a formato HTML. El valor predeterminado es una cadena vacía en C#.
type: docs
weight: 360
