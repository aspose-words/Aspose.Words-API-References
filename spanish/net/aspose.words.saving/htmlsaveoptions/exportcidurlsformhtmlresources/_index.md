...
description: Especifica si se deben usar las URL de CID Content-ID para hacer referencia a los recursos imágenes fuentes CSS incluidos en los documentos MHTML . El valor predeterminado esfalso .
type: docs
weight: 120
