...
description: HtmlSaveOptions CssSavingCallback propiedad. Permite controlar cómo se guardan los estilos CSS cuando un documento se guarda en HTML MHTML o EPUB en C#.
type: docs
weight: 40
