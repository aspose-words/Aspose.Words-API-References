...
description: Aspose.Words.Saving.HtmlMetafileFormat enumeración. Indica el formato en el que se guardan los metarchivos en documentos HTML.
type: docs
weight: 4830
...
| --- | --- | --- |
| Png | `0` | Los metarchivos se representan en imágenes PNG de trama. |
