...
description: MappedDataFieldCollection método. Devuelve un objeto de enumerador de diccionario que se puede usar para iterar sobre todos los elementos de la colección.
type: docs
weight: 70
