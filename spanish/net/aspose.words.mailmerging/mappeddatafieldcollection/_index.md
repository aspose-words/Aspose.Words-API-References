...
description: Permite mapear automáticamente entre nombres de campos en su fuente de datos y nombres de campos de combinación de correspondencia en el documento.
type: docs
weight: 3650
