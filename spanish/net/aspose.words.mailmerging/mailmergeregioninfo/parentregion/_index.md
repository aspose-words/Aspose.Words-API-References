...
description: Descubra la propiedad ParentRegion de MailMergeRegionInfo, que proporciona información esencial sobre la región principal y devuelve un valor nulo para las regiones de nivel superior. ¡Mejore la automatización de sus documentos!
type: docs
weight: 70
url: /es/net/aspose.words.mailmerging/mailmergeregioninfo/parentregion/
---
## MailMergeRegionInfo.ParentRegion property

Devuelve información de la región principal (nulo para la región de nivel superior).
