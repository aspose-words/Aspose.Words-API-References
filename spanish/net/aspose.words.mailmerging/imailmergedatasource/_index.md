...
description: Implemente esta interfaz para permitir la combinación de correspondencia desde un origen de datos personalizado como una lista de objetos. También se admiten datos maestro-detalle.
type: docs
weight: 3590
