...
description: Devuelve el nombre de la fuente de datos.
type: docs
weight: 10
...
Si está implementando[`IMailMergeDataSource`](../../imailmergedatasource), devuelva el nombre de la fuente data de esta propiedad.
