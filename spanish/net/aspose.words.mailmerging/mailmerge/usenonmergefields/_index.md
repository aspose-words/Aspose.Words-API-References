...
description: Cuando es verdadero especifica que además de los campos MERGEFIELD la combinación de correspondencia se realiza en algunos otros tipos de campos y también en las etiquetas fieldName.
type: docs
weight: 150
