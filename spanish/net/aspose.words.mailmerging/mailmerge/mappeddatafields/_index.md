...
description: Descubra la propiedad MappedDataFields de MailMerge, acceda a una poderosa colección de campos de datos mapeados para mejorar sus operaciones de combinación de correspondencia sin esfuerzo.
type: docs
weight: 50
...
Los campos de datos mapeados permiten mapear automáticamente entre los nombres de los campos en su fuente de datos y los nombres de los campos de combinación de correspondencia en el documento.
