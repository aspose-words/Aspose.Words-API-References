...
description: Especifica si guardar o no un subconjunto de las fuentes TrueType incrustadas con el documento. El valor predeterminado para esta propiedad es falso.
type: docs
weight: 50
