...
description: Descubra cómo utilizar el método SetFontsFolder para especificar un directorio de fuentes TrueType en Aspose.Words, mejorando la representación de documentos y la incrustación de fuentes.
type: docs
weight: 80
...
| --- | --- | --- |
| fontFolder | String | La carpeta que contiene fuentes TrueType. |
