...
description: Crea notas al pie atractivas sin esfuerzo con nuestro Constructor de Notas al Pie. ¡Mejora la claridad y el profesionalismo de tu contenido con solo unos clics!
type: docs
weight: 10
...
Inicializa una instancia de la[`Footnote`](../) clase.
...
| footnoteType | FootnoteType | A[`FootnoteType`](../footnotetype/) value que especifica si se trata de una nota al pie o una nota final. |
