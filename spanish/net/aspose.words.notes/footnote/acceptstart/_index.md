...
description: Descubra el método Footnote AcceptStart, diseñado para mejorar la participación de los visitantes guiándolos sin problemas al comienzo de la nota al pie.
type: docs
weight: 100
url: /es/net/aspose.words.notes/footnote/acceptstart/
---
## Footnote.AcceptStart method

Acepta un visitante por visitar el inicio de la nota al pie.
