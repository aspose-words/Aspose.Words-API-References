...
description: Aspose.Words.Notes.EndnoteOptions clase. Representa las opciones de numeración de notas al final de un documento o sección.
type: docs
weight: 4000
...
Representa las opciones de numeración de notas al final de un documento o sección.
...
| Nombre | Descripción |
| --- | --- |
| [NumberStyle](../../aspose.words.notes/endnoteoptions/numberstyle/) { get; set; } | Especifica el formato de número para las notas al final numeradas automáticamente. |
...
| [StartNumber](../../aspose.words.notes/endnoteoptions/startnumber/) { get; set; } | Especifica el número o carácter inicial para las primeras notas al final numeradas automáticamente. |
