...
description: Descubra cómo la propiedad RestartRule de EndnoteOptions mejora su documento al controlar la numeración automática para lograr una apariencia pulida y profesional.
type: docs
weight: 30
