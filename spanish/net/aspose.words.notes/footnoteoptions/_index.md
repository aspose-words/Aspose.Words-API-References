...
description: Descubra la clase Aspose.Words.FootnoteOptions para personalizar la numeración de notas al pie en sus documentos y secciones. ¡Mejore la claridad de sus documentos hoy mismo!
type: docs
weight: 4970
...
| [NumberStyle](../../aspose.words.notes/footnoteoptions/numberstyle/) { get; set; } | Especifica el formato de número para notas al pie numeradas automáticamente. |
...
| [StartNumber](../../aspose.words.notes/footnoteoptions/startnumber/) { get; set; } | Especifica el número o carácter inicial para las primeras notas al pie numeradas automáticamente. |
