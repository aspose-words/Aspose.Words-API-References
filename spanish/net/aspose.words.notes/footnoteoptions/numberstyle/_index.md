...
description: Descubra la propiedad FootnoteOptions NumberStyle para personalizar fácilmente los formatos de numeración de notas al pie para mejorar la claridad y el profesionalismo del documento.
type: docs
weight: 20
...
Especifica el formato de número para notas al pie numeradas automáticamente.
