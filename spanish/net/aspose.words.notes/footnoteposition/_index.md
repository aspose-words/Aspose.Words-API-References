...
| --- | --- | --- |
| BottomOfPage | `1` | Las notas al pie se imprimen en la parte inferior de cada página. |
| BeneathText | `2` | Las notas al pie se muestran debajo del texto de cada página. |
