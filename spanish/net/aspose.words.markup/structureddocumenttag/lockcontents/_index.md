...
description: Descubra la propiedad StructuredDocumentTag LockContents, establecida en verdadero, evita que los usuarios editen contenido de SDT, lo que garantiza la integridad y seguridad del documento.
type: docs
weight: 200
...
Cuando se establece en`verdadero` , esta propiedad prohibirá que un usuario edite el contenido de este**TED** .
