...
description: Descubre la propiedad EndCharacterFont de StructuredDocumentTags para un formato de texto mejorado. ¡Mejora el último carácter de tu documento con fuentes personalizadas!
type: docs
weight: 120
...
Formato de fuente que se aplicará al último carácter del texto ingresado en**TED** .
