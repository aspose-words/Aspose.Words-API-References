...
description: Descubra la propiedad Apariencia de StructuredDocumentTag para personalizar y mejorar fácilmente el estilo visual de sus etiquetas de documentos estructurados.
type: docs
weight: 20
url: /es/net/aspose.words.markup/structureddocumenttag/appearance/
---
## StructuredDocumentTag.Appearance property

Obtiene/establece la apariencia de una etiqueta de documento estructurado.
