...
description: Descubra la propiedad Multiline StructuredDocumentTag, que permite múltiples líneas de texto para mejorar la flexibilidad del documento y la experiencia del usuario.
type: docs
weight: 210
url: /es/net/aspose.words.markup/structureddocumenttag/multiline/
---
## StructuredDocumentTag.Multiline property

Especifica si esto**TED** permite múltiples líneas de texto.
...
El acceso a esta propiedad sólo funcionará paraRichText yPlainText Tipo SDT.
