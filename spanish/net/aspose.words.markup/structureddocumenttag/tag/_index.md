...
description: Descubra la propiedad StructuredDocumentTag que define etiquetas esenciales para los nodos SDT, lo que garantiza una gestión y organización eficiente de los documentos.
type: docs
weight: 280
...
Especifica una etiqueta asociada con el nodo SDT actual. No se puede`nulo` .
...
Una etiqueta es una cadena arbitraria que las aplicaciones pueden asociar con SDT para identificarlo sin proporcionar un nombre descriptivo visible.
