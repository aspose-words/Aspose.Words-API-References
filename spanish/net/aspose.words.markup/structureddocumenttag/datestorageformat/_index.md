...
description: Obtiene/establece el formato en el que se almacena la fecha para una fecha SDT cuando el SDT está vinculado a un nodo XML en el almacén de datos del documento. El valor predeterminado esDateTime
type: docs
weight: 110
