...
description: Especifica si el contenido de este SDT se interpretará que contiene marcador de posición text a diferencia de los contenidos de texto regulares dentro de la SDT.
type: docs
weight: 150
