...
description: Descubra cómo la propiedad StructuredDocumentTag XmlMapping conecta sus etiquetas a datos XML, mejorando la personalización e integración de documentos para lograr flujos de trabajo perfectos.
type: docs
weight: 320
...
Puedes utilizar el[`SetMapping`](../../xmlmapping/setmapping/) método de este objeto para map una etiqueta de documento estructurado a datos XML.
