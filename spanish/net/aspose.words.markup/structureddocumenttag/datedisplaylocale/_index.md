...
description: StructuredDocumentTag DateDisplayLocale propiedad. Permite configurar/obtener el formato de idioma para la fecha que se muestra en esteTED  en C#.
type: docs
weight: 100
...
Permite configurar/obtener el formato de idioma para la fecha que se muestra en este**TED** .
