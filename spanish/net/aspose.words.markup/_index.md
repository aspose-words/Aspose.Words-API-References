...
| Clase | Descripción |
| --- | --- |
| [CustomPart](./custompart/) | Representa una pieza personalizada (contenido arbitrario), que no está definida por el estándar ISO/IEC 29500. |
| [CustomPartCollection](./custompartcollection/) | Representa una colección de[`CustomPart`](../aspose.words.markup/custompart/) objetos. |
| [CustomXmlPart](./customxmlpart/) | Representa una parte de almacenamiento de datos XML personalizada (datos XML personalizados dentro de un paquete). |
| [CustomXmlPartCollection](./customxmlpartcollection/) | Representa una colección de elementos XML personalizados. Los artículos son[`CustomXmlPart`](../aspose.words.markup/customxmlpart/) objetos. |
...
| [CustomXmlSchemaCollection](./customxmlschemacollection/) | Una colección de cadenas que representan esquemas XML asociados con un elemento XML personalizado. |
| [SdtListItem](./sdtlistitem/) | Este elemento especifica un único elemento de lista dentro de un elemento principalComboBox oDropDownList etiqueta de documento estructurado. |
...
| --- | --- |
| [MarkupLevel](./markuplevel/) | Especifica el nivel en el árbol del documento donde se[`StructuredDocumentTag`](../aspose.words.markup/structureddocumenttag/) puede ocurrir. |
