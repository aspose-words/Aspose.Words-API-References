...
description: Descubra la propiedad Elemento SmartTag para definir y administrar fácilmente los nombres de etiquetas inteligentes dentro de sus documentos para una mejor organización y eficiencia.
type: docs
weight: 20
url: /es/net/aspose.words.markup/smarttag/element/
---
## SmartTag.Element property

Especifica el nombre de la etiqueta inteligente dentro del documento.
