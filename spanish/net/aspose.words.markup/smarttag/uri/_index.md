...
description: Descubra la propiedad SmartTag Uri defina el URI del espacio de nombres de su etiqueta inteligente para obtener una funcionalidad mejorada y una integración perfecta en sus aplicaciones.
type: docs
weight: 50
