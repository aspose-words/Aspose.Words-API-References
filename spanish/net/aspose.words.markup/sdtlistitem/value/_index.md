...
description: Descubra la propiedad SdtListItem Value para acceder y administrar fácilmente los valores de los elementos de la lista para un mejor manejo de datos en sus aplicaciones.
type: docs
weight: 30
...
Obtiene el valor de este elemento de la lista.
