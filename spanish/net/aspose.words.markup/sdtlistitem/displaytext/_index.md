...
description: SdtListItem propiedad. Obtiene el texto para mostrar en el contenido de ejecución en lugar delValue contenido del atributo para este elemento de la lista.
type: docs
weight: 20
...
Obtiene el texto para mostrar en el contenido de ejecución en lugar del[`Value`](../value/) contenido del atributo para este elemento de la lista.
