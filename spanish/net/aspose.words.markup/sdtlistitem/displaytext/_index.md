...
description: Descubra cómo la propiedad SdtListItem DisplayText mejora su contenido al personalizar el texto mostrado, mejorando la participación y la claridad del usuario.
type: docs
weight: 20
...
Obtiene el texto que se mostrará en el contenido de la ejecución en lugar de[`Value`](../value/) contenido de los atributos para este elemento de la lista.
