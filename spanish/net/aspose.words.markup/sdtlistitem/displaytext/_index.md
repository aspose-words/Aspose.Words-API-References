...
description: Obtiene el texto para mostrar en el contenido de ejecución en lugar delValueaspose.words.markup/sdtlistitem/value contenido del atributo para este elemento de la lista.
type: docs
weight: 20
