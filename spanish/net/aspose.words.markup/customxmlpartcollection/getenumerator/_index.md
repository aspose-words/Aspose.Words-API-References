...
description: Explore el método GetEnumerator de CustomXmlPartCollection para iterar fácilmente a través de todos los elementos de la colección, mejorando su gestión de datos XML.
type: docs
weight: 80
