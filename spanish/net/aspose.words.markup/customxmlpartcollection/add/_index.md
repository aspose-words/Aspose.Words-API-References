...
description: Descubra el método CustomXmlPartCollection Add para mejorar sin esfuerzo sus colecciones agregando nuevos elementos con facilidad y eficiencia.
type: docs
weight: 40
...
| --- | --- | --- |
| part | CustomXmlPart | La parte XML personalizada para agregar. |
...
Crea una nueva parte XML con el XML especificado y la agrega a la colección.
