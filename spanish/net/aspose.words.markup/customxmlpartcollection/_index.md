...
description: Representa una colección de elementos XML personalizados. los artículos sonCustomXmlPart./customxmlpart/ objetos.
type: docs
weight: 3690
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.words.markup/customxmlpartcollection/add/#add_1)(CustomXmlPart) | Agrega un elemento a la colección. |
