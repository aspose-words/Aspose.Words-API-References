...
description: Descubra la propiedad IsShowingPlaceholderText de IStructuredDocumentTag para identificar fácilmente el texto de marcador de posición en su SDT, mejorando la claridad y la gestión del contenido.
type: docs
weight: 50
...
si se establece como verdadero, este estado se reanudará (mostrando texto de marcador de posición) al abrir este documento.
