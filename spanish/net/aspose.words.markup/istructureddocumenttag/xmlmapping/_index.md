...
description: Descubra cómo la propiedad IStructuredDocumentTag XmlMapping conecta etiquetas estructuradas a datos XML, mejorando la personalización e integración de documentos.
type: docs
weight: 160
...
Puedes utilizar el[`SetMapping`](../../xmlmapping/setmapping/)método de este objeto para mapear una etiqueta de documento estructurado a datos XML.
