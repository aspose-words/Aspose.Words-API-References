...
description: Descubra la propiedad IStructuredDocumentTag LockContentControl. Si se establece en "true", impide que los usuarios eliminen SDT, lo que mejora la integridad y el control del documento.
type: docs
weight: 70
...
Cuando se establece como verdadero, esta propiedad prohibirá que un usuario elimine esto**TED** .
