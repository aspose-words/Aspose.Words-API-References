...
description: Especifica cómo se almacena/recupera la fecha de una SDT de fecha cuando la SDT está vinculada a un nodo XML en el almacén de datos del documento.
type: docs
weight: 3770
