...
description: Descubra si CustomXmlPropertyCollection contiene una propiedad por nombre. Gestione eficientemente sus datos XML con nuestros métodos fiables para una integración perfecta.
type: docs
weight: 50
...
| --- | --- | --- |
| name | String | Nombre de la propiedad a localizar que distingue entre mayúsculas y minúsculas. |
