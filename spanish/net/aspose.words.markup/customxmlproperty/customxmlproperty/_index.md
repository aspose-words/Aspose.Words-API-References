...
description: Descubra el constructor CustomXmlProperty. Cree e inicialice fácilmente nuevas instancias para una gestión fluida de propiedades XML en sus proyectos.
type: docs
weight: 10
url: /es/net/aspose.words.markup/customxmlproperty/customxmlproperty/
---
...
| --- | --- | --- |
| name | String | El nombre de la propiedad. No puede ser`nulo`. |
| uri | String | El URI del espacio de nombres de la propiedad. No puede ser`nulo`. |
| value | String | El valor de la propiedad. No puede ser`nulo`. |
