...
description: Aspose.Words.Markup.CustomXmlSchemaCollection clase. Una colección de cadenas que representan esquemas XML asociados con una parte XML personalizada.
type: docs
weight: 3720
...
| Nombre | Descripción |
| --- | --- |
| [Count](../../aspose.words.markup/customxmlschemacollection/count/) { get; } | Obtiene el número de elementos que contiene la colección. |
...
| [GetEnumerator](../../aspose.words.markup/customxmlschemacollection/getenumerator/)() | Devuelve un objeto enumerador que se puede usar para iterar sobre todos los elementos de la colección. |
...
Usted no crea instancias de esta clase. Accede a la colección de esquemas XML de un XML personalizado part a través de la[`Schemas`](../customxmlpart/schemas/) propiedad.
