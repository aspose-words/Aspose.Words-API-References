...
description: Administre sin esfuerzo su CustomXmlSchemaCollection con el método Remove para eliminar valores específicos, mejorando la organización y la eficiencia de los datos.
type: docs
weight: 80
url: /es/net/aspose.words.markup/customxmlschemacollection/remove/
---
...
| --- | --- | --- |
| name | String | El valor que distingue entre mayúsculas y minúsculas que se va a eliminar. |
