...
description: Duplica fácilmente tu CustomXmlSchemaCollection con nuestro método Clonar para una experiencia de copia profunda y fluida. ¡Mejora tu gestión de XML hoy mismo!
type: docs
weight: 50
url: /es/net/aspose.words.markup/customxmlschemacollection/clone/
---
## CustomXmlSchemaCollection.Clone method

Realiza un clon profundo de este objeto.
