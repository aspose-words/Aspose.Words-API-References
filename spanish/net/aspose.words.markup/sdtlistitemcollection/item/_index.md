...
description: Acceda fácilmente a los objetos SdtListItem con la propiedad Item de SdtListItemCollection. Recupere elementos usando su índice de base cero para una gestión de datos fluida.
type: docs
weight: 20
...
Devuelve un[`SdtListItem`](../../sdtlistitem/) objeto dado su índice basado en cero en la colección.
