...
description: XmlMapping propiedad. Devuelve asignaciones de prefijos de espacios de nombres XML para evaluar elXPath .
type: docs
weight: 30
...
Devuelve asignaciones de prefijos de espacios de nombres XML para evaluar el[`XPath`](../xpath/) .
