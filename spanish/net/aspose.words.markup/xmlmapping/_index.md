...
| [PrefixMappings](../../aspose.words.markup/xmlmapping/prefixmappings/) { get; } | Devuelve asignaciones de prefijos de espacios de nombres XML para evaluar la[`XPath`](./xpath/) . |
| [StoreItemId](../../aspose.words.markup/xmlmapping/storeitemid/) { get; } | Especifica el identificador de datos XML personalizado para la parte de datos XML personalizado que se utilizará para evaluar el[`XPath`](./xpath/) expresión. |
