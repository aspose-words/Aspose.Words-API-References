...
| --- | --- | --- |
| Left | `0` | La etiqueta de la lista se alinea a la izquierda de la posición del número. |
| Center | `1` | La etiqueta de la lista se centra en la posición del número. |
| Right | `2` | Esta etiqueta de lista está alineada a la derecha de la posición del número. |

### Observaciones

Se utiliza como un valor para el[`Alignment`](../listlevel/alignment/) propiedad.
