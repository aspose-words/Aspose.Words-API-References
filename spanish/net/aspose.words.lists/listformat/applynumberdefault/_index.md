...
Este es un método abreviado que crea una nueva lista utilizando la plantilla numerada predeterminada, la aplica al párrafo y selecciona el primer nivel de lista.
