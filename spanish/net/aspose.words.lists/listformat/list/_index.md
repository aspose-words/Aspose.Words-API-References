...
description: Gestiona la estructura de tu documento con ListFormat. Obtén o configura fácilmente la lista para cualquier párrafo, mejorando la organización y la legibilidad.
type: docs
weight: 20
...
Establecer esta propiedad en`nulo` Elimina las viñetas y la numeración del párrafo y establece el número de nivel de lista en cero. Al establecer esta propiedad en`nulo` es equivalente a llamar[`RemoveNumbers`](../removenumbers/).
