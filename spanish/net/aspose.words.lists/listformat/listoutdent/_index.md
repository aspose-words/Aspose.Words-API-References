...
description: Descubra cómo el método ListFormat ListOutdent puede simplificar la estructura de su documento al reducir el nivel de lista del párrafo actual sin esfuerzo.
type: docs
weight: 80
url: /es/net/aspose.words.lists/listformat/listoutdent/
---
...
En documentos de Word, las listas pueden constar de hasta nueve niveles. El formato de lista para cada nivel especifica la viñeta o número utilizado, la sangría izquierda, el espacio entre la viñeta y el texto, etc.
