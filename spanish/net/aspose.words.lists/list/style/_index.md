...
description: List propiedad. Obtiene el estilo de lista al que hace referencia o define esta lista.
type: docs
weight: 80
...
Si esta lista no está asociada con un estilo de lista, la propiedad devolverá un valor nulo.
...
Una lista podría ser una definición de un estilo de lista, en este caso[`IsListStyleDefinition`](../isliststyledefinition/) será verdadero. Dicha lista no se puede aplicar directamente a los párrafos del documento.
