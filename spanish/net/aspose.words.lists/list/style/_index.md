...
description: Descubre la propiedad Estilo de Lista para definir y personalizar tus listas eficazmente. ¡Mejora tu diseño web con opciones de estilo únicas!
type: docs
weight: 80
...
Obtiene el estilo de lista al que esta lista hace referencia o define.
...
Si esta lista no está asociada a un estilo de lista, la propiedad devolverá`nulo`.
