...
description: List propiedad. Devuelve verdadero si esta lista es una definición de un estilo de lista.
type: docs
weight: 20
...
Cuando esta propiedad es verdadera, la[`Style`](../style/)La propiedad devuelve el estilo de lista que define esta lista.
