...
description: Descubra la propiedad ListLevel TrailingCharacter para personalizar el formato de su lista estableciendo o recuperando el carácter después de cada número de lista.
type: docs
weight: 140
