...
description: Descubra la propiedad NumberStyle de ListLevel para personalizar y establecer fácilmente estilos de números para sus listas, mejorando la organización y la claridad.
type: docs
weight: 90
