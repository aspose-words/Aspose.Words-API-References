...
description: ListLevel CustomNumberStyleFormat propiedad. Obtiene el formato de estilo de número personalizado para este nivel de lista. Por ejemplo a ç ĝ  en C#.
type: docs
weight: 20
