...
description: ListLevel NumberFormat propiedad. Devuelve o establece el formato de número para el nivel de lista en C#.
type: docs
weight: 70
...
Por ejemplo, la cadena "\x0000.\x0001)" generará una lista label que se parece a "1.5)". El número "1" es el número actual de el primer nivel de la lista, el número "5" es el número actual del segundo nivel de la lista.

No se permite un valor nulo, pero una cadena vacía significa que ningún número es válido.
