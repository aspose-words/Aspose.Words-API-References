...
Por ejemplo, la cadena "\x0000.\x0001)" generará una lista label similar a "1.5)". El número "1" es el número actual de el primer nivel de lista, el número "5" es el número actual del segundo nivel de lista.

Nulo no está permitido, pero una cadena vacía significa que ningún número es válido.
