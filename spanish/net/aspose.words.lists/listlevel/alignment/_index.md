...
description: ListLevel propiedad. Obtiene o establece la justificación del número real del elemento de la lista.
type: docs
weight: 10
...
La etiqueta de la lista se justifica en relación con el[`NumberPosition`](../numberposition/) propiedad.
