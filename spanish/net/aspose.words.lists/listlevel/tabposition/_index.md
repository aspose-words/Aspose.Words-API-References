...
description: ListLevel propiedad. Devuelve o establece la posición de tabulación en puntos para el nivel de lista.
type: docs
weight: 120
...
Sólo tiene efecto cuando[`TrailingCharacter`](../trailingcharacter/) es una pestaña
