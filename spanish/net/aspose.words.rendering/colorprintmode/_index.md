...
description: Aspose.Words.Rendering.ColorPrintMode enumeración. Especifica cómo se imprimen las páginas sin color si el dispositivo admite la impresión en color.
type: docs
weight: 4540
