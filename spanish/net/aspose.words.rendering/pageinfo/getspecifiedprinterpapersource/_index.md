...
description: Obtiene elPaperSource objeto adecuado para imprimir la página representada por estePageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
Obtiene elPaperSource objeto adecuado para imprimir la página representada por este[`PageInfo`](../../pageinfo) .
