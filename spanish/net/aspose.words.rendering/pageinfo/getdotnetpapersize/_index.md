...
description: Obtiene elPaperSize objeto adecuado para imprimir la página representada por estePageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 70
...
Obtiene elPaperSize objeto adecuado para imprimir la página representada por este[`PageInfo`](../../pageinfo) .
