...
description: Descubra la propiedad NodeRendererBase BoundsInPoints para acceder a dimensiones de forma precisas en puntos, mejorando la precisión y la eficiencia de su diseño.
type: docs
weight: 10
...
Esta propiedad devuelve el cuadro delimitador real (tal como se representa en la página) de la forma. Los límites tienen en cuenta la rotación de la forma (si la hay).
