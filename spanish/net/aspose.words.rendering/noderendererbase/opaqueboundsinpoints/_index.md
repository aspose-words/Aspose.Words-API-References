...
description: NodeRendererBase propiedad. Obtiene los límites opacos de la forma en puntos.
type: docs
weight: 20
...
Esta propiedad devuelve el cuadro delimitador opaco (es decir, se ignoran las partes transparentes de la forma). Los límites tienen en cuenta la rotación de la forma.
