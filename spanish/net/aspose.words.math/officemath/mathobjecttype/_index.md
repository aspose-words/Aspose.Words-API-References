...
description: Descubra la propiedad MathObjectType de OfficeMath para acceder y utilizar fácilmente MathObjectTypes para mejorar el formato y la funcionalidad de los documentos.
type: docs
weight: 30
