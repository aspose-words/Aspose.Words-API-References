...
description: Descubra el método AcceptStart de OfficeMath, diseñado para dar una bienvenida fluida a los visitantes y mejorar su experiencia matemática en la oficina. ¡Aumente su productividad hoy mismo!
type: docs
weight: 80
url: /es/net/aspose.words.math/officemath/acceptstart/
---
## OfficeMath.AcceptStart method

Acepta un visitante para visitar el inicio de la oficina de matemáticas.
