...
| Clase | Descripción |
| --- | --- |
| [OfficeMath](./officemath/) | Representa un objeto de Office Math como una función, ecuación, matriz o similar. Puede contener elementos secundarios , incluidas series de texto matemático, marcadores, comentarios y otros.[`OfficeMath`](../aspose.words.math/officemath/)instancias y algunos otros nodos. |
## Enumeración
