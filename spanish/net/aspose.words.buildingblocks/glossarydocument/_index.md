...
description: Aspose.Words.BuildingBlocks.GlossaryDocument clase. Representa el elemento raíz de un documento de glosario dentro de un documento de Word. Un documento de glosario es un almacenamiento para Autotexto entradas de Autocorrección y Building Blocks.
type: docs
weight: 170
