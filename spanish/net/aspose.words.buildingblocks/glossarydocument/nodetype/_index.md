...
description: Descubra la propiedad NodeType GlossaryDocument, que recupera de manera eficiente el valor de GlossaryDocument para una mejor gestión de contenido.
type: docs
weight: 50
url: /es/net/aspose.words.buildingblocks/glossarydocument/nodetype/
---
## GlossaryDocument.NodeType property

Devuelve elGlossaryDocument valor.
