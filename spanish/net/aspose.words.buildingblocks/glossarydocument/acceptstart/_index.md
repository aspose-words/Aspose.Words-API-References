...
description: Descubra el método AcceptStart de GlossaryDocument para dar una bienvenida fluida a los visitantes y mejorar su experiencia desde el comienzo de su glosario.
type: docs
weight: 80
url: /es/net/aspose.words.buildingblocks/glossarydocument/acceptstart/
---
## GlossaryDocument.AcceptStart method

Acepta un visitante por visitar el inicio del documento del Glosario.
