...
description: Descubra el método AcceptEnd de GlossaryDocument, que gestiona eficientemente el acceso de los visitantes al final de su glosario. ¡Mejore la experiencia del usuario hoy mismo!
type: docs
weight: 70
url: /es/net/aspose.words.buildingblocks/glossarydocument/acceptend/
---
## GlossaryDocument.AcceptEnd method

Acepta a un visitante por visitar el final del documento del Glosario.
