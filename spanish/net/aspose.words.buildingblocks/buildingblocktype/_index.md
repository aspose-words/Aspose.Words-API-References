...
description: Aspose.Words.BuildingBlocks.BuildingBlockType enumeración. Especifica un tipo de bloque de creación. El tipo puede afectar la visibilidad y el comportamiento del bloque de creación en Microsoft Word en C#.
type: docs
weight: 170
...
| --- | --- | --- |
| None | `0` | No se especifica ningún tipo de información para el bloque de creación. |
| AutomaticallyReplaceNameWithContent | `1` | Permite que el bloque de construcción se inserte automáticamente en el documento cada vez que se ingresa su nombre en una aplicación. |
...
| Normal | `4` | El componente básico es una entrada de documento de glosario normal (es decir, normal). |
...
Corresponde a la**ST_DocPartType** escriba OOXML.
