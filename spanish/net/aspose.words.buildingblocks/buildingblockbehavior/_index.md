...
description: Descubra la enumeración Aspose.Words BuildingBlockBehavior, que define cómo los bloques de construcción mejoran el contenido de su documento al insertarlo para una edición perfecta.
type: docs
weight: 330
...
Especifica el comportamiento que se aplicará al contenido del bloque de construcción cuando se inserta en el documento principal.
...
| --- | --- | --- |
| Content | `0` | Especifica que el bloque de construcción se insertará como contenido en línea. |
| Paragraph | `1` | Especifica que el bloque de construcción se insertará en su propio párrafo. |
| Page | `2` | Especifica que el bloque de construcción se agregará a su propia página. |
| Default | `0` | Lo mismo queContent . |

## Observaciones

Corresponde a la**Comportamiento de la parte del documento ST** Escriba en OOXML.
