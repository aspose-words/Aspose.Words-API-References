...
description: BuildingBlock propiedad. Especifica la categorización de primer nivel para el bloque de creación a efectos de la clasificación o la clasificación de la interfaz de usuario.
type: docs
weight: 60
...
Especifica la categorización de primer nivel para el bloque de creación a efectos de la clasificación o la clasificación de la interfaz de usuario.
...
Los bloques de construcción en la interfaz de usuario de Microsoft Word se organizan en galerías. Cada`Gallery` puede tener varias categorías. Cada bloque dentro de a[`Category`](../category/) tiene un[`Name`](../name/).

corresponde a la **docPartPr.category.gallery** elemento en OOXML.
