...
description: Especifica la categorización de primer nivel para el bloque de creación a efectos de la clasificación o la clasificación de la interfaz de usuario.
type: docs
weight: 60
