...
description: BuildingBlock propiedad. Especifica la categorización de primer nivel para el bloque de creación a efectos de clasificación o ordenación de la interfaz de usuario.
type: docs
weight: 60
