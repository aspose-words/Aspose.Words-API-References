...
description: Descubra la propiedad única de BuildingBlock Gallery para una categorización eficiente y una ordenación fluida de la interfaz de usuario. ¡Mejore su organización hoy mismo!
type: docs
weight: 60
url: /es/net/aspose.words.buildingblocks/buildingblock/gallery/
---
## BuildingBlock.Gallery property

Especifica la categorización de primer nivel para el bloque de construcción a los efectos de clasificación o clasificación de la interfaz de usuario.
...
Los bloques de construcción en la interfaz de usuario de Microsoft Word se organizan en galerías. Cada uno`Gallery` Puede tener varias categorías. Cada bloque dentro de a[`Category`](../category/) tiene una[`Name`](../name/).

Corresponde a la**docPartPr.categoría.galería** elemento en OOXML.
