...
description: Aspose.Words.BuildingBlocks.BuildingBlock clase. Representa una entrada de documento del glosario como un Building Block Autotexto o una entrada de Autocorrección.
type: docs
weight: 120
...
`BuildingBlock` solo puede contener[`Section`](../../aspose.words/section/) nodos.

`BuildingBlock` solo puede ser hijo de[`GlossaryDocument`](../glossarydocument/).
