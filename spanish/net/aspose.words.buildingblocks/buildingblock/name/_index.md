...
description: BuildingBlock propiedad. Obtiene o establece el nombre de este bloque de creación.
type: docs
weight: 90
...
El nombre puede tener cualquier contenido de cadena, generalmente un identificador amigable. Varios bloques de construcción pueden tener el mismo nombre.

No puede ser`nulo` y no puede ser una cadena vacía.

corresponde a la **docPartPr.name** elemento en OOXML.
