...
description: Descubre el constructor BuildingBlock y crea nuevas instancias fácilmente. ¡Desbloquea potentes funciones para un desarrollo fluido y un rendimiento mejorado!
type: docs
weight: 10
...
Cuando[`BuildingBlock`](../) se crea, pertenece al documento de glosario especificado, pero aún no es parte del documento de glosario y[`ParentNode`](../../../aspose.words/node/parentnode/) es`nulo`.

Para anexar[`BuildingBlock`](../) un[`GlossaryDocument`](../../glossarydocument/) usar [`AppendChild`](../../../aspose.words/compositenode/appendchild/).
