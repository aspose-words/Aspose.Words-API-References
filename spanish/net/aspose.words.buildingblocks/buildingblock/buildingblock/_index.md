...
Cuando[`BuildingBlock`](../../buildingblock) se crea, pertenece al documento de glosario especificado, pero aún no forma parte del documento de glosario y[`ParentNode`](../../../aspose.words/node/parentnode) es`nulo`.

Para anexar[`BuildingBlock`](../../buildingblock) a un[`GlossaryDocument`](../../glossarydocument) usar [`AppendChild`](../../../aspose.words/compositenode/appendchild).
