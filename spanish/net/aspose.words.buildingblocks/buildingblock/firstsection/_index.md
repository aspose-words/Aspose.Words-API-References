...
description: Descubre BuildingBlock FirstSection. Accede fácilmente a la primera sección de tu bloque de construcción para una organización optimizada y una mayor eficiencia.
type: docs
weight: 50
url: /es/net/aspose.words.buildingblocks/buildingblock/firstsection/
---
## BuildingBlock.FirstSection property

Obtiene la primera sección del bloque de construcción.
