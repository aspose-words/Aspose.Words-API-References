...
description: Descubra cómo BuildingBlock Behavior mejora su documento al definir métodos de inserción de contenido para una integración perfecta y un flujo de trabajo mejorado.
type: docs
weight: 20
url: /es/net/aspose.words.buildingblocks/buildingblock/behavior/
---
## BuildingBlock.Behavior property

Especifica el comportamiento que se aplicará cuando el contenido del bloque de construcción se inserte en el documento principal.
