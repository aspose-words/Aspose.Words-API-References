...
description: Descubra nuestras propiedades de categoría BuildingBlock para una categorización mejorada de segundo nivel, agilizando sus proyectos y aumentando la eficiencia de la organización.
type: docs
weight: 30
...
Los bloques de construcción en la interfaz de usuario de Microsoft Word se organizan en galerías. Cada uno[`Gallery`](../gallery/) Puede tener varias categorías. Cada bloque dentro de a`Category` tiene una[`Name`](../name/).

No puede ser`nulo` y no puede ser una cadena vacía.

Corresponde a la**docPartPr.categoría.nombre** elemento en OOXML.
