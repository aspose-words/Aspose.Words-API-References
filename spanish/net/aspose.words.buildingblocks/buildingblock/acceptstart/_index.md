...
description: Descubra el método BuildingBlock AcceptStart, dé la bienvenida a los visitantes de forma fluida y mejore su experiencia desde el momento de su llegada.
type: docs
weight: 150
url: /es/net/aspose.words.buildingblocks/buildingblock/acceptstart/
---
## BuildingBlock.AcceptStart method

Acepta un visitante por visitar el inicio del BuildingBlock.
