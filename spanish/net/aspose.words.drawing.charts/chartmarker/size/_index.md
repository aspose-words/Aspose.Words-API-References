...
description: ¡Ajusta fácilmente el tamaño del marcador de gráfico! Personaliza el tamaño del marcador de tu gráfico para mayor claridad y atractivo visual. El valor predeterminado es 7.
type: docs
weight: 20
url: /es/net/aspose.words.drawing.charts/chartmarker/size/
---
## ChartMarker.Size property

Obtiene o establece el tamaño del marcador del gráfico. El valor predeterminado es 7.
