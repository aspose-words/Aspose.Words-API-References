...
description: Descubra la propiedad Símbolo de Marcador de Gráfico para personalizar fácilmente sus marcadores de gráfico. Mejore la visualización de datos con símbolos únicos para obtener una mejor perspectiva.
type: docs
weight: 30
url: /es/net/aspose.words.drawing.charts/chartmarker/symbol/
---
## ChartMarker.Symbol property

Obtiene o establece el símbolo de marcador de gráfico.
