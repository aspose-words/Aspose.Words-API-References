...
description: Descubra la enumeración Aspose.Words.Drawing.Charts.AxisCrosses para definir puntos de cruce de ejes y mejorar sus capacidades de creación de gráficos sin esfuerzo.
type: docs
weight: 780
...
| Maximum | `1` | Un eje perpendicular cruza en el valor máximo del eje. |
| Minimum | `2` | Un eje perpendicular cruza en el valor mínimo del eje. |
| Custom | `3` | Un eje perpendicular cruza en el valor especificado del eje. |
