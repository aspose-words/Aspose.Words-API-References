...
description: Descubra cómo el método ChartDataPoint ClearFormat restablece el formato de sus puntos de datos al valor predeterminado, mejorando la claridad y la consistencia de sus gráficos.
type: docs
weight: 70
...
Borra el formato de este punto de datos. Las propiedades se restablecen a los valores predeterminados definidos en la serie principal.
