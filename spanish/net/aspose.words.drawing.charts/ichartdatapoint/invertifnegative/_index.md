...
description: Descubra la propiedad IChartDataPoint InvertIfNegative, que permite la inversión de color para valores negativos. ¡Mejore su visualización de datos con esta función única!
type: docs
weight: 30
...
Especifica si el elemento padre debe invertir sus colores si el valor es negativo.
