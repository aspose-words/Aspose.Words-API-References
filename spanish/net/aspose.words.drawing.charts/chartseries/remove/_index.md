...
Elimina el valor X, el valor Y y el tamaño de la burbuja, si se admiten, de la serie de gráficos en el índice especificado. También se eliminan el punto de datos y la etiqueta de datos correspondientes.
