...
description: Descubra la propiedad ChartSeries Name, administre fácilmente los nombres de las series, genere automáticamente índices y mejore la visualización de datos sin esfuerzo.
type: docs
weight: 110
...
Obtiene o establece el nombre de la serie, si el nombre no se establece explícitamente, se genera utilizando el índice. De manera predeterminada, devuelve Serie más uno basado en el índice.
