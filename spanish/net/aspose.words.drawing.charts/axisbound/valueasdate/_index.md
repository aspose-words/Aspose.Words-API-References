...
description: AxisBound propiedad. Devuelve el valor del límite del eje representado como datetime.
type: docs
weight: 40
...
Devuelve el valor del límite del eje representado como datetime.
