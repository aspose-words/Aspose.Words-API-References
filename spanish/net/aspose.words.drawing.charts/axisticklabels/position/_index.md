...
description: Descubra la propiedad Posición de AxisTickLabels para personalizar fácilmente la ubicación de la etiqueta de marca en su eje para una mejor visualización y claridad de los datos.
type: docs
weight: 60
url: /es/net/aspose.words.drawing.charts/axisticklabels/position/
---
## AxisTickLabels.Position property

Obtiene o establece la posición de las etiquetas de marca en el eje.
