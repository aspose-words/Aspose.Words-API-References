...
description: Mejore sus gráficos con la propiedad de fuente AxisTickLabels, que permite un formato de fuente personalizable para obtener etiquetas de marcas más claras e impactantes.
type: docs
weight: 20
url: /es/net/aspose.words.drawing.charts/axisticklabels/font/
---
## AxisTickLabels.Font property

Proporciona acceso al formato de fuente de las etiquetas de las marcas.
