...
description: Descubra la propiedad ChartSeriesGroup SeriesType para identificar fácilmente los tipos de series de gráficos en sus visualizaciones de datos para mejorar el análisis y la comprensión.
type: docs
weight: 110
url: /es/net/aspose.words.drawing.charts/chartseriesgroup/seriestype/
---
## ChartSeriesGroup.SeriesType property

Obtiene el tipo de serie de gráficos incluida en este grupo.
