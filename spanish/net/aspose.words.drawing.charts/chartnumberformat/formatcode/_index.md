...
description: ChartNumberFormat propiedad. Obtiene o establece el código de formato aplicado a una etiqueta de datos.
type: docs
weight: 10
...
El formato de número se usa para cambiar la forma en que aparece un valor en la etiqueta de datos y se puede usar de formas muy creativas. Los ejemplos de formatos de número:
