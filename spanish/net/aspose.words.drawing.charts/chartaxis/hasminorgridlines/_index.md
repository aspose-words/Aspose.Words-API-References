...
description: Descubra la propiedad ChartAxis HasMinorGridlines para controlar fácilmente las líneas de cuadrícula menores en sus gráficos, mejorando la legibilidad y la visualización de los datos.
type: docs
weight: 100
...
Obtiene o establece un indicador que indica si el eje tiene líneas de cuadrícula menores.
