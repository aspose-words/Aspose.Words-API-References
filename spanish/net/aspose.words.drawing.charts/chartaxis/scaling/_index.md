...
description: Descubra las propiedades de escalado de ChartAxis para optimizar los ajustes de los ejes. Controle con precisión la visualización de sus datos con opciones de escalado fáciles de usar.
type: docs
weight: 220
