...
description: Descubra la propiedad ChartAxis TickLabels para personalizar las etiquetas de marcas de graduación de sus ejes para mejorar la visualización de datos y la claridad en sus gráficos.
type: docs
weight: 230
url: /es/net/aspose.words.drawing.charts/chartaxis/ticklabels/
---
## ChartAxis.TickLabels property

Proporciona acceso a las propiedades de las etiquetas de las marcas de graduación del eje.
