...
description: Descubra la propiedad ChartAxis MajorUnitScale para personalizar fácilmente las marcas de graduación principales en su eje de categoría de tiempo para una mejor visualización de datos.
type: docs
weight: 150
...
Devuelve o establece el valor de escala para las marcas de graduación principales en el eje de categoría de tiempo.
