...
description: Descubra la propiedad ChartAxis MajorTickMark para personalizar fácilmente las marcas de graduación principales de su gráfico para lograr una mayor claridad y precisión visual.
type: docs
weight: 120
