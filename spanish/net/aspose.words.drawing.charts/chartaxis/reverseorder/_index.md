...
description: Descubra la propiedad ChartAxis ReverseOrder para mostrar fácilmente los valores del eje en sentido inverso, mejorando la claridad de los datos desde el máximo hasta el mínimo.
type: docs
weight: 210
