...
description: Descubra la propiedad ChartAxis MinorUnitScale para personalizar fácilmente las marcas de graduación menores en el eje de categoría de tiempo para una mejor visualización de datos.
type: docs
weight: 190
...
Devuelve o establece el valor de escala para las marcas de graduación menores en el eje de categoría de tiempo.
