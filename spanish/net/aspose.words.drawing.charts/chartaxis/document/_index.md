...
description: Descubra la propiedad de documento ChartAxis, acceda al documento del gráfico principal sin esfuerzo para mejorar la visualización y el análisis de datos.
type: docs
weight: 70
