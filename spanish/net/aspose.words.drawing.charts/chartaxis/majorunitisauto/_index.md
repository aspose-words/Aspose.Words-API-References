...
description: Descubra la propiedad ChartAxis MajorUnitIsAuto, controle fácilmente el espaciado de las marcas de graduación principales para mejorar la claridad y precisión de los gráficos en sus visualizaciones de datos.
type: docs
weight: 140
...
Obtiene o establece un indicador que indica si se utilizará la distancia predeterminada entre las marcas de graduación principales.
