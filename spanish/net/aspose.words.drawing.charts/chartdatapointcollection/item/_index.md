...
description: ChartDataPointCollection Item propiedad. DevolucionesChartDataPoint para el índice especificado en C#.
type: docs
weight: 20
...
Devoluciones[`ChartDataPoint`](../../chartdatapoint/) para el índice especificado.
