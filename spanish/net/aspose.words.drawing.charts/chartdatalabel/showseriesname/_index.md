...
description: Descubra la propiedad ShowSeriesName de ChartDataLabel y controle fácilmente la visibilidad de los nombres de las series en sus gráficos. ¡Mejore la claridad de sus datos con una sencilla configuración booleana!
type: docs
weight: 190
...
Devuelve o establece un valor booleano para indicar el comportamiento de visualización del nombre de la serie para las etiquetas de datos en un gráfico. `verdadero` para mostrar el nombre de la serie;`FALSO` para ocultar. Por defecto`FALSO` .
