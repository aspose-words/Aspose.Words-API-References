...
description: Ajuste la propiedad ChartDataLabel Top para controlar la posición de las etiquetas de datos y mejorar la claridad del gráfico. ¡Optimice la representación visual de sus datos sin esfuerzo!
type: docs
weight: 210
url: /es/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

Obtiene o establece la distancia de la etiqueta de datos en puntos desde el borde superior del gráfico o desde la posición especificada por su[`Position`](../position/) propiedad, dependiendo del valor de la misma[`TopMode`](../topmode/) propiedad.
