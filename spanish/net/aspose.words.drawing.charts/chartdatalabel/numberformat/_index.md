...
description: Descubra la propiedad ChartDataLabel NumberFormat para personalizar fácilmente los formatos de números para una mejor visualización de datos en sus gráficos.
type: docs
weight: 80
...
Devuelve el formato de número del elemento padre.
