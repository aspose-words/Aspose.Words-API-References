...
description: Mejore sus gráficos con la propiedad ShowLeaderLines de ChartDataLabel. Muestre fácilmente las líneas guía de las etiquetas de datos para una visualización más clara.
type: docs
weight: 160
...
Permite especificar si se deben mostrar las líneas guía de la etiqueta de datos. El valor predeterminado es`FALSO` .
