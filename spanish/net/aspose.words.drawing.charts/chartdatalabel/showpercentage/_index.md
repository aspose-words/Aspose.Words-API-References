...
description: Habilite la visualización de porcentajes en las etiquetas de datos de gráficos con la propiedad ChartDataLabel ShowPercentage. ¡Mejore la claridad y la comprensión de sus datos visuales!
type: docs
weight: 180
...
Permite especificar si se mostrará el valor porcentual para las etiquetas de datos en un gráfico. El valor predeterminado es`FALSO` .
