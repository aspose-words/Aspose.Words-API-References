...
description: ChartDataLabel propiedad. Permite especificar si se mostrará el valor porcentual para las etiquetas de datos en un gráfico. El valor predeterminado es falso.
type: docs
weight: 110
