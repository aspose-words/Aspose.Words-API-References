...
description: ChartDataLabel propiedad. Permite especificar si se mostrará la clave de leyenda para las etiquetas de datos en un gráfico. El valor predeterminado es falso.
type: docs
weight: 100
