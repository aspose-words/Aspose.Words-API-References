...
description: Descubra la propiedad ShowLegendKey de ChartDataLabel para controlar fácilmente la visibilidad de la leyenda en sus gráficos. ¡Mejore la claridad y la presentación de datos sin esfuerzo!
type: docs
weight: 170
url: /es/net/aspose.words.drawing.charts/chartdatalabel/showlegendkey/
---
## ChartDataLabel.ShowLegendKey property

Permite especificar si se mostrará la clave de leyenda para las etiquetas de datos en un gráfico. El valor predeterminado es`FALSO` .
