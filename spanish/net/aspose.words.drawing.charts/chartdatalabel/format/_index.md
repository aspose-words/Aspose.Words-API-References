...
description: Descubra la propiedad de formato ChartDataLabel para acceder fácilmente a formatos de relleno y línea personalizables, mejorando la visualización de sus datos sin esfuerzo.
type: docs
weight: 20
url: /es/net/aspose.words.drawing.charts/chartdatalabel/format/
---
## ChartDataLabel.Format property

Proporciona acceso al relleno y formato de línea de la etiqueta de datos.
