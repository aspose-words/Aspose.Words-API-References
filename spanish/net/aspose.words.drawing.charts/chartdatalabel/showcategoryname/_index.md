...
description: Mejore sus gráficos con la propiedad ShowCategoryName de ChartDataLabel. Muestre fácilmente los nombres de las categorías en las etiquetas de datos para obtener información más clara y mejores visualizaciones.
type: docs
weight: 140
url: /es/net/aspose.words.drawing.charts/chartdatalabel/showcategoryname/
---
## ChartDataLabel.ShowCategoryName property

Permite especificar si se mostrará el nombre de la categoría para las etiquetas de datos en un gráfico. El valor predeterminado es`FALSO` .
