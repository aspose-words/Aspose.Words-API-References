...
description: ChartDataLabel propiedad. Permite especificar si se mostrará el nombre de la categoría para las etiquetas de datos en un gráfico. El valor predeterminado es falso.
type: docs
weight: 70
