...
description: Explore la propiedad Eje Y del gráfico para acceder y personalizar fácilmente el eje Y principal de su gráfico para mejorar la visualización y la comprensión de los datos.
type: docs
weight: 30
