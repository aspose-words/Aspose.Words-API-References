...
description: Descubra la propiedad Máximo de AxisScaling para establecer o recuperar fácilmente el valor máximo del eje, mejorando su visualización de datos con precisión.
type: docs
weight: 30
