...
description: ChartDataLabelCollection propiedad. Permite especificar si se mostrará la clave de leyenda para las etiquetas de datos de toda la serie. El valor predeterminado es falso .
type: docs
weight: 90
...
El valor definido para esta propiedad se puede anular para una etiqueta de datos individual con el uso de [`ShowLegendKey`](../../chartdatalabel/showlegendkey/) propiedad.
