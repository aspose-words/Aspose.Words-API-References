...
description: ChartDataLabelCollection propiedad. Permite especificar si la clave de leyenda se mostrará para las etiquetas de datos de toda la serie. El valor predeterminado esFALSO .
type: docs
weight: 110
