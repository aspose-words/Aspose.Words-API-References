...
description: Ajuste la rotación de su ChartDataLabelCollection para una visibilidad óptima. Personalice los ángulos de las etiquetas de datos para mejorar la legibilidad y el impacto de su gráfico.
type: docs
weight: 80
url: /es/net/aspose.words.drawing.charts/chartdatalabelcollection/rotation/
---
...
Si el[`Orientation`](../orientation/) El valor esHorizontalLas formas de etiqueta, si existen, se rotan junto con el texto de la etiqueta. De lo contrario, solo se rota el texto de la etiqueta.
