...
description: ChartDataLabelCollection propiedad. Permite especificar si es necesario mostrar las líneas guía de las etiquetas de datos para las etiquetas de datos de toda la serie. El valor predeterminado es falso .
type: docs
weight: 80
