...
description: Descubra la propiedad Count de ChartDataLabelCollection, que proporciona acceso rápido al número total de ChartDataLabels para una mejor visualización de datos.
type: docs
weight: 10
...
Devuelve el número de[`ChartDataLabel`](../../chartdatalabel/) en esta colección.
