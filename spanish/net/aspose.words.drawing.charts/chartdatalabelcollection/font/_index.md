...
description: Acceda y personalice el formato de fuente de las etiquetas de datos de toda su serie con la propiedad de fuente ChartDataLabelCollection para una mejor visualización de datos.
type: docs
weight: 20
...
El valor definido para esta propiedad se puede anular para una etiqueta de datos individual mediante el uso de [`Font`](../../chartdatalabel/font/) propiedad.
