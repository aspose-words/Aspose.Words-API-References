...
description: Devuelve o establece un valor booleano para indicar el comportamiento de visualización del nombre de la serie para las etiquetas de datos de toda la serie.  Verdaderopara mostrar el nombre de la serie. Falso esconder. Por defecto falso .
type: docs
weight: 110
