...
description: Permite especificar si se mostrará el tamaño de la burbuja para las etiquetas de datos de toda la serie. Se aplica solo a gráficos de burbujas. El valor predeterminado es falso .
type: docs
weight: 50
