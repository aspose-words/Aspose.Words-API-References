...
description: Descubra cómo utilizar el método ClearFormat en ChartDataLabelCollection para restablecer sin esfuerzo todos los formatos de etiquetas de datos de gráficos para obtener imágenes más limpias.
type: docs
weight: 180
...
Borra el formato de todos[`ChartDataLabel`](../../chartdatalabel/) en esta colección.
