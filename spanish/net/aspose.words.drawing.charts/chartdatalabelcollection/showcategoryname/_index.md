...
description: ChartDataLabelCollection propiedad. Permite especificar si el nombre de la categoría se mostrará para las etiquetas de datos de toda la serie. El valor predeterminado esFALSO .
type: docs
weight: 80
