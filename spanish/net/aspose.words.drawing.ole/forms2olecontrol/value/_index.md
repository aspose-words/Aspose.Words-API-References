...
description: Forms2OleControl propiedad. Obtiene la propiedad Valor subyacente que a menudo representa el estado de control. Por ejemplo el botón de opción marcado tiene el valor 1 mientras que no está marcado tiene 0. El valor predeterminado es una cadena vacía.
type: docs
weight: 60
