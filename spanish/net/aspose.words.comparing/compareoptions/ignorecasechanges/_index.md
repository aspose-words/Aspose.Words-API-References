...
description: Descubra cómo la propiedad CompareOptions IgnoreCaseChanges mejora la comparación de documentos al permitir un análisis sin distinción entre mayúsculas y minúsculas para obtener resultados precisos.
type: docs
weight: 50
...
Verdadero indica que la comparación de documentos no distingue entre mayúsculas y minúsculas.
...
De forma predeterminada, la comparación distingue entre mayúsculas y minúsculas.
