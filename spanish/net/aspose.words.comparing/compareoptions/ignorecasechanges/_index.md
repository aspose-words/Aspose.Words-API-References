...
description: True indica que la comparación de documentos no distingue entre mayúsculas y minúsculas. Por defecto la comparación distingue entre mayúsculas y minúsculas.
type: docs
weight: 30
