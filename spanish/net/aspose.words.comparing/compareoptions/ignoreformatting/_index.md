...
description: Descubra cómo la propiedad IgnoreFormatting de CompareOptions mejora el procesamiento de texto al ignorar el formato para una comparación de datos más eficiente.
type: docs
weight: 90
...
Verdadero indica que se ignora el formato.
...
De forma predeterminada, el formato del documento no se ignora.
