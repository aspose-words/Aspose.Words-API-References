...
description: Descubra cómo la propiedad IgnoreTables de CompareOptions mejora el análisis de datos al controlar la comparación de datos de tablas para obtener información precisa.
type: docs
weight: 110
...
Especifica si se deben comparar las diferencias en los datos contenidos en las tablas.
