...
description: Compare fácilmente las diferencias entre documentos con CompareOptions y CompareMoves. ¡Descubra información clave y agilice su flujo de trabajo hoy mismo!
type: docs
weight: 30
url: /es/net/aspose.words.comparing/compareoptions/comparemoves/
---
## CompareOptions.CompareMoves property

Especifica si se deben comparar las diferencias entre los dos documentos.
...
Por defecto no se producen revisiones de movimiento.
