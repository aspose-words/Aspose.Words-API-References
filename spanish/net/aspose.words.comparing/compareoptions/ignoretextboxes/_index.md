...
description: Descubra cómo la propiedad CompareOptions IgnoreTextboxes mejora la comparación de datos al excluir las diferencias de los cuadros de texto para obtener resultados más precisos.
type: docs
weight: 120
...
Especifica si se deben comparar las diferencias en los datos contenidos en los cuadros de texto.
...
De forma predeterminada, los cuadros de texto no se ignoran.
