...
description: Descubra cómo la propiedad IgnoreFootnotes en CompareOptions mejora la comparación de documentos al excluir notas al pie y notas finales para obtener resultados más claros.
type: docs
weight: 80
...
Especifica si se deben comparar las diferencias en las notas al pie y las notas finales.
...
Por defecto las notas al pie no se ignoran.
