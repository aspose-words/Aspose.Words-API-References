---
title: "Aspose::Words::Markup::CustomXmlPartCollection::GetById método"
linktitle: "GetById"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::CustomXmlPartCollection::GetById método. Busca y devuelve una parte XML personalizada por su identificador en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
...
| --- | --- | --- |
| id | const System::String\& | Cadena sensible a mayúsculas y minúsculas que identifica la parte XML personalizada. |

### ReturnValue

Devuelve **null** si no se encuentra una parte XML personalizada con el identificador especificado.
