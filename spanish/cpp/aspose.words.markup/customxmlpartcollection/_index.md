---
title: "Clase Aspose::Words::Markup::CustomXmlPartCollection"
linktitle: "CustomXmlPartCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Markup::CustomXmlPartCollection. Representa una colección de partes XML personalizadas. Los elementos son objetos CustomXmlPart. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.markup/customxmlpartcollection/
---
## CustomXmlPartCollection class


Representa una colección de partes XML personalizadas. Los elementos son objetos [CustomXmlPart](../customxmlpart/). Para obtener más información, visite el artículo de documentación [Etiquetas de documento estructurado o control de contenido](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/).
...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | Agrega un elemento a la colección. |
| [Add](./add/)(const System::String\&, const System::String\&) | Crea una nueva parte XML con el XML especificado y la agrega a la colección. |
| [begin](./begin/)() |  |
| [begin](./begin/)() const |  |
| [cbegin](./cbegin/)() const |  |
| [cend](./cend/)() const |  |
...
| [GetById](./getbyid/)(const System::String\&) | Busca y devuelve una parte XML personalizada por su identificador. |
...
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | Obtiene o establece un elemento en el índice especificado. |
...
Normalmente no necesita crear instancias de esta clase. Puede acceder a los datos XML personalizados almacenados en un documento a través de la propiedad [CustomXmlParts](../../aspose.words/document/get_customxmlparts/).
