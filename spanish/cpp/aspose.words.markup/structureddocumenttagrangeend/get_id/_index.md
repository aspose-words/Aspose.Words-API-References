---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id método"
linktitle: "get_Id"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id método. Especifica un Id numérico persistente, único y de solo lectura para este nodo StructuredDocumentTagRange. El nodo StructuredDocumentTagRangeStart correspondiente tiene el mismo Id en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.markup/structureddocumenttagrangeend/get_id/
---
## StructuredDocumentTagRangeEnd::get_Id method


Especifica un Id numérico persistente, único y de solo lectura para este nodo **StructuredDocumentTagRange**. El nodo [StructuredDocumentTagRangeStart](../../structureddocumenttagrangestart/) correspondiente tiene el mismo [Id](../../structureddocumenttagrangestart/get_id/).
