---
title: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue método"
linktitle: "get_SelectedValue"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue método. Especifica el valor seleccionado actualmente en esta lista. Se permite valor nulo, lo que significa que no hay ninguna entrada seleccionada asociada a esta colección de elementos de lista en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


Especifica el valor seleccionado actualmente en esta lista. Se permite un valor nulo, lo que significa que no hay ninguna entrada seleccionada asociada con esta colección de elementos de lista.
