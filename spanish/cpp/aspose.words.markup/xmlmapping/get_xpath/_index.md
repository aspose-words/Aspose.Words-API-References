---
title: "Método Aspose::Words::Markup::XmlMapping::get_XPath"
linktitle: "get_XPath"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Markup::XmlMapping::get_XPath. Devuelve la expresión XPath, que se evalúa para encontrar el nodo XML personalizado que está mapeado al elemento de documento estructurado padre en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.markup/xmlmapping/get_xpath/
---
## XmlMapping::get_XPath method


Devuelve la expresión XPath, que se evalúa para encontrar el nodo XML personalizado que está asignado a la etiqueta de documento estructurado principal.
