---
title: "Método Aspose::Words::Markup::XmlMapping::get_PrefixMappings"
linktitle: "get_PrefixMappings"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Markup::XmlMapping::get_PrefixMappings. Devuelve los mapeos de prefijos de espacio de nombres XML para evaluar el XPath en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.markup/xmlmapping/get_prefixmappings/
---
## XmlMapping::get_PrefixMappings method


Devuelve los mapeos de prefijos de espacio de nombres XML para evaluar el [XPath](../get_xpath/).
