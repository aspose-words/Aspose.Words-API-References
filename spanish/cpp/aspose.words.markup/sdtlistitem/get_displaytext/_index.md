---
title: "Método get_DisplayText de Aspose::Words::Markup::SdtListItem"
linktitle: "get_DisplayText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método get_DisplayText de Aspose::Words::Markup::SdtListItem. Obtiene el texto a mostrar en el contenido de ejecución en lugar del contenido del atributo Value para este elemento de lista en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.markup/sdtlistitem/get_displaytext/
---
## SdtListItem::get_DisplayText method


Obtiene el texto a mostrar en el contenido de ejecución en lugar del contenido del atributo [Value](../get_value/) para este elemento de lista.
