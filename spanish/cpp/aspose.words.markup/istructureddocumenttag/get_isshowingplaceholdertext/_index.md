---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText método"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText método. Especifica si el contenido de este SDT debe interpretarse como texto de marcador de posición (en contraste con contenido de texto regular dentro del SDT). Si se establece en true, este estado se reanudará (mostrando texto de marcador de posición) al abrir este documento en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.markup/istructureddocumenttag/get_isshowingplaceholdertext/
---
