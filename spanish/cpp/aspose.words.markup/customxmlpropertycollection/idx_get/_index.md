---
title: "Método idx_get de Aspose::Words::Markup::CustomXmlPropertyCollection"
linktitle: "idx_get"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método idx_get de Aspose::Words::Markup::CustomXmlPropertyCollection. Obtiene una propiedad con el nombre especificado en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.markup/customxmlpropertycollection/idx_get/
---
...
| --- | --- | --- |
| name | const System::String\& | Nombre sensible a mayúsculas y minúsculas de la propiedad a localizar. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int32_t | Índice basado en cero de la propiedad. |
