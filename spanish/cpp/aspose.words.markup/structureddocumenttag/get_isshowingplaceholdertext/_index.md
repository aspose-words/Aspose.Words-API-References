---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText método"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText method. Especifica si el contenido de este **SDT** debe interpretarse como texto de marcador de posición (en contraposición al contenido de texto regular dentro del **SDT**). Si se establece en true, este estado se reanudará (mostrando texto de marcador de posición) al abrir este documento en C++."
type: docs
weight: 18000
url: /es/cpp/aspose.words.markup/structureddocumenttag/get_isshowingplaceholdertext/
---
## StructuredDocumentTag::get_IsShowingPlaceholderText method


Especifica si el contenido de este **SDT** debe interpretarse como texto de marcador de posición (en lugar de contenido de texto regular dentro del SDT). Si se establece en **true**, este estado se reanudará (mostrando el texto de marcador de posición) al abrir este documento.
