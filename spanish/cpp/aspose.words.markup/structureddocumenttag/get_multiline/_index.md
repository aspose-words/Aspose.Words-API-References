---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_Multiline método"
linktitle: "get_Multiline"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Multiline método. Especifica si este SDT permite múltiples líneas de texto en C++."
type: docs
weight: 24000
url: /es/cpp/aspose.words.markup/structureddocumenttag/get_multiline/
---
## StructuredDocumentTag::get_Multiline method


Especifica si este **SDT** permite varias líneas de texto.
...
Acceder a esta propiedad solo funcionará para [RichText](../../sdttype/) y [PlainText](../../sdttype/) tipo SDT.
