---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat método"
linktitle: "get_DateStorageFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat method. Obtiene/establece el formato en el que se almacena la fecha para un **SDT** de fecha cuando el **SDT** está vinculado a un nodo XML en el almacén de datos del documento. El valor predeterminado es DateTime en C++."
type: docs
weight: 14000
url: /es/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


Obtiene/establece el formato en el que se almacena la fecha para un **SDT** de fecha cuando el **SDT** está vinculado a un nodo XML en el almacén de datos del documento. El valor predeterminado es [DateTime](../../sdtdatestorageformat/)
