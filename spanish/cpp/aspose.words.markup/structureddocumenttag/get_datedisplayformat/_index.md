---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateDisplayFormat método"
linktitle: "get_DateDisplayFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateDisplayFormat method. Cadena que representa el formato en el que se muestran las fechas en C++."
type: docs
weight: 12000
url: /es/cpp/aspose.words.markup/structureddocumenttag/get_datedisplayformat/
---
## StructuredDocumentTag::get_DateDisplayFormat method


Cadena que representa el formato en el que se muestran las fechas.
...
Las fechas para inglés (EE. UU.) son "mm/dd/yyyy"
