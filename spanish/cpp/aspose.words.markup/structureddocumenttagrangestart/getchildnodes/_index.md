---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::GetChildNodes método"
linktitle: "GetChildNodes"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::GetChildNodes método. Devuelve una colección en vivo de nodos hijos que coinciden con los tipos especificados en C++."
type: docs
weight: 22000
url: /es/cpp/aspose.words.markup/structureddocumenttagrangestart/getchildnodes/
---
...
Muestra cómo obtener nodos hijos de [StructuredDocumentTagRangeStart](../).
```cpp
