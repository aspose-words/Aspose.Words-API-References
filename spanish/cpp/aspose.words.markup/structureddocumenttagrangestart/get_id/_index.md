---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id método"
linktitle: "get_Id"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Id. Especifica un Id numérico único, de solo lectura y persistente, para esta etiqueta de documento estructurada en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.markup/structureddocumenttagrangestart/get_id/
---
## StructuredDocumentTagRangeStart::get_Id method


Especifica un Id numérico persistente, de solo lectura y único para esta etiqueta de documento estructurado.
...
El atributo Id debe seguir estas reglas:* El documento conservará los Ids de etiquetas de documento estructuradas solo si todo el documento se clona [Clone](../../../aspose.words/document/clone/).
