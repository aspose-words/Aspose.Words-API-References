---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText método"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText método. Especifica si el contenido de esta etiqueta de documento estructurada debe interpretarse como texto de marcador de posición (en contraposición al contenido de texto regular dentro de la etiqueta de documento estructurada). Si se establece en true, este estado se reanudará (mostrando texto de marcador de posición) al abrir este documento en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.markup/structureddocumenttagrangestart/get_isshowingplaceholdertext/
---
