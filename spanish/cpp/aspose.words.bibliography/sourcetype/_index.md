...
description: "Aspose::Words::Bibliography::SourceType enum. Representa los tipos de fuentes bibliográficas en C++."
type: docs
weight: 1000
url: /es/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum
...
| --- | --- | --- |
| ArticleInAPeriodical | 0 | Especifica el artículo en una fuente de periódico. |
| Book | 1 | Especifica la fuente del libro. |
| BookSection | 2 | Especifica la fuente de la sección del libro. |
| JournalArticle | 3 | Especifica la fuente del artículo de revista. |
| ConferenceProceedings | 4 | Especifica la fuente de las actas de la conferencia. |
| Informe | 5 | Especifica la fuente del informe. |
| SoundRecording | 6 | Especifica la fuente de la grabación de sonido. |
| Actuación | 7 | Especifica la fuente de la actuación. |
| Arte | 8 | Especifica la fuente del arte. |
| DocumentFromInternetSite | 9 | Especifica la fuente del documento del sitio web. |
| SitioWeb | 10 | Especifica la fuente del sitio web. |
| Película | 11 | Especifica la fuente de la película. |
| Entrevista | 12 | Especifica la fuente de la entrevista. |
| Patente | 13 | Especifica la fuente de la patente. |
| Electrónico | 14 | Especifica la fuente electrónica. |
| Caso | 15 | Especifica la fuente del caso. |
| Varios | 16 | Especifica la fuente miscelánea. |
