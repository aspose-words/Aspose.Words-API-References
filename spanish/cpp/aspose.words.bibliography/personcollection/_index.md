---
title: "Clase Aspose::Words::Bibliography::PersonCollection"
linktitle: "PersonCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Bibliography::PersonCollection. Representa una lista de personas que son contribuyentes de fuentes bibliográficas en C++."
type: docs
weight: 750
url: /es/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Representa una lista de personas que son colaboradores de la fuente bibliográfica.
...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Agrega un [Person](../person/) a la colección. |
| [Clear](./clear/)() | Elimina todos los elementos de la colección. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Determina si la colección contiene una persona específica. |
| [get_Count](./get_count/)() | Obtiene el número de personas contenidas en la colección. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtiene o establece una persona en el índice especificado. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Obtiene o establece una persona en el índice especificado. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Inicializa una nueva instancia de la clase [PersonCollection](./). |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Inicializa una nueva instancia de la clase [PersonCollection](./). |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Elimina a la persona de la colección. |
| [RemoveAt](./removeat/)(int32_t) | Elimina a la persona en el índice especificado. |
...
// Obtenga los datos predeterminados de las fuentes bibliográficas.
...
// Además, puede crear una nueva fuente.
