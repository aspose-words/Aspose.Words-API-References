---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Composer método"
linktitle: "get_Composer"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Composer método. Obtiene o establece el compositor de una fuente en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.bibliography/contributorcollection/get_composer/
---
## ContributorCollection::get_Composer method


Obtiene o establece el compositor de una fuente.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Composer()
```
