---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Inventor método"
linktitle: "get_Inventor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Inventor método. Obtiene o establece el inventor de una fuente en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.bibliography/contributorcollection/get_inventor/
---
## ContributorCollection::get_Inventor method


Obtiene o establece el inventor de una fuente.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Inventor()
```
