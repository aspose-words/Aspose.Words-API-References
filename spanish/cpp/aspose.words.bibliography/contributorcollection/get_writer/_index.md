---
title: "Método Aspose::Words::Bibliography::ContributorCollection::get_Writer"
linktitle: "get_Writer"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Bibliography::ContributorCollection::get_Writer. Obtiene o establece el escritor de una fuente en C++."
type: docs
weight: 17000
url: /es/cpp/aspose.words.bibliography/contributorcollection/get_writer/
---
## ContributorCollection::get_Writer method


Obtiene o establece el escritor de una fuente.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Writer()
```
