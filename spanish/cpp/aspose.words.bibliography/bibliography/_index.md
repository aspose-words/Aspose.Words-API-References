---
title: "Clase Aspose::Words::Bibliography::Bibliography"
linktitle: "Bibliografía"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Bibliography::Bibliography. Representa la lista de fuentes bibliográficas disponibles en el documento en C++."
type: docs
weight: 125
url: /es/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| Método | Descripción |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Obtiene una cadena que representa el nombre del estilo activo a usar para una bibliografía. |
| [get_Sources](./get_sources/)() const | Obtiene una colección que representa todas las fuentes contenidas en una bibliografía. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Establece una cadena que representa el nombre del estilo activo a usar para una bibliografía. |
| static [Type](./type/)() |  |
