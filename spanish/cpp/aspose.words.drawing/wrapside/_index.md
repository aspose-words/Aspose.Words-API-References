...
description: "Aspose::Words::Drawing::WrapSide enum. Especifica en qué lado(s) de la forma o imagen el texto se envuelve en C++."
type: docs
weight: 44000
url: /es/cpp/aspose.words.drawing/wrapside/
---
## WrapSide enum
...
| --- | --- | --- |
| Both | 0 | El texto del documento se envuelve en ambos lados de la forma. |
| Izquierda | 1 | El texto del documento se envuelve solo en el lado izquierdo de la forma. Hay un área libre de texto a la derecha de la forma. |
| Derecha | 2 | El texto del documento se envuelve solo en el lado derecho de la forma. Hay un área libre de texto a la izquierda de la forma. |
| Largest | 3 | El texto del documento se envuelve en el lado de la forma que está más alejado del margen de la página, dejando un área libre de texto en el otro lado de la forma. |
| Default | n/a | El valor predeterminado es [Both](./). |
