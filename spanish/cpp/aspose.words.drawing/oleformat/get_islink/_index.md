---
title: "Aspose::Words::Drawing::OleFormat::get_IsLink método"
linktitle: "get_IsLink"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::OleFormat::get_IsLink método. Devuelve true si el objeto OLE está enlazado (cuando SourceFullName está especificado) en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.drawing/oleformat/get_islink/
---
## OleFormat::get_IsLink method


Devuelve **true** si el objeto OLE está enlazado (cuando [SourceFullName](../get_sourcefullname/) está especificado).
