---
title: "Aspose::Words::Drawing::OleFormat::get_OleIcon método"
linktitle: "get_OleIcon"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::OleFormat::get_OleIcon método. Obtiene el aspecto de dibujo del objeto OLE. Cuando es verdadero, el objeto OLE se muestra como un ícono. Cuando es falso, el objeto OLE se muestra como contenido en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.drawing/oleformat/get_oleicon/
---
...
Aspose.Words no permite establecer esta propiedad para evitar confusiones. Si pudieras cambiar el aspecto de dibujo en Aspose.Words, Microsoft Word seguiría mostrando el objeto OLE en su aspecto de dibujo original hasta que edites o actualices el objeto OLE en Microsoft Word.
