...
description: "Aspose::Words::Drawing::Shape::get_SignatureLine method. Obtiene el objeto SignatureLine si la forma es una línea de firma. Devuelve null en caso contrario en C++."
type: docs
weight: 18000
url: /es/cpp/aspose.words.drawing/shape/get_signatureline/
---
## Shape::get_SignatureLine method


Obtiene el objeto [SignatureLine](../../signatureline/) si la forma es una línea de firma. Devuelve **null** en caso contrario.
