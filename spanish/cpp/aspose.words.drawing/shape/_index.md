---
title: "Clase Aspose::Words::Drawing::Shape"
linktitle: "Shape"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Drawing::Shape. Representa un objeto en la capa de dibujo, como un AutoShape, cuadro de texto, forma libre, objeto OLE, control ActiveX o imagen. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.drawing/shape/
---
## Shape class


Representa un objeto en la capa de dibujo, como un AutoShape, cuadro de texto, forma libre, objeto OLE, control ActiveX o imagen. Para obtener más información, visite el artículo de documentación [Working with Shapes](https://docs.aspose.com/words/cpp/working-with-shapes/).
...
| [AcceptEnd](./acceptend/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Acepta un visitante para visitar el final de la forma. |
| [AcceptStart](./acceptstart/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Acepta un visitante para visitar el inicio de la forma. |
...
| [get_Adjustments](./get_adjustments/)() | Proporciona acceso a los valores sin procesar de ajuste de una forma. Para una forma que no contiene valores sin procesar de ajuste, devuelve una colección vacía. |
...
| [get_Chart](./get_chart/)() | Proporciona acceso a las propiedades del gráfico si esta forma tiene un [Chart](../../aspose.words.drawing.charts/chart/). |
...
| [get_ExtrusionEnabled](./get_extrusionenabled/)() | Devuelve **true** si el efecto de extrusión está habilitado. |
| [get_Fill](../shapebase/get_fill/)() | Obtiene el formato de relleno de la forma. |
| [get_FillColor](./get_fillcolor/)() | Define el color del pincel que rellena la ruta cerrada de la forma. |
| [get_Filled](./get_filled/)() | Determina si la ruta cerrada de la forma será rellenada. |
| [get_FirstChild](../../aspose.words/compositenode/get_firstchild/)() const | Obtiene el primer hijo del nodo. |
| [get_FirstParagraph](./get_firstparagraph/)() | Obtiene el primer párrafo en la forma. |
...
| [get_HasChart](./get_haschart/)() | Devuelve **true** si este [Shape](./) tiene un [Chart](../../aspose.words.drawing.charts/chart/). |
...
| [get_HasSmartArt](./get_hassmartart/)() | Devuelve **true** si este [Shape](./) tiene un objeto SmartArt. |
...
| [get_HorizontalRuleFormat](./get_horizontalruleformat/)() | Proporciona acceso a las propiedades de la forma de regla horizontal. Para una forma que no es una regla horizontal, devuelve **null**. |
| [get_HRef](../shapebase/get_href/)() | Obtiene o establece la dirección completa del hipervínculo para una forma. |
| [get_ImageData](./get_imagedata/)() | Proporciona acceso a la imagen de la forma. Devuelve **null** si la forma no puede tener una imagen. |
...
| [get_LastParagraph](./get_lastparagraph/)() | Obtiene el último párrafo en la forma. |
...
| [get_NodeType](./get_nodetype/)() const override | Devuelve [Shape](../../aspose.words/nodetype/). |
| [get_OleFormat](./get_oleformat/)() | Proporciona acceso a los datos OLE de una forma. Para una forma que no es un objeto OLE o control ActiveX, devuelve **null**. |
...
| [get_ShadowEnabled](./get_shadowenabled/)() | Devuelve **true** si el efecto de sombra está habilitado. |
...
| [get_SignatureLine](./get_signatureline/)() | Obtiene el objeto [SignatureLine](../signatureline/) si la forma es una línea de firma. Devuelve **null** en caso contrario. |
...
| [get_StoryType](./get_storytype/)() | Devuelve [Textbox](../../aspose.words/storytype/). |
| [get_Stroke](./get_stroke/)() | Define un trazo para una forma. |
| [get_StrokeColor](./get_strokecolor/)() | Define el color de un trazo. |
| [get_Stroked](./get_stroked/)() | Define si la ruta será trazada. |
| [get_StrokeWeight](./get_strokeweight/)() | Define el grosor del pincel que traza la ruta de una forma en puntos. |
| [get_Target](../shapebase/get_target/)() | Obtiene o establece el marco de destino para el hipervínculo de la forma. |
| [get_TextBox](./get_textbox/)() | Define atributos que especifican cómo se muestra el texto en una forma. |
| [get_TextPath](./get_textpath/)() | Define el texto de la ruta de texto (de un objeto WordArt). |
...
| [set_FillColor](./set_fillcolor/)(System::Drawing::Color) | Método set para [Aspose::Words::Drawing::Shape::get_FillColor](./get_fillcolor/). |
| [set_Filled](./set_filled/)(bool) | Método set para [Aspose::Words::Drawing::Shape::get_Filled](./get_filled/). |
...
| [set_StrokeColor](./set_strokecolor/)(System::Drawing::Color) | Método set para [Aspose::Words::Drawing::Shape::get_StrokeColor](./get_strokecolor/). |
| [set_Stroked](./set_stroked/)(bool) | Método set para [Aspose::Words::Drawing::Shape::get_Stroked](./get_stroked/). |
| [set_StrokeWeight](./set_strokeweight/)(double) | Método set para [Aspose::Words::Drawing::Shape::get_StrokeWeight](./get_strokeweight/). |
...
| [Shape](./shape/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, Aspose::Words::Drawing::ShapeType) | Crea un nuevo objeto de forma. |
...
| static [Type](./type/)() |  |
| [UpdateSmartArtDrawing](./updatesmartartdrawing/)() | Actualiza el dibujo pre‑renderizado de SmartArt usando el motor de renderizado en frío de SmartArt de [Aspose.Words](../../aspose.words/)'s. |
## Observaciones


Usando la clase [Shape](./) puedes crear o modificar formas en un documento de Microsoft Word.

Una propiedad importante de una forma es su [ShapeType](../shapebase/get_shapetype/). Las formas de diferentes tipos pueden tener distintas capacidades en un documento de Word. Por ejemplo, solo las formas de imagen y OLE pueden contener imágenes dentro de ellas. La mayoría de las formas pueden tener texto, pero no todas.

Las formas que pueden tener texto pueden contener nodos [Paragraph](../../aspose.words/paragraph/) y [Table](../../aspose.words.tables/table/) como hijos.
...
// Inserta dos formas junto con una forma de grupo que contiene otra forma dentro de ella.
...
// Elimina todos los nodos Shape del documento.
System::SharedPtr<Aspose::Words::NodeCollection> shapes = doc->GetChildNodes(Aspose::Words::NodeType::Shape, true);
shapes->Clear();

// Todas las formas han desaparecido, pero la forma de grupo sigue en el documento.
ASSERT_EQ(1, doc->GetChildNodes(Aspose::Words::NodeType::GroupShape, true)->get_Count());
ASSERT_EQ(0, doc->GetChildNodes(Aspose::Words::NodeType::Shape, true)->get_Count());

// Elimina todas las formas de grupo por separado.
