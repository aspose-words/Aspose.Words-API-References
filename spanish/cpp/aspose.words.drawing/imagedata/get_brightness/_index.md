---
title: "Aspose::Words::Drawing::ImageData::get_Brightness método"
linktitle: "get_Brightness"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::ImageData::get_Brightness método. Obtiene o establece el brillo de la imagen. El valor de esta propiedad debe ser un número de 0.0 (más oscuro) a 1.0 (más brillante) en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.drawing/imagedata/get_brightness/
---
## ImageData::get_Brightness method


Obtiene o establece el brillo de la imagen. El valor de esta propiedad debe ser un número entre 0.0 (más oscuro) y 1.0 (más brillante).
