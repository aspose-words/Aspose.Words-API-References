---
title: "Aspose::Words::Drawing::ImageData::get_Contrast método"
linktitle: "get_Contrast"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Drawing::ImageData::get_Contrast. Obtiene o establece el contraste para la imagen especificada. El valor de esta propiedad debe ser un número entre 0.0 (el menor contraste) y 1.0 (el mayor contraste) en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.drawing/imagedata/get_contrast/
---
## ImageData::get_Contrast method


Obtiene o establece el contraste de la imagen especificada. El valor de esta propiedad debe ser un número entre 0.0 (menor contraste) y 1.0 (mayor contraste).
