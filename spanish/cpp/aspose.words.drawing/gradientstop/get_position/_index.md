---
title: "Método Aspose::Words::Drawing::GradientStop::get_Position"
linktitle: "get_Position"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Drawing::GradientStop::get_Position. Obtiene o establece un valor que representa la posición de un punto dentro del degradado expresado como un porcentaje en el rango 0.0 a 1.0 en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.drawing/gradientstop/get_position/
---
## GradientStop::get_Position method


Obtiene o establece un valor que representa la posición de una parada dentro del degradado expresada como un porcentaje en el rango de 0.0 a 1.0.
