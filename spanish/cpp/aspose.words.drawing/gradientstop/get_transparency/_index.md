---
title: "Método Aspose::Words::Drawing::GradientStop::get_Transparency"
linktitle: "get_Transparency"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Drawing::GradientStop::get_Transparency. Obtiene o establece un valor que representa la transparencia del relleno de degradado expresado como un porcentaje en el rango 0.0 a 1.0 en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.drawing/gradientstop/get_transparency/
---
## GradientStop::get_Transparency method


Obtiene o establece un valor que representa la transparencia del relleno de degradado expresada como un porcentaje en el rango de 0.0 a 1.0.
