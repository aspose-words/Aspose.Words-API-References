---
title: "Método RemoveAt de Aspose::Words::Drawing::GradientStopCollection"
linktitle: "RemoveAt"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método RemoveAt de Aspose::Words::Drawing::GradientStopCollection. Elimina un GradientStop de la colección en un índice especificado en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.drawing/gradientstopcollection/removeat/
---
## GradientStopCollection::RemoveAt method


Elimina un [GradientStop](../../gradientstop/) de la colección en un índice especificado.
...
Eliminado [GradientStop](../../gradientstop/).
