---
title: "Aspose::Words::Drawing::Fill::get_ForeThemeColor método"
linktitle: "get_ForeThemeColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::Fill::get_ForeThemeColor método. Obtiene o establece un objeto ThemeColor que representa el color de primer plano del relleno en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.drawing/fill/get_forethemecolor/
---
## Fill::get_ForeThemeColor method


Obtiene o establece un objeto ThemeColor que representa el color de primer plano del relleno.
