...
description: "Aspose::Words::Drawing::RelativeHorizontalSize enum. Especifica respecto a qué se calcula horizontalmente el ancho de una forma o un marco de texto en C++."
type: docs
weight: 33500
url: /es/cpp/aspose.words.drawing/relativehorizontalsize/
---
## RelativeHorizontalSize enum


Especifica, de forma relativa, respecto a qué se calcula horizontalmente el ancho de una forma o de un marco de texto.
...
| --- | --- | --- |
| Margen | 0 | Especifica que el ancho se calcula relativamente al espacio entre los márgenes izquierdo y derecho. |
| Page | 1 | Especifica que el ancho se calcula relativamente al ancho de la página. |
| LeftMargin | 2 | Especifica que el ancho se calcula relativamente al tamaño del área del margen izquierdo. |
| RightMargin | 3 | Especifica que el ancho se calcula relativamente al tamaño del área del margen derecho. |
| InnerMargin | 4 | Especifica que el ancho se calcula relativamente al tamaño del área del margen interior, al tamaño del área del margen izquierdo para páginas impares y al tamaño del área del margen derecho para páginas pares. |
| OuterMargin | 5 | Especifica que el ancho se calcula relativamente al tamaño del área del margen exterior, al tamaño del área del margen derecho para páginas impares y al tamaño del área del margen izquierdo para páginas pares. |
