---
title: "Método Aspose::Words::Drawing::ReflectionFormat::get_Blur"
linktitle: "get_Blur"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Drawing::ReflectionFormat::get_Blur. Obtiene o establece un valor double que especifica el grado de efecto de desenfoque aplicado al efecto de reflexión en puntos. El valor predeterminado es 0.0 en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.drawing/reflectionformat/get_blur/
---
## ReflectionFormat::get_Blur method


Obtiene o establece un valor double que especifica el grado del efecto de desenfoque aplicado al efecto de reflexión en puntos. El valor predeterminado es 0.0.
