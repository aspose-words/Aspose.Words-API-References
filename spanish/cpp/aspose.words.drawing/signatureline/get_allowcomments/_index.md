---
title: "Aspose::Words::Drawing::SignatureLine::get_AllowComments método"
linktitle: "get_AllowComments"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::SignatureLine::get_AllowComments método. Obtiene o establece un valor que indica que el firmante puede agregar comentarios en el cuadro de diálogo de firma. El valor predeterminado para esta propiedad es false en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.drawing/signatureline/get_allowcomments/
---
## SignatureLine::get_AllowComments method


Obtiene o establece un valor que indica que el firmante puede agregar comentarios en el cuadro de diálogo Sign. El valor predeterminado para esta propiedad es **false**.
