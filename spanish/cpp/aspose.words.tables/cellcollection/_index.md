...
description: "Aspose::Words::Tables::CellCollection class. Proporciona acceso tipado a una colección de nodos Cell. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.tables/cellcollection/
---
## CellCollection class


Proporciona acceso tipado a una colección de [Cell](../cell/) nodos. Para obtener más información, visite el artículo de documentación [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/).
...
| [idx_get](./idx_get/)(int32_t) | Recupera un [Cell](../cell/) en el índice dado. |
...
| [ToArray](./toarray/)() | Copia todas las celdas de la colección a una nueva matriz de celdas. |
| static [Type](./type/)() |  |
