...
description: "Aspose::Words::Section::Section constructor. Inicializa una nueva instancia de la clase Section en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words/section/section/
---
...
Cuando se crea la sección, pertenece al documento especificado, pero aún no forma parte del documento y [ParentNode](../../node/get_parentnode/) es **null**.

Para incluir [Section](../) en un documento, usa los métodos [InsertAfter1()</see> y <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) del [Document](../../document/) O los métodos [Add()](../) y [Insert()](../) de la propiedad [Sections](../../document/get_sections/).
