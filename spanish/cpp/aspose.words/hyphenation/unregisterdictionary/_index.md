---
title: "Método Aspose::Words::Hyphenation::UnregisterDictionary"
linktitle: "UnregisterDictionary"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Hyphenation::UnregisterDictionary. Anula el registro de un diccionario de guionado para el idioma especificado. Esto es diferente de registrar un diccionario Null. Anular el registro de un diccionario habilita la devolución de llamada para el idioma especificado en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words/hyphenation/unregisterdictionary/
---
## Hyphenation::UnregisterDictionary method


Anula el registro de un diccionario de separación silábica para el idioma especificado. Esto es diferente de registrar un diccionario Null. Anular el registro de un diccionario habilita la devolución de llamada para el idioma especificado.
...
| --- | --- | --- |
| idioma | const System::String\& | Un nombre de idioma, p. ej. "en-US". Consulte la documentación de .NET para "culture name" y el RFC 4646 para más detalles. Si **null** o cadena vacía, entonces todos los diccionarios se anulan. |
