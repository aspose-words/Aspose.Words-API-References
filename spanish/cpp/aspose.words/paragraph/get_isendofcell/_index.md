...
description: "Aspose::Words::Paragraph::get_IsEndOfCell method. Verdadero si este párrafo es el último párrafo en una Cell; falso en caso contrario en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words/paragraph/get_isendofcell/
---
## Paragraph::get_IsEndOfCell method


Verdadero si este párrafo es el último párrafo en una [Cell](../../../aspose.words.tables/cell/); falso en caso contrario.
