...
description: "Aspose::Words::EditableRangeStart class. Representa el inicio de un rango editable en un documento Word. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 26000
url: /es/cpp/aspose.words/editablerangestart/
---
## EditableRangeStart class


Representa el inicio de un rango editable en un documento Word. Para obtener más información, visite el artículo de documentación [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_EditableRange](./get_editablerange/)() | Obtiene el objeto fachada que encapsula este inicio y fin de rango editable. |
...
| [get_NodeType](./get_nodetype/)() const override | Devuelve [EditableRangeStart](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | Setter para [Aspose::Words::EditableRangeStart::get_Id](./get_id/). |
...
Un rango editable completo en un documento Word consta de un [EditableRangeStart](./) y un [EditableRangeEnd](../editablerangeend/) coincidente con el mismo Id.
...
Utilice la clase [EditableRange](./get_editablerange/) como una "fachada" para trabajar con un rango editable como un único objeto.
