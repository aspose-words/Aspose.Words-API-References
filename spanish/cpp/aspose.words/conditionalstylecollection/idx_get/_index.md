---
title: "Aspose::Words::ConditionalStyleCollection::idx_get método"
linktitle: "idx_get"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::ConditionalStyleCollection::idx_get método. Recupera un objeto ConditionalStyle por tipo de estilo condicional en C++."
type: docs
weight: 18000
url: /es/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


Recupera un objeto [ConditionalStyle](../../conditionalstyle/) por tipo de estilo condicional.
...
Recupera un objeto [ConditionalStyle](../../conditionalstyle/) por índice.
...
| --- | --- | --- |
| index | int32_t | Índice basado en cero del estilo condicional a recuperar. |
