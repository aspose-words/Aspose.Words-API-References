---
title: "Aspose::Words::Node::PreviousPreOrder método"
linktitle: "PreviousPreOrder"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Node::PreviousPreOrder método. Obtiene el nodo anterior según el algoritmo de recorrido en preorden del árbol en C++."
type: docs
weight: 19000
url: /es/cpp/aspose.words/node/previouspreorder/
---
## Node::PreviousPreOrder method


Obtiene el nodo anterior según el algoritmo de recorrido en preorden del árbol.
...
Nodo anterior en orden preorden. Nulo si se alcanza el *rootNode*.
