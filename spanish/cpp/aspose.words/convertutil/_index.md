...
description: "Aspose::Words::ConvertUtil class. Proporciona funciones auxiliares para convertir entre varias unidades de medida. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 19000
url: /es/cpp/aspose.words/convertutil/
---
## ConvertUtil class


Proporciona funciones auxiliares para convertir entre varias unidades de medida. Para obtener más información, visite el artículo de documentación [Convert Between Measurement Units](https://docs.aspose.com/words/cpp/convert-between-measurement-units/).
...
| static [InchToPoint](./inchtopoint/)(double) | Convierte pulgadas a puntos. |
| static [MillimeterToPoint](./millimetertopoint/)(double) | Convierte milímetros a puntos. |
| static [PixelToNewDpi](./pixeltonewdpi/)(double, double, double) | Convierte píxeles de una resolución a otra. |
| static [PixelToPoint](./pixeltopoint/)(double) | Convierte píxeles a puntos a 96 ppp. |
| static [PixelToPoint](./pixeltopoint/)(double, double) | Convierte píxeles a puntos a la resolución de píxeles especificada. |
| static [PointToInch](./pointtoinch/)(double) | Convierte puntos a pulgadas. |
| static [PointToPixel](./pointtopixel/)(double) | Convierte puntos a píxeles a 96 ppp. |
| static [PointToPixel](./pointtopixel/)(double, double) | Convierte puntos a píxeles a la resolución de píxeles especificada. |
