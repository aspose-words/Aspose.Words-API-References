---
title: "Método Aspose::Words::SignatureLineOptions::get_ShowDate"
linktitle: "get_ShowDate"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::SignatureLineOptions::get_ShowDate. Obtiene o establece un valor que indica que la fecha de firma se muestra en la línea de firma. El valor predeterminado para esta propiedad es true en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words/signaturelineoptions/get_showdate/
---
## SignatureLineOptions::get_ShowDate method


Obtiene o establece un valor que indica que la fecha de firma se muestra en la línea de firma. El valor predeterminado para esta propiedad es **true**.
