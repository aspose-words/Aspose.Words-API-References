---
title: "Aspose::Words::ConditionalStyle::get_Borders método"
linktitle: "get_Borders"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::ConditionalStyle::get_Borders método. Obtiene la colección de bordes de celda predeterminados para el estilo condicional en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words/conditionalstyle/get_borders/
---
## ConditionalStyle::get_Borders method


Obtiene la colección de bordes de celda predeterminados para el estilo condicional.
