---
title: "Método Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber"
linktitle: "get_UpdatePageStartingNumber"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::PageExtractOptions::get_UpdatePageStartingNumber. Especifica si el número de página inicial en el documento resultante debe actualizarse. El valor predeterminado es true en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words/pageextractoptions/get_updatepagestartingnumber/
---
## PageExtractOptions::get_UpdatePageStartingNumber method


Especifica si el número de página inicial en el documento resultante se actualizará. El valor predeterminado es **true**.
