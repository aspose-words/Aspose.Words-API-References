---
title: "clase Aspose::Words::Revision"
linktitle: "Revisión"
second_title: "Referencia de API de Aspose.Words para C++"
description: "clase Aspose::Words::Revision. Representa una revisión (cambio rastreado) en un nodo o estilo de documento. Use RevisionType para comprobar el tipo de esta revisión. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 52000
url: /es/cpp/aspose.words/revision/
---
## Revision class


Representa una revisión (cambio rastreado) en un nodo o estilo de documento. Use [RevisionType](./get_revisiontype/) para comprobar el tipo de esta revisión. Para obtener más información, visite el artículo de documentación [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/).
...
| Método | Descripción |
| --- | --- |
| [Accept](./accept/)() | Acepta esta revisión. |
| [get_Author](./get_author/)() | Obtiene o establece el autor de esta revisión. No puede ser una cadena vacía o **null**. |
| [get_DateTime](./get_datetime/)() | Obtiene o establece la fecha/hora de esta revisión. |
| [get_Group](./get_group/)() | Obtiene el grupo de revisión. Devuelve **null** si la revisión no pertenece a ningún grupo. |
| [get_ParentNode](./get_parentnode/)() | Obtiene el nodo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará para cualquier tipo de revisión que no sea [StyleDefinitionChange](../revisiontype/). |
| [get_ParentStyle](./get_parentstyle/)() | Obtiene el estilo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará solo para el tipo de revisión [StyleDefinitionChange](../revisiontype/). |
| [get_RevisionType](./get_revisiontype/)() const | Obtiene el tipo de esta revisión. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)() | Rechazar esta revisión. |
| [set_Author](./set_author/)(const System::String\&) | Método set para [Aspose::Words::Revision::get_Author](./get_author/). |
| [set_DateTime](./set_datetime/)(System::DateTime) | Método set para [Aspose::Words::Revision::get_DateTime](./get_datetime/). |
| static [Type](./type/)() |  |
