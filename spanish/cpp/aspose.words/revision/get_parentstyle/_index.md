---
title: "Aspose::Words::Revision::get_ParentStyle método"
linktitle: "get_ParentStyle"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Revision::get_ParentStyle método. Obtiene el estilo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará solo para el tipo de revisión StyleDefinitionChange en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words/revision/get_parentstyle/
---
## Revision::get_ParentStyle method


Obtiene el estilo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará solo para el tipo de revisión [StyleDefinitionChange](../../revisiontype/).
