---
title: "Método Aspose::Words::Revision::get_ParentNode"
linktitle: "get_ParentNode"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Revision::get_ParentNode. Obtiene el nodo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará para cualquier tipo de revisión que no sea StyleDefinitionChange en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


Obtiene el nodo padre inmediato (propietario) de esta revisión. Esta propiedad funcionará para cualquier tipo de revisión que no sea [StyleDefinitionChange](../../revisiontype/).
