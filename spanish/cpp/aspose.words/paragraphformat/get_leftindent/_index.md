---
title: "Aspose::Words::ParagraphFormat::get_LeftIndent método"
linktitle: "get_LeftIndent"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::ParagraphFormat::get_LeftIndent método. Obtiene o establece el valor (en puntos) que representa la sangría izquierda para el párrafo en C++."
type: docs
weight: 19000
url: /es/cpp/aspose.words/paragraphformat/get_leftindent/
---
## ParagraphFormat::get_LeftIndent method


Obtiene o establece el valor (en puntos) que representa la sangría izquierda para el párrafo.
