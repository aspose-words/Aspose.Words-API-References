---
title: "Aspose::Words::ParagraphFormat::get_SpaceBeforeAuto método"
linktitle: "get_SpaceBeforeAuto"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::ParagraphFormat::get_SpaceBeforeAuto método. Verdadero si la cantidad de espaciado antes del párrafo se establece automáticamente en C++."
type: docs
weight: 34000
url: /es/cpp/aspose.words/paragraphformat/get_spacebeforeauto/
---
## ParagraphFormat::get_SpaceBeforeAuto method


True si la cantidad de espacio antes del párrafo se establece automáticamente.
...
Cuando se establece en **true**, anula el efecto de [SpaceBefore](../get_spacebefore/).
