---
title: "Aspose::Words::Shading::get_ForegroundTintAndShade método"
linktitle: "get_ForegroundTintAndShade"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Shading::get_ForegroundTintAndShade método. Obtiene o establece un valor double que aclara u oscurece un color de tema de primer plano en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words/shading/get_foregroundtintandshade/
---
## Shading::get_ForegroundTintAndShade method


Obtiene o establece un valor doble que aclara o oscurece un color temático de primer plano.
