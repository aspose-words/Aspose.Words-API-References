---
title: "Método get_BackgroundPatternThemeColor de Aspose::Words::Shading"
linktitle: "get_BackgroundPatternThemeColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Shading::get_BackgroundPatternThemeColor método. Obtiene o establece el color del tema del patrón de fondo en el esquema de color aplicado que está asociado con este objeto Shading en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words/shading/get_backgroundpatternthemecolor/
---
## Shading::get_BackgroundPatternThemeColor method


Obtiene o establece el color del tema del patrón de fondo en el esquema de color aplicado que está asociado con este objeto [Shading](../).
