---
title: "Método idx_set de Aspose::Words::VariableCollection"
linktitle: "idx_set"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método idx_set de Aspose::Words::VariableCollection. Obtiene o establece una variable de documento por su nombre sin distinción de mayúsculas. Los valores nulos no están permitidos como lado derecho de la asignación y serán reemplazados por una cadena vacía en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words/variablecollection/idx_set/
---
## VariableCollection::idx_set(const System::String\&, const System::String\&) method


Obtiene o establece una variable de documento por su nombre sin distinción de mayúsculas/minúsculas. Los valores **null** no están permitidos como lado derecho de la asignación y serán reemplazados por una cadena vacía.
...
Obtiene o establece una variable de documento en el índice especificado. Los valores **null** no están permitidos como lado derecho de la asignación y serán reemplazados por una cadena vacía.
...
| --- | --- | --- |
| index | int32_t | Índice basado en cero de la variable de documento. |
