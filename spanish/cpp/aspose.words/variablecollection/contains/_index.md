---
title: "Método Contains de Aspose::Words::VariableCollection"
linktitle: "Contains"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Contains de Aspose::Words::VariableCollection. Determina si la colección contiene una variable de documento con el nombre especificado en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words/variablecollection/contains/
---
...
| --- | --- | --- |
| name | const System::String\& | Nombre de la variable de documento sin distinción de mayúsculas a localizar. |
