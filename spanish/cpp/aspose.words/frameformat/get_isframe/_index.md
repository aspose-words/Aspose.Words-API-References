---
title: "Aspose::Words::FrameFormat::get_IsFrame método"
linktitle: "get_IsFrame"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::FrameFormat::get_IsFrame método. Devuelve true si el párrafo es un marco en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words/frameformat/get_isframe/
---
## FrameFormat::get_IsFrame method


Devuelve **true** si el párrafo es un marco.
