...
description: "Aspose::Words::FileFormatUtil::ExtensionToSaveFormat method. Convierte una extensión de nombre de archivo en un valor SaveFormat en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words/fileformatutil/extensiontosaveformat/
---
## FileFormatUtil::ExtensionToSaveFormat method


Convierte una extensión de nombre de archivo en un valor [SaveFormat](../../saveformat/).
...
| --- | --- | --- |
| extensión | const System::String\& | La extensión del archivo. Puede estar con o sin un punto inicial. No distingue entre mayúsculas y minúsculas. |
## Observaciones


Si la extensión no puede ser reconocida, devuelve [Unknown](../../saveformat/).
