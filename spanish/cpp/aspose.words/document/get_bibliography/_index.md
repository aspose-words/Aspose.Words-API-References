---
title: "Aspose::Words::Document::get_Bibliography método"
linktitle: "get_Bibliography"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Document::get_Bibliography método. Obtiene el objeto Bibliography que representa la lista de fuentes disponibles en el documento en C++."
type: docs
weight: 14500
url: /es/cpp/aspose.words/document/get_bibliography/
---
## Document::get_Bibliography method


Obtiene el objeto [Bibliography](./) que representa la lista de fuentes disponibles en el documento.
