---
title: "Método Aspose::Words::Document::NormalizeFieldTypes"
linktitle: "NormalizeFieldTypes"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Document::NormalizeFieldTypes. Cambia los valores del tipo de campo FieldType de FieldStart, FieldSeparator, FieldEnd en todo el documento para que correspondan a los tipos de campo contenidos en los códigos de campo en C++."
type: docs
weight: 66000
url: /es/cpp/aspose.words/document/normalizefieldtypes/
---
## Document::NormalizeFieldTypes method


Cambia los valores del tipo de campo [FieldType](../../../aspose.words.fields/fieldchar/get_fieldtype/) de [FieldStart](../../../aspose.words.fields/fieldstart/), [FieldSeparator](../../../aspose.words.fields/fieldseparator/) y [FieldEnd](../../../aspose.words.fields/fieldend/) en todo el documento para que correspondan a los tipos de campo contenidos en los códigos de campo.
...
Para cambiar los valores del tipo de campo en una parte específica del documento, usa [NormalizeFieldTypes](../../range/normalizefieldtypes/).
