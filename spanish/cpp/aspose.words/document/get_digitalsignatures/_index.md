---
title: "Aspose::Words::Document::get_DigitalSignatures método"
linktitle: "get_DigitalSignatures"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Document::get_DigitalSignatures método. Obtiene la colección de firmas digitales de este documento y sus resultados de validación en C++."
type: docs
weight: 21000
url: /es/cpp/aspose.words/document/get_digitalsignatures/
---
## Document::get_DigitalSignatures method


Obtiene la colección de firmas digitales de este documento y sus resultados de validación.
...
Esta colección contiene firmas digitales que fueron cargadas del documento original. Estas firmas digitales no se guardarán cuando guarde este objeto [Document](../) en un archivo o flujo porque guardar o convertir producirá un documento que es diferente del original y las firmas digitales originales ya no serán válidas.

Esta colección nunca es **null**. Si el documento no está firmado, contendrá cero elementos.
