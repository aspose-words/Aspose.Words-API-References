---
title: "Aspose::Words::Document::get_TrackRevisions método"
linktitle: "get_TrackRevisions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Document::get_TrackRevisions método. Verdadero si los cambios se rastrean cuando este documento se edita en Microsoft Word en C++."
type: docs
weight: 54000
url: /es/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


True si los cambios se rastrean cuando este documento se edita en Microsoft Word.
...
Configurar esta opción solo indica a Microsoft Word si el seguimiento de cambios está activado o desactivado. Esta propiedad no afecta a los cambios en el documento que realice programáticamente a través de Aspose.Words.

Si desea rastrear cambios automáticamente a medida que se realizan programáticamente por [Aspose.Words](../../) en este documento, use el método [StartTrackRevisions()](../).
