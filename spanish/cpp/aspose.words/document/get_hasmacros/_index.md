---
title: "Aspose::Words::Document::get_HasMacros método"
linktitle: "get_HasMacros"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Document::get_HasMacros método. Devuelve verdadero si el documento tiene un proyecto VBA (macros) en C++."
type: docs
weight: 30000
url: /es/cpp/aspose.words/document/get_hasmacros/
---
## Document::get_HasMacros method


Devuelve **true** si el documento tiene un proyecto VBA (macros).
