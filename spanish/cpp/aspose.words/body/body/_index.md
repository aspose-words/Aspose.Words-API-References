...
description: "Aspose::Words::Body::Body constructor. Inicializa una nueva instancia de la clase Body en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words/body/body/
---
## Body::Body constructor


Inicializa una nueva instancia de la clase [Body](../).
...
Cuando se crea [Body](../), pertenece al documento especificado, pero aún no forma parte del documento y [ParentNode](../../node/get_parentnode/) es **null**.

Para anexar [Body](../) a una [Section](../../section/) use los métodos [AppendChild](../)[InsertAfter](../) o [InsertBefore](../).
