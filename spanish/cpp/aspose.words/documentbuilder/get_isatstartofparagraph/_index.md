---
title: "Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph método"
linktitle: "get_IsAtStartOfParagraph"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::DocumentBuilder::get_IsAtStartOfParagraph método. Devuelve true si el cursor está al comienzo del párrafo actual (no hay texto antes del cursor) en C++."
type: docs
weight: 20000
url: /es/cpp/aspose.words/documentbuilder/get_isatstartofparagraph/
---
## DocumentBuilder::get_IsAtStartOfParagraph method


Devuelve **true** si el cursor está al principio del párrafo actual (no hay texto antes del cursor).
