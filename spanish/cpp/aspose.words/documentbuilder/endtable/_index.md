---
title: "Aspose::Words::DocumentBuilder::EndTable método"
linktitle: "EndTable"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::DocumentBuilder::EndTable método. Finaliza una tabla en el documento en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words/documentbuilder/endtable/
---
...
El nodo de tabla que acaba de finalizarse.
## Observaciones


Este método debe llamarse solo una vez después de que se haya llamado a [EndRow](../endrow/). Cuando se llama, [EndTable](./) mueve el cursor fuera de la celda actual para que apunte justo después de la tabla.
