...
description: "Aspose::Words::RevisionCollection class. Una colección de objetos Revision que representan revisiones en el documento. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 53000
url: /es/cpp/aspose.words/revisioncollection/
---
## RevisionCollection class


Una colección de objetos [Revision](../revision/) que representan revisiones en el documento. Para obtener más información, visite el artículo de documentación [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/).
...
| Método | Descripción |
| --- | --- |
| [Accept](./accept/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Acepta revisiones que coinciden con criterios especificados. |
| [AcceptAll](./acceptall/)() | Acepta todas las revisiones de esta colección. |
| [get_Count](./get_count/)() | Devuelve el número de revisiones en la colección. |
| [get_Groups](./get_groups/)() | Colección de grupos de revisiones. |
| [GetEnumerator](./getenumerator/)() override | Devuelve un objeto enumerador. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Devuelve una [Revision](../revision/) en el índice especificado. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Rechaza revisiones que coinciden con los criterios especificados. |
| [RejectAll](./rejectall/)() | Rechaza todas las revisiones en esta colección. |
| static [Type](./type/)() |  |
## Observaciones


No crea instancias de esta clase directamente. Use la propiedad [Revisions](../document/get_revisions/) para obtener las revisiones presentes en un documento.
