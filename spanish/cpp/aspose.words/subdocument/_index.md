---
title: "Clase Aspose::Words::SubDocument"
linktitle: "SubDocument"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::SubDocument. Representa un SubDocument, que es una referencia a un documento almacenado externamente. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 66000
url: /es/cpp/aspose.words/subdocument/
---
## SubDocument class


Representa un **SubDocument**, que es una referencia a un documento almacenado externamente. Para obtener más información, visite el artículo de documentación [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_NodeType](./get_nodetype/)() const override | Devuelve [SubDocument](../nodetype/). |
...
En esta versión de Aspose.Words, los nodos [SubDocument](./) no proporcionan métodos y propiedades públicas para crear o modificar un subdocumento. En esta versión no puedes instanciar nodos [SubDocument](./) ni modificar los existentes, excepto eliminarlos.
