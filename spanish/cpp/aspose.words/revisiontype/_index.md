...
description: "Aspose::Words::RevisionType enum. Especifica el tipo de cambio que se está rastreando en Revision en C++."
type: docs
weight: 113000
url: /es/cpp/aspose.words/revisiontype/
---
## RevisionType enum
...
| Deletion | 1 | El contenido fue eliminado del documento. |
| FormatChange | 2 | Se aplicó un cambio de formato al nodo padre. |
| StyleDefinitionChange | 3 | Se aplicó un cambio de formato al estilo padre. |
| Moviendo | 4 | El contenido se movió en el documento. |
