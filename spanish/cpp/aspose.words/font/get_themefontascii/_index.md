---
title: "Método Aspose::Words::Font::get_ThemeFontAscii"
linktitle: "get_ThemeFontAscii"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Font::get_ThemeFontAscii. Obtiene o establece la fuente temática utilizada para texto latino (caracteres con códigos de carácter del 0 (cero) al 127) en el esquema de fuentes aplicado que está asociado con este objeto Font en C++."
type: docs
weight: 50000
url: /es/cpp/aspose.words/font/get_themefontascii/
---
## Font::get_ThemeFontAscii method


Obtiene o establece la fuente temática utilizada para texto latino (caracteres con códigos de carácter del 0 (cero) al 127) en el esquema de fuentes aplicado que está asociado con este objeto [Font](../).
