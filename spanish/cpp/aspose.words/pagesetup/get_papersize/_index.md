---
title: "Método Aspose::Words::PageSetup::get_PaperSize"
linktitle: "get_PaperSize"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::PageSetup::get_PaperSize. Devuelve o establece el tamaño del papel en C++."
type: docs
weight: 37000
url: /es/cpp/aspose.words/pagesetup/get_papersize/
---
...
Establecer esta propiedad actualiza los valores de [PageWidth](../get_pagewidth/) y [PageHeight](../get_pageheight/). Establecer este valor a [Custom](../../papersize/) no cambia los valores existentes.
...
Muestra cómo establecer el tamaño del papel de JisB4 o JisB5.
```cpp
