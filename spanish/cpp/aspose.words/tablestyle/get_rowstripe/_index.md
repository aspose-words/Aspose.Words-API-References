---
title: "Método Aspose::Words::TableStyle::get_RowStripe"
linktitle: "get_RowStripe"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::TableStyle::get_RowStripe. Obtiene o establece un número de filas para incluir en el banding cuando el estilo especifica banding de filas impares/pares en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words/tablestyle/get_rowstripe/
---
## TableStyle::get_RowStripe method


Obtiene o establece un número de filas para incluir en el bandado cuando el estilo especifica bandado de filas impares/pares.
