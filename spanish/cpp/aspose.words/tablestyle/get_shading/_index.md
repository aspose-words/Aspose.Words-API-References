---
title: "Método Aspose::Words::TableStyle::get_Shading"
linktitle: "get_Shading"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::TableStyle::get_Shading. Obtiene un objeto Shading que se refiere al formato de sombreado para las celdas de tabla en C++."
type: docs
weight: 14000
url: /es/cpp/aspose.words/tablestyle/get_shading/
---
## TableStyle::get_Shading method


Obtiene un objeto [Shading](../../shading/) que se refiere al formato de sombreado para las celdas de tabla.
