...
description: "Aspose::Words::Comparing::ComparisonTargetType enum. Permite especificar el documento base que se utilizará durante la comparación. El valor predeterminado es Current en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


Permite especificar el documento base que se utilizará durante la comparación. El valor predeterminado es [Current](./).
...
| --- | --- | --- |
| Actual | 0 | Este documento se utiliza como base durante la comparación. |
| New | 1 | Otro documento se utiliza como base durante la comparación. |
