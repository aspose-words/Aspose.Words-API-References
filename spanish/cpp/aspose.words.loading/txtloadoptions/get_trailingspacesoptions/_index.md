---
title: "Método Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions"
linktitle: "get_TrailingSpacesOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Loading::TxtLoadOptions::get_TrailingSpacesOptions. Obtiene o establece la opción preferida para el manejo de espacios finales. El valor predeterminado es Trim en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.loading/txtloadoptions/get_trailingspacesoptions/
---
## TxtLoadOptions::get_TrailingSpacesOptions method


Obtiene o establece la opción preferida para el manejo de espacios finales. El valor predeterminado es [Trim](../../txttrailingspacesoptions/).
