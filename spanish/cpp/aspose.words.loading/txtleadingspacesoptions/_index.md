...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. Especifica las opciones disponibles para el manejo de espacios iniciales durante la importación desde un archivo de Texto en C++."
type: docs
weight: 18000
url: /es/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Especifica las opciones disponibles para el manejo de espacios iniciales durante la importación desde el archivo [Text](../../aspose.words/loadformat/).
...
| Preserve | 2 | Los espacios iniciales se conservan. |
