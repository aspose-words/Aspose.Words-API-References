---
title: "clase Aspose::Words::Loading::PdfLoadOptions"
linktitle: "PdfLoadOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "clase Aspose::Words::Loading::PdfLoadOptions. Permite especificar opciones adicionales al cargar un documento Pdf en un objeto Document. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.loading/pdfloadoptions/
---
## PdfLoadOptions class


Permite especificar opciones adicionales al cargar un documento Pdf en un objeto [Document](../../aspose.words/document/). Para obtener más información, visite el artículo de documentación [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_PageCount](./get_pagecount/)() const | Obtiene el número de páginas a leer. El valor predeterminado es MaxValue, lo que significa que se leerán todas las páginas del documento. |
| [get_PageIndex](./get_pageindex/)() const | Obtiene el índice basado en cero de la primera página a leer. El valor predeterminado es 0. |
...
| [get_SkipPdfImages](./get_skippdfimages/)() const | Obtiene la bandera que indica si las imágenes deben omitirse al cargar un documento PDF. El valor predeterminado es **false**. |
...
| [set_PageCount](./set_pagecount/)(int32_t) | Establece el número de páginas a leer. El valor predeterminado es MaxValue, lo que significa que se leerán todas las páginas del documento. |
| [set_PageIndex](./set_pageindex/)(int32_t) | Establece el índice basado en 0 de la primera página a leer. El valor predeterminado es 0. |
...
| [set_SkipPdfImages](./set_skippdfimages/)(bool) | Establece la bandera que indica si se deben omitir las imágenes al cargar el documento PDF. El valor predeterminado es **false**. |
