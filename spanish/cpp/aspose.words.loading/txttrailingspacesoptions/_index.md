---
title: "Enumeración Aspose::Words::Loading::TxtTrailingSpacesOptions"
linktitle: "TxtTrailingSpacesOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Enumeración Aspose::Words::Loading::TxtTrailingSpacesOptions. Especifica las opciones disponibles para el manejo de espacios finales durante la importación desde un archivo de Texto en C++."
type: docs
weight: 19000
url: /es/cpp/aspose.words.loading/txttrailingspacesoptions/
---
## TxtTrailingSpacesOptions enum


Especifica las opciones disponibles para el manejo de espacios finales durante la importación desde el archivo [Text](../../aspose.words/loadformat/).
...
| --- | --- | --- |
| Trim | 0 | Los espacios finales se recortan. |
| Preserve | 1 | Los espacios finales se conservan. |
