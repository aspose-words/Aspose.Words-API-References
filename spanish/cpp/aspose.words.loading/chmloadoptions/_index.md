...
description: "Aspose::Words::Loading::ChmLoadOptions class. Permite especificar opciones adicionales al cargar un documento CHM en un objeto Document. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 1000
url: /es/cpp/aspose.words.loading/chmloadoptions/
---
## ChmLoadOptions class


Permite especificar opciones adicionales al cargar un documento CHM en un objeto [Document](../../aspose.words/document/). Para obtener más información, visite el artículo de documentación [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/).
...
| [get_OriginalFileName](./get_originalfilename/)() const | El nombre del archivo CHM. El valor predeterminado es **null**. |
...
| [set_OriginalFileName](./set_originalfilename/)(const System::String\&) | Método set para [Aspose::Words::Loading::ChmLoadOptions::get_OriginalFileName](./get_originalfilename/). |
