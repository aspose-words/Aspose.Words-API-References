...
description: "Aspose::Words::Fonts::FontPitch enum. Representa el pitch de la fuente en C++."
type: docs
weight: 22000
url: /es/cpp/aspose.words.fonts/fontpitch/
---
## FontPitch enum
...
| --- | --- | --- |
| Predeterminado | 0 | Especifica que no hay información disponible sobre el pitch de una fuente. |
| Fija | 1 | Especifica que esta es una fuente de ancho fijo. |
| Variable | 2 | Especifica que este es una fuente de ancho proporcional. |
