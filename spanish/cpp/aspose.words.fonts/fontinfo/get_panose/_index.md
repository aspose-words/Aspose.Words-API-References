---
title: "Método Aspose::Words::Fonts::FontInfo::get_Panose"
linktitle: "get_Panose"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Fonts::FontInfo::get_Panose. Obtiene o establece el número de clasificación tipográfica PANOSE en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.fonts/fontinfo/get_panose/
---
## FontInfo::get_Panose method


Obtiene o establece el número de clasificación tipográfica PANOSE.
...
PANOSE es una descripción compacta de 10 bytes de las características visuales críticas de una fuente, como contraste, peso y estilo de serifa. Los dígitos representan Tipo de familia, Serifa [Style](../../../aspose.words/style/), Peso, Proporción, Contraste, Variación de trazo, Brazo [Style](../../../aspose.words/style/), Forma de letra, Línea media y Altura‑x.
