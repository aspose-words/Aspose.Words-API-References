...
description: "Aspose::Words::Fonts::SystemFontSource class. Representa todas las fuentes TrueType instaladas en el sistema. Para obtener más información, visita el artículo de documentación en C++."
type: docs
weight: 17000
url: /es/cpp/aspose.words.fonts/systemfontsource/
---
## SystemFontSource class


Representa todas las fuentes TrueType instaladas en el sistema. Para obtener más información, visite el artículo de documentación [Working with Fonts](https://docs.aspose.com/words/cpp/working-with-fonts/).
...
| static [GetSystemFontFolders](./getsystemfontfolders/)() | Devuelve las carpetas de fuentes del sistema o una matriz vacía si las carpetas no son accesibles. |
