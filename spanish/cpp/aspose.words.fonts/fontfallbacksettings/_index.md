---
title: "Aspose::Words::Fonts::FontFallbackSettings clase"
linktitle: "FontFallbackSettings"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fonts::FontFallbackSettings clase. Especifica la configuración del mecanismo de sustitución de fuentes. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.fonts/fontfallbacksettings/
---
## FontFallbackSettings class


Especifica la configuración del mecanismo de reserva de fuentes. Para obtener más información, visite el artículo de documentación [Working with Fonts](https://docs.aspose.com/words/cpp/working-with-fonts/).
...
| Método | Descripción |
| --- | --- |
| [BuildAutomatic](./buildautomatic/)() | Construye automáticamente la configuración de sustitución escaneando las fuentes disponibles. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Load](./load/)(const System::String\&) | Carga la configuración de sustitución de fuentes desde un archivo XML. |
| [Load](./load/)(const System::SharedPtr\<System::IO::Stream\>\&) | Carga la configuración de sustitución desde un flujo XML. |
| [Load](./load/)(std::basic_istream\<CharType, Traits\>\&) |  |
| [LoadMsOfficeFallbackSettings](./loadmsofficefallbacksettings/)() | Carga configuraciones de sustitución predefinidas que imitan la sustitución de Microsoft Word y utilizan fuentes de Microsoft Office. |
| [LoadNotoFallbackSettings](./loadnotofallbacksettings/)() | Carga configuraciones de sustitución predefinidas que utilizan fuentes Google Noto. |
| [Save](./save/)(const System::SharedPtr\<System::IO::Stream\>\&) | Guarda la configuración de sustitución actual en un flujo. |
| [Save](./save/)(const System::String\&) | Guarda la configuración de sustitución actual en un archivo. |
