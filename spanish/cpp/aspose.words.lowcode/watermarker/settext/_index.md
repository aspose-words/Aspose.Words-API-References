---
title: "Aspose::Words::LowCode::Watermarker::SetText método"
linktitle: "SetText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::LowCode::Watermarker::SetText método. Añade una marca de agua de texto al documento desde flujos con opciones en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.lowcode/watermarker/settext/
---
...
Agrega una marca de agua de texto al documento desde flujos con opciones.
...
| watermarkText | const System::String\& | Texto que se muestra como marca de agua. |
## Observaciones
...
| saveFormat | Aspose::Words::SaveFormat | El formato de guardado. |
| watermarkText | const System::String\& | Texto que se muestra como marca de agua. |
| opciones | const System::SharedPtr\<Aspose::Words::TextWatermarkOptions\>\& | Define opciones adicionales para la marca de agua de texto. |
## Observaciones
