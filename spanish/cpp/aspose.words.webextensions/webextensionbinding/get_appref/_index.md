---
title: "Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef método"
linktitle: "get_AppRef"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef método. Especifica la clave de vinculación utilizada para mapear la entrada de vinculación en esta lista con los datos vinculados en el documento en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.webextensions/webextensionbinding/get_appref/
---
## WebExtensionBinding::get_AppRef method


Especifica la clave de enlace utilizada para mapear la entrada de enlace en esta lista con los datos vinculados en el documento.
