---
title: "Aspose::Words::WebExtensions::WebExtension clase"
linktitle: "WebExtension"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::WebExtensions::WebExtension clase. Representa un objeto de extensión web. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Representa un objeto de extensión web. Para obtener más información, visite el artículo de documentación [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| Método | Descripción |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Especifica referencias alternas a una extensión web. |
| [get_Bindings](./get_bindings/)() const | Especifica una lista de enlaces de extensiones web. |
| [get_Id](./get_id/)() const | Identifica de forma única la instancia de la extensión web en el documento actual. |
| [get_IsFrozen](./get_isfrozen/)() const | Especifica si el usuario puede interactuar con la extensión web o no. |
| [get_Properties](./get_properties/)() const | Representa un conjunto de propiedades personalizadas de la extensión web. |
| [get_Reference](./get_reference/)() const | Especifica la referencia principal a una extensión web. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Método setter para [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Método setter para [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
