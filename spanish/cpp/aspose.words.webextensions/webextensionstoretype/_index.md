...
description: "Aspose::Words::WebExtensions::WebExtensionStoreType enum. Enumera los tipos disponibles de una tienda de extensiones web en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.webextensions/webextensionstoretype/
---
...
| --- | --- | --- |
| SPCatalog | 0 | Especifica que el tipo de almacén es el catálogo corporativo de SharePoint. |
| OMEX | 1 | Especifica que el tipo de almacén es Office.com. |
| SPApp | 2 | Especifica que el tipo de almacén es una aplicación web de SharePoint. |
...
| ExCatalog | 6 | Especifica que el tipo de almacén es Implementación Centralizada a través de Exchange. |
