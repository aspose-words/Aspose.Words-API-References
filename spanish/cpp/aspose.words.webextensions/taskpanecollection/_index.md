---
title: "Clase Aspose::Words::WebExtensions::TaskPaneCollection"
linktitle: "TaskPaneCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::WebExtensions::TaskPaneCollection. Especifica una lista de objetos de panel de tareas persistentes. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Especifica una lista de objetos de panel de tareas persistentes. Para obtener más información, visite el artículo de documentación [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
