---
title: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection clase"
linktitle: "WebExtensionPropertyCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection clase. Especifica un conjunto de propiedades personalizadas de extensiones web. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Especifica un conjunto de propiedades personalizadas de la extensión web. Para obtener más información, visite el artículo de documentación [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
