---
title: "Aspose::Words::WebExtensions::TaskPaneDockState enumeración"
linktitle: "TaskPaneDockState"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::WebExtensions::TaskPaneDockState enumeración. Enumera las ubicaciones disponibles del objeto panel de tareas en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.webextensions/taskpanedockstate/
---
...
| --- | --- | --- |
| Derecha | 0 | Anclar el panel de tareas en el lado derecho de la ventana del documento. |
| Izquierda | 1 | Anclar el panel de tareas en el lado izquierdo de la ventana del documento. |
