---
title: "Método Aspose::Words::WebExtensions::TaskPane::get_IsLocked"
linktitle: "get_IsLocked"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::WebExtensions::TaskPane::get_IsLocked. Especifica si el panel de tareas está bloqueado al documento en la interfaz de usuario y no puede ser cerrado por el usuario en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.webextensions/taskpane/get_islocked/
---
## TaskPane::get_IsLocked method


Especifica si el panel de tareas está bloqueado al documento en la interfaz de usuario y no puede ser cerrado por el usuario.
