---
title: "Aspose::Words::WebExtensions::TaskPane::get_IsVisible método"
linktitle: "get_IsVisible"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::WebExtensions::TaskPane::get_IsVisible. Especifica si el panel de tareas se muestra como visible de forma predeterminada cuando el documento se abre en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.webextensions/taskpane/get_isvisible/
---
## TaskPane::get_IsVisible method


Especifica si el panel de tareas se muestra visible por defecto cuando se abre el documento.
