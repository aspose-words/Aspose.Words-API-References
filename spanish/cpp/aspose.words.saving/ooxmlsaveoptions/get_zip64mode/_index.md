---
title: "Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode método"
linktitle: "get_Zip64Mode"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode método. Especifica si se deben o no usar extensiones de formato ZIP64 para el documento de salida. El valor predeterminado es Never en C++."
type: docs
weight: 7500
url: /es/cpp/aspose.words.saving/ooxmlsaveoptions/get_zip64mode/
---
## OoxmlSaveOptions::get_Zip64Mode method


Especifica si se deben o no usar extensiones de formato ZIP64 para el documento de salida. El valor predeterminado es [Never](../../zip64mode/).
