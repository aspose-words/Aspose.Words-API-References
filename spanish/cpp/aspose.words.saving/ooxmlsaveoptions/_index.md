---
title: "Clase Aspose::Words::Saving::OoxmlSaveOptions"
linktitle: "OoxmlSaveOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Saving::OoxmlSaveOptions. Puede usarse para especificar opciones adicionales al guardar un documento en formato Docx, Docm, Dotx, Dotm o FlatOpc. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 16000
url: /es/cpp/aspose.words.saving/ooxmlsaveoptions/
---
## OoxmlSaveOptions class


Puede usarse para especificar opciones adicionales al guardar un documento en formato [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) o [FlatOpc](../../aspose.words/saveformat/). Para obtener más información, visite el artículo de documentación [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_Compliance](./get_compliance/)() | Especifica la versión OOXML para el documento de salida. El valor predeterminado es [Ecma376_2006](../ooxmlcompliance/). |
...
| [get_KeepLegacyControlChars](./get_keeplegacycontrolchars/)() const | Mantiene la representación original de los caracteres de control heredados. |
...
| [get_Password](./get_password/)() const | Obtiene/establece una contraseña para cifrar el documento usando el algoritmo de cifrado ECMA376 Standard. |
...
| [get_SaveFormat](./get_saveformat/)() override | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Puede ser [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) o [FlatOpc](../../aspose.words/saveformat/). |
...
| [get_Zip64Mode](./get_zip64mode/)() const | Especifica si se deben usar o no extensiones de formato ZIP64 para el documento de salida. El valor predeterminado es [Never](../zip64mode/). |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)() | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en formato [Docx](../../aspose.words/saveformat/). |
| [OoxmlSaveOptions](./ooxmlsaveoptions/)(Aspose::Words::SaveFormat) | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en formato [Docx](../../aspose.words/saveformat/), [Docm](../../aspose.words/saveformat/), [Dotx](../../aspose.words/saveformat/), [Dotm](../../aspose.words/saveformat/) o [FlatOpc](../../aspose.words/saveformat/). |
...
| [set_Compliance](./set_compliance/)(Aspose::Words::Saving::OoxmlCompliance) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_Compliance](./get_compliance/). |
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_KeepLegacyControlChars](./set_keeplegacycontrolchars/)(bool) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_KeepLegacyControlChars](./get_keeplegacycontrolchars/). |
...
| [set_Password](./set_password/)(const System::String\&) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_Zip64Mode](./set_zip64mode/)(Aspose::Words::Saving::Zip64Mode) | Método setter para [Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode](./get_zip64mode/). |
| static [Type](./type/)() |  |
