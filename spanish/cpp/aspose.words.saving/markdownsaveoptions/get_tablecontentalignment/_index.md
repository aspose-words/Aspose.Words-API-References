---
title: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment método"
linktitle: "get_TableContentAlignment"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment método. Obtiene o establece un valor que especifica cómo alinear el contenido en tablas al exportar al formato Markdown. El valor predeterminado es Auto en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.saving/markdownsaveoptions/get_tablecontentalignment/
---
## MarkdownSaveOptions::get_TableContentAlignment method


Obtiene o establece un valor que especifica cómo alinear el contenido en tablas al exportar al formato [Markdown](../../../aspose.words/saveformat/). El valor predeterminado es [Auto](../../tablecontentalignment/).
