---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add método"
linktitle: "Add"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add método. Añade un marcador a la colección en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | El nombre del marcador a añadir, sin distinción de mayúsculas y minúsculas. |
| outlineLevel | int32_t | El nivel de esquema del marcador. El rango válido es de 0 a 9. |
