---
title: "Método Aspose::Words::Saving::BookmarksOutlineLevelCollection::idx_get"
linktitle: "idx_get"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Saving::BookmarksOutlineLevelCollection::idx_get. Obtiene o establece un nivel de esquema de marcador por el nombre del marcador en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/idx_get/
---
## BookmarksOutlineLevelCollection::idx_get(const System::String\&) method


Obtiene o establece el nivel de esquema del marcador por el nombre del marcador.
...
| --- | --- | --- |
| name | const System::String\& | Nombre del marcador sin distinción entre mayúsculas y minúsculas. |
...
Obtiene o establece el nivel de esquema del marcador en el índice especificado.
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| index | int32_t | Índice basado en cero del marcador. |
