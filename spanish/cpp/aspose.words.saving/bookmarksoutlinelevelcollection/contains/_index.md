...
description: "Método Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains. Determina si la colección contiene un marcador con el nombre especificado en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/contains/
---
## BookmarksOutlineLevelCollection::Contains method


Determina si la colección contiene un marcador con el nombre dado.
...
| --- | --- | --- |
| name | const System::String\& | Nombre del marcador sin distinción de mayúsculas/minúsculas a localizar. |
