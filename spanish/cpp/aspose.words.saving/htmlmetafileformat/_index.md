---
title: "Aspose::Words::Saving::HtmlMetafileFormat enumeración"
linktitle: "HtmlMetafileFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::HtmlMetafileFormat enumeración. Indica el formato en el que los metarchivos se guardan en documentos HTML en C++."
type: docs
weight: 60000
url: /es/cpp/aspose.words.saving/htmlmetafileformat/
---
## HtmlMetafileFormat enum


Indica el formato en el que los metarchivos se guardan en documentos HTML.
...
| --- | --- | --- |
| Png | 0 | Los metarchivos se renderizan como imágenes PNG rasterizadas. |
