---
title: "Clase Aspose::Words::Saving::DocSaveOptions"
linktitle: "DocSaveOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Saving::DocSaveOptions. Puede usarse para especificar opciones adicionales al guardar un documento en formato Doc o Dot. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.saving/docsaveoptions/
---
## DocSaveOptions class


Puede usarse para especificar opciones adicionales al guardar un documento en formato [Doc](../../aspose.words/saveformat/) o [Dot](../../aspose.words/saveformat/). Para obtener más información, visite el artículo de documentación [Especificar opciones de guardado](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [DocSaveOptions](./docsaveoptions/)() | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en formato [Doc](../../aspose.words/saveformat/). |
| [DocSaveOptions](./docsaveoptions/)(Aspose::Words::SaveFormat) | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en formato [Doc](../../aspose.words/saveformat/) o [Dot](../../aspose.words/saveformat/). |
...
| [get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/)() const | Cuando **false**, los metafiles pequeños no se comprimen por razones de rendimiento. El valor predeterminado es **true**, todos los metafiles se comprimen sin importar su tamaño. |
...
| [get_Password](./get_password/)() const | Obtiene/establece una contraseña para cifrar el documento usando el método de cifrado RC4. |
...
| [get_SaveFormat](./get_saveformat/)() override | Especifica el formato en el que se guardará el documento si se usa este objeto de opciones de guardado. Puede ser [Doc](../../aspose.words/saveformat/) o [Dot](../../aspose.words/saveformat/). |
| [get_SavePictureBullet](./get_savepicturebullet/)() const | Cuando **false**, los datos de PictureBullet no se guardan en el documento de salida. El valor predeterminado es **true**. |
| [get_SaveRoutingSlip](./get_saveroutingslip/)() const | Cuando **false**, los datos de RoutingSlip no se guardan en el documento de salida. El valor predeterminado es **true**. |
...
| [set_AlwaysCompressMetafiles](./set_alwayscompressmetafiles/)(bool) | Método setter para [Aspose::Words::Saving::DocSaveOptions::get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/). |
...
| [set_Password](./set_password/)(const System::String\&) | Método setter para [Aspose::Words::Saving::DocSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Método setter para [Aspose::Words::Saving::DocSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SavePictureBullet](./set_savepicturebullet/)(bool) | Método setter para [Aspose::Words::Saving::DocSaveOptions::get_SavePictureBullet](./get_savepicturebullet/). |
| [set_SaveRoutingSlip](./set_saveroutingslip/)(bool) | Método setter para [Aspose::Words::Saving::DocSaveOptions::get_SaveRoutingSlip](./get_saveroutingslip/). |
