---
title: "Método Aspose::Words::Saving::TxtSaveOptions::get_ListIndentation"
linktitle: "get_ListIndentation"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Saving::TxtSaveOptions::get_ListIndentation. Obtiene un objeto TxtListIndentation que especifica cuántos y qué carácter usar para la sangría de los niveles de lista. Por defecto, es un recuento cero del carácter ''\\\\0'', lo que significa sin sangría en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.saving/txtsaveoptions/get_listindentation/
---
## TxtSaveOptions::get_ListIndentation method


Obtiene un objeto [TxtListIndentation](../../txtlistindentation/) que especifica cuántos y qué carácter usar para la sangría de los niveles de lista. Por defecto, es un recuento cero del carácter '\\0', lo que significa sin sangría.
