---
title: "Clase Aspose::Words::Saving::XamlFlowSaveOptions"
linktitle: "XamlFlowSaveOptions"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Saving::XamlFlowSaveOptions. Puede usarse para especificar opciones adicionales al guardar un documento en formato XamlFlow o XamlFlowPack. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 37000
url: /es/cpp/aspose.words.saving/xamlflowsaveoptions/
---
## XamlFlowSaveOptions class


Puede usarse para especificar opciones adicionales al guardar un documento en el formato [XamlFlow](../../aspose.words/saveformat/) o [XamlFlowPack](../../aspose.words/saveformat/). Para obtener más información, visite el artículo de documentación [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_ImageSavingCallback](./get_imagesavingcallback/)() const | Permite controlar cómo se guardan las imágenes cuando un documento se guarda en XAML. |
| [get_ImagesFolder](./get_imagesfolder/)() const | Especifica la carpeta física donde se guardan las imágenes al exportar un documento al formato XAML. El valor predeterminado es una cadena vacía. |
| [get_ImagesFolderAlias](./get_imagesfolderalias/)() const | Especifica el nombre de la carpeta utilizada para construir los URI de imágenes escritos en un documento XAML. El valor predeterminado es una cadena vacía. |
...
| [get_SaveFormat](./get_saveformat/)() override | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Solo puede ser [XamlFlow](../../aspose.words/saveformat/). |
...
| [set_ImageSavingCallback](./set_imagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IImageSavingCallback\>\&) | Permite controlar cómo se guardan las imágenes cuando un documento se guarda en XAML. |
| [set_ImagesFolder](./set_imagesfolder/)(const System::String\&) | Método set para [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolder](./get_imagesfolder/). |
| [set_ImagesFolderAlias](./set_imagesfolderalias/)(const System::String\&) | Método set para [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolderAlias](./get_imagesfolderalias/). |
...
| [set_ReplaceBackslashWithYenSign](./set_replacebackslashwithyensign/)(bool) | Método set para [Aspose::Words::Saving::XamlFlowSaveOptions::get_ReplaceBackslashWithYenSign](./get_replacebackslashwithyensign/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Especifica el formato en el que se guardará el documento si se utiliza este objeto de opciones de guardado. Solo puede ser [XamlFlow](../../aspose.words/saveformat/). |
...
| static [Type](./type/)() |  |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)() | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en el formato [XamlFlow](../../aspose.words/saveformat/). |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)(Aspose::Words::SaveFormat) | Inicializa una nueva instancia de esta clase que puede usarse para guardar un documento en el formato [XamlFlow](../../aspose.words/saveformat/) o [XamlFlowPack](../../aspose.words/saveformat/). |
## Ver también
