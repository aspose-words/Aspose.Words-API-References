---
title: "Aspose::Words::Saving::HtmlSaveOptions::get_HtmlVersion método"
linktitle: "get_HtmlVersion"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::HtmlSaveOptions::get_HtmlVersion método. Especifica la versión del estándar HTML que debe usarse al guardar el documento en HTML o MHTML. El valor predeterminado es Xhtml en C++."
type: docs
weight: 35000
url: /es/cpp/aspose.words.saving/htmlsaveoptions/get_htmlversion/
---
## HtmlSaveOptions::get_HtmlVersion method


Especifica la versión del estándar HTML que debe usarse al guardar el documento en HTML o MHTML. El valor predeterminado es [Xhtml](../../htmlversion/).
