---
title: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels método"
linktitle: "get_ExportListLabels"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels método. Controla cómo se exportan las etiquetas de lista a HTML, MHTML o EPUB. El valor predeterminado es Auto en C++."
type: docs
weight: 21000
url: /es/cpp/aspose.words.saving/htmlsaveoptions/get_exportlistlabels/
---
## HtmlSaveOptions::get_ExportListLabels method


Controla cómo se exportan las etiquetas de lista a HTML, MHTML o EPUB. El valor predeterminado es [Auto](../../exportlistlabels/).
