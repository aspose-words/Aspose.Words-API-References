---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder método"
linktitle: "get_HasVerticalBorder"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasVerticalBorder método. Obtiene o establece una bandera que indica si se muestra un borde vertical de la tabla de datos. El valor predeterminado es true en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.drawing.charts/chartdatatable/get_hasverticalborder/
---
## ChartDataTable::get_HasVerticalBorder method


Obtiene o establece una bandera que indica si se muestra un borde vertical de la tabla de datos. El valor predeterminado es **true**.
