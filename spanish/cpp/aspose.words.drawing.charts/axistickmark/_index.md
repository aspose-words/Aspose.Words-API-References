...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. Especifica las posibles posiciones para las marcas de graduación en C++."
type: docs
weight: 25000
url: /es/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum
...
| Dentro | 1 | Especifica que las marcas de graduación deben estar dentro del área del gráfico. |
| Exterior | 2 | Especifica que las marcas de graduación deben estar fuera del área del gráfico. |
| None | 3 | Especifica que no debe haber marcas de graduación. |
