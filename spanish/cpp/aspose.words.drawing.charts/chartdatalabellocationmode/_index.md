---
title: "Enumeración Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode"
linktitle: "ChartDataLabelLocationMode"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Enumeración Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode. Especifica cómo se interpretan los valores que indican la ubicación de una etiqueta de datos - las propiedades Left y Top - en C++."
type: docs
weight: 27167
url: /es/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


Especifica cómo se interpretan los valores que indican la ubicación de una etiqueta de datos - las propiedades [Left](../chartdatalabel/get_left/) y [Top](../chartdatalabel/get_top/) -.
...
| --- | --- | --- |
| Offset | 0 | La ubicación de una etiqueta de datos se especifica mediante un desplazamiento desde la posición definida por su propiedad [Position](../chartdatalabel/get_position/). |
| Absoluto | 1 | La ubicación de una etiqueta de datos se especifica usando coordenadas absolutas, comenzando desde la esquina superior izquierda de un gráfico. |
