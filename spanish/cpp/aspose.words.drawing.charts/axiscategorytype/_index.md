---
title: "Enumeración Aspose::Words::Drawing::Charts::AxisCategoryType"
linktitle: "AxisCategoryType"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Enumeración Aspose::Words::Drawing::Charts::AxisCategoryType. Especifica el tipo de un eje de categoría en C++."
type: docs
weight: 21000
url: /es/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| --- | --- | --- |
| Automático | 0 | Especifica que el tipo de un eje de categoría se determina automáticamente en función de los datos. |
| Categoría | 1 | Especifica un eje de un conjunto arbitrario de categorías. |
| Tiempo | 2 | Especifica un eje de categoría de tiempo. |
