---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit clase"
linktitle: "AxisDisplayUnit"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Drawing::Charts::AxisDisplayUnit. Proporciona acceso a las opciones de escalado de las unidades de visualización para el eje de valores. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Proporciona acceso a las opciones de escala de las unidades de visualización para el eje de valores. Para obtener más información, visite el artículo de documentación [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/).
...
| [get_CustomUnit](./get_customunit/)() const | Obtiene o establece un divisor definido por el usuario para escalar las unidades de visualización en el eje de valores. |
| [get_Document](./get_document/)() | Devuelve el documento que contiene el gráfico principal. |
| [get_Unit](./get_unit/)() const | Obtiene o establece el valor de escalado de las unidades de visualización como uno de los valores predefinidos. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | Método set para [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/). |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | Método set para [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/). |
| static [Type](./type/)() |  |
