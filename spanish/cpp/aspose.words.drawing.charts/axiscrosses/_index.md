---
title: "Aspose::Words::Drawing::Charts::AxisCrosses enumeración"
linktitle: "AxisCrosses"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::Charts::AxisCrosses enumeración. Especifica los posibles puntos de cruce para un eje en C++."
type: docs
weight: 22000
url: /es/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum
...
| --- | --- | --- |
| Automático | 0 | El eje de categorías cruza en el punto cero del eje de valores (si es posible), o en el valor mínimo si el mínimo es mayor que cero, o en el máximo si el máximo es menor que cero. |
| Máximo | 1 | Un eje perpendicular cruza en el valor máximo del eje. |
| Mínimo | 2 | Un eje perpendicular cruza en el valor mínimo del eje. |
| Personalizado | 3 | Un eje perpendicular cruza en el valor especificado del eje. |
