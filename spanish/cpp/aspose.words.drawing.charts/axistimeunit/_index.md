---
title: "Aspose::Words::Drawing::Charts::AxisTimeUnit enumeración"
linktitle: "AxisTimeUnit"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Enum Aspose::Words::Drawing::Charts::AxisTimeUnit. Especifica la unidad de tiempo para los ejes en C++."
type: docs
weight: 26000
url: /es/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum
...
| --- | --- | --- |
| Automático | 0 | Especifica que la unidad no se estableció explícitamente y se debe usar el valor predeterminado. |
| Días | 1 | Especifica que los datos del gráfico se mostrarán en días. |
| Meses | 2 | Especifica que los datos del gráfico se mostrarán en meses. |
| Años | 3 | Especifica que los datos del gráfico se mostrarán en años. |
