---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing método"
linktitle: "get_IsAutoSpacing"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing método. Obtiene o establece una bandera que indica si se debe usar un intervalo automático para dibujar las etiquetas de marca en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.drawing.charts/axisticklabels/get_isautospacing/
---
## AxisTickLabels::get_IsAutoSpacing method


Obtiene o establece una bandera que indica si se debe usar un intervalo automático para dibujar las etiquetas de marcas de graduación.
...
La propiedad tiene efecto en los ejes de categoría de texto y de series. No es compatible con los nuevos gráficos de MS Office 2016.
