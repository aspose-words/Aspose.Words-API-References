---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing método"
linktitle: "get_Spacing"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing método. Obtiene o establece el intervalo al que se dibujan las etiquetas de marca en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


Obtiene o establece el intervalo en el que se dibujan las etiquetas de los marcadores.
...
La propiedad tiene efecto en los ejes de categoría de texto y de series. No es compatible con los nuevos gráficos de MS Office 2016. El rango válido de un valor es mayor o igual a 1.

Establecer esta propiedad asigna la propiedad [IsAutoSpacing](../get_isautospacing/) a **false**.
