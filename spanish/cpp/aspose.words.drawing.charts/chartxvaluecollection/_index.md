---
title: "Clase Aspose::Words::Drawing::Charts::ChartXValueCollection"
linktitle: "ChartXValueCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Drawing::Charts::ChartXValueCollection. Representa una colección de valores X para una serie de gráfico en C++."
type: docs
weight: 18400
url: /es/cpp/aspose.words.drawing.charts/chartxvaluecollection/
---
...
| [get_FormatCode](./get_formatcode/)() | Obtiene o establece el código de formato aplicado a los valores X. |
| [GetEnumerator](./getenumerator/)() override | Devuelve un objeto enumerador. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtiene o establece el valor X en el índice especificado. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Drawing::Charts::ChartXValue\>\&) | Obtiene o establece el valor X en el índice especificado. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_FormatCode](./set_formatcode/)(const System::String\&) | Establecedor para [Aspose::Words::Drawing::Charts::ChartXValueCollection::get_FormatCode](./get_formatcode/). |
| static [Type](./type/)() |  |
## Observaciones


Todos los elementos de la colección, excepto **null**, deben tener el mismo [ValueType](../chartxvalue/get_valuetype/).

La colección solo permite cambiar valores X. Para agregar o insertar nuevos valores a una serie de gráfico, o eliminar valores, se pueden usar los métodos apropiados de la clase [ChartSeries](../chartseries/).
