---
title: "Método Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left"
linktitle: "get_Left"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left. Obtiene o establece la distancia de la etiqueta de datos en puntos desde el borde izquierdo del gráfico o desde la posición especificada por su propiedad Position, dependiendo del valor de la propiedad LeftMode en C++."
type: docs
weight: 6334
url: /es/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


Obtiene o establece la distancia de la etiqueta de datos en puntos desde el borde izquierdo del gráfico o desde la posición especificada por su propiedad [Position](../get_position/), dependiendo del valor de la propiedad [LeftMode](../get_leftmode/).
...
El valor de la propiedad cambia proporcionalmente si se redimensiona la forma del gráfico.

La propiedad no se puede establecer en un gráfico de Word 2016.
