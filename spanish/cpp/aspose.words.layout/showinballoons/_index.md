...
description: "Aspose::Words::Layout::ShowInBalloons enum. Especifica qué revisiones se renderizan en globos en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Especifica qué revisiones se renderizan en globos.
...
| --- | --- | --- |
| None | 0 | Renderiza inserciones, eliminaciones y revisiones de formato en línea. |
| Format | 1 | Renderiza inserciones y eliminaciones en línea, revisiones de formato en globos. |
| FormatAndDelete | 2 | Renderiza revisiones de inserción en línea, y revisiones de eliminación y formato en globos. |
