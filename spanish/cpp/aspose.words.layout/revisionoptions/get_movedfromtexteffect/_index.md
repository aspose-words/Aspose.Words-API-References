---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect método"
linktitle: "get_MovedFromTextEffect"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect método. Permite especificar el efecto que se aplicará a las áreas donde el contenido se movió desde Moving. El valor predeterminado es DoubleStrikeThrough en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words.layout/revisionoptions/get_movedfromtexteffect/
---
## RevisionOptions::get_MovedFromTextEffect method


Permite especificar el efecto que se aplicará a las áreas donde el contenido se movió desde [Moving](../../../aspose.words/revisiontype/). El valor predeterminado es [DoubleStrikeThrough](../../revisiontexteffect/)
