---
title: "Método Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect"
linktitle: "get_MovedToTextEffect"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect. Permite especificar el efecto que se aplicará a las áreas donde el contenido se movió a Moving. El valor predeterminado es DoubleUnderline en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.layout/revisionoptions/get_movedtotexteffect/
---
## RevisionOptions::get_MovedToTextEffect method


Permite especificar el efecto que se aplicará a las áreas donde el contenido se movió a [Movimiento](../../../aspose.words/revisiontype/). El valor predeterminado es [DoubleUnderline](../../revisiontexteffect/)
