---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor método"
linktitle: "get_MovedToTextColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor. Permite especificar el color que se usará en las áreas donde el contenido se movió a Moving. El valor predeterminado es ByAuthor en C++."
type: docs
weight: 10000
url: /es/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


Permite especificar el color que se usará en las áreas donde el contenido se movió a [Moving](../../../aspose.words/revisiontype/). El valor predeterminado es [ByAuthor](../../revisioncolor/).
