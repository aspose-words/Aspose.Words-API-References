---
title: "Método Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor"
linktitle: "get_MovedFromTextColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor. Permite especificar el color que se usará en las áreas donde el contenido se movió desde Moving. El valor predeterminado es ByAuthor en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Permite especificar el color que se usará en las áreas donde el contenido se movió desde [Moving](../../../aspose.words/revisiontype/). El valor predeterminado es [ByAuthor](../../revisioncolor/).
