---
title: "Método Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor"
linktitle: "get_DeletedTextColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor. Permite especificar el color que se usará para el contenido eliminado Deletion. El valor predeterminado es ByAuthor en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


Permite especificar el color que se usará para el contenido eliminado [Deletion](../../../aspose.words/revisiontype/). El valor predeterminado es [ByAuthor](../../revisioncolor/).
