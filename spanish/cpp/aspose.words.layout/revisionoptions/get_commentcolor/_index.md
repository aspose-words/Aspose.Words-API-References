---
title: "Aspose::Words::Layout::RevisionOptions::get_CommentColor método"
linktitle: "get_CommentColor"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Layout::RevisionOptions::get_CommentColor método. Permite especificar el color a usar para los comentarios. El valor predeterminado es Rojo en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


Permite especificar el color a usar para los comentarios. El valor predeterminado es [Rojo](../../revisioncolor/).
