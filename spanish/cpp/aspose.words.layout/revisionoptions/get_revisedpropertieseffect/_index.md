---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect método"
linktitle: "get_RevisedPropertiesEffect"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect método. Permite especificar el efecto para áreas de contenido con cambios en las propiedades de formato FormatChange. El valor predeterminado es None en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


Permite especificar el efecto para áreas de contenido con cambios en las propiedades de formato [FormatChange](../../../aspose.words/revisiontype/) Valor predeterminado es [None](../../revisiontexteffect/)
