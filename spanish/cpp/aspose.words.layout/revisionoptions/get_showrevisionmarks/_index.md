---
title: "Método Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks"
linktitle: "get_ShowRevisionMarks"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_ShowRevisionMarks. Permite especificar si el texto de revisión debe estar marcado con formato especial. El valor predeterminado es true en C++."
type: docs
weight: 20000
url: /es/cpp/aspose.words.layout/revisionoptions/get_showrevisionmarks/
---
## RevisionOptions::get_ShowRevisionMarks method


Permite especificar si el texto de revisión debe marcarse con un formato especial. El valor predeterminado es **true**.
