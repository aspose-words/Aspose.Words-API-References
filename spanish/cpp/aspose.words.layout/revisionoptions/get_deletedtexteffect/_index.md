---
title: "Método Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect"
linktitle: "get_DeletedTextEffect"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect. Permite especificar el efecto que se aplicará al contenido eliminado Deletion. El valor predeterminado es StrikeThrough en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


Permite especificar el efecto que se aplicará al contenido eliminado [Deletion](../../../aspose.words/revisiontype/). El valor predeterminado es [StrikeThrough](../../revisiontexteffect/)
