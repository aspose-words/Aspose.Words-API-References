---
title: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex método"
linktitle: "GetStartPageIndex"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex método. Obtiene el índice basado en 1 de la página donde comienza el nodo. Devuelve 0 si el nodo no puede asignarse a una página en C++."
type: docs
weight: 8000
url: /es/cpp/aspose.words.layout/layoutcollector/getstartpageindex/
---
## LayoutCollector::GetStartPageIndex method


Obtiene el índice basado en uno de la página donde comienza el nodo. Devuelve 0 si el nodo no puede asignarse a una página.
