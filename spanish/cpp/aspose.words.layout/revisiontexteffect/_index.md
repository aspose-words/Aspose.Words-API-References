...
description: "Aspose::Words::Layout::RevisionTextEffect enum. Permite especificar el efecto de decoración para las revisiones del texto del documento en C++."
type: docs
weight: 12000
url: /es/cpp/aspose.words.layout/revisiontexteffect/
---
...
| --- | --- | --- |
| None | 0 | El contenido revisado no tiene efectos especiales aplicados. Esto corresponde a [NoHighlight](../revisioncolor/). |
| Color | 1 | El contenido revisado se resalta solo con color. |
| Negrita | 2 | El contenido revisado se pone en negrita y coloreado. |
| Cursiva | 3 | El contenido revisado se pone en cursiva y coloreado. |
| Subrayado | 4 | El contenido revisado está subrayado y coloreado. |
| DobleSubrayado | 5 | El contenido revisado está doblemente subrayado y coloreado. |
| Tachado | 6 | El contenido revisado está tachado y coloreado. |
| DobleTachado | 7 | El contenido revisado está doblemente tachado y coloreado. |
| Oculto | 8 | El contenido revisado está oculto. |
