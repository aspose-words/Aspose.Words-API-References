---
title: "Clase Aspose::Words::Fields::FieldEditTime"
linktitle: "FieldEditTime"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldEditTime. Implementa el campo EDITTIME. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 37000
url: /es/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


Implementa el campo EDITTIME. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// el tiempo que el documento ha estado abierto en una ventana de Microsoft Word.
...
// Esta propiedad de documento incorporada registra los minutos. Microsoft Word usa esta propiedad
// para registrar el tiempo que el documento ha estado abierto. También podemos editarla nosotros mismos.
...
// actualizado manualmente en Microsoft Word cada vez que necesitemos un valor preciso.
doc->UpdateFields();
