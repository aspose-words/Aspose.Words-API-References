---
title: "Clase Aspose::Words::Fields::FieldNoteRef"
linktitle: "FieldNoteRef"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldNoteRef. Implementa el campo NOTEREF. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 72000
url: /es/cpp/aspose.words.fields/fieldnoteref/
---
## FieldNoteRef class


Implementa el campo NOTEREF. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_InsertHyperlink](./get_inserthyperlink/)() | Obtiene si se debe insertar un hipervínculo al párrafo marcado. |
| [get_InsertReferenceMark](./get_insertreferencemark/)() | Inserta la marca de referencia con el mismo formato de caracteres que el estilo de Referencia de nota al pie o Referencia de nota final. |
| [get_InsertRelativePosition](./get_insertrelativeposition/)() | Obtiene si se debe insertar una posición relativa del párrafo marcado. |
...
| [set_InsertHyperlink](./set_inserthyperlink/)(bool) | Establece si se debe insertar un hipervínculo al párrafo marcado. |
| [set_InsertReferenceMark](./set_insertreferencemark/)(bool) | Inserta la marca de referencia con el mismo formato de caracteres que el estilo de Referencia de nota al pie o Referencia de nota final. |
| [set_InsertRelativePosition](./set_insertrelativeposition/)(bool) | Establece si se debe insertar una posición relativa del párrafo marcado. |
...
Muestra cómo hacer referencias cruzadas de notas al pie con el campo NOTEREF.
```cpp
...
// Este campo funciona solo en versiones anteriores de Microsoft Word.
