...
description: "Clase Aspose::Words::Fields::FieldTC. Implementa el campo TC. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 100000
url: /es/cpp/aspose.words.fields/fieldtc/
---
## FieldTC class


Implementa el campo TC. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryLevel](./get_entrylevel/)() | Obtiene el nivel de la entrada. |
...
| [get_OmitPageNumber](./get_omitpagenumber/)() override | Obtiene si el número de página en el índice debe omitirse para este campo. |
...
| [get_Text](./get_text/)() | Obtiene el texto de la entrada. |
| virtual [get_Type](../field/get_type/)() const | Obtiene el tipo de campo de Microsoft Word. |
| [get_TypeIdentifier](./get_typeidentifier/)() | Obtiene un identificador de tipo para este campo (que suele ser una letra). |
...
| [set_EntryLevel](./set_entrylevel/)(const System::String\&) | Establece el nivel de la entrada. |
...
| [set_OmitPageNumber](./set_omitpagenumber/)(bool) | Establece si el número de página en el índice debe omitirse para este campo. |
| [set_Result](../field/set_result/)(const System::String\&) | Método set para [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_Text](./set_text/)(const System::String\&) | Establece el texto de la entrada. |
| [set_TypeIdentifier](./set_typeidentifier/)(const System::String\&) | Establece un identificador de tipo para este campo (que suele ser una letra). |
| static [Type](./type/)() |  |
