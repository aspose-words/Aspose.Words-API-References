---
title: "Clase Aspose::Words::Fields::FieldLastSavedBy"
linktitle: "FieldLastSavedBy"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldLastSavedBy. Implementa el campo LASTSAVEDBY. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 62000
url: /es/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


Implementa el campo LASTSAVEDBY. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Muestra cómo usar el campo LASTSAVEDBY.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Si creamos un documento en Microsoft Word, tendrá el nombre del usuario en la propiedad incorporada "Last saved by".
