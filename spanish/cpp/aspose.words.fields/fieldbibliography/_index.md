---
title: "Aspose::Words::Fields::FieldBibliography clase"
linktitle: "FieldBibliography"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldBibliography clase. Implementa el campo BIBLIOGRAPHY. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 18000
url: /es/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


Implementa el campo BIBLIOGRAPHY. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Obtiene el ID de idioma que se usa para filtrar los datos bibliográficos y mostrar solo las fuentes en el documento que utilizan ese idioma. |
| [get_Format](../field/get_format/)() | Obtiene un objeto [FieldFormat](../fieldformat/) que proporciona acceso tipado al formato del campo. |
| [get_FormatLanguageId](./get_formatlanguageid/)() | Obtiene el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento. |
...
| [get_SourceTag](./get_sourcetag/)() | Obtiene un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Establece el ID de idioma que se usa para filtrar los datos bibliográficos y mostrar solo las fuentes en el documento que utilizan ese idioma. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Establece el ID de idioma que se usa para formatear las fuentes bibliográficas en el documento. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Establece un valor para que solo se muestren en la bibliografía las fuentes cuyo valor del elemento Tag coincida. |
| static [Type](./type/)() |  |
