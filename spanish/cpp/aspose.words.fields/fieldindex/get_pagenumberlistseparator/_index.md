---
title: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator método"
linktitle: "get_PageNumberListSeparator"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator método. Obtiene o establece la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.fields/fieldindex/get_pagenumberlistseparator/
---
## FieldIndex::get_PageNumberListSeparator method


Obtiene o establece la secuencia de caracteres que se usa para separar dos números de página en una lista de números de página.
