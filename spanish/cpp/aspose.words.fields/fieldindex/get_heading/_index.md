---
title: "Aspose::Words::Fields::FieldIndex::get_Heading método"
linktitle: "get_Heading"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldIndex::get_Heading método. Obtiene o establece un encabezado que aparece al inicio de cada conjunto de entradas para cualquier letra dada en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.fields/fieldindex/get_heading/
---
## FieldIndex::get_Heading method


Obtiene o establece un encabezado que aparece al inicio de cada conjunto de entradas para una letra dada.
