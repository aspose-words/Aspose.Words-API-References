---
title: "Aspose::Words::Fields::FieldIndex::get_BookmarkName método"
linktitle: "get_BookmarkName"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldIndex::get_BookmarkName método. Obtiene o establece el nombre del marcador que indica la porción del documento utilizada para crear el índice en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fieldindex/get_bookmarkname/
---
## FieldIndex::get_BookmarkName method


Obtiene o establece el nombre del marcador que indica la parte del documento utilizada para crear el índice.
