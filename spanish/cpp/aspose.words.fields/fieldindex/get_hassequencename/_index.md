---
title: "Aspose::Words::Fields::FieldIndex::get_HasSequenceName método"
linktitle: "get_HasSequenceName"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldIndex::get_HasSequenceName método. Obtiene un valor que indica si se debe usar una secuencia mientras se construye el resultado del campo en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.fields/fieldindex/get_hassequencename/
---
## FieldIndex::get_HasSequenceName method


Obtiene un valor que indica si se debe usar una secuencia durante la generación del resultado del campo.
