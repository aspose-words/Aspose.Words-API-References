---
title: "Aspose::Words::Fields::FieldEnd clase"
linktitle: "FieldEnd"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldEnd. Representa el final de un campo Word en un documento. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 39000
url: /es/cpp/aspose.words.fields/fieldend/
---
## FieldEnd class


Representa el final de un campo Word en un documento. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_HasSeparator](./get_hasseparator/)() const | Devuelve **true** si este campo tiene un separador. |
...
| [get_NodeType](./get_nodetype/)() const override | Devuelve [FieldEnd](../../aspose.words/nodetype/). |
