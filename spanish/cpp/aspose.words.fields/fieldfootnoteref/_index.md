...
description: "Aspose::Words::Fields::FieldFootnoteRef class. Implementa el campo FOOTNOTEREF. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 44000
url: /es/cpp/aspose.words.fields/fieldfootnoteref/
---
## FieldFootnoteRef class


Implementa el campo FOOTNOTEREF. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
