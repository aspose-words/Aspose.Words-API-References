---
title: "Clase Aspose::Words::Fields::FieldTime"
linktitle: "FieldTime"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldTime. Implementa el campo TIME. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 102000
url: /es/cpp/aspose.words.fields/fieldtime/
---
## FieldTime class


Implementa el campo TIME. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
