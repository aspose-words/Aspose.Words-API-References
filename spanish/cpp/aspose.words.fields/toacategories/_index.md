---
title: "Clase Aspose::Words::Fields::ToaCategories"
linktitle: "ToaCategories"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::ToaCategories. Representa una tabla de categorías de autoridades. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 116000
url: /es/cpp/aspose.words.fields/toacategories/
---
## ToaCategories class


Representa una tabla de categorías de autoridades. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| static [get_DefaultCategories](./get_defaultcategories/)() | Obtiene la tabla predeterminada de categorías de autoridades. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtiene o establece el encabezado de la categoría por número de categoría. |
| [idx_set](./idx_set/)(int32_t, const System::String\&) | Obtiene o establece el encabezado de la categoría por número de categoría. |
