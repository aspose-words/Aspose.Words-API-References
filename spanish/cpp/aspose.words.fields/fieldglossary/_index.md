---
title: "Aspose::Words::Fields::FieldGlossary clase"
linktitle: "FieldGlossary"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldGlossary clase. Implementa el campo GLOSSARY. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 50000
url: /es/cpp/aspose.words.fields/fieldglossary/
---
## FieldGlossary class


Implementa el campo GLOSSARY. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() override | Obtiene o establece el nombre de la entrada del glosario a insertar. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Método setter para [Aspose::Words::Fields::FieldGlossary::get_EntryName](./get_entryname/). |
