...
description: "Aspose::Words::Fields::FieldDde class. Implementa el campo DDE. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 32000
url: /es/cpp/aspose.words.fields/fielddde/
---
## FieldDde class


Implementa el campo DDE. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
