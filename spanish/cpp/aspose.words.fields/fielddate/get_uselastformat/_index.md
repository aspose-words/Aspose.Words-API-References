---
title: "Aspose::Words::Fields::FieldDate::get_UseLastFormat método"
linktitle: "get_UseLastFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldDate::get_UseLastFormat método. Obtiene o establece si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fielddate/get_uselastformat/
---
## FieldDate::get_UseLastFormat method


Obtiene o establece si se debe usar un formato usado por última vez por la aplicación anfitriona al insertar un nuevo campo DATE.
