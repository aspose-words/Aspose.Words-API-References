---
title: "Aspose::Words::Fields::FieldUnknown clase"
linktitle: "FieldUnknown"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldUnknown clase. Implementa un campo desconocido o no reconocido. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 106000
url: /es/cpp/aspose.words.fields/fieldunknown/
---
## FieldUnknown class


Implementa un campo desconocido o no reconocido. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Inserte un campo que no denote un tipo de campo objetivo en su código de campo.
