---
title: "Aspose::Words::Fields::FieldAutoTextList clase"
linktitle: "FieldAutoTextList"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAutoTextList clase. Implementa el campo AUTOTEXTLIST. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 16000
url: /es/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


Implementa el campo AUTOTEXTLIST. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() | Obtiene el nombre de la entrada AutoText. |
...
| [get_ListStyle](./get_liststyle/)() | Obtiene el nombre del estilo en el que se basa la lista que contiene entradas. |
...
| [get_ScreenTip](./get_screentip/)() | Obtiene el texto del ScreenTip a mostrar. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Establece el nombre de la entrada AutoText. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | Establece el nombre del estilo en el que se basa la lista que contiene entradas. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | Establece el texto del ScreenTip a mostrar. |
| static [Type](./type/)() |  |
