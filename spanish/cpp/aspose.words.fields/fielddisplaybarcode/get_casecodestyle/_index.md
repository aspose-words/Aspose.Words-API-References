---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_CaseCodeStyle método"
linktitle: "get_CaseCodeStyle"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_CaseCodeStyle método. Obtiene o establece el estilo de un Case Code para el tipo de código de barras ITF14. Los valores válidos son [STD|EXT|ADD] en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.fields/fielddisplaybarcode/get_casecodestyle/
---
## FieldDisplayBarcode::get_CaseCodeStyle method


Obtiene o establece el estilo de un Case Code para el tipo de código de barras ITF14. Los valores válidos son [STD|EXT|ADD].
