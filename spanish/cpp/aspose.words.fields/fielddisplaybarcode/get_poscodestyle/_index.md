---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle método"
linktitle: "get_PosCodeStyle"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle método. Obtiene o establece el estilo de un código de barras Point of Sale (tipos de código de barras UPCA|UPCE|EAN13|EAN8). Los valores válidos (sin distinción de mayúsculas) son [STD|SUP2|SUP5|CASE] en C++."
type: docs
weight: 11000
url: /es/cpp/aspose.words.fields/fielddisplaybarcode/get_poscodestyle/
---
## FieldDisplayBarcode::get_PosCodeStyle method


Obtiene o establece el estilo de un código de barras Point of Sale (tipos de código de barras UPCA|UPCE|EAN13|EAN8). Los valores válidos (sin distinción de mayúsculas) son [STD|SUP2|SUP5|CASE].
