---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText método"
linktitle: "get_DisplayText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText método. Obtiene o establece si se muestra el dato del código de barras (texto) junto con la imagen en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.fields/fielddisplaybarcode/get_displaytext/
---
## FieldDisplayBarcode::get_DisplayText method


Obtiene o establece si se muestra los datos del código de barras (texto) junto con la imagen.
