---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_AddStartStopChar método"
linktitle: "get_AddStartStopChar"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_AddStartStopChar método. Obtiene o establece si se deben agregar caracteres de inicio/fin para los tipos de código de barras NW7 y CODE39 en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fielddisplaybarcode/get_addstartstopchar/
---
## FieldDisplayBarcode::get_AddStartStopChar method


Obtiene o establece si se deben agregar caracteres de inicio/fin para los tipos de código de barras NW7 y CODE39.
