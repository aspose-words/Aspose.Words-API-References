---
title: "Aspose::Words::Fields::FieldAutoNumOut clase"
linktitle: "FieldAutoNumOut"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAutoNumOut clase. Implementa el campo AUTONUMOUT. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 14000
url: /es/cpp/aspose.words.fields/fieldautonumout/
---
## FieldAutoNumOut class


Implementa el campo AUTONUMOUT. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// A diferencia de los campos AUTONUM, los campos AUTONUMOUT utilizan el esquema de numeración de contorno,
// que podemos definir en Microsoft Word a través de Formato -> Viñetas y numeración -> "Outline Numbered".
// Esto nos permite numerar automáticamente los elementos como una lista numerada.
// Los campos LISTNUM son una alternativa más reciente a los campos AUTONUMOUT.
