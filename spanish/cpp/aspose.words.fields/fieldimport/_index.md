---
title: "clase Aspose::Words::Fields::FieldImport"
linktitle: "FieldImport"
second_title: "Referencia de API de Aspose.Words para C++"
description: "clase Aspose::Words::Fields::FieldImport. Implementa el campo IMPORT. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 55000
url: /es/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


Implementa el campo IMPORT. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_SourceFullName](./get_sourcefullname/)() override | Obtiene o establece la ubicación de la imagen. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | Establecedor de [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | Método set para [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | Establecedor de [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/). |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | Establecedor de [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
