...
description: "Aspose::Words::Fields::FieldBuilder class. Construye un campo a partir de tokens de código de campo (argumentos y conmutadores). Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 20000
url: /es/cpp/aspose.words.fields/fieldbuilder/
---
## FieldBuilder class


Construye un campo a partir de tokens de código de campo (argumentos y conmutadores). Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [AddArgument](./addargument/)(const System::String\&) | Agrega un argumento al campo. |
| [AddArgument](./addargument/)(int32_t) | Agrega un argumento al campo. |
| [AddArgument](./addargument/)(double) | Agrega un argumento al campo. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Agrega un campo hijo representado por otro [FieldBuilder](./) al código del campo. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldArgumentBuilder\>\&) | Agrega un argumento del campo representado por [FieldArgumentBuilder](../fieldargumentbuilder/) al código del campo. |
| [AddSwitch](./addswitch/)(const System::String\&) | Agrega un conmutador del campo. |
| [AddSwitch](./addswitch/)(const System::String\&, const System::String\&) | Agrega un conmutador del campo. |
| [AddSwitch](./addswitch/)(const System::String\&, int32_t) | Agrega un conmutador del campo. |
| [AddSwitch](./addswitch/)(const System::String\&, double) | Agrega un conmutador del campo. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Construye e inserta un campo en el documento antes del nodo en línea especificado. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Paragraph\>\&) | Construye e inserta un campo en el documento al final del párrafo especificado. |
| [FieldBuilder](./fieldbuilder/)(Aspose::Words::Fields::FieldType) | Inicializa una instancia de la clase [FieldBuilder](./). |
