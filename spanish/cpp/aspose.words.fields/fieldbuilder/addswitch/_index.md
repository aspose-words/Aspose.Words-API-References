...
description: "Aspose::Words::Fields::FieldBuilder::AddSwitch method. Agrega el interruptor de un campo en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.fields/fieldbuilder/addswitch/
---
## FieldBuilder::AddSwitch(const System::String\&) method


Agrega un conmutador del campo.
...
| --- | --- | --- |
| switchName | const System::String\& | El nombre del interruptor. |
...
| --- | --- | --- |
| switchName | const System::String\& | El nombre del interruptor. |
| switchArgument | const System::String\& | El valor del interruptor. |
...
| --- | --- | --- |
| switchName | const System::String\& | El nombre del interruptor. |
| switchArgument | int32_t | El valor del interruptor. |
