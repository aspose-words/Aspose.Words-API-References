...
description: "Aspose::Words::Fields::FieldBuilder::AddArgument method. Agrega un argumento de campo representado por FieldArgumentBuilder al código del campo en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.fields/fieldbuilder/addargument/
---
## FieldBuilder::AddArgument(const System::SharedPtr\<Aspose::Words::Fields::FieldArgumentBuilder\>\&) method


Agrega un argumento de campo representado por [FieldArgumentBuilder](../../fieldargumentbuilder/) al código del campo.
...
Agrega un campo hijo representado por otro [FieldBuilder](../) al código del campo.
...
| --- | --- | --- |
| argument | const System::String\& | El valor del argumento. |
...
| Parámetro | Tipo | Descripción |
| --- | --- | --- |
| argument | int32_t | El valor del argumento. |
