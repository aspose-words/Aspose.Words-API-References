---
title: "Aspose::Words::Fields::FieldSeparator clase"
linktitle: "FieldSeparator"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldSeparator clase. Representa un separador de campo de Word que separa el código del campo del resultado del campo. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 90000
url: /es/cpp/aspose.words.fields/fieldseparator/
---
## FieldSeparator class


Representa un separador de campo de Word que separa el código del campo del resultado del campo. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_NodeType](./get_nodetype/)() const override | Devuelve [FieldSeparator](../../aspose.words/nodetype/). |
