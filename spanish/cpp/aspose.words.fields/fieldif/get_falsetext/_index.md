---
title: "Aspose::Words::Fields::FieldIf::get_FalseText método"
linktitle: "get_FalseText"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldIf::get_FalseText método. Obtiene o establece el texto que se muestra si la expresión de comparación es falsa en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.fields/fieldif/get_falsetext/
---
## FieldIf::get_FalseText method


Obtiene o establece el texto mostrado si la expresión de comparación es **false**.
