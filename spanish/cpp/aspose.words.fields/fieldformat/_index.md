---
title: "Aspose::Words::Fields::FieldFormat clase"
linktitle: "FieldFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldFormat clase. Proporciona acceso tipado al formato numérico, de fecha y hora, y general del campo''. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 45000
url: /es/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Proporciona acceso tipado a los formatos numéricos, de fecha y hora, y generales del campo. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Obtiene o establece un formato que se aplica al resultado de un campo de fecha y hora. Corresponde al interruptor \@. |
| [get_GeneralFormats](./get_generalformats/)() | Obtiene una colección de formatos generales que se aplican a un resultado numérico, de texto o de cualquier campo. Corresponde a los interruptores \*. |
| [get_NumericFormat](./get_numericformat/)() | Obtiene o establece un formato que se aplica al resultado de un campo numérico. Corresponde al interruptor \#. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Método set para [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Método set para [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
