---
title: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat método"
linktitle: "get_DateTimeFormat"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat método. Obtiene o establece un formato que se aplica al resultado de un campo de fecha y hora. Corresponde al interruptor \\@ en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fieldformat/get_datetimeformat/
---
## FieldFormat::get_DateTimeFormat method


Obtiene o establece un formato que se aplica al resultado de un campo de fecha y hora. Corresponde al interruptor \@.
