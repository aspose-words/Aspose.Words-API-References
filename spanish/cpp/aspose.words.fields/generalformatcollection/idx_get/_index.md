---
title: "Aspose::Words::Fields::GeneralFormatCollection::idx_get método"
linktitle: "idx_get"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::GeneralFormatCollection::idx_get método. Obtiene un formato general en el índice especificado en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.fields/generalformatcollection/idx_get/
---
## GeneralFormatCollection::idx_get method


Obtiene un formato general en el índice especificado.
...
| --- | --- | --- |
| index | int32_t | El índice de un formato general. |
