---
title: "Clase Aspose::Words::Fields::GeneralFormatCollection"
linktitle: "GeneralFormatCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::GeneralFormatCollection. Representa una colección tipada de formatos generales. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 114000
url: /es/cpp/aspose.words.fields/generalformatcollection/
---
## GeneralFormatCollection class


Representa una colección tipada de formatos generales. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [Add](./add/)(Aspose::Words::Fields::GeneralFormat) | Agrega un formato general a la colección. |
| [get_Count](./get_count/)() | Obtiene el número total de elementos en la colección. |
| [GetEnumerator](./getenumerator/)() override | Devuelve un objeto enumerador. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtiene un formato general en el índice especificado. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)(Aspose::Words::Fields::GeneralFormat) | Elimina todas las apariciones del formato general especificado de la colección. |
| [RemoveAt](./removeat/)(int32_t) | Elimina una aparición de formato general en el índice especificado. |
| static [Type](./type/)() |  |
