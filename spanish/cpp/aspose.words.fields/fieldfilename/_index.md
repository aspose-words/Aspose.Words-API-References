---
title: "Clase Aspose::Words::Fields::FieldFileName"
linktitle: "FieldFileName"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldFileName. Implementa el campo FILENAME. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 41000
url: /es/cpp/aspose.words.fields/fieldfilename/
---
## FieldFileName class


Implementa el campo FILENAME. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_IncludeFullPath](./get_includefullpath/)() | Obtiene o establece si se debe incluir el nombre completo de la ruta del archivo. |
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | Método setter para [Aspose::Words::Fields::FieldFileName::get_IncludeFullPath](./get_includefullpath/). |
...
En la implementación actual, utiliza la propiedad [OriginalFileName](../../aspose.words/document/get_originalfilename/) para recuperar el nombre del archivo. Si el documento se cargó desde un flujo o se creó en blanco, utiliza el nombre del archivo al que se está guardando (si se conoce).
