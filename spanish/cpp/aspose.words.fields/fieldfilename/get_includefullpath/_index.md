---
title: "Método Aspose::Words::Fields::FieldFileName::get_IncludeFullPath"
linktitle: "get_IncludeFullPath"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Fields::FieldFileName::get_IncludeFullPath. Obtiene o establece si se debe incluir la ruta completa del archivo en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fieldfilename/get_includefullpath/
---
...
Muestra cómo usar [FieldOptions](../../fieldoptions/) para sobrescribir el valor predeterminado del campo FILENAME.
```cpp
