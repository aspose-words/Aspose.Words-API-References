...
description: "Aspose::Words::Fields::FieldMergeSeq class. Implementa el campo MERGESEQ. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 69000
url: /es/cpp/aspose.words.fields/fieldmergeseq/
---
## FieldMergeSeq class


Implementa el campo MERGESEQ. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
