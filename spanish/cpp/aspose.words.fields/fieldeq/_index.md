---
title: "Clase Aspose::Words::Fields::FieldEQ"
linktitle: "FieldEQ"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldEQ. Implementa el campo EQ. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 40000
url: /es/cpp/aspose.words.fields/fieldeq/
---
## FieldEQ class


Implementa el campo EQ. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [AsOfficeMath](./asofficemath/)() | Devuelve el objeto Office [Math](../../aspose.words.math/) correspondiente al campo EQ. |
