---
title: "Método Aspose::Words::Fields::FieldSeq::get_ResetNumber"
linktitle: "get_ResetNumber"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Fields::FieldSeq::get_ResetNumber. Obtiene o establece un número entero al que restablecer el número de secuencia. Devuelve -1 si el número está ausente en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.fields/fieldseq/get_resetnumber/
---
## FieldSeq::get_ResetNumber method


Obtiene o establece un número entero al que restablecer el número de secuencia. Devuelve -1 si el número está ausente.
