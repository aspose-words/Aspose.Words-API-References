---
title: "Aspose::Words::Fields::FieldGreetingLine clase"
linktitle: "FieldGreetingLine"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldGreetingLine clase. Implementa el campo GREETINGLINE. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 52000
url: /es/cpp/aspose.words.fields/fieldgreetingline/
---
## FieldGreetingLine class


Implementa el campo GREETINGLINE. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_AlternateText](./get_alternatetext/)() | Obtiene el texto a incluir en el campo si el nombre está vacío. |
...
| [get_LanguageId](./get_languageid/)() | Obtiene el identificador de idioma utilizado para formatear el nombre. |
| [get_LocaleId](../field/get_localeid/)() | Obtiene o establece el LCID del campo. |
| [get_NameFormat](./get_nameformat/)() | Obtiene el formato del nombre incluido en el campo. |
...
| [set_AlternateText](./set_alternatetext/)(const System::String\&) | Establece el texto a incluir en el campo si el nombre está vacío. |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | Establece el identificador de idioma utilizado para formatear el nombre. |
| [set_LocaleId](../field/set_localeid/)(int32_t) | Método set para [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/). |
| [set_NameFormat](./set_nameformat/)(const System::String\&) | Establece el formato del nombre incluido en el campo. |
