---
title: "Aspose::Words::Fields::FieldArgumentBuilder clase"
linktitle: "FieldArgumentBuilder"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldArgumentBuilder clase. Construye un argumento de campo complejo que consiste en campos, nodos y texto plano. Para obtener más información, visita el artículo de documentación en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


Construye un argumento de campo complejo que consiste en campos, nodos y texto sin formato. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Agrega un campo representado por un [FieldBuilder](../fieldbuilder/) al argumento. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Agrega un nodo al argumento. |
| [AddText](./addtext/)(const System::String\&) | Agrega un texto plano al argumento. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | Inicializa una instancia de la clase [FieldArgumentBuilder](./). |
