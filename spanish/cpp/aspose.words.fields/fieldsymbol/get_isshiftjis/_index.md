---
title: "Aspose::Words::Fields::FieldSymbol::get_IsShiftJis método"
linktitle: "get_IsShiftJis"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldSymbol::get_IsShiftJis método. Obtiene o establece si el código de carácter se interpreta como el valor de un carácter SHIFT-JIS en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.fields/fieldsymbol/get_isshiftjis/
---
## FieldSymbol::get_IsShiftJis method


Obtiene o establece si el código de carácter se interpreta como el valor de un carácter SHIFT-JIS.
