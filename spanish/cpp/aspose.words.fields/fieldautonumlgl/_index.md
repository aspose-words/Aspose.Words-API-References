---
title: "Aspose::Words::Fields::FieldAutoNumLgl clase"
linktitle: "FieldAutoNumLgl"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAutoNumLgl clase. Implementa el campo AUTONUMLGL. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 13000
url: /es/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Implementa el campo AUTONUMLGL. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Obtiene si se debe mostrar el número sin un punto final. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Obtiene el carácter separador que se utilizará. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Establece si se debe mostrar el número sin un punto final. |
| [set_Result](../field/set_result/)(const System::String\&) | Método set para [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Establece el carácter separador que se utilizará. |
| static [Type](./type/)() |  |
