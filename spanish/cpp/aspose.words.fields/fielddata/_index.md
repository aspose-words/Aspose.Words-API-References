---
title: "Aspose::Words::Fields::FieldData clase"
linktitle: "FieldData"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldData clase. Implementa el campo DATA. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 27000
url: /es/cpp/aspose.words.fields/fielddata/
---
## FieldData class


Implementa el campo DATA. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
Muestra cómo insertar un campo DATA en un documento.
```cpp
