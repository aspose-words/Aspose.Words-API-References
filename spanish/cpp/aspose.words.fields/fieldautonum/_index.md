---
title: "Aspose::Words::Fields::FieldAutoNum clase"
linktitle: "FieldAutoNum"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAutoNum clase. Implementa el campo AUTONUM. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 12000
url: /es/cpp/aspose.words.fields/fieldautonum/
---
## FieldAutoNum class


Implementa el campo AUTONUM. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Obtiene o establece el carácter separador que se utilizará. |
...
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Método setter de [Aspose::Words::Fields::FieldAutoNum::get_SeparatorCharacter](./get_separatorcharacter/). |
| static [Type](./type/)() |  |
