---
title: "Aspose::Words::Fields::FieldAdvance::get_RightOffset método"
linktitle: "get_RightOffset"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAdvance::get_RightOffset método. Obtiene o establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la derecha en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.fields/fieldadvance/get_rightoffset/
---
## FieldAdvance::get_RightOffset method


Obtiene o establece el número de puntos por los que el texto que sigue al campo debe moverse a la derecha.
