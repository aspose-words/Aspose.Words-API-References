---
title: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset método"
linktitle: "get_LeftOffset"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset método. Obtiene o establece el número de puntos por los que el texto que sigue al campo debe desplazarse a la izquierda en C++."
type: docs
weight: 4000
url: /es/cpp/aspose.words.fields/fieldadvance/get_leftoffset/
---
## FieldAdvance::get_LeftOffset method


Obtiene o establece el número de puntos por los que el texto que sigue al campo debe moverse a la izquierda.
