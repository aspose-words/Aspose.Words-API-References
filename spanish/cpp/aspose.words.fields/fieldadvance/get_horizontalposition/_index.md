---
title: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition método"
linktitle: "get_HorizontalPosition"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition método. Obtiene o establece el número de puntos por los que el texto que sigue al campo debe desplazarse horizontalmente desde el borde izquierdo de la columna, el marco o el cuadro de texto en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.fields/fieldadvance/get_horizontalposition/
---
## FieldAdvance::get_HorizontalPosition method


Obtiene o establece el número de puntos por los que el texto que sigue al campo debe moverse horizontalmente desde el borde izquierdo de la columna, marco o cuadro de texto.
