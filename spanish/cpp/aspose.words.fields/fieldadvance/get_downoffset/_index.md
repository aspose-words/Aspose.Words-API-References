---
title: "Aspose::Words::Fields::FieldAdvance::get_DownOffset método"
linktitle: "get_DownOffset"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldAdvance::get_DownOffset método. Obtiene o establece el número de puntos por los que el texto que sigue al campo debe desplazarse hacia abajo en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.fields/fieldadvance/get_downoffset/
---
## FieldAdvance::get_DownOffset method


Obtiene o establece el número de puntos por los que el texto que sigue al campo debe moverse hacia abajo.
