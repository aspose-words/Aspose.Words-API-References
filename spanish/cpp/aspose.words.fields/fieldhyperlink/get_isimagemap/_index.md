---
title: "Método Aspose::Words::Fields::FieldHyperlink::get_IsImageMap"
linktitle: "get_IsImageMap"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método Aspose::Words::Fields::FieldHyperlink::get_IsImageMap. Obtiene o establece si se deben agregar coordenadas al hipervínculo para un mapa de imagen del lado del servidor en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.fields/fieldhyperlink/get_isimagemap/
---
## FieldHyperlink::get_IsImageMap method


Obtiene o establece si se deben agregar coordenadas al hipervínculo para un mapa de imágenes del lado del servidor.
