...
description: "Aspose::Words::Fields::FieldAutoText class. Implementa el campo AUTOTEXT. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 15000
url: /es/cpp/aspose.words.fields/fieldautotext/
---
## FieldAutoText class


Implementa el campo AUTOTEXT. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_EntryName](./get_entryname/)() override | Obtiene o establece el nombre de la entrada AutoText. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Método set para [Aspose::Words::Fields::FieldAutoText::get_EntryName](./get_entryname/). |
