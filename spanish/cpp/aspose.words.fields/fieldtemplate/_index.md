---
title: "Aspose::Words::Fields::FieldTemplate clase"
linktitle: "FieldTemplate"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldTemplate clase. Implementa el campo TEMPLATE. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 101000
url: /es/cpp/aspose.words.fields/fieldtemplate/
---
## FieldTemplate class


Implementa el campo TEMPLATE. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [set_IncludeFullPath](./set_includefullpath/)(bool) | Método set para [Aspose::Words::Fields::FieldTemplate::get_IncludeFullPath](./get_includefullpath/). |
