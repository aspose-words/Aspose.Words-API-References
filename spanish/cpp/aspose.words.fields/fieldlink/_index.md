---
title: "Clase Aspose::Words::Fields::FieldLink"
linktitle: "FieldLink"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Fields::FieldLink. Implementa el campo LINK. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 63000
url: /es/cpp/aspose.words.fields/fieldlink/
---
## FieldLink class


Implementa el campo LINK. Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| Método | Descripción |
| --- | --- |
| [get_AutoUpdate](./get_autoupdate/)() | Obtiene si se debe actualizar este campo automáticamente. |
...
| [get_FormatUpdateType](./get_formatupdatetype/)() | Obtiene la forma en que el objeto vinculado actualiza su formato. |
...
| [set_AutoUpdate](./set_autoupdate/)(bool) | Establece si se debe actualizar este campo automáticamente. |
| [set_FormatUpdateType](./set_formatupdatetype/)(const System::String\&) | Establece la forma en que el objeto vinculado actualiza su formato. |
