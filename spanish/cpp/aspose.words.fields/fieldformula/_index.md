---
title: "Aspose::Words::Fields::FieldFormula clase"
linktitle: "FieldFormula"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Fields::FieldFormula clase. Implementa el campo = (fórmula). Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 49000
url: /es/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


Implementa el campo = (fórmula). Para obtener más información, visite el artículo de documentación [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
// Utilice un generador de campos para construir una ecuación matemática,
// luego cree un campo de fórmula para mostrar el resultado de la ecuación en el documento.
