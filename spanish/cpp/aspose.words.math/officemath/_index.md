...
description: "Aspose::Words::Math::OfficeMath class. Representa un objeto Office Math como una función, ecuación, matriz o similar. Puede contener elementos secundarios, incluidos fragmentos de texto matemático, marcadores, comentarios, otras instancias de OfficeMath y algunos otros nodos. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 1000
url: /es/cpp/aspose.words.math/officemath/
---
## OfficeMath class


Representa un objeto Office [Math](../) como una función, ecuación, matriz o similar. Puede contener elementos secundarios, incluidos fragmentos de texto matemático, marcadores, comentarios, otras instancias de [OfficeMath](./) y algunos otros nodos. Para obtener más información, visite el artículo de documentación [Working with OfficeMath](https://docs.aspose.com/words/cpp/working-with-officemath/).
...
| [AcceptEnd](./acceptend/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Acepta un visitante para visitar el final del Office Math. |
| [AcceptStart](./acceptstart/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Acepta un visitante para visitar el inicio del Office Math. |
...
| [get_DisplayType](./get_displaytype/)() | Obtiene/establece el tipo de formato de visualización de Office [Math](../) que representa si una ecuación se muestra en línea con el texto o en una línea propia. |
...
| [get_Justification](./get_justification/)() | Obtiene/establece la justificación de Office [Math](../). |
| [get_LastChild](../../aspose.words/compositenode/get_lastchild/)() const | Obtiene el último hijo del nodo. |
| [get_MathObjectType](./get_mathobjecttype/)() const | Obtiene el tipo [MathObjectType](./get_mathobjecttype/) de este objeto Office [Math](../). |
| [get_NextNode](../../aspose.words/node/get_nextnode/)() const |  |
| [get_NextSibling](../../aspose.words/node/get_nextsibling/)() | Obtiene el nodo que sigue inmediatamente a este nodo. |
| [get_NodeType](./get_nodetype/)() const override | Devuelve [OfficeMath](../../aspose.words/nodetype/). |
| [get_ParentNode](../../aspose.words/node/get_parentnode/)() | Obtiene el padre inmediato de este nodo. |
| [get_ParentParagraph](./get_parentparagraph/)() | Recupera el [Paragraph](../../aspose.words/paragraph/) padre de este nodo. |
...
| [GetMathRenderer](./getmathrenderer/)() | Crea y devuelve un objeto que puede usarse para renderizar esta ecuación en una imagen. |
...
| [set_DisplayType](./set_displaytype/)(Aspose::Words::Math::OfficeMathDisplayType) | Establecedor de [Aspose::Words::Math::OfficeMath::get_DisplayType](./get_displaytype/). |
| [set_Justification](./set_justification/)(Aspose::Words::Math::OfficeMathJustification) | Establecedor de [Aspose::Words::Math::OfficeMath::get_Justification](./get_justification/). |
...
En esta versión de Aspose.Words, los nodos [OfficeMath](./) no proporcionan métodos y propiedades públicas para crear o modificar un objeto [OfficeMath](./). En esta versión no puedes instanciar nodos [Math](../) ni modificar los existentes, excepto eliminarlos.
