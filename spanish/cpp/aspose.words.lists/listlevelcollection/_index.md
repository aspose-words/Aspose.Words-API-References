---
title: "Clase Aspose::Words::Lists::ListLevelCollection"
linktitle: "ListLevelCollection"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Clase Aspose::Words::Lists::ListLevelCollection. Una colección de formatos de lista para cada nivel en una lista. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.lists/listlevelcollection/
---
## ListLevelCollection class


Una colección de formatos de lista para cada nivel en una lista. Para obtener más información, visite el artículo de documentación [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/).
...
| [end](./end/)() |  |
| [end](./end/)() const |  |
| [get_Count](./get_count/)() | Obtiene el número de niveles en esta lista. |
| [GetEnumerator](./getenumerator/)() override | Obtiene el objeto enumerador que enumerará los niveles en esta lista. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Obtiene un nivel de lista por índice. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Lists::ListLevel\>\&) | Obtiene un nivel de lista por índice. |
