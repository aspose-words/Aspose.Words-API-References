---
title: "Aspose::Words::Lists::ListFormat::ListIndent método"
linktitle: "ListIndent"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::ListFormat::ListIndent método. Incrementa el nivel de lista del párrafo actual en un nivel en C++."
type: docs
weight: 10000
url: /es/cpp/aspose.words.lists/listformat/listindent/
---
## ListFormat::ListIndent method


Incrementa el nivel de lista del párrafo actual en un nivel.
...
Este método cambia el nivel de lista y aplica las propiedades de formato del nuevo nivel.

En documentos de Word, las listas pueden constar de hasta nueve niveles. El formato [List](../../list/) para cada nivel especifica qué viñeta o número se usa, la sangría izquierda, el espacio entre la viñeta y el texto, etc.
