---
title: "Método ApplyBulletDefault de Aspose::Words::Lists::ListFormat"
linktitle: "ApplyBulletDefault"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Método ApplyBulletDefault de Aspose::Words::Lists::ListFormat. Inicia una nueva lista con viñetas predeterminada y la aplica al párrafo en C++."
type: docs
weight: 2000
url: /es/cpp/aspose.words.lists/listformat/applybulletdefault/
---
## ListFormat::ApplyBulletDefault method


Inicia una nueva lista con viñetas predeterminada y la aplica al párrafo.
...
Este es un método abreviado que crea una nueva lista usando la plantilla de viñetas predeterminada, la aplica al párrafo y selecciona el primer nivel de lista.
