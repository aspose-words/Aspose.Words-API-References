---
title: "Aspose::Words::Lists::ListFormat::get_ListLevelNumber método"
linktitle: "get_ListLevelNumber"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::ListFormat::get_ListLevelNumber método. Obtiene o establece el número de nivel de lista (0 a 8) para el párrafo en C++."
type: docs
weight: 7000
url: /es/cpp/aspose.words.lists/listformat/get_listlevelnumber/
---
...
Tiene efecto solo cuando la propiedad [List](../get_list/) está configurada para referenciar una lista válida.
