---
title: "Aspose::Words::Lists::ListFormat::get_ListLevel método"
linktitle: "get_ListLevel"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::ListFormat::get_ListLevel método. Devuelve el formato del nivel de lista más cualquier anulación de formato aplicada al párrafo actual en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.lists/listformat/get_listlevel/
---
## ListFormat::get_ListLevel method


Devuelve el formato del nivel de lista más cualquier anulación de formato aplicada al párrafo actual.
