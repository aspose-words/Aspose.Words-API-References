---
title: "Aspose::Words::Lists::List::get_IsListStyleReference método"
linktitle: "get_IsListStyleReference"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::List::get_IsListStyleReference método. Devuelve true si esta lista es una referencia a un estilo de lista en C++."
type: docs
weight: 6000
url: /es/cpp/aspose.words.lists/list/get_isliststylereference/
---
## List::get_IsListStyleReference method


Devuelve **true** si esta lista es una referencia a un estilo de lista.
...
Nota, modificar las propiedades de una lista que es una referencia al estilo de lista no tiene efecto. El formato de lista especificado en el propio estilo de lista siempre tiene prioridad.
