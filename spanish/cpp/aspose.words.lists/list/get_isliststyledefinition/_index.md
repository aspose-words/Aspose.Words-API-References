---
title: "Aspose::Words::Lists::List::get_IsListStyleDefinition método"
linktitle: "get_IsListStyleDefinition"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition método. Devuelve true si esta lista es una definición de un estilo de lista en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
## List::get_IsListStyleDefinition method


Devuelve **true** si esta lista es una definición de un estilo de lista.
...
Cuando esta propiedad es **true**, la propiedad [Style](../get_style/) devuelve el estilo de lista que define esta lista.

Al modificar las propiedades de una lista que define un estilo de lista, modificas las propiedades del estilo de lista.

Una lista que es una definición de un estilo de lista no puede aplicarse directamente a los párrafos para numerarlos.
