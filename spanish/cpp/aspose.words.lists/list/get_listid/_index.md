---
title: "Aspose::Words::Lists::List::get_ListId método"
linktitle: "get_ListId"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::List::get_ListId método. Obtiene el identificador único de la lista en C++."
type: docs
weight: 9000
url: /es/cpp/aspose.words.lists/list/get_listid/
---
...
Normalmente no necesita usar esta propiedad. Pero si la usa, normalmente lo hace en conjunto con el método [GetListByListId()](../../listcollection/getlistbylistid/) para encontrar una lista por su identificador.
