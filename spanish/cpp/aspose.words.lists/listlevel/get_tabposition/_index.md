---
title: "Aspose::Words::Lists::ListLevel::get_TabPosition método"
linktitle: "get_TabPosition"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::ListLevel::get_TabPosition método. Devuelve o establece la posición de tabulación (en puntos) para el nivel de lista en C++."
type: docs
weight: 17000
url: /es/cpp/aspose.words.lists/listlevel/get_tabposition/
---
## ListLevel::get_TabPosition method


Devuelve o establece la posición de tabulación (en puntos) para el nivel de lista.
...
Tiene efecto solo cuando [TrailingCharacter](../get_trailingcharacter/) es una tabulación.
