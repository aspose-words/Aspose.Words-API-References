---
title: "Aspose::Words::Lists::ListLevel::get_TrailingCharacter método"
linktitle: "get_TrailingCharacter"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Aspose::Words::Lists::ListLevel::get_TrailingCharacter método. Devuelve o establece el carácter insertado después del número para el nivel de lista en C++."
type: docs
weight: 19000
url: /es/cpp/aspose.words.lists/listlevel/get_trailingcharacter/
---
## ListLevel::get_TrailingCharacter method


Devuelve o establece el carácter insertado después del número para el nivel de lista.
