...
description: "Aspose::Words::Themes::Theme class. Representa el Tema del documento y proporciona acceso a las partes principales del tema, incluyendo MajorFonts, MinorFonts y Colors. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 1000
url: /es/cpp/aspose.words.themes/theme/
---
## Theme class


Representa el documento [Theme](./) y proporciona acceso a las partes principales del tema, incluyendo [MajorFonts](./get_majorfonts/), [MinorFonts](./get_minorfonts/) y [Colors](./get_colors/). Para obtener más información, visite el artículo de documentación [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Método | Descripción |
| --- | --- |
| [get_Colors](./get_colors/)() const | Permite especificar el conjunto de colores del tema para el documento. |
| [get_MajorFonts](./get_majorfonts/)() const | Permite especificar el conjunto de fuentes principales para diferentes idiomas. |
| [get_MinorFonts](./get_minorfonts/)() const | Permite especificar el conjunto de fuentes secundarias para diferentes idiomas. |
