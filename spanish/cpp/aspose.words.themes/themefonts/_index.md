...
description: "Aspose::Words::Themes::ThemeFonts class. Representa una colección de fuentes en el esquema de fuentes, permitiendo especificar diferentes fuentes para distintos idiomas Latin, EastAsian y ComplexScript. Para obtener más información, visite el artículo de documentación en C++."
type: docs
weight: 3000
url: /es/cpp/aspose.words.themes/themefonts/
---
## ThemeFonts class


Representa una colección de fuentes en el esquema de fuentes, permitiendo especificar diferentes fuentes para distintos idiomas [Latin](./get_latin/), [EastAsian](./get_eastasian/) y [ComplexScript](./get_complexscript/). Para obtener más información, visite el artículo de documentación [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/).
...
| Método | Descripción |
| --- | --- |
| [get_ComplexScript](./get_complexscript/)() | Especifica el nombre de la fuente para caracteres ComplexScript. |
| [get_EastAsian](./get_eastasian/)() | Especifica el nombre de la fuente para caracteres EastAsian. |
| [get_Latin](./get_latin/)() | Especifica el nombre de la fuente para caracteres Latin. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_ComplexScript](./set_complexscript/)(const System::String\&) | Setter para [Aspose::Words::Themes::ThemeFonts::get_ComplexScript](./get_complexscript/). |
| [set_EastAsian](./set_eastasian/)(const System::String\&) | Setter para [Aspose::Words::Themes::ThemeFonts::get_EastAsian](./get_eastasian/). |
| [set_Latin](./set_latin/)(const System::String\&) | Setter para [Aspose::Words::Themes::ThemeFonts::get_Latin](./get_latin/). |
| static [Type](./type/)() |  |
