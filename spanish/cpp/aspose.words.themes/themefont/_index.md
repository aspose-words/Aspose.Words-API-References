---
title: "Enumeración Aspose::Words::Themes::ThemeFont"
linktitle: "ThemeFont"
second_title: "Referencia de API de Aspose.Words para C++"
description: "Enumeración Aspose::Words::Themes::ThemeFont. Especifica los tipos de nombres de fuentes de tema para los temas de documentos en C++."
type: docs
weight: 5000
url: /es/cpp/aspose.words.themes/themefont/
---
## ThemeFont enum


Especifica los tipos de nombres de fuentes de tema para los temas de documentos.
...
| Mayor | 1 | Fuente de tema mayor. |
| Menor | 2 | Fuente de tema menor. |
