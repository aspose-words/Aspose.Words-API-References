...
description: BorderCollection Left özelliğini keşfedin, gelişmiş tasarım esnekliği ve görsel çekicilik için sol kenarlığa zahmetsizce erişin ve özelleştirin.
type: docs
weight: 70
