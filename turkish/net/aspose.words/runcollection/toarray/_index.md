...
description: RunCollection'ınızı ToArray metoduyla zahmetsizce bir diziye dönüştürerek sorunsuz veri yönetimi ve gelişmiş performans sağlayın.
type: docs
weight: 20
...
Koleksiyondaki tüm çalıştırmaları yeni bir çalıştırma dizisine kopyalar.
