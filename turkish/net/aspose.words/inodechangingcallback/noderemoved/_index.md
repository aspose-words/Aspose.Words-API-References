...
description: Bir belge düğümü kaldırıldığında tetiklenen INodeChangingCallback NodeRemoved yöntemini keşfedin; kodlama verimliliğinizi ve belge yönetiminizi artırın.
type: docs
weight: 30
url: /tr/net/aspose.words/inodechangingcallback/noderemoved/
---
## INodeChangingCallback.NodeRemoved method

Bu belgeye ait bir düğüm üst düğümünden kaldırıldığında çağrılır.
