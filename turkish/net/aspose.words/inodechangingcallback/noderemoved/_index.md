...
description: INodeChangingCallback NodeRemoved yöntem. Bu belgeye ait bir düğüm üst öğesinden kaldırıldığında çağrılır C#'da.
type: docs
weight: 30
...
Bu belgeye ait bir düğüm üst öğesinden kaldırıldığında çağrılır.
