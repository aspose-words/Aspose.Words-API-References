...
description: PageSetup mülk. Bir bölümün ilk sayfası dışında tümü için kullanılacak kağıt tepsisini bölme alır veya ayarlar. Değer uygulamaya yazıcıya özeldir.
type: docs
weight: 290
...
Bir bölümün ilk sayfası dışında tümü için kullanılacak kağıt tepsisini (bölme) alır veya ayarlar. Değer uygulamaya (yazıcıya) özeldir.
