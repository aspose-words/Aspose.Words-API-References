...
description: Belgenizin tasarımını ve görsel çekiciliğini geliştirmek için Tema nesnesini zahmetsizce almak üzere Belge Teması özelliğine erişin.
type: docs
weight: 440
...
Şunu alır:`Theme` bu belge için nesne.
