...
description: Document mülk. İade doğru belgede izlenen değişiklikler varsa.
type: docs
weight: 200
...
İade **doğru** belgede izlenen değişiklikler varsa.
...
Bu özellik, karşılaştırma yapmak için bir kısayoldur[`Count`](../../revisioncollection/count/)sıfıra.
