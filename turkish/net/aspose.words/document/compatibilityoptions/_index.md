...
description: Kullanıcı tercihlerini özelleştirmek ve kusursuz işbirliği için özel ayarlarla düzenleme deneyiminizi geliştirmek amacıyla Word'ün Belge Uyumluluk Seçeneklerine erişin.
type: docs
weight: 60
...
Belge uyumluluk seçeneklerine erişim sağlar (yani, belgeye girilen kullanıcı tercihleri)**Uyumluluk** sekmesi**Seçenekler**Word'de iletişim kutusu).
