...
description: Özel XML Veri Depolama Parçalarını verimli bir şekilde yönetmek için Belge CustomXmlParts özelliğini keşfedin. Belgenizin işlevselliğini bugün geliştirin!
type: docs
weight: 90
...
Özel XML Veri Depolama Parçaları koleksiyonunu alır veya ayarlar.
