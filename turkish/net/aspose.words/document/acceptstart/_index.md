...
description: AcceptStart yöntemini keşfedin, gelişmiş bir kullanıcı deneyimi ve daha akıcı bir gezinme için belgenizin başına gelen ziyaretçileri sorunsuz bir şekilde karşılayın.
type: docs
weight: 560
url: /tr/net/aspose.words/document/acceptstart/
---
## Document.AcceptStart method

Belgenin başlangıcını ziyaret eden bir ziyaretçiyi kabul eder.
