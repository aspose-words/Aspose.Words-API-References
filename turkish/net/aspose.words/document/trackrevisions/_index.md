...
description: Document mülk. Doğru bu belge Microsoft Wordde düzenlendiğinde değişiklikler izleniyorsa.
type: docs
weight: 410
...
**Doğru** bu belge Microsoft Word'de düzenlendiğinde değişiklikler izleniyorsa.
...
Bu seçeneğin ayarlanması, yalnızca Microsoft Word'e, change yolunun açık mı yoksa kapalı mı olduğu konusunda talimat verir. Bu özelliğin, Aspose.Words aracılığıyla programlı olarak yaptığınız belgede yaptığınız değişiklikler üzerinde hiçbir etkisi yoktur.

Bu belgede Aspose.Words tarafından programlı olarak yapıldığından değişiklikleri otomatik olarak izlemek istiyorsanız,[`StartTrackRevisions`](../starttrackrevisions/) yöntem.
