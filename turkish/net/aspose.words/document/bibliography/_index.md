...
description: Araştırmanızı ve atıf doğruluğunuzu artırmak için kapsamlı bir kaynak listesi almak üzere Belge Kaynakçası özelliğine erişin.
type: docs
weight: 40
url: /tr/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Şunu alır:`Bibliography`belgede mevcut kaynakların listesini temsil eden nesne.
