...
description: Bu belgeyi düzenleme ve biçim revizyonlarının sayısı olarak değişiklik üreten başka bir belgeyle karşılaştırırRevisionaspose.words/revision .
type: docs
weight: 540
