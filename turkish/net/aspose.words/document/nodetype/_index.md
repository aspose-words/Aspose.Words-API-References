...
description: Temel belge ayrıntılarını açığa çıkarmak ve veri yönetiminizi geliştirmek için Document NodeType özelliğini keşfedin. Avantajlarını bugün keşfedin!
type: docs
weight: 290
url: /tr/net/aspose.words/document/nodetype/
---
## Document.NodeType property

Geri DöndürürDocument .
