...
description: TabStopCollection After yöntem. Belirtilen konumun sağındaki ilk sekme durağını alır C#'da.
type: docs
weight: 40
...
Belirtilen konumun sağındaki ilk sekme durağını alır.
