...
description: Ziyaretçi katılımını artırmak ve web sitenizdeki etkileşimleri kolaylaştırmak için SpecialChar Accept yöntemini keşfedin. Kullanıcı memnuniyetini bugün artırın!
type: docs
weight: 20
...
Çağrılar[`VisitSpecialChar`](../../documentvisitor/visitspecialchar/).
