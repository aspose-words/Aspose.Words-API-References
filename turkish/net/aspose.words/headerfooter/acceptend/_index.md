...
description: Ziyaretçi etkileşimlerini başlığın sonunda sorunsuz bir şekilde yönetmek için tasarlanmış HeaderFooter AcceptEnd yöntemi ile web sitenizin kullanıcı deneyimini geliştirin.
type: docs
weight: 80
url: /tr/net/aspose.words/headerfooter/acceptend/
---
## HeaderFooter.AcceptEnd method

Başlığın sonunu ziyaret eden bir ziyaretçiyi kabul eder.
