...
description: Aspose.Words.HeaderFooter sınıf. Bir bölümün üstbilgi veya altbilgi metni için kapsayıcıyı temsil eder C#'da.
type: docs
weight: 3100
...
| İsim | Tanım |
| --- | --- |
| [HeaderFooter](headerfooter/)(*[DocumentBase](../documentbase/), [HeaderFooterType](../headerfootertype/)*) | Belirtilen türde yeni bir üst bilgi veya alt bilgi oluşturur. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words/headerfooter/accept/)(*[DocumentVisitor](../documentvisitor/)*) | Ziyaretçi kabul eder. |
