...
description: Ziyaretçi katılımını artırmak ve etkileşimleri kolaylaştırmak için Bölüm Kabul yöntemini keşfedin. Sitenizin performansını bugün artırın!
type: docs
weight: 70
...
Çağrılar[`VisitSectionStart`](../../documentvisitor/visitsectionstart/) , sonra arar[`Accept`](../../node/accept/) section ve çağrıların tüm alt düğümleri için[`VisitSectionEnd`](../../documentvisitor/visitsectionend/) sonunda.
