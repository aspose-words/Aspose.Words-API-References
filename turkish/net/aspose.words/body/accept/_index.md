...
description: Body yöntem. Bir ziyaretçiyi kabul eder.
type: docs
weight: 40
...
DocumentVisitor.VisitBodyStart'ı çağırır, ardından bölüm 'nin tüm alt düğümleri için Kabul Et'i çağırır ve sonunda DocumentVisitor.VisitBodyEnd'i çağırır.
