...
description: Yapı bloğu numaralandırmasını başlatmak için gerekli olan DocumentVisitor VisitBuildingBlockStart yöntemini keşfedin. Kodlama verimliliğinizi bugün artırın!
type: docs
weight: 70
...
Bir yapı bloğunun numaralandırılması başladığında çağrılır.
