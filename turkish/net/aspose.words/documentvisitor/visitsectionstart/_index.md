...
description: Bölüm numaralandırmasını izlemek için gerekli olan DocumentVisitor VisitSectionStart yöntemini keşfedin. Bu güçlü araçla kodlama verimliliğinizi artırın!
type: docs
weight: 380
url: /tr/net/aspose.words/documentvisitor/visitsectionstart/
---
## DocumentVisitor.VisitSectionStart method

Bir bölümün numaralandırılması başladığında çağrılır.
