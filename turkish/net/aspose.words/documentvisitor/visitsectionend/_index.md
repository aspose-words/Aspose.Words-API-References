...
description: Uygulamalarınızda bölüm numaralandırmasını yönetmek için önemli olan DocumentVisitor VisitSectionEnd metodunu keşfedin. Kodlama verimliliğinizi bugün artırın!
type: docs
weight: 370
url: /tr/net/aspose.words/documentvisitor/visitsectionend/
---
## DocumentVisitor.VisitSectionEnd method

Bir bölümün numaralandırılması sona erdiğinde çağrılır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| section | Section | Ziyaret edilen nesne. |
