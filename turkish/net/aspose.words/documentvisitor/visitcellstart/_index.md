...
description: Tablo hücre numaralandırmasını etkili bir şekilde yönetmek için gerekli olan DocumentVisitor'daki VisitCellStart yöntemini keşfedin. Kodlama becerilerinizi bugün geliştirin!
type: docs
weight: 90
...
Bir tablo hücresinin numaralandırılması başladığında çağrılır.
