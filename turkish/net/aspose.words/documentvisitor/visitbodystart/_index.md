...
description: Bölümlerinizdeki ana metin hikayelerini verimli bir şekilde numaralandırmak için gerekli olan DocumentVisitor VisitBodyStart yöntemini keşfedin. Kodlama iş akışınızı bugün geliştirin!
type: docs
weight: 30
...
Bir bölümdeki ana metin hikayesinin numaralandırılması başladığında çağrılır.
