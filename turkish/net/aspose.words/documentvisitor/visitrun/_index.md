...
description: DocumentVisitor yöntem. içinde bir metin akışıyla karşılaşıldığında çağrılır.
type: docs
weight: 360
...
içinde bir metin akışıyla karşılaşıldığında çağrılır.
