...
description: Uygulamalarınızda Yapılandırılmış Belge Etiketlerini etkili bir şekilde işlemek için gerekli olan DocumentVisitor VisitStructuredDocumentTagRangeStart metodunu keşfedin.
type: docs
weight: 460
...
StructuredDocumentTagRangeStart ile karşılaşıldığında çağrılır.
