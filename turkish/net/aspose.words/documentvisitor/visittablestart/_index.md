...
description: Uygulamalarınızda tablo numaralandırmasını etkin bir şekilde yönetmek için gerekli olan DocumentVisitor VisitTableStart metodunu keşfedin. Kodlama becerilerinizi bugün geliştirin!
type: docs
weight: 500
...
Bir tablonun numaralandırılması başladığında çağrılır.
