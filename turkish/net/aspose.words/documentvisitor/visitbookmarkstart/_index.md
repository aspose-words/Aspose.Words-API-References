...
description: DocumentVisitor yöntem. Belgede bir yer işareti başlangıcı ile karşılaşıldığında çağrılır.
type: docs
weight: 50
...
Belgede bir yer işareti başlangıcı ile karşılaşıldığında çağrılır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| bookmarkStart | BookmarkStart | Ziyaret edilen nesne. |
