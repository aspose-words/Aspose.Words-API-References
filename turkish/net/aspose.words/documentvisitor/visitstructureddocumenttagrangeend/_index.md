...
description: Uygulamalarınızda Yapılandırılmış Belge Etiketlerini etkili bir şekilde işlemek için gerekli olan DocumentVisitor VisitStructuredDocumentTagRangeEnd metodunu keşfedin.
type: docs
weight: 450
...
StructuredDocumentTagRangeEnd ile karşılaşıldığında çağrılır.
