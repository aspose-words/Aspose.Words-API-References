...
description: Bölümlerdeki başlık ve altbilgi numaralandırmasını izlemek için gerekli olan DocumentVisitor VisitHeaderFooterStart yöntemini keşfedin. Belge yönetiminizi geliştirin!
type: docs
weight: 290
url: /tr/net/aspose.words/documentvisitor/visitheaderfooterstart/
---
## DocumentVisitor.VisitHeaderFooterStart method

Bir bölümdeki üstbilgi veya altbilginin numaralandırılması başladığında çağrılır.
