...
description: DocumentVisitor'daki VisitGlossaryDocumentEnd yöntemini keşfedin. Verimli veri yönetimi için sözlük belge numaralandırmasını nasıl geliştirdiğini öğrenin.
type: docs
weight: 240
...
Not: Bir sözlük belge düğümü ve onun alt düğümleri, bir a Visitor'ı bir[`Document`](../../document/) . Bir Visitor'ı a sözlük belgesi üzerinde çalıştırmak istiyorsanız, şunu çağırmanız gerekir:[`Accept`](../../../aspose.words.buildingblocks/glossarydocument/accept/) .
