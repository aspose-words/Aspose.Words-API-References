...
description: Belgenizde bir form alanı algılandığında tetiklenen DocumentVisitor VisitFormField yöntemini keşfedin. Belge işlemenizi bugün geliştirin!
type: docs
weight: 230
url: /tr/net/aspose.words/documentvisitor/visitformfield/
---
## DocumentVisitor.VisitFormField method

Belgede bir form alanıyla karşılaşıldığında çağrılır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| formField | FormField | Ziyaret edilen nesne. |
