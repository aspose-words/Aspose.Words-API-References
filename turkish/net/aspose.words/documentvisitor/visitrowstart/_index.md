...
description: DocumentVisitor yöntem. Bir tablo satırının numaralandırılması başladığında çağrılır.
type: docs
weight: 350
...
Bir tablo satırının numaralandırılması başladığında çağrılır.
