...
description: ConditionalStyle mülk. Tablo hücrelerinin içeriğinin altına eklenecek boşluk miktarını puan olarak alır veya ayarlar.
type: docs
weight: 20
url: /tr/net/aspose.words/conditionalstyle/bottompadding/
---
## ConditionalStyle.BottomPadding property

Tablo hücrelerinin içeriğinin altına eklenecek boşluk miktarını (puan olarak) alır veya ayarlar.
