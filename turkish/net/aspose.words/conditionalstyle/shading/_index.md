...
description: Stilleriniz için gölgelendirme biçimlendirmesine erişmek için ConditionalStyle Shading özelliğini keşfedin. Tasarımlarınızı bugün özel görsel efektlerle geliştirin!
type: docs
weight: 70
...
Bir tane alır[`Shading`](../../shading/) Bu koşullu stil için gölgelendirme biçimlendirmesine başvuran nesne.
