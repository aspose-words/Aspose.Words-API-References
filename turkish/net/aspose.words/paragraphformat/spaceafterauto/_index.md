...
description: ParagraphFormat mülk. Paragraftan sonraki boşluk miktarı otomatik olarak ayarlanırsa doğrudur.
type: docs
weight: 300
...
Paragraftan sonraki boşluk miktarı otomatik olarak ayarlanırsa doğrudur.
...
true olarak ayarlandığında, etkisini geçersiz kılar[`SpaceAfter`](../spaceafter/).
