...
description: ParagraphFormat IsListItem özelliğinin, madde işaretli veya numaralı liste öğelerini zahmetsizce belirleyerek belge biçimlendirmenizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 150
...
Paragraf madde işaretli veya numaralı bir listede yer aldığında doğrudur.
