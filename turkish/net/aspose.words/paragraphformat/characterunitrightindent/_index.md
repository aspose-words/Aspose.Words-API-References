...
description: ParagraphFormat mülk. Belirtilen paragraflar için doğru girinti değerini karakter olarak alır veya ayarlar.
type: docs
weight: 80
...
Belirtilen paragraflar için doğru girinti değerini (karakter olarak) alır veya ayarlar.
