...
description: Revizyon Yazarınızı zahmetsizce yönetin. Her revizyon için yazar ayrıntılarını kolayca ayarlayın veya güncelleyin; belgelerinizde açıklık ve hesap verebilirlik sağlayın.
type: docs
weight: 10
url: /tr/net/aspose.words/revision/author/
---
## Revision.Author property

Bu revizyonun yazarını alır veya ayarlar. Boş bir dize veya olamaz`hükümsüz` .
