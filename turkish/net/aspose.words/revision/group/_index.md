...
description: Revizyon Grubu özelliğini keşfedin, revizyon gruplarını zahmetsizce alın veya grup yoksa null alın. Veri yönetiminizi bugün basitleştirin!
type: docs
weight: 30
...
Revizyon grubunu alır. Geri döndürür`hükümsüz` eğer revizyon herhangi bir gruba ait değilse.
...
Revizyon türü şuysa revizyonun grubu yokturStyleDefinitionChange or eğer revizyon artık belge bağlamında mevcut değilse (kabul edildi/reddedildi).
