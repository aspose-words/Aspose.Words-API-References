...
description: Revision mülk. Bu revizyonun hemen üst düğümünü sahibini alır. Bu özellik aşağıdakiler dışındaki herhangi bir revizyon türü için çalışacaktır.StyleDefinitionChange .
type: docs
weight: 40
...
Bu revizyonun hemen üst düğümünü (sahibini) alır. Bu özellik, aşağıdakiler dışındaki herhangi bir revizyon türü için çalışacaktır.StyleDefinitionChange .
...
Bu revizyon Stil biçimlendirmesinin değiştirilmesiyle ilgiliyse, şunu kullanın:[`ParentStyle`](../parentstyle/) bunun yerine.
