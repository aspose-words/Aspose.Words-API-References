...
description: Belgeye bir tablo hücresi ekler.
type: docs
weight: 250
...
Bir masa başlatmak için aramanız yeterli **EkleHücre** . Bundan sonra, diğer yöntemlerini kullanarak eklediğiniz herhangi bir içerik[`DocumentBuilder`](../../documentbuilder) sınıfı geçerli hücreye eklenecektir.
