...
description: DocumentBuilder'ın EndTable yöntemi ile belge tablolarınızı zahmetsizce sonlandırın, kusursuz biçimlendirme ve profesyonel sunum sağlayın.
type: docs
weight: 250
...
Bu yöntem yalnızca bir kez çağrılmalıdır.[`EndRow`](../endrow/) çağrıldı. Çağrıldığında, `EndTable` imleci geçerli hücreden çıkarıp tablonun hemen sonrasına işaret eder.
