...
description: DocumentBuilder mülk. İmleç geçerli paragrafın başındaysa doğru döndürür imleçten önce metin yok.
type: docs
weight: 110
...
İmleç geçerli paragrafın başındaysa doğru döndürür (imleçten önce metin yok).
