...
description: CurrentParagraph özelliğiyle DocumentBuilder'daki seçili paragrafa kolayca erişin. Belge düzenleme sürecinizi bugün kolaylaştırın!
type: docs
weight: 50
...
Bu bölümde şu anda seçili olan paragrafı alır[`DocumentBuilder`](../) .
