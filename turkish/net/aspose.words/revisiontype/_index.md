...
description: Aspose.Words.RevisionType Sıralama. İçinde izlenen değişikliğin türünü belirtir.Revision .
type: docs
weight: 4540
...
İçinde izlenen değişikliğin türünü belirtir.[`Revision`](../revision/) .
...
| Moving | `4` | İçerik belgede taşındı. |
