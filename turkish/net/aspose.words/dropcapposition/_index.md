...
| İsim | Değer | Tanım |
| --- | --- | --- |
| None | `0` | Paragrafta büyük harf yok. |
| Normal | `1` | Gömme, bağlantı paragrafındaki metin kenar boşluğunun içinde bulunur. |
| Margin | `2` | Gömme, bağlantı paragrafındaki metin kenar boşluğunun dışında konumlandırılır. |

### Örnekler

Gömme büyük harfin nasıl oluşturulacağını gösterir.

```csharp
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);

// İkinci ve üçüncü paragraflardaki metnin başladığı büyük harfli bir paragraf ekleyin.
