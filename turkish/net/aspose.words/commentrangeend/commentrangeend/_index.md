...
Ne zaman[`CommentRangeEnd`](../../commentrangeend) oluşturulur, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değil ve[`ParentNode`](../../node/parentnode) boş.

eklemek için[`CommentRangeEnd`](../../commentrangeend) belgeye, yorumun eklenmesini istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
