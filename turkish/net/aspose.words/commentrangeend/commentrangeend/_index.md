...
Ne zaman[`CommentRangeEnd`](../) oluşturulur, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değil ve[`ParentNode`](../../node/parentnode/) boş.

eklemek için[`CommentRangeEnd`](../) belgeye, yorumun eklenmesini istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
