...
description: CommentRangeEnd oluşturucusunu keşfedin, sorunsuz kod entegrasyonu ve gelişmiş işlevsellik için bu sınıfın yeni örneklerini zahmetsizce oluşturun.
type: docs
weight: 10
...
Ne zaman[`CommentRangeEnd`](../) oluşturulduğunda, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değildir ve[`ParentNode`](../../node/parentnode/) dır`hükümsüz`.

Birini eklemek için[`CommentRangeEnd`](../) Yorumun eklenmesini istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
