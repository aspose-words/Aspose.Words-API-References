...
description: Toplam koşullu stil sayısına kolayca erişmek için ConditionalStyleCollection Count özelliğini keşfedin, böylece tasarım esnekliğinizi ve verimliliğinizi artırın.
type: docs
weight: 30
...
Koleksiyondaki koşullu stillerin sayısını alır.
