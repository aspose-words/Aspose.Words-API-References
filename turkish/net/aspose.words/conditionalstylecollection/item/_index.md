...
description: ConditionalStyle nesnelerine türlerine göre kolayca erişmek ve stil oluşturma yeteneklerinizi zahmetsizce geliştirmek için ConditionalStyleCollection Öğe özelliğini keşfedin.
type: docs
weight: 80
...
Birini alır[`ConditionalStyle`](../../conditionalstyle/) koşullu stil türüne göre nesne.
...
Birini alır[`ConditionalStyle`](../../conditionalstyle/) nesne index. tarafından
