...
description: CompositeNode InsertBefore yöntem. Belirtilen düğümü belirtilen referans düğümünün hemen öncesine ekler C#'da.
type: docs
weight: 140
...
Belirtilen düğümü, belirtilen referans düğümünün hemen öncesine ekler.
...
| refChild | Node | [`Node`](../../node/) bu referans düğümüdür.*newChild* bu düğümün önüne yerleştirilir. |
...
Eğer*refChild* dır-dir`hükümsüz` , ekler*newChild* alt düğümler listesinin sonunda.
