...
description: CompositeNode IsComposite özelliğini keşfedin. Bir düğümün gelişmiş veri yapısı yönetimi için alt düğümleri destekleyip desteklemediğini kolayca kontrol edin.
type: docs
weight: 40
...
Geri Döndürür`doğru` çünkü bu düğümün alt düğümleri olabilir.
