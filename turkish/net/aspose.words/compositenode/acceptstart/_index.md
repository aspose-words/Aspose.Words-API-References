...
description: CompositeNode AcceptStart yönteminin, kusursuz ziyaretçi entegrasyonu için VisitXXXStart yöntemini çağırarak belge işlemeyi nasıl geliştirdiğini keşfedin.
type: docs
weight: 70
url: /tr/net/aspose.words/compositenode/acceptstart/
---
## CompositeNode.AcceptStart method

Türetilmiş bir sınıfta uygulandığında, belirtilen belge ziyaretçisinin VisitXXXStart yöntemini çağırır.
