...
description: Microsoft Word'deki Inline IsFormatRevision özelliğini keşfedin. Nesne biçimlendirmesinin değişiklik izleme etkinleştirilmiş olarak değişip değişmediğini gösterir ve belge yönetimini geliştirir.
type: docs
weight: 30
