...
description: Yazı tipi gizli metin olarak biçimlendirilmişse doğrudur.
type: docs
weight: 140
...
// "Gizli metin" seçeneğini etkinleştirmedikçe gizli metni görmeyeceğiz veya vurgulamayacağız
// Microsoft Word'de "Dosya" aracılığıyla bulundu -> "Seçenekler" -> "Görüntülemek". Metin hala orada olacak,
