...
description: Font ThemeFont özelliğiyle tema yazı tiplerini zahmetsizce nasıl yöneteceğinizi keşfedin. Cilalı bir görünüm için özelleştirilebilir yazı tipi şemalarıyla tasarımınızı geliştirin!
type: docs
weight: 480
...
Bu temayla ilişkili uygulanan yazı tipi şemasındaki tema yazı tipini alır veya ayarlar[`Font`](../) nesne.
