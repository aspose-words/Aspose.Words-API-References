...
description: Font LocaleIdBi özelliğini keşfedin, biçimlendirilmiş sağdan sola karakterler için yerel tanımlayıcıları kolayca yönetin ve çok dilli uygulamalarınızı geliştirin.
type: docs
weight: 210
...
Biçimlendirilmiş sağdan sola karakterlerin yerel tanımlayıcısını (dil) alır veya ayarlar.
