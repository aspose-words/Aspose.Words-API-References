...
description: Ziyaretçi etkileşimlerini sorunsuz bir şekilde yönetmek ve web uygulamanızın işlevselliğini geliştirmek için EditableRangeEnd Accept yöntemini keşfedin.
type: docs
weight: 40
...
Çağrılar[`VisitEditableRangeEnd`](../../documentvisitor/visiteditablerangeend/).
