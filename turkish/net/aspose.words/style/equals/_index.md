...
description: Belirtilen stille karşılaştırır. Stiller İstdler yalnızca yerleşik stiller için karşılaştırılır. Stil varsayılanları karşılaştırmaya dahil edilmez. Temel stil bağlantılı stil ve sonraki paragraf stili yinelemeli olarak karşılaştırılır.
type: docs
weight: 170
