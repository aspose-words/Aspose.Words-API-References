...
description: Paragraph yöntem. Bir ziyaretçiyi kabul eder.
type: docs
weight: 230
...
DocumentVisitor.VisitParagraphStart'ı çağırır, ardından paragrafın tüm alt düğümleri için Kabul Et'i çağırır ve sonunda DocumentVisitor.VisitParagraphEnd'i çağırır.
