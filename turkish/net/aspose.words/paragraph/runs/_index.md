...
description: Paragraph mülk. Paragraf içinde yazılan metin parçaları koleksiyonuna erişim sağlar.
type: docs
weight: 220
...
Paragraf içinde yazılan metin parçaları koleksiyonuna erişim sağlar.
