...
description: Belgenizin yapısını ve okunabilirliğini artırarak, paragraflar içindeki biçimlendirilmiş metin koleksiyonlarına kolay erişim için Paragraf Çalışmaları özelliğini keşfedin.
type: docs
weight: 220
...
Paragrafın içindeki metin parçalarının yazılmış koleksiyonuna erişim sağlar.
