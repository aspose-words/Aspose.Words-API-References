...
description: Aspose.Words.Paragraph sınıf. Metnin bir paragrafını temsil eder C#'da.
type: docs
weight: 4390
...
| İsim | Tanım |
| --- | --- |
| [Paragraph](paragraph/)(*[DocumentBase](../documentbase/)*) | Yeni bir örneğini başlatır`Paragraph` class. |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words/paragraph/accept/)(*[DocumentVisitor](../documentvisitor/)*) | Ziyaretçi kabul eder. |
