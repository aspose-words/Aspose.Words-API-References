...
description: Tablo hücre ve satır sonlarını x0007 karakteriyle tanımlamanın anahtarı olan ControlChar Hücre alanını keşfedin. Veri organizasyonunuzu zahmetsizce geliştirin!
type: docs
weight: 10
...
Bir tablo hücresinin sonu veya bir tablo satırının sonu karakteri: "\x0007" veya "\a".
