...
description: ControlChar ParagraphBreak alanını keşfedin. Sorunsuz metin biçimlendirme ve iyileştirilmiş okunabilirlik için x000d karakteriyle paragraf sonlarını kolayca yönetin.
type: docs
weight: 220
url: /tr/net/aspose.words/controlchar/paragraphbreak/
---
## ControlChar.ParagraphBreak field

Paragraf sonu karakteri: "\x000d" veya "\r". Aynı[`Cr`](../cr/)
