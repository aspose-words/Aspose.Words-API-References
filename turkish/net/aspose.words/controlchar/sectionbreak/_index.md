...
description: ControlChar SectionBreak alanını keşfedin, x000c karakteriyle belge bölümlerini etkin bir şekilde yönetin, biçimlendirmeyi ve okunabilirliği artırın.
type: docs
weight: 240
...
Bölüm sonu karakteri: "\x000c" veya "\f". Aynı değere sahip olduğunu unutmayın[`PageBreak`](../pagebreak/) .
