...
description: Satır başı ve ardından satır besleme karakteri x000dx000a veya rn. Microsoft Word belgelerinde bu şekilde kullanılmaz ancak metin dosyalarında paragraf sonları için yaygın olarak kullanılır.
type: docs
weight: 60
