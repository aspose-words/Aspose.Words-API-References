...
description: ControlChar PageBreak alanını keşfedin, x000c karakteriyle sayfa sonlarını verimli bir şekilde yönetin. Belge biçimlendirmenizi bugün basitleştirin!
type: docs
weight: 200
url: /tr/net/aspose.words/controlchar/pagebreak/
---
## ControlChar.PageBreak field

Sayfa sonu karakteri: "\x000c" veya "\f". Aynı değere sahip olduğunu unutmayın[`SectionBreak`](../sectionbreak/) .
