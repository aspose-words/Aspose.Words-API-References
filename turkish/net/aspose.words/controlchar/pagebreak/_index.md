...
description: ControlChar PageBreak alan. Sayfa sonu karakteri x000c veya f. ile aynı değere sahip olduğunu unutmayın.SectionBreak  C#'da.
type: docs
weight: 200
...
Sayfa sonu karakteri: "\x000c" veya "\f". ile aynı değere sahip olduğunu unutmayın.[`SectionBreak`](../sectionbreak/) .
