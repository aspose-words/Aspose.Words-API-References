...
description: ControlChar alan. Alan ayırıcı karakter alan kodunu alan değerinden ayırır. Bazı alanlarda isteğe bağlı. Değer char20.
type: docs
weight: 90
...
Alan ayırıcı karakter, alan kodunu alan değerinden ayırır. Bazı alanlarda isteğe bağlı. Değer: (char)20.
