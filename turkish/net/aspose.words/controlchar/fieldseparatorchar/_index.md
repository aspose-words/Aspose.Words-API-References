...
description: ControlChar FieldSeparatorChar'ın alan kodlarını değerlerden etkili bir şekilde ayırarak veri yönetimini nasıl geliştirdiğini ve iş akışınızı zahmetsizce nasıl optimize ettiğini keşfedin.
type: docs
weight: 90
...
Alan ayırıcı karakteri, alan kodunu alan değerinden ayırır. Bazı alanlarda isteğe bağlıdır. Değer: (char)20.
