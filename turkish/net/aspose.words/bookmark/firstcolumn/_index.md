...
description: FirstColumn özelliğini keşfedin. Verimli veri yönetimi için tablonuzun yer imi aralığındaki ilk sütunun sıfır tabanlı dizinine kolayca erişin.
type: docs
weight: 30
...
Yer imiyle ilişkili tablo sütun aralığının ilk sütununun sıfır tabanlı dizinini alır.
