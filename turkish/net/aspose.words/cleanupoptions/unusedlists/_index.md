...
description: CleanupOptions mülk. Kullanılmayan liste ve liste tanımlarının belgeden kaldırılması gerekip gerekmediğini belirtir. Varsayılan değer doğru .
type: docs
weight: 40
...
Kullanılmayan liste ve liste tanımlarının belgeden kaldırılması gerekip gerekmediğini belirtir. Varsayılan değer **doğru** .
