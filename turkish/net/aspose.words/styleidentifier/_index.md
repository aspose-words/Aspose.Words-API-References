...
description: Yerel ayardan bağımsız stil tanımlayıcısı.
type: docs
weight: 5850
...
| DocumentMap | `89` |  |
| EmailSignature | `91` |  |
| EndnoteText | `43` | Son Not Metni stili. |
| Footer | `32` | Altbilgi stili. |
| FootnoteText | `29` | Dipnot Metni stili. |
...
| EnvelopeReturn | `37` | Zarf Dönüş stili. |
| Index1 | `10` |  |
| Index2 | `11` |  |
| Index3 | `12` |  |
| Index4 | `13` |  |
...
| ListTable5Dark | `326` | Liste Tablosu 5 Dark |
| ListTable6Colorful | `327` | Liste Tablosu 6 Renkli |
