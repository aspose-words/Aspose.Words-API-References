...
description: Kendisiyle ilişkilendirilmiş bir yorumu olan bir metin bölgesinin başlangıcını belirtir.
type: docs
weight: 250
...
[`CommentRangeStart`](../commentrangestart) satır içi düzey bir düğümdür ve yalnızca alt öğesi olabilir[`Paragraph`](../paragraph).
