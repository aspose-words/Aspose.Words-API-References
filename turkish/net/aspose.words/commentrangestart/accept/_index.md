...
description: Ziyaretçi katılımını artırmak ve sitenizdeki etkileşimleri kolaylaştırmak için CommentRangeStart Accept yöntemini keşfedin. Kullanıcı deneyimini bugün artırın!
type: docs
weight: 40
...
Çağrılar[`VisitCommentRangeStart`](../../documentvisitor/visitcommentrangestart/).
