...
Ne zaman[`CommentRangeStart`](../../commentrangestart) oluşturulur, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değil ve[`ParentNode`](../../node/parentnode) boş.

eklemek için[`CommentRangeStart`](../../commentrangestart) belgeye, yorumun eklenmesini istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
