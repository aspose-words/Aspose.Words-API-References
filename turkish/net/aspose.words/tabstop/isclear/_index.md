...
description: TabStop IsClear özelliğinin, sorunsuz sekme yönetimi sağlayarak, mevcut durakları temizleyerek daha sorunsuz bir kullanıcı deneyimi sunarak kullanıcı arayüzünüzü nasıl geliştirdiğini keşfedin.
type: docs
weight: 30
...
Geri Döndürür`doğru` eğer bu sekme durağı bu pozisyondaki mevcut sekme duraklarını temizlerse.
