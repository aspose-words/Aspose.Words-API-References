...
description: AcceptEnd yönteminin yorum ziyaretlerini verimli bir şekilde yöneterek kullanıcı deneyimini nasıl geliştirdiğini öğrenin. Sorunsuz ziyaretçi kabulüyle etkileşimi artırın!
type: docs
weight: 140
url: /tr/net/aspose.words/comment/acceptend/
---
## Comment.AcceptEnd method

Yorumun sonunu ziyaret eden bir ziyaretçiyi kabul eder.
