...
description: Yorumları Tamamlandı özelliğiyle tamamlandı olarak işaretleyin. Bu basit işaretleme özelliğiyle görevlerinizi kolayca yönetin ve iş akışı verimliliğini artırın.
type: docs
weight: 60
...
Yorumun yapıldığına işaret edildiğini belirten bayrağı alır veya ayarlar.
