...
description: Ziyaretçileri yorumların başında sorunsuz bir şekilde karşılamak, kullanıcı etkileşimini ve katılımını artırmak için AcceptStart yöntemini keşfedin.
type: docs
weight: 150
url: /tr/net/aspose.words/comment/acceptstart/
---
## Comment.AcceptStart method

Yorumun başlangıcını ziyaret eden bir ziyaretçiyi kabul eder.
