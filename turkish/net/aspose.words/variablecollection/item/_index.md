...
description: Büyük/küçük harfe duyarlı olmayan bir belge değişkeni alır veya ayarlar. boş değerlere atamanın sağ tarafı olarak izin verilmez ve boş dizeyle değiştirilir.
type: docs
weight: 20
...
| Parametre | Tanım |
| --- | --- |
| index | Belge değişkeninin sıfır tabanlı dizini. |
