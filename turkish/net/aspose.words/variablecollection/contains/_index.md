...
description: VariableCollection'ın isme göre bir belge değişkeni tutup tutmadığını keşfedin. Veri yönetiminizi kolaylaştırın ve kodlama verimliliğinizi bugün artırın!
type: docs
weight: 50
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| name | String | Bulunacak belge değişkeninin büyük/küçük harfe duyarlı olmayan adı. |
