...
description: VariableCollection yöntem. Koleksiyonun verilen ada sahip bir belge değişkeni içerip içermediğini belirler.
type: docs
weight: 50
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| name | String | Bulunacak belge değişkeninin büyük/küçük harfe duyarsız adı. |
