...
description: Kapsamlı bir yer imleri koleksiyonuna erişmek, belge gezinmenizi ve düzenlemenizi zahmetsizce geliştirmek için Range Bookmarks özelliğini keşfedin.
type: docs
weight: 10
...
Bir`Bookmarks` . aralığındaki tüm yer imlerini temsil eden koleksiyon
