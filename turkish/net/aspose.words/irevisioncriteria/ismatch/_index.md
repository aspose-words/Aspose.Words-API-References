...
description: IRevisionCriteria IsMatch yönteminin, belirli bir revizyonun optimum sonuçlar için kriterlerinizle uyumlu olup olmadığını etkili bir şekilde nasıl doğruladığını keşfedin.
type: docs
weight: 10
url: /tr/net/aspose.words/irevisioncriteria/ismatch/
---
## IRevisionCriteria.IsMatch method

Belirtilip belirtilmediğini kontrol eder*revision* kriterlere uyuyor.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| revision | Revision | The[`Revision`](../../revision/) Kriterlere uygun örnek. |

### Geri dönüş değeri

`Doğru` eğer*revision* kriterlere uyuyor, aksi takdirde`YANLIŞ`.

## Notlar

Yöntem uygulaması beklenmeyen sonuçlar nedeniyle revizyonu kabul etmemeli/reddetmemeli veya herhangi bir şekilde değiştirmemelidir.
