...
| İsim | Tanım |
| --- | --- |
| [Count](../../aspose.words/revisioncollection/count/) { get; } | Koleksiyondaki revizyonların sayısını verir. |
| [Groups](../../aspose.words/revisioncollection/groups/) { get; } | Revizyon grupları koleksiyonu. |
| [Item](../../aspose.words/revisioncollection/item/) { get; } | Belirtilen dizinde bir Düzeltme döndürür. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| [AcceptAll](../../aspose.words/revisioncollection/acceptall/)() | Bu koleksiyondaki tüm düzeltmeleri kabul eder. |
...
Bu sınıfın örneklerini doğrudan oluşturmazsınız. Kullan[`Revisions`](../document/revisions/) Bir belgede mevcut revizyonları almak için özellik.
