...
description: RevisionCollection Item özelliğiyle belirli revizyonlara zahmetsizce erişin. Kolaylaştırılmış veri yönetimi için revizyonları dizine göre hızla alın.
type: docs
weight: 30
...
Bir[`Revision`](../../revision/) belirtilen dizinde.
