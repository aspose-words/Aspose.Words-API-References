...
description: Ölçülü yönteminizin IsMetered ile lisanslı olup olmadığını keşfedin. Uyumluluğu sağlayın ve bugün lisanslı hizmetlerin avantajlarının kilidini açın!
type: docs
weight: 60
url: /tr/net/aspose.words/metered/ismeteredlicensed/
---
## Metered.IsMeteredLicensed method

Ölçümlü olup olmadığını kontrol edin
