...
description: Aspose.Words.Loading.TxtTrailingSpacesOptions Sıralama. Şuradan içe aktarma sırasında sondaki boşlukların işlenmesi için mevcut seçenekleri belirtir.Text dosya.
type: docs
weight: 3540
...
Şuradan içe aktarma sırasında sondaki boşlukların işlenmesi için mevcut seçenekleri belirtir.Text dosya.
