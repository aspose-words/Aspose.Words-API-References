...
description: ListLevel mülk. Liste düzeyi için sayı veya madde işaretinin konumunu nokta olarak döndürür veya ayarlar.
type: docs
weight: 80
...
Liste düzeyi için sayı veya madde işaretinin konumunu (nokta olarak) döndürür veya ayarlar.
...
`NumberPosition` paragrafın LeftIndent artı FirstLineIndent değerine karşılık gelir.
