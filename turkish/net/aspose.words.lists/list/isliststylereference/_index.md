...
description: List mülk. Bu liste bir liste stiline başvuruysa true değerini döndürür.
type: docs
weight: 30
...
Bu liste bir liste stiline başvuruysa true değerini döndürür.
...
Liste stiline referans olan bir listenin özelliklerini değiştirmenin hiçbir etkisi olmadığını unutmayın. Liste stilinde belirtilen liste formatı her zaman önceliklidir.
