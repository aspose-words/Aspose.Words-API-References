...
İadeler`doğru` bu liste bir liste stilinin tanımıysa.
...
Liste stilini tanımlayan bir listenin özelliklerini değiştirerek, liste stilinin Properties özelliğini değiştirirsiniz.
