...
description: ListFormat yöntem. Geçerli paragraftan sayıları veya madde işaretlerini kaldırır ve liste düzeyini sıfıra ayarlar.
type: docs
weight: 90
...
Geçerli paragraftan sayıları veya madde işaretlerini kaldırır ve liste düzeyini sıfıra ayarlar.
...
Bu yöntemi çağırmak,[`List`](../list/) null özelliği.
