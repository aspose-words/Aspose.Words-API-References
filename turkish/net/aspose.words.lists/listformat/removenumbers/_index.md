...
description: ListFormat RemoveNumbers yöntemiyle paragraflarınızdaki sayıları veya madde işaretlerini zahmetsizce kaldırın ve temiz biçimlendirme için liste düzeyinizi sıfırlayın.
type: docs
weight: 90
...
Geçerli paragraftan numaraları veya madde işaretlerini kaldırır ve liste düzeyini sıfıra ayarlar.
...
Bu yöntemi çağırmak, şunu ayarlamaya eşdeğerdir:[`List`](../list/) mülk`hükümsüz`.

## Örnekler

Bir bölümün ana metnindeki tüm paragraflardan liste biçimlendirmesinin nasıl kaldırılacağını gösterir.
