...
description: ApplyNumberDefault yönteminin paragraflarınız için varsayılan numaralı bir liste oluşturarak belgelerinizdeki düzeni ve anlaşılırlığı nasıl artırdığını keşfedin.
type: docs
weight: 60
...
Yeni bir varsayılan numaralandırılmış liste başlatır ve bunu paragrafa uygular.
