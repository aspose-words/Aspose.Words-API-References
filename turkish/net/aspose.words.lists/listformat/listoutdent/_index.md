...
description: ListFormat yöntem. Geçerli paragrafın liste düzeyini bir düzey azaltır.
type: docs
weight: 80
...
Word belgelerinde, listeler en fazla dokuz düzeyden oluşabilir. Her seviye için formatting listesi, hangi madde işaretinin veya sayının kullanıldığını, sol girintiyi, madde işareti ile metin arasındaki boşluğu vb. belirtir.
