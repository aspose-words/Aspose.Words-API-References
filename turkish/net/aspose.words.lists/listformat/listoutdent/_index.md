...
description: ListFormat ListOutdent yönteminin, geçerli paragrafın liste düzeyini zahmetsizce azaltarak belgenizin yapısını nasıl basitleştirebileceğini keşfedin.
type: docs
weight: 80
url: /tr/net/aspose.words.lists/listformat/listoutdent/
---
## ListFormat.ListOutdent method

Geçerli paragrafın liste düzeyini bir düzey azaltır.
...
Word belgelerinde listeler en fazla dokuz seviyeden oluşabilir. Her seviye için liste biçimlendirmesi hangi madde işaretinin veya numaranın kullanılacağını, sol girintiyi, madde işaretiyle metin arasındaki boşluğu vb. belirtir.
