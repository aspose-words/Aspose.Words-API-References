...
description: Rapor oluşturma sürecinizi kolaylaştırmak ve üretkenliği artırmak için tasarlanan ReportBuilder Create yöntemi ile güçlü raporları zahmetsizce oluşturun.
type: docs
weight: 10
url: /tr/net/aspose.words.lowcode/reportbuilder/create/
---
## Create() {#create}
