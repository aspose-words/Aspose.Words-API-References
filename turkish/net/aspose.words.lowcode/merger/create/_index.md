...
description: Sorunsuz belge işleme ve gelişmiş verimlilik için yeni bir posta birleştirme işlemcisi örneğini zahmetsizce oluşturmak üzere Birleştirme Oluşturma yöntemini keşfedin.
type: docs
weight: 10
url: /tr/net/aspose.words.lowcode/merger/create/
---
## Create() {#create}

Posta birleştirme işlemcisinin yeni bir örneğini oluşturur.
