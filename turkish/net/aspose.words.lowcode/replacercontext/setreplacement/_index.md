...
description: Kusursuz desen ve değiştirme yönetimine olanak tanıyan ReplacerContext SetReplacement yöntemi ile bul ve değiştir işlemlerinizi geliştirin.
type: docs
weight: 30
url: /tr/net/aspose.words.lowcode/replacercontext/setreplacement/
---
## SetReplacement(*string, string*) {#setreplacement}

Bul/değiştir işlemi tarafından kullanılan deseni ve değiştirmeyi ayarlar.
...
Bu yöntemin kullanılması daha önce belirlenmiş olan desen ve değiştirmeyi geçersiz kılar.
