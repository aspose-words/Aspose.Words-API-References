...
description: LINQ Reporting Engine ile kusursuz belge üretimi için Aspose.Words LowCode ReportBuilderContext sınıfını keşfedin. İş akışınızı bugün geliştirin.
type: docs
weight: 4370
url: /tr/net/aspose.words.lowcode/reportbuildercontext/
---
## ReportBuilderContext class

LINQ Raporlama Motoru bağlamı.
...
| İsim | Tanım |
| --- | --- |
| [DataSources](../../aspose.words.lowcode/reportbuildercontext/datasources/) { get; } | Raporu oluşturmak için kullanılan veri kaynakları. |
...
| [ReportBuilderOptions](../../aspose.words.lowcode/reportbuildercontext/reportbuilderoptions/) { get; } | Rapor oluşturma seçenekleri. |
