...
description: Kalıcı görev bölmesi nesnelerini verimli bir şekilde yönetmek için çözümünüz olan Aspose.Words.WebExtensions.TaskPaneCollection sınıfını keşfedin. Web uygulamalarınızı bugün geliştirin!
type: docs
weight: 7570
...
Kalıcı görev bölmesi nesnelerinin bir listesini belirtir.
