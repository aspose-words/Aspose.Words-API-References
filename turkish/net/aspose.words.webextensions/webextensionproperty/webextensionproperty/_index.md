...
description: WebExtensionProperty oluşturucusu ile zahmetsizce özel web uzantısı özellikleri oluşturun. Projelerinizi özelleştirilmiş ad-değer çiftleriyle geliştirin!
type: docs
weight: 10
...
Belirtilen ad ve değerle web uzantısı özel özelliğini oluşturur.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| name | String | Emlak adı. |
| value | String | Emlak değeri. |
