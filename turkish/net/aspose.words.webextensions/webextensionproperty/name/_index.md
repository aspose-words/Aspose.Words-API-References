...
description: Web uzantılarınızı geliştiren ve işlevselliği artıran özel özellik adları oluşturmak için WebExtensionProperty Adının nasıl kullanılacağını keşfedin.
type: docs
weight: 20
