...
description: Web uygulamalarınızda gelişmiş işlevsellik ve esneklik için özel özellik değerleri tanımlamanıza olanak tanıyan WebExtensionProperty Value özelliğini keşfedin.
type: docs
weight: 30
