...
description: Görev Bölmesi Satır özelliğini keşfedin, uygulamalarınızda sorunsuz organizasyon ve gelişmiş üretkenlik için görev bölmesi dizinlemeyi kolayca yönetin.
type: docs
weight: 50
...
Aynı varsayılan konuma yerleştirilmiş diğer kalıcı görev bölmeleri arasında, bu görev bölmesinin dışarıdan içeriye doğru numaralandırılan dizinini belirtir.
