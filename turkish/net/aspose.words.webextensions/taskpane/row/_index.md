...
description: TaskPane mülk. Aynı varsayılan konuma yerleştirilmiş diğer persisted görev bölmeleri arasında bu görev bölmesinin dıştan içe doğru numaralandırarak dizinini belirtir.
type: docs
weight: 50
...
Aynı varsayılan konuma yerleştirilmiş diğer persisted görev bölmeleri arasında bu görev bölmesinin dıştan içe doğru numaralandırarak dizinini belirtir.
