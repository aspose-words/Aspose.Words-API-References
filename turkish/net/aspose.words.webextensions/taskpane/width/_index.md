...
description: Görev bölmenizin varsayılan genişliğini kolayca özelleştirmek, kullanıcı deneyimini ve işlevselliğini artırmak için Görev Bölmesi Genişliği özelliğini keşfedin.
type: docs
weight: 70
