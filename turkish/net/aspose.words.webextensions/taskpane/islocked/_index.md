...
description: TaskPane IsLocked özelliğini keşfedin, kullanıcı arayüzünüzdeki görev bölmesi erişilebilirliğini kontrol edin ve böylece kullanıcıların üretkenliği artırmak için önemli özellikleri kapatamamasını sağlayın.
type: docs
weight: 30
...
Görev bölmesinin kullanıcı arayüzündeki belgeye kilitlenip kilitlenmediğini ve kullanıcı tarafından kapatılamayacağını belirtir.
