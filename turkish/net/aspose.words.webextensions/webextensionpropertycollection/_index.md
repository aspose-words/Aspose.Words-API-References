...
description: Özel web uzantısı özelliklerini verimli bir şekilde yönetmek için Aspose.Words.WebExtensions.WebExtensionPropertyCollection'ı keşfedin. Belge otomasyonunuzu bugün geliştirin!
type: docs
weight: 7640
url: /tr/net/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class

Bir dizi web uzantısı özel özelliğini belirtir.
