...
description: WebExtensionReference Store özelliğini keşfedin; pazaryerindeki web uzantılarına etkin bir şekilde erişmenizi ve onları yönetmenizi sağlayan ağ geçidiniz.
type: docs
weight: 30
...
Web uzantısının depolandığı pazaryerinin örneğini belirtir.
