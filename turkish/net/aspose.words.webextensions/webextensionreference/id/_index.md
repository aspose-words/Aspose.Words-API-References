...
description: WebExtensionReference Id özelliğini keşfedin; katalog sağlayıcılarındaki web uzantıları için benzersiz tanımlayıcınız. Uzantınızın görünürlüğünü bugün artırın!
type: docs
weight: 20
...
Bir katalog sağlayıcısı içindeki web uzantısıyla ilişkili tanımlayıcı.
