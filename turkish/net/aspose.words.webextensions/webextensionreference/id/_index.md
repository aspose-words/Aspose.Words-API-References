...
description: WebExtensionReference mülk. Bir katalog sağlayıcı içindeki web uzantısıyla ilişkili tanımlayıcı.
type: docs
weight: 20
...
Bir katalog sağlayıcı içindeki web uzantısıyla ilişkili tanımlayıcı.
