...
description: Web uzantıları için birincil bağlantıları tanımlamanın anahtarı olan WebExtension Reference özelliğini keşfedin. İşlevselliği geliştirin ve geliştirmeyi kolaylaştırın!
type: docs
weight: 60
...
Bir web uzantısına birincil başvuruyu belirtir.
