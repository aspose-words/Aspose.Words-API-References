...
description: Web uzantılarınızı geliştirmek için güçlü bir özelleştirilebilir özellikler seti olan WebExtension Properties'i keşfedin. Bugün benzersiz işlevselliğin kilidini açın!
type: docs
weight: 50
...
Bir dizi web uzantısı özel özelliğini temsil eder.
