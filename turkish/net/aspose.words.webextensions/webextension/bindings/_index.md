...
description: WebExtension Bağlantılarını keşfedin, gelişmiş işlevsellik ve kullanıcı deneyimi için özelleştirilebilir web uzantısı bağlantılarıyla geliştirmenizi kolaylaştırın.
type: docs
weight: 20
...
Web uzantısı bağlamalarının bir listesini belirtir.
