...
description: Web uzantınızı gelişmiş işlevsellik için çok yönlü başvuru seçenekleriyle geliştirmek için WebExtension AlternateReferences özelliğini keşfedin.
type: docs
weight: 10
