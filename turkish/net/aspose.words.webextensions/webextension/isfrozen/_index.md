...
description: Kullanıcının web uzantınızla etkileşimini kontrol eden WebExtension IsFrozen özelliğini keşfedin. Kullanılabilirliği artırın ve kullanıcı deneyimini bugün optimize edin!
type: docs
weight: 40
