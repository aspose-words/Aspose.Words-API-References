...
description: WebExtensionBinding AppRef özelliğinin bağlama anahtarlarını belge verilerine nasıl bağladığını ve web uygulamanızın işlevselliğini ve performansını nasıl artırdığını keşfedin.
type: docs
weight: 20
...
Bu listedeki bağlama girdisini belgedeki bağlı verilerle eşlemek için kullanılan bağlama anahtarını belirtir.
