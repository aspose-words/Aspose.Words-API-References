...
description: WebExtensionBinding oluşturucusu ile güçlü web uzantısı bağlamalarını zahmetsizce oluşturun. Sorunsuz entegrasyon ve gelişmiş işlevsellik için parametreleri özelleştirin.
type: docs
weight: 10
...
Belirtilen parametrelerle web uzantısı bağlaması oluşturur.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| id | String | Bağlayıcı tanımlayıcı. |
| bindingType | WebExtensionBindingType | Bağlayıcı tip. |
| appRef | String | Bu listedeki bağlayıcı girdiyi belgedeki bağlı verilerle eşlemek için kullanılan bağlayıcı anahtar. |
