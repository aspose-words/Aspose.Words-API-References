...
description: Gelişmiş web uzantısı işlevselliği için benzersiz bağlama tanımlayıcıları tanımlamanın anahtarı olan WebExtensionBinding Id özelliğini keşfedin.
type: docs
weight: 40
...
Bağlayıcı tanımlayıcıyı belirtir.
