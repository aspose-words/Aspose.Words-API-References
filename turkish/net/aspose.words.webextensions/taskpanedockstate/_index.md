...
description: Gelişmiş belge düzenleme ve kullanıcı deneyimi için görev bölmesi konumlarını tanımlayan Aspose.Words.WebExtensions.TaskPaneDockState enum'unu keşfedin.
type: docs
weight: 7580
...
Görev bölmesi nesnesinin kullanılabilir konumlarını sıralar.
