...
description: bu Aspose.Words.WebUzantıları ad alanı Office Eklentilerini temsil etmek için XML sözcük dağarcığını genişleten öğeleri ve öznitelikleri to özelleştirmesine olanak tanıyan sınıflar sağlar.
type: docs
weight: 280
...
| [WebExtensionReference](./webextensionreference) | Bir web uzantısına yapılan başvuruyu temsil eder. Başvuru, sağlayıcı konumunu ve uzantısının sürümünü belirlemek için kullanılır. |
...
| [WebExtensionBindingType](./webextensionbindingtype) | Bir web uzantısı ile belgedeki veriler arasındaki mevcut bağlama türlerini numaralandırır. |
| [WebExtensionStoreType](./webextensionstoretype) | Bir web uzantısı deposunun mevcut türlerini numaralandırır. |
