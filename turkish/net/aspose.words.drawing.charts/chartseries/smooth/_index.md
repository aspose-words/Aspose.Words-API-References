...
description: ChartSeries Smooth özelliğiyle grafiklerinizi geliştirin. Daha iyi veri netliği için CatmullRom spline'larını kullanarak görsel olarak çekici, pürüzsüz çizgiler zahmetsizce oluşturun.
type: docs
weight: 130
...
Grafikteki noktaları birleştiren çizginin Catmull-Rom spline'ları kullanılarak düzeltilip düzeltilmeyeceğini belirtmeye olanak tanır.
