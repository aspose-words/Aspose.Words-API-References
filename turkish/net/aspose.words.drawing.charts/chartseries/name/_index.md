...
description: ChartSeries Name özelliğini keşfedin, seri adlarını kolayca yönetin, endekslerle otomatik oluşturun ve veri görselleştirmeyi zahmetsizce geliştirin.
type: docs
weight: 110
...
Serinin adını alır veya ayarlar; ad açıkça ayarlanmamışsa index. kullanılarak oluşturulur. Varsayılan olarak Seri artı bir tabanlı index. değerini döndürür.
