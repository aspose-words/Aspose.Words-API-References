...
description: ChartSeries mülk. Dizinin adını alır veya ayarlar ad açıkça ayarlanmadıysa dizin kullanılarak oluşturulur. Varsayılan olarak Seri artı bir tabanlı dizin döndürür.
type: docs
weight: 100
...
Dizinin adını alır veya ayarlar, ad açıkça ayarlanmadıysa dizin kullanılarak oluşturulur. Varsayılan olarak Seri artı bir tabanlı dizin döndürür.
