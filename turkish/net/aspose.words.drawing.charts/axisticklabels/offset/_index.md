...
description: Veri görselleştirmelerinizde gelişmiş netlik ve görsel çekicilik için, eksenden işaret etiketi mesafesini özelleştirmek üzere AxisTickLabels Ofsetini ayarlayın.
type: docs
weight: 40
url: /tr/net/aspose.words.drawing.charts/axisticklabels/offset/
---
## AxisTickLabels.Offset property

Tik etiketlerinin eksenden uzaklığını alır veya ayarlar.
...
Geçerli aralık 0 ile 1000 yüzde dahil olmak üzeredir. Varsayılan değer 100%'dür.

Özellik yalnızca kategori eksenleri için etkilidir. MS Office 2016 yeni grafikleri tarafından desteklenmez.
