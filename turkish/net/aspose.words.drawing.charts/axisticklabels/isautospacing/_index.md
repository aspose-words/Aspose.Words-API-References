...
description: Projelerinizde hassas veri görselleştirmesi için otomatik etiket aralıklarını zahmetsizce yönetmek amacıyla AxisTickLabels IsAutoSpacing özelliğini keşfedin.
type: docs
weight: 30
url: /tr/net/aspose.words.drawing.charts/axisticklabels/isautospacing/
---
## AxisTickLabels.IsAutoSpacing property

Tik etiketlerini çizmek için otomatik aralık kullanılıp kullanılmayacağını belirten bir bayrak alır veya ayarlar.
