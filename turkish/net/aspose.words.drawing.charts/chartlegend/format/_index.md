...
description: Veri görselleştirme deneyiminizi geliştirmek için efsane dolgusu ve çizgi stillerini kolayca özelleştirmek üzere ChartLegend Format özelliğini keşfedin.
type: docs
weight: 20
url: /tr/net/aspose.words.drawing.charts/chartlegend/format/
---
## ChartLegend.Format property

Efsanenin dolgu ve satır biçimlendirmesine erişim sağlar.
