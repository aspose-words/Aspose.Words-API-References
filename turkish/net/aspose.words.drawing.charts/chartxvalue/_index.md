...
| İsim | Tanım |
| --- | --- |
| [DateTimeValue](../../aspose.words.drawing.charts/chartxvalue/datetimevalue/) { get; } | Saklanan tarihsaat değerini alır. |
| [DoubleValue](../../aspose.words.drawing.charts/chartxvalue/doublevalue/) { get; } | Saklanan sayısal değeri alır. |
| [MultilevelValue](../../aspose.words.drawing.charts/chartxvalue/multilevelvalue/) { get; } | Saklanan çok düzeyli değeri alır. |
| [StringValue](../../aspose.words.drawing.charts/chartxvalue/stringvalue/) { get; } | Saklanan dize değerini alır. |
| [TimeValue](../../aspose.words.drawing.charts/chartxvalue/timevalue/) { get; } | Saklanan zaman değerini alır. |
| [ValueType](../../aspose.words.drawing.charts/chartxvalue/valuetype/) { get; } | Nesnede saklanan X değerinin türünü alır. |
...
Bir grafik serisinin boş olmayan tüm X değerleri aynı olmalıdır[`ChartXValueType`](../chartxvaluetype/) tip.
