...
description: Sezgisel Sol ve Üst özellik ayarlarıyla veri etiketi konumlandırmasını etkili bir şekilde özelleştirmek için Aspose.Words.ChartDataLabelLocationMode enum'unu keşfedin.
type: docs
weight: 950
url: /tr/net/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enumeration

Bir veri etiketinin konumunu belirten değerlerin nasıl kullanılacağını belirtir -[`Left`](../chartdatalabel/left/) ve [`Top`](../chartdatalabel/top/) özellikler - yorumlanır.
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Offset | `0` | Bir veri etiketinin konumu, its tarafından tanımlanan konumdan bir ofsetle belirtilir.[`Position`](../chartdatalabel/position/) mülk. |
| Absolute | `1` | Bir veri etiketinin konumu, bir grafiğin sol üst köşesinden başlayarak mutlak koordinatlar kullanılarak belirtilir. |
