...
description: Eksen başlığı dolgusunu ve çizgi stillerini kolayca özelleştirmek ve veri görselleştirmenizi geliştirmek için ChartAxisTitle Format özelliğini keşfedin.
type: docs
weight: 20
url: /tr/net/aspose.words.drawing.charts/chartaxistitle/format/
---
## ChartAxisTitle.Format property

Eksen başlığının dolgu ve satır biçimlendirmesine erişim sağlar.
