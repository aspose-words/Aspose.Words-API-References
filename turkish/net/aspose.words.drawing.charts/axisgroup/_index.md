...
description: Gelişmiş veri görselleştirmesi için grafik eksen gruplarını etkili bir şekilde yönetmenin anahtarı olan Aspose.Words.Drawing.Charts.AxisGroup enum'unu keşfedin.
type: docs
weight: 800
url: /tr/net/aspose.words.drawing.charts/axisgroup/
---
## AxisGroup enumeration

Bir grafik eksen grubunun türünü temsil eder.
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Primary | `0` | Birincil eksen grubunu belirtir. |
| Secondary | `1` | İkincil eksen grubunu belirtir. |
