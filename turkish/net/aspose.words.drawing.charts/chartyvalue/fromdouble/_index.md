...
description: Gelişmiş veri görselleştirmesi için Double türünde ChartYValue örneklerini zahmetsizce oluşturmak üzere ChartYValue FromDouble yöntemini keşfedin.
type: docs
weight: 20
...
Bir tane oluşturur[`ChartYValue`](../) örneğiDouble tür.
