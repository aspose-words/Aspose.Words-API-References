...
| İsim | Tanım |
| --- | --- |
| [DateTimeValue](../../aspose.words.drawing.charts/chartyvalue/datetimevalue/) { get; } | Saklanan tarihsaat değerini alır. |
| [DoubleValue](../../aspose.words.drawing.charts/chartyvalue/doublevalue/) { get; } | Saklanan sayısal değeri alır. |
| [TimeValue](../../aspose.words.drawing.charts/chartyvalue/timevalue/) { get; } | Saklanan zaman değerini alır. |
| [ValueType](../../aspose.words.drawing.charts/chartyvalue/valuetype/) { get; } | Nesnede saklanan Y değerinin türünü alır. |
...
Bir grafik serisinin boş olmayan tüm Y değerleri aynı olmalıdır[`ChartYValueType`](../chartyvaluetype/) tip.
