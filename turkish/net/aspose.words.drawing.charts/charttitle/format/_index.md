...
description: Grafiklerinize profesyonel ve cilalı bir görünüm kazandırmak için gelişmiş dolgu ve çizgi stili için ChartTitle Format özelliğini keşfedin.
type: docs
weight: 20
url: /tr/net/aspose.words.drawing.charts/charttitle/format/
---
## ChartTitle.Format property

Grafik başlığının dolgu ve satır biçimlendirmesine erişim sağlar.
