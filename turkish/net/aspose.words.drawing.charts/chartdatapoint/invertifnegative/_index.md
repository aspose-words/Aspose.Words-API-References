...
description: ChartDataPoint InvertIfNegative özelliğinin, negatif değerler için renkleri tersine çevirerek veri görselleştirmesini nasıl geliştirdiğini, netliği ve etkiyi nasıl artırdığını keşfedin.
type: docs
weight: 50
