...
description: ChartDataPoint ClearFormat yönteminin veri noktanızın biçimini varsayılana nasıl sıfırladığını, grafiklerinizdeki netliği ve tutarlılığı nasıl artırdığını keşfedin.
type: docs
weight: 70
...
Bu veri noktasının biçimini temizler. Özellikler, ana seride tanımlanan varsayılan değerlere ayarlanır.
