...
description: Grafiklerinizdeki veri etiketi konumlandırmasını özelleştirmek için ChartDataLabel LeftMode özelliğini keşfedin. Hassas kontrolle netliği ve sunumu geliştirin.
type: docs
weight: 70
url: /tr/net/aspose.words.drawing.charts/chartdatalabel/leftmode/
---
## ChartDataLabel.LeftMode property

Yorumlama modunu alır veya ayarlar[`Left`](../left/) özellik değeri: grafikteki sol kenardan veri etiketinin location değerini belirtilen konumdan ayarlayıp ayarlamadığı[`Position`](../position/) özelliği.
