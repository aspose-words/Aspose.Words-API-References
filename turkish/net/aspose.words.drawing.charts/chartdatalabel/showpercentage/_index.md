...
description: ChartDataLabel ShowPercentage özelliğiyle grafik veri etiketlerinde yüzde gösterimini etkinleştirin. Görsel verilerinizdeki netliği ve içgörüleri geliştirin!
type: docs
weight: 180
...
Bir grafikteki veri etiketleri için yüzde değerinin görüntülenip görüntülenmeyeceğini belirtmeye olanak tanır. Varsayılan değer`YANLIŞ` .
