...
description: Grafiğinizdeki veri etiketi konumlandırmasını kontrol etmek için ChartDataLabel Left özelliğini ayarlayın. Kesin mesafe ayarlarıyla netliği ve sunumu geliştirin.
type: docs
weight: 60
url: /tr/net/aspose.words.drawing.charts/chartdatalabel/left/
---
## ChartDataLabel.Left property

Veri etiketinin grafiğin sol kenarından veya onun tarafından belirtilen konumdan uzaklığını noktalar halinde alır veya ayarlar.[`Position`](../position/) mülk, değerine bağlı olarak[`LeftMode`](../leftmode/) özelliği.
