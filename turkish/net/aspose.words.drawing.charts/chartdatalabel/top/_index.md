...
description: Gelişmiş grafik netliği için veri etiketi konumlandırmasını kontrol etmek üzere ChartDataLabel Top özelliğini ayarlayın. Görsel veri sunumunuzu zahmetsizce optimize edin!
type: docs
weight: 210
url: /tr/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

Veri etiketinin grafiğin üst kenarından veya onun tarafından belirtilen konumdan uzaklığını noktalar halinde alır veya ayarlar.[`Position`](../position/) mülk, değerine bağlı olarak[`TopMode`](../topmode/) özelliği.
...
Grafik şekli yeniden boyutlandırıldığında özelliğin değeri orantılı olarak değişir.
