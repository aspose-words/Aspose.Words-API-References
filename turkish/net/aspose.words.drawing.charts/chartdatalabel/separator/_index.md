...
description: ChartDataLabel mülk. Bir grafikteki veri etiketleri için kullanılan dize ayırıcısını alır veya ayarlar. Bunun yerine bir satır sonu kullanılacaksa yalnızca kategori adını ve yüzdeyi gösteren pasta grafikler hariç varsayılan değer bir virgüldür.
type: docs
weight: 50
...
Bir grafikteki veri etiketleri için kullanılan dize ayırıcısını alır veya ayarlar. Bunun yerine bir satır sonu kullanılacaksa, yalnızca kategori adını ve yüzdeyi gösteren pasta grafikler hariç, varsayılan değer bir virgüldür.
