...
description: Grafiğinizin veri etiketlerini özelleştirmek için ChartDataLabel Separator özelliğini keşfedin. Daha net görselleştirme ve içgörüler için dize ayırıcılarını kolayca ayarlayın.
type: docs
weight: 120
...
Bir grafikteki veri etiketleri için kullanılan dize ayırıcısını alır veya ayarlar. Yalnızca kategori adını ve yüzdeyi gösteren pasta grafikleri dışında, varsayılan değer virgüldür; bunun yerine satır sonu kullanılmalıdır.
