...
description: ChartDataLabel ShowSeriesName özelliğini keşfedin, grafiklerinizdeki seri adı görünürlüğünü kolayca kontrol edin. Basit bir Boole ayarıyla veri netliğini artırın!
type: docs
weight: 190
...
Bir grafikteki veri etiketleri için seri adı görüntüleme davranışını belirtmek üzere bir Boole değeri döndürür veya ayarlar. `doğru` dizi adını göstermek için;`YANLIŞ` gizlemek için. Varsayılan olarak`YANLIŞ` .
