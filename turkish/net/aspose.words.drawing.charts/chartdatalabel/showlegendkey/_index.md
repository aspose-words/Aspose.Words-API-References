...
description: ChartDataLabel ShowLegendKey mülk. Bir grafikteki veri etiketleri için açıklama anahtarının görüntülenip görüntülenmeyeceğini belirlemeye izin verir. Varsayılan değerYANLIŞ  C#'da.
type: docs
weight: 120
url: /tr/net/aspose.words.drawing.charts/chartdatalabel/showlegendkey/
---
## ChartDataLabel.ShowLegendKey property

Bir grafikteki veri etiketleri için açıklama anahtarının görüntülenip görüntülenmeyeceğini belirlemeye izin verir. Varsayılan değer:`YANLIŞ` .
