...
description: Grafiklerinizdeki efsane anahtarı görünürlüğünü kolayca kontrol etmek için ChartDataLabel ShowLegendKey özelliğini keşfedin. Netliği ve veri sunumunu zahmetsizce geliştirin!
type: docs
weight: 170
...
Bir grafikteki veri etiketleri için efsane anahtarının görüntülenip görüntülenmeyeceğini belirtmeye olanak tanır. Varsayılan değer`YANLIŞ` .
