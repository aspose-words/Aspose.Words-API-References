...
description: Veri görselleştirmenizi geliştirmek için ChartDataLabel ShowValue özelliğini keşfedin. Daha net içgörüler için etiketlerdeki değer gösterimini kontrol edin. Varsayılan, false.
type: docs
weight: 200
...
Veri etiketlerinde değerlerin görüntülenip görüntülenmeyeceğini belirtmeye olanak tanır. Varsayılan değer`YANLIŞ` .
