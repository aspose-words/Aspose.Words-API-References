...
description: Veri etiketi değerlerini görüntüleyerek grafiklerinizi geliştirmek için ChartDataLabel ShowDataLabelsRange özelliğini keşfedin. Bu kolay özellik ile netliği artırın!
type: docs
weight: 150
...
Veri etiketlerinde görüntülenecek veri etiketi aralığındaki değerlerin belirtilmesine olanak tanır. Varsayılan değer`YANLIŞ` .
