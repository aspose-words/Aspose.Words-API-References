...
description: ChartDataLabel ShowCategoryName özelliğiyle grafiklerinizi geliştirin. Daha net içgörüler ve daha iyi görseller için kategori adlarını veri etiketlerinde kolayca görüntüleyin.
type: docs
weight: 140
...
Bir grafikteki veri etiketleri için kategori adının görüntülenip görüntülenmeyeceğini belirtmeye olanak tanır. Varsayılan değer`YANLIŞ` .
