...
description: ChartDataPointCollection Item özelliği ile herhangi bir endeks için ChartDataPoint'e erişin. Veri görselleştirmenizi kolaylıkla ve hassasiyetle geliştirin!
type: docs
weight: 20
...
Geri Döndürür[`ChartDataPoint`](../../chartdatapoint/) belirtilen dizin için.
