...
description: ChartDataPointCollection'ın, toplam ChartDataPoint sayısını verimli bir şekilde döndüren ve veri görselleştirmenizi geliştiren Count özelliğini keşfedin.
type: docs
weight: 10
...
sayısını döndürür[`ChartDataPoint`](../../chartdatapoint/) bu koleksiyonda.
