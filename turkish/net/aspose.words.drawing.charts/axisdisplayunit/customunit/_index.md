...
description: Gelişmiş veri netliği için kullanıcı tanımlı ölçeklemeyle değer ekseni görüntüleme birimlerinizi kolayca özelleştirmek üzere AxisDisplayUnit CustomUnit özelliğini keşfedin.
type: docs
weight: 20
...
Bu özelliğin ayarlanması,[`Unit`](../unit/) özellik to Custom.
