...
description: AxisDisplayUnit mülk. Değer eksenindeki görüntüleme birimlerini ölçeklendirmek için kullanıcı tanımlı bir bölen alır veya ayarlar.
type: docs
weight: 20
...
Mülk, MS Office 2016 yeni çizelgeleri tarafından desteklenmemektedir. Varsayılan değer 1'dir.

Bu özelliğin ayarlanması,[`Unit`](../unit/) için özellikCustom.
