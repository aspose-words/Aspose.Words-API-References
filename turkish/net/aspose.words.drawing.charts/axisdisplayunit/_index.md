...
description: Aspose.Words.Drawing.Charts.AxisDisplayUnit sınıf. Değer ekseni için görüntüleme birimlerinin ölçekleme seçeneklerine erişim sağlar.
type: docs
weight: 540
...
| [Document](../../aspose.words.drawing.charts/axisdisplayunit/document/) { get; } | Başlık sahibinin ait olduğu Belgeyi döndürür. |
