...
description: Gelişmiş grafik netliği ve hassasiyeti için değer ekseni ölçekleme seçeneklerini özelleştirmek üzere Aspose.Words.Drawing.Charts.AxisDisplayUnit sınıfını keşfedin.
type: docs
weight: 790
...
Değer ekseni için görüntüleme birimlerinin ölçekleme seçeneklerine erişim sağlar.
...
| İsim | Tanım |
| --- | --- |
| [CustomUnit](../../aspose.words.drawing.charts/axisdisplayunit/customunit/) { get; set; } | Değer eksenindeki görüntüleme birimlerini ölçeklendirmek için kullanıcı tanımlı bir bölen alır veya ayarlar. |
| [Document](../../aspose.words.drawing.charts/axisdisplayunit/document/) { get; } | Üst grafiği içeren belgeyi döndürür. |
| [Unit](../../aspose.words.drawing.charts/axisdisplayunit/unit/) { get; set; } | Görüntüleme birimlerinin ölçekleme değerini önceden tanımlanmış değerlerden biri olarak alır veya ayarlar. |
