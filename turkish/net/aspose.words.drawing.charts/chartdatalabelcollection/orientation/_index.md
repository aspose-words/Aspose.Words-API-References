...
description: Veri etiketleriniz için metin yönünü kolayca özelleştirmek, grafiğinizin netliğini ve etkisini artırmak için ChartDataLabelCollection Yönlendirme özelliğini keşfedin.
type: docs
weight: 60
url: /tr/net/aspose.words.drawing.charts/chartdatalabelcollection/orientation/
---
## ChartDataLabelCollection.Orientation property

Tüm serinin veri etiketlerinin metin yönünü alır veya ayarlar.
