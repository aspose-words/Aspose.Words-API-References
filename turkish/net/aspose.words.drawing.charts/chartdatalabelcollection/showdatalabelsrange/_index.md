...
description: ChartDataLabelCollection'daki ShowDataLabelsRange özelliğini keşfedin. Serileriniz için veri etiketi görünürlüğünü kontrol edin ve veri sunumunu zahmetsizce geliştirin!
type: docs
weight: 120
url: /tr/net/aspose.words.drawing.charts/chartdatalabelcollection/showdatalabelsrange/
---
## ChartDataLabelCollection.ShowDataLabelsRange property

Veri etiketi aralığındaki değerlerin tüm serinin veri etiketlerinde görüntülenip görüntülenmeyeceğini belirtmeye olanak tanır. Varsayılan değer`YANLIŞ` .
...
Bu özellik için tanımlanan değer, kullanılarak ayrı bir veri etiketi için geçersiz kılınabilir[`ShowDataLabelsRange`](../../chartdatalabel/showdatalabelsrange/) mülk.
