...
description: Gelişmiş veri görselleştirmesi için ChartDataLabels'ın toplam sayısına hızlı erişim sağlayan ChartDataLabelCollection'ın Count özelliğini keşfedin.
type: docs
weight: 10
...
sayısını döndürür[`ChartDataLabel`](../../chartdatalabel/) bu koleksiyonda.
