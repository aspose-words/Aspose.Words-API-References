...
| İsim | Tanım |
| --- | --- |
| [Format](../../aspose.words.drawing.charts/chartmarker/format/) { get; } | Bu işaretçinin dolgu ve satır biçimlendirmesine erişim sağlar. |
| [Size](../../aspose.words.drawing.charts/chartmarker/size/) { get; set; } | Grafik işaretçi boyutunu alır veya ayarlar. Varsayılan değer 7. |
| [Symbol](../../aspose.words.drawing.charts/chartmarker/symbol/) { get; set; } | Grafik işaretçi simgesini alır veya ayarlar. |
