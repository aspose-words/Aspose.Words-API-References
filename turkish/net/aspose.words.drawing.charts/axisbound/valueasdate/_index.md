...
description: AxisBound mülk. Tarih saat olarak temsil edilen eksen sınırının değerini döndürür.
type: docs
weight: 40
...
Tarih saat olarak temsil edilen eksen sınırının değerini döndürür.
