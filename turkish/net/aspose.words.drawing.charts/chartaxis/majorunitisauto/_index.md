...
description: ChartAxis MajorUnitIsAuto özelliğini keşfedin, veri görselleştirmelerinizde gelişmiş grafik netliği ve hassasiyeti için büyük onay işareti aralıklarını kolayca kontrol edin.
type: docs
weight: 140
...
Ana işaretler arasındaki varsayılan mesafenin kullanılıp kullanılmayacağını belirten bir bayrak alır veya ayarlar.
