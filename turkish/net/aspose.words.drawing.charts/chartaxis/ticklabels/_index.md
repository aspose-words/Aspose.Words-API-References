...
description: Grafiklerinizdeki gelişmiş veri görselleştirmesi ve netlik için eksen onay işareti etiketlerinizi özelleştirmek üzere ChartAxis TickLabels özelliğini keşfedin.
type: docs
weight: 230
url: /tr/net/aspose.words.drawing.charts/chartaxis/ticklabels/
---
## ChartAxis.TickLabels property

Eksen onay işareti etiketlerinin özelliklerine erişim sağlar.
