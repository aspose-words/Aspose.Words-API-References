...
description: Eksen değerlerini tersten kolayca görüntülemek ve veri netliğini maksimumdan minimuma artırmak için ChartAxis ReverseOrder özelliğini keşfedin.
type: docs
weight: 210
...
Eksen değerlerinin ters sırada, yani maksimumdan minimuma doğru görüntülenip görüntülenmeyeceğini belirten bir bayrak döndürür veya ayarlar.
...
Özellik MS Office 2016 yeni grafikleri tarafından desteklenmiyor. Varsayılan değer`YANLIŞ` .
