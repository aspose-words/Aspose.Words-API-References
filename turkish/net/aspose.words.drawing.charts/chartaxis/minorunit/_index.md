...
description: ChartAxis mülk. Küçük onay işaretleri arasındaki mesafeyi döndürür veya ayarlar.
type: docs
weight: 140
...
Bu özelliğin ayarlanması,[`MinorUnitIsAuto`](../minorunitisauto/) mülk **yanlış**.
