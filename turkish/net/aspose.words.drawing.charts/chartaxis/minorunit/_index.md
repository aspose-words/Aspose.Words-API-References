...
description: Grafik netliğini ve hassasiyetini artırmak için küçük işaret aralıklarını kolayca ayarlamak üzere ChartAxis MinorUnit özelliğini keşfedin.
type: docs
weight: 170
...
Küçük işaretler arasındaki mesafeyi döndürür veya ayarlar.
...
Bu özelliğin ayarlanması,[`MinorUnitIsAuto`](../minorunitisauto/) mülk`YANLIŞ`.
