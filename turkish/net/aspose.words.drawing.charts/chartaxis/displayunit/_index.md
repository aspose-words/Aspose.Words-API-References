...
description: ChartAxis DisplayUnit özelliğinin, daha net içgörüler için değer ekseni ölçeklemesini optimize ederek veri görselleştirmenizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 60
...
Değer ekseni için görüntüleme birimlerinin ölçekleme değerini belirtir.
