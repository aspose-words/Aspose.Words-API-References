...
description: ChartAxis MinorUnitIsAuto özelliğinin grafiğinizin işaretlerini daha net veri görselleştirmesi için nasıl optimize ettiğini keşfedin. Grafiklerinizi zahmetsizce geliştirin!
type: docs
weight: 180
...
Küçük işaretler arasındaki varsayılan mesafenin kullanılıp kullanılmayacağını belirten bir bayrak alır veya ayarlar.
...
Özellik zaman kategorisi ve değer eksenleri için etkilidir.
