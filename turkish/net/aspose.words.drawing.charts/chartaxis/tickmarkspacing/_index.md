...
description: Grafiklerinizin okunabilirliğini ve görsel çekiciliğini artırmak için, işaret aralıklarını özelleştirmek amacıyla ChartAxis TickMarkSpacing özelliğini keşfedin.
type: docs
weight: 240
...
İşaretlerin çizildiği aralığı alır veya ayarlar.
...
Özellik, metin kategorisi ve seri eksenleri için etkilidir. MS Office 2016 yeni grafikler tarafından desteklenmez.
