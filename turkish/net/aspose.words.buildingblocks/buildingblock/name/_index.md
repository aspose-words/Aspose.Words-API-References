...
description: BuildingBlock mülk. Bu yapı taşının adını alır veya ayarlar.
type: docs
weight: 90
...
Bu yapı taşının adını alır veya ayarlar.
...
Ad, genellikle kolay bir tanımlayıcı olan herhangi bir dize içeriği içerebilir. Birden çok yapı taşı aynı ada sahip olabilir.

Olamaz`hükümsüz` ve boş bir dize olamaz.

karşılık gelir **docPartPr.name** OOXML'deki eleman.
