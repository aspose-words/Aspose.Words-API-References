...
description: Projelerinizdeki yapı taşı türlerini tanımlamak için gerekli olan BuildingBlock Type özelliğini keşfedin. Tasarımınızı netlik ve kesinlikle geliştirin!
type: docs
weight: 120
...
Yapı bloğu türü, Microsoft Word'deki yapı bloğunun görünürlüğünü ve davranışını etkileyebilir.

Karşılık gelir**docPartPr.türleri** OOXML'deki öğe.
