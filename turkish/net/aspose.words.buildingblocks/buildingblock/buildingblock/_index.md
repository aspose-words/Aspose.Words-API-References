...
Ne zaman[`BuildingBlock`](../../buildingblock) oluşturulur, belirtilen sözlük belgesine, aittir, ancak henüz sözlük belgesinin bir parçası değildir ve[`ParentNode`](../../../aspose.words/node/parentnode) dır-dir`hükümsüz`.

Eklemek[`BuildingBlock`](../../buildingblock) bir[`GlossaryDocument`](../../glossarydocument) kullan[`AppendChild`](../../../aspose.words/compositenode/appendchild).
