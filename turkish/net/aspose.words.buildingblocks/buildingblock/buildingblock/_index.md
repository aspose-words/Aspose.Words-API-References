...
description: BuildingBlock oluşturucusunu keşfedin, zahmetsizce yeni örnekler yaratın. Kusursuz geliştirme ve gelişmiş performans için güçlü özelliklerin kilidini açın!
type: docs
weight: 10
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| glossaryDoc | GlossaryDocument | Sahip belgesi. |

## Notlar

Ne zaman[`BuildingBlock`](../) oluşturulduğunda, belirtilen sözlük belgesine aittir, ancak henüz sözlük belgesinin bir parçası değildir ve[`ParentNode`](../../../aspose.words/node/parentnode/) dır`hükümsüz`.

Eklemek için[`BuildingBlock`](../)birine[`GlossaryDocument`](../../glossarydocument/) kullanın[`AppendChild`](../../../aspose.words/compositenode/appendchild/).
