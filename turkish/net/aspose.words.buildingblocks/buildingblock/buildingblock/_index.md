...
Ne zaman[`BuildingBlock`](../) oluşturulur, belirtilen sözlük belgesine, aittir, ancak henüz sözlük belgesinin bir parçası değildir ve[`ParentNode`](../../../aspose.words/node/parentnode/) dır-dir`hükümsüz`.

Eklemek[`BuildingBlock`](../) bir[`GlossaryDocument`](../../glossarydocument/) kullan[`AppendChild`](../../../aspose.words/compositenode/appendchild/).
