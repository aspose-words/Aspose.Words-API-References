...
description: BuildingBlock Davranışının, kusursuz entegrasyon ve gelişmiş iş akışı için içerik ekleme yöntemlerini tanımlayarak belgenizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 20
...
Yapı bloğunun içeriği ana belgeye eklendiğinde uygulanacak davranışı belirtir.
