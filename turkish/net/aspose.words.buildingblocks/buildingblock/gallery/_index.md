...
description: BuildingBlock mülk. sınıflandırma veya kullanıcı arabirimi sıralama amaçları için yapı taşı için birinci düzey kategorizasyonu belirtir.
type: docs
weight: 60
...
sınıflandırma veya kullanıcı arabirimi sıralama amaçları için yapı taşı için birinci düzey kategorizasyonu belirtir.
...
Microsoft Word kullanıcı arabirimindeki yapı taşları, Galeriler halinde düzenlenir. Her biri`Gallery` birden fazla Kategori olabilir. a içindeki her blok[`Category`](../category/) sahip[`Name`](../name/).

karşılık gelir **docPartPr.category.gallery** OOXML'deki eleman.
