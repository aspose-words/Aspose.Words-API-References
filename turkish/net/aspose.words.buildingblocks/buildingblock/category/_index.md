...
Yapı taşı için ikinci düzey kategorizasyonu belirtir.
...
Microsoft Word kullanıcı arabirimindeki yapı taşları, Galeriler halinde düzenlenir. Her biri[`Gallery`](../gallery/) birden fazla Kategori olabilir. a içindeki her blok`Category` sahip[`Name`](../name/).

Olamaz`hükümsüz` ve boş bir dize olamaz.

karşılık gelir **docPartPr.category.name** OOXML'deki eleman.
