...
description: GlossaryDocument'ta FirstBuildingBlock özelliğini keşfedin. Sorunsuz belge yönetimi için ilk yapı bloğuna kolayca erişin.
type: docs
weight: 30
...
Sözlük belgesindeki ilk yapı taşını alır.
...
Geri Döndürür`hükümsüz` eğer mevcut yapı taşları yoksa.
