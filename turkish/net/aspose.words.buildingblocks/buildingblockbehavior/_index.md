...
description: Sorunsuz düzenleme için yapı taşlarının belgenizin içeriğini eklendiğinde nasıl geliştireceğini tanımlayan Aspose.Words BuildingBlockBehavior enum'unu keşfedin.
type: docs
weight: 330
...
Ana belgeye eklendiğinde yapı bloğunun içeriğine uygulanacak davranışı belirtir.
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Content | `0` | Yapı bloğunun satır içi içerik olarak ekleneceğini belirtir. |
| Paragraph | `1` | Yapı bloğunun kendi paragrafına ekleneceğini belirtir. |
| Page | `2` | Yapı bloğunun kendi sayfasına ekleneceğini belirtir. |
| Default | `0` | AynısıContent . |
