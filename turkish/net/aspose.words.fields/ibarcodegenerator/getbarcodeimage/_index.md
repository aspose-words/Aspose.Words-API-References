...
description: iBarcodeGenerator'ın GetBarcodeImage metoduyla zahmetsizce özel barkod görüntüleri oluşturun. DisplayBarcode alanınızı verimli bir şekilde geliştirmek için ideal!
type: docs
weight: 10
url: /tr/net/aspose.words.fields/ibarcodegenerator/getbarcodeimage/
---
## IBarcodeGenerator.GetBarcodeImage method

Parametre kümesini kullanarak barkod görüntüsünü oluşturun (DisplayBarcode alanı için).
