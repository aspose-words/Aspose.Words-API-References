...
description: FieldSymbol IsAnsi özelliğini keşfedin, gelişmiş veri işleme ve iyileştirilmiş kodlama verimliliği için ANSI karakter kodlarını kolayca yönetin.
type: docs
weight: 60
url: /tr/net/aspose.words.fields/fieldsymbol/isansi/
---
## FieldSymbol.IsAnsi property

Karakter kodunun bir ANSI karakterinin değeri olarak yorumlanıp yorumlanmayacağını alır veya ayarlar.
