...
description: FieldDisplayBarcode'un SymbolRotation özelliğini keşfedin. 0-3 geçerli değerleriyle optimum tarama için barkod dönüşünü kolayca ayarlayın. Veri görüntünüzü geliştirin!
type: docs
weight: 140
url: /tr/net/aspose.words.fields/fielddisplaybarcode/symbolrotation/
---
## FieldDisplayBarcode.SymbolRotation property

Barkod sembolünün dönüşünü alır veya ayarlar. Geçerli değerler [0, 3]'tür
