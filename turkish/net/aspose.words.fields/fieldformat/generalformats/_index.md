...
description: Veri sunumunuzu ve sonuçlarınızı geliştirmek için çok yönlü sayısal metin biçimleri koleksiyonu sunan FieldFormat GeneralFormats özelliğini keşfedin.
type: docs
weight: 20
