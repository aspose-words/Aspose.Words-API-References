...
description: Dipnot ve sonnot numaralandırmasını kolayca yönetmek ve belgelerinizi kusursuz açıklamalarla geliştirmek için FieldRef IncludeNoteOrComment özelliğini keşfedin.
type: docs
weight: 30
...
Yer imi tarafından işaretlenen dipnot, sonnot ve açıklama numaralarının artırılıp artırılmayacağını alır veya ayarlar ve karşılık gelen dipnot, sonnot ve yorum metnini ekler.
