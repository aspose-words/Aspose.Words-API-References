...
description: FieldRef mülk. Yer imi tarafından işaretlenen dipnot son not ve ek açıklama numaralarının artırılıp artırılmayacağını ve ilgili dipnotu son notu ve yorum metnini ekleyip eklememeyi ayarlar.
type: docs
weight: 30
...
Yer imi tarafından işaretlenen dipnot, son not ve ek açıklama numaralarının artırılıp artırılmayacağını ve ilgili dipnotu, son notu ve yorum metnini ekleyip eklememeyi ayarlar.
