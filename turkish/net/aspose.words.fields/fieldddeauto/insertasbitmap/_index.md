...
description: Bağlı nesnenin bitmap olarak eklenip eklenmeyeceğini alır veya ayarlar.
type: docs
weight: 20
...
Bağlı nesnenin bitmap olarak eklenip eklenmeyeceğini alır veya ayarlar.
