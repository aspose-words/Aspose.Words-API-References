...
description: Bağlantılı nesnenin salt metin biçiminde eklenip eklenmeyeceğini alır veya ayarlar.
type: docs
weight: 60
url: /tr/net/aspose.words.fields/fieldddeauto/insertastext/
---
## FieldDdeAuto.InsertAsText property

Bağlantılı nesnenin salt metin biçiminde eklenip eklenmeyeceğini alır veya ayarlar.
