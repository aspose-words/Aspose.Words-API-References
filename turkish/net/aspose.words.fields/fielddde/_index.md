...
description: Aspose.Words.Fields.FieldDde sınıf. DDE alanını uygular C#'da.
type: docs
weight: 1780
...
| [InsertAsBitmap](../../aspose.words.fields/fielddde/insertasbitmap/) { get; set; } | Bağlantılı nesnenin bitmap olarak eklenip eklenmeyeceğini alır veya ayarlar. |
| [InsertAsHtml](../../aspose.words.fields/fielddde/insertashtml/) { get; set; } | Bağlantılı nesnenin HTML biçimindeki metin olarak eklenip eklenmeyeceğini alır veya ayarlar. |
| [InsertAsPicture](../../aspose.words.fields/fielddde/insertaspicture/) { get; set; } | Bağlı nesnenin resim olarak eklenip eklenmeyeceğini alır veya ayarlar. |
...
| [InsertAsText](../../aspose.words.fields/fielddde/insertastext/) { get; set; } | Bağlı nesnenin salt metin biçiminde eklenip eklenmeyeceğini alır veya ayarlar. |
| [InsertAsUnicode](../../aspose.words.fields/fielddde/insertasunicode/) { get; set; } | Bağlı nesnenin Unicode metin olarak eklenip eklenmeyeceğini alır veya ayarlar. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Belgede yapılan diğer değişiklikler nedeniyle alanın geçerli sonucunun artık doğru (eski) olup olmadığını alır veya ayarlar. |
| [IsLinked](../../aspose.words.fields/fielddde/islinked/) { get; set; } | Grafik verilerini belgede saklamayarak dosya boyutunun küçültülüp küçültülmeyeceğini alır veya ayarlar. |
...
| [SourceItem](../../aspose.words.fields/fielddde/sourceitem/) { get; set; } | Kaynak dosyanın bağlanılan kısmını alır veya ayarlar. |
...
Başka bir uygulamadan kopyalanan bilgiler için bu alan, bu bilgiyi DDE. kullanarak orijinal kaynak dosyasına bağlar.
