...
description: Projelerinizdeki görüntü konumlarını gelişmiş organizasyon ve erişilebilirlik için kolayca yönetmek amacıyla FieldImport SourceFullName özelliğinin nasıl kullanılacağını keşfedin.
type: docs
weight: 40
