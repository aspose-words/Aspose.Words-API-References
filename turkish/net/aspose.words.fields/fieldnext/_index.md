...
description: Belgelerinizdeki NEXT alanlarını verimli bir şekilde yönetmek için Aspose.Words.Fields.FieldNext sınıfını keşfedin. Belge otomasyonunuzu bugün geliştirin!
type: docs
weight: 2590
...
Yeni bir birleştirilmiş belge başlatmak yerine, bir sonraki veri kaydını geçerli birleştirilmiş belgeye birleştirir.
