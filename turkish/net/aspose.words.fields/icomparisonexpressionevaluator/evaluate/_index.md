...
description: Hassas karşılaştırma değerlendirmeleri için IComparisonExpressionEvaluator'ın Evaluate metodunu keşfedin. Güçlü aracımızla kodlama verimliliğinizi artırın!
type: docs
weight: 10
...
Uygulama şunu döndürmelidir:`hükümsüz` varsayılan değerlendirmenin yapılması gerektiğini belirtmek için.
