...
description: FieldToa mülk. Aynı otoritesine yapılan beş veya daha fazla farklı sayfa referansının alıntılanan çalışmada bir kelimenin veya pasajın sık sık geçtiğini belirtmek için kullanılan passim ile değiştirilip değiştirilmeyeceğini ayarlar .
type: docs
weight: 110
...
Aynı otoritesine yapılan beş veya daha fazla farklı sayfa referansının, alıntılanan çalışmada bir kelimenin veya pasajın sık sık geçtiğini belirtmek için kullanılan "passim" ile değiştirilip değiştirilmeyeceğini ayarlar .
