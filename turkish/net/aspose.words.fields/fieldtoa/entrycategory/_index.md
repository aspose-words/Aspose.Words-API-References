...
description: Tablo girişleriniz için integral kategorileri etkin bir şekilde yönetmek ve özelleştirmek için FieldToa'nın EntryCategory özelliğini keşfedin. Organizasyonu bugün geliştirin!
type: docs
weight: 30
url: /tr/net/aspose.words.fields/fieldtoa/entrycategory/
---
## FieldToa.EntryCategory property

Tabloda yer alan girdiler için integral kategorisini alır veya ayarlar.
