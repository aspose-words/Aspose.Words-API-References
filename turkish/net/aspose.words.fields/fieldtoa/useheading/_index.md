...
description: FieldToa UseHeading özelliğinin, daha iyi organizasyon ve netlik için kategori başlıkları ekleyerek yetki tablonuzu nasıl geliştirdiğini keşfedin.
type: docs
weight: 100
...
Yetkililer tablosundaki girdiler için kategori başlığının eklenip eklenmeyeceğini alır veya ayarlar.
