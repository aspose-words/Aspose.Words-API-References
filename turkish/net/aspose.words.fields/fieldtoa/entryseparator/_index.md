...
description: FieldToa mülk. Bir otorite tablosu girdisi ile sayfa numarasını ayırmak için kullanılan karakter dizisini alır veya ayarlar.
type: docs
weight: 40
...
Bir otorite tablosu girdisi ile sayfa numarasını ayırmak için kullanılan karakter dizisini alır veya ayarlar.
