...
description: Uygulamalarınızda sıra adlarını kolayca yönetmek ve sayfa numaralandırmasını geliştirmek için FieldToa SequenceName özelliğini keşfedin. İş akışınızı bugün optimize edin!
type: docs
weight: 80
url: /tr/net/aspose.words.fields/fieldtoa/sequencename/
---
## FieldToa.SequenceName property

Sayfa numarasına dahil olan bir dizinin adını alır veya ayarlar.
