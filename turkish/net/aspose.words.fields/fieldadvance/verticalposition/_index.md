...
description: Sayfanızdaki metin konumunu kolayca ayarlamak, düzen denetimini ve okunabilirliği artırmak için FieldAdvance VerticalPosition özelliğini keşfedin.
type: docs
weight: 70
...
Alanı takip eden metnin sayfanın üst kenarından dikey olarak hareket ettirileceği nokta sayısını alır veya ayarlar.
