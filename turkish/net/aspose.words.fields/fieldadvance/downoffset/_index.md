...
description: FieldAdvance DownOffset özelliğini keşfedin, gelişmiş belge biçimlendirmesi için dikey aralık üzerinde hassas kontrolle metin konumunu kolayca ayarlayın.
type: docs
weight: 20
...
Alanı takip eden metnin aşağı hareket ettirileceği nokta sayısını alır veya ayarlar.
