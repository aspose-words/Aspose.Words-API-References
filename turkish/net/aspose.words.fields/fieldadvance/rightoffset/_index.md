...
description: FieldAdvance RightOffset özelliğini keşfedin, gelişmiş belge biçimlendirmesi ve netliği için hassas nokta denetimiyle metin konumunu kolayca ayarlayın.
type: docs
weight: 50
url: /tr/net/aspose.words.fields/fieldadvance/rightoffset/
---
## FieldAdvance.RightOffset property

Alanı takip eden metnin sağa kaydırılacağı nokta sayısını alır veya ayarlar.
