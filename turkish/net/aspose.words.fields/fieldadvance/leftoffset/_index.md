...
description: FieldAdvance LeftOffset mülk. Alanı takip eden metnin sola taşınması gereken nokta sayısını alır veya ayarlar C#'da.
type: docs
weight: 40
...
Alanı takip eden metnin sola taşınması gereken nokta sayısını alır veya ayarlar.
