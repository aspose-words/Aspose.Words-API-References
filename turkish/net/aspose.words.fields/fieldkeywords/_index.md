...
description: Aspose.Words.Fields.FieldKeywords sınıf. ANAHTAR KELİMELER alanını uygular C#'da.
type: docs
weight: 2090
...
Belgenin anahtar sözcüklerini, belgede kaydedildiği şekliyle alır ve isteğe bağlı olarak ayarlar.**Anahtar Kelimeler** the yerleşik belge özelliklerinin özelliği.
