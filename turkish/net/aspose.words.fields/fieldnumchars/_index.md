...
description: Gelişmiş belge işleme için NUMCHARS alanını verimli bir şekilde uygulamak üzere tasarlanmış Aspose.Words.Fields.FieldNumChars sınıfını keşfedin.
type: docs
weight: 2620
...
Geçerli belgedeki karakter sayısını, kaydedildiği şekilde alır.**Karakterler** the yerleşik belge özelliklerinin özelliği.
