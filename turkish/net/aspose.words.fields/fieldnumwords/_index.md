...
description: Belgelerde kolay kelime sayımı yönetimi için Aspose.Words.Fields.FieldNumWords sınıfını keşfedin. Bu güçlü özellik ile metin işlemenizi geliştirin!
type: docs
weight: 2640
...
Geçerli belgedeki sözcük sayısını, belgede kaydedildiği gibi alır.**Kelimeler** the yerleşik belge özelliklerinin özelliği.
