...
description: FieldOptions mülk. t anahtarı için özel stil ayırıcı alır veya ayarlarFieldToc alan.
type: docs
weight: 50
...
\t anahtarı için özel stil ayırıcı alır veya ayarlar[`FieldToc`](../../fieldtoc/) alan.
...
Varsayılan olarak, \t anahtarıyla tanımlanan özel stiller[`FieldToc`](../../fieldtoc/) alanı, geçerli kültürden alınan bir sınırlayıcı ile ayrılır. Bu özellik, kullanıcı tanımlı bir sınırlayıcı belirterek bu davranışı geçersiz kılar.
