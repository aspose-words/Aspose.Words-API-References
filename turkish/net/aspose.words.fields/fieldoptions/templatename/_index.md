...
Bu özellik tarafından kullanılır[`FieldTemplate`](../../fieldtemplate/) alan ise[`AttachedTemplate`](../../../aspose.words/document/attachedtemplate/) mülk boş.

Bu özellik boşsa, varsayılan şablon dosya adı`Normal.dotm` kullanıldı.
