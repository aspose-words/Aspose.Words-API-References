...
description: Varsayılan belge yazarının adını alır veya ayarlar. Yazarın adı yerleşik belge özelliklerinde zaten belirtilmişse bu seçenek dikkate alınmaz.
type: docs
weight: 60
