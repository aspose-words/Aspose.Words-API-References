...
description: FieldDatabase InsertHeadings özelliğiyle veritabanınızı verimli bir şekilde yönetin. Daha net veri sunumu için sütun başlıklarını kolayca özelleştirin.
type: docs
weight: 60
...
Alan adlarının veritabanından sütun başlıkları olarak eklenip eklenmeyeceğini alır veya ayarlar.
