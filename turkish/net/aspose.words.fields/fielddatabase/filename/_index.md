...
description: Veritabanınızın tam yolunu ve dosya adını kolayca yönetmek, verilerinizin organizasyonunu ve erişimini geliştirmek için FieldDatabase FileName özelliğini keşfedin.
type: docs
weight: 30
...
Veritabanının tam yolunu ve dosya adını alır veya ayarlar
