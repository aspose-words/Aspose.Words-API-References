...
description: FieldDatabase LastRecord özelliğini keşfedin. Sorunsuz veri ekleme ve gelişmiş veritabanı verimliliği için son veri kayıt numaranızı kolayca yönetin.
type: docs
weight: 80
url: /tr/net/aspose.words.fields/fielddatabase/lastrecord/
---
## FieldDatabase.LastRecord property

Eklenecek son veri kaydının tamsayı kayıt numarasını alır veya ayarlar.
