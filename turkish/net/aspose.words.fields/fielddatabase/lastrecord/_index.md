...
description: FieldDatabase LastRecord mülk. Eklenecek son veri kaydının integral kayıt numarasını alır veya ayarlar C#'da.
type: docs
weight: 80
...
Eklenecek son veri kaydının integral kayıt numarasını alır veya ayarlar.
