...
description: FieldDatabase'deki FirstRecord özelliğini keşfedin, sorunsuz veri girişi ve gelişmiş verimlilik için başlangıç veri kaydı numaranızı kolayca yönetin.
type: docs
weight: 40
...
Eklenecek ilk veri kaydının tamsayı kayıt numarasını alır veya ayarlar.
