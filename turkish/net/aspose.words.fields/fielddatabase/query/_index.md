...
description: FieldDatabase Query ile veritabanınızı zahmetsizce yönetin. Verimli veri sorgulaması için SQL talimatlarını kolayca ayarlayın ve alın.
type: docs
weight: 90
...
Veritabanını sorgulayan bir dizi SQL talimatını alır veya ayarlar.
