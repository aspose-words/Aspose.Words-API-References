...
description: FieldXE'nin IsItalic özelliğinin, sayfa numaralarına italik biçimlendirmeyi kolayca uygulayarak belgenizin stilini nasıl geliştirdiğini ve cilalı bir görünüm sağladığını keşfedin.
type: docs
weight: 40
