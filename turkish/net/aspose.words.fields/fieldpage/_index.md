...
description: Kusursuz PAGE alanı uygulaması için Aspose.Words.Fields.FieldPage sınıfını keşfedin. Belge otomasyonunuzu bugün güçlü özellikler ile geliştirin!
type: docs
weight: 2670
url: /tr/net/aspose.words.fields/fieldpage/
---
## FieldPage class
...
// Aşağıda belgelerimizin boyutunu takip etmek için kullanabileceğimiz üç tip alan bulunmaktadır.
// 1 - NUMCHARS alanıyla karakter sayısını takip edin:
...
// Aspose.Words veya Microsoft Word kullanarak belgeyi programatik olarak düzenlerken.
 // Güncel bir değer görmek istediğimizde bunları güncellememiz gerekiyor.
doc.UpdateFields();
