...
description: Aspose.Words.Fields.FieldUserName sınıf. USERNAME alanını uygular C#'da.
type: docs
weight: 2600
...
| [UserName](../../aspose.words.fields/fieldusername/username/) { get; set; } | Geçerli kullanıcının adını hareket ettirin veya ayarlayın. |
