...
description: Tanınmayan alanları verimli bir şekilde işlemek için Aspose.Words.Fields.FieldUnknown sınıfını keşfedin. Sorunsuz entegrasyonla belge işlemenizi geliştirin!
type: docs
weight: 2960
...
// Alan kodunda nesnel alan türünü belirtmeyen bir alan ekle.
Field field = builder.InsertField(" NOTAREALFIELD //A");

// "FieldNone" alan türü bu tür alanlar için ayrılmıştır.
Assert.AreEqual(FieldType.FieldNone, field.Type);

// Bu alanlarla çalışmaya devam edebilir ve bunları FieldUnknown sınıfının örnekleri olarak atayabiliriz.
