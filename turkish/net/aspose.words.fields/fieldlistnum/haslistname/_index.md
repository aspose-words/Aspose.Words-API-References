...
description: FieldListNum HasListName özelliğinin, gelişmiş belge biçimlendirmesi için alan koduna soyut bir numaralandırma tanımı adının eklenip eklenmediğini nasıl gösterdiğini keşfedin.
type: docs
weight: 20
...
Soyut numaralandırma tanımının adının alanın kodu tarafından sağlanıp sağlanmadığını belirten bir değer döndürür.
