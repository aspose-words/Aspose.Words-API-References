...
description: FieldBibliography FormatLanguageId özelliğinin, daha iyi anlaşılırlık için özelleştirilebilir dil ayarlarıyla belgenizin bibliyografik kaynaklarını nasıl geliştirdiğini keşfedin.
type: docs
weight: 30
...
Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini alır veya ayarlar.
