...
description: SourceTag özelliğiyle bibliyografinizi zahmetsizce yönetin; kaynakları eşleşen etiketlere göre filtreleyerek kişiselleştirilmiş, düzenli bir referans listesi oluşturun.
type: docs
weight: 40
url: /tr/net/aspose.words.fields/fieldbibliography/sourcetag/
---
## FieldBibliography.SourceTag property

Kaynakçada yalnızca Etiket öğesi değeriyle eşleşen kaynakların görüntülenmesini sağlayacak bir değer alır veya ayarlar.
