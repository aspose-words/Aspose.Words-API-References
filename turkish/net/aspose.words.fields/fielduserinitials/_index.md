...
description: USERINITIALS alanlarını kolayca uygulamak, belge kişiselleştirmesini ve kullanıcı etkileşimini geliştirmek için Aspose.Words.Fields.FieldUserInitials sınıfını keşfedin.
type: docs
weight: 3000
url: /tr/net/aspose.words.fields/fielduserinitials/
---
## FieldUserInitials class

USERINITIALS alanını uygular.
...
| [UserInitials](../../aspose.words.fields/fielduserinitials/userinitials/) { get; set; } | Geçerli kullanıcının baş harflerini alır veya ayarlar. |
...
Mevcut kullanıcının baş harflerini alır.
