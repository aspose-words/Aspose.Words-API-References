...
description: FieldToc PreserveLineBreaks özelliğinin, okunabilirliği ve biçimlendirmeyi iyileştirmek için yeni satır karakterlerini koruyarak tablo girişlerini nasıl geliştirdiğini keşfedin.
type: docs
weight: 130
...
Tablo girişleri içindeki yeni satır karakterlerinin korunup korunmayacağını alır veya ayarlar.
