...
description: FieldToc EntrySeparator özelliğini keşfedin, giriş sayfası gezintisini geliştirmek ve belge organizasyonunu iyileştirmek için karakter dizilerini özelleştirin.
type: docs
weight: 70
...
Bir girişi ve sayfa numarasını ayıran karakter dizisini alır veya ayarlar.
