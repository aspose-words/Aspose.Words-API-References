...
description: FieldToc mülk. Bir şekil tablosu oluştururken kullanılan dizi tanımlayıcısının adını alır veya ayarlar.
type: docs
weight: 160
...
Bir şekil tablosu oluştururken kullanılan dizi tanımlayıcısının adını alır veya ayarlar.
