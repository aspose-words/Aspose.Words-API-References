...
description: FieldToc PreserveTabs özelliğinin, tablo girişlerindeki sekme girişlerini koruyarak daha iyi bir organizasyon sağlayarak veri yönetiminizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 140
url: /tr/net/aspose.words.fields/fieldtoc/preservetabs/
---
## FieldToc.PreserveTabs property

Tablo girişleri içindeki sekme girişlerinin korunup korunmayacağını alır veya ayarlar.
