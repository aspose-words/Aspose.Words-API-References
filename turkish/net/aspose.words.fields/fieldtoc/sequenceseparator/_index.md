...
description: Belgenizin dizisini ve sayfa numarası biçimlendirmesini zahmetsizce özelleştirmek için FieldToc SequenceSeparator özelliğini keşfedin. Netliği ve organizasyonu geliştirin!
type: docs
weight: 150
...
Sıra numaralarını ve sayfa numaralarını ayırmak için kullanılan karakter dizisini alır veya ayarlar.
