...
description: İçindekiler tablonuzu FieldToc'un UpdatePageNumbers yöntemi ile zahmetsizce güncelleyin, böylece doğru gezinme ve gelişmiş belge kullanılabilirliği sağlayın.
type: docs
weight: 180
...
Bu içerik tablosundaki öğelerin sayfa numaralarını günceller.
...
`doğru` işlem başarılı olursa. İlgili TOC yer imlerinden herhangi biri kaldırılmışsa,`YANLIŞ` iade edilecektir.
