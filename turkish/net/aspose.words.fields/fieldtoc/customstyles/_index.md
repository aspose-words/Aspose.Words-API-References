...
description: İçindekiler tablonuzu FieldToc'un CustomStyles özelliğiyle özelleştirin. Gelişmiş sunum için yerleşik başlıkların ötesinde benzersiz stiller kolayca ekleyin.
type: docs
weight: 40
url: /tr/net/aspose.words.fields/fieldtoc/customstyles/
---
## FieldToc.CustomStyles property

İçindekiler tablosuna dahil edilecek yerleşik başlık stilleri dışındaki stillerin listesini alır veya ayarlar.
