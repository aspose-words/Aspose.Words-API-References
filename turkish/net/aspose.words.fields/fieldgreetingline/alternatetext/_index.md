...
description: İsimler eksik olduğunda özel metin görüntüleyerek kullanıcı deneyimini geliştirmek için FieldGreetingLine AlternateText özelliğinin nasıl kullanılacağını keşfedin.
type: docs
weight: 20
...
Ad boşsa alana eklenecek metni alır veya ayarlar.
