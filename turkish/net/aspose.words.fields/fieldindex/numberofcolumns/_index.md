...
description: FieldIndex mülk. Dizini oluştururken kullanılan sayfa başına sütun sayısını alır veya ayarlar.
type: docs
weight: 100
...
Dizini oluştururken kullanılan sayfa başına sütun sayısını alır veya ayarlar.
