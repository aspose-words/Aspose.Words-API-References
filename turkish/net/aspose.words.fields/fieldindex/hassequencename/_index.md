...
description: FieldIndex mülk. Alanın sonucu oluşturulurken bir dizinin kullanılması gerekip gerekmediğini gösteren bir değer alır.
type: docs
weight: 60
...
Alanın sonucu oluşturulurken bir dizinin kullanılması gerekip gerekmediğini gösteren bir değer alır.
