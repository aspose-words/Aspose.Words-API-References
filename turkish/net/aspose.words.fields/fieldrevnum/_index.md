...
description: Aspose.Words.Fields.FieldRevNum sınıf. REVNUM alanını uygular.
type: docs
weight: 2190
...
Belgenin revizyon numarasını, **Revizyon**the yerleşik belge özelliklerinin özelliği.
