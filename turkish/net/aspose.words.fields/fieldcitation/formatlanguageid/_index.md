...
description: FieldCitation FormatLanguageId özelliğinin bibliyografik stiller için dil kimliklerini yöneterek belgelerinizdeki atıf biçimlendirmesini nasıl geliştirdiğini keşfedin.
type: docs
weight: 30
...
Belgedeki alıntı 'yi biçimlendirmek için belirtilen bibliyografik stil ile birlikte kullanılan dil kimliğini alır veya ayarlar.
