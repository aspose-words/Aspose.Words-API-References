...
description: FieldCitation SourceTag özelliğini keşfedin, sorunsuz veri ekleme ve gelişmiş kaynak doğruluğu için Etiket öğelerini kolayca yönetin ve özelleştirin.
type: docs
weight: 60
...
Eşleşen bir değeri alır veya ayarlar**Etiket** eklenecek kaynağın öğe değeri.
