...
description: FieldCitation AnotherSourceTag özelliğinin, doğru referanslama için birden fazla kaynaktan gelen değerleri birbirine bağlayarak alıntılarınızı nasıl geliştirdiğini keşfedin.
type: docs
weight: 20
...
Eşleşen bir değeri alır veya ayarlar**Etiket** atıflarda yer alacak başka bir kaynağın öğe değeri.
