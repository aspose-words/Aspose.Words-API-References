...
description: Gelişmiş veri işleme için karşılaştırma ifadelerinizin sağ tarafını kolayca yönetmek ve özelleştirmek amacıyla FieldNextIf RightExpression özelliğini keşfedin.
type: docs
weight: 40
