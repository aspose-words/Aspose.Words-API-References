...
description: Bağlantılı nesnenin HTML biçiminde metin olarak eklenip eklenmeyeceğini alır veya ayarlar.
type: docs
weight: 50
...
Bağlantılı nesnenin HTML biçiminde metin olarak eklenip eklenmeyeceğini alır veya ayarlar.
