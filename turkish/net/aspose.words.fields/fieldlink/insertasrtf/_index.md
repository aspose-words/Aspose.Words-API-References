...
description: Gelişmiş belge entegrasyonu ve esneklik için zengin metin biçimindeki (RTF) bağlantılı nesneleri kolayca yönetmek üzere FieldLink InsertAsRtf özelliğini keşfedin.
type: docs
weight: 70
...
Bağlantılı nesnenin zengin metin biçiminde (RTF) eklenip eklenmeyeceğini alır veya ayarlar.
