...
description: Bağlantılı nesnelerin biçimlendirmelerini nasıl güncelleyeceğini etkin bir şekilde yönetmek için FieldLink FormatUpdateType özelliğini keşfedin. İş akışınızı bugün geliştirin!
type: docs
weight: 30
url: /tr/net/aspose.words.fields/fieldlink/formatupdatetype/
---
## FieldLink.FormatUpdateType property

Bağlantılı nesnenin biçimlendirmesini güncelleme yolunu alır veya ayarlar.
