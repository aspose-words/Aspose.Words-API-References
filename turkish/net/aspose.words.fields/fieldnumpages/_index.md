...
description: NUMPAGES alanını zahmetsizce uygulamak, belge otomasyonunu ve verimliliğini artırmak için Aspose.Words.Fields.FieldNumPages sınıfını keşfedin.
type: docs
weight: 2630
url: /tr/net/aspose.words.fields/fieldnumpages/
---
## FieldNumPages class

NUMPAGES alanını uygular.
...
Geçerli belgedeki sayfa sayısını, kaydedildiği şekilde alır.**Sayfalar** the yerleşik belge özelliklerinin özelliği.
