...
description: FormFieldCollection RemoveAt metodunu kullanarak bir form alanını zahmetsizce kaldırın. Bu verimli dizin tabanlı çözümle formlarınızı kolaylaştırın.
type: docs
weight: 60
...
Belirtilen dizindeki bir form alanını kaldırır.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| index | Int32 | Kaldırılacak form alanının sıfırdan başlayan dizini. |
