...
description: FormFieldCollection Item özelliğiyle belirli form alanlarına kolayca erişin. Veri işlemeyi kolaylaştırın ve form yönetimini geliştirin.
type: docs
weight: 20
...
| Parametre | Tanım |
| --- | --- |
| bookmarkName | Büyük/küçük harfe duyarlı yer imi adı. |

## Notlar

Geri Döndürür`hükümsüz` Belirtilen yer imi adına sahip form alanı bulunamıyorsa.
