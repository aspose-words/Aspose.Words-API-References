...
description: FieldBarcode IsUSPostalAddress özelliğini keşfedin. Doğru veri işleme ve gelişmiş verimlilik için ABD posta adresi doğrulamasını kolayca yönetin.
type: docs
weight: 40
...
Alınır veya ayarlanır[`PostalAddress`](../postaladdress/) bir ABD posta adresidir.
