...
description: Kusursuz TEMPLATE alan uygulaması için Aspose.Words.Fields.FieldTemplate sınıfını keşfedin. Güçlü özelliklerle belge işlemenizi geliştirin!
type: docs
weight: 2900
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | Tam dosya yolu adının eklenip eklenmeyeceğini alır veya ayarlar. |
