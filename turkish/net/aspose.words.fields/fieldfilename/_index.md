...
description: Sorunsuz belge otomasyonu için FILENAME alan uygulamasını basitleştirmek üzere tasarlanmış Aspose.Words.Fields.FieldFileName sınıfını keşfedin.
type: docs
weight: 2280
...
| [IncludeFullPath](../../aspose.words.fields/fieldfilename/includefullpath/) { get; set; } | Tam dosya yolu adının eklenip eklenmeyeceğini alır veya ayarlar. |
...
Mevcut uygulamada, şunu kullanır:[`OriginalFileName`](../../aspose.words/document/originalfilename/) retrieve dosya adının özelliği. Belge bir akıştan yüklendiyse veya boş oluşturulduysa, kaydedilmekte olan dosyanın adını kullanır (biliniyorsa).
