...
description: Barkodlarınızı, daha iyi okunabilirlik için görsellerin yanında veri metni görüntüleyerek geliştirmek amacıyla BarcodeParameters DisplayText özelliğini keşfedin.
type: docs
weight: 70
url: /tr/net/aspose.words.fields/barcodeparameters/displaytext/
---
## BarcodeParameters.DisplayText property

Barkod verilerinin (metin) görüntüyle birlikte görüntülenip görüntülenmeyeceği.
