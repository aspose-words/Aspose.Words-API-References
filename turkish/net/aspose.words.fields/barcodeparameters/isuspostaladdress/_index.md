...
description: Bir adresin geçerli bir ABD posta adresi olup olmadığını kolayca doğrulamak için BarcodeParameters'ın IsUSPostalAddress özelliğini keşfedin. Veri doğruluğunuzu bugün artırın!
type: docs
weight: 130
...
İster[`PostalAddress`](../postaladdress/) bir ABD posta adresidir.
