...
description: En iyi barkod performansı için tam yüzde puanlarında (10-1000) hassas sembol ölçeklemesi sağlayan BarcodeParameters ScalingFactor özelliğini keşfedin.
type: docs
weight: 160
...
Sembol için ölçekleme faktörü. Değer tam yüzde puanları cinsindendir ve geçerli değerler [10, 1000].
