...
description: BarcodeParameters IsBookmark özelliğini keşfedin! PostalAddress'in verimli yer imi çözümleriyle belge yönetiminizi nasıl geliştirebileceğini öğrenin.
type: docs
weight: 120
url: /tr/net/aspose.words.fields/barcodeparameters/isbookmark/
---
## BarcodeParameters.IsBookmark property

İster[`PostalAddress`](../postaladdress/) bir yer iminin adıdır.
