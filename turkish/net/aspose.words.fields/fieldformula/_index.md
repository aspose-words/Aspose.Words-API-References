...
description: Belgelerinizdeki formül alanlarını gelişmiş işlevsellik için zahmetsizce uygulamak ve yönetmek amacıyla Aspose.Words.Fields.FieldFormula sınıfını keşfedin.
type: docs
weight: 2360
...
// Bir matematiksel denklemi oluşturmak için bir alan oluşturucu kullanın,
// daha sonra denklemin sonucunu belgede görüntülemek için bir formül alanı oluşturun.
