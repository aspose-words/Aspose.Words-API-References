...
description: Aspose.Words.Fields.FieldIf sınıf. IF alanını uygular C#'da.
type: docs
weight: 2000
...
| [FalseText](../../aspose.words.fields/fieldif/falsetext/) { get; set; } | Karşılaştırma ifadesi ise görüntülenen metni alır veya ayarlar.`YANLIŞ` . |
