...
description: FieldIf mülk. Karşılaştırma ifadesi yanlışsa görüntülenen metni alır veya ayarlar.
type: docs
weight: 30
...
Karşılaştırma ifadesi yanlışsa görüntülenen metni alır veya ayarlar.
