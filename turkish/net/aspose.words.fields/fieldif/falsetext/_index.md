...
description: FieldIf FalseText mülk. Karşılaştırma ifadesi ise görüntülenen metni alır veya ayarlar.YANLIŞ  C#'da.
type: docs
weight: 30
...
Karşılaştırma ifadesi ise görüntülenen metni alır veya ayarlar.`YANLIŞ` .
