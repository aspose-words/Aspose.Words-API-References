...
description: Aspose.Words.Fields.FieldLastSavedBy sınıf. SONSAVEDBY alanını uygular.
type: docs
weight: 1950
...
// Microsoft Word'de bir belge oluşturursak, "Son kaydedilen" yerleşik özelliğinde kullanıcının adı olacaktır.
 // Programlı bir belge yaparsak, bu özellik null olacak ve bir değer atamamız gerekecek.
