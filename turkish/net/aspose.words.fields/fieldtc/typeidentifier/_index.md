...
description: FieldTC mülk. Bu alan için genellikle bir harf olan bir tür tanımlayıcısı alır veya ayarlar.
type: docs
weight: 50
...
Bu alan için (genellikle bir harf olan) bir tür tanımlayıcısı alır veya ayarlar.
