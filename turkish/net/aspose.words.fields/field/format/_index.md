...
description: Alan Biçimi nesnelerine kesintisiz erişim için Alan Biçimi özelliğini keşfedin, alanlarınızın biçimlendirmesini hassas ve kolay bir şekilde geliştirin.
type: docs
weight: 30
...
Bir tane alır[`FieldFormat`](../../fieldformat/)alanın biçimlendirmesine yazılmış erişim sağlayan nesne.
