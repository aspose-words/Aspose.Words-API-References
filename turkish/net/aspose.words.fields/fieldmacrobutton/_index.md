...
description: Aspose.Words.Fields.FieldMacroButton sınıf. MACROBUTTON alanını uygular C#'da.
type: docs
weight: 2130
...
| [DisplayText](../../aspose.words.fields/fieldmacrobutton/displaytext/) { get; set; } | Metnin, makroyu veya komutu çalıştırmak için seçilen "düğme" olarak görünmesini sağlar veya ayarlar. |
...
Aspose.Words'te bu alan aynı zamanda birleştirme alanı görevi de görebilir.
