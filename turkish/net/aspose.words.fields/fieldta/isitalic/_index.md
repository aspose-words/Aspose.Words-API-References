...
description: FieldTA mülk. Girdi için sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır veya ayarlar.
type: docs
weight: 40
...
Girdi için sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır veya ayarlar.
