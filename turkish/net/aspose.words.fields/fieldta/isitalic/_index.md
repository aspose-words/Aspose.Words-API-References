...
description: FieldTA'nın IsItalic özelliğiyle sayfa numaralarını nasıl kolayca biçimlendireceğinizi keşfedin; belgelerinizi daha iyi okunabilirlik için şık italik metinlerle zenginleştirin.
type: docs
weight: 40
url: /tr/net/aspose.words.fields/fieldta/isitalic/
---
## FieldTA.IsItalic property

Giriş için sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır veya ayarlar.
