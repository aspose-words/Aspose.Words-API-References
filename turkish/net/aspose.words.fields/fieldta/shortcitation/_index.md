...
description: FieldTA ShortCitation'ınızı zahmetsizce yönetin. Girişler için kısa alıntıları kolayca alın veya ayarlayın, veri organizasyonunu ve erişilebilirliğini geliştirin.
type: docs
weight: 70
url: /tr/net/aspose.words.fields/fieldta/shortcitation/
---
## FieldTA.ShortCitation property

Giriş için kısa alıntıyı alır veya ayarlar.
