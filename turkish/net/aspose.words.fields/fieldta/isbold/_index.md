...
description: FieldTA mülk. Girdi için sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını belirler.
type: docs
weight: 30
...
Girdi için sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını belirler.
