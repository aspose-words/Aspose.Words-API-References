...
public void FieldTime()
{
    ...
    // Görüntülenen saatimizin formatını değiştirmek için \@ bayrağını kullanabiliriz.
    field = InsertFieldTime(builder, "\\@ HHmm");

    Assert.AreEqual(" TIME \\@ HHmm", field.GetFieldCode());

    // TIME alanının Gregoryen takvimine göre tarihi de göstermesini sağlayacak şekilde formatı ayarlayabiliriz.
...
/// <summary>
/// TIME alanı eklemek, yeni bir paragraf eklemek ve alanı döndürmek için bir belge oluşturucu kullanın.
/// </summary>
