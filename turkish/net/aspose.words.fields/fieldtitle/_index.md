...
description: Aspose.Words.Fields.FieldTitle sınıf. BAŞLIK alanını uygular.
type: docs
weight: 2360
...
Belgenin başlığında kayıtlı olduğu gibi alır ve isteğe bağlı olarak ayarlar. **Başlık**the yerleşik belge özelliklerinin özelliği.
