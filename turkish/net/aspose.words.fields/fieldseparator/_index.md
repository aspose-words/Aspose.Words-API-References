...
description: Alan kodlarını sonuçlardan etkili bir şekilde ayırarak Word belgelerinizi geliştirmek için tasarlanmış Aspose.Words.Fields.FieldSeparator sınıfını keşfedin.
type: docs
weight: 2790
...
| override [NodeType](../../aspose.words.fields/fieldseparator/nodetype/) { get; } | Geri DöndürürFieldSeparator . |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldseparator/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Bir ziyaretçiyi kabul eder. |
...
`FieldSeparator` satır içi düzeyde bir düğümdür ve x000d_ tarafından temsil edilir[`FieldSeparatorChar`](../../aspose.words/controlchar/fieldseparatorchar/) belgedeki kontrol karakteri.

`FieldSeparator` sadece bir çocuk olabilir[`Paragraph`](../../aspose.words/paragraph/).
