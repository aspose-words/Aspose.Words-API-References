...
description: FormField Checked özelliğini kullanarak formunuzu kolayca yönetin. Onay kutusu durumunu zahmetsizce kontrol edin; sorunsuz kullanıcı deneyimi için varsayılan olarak işaretli değildir.
type: docs
weight: 30
...
Onay kutusu form alanının işaretli durumunu alır veya ayarlar. Bu özelliğin varsayılan değeri`YANLIŞ` .
