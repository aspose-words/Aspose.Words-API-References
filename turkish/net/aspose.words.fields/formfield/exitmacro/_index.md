...
description: Formlarınız için çıkış makrolarını kolayca yönetmek için FormField ExitMacro özelliğini keşfedin. Kullanıcı deneyimini geliştirin ve veri girişini bugün kolaylaştırın!
type: docs
weight: 90
...
Form alanı için bir çıkış makrosu adı döndürür veya ayarlar.
...
Çıkış makrosu, Microsoft Word'de form alanı odak noktasını kaybettiğinde çalışır.

Microsoft Word en fazla 32 karakter uzunluğundaki dizelere izin verir.
