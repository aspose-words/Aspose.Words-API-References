...
description: Metin alanı sınırlarını ayarlamak için FormField MaxLength özelliğini keşfedin. En iyi veri girişi için özelleştirilebilir uzunluk ayarlarıyla kullanıcı deneyimini geliştirin.
type: docs
weight: 120
...
Metin alanı için maksimum uzunluk. Uzunluk sınırlı olmadığında sıfır.
