...
description: Onay kutunuzun varsayılan değerini ayarlamak için FormField Default özelliğini nasıl özelleştireceğinizi keşfedin. Kolay değer ayarlamalarıyla kullanıcı deneyimini geliştirin!
type: docs
weight: 40
...
Onay kutusu form alanının varsayılan değerini alır veya ayarlar. Bu özellik için varsayılan değer şudur:`YANLIŞ` .
