...
description: FormField OwnHelp özelliğini keşfedin. Kullanıcılar odaklanmış form alanlarına F1'e bastığında yardım mesajlarını özelleştirerek kullanıcı deneyimini kolaylaştırın.
type: docs
weight: 150
...
Bir form alanı odakta olduğunda ve kullanıcı F1'e bastığında bir ileti kutusunda görüntülenen metnin kaynağını belirtir.
...
Eğer`doğru` , belirtilen metin[`HelpText`](../helptext/) özellik görüntülenir. Eğer`YANLIŞ` , Otomatik Metin girişinde belirtilen metin[`HelpText`](../helptext/) mülk görüntülenir.
