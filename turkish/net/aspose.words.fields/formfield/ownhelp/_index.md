...
description: FormField mülk. Odak bir form alanına sahip olduğunda ve kullanıcı F1e bastığında ileti kutusunda görüntülenen metnin kaynağını belirtir.
type: docs
weight: 150
...
Odak bir form alanına sahip olduğunda ve kullanıcı F1'e bastığında ileti kutusunda görüntülenen metnin kaynağını belirtir.
...
True ise, HelpText özelliği tarafından belirtilen metin görüntülenir. False ise, HelpText özelliği tarafından belirtilen Otomatik Metin girişindeki metin görüntülenir.
