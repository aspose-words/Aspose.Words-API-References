...
description: FormField mülk. Bir metin formu alanı için metin biçimlendirmesini döndürür veya ayarlar.
type: docs
weight: 200
...
Bir metin formu alanı için metin biçimlendirmesini döndürür veya ayarlar.
...
Metin formu alanı normal metin içeriyorsa, geçerli biçim dizeleri: "", "BÜYÜK HARF", "KÜÇÜK HARF", "İLK BÜYÜK HARF" ve "BAŞLIK DURUM". strings büyük/küçük harfe duyarsızdır.
