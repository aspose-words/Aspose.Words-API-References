...
description: FormField IsCheckBoxExactSize özelliğini keşfedin, en iyi özelleştirme için basit bir Boole ayarıyla metin kutusu boyutlandırmasını kolayca kontrol edin.
type: docs
weight: 110
...
Metin kutusunun boyutunun otomatik mi yoksa açıkça mı belirtildiğini belirten Boole değerini alır veya ayarlar.
