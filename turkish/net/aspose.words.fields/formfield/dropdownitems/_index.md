...
description: Açılır form alanının öğelerine erişim sağlar.
type: docs
weight: 50
...
Açılır form alanının öğelerine erişim sağlar.
...
Microsoft Word, bir açılır form alanında en fazla 25 öğeye izin verir.
