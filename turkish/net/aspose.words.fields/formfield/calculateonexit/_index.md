...
description: FormField CalculateOnExit özelliğinin çıkışta alan referanslarını nasıl otomatik olarak güncellediğini, belgenizin doğruluğunu ve verimliliğini nasıl artırdığını keşfedin.
type: docs
weight: 10
...
Belirtilen form alanına yapılan başvurular, alandan çıkıldığında otomatik olarak güncelleniyorsa doğrudur.
...
Ayar`CalculateOnExit` yalnızca belge Microsoft Word'de açıldığında form alanının davranışını etkiler. Aspose.Words, references 'yi form alanına asla güncellemez.
