...
description: FormField CheckBoxSize özelliğini kullanarak onay kutusu boyutlarını noktalar halinde özelleştirebilir ve IsCheckBoxExactSize etkinleştirildiğinde formlarınızı geliştirebilirsiniz.
type: docs
weight: 20
...
Onay kutusunun boyutunu noktalar halinde alır veya ayarlar. Yalnızca şu durumlarda etkilidir:[`IsCheckBoxExactSize`](../ischeckboxexactsize/) dır`doğru` .
