...
description: Formlarınız için giriş makrolarını kolayca yönetmek, işlevselliği ve kullanıcı deneyimini geliştirmek için FormField EntryMacro özelliğini keşfedin.
type: docs
weight: 80
...
Form alanı için bir giriş makrosu adı döndürür veya ayarlar.
...
Giriş makrosu, Microsoft Word'de form alanına odaklanıldığında çalışır.
