...
description: FormField mülk. Bir form alanı etkinse doğrudur.
type: docs
weight: 70
...
Bir form alanı etkinse doğrudur.
...
Bir form alanı etkinleştirilirse, form dolduruldukça içeriği değiştirilebilir.
