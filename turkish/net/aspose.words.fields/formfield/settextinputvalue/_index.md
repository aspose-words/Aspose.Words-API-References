...
description: İçinde belirtilen metin biçimini uygularTextInputFormataspose.words.fields/formfield/textinputformat/ ve değeri içinde saklarResultaspose.words.fields/formfield/result/ .
type: docs
weight: 250
...
İçinde belirtilen metin biçimini uygular[`TextInputFormat`](../textinputformat/) ve değeri içinde saklar[`Result`](../result/) .
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| newValue | Object | Bir dize, sayı veya DateTime nesnesi olabilir. |

### Notlar

bu[`TextInputDefault`](../textinputdefault/) değer uygulanırsa*newValue* dır-dir`hükümsüz`.
