...
description: FormField mülk. Odak bir form alanına sahip olduğunda durum çubuğunda görüntülenen metni döndürür veya ayarlar.
type: docs
weight: 180
...
Odak bir form alanına sahip olduğunda durum çubuğunda görüntülenen metni döndürür veya ayarlar.
...
OwnStatus özelliği true olarak ayarlanırsa, StatusText özelliği durum çubuğu metnini belirtir. OwnStatus özelliği false olarak ayarlanırsa, StatusText özelliği form alanı için durum çubuğu metnini içeren bir AutoText girişinin adını belirtir.
