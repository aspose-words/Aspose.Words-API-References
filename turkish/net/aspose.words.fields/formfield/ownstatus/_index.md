...
description: FormField mülk. Odak bir form alanına sahip olduğunda durum çubuğunda görüntülenen metnin kaynağını belirtir.
type: docs
weight: 160
...
Odak bir form alanına sahip olduğunda durum çubuğunda görüntülenen metnin kaynağını belirtir.
...
Doğruysa, StatusText özelliği tarafından belirtilen metin görüntülenir. Yanlışsa, StatusText özelliği tarafından belirtilen Otomatik Metin girişinin metni görüntülenir.
