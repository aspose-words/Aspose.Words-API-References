...
description: FormField OwnStatus özelliğinin, bir form alanına odaklanıldığında durum çubuğu metnini özelleştirerek kullanıcı deneyimini nasıl geliştirdiğini keşfedin.
type: docs
weight: 160
...
Bir form alanı odakta olduğunda durum çubuğunda görüntülenen metnin kaynağını belirtir.
...
Eğer`doğru` , belirtilen metin[`StatusText`](../statustext/) özellik görüntülenir. Eğer`YANLIŞ` , tarafından belirtilen Otomatik Metin girişinin metni[`StatusText`](../statustext/) mülk görüntülenir.
