...
description: Gelişmiş kişiselleştirme ve kullanıcı deneyimi için kullanıcı baş harflerini kolayca yönetmek ve özelleştirmek amacıyla UserInformation Initials özelliğinin nasıl kullanılacağını keşfedin.
type: docs
weight: 40
