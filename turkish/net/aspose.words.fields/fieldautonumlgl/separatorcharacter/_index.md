...
description: Veri biçimlendirmenizi esnek bir ayırıcı karakterle geliştirmek için FieldAutoNumLgl SeparatorCharacter özelliğini nasıl özelleştireceğinizi keşfedin.
type: docs
weight: 30
