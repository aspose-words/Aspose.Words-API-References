...
description: Aspose.Words.Fields.IFieldDatabaseProvider arayüzüyle belge otomasyonunuzu geliştirin. FieldDatabase güncellemeleri için sorunsuz bir şekilde veri sağlayın.
type: docs
weight: 3100
...
Bu arayüzü, veri sağlamak için uygulayın[`FieldDatabase`](../fielddatabase/) güncellendiğinde alan.
...
| İsim | Tanım |
| --- | --- |
| [GetQueryResult](../../aspose.words.fields/ifielddatabaseprovider/getqueryresult/)(*string, string, string, [FieldDatabase](../fielddatabase/)*) | Sorgu sonucunu döndürür. |
