...
description: Verimli veri alımı için IFieldDatabaseProvider'ın GetQueryResult metodunu keşfedin. Sorgularınızı kolaylaştırın ve veritabanı performansını bugün artırın!
type: docs
weight: 10
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| fileName | String | \d alanı anahtarında belirtilen veritabanının tam yolu ve dosya adı. |
| connection | String | \c alanında belirtilen verilere bağlantı. |
...
The[`FieldDatabaseDataTable`](../../fielddatabasedatatable/) Alanın güncellenmesi için kullanılması gereken örnek.
