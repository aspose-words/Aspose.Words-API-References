...
description: Özelleştirilebilir kaydetme seçenekleri ve etkili geri aramalarla belge işlemeyi geliştirmek için gerekli olan Aspose.Words.Saving.DocumentPartSavingArgs sınıfını keşfedin.
type: docs
weight: 5690
...
Şunun için veri sağlar:[`DocumentPartSaving`](../idocumentpartsavingcallback/documentpartsaving/) geri arama.
...
| [DocumentPartStream](../../aspose.words.saving/documentpartsavingargs/documentpartstream/) { get; set; } | Belge bölümünün kaydedileceği akışı belirtmenize olanak tanır. |
...
Aspose.Words bir belgeyi HTML veya ilgili biçimlere kaydettiğinde ve[`DocumentSplitCriteria`](../htmlsaveoptions/documentsplitcriteria/) belirtildiğinde, belge parçalara bölünür ve varsayılan olarak her belge parçası ayrı bir dosyaya kaydedilir.

Sınıf`DocumentPartSavingArgs` Her belge parçasının nasıl kaydedileceğini kontrol etmenizi sağlar. Dosya adlarının nasıl oluşturulacağını yeniden tanımlamanıza veya kendi akış nesnelerinizi sağlayarak belge parçalarının dosyalarına kaydedilmesini tamamen engellemenize olanak tanır.

Belge parçalarını dosyalar yerine akışlara kaydetmek için şunu kullanın:[`DocumentPartStream`](./documentpartstream/) mülk.
