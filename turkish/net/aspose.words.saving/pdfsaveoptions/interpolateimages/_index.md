...
description: Görüntü enterpolasyonunun uygun bir okuyucu tarafından gerçekleştirilip gerçekleştirilmeyeceğini gösteren bir bayrak. Ne zamanyanlış belirtilirse bayrak çıktı belgesine yazılmaz ve bunun yerine okuyucunun varsayılan davranışı kullanılır.
type: docs
weight: 180
