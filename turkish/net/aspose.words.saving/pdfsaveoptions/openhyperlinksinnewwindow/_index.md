...
description: Pdf Document çıktısındaki köprülerin bir tarayıcının yeni bir penceresinde veya sekmesinde açılmaya zorlanıp zorlanmadığını belirleyen bir değer alır veya ayarlar.
type: docs
weight: 200
