...
description: PdfSaveOptions EmbedFullFonts özelliğinin, kusursuz biçimlendirme için tam yazı tipi yerleştirmeyi sağlayarak PDF belgelerinizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 120
...
Yazı tiplerinin ortaya çıkan PDF belgelerine nasıl yerleştirileceğini kontrol eder.
...
Varsayılan değer:`YANLIŞ`, bu da yazı tiplerinin gömülmeden önce alt kümeye ayrılması anlamına gelir. Alt kümeye ayırma, çıktı dosyası boyutunu daha küçük tutmak istiyorsanız yararlıdır. Alt kümeye ayırma, bir yazı tipinden kullanılmayan tüm glifleri kaldırır.

Bu değer olarak ayarlandığında`doğru`, tam bir yazı tipi dosyası PDF'ye alt kümelemesi olmadan gömülür. Bu daha büyük çıktı dosyalarıyla sonuçlanacaktır, ancak daha sonra ortaya çıkan PDF'yi düzenlemek istediğinizde (örneğin daha fazla metin eklemek) yararlı bir seçenek olabilir.

Bazı yazı tipleri büyüktür (birkaç megabayt) ve bunları subsetting olmadan yerleştirmek büyük çıktı belgelerine yol açacaktır.
