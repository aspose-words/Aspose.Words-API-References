...
description: IResourceSavingCallback yöntem. Aspose.Words harici bir kaynağı sabit sayfa HTML veya SVG formatlarına kaydettiğinde çağrılır.
type: docs
weight: 10
...
Aspose.Words harici bir kaynağı sabit sayfa HTML veya SVG formatlarına kaydettiğinde çağrılır.
