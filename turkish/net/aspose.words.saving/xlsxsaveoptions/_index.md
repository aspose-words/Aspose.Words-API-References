...
description: Belgenizi Xlsx'e dönüştürmeyi geliştirmek için Aspose.Words.Saving.XlsxSaveOptions'ı keşfedin. En iyi sonuçlar için gelişmiş kaydetme seçeneklerinin kilidini açın!
type: docs
weight: 6520
...
Bir belgeyi kaydederken ek seçenekleri belirtmek için kullanılabilirXlsx biçimi.

Daha fazla bilgi edinmek için şu adresi ziyaret edin:[Specify Seçenekleri Kaydet](https://docs.aspose.com/words/net/specify-save-options/) belgeleme makalesi.
...
| [CompressionLevel](../../aspose.words.saving/xlsxsaveoptions/compressionlevel/) { get; set; } | Belgeyi kaydetmek için kullanılan sıkıştırma düzeyini belirtir. Varsayılan değerNormal . |
...
| [DateTimeParsingMode](../../aspose.words.saving/xlsxsaveoptions/datetimeparsingmode/) { get; set; } | Belge metninin tarih ve saat değerlerini tanımlamak için nasıl ayrıştırılacağını belirten modu alır veya ayarlar. Varsayılan değerUseCurrentLocale . |
...
| [SectionMode](../../aspose.words.saving/xlsxsaveoptions/sectionmode/) { get; set; } | Bölümlerin çıkış XLSX belgesine kaydedilirken nasıl işleneceğini alır veya ayarlar. Varsayılan değerMultipleWorksheets . |
