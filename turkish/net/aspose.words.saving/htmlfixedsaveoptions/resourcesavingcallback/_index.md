...
description: HtmlFixedSaveOptions ResourceSavingCallback ile belge dışa aktarımlarınızı optimize edin. Gelişmiş HTML çıktısı için resim, yazı tipi ve CSS kaydetmeyi kontrol edin.
type: docs
weight: 150
...
Bir belge sabit sayfalı Html biçimine aktarıldığında kaynakların (resimler, yazı tipleri ve css) nasıl kaydedileceğini kontrol etmenizi sağlar.
