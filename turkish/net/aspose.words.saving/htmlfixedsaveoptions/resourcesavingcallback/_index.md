...
description: HtmlFixedSaveOptions mülk. Bir belge sabit sayfa Html formatına aktarıldığında kaynakların resimler yazı tipleri ve css nasıl kaydedileceğini kontrol etmeye izin verir.
type: docs
weight: 130
...
Bir belge sabit sayfa Html formatına aktarıldığında kaynakların (resimler, yazı tipleri ve css) nasıl kaydedileceğini kontrol etmeye izin verir.
