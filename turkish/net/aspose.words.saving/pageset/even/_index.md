...
description: PageSet Even ile belgenizdeki tüm çift sayfaların orijinal sırasını alın. İş akışınızı kolaylaştırın ve belge yönetimini geliştirin!
type: docs
weight: 30
...
Sayfa dizinleri sıfır tabanlı olduğundan çift sayfaların dizinleri tektir.
