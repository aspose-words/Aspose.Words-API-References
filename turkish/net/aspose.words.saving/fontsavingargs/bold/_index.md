...
description: Fontunuzun kalın olup olmadığını kolayca belirlemek için FontSavingArgs Bold özelliğini keşfedin. Daha iyi okunabilirlik ve tasarım için tipografinizi geliştirin.
type: docs
weight: 10
...
Mevcut yazı tipinin kalın olup olmadığını gösterir.
