...
description: Gelişmiş uygulama performansı ve kullanıcı deneyimi için kesintisiz font depolama ve yönetimi sağlayan FontSavingArgs FontStream özelliğini keşfedin.
type: docs
weight: 50
...
Yazı tipinin kaydedileceği akışı belirtmenize olanak tanır.
...
Varsayılan değer:`hükümsüz` Bu özellik olduğunda`hükümsüz` , yazı tipi belirtilen bir dosyaya kaydedilecektir.[`FontFileName`](../fontfilename/) mülk.
