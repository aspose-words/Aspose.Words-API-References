...
description: Yazı tipinizin italik olup olmadığını kolayca kontrol etmek için FontSavingArgs Italic özelliğini keşfedin, böylece metin stilinizi ve tasarım esnekliğinizi artırın.
type: docs
weight: 80
url: /tr/net/aspose.words.saving/fontsavingargs/italic/
---
## FontSavingArgs.Italic property

Mevcut yazı tipinin italik olup olmadığını belirtir.
