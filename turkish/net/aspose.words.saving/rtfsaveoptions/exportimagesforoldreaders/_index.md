...
description: RtfSaveOptions mülk. Eski okuyucular için anahtar kelimelerin RTFye yazılıp yazılmadığını belirtir. Bu RTF belgesinin boyutunu önemli ölçüde etkileyebilir. Varsayılan değerdoğru .
type: docs
weight: 30
