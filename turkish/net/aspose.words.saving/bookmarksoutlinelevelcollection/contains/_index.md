...
description: BookmarksOutlineLevelCollection'da bir yer işaretinin olup olmadığını keşfedin. Bu etkili organizasyon için temel yöntemle yer işaretlerinizi kolayca yönetin.
type: docs
weight: 60
...
Koleksiyonun belirtilen ada sahip bir yer imi içerip içermediğini belirler.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| name | String | Bulunacak yer iminin büyük/küçük harfe duyarlı olmayan adı. |
