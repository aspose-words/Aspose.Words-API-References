...
description: Üstbilgilerin ve altbilgilerin HTML MHTML veya EPUBa nasıl çıkarılacağını belirtir. Varsayılan değerPerSection HTML/MHTML için veNone EPUB için.
type: docs
weight: 170
