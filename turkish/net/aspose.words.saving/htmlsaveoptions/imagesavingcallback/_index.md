...
description: HtmlSaveOptions' ImageSavingCallback ile görüntü kaydetmeyi kontrol edin. Sorunsuz kullanıcı deneyimi için belge dışa aktarımlarını HTML, MHTML veya EPUB'a optimize edin.
type: docs
weight: 350
...
Bir belge HTML, MHTML veya EPUB olarak kaydedildiğinde görüntülerin nasıl kaydedileceğini kontrol etmenizi sağlar.
