...
description: HTML MHTML veya EPUBa kaydederken gidiş dönüş bilgilerinin yazıp yazılmayacağını belirtir. Varsayılan değerdoğru HTML için veyanlış MHTML ve EPUB için.
type: docs
weight: 250
