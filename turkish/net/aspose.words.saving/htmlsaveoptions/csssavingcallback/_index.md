...
description: HtmlSaveOptions CssSavingCallback ile CSS stil kaydetmeyi kontrol edin. Belgenizin HTML, MHTML veya EPUB'a dışa aktarımlarını zahmetsizce optimize edin!
type: docs
weight: 40
...
Bir belge HTML, MHTML veya EPUB olarak kaydedildiğinde CSS stillerinin nasıl kaydedileceğini kontrol etmenizi sağlar.
