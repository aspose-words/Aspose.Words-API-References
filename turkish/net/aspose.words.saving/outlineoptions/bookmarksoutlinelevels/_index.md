...
description: OutlineOptions mülk. Tek tek yer imlerinin anahat düzeyini belirlemeye izin verir.
type: docs
weight: 20
...
Tek tek yer imlerinin anahat düzeyini belirlemeye izin verir.
...
Bu koleksiyonda yer imi düzeyi belirtilmemişse,[`DefaultBookmarksOutlineLevel`](../defaultbookmarksoutlinelevel/) değer kullanılır.
