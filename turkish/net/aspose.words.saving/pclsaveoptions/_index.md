...
description: Aspose.Words.Saving.PclSaveOptions sınıf. Bir belgeyi bilgisayara kaydederken ek seçenekleri belirlemek için kullanılabilir.Pcl format.
type: docs
weight: 5400
...
Bir belgeyi bilgisayara kaydederken ek seçenekleri belirlemek için kullanılabilir.Pcl format.
...
| [FallbackFontName](../../aspose.words.saving/pclsaveoptions/fallbackfontname/) { get; set; } | Yazıcıda ve yerleşik yazı tipi koleksiyonlarında beklenen yazı tipi bulunamazsa kullanılacak yazı tipinin adı . |
...
| [RasterizeTransformedElements](../../aspose.words.saving/pclsaveoptions/rasterizetransformedelements/) { get; set; } | Karmaşık dönüştürülmüş elementlerin 'nin PCL belgesine kaydedilmeden önce rasterleştirilmesi gerekip gerekmediğini belirleyen bir değer alır veya ayarlar. Varsayılan:`doğru` . |
