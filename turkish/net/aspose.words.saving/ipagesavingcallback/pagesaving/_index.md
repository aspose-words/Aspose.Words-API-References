...
description: Aspose.Words'de sabit formatlara sayfa kaydetmeyi optimize etmek için tasarlanmış iPageSavingCallback yöntemini keşfedin. Belge yönetiminizi bugün geliştirin!
type: docs
weight: 10
...
Aspose.Words sabit sayfa biçimlerine ayrı bir sayfa kaydettiğinde çağrılır.
