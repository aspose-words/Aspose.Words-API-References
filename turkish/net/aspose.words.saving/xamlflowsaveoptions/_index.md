...
description: Aspose.Words.Saving.XamlFlowSaveOptions sınıf. Bir belgeyi ye kaydederken ek seçenekleri belirtmek için kullanılabilirXamlFlow veyaXamlFlowPack format C#'da.
type: docs
weight: 5700
...
| [XamlFlowSaveOptions](xamlflowsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | Bir belgeyi kaydetmek için kullanılabilecek bu sınıfın yeni bir örneğini başlatır.XamlFlow veyaXamlFlowPack format. |
