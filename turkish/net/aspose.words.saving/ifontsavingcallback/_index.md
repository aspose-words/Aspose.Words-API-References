...
description: IFontSavingCallback arayüzüyle Aspose.Words'de font kaydetmeyi kontrol edin. Bildirimler alın ve en iyi belge kalitesi için HTML dışa aktarımlarını özelleştirin.
type: docs
weight: 5910
...
Bildirimleri almak ve Aspose.Words'ün bir belgeyi HTML biçimine aktarırken yazı tiplerini nasıl kaydedeceğini kontrol etmek istiyorsanız bu arayüzü uygulayın.
...
| İsim | Tanım |
| --- | --- |
| [FontSaving](../../aspose.words.saving/ifontsavingcallback/fontsaving/)(*[FontSavingArgs](../fontsavingargs/)*) | Aspose.Words bir font kaynağını kaydetmek üzereyken çağrılır. |
