...
description: Gelişmiş belge performansı için yazı tipi kaynak tasarrufunu optimize etmek üzere tasarlanmış Aspose.Words'deki iFontSavingCallback yöntemini keşfedin.
type: docs
weight: 10
...
Aspose.Words bir font kaynağını kaydetmek üzereyken çağrılır.
