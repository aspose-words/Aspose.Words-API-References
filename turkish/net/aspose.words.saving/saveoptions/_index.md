...
description: Bu kullanıcının bir belgeyi belirli bir biçimde kaydederken ek seçenekleri belirlemesine olanak tanıyan sınıflar için soyut bir temel sınıftır.
type: docs
weight: 5300
