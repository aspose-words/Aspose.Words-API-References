...
description: Liste düzeylerinin girintilenmesi için kaç tane ve hangi karakterin kullanılacağını belirten bir ListIndentation nesnesi alır. Varsayılan olarak sıfır 0 karakter sayısıdır bu girinti olmadığı anlamına gelir.
type: docs
weight: 30
