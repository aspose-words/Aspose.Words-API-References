...
description: Gelişmiş organizasyon ve sunum için belgenizin anahat ayarlarını özelleştirmek üzere XpsSaveOptions OutlineOptions özelliğini keşfedin.
type: docs
weight: 30
...
Dikkat[`ExpandedOutlineLevels`](../../outlineoptions/expandedoutlinelevels/) XPS'e kaydederken bu seçenek çalışmayacaktır.
