...
Bu özellik, dosyalar yerine belge sayfalarını akışlara kaydetmenize olanak tanır.

Varsayılan değer`hükümsüz` . Bu özellik ne zaman`hükümsüz` belge sayfası , belirtilen bir dosyaya kaydedilecektir.[`PageFileName`](../pagefilename/) Emlak.

Hem PageStream hem de PageFileName ayarlanırsa, PageStream kullanılır.
