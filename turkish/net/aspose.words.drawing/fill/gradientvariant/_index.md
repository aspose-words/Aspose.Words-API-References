...
description: Çarpıcı dolgu efektleri için GradientVariant özelliğini nasıl ayarlayacağınızı keşfedin. Tasarımınızı bugün canlı degrade seçenekleriyle geliştirin!
type: docs
weight: 130
...
Gradyan varyantını alır[`GradientVariant`](../../gradientvariant/) dolgu için.
