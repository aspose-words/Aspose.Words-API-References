...
description: Fill Visible özelliğiyle görünürlüğü kontrol edin. Tasarımınızı geliştirmek ve uygulamanızda netlik sağlamak için biçimlendirmeyi kolayca yönetin.
type: docs
weight: 210
...
Değeri alır veya ayarlar`doğru` bu örneğe uygulanan biçimlendirme görünürse.
