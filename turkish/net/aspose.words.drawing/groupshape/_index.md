...
description: Belgelerinizdeki gruplanmış şekilleri kolayca yönetmek ve düzenlemek için Aspose.Words.Drawing.GroupShape sınıfını keşfedin ve görsel çekiciliği artırın.
type: docs
weight: 1350
url: /tr/net/aspose.words.drawing/groupshape/
---
## GroupShape class

Bir belgedeki bir grup şekli temsil eder.

Daha fazla bilgi edinmek için şu adresi ziyaret edin:[Word Belgesine Grup Şekli Nasıl Eklenir](https://docs.aspose.com/words/net/how-to-add-group-shape-into-a-word-document/) belgeleme makalesi.
...
| İsim | Tanım |
| --- | --- |
| [GroupShape](groupshape/)(*[DocumentBase](../../aspose.words/documentbase/)*) | Yeni bir grup şekli oluşturur. |
...
| override [NodeType](../../aspose.words.drawing/groupshape/nodetype/) { get; } | Geri DöndürürGroupShape . |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words.drawing/groupshape/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Bir ziyaretçiyi kabul eder. |
| override [AcceptEnd](../../aspose.words.drawing/groupshape/acceptend/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | GroupShape'in sonunu ziyaret eden bir ziyaretçiyi kabul eder. |
| override [AcceptStart](../../aspose.words.drawing/groupshape/acceptstart/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | GroupShape'in başlangıcını ziyaret eden bir ziyaretçiyi kabul eder. |
...
A`GroupShape` bileşik bir düğümdür ve şunlara sahip olabilir:[`Shape`](../shape/) ve `GroupShape` Çocuklar olarak düğümler.

Her biri`GroupShape`alt şekilleri için yeni bir koordinat sistemi tanımlar. Koordinat sistemi,[`CoordSize`](../shapebase/coordsize/) ve [`CoordOrigin`](../shapebase/coordorigin/) özellikler.
