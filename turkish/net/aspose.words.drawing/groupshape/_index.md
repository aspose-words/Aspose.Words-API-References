...
description: Aspose.Words.Drawing.GroupShape sınıf. Belgedeki bir grup şekli temsil eder.
type: docs
weight: 890
...
Belgedeki bir grup şekli temsil eder.
...
| override [NodeType](../../aspose.words.drawing/groupshape/nodetype/) { get; } | İadeGroupShape . |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words.drawing/groupshape/accept/)(DocumentVisitor) | Bir ziyaretçiyi kabul eder. |
