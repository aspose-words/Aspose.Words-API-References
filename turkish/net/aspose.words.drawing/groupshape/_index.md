...
description: Aspose.Words.Drawing.GroupShape sınıf. Bir belgedeki şekil grubunu temsil eder C#'da.
type: docs
weight: 1020
...
Bir belgedeki şekil grubunu temsil eder.

Daha fazlasını öğrenmek için şu adresi ziyaret edin:[Word Belgesine Grup Şekli Nasıl Eklenir](https://docs.aspose.com/words/net/how-to-add-group-shape-into-a-word-document/) dokümantasyon makalesi.
...
| override [NodeType](../../aspose.words.drawing/groupshape/nodetype/) { get; } | İadelerGroupShape . |
...
| İsim | Tanım |
| --- | --- |
| override [Accept](../../aspose.words.drawing/groupshape/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Ziyaretçi kabul eder. |
...
A`GroupShape` bileşik bir düğümdür ve sahip olabilir[`Shape`](../shape/) ve `GroupShape` çocuklar gibi düğümler.
