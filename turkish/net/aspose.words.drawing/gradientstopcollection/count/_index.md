...
description: GradientStopCollection mülk. Koleksiyondaki öğelerin sayısını gösteren bir tamsayı değeri alır.
type: docs
weight: 10
...
Koleksiyondaki öğelerin sayısını gösteren bir tamsayı değeri alır.
