...
description: GradientStopCollection'ın çok yönlü Öğe özelliğini keşfederek GradientStop nesnelerini kolayca yönetin ve tasarımınızı canlı degradelerle zenginleştirin.
type: docs
weight: 20
...
Bir değeri alır veya ayarlar[`GradientStop`](../../gradientstop/) koleksiyondaki nesne.
