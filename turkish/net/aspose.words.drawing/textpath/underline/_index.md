...
description: TextPath Underline özelliğini keşfedin. Okunabilirliği ve tasarım çekiciliğini artırmak için altı çizili yazı tipleriyle tipografinizi kolayca geliştirin.
type: docs
weight: 190
...
Yazı tipi altı çiziliyse doğrudur.
