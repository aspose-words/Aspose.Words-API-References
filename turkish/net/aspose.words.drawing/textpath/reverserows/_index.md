...
description: Düzeninizi geliştirmek için TextPath ReverseRows özelliğini keşfedin. Geliştirilmiş tasarım esnekliği ve kullanıcı deneyimi için satır sırasını kontrol edin.
type: docs
weight: 80
...
Satırların düzen sırasının tersine çevrilip çevrilmeyeceğini belirler.
...
Eğer`doğru`, satırların düzen sırası tersine çevrilir. Bu öznitelik dikey metin düzeni için kullanılır.
