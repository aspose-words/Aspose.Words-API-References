...
description: Satırların düzen sırasının tersine çevrilip çevrilmeyeceğini belirler.
type: docs
weight: 80
...
Eğer **doğru**, satırların düzen sırası tersine çevrilir. Bu nitelik dikey metin düzeni için kullanılır.
