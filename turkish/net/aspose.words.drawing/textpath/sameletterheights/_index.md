...
description: Projeniz genelinde metin okunabilirliğini ve tasarım tutarlılığını artırarak tekdüze harf yüksekliğini garantilemek için TextPath SameLetterHeights özelliğini keşfedin.
type: docs
weight: 100
...
Tüm harflerin ilk harf durumundan bağımsız olarak aynı yükseklikte olup olmayacağını belirler.
