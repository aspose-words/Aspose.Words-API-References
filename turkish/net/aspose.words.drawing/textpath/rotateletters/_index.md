...
description: Dinamik bir görsel efekt için metin dönüşünü kontrol ederek tasarımlarınızı geliştirmek için TextPath RotateLetters özelliğini keşfedin. Yaratıcılığınızı yükseltin!
type: docs
weight: 90
url: /tr/net/aspose.words.drawing/textpath/rotateletters/
---
## TextPath.RotateLetters property

Metnin harflerinin döndürülüp döndürülmeyeceğini belirler.
