...
description: TextPath Spacing'i keşfedin. Metin aralığını zahmetsizce kontrol edin. Hassas ayarlamalarla okunabilirliği optimize edin—mükemmel hizalama için 1 eşittir 100!
type: docs
weight: 140
...
Metin için aralık miktarını tanımlar. 1, %100 anlamına gelir.
