...
description: Metnin üstünde ve altında fazladan boşluğun kaldırılıp kaldırılmayacağını belirler.
type: docs
weight: 180
...
Metnin üstünde ve altında fazladan boşluğun kaldırılıp kaldırılmayacağını belirler.
