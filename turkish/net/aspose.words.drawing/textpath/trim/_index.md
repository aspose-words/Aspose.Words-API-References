...
description: Daha temiz, daha cilalı bir görünüm için metnin üstünde ve altında istenmeyen boşlukları kaldırarak tasarımınızı geliştirmek amacıyla TextPath Trim özelliğini keşfedin.
type: docs
weight: 180
...
Metnin üstünde ve altında bulunan fazladan boşluğun kaldırılıp kaldırılmayacağını belirler.
