...
description: TextPath mülk. Metnin bir şeklin sınırlayıcı kutusuna sığıp sığmayacağını tanımlar.
type: docs
weight: 30
...
Metnin bir şeklin sınırlayıcı kutusuna sığıp sığmayacağını tanımlar.
