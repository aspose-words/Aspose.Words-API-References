...
description: TextPath FitShape mülk. Metnin bir şeklin sınırlayıcı kutusuna uyup uymayacağını tanımlar C#'da.
type: docs
weight: 30
...
Metnin bir şeklin sınırlayıcı kutusuna uyup uymayacağını tanımlar.
