...
description: TextPath FitShape özelliğinin, metninizin şeklin sınırlayıcı kutusuna mükemmel şekilde uymasını sağlayarak gelişmiş tasarım esnekliğini nasıl sağladığını keşfedin.
type: docs
weight: 30
url: /tr/net/aspose.words.drawing/textpath/fitshape/
---
## TextPath.FitShape property

Metnin bir şeklin sınırlayıcı kutusuna uyup uymadığını tanımlar.
