...
description: Web tasarımında çarpıcı tipografi için metin yollarınızı zahmetsizce tanımlamak ve özelleştirmek amacıyla TextPath FontFamily özelliğini keşfedin.
type: docs
weight: 40
...
textpath yazı tipinin ailesini tanımlar.
