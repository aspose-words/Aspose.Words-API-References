...
description: WordArt hizalaması.
type: docs
weight: 1210
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Stretch | `0` | Metnin her satırını genişliğe sığacak şekilde uzatın. |
| Center | `1` | Metni genişlikte ortalayın. |
| Left | `2` | Sola yasla. |
| Right | `3` | Sağa yasla. |
| LetterJustify | `4` | Harfleri genişliğe sığacak şekilde yayın. |
| WordJustify | `5` | Kelimeleri genişliğe sığacak şekilde yayın. |
