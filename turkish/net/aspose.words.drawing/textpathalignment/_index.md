...
description: Hassas WordArt hizalaması için Aspose.Words.Drawing.TextPathAlignment enum'unu keşfedin. Çok yönlü metin seçenekleriyle belge tasarımınızı geliştirin!
type: docs
weight: 1770
...
| İsim | Değer | Tanım |
| --- | --- | --- |
| Stretch | `0` | Metnin her satırını genişliğe uyacak şekilde uzat. |
| Center | `1` | Metni genişliğe göre ortala. |
| Left | `2` | Sola yaslı. |
| Right | `3` | Sağa yasla. |
| LetterJustify | `4` | Harfleri genişliğe uyacak şekilde yayın. |
| WordJustify | `5` | Kelimeleri genişliğe uyacak şekilde yayın. |
