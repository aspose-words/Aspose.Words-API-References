...
| DarkUpwardDiagonal | `16` | Koyu yukarı doğru çapraz. |
| DarkVertical | `17` | Koyu dikey. |
| DashedDownwardDiagonal | `18` | Aşağıya doğru kesikli çapraz. |
...
| Divot | `24` | Desen bölümü. |
| DottedDiamond | `25` | Noktalı baklava. |
...
| LightUpwardDiagonal | `36` | Işık yukarıya doğru çapraz. |
| LightVertical | `37` | Hafif dikey. |
| NarrowHorizontal | `38` | Dar yatay. |
| NarrowVertical | `39` | Dar dikey. |
| OutlinedDiamond | `40` | Ana hatlarıyla baklava desenli. |
| Plaid | `41` | Ekose. |
| Shingle | `42` | Kiremit. |
...
| Wave | `51` | Dalga. |
| Weave | `52` | Örgü. |
| WideDownwardDiagonal | `53` | Aşağıya doğru geniş diyagonal. |
| WideUpwardDiagonal | `54` | Yukarıya doğru geniş çapraz. |
| ZigZag | `55` | Zig zag. |
