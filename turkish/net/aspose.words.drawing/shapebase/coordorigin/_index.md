...
description: Tasarımlarınızı optimize etmek için ShapeBase CoordOrigin özelliğini keşfedin. Şeklinizin içerdiği bloğun sol üst köşesi için kesin koordinatlara erişin.
type: docs
weight: 110
