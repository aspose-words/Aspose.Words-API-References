...
description: ShapeBase mülk. Bu şeklin içerdiği bloğun içindeki koordinat uzayının genişliği ve yüksekliği.
type: docs
weight: 120
...
Bu şeklin içerdiği bloğun içindeki koordinat uzayının genişliği ve yüksekliği.
