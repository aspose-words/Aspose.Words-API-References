...
description: Çarpıcı görsel efektler için benzersiz nokta ve çizgi desenleriyle tasarımınızı özelleştirmek üzere Stroke DashStyle özelliğini keşfedin.
type: docs
weight: 70
...
Bir vuruş için nokta ve çizgi desenini belirtir.
