...
description: Stroke mülk. Konturun şeffaflık derecesini temsil eden 0.0 opak ile 1.0 net arasında bir değer alır veya ayarlar.
type: docs
weight: 180
...
Konturun şeffaflık derecesini temsil eden 0.0 (opak) ile 1.0 (net) arasında bir değer alır veya ayarlar.
