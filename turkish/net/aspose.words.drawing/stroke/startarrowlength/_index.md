...
description: Projelerinizde görsel çekiciliği ve hassasiyeti artırmak için tasarımınızın ok ucu uzunluğunu özelleştirmek üzere Stroke StartArrowLength özelliğini keşfedin.
type: docs
weight: 210
...
Bir vuruşun başlangıcı için ok ucu uzunluğunu tanımlar.
