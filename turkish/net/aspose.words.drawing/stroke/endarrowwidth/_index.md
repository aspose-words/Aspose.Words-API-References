...
description: Stroke EndArrowWidth özelliğini kullanarak vuruşlar için ok ucu genişliğini özelleştirebilir, tasarım hassasiyetinizi ve görsel çekiciliğinizi artırabilirsiniz.
type: docs
weight: 100
...
Bir vuruşun sonu için ok ucu genişliğini tanımlar.
