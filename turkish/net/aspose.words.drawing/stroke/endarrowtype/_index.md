...
description: Stroke EndArrowType özelliğinin, vuruşlar için şık ok uçları tanımlayarak tasarımlarınızı nasıl geliştirdiğini keşfedin. Grafiklerinizi bugün yükseltin!
type: docs
weight: 90
...
Bir vuruşun sonu için ok ucunu tanımlar.
