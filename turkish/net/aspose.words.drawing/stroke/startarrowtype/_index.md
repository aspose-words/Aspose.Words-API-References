...
description: Tasarımınızın görsel çekiciliğini ve netliğini artırmak için vuruşların başlangıcındaki ok uçlarını özelleştirmek üzere Stroke StartArrowType özelliğini keşfedin.
type: docs
weight: 220
...
Bir vuruşun başlangıcı için ok ucunu tanımlar.
