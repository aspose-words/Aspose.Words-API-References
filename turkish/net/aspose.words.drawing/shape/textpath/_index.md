...
description: Görsel çekiciliği artırmak ve çarpıcı metin efektleri oluşturmak için WordArt'ınızı Shape TextPath özelliğiyle özelleştirin.
type: docs
weight: 240
...
Metin yolunun (WordArt nesnesinin) metnini tanımlar.
