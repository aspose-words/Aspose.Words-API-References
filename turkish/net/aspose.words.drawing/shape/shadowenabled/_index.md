...
description: Shape ShadowEnabled özelliğinin, daha dinamik bir görsel çekicilik için gölge efektlerini etkinleştirerek tasarımlarınızı nasıl geliştirdiğini keşfedin.
type: docs
weight: 160
...
Geri Döndürür`doğru` gölge efekti etkinleştirilmişse.
