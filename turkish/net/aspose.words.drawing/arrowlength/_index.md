...
description: Belgelerinizdeki gelişmiş çizgi grafikleri için ok uzunluklarını özelleştirmek üzere Aspose.Words.Drawing.ArrowLength enum'unu keşfedin. Tasarımınızı bugün yükseltin!
type: docs
weight: 720
url: /tr/net/aspose.words.drawing/arrowlength/
---
## ArrowLength enumeration

Bir satırın sonundaki okun uzunluğu.
