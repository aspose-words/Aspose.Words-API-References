...
description: GradientStop mülk. 0.0 ila 1.0 aralığında yüzde olarak ifade edilen degrade içindeki bir durağın konumunu temsil eden bir değer alır veya ayarlar.
type: docs
weight: 30
