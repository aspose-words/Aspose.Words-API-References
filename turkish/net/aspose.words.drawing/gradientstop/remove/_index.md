...
description: GradientStopCollection'dan degrade duraklarının kaldırılmasını kolaylaştıran GradientStop Remove yöntemi ile degradelerinizi zahmetsizce yönetin.
type: docs
weight: 60
