...
description: GradientStop Remove yöntem. Degrade durağını üst öğeden kaldırırGradientStopCollection  C#'da.
type: docs
weight: 60
...
Degrade durağını üst öğeden kaldırır[`GradientStopCollection`](../../gradientstopcollection/) .
