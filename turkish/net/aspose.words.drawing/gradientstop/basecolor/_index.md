...
description: GradientStop BaseColor özelliğini keşfederek degrade durağınızın saf rengine kolayca erişebilir, tasarımınızı hassasiyet ve netlikle geliştirebilirsiniz.
type: docs
weight: 20
...
Herhangi bir değiştirici kullanmadan degrade durağının rengini temsil eden bir değer alır.
