...
description: GradientStop Transparency özelliğini keşfederek degrade dolgu şeffaflığını %0'dan %100'e kadar kolayca ayarlayın. Tasarımlarınızı hassas kontrolle geliştirin!
type: docs
weight: 50
...
Degradenin şeffaflığını temsil eden bir değeri alır veya ayarlar fill 0,0 ile 1,0 aralığında bir yüzde olarak ifade edilir.
