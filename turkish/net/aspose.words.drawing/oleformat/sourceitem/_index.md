...
description: OleFormat SourceItem özelliğini keşfedin, bu temel dize işlevselliğiyle kaynak dosyanızın bağlantılı bölümlerini kolayca tanımlayın ve yönetin.
type: docs
weight: 110
...
Bağlantı kurulan kaynak dosyanın bölümünü tanımlamak için kullanılan bir dizeyi alır veya ayarlar.
...
Örneğin, kaynak dosya bir Microsoft Excel çalışma kitabıysa,`SourceItem` özelliği, OLE nesnesi çalışma sayfasından yalnızca birkaç hücre içeriyorsa "Workbook1!R3C1:R4C2" değerini döndürebilir.
