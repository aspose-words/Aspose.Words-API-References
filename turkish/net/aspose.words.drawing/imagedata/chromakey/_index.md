...
description: ImageData ChromaKey özelliğini keşfedin, görselleriniz için şeffaf renkler ayarlayın ve görsel efektleri zahmetsizce geliştirin. Yaratıcı olasılıkların kilidini açın!
type: docs
weight: 40
...
Şeffaf olarak ele alınacak görüntünün renk değerini tanımlar.
