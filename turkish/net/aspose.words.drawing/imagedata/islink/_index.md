...
description: ImageData mülk. Görüntü şekle bağlıysa true döndürür ne zamanSourceFullName belirtilir.
type: docs
weight: 150
...
Görüntü şekle bağlıysa true döndürür (ne zaman[`SourceFullName`](../sourcefullname/) belirtilir).
