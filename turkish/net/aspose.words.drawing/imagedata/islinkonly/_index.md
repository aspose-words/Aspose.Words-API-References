...
description: ImageData IsLinkOnly özelliğini keşfedin; bu özellik, bir görüntünün harici olarak bağlantılı olup olmadığını gösterir ve belge verimliliğini ve depolama yönetimini artırır.
type: docs
weight: 160
...
Geri Döndürür`doğru` eğer görüntü bağlantılıysa ve belgede saklanmıyorsa.
