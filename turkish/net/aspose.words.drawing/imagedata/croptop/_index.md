...
description: Görüntülerinizi ImageData CropTop ile optimize edin, mükemmel çerçeveleme ve gelişmiş görsel çekicilik için üstten resim kaldırmayı kontrol edin.
type: docs
weight: 90
...
Resmin üst taraftan kaldırılma oranını tanımlar.
