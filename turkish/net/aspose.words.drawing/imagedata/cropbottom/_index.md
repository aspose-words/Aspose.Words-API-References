...
description: Görüntülerinizin alt kısmındaki istenmeyen kısımları kaldırarak mükemmel bir uyum için görüntülerinizi kolayca özelleştirmek amacıyla ImageData CropBottom özelliğini keşfedin.
type: docs
weight: 60
url: /tr/net/aspose.words.drawing/imagedata/cropbottom/
---
## ImageData.CropBottom property

Alt taraftan resim kaldırma oranını tanımlar.
