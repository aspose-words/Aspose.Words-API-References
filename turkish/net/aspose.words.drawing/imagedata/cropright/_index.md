...
description: ImageData CropRight özelliğini keşfedin, hassas görüntü düzenleme ve gelişmiş görsel çekicilik için resim kırpmayı sağ taraftan kontrol edin.
type: docs
weight: 80
...
Sağ taraftan resim kaldırma oranını tanımlar.
