...
description: Belirtilen resim için kontrastı alır veya ayarlar. Bu özellik için değer  00 en az karşıtlık ile 10 en büyük karşıtlık arasında bir sayı olmalıdır.
type: docs
weight: 50
