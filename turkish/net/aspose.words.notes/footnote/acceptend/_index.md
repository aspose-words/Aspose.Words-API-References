...
description: Dipnot ziyaretlerini sorunsuz bir şekilde yöneterek kullanıcı deneyimini geliştirmek için tasarlanmış Footnote AcceptEnd yöntemini keşfedin. Navigasyonu bugün geliştirin!
type: docs
weight: 90
url: /tr/net/aspose.words.notes/footnote/acceptend/
---
## Footnote.AcceptEnd method

Dipnotun sonunu ziyaret eden bir ziyaretçiyi kabul eder.
