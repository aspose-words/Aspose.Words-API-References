...
description: Bu dipnot için kullanılacak özel referans işaretini alır/ayarlar. Varsayılan değer boş dize Empty  yani otomatik numaralandırılmış dipnotlar kullanılır.
type: docs
weight: 50
