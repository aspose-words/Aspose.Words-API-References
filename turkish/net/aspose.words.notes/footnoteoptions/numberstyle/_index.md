...
description: FootnoteOptions mülk. Otomatik olarak numaralandırılmış dipnotlar için sayı biçimini belirtir.
type: docs
weight: 20
...
Otomatik olarak numaralandırılmış dipnotlar için sayı biçimini belirtir.
