...
description: EndnoteOptions mülk. Otomatik numaralandırmanın ne zaman yeniden başlayacağını belirler.
type: docs
weight: 30
...
Tüm değerler son notlar için geçerli değildir. Hangi değerlerin uygulanabilir olduğunu belirlemek için bkz.[`FootnoteNumberingRule`](../../footnotenumberingrule/).
