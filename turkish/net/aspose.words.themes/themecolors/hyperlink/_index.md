...
description: Web sitenizin tasarımını ve kullanıcı deneyimini zahmetsizce geliştirmek için köprü renklerini özelleştirmek amacıyla ThemeColors Hyperlink özelliğini keşfedin.
type: docs
weight: 100
...
Bir köprü metni için renk belirtir.
