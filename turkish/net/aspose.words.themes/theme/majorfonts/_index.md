...
description: Sitenizin tipografisini MajorFonts ile özelleştirin. Okunabilirliği ve kullanıcı deneyimini geliştirmek için birden fazla dil için kolayca çeşitli yazı tipleri ayarlayın.
type: docs
weight: 30
url: /tr/net/aspose.words.themes/theme/majorfonts/
---
## Theme.MajorFonts property

Farklı diller için ana yazı tiplerinin kümesini belirtmeye olanak tanır.
