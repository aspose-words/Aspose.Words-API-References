...
description: MajorFonts, MinorFonts ve canlı Renkler gibi özelleştirilebilir temalarla belgelerinizi geliştirmek için Aspose.Words.Theme sınıfını keşfedin.
type: docs
weight: 7310
...
Belge Temasını temsil eder ve ana tema bölümlerine erişim sağlar.[`MajorFonts`](./majorfonts/) ,[`MinorFonts`](./minorfonts/) Ve[`Colors`](./colors/)
...
| İsim | Tanım |
| --- | --- |
| [Colors](../../aspose.words.themes/theme/colors/) { get; } | Belge için tema renkleri kümesini belirtmenize olanak tanır. |
| [MajorFonts](../../aspose.words.themes/theme/majorfonts/) { get; } | Farklı diller için ana yazı tiplerinin kümesini belirtmeye olanak tanır. |
| [MinorFonts](../../aspose.words.themes/theme/minorfonts/) { get; } | Farklı diller için küçük yazı tiplerinin kümesini belirtmenize olanak tanır. |
