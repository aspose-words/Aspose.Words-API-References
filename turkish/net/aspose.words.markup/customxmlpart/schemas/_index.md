...
description: Özel XML parçalarınızla bağlantılı XML şemalarını kolayca yönetmek, veri organizasyonunu ve verimliliği artırmak için CustomXmlPart Schemas özelliğini keşfedin.
type: docs
weight: 50
...
Bu özel XML parçasıyla ilişkili XML şemaları kümesini belirtir.
