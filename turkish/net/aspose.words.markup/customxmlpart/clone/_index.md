...
description: CustomXmlPart yöntem. Nesnenin yeterince derin bir kopyasını oluşturur. Data değer.
type: docs
weight: 60
...
Nesnenin "yeterince derin" bir kopyasını oluşturur. [`Data`](../data/) değer.
