...
description: Bunun için benzersiz bir salt okunur kalıcı sayısal kimlik belirtir YapılandırılmışBelgeEtiketAralığı node. Karşılık gelenStructuredDocumentTagRangeStartaspose.words.markup/structureddocumenttagrangestart düğüm aynıIdaspose.words.markup/structureddocumenttagrangestart/id .
type: docs
weight: 20
