...
description: StructuredDocumentTagRangeStart mülk. true olarak ayarlandığında bu özellik bir kullanıcının bu yapılandırılmış belge etiketinin içeriğini düzenlemesini engeller.
type: docs
weight: 90
