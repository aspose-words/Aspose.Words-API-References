...
description: Bu yapılandırılmış belge etiketinin içeriğinin yapılandırılmış belge etiketi içindeki normal metin içeriklerinin aksine yer tutucu metin içerecek şekilde yorumlanıp yorumlanmayacağını belirtir.
type: docs
weight: 50
