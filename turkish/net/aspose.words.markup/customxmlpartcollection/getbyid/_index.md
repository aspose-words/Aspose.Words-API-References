...
description: Gelişmiş veri yönetimi için benzersiz tanımlayıcılarına göre özel XML parçalarını zahmetsizce almak üzere CustomXmlPartCollection GetById yöntemini keşfedin.
type: docs
weight: 70
...
Tanımlayıcısına göre özel bir XML parçasını bulur ve döndürür.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| id | String | Özel XML parçasını tanımlayan büyük/küçük harfe duyarlı dize. |

### Geri dönüş değeri

İade`hükümsüz` Belirtilen tanımlayıcıya sahip özel bir XML parçası bulunamazsa.
