...
description: SmartTag Uri özelliğini keşfedin; gelişmiş işlevsellik ve uygulamalarınızda sorunsuz entegrasyon için akıllı etiketinizin ad alanı URI'sini tanımlayın.
type: docs
weight: 50
...
Akıllı etiketin ad alanı URI'sini belirtir.
