...
description: Gelişmiş organizasyon ve verimlilik için belgelerinizdeki akıllı etiket adlarını kolayca tanımlamak ve yönetmek amacıyla SmartTag Element özelliğini keşfedin.
type: docs
weight: 20
...
Belge içindeki akıllı etiketin adını belirtir.
