...
description: CustomXmlProperty oluşturucusunu keşfedin. Projelerinizde sorunsuz XML özelliği yönetimi için yeni örnekleri kolayca oluşturun ve başlatın.
type: docs
weight: 10
url: /tr/net/aspose.words.markup/customxmlproperty/customxmlproperty/
---
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| name | String | Mülkün adı. Olamaz`hükümsüz`. |
| uri | String | Özelliğin ad alanı URI'si. Olamaz`hükümsüz`. |
| value | String | Mülkün değeri. Olamaz`hükümsüz`. |
