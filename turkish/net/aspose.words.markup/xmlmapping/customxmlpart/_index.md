...
description: Gelişmiş belge entegrasyonu için yapılandırılmış belge etiketlerinizi özel XML veri parçalarına bağlayan XmlMapping CustomXmlPart özelliğini keşfedin.
type: docs
weight: 10
