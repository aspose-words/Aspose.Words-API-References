...
description: StructuredDocumentTag XmlMapping özelliğinin etiketlerinizi XML verilerine nasıl bağladığını, sorunsuz iş akışları için belge özelleştirmesini ve entegrasyonunu nasıl geliştirdiğini keşfedin.
type: docs
weight: 320
...
Şunu kullanabilirsiniz:[`SetMapping`](../../xmlmapping/setmapping/) bu nesnenin XML verilerine yapılandırılmış bir belge etiketini map olarak eşleme yöntemi.
