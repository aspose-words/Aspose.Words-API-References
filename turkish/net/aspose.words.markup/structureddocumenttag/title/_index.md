...
description: SDT'niz için kullanıcı dostu bir ad tanımlayan, belgenin açıklığını ve kullanılabilirliğini artıran StructuredDocumentTag Title özelliğini keşfedin.
type: docs
weight: 290
...
Bu ile ilişkili dostça adı belirtir**SDT** . olamaz`hükümsüz` .
