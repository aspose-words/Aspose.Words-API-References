...
description: BuildingBlockaspose.words.buildingblocks/buildingblock bu SDT çalıştırma içeriği boş olduğunda görüntülenmesi gereken yer tutucu metni içeren ilişkili eşlenen XML öğesiXmlMappingaspose.words.markup/structureddocumenttag/xmlmapping element veyaIsShowingPlaceholderTextaspose.words.markup/structureddocumenttag/isshowingplaceholdertext eleman doğrudur.
type: docs
weight: 230
