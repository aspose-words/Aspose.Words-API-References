...
description: SDT'de kusursuz metin biçimlendirme için StructuredDocumentTag ContentsFont özelliğini keşfedin. Özelleştirilebilir yazı tipi seçenekleriyle belgelerinizi geliştirin!
type: docs
weight: 80
...
Girilen metne uygulanacak yazı tipi biçimlendirmesi**SDT** .
