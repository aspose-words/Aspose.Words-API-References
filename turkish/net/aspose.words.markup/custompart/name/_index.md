...
description: OOXML paketlerinde CustomPart adlarının nasıl yönetileceğini keşfedin. Sorunsuz entegrasyon ve gelişmiş işlevsellik için mutlak adları kolayca ayarlayın veya alın.
type: docs
weight: 50
...
Bu parçanın OOXML paketindeki veya hedef URL'deki mutlak adını alır veya ayarlar.
