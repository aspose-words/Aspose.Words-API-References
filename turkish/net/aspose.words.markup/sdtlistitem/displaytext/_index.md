...
description: SdtListItem mülk. Çalıştırma içeriğinde görüntülenecek metni alır.Value bu liste öğesi için öznitelik içeriği.
type: docs
weight: 20
...
Çalıştırma içeriğinde görüntülenecek metni alır.[`Value`](../value/) bu liste öğesi için öznitelik içeriği.
