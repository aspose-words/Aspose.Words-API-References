...
description: SdtListItem DisplayText özelliğinin görüntülenen metni özelleştirerek, kullanıcı etkileşimini ve netliği iyileştirerek içeriğinizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 20
...
Çalıştırma içeriğinde gösterilecek metni alır[`Value`](../value/) bu liste öğesinin öznitelik içerikleri.
