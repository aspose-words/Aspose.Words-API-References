...
description: SDT'nizdeki yer tutucu metni kolayca tanımlamak, içerik netliğini ve yönetimini geliştirmek için IStructuredDocumentTag IsShowingPlaceholderText özelliğini keşfedin.
type: docs
weight: 50
...
true olarak ayarlanırsa, bu durum bu belge açıldığında devam ettirilecektir (yer tutucu metin gösterilir).
