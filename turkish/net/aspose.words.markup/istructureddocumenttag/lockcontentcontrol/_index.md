...
description: IStructuredDocumentTag LockContentControl özelliğini keşfedin. True olarak ayarlandığında, kullanıcıların SDT'yi silmesini önleyerek belge bütünlüğünü ve denetimini artırır.
type: docs
weight: 70
...
Bu özellik doğru olarak ayarlandığında, kullanıcının bunu silmesini engelleyecektir**SDT** .
