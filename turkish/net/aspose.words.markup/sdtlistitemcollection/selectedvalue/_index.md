...
description: Listenizdeki geçerli seçimi tanımlayan ve hiçbir seçim yapılmaması durumunda null değerini sağlayan SdtListItemCollection'ın SelectedValue özelliğini keşfedin. Veri yönetiminizi geliştirin!
type: docs
weight: 30
...
Bu listede şu anda seçili değeri belirtir. Boş değere izin verilir, yani şu anda seçili bir girdi bu liste öğesi koleksiyonuyla ilişkilendirilmemiştir.
