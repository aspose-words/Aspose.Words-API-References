...
description: SdtListItemCollection RemoveAt metoduyla bir liste öğesini dizine göre zahmetsizce kaldırın. Veri yönetiminizi bugün kolaylaştırın!
type: docs
weight: 70
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| index | Int32 | Kaldırılacak öğenin sıfırdan başlayan dizini. |
