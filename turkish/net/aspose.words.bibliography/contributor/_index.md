...
description: Kuruluşlar ve bireyler dahil olmak üzere bibliyografya katılımcılarını yönetmek için başvuracağınız çözüm olan Aspose.Words.Bibliography.Contributor sınıfını keşfedin.
type: docs
weight: 150
url: /tr/net/aspose.words.bibliography/contributor/
---
## Contributor class

Bir bibliyografya kaynağı katılımcısını temsil eder. Bir şirket (bir kuruluş) veya bir kişiler listesi olabilir.
