...
description: ContributorCollection Performer özelliğini keşfedin, gelişmiş veri organizasyonu ve alımı için kaynak icracılarını kolayca yönetin ve özelleştirin.
type: docs
weight: 130
url: /tr/net/aspose.words.bibliography/contributorcollection/performer/
---
## ContributorCollection.Performer property

Bir kaynağın icracısını alır veya ayarlar.
