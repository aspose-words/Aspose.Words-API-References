...
description: ContributorCollection Counsel'ı keşfedin. Gelişmiş mülk içgörüleri ve kolaylaştırılmış karar alma için kaynak danışmanlığını kolayca yönetin ve erişin.
type: docs
weight: 70
url: /tr/net/aspose.words.bibliography/contributorcollection/counsel/
---
## ContributorCollection.Counsel property

Bir kaynağın tavsiyesini alır veya ayarlar.
