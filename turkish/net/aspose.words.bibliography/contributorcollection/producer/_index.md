...
description: Medyanızı ContributorCollection'ın Producer özelliğiyle yönetin; içeriğin daha kolay düzenlenmesi için kaynağın maker'ını kolayca ayarlayın veya alın.
type: docs
weight: 140
url: /tr/net/aspose.words.bibliography/contributorcollection/producer/
---
## ContributorCollection.Producer property

Bir kaynağın üreticisini alır veya ayarlar.
