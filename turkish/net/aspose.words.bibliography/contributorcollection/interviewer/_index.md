...
description: ContributorCollection Röportajcı özelliğini keşfedin, kaynaklarınız için röportajcı ayrıntılarını kolayca yönetin ve özelleştirin. Veri yönetiminizi bugün geliştirin!
type: docs
weight: 110
url: /tr/net/aspose.words.bibliography/contributorcollection/interviewer/
---
## ContributorCollection.Interviewer property

Bir kaynağın görüşmecisini alır veya ayarlar.
