...
description: Bibliyografya katılımcılarını etkin bir şekilde yönetmek ve belgenizin referanslarını geliştirmek için Aspose.Words.Bibliography.ContributorCollection sınıfını keşfedin.
type: docs
weight: 160
url: /tr/net/aspose.words.bibliography/contributorcollection/
---
## ContributorCollection class

Bibliyografya kaynağı katkıda bulunanları temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Artist](../../aspose.words.bibliography/contributorcollection/artist/) { get; set; } | Bir kaynağın sanatçısını alır veya ayarlar. |
| [Author](../../aspose.words.bibliography/contributorcollection/author/) { get; set; } | Bir kaynağın yazarını alır veya ayarlar. |
| [BookAuthor](../../aspose.words.bibliography/contributorcollection/bookauthor/) { get; set; } | Bir kaynağın kitap yazarını alır veya ayarlar. |
| [Compiler](../../aspose.words.bibliography/contributorcollection/compiler/) { get; set; } | Bir kaynağın derleyicisini alır veya ayarlar. |
| [Composer](../../aspose.words.bibliography/contributorcollection/composer/) { get; set; } | Bir kaynağın bestecisini alır veya ayarlar. |
| [Conductor](../../aspose.words.bibliography/contributorcollection/conductor/) { get; set; } | Bir kaynağın iletkenini alır veya ayarlar. |
| [Counsel](../../aspose.words.bibliography/contributorcollection/counsel/) { get; set; } | Bir kaynağın tavsiyesini alır veya ayarlar. |
| [Director](../../aspose.words.bibliography/contributorcollection/director/) { get; set; } | Bir kaynağın yönetmenini alır veya ayarlar. |
| [Editor](../../aspose.words.bibliography/contributorcollection/editor/) { get; set; } | Bir kaynağın düzenleyicisini alır veya ayarlar. |
| [Interviewee](../../aspose.words.bibliography/contributorcollection/interviewee/) { get; set; } | Bir kaynağın röportaj yapılan kişisini alır veya ayarlar. |
| [Interviewer](../../aspose.words.bibliography/contributorcollection/interviewer/) { get; set; } | Bir kaynağın görüşmecisini alır veya ayarlar. |
| [Inventor](../../aspose.words.bibliography/contributorcollection/inventor/) { get; set; } | Bir kaynağın yaratıcısını alır veya ayarlar. |
| [Performer](../../aspose.words.bibliography/contributorcollection/performer/) { get; set; } | Bir kaynağın icracısını alır veya ayarlar. |
| [Producer](../../aspose.words.bibliography/contributorcollection/producer/) { get; set; } | Bir kaynağın üreticisini alır veya ayarlar. |
| [Translator](../../aspose.words.bibliography/contributorcollection/translator/) { get; set; } | Bir kaynağın çevirmenini alır veya ayarlar. |
| [Writer](../../aspose.words.bibliography/contributorcollection/writer/) { get; set; } | Bir kaynağın yazarını alır veya ayarlar. |
