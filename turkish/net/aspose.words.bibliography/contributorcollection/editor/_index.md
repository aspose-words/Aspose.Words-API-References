...
description: ContributorCollection'ınızı kolaylıkla yönetin! İş akışınızı geliştirmek ve içerik yönetimini kolaylaştırmak için kaynaklar için düzenleyiciyi ayarlayın veya edinin.
type: docs
weight: 90
url: /tr/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

Bir kaynağın düzenleyicisini alır veya ayarlar.
