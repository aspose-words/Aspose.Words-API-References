...
description: Gelişmiş veri organizasyonu ve verimlilik için kaynak bestecileri kolayca yönetmek ve özelleştirmek amacıyla ContributorCollection Composer özelliğini keşfedin.
type: docs
weight: 50
url: /tr/net/aspose.words.bibliography/contributorcollection/composer/
---
## ContributorCollection.Composer property

Bir kaynağın bestecisini alır veya ayarlar.
