...
description: ContributorCollection Conductor özelliğini keşfedin, gelişmiş veri organizasyonu ve kontrolü için kaynak iletkenini kolayca yönetin ve özelleştirin.
type: docs
weight: 60
url: /tr/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Bir kaynağın iletkenini alır veya ayarlar.
