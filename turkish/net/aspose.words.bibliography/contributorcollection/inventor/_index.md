...
description: Kaynaklarınızın mucidini kolayca yönetmek ve belirlemek için ContributorCollection Inventor özelliğini keşfedin ve projenizin organizasyonunu geliştirin.
type: docs
weight: 120
url: /tr/net/aspose.words.bibliography/contributorcollection/inventor/
---
## ContributorCollection.Inventor property

Bir kaynağın yaratıcısını alır veya ayarlar.
