...
description: Projelerinizde araştırmanızı geliştirmek ve doğru atıfları garantilemek için mükemmel olan kapsamlı bir bibliyografya kaynakları koleksiyonunu keşfedin.
type: docs
weight: 20
url: /tr/net/aspose.words.bibliography/bibliography/sources/
---
## Bibliography.Sources property

Bir bibliyografyada bulunan tüm kaynakları temsil eden bir koleksiyon alır.
