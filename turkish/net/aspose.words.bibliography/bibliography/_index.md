...
description: Belgelerdeki bibliyografya kaynaklarını etkin ve zahmetsizce yönetmek için temel aracınız olan Aspose.Words.Bibliography sınıfını keşfedin.
type: docs
weight: 140
url: /tr/net/aspose.words.bibliography/bibliography/
---
## Bibliography class

Belgede mevcut bibliyografya kaynaklarının listesini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | Bir bibliyografya için kullanılacak etkin stilin adını temsil eden bir dize alır veya ayarlar. |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | Bir bibliyografyada bulunan tüm kaynakları temsil eden bir koleksiyon alır. |
