...
description: Kullanıcı dostu oluşturucumuzla zahmetsizce yeni bir Person örneği oluşturun. Kodlamanızı basitleştirin ve projelerinizi bugün geliştirin!
type: docs
weight: 10
url: /tr/net/aspose.words.bibliography/person/person/
---
## Person constructor

Yeni bir örneğini başlat[`Person`](../) sınıf.
