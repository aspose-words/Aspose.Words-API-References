...
description: Bibliyografyalardaki bireysel katılımcıları yönetmek için Aspose.Words.Bibliography.Person sınıfını keşfedin. Belgenizin atıf doğruluğunu artırın!
type: docs
weight: 180
url: /tr/net/aspose.words.bibliography/person/
---
## Person class

Bireysel (bir kişi) bibliyografya kaynağı katılımcısını temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [Person](person/)(*string, string, string*) | Yeni bir örneğini başlat`Person` sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | Bir kişinin adını alır veya ayarlar. |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | Bir kişinin soyadını alır veya ayarlar. |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | Bir kişinin ikinci adını alır veya ayarlar. |
