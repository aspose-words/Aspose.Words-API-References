...
description: Veri kaynaklarınızı kolayca yönetmek için SourceType özelliğini keşfedin. Gelişmiş veri organizasyonu için kaynak türlerini zahmetsizce alın veya ayarlayın.
type: docs
weight: 410
url: /tr/net/aspose.words.bibliography/source/sourcetype/
---
## Source.SourceType property

Bir kaynağın kaynak türünü alır veya ayarlar.
