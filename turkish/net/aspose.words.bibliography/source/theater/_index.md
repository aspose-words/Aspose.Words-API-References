...
description: Source Theater özelliğini keşfedin, gelişmiş bir eğlence deneyimi için tiyatro ayarlarınızı zahmetsizce yönetin ve özelleştirin. Yaratıcı potansiyelinizi açığa çıkarın!
type: docs
weight: 460
url: /tr/net/aspose.words.bibliography/source/theater/
---
## Source.Theater property

Bir kaynağın tiyatrosunu alır veya ayarlar.
