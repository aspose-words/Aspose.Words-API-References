...
description: Kaynağınızın süreli yayın başlığını zahmetsizce yönetin. Gelişmiş organizasyon ve doğru referanslama için başlıkları kolayca alın veya ayarlayın.
type: docs
weight: 330
url: /tr/net/aspose.words.bibliography/source/periodicaltitle/
---
## Source.PeriodicalTitle property

Bir kaynağın periyodik başlığını alır veya ayarlar.
