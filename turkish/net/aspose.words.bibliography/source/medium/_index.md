...
description: Sezgisel aracımızla kaynağınızın ortamını zahmetsizce yönetin. Veri organizasyonunuzu geliştirin ve iş akışınızı bugünden itibaren kolaylaştırın!
type: docs
weight: 270
url: /tr/net/aspose.words.bibliography/source/medium/
---
## Source.Medium property

Bir kaynağın ortamını alır veya ayarlar.
