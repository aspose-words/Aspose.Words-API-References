...
description: StateOrProvince özelliklerini zahmetsizce nasıl yöneteceğinizi keşfedin. Kullanıcı dostu rehberimizle herhangi bir kaynak için eyalet veya ili kolayca alın veya ayarlayın!
type: docs
weight: 430
url: /tr/net/aspose.words.bibliography/source/stateorprovince/
---
## Source.StateOrProvince property

Bir kaynağın durumunu veya eyaletini alır veya ayarlar.
