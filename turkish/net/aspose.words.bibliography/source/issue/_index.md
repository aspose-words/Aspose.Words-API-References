...
description: Kaynak sorunlarınızı zahmetsizce yönetin. İş akışınızı kolaylaştırmak ve üretkenliği artırmak için kaynak özelliklerini kolayca alın veya ayarlayın.
type: docs
weight: 240
url: /tr/net/aspose.words.bibliography/source/issue/
---
## Source.Issue property

Bir kaynağın sorununu alır veya ayarlar.
