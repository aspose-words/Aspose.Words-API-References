...
description: Source InternetSiteTitle'ınızı zahmetsizce yönetin. Gelişmiş çevrimiçi görünürlük ve markalaşma için web sitenizin başlığını kolayca güncelleyin veya alın.
type: docs
weight: 230
url: /tr/net/aspose.words.bibliography/source/internetsitetitle/
---
## Source.InternetSiteTitle property

Bir kaynağın internet sitesi başlığını alır veya ayarlar.
