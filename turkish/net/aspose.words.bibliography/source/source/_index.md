...
description: Oluşturucumuzla zahmetsizce yeni bir Source sınıf örneği oluşturun. Kodlama sürecinizi basitleştirin ve projenizin verimliliğini bugün artırın!
type: docs
weight: 10
url: /tr/net/aspose.words.bibliography/source/source/
---
## Source constructor

Yeni bir örneğini başlat[`Source`](../) sınıf.
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| tag | String | Tanımlayıcı etiket adı. |
| sourceType | SourceType | Kaynak türü. |
