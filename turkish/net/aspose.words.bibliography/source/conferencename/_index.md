...
description: Source ConferenceName ile konferans adlarını zahmetsizce nasıl yöneteceğinizi keşfedin. Araştırmanızı basitleştirin ve atıf doğruluğunuzu bugün artırın!
type: docs
weight: 110
url: /tr/net/aspose.words.bibliography/source/conferencename/
---
## Source.ConferenceName property

Bir kaynağın konferans veya işlem adını alır veya ayarlar.
