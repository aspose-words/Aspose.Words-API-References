...
description: Kaynağınızın dergi adını JournalName özelliğiyle kolayca nasıl yöneteceğinizi keşfedin. Araştırmanızı basitleştirin ve atıflarınızı bugün geliştirin!
type: docs
weight: 250
url: /tr/net/aspose.words.bibliography/source/journalname/
---
## Source.JournalName property

Bir kaynağın günlük adını alır veya ayarlar.
