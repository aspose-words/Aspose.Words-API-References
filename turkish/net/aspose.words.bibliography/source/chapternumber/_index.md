...
description: Kaynağınızın bölüm numarasını ChapterNumber özelliğiyle zahmetsizce yönetin; kullanımı kolay ve düzenli referanslama için olmazsa olmazdır.
type: docs
weight: 80
url: /tr/net/aspose.words.bibliography/source/chapternumber/
---
