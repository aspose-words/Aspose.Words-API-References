...
description: Kaynak departmanınızı zahmetsizce yönetin. Gelişmiş organizasyon ve verimlilik için departman ayrıntılarını kolayca alın veya ayarlayın. Bugün kusursuz entegrasyonu keşfedin!
type: docs
weight: 170
url: /tr/net/aspose.words.bibliography/source/department/
---
## Source.Department property

Bir kaynağın bölümünü alır veya ayarlar.
