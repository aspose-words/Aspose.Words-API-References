...
description: Kaynak NumberVolumes'u kolayca yönetin. En iyi kaynak yönetimi için hacim sayısını ayarlayın ve veri organizasyonunuzu zahmetsizce geliştirin.
type: docs
weight: 300
url: /tr/net/aspose.words.bibliography/source/numbervolumes/
---
## Source.NumberVolumes property

Bir kaynağın birim sayısını alır veya ayarlar.
