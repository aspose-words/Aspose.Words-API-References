...
description: Sorunsuz dijital nesne tanımlayıcısı kullanımı için Doi özelliklerinin nasıl verimli bir şekilde yönetileceğini keşfedin. Araştırma görünürlüğünüzü bugün artırın!
type: docs
weight: 190
url: /tr/net/aspose.words.bibliography/source/doi/
---
## Source.Doi property

Dijital nesne tanımlayıcısını alır veya ayarlar.
