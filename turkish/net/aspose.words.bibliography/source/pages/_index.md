...
description: Kaynak Sayfaları zahmetsizce yönetin. İçerik organizasyonunuzu ve iş akışı verimliliğinizi artırmak için kaynak sayfa ayrıntılarını kolayca alın veya ayarlayın.
type: docs
weight: 310
url: /tr/net/aspose.words.bibliography/source/pages/
---
## Source.Pages property

Bir kaynağın sayfalarını alır veya ayarlar.
