...
description: Kitap başlıklarınızı kolayca yönetmek ve özelleştirmek için BookTitle özelliğini keşfedin. Bu temel özellik ile kaynak yönetiminizi geliştirin!
type: docs
weight: 40
url: /tr/net/aspose.words.bibliography/source/booktitle/
---
## Source.BookTitle property

Bir kaynağın kitap başlığını alır veya ayarlar.
