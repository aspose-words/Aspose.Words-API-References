...
description: Kaynağınızın erişim tarihini Source DayAccessed ile zahmetsizce yönetin. Daha iyi bir organizasyon için kaynağınıza ne zaman erişildiğini kolayca takip edin ve güncelleyin.
type: docs
weight: 160
url: /tr/net/aspose.words.bibliography/source/dayaccessed/
---
## Source.DayAccessed property

Bir kaynağın erişildiği günü alır veya ayarlar.
