...
description: Kaynak Etiket özelliğinizi zahmetsizce yönetin. Kaynağınız için benzersiz etiket adını kolayca alın veya ayarlayın, organizasyonunuzu ve verimliliğinizi artırın.
type: docs
weight: 450
url: /tr/net/aspose.words.bibliography/source/tag/
---
## Source.Tag property

Bir kaynağın tanımlayıcı etiket adını alır veya ayarlar.
