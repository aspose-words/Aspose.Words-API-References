...
description: Kaynağınızın kısa başlığını zahmetsizce yönetin. Sorunsuz organizasyon ve geliştirilmiş netlik için ShortTitle özelliğini kolayca alın veya ayarlayın.
type: docs
weight: 400
url: /tr/net/aspose.words.bibliography/source/shorttitle/
---
## Source.ShortTitle property

Bir kaynağın kısa başlığını alır veya ayarlar.
