...
description: Lcid özelliğini zahmetsizce yönetin. Sorunsuz yerelleştirme ve gelişmiş kullanıcı deneyimi için kaynağınızın yerel kimliğini alın veya ayarlayın.
type: docs
weight: 260
url: /tr/net/aspose.words.bibliography/source/lcid/
---
## Source.Lcid property

Bir kaynağın yerel kimliğini alır veya ayarlar.
