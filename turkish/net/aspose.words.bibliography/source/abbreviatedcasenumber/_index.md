...
description: Kullanıcı dostu aracımızla kaynağınızın kısaltılmış dava numarasını zahmetsizce yönetin. Dava takibinizi bugün basitleştirin!
type: docs
weight: 20
url: /tr/net/aspose.words.bibliography/source/abbreviatedcasenumber/
---
## Source.AbbreviatedCaseNumber property

Bir kaynağın kısaltılmış durum numarasını alır veya ayarlar.
