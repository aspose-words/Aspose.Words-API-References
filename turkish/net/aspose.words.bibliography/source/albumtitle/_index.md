...
description: AlbumTitle özelliğiyle kaynağınızın albüm başlığını zahmetsizce yönetin. Daha iyi organizasyon ve erişilebilirlik için başlıkları kolayca alın veya ayarlayın.
type: docs
weight: 30
url: /tr/net/aspose.words.bibliography/source/albumtitle/
---
## Source.AlbumTitle property

Bir kaynağın albüm başlığını alır veya ayarlar.
