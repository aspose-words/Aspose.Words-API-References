...
description: Source ProductionCompany ile prodüksiyon şirketinizi zahmetsizce yönetin. Sorunsuz iş birliği için kaynağınızın prodüksiyon ayrıntılarını kolayca ayarlayın veya güncelleyin.
type: docs
weight: 340
url: /tr/net/aspose.words.bibliography/source/productioncompany/
---
## Source.ProductionCompany property

Bir kaynağın üretim şirketini alır veya ayarlar.
