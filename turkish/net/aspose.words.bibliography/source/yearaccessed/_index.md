...
description: Source YearAccessed özelliğinizi kolayca yönetin. Doğru alıntılar ve akıcı araştırma yönetimi için erişilen yılı alın veya ayarlayın.
type: docs
weight: 540
url: /tr/net/aspose.words.bibliography/source/yearaccessed/
---
## Source.YearAccessed property

Bir kaynağın erişildiği yılı alır veya ayarlar.
