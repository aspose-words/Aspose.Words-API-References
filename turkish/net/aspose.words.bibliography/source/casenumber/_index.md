...
description: Kaynak CaseNumber özelliğiyle kaynağınızın vaka numarasını zahmetsizce yönetin. Daha iyi sonuçlar için izlemeyi basitleştirin ve organizasyonu geliştirin.
type: docs
weight: 70
url: /tr/net/aspose.words.bibliography/source/casenumber/
---
## Source.CaseNumber property

Bir kaynağın durum numarasını alır veya ayarlar.
