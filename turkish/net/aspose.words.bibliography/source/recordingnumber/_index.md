...
description: Kaynak Kayıt Numarası özelliğiyle kayıtlarınızı zahmetsizce yönetin; sorunsuz ses yönetimi için kaynak kayıt numaralarını hızla alın veya güncelleyin.
type: docs
weight: 370
url: /tr/net/aspose.words.bibliography/source/recordingnumber/
---
## Source.RecordingNumber property

Bir kaynağın kayıt numarasını alır veya ayarlar.
