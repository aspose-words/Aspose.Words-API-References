...
description: Kaynağınızın erişim ayını zahmetsizce yönetin. En iyi veri takibi ve organizasyonu için erişilen ayı kolayca ayarlayın veya alın.
type: docs
weight: 290
url: /tr/net/aspose.words.bibliography/source/monthaccessed/
---
## Source.MonthAccessed property

Bir kaynağın erişildiği ayı alır veya ayarlar.
