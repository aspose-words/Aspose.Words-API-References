...
description: Source Reporter özelliğinizi zahmetsizce yönetin. Herhangi bir kaynak için muhabiri kolayca alın veya ayarlayın ve veri yönetimi verimliliğinizi artırın.
type: docs
weight: 390
url: /tr/net/aspose.words.bibliography/source/reporter/
---
## Source.Reporter property

Bir kaynağın muhabirini alır veya ayarlar.
