...
description: Kaynak Yılı özelliğinizi zahmetsizce yönetin. Basitleştirilmiş veri organizasyonu ve gelişmiş doğruluk için bir kaynağın yılını kolayca alın veya ayarlayın.
type: docs
weight: 530
url: /tr/net/aspose.words.bibliography/source/year/
---
## Source.Year property

Bir kaynağın yılını alır veya ayarlar.
