...
description: Kaynak StandardNumber özelliğini zahmetsizce yönetin. Sorunsuz veri entegrasyonu ve doğruluğu için standart numarayı kolayca alın veya ayarlayın.
type: docs
weight: 420
url: /tr/net/aspose.words.bibliography/source/standardnumber/
---
## Source.StandardNumber property

Bir kaynağın standart numarasını alır veya ayarlar.
