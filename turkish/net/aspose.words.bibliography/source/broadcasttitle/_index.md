...
description: Kullanıcı dostu BroadcastTitle özelliğimizle kaynağınızın yayın başlığını zahmetsizce yönetin. İçeriğinizin görünürlüğünü ve etkileşimini bugün artırın!
type: docs
weight: 60
url: /tr/net/aspose.words.bibliography/source/broadcasttitle/
---
## Source.BroadcastTitle property

Bir kaynağın yayın başlığını alır veya ayarlar.
