...
description: Kaynak katkıda bulunanları verimli bir şekilde listeleyerek bibliyografya yönetimini kolaylaştırmak için tasarlanmış Aspose.Words.Bibliography.PersonCollection sınıfını keşfedin.
type: docs
weight: 190
url: /tr/net/aspose.words.bibliography/personcollection/
---
## PersonCollection class

Bibliyografya kaynağı katkıda bulunan kişilerin bir listesini temsil eder.
...
| İsim | Tanım |
| --- | --- |
| [PersonCollection](personcollection/#constructor)() | Yeni bir örneğini başlat`PersonCollection` sınıf. |
| [PersonCollection](personcollection/#constructor_2)(*IEnumerable&lt;Person&gt;*) |  |
| [PersonCollection](personcollection/#constructor_1)(*params Person[]*) | Yeni bir örneğini başlat`PersonCollection` sınıf. |

## Özellikleri

| İsim | Tanım |
| --- | --- |
| [Count](../../aspose.words.bibliography/personcollection/count/) { get; } | Koleksiyonda bulunan kişi sayısını alır. |
| [Item](../../aspose.words.bibliography/personcollection/item/) { get; set; } | Belirtilen dizindeki bir kişiyi alır veya ayarlar. |

## yöntemler

| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.words.bibliography/personcollection/add/)(*[Person](../person/)*) | Bir tane ekler[`Person`](../person/) koleksiyona. |
| [Clear](../../aspose.words.bibliography/personcollection/clear/)() | Koleksiyondaki tüm öğeleri kaldırır. |
| [Contains](../../aspose.words.bibliography/personcollection/contains/)(*[Person](../person/)*) | Koleksiyonun belirli bir kişiyi içerip içermediğini belirler. |
| [Remove](../../aspose.words.bibliography/personcollection/remove/)(*[Person](../person/)*) | Kişiyi koleksiyondan kaldırır. |
| [RemoveAt](../../aspose.words.bibliography/personcollection/removeat/)(*int*) | Belirtilen dizindeki kişiyi kaldırır. |
