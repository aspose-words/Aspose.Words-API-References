...
description: PersonCollection'da indekse göre belirli bir kişiye erişin veya onu değiştirin. Verimli kodlama için bu temel özellik ile veri yönetimini basitleştirin!
type: docs
weight: 30
url: /tr/net/aspose.words.bibliography/personcollection/item/
---
## PersonCollection indexer

Belirtilen dizindeki bir kişiyi alır veya ayarlar.
