...
description: PageInfo mülk. Belgede belirtildiği gibi bu sayfa için kağıt tepsisini bölmesi alır. Değer uygulamaya yazıcıya özeldir.
type: docs
weight: 40
...
Belgede belirtildiği gibi bu sayfa için kağıt tepsisini (bölmesi) alır. Değer uygulamaya (yazıcıya) özeldir.
