...
description: NodeRendererBase mülk. Şeklin opak sınırlarını nokta olarak alır.
type: docs
weight: 20
...
Şeklin opak sınırlarını nokta olarak alır.
...
Bu özellik, şeklin opak (yani şeklin saydam kısımları yoksayılır) sınırlayıcı kutusunu döndürür. Sınırlar, şekil döndürmeyi hesaba katar.
