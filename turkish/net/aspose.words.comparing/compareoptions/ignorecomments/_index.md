...
description: CompareOptions IgnoreComments özelliğinin, daha net sonuçlar için yorum farklılıklarını hariç tutarak karşılaştırmanızı nasıl geliştirdiğini keşfedin.
type: docs
weight: 60
...
Yorumlardaki farklılıkların karşılaştırılıp karşılaştırılmayacağını belirtir.
