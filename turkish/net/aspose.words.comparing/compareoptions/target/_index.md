...
description: Etkili belge karşılaştırması için CompareOptions'da Hedef özelliğinin nasıl ayarlanacağını keşfedin. Bugün hassas hedeflemeyle sürecinizi kolaylaştırın!
type: docs
weight: 130
...
Karşılaştırma sırasında hedef olarak hangi belgenin kullanılacağını belirtir.
