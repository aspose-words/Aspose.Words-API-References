...
description: CompareOptions IgnoreTextboxes özelliğinin, daha doğru sonuçlar için metin kutusu farklılıklarını hariç tutarak veri karşılaştırmasını nasıl geliştirdiğini keşfedin.
type: docs
weight: 120
...
Metin kutularında bulunan verilerdeki farklılıkların karşılaştırılıp karşılaştırılmayacağını belirtir.
