...
description: CompareOptions IgnoreCaseChanges özelliğinin, doğru sonuçlar için büyük/küçük harfe duyarlı olmayan analizi etkinleştirerek belge karşılaştırmasını nasıl geliştirdiğini keşfedin.
type: docs
weight: 50
...
True, belge karşılaştırmasının büyük/küçük harfe duyarlı olmadığını gösterir.
