...
description: CompareOptions IgnoreTables özelliğinin, doğru içgörüler için tablo veri karşılaştırmasını kontrol ederek veri analizini nasıl geliştirdiğini keşfedin.
type: docs
weight: 110
...
Tablolarda bulunan verilerdeki farklılıkların karşılaştırılıp karşılaştırılmayacağını belirtir.
