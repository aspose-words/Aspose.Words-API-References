...
description: CompareOptions IgnoreFields özelliğinin, optimize edilmiş sonuçlar için alan farkı karşılaştırmalarını kontrol ederek verimliliği nasıl artırdığını keşfedin.
type: docs
weight: 70
...
Alanlardaki farklılıkların karşılaştırılıp karşılaştırılmayacağını belirtir.
