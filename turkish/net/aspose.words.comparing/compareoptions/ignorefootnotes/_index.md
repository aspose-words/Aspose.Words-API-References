...
description: CompareOptions'daki IgnoreFootnotes özelliğinin, daha net sonuçlar için dipnotları ve son notları hariç tutarak belge karşılaştırmasını nasıl geliştirdiğini keşfedin.
type: docs
weight: 80
...
Dipnotlar ve sonnotlardaki farklılıkların karşılaştırılıp karşılaştırılmayacağını belirtir.
