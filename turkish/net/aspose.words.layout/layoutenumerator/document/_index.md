...
description: Verimli belge numaralandırması için LayoutEnumerator Belge özelliğini keşfedin. Bu güçlü özellik ile iş akışınızı geliştirin!
type: docs
weight: 30
...
Bu örneğin sıraladığı belgeyi alır.
