...
description: LayoutEnumerator MoveNextLogical yönteminin kardeş varlıklar arasında sorunsuz bir şekilde nasıl gezindiğini ve sayfalar arasında paragraf satırlarının düzgün yinelemesini nasıl sağladığını keşfedin.
type: docs
weight: 130
...
Mantıksal bir sırayla bir sonraki kardeş varlığa gider. Sayfalar arasında bölünmüş bir paragrafın satırlarını yinelerken bu yöntem başka bir sayfada bulunsa bile bir sonraki satıra gider.
