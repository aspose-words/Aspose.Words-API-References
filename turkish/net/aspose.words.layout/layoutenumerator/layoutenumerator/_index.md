...
description: LayoutEnumerator oluşturucusunu keşfedin, uygulamalarınızda etkili düzen yönetimi için bu sınıfın yeni örneklerini kolayca oluşturun.
type: docs
weight: 10
...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| document | Document | Sayfa düzeni modeli numaralandırılacak belge. |

## Notlar

Belgenin sayfa düzeni modeli oluşturulmamışsa, numaratör çağrıları[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) onu inşa etmek için.

Belge güncellendiğinde ve yeni sayfa düzeni modeli oluşturulduğunda, buna erişmek için yeni bir numaratör kullanılması gerekir.
