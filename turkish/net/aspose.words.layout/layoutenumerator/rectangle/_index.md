...
description: LayoutEnumerator mülk. Sayfanın sol üst köşesine göre geçerli varlığın sınırlayıcı dikdörtgenini döndürür nokta olarak.
type: docs
weight: 60
...
Sayfanın sol üst köşesine göre geçerli varlığın sınırlayıcı dikdörtgenini döndürür (nokta olarak).
