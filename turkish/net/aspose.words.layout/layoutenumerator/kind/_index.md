...
description: Mevcut varlık türünü tanımlayan LayoutEnumerator Kind özelliğini keşfedin. Bu temel özellik ile verilerinizde netlik sağlayın.
type: docs
weight: 50
...
Mevcut varlığın türünü alır. Bu boş bir dize olabilir ancak asla`hükümsüz` .
...
Bu, geçerli varlığın daha belirli bir türüdür, örneğin yer imi aralığıSpan and türü BOOKMARKSTART veya BOOKMARKEND türünde olabilir.
