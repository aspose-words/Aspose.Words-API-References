...
| Parametre | Tip | Tanım |
| --- | --- | --- |
| types | LayoutEntityType | Taşınacak ana varlık türü. Birden çok ebeveyn türü belirtmek için bitsel-OR kullanın. |

### Notlar

Bu yöntem, varlığın hücresini, sütununu veya üstbilgi/altbilgi üst öğesini bulmanız gerektiğinde kullanışlıdır.
