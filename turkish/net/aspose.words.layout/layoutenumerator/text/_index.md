...
description: LayoutEnumerator mülk. Geçerli yayılma varlığının metnini alır. Diğer varlık türleri için atar.
type: docs
weight: 70
...
Geçerli yayılma varlığının metnini alır. Diğer varlık türleri için atar.
