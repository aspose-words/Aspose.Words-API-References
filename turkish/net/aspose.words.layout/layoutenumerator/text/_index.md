...
description: Mevcut span varlığının metnini kolayca almak için LayoutEnumerator Text özelliğini keşfedin. Bu güçlü özellik ile veri işlemeyi basitleştirin!
type: docs
weight: 80
url: /tr/net/aspose.words.layout/layoutenumerator/text/
---
## LayoutEnumerator.Text property

Mevcut span varlığının metnini alır. Diğer varlık türleri için atar.
