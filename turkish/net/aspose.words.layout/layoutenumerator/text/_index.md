...
description: LayoutEnumerator Text mülk. Geçerli yayılma varlığının metnini alır. Diğer varlık türleri için fırlatmalar C#'da.
type: docs
weight: 80
...
Geçerli yayılma varlığının metnini alır. Diğer varlık türleri için fırlatmalar.
