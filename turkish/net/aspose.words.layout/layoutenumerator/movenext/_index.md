...
description: Kardeş varlıklarda görsel olarak gezinmek için LayoutEnumerator MoveNext yöntemini keşfedin. Sayfaları geçmeden paragraf satırları arasında verimli bir şekilde yineleyin.
type: docs
weight: 120
...
Görsel sıradaki bir sonraki kardeş varlığa gider. Sayfalar arasında bölünmüş bir paragrafın satırlarını yinelerken bu method bir sonraki sayfaya gitmez, bunun yerine aynı sayfadaki bir sonraki varlığa gider.
