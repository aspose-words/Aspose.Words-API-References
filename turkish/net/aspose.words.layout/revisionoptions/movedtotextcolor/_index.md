...
description: RevisionOptions mülk. İçeriğin taşındığı alanlar için kullanılacak rengi belirlemenizi sağlarMoving . Varsayılan değerByAuthor .
type: docs
weight: 90
...
İçeriğin taşındığı alanlar için kullanılacak rengi belirlemenizi sağlarMoving . Varsayılan değerByAuthor .
