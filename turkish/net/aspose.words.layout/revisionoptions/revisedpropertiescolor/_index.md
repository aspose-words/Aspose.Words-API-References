...
description: İçeriğinizi RevisionOptions' RevisedPropertiesColor ile özelleştirin. Bu kullanıcı dostu özellik ile biçimlendirme değişikliklerini kolayca vurgulayın ve okunabilirliği artırın.
type: docs
weight: 130
...
Biçimlendirme özelliklerinde değişiklik yapıldığında içerik için kullanılacak rengin belirtilmesine olanak tanırFormatChange Varsayılan değerNoHighlight .
