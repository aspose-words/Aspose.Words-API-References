...
description: RevisionOptions mülk. İçeriğin taşındığı alanlar için kullanılacak rengi belirlemeye izin verirMoving . Varsayılan değerByAuthor .
type: docs
weight: 70
...
İçeriğin taşındığı alanlar için kullanılacak rengi belirlemeye izin verirMoving . Varsayılan değerByAuthor .
