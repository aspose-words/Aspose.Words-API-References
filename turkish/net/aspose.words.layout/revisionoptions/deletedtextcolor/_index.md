...
description: Silinen içeriği vurgulamak için RevisionOptions'ınızı DeletedTextColor özelliğiyle özelleştirin. Varsayılan ByAuthor'dır. Belgenizin netliğini artırın!
type: docs
weight: 30
...
Silinen içerik için kullanılacak rengin belirtilmesine olanak tanırDeletion . Varsayılan değerByAuthor .
