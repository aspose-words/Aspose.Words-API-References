...
description: Düzeltme çubuklarının gözden geçirilmiş içerik içeren satırların yakınında oluşturulup oluşturulmayacağını belirlemeye izin verir. Varsayılan değer Truedur.
type: docs
weight: 180
