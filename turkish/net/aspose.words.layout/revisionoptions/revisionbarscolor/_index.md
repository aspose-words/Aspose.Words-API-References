...
description: Gözden geçirilmiş bilgi içeren belge satırlarını tanımlayan kenar çubukları için kullanılacak rengi belirlemeye izin verir. Varsayılan değerRed .
type: docs
weight: 130
