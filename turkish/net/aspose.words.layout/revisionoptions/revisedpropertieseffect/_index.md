...
description: RevisionOptions'daki RevisedPropertiesEffect'in içerik biçimlendirmenizi nasıl geliştirdiğini keşfedin. FormatChange özelliğiyle değişiklikleri kolayca özelleştirin.
type: docs
weight: 140
...
Biçimlendirme özelliklerinde değişiklik olan içerik alanları için efekti belirtmeye olanak tanırFormatChange Varsayılan değerNone
...
| istisna | şart |
| --- | --- |
| ArgumentOutOfRangeException | Hidden izin verilmez. |
