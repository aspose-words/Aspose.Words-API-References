...
description: Belgenizin revizyon çubuklarını RevisionOptions RevisionBarsWidth özelliğiyle yönetin. Net görünürlük ve organizasyon için genişliği kolayca özelleştirin.
type: docs
weight: 170
...
Revizyon çubuklarının ve noktaların genişliğini alır veya ayarlar.
