...
description: LayoutCollector yöntem. Belirtilen düğümün kapsadığı sayfa sayısını alır. 0 düğüm tek bir sayfa içindeyse. Bu aynıGetEndPageIndex GetStartPageIndex .
type: docs
weight: 60
...
Belirtilen düğümün kapsadığı sayfa sayısını alır. 0 düğüm tek bir sayfa içindeyse. Bu aynı[`GetEndPageIndex`](../getendpageindex/) -[`GetStartPageIndex`](../getstartpageindex/) .
