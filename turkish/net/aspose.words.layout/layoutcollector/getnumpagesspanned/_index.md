...
description: LayoutCollector yöntem. Belirtilen düğümün kapsadığı sayfa sayısını alır. Düğüm tek bir sayfadaysa 0. Bu şununla aynıdırGetEndPageIndex GetStartPageIndex .
type: docs
weight: 60
