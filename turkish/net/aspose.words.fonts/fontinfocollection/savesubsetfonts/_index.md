...
description: Belge ile katıştırılmış TrueType yazı tiplerinin bir alt kümesinin kaydedilip kaydedilmeyeceğini belirtir. Bu özellik için varsayılan değer yanlış.
type: docs
weight: 50
