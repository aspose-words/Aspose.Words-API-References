...
description: TableSubstitutionRule'daki GetSubstitutes metodunu keşfedin. Orijinal yazı tipiniz için yedek yazı tipi adlarını kolayca alın, tasarım esnekliğini artırın.
type: docs
weight: 20
...
Alternatif font adlarının listesi.
