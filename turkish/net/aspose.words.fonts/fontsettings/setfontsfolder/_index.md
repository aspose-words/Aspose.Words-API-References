...
description: FontSettings yöntem. Aspose.Wordsün belgeleri oluştururken veya yazı tiplerini gömerken TrueType yazı tiplerini aradığı klasörü ayarlar. SetFontsFolders yalnızca bir yazı tipi dizini ayarlamak için.
type: docs
weight: 80
...
Aspose.Words'ün belgeleri oluştururken veya yazı tiplerini gömerken TrueType yazı tiplerini aradığı klasörü ayarlar. [`SetFontsFolders`](../setfontsfolders/) yalnızca bir yazı tipi dizini ayarlamak için.
