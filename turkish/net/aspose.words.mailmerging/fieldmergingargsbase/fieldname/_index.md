...
description: Sorunsuz entegrasyon için birleştirme alan adını veri kaynağınızdan alan FieldMergingArgsBase'in FieldName özelliğini keşfedin.
type: docs
weight: 40
...
Örneğin belgede "Image:MyFieldName" gibi bir alan adı öneki belirttiyseniz, o zaman`FieldName` önek olmadan alan adını, yani "MyFieldName"i döndürür.
