...
description: FieldMergingArgsBase mülk. Document adres mektup birleştirmenin gerçekleştirildiği nesne.
type: docs
weight: 10
...
`Document` adres mektup birleştirmenin gerçekleştirildiği nesne.
