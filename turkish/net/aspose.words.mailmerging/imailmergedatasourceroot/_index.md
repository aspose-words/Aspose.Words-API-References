...
description: Aspose.Words.MailMerging.IMailMergeDataSourceRoot arayüz. Ana ayrıntı verileriyle özel bir veri kaynağından adres mektup birleştirmeye izin vermek için bu arabirimi uygulayın.
type: docs
weight: 3600
...
Ana ayrıntı verileriyle özel bir veri kaynağından adres mektup birleştirmeye izin vermek için bu arabirimi uygulayın.
...
| İsim | Tanım |
| --- | --- |
| [GetDataSource](../../aspose.words.mailmerging/imailmergedatasourceroot/getdatasource/)(string) | Aspose.Words adres mektup birleştirme motoru, bir üst düzey adres mektup birleştirme bölgesinin başlangıcıyla karşılaştığında bu yöntemi çağırır. |
