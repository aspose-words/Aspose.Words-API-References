...
description: MailMerge mülk. Adres mektup birleştirme işlemi için eşlenmiş veri alanlarını temsil eden bir koleksiyon döndürür.
type: docs
weight: 50
...
Adres mektup birleştirme işlemi için eşlenmiş veri alanlarını temsil eden bir koleksiyon döndürür.
...
Eşlenen veri alanları, veri kaynağınızdaki alan adları ile belgedeki adres mektup birleştirme alanlarının adları arasında otomatik olarak eşlemeye olanak tanır.
