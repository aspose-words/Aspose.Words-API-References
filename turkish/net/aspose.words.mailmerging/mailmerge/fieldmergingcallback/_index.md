...
description: MailMerge mülk. Adresmektup birleştirme sırasında belgede bir adres mektup birleştirme alanıyla karşılaşıldığında oluşur.
type: docs
weight: 30
...
Adres-mektup birleştirme sırasında belgede bir adres mektup birleştirme alanıyla karşılaşıldığında oluşur.
