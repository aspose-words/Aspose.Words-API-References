...
description: ImageFieldMergingArgs mülk. Adres mektup birleştirme motorunun belgeye eklemesi gereken resmi belirtir.
type: docs
weight: 10
...
```csharp
{
    ...
    // Bu durumda alan, veri kaynağının "ImageColumn" adında böyle bir sütuna sahip olmasını bekler.
    ...
    // Kısa adlar kullanarak görüntülere başvuran bir veri kaynağı oluşturun.
...
/// <summary>
/// Görüntü adlarını, bu görüntüleri içeren yerel sistem dosya adlarıyla eşleyen bir sözlük içerir.
