...
description: Bir barındırma uygulamasının belirtilen harici data kaynağındaki ilk veri satırını veri kaynağındaki her sütunun adlarını içeren bir başlık satırı olarak ele alacağını belirtir. Varsayılan değeryanlış .
type: docs
weight: 60
