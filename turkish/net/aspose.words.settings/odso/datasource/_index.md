...
description: Odso mülk. Adres mektup birleştirme gerçekleştirmek için bir belgeye bağlanacak dış veri kaynağının konumunu belirtir. Varsayılan değer boş bir dizedir.
type: docs
weight: 30
...
Adres mektup birleştirme gerçekleştirmek için bir belgeye bağlanacak dış veri kaynağının konumunu belirtir. Varsayılan değer boş bir dizedir.
