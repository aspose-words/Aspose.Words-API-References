...
description: Harici veri kaynakları içindeki sütunları ayırmak için kullanılan sütun sınırlayıcı olarak yorumlanacak karakteri belirtir. Varsayılan değer 0dır yani tanımlanmış sütun sınırlayıcı yoktur.
type: docs
weight: 20
