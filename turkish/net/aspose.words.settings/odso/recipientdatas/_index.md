...
description: Adres mektup birleştirmede tek tek kayıtların dahil edilmesini/hariç tutulmasını belirten bir nesneler koleksiyonunu alır veya ayarlar. Bu nesne hiçbir zaman boş değildir.
type: docs
weight: 70
