...
description: Doğru belge görüntüleme için CompatibilityOptions' UsePrinterMetrics özelliğiyle yazdırmanızı optimize edin. Performansı ve kaliteyi zahmetsizce artırın!
type: docs
weight: 640
...
Belgeleri Görüntülemek İçin Yazıcı Ölçümlerini Kullanın.
...
Yazıcı Ölçütleri kullanılan sürücülere bağlı olarak farklılık gösterebilir. Örneğin, Windows "Microsoft OpenXPS Class Driver 2" ve "Microsoft Print to PDF" biraz farklı ölçütler sağlar. Bu nedenle, bu seçenek etkinleştirilirse son belgenin düzeni değişebilir.
