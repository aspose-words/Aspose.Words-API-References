...
description: CompatibilityOptions TransparentMetafiles özelliğinin meta dosyası görüntülerinin arkasında arka plan karartmasını önleyerek grafiklerinizi nasıl geliştirdiğini keşfedin.
type: docs
weight: 550
...
Meta dosya resimlerinin arkasındaki alanın boşaltılmayacağını belirtir.
