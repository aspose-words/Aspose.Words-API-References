...
description: CompatibilityOptions WPSpaceWidth özelliğinin, WordPerfect 5.x'teki gibi gelişmiş belge biçimlendirmesi için boşluk genişliğini nasıl özelleştirmenize olanak tanıdığını keşfedin.
type: docs
weight: 700
...
WordPerfect 5.x'te yapıldığı gibi bir boşluğun genişliğinin ayarlanıp ayarlanamayacağını belirtir.
