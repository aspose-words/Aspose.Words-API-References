...
description: Kullanıcı arayüzünüzü CompatibilityOptions UICompat97To2003 ayarıyla optimize edin. Sorunsuz Word 97-2003 kullanımı için uyumsuz özellikleri devre dışı bırakın. Performansı bugün artırın!
type: docs
weight: 570
...
Word97-2003 ile uyumlu olmayan kullanıcı arayüzü işlevselliğini devre dışı bırakmak için doğru. Varsayılan değer`YANLIŞ` .
...
Word97-2003 ile uyumlu olmayan kullanıcı arayüzü işlevselliğini devre dışı bırakan Word97-2003 uyumluluk ayarını denetler. `doğru` 'w:uiCompat97To2003' XML öğesi '\word\settings.xml' belge paketi bölümüne yazılır. Varsayılan değer`YANLIŞ` . olarak ayarlandığında`YANLIŞ` , bu öğe yazılmamış. Teknik olarak bu özellik uyumluluk seçeneklerinin bir parçası değil, ancak API kolaylığı için buraya koyduk.
