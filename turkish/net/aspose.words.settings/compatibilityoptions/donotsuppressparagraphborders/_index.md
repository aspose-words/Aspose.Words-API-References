...
description: Belge düzeninizi geliştirmek için çerçevelerin yanındaki paragraf kenarlıklarını etkili bir şekilde yöneterek CompatibilityOptions DoNotSuppressParagraphBorders özelliğini keşfedin.
type: docs
weight: 190
url: /tr/net/aspose.words.settings/compatibilityoptions/donotsuppressparagraphborders/
---
## CompatibilityOptions.DoNotSuppressParagraphBorders property

Çerçevelerin Yanındaki Paragraf Kenarlıklarını Gizlemeyin.
