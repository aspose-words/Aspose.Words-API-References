...
description: Doğu Asya satır sonlarını geliştirmek ve okunabilirliği ve biçimlendirmeyi iyileştirmek için CompatibilityOptions'ın UseWord97LineBreakRules özelliğini kullanarak belgelerinizi optimize edin.
type: docs
weight: 680
...
Word 97 Doğu Asya Satır Sonu'nu taklit edin.
