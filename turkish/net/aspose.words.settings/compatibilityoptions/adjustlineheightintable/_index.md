...
description: Tablolarınızı hassas satır aralığı için AdjustLineHeightInTable özelliğiyle geliştirin. Belge netliğini ve sunumunu zahmetsizce iyileştirin!
type: docs
weight: 10
url: /tr/net/aspose.words.settings/compatibilityoptions/adjustlineheightintable/
---
## CompatibilityOptions.AdjustLineHeightInTable property

Tablo Hücrelerindeki Satırlara Belge Izgara Çizgisi Aralıklarını Ekle.
