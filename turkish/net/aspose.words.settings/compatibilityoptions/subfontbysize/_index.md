...
description: Font değiştirme sırasında boyutu önceliklendirerek en iyi okunabilirliği sağlamak için CompatibilityOptions SubFontBySize özelliğiyle font görünümünüzü geliştirin.
type: docs
weight: 470
url: /tr/net/aspose.words.settings/compatibilityoptions/subfontbysize/
---
## CompatibilityOptions.SubFontBySize property

Yazı Tipi Değişimi Sırasında Yazı Tipi Boyutunun Önceliğini Artır.
