...
description: CompatibilityOptions için AlignTablesRowByRow özelliğini keşfedin. Gelişmiş düzen denetimi ve iyileştirilmiş tasarım esnekliği için tablo satırlarını bağımsız olarak hizalayın.
type: docs
weight: 20
