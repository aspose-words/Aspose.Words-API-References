...
description: CompatibilityOptions ShowBreaksInFrames ile web tasarımınızı geliştirin. Gelişmiş düzen kontrolü için çerçevelerdeki sayfa ve sütun sonlarını kolayca görselleştirin.
type: docs
weight: 430
...
Çerçevelerde Mevcut Sayfa/Sütun Sonlarını Görüntüle.
