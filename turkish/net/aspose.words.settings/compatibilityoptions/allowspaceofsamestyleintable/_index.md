...
description: CompatibilityOptions' AllowSpaceOfSameStyleInTable ile tablo düzenlerini geliştirin. Daha iyi okunabilirlik ve tasarım için geliştirilmiş paragraf aralığının keyfini çıkarın.
type: docs
weight: 30
url: /tr/net/aspose.words.settings/compatibilityoptions/allowspaceofsamestyleintable/
---
## CompatibilityOptions.AllowSpaceOfSameStyleInTable property

Tablolardaki Paragrafların Bağlamsal Aralıklarına İzin Ver.
