...
description: HTML'nizi CompatibilityOptions DoNotUseHTMLParagraphAutoSpacing özelliğiyle optimize edin. Daha temiz bir düzen için sabit paragraf aralığı sağlayın!
type: docs
weight: 210
...
HTML Otomatik Ayarı için Sabit Paragraf Aralığı Kullan.
