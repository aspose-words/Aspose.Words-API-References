...
description: Kusursuz ayna girintileri ve göreceli konumlandırma için CompatibilityOptions özelliğini keşfedin. Tasarım esnekliğinizi ve kullanıcı deneyiminizi bugün geliştirin!
type: docs
weight: 540
...
Ayna girintileri ve bağıl konumlandırma için iç ve dış kısımların değiştirilmesini belirtir.
