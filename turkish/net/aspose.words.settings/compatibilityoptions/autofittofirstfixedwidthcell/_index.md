...
description: AutofitToFirstFixedWidthCell özelliğinin, sütunların en iyi görüntüleme için tercih edilen genişlikleri aşmasına izin vererek tablo düzenlerini nasıl geliştirdiğini keşfedin.
type: docs
weight: 50
url: /tr/net/aspose.words.settings/compatibilityoptions/autofittofirstfixedwidthcell/
---
## CompatibilityOptions.AutofitToFirstFixedWidthCell property

Tablo Sütunlarının Bileşen Hücrelerinin Tercih Edilen Genişliklerini Aşmasına İzin Ver.
...
Bu seçenek MS Word 2013 kullanıcı arayüzünde "Word 2003 tablo otomatik sığdırma kurallarını kullan" olarak adlandırılır. Bu aslında sabit düzen tabloları için ızgaranın nasıl hesaplandığını da etkiler (bazı durumlarda).
