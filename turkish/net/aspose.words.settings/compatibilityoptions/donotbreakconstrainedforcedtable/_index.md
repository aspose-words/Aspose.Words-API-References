...
description: Sorunsuz düzenler için yüzen tablolar etrafındaki tablo satırı sonlarını önlemek amacıyla CompatibilityOptions DoNotBreakConstrainedForcedTable özelliğini keşfedin.
type: docs
weight: 130
...
Yüzen Tabloların Etrafındaki Tablo Satırlarını Bölmeyin.
