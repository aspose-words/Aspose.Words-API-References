...
description: LayoutTableRowsApart özelliğinin, daha iyi tasarım esnekliği için tablo satırlarındaki satır içi nesnelerin bağımsız olarak sarılmasını sağlayarak uyumluluğu nasıl artırdığını keşfedin.
type: docs
weight: 300
