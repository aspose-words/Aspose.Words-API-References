...
description: CompatibilityOptions için SelectFldWithFirstOrLastChar özelliğini keşfedin. Gelişmiş verimlilik için alanları ilk veya son karaktere göre kolayca seçin.
type: docs
weight: 410
...
İlk veya Son Karakter Seçildiğinde Alanı Seç.
