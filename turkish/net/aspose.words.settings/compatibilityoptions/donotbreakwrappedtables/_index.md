...
description: Sorunsuz bir belge düzeni için yüzen tabloların sayfalar arasında dağılmasını önlemek amacıyla CompatibilityOptions DoNotBreakWrappedTables özelliğini keşfedin.
type: docs
weight: 140
...
Yüzen Tabloların Sayfalar Arasında Bölünmesine İzin Vermeyin.
