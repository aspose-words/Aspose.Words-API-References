...
description: Uyumluluk seçeneklerini içerir yani ekranda girilen kullanıcı tercihleri. uyumluluk sekmesi Seçenekler Microsoft Wordde iletişim kutusu.
type: docs
weight: 5490
...
Uyumluluk seçeneklerini içerir (yani, ekranda girilen kullanıcı tercihleri). **uyumluluk** sekmesi **Seçenekler** Microsoft Word'de iletişim kutusu).
