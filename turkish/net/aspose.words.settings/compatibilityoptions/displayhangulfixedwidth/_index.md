...
description: Ekranınızı CompatibilityOptions DisplayHangulFixedWidth özelliğiyle optimize edin. Netlik ve stil için tutarlı, sabit genişlikte Hangul karakterleri sağlayın.
type: docs
weight: 110
...
Hangul Karakterleri için Her Zaman Sabit Genişlik Kullanın.
