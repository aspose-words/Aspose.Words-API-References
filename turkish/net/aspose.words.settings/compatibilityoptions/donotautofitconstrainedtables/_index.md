...
description: CompatibilityOptions DoNotAutofitConstrainedTables özelliğiyle tablolarınızı optimize edin. Sarılmış nesnelerin yanında mükemmel hizalamayı zahmetsizce sağlayın.
type: docs
weight: 120
...
Tabloları Sarılmış Nesnelerin Yanına Sığacak Şekilde Otomatik Olarak Sığdırmayın.
