...
description: ConvMailMergeEsc özelliğinin ters eğik çizgileri çift tırnak işareti olarak ele alarak uyumluluğu nasıl artırdığını ve belge biçimlendirmenizi nasıl kolaylaştırdığını keşfedin.
type: docs
weight: 90
...
Ters eğik çizgi tırnak işaretini iki tırnak işareti olarak kabul et.
