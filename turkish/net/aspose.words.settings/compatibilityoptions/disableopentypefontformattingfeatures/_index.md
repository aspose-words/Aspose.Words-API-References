...
description: Belge tutarlılığını ve performansını iyileştirmek için CompatibilityOptions özelliğiyle OpenType yazı tipi biçimlendirme özelliklerinin nasıl devre dışı bırakılacağını öğrenin.
type: docs
weight: 100
url: /tr/net/aspose.words.settings/compatibilityoptions/disableopentypefontformattingfeatures/
---
## CompatibilityOptions.DisableOpenTypeFontFormattingFeatures property

OpenType yazı tipi biçimlendirme özelliklerini devre dışı bırakmayı belirtir.
