...
description: ForgetLastTabAlignment özelliğinin, sola hizalanmamış metin için son sekme durağı genişliğini yok sayarak paragraf hizalamasını nasıl geliştirdiğini keşfedin.
type: docs
weight: 270
...
Paragrafı Hizalarken Son Sekme Durağının Genişliğini Yoksay, Sola Hizalı Değilse.
