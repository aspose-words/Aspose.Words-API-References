...
description: Karakterleri sıkıştırmadan belge ızgaralarını optimize etmek için CompatibilityOptions DoNotUseEastAsianBreakRules özelliğini keşfedin. Biçimlendirmenizi bugün geliştirin!
type: docs
weight: 200
...
Belge Izgarası Kullanılırken Sıkıştırılabilir Karakterleri Sıkıştırmayın.
