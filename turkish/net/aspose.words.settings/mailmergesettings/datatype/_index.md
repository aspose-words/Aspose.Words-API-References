...
description: MailMergeSettings DataType özelliğini keşfedin, posta birleştirme veri kaynağı türünüzü ve erişim yönteminizi tanımlayın. İş akışınızı zahmetsizce optimize edin!
type: docs
weight: 70
...
Posta birleştirme veri kaynağının türünü ve veri erişim yöntemini belirtir. Varsayılan değer:Default .
