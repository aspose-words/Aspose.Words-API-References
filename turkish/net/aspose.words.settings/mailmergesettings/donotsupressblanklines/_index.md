...
description: MailMergeSettings DoNotSupressBlankLines özelliğiyle posta birleştirmenizi optimize edin ve cilalı belgeler için boş satırların etkili bir şekilde işlenmesini sağlayın.
type: docs
weight: 90
...
Posta birleştirme işlemini gerçekleştiren bir uygulamanın, posta birleştirme sonucunda birleştirilen belgelerdeki boş satırları nasıl işleyeceğini belirtir. Varsayılan değer:`YANLIŞ` .
