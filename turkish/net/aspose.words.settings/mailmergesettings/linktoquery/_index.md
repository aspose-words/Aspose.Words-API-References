...
description: MailMergeSettings mülk. Bundan emin değilim. Microsoft Word Otomasyon Referansı bunun sorgunun belgesi Microsoft Wordde her açıldığında yürütüldüğünü belirttiğini belirtir. Ancak OOXML belirtimi bunun sorgunun gerçek sorguyu içeren harici bir sorgu dosyasına referans içerdiğini belirttiğini belirtir. Varsayılan değeryanlış .
type: docs
weight: 110
...
Bundan emin değilim. Microsoft Word Otomasyon Referansı, bunun sorgunun belgesi Microsoft Word'de her açıldığında yürütüldüğünü belirttiğini belirtir. Ancak OOXML belirtimi, bunun, sorgunun gerçek sorguyu içeren harici bir sorgu dosyasına referans içerdiğini belirttiğini belirtir. Varsayılan değer`yanlış` .
