...
description: OdsoFieldMapData mülk. tarafından dizini belirtilen sütun için bir dış veri kaynağı içindeki sütun adını belirtir.Column property. Varsayılan değer boş bir dizedir.
type: docs
weight: 40
...
tarafından dizini belirtilen sütun için bir dış veri kaynağı içindeki sütun adını belirtir.[`Column`](../column/) property. Varsayılan değer boş bir dizedir.
