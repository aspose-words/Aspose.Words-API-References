...
description: tarafından dizini belirtilen sütun için bir dış veri kaynağı içindeki sütun adını belirtir.Columnaspose.words.settings/odsofieldmapdata/column/ property. Varsayılan değer boş bir dizedir.
type: docs
weight: 40
