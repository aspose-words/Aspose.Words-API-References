...
description: Sorunsuz iş akışları için belge işlemeyi ve uyumluluğu geliştirerek MS Word davranışlarını kopyalamak için Aspose.Words.Settings.MsWordVersion enum'unu keşfedin.
type: docs
weight: 6690
...
Aspose.Wods'un MS Word sürümüne özgü uygulama davranışını taklit etmesine izin verir.
