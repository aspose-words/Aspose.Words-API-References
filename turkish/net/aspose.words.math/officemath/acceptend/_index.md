...
description: OfficeMath'in AcceptEnd yöntemini keşfedin; ziyaretçi erişimini sorunsuz bir şekilde yönetin ve ofis matematik deneyiminizi geliştirin. Verimliliği bugün artırın!
type: docs
weight: 70
url: /tr/net/aspose.words.math/officemath/acceptend/
---
## OfficeMath.AcceptEnd method

Ofis matematiğinin sonunu ziyaret eden bir ziyaretçiyi kabul eder.
