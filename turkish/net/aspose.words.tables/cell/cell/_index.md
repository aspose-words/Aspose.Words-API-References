...
description: Cell inşaatçı. Yeni bir örneğini başlatır Hücre sınıf.
type: docs
weight: 10
...
Yeni bir örneğini başlatır **Hücre** sınıf.
...
Ne zaman **Hücre** oluşturulur, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değil ve **Üst Düğüm** boş.

Eklemek **Hücre** belgeye hücrenin eklenmesini istediğiniz satırda InsertAfter veya InsertBefore kullanın.
