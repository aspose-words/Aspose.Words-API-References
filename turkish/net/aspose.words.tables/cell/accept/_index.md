...
description: Cell yöntem. Bir ziyaretçiyi kabul eder.
type: docs
weight: 110
...
DocumentVisitor.VisitCellStart'ı çağırır, ardından bölüm 'nin tüm alt düğümleri için Kabul Et'i çağırır ve sonunda DocumentVisitor.VisitCellEnd'i çağırır.
