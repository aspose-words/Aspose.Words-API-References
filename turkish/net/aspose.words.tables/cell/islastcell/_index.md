...
description: Cell IsLastCell mülk. Bu bir satırın içindeki son hücreyse doğrudur aksi halde yanlış C#'da.
type: docs
weight: 50
...
Bu, bir satırın içindeki son hücreyse doğrudur; aksi halde yanlış.
