...
description: Cell IsLastCell özelliğini keşfedin. Bir hücrenin satırdaki son hücre olup olmadığını kolayca belirleyerek veri yönetiminizi ve optimizasyon stratejilerinizi geliştirin.
type: docs
weight: 50
url: /tr/net/aspose.words.tables/cell/islastcell/
---
## Cell.IsLastCell property

Bu, satırın içindeki son hücreyse Doğru; aksi takdirde Yanlış.
