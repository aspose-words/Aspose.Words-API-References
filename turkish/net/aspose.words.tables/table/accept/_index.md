...
description: Table yöntem. Bir ziyaretçiyi kabul eder.
type: docs
weight: 350
...
DocumentVisitor.VisitTableStart'ı çağırır, ardından bölüm 'nin tüm alt düğümleri için Kabul Et'i çağırır ve sonunda DocumentVisitor.VisitTableEnd'i çağırır.
