...
description: Ziyaretçileri masanın başında sorunsuz bir şekilde karşılamak, kullanıcı deneyimini ve etkileşimini geliştirmek için Table AcceptStart yöntemini keşfedin.
type: docs
weight: 370
url: /tr/net/aspose.words.tables/table/acceptstart/
---
## Table.AcceptStart method

Tablonun başlangıcını ziyaret eden bir ziyaretçiyi kabul eder.
