...
description: CellCollection Item özelliğiyle belirli Hücrelere zahmetsizce erişin. Kolaylaştırılmış veri yönetimi ve gelişmiş performans için herhangi bir Hücreyi dizine göre alın.
type: docs
weight: 10
...
Birini alır[`Cell`](../../cell/) verilen indekste.
