...
description: Row yöntem. Bir ziyaretçiyi kabul eder.
type: docs
weight: 100
...
DocumentVisitor.VisitRowStart'ı çağırır, ardından bölüm 'nin tüm alt düğümleri için Kabul Et'i çağırır ve sonunda DocumentVisitor.VisitRowEnd'i çağırır.
