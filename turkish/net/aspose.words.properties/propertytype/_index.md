...
description: Gelişmiş belge yönetimi ve özelleştirmesi için belge özelliği veri türlerini kolayca tanımlamak üzere Aspose.Words.PropertyType enum'unu keşfedin.
type: docs
weight: 5230
...
| Double | `2` | Özellik bir yüzen sayıdır. |
| Number | `3` | Özellik bir tam sayıdır. |
| String | `4` | Özellik bir dize değeridir. |
| StringArray | `5` | Özellik, dizelerden oluşan bir dizidir. |
| ObjectArray | `6` | Özellik, nesnelerden oluşan bir dizidir. |
| ByteArray | `7` | Özellik bir bayt dizisidir. |
| Other | `8` | Özellik başka bir türdür. |
