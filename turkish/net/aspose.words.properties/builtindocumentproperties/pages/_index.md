...
description: Belgenizin sayfa sayısının doğru bir tahminini sunarak verimli yönetim ve organizasyon sağlayan BuiltInDocumentProperties Pages özelliğini keşfedin.
type: docs
weight: 230
...
Aspose.Words, çağırdığınızda bu özelliği günceller[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/).
