...
description: BuiltInDocumentProperties mülk. Belge şablonunun bilgi adını alır veya ayarlar.
type: docs
weight: 270
...
Microsoft Word'de bu özellik yalnızca bilgi amaçlıdır ve genellikle yolu olmayan şablonun yalnızca dosya adını içerir.

Boş dize, belgenin Normal şablona eklendiği anlamına gelir.

Ekli şablonun gerçek adını almak veya ayarlamak için the öğesini kullanın.[`AttachedTemplate`](../../../aspose.words/document/attachedtemplate/) Emlak.
