...
description: BuiltInDocumentProperties mülk. Belgedeki boşluklar dahil karakter sayısının bir tahminini temsil eder.
type: docs
weight: 50
...
Belgedeki (boşluklar dahil) karakter sayısının bir tahminini temsil eder.
