...
description: Belgeleriniz için doğru kelime sayısı tahmini sunan BuiltInDocumentProperties Words özelliğini keşfedin ve düzenleme verimliliğini artırın.
type: docs
weight: 360
...
Belgedeki kelime sayısının bir tahminini temsil eder.
