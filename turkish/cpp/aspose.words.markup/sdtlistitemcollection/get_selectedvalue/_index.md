---
title: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue yöntemi"
linktitle: "get_SelectedValue"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue yöntemi. Bu listedeki şu anda seçili değeri belirtir. Null değere izin verilir, bu da bu liste öğesi koleksiyonunda şu anda seçili bir giriş olmadığını gösterir C++'ta."
type: docs
weight: 9000
url: /tr/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


Bu listede şu anda seçili değeri belirtir. Boş değer izin verilir, bu da şu anda seçili bir girişin bu liste öğesi koleksiyonuyla ilişkili olmadığı anlamına gelir.
