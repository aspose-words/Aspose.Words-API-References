---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id metodu"
linktitle: "get_Id"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id metodu. Bu StructuredDocumentTagRange düğümü için benzersiz, yalnızca okunabilir, kalıcı sayısal Id belirtir. İlgili StructuredDocumentTagRangeStart düğümünün aynı Id'si C++'ta bulunur."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.markup/structureddocumenttagrangeend/get_id/
---
## StructuredDocumentTagRangeEnd::get_Id method


**StructuredDocumentTagRange** düğümü için benzersiz, yalnızca okunabilir, kalıcı sayısal Id belirtir. İlgili [StructuredDocumentTagRangeStart](../../structureddocumenttagrangestart/) düğümünün aynı [Id](../../structureddocumenttagrangestart/get_id/) değeri vardır.
