...
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText method. Bu SDT'nin içeriğinin yer tutucu metin içerip içermediğini (SDT içindeki normal metin içeriğine kıyasla) belirtir. true olarak ayarlanırsa, bu durum belge C++'da açıldığında (yer tutucu metin gösterilerek) yeniden etkinleştirilir."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.markup/istructureddocumenttag/get_isshowingplaceholdertext/
---
## IStructuredDocumentTag::get_IsShowingPlaceholderText method


Bu **SDT** içeriğinin yer tutucu metin içerdiği (SDT içindeki normal metin içeriğine karşı) yorumlanıp yorumlanmayacağını belirtir. true olarak ayarlanırsa, bu durum belge açıldığında (yer tutucu metni göstererek) yeniden etkinleştirilir.
