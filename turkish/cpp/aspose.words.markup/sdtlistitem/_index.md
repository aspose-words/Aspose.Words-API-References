...
description: "Aspose::Words::Markup::SdtListItem class. Bu öğe, bir üst ComboBox veya DropDownList yapılandırılmış belge etiketinde tek bir liste öğesini belirtir. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.markup/sdtlistitem/
---
## SdtListItem class


Bu öğe, bir üst [ComboBox](../sdttype/) veya [DropDownList](../sdttype/) yapılandırılmış belge etiketinde tek bir liste öğesini belirtir. Daha fazla bilgi için [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/) belge makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_DisplayText](./get_displaytext/)() const | Bu liste öğesi için [Value](./get_value/) öznitelik içeriği yerine çalıştırma içeriğinde görüntülenecek metni alır. |
| [get_Value](./get_value/)() const | Bu liste öğesinin değerini alır. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [SdtListItem](./sdtlistitem/)(const System::String\&, const System::String\&) | Bu sınıfın yeni bir örneğini başlatır. |
| [SdtListItem](./sdtlistitem/)(const System::String\&) | Bu sınıfın yeni bir örneğini başlatır. |
| static [Type](./type/)() |  |
