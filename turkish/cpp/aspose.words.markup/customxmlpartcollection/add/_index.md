---
title: "Aspose::Words::Markup::CustomXmlPartCollection::Add metodu"
linktitle: "Add"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::CustomXmlPartCollection::Add metodu. C++'ta koleksiyona bir öğe ekler."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| --- | --- | --- |
| parça | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Eklenecek özel XML parçası. |
...
Belirtilen XML ile yeni bir XML bölümü oluşturur ve koleksiyona ekler.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| id | const System::String\& | Yeni bir özel XML parçasının tanımlayıcısı. |
| xml | const System::String\& | Parçanın XML verisi. |

### ReturnValue

Oluşturulan özel XML parçası.
