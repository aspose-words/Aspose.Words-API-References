---
title: "Aspose::Words::Markup::CustomXmlPartCollection::GetById yöntemi"
linktitle: "GetById"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::CustomXmlPartCollection::GetById yöntemi. C++'ta kimliğiyle bir özel XML bölümünü bulur ve döndürür."
type: docs
weight: 11000
url: /tr/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
## CustomXmlPartCollection::GetById method


Bir tanımlayıcı ile özel bir XML bölümünü bulur ve döndürür.
...
| --- | --- | --- |
| id | const System::String\& | Özel XML bölümünü tanımlayan büyük/küçük harfe duyarlı dize. |

### ReturnValue

Belirtilen kimliğe sahip bir özel XML bölümü bulunamazsa **null** döndürür.
