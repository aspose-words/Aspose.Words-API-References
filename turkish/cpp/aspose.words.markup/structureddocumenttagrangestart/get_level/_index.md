---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Level yöntemi"
linktitle: "get_Level"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_Level yöntemi. Bu yapılandırılmış belge etiketi aralığının başlangıcının belge ağacında hangi seviyede oluştuğunu C++'de alır."
type: docs
weight: 10000
url: /tr/cpp/aspose.words.markup/structureddocumenttagrangestart/get_level/
---
## StructuredDocumentTagRangeStart::get_Level method


Bu yapılandırılmış belge etiketi aralığı başlangıcının belge ağacında oluştuğu seviyeyi alır.
