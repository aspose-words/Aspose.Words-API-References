---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd metodu"
linktitle: "get_RangeEnd"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd metodu. Aralığın sonunu belirtir eğer StructuredDocumentTag bir aralıklı yapılandırılmış belge etiketi ise. Aksi takdirde C++'ta null döndürür."
type: docs
weight: 16000
url: /tr/cpp/aspose.words.markup/structureddocumenttagrangestart/get_rangeend/
---
## StructuredDocumentTagRangeStart::get_RangeEnd method


Aralığın sonunu belirtir eğer [StructuredDocumentTag](../../structureddocumenttag/) bir aralıklı yapılandırılmış belge etiketi ise. Aksi takdirde **null** döndürür.
