---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat metodu"
linktitle: "get_DateStorageFormat"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat metodu. SDT bir XML düğümüne bağlandığında tarih SDT'si için tarihin saklandığı biçimi alır/ayarlar. Varsayılan değer C++'ta DateTime'dır."
type: docs
weight: 14000
url: /tr/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


**SDT** bir XML düğümüne bağlandığında tarih SDT'si için tarihin saklandığı biçimi alır/ayarlar. Varsayılan değer [DateTime](../../sdtdatestorageformat/)
