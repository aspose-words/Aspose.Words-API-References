---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder metodu"
linktitle: "get_Placeholder"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder metodu. C++ içinde bu SDT çalıştırma içeriği boş olduğunda, ilgili eşlenmiş XML öğesi XmlMapping öğesi aracılığıyla belirtilen şekilde boş olduğunda veya IsShowingPlaceholderText öğesi true olduğunda görüntülenmesi gereken yer tutucu metni içeren BuildingBlock'ı alır."
type: docs
weight: 26000
url: /tr/cpp/aspose.words.markup/structureddocumenttag/get_placeholder/
---
## StructuredDocumentTag::get_Placeholder method


Bu SDT çalıştırma içeriği boş olduğunda, ilgili eşlenmiş XML öğesi [XmlMapping](../get_xmlmapping/) öğesi aracılığıyla belirtilen şekilde boş olduğunda veya [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) öğesi **true** olduğunda görüntülenmesi gereken yer tutucu metni içeren [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) öğesini alır.
