---
title: "Aspose::Words::Markup::XmlMapping::SetMapping metodu"
linktitle: "SetMapping"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Markup::XmlMapping::SetMapping metodu. C++'ta üst yapı belge etiketi ile özel bir XML veri bölümünün bir XML düğümü arasında bir eşleme ayarlar."
type: docs
weight: 10000
url: /tr/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


Üst yapılandırılmış belge etiketi ile bir özel XML veri bölümünün XML düğümü arasında bir eşleme ayarlar.
...
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | Eşlenecek bir özel XML veri bölümü. |
| xPath | const System::String\& | XML düğümünü bulmak için bir XPath ifadesi. |
| prefixMapping | const System::String\& | XPath'i değerlendirmek için XML ad alanı önek eşlemeleri. |

### ReturnValue

Üst yapı belge etiketinin XML düğümüne başarıyla eşlenip eşlenmediğini gösteren bir işaret.
