...
description: "Aspose::Words::Drawing::Charts::AxisBuiltInUnit enum. Bir eksenin C++'de görüntü birimlerini belirtir."
type: docs
weight: 20000
url: /tr/cpp/aspose.words.drawing.charts/axisbuiltinunit/
---
...
| Özel | 1 | Grafikteki değerlerin kullanıcı tanımlı bir bölenle bölüneceğini belirtir. Bu değer, MS Office 2016'nın yeni grafik türleri tarafından desteklenmez. |
| Milyarlar | 2 | Grafikteki değerlerin 1.000.000.000 ile bölüneceğini belirtir. |
| HundredMillions | 3 | Grafikteki değerlerin 100.000.000 ile bölüneceğini belirtir. |
| Hundreds | 4 | Grafikteki değerlerin 100 ile bölüneceğini belirtir. |
| HundredThousands | 5 | Grafikteki değerlerin 100.000 ile bölüneceğini belirtir. |
| Millions | 6 | Grafikteki değerlerin 1.000.000 ile bölüneceğini belirtir. |
| TenMillions | 7 | Grafikteki değerlerin 10.000.000 ile bölüneceğini belirtir. |
| TenThousands | 8 | Grafikteki değerlerin 10.000 ile bölüneceğini belirtir. |
| Thousands | 9 | Grafikteki değerlerin 1.000 ile bölüneceğini belirtir. |
| Trillions | 10 | Grafikteki değerlerin 1.000.000.000.000 ile bölüneceğini belirtir. |
| Percentage | 11 | Grafikteki değerlerin 0,01 ile bölüneceğini belirtir. Bu değer yalnızca MS Office 2016'nın yeni grafik türleri tarafından desteklenir. |
