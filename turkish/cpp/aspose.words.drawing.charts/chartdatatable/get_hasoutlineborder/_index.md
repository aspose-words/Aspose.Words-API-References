---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder metodu"
linktitle: "get_HasOutlineBorder"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder metodu. Seri ve kategori adlarının etrafındaki bir kenarlık olan dış hat kenarlığının görüntülenip görüntülenmeyeceğini belirten bir bayrağı alır veya ayarlar. Varsayılan değer C++'da true'dur."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.drawing.charts/chartdatatable/get_hasoutlineborder/
---
## ChartDataTable::get_HasOutlineBorder method


Seri ve kategori adlarının etrafındaki bir dış kenarın, yani bir taslak kenarın gösterilip gösterilmeyeceğini belirten bir bayrağı alır veya ayarlar. Varsayılan değer **true**'dır.
