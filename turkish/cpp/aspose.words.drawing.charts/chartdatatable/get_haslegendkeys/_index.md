---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys metodu"
linktitle: "get_HasLegendKeys"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys metodu. Veri tablosunda lejand anahtarlarının gösterilip gösterilmediğini belirten bir bayrağı alır veya ayarlar. Varsayılan değer C++'da true'dur."
type: docs
weight: 5000
url: /tr/cpp/aspose.words.drawing.charts/chartdatatable/get_haslegendkeys/
---
## ChartDataTable::get_HasLegendKeys method


Veri tablosunda efsane anahtarlarının gösterilip gösterilmeyeceğini belirten bir bayrağı alır veya ayarlar. Varsayılan değer **true**'dır.
