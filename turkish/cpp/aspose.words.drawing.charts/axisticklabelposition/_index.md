...
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition enum. C++'da işaret etiketi konumları için olası pozisyonları belirtir."
type: docs
weight: 24000
url: /tr/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
## AxisTickLabelPosition enum


İşaret etiketi konumları için olası yerleri belirtir.
...
| NextToAxis | 2 | Eksen etiketlerinin eksenin yanına yerleştirileceğini belirtir. |
| None | 3 | Eksen etiketlerinin çizilmediğini belirtir. |
| Default | n/a | İşaret etiketi konumunun varsayılan değerini belirtir. |
