...
description: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode enum. Veri etiketinin konumunu belirten değerlerin – Left ve Top özelliklerinin – C++'ta nasıl yorumlandığını belirtir."
type: docs
weight: 27167
url: /tr/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


Veri etiketinin konumunu belirten değerlerin - [Left](../chartdatalabel/get_left/) ve [Top](../chartdatalabel/get_top/) özelliklerinin - nasıl yorumlandığını belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Offset | 0 | Bir veri etiketinin konumu, [Position](../chartdatalabel/get_position/) özelliğiyle tanımlanan konumdan bir offset ile belirtilir. |
| Mutlak | 1 | Bir veri etiketinin konumu, grafiğin sol üst köşesinden başlayarak mutlak koordinatlar kullanılarak belirtilir. |
