...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. C++'de işaret çubuğu konumlarının olası değerlerini belirtir."
type: docs
weight: 25000
url: /tr/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum


İşaret işaretleri için olası konumları belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Çapraz | 0 | İşaret çubuğunun ekseni kesmesini belirtir. |
| İçinde | 1 | İşaretçilerin grafik alanının içinde olacağını belirtir. |
| Dış | 2 | İşaretçilerin grafik alanının dışında olacağını belirtir. |
| None | 3 | İşaretçilerin olmayacağını belirtir. |
