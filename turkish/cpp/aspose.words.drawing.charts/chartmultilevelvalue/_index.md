...
description: "Aspose::Words::Drawing::Charts::ChartMultilevelValue class. C++'da çok seviyeli veri gösteren grafikler için bir değeri temsil eder."
type: docs
weight: 14500
url: /tr/cpp/aspose.words.drawing.charts/chartmultilevelvalue/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [ChartMultilevelValue](./chartmultilevelvalue/)(const System::String\&, const System::String\&, const System::String\&) | Bu sınıfın üç seviyeli bir değeri temsil eden yeni bir örneğini başlatır. |
| [ChartMultilevelValue](./chartmultilevelvalue/)(const System::String\&, const System::String\&) | Bu sınıfın iki seviyeli bir değeri temsil eden yeni bir örneğini başlatır. |
| [ChartMultilevelValue](./chartmultilevelvalue/)(const System::String\&) | Bu sınıfın tek seviyeli bir değeri temsil eden yeni bir örneğini başlatır. |
| [Equals](./equals/)(System::SharedPtr\<System::Object\>) override | Belirtilen nesnenin mevcut çok seviyeli veri nesnesine eşit olup olmadığını gösteren bir bayrağı alır. |
| [get_Level1](./get_level1/)() const | Bu değerin referans verdiği grafiğin üst seviyesinin adını alır. |
| [get_Level2](./get_level2/)() const | Bu değerin referans verdiği grafiğin ara seviyesinin adını alır. |
| [get_Level3](./get_level3/)() const | Bu değerin referans verdiği grafiğin alt seviyesinin adını alır. |
| [GetHashCode](./gethashcode/)() const override | Mevcut çok seviyeli veri nesnesi için bir karma kodu alır. |
