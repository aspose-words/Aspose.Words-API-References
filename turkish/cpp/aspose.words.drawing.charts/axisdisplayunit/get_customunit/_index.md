---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metodu"
linktitle: "get_CustomUnit"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit metodu. C++'da değer eksenindeki görüntü birimlerini ölçeklemek için kullanıcı tanımlı bir bölücü alır veya ayarlar."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


Değer eksenindeki görüntü birimlerini ölçeklendirmek için kullanıcı tanımlı bir bölen alır veya ayarlar.
...
Bu özelliği ayarlamak, [Unit](../get_unit/) özelliğini [Custom](../../axisbuiltinunit/) olarak ayarlar.
