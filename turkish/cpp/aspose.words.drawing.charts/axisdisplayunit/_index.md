...
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit sınıfı. Değer ekseni için görüntü birimlerinin ölçeklendirme seçeneklerine erişim sağlar. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


Değer ekseni için gösterim birimlerinin ölçeklendirme seçeneklerine erişim sağlar. Daha fazla bilgi edinmek için [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/) dokümantasyon makalesini ziyaret edin.
...
| [get_CustomUnit](./get_customunit/)() const | Değer eksenindeki görüntü birimlerini ölçeklendirmek için kullanıcı tanımlı bir bölen alır veya ayarlar. |
| [get_Document](./get_document/)() | Üst grafiği içeren belgeyi döndürür. |
| [get_Unit](./get_unit/)() const | Görüntü birimlerinin ölçekleme değerini önceden tanımlı değerlerden biri olarak alır veya ayarlar. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/) için ayarlayıcı. |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/) için ayarlayıcı. |
| static [Type](./type/)() |  |
