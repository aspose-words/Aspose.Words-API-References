...
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Top method. TopMode özelliğinin değerine bağlı olarak, veri etiketinin grafiğin üst kenarından veya Position özelliğiyle belirtilen konumdan puan cinsinden uzaklığını alır veya ayarlar C++'ta."
type: docs
weight: 16334
url: /tr/cpp/aspose.words.drawing.charts/chartdatalabel/get_top/
---
## ChartDataLabel::get_Top method


Veri etiketinin, grafiğin üst kenarından veya [Position](../get_position/) özelliğiyle belirtilen konumdan, [TopMode](../get_topmode/) özelliğinin değerine bağlı olarak, puan cinsinden uzaklığını alır veya ayarlar.
