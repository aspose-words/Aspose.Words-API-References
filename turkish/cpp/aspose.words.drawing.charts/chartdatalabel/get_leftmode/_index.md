---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metodu"
linktitle: "get_LeftMode"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_LeftMode metodu. Left özelliğinin değerinin yorumlama modunu alır veya ayarlar: veri etiketinin konumunu grafiğin sol kenarından mı yoksa Position özelliğiyle belirtilen konumdan mı ayarladığını belirler (C++'da)."
type: docs
weight: 6667
url: /tr/cpp/aspose.words.drawing.charts/chartdatalabel/get_leftmode/
---
## ChartDataLabel::get_LeftMode method


[Left](../get_left/) özelliğinin değerinin yorumlama modunu alır veya ayarlar: veri etiketinin konumunu grafiğin sol kenarından mı yoksa [Position](../get_position/) özelliğiyle belirtilen konumdan mı ayarlar.
