---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left metodu"
linktitle: "get_Left"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left metodu. C++'da LeftMode özelliğinin değerine bağlı olarak, veri etiketinin grafiğin sol kenarından veya Position özelliğiyle belirtilen konumdan nokta cinsinden uzaklığını alır veya ayarlar."
type: docs
weight: 6334
url: /tr/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


Veri etiketinin grafiğin sol kenarından veya [Position](../get_position/) özelliğiyle belirtilen konumdan nokta cinsinden uzaklığını alır veya ayarlar, [LeftMode](../get_leftmode/) özelliğinin değerine bağlı olarak.
