---
title: "Aspose::Words::Tables::RowCollection sınıfı"
linktitle: "RowCollection"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Tables::RowCollection sınıfı. Row düğümlerinin bir koleksiyonuna tipli erişim sağlar. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.tables/rowcollection/
---
## RowCollection class


[Row](../row/) düğümlerinin bir koleksiyonuna tipli erişim sağlar. Daha fazla bilgi için [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/) belge makalesini ziyaret edin.
...
| [idx_get](./idx_get/)(int32_t) | Verilen indeksteki bir [Row](../row/) alır. |
...
| [ToArray](./toarray/)() | Koleksiyondaki tüm satırları yeni bir satır dizisine kopyalar. |
| static [Type](./type/)() |  |
