---
title: "Aspose::Words::Comparing::CompareOptions::get_CompareMoves yöntemi"
linktitle: "get_CompareMoves"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Comparing::CompareOptions::get_CompareMoves yöntemi. C++'ta iki belge arasındaki farkları karşılaştırıp karşılaştırmayacağını belirtir."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.comparing/compareoptions/get_comparemoves/
---
## CompareOptions::get_CompareMoves method


İki belge arasındaki farkların karşılaştırılıp karşılaştırılmayacağını belirtir.
