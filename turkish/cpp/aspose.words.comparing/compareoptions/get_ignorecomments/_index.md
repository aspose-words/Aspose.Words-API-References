---
title: "Aspose::Words::Comparing::CompareOptions::get_IgnoreComments yöntemi"
linktitle: "get_IgnoreComments"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Comparing::CompareOptions::get_IgnoreComments yöntemi. C++'ta yorumlardaki farkları karşılaştırıp karşılaştırmayacağını belirtir."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.comparing/compareoptions/get_ignorecomments/
---
## CompareOptions::get_IgnoreComments method


Yorumlardaki farkların karşılaştırılıp karşılaştırılmayacağını belirtir.
