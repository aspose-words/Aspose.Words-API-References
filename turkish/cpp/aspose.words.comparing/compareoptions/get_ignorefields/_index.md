---
title: "Aspose::Words::Comparing::CompareOptions::get_IgnoreFields metodu"
linktitle: "get_IgnoreFields"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Comparing::CompareOptions::get_IgnoreFields metodu. C++'ta alanlardaki farkların karşılaştırılıp karşılaştırılmayacağını belirtir."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.comparing/compareoptions/get_ignorefields/
---
## CompareOptions::get_IgnoreFields method


Alanlardaki farkların karşılaştırılıp karşılaştırılmayacağını belirtir.
