---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth yöntemi"
linktitle: "get_ColorDepth"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth yöntemi. Dijital imza için renk derinliğini alır veya ayarlar. Varsayılan değer C++'da 32'dir."
type: docs
weight: 2667
url: /tr/cpp/aspose.words.digitalsignatures/signoptions/get_colordepth/
---
## SignOptions::get_ColorDepth method


Dijital imza için renk derinliğini alır veya ayarlar. Varsayılan değer 32.

```cpp
int32_t Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth() const
```
