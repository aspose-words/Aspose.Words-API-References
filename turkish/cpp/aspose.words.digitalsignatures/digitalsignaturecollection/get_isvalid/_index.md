---
title: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid yöntemi"
linktitle: "get_IsValid"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid yöntemi. Bu koleksiyondaki tüm dijital imzalar geçerli ve belge değiştirilmemişse true döndürür. Ayrıca hiçbir dijital imza yoksa da true döndürür. En az bir dijital imza geçersizse false döndürür C++'ta."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/get_isvalid/
---
## DigitalSignatureCollection::get_IsValid method


Bu koleksiyondaki tüm dijital imzalar geçerli ve belge değiştirilmemişse **true** döndürür. Ayrıca dijital imza yoksa **true** döndürür. En az bir dijital imza geçersizse **false** döndürür.
