...
description: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection class. Bir belgeye eklenmiş dijital imzaların yalnızca okunabilir bir koleksiyonunu sağlar. Daha fazla bilgi için C++'deki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/
---
## DigitalSignatureCollection class


Bir belgeye eklenmiş dijital imzaların yalnızca okunabilir bir koleksiyonunu sağlar. Daha fazla bilgi için, [Work with Digital Signatures](https://docs.aspose.com/words/cpp/working-with-digital-signatures/) dokümantasyon makalesini ziyaret edin.
...
| [get_IsValid](./get_isvalid/)() | Bu koleksiyondaki tüm dijital imzalar geçerli ve belge değiştirilmemişse **true** döndürür. Ayrıca dijital imza yoksa **true** döndürür. En az bir dijital imza geçersizse **false** döndürür. |
...
| [idx_get](./idx_get/)(int32_t) | Belirtilen indeksteki belge imzasını alır. |
