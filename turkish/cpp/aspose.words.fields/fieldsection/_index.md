...
description: "Aspose::Words::Fields::FieldSection sınıfı. SECTION alanını uygular. Daha fazla bilgi için C++'ta belgeler makalesini ziyaret edin."
type: docs
weight: 88000
url: /tr/cpp/aspose.words.fields/fieldsection/
---
## FieldSection class


SECTION alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
