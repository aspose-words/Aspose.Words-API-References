---
title: "Aspose::Words::Fields::FieldTA sınıfı"
linktitle: "FieldTA"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldTA sınıfı. TA alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 99000
url: /tr/cpp/aspose.words.fields/fieldta/
---
## FieldTA class


TA alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_EntryCategory](./get_entrycategory/)() | Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini alır. |
...
| [get_IsBold](./get_isbold/)() | Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını alır. |
...
| [get_IsItalic](./get_isitalic/)() | Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır. |
...
| [get_LongCitation](./get_longcitation/)() | Giriş için uzun atıfı alır. |
| [get_PageRangeBookmarkName](./get_pagerangebookmarkname/)() | Girişin sayfa numarası olarak eklenen sayfa aralığını işaretleyen yer iminin adını alır. |
...
| [get_ShortCitation](./get_shortcitation/)() | Giriş için kısa atıfı alır. |
...
| [set_EntryCategory](./set_entrycategory/)(const System::String\&) | Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini ayarlar. |
| [set_IsBold](./set_isbold/)(bool) | Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını ayarlar. |
| [set_IsDirty](../field/set_isdirty/)(bool) | [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) için ayarlayıcı. |
| [set_IsItalic](./set_isitalic/)(bool) | Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını ayarlar. |
...
| [set_LongCitation](./set_longcitation/)(const System::String\&) | Giriş için uzun atıfı ayarlar. |
| [set_PageRangeBookmarkName](./set_pagerangebookmarkname/)(const System::String\&) | Girişin sayfa numarası olarak eklenen sayfa aralığını işaretleyen yer iminin adını ayarlar. |
| [set_Result](../field/set_result/)(const System::String\&) | [Aspose::Words::Fields::Field::get_Result](../field/get_result/) için ayarlayıcı. |
| [set_ShortCitation](./set_shortcitation/)(const System::String\&) | Giriş için kısa atıfı ayarlar. |
| static [Type](./type/)() |  |
