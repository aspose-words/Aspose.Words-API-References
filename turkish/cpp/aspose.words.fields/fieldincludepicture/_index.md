...
description: "Aspose::Words::Fields::FieldIncludePicture sınıfı. INCLUDEPICTURE alanını uygular. Daha fazla bilgi için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 57000
url: /tr/cpp/aspose.words.fields/fieldincludepicture/
---
## FieldIncludePicture class


INCLUDEPICTURE alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_ResizeHorizontally](./get_resizehorizontally/)() | Kaynağın resmini yatay olarak yeniden boyutlandırıp boyutlandırmayacağını alır veya ayarlar. |
| [get_ResizeVertically](./get_resizevertically/)() | Kaynağın resmini dikey olarak yeniden boyutlandırıp boyutlandırmayacağını alır veya ayarlar. |
...
| [get_SourceFullName](./get_sourcefullname/)() override | Resmin konumunu bir IRI kullanarak alır veya ayarlar. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | [Aspose::Words::Fields::FieldIncludePicture::get_GraphicFilter](./get_graphicfilter/) için ayarlayıcı. |
| [set_IsDirty](../field/set_isdirty/)(bool) | [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) için ayarlayıcı. |
| [set_IsLinked](./set_islinked/)(bool) | [Aspose::Words::Fields::FieldIncludePicture::get_IsLinked](./get_islinked/) için ayarlayıcı. |
...
| [set_ResizeHorizontally](./set_resizehorizontally/)(bool) | [Aspose::Words::Fields::FieldIncludePicture::get_ResizeHorizontally](./get_resizehorizontally/) için ayarlayıcı. |
| [set_ResizeVertically](./set_resizevertically/)(bool) | [Aspose::Words::Fields::FieldIncludePicture::get_ResizeVertically](./get_resizevertically/) için ayarlayıcı. |
| [set_Result](../field/set_result/)(const System::String\&) | [Aspose::Words::Fields::Field::get_Result](../field/get_result/) için ayarlayıcı. |
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | [Aspose::Words::Fields::FieldIncludePicture::get_SourceFullName](./get_sourcefullname/) için ayarlayıcı. |
| static [Type](./type/)() |  |
