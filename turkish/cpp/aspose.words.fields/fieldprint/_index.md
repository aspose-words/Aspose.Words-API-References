---
title: "Aspose::Words::Fields::FieldPrint sınıfı"
linktitle: "FieldPrint"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldPrint sınıfı. PRINT alanını uygular. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 80000
url: /tr/cpp/aspose.words.fields/fieldprint/
---
## FieldPrint class


PRINT alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_PostScriptGroup](./get_postscriptgroup/)() | PostScript talimatlarının çalıştığı çizim dikdörtgenini alır veya ayarlar. |
| [get_PrinterInstructions](./get_printerinstructions/)() | Yazıcıya özgü kontrol kodu karakterlerini veya PostScript talimatlarını alır veya ayarlar. |
...
| [set_PostScriptGroup](./set_postscriptgroup/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldPrint::get_PostScriptGroup](./get_postscriptgroup/). |
| [set_PrinterInstructions](./set_printerinstructions/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldPrint::get_PrinterInstructions](./get_printerinstructions/). |
