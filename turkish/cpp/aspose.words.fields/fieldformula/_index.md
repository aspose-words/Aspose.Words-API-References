---
title: "Aspose::Words::Fields::FieldFormula sınıfı"
linktitle: "FieldFormula"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldFormula sınıfı. = (formül) alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 49000
url: /tr/cpp/aspose.words.fields/fieldformula/
---
## FieldFormula class


= (formül) alanını uygular. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
Formül alanını kullanarak bir denklemin sonucunu nasıl görüntüleyeceğinizi gösterir.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();

// Bir alan oluşturucu kullanarak matematiksel bir denklem oluşturun,
// daha sonra belgedeki denklemin sonucunu göstermek için bir formül alanı oluşturun.
