---
title: "Aspose::Words::Fields::FieldFileSize sınıf"
linktitle: "FieldFileSize"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldFileSize sınıf. FILESIZE alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 42000
url: /tr/cpp/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class


FILESIZE alanını uygular. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_IsInKilobytes](./get_isinkilobytes/)() | Dosya boyutunun kilobayt cinsinden gösterilip gösterilmeyeceğini alır veya ayarlar. |
| [get_IsInMegabytes](./get_isinmegabytes/)() | Dosya boyutunun megabayt olarak gösterilip gösterilmeyeceğini alır veya ayarlar. |
...
| [set_IsInKilobytes](./set_isinkilobytes/)(bool) | Ayarlayıcı [Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes](./get_isinkilobytes/). |
| [set_IsInMegabytes](./set_isinmegabytes/)(bool) | Ayarlayıcı [Aspose::Words::Fields::FieldFileSize::get_IsInMegabytes](./get_isinmegabytes/). |
...
Mevcut belgenin dosya boyutunu alır; boyut belirlenemezse 0 döndürür.

Mevcut uygulamada, dosya boyutunu belirlemek için kullanılan dosya adını almak üzere [OriginalFileName](../../aspose.words/document/get_originalfilename/) özelliğini kullanır.
