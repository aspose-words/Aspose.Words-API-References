---
title: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition yöntemi"
linktitle: "get_HorizontalPosition"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition yöntemi. C++'ta alandan sonraki metnin sütun, çerçeve veya metin kutusunun sol kenarından yatay olarak kaydırılması için gereken nokta sayısını alır veya ayarlar."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.fields/fieldadvance/get_horizontalposition/
---
## FieldAdvance::get_HorizontalPosition method


Alanı izleyen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak hareket ettirilmesi gereken puan sayısını alır veya ayarlar.
