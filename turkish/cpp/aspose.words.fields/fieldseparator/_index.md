---
title: "Aspose::Words::Fields::FieldSeparator sınıfı"
linktitle: "FieldSeparator"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldSeparator sınıfı. Alan kodunu alan sonucundan ayıran bir Word alan ayırıcıyı temsil eder. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 90000
url: /tr/cpp/aspose.words.fields/fieldseparator/
---
## FieldSeparator class


Bir Word alan ayıracını temsil eder ve alan kodunu alan sonucundan ayırır. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_NodeType](./get_nodetype/)() const override | Döndürür [FieldSeparator](../../aspose.words/nodetype/). |
