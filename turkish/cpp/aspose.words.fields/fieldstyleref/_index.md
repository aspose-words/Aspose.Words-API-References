---
title: "Aspose::Words::Fields::FieldStyleRef sınıfı"
linktitle: "FieldStyleRef"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldStyleRef sınıfı. STYLEREF alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 96000
url: /tr/cpp/aspose.words.fields/fieldstyleref/
---
## FieldStyleRef class


STYLEREF alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_InsertParagraphNumber](./get_insertparagraphnumber/)() | Referans alınan paragrafın paragraf numarasını belgede göründüğü gibi tam olarak ekleyip eklemeyeceğini alır veya ayarlar. |
| [get_InsertParagraphNumberInFullContext](./get_insertparagraphnumberinfullcontext/)() | Referans alınan paragrafın paragraf numarasını tam bağlamda ekleyip eklemeyeceğini alır veya ayarlar. |
| [get_InsertParagraphNumberInRelativeContext](./get_insertparagraphnumberinrelativecontext/)() | Referans alınan paragrafın paragraf numarasını göreceli bağlamda ekleyip eklemeyeceğini alır veya ayarlar. |
| [get_InsertRelativePosition](./get_insertrelativeposition/)() | Referans alınan paragrafın göreceli konumunu ekleyip eklemeyeceğini alır veya ayarlar. |
...
| [get_SearchFromBottom](./get_searchfrombottom/)() | Mevcut sayfanın altından, üstünden ziyade, arama yapıp yapmayacağını alır veya ayarlar. |
...
| [get_StyleName](./get_stylename/)() | Aranacak metnin biçimlendirildiği stilin adını alır veya ayarlar. |
| [get_SuppressNonDelimiters](./get_suppressnondelimiters/)() | Ayırıcı olmayan karakterlerin bastırılıp bastırılmayacağını alır veya ayarlar. |
...
| [set_InsertParagraphNumber](./set_insertparagraphnumber/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber](./get_insertparagraphnumber/). |
| [set_InsertParagraphNumberInFullContext](./set_insertparagraphnumberinfullcontext/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInFullContext](./get_insertparagraphnumberinfullcontext/). |
| [set_InsertParagraphNumberInRelativeContext](./set_insertparagraphnumberinrelativecontext/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumberInRelativeContext](./get_insertparagraphnumberinrelativecontext/). |
| [set_InsertRelativePosition](./set_insertrelativeposition/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_InsertRelativePosition](./get_insertrelativeposition/). |
...
| [set_SearchFromBottom](./set_searchfrombottom/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_SearchFromBottom](./get_searchfrombottom/). |
| [set_StyleName](./set_stylename/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_StyleName](./get_stylename/). |
| [set_SuppressNonDelimiters](./set_suppressnondelimiters/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldStyleRef::get_SuppressNonDelimiters](./get_suppressnondelimiters/). |
| static [Type](./type/)() |  |
