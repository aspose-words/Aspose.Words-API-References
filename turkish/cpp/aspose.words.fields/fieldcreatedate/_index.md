---
title: "Aspose::Words::Fields::FieldCreateDate sınıfı"
linktitle: "FieldCreateDate"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldCreateDate sınıfı. CREATEDATE alanını uygular. Daha fazla bilgi edinmek için C++ belgeleri makalesini ziyaret edin."
type: docs
weight: 26000
url: /tr/cpp/aspose.words.fields/fieldcreatedate/
---
## FieldCreateDate class


CREATEDATE alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [set_UseLunarCalendar](./set_uselunarcalendar/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldCreateDate::get_UseLunarCalendar](./get_uselunarcalendar/). |
| [set_UseSakaEraCalendar](./set_usesakaeracalendar/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldCreateDate::get_UseSakaEraCalendar](./get_usesakaeracalendar/). |
| [set_UseUmAlQuraCalendar](./set_useumalquracalendar/)(bool) | Ayarlayıcı: [Aspose::Words::Fields::FieldCreateDate::get_UseUmAlQuraCalendar](./get_useumalquracalendar/). |
| static [Type](./type/)() |  |
