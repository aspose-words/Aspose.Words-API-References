...
description: "Aspose::Words::Fields::FieldTC sınıfı. TC alanını uygular. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 100000
url: /tr/cpp/aspose.words.fields/fieldtc/
---
## FieldTC class


TC alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_EntryLevel](./get_entrylevel/)() | Girdinin seviyesini alır. |
...
| [get_OmitPageNumber](./get_omitpagenumber/)() override | Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını alır. |
...
| [get_Text](./get_text/)() | Girdinin metnini alır. |
| virtual [get_Type](../field/get_type/)() const | Microsoft Word alan türünü alır. |
| [get_TypeIdentifier](./get_typeidentifier/)() | Bu alan için bir tip tanımlayıcısını alır (genellikle bir harftir). |
...
| [set_EntryLevel](./set_entrylevel/)(const System::String\&) | Girdinin seviyesini ayarlar. |
...
| [set_OmitPageNumber](./set_omitpagenumber/)(bool) | Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını ayarlar. |
| [set_Result](../field/set_result/)(const System::String\&) | [Aspose::Words::Fields::Field::get_Result](../field/get_result/) için ayarlayıcı. |
| [set_Text](./set_text/)(const System::String\&) | Girdinin metnini ayarlar. |
| [set_TypeIdentifier](./set_typeidentifier/)(const System::String\&) | Bu alan için bir tip tanımlayıcısını ayarlar (genellikle bir harftir). |
| static [Type](./type/)() |  |
