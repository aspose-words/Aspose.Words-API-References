---
title: "Aspose::Words::Fields::FieldTime sınıfı"
linktitle: "FieldTime"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldTime sınıfı. TIME alanını uygular. Daha fazla bilgi için C++'deki belge makalesini ziyaret edin."
type: docs
weight: 102000
url: /tr/cpp/aspose.words.fields/fieldtime/
---
## FieldTime class


TIME alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
