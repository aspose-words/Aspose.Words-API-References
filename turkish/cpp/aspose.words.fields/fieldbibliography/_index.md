---
title: "Aspose::Words::Fields::FieldBibliography sınıfı"
linktitle: "FieldBibliography"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldBibliography sınıfı. BIBLIOGRAPHY alanını uygular. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 18000
url: /tr/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


BIBLIOGRAPHY alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Belge içinde o dili kullanan kaynakları filtrelemek için bibliyografik verileri süzen dil kimliğini alır. |
| [get_Format](../field/get_format/)() | Alan biçimlendirmesine tipli erişim sağlayan bir [FieldFormat](../fieldformat/) nesnesi alır. |
| [get_FormatLanguageId](./get_formatlanguageid/)() | Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini alır. |
...
| [get_SourceTag](./get_sourcetag/)() | Bibliyografide yalnızca eşleşen Tag öğesi değerine sahip kaynakların gösterilmesi için bir değer alır. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Belge içinde o dili kullanan kaynakları filtrelemek için kullanılan dil kimliğini ayarlar. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Belgedeki bibliografik kaynakları biçimlendirmek için kullanılan dil kimliğini ayarlar. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Bibliyografide yalnızca eşleşen Tag öğesi değerine sahip kaynakların gösterilmesi için bir değer ayarlar. |
| static [Type](./type/)() |  |
