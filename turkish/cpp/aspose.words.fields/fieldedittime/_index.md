...
description: "Aspose::Words::Fields::FieldEditTime sınıfı. EDITTIME alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 37000
url: /tr/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


EDITTIME alanını uygular. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
// EDITTIME alanı, dakikalar cinsinden gösterecektir,
// belge açıkken Microsoft Word penceresinde harcanan süreyi.
...
// belge açıkken harcanan süreyi izlemek için. Biz de bunu kendimiz düzenleyebiliriz.
...
// Alan gerçek zamanlı olarak kendini güncellemez ve ayrıca
// doğru bir değer gerektiğinde Microsoft Word'de manuel olarak güncellenmelidir.
doc->UpdateFields();
