---
title: "Aspose::Words::Fields::FieldData sınıfı"
linktitle: "FieldData"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldData sınıfı. DATA alanını uygular. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 27000
url: /tr/cpp/aspose.words.fields/fielddata/
---
## FieldData class


DATA alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
Bir belgeye DATA alanı eklemenin nasıl yapılacağını gösterir.
```cpp
