---
title: "Aspose::Words::Fields::FieldInfo sınıfı"
linktitle: "FieldInfo"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldInfo sınıfı. INFO alanını uygular. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 60000
url: /tr/cpp/aspose.words.fields/fieldinfo/
---
## FieldInfo class


INFO alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_InfoType](./get_infotype/)() | Eklenecek belge özelliğinin türünü alır veya ayarlar. |
...
| [get_NewValue](./get_newvalue/)() | Özelliği güncelleyen isteğe bağlı bir değeri alır veya ayarlar. |
...
| [set_InfoType](./set_infotype/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldInfo::get_InfoType](./get_infotype/). |
...
| [set_NewValue](./set_newvalue/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldInfo::get_NewValue](./get_newvalue/). |
