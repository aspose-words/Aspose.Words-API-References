...
description: "Aspose::Words::Fields::FieldUserAddress sınıfı. USERADDRESS alanını uygular. Daha fazla bilgi için C++'ta belgeler makalesini ziyaret edin."
type: docs
weight: 108000
url: /tr/cpp/aspose.words.fields/fielduseraddress/
---
## FieldUserAddress class


USERADDRESS alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_UserAddress](./get_useraddress/)() | Geçerli kullanıcının posta adresini alır veya ayarlar. |
...
| [set_UserAddress](./set_useraddress/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldUserAddress::get_UserAddress](./get_useraddress/). |
| static [Type](./type/)() |  |
