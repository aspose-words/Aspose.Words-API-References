---
title: "Aspose::Words::Fields::ToaCategories sınıfı"
linktitle: "ToaCategories"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::ToaCategories sınıfı. Yetkiler kategorileri tablosunu temsil eder. Daha fazla bilgi için C++'deki belge makalesini ziyaret edin."
type: docs
weight: 116000
url: /tr/cpp/aspose.words.fields/toacategories/
---
## ToaCategories class


Yetkiler kategorileri tablosunu temsil eder. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| static [get_DefaultCategories](./get_defaultcategories/)() | Yetkiler kategorileri varsayılan tablosunu alır. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Kategori numarasına göre kategori başlığını alır veya ayarlar. |
| [idx_set](./idx_set/)(int32_t, const System::String\&) | Kategori numarasına göre kategori başlığını alır veya ayarlar. |
