...
description: "Aspose::Words::Fields::FieldGreetingLine sınıfı. GREETINGLINE alanını uygular. Daha fazla bilgi için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 52000
url: /tr/cpp/aspose.words.fields/fieldgreetingline/
---
## FieldGreetingLine class


GREETINGLINE alanını uygular. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_AlternateText](./get_alternatetext/)() | İsim boşsa alana dahil edilecek metni alır. |
...
| [get_LanguageId](./get_languageid/)() | İsmi biçimlendirmek için kullanılan dil kimliğini alır. |
| [get_LocaleId](../field/get_localeid/)() | Alan'ın LCID'sini alır veya ayarlar. |
| [get_NameFormat](./get_nameformat/)() | Alana dahil edilen ismin biçimini alır. |
...
| [GetFieldNames](./getfieldnames/)() override | Alan tarafından kullanılan posta birleştirme alan adlarının bir koleksiyonunu döndürür. |
...
| [set_AlternateText](./set_alternatetext/)(const System::String\&) | İsim boşsa alana dahil edilecek metni ayarlar. |
...
| [set_LanguageId](./set_languageid/)(const System::String\&) | İsmi biçimlendirmek için kullanılan dil kimliğini ayarlar. |
| [set_LocaleId](../field/set_localeid/)(int32_t) | [Aspose::Words::Fields::Field::get_LocaleId](../field/get_localeid/) için ayarlayıcı. |
| [set_NameFormat](./set_nameformat/)(const System::String\&) | Alana dahil edilen ismin biçimini ayarlar. |
