---
title: "Aspose::Words::Fields::FieldFormat sınıfı"
linktitle: "FieldFormat"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldFormat sınıfı. Alanın sayısal, tarih ve saat ve genel biçimlendirmesine tiplenmiş erişim sağlar. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 45000
url: /tr/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Alanların sayısal, tarih ve saat ve genel biçimlendirmesine tipli erişim sağlar. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Tarih ve saat alanı sonucuna uygulanan bir biçimlendirmeyi alır veya ayarlar. \\@ anahtarına karşılık gelir. |
| [get_GeneralFormats](./get_generalformats/)() | Sayısal, metin veya herhangi bir alan sonucuna uygulanan genel biçimlerin bir koleksiyonunu alır. \\* anahtarlarına karşılık gelir. |
| [get_NumericFormat](./get_numericformat/)() | Sayısal alan sonucuna uygulanan bir biçimlendirmeyi alır veya ayarlar. \\# anahtarına karşılık gelir. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Ayarlayıcı [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Ayarlayıcı [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
