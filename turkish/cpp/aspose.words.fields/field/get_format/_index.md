...
description: "Aspose::Words::Fields::Field::get_Format yöntemi. C++'da alanın biçimlendirmesine tipli erişim sağlayan bir FieldFormat nesnesi alır."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.fields/field/get_format/
---
## Field::get_Format method


Bir [FieldFormat](../../fieldformat/) nesnesi alır; bu nesne alanın biçimlendirmesine tipli erişim sağlar.
