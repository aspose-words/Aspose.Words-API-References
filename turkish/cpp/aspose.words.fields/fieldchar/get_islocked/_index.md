---
title: "Aspose::Words::Fields::FieldChar::get_IsLocked yöntemi"
linktitle: "get_IsLocked"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldChar::get_IsLocked yöntemi. C++'de üst alanın kilitli olup olmadığını alır veya ayarlar (sonucunu yeniden hesaplamamalı)."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.fields/fieldchar/get_islocked/
---
## FieldChar::get_IsLocked method


Üst alanın kilitli olup olmadığını alır veya ayarlar (sonucu yeniden hesaplamamalıdır).
