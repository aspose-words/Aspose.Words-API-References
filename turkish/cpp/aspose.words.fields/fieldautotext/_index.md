...
description: "Aspose::Words::Fields::FieldAutoText sınıfı. AUTOTEXT alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 15000
url: /tr/cpp/aspose.words.fields/fieldautotext/
---
## FieldAutoText class


AUTOTEXT alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_EntryName](./get_entryname/)() override | AutoText girişinin adını alır veya ayarlar. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | [Aspose::Words::Fields::FieldAutoText::get_EntryName](./get_entryname/) için ayarlayıcı. |
