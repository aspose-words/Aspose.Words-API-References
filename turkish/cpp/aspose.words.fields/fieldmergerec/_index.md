...
description: "Aspose::Words::Fields::FieldMergeRec sınıfı. MERGEREC alanını uygular. Daha fazla bilgi için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 68000
url: /tr/cpp/aspose.words.fields/fieldmergerec/
---
## FieldMergeRec class


MERGEREC alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
