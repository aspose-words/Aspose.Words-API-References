---
title: "Aspose::Words::Fields::FieldSet sınıfı"
linktitle: "FieldSet"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldSet sınıfı. SET alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 92000
url: /tr/cpp/aspose.words.fields/fieldset/
---
## FieldSet class


SET alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Yer iminin adını alır veya ayarlar. |
| [get_BookmarkText](./get_bookmarktext/)() | Yer işaretinin yeni metnini alır veya ayarlar. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | [Aspose::Words::Fields::FieldSet::get_BookmarkName](./get_bookmarkname/) için ayarlayıcı. |
| [set_BookmarkText](./set_bookmarktext/)(const System::String\&) | [Aspose::Words::Fields::FieldSet::get_BookmarkText](./get_bookmarktext/) için ayarlayıcı. |
