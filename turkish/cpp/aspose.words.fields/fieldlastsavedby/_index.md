---
title: "Aspose::Words::Fields::FieldLastSavedBy sınıfı"
linktitle: "FieldLastSavedBy"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldLastSavedBy sınıfı. LASTSAVEDBY alanını uygular. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 62000
url: /tr/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


LASTSAVEDBY alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
LASTSAVEDBY alanını nasıl kullanacağınızı gösterir.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Microsoft Word'de bir belge oluşturursak, "Last saved by" yerleşik özelliğinde kullanıcının adını içerir.
// Programlı olarak bir belge oluşturursak, bu özellik null olur ve bir değer atamamız gerekir.
doc->get_BuiltInDocumentProperties()->set_LastSavedBy(u"John Doe");

// Bu özelliğin değerini belgede göstermek için LASTSAVEDBY alanını kullanabiliriz.
