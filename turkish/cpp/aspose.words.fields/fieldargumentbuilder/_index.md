...
description: "Aspose::Words::Fields::FieldArgumentBuilder sınıfı. Alanlar, düğümler ve düz metinden oluşan karmaşık bir alan argümanı oluşturur. Daha fazla bilgi için C++'daki  dokümantasyon makalesini ziyaret edin."
type: docs
weight: 9000
url: /tr/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


Alanlar, düğümler ve düz metinden oluşan karmaşık bir alan argümanı oluşturur. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Argümana, bir [FieldBuilder](../fieldbuilder/) tarafından temsil edilen bir alan ekler. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Argümana bir düğüm ekler. |
| [AddText](./addtext/)(const System::String\&) | Argümana düz metin ekler. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | [FieldArgumentBuilder](./) sınıfının bir örneğini başlatır. |
