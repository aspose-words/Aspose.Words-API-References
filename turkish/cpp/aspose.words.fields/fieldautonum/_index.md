---
title: "Aspose::Words::Fields::FieldAutoNum sınıfı"
linktitle: "FieldAutoNum"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldAutoNum sınıfı. AUTONUM alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.fields/fieldautonum/
---
## FieldAutoNum class


AUTONUM alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Kullanılacak ayırıcı karakteri alır veya ayarlar. |
...
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Ayarlayıcı [Aspose::Words::Fields::FieldAutoNum::get_SeparatorCharacter](./get_separatorcharacter/). |
| static [Type](./type/)() |  |
