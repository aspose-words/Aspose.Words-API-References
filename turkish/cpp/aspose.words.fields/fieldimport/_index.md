---
title: "Aspose::Words::Fields::FieldImport sınıfı"
linktitle: "FieldImport"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldImport sınıfı. IMPORT alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 55000
url: /tr/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


IMPORT alanını uygular. Daha fazla bilgi edinmek için, [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [get_GraphicFilter](./get_graphicfilter/)() | Eklenecek grafiğin formatı için filtrenin adını alır veya ayarlar. |
...
| [get_IsLinked](./get_islinked/)() override | Belgeyle birlikte grafik verileri depolanmayarak dosya boyutunun küçültülüp küçültülmeyeceğini alır veya ayarlar. |
...
| [get_SourceFullName](./get_sourcefullname/)() override | Resmin konumunu alır veya ayarlar. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | Ayarlayıcı [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/) için. |
| [set_IsDirty](../field/set_isdirty/)(bool) | [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) için ayarlayıcı. |
| [set_IsLinked](./set_islinked/)(bool) | Ayarlayıcı [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/) için. |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | Ayarlayıcı [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/) için. |
| static [Type](./type/)() |  |
