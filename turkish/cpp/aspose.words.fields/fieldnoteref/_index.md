---
title: "Aspose::Words::Fields::FieldNoteRef sınıfı"
linktitle: "FieldNoteRef"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldNoteRef sınıfı. NOTEREF alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 72000
url: /tr/cpp/aspose.words.fields/fieldnoteref/
---
## FieldNoteRef class


NOTEREF alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_BookmarkName](./get_bookmarkname/)() | Yer işaretinin adını alır. |
...
| [get_InsertHyperlink](./get_inserthyperlink/)() | Yer işaretli paragraf için bir köprü eklenip eklenmeyeceğini alır. |
| [get_InsertReferenceMark](./get_insertreferencemark/)() | Altnot Referansı veya Sonnot Referansı stilindeki aynı karakter biçimlendirmesiyle referans işaretini ekler. |
| [get_InsertRelativePosition](./get_insertrelativeposition/)() | Yer işaretli paragrafın göreli konumunun eklenip eklenmeyeceğini alır. |
...
| [set_BookmarkName](./set_bookmarkname/)(const System::String\&) | Yer işaretinin adını ayarlar. |
| [set_InsertHyperlink](./set_inserthyperlink/)(bool) | Yer işaretli paragraf için bir köprü eklenip eklenmeyeceğini ayarlar. |
| [set_InsertReferenceMark](./set_insertreferencemark/)(bool) | Altnot Referansı veya Sonnot Referansı stilindeki aynı karakter biçimlendirmesiyle referans işaretini ekler. |
| [set_InsertRelativePosition](./set_insertrelativeposition/)(bool) | Yer işaretli paragrafın göreli konumunun eklenip eklenmeyeceğini ayarlar. |
...
NOTEREF alanı ile ayaknotlarını çapraz referanslamayı gösterir.
```cpp
