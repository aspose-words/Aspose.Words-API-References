---
title: "Aspose::Words::Fields::FieldCompare sınıfı"
linktitle: "FieldCompare"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldCompare sınıfı. COMPARE alanını uygular. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 25000
url: /tr/cpp/aspose.words.fields/fieldcompare/
---
## FieldCompare class


COMPARE alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldCompare::get_ComparisonOperator](./get_comparisonoperator/). |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldCompare::get_LeftExpression](./get_leftexpression/). |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | Ayarlayıcı: [Aspose::Words::Fields::FieldCompare::get_RightExpression](./get_rightexpression/). |
| static [Type](./type/)() |  |
