---
title: "Aspose::Words::Fields::FieldSectionPages sınıfı"
linktitle: "FieldSectionPages"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fields::FieldSectionPages sınıfı. SECTIONPAGES alanını uygular. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 89000
url: /tr/cpp/aspose.words.fields/fieldsectionpages/
---
## FieldSectionPages class


SECTIONPAGES alanını uygular. Daha fazla bilgi edinmek için [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) dokümantasyon makalesini ziyaret edin.
...
SECTION ve SECTIONPAGES alanlarını bölümlere göre sayfa numaralandırmak için nasıl kullanacağınızı gösterir.
```cpp
...
// SECTION alanı, içinde bulunduğu bölümün numarasını gösterir.
...
// PAGE alanı, içinde bulunduğu sayfanın numarasını gösterir.
builder->Write(u"\nPage ");
...
// SECTIONPAGES alanı, içinde bulunduğu bölümün kapsadığı sayfa sayısını gösterir.
builder->Write(u" of ");
...
// Üstbilgiden çıkıp ana belgeye geri dönün ve iki sayfa ekleyin.
// Bu sayfaların tümü ilk bölümde olacak. Her üstbilgide bir kez görünen alanlarımız,
// bu bölümün geçerli/toplam sayfalarını numaralandıracak.
builder->MoveToDocumentEnd();
builder->InsertBreak(Aspose::Words::BreakType::PageBreak);
builder->InsertBreak(Aspose::Words::BreakType::PageBreak);

// Belge oluşturucu kullanarak yeni bir bölümü şu şekilde ekleyebiliriz.
// Bu, tüm sonraki üstbilgilerde SECTION ve SECTIONPAGES alanlarında gösterilen değerleri etkileyecek.
builder->InsertBreak(Aspose::Words::BreakType::SectionBreakNewPage);

// PAGE alanı, tüm belge boyunca sayfaları saymaya devam edecek.
// Her bölümde sayacını manuel olarak sıfırlayarak sayfaları bölüm bölüm izleyebiliriz.
