---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor yöntemi"
linktitle: "get_MovedFromTextColor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor yöntemi. İçeriğin Moving'den taşındığı alanlarda kullanılacak rengi belirtmenizi sağlar. Varsayılan değer C++'da ByAuthor'dır."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


İçeriğin [Moving](../../../aspose.words/revisiontype/)den taşındığı alanlarda kullanılacak rengi belirtmenizi sağlar. Varsayılan değer [ByAuthor](../../revisioncolor/)'dır.
