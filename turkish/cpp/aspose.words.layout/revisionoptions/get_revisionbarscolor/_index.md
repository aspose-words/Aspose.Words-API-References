---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor yöntemi"
linktitle: "get_RevisionBarsColor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisionBarsColor yöntemi. Revize edilmiş bilgileri içeren belge satırlarını tanımlayan yan çubuklar için kullanılacak rengi belirtmenizi sağlar. Varsayılan değer C++'da Kırmızıdır."
type: docs
weight: 14000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_revisionbarscolor/
---
## RevisionOptions::get_RevisionBarsColor method


Revize edilmiş bilgileri içeren belge satırlarını tanımlayan yan çubuklar için kullanılacak rengi belirtmenizi sağlar. Varsayılan değer [Red](../../revisioncolor/)dır.
