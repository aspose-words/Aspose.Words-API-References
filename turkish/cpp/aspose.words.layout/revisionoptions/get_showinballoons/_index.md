---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons yöntemi"
linktitle: "get_ShowInBalloons"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons yöntemi. Revizyonların balonlarda render edilip edilmeyeceğini belirtmenizi sağlar. Varsayılan değer C++'da None'dır."
type: docs
weight: 17000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_showinballoons/
---
## RevisionOptions::get_ShowInBalloons method


Revizyonların balonlarda render edilip edilmeyeceğini belirtmenizi sağlar. Varsayılan değer [None](../../showinballoons/)dir.
...
// Varsayılan olarak, revizyon olan metin diğer revizyon olmayan metinlerden ayırt etmek için farklı bir renge sahiptir.
// Sayfanın sağ kenarında bir balonda her revizyon hakkında daha fazla ayrıntı göstermek için bir revizyon seçeneği ayarlayın.
