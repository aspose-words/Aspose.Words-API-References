---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor yöntemi"
linktitle: "get_RevisedPropertiesColor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor yöntemi. Biçimlendirme özellikleri değişiklikleri olan içerik için kullanılacak rengi belirtmeye izin verir FormatChange. Varsayılan değer C++'da NoHighlight'dir."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_revisedpropertiescolor/
---
## RevisionOptions::get_RevisedPropertiesColor method


Biçimlendirme özellikleri değişiklikleri olan içerik için kullanılacak rengi belirtmeye izin verir [FormatChange](../../../aspose.words/revisiontype/) Varsayılan değer [NoHighlight](../../revisioncolor/).
