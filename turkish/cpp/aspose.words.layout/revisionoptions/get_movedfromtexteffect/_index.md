---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect yöntemi"
linktitle: "get_MovedFromTextEffect"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect yöntemi. İçeriğin taşındığı alanlara uygulanacak efekti belirtmenizi sağlar Moving. Varsayılan değer C++'da DoubleStrikeThrough'dir."
type: docs
weight: 9000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_movedfromtexteffect/
---
## RevisionOptions::get_MovedFromTextEffect method


İçeriğin taşındığı alanlara uygulanacak efekti belirtmenizi sağlar [Moving](../../../aspose.words/revisiontype/). Varsayılan değer [DoubleStrikeThrough](../../revisiontexteffect/)dir.
