---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect yöntemi"
linktitle: "get_RevisedPropertiesEffect"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect yöntemi. Biçimlendirme özelliklerindeki değişikliklerle içerik alanları için etkiyi belirtmeye izin verir FormatChange. Varsayılan değer C++'ta None."
type: docs
weight: 13000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


Biçimlendirme özelliklerindeki değişikliklerle içerik alanları için etkiyi belirtmeye izin verir [FormatChange](../../../aspose.words/revisiontype/) Varsayılan değer [None](../../revisiontexteffect/).
