---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor yöntemi"
linktitle: "get_MovedToTextColor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor yöntemi. İçeriğin Moving'e taşındığı alanlarda kullanılacak rengi belirtmenizi sağlar. Varsayılan değer C++'da ByAuthor'dır."
type: docs
weight: 10000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


İçeriğin [Moving](../../../aspose.words/revisiontype/)e taşındığı alanlarda kullanılacak rengi belirtmenizi sağlar. Varsayılan değer [ByAuthor](../../revisioncolor/)'dır.
