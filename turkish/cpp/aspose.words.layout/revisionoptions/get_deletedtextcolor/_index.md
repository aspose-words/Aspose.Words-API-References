---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor yöntemi"
linktitle: "get_DeletedTextColor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor yöntemi. Silinen içerik (Deletion) için kullanılacak rengi belirtmenizi sağlar. Varsayılan değer C++'da ByAuthor'dır."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


Silinen içerik [Deletion](../../../aspose.words/revisiontype/) için kullanılacak rengi belirtmenizi sağlar. Varsayılan değer [ByAuthor](../../revisioncolor/)dır.
