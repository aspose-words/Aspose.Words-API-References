...
description: "Aspose::Words::Layout::RevisionTextEffect enum. C++'ta belge metni revizyonları için dekorasyon etkisini belirtmeye olanak tanır."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.layout/revisiontexteffect/
---
## RevisionTextEffect enum


Belge metni revizyonları için süsleme etkisini belirtmeyi sağlar.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| None | 0 | Revize edilmiş içeriğe özel bir efekt uygulanmaz. Bu, [NoHighlight](../revisioncolor/) ile eşleşir. |
| Renk | 1 | Revize edilmiş içerik yalnızca renk ile vurgulanır. |
| Kalın | 2 | Revize edilmiş içerik kalın ve renkli yapılır. |
| İtalik | 3 | Revize edilmiş içerik italik ve renkli yapılır. |
| Alt çizgi | 4 | Revize edilmiş içerik altı çizili ve renkli yapılır. |
| ÇiftAltÇizgi | 5 | Revize edilmiş içerik çift altı çizili ve renkli yapılır. |
| ÜstÜstÇizgi | 6 | Revize edilmiş içerik üstü çizili ve renkli yapılır. |
| ÇiftÜstÜstÇizgi | 7 | Revize edilmiş içerik çift üstü çizili ve renkli yapılır. |
| Gizli | 8 | Revize edilmiş içerik gizlidir. |
