...
description: "Aspose::Words::Layout::ShowInBalloons enum. C++'da hangi revizyonların balonlarda renderleneceğini belirtir."
type: docs
weight: 13000
url: /tr/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Balonlarda hangi revizyonların render edileceğini belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| None | 0 | Ekleme, silme ve biçim revizyonlarını satır içinde renderler. |
| Biçim | 1 | Ekleme ve silme revizyonlarını satır içinde, biçim revizyonlarını ise balonlarda renderler. |
| FormatAndDelete | 2 | Ekleme revizyonlarını satır içinde, silme ve biçimlendirme revizyonlarını balonlarda render eder. |
