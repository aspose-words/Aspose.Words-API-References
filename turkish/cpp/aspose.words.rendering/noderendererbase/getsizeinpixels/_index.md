...
description: "Aspose::Words::Rendering::NodeRendererBase::GetSizeInPixels metodu. Belirtilen yakınlaştırma faktörü ve çözünürlük için şeklin piksel cinsinden boyutunu hesaplar C++'da."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.rendering/noderendererbase/getsizeinpixels/
---
## NodeRendererBase::GetSizeInPixels(float, float) method


Belirtilen yakınlaştırma faktörü ve çözünürlük için şeklin boyutunu pikseller cinsinden hesaplar.
...
| dpi | float | Noktalardan piksellere dönüştürmek için (yatay ve dikey) çözünürlük (inç başına nokta). |
...
Bu metod [SizeInPoints](../get_sizeinpoints/) değerini piksel cinsinden boyuta dönüştürür ve şekli düzgün bir şekilde bitmap üzerine render etmek için bir bitmap oluşturmak istediğinizde faydalıdır.
