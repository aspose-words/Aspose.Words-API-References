...
description: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints method. Şeklin gerçek boyutunu nokta cinsinden C++'ta alır."
type: docs
weight: 5000
url: /tr/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
## NodeRendererBase::get_SizeInPoints method


Şeklin gerçek boyutunu puan cinsinden alır.
...
Bu özellik, şeklin gerçek (sayfada render edildiği gibi) sınırlayıcı kutusunun boyutunu döndürür. Boyut, şekil dönüşünü (varsa) dikkate alır.
