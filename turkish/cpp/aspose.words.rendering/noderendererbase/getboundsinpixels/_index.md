...
description: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels yöntemi. Belirtilen yakınlaştırma faktörü ve çözünürlük için şeklin piksel cinsinden sınırlarını C++'da hesaplar."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.rendering/noderendererbase/getboundsinpixels/
---
## NodeRendererBase::GetBoundsInPixels(float, float) method


Belirtilen yakınlaştırma faktörü ve çözünürlük için şeklin sınırlarını pikseller cinsinden hesaplar.
...
Şeklin piksel cinsinden gerçek (sayfada render edildiği gibi) sınırlama kutusu.
## Açıklamalar


Bu yöntem, [BoundsInPoints](../get_boundsinpoints/) öğesini piksel cinsinden dikdörtgene dönüştürür.
