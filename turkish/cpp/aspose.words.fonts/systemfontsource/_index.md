---
title: "Aspose::Words::Fonts::SystemFontSource sınıfı"
linktitle: "SystemFontSource"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Fonts::SystemFontSource sınıfı. Sisteme kurulan tüm TrueType yazı tiplerini temsil eder. Daha fazla bilgi için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 17000
url: /tr/cpp/aspose.words.fonts/systemfontsource/
---
## SystemFontSource class


Sisteme yüklü tüm TrueType yazı tiplerini temsil eder. Daha fazla bilgi için, [Working with Fonts](https://docs.aspose.com/words/cpp/working-with-fonts/) dokümantasyon makalesini ziyaret edin.
...
| static [GetSystemFontFolders](./getsystemfontfolders/)() | Sistem yazı tipi klasörlerini döndürür; klasörlere erişilemezse boş bir dizi döner. |
...
| [SystemFontSource](./systemfontsource/)(int32_t) | Yapıcı. |
| static [Type](./type/)() |  |
