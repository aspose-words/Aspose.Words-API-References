...
description: "Aspose::Words::Fonts::FontPitch enum. C++'da yazı tipi perdesini temsil eder."
type: docs
weight: 22000
url: /tr/cpp/aspose.words.fonts/fontpitch/
---
## FontPitch enum


Yazı tipi pitch'ini temsil eder.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Default | 0 | Bir yazı tipinin perdesi hakkında bilgi bulunmadığını belirtir. |
| Fixed | 1 | Bunun sabit genişlikli bir yazı tipi olduğunu belirtir. |
| Değişken | 2 | Bu yazı tipinin orantılı genişlikte olduğunu belirtir. |
