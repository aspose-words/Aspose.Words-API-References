...
description: "Aspose::Words::WebExtensions::TaskPaneDockState enum. Görev bölmesi nesnesinin C++'deki kullanılabilir konumlarını listeler."
type: docs
weight: 11000
url: /tr/cpp/aspose.words.webextensions/taskpanedockstate/
---
## TaskPaneDockState enum


Görev bölmesi nesnesinin kullanılabilir konumlarını listeler.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Sağ | 0 | Görev bölmesini belge penceresinin sağ tarafına yerleştir. |
| Sol | 1 | Görev bölmesini belge penceresinin sol tarafına yerleştir. |
