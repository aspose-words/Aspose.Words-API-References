...
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection class. Web uzantısı özel özelliklerinin bir kümesini belirtir. Daha fazla bilgi için C++'deki belge makalesini ziyaret edin."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Web uzantısı özel özelliklerinin bir kümesini belirtir. Daha fazla bilgi edinmek için [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) dokümantasyon makalesini ziyaret edin.
