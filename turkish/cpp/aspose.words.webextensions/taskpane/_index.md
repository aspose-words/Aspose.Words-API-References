---
title: "Aspose::Words::WebExtensions::TaskPane sınıfı"
linktitle: "TaskPane"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::WebExtensions::TaskPane sınıfı. Bir eklenti görev bölmesi nesnesini temsil eder. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.webextensions/taskpane/
---
## TaskPane class


Bir eklenti görev bölmesi nesnesini temsil eder. Daha fazla bilgi için [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_DockState](./get_dockstate/)() const | Bu görev bölmesi nesnesinin son bağlandığı konumu belirtir. |
| [get_IsLocked](./get_islocked/)() const | Görev bölmesinin UI'da belgeye kilitlenip kilitlenmediğini ve kullanıcının kapatıp kapatamayacağını belirtir. |
| [get_IsVisible](./get_isvisible/)() const | Görev bölmesinin belge açıldığında varsayılan olarak görünür olup olmadığını belirtir. |
| [get_Row](./get_row/)() const | Aynı varsayılan konumda bağlanan diğer kalıcı görev bölmeleri arasında, dıştan içe doğru sayılan bu görev bölmesinin indeksini belirtir. |
| [get_WebExtension](./get_webextension/)() const | Bir web uzantısı nesnesini temsil eder. |
| [get_Width](./get_width/)() const | Bu görev bölmesi örneği için varsayılan genişlik değerini belirtir. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DockState](./set_dockstate/)(Aspose::Words::WebExtensions::TaskPaneDockState) | Ayarlayıcı [Aspose::Words::WebExtensions::TaskPane::get_DockState](./get_dockstate/). |
| [set_IsLocked](./set_islocked/)(bool) | Ayarlayıcı [Aspose::Words::WebExtensions::TaskPane::get_IsLocked](./get_islocked/). |
| [set_IsVisible](./set_isvisible/)(bool) | Ayarlayıcı [Aspose::Words::WebExtensions::TaskPane::get_IsVisible](./get_isvisible/). |
| [set_Row](./set_row/)(int32_t) | Ayarlayıcı [Aspose::Words::WebExtensions::TaskPane::get_Row](./get_row/). |
| [set_Width](./set_width/)(double) | Ayarlayıcı [Aspose::Words::WebExtensions::TaskPane::get_Width](./get_width/). |
| [TaskPane](./taskpane/)() |  |
| static [Type](./type/)() |  |
