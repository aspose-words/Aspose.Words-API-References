---
title: "Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty yapıcı"
linktitle: "WebExtensionProperty"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty yapıcı. C++'ta belirtilen ad ve değerle web uzantısı özel özelliği oluşturur."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.webextensions/webextensionproperty/webextensionproperty/
---
## WebExtensionProperty::WebExtensionProperty constructor


Belirtilen ad ve değerle bir web uzantısı özel özelliği oluşturur.
...
| --- | --- | --- |
| name | const System::String\& | Özellik adı. |
| value | const System::String\& | Özellik değeri. |
