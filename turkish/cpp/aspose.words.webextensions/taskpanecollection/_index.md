---
title: "Aspose::Words::WebExtensions::TaskPaneCollection sınıfı"
linktitle: "TaskPaneCollection"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::WebExtensions::TaskPaneCollection sınıfı. Kalıcı görev bölmesi nesnelerinin bir listesini belirtir. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Kalıcı görev bölmesi nesnelerinin bir listesini belirtir. Daha fazla bilgi için [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) dokümantasyon makalesini ziyaret edin.
