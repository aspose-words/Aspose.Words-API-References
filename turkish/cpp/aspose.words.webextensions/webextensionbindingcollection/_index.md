---
title: "Aspose::Words::WebExtensions::WebExtensionBindingCollection sınıfı"
linktitle: "WebExtensionBindingCollection"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::WebExtensions::WebExtensionBindingCollection sınıfı. Web uzantısı bağlamalarının bir listesini belirtir. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.webextensions/webextensionbindingcollection/
---
## WebExtensionBindingCollection class


Web uzantısı bağlamalarının bir listesini belirtir. Daha fazla bilgi edinmek için [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) dokümantasyon makalesini ziyaret edin.
