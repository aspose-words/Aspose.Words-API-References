...
description: "Aspose::Words::WebExtensions::WebExtensionStoreType enum. C++'ta bir web uzantısı mağazası için kullanılabilir türleri listeler."
type: docs
weight: 13000
url: /tr/cpp/aspose.words.webextensions/webextensionstoretype/
---
## WebExtensionStoreType enum


Web uzantısı mağazasının kullanılabilir tiplerini listeler.
