---
title: "Aspose::Words::WebExtensions::WebExtension sınıfı"
linktitle: "WebExtension"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::WebExtensions::WebExtension sınıfı. Bir web uzantısı nesnesini temsil eder. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Bir web eklentisi nesnesini temsil eder. Daha fazla bilgi için [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Bir web uzantısına alternatif referansları belirtir. |
| [get_Bindings](./get_bindings/)() const | Web uzantısı bağlamalarının bir listesini belirtir. |
| [get_Id](./get_id/)() const | Geçerli belgede web uzantısı örneğini benzersiz şekilde tanımlar. |
| [get_IsFrozen](./get_isfrozen/)() const | Kullanıcının web uzantısıyla etkileşime girip giremeyeceğini belirtir. |
| [get_Properties](./get_properties/)() const | Web uzantısı özel özelliklerinin bir kümesini temsil eder. |
| [get_Reference](./get_reference/)() const | Bir web uzantısına birincil referansı belirtir. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Ayarlayıcı [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Ayarlayıcı [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
