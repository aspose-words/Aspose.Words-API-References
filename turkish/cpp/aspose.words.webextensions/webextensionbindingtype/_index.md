...
description: "Aspose::Words::WebExtensions::WebExtensionBindingType enum. C++'da bir web uzantısı ile belgedeki veri arasındaki bağlama için mevcut tipleri listeler."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.webextensions/webextensionbindingtype/
---
## WebExtensionBindingType enum


Web uzantısı ile belgedeki veri arasındaki bağlama türlerinin kullanılabilir tiplerini listeler.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Matris | 0 | Başlık satırı olmayan tablo verisi. |
| Table | 1 | Başlık satırı olan tablo verisi. |
| Metin | 2 | Düz metin. |
| Default | n/a | Varsayılan olarak kullanılan matris. |
