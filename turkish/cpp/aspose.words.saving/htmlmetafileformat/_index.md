...
description: "Aspose::Words::Saving::HtmlMetafileFormat enum. Metafile'lerin C++'ta HTML belgelerine kaydedildiği biçimi gösterir."
type: docs
weight: 60000
url: /tr/cpp/aspose.words.saving/htmlmetafileformat/
---
## HtmlMetafileFormat enum


Metafile'ların HTML belgelerine kaydedildiği formatı gösterir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Png | 0 | Metafile'ler raster PNG görüntülerine işlenir. |
| Svg | 1 | Metafile'ler vektör SVG görüntülerine dönüştürülür. |
| EmfOrWmf | 2 | Metafile'ler olduğu gibi, dönüşüm olmadan kaydedilir. |
