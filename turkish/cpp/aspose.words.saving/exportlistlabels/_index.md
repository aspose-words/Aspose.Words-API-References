...
description: "Aspose::Words::Saving::ExportListLabels enum. C++'da liste etiketlerinin HTML, MHTML ve EPUB formatına nasıl dışa aktarıldığını belirtir."
type: docs
weight: 56000
url: /tr/cpp/aspose.words.saving/exportlistlabels/
---
## ExportListLabels enum


Liste etiketlerinin HTML, MHTML ve EPUB'a nasıl dışa aktarılacağını belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Otomatik | 0 | Liste etiketlerini otomatik modda çıktılar. Mümkün olduğunda HTML yerel öğelerini kullanır. |
| AsInlineText | 1 | Tüm liste etiketlerini satır içi metin olarak çıktılar. |
| ByHtmlTags | 2 | Tüm liste etiketlerini HTML yerel öğeleri olarak çıktılar. |
