---
title: "Aspose::Words::Saving::PsSaveOptions sınıfı"
linktitle: "PsSaveOptions"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Saving::PsSaveOptions sınıfı. Bir belgeyi Ps formatında kaydederken ek seçenekler belirtmek için kullanılabilir. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 26000
url: /tr/cpp/aspose.words.saving/pssaveoptions/
---
## PsSaveOptions class


Bir belgeyi [Ps](../../aspose.words/saveformat/) formatında kaydederken ek seçenekler belirtmek için kullanılabilir. Daha fazla bilgi için [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) belge makalesini ziyaret edin.
...
| [get_SaveFormat](./get_saveformat/)() override | Bu kaydetme seçenekleri nesnesi kullanıldığında belgenin kaydedileceği biçimi belirtir. Yalnızca [Ps](../../aspose.words/saveformat/) olabilir. |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Ayarlayıcı [Aspose::Words::Saving::PsSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | Ayarlayıcı [Aspose::Words::Saving::PsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/). |
