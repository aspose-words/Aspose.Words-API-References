---
title: "Aspose::Words::Saving::TxtSaveOptionsBase::get_ExportHeadersFootersMode yöntemi"
linktitle: "get_ExportHeadersFootersMode"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Saving::TxtSaveOptionsBase::get_ExportHeadersFootersMode yöntemi. Başlıkların ve altbilgilerin metin formatlarına nasıl dışa aktarıldığını belirtir. Varsayılan değer C++'da PrimaryOnly'dır."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.saving/txtsaveoptionsbase/get_exportheadersfootersmode/
---
## TxtSaveOptionsBase::get_ExportHeadersFootersMode method


Başlıkların ve altbilgilerin metin formatlarına nasıl dışa aktarıldığını belirtir. Varsayılan değer [PrimaryOnly](../../txtexportheadersfootersmode/) dir.
