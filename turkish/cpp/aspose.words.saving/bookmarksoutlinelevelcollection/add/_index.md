...
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add method. C++'ta koleksiyona bir yer imi ekler."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Eklenecek yer iminin büyük/küçük harfe duyarsız adı. |
| outlineLevel | int32_t | Yer iminin anahat seviyesi. Geçerli aralık 0 ile 9 arasındadır. |
