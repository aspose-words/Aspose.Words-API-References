...
description: "Aspose::Words::Saving::ImageSaveOptions::get_JpegQuality yöntemi. C++'da oluşturulan JPEG görüntülerinin kalitesini belirleyen bir değeri alır veya ayarlar."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.saving/imagesaveoptions/get_jpegquality/
---
...
Yalnızca JPEG olarak kaydedildiğinde etkili olur.

Bu özelliği, JPEG formatında kaydedilirken oluşturulan görüntülerin kalitesini almak veya ayarlamak için kullanın. Değer 0 ile 100 arasında değişebilir; 0 en kötü kaliteyi ancak en yüksek sıkıştırmayı, 100 ise en iyi kaliteyi ancak en düşük sıkıştırmayı ifade eder.
