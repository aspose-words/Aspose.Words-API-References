---
title: "Aspose::Words::Saving::HtmlSaveOptions::get_MetafileFormat yöntemi"
linktitle: "get_MetafileFormat"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Saving::HtmlSaveOptions::get_MetafileFormat yöntemi. Metafile'lerin HTML, MHTML veya EPUB olarak dışa aktarılırken hangi formatta kaydedileceğini belirtir. Varsayılan değer Png'dir, bu da metafile'lerin C++'ta raster PNG görüntülerine dönüştürüldüğü anlamına gelir."
type: docs
weight: 40000
url: /tr/cpp/aspose.words.saving/htmlsaveoptions/get_metafileformat/
---
## HtmlSaveOptions::get_MetafileFormat method


Metafile'lerin HTML, MHTML veya EPUB olarak dışa aktarılırken hangi formatta kaydedileceğini belirtir. Varsayılan değer [Png](../../htmlmetafileformat/)'dir, bu da metafile'lerin raster PNG görüntülerine dönüştürüldüğü anlamına gelir.
...
Metafile'ler HTML tarayıcıları tarafından yerel olarak görüntülenmez. Varsayılan olarak, Aspose.Words HTML olarak dışa aktarılırken WMF ve EMF görüntülerini PNG dosyalarına dönüştürür. Diğer seçenekler, metafile'leri SVG görüntülerine dönüştürmek veya dönüştürme olmadan olduğu gibi dışa aktarmaktır.

Bazı görüntü dönüşümleri, özellikle görüntü kırpma, metafile görüntülerine dönüştürme yapılmadan HTML'ye dışa aktarılırsa uygulanmaz.
