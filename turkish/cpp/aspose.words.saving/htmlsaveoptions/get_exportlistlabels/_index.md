...
description: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels yöntemi. Liste etiketlerinin HTML, MHTML veya EPUB'a nasıl çıktılanacağını kontrol eder. Varsayılan değer C++'da Auto'dur."
type: docs
weight: 21000
url: /tr/cpp/aspose.words.saving/htmlsaveoptions/get_exportlistlabels/
---
## HtmlSaveOptions::get_ExportListLabels method


Liste etiketlerinin HTML, MHTML veya EPUB'a nasıl çıktılanacağını kontrol eder. Varsayılan değer [Auto](../../exportlistlabels/)dır.
...
Liste dışa aktarımını HTML'ye nasıl yapılandıracağınızı gösterir.
```cpp
...
// belgenin listeleri temsil etmek için hangi HTML öğelerini kullanacağını belirlemek için.
// "ExportListLabels" özelliğini "ExportListLabels.AsInlineText" olarak ayarlama
// span'leri biçimlendirerek listeler oluşturur.
// \"ExportListLabels\" özelliğini \"ExportListLabels.Auto\" olarak ayarlamak <p> etiketini kullanacaktır
// listeleri oluşturmak için, <ol> ve <li> etiketlerini kullanmanın biçim kaybına yol açabileceği durumlarda.
// \"ExportListLabels\" özelliğini \"ExportListLabels.ByHtmlTags\" olarak ayarlamak
// tüm listeleri oluşturmak için <ol> ve <li> etiketlerini kullanacaktır.
