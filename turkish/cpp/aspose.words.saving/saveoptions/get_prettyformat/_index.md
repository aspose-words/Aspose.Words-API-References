---
title: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat yöntemi"
linktitle: "get_PrettyFormat"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Saving::SaveOptions::get_PrettyFormat yöntemi. true olduğunda, uygulanabilir yerlerde çıktıyı güzel biçimlendirir. Varsayılan değer C++'da false'tur."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.saving/saveoptions/get_prettyformat/
---
## SaveOptions::get_PrettyFormat method


**true** olduğunda, uygulanabilir yerlerde çıktıyı güzel biçimlendirir. Varsayılan değer **false**.
...
İnsana okunabilir hale getirmek için HTML, MHTML, EPUB, WordML, RTF, DOCX ve ODT çıktısını **true** olarak ayarlayın. Test veya hata ayıklama için faydalıdır.

## Örnekler



Kaydedilmiş bir .html belgesinin ham kodunun okunabilirliğini nasıl artıracağınızı gösterir.
```cpp
...
// Güzel biçimlendirmeyi etkinleştirmek, sekme durakları ve yeni satır karakterleri ekleyerek ham html kodunu daha okunabilir hale getirir.
