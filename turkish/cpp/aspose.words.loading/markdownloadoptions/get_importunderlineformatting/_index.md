---
title: "Aspose::Words::Loading::MarkdownLoadOptions::get_ImportUnderlineFormatting metodu"
linktitle: "get_ImportUnderlineFormatting"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Loading::MarkdownLoadOptions::get_ImportUnderlineFormatting metodu. İki artı karakteri \\\"++\\\" dizisini alt çizgi metin biçimlendirmesi olarak tanıyıp tanımadığını belirten bir boolean değer alır veya ayarlar. Varsayılan değer C++'ta false'tur."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.loading/markdownloadoptions/get_importunderlineformatting/
---
## MarkdownLoadOptions::get_ImportUnderlineFormatting method


İki artı karakteri \"++\" dizisini alt çizgi metin biçimlendirmesi olarak tanıyıp tanımayacağını belirten bir boolean değer alır veya ayarlar. Varsayılan değer **false**.
...
Artı karakterleri \"++\" alt çizgi metin biçimlendirmesi olarak nasıl tanıyacağını gösterir.
```cpp
{
