---
title: "Aspose::Words::Loading::TxtLoadOptions::get_LeadingSpacesOptions yöntemi"
linktitle: "get_LeadingSpacesOptions"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Loading::TxtLoadOptions::get_LeadingSpacesOptions yöntemi. Başlangıç boşluklarının işlenmesi için tercih edilen seçeneği alır veya ayarlar. Varsayılan değer C++'da ConvertToIndent'tir."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.loading/txtloadoptions/get_leadingspacesoptions/
---
## TxtLoadOptions::get_LeadingSpacesOptions method


Başlangıç boşluklarının işlenmesi için tercih edilen seçeneği alır veya ayarlar. Varsayılan değer [ConvertToIndent](../../txtleadingspacesoptions/).
