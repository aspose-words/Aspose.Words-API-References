...
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions enum. C++'ta Metin dosyasından içe aktarım sırasında önde gelen boşlukların işlenmesi için mevcut seçenekleri belirtir."
type: docs
weight: 18000
url: /tr/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


Metin dosyasından içe aktarım sırasında önde gelen boşlukların işlenmesi için mevcut seçenekleri belirtir [Text](../../aspose.words/loadformat/) dosyası.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| ConvertToIndent | 0 | Ön boşluklar kaldırılır ve sol girintiye dönüştürülür. |
| Trim | 1 | Ön boşluklar kırpılır. |
| Preserve | 2 | Ön boşluklar korunur. |
