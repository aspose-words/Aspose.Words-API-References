...
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition yöntemi. Bu liste bir liste stilinin tanımıysa true döndürür C++ içinde."
type: docs
weight: 5000
url: /tr/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
## List::get_IsListStyleDefinition method


Bu liste bir liste stilinin tanımıysa **true** döndürür.
...
Bu özellik **true** olduğunda, [Style](../get_style/) özelliği bu listenin tanımladığı liste stilini döndürür.

Bir liste stilini tanımlayan bir listenin özelliklerini değiştirerek, liste stilinin özelliklerini değiştirirsiniz.

Liste stilinin tanımı olan bir liste, paragraflara doğrudan uygulanarak numaralandırılamaz.
