...
description: "Aspose::Words::Lists::List::get_ListId method. C++'ta listenin benzersiz tanımlayıcısını alır."
type: docs
weight: 9000
url: /tr/cpp/aspose.words.lists/list/get_listid/
---
...
Genellikle bu özelliği kullanmanız gerekmez. Ancak kullanmanız durumunda, genellikle bir listeyi kimliğiyle bulmak için [GetListByListId()](../../listcollection/getlistbylistid/) metodu ile birlikte kullanırsınız.
