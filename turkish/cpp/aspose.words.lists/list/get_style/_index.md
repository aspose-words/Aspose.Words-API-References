---
title: "Aspose::Words::Lists::List::get_Style metodu"
linktitle: "get_Style"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Lists::List::get_Style metodu. Bu listenin C++'ta başvurduğu veya tanımladığı liste stilini alır."
type: docs
weight: 11000
url: /tr/cpp/aspose.words.lists/list/get_style/
---
## List::get_Style method


Bu listenin referans verdiği veya tanımladığı liste stilini alır.
...
Bu liste bir liste stiliyle ilişkilendirilmemişse, özellik **null** döndürecektir.

Bir liste, bir liste stiline referans olabilir; bu durumda [IsListStyleReference](../get_isliststylereference/) **true** olacaktır.

Bir liste, bir liste stilinin tanımı olabilir; bu durumda [IsListStyleDefinition](../get_isliststyledefinition/) **true** olacaktır. Böyle bir liste doğrudan belgede paragraflara uygulanamaz.
