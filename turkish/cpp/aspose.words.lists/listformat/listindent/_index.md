...
description: "Aspose::Words::Lists::ListFormat::ListIndent yöntemi. C++'ta mevcut paragrafın liste seviyesini bir seviye artırır."
type: docs
weight: 10000
url: /tr/cpp/aspose.words.lists/listformat/listindent/
---
## ListFormat::ListIndent method


Geçerli paragrafın liste seviyesini bir seviye artırır.
...
Bu yöntem liste seviyesini değiştirir ve yeni seviyenin biçimlendirme özelliklerini uygular.

Word belgelerinde listeler en fazla dokuz seviye içerebilir. [List](../../list/) biçimlendirmesi her seviye için hangi madde işareti veya sayının kullanılacağını, sol girintiyi, madde işareti ile metin arasındaki boşluğu vb. belirler.
