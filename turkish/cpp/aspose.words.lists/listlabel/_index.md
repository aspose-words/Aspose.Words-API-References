---
title: "Aspose::Words::Lists::ListLabel sınıfı"
linktitle: "ListLabel"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Lists::ListLabel sınıfı. Bir liste etiketi için özgü özellikleri tanımlar. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.lists/listlabel/
---
## ListLabel class


Bir liste etiketi için özel özellikleri tanımlar. Daha fazla bilgi için, [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_Font](./get_font/)() | Liste etiketinin yazı tipini alır. |
| [get_LabelString](./get_labelstring/)() | Liste etiketinin dize temsilini alır. |
| [get_LabelValue](./get_labelvalue/)() | Bu etiket için sayısal bir değer alır. |
