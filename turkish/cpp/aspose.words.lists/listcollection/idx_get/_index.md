...
description: "Aspose::Words::Lists::ListCollection::idx_get yöntemi. C++'da indeksle bir liste alır."
type: docs
weight: 13000
url: /tr/cpp/aspose.words.lists/listcollection/idx_get/
---
## ListCollection::idx_get method


Bir indeks ile bir liste alır.
...
Mevcut bir listenin liste biçimlendirmesini paragraf koleksiyonuna nasıl uygulayacağınızı gösterir.
```cpp
