...
description: "Aspose::Words::Lists::ListTrailingCharacter enum. C++'da liste etiketini paragraf metninden ayıran karakteri belirtir."
type: docs
weight: 9000
url: /tr/cpp/aspose.words.lists/listtrailingcharacter/
---
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Sekme | 0 | Liste etiketi ile paragraf metni arasında bir sekme karakteri yer alır. |
| Boşluk | 1 | Liste etiketi ile paragraf metni arasında bir boşluk karakteri yer alır. |
| Yok | 2 | Liste etiketi ile paragraf metni arasında ayırıcı karakter yoktur. |

## Açıklamalar


[TrailingCharacter](../listlevel/get_trailingcharacter/) özelliği için bir değer olarak kullanılır.
