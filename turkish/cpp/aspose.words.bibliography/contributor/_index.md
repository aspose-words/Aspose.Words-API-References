---
title: "Aspose::Words::Bibliography::Contributor class"
linktitle: "Katkıda Bulunan"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::Contributor class. Bibliyografik kaynak katkı sağlayıcısını temsil eder. Bir şirket (bir organizasyon) ya da C++'ta bir kişi listesi olabilir."
type: docs
weight: 250
url: /tr/cpp/aspose.words.bibliography/contributor/
---
## Contributor class


Bir bibliyografya kaynağı katkı sağlayıcısını temsil eder. Bir şirket (bir organizasyon) ya da bir kişi listesi olabilir.

```cpp
class Contributor : public virtual System::Object
```
