...
description: "Aspose::Words::Bibliography::PersonCollection class. C++'de bibliyografi kaynağı katkıda bulunan kişilerin bir listesini temsil eder."
type: docs
weight: 750
url: /tr/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Bibliyografya kaynağı katkı sağlayıcıları olan kişilerin bir listesini temsil eder.
...
| Yöntem | Açıklama |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Koleksiyona bir [Person](../person/) ekler. |
| [Clear](./clear/)() | Koleksiyondaki tüm öğeleri kaldırır. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Koleksiyonun belirli bir kişiyi içerip içermediğini belirler. |
| [get_Count](./get_count/)() | Koleksiyonda bulunan kişi sayısını alır. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Belirtilen indeksteki kişiyi alır veya ayarlar. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Belirtilen indeksteki kişiyi alır veya ayarlar. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Yeni bir [PersonCollection](./) sınıf örneği başlatır. |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Yeni bir [PersonCollection](./) sınıf örneği başlatır. |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Kişiyi koleksiyondan kaldırır. |
| [RemoveAt](./removeat/)(int32_t) | Belirtilen indeksteki kişiyi kaldırır. |
