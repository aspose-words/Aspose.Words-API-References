...
description: "Aspose::Words::Bibliography::Person class. C++'de bireysel (bir kişi) bibliyografi kaynağı katkıda bulunanı temsil eder."
type: docs
weight: 625
url: /tr/cpp/aspose.words.bibliography/person/
---
## Person class


Bireysel (bir kişi) bibliyografya kaynağı katkı sağlayıcısını temsil eder.
...
| [get_First](./get_first/)() const | Bir kişinin ilk adını alır veya ayarlar. |
| [get_Last](./get_last/)() const | Bir kişinin soyadını alır veya ayarlar. |
| [get_Middle](./get_middle/)() const | Bir kişinin ikinci adını alır veya ayarlar. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Yeni bir [Person](./) sınıf örneği başlatır. |
| [set_First](./set_first/)(const System::String\&) | [Aspose::Words::Bibliography::Person::get_First](./get_first/) için ayarlayıcı. |
| [set_Last](./set_last/)(const System::String\&) | [Aspose::Words::Bibliography::Person::get_Last](./get_last/) için ayarlayıcı. |
| [set_Middle](./set_middle/)(const System::String\&) | [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/) için ayarlayıcı. |
| static [Type](./type/)() |  |
