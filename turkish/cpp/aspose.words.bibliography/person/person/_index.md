---
title: "Aspose::Words::Bibliography::Person::Person yapıcısı"
linktitle: "Person"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::Person::Person yapıcısı. C++'ta Person sınıfının yeni bir örneğini başlatır."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.bibliography/person/person/
---
## Person::Person constructor


Yeni bir [Person](../) sınıfı örneği başlatın.
...
| --- | --- | --- |
| last | const System::String\& | Soyadı. |
| first | const System::String\& | Soyadı. |
| middle | const System::String\& | Soyadı. |
