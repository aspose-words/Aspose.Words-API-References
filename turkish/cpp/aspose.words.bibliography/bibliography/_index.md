...
linktitle: "Bibliyografya"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::Bibliography class. C++'de belgede mevcut olan bibliyografi kaynaklarının listesini temsil eder."
type: docs
weight: 125
url: /tr/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class


Belgede mevcut olan bibliyografya kaynakları listesini temsil eder.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize alır. |
| [get_Sources](./get_sources/)() const | Bir bibliyografide bulunan tüm kaynakları temsil eden bir koleksiyon alır. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize ayarlar. |
| static [Type](./type/)() |  |
