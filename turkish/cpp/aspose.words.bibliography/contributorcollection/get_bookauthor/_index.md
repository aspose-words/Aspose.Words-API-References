---
title: "Aspose::Words::Bibliography::ContributorCollection::get_BookAuthor metodu"
linktitle: "get_BookAuthor"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::ContributorCollection::get_BookAuthor metodu. Bir kaynağın kitap yazarını alır veya ayarlar C++'de."
type: docs
weight: 4000
url: /tr/cpp/aspose.words.bibliography/contributorcollection/get_bookauthor/
---
## ContributorCollection::get_BookAuthor method


Bir kaynağın kitap yazarını alır veya ayarlar.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_BookAuthor()
```
