---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Author metodu"
linktitle: "get_Author"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Author metodu. Bir kaynağın yazarını alır veya ayarlar C++'de."
type: docs
weight: 3000
url: /tr/cpp/aspose.words.bibliography/contributorcollection/get_author/
---
## ContributorCollection::get_Author method


Bir kaynağın yazarını alır veya ayarlar.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Author()
```
