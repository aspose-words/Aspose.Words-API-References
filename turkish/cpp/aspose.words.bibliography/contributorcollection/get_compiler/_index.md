---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Compiler yöntemi"
linktitle: "get_Compiler"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Compiler yöntemi. Bir kaynağın derleyicisini C++'ta alır veya ayarlar."
type: docs
weight: 5000
url: /tr/cpp/aspose.words.bibliography/contributorcollection/get_compiler/
---
## ContributorCollection::get_Compiler method


Bir kaynağın derleyicisini alır veya ayarlar.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Compiler()
```
