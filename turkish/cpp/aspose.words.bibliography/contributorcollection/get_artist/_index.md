---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Artist yöntemi"
linktitle: "get_Artist"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Artist yöntemi. Bir kaynağın sanatçısını C++'ta alır veya ayarlar."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.bibliography/contributorcollection/get_artist/
---
## ContributorCollection::get_Artist method


Bir kaynağın sanatçısını alır veya ayarlar.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Artist()
```
