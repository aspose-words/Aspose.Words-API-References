---
title: "Aspose::Words::Bibliography::ContributorCollection::get_Performer metodu"
linktitle: "get_Performer"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Bibliography::ContributorCollection::get_Performer metodu. C++'ta bir kaynağın performer'ını alır veya ayarlar."
type: docs
weight: 14000
url: /tr/cpp/aspose.words.bibliography/contributorcollection/get_performer/
---
## ContributorCollection::get_Performer method


Bir kaynağın performansçısını alır veya ayarlar.

```cpp
System::SharedPtr<Aspose::Words::Bibliography::Contributor> Aspose::Words::Bibliography::ContributorCollection::get_Performer()
```
