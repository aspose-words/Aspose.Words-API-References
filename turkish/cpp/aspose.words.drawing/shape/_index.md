...
description: "Aspose::Words::Drawing::Shape class. Çizim katmanında bir nesneyi temsil eder; örneğin AutoShape, metin kutusu, serbest şekil, OLE nesnesi, ActiveX denetimi veya resim. Daha fazla bilgi için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 11000
url: /tr/cpp/aspose.words.drawing/shape/
---
## Shape class


AutoShape, metin kutusu, serbest şekil, OLE nesnesi, ActiveX denetimi veya resim gibi çizim katmanındaki bir nesneyi temsil eder. Daha fazla bilgi edinmek için [Working with Shapes](https://docs.aspose.com/words/cpp/working-with-shapes/) dokümantasyon makalesini ziyaret edin.
...
| [AcceptEnd](./acceptend/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Şeklin sonunu ziyaret etmek için bir ziyaretçi kabul eder. |
| [AcceptStart](./acceptstart/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Şeklin başlangıcını ziyaret etmek için bir ziyaretçiyi kabul eder. |
...
| [get_Adjustments](./get_adjustments/)() | Bir şeklin ayar ham değerlerine erişim sağlar. Herhangi bir ayar ham değeri içermeyen bir şekil için boş bir koleksiyon döndürür. |
...
| [get_Chart](./get_chart/)() | Bu şeklin bir [Chart](../../aspose.words.drawing.charts/chart/) içermesi durumunda grafik özelliklerine erişim sağlar. |
...
| [get_ExtrusionEnabled](./get_extrusionenabled/)() | Ekstrüzyon efekti etkinse **true** döndürür. |
| [get_Fill](../shapebase/get_fill/)() | Şekil için dolgu biçimlendirmesini alır. |
| [get_FillColor](./get_fillcolor/)() | Şeklin kapalı yolunu dolduran fırça rengini tanımlar. |
| [get_Filled](./get_filled/)() | Şeklin kapalı yolunun doldurulup doldurulmayacağını belirler. |
| [get_FirstChild](../../aspose.words/compositenode/get_firstchild/)() const | Düğümün ilk çocuğunu alır. |
| [get_FirstParagraph](./get_firstparagraph/)() | Şekildeki ilk paragrafı alır. |
...
| [get_HasChart](./get_haschart/)() | Bu [Shape](./) bir [Chart](../../aspose.words.drawing.charts/chart/) içeriyorsa **true** döndürür. |
...
| [get_HasSmartArt](./get_hassmartart/)() | Bu [Shape](./) bir SmartArt nesnesine sahipse **true** döndürür. |
...
| [get_HorizontalRuleFormat](./get_horizontalruleformat/)() | Yatay kural şeklinin özelliklerine erişim sağlar. Yatay kural olmayan bir şekil için **null** döndürür. |
| [get_HRef](../shapebase/get_href/)() | Bir şekil için tam hiperlink adresini alır veya ayarlar. |
| [get_ImageData](./get_imagedata/)() | Şeklin görüntüsüne erişim sağlar. Şeklin görüntüsü olamazsa **null** döndürür. |
...
| [get_LastParagraph](./get_lastparagraph/)() | Şekildeki son paragrafı alır. |
...
| [get_NodeType](./get_nodetype/)() const override | [Shape](../../aspose.words/nodetype/) döndürür. |
| [get_OleFormat](./get_oleformat/)() | Bir şeklin OLE verilerine erişim sağlar. OLE nesnesi veya ActiveX kontrolü olmayan bir şekil için **null** döndürür. |
...
| [get_ShadowEnabled](./get_shadowenabled/)() | Gölge efekti etkinse **true** döndürür. |
...
| [get_SignatureLine](./get_signatureline/)() | Şekil bir imza satırı ise [SignatureLine](../signatureline/) nesnesini alır. Aksi takdirde **null** döndürür. |
...
| [get_StoryType](./get_storytype/)() | [Textbox](../../aspose.words/storytype/) döndürür. |
| [get_Stroke](./get_stroke/)() | Bir şekil için çizgi (stroke) tanımlar. |
| [get_StrokeColor](./get_strokecolor/)() | Bir çizginin rengini tanımlar. |
| [get_Stroked](./get_stroked/)() | Yolun çizgiyle çizilip çizilmeyeceğini tanımlar. |
| [get_StrokeWeight](./get_strokeweight/)() | Bir şeklin yolunu puan cinsinden çizen fırça kalınlığını tanımlar. |
| [get_Target](../shapebase/get_target/)() | Şekil bağlantısı için hedef çerçeveyi alır veya ayarlar. |
| [get_TextBox](./get_textbox/)() | Metnin bir şekil içinde nasıl görüntüleneceğini belirten öznitelikleri tanımlar. |
| [get_TextPath](./get_textpath/)() | Metin yolunun (WordArt nesnesi) metnini tanımlar. |
...
| [set_FillColor](./set_fillcolor/)(System::Drawing::Color) | [Aspose::Words::Drawing::Shape::get_FillColor](./get_fillcolor/) için ayarlayıcı. |
| [set_Filled](./set_filled/)(bool) | [Aspose::Words::Drawing::Shape::get_Filled](./get_filled/) için ayarlayıcı. |
...
| [set_StrokeColor](./set_strokecolor/)(System::Drawing::Color) | [Aspose::Words::Drawing::Shape::get_StrokeColor](./get_strokecolor/) için ayarlayıcı. |
| [set_Stroked](./set_stroked/)(bool) | [Aspose::Words::Drawing::Shape::get_Stroked](./get_stroked/) için ayarlayıcı. |
| [set_StrokeWeight](./set_strokeweight/)(double) | [Aspose::Words::Drawing::Shape::get_StrokeWeight](./get_strokeweight/) için ayarlayıcı. |
...
| [Shape](./shape/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, Aspose::Words::Drawing::ShapeType) | Yeni bir şekil nesnesi oluşturur. |
...
| static [Type](./type/)() |  |
| [UpdateSmartArtDrawing](./updatesmartartdrawing/)() | SmartArt önceden render edilmiş çizimini [Aspose.Words](../../aspose.words/)'nin SmartArt soğuk render motorunu kullanarak günceller. |
## Açıklamalar


Microsoft Word belgesinde şekiller oluşturmak veya değiştirmek için [Shape](./) sınıfını kullanabilirsiniz.

Bir şeklin önemli bir özelliği, onun [ShapeType](../shapebase/get_shapetype/) özelliğidir. Farklı tipteki şekiller, Word belgesinde farklı yeteneklere sahip olabilir. Örneğin, yalnızca resim ve OLE şekilleri içinde resim barındırabilir. Şekillerin çoğu metin içerebilir, ancak hepsi değil.

Metin içerebilen şekiller, çocuk olarak [Paragraph](../../aspose.words/paragraph/) ve [Table](../../aspose.words.tables/table/) düğümlerini içerebilir.
...
Bir belgede tüm şekilleri nasıl sileceğinizi gösterir.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// İçinde başka bir şekil bulunan bir grup şekliyle birlikte iki şekil ekleyin.
