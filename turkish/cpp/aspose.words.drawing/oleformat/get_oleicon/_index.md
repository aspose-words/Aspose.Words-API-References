---
title: "Aspose::Words::Drawing::OleFormat::get_OleIcon yöntemi"
linktitle: "get_OleIcon"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::OleFormat::get_OleIcon yöntemi. OLE nesnesinin çizim yönünü alır. True olduğunda, OLE nesnesi bir simge olarak gösterilir. False olduğunda, OLE nesnesi C++ içinde içerik olarak gösterilir."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.drawing/oleformat/get_oleicon/
---
## OleFormat::get_OleIcon method


OLE nesnesinin çizim görünümünü alır. **true** olduğunda, OLE nesnesi bir simge olarak gösterilir. **false** olduğunda, OLE nesnesi içerik olarak gösterilir.
...
Aspose.Words, karışıklığı önlemek için bu özelliğin ayarlanmasına izin vermez. Eğer Aspose.Words içinde çizim yönünü değiştirebilseydiniz, Microsoft Word OLE nesnesini orijinal çizim yönünde göstermeye devam ederdi; OLE nesnesini Microsoft Word içinde düzenleyene veya güncelleyinceye kadar.
