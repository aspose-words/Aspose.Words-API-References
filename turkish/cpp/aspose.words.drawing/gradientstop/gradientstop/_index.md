---
title: "Aspose::Words::Drawing::GradientStop::GradientStop yapıcı"
linktitle: "GradientStop"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::GradientStop::GradientStop yapıcı. C++'ta GradientStop sınıfının yeni bir örneğini başlatır."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
## GradientStop::GradientStop(System::Drawing::Color, double) constructor


Yeni bir [GradientStop](../) sınıf örneği başlatır.
...
| --- | --- | --- |
| color | System::Drawing::Color | Gradient durak noktasının rengini temsil eder. |
| konum | double | Gradient içindeki bir durak noktasının konumunu yüzde olarak 0.0 ile 1.0 aralığında temsil eder. |
...
| color | System::Drawing::Color | Gradient durak noktasının rengini temsil eder. |
| konum | double | Gradient içindeki bir durak noktasının konumunu yüzde olarak 0.0 ile 1.0 aralığında temsil eder. |
| şeffaflık | double | Gradient içindeki bir durak noktasının şeffaflığını yüzde olarak 0.0 ile 1.0 aralığında temsil eder. |
