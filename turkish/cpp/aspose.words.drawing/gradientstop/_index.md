---
title: "Aspose::Words::Drawing::GradientStop sınıfı"
linktitle: "GradientStop"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::GradientStop sınıfı. Bir degrade durak noktasını temsil eder. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 2000
url: /tr/cpp/aspose.words.drawing/gradientstop/
---
## GradientStop class


Bir gradient durak noktasını temsil eder. Daha fazla bilgi için, [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/) dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [get_BaseColor](./get_basecolor/)() | Degrade durak noktasının rengini, herhangi bir değiştirici olmadan temsil eden bir değer alır. |
| [get_Color](./get_color/)() | Degrade durak noktasının rengini temsil eden bir değeri alır veya ayarlar. |
| [get_Position](./get_position/)() const | Degrade içinde bir durak noktasının konumunu, 0.0 ile 1.0 aralığında yüzde olarak ifade eden bir değeri alır veya ayarlar. |
| [get_Transparency](./get_transparency/)() const | Degrade dolgusunun şeffaflığını, 0.0 ile 1.0 aralığında yüzde olarak ifade eden bir değeri alır veya ayarlar. |
| [GetType](./gettype/)() const override |  |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double) | Yeni bir [GradientStop](./) sınıf örneği başlatır. |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double, double) | Yeni bir [GradientStop](./) sınıf örneği başlatır. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)() | Degrade durak noktasını üst [GradientStopCollection](../gradientstopcollection/) koleksiyonundan kaldırır. |
| [set_Color](./set_color/)(System::Drawing::Color) | [Aspose::Words::Drawing::GradientStop::get_Color](./get_color/) için ayarlayıcı. |
| [set_Position](./set_position/)(double) | [Aspose::Words::Drawing::GradientStop::get_Position](./get_position/) için ayarlayıcı. |
| [set_Transparency](./set_transparency/)(double) | [Aspose::Words::Drawing::GradientStop::get_Transparency](./get_transparency/) için ayarlayıcı. |
| static [Type](./type/)() |  |
