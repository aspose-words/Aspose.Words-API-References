---
title: "Aspose::Words::Drawing::GradientStop::get_Transparency yöntemi"
linktitle: "get_Transparency"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::GradientStop::get_Transparency yöntemi. Değişim doldurmanın şeffaflığını yüzde olarak 0.0 ile 1.0 aralığında temsil eden bir değeri alır veya ayarlar (C++)."
type: docs
weight: 5000
url: /tr/cpp/aspose.words.drawing/gradientstop/get_transparency/
---
## GradientStop::get_Transparency method


Degrade dolgusunun şeffaflığını, 0.0 ile 1.0 aralığında yüzde olarak ifade eden bir değeri alır veya ayarlar.
