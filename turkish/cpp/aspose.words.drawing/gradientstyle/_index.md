...
description: "Aspose::Words::Drawing::GradientStyle enum. C++'da bir degrade doldurma stilini belirtir."
type: docs
weight: 24000
url: /tr/cpp/aspose.words.drawing/gradientstyle/
---
## GradientStyle enum


Gradyan dolgu için stili belirtir.
...
| --- | --- | --- |
| None | -1 | Degrade yok. |
| Yatay | 1 | Nesne üzerinde yatay olarak akan degrade. |
| Dikey | 2 | Nesne üzerinde dikey olarak aşağı akan degrade. |
| DiagonalUp | 3 | Alt köşeden karşı köşeye doğru hareket eden diyagonal degrade. |
| DiagonalDown | 4 | Üst köşeden karşı köşeye aşağı doğru hareket eden diyagonal degrade. |
| FromCorner | 5 | Bir köşeden diğer üç köşeye doğru akan degrade. |
| FromCenter | 6 | Merkezden köşelere doğru yayılan degrade. |
