...
description: "Aspose::Words::Drawing::ShapeMarkupLanguage enum. C++'da şekil için kullanılan İşaretleme dilini belirtir."
type: docs
weight: 37000
url: /tr/cpp/aspose.words.drawing/shapemarkuplanguage/
---
## ShapeMarkupLanguage enum


Şekil için kullanılan [Markup](../../aspose.words.markup/) dilini belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| Dml | 0 | [Drawing](../)[Markup](../../aspose.words.markup/) Dili, şekli tanımlamak için kullanılır. |
| Vml | 1 | Vektör [Markup](../../aspose.words.markup/) Dili, şekli tanımlamak için kullanılır. |
