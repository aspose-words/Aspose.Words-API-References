...
description: "Aspose::Words::Drawing::GradientVariant enum. C++'da bir degrade dolgu için varyantı belirtir."
type: docs
weight: 25000
url: /tr/cpp/aspose.words.drawing/gradientvariant/
---
## GradientVariant enum


Gradyan dolgu için varyantı belirtir.
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| None | 0 | Degrade varyantı 'None'. |
| Variant1 | 1 | Degrade varyantı 1. |
| Variant2 | 2 | Degrade varyantı 2. |
| Variant3 | 3 | Degrade varyantı 3. |
| Variant4 | 4 | Degrade varyantı 4. |
