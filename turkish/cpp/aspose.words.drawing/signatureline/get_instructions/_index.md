---
title: "Aspose::Words::Drawing::SignatureLine::get_Instructions metodu"
linktitle: "get_Instructions"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::SignatureLine::get_Instructions metodu. İmzalama satırında imzalayan kişiye gösterilen talimatları alır veya ayarlar. Bu özellik, DefaultInstructions ayarlanmışsa yoksayılır. Bu özelliğin varsayılan değeri C++'da boş dizedir."
type: docs
weight: 6000
url: /tr/cpp/aspose.words.drawing/signatureline/get_instructions/
---
## SignatureLine::get_Instructions method


İmzalama satırında imzalayan kişiye gösterilen talimatları alır veya ayarlar. Bu özellik, [DefaultInstructions](../get_defaultinstructions/) ayarlanmışsa yoksayılır. Bu özelliğin varsayılan değeri **empty string**.
