---
title: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle metodu"
linktitle: "get_SignerTitle"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::SignatureLine::get_SignerTitle metodu. Önerilen imzalayanın unvanını alır veya ayarlar (örneğin, Manager). Bu özelliğin varsayılan değeri C++'da boş dizedir."
type: docs
weight: 12000
url: /tr/cpp/aspose.words.drawing/signatureline/get_signertitle/
---
## SignatureLine::get_SignerTitle method


Önerilen imzalayanın unvanını (örneğin, Manager) alır veya ayarlar. Bu özelliğin varsayılan değeri **empty string**.
