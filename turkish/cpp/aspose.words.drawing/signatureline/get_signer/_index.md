---
title: "Aspose::Words::Drawing::SignatureLine::get_Signer metodu"
linktitle: "get_Signer"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Drawing::SignatureLine::get_Signer metodu. İmza satırının önerilen imzacısını alır veya ayarlar. Bu özelliğin varsayılan değeri C++'ta boş bir dizedir."
type: docs
weight: 11000
url: /tr/cpp/aspose.words.drawing/signatureline/get_signer/
---
## SignatureLine::get_Signer method


İmza satırının önerilen imzalayanını alır veya ayarlar. Bu özelliğin varsayılan değeri **empty string**.
