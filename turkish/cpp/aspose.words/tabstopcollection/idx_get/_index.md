---
title: "Aspose::Words::TabStopCollection::idx_get yöntemi"
linktitle: "idx_get"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::TabStopCollection::idx_get yöntemi. C++'ta belirtilen konumdaki sekme durağını alır."
type: docs
weight: 12000
url: /tr/cpp/aspose.words/tabstopcollection/idx_get/
---
## TabStopCollection::idx_get(double) method


Belirtilen konumdaki bir sekme durak noktasını alır.
...
| --- | --- | --- |
| konum | double | Sekme durağının konumu (nokta cinsinden). |
...
Verilen dizindeki bir sekme durak noktasını alır.
