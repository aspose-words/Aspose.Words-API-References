...
description: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent method. İlk satır veya sarkıt girinti için değeri (karakter cinsinden) alır veya ayarlar. İlk satır girintisini ayarlamak için pozitif değerler, sarkıt girintisini ayarlamak için negatif değerler kullanın C++'ta."
type: docs
weight: 8000
url: /tr/cpp/aspose.words/paragraphformat/get_characterunitfirstlineindent/
---
## ParagraphFormat::get_CharacterUnitFirstLineIndent method


İlk satır veya sarkıt girinti için değeri (karakter cinsinden) alır veya ayarlar. İlk satır girintisini ayarlamak için pozitif değerleri, sarkıt girintisini ayarlamak için negatif değerleri kullanın.
