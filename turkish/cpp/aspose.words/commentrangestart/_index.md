---
title: "Aspose::Words::CommentRangeStart sınıfı"
linktitle: "CommentRangeStart"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::CommentRangeStart sınıfı. Yorumla ilişkili bir metin bölgesinin başlangıcını belirtir. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 14000
url: /tr/cpp/aspose.words/commentrangestart/
---
## CommentRangeStart class


Yorumla ilişkili bir metin bölgesinin başlangıcını belirtir. Daha fazla bilgi edinmek için [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/) dokümantasyon makalesini ziyaret edin.
...
| [CommentRangeStart](./commentrangestart/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | Bu sınıfın yeni bir örneğini başlatır. |
...
| [get_NodeType](./get_nodetype/)() const override | Döndürür [CommentRangeStart](../nodetype/). |
...
Metnin bir bölgesine bağlanan bir yorum oluşturmak için, bir [Comment](../comment/) oluşturmanız ve ardından [CommentRangeStart](./) ve [CommentRangeEnd](../commentrangeend/) oluşturmanız ve tanımlayıcılarını aynı [Id](../comment/get_id/) değerine ayarlamanız gerekir.
