...
description: "Aspose::Words::ConditionalStyleType enum. C++'ta bir tablo stilinde koşullu biçimlendirme tanımlanabilecek olası tablo alanlarını temsil eder."
type: docs
weight: 85000
url: /tr/cpp/aspose.words/conditionalstyletype/
---
...
| Ad | Değer | Açıklama |
| --- | --- | --- |
| FirstRow | 0 | Bir tablonun ilk satırının biçimlendirilmesini belirtir. |
| FirstColumn | 1 | Bir tablonun ilk sütununun biçimlendirilmesini belirtir. |
| LastRow | 2 | Bir tablonun son satırının biçimlendirilmesini belirtir. |
| LastColumn | 3 | Bir tablonun son sütununun biçimlendirilmesini belirtir. |
| OddRowBanding | 4 | Tek sayılı satır şeridinin biçimlendirilmesini belirtir. |
| OddColumnBanding | 5 | Tek sayılı sütun şeridinin biçimlendirilmesini belirtir. |
| EvenRowBanding | 6 | Çift sayılı satır şeridinin biçimlendirilmesini belirtir. |
| EvenColumnBanding | 7 | Çift numaralı sütun şeridinin biçimlendirmesini belirtir. |
