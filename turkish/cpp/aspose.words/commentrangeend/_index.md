...
description: "Aspose::Words::CommentRangeEnd sınıfı. Yorumla ilişkili bir metin bölgesinin sonunu gösterir. Daha fazla bilgi edinmek için C++'daki dokümantasyon makalesini ziyaret edin."
type: docs
weight: 13000
url: /tr/cpp/aspose.words/commentrangeend/
---
## CommentRangeEnd class


Yorumla ilişkili bir metin bölgesinin sonunu belirtir. Daha fazla bilgi edinmek için [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/) dokümantasyon makalesini ziyaret edin.
...
| [CommentRangeEnd](./commentrangeend/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | Bu sınıfın yeni bir örneğini başlatır. |
...
| [get_Id](./get_id/)() const | Bu bölgenin bağlı olduğu yorumun tanımlayıcısını belirtir. |
...
| [get_NodeType](./get_nodetype/)() const override | Döndürür [CommentRangeEnd](../nodetype/). |
...
| [set_Id](./set_id/)(int32_t) | Bu bölgenin bağlı olduğu yorumun tanımlayıcısını belirtir. |
...
Metin bölgesine bağlı bir yorum oluşturmak için bir [Comment](../comment/) oluşturmalı, ardından [CommentRangeStart](../commentrangestart/) ve [CommentRangeEnd](./) oluşturup, tanımlayıcılarını aynı [Id](../comment/get_id/) değerine ayarlamalısınız.
