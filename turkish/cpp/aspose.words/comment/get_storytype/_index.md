---
title: "Aspose::Words::Comment::get_StoryType metodu"
linktitle: "get_StoryType"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Comment::get_StoryType metodu. C++'da Yorumları döndürür."
type: docs
weight: 13000
url: /tr/cpp/aspose.words/comment/get_storytype/
---
## Comment::get_StoryType method


[Comments](../../storytype/) döndürür.
...
[InlineStory](../../inlinestory/) düğümlerinin nasıl ekleneceğini gösterir.
```cpp
