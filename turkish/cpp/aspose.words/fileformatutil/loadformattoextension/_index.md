...
description: "Aspose::Words::FileFormatUtil::LoadFormatToExtension method. Bir yük formatı numaralandırılmış değerini dosya uzantısına dönüştürür. Döndürülen uzantı, C++'da başında nokta olan küçük harfli bir dizedir."
type: docs
weight: 6000
url: /tr/cpp/aspose.words/fileformatutil/loadformattoextension/
---
## FileFormatUtil::LoadFormatToExtension method


Bir yükleme formatı enum değerini bir dosya uzantısına dönüştürür. Döndürülen uzantı, başında nokta bulunan küçük harfli bir dizedir.
