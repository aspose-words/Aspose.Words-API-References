...
description: "Aspose::Words::ConvertUtil::PointToPixel yöntemi. C++'ta 96 dpi'de puanları piksele dönüştürür."
type: docs
weight: 6000
url: /tr/cpp/aspose.words/convertutil/pointtopixel/
---
## ConvertUtil::PointToPixel(double) method


Puanları 96 dpi'de piksellere dönüştürür.
...
| --- | --- | --- |
| puanlar | double | Dönüştürülecek değer. |
...
Puanları belirtilen piksel çözünürlüğünde piksellere dönüştürür.
