---
title: "Aspose::Words::BorderCollection::get_Horizontal yöntemi"
linktitle: "get_Horizontal"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::BorderCollection::get_Horizontal yöntemi. C++'da hücreler veya uyumlu paragraflar arasındaki yatay kenarlığı alır."
type: docs
weight: 8000
url: /tr/cpp/aspose.words/bordercollection/get_horizontal/
---
## BorderCollection::get_Horizontal method


Hücreler veya uyumlu paragraflar arasında kullanılan yatay kenarı alır.
...
Bir paragrafın biçimine yatay kenarlıklara ayarların nasıl uygulanacağını gösterir.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);

// Paragraf için kırmızı yatay bir kenarlık oluşturun. Daha sonra oluşturulan tüm paragraflar bu kenarlık ayarlarını devralacaktır.
...
// Metni belgeye yeni bir paragraf oluşturmadan yazın.
// Altında paragraf olmadığı için yatay kenarlık görünür olmayacaktır.
builder->Write(u"Paragraph above horizontal border.");

// İkinci bir paragraf eklediğimizde, ilk paragrafın kenarlığı görünür hale gelecektir.
