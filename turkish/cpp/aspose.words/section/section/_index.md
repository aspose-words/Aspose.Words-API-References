...
description: "Aspose::Words::Section::Section constructor. C++'ta Section sınıfının yeni bir örneğini başlatır."
type: docs
weight: 2000
url: /tr/cpp/aspose.words/section/section/
---
...
Bölüm oluşturulduğunda, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değildir ve [ParentNode](../../node/get_parentnode/) **null**'dır.

Bir belgeye [Section](../) eklemek için [Document](../../document/) yöntemlerinden [InsertAfter1()</see> ve <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) yöntemlerini veya [Sections](../../document/get_sections/) özelliğinin [Add()](../) ve [Insert()](../) yöntemlerini kullanın.
