...
description: "Aspose::Words::RevisionType enum. Revision'da C++ içinde izlenen değişiklik türünü belirtir."
type: docs
weight: 113000
url: /tr/cpp/aspose.words/revisiontype/
---
## RevisionType enum


İzlenen değişiklik türünü [Revision](../revision/) içinde belirtir.
...
| FormatChange | 2 | Biçimlendirme değişikliği üst düğüme uygulandı. |
| StyleDefinitionChange | 3 | Biçimlendirme değişikliği üst stile uygulandı. |
| Taşıma | 4 | İçerik belgede taşındı. |
