---
title: "Aspose::Words::Revision::get_ParentNode yöntemi"
linktitle: "get_ParentNode"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Revision::get_ParentNode yöntemi. Bu revizyonun doğrudan üst düğümünü (sahibini) alır. Bu özellik, C++'ta StyleDefinitionChange dışındaki tüm revizyon türleri için çalışır."
type: docs
weight: 6000
url: /tr/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


Bu revizyonun doğrudan üst düğümünü (sahibini) alır. Bu özellik, [StyleDefinitionChange](../../revisiontype/) dışındaki tüm revizyon türleri için çalışır.
