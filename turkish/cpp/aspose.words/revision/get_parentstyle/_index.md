...
description: "Aspose::Words::Revision::get_ParentStyle method. Bu revizyonun doğrudan üst stilini (sahibini) alır. Bu özellik yalnızca C++'ta StyleDefinitionChange revizyon tipi için çalışır."
type: docs
weight: 7000
url: /tr/cpp/aspose.words/revision/get_parentstyle/
---
## Revision::get_ParentStyle method


Bu revizyonun doğrudan üst stilini (sahibini) alır. Bu özellik yalnızca [StyleDefinitionChange](../../revisiontype/) revizyon tipi için çalışır.
