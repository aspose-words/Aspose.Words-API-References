...
description: "Aspose::Words::TextWatermarkOptions::get_IsSemitrasparent yöntemi. Filigranın opaklığından sorumlu olan bir boolean değeri alır veya ayarlar. Varsayılan değer C++'ta true'dur."
type: docs
weight: 6000
url: /tr/cpp/aspose.words/textwatermarkoptions/get_issemitrasparent/
---
## TextWatermarkOptions::get_IsSemitrasparent method


Filigranın opaklığından sorumlu bir boolean değeri alır veya ayarlar. Varsayılan değer **true**'dır.
