---
title: "Aspose::Words::RunCollection sınıfı"
linktitle: "RunCollection"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::RunCollection sınıfı. Run düğümlerinin bir koleksiyonuna tip güvenli erişim sağlar. Daha fazla bilgi edinmek için C++'daki belge makalesini ziyaret edin."
type: docs
weight: 57000
url: /tr/cpp/aspose.words/runcollection/
---
## RunCollection class


Run düğümlerinin bir koleksiyonuna tip güvenli erişim sağlar. Daha fazla bilgi edinmek için [Programming with Documents](https://docs.aspose.com/words/cpp/programming-with-documents/) belge makalesini ziyaret edin.
...
| [idx_get](./idx_get/)(int32_t) | Verilen indeksdeki bir [Run](../run/) öğesini alır. |
...
| [ToArray](./toarray/)() | Koleksiyondaki tüm run'ları yeni bir run dizisine kopyalar. |
| static [Type](./type/)() |  |
