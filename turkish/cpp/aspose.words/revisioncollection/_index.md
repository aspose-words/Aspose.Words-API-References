...
description: "Aspose::Words::RevisionCollection class. Belgedeki revizyonları temsil eden Revision nesnelerinin bir koleksiyonudur. Daha fazla bilgi için C++ belgelerindeki makaleyi ziyaret edin."
type: docs
weight: 53000
url: /tr/cpp/aspose.words/revisioncollection/
---
## RevisionCollection class


Belgedeki revizyonları temsil eden [Revision](../revision/) nesnelerinin bir koleksiyonu. Daha fazla bilgi için [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/) belgelerindeki makaleyi ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [Accept](./accept/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Belirtilen kriterlere uyan revizyonları kabul eder. |
| [AcceptAll](./acceptall/)() | Bu koleksiyondaki tüm revizyonları kabul eder. |
| [get_Count](./get_count/)() | Koleksiyondaki revizyon sayısını döndürür. |
| [get_Groups](./get_groups/)() | Revizyon gruplarının koleksiyonu. |
| [GetEnumerator](./getenumerator/)() override | Bir enumeratör nesnesi döndürür. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Belirtilen indeksteki bir [Revision](../revision/) döndürür. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Belirtilen kriterlere uyan revizyonları reddeder. |
| [RejectAll](./rejectall/)() | Bu koleksiyondaki tüm revizyonları reddeder. |
| static [Type](./type/)() |  |
## Açıklamalar


Bu sınıfın örneklerini doğrudan oluşturmazsınız. Bir belgede mevcut revizyonları almak için [Revisions](../document/get_revisions/) özelliğini kullanın.
