---
title: "Aspose::Words::Font::get_ThemeFontAscii yöntemi"
linktitle: "get_ThemeFontAscii"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Font::get_ThemeFontAscii yöntemi. Uygulanan yazı tipi şemasında, bu Font nesnesiyle ilişkili, Latin metni (karakter kodları 0 (sıfır) ile 127 arasında) için kullanılan tema yazı tipini alır veya ayarlar."
type: docs
weight: 50000
url: /tr/cpp/aspose.words/font/get_themefontascii/
---
## Font::get_ThemeFontAscii method


Uygulanan yazı tipi şemasında, bu [Font](../) nesnesiyle ilişkili, Latin metni (karakter kodları 0 (sıfır) ile 127 arasında) için kullanılan tema yazı tipini alır veya ayarlar.
