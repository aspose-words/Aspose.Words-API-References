---
title: "Aspose::Words::VariableCollection::Add yöntemi"
linktitle: "Add"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::VariableCollection::Add yöntemi. C++'de bir belge değişkenini koleksiyona ekler."
type: docs
weight: 2000
url: /tr/cpp/aspose.words/variablecollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Eklenecek değişkenin büyük/küçük harfe duyarsız adı. |
| value | const System::String\& | Değişkenin değeri. Değer **null** olamaz, değer null ise boş bir dize kullanılacaktır. |
