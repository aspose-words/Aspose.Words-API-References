---
title: "Aspose::Words::SignatureLineOptions::get_Instructions metodu"
linktitle: "get_Instructions"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::SignatureLineOptions::get_Instructions metodu. İmzalama satırını imzalarken imzalayana gösterilen talimatları alır veya ayarlar. Bu özelliğin varsayılan değeri C++'da boş bir dizedir."
type: docs
weight: 6000
url: /tr/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


İmza satırını imzalarken imzalayana gösterilen talimatları alır veya ayarlar. Bu özelliğin varsayılan değeri **empty string**.
