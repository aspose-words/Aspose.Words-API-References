---
title: "Aspose::Words::Document::get_TrackRevisions metodu"
linktitle: "get_TrackRevisions"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Document::get_TrackRevisions metodu. C++'ta bu belge Microsoft Word'de düzenlendiğinde değişiklikler izleniyorsa doğru."
type: docs
weight: 54000
url: /tr/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


Bu belge Microsoft Word'de düzenlendiğinde değişiklikler izleniyorsa doğru.
...
Bu seçeneği ayarlamak yalnızca Microsoft Word'e değişiklik izleme özelliğinin açık mı kapalı mı olduğunu bildirir. Bu özellik, Aspose.Words aracılığıyla programlı olarak yaptığınız belge değişikliklerini etkilemez.

Bu belgeye [Aspose.Words](../../) tarafından programlı olarak yapılan değişiklikleri otomatik olarak izlemek istiyorsanız, [StartTrackRevisions()](../) metodunu kullanın.
