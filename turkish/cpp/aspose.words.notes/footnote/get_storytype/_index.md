---
title: "Aspose::Words::Notes::Footnote::get_StoryType yöntemi"
linktitle: "get_StoryType"
second_title: "C++ için Aspose.Words API Referansı"
description: "Aspose::Words::Notes::Footnote::get_StoryType yöntemi. C++'ta Footnotes veya Endnotes döndürür."
type: docs
weight: 8000
url: /tr/cpp/aspose.words.notes/footnote/get_storytype/
---
## Footnote::get_StoryType method


Döndürür [Footnotes](../../../aspose.words/storytype/) veya [Endnotes](../../../aspose.words/storytype/).
...
[InlineStory](../../../aspose.words/inlinestory/) düğümlerinin nasıl ekleneceğini gösterir.
```cpp
