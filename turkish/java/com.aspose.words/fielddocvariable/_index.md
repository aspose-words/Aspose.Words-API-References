...
description: "Java'da DOCVARIABLE alanını uygular."
type: docs
weight: 225
url: /tr/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | Alınacak belge değişkeninin adını alır. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Alınacak belge değişkeninin adını ayarlar. |
...
Alınacak belge değişkeninin adını alır.
...
**Returns:**
java.lang.String - Alınacak belge değişkeninin adı.
### isDirty() {#isDirty}
```
...
Alınacak belge değişkeninin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alınacak belge değişkeninin adı. |
