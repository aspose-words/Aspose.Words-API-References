...
description: "Java'da bir takvim türünü belirtir."
type: docs
weight: 58
url: /tr/java/com.aspose.words/calendartype/
---
...
Bir takvim türünü belirtir.

 **Examples:** 

Alanlar güncellendiğinde alan sonuçlarına özel bir biçim otomatik olarak nasıl uygulanacağını gösterir.
...
| Alan | Açıklama |
| --- | --- |
| [GREGORIAN](#GREGORIAN) | Gregoryen takvim. |
| [HEBREW](#HEBREW) | İbrani Ay takvimi. |
| [HIJRI](#HIJRI) | Hicri Ay takvimi. |
| [SAKA_ERA](#SAKA-ERA) | Saka Dönemi takvimi. |
| [UM_AL_QURA](#UM-AL-QURA) | Um-al-Qura takvimi. |
| [length](#length) |  |
## Yöntemler
