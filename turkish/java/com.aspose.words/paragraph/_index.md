...
description: "Java'da bir metin paragrafını temsil eder."
type: docs
weight: 522
url: /tr/java/com.aspose.words/paragraph/
---
...
Bir paragraf içinde oluşabilecek alt düğümlerin tam listesi şunları içerir: [BookmarkStart](../../com.aspose.words/bookmarkstart/), [BookmarkEnd](../../com.aspose.words/bookmarkend/), [FieldStart](../../com.aspose.words/fieldstart/), [FieldSeparator](../../com.aspose.words/fieldseparator/), [FieldEnd](../../com.aspose.words/fieldend/), [FormField](../../com.aspose.words/formfield/), [Comment](../../com.aspose.words/comment/), [Footnote](../../com.aspose.words/footnote/), [Run](../../com.aspose.words/run/), [SpecialChar](../../com.aspose.words/specialchar/), [Shape](../../com.aspose.words/shape/), [GroupShape](../../com.aspose.words/groupshape/), [SmartTag](../../com.aspose.words/smarttag/).

Microsoft Word'de geçerli bir paragraf her zaman bir paragraf sonu karakteriyle biter ve en minimal geçerli paragraf sadece bir paragraf sonundan oluşur. [Paragraph](../../com.aspose.words/paragraph/) sınıfı, sonuna uygun paragraf sonu karakterini otomatik olarak ekler ve bu karakter, [Paragraph](../../com.aspose.words/paragraph/) alt düğümlerinin bir parçası değildir; bu nedenle bir [Paragraph](../../com.aspose.words/paragraph/) boş olabilir.

Paragraf metni içinde paragraf sonu [ControlChar.PARAGRAPH\_BREAK](../../com.aspose.words/controlchar/\#PARAGRAPH-BREAK) veya hücre sonu [ControlChar.CELL](../../com.aspose.words/controlchar/\#CELL) karakterlerini eklemeyin; bu karakterler belge Microsoft Word'de açıldığında paragrafı geçersiz kılabilir.
...
| Yapıcı | Açıklama |
| --- | --- |
| [Paragraph(DocumentBase doc)](#Paragraph-com.aspose.words.DocumentBase) | Yeni bir [Paragraph](../../com.aspose.words/paragraph/) sınıfı örneği başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [accept(DocumentVisitor visitor)](#accept-com.aspose.words.DocumentVisitor) | Bir ziyaretçiyi kabul eder. |
| [acceptEnd(DocumentVisitor visitor)](#acceptEnd-com.aspose.words.DocumentVisitor) | Belgenin paragrafının sonunu ziyaret etmek için bir ziyaretçiyi kabul eder. |
| [acceptStart(DocumentVisitor visitor)](#acceptStart-com.aspose.words.DocumentVisitor) | Belgenin paragrafının başlangıcını ziyaret etmek için bir ziyaretçiyi kabul eder. |
...
| [appendField(String fieldCode)](#appendField-java.lang.String) | Bu paragrafa bir alan ekler. |
| [appendField(String fieldCode, String fieldValue)](#appendField-java.lang.String-java.lang.String) | Bu paragrafa bir alan ekler. |
...
| [getBreakIsStyleSeparator()](#getBreakIsStyleSeparator) | Bu paragraf sonu bir Stil Ayırıcı ise doğru. |
...
| [getEffectiveTabStops()](#getEffectiveTabStops) | Stiller veya listeler tarafından dolaylı olarak uygulananlar da dahil olmak üzere bu paragrafa uygulanan tüm sekme duraklarının dizisini döndürür. |
| [getFirstChild()](#getFirstChild) | Düğümün ilk alt öğesini alır. |
| [getFrameFormat()](#getFrameFormat) | Çerçeve biçimlendirme özelliklerine erişim sağlar. |
| [getLastChild()](#getLastChild) | Düğümün son alt öğesini alır. |
| [getListFormat()](#getListFormat) | Paragrafın liste biçimlendirme özelliklerine erişim sağlar. |
| [getListLabel()](#getListLabel) | Bu paragraf için liste numaralandırma değeri ve biçimlendirmesine erişim sağlayan bir [getListLabel()](../../com.aspose.words/paragraph/\#getListLabel) nesnesi alır. |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node) |  |
| [getNextSibling()](#getNextSibling) | Bu düğümü hemen izleyen düğümü alır. |
| [getNodeType()](#getNodeType) | [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH) döndürür. |
| [getParagraphBreakFont()](#getParagraphBreakFont) | Paragraf sonu karakterinin yazı tipi biçimlendirmesine erişim sağlar. |
| [getParagraphFormat()](#getParagraphFormat) | Paragraf biçimlendirme özelliklerine erişim sağlar. |
| [getParentNode()](#getParentNode) | Bu düğümün hemen üst ebeveynini alır. |
| [getParentSection()](#getParentSection) | Paragrafın üst [Section](../../com.aspose.words/section/) öğesini alır. |
| [getParentStory()](#getParentStory) | Üst bölüm seviyesindeki hikayeyi alır; bu, [Body](../../com.aspose.words/body/) veya [HeaderFooter](../../com.aspose.words/headerfooter/) olabilir. |
...
| [getRuns()](#getRuns) | Paragraf içindeki metin parçalarının tiplenmiş koleksiyonuna erişim sağlar. |
| [getText()](#getText) | Paragraf sonu karakteri dahil bu paragrafın metnini alır. |
...
| [insertField(String fieldCode, Node refNode, boolean isAfter)](#insertField-java.lang.String-com.aspose.words.Node-boolean) | Bu paragraf içine bir alan ekler. |
| [insertField(String fieldCode, String fieldValue, Node refNode, boolean isAfter)](#insertField-java.lang.String-java.lang.String-com.aspose.words.Node-boolean) | Bu paragraf içine bir alan ekler. |
| [isComposite()](#isComposite) | Bu düğümün alt düğüm alabileceği için  true  döndürür. |
| [isDeleteRevision()](#isDeleteRevision) | Değişiklik izleme etkinken bu nesne Microsoft Word'de silinmişse true döndürür. |
| [isEndOfCell()](#isEndOfCell) | Bu paragraf bir [Cell](../../com.aspose.words/cell/) içindeki son paragraf ise doğru; aksi takdirde yanlış. |
| [isEndOfDocument()](#isEndOfDocument) | Bu paragraf belgenin son bölümündeki son paragraf ise doğru. |
| [isEndOfHeaderFooter()](#isEndOfHeaderFooter) | Bu paragraf bir [Section](../../com.aspose.words/section/) içindeki [HeaderFooter](../../com.aspose.words/headerfooter/) (ana metin hikayesi) içinde son paragraf ise doğru; aksi takdirde yanlış. |
| [isEndOfSection()](#isEndOfSection) | Bu paragraf bir [Section](../../com.aspose.words/section/) içindeki [Body](../../com.aspose.words/body/) (ana metin hikayesi) içinde son paragraf ise doğru; aksi takdirde yanlış. |
| [isFormatRevision()](#isFormatRevision) | Değişiklik izleme etkinken nesnenin biçimlendirmesi Microsoft Word'de değiştirilmişse true döndürür. |
| [isInCell()](#isInCell) | Bu paragraf bir [Cell](../../com.aspose.words/cell/) öğesinin doğrudan çocuğu ise doğru; aksi takdirde yanlış. |
| [isInsertRevision()](#isInsertRevision) | Değişiklik izleme etkinken bu nesne Microsoft Word'e eklenmişse true döndürür. |
| [isListItem()](#isListItem) | Paragraf orijinal revizyonda madde işaretli veya numaralı bir listede bir öğe olduğunda doğru. |
| [isMoveFromRevision()](#isMoveFromRevision) | Değişiklik izleme etkinken bu nesne Microsoft Word'de taşınmış (silinmiş) ise  true  döndürür. |
| [isMoveToRevision()](#isMoveToRevision) | Değişiklik izleme etkinken bu nesne Microsoft Word'de taşınmış (eklenmiş) ise  true  döndürür. |
| [iterator()](#iterator) | Bu düğümün alt düğümleri üzerinde foreach tarzı yineleme desteği sağlar. |
| [joinRunsWithSameFormatting()](#joinRunsWithSameFormatting) | Paragrafta aynı biçimlendirmeye sahip koşulları birleştirir. |
| [joinRunsWithSameFormatting(JoinRunsOptions options)](#joinRunsWithSameFormatting-com.aspose.words.JoinRunsOptions) | Paragrafta aynı biçimlendirmeye sahip koşulları birleştirir. |
...
Yeni bir [Paragraph](../../com.aspose.words/paragraph/) sınıfı örneği başlatır.

 **Remarks:** 

[Paragraph](../../com.aspose.words/paragraph/) oluşturulduğunda, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değildir ve [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) null'dur.

Belgeye bir [Paragraph](../../com.aspose.words/paragraph/) eklemek için, paragrafın eklenmesini istediğiniz hikayede [CompositeNode.insertAfter(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertAfter-com.aspose.words.Node--com.aspose.words.Node) veya [CompositeNode.insertBefore(com.aspose.words.Node, com.aspose.words.Node)](../../com.aspose.words/compositenode/\#insertBefore-com.aspose.words.Node--com.aspose.words.Node) kullanın.
...
[DocumentVisitor.visitParagraphStart(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/\#visitParagraphStart-com.aspose.words.Paragraph) çağrılır, ardından paragrafın tüm alt düğümleri için [Node.accept(com.aspose.words.DocumentVisitor)](../../com.aspose.words/node/\#accept-com.aspose.words.DocumentVisitor) çağrılır ve sonunda [DocumentVisitor.visitParagraphEnd(com.aspose.words.Paragraph)](../../com.aspose.words/documentvisitor/\#visitParagraphEnd-com.aspose.words.Paragraph) çağrılır.
...
Belgenin paragrafının sonunu ziyaret etmek için bir ziyaretçiyi kabul eder.
...
Belgenin paragrafının başlangıcını ziyaret etmek için bir ziyaretçiyi kabul eder.
...
Bir paragrafın sonuna alan eklemenin çeşitli yollarını gösterir.
...
| --- | --- | --- |
| fieldCode | java.lang.String | Eklenecek alan kodu (küme parantezleri olmadan). |
| fieldValue | java.lang.String | Eklenecek alan değeri. Değeri olmayan alanlar için `null` geçin. |
...
Bu paragraf sonu bir Stil Ayırıcı ise True. Stil ayırıcı, bir paragrafın farklı paragraf stillerine sahip bölümlerden oluşmasını sağlar.

 **Examples:** 

Bir TOC başlığıyla aynı satıra metin yazmayı ve bunun TOC'da görünmemesini gösterir.
...
Bu paragraf için liste numaralandırma değeri ve biçimlendirmesine erişim sağlayan bir [getListLabel()](../../com.aspose.words/paragraph/\#getListLabel) nesnesi alır.
...
[NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH) döndürür.
...
**Returns:**
int - [NodeType.PARAGRAPH](../../com.aspose.words/nodetype/\#PARAGRAPH). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
...
Paragraf sonu karakterinin yazı tipi biçimlendirmesine erişim sağlar.
...
Paragrafın üst [Section](../../com.aspose.words/section/) öğesini alır.
...
Üst bölüm seviyesindeki hikayeyi alır; bu, [Body](../../com.aspose.words/body/) veya [HeaderFooter](../../com.aspose.words/headerfooter/) olabilir.
...
Paragraf içindeki metin parçalarının tiplenmiş koleksiyonuna erişim sağlar.
...
Bu paragraf içine bir alan ekler.

 **Examples:** 

Bir paragrafın içine alan eklemenin çeşitli yollarını gösterir.
...
| --- | --- | --- |
| fieldCode | java.lang.String | Eklenecek alan kodu (küme parantezleri olmadan). |
| refNode | [Node](../../com.aspose.words/node/) | Bu paragraftaki referans düğümü (eğer `refNode` `null` ise, paragrafın sonuna ekler). |
| isAfter | boolean | Alanı referans düğümünden sonra mı yoksa önce mi ekleyeceği. |
...
Değişiklik izleme etkinken bu nesne Microsoft Word'de silinmişse true döndürür.
...
**Returns:**
boolean - Değişiklik izleme etkinken bu nesne Microsoft Word'de silinmişse true.
...
Bu paragraf bir [Cell](../../com.aspose.words/cell/) içindeki son paragraf ise doğru; aksi takdirde yanlış.
...
Bu paragraf bir [Section](../../com.aspose.words/section/) içindeki [HeaderFooter](../../com.aspose.words/headerfooter/) (ana metin hikayesi) içinde son paragraf ise doğru; aksi takdirde yanlış.
...
Bu paragraf bir [Section](../../com.aspose.words/section/) içindeki [Body](../../com.aspose.words/body/) (ana metin hikayesi) içinde son paragraf ise doğru; aksi takdirde yanlış.
...
Değişiklik izleme etkinken nesnenin biçimlendirmesi Microsoft Word'de değiştirilmişse true döndürür.

 **Examples:** 

Bir paragrafın format revizyonu olup olmadığını nasıl kontrol edeceğinizi gösterir.
...
**Returns:**
boolean - Değişiklik izleme etkinken nesnenin biçimlendirmesi Microsoft Word'de değiştirilmişse true.
### isInCell() {#isInCell}
```
...
Bu paragraf bir [Cell](../../com.aspose.words/cell/) öğesinin doğrudan çocuğu ise doğru; aksi takdirde yanlış.
...
Değişiklik izleme etkinken bu nesne Microsoft Word'e eklenmişse true döndürür.
...
**Returns:**
boolean - Değişiklik izleme etkinken bu nesne Microsoft Word'e eklenmişse true.
...
Değişiklik izleme etkinken bu nesne Microsoft Word'de taşınmış (silinmiş) ise  true  döndürür.
...
**Returns:**
boolean -  true  eğer bu nesne Microsoft Word'de taşınmış (silinmiş) ise.
...
Değişiklik izleme etkinken bu nesne Microsoft Word'de taşınmış (eklenmiş) ise  true  döndürür.
...
**Returns:**
boolean -  true  eğer bu nesne Microsoft Word'de değişiklik izleme etkinken taşındıysa (eklenmişse).
### iterator() {#iterator}
```
...
Paragrafta aynı biçimlendirmeye sahip koşulları birleştirir.

 **Examples:** 

Gereksiz koşuları birleştirerek paragrafları nasıl basitleştireceğinizi gösterir.
...
**Returns:**
int - Gerçekleştirilen birleştirme sayısı. **N** ardışık koşu birleştirildiğinde, **N - 1** birleştirme olarak sayılır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| options | [JoinRunsOptions](../../com.aspose.words/joinrunsoptions/) | Ek seçenekler |
