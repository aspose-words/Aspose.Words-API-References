...
description: "Java'da atanmış tablo stiliyle bir tablo alanına uygulanan özel biçimlendirmeyi temsil eder."
type: docs
weight: 123
url: /tr/java/com.aspose.words/conditionalstyle/
---
...
Atanan tablo stiliyle bir tablo alanına uygulanan özel biçimlendirmeyi temsil eder.
...
| [equals(Object obj)](#equals-java.lang.Object) | Bu koşullu stili belirtilen nesneyle karşılaştırır. |
...
| [getBorders()](#getBorders) | Koşullu stil için varsayılan hücre kenarlıklarının koleksiyonunu alır. |
...
| [getFont()](#getFont) | Koşullu stilin karakter biçimlendirmesini alır. |
| [getLeftPadding()](#getLeftPadding) | Tablo hücrelerinin içeriğinin soluna eklenecek boşluk miktarını (puan cinsinden) alır. |
| [getParagraphFormat()](#getParagraphFormat) | Koşullu stilin paragraf biçimlendirmesini alır. |
| [getRightPadding()](#getRightPadding) | Tablo hücrelerinin içeriğinin sağına eklenecek boşluk miktarını (puan cinsinden) alır. |
| [getShading()](#getShading) | Bu koşullu stil için gölgelendirme biçimlendirmesine referans veren bir [Shading](../../com.aspose.words/shading/) nesnesini alır. |
| [getTopPadding()](#getTopPadding) | Tablo hücrelerinin içeriğinin üstüne eklenecek boşluk miktarını (puan cinsinden) alır. |
| [getType()](#getType) | Bu koşullu stilin ilişkili olduğu tablo alanını alır. |
| [hashCode()](#hashCode) |  |
...
Bu koşullu stili belirtilen nesneyle karşılaştırır.
...
Koşullu stil için varsayılan hücre kenarlıklarının koleksiyonunu alır.
...
Koşullu stilin karakter biçimlendirmesini alır.
...
Bu koşullu stil için gölgelendirme biçimlendirmesine referans veren bir [Shading](../../com.aspose.words/shading/) nesnesini alır.
...
**Returns:**
int - Bu koşullu stilin ilişkili olduğu tablo alanı. Döndürülen değer, [ConditionalStyleType](../../com.aspose.words/conditionalstyletype/) sabitlerinden biridir.
### hashCode() {#hashCode}
```
public int hashCode()
```
