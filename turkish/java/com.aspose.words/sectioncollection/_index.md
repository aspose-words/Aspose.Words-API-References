...
description: "Java'da belgede bulunan Section nesnelerinin bir koleksiyonu."
type: docs
weight: 606
url: /tr/java/com.aspose.words/sectioncollection/
---
...
Belgedeki [Section](../../com.aspose.words/section/) nesnelerinin bir koleksiyonu.
...
Bölümlerin programlı olarak eklenmesi ve kaldırılması, posta birleştirme sırasında oluşturulan belgeleri özelleştirmek için kullanılabilir. Bir belgenin bazı kriterlere bağlı olarak farklı içeriklere veya içerik bölümlerine sahip olması gerekiyorsa, birden fazla bölüm içeren bir \"ana\" belge oluşturabilir ve posta birleştirmeden önce veya sonra bazı bölümleri silebilirsiniz.
...
| [get(int index)](#get-int) | Belirtilen indeksteki bölümü alır. |
...
Belirtilen indeksteki bölümü alır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Bölüm listesine bir indeks. |
...
**Returns:**
com.aspose.words.Node[] - Bölüm dizisi.
