...
description: "Java'da FILESIZE alanını uygular."
type: docs
weight: 231
url: /tr/java/com.aspose.words/fieldfilesize/
---
...
Geçerli belgenin dosya boyutunu alır; boyut belirlenemezse 0 döndürür.

Mevcut uygulamada, dosya boyutunu belirlemek için kullanılan dosya adını almak üzere [Document.getOriginalFileName()](../../com.aspose.words/document/\\#getOriginalFileName) özelliğini kullanır.

 **Examples:** 

Bir FILESIZE alanı ile belgenin dosya boyutunun nasıl görüntüleneceğini gösterir.
...
| [isInKilobytes()](#isInKilobytes) | Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceğini alır. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceğini ayarlar. |
| [isInMegabytes()](#isInMegabytes) | Dosya boyutunun megabayt cinsinden görüntülenip görüntülenmeyeceğini alır. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Dosya boyutunun megabayt cinsinden görüntülenip görüntülenmeyeceğini ayarlar. |
...
Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceğini alır.
...
**Returns:**
boolean - Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceği.
...
Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Dosya boyutunun kilobayt cinsinden görüntülenip görüntülenmeyeceği. |
...
Dosya boyutunun megabayt cinsinden görüntülenip görüntülenmeyeceğini alır.
...
**Returns:**
boolean - Dosya boyutunun megabayt cinsinden görüntülenip görüntülenmeyeceği.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Dosya boyutunun megabayt cinsinden görüntülenip görüntülenmeyeceği. |
