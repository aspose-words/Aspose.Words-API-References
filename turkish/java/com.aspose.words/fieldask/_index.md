...
description: "Java'da ASK alanını uygular."
type: docs
weight: 199
url: /tr/java/com.aspose.words/fieldask/
---
...
Kullanıcıyı bilgi girmeye yönlendirir ve kullanıcının yanıtını temsil edecek bir yer imi atar.
...
| [getDefaultResponse()](#getDefaultResponse) | Varsayılan kullanıcı yanıtını alır (istek penceresinde bulunan başlangıç değeri). |
...
| [getPromptOnceOnMailMerge()](#getPromptOnceOnMailMerge) | Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediğini alır. |
| [getPromptText()](#getPromptText) | İstek metnini alır (istek penceresinin başlığı). |
...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String) | Varsayılan kullanıcı yanıtını ayarlar (istek penceresinde bulunan başlangıç değeri). |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean) | Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediğini ayarlar. |
| [setPromptText(String value)](#setPromptText-java.lang.String) | İstek metnini ayarlar (istek penceresinin başlığı). |
...
Varsayılan kullanıcı yanıtını alır (istek penceresinde bulunan başlangıç değeri).
...
**Returns:**
java.lang.String - Varsayılan kullanıcı yanıtı (istek penceresinde bulunan başlangıç değeri).
...
Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediğini alır.
...
**Returns:**
boolean - Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediği.
...
İstek metnini alır (istek penceresinin başlığı).
...
**Returns:**
java.lang.String - İstek metni (istek penceresinin başlığı).
### getResult() {#getResult}
```
...
Varsayılan kullanıcı yanıtını ayarlar (istek penceresinde bulunan başlangıç değeri).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Varsayılan kullanıcı yanıtı (istek penceresinde bulunan başlangıç değeri). |
...
Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Kullanıcı yanıtının bir posta birleştirme işlemi başına bir kez alınması gerekip gerekmediği. |
...
İstek metnini ayarlar (istek penceresinin başlığı).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | İstek metni (istek penceresinin başlığı). |
