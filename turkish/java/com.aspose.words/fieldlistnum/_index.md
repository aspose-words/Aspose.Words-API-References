...
description: "Java'da LISTNUM alanını uygular."
type: docs
weight: 255
url: /tr/java/com.aspose.words/fieldlistnum/
---
...
LISTNUM alanlarıyla paragrafları nasıl numaralandıracağınızı gösterir.
...
| [getListLevel()](#getListLevel) | Alanının varsayılan davranışını geçersiz kılarak listedeki seviyeyi alır. |
| [getListName()](#getListName) | Numaralandırma için kullanılan soyut numaralandırma tanımının adını alır. |
...
| [getStartingNumber()](#getStartingNumber) | Bu alan için başlangıç değerini alır. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Microsoft Word alan türünü alır. |
| [hasListName()](#hasListName) | Alan kodu tarafından bir soyut numaralandırma tanımının adının sağlanıp sağlanmadığını gösteren bir değer döndürür. |
...
| [remove()](#remove) |  |
| [setListLevel(String value)](#setListLevel-java.lang.String) | Alanının varsayılan davranışını geçersiz kılarak listedeki seviyeyi ayarlar. |
| [setListName(String value)](#setListName-java.lang.String) | Numaralandırma için kullanılan soyut numaralandırma tanımının adını ayarlar. |
...
| [setStartingNumber(String value)](#setStartingNumber-java.lang.String) | Bu alan için başlangıç değerini ayarlar. |
...
Alanının varsayılan davranışını geçersiz kılarak listedeki seviyeyi alır.
...
**Returns:**
java.lang.String - Alanının varsayılan davranışını geçersiz kılarak listedeki seviye.
...
Numaralandırma için kullanılan soyut numaralandırma tanımının adını alır.
...
**Returns:**
java.lang.String - Numaralandırma için kullanılan soyut numaralandırma tanımının adı.
...
Bu alan için başlangıç değerini alır.
...
**Returns:**
java.lang.String - Bu alan için başlangıç değeri.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Alan kodu tarafından bir soyut numaralandırma tanımının adının sağlanıp sağlanmadığını gösteren bir değer döndürür.
...
**Returns:**
boolean - Alan kodu tarafından bir soyut numaralandırma tanımının adının sağlanıp sağlanmadığını gösteren bir değer.
### isDirty() {#isDirty}
```
...
Alanının varsayılan davranışını geçersiz kılarak listedeki seviyeyi ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanının varsayılan davranışını geçersiz kılarak listedeki seviye. |
...
Numaralandırma için kullanılan soyut numaralandırma tanımının adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Numaralandırma için kullanılan soyut numaralandırma tanımının adı. |
...
Bu alan için başlangıç değerini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bu alan için başlangıç değeri. |
