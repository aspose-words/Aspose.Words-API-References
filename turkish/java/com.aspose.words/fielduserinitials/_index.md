...
description: "Java'da USERINITIALS alanını uygular."
type: docs
weight: 304
url: /tr/java/com.aspose.words/fielduserinitials/
---
...
| [getUserInitials()](#getUserInitials) | Geçerli kullanıcının baş harflerini alır. |
...
| [setUserInitials(String value)](#setUserInitials-java.lang.String) | Geçerli kullanıcının baş harflerini ayarlar. |
...
**Returns:**
java.lang.String - Geçerli kullanıcının baş harfleri.
### isDirty() {#isDirty}
```
...
Geçerli kullanıcının baş harflerini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Geçerli kullanıcının baş harfleri. |
