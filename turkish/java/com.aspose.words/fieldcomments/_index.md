...
description: "Java'da COMMENTS alanını uygular."
type: docs
weight: 213
url: /tr/java/com.aspose.words/fieldcomments/
---
...
COMMENTS alanını uygular.

Daha fazla bilgi için, [ Working with Fields ][Working with Fields] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Geçerli belgeyle ilgili yorumları alır ve isteğe bağlı olarak ayarlar, yerleşik belge özelliklerinin [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) özelliğinde kaydedildiği gibi.
...
| [getText()](#getText) | Yorumların metnini alır. |
...
| [setText(String value)](#setText-java.lang.String) | Yorumların metnini ayarlar. |
...
**Returns:**
java.lang.String - Yorumların metni.
### getType() {#getType}
```
public int getType()
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Yorumların metni. |
