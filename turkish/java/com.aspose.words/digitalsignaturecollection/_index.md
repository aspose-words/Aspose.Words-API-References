...
description: "Java'da bir belgeye eklenen dijital imzaların yalnızca okunabilir bir koleksiyonunu sağlar."
type: docs
weight: 151
url: /tr/java/com.aspose.words/digitalsignaturecollection/
---
...
Bir belgeye eklenmiş dijital imzaların yalnızca okunabilir bir koleksiyonunu sağlar.
...
| Yöntem | Açıklama |
| --- | --- |
| [get(int index)](#get-int) | Belirtilen indeksteki belge imzasını alır. |
| [getCount()](#getCount) | Koleksiyonda bulunan öğe sayısını alır. |
| [isValid()](#isValid) | Bu koleksiyondaki tüm dijital imzalar geçerli ve belge değiştirilmemişse  true  döndürür. Ayrıca dijital imza yoksa da  true  döndürür. |
...
| --- | --- | --- |
| indeks | int | İmzanın sıfır tabanlı indeksi. |
...
**Returns:**
boolean - true eğer bu koleksiyondaki tüm dijital imzalar geçerli ve belge değiştirilmemişse. Ayrıca dijital imza yoksa true döndürür.
### iterator() {#iterator}
```
...
İmzalı bir belgenin tüm dijital imzalarını nasıl yazdıracağınızı gösterir.
