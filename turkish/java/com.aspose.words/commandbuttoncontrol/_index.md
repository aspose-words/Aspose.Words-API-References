...
description: "CommandButton kontrolü, Java'da bir kullanıcı tıkladığında bir eylemi gerçekleştiren bir makroyu çalıştırır."
type: docs
weight: 107
url: /tr/java/com.aspose.words/commandbuttoncontrol/
---
...
CommandButton denetimi, bir kullanıcı tıkladığında bir eylem gerçekleştiren bir makroyu çalıştırır.
...
| Yapıcı | Açıklama |
| --- | --- |
| [CommandButtonControl()](#CommandButtonControl) | Yeni bir [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/) sınıfı örneği başlatır. |
## Yöntemler
...
Yeni bir [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/) sınıfı örneği başlatır.
