...
description: "Java'da belge yükleme veya kaydetme sırasında Aspose.Words tarafından verilen bir yazı tipi ikame uyarısı hakkında bilgi içerir."
type: docs
weight: 338
url: /tr/java/com.aspose.words/fontsubstitutionwarninginfo/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [getDescription()](#getDescription) | Uyarının açıklamasını döndürür. |
| [getReason()](#getReason) | Yazı tipi ikame nedeni. |
| [getRequestedBold()](#getRequestedBold) | Kalın stilinin istenip istenmediğini gösterir. |
| [getRequestedFamilyName()](#getRequestedFamilyName) | İstenen yazı tipi ailesi adı. |
| [getRequestedItalic()](#getRequestedItalic) | İtalik stilinin istenip istenmediğini gösterir. |
| [getResolvedFont()](#getResolvedFont) | Çözülmüş yazı tipi. |
| [getSource()](#getSource) | Uyarının kaynağını döndürür. |
...
**Returns:**
java.lang.String - Uyarının açıklaması.
### getReason() {#getReason}
```
...
**Returns:**
int - İlgili  int  değeri. Döndürülen değer, [FontSubstitutionReason](../../com.aspose.words/fontsubstitutionreason/) sabitlerinden biridir.
...
Kalın stilinin istenip istenmediğini gösterir.
...
**Returns:**
int - Uyarının kaynağı. Döndürülen değer [WarningSource](../../com.aspose.words/warningsource/) sabitlerinden biridir.
...
**Returns:**
int - Uyarının türü. Döndürülen değer [WarningType](../../com.aspose.words/warningtype/) sabitlerinin bit düzeyinde bir birleşimidir.
