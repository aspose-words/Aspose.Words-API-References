...
description: "Java'da bir eklenti görev bölmesi nesnesini temsil eder."
type: docs
weight: 663
url: /tr/java/com.aspose.words/taskpane/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [getDockState()](#getDockState) | Bu görev bölmesi nesnesinin son bağlandığı konumu belirtir. |
| [getRow()](#getRow) | Bu görev bölmesinin, aynı varsayılan konuma bağlanan diğer kalıcı görev bölmeleri arasında dıştan içe doğru sayılan dizinini belirtir. |
| [getWebExtension()](#getWebExtension) | Bir web uzantısı nesnesini temsil eder. |
| [getWidth()](#getWidth) | Bu görev bölmesi örneği için varsayılan genişlik değerini belirtir. |
| [isLocked()](#isLocked) | Görev bölmesinin kullanıcı arabiriminde belgeye kilitlenip kilitlenmediğini ve kullanıcının kapatıp kapatamayacağını belirtir. |
| [isLocked(boolean value)](#isLocked-boolean) | Görev bölmesinin kullanıcı arabiriminde belgeye kilitlenip kilitlenmediğini ve kullanıcının kapatıp kapatamayacağını belirtir. |
| [isVisible()](#isVisible) | Belge açıldığında görev bölmesinin varsayılan olarak görünür olup olmayacağını belirtir. |
| [isVisible(boolean value)](#isVisible-boolean) | Belge açıldığında görev bölmesinin varsayılan olarak görünür olup olmayacağını belirtir. |
| [setDockState(int value)](#setDockState-int) | Bu görev bölmesi nesnesinin son bağlandığı konumu belirtir. |
| [setRow(int value)](#setRow-int) | Bu görev bölmesinin, aynı varsayılan konuma bağlanan diğer kalıcı görev bölmeleri arasında dıştan içe doğru sayılan dizinini belirtir. |
| [setWidth(double value)](#setWidth-double) | Bu görev bölmesi örneği için varsayılan genişlik değerini belirtir. |
...
**Returns:**
int - İlgili  int  değeri. Döndürülen değer, [TaskPaneDockState](../../com.aspose.words/taskpanedockstate/) sabitlerinden biridir.
### getRow() {#getRow}
```
public int getRow()
```
...
Bu görev bölmesinin, aynı varsayılan konuma bağlanan diğer kalıcı görev bölmeleri arasında dıştan içe doğru sayılan dizinini belirtir.
...
Görev bölmesinin kullanıcı arabiriminde belgeye kilitlenip kilitlenmediğini ve kullanıcının kapatıp kapatamayacağını belirtir.
...
Belge açıldığında görev bölmesinin varsayılan olarak görünür olup olmayacağını belirtir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | İlgili  int  değeri. Değer, [TaskPaneDockState](../../com.aspose.words/taskpanedockstate/) sabitlerinden biri olmalıdır. |
