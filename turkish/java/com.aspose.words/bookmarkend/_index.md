...
description: "Java'da bir Word belgesindeki yer iminin sonunu temsil eder."
type: docs
weight: 43
url: /tr/java/com.aspose.words/bookmarkend/
---
...
Word belgesindeki bir yer iminin sonunu temsil eder.
...
Yer imleriyle tek bir nesne olarak çalışmak için [Bookmark](../../com.aspose.words/bookmark/) sınıfını bir "facade" olarak kullanın.
...
| Yapıcı | Açıklama |
| --- | --- |
| [BookmarkEnd(DocumentBase doc, String name)](#BookmarkEnd-com.aspose.words.DocumentBase-java.lang.String) | Yeni bir [BookmarkEnd](../../com.aspose.words/bookmarkend/) sınıfı örneği başlatır. |
## Yöntemler
...
| [getNodeType()](#getNodeType) | Döndürür [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). |
...
Yeni bir [BookmarkEnd](../../com.aspose.words/bookmarkend/) sınıfı örneği başlatır.
...
Çağırır [DocumentVisitor.visitBookmarkEnd(com.aspose.words.BookmarkEnd)](../../com.aspose.words/documentvisitor/\#visitBookmarkEnd-com.aspose.words.BookmarkEnd).
...
Döndürür [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END).
...
**Returns:**
int - [NodeType.BOOKMARK\_END](../../com.aspose.words/nodetype/\#BOOKMARK-END). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
