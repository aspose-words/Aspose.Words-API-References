...
description: "Java'da bir web uzantısı ile belgedeki veri arasındaki bağlama ilişkisinin tanımlanmasını belirtir."
type: docs
weight: 727
url: /tr/java/com.aspose.words/webextensionbinding/
---
...
Web uzantısı ile belgedeki veri arasındaki bağlama ilişkisini belirtir.
...
| Yapıcı | Açıklama |
| --- | --- |
| [WebExtensionBinding(String id, int bindingType, String appRef)](#WebExtensionBinding-java.lang.String-int-java.lang.String) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getAppRef()](#getAppRef) | Bu listedeki bağlama girişini belgede bağlanan veriyle eşleştirmek için kullanılan bağlama anahtarını belirtir. |
| [getBindingType()](#getBindingType) | Bağlama tipini belirtir. |
| [getId()](#getId) | Bağlama tanımlayıcısını belirtir. |
| [setAppRef(String value)](#setAppRef-java.lang.String) | Bu listedeki bağlama girişini belgede bağlanan veriyle eşleştirmek için kullanılan bağlama anahtarını belirtir. |
| [setBindingType(int value)](#setBindingType-int) | Bağlama tipini belirtir. |
| [setId(String value)](#setId-java.lang.String) | Bağlama tanımlayıcısını belirtir. |
...
**Returns:**
int - İlgili  int  değeri. Döndürülen değer, [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/) sabitlerinden biridir.
### getId() {#getId}
```
public String getId()
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | İlgili  int  değeri. Değer, [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/) sabitlerinden biri olmalıdır. |
