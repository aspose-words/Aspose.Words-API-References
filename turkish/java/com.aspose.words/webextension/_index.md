...
description: "Java'da bir web uzantısı nesnesini temsil eder."
type: docs
weight: 726
url: /tr/java/com.aspose.words/webextension/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [getAlternateReferences()](#getAlternateReferences) | Bir web uzantısına alternatif referansları belirtir. |
| [getBindings()](#getBindings) | Web uzantısı bağlamalarının bir listesini belirtir. |
| [getId()](#getId) | Geçerli belgede web uzantısı örneğini benzersiz şekilde tanımlar. |
| [getProperties()](#getProperties) | Web uzantısı özel özelliklerinin bir kümesini temsil eder. |
| [getReference()](#getReference) | Bir web uzantısına birincil referansı belirtir. |
| [isFrozen()](#isFrozen) | Kullanıcının web uzantısıyla etkileşime girip giremeyeceğini belirtir. |
| [isFrozen(boolean value)](#isFrozen-boolean) | Kullanıcının web uzantısıyla etkileşime girip giremeyeceğini belirtir. |
| [setId(String value)](#setId-java.lang.String) | Geçerli belgede web uzantısı örneğini benzersiz şekilde tanımlar. |
