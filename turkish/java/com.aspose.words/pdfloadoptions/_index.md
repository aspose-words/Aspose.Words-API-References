...
description: "Java'da bir Document nesnesine Pdf belgesi yüklenirken ek seçenekler belirtmeye izin verir."
type: docs
weight: 538
url: /tr/java/com.aspose.words/pdfloadoptions/
---
...
Pdf belgesi bir [Document](../../com.aspose.words/document/) nesnesine yüklenirken ek seçenekler belirtmeye izin verir.
...
| [getPageCount()](#getPageCount) | Okunacak sayfa sayısını alır. |
| [getPageIndex()](#getPageIndex) | Okunacak ilk sayfanın 0 tabanlı indeksini alır. |
...
| [getSkipPdfImages()](#getSkipPdfImages) | PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrağı alır. |
...
| [setPageCount(int value)](#setPageCount-int) | Okunacak sayfa sayısını ayarlar. |
| [setPageIndex(int value)](#setPageIndex-int) | Okunacak ilk sayfanın 0 tabanlı indeksini ayarlar. |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean) | PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrağı ayarlar. |
...
Okunacak sayfa sayısını alır. Varsayılan değer MaxValue'dir ve bu, belgenin tüm sayfalarının okunacağı anlamına gelir.
...
Okunacak ilk sayfanın 0 tabanlı indeksini alır. Varsayılan değer 0'dır.
...
**Returns:**
int - Okunacak ilk sayfanın 0 tabanlı indeksi.
...
PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrağı alır. Varsayılan değer false'dur.
...
**Returns:**
boolean - PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrak.
...
Okunacak sayfa sayısını ayarlar. Varsayılan değer MaxValue'dir ve bu, belgenin tüm sayfalarının okunacağı anlamına gelir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | int | Okunacak sayfa sayısı. |
...
Okunacak ilk sayfanın 0 tabanlı indeksini ayarlar. Varsayılan değer 0'dır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | int | Okunacak ilk sayfanın 0 tabanlı indeksi. |
...
PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrağı ayarlar. Varsayılan değer false'tur.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | PDF belgesi yüklenirken görüntülerin atlanıp atlanmayacağını gösteren bayrak. |
