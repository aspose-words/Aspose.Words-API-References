...
description: "Java'da USERADDRESS alanını uygular."
type: docs
weight: 303
url: /tr/java/com.aspose.words/fielduseraddress/
---
...
| [getUserAddress()](#getUserAddress) | Mevcut kullanıcının posta adresini alır. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | Mevcut kullanıcının posta adresini ayarlar. |
...
Mevcut kullanıcının posta adresini alır.
...
**Returns:**
java.lang.String - Mevcut kullanıcının posta adresi.
### isDirty() {#isDirty}
```
...
Mevcut kullanıcının posta adresini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Mevcut kullanıcının posta adresi. |
