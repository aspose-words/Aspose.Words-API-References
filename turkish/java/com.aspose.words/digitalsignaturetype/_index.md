...
description: "Java'da bir dijital imzanın türünü belirtir."
type: docs
weight: 153
url: /tr/java/com.aspose.words/digitalsignaturetype/
---
...
| Alan | Açıklama |
| --- | --- |
| [CRYPTO_API](#CRYPTO-API) | Microsoft Word 97-2003 .DOC ikili belgelerinde kullanılan Crypto API imza yöntemi. |
| [UNKNOWN](#UNKNOWN) | Bir hatayı gösterir, bilinmeyen dijital imza türü. |
| [XML_DSIG](#XML-DSIG) | OOXML ve OpenDocument belgelerinde kullanılan XmlDsig imza yöntemi. |
| [length](#length) |  |
## Yöntemler
...
Microsoft Word 97-2003 .DOC ikili belgelerinde kullanılan Crypto API imza yöntemi.
...
Bir hatayı gösterir, bilinmeyen dijital imza türü.
...
OOXML ve OpenDocument belgelerinde kullanılan XmlDsig imza yöntemi.
