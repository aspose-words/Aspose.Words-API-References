...
description: "Java'da PRINT alanını uygular."
type: docs
weight: 273
url: /tr/java/com.aspose.words/fieldprint/
---
...
Belge yazdırıldığında seçili yazıcıya yazıcıya özgü kontrol kodu karakterlerini göndermek için bir talimat.

 **Examples:** 

Bir PRINT alanı eklemeyi gösterir.
...
| [getPostScriptGroup()](#getPostScriptGroup) | PostScript talimatlarının çalıştığı çizim dikdörtgenini alır. |
| [getPrinterInstructions()](#getPrinterInstructions) | Yazıcıya özgü kontrol kodu karakterlerini veya PostScript talimatlarını alır. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | PostScript talimatlarının çalıştığı çizim dikdörtgenini ayarlar. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Yazıcıya özgü kontrol kodu karakterlerini veya PostScript talimatlarını ayarlar. |
...
PostScript talimatlarının çalıştığı çizim dikdörtgenini alır.
...
**Returns:**
java.lang.String - PostScript talimatlarının çalıştığı çizim dikdörtgeni.
...
Yazıcıya özgü kontrol kodu karakterlerini veya PostScript talimatlarını alır.
...
**Returns:**
java.lang.String - Yazıcıya özgü kontrol kodu karakterleri veya PostScript talimatları.
### getResult() {#getResult}
```
...
PostScript talimatlarının çalıştığı çizim dikdörtgenini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | PostScript talimatlarının çalıştığı çizim dikdörtgeni. |
...
Yazıcıya özgü kontrol kodu karakterlerini veya PostScript talimatlarını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Yazıcıya özgü kontrol kodu karakterleri veya PostScript talimatları. |
