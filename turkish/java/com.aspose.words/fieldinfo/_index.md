...
description: "Java'da INFO alanını uygular."
type: docs
weight: 251
url: /tr/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Eklenecek belge özelliğinin tipini alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getNewValue()](#getNewValue) | Özelliği güncelleyen isteğe bağlı bir değeri alır. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Eklenecek belge özelliğinin tipini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Özelliği güncelleyen isteğe bağlı bir değeri ayarlar. |
...
Eklenecek belge özelliğinin tipini alır.
...
**Returns:**
java.lang.String - Eklenecek belge özelliğinin türü.
...
Özelliği güncelleyen isteğe bağlı bir değeri alır.
...
**Returns:**
java.lang.String - Özelliği güncelleyen isteğe bağlı bir değer.
### getResult() {#getResult}
```
...
Eklenecek belge özelliğinin tipini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek belge özelliğinin türü. |
...
Özelliği güncelleyen isteğe bağlı bir değeri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Özelliği güncelleyen isteğe bağlı bir değer. |
