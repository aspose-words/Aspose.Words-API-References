...
description: "Java'da EQ alanını uygular."
type: docs
weight: 226
url: /tr/java/com.aspose.words/fieldeq/
---
...
EQ alanını kullanarak çeşitli matematiksel denklemleri nasıl görüntüleyeceğinizi gösterir.
...
EQ alanını Office Math ile nasıl değiştireceğinizi gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [asOfficeMath()](#asOfficeMath) | EQ alanına karşılık gelen Office Math nesnesini döndürür. |
