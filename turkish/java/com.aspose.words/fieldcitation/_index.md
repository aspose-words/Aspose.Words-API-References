...
description: "Java'da CITATION alanını uygular."
type: docs
weight: 211
url: /tr/java/com.aspose.words/fieldcitation/
---
...
**Source** öğesinin içeriğini belirtilen **Tag** öğesiyle bibliyografik bir stil kullanarak ekler.
...
| Yöntem | Açıklama |
| --- | --- |
| [getAnotherSourceTag()](#getAnotherSourceTag) | Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değeri alır. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Belgedeki alıntıyı biçimlendirmek için belirtilen bibliyografik stil ile birlikte kullanılan dil kimliğini alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getPageNumber()](#getPageNumber) | Alıntıyla ilişkili bir sayfa numarasını alır. |
| [getPrefix()](#getPrefix) | Alıntının başına eklenen bir ön eki alır. |
...
| [getSourceTag()](#getSourceTag) | Eklenecek kaynağın **Tag** öğesinin değerine eşleşen bir değeri alır. |
| [getStart()](#getStart) | Alan başlangıcını temsil eden düğümü alır. |
| [getSuffix()](#getSuffix) | Alıntının sonuna eklenen bir soneki alır. |
| [getSuppressAuthor()](#getSuppressAuthor) | Alıntıdan yazar bilgisinin gizlenip gizlenmediğini alır. |
| [getSuppressTitle()](#getSuppressTitle) | Alıntıdan başlık bilgisinin gizlenip gizlenmediğini alır. |
| [getSuppressYear()](#getSuppressYear) | Alıntıdan yıl bilgisinin gizlenip gizlenmediğini alır. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Microsoft Word alan türünü alır. |
| [getVolumeNumber()](#getVolumeNumber) | Alıntıyla ilişkili bir cilt numarasını alır. |
...
| [setAnotherSourceTag(String value)](#setAnotherSourceTag-java.lang.String) | Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değeri ayarlar. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Belirtilen bibliyografik stil ile birlikte kullanılan dil kimliğini belge içinde alıntıyı biçimlendirmek için ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setPageNumber(String value)](#setPageNumber-java.lang.String) | Alıntıyla ilişkili bir sayfa numarasını ayarlar. |
| [setPrefix(String value)](#setPrefix-java.lang.String) | Alıntının başına eklenen bir ön eki ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Eklenecek kaynağın **Tag** öğesinin değerine eşleşen bir değeri ayarlar. |
| [setSuffix(String value)](#setSuffix-java.lang.String) | Alıntının sonuna eklenen bir soneki ayarlar. |
| [setSuppressAuthor(boolean value)](#setSuppressAuthor-boolean) | Alıntıdan yazar bilgisinin gizlenip gizlenmeyeceğini ayarlar. |
| [setSuppressTitle(boolean value)](#setSuppressTitle-boolean) | Alıntıdan başlık bilgisinin gizlenip gizlenmeyeceğini ayarlar. |
| [setSuppressYear(boolean value)](#setSuppressYear-boolean) | Alıntıdan yıl bilgisinin gizlenip gizlenmeyeceğini ayarlar. |
| [setVolumeNumber(String value)](#setVolumeNumber-java.lang.String) | Alıntıyla ilişkili bir cilt numarasını ayarlar. |
...
Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değeri alır.
...
**Returns:**
java.lang.String - Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değer.
...
Belgedeki alıntıyı biçimlendirmek için belirtilen bibliyografik stil ile birlikte kullanılan dil kimliğini alır.
...
**Returns:**
java.lang.String - Belirtilen bibliyografik stil ile birlikte kullanılan dil kimliği, belge içinde alıntıyı biçimlendirmek için.
...
Alıntıyla ilişkili bir sayfa numarasını alır.
...
**Returns:**
java.lang.String - Alıntıyla ilişkili bir sayfa numarası.
### getPrefix() {#getPrefix}
```
...
Alıntının başına eklenen bir ön eki alır.
...
**Returns:**
java.lang.String - Alıntının başına eklenen bir ön ek.
### getResult() {#getResult}
```
...
Eklenecek kaynağın **Tag** öğesinin değerine eşleşen bir değeri alır.
...
**Returns:**
java.lang.String - Eklenecek kaynağın **Tag** öğesinin değerine eşleşen bir değer.
### getStart() {#getStart}
```
...
Alıntının sonuna eklenen bir soneki alır.
...
**Returns:**
java.lang.String - Alıntının sonuna eklenen bir sonek.
...
Alıntıdan yazar bilgisinin gizlenip gizlenmediğini alır.
...
**Returns:**
boolean - Alıntıdan yazar bilgisinin gizlenip gizlenmediği.
...
Alıntıdan başlık bilgisinin gizlenip gizlenmediğini alır.
...
**Returns:**
boolean - Alıntıdan başlık bilgisinin gizlenip gizlenmediği.
...
Alıntıdan yıl bilgisinin gizlenip gizlenmediğini alır.
...
**Returns:**
boolean - Alıntıdan yıl bilgisinin gizlenip gizlenmediği.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Alıntıyla ilişkili bir cilt numarasını alır.
...
**Returns:**
java.lang.String - Alıntıyla ilişkili bir cilt numarası.
### isDirty() {#isDirty}
```
...
Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değeri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alıntıya dahil edilecek başka bir kaynağın **Tag** öğesinin değerine eşleşen bir değer. |
...
Belirtilen bibliyografik stil ile birlikte kullanılan dil kimliğini belge içinde alıntıyı biçimlendirmek için ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belirtilen bibliyografik stil ile birlikte kullanılan, belgede atıfı biçimlendirmek için kullanılan dil kimliği. |
...
Alıntıyla ilişkili bir sayfa numarasını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Atıfla ilişkili bir sayfa numarası. |
...
Alıntının başına eklenen bir ön eki ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Atıfa ön ek olarak eklenen bir önek. |
...
Eklenecek kaynağın **Tag** öğesinin değerine eşleşen bir değeri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Kaynağın eklenmesi için **Tag** öğesinin değerine uyan bir değer. |
...
Alıntının sonuna eklenen bir soneki ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Atıfa eklenen bir sonek. |
...
Alıntıdan yazar bilgisinin gizlenip gizlenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yazar bilgisinin atıftan gizlenip gizlenmediği. |
...
Alıntıdan başlık bilgisinin gizlenip gizlenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Başlık bilgisinin atıftan gizlenip gizlenmediği. |
...
Alıntıdan yıl bilgisinin gizlenip gizlenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yıl bilgisinin atıftan gizlenip gizlenmediği. |
...
Alıntıyla ilişkili bir cilt numarasını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Atıfla ilişkili bir cilt numarası. |
