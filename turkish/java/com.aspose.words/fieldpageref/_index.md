...
description: "Java'da PAGEREF alanını uygular."
type: docs
weight: 272
url: /tr/java/com.aspose.words/fieldpageref/
---
...
Belirtilen yer imini içeren sayfanın numarasını çapraz referans için ekler.

 **Examples:** 

Yer imlerinin göreceli konumunu göstermek için PAGEREF alanlarının nasıl ekleneceğini gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Yer iminin adını alır. |
...
| [getInsertHyperlink()](#getInsertHyperlink) | Yer işaretli paragraf için bir köprü eklenip eklenmeyeceğini alır. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Yer işaretli paragrafın göreceli konumunun eklenip eklenmeyeceğini alır. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Yer imi adını ayarlar. |
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Yer işareti yapılan paragraf için bir köprü eklenip eklenmeyeceğini ayarlar. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Yer işareti yapılan paragrafın göreli konumunun eklenip eklenmeyeceğini ayarlar. |
...
Yer işaretli paragraf için bir köprü eklenip eklenmeyeceğini alır.
...
**Returns:**
boolean - Yer işareti yapılan paragraf için bir köprü eklenip eklenmeyeceği.
...
Yer işaretli paragrafın göreceli konumunun eklenip eklenmeyeceğini alır.
...
**Returns:**
boolean - Yer işareti yapılan paragrafın göreli konumunun eklenip eklenmeyeceği.
...
Yer işareti yapılan paragraf için bir köprü eklenip eklenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yer işareti yapılan paragraf için bir köprü eklenip eklenmeyeceği. |
...
Yer işareti yapılan paragrafın göreli konumunun eklenip eklenmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yer işareti yapılan paragrafın göreli konumunun eklenip eklenmeyeceği. |
