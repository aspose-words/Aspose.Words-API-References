...
description: "Java'da IF alanını uygular."
type: docs
weight: 243
url: /tr/java/com.aspose.words/fieldif/
---
...
İfadeler [getLeftExpression()](../../com.aspose.words/fieldif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setLeftExpression-java.lang.String) ve [getRightExpression()](../../com.aspose.words/fieldif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldif/\#setRightExpression-java.lang.String) tarafından belirlenen değerleri, [getComparisonOperator()](../../com.aspose.words/fieldif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldif/\#setComparisonOperator-java.lang.String) tarafından belirlenen operatör kullanılarak karşılaştırır.
...
| [getFalseText()](#getFalseText) | Karşılaştırma ifadesi false olduğunda görüntülenen metni alır. |
...
| [getTrueText()](#getTrueText) | Karşılaştırma ifadesi true olduğunda görüntülenen metni alır. |
...
| [setFalseText(String value)](#setFalseText-java.lang.String) | Karşılaştırma ifadesi false olduğunda görüntülenen metni ayarlar. |
...
| [setTrueText(String value)](#setTrueText-java.lang.String) | Karşılaştırma ifadesi true olduğunda görüntülenen metni ayarlar. |
...
**Returns:**
int - Koşul değerlendirmesinin sonucunu temsil eden bir [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/) değeri. Döndürülen değer, [FieldIfComparisonResult](../../com.aspose.words/fieldifcomparisonresult/) sabitlerinden biridir.
...
Karşılaştırma ifadesi false olduğunda görüntülenen metni alır.
...
**Returns:**
java.lang.String - Karşılaştırma ifadesi false olduğunda görüntülenen metin.
...
Karşılaştırma ifadesi true olduğunda görüntülenen metni alır.
...
**Returns:**
java.lang.String - Karşılaştırma ifadesi true olduğunda görüntülenen metin.
### getType() {#getType}
```
public int getType()
```
...
Karşılaştırma ifadesi false olduğunda görüntülenen metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Karşılaştırma ifadesi false olduğunda görüntülenen metin. |
...
Karşılaştırma ifadesi true olduğunda görüntülenen metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Karşılaştırma ifadesi true olduğunda görüntülenen metin. |
