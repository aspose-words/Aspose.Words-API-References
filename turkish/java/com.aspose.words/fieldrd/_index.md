...
description: "Java'da RD alanını uygular."
type: docs
weight: 277
url: /tr/java/com.aspose.words/fieldrd/
---
...
İçindekiler tablosu, yetkililer tablosu veya bir indeks oluştururken TOC, TOA veya INDEX alanı ile dahil edilecek bir dosyayı tanımlar.
...
| [getFileName()](#getFileName) | İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adını alır. |
...
| [isPathRelative()](#isPathRelative) | Yolun geçerli belgeye göre göreli olup olmadığını alır. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Yolun geçerli belgeye göre göreli olup olmadığını ayarlar. |
| [remove()](#remove) | Alanı belgeden kaldırır. |
| [setFileName(String value)](#setFileName-java.lang.String) | İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adını ayarlar. |
...
İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adını alır.
...
**Returns:**
java.lang.String - İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adı.
### getFormat() {#getFormat}
```
...
Yolun geçerli belgeye göre göreli olup olmadığını alır.
...
**Returns:**
boolean - Yolun geçerli belgeye göre göreli olup olmadığı.
...
Yolun geçerli belgeye göre göreli olup olmadığını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yolun geçerli belgeye göre göreli olup olmadığı. |
...
İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | İçindekiler tablosu, yetkililer tablosu veya indeks oluştururken dahil edilecek dosyanın adı. |
