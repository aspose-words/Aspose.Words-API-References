...
description: "Java'da bir Document nesnesine HTML belgesi yüklerken ek seçenekler belirtmeye izin verir."
type: docs
weight: 382
url: /tr/java/com.aspose.words/htmlloadoptions/
---
...
HTML belgesi bir [Document](../../com.aspose.words/document/) nesnesine yüklenirken ek seçenekler belirtmeye izin verir.

Daha fazla bilgi edinmek için, [ Specify Load Options ][Specify Load Options] dokümantasyon makalesini ziyaret edin.

 **Examples:** 

HTML belgesi yüklenirken koşullu yorumları nasıl destekleyeceğini gösterir.
...
| [HtmlLoadOptions(String password)](#HtmlLoadOptions-java.lang.String) | Şifreli bir belgeyi yüklemek için belirtilen parolayı kullanarak bu sınıfın yeni bir örneğini başlatmak için bir kısayol. |
| [HtmlLoadOptions(int loadFormat, String password, String baseUri)](#HtmlLoadOptions-int-java.lang.String-java.lang.String) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler
...
| [getBlockImportMode()](#getBlockImportMode) | Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değeri alır. |
...
| [getConvertSvgToEmf()](#getConvertSvgToEmf) | Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değeri alır. |
...
| [getIgnoreNoscriptElements()](#getIgnoreNoscriptElements) | HTML öğelerinin göz ardı edilip edilmeyeceğini gösteren bir değeri alır. |
...
| [getPreferredControlType()](#getPreferredControlType) | İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipini alır. |
...
| [getSupportFontFaceRules()](#getSupportFontFaceRules) | @font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerinin yüklenip yüklenmeyeceğini gösteren bir değer alır. |
| [getSupportVml()](#getSupportVml) | VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değer alır. |
...
| [getWebRequestTimeout()](#getWebRequestTimeout) | Web isteğinin zaman aşımına uğramadan önce beklenecek milisaniye sayısı. |
...
| [setBlockImportMode(int value)](#setBlockImportMode-int) | Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değeri ayarlar. |
...
| [setConvertSvgToEmf(boolean value)](#setConvertSvgToEmf-boolean) | Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değeri ayarlar. |
...
| [setIgnoreNoscriptElements(boolean value)](#setIgnoreNoscriptElements-boolean) | HTML  öğelerini yok sayıp saymayacağını gösteren bir değeri ayarlar. |
...
| [setPreferredControlType(int value)](#setPreferredControlType-int) | İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipini ayarlar. |
...
| [setSupportFontFaceRules(boolean value)](#setSupportFontFaceRules-boolean) | @font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerinin yüklenip yüklenmeyeceğini gösteren bir değeri ayarlar. |
| [setSupportVml(boolean value)](#setSupportVml-boolean) | VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değeri ayarlar. |
...
| [setWebRequestTimeout(int value)](#setWebRequestTimeout-int) | Web isteğinin zaman aşımına uğramadan önce beklenecek milisaniye sayısı. |
...
| --- | --- | --- |
| şifre | java.lang.String | Şifreli bir belgeyi açmak için şifre. null veya boş dize olabilir. |
...
Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değeri alır. Varsayılan değer [BlockImportMode.MERGE](../../com.aspose.words/blockimportmode/\#MERGE) dir.
...
**Returns:**
int - Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değer. Döndürülen değer [BlockImportMode](../../com.aspose.words/blockimportmode/) sabitlerinden biridir.
...
Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değeri alır. Varsayılan değer  false  olup, mümkün olduğunda, yüklenen SVG görüntüleri dönüşüm olmadan olduğu gibi saklanır.

 **Remarks:** 

MS Word'ün daha yeni sürümleri SVG görüntülerini yerel olarak destekler. Yükleme seçeneklerinde belirtilen MS Word sürümü SVG'yi destekliyorsa, Aspose.Words SVG görüntülerini olduğu gibi dönüşüm olmadan saklar. SVG desteklenmiyorsa, yüklenen SVG görüntüleri EMF formatına dönüştürülür.

Ancak, bu seçenek  true  olarak ayarlanırsa, Aspose.Words belirtilen MS Word sürümü SVG görüntülerini desteklese bile yüklenen SVG görüntülerini EMF'ye dönüştürür.
...
**Returns:**
boolean - Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değer.
...
HTML öğelerini yok sayıp saymayacağını gösteren bir değer alır. Varsayılan değer  false  dır.

 **Remarks:** 

MS Word gibi, Aspose.Words betikleri desteklemez ve varsayılan olarak  öğelerinin içeriğini sonuç belgeye yükler. Ancak çoğu tarayıcıda betikler desteklenir ve  öğelerinin içeriği görünmez. Bu özelliği  true  olarak ayarlamak, Aspose.Words'ün tüm  öğelerini yok saymasını sağlar ve tarayıcılarda görülenlere daha yakın belgeler üretmeye yardımcı olur.

 **Examples:** 

HTML öğelerini yok saymayı gösterir.
...
**Returns:**
boolean - HTML öğelerini yok sayıp saymayacağını gösteren bir değer.
...
İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipini alır. Varsayılan değer [HtmlControlType.FORM\_FIELD](../../com.aspose.words/htmlcontroltype/\#FORM-FIELD) dır. Not: Bu özelliğin ayarlanması, tüm içe aktarılan denetimlerin belirtilen tipte olacağını garanti etmez. Eğer bir HTML denetimi, tercih edilen tipte belge düğümleriyle temsil edilemiyorsa, Aspose.Words o denetim için uyumlu bir [HtmlControlType](../../com.aspose.words/htmlcontroltype/) kullanacaktır. Örnekler: İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipini nasıl ayarlayacağınızı gösterir.   final String html = "\\r\\n\\r\\n\\r\\n" + "item1\\r\\n\\r\\n\\r\\n\\r\\n"; HtmlLoadOptions htmlLoadOptions = new HtmlLoadOptions(); htmlLoadOptions.setPreferredControlType(HtmlControlType.STRUCTURED\_DOCUMENT\_TAG); Document doc = new Document(new ByteArrayInputStream(html.getBytes(StandardCharsets.UTF\_8)), htmlLoadOptions); NodeCollection nodes = doc.getChildNodes(NodeType.STRUCTURED\_DOCUMENT\_TAG, true); StructuredDocumentTag tag = (StructuredDocumentTag) nodes.get(0);

**Returns:**
int - İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipi. Döndürülen değer [HtmlControlType](../../com.aspose.words/htmlcontroltype/) sabitlerinden biridir.
...
@font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerinin yüklenip yüklenmeyeceğini gösteren bir değer alır. Varsayılan değer false.

 **Remarks:** 

Bu seçenek etkinleştirildiğinde, @font-face kurallarında bildirilen yazı tipleri yüklenir ve ortaya çıkan belgenin yazı tipi tanımlarına gömülür (bkz. [DocumentBase.getFontInfos()](../../com.aspose.words/documentbase/\#getFontInfos)). Bu, yüklenen yazı tiplerinin render için kullanılabilir olmasını sağlar ancak kaydetme sırasında yazı tiplerinin otomatik olarak gömülmesini etkinleştirmez. Belgeyi yüklenen yazı tipleriyle kaydetmek için, [FontInfoCollection.getEmbedTrueTypeFonts()](../../com.aspose.words/fontinfocollection/\#getEmbedTrueTypeFonts) / [FontInfoCollection.setEmbedTrueTypeFonts(boolean)](../../com.aspose.words/fontinfocollection/\#setEmbedTrueTypeFonts-boolean) özelliği, [DocumentBase.getFontInfos()](../../com.aspose.words/documentbase/\#getFontInfos) koleksiyonunda true olarak ayarlanmalıdır.

Desteklenen yazı tipi formatları TTF, EOT ve WOFF'tur.

**Returns:**
boolean - @font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerini yükleyip yüklemeyeceğini gösteren bir değer.
...
VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değer alır.
...
**Returns:**
boolean - VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değer.
...
Web isteğinin zaman aşımına uğramadan önce beklenecek milisaniye sayısı. Varsayılan değer 100000 milisaniye (100 saniye).

 **Remarks:** 

Aspose.Words'un HTML ve MHTML belgelerinde bağlantılı dış kaynakları (görseller, stil sayfaları) yüklerken yanıt beklediği milisaniye sayısı.
...
Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değer ayarlar. Varsayılan değer [BlockImportMode.MERGE](../../com.aspose.words/blockimportmode/#MERGE) dir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | Blok düzeyindeki öğelerin özelliklerinin nasıl içe aktarılacağını belirten bir değer. Değer, [BlockImportMode](../../com.aspose.words/blockimportmode/) sabitlerinden biri olmalıdır. |
...
Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değer ayarlar. Varsayılan değer  false  olup, mümkün olduğunda, yüklenen SVG görüntüleri dönüşüm olmadan olduğu gibi saklanır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yüklenen SVG görüntülerinin EMF formatına dönüştürülüp dönüştürülmeyeceğini gösteren bir değer. |
...
HTML öğelerinin yok sayılıp sayılmayacağını gösteren bir değer ayarlar. Varsayılan değer  false .
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | HTML öğelerinin yok sayılıp sayılmayacağını gösteren bir değer. |
...
İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipini ayarlar. Varsayılan değer [HtmlControlType.FORM_FIELD](../../com.aspose.words/htmlcontroltype/#FORM-FIELD). Notlar:Bu özelliğin ayarlanmasının tüm içe aktarılan denetimlerin belirtilen tipte olacağını garanti etmediğini lütfen unutmayın. Eğer bir HTML denetimi tercih edilen tipte belge düğümleriyle temsil edilemiyorsa, Aspose.Words o denetim için uyumlu bir [HtmlControlType](../../com.aspose.words/htmlcontroltype/) kullanacaktır. Örnekler:İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipinin nasıl ayarlanacağını gösterir.   final String html = "\r\n\r\n\r\n" + "item1\r\n\r\n\r\n\r\n"; HtmlLoadOptions htmlLoadOptions = new HtmlLoadOptions(); htmlLoadOptions.setPreferredControlType(HtmlControlType.STRUCTURED_DOCUMENT_TAG); Document doc = new Document(new ByteArrayInputStream(html.getBytes(StandardCharsets.UTF_8)), htmlLoadOptions); NodeCollection nodes = doc.getChildNodes(NodeType.STRUCTURED_DOCUMENT_TAG, true); StructuredDocumentTag tag = (StructuredDocumentTag) nodes.get(0);

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | İçe aktarılan  ve  öğelerini temsil edecek belge düğümlerinin tercih edilen tipi. Değer, [HtmlControlType](../../com.aspose.words/htmlcontroltype/) sabitlerinden biri olmalıdır. |
...
@font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerini yükleyip yüklemeyeceğini gösteren bir değer ayarlar. Varsayılan değer  false .
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | @font-face kurallarını destekleyip desteklemeyeceğini ve bildirilen yazı tiplerini yükleyip yüklemeyeceğini gösteren bir değer. |
...
VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değeri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | VML görüntülerini destekleyip desteklemeyeceğini gösteren bir değer. |
