...
description: "Java'da ADDRESSBLOCK alanını uygular."
type: docs
weight: 196
url: /tr/java/com.aspose.words/fieldaddressblock/
---
...
Bir adres bloğunu temsil eder. *Adres bloğu*, hedef ülkenin gerektirdiği sırada posta adresi için uygun bilgileri belirten bir metin bloğudur.

 **Examples:** 

Alan tarafından kullanılan birleştirme alanı adlarının nasıl alınacağını gösterir.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Hariç tutulan ülke/bölge adını alır. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceğini alır. |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Ülke/bölge adının dahil edilip edilmeyeceğini alır. |
| [getLanguageId()](#getLanguageId) | Adresi biçimlendirmek için kullanılan dil kimliğini alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Adı ve adres biçimini alır. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Hariç tutulan ülke/bölge adını ayarlar. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceğini ayarlar. |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Ülke/bölge adının dahil edilip edilmeyeceğini ayarlar. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Adresi biçimlendirmek için kullanılan dil kimliğini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Adı ve adres biçimini ayarlar. |
...
Hariç tutulan ülke/bölge adını alır.
...
**Returns:**
java.lang.String - Hariç tutulan ülke/bölge adı.
...
Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceğini alır.
...
**Returns:**
boolean - Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceği.
...
Ülke/bölge adının dahil edilip edilmeyeceğini alır.
...
**Returns:**
java.lang.String - Ülke/bölge adının dahil edilip edilmeyeceği.
...
Adresi biçimlendirmek için kullanılan dil kimliğini alır.
...
**Returns:**
java.lang.String - Adresi biçimlendirmek için kullanılan dil kimliği.
...
**Returns:**
java.lang.String - Adı ve adres biçimi.
### getResult() {#getResult}
```
...
Hariç tutulan ülke/bölge adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Hariç tutulan ülke/bölge adı. |
...
Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Alıcı ülke/bölgesine göre, POST\*CODE (Universal Postal Union 2006) tarafından tanımlandığı gibi adresi biçimlendirip biçimlendirmeyeceği. |
...
Ülke/bölge adının dahil edilip edilmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Ülke/bölge adının dahil edilip edilmeyeceği. |
...
Adresi biçimlendirmek için kullanılan dil kimliğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Adresi biçimlendirmek için kullanılan dil kimliği. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Adı ve adres biçimi. |
