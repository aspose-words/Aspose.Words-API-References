...
description: "Java'da işaretçilerin olası konumlarını belirtir."
type: docs
weight: 32
url: /tr/java/com.aspose.words/axistickmark/
---
...
Tik işaretleri için olası konumları belirtir.
...
| Alan | Açıklama |
| --- | --- |
| [CROSS](#CROSS) | İşaretçilerin ekseni kesmesini belirtir. |
| [INSIDE](#INSIDE) | İşaretçilerin çizim alanının içinde olmasını belirtir. |
| [NONE](#NONE) | İşaretçilerin olmamasını belirtir. |
| [OUTSIDE](#OUTSIDE) | İşaretçilerin çizim alanının dışında olmasını belirtir. |
| [length](#length) |  |
## Yöntemler
...
İşaretçilerin ekseni kesmesini belirtir.
...
İşaretçilerin çizim alanının içinde olmasını belirtir.
...
İşaretçilerin olmamasını belirtir.
...
İşaretçilerin çizim alanının dışında olmasını belirtir.
