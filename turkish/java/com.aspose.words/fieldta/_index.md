...
description: "Java'da TA alanını uygular."
type: docs
weight: 292
url: /tr/java/com.aspose.words/fieldta/
---
...
Yetki tablosu girişinin metnini ve sayfa numarasını tanımlar, bu TOA alanı tarafından kullanılır.
...
| [getEntryCategory()](#getEntryCategory) | Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini alır. |
...
| [getLongCitation()](#getLongCitation) | Giriş için uzun atıfı alır. |
...
| [getShortCitation()](#getShortCitation) | Giriş için kısa atıfı alır. |
| [getStart()](#getStart) | Alan başlangıcını temsil eden düğümü alır. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getType()](#getType) | Microsoft Word alan türünü alır. |
| [isBold()](#isBold) | Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını alır. |
| [isBold(boolean value)](#isBold-boolean) | Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını ayarlar. |
...
| [isItalic()](#isItalic) | Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır. |
| [isItalic(boolean value)](#isItalic-boolean) | Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını ayarlar. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String) | Giriş için uzun atıfı ayarlar. |
...
| [setShortCitation(String value)](#setShortCitation-java.lang.String) | Giriş için kısa atıfı ayarlar. |
...
Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini alır.
...
**Returns:**
java.lang.String - Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisi.
...
**Returns:**
java.lang.String - Giriş için uzun atıf.
...
**Returns:**
java.lang.String - Giriş için kısa atıf.
### getStart() {#getStart}
```
...
Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını alır.
...
**Returns:**
boolean - Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağı.
...
Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Girişin sayfa numarasına kalın biçimlendirme uygulanıp uygulanmayacağı. |
...
Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını alır.
...
**Returns:**
boolean - Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağı.
...
Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Girişin sayfa numarasına italik biçimlendirme uygulanıp uygulanmayacağı. |
...
Kategorilerin sırasına karşılık gelen bir sayı olan bütünsel giriş kategorisini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bütünsel giriş kategorisi, kategorilerin sırasına karşılık gelen bir sayı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Giriş için uzun atıf. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Giriş için kısa atıf. |
