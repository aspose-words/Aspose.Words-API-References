...
description: "Java'da ADVANCE alanını uygular."
type: docs
weight: 197
url: /tr/java/com.aspose.words/fieldadvance/
---
...
Alanı takiben gelen metnin görüntülendiği başlangıç noktasını sağa veya sola, yukarı veya aşağı, ya da belirli bir yatay veya dikey konuma taşır.

 **Examples:** 

Bir ADVANCE alanının nasıl ekleneceğini ve özelliklerinin nasıl düzenleneceğini gösterir.
...
| [getDownOffset()](#getDownOffset) | Alanı takiben gelen metnin aşağı doğru hareket ettirilmesi gereken nokta sayısını alır. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Alanı takiben gelen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak ne kadar nokta kaydırılması gerektiğini alır. |
| [getLeftOffset()](#getLeftOffset) | Alanı takiben gelen metnin sola hareket ettirilmesi gereken nokta sayısını alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getResult()](#getResult) | Alan ayırıcı ile alan sonu arasındaki metni alır. |
| [getRightOffset()](#getRightOffset) | Alanı takiben gelen metnin sağa hareket ettirilmesi gereken nokta sayısını alır. |
...
| [getUpOffset()](#getUpOffset) | Alanı takiben gelen metnin yukarı hareket ettirilmesi gereken nokta sayısını alır. |
| [getVerticalPosition()](#getVerticalPosition) | Alanı takiben gelen metnin sayfanın üst kenarından dikey olarak ne kadar nokta kaydırılması gerektiğini alır. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Alanı takiben gelen metnin aşağı doğru hareket ettirilmesi gereken nokta sayısını ayarlar. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Alanı izleyen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak kaydırılması gereken puan sayısını ayarlar. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Alanı izleyen metnin sola kaydırılması gereken puan sayısını ayarlar. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Alanı izleyen metnin sağa kaydırılması gereken puan sayısını ayarlar. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Alanı izleyen metnin yukarı kaydırılması gereken puan sayısını ayarlar. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Alanı izleyen metnin sayfanın üst kenarından dikey olarak kaydırılması gereken puan sayısını ayarlar. |
...
Alanı takiben gelen metnin aşağı doğru hareket ettirilmesi gereken nokta sayısını alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin aşağı kaydırılması gereken puan sayısı.
### getEnd() {#getEnd}
```
...
Alanı takiben gelen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak ne kadar nokta kaydırılması gerektiğini alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak kaydırılması gereken puan sayısı.
...
Alanı takiben gelen metnin sola hareket ettirilmesi gereken nokta sayısını alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin sola kaydırılması gereken puan sayısı.
...
Alanı takiben gelen metnin sağa hareket ettirilmesi gereken nokta sayısını alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin sağa kaydırılması gereken puan sayısı.
...
Alanı takiben gelen metnin yukarı hareket ettirilmesi gereken nokta sayısını alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin yukarı kaydırılması gereken puan sayısı.
...
Alanı takiben gelen metnin sayfanın üst kenarından dikey olarak ne kadar nokta kaydırılması gerektiğini alır.
...
**Returns:**
java.lang.String - Alanı izleyen metnin sayfanın üst kenarından dikey olarak kaydırılması gereken puan sayısı.
### isDirty() {#isDirty}
```
...
Alanı takiben gelen metnin aşağı doğru hareket ettirilmesi gereken nokta sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin aşağı kaydırılması gereken puan sayısı. |
...
Alanı izleyen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak kaydırılması gereken puan sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin sütunun, çerçevenin veya metin kutusunun sol kenarından yatay olarak kaydırılması gereken puan sayısı. |
...
Alanı izleyen metnin sola kaydırılması gereken puan sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin sola kaydırılması gereken puan sayısı. |
...
Alanı izleyen metnin sağa kaydırılması gereken puan sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin sağa kaydırılması gereken puan sayısı. |
...
Alanı izleyen metnin yukarı kaydırılması gereken puan sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin yukarı kaydırılması gereken puan sayısı. |
...
Alanı izleyen metnin sayfanın üst kenarından dikey olarak kaydırılması gereken puan sayısını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alanı izleyen metnin sayfanın üst kenarından dikey olarak kaydırılması gereken puan sayısı. |
