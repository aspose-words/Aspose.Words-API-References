...
description: "Java'da LoadFormat.TEXT dosyasından içe aktarım sırasında önde gelen boşlukların işlenmesi için mevcut seçenekleri belirtir."
type: docs
weight: 691
url: /tr/java/com.aspose.words/txtleadingspacesoptions/
---
...
İçe aktarım sırasında önde gelen boşlukların işlenmesi için mevcut seçenekleri [LoadFormat.TEXT](../../com.aspose.words/loadformat/\#TEXT) dosyasından belirtir.
...
| Alan | Açıklama |
| --- | --- |
| [CONVERT_TO_INDENT](#CONVERT-TO-INDENT) | Önde gelen boşluklar kaldırılır ve sol girintiye dönüştürülür. |
| [PRESERVE](#PRESERVE) | Önde gelen boşluklar korunur. |
| [TRIM](#TRIM) | Önde gelen boşluklar kırpılır |
| [length](#length) |  |
## Yöntemler
...
Önde gelen boşluklar kaldırılır ve sol girintiye dönüştürülür.
