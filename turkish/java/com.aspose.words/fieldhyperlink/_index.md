...
description: "Java'da HYPERLINK alanını uygular."
type: docs
weight: 242
url: /tr/java/com.aspose.words/fieldhyperlink/
---
...
Seçildiğinde, kontrolün bir yer işareti veya URL gibi bir konuma atlamasını sağlar.

 **Examples:** 

HYPERLINK alanlarını kullanarak yerel dosya sistemindeki belgelere nasıl bağlanılacağını gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getAddress()](#getAddress) | Bu hiperlinkin atladığı konumu alır. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağını alır. |
| [getResult()](#getResult) | Alan ayırıcı ile alan sonu arasındaki metni alır. |
| [getScreenTip()](#getScreenTip) | Köprü için ScreenTip metnini alır. |
...
| [getSubAddress()](#getSubAddress) | Bu köprünün atladığı, örneğin bir yer imi gibi, dosyadaki konumu alır. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | Bağlantının yönlendirilmesi gereken hedefi alır. |
...
| [isImageMap()](#isImageMap) | Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceğini alır. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceğini ayarlar. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Bu köprünün atladığı konumu ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağını ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Köprü için ScreenTip metnini ayarlar. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | Bu köprünün atladığı, örneğin bir yer imi gibi, dosyadaki konumu ayarlar. |
| [setTarget(String value)](#setTarget-java.lang.String) | Bağlantının yönlendirilmesi gereken hedefi ayarlar. |
...
Bu hiperlinkin atladığı konumu alır.
...
**Returns:**
java.lang.String - Bu köprünün atladığı konum.
...
Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağını alır.
...
**Returns:**
boolean - Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağı.
### getResult() {#getResult}
```
...
Köprü için ScreenTip metnini alır.
...
**Returns:**
java.lang.String - Köprü için ScreenTip metni.
...
Bu köprünün atladığı, örneğin bir yer imi gibi, dosyadaki konumu alır.
...
**Returns:**
java.lang.String - Dosyadaki bir konum, örneğin bir yer imi, bu köprünün atladığı yer.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Bağlantının yönlendirilmesi gereken hedefi alır.
...
**Returns:**
java.lang.String - Bağlantının yönlendirilmesi gereken hedef.
### getType() {#getType}
```
public int getType()
```
...
Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceğini alır.
...
**Returns:**
boolean - Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceği.
...
Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Sunucu tarafı görüntü haritası için köprünün koordinatlarını ekleyip eklemeyeceği. |
...
Bu köprünün atladığı konumu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bu köprünün atladığı konum. |
...
Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Hedef sitenin yeni bir web tarayıcı penceresinde açılıp açılmayacağı. |
...
Köprü için ScreenTip metnini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Köprü için ScreenTip metni. |
...
Bu köprünün atladığı, örneğin bir yer imi gibi, dosyadaki konumu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Dosyadaki bir konum, örneğin bir yer imi, bu köprünün atladığı yer. |
...
Bağlantının yönlendirilmesi gereken hedefi ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bağlantının yönlendirilmesi gereken hedef. |
