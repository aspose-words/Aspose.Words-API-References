...
description: "Uygulandığında, Java'da belirli bir alanın güncellenmesi sırasında kullanılacak bir CultureInfo nesnesi sağlar."
type: docs
weight: 767
url: /tr/java/com.aspose.words/ifieldupdatecultureprovider/
---
```
public interface IFieldUpdateCultureProvider
```

Uygulandığında, belirli bir alanın güncellenmesi sırasında kullanılacak bir [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) nesnesi sağlar.

 **Examples:** 

Her alan için tarih/saat biçimlendirmesini çözen bir kültürün nasıl belirtileceğini gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getCulture(String culture, Field field)](#getCulture-java.lang.String-com.aspose.words.Field) | Alan güncellemesi sırasında kullanılacak bir [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) nesnesi döndürür. |
...
Alan güncellemesi sırasında kullanılacak bir [CultureInfo](../../com.aspose.words.net.system.globalization/cultureinfo/) nesnesi döndürür.
...
| --- | --- | --- |
| kültür | java.lang.String | Güncellenmekte olan alan için istenen kültürün adıdır. |
| field | [Field](../../com.aspose.words/field/) | Güncellenen alan. |
