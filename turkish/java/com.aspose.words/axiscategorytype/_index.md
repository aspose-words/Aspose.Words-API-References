...
description: "Java'da kategori ekseninin tipini belirtir."
type: docs
weight: 24
url: /tr/java/com.aspose.words/axiscategorytype/
---
...
Bir kategori ekseninin tipini belirtir.
...
| Alan | Açıklama |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Kategori ekseninin tipinin veriye göre otomatik olarak belirlendiğini belirtir. |
| [CATEGORY](#CATEGORY) | İsteğe bağlı bir kategori kümesinin eksenini belirtir. |
| [TIME](#TIME) | Zaman kategori eksenini belirtir. |
| [length](#length) |  |
## Yöntemler
...
Kategori ekseninin tipinin veriye göre otomatik olarak belirlendiğini belirtir.
...
İsteğe bağlı bir kategori kümesinin eksenini belirtir.
...
Zaman kategori eksenini belirtir.
