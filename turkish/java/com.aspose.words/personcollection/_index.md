...
description: "Java'da bibliyografi kaynağı katkıda bulunan kişilerin bir listesini temsil eder."
type: docs
weight: 546
url: /tr/java/com.aspose.words/personcollection/
---
...
Bibliyografi kaynağı katkı sağlayıcıları olan kişilerin bir listesini temsil eder.
...
| Yapıcı | Açıklama |
| --- | --- |
| [PersonCollection()](#PersonCollection) | Yeni bir [PersonCollection](../../com.aspose.words/personcollection/) sınıfı örneği oluştur. |
| [PersonCollection(Iterable persons)](#PersonCollection-java.lang.Iterable) | Bu sınıfın yeni bir örneğini başlatır. |
| [PersonCollection(Person[] persons)](#PersonCollection-com.aspose.words.Person...) | Yeni bir [PersonCollection](../../com.aspose.words/personcollection/) sınıfı örneği oluştur. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [add(Person person)](#add-com.aspose.words.Person) | [Person](../../com.aspose.words/person/) öğesini koleksiyona ekler. |
| [clear()](#clear) | Koleksiyondaki tüm öğeleri kaldırır. |
| [contains(Person person)](#contains-com.aspose.words.Person) | Koleksiyonun belirli bir kişiyi içerip içermediğini belirler. |
| [get(int index)](#get-int) | Belirtilen indeksteki kişiyi alır. |
| [getCount()](#getCount) | Koleksiyonda bulunan kişi sayısını alır. |
| [iterator()](#iterator) |  |
| [remove(Person person)](#remove-com.aspose.words.Person) | Koleksiyondan kişiyi kaldırır. |
| [removeAt(int index)](#removeAt-int) | Belirtilen indeksteki kişiyi kaldırır. |
| [set(int index, Person value)](#set-int-com.aspose.words.Person) | Belirtilen indekste bir kişiyi ayarlar. |
...
Yeni bir [PersonCollection](../../com.aspose.words/personcollection/) sınıfı örneği oluştur.
...
[Person](../../com.aspose.words/person/) öğesini koleksiyona ekler.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | Koleksiyona eklenecek kişi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | Koleksiyonda bulunacak kişi. |
...
Belirtilen indeksteki kişiyi alır.
...
**Returns:**
int - Koleksiyonda bulunan kişi sayısı.
### iterator() {#iterator}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| person | [Person](../../com.aspose.words/person/) | Koleksiyondan kaldırılacak kişi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Kaldırılacak kişinin sıfır tabanlı indeksi. |
...
Belirtilen indekste bir kişiyi ayarlar.
...
| --- | --- | --- |
| indeks | int | Koleksiyona ait bir indeks. |
| value | [Person](../../com.aspose.words/person/) | Belirtilen indeksteki bir kişi. |
