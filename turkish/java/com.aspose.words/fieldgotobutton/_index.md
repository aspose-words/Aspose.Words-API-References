...
description: "Java'da GOTOBUTTON alanını uygular."
type: docs
weight: 240
url: /tr/java/com.aspose.words/fieldgotobutton/
---
...
Aktifleştirildiğinde belge ekleme noktasını belirtilen konuma taşıyan bir atlama komutu ekler.
...
| [getDisplayText()](#getDisplayText) | Gets the text of the \"button\" that appears in the document, such that it can be selected to activate the jump. |
...
| [getLocation()](#getLocation) | Atlanacak bir yer imi, sayfa numarası veya başka bir öğenin adını alır. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Sets the text of the \"button\" that appears in the document, such that it can be selected to activate the jump. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setLocation(String value)](#setLocation-java.lang.String) | Atlanacak bir yer imi, sayfa numarası veya başka bir öğenin adını ayarlar. |
...
**Returns:**
java.lang.String - Belge içinde görünen "button" metni, böylece seçilip atlamayı etkinleştirebilir.
### getEnd() {#getEnd}
```
...
Atlanacak bir yer imi, sayfa numarası veya başka bir öğenin adını alır.
...
**Returns:**
java.lang.String - Bir yer iminin, sayfa numarasının veya atlanacak başka bir öğenin adı.
### getResult() {#getResult}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belge içinde görünen "button" metni, böylece seçilip atlamayı etkinleştirebilir. |
...
Atlanacak bir yer imi, sayfa numarası veya başka bir öğenin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bir yer iminin, sayfa numarasının veya atlanacak başka bir öğenin adı. |
