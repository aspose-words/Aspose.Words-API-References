...
description: "Java'da bir belgeyi SaveFormat.HTML veya SaveFormat.EPUB formatına dışa aktarırken Aspose.Words'un belge parçalarını nasıl kaydettiğini kontrol etmek ve bildirim almak istiyorsanız bu arabirimi uygulayın."
type: docs
weight: 760
url: /tr/java/com.aspose.words/idocumentpartsavingcallback/
---
```
public interface IDocumentPartSavingCallback
```

Bir belgeyi [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) veya [SaveFormat.EPUB](../../com.aspose.words/saveformat/\#EPUB) formatına dışa aktarırken Aspose.Words'un belge parçalarını nasıl kaydettiğini kontrol etmek ve bildirim almak istiyorsanız bu arabirimi uygulayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [documentPartSaving(DocumentPartSavingArgs args)](#documentPartSaving-com.aspose.words.DocumentPartSavingArgs) | Aspose.Words bir belge parçasını kaydetmek üzereyken çağrılır. |
...
Aspose.Words bir belge parçasını kaydetmek üzereyken çağrılır.
