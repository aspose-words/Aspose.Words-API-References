...
description: "Aspose.Words'in Java'da bir belgeyi HTML olarak kaydederken görüntüleri nasıl kaydettiğini kontrol etmek istiyorsanız bu arabirimi uygulayın."
type: docs
weight: 773
url: /tr/java/com.aspose.words/iimagesavingcallback/
---
```
public interface IImageSavingCallback
```

Aspose.Words'in bir belgeyi HTML olarak kaydederken görüntüleri nasıl kaydettiğini kontrol etmek istiyorsanız bu arabirimi uygulayın. Diğer formatlar tarafından da kullanılabilir.

 **Examples:** 

Markdown belgesine kaydederken görüntü adını yeniden adlandırmayı gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | Aspose.Words bir görüntüyü HTML'ye kaydettiğinde çağrılır. |
...
Aspose.Words bir görüntüyü HTML'ye kaydettiğinde çağrılır.
