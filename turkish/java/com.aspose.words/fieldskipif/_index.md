...
description: "Java'da SKIPIF alanını uygular."
type: docs
weight: 287
url: /tr/java/com.aspose.words/fieldskipif/
---
...
İfadeler [getLeftExpression()](../../com.aspose.words/fieldskipif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldskipif/\#setLeftExpression-java.lang.String) ve [getRightExpression()](../../com.aspose.words/fieldskipif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldskipif/\#setRightExpression-java.lang.String) tarafından belirlenen değerleri, [getComparisonOperator()](../../com.aspose.words/fieldskipif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldskipif/\#setComparisonOperator-java.lang.String) tarafından belirlenen operatörü kullanarak karşılaştırır. Karşılaştırma doğruysa, SKIPIF geçerli birleştirme belgesini iptal eder, veri kaynağındaki bir sonraki veri kaydına geçer ve yeni bir birleştirme belgesi başlatır. Karşılaştırma yanlışsa, geçerli birleştirme belgesi devam eder.

 **Examples:** 

SKIPIF alanını kullanarak bir posta birleştirmesinde sayfaların nasıl atlanacağını gösterir.
