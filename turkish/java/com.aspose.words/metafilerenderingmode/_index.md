...
description: "Aspose.Words'ün Java'da WMF ve EMF metafilelerini nasıl işleyeceğini belirtir."
type: docs
weight: 467
url: /tr/java/com.aspose.words/metafilerenderingmode/
---
...
Aspose.Words'un WMF ve EMF metafilelerini nasıl render etmesi gerektiğini belirtir.
...
| Alan | Açıklama |
| --- | --- |
| [BITMAP](#BITMAP) | Aspose.Words, bir metafile'ı bitmap'e renderlemek için GDI+ çağırır ve ardından bitmap'i çıktı belgesine kaydeder. |
| [VECTOR](#VECTOR) | Aspose.Words, bir metafile'ı vektör grafiği olarak renderler. |
| [VECTOR_WITH_FALLBACK](#VECTOR-WITH-FALLBACK) | Aspose.Words, bir metafile'ı vektör grafiği olarak renderlemeye çalışır. |
| [length](#length) |  |
## Yöntemler
...
Aspose.Words, bir metafile'ı bitmap'e renderlemek için GDI+ çağırır ve ardından bitmap'i çıktı belgesine kaydeder.
...
Aspose.Words, bir metafile'ı vektör grafiği olarak renderler.
...
Aspose.Words, bir metafile'ı vektör grafiği olarak renderlemeye çalışır. Aspose.Words, metafile kayıtlarının bazılarını vektör grafiğine doğru şekilde renderleyemezse, bu metafile'ı bitmap olarak renderler.
