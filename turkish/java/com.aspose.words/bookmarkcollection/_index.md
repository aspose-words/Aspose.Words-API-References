...
description: "Belirtilen aralıktaki yer imlerini temsil eden Bookmark nesnelerinin bir koleksiyonu."
type: docs
weight: 42
url: /tr/java/com.aspose.words/bookmarkcollection/
---
...
Belirtilen aralıktaki yer imlerini temsil eden [Bookmark](../../com.aspose.words/bookmark/) nesnelerinin bir koleksiyonu.
...
| [get(int index)](#get-int) | Belirtilen dizinde bir yer imi döndürür. |
| [get(String bookmarkName)](#get-java.lang.String) | İsme göre bir yer imi döndürür. |
| [getCount()](#getCount) | Koleksiyondaki yer imlerinin sayısını döndürür. |
| [iterator()](#iterator) | Bir enumerator nesnesi döndürür. |
| [remove(Bookmark bookmark)](#remove-com.aspose.words.Bookmark) | Belirtilen yer imini belgeden kaldırır. |
| [remove(String bookmarkName)](#remove-java.lang.String) | Belirtilen isimdeki bir yer imini kaldırır. |
...
Bu koleksiyondaki ve belgedeki tüm yer imlerini kaldırır.
...
İsme göre bir yer imi döndürür.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bookmarkName | java.lang.String | Yer iminin büyük/küçük harfe duyarsız adı. |
...
**Returns:**
int - Koleksiyondaki yer imlerinin sayısı.
### iterator() {#iterator}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bookmark | [Bookmark](../../com.aspose.words/bookmark/) | Kaldırılacak yer imi. |
...
Belirtilen isimdeki bir yer imini kaldırır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bookmarkName | java.lang.String | Kaldırılacak yer iminin büyük/küçük harfe duyarsız adı. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Kaldırılacak yer iminin sıfır tabanlı dizini. |
