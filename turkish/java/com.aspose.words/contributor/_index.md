...
description: "Java'da bir bibliyografi kaynağı katkı sağlayıcısını temsil eder."
type: docs
weight: 128
url: /tr/java/com.aspose.words/contributor/
---
...
Bir bibliyografi kaynağı katkı sağlayıcısını temsil eder. Kurumsal (bir organizasyon) ya da bir kişi listesi olabilir.
