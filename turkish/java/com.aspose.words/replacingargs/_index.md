...
description: "Java'da özel bir değiştirme işlemi için veri sağlar."
type: docs
weight: 569
url: /tr/java/com.aspose.words/replacingargs/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [getGroupIndex()](#getGroupIndex) | İndeksine göre, [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) içinde yakalanan bir grubu, [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String) dizesiyle değiştirilmek üzere tanımlar. |
| [getMatch()](#getMatch) | Bir **Replace** işlemi sırasında tek bir düzenli ifade eşleşmesinden elde edilen java.util.regex.Matcher. |
| [getMatchEndNode()](#getMatchEndNode) | Eşleşmenin sonunu içeren düğümü alır. |
| [getMatchNode()](#getMatchNode) | Eşleşmenin başlangıcını içeren düğümü alır. |
| [getMatchOffset()](#getMatchOffset) | Eşleşmenin başlangıcını içeren düğümün başlangıcından itibaren, eşleşmenin sıfır tabanlı başlangıç konumunu alır. |
| [getReplacement()](#getReplacement) | Değiştirme dizesini alır. |
| [setGroupIndex(int value)](#setGroupIndex-int) | İndeksine göre, [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) içinde yakalanan bir grubu, [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String) dizesiyle değiştirilmek üzere tanımlar. |
| [setReplacement(String value)](#setReplacement-java.lang.String) | Değiştirme dizesini ayarlar. |
...
İndeksine göre, [getMatch()](../../com.aspose.words/replacingargs/\#getMatch) içinde yakalanan bir grubu, [getReplacement()](../../com.aspose.words/replacingargs/\#getReplacement) / [setReplacement(java.lang.String)](../../com.aspose.words/replacingargs/\#setReplacement-java.lang.String) dizesiyle değiştirilmek üzere tanımlar.
...
Bir **Replace** işlemi sırasında tek bir düzenli ifade eşleşmesinden elde edilen java.util.regex.Matcher.

 **Remarks:** 

Matcher.start() eşleşmenin, bul ve değiştir aralığının başlangıcından itibaren sıfır tabanlı başlangıç konumunu alır.
...
**Returns:**
java.util.regex.Matcher - İlgili java.util.regex.Matcher değeri.
...
Eşleşmenin sonunu içeren düğümü alır.

 **Examples:** 

Eşleşmenin son düğümünü nasıl alacağınızı gösterir.
...
**Returns:**
int - Eşleşmenin başlangıcını içeren düğümün başlangıcından itibaren, sıfır tabanlı başlangıç konumu.
...
**Returns:**
java.lang.String - Yerine koyma dizesi.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Yerine koyma dizesi. |
