...
description: "Java'da grafik şekil özelliklerine erişim sağlar."
type: docs
weight: 66
url: /tr/java/com.aspose.words/chart/
---
...
Grafik şekil özelliklerine erişim sağlar.
...
| Yöntem | Açıklama |
| --- | --- |
| [getAxes()](#getAxes) | Bu grafiğin tüm eksenlerinin bir koleksiyonunu alır. |
| [getAxisX()](#getAxisX) | Grafiğin birincil X ekseninin özelliklerine erişim sağlar. |
| [getAxisY()](#getAxisY) | Grafiğin birincil Y ekseninin özelliklerine erişim sağlar. |
| [getAxisZ()](#getAxisZ) | Grafiğin Z ekseninin özelliklerine erişim sağlar. |
| [getDataTable()](#getDataTable) | Bu grafiğin veri tablosunun özelliklerine erişim sağlar. |
| [getFormat()](#getFormat) | Grafiğin dolgu ve çizgi biçimlendirmesine erişim sağlar. |
| [getLegend()](#getLegend) | Grafik açıklama özelliklerine erişim sağlar. |
| [getSeries()](#getSeries) | Seri koleksiyonuna erişim sağlar. |
| [getSeriesGroups()](#getSeriesGroups) | Bu grafiğin bir seri grup koleksiyonuna erişim sağlar. |
| [getShapeType()](#getShapeType) |  |
| [getSourceFullName()](#getSourceFullName) | Bu grafiğin bağlı olduğu xls/xlsx dosyasının yolunu ve adını alır. |
| [getStyle()](#getStyle) | Grafiğin stilini alır. |
| [getTitle()](#getTitle) | Grafik başlığı özelliklerine erişim sağlar. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Bu grafiğin bağlı olduğu xls/xlsx dosyasının yolunu ve adını alır. |
| [setStyle(int value)](#setStyle-int) | Grafiğin stilini ayarlar. |
### getAxes() {#getAxes}
```
...
Grafiğin birincil X ekseninin özelliklerine erişim sağlar.
...
Grafiğin Z ekseninin özelliklerine erişim sağlar.
...
Bu grafiğin veri tablosunun özelliklerine erişim sağlar. Veri tablosu, [ChartDataTable.getShow()](../../com.aspose.words/chartdatatable/\#getShow) / [ChartDataTable.setShow(boolean)](../../com.aspose.words/chartdatatable/\#setShow-boolean) özelliği kullanılarak gösterilebilir.
...
Grafiğin dolgu ve çizgi biçimlendirmesine erişim sağlar.
...
Seri koleksiyonuna erişim sağlar.
...
Bu grafiğin bir seri grup koleksiyonuna erişim sağlar.
...
Grafik bağlıysa dış xls/xlsx belgesinin tam adını nasıl alıp ayarlayacağınızı gösterir.
...
**Returns:**
java.lang.String - Bu grafiğin bağlı olduğu xls/xlsx dosyasının yol ve adı.
### getStyle() {#getStyle}
```
public int getStyle()
```
...
Grafiğin stilini alır.

**Returns:**
int - Grafiğin stili. Döndürülen değer, [ChartStyle](../../com.aspose.words/chartstyle/) sabitlerinden biridir.
### getTitle() {#getTitle}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bu grafiğin bağlı olduğu xls/xlsx dosyasının yol ve adı. |
...
Grafiğin stilini ayarlar.

**Parameters:**
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | Grafiğin stili. Değer, [ChartStyle](../../com.aspose.words/chartstyle/) sabitlerinden biri olmalıdır. |
