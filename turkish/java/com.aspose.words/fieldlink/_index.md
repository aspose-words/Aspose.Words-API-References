...
description: "Java'da LINK alanını uygular."
type: docs
weight: 254
url: /tr/java/com.aspose.words/fieldlink/
---
...
Başka bir uygulamadan kopyalanan bilgiler için, bu alan o bilgiyi orijinal kaynak dosyasına bağlar.
...
| [getFormatUpdateType()](#getFormatUpdateType) | Bağlı nesnenin biçimlendirmesini güncelleme yolunu alır. |
...
| [setFormatUpdateType(String value)](#setFormatUpdateType-java.lang.String) | Bağlı nesnenin biçimlendirmesini güncelleme yolunu ayarlar. |
...
Bağlı nesnenin biçimlendirmesini güncelleme yolunu alır.
...
**Returns:**
java.lang.String - Bağlı nesnenin biçimlendirmesini güncelleme yolu.
...
Bağlı nesnenin biçimlendirmesini güncelleme yolunu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bağlı nesnenin biçimlendirmesini güncelleme yolu. |
