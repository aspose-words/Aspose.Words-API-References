...
description: "Java'da belgede düğümler eklendiğinde veya kaldırıldığında bildirim almak istiyorsanız bu arayüzü uygulayın."
type: docs
weight: 778
url: /tr/java/com.aspose.words/inodechangingcallback/
---
```
public interface INodeChangingCallback
```

Belgede düğümler eklendiğinde veya kaldırıldığında bildirimler almak istiyorsanız bu arabirimi uygulayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [nodeInserted(NodeChangingArgs args)](#nodeInserted-com.aspose.words.NodeChangingArgs) | Bu belgeye ait bir düğüm başka bir düğüme eklendiğinde çağrılır. |
| [nodeInserting(NodeChangingArgs args)](#nodeInserting-com.aspose.words.NodeChangingArgs) | Bu belgeye ait bir düğüm başka bir düğüme eklenmek üzereyken hemen önce çağrılır. |
| [nodeRemoved(NodeChangingArgs args)](#nodeRemoved-com.aspose.words.NodeChangingArgs) | Bu belgeye ait bir düğüm ebeveyninden kaldırıldığında çağrılır. |
| [nodeRemoving(NodeChangingArgs args)](#nodeRemoving-com.aspose.words.NodeChangingArgs) | Bu belgeye ait bir düğüm belgeden kaldırılmak üzereyken hemen önce çağrılır. |
...
Bu belgeye ait bir düğüm başka bir düğüme eklenmek üzereyken hemen önce çağrılır.
...
Bu belgeye ait bir düğüm ebeveyninden kaldırıldığında çağrılır.
...
Bu belgeye ait bir düğüm belgeden kaldırılmak üzereyken hemen önce çağrılır.
