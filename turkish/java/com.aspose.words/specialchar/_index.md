...
description: "Java'da belgede özel karakterler için temel sınıf."
type: docs
weight: 628
url: /tr/java/com.aspose.words/specialchar/
---
...
Bir Microsoft Word belgesi, alanlar, form alanları, şekiller, OLE nesneleri, dipnotlar vb. temsil eden bir dizi özel karakter içerebilir. Özel karakterlerin listesi için [ControlChar](../../com.aspose.words/controlchar/) bakın.

[SpecialChar](../../com.aspose.words/specialchar/) is an inline-node and can only be a child of [Paragraph](../../com.aspose.words/paragraph/).

[SpecialChar](../../com.aspose.words/specialchar/) char is used as a base class for more specific classes that represent special characters that Aspose.Words provides programmatic access for. The [SpecialChar](../../com.aspose.words/specialchar/) class is also used itself to represent special character for which Aspose.Words does not provide detailed programmatic access.
...
| [getFont()](#getFont) | Bu nesnenin yazı tipi biçimlendirmesine erişim sağlar. |
| [getNextSibling()](#getNextSibling) | Bu düğümü hemen izleyen düğümü alır. |
| [getNodeType()](#getNodeType) | Döndürür [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). |
| [getParentNode()](#getParentNode) | Bu düğümün hemen üst ebeveynini alır. |
| [getParentParagraph()](#getParentParagraph) | Bu düğümün üst [Paragraph](../../com.aspose.words/paragraph/) öğesini alır. |
...
| [getText()](#getText) | Bu düğümün temsil ettiği özel karakteri alır. |
...
[DocumentVisitor.visitSpecialChar(com.aspose.words.SpecialChar)](../../com.aspose.words/documentvisitor/\#visitSpecialChar-com.aspose.words.SpecialChar) metodunu çağırır.
...
| --- | --- | --- |
| visitor | [DocumentVisitor](../../com.aspose.words/documentvisitor/) | Düğümü ziyaret edecek ziyaretçi. |

**Returns:**
boolean - ziyaretçi yinelemeyi durdurmak istediğinde false.
### clearRunAttrs() {#clearRunAttrs}
```
...
Döndürür [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR).
...
**Returns:**
int - [NodeType.SPECIAL\_CHAR](../../com.aspose.words/nodetype/\#SPECIAL-CHAR). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
...
Bu düğümün üst [Paragraph](../../com.aspose.words/paragraph/) öğesini alır.
...
**Returns:**
java.lang.String - Bu düğümün temsil ettiği karakteri içeren dize.
