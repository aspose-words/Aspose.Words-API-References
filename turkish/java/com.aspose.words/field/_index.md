...
description: "Java'da bir Microsoft Word belge alanını temsil eder."
type: docs
weight: 194
url: /tr/java/com.aspose.words/field/
---
...
Word belgesindeki bir alan, alan başlangıcı, alan kodu, alan ayırıcı, alan sonucu ve alan sonu gibi birden çok düğümden oluşan karmaşık bir yapıdır. Alanlar iç içe olabilir, zengin içerik barındırabilir ve bir belgede birden çok paragraf veya bölümü kapsayabilir. [Field](../../com.aspose.words/field/) sınıfı, bir alanla tek bir nesne gibi çalışmayı sağlayan özellikler ve yöntemler sunan bir "facade" (fasad) nesnedir.

Bu [getStart()](../../com.aspose.words/field/\#getStart), [getSeparator()](../../com.aspose.words/field/\#getSeparator) ve [getEnd()](../../com.aspose.words/field/\#getEnd) özellikleri, alanın başlangıç, ayırıcı ve bitiş düğümlerine sırasıyla işaret eder.

Alan başlangıcı ile ayırıcı arasındaki içerik alan kodudur. Alan ayırıcı ile alan sonu arasındaki içerik alan sonucudur. Alan kodu genellikle talimatları belirten bir veya daha fazla [Run](../../com.aspose.words/run/) nesnesinden oluşur. İşleme uygulamasının, alan sonucunu hesaplamak için alan kodunu yürütmesi beklenir.

Alan sonuçlarını hesaplama sürecine alan güncellemesi denir. Aspose.Words, çoğu alan türünün sonuçlarını Microsoft Word'ün yaptığı aynı şekilde güncelleyebilir. Özellikle, Aspose.Words en karmaşık formül alanlarının bile sonuçlarını hesaplayabilir. Tek bir alanın sonucunu hesaplamak için [update()](../../com.aspose.words/field/\#update) yöntemini kullanın. Tüm belgede alanları güncellemek için [Document.updateFields()](../../com.aspose.words/document/\#updateFields) yöntemini kullanın.

[getFieldCode(boolean)](../../com.aspose.words/field/\#getFieldCode-boolean) yöntemini kullanarak alan kodunun düz metin sürümünü alabilirsiniz. Alan sonucunun düz metin sürümünü [getResult()](../../com.aspose.words/field/\#getResult) / [setResult(java.lang.String)](../../com.aspose.words/field/\#setResult-java.lang.String) özelliğiyle alıp ayarlayabilirsiniz. Hem alan kodu hem de alan sonucu, iç içe alanlar, paragraflar, şekiller, tablolar gibi karmaşık içerikler içerebilir; bu durumda daha fazla kontrol gerektiğinde alan düğümleriyle doğrudan çalışmak isteyebilirsiniz.

[Field](../../com.aspose.words/field/) sınıfının örneklerini doğrudan oluşturmazsınız. Yeni bir alan oluşturmak için [DocumentBuilder.insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String) yöntemini kullanın.
