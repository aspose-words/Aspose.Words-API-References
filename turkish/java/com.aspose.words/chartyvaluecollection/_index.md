...
description: "Java'da bir grafik serisi için Y değerlerinin bir koleksiyonunu temsil eder."
type: docs
weight: 98
url: /tr/java/com.aspose.words/chartyvaluecollection/
---
...
Koleksiyondaki **null** dışındaki tüm öğeler aynı [ChartYValue.getValueType()](../../com.aspose.words/chartyvalue/\#getValueType) olmalıdır.

Koleksiyon yalnızca Y değerlerini değiştirmeye izin verir. Bir grafik serisine yeni değerler eklemek veya eklemek ya da değerleri kaldırmak için, [ChartSeries](../../com.aspose.words/chartseries/) sınıfının uygun yöntemleri kullanılabilir.
...
| Yöntem | Açıklama |
| --- | --- |
| [get(int index)](#get-int) | Belirtilen indeksteki Y değerini alır. |
| [getCount()](#getCount) | Bu koleksiyondaki öğe sayısını alır. |
| [getFormatCode()](#getFormatCode) | Y değerlerine uygulanan format kodunu alır. |
| [iterator()](#iterator) | Bir enumerator nesnesi döndürür. |
| [set(int index, ChartYValue value)](#set-int-com.aspose.words.ChartYValue) | Belirtilen indeksteki Y değerini ayarlar. |
| [setFormatCode(String value)](#setFormatCode-java.lang.String) | Y değerlerine uygulanan format kodunu ayarlar. |
...
Belirtilen indeksteki Y değerini alır.
...
Y değerlerine uygulanan format kodunu alır.
...
**Returns:**
java.lang.String - Y değerlerine uygulanan biçim kodu.
### iterator() {#iterator}
```
...
Belirtilen indeksteki Y değerini ayarlar.
...
| --- | --- | --- |
| indeks | int |  |
| value | [ChartYValue](../../com.aspose.words/chartyvalue/) | Belirtilen indeksdeki Y değeri. |
...
Y değerlerine uygulanan format kodunu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Y değerlerine uygulanan biçim kodu. |
