...
description: "Java'da belgede mevcut olan bibliyografya kaynaklarının listesini temsil eder."
type: docs
weight: 38
url: /tr/java/com.aspose.words/bibliography/
---
...
Belgede mevcut olan bibliyografi kaynaklarının listesini temsil eder.
...
| Yöntem | Açıklama |
| --- | --- |
| [getBibliographyStyle()](#getBibliographyStyle) | Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize alır. |
| [getSources()](#getSources) | Bir bibliyografide bulunan tüm kaynakları temsil eden bir koleksiyon alır. |
| [setBibliographyStyle(String value)](#setBibliographyStyle-java.lang.String) | Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize ayarlar. |
...
Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize alır.
...
**Returns:**
java.lang.String - Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize.
...
Bir bibliyografide bulunan tüm kaynakları temsil eden bir koleksiyon alır.
...
**Returns:**
java.util.ArrayList - Bir bibliyografide bulunan tüm kaynakları temsil eden bir koleksiyon.
...
Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize ayarlar.
...
| --- | --- | --- |
| değer | java.lang.String | Bir bibliyografide kullanılacak aktif stilin adını temsil eden bir dize. |
