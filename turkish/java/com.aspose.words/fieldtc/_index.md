...
description: "Java'da TC alanını uygular."
type: docs
weight: 293
url: /tr/java/com.aspose.words/fieldtc/
---
...
Bir içindekiler tablosu (şekil tablosu dahil) girdisi için metni ve sayfa numarasını tanımlar; bu, bir TOC alanı tarafından kullanılır.

 **Examples:** 

Bir TOC alanı eklemenin ve hangi TC alanlarının giriş olarak sonlanacağını filtrelemenin nasıl yapılacağını gösterir.
...
| [getEntryLevel()](#getEntryLevel) | Girdinin seviyesini alır. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını alır. |
...
| [getTypeIdentifier()](#getTypeIdentifier) | Bu alan için bir tip tanımlayıcısını alır (genellikle bir harf olur). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Girdinin seviyesini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını ayarlar. |
...
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Bu alan için bir tip tanımlayıcısını ayarlar (genellikle bir harf olur). |
...
**Returns:**
java.lang.String - Girdinin seviyesi.
...
Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını alır.
...
**Returns:**
boolean - Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağı.
### getPageNumber() {#getPageNumber}
```
...
Bu alan için bir tip tanımlayıcısını alır (genellikle bir harf olur).
...
**Returns:**
java.lang.String - Bu alan için bir tip tanımlayıcısı (genellikle bir harf).
### hasBookmark() {#hasBookmark}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Girdinin seviyesi. |
...
Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Bu alan için TOC'deki sayfa numarasının atlanıp atlanmayacağı. |
...
Bu alan için bir tip tanımlayıcısını ayarlar (genellikle bir harf olur).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bu alan için bir tip tanımlayıcısı (genellikle bir harf olan). |
