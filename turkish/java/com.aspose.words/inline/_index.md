...
description: "Java'da karakter biçimlendirmesiyle ilişkilendirilebilen ancak kendi alt düğümlerine sahip olamayan satır içi düzeyindeki düğümler için temel sınıf."
type: docs
weight: 403
url: /tr/java/com.aspose.words/inline/
---
...
Kendi alt düğümlerine sahip olamayan, ancak karakter biçimlendirmesiyle ilişkilendirilebilen satır içi düzey düğümler için temel sınıf.

Daha fazla bilgi edinmek için, [ Logical Levels of Nodes in a Document ][Logical Levels of Nodes in a Document] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

[Inline](../../com.aspose.words/inline/) sınıfından türetilen bir sınıf, [Paragraph](../../com.aspose.words/paragraph/) sınıfının çocuğu olabilir.
...
| [getNodeType()](#getNodeType) | Bu düğümün tipini alır. |
...
**Returns:**
int - Bu düğümün tipi. Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
