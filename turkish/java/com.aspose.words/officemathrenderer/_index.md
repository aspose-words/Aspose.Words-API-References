...
description: "Java'da bireysel bir OfficeMath'i raster veya vektör görüntüye ya da bir Graphics nesnesine render etmek için yöntemler sağlar."
type: docs
weight: 499
url: /tr/java/com.aspose.words/officemathrenderer/
---
...
Bireysel bir [OfficeMath](../../com.aspose.words/officemath/) öğesini raster veya vektör görüntüye ya da bir Graphics nesnesine render etmek için yöntemler sağlar.

Daha fazla bilgi edinmek için, [ Working with OfficeMath ][Working with OfficeMath] dokümantasyon makalesini ziyaret edin.
...
| Yapıcı | Açıklama |
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | Render etmek istediğiniz [OfficeMath](../../com.aspose.words/officemath/) nesnesi. |
