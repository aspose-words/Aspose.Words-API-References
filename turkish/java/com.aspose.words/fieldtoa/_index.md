...
description: "Java'da TOA alanını uygular."
type: docs
weight: 297
url: /tr/java/com.aspose.words/fieldtoa/
---
...
TA alanları tarafından belirtilen girişleri kullanarak bir yetki tablosu (yani bir yasal belgede, örneğin davalar, kanunlar ve kurallar gibi referansların ve bu referansların göründüğü sayfa numaralarının bir listesi) oluşturur.

 **Examples:** 

TOA ve TA alanlarını kullanarak bir yetki tablosu oluşturmanın ve özelleştirmenin nasıl yapılacağını gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Tabloyu oluşturmak için kullanılan belgenin bölümünü işaretleyen yer iminin adını alır. |
...
| [getEntryCategory()](#getEntryCategory) | Tabloda yer alan girişler için tam kategoriyi alır. |
| [getEntrySeparator()](#getEntrySeparator) | Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisini alır. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Belgedeki giriş metninin biçimlendirmesinin yetki tablosundaki girişten kaldırılıp kaldırılmayacağını alır. |
...
| [getUseHeading()](#getUseHeading) | Yetki tablosundaki girişler için kategori başlığının dahil edilip edilmeyeceğini alır. |
| [getUsePassim()](#getUsePassim) | Aynı yetkiye beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan "passim" ile değiştirip değiştirmeyeceğini alır. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Tabloyu oluşturmak için kullanılan belgenin bölümünü işaretleyen yer iminin adını ayarlar. |
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Tabloda yer alan girişler için tam kategoriyi ayarlar. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisini ayarlar. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Belgedeki giriş metninin biçimlendirmesinin yetki tablosundaki girişten kaldırılıp kaldırılmayacağını ayarlar. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Yetki tablosundaki girişler için kategori başlığının dahil edilip edilmeyeceğini ayarlar. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Aynı yetkiye beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan "passim" ile değiştirip değiştirmeyeceğini ayarlar. |
...
Tabloyu oluşturmak için kullanılan belgenin bölümünü işaretleyen yer iminin adını alır.
...
**Returns:**
java.lang.String - Tabloyu oluşturmak için kullanılan belgenin bölümünü işaretleyen yer iminin adı.
...
Tabloda yer alan girişler için tam kategoriyi alır.
...
**Returns:**
java.lang.String - Tabloya dahil edilen girişler için tam kategori.
...
Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisini alır.
...
**Returns:**
java.lang.String - Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisi.
...
Belgedeki giriş metninin biçimlendirmesinin yetki tablosundaki girişten kaldırılıp kaldırılmayacağını alır.
...
**Returns:**
boolean - Belge içindeki giriş metninin biçimlendirmesini yetki tablosundaki girişten kaldırıp kaldırmayacağı.
### getResult() {#getResult}
```
...
Yetki tablosundaki girişler için kategori başlığının dahil edilip edilmeyeceğini alır.
...
**Returns:**
boolean - Yetki tablosundaki girişler için kategori başlığının eklenip eklenmeyeceği.
...
Aynı yetkiye beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan "passim" ile değiştirip değiştirmeyeceğini alır.
...
**Returns:**
boolean - Aynı yetkiye ait beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan \"passim\" ile değiştirip değiştirmeyeceği.
### isDirty() {#isDirty}
```
...
Tabloyu oluşturmak için kullanılan belgenin bölümünü işaretleyen yer iminin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Tablonun oluşturulması için kullanılan belge bölümünü işaretleyen yer iminin adı. |
...
Tabloda yer alan girişler için tam kategoriyi ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Tabloya dahil edilen girişler için bütünsel kategori. |
...
Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Yetki tablosu girişini ve sayfa numarasını ayırmak için kullanılan karakter dizisi. |
...
Belgedeki giriş metninin biçimlendirmesinin yetki tablosundaki girişten kaldırılıp kaldırılmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Belge içindeki giriş metninin biçimlendirmesini yetki tablosundaki girişten kaldırıp kaldırmayacağı. |
...
Yetki tablosundaki girişler için kategori başlığının dahil edilip edilmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yetki tablosundaki girişler için kategori başlığının eklenip eklenmeyeceği. |
...
Aynı yetkiye beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan "passim" ile değiştirip değiştirmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Aynı yetkiye ait beş veya daha fazla farklı sayfa referansını, alıntılanan eserde bir kelime ya da pasajın sıkça geçtiğini göstermek için kullanılan \"passim\" ile değiştirip değiştirmeyeceği. |
