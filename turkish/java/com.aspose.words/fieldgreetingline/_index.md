...
description: "Java'da GREETINGLINE alanını uygular."
type: docs
weight: 241
url: /tr/java/com.aspose.words/fieldgreetingline/
---
...
| Yöntem | Açıklama |
| --- | --- |
| [getAlternateText()](#getAlternateText) | İsim boşsa alana dahil edilecek metni alır. |
...
| [getFieldNames()](#getFieldNames) | Alan tarafından kullanılan birleştirme posta alan adlarının bir koleksiyonunu döndürür. |
...
| [getLanguageId()](#getLanguageId) | İsmi biçimlendirmek için kullanılan dil kimliğini alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | Alana dahil edilen ismin biçimini alır. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | İsim boşsa alana dahil edilecek metni ayarlar. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | İsmi biçimlendirmek için kullanılan dil kimliğini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Alana dahil edilen ismin biçimini ayarlar. |
...
İsim boşsa alana dahil edilecek metni alır.
...
**Returns:**
java.lang.String - İsim boşsa alana dahil edilecek metin.
...
Alan tarafından kullanılan birleştirme posta alan adlarının bir koleksiyonunu döndürür.
...
İsmi biçimlendirmek için kullanılan dil kimliğini alır.
...
**Returns:**
java.lang.String - İsmi biçimlendirmek için kullanılan dil kimliği.
...
Alana dahil edilen ismin biçimini alır.
...
**Returns:**
java.lang.String - Alana dahil edilen ismin biçimi.
### getResult() {#getResult}
```
...
İsim boşsa alana dahil edilecek metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | İsim boşsa alana dahil edilecek metin. |
...
İsmi biçimlendirmek için kullanılan dil kimliğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | İsmi biçimlendirmek için kullanılan dil kimliği. |
...
Alana dahil edilen ismin biçimini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alana dahil edilen ismin biçimi. |
