...
description: "Java'da AUTHOR alanını uygular."
type: docs
weight: 200
url: /tr/java/com.aspose.words/fieldauthor/
---
...
Yerleşik belge özelliklerinin **Author** özelliğinde kaydedildiği gibi, belge yazarının adını alır ve isteğe bağlı olarak ayarlar.
...
| Yöntem | Açıklama |
| --- | --- |
| [getAuthorName()](#getAuthorName) | Belge yazarının adını alır. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Belge yazarının adını ayarlar. |
...
**Returns:**
java.lang.String - Belge yazarının adı.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belge yazarının adı. |
