...
description: "Java'da değiştirme işlemleri için yönü belirtir."
type: docs
weight: 313
url: /tr/java/com.aspose.words/findreplacedirection/
---
...
| Alan | Açıklama |
| --- | --- |
| [BACKWARD](#BACKWARD) | Eşleşen öğeler sonuncudan ilkine doğru değiştirilir. |
| [FORWARD](#FORWARD) | Eşleşen öğeler ilk olandan sona doğru değiştirilir. |
| [length](#length) |  |
## Yöntemler
...
Eşleşen öğeler sonuncudan ilkine doğru değiştirilir.
...
Eşleşen öğeler ilk olandan sona doğru değiştirilir.
