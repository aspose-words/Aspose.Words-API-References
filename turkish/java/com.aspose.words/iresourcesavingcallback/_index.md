...
description: "Java'da bir belgeyi sabit sayfa HTML veya SVG olarak kaydederken Aspose.Words dış kaynakları (görseller, yazı tipleri ve css) nasıl kaydeder kontrol etmek istiyorsanız bu arayüzü uygulayın."
type: docs
weight: 783
url: /tr/java/com.aspose.words/iresourcesavingcallback/
---
```
public interface IResourceSavingCallback
```

Bir belgeyi sabit sayfa HTML veya SVG olarak kaydederken Aspose.Words'un harici kaynakları (görüntüler, yazı tipleri ve css) nasıl kaydettiğini kontrol etmek istiyorsanız bu arabirimi uygulayın.
...
Kaynak URI'sını değiştirmek için bir geri çağırma (callback) nasıl kullanılacağını gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [resourceSaving(ResourceSavingArgs args)](#resourceSaving-com.aspose.words.ResourceSavingArgs) | Aspose.Words bir dış kaynağı sabit sayfa HTML veya SVG formatlarına kaydettiğinde çağrılır. |
...
Aspose.Words bir dış kaynağı sabit sayfa HTML veya SVG formatlarına kaydettiğinde çağrılır.
