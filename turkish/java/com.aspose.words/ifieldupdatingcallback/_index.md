...
description: "Bu arayüzü uygulayın, Java'da bir alan güncellemesi sırasında çağrılan kendi özel yöntemlerinizi kullanmak istiyorsanız."
type: docs
weight: 768
url: /tr/java/com.aspose.words/ifieldupdatingcallback/
---
```
public interface IFieldUpdatingCallback
```

Bir alan güncellenirken kendi özel yöntemlerinizin çağrılmasını istiyorsanız bu arabirimi uygulayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [fieldUpdated(Field field)](#fieldUpdated-com.aspose.words.Field) | Bir alan güncellendikten hemen sonra çağrılan kullanıcı tanımlı bir yöntem. |
| [fieldUpdating(Field field)](#fieldUpdating-com.aspose.words.Field) | Bir alan güncellenmeden hemen önce çağrılan kullanıcı tanımlı bir yöntem. |
