...
description: "Java'da AUTOTEXTLIST alanını uygular."
type: docs
weight: 205
url: /tr/java/com.aspose.words/fieldautotextlist/
---
...
Etkin şablondaki AutoText girişlerine dayalı bir kısayol menüsü oluşturur.

 **Examples:** 

Bir AUTOTEXTLIST alanını kullanarak AutoText girişleri listesinden seçim yapmayı gösterir.
...
| [getEntryName()](#getEntryName) | AutoText girişinin adını alır. |
...
| [getListStyle()](#getListStyle) | Girişleri içerecek listenin dayandığı stilin adını alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getResult()](#getResult) | Alan ayırıcı ile alan sonu arasındaki metni alır. |
| [getScreenTip()](#getScreenTip) | Gösterilecek ScreenTip metnini alır. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | AutoText girişinin adını ayarlar. |
| [setListStyle(String value)](#setListStyle-java.lang.String) | Girişleri içerecek listenin dayandığı stilin adını ayarlar. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Gösterilecek ScreenTip metnini ayarlar. |
...
**Returns:**
java.lang.String - AutoText girişinin adı.
...
Girişleri içerecek listenin dayandığı stilin adını alır.
...
**Returns:**
java.lang.String - Girişleri içerecek listenin dayandığı stilin adı.
...
Gösterilecek ScreenTip metnini alır.
...
**Returns:**
java.lang.String - Gösterilecek ScreenTip metni.
...
AutoText girişinin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | AutoText girişinin adı. |
...
Girişleri içerecek listenin dayandığı stilin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Girişleri içerecek listenin dayandığı stilin adı. |
...
Gösterilecek ScreenTip metnini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Gösterilecek ScreenTip metni. |
