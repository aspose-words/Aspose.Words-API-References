...
description: "Java'da BARCODE alanını uygular."
type: docs
weight: 206
url: /tr/java/com.aspose.words/fieldbarcode/
---
...
BARCODE alanını uygular.

Daha fazla bilgi için, [ Working with Fields ][Working with Fields] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

ABD Posta Servisi tarafından kullanılan adresin makine tarafından okunabilir biçiminde bir posta barkodu ekler.
...
| [getFacingIdentificationMark()](#getFacingIdentificationMark) | Eklenecek Facing Identification Mark (FIM) tipini alır. |
...
| [getPostalAddress()](#getPostalAddress) | Barkod oluşturmak için kullanılan posta adresini veya ona referans veren yer işaretinin adını alır. |
...
| [isBookmark()](#isBookmark) | Bir yer işareti adı olup olmadığını alır [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
| [isBookmark(boolean value)](#isBookmark-boolean) | Bir yer işareti adı olup olmadığını ayarlar [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
...
| [isUSPostalAddress()](#isUSPostalAddress) | ABD olup olmadığını alır [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
| [isUSPostalAddress(boolean value)](#isUSPostalAddress-boolean) | ABD olup olmadığını ayarlar [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
| [remove()](#remove) | Alanı belgeden kaldırır. |
| [setFacingIdentificationMark(String value)](#setFacingIdentificationMark-java.lang.String) | Eklenecek Facing Identification Mark (FIM) tipini ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setPostalAddress(String value)](#setPostalAddress-java.lang.String) | Barkod oluşturmak için kullanılan posta adresini veya ona referans veren yer işaretinin adını ayarlar. |
...
Eklenecek Facing Identification Mark (FIM) tipini alır.
...
**Returns:**
java.lang.String - Eklenecek Facing Identification Mark (FIM) tipi.
...
Barkod oluşturmak için kullanılan posta adresini veya ona referans veren yer işaretinin adını alır.
...
**Returns:**
java.lang.String - Barkod oluşturmak için kullanılan posta adresi veya ona referans veren yer işaretinin adı.
### getResult() {#getResult}
```
...
Bir yer işareti adı olup olmadığını alır [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
**Returns:**
boolean - Bir yer işareti adı olup olmadığını [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
Bir yer işareti adı olup olmadığını ayarlar [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | boolean | Bir yer işareti adı olup olmadığını [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
...
Bir ABD posta adresi olup olmadığını alır [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
**Returns:**
boolean - Bir ABD olup olmadığını [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
Bir ABD posta adresi olup olmadığını ayarlar [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String).
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | boolean | Bir ABD olup olmadığını [getPostalAddress()](../../com.aspose.words/fieldbarcode/\#getPostalAddress) / [setPostalAddress(java.lang.String)](../../com.aspose.words/fieldbarcode/\#setPostalAddress-java.lang.String). |
...
Eklenecek Facing Identification Mark (FIM) tipini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek Facing Identification Mark (FIM) tipi. |
...
Barkod oluşturmak için kullanılan posta adresini veya ona referans veren yer işaretinin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Barkod oluşturmak için kullanılan posta adresi veya ona referans veren yer işaretinin adı. |
