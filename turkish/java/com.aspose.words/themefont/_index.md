...
description: "Java'da belge temaları için tema yazı tipi adlarının türlerini belirtir."
type: docs
weight: 685
url: /tr/java/com.aspose.words/themefont/
---
...
Üst nesne özellikleri içinde tema yazı tipi olarak başvurulabilecek bir tema yazı tipi türünü belirtir. Bu tema yazı tipi, belgenin Theme bölümünde bulunan önceden tanımlanmış tema yazı tiplerinden birine referanstır ve belge içinde yazı tipi bilgilerinin merkezi olarak ayarlanmasını sağlar.
...
| Alan | Açıklama |
| --- | --- |
| [MAJOR](#MAJOR) | Ana tema yazı tipi. |
| [MINOR](#MINOR) | İkincil tema yazı tipi. |
| [NONE](#NONE) | Tema yazı tipi yok. |
| [length](#length) |  |
## Yöntemler
