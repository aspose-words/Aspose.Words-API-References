...
description: "Java'da bir belge düğümünde veya stilinde izlenen bir değişikliği temsil eder."
type: docs
weight: 579
url: /tr/java/com.aspose.words/revision/
---
...
Bir belge düğümünde veya stilinde bir revizyonu (izlenen değişiklik) temsil eder. Bu revizyonun türünü kontrol etmek için [getRevisionType()](../../com.aspose.words/revision/\#getRevisionType) kullanın.
...
| [getAuthor()](#getAuthor) | Bu revizyonun yazarını alır. |
| [getDateTime()](#getDateTime) | Bu revizyonun tarih/saatini alır. |
| [getGroup()](#getGroup) | Revizyon grubunu alır. |
| [getParentNode()](#getParentNode) | Bu revizyonun doğrudan üst düğümünü (sahibini) alır. |
| [getParentStyle()](#getParentStyle) | Bu revizyonun doğrudan üst stilini (sahibini) alır. |
| [getRevisionType()](#getRevisionType) | Bu revizyonun tipini alır. |
| [reject()](#reject) | Bu revizyonu reddet. |
| [setAuthor(String value)](#setAuthor-java.lang.String) | Bu revizyonun yazarını ayarlar. |
| [setDateTime(Date value)](#setDateTime-java.util.Date) | Bu revizyonun tarih/saatini ayarlar. |
### accept() {#accept}
```
public void accept()
```
...
Bu revizyonun yazarını alır. Boş dize ya da  null .
...
**Returns:**
java.lang.String - Bu revizyonun yazarı.
...
Bu revizyonun tarih/saatini alır.
...
**Returns:**
java.util.Date - Bu revizyonun tarih/saati.
### getGroup() {#getGroup}
```
...
Revizyon grubunu alır. Revizyon herhangi bir gruba ait değilse  null  döner.

 **Remarks:** 

Revizyonun grubu yoktur eğer revizyon tipi [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) ise ya da revizyon belge bağlamında artık mevcut değilse (kabul edildi/reddedildi).
...
Bu revizyonun doğrudan üst düğümünü (sahibini) alır. Bu özellik, [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) dışındaki tüm revizyon tipleri için çalışır.

 **Remarks:** 

Bu revizyon Stil biçimlendirme değişikliğiyle ilgiliyse, bunun yerine [getParentStyle()](../../com.aspose.words/revision/\#getParentStyle) kullanın.
...
Bu revizyonun doğrudan üst stilini (sahibini) alır. Bu özellik yalnızca [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) revizyon tipi için çalışır.

 **Remarks:** 

Bu revizyon belge düğümlerindeki değişikliklerle ilgiliyse, bunun yerine [getParentNode()](../../com.aspose.words/revision/\#getParentNode) kullanın.
...
**Returns:**
int - Bu revizyonun tipi. Döndürülen değer, [RevisionType](../../com.aspose.words/revisiontype/) sabitlerinden biridir.
### reject() {#reject}
```
public void reject()
```
...
Bu revizyonun yazarını ayarlar. Boş dize ya da  null  olamaz.
...
| --- | --- | --- |
| değer | java.lang.String | Bu revizyonun yazarı. |
...
Bu revizyonun tarih/saatini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.util.Date | Bu revizyonun tarih/saati. |
