...
description: "Karşılaştırma sırasında kullanılacak temel belgeyi Java'da belirtmeye olanak tanır."
type: docs
weight: 118
url: /tr/java/com.aspose.words/comparisontargettype/
---
...
Karşılaştırma sırasında kullanılacak temel belgeyi belirtmeye olanak tanır. Varsayılan değer [CURRENT](../../com.aspose.words/comparisontargettype/\#CURRENT) dir.

 **Remarks:** 

Microsoft Word "Değişiklikleri göster" seçeneği ile "Belgeleri Karşılaştır" iletişim kutusundaki ilişkilidir.
...
| Alan | Açıklama |
| --- | --- |
| [CURRENT](#CURRENT) | Bu belge, karşılaştırma sırasında temel olarak kullanılır. |
| [NEW](#NEW) | Diğer belge, karşılaştırma sırasında temel olarak kullanılır. |
| [length](#length) |  |
## Yöntemler
...
Bu belge, karşılaştırma sırasında temel olarak kullanılır.
...
Diğer belge, karşılaştırma sırasında temel olarak kullanılır.
