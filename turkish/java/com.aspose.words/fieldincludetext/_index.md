...
description: "Java'da INCLUDETEXT alanını uygular."
type: docs
weight: 248
url: /tr/java/com.aspose.words/fieldincludetext/
---
...
Başka bir belgede bulunan metnin ve grafiğin tamamını veya bir kısmını ekler.

 **Examples:** 

Bir INCLUDETEXT alanı oluşturmayı ve özelliklerini ayarlamayı gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Dahil edilecek belgede yer iminin adını alır. |
| [getDisplayResult()](#getDisplayResult) | Görüntülenen alan sonucunu temsil eden metni alır. |
| [getEncoding()](#getEncoding) | Referans verilen dosya içindeki veriye uygulanan kodlamayı alır. |
...
| [getLockFields()](#getLockFields) | Dahil edilen belgede alanların güncellenmesini önleyip önlemeyeceğini alır. |
| [getMimeType()](#getMimeType) | Referans verilen dosyanın MIME türünü alır. |
| [getNamespaceMappings()](#getNamespaceMappings) | XPath sorguları için ad alanı eşlemelerini alır. |
...
| [getSourceFullName()](#getSourceFullName) | Bir IRI kullanarak belgenin konumunu alır. |
| [getStart()](#getStart) | Alan başlangıcını temsil eden düğümü alır. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTextConverter()](#getTextConverter) | Dahil edilen dosyanın formatı için metin dönüştürücünün adını alır. |
| [getType()](#getType) | Microsoft Word alan türünü alır. |
| [getXPath()](#getXPath) | XML dosyasının istenen bölümü için XPath'i alır. |
| [getXslTransformation()](#getXslTransformation) | XML verisini biçimlendirmek için XSL Dönüşümünün konumunu alır. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Dahil edilecek belgede yer iminin adını ayarlar. |
| [setEncoding(String value)](#setEncoding-java.lang.String) | Referans verilen dosya içindeki veriye uygulanan kodlamayı ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setLockFields(boolean value)](#setLockFields-boolean) | Dahil edilen belgede alanların güncellenmesini önleyip önlemeyeceğini ayarlar. |
| [setMimeType(String value)](#setMimeType-java.lang.String) | Referans verilen dosyanın MIME türünü ayarlar. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | XPath sorguları için ad alanı eşlemelerini ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Bir IRI kullanarak belgenin konumunu ayarlar. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | Dahil edilen dosyanın formatı için metin dönüştürücünün adını ayarlar. |
| [setXPath(String value)](#setXPath-java.lang.String) | XML dosyasının istenen bölümü için XPath'i ayarlar. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | XML verisini biçimlendirmek için XSL Dönüşümünün konumunu ayarlar. |
...
Dahil edilecek belgede yer iminin adını alır.
...
**Returns:**
java.lang.String - Dahil edilecek belgede yer iminin adı.
...
Referans verilen dosya içindeki veriye uygulanan kodlamayı alır.
...
**Returns:**
java.lang.String - Referans verilen dosya içindeki veriye uygulanan kodlama.
### getEnd() {#getEnd}
```
...
Dahil edilen belgede alanların güncellenmesini önleyip önlemeyeceğini alır.
...
**Returns:**
boolean - Dahil edilen belgede alanların güncellenmesini önleyip önlemeyeceği.
...
Referans verilen dosyanın MIME türünü alır.
...
**Returns:**
java.lang.String - Referans verilen dosyanın MIME türü.
...
XPath sorguları için ad alanı eşlemelerini alır.
...
**Returns:**
java.lang.String - XPath sorguları için ad alanı eşlemeleri.
### getResult() {#getResult}
```
...
Bir IRI kullanarak belgenin konumunu alır.
...
**Returns:**
java.lang.String - IRI kullanarak belgenin konumu.
### getStart() {#getStart}
```
...
Dahil edilen dosyanın formatı için metin dönüştürücünün adını alır.
...
**Returns:**
java.lang.String - Eklenen dosyanın formatı için metin dönüştürücünün adı.
### getType() {#getType}
```
public int getType()
```
...
XML dosyasının istenen bölümü için XPath'i alır.
...
**Returns:**
java.lang.String - XML dosyasının istenen bölümü için XPath.
...
XML verisini biçimlendirmek için XSL Dönüşümünün konumunu alır.
...
**Returns:**
java.lang.String - XML verisini biçimlendirmek için XSL Dönüşümünün konumu.
### isDirty() {#isDirty}
```
...
Dahil edilecek belgede yer iminin adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek belgede yer alan yer iminin adı. |
...
Referans verilen dosya içindeki veriye uygulanan kodlamayı ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Referans alınan dosya içindeki verilere uygulanan kodlama. |
...
Dahil edilen belgede alanların güncellenmesini önleyip önlemeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Eklenen belgede alanların güncellenmesini önleyip önlemeyeceği. |
...
Referans verilen dosyanın MIME türünü ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Referans alınan dosyanın MIME türü. |
...
XPath sorguları için ad alanı eşlemelerini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | XPath sorguları için ad alanı eşlemeleri. |
...
Bir IRI kullanarak belgenin konumunu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | IRI kullanarak belgenin konumu. |
...
Dahil edilen dosyanın formatı için metin dönüştürücünün adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenen dosyanın formatı için metin dönüştürücünün adı. |
...
XML dosyasının istenen bölümü için XPath'i ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | XML dosyasının istenen bölümü için XPath. |
...
XML verisini biçimlendirmek için XSL Dönüşümünün konumunu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | XML verisini biçimlendirmek için XSL Dönüşümünün konumu. |
