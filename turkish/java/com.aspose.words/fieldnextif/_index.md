...
description: "Java'da NEXTIF alanını uygular."
type: docs
weight: 264
url: /tr/java/com.aspose.words/fieldnextif/
---
...
İfadelerle belirlenen değerleri [getLeftExpression()](../../com.aspose.words/fieldnextif/\#getLeftExpression) / [setLeftExpression(java.lang.String)](../../com.aspose.words/fieldnextif/\#setLeftExpression-java.lang.String) ve [getRightExpression()](../../com.aspose.words/fieldnextif/\#getRightExpression) / [setRightExpression(java.lang.String)](../../com.aspose.words/fieldnextif/\#setRightExpression-java.lang.String) karşılaştırmada, [getComparisonOperator()](../../com.aspose.words/fieldnextif/\#getComparisonOperator) / [setComparisonOperator(java.lang.String)](../../com.aspose.words/fieldnextif/\#setComparisonOperator-java.lang.String) tarafından belirlenen operatörü kullanarak. Eğer karşılaştırma doğruysa, bir sonraki veri kaydı mevcut birleştirme belgesine birleştirilir. (Ana belgede NEXTIF'ten sonra gelen birleştirme alanları, mevcut veri kaydı yerine bir sonraki veri kaydının değerleriyle değiştirilir.) Eğer karşılaştırma yanlışsa, bir sonraki veri kaydı yeni bir birleştirme belgesine birleştirilir.

 **Examples:** 

Posta birleştirme sırasında birden çok satırı tek bir sayfaya birleştirmek için NEXT/NEXTIF alanlarının nasıl kullanılacağını gösterir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getComparisonOperator()](#getComparisonOperator) | Karşılaştırma operatörünü alır. |
...
| [getLeftExpression()](#getLeftExpression) | Karşılaştırma ifadesinin sol kısmını alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getResult()](#getResult) | Alan ayırıcı ile alan sonu arasındaki metni alır. |
| [getRightExpression()](#getRightExpression) | Karşılaştırma ifadesinin sağ kısmını alır. |
...
| [setComparisonOperator(String value)](#setComparisonOperator-java.lang.String) | Karşılaştırma operatörünü ayarlar. |
| [setLeftExpression(String value)](#setLeftExpression-java.lang.String) | Karşılaştırma ifadesinin sol kısmını ayarlar. |
...
| [setRightExpression(String value)](#setRightExpression-java.lang.String) | Karşılaştırma ifadesinin sağ kısmını ayarlar. |
...
Karşılaştırma operatörünü alır.
...
**Returns:**
java.lang.String - Karşılaştırma operatörü.
...
Karşılaştırma ifadesinin sol kısmını alır.
...
**Returns:**
java.lang.String - Karşılaştırma ifadesinin sol kısmı.
...
Karşılaştırma ifadesinin sağ kısmını alır.
...
**Returns:**
java.lang.String - Karşılaştırma ifadesinin sağ kısmı.
...
Karşılaştırma operatörünü ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Karşılaştırma operatörü. |
...
Karşılaştırma ifadesinin sol kısmını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Karşılaştırma ifadesinin sol kısmı. |
...
Karşılaştırma ifadesinin sağ kısmını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Karşılaştırma ifadesinin sağ kısmı. |
