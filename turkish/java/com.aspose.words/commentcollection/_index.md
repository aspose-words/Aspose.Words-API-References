...
description: "Java'da Comment düğümlerinin bir koleksiyonuna tiplenmiş erişim sağlar."
type: docs
weight: 109
url: /tr/java/com.aspose.words/commentcollection/
---
...
Tiplenmiş erişim, [Comment](../../com.aspose.words/comment/) düğümlerinin bir koleksiyonuna sağlar.

Daha fazla bilgi için, [ Working with Comments ][Working with Comments] dokümantasyon makalesini ziyaret edin.

 **Examples:** 

Bir yorumun "done" olarak işaretlenmesini gösterir.
...
| [get(int index)](#get-int) | Verilen indeksteki bir [Comment](../../com.aspose.words/comment/) öğesini alır. |
...
Verilen indeksteki bir [Comment](../../com.aspose.words/comment/) öğesini alır.
