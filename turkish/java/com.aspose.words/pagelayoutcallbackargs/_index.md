...
description: "Java'da IPageLayoutCallback.notifycom.aspose.words.PageLayoutCallbackArgs içine geçirilen bir argüman."
type: docs
weight: 514
url: /tr/java/com.aspose.words/pagelayoutcallbackargs/
---
...
Java'da [IPageLayoutCallback.notify(com.aspose.words.PageLayoutCallbackArgs)](../../com.aspose.words/ipagelayoutcallback/\#notify-com.aspose.words.PageLayoutCallbackArgs) içine geçirilen bir argüman.
...
| Yöntem | Açıklama |
| --- | --- |
| [getDocument()](#getDocument) | Belgeyi alır. |
| [getEvent()](#getEvent) | Olayı alır. |
| [getPageIndex()](#getPageIndex) | Bu olayın ilişkili olduğu belgede sayfanın 0 tabanlı indeksini alır. |
...
**Returns:**
int - Olay. Döndürülen değer, [PageLayoutEvent](../../com.aspose.words/pagelayoutevent/) sabitlerinden biridir.
...
Bu olayın ilişkili olduğu belgede sayfanın 0 tabanlı indeksini alır. İlişkili bir sayfa yoksa veya sayfa yeniden akış sırasında kaldırıldıysa negatif değer döndürür.
...
**Returns:**
int - Bu olayın ilişkili olduğu belgede sayfanın 0 tabanlı indeksi.
