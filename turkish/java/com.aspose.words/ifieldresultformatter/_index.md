...
description: "Bu arayüzü, alan sonucunun Java'da nasıl biçimlendirileceğini kontrol etmek istiyorsanız uygulayın."
type: docs
weight: 766
url: /tr/java/com.aspose.words/ifieldresultformatter/
---
```
...
| [formatNumeric(double value, String format)](#formatNumeric-double-java.lang.String) | Aspose.Words sayısal bir biçim değiştiricisi uyguladığında çağrılır, örneğin. |
### format(double value, int format) {#format-double-int}
```
...
Aspose.Words sayısal bir biçim değiştiricisi uyguladığında çağrılır, örneğin \\\\# \"\\#.\\#\".

 **Remarks:** 

Uygulama, varsayılan biçimlendirmenin uygulanması gerektiğini göstermek için  null  döndürmelidir.
