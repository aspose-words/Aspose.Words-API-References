...
description: "Java'da bir belgede Word alanının sonunu temsil eder."
type: docs
weight: 229
url: /tr/java/com.aspose.words/fieldend/
---
...
Bir belgede Word alanının sonunu temsil eder.
...
| [getNodeType()](#getNodeType) | Döndürür [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). |
...
| [hasSeparator()](#hasSeparator) | Bu alanın bir ayırıcıya sahip olması durumunda  true  döndürür. |
...
Çağırır [DocumentVisitor.visitFieldEnd(com.aspose.words.FieldEnd)](../../com.aspose.words/documentvisitor/\#visitFieldEnd-com.aspose.words.FieldEnd).
...
Döndürür [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END).
...
**Returns:**
int - [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
...
Bu alanın bir ayırıcıya sahip olması durumunda  true  döndürür.
...
**Returns:**
boolean -  true  bu alanın bir ayırıcıya sahip olması durumunda.
