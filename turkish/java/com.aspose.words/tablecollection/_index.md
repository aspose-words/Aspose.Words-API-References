...
description: "Java'da Table düğümlerinin bir koleksiyonuna tiplenmiş erişim sağlar."
type: docs
weight: 658
url: /tr/java/com.aspose.words/tablecollection/
---
...
Bir koleksiyon içindeki [Table](../../com.aspose.words/table/) düğümlerine tiplenmiş erişim sağlar.

Daha fazla bilgi için, [ Working with Tables ][Working with Tables] dokümantasyon makalesini ziyaret edin.

 **Examples:** 

Bir belgede tüm tabloların ilk ve son satırlarını nasıl kaldıracağınızı gösterir.
...
| [get(int index)](#get-int) | Verilen indeksteki bir [Table](../../com.aspose.words/table/) öğesini alır. |
...
| [toArray()](#toArray) | Tüm tabloları koleksiyondan yeni bir tablo dizisine kopyalar. |
...
Verilen indeksteki bir [Table](../../com.aspose.words/table/) öğesini alır.
...
Tüm tabloları koleksiyondan yeni bir tablo dizisine kopyalar.
...
**Returns:**
com.aspose.words.Node[] - Tablo dizisi.
