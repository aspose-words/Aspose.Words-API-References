...
description: "Java'da NOTEREF alanını uygular."
type: docs
weight: 265
url: /tr/java/com.aspose.words/fieldnoteref/
---
...
Belirtilen yer işaretiyle işaretlenmiş dipnot veya sonnot işaretini ekler.

 **Examples:** 

NOTEREF alanlarını eklemeyi ve görünümünü değiştirmeyi gösterir.
...
NOTEREF alanı ile dipnotları çapraz referanslamayı gösterir.
...
| [getInsertReferenceMark()](#getInsertReferenceMark) | Dipnot Referansı veya Sonnot Referansı stilindeki aynı karakter biçimlendirmesiyle referans işaretini ekler. |
...
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Dipnot Referansı veya Sonnot Referansı stilindeki aynı karakter biçimlendirmesiyle referans işaretini ekler. |
...
Dipnot Referansı veya Sonnot Referansı stilindeki aynı karakter biçimlendirmesiyle referans işaretini ekler.
