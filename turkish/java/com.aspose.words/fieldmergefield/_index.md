...
description: "Java'da MERGEFIELD alanını uygular."
type: docs
weight: 258
url: /tr/java/com.aspose.words/fieldmergefield/
---
...
Bir posta birleştirme ana belgesindeki birleştirme karakterleri içinde bir veri alanının adını alır. Ana belge seçilen veri kaynağıyla birleştirildiğinde, belirtilen veri alanındaki bilgi birleştirme alanının yerine eklenir.

 **Examples:** 

MERGEFIELD alanlarını kullanarak posta birleştirme yapmayı gösterir.
...
| [getFieldName()](#getFieldName) | Bir veri alanının adını alır. |
| [getFieldNameNoPrefix()](#getFieldNameNoPrefix) | Veri alanının yalnızca adını döndürür. |
...
| [getTextAfter()](#getTextAfter) | Alan boş değilse, alandan sonra eklenecek metni alır. |
| [getTextBefore()](#getTextBefore) | Alan boş değilse, alandan önce eklenecek metni alır. |
...
| [isMapped()](#isMapped) | Bu alanın eşlenmiş bir alan olup olmadığını alır. |
| [isMapped(boolean value)](#isMapped-boolean) | Bu alanın eşlenmiş bir alan olup olmadığını ayarlar. |
| [isVerticalFormatting()](#isVerticalFormatting) | Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceğini alır. |
| [isVerticalFormatting(boolean value)](#isVerticalFormatting-boolean) | Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceğini ayarlar. |
| [remove()](#remove) | Alanı belgeden kaldırır. |
| [setFieldName(String value)](#setFieldName-java.lang.String) | Bir veri alanının adını ayarlar. |
...
| [setTextAfter(String value)](#setTextAfter-java.lang.String) | Alan boş değilse, alandan sonra eklenecek metni ayarlar. |
| [setTextBefore(String value)](#setTextBefore-java.lang.String) | Alan boş değilse, alandan önce eklenecek metni ayarlar. |
...
**Returns:**
java.lang.String - Bir veri alanının adı.
...
Veri alanının yalnızca adını döndürür. Herhangi bir önek, önek özelliğine göre kaldırılır.
...
**Returns:**
java.lang.String - Veri alanının yalnızca adı.
### getFormat() {#getFormat}
```
...
Alan boş değilse, alandan sonra eklenecek metni alır.
...
**Returns:**
java.lang.String - Alan boş değilse, alandan sonra eklenecek metin.
...
Alan boş değilse, alandan önce eklenecek metni alır.
...
**Returns:**
java.lang.String - Alan boş değilse, alandan önce eklenecek metin.
### getType() {#getType}
```
public int getType()
```
...
Bu alanın eşlenmiş bir alan olup olmadığını alır.
...
**Returns:**
boolean - Bu alanın eşlenmiş bir alan olup olmadığı.
...
Bu alanın eşlenmiş bir alan olup olmadığını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Bu alanın eşlenmiş bir alan olup olmadığı. |
...
Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceğini alır.
...
**Returns:**
boolean - Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceği.
...
Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Dikey biçimlendirme için karakter dönüşümünün etkinleştirilip etkinleştirilmeyeceği. |
...
Bir veri alanının adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Bir veri alanının adı. |
...
Alan boş değilse, alandan sonra eklenecek metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alan boş değilse, alandan sonra eklenecek metin. |
...
Alan boş değilse, alandan önce eklenecek metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Alan boş değilse, alandan önce eklenecek metin. |
