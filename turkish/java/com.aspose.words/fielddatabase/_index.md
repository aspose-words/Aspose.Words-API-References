...
description: "Java'da DATABASE alanını uygular."
type: docs
weight: 217
url: /tr/java/com.aspose.words/fielddatabase/
---
...
Veritabanı sorgusunun sonuçlarını bir WordprocessingML tablosuna ekler.
...
| Yöntem | Açıklama |
| --- | --- |
| [getConnection()](#getConnection) | Veriye bir bağlantı alır. |
...
| [getFileName()](#getFileName) | Veritabanının tam yolunu ve dosya adını alır |
| [getFirstRecord()](#getFirstRecord) | Eklenecek ilk veri kaydının tam kayıt numarasını alır. |
...
| [getFormatAttributes()](#getFormatAttributes) | Tabloya uygulanacak formatın hangi özniteliklerinin olduğunu alır. |
| [getInsertHeadings()](#getInsertHeadings) | Sonuç tablosunda veritabanından alan adlarını sütun başlıkları olarak ekleyip eklemeyeceğini alır. |
| [getInsertOnceOnMailMerge()](#getInsertOnceOnMailMerge) | Bir birleştirmenin başına veri ekleyip eklemeyeceğini alır. |
| [getLastRecord()](#getLastRecord) | Eklenecek son veri kaydının tam kayıt numarasını alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getQuery()](#getQuery) | Veritabanını sorgulayan bir SQL talimatları kümesini alır. |
...
| [getTableFormat()](#getTableFormat) | Veritabanı sorgusunun sonucuna uygulanacak formatı alır. |
...
| [setConnection(String value)](#setConnection-java.lang.String) | Veriye bir bağlantı ayarlar. |
| [setFileName(String value)](#setFileName-java.lang.String) | Veritabanının tam yolunu ve dosya adını ayarlar |
| [setFirstRecord(String value)](#setFirstRecord-java.lang.String) | Eklenecek ilk veri kaydının bütünsel kayıt numarasını ayarlar. |
| [setFormatAttributes(String value)](#setFormatAttributes-java.lang.String) | Tabloya uygulanacak formatın hangi özniteliklerinin uygulanacağını ayarlar. |
| [setInsertHeadings(boolean value)](#setInsertHeadings-boolean) | Veritabanından alan adlarını sonuç tablosunda sütun başlıkları olarak ekleyip eklemeyeceğini ayarlar. |
| [setInsertOnceOnMailMerge(boolean value)](#setInsertOnceOnMailMerge-boolean) | Birleştirmenin başında veriyi ekleyip eklemeyeceğini ayarlar. |
| [setLastRecord(String value)](#setLastRecord-java.lang.String) | Eklenecek son veri kaydının bütünsel kayıt numarasını ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setQuery(String value)](#setQuery-java.lang.String) | Veritabanını sorgulayan bir SQL komut kümesini ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setTableFormat(String value)](#setTableFormat-java.lang.String) | Veritabanı sorgusunun sonucuna uygulanacak formatı ayarlar. |
...
**Returns:**
java.lang.String - Veriye bir bağlantı.
...
Veritabanının tam yolunu ve dosya adını alır
...
**Returns:**
java.lang.String - Veritabanının tam yolu ve dosya adı
...
Eklenecek ilk veri kaydının tam kayıt numarasını alır.
...
**Returns:**
java.lang.String - Eklenecek ilk veri kaydının bütünsel kayıt numarası.
### getFormat() {#getFormat}
```
...
Tabloya uygulanacak formatın hangi özniteliklerinin olduğunu alır.
...
**Returns:**
java.lang.String - Tabloya uygulanacak formatın hangi öznitelikleri.
...
Sonuç tablosunda veritabanından alan adlarını sütun başlıkları olarak ekleyip eklemeyeceğini alır.
...
**Returns:**
boolean - Veritabanından alan adlarını sonuç tablosunda sütun başlıkları olarak ekleyip eklemeyeceği.
...
Bir birleştirmenin başına veri ekleyip eklemeyeceğini alır.
...
**Returns:**
boolean - Birleştirmenin başında veriyi ekleyip eklemeyeceği.
...
Eklenecek son veri kaydının tam kayıt numarasını alır.
...
**Returns:**
java.lang.String - Eklenecek son veri kaydının bütünsel kayıt numarası.
...
Veritabanını sorgulayan bir SQL talimatları kümesini alır.
...
**Returns:**
java.lang.String - Veritabanını sorgulayan bir SQL komut kümesi.
### getResult() {#getResult}
```
...
Veritabanı sorgusunun sonucuna uygulanacak formatı alır.
...
**Returns:**
java.lang.String - Veritabanı sorgusunun sonucuna uygulanacak format.
### getType() {#getType}
```
public int getType()
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Veriye bir bağlantı. |
...
Veritabanının tam yolunu ve dosya adını ayarlar
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Veritabanının tam yolu ve dosya adı |
...
Eklenecek ilk veri kaydının bütünsel kayıt numarasını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek ilk veri kaydının bütünsel kayıt numarası. |
...
Tabloya uygulanacak formatın hangi özniteliklerinin uygulanacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Tabloya uygulanacak formatın hangi öznitelikleri. |
...
Veritabanından alan adlarını sonuç tablosunda sütun başlıkları olarak ekleyip eklemeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Veritabanından alan adlarını sonuç tablosunda sütun başlıkları olarak ekleyip eklemeyeceği. |
...
Birleştirmenin başında veriyi ekleyip eklemeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Birleştirmenin başında veriyi ekleyip eklemeyeceği. |
...
Eklenecek son veri kaydının bütünsel kayıt numarasını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek son veri kaydının tam kayıt numarası. |
...
Veritabanını sorgulayan bir SQL komut kümesini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Veritabanını sorgulayan bir dizi SQL talimatı. |
...
Veritabanı sorgusunun sonucuna uygulanacak formatı ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Veritabanı sorgusunun sonucuna uygulanacak format. |
