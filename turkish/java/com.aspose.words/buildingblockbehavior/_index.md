...
description: "Java'da yapı bloğu ana belgeye eklendiğinde içeriğine uygulanacak davranışı belirtir."
type: docs
weight: 53
url: /tr/java/com.aspose.words/buildingblockbehavior/
---
...
Building block ana belgeye eklendiğinde içeriğine uygulanacak davranışı belirtir.

 **Remarks:** 

OOXML'de **ST\_DocPartBehavior** türüne karşılık gelir.
...
| Alan | Açıklama |
| --- | --- |
| [CONTENT](#CONTENT) | Yapı bloğunun satır içi içerik olarak ekleneceğini belirtir. |
| [DEFAULT](#DEFAULT) | Aynı [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT) gibi. |
| [PAGE](#PAGE) | Yapı bloğunun kendi sayfasına ekleneceğini belirtir. |
| [PARAGRAPH](#PARAGRAPH) | Yapı bloğunun kendi paragrafına ekleneceğini belirtir. |
| [length](#length) |  |
## Yöntemler
...
Yapı bloğunun satır içi içerik olarak ekleneceğini belirtir.
...
Aynı [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT) gibi.
...
Yapı bloğunun kendi sayfasına ekleneceğini belirtir.
...
Yapı bloğunun kendi paragrafına ekleneceğini belirtir.
