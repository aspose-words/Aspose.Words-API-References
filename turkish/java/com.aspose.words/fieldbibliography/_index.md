...
description: "Java'da BIBLIOGRAPHY alanını uygular."
type: docs
weight: 207
url: /tr/java/com.aspose.words/fieldbibliography/
---
...
BIBLIOGRAPHY alanını uygular.

Daha fazla bilgi için, [ Working with Fields ][Working with Fields] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Belgenin Bibliography bölümünün içeriğini bibliyografik bir stil ile ekler.

 **Examples:** 

CITATION ve BIBLIOGRAPHY alanlarıyla nasıl çalışılacağını gösterir.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliğini alır. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini alır. |
...
| [getSourceTag()](#getSourceTag) | Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değeri alır. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliğini ayarlar. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini ayarlar. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değeri ayarlar. |
...
Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliğini alır.
...
**Returns:**
java.lang.String - Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliği.
### getFormat() {#getFormat}
```
...
Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini alır.
...
**Returns:**
java.lang.String - Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliği.
...
Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değeri alır.
...
**Returns:**
java.lang.String - Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değer.
### getStart() {#getStart}
```
...
Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belgedeki yalnızca o dili kullanan kaynakları filtrelemek için kullanılan dil kimliği. |
...
Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belgedeki bibliyografik kaynakları biçimlendirmek için kullanılan dil kimliği. |
...
Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değeri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Etiket öğesi değeriyle eşleşen yalnızca kaynakların bibliyografide gösterilmesini sağlayan bir değer. |
