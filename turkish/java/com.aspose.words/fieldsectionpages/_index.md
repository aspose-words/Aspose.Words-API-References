...
description: "Java'da SECTIONPAGES alanını uygular."
type: docs
weight: 282
url: /tr/java/com.aspose.words/fieldsectionpages/
---
...
Mevcut bölümdeki geçerli sayfanın numarasını alır.

 **Examples:** 

Bölümlere göre sayfaları numaralandırmak için SECTION ve SECTIONPAGES alanlarının nasıl kullanılacağını gösterir.
