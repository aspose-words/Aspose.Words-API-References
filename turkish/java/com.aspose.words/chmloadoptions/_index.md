...
description: "Java'da bir CHM belgesini Document nesnesine yüklerken ek seçenekler belirtmeye izin verir."
type: docs
weight: 102
url: /tr/java/com.aspose.words/chmloadoptions/
---
...
CHM belgesini bir [Document](../../com.aspose.words/document/) nesnesine yüklerken ek seçenekler belirtmeye izin verir.
...
| [getOriginalFileName()](#getOriginalFileName) | CHM dosyasının adı. |
...
| [setOriginalFileName(String value)](#setOriginalFileName-java.lang.String) | CHM dosyasının adı. |
...
CHM dosyasının adı. Varsayılan değer null'dur.

 **Remarks:** 

CHM belgeleri, aynı belgeye dosya adıyla referans veren bağlantılar içerebilir. Aspose.Words bu tür bağlantıları destekler ve genellikle bir bağlantının referans verdiği dosyanın yüklenen dosya olup olmadığını kontrol etmek için [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) kullanır. Bir belge bir akıştan yüklendiğinde, orijinal dosya adı otomatik olarak belirlenemediği için bu özellik aracılığıyla açıkça belirtilmelidir.

Bir CHM belgesi bir dosyadan yüklendiğinde ve bu özellik için null olmayan bir değer belirtilmişse, değer [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) içinde saklanan gerçek dosya adının üzerine öncelik alır.
