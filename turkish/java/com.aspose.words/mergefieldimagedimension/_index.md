...
description: "Java'da bir görüntü boyutunu temsil eder."
type: docs
weight: 462
url: /tr/java/com.aspose.words/mergefieldimagedimension/
---
...
Posta birleştirme sürecinde kullanılan bir görüntü boyutunu (yani genişlik ya da yükseklik) temsil eder.

Daha fazla bilgi için, [ Working with Fields ][Working with Fields] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Bir posta birleştirme sırasında görüntünün orijinal boyutuyla eklenmesi gerektiğini göstermek için, [getValue()](../../com.aspose.words/mergefieldimagedimension/\#getValue) / [setValue(double)](../../com.aspose.words/mergefieldimagedimension/\#setValue-double) özelliğine negatif bir değer atamalısınız.
...
| Yapıcı | Açıklama |
| --- | --- |
| [MergeFieldImageDimension(double value)](#MergeFieldImageDimension-double) | Verilen değeri puan cinsinden kullanarak bir görüntü boyutu örneği oluşturur. |
| [MergeFieldImageDimension(double value, int unit)](#MergeFieldImageDimension-double-int) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getUnit()](#getUnit) | Birim. |
| [getValue()](#getValue) | Değer. |
| [setUnit(int value)](#setUnit-int) | Birim. |
| [setValue(double value)](#setValue-double) | Değer. |
...
Verilen değeri puan cinsinden kullanarak bir görüntü boyutu örneği oluşturur.

 **Remarks:** 

İlgili görüntü boyutunun orijinal değerinin uygulanması gerektiğini göstermek için negatif bir değer kullanmalısınız.
...
**Returns:**
int - İlgili  int  değeri. Döndürülen değer, [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/) sabitlerinden biridir.
### getValue() {#getValue}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | İlgili  int  değeri. Değer, [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/) sabitlerinden biri olmalıdır. |
