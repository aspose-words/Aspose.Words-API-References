...
description: "Java'da Run düğümlerinin bir koleksiyonuna tiplenmiş erişim sağlar."
type: docs
weight: 594
url: /tr/java/com.aspose.words/runcollection/
---
...
Tiplenmiş bir [Run](../../com.aspose.words/run/) düğüm koleksiyonuna erişim sağlar.
...
| [get(int index)](#get-int) | Verilen indeksteki bir [Run](../../com.aspose.words/run/) öğesini alır. |
...
Verilen indeksteki bir [Run](../../com.aspose.words/run/) öğesini alır.
...
**Returns:**
com.aspose.words.Node[] - Run'ların bir dizisi.
