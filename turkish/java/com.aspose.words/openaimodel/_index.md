...
description: "Java'da Aspose.Words içinde OpenAi modelleri entegrasyonunu temsil eden sınıf."
type: docs
weight: 505
url: /tr/java/com.aspose.words/openaimodel/
---
...
Aspose.Words içinde OpenAi modelleri entegrasyonunu temsil eden sınıf.

 **Remarks:** 

OpenAi modelleri detayları için lütfen https://platform.openai.com/docs/models adresine bakın.
...
| Yapıcı | Açıklama |
| --- | --- |
| [OpenAiModel(String name, String apiKey)](#OpenAiModel-java.lang.String-java.lang.String) | Yeni bir [OpenAiModel](../../com.aspose.words/openaimodel/) sınıfı örneği başlatır. |
| [OpenAiModel(String name)](#OpenAiModel-java.lang.String) | Yeni bir [OpenAiModel](../../com.aspose.words/openaimodel/) sınıfı örneği başlatır. |
## Yöntemler
...
| [withOrganization(String organizationId)](#withOrganization-java.lang.String) | Model için belirtilen bir Organizasyon ayarlar. |
| [withProject(String projectId)](#withProject-java.lang.String) | Model için belirtilen bir Proje ayarlar. |
...
Yeni bir [OpenAiModel](../../com.aspose.words/openaimodel/) sınıfı örneği başlatır.

 **Examples:** 

Bir API anahtarı ve model adı kullanarak doğrudan bir OpenAI model örneği oluşturmayı gösterir.
...
| --- | --- | --- |
| name | java.lang.String | Modelin adı. Örneğin, gpt-5.2-chat-latest. |
| apiKey | java.lang.String | OpenAi API'sini kullanmak için API anahtarı. |
...
Modelin URL'sini alır. Varsayılan değer "https://api.openai.com/".
...
Modelin URL'sini ayarlar. Varsayılan değer "https://api.openai.com/".
...
Model için belirtilen bir Organizasyon ayarlar.
...
Model için belirtilen bir Proje ayarlar.
