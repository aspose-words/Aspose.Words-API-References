...
description: "Java'da bir web uzantısına referansı temsil eder."
type: docs
weight: 732
url: /tr/java/com.aspose.words/webextensionreference/
---
...
Web uzantısına referansı temsil eder. Referans, sağlayıcı konumunu ve uzantının sürümünü belirlemek için kullanılır.
...
| Yöntem | Açıklama |
| --- | --- |
| [getId()](#getId) | Katalog sağlayıcısı içinde web uzantısıyla ilişkili tanımlayıcı. |
| [getStore()](#getStore) | Web uzantısının depolandığı pazar yerinin örneğini belirtir. |
| [getStoreType()](#getStoreType) | Pazar yerinin türünü belirtir. |
| [getVersion()](#getVersion) | Web uzantısının sürümünü belirtir. |
| [setId(String value)](#setId-java.lang.String) | Katalog sağlayıcısı içinde web uzantısıyla ilişkili tanımlayıcı. |
| [setStore(String value)](#setStore-java.lang.String) | Web uzantısının depolandığı pazar yerinin örneğini belirtir. |
| [setStoreType(int value)](#setStoreType-int) | Pazar yerinin türünü belirtir. |
| [setVersion(String value)](#setVersion-java.lang.String) | Web uzantısının sürümünü belirtir. |
### getId() {#getId}
```
public String getId()
```
...
**Returns:**
int - İlgili  int  değeri. Döndürülen değer, [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/) sabitlerinden biridir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | İlgili  int  değeri. Değer, [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/) sabitlerinden biri olmalıdır. |
