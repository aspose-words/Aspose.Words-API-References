...
description: "Java belgelerinde sıkça karşılaşılan kontrol karakterleri."
type: docs
weight: 130
url: /tr/java/com.aspose.words/controlchar/
---
...
Belgelerde sıkça karşılaşılan kontrol karakterleri.

Daha fazla bilgi edinmek için [ Working With Control Characters ][Working With Control Characters] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Aynı sabitlerin hem char hem de string sürümlerini sağlar. Örneğin: string [LINE\_BREAK](../../com.aspose.words/controlchar/\#LINE-BREAK) ve char [LINE\_BREAK\_CHAR](../../com.aspose.words/controlchar/\#LINE-BREAK-CHAR) aynı değere sahiptir.
...
| Alan | Açıklama |
| --- | --- |
| [CELL](#CELL) | Bir tablo hücresinin veya tablo satırının son karakteri: "\\x0007" veya "\\a". |
| [CELL_CHAR](#CELL-CHAR) | Bir tablo hücresinin veya tablo satırının son karakteri: (char)7 veya "\\a". |
| [COLUMN_BREAK](#COLUMN-BREAK) | Sütun sonu karakteri: "\\x000e". |
| [COLUMN_BREAK_CHAR](#COLUMN-BREAK-CHAR) | Sütun sonu karakteri: (char)14. |
| [CR](#CR) | Satır başı karakteri: "\\x000d" veya "\\r". |
| [CR_LF](#CR-LF) | Satır başı ardından satır besleme karakteri: "\\x000d\\x000a" veya "\\r\\n". |
| [DEFAULT_TEXT_INPUT_CHAR](#DEFAULT-TEXT-INPUT-CHAR) | Bu, metin girişi form alanlarında varsayılan değer olarak kullanılan "o" karakteridir. |
| [FIELD_END_CHAR](#FIELD-END-CHAR) | MS Word alanının son karakteri: (char)21. |
| [FIELD_SEPARATOR_CHAR](#FIELD-SEPARATOR-CHAR) | Alan ayırıcı karakter, alan kodunu alan değerinden ayırır. |
| [FIELD_START_CHAR](#FIELD-START-CHAR) | MS Word alanının başlangıç karakteri: (char)19. |
| [LF](#LF) | Satır besleme karakteri: "\x000a" veya "\n". |
| [LINE_BREAK](#LINE-BREAK) | Satır sonu karakteri: "\x000b" veya "\v". |
| [LINE_BREAK_CHAR](#LINE-BREAK-CHAR) | Satır sonu karakteri: (char)11 veya "\v". |
| [LINE_FEED](#LINE-FEED) | Satır besleme karakteri: "\x000a" veya "\n". |
| [LINE_FEED_CHAR](#LINE-FEED-CHAR) | Satır besleme karakteri: (char)10 veya "\n". |
| [NON_BREAKING_HYPHEN_CHAR](#NON-BREAKING-HYPHEN-CHAR) | Microsoft Word'de kesintisiz tire (char)30'dur. |
| [NON_BREAKING_SPACE](#NON-BREAKING-SPACE) | Kesintisiz boşluk karakteri: "\x00a0". |
| [NON_BREAKING_SPACE_CHAR](#NON-BREAKING-SPACE-CHAR) | Kesintisiz boşluk karakteri: (char)160. |
| [OPTIONAL_HYPHEN_CHAR](#OPTIONAL-HYPHEN-CHAR) | Microsoft Word'de isteğe bağlı tire (char)31'dir. |
| [PAGE_BREAK](#PAGE-BREAK) | Sayfa sonu karakteri: "\x000c" veya "\f". |
| [PAGE_BREAK_CHAR](#PAGE-BREAK-CHAR) | Sayfa sonu karakteri: (char)12 veya "\f". |
| [PARAGRAPH_BREAK](#PARAGRAPH-BREAK) | Paragraf sonu karakteri: "\x000d" veya "\r". |
| [PARAGRAPH_BREAK_CHAR](#PARAGRAPH-BREAK-CHAR) | Paragraf sonu karakteri: (char)13 veya "\r". |
| [SECTION_BREAK](#SECTION-BREAK) | Bölüm sonu karakteri: "\x000c" veya "\f". |
| [SECTION_BREAK_CHAR](#SECTION-BREAK-CHAR) | Bölüm sonu karakteri: (char)12 veya "\f". |
| [SPACE_CHAR](#SPACE-CHAR) | Boşluk karakteri: (char)32. |
| [TAB](#TAB) | Sekme karakteri: "\x0009" veya "\t". |
| [TAB_CHAR](#TAB-CHAR) | Sekme karakteri: (char)9 veya "\t". |
### CELL {#CELL}
```
...
Bir tablo hücresinin veya tablo satırının son karakteri: "\\x0007" veya "\\a".
...
Bir tablo hücresinin veya tablo satırının son karakteri: (char)7 veya "\\a".
...
Satırbaşı karakteri: "\x000d" veya "\r". Aynı: [PARAGRAPH\_BREAK](../../com.aspose.words/controlchar/\#PARAGRAPH-BREAK).
...
MS Word alanının son karakteri: (char)21.
...
Alan ayırıcı karakter, alan kodunu alan değerinden ayırır. Bazı alanlarda isteğe bağlıdır. Değer: (char)20.
...
MS Word alanının başlangıç karakteri: (char)19.
...
Satır besleme karakteri: "\x000a" veya "\n". Aynı: [LINE\_FEED](../../com.aspose.words/controlchar/\#LINE-FEED).
...
Satır sonu karakteri: (char)11 veya "\v".
...
Satır besleme karakteri: "\x000a" ve "\n". Aynı: [LF](../../com.aspose.words/controlchar/\#LF).
...
Satır besleme karakteri: (char)10 veya "\n".
...
Microsoft Word'deki kesintisiz tire, Unicode karakteri U+2011 kesintisiz tireye karşılık gelmez; bunun yerine Microsoft Word'e bir tire görüntülemesini ve satırı bölmemesini söyleyen dahili bir bilgi temsil eder.
...
Kesintisiz boşluk karakteri: "\x00a0".
...
Kesintisiz boşluk karakteri: (char)160.
...
Microsoft Word'de isteğe bağlı tire (char)31'dir.

 **Remarks:** 

Microsoft Word'deki isteğe bağlı tire, Unicode karakteri U+00AD yumuşak tireye karşılık gelmez. Bunun yerine, Word'e olası bir heceleme noktası hakkında bilgi veren iç bilgi ekler.
...
Sayfa sonu karakteri: "\\x000c" veya "\\f". Not, bunun aynı değere sahip olduğu [SECTION\_BREAK](../../com.aspose.words/controlchar/\#SECTION-BREAK).
...
Sayfa sonu karakteri: (char)12 veya "\f".
...
Paragraf sonu karakteri: "\\x000d" veya "\\r". Aynı [CR](../../com.aspose.words/controlchar/\#CR) ile.
...
Paragraf sonu karakteri: (char)13 veya "\r".
...
Bölüm sonu karakteri: "\\x000c" veya "\\f". Not, aynı değere sahiptir [PAGE\_BREAK](../../com.aspose.words/controlchar/\#PAGE-BREAK).
...
Bölüm sonu karakteri: (char)12 veya "\f".
...
Sekme durak konumları için özel bir aralık nasıl ayarlanır gösterir.
