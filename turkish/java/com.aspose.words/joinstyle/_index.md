...
description: "Java'da çizgi birleştirme stili."
type: docs
weight: 407
url: /tr/java/com.aspose.words/joinstyle/
---
...
| Alan | Açıklama |
| --- | --- |
| [BEVEL](#BEVEL) | Kenarları düz bir çizgiyle birleştir. |
| [MITER](#MITER) | Kenarları birleşene kadar uzat. |
| [ROUND](#ROUND) | İki kenar arasında bir yay çizin. |
| [length](#length) |  |
## Yöntemler
...
Kenarları düz bir çizgiyle birleştir.
...
Kenarları birleşene kadar uzat.
...
İki kenar arasında bir yay çizin.
