...
description: "Java'da bir yapı bloğunun sınıflandırıldığı önceden tanımlı galeriyi belirtir."
type: docs
weight: 55
url: /tr/java/com.aspose.words/buildingblockgallery/
---
...
Bir building block'un sınıflandırıldığı önceden tanımlı galeriyi belirtir.

 **Remarks:** 

OOXML'de **ST\_DocPartGallery** türüne karşılık gelir.
...
| Alan | Açıklama |
| --- | --- |
| [ALL](#ALL) | Bu sözlük belge girişinin tüm olası galeri sınıflandırma değerleriyle ilişkilendirilmesi gerektiğini belirtir. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | Aynı [ALL](../../com.aspose.words/buildingblockgallery/\#ALL) gibi. |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
Bu sözlük belge girişinin tüm olası galeri sınıflandırma değerleriyle ilişkilendirilmesi gerektiğini belirtir.
...
Aynı [ALL](../../com.aspose.words/buildingblockgallery/\#ALL) gibi.
