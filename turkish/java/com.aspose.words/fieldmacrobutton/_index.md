...
description: "Java'da MACROBUTTON alanını uygular."
type: docs
weight: 256
url: /tr/java/com.aspose.words/fieldmacrobutton/
---
...
| [getDisplayText()](#getDisplayText) | Makro veya komutu çalıştırmak için seçilen \"düğme\" olarak görünecek metni alır. |
...
| [getMacroName()](#getMacroName) | Çalıştırılacak makro veya komutun adını alır. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Makro veya komutu çalıştırmak için seçilen \"düğme\" olarak görünecek metni ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Çalıştırılacak makro veya komutun adını ayarlar. |
...
Makro veya komutu çalıştırmak için seçilen \"düğme\" olarak görünecek metni alır.
...
**Returns:**
java.lang.String - Makro veya komutu çalıştırmak için seçilen \"düğme\" olarak görünecek metin.
### getEnd() {#getEnd}
```
...
Çalıştırılacak makro veya komutun adını alır.
...
**Returns:**
java.lang.String - Çalıştırılacak makro veya komutun adı.
### getMergeFieldName() {#getMergeFieldName}
```
...
Makro veya komutu çalıştırmak için seçilen \"düğme\" olarak görünecek metni ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Makro veya komutu çalıştırmak için seçilen "düğme" olarak görünecek metin. |
...
Çalıştırılacak makro veya komutun adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Çalıştırılacak makro veya komutun adı. |
