...
description: "Java'da bunun dipnot mu yoksa sonnot mu olduğunu belirtir."
type: docs
weight: 346
url: /tr/java/com.aspose.words/footnotetype/
---
...
Dipnotlar ve sonnotlar, [FOOTNOTE](../../com.aspose.words/footnotetype/#FOOTNOTE) sınıfı tarafından temsil edilen nesnelerle gösterilir. Dipnotlar ile sonnotları ayırt etmek için [Footnote.getFootnoteType()](../../com.aspose.words/footnote/#getFootnoteType) metodunu kullanın.

 **Examples:** 

Bir dipnot ve bir sonnot ile metni nasıl referans göstereceğinizi gösterir.
...
Dipnotları nasıl ekleyeceğinizi ve özelleştireceğinizi gösterir.
...
| Alan | Açıklama |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | Nesne bir sonnottur. |
| [FOOTNOTE](#FOOTNOTE) | Nesne bir dipnottur. |
| [length](#length) |  |
## Yöntemler
