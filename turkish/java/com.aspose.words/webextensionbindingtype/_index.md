...
description: "Java'da bir web uzantısı ile belgedeki veri arasındaki bağlama türlerinin mevcut olanlarını listeler."
type: docs
weight: 729
url: /tr/java/com.aspose.words/webextensionbindingtype/
---
...
Web uzantısı ile belgedeki veri arasındaki bağlama için mevcut türleri listeler.
...
| Alan | Açıklama |
| --- | --- |
| [DEFAULT](#DEFAULT) | Varsayılan olarak kullanılan matris. |
| [MATRIX](#MATRIX) | Başlık satırı olmayan tablo verisi. |
| [TABLE](#TABLE) | Başlık satırı olan tablo verisi. |
| [TEXT](#TEXT) | Düz metin. |
| [length](#length) |  |
## Yöntemler
...
Varsayılan olarak kullanılan matris.
...
Başlık satırı olmayan tablo verisi.
...
Başlık satırı olan tablo verisi.
