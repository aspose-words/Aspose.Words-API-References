...
description: "Java'da belge yükleme veya kaydetme sırasında Aspose.Words tarafından verilen bir uyarı hakkında bilgi içerir."
type: docs
weight: 717
url: /tr/java/com.aspose.words/warninginfo/
---
...
Aspose.Words'in belge yükleme veya kaydetme sırasında verdiği bir uyarı hakkında bilgi içerir.

Daha fazla bilgi için, [ Programming with Documents ][Programming with Documents] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Bu sınıfın örneklerini siz oluşturmazsınız. Bu sınıfın nesneleri Aspose.Words tarafından oluşturulur ve [IWarningCallback.warning(com.aspose.words.WarningInfo)](../../com.aspose.words/iwarningcallback/\#warning-com.aspose.words.WarningInfo) metoduna geçirilir.
