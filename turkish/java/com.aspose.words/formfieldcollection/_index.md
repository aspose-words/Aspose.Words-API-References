...
description: "Java'da bir aralıktaki tüm form alanlarını temsil eden FormField nesnelerinin bir koleksiyonu."
type: docs
weight: 348
url: /tr/java/com.aspose.words/formfieldcollection/
---
...
Bir aralıktaki tüm form alanlarını temsil eden [FormField](../../com.aspose.words/formfield/) nesnelerinin bir koleksiyonu.

Daha fazla bilgi için, [ Working with Form Fields ][Working with Form Fields] dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [clear()](#clear) | Bu koleksiyondaki ve belgedeki tüm form alanlarını kaldırır. |
| [get(int index)](#get-int) | Belirtilen indeksteki bir form alanını döndürür. |
| [get(String bookmarkName)](#get-java.lang.String) | Yer işareti adıyla bir form alanını döndürür. |
| [getCount()](#getCount) | Koleksiyondaki form alanlarının sayısını döndürür. |
| [iterator()](#iterator) | Bir enumerator nesnesi döndürür. |
| [remove(String formField)](#remove-java.lang.String) | Belirtilen adla bir form alanını kaldırır. |
| [removeAt(int index)](#removeAt-int) | Belirtilen indeksteki bir form alanını kaldırır. |
### clear() {#clear}
```
public void clear()
```
...
Bu koleksiyondaki ve belgedeki tüm form alanlarını kaldırır.
...
Yer işareti adıyla bir form alanını döndürür.

 **Remarks:** 

Belirtilen yer işareti adıyla form alanı bulunamazsa null döndürür.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| bookmarkName | java.lang.String | Büyük/küçük harfe duyarsız yer işareti adı. |
...
**Returns:**
int - Koleksiyondaki form alanlarının sayısı.
### iterator() {#iterator}
```
...
Belirtilen adla bir form alanını kaldırır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| formField | java.lang.String | Kaldırılacak form alanının büyük/küçük harfe duyarsız adı. |
...
Belirtilen indeksteki bir form alanını kaldırır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Kaldırılacak form alanının sıfır tabanlı indeksi. |
