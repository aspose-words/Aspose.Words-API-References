...
description: "Java'da SUBJECT alanını uygular."
type: docs
weight: 290
url: /tr/java/com.aspose.words/fieldsubject/
---
...
Yerleşik belge özelliklerinin **Subject** özelliğinde kaydedildiği gibi, belgenin konusunu alır ve isteğe bağlı olarak ayarlar.
...
| [getText()](#getText) | Konunun metnini alır. |
...
| [setText(String value)](#setText-java.lang.String) | Konunun metnini ayarlar. |
...
**Returns:**
java.lang.String - Konunun metni.
### getType() {#getType}
```
public int getType()
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Konunun metni. |
