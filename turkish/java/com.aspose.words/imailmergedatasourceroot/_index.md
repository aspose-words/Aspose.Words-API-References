...
description: "Bu arayüzü uygulayarak Java'da master-detay verileriyle özel bir veri kaynağından birleştirme (mail merge) yapılmasını sağlayın."
type: docs
weight: 777
url: /tr/java/com.aspose.words/imailmergedatasourceroot/
---
```
public interface IMailMergeDataSourceRoot
```

Ana‑detay verileri içeren özel bir veri kaynağından posta birleştirmeye izin vermek için bu arabirimi uygulayın.

 **Examples:** 

Master-detay verileri içeren özel bir veri kaynağından birleştirme (mail merge) gerçekleştirir.
...
| Yöntem | Açıklama |
| --- | --- |
| [getDataSource(String tableName)](#getDataSource-java.lang.String) | Aspose.Words birleştirme motoru, üst düzey bir birleştirme bölgesinin başlangıcına rastladığında bu yöntemi çağırır. |
...
Aspose.Words birleştirme motoru bir belgeyi veriyle doldururken MERGEFIELD TableStart:TableName ile karşılaştığında, bu nesnede [getDataSource(java.lang.String)](../../com.aspose.words/imailmergedatasourceroot/\#getDataSource-java.lang.String) yöntemini çağırır. Uygulamanız yeni bir veri kaynağı nesnesi döndürmelidir. Aspose.Words, birleştirme bölgesini doldurmak için döndürülen veri kaynağını kullanacaktır.
