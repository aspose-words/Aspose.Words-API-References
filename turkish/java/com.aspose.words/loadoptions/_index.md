...
description: "Java'da bir Document nesnesine bir belge yüklerken şifre veya temel URI gibi ek seçenekleri belirtmenizi sağlar."
type: docs
weight: 435
url: /tr/java/com.aspose.words/loadoptions/
---
...
Java'da bir [Document](../../com.aspose.words/document/) nesnesine bir belge yüklerken şifre veya temel URI gibi ek seçenekleri belirtmenizi sağlar.

Daha fazla bilgi edinmek için, [ Specify Load Options ][Specify Load Options] dokümantasyon makalesini ziyaret edin.

 **Examples:** 

Şifreli bir Microsoft Word belgesinin nasıl yükleneceğini gösterir.
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | Şifreli bir belgeyi yüklemek için belirtilen parolayı kullanarak bu sınıfın yeni bir örneğini başlatmak için bir kısayol. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler
