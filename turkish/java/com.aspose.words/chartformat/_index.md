...
description: "Java'da bir grafik öğesinin biçimlendirmesini temsil eder."
type: docs
weight: 78
url: /tr/java/com.aspose.words/chartformat/
---
...
Grafik öğesinin biçimlendirmesini temsil eder.
...
| [getEndCap()](#getEndCap) |  |
| [getFill()](#getFill) | Üst grafik öğesi için dolgu biçimlendirmesini alır. |
...
| [getShapeType()](#getShapeType) | Üst grafik öğesinin şekil tipini alır. |
| [getStartArrowLength()](#getStartArrowLength) |  |
| [getStartArrowType()](#getStartArrowType) |  |
| [getStartArrowWidth()](#getStartArrowWidth) |  |
| [getStroke()](#getStroke) | Üst grafik öğesi için çizgi biçimlendirmesini alır. |
...
| [getWeight()](#getWeight) |  |
| [isDefined()](#isDefined) | Herhangi bir biçimin tanımlı olup olmadığını gösteren bir bayrağı alır. |
...
| [setDefaultFill()](#setDefaultFill) | Grafik öğesinin dolgusunu varsayılan değere sıfırlar. |
...
| [setShapeType(int value)](#setShapeType-int) | Üst grafik öğesinin şekil tipini ayarlar. |
...
Üst grafik öğesi için dolgu biçimlendirmesini alır.
...
Üst grafik öğesinin şekil tipini alır.
...
**Returns:**
int - Üst grafik öğesinin şekil tipi. Döndürülen değer, [ChartShapeType](../../com.aspose.words/chartshapetype/) sabitlerinden biridir.
### getStartArrowLength() {#getStartArrowLength}
```
...
Üst grafik öğesi için çizgi biçimlendirmesini alır.
...
Herhangi bir biçimin tanımlı olup olmadığını gösteren bir bayrağı alır.

 **Examples:** 

Seride tanımlanan varsayılan değere dolgu sıfırlamanın nasıl yapılacağını gösterir.
...
**Returns:**
boolean - Herhangi bir biçimin tanımlı olup olmadığını gösteren bir bayrak.
### oneColorGradient(int style, int variant, double degree) {#oneColorGradient-int-int-double}
```
...
Grafik öğesinin dolgusunu varsayılan değere sıfırlar.
...
Üst grafik öğesinin şekil tipini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | Üst grafik öğesinin şekil türü. Değer, [ChartShapeType](../../com.aspose.words/chartshapetype/) sabitlerinden biri olmalıdır. |
