...
description: "Java'da DATE alanını uygular."
type: docs
weight: 220
url: /tr/java/com.aspose.words/fielddate/
---
...
Geçerli tarih ve zamanı ekler. Varsayılan olarak, Gregoryen takvim kullanılır.

 **Examples:** 

Farklı takvim türlerine göre tarihleri göstermek için DATE alanlarının nasıl kullanılacağını gösterir.
...
| [getUseLastFormat()](#getUseLastFormat) | Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından son kullanılan biçimin kullanılıp kullanılmayacağını alır. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından son kullanılan biçimin kullanılıp kullanılmayacağını ayarlar. |
...
Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından son kullanılan biçimin kullanılıp kullanılmayacağını alır.
...
**Returns:**
boolean - Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından son kullanılan biçimin kullanılıp kullanılmayacağı.
...
Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından son kullanılan biçimin kullanılıp kullanılmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Yeni bir DATE alanı eklerken, barındırma uygulaması tarafından en son kullanılan biçimin kullanılıp kullanılmayacağını. |
