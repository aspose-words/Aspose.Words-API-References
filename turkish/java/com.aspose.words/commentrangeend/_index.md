...
description: "Java'da bir yoruma bağlı olan metin bölgesinin sonunu belirtir."
type: docs
weight: 111
url: /tr/java/com.aspose.words/commentrangeend/
---
...
Yorumla ilişkili bir metin bölgesinin sonunu gösterir.
...
| Yapıcı | Açıklama |
| --- | --- |
| [CommentRangeEnd(DocumentBase doc, int id)](#CommentRangeEnd-com.aspose.words.DocumentBase-int) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler
...
| [getNodeType()](#getNodeType) | Şu değeri döndürür: [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). |
...
[CommentRangeEnd](../../com.aspose.words/commentrangeend/) oluşturulduğunda, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değildir ve [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) **null** değerindedir.

Belgeye bir [CommentRangeEnd](../../com.aspose.words/commentrangeend/) eklemek için, yorumu eklemek istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
...
[DocumentVisitor.visitCommentRangeEnd(com.aspose.words.CommentRangeEnd)](../../com.aspose.words/documentvisitor/\#visitCommentRangeEnd-com.aspose.words.CommentRangeEnd) metodunu çağırır.
...
Şu değeri döndürür: [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END).
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_END](../../com.aspose.words/nodetype/\#COMMENT-RANGE-END). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
### getParentIdInternal() {#getParentIdInternal}
```
