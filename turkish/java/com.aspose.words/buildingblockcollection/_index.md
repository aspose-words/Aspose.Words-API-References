...
description: "Java'da belgede bulunan BuildingBlock nesnelerinin bir koleksiyonu."
type: docs
weight: 54
url: /tr/java/com.aspose.words/buildingblockcollection/
---
...
Belgedeki [BuildingBlock](../../com.aspose.words/buildingblock/) nesnelerinin bir koleksiyonu.
...
Bu sınıfın örneklerini doğrudan oluşturmazsınız. Yapı blokları koleksiyonuna erişmek için [GlossaryDocument.getBuildingBlocks()](../../com.aspose.words/glossarydocument/\#getBuildingBlocks) özelliğini kullanın.
...
| [get(int index)](#get-int) | Verilen indeksteki bir yapı bloğunu alır. |
...
| [toArray()](#toArray) | Koleksiyondaki tüm yapı bloklarını yeni bir yapı blokları dizisine kopyalar. |
...
Verilen indeksteki bir yapı bloğunu alır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Yapı blokları listesindeki bir indeks. |
...
Koleksiyondaki tüm yapı bloklarını yeni bir yapı blokları dizisine kopyalar.
...
**Returns:**
com.aspose.words.Node[] - Bir yapı blokları dizisi.
