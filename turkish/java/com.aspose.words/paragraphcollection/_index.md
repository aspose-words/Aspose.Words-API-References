...
description: "Java'da Paragraph düğümlerinin bir koleksiyonuna tip güvenli erişim sağlar."
type: docs
weight: 524
url: /tr/java/com.aspose.words/paragraphcollection/
---
...
| [get(int index)](#get-int) | Verilen dizindeki bir [Paragraph](../../com.aspose.words/paragraph/) alır. |
...
Verilen dizindeki bir [Paragraph](../../com.aspose.words/paragraph/) alır.
...
Bir NodeCollection'dan dizi oluşturmanın nasıl yapılacağını gösterir.
...
\"hot remove\" kullanarak bir node'u yineleme sırasında nasıl kaldırılacağını gösterir.
...
**Returns:**
com.aspose.words.Node[] - Paragrafların bir dizisi.
