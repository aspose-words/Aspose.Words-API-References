...
description: "Java'da yazı tipi adını işlemek için yazı tipi ikamesi kuralı."
type: docs
weight: 329
url: /tr/java/com.aspose.words/fontnamesubstitutionrule/
---
...
Yazı tipi adını işlemek için yazı tipi ikame kuralı.

Daha fazla bilgi için, [ Working with Fonts ][Working with Fonts] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Bu kurala göre Aspose.Words, ikame elde etmek için yazı tipi adını işlemeye çalışır. Özellikle Aspose.Words, MS Word gibi '-', ',' ve '(' ayırıcılarıyla gelen ekleri kaldırmaya çalışır.
