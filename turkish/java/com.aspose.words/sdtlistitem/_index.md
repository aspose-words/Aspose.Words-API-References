...
description: "Bu öğe, Java'da bir üst SdtType.COMBO_BOX veya SdtType.DROP_DOWN_LIST yapılandırılmış belge etiketinde tek bir liste öğesini belirtir."
type: docs
weight: 602
url: /tr/java/com.aspose.words/sdtlistitem/
---
...
Bu öğe, bir üst [SdtType.COMBO\_BOX](../../com.aspose.words/sdttype/\#COMBO-BOX) veya [SdtType.DROP\_DOWN\_LIST](../../com.aspose.words/sdttype/\#DROP-DOWN-LIST) yapılandırılmış belge etiketinde tek bir liste öğesini belirtir.
...
| Yapıcı | Açıklama |
| --- | --- |
| [SdtListItem(String displayText, String value)](#SdtListItem-java.lang.String-java.lang.String) | Bu sınıfın yeni bir örneğini başlatır. |
| [SdtListItem(String value)](#SdtListItem-java.lang.String) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler

| Yöntem | Açıklama |
| --- | --- |
| [getDisplayText()](#getDisplayText) | Bu liste öğesi için [getValue()](../../com.aspose.words/sdtlistitem/\#getValue) öznitelik içeriği yerine çalıştırma içeriğinde görüntülenecek metni alır. |
| [getValue()](#getValue) | Bu liste öğesinin değerini alır. |
...
Bu liste öğesi için [getValue()](../../com.aspose.words/sdtlistitem/\#getValue) öznitelik içeriği yerine çalıştırma içeriğinde görüntülenecek metni alır.
...
**Returns:**
java.lang.String - Bu liste öğesi için [getValue()](../../com.aspose.words/sdtlistitem/\#getValue) öznitelik içeriği yerine çalıştırma içeriğinde görüntülenecek metin.
### getValue() {#getValue}
```
...
**Returns:**
java.lang.String - Bu liste öğesinin değeri.
