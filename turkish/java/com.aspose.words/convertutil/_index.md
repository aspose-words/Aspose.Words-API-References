...
description: "Java'da çeşitli ölçü birimleri arasında dönüştürme yapacak yardımcı işlevler sağlar."
type: docs
weight: 131
url: /tr/java/com.aspose.words/convertutil/
---
...
Çeşitli ölçü birimleri arasında dönüştürme yapmak için yardımcı işlevler sağlar.

Daha fazla bilgi edinmek için, [ Convert Between Measurement Units ][Convert Between Measurement Units] dokümantasyon makalesini ziyaret edin.
...
| Yöntem | Açıklama |
| --- | --- |
| [inchToPoint(double inches)](#inchToPoint-double) | İnçleri puana dönüştürür. |
| [millimeterToPoint(double millimeters)](#millimeterToPoint-double) | Milimetreleri puana dönüştürür. |
| [pixelToNewDpi(double pixels, double oldDpi, double newDpi)](#pixelToNewDpi-double-double-double) | Piksel değerlerini bir çözünürlükten diğerine dönüştürür. |
| [pixelToPoint(double pixels)](#pixelToPoint-double) | Piksel değerlerini puana dönüştürür. |
| [pixelToPoint(double pixels, double resolution)](#pixelToPoint-double-double) | Belirtilen piksel çözünürlüğünde piksel değerlerini puana dönüştürür. |
| [pointToInch(double points)](#pointToInch-double) | Puanları inçe dönüştürür. |
| [pointToPixel(double points)](#pointToPixel-double) | Puanları piksele dönüştürür. |
| [pointToPixel(double points, double resolution)](#pointToPixel-double-double) | Belirtilen piksel çözünürlüğünde puanları piksele dönüştürür. |
...
| --- | --- | --- |
| inç | double | Dönüştürülecek değer. |
...
Varsayılan ve özel çözünürlükle puanları piksele dönüştürmeyi nasıl kullanacağınızı gösterir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| piksel | double | Dönüştürülecek değer. |
...
Pikselleri noktaya dönüştürür.  Pikselleri 96 dpi'de noktaya dönüştürür.
...
Sayfa özelliklerini piksellerle nasıl belirteceğinizi gösterir.
...
Belirtilen piksel çözünürlüğünde piksel değerlerini puana dönüştürür.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| nokta | double | Dönüştürülecek değer. |
...
Noktaları piksellere dönüştürür.  Noktaları 96 dpi'de piksellere dönüştürür.
...
Belirtilen piksel çözünürlüğünde puanları piksele dönüştürür.
