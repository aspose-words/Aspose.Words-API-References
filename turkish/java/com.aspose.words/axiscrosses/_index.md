...
description: "Java'da bir eksen için olası kesişim noktalarını belirtir."
type: docs
weight: 25
url: /tr/java/com.aspose.words/axiscrosses/
---
...
| Alan | Açıklama |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Kategori ekseni, değer ekseninin sıfır noktasında (mümkünse) kesişir, ya da minimum değer sıfırdan büyükse minimum değerde, ya da maksimum değer sıfırdan küçükse maksimumda kesişir. |
| [CUSTOM](#CUSTOM) | Dikey bir eksen, eksenin belirtilen değerinde kesişir. |
| [MAXIMUM](#MAXIMUM) | Dikey bir eksen, eksenin maksimum değerinde kesişir. |
| [MINIMUM](#MINIMUM) | Dikey bir eksen, eksenin minimum değerinde kesişir. |
| [length](#length) |  |
## Yöntemler
...
Kategori ekseni, değer ekseninin sıfır noktasında (mümkünse) kesişir, ya da minimum değer sıfırdan büyükse minimum değerde, ya da maksimum değer sıfırdan küçükse maksimumda kesişir.
...
Dikey bir eksen, eksenin belirtilen değerinde kesişir.
...
Dikey bir eksen, eksenin maksimum değerinde kesişir.
...
Dikey bir eksen, eksenin minimum değerinde kesişir.
