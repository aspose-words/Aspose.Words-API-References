...
description: "Java'da INCLUDEPICTURE alanını uygular."
type: docs
weight: 247
url: /tr/java/com.aspose.words/fieldincludepicture/
---
...
Bir resmi alır ve alan sonucu olarak gösterir.

 **Examples:** 

IMPORT ve INCLUDEPICTURE alanlarını kullanarak görüntü eklemenin nasıl yapılacağını gösterir.
...
| [getGraphicFilter()](#getGraphicFilter) | Eklenecek grafiğin formatı için filtre adını alır. |
| [getLocaleId()](#getLocaleId) | Alanının LCID'sini alır. |
| [getResizeHorizontally()](#getResizeHorizontally) | Resmi kaynaktan yatay olarak yeniden boyutlandırıp boyutlandırmayacağını alır. |
| [getResizeVertically()](#getResizeVertically) | Resmi kaynaktan dikey olarak yeniden boyutlandırıp boyutlandırmayacağını alır. |
...
| [getSourceFullName()](#getSourceFullName) | Bir IRI kullanarak resmin konumunu alır. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Eklenecek grafiğin formatı için filtre adını ayarlar. |
| [setLocaleId(int value)](#setLocaleId-int) | Alanının LCID'sini ayarlar. |
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Resmi kaynaktan yatay olarak yeniden boyutlandırıp boyutlandırmayacağını ayarlar. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Resmi kaynaktan dikey olarak yeniden boyutlandırıp boyutlandırmayacağını ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Bir IRI kullanarak resmin konumunu ayarlar. |
...
Eklenecek grafiğin formatı için filtre adını alır.
...
**Returns:**
java.lang.String - Eklenecek grafiğin formatı için filtre adı.
...
Resmi kaynaktan yatay olarak yeniden boyutlandırıp boyutlandırmayacağını alır.
...
**Returns:**
boolean - Resmi kaynaktan yatay olarak yeniden boyutlandırıp boyutlandırmayacağı.
...
Resmi kaynaktan dikey olarak yeniden boyutlandırıp boyutlandırmayacağını alır.
...
**Returns:**
boolean - Resmi kaynaktan dikey olarak yeniden boyutlandırıp boyutlandırmayacağı.
### getResult() {#getResult}
```
...
Bir IRI kullanarak resmin konumunu alır.
...
**Returns:**
java.lang.String - Bir IRI kullanarak resmin konumu.
### getStart() {#getStart}
```
...
Eklenecek grafiğin formatı için filtre adını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Eklenecek grafiğin formatı için filtrenin adı. |
...
Resmi kaynaktan yatay olarak yeniden boyutlandırıp boyutlandırmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Kaynağın yatay olarak resmi yeniden boyutlandırıp boyutlandırmayacağını belirtir. |
...
Resmi kaynaktan dikey olarak yeniden boyutlandırıp boyutlandırmayacağını ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Kaynağın dikey olarak resmi yeniden boyutlandırıp boyutlandırmayacağını belirtir. |
...
Bir IRI kullanarak resmin konumunu ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Resmin IRI kullanılarak konumu. |
