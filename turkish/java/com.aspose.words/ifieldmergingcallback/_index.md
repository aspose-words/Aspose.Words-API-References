...
description: "Java'da bir posta birleştirme işlemi sırasında verilerin birleştirme alanlarına nasıl ekleneceğini kontrol etmek istiyorsanız bu arayüzü uygulayın."
type: docs
weight: 765
url: /tr/java/com.aspose.words/ifieldmergingcallback/
---
```
public interface IFieldMergingCallback
```

Posta birleştirme işlemi sırasında verinin birleştirme alanlarına nasıl ekleneceğini kontrol etmek istiyorsanız bu arayüzü uygulayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [fieldMerging(FieldMergingArgs args)](#fieldMerging-com.aspose.words.FieldMergingArgs) | Aspose.Words posta birleştirme motoru belge içinde bir birleştirme alanına veri eklemek üzereyken çağrılır. |
| [imageFieldMerging(ImageFieldMergingArgs args)](#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs) | Aspose.Words posta birleştirme motoru bir birleştirme alanına görüntü eklemek üzereyken çağrılır. |
...
Aspose.Words posta birleştirme motoru belge içinde bir birleştirme alanına veri eklemek üzereyken çağrılır.
...
Aspose.Words posta birleştirme motoru bir birleştirme alanına görüntü eklemek üzereyken çağrılır.
