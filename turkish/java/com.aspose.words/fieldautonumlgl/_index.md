...
description: "Java'da AUTONUMLGL alanını uygular."
type: docs
weight: 202
url: /tr/java/com.aspose.words/fieldautonumlgl/
---
...
AUTONUMLGL alanlarını kullanarak bir belgeyi nasıl düzenleyeceğinizi gösterir.
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Sayının son nokta olmadan gösterilip gösterilmeyeceğini alır. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Kullanılacak ayırıcı karakteri alır. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Sayının son nokta olmadan gösterilip gösterilmeyeceğini ayarlar. |
| [setResult(String value)](#setResult-java.lang.String) | Alan ayırıcı ile alan sonu arasındaki metni ayarlar. |
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Kullanılacak ayırıcı karakteri ayarlar. |
...
Sayının son nokta olmadan gösterilip gösterilmeyeceğini alır.
...
**Returns:**
boolean - Sayının son nokta olmadan gösterilip gösterilmeyeceği.
### getResult() {#getResult}
```
...
Kullanılacak ayırıcı karakteri alır.
...
**Returns:**
java.lang.String - Kullanılacak ayırıcı karakter.
### getStart() {#getStart}
```
...
Sayının son nokta olmadan gösterilip gösterilmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Sayının son nokta olmadan gösterilip gösterilmeyeceği. |
...
Kullanılacak ayırıcı karakteri ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Kullanılacak ayırıcı karakter. |
