...
description: "Java'da bir Word belgesindeki düzenlenebilir bir aralığın başlangıcını temsil eder."
type: docs
weight: 181
url: /tr/java/com.aspose.words/editablerangestart/
---
...
Word belgesindeki bir düzenlenebilir aralığın başlangıcını temsil eder.
...
Word belgesindeki tam bir düzenlenebilir aralık, aynı Id'ye sahip bir [EditableRangeStart](../../com.aspose.words/editablerangestart/) ve eşleşen bir [EditableRangeEnd](../../com.aspose.words/editablerangeend/) içerir.
...
[getEditableRange()](../../com.aspose.words/editablerangestart/\#getEditableRange) sınıfını, bir düzenlenebilir aralıkla tek bir nesne olarak çalışmak için bir \"facade\" (arayüz) olarak kullanın.

Şu anda düzenlenebilir aralıklar yalnızca satır içi seviyesinde, yani [Paragraph](../../com.aspose.words/paragraph/) içinde desteklenir, ancak düzenlenebilir aralık başlangıcı ve sonu farklı paragraflarda olabilir.
...
| [getEditableRange()](#getEditableRange) | Bu düzenlenebilir aralık başlangıcı ve sonunu kapsayan facade nesnesini alır. |
| [getId()](#getId) | Düzenlenebilir aralığın tanımlayıcısını belirtir. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Bu düğümü hemen izleyen düğümü alır. |
| [getNodeType()](#getNodeType) | [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START) döndürür. |
...
| [setId(int value)](#setId-int) | Düzenlenebilir aralığın tanımlayıcısını belirtir. |
...
[DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor/\#visitEditableRangeStart-com.aspose.words.EditableRangeStart) metodunu çağırır.
...
Bu düzenlenebilir aralık başlangıcı ve sonunu kapsayan facade nesnesini alır.
...
Düzenlenebilir aralığın tanımlayıcısını belirtir.
...
[NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START) döndürür.
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
### getParentIdInternal() {#getParentIdInternal}
```
