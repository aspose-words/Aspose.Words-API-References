...
description: "Java'da çok bölümlü içeriği kabul eden aralıklı yapılandırılmış belge etiketi sonunu temsil eder."
type: docs
weight: 639
url: /tr/java/com.aspose.words/structureddocumenttagrangeend/
---
...
Çok bölümlü içeriği kabul eden **ranged** yapılandırılmış belge etiketi sonunu temsil eder. Ayrıca [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/) düğümüne bakın.
...
| Yapıcı | Açıklama |
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int) | **Structured document tag range end** sınıfının yeni bir örneğini başlatır. |
## Yöntemler
...
| [getId()](#getId) | Bu **StructuredDocumentTagRange** düğümü için benzersiz, yalnızca okunabilir, kalıcı sayısal bir Id belirtir. |
| [getNextSibling()](#getNextSibling) | Bu düğümü hemen izleyen düğümü alır. |
| [getNodeType()](#getNodeType) | Döndürür [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). |
...
**Structured document tag range end** sınıfının yeni bir örneğini başlatır.
...
| id | int | İlgili yapılandırılmış belge etiketi aralığı başlangıcının tanımlayıcısı. |
...
Bu **StructuredDocumentTagRange** düğümü için benzersiz, yalnızca okunabilir, kalıcı sayısal bir Id belirtir. İlgili [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/) düğümünün aynı [StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart/\#getId) değeri vardır.
...
Döndürür [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END).

**Returns:**
int - [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
