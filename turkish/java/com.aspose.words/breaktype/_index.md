...
description: "Java'da bir belgedeki kesme türünü belirtir."
type: docs
weight: 49
url: /tr/java/com.aspose.words/breaktype/
---
...
| Alan | Açıklama |
| --- | --- |
| [COLUMN_BREAK](#COLUMN-BREAK) | Açık sütun kesmesi. |
| [LINE_BREAK](#LINE-BREAK) | Açık satır kesmesi. |
| [PAGE_BREAK](#PAGE-BREAK) | Açık sayfa kesmesi. |
| [PARAGRAPH_BREAK](#PARAGRAPH-BREAK) | Paragraflar arasındaki kesme. |
| [SECTION_BREAK_CONTINUOUS](#SECTION-BREAK-CONTINUOUS) | Yeni bölümün önceki bölümle aynı sayfada başlamasını belirtir. |
| [SECTION_BREAK_EVEN_PAGE](#SECTION-BREAK-EVEN-PAGE) | Yeni bölümün yeni çift sayfada başlamasını belirtir. |
| [SECTION_BREAK_NEW_COLUMN](#SECTION-BREAK-NEW-COLUMN) | Yeni bölümün yeni sütunda başlamasını belirtir. |
| [SECTION_BREAK_NEW_PAGE](#SECTION-BREAK-NEW-PAGE) | Yeni bölümün yeni bir sayfada başlamasını belirtir. |
| [SECTION_BREAK_ODD_PAGE](#SECTION-BREAK-ODD-PAGE) | Yeni bölümün yeni tek sayfada başlamasını belirtir. |
| [length](#length) |  |
## Yöntemler
...
Yeni bölümün önceki bölümle aynı sayfada başlamasını belirtir.
...
Yeni bölümün yeni çift sayfada başlamasını belirtir.
...
Yeni bölümün yeni sütunda başlamasını belirtir.
...
Yeni bölümün yeni bir sayfada başlamasını belirtir.
...
Yeni bölümün yeni tek sayfada başlamasını belirtir.
