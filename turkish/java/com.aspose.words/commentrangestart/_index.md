...
description: "Java'da bir yorumla ilişkilendirilmiş bir metin bölgesinin başlangıcını belirtir."
type: docs
weight: 112
url: /tr/java/com.aspose.words/commentrangestart/
---
...
Yorumla ilişkili bir metin bölgesinin başlangıcını gösterir.

Daha fazla bilgi için, [ Working with Comments ][Working with Comments] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Metin bölgesine bağlı bir yorum oluşturmak için, bir [Comment](../../com.aspose.words/comment/) oluşturmalı, ardından [CommentRangeStart](../../com.aspose.words/commentrangestart/) ve [CommentRangeEnd](../../com.aspose.words/commentrangeend/) oluşturmalı ve kimliklerini aynı [Comment.getId()](../../com.aspose.words/comment/\#getId) / [Comment.setId(int)](../../com.aspose.words/comment/\#setId-int) değeriyle ayarlamalısınız.
...
Bir belge ziyaretçisi kullanarak tüm yorumların ve yorum aralıklarının içeriğinin nasıl yazdırılacağını gösterir.
...
| Yapıcı | Açıklama |
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | Bu sınıfın yeni bir örneğini başlatır. |
## Yöntemler
...
| [getId()](#getId) | Bu bölgenin bağlı olduğu yorumun tanımlayıcısını belirtir. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Bu düğümü hemen izleyen düğümü alır. |
| [getNodeType()](#getNodeType) | [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START) değerini döndürür. |
...
| [setId(int value)](#setId-int) | Bu bölgenin bağlı olduğu yorumun tanımlayıcısını belirtir. |
...
Bir [CommentRangeStart](../../com.aspose.words/commentrangestart/) oluşturulduğunda, belirtilen belgeye aittir, ancak henüz belgenin bir parçası değildir ve [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) null'dur.

Bir [CommentRangeStart](../../com.aspose.words/commentrangestart/) belgeye eklemek için, yorumun eklenmesini istediğiniz paragrafta InsertAfter veya InsertBefore kullanın.
...
| id | int | Bu nesnenin bağlı olduğu yorumun tanımlayıcısı. |
...
Çağırır [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\#visitCommentRangeStart-com.aspose.words.CommentRangeStart).
...
[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START) değerini döndürür.
...
**Returns:**
int - [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
### getParentIdInternal() {#getParentIdInternal}
```
