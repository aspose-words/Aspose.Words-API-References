...
description: "Uygulandığında, Java'da FieldIf ve FieldCompare alanları için varsayılan karşılaştırma ifadeleri değerlendirmesini geçersiz kılmaya izin verir."
type: docs
weight: 755
url: /tr/java/com.aspose.words/icomparisonexpressionevaluator/
---
```
public interface IComparisonExpressionEvaluator
```

Uygulandığında, [FieldIf](../../com.aspose.words/fieldif/) ve [FieldCompare](../../com.aspose.words/fieldcompare/) alanları için varsayılan karşılaştırma ifadeleri değerlendirmesini geçersiz kılmaya izin verir.
...
| Yöntem | Açıklama |
| --- | --- |
| [evaluate(Field field, ComparisonExpression expression)](#evaluate-com.aspose.words.Field-com.aspose.words.ComparisonExpression) | Karşılaştırma ifadesini değerlendirir. |
...
Uygulama, varsayılan değerlendirmenin yapılacağını göstermek için  null  döndürmelidir.
