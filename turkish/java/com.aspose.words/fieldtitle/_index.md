...
description: "Java'da TITLE alanını uygular."
type: docs
weight: 296
url: /tr/java/com.aspose.words/fieldtitle/
---
...
Yerleşik belge özelliklerinde **Title** özelliğinde kaydedilen belgenin başlığını alır ve isteğe bağlı olarak ayarlar.
...
| [getText()](#getText) | Başlığın metnini alır. |
...
| [setText(String value)](#setText-java.lang.String) | Başlığın metnini ayarlar. |
...
**Returns:**
java.lang.String - Başlığın metni.
### getType() {#getType}
```
public int getType()
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Başlığın metni. |
