...
description: "Java'da bir grafik veri işaretçisini temsil eder."
type: docs
weight: 82
url: /tr/java/com.aspose.words/chartmarker/
---
...
Grafik veri işaretçisini temsil eder.
...
| Yöntem | Açıklama |
| --- | --- |
| [getFormat()](#getFormat) | Bu işaretçinin dolgu ve çizgi biçimlendirmesine erişim sağlar. |
| [getShapeType()](#getShapeType) |  |
| [getSize()](#getSize) | Grafik işaretçi boyutunu alır. |
| [getSymbol()](#getSymbol) | Grafik işaretçi sembolünü alır. |
| [isFillSupported()](#isFillSupported) |  |
| [isFormatDefined()](#isFormatDefined) |  |
| [materializeSpPr()](#materializeSpPr) |  |
| [setShapeType(int value)](#setShapeType-int) |  |
| [setSize(int value)](#setSize-int) | Grafik işaretçi boyutunu ayarlar. |
| [setSymbol(int value)](#setSymbol-int) | Grafik işaretçi sembolünü ayarlar. |
### getFormat() {#getFormat}
```
...
Bu işaretçinin dolgu ve çizgi biçimlendirmesine erişim sağlar.
...
Grafik işaretçi boyutunu alır. Varsayılan değer 7'dir.
...
Grafik işaretçi sembolünü alır.
...
**Returns:**
int - Grafik işaretçi sembolü. Döndürülen değer, [MarkerSymbol](../../com.aspose.words/markersymbol/) sabitlerinden biridir.
### isFillSupported() {#isFillSupported}
```
...
Grafik işaretçi boyutunu ayarlar. Varsayılan değer 7'dir.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | int | Grafik işaretçi boyutu. |
...
Grafik işaretçi sembolünü ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | int | Grafik işaretçi sembolü. Değer, [MarkerSymbol](../../com.aspose.words/markersymbol/) sabitlerinden biri olmalıdır. |
