...
description: "Java'da bir belgeyi HTML formatına dışa aktarırken Aspose.Words'in yazı tiplerini nasıl kaydettiğini kontrol etmek ve bildirim almak istiyorsanız bu arabirimi uygulayın."
type: docs
weight: 771
url: /tr/java/com.aspose.words/ifontsavingcallback/
---
```
public interface IFontSavingCallback
```

Bir belgeyi HTML formatına dışa aktarırken Aspose.Words'un yazı tiplerini nasıl kaydettiğini kontrol etmek ve bildirimler almak istiyorsanız bu arabirimi uygulayın.
...
| Yöntem | Açıklama |
| --- | --- |
| [fontSaving(FontSavingArgs args)](#fontSaving-com.aspose.words.FontSavingArgs) | Aspose.Words bir yazı tipi kaynağını kaydetmek üzereyken çağrılır. |
...
Aspose.Words bir yazı tipi kaynağını kaydetmek üzereyken çağrılır.
