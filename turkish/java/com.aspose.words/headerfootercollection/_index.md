...
description: "Java'da bir Bölümün HeaderFooter düğümlerine tipli erişim sağlar."
type: docs
weight: 371
url: /tr/java/com.aspose.words/headerfootercollection/
---
...
Bir [Section](../../com.aspose.words/section/) öğesinin [HeaderFooter](../../com.aspose.words/headerfooter/) düğümlerine tipli erişim sağlar.

Daha fazla bilgi için, [ Working with Headers and Footers ][Working with Headers and Footers] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Maksimum bir [HeaderFooter](../../com.aspose.words/headerfooter/) bulunabilir.

her [Section](../../com.aspose.words/section/) başına bir [HeaderFooterType](../../com.aspose.words/headerfootertype/) olmak üzere.
...
Bir belgeden tüm altbilgileri silmenin nasıl yapılacağını gösterir.
...
| [get(int index)](#get-int) | Verilen dizindeki bir [HeaderFooter](../../com.aspose.words/headerfooter/) alır. |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean) | Tüm üstbilgileri ve altbilgileri önceki bölümdeki karşılık gelen üstbilgi ve altbilgilere bağlar veya bağlamayı kaldırır. |
...
| [toArray()](#toArray) | Koleksiyondaki tüm  HeaderFooter  nesnelerini yeni bir  HeaderFooter  dizisine kopyalar. |
...
Verilen dizindeki bir [HeaderFooter](../../com.aspose.words/headerfooter/) alır.
...
Bölümler arasında üstbilgi ve altbilgileri bağlamanın nasıl yapılacağını gösterir.
...
Tüm üstbilgileri ve altbilgileri önceki bölümdeki karşılık gelen üstbilgi ve altbilgilere bağlar veya bağlamayı kaldırır.

 **Remarks:** 

Üstbilgi veya altbilgilerden herhangi biri yoksa, otomatik olarak oluşturur.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| isLinkToPrevious | boolean | true  önceki bölüme üstbilgi ve altbilgileri bağlamak için;  false  bağlamayı kaldırmak için. |
...
Koleksiyondaki tüm  HeaderFooter  nesnelerini yeni bir  HeaderFooter  dizisine kopyalar.
...
**Returns:**
com.aspose.words.HeaderFooter[] - Bir dizi  HeaderFooter  nesnesi.
