...
description: "Bir SubDocument'i temsil eder - Java'da harici olarak depolanan bir belgeye referanstır."
type: docs
weight: 645
url: /tr/java/com.aspose.words/subdocument/
---
...
**SubDocument** \- harici depolanmış bir belgeye referans olan bir nesneyi temsil eder.
...
Aspose.Words'ün bu sürümünde, [SubDocument](../../com.aspose.words/subdocument/) düğümleri bir alt belge oluşturmak veya değiştirmek için genel yöntemler ve özellikler sağlamaz. Bu sürümde [SubDocument](../../com.aspose.words/subdocument/) düğümlerini örnekleyemez veya mevcut olanları silebilmek dışında değiştiremezsiniz.
...
| [getNodeType()](#getNodeType) | Döndürür [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). |
...
Döndürür [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT).
...
**Returns:**
int - [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). Döndürülen değer, [NodeType](../../com.aspose.words/nodetype/) sabitlerinden biridir.
