...
description: "CheckBox kontrolü Java'da bir değeri değiştirir."
type: docs
weight: 100
url: /tr/java/com.aspose.words/checkboxcontrol/
---
...
Üç olası durumu vardır: seçili, temizlenmiş ve ne seçili ne de temizlenmiş, yani açık ve kapalı durumların bir kombinasyonu.
...
| [getChecked()](#getChecked) | Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer alır. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer ayarlar. |
...
Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer alır. Varsayılan değer  false  dır.
...
**Returns:**
boolean - Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer.
...
Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer ayarlar. Varsayılan değer  false  dır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | boolean | Bu [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) işaretli olup olmadığını gösteren bir boolean değer. |
