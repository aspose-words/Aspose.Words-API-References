...
description: "Java'da bir belge özelliğinin veri tipini belirtir."
type: docs
weight: 555
url: /tr/java/com.aspose.words/propertytype/
---
...
| Alan | Açıklama |
| --- | --- |
| [BOOLEAN](#BOOLEAN) | Özellik bir boolean değerdir. |
| [BYTE_ARRAY](#BYTE-ARRAY) | Özellik bir bayt dizisidir. |
| [DATE_TIME](#DATE-TIME) | Özellik bir tarih saat değeridir. |
| [DOUBLE](#DOUBLE) | Özellik bir kayan nokta sayıdır. |
| [NUMBER](#NUMBER) | Özellik bir tam sayı değeridir. |
| [OBJECT_ARRAY](#OBJECT-ARRAY) | Özellik bir nesne dizisidir. |
| [OTHER](#OTHER) | Özellik başka bir türdür. |
| [STRING](#STRING) | Özellik bir metin (string) değeridir. |
| [STRING_ARRAY](#STRING-ARRAY) | Özellik bir metin dizisidir. |
| [length](#length) |  |
## Yöntemler
...
Özellik bir tarih saat değeridir.
...
Özellik bir kayan nokta sayıdır.
...
Özellik bir tam sayı değeridir.
...
Özellik bir metin (string) değeridir.
