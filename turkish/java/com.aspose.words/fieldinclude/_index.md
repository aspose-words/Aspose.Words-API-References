...
description: "Java'da INCLUDE alanını uygular."
type: docs
weight: 246
url: /tr/java/com.aspose.words/fieldinclude/
---
...
INCLUDE alanını nasıl oluşturacağınızı ve özelliklerini nasıl ayarlayacağınızı gösterir.
...
| [getSourceFullName()](#getSourceFullName) | Belgenin konumunu alır. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Belgenin konumunu ayarlar. |
...
**Returns:**
java.lang.String - Belgenin konumu.
### getStart() {#getStart}
```
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Belgenin konumu. |
