...
description: "Java'da FILENAME alanını uygular."
type: docs
weight: 230
url: /tr/java/com.aspose.words/fieldfilename/
---
...
Mevcut uygulamada, dosya adını almak için [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) özelliğini kullanır. Belge bir akıştan yüklendiyse veya boş oluşturulduysa, (biliniyorsa) kaydedilen dosyanın adını kullanır.

 **Examples:** 

FILENAME alanı için varsayılan değeri geçersiz kılmak amacıyla FieldOptions kullanımını gösterir.
...
| [getIncludeFullPath()](#getIncludeFullPath) | Tam dosya yolu adının dahil edilip edilmeyeceğini alır. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Tam dosya yolu adının dahil edilip edilmeyeceğini ayarlar. |
...
Tam dosya yolu adının dahil edilip edilmeyeceğini alır.
...
**Returns:**
boolean - Tam dosya yolu adının dahil edilip edilmeyeceği.
...
Tam dosya yolu adının dahil edilip edilmeyeceğini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | boolean | Tam dosya yolu adının dahil edilip edilmeyeceği. |
