...
description: "Java'da MERGEREC alanını uygular."
type: docs
weight: 259
url: /tr/java/com.aspose.words/fieldmergerec/
---

**Inheritance:**
java.lang.Object, [com.aspose.words.Field](../../com.aspose.words/field/)
```
public class FieldMergeRec extends Field
```
...
Şu anda MERGEREC ve MERGESEQ alanları aynı işlevi gerçekleştiriyor çünkü Aspose.Words posta birleştirmesinde kayıtları nasıl atlayacağımızı kesin olarak bilmiyoruz.

 **Examples:** 

Bir posta birleştirme çıktısı belgelerinde posta birleştirme kayıtlarını numaralandırmak ve saymak için MERGEREC ve MERGESEQ alanlarının nasıl kullanılacağını gösterir.
