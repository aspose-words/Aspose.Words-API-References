...
description: "Java'da grafik ekseninin tipini belirtir."
type: docs
weight: 70
url: /tr/java/com.aspose.words/chartaxistype/
---
...
Grafik ekseninin tipini belirtir.
...
| Alan | Açıklama |
| --- | --- |
| [CATEGORY](#CATEGORY) | Bir grafiğin kategori ekseni. |
| [SERIES](#SERIES) | Bir grafiğin seri ekseni. |
| [VALUE](#VALUE) | Bir grafiğin değer ekseni. |
| [length](#length) |  |
## Yöntemler
