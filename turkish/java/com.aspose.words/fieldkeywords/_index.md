...
description: "Java'da KEYWORDS alanını uygular."
type: docs
weight: 252
url: /tr/java/com.aspose.words/fieldkeywords/
---
...
KEYWORDS alanını uygular.

Daha fazla bilgi için, [ Working with Fields ][Working with Fields] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Belgenin anahtar kelimelerini alır ve isteğe bağlı olarak ayarlar; bu anahtar kelimeler, yerleşik belge özelliklerinin **Keywords** özelliğinde kaydedilir.
...
| [getText()](#getText) | Anahtar kelimelerin metnini alır. |
...
| [setText(String value)](#setText-java.lang.String) | Anahtar kelimelerin metnini ayarlar. |
...
Anahtar kelimelerin metnini alır.
...
**Returns:**
java.lang.String - Anahtar kelimelerin metni.
### getType() {#getType}
```
public int getType()
```
...
Anahtar kelimelerin metnini ayarlar.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| değer | java.lang.String | Anahtar kelimelerin metni. |
