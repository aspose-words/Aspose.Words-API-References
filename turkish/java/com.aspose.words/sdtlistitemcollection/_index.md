...
description: "Java'da yapılandırılmış bir belge etiketinin SdtListItem öğelerine erişim sağlar."
type: docs
weight: 603
url: /tr/java/com.aspose.words/sdtlistitemcollection/
---
...
Yapılandırılmış bir belge etiketinin [SdtListItem](../../com.aspose.words/sdtlistitem/) öğelerine erişim sağlar.
...
| Yöntem | Açıklama |
| --- | --- |
| [add(SdtListItem item)](#add-com.aspose.words.SdtListItem) | Bu koleksiyona bir öğe ekler. |
| [clear()](#clear) | Bu koleksiyondaki tüm öğeleri temizler. |
| [get(int index)](#get-int) | Koleksiyondaki sıfır tabanlı indeksine göre bir [SdtListItem](../../com.aspose.words/sdtlistitem/) nesnesi döndürür. |
| [getCount()](#getCount) | Koleksiyondaki öğe sayısını alır. |
| [getSelectedValue()](#getSelectedValue) | Bu listede şu anda seçili değeri belirtir. |
...
| [removeAt(int index)](#removeAt-int) | Belirtilen indeksdeki bir liste öğesini kaldırır. |
| [setSelectedValue(SdtListItem value)](#setSelectedValue-com.aspose.words.SdtListItem) | Bu listede şu anda seçili değeri belirtir. |
...
Bu koleksiyondaki tüm öğeleri temizler.
...
Koleksiyondaki sıfır tabanlı indeksine göre bir [SdtListItem](../../com.aspose.words/sdtlistitem/) nesnesi döndürür.
...
Bu listede şu anda seçili değeri belirtir. Null değere izin verilir, bu da şu anda seçili bir girişin bu liste öğesi koleksiyonuyla ilişkili olmadığı anlamına gelir.
...
Belirtilen indeksdeki bir liste öğesini kaldırır.
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| indeks | int | Kaldırılacak öğenin sıfır tabanlı indeksi. |
...
| Parametre | Tür | Açıklama |
| --- | --- | --- |
| value | [SdtListItem](../../com.aspose.words/sdtlistitem/) | İlgili [SdtListItem](../../com.aspose.words/sdtlistitem/) değeri. |
