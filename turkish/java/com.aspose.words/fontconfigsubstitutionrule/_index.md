...
description: "Java'da font yapılandırma ikame kuralı."
type: docs
weight: 320
url: /tr/java/com.aspose.words/fontconfigsubstitutionrule/
---
...
Yazı tipi yapılandırma ikame kuralı.

Daha fazla bilgi için, [ Working with Fonts ][Working with Fonts] dokümantasyon makalesini ziyaret edin.

 **Remarks:** 

Bu kural, orijinal font mevcut değilse ikameyi elde etmek için Linux (ve diğer Unix benzeri) platformlarda fontconfig aracını kullanır.
