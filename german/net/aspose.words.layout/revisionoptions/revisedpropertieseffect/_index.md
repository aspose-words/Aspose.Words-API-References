...
description: Entdecken Sie, wie der RevisedPropertiesEffect in RevisionOptions Ihre Inhaltsformatierung verbessert. Mit der Funktion „FormatChange“ können Sie Änderungen ganz einfach anpassen.
type: docs
weight: 140
...
Ermöglicht die Festlegung der Auswirkung auf Inhaltsbereiche bei Änderungen der FormatierungseigenschaftenFormatChange Der Standardwert istNone
...
| Ausnahme | Bedingung |
| --- | --- |
| ArgumentOutOfRangeException | Hidden ist nicht erlaubt. |
