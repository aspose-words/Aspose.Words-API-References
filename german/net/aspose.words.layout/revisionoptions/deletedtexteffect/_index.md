...
description: RevisionOptions eigendom. Ermöglicht die Angabe des Effekts der auf den gelöschten Inhalt angewendet werden sollDeletion . Der Standardwert istStrikeThrough
type: docs
weight: 30
