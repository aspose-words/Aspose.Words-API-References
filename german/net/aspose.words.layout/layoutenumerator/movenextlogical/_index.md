...
description: LayoutEnumerator methode. Wechselt in logischer Reihenfolge zur nächsten gleichgeordneten Entität. Beim Iterieren von Zeilen eines Absatzes die über Seiten hinweg unterbrochen sind wechselt diese Methode zur nächsten Zeile selbst wenn sie sich auf einer anderen Seite befindet.
type: docs
weight: 120
...
Wechselt in logischer Reihenfolge zur nächsten gleichgeordneten Entität. Beim Iterieren von Zeilen eines Absatzes, die über Seiten hinweg unterbrochen sind, wechselt diese Methode zur nächsten Zeile, selbst wenn sie sich auf einer anderen Seite befindet.
