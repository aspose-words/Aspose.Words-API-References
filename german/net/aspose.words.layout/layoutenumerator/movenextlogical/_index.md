...
description: Entdecken Sie, wie die MoveNextLogical-Methode von LayoutEnumerator nahtlos zwischen Geschwisterentitäten navigiert und so eine reibungslose Iteration von Absatzzeilen über mehrere Seiten hinweg gewährleistet.
type: docs
weight: 130
...
Wechselt in logischer Reihenfolge zum nächsten Geschwisterelement. Beim Durchlaufen von Zeilen eines Absatzes, der über mehrere Seiten verteilt ist, wechselt diese Methode zur nächsten Zeile, auch wenn sich diese auf einer anderen Seite befindet.
