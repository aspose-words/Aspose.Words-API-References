...
description: LayoutEnumerator constructeur. Initialisiert eine neue Instanz dieser Klasse.
type: docs
weight: 10
...
| --- | --- | --- |
| document | Document | Ein Dokument, dessen Seitenlayoutmodell aufzuzählen ist. |

### Bemerkungen

Wenn das Seitenlayoutmodell des Dokuments nicht erstellt wurde, ruft der Enumerator auf[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/) es zu bauen.

Immer wenn das Dokument aktualisiert und ein neues Seitenlayoutmodell erstellt wird, muss ein neuer Enumerator verwendet werden, um darauf zuzugreifen.
