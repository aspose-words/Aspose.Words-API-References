...
description: LayoutEnumerator methode. Wechselt zur nächsten gleichgeordneten Entität in visueller Reihenfolge. Beim Iterieren von Zeilen eines Absatzes die über Seiten hinweg unterbrochen sind wechselt diese Methode nicht zur nächsten Seite sondern zur nächsten Entität auf derselben Seite.
type: docs
weight: 110
...
Wechselt zur nächsten gleichgeordneten Entität in visueller Reihenfolge. Beim Iterieren von Zeilen eines Absatzes, die über Seiten hinweg unterbrochen sind, wechselt diese Methode nicht zur nächsten Seite, sondern zur nächsten Entität auf derselben Seite.
