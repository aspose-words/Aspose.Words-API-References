...
description: Entdecken Sie die Eigenschaft „LayoutEnumerator Kind“, die den aktuellen Entitätstyp identifiziert. Sorgen Sie mit dieser wichtigen Funktion für Übersichtlichkeit in Ihren Daten.
type: docs
weight: 50
...
Gibt die Art der aktuellen Entität an. Dies kann ein leerer String sein, aber niemals`null` .
...
Dies ist ein spezifischerer Typ der aktuellen Entität, z. B. hat der LesezeichenbereichSpan Typ und können entweder vom Typ BOOKMARKSTART oder BOOKMARKEND sein.
