...
description: CompareOptions eigendom. Gibt an welches Dokument als Ziel beim Vergleich verwendet werden soll.
type: docs
weight: 120
...
Gibt an, welches Dokument als Ziel beim Vergleich verwendet werden soll.
