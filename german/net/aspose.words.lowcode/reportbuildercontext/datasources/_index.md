...
description: Entdecken Sie die DataSources-Eigenschaft von ReportBuilderContext für die nahtlose Berichterstellung mit vielseitigen, auf Ihre Anforderungen zugeschnittenen Datenquellen.
type: docs
weight: 20
url: /de/net/aspose.words.lowcode/reportbuildercontext/datasources/
---
## ReportBuilderContext.DataSources property

Zum Erstellen des Berichts verwendete Datenquellen.
...
Der Schlüssel stellt die Datenquelle dar, während der Wert der Name der Datenquelle ist. Der Name der Datenquelle kann null oder eine leere Zeichenfolge sein. In solchen Fällen erkennt die Berichts-Engine den Namen der Datenquelle automatisch aus der angegebenen Datenquelle.
