...
description: Gibt die Kategorisierung der zweiten Ebene für den Baustein an.
type: docs
weight: 30
...
Bausteine in der Benutzeroberfläche von Microsoft Word sind in Galerien angeordnet. Jeder[`Gallery`](../gallery) kann mehrere Kategorien haben. Jeder Block innerhalb a`Category` hat ein[`Name`](../name).

Kann nicht sein`Null` und darf kein leerer String sein.
