...
description: Gibt die Kategorisierung der ersten Ebene für den Baustein zum Zweck der -Klassifizierung oder Sortierung der Benutzeroberfläche an.
type: docs
weight: 60
...
Gibt die Kategorisierung der ersten Ebene für den Baustein zum Zweck der -Klassifizierung oder Sortierung der Benutzeroberfläche an.
...
Bausteine in der Benutzeroberfläche von Microsoft Word sind in Galerien angeordnet. Jeder`Gallery` kann mehrere Kategorien haben. Jeder Block innerhalb a[`Category`](../category) hat ein[`Name`](../name).
