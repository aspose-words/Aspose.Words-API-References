...
| --- | --- | --- |
| glossaryDoc | GlossaryDocument | Das Besitzerdokument. |

### Bemerkungen

Wann[`BuildingBlock`](../../buildingblock) erstellt wird, gehört es zum angegebenen Glossardokument, ist aber noch nicht Teil des Glossardokuments und[`ParentNode`](../../../aspose.words/node/parentnode) ist`Null`.

Anhängen[`BuildingBlock`](../../buildingblock) zu einem[`GlossaryDocument`](../../glossarydocument) benutze [`AppendChild`](../../../aspose.words/compositenode/appendchild).
