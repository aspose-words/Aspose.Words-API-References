...
description: Aspose.Words.BuildingBlocks.BuildingBlockBehavior opsomming. Gibt das Verhalten an das auf den Inhalt des Bausteins angewendet werden soll wenn er in das Hauptdokument eingefügt wird.
type: docs
weight: 130
