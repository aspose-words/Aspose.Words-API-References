...
description: Entdecken Sie die Aufzählung Aspose.Words BuildingBlockBehavior, die definiert, wie Bausteine den Inhalt Ihres Dokuments beim Einfügen für eine nahtlose Bearbeitung verbessern.
type: docs
weight: 330
...
| Page | `2` | Gibt an, dass der Baustein in eine eigene Seite eingefügt werden soll. |
