...
| Klasse | Beschreibung |
| --- | --- |
| [BuildingBlock](./buildingblock/) | Stellt einen Glossardokumenteintrag wie einen Baustein, einen AutoText oder einen AutoKorrektureintrag dar. |
| [BuildingBlockCollection](./buildingblockcollection/) | Eine Sammlung von[`BuildingBlock`](../aspose.words.buildingblocks/buildingblock/)Objekte im Dokument. |
| [GlossaryDocument](./glossarydocument/) | Stellt das Stammelement für ein Glossardokument in einem Word-Dokument dar. Ein Glossardokument ist ein Speicher für AutoText, AutoKorrektur-Einträge und Bausteine. |
## Aufzählung
