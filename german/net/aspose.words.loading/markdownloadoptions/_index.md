...
description: Entdecken Sie Aspose.Words.MarkdownLoadOptions, um das Laden von Markdown-Dokumenten zu verbessern. Passen Sie die Optionen für eine nahtlose Integration in Ihre Projekte an.
type: docs
weight: 4120
url: /de/net/aspose.words.loading/markdownloadoptions/
---
## MarkdownLoadOptions class

Ermöglicht die Angabe zusätzlicher Optionen beim LadenMarkdown Dokument in ein[`Document`](../../aspose.words/document/) Objekt.
...
| Name | Beschreibung |
| --- | --- |
| [MarkdownLoadOptions](markdownloadoptions/)() | Initialisiert eine neue Instanz von`MarkdownLoadOptions` Klasse. |
...
| [ImportUnderlineFormatting](../../aspose.words.loading/markdownloadoptions/importunderlineformatting/) { get; set; } | Ruft einen booleschen Wert ab oder legt ihn fest, der angibt, ob eine Sequenz von zwei Pluszeichen "++" als Unterstreichungstextformatierung erkannt werden soll. Der Standardwert ist`FALSCH` . |
...
| [PreserveEmptyLines](../../aspose.words.loading/markdownloadoptions/preserveemptylines/) { get; set; } | Ruft einen booleschen Wert ab oder setzt ihn, der angibt, ob leere Zeilen beim Laden einesMarkdown document. Der Standardwert ist`FALSCH` . |
