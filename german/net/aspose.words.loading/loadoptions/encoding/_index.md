...
description: Ruft die Kodierung ab oder legt sie fest die verwendet wird um ein HTML- TXT- oder CHM-Dokument zu laden wenn die Kodierung nicht innerhalb des Dokuments angegeben ist. Kann null sein. Standard ist null.
type: docs
weight: 50
