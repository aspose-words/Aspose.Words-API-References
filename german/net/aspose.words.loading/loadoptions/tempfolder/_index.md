...
description: Ermöglicht die Verwendung temporärer Dateien beim Lesen des Dokuments. Standardmäßig ist diese EigenschaftNull und es werden keine temporären Dateien verwendet.
type: docs
weight: 150
