...
description: Aspose.Words.Loading.ChmLoadOptions klas. Ermöglicht die Angabe zusätzlicher Optionen beim Laden eines CHMDokuments in eineDocument Objekt.
type: docs
weight: 3370
...
Ermöglicht die Angabe zusätzlicher Optionen beim Laden eines CHM-Dokuments in eine[`Document`](../../aspose.words/document/) Objekt.
