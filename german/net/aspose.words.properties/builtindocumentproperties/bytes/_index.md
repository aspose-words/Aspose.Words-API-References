...
description: Entdecken Sie die Eigenschaft „BuiltInDocumentProperties Bytes“, ein wichtiges Tool zum Schätzen der Dokumentgröße und zur Verbesserung der Dateiverwaltung und Effizienz.
type: docs
weight: 20
url: /de/net/aspose.words.properties/builtindocumentproperties/bytes/
---
## BuiltInDocumentProperties.Bytes property

Stellt eine Schätzung der Anzahl der Bytes im Dokument dar.
...
Microsoft Word legt diese Eigenschaft nicht immer fest.
