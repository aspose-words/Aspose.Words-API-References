...
description: Entdecken Sie die Aspose.Words WebExtensionBindingType-Aufzählung, die Bindungstypen für die nahtlose Integration von Weberweiterungen in Ihre Dokumentdaten definiert.
type: docs
weight: 7620
...
Listet die verfügbaren Bindungstypen zwischen einer Weberweiterung und den Daten im Dokument auf.
...
| Text | `2` | Klartext. |
| Default | `0` | Standardmäßig verwendete Matrix. |
