...
description: Entdecken Sie die Aufzählung Aspose.Words.WebExtensions.TaskPaneDockState, die Aufgabenbereichspositionen für eine verbesserte Dokumentbearbeitung und Benutzererfahrung definiert.
type: docs
weight: 7580
...
Listet die verfügbaren Speicherorte des Aufgabenbereichobjekts auf.
...
| --- | --- | --- |
| Right | `0` | Docken Sie den Aufgabenbereich an der rechten Seite des Dokumentfensters an. |
