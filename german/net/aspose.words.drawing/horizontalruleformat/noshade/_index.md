...
description: Zeigt das Vorhandensein von 3DSchattierung für die horizontale Linie an. Wenn wahr dann ist die horizontale Linie ohne 3DSchattierung und es wird Volltonfarbe verwendet.
type: docs
weight: 40
