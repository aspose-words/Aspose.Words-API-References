...
description: Entdecken Sie die Enumeration Aspose.Words.Drawing.EndCap für anpassbare Zeilenabschlussstile. Verbessern Sie Ihre Dokumentdesigns mit einzigartigen visuellen Effekten!
type: docs
weight: 1260
...
Gibt den Stil des Zeilenendes an.
...
| --- | --- | --- |
| Round | `0` | Abgerundete Enden. |
| Square | `1` | Quadrat steht um die halbe Linienbreite hervor. |
