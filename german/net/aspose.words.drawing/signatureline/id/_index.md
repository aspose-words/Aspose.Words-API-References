...
description: Entdecken Sie die SignatureLine-ID-Eigenschaft, um Signaturzeilenkennungen einfach zu verwalten und anzupassen, um eine nahtlose Dokumentintegration und ein verbessertes Benutzererlebnis zu gewährleisten.
type: docs
weight: 40
...
Diese Kennung kann mit einer digitalen Signatur verknüpft werden, wenn ein Dokument mit[`DigitalSignatureUtil`](../../../aspose.words.digitalsignatures/digitalsignatureutil/). Dieser Wert muss eindeutig sein und wird standardmäßig zufällig generiert. Neue Guid (NewGuid).
