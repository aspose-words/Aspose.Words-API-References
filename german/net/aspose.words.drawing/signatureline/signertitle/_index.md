...
description: SignatureLine eigendom. Ruft den Titel des vorgeschlagenen Unterzeichners ab oder legt ihn fest z. B. Manager. Der Standardwert für diese Eigenschaft ist leerer String Empty .
type: docs
weight: 110
...
Ruft den Titel des vorgeschlagenen Unterzeichners ab oder legt ihn fest (z. B. Manager). Der Standardwert für diese Eigenschaft ist **leerer String** (Empty ).
