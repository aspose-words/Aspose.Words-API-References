...
description: Stellt ein Objekt in der Zeichnungsebene dar z. B. eine AutoForm ein Textfeld eine Freiform ein OLEObjekt ein ActiveXSteuerelement oder ein Bild.
type: docs
weight: 1100
...
Verwendung der`Shape` Klasse können Sie Formen in einem Microsoft Word-Dokument erstellen oder ändern.
