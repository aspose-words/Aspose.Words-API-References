...
| Cross | `13` | Kreuz. |
| DarkDownwardDiagonal | `14` | Dunkle Abwärtsdiagonale. |
| DarkHorizontal | `15` | Dunkel horizontal. |
| DarkUpwardDiagonal | `16` | Dunkle Aufwärtsdiagonale. |
...
| DashedUpwardDiagonal | `20` | Diagonal nach oben gestrichelt. |
...
| DownwardDiagonal | `27` | Abwärtsdiagonale. |
...
| LightDownwardDiagonal | `33` | Leicht nach unten gerichtete Diagonale. |
...
| OutlinedDiamond | `40` | Umrissener Diamant. |
| Plaid | `41` | Plaid. |
| Shingle | `42` | Schindel. |
...
| Sphere | `47` | Kugel. |
| Trellis | `48` | Spalier. |
| UpwardDiagonal | `49` | Aufwärtsdiagonale. |
| Vertical | `50` | Vertikal. |
| Wave | `51` | Welle. |
| Weave | `52` | Weben. |
| WideDownwardDiagonal | `53` | Breite Abwärtsdiagonale. |
| WideUpwardDiagonal | `54` | Breite Aufwärtsdiagonale. |
| ZigZag | `55` | Zickzack. |
