...
description: Entdecken Sie, wie die TextPath XScale-Eigenschaft Ihr Design verbessert, indem sie gerade Textpfade für glattere, präzisere Layouts ermöglicht.
type: docs
weight: 200
...
Bestimmt, ob anstelle des Formpfads ein gerader Textpfad verwendet wird.
...
Wenn`WAHR`, verläuft der Text entlang eines Pfades von links nach rechts entlang des x-Werts von , der unteren Grenze der Form.
