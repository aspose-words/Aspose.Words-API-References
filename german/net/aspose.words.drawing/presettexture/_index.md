...
| Canvas | `4` | Leinwandtextur. |
| Cork | `5` | Korkstruktur. |
| Denim | `6` | Denim-Textur. |
| FishFossil | `7` | Fischfossil-Textur. |
| Granite | `8` | Granittextur. |
| GreenMarble | `9` | Grüne Marmorstruktur. |
| MediumWood | `10` | Mittlere Holzstruktur. |
| Newsprint | `11` | Zeitungspapier-Textur. |
| Oak | `12` | Eichenstruktur. |
| PaperBag | `13` | Papiertütentextur. |
| Papyrus | `14` | Papyrus-Textur. |
| Parchment | `15` | Pergamenttextur. |
