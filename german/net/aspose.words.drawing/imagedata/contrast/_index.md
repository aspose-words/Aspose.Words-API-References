...
description: Passen Sie den Bildkontrast einfach mit der ImageData-Kontrast-Eigenschaft an. Stellen Sie Werte zwischen 0,0 (niedrig) und 1,0 (hoch) ein, um optimale Bildschärfe und -qualität zu erzielen.
type: docs
weight: 50
...
Ruft den Kontrast für das angegebene Bild ab oder legt ihn fest. Der Wert für diese Eigenschaft muss eine Zahl zwischen 0,0 (geringster Kontrast) und 1,0 (größter Kontrast) sein.
