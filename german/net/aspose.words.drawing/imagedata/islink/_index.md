...
description: Entdecken Sie, wie die ImageData IsLink-Eigenschaft Ihr Design verbessert, indem sie Bilder nahtlos mit Formen verknüpft, wenn SourceFullName festgelegt ist. Steigern Sie Ihre Kreativität!
type: docs
weight: 150
...
Rückgaben`WAHR` wenn das Bild mit der Form verknüpft ist (wenn[`SourceFullName`](../sourcefullname/) angegeben ist).
