...
description: ImageData eigendom. Gibt true zurück wenn das Bild mit der Form verknüpft ist whenSourceFullName angegeben ist.
type: docs
weight: 150
...
Gibt true zurück, wenn das Bild mit der Form verknüpft ist (when[`SourceFullName`](../sourcefullname/) angegeben ist).
