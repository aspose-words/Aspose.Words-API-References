...
description: Erstellen Sie mühelos atemberaubende Farbverläufe mit dem GradientStop-Konstruktor. Initialisieren und individualisieren Sie Ihre Designs mühelos für eine lebendige Optik!
type: docs
weight: 10
...
Initialisiert eine neue Instanz des[`GradientStop`](../) Klasse.
...
| --- | --- | --- |
| color | Color | Stellt die Farbe des Farbverlaufsstopps dar. |
| position | Double | Stellt die Position eines Stopps innerhalb des Gradienten dar, ausgedrückt als Prozentsatz im Bereich von 0,0 bis 1,0. |
...
| color | Color | Stellt die Farbe des Farbverlaufsstopps dar. |
| position | Double | Stellt die Position eines Stopps innerhalb des Gradienten dar, ausgedrückt als Prozentsatz im Bereich von 0,0 bis 1,0. |
| transparency | Double | Stellt die Transparenz eines Stopps innerhalb des Farbverlaufs dar, ausgedrückt als Prozentsatz im Bereich von 0,0 bis 1,0. |
