...
description: Aspose.Words.Drawing.TextPathAlignment opsomming. WordArtAusrichtung.
type: docs
weight: 1210
...
| --- | --- | --- |
| Stretch | `0` | Strecken Sie jede Textzeile, um sie an die Breite anzupassen. |
| Center | `1` | Text auf Breite zentrieren. |
| Left | `2` | Linksbündig ausrichten. |
| Right | `3` | Rechtsbündig ausrichten. |
| LetterJustify | `4` | Buchstaben so ausbreiten, dass sie in die Breite passen. |
| WordJustify | `5` | Spreizen Sie die Wörter so aus, dass sie in die Breite passen. |
