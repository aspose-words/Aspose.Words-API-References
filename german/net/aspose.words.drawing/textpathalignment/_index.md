...
description: Entdecken Sie die Enumeration Aspose.Words.Drawing.TextPathAlignment für präzise WordArt-Ausrichtung. Verbessern Sie Ihr Dokumentdesign mit vielseitigen Textoptionen!
type: docs
weight: 1770
url: /de/net/aspose.words.drawing/textpathalignment/
---
...
| --- | --- | --- |
| Stretch | `0` | Strecken Sie jede Textzeile, damit sie der Breite entspricht. |
| Center | `1` | Text auf Breite zentrieren. |
| Left | `2` | Linksbündig. |
| Right | `3` | Rechtsbündig. |
| LetterJustify | `4` | Buchstaben so verteilen, dass sie der Breite entsprechen. |
| WordJustify | `5` | Wörter so verteilen, dass sie der Breite entsprechen. |
