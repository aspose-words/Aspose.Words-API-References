...
description: OleFormat eigendom. Gibt an ob der Link zum OLEObjekt gegen Aktualisierungen gesperrt ist.
type: docs
weight: 50
...
Gibt an, ob der Link zum OLE-Objekt gegen Aktualisierungen gesperrt ist.
