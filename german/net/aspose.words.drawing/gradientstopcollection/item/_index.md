...
description: GradientStopCollection Item eigendom. Ruft a ab oder legt es festGradientStop Objekt in der Sammlung in C#.
type: docs
weight: 20
...
Ruft a ab oder legt es fest[`GradientStop`](../../gradientstop/) Objekt in der Sammlung.
