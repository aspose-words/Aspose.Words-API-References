...
| [Item](../../aspose.words.drawing/gradientstopcollection/item/) { get; set; } | Holt oder setzt a[`GradientStop`](../gradientstop/) Objekt in der Sammlung. |

## Methoden

| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.words.drawing/gradientstopcollection/add/)(GradientStop) | Fügt einen angegebenen hinzu[`GradientStop`](../gradientstop/) zu einem Gefälle. |
...
| [Insert](../../aspose.words.drawing/gradientstopcollection/insert/)(int, GradientStop) | Fügt ein[`GradientStop`](../gradientstop/) zur Sammlung an einem bestimmten Index. |
...
| [RemoveAt](../../aspose.words.drawing/gradientstopcollection/removeat/)(int) | Entfernt a[`GradientStop`](../gradientstop/)aus der Sammlung an einem bestimmten Index. |

### Bemerkungen

Sie erstellen keine Instanzen dieser Klasse direkt. Verwenden Sie die[`GradientStops`](../fill/gradientstops/) -Eigenschaft für den Zugriff auf Verlaufsstopps von Füllobjekten.
