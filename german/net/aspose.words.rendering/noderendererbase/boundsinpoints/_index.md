...
description: Entdecken Sie die Eigenschaft „BoundsInPoints“ von NodeRendererBase, um auf präzise Formabmessungen in Punkten zuzugreifen und so die Genauigkeit und Effizienz Ihres Designs zu verbessern.
type: docs
weight: 10
...
Ruft die tatsächlichen Grenzen der Form in Punkten ab.
...
Diese Eigenschaft gibt den tatsächlichen Begrenzungsrahmen (wie auf der Seite gerendert) der Form zurück. Die Begrenzungen berücksichtigen die Formdrehung (sofern vorhanden).
