...
description: Entdecken Sie die NodeRendererBase GetBoundsInPixels-Methode, um die Formabmessungen in Pixeln basierend auf Zoom und Auflösung für mehr Präzision genau zu berechnen.
type: docs
weight: 40
...
Der tatsächliche (wie auf der Seite gerenderte) Begrenzungsrahmen der Form in Pixeln.

## Bemerkungen

Diese Methode konvertiert[`BoundsInPoints`](../boundsinpoints/) in ein Rechteck in Pixeln.
