...
description: Ruft die abPaperSource Objekt das zum Drucken der von diesem repräsentierten Seite geeignet istPageInfoaspose.words.rendering/pageinfo .
type: docs
weight: 90
...
Ruft die abPaperSource Objekt, das zum Drucken der von diesem repräsentierten Seite geeignet ist[`PageInfo`](../../pageinfo) .
