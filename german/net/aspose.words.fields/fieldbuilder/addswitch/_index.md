...
description: Entdecken Sie die FieldBuilder AddSwitch-Methode, um mühelos Feldschalter hinzuzufügen und so die Funktionalität und das Benutzererlebnis Ihrer Anwendung zu verbessern.
type: docs
weight: 30
...
| --- | --- | --- |
| switchName | String | Der Switch-Name. |
