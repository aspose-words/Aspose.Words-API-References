...
description: Entdecken Sie die Klasse Aspose.Words.Fields.GeneralFormatCollection – eine leistungsstarke, typisierte Sammlung zur mühelosen Verwaltung allgemeiner Formate in Ihren Dokumenten.
type: docs
weight: 3060
...
| Name | Beschreibung |
| --- | --- |
| [Count](../../aspose.words.fields/generalformatcollection/count/) { get; } | Ruft die Gesamtzahl der Elemente in der Sammlung ab. |
| [Item](../../aspose.words.fields/generalformatcollection/item/) { get; } | Ruft ein allgemeines Format am angegebenen Index ab. |
