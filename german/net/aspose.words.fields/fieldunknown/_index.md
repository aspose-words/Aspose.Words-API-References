...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldUnknown für die effiziente Verarbeitung unbekannter Felder. Verbessern Sie Ihre Dokumentenverarbeitung durch nahtlose Integration!
type: docs
weight: 2960
url: /de/net/aspose.words.fields/fieldunknown/
---
## FieldUnknown class

Implementiert ein unbekanntes oder nicht erkanntes Feld.
...
Zeigt, wie mit dem Feld „FieldNone“ in einem Dokument gearbeitet wird.

```csharp
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);

// Fügen Sie ein Feld ein, dessen Feldcode keinen objektiven Feldtyp angibt.
Field field = builder.InsertField(" NOTAREALFIELD //A");

// Für solche Felder ist der Feldtyp „FieldNone“ reserviert.
Assert.AreEqual(FieldType.FieldNone, field.Type);

// Wir können auch weiterhin mit diesen Feldern arbeiten und sie als Instanzen der Klasse FieldUnknown zuweisen.
