...
description: Entdecken Sie die IsUSPostalAddress-Funktion von BarcodeParameters, um einfach zu überprüfen, ob eine Adresse eine gültige US-Postanschrift ist. Verbessern Sie noch heute Ihre Datengenauigkeit!
type: docs
weight: 130
...
Ob[`PostalAddress`](../postaladdress/) ist eine US-Postanschrift.
