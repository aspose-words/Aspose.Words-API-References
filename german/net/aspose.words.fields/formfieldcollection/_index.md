...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FormFieldCollection, Ihre Lösung für die einfache und effiziente Verwaltung aller Formularfelder in einem Dokument.
type: docs
weight: 3040
...
| Name | Beschreibung |
| --- | --- |
| [Count](../../aspose.words.fields/formfieldcollection/count/) { get; } | Gibt die Anzahl der Formularfelder in der Sammlung zurück. |
| [Item](../../aspose.words.fields/formfieldcollection/item/) { get; } | Gibt ein Formularfeld am angegebenen Index zurück. (2 indexers) |
