...
description: Aspose.Words.Fields.FieldDatabase klas. Implementiert das Feld DATABASE in C#.
type: docs
weight: 1740
...
| Name | Beschreibung |
| --- | --- |
| [Connection](../../aspose.words.fields/fielddatabase/connection/) { get; set; } | Ruft eine Verbindung zu den Daten ab oder setzt sie. |
| [DisplayResult](../../aspose.words.fields/field/displayresult/) { get; } | Ruft den Text ab, der das angezeigte Feldergebnis darstellt. |
| [End](../../aspose.words.fields/field/end/) { get; } | Ruft den Knoten ab, der das Feldende darstellt. |
| [FileName](../../aspose.words.fields/fielddatabase/filename/) { get; set; } | Ruft den vollständigen Pfad und Dateinamen der Datenbank ab oder legt diesen fest |
...
| [InsertOnceOnMailMerge](../../aspose.words.fields/fielddatabase/insertonceonmailmerge/) { get; set; } | Ruft ab oder legt fest, ob Daten zu Beginn einer Zusammenführung eingefügt werden sollen. |
...
| [Query](../../aspose.words.fields/fielddatabase/query/) { get; set; } | Ruft eine Reihe von SQL-Anweisungen ab, die die Datenbank abfragen, oder legt diese fest. |
...
| [TableFormat](../../aspose.words.fields/fielddatabase/tableformat/) { get; set; } | Ruft das Format ab, das auf das Ergebnis der Datenbankabfrage angewendet werden soll, oder legt dieses fest. |
