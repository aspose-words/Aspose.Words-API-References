...
description: Field eigendom. erhält aFieldFormat Objekt das typisierten Zugriff auf die Feldformatierung bereitstellt.
type: docs
weight: 30
...
erhält a[`FieldFormat`](../../fieldformat/) Objekt, das typisierten Zugriff auf die Feldformatierung bereitstellt.
