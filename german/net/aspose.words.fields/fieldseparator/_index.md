...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldSeparator, die Ihre Word-Dokumente durch die effektive Trennung von Feldcodes und Ergebnissen verbessert.
type: docs
weight: 2790
...
Stellt ein Word-Feldtrennzeichen dar, das den Feldcode vom Feldergebnis trennt.
...
| override [NodeType](../../aspose.words.fields/fieldseparator/nodetype/) { get; } | RückgabenFieldSeparator . |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldseparator/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Nimmt einen Besucher auf. |
...
`FieldSeparator` ist ein Inline-Level-Knoten und wird repräsentiert durch[`FieldSeparatorChar`](../../aspose.words/controlchar/fieldseparatorchar/) Steuerzeichen im Dokument.

`FieldSeparator` kann nur ein Kind sein von[`Paragraph`](../../aspose.words/paragraph/).
