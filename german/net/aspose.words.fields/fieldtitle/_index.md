...
description: Entdecken Sie die Aspose.Words.Fields.FieldTitle-Klasse für die nahtlose Implementierung von TITLE-Feldern. Verbessern Sie Ihr Dokumentenmanagement noch heute mit leistungsstarken Funktionen!
type: docs
weight: 2920
...
| [Text](../../aspose.words.fields/fieldtitle/text/) { get; set; } | Ruft den Text des Titels ab oder legt ihn fest. |
...
Ruft den Titel des Dokuments ab und legt ihn optional fest, wie er in der**Titel** Eigenschaft der integrierten Dokumenteigenschaften.
