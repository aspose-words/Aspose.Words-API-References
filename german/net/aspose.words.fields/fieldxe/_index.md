...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldXE, Ihre Lösung für die effiziente Implementierung von XE-Feldern in der Dokumentenverarbeitung. Optimieren Sie Ihren Workflow noch heute!
type: docs
weight: 3020
...
| [IsBold](../../aspose.words.fields/fieldxe/isbold/) { get; set; } | Ruft ab oder legt fest, ob die Seitenzahl des Eintrags fett formatiert werden soll. |
...
| [PageNumberReplacement](../../aspose.words.fields/fieldxe/pagenumberreplacement/) { get; set; } | Ruft den anstelle einer Seitenzahl verwendeten Text ab oder legt ihn fest. |
| [PageRangeBookmarkName](../../aspose.words.fields/fieldxe/pagerangebookmarkname/) { get; set; } | Ruft den Namen des Lesezeichens ab oder legt ihn fest, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird. |
