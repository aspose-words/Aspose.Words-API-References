...
description: Aspose.Words.Fields.FieldFileSize klas. Implementiert das FILESIZEFeld.
type: docs
weight: 1880
...
In der aktuellen Implementierung wird die verwendet[`OriginalFileName`](../../aspose.words/document/originalfilename/) Eigenschaft zum Abrufen des Dateinamens, der zur Bestimmung der Dateigröße verwendet wird.
