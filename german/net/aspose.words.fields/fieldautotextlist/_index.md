...
description: Aspose.Words.Fields.FieldAutoTextList klas. Implementiert das AUTOTEXTLISTFeld.
type: docs
weight: 1470
...
| [ListStyle](../../aspose.words.fields/fieldautotextlist/liststyle/) { get; set; } | Ermittelt oder setzt den Namen des Stils, auf dem die Liste mit Einträgen basiert. |
...
| [ScreenTip](../../aspose.words.fields/fieldautotextlist/screentip/) { get; set; } | Ruft den anzuzeigenden Text der QuickInfo ab oder legt ihn fest. |
