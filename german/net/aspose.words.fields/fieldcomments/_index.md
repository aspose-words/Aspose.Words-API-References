...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldComments, um COMMENTS-Felder effizient in Ihren Dokumenten zu implementieren und zu verwalten. Optimieren Sie noch heute Ihre Dokumentenverarbeitung!
type: docs
weight: 2110
...
Implementiert das Feld COMMENTS.
...
| [Text](../../aspose.words.fields/fieldcomments/text/) { get; set; } | Ruft den Text der Kommentare ab oder legt ihn fest. |
...
Ruft die Kommentare zum aktuellen Dokument ab und setzt sie optional, wie sie im[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/)Eigenschaft der integrierten Dokumenteigenschaften.
