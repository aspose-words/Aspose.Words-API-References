...
description: Aspose.Words.Fields.FieldComments klas. Implementiert das Feld KOMMENTARE in C#.
type: docs
weight: 1700
...
Implementiert das Feld KOMMENTARE.
...
| [Text](../../aspose.words.fields/fieldcomments/text/) { get; set; } | Ruft den Text der Kommentare ab oder setzt ihn. |
...
Ruft die Kommentare zum aktuellen Dokument ab, wie im aufgezeichnet, und legt diese optional fest[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/) property der integrierten Dokumenteigenschaften.
