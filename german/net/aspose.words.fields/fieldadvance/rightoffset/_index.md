...
description: Entdecken Sie die FieldAdvance RightOffset-Eigenschaft und passen Sie die Textpositionierung mithilfe präziser Punktsteuerung ganz einfach an, um die Dokumentformatierung und -übersichtlichkeit zu verbessern.
type: docs
weight: 50
url: /de/net/aspose.words.fields/fieldadvance/rightoffset/
---
## FieldAdvance.RightOffset property

Ruft die Anzahl der Punkte ab oder legt sie fest, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll.
