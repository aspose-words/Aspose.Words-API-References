...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldDde für die nahtlose Implementierung von DDE-Feldern. Verbessern Sie Ihre Dokumentenautomatisierung noch heute mit leistungsstarken Funktionen!
type: docs
weight: 2190
...
| [IsLinked](../../aspose.words.fields/fielddde/islinked/) { get; set; } | Ruft ab oder legt fest, ob die Dateigröße reduziert werden soll, indem Grafikdaten nicht mit dem Dokument gespeichert werden. |
...
Informationen, die aus einer anderen Anwendung kopiert wurden, werden in diesem Feld mithilfe von DDE mit der ursprünglichen Quelldatei verknüpft.
