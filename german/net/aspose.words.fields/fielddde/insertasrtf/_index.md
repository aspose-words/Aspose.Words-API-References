...
description: Entdecken Sie, wie die FieldDde InsertAsRtf-Eigenschaft Ihr Dokument verbessert, indem sie verknüpfte Objekte nahtlos im Rich Text Format (RTF) einfügt und so die Formatierung verbessert.
type: docs
weight: 60
url: /de/net/aspose.words.fields/fielddde/insertasrtf/
---
## FieldDde.InsertAsRtf property

Ruft ab oder legt fest, ob das verknüpfte Objekt im Rich-Text-Format (RTF) eingefügt werden soll.
