...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldImport, die die Dokumentenverarbeitung durch effiziente IMPORT-Feldimplementierung zur Steigerung der Produktivität optimiert.
type: docs
weight: 2430
...
| [GraphicFilter](../../aspose.words.fields/fieldimport/graphicfilter/) { get; set; } | Liest oder setzt den Namen des Filters für das Format der einzufügenden Grafik. |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | Ruft ab oder legt fest, ob das aktuelle Ergebnis des Felds aufgrund anderer am Dokument vorgenommener Änderungen nicht mehr korrekt (veraltet) ist. |
| [IsLinked](../../aspose.words.fields/fieldimport/islinked/) { get; set; } | Ruft ab oder legt fest, ob die Dateigröße reduziert werden soll, indem Grafikdaten nicht mit dem Dokument gespeichert werden. |
