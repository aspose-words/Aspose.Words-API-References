...
description: Ruft den Namen des Autors des Standarddokuments ab oder legt ihn fest. Wenn der Name des Autors bereits in den integrierten Dokumenteigenschaften angegeben ist wird diese Option nicht berücksichtigt.
type: docs
weight: 60
