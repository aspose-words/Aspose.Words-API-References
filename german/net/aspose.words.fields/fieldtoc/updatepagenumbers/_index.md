...
description: Aktualisieren Sie Ihr Inhaltsverzeichnis mühelos mit der UpdatePageNumbers-Methode von FieldToc und sorgen Sie so für eine genaue Navigation und verbesserte Benutzerfreundlichkeit des Dokuments.
type: docs
weight: 180
...
Aktualisiert die Seitenzahlen für Elemente in diesem Inhaltsverzeichnis.
...
`WAHR` wenn der Vorgang erfolgreich ist. Wenn eines der zugehörigen Inhaltsverzeichnis-Lesezeichen entfernt wurde,`FALSCH` wird zurückgegeben.
