...
description: Aspose.Words.Fields.FieldFootnoteRef klas. Implementiert das FOOTNOTEREFFeld.
type: docs
weight: 1750
url: /de/net/aspose.words.fields/fieldfootnoteref/
---
...
Zeigt, wie auf Fußnoten mit dem Feld FOOTNOTEREF verwiesen wird.
...
// Fügen Sie ein FOOTNOTEREF-Feld ein, mit dem wir mehr als einmal auf eine Fußnote verweisen können, während wir denselben Fußnotenmarker wiederverwenden.
builder.Write("CrossReference: ");
FieldFootnoteRef field = (FieldFootnoteRef) builder.InsertField(FieldType.FieldFootnoteRef, true);

// Auf das Lesezeichen verweisen, das wir mit dem Feld FOOTNOTEREF erstellt haben. Dieses Lesezeichen enthält eine Fußnotenmarkierung
// gehört zu der von uns eingefügten Fußnote. Das Feld zeigt diese Fußnotenmarkierung an.
