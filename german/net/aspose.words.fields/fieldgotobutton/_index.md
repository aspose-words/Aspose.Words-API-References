...
description: Entdecken Sie die Aspose.Words.Fields.FieldGoToButton-Klasse für nahtlose Navigation mit GOTOBUTTON-Feldern. Verbessern Sie noch heute die Interaktivität Ihrer Dokumente!
type: docs
weight: 2380
...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | Ruft den Text der „Schaltfläche“ ab oder legt ihn fest, der im Dokument angezeigt wird, sodass er zum Aktivieren des Sprungs ausgewählt werden kann. |
...
Fügt einen Sprungbefehl ein, sodass bei Aktivierung die Einfügemarke des Dokuments an die angegebene Position verschoben wird.
