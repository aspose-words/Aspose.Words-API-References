...
description: Entdecken Sie die FieldCitation-Präfixeigenschaft und passen Sie Zitate ganz einfach mit einem eindeutigen Präfix an, um die Übersichtlichkeit und Organisation Ihrer Dokumente zu verbessern.
type: docs
weight: 50
url: /de/net/aspose.words.fields/fieldcitation/prefix/
---
## FieldCitation.Prefix property

Ruft ein Präfix ab oder legt es fest, das dem Zitat vorangestellt wird.
