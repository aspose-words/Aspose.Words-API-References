...
description: Entdecken Sie die FieldRef InsertHyperlink-Eigenschaft, erstellen Sie ganz einfach Hyperlinks zu mit Lesezeichen versehenen Absätzen und verbessern Sie so die Navigation und das Benutzererlebnis in Ihren Dokumenten.
type: docs
weight: 40
url: /de/net/aspose.words.fields/fieldref/inserthyperlink/
---
## FieldRef.InsertHyperlink property

Ruft ab oder legt fest, ob ein Hyperlink zum mit Lesezeichen versehenen Absatz erstellt werden soll.
