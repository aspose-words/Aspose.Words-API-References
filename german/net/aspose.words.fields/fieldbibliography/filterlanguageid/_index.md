...
description: Entdecken Sie, wie die Eigenschaft „FieldBibliography FilterLanguageId“ Ihr bibliografisches Datenmanagement verbessert, indem sie Quellen nach Sprache filtert, um präzise Ergebnisse zu erzielen.
type: docs
weight: 20
url: /de/net/aspose.words.fields/fieldbibliography/filterlanguageid/
---
## FieldBibliography.FilterLanguageId property

Ruft die Sprach-ID ab oder legt sie fest, die verwendet wird, um die bibliografischen Daten auf nur die Quellen im Dokument zu filtern, die diese Sprache verwenden.
