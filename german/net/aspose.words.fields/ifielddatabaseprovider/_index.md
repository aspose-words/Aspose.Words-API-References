...
description: Verbessern Sie Ihre Dokumentenautomatisierung mit der Schnittstelle Aspose.Words.Fields.IFieldDatabaseProvider. Stellen Sie nahtlos Daten für FieldDatabase-Updates bereit.
type: docs
weight: 3100
...
Implementieren Sie diese Schnittstelle, um Daten für die[`FieldDatabase`](../fielddatabase/) Feld, wenn es aktualisiert wird.
