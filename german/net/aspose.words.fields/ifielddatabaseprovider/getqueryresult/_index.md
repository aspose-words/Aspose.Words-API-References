...
description: Entdecken Sie die GetQueryResult-Methode des IFieldDatabaseProviders für effizienten Datenabruf. Optimieren Sie Ihre Abfragen und verbessern Sie die Datenbankleistung noch heute!
type: docs
weight: 10
url: /de/net/aspose.words.fields/ifielddatabaseprovider/getqueryresult/
---
...
| connection | String | Die Verbindung zu den im Feld \c angegebenen Daten wird durch den Schalter hergestellt. |
| query | String | Der Satz von SQL-Anweisungen, die die im Feldschalter \s angegebene Datenbank abfragen. |
| field | FieldDatabase | Das Feld wird aktualisiert. |
