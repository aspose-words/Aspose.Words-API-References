...
description: Entdecken Sie die Klasse Aspose.Words.Fields.FieldAsk für die nahtlose Implementierung des ASK-Felds und verbessern Sie so die Dokumentenautomatisierung und -effizienz.
type: docs
weight: 1970
...
| [DefaultResponse](../../aspose.words.fields/fieldask/defaultresponse/) { get; set; } | Ruft die Standardbenutzerantwort ab oder legt sie fest (Anfangswert im Eingabeaufforderungsfenster). |
...
Fordert den Benutzer auf, Informationen einzugeben, und weist ein Lesezeichen zu, das die Antwort des Benutzers darstellt.
