...
description: Entdecken Sie die Eigenschaft FieldIf FalseText, verwalten Sie angezeigten Text für falsche Vergleiche einfach und verbessern Sie so das Benutzererlebnis und die Funktionalität Ihrer Anwendungen.
type: docs
weight: 30
url: /de/net/aspose.words.fields/fieldif/falsetext/
---
## FieldIf.FalseText property

Ruft den angezeigten Text ab oder legt ihn fest, wenn der Vergleichsausdruck`FALSCH` .
