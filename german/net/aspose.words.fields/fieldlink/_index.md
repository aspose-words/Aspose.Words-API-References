...
description: Entdecken Sie die Aspose.Words.Fields.FieldLink-Klasse für die nahtlose Implementierung von LINK-Feldern. Verbessern Sie Ihre Dokumentenverarbeitung noch heute mit leistungsstarken Funktionen!
type: docs
weight: 2520
...
| [FormatUpdateType](../../aspose.words.fields/fieldlink/formatupdatetype/) { get; set; } | Ruft eine Methode ab oder legt sie fest, mit der das verknüpfte Objekt seine Formatierung aktualisiert. |
...
| [IsLinked](../../aspose.words.fields/fieldlink/islinked/) { get; set; } | Ruft ab oder legt fest, ob die Dateigröße reduziert werden soll, indem Grafikdaten nicht mit dem Dokument gespeichert werden. |
