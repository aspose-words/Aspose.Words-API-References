...
description: Wendet das in angegebene Textformat anTextInputFormataspose.words.fields/formfield/textinputformat/ und speichert den Wert inResultaspose.words.fields/formfield/result/ .
type: docs
weight: 250
...
Wendet das in angegebene Textformat an[`TextInputFormat`](../textinputformat/) und speichert den Wert in[`Result`](../result/) .
