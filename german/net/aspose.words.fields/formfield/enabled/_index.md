...
description: True wenn ein Formularfeld aktiviert ist.
type: docs
weight: 70
...
Wenn ein Formularfeld aktiviert ist, kann sein Inhalt geändert werden, während das Formular ausgefüllt wird.
