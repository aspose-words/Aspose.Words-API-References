...
description: Gibt die Textformatierung für ein Textformularfeld zurück oder legt sie fest.
type: docs
weight: 200
...
Gibt die Textformatierung für ein Textformularfeld zurück oder legt sie fest.
...
Wenn das Textformularfeld normalen Text enthält, sind gültige Formatzeichenfolgen "", "GROSSBUCHSTABEN", "KLEINBUCHSTABEN", "ERSTE GROSSBUCHSTABEN" und "TITELBUCHSTABEN". Bei den strings wird die Groß-/Kleinschreibung nicht beachtet.

Wenn das Textformularfeld eine Zahl oder einen Datums-/Zeitwert enthält, dann sind gültige -Formatzeichenfolgen Zahlen- oder Datums- und Zeitformatzeichenfolgen.

Microsoft Word erlaubt Zeichenfolgen mit höchstens 64 Zeichen.
