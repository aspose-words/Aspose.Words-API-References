...
description: Gibt den Text zurück oder legt ihn fest der in einem Meldungsfeld angezeigt wird wenn das Formularfeld den Fokus hat und der Benutzer F1 drückt.
type: docs
weight: 100
...
Wenn die OwnHelp-Eigenschaft auf True gesetzt ist, gibt HelpText den Textstringwert an. Wenn OwnHelp auf False gesetzt ist, gibt HelpText den Namen eines AutoText-Eintrags an, der help -Text für das Formularfeld enthält.
