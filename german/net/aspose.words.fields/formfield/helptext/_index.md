...
description: Entdecken Sie die HelpText-Eigenschaft von FormField und verbessern Sie das Benutzererlebnis mit informativen Meldungen, die angezeigt werden, wenn F1 auf fokussierten Feldern gedrückt wird.
type: docs
weight: 100
...
Gibt den Text zurück oder legt ihn fest, der in einem Meldungsfeld angezeigt wird, wenn das Formularfeld den Fokus hat und der Benutzer F1 drückt.
...
Wenn die[`OwnHelp`](../ownhelp/) Eigenschaft ist auf`WAHR` ,`HelpText` gibt den Textzeichenfolgenwert an. Wenn[`OwnHelp`](../ownhelp/) ist eingestellt auf`FALSCH` ,`HelpText` Gibt den Namen eines AutoText-Eintrags an, der help -Text für das Formularfeld enthält.
