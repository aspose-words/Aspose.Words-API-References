...
description: Verwalten Sie Ihr Formular ganz einfach mit der FormField Checked-Eigenschaft. Steuern Sie den Status von Kontrollkästchen mühelos – standardmäßig ist das Kontrollkästchen deaktiviert, um die Benutzerfreundlichkeit zu optimieren.
type: docs
weight: 30
...
Ruft den aktivierten Status des Kontrollkästchen-Formularfelds ab oder legt ihn fest. Der Standardwert für diese Eigenschaft ist`FALSCH` .
