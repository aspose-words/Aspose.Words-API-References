...
description: Aspose.Words.Fields.FieldFormDropDown klas. Implementiert das FORMDROPDOWNFeld in C#.
type: docs
weight: 1920
...
```csharp
// Diese Felder sind ältere Äquivalente des FormField. Wir können diese Felder mit Aspose.Words lesen, aber nicht erstellen.
