...
description: Entdecken Sie den CustomXmlProperty-Konstruktor. Erstellen und initialisieren Sie ganz einfach neue Instanzen für eine nahtlose XML-Eigenschaftenverwaltung in Ihren Projekten.
type: docs
weight: 10
...
| --- | --- | --- |
| name | String | Der Name der Eigenschaft. Kann nicht`null`. |
| uri | String | Der Namespace-URI der Eigenschaft. Kann nicht`null`. |
| value | String | Der Wert der Immobilie. Kann nicht`null`. |
