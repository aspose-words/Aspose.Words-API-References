...
description: Gibt den aktuell ausgewählten Wert in dieser Liste an. Nullwert zulässig was bedeutet dass dieser Listenelementsammlung kein aktuell ausgewählter Eintrag zugeordnet ist.
type: docs
weight: 30
