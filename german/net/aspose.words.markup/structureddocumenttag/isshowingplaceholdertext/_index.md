...
description: StructuredDocumentTag eigendom. Gibt an ob der Inhalt dieser SDT soll so interpretiert werden dass es Platzhaltertext enthält im Gegensatz zu regulären Textinhalten innerhalb des SDT.
type: docs
weight: 150
