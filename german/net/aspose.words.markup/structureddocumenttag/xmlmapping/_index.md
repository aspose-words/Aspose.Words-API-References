...
description: Entdecken Sie, wie die StructuredDocumentTag XmlMapping-Eigenschaft Ihre Tags mit XML-Daten verbindet und so die Dokumentanpassung und -integration für nahtlose Arbeitsabläufe verbessert.
type: docs
weight: 320
...
Sie können die[`SetMapping`](../../xmlmapping/setmapping/) Methode dieses Objekts, um ein strukturiertes Dokument-Tag in XML-Daten zuzuordnen.
