...
description: StructuredDocumentTag eigendom. Gibt das vollständige Datum und die letzte Uhrzeit an die hierin eingegeben wurden SDT .
type: docs
weight: 130
...
Gibt das vollständige Datum und die letzte Uhrzeit an, die hierin eingegeben wurden **SDT** .
