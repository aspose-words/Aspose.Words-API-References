...
description: Entdecken Sie die Methode „CustomXmlPartCollection Add“, um Ihre Sammlungen mühelos zu erweitern, indem Sie einfach und effizient neue Elemente hinzufügen.
type: docs
weight: 40
...
| --- | --- | --- |
| part | CustomXmlPart | Der hinzuzufügende benutzerdefinierte XML-Teil. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| id | String | Kennung eines neuen benutzerdefinierten XML-Teils. |
