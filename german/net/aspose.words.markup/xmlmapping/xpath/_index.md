...
description: XmlMapping eigendom. Gibt den XPathAusdruck zurück der ausgewertet wird um den benutzerdefinierten XMLKnoten zu finden der dem übergeordneten Tag des strukturierten Dokuments zugeordnet ist.
type: docs
weight: 50
...
Gibt den XPath-Ausdruck zurück, der ausgewertet wird, um den benutzerdefinierten XML-Knoten zu finden, der dem übergeordneten Tag des strukturierten Dokuments zugeordnet ist.
