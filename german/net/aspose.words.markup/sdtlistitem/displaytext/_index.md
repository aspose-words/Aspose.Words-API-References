...
description: Entdecken Sie, wie die DisplayText-Eigenschaft von SdtListItem Ihren Inhalt durch Anpassen des angezeigten Textes verbessert und so die Benutzerinteraktion und Klarheit verbessert.
type: docs
weight: 20
...
Ruft den Text ab, der im Laufinhalt anstelle des[`Value`](../value/) Attributinhalte für dieses Listenelement.
