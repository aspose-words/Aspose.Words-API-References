...
| [CustomPartCollection](./custompartcollection/) | Stellt eine Sammlung von dar[`CustomPart`](../aspose.words.markup/custompart/) Objekte. |
| [CustomXmlPart](./customxmlpart/) | Stellt einen benutzerdefinierten XML-Datenspeicherteil dar (benutzerdefinierte XML-Daten innerhalb eines Pakets). |
| [CustomXmlPartCollection](./customxmlpartcollection/) | Stellt eine Sammlung benutzerdefinierter XML-Teile dar. Die Artikel sind[`CustomXmlPart`](../aspose.words.markup/customxmlpart/) Objekte. |
| [CustomXmlProperty](./customxmlproperty/) | Stellt ein einzelnes benutzerdefiniertes XML-Attribut oder eine Smart-Tag-Eigenschaft dar. |
| [CustomXmlPropertyCollection](./customxmlpropertycollection/) | Stellt eine Sammlung benutzerdefinierter XML-Attribute oder Smart-Tag-Eigenschaften dar. |
...
| --- | --- |
| [MarkupLevel](./markuplevel/) | Gibt die Ebene im Dokumentbaum an, auf der sich eine bestimmte befindet[`StructuredDocumentTag`](../aspose.words.markup/structureddocumenttag/) kann auftreten. |
