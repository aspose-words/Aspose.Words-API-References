...
description: Entdecken Sie die SmartTag-URI-Eigenschaft – definieren Sie den Namespace-URI Ihres Smarttags für erweiterte Funktionalität und nahtlose Integration in Ihre Anwendungen.
type: docs
weight: 50
...
Gibt die Namespace-URI des Smarttags an.
