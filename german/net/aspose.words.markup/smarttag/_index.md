...
description: Aspose.Words.Markup.SmartTag klas. Dieses Element gibt das Vorhandensein eines Smarttags um eine oder mehrere InlineStrukturen Läufe Bilder Felder usw. innerhalb eines Absatzes an in C#.
type: docs
weight: 4050
...
| Name | Beschreibung |
| --- | --- |
| [SmartTag](smarttag/)(*[DocumentBase](../../aspose.words/documentbase/)*) | Initialisiert eine neue Instanz von`SmartTag` Klasse. |
...
| override [NodeType](../../aspose.words.markup/smarttag/nodetype/) { get; } | Gibt zurückSmartTag . |
...
| [Properties](../../aspose.words.markup/smarttag/properties/) { get; } | Eine Sammlung der Smart-Tag-Eigenschaften. |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.words.markup/smarttag/accept/)(*[DocumentVisitor](../../aspose.words/documentvisitor/)*) | Akzeptiert einen Besucher. |
...
`SmartTag` kann ein Kind von a sein[`Paragraph`](../../aspose.words/paragraph/) oder ein anderer`SmartTag` Knoten.
