...
description: Entdecken Sie die ListLevel NumberFormat-Eigenschaft, um eindeutige Zahlenformate für Ihre Listen einfach anzupassen und festzulegen und so die Übersichtlichkeit und den Stil Ihres Dokuments zu verbessern.
type: docs
weight: 70
...
Die Zeichenfolge kann neben normalen Textzeichen auch Platzhalterzeichen von \x0000 bis \x0008 enthalten, die die Nummern aus den entsprechenden Listenebenen darstellen.

Beispielsweise erzeugt die Zeichenfolge "\x0000.\x0001)" eine Listenbezeichnung , die etwa wie "1.5) aussieht. Die Zahl "1" ist die aktuelle Nummer der 1. Listenebene, die Zahl "5" ist die aktuelle Nummer der 2. Listenebene.

Null ist nicht zulässig, aber eine leere Zeichenfolge, die keine Zahl bedeutet, ist gültig.
