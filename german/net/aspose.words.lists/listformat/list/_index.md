...
description: ListFormat eigendom. Ruft die Liste ab oder legt sie fest zu der dieser Absatz gehört.
type: docs
weight: 20
...
Wenn Sie diese Eigenschaft auf null setzen, werden Aufzählungszeichen und Nummerierungen aus dem Absatz entfernt und die Nummer der Listenebene auf null gesetzt. Das Setzen dieser Eigenschaft auf null entspricht einem Aufruf[`RemoveNumbers`](../removenumbers/).
