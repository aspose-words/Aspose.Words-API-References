...
description: ListFormat methode. Entfernt Nummern oder Aufzählungszeichen aus dem aktuellen Absatz und setzt die Listenebene auf Null.
type: docs
weight: 90
...
Entfernt Nummern oder Aufzählungszeichen aus dem aktuellen Absatz und setzt die Listenebene auf Null.
...
Das Aufrufen dieser Methode entspricht dem Festlegen von[`List`](../list/) Eigenschaft auf null.

### Beispiele

Zeigt, wie Sie die Listenformatierung aus allen Absätzen im Haupttext eines Abschnitts entfernen.
