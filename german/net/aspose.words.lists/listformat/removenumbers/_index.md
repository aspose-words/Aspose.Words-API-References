...
description: Entfernen Sie mühelos Zahlen oder Aufzählungszeichen aus Ihren Absätzen mit der RemoveNumbers-Methode von ListFormat und setzen Sie Ihre Listenebene für eine saubere Formatierung auf Null zurück.
type: docs
weight: 90
...
Entfernt Nummerierungen oder Aufzählungszeichen aus dem aktuellen Absatz und setzt die Listenebene auf Null.
...
Der Aufruf dieser Methode entspricht dem Setzen der[`List`](../list/) Eigentum zu`null`.

## Beispiele

Zeigt, wie die Listenformatierung aus allen Absätzen im Haupttext eines Abschnitts entfernt wird.
