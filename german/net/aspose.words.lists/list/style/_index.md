...
Ruft den Listenstil ab, auf den diese Liste verweist oder den er definiert.
...
Eine Liste könnte in diesem Fall ein Verweis auf einen Listenstil sein[`IsListStyleReference`](../isliststylereference/) wird sein`WAHR`.
