...
description: Gibt an ob TrueType-Schriftarten in ein Dokument eingebettet werden wenn es gespeichert wird. Der Standardwert für diese Eigenschaft ist FALSCH .
type: docs
weight: 30
