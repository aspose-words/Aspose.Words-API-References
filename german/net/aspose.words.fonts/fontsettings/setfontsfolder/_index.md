...
description: FontSettings methode. Legt den Ordner fest in dem Aspose.Words beim Rendern von Dokumenten oder beim Einbetten von Schriftarten nach TrueTypeSchriftarten sucht. Dies ist eine Verknüpfung zuSetFontsFolders zum Setzen nur eines Fontverzeichnisses.
type: docs
weight: 80
...
Legt den Ordner fest, in dem Aspose.Words beim Rendern von Dokumenten oder beim Einbetten von Schriftarten nach TrueType-Schriftarten sucht. Dies ist eine Verknüpfung zu[`SetFontsFolders`](../setfontsfolders/) zum Setzen nur eines Fontverzeichnisses.
