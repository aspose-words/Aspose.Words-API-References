...
description: Gibt einen Modus zum Analysieren einfacher JSON-Werte Null Boolean Zahl Ganzzahl und Zeichenfolge beim Laden von JSON an. Ein solcher Modus wirkt sich nicht auf die Analyse von Datums- und Uhrzeitwerten aus.
type: docs
weight: 4440
