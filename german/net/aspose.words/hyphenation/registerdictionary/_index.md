...
description: Registriert und lädt ein Silbentrennungswörterbuch für die angegebene Sprache aus einem Stream. Wird ausgelöst wenn das Wörterbuch nicht gelesen werden kann oder ein ungültiges Format hat.
type: docs
weight: 40
