...
description: Entdecken Sie die Klasse Aspose.Words.BookmarkStart, die für die Verwaltung von Lesezeichen in Word-Dokumenten unerlässlich ist. Verbessern Sie noch heute Ihre Dokumentbearbeitung!
type: docs
weight: 260
...
| Name | Beschreibung |
| --- | --- |
| [BookmarkStart](bookmarkstart/)(*[DocumentBase](../documentbase/), string*) | Initialisiert eine neue Instanz des`BookmarkStart` Klasse. |
...
| override [NodeType](../../aspose.words/bookmarkstart/nodetype/) { get; } | RückgabenBookmarkStart . |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.words/bookmarkstart/accept/)(*[DocumentVisitor](../documentvisitor/)*) | Nimmt einen Besucher auf. |
...
Ein vollständiges Lesezeichen in einem Word-Dokument besteht aus einem`BookmarkStart` und ein passendes[`BookmarkEnd`](../bookmarkend/) mit demselben Lesezeichennamen.

`BookmarkStart` Und[`BookmarkEnd`](../bookmarkend/) sind lediglich Markierungen innerhalb eines Dokuments , die angeben, wo das Lesezeichen beginnt und endet.
