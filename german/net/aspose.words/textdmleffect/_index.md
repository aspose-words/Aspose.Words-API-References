...
description: Aspose.Words.TextDmlEffect opsomming. DMLTexteffekt für Textläufe.
type: docs
weight: 6410
...
| --- | --- | --- |
| Glow | `0` | Glow-Effekt, bei dem ein farblich unscharfer Umriss außerhalb der Kanten des Objekts hinzugefügt wird. |
