...
type: docs
weight: 10
url: /de/net/aspose.words/commentrangestart/commentrangestart/
---
...
Wann[`CommentRangeStart`](../../commentrangestart) erstellt wird, gehört es zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und[`ParentNode`](../../node/parentnode) ist Null.

Zum Anhängen von a[`CommentRangeStart`](../../commentrangestart) zum Dokument einfügen, verwenden Sie InsertAfter oder InsertBefore für den Absatz, an dem Sie den Kommentar einfügen möchten.
