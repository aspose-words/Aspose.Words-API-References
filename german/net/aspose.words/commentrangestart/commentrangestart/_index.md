...
description: Entdecken Sie den CommentRangeStart-Konstruktor. Erstellen Sie einfach neue Instanzen dieser Klasse für eine effizientere Codierung und optimierte Entwicklung.
type: docs
weight: 10
...
Um ein[`CommentRangeStart`](../) Verwenden Sie im Dokument InsertAfter oder InsertBefore für den Absatz, in den Sie den Kommentar einfügen möchten.
