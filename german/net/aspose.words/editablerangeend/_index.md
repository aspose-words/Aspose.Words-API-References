...
description: Aspose.Words.EditableRangeEnd klas. Repräsentiert das Ende eines bearbeitbaren Bereichs in einem WordDokument.
type: docs
weight: 1280
...
| [EditableRangeStart](../../aspose.words/editablerangeend/editablerangestart/) { get; } | Entsprechender EditableRangeStart, empfangen von ID. |
...
Ein vollständig bearbeitbarer Bereich in einem Word-Dokument besteht aus a[`EditableRangeStart`](./editablerangestart/) und ein passendes`EditableRangeEnd` mit der gleichen ID.

[`EditableRangeStart`](./editablerangestart/) und`EditableRangeEnd` sind nur Markierungen innerhalb eines document , die angeben, wo der bearbeitbare Bereich beginnt und endet.
