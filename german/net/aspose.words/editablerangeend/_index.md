...
description: Entdecken Sie die Klasse Aspose.Words.EditableRangeEnd, die für die effiziente Verwaltung bearbeitbarer Bereiche in Word-Dokumenten zur nahtlosen Dokumentbearbeitung entwickelt wurde.
type: docs
weight: 1840
...
| [Id](../../aspose.words/editablerangeend/id/) { get; set; } | Gibt die Kennung des editierbaren Bereichs an. |
...
| override [NodeType](../../aspose.words/editablerangeend/nodetype/) { get; } | RückgabenEditableRangeEnd . |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.words/editablerangeend/accept/)(*[DocumentVisitor](../documentvisitor/)*) | Nimmt einen Besucher auf. |
...
Ein vollständiger bearbeitbarer Bereich in einem Word-Dokument besteht aus einem[`EditableRangeStart`](./editablerangestart/) und ein passendes`EditableRangeEnd` mit der gleichen ID.

[`EditableRangeStart`](./editablerangestart/) Und`EditableRangeEnd` sind lediglich Markierungen innerhalb eines Dokuments , die angeben, wo der bearbeitbare Bereich beginnt und endet.
