...
description: Entdecken Sie die Klasse Aspose.Words.CommentRangeEnd, die das Ende von kommentarbezogenen Textbereichen markiert. Verbessern Sie die Dokumentenverwaltung mit präzisen Kommentaren!
type: docs
weight: 440
...
| override [NodeType](../../aspose.words/commentrangeend/nodetype/) { get; } | RückgabenCommentRangeEnd . |
...
| Name | Beschreibung |
| --- | --- |
| override [Accept](../../aspose.words/commentrangeend/accept/)(*[DocumentVisitor](../documentvisitor/)*) | Nimmt einen Besucher auf. |
...
Um einen Kommentar zu erstellen, der an einem Textbereich verankert ist, müssen Sie einen[`Comment`](../comment/) und dann erstellen[`CommentRangeStart`](../commentrangestart/) Und`CommentRangeEnd` und setzen Sie ihre Kennungen auf den gleichen[`Id`](../comment/id/) Wert.

`CommentRangeEnd` ist ein Inline-Level-Knoten und kann nur ein Kind von[`Paragraph`](../paragraph/).
