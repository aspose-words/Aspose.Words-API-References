...
Wann[`CommentRangeEnd`](../../commentrangeend) erstellt wird, gehört es zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und[`ParentNode`](../../node/parentnode) ist Null.

Zum Anhängen von a[`CommentRangeEnd`](../../commentrangeend) zum Dokument einfügen, verwenden Sie InsertAfter oder InsertBefore für den Absatz, an dem Sie den Kommentar einfügen möchten.
