...
description: CommentRangeEnd constructeur. Initialisiert eine neue Instanz dieser Klasse.
type: docs
weight: 10
...
Zum Anhängen von a[`CommentRangeEnd`](../) zum Dokument einfügen, verwenden Sie InsertAfter oder InsertBefore für den Absatz, an dem Sie den Kommentar einfügen möchten.
