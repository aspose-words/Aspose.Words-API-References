...
description: Entdecken Sie die Item-Eigenschaft „ConditionalStyleCollection“, um einfach auf ConditionalStyle-Objekte nach Typ zuzugreifen und so Ihre Styling-Funktionen mühelos zu verbessern.
type: docs
weight: 80
...
Ruft eine[`ConditionalStyle`](../../conditionalstyle/) Objekt nach bedingtem Stiltyp.
...
Ruft eine[`ConditionalStyle`](../../conditionalstyle/) Objekt nach Index.
