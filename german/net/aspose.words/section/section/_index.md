...
description: Erstellen Sie mühelos dynamische Webabschnitte mit unserem Abschnittskonstruktor. Initialisieren und passen Sie Ihre Abschnittsklasse einfach an, um eine optimale Site-Performance zu erzielen.
type: docs
weight: 10
...
Einschließen[`Section`](../) in ein Dokument verwenden[`InsertAfter`](../../compositenode/insertafter/) und [`InsertBefore`](../../compositenode/insertbefore/) Methoden der[`Document`](../../document/) ODER [`Add`](../../nodecollection/add/) Und[`Insert`](../../nodecollection/insert/) Methoden der[`Sections`](../../document/sections/) Eigentum.
