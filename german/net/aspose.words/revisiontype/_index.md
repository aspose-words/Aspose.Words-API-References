...
description: Entdecken Sie die Enumeration Aspose.Words.RevisionType, um Dokumentänderungen effizient zu verfolgen und zu verwalten. Verbessern Sie Ihre Dokumentbearbeitung mit Präzision!
type: docs
weight: 5540
...
Gibt den Typ der Änderung an, die verfolgt wird in[`Revision`](../revision/) .
...
| --- | --- | --- |
| Insertion | `0` | Neuer Inhalt wurde in das Dokument eingefügt. |
| Deletion | `1` | Inhalt wurde aus dem Dokument entfernt. |
| FormatChange | `2` | Die Formatierungsänderung wurde auf den übergeordneten Knoten angewendet. |
