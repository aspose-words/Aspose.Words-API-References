...
Gibt die Art der Änderung an, in der verfolgt wird[`Revision`](../revision/) .
...
| FormatChange | `2` | Formatierungsänderung wurde auf den übergeordneten Knoten angewendet. |
