...
| const [DefaultTextInputChar](../../aspose.words/controlchar/defaulttextinputchar/) | Dies ist das „o“-Zeichen, das als Standardwert in Texteingabeformularfeldern verwendet wird. |
| const [FieldEndChar](../../aspose.words/controlchar/fieldendchar/) | Ende des MS Word-Feldzeichens: (char)21. |
| const [FieldSeparatorChar](../../aspose.words/controlchar/fieldseparatorchar/) | Das Feldtrennzeichen trennt den Feldcode vom Feldwert. In einigen Bereichen optional. Wert: (char)20. |
