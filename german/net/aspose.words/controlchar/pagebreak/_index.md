...
description: ControlChar veld. Seitenumbruchzeichen x000c oder f. Beachten Sie dass es denselben Wert hat wieSectionBreak .
type: docs
weight: 200
...
Seitenumbruchzeichen: "\x000c" oder "\f". Beachten Sie, dass es denselben Wert hat wie[`SectionBreak`](../sectionbreak/) .
