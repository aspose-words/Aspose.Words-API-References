...
description: Entdecken Sie das ControlChar SectionBreak-Feld, verwalten Sie Dokumentabschnitte effizient mit dem Zeichen x000c und verbessern Sie so die Formatierung und Lesbarkeit.
type: docs
weight: 240
url: /de/net/aspose.words/controlchar/sectionbreak/
---
## ControlChar.SectionBreak field

Abschnittsendezeichen: "\x000c" oder "\f". Beachten Sie, dass es den gleichen Wert hat wie[`PageBreak`](../pagebreak/) .
