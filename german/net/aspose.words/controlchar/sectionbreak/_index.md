...
description: ControlChar veld. Abschnittsendezeichen x000c oder f. Beachten Sie dass es denselben Wert hat wiePageBreak .
type: docs
weight: 240
...
Abschnittsendezeichen: "\x000c" oder "\f". Beachten Sie, dass es denselben Wert hat wie[`PageBreak`](../pagebreak/) .
