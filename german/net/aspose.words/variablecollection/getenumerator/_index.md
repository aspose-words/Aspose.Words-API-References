...
description: Erkunden Sie die GetEnumerator-Methode von VariableCollection, um einfach alle Variablen in Ihrer Sammlung zu durchlaufen und so die Datenverwaltung und den Datenzugriff zu verbessern.
type: docs
weight: 60
url: /de/net/aspose.words/variablecollection/getenumerator/
---
## VariableCollection.GetEnumerator method

Gibt ein Enumeratorobjekt zurück, mit dem alle Variablen in der Sammlung durchlaufen werden können.
