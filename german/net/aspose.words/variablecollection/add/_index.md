...
| --- | --- | --- |
| name | String | Der Name der hinzuzufügenden Variablen ohne Berücksichtigung der Groß-/Kleinschreibung. |
| value | String | Der Wert der Variablen. Der Wert darf nicht null sein, wenn der Wert null ist, wird stattdessen eine leere Zeichenfolge verwendet. |
