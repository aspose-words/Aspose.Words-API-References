...
description: Finden Sie heraus, ob VariableCollection eine Dokumentvariable mit Namen enthält. Optimieren Sie Ihr Datenmanagement und steigern Sie Ihre Programmiereffizienz!
type: docs
weight: 50
...
Bestimmt, ob die Sammlung eine Dokumentvariable mit dem angegebenen Namen enthält.
...
| --- | --- | --- |
| name | String | Name der zu suchenden Dokumentvariable ohne Berücksichtigung der Groß-/Kleinschreibung. |
