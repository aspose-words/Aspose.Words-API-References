...
description: Entdecken Sie, wie die Eigenschaft „RestartPageNumbering“ die Dokumentformatierung durch abschnittsspezifische Seitennummerierung verbessert. Optimieren Sie Ihr Layout mühelos!
type: docs
weight: 360
...
Wahr, wenn die Seitennummerierung am Anfang des Abschnitts neu beginnt.
...
Wenn eingestellt auf`FALSCH` , Die`RestartPageNumbering` Eigenschaft überschreibt the [`PageStartingNumber`](../pagestartingnumber/) Eigenschaft, damit die Seitennummerierung vom vorherigen Abschnitt fortgesetzt werden kann.
