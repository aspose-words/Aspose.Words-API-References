...
description: Entdecken Sie die Methode „TabStopCollection Equals“, um TabStopCollections einfach auf Gleichheit zu vergleichen und so Ihre Codierungseffizienz und -genauigkeit zu verbessern.
type: docs
weight: 70
...
Bestimmt, ob die angegebene[`TabStopCollection`](../) ist im Wert gleich dem aktuellen[`TabStopCollection`](../) .
