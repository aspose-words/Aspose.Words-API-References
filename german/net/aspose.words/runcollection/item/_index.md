...
description: Greifen Sie mühelos auf bestimmte RunCollection-Elemente zu. Rufen Sie jeden Run nach Index ab, um die Datenverwaltung zu optimieren und die Leistung zu verbessern.
type: docs
weight: 10
...
Ruft eine[`Run`](../../run/) am angegebenen Index.
