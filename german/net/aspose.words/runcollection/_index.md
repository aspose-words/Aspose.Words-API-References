...
description: Aspose.Words.RunCollection klas. Bietet getippten Zugriff auf eine Sammlung vonRun Knoten.
type: docs
weight: 4570
...
Bietet getippten Zugriff auf eine Sammlung von[`Run`](../run/) Knoten.
...
| [Item](../../aspose.words/runcollection/item/) { get; } | Ruft a **Laufen** am angegebenen Index. (2 indexers) |
