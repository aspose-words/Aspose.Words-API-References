...
description: DocumentBuilder methode. Beendet eine Tabelle im Dokument.
type: docs
weight: 230
...
Diese Methode sollte danach nur einmal aufgerufen werden[`EndRow`](../endrow/) hieß. Bei Anruf  **EndTable** bewegt den Cursor aus der aktuellen Zelle heraus und zeigt direkt hinter die Tabelle.
