...
description: Greifen Sie mit der CurrentParagraph-Eigenschaft einfach auf den ausgewählten Absatz in DocumentBuilder zu. Optimieren Sie noch heute Ihre Dokumentbearbeitung!
type: docs
weight: 50
...
Ruft den Absatz ab, der aktuell in diesem[`DocumentBuilder`](../) .
