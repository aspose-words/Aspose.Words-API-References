...
description: Bewegt den Cursor zu einem Lesezeichen.
type: docs
weight: 470
...
True, wenn das Lesezeichen gefunden wurde; falsch sonst.

### Bemerkungen

Bewegt den Cursor an eine Position unmittelbar nach dem Beginn des Lesezeichens mit dem angegebenen Namen.

Beim Vergleich wird die Groß-/Kleinschreibung nicht beachtet. Wenn das Lesezeichen nicht gefunden wurde, wird false is zurückgegeben und der Cursor wird nicht bewegt.

Das Einfügen von neuem Text ersetzt nicht den vorhandenen Text des Lesezeichens.

Beachten Sie, dass einige Lesezeichen im Dokument Formularfeldern zugewiesen sind. Wenn Sie zu einem solchen Lesezeichen wechseln und dort Text einfügen, wird der Text in den Formularfeldcode eingefügt. Obwohl das Formularfeld dadurch nicht ungültig wird, ist der eingefügte -Text nicht sichtbar, da er Teil des Feldcodes wird.
...
Bewegt den Cursor mit größerer Genauigkeit zu einem Lesezeichen.
...
| --- | --- | --- |
| bookmarkName | String | Der Name des Lesezeichens, zu dem der Cursor bewegt werden soll. |
| isStart | Boolean | Wenn wahr, bewegt sich der Cursor zum Anfang des Lesezeichens. Wenn falsch, bewegt sich der Cursor zum Ende des Lesezeichens. |
| isAfter | Boolean | Wenn wahr, bewegt sich der Cursor hinter die Start- oder Endposition von bookmark . Wenn falsch, bewegt sich der Cursor vor die Start- oder Endposition von bookmark . |
...
Wenn sich die gewünschte Position nicht auf der Inline-Ebene befindet, wird zum nächsten Absatz gewechselt.

Beim Vergleich wird die Groß-/Kleinschreibung nicht beachtet. Wenn das Lesezeichen nicht gefunden wurde, wird false is zurückgegeben und der Cursor wird nicht bewegt.

### Beispiele

Zeigt, wie der Einfügepunkt-Cursor des Knotens eines Dokumenterstellers zu einem Lesezeichen verschoben wird.
...
// passender Lesezeichenname irgendwo danach und Inhalt, der von diesen Knoten eingeschlossen wird.
builder.StartBookmark("MyBookmark");
builder.Write("Hello world! ");
builder.EndBookmark("MyBookmark");

// Es gibt 4 Möglichkeiten, den Cursor eines Dokumentenerstellers auf ein Lesezeichen zu bewegen.
