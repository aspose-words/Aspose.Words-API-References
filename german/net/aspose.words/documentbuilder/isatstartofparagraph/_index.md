...
description: Entdecken Sie die IsAtStartOfParagraph-Eigenschaft von DocumentBuilder. Überprüfen Sie einfach, ob sich Ihr Cursor am Absatzanfang befindet, um Text effizient zu bearbeiten.
type: docs
weight: 130
...
Rückgaben`WAHR`wenn sich der Cursor am Anfang des aktuellen Absatzes befindet (kein Text vor dem Cursor).
