...
description: Fügt einen HTML-String in das Dokument ein.
type: docs
weight: 330
...
| --- | --- | --- |
| html | String | Eine HTML-Zeichenfolge, die in das Dokument eingefügt werden soll. |
| useBuilderFormatting | Boolean | Ein Wert, der angibt, ob die Formatierung angegeben ist in[`DocumentBuilder`](../../documentbuilder) wird als Basisformatierung für aus HTML importierten Text verwendet. |

### Bemerkungen

Mit dieser Methode können Sie ein HTML-Fragment oder ein ganzes HTML-Dokument einfügen.

Wann*useBuilderFormatting* ist`FALSCH` , [`DocumentBuilder`](../../documentbuilder) die Formatierung wird ignoriert und die Formatierung des eingefügten text basiert auf der Standard-HTML-Formatierung. Als Ergebnis sieht der Text so aus, wie er in Browsern gerendert wird.

Wann*useBuilderFormatting* ist`Stimmt` , Formatierung des eingefügten Textes basiert auf[`DocumentBuilder`](../../documentbuilder) Formatierung, und der Text sieht aus als wäre er mit eingefügt worden[`Write`](../write) .
