...
description: Entdecken Sie die Paragraph ParentStory-Eigenschaft, um einfach auf übergeordnete Storys auf Abschnittsebene zuzugreifen und die Struktur Ihres Dokuments mit Body- oder HeaderFooter-Optionen zu verbessern.
type: docs
weight: 210
...
Ruft die übergeordnete Story auf Abschnittsebene ab, die[`Body`](../../body/) oder[`HeaderFooter`](../../headerfooter/) .
