...
description: Paragraph constructeur. Initialisiert eine neue Instanz vonParagraph Klasse.
type: docs
weight: 10
...
Anhängen[`Paragraph`](../) zur DokumentenverwendungNode) oderNode) in der Story, in der der Absatz eingefügt werden soll.
