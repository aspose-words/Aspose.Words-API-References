...
description: Erstellen Sie mühelos dynamische Inhalte mit unserem Absatzkonstruktor. Initialisieren und passen Sie Ihre Absatzklasse einfach an, um die Lesbarkeit zu verbessern.
type: docs
weight: 10
url: /de/net/aspose.words/paragraph/paragraph/
---
## Paragraph constructor

Initialisiert eine neue Instanz des[`Paragraph`](../) Klasse.
...
Wann[`Paragraph`](../) erstellt wird, gehört es zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und[`ParentNode`](../../node/parentnode/) Ist`null`.

Anhängen[`Paragraph`](../) zur Dokumentenverwendung[`InsertAfter`](../../compositenode/insertafter/) oder[`InsertBefore`](../../compositenode/insertbefore/) in der Story, in der Sie den Absatz einfügen möchten.
