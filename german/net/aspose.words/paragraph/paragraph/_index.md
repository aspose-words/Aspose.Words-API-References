...
description: Paragraph constructeur. Initialisiert eine neue Instanz von Absatz Klasse.
type: docs
weight: 10
...
Initialisiert eine neue Instanz von **Absatz** Klasse.
...
Wann **Absatz** erstellt wird, gehört es zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und **Elternknoten** ist Null.

Anhängen **Absatz** zum Dokument verwenden Sie InsertAfter oder InsertBefore in der Story, in der Sie den Absatz einfügen möchten.
