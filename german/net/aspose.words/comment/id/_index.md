...
description: Ruft die Kommentarkennung ab.
type: docs
weight: 60
...
Die Kommentarkennung ermöglicht es, einen Kommentar in einem Textbereich im Dokument zu verankern. Der Bereich muss mit dem abgegrenzt werden[`CommentRangeStart`](../../commentrangestart) und[`CommentRangeEnd`](../../commentrangeend) Objekt, das den gleichen ID-Wert wie das hat[`Comment`](../../comment) Objekt.
