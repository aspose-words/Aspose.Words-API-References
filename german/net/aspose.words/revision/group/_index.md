...
description: Entdecken Sie die Eigenschaft „Revisionsgruppe“, rufen Sie mühelos Revisionsgruppen ab oder erhalten Sie Null, wenn keine Gruppe vorhanden ist. Vereinfachen Sie noch heute Ihr Datenmanagement!
type: docs
weight: 30
...
Ruft die Revisionsgruppe ab. Gibt zurück`null` wenn die Revision keiner Gruppe angehört.
...
Revision hat keine Gruppe, wenn Revisionstyp istStyleDefinitionChange oder , wenn die Revision im Dokumentkontext nicht mehr vorhanden ist (akzeptiert/abgelehnt).
