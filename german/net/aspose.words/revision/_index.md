...
description: Erkunden Sie die Klasse Aspose.Words.Revision, um nachverfolgte Änderungen in Dokumenten zu verwalten. Identifizieren Sie Revisionstypen einfach für eine nahtlose Dokumentbearbeitung.
type: docs
weight: 5500
...
| Name | Beschreibung |
| --- | --- |
| [Author](../../aspose.words/revision/author/) { get; set; } | Ruft den Autor dieser Revision ab oder legt ihn fest. Kann keine leere Zeichenfolge sein oder`null` . |
| [DateTime](../../aspose.words/revision/datetime/) { get; set; } | Ruft Datum/Uhrzeit dieser Revision ab oder legt diese fest. |
| [Group](../../aspose.words/revision/group/) { get; } | Ruft die Revisionsgruppe ab. Gibt zurück`null` wenn die Revision keiner Gruppe angehört. |
| [ParentNode](../../aspose.words/revision/parentnode/) { get; } | Ruft den unmittelbaren übergeordneten Knoten (Besitzer) dieser Revision ab. Diese Eigenschaft funktioniert für alle Revisionstypen außerStyleDefinitionChange . |
| [ParentStyle](../../aspose.words/revision/parentstyle/) { get; } | Ruft den unmittelbar übergeordneten Stil (Besitzer) dieser Revision ab. Diese Eigenschaft funktioniert nur für dieStyleDefinitionChange Revisionstyp. |
...
| [Reject](../../aspose.words/revision/reject/)() | Diese Revision ablehnen. |
