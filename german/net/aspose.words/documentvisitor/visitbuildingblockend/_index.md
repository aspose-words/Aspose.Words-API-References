...
description: Erkunden Sie die Methode „VisitBuildingBlockEnd“ von DocumentVisitor, die am Ende der Bausteinaufzählung ausgelöst wird, um eine effiziente Dokumentverarbeitung zu gewährleisten.
type: docs
weight: 60
url: /de/net/aspose.words/documentvisitor/visitbuildingblockend/
---
...
Hinweis: Ein Bausteinknoten und seine untergeordneten Knoten werden nicht besucht, wenn Sie einen Besucher über einen[`Document`](../../document/) Wenn Sie einen Besucher über einen -Baustein ausführen möchten, müssen Sie den Besucher über[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument/) oder -Aufruf[`Accept`](../../../aspose.words.buildingblocks/buildingblock/accept/) .
