...
description: Entdecken Sie die DocumentVisitor VisitRun-Methode für effiziente Textverarbeitung in Ihren Anwendungen. Verbessern Sie Ihren Code mit diesem unverzichtbaren Tool!
type: docs
weight: 360
...
Wird aufgerufen, wenn ein Textabschnitt darin gefunden wird.
...
| --- | --- | --- |
| run | Run | Das Objekt, das besucht wird. |
