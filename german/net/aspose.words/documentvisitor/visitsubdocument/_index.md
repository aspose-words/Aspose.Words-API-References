...
description: Entdecken Sie die VisitSubDocument-Methode von DocumentVisitor, die für die effiziente Handhabung von Unterdokumenten in Ihren Anwendungen entwickelt wurde. Steigern Sie Ihre Codiereffizienz!
type: docs
weight: 480
url: /de/net/aspose.words/documentvisitor/visitsubdocument/
---
## DocumentVisitor.VisitSubDocument method

Wird aufgerufen, wenn ein Unterdokument gefunden wird.
...
| --- | --- | --- |
| subDocument | SubDocument | Das Objekt, das besucht wird. |
