...
description: Entdecken Sie die DocumentVisitor VisitSectionStart-Methode, die für die Nachverfolgung der Abschnittsaufzählung unerlässlich ist. Steigern Sie Ihre Codiereffizienz mit diesem leistungsstarken Tool!
type: docs
weight: 380
...
Wird aufgerufen, wenn mit der Aufzählung eines Abschnitts begonnen wurde.
...
| --- | --- | --- |
| section | Section | Das Objekt, das besucht wird. |
