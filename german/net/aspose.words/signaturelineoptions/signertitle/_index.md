...
description: Entdecken Sie die SignatureLineOptions SignerTitle-Eigenschaft, um vorgeschlagene Unterzeichnertitel einfach anzupassen. Verleihen Sie Ihrem Dokument mühelos mehr Professionalität!
type: docs
weight: 80
url: /de/net/aspose.words/signaturelineoptions/signertitle/
---
## SignatureLineOptions.SignerTitle property

Ruft den vorgeschlagenen Titel des Unterzeichners ab oder legt ihn fest. Der Standardwert für diese Eigenschaft ist**leere Zeichenfolge** (Empty ).
