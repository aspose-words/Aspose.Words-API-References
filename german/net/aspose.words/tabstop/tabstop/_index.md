...
| --- | --- | --- |
| position | Double | Die Position des Tabstopps in Punkt. |
| alignment | TabAlignment | EIN[`TabAlignment`](../../tabalignment/) Der Wert that gibt die Textausrichtung an diesem Tabstopp an. |
| leader | TabLeader | EIN[`TabLeader`](../../tableader/) Wert, der den Typ der Führungslinie angibt, die unter dem Tabulatorzeichen angezeigt wird. |
