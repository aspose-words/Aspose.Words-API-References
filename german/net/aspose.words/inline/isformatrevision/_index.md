...
description: Entdecken Sie die Inline-Eigenschaft „IsFormatRevision“ in Microsoft Word. Sie zeigt an, ob sich die Objektformatierung bei aktivierter Änderungsverfolgung geändert hat, und verbessert so die Dokumentenverwaltung.
type: docs
weight: 30
