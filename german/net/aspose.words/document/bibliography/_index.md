...
description: Greifen Sie auf die Dokumentbibliografie-Eigenschaft zu, um eine umfassende Quellenliste abzurufen und so Ihre Recherche und Zitatgenauigkeit zu verbessern.
type: docs
weight: 40
url: /de/net/aspose.words/document/bibliography/
---
## Document.Bibliography property

Ruft die`Bibliography`Objekt, das die Liste der im Dokument verfügbaren Quellen darstellt.
