...
description: Entdecken Sie, wie Sie Ihr Dokumentenglossar effektiv verwalten. Erfahren Sie, wie Sie Glossareinträge für AutoText und Bausteine in Ihren Vorlagen festlegen und abrufen.
type: docs
weight: 180
...
Ruft das Glossardokument innerhalb dieses Dokuments oder dieser Vorlage ab oder legt es fest. Ein Glossardokument ist ein Speicher für in einem Dokument definierte AutoText-, AutoKorrektur- und Bausteineinträge.
...
Diese Eigenschaft gibt`null` wenn das Dokument kein Glossardokument hat.

Sie können einem Dokument ein Glossar hinzufügen, indem Sie a erstellen.[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument/) Objekt und Zuweisen dieser Eigenschaft.
