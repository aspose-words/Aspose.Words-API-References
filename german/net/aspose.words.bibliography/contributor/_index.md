...
description: Entdecken Sie die Klasse Aspose.Words.Bibliography.Contributor, Ihre Lösung für die Verwaltung von Bibliografie-Mitwirkenden, einschließlich Organisationen und Einzelpersonen.
type: docs
weight: 150
url: /de/net/aspose.words.bibliography/contributor/
---
## Contributor class

Stellt einen Beitragenden zur Bibliografiequelle dar. Kann entweder ein Unternehmen (eine Organisation) oder eine Liste von Personen sein.
