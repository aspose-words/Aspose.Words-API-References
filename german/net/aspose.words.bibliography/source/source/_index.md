...
description: Erstellen Sie mühelos eine neue Source-Klasseninstanz mit unserem Konstruktor. Vereinfachen Sie Ihren Codierungsprozess und steigern Sie noch heute die Effizienz Ihres Projekts!
type: docs
weight: 10
url: /de/net/aspose.words.bibliography/source/source/
---
## Source constructor

Initialisieren Sie eine neue Instanz des[`Source`](../) Klasse.
...
| --- | --- | --- |
| tag | String | Der identifizierende Tag-Name. |
| sourceType | SourceType | Der Quelltyp. |
