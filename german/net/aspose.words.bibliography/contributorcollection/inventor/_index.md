...
description: Entdecken Sie die ContributorCollection Inventor-Eigenschaft, um den Erfinder Ihrer Quellen einfach zu verwalten und zu identifizieren und so die Organisation Ihres Projekts zu verbessern.
type: docs
weight: 120
url: /de/net/aspose.words.bibliography/contributorcollection/inventor/
---
## ContributorCollection.Inventor property

Ruft den Erfinder einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Inventor { get; set; }
```
