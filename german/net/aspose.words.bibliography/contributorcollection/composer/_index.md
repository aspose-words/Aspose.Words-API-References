...
description: Entdecken Sie die ContributorCollection Composer-Eigenschaft, um Quell-Composer einfach zu verwalten und anzupassen und so die Datenorganisation und -effizienz zu verbessern.
type: docs
weight: 50
url: /de/net/aspose.words.bibliography/contributorcollection/composer/
---
## ContributorCollection.Composer property

Ruft den Komponisten einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Composer { get; set; }
```
