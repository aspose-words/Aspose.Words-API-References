---
title: ContributorCollection.Producer
linktitle: Producer
articleTitle: Producer
second_title: Aspose.Words für .NET
description: Verwalten Sie Ihre Medien mit der Producer-Eigenschaft von ContributorCollection – legen Sie den Produzenten der Quelle einfach fest oder rufen Sie ihn ab, um die Inhaltsorganisation zu optimieren.
type: docs
weight: 140
url: /de/net/aspose.words.bibliography/contributorcollection/producer/
---
## ContributorCollection.Producer property

Ruft den Produzenten einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Producer { get; set; }
```
