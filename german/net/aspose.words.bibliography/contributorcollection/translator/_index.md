---
title: ContributorCollection.Translator
linktitle: Translator
articleTitle: Translator
second_title: Aspose.Words für .NET
description: Entdecken Sie die ContributorCollection Translator-Eigenschaft, verwalten und passen Sie Quellübersetzer einfach an, um die Zugänglichkeit und das Engagement Ihrer Inhalte zu verbessern.
type: docs
weight: 150
url: /de/net/aspose.words.bibliography/contributorcollection/translator/
---
## ContributorCollection.Translator property

Ruft den Übersetzer einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Translator { get; set; }
```
