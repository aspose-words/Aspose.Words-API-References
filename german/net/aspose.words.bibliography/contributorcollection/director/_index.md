---
title: ContributorCollection.Director
linktitle: Director
articleTitle: Director
second_title: Aspose.Words für .NET
description: Verwalten Sie Ihre ContributorCollection mühelos. Legen Sie den Direktor für jede Quelle einfach fest oder aktualisieren Sie ihn. So verbessern Sie Organisation und Effizienz.
type: docs
weight: 80
url: /de/net/aspose.words.bibliography/contributorcollection/director/
---
## ContributorCollection.Director property

Ruft den Direktor einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Director { get; set; }
```
