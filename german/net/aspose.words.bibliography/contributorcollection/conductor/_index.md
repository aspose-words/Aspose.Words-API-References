---
title: ContributorCollection.Conductor
linktitle: Conductor
articleTitle: Conductor
second_title: Aspose.Words für .NET
description: Entdecken Sie die ContributorCollection Conductor-Eigenschaft, verwalten und passen Sie den Quellleiter einfach an, um die Datenorganisation und -kontrolle zu verbessern.
type: docs
weight: 60
url: /de/net/aspose.words.bibliography/contributorcollection/conductor/
---
## ContributorCollection.Conductor property

Ruft den Leiter einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Conductor { get; set; }
```
