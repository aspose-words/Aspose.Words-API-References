---
title: ContributorCollection.Editor
linktitle: Editor
articleTitle: Editor
second_title: Aspose.Words für .NET
description: Verwalten Sie Ihre ContributorCollection ganz einfach! Richten Sie den Quellen-Editor ein oder nutzen Sie ihn, um Ihren Workflow zu verbessern und die Inhaltsverwaltung zu optimieren.
type: docs
weight: 90
url: /de/net/aspose.words.bibliography/contributorcollection/editor/
---
## ContributorCollection.Editor property

Ruft den Editor einer Quelle ab oder legt ihn fest.

```csharp
public Contributor Editor { get; set; }
```
