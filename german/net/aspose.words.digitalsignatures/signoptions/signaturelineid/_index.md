...
description: Entdecken Sie die SignatureLineId-Eigenschaft in SignOptions. Identifizieren Sie Signaturzeilen ganz einfach mit einer eindeutigen GUID und steigern Sie so die Effizienz Ihres Dokumentenmanagements.
type: docs
weight: 50
...
Signaturzeilenkennung. Der Standardwert ist**Leere (nur Nullen) GUID** .
...
Wenn gesetzt, verbindet es[`SignatureLine`](../../../aspose.words.drawing/signatureline/) mit entsprechenden[`DigitalSignature`](../../digitalsignature/) .
