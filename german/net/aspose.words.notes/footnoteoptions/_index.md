...
description: Aspose.Words.Notes.FootnoteOptions klas. Repräsentiert die Fußnotennummerierungsoptionen für ein Dokument oder einen Abschnitt.
type: docs
weight: 4040
...
Repräsentiert die Fußnotennummerierungsoptionen für ein Dokument oder einen Abschnitt.
...
| [RestartRule](../../aspose.words.notes/footnoteoptions/restartrule/) { get; set; } | Legt fest, wann die automatische Nummerierung neu gestartet wird. |
| [StartNumber](../../aspose.words.notes/footnoteoptions/startnumber/) { get; set; } | Gibt die Anfangsnummer oder das Anfangszeichen für die ersten automatisch nummerierten Fußnoten an. |
