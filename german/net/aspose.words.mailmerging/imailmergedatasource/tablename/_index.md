...
description: Gibt den Namen der Datenquelle zurück.
type: docs
weight: 10
...
Wenn Sie implementieren[`IMailMergeDataSource`](../../imailmergedatasource), geben Sie den Namen der Quelle data aus dieser Eigenschaft zurück.
