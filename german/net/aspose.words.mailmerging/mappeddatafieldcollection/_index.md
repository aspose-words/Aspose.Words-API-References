...
description: Ermöglicht die automatische Zuordnung zwischen Namen von Feldern in Ihrer Datenquelle und Namen von Serienbrieffeldern im Dokument.
type: docs
weight: 3650
...
| [Item](../../aspose.words.mailmerging/mappeddatafieldcollection/item) { get; set; } | Ruft den Namen des Felds in der Datenquelle ab, das dem angegebenen Seriendruckfeld zugeordnet ist, oder legt ihn fest. |
...
| [GetEnumerator](../../aspose.words.mailmerging/mappeddatafieldcollection/getenumerator)() | Gibt ein Dictionary-Enumerator-Objekt zurück, das verwendet werden kann, um über alle Elemente in der Sammlung zu iterieren. |
| [Remove](../../aspose.words.mailmerging/mappeddatafieldcollection/remove)(string) | Entfernt eine Feldzuordnung. |

### Bemerkungen

Dies wird als Sammlung von String-Schlüsseln in String-Werte implementiert. Die Schlüssel sind die Namen der Serienbrieffelder im Dokument und die Werte sind die Namen der Felder in Ihrer Datenquelle.
