...
description: MappedDataFieldCollection methode. Bestimmt ob eine Zuordnung aus dem angegebenen Feld im Dokument in der Sammlung vorhanden ist.
type: docs
weight: 50
...
Bestimmt, ob eine Zuordnung aus dem angegebenen Feld im Dokument in der Sammlung vorhanden ist.
...
| --- | --- | --- |
| documentFieldName | String | Groß-/Kleinschreibung beachtender Name des Seriendruckfelds im Dokument. |
