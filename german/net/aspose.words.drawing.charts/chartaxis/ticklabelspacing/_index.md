...
description: ChartAxis eigendom. Holt oder setzt das Intervall in dem TickLabels gezeichnet werden.
type: docs
weight: 230
...
Holt oder setzt das Intervall, in dem Tick-Labels gezeichnet werden.
...
Die Eigenschaft wirkt sich auf Textkategorie- und Reihenachsen aus. Es wird von MS Office 2016 new charts nicht unterstützt. Der gültige Bereich eines Werts ist größer oder gleich 1.

Durch Festlegen dieser Eigenschaft wird die[`TickLabelSpacingIsAuto`](../ticklabelspacingisauto/) Eigentum zu **FALSCH**.
