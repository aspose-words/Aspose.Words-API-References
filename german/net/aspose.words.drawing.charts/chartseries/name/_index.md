...
description: ChartSeries eigendom. Ruft den Namen der Reihe ab oder legt ihn fest. Wenn der Name nicht explizit festgelegt wird wird er mithilfe von Index generiert. Gibt standardmäßig Reihe plus einen basierenden Index zurück.
type: docs
weight: 100
...
Ruft den Namen der Reihe ab oder legt ihn fest. Wenn der Name nicht explizit festgelegt wird, wird er mithilfe von Index generiert. Gibt standardmäßig Reihe plus einen basierenden Index zurück.
