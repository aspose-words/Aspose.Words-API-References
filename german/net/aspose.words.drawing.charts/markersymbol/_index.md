...
description: Aspose.Words.Drawing.Charts.MarkerSymbol opsomming. Gibt den Markersymbolstil an.
type: docs
weight: 790
...
| --- | --- | --- |
| Default | `0` | Gibt an, dass ein Standardmarkersymbol an jedem Datenpunkt gezeichnet werden soll. |
