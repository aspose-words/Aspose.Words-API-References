...
description: Entdecken Sie die FormatCode-Eigenschaft der ChartYValueCollection, um die Formatierung der Y-Werte einfach anzupassen. Verbessern Sie Ihre Datenvisualisierung mit Präzision!
type: docs
weight: 20
url: /de/net/aspose.words.drawing.charts/chartyvaluecollection/formatcode/
---
## ChartYValueCollection.FormatCode property

Ruft den auf die Y-Werte angewendeten Formatcode ab oder legt ihn fest.
