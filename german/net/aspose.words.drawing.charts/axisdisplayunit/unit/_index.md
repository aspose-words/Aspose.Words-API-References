...
description: Entdecken Sie die AxisDisplayUnit-Eigenschaft, um die Skalierung der Anzeigeeinheiten mit vordefinierten Werten für eine verbesserte Datenvisualisierung einfach anzupassen.
type: docs
weight: 40
...
Ruft den Skalierungswert der Anzeigeeinheiten als einen der vordefinierten Werte ab oder legt ihn fest.
...
Der Standardwert istNone . DerCustom und Percentage Werte sind in einigen Diagrammtypen nicht verfügbar; siehe [`AxisBuiltInUnit`](../../axisbuiltinunit/) für weitere Informationen.
