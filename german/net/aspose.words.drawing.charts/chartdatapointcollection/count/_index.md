...
description: Entdecken Sie die Count-Eigenschaft von ChartDataPointCollection, die effizient die Gesamtzahl der ChartDataPoints zurückgibt und so Ihre Datenvisualisierung verbessert.
type: docs
weight: 10
...
Gibt die Anzahl der[`ChartDataPoint`](../../chartdatapoint/) in dieser Sammlung.
