...
description: Greifen Sie mit der Item-Eigenschaft in der ChartDataLabelCollection einfach auf bestimmte ChartDataLabel zu. Verbessern Sie noch heute Ihre Datenvisualisierung!
type: docs
weight: 40
url: /de/net/aspose.words.drawing.charts/chartdatalabelcollection/item/
---
## ChartDataLabelCollection indexer

Rückgaben[`ChartDataLabel`](../../chartdatalabel/) für den angegebenen Index.
