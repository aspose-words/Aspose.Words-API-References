...
description: Passen Sie die Drehung Ihrer ChartDataLabelCollection für optimale Sichtbarkeit an. Passen Sie die Winkel der Datenbeschriftungen an, um die Lesbarkeit und Wirkung Ihres Diagramms zu verbessern.
type: docs
weight: 80
url: /de/net/aspose.words.drawing.charts/chartdatalabelcollection/rotation/
---
## ChartDataLabelCollection.Rotation property

Ruft die Drehung der Datenbeschriftungen der gesamten Reihe in Grad ab oder legt sie fest.
...
Wenn die[`Orientation`](../orientation/) Wert istHorizontal, Beschriftungsformen, (sofern vorhanden), werden zusammen mit dem Beschriftungstext gedreht. Andernfalls wird nur der Beschriftungstext gedreht.
