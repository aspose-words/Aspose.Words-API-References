...
description: Entdecken Sie die Eigenschaft „ShowDataLabelsRange“ in der ChartDataLabelCollection. Steuern Sie die Sichtbarkeit der Datenbeschriftungen für Ihre Serien und verbessern Sie die Datenpräsentation mühelos!
type: docs
weight: 120
...
Ermöglicht die Angabe, ob Werte aus dem Datenbeschriftungsbereich in den Datenbeschriftungen der gesamten Reihe angezeigt werden sollen. Der Standardwert ist`FALSCH` .
...
Der für diese Eigenschaft definierte Wert kann für ein einzelnes Datenlabel mit dem überschrieben werden.[`ShowDataLabelsRange`](../../chartdatalabel/showdatalabelsrange/) Eigenschaft.
