...
| Name | Beschreibung |
| --- | --- |
| [DateTimeValue](../../aspose.words.drawing.charts/chartyvalue/datetimevalue/) { get; } | Ruft den gespeicherten Datum/Uhrzeit-Wert ab. |
| [DoubleValue](../../aspose.words.drawing.charts/chartyvalue/doublevalue/) { get; } | Ruft den gespeicherten numerischen Wert ab. |
| [TimeValue](../../aspose.words.drawing.charts/chartyvalue/timevalue/) { get; } | Ruft den gespeicherten Zeitwert ab. |
| [ValueType](../../aspose.words.drawing.charts/chartyvalue/valuetype/) { get; } | Ruft den Typ des im Objekt gespeicherten Y-Werts ab. |
...
Alle Y-Werte ungleich Null einer Diagrammreihe müssen gleich sein[`ChartYValueType`](../chartyvaluetype/) Typ.
