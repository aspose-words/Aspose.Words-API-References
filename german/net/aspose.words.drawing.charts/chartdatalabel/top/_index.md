...
description: Passen Sie die Eigenschaft „ChartDataLabel oben“ an, um die Positionierung der Datenbeschriftung für eine bessere Diagrammübersicht zu steuern. Optimieren Sie Ihre visuelle Datendarstellung mühelos!
type: docs
weight: 210
url: /de/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

Ermittelt oder setzt den Abstand der Datenbeschriftung in Punkten vom oberen Rand des Diagramms oder von der Position , die durch seine[`Position`](../position/) Eigentum, abhängig vom Wert des[`TopMode`](../topmode/) Eigenschaft.
...
Der Wert der Eigenschaft ändert sich proportional, wenn die Größe der Diagrammform geändert wird.
