...
description: Entdecken Sie die Eigenschaft „ChartDataLabel LeftMode“, um die Positionierung von Datenbeschriftungen in Ihren Diagrammen anzupassen. Verbessern Sie Übersichtlichkeit und Präsentation durch präzise Steuerung.
type: docs
weight: 70
url: /de/net/aspose.words.drawing.charts/chartdatalabel/leftmode/
---
## ChartDataLabel.LeftMode property

Ermittelt oder setzt den Interpretationsmodus des[`Left`](../left/) Eigenschaftswert: ob die Position der Datenbeschriftung vom linken Rand des Diagramms oder von der durch seine angegebene Position festgelegt wird[`Position`](../position/) Eigenschaft.
