...
description: Entdecken Sie die Eigenschaft „ChartDataLabel ShowSeriesName“ und steuern Sie ganz einfach die Sichtbarkeit von Seriennamen in Ihren Diagrammen. Verbessern Sie die Datenübersicht mit einer einfachen booleschen Einstellung!
type: docs
weight: 190
...
Gibt einen Booleschen Wert zurück oder legt ihn fest, um das Anzeigeverhalten des Seriennamens für die Datenbeschriftungen in einem Diagramm anzugeben. `WAHR` um den Seriennamen anzuzeigen;`FALSCH` zu verbergen. Standardmäßig`FALSCH` .
