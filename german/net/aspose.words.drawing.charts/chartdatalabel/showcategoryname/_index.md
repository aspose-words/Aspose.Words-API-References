...
description: Optimieren Sie Ihre Diagramme mit der Eigenschaft „ChartDataLabel ShowCategoryName“. Zeigen Sie Kategorienamen einfach auf Datenbeschriftungen an, um klarere Einblicke und eine bessere Darstellung zu ermöglichen.
type: docs
weight: 140
url: /de/net/aspose.words.drawing.charts/chartdatalabel/showcategoryname/
---
## ChartDataLabel.ShowCategoryName property

Ermöglicht die Angabe, ob der Kategoriename für die Datenbeschriftungen in einem Diagramm angezeigt werden soll. Der Standardwert ist`FALSCH` .
