...
description: Implementieren Sie diese Schnittstelle wenn Sie steuern möchten wie Aspose.Words CSS Cascading Style Sheet speichert wenn ein Dokument in HTML gespeichert wird.
type: docs
weight: 4870
