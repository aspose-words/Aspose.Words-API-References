...
description: Gibt die Version des HTML-Standards an die verwendet werden soll wenn das Dokument in HTML oder MHTML gespeichert wird. Der Standardwert istXhtml .
type: docs
weight: 340
