...
description: Gibt an in welchem Format Metadateien gespeichert werden wenn sie in HTML MHTML oder EPUB exportiert werden. Standardwert istPng  was bedeutet dass Metadateien in RasterPNGBilder gerendert werden.
type: docs
weight: 390
