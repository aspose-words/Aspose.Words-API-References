...
description: Gibt den physischen Ordner an in dem Bilder gespeichert werden wenn ein Dokument in das HTML-Format exportiert wird. Standard ist eine leere Zeichenfolge.
type: docs
weight: 370
