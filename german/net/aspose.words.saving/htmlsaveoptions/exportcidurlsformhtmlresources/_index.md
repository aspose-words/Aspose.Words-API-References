...
description: Gibt an ob CID-URLs Content-ID verwendet werden sollen um auf Ressourcen Bilder Schriftarten CSS zu verweisen die in MHTML -Dokumenten enthalten sind. Standardwert istFALSCH .
type: docs
weight: 120
