...
description: Gibt an ob CIDURLs ContentID verwendet werden sollen um auf Ressourcen Bilder Schriftarten CSS zu verweisen die in MHTML Dokumenten enthalten sind. Standardwert istFALSCH .
type: docs
weight: 120
