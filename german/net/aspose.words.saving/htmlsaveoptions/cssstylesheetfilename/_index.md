...
description: Gibt den Pfad und den Namen der CSS-Datei Cascading Style Sheet an die geschrieben wird wenn ein Dokument in HTML exportiert wird. Standard ist eine leere Zeichenfolge.
type: docs
weight: 50
