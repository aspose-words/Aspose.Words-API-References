...
description: Gibt die maximale Ebene von Überschriften an die beim Exportieren in das IDPFEPUBFormat in die Navigationskarte eingetragen werden. Der Standardwert ist3 .
type: docs
weight: 110
