...
description: Gibt den Namen des Ordners an der verwendet wird um URIs aller Ressourcen zu erstellen die in ein HTMLDokument geschrieben werden. Standard ist eine leere Zeichenfolge.
type: docs
weight: 430
