...
description: Gibt den Namen des Ordners an der zum Erstellen von BildURIs verwendet wird die in ein HTMLDokument geschrieben werden. Standard ist eine leere Zeichenfolge.
type: docs
weight: 380
