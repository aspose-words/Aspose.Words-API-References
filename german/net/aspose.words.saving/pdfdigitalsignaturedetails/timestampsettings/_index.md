...
description: PdfDigitalSignatureDetails eigendom. Ruft die Zeitstempeleinstellungen der digitalen Signatur ab oder legt sie fest.
type: docs
weight: 70
...
Ruft die Zeitstempeleinstellungen der digitalen Signatur ab oder legt sie fest.
...
Der Standardwert ist null und die digitale Signatur wird nicht mit einem Zeitstempel versehen. Wenn diese Eigenschaft auf gültig gesetzt ist[`PdfDigitalSignatureTimestampSettings`](../../pdfdigitalsignaturetimestampsettings/) object, wird die digitale Signatur im PDF-Dokument mit einem Zeitstempel versehen.
