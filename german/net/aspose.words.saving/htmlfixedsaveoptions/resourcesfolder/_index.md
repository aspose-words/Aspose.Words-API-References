...
description: Gibt den physischen Ordner an in dem Ressourcen Bilder Schriftarten CSS gespeichert werden wenn ein Dokument in das HTMLFormat exportiert wird. Standard istNull .
type: docs
weight: 140
