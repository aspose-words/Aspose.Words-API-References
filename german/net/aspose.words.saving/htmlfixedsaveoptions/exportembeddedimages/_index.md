...
description: Gibt an ob Bilder in ein HTML-Dokument im Base64-Format eingebettet werden sollen. Beachten Sie dass das Setzen dieses Flags die Größe der Ausgabe-Html-Datei erheblich erhöhen kann.
type: docs
weight: 60
