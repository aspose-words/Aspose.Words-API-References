...
description: Gibt an ob Bilder in ein HTMLDokument im Base64Format eingebettet werden sollen. Beachten Sie dass das Setzen dieses Flags die Größe der AusgabeHtmlDatei erheblich erhöhen kann.
type: docs
weight: 60
