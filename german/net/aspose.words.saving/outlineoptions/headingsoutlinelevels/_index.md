...
description: OutlineOptions eigendom. Gibt an wie viele Ebenen von Überschriften mit den Überschriftenstilen formatierte Absätze in die Dokumentgliederung aufgenommen werden sollen.
type: docs
weight: 70
