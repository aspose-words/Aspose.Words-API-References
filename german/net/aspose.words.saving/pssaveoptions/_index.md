...
description: Entdecken Sie Aspose.Words.Saving.PsSaveOptions, um Ihr Dokumentspeichererlebnis im Ps-Format mit anpassbaren Optionen für optimale Ergebnisse zu verbessern.
type: docs
weight: 6350
url: /de/net/aspose.words.saving/pssaveoptions/
---
## PsSaveOptions class

Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments imPs format.
...
| override [SaveFormat](../../aspose.words.saving/pssaveoptions/saveformat/) { get; set; } | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Speicheroptionsobjekt verwendet wird. Kann nurPs . |
...
| [UseBookFoldPrintingSettings](../../aspose.words.saving/pssaveoptions/usebookfoldprintingsettings/) { get; set; } | Ruft einen booleschen Wert ab oder legt ihn fest, der angibt, ob das Dokument im Broschüren-Drucklayout gespeichert werden soll, wenn dies über[`MultiplePages`](../../aspose.words/pagesetup/multiplepages/) . |
