...
description: Aspose.Words.Saving.PsSaveOptions klas. Kann zum Angeben zusätzlicher Optionen beim Speichern eines Dokuments im verwendet werdenPs format.
type: docs
weight: 5550
...
Kann zum Angeben zusätzlicher Optionen beim Speichern eines Dokuments im verwendet werdenPs format.
...
| override [SaveFormat](../../aspose.words.saving/pssaveoptions/saveformat/) { get; set; } | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Speicheroptionsobjekt verwendet wird. Kann nur seinPs . |
