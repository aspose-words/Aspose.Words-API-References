...
description: Gibt die Schwellenauflösung in Pixel pro Zoll an. Wenn die Auflösung eines Bildes im Dokument unter dem Schwellenwert liegt wird der Downsampling-Algorithmus nicht angewendet. Ein Wert von 0 bedeutet dass die Schwellenprüfung nicht verwendet wird und alle Bilder verkleinert werden können werden heruntergesampelt.
type: docs
weight: 40
