...
description: Gibt an ob das Programm versuchen soll das Layout von Tabellen beim Speichern im Nur-Text-Format beizubehalten. Der Standardwert ist FALSCH .
type: docs
weight: 50
