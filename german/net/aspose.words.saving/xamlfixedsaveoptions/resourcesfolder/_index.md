...
description: Gibt den physischen Ordner an in dem Ressourcen Bilder und Schriftarten gespeichert werden wenn ein Dokument in das XAML-Format mit festen Seiten exportiert wird. Standard istNull .
type: docs
weight: 30
