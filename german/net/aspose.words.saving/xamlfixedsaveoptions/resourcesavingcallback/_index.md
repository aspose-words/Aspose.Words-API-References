...
description: Ermöglicht die Steuerung wie Ressourcen Bilder und Schriftarten gespeichert werden wenn ein Dokument in das XAMLFormat mit festen Seiten exportiert wird.
type: docs
weight: 20
