...
description: Gibt den Namen des Ordners an der zum Erstellen von Bild-URIs verwendet wird die in ein XAML-Dokument geschrieben werden. Standard ist eine leere Zeichenfolge.
type: docs
weight: 40
