...
description: Gibt das Format an in dem das Dokument gespeichert wird wenn dieses Speicheroptionsobjekt verwendet wird. Kann seinDocx Docm  Dotx Dotm oderFlatOpc .
type: docs
weight: 60
