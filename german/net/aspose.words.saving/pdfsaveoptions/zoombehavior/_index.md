...
description: Ruft einen Wert ab oder legt einen Wert fest der bestimmt welche Art von Zoom angewendet werden soll wenn ein Dokument mit einem PDFViewer geöffnet wird.
type: docs
weight: 290
