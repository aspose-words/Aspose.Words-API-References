...
Der Standardwert ist`Null` . Wenn diese Eigenschaft ist`Null` wird die Dokumentseite in einer Datei gespeichert, die in der angegeben ist[`PageFileName`](../pagefilename/) Eigentum.

Wenn sowohl PageStream als auch PageFileName festgelegt sind, wird PageStream verwendet.
