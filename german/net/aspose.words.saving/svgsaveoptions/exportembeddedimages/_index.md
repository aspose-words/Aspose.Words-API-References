...
description: Gibt an ob Bilder als Base64 in das SVGDokument eingebettet werden sollen. Beachten Sie dass das Setzen dieses Flags die Größe der ausgegebenen SVGDatei erheblich erhöhen kann.
type: docs
weight: 20
