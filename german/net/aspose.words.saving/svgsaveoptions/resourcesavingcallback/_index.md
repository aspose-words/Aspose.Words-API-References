...
description: SvgSaveOptions ResourceSavingCallback eigendom. Ermöglicht die Steuerung wie Ressourcen Bilder gespeichert werden wenn ein Dokument in das SVGFormat exportiert wird in C#.
type: docs
weight: 40
