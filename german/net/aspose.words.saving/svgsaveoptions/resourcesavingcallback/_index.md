...
description: SvgSaveOptions eigendom. Ermöglicht die Steuerung wie Ressourcen Bilder gespeichert werden wenn ein Dokument in das SVGFormat exportiert wird.
type: docs
weight: 40
