...
description: Aspose.Words.Saving.SvgSaveOptions klas. Kann zum Angeben zusätzlicher Optionen beim Speichern eines Dokuments im verwendet werdenSvg format in C#.
type: docs
weight: 5600
...
Kann zum Angeben zusätzlicher Optionen beim Speichern eines Dokuments im verwendet werdenSvg format.
...
| [ExportEmbeddedImages](../../aspose.words.saving/svgsaveoptions/exportembeddedimages/) { get; set; } | Gibt an, ob Bilder als base64 in das SVG-Dokument eingebettet werden sollen. Hinweis: Das Setzen dieses Flags kann die Größe der ausgegebenen SVG-Datei erheblich erhöhen. |
...
| [FitToViewPort](../../aspose.words.saving/svgsaveoptions/fittoviewport/) { get; set; } | Gibt an, ob die Ausgabe-SVG den verfügbaren Ansichtsfensterbereich (Browserfenster oder Container) ausfüllen soll. Wenn auf gesetzt`WAHR` Breite und Höhe der Ausgabe-SVG werden auf 100 % gesetzt. |
...
| [ShowPageBorder](../../aspose.words.saving/svgsaveoptions/showpageborder/) { get; set; } | Steuert, ob dem Umriss der Seite ein Rahmen hinzugefügt wird. Standard ist`WAHR` . |
...
| [TextOutputMode](../../aspose.words.saving/svgsaveoptions/textoutputmode/) { get; set; } | Ruft einen Wert ab oder legt diesen fest, der bestimmt, wie Text in SVG gerendert werden soll. |
