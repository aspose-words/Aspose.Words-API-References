...
description: Gibt an ob die Schlüsselwörter für alte Reader in RTF geschrieben werden oder nicht. Dies kann die Größe des RTFDokuments erheblich beeinflussen. Standardwert istStimmt .
type: docs
weight: 30
