...
description: Gibt an ob die Schlüsselwörter für alte Reader in RTF geschrieben werden oder nicht. Dies kann die Größe des RTF-Dokuments erheblich beeinflussen. Standardwert istStimmt .
type: docs
weight: 30
