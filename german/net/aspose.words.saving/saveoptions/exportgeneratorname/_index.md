...
description: SaveOptions eigendom. WannWAHR  bewirkt dass der Name und die Version von Aspose.Words in erzeugte Dateien eingebettet werden. Der Standardwert istWAHR .
type: docs
weight: 80
