...
description: Aspose.Words.Saving.SaveOptions klas. Dies ist eine abstrakte Basisklasse für Klassen die es dem Benutzer ermöglichen zusätzliche Optionen anzugeben wenn ein Dokument in einem bestimmten Format gespeichert wird.
type: docs
weight: 5300
