...
description: Gibt den Ordner für temporäre Dateien an der beim Speichern in eine DOC oder DOCXDatei verwendet wird. Standardmäßig ist diese EigenschaftNull und es werden keine temporären Dateien verwendet.
type: docs
weight: 150
