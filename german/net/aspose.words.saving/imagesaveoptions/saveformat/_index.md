...
description: Entdecken Sie die SaveFormat-Eigenschaft von ImageSaveOptions, um Dokumente mühelos in Formaten wie TIFF, PNG, JPEG und anderen zu speichern. Optimieren Sie Ihren Workflow noch heute!
type: docs
weight: 140
...
Gibt das Format an, in dem die gerenderten Dokumentseiten oder Formen gespeichert werden, wenn dieses Speicheroptionsobjekt verwendet wird. Kann ein Raster sein Tiff ,Png ,Bmp , Jpeg oder VektorEmf ,Eps , WebP ,Svg .
...
Die Anzahl der weiteren Optionen hängt vom gewählten Format ab.

Außerdem ist es möglich, im SVG-Format zu speichern, sowohl über[`ImageSaveOptions`](../) und über[`SvgSaveOptions`](../../svgsaveoptions/).
