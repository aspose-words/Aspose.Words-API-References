...
description: Implementieren Sie diese Schnittstelle wenn Sie steuern möchten wie Aspose.Words Bilder speichert wenn ein Dokument in HTML gespeichert wird. Kann von anderen Formaten verwendet werden.
type: docs
weight: 4910
