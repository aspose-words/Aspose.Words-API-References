...
description: Aspose.Words.Saving.PdfZoomBehavior opsomming. Gibt den Zoomtyp an der auf ein PDFDokument angewendet wird wenn es in einem PDFViewer geöffnet wird in C#.
type: docs
weight: 5540
