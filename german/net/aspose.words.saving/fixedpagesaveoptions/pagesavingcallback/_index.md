...
description: FixedPageSaveOptions eigendom. Ermöglicht die Steuerung wie separate Seiten gespeichert werden wenn ein Dokument in ein festes Seitenformat exportiert wird.
type: docs
weight: 60
