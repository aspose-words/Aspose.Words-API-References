...
description: Entdecken Sie Aspose.Words.PclSaveOptions, um Ihre Dokumentspeicherung mit anpassbaren Funktionen für das PCL-Format zu verbessern. Optimieren Sie Ihren Workflow noch heute!
type: docs
weight: 6180
...
Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments imPcl format.
...
| [FallbackFontName](../../aspose.words.saving/pclsaveoptions/fallbackfontname/) { get; set; } | Name der Schriftart, die verwendet wird, wenn in den Drucker- und integrierten Schriftartensammlungen keine erwartete Schriftart gefunden wird. |
...
| [RasterizeTransformedElements](../../aspose.words.saving/pclsaveoptions/rasterizetransformedelements/) { get; set; } | Ruft einen Wert ab oder legt ihn fest, der bestimmt, ob komplexe transformierte Elemente vor dem Speichern in einem PCL-Dokument gerastert werden sollen. Der Standardwert ist`WAHR` . |
| override [SaveFormat](../../aspose.words.saving/pclsaveoptions/saveformat/) { get; set; } | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Speicheroptionsobjekt verwendet wird. Kann nurPcl . |
...
| Name | Beschreibung |
| --- | --- |
| [AddPrinterFont](../../aspose.words.saving/pclsaveoptions/addprinterfont/)(*string, string*) | Fügt Informationen zur Schriftart hinzu, die vom Hersteller auf den Drucker hochgeladen werden. |
