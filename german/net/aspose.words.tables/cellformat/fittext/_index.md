...
description: Entdecken Sie die CellFormat-Eigenschaft „FitText“, mit der Sie Text ganz einfach so komprimieren können, dass er in die Breite Ihrer Zelle passt, und so die Lesbarkeit und Darstellung in Ihren Tabellen verbessern.
type: docs
weight: 30
...
Wenn`WAHR` , passt den Text in die Zelle ein und komprimiert jeden Absatz auf die Breite der Zelle.
