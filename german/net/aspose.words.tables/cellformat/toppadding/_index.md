...
description: Entdecken Sie die CellFormat TopPadding-Eigenschaft, um den Abstand über Zellinhalten in Punkten anzupassen und so das Layout und die Lesbarkeit Ihrer Tabelle zu verbessern.
type: docs
weight: 110
url: /de/net/aspose.words.tables/cellformat/toppadding/
---
## CellFormat.TopPadding property

Gibt den Abstand (in Punkten) zurück, der über dem Inhalt der Zelle hinzugefügt werden soll, oder legt ihn fest.
