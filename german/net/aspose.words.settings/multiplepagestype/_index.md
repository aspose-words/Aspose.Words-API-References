...
| BookFoldPrinting | `3` | Gibt an, ob das Dokument als Buchfalte gedruckt werden soll. |
| BookFoldPrintingReverse | `4` | Gibt an, ob das Dokument als umgekehrte Buchfalte gedruckt werden soll. |
