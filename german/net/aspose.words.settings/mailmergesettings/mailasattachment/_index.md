...
description: MailMergeSettings eigendom. Gibt an dass die während eines Seriendruckvorgangs erstellten Dokumente per EMail als Anhang und nicht als als Text der eigentlichen EMail gesendet werden sollen. Der Standardwert istFALSCH .
type: docs
weight: 120
...
Gibt an, dass die während eines Seriendruckvorgangs erstellten Dokumente per E-Mail als Anhang und nicht als als Text der eigentlichen E-Mail gesendet werden sollen. Der Standardwert ist`FALSCH` .
