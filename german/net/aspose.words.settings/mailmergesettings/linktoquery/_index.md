...
description: MailMergeSettings eigendom. Ich bin mir diesbezüglich nicht sicher. Die Microsoft WordAutomatisierungsreferenz schlägt vor dass dies angibt dass die Abfrage jedes Mal ausgeführt wird wenn das Dokument in Microsoft Word geöffnet wird. Aber die OOXMLSpezifikation schlägt vor dass dies angibt dass die Abfrage einen Verweis auf eine externe Abfragedatei enthält die die eigentliche Abfrage enthält. Der Standardwert istFALSCH .
type: docs
weight: 110
