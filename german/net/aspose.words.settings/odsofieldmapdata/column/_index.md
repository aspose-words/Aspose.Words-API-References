...
description: OdsoFieldMapData eigendom. Gibt den nullbasierten Index der Spalte innerhalb einer externen Datenquelle an die dem lokalen Namen eines bestimmten MERGEFIELDFelds zugeordnet werden soll. Der Standardwert ist 0.
type: docs
weight: 20
