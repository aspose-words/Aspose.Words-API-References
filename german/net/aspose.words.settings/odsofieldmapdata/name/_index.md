...
description: Entdecken Sie die OdsoFieldMapData-Name-Eigenschaft und verknüpfen Sie externe Datenspalten ganz einfach mit anpassbarer Indizierung. Vereinfachen Sie mühelos die Datenverwaltung!
type: docs
weight: 40
...
Gibt den Spaltennamen innerhalb einer externen Datenquelle für die Spalte an, deren -Index durch den[`Column`](../column/)property. Der Standardwert ist eine leere Zeichenfolge.
