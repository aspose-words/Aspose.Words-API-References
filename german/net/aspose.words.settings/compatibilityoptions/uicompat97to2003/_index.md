...
description: Optimieren Sie Ihre Benutzeroberfläche mit der Einstellung „CompatibilityOptions UICompat97To2003“. Deaktivieren Sie nicht kompatible Funktionen für eine reibungslose Nutzung von Word 97 bis 2003. Verbessern Sie noch heute die Leistung!
type: docs
weight: 570
...
True, um die UI-Funktionalität zu deaktivieren, die nicht mit Word97-2003 kompatibel ist. Der Standardwert ist`FALSCH` .
...
Steuert die Word97-2003-Kompatibilitätseinstellung, die UI-Funktionalität deaktiviert, die nicht mit Word97-2003 kompatibel ist. Wenn`WAHR` 'w:uiCompat97To2003' XML-Element wird in '\word\settings.xml' Dokumentpaketteil geschrieben. Standardwert ist`FALSCH` Wenn eingestellt auf`FALSCH` , dieses Element wird nicht geschrieben. Technisch gesehen ist diese Eigenschaft nicht Teil der Kompatibilitätsoptionen, aber wir haben sie aus Gründen der API-Vereinfachung hier eingefügt.
