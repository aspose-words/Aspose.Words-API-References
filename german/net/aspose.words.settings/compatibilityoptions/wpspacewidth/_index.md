...
description: Entdecken Sie, wie Sie mit der WPSpaceWidth-Eigenschaft von CompatibilityOptions die Leerzeichenbreite wie in WordPerfect 5.x anpassen können, um die Dokumentformatierung zu verbessern.
type: docs
weight: 700
...
Gibt an, ob die Breite eines Zwischenraums wie in WordPerfect 5.x festgelegt werden soll.
