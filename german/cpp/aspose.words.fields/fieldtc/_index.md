---
title: "Aspose::Words::Fields::FieldTC Klasse"
linktitle: "FieldTC"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldTC Klasse. Implementiert das TC-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 100000
url: /de/cpp/aspose.words.fields/fieldtc/
---
## FieldTC class


Implementiert das TC-Feld. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_EntryLevel](./get_entrylevel/)() | Liefert die Ebene des Eintrags. |
...
| [get_OmitPageNumber](./get_omitpagenumber/)() override | Liefert, ob die Seitenzahl im Inhaltsverzeichnis für dieses Feld weggelassen werden soll. |
...
| [get_Text](./get_text/)() | Liefert den Text des Eintrags. |
| virtual [get_Type](../field/get_type/)() const | Liefert den Microsoft‑Word-Feldtyp. |
| [get_TypeIdentifier](./get_typeidentifier/)() | Liefert einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist). |
...
| [set_EntryLevel](./set_entrylevel/)(const System::String\&) | Setzt die Ebene des Eintrags. |
...
| [set_OmitPageNumber](./set_omitpagenumber/)(bool) | Setzt, ob die Seitenzahl im Inhaltsverzeichnis für dieses Feld weggelassen werden soll. |
| [set_Result](../field/set_result/)(const System::String\&) | Setter für [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_Text](./set_text/)(const System::String\&) | Setzt den Text des Eintrags. |
| [set_TypeIdentifier](./set_typeidentifier/)(const System::String\&) | Setzt einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist). |
| static [Type](./type/)() |  |
