---
title: "Aspose::Words::Fields::FieldAdvance::get_VerticalPosition Methode"
linktitle: "get_VerticalPosition"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldAdvance::get_VerticalPosition Methode. Gibt die Anzahl der Punkte zurück oder legt sie fest, um die der Text, der dem Feld folgt, vertikal vom oberen Rand der Seite in C++ verschoben werden soll."
type: docs
weight: 7000
url: /de/cpp/aspose.words.fields/fieldadvance/get_verticalposition/
---
## FieldAdvance::get_VerticalPosition method


Liest oder legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, vertikal vom oberen Rand der Seite verschoben werden soll.
