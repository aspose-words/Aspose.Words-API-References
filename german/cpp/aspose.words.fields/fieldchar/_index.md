---
title: "Aspose::Words::Fields::FieldChar Klasse"
linktitle: "FieldChar"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldChar Klasse. Basisklasse für Knoten, die Feldzeichen in einem Dokument darstellen. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 21000
url: /de/cpp/aspose.words.fields/fieldchar/
---
## FieldChar class


Basisklasse für Knoten, die Feldzeichen in einem Dokument darstellen. Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| --- | --- |
| [Accept](../../aspose.words/specialchar/accept/)(System::SharedPtr\<Aspose::Words::DocumentVisitor\>) override | Akzeptiert einen Besucher. |
...
| [get_FieldType](./get_fieldtype/)() const | Gibt den Typ des Feldes zurück. |
...
| [get_IsDirty](./get_isdirty/)() const | Liefert oder setzt, ob das aktuelle Ergebnis des Feldes aufgrund anderer Änderungen am Dokument nicht mehr korrekt (veraltet) ist. |
...
| [get_IsLocked](./get_islocked/)() const | Liest oder setzt, ob das übergeordnete Feld gesperrt ist (sollte sein Ergebnis nicht neu berechnen). |
...
| [get_NodeType](../../aspose.words/specialchar/get_nodetype/)() const override | Gibt zurück [SpecialChar](../../aspose.words/nodetype/). |
...
| [set_IsDirty](./set_isdirty/)(bool) | Setter für [Aspose::Words::Fields::FieldChar::get_IsDirty](./get_isdirty/). |
| [set_IsLocked](./set_islocked/)(bool) | Setter für [Aspose::Words::Fields::FieldChar::get_IsLocked](./get_islocked/). |
