---
title: "Aspose::Words::Fields::FieldRD Klasse"
linktitle: "FieldRD"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldRD Klasse. Implementiert das RD-Feld. Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel in C++."
type: docs
weight: 84000
url: /de/cpp/aspose.words.fields/fieldrd/
---
## FieldRD class


Implementiert das RD-Feld. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_FileName](./get_filename/)() | Ruft den Namen der Datei ab oder legt ihn fest, die beim Erstellen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes einzuschließen ist. |
...
| [get_IsPathRelative](./get_ispathrelative/)() | Ruft ab, ob der Pfad relativ zum aktuellen Dokument ist, oder legt dies fest. |
...
| [set_FileName](./set_filename/)(const System::String\&) | Setter für [Aspose::Words::Fields::FieldRD::get_FileName](./get_filename/). |
...
| [set_IsPathRelative](./set_ispathrelative/)(bool) | Setter für [Aspose::Words::Fields::FieldRD::get_IsPathRelative](./get_ispathrelative/). |
