...
description: "Aspose::Words::Fields::FieldData class. Implementiert das DATA-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 27000
url: /de/cpp/aspose.words.fields/fielddata/
---
## FieldData class


Implementiert das DATA‑Feld. Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
