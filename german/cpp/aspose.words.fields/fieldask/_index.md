...
description: "Aspose::Words::Fields::FieldAsk Klasse. Implementiert das ASK-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 10000
url: /de/cpp/aspose.words.fields/fieldask/
---
## FieldAsk class


Implementiert das ASK‑Feld. Weitere Informationen finden Sie im Dokumentationsartikel [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| [get_DefaultResponse](./get_defaultresponse/)() | Ermittelt die Standardbenutzerantwort (der im Eingabeaufforderungsfenster enthaltene Anfangswert). |
...
| [get_PromptOnceOnMailMerge](./get_promptonceonmailmerge/)() | Ermittelt, ob die Benutzerantwort nur einmal pro Seriendruckvorgang empfangen werden soll. |
| [get_PromptText](./get_prompttext/)() | Ermittelt den Eingabetext (den Titel des Eingabeaufforderungsfensters). |
...
| [set_DefaultResponse](./set_defaultresponse/)(const System::String\&) | Setzt die Standardbenutzerantwort (der im Eingabeaufforderungsfenster enthaltene Anfangswert). |
...
| [set_PromptOnceOnMailMerge](./set_promptonceonmailmerge/)(bool) | Legt fest, ob die Benutzerantwort nur einmal pro Seriendruckvorgang empfangen werden soll. |
| [set_PromptText](./set_prompttext/)(const System::String\&) | Setzt den Eingabetext (den Titel des Eingabeaufforderungsfensters). |
