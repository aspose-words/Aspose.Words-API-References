---
title: "Aspose::Words::Fields::FieldAutoNumLgl Klasse"
linktitle: "FieldAutoNumLgl"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldAutoNumLgl Klasse. Implementiert das AUTONUMLGL-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 13000
url: /de/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


Implementiert das AUTONUMLGL‑Feld. Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | Ermittelt, ob die Zahl ohne abschließenden Punkt angezeigt wird. |
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | Ermittelt das zu verwendende Trennzeichen. |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | Legt fest, ob die Zahl ohne abschließenden Punkt angezeigt wird. |
| [set_Result](../field/set_result/)(const System::String\&) | Setter für [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | Legt das zu verwendende Trennzeichen fest. |
| static [Type](./type/)() |  |
