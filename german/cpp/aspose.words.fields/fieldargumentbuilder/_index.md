---
title: "Aspose::Words::Fields::FieldArgumentBuilder Klasse"
linktitle: "FieldArgumentBuilder"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldArgumentBuilder Klasse. Erstellt ein komplexes Feldargument, das aus Feldern, Knoten und einfachem Text besteht. Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel in C++."
type: docs
weight: 9000
url: /de/cpp/aspose.words.fields/fieldargumentbuilder/
---
## FieldArgumentBuilder class


Erstellt ein komplexes Feldargument, das aus Feldern, Knoten und einfachem Text besteht. Weitere Informationen finden Sie im Dokumentationsartikel [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/).
...
| --- | --- |
| [AddField](./addfield/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Fügt dem Argument ein Feld hinzu, das durch einen [FieldBuilder](../fieldbuilder/) dargestellt wird. |
| [AddNode](./addnode/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Fügt dem Argument einen Knoten hinzu. |
| [AddText](./addtext/)(const System::String\&) | Fügt dem Argument einen einfachen Text hinzu. |
| [FieldArgumentBuilder](./fieldargumentbuilder/)() | Initialisiert eine Instanz der [FieldArgumentBuilder](./) Klasse. |
