---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle Methode"
linktitle: "get_PosCodeStyle"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle Methode. Liest oder setzt den Stil eines Point-of-Sale-Barcodes (Barcode-Typen UPCA|UPCE|EAN13|EAN8). Die gültigen Werte (Groß-/Kleinschreibung ignorierend) sind [STD|SUP2|SUP5|CASE] in C++."
type: docs
weight: 11000
url: /de/cpp/aspose.words.fields/fielddisplaybarcode/get_poscodestyle/
---
## FieldDisplayBarcode::get_PosCodeStyle method


Liest oder setzt den Stil eines Point-of-Sale-Barcodes (Barcode-Typen UPCA|UPCE|EAN13|EAN8). Die gültigen Werte (Groß-/Kleinschreibung ignorierend) sind [STD|SUP2|SUP5|CASE].
