---
title: "Aspose::Words::Fields::FieldGoToButton Klasse"
linktitle: "FieldGoToButton"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldGoToButton Klasse. Implementiert das GOTOBUTTON-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 51000
url: /de/cpp/aspose.words.fields/fieldgotobutton/
---
## FieldGoToButton class


Implementiert das GOTOBUTTON-Feld. Weitere Informationen finden Sie im [Arbeiten mit Feldern](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_DisplayText](./get_displaytext/)() | Liest oder setzt den Text der \"button\", die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren. |
...
| [get_Location](./get_location/)() | Liest oder setzt den Namen eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll. |
...
| [set_DisplayText](./set_displaytext/)(const System::String\&) | Setter für [Aspose::Words::Fields::FieldGoToButton::get_DisplayText](./get_displaytext/). |
...
| [set_Location](./set_location/)(const System::String\&) | Setter für [Aspose::Words::Fields::FieldGoToButton::get_Location](./get_location/). |
