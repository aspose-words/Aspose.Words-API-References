---
title: "Aspose::Words::Fields::FieldMergeField Klasse"
linktitle: "FieldMergeField"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldMergeField Klasse. Implementiert das MERGEFIELD-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 67000
url: /de/cpp/aspose.words.fields/fieldmergefield/
---
## FieldMergeField class


Implementiert das MERGEFIELD-Feld. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_FieldName](./get_fieldname/)() | Liefert den Namen eines Datenfelds. |
| [get_FieldNameNoPrefix](./get_fieldnamenoprefix/)() const | Gibt nur den Namen des Datenfelds zurück. Jegliches Präfix wird von der Präfix‑Eigenschaft entfernt. |
...
| [get_IsMapped](./get_ismapped/)() | Liefert, ob dieses Feld ein zugeordnetes Feld ist. |
| [get_IsVerticalFormatting](./get_isverticalformatting/)() | Liefert, ob die Zeichenkonvertierung für vertikale Formatierung aktiviert werden soll. |
...
| [get_TextAfter](./get_textafter/)() | Ermittelt den Text, der nach dem Feld eingefügt wird, wenn das Feld nicht leer ist. |
| [get_TextBefore](./get_textbefore/)() | Ermittelt den Text, der vor dem Feld eingefügt wird, wenn das Feld nicht leer ist. |
| [get_Type](./get_type/)() const override | Liefert den Microsoft‑Word-Feldtyp. |
...
| [set_FieldName](./set_fieldname/)(const System::String\&) | Legt den Namen eines Datenfelds fest. |
...
| [set_IsMapped](./set_ismapped/)(bool) | Legt fest, ob dieses Feld ein zugeordnetes Feld ist. |
| [set_IsVerticalFormatting](./set_isverticalformatting/)(bool) | Legt fest, ob die Zeichenkonvertierung für vertikale Formatierung aktiviert werden soll. |
...
| [set_TextAfter](./set_textafter/)(const System::String\&) | Legt den Text fest, der nach dem Feld eingefügt wird, wenn das Feld nicht leer ist. |
| [set_TextBefore](./set_textbefore/)(const System::String\&) | Legt den Text fest, der vor dem Feld eingefügt wird, wenn das Feld nicht leer ist. |
| static [Type](./type/)() |  |
