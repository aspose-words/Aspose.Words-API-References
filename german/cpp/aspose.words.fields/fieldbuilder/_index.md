---
title: "Klasse Aspose::Words::Fields::FieldBuilder"
linktitle: "FieldBuilder"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Klasse Aspose::Words::Fields::FieldBuilder. Erstellt ein Feld aus Feldcode‑Token (Argumente und Schalter). Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 20000
url: /de/cpp/aspose.words.fields/fieldbuilder/
---
## FieldBuilder class


Erstellt ein Feld aus Feldcode‑Token (Argumente und Schalter). Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| --- | --- |
| [AddArgument](./addargument/)(const System::String\&) | Fügt ein Argument zum Feld hinzu. |
| [AddArgument](./addargument/)(int32_t) | Fügt ein Argument zum Feld hinzu. |
| [AddArgument](./addargument/)(double) | Fügt ein Argument zum Feld hinzu. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | Fügt ein untergeordnetes Feld, das durch einen anderen [FieldBuilder](./) dargestellt wird, zum Feldcode hinzu. |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldArgumentBuilder\>\&) | Fügt ein Feldargument, das durch [FieldArgumentBuilder](../fieldargumentbuilder/) dargestellt wird, zum Feldcode hinzu. |
| [AddSwitch](./addswitch/)(const System::String\&) | Fügt einen Schalter zum Feld hinzu. |
| [AddSwitch](./addswitch/)(const System::String\&, const System::String\&) | Fügt einen Schalter zum Feld hinzu. |
| [AddSwitch](./addswitch/)(const System::String\&, int32_t) | Fügt einen Schalter zum Feld hinzu. |
| [AddSwitch](./addswitch/)(const System::String\&, double) | Fügt einen Schalter zum Feld hinzu. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | Erstellt und fügt ein Feld in das Dokument ein, bevor der angegebene Inline‑Knoten eingefügt wird. |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Paragraph\>\&) | Erstellt und fügt ein Feld am Ende des angegebenen Absatzes in das Dokument ein. |
| [FieldBuilder](./fieldbuilder/)(Aspose::Words::Fields::FieldType) | Initialisiert eine Instanz der [FieldBuilder](./)-Klasse. |
