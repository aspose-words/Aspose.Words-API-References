...
description: "Aspose::Words::Fields::FieldIncludePicture class. Implementiert das INCLUDEPICTURE‑Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 57000
url: /de/cpp/aspose.words.fields/fieldincludepicture/
---
## FieldIncludePicture class


Implementiert das INCLUDEPICTURE-Feld. Weitere Informationen finden Sie im [Arbeiten mit Feldern](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_GraphicFilter](./get_graphicfilter/)() | Ermittelt oder legt den Namen des Filters für das Format der einzufügenden Grafik fest. |
...
| [get_IsLinked](./get_islinked/)() override | Ermittelt oder legt fest, ob die Dateigröße reduziert werden soll, indem Grafikdaten nicht im Dokument gespeichert werden. |
...
| [get_ResizeHorizontally](./get_resizehorizontally/)() | Ermittelt oder legt fest, ob das Bild horizontal von der Quelle skaliert werden soll. |
| [get_ResizeVertically](./get_resizevertically/)() | Ermittelt oder legt fest, ob das Bild vertikal von der Quelle skaliert werden soll. |
...
| [get_SourceFullName](./get_sourcefullname/)() override | Liest oder setzt den Speicherort des Bildes mittels einer IRI. |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | Setzer für [Aspose::Words::Fields::FieldIncludePicture::get_GraphicFilter](./get_graphicfilter/). |
| [set_IsDirty](../field/set_isdirty/)(bool) | Setter für [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/). |
| [set_IsLinked](./set_islinked/)(bool) | Setzer für [Aspose::Words::Fields::FieldIncludePicture::get_IsLinked](./get_islinked/). |
...
| [set_ResizeHorizontally](./set_resizehorizontally/)(bool) | Setzer für [Aspose::Words::Fields::FieldIncludePicture::get_ResizeHorizontally](./get_resizehorizontally/). |
| [set_ResizeVertically](./set_resizevertically/)(bool) | Setzer für [Aspose::Words::Fields::FieldIncludePicture::get_ResizeVertically](./get_resizevertically/). |
| [set_Result](../field/set_result/)(const System::String\&) | Setter für [Aspose::Words::Fields::Field::get_Result](../field/get_result/). |
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | Setzer für [Aspose::Words::Fields::FieldIncludePicture::get_SourceFullName](./get_sourcefullname/). |
| static [Type](./type/)() |  |
