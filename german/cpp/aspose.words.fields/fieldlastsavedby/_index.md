---
title: "Aspose::Words::Fields::FieldLastSavedBy Klasse"
linktitle: "FieldLastSavedBy"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldLastSavedBy Klasse. Implementiert das LASTSAVEDBY-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 62000
url: /de/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


Implementiert das LASTSAVEDBY-Feld. Weitere Informationen finden Sie im [Arbeiten mit Feldern](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
Zeigt, wie man das LASTSAVEDBY-Feld verwendet.
```cpp
...
// Wenn wir ein Dokument programmgesteuert erstellen, ist diese Eigenschaft null und wir müssen ihr einen Wert zuweisen.
doc->get_BuiltInDocumentProperties()->set_LastSavedBy(u"John Doe");

// Wir können das LASTSAVEDBY-Feld verwenden, um den Wert dieser Eigenschaft im Dokument anzuzeigen.
