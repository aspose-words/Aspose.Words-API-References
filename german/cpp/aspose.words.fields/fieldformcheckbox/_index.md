---
title: "Aspose::Words::Fields::FieldFormCheckBox Klasse"
linktitle: "FieldFormCheckBox"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldFormCheckBox Klasse. Implementiert das FORMCHECKBOX-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 46000
url: /de/cpp/aspose.words.fields/fieldformcheckbox/
---
## FieldFormCheckBox class


Implementiert das FORMCHECKBOX-Feld. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
Zeigt, wie man die Felder FORMCHECKBOX, FORMDROPDOWN und FORMTEXT verarbeitet.
```cpp
// Diese Felder sind Legacy-Entsprechungen des FormField. Wir können sie lesen, aber nicht mit Aspose.Words erstellen.
// In Microsoft Word können wir diese Felder über das Menü Legacy Tools im Register Entwickler einfügen.
