---
title: "Aspose::Words::Fields::FieldAutoTextList Klasse"
linktitle: "FieldAutoTextList"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldAutoTextList Klasse. Implementiert das AUTOTEXTLIST-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 16000
url: /de/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


Implementiert das AUTOTEXTLIST‑Feld. Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_EntryName](./get_entryname/)() | Liefert den Namen des AutoText‑Eintrags. |
...
| [get_ListStyle](./get_liststyle/)() | Liefert den Namen des Stils, auf dem die Liste mit Einträgen basiert. |
...
| [get_ScreenTip](./get_screentip/)() | Liefert den Text des anzuzeigenden ScreenTips. |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | Setzt den Namen des AutoText‑Eintrags. |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | Setzt den Namen des Stils, auf dem die Liste mit Einträgen basiert. |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | Setzt den Text des anzuzeigenden ScreenTips. |
| static [Type](./type/)() |  |
