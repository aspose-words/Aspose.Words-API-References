---
title: "Aspose::Words::Fields::FieldEditTime Klasse"
linktitle: "FieldEditTime"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldEditTime Klasse. Implementiert das EDITTIME-Feld. Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel in C++."
type: docs
weight: 37000
url: /de/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


Implementiert das EDITTIME-Feld. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
// Das EDITTIME-Feld zeigt, in Minuten,
// die Zeit, die das Dokument in einem Microsoft Word-Fenster geöffnet war.
...
// um die Zeit zu verfolgen, die das Dokument geöffnet war. Wir können sie auch selbst bearbeiten.
...
// Das Feld aktualisiert sich nicht in Echtzeit und muss außerdem
// manuell in Microsoft Word aktualisiert werden, wann immer wir einen genauen Wert benötigen.
doc->UpdateFields();
