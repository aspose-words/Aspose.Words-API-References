---
title: "Aspose::Words::Fields::FieldFormat Klasse"
linktitle: "FieldFormat"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldFormat Klasse. Bietet typisierten Zugriff auf field''s numerische, datums- und zeitbezogene sowie allgemeine Formatierung. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 45000
url: /de/cpp/aspose.words.fields/fieldformat/
---
## FieldFormat class


Stellt typisierten Zugriff auf numerische, Datums- und Zeit- sowie allgemeine Formatierung des Feldes bereit. Weitere Informationen finden Sie im [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| --- | --- |
| [get_DateTimeFormat](./get_datetimeformat/)() | Liest oder setzt eine Formatierung, die auf das Ergebnis eines Datums‑ und Zeitfeldes angewendet wird. Entspricht dem \@‑Schalter. |
| [get_GeneralFormats](./get_generalformats/)() | Liest eine Sammlung allgemeiner Formate, die auf das Ergebnis eines numerischen, Text‑ oder beliebigen Feldes angewendet werden. Entspricht den \*‑Schaltern. |
| [get_NumericFormat](./get_numericformat/)() | Liest oder setzt eine Formatierung, die auf das Ergebnis eines numerischen Feldes angewendet wird. Entspricht dem \#‑Schalter. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DateTimeFormat](./set_datetimeformat/)(const System::String\&) | Setter für [Aspose::Words::Fields::FieldFormat::get_DateTimeFormat](./get_datetimeformat/). |
| [set_NumericFormat](./set_numericformat/)(const System::String\&) | Setter für [Aspose::Words::Fields::FieldFormat::get_NumericFormat](./get_numericformat/). |
| static [Type](./type/)() |  |
