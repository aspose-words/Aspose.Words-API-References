---
title: "Aspose::Words::Fields::FieldType Aufzählung"
linktitle: "FieldType"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Fields::FieldType Aufzählung. Gibt die Feldtypen von Microsoft Word in C++ an."
type: docs
weight: 130000
url: /de/cpp/aspose.words.fields/fieldtype/
---
## FieldType enum


Gibt die Feldtypen von Microsoft Word an.
...
| --- | --- | --- |
| FieldNone | 0 | [Field](../field/) Typ ist nicht angegeben oder unbekannt. |
| FieldCannotParse | 1 | Gibt an, dass das Feld nicht geparst werden konnte. |
...
| FieldComments | 19 | Gibt das COMMENTS-Feld an. |
...
| FieldFormula | 34 | Gibt das = (Formel)-Feld an. |
| FieldGreetingLine | 94 | Gibt das GREETINGLINE-Feld an. |
| FieldGlossary | 47 | Gibt das GLOSSARY-Feld an. |
...
| FieldKeyword | 18 | Gibt das KEYWORDS-Feld an. |
| FieldLastSavedBy | 20 | Gibt das LASTSAVEDBY-Feld an. |
...
| FieldNumWords | 27 | Gibt das NUMWORDS-Feld an. |
| FieldOcx | 87 | Gibt das OCX-Feld an. Normalerweise stellt Aspose.Words ein ActiveX-Steuerelement als ein [Shape](../../aspose.words.drawing/shape/)‑Objekt dar, aber bei einigen Dokumenten, bei denen ein Steuerelement keine Daten hat und/oder ungültig zu sein scheint, wird es als Feld dargestellt. |
