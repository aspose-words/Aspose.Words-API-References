...
description: "Aspose::Words::Fields::FieldBibliography class. Implementiert das BIBLIOGRAPHY-Feld. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 18000
url: /de/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


Implementiert das BIBLIOGRAPHY‑Feld. Um mehr zu erfahren, besuchen Sie den [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) Dokumentationsartikel.
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | Liest die Sprach-ID, die verwendet wird, um die bibliografischen Daten zu filtern, sodass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden. |
...
| [get_FormatLanguageId](./get_formatlanguageid/)() | Liest die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren. |
...
| [get_SourceTag](./get_sourcetag/)() | Liest einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert im Literaturverzeichnis angezeigt werden. |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Daten zu filtern, sodass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden. |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren. |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | Setzt einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert im Literaturverzeichnis angezeigt werden. |
| static [Type](./type/)() |  |
