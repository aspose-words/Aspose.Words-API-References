...
description: "Aspose::Words::Fields::FieldIfComparisonResult enum. Gibt das Ergebnis der Auswertung der IF-Feldbedingung in C++ an."
type: docs
weight: 128000
url: /de/cpp/aspose.words.fields/fieldifcomparisonresult/
---
## FieldIfComparisonResult enum


Gibt das Ergebnis der Auswertung der IF-Feldbedingung an.
...
| --- | --- | --- |
| Fehler | 0 | In der Bedingung ist ein Fehler aufgetreten. |
| Wahr | 1 | Die Bedingung ist **true**. |
| Falsch | 2 | Die Bedingung ist **false**. |
