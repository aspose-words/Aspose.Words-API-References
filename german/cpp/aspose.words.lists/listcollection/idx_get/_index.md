...
description: "Aspose::Words::Lists::ListCollection::idx_get Methode. Gibt eine Liste nach Index in C++ zurück."
type: docs
weight: 13000
url: /de/cpp/aspose.words.lists/listcollection/idx_get/
---
## ListCollection::idx_get method


Ermittelt eine Liste anhand des Index.
...
Zeigt, wie die Listformatierung einer vorhandenen Liste auf eine Sammlung von Absätzen angewendet wird.
```cpp
