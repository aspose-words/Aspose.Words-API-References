---
title: "Aspose::Words::Lists::ListFormat::RemoveNumbers Methode"
linktitle: "RemoveNumbers"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Lists::ListFormat::RemoveNumbers Methode. Entfernt Zahlen oder Aufzählungszeichen aus dem aktuellen Absatz und setzt die Listenebene auf Null in C++."
type: docs
weight: 12000
url: /de/cpp/aspose.words.lists/listformat/removenumbers/
---
...
Der Aufruf dieser Methode ist gleichbedeutend mit dem Setzen der [List](../get_list/) Eigenschaft auf **null**.
...
Zeigt, wie die Listformatierung aus allen Absätzen im Haupttext eines Abschnitts entfernt wird.
```cpp
auto doc = System::MakeObject<Aspose::Words::Document>();
auto builder = System::MakeObject<Aspose::Words::DocumentBuilder>(doc);
