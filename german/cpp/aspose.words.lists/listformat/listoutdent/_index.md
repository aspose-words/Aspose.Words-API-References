---
title: "Aspose::Words::Lists::ListFormat::ListOutdent Methode"
linktitle: "ListOutdent"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Lists::ListFormat::ListOutdent Methode. Verringert die Listenebene des aktuellen Absatzes um eine Ebene in C++."
type: docs
weight: 11000
url: /de/cpp/aspose.words.lists/listformat/listoutdent/
---
...
Diese Methode ändert die Listentiefe und wendet die Formatierungseigenschaften der neuen Ebene an.

In Word-Dokumenten können Listen bis zu neun Ebenen umfassen. Die [List](../../list/)‑Formatierung für jede Ebene legt fest, welches Aufzählungszeichen oder welche Nummer verwendet wird, die linke Einrückung, den Abstand zwischen Aufzählungszeichen und Text usw.
