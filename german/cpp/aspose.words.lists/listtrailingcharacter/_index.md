...
description: "Aspose::Words::Lists::ListTrailingCharacter‑Enum. Gibt das Zeichen an, das das Listenelement vom Text des Absatzes in C++ trennt."
type: docs
weight: 9000
url: /de/cpp/aspose.words.lists/listtrailingcharacter/
---
## ListTrailingCharacter enum


Gibt das Zeichen an, das das Listenelement vom Text des Absatzes trennt.
...
| --- | --- | --- |
| Tab | 0 | Ein Tab‑Zeichen wird zwischen dem Listenelement und dem Text des Absatzes eingefügt. |
| Leerzeichen | 1 | Ein Leerzeichen wird zwischen dem Listenelement und dem Text des Absatzes eingefügt. |
| Nichts | 2 | Es gibt kein Trennzeichen zwischen dem Listenelement und dem Text des Absatzes. |

## Hinweise


Wird als Wert für die Eigenschaft [TrailingCharacter](../listlevel/get_trailingcharacter/) verwendet.
