---
title: "Aspose::Words::Lists::List::get_IsListStyleDefinition Methode"
linktitle: "get_IsListStyleDefinition"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition Methode. Gibt true zurück, wenn diese Liste eine Definition eines Liststyles in C++ ist."
type: docs
weight: 5000
url: /de/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
## List::get_IsListStyleDefinition method


Gibt **true** zurück, wenn diese Liste eine Definition eines Listenstils ist.
...
Wenn diese Eigenschaft **true** ist, gibt die [Style](../get_style/) Eigenschaft den Liststil zurück, den diese Liste definiert.

Durch Ändern der Eigenschaften einer Liste, die einen Liststil definiert, ändern Sie die Eigenschaften des Liststils.

Eine Liste, die eine Definition eines Liststils ist, kann nicht direkt auf Absätze angewendet werden, um sie zu nummerieren.
