...
description: "Aspose::Words::Lists::List::get_ListLevels method. Gibt die Sammlung von Listenebenen für diese Liste in C++ zurück."
type: docs
weight: 10000
url: /de/cpp/aspose.words.lists/list/get_listlevels/
---
## List::get_ListLevels method


Ermittelt die Sammlung der Listenebenen für diese Liste.
...
Verwenden Sie diese Eigenschaft, um auf die Formatierung jeder einzelnen Ebene der Liste zuzugreifen und sie zu ändern.
