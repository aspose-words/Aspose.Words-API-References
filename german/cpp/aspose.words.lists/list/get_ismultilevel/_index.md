...
description: "Aspose::Words::Lists::List::get_IsMultiLevel method. Gibt true zurück, wenn die Liste 9 Ebenen enthält; false, wenn sie 1 Ebene hat in C++."
type: docs
weight: 7000
url: /de/cpp/aspose.words.lists/list/get_ismultilevel/
---
## List::get_IsMultiLevel method


Gibt **true** zurück, wenn die Liste 9 Ebenen enthält; **false**, wenn sie 1 Ebene enthält.
...
Microsoft Word 2003 und neuere Versionen erstellen immer mehrstufige Listen mit 9 Ebenen. In einigen Dokumenten, die mit früheren Versionen von Microsoft Word erstellt wurden, können jedoch Listen vorkommen, die nur 1 Ebene haben.
