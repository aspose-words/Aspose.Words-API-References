...
description: "Aspose::Words::Notes::Footnote::Footnote Konstruktor. Initialisiert eine Instanz der Footnote‑Klasse in C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words.notes/footnote/footnote/
---
## Footnote::Footnote constructor


Initialisiert eine Instanz der [Footnote](../)‑Klasse.
...
| footnoteType | Aspose::Words::Notes::FootnoteType | Ein [FootnoteType](../get_footnotetype/)‑Wert, der angibt, ob es sich um eine Fußnote oder Endnote handelt. |
## Hinweise


Wenn [Footnote](../) erstellt wird, gehört sie zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und [ParentNode](../../../aspose.words/node/get_parentnode/) ist **null**.

Um [Footnote](../) an das Dokument anzuhängen, verwenden Sie[InsertAfter1()</see> oder <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\>, System::SharedPtr\<Aspose::Words::Node\>)\">InsertBefore1()](../) im Absatz, in dem Sie die Fußnote einfügen möchten.
