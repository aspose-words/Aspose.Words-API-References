---
title: "Aspose::Words::HeaderFooterCollection::LinkToPrevious Methode"
linktitle: "LinkToPrevious"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::HeaderFooterCollection::LinkToPrevious Methode. Verknüpft oder löst die angegebene Kopf- oder Fußzeile mit der entsprechenden Kopf- oder Fußzeile im vorherigen Abschnitt in C++."
type: docs
weight: 5000
url: /de/cpp/aspose.words/headerfootercollection/linktoprevious/
---
## HeaderFooterCollection::LinkToPrevious(Aspose::Words::HeaderFooterType, bool) method


Verknüpft oder löst die angegebene Kopf- oder Fußzeile mit der entsprechenden Kopf- oder Fußzeile im vorherigen Abschnitt.
...
| --- | --- | --- |
| headerFooterType | Aspose::Words::HeaderFooterType | Ein [HeaderFooterType](../../headerfootertype/) Wert, der die zu verknüpfende/zu lösendende Kopf- oder Fußzeile angibt. |
| isLinkToPrevious | bool | **true** um die Kopf- oder Fußzeile mit dem vorherigen Abschnitt zu verknüpfen; **false** zum Trennen. |
## Hinweise


Falls die Kopf- oder Fußzeile des angegebenen Typs nicht existiert, wird sie automatisch erstellt.
...
Verknüpft oder löst alle Kopf- und Fußzeilen mit den entsprechenden Kopf- und Fußzeilen im vorherigen Abschnitt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| isLinkToPrevious | bool | **true** um die Kopf- und Fußzeilen mit dem vorherigen Abschnitt zu verknüpfen; **false** um sie zu trennen. |
## Hinweise


Falls eine der Kopf- oder Fußzeilen nicht existiert, werden sie automatisch erstellt.
