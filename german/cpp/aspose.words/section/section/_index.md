---
title: "Aspose::Words::Section::Section Konstruktor"
linktitle: "Abschnitt"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Section::Section Konstruktor. Initialisiert eine neue Instanz der Section-Klasse in C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words/section/section/
---
...
Wenn der Abschnitt erstellt wird, gehört er zum angegebenen Dokument, ist aber noch nicht Teil des Dokuments und [ParentNode](../../node/get_parentnode/) ist **null**.

Um [Section](../) in ein Dokument einzufügen, verwenden Sie die Methoden [InsertAfter1()</see> und <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../) des [Document](../../document/) ODER die Methoden [Add()](../) und [Insert()](../) der Eigenschaft [Sections](../../document/get_sections/).
