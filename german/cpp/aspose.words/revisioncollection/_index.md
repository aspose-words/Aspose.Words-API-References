...
description: "Aspose::Words::RevisionCollection class. Eine Sammlung von Revision‑Objekten, die Änderungen im Dokument darstellen. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 53000
url: /de/cpp/aspose.words/revisioncollection/
---
## RevisionCollection class


Eine Sammlung von [Revision](../revision/)-Objekten, die Änderungen im Dokument darstellen. Weitere Informationen finden Sie im Dokumentationsartikel [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/).
...
| --- | --- |
| [Accept](./accept/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Akzeptiert Revisionen, die den angegebenen Kriterien entsprechen. |
| [AcceptAll](./acceptall/)() | Akzeptiert alle Revisionen in dieser Sammlung. |
| [get_Count](./get_count/)() | Gibt die Anzahl der Revisionen in der Sammlung zurück. |
| [get_Groups](./get_groups/)() | Sammlung von Revisionsgruppen. |
| [GetEnumerator](./getenumerator/)() override | Gibt ein Enumerator-Objekt zurück. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Gibt eine [Revision](../revision/) am angegebenen Index zurück. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | Verwirft Revisionen, die den angegebenen Kriterien entsprechen. |
| [RejectAll](./rejectall/)() | Verwirft alle Revisionen in dieser Sammlung. |
| static [Type](./type/)() |  |
## Hinweise


Sie erstellen keine Instanzen dieser Klasse direkt. Verwenden Sie die [Revisions](../document/get_revisions/) Eigenschaft, um Revisionen in einem Dokument zu erhalten.
