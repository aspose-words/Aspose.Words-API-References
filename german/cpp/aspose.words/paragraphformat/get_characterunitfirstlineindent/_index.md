---
title: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent-Methode"
linktitle: "get_CharacterUnitFirstLineIndent"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::ParagraphFormat::get_CharacterUnitFirstLineIndent-Methode. Gibt den Wert (in Zeichen) für den Erstzeilen- oder hängenden Einzug zurück oder legt ihn fest. Verwenden Sie positive Werte, um den Erstzeileneinzug festzulegen, und negative Werte, um den hängenden Einzug in C++ festzulegen."
type: docs
weight: 8000
url: /de/cpp/aspose.words/paragraphformat/get_characterunitfirstlineindent/
---
## ParagraphFormat::get_CharacterUnitFirstLineIndent method


Liest oder legt den Wert (in Zeichen) für den Erstzeileneinzug oder hängenden Einzug fest. Verwenden Sie positive Werte, um den Erstzeileneinzug festzulegen, und negative Werte, um den hängenden Einzug festzulegen.
