---
title: "Aspose::Words::EditableRangeEnd Klasse"
linktitle: "EditableRangeEnd"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::EditableRangeEnd Klasse. Stellt das Ende eines bearbeitbaren Bereichs in einem Word‑Dokument dar. Weitere Informationen finden Sie im Dokumentationsartikel in C++."
type: docs
weight: 25000
url: /de/cpp/aspose.words/editablerangeend/
---
## EditableRangeEnd class


Stellt das Ende eines bearbeitbaren Bereichs in einem Word-Dokument dar. Weitere Informationen finden Sie im Dokumentationsartikel [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/).
...
| [get_EditableRangeStart](./get_editablerangestart/)() | Entsprechendes [EditableRangeStart](../editablerangestart/), erhalten per ID. |
...
| [get_NodeType](./get_nodetype/)() const override | Gibt [EditableRangeEnd](../nodetype/) zurück. |
...
| [set_Id](./set_id/)(int32_t) | Setter für [Aspose::Words::EditableRangeEnd::get_Id](./get_id/). |
...
Ein vollständiger bearbeitbarer Bereich in einem Word‑Dokument besteht aus einem [EditableRangeStart](./get_editablerangestart/) und einem passenden [EditableRangeEnd](./) mit derselben Id.
