---
title: "Aspose::Words::FontSubstitutionWarningInfo::get_Reason Methode"
linktitle: "get_Reason"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::FontSubstitutionWarningInfo::get_Reason Methode. Grund für die Schriftartsubstitution in C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words/fontsubstitutionwarninginfo/get_reason/
---
## FontSubstitutionWarningInfo::get_Reason method


[Font](../../font/) substitution reason.

```cpp
Aspose::Words::FontSubstitutionReason Aspose::Words::FontSubstitutionWarningInfo::get_Reason() const
```
