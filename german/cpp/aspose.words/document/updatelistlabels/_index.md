...
description: "Aspose::Words::Document::UpdateListLabels-Methode. Aktualisiert Listeneinträge für alle Listenelemente im Dokument in C++."
type: docs
weight: 97000
url: /de/cpp/aspose.words/document/updatelistlabels/
---
## Document::UpdateListLabels method


Aktualisiert die Listeneinträge für alle Listenelemente im Dokument.
...
Diese Methode aktualisiert Listeneigenschaften wie [LabelValue](../../../aspose.words.lists/listlabel/get_labelvalue/) und [LabelString](../../../aspose.words.lists/listlabel/get_labelstring/) für jedes [ListLabel](../../paragraph/get_listlabel/) Objekt im Dokument.

Außerdem wird diese Methode manchmal implizit aufgerufen, wenn Felder im Dokument aktualisiert werden. Dies ist erforderlich, weil einige Felder, die Listennummern referenzieren können (wie TOC oder REF), aktuelle Werte benötigen.
