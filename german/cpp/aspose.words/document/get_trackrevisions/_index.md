---
title: "Aspose::Words::Document::get_TrackRevisions Methode"
linktitle: "get_TrackRevisions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Document::get_TrackRevisions Methode. Wahr, wenn Änderungen nachverfolgt werden, wenn dieses Dokument in Microsoft Word in C++ bearbeitet wird."
type: docs
weight: 54000
url: /de/cpp/aspose.words/document/get_trackrevisions/
---
...
Das Festlegen dieser Option weist Microsoft Word nur an, ob die Nachverfolgung von Änderungen ein- oder ausgeschaltet ist. Diese Eigenschaft hat keinen Einfluss auf Änderungen am Dokument, die Sie programmgesteuert über Aspose.Words vornehmen.

Wenn Sie Änderungen automatisch nachverfolgen möchten, während sie programmgesteuert von [Aspose.Words](../../) an diesem Dokument vorgenommen werden, verwenden Sie die Methode [StartTrackRevisions()](../).
