...
description: "Aspose::Words::FileFormatUtil::SaveFormatToExtension method. Konvertiert einen enumerierten Save-Format-Wert in eine Dateierweiterung. Die zurückgegebene Erweiterung ist ein Kleinbuchstaben-String mit einem führenden Punkt in C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words/fileformatutil/saveformattoextension/
---
## FileFormatUtil::SaveFormatToExtension method


Konvertiert einen Aufzählungswert des Speicherformats in eine Dateierweiterung. Die zurückgegebene Erweiterung ist ein kleingeschriebener String mit einem führenden Punkt.
...
Der [FlatOpc](../../saveformat/)-Wert wird in ".fopc" konvertiert.
