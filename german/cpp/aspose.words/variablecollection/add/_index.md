---
title: "Aspose::Words::VariableCollection::Add Methode"
linktitle: "Add"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::VariableCollection::Add Methode. Fügt eine Dokumentvariable zur Sammlung in C++ hinzu."
type: docs
weight: 2000
url: /de/cpp/aspose.words/variablecollection/add/
---
...
| --- | --- | --- |
| name | const System::String\& | Der case-insensitive Name der hinzuzufügenden Variable. |
| Wert | const System::String\& | Der Wert der Variable. Der Wert darf nicht **null** sein, wenn der Wert null ist, wird stattdessen ein leerer String verwendet. |
