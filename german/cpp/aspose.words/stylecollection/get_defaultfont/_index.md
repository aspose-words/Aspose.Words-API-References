...
description: "Aspose::Words::StyleCollection::get_DefaultFont-Methode. Ruft die standardmäßige Textformatierung des Dokuments in C++ ab."
type: docs
weight: 6000
url: /de/cpp/aspose.words/stylecollection/get_defaultfont/
---
## StyleCollection::get_DefaultFont method


Ermittelt die standardmäßige Textformatierung des Dokuments.
...
Beachten Sie, dass dokumentweite Vorgaben erst in Microsoft Word 2007 eingeführt wurden und nur in OOXML‑Formaten ([Docx](../../loadformat/)) vollständig unterstützt werden. Ältere Dokumentformate unterstützen diese Funktion nur eingeschränkt und können lediglich Schriftartnamen speichern.
