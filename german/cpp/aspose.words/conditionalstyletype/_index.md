...
description: "Aspose::Words::ConditionalStyleType enum. Stellt mögliche Tabellenbereiche dar, für die bedingte Formatierung in einem Tabellenstil in C++ definiert werden kann."
type: docs
weight: 85000
url: /de/cpp/aspose.words/conditionalstyletype/
---
...
| OddRowBanding | 4 | Gibt die Formatierung von ungeraden Zeilenstreifen an. |
| OddColumnBanding | 5 | Gibt die Formatierung von ungeraden Spaltenstreifen an. |
| EvenRowBanding | 6 | Gibt die Formatierung des gerade nummerierten Zeilenstreifens an. |
| EvenColumnBanding | 7 | Gibt die Formatierung des gerade nummerierten Spaltenstreifens an. |
