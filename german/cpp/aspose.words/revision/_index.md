---
title: "Aspose::Words::Revision Klasse"
linktitle: "Revision"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Revision Klasse. Stellt eine Revision (nachverfolgte Änderung) in einem Dokumentknoten oder Stil dar. Verwenden Sie RevisionType, um den Typ dieser Revision zu prüfen. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 52000
url: /de/cpp/aspose.words/revision/
---
## Revision class


Stellt eine Revision (nachverfolgte Änderung) in einem Dokumentknoten oder Stil dar. Verwenden Sie [RevisionType](./get_revisiontype/), um den Typ dieser Revision zu prüfen. Weitere Informationen finden Sie im Artikel [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/) der Dokumentation.
...
| [get_Author](./get_author/)() | Liest oder legt den Autor dieser Revision fest. Darf nicht leer sein oder **null**. |
| [get_DateTime](./get_datetime/)() | Liest oder legt das Datum/Uhrzeit dieser Revision fest. |
| [get_Group](./get_group/)() | Liest die Revisionsgruppe. Gibt **null** zurück, wenn die Revision zu keiner Gruppe gehört. |
| [get_ParentNode](./get_parentnode/)() | Liest den unmittelbaren übergeordneten Knoten (Besitzer) dieser Revision. Diese Eigenschaft funktioniert für jeden Revisionstyp außer [StyleDefinitionChange](../revisiontype/). |
| [get_ParentStyle](./get_parentstyle/)() | Liest den unmittelbaren übergeordneten Stil (Besitzer) dieser Revision. Diese Eigenschaft funktioniert nur für den Revisionstyp [StyleDefinitionChange](../revisiontype/). |
| [get_RevisionType](./get_revisiontype/)() const | Liest den Typ dieser Revision. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)() | Verwirft diese Revision. |
| [set_Author](./set_author/)(const System::String\&) | Setter für [Aspose::Words::Revision::get_Author](./get_author/). |
| [set_DateTime](./set_datetime/)(System::DateTime) | Setter für [Aspose::Words::Revision::get_DateTime](./get_datetime/). |
| static [Type](./type/)() |  |
