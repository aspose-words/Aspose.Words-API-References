...
description: "Aspose::Words::CommentRangeEnd class. Bezeichnet das Ende eines Textbereichs, dem ein Kommentar zugeordnet ist. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 13000
url: /de/cpp/aspose.words/commentrangeend/
---
## CommentRangeEnd class


Bezeichnet das Ende eines Textbereichs, dem ein Kommentar zugeordnet ist. Weitere Informationen finden Sie im Dokumentationsartikel [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/).
...
| [CommentRangeEnd](./commentrangeend/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | Initialisiert eine neue Instanz dieser Klasse. |
...
| [get_Id](./get_id/)() const | Gibt den Bezeichner des Kommentars an, mit dem dieser Bereich verknüpft ist. |
...
| [get_NodeType](./get_nodetype/)() const override | Gibt [CommentRangeEnd](../nodetype/) zurück. |
...
| [set_Id](./set_id/)(int32_t) | Gibt den Bezeichner des Kommentars an, mit dem dieser Bereich verknüpft ist. |
...
Um einen Kommentar zu erstellen, der an einen Textbereich angeheftet ist, müssen Sie ein [Comment](../comment/) erstellen und anschließend [CommentRangeStart](../commentrangestart/) und [CommentRangeEnd](./) erzeugen und deren Bezeichner auf denselben [Id](../comment/get_id/)-Wert setzen.
