...
description: "Aspose::Words::Comparing::ComparisonTargetType Enum. Ermöglicht die Angabe des Basisdokuments, das beim Vergleich verwendet wird. Der Standardwert ist Current in C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


Ermöglicht die Angabe des Basisdokuments, das beim Vergleich verwendet wird. Der Standardwert ist [Current](./).
...
| --- | --- | --- |
| Aktuell | 0 | Dieses Dokument wird als Basis beim Vergleich verwendet. |
| Neu | 1 | Ein anderes Dokument wird während des Vergleichs als Basis verwendet. |
