...
description: "Aspose::Words::WebExtensions::WebExtension class. Stellt ein Web-Extension-Objekt dar. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 4000
url: /de/cpp/aspose.words.webextensions/webextension/
---
## WebExtension class


Stellt ein Web‑Extension‑Objekt dar. Weitere Informationen finden Sie im Dokumentationsartikel [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| --- | --- |
| [get_AlternateReferences](./get_alternatereferences/)() const | Gibt alternative Verweise auf eine Web-Extension an. |
| [get_Bindings](./get_bindings/)() const | Gibt eine Liste von Web-Extension-Bindungen an. |
| [get_Id](./get_id/)() const | Identifiziert die Web-Extension-Instanz im aktuellen Dokument eindeutig. |
| [get_IsFrozen](./get_isfrozen/)() const | Gibt an, ob der Benutzer mit der Web-Extension interagieren kann oder nicht. |
| [get_Properties](./get_properties/)() const | Stellt eine Menge benutzerdefinierter Eigenschaften der Web-Extension dar. |
| [get_Reference](./get_reference/)() const | Gibt den primären Verweis auf eine Web-Extension an. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Id](./set_id/)(const System::String\&) | Setter für [Aspose::Words::WebExtensions::WebExtension::get_Id](./get_id/). |
| [set_IsFrozen](./set_isfrozen/)(bool) | Setter für [Aspose::Words::WebExtensions::WebExtension::get_IsFrozen](./get_isfrozen/). |
| static [Type](./type/)() |  |
