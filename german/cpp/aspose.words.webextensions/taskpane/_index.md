---
title: "Aspose::Words::WebExtensions::TaskPane Klasse"
linktitle: "TaskPane"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::WebExtensions::TaskPane Klasse. Stellt ein Add‑In‑Task‑Pane-Objekt dar. Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel für C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words.webextensions/taskpane/
---
## TaskPane class


Stellt ein Add‑In‑Task‑Pane‑Objekt dar. Weitere Informationen finden Sie im Dokumentationsartikel [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
...
| --- | --- |
| [get_DockState](./get_dockstate/)() const | Gibt den zuletzt angedockten Ort dieses Task‑Pane‑Objekts an. |
| [get_IsLocked](./get_islocked/)() const | Gibt an, ob das Task‑Pane in der Benutzeroberfläche an das Dokument gesperrt ist und vom Benutzer nicht geschlossen werden kann. |
| [get_IsVisible](./get_isvisible/)() const | Gibt an, ob das Task‑Pane standardmäßig sichtbar ist, wenn das Dokument geöffnet wird. |
| [get_Row](./get_row/)() const | Gibt den Index dieses Task‑Pane an, beginnend von außen nach innen, unter den anderen persistierten Task‑Panes, die am selben Standardort angedockt sind. |
| [get_WebExtension](./get_webextension/)() const | Stellt ein Web‑Extension‑Objekt dar. |
| [get_Width](./get_width/)() const | Gibt den Standardbreitenwert für diese Task‑Pane‑Instanz an. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_DockState](./set_dockstate/)(Aspose::Words::WebExtensions::TaskPaneDockState) | Setter für [Aspose::Words::WebExtensions::TaskPane::get_DockState](./get_dockstate/). |
| [set_IsLocked](./set_islocked/)(bool) | Setter für [Aspose::Words::WebExtensions::TaskPane::get_IsLocked](./get_islocked/). |
| [set_IsVisible](./set_isvisible/)(bool) | Setter für [Aspose::Words::WebExtensions::TaskPane::get_IsVisible](./get_isvisible/). |
| [set_Row](./set_row/)(int32_t) | Setter für [Aspose::Words::WebExtensions::TaskPane::get_Row](./get_row/). |
| [set_Width](./set_width/)(double) | Setter für [Aspose::Words::WebExtensions::TaskPane::get_Width](./get_width/). |
| [TaskPane](./taskpane/)() |  |
| static [Type](./type/)() |  |
