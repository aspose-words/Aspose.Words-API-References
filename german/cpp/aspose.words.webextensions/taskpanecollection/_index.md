---
title: "Aspose::Words::WebExtensions::TaskPaneCollection Klasse"
linktitle: "TaskPaneCollection"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::WebExtensions::TaskPaneCollection Klasse. Gibt eine Liste von persistierten Task-Pane-Objekten an. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 3000
url: /de/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


Gibt eine Liste von persistierten Task‑Pane‑Objekten an. Weitere Informationen finden Sie im Dokumentationsartikel [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
