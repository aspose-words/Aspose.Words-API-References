---
title: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection Klasse"
linktitle: "WebExtensionPropertyCollection"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection Klasse. Gibt eine Menge von benutzerdefinierten Web‑Extension‑Eigenschaften an. Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel für C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


Gibt eine Menge von benutzerdefinierten Eigenschaften einer Web-Extension an. Weitere Informationen finden Sie im Dokumentationsartikel [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
