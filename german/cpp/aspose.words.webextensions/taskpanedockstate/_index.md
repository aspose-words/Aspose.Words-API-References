...
description: "Aspose::Words::WebExtensions::TaskPaneDockState Enum. Listet die verfügbaren Positionen des Task‑Pane‑Objekts in C++ auf."
type: docs
weight: 11000
url: /de/cpp/aspose.words.webextensions/taskpanedockstate/
---
...
| --- | --- | --- |
| Rechts | 0 | Dockt das Task‑Pane an der rechten Seite des Dokumentfensters. |
| Links | 1 | Dockt das Task‑Pane an der linken Seite des Dokumentfensters. |
