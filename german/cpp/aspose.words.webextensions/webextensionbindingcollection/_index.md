...
description: "Aspose::Words::WebExtensions::WebExtensionBindingCollection class. Gibt eine Liste von Web-Extension-Bindungen an. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 6000
url: /de/cpp/aspose.words.webextensions/webextensionbindingcollection/
---
## WebExtensionBindingCollection class


Gibt eine Liste von Web-Extension-Bindungen an. Weitere Informationen finden Sie im Dokumentationsartikel [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/).
