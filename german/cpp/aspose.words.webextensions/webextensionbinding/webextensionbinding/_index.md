---
title: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding Konstruktor"
linktitle: "WebExtensionBinding"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding Konstruktor. Erstellt ein Web-Extension-Binding mit angegebenen Parametern in C++."
type: docs
weight: 2000
url: /de/cpp/aspose.words.webextensions/webextensionbinding/webextensionbinding/
---
## WebExtensionBinding::WebExtensionBinding constructor


Erstellt eine Web-Extension-Bindung mit den angegebenen Parametern.
...
| --- | --- | --- |
| id | const System::String\& | Binding-Identifikator. |
| bindingType | Aspose::Words::WebExtensions::WebExtensionBindingType | Binding-Typ. |
| appRef | const System::String\& | Binding-Schlüssel, der verwendet wird, um den Bindungseintrag in dieser Liste mit den gebundenen Daten im Dokument zu verknüpfen. |
