---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect Methode"
linktitle: "get_MovedToTextEffect"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect Methode. Ermöglicht die Angabe des Effekts, der auf die Bereiche angewendet wird, in die Inhalte verschoben wurden Moving. Standardwert ist DoubleUnderline in C++."
type: docs
weight: 11000
url: /de/cpp/aspose.words.layout/revisionoptions/get_movedtotexteffect/
---
## RevisionOptions::get_MovedToTextEffect method


Ermöglicht die Angabe des Effekts, der auf die Bereiche angewendet wird, in die Inhalte verschoben wurden [Moving](../../../aspose.words/revisiontype/). Standardwert ist [DoubleUnderline](../../revisiontexteffect/).
