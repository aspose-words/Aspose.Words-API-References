...
description: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect method. Ermöglicht die Angabe des Effekts, der auf den eingefügten Inhalt (Insertion) angewendet wird. Der Standardwert ist Underline in C++."
type: docs
weight: 6000
url: /de/cpp/aspose.words.layout/revisionoptions/get_insertedtexteffect/
---
## RevisionOptions::get_InsertedTextEffect method


Ermöglicht die Angabe des Effekts, der auf den eingefügten Inhalt [Insertion](../../../aspose.words/revisiontype/) angewendet wird. Der Standardwert ist [Underline](../../revisiontexteffect/).
