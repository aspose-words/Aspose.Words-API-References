---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor Methode"
linktitle: "get_MovedFromTextColor"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor Methode. Ermöglicht die Angabe der Farbe, die für Bereiche verwendet wird, aus denen Inhalt verschoben wurde Moving. Standardwert ist ByAuthor in C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


Ermöglicht die Angabe der Farbe, die für Bereiche verwendet wird, aus denen Inhalt verschoben wurde [Moving](../../../aspose.words/revisiontype/). Standardwert ist [ByAuthor](../../revisioncolor/).
