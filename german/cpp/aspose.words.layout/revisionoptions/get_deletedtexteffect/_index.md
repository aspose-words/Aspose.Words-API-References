---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect Methode"
linktitle: "get_DeletedTextEffect"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect Methode. Ermöglicht die Angabe des Effekts, der auf den gelöschten Inhalt Deletion angewendet wird. Standardwert ist StrikeThrough in C++."
type: docs
weight: 4000
url: /de/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


Ermöglicht die Angabe des Effekts, der auf den gelöschten Inhalt [Deletion](../../../aspose.words/revisiontype/) angewendet wird. Standardwert ist [StrikeThrough](../../revisiontexteffect/)
