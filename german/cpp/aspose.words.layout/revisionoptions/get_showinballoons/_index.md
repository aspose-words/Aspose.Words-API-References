---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons Methode"
linktitle: "get_ShowInBalloons"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowInBalloons Methode. Ermöglicht die Angabe, ob die Revisionen in den Ballons dargestellt werden. Standardwert ist None in C++."
type: docs
weight: 17000
url: /de/cpp/aspose.words.layout/revisionoptions/get_showinballoons/
---
## RevisionOptions::get_ShowInBalloons method


Ermöglicht die Angabe, ob die Revisionen in den Ballons dargestellt werden. Der Standardwert ist [None](../../showinballoons/).
...
// Standardmäßig hat Text, der eine Revision ist, eine andere Farbe, um ihn vom übrigen Nicht-Revisionstext zu unterscheiden.
// Legen Sie eine Revisionsoption fest, um mehr Details zu jeder Revision in einem Ballon am rechten Rand der Seite anzuzeigen.
