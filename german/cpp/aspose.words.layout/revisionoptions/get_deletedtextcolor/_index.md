---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor Methode"
linktitle: "get_DeletedTextColor"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor Methode. Ermöglicht die Angabe der Farbe, die für gelöschten Inhalt Deletion verwendet wird. Der Standardwert ist ByAuthor in C++."
type: docs
weight: 3000
url: /de/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


Ermöglicht die Angabe der Farbe, die für gelöschten Inhalt [Deletion](../../../aspose.words/revisiontype/) verwendet wird. Der Standardwert ist [ByAuthor](../../revisioncolor/).
