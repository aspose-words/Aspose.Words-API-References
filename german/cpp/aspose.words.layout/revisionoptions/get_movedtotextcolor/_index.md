---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor Methode"
linktitle: "get_MovedToTextColor"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor Methode. Ermöglicht die Angabe der Farbe, die für Bereiche verwendet wird, in die Inhalte verschoben wurden Moving. Standardwert ist ByAuthor in C++."
type: docs
weight: 10000
url: /de/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


Ermöglicht die Angabe der Farbe, die für Bereiche verwendet wird, in die Inhalte verschoben wurden [Moving](../../../aspose.words/revisiontype/). Standardwert ist [ByAuthor](../../revisioncolor/).
