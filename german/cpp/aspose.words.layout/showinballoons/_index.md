...
description: "Aspose::Words::Layout::ShowInBalloons enum. Gibt an, welche Revisionen in C++ in Ballons dargestellt werden."
type: docs
weight: 13000
url: /de/cpp/aspose.words.layout/showinballoons/
---
## ShowInBalloons enum


Gibt an, welche Revisionen in Ballons gerendert werden.
...
| --- | --- | --- |
| Keine | 0 | Rendert Einfüge‑, Lösch‑ und Formatierungs‑Revisionen inline. |
| Format | 1 | Rendert Einfüge‑ und Lösch‑Revisionen inline, Formatierungs‑Revisionen in Ballons. |
| FormatAndDelete | 2 | Rendert Einfüge‑Revisionen inline, Lösch‑ und Formatierungs‑Revisionen in Ballons. |
