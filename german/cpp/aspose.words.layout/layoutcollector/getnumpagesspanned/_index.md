---
title: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned Methode"
linktitle: "GetNumPagesSpanned"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned Methode. Gibt die Anzahl der Seiten zurück, die der angegebene Knoten überspannt. 0, wenn der Knoten innerhalb einer einzelnen Seite liegt. Dies entspricht GetEndPageIndex() - GetStartPageIndex() in C++."
type: docs
weight: 7000
url: /de/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


Liefert die Anzahl der Seiten, die der angegebene Knoten umfasst. 0, wenn der Knoten innerhalb einer einzelnen Seite liegt. Dies entspricht [GetEndPageIndex()](../) - [GetStartPageIndex()](../).
