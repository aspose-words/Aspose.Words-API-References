---
title: "Aspose::Words::Loading::RtfLoadOptions‑Klasse"
linktitle: "RtfLoadOptions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Loading::RtfLoadOptions‑Klasse. Ermöglicht die Angabe zusätzlicher Optionen beim Laden eines Rtf‑Dokuments in ein Document‑Objekt. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words.loading/rtfloadoptions/
---
## RtfLoadOptions class


Ermöglicht die Angabe zusätzlicher Optionen beim Laden eines [Rtf](../../aspose.words/loadformat/)-Dokuments in ein [Document](../../aspose.words/document/)-Objekt. Weitere Informationen finden Sie im Artikel [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/) der Dokumentation.
...
| [get_RecognizeUtf8Text](./get_recognizeutf8text/)() const | Wenn auf **true** gesetzt, wird versucht, UTF‑8‑Zeichen zu erkennen; sie werden beim Import beibehalten. |
...
| [set_RecognizeUtf8Text](./set_recognizeutf8text/)(bool) | Setter für [Aspose::Words::Loading::RtfLoadOptions::get_RecognizeUtf8Text](./get_recognizeutf8text/). |
