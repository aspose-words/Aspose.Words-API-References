...
description: "Aspose::Words::Loading::TxtTrailingSpacesOptions Enum. Gibt die verfügbaren Optionen für die Behandlung von nachgestellten Leerzeichen beim Import aus einer Textdatei in C++ an."
type: docs
weight: 19000
url: /de/cpp/aspose.words.loading/txttrailingspacesoptions/
---
## TxtTrailingSpacesOptions enum


Gibt die verfügbaren Optionen für die Behandlung von nachgestellten Leerzeichen beim Import aus einer [Text](../../aspose.words/loadformat/) Datei an.
...
| --- | --- | --- |
| Trimmen | 0 | Nachgestellte Leerzeichen werden getrimmt. |
| Beibehalten | 1 | Nachgestellte Leerzeichen werden beibehalten. |
