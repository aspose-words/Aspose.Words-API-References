---
title: "Aspose::Words::Markup::CustomXmlPart::get_Id Methode"
linktitle: "get_Id"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::CustomXmlPart::get_Id Methode. Gibt die Zeichenkette zurück oder setzt sie, die diesen benutzerdefinierten XML‑Part innerhalb eines OOXML‑Dokuments in C++ identifiziert."
type: docs
weight: 6000
url: /de/cpp/aspose.words.markup/customxmlpart/get_id/
---
## CustomXmlPart::get_Id method


Liest oder setzt die Zeichenkette, die diesen benutzerdefinierten XML-Part in einem OOXML-Dokument identifiziert.
...
ISO/IEC 29500 gibt an, dass dieser Wert eine GUID ist, aber alte Versionen von Microsoft Word erlaubten hier beliebige Zeichenketten. Aspose.Words verhält sich im ECMA‑376‑Format genauso. Beachten Sie jedoch, dass Microsoft Word Online ein Dokument, das mit einem Nicht‑GUID‑Wert erstellt wurde, nicht öffnen kann. Daher ist für diese Eigenschaft ein GUID‑Wert vorzuziehen.

Ein gültiger Wert muss ein Bezeichner sein, der innerhalb dieses Dokuments unter allen benutzerdefinierten XML‑Datenparts eindeutig ist.
