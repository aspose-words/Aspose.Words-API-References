---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_Placeholder Methode"
linktitle: "get_Placeholder"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_Placeholder Methode. Ruft das BuildingBlock ab, das den Platzhaltertext enthält, der angezeigt werden soll, wenn der Inhalt dieses SDT-Laufs leer ist, das zugehörige zugeordnete XML-Element leer ist, wie über das XmlMapping-Element angegeben, oder das IsShowingPlaceholderText-Element in C++ auf true gesetzt ist."
type: docs
weight: 8000
url: /de/cpp/aspose.words.markup/istructureddocumenttag/get_placeholder/
---
## IStructuredDocumentTag::get_Placeholder method


Ruft das [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) ab, das den Platzhaltertext enthält, der angezeigt werden soll, wenn der Inhalt dieses SDT-Laufs leer ist, das zugehörige zugeordnete XML-Element leer ist, wie über das [XmlMapping](../get_xmlmapping/) Element angegeben, oder das [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) Element auf true gesetzt ist.
