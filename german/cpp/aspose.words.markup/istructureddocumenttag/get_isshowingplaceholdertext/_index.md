---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText-Methode"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_IsShowingPlaceholderText-Methode. Gibt an, ob der Inhalt dieses SDT als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT). Wenn auf true gesetzt, wird dieser Zustand beim Öffnen dieses Dokuments in C++ wiederhergestellt (Platzhaltertext wird angezeigt)."
type: docs
weight: 4000
url: /de/cpp/aspose.words.markup/istructureddocumenttag/get_isshowingplaceholdertext/
---
## IStructuredDocumentTag::get_IsShowingPlaceholderText method


Gibt an, ob der Inhalt dieses **SDT** als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT). Wenn auf true gesetzt, wird dieser Zustand beim Öffnen des Dokuments wiederhergestellt (Platzhaltertext wird angezeigt).
