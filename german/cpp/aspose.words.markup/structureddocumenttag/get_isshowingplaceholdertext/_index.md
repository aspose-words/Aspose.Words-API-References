---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText Methode"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_IsShowingPlaceholderText Methode. Gibt an, ob der Inhalt dieses SDT als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT). Wenn auf true gesetzt, wird dieser Zustand beim Öffnen dieses Dokuments in C++ wiederhergestellt (Platzhaltertext wird angezeigt)."
type: docs
weight: 18000
url: /de/cpp/aspose.words.markup/structureddocumenttag/get_isshowingplaceholdertext/
---
## StructuredDocumentTag::get_IsShowingPlaceholderText method


Gibt an, ob der Inhalt dieses **SDT** als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt im SDT). Wenn auf **true** gesetzt, wird dieser Zustand beim Öffnen des Dokuments wiederhergestellt (Platzhaltertext wird angezeigt).
