---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat Methode"
linktitle: "get_DateStorageFormat"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_DateStorageFormat Methode. Ruft das Format ab bzw. legt es fest, in dem das Datum für ein Datums‑SDT gespeichert wird, wenn das SDT an einen XML‑Knoten im Datenspeicher des Dokuments gebunden ist. Der Standardwert ist DateTime in C++."
type: docs
weight: 14000
url: /de/cpp/aspose.words.markup/structureddocumenttag/get_datestorageformat/
---
## StructuredDocumentTag::get_DateStorageFormat method


Ruft das Format ab bzw. legt es fest, in dem das Datum für ein Datums‑SDT gespeichert wird, wenn das **SDT** an einen XML‑Knoten im Datenspeicher des Dokuments gebunden ist. Der Standardwert ist [DateTime](../../sdtdatestorageformat/)
