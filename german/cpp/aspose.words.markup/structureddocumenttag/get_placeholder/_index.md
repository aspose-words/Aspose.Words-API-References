---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder Methode"
linktitle: "get_Placeholder"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Placeholder Methode. Ruft das BuildingBlock ab, das Platzhaltertext enthält, der angezeigt werden soll, wenn der Inhalt dieses SDT-Laufs leer ist, das zugehörige zugeordnete XML-Element leer ist, wie über das XmlMapping-Element angegeben, oder das IsShowingPlaceholderText-Element ist true in C++."
type: docs
weight: 26000
url: /de/cpp/aspose.words.markup/structureddocumenttag/get_placeholder/
---
## StructuredDocumentTag::get_Placeholder method


Ruft das [BuildingBlock](../../../aspose.words.buildingblocks/buildingblock/) ab, das Platzhaltertext enthält, der angezeigt werden soll, wenn der Inhalt dieses SDT-Laufs leer ist, das zugehörige zugeordnete XML-Element leer ist, wie über das [XmlMapping](../get_xmlmapping/) Element angegeben, oder das [IsShowingPlaceholderText](../get_isshowingplaceholdertext/) Element **true** ist.
