---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems-Methode"
linktitle: "get_ListItems"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems-Methode. Gibt die SdtListItemCollection zurück, die mit diesem SDT in C++ verknüpft ist."
type: docs
weight: 21000
url: /de/cpp/aspose.words.markup/structureddocumenttag/get_listitems/
---
## StructuredDocumentTag::get_ListItems method


Gibt die [SdtListItemCollection](../../sdtlistitemcollection/) zurück, die mit diesem **SDT** verknüpft ist.
...
Der Zugriff auf diese Eigenschaft funktioniert nur für die SDT-Typen [ComboBox](../../sdttype/) oder [DropDownList](../../sdttype/).
