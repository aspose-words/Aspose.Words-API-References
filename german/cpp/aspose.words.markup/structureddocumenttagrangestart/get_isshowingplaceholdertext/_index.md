---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText Methode"
linktitle: "get_IsShowingPlaceholderText"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText Methode. Gibt an, ob der Inhalt dieses strukturierten Dokument-Tags als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des strukturierten Dokument-Tags). Wenn auf true gesetzt, wird dieser Zustand (Anzeige von Platzhaltertext) beim Öffnen dieses Dokuments in C++ wiederhergestellt."
type: docs
weight: 8000
url: /de/cpp/aspose.words.markup/structureddocumenttagrangestart/get_isshowingplaceholdertext/
---
## StructuredDocumentTagRangeStart::get_IsShowingPlaceholderText method


Gibt an, ob der Inhalt dieses strukturierten Dokument-Tags als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des strukturierten Dokument-Tags). Wenn auf **true** gesetzt, wird dieser Zustand beim Öffnen des Dokuments wiederhergestellt (Platzhaltertext wird angezeigt).
