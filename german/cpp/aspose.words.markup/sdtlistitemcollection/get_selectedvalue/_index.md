---
title: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue Methode"
linktitle: "get_SelectedValue"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue Methode. Gibt den aktuell ausgewählten Wert in dieser Liste an. Nullwert erlaubt, was bedeutet, dass kein aktuell ausgewählter Eintrag mit dieser Listenelementsammlung in C++ verknüpft ist."
type: docs
weight: 9000
url: /de/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


Gibt den aktuell ausgewählten Wert in dieser Liste an. Nullwert ist zulässig, was bedeutet, dass kein aktuell ausgewählter Eintrag mit dieser Listenelementsammlung verknüpft ist.
