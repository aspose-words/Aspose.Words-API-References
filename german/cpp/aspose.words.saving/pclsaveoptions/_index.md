---
title: "Aspose::Words::Saving::PclSaveOptions Klasse"
linktitle: "PclSaveOptions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Saving::PclSaveOptions Klasse. Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im Pcl‑Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel in C++."
type: docs
weight: 21000
url: /de/cpp/aspose.words.saving/pclsaveoptions/
---
## PclSaveOptions class


Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im [Pcl](../../aspose.words/saveformat/)‑Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| --- | --- |
| [AddPrinterFont](./addprinterfont/)(const System::String\&, const System::String\&) | Fügt Informationen über die Schriftart hinzu, die vom Hersteller zum Drucker hochgeladen wird. |
...
| [get_FallbackFontName](./get_fallbackfontname/)() const | Name der Schriftart, die verwendet wird, wenn keine erwartete Schriftart im Drucker und in den integrierten Schriftartsammlungen gefunden wird. |
...
| [get_RasterizeTransformedElements](./get_rasterizetransformedelements/)() const | Liest oder setzt einen Wert, der bestimmt, ob komplexe transformierte Elemente vor dem Speichern in ein PCL-Dokument gerastert werden sollen oder nicht. Standardwert ist **true**. |
| [get_SaveFormat](./get_saveformat/)() override | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Speicheroptionen-Objekt verwendet wird. Kann nur [Pcl](../../aspose.words/saveformat/) sein. |
...
| [set_FallbackFontName](./set_fallbackfontname/)(const System::String\&) | Setter für [Aspose::Words::Saving::PclSaveOptions::get_FallbackFontName](./get_fallbackfontname/). |
...
| [set_RasterizeTransformedElements](./set_rasterizetransformedelements/)(bool) | Setter für [Aspose::Words::Saving::PclSaveOptions::get_RasterizeTransformedElements](./get_rasterizetransformedelements/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter für [Aspose::Words::Saving::PclSaveOptions::get_SaveFormat](./get_saveformat/). |
