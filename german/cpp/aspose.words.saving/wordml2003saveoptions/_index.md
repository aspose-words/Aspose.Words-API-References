---
title: "Klasse Aspose::Words::Saving::WordML2003SaveOptions"
linktitle: "WordML2003SaveOptions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Klasse Aspose::Words::Saving::WordML2003SaveOptions. Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im WordML-Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 35000
url: /de/cpp/aspose.words.saving/wordml2003saveoptions/
---
## WordML2003SaveOptions class


Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im [WordML](../../aspose.words/saveformat/)-Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses SaveOptions-Objekt verwendet wird. Kann nur [WordML](../../aspose.words/saveformat/) sein. |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter für [Aspose::Words::Saving::WordML2003SaveOptions::get_SaveFormat](./get_saveformat/). |
...
Derzeit bietet es nur die Eigenschaft [SaveFormat](./get_saveformat/) an, aber in Zukunft könnten weitere Optionen hinzugefügt werden.
...
// Setzen Sie das Flag "MemoryOptimization" auf "true", um den Speicherverbrauch zu reduzieren
// während des Speichervorgangs des Dokuments, allerdings auf Kosten einer längeren Speicherzeit.
