---
title: "Aspose::Words::Saving::DoclingSaveOptions Klasse"
linktitle: "DoclingSaveOptions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Saving::DoclingSaveOptions Klasse. Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im Docling-Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 2750
url: /de/cpp/aspose.words.saving/doclingsaveoptions/
---
## DoclingSaveOptions class


Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im [Docling](../../aspose.words/saveformat/) Format anzugeben. Weitere Informationen finden Sie im [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) Dokumentationsartikel.
...
| [get_RenderNonImageShapes](./get_rendernonimageshapes/)() const | Liest oder legt einen Wert fest, der angibt, ob Nicht-Bild-Formen gerendert und in das ausgegebene Docling-JSON-Dokument geschrieben werden sollen. |
| [get_SaveFormat](./get_saveformat/)() override | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses SaveOptions-Objekt verwendet wird. Kann nur [Docling](../../aspose.words/saveformat/) sein. |
...
| [set_RenderNonImageShapes](./set_rendernonimageshapes/)(bool) | Setter für [Aspose::Words::Saving::DoclingSaveOptions::get_RenderNonImageShapes](./get_rendernonimageshapes/). |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter für [Aspose::Words::Saving::DoclingSaveOptions::get_SaveFormat](./get_saveformat/). |
