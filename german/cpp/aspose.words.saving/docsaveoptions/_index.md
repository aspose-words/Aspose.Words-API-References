...
description: "Aspose::Words::Saving::DocSaveOptions class. Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im Doc- oder Dot-Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 3000
url: /de/cpp/aspose.words.saving/docsaveoptions/
---
## DocSaveOptions class


Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im [Doc](../../aspose.words/saveformat/)‑ oder [Dot](../../aspose.words/saveformat/)‑Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [DocSaveOptions](./docsaveoptions/)() | Initialisiert eine neue Instanz dieser Klasse, die zum Speichern eines Dokuments im [Doc](../../aspose.words/saveformat/)‑Format verwendet werden kann. |
| [DocSaveOptions](./docsaveoptions/)(Aspose::Words::SaveFormat) | Initialisiert eine neue Instanz dieser Klasse, die zum Speichern eines Dokuments im [Doc](../../aspose.words/saveformat/)‑ oder [Dot](../../aspose.words/saveformat/)‑Format verwendet werden kann. |
...
| [get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/)() const | Wenn **false**, werden kleine Metadateien aus Leistungsgründen nicht komprimiert. Der Standardwert ist **true**, alle Metadateien werden unabhängig von ihrer Größe komprimiert. |
...
| [get_Password](./get_password/)() const | Liest/legt ein Passwort fest, um das Dokument mit dem RC4‑Verschlüsselungsverfahren zu verschlüsseln. |
...
| [get_SaveFormat](./get_saveformat/)() override | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Save‑Options‑Objekt verwendet wird. Kann [Doc](../../aspose.words/saveformat/) oder [Dot](../../aspose.words/saveformat/) sein. |
| [get_SavePictureBullet](./get_savepicturebullet/)() const | Wenn **false**, werden PictureBullet‑Daten nicht im Ausgabedokument gespeichert. Der Standardwert ist **true**. |
| [get_SaveRoutingSlip](./get_saveroutingslip/)() const | Wenn **false**, werden RoutingSlip‑Daten nicht im Ausgabedokument gespeichert. Der Standardwert ist **true**. |
...
| [set_AlwaysCompressMetafiles](./set_alwayscompressmetafiles/)(bool) | Setter für [Aspose::Words::Saving::DocSaveOptions::get_AlwaysCompressMetafiles](./get_alwayscompressmetafiles/). |
...
| [set_Password](./set_password/)(const System::String\&) | Setter für [Aspose::Words::Saving::DocSaveOptions::get_Password](./get_password/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter für [Aspose::Words::Saving::DocSaveOptions::get_SaveFormat](./get_saveformat/). |
| [set_SavePictureBullet](./set_savepicturebullet/)(bool) | Setter für [Aspose::Words::Saving::DocSaveOptions::get_SavePictureBullet](./get_savepicturebullet/). |
| [set_SaveRoutingSlip](./set_saveroutingslip/)(bool) | Setter für [Aspose::Words::Saving::DocSaveOptions::get_SaveRoutingSlip](./get_saveroutingslip/). |
