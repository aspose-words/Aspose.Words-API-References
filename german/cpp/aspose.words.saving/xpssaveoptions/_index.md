---
title: "Aspose::Words::Saving::XpsSaveOptions Klasse"
linktitle: "XpsSaveOptions"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Saving::XpsSaveOptions Klasse. Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im Xps-Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 38000
url: /de/cpp/aspose.words.saving/xpssaveoptions/
---
## XpsSaveOptions class


Kann verwendet werden, um zusätzliche Optionen beim Speichern eines Dokuments im [Xps](../../aspose.words/saveformat/) Format anzugeben. Weitere Informationen finden Sie im Dokumentationsartikel [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/).
...
| [get_SaveFormat](./get_saveformat/)() override | Gibt das Format an, in dem das Dokument gespeichert wird, wenn dieses Save-Options-Objekt verwendet wird. Kann nur [Xps](../../aspose.words/saveformat/) sein. |
...
| [set_CompressionLevel](./set_compressionlevel/)(Aspose::Words::Saving::CompressionLevel) | Setter für [Aspose::Words::Saving::XpsSaveOptions::get_CompressionLevel](./get_compressionlevel/). |
...
| [set_DigitalSignatureDetails](./set_digitalsignaturedetails/)(const System::SharedPtr\<Aspose::Words::Saving::DigitalSignatureDetails\>\&) | Setter für [Aspose::Words::Saving::XpsSaveOptions::get_DigitalSignatureDetails](./get_digitalsignaturedetails/). |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | Setter für [Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat](./get_saveformat/). |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | Setter für [Aspose::Words::Saving::XpsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/). |
...
| static [Type](./type/)() |  |
| [XpsSaveOptions](./xpssaveoptions/)() | Initialisiert eine neue Instanz dieser Klasse, die verwendet werden kann, um ein Dokument im [Xps](../../aspose.words/saveformat/)‑Format zu speichern. |
| [XpsSaveOptions](./xpssaveoptions/)(Aspose::Words::SaveFormat) | Initialisiert eine neue Instanz dieser Klasse, die verwendet werden kann, um ein Dokument im [Xps](../../aspose.words/saveformat/)‑ oder [OpenXps](../../aspose.words/saveformat/)‑Format zu speichern. |
