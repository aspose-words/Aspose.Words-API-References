...
description: "Aspose::Words::Saving::HtmlVersion Enum. Gibt an, welche HTML-Version beim Speichern des Dokuments in den Formaten Html und Mhtml in C++ verwendet wird."
type: docs
weight: 62000
url: /de/cpp/aspose.words.saving/htmlversion/
---
## HtmlVersion enum


Gibt an, welche HTML-Version beim Speichern des Dokuments in den Formaten [Html](../../aspose.words/saveformat/) und [Mhtml](../../aspose.words/saveformat/) verwendet wird.
...
| --- | --- | --- |
| Xhtml | 0 | Speichert das Dokument konform zum XHTML 1.0 Transitional-Standard. |
| Html5 | 1 | Speichert das Dokument konform zum HTML‑5‑Standard. |
