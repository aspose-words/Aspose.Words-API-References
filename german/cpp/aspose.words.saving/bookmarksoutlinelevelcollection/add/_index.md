---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add Methode"
linktitle: "Add"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add Methode. Fügt ein Lesezeichen zur Sammlung in C++ hinzu."
type: docs
weight: 3000
url: /de/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
## BookmarksOutlineLevelCollection::Add method


Fügt ein Lesezeichen zur Sammlung hinzu.
...
| --- | --- | --- |
| name | const System::String\& | Der nicht‑groß-/kleinschreibungssensible Name des hinzuzufügenden Lesezeichens. |
| outlineLevel | int32_t | Die Gliederungsebene des Lesezeichens. Gültiger Bereich ist 0 bis 9. |
