---
title: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment-Methode"
linktitle: "get_TableContentAlignment"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment-Methode. Gibt einen Wert zurück oder legt ihn fest, der angibt, wie Inhalte in Tabellen beim Export in das Markdown-Format ausgerichtet werden sollen. Der Standardwert ist Auto in C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words.saving/markdownsaveoptions/get_tablecontentalignment/
---
## MarkdownSaveOptions::get_TableContentAlignment method


Gibt einen Wert zurück oder legt ihn fest, der angibt, wie Inhalte in Tabellen beim Export in das [Markdown](../../../aspose.words/saveformat/)‑Format ausgerichtet werden sollen. Der Standardwert ist [Auto](../../tablecontentalignment/).
