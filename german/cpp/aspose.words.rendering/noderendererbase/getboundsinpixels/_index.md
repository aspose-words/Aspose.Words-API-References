---
title: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels Methode"
linktitle: "GetBoundsInPixels"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Rendering::NodeRendererBase::GetBoundsInPixels Methode. Berechnet die Begrenzungen der Form in Pixeln für einen angegebenen Zoomfaktor und eine Auflösung in C++."
type: docs
weight: 6000
url: /de/cpp/aspose.words.rendering/noderendererbase/getboundsinpixels/
---
...
| dpi | float | Die Auflösung (horizontal und vertikal), um von Punkten zu Pixeln zu konvertieren (Punkte pro Zoll). |

### ReturnValue

Das tatsächliche (wie auf der Seite gerendert) Begrenzungsfeld der Form in Pixeln.
## Hinweise


Diese Methode konvertiert [BoundsInPoints](../get_boundsinpoints/) in ein Rechteck in Pixeln.
