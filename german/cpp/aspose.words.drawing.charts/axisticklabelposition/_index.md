...
description: "Aspose::Words::Drawing::Charts::AxisTickLabelPosition enum. Gibt die möglichen Positionen für Tick‑Beschriftungen in C++ an."
type: docs
weight: 24000
url: /de/cpp/aspose.words.drawing.charts/axisticklabelposition/
---
...
| --- | --- | --- |
| Hoch | 0 | Gibt an, dass die Achsenbeschriftungen am oberen Ende der senkrechten Achse liegen sollen. |
| Niedrig | 1 | Gibt an, dass die Achsenbeschriftungen am unteren Ende der senkrechten Achse liegen sollen. |
| NextToAxis | 2 | Gibt an, dass die Achsenbeschriftungen neben der Achse liegen sollen. |
| Keine | 3 | Gibt an, dass die Achsenbeschriftungen nicht gezeichnet werden. |
| Standard | n/a | Gibt den Standardwert für die Position der Tick‑Beschriftungen an. |
