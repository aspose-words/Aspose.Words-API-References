...
description: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode enum. Gibt an, wie die Werte, die den Ort einer Datenbeschriftung festlegen – die Eigenschaften Left und Top – in C++ interpretiert werden."
type: docs
weight: 27167
url: /de/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


Gibt an, wie die Werte, die den Ort einer Datenbeschriftung festlegen – die [Left](../chartdatalabel/get_left/)- und [Top](../chartdatalabel/get_top/)-Eigenschaften – interpretiert werden.
...
| --- | --- | --- |
| Offset | 0 | Der Ort einer Datenbeschriftung wird durch einen Versatz von der durch die [Position](../chartdatalabel/get_position/)-Eigenschaft definierten Position angegeben. |
| Absolut | 1 | Der Ort einer Datenbeschriftung wird mit absoluten Koordinaten angegeben, beginnend in der oberen linken Ecke eines Diagramms. |
