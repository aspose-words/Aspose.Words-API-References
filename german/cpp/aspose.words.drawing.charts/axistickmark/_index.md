...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. Gibt die möglichen Positionen für Tick-Markierungen in C++ an."
type: docs
weight: 25000
url: /de/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum
...
| --- | --- | --- |
| Cross | 0 | Gibt an, dass die Tick-Markierungen die Achse kreuzen sollen. |
| Inside | 1 | Gibt an, dass die Tick-Markierungen innerhalb des Diagrammbereichs liegen sollen. |
| Außerhalb | 2 | Gibt an, dass die Tick-Markierungen außerhalb des Diagrammbereichs liegen sollen. |
| Keine | 3 | Gibt an, dass keine Markierungen vorhanden sein sollen. |
