---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left Methode"
linktitle: "get_Left"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left Methode. Gibt den Abstand der Datenbeschriftung in Punkten vom linken Rand des Diagramms oder von der durch die Position‑Eigenschaft angegebenen Position zurück bzw. legt ihn fest, abhängig vom Wert der LeftMode‑Eigenschaft in C++."
type: docs
weight: 6334
url: /de/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


Gibt den Abstand der Datenbeschriftung in Punkten vom linken Rand des Diagramms oder von der durch die [Position](../get_position/) Eigenschaft angegebenen Position zurück bzw. legt ihn fest, abhängig vom Wert der [LeftMode](../get_leftmode/) Eigenschaft.
