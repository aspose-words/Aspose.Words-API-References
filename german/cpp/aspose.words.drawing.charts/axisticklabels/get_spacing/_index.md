...
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing method. Gibt das Intervall zurück, in dem die Tick-Labels gezeichnet werden, oder legt es fest in C++."
type: docs
weight: 9000
url: /de/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
## AxisTickLabels::get_Spacing method


Ermittelt oder setzt das Intervall, in dem die Tick‑Labels gezeichnet werden.
...
Die Eigenschaft wirkt sich auf Textkategorie- und Serienachsen aus. Sie wird von den neuen Diagrammen in MS Office 2016 nicht unterstützt. Der gültige Wertebereich ist größer oder gleich 1.

Durch das Festlegen dieser Eigenschaft wird die [IsAutoSpacing](../get_isautospacing/) Eigenschaft auf **false** gesetzt.
