...
description: "Aspose::Words::Drawing::Charts::AxisTickLabels class. Stellt Eigenschaften von Achsen‑Tick‑Mark‑Labels in C++ dar."
type: docs
weight: 3250
url: /de/cpp/aspose.words.drawing.charts/axisticklabels/
---
## AxisTickLabels class


Stellt Eigenschaften von Achsenbeschriftungsmarken dar.
...
| --- | --- |
| [get_Alignment](./get_alignment/)() | Ermittelt oder setzt die Textausrichtung der Achsen‑Tick‑Labels. |
| [get_Font](./get_font/)() | Stellt Zugriff auf die Schriftformatierung der Tick‑Labels bereit. |
| [get_IsAutoSpacing](./get_isautospacing/)() | Ermittelt oder setzt ein Flag, das angibt, ob ein automatisches Intervall zum Zeichnen der Tick‑Labels verwendet werden soll. |
| [get_Offset](./get_offset/)() | Ermittelt oder setzt den Abstand der Tick‑Labels von der Achse. |
| [get_Orientation](./get_orientation/)() | Ermittelt oder setzt die Ausrichtung des Tick‑Label‑Texts. |
| [get_Position](./get_position/)() | Ermittelt oder setzt die Position der Tick‑Labels auf der Achse. |
| [get_Rotation](./get_rotation/)() | Ermittelt oder setzt die Drehung der Tick‑Labels in Grad. |
| [get_Spacing](./get_spacing/)() | Ermittelt oder setzt das Intervall, in dem die Tick‑Labels gezeichnet werden. |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Alignment](./set_alignment/)(Aspose::Words::ParagraphAlignment) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Alignment](./get_alignment/). |
| [set_IsAutoSpacing](./set_isautospacing/)(bool) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing](./get_isautospacing/). |
| [set_Offset](./set_offset/)(int32_t) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Offset](./get_offset/). |
| [set_Orientation](./set_orientation/)(Aspose::Words::Drawing::ShapeTextOrientation) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Orientation](./get_orientation/). |
| [set_Position](./set_position/)(Aspose::Words::Drawing::Charts::AxisTickLabelPosition) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Position](./get_position/). |
| [set_Rotation](./set_rotation/)(int32_t) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Rotation](./get_rotation/). |
| [set_Spacing](./set_spacing/)(int32_t) | Setter für [Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing](./get_spacing/). |
| static [Type](./type/)() |  |
