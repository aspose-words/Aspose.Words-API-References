---
title: "Aspose::Words::Drawing::Charts::ChartSeries::Insert Methode"
linktitle: "Insert"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Drawing::Charts::ChartSeries::Insert Methode. Fügt den angegebenen X‑Wert an der angegebenen Position in die Diagrammreihe ein. Unterstützt die Reihe Y‑Werte und Blasengrößen, bleiben diese für den X‑Wert leer in C++."
type: docs
weight: 13500
url: /de/cpp/aspose.words.drawing.charts/chartseries/insert/
---
...
Zeigt, wie man Daten in eine Diagrammreihe einfügt.
```cpp
...
Fügt die angegebenen X‑ und Y‑Werte an der angegebenen Position in die Diagrammserie ein.
...
Fügt den angegebenen X‑Wert, Y‑Wert und die Blasengröße an der angegebenen Position in die Diagrammserie ein.
