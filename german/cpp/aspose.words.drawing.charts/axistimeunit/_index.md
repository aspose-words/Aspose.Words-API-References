...
description: "Aspose::Words::Drawing::Charts::AxisTimeUnit Enum. Gibt die Zeiteinheit für Achsen in C++ an."
type: docs
weight: 26000
url: /de/cpp/aspose.words.drawing.charts/axistimeunit/
---
## AxisTimeUnit enum
...
| --- | --- | --- |
| Automatisch | 0 | Gibt an, dass die Einheit nicht explizit festgelegt wurde und der Standardwert verwendet werden soll. |
| Tage | 1 | Gibt an, dass die Diagrammdaten in Tagen angezeigt werden. |
| Monate | 2 | Gibt an, dass die Diagrammdaten in Monaten angezeigt werden. |
| Jahre | 3 | Gibt an, dass die Diagrammdaten in Jahren angezeigt werden. |
