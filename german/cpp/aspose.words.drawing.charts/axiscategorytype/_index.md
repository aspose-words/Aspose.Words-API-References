...
description: "Aspose::Words::Drawing::Charts::AxisCategoryType Enum. Gibt den Typ einer Kategorienachse in C++ an."
type: docs
weight: 21000
url: /de/cpp/aspose.words.drawing.charts/axiscategorytype/
---
## AxisCategoryType enum


Gibt den Typ einer Kategorienachse an.
...
| --- | --- | --- |
| Automatisch | 0 | Gibt an, dass der Typ einer Kategorienachse basierend auf den Daten automatisch bestimmt wird. |
| Kategorie | 1 | Gibt eine Achse eines beliebigen Satzes von Kategorien an. |
| Zeit | 2 | Gibt eine Zeitkategorie-Achse an. |
