...
description: "Aspose::Words::Drawing::GradientStyle-Enum. Gibt den Stil für eine Farbverlauf-Füllung in C++ an."
type: docs
weight: 24000
url: /de/cpp/aspose.words.drawing/gradientstyle/
---
## GradientStyle enum


Gibt den Stil für eine Farbverlauffüllung an.
...
| --- | --- | --- |
| Keine | -1 | Kein Farbverlauf. |
| Horizontal | 1 | Farbverlauf verläuft horizontal über ein Objekt. |
| Vertikal | 2 | Farbverlauf verläuft vertikal nach unten über ein Objekt. |
| DiagonalUp | 3 | Diagonaler Farbverlauf, der von einer unteren Ecke zur gegenüberliegenden Ecke nach oben verläuft. |
| DiagonalDown | 4 | Diagonaler Farbverlauf, der von einer oberen Ecke zur gegenüberliegenden Ecke nach unten verläuft. |
| FromCorner | 5 | Farbverlauf verläuft von einer Ecke zu den anderen drei Ecken. |
| FromCenter | 6 | Farbverlauf verläuft vom Zentrum zu den Ecken. |
