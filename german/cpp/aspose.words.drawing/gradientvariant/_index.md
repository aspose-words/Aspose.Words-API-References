---
title: "Aspose::Words::Drawing::GradientVariant Aufzählung"
linktitle: "GradientVariant"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Drawing::GradientVariant Aufzählung. Gibt die Variante für eine Farbverlauffüllung in C++ an."
type: docs
weight: 25000
url: /de/cpp/aspose.words.drawing/gradientvariant/
---
## GradientVariant enum


Gibt die Variante für eine Farbverlauffüllung an.
...
| --- | --- | --- |
| Keine | 0 | Gradient-Variante 'None'. |
| Variant1 | 1 | Gradient-Variante 1. |
| Variant2 | 2 | Gradient-Variante 2. |
| Variant3 | 3 | Gradient-Variante 3. |
| Variant4 | 4 | Gradient-Variante 4. |
