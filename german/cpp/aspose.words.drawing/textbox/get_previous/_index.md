---
title: "Aspose::Words::Drawing::TextBox::get_Previous Methode"
linktitle: "get_Previous"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Drawing::TextBox::get_Previous Methode. Gibt eine TextBox zurück, die die vorherige TextBox in einer Sequenz von Formen in C++ darstellt."
type: docs
weight: 12000
url: /de/cpp/aspose.words.drawing/textbox/get_previous/
---
## TextBox::get_Previous method


Gibt eine [TextBox](../) zurück, die die vorherige [TextBox](../) in einer Sequenz von Formen darstellt.
...
Zeigt, wie man Textfelder verknüpft.
```cpp
...
// Erstellt Verknüpfungen zwischen einigen der Textfelder.
...
// Nur ein leeres Textfeld darf eine Verknüpfung haben.
...
if (textBox3->get_Next() == nullptr && textBox3->get_Previous() != nullptr)
{
    ...
    // Trennen Sie die Vorwärtsverknüpfung zwischen textBox2 und textBox3 und prüfen Sie anschließend, dass sie nicht mehr verknüpft sind.
