---
title: "Aspose::Words::Drawing::GradientStopCollection Klasse"
linktitle: "GradientStopCollection"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Drawing::GradientStopCollection Klasse. Enthält eine Sammlung von GradientStop-Objekten. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 3000
url: /de/cpp/aspose.words.drawing/gradientstopcollection/
---
## GradientStopCollection class


Enthält eine Sammlung von [GradientStop](../gradientstop/) Objekten. Weitere Informationen finden Sie im Dokumentationsartikel [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/).
...
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Fügt einem Farbverlauf ein angegebenes [GradientStop](../gradientstop/) hinzu. |
| [get_Count](./get_count/)() | Gibt einen ganzzahligen Wert zurück, der die Anzahl der Elemente in der Sammlung angibt. |
| [GetEnumerator](./getenumerator/)() override | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Liest oder setzt ein [GradientStop](../gradientstop/) Objekt in der Sammlung. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Liest oder setzt ein [GradientStop](../gradientstop/) Objekt in der Sammlung. |
| [Insert](./insert/)(int32_t, const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Fügt ein [GradientStop](../gradientstop/) an einem angegebenen Index in die Sammlung ein. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Drawing::GradientStop\>\&) | Entfernt ein angegebenes [GradientStop](../gradientstop/) aus der Sammlung. |
| [RemoveAt](./removeat/)(int32_t) | Entfernt ein [GradientStop](../gradientstop/) aus der Sammlung an einem angegebenen Index. |
| static [Type](./type/)() |  |
