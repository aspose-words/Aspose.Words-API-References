...
description: "Aspose::Words::Bibliography::PersonCollection class. Stellt eine Liste von Personen dar, die Bibliographie-Quellenbeiträger in C++ sind."
type: docs
weight: 750
url: /de/cpp/aspose.words.bibliography/personcollection/
---
## PersonCollection class


Stellt eine Liste von Personen dar, die Bibliographie‑Quellen‑Beitragende sind.
...
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Fügt ein [Person](../person/) zur Sammlung hinzu. |
| [Clear](./clear/)() | Entfernt alle Elemente aus der Sammlung. |
| [Contains](./contains/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Bestimmt, ob die Sammlung eine bestimmte Person enthält. |
| [get_Count](./get_count/)() | Gibt die Anzahl der in der Sammlung enthaltenen Personen zurück. |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | Liest oder setzt eine Person am angegebenen Index. |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Liest oder setzt eine Person am angegebenen Index. |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [PersonCollection](./personcollection/)() | Initialisiert eine neue Instanz der [PersonCollection](./) Klasse. |
...
| [PersonCollection](./personcollection/)(const System::ArrayPtr\<System::SharedPtr\<Aspose::Words::Bibliography::Person\>\>\&) | Initialisiert eine neue Instanz der [PersonCollection](./) Klasse. |
| [Remove](./remove/)(const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\&) | Entfernt die Person aus der Sammlung. |
| [RemoveAt](./removeat/)(int32_t) | Entfernt die Person am angegebenen Index. |
