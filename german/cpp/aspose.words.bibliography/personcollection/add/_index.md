---
title: "Aspose::Words::Bibliography::PersonCollection::Add Methode"
linktitle: "Add"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Bibliography::PersonCollection::Add Methode. Fügt eine Person zur Sammlung hinzu in C++."
type: docs
weight: 3000
url: /de/cpp/aspose.words.bibliography/personcollection/add/
---
## PersonCollection::Add method


Fügt eine [Person](../../person/) zur Sammlung hinzu.
...
| --- | --- | --- |
| Person | const System::SharedPtr\<Aspose::Words::Bibliography::Person\>\& | Die Person, die zur Sammlung hinzugefügt werden soll. |
