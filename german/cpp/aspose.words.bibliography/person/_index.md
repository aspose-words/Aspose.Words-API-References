...
description: "Aspose::Words::Bibliography::Person class. Stellt einen einzelnen (eine Person) Bibliographie-Quellenbeiträger in C++ dar."
type: docs
weight: 625
url: /de/cpp/aspose.words.bibliography/person/
---
## Person class


Stellt einen individuellen (eine Person) Bibliographie‑Quellen‑Beitragenden dar.
...
| [get_First](./get_first/)() const | Liest oder setzt den Vornamen einer Person. |
| [get_Last](./get_last/)() const | Liest oder setzt den Nachnamen einer Person. |
| [get_Middle](./get_middle/)() const | Liest oder setzt den Mittelname einer Person. |
| [GetHashCode](./gethashcode/)() const override |  |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Person](./person/)(const System::String\&, const System::String\&, const System::String\&) | Initialisiert eine neue Instanz der [Person](./)-Klasse. |
| [set_First](./set_first/)(const System::String\&) | Setter für [Aspose::Words::Bibliography::Person::get_First](./get_first/). |
| [set_Last](./set_last/)(const System::String\&) | Setter für [Aspose::Words::Bibliography::Person::get_Last](./get_last/). |
| [set_Middle](./set_middle/)(const System::String\&) | Setter für [Aspose::Words::Bibliography::Person::get_Middle](./get_middle/). |
| static [Type](./type/)() |  |
