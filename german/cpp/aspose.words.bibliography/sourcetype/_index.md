---
title: "Aspose::Words::Bibliography::SourceType Aufzählung"
linktitle: "SourceType"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Bibliography::SourceType enum. Repräsentiert Bibliographie-Quelltypen in C++."
type: docs
weight: 1000
url: /de/cpp/aspose.words.bibliography/sourcetype/
---
## SourceType enum


Stellt Bibliographie‑Quellen‑Typen dar.
...
| --- | --- | --- |
| ArticleInAPeriodical | 0 | Gibt den Artikel in einer periodischen Quelle an. |
| Book | 1 | Gibt die Buchquelle an. |
| BookSection | 2 | Gibt die Buchabschnittsquelle an. |
| JournalArticle | 3 | Gibt die Zeitschriftenartikelquelle an. |
| ConferenceProceedings | 4 | Gibt die Konferenzbeitragsquelle an. |
| Report | 5 | Gibt die Berichtquelle an. |
| SoundRecording | 6 | Gibt die Tonaufnahmequelle an. |
| Performance | 7 | Gibt die Aufführungsquelle an. |
| Art | 8 | Gibt die Kunstquelle an. |
| DocumentFromInternetSite | 9 | Gibt die Dokumentquelle von einer Internetseite an. |
| InternetSite | 10 | Gibt die Internetseitenquelle an. |
| Film | 11 | Gibt die Filmquelle an. |
| Interview | 12 | Gibt die Interviewquelle an. |
| Patent | 13 | Gibt die Patentquelle an. |
| Elektronisch | 14 | Gibt die elektronische Quelle an. |
| Fall | 15 | Gibt die Fallquelle an. |
| Sonstiges | 16 | Gibt die sonstige Quelle an. |
