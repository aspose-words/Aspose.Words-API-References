...
description: "Aspose::Words::Themes::Theme class. Stellt das Dokument‑Theme dar und bietet Zugriff auf die wichtigsten Theme‑Teile einschließlich MajorFonts, MinorFonts und Colors. Weitere Informationen finden Sie im Dokumentationsartikel für C++."
type: docs
weight: 1000
url: /de/cpp/aspose.words.themes/theme/
---
## Theme class


Stellt das Dokument [Theme](./) dar und bietet Zugriff auf die wichtigsten Theme‑Teile einschließlich [MajorFonts](./get_majorfonts/), [MinorFonts](./get_minorfonts/) und [Colors](./get_colors/). Weitere Informationen finden Sie im Artikel [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/) der Dokumentation.
...
| --- | --- |
| [get_Colors](./get_colors/)() const | Ermöglicht das Festlegen des Satzes von Theme‑Farben für das Dokument. |
| [get_MajorFonts](./get_majorfonts/)() const | Ermöglicht das Festlegen des Satzes von Hauptschriftarten für verschiedene Sprachen. |
| [get_MinorFonts](./get_minorfonts/)() const | Ermöglicht das Festlegen des Satzes von Nebenschriftarten für verschiedene Sprachen. |
