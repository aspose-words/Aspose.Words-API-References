...
description: "Aspose::Words::Themes::ThemeFont enum. Gibt die Arten von Themen‑Schriftartnamen für Dokumentthemen in C++ an."
type: docs
weight: 5000
url: /de/cpp/aspose.words.themes/themefont/
---
## ThemeFont enum


Gibt die Typen von Themen-Schriftartnamen für Dokumentthemen an.
...
| --- | --- | --- |
| Keine | 0 | Keine Themen-Schriftart. |
| Haupt | 1 | Haupt-Themen-Schriftart. |
| Neben | 2 | Neben-Themen-Schriftart. |
