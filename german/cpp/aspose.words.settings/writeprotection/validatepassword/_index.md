---
title: "Aspose::Words::Settings::WriteProtection::ValidatePassword Methode"
linktitle: "ValidatePassword"
second_title: "Aspose.Words für C++ API‑Referenz"
description: "Aspose::Words::Settings::WriteProtection::ValidatePassword Methode. Gibt true zurück, wenn das angegebene Passwort dem Schreibschutz‑Passwort entspricht, mit dem das Dokument geschützt wurde. Ist das Dokument nicht mit einem Passwort schreibgeschützt, wird false zurückgegeben in C++."
type: docs
weight: 8000
url: /de/cpp/aspose.words.settings/writeprotection/validatepassword/
---
## WriteProtection::ValidatePassword method


Gibt **true** zurück, wenn das angegebene Passwort dem Schreibschutz-Passwort entspricht, mit dem das Dokument geschützt wurde. Ist das Dokument nicht passwortgeschützt, wird **false** zurückgegeben.
