...
description: "Stellt ein WebExtension-Objekt in Java dar."
type: docs
weight: 726
url: /de/java/com.aspose.words/webextension/
---
...
| --- | --- |
| [getAlternateReferences()](#getAlternateReferences) | Gibt alternative Verweise auf eine WebExtension an. |
| [getBindings()](#getBindings) | Gibt eine Liste von Web-Erweiterungsbindungen an. |
| [getId()](#getId) | Identifiziert die WebExtension-Instanz im aktuellen Dokument eindeutig. |
| [getProperties()](#getProperties) | Stellt eine Menge benutzerdefinierter Eigenschaften einer WebExtension dar. |
| [getReference()](#getReference) | Gibt den primären Verweis auf eine WebExtension an. |
| [isFrozen()](#isFrozen) | Gibt an, ob der Benutzer mit der WebExtension interagieren kann oder nicht. |
| [isFrozen(boolean value)](#isFrozen-boolean) | Gibt an, ob der Benutzer mit der WebExtension interagieren kann oder nicht. |
| [setId(String value)](#setId-java.lang.String) | Identifiziert die WebExtension-Instanz im aktuellen Dokument eindeutig. |
...
Gibt alternative Verweise auf eine WebExtension an.
...
Identifiziert die WebExtension-Instanz im aktuellen Dokument eindeutig.
...
Stellt eine Menge benutzerdefinierter Eigenschaften einer WebExtension dar.
...
Gibt den primären Verweis auf eine WebExtension an.
...
Gibt an, ob der Benutzer mit der WebExtension interagieren kann oder nicht.
