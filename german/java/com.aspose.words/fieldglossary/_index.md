...
description: "Implementiert das GLOSSARY‑Feld in Java."
type: docs
weight: 239
url: /de/java/com.aspose.words/fieldglossary/
---
...
Implementiert das GLOSSARY-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Fügt einen Glossareintrag ein.

 **Examples:** 

Zeigt, wie ein Baustein mit AUTOTEXT‑ und GLOSSARY‑Feldern angezeigt wird.
...
| [getEntryName()](#getEntryName) | Liefert den Namen des einzufügenden Glossareintrags. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | Setzt den Namen des einzufügenden Glossareintrags. |
...
Liefert den Namen des einzufügenden Glossareintrags.
...
**Returns:**
java.lang.String – Der Name des einzufügenden Glossareintrags.
...
Setzt den Namen des einzufügenden Glossareintrags.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des einzufügenden Glossareintrags. |
