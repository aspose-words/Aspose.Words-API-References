...
description: "Stellt die Referenz zu einer Web-Erweiterung in Java dar."
type: docs
weight: 732
url: /de/java/com.aspose.words/webextensionreference/
---
...
Stellt die Referenz zu einer Web-Erweiterung dar. Die Referenz wird verwendet, um den Standort des Anbieters und die Version der Erweiterung zu identifizieren.
...
| --- | --- |
| [getId()](#getId) | Kennzeichen, das mit der Web-Erweiterung innerhalb eines Kataloganbieters verknüpft ist. |
| [getStore()](#getStore) | Gibt die Instanz des Marktplatzes an, in dem die Web-Erweiterung gespeichert ist. |
| [getStoreType()](#getStoreType) | Gibt den Typ des Marktplatzes an. |
| [getVersion()](#getVersion) | Gibt die Version der Web-Erweiterung an. |
| [setId(String value)](#setId-java.lang.String) | Kennzeichen, das mit der Web-Erweiterung innerhalb eines Kataloganbieters verknüpft ist. |
| [setStore(String value)](#setStore-java.lang.String) | Gibt die Instanz des Marktplatzes an, in dem die Web-Erweiterung gespeichert ist. |
| [setStoreType(int value)](#setStoreType-int) | Gibt den Typ des Marktplatzes an. |
| [setVersion(String value)](#setVersion-java.lang.String) | Gibt die Version der Web-Erweiterung an. |
### getId() {#getId}
```
public String getId()
```
...
Kennzeichen, das mit der Web-Erweiterung innerhalb eines Kataloganbieters verknüpft ist.
...
**Returns:**
int - Der entsprechende int‑Wert. Der zurückgegebene Wert ist einer der [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/) Konstanten.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | int | Der entsprechende int‑Wert. Der Wert muss einer der [WebExtensionStoreType](../../com.aspose.words/webextensionstoretype/) Konstanten sein. |
