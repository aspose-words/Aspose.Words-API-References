...
description: "Gibt die Einstellungen des Schriftart-Substitutionsmechanismus in Java an."
type: docs
weight: 337
url: /de/java/com.aspose.words/fontsubstitutionsettings/
---
...
Gibt die Einstellungen für den Schrift‑Ersetzungsmechanismus an.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Der Schriftart-Substitutionsprozess besteht aus mehreren Regeln, die nacheinander in einer bestimmten Reihenfolge geprüft werden. Wenn die erste Regel die Schriftart nicht auflösen kann, wird die zweite Regel geprüft und so weiter.

Die Reihenfolge der Regeln ist wie folgt: 1. Regel für Schriftartnamen-Substitution (standardmäßig aktiviert) 2. Regel für Schriftartkonfigurations-Substitution (standardmäßig deaktiviert) 3. Tabellen-Substitutionsregel (standardmäßig aktiviert) 4. Regel für Schriftartinfo-Substitution (standardmäßig aktiviert) 5. Standard-Schriftartregel (standardmäßig aktiviert)

Beachten Sie, dass die Regel für Schriftartinfo-Substitution die Schriftart immer auflöst, wenn [FontInfo](../../com.aspose.words/fontinfo/) verfügbar ist, und die Standard-Schriftartregel überschreibt. Wenn Sie die Standard-Schriftartregel verwenden möchten, sollten Sie die Regel für Schriftartinfo-Substitution deaktivieren.

Beachten Sie, dass die Regel für Schriftartkonfigurations-Substitution die Schriftart in den meisten Fällen auflöst und daher alle anderen Regeln überschreibt.
...
| --- | --- |
| [getDefaultFontSubstitution()](#getDefaultFontSubstitution) | Einstellungen zur Standard-Schriftart-Substitutionsregel. |
| [getFontConfigSubstitution()](#getFontConfigSubstitution) | Einstellungen zur Schriftartkonfigurations-Substitutionsregel. |
| [getFontInfoSubstitution()](#getFontInfoSubstitution) | Einstellungen zur Schriftartinfo-Substitutionsregel. |
| [getFontNameSubstitution()](#getFontNameSubstitution) | Einstellungen zur Schriftartnamen-Substitutionsregel. |
| [getTableSubstitution()](#getTableSubstitution) | Einstellungen zur Tabellen-Substitutionsregel. |
...
Einstellungen zur Standard-Schriftart-Substitutionsregel.
...
Einstellungen zur Schriftartkonfigurations-Substitutionsregel.
...
Einstellungen zur Schriftartinfo-Substitutionsregel.
...
Einstellungen zur Schriftartnamen-Substitutionsregel.
...
Einstellungen zur Tabellen-Substitutionsregel.
