...
description: "Stellt eine Sammlung von VbaReference-Objekten in Java dar."
type: docs
weight: 711
url: /de/java/com.aspose.words/vbareferencecollection/
---
...
Stellt eine Sammlung von [VbaReference](../../com.aspose.words/vbareference/) Objekten dar.
...
| --- | --- |
| [get(int index)](#get-int) | Ruft das [VbaReference](../../com.aspose.words/vbareference/) Objekt am angegebenen Index ab. |
| [getCount()](#getCount) | Gibt die Anzahl der VBA-Referenzen in der Sammlung zurück. |
| [iterator()](#iterator) |  |
| [remove(VbaReference item)](#remove-com.aspose.words.VbaReference) | Entfernt das erste Vorkommen eines angegebenen [VbaReference](../../com.aspose.words/vbareference/) Elements aus der Sammlung. |
| [removeAt(int index)](#removeAt-int) | Entfernt das [VbaReference](../../com.aspose.words/vbareference/) Element am angegebenen Index der Sammlung. |
...
Ruft das [VbaReference](../../com.aspose.words/vbareference/) Objekt am angegebenen Index ab.
...
| --- | --- | --- |
| Index | int | Der nullbasierte Index der abzurufenden Referenz. |
...
**Returns:**
int – Die Anzahl der VBA-Referenzen in der Sammlung.
### iterator() {#iterator}
```
...
Entfernt das erste Vorkommen eines angegebenen [VbaReference](../../com.aspose.words/vbareference/) Elements aus der Sammlung.
...
Entfernt das [VbaReference](../../com.aspose.words/vbareference/) Element am angegebenen Index der Sammlung.
