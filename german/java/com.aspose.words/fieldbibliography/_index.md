...
description: "Implementiert das BIBLIOGRAPHY-Feld in Java."
type: docs
weight: 207
url: /de/java/com.aspose.words/fieldbibliography/
---
...
Implementiert das BIBLIOGRAPHY-Feld.
...
| [getFilterLanguageId()](#getFilterLanguageId) | Ermittelt die Sprach-ID, die verwendet wird, um die bibliografischen Daten so zu filtern, dass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden. |
...
| [getFormatLanguageId()](#getFormatLanguageId) | Ermittelt die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren. |
...
| [getSourceTag()](#getSourceTag) | Ermittelt einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert in der Bibliografie angezeigt werden. |
...
| [setFilterLanguageId(String value)](#setFilterLanguageId-java.lang.String) | Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Daten so zu filtern, dass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden. |
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String) | Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren. |
...
| [setSourceTag(String value)](#setSourceTag-java.lang.String) | Setzt einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert in der Bibliografie angezeigt werden. |
...
Ermittelt die Sprach-ID, die verwendet wird, um die bibliografischen Daten so zu filtern, dass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden.
...
**Returns:**
java.lang.String - Die Sprach-ID, die verwendet wird, um die bibliografischen Daten so zu filtern, dass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden.
### getFormat() {#getFormat}
```
...
Ermittelt die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren.
...
**Returns:**
java.lang.String - Die Sprach-ID, die zum Formatieren der bibliografischen Quellen im Dokument verwendet wird.
...
Ermittelt einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert in der Bibliografie angezeigt werden.
...
**Returns:**
java.lang.String - Ein Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert im Literaturverzeichnis angezeigt werden.
### getStart() {#getStart}
```
...
Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Daten so zu filtern, dass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Sprach-ID, die verwendet wird, um die bibliografischen Daten zu filtern, sodass nur die Quellen im Dokument angezeigt werden, die diese Sprache verwenden. |
...
Setzt die Sprach-ID, die verwendet wird, um die bibliografischen Quellen im Dokument zu formatieren.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Sprach-ID, die zum Formatieren der bibliografischen Quellen im Dokument verwendet wird. |
...
Setzt einen Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert in der Bibliografie angezeigt werden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Wert, sodass nur die Quellen mit übereinstimmendem Tag-Elementwert im Literaturverzeichnis angezeigt werden. |
