...
description: "Implementiert das AUTHOR-Feld in Java."
type: docs
weight: 200
url: /de/java/com.aspose.words/fieldauthor/
---
...
Ruft den Namen des Dokumentautors ab und setzt ihn optional, wie in der **Author**-Eigenschaft der integrierten Dokumenteigenschaften aufgezeichnet.

 **Examples:** 

Zeigt, wie man ein AUTHOR-Feld verwendet, um den Namen des Dokumenterstellers anzuzeigen.
...
| --- | --- |
| [getAuthorName()](#getAuthorName) | Liest den Namen des Dokumentautors. |
...
| [setAuthorName(String value)](#setAuthorName-java.lang.String) | Setzt den Namen des Dokumentautors. |
...
Liest den Namen des Dokumentautors.
...
**Returns:**
java.lang.String - Der Name des Dokumentautors.
...
Setzt den Namen des Dokumentautors.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Dokumentautors. |
