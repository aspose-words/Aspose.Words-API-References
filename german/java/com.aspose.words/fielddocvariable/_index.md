...
description: "Implementiert das DOCVARIABLE-Feld in Java."
type: docs
weight: 225
url: /de/java/com.aspose.words/fielddocvariable/
---
...
| [getVariableName()](#getVariableName) | Liefert den Namen der Dokumentvariablen, die abgerufen werden soll. |
...
| [setVariableName(String value)](#setVariableName-java.lang.String) | Setzt den Namen der Dokumentvariablen, die abgerufen werden soll. |
...
Liefert den Namen der Dokumentvariablen, die abgerufen werden soll.
...
**Returns:**
java.lang.String - Der Name der Dokumentvariablen, die abgerufen werden soll.
### isDirty() {#isDirty}
```
...
Setzt den Namen der Dokumentvariablen, die abgerufen werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name der Dokumentvariablen, die abgerufen werden soll. |
