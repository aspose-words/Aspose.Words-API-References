...
description: "Implementiert das INFO-Feld in Java."
type: docs
weight: 251
url: /de/java/com.aspose.words/fieldinfo/
---
...
| [getInfoType()](#getInfoType) | Liefert den Typ der einzufügenden Dokumenteigenschaft. |
| [getLocaleId()](#getLocaleId) | Liefert die LCID des Feldes. |
| [getNewValue()](#getNewValue) | Liefert einen optionalen Wert, der die Eigenschaft aktualisiert. |
...
| [setInfoType(String value)](#setInfoType-java.lang.String) | Setzt den Typ der einzufügenden Dokumenteigenschaft. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setNewValue(String value)](#setNewValue-java.lang.String) | Setzt einen optionalen Wert, der die Eigenschaft aktualisiert. |
...
Liefert den Typ der einzufügenden Dokumenteigenschaft.
...
**Returns:**
java.lang.String - Der Typ der einzufügenden Dokumenteigenschaft.
...
Liefert einen optionalen Wert, der die Eigenschaft aktualisiert.
...
**Returns:**
java.lang.String - Ein optionaler Wert, der die Eigenschaft aktualisiert.
### getResult() {#getResult}
```
...
Setzt den Typ der einzufügenden Dokumenteigenschaft.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Typ der einzufügenden Dokumenteigenschaft. |
...
Setzt einen optionalen Wert, der die Eigenschaft aktualisiert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein optionaler Wert, der die Eigenschaft aktualisiert. |
