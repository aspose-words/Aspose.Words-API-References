...
description: "Stellt ein einzelnes benutzerdefiniertes XML-Attribut oder eine Smart‑Tag‑Eigenschaft in Java dar."
type: docs
weight: 145
url: /de/java/com.aspose.words/customxmlproperty/
---
...
Wird als Element einer [CustomXmlPropertyCollection](../../com.aspose.words/customxmlpropertycollection/) Sammlung verwendet.
...
| --- | --- |
| [CustomXmlProperty(String name, String uri, String value)](#CustomXmlProperty-java.lang.String-java.lang.String-java.lang.String) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getName()](#getName) | Gibt den Namen des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft an. |
| [getUri()](#getUri) | Ruft den Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft ab. |
| [getValue()](#getValue) | Ruft den Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft ab. |
| [setUri(String value)](#setUri-java.lang.String) | Setzt den Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft. |
| [setValue(String value)](#setValue-java.lang.String) | Setzt den Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft. |
...
| --- | --- | --- |
| name | java.lang.String | Der Name der Eigenschaft. Darf nicht null sein. |
| uri | java.lang.String | Der Namespace-URI der Eigenschaft. Darf nicht null sein. |
| Wert | java.lang.String | Der Wert der Eigenschaft. Darf nicht null sein. |
...
Standard ist eine leere Zeichenkette.
...
Ruft den Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft ab.
...
Zeigt, wie man mit Smart-Tag-Eigenschaften arbeitet, um detaillierte Informationen über Smart Tags zu erhalten.
...
**Returns:**
java.lang.String – Der Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft.
### getValue() {#getValue}
```
...
Ruft den Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft ab.
...
**Returns:**
java.lang.String – Der Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft.
...
Setzt den Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Namespace-URI des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft. |
...
Setzt den Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Wert des benutzerdefinierten XML-Attributs oder der Smart-Tag-Eigenschaft. |
