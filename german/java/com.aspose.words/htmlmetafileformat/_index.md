...
description: "Gibt das Format an, in dem Metadateien in HTML-Dokumenten in Java gespeichert werden."
type: docs
weight: 383
url: /de/java/com.aspose.words/htmlmetafileformat/
---
...
Gibt das Format an, in dem Metadateien in HTML-Dokumente gespeichert werden.
...
| Feld | Beschreibung |
| --- | --- |
| [EMF_OR_WMF](#EMF-OR-WMF) | Metadateien werden unverändert gespeichert, ohne Konvertierung. |
| [PNG](#PNG) | Metadateien werden in Raster-PNG-Bilder gerendert. |
| [SVG](#SVG) | Metadateien werden in Vektor-SVG-Bilder konvertiert. |
| [length](#length) |  |
## Methoden
...
Metadateien werden unverändert gespeichert, ohne Konvertierung.
...
Metadateien werden in Raster-PNG-Bilder gerendert.
...
Metadateien werden in Vektor-SVG-Bilder konvertiert.
