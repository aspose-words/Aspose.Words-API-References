...
description: "Stellt das Ende eines Word-Feldes in einem Dokument in Java dar."
type: docs
weight: 229
url: /de/java/com.aspose.words/fieldend/
---
...
Stellt das Ende eines Word-Feldes in einem Dokument dar.
...
| [getNodeType()](#getNodeType) | Gibt zurück [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). |
...
| [hasSeparator()](#hasSeparator) | Gibt  true  zurück, wenn dieses Feld einen Trenner hat. |
...
Ruft [DocumentVisitor.visitFieldEnd(com.aspose.words.FieldEnd)](../../com.aspose.words/documentvisitor/\#visitFieldEnd-com.aspose.words.FieldEnd) auf.
...
Gibt zurück [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END).
...
**Returns:**
int - [NodeType.FIELD\_END](../../com.aspose.words/nodetype/\#FIELD-END). Der zurückgegebene Wert ist einer der [NodeType](../../com.aspose.words/nodetype/) Konstanten.
...
Gibt  true  zurück, wenn dieses Feld einen Trenner hat.
...
**Returns:**
boolean -  true  wenn dieses Feld einen Trenner hat.
