...
description: "Implementiert das HYPERLINK-Feld in Java."
type: docs
weight: 242
url: /de/java/com.aspose.words/fieldhyperlink/
---
...
Wenn ausgewählt, bewirkt es, dass die Steuerung zur Position springt, z. B. zu einem Lesezeichen oder einer URL.

 **Examples:** 

Zeigt, wie man HYPERLINK-Felder verwendet, um Dokumente im lokalen Dateisystem zu verlinken.
...
| --- | --- |
| [getAddress()](#getAddress) | Gibt einen Ort zurück, zu dem dieser Hyperlink springt. |
...
| [getOpenInNewWindow()](#getOpenInNewWindow) | Gibt zurück, ob die Zielseite in einem neuen Webbrowser-Fenster geöffnet werden soll. |
| [getResult()](#getResult) | Ermittelt den Text, der zwischen dem Feldtrennzeichen und dem Feldende liegt. |
| [getScreenTip()](#getScreenTip) | Gibt den ScreenTip-Text für den Hyperlink zurück. |
...
| [getSubAddress()](#getSubAddress) | Gibt einen Ort in der Datei zurück, z. B. ein Lesezeichen, zu dem dieser Hyperlink springt. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTarget()](#getTarget) | Ermittelt das Ziel, zu dem der Link weitergeleitet werden soll. |
...
| [isImageMap()](#isImageMap) | Ermittelt, ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen. |
| [isImageMap(boolean value)](#isImageMap-boolean) | Legt fest, ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen. |
...
| [setAddress(String value)](#setAddress-java.lang.String) | Legt einen Ort fest, zu dem dieser Hyperlink springt. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setOpenInNewWindow(boolean value)](#setOpenInNewWindow-boolean) | Legt fest, ob die Zielseite in einem neuen Browserfenster geöffnet werden soll. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Legt den ScreenTip-Text für den Hyperlink fest. |
| [setSubAddress(String value)](#setSubAddress-java.lang.String) | Legt einen Ort in der Datei, z. B. ein Lesezeichen, fest, zu dem dieser Hyperlink springt. |
| [setTarget(String value)](#setTarget-java.lang.String) | Legt das Ziel fest, zu dem der Link weitergeleitet werden soll. |
...
Gibt einen Ort zurück, zu dem dieser Hyperlink springt.
...
**Returns:**
java.lang.String - Ein Ort, zu dem dieser Hyperlink springt.
...
Gibt zurück, ob die Zielseite in einem neuen Webbrowser-Fenster geöffnet werden soll.
...
**Returns:**
boolean - Ob die Zielseite in einem neuen Browserfenster geöffnet werden soll.
### getResult() {#getResult}
```
...
Gibt den ScreenTip-Text für den Hyperlink zurück.
...
**Returns:**
java.lang.String - Der ScreenTip-Text für den Hyperlink.
...
Gibt einen Ort in der Datei zurück, z. B. ein Lesezeichen, zu dem dieser Hyperlink springt.
...
**Returns:**
java.lang.String - Ein Ort in der Datei, z. B. ein Lesezeichen, zu dem dieser Hyperlink springt.
### getSwitchType(String switchName) {#getSwitchType-java.lang.String}
```
...
Ermittelt das Ziel, zu dem der Link weitergeleitet werden soll.
...
**Returns:**
java.lang.String - Das Ziel, zu dem der Link weitergeleitet werden soll.
### getType() {#getType}
```
public int getType()
```
...
Ermittelt, ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen.
...
**Returns:**
boolean - Ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen.
...
Legt fest, ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob Koordinaten zum Hyperlink für eine serverseitige Image-Map hinzugefügt werden sollen. |
...
Legt einen Ort fest, zu dem dieser Hyperlink springt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Ort, zu dem dieser Hyperlink springt. |
...
Legt fest, ob die Zielseite in einem neuen Browserfenster geöffnet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Zielseite in einem neuen Browserfenster geöffnet werden soll. |
...
Legt den ScreenTip-Text für den Hyperlink fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der ScreenTip-Text für den Hyperlink. |
...
Legt einen Ort in der Datei, z. B. ein Lesezeichen, fest, zu dem dieser Hyperlink springt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Ort in der Datei, z. B. ein Lesezeichen, zu dem dieser Hyperlink springt. |
...
Legt das Ziel fest, zu dem der Link weitergeleitet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das Ziel, zu dem der Link weitergeleitet werden soll. |
