...
description: "Enumeriert die verfügbaren Positionen des Task‑Pane-Objekts in Java."
type: docs
weight: 665
url: /de/java/com.aspose.words/taskpanedockstate/
---
...
Enumeriert verfügbare Positionen des Task‑Pane‑Objekts.
...
| Feld | Beschreibung |
| --- | --- |
| [LEFT](#LEFT) | Andocken des Task‑Pane an der linken Seite des Dokumentfensters. |
| [RIGHT](#RIGHT) | Andocken des Task‑Pane an der rechten Seite des Dokumentfensters. |
| [length](#length) |  |
## Methoden
...
Andocken des Task‑Pane an der linken Seite des Dokumentfensters.
...
Andocken des Task‑Pane an der rechten Seite des Dokumentfensters.
