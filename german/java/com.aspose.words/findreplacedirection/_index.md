...
description: "Gibt die Richtung für Ersetzungsoperationen in Java an."
type: docs
weight: 313
url: /de/java/com.aspose.words/findreplacedirection/
---
...
Gibt die Richtung für Ersetzungsoperationen an.
...
| Feld | Beschreibung |
| --- | --- |
| [BACKWARD](#BACKWARD) | Übereinstimmende Elemente werden von zuletzt nach zuerst ersetzt. |
| [FORWARD](#FORWARD) | Übereinstimmende Elemente werden von zuerst nach zuletzt ersetzt. |
| [length](#length) |  |
## Methoden
...
Übereinstimmende Elemente werden von zuletzt nach zuerst ersetzt.
...
Übereinstimmende Elemente werden von zuerst nach zuletzt ersetzt.
