...
description: "Wird als Wert für die BuiltInDocumentProperties.getSecurity / BuiltInDocumentProperties.setSecurityint‑Eigenschaft in Java verwendet."
type: docs
weight: 173
url: /de/java/com.aspose.words/documentsecurity/
---
...
Wird als Wert für die [BuiltInDocumentProperties.getSecurity()](../../com.aspose.words/builtindocumentproperties/\#getSecurity) / [BuiltInDocumentProperties.setSecurity(int)](../../com.aspose.words/builtindocumentproperties/\#setSecurity-int)‑Eigenschaft verwendet. Gibt das Sicherheitsniveau eines Dokuments als numerischen Wert an.
...
| Feld | Beschreibung |
| --- | --- |
| [NONE](#NONE) | Für die Eigenschaft sind keine Sicherheitszustände angegeben. |
| [PASSWORD_PROTECTED](#PASSWORD-PROTECTED) | Das Dokument ist passwortgeschützt. |
| [READ_ONLY_ENFORCED](#READ-ONLY-ENFORCED) | Das Dokument soll immer schreibgeschützt geöffnet werden. |
| [READ_ONLY_EXCEPT_ANNOTATIONS](#READ-ONLY-EXCEPT-ANNOTATIONS) | Das Dokument soll immer schreibgeschützt geöffnet werden, außer für Anmerkungen. |
| [READ_ONLY_RECOMMENDED](#READ-ONLY-RECOMMENDED) | Das Dokument soll, wenn möglich, schreibgeschützt geöffnet werden, wobei die Einstellung überschrieben werden kann. |
| [length](#length) |  |
## Methoden
...
Für die Eigenschaft sind keine Sicherheitszustände angegeben.
...
Das Dokument ist passwortgeschützt. (Hinweis: Bisher wurde dies in keinem Dokument beobachtet).
...
Das Dokument soll immer schreibgeschützt geöffnet werden.
...
Das Dokument soll immer schreibgeschützt geöffnet werden, außer für Anmerkungen.
...
Das Dokument soll, wenn möglich, schreibgeschützt geöffnet werden, wobei die Einstellung überschrieben werden kann.
