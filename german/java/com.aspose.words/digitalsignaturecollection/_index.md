...
description: "Stellt eine schreibgeschützte Sammlung digitaler Signaturen bereit, die an ein Dokument in Java angehängt sind."
type: docs
weight: 151
url: /de/java/com.aspose.words/digitalsignaturecollection/
---
...
| --- | --- |
| [get(int index)](#get-int) | Liest eine Dokumentensignatur am angegebenen Index. |
| [getCount()](#getCount) | Ermittelt die Anzahl der im Sammelobjekt enthaltenen Elemente. |
| [isValid()](#isValid) | Gibt  true  zurück, wenn alle digitalen Signaturen in dieser Sammlung gültig sind und das Dokument nicht manipuliert wurde. Gibt ebenfalls  true  zurück, wenn keine digitalen Signaturen vorhanden sind. |
...
Liest eine Dokumentensignatur am angegebenen Index.
...
| --- | --- | --- |
| Index | int | Nullbasierter Index der Signatur. |
...
**Returns:**
boolean -  true  wenn alle digitalen Signaturen in dieser Sammlung gültig sind und das Dokument nicht manipuliert wurde. Gibt außerdem  true  zurück, wenn keine digitalen Signaturen vorhanden sind.
### iterator() {#iterator}
```
