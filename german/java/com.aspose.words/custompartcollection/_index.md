...
description: "Stellt eine Sammlung von CustomPart-Objekten in Java dar."
type: docs
weight: 142
url: /de/java/com.aspose.words/custompartcollection/
---
...
Stellt eine Sammlung von [CustomPart](../../com.aspose.words/custompart/) Objekten dar.
...
Normalerweise müssen Sie keine Instanzen dieser Klasse erstellen. Sie greifen über die Eigenschaft [Document.getPackageCustomParts()](../../com.aspose.words/document/\#getPackageCustomParts) / [Document.setPackageCustomParts(com.aspose.words.CustomPartCollection)](../../com.aspose.words/document/\#setPackageCustomParts-com.aspose.words.CustomPartCollection) auf die mit dem OOXML-Paket verbundenen benutzerdefinierten Teile zu.
...
| --- | --- |
| [add(CustomPart part)](#add-com.aspose.words.CustomPart) | Fügt ein Element zur Sammlung hinzu. |
...
| [set(int index, CustomPart value)](#set-int-com.aspose.words.CustomPart) | Setzt ein Element am angegebenen Index. |
...
| --- | --- | --- |
| part | [CustomPart](../../com.aspose.words/custompart/) | Das hinzuzufügende Element. |
...
| --- | --- | --- |
| Index | int | Nullbasierter Index des Elements. |
| value | [CustomPart](../../com.aspose.words/custompart/) | Ein Element am angegebenen Index. |
