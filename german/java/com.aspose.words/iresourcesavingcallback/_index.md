...
description: "Implementieren Sie dieses Interface, wenn Sie steuern möchten, wie Aspose.Words externe Ressourcen wie Bilder, Schriftarten und CSS beim Speichern eines Dokuments als festseitiges HTML oder SVG in Java speichert."
type: docs
weight: 783
url: /de/java/com.aspose.words/iresourcesavingcallback/
---
```
...
Zeigt, wie man einen Callback verwendet, um die Ressourcen-URI zu ändern.
...
| --- | --- |
| [resourceSaving(ResourceSavingArgs args)](#resourceSaving-com.aspose.words.ResourceSavingArgs) | Wird aufgerufen, wenn Aspose.Words eine externe Ressource in das feste HTML- oder SVG-Format speichert. |
...
Wird aufgerufen, wenn Aspose.Words eine externe Ressource in das feste HTML- oder SVG-Format speichert.
