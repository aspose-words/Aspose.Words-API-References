...
description: "Implementiert das TITLE-Feld in Java."
type: docs
weight: 296
url: /de/java/com.aspose.words/fieldtitle/
---
...
Ruft den Titel des Dokuments ab und setzt ihn optional, wie in der **Title**-Eigenschaft der integrierten Dokumenteigenschaften aufgezeichnet.
...
| [getText()](#getText) | Liest den Text des Titels. |
...
| [setText(String value)](#setText-java.lang.String) | Setzt den Text des Titels. |
...
**Returns:**
java.lang.String - Der Text des Titels.
### getType() {#getType}
```
public int getType()
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text des Titels. |
