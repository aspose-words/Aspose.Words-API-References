...
description: "Implementieren Sie dieses Interface, wenn Sie Benachrichtigungen erhalten und steuern möchten, wie Aspose.Words Schriftarten beim Exportieren eines Dokuments in das HTML-Format in Java speichert."
type: docs
weight: 771
url: /de/java/com.aspose.words/ifontsavingcallback/
---
```
public interface IFontSavingCallback
```

Implementieren Sie dieses Interface, wenn Sie Benachrichtigungen erhalten und steuern möchten, wie **Aspose.Words** Schriftarten speichert, wenn ein Dokument in das HTML-Format exportiert wird.
...
| --- | --- |
| [fontSaving(FontSavingArgs args)](#fontSaving-com.aspose.words.FontSavingArgs) | Wird aufgerufen, wenn Aspose.Words dabei ist, eine Schriftressource zu speichern. |
...
Wird aufgerufen, wenn Aspose.Words dabei ist, eine Schriftressource zu speichern.
