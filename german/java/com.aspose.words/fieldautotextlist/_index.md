...
description: "Implementiert das AUTOTEXTLIST-Feld in Java."
type: docs
weight: 205
url: /de/java/com.aspose.words/fieldautotextlist/
---
...
Implementiert das AUTOTEXTLIST-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Erstellt ein Kontextmenü basierend auf AutoText-Einträgen in der aktiven Vorlage.

 **Examples:** 

Zeigt, wie man ein AUTOTEXTLIST-Feld verwendet, um aus einer Liste von AutoText-Einträgen auszuwählen.
...
| [getEntryName()](#getEntryName) | Liest den Namen des AutoText-Eintrags. |
...
| [getListStyle()](#getListStyle) | Liest den Namen des Stils, auf dem die Liste der Einträge basiert. |
...
| [getScreenTip()](#getScreenTip) | Liest den Text des anzuzeigenden ScreenTips. |
...
| [setEntryName(String value)](#setEntryName-java.lang.String) | Setzt den Namen des AutoText-Eintrags. |
| [setListStyle(String value)](#setListStyle-java.lang.String) | Setzt den Namen des Stils, auf dem die Liste der Einträge basiert. |
...
| [setScreenTip(String value)](#setScreenTip-java.lang.String) | Setzt den Text des anzuzeigenden ScreenTips. |
...
Liest den Namen des AutoText-Eintrags.
...
**Returns:**
java.lang.String - Der Name des AutoText-Eintrags.
...
Liest den Namen des Stils, auf dem die Liste der Einträge basiert.
...
**Returns:**
java.lang.String - Der Name des Stils, auf dem die Liste der Einträge basiert.
...
Liest den Text des anzuzeigenden ScreenTips.
...
**Returns:**
java.lang.String - Der Text des anzuzeigenden ScreenTips.
...
Setzt den Namen des AutoText-Eintrags.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des AutoText-Eintrags. |
...
Setzt den Namen des Stils, auf dem die Liste der Einträge basiert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Stils, auf dem die Liste der Einträge basiert. |
...
Setzt den Text des anzuzeigenden ScreenTips.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text des anzuzeigenden ScreenTips. |
