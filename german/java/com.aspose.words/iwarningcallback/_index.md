...
description: "Implementieren Sie dieses Interface, wenn Sie eine eigene benutzerdefinierte Methode bereitstellen möchten, die aufgerufen wird, um Verlust‑der‑Genauigkeit‑Warnungen zu erfassen, die beim Laden oder Speichern von Dokumenten in Java auftreten können."
type: docs
weight: 788
url: /de/java/com.aspose.words/iwarningcallback/
---
```
public interface IWarningCallback
```

Implementieren Sie dieses Interface, wenn Sie eine eigene benutzerdefinierte Methode aufrufen lassen möchten, um Verlust‑der‑Genauigkeit‑Warnungen zu erfassen, die beim Laden oder Speichern eines Dokuments auftreten können.
...
| --- | --- |
| [warning(WarningInfo info)](#warning-com.aspose.words.WarningInfo) | Aspose.Words ruft diese Methode auf, wenn ein Problem beim Laden oder Speichern eines Dokuments auftritt, das zu einem Verlust von Formatierung oder Daten‑Genauigkeit führen könnte. |
...
Aspose.Words ruft diese Methode auf, wenn ein Problem beim Laden oder Speichern eines Dokuments auftritt, das zu einem Verlust von Formatierung oder Daten‑Genauigkeit führen könnte.
