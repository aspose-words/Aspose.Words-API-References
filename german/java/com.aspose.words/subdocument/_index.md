...
description: "Stellt ein SubDocument dar – ein Verweis auf ein extern gespeichertes Dokument in Java."
type: docs
weight: 645
url: /de/java/com.aspose.words/subdocument/
---
...
Stellt ein **SubDocument** \- dar, das eine Referenz zu einem extern gespeicherten Dokument ist.
...
In dieser Version von Aspose.Words stellen [SubDocument](../../com.aspose.words/subdocument/)-Knoten keine öffentlichen Methoden und Eigenschaften zum Erstellen oder Ändern eines SubDocuments bereit. In dieser Version können Sie [SubDocument](../../com.aspose.words/subdocument/)-Knoten nicht instanziieren oder vorhandene ändern, außer sie zu löschen.

[SubDocument](../../com.aspose.words/subdocument/) can only be a child of [Paragraph](../../com.aspose.words/paragraph/).

 **Examples:** 

Zeigt, wie man auf das SubDocument eines Hauptdokuments zugreift.
...
| [getNodeType()](#getNodeType) | Gibt [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT) zurück. |
...
Gibt [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT) zurück.
...
**Returns:**
int - [NodeType.SUB\_DOCUMENT](../../com.aspose.words/nodetype/\#SUB-DOCUMENT). Der zurückgegebene Wert ist einer der [NodeType](../../com.aspose.words/nodetype/) Konstanten.
