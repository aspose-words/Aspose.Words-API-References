...
description: "Implementiert das ADVANCE‑Feld in Java."
type: docs
weight: 197
url: /de/java/com.aspose.words/fieldadvance/
---
...
Verschiebt den Ausgangspunkt, an dem der Text, der lexikalisch dem Feld folgt, nach rechts oder links, nach oben oder unten oder zu einer bestimmten horizontalen oder vertikalen Position angezeigt wird.

 **Examples:** 

Zeigt, wie man ein ADVANCE‑Feld einfügt und dessen Eigenschaften bearbeitet.
...
| [getDownOffset()](#getDownOffset) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach unten verschoben werden soll. |
...
| [getHorizontalPosition()](#getHorizontalPosition) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll. |
| [getLeftOffset()](#getLeftOffset) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach links verschoben werden soll. |
...
| [getRightOffset()](#getRightOffset) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll. |
...
| [getUpOffset()](#getUpOffset) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach oben verschoben werden soll. |
| [getVerticalPosition()](#getVerticalPosition) | Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll. |
...
| [setDownOffset(String value)](#setDownOffset-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach unten verschoben werden soll. |
| [setHorizontalPosition(String value)](#setHorizontalPosition-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll. |
| [setLeftOffset(String value)](#setLeftOffset-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach links verschoben werden soll. |
...
| [setRightOffset(String value)](#setRightOffset-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll. |
| [setUpOffset(String value)](#setUpOffset-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach oben verschoben werden soll. |
| [setVerticalPosition(String value)](#setVerticalPosition-java.lang.String) | Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll. |
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach unten verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach unten verschoben werden soll.
### getEnd() {#getEnd}
```
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll.
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach links verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach links verschoben werden soll.
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll.
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach oben verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach oben verschoben werden soll.
...
Ermittelt die Anzahl der Punkte, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll.
...
**Returns:**
java.lang.String - Die Anzahl der Punkte, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll.
### isDirty() {#isDirty}
```
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach unten verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach unten verschoben werden soll. |
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, horizontal von der linken Kante der Spalte, des Rahmens oder der Textbox verschoben werden soll. |
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach links verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach links verschoben werden soll. |
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach rechts verschoben werden soll. |
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, nach oben verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, nach oben verschoben werden soll. |
...
Legt die Anzahl der Punkte fest, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Anzahl der Punkte, um die der Text, der dem Feld folgt, vertikal von der oberen Kante der Seite verschoben werden soll. |
