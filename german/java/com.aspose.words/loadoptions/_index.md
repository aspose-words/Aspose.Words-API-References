...
description: "Ermöglicht das Angeben zusätzlicher Optionen wie Passwort oder Basis-URI beim Laden eines Dokuments in ein Document-Objekt in Java."
type: docs
weight: 435
url: /de/java/com.aspose.words/loadoptions/
---
...
Ermöglicht das Angeben zusätzlicher Optionen (wie Passwort oder Basis-URI), wenn ein Dokument in ein [Document](../../com.aspose.words/document/) Objekt geladen wird.
...
| [LoadOptions(String password)](#LoadOptions-java.lang.String) | Eine Abkürzung, um eine neue Instanz dieser Klasse mit dem angegebenen Passwort zum Laden eines verschlüsselten Dokuments zu initialisieren. |
| [LoadOptions(int loadFormat, String password, String baseUri)](#LoadOptions-int-java.lang.String-java.lang.String) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden
