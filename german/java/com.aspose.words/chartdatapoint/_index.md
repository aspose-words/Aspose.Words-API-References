...
description: "Ermöglicht die Angabe der Formatierung eines einzelnen Datenpunkts im Diagramm in Java."
type: docs
weight: 75
url: /de/java/com.aspose.words/chartdatapoint/
---
...
Bei einer Serie ist das [ChartDataPoint](../../com.aspose.words/chartdatapoint/) Objekt ein Mitglied der [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/). Die [ChartDataPointCollection](../../com.aspose.words/chartdatapointcollection/) enthält für jeden Punkt ein [ChartDataPoint](../../com.aspose.words/chartdatapoint/) Objekt.
...
| --- | --- |
| [clearFormat()](#clearFormat) | Löscht das Format dieses Datenpunkts. |
...
| [getFormat()](#getFormat) | Bietet Zugriff auf die Füll- und Linienformatierung dieses Datenpunkts. |
| [getIndex()](#getIndex) | Index des Datenpunkts, für den dieses Objekt die Formatierung anwendet. |
...
| [getMarker()](#getMarker) | Gibt den Diagrammdatenmarker an. |
...
Zeigt, wie man individuelle Formatierungen für Kategorien eines Säulendiagramms festlegt.
...
Index des Datenpunkts, für den dieses Objekt die Formatierung anwendet.
...
Gibt den Diagrammdatenmarker an.
