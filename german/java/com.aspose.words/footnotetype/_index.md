...
description: "Gibt an, ob dies in Java eine Fußnote oder eine Endnote ist."
type: docs
weight: 346
url: /de/java/com.aspose.words/footnotetype/
---
...
Gibt an, ob dies eine Fußnote oder eine Endnote ist.

 **Remarks:** 

Sowohl Fußnoten als auch Endnoten werden durch Objekte der Klasse [FOOTNOTE](../../com.aspose.words/footnotetype/\#FOOTNOTE) repräsentiert. Verwenden Sie [Footnote.getFootnoteType()](../../com.aspose.words/footnote/\#getFootnoteType), um zwischen Fußnoten und Endnoten zu unterscheiden.
...
| Feld | Beschreibung |
| --- | --- |
| [ENDNOTE](#ENDNOTE) | Das Objekt ist eine Endnote. |
| [FOOTNOTE](#FOOTNOTE) | Das Objekt ist eine Fußnote. |
| [length](#length) |  |
## Methoden
