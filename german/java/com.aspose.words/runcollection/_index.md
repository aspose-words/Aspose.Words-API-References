...
description: "Bietet typisierten Zugriff auf eine Sammlung von Run-Knoten in Java."
type: docs
weight: 594
url: /de/java/com.aspose.words/runcollection/
---
...
Bietet typisierten Zugriff auf eine Sammlung von [Run](../../com.aspose.words/run/) Knoten.
...
| [get(int index)](#get-int) | Ruft ein [Run](../../com.aspose.words/run/) am angegebenen Index ab. |
...
Ruft ein [Run](../../com.aspose.words/run/) am angegebenen Index ab.
...
Kopiert alle Runs aus der Sammlung in ein neues Array von Runs.
...
**Returns:**
com.aspose.words.Node[] - Ein Array von Durchläufen.
