...
description: "Eine Sammlung von RevisionGroup-Objekten, die Revisionsgruppen im Dokument in Java darstellen."
type: docs
weight: 583
url: /de/java/com.aspose.words/revisiongroupcollection/
---
...
Eine Sammlung von [RevisionGroup](../../com.aspose.words/revisiongroup/) Objekten, die Revisionsgruppen im Dokument darstellen.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Track Changes in a Document ][Track Changes in a Document].

 **Remarks:** 

Sie erstellen Instanzen dieser Klasse nicht direkt. Verwenden Sie die [RevisionCollection.getGroups()](../../com.aspose.words/revisioncollection/\#getGroups) Eigenschaft, um die im Dokument vorhandenen Revisionsgruppen zu erhalten.
...
| --- | --- |
| [get(int index)](#get-int) | Gibt eine Revisionsgruppe am angegebenen Index zurück. |
| [getCount()](#getCount) | Gibt die Anzahl der Revisionsgruppen in der Sammlung zurück. |
...
**Returns:**
int - Die Anzahl der Revisionsgruppen in der Sammlung.
### iterator() {#iterator}
```
