...
description: "Ermöglicht das Angeben zusätzlicher Optionen beim Laden eines LoadFormat.MARKDOWN-Dokuments in ein Document-Objekt in Java."
type: docs
weight: 454
url: /de/java/com.aspose.words/markdownloadoptions/
---
...
Ermöglicht das Angeben zusätzlicher Optionen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments in ein [Document](../../com.aspose.words/document/)-Objekt.
...
| --- | --- |
| [MarkdownLoadOptions()](#MarkdownLoadOptions) | Initialisiert eine neue Instanz der Klasse [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/). |
## Methoden
...
| [getImportUnderlineFormatting()](#getImportUnderlineFormatting) | Gibt einen booleschen Wert zurück, der angibt, ob eine Sequenz aus zwei Pluszeichen "++" als Unterstreichungs-Textformatierung erkannt werden soll. |
...
| [getPreserveEmptyLines()](#getPreserveEmptyLines) | Gibt einen booleschen Wert zurück, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments beibehalten werden sollen. |
...
| [getSoftLineBreakCharacter()](#getSoftLineBreakCharacter) | Gibt einen Zeichenwert zurück, der einen weichen Zeilenumbruch darstellt. |
...
| [setImportUnderlineFormatting(boolean value)](#setImportUnderlineFormatting-boolean) | Setzt einen booleschen Wert, der angibt, ob eine Sequenz aus zwei Pluszeichen "++" als Unterstreichungs-Textformatierung erkannt werden soll. |
...
| [setPreserveEmptyLines(boolean value)](#setPreserveEmptyLines-boolean) | Setzt einen booleschen Wert, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments beibehalten werden sollen. |
...
| [setSoftLineBreakCharacter(char value)](#setSoftLineBreakCharacter-char) | Setzt einen Zeichenwert, der einen weichen Zeilenumbruch darstellt. |
...
Initialisiert eine neue Instanz der Klasse [MarkdownLoadOptions](../../com.aspose.words/markdownloadoptions/).

 **Remarks:** 

Setzt automatisch [LoadFormat](../../com.aspose.words/loadformat/) auf [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN).
...
Gibt einen booleschen Wert zurück, der angibt, ob eine Sequenz aus zwei Pluszeichen "++" als Unterstreichungs-Textformatierung erkannt werden soll. Der Standardwert ist false.
...
**Returns:**
boolean - Ein boolescher Wert, der angibt, ob eine Sequenz aus zwei Pluszeichen "++" als Unterstreichungs-Textformatierung erkannt werden soll.
...
Gibt einen booleschen Wert zurück, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments beibehalten werden sollen. Der Standardwert ist false.

Normalerweise werden leere Zeilen zwischen Block-Elementen in Markdown ignoriert. Leere Zeilen am Anfang und Ende des Dokuments werden ebenfalls ignoriert. Diese Option ermöglicht das Importieren solcher leerer Zeilen.
...
**Returns:**
boolean - Ein boolescher Wert, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments beibehalten werden sollen.
...
Gibt einen Zeichenwert zurück, der einen weichen Zeilenumbruch darstellt. Der Standardwert ist SPACE (U+0020).

 **Remarks:** 

Hinweis: Durch das Setzen dieser Option auf [ControlChar.LINE\_BREAK\_CHAR](../../com.aspose.words/controlchar/\#LINE-BREAK-CHAR) können Sie weiche Zeilenumbrüche als harte Zeilenumbrüche laden.

 **Examples:** 

Zeigt, wie man das Zeichen für weiche Zeilenumbrüche festlegt.
...
**Returns:**
char – Ein Zeichenwert, der einen weichen Zeilenumbruch darstellt.
...
Setzt einen booleschen Wert, der angibt, ob eine Sequenz von zwei Pluszeichen \"++\" als Unterstreichungsformatierung erkannt werden soll. Der Standardwert ist false.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ein boolescher Wert, der angibt, ob eine Sequenz von zwei Pluszeichen \"++\" als Unterstreichungsformatierung erkannt werden soll. |
...
Setzt einen booleschen Wert, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments erhalten bleiben sollen. Der Standardwert ist false.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | boolean | Ein boolescher Wert, der angibt, ob leere Zeilen beim Laden eines [LoadFormat.MARKDOWN](../../com.aspose.words/loadformat/\#MARKDOWN)-Dokuments erhalten bleiben sollen. |
...
Setzt einen Zeichenwert, der einen weichen Zeilenumbruch darstellt. Der Standardwert ist SPACE (U+0020).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | char | Ein Zeichenwert, der einen weichen Zeilenumbruch darstellt. |
