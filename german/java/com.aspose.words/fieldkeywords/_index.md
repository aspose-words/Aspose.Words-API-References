...
description: "Implementiert das KEYWORDS‑Feld in Java."
type: docs
weight: 252
url: /de/java/com.aspose.words/fieldkeywords/
---
...
Implementiert das KEYWORDS-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Ruft die Schlüsselwörter des Dokuments ab und setzt sie optional, wie sie in der **Keywords**‑Eigenschaft der integrierten Dokumenteigenschaften gespeichert sind.

 **Examples:** 

Zeigt, wie man ein KEYWORDS-Feld einfügt.
...
| [getText()](#getText) | Liefert den Text der Schlüsselwörter. |
...
| [setText(String value)](#setText-java.lang.String) | Setzt den Text der Schlüsselwörter. |
...
Liefert den Text der Schlüsselwörter.
...
**Returns:**
java.lang.String – Der Text der Schlüsselwörter.
### getType() {#getType}
```
public int getType()
```
...
Setzt den Text der Schlüsselwörter.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text der Schlüsselwörter. |
