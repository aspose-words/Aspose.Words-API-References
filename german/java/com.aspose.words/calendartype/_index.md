...
description: "Gibt den Typ eines Kalenders in Java an."
type: docs
weight: 58
url: /de/java/com.aspose.words/calendartype/
---
...
| Feld | Beschreibung |
| --- | --- |
| [GREGORIAN](#GREGORIAN) | Der Gregorianische Kalender. |
| [HEBREW](#HEBREW) | Der hebräische Lunarkalender. |
| [HIJRI](#HIJRI) | Der Hijri-Lunarkalender. |
| [SAKA_ERA](#SAKA-ERA) | Der Saka-Era-Kalender. |
| [UM_AL_QURA](#UM-AL-QURA) | Der Um-al-Qura-Kalender. |
| [length](#length) |  |
## Methoden
