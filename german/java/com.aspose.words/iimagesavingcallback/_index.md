...
description: "Implementieren Sie dieses Interface, wenn Sie steuern möchten, wie Aspose.Words Bilder beim Speichern eines Dokuments als HTML in Java speichert."
type: docs
weight: 773
url: /de/java/com.aspose.words/iimagesavingcallback/
---
```
public interface IImageSavingCallback
```

Implementieren Sie dieses Interface, wenn Sie steuern möchten, wie Aspose.Words Bilder beim Speichern eines Dokuments als HTML speichert. Kann von anderen Formaten verwendet werden.

 **Examples:** 

Zeigt, wie der Bildname beim Speichern in ein Markdown-Dokument umbenannt wird.
...
| --- | --- |
| [imageSaving(ImageSavingArgs args)](#imageSaving-com.aspose.words.ImageSavingArgs) | Wird aufgerufen, wenn Aspose.Words ein Bild nach HTML speichert. |
...
Wird aufgerufen, wenn Aspose.Words ein Bild nach HTML speichert.
