...
description: "Implementieren Sie dieses Interface, wenn Sie steuern möchten, wie Daten während eines Seriendruckvorgangs in Java in Zusammenführungsfelder eingefügt werden."
type: docs
weight: 765
url: /de/java/com.aspose.words/ifieldmergingcallback/
---
```
public interface IFieldMergingCallback
```

Implementieren Sie diese Schnittstelle, wenn Sie steuern möchten, wie Daten während eines Seriendruckvorgangs in Merge-Felder eingefügt werden.
...
Zeigt, wie Bilder, die in einem Datenbank‑BLOB‑Feld gespeichert sind, in einen Bericht eingefügt werden.
...
| --- | --- |
| [fieldMerging(FieldMergingArgs args)](#fieldMerging-com.aspose.words.FieldMergingArgs) | Wird aufgerufen, wenn die Aspose.Words‑Seriendruck‑Engine dabei ist, Daten in ein Zusammenführungsfeld im Dokument einzufügen. |
| [imageFieldMerging(ImageFieldMergingArgs args)](#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs) | Wird aufgerufen, wenn die Aspose.Words‑Seriendruck‑Engine dabei ist, ein Bild in ein Zusammenführungsfeld einzufügen. |
...
Wird aufgerufen, wenn die Aspose.Words‑Seriendruck‑Engine dabei ist, Daten in ein Zusammenführungsfeld im Dokument einzufügen.
...
Wird aufgerufen, wenn die Aspose.Words‑Seriendruck‑Engine dabei ist, ein Bild in ein Zusammenführungsfeld einzufügen.
