...
description: "Implementiert das Feld AUTONUMLGL in Java."
type: docs
weight: 202
url: /de/java/com.aspose.words/fieldautonumlgl/
---
...
Fügt eine automatische Nummer im rechtlichen Format ein.

 **Examples:** 

Zeigt, wie ein Dokument mit AUTONUMLGL-Feldern organisiert wird.
...
| [getRemoveTrailingPeriod()](#getRemoveTrailingPeriod) | Ermittelt, ob die Nummer ohne abschließenden Punkt angezeigt werden soll. |
...
| [getSeparatorCharacter()](#getSeparatorCharacter) | Ermittelt das zu verwendende Trennzeichen. |
...
| [setRemoveTrailingPeriod(boolean value)](#setRemoveTrailingPeriod-boolean) | Legt fest, ob die Nummer ohne abschließenden Punkt angezeigt werden soll. |
...
| [setSeparatorCharacter(String value)](#setSeparatorCharacter-java.lang.String) | Legt das zu verwendende Trennzeichen fest. |
...
### getRemoveTrailingPeriod() {#getRemoveTrailingPeriod}
```
public boolean getRemoveTrailingPeriod()
```


Ermittelt, ob die Nummer ohne abschließenden Punkt angezeigt werden soll.
...
**Returns:**
boolean - Ob die Nummer ohne abschließenden Punkt angezeigt werden soll.
### getResult() {#getResult}
```
...
Ermittelt das zu verwendende Trennzeichen.
...
**Returns:**
java.lang.String - Das zu verwendende Trennzeichen.
### getStart() {#getStart}
```
...
### setRemoveTrailingPeriod(boolean value) {#setRemoveTrailingPeriod-boolean}
```
public void setRemoveTrailingPeriod(boolean value)
```


Legt fest, ob die Nummer ohne abschließenden Punkt angezeigt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Nummer ohne abschließenden Punkt angezeigt werden soll. |
...
### setSeparatorCharacter(String value) {#setSeparatorCharacter-java.lang.String}
```
public void setSeparatorCharacter(String value)
```


Legt das zu verwendende Trennzeichen fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das zu verwendende Trennzeichen. |
