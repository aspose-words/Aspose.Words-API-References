...
description: "Implementiert von Klassen, die Hyphenationswörterbücher in Java registrieren können."
type: docs
weight: 772
url: /de/java/com.aspose.words/ihyphenationcallback/
---
```
public interface IHyphenationCallback
```

Wird von Klassen implementiert, die Silbentrennungswörterbücher registrieren können.
...
| --- | --- |
| [requestDictionary(String language)](#requestDictionary-java.lang.String) | Benachrichtigt die Anwendung, dass das Hyphenationswörterbuch für die angegebene Sprache nicht gefunden wurde und möglicherweise registriert werden muss. |
...
Benachrichtigt die Anwendung, dass das Hyphenationswörterbuch für die angegebene Sprache nicht gefunden wurde und möglicherweise registriert werden muss.

Die Implementierung sollte ein Wörterbuch finden und es mit den **M:Aspose.Words.Hyphenation.RegisterDictionary(System.String,System.IO.Stream)**-Methoden registrieren.

Ist das Wörterbuch für die angegebene Sprache nicht verfügbar, kann die Implementierung weitere Aufrufe für dieselbe Sprache mit [Hyphenation.registerDictionary(java.lang.String, java.lang.String)](../../com.aspose.words/hyphenation/\#registerDictionary-java.lang.String--java.lang.String) und dem Wert  null  abwählen.

 **Remarks:** 

Ausnahmen, die von dieser Methode ausgelöst werden, brechen die Ausführung des Seitenlayoutprozesses ab.
