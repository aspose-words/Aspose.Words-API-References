...
description: "Implementiert das PRINT-Feld in Java."
type: docs
weight: 273
url: /de/java/com.aspose.words/fieldprint/
---
...
Eine Anweisung, die druckerspezifischen Steuerzeichen an den ausgewählten Drucker zu senden, wenn das Dokument gedruckt wird.
...
| [getPostScriptGroup()](#getPostScriptGroup) | Liefert das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden. |
| [getPrinterInstructions()](#getPrinterInstructions) | Liefert die druckerspezifischen Steuerzeichen oder PostScript-Anweisungen. |
...
| [setPostScriptGroup(String value)](#setPostScriptGroup-java.lang.String) | Setzt das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden. |
| [setPrinterInstructions(String value)](#setPrinterInstructions-java.lang.String) | Setzt die druckerspezifischen Steuerzeichen oder PostScript-Anweisungen. |
...
Liefert das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden.
...
**Returns:**
java.lang.String - Das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden.
...
Liefert die druckerspezifischen Steuerzeichen oder PostScript-Anweisungen.
...
**Returns:**
java.lang.String - Die druckerspezifischen Steuerzeichen oder PostScript-Anweisungen.
### getResult() {#getResult}
```
...
Setzt das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das Zeichenrechteck, auf das die PostScript-Anweisungen angewendet werden. |
...
Setzt die druckerspezifischen Steuerzeichen oder PostScript-Anweisungen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die druckspezifischen Steuerzeichen oder PostScript-Anweisungen. |
