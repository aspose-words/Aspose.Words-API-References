...
description: "Implementiert das TA-Feld in Java."
type: docs
weight: 292
url: /de/java/com.aspose.words/fieldta/
---
...
Definiert den Text und die Seitenzahl für einen Eintrag im Verzeichnis der Autoritäten, der von einem TOA-Feld verwendet wird.
...
| [getEntryCategory()](#getEntryCategory) | Liest die ganzzahlige Eintragskategorie, die eine Nummer ist, die der Reihenfolge der Kategorien entspricht. |
...
| [getLongCitation()](#getLongCitation) | Liest die lange Zitierung für den Eintrag. |
...
| [getShortCitation()](#getShortCitation) | Liest die kurze Zitierung für den Eintrag. |
...
| [isBold()](#isBold) | Liest, ob die Seitenzahl für den Eintrag fett formatiert werden soll. |
| [isBold(boolean value)](#isBold-boolean) | Setzt, ob die Seitenzahl für den Eintrag fett formatiert werden soll. |
...
| [isItalic()](#isItalic) | Liest, ob die Seitenzahl für den Eintrag kursiv formatiert werden soll. |
| [isItalic(boolean value)](#isItalic-boolean) | Setzt, ob die Seitenzahl für den Eintrag kursiv formatiert werden soll. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Setzt die ganzzahlige Eintragskategorie, die eine Nummer ist, die der Reihenfolge der Kategorien entspricht. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setLongCitation(String value)](#setLongCitation-java.lang.String) | Setzt die lange Zitierung für den Eintrag. |
...
| [setShortCitation(String value)](#setShortCitation-java.lang.String) | Setzt die kurze Zitierung für den Eintrag. |
...
Liest die ganzzahlige Eintragskategorie, die eine Nummer ist, die der Reihenfolge der Kategorien entspricht.
...
**Returns:**
java.lang.String - Die ganzzahlige Eintragskategorie, die eine Nummer ist, die der Reihenfolge der Kategorien entspricht.
...
Liest die lange Zitierung für den Eintrag.
...
**Returns:**
java.lang.String - Die lange Zitation für den Eintrag.
...
Liest die kurze Zitierung für den Eintrag.
...
**Returns:**
java.lang.String - Die kurze Zitation für den Eintrag.
### getStart() {#getStart}
```
...
Liest, ob die Seitenzahl für den Eintrag fett formatiert werden soll.
...
**Returns:**
boolean - Ob die Seitenzahl für den Eintrag fett formatiert werden soll.
...
Setzt, ob die Seitenzahl für den Eintrag fett formatiert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Seitenzahl für den Eintrag fett formatiert werden soll. |
...
Liest, ob die Seitenzahl für den Eintrag kursiv formatiert werden soll.
...
**Returns:**
boolean - Ob die Seitenzahl für den Eintrag kursiv formatiert werden soll.
...
Setzt, ob die Seitenzahl für den Eintrag kursiv formatiert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Seitenzahl für den Eintrag kursiv formatiert werden soll. |
...
Setzt die ganzzahlige Eintragskategorie, die eine Nummer ist, die der Reihenfolge der Kategorien entspricht.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die ganzzahlige Eintragskategorie, die eine Zahl ist, die der Reihenfolge der Kategorien entspricht. |
...
Setzt die lange Zitierung für den Eintrag.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die lange Zitation für den Eintrag. |
...
Setzt die kurze Zitierung für den Eintrag.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die kurze Zitation für den Eintrag. |
