...
description: "Eine Sammlung von Revision‑Objekten, die Änderungen im Dokument in Java darstellen."
type: docs
weight: 580
url: /de/java/com.aspose.words/revisioncollection/
---
...
Eine Sammlung von [Revision](../../com.aspose.words/revision/) Objekten, die Änderungen im Dokument darstellen.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Track Changes in a Document ][Track Changes in a Document].

 **Remarks:** 

Sie erstellen keine Instanzen dieser Klasse direkt. Verwenden Sie die Eigenschaft [Document.getRevisions()](../../com.aspose.words/document/\#getRevisions), um die in einem Dokument vorhandenen Revisionen abzurufen.
...
| --- | --- |
| [accept(IRevisionCriteria criteria)](#accept-com.aspose.words.IRevisionCriteria) | Akzeptiert Revisionen, die den angegebenen Kriterien entsprechen. |
| [acceptAll()](#acceptAll) | Akzeptiert alle Revisionen in dieser Sammlung. |
| [get(int index)](#get-int) | Gibt eine [Revision](../../com.aspose.words/revision/) am angegebenen Index zurück. |
| [getCount()](#getCount) | Gibt die Anzahl der Revisionen in der Sammlung zurück. |
| [getGroups()](#getGroups) | Sammlung von Revisionsgruppen. |
| [iterator()](#iterator) | Gibt ein Enumerator‑Objekt zurück. |
| [reject(IRevisionCriteria criteria)](#reject-com.aspose.words.IRevisionCriteria) | Verwirft Revisionen, die den angegebenen Kriterien entsprechen. |
| [rejectAll()](#rejectAll) | Verwirft alle Revisionen in dieser Sammlung. |
...
| --- | --- | --- |
| criteria | [IRevisionCriteria](../../com.aspose.words/irevisioncriteria/) | Die Implementierung von [IRevisionCriteria](../../com.aspose.words/irevisioncriteria/). |

**Returns:**
int – Die Anzahl der akzeptierten Revisionen.
### acceptAll() {#acceptAll}
```
...
Zeigt, wie man Dokumente vergleicht.
...
Gibt eine [Revision](../../com.aspose.words/revision/) am angegebenen Index zurück.
...
**Returns:**
int – Die Anzahl der Revisionen in der Sammlung.
### getGroups() {#getGroups}
```
...
Verwirft Revisionen, die den angegebenen Kriterien entsprechen.
...
**Returns:**
int – Die Anzahl der verworfenen Revisionen.
### rejectAll() {#rejectAll}
```
