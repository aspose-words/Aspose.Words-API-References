...
description: "Stellt ein einzelnes Lesezeichen in Java dar."
type: docs
weight: 41
url: /de/java/com.aspose.words/bookmark/
---
...
| --- | --- |
| [getBookmarkEnd()](#getBookmarkEnd) | Gibt den Knoten zurück, der das Ende des Lesezeichens darstellt. |
| [getBookmarkStart()](#getBookmarkStart) | Gibt den Knoten zurück, der den Anfang des Lesezeichens darstellt. |
| [getFirstColumn()](#getFirstColumn) | Gibt den nullbasierten Index der ersten Spalte des Tabellenspaltenbereichs zurück, der dem Lesezeichen zugeordnet ist. |
| [getLastColumn()](#getLastColumn) | Gibt den nullbasierten Index der letzten Spalte des Tabellenspaltenbereichs zurück, der dem Lesezeichen zugeordnet ist. |
| [getName()](#getName) | Liest den Namen des Lesezeichens. |
| [getText()](#getText) | Gibt den im Lesezeichen eingeschlossenen Text zurück. |
| [isColumn()](#isColumn) | Gibt  true  zurück, wenn dieses Lesezeichen ein Tabellenspalten-Lesezeichen ist. |
| [remove()](#remove) | Entfernt das Lesezeichen aus dem Dokument. |
| [setName(String value)](#setName-java.lang.String) | Setzt den Namen des Lesezeichens. |
| [setText(String value)](#setText-java.lang.String) | Setzt den im Lesezeichen eingeschlossenen Text. |
...
Gibt den Knoten zurück, der das Ende des Lesezeichens darstellt.
...
Gibt den Knoten zurück, der den Anfang des Lesezeichens darstellt.
...
Gibt den nullbasierten Index der ersten Spalte des Tabellenspaltenbereichs zurück, der dem Lesezeichen zugeordnet ist.

 **Remarks:** 

Gibt **-1** zurück, wenn dieses Lesezeichen kein Tabellenspalten-Lesezeichen ist.
...
**Returns:**
int - Der nullbasierte Index der ersten Spalte des Tabellenspaltenbereichs, der dem Lesezeichen zugeordnet ist.
...
Gibt den nullbasierten Index der letzten Spalte des Tabellenspaltenbereichs zurück, der dem Lesezeichen zugeordnet ist.
...
**Returns:**
int - Der nullbasierte Index der letzten Spalte des Tabellenspaltenbereichs, der dem Lesezeichen zugeordnet ist.
### getName() {#getName}
```
...
Beachten Sie, dass wenn Sie den Namen eines Lesezeichens zu einem Namen ändern, der bereits im Dokument existiert, kein Fehler angezeigt wird und beim Speichern des Dokuments nur das erste Lesezeichen gespeichert wird.
...
Gibt den im Lesezeichen eingeschlossenen Text zurück.
...
**Returns:**
java.lang.String - Der Text, der im Lesezeichen eingeschlossen ist.
### isColumn() {#isColumn}
```
...
Gibt  true  zurück, wenn dieses Lesezeichen ein Tabellenspalten-Lesezeichen ist.
...
**Returns:**
boolean -  true  wenn dieses Lesezeichen ein Tabellenspalten-Lesezeichen ist.
### remove() {#remove}
```
public void remove()
```
...
Setzt den im Lesezeichen eingeschlossenen Text.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text, der im Lesezeichen eingeschlossen ist. |
