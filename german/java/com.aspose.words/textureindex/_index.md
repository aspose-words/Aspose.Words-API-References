...
description: "Gibt die Schattierungs-Textur in Java an."
type: docs
weight: 681
url: /de/java/com.aspose.words/textureindex/
---
...
| [TEXTURE_NIL](#TEXTURE-NIL) | Gibt an, dass im aktuellen schattierten Bereich kein Muster verwendet werden soll (d.h. |
...
Gibt an, dass im aktuellen schattierten Bereich kein Muster verwendet werden soll (d.h. das Muster ist eine vollständige Füllung mit der Hintergrundfarbe).
