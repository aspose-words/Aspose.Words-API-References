...
description: "Implementiert das PAGEREF-Feld in Java."
type: docs
weight: 272
url: /de/java/com.aspose.words/fieldpageref/
---
...
Fügt die Seitenzahl ein, die das angegebene Lesezeichen für einen Querverweis enthält.

 **Examples:** 

Zeigt, wie man PAGEREF-Felder einfügt, um die relative Position von Lesezeichen anzuzeigen.
...
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Liest den Namen des Lesezeichens. |
...
| [getInsertHyperlink()](#getInsertHyperlink) | Ermittelt, ob ein Hyperlink zum markierten Absatz eingefügt werden soll. |
| [getInsertRelativePosition()](#getInsertRelativePosition) | Ermittelt, ob eine relative Position des markierten Absatzes eingefügt werden soll. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Setzt den Namen des Lesezeichens. |
| [setInsertHyperlink(boolean value)](#setInsertHyperlink-boolean) | Legt fest, ob ein Hyperlink zum markierten Absatz eingefügt werden soll. |
| [setInsertRelativePosition(boolean value)](#setInsertRelativePosition-boolean) | Legt fest, ob eine relative Position des markierten Absatzes eingefügt werden soll. |
...
Liest den Namen des Lesezeichens.
...
Ermittelt, ob ein Hyperlink zum markierten Absatz eingefügt werden soll.
...
**Returns:**
boolean - Ob ein Hyperlink zum markierten Absatz eingefügt werden soll.
...
Ermittelt, ob eine relative Position des markierten Absatzes eingefügt werden soll.
...
**Returns:**
boolean - Ob eine relative Position des markierten Absatzes eingefügt werden soll.
...
Setzt den Namen des Lesezeichens.
...
Legt fest, ob ein Hyperlink zum markierten Absatz eingefügt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob ein Hyperlink zum markierten Absatz eingefügt werden soll. |
...
Legt fest, ob eine relative Position des markierten Absatzes eingefügt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob eine relative Position des markierten Absatzes eingefügt werden soll. |
