...
description: "Implementiert das INCLUDETEXT-Feld in Java."
type: docs
weight: 248
url: /de/java/com.aspose.words/fieldincludetext/
---
...
Zeigt, wie ein INCLUDETEXT‑Feld erstellt und dessen Eigenschaften festgelegt werden.
...
| --- | --- |
| [getBookmarkName()](#getBookmarkName) | Ermittelt den Namen des Lesezeichens im einzufügenden Dokument. |
| [getDisplayResult()](#getDisplayResult) | Liefert den Text, der das angezeigte Feldresultat darstellt. |
| [getEncoding()](#getEncoding) | Ermittelt die auf die Daten in der referenzierten Datei angewendete Kodierung. |
...
| [getLockFields()](#getLockFields) | Ermittelt, ob Felder im eingefügten Dokument vor einer Aktualisierung geschützt werden sollen. |
| [getMimeType()](#getMimeType) | Ermittelt den MIME-Typ der referenzierten Datei. |
| [getNamespaceMappings()](#getNamespaceMappings) | Ermittelt die Namespace‑Zuordnungen für XPath‑Abfragen. |
...
| [getSourceFullName()](#getSourceFullName) | Ermittelt den Speicherort des Dokuments mittels einer IRI. |
| [getStart()](#getStart) | Ermittelt den Knoten, der den Beginn des Feldes darstellt. |
| [getSwitchType(String switchName)](#getSwitchType-java.lang.String) |  |
| [getTextConverter()](#getTextConverter) | Ermittelt den Namen des Textkonverters für das Format der eingefügten Datei. |
| [getType()](#getType) | Ermittelt den Microsoft‑Word‑Feldtyp. |
| [getXPath()](#getXPath) | Ermittelt XPath für den gewünschten Teil der XML‑Datei. |
| [getXslTransformation()](#getXslTransformation) | Ermittelt den Speicherort der XSL‑Transformation zur Formatierung von XML‑Daten. |
...
| [setBookmarkName(String value)](#setBookmarkName-java.lang.String) | Legt den Namen des Lesezeichens im einzufügenden Dokument fest. |
| [setEncoding(String value)](#setEncoding-java.lang.String) | Legt die auf die Daten in der referenzierten Datei angewendete Kodierung fest. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setLockFields(boolean value)](#setLockFields-boolean) | Legt fest, ob Felder im eingefügten Dokument vor einer Aktualisierung geschützt werden sollen. |
| [setMimeType(String value)](#setMimeType-java.lang.String) | Legt den MIME-Typ der referenzierten Datei fest. |
| [setNamespaceMappings(String value)](#setNamespaceMappings-java.lang.String) | Legt die Namespace‑Zuordnungen für XPath‑Abfragen fest. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Legt den Speicherort des Dokuments mittels einer IRI fest. |
| [setTextConverter(String value)](#setTextConverter-java.lang.String) | Legt den Namen des Textkonverters für das Format der eingefügten Datei fest. |
| [setXPath(String value)](#setXPath-java.lang.String) | Legt XPath für den gewünschten Teil der XML‑Datei fest. |
| [setXslTransformation(String value)](#setXslTransformation-java.lang.String) | Legt den Speicherort der XSL‑Transformation zur Formatierung von XML‑Daten fest. |
...
Ermittelt den Namen des Lesezeichens im einzufügenden Dokument.
...
**Returns:**
java.lang.String - Der Name des Lesezeichens im einzufügenden Dokument.
...
Ermittelt die auf die Daten in der referenzierten Datei angewendete Kodierung.
...
**Returns:**
java.lang.String - Die auf die Daten in der referenzierten Datei angewendete Kodierung.
### getEnd() {#getEnd}
```
...
Ermittelt, ob Felder im eingefügten Dokument vor einer Aktualisierung geschützt werden sollen.
...
**Returns:**
boolean - Ob Felder im eingefügten Dokument vor einer Aktualisierung geschützt werden sollen.
...
Ermittelt den MIME-Typ der referenzierten Datei.
...
**Returns:**
java.lang.String - Der MIME-Typ der referenzierten Datei.
...
Ermittelt die Namespace‑Zuordnungen für XPath‑Abfragen.
...
**Returns:**
java.lang.String - Die Namespace‑Zuordnungen für XPath‑Abfragen.
### getResult() {#getResult}
```
...
Ermittelt den Speicherort des Dokuments mittels einer IRI.
...
**Returns:**
java.lang.String - Der Speicherort des Dokuments unter Verwendung einer IRI.
### getStart() {#getStart}
```
...
Ermittelt den Namen des Textkonverters für das Format der eingefügten Datei.
...
**Returns:**
java.lang.String - Der Name des Textkonverters für das Format der eingebetteten Datei.
### getType() {#getType}
```
public int getType()
```
...
Ermittelt XPath für den gewünschten Teil der XML‑Datei.
...
**Returns:**
java.lang.String - XPath für den gewünschten Abschnitt der XML-Datei.
...
Ermittelt den Speicherort der XSL‑Transformation zur Formatierung von XML‑Daten.
...
**Returns:**
java.lang.String - Der Speicherort der XSL-Transformation zur Formatierung von XML-Daten.
### isDirty() {#isDirty}
```
...
Legt den Namen des Lesezeichens im einzufügenden Dokument fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Lesezeichens im einzuschließenden Dokument. |
...
Legt die auf die Daten in der referenzierten Datei angewendete Kodierung fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Kodierung, die auf die Daten in der referenzierten Datei angewendet wird. |
...
Legt fest, ob Felder im eingefügten Dokument vor einer Aktualisierung geschützt werden sollen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob Felder im eingeschlossenen Dokument vor Aktualisierungen geschützt werden sollen. |
...
Legt den MIME-Typ der referenzierten Datei fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der MIME-Typ der referenzierten Datei. |
...
Legt die Namespace‑Zuordnungen für XPath‑Abfragen fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Namespace-Zuordnungen für XPath-Abfragen. |
...
Legt den Speicherort des Dokuments mittels einer IRI fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Speicherort des Dokuments unter Verwendung einer IRI. |
...
Legt den Namen des Textkonverters für das Format der eingefügten Datei fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Textkonverters für das Format der eingebetteten Datei. |
...
Legt XPath für den gewünschten Teil der XML‑Datei fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | XPath für den gewünschten Abschnitt der XML-Datei. |
...
Legt den Speicherort der XSL‑Transformation zur Formatierung von XML‑Daten fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Speicherort der XSL-Transformation zur Formatierung von XML-Daten. |
