...
description: "Stellt alle TrueType-Schriften dar, die im System in Java installiert sind."
type: docs
weight: 651
url: /de/java/com.aspose.words/systemfontsource/
---
...
Stellt alle im System installierten TrueType-Schriften dar.
...
| [SystemFontSource(int priority)](#SystemFontSource-int) | Konstruktor. |
## Methoden
...
| [getSystemFontFolders()](#getSystemFontFolders) | Gibt System-Schriftordner zurück oder ein leeres Array, wenn die Ordner nicht zugänglich sind. |
...
Auf einigen Plattformen kann Aspose.Words Systemschriften nicht nur über Ordner, sondern auch aus anderen Quellen suchen. Zum Beispiel sucht Aspose.Words auf der Windows-Plattform Schriften auch in der Registrierung.
