...
description: "Implementiert das DATABASE‑Feld in Java."
type: docs
weight: 217
url: /de/java/com.aspose.words/fielddatabase/
---
...
| --- | --- |
| [getConnection()](#getConnection) | Liefert eine Verbindung zu den Daten. |
...
| [getFileName()](#getFileName) | Liefert den vollständigen Pfad und Dateinamen der Datenbank |
| [getFirstRecord()](#getFirstRecord) | Ermittelt die ganzzahlige Datensatznummer des ersten Datensatzes, der eingefügt werden soll. |
...
| [getFormatAttributes()](#getFormatAttributes) | Ermittelt, welche Attribute des Formats auf die Tabelle angewendet werden sollen. |
| [getInsertHeadings()](#getInsertHeadings) | Ermittelt, ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen. |
| [getInsertOnceOnMailMerge()](#getInsertOnceOnMailMerge) | Ermittelt, ob Daten am Anfang einer Zusammenführung eingefügt werden sollen. |
| [getLastRecord()](#getLastRecord) | Ermittelt die ganzzahlige Datensatznummer des letzten Datensatzes, der eingefügt werden soll. |
| [getLocaleId()](#getLocaleId) | Liefert die LCID des Feldes. |
| [getQuery()](#getQuery) | Ermittelt ein Satz von SQL-Anweisungen, die die Datenbank abfragen. |
...
| [getTableFormat()](#getTableFormat) | Ermittelt das Format, das auf das Ergebnis der Datenbankabfrage angewendet werden soll. |
...
| [setConnection(String value)](#setConnection-java.lang.String) | Legt eine Verbindung zu den Daten fest. |
| [setFileName(String value)](#setFileName-java.lang.String) | Legt den vollständigen Pfad und Dateinamen der Datenbank fest |
| [setFirstRecord(String value)](#setFirstRecord-java.lang.String) | Legt die ganzzahlige Datensatznummer des ersten Datensatzes, der eingefügt werden soll fest. |
| [setFormatAttributes(String value)](#setFormatAttributes-java.lang.String) | Legt fest, welche Attribute des Formats auf die Tabelle angewendet werden sollen. |
| [setInsertHeadings(boolean value)](#setInsertHeadings-boolean) | Legt fest, ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen. |
| [setInsertOnceOnMailMerge(boolean value)](#setInsertOnceOnMailMerge-boolean) | Legt fest, ob Daten am Anfang einer Zusammenführung eingefügt werden sollen. |
| [setLastRecord(String value)](#setLastRecord-java.lang.String) | Legt die ganzzahlige Datensatznummer des letzten Datensatzes fest, der eingefügt werden soll. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setQuery(String value)](#setQuery-java.lang.String) | Legt einen Satz von SQL-Anweisungen fest, die die Datenbank abfragen. |
...
| [setTableFormat(String value)](#setTableFormat-java.lang.String) | Legt das Format fest, das auf das Ergebnis der Datenbankabfrage angewendet werden soll. |
...
Liefert eine Verbindung zu den Daten.
...
**Returns:**
java.lang.String - Eine Verbindung zu den Daten.
...
Liefert den vollständigen Pfad und Dateinamen der Datenbank
...
**Returns:**
java.lang.String - Der vollständige Pfad und Dateiname der Datenbank
...
Ermittelt die ganzzahlige Datensatznummer des ersten Datensatzes, der eingefügt werden soll.
...
**Returns:**
java.lang.String - Die ganzzahlige Datensatznummer des ersten Datensatzes, der eingefügt werden soll.
### getFormat() {#getFormat}
```
...
Ermittelt, welche Attribute des Formats auf die Tabelle angewendet werden sollen.
...
**Returns:**
java.lang.String - Welche Attribute des Formats auf die Tabelle angewendet werden sollen.
...
Ermittelt, ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen.
...
**Returns:**
boolean - Ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen.
...
Ermittelt, ob Daten am Anfang einer Zusammenführung eingefügt werden sollen.
...
**Returns:**
boolean - Ob Daten am Anfang einer Zusammenführung eingefügt werden sollen.
...
Ermittelt die ganzzahlige Datensatznummer des letzten Datensatzes, der eingefügt werden soll.
...
**Returns:**
java.lang.String - Die ganzzahlige Datensatznummer des letzten Datensatzes, der eingefügt werden soll.
...
Ermittelt ein Satz von SQL-Anweisungen, die die Datenbank abfragen.
...
**Returns:**
java.lang.String - Ein Satz von SQL-Anweisungen, die die Datenbank abfragen.
### getResult() {#getResult}
```
...
Ermittelt das Format, das auf das Ergebnis der Datenbankabfrage angewendet werden soll.
...
**Returns:**
java.lang.String - Das Format, das auf das Ergebnis der Datenbankabfrage angewendet werden soll.
### getType() {#getType}
```
public int getType()
```
...
Legt eine Verbindung zu den Daten fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Eine Verbindung zu den Daten. |
...
Legt den vollständigen Pfad und Dateinamen der Datenbank fest
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der vollständige Pfad und Dateiname der Datenbank |
...
Legt die ganzzahlige Datensatznummer des ersten Datensatzes, der eingefügt werden soll fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die ganzzahlige Datensatznummer des ersten einzufügenden Datensatzes. |
...
Legt fest, welche Attribute des Formats auf die Tabelle angewendet werden sollen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Welche Attribute des Formats auf die Tabelle angewendet werden sollen. |
...
Legt fest, ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Feldnamen aus der Datenbank als Spaltenüberschriften in die resultierende Tabelle eingefügt werden sollen. |
...
Legt fest, ob Daten am Anfang einer Zusammenführung eingefügt werden sollen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob Daten am Anfang einer Zusammenführung eingefügt werden sollen. |
...
Legt die ganzzahlige Datensatznummer des letzten Datensatzes fest, der eingefügt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die ganzzahlige Datensatznummer des letzten einzufügenden Datensatzes. |
...
Legt einen Satz von SQL-Anweisungen fest, die die Datenbank abfragen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Satz von SQL-Anweisungen, die die Datenbank abfragen. |
...
Legt das Format fest, das auf das Ergebnis der Datenbankabfrage angewendet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das Format, das auf das Ergebnis der Datenbankabfrage angewendet werden soll. |
