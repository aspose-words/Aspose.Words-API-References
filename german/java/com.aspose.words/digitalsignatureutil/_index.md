...
description: "Stellt Methoden zum Signieren von Dokumenten in Java bereit."
type: docs
weight: 154
url: /de/java/com.aspose.words/digitalsignatureutil/
---
...
Da die digitale Signatur mit dem Dateiinhalt und nicht mit dem Document Object Model arbeitet, werden diese Methoden in einer separaten Klasse bereitgestellt.

Unterstützte Formate sind: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
| [loadSignatures(String fileName)](#loadSignatures-java.lang.String) | Lädt digitale Signaturen aus dem Dokument. |
...
| [removeAllSignatures(String srcFileName, String dstFileName)](#removeAllSignatures-java.lang.String-java.lang.String) | Entfernt alle digitalen Signaturen aus der Quelldatei und schreibt die unsignierte Datei in die Zieldatei. |
...
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder) | Signiert das Quelldokument mit dem angegebenen [CertificateHolder](../../com.aspose.words/certificateholder/) mittels digitaler Signatur und schreibt das signierte Dokument in die Zieldatei. |
| [sign(String srcFileName, String dstFileName, CertificateHolder certHolder, SignOptions signOptions)](#sign-java.lang.String-java.lang.String-com.aspose.words.CertificateHolder-com.aspose.words.SignOptions) | Signiert das Quelldokument mit dem angegebenen [CertificateHolder](../../com.aspose.words/certificateholder/) und [SignOptions](../../com.aspose.words/signoptions/) mittels digitaler Signatur und schreibt das signierte Dokument in die Zieldatei. |
### loadSignatures(InputStream stream) {#loadSignatures-java.io.InputStream}
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileName | java.lang.String | Pfad zum Dokument. |
...
Die folgenden Formate sind für das Entfernen digitaler Signaturen kompatibel: [LoadFormat.DOC](../../com.aspose.words/loadformat/\#DOC), [LoadFormat.DOT](../../com.aspose.words/loadformat/\#DOT), [LoadFormat.DOCX](../../com.aspose.words/loadformat/\#DOCX), [LoadFormat.DOTX](../../com.aspose.words/loadformat/\#DOTX), [LoadFormat.DOCM](../../com.aspose.words/loadformat/\#DOCM), [LoadFormat.DOTM](../../com.aspose.words/loadformat/\#DOTM), [LoadFormat.ODT](../../com.aspose.words/loadformat/\#ODT), [LoadFormat.OTT](../../com.aspose.words/loadformat/\#OTT).
...
Signiert das Quelldokument mit dem angegebenen [CertificateHolder](../../com.aspose.words/certificateholder/) mittels digitaler Signatur und schreibt das signierte Dokument in die Zieldatei.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| srcFileName | java.lang.String | Der Dateiname des zu signierenden Dokuments. |
| dstFileName | java.lang.String | Der Dateiname der signierten Dokumentausgabe. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | [CertificateHolder](../../com.aspose.words/certificateholder/) Objekt mit dem Zertifikat, das zum Signieren der Datei verwendet wird. |
...
Signiert das Quelldokument mit dem angegebenen [CertificateHolder](../../com.aspose.words/certificateholder/) und [SignOptions](../../com.aspose.words/signoptions/) mittels digitaler Signatur und schreibt das signierte Dokument in die Zieldatei.
...
| dstFileName | java.lang.String | Der Dateiname der signierten Dokumentausgabe. |
| certHolder | [CertificateHolder](../../com.aspose.words/certificateholder/) | [CertificateHolder](../../com.aspose.words/certificateholder/) Objekt mit dem Zertifikat, das zum Signieren der Datei verwendet wird. |
| signOptions | [SignOptions](../../com.aspose.words/signoptions/) | [SignOptions](../../com.aspose.words/signoptions/) Objekt mit verschiedenen Signieroptionen. |
