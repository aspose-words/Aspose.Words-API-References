...
description: "Das CheckBox-Steuerelement schaltet einen Wert in Java um."
type: docs
weight: 100
url: /de/java/com.aspose.words/checkboxcontrol/
---
...
Es hat drei mögliche Zustände: ausgewählt, gelöscht und weder ausgewählt noch gelöscht, was eine Kombination aus Ein- und Aus-Zuständen bedeutet.
...
| [getChecked()](#getChecked) | Ermittelt einen booleschen Wert, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht. |
...
| [setChecked(boolean value)](#setChecked-boolean) | Legt einen booleschen Wert fest, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht. |
...
Ermittelt einen booleschen Wert, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht. Der Standardwert ist  false .
...
**Returns:**
boolean - Ein boolescher Wert, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht.
...
Legt einen booleschen Wert fest, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht. Der Standardwert ist  false .
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | boolean | Ein boolescher Wert, der angibt, ob dieses [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) aktiviert ist oder nicht. |
