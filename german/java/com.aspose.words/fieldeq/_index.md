...
description: "Implementiert das EQ-Feld in Java."
type: docs
weight: 226
url: /de/java/com.aspose.words/fieldeq/
---

**Inheritance:**
java.lang.Object, [com.aspose.words.Field](../../com.aspose.words/field/)
```
public class FieldEQ extends Field
```
...
Zeigt, wie das EQ-Feld verwendet wird, um eine Vielzahl mathematischer Gleichungen anzuzeigen.
...
| --- | --- |
| [asOfficeMath()](#asOfficeMath) | Gibt das Office Math-Objekt zurück, das dem EQ-Feld entspricht. |
...
### asOfficeMath() {#asOfficeMath}
```
public OfficeMath asOfficeMath()
```


Gibt das Office Math-Objekt zurück, das dem EQ-Feld entspricht.
