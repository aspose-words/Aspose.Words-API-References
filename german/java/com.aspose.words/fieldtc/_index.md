...
description: "Implementiert das TC‑Feld in Java."
type: docs
weight: 293
url: /de/java/com.aspose.words/fieldtc/
---
...
Definiert den Text und die Seitenzahl für einen Eintrag im Inhaltsverzeichnis (einschließlich eines Abbildungsverzeichnisses), der von einem TOC‑Feld verwendet wird.
...
| [getEntryLevel()](#getEntryLevel) | Liest die Ebene des Eintrags. |
...
| [getOmitPageNumber()](#getOmitPageNumber) | Liest, ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll. |
...
| [getTypeIdentifier()](#getTypeIdentifier) | Liest einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist). |
...
| [setEntryLevel(String value)](#setEntryLevel-java.lang.String) | Setzt die Ebene des Eintrags. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setOmitPageNumber(boolean value)](#setOmitPageNumber-boolean) | Setzt, ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll. |
...
| [setTypeIdentifier(String value)](#setTypeIdentifier-java.lang.String) | Setzt einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist). |
...
**Returns:**
java.lang.String - Die Ebene des Eintrags.
...
Liest, ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll.
...
**Returns:**
boolean - Ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll.
### getPageNumber() {#getPageNumber}
```
...
Liest einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist).
...
**Returns:**
java.lang.String - Ein Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist).
### hasBookmark() {#hasBookmark}
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Ebene des Eintrags. |
...
Setzt, ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Seitenzahl im TOC für dieses Feld weggelassen werden soll. |
...
Setzt einen Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist).
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Typbezeichner für dieses Feld (der typischerweise ein Buchstabe ist). |
