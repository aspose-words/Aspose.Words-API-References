...
description: "Stellt einen Typ einer Diagrammachsen-Gruppe in Java dar."
type: docs
weight: 27
url: /de/java/com.aspose.words/axisgroup/
---
...
Stellt einen Typ einer Diagrammachsgruppe dar.
...
| Feld | Beschreibung |
| --- | --- |
| [PRIMARY](#PRIMARY) | Gibt die primäre Achsengruppe an. |
| [SECONDARY](#SECONDARY) | Gibt die sekundäre Achsengruppe an. |
| [length](#length) |  |
## Methoden
...
Gibt die primäre Achsengruppe an.
...
Gibt die sekundäre Achsengruppe an.
