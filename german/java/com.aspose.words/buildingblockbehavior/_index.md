...
description: "Gibt das Verhalten an, das auf den Inhalt des Bausteins angewendet werden soll, wenn er in das Hauptdokument in Java eingefügt wird."
type: docs
weight: 53
url: /de/java/com.aspose.words/buildingblockbehavior/
---
...
Gibt das Verhalten an, das auf den Inhalt des Building Blocks angewendet werden soll, wenn er in das Hauptdokument eingefügt wird.

 **Remarks:** 

Entspricht dem Typ **ST\_DocPartBehavior** in OOXML.
...
| Feld | Beschreibung |
| --- | --- |
| [CONTENT](#CONTENT) | Gibt an, dass der Baustein als Inline-Inhalt eingefügt werden soll. |
| [DEFAULT](#DEFAULT) | Entspricht [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT). |
| [PAGE](#PAGE) | Gibt an, dass der Baustein in einer eigenen Seite hinzugefügt werden soll. |
| [PARAGRAPH](#PARAGRAPH) | Gibt an, dass der Baustein in einen eigenen Absatz eingefügt werden soll. |
| [length](#length) |  |
## Methoden
...
Gibt an, dass der Baustein als Inline-Inhalt eingefügt werden soll.
...
Entspricht [CONTENT](../../com.aspose.words/buildingblockbehavior/\#CONTENT).
...
Gibt an, dass der Baustein in einer eigenen Seite hinzugefügt werden soll.
...
Gibt an, dass der Baustein in einen eigenen Absatz eingefügt werden soll.
