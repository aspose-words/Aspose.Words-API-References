...
description: "Implementiert das FILESIZE-Feld in Java."
type: docs
weight: 231
url: /de/java/com.aspose.words/fieldfilesize/
---
...
Implementiert das FILESIZE-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Ruft die Größe der Datei des aktuellen Dokuments ab oder 0, wenn die Größe nicht ermittelt werden kann.

In der aktuellen Implementierung wird die [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName)-Eigenschaft verwendet, um den Dateinamen abzurufen, der zur Bestimmung der Dateigröße verwendet wird.
...
| [isInKilobytes()](#isInKilobytes) | Ermittelt, ob die Dateigröße in Kilobyte angezeigt werden soll. |
| [isInKilobytes(boolean value)](#isInKilobytes-boolean) | Legt fest, ob die Dateigröße in Kilobyte angezeigt werden soll. |
| [isInMegabytes()](#isInMegabytes) | Ermittelt, ob die Dateigröße in Megabyte angezeigt werden soll. |
| [isInMegabytes(boolean value)](#isInMegabytes-boolean) | Legt fest, ob die Dateigröße in Megabyte angezeigt werden soll. |
...
Ermittelt, ob die Dateigröße in Kilobyte angezeigt werden soll.
...
**Returns:**
boolean - Ob die Dateigröße in Kilobyte angezeigt werden soll.
...
Legt fest, ob die Dateigröße in Kilobyte angezeigt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Dateigröße in Kilobyte angezeigt werden soll. |
...
Ermittelt, ob die Dateigröße in Megabyte angezeigt werden soll.
...
**Returns:**
boolean - Ob die Dateigröße in Megabyte angezeigt werden soll.
...
Legt fest, ob die Dateigröße in Megabyte angezeigt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Dateigröße in Megabyte angezeigt werden soll. |
