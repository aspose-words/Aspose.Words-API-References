...
description: "Implementiert das GREETINGLINE-Feld in Java."
type: docs
weight: 241
url: /de/java/com.aspose.words/fieldgreetingline/
---
...
| --- | --- |
| [getAlternateText()](#getAlternateText) | Liefert den Text, der in das Feld eingefügt wird, wenn der Name leer ist. |
...
| [getLanguageId()](#getLanguageId) | Liefert die Sprach-ID, die zum Formatieren des Namens verwendet wird. |
| [getLocaleId()](#getLocaleId) | Liefert die LCID des Feldes. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameFormat()](#getNameFormat) | Ermittelt das Format des im Feld enthaltenen Namens. |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String) | Legt den Text fest, der im Feld eingefügt wird, wenn der Name leer ist. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Legt die Sprach-ID fest, die zum Formatieren des Namens verwendet wird. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setNameFormat(String value)](#setNameFormat-java.lang.String) | Legt das Format des im Feld enthaltenen Namens fest. |
...
Liefert den Text, der in das Feld eingefügt wird, wenn der Name leer ist.
...
**Returns:**
java.lang.String - Der Text, der im Feld eingefügt wird, wenn der Name leer ist.
...
Liefert die Sprach-ID, die zum Formatieren des Namens verwendet wird.
...
**Returns:**
java.lang.String - Die Sprach-ID, die zum Formatieren des Namens verwendet wird.
...
Ermittelt das Format des im Feld enthaltenen Namens.
...
**Returns:**
java.lang.String - Das Format des im Feld enthaltenen Namens.
### getResult() {#getResult}
```
...
Legt den Text fest, der im Feld eingefügt wird, wenn der Name leer ist.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text, der im Feld eingefügt wird, wenn der Name leer ist. |
...
Legt die Sprach-ID fest, die zum Formatieren des Namens verwendet wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Sprach-ID, die zum Formatieren des Namens verwendet wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das Format des im Feld enthaltenen Namens. |
