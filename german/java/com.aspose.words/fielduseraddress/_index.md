...
description: "Implementiert das USERADDRESS-Feld in Java."
type: docs
weight: 303
url: /de/java/com.aspose.words/fielduseraddress/
---
...
| [getUserAddress()](#getUserAddress) | Liefert die aktuelle Postadresse des Benutzers. |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String) | Setzt die aktuelle Postadresse des Benutzers. |
...
Liefert die aktuelle Postadresse des Benutzers.
...
**Returns:**
java.lang.String - Die aktuelle Postadresse des Benutzers.
### isDirty() {#isDirty}
```
...
Setzt die aktuelle Postadresse des Benutzers.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die aktuelle Postadresse des Benutzers. |
