...
description: "Implementieren Sie dieses Interface, wenn Sie eine eigene benutzerdefinierte Methode während einer Suchen‑und‑Ersetzen‑Operation in Java aufrufen möchten."
type: docs
weight: 781
url: /de/java/com.aspose.words/ireplacingcallback/
---
```
public interface IReplacingCallback
```

Implementieren Sie dieses Interface, wenn Sie eine eigene benutzerdefinierte Methode während einer Suchen‑und‑Ersetzen‑Operation aufrufen lassen möchten.
...
| --- | --- |
| [replacing(ReplacingArgs args)](#replacing-com.aspose.words.ReplacingArgs) | Eine benutzerdefinierte Methode, die während einer Ersetzungsoperation für jedes gefundene Ergebnis unmittelbar vor dem Ersetzen aufgerufen wird. |
...
Eine benutzerdefinierte Methode, die während einer Ersetzungsoperation für jedes gefundene Ergebnis unmittelbar vor dem Ersetzen aufgerufen wird.
...
**Returns:**
int – Ein [ReplaceAction](../../com.aspose.words/replaceaction/)‑Wert, der die für das aktuelle Ergebnis auszuführende Aktion angibt. Der zurückgegebene Wert ist einer der [ReplaceAction](../../com.aspose.words/replaceaction/)‑Konstanten.
