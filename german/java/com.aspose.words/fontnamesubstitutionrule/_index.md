...
description: "Schriftart‑Substitutionsregel zur Verarbeitung von Schriftartnamen in Java."
type: docs
weight: 329
url: /de/java/com.aspose.words/fontnamesubstitutionrule/
---
...
Schrift‑Ersetzungsregel zur Verarbeitung des Schriftnamens.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Gemäß dieser Regel versucht Aspose.Words, den Schriftartnamen zu verarbeiten, um die Substitution zu erhalten. Insbesondere versucht Aspose.Words, Suffixe mit den Trennzeichen '-', ',' und '(' zu entfernen, wie es MS Word tut.
