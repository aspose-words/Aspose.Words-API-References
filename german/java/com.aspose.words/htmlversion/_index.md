...
description: "Gibt an, welche HTML‑Version beim Speichern des Dokuments in den Formaten SaveFormat.HTML und SaveFormat.MHTML in Java verwendet wird."
type: docs
weight: 386
url: /de/java/com.aspose.words/htmlversion/
---
...
Gibt an, welche HTML‑Version beim Speichern des Dokuments in den Formaten [SaveFormat.HTML](../../com.aspose.words/saveformat/\#HTML) und [SaveFormat.MHTML](../../com.aspose.words/saveformat/\#MHTML) verwendet wird.

 **Examples:** 

Zeigt, wie man ein Dokument in einer bestimmten HTML‑Version speichert.
