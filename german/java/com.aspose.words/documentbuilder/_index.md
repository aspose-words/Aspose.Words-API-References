...
description: "Stellt Methoden zum Einfügen von Text, Bildern und anderem Inhalt sowie zum Festlegen von Schriftart-, Absatz- und Abschnittsformatierungen in Java bereit."
type: docs
weight: 163
url: /de/java/com.aspose.words/documentbuilder/
---
...
Stellt Methoden zum Einfügen von Text, Bildern und anderem Inhalt sowie zum Festlegen von Schriftart-, Absatz- und Abschnittsformatierungen bereit.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Document Builder Overview ][Document Builder Overview].
...
Erstellen Sie einen [DocumentBuilder](../../com.aspose.words/documentbuilder/) und verknüpfen Sie ihn mit einem [Document](../../com.aspose.words/document/).

Der [DocumentBuilder](../../com.aspose.words/documentbuilder/) verfügt über einen internen Cursor, an dem der Text eingefügt wird, wenn Sie [write(java.lang.String)](../../com.aspose.words/documentbuilder/\#write-java.lang.String), [writeln(java.lang.String)](../../com.aspose.words/documentbuilder/\#writeln-java.lang.String) oder **M:Aspose.Words.DocumentBuilder.InsertBreak(Aspose.Words.BreakType)** aufrufen, sowie andere Methoden. Sie können den Cursor des [DocumentBuilder](../../com.aspose.words/documentbuilder/) zu einer anderen Position in einem Dokument navigieren, indem Sie verschiedene MoveToXXX‑Methoden verwenden.

Verwenden Sie die Eigenschaft [getFont()](../../com.aspose.words/documentbuilder/\#getFont), um die Zeichenformatierung festzulegen, die auf allen ab der aktuellen Position im Dokument eingefügten Text angewendet wird.

Verwenden Sie die Eigenschaft [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat), um die Absatzformatierung für den aktuellen und alle eingefügten Absätze festzulegen.

Verwenden Sie die Eigenschaft [getPageSetup()](../../com.aspose.words/documentbuilder/\#getPageSetup), um Seiten- und Abschnittseigenschaften für den aktuellen Abschnitt und alle eingefügten Abschnitte festzulegen.

Verwenden Sie die Eigenschaften [getCellFormat()](../../com.aspose.words/documentbuilder/\#getCellFormat) und [getRowFormat()](../../com.aspose.words/documentbuilder/\#getRowFormat), um Formatierungseigenschaften für Tabellenzellen und -zeilen festzulegen. Verwenden Sie die Methoden [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell) und [endRow()](../../com.aspose.words/documentbuilder/\#endRow), um eine Tabelle zu erstellen.

Beachten Sie, dass die Eigenschaften [getFont()](../../com.aspose.words/documentbuilder/\#getFont), [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat) und [getPageSetup()](../../com.aspose.words/documentbuilder/\#getPageSetup) aktualisiert werden, sobald Sie zu einer anderen Stelle im Dokument navigieren, um die dort verfügbaren Formatierungseigenschaften widerzuspiegeln.
...
| [DocumentBuilder(DocumentBuilderOptions options)](#DocumentBuilder-com.aspose.words.DocumentBuilderOptions) | Initialisiert eine neue Instanz dieser Klasse. |
| [DocumentBuilder(Document doc)](#DocumentBuilder-com.aspose.words.Document) | Initialisiert eine neue Instanz dieser Klasse. |
| [DocumentBuilder(Document doc, DocumentBuilderOptions options)](#DocumentBuilder-com.aspose.words.Document-com.aspose.words.DocumentBuilderOptions) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden
...
| [deleteRow(int tableIndex, int rowIndex)](#deleteRow-int-int) | Löscht eine Zeile aus einer Tabelle. |
| [endBookmark(String bookmarkName)](#endBookmark-java.lang.String) | Markiert die aktuelle Position im Dokument als Lesezeichenende. |
| [endColumnBookmark(String bookmarkName)](#endColumnBookmark-java.lang.String) | Markiert die aktuelle Position im Dokument als Spalten-Lesezeichen-Ende. |
| [endEditableRange()](#endEditableRange) | Markiert die aktuelle Position im Dokument als Ende eines bearbeitbaren Bereichs. |
| [endEditableRange(EditableRangeStart start)](#endEditableRange-com.aspose.words.EditableRangeStart) | Markiert die aktuelle Position im Dokument als Ende eines bearbeitbaren Bereichs. |
...
| [getCellFormat()](#getCellFormat) | Gibt ein Objekt zurück, das die aktuellen Formatierungseigenschaften der Tabellenzelle darstellt. |
| [getCurrentNode()](#getCurrentNode) | Ermittelt den Knoten, der derzeit in diesem DocumentBuilder ausgewählt ist. |
| [getCurrentParagraph()](#getCurrentParagraph) | Ermittelt den Absatz, der derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist. |
| [getCurrentSection()](#getCurrentSection) | Ermittelt den Abschnitt, der derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist. |
| [getCurrentStory()](#getCurrentStory) | Ermittelt die Story, die derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist. |
| [getCurrentStructuredDocumentTag()](#getCurrentStructuredDocumentTag) | Ermittelt das strukturierte Dokument-Tag, das derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist. |
...
| [getDocument()](#getDocument) | Ermittelt das [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document)-Objekt, an das dieses Objekt angehängt ist. |
| [getFont()](#getFont) | Gibt ein Objekt zurück, das die aktuellen Schriftformatierungseigenschaften darstellt. |
| [getItalic()](#getItalic) | True, wenn die Schriftart als kursiv formatiert ist. |
| [getListFormat()](#getListFormat) | Gibt ein Objekt zurück, das die aktuellen Listformatierungseigenschaften darstellt. |
| [getPageSetup()](#getPageSetup) | Gibt ein Objekt zurück, das die aktuellen Seiteneinrichtungs- und Abschnittseigenschaften darstellt. |
| [getParagraphFormat()](#getParagraphFormat) | Gibt ein Objekt zurück, das die aktuellen Absatzformatierungseigenschaften darstellt. |
| [getRowFormat()](#getRowFormat) | Gibt ein Objekt zurück, das die aktuellen Tabellenzeilenformatierungseigenschaften darstellt. |
| [getUnderline()](#getUnderline) | Ermittelt/legt den Unterstreichungsstil für die aktuelle Schrift fest. |
...
| [insertCheckBox(String name, boolean defaultValue, boolean checkedValue, int size)](#insertCheckBox-java.lang.String-boolean-boolean-int) | Fügt ein Kontrollkästchen-Formularfeld an der aktuellen Position ein. |
| [insertCheckBox(String name, boolean checkedValue, int size)](#insertCheckBox-java.lang.String-boolean-int) | Fügt ein Kontrollkästchen-Formularfeld an der aktuellen Position ein. |
| [insertComboBox(String name, String[] items, int selectedIndex)](#insertComboBox-java.lang.String-java.lang.String---int) | Fügt ein Kombinationsfeld-Formularfeld an der aktuellen Position ein. |
...
| [insertField(String fieldCode)](#insertField-java.lang.String) | Fügt ein Word-Feld in ein Dokument ein und aktualisiert das Feldresultat. |
| [insertField(String fieldCode, String fieldValue)](#insertField-java.lang.String-java.lang.String) | Fügt ein Word-Feld in ein Dokument ein, ohne das Feldresultat zu aktualisieren. |
...
| [insertForms2OleControl(Forms2OleControl forms2OleControl)](#insertForms2OleControl-com.aspose.words.Forms2OleControl) | Fügt ein [Forms2OleControl](../../com.aspose.words/forms2olecontrol/)-Objekt an der aktuellen Position ein.. |
| [insertGroupShape(ShapeBase[] shapes)](#insertGroupShape-com.aspose.words.ShapeBase...) | Gruppiert die als Parameter übergebenen Formen in einen neuen GroupShape-Knoten, der an der aktuellen Position eingefügt wird. |
| [insertGroupShape(double left, double top, double width, double height, ShapeBase[] shapes)](#insertGroupShape-double-double-double-double-com.aspose.words.ShapeBase...) | Gruppiert die als Parameter übergebenen Formen in einen neuen GroupShape-Knoten mit der angegebenen Größe, der an der angegebenen Position eingefügt wird. |
| [insertHorizontalRule()](#insertHorizontalRule) | Fügt eine horizontale Linienform in das Dokument ein. |
| [insertHtml(String html)](#insertHtml-java.lang.String) | Fügt eine HTML-Zeichenkette in das Dokument ein. |
| [insertHtml(String html, boolean useBuilderFormatting)](#insertHtml-java.lang.String-boolean) | Fügt eine HTML-Zeichenkette in das Dokument ein. |
| [insertHtml(String html, int options)](#insertHtml-java.lang.String-int) |  |
| [insertHyperlink(String displayText, String urlOrBookmark, boolean isBookmark)](#insertHyperlink-java.lang.String-java.lang.String-boolean) | Fügt einen Hyperlink in das Dokument ein. |
| [insertImage(byte[] imageBytes)](#insertImage-byte) | Fügt ein Bild aus einem Byte-Array in das Dokument ein. |
| [insertImage(byte[] imageBytes, double width, double height)](#insertImage-byte---double-double) | Fügt ein Inline-Bild aus einem Byte-Array in das Dokument ein und skaliert es auf die angegebene Größe. |
...
| [insertImage(BufferedImage image)](#insertImage-java.awt.image.BufferedImage) | Fügt ein Bild in das Dokument ein. |
| [insertImage(BufferedImage image, double width, double height)](#insertImage-java.awt.image.BufferedImage-double-double) | Fügt ein Inline-Bild aus einem java.awt.image.BufferedImage-Objekt in das Dokument ein und skaliert es auf die angegebene Größe. |
...
| [insertImage(String fileName)](#insertImage-java.lang.String) | Fügt ein Bild aus einer Datei oder URL in das Dokument ein. |
| [insertImage(String fileName, double width, double height)](#insertImage-java.lang.String-double-double) | Fügt ein Inline-Bild aus einer Datei oder URL in das Dokument ein und skaliert es auf die angegebene Größe. |
...
| [insertNode(Node node)](#insertNode-com.aspose.words.Node) | Fügt einen Knoten vor dem Cursor ein. |
...
| [insertOleObjectAsIcon(String fileName, boolean isLinked, String iconFile, String iconCaption)](#insertOleObjectAsIcon-java.lang.String-boolean-java.lang.String-java.lang.String) | Fügt ein eingebettetes oder verknüpftes OLE-Objekt als Symbol in das Dokument ein. |
| [insertOleObjectAsIcon(String fileName, String progId, boolean isLinked, String iconFile, String iconCaption)](#insertOleObjectAsIcon-java.lang.String-java.lang.String-boolean-java.lang.String-java.lang.String) | Fügt ein eingebettetes oder verknüpftes OLE-Objekt als Symbol in das Dokument ein. |
| [insertOnlineVideo(String videoUrl, double width, double height)](#insertOnlineVideo-java.lang.String-double-double) | Fügt ein Online-Video-Objekt in das Dokument ein und skaliert es auf die angegebene Größe. |
...
| [insertOnlineVideo(String videoUrl, String videoEmbedCode, byte[] thumbnailImageBytes, double width, double height)](#insertOnlineVideo-java.lang.String-java.lang.String-byte---double-double) | Fügt ein Online-Video-Objekt in das Dokument ein und skaliert es auf die angegebene Größe. |
...
| [insertSignatureLine(SignatureLineOptions signatureLineOptions)](#insertSignatureLine-com.aspose.words.SignatureLineOptions) | Fügt eine Signaturzeile an der aktuellen Position ein. |
...
| [insertStyleSeparator()](#insertStyleSeparator) | Fügt einen Stiltrennzeichen in das Dokument ein. |
| [insertTableOfContents(String switches)](#insertTableOfContents-java.lang.String) | Fügt ein TOC (Inhaltsverzeichnis)-Feld in das Dokument ein. |
...
| [isAtEndOfParagraph()](#isAtEndOfParagraph) | Gibt  true  zurück, wenn der Cursor am Ende des aktuellen Absatzes ist. |
| [isAtEndOfStructuredDocumentTag()](#isAtEndOfStructuredDocumentTag) | Gibt **true** zurück, wenn der Cursor am Ende eines strukturierten Dokumenttags ist. |
| [isAtStartOfParagraph()](#isAtStartOfParagraph) | Gibt  true  zurück, wenn der Cursor am Anfang des aktuellen Absatzes ist (kein Text vor dem Cursor). |
| [moveTo(Node node)](#moveTo-com.aspose.words.Node) | Bewegt den Cursor zu einem Inline-Knoten oder zum Ende eines Absatzes. |
| [moveToBookmark(String bookmarkName)](#moveToBookmark-java.lang.String) | Bewegt den Cursor zu einem Lesezeichen. |
| [moveToBookmark(String bookmarkName, boolean isStart, boolean isAfter)](#moveToBookmark-java.lang.String-boolean-boolean) | Bewegt den Cursor zu einem Lesezeichen mit höherer Präzision. |
| [moveToCell(int tableIndex, int rowIndex, int columnIndex, int characterIndex)](#moveToCell-int-int-int-int) | Bewegt den Cursor zu einer Tabellenzelle im aktuellen Abschnitt. |
...
| [moveToField(Field field, boolean isAfter)](#moveToField-com.aspose.words.Field-boolean) | Bewegt den Cursor zu einem Feld im Dokument. |
| [moveToHeaderFooter(int headerFooterType)](#moveToHeaderFooter-int) |  |
| [moveToMergeField(String fieldName)](#moveToMergeField-java.lang.String) | Bewegt den Cursor zum angegebenen Zusammenführungsfeld. |
| [moveToMergeField(String fieldName, boolean isAfter, boolean isDeleteField)](#moveToMergeField-java.lang.String-boolean-boolean) | Verschiebt das Zusammenführungsfeld zum angegebenen Zusammenführungsfeld. |
| [moveToParagraph(int paragraphIndex, int characterIndex)](#moveToParagraph-int-int) | Bewegt den Cursor zu einem Absatz im aktuellen Abschnitt. |
| [moveToSection(int sectionIndex)](#moveToSection-int) | Bewegt den Cursor zum Anfang des Hauptbereichs in einem angegebenen Abschnitt. |
| [moveToStructuredDocumentTag(StructuredDocumentTag structuredDocumentTag, int characterIndex)](#moveToStructuredDocumentTag-com.aspose.words.StructuredDocumentTag-int) | Bewegt den Cursor zum strukturierten Dokument-Tag. |
| [moveToStructuredDocumentTag(int structuredDocumentTagIndex, int characterIndex)](#moveToStructuredDocumentTag-int-int) | Bewegt den Cursor zu einem strukturierten Dokument-Tag im aktuellen Abschnitt. |
| [popFont()](#popFont) | Ruft die zuvor im Stack gespeicherte Zeichenformatierung ab. |
| [pushFont()](#pushFont) | Speichert die aktuelle Zeichenformatierung im Stack. |
...
| [setDocument(Document value)](#setDocument-com.aspose.words.Document) | Setzt das [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document) Objekt, an das dieses Objekt angehängt ist. |
...
| [setUnderline(int value)](#setUnderline-int) | Ermittelt/legt den Unterstreichungsstil für die aktuelle Schrift fest. |
| [startBookmark(String bookmarkName)](#startBookmark-java.lang.String) | Markiert die aktuelle Position im Dokument als Lesezeichenanfang. |
| [startColumnBookmark(String bookmarkName)](#startColumnBookmark-java.lang.String) | Markiert die aktuelle Position im Dokument als Spalten-Lesezeichenanfang. |
| [startEditableRange()](#startEditableRange) | Markiert die aktuelle Position im Dokument als Beginn eines bearbeitbaren Bereichs. |
| [startTable()](#startTable) | Startet eine Tabelle im Dokument. |
| [write(String text)](#write-java.lang.String) | Fügt eine Zeichenkette in das Dokument an der aktuellen Einfügeposition ein. |
| [writeln()](#writeln) | Fügt einen Absatzumbruch in das Dokument ein. |
| [writeln(String text)](#writeln-java.lang.String) | Fügt eine Zeichenkette und einen Absatzumbruch in das Dokument ein. |
...
Erstellt ein neues [DocumentBuilder](../../com.aspose.words/documentbuilder/) Objekt und hängt es an ein neues [Document](../../com.aspose.words/document/) Objekt.
...
Erstellt ein neues [DocumentBuilder](../../com.aspose.words/documentbuilder/) Objekt und hängt es an ein neues [Document](../../com.aspose.words/document/) Objekt. Zusätzliche Optionen für den Dokumentaufbau können angegeben werden.
...
Erstellt ein neues [DocumentBuilder](../../com.aspose.words/documentbuilder/) Objekt, hängt es an das angegebene [Document](../../com.aspose.words/document/) Objekt. Der Cursor wird am Anfang des Dokuments positioniert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | Das [Document](../../com.aspose.words/document/) Objekt, an das angehängt werden soll. |
...
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | Das [Document](../../com.aspose.words/document/) Objekt, an das angehängt werden soll. |
| options | [DocumentBuilderOptions](../../com.aspose.words/documentbuilderoptions/) | Zusätzliche Optionen für den Dokumentaufbauprozess. |
...
Wenn sich der Cursor innerhalb der Zeile befindet, die gelöscht wird, wird er zur nächsten Zeile oder zum nächsten Absatz nach der Tabelle verschoben.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| tableIndex | int | Der Index der Tabelle. |
| rowIndex | int | Der Index der Zeile in der Tabelle. |
...
Lesezeichen in einem Dokument können sich überschneiden und beliebige Bereiche umfassen. Um ein gültiges Lesezeichen zu erstellen, müssen Sie sowohl [startBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#startBookmark-java.lang.String) als auch [endBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#endBookmark-java.lang.String) mit dem gleichen  bookmarkName  Parameter aufrufen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| bookmarkName | java.lang.String | Name des Lesezeichens. |
...
Markiert die aktuelle Position im Dokument als Ende eines Spalten-Lesezeichens. Die Position muss sich in einer Tabellenzelle befinden.

 **Remarks:** 

Ein Spalten-Lesezeichen umfasst eine oder mehrere Spalten in einem Zeilenbereich. Um ein gültiges Lesezeichen zu erstellen, müssen Sie sowohl [startColumnBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#startColumnBookmark-java.lang.String) als auch [endColumnBookmark(java.lang.String)](../../com.aspose.words/documentbuilder/\#endColumnBookmark-java.lang.String) mit dem gleichen  bookmarkName  Parameter aufrufen.

Fehlerhaft gebildete Lesezeichen oder Lesezeichen mit doppelten Namen werden beim Speichern des Dokuments ignoriert.

Die tatsächliche Position des eingefügten [BookmarkEnd](../../com.aspose.words/bookmarkend/) Knotens kann von der aktuellen Position des DocumentBuilder abweichen.
...
Ein bearbeitbarer Bereich in einem Dokument kann sich überschneiden und beliebige Bereiche umfassen. Um einen gültigen bearbeitbaren Bereich zu erstellen, müssen Sie sowohl die Methoden [startEditableRange()](../../com.aspose.words/documentbuilder/\#startEditableRange) als auch [endEditableRange()](../../com.aspose.words/documentbuilder/\#endEditableRange) oder [endEditableRange(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentbuilder/\#endEditableRange-com.aspose.words.EditableRangeStart) aufrufen.

Fehlerhaft gebildete bearbeitbare Bereiche werden beim Speichern des Dokuments ignoriert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| start | [EditableRangeStart](../../com.aspose.words/editablerangestart/) | Dies ist der Start des bearbeitbaren Bereichs. |
...
Rufen Sie [endRow()](../../com.aspose.words/documentbuilder/\#endRow) auf, um eine Tabellenzeile zu beenden. Wenn Sie anschließend sofort [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell) aufrufen, wird die Tabelle in einer neuen Zeile fortgesetzt.

Verwenden Sie die Eigenschaft [getRowFormat()](../../com.aspose.words/documentbuilder/\#getRowFormat) , um die Zeilenformatierung festzulegen.
...
Beendet eine Tabelle im Dokument.

 **Remarks:** 

Diese Methode sollte nur einmal aufgerufen werden, nachdem [endRow()](../../com.aspose.words/documentbuilder/\#endRow) aufgerufen wurde. Beim Aufruf verschiebt [endTable()](../../com.aspose.words/documentbuilder/\#endTable) den Cursor aus der aktuellen Zelle heraus, sodass er direkt nach der Tabelle zeigt.
...
Zeigt, wie man MERGEFIELDs mit Daten füllt, indem man einen DocumentBuilder anstelle eines Seriendrucks verwendet.
...
Gibt ein Objekt zurück, das die aktuellen Formatierungseigenschaften der Tabellenzelle darstellt.
...
Ermittelt den Knoten, der derzeit in diesem DocumentBuilder ausgewählt ist.
...
Wenn der aktuelle Absatz leer ist oder der Cursor unmittelbar vor dem Ende eines Absatzes oder eines strukturierten Dokumenten-Tags positioniert ist, gibt [getCurrentNode()](../../com.aspose.words/documentbuilder/\#getCurrentNode)  null  zurück.

 **Examples:** 

Zeigt, wie man den Cursor des DocumentBuilder zu verschiedenen Knoten in einem Dokument bewegt.
...
Ermittelt den Absatz, der derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist.
...
Ermittelt den Abschnitt, der derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist.
...
Ermittelt die Story, die derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist.

 **Examples:** 

Zeigt, wie man mit der aktuellen Story eines DocumentBuilder arbeitet.
...
Ermittelt das strukturierte Dokument-Tag, das derzeit in diesem [DocumentBuilder](../../com.aspose.words/documentbuilder/) ausgewählt ist.

 **Examples:** 

Zeigt, wie man den Cursor des DocumentBuilder innerhalb eines strukturierten Dokument-Tags bewegt.
...
Ermittelt das [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document)-Objekt, an das dieses Objekt angehängt ist.
...
Verwenden Sie [getFont()](../../com.aspose.words/documentbuilder/\#getFont), um auf Schriftformatierungseigenschaften zuzugreifen und diese zu ändern.
...
Gibt ein Objekt zurück, das die aktuellen Listformatierungseigenschaften darstellt.
...
Gibt ein Objekt zurück, das die aktuellen Seiteneinrichtungs- und Abschnittseigenschaften darstellt.
...
Gibt ein Objekt zurück, das die aktuellen Tabellenzeilenformatierungseigenschaften darstellt.
...
Ermittelt/legt den Unterstreichungsstil für die aktuelle Schrift fest.

 **Examples:** 

Zeigt, wie man Text, der von einem DocumentBuilder eingefügt wurde, formatiert.
...
**Returns:**
int – Der entsprechende int‑Wert. Der zurückgegebene Wert ist einer der [Underline](../../com.aspose.words/underline/)‑Konstanten.
### insertBreak(int breakType) {#insertBreak-int}
```
...
Um eine Tabelle zu starten, rufen Sie einfach [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell) auf. Danach wird jeder Inhalt, den Sie mit anderen Methoden der [DocumentBuilder](../../com.aspose.words/documentbuilder/)‑Klasse hinzufügen, in die aktuelle Zelle eingefügt.

Um in derselben Zeile eine neue Zelle zu beginnen, rufen Sie erneut [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell) auf.

Um eine Tabellenzeile zu beenden, rufen Sie [endRow()](../../com.aspose.words/documentbuilder/\#endRow) auf.

Verwenden Sie die Eigenschaft [getCellFormat()](../../com.aspose.words/documentbuilder/\#getCellFormat), um die Zellenformatierung festzulegen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| name | java.lang.String | Der Name des Formularfelds. Kann eine leere Zeichenkette sein. Der Wert, der länger als 20 Zeichen ist, wird abgeschnitten. |
...
| size | int | Gibt die Größe des Kontrollkästchens in Punkten an. Geben Sie 0 für MS Word an, damit die Größe des Kontrollkästchens automatisch berechnet wird. |
...
| --- | --- | --- |
| name | java.lang.String | Der Name des Formularfelds. Kann eine leere Zeichenkette sein. Der Wert, der länger als 20 Zeichen ist, wird abgeschnitten. |
| Elemente | java.lang.String[] | Die Elemente der ComboBox. Maximal sind 25 Elemente. |
| selectedIndex | int | Der Index des ausgewählten Elements in der ComboBox. |
...
Diese Methode fügt ein Feld in ein Dokument ein und aktualisiert das Feldergebnis sofort. Aspose.Words kann Felder der meisten Typen aktualisieren, jedoch nicht alle. Weitere Details siehe die Überladung [insertField(java.lang.String, java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String--java.lang.String).

 **Examples:** 

Zeigt, wie Felder eingefügt und der Cursor des DocumentBuilder zu ihnen verschoben wird.
...
Felder in Microsoft‑Word‑Dokumenten bestehen aus einem Feldcode und einem Feldergebnis. Der Feldcode ist wie eine Formel und das Feldergebnis ist wie der von der Formel erzeugte Wert. Der Feldcode kann auch Feldschalter enthalten, die wie zusätzliche Anweisungen für die Ausführung einer bestimmten Aktion sind.

Sie können in Microsoft Word zwischen der Anzeige von Feldcodes und Ergebnissen in Ihrem Dokument mit der Tastenkombination Alt+F9 wechseln. Feldcodes erscheinen zwischen geschweiften Klammern ( \{ \} ).

Um ein Feld zu erstellen, müssen Sie einen Feldtyp, einen Feldcode und einen \"Platzhalter\"-Feldwert angeben. Wenn Sie sich über die Syntax eines bestimmten Feldcodes nicht sicher sind, erstellen Sie das Feld zuerst in Microsoft Word und wechseln Sie, um dessen Feldcode zu sehen.

Aspose.Words kann Feldergebnisse für die meisten Feldtypen berechnen, aber diese Methode aktualisiert das Feldergebnis nicht automatisch. Da das Feldergebnis nicht automatisch berechnet wird, sollten Sie einen Zeichenkettenwert (oder sogar eine leere Zeichenkette) übergeben, der in das Feldergebnis eingefügt wird. Dieser Wert bleibt als Platzhalter im Feldergebnis, bis das Feld aktualisiert wird. Um das Feldergebnis zu aktualisieren, können Sie [Field.update()](../../com.aspose.words/field/\#update) am zurückgegebenen Feldobjekt aufrufen oder [Document.updateFields()](../../com.aspose.words/document/\#updateFields), um Felder im gesamten Dokument zu aktualisieren.
...
Fügt ein [Forms2OleControl](../../com.aspose.words/forms2olecontrol/)-Objekt an der aktuellen Position ein..
...
Position und Größe der neuen GroupShape werden automatisch berechnet.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| shapes | [ShapeBase\[\]](../../com.aspose.words/shapebase/) | Die Liste der zu gruppierenden Formen. |
...
Gruppiert die als Parameter übergebenen Formen in einen neuen GroupShape-Knoten mit der angegebenen Größe, der an der angegebenen Position eingefügt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| html | java.lang.String | Ein HTML‑String, der in das Dokument eingefügt wird. |
...
Wenn  useBuilderFormatting  false ist, wird die Formatierung von [DocumentBuilder](../../com.aspose.words/documentbuilder/) ignoriert und die Formatierung des eingefügten Textes basiert auf der Standard‑HTML‑Formatierung. Infolgedessen sieht der Text so aus, wie er in Browsern gerendert wird.

Wenn  useBuilderFormatting  true ist, basiert die Formatierung des eingefügten Textes auf der Formatierung von [DocumentBuilder](../../com.aspose.words/documentbuilder/) und der Text sieht so aus, als wäre er mit [write(java.lang.String)](../../com.aspose.words/documentbuilder/\#write-java.lang.String) eingefügt worden.

 **Examples:** 

Zeigt, wie man die Formatierung eines DocumentBuilder beim Einfügen von HTML‑Inhalt anwendet.
...
| --- | --- | --- |
| html | java.lang.String | Ein HTML‑String, der in das Dokument eingefügt wird. |
| useBuilderFormatting | boolean | Ein Wert, der angibt, ob die in [DocumentBuilder](../../com.aspose.words/documentbuilder/) angegebene Formatierung als Basisformatierung für aus HTML importierten Text verwendet wird. |
...
Beachten Sie, dass Sie die Schriftformatierung für den angezeigten Hyperlink-Text explizit über die Eigenschaft [getFont()](../../com.aspose.words/documentbuilder/\#getFont) angeben müssen.

Diese Methode ruft intern [insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String) auf, um ein MS‑Word‑HYPERLINK‑Feld in das Dokument einzufügen.
...
Zeigt, wie man den Formatierungs‑Stack eines DocumentBuilder verwendet.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| displayText | java.lang.String | Text des Links, der im Dokument angezeigt werden soll. |
| urlOrBookmark | java.lang.String | Linkziel. Kann eine URL oder ein Name eines Lesezeichens im Dokument sein. Diese Methode fügt stets Apostrophe am Anfang und Ende der URL hinzu. |
...
Fügt ein Bild aus einem Byte-Array in das Dokument ein. Das Bild wird inline und mit 100 %iger Skalierung eingefügt.

 **Remarks:** 

Sie können die Bildgröße, den Ort, die Positionierungsmethode und weitere Einstellungen ändern, indem Sie das von dieser Methode zurückgegebene [Shape](../../com.aspose.words/shape/)‑Objekt verwenden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| BildBytes | byte[] | Das Byte-Array, das das Bild enthält. |
...
| --- | --- | --- |
| BildBytes | byte[] | Das Byte-Array, das das Bild enthält. |
| Breite | double | Die Breite des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
| Höhe | double | Die Höhe des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
...
Fügt ein Bild in das Dokument ein.  Fügt ein Bild aus einem java.awt.image.BufferedImage‑Objekt in das Dokument ein. Das Bild wird inline und mit 100 %iger Skalierung eingefügt.

 **Remarks:** 

Sie können die Bildgröße, den Ort, die Positionierungsmethode und weitere Einstellungen ändern, indem Sie das von dieser Methode zurückgegebene [Shape](../../com.aspose.words/shape/)‑Objekt verwenden.

Aspose.Words fügt das Bild im PNG‑Format und mit den Standardeinstellungen ein. Wenn Sie ein  BufferedImage  in einem anderen Format oder mit anderen Einstellungen einfügen möchten, müssen Sie das Bild in ein Byte‑Array speichern und [insertImage(byte[])](../../com.aspose.words/documentbuilder/\#insertImage-byte) verwenden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Bild | java.awt.image.BufferedImage | Das Bild, das in das Dokument eingefügt werden soll. |
...
Fügt ein Inline-Bild aus einem java.awt.image.BufferedImage-Objekt in das Dokument ein und skaliert es auf die angegebene Größe.
...
Fügt ein Bild aus einer Datei oder URL in das Dokument ein. Das Bild wird inline und mit 100 %iger Skalierung eingefügt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileName | java.lang.String | Die Datei mit dem Bild. Kann jede gültige lokale oder entfernte URI sein. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileName | java.lang.String | Die Datei, die das Bild enthält. |
| Breite | double | Die Breite des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
| Höhe | double | Die Höhe des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fileName | java.lang.String | Vollständiger Pfad zur Datei. |
| isLinked | boolean | Wenn  true  ist, wird ein verknüpftes OLE-Objekt eingefügt, andernfalls ein eingebettetes OLE-Objekt. |
| iconFile | java.lang.String | Vollständiger Pfad zur ICO-Datei. Wenn der Wert  null  ist, verwendet **Aspose.Words** ein vordefiniertes Bild. |
| iconCaption | java.lang.String | Symbolbeschriftung. Wenn der Wert  null  ist, verwendet **Aspose.Words** den Dateinamen. |
...
| --- | --- | --- |
| fileName | java.lang.String | Vollständiger Pfad zur Datei. |
| progId | java.lang.String | ProgId des OLE-Objekts. |
| isLinked | boolean | Wenn  true  ist, wird ein verknüpftes OLE-Objekt eingefügt, andernfalls ein eingebettetes OLE-Objekt. |
| iconFile | java.lang.String | Vollständiger Pfad zur ICO-Datei. Wenn der Wert  null  ist, verwendet **Aspose.Words** ein vordefiniertes Bild. |
| iconCaption | java.lang.String | Symbolbeschriftung. Wenn der Wert  null  ist, verwendet **Aspose.Words** den Dateinamen. |
...
Wenn Ihr Online-Video nicht korrekt angezeigt wird, verwenden Sie [insertOnlineVideo(java.lang.String, java.lang.String, byte[], double, double)](../../com.aspose.words/documentbuilder/\#insertOnlineVideo-java.lang.String--java.lang.String--byte----double--double), das benutzerdefinierten eingebetteten HTML-Code akzeptiert.

Der Code zum Einbetten von Videos kann je nach Anbieter variieren; konsultieren Sie Ihren jeweiligen Anbieter für Details.

 **Examples:** 

Zeigt, wie ein Online-Video mithilfe einer URL in ein Dokument eingefügt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| videoUrl | java.lang.String | Die URL zum Video. |
| Breite | double | Die Breite des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
| Höhe | double | Die Höhe des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
...
Zeigt, wie ein Online-Video mit einem benutzerdefinierten Thumbnail in ein Dokument eingefügt wird.
...
| --- | --- | --- |
| videoUrl | java.lang.String | Die URL zum Video. |
| videoEmbedCode | java.lang.String | Der Einbettungscode für das Video. |
| thumbnailImageBytes | byte[] | Die Bytes des Thumbnail-Bildes. |
| Breite | double | Die Breite des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
| Höhe | double | Die Höhe des Bildes in Punkten. Kann einen negativen oder null Wert haben, um 100 % Skalierung anzufordern. |
...
Die aktuelle Absatzformatierung, die durch die Eigenschaft [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat) angegeben ist, wird verwendet.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| signatureLineOptions | [SignatureLineOptions](../../com.aspose.words/signaturelineoptions/) | Das Objekt, das die Parameter für das Erstellen einer Signaturzeile speichert. |
...
Fügt einen Stiltrennzeichen in das Dokument ein.

 **Remarks:** 

Diese Methode ermöglicht das Anwenden unterschiedlicher Absatzstile auf zwei verschiedene Teile einer Textzeile.

 **Examples:** 

Zeigt, wie man mit Stiltrennzeichen arbeitet.
...
Fügt ein TOC (Inhaltsverzeichnis)-Feld in das Dokument ein.

 **Remarks:** 

Diese Methode fügt ein TOC‑Feld (Inhaltsverzeichnis) an der aktuellen Position in das Dokument ein.

Ein Inhaltsverzeichnis in einem Word‑Dokument kann auf verschiedene Arten erstellt und mit einer Vielzahl von Optionen formatiert werden. Die Art und Weise, wie das Inhaltsverzeichnis von Microsoft Word erstellt und angezeigt wird, wird durch die Feldschalter gesteuert.

Der einfachste Weg, die Schalter anzugeben, besteht darin, ein Inhaltsverzeichnis in ein Word‑Dokument einzufügen und zu konfigurieren, indem man das Menü Insert->Reference->Index and Tables verwendet, dann die Anzeige der Feldcodes einschaltet, um die Schalter zu sehen. Sie können in Microsoft Word Alt+F9 drücken, um die Anzeige der Feldcodes ein- oder auszuschalten.
...
Beachten Sie, dass [insertTableOfContents(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertTableOfContents-java.lang.String) nur ein TOC‑Feld einfügt, das Inhaltsverzeichnis jedoch nicht tatsächlich erstellt. Das Inhaltsverzeichnis wird von Microsoft Word erstellt, wenn das Feld aktualisiert wird.

Wenn Sie mit dieser Methode ein Inhaltsverzeichnis einfügen und dann die Datei in Microsoft Word öffnen, sehen Sie das Inhaltsverzeichnis nicht, weil das TOC‑Feld noch nicht aktualisiert wurde.

In Microsoft Word werden Felder beim Öffnen eines Dokuments nicht automatisch aktualisiert, Sie können Felder jedoch jederzeit durch Drücken von F9 aktualisieren.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Schalter | java.lang.String | Die Schalter des TOC‑Feldes. |
...
Gibt  true  zurück, wenn der Cursor am Ende des aktuellen Absatzes ist.
...
**Returns:**
boolean –  true  wenn der Cursor am Ende des aktuellen Absatzes steht.
...
Gibt **true** zurück, wenn der Cursor am Ende eines strukturierten Dokumenttags ist.
...
**Returns:**
boolean – **true** wenn der Cursor am Ende eines strukturierten Dokumenten‑Tags steht.
...
Gibt  true  zurück, wenn der Cursor am Anfang des aktuellen Absatzes ist (kein Text vor dem Cursor).
...
**Returns:**
boolean –  true  wenn der Cursor am Anfang des aktuellen Absatzes steht (kein Text vor dem Cursor).
...
Wenn *node* ein Inline‑Level‑Knoten ist, wird der Cursor zu diesem Knoten bewegt und weiterer Inhalt wird vor diesem Knoten eingefügt.

Wenn *node* ein [Paragraph](../../com.aspose.words/paragraph/) ist, wird der Cursor an das Ende des Absatzes bewegt und weiterer Inhalt wird unmittelbar vor dem Absatzumbruch eingefügt.

Wenn *node* ein Block‑Level‑Knoten, aber kein [Paragraph](../../com.aspose.words/paragraph/) ist, wird der Cursor an das Ende des ersten Absatzes im Block‑Level‑Knoten bewegt und weiterer Inhalt wird unmittelbar vor dem Absatzumbruch eingefügt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| node | [Node](../../com.aspose.words/node/) | Der Knoten muss ein Absatz oder ein direktes Kind eines Absatzes sein. |
...
Verschiebt den Cursor an eine Position direkt nach dem Beginn des Lesezeichens mit dem angegebenen Namen.

Der Vergleich ist nicht case‑sensitive. Wenn das Lesezeichen nicht gefunden wird, wird  false  zurückgegeben und der Cursor wird nicht verschoben.

Das Einfügen neuen Textes ersetzt nicht den vorhandenen Text des Lesezeichens.

Beachten Sie, dass einige Lesezeichen im Dokument Formularfeldern zugewiesen sind. Wenn Sie zu einem solchen Lesezeichen navigieren und dort Text einfügen, wird der Text in den Code des Formularfelds eingefügt. Obwohl dies das Formularfeld nicht ungültig macht, wird der eingefügte Text nicht sichtbar sein, weil er Teil des Feldcodes wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| bookmarkName | java.lang.String | Der Name des Lesezeichens, zu dem der Cursor bewegt werden soll. |

**Returns:**
boolean -  true  wenn das Lesezeichen gefunden wurde;  false  sonst.
...
Bewegt den Cursor an eine Position vor oder nach dem Beginn bzw. Ende des Lesezeichens.

Wenn die gewünschte Position nicht auf Inline-Ebene liegt, wird zum nächsten Absatz gesprungen.

Der Vergleich ist nicht case‑sensitive. Wenn das Lesezeichen nicht gefunden wird, wird  false  zurückgegeben und der Cursor wird nicht verschoben.

 **Examples:** 

Zeigt, wie man den Einfügepunkt‑Cursor eines Document Builders zu einem Lesezeichen bewegt.
...
| --- | --- | --- |
| bookmarkName | java.lang.String | Der Name des Lesezeichens, zu dem der Cursor bewegt werden soll. |
| isStart | boolean | Wenn  true , bewegt der Cursor zum Anfang des Lesezeichens. Wenn  false , bewegt er den Cursor zum Ende des Lesezeichens. |
| isAfter | boolean | Wenn  true , wird der Cursor nach der Start‑ oder Endposition des Lesezeichens gesetzt. Wenn  false , wird er vor der Start‑ oder Endposition des Lesezeichens gesetzt. |
...
Zeigt, wie man den Cursor eines Document Builders zu einer Zelle in einer Tabelle bewegt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| tableIndex | int | Der Index der Tabelle, zu der navigiert werden soll. |
| rowIndex | int | Der Index der Zeile in der Tabelle. |
| columnIndex | int | Der Index der Spalte in der Tabelle. |
| characterIndex | int | Der Index des Zeichens innerhalb der Zelle. Ein negativer Wert ermöglicht die Angabe einer Position vom Ende der Zelle aus. Verwenden Sie -1, um zum Ende der Zelle zu springen. |
...
Zeigt, wie man den Einfügepunkt‑Cursor eines Document Builders zu einem bestimmten Feld bewegt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| field | [Field](../../com.aspose.words/field/) | Das Feld, zu dem der Cursor bewegt werden soll. |
| isAfter | boolean | Wenn  true , wird der Cursor nach dem Feldende gesetzt. Wenn  false , wird er vor dem Feldbeginn gesetzt. |
...
Bewegt den Cursor zum angegebenen Seriendruckfeld.  Bewegt den Cursor an eine Position unmittelbar hinter dem angegebenen Seriendruckfeld und entfernt das Seriendruckfeld.

 **Remarks:** 

Beachten Sie, dass diese Methode das Seriendruckfeld aus dem Dokument löscht, nachdem der Cursor bewegt wurde.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| fieldName | java.lang.String | Der Groß-/Kleinschreibungs‑unabhängige Name des Seriendruckfelds. |

**Returns:**
boolean -  true  wenn das Seriendruckfeld gefunden wurde und der Cursor bewegt wurde;  false  sonst.
...
| fieldName | java.lang.String | Der Groß-/Kleinschreibungs‑unabhängige Name des Seriendruckfelds. |
| isAfter | boolean | Wenn  true , wird der Cursor nach dem Feldende gesetzt. Wenn  false , wird er vor dem Feldbeginn gesetzt. |
| isDeleteField | boolean | Wenn  true , löscht das Zusammenführungsfeld. |
...
Die Navigation wird innerhalb der aktuellen Story des aktuellen Abschnitts durchgeführt. Das heißt, wenn Sie den Cursor in die primäre Kopfzeile des ersten Abschnitts verschoben haben, dann gibt  paragraphIndex  den Index des Absatzes innerhalb dieser Kopfzeile dieses Abschnitts an.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| paragraphIndex | int | Der Index des Absatzes, zu dem verschoben werden soll. |
| characterIndex | int | Der Index des Zeichens innerhalb des Absatzes. Ein negativer Wert ermöglicht die Angabe einer Position vom Ende des Absatzes aus. Verwenden Sie -1, um zum Ende des Absatzes zu springen. |
...
Wenn  sectionIndex  größer oder gleich 0 ist, gibt er einen Index vom Anfang des Dokuments an, wobei 0 der erste Abschnitt ist. Wenn  sectionIndex  kleiner als 0 ist, gibt er einen Index vom Ende des Dokuments an, wobei -1 der letzte Abschnitt ist.

Der Cursor wird zum ersten Absatz im [Body](../../com.aspose.words/body/) des angegebenen Abschnitts verschoben.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| sectionIndex | int | Der Index des Abschnitts, zu dem verschoben werden soll. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| structuredDocumentTag | [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) | Das strukturierte Dokument-Tag, zu dem verschoben werden soll. |
| characterIndex | int | Der Index des Zeichens innerhalb des strukturierten Dokument-Tags. Ein negativer Wert ermöglicht die Angabe einer Position vom Ende des strukturierten Dokument-Tags aus. Verwenden Sie -1, um zum Ende des strukturierten Dokument-Tags zu springen. Wenn das strukturierte Dokument-Tag auf Blockebene ist und Sie den Cursor zum Ende seines letzten Absatzes bewegen möchten, geben Sie -2 an. |
...
Die Navigation wird innerhalb der aktuellen Story des aktuellen Abschnitts durchgeführt. Das heißt, wenn Sie den Cursor in die primäre Kopfzeile des ersten Abschnitts verschoben haben, dann gibt  structuredDocumentTagIndex  den Index des strukturierten Dokument-Tags innerhalb dieser Kopfzeile dieses Abschnitts an.

Wenn  structuredDocumentTagIndex  größer oder gleich 0 ist, gibt er einen Index vom Anfang des Abschnitts an, wobei 0 das erste strukturierte Dokument-Tag ist. Wenn  structuredDocumentTagIndex  kleiner als 0 ist, gibt er einen Index vom Ende des Abschnitts an, wobei -1 das letzte strukturierte Dokument-Tag ist.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| structuredDocumentTagIndex | int | Der Index des strukturierten Dokument-Tags, zu dem verschoben werden soll. |
| characterIndex | int | Der Index des Zeichens innerhalb des strukturierten Dokument-Tags. Ein negativer Wert ermöglicht die Angabe einer Position vom Ende des strukturierten Dokument-Tags aus. Verwenden Sie -1, um zum Ende des strukturierten Dokument-Tags zu springen. Wenn das strukturierte Dokument-Tag auf Blockebene ist und Sie den Cursor zum Ende seines letzten Absatzes bewegen möchten, geben Sie -2 an. |
...
Ruft die zuvor im Stack gespeicherte Zeichenformatierung ab.
...
Speichert die aktuelle Zeichenformatierung im Stack.
...
Setzt das [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document) Objekt, an das dieses Objekt angehängt ist.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | [Document](../../com.aspose.words/document/) | Das [getDocument()](../../com.aspose.words/documentbuilder/\#getDocument) / [setDocument(com.aspose.words.Document)](../../com.aspose.words/documentbuilder/\#setDocument-com.aspose.words.Document) Objekt, an das dieses Objekt angehängt ist. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | int | Der entsprechende  int  Wert. Der Wert muss einer der [Underline](../../com.aspose.words/underline/) Konstanten sein. |
...
Markiert die aktuelle Position im Dokument als Beginn eines Spalten-Lesezeichens. Die Position muss sich in einer Tabellenzelle befinden.
...
Die tatsächliche Position des eingefügten [BookmarkStart](../../com.aspose.words/bookmarkstart/) Knotens kann von der aktuellen Position des Dokument-Builders abweichen.
...
Markiert die aktuelle Position im Dokument als Beginn eines bearbeitbaren Bereichs.
...
Die nächste Methode, die aufgerufen werden soll, ist [insertCell()](../../com.aspose.words/documentbuilder/\#insertCell).
...
Die aktuelle Schriftformatierung, die durch die Eigenschaft [getFont()](../../com.aspose.words/documentbuilder/\#getFont) angegeben ist, wird verwendet.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Text | java.lang.String | Die Zeichenkette, die in das Dokument eingefügt werden soll. |
...
Ruft [insertParagraph()](../../com.aspose.words/documentbuilder/\#insertParagraph) auf.
...
Fügt eine Zeichenkette und einen Absatzumbruch in das Dokument ein.

 **Remarks:** 

Die aktuelle Schrift- und Absatzformatierung, die durch die Eigenschaften [getFont()](../../com.aspose.words/documentbuilder/\#getFont) und [getParagraphFormat()](../../com.aspose.words/documentbuilder/\#getParagraphFormat) angegeben sind, wird verwendet.
