...
description: "Stellt ein Microsoft Word-Dokumentfeld in Java dar."
type: docs
weight: 194
url: /de/java/com.aspose.words/field/
---
...
Ein Feld in einem Word-Dokument ist eine komplexe Struktur, die aus mehreren Knoten besteht, darunter Feldanfang, Feldcode, Feldtrennzeichen, Feldresultat und Feldende. Felder können verschachtelt sein, reichhaltige Inhalte enthalten und sich über mehrere Absätze oder Abschnitte in einem Dokument erstrecken. Die Klasse [Field](../../com.aspose.words/field/) ist ein „Facade“-Objekt, das Eigenschaften und Methoden bereitstellt, mit denen man mit einem Feld als einem einzigen Objekt arbeiten kann.

Die Eigenschaften [getStart()](../../com.aspose.words/field/\#getStart), [getSeparator()](../../com.aspose.words/field/\#getSeparator) und [getEnd()](../../com.aspose.words/field/\#getEnd) verweisen jeweils auf die Feldanfangs‑, Trenn‑ und Endknoten des Feldes.

Der Inhalt zwischen Feldanfang und Trennzeichen ist der Feldcode. Der Inhalt zwischen Feldtrennzeichen und Feldende ist das Feldresultat. Der Feldcode besteht typischerweise aus einem oder mehreren [Run](../../com.aspose.words/run/)-Objekten, die Anweisungen spezifizieren. Von der verarbeitenden Anwendung wird erwartet, den Feldcode auszuführen, um das Feldresultat zu berechnen.

Der Vorgang zur Berechnung von Feldresultaten wird Feldaktualisierung genannt. Aspose.Words kann Feldresultate der meisten Feldtypen exakt auf dieselbe Weise aktualisieren, wie Microsoft Word es tut. Besonders bemerkenswert ist, dass Aspose.Words sogar die Ergebnisse der komplexesten Formelfelder berechnen kann. Um das Feldresultat eines einzelnen Feldes zu berechnen, verwenden Sie die Methode [update()](../../com.aspose.words/field/\#update). Um Felder im gesamten Dokument zu aktualisieren, verwenden Sie [Document.updateFields()](../../com.aspose.words/document/\#updateFields).

Sie können die Nur‑Text‑Version des Feldcodes mit der Methode [getFieldCode(boolean)](../../com.aspose.words/field/\#getFieldCode-boolean) erhalten. Sie können die Nur‑Text‑Version des Feldresultats mit der Eigenschaft [getResult()](../../com.aspose.words/field/\#getResult) / [setResult(java.lang.String)](../../com.aspose.words/field/\#setResult-java.lang.String) abrufen und festlegen. Sowohl der Feldcode als auch das Feldresultat können komplexe Inhalte enthalten, wie verschachtelte Felder, Absätze, Formen, Tabellen, und in diesem Fall möchten Sie möglicherweise direkt mit den Feldknoten arbeiten, wenn Sie mehr Kontrolle benötigen.

Sie erstellen keine Instanzen der Klasse [Field](../../com.aspose.words/field/) direkt. Um ein neues Feld zu erstellen, verwenden Sie die Methode [DocumentBuilder.insertField(java.lang.String)](../../com.aspose.words/documentbuilder/\#insertField-java.lang.String).
