...
description: "Stellt Methoden bereit, um ein einzelnes OfficeMath in ein Raster‑ oder Vektorbild oder in ein Graphics‑Objekt in Java zu rendern."
type: docs
weight: 499
url: /de/java/com.aspose.words/officemathrenderer/
---
...
Stellt Methoden bereit, um ein einzelnes [OfficeMath](../../com.aspose.words/officemath/) in ein Raster‑ oder Vektorbild oder in ein Graphics‑Objekt zu rendern.

Um mehr zu erfahren, besuchen Sie den [ Working with OfficeMath ][Working with OfficeMath] Dokumentationsartikel.
...
| --- | --- |
| [OfficeMathRenderer(OfficeMath math)](#OfficeMathRenderer-com.aspose.words.OfficeMath) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden
...
| --- | --- | --- |
| math | [OfficeMath](../../com.aspose.words/officemath/) | Das [OfficeMath](../../com.aspose.words/officemath/) Objekt, das Sie rendern möchten. |
