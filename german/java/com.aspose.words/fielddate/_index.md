...
description: "Implementiert das DATE-Feld in Java."
type: docs
weight: 220
url: /de/java/com.aspose.words/fielddate/
---
...
| [getUseLastFormat()](#getUseLastFormat) | Ermittelt, ob beim Einfügen eines neuen DATE-Feldes das zuletzt von der Host‑Anwendung verwendete Format verwendet werden soll. |
| [getUseLunarCalendar()](#getUseLunarCalendar) | Ermittelt, ob der islamische Mondkalender oder der hebräische Mondkalender verwendet wird. |
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar) | Ermittelt, ob der Saka‑Ära‑Kalender verwendet wird. |
| [getUseUmAlQuraCalendar()](#getUseUmAlQuraCalendar) | Ermittelt, ob der Um‑al‑Qura‑Kalender verwendet wird. |
...
| [setUseLastFormat(boolean value)](#setUseLastFormat-boolean) | Legt fest, ob beim Einfügen eines neuen DATE-Feldes das zuletzt von der Host‑Anwendung verwendete Format verwendet werden soll. |
| [setUseLunarCalendar(boolean value)](#setUseLunarCalendar-boolean) | Legt fest, ob der islamische Mondkalender oder der hebräische Mondkalender verwendet werden soll. |
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean) | Legt fest, ob der Saka‑Ära‑Kalender verwendet werden soll. |
| [setUseUmAlQuraCalendar(boolean value)](#setUseUmAlQuraCalendar-boolean) | Legt fest, ob der Um‑al‑Qura‑Kalender verwendet werden soll. |
...
Ermittelt, ob beim Einfügen eines neuen DATE-Feldes das zuletzt von der Host‑Anwendung verwendete Format verwendet werden soll.
...
**Returns:**
boolean - Ob ein Format verwendet werden soll, das zuletzt von der Host-Anwendung beim Einfügen eines neuen DATE-Feldes verwendet wurde.
...
Ermittelt, ob der islamische Mondkalender oder der hebräische Mondkalender verwendet wird.
...
**Returns:**
boolean - Ob der islamische Mondkalender oder der hebräische Mondkalender verwendet wird.
...
Ermittelt, ob der Saka‑Ära‑Kalender verwendet wird.
...
**Returns:**
boolean - Ob der Saka‑Ära‑Kalender verwendet wird.
...
Ermittelt, ob der Um‑al‑Qura‑Kalender verwendet wird.
...
**Returns:**
boolean - Ob der Um-al-Qura-Kalender verwendet werden soll.
### isDirty() {#isDirty}
```
...
Legt fest, ob beim Einfügen eines neuen DATE-Feldes das zuletzt von der Host‑Anwendung verwendete Format verwendet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob ein Format verwendet werden soll, das zuletzt von der Host-Anwendung beim Einfügen eines neuen DATE-Feldes verwendet wurde. |
...
Legt fest, ob der islamische Mondkalender oder der hebräische Mondkalender verwendet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob der Hijri Lunar- oder der Hebrew Lunar-Kalender verwendet werden soll. |
...
Legt fest, ob der Saka‑Ära‑Kalender verwendet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob der Saka Era-Kalender verwendet werden soll. |
...
Legt fest, ob der Um‑al‑Qura‑Kalender verwendet werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob der Um-al-Qura-Kalender verwendet werden soll. |
