...
description: "Implementiert das SUBJECT-Feld in Java."
type: docs
weight: 290
url: /de/java/com.aspose.words/fieldsubject/
---
...
Ruft das Betreff des Dokuments ab und kann es optional setzen, wie in der **Subject**-Eigenschaft der integrierten Dokumenteigenschaften aufgezeichnet.
...
| [getText()](#getText) | Liest den Text des Betreffs. |
...
| [setText(String value)](#setText-java.lang.String) | Setzt den Text des Betreffs. |
...
**Returns:**
java.lang.String - Der Text des Betreffs.
### getType() {#getType}
```
public int getType()
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text des Betreffs. |
