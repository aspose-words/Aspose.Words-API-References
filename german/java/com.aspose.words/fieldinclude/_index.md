...
description: "Implementiert das INCLUDE-Feld in Java."
type: docs
weight: 246
url: /de/java/com.aspose.words/fieldinclude/
---
...
Zeigt, wie man ein INCLUDE-Feld erstellt und dessen Eigenschaften festlegt.
...
| [getSourceFullName()](#getSourceFullName) | Ermittelt den Speicherort des Dokuments. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Legt den Speicherort des Dokuments fest. |
...
Ermittelt den Speicherort des Dokuments.
...
**Returns:**
java.lang.String - Der Speicherort des Dokuments.
### getStart() {#getStart}
```
...
Legt den Speicherort des Dokuments fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Speicherort des Dokuments. |
