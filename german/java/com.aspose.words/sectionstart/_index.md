...
description: "Der Typ des Umbruchs zu Beginn des Abschnitts in Java."
type: docs
weight: 608
url: /de/java/com.aspose.words/sectionstart/
---
...
Der Typ des Umbruchs zu Beginn des Abschnitts.
...
| Feld | Beschreibung |
| --- | --- |
| [CONTINUOUS](#CONTINUOUS) | Der neue Abschnitt beginnt auf derselben Seite wie der vorherige Abschnitt. |
| [EVEN_PAGE](#EVEN-PAGE) | Der Abschnitt beginnt auf einer neuen geraden Seite. |
| [NEW_COLUMN](#NEW-COLUMN) | Der Abschnitt beginnt in einer neuen Spalte. |
| [NEW_PAGE](#NEW-PAGE) | Der Abschnitt beginnt auf einer neuen Seite. |
| [ODD_PAGE](#ODD-PAGE) | Der Abschnitt beginnt auf einer neuen ungeraden Seite. |
| [length](#length) |  |
## Methoden
...
Der neue Abschnitt beginnt auf derselben Seite wie der vorherige Abschnitt.
...
Der Abschnitt beginnt auf einer neuen geraden Seite.
...
Der Abschnitt beginnt in einer neuen Spalte.
...
Der Abschnitt beginnt auf einer neuen Seite.
...
Der Abschnitt beginnt auf einer neuen ungeraden Seite.
