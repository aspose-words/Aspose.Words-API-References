...
description: "LINQ Reporting Engine‑Kontext in Java."
type: docs
weight: 572
url: /de/java/com.aspose.words/reportbuildercontext/
---
...
| --- | --- |
| [ReportBuilderContext()](#ReportBuilderContext) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getDataSources()](#getDataSources) | Datenquellen, die zum Erstellen des Berichts verwendet werden. |
...
| [getReportBuilderOptions()](#getReportBuilderOptions) | Optionen zum Erstellen des Berichts. |
...
Datenquellen, die zum Erstellen des Berichts verwendet werden.

 **Remarks:** 

Der Schlüssel stellt die Datenquelle dar, während der Wert den Namen der Datenquelle enthält. Der Datenquellenname kann null oder ein leerer String sein; in solchen Fällen erkennt die Reporting‑Engine den Namen der Datenquelle automatisch aus der angegebenen Datenquelle.
...
**Returns:**
java.util.LinkedHashMap - Der entsprechende java.util.HashMap-Wert.
