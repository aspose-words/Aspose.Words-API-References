...
description: "Implementiert das NOTEREF-Feld in Java."
type: docs
weight: 265
url: /de/java/com.aspose.words/fieldnoteref/
---
...
Fügt das Zeichen der Fußnote oder Endnote ein, das durch das angegebene Lesezeichen markiert ist.

 **Examples:** 

Zeigt, wie man NOTEREF-Felder einfügt und ihr Aussehen ändert.
...
Zeigt, wie man Fußnoten mit dem NOTEREF-Feld querverweist.
...
| [getInsertReferenceMark()](#getInsertReferenceMark) | Fügt das Referenzzeichen mit derselben Zeichenformatierung wie der Stil Fußnotenreferenz oder Endnotenreferenz ein. |
...
| [setInsertReferenceMark(boolean value)](#setInsertReferenceMark-boolean) | Fügt das Referenzzeichen mit derselben Zeichenformatierung wie der Stil Fußnotenreferenz oder Endnotenreferenz ein. |
...
Fügt das Referenzzeichen mit derselben Zeichenformatierung wie der Stil Fußnotenreferenz oder Endnotenreferenz ein.
