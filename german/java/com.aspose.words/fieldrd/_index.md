...
description: "Implementiert das RD-Feld in Java."
type: docs
weight: 277
url: /de/java/com.aspose.words/fieldrd/
---
...
Identifiziert eine Datei, die beim Erstellen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes mit dem TOC-, TOA- oder INDEX-Feld einbezogen wird.
...
| [getFileName()](#getFileName) | Ermittelt den Namen der Datei, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes einbezogen wird. |
...
| [isPathRelative()](#isPathRelative) | Ermittelt, ob der Pfad relativ zum aktuellen Dokument ist. |
| [isPathRelative(boolean value)](#isPathRelative-boolean) | Legt fest, ob der Pfad relativ zum aktuellen Dokument ist. |
| [remove()](#remove) | Entfernt das Feld aus dem Dokument. |
| [setFileName(String value)](#setFileName-java.lang.String) | Legt den Namen der Datei fest, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes einbezogen wird. |
...
Ermittelt den Namen der Datei, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes einbezogen wird.
...
**Returns:**
java.lang.String - Der Name der Datei, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Rechtsgrundlagen oder eines Indexes einzuschließen ist.
### getFormat() {#getFormat}
```
...
Ermittelt, ob der Pfad relativ zum aktuellen Dokument ist.
...
**Returns:**
boolean - Ob der Pfad relativ zum aktuellen Dokument ist.
...
Legt fest, ob der Pfad relativ zum aktuellen Dokument ist.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob der Pfad relativ zum aktuellen Dokument ist. |
...
Legt den Namen der Datei fest, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Autoritäten oder eines Indexes einbezogen wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name der Datei, die beim Erzeugen eines Inhaltsverzeichnisses, eines Verzeichnisses der Rechtsgrundlagen oder eines Indexes einzuschließen ist. |
