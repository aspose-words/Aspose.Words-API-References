...
description: "Stellt die Fußnotennummerierungsoptionen für ein Dokument oder einen Abschnitt in Java dar."
type: docs
weight: 341
url: /de/java/com.aspose.words/footnoteoptions/
---
...
Stellt die Optionen für die Fußnotennummerierung eines Dokuments oder Abschnitts dar.
...
| --- | --- |
| [getColumns()](#getColumns) | Gibt die Anzahl der Spalten an, mit denen der Fußnotenbereich formatiert wird. |
| [getLocation()](#getLocation) |  |
| [getNumberStyle()](#getNumberStyle) | Gibt das Zahlenformat für automatisch nummerierte Fußnoten an. |
| [getPosition()](#getPosition) | Gibt die Position der Fußnoten an. |
| [getRestartRule()](#getRestartRule) | Bestimmt, wann die automatische Nummerierung neu startet. |
| [getStartNumber()](#getStartNumber) | Gibt die Startzahl oder das Zeichen für die ersten automatisch nummerierten Fußnoten an. |
| [setColumns(int value)](#setColumns-int) | Gibt die Anzahl der Spalten an, mit denen der Fußnotenbereich formatiert wird. |
| [setLocation(int value)](#setLocation-int) |  |
| [setNumberStyle(int value)](#setNumberStyle-int) | Gibt das Zahlenformat für automatisch nummerierte Fußnoten an. |
| [setPosition(int value)](#setPosition-int) | Gibt die Position der Fußnoten an. |
| [setRestartRule(int value)](#setRestartRule-int) | Bestimmt, wann die automatische Nummerierung neu startet. |
| [setStartNumber(int value)](#setStartNumber-int) | Gibt die Startzahl oder das Zeichen für die ersten automatisch nummerierten Fußnoten an. |
...
Wenn diese Eigenschaft den Wert 0 hat, wird der Fußnotenbereich mit einer Spaltenanzahl formatiert, die auf der Anzahl der Spalten der angezeigten Seite basiert. Der Standardwert ist 0.
...
**Returns:**
int - Der entsprechende  int  Wert. Der zurückgegebene Wert ist einer der [FootnotePosition](../../com.aspose.words/footnoteposition/) Konstanten.
...
Gibt die Startzahl oder das Zeichen für die ersten automatisch nummerierten Fußnoten an.

 **Remarks:** 

Diese Eigenschaft hat nur Wirkung, wenn [getRestartRule()](../../com.aspose.words/footnoteoptions/\#getRestartRule) / [setRestartRule(int)](../../com.aspose.words/footnoteoptions/\#setRestartRule-int) auf [FootnoteNumberingRule.CONTINUOUS](../../com.aspose.words/footnotenumberingrule/\#CONTINUOUS) gesetzt ist.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | int | Der entsprechende  int  Wert. Der Wert muss einer der [FootnotePosition](../../com.aspose.words/footnoteposition/) Konstanten sein. |
