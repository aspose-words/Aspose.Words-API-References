...
description: "Stellt das Ende eines bereichsbezogenen strukturierten Dokument‑Tags dar, das Inhalte aus mehreren Abschnitten in Java akzeptiert."
type: docs
weight: 639
url: /de/java/com.aspose.words/structureddocumenttagrangeend/
---
...
Stellt das Ende eines **ranged** strukturierten Dokument‑Tags dar, das Inhalte aus mehreren Abschnitten akzeptiert. Siehe auch den Knoten [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).
...
| --- | --- |
| [StructuredDocumentTagRangeEnd(DocumentBase doc, int id)](#StructuredDocumentTagRangeEnd-com.aspose.words.DocumentBase-int) | Initialisiert eine neue Instanz der Klasse **Structured document tag range end**. |
## Methoden
...
| [getId()](#getId) | Gibt eine eindeutige schreibgeschützte persistente numerische Id für diesen **StructuredDocumentTagRange**-Knoten an. |
| [getNextSibling()](#getNextSibling) | Ermittelt den Knoten, der unmittelbar auf diesen Knoten folgt. |
| [getNodeType()](#getNodeType) | Gibt [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END) zurück. |
...
Initialisiert eine neue Instanz der Klasse **Structured document tag range end**.
...
| id | int | Bezeichner des entsprechenden Starts des strukturierten Dokument-Tag-Bereichs. |
...
Gibt eine eindeutige schreibgeschützte persistente numerische Id für diesen **StructuredDocumentTagRange**-Knoten an. Der entsprechende [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/)‑Knoten hat dieselbe [StructuredDocumentTagRangeStart.getId()](../../com.aspose.words/structureddocumenttagrangestart/\#getId).
...
Gibt [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END) zurück.

**Returns:**
int - [NodeType.STRUCTURED\_DOCUMENT\_TAG\_RANGE\_END](../../com.aspose.words/nodetype/\#STRUCTURED-DOCUMENT-TAG-RANGE-END). Der zurückgegebene Wert ist einer der Konstanten von [NodeType](../../com.aspose.words/nodetype/).
