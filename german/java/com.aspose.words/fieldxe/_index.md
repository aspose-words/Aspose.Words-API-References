...
description: "Implementiert das XE-Feld in Java."
type: docs
weight: 306
url: /de/java/com.aspose.words/fieldxe/
---
...
| [getEntryType()](#getEntryType) | Liefert einen Indexeintragstyp. |
...
| [getPageNumberReplacement()](#getPageNumberReplacement) | Liefert den Text, der anstelle einer Seitenzahl verwendet wird. |
| [getPageRangeBookmarkName()](#getPageRangeBookmarkName) | Liefert den Namen des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird. |
...
| [getText()](#getText) | Liefert den Text des Eintrags. |
| [getType()](#getType) | Ermittelt den Microsoft‑Word‑Feldtyp. |
| [getYomi()](#getYomi) | Liefert das Yomi (erstes phonetisches Zeichen zum Sortieren von Indizes) für den Indexeintrag |
| [isBold()](#isBold) | Liefert, ob die Seitenzahl des Eintrags fett formatiert werden soll. |
| [isBold(boolean value)](#isBold-boolean) | Legt fest, ob die Seitenzahl des Eintrags fett formatiert werden soll. |
...
| [isItalic()](#isItalic) | Liefert, ob die Seitenzahl des Eintrags kursiv formatiert werden soll. |
| [isItalic(boolean value)](#isItalic-boolean) | Legt fest, ob die Seitenzahl des Eintrags kursiv formatiert werden soll. |
...
| [setEntryType(String value)](#setEntryType-java.lang.String) | Setzt einen Indexeintragstyp. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setPageNumberReplacement(String value)](#setPageNumberReplacement-java.lang.String) | Setzt den Text, der anstelle einer Seitenzahl verwendet wird. |
| [setPageRangeBookmarkName(String value)](#setPageRangeBookmarkName-java.lang.String) | Setzt den Namen des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird. |
...
| [setText(String value)](#setText-java.lang.String) | Setzt den Text des Eintrags. |
| [setYomi(String value)](#setYomi-java.lang.String) | Setzt das Yomi (erstes phonetisches Zeichen zum Sortieren von Indizes) für den Indexeintrag |
...
Liefert einen Indexeintragstyp.
...
**Returns:**
java.lang.String - Ein Indexeintragstyp.
...
Liefert den Text, der anstelle einer Seitenzahl verwendet wird.
...
**Returns:**
java.lang.String - Text, der anstelle einer Seitenzahl verwendet wird.
...
Liefert den Namen des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird.
...
**Returns:**
java.lang.String - Der Name des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird.
### getResult() {#getResult}
```
...
**Returns:**
java.lang.String - Der Text des Eintrags.
### getType() {#getType}
```
public int getType()
```
...
Liefert das Yomi (erstes phonetisches Zeichen zum Sortieren von Indizes) für den Indexeintrag
...
**Returns:**
java.lang.String - Das Yomi (erstes phonetisches Zeichen zum Sortieren von Indizes) für den Indexeintrag
### isBold() {#isBold}
```
...
Liefert, ob die Seitenzahl des Eintrags fett formatiert werden soll.
...
**Returns:**
boolean - Ob die fette Formatierung auf die Seitenzahl des Eintrags angewendet werden soll.
...
Legt fest, ob die Seitenzahl des Eintrags fett formatiert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die fette Formatierung auf die Seitenzahl des Eintrags angewendet werden soll. |
...
Liefert, ob die Seitenzahl des Eintrags kursiv formatiert werden soll.
...
**Returns:**
boolean - Ob die kursive Formatierung auf die Seitenzahl des Eintrags angewendet werden soll.
...
Legt fest, ob die Seitenzahl des Eintrags kursiv formatiert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die kursive Formatierung auf die Seitenzahl des Eintrags angewendet werden soll. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ein Indexeintragstyp. |
...
Setzt den Text, der anstelle einer Seitenzahl verwendet wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Text, der anstelle einer Seitenzahl verwendet wird. |
...
Setzt den Namen des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Lesezeichens, das einen Seitenbereich markiert, der als Seitenzahl des Eintrags eingefügt wird. |
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text des Eintrags. |
...
Setzt das Yomi (erstes phonetisches Zeichen zum Sortieren von Indizes) für den Indexeintrag
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Das Yomi (erstes phonetisches Zeichen zum Sortieren von Indexeinträgen) für den Indexeintrag |
