...
description: "Gibt das Ergebnis der Auswertung der IF-Feldbedingung in Java an."
type: docs
weight: 244
url: /de/java/com.aspose.words/fieldifcomparisonresult/
---
...
| Feld | Beschreibung |
| --- | --- |
| [ERROR](#ERROR) | Es gibt einen Fehler in der Bedingung. |
| [FALSE](#FALSE) | Die Bedingung ist  false . |
| [TRUE](#TRUE) | Die Bedingung ist  true . |
| [length](#length) |  |
## Methoden
...
Es gibt einen Fehler in der Bedingung.
