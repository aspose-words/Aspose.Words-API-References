...
description: "Implementiert das IMPORT-Feld in Java."
type: docs
weight: 245
url: /de/java/com.aspose.words/fieldimport/
---
...
Implementiert das IMPORT-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Ruft das im Dokument enthaltene Bild ab.

 **Examples:** 

Zeigt, wie man Bilder mit den Feldern IMPORT und INCLUDEPICTURE einfügt.
...
| [getGraphicFilter()](#getGraphicFilter) | Liest den Namen des Filters für das Format der einzufügenden Grafik. |
...
| [getSourceFullName()](#getSourceFullName) | Ermittelt den Speicherort des Bildes. |
...
| [setGraphicFilter(String value)](#setGraphicFilter-java.lang.String) | Setzt den Namen des Filters für das Format der einzufügenden Grafik. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Setzt den Speicherort des Bildes. |
...
Liest den Namen des Filters für das Format der einzufügenden Grafik.
...
**Returns:**
java.lang.String - Der Name des Filters für das Format der einzufügenden Grafik.
...
Ermittelt den Speicherort des Bildes.
...
**Returns:**
java.lang.String - Der Speicherort des Bildes.
### getStart() {#getStart}
```
...
Setzt den Namen des Filters für das Format der einzufügenden Grafik.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des Filters für das Format der einzufügenden Grafik. |
...
Setzt den Speicherort des Bildes.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Speicherort des Bildes. |
