...
description: "Enthält Informationen über eine Mail‑Merge‑Region in Java."
type: docs
weight: 444
url: /de/java/com.aspose.words/mailmergeregioninfo/
---
...
Enthält Informationen über einen Seriendruckbereich.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Mail Merge and Reporting ][Mail Merge and Reporting].

 **Examples:** 

Zeigt, wie man MailMergeRegionInfo abruft und damit arbeitet.
...
| --- | --- |
| [getEndField()](#getEndField) | Gibt ein Endfeld für die Region zurück. |
| [getEndMustacheTag()](#getEndMustacheTag) | Gibt ein End‑„mustache“-Tag für die Region zurück. |
| [getFields()](#getFields) | Gibt eine Liste von untergeordneten Feldern zurück. |
| [getLevel()](#getLevel) | Gibt die Verschachtelungsebene für die Region zurück. |
| [getMustacheTags()](#getMustacheTags) | Gibt eine Liste von untergeordneten „mustache“-Tags zurück. |
| [getName()](#getName) | Gibt den Namen der Region zurück. |
| [getParentRegion()](#getParentRegion) | Gibt die übergeordnete Regionsinformation zurück (null für die Region oberster Ebene). |
| [getRegions()](#getRegions) | Gibt eine Liste von untergeordneten Regionen zurück. |
| [getStartField()](#getStartField) | Gibt ein Startfeld für die Region zurück. |
| [getStartMustacheTag()](#getStartMustacheTag) | Gibt ein Start-"mustache"-Tag für die Region zurück. |
...
Gibt ein Endfeld für die Region zurück.
...
Gibt eine Liste von untergeordneten Feldern zurück.
...
**Returns:**
java.util.ArrayList - Eine Liste von untergeordneten Feldern.
### getLevel() {#getLevel}
```
public int getLevel()
```
...
**Returns:**
int - Die Verschachtelungsebene für die Region.
...
Gibt eine Liste von untergeordneten „mustache“-Tags zurück.

**Returns:**
java.util.ArrayList - Eine Liste von untergeordneten "mustache"-Tags.
### getName() {#getName}
```
...
**Returns:**
java.lang.String - Der Name der Region.
...
Gibt die übergeordnete Regionsinformation zurück (null für die Region oberster Ebene).

 **Examples:** 

Zeigt, wie man Mail-Merge-Regionen erstellt, auflistet und liest.
...
Gibt eine Liste von untergeordneten Regionen zurück.
...
**Returns:**
java.util.ArrayList - Eine Liste von untergeordneten Regionen.
