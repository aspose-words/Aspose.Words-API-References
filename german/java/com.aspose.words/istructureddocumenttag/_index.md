...
description: "Schnittstelle zur Definition gemeinsamer Daten für StructuredDocumentTag und StructuredDocumentTagRangeStart in Java."
type: docs
weight: 785
url: /de/java/com.aspose.words/istructureddocumenttag/
---
```
public interface IStructuredDocumentTag
```

Schnittstelle zur Definition gemeinsamer Daten für [StructuredDocumentTag](../../com.aspose.words/structureddocumenttag/) und [StructuredDocumentTagRangeStart](../../com.aspose.words/structureddocumenttagrangestart/).

 **Examples:** 

Zeigt, wie man ein strukturiertes Dokument-Tag entfernt, aber den Inhalt beibehält.
...
| [getId()](#getId) | Gibt eine eindeutige schreibgeschützte persistente numerische ID für dieses **SDT** an. |
| [getLevel()](#getLevel) | Ermittelt die Ebene, auf der dieses **SDT** im Dokumentbaum vorkommt. |
| [getLockContentControl()](#getLockContentControl) | Wenn auf true gesetzt, verhindert diese Eigenschaft, dass ein Benutzer dieses **SDT** löscht. |
| [getLockContents()](#getLockContents) | Wenn auf true gesetzt, verhindert diese Eigenschaft, dass ein Benutzer den Inhalt dieses **SDT** bearbeitet. |
| [getNode()](#getNode) | Gibt ein Node‑Objekt zurück, das diese Schnittstelle implementiert. |
| [getPlaceholder()](#getPlaceholder) | Ermittelt das [BuildingBlock](../../com.aspose.words/buildingblock/) mit Platzhaltertext, das angezeigt werden soll, wenn der Inhalt dieses SDT‑Laufs leer ist, das zugehörige zugeordnete XML‑Element leer ist, wie über das [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) Element angegeben, oder das [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) Element auf true gesetzt ist. |
...
| [getSdtType()](#getSdtType) | Ermittelt den Typ dieses **Structured document tag**. |
| [getTag()](#getTag) | Gibt ein Tag an, das dem aktuellen SDT-Knoten zugeordnet ist. |
| [getTitle()](#getTitle) | Gibt den freundlichen Namen an, der mit diesem **SDT** verknüpft ist. |
...
| [getXmlMapping()](#getXmlMapping) | Liefert ein Objekt, das die Zuordnung dieses strukturierten Dokumenttags zu XML‑Daten in einem benutzerdefinierten XML‑Teil des aktuellen Dokuments darstellt. |
| [isMultiSection()](#isMultiSection) | Gibt true zurück, wenn diese Instanz ein Bereichs‑(Mehrabschnitt‑)strukturierter Dokument-Tag ist. |
| [isShowingPlaceholderText()](#isShowingPlaceholderText) | Gibt an, ob der Inhalt dieses **SDT** als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT). |
| [isShowingPlaceholderText(boolean value)](#isShowingPlaceholderText-boolean) | Gibt an, ob der Inhalt dieses **SDT** als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT). |
| [removeSelfOnly()](#removeSelfOnly) | Entfernt nur diesen SDT‑Knoten selbst, lässt jedoch dessen Inhalt im Dokumentbaum erhalten. |
...
| [setLockContentControl(boolean value)](#setLockContentControl-boolean) | Wenn auf true gesetzt, verhindert diese Eigenschaft, dass ein Benutzer dieses **SDT** löscht. |
| [setLockContents(boolean value)](#setLockContents-boolean) | Wenn auf true gesetzt, verhindert diese Eigenschaft, dass ein Benutzer den Inhalt dieses **SDT** bearbeitet. |
...
| [setTag(String value)](#setTag-java.lang.String) | Gibt ein Tag an, das dem aktuellen SDT-Knoten zugeordnet ist. |
| [setTitle(String value)](#setTitle-java.lang.String) | Gibt den freundlichen Namen an, der mit diesem **SDT** verknüpft ist. |
...
Ermittelt die Ebene, auf der dieses **SDT** im Dokumentbaum vorkommt.
...
**Returns:**
int – Die Ebene, auf der dieses **SDT** im Dokumentbaum vorkommt. Der zurückgegebene Wert ist einer der Konstanten aus [MarkupLevel](../../com.aspose.words/markuplevel/).
...
Zeigt, wie Bearbeitungsbeschränkungen auf strukturierte Dokumenttags angewendet werden.
...
Ermittelt das [BuildingBlock](../../com.aspose.words/buildingblock/) mit Platzhaltertext, das angezeigt werden soll, wenn der Inhalt dieses SDT‑Laufs leer ist, das zugehörige zugeordnete XML‑Element leer ist, wie über das [getXmlMapping()](../../com.aspose.words/istructureddocumenttag/\#getXmlMapping) Element angegeben, oder das [isShowingPlaceholderText()](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/istructureddocumenttag/\#isShowingPlaceholderText-boolean) Element auf true gesetzt ist.
...
Zeigt, wie der Inhalt eines Bausteins als benutzerdefinierter Platzhaltertext für einen strukturierten Dokumenttag verwendet wird.
...
Ermittelt den Typ dieses **Structured document tag**.

**Returns:**
int – Typ dieses **Structured document tag**. Der zurückgegebene Wert ist einer der Konstanten aus [SdtType](../../com.aspose.words/sdttype/).
### getTag() {#getTag}
```
...
Zeigt, wie ein strukturierter Dokumenttag in einem einfachen Textfeld erstellt und dessen Erscheinungsbild geändert wird.
...
Gibt den freundlichen Namen an, der mit diesem **SDT** verknüpft ist. Darf nicht null sein.
...
Zeigt, wie das im Knoten enthaltene XML im FlatOpc‑Format abgerufen wird.
...
Liefert ein Objekt, das die Zuordnung dieses strukturierten Dokumenttags zu XML‑Daten in einem benutzerdefinierten XML‑Teil des aktuellen Dokuments darstellt.

 **Remarks:** 

Sie können die Methode [XmlMapping.setMapping(com.aspose.words.CustomXmlPart, java.lang.String, java.lang.String)](../../com.aspose.words/xmlmapping/\#setMapping-com.aspose.words.CustomXmlPart--java.lang.String--java.lang.String) dieses Objekts verwenden, um einen strukturierten Dokumenttag zu XML‑Daten zuzuordnen.
...
**Returns:**
boolean – True, wenn diese Instanz ein Bereichs‑(Mehrabschnitt‑)strukturierter Dokument-Tag ist.
...
Gibt an, ob der Inhalt dieses **SDT** als Platzhaltertext interpretiert werden soll (im Gegensatz zu regulärem Textinhalt innerhalb des SDT).
...
Entfernt nur diesen SDT‑Knoten selbst, lässt jedoch dessen Inhalt im Dokumentbaum erhalten.
