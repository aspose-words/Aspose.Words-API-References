...
description: "Implementiert das INCLUDEPICTURE-Feld in Java."
type: docs
weight: 247
url: /de/java/com.aspose.words/fieldincludepicture/
---
...
Ruft ein Bild ab und zeigt es als Feldresultat an.
...
| [getResizeHorizontally()](#getResizeHorizontally) | Liest, ob das Bild horizontal von der Quelle skaliert werden soll. |
| [getResizeVertically()](#getResizeVertically) | Liest, ob das Bild vertikal von der Quelle skaliert werden soll. |
...
| [getSourceFullName()](#getSourceFullName) | Liest den Speicherort des Bildes mittels einer IRI. |
...
| [setResizeHorizontally(boolean value)](#setResizeHorizontally-boolean) | Setzt, ob das Bild horizontal von der Quelle skaliert werden soll. |
| [setResizeVertically(boolean value)](#setResizeVertically-boolean) | Legt fest, ob das Bild vertikal aus der Quelle skaliert werden soll. |
...
| [setSourceFullName(String value)](#setSourceFullName-java.lang.String) | Legt den Speicherort des Bildes mittels einer IRI fest. |
...
Liest, ob das Bild horizontal von der Quelle skaliert werden soll.
...
**Returns:**
boolean - Ob das Bild horizontal aus der Quelle skaliert werden soll.
...
Liest, ob das Bild vertikal von der Quelle skaliert werden soll.
...
**Returns:**
boolean - Ob das Bild vertikal aus der Quelle skaliert werden soll.
### getResult() {#getResult}
```
...
Liest den Speicherort des Bildes mittels einer IRI.
...
**Returns:**
java.lang.String - Der Speicherort des Bildes mittels einer IRI.
### getStart() {#getStart}
```
...
Setzt, ob das Bild horizontal von der Quelle skaliert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob das Bild horizontal aus der Quelle skaliert werden soll. |
...
Legt fest, ob das Bild vertikal aus der Quelle skaliert werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob das Bild vertikal aus der Quelle skaliert werden soll. |
...
Legt den Speicherort des Bildes mittels einer IRI fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Speicherort des Bildes mittels einer IRI. |
