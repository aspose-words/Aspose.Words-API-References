...
description: "Stellt die minimale oder maximale Grenze von Achsenwerten in Java dar."
type: docs
weight: 22
url: /de/java/com.aspose.words/axisbound/
---
...
Stellt den minimalen oder maximalen Grenzwert von Achsenwerten dar.

Weitere Informationen finden Sie im Dokumentationsartikel zu [ Working with Charts ][Working with Charts].

 **Remarks:** 

Die Grenze kann als numerischer, Datum/Zeit- oder ein spezieller "auto"-Wert angegeben werden.
...
| [AxisBound(double value)](#AxisBound-double) | Erstellt eine Achsengrenze, die als Zahl dargestellt wird. |
| [AxisBound(Date datetime)](#AxisBound-java.util.Date) | Erstellt eine Achsengrenze, die als Datum/Zeit-Wert dargestellt wird. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [equals(Object obj)](#equals-java.lang.Object) | Bestimmt, ob das angegebene Objekt im Wert dem aktuellen Objekt entspricht. |
| [getValue()](#getValue) | Gibt den numerischen Wert der Achsengrenze zurück. |
| [getValueAsDate()](#getValueAsDate) | Gibt den Wert der Achsenbegrenzung zurück, dargestellt als datetime. |
| [hashCode()](#hashCode) |  |
| [isAuto()](#isAuto) | Gibt ein Flag zurück, das anzeigt, dass die Achsenbegrenzung automatisch bestimmt werden soll. |
...
Erstellt eine Achsengrenze, die als Datum/Zeit-Wert dargestellt wird.
...
**Returns:**
double - Numerischer Wert der Achsenbegrenzung.
...
Gibt den Wert der Achsenbegrenzung zurück, dargestellt als datetime.
...
**Returns:**
java.util.Date - Wert der Achsenbegrenzung dargestellt als datetime.
### hashCode() {#hashCode}
```
public int hashCode()
```
...
Gibt ein Flag zurück, das anzeigt, dass die Achsenbegrenzung automatisch bestimmt werden soll.
...
**Returns:**
boolean - Ein Flag, das anzeigt, dass die Achsenbegrenzung automatisch bestimmt werden soll.
### toString() {#toString}
```
