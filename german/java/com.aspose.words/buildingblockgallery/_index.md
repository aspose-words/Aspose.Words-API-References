...
description: "Gibt die vordefinierte Galerie an, in die ein Baustein in Java klassifiziert wird."
type: docs
weight: 55
url: /de/java/com.aspose.words/buildingblockgallery/
---
...
Gibt die vordefinierte Galerie an, in die ein Building Block klassifiziert wird.

 **Remarks:** 

Entspricht dem Typ **ST\\_DocPartGallery** in OOXML.
...
| Feld | Beschreibung |
| --- | --- |
| [ALL](#ALL) | Gibt an, dass dieser Glossareintrags mit allen möglichen Galerieklassifizierungswerten verknüpft sein soll. |
| [AUTO_TEXT](#AUTO-TEXT) |  |
...
| [DEFAULT](#DEFAULT) | Entspricht [ALL](../../com.aspose.words/buildingblockgallery/\\#ALL). |
| [EQUATIONS](#EQUATIONS) |  |
| [FOOTERS](#FOOTERS) |  |
| [HEADERS](#HEADERS) |  |
...
Gibt an, dass dieser Glossareintrags mit allen möglichen Galerieklassifizierungswerten verknüpft sein soll.
...
Entspricht [ALL](../../com.aspose.words/buildingblockgallery/\\#ALL).
