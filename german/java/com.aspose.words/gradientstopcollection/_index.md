...
description: "Enthält eine Sammlung von GradientStop-Objekten in Java."
type: docs
weight: 363
url: /de/java/com.aspose.words/gradientstopcollection/
---
...
Enthält eine Sammlung von [GradientStop](../../com.aspose.words/gradientstop/) Objekten.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Graphic Elements ][Working with Graphic Elements].

 **Remarks:** 

Sie erstellen keine Instanzen dieser Klasse direkt. Verwenden Sie die Eigenschaft [Fill.getGradientStops()](../../com.aspose.words/fill/\#getGradientStops), um auf die Gradient-Stops von Füllobjekten zuzugreifen.
...
| --- | --- |
| [add(GradientStop gradientStop)](#add-com.aspose.words.GradientStop) | Fügt einen angegebenen [GradientStop](../../com.aspose.words/gradientstop/) zu einem Farbverlauf hinzu. |
| [get(int index)](#get-int) | Ruft ein [GradientStop](../../com.aspose.words/gradientstop/) Objekt aus der Sammlung ab. |
| [getCount()](#getCount) | Ruft einen ganzzahligen Wert ab, der die Anzahl der Elemente in der Sammlung angibt. |
| [insert(int index, GradientStop gradientStop)](#insert-int-com.aspose.words.GradientStop) | Fügt ein [GradientStop](../../com.aspose.words/gradientstop/) an einem angegebenen Index in die Sammlung ein. |
| [iterator()](#iterator) | Gibt einen Enumerator zurück, der die Sammlung durchläuft. |
| [remove(GradientStop gradientStop)](#remove-com.aspose.words.GradientStop) | Entfernt ein angegebenes [GradientStop](../../com.aspose.words/gradientstop/) aus der Sammlung. |
| [removeAt(int index)](#removeAt-int) | Entfernt ein [GradientStop](../../com.aspose.words/gradientstop/) aus der Sammlung an einem angegebenen Index. |
| [set(int index, GradientStop value)](#set-int-com.aspose.words.GradientStop) | Setzt ein [GradientStop](../../com.aspose.words/gradientstop/) Objekt in der Sammlung. |
...
Fügt einen angegebenen [GradientStop](../../com.aspose.words/gradientstop/) zu einem Farbverlauf hinzu.
...
Ruft ein [GradientStop](../../com.aspose.words/gradientstop/) Objekt aus der Sammlung ab.
...
**Returns:**
int – Ein ganzzahliger Wert, der die Anzahl der Elemente in der Sammlung angibt.
...
Fügt ein [GradientStop](../../com.aspose.words/gradientstop/) an einem angegebenen Index in die Sammlung ein.
...
Entfernt ein angegebenes [GradientStop](../../com.aspose.words/gradientstop/) aus der Sammlung.
...
**Returns:**
boolean –  true  wenn der Gradient-Stop erfolgreich entfernt wurde, andernfalls  false .
...
Entfernt ein [GradientStop](../../com.aspose.words/gradientstop/) aus der Sammlung an einem angegebenen Index.
...
Setzt ein [GradientStop](../../com.aspose.words/gradientstop/) Objekt in der Sammlung.
...
| --- | --- | --- |
| Index | int |  |
| value | [GradientStop](../../com.aspose.words/gradientstop/) | Ein [GradientStop](../../com.aspose.words/gradientstop/) Objekt in der Sammlung. |
