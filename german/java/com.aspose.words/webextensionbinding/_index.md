...
description: "Gibt eine Bindungsbeziehung zwischen einer Web‑Erweiterung und den Daten im Dokument in Java an."
type: docs
weight: 727
url: /de/java/com.aspose.words/webextensionbinding/
---
...
Gibt eine Bindungsbeziehung zwischen einer Web-Erweiterung und den Daten im Dokument an.
...
| --- | --- |
| [WebExtensionBinding(String id, int bindingType, String appRef)](#WebExtensionBinding-java.lang.String-int-java.lang.String) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getAppRef()](#getAppRef) | Gibt den Bindungsschlüssel an, der verwendet wird, um den Bindungseintrag in dieser Liste mit den gebundenen Daten im Dokument zuzuordnen. |
| [getBindingType()](#getBindingType) | Gibt den Bindungstyp an. |
| [getId()](#getId) | Gibt den Bindungsbezeichner an. |
| [setAppRef(String value)](#setAppRef-java.lang.String) | Gibt den Bindungsschlüssel an, der verwendet wird, um den Bindungseintrag in dieser Liste mit den gebundenen Daten im Dokument zuzuordnen. |
| [setBindingType(int value)](#setBindingType-int) | Gibt den Bindungstyp an. |
| [setId(String value)](#setId-java.lang.String) | Gibt den Bindungsbezeichner an. |
...
Gibt den Bindungsschlüssel an, der verwendet wird, um den Bindungseintrag in dieser Liste mit den gebundenen Daten im Dokument zuzuordnen.
...
**Returns:**
int - Der entsprechende  int  Wert. Der zurückgegebene Wert ist einer der Konstanten von [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/) Konstanten.
### getId() {#getId}
```
public String getId()
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | int | Der entsprechende  int  Wert. Der Wert muss einer der Konstanten von [WebExtensionBindingType](../../com.aspose.words/webextensionbindingtype/) sein. |
