...
description: "Tabellen-Schriftart-Substitutionsregel in Java."
type: docs
weight: 662
url: /de/java/com.aspose.words/tablesubstitutionrule/
---
...
Regel für die Schriftart‑Substitution in Tabellen.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Working with Fonts ][Working with Fonts].

 **Remarks:** 

Diese Regel definiert die Liste der Ersatz‑Schriftartnamen, die verwendet werden, wenn die Originalschriftart nicht verfügbar ist. Ersatzschriften werden anhand des Schriftartnamens und der [FontInfo.getAltName()](../../com.aspose.words/fontinfo/\#getAltName) / [FontInfo.setAltName(java.lang.String)](../../com.aspose.words/fontinfo/\#setAltName-java.lang.String) (falls vorhanden) überprüft.
...
| --- | --- |
| [addSubstitutes(String originalFontName, String[] substituteFontNames)](#addSubstitutes-java.lang.String-java.lang.String...) | Fügt Ersatz‑Schriftartnamen für einen angegebenen Originalschriftartnamen hinzu. |
| [getEnabled()](#getEnabled) | Gibt an, ob die Regel aktiviert ist oder nicht. |
| [getSubstitutes(String originalFontName)](#getSubstitutes-java.lang.String) | Gibt ein Array zurück, das Ersatz‑Schriftartnamen für den angegebenen Originalschriftartnamen enthält. |
| [load(InputStream stream)](#load-java.io.InputStream) |  |
| [load(String fileName)](#load-java.lang.String) | Lädt Tabellensubstitutionseinstellungen aus einer XML‑Datei. |
| [loadAndroidSettings()](#loadAndroidSettings) | Lädt vordefinierte Tabellensubstitutionseinstellungen für die Android‑Plattform. |
| [loadLinuxSettings()](#loadLinuxSettings) | Lädt vordefinierte Tabellensubstitutionseinstellungen für die Linux‑Plattform. |
| [loadWindowsSettings()](#loadWindowsSettings) | Lädt vordefinierte Tabellensubstitutionseinstellungen für die Windows‑Plattform. |
| [save(OutputStream outputStream)](#save-java.io.OutputStream) |  |
| [save(String fileName)](#save-java.lang.String) | Speichert die aktuellen Tabellensubstitutionseinstellungen in einer Datei. |
| [setEnabled(boolean value)](#setEnabled-boolean) | Gibt an, ob die Regel aktiviert ist oder nicht. |
| [setSubstitutes(String originalFontName, String[] substituteFontNames)](#setSubstitutes-java.lang.String-java.lang.String...) | Überschreibt Ersatz‑Schriftartnamen für einen angegebenen Originalschriftartnamen. |
...
Fügt Ersatz‑Schriftartnamen für einen angegebenen Originalschriftartnamen hinzu.
...
Zeigt, wie man mit benutzerdefinierten Schriftart‑Substitutionstabellen arbeitet.
...
| substituteFontNames | java.lang.String[] | Liste alternativer Schriftartnamen. |
...
Gibt ein Array zurück, das Ersatz‑Schriftartnamen für den angegebenen Originalschriftartnamen enthält.
...
**Returns:**
java.lang.Iterable – Liste alternativer Schriftartnamen.
### load(InputStream stream) {#load-java.io.InputStream}
```
...
Lädt Tabellensubstitutionseinstellungen aus einer XML‑Datei.
...
Lädt vordefinierte Tabellensubstitutionseinstellungen für die Android‑Plattform.
...
Speichert die aktuellen Tabellensubstitutionseinstellungen in einer Datei.
...
Überschreibt Ersatz‑Schriftartnamen für einen angegebenen Originalschriftartnamen.

 **Examples:** 

Zeigt, wie man Schriftart‑Substitutionsregeln festlegt.
