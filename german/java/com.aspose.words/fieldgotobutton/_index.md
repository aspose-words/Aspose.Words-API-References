...
description: "Implementiert das GOTOBUTTON-Feld in Java."
type: docs
weight: 240
url: /de/java/com.aspose.words/fieldgotobutton/
---
...
Fügt einen Sprungbefehl ein, sodass beim Aktivieren der Einfügepunkt des Dokuments an die angegebene Position verschoben wird.

 **Examples:** 

Zeigt das Einfügen eines GOTOBUTTON-Feldes.
...
| [getDisplayText()](#getDisplayText) | Liest den Text der "Schaltfläche" aus, die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren. |
...
| [getLocation()](#getLocation) | Liest den Namen eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Setzt den Text der "Schaltfläche", die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setLocation(String value)](#setLocation-java.lang.String) | Setzt den Namen eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll. |
...
Liest den Text der "Schaltfläche" aus, die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren.
...
**Returns:**
java.lang.String - Der Text der "Schaltfläche", die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren.
### getEnd() {#getEnd}
```
...
Liest den Namen eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll.
...
**Returns:**
java.lang.String - Der Name eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll.
### getResult() {#getResult}
```
...
Setzt den Text der "Schaltfläche", die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text der "Schaltfläche", die im Dokument erscheint, sodass sie ausgewählt werden kann, um den Sprung zu aktivieren. |
...
Setzt den Namen eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name eines Lesezeichens, einer Seitenzahl oder eines anderen Elements, zu dem gesprungen werden soll. |
