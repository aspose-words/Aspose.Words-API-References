...
description: "Gibt den Typ einer Kategorienachse in Java an."
type: docs
weight: 24
url: /de/java/com.aspose.words/axiscategorytype/
---
...
| Feld | Beschreibung |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Gibt an, dass der Typ einer Kategorienachse automatisch anhand der Daten bestimmt wird. |
| [CATEGORY](#CATEGORY) | Gibt eine Achse eines beliebigen Satzes von Kategorien an. |
| [TIME](#TIME) | Gibt eine Zeit‑Kategorienachse an. |
| [length](#length) |  |
## Methoden
...
Gibt an, dass der Typ einer Kategorienachse automatisch anhand der Daten bestimmt wird.
...
Gibt eine Achse eines beliebigen Satzes von Kategorien an.
...
Gibt eine Zeit‑Kategorienachse an.
