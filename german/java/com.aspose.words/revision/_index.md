...
description: "Stellt eine nachverfolgte Änderung (Revision) in einem Dokumentknoten oder Stil in Java dar."
type: docs
weight: 579
url: /de/java/com.aspose.words/revision/
---
...
Stellt eine Revision (nachverfolgte Änderung) in einem Dokumentknoten oder Stil dar. Verwenden Sie [getRevisionType()](../../com.aspose.words/revision/\#getRevisionType), um den Typ dieser Revision zu prüfen.
...
| --- | --- |
| [accept()](#accept) | Akzeptiert diese Revision. |
| [getAuthor()](#getAuthor) | Liefert den Autor dieser Revision. |
| [getDateTime()](#getDateTime) | Liefert das Datum/Uhrzeit dieser Revision. |
| [getGroup()](#getGroup) | Liefert die Revisionsgruppe. |
| [getParentNode()](#getParentNode) | Liefert den unmittelbaren übergeordneten Knoten (Eigentümer) dieser Revision. |
| [getParentStyle()](#getParentStyle) | Liefert den unmittelbaren übergeordneten Stil (Eigentümer) dieser Revision. |
| [getRevisionType()](#getRevisionType) | Liefert den Typ dieser Revision. |
| [reject()](#reject) | Verwirft diese Revision. |
| [setAuthor(String value)](#setAuthor-java.lang.String) | Setzt den Autor dieser Revision. |
| [setDateTime(Date value)](#setDateTime-java.util.Date) | Setzt das Datum/Uhrzeit dieser Revision. |
### accept() {#accept}
```
public void accept()
```
...
Liefert den Autor dieser Revision. Darf nicht leerer String oder null sein.
...
**Returns:**
java.lang.String - Der Autor dieser Revision.
...
Liefert das Datum/Uhrzeit dieser Revision.
...
**Returns:**
java.util.Date - Das Datum/Uhrzeit dieser Revision.
### getGroup() {#getGroup}
```
...
Liefert die Revisionsgruppe. Gibt null zurück, wenn die Revision keiner Gruppe zugeordnet ist.

 **Remarks:** 

Eine Revision hat keine Gruppe, wenn der Revisionstyp [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE) ist oder wenn die Revision im Dokumentkontext nicht mehr existiert (akzeptiert/abgelehnt).
...
Liefert den unmittelbaren übergeordneten Knoten (Besitzer) dieser Revision. Diese Eigenschaft funktioniert für jeden Revisionstyp außer [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Wenn sich diese Revision auf eine Änderung der Formatierung von Stilen bezieht, verwenden Sie stattdessen [getParentStyle()](../../com.aspose.words/revision/\#getParentStyle).
...
Liefert den unmittelbaren übergeordneten Stil (Besitzer) dieser Revision. Diese Eigenschaft funktioniert nur für den Revisionstyp [RevisionType.STYLE\_DEFINITION\_CHANGE](../../com.aspose.words/revisiontype/\#STYLE-DEFINITION-CHANGE).

 **Remarks:** 

Wenn sich diese Revision auf Änderungen von Dokumentknoten bezieht, verwenden Sie stattdessen [getParentNode()](../../com.aspose.words/revision/\#getParentNode).
...
Liefert den Typ dieser Revision.
...
**Returns:**
int – Der Typ dieser Revision. Der zurückgegebene Wert ist einer der Konstanten von [RevisionType](../../com.aspose.words/revisiontype/).
### reject() {#reject}
```
public void reject()
```
...
Legt den Autor dieser Revision fest. Darf nicht leer sein oder null.
...
| --- | --- | --- |
| Wert | java.lang.String | Der Autor dieser Revision. |
...
Setzt das Datum/Uhrzeit dieser Revision.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.util.Date | Das Datum/Uhrzeit dieser Revision. |
