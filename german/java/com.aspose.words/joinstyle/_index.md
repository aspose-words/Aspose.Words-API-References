...
description: "Linienverbindungsstil in Java."
type: docs
weight: 407
url: /de/java/com.aspose.words/joinstyle/
---
...
| Feld | Beschreibung |
| --- | --- |
| [BEVEL](#BEVEL) | Verbinde Kanten mit einer geraden Linie. |
| [MITER](#MITER) | Verlängere Kanten, bis sie sich verbinden. |
| [ROUND](#ROUND) | Zeichne einen Bogen zwischen den beiden Kanten. |
| [length](#length) |  |
## Methoden
...
Verbinde Kanten mit einer geraden Linie.
...
Verlängere Kanten, bis sie sich verbinden.
...
Zeichne einen Bogen zwischen den beiden Kanten.
