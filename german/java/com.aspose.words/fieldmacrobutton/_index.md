...
description: "Implementiert das MACROBUTTON-Feld in Java."
type: docs
weight: 256
url: /de/java/com.aspose.words/fieldmacrobutton/
---
...
Zeigt, wie man MACROBUTTON-Felder verwendet, um die Makros eines Dokuments durch Klicken auszuführen.
...
| [getDisplayText()](#getDisplayText) | Liefert den Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird. |
...
| [getMacroName()](#getMacroName) | Liefert den Namen des auszuführenden Makros oder Befehls. |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String) | Setzt den Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setMacroName(String value)](#setMacroName-java.lang.String) | Setzt den Namen des auszuführenden Makros oder Befehls. |
...
Liefert den Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird.
...
**Returns:**
java.lang.String - Der Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird.
### getEnd() {#getEnd}
```
...
Liefert den Namen des auszuführenden Makros oder Befehls.
...
**Returns:**
java.lang.String - Der Name des auszuführenden Makros oder Befehls.
### getMergeFieldName() {#getMergeFieldName}
```
...
Setzt den Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text, der als "Schaltfläche" angezeigt wird, die zum Ausführen des Makros oder Befehls ausgewählt wird. |
...
Setzt den Namen des auszuführenden Makros oder Befehls.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name des auszuführenden Makros oder Befehls. |
