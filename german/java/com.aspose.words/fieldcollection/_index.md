...
description: "Eine Sammlung von Field-Objekten, die die Felder im angegebenen Bereich in Java darstellt."
type: docs
weight: 212
url: /de/java/com.aspose.words/fieldcollection/
---
...
Eine Sammlung von [Field](../../com.aspose.words/field/)-Objekten, die die Felder im angegebenen Bereich darstellt.
...
Die [FieldCollection](../../com.aspose.words/fieldcollection/)-Sammlung besitzt die enthaltenen Felder nicht, sondern ist lediglich eine Auswahl von Feldern.

Die [FieldCollection](../../com.aspose.words/fieldcollection/)-Sammlung ist "live", d. h. Änderungen an den Kindknoten des Knotens, von dem sie erstellt wurde, werden sofort in den von den [FieldCollection](../../com.aspose.words/fieldcollection/)-Eigenschaften und -Methoden zurückgegebenen Feldern widergespiegelt.
...
| [get(int index)](#get-int) | Gibt ein Feld am angegebenen Index zurück. |
| [getCount()](#getCount) | Gibt die Anzahl der Felder in der Sammlung zurück. |
| [iterator()](#iterator) | Gibt ein Enumerator‑Objekt zurück. |
| [remove(Field field)](#remove-com.aspose.words.Field) | Entfernt das angegebene Feld aus dieser Sammlung und aus dem Dokument. |
| [removeAt(int index)](#removeAt-int) | Entfernt ein Feld am angegebenen Index aus dieser Sammlung und aus dem Dokument. |
### clear() {#clear}
```
public void clear()
```
...
**Returns:**
int - Die Anzahl der Felder in der Sammlung.
### iterator() {#iterator}
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| field | [Field](../../com.aspose.words/field/) | Ein zu entfernendes Feld. |
