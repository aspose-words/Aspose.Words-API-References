...
description: "Gibt den Typ der in Revision in Java verfolgten Änderung an."
type: docs
weight: 586
url: /de/java/com.aspose.words/revisiontype/
---
...
Gibt den Typ der in [Revision](../../com.aspose.words/revision/) verfolgten Änderung an.
...
| Feld | Beschreibung |
| --- | --- |
| [DELETION](#DELETION) | Inhalt wurde aus dem Dokument entfernt. |
| [FORMAT_CHANGE](#FORMAT-CHANGE) | Eine Formatierungsänderung wurde auf den übergeordneten Knoten angewendet. |
| [INSERTION](#INSERTION) | Neuer Inhalt wurde in das Dokument eingefügt. |
| [MOVING](#MOVING) | Inhalt wurde im Dokument verschoben. |
| [STYLE_DEFINITION_CHANGE](#STYLE-DEFINITION-CHANGE) | Eine Formatierungsänderung wurde auf den übergeordneten Stil angewendet. |
| [length](#length) |  |
## Methoden
...
Inhalt wurde aus dem Dokument entfernt.
...
Eine Formatierungsänderung wurde auf den übergeordneten Knoten angewendet.
...
Neuer Inhalt wurde in das Dokument eingefügt.
...
Inhalt wurde im Dokument verschoben.
...
Eine Formatierungsänderung wurde auf den übergeordneten Stil angewendet.
