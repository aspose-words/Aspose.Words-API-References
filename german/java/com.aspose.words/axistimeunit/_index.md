...
description: "Gibt die Zeiteinheit für Achsen in Java an."
type: docs
weight: 33
url: /de/java/com.aspose.words/axistimeunit/
---
...
| Feld | Beschreibung |
| --- | --- |
| [AUTOMATIC](#AUTOMATIC) | Gibt an, dass die Einheit nicht explizit festgelegt wurde und der Standardwert verwendet werden soll. |
| [DAYS](#DAYS) | Gibt an, dass die Diagrammdaten in Tagen angezeigt werden sollen. |
| [MONTHS](#MONTHS) | Gibt an, dass die Diagrammdaten in Monaten angezeigt werden sollen. |
| [YEARS](#YEARS) | Gibt an, dass die Diagrammdaten in Jahren angezeigt werden sollen. |
| [length](#length) |  |
## Methoden
...
Gibt an, dass die Einheit nicht explizit festgelegt wurde und der Standardwert verwendet werden soll.
...
Gibt an, dass die Diagrammdaten in Tagen angezeigt werden sollen.
...
Gibt an, dass die Diagrammdaten in Monaten angezeigt werden sollen.
...
Gibt an, dass die Diagrammdaten in Jahren angezeigt werden sollen.
