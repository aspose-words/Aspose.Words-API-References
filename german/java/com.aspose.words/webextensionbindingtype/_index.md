...
description: "Enumeriert die verfügbaren Bindungstypen zwischen einer Web-Erweiterung und den Daten im Dokument in Java."
type: docs
weight: 729
url: /de/java/com.aspose.words/webextensionbindingtype/
---
...
Enumeriert verfügbare Bindungstypen zwischen einer Web-Erweiterung und den Daten im Dokument.
...
| Feld | Beschreibung |
| --- | --- |
| [DEFAULT](#DEFAULT) | Standardmäßig verwendete Matrix. |
| [MATRIX](#MATRIX) | Tabellendaten ohne Kopfzeile. |
| [TABLE](#TABLE) | Tabellendaten mit einer Kopfzeile. |
| [TEXT](#TEXT) | Klartext. |
| [length](#length) |  |
## Methoden
...
Standardmäßig verwendete Matrix.
...
Tabellendaten mit einer Kopfzeile.
