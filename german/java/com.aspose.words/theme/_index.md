...
description: "Stellt das Dokument-Theme dar und bietet Zugriff auf die Haupt-Theme-Teile einschließlich getMajorFonts, getMinorFonts und getColors in Java."
type: docs
weight: 682
url: /de/java/com.aspose.words/theme/
---
...
Stellt das Dokument-Theme dar und bietet Zugriff auf die Haupt-Theme-Teile einschließlich [getMajorFonts()](../../com.aspose.words/theme/\#getMajorFonts), [getMinorFonts()](../../com.aspose.words/theme/\#getMinorFonts) und [getColors()](../../com.aspose.words/theme/\#getColors)
...
| --- | --- |
| [getColors()](#getColors) | Ermöglicht das Festlegen des Satzes von Theme-Farben für das Dokument. |
| [getFontName(int themeFont)](#getFontName-int) |  |
| [getMajorFonts()](#getMajorFonts) | Ermöglicht das Festlegen des Satzes von Hauptschriftarten für verschiedene Sprachen. |
| [getMinorFonts()](#getMinorFonts) | Ermöglicht das Festlegen des Satzes von Nebenschriftarten für verschiedene Sprachen. |
| [onChange()](#onChange) |  |
### getColors() {#getColors}
```
...
Ermöglicht das Festlegen des Satzes von Theme-Farben für das Dokument.
...
Ermöglicht das Festlegen des Satzes von Nebenschriftarten für verschiedene Sprachen.
