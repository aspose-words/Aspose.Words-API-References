...
description: "Stellt die Liste der im Dokument verfügbaren Bibliografie-Quellen in Java dar."
type: docs
weight: 38
url: /de/java/com.aspose.words/bibliography/
---
...
Stellt die Liste der im Dokument verfügbaren Bibliografienquellen dar.
...
| --- | --- |
| [getBibliographyStyle()](#getBibliographyStyle) | Gibt einen String zurück, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt. |
| [getSources()](#getSources) | Gibt eine Sammlung zurück, die alle in einer Bibliografie enthaltenen Quellen darstellt. |
| [setBibliographyStyle(String value)](#setBibliographyStyle-java.lang.String) | Setzt einen String, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt. |
...
Gibt einen String zurück, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt.
...
**Returns:**
java.lang.String - Ein String, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt.
...
Gibt eine Sammlung zurück, die alle in einer Bibliografie enthaltenen Quellen darstellt.
...
**Returns:**
java.util.ArrayList - Eine Sammlung, die alle in einer Bibliografie enthaltenen Quellen darstellt.
...
Setzt einen String, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt.
...
| --- | --- | --- |
| Wert | java.lang.String | Ein String, der den Namen des aktiven Stils für die Verwendung in einer Bibliografie darstellt. |
