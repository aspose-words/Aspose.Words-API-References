...
description: "WordArt-Ausrichtung in Java."
type: docs
weight: 677
url: /de/java/com.aspose.words/textpathalignment/
---
...
| Feld | Beschreibung |
| --- | --- |
| [CENTER](#CENTER) | Text auf Breite zentrieren. |
| [LEFT](#LEFT) | Linksbündig ausrichten. |
| [LETTER_JUSTIFY](#LETTER-JUSTIFY) | Buchstaben ausbreiten, um die Breite zu füllen. |
| [RIGHT](#RIGHT) | Rechtsbündig ausrichten. |
| [STRETCH](#STRETCH) | Jede Textzeile strecken, um die Breite zu füllen. |
| [WORD_JUSTIFY](#WORD-JUSTIFY) | Wörter ausbreiten, um die Breite zu füllen. |
| [length](#length) |  |
## Methoden
...
Buchstaben ausbreiten, um die Breite zu füllen.
...
Jede Textzeile strecken, um die Breite zu füllen.
...
Wörter ausbreiten, um die Breite zu füllen.
