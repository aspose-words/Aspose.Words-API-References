...
description: "Implementiert das COMMENTS-Feld in Java."
type: docs
weight: 213
url: /de/java/com.aspose.words/fieldcomments/
---
...
Ruft die Kommentare, die sich auf das aktuelle Dokument beziehen, ab und setzt sie optional, wie in der [BuiltInDocumentProperties.getComments()](../../com.aspose.words/builtindocumentproperties/\#getComments) / [BuiltInDocumentProperties.setComments(java.lang.String)](../../com.aspose.words/builtindocumentproperties/\#setComments-java.lang.String) Eigenschaft der integrierten Dokumenteigenschaften aufgezeichnet.

 **Examples:** 

Zeigt, wie man das COMMENTS-Feld verwendet.
...
| [getText()](#getText) | Ruft den Text der Kommentare ab. |
...
| [setText(String value)](#setText-java.lang.String) | Setzt den Text der Kommentare. |
...
Ruft den Text der Kommentare ab.
...
**Returns:**
java.lang.String - Der Text der Kommentare.
### getType() {#getType}
```
public int getType()
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Text der Kommentare. |
