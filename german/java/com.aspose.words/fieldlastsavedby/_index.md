...
description: "Implementiert das LASTSAVEDBY‑Feld in Java."
type: docs
weight: 253
url: /de/java/com.aspose.words/fieldlastsavedby/
---
...
Implementiert das LASTSAVEDBY-Feld.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Ruft den Namen des Benutzers ab, der das aktuelle Dokument zuletzt geändert und gespeichert hat, wie im **LastModifiedBy**‑Eigenschaft der integrierten Dokumenteigenschaften aufgezeichnet.

 **Examples:** 

Zeigt, wie das LASTSAVEDBY‑Feld verwendet wird.
