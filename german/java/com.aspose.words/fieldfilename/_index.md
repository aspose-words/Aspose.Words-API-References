...
description: "Implementiert das FILENAME-Feld in Java."
type: docs
weight: 230
url: /de/java/com.aspose.words/fieldfilename/
---
...
Implementiert das FILENAME-Feld.
...
In der aktuellen Implementierung wird die Eigenschaft [Document.getOriginalFileName()](../../com.aspose.words/document/\#getOriginalFileName) verwendet, um den Dateinamen abzurufen. Wenn das Dokument aus einem Stream geladen oder leer erstellt wurde, wird der Name der Datei verwendet, in die gespeichert wird (falls bekannt).

 **Examples:** 

Zeigt, wie man FieldOptions verwendet, um den Standardwert für das FILENAME-Feld zu überschreiben.
...
| [getIncludeFullPath()](#getIncludeFullPath) | Ermittelt, ob der vollständige Dateipfadname eingeschlossen werden soll. |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean) | Legt fest, ob der vollständige Dateipfadname eingeschlossen werden soll. |
...
Ermittelt, ob der vollständige Dateipfadname eingeschlossen werden soll.
...
**Returns:**
boolean - Ob der vollständige Dateipfadname einbezogen werden soll.
...
Legt fest, ob der vollständige Dateipfadname eingeschlossen werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob der vollständige Dateipfadname einbezogen werden soll. |
