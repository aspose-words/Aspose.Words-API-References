...
description: "Stellt Daten für das Feldaktualisierungsfortschrittsereignis in Java bereit."
type: docs
weight: 302
url: /de/java/com.aspose.words/fieldupdatingprogressargs/
---
...
Stellt Daten für das Ereignis zum Fortschritt der Feldaktualisierung bereit.
...
| --- | --- |
| [getTotalFieldsCount()](#getTotalFieldsCount) | Ermittelt die Gesamtanzahl der zu aktualisierenden Felder. |
| [getUpdateCompleted()](#getUpdateCompleted) | Ermittelt einen Wert, der angibt, ob die Feldaktualisierung abgeschlossen ist. |
| [getUpdatedFieldsCount()](#getUpdatedFieldsCount) | Ermittelt die Anzahl der aktualisierten Felder. |
...
Ermittelt die Gesamtanzahl der zu aktualisierenden Felder.
...
**Returns:**
int - Die Gesamtanzahl der zu aktualisierenden Felder.
...
Ermittelt einen Wert, der angibt, ob die Feldaktualisierung abgeschlossen ist.
...
**Returns:**
boolean - Ein Wert, der angibt, ob die Feldaktualisierung abgeschlossen ist.
...
Ermittelt die Anzahl der aktualisierten Felder.
...
**Returns:**
int - Die Anzahl der aktualisierten Felder.
