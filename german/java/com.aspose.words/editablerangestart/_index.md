...
description: "Stellt den Beginn eines bearbeitbaren Bereichs in einem Word-Dokument in Java dar."
type: docs
weight: 181
url: /de/java/com.aspose.words/editablerangestart/
---
...
Ein vollständiger bearbeitbarer Bereich in einem Word-Dokument besteht aus einem [EditableRangeStart](../../com.aspose.words/editablerangestart/) und einem passenden [EditableRangeEnd](../../com.aspose.words/editablerangeend/) mit derselben Id.
...
Verwenden Sie die Klasse [getEditableRange()](../../com.aspose.words/editablerangestart/\#getEditableRange) als "Fassade", um mit einem bearbeitbaren Bereich als einzelnes Objekt zu arbeiten.

Derzeit werden bearbeitbare Bereiche nur auf Inline-Ebene unterstützt, das heißt innerhalb von [Paragraph](../../com.aspose.words/paragraph/), aber der Beginn und das Ende eines bearbeitbaren Bereichs können in verschiedenen Absätzen liegen.
...
| [getEditableRange()](#getEditableRange) | Liefert das Fassadenobjekt, das diesen Beginn und das Ende des bearbeitbaren Bereichs kapselt. |
| [getId()](#getId) | Gibt den Bezeichner des bearbeitbaren Bereichs an. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Ermittelt den Knoten, der unmittelbar auf diesen Knoten folgt. |
| [getNodeType()](#getNodeType) | Gibt [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START) zurück. |
...
| [setId(int value)](#setId-int) | Gibt den Bezeichner des bearbeitbaren Bereichs an. |
...
Ruft [DocumentVisitor.visitEditableRangeStart(com.aspose.words.EditableRangeStart)](../../com.aspose.words/documentvisitor/\#visitEditableRangeStart-com.aspose.words.EditableRangeStart) auf.
...
Liefert das Fassadenobjekt, das diesen Beginn und das Ende des bearbeitbaren Bereichs kapselt.
...
Gibt [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START) zurück.
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_START](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-START). Der zurückgegebene Wert ist einer der [NodeType](../../com.aspose.words/nodetype/) Konstanten.
### getParentIdInternal() {#getParentIdInternal}
```
