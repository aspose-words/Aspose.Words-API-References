...
description: "Bezeichnet den Beginn eines Textbereichs, dem in Java ein Kommentar zugeordnet ist."
type: docs
weight: 112
url: /de/java/com.aspose.words/commentrangestart/
---
...
| --- | --- |
| [CommentRangeStart(DocumentBase doc, int id)](#CommentRangeStart-com.aspose.words.DocumentBase-int) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden
...
| [getId()](#getId) | Gibt die Kennung des Kommentars an, mit dem dieser Bereich verknüpft ist. |
| [getIdInternal()](#getIdInternal) |  |
| [getNextSibling()](#getNextSibling) | Ermittelt den Knoten, der unmittelbar auf diesen Knoten folgt. |
| [getNodeType()](#getNodeType) | Gibt [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START) zurück. |
...
| [setId(int value)](#setId-int) | Gibt die Kennung des Kommentars an, mit dem dieser Bereich verknüpft ist. |
...
Wenn [CommentRangeStart](../../com.aspose.words/commentrangestart/) erstellt wird, gehört es zum angegebenen Dokument, ist jedoch noch nicht Teil des Dokuments und [Node.getParentNode()](../../com.aspose.words/node/\#getParentNode) ist null.

Um ein [CommentRangeStart](../../com.aspose.words/commentrangestart/) an das Dokument anzuhängen, verwenden Sie InsertAfter oder InsertBefore im Absatz, in dem der Kommentar eingefügt werden soll.
...
Ruft [DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor/\#visitCommentRangeStart-com.aspose.words.CommentRangeStart) auf.
...
Gibt [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START) zurück.
...
**Returns:**
int – [NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype/\#COMMENT-RANGE-START). Der zurückgegebene Wert ist einer der Konstanten von [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
