...
description: "Gibt den Modus des Ressourcenladens in Java an."
type: docs
weight: 575
url: /de/java/com.aspose.words/resourceloadingaction/
---
...
| Feld | Beschreibung |
| --- | --- |
| [DEFAULT](#DEFAULT) | Aspose.Words lädt diese Ressource wie üblich. |
| [SKIP](#SKIP) | Aspose.Words überspringt das Laden dieser Ressource. |
| [USER_PROVIDED](#USER-PROVIDED) | Aspose.Words verwendet das vom Benutzer bereitgestellte Byte-Array in [ResourceLoadingArgs.setData(byte[])](../../com.aspose.words/resourceloadingargs/\#setData-byte) als Ressourcendaten. |
| [length](#length) |  |
## Methoden
...
Aspose.Words lädt diese Ressource wie üblich.
...
Aspose.Words überspringt das Laden dieser Ressource. Nur ein Link ohne Daten wird für ein Bild gespeichert, ein CSS-Stylesheet wird für das HTML-Format ignoriert.
...
Aspose.Words verwendet das vom Benutzer bereitgestellte Byte-Array in [ResourceLoadingArgs.setData(byte[])](../../com.aspose.words/resourceloadingargs/\#setData-byte) als Ressourcendaten.
