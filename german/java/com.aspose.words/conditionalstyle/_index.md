...
description: "Stellt spezielle Formatierung dar, die auf einen Bereich einer Tabelle mit zugewiesenen Tabellenstil in Java angewendet wird."
type: docs
weight: 123
url: /de/java/com.aspose.words/conditionalstyle/
---
...
Stellt spezielle Formatierung dar, die auf einen Bereich einer Tabelle mit zugewiesenem Tabellenstil angewendet wird.
...
| [equals(Object obj)](#equals-java.lang.Object) | Vergleicht diesen bedingten Stil mit dem angegebenen Objekt. |
...
| [getBorders()](#getBorders) | Gibt die Sammlung der Standardzellenrahmen für den bedingten Stil zurück. |
...
| [getFont()](#getFont) | Gibt die Zeichenformatierung des bedingten Stils zurück. |
...
| [getParagraphFormat()](#getParagraphFormat) | Gibt die Absatzformatierung des bedingten Stils zurück. |
...
| [getShading()](#getShading) | Ruft ein [Shading](../../com.aspose.words/shading/) Objekt ab, das sich auf die Schattierungsformatierung für diesen bedingten Stil bezieht. |
...
| [getType()](#getType) | Ermittelt den Tabellenbereich, auf den sich dieser bedingte Stil bezieht. |
| [hashCode()](#hashCode) |  |
...
Vergleicht diesen bedingten Stil mit dem angegebenen Objekt.
...
Gibt die Sammlung der Standardzellenrahmen für den bedingten Stil zurück.
...
Gibt die Zeichenformatierung des bedingten Stils zurück.
...
Gibt die Absatzformatierung des bedingten Stils zurück.
...
Ruft ein [Shading](../../com.aspose.words/shading/) Objekt ab, das sich auf die Schattierungsformatierung für diesen bedingten Stil bezieht.
...
Ermittelt den Tabellenbereich, auf den sich dieser bedingte Stil bezieht.
...
**Returns:**
int - Tabellenbereich, auf den sich dieser bedingte Stil bezieht. Der zurückgegebene Wert ist einer der Konstanten von [ConditionalStyleType](../../com.aspose.words/conditionalstyletype/).
### hashCode() {#hashCode}
```
public int hashCode()
```
