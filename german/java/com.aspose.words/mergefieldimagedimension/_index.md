...
description: "Stellt eine Bilddimension dar, z. B. in Java."
type: docs
weight: 462
url: /de/java/com.aspose.words/mergefieldimagedimension/
---
...
Stellt eine Bilddimension (d. h. die Breite oder die Höhe) dar, die im gesamten Seriendruckprozess verwendet wird.

Weitere Informationen finden Sie im Dokumentationsartikel [ Working with Fields ][Working with Fields].

 **Remarks:** 

Um anzuzeigen, dass das Bild während eines Seriendrucks mit seiner Originalgröße eingefügt werden soll, sollten Sie der [getValue()](../../com.aspose.words/mergefieldimagedimension/\#getValue) / [setValue(double)](../../com.aspose.words/mergefieldimagedimension/\#setValue-double) Eigenschaft einen negativen Wert zuweisen.
...
| --- | --- |
| [MergeFieldImageDimension(double value)](#MergeFieldImageDimension-double) | Erstellt eine Bilddimension-Instanz mit dem angegebenen Wert in Punkten. |
| [MergeFieldImageDimension(double value, int unit)](#MergeFieldImageDimension-double-int) | Initialisiert eine neue Instanz dieser Klasse. |
## Methoden

| Methode | Beschreibung |
| --- | --- |
| [getUnit()](#getUnit) | Die Einheit. |
| [getValue()](#getValue) | Der Wert. |
| [setUnit(int value)](#setUnit-int) | Die Einheit. |
| [setValue(double value)](#setValue-double) | Der Wert. |
...
Erstellt eine Bilddimension-Instanz mit dem angegebenen Wert in Punkten.

 **Remarks:** 

Sie sollten einen negativen Wert verwenden, um anzuzeigen, dass der Originalwert der entsprechenden Bilddimension angewendet werden soll.
...
**Returns:**
int - Der entsprechende  int  Wert. Der zurückgegebene Wert ist einer der Konstanten von [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/).
### getValue() {#getValue}
```
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| value | int | Der entsprechende  int  Wert. Der Wert muss einer der Konstanten von [MergeFieldImageDimensionUnit](../../com.aspose.words/mergefieldimagedimensionunit/) sein. |
