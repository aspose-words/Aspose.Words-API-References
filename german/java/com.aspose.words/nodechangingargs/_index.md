...
description: "Stellt Daten für Methoden des INodeChangingCallback‑Interfaces in Java bereit."
type: docs
weight: 478
url: /de/java/com.aspose.words/nodechangingargs/
---
...
Stellt Daten für Methoden des [INodeChangingCallback](../../com.aspose.words/inodechangingcallback/)-Interfaces bereit.
...
| --- | --- |
| [getAction()](#getAction) | Gibt einen Wert zurück, der angibt, welcher Typ von Knotenänderungsereignis gerade auftritt. |
| [getNewParent()](#getNewParent) | Gibt den übergeordneten Knoten zurück, der nach Abschluss der Operation gesetzt wird. |
| [getNode()](#getNode) | Gibt das [getNode()](../../com.aspose.words/nodechangingargs/\#getNode) zurück, das hinzugefügt oder entfernt wird. |
| [getOldParent()](#getOldParent) | Gibt den übergeordneten Knoten zurück, bevor die Operation begann. |
### getAction() {#getAction}
```
...
**Returns:**
int – Ein Wert, der angibt, welcher Typ von Knotenänderungsereignis auftritt. Der zurückgegebene Wert ist einer der Konstanten von [NodeChangingAction](../../com.aspose.words/nodechangingaction/).
...
Gibt den übergeordneten Knoten zurück, der nach Abschluss der Operation gesetzt wird.
...
Gibt das [getNode()](../../com.aspose.words/nodechangingargs/\#getNode) zurück, das hinzugefügt oder entfernt wird.
...
Gibt den übergeordneten Knoten zurück, bevor die Operation begann.
