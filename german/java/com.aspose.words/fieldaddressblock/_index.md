...
description: "Implementiert das ADDRESSBLOCK‑Feld in Java."
type: docs
weight: 196
url: /de/java/com.aspose.words/fieldaddressblock/
---
...
Stellt einen Adressblock dar. Ein *address block* ist ein Textblock, der Informationen für eine postalische Versandadresse enthält, in der vom Zielland geforderten Reihenfolge.

 **Examples:** 

Zeigt, wie man die vom Feld verwendeten Seriendruckfeldnamen abruft.
...
| [getExcludedCountryOrRegionName()](#getExcludedCountryOrRegionName) | Liefert den ausgeschlossenen Länder-/Regionsnamen. |
...
| [getFieldNames()](#getFieldNames) | Gibt eine Sammlung der vom Feld verwendeten Seriendruckfeldnamen zurück. |
...
| [getFormatAddressOnCountryOrRegion()](#getFormatAddressOnCountryOrRegion) | Liefert, ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert. |
| [getIncludeCountryOrRegionName()](#getIncludeCountryOrRegionName) | Liefert, ob der Name des Landes/der Region einbezogen werden soll. |
| [getLanguageId()](#getLanguageId) | Liefert die Sprach-ID, die zur Formatierung der Adresse verwendet wird. |
| [getLocaleId()](#getLocaleId) | Liefert die LCID des Feldes. |
| [getMergeFormat()](#getMergeFormat) |  |
| [getNameAndAddressFormat()](#getNameAndAddressFormat) | Liefert den Namen und das Adressformat. |
...
| [setExcludedCountryOrRegionName(String value)](#setExcludedCountryOrRegionName-java.lang.String) | Setzt den ausgeschlossenen Länder-/Regionsnamen. |
| [setFormatAddressOnCountryOrRegion(boolean value)](#setFormatAddressOnCountryOrRegion-boolean) | Setzt, ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert. |
| [setIncludeCountryOrRegionName(String value)](#setIncludeCountryOrRegionName-java.lang.String) | Legt fest, ob der Name des Landes/der Region eingeschlossen wird. |
| [setLanguageId(String value)](#setLanguageId-java.lang.String) | Legt die Sprach-ID fest, die zum Formatieren der Adresse verwendet wird. |
| [setLocaleId(int value)](#setLocaleId-int) | Legt die LCID des Feldes fest. |
| [setNameAndAddressFormat(String value)](#setNameAndAddressFormat-java.lang.String) | Legt den Namen und das Adressformat fest. |
...
Liefert den ausgeschlossenen Länder-/Regionsnamen.
...
**Returns:**
java.lang.String - Der ausgeschlossene Länder-/Regionsname.
...
Gibt eine Sammlung der vom Feld verwendeten Seriendruckfeldnamen zurück.
...
Liefert, ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert.
...
**Returns:**
boolean - Ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert.
...
Liefert, ob der Name des Landes/der Region einbezogen werden soll.
...
**Returns:**
java.lang.String - Ob der Name des Landes/der Region eingeschlossen werden soll.
...
Liefert die Sprach-ID, die zur Formatierung der Adresse verwendet wird.
...
**Returns:**
java.lang.String - Die Sprach-ID, die zum Formatieren der Adresse verwendet wird.
...
Liefert den Namen und das Adressformat.
...
**Returns:**
java.lang.String - Der Name und das Adressformat.
### getResult() {#getResult}
```
...
Setzt den ausgeschlossenen Länder-/Regionsnamen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der ausgeschlossene Länder-/Regionsname. |
...
Setzt, ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Ob die Adresse gemäß dem Land/der Region des Empfängers formatiert werden soll, wie durch POST\*CODE (Universal Postal Union 2006) definiert. |
...
Legt fest, ob der Name des Landes/der Region eingeschlossen wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Ob der Name des Landes/der Region eingeschlossen werden soll. |
...
Legt die Sprach-ID fest, die zum Formatieren der Adresse verwendet wird.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Sprach-ID, die zum Formatieren der Adresse verwendet wird. |
...
Legt den Namen und das Adressformat fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Der Name und das Adressformat. |
