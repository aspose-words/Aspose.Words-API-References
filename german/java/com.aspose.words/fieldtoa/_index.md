...
description: "Implementiert das TOA-Feld in Java."
type: docs
weight: 297
url: /de/java/com.aspose.words/fieldtoa/
---
...
Erstellt ein Verzeichnis der Autoritäten (das ist eine Liste der Verweise in einem juristischen Dokument, wie Verweise auf Fälle, Gesetze und Regeln, zusammen mit den Seitenzahlen, auf denen die Verweise erscheinen) unter Verwendung der durch TA-Felder angegebenen Einträge.

 **Examples:** 

Zeigt, wie ein Verzeichnis der Autoritäten mit TOA- und TA-Feldern erstellt und angepasst wird.
...
| [getEntryCategory()](#getEntryCategory) | Ruft die ganzzahlige Kategorie für im Tabellen enthaltene Einträge ab. |
| [getEntrySeparator()](#getEntrySeparator) | Ruft die Zeichenfolge ab, die verwendet wird, um einen Eintrag im Verzeichnis der Autoritäten und seine Seitenzahl zu trennen. |
...
| [getRemoveEntryFormatting()](#getRemoveEntryFormatting) | Ruft ab, ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag im Verzeichnis der Autoritäten entfernt werden soll. |
...
| [getUseHeading()](#getUseHeading) | Ruft ab, ob die Kategorienüberschrift für die Einträge in einem Verzeichnis der Autoritäten eingeschlossen werden soll. |
| [getUsePassim()](#getUsePassim) | Ruft ab, ob fünf oder mehr unterschiedliche Seitenverweise auf dieselbe Quelle durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in der zitierten Arbeit vorkommt. |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String) | Legt die ganzzahlige Kategorie für im Tabellen enthaltene Einträge fest. |
| [setEntrySeparator(String value)](#setEntrySeparator-java.lang.String) | Legt die Zeichenfolge fest, die verwendet wird, um einen Eintrag im Verzeichnis der Autoritäten und seine Seitenzahl zu trennen. |
...
| [setRemoveEntryFormatting(boolean value)](#setRemoveEntryFormatting-boolean) | Legt fest, ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag im Verzeichnis der Autoritäten entfernt werden soll. |
...
| [setUseHeading(boolean value)](#setUseHeading-boolean) | Legt fest, ob die Kategorienüberschrift für die Einträge in einem Verzeichnis der Autoritäten eingeschlossen werden soll. |
| [setUsePassim(boolean value)](#setUsePassim-boolean) | Legt fest, ob fünf oder mehr unterschiedliche Seitenverweise auf dieselbe Quelle durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in der zitierten Arbeit vorkommt. |
...
Ruft die ganzzahlige Kategorie für im Tabellen enthaltene Einträge ab.
...
**Returns:**
java.lang.String - Die ganzzahlige Kategorie für im Tabellen enthaltene Einträge.
...
Ruft die Zeichenfolge ab, die verwendet wird, um einen Eintrag im Verzeichnis der Autoritäten und seine Seitenzahl zu trennen.
...
**Returns:**
java.lang.String - Die Zeichenfolge, die verwendet wird, um einen Eintrag im Verzeichnis der Autoritäten und seine Seitenzahl zu trennen.
...
Ruft ab, ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag im Verzeichnis der Autoritäten entfernt werden soll.
...
**Returns:**
boolean - Ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag im Verzeichnis der Autoritäten entfernt werden soll.
### getResult() {#getResult}
```
...
Ruft ab, ob die Kategorienüberschrift für die Einträge in einem Verzeichnis der Autoritäten eingeschlossen werden soll.
...
**Returns:**
boolean - Gibt an, ob die Kategorienüberschrift für die Einträge in einer Tabelle der Autoritäten eingeschlossen werden soll.
...
Ruft ab, ob fünf oder mehr unterschiedliche Seitenverweise auf dieselbe Quelle durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in der zitierten Arbeit vorkommt.
...
**Returns:**
boolean - Gibt an, ob fünf oder mehr verschiedene Seitenverweise auf dieselbe Autorität durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in dem zitierten Werk vorkommt.
### isDirty() {#isDirty}
```
...
Legt die ganzzahlige Kategorie für im Tabellen enthaltene Einträge fest.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die integrale Kategorie für in der Tabelle enthaltene Einträge. |
...
Legt die Zeichenfolge fest, die verwendet wird, um einen Eintrag im Verzeichnis der Autoritäten und seine Seitenzahl zu trennen.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | java.lang.String | Die Zeichenfolge, die verwendet wird, um einen Eintrag einer Tabelle der Autoritäten und seine Seitenzahl zu trennen. |
...
Legt fest, ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag im Verzeichnis der Autoritäten entfernt werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Gibt an, ob die Formatierung des Eintragstextes im Dokument aus dem Eintrag in der Tabelle der Autoritäten entfernt werden soll. |
...
Legt fest, ob die Kategorienüberschrift für die Einträge in einem Verzeichnis der Autoritäten eingeschlossen werden soll.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Gibt an, ob die Kategorienüberschrift für die Einträge in einer Tabelle der Autoritäten eingeschlossen werden soll. |
...
Legt fest, ob fünf oder mehr unterschiedliche Seitenverweise auf dieselbe Quelle durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in der zitierten Arbeit vorkommt.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Gibt an, ob fünf oder mehr verschiedene Seitenverweise auf dieselbe Autorität durch \"passim\" ersetzt werden sollen, was verwendet wird, um anzuzeigen, dass ein Wort oder Abschnitt häufig in dem zitierten Werk vorkommt. |
