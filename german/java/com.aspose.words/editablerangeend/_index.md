...
description: "Stellt das Ende eines bearbeitbaren Bereichs in einem Word-Dokument in Java dar."
type: docs
weight: 180
url: /de/java/com.aspose.words/editablerangeend/
---
...
Ein vollständiger bearbeitbarer Bereich in einem Word-Dokument besteht aus einem [getEditableRangeStart()](../../com.aspose.words/editablerangeend/\#getEditableRangeStart) und einem passenden [EditableRangeEnd](../../com.aspose.words/editablerangeend/) mit derselben Id.
...
Verwenden Sie die Klasse [EditableRange](../../com.aspose.words/editablerange/) als \"Fassade\", um mit einem bearbeitbaren Bereich als einzelnes Objekt zu arbeiten.
...
| [getEditableRangeStart()](#getEditableRangeStart) | Entsprechendes [EditableRangeStart](../../com.aspose.words/editablerangestart/), erhalten über die ID. |
...
| [getNodeType()](#getNodeType) | Gibt [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END) zurück. |
...
Ruft [DocumentVisitor.visitEditableRangeEnd(com.aspose.words.EditableRangeEnd)](../../com.aspose.words/documentvisitor/\#visitEditableRangeEnd-com.aspose.words.EditableRangeEnd) auf.
...
Entsprechendes [EditableRangeStart](../../com.aspose.words/editablerangestart/), erhalten über die ID.
...
Gibt [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END) zurück.
...
**Returns:**
int - [NodeType.EDITABLE\_RANGE\_END](../../com.aspose.words/nodetype/\#EDITABLE-RANGE-END). Der zurückgegebene Wert ist einer der Konstanten von [NodeType](../../com.aspose.words/nodetype/).
### getParentIdInternal() {#getParentIdInternal}
```
