...
description: "Ermöglicht das Angeben zusätzlicher Optionen beim Laden eines PDF-Dokuments in ein Document-Objekt in Java."
type: docs
weight: 538
url: /de/java/com.aspose.words/pdfloadoptions/
---
...
Ermöglicht das Angeben zusätzlicher Optionen beim Laden eines PDF-Dokuments in ein [Document](../../com.aspose.words/document/) Objekt.

Um mehr zu erfahren, besuchen Sie den Dokumentationsartikel [ Specify Load Options ][Specify Load Options].

 **Examples:** 

Zeigt, wie Bilder beim Laden von PDF-Dateien übersprungen werden können.
...
| [getPageCount()](#getPageCount) | Ermittelt die Anzahl der zu lesenden Seiten. |
| [getPageIndex()](#getPageIndex) | Ermittelt den nullbasierten Index der ersten zu lesenden Seite. |
...
| [getSkipPdfImages()](#getSkipPdfImages) | Ermittelt das Flag, das angibt, ob Bilder beim Laden des PDF-Dokuments übersprungen werden müssen. |
...
| [setPageCount(int value)](#setPageCount-int) | Legt die Anzahl der zu lesenden Seiten fest. |
| [setPageIndex(int value)](#setPageIndex-int) | Legt den nullbasierten Index der ersten zu lesenden Seite fest. |
...
| [setSkipPdfImages(boolean value)](#setSkipPdfImages-boolean) | Setzt das Flag, das angibt, ob Bilder beim Laden eines PDF-Dokuments übersprungen werden müssen. |
...
Liest die Anzahl der zu lesenden Seiten. Standard ist MaxValue, was bedeutet, dass alle Seiten des Dokuments gelesen werden.
...
**Returns:**
int - Die Anzahl der zu lesenden Seiten.
...
Liest den nullbasierten Index der ersten zu lesenden Seite. Standard ist 0.
...
**Returns:**
int - Der nullbasierte Index der ersten zu lesenden Seite.
...
Liest das Flag, das angibt, ob Bilder beim Laden eines PDF-Dokuments übersprungen werden müssen. Standard ist false.
...
**Returns:**
boolean - Das Flag, das angibt, ob Bilder beim Laden eines PDF-Dokuments übersprungen werden müssen.
...
Setzt die Anzahl der zu lesenden Seiten. Standard ist MaxValue, was bedeutet, dass alle Seiten des Dokuments gelesen werden.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | Die Anzahl der zu lesenden Seiten. |
...
Setzt den nullbasierten Index der ersten zu lesenden Seite. Standard ist 0.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | int | Der nullbasierte Index der ersten zu lesenden Seite. |
...
Setzt das Flag, das angibt, ob Bilder beim Laden eines PDF-Dokuments übersprungen werden müssen. Standard ist false.
...
| Parameter | Typ | Beschreibung |
| --- | --- | --- |
| Wert | boolean | Das Flag, das angibt, ob Bilder beim Laden eines PDF-Dokuments übersprungen werden müssen. |
