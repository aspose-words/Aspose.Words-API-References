---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect 方法"
linktitle: "get_RevisedPropertiesEffect"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesEffect 方法。允许为具有格式属性更改的内容区域指定效果 FormatChange。默认值为 C++ 中的 None。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_revisedpropertieseffect/
---
## RevisionOptions::get_RevisedPropertiesEffect method


允许为具有格式属性更改的内容区域指定效果 [FormatChange](../../../aspose.words/revisiontype/)。默认值为 [None](../../revisiontexteffect/)。
