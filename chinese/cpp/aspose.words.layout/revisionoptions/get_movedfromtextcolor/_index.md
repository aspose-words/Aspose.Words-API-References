---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor 方法"
linktitle: "get_MovedFromTextColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextColor 方法。允许指定用于内容移动来源区域的颜色（Moving）。默认值在 C++ 中为 ByAuthor。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_movedfromtextcolor/
---
## RevisionOptions::get_MovedFromTextColor method


允许指定用于内容移动来源区域的颜色 [Moving](../../../aspose.words/revisiontype/)。默认值为 [ByAuthor](../../revisioncolor/)。
