---
title: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor 方法"
linktitle: "get_RevisedPropertiesColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_RevisedPropertiesColor 方法。允许指定用于具有格式属性更改（FormatChange）的内容的颜色。默认值在 C++ 中为 NoHighlight。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_revisedpropertiescolor/
---
## RevisionOptions::get_RevisedPropertiesColor method


允许指定用于具有格式属性更改的内容的颜色 [FormatChange](../../../aspose.words/revisiontype/). 默认值是 [NoHighlight](../../revisioncolor/).
