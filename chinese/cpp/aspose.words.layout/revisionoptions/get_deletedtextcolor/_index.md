---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor 方法"
linktitle: "get_DeletedTextColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextColor 方法。允许指定用于已删除内容（Deletion）的颜色。默认值在 C++ 中为 ByAuthor。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_deletedtextcolor/
---
## RevisionOptions::get_DeletedTextColor method


允许指定用于已删除内容的颜色 [Deletion](../../../aspose.words/revisiontype/)。默认值为 [ByAuthor](../../revisioncolor/)。
