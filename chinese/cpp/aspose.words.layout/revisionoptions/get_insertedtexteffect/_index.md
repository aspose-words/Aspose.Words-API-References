---
title: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect 方法"
linktitle: "get_InsertedTextEffect"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_InsertedTextEffect 方法。允许指定要应用于插入内容 Insertion 的效果。默认值是 Underline，在 C++ 中。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_insertedtexteffect/
---
## RevisionOptions::get_InsertedTextEffect method


允许指定要应用于插入内容的效果 [Insertion](../../../aspose.words/revisiontype/)。默认值是 [Underline](../../revisiontexteffect/)。
