---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect 方法"
linktitle: "get_MovedFromTextEffect"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedFromTextEffect 方法。允许指定要应用于内容移动来源区域 Moving 的效果。默认值是 DoubleStrikeThrough，在 C++ 中。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_movedfromtexteffect/
---
## RevisionOptions::get_MovedFromTextEffect method


允许指定要应用于内容移动来源区域的效果 [Moving](../../../aspose.words/revisiontype/)。默认值是 [DoubleStrikeThrough](../../revisiontexteffect/)。
