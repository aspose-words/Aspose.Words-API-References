---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor 方法"
linktitle: "get_MovedToTextColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextColor 方法。允许指定用于内容移动到的区域的颜色（Moving）。默认值为 ByAuthor，适用于 C++。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_movedtotextcolor/
---
## RevisionOptions::get_MovedToTextColor method


允许指定用于内容移动到的区域的颜色 [Moving](../../../aspose.words/revisiontype/)。默认值为 [ByAuthor](../../revisioncolor/)。
