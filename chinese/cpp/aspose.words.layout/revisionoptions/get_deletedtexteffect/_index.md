---
title: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect 方法"
linktitle: "get_DeletedTextEffect"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_DeletedTextEffect 方法。允许指定应用于已删除内容（Deletion）的效果。默认值在 C++ 中为 StrikeThrough。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_deletedtexteffect/
---
## RevisionOptions::get_DeletedTextEffect method


允许指定应用于已删除内容的效果 [Deletion](../../../aspose.words/revisiontype/)。默认值为 [StrikeThrough](../../revisiontexteffect/)。
