---
title: "Aspose::Words::Layout::RevisionOptions::get_CommentColor 方法"
linktitle: "get_CommentColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_CommentColor 方法。允许指定用于批注的颜色。默认值为 C++ 中的红色。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_commentcolor/
---
## RevisionOptions::get_CommentColor method


允许指定用于批注的颜色。默认值为 [红色](../../revisioncolor/)。
