---
title: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect 方法"
linktitle: "get_MovedToTextEffect"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_MovedToTextEffect 方法。允许指定要应用于内容移动目标区域 Moving 的效果。默认值是 DoubleUnderline，在 C++ 中。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_movedtotexteffect/
---
## RevisionOptions::get_MovedToTextEffect method


允许指定要应用于内容移动到的区域的效果 [Moving](../../../aspose.words/revisiontype/). 默认值是 [DoubleUnderline](../../revisiontexteffect/).
