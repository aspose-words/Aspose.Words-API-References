---
title: "Aspose::Words::Layout::RevisionOptions::get_ShowOriginalRevision 方法"
linktitle: "get_ShowOriginalRevision"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::RevisionOptions::get_ShowOriginalRevision 方法。允许指定是否显示原始文本而不是修订后的文本。默认在 C++ 中为 false。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words.layout/revisionoptions/get_showoriginalrevision/
---
## RevisionOptions::get_ShowOriginalRevision method


允许指定是否应显示原始文本而不是修订后的文本。默认值是 **false**。
