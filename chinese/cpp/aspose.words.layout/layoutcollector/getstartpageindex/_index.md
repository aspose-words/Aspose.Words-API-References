---
title: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex 方法"
linktitle: "GetStartPageIndex"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::LayoutCollector::GetStartPageIndex 方法。获取节点开始所在页面的 1 基索引。如果节点无法映射到页面，则在 C++ 中返回 0。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.layout/layoutcollector/getstartpageindex/
---
## LayoutCollector::GetStartPageIndex method


获取节点开始所在页的基于 1 的索引。如果节点无法映射到页，则返回 0。
