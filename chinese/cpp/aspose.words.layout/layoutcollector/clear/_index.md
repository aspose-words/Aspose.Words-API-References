---
title: "Aspose::Words::Layout::LayoutCollector::Clear 方法"
linktitle: "清除"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::LayoutCollector::Clear 方法。清除所有收集的布局数据。在文档手动更新或布局在 C++ 中重新构建后调用此方法。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.layout/layoutcollector/clear/
---
## LayoutCollector::Clear method


清除所有收集的布局数据。在文档手动更新或布局重新构建后调用此方法。
