---
title: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned 方法"
linktitle: "GetNumPagesSpanned"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::LayoutCollector::GetNumPagesSpanned 方法。获取指定节点跨越的页数。如果节点位于单页内，则返回 0。这等同于 C++ 中的 GetEndPageIndex() - GetStartPageIndex()。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.layout/layoutcollector/getnumpagesspanned/
---
## LayoutCollector::GetNumPagesSpanned method


获取指定节点跨越的页数。如果节点位于单页内则为 0。这与 [GetEndPageIndex()](../) - [GetStartPageIndex()](../) 相同。
