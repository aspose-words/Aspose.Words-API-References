---
title: "Aspose::Words::Layout::LayoutCollector::GetEndPageIndex 方法"
linktitle: "GetEndPageIndex"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::LayoutCollector::GetEndPageIndex 方法。获取节点结束所在页的 1 基索引。如果节点无法映射到页面，则返回 0（在 C++ 中）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.layout/layoutcollector/getendpageindex/
---
## LayoutCollector::GetEndPageIndex method


获取节点结束所在页面的 1 基索引。如果节点无法映射到页面，则返回 0。
