---
title: "Aspose::Words::Layout::LayoutEnumerator::get_Current 方法"
linktitle: "get_Current"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Layout::LayoutEnumerator::get_Current 方法。获取或设置页面布局模型中的当前位置。此属性返回一个不透明对象，对应于 C++ 中的当前布局实体。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.layout/layoutenumerator/get_current/
---
## LayoutEnumerator::get_Current method


获取或设置页面布局模型中的当前位置信息。此属性返回一个对应当前布局实体的不透明对象。
