---
title: "Aspose::Words::Bibliography::Source::Source 构造函数"
linktitle: "来源"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Bibliography::Source::Source 构造函数。初始化 Source 类的一个新实例（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.bibliography/source/source/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| tag | const System::String\& | 标识标签的名称。 |
| sourceType | Aspose::Words::Bibliography::SourceType | 源的类型。 |
