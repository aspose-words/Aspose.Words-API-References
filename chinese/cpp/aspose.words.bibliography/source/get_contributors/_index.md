---
title: "Aspose::Words::Bibliography::Source::get_Contributors 方法"
linktitle: "get_Contributors"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Bibliography::Source::get_Contributors 方法。获取源的贡献者列表（作者、编辑、撰写者等），在 C++ 中。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.bibliography/source/get_contributors/
---
## Source::get_Contributors method


获取或设置来源的贡献者列表（作者、编辑、撰写者等）。
