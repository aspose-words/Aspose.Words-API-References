---
title: "Aspose::Words::Bibliography::Bibliography 类"
linktitle: "参考文献"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Bibliography::Bibliography 类。表示文档中可用的书目来源列表（C++）。"
type: docs
weight: 125
url: /zh/cpp/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| 方法 | 描述 |
| --- | --- |
| [get_BibliographyStyle](./get_bibliographystyle/)() const | 获取一个字符串，表示用于书目的活动样式名称。 |
| [get_Sources](./get_sources/)() const | 获取一个集合，表示书目中包含的所有来源。 |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_BibliographyStyle](./set_bibliographystyle/)(const System::String\&) | 设置一个字符串，表示用于书目的活动样式名称。 |
| static [Type](./type/)() |  |
