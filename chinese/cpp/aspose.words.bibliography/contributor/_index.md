---
title: "Aspose::Words::Bibliography::Contributor 类"
linktitle: "贡献者"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Bibliography::Contributor 类。表示一个书目来源贡献者。可以是企业（组织）或人员列表（C++）。"
type: docs
weight: 250
url: /zh/cpp/aspose.words.bibliography/contributor/
---
## Contributor class


表示参考文献来源的贡献者。可以是企业（组织）或人员列表。
