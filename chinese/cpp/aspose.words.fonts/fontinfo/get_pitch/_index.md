---
title: "Aspose::Words::Fonts::FontInfo::get_Pitch 方法"
linktitle: "get_Pitch"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fonts::FontInfo::get_Pitch 方法。pitch 表示字体是固定宽度、比例间距，还是依赖于 C++ 中的默认设置。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.fonts/fontinfo/get_pitch/
---
## FontInfo::get_Pitch method


字距指示字体是固定字距、比例间距，还是依赖默认设置。
