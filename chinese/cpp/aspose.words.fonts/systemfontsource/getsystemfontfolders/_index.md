---
title: "Aspose::Words::Fonts::SystemFontSource::GetSystemFontFolders 方法"
linktitle: "GetSystemFontFolders"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fonts::SystemFontSource::GetSystemFontFolders 方法。返回系统字体文件夹，如果文件夹不可访问则返回空数组（在 C++ 中）。"
type: docs
weight: 1000
url: /zh/cpp/aspose.words.fonts/systemfontsource/getsystemfontfolders/
---
## SystemFontSource::GetSystemFontFolders method


返回系统字体文件夹，如果文件夹不可访问则返回空数组。
