---
title: "Aspose::Words::Markup::CustomXmlSchemaCollection::Add 方法"
linktitle: "Add"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlSchemaCollection::Add 方法。向集合中添加一个项（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.markup/customxmlschemacollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | const System::String\& | 要添加的项。 |
