---
title: "Aspose::Words::Markup::IStructuredDocumentTag::get_XmlMapping 方法"
linktitle: "get_XmlMapping"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::IStructuredDocumentTag::get_XmlMapping 方法。获取一个对象，该对象表示此结构化文档标签在当前文档的自定义 XML 部分中映射到 XML 数据的映射关系（C++）。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words.markup/istructureddocumenttag/get_xmlmapping/
---
