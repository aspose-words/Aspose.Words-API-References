---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id 方法"
linktitle: "get_Id"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeEnd::get_Id 方法。为此 StructuredDocumentTagRange 节点指定唯一的只读持久数值 Id。对应的 StructuredDocumentTagRangeStart 节点在 C++ 中具有相同的 Id。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.markup/structureddocumenttagrangeend/get_id/
---
## StructuredDocumentTagRangeEnd::get_Id method


为此 **StructuredDocumentTagRange** 节点指定唯一的只读持久数值 Id。对应的 [StructuredDocumentTagStart](../../structureddocumenttagrangestart/) 节点具有相同的 [Id](../../structureddocumenttagrangestart/get_id/)。
