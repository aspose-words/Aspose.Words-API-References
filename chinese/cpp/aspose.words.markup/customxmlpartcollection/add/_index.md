...
description: "Aspose::Words::Markup::CustomXmlPartCollection::Add 方法。向集合中添加一个项（在 C++ 中）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.markup/customxmlpartcollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 部件 | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | 要添加的自定义 XML 部件。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| id | const System::String\& | 新自定义 XML 部件的标识符。 |
| xml | const System::String\& | 部件的 XML 数据。 |
