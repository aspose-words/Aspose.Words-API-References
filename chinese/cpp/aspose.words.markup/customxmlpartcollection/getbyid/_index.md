...
description: "Aspose::Words::Markup::CustomXmlPartCollection::GetById 方法。查找并返回具有其标识符的自定义 XML 部分（在 C++ 中）。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.markup/customxmlpartcollection/getbyid/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| id | const System::String\& | 区分大小写的字符串，用于标识自定义 XML 部分。 |

### ReturnValue

如果未找到具有指定标识符的自定义 XML 部分，则返回 **null**。
