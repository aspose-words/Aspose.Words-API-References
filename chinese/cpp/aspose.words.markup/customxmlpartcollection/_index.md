---
title: "Aspose::Words::Markup::CustomXmlPartCollection 类"
linktitle: "CustomXmlPartCollection"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlPartCollection 类。表示 Custom XML 部分的集合。项为 CustomXmlPart 对象。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.markup/customxmlpartcollection/
---
## CustomXmlPartCollection class


表示 Custom XML 部分的集合。项为 [CustomXmlPart](../customxmlpart/) 对象。欲了解更多，请访问 [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | 向集合中添加一个项。 |
| [Add](./add/)(const System::String\&, const System::String\&) | 使用指定的 XML 创建一个新的 XML 部分并将其添加到集合中。 |
| [begin](./begin/)() |  |
| [begin](./begin/)() const |  |
| [cbegin](./cbegin/)() const |  |
| [cend](./cend/)() const |  |
...
| [GetById](./getbyid/)(const System::String\&) | 通过标识符查找并返回自定义 XML 部分。 |
| [GetEnumerator](./getenumerator/)() override | 返回一个可用于遍历集合中所有项的枚举器对象。 |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | 获取或设置指定索引处的项。 |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\&) | 获取或设置指定索引处的项。 |
...
通常不需要创建此类的实例。您可以通过 [CustomXmlParts](../../aspose.words/document/get_customxmlparts/) 属性访问文档中存储的自定义 XML 数据。
