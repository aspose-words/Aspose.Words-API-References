---
title: "Aspose::Words::Markup::CustomXmlPart::get_Id 方法"
linktitle: "get_Id"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlPart::get_Id 方法。在 C++ 中获取或设置标识此自定义 XML 部件在 OOXML 文档中的字符串。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.markup/customxmlpart/get_id/
---
...
ISO/IEC 29500 规定此值为 GUID，但旧版 Microsoft Word 允许使用任意字符串。Aspose.Words 在 ECMA-376 格式中也采用相同做法。但请注意，Microsoft Word Online 无法打开使用非 GUID 值创建的文档。因此，建议此属性使用 GUID 作为首选值。

有效值必须是此文档中所有自定义 XML 数据部件中唯一的标识符。
