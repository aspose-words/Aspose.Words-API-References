---
title: "Aspose::Words::Markup::CustomXmlPart 类"
linktitle: "CustomXmlPart"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlPart 类。表示一个自定义 XML 数据存储部件（包内的自定义 XML 数据）。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.markup/customxmlpart/
---
## CustomXmlPart class


表示自定义 XML 数据存储部件（包内的自定义 XML 数据）。了解更多，请访问 [Structured Document Tags or Content Control](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/) 文档文章。
...
| [get_Data](./get_data/)() const | 获取或设置此自定义 XML 数据存储部件的 XML 内容。 |
| [get_DataChecksum](./get_datachecksum/)() | 指定 [Data](./get_data/) 内容的循环冗余校验 (CRC) 校验和。 |
| [get_Id](./get_id/)() const | 获取或设置在 OOXML 文档中标识此自定义 XML 部件的字符串。 |
| [get_Schemas](./get_schemas/)() const | 指定与此自定义 XML 部件关联的 XML 架构集合。 |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_Data](./set_data/)(const System::ArrayPtr\<uint8_t\>\&) | 用于 [Aspose::Words::Markup::CustomXmlPart::get_Data](./get_data/) 的设置器。 |
| [set_Id](./set_id/)(const System::String\&) | 用于 [Aspose::Words::Markup::CustomXmlPart::get_Id](./get_id/) 的设置器。 |
| static [Type](./type/)() |  |
## 备注


DOCX 或 DOC 文档可以包含一个或多个自定义 XML 数据存储部件。Aspose.Words 会保留并允许通过 [CustomXmlParts](../../aspose.words/document/get_customxmlparts/) 集合创建和提取自定义 XML 数据。
