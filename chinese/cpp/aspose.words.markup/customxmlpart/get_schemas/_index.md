---
title: "Aspose::Words::Markup::CustomXmlPart::get_Schemas 方法"
linktitle: "get_Schemas"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlPart::get_Schemas 方法。指定与此自定义 XML 部分关联的 XML 架构集合（C++）。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.markup/customxmlpart/get_schemas/
---
## CustomXmlPart::get_Schemas method


指定与此自定义 XML 部件关联的 XML 架构集合。
