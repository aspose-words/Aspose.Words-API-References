---
title: "Aspose::Words::Markup::XmlMapping::SetMapping 方法"
linktitle: "SetMapping"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::XmlMapping::SetMapping 方法。设置父结构化文档标签与自定义 XML 数据部件的 XML 节点之间的映射关系，适用于 C++。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.markup/xmlmapping/setmapping/
---
## XmlMapping::SetMapping method


设置父结构化文档标签与自定义 XML 数据部件的 XML 节点之间的映射。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| customXmlPart | const System::SharedPtr\<Aspose::Words::Markup::CustomXmlPart\>\& | 要映射到的自定义 XML 数据部件。 |
| xPath | const System::String\& | 用于查找 XML 节点的 XPath 表达式。 |
| prefixMapping | const System::String\& | 用于评估 XPath 的 XML 命名空间前缀映射。 |
