---
title: "Aspose::Words::Markup::XmlMapping::get_IsMapped 方法"
linktitle: "get_IsMapped"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::XmlMapping::get_IsMapped 方法。如果父结构化文档标签在 C++ 中成功映射到 XML 数据，则返回 true。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.markup/xmlmapping/get_ismapped/
---
## XmlMapping::get_IsMapped method


如果父结构化文档标签成功映射到 XML 数据，则返回 **true**。
