...
description: "Aspose::Words::Markup::XmlMapping::get_PrefixMappings 方法。返回用于在 C++ 中评估 XPath 的 XML 命名空间前缀映射。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.markup/xmlmapping/get_prefixmappings/
---
## XmlMapping::get_PrefixMappings method


返回用于评估 [XPath](../get_xpath/) 的 XML 命名空间前缀映射。
