---
title: "Aspose::Words::Markup::XmlMapping::get_CustomXmlPart 方法"
linktitle: "get_CustomXmlPart"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::XmlMapping::get_CustomXmlPart 方法。返回在 C++ 中映射父结构化文档标签的自定义 XML 数据部件。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.markup/xmlmapping/get_customxmlpart/
---
## XmlMapping::get_CustomXmlPart method


返回父结构化文档标签映射到的自定义 XML 数据部件。
