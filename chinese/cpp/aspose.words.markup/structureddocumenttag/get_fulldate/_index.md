---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_FullDate 方法"
linktitle: "get_FullDate"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_FullDate 方法。指定在 C++ 中最后输入到此 SDT 的完整日期和时间。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.markup/structureddocumenttag/get_fulldate/
---
## StructuredDocumentTag::get_FullDate method


指定最后输入到此 **SDT** 的完整日期和时间。
