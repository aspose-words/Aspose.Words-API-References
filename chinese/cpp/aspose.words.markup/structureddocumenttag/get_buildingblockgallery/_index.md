...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_BuildingBlockGallery 方法。指定此 SDT 的构建块类型。在 C++ 中不能为空。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.markup/structureddocumenttag/get_buildingblockgallery/
---
## StructuredDocumentTag::get_BuildingBlockGallery method


指定此 **SDT** 的构建块类型。不能为空 **null**。
