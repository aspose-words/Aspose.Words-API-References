...
description: "Aspose::Words::Markup::StructuredDocumentTag::get_Title method. 指定与此 SDT 关联的友好名称。在 C++ 中不能为空。"
type: docs
weight: 32000
url: /zh/cpp/aspose.words.markup/structureddocumenttag/get_title/
---
## StructuredDocumentTag::get_Title method


指定与此 **SDT** 关联的友好名称。不能为空 **null**。
