...
description: "Aspose::Words::Markup::StructuredDocumentTag::SetCheckedSymbol 方法。设置用于表示复选框内容控件已选中状态的符号，在 C++ 中。"
type: docs
weight: 58000
url: /zh/cpp/aspose.words.markup/structureddocumenttag/setcheckedsymbol/
---
## StructuredDocumentTag::SetCheckedSymbol method


设置用于表示复选框内容控件已选状态的符号。
