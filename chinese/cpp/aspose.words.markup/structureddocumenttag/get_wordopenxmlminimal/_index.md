---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_WordOpenXMLMinimal 方法"
linktitle: "get_WordOpenXMLMinimal"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_WordOpenXMLMinimal 方法。获取表示节点中包含的 XML 的字符串，采用 FlatOpc 格式。与 WordOpenXML 属性不同，此方法在 C++ 中生成一个精简的文档，排除任何非内容相关的部分。"
type: docs
weight: 33500
url: /zh/cpp/aspose.words.markup/structureddocumenttag/get_wordopenxmlminimal/
---
