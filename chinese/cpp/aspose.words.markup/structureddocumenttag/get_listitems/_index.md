---
title: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems 方法"
linktitle: "get_ListItems"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::StructuredDocumentTag::get_ListItems 方法。获取与此 SDT 关联的 SdtListItemCollection（在 C++ 中）。"
type: docs
weight: 21000
url: /zh/cpp/aspose.words.markup/structureddocumenttag/get_listitems/
---
## StructuredDocumentTag::get_ListItems method


获取与此 **SDT** 关联的 [SdtListItemCollection](../../sdtlistitemcollection/)。
...
访问此属性仅适用于 [ComboBox](../../sdttype/) 或 [DropDownList](../../sdttype/) SDT 类型。
