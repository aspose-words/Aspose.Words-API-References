---
title: "Aspose::Words::Markup::SdtListItem::get_DisplayText 方法"
linktitle: "get_DisplayText"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::SdtListItem::get_DisplayText 方法。获取用于在运行内容中显示的文本，以替代此列表项的 Value 属性内容（C++）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.markup/sdtlistitem/get_displaytext/
---
## SdtListItem::get_DisplayText method


获取用于在运行内容中显示的文本，以替代此列表项的 [Value](../get_value/) 属性内容。
