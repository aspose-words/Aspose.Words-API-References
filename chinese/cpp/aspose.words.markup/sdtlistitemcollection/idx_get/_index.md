...
description: "Aspose::Words::Markup::SdtListItemCollection::idx_get 方法。 在 C++ 中，根据其在集合中的零基索引返回一个 SdtListItem 对象。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.markup/sdtlistitemcollection/idx_get/
---
## SdtListItemCollection::idx_get method


返回一个 [SdtListItem](../../sdtlistitem/) 对象，该对象根据其在集合中的零基索引提供。
