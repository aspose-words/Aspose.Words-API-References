...
description: "Aspose::Words::Markup::SdtListItemCollection 类。提供对结构化文档标签的 SdtListItem 元素的访问。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.markup/sdtlistitemcollection/
---
## SdtListItemCollection class


提供对结构化文档标签的 [SdtListItem](../sdtlistitem/) 元素的访问。要了解更多信息，请访问 [结构化文档标签或内容控件](https://docs.aspose.com/words/cpp/working-with-content-control-sdt/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [Add](./add/)(const System::SharedPtr\<Aspose::Words::Markup::SdtListItem\>\&) | 向此集合添加一个项。 |
| [begin](./begin/)() |  |
| [begin](./begin/)() const |  |
| [cbegin](./cbegin/)() const |  |
| [cend](./cend/)() const |  |
| [Clear](./clear/)() | 清除此集合中的所有项。 |
| [end](./end/)() |  |
| [end](./end/)() const |  |
| [get_Count](./get_count/)() | 获取集合中项目的数量。 |
| [get_SelectedValue](./get_selectedvalue/)() | 指定此列表中当前选定的值。允许空值，这意味着没有当前选定的条目与此列表项集合关联。 |
| [GetEnumerator](./getenumerator/)() override | 返回一个可用于遍历集合中所有项的枚举器对象。 |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | 返回集合中给定零基索引的 [SdtListItem](../sdtlistitem/) 对象。 |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [RemoveAt](./removeat/)(int32_t) | 移除指定索引处的列表项。 |
| [set_SelectedValue](./set_selectedvalue/)(const System::SharedPtr\<Aspose::Words::Markup::SdtListItem\>\&) | 用于设置 [Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue](./get_selectedvalue/) 的 setter。 |
| static [Type](./type/)() |  |
