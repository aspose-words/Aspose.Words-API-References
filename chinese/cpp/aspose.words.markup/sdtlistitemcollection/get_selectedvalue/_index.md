...
description: "Aspose::Words::Markup::SdtListItemCollection::get_SelectedValue 方法。指定此列表中当前选中的值。允许空值，表示此列表项集合中没有关联的当前选中条目。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.markup/sdtlistitemcollection/get_selectedvalue/
---
## SdtListItemCollection::get_SelectedValue method


指定此列表中当前选定的值。允许空值，这意味着没有当前选定的条目与此列表项集合关联。
