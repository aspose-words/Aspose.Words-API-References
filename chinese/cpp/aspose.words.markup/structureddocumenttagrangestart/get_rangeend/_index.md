---
title: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd 方法"
linktitle: "get_RangeEnd"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::StructuredDocumentTagRangeStart::get_RangeEnd 方法。指定范围的结束位置（如果 StructuredDocumentTag 是范围结构化文档标签），否则返回 null（C++）。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.markup/structureddocumenttagrangestart/get_rangeend/
---
## StructuredDocumentTagRangeStart::get_RangeEnd method


如果 [StructuredDocumentTag](../../structureddocumenttag/) 是范围结构化文档标签，则指定范围的结束位置。否则返回 **null**。
