---
title: "Aspose::Words::Markup::CustomXmlProperty::get_Uri 方法"
linktitle: "get_Uri"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Markup::CustomXmlProperty::get_Uri 方法。获取或设置自定义 XML 属性或智能标签属性的命名空间 URI（C++）。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.markup/customxmlproperty/get_uri/
---
## CustomXmlProperty::get_Uri method


获取或设置自定义 XML 属性或智能标签属性的命名空间 URI。
