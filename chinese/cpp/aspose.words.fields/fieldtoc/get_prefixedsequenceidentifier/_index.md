---
title: "Aspose::Words::Fields::FieldToc::get_PrefixedSequenceIdentifier 方法"
linktitle: "get_PrefixedSequenceIdentifier"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldToc::get_PrefixedSequenceIdentifier 方法。获取或设置序列的标识符，以便在 C++ 中为条目的页码添加前缀。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words.fields/fieldtoc/get_prefixedsequenceidentifier/
---
## FieldToc::get_PrefixedSequenceIdentifier method


获取或设置应在条目页码前添加前缀的序列标识符。
