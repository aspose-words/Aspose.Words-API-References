...
description: "Aspose::Words::Fields::FieldLastSavedBy 类。实现 LASTSAVEDBY 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 62000
url: /zh/cpp/aspose.words.fields/fieldlastsavedby/
---
## FieldLastSavedBy class


实现 LASTSAVEDBY 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
// 如果我们在 Microsoft Word 中创建文档，它将在内置属性“Last saved by”中包含用户的名称。
// 如果我们以编程方式创建文档，此属性将为 null，我们需要赋予一个值。
