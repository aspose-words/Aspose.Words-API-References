---
title: "Aspose::Words::Fields::GeneralFormatCollection::Add 方法"
linktitle: "Add"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::GeneralFormatCollection::Add 方法。向集合中添加通用格式（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/generalformatcollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 项 | Aspose::Words::Fields::GeneralFormat | 一个通用格式。 |
