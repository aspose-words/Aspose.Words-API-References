---
title: "Aspose::Words::Fields::FieldFormat::get_NumericFormat 方法"
linktitle: "get_NumericFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldFormat::get_NumericFormat 方法。获取或设置应用于数值字段结果的格式。对应 C++ 中的 \\\\# 开关。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.fields/fieldformat/get_numericformat/
---
## FieldFormat::get_NumericFormat method


获取或设置应用于数值字段结果的格式。对应 \# 开关。
