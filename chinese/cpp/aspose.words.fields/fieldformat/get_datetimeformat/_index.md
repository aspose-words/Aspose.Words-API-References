---
title: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat 方法"
linktitle: "get_DateTimeFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldFormat::get_DateTimeFormat 方法。获取或设置应用于日期和时间字段结果的格式。对应 C++ 中的 \\\\@ 开关。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/fieldformat/get_datetimeformat/
---
## FieldFormat::get_DateTimeFormat method


获取或设置应用于日期和时间字段结果的格式。对应 \@ 开关。
