---
title: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats 方法"
linktitle: "get_GeneralFormats"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldFormat::get_GeneralFormats 方法。获取应用于数值、文本或任何字段结果的一组通用格式。对应 C++ 中的 \\\\* 开关。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.fields/fieldformat/get_generalformats/
---
## FieldFormat::get_GeneralFormats method


获取应用于数值、文本或任何字段结果的一组通用格式。对应 \* 开关。
