---
title: "Aspose::Words::Fields::FieldAutoTextList 类"
linktitle: "FieldAutoTextList"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldAutoTextList 类。实现 AUTOTEXTLIST 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.fields/fieldautotextlist/
---
## FieldAutoTextList class


实现 AUTOTEXTLIST 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_EntryName](./get_entryname/)() | 获取 AutoText 条目的名称。 |
...
| [set_EntryName](./set_entryname/)(const System::String\&) | 设置 AutoText 条目的名称。 |
...
| [set_ListStyle](./set_liststyle/)(const System::String\&) | 设置用于包含条目的列表所基于的样式名称。 |
...
| [set_ScreenTip](./set_screentip/)(const System::String\&) | 设置要显示的 ScreenTip 文本。 |
| static [Type](./type/)() |  |
