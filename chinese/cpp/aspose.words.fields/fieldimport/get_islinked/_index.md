---
title: "Aspose::Words::Fields::FieldImport::get_IsLinked 方法"
linktitle: "get_IsLinked"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldImport::get_IsLinked 方法。获取或设置是否通过不在文档中存储图形数据来减小文件大小（C++）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.fields/fieldimport/get_islinked/
---
