---
title: "Aspose::Words::Fields::FieldImport 类"
linktitle: "FieldImport"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldImport 类。实现 IMPORT 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 55000
url: /zh/cpp/aspose.words.fields/fieldimport/
---
## FieldImport class


实现 IMPORT 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_SourceFullName](./get_sourcefullname/)() override | 获取或设置图片的位置。 |
...
| [set_GraphicFilter](./set_graphicfilter/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldImport::get_GraphicFilter](./get_graphicfilter/)。 |
| [set_IsDirty](../field/set_isdirty/)(bool) | 用于设置 [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) 的 setter。 |
| [set_IsLinked](./set_islinked/)(bool) | 用于设置 [Aspose::Words::Fields::FieldImport::get_IsLinked](./get_islinked/)。 |
...
| [set_SourceFullName](./set_sourcefullname/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldImport::get_SourceFullName](./get_sourcefullname/)。 |
| static [Type](./type/)() |  |
