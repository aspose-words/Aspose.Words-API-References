---
title: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset 方法"
linktitle: "get_LeftOffset"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldAdvance::get_LeftOffset 方法。获取或设置字段后面的文本应向左移动的点数（单位为点），在 C++ 中。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.fields/fieldadvance/get_leftoffset/
---
## FieldAdvance::get_LeftOffset method


获取或设置字段后面的文本应向左移动的点数。
