---
title: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition 方法"
linktitle: "get_HorizontalPosition"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldAdvance::get_HorizontalPosition 方法。获取或设置字段后面的文本相对于列、框架或文本框左边缘水平移动的点数（单位为点），在 C++ 中。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.fields/fieldadvance/get_horizontalposition/
---
## FieldAdvance::get_HorizontalPosition method


获取或设置字段后面的文本应相对于列、框架或文本框左边缘水平移动的点数。
