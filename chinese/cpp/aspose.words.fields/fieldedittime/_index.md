---
title: "Aspose::Words::Fields::FieldEditTime 类"
linktitle: "FieldEditTime"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldEditTime 类。实现 EDITTIME 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 37000
url: /zh/cpp/aspose.words.fields/fieldedittime/
---
## FieldEditTime class


实现 EDITTIME 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
// 此内置文档属性跟踪分钟。Microsoft Word 使用此属性
// 用于跟踪文档打开时所花费的时间。我们也可以自行编辑它。
...
// 该字段不会实时自动更新，并且还必须
// 在 Microsoft Word 中手动更新，只要我们需要准确的值。
doc->UpdateFields();
