---
title: "Aspose::Words::Fields::FieldAutoNumLgl 类"
linktitle: "FieldAutoNumLgl"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldAutoNumLgl 类。实现 AUTONUMLGL 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.fields/fieldautonumlgl/
---
## FieldAutoNumLgl class


实现 AUTONUMLGL 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_RemoveTrailingPeriod](./get_removetrailingperiod/)() | 获取是否在数字后不显示句点。 |
| [get_Result](../field/get_result/)() | 获取或设置位于字段分隔符和字段结束之间的文本。 |
| [get_Separator](../field/get_separator/)() | 获取表示字段分隔符的节点。可以是 **null**。 |
| [get_SeparatorCharacter](./get_separatorcharacter/)() | 获取要使用的分隔符字符。 |
...
| [set_RemoveTrailingPeriod](./set_removetrailingperiod/)(bool) | 设置是否在数字后不显示句点。 |
| [set_Result](../field/set_result/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::Field::get_Result](../field/get_result/) 的 setter。 |
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | 设置要使用的分隔符字符。 |
| static [Type](./type/)() |  |
