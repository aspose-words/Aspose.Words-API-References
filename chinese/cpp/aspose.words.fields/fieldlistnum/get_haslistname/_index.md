---
title: "Aspose::Words::Fields::FieldListNum::get_HasListName 方法"
linktitle: "get_HasListName"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldListNum::get_HasListName 方法。返回一个值，指示字段''的代码中是否提供了抽象编号定义的名称（在 C++ 中）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/fieldlistnum/get_haslistname/
---
## FieldListNum::get_HasListName method


返回一个值，指示字段代码是否提供了抽象编号定义的名称。
