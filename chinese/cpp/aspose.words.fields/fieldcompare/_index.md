---
title: "Aspose::Words::Fields::FieldCompare 类"
linktitle: "FieldCompare"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldCompare 类。实现 COMPARE 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 25000
url: /zh/cpp/aspose.words.fields/fieldcompare/
---
## FieldCompare class


实现 COMPARE 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [set_ComparisonOperator](./set_comparisonoperator/)(const System::String\&) | 用于 [Aspose::Words::Fields::FieldCompare::get_ComparisonOperator](./get_comparisonoperator/) 的 setter。 |
...
| [set_LeftExpression](./set_leftexpression/)(const System::String\&) | 用于 [Aspose::Words::Fields::FieldCompare::get_LeftExpression](./get_leftexpression/) 的 setter。 |
...
| [set_RightExpression](./set_rightexpression/)(const System::String\&) | 用于 [Aspose::Words::Fields::FieldCompare::get_RightExpression](./get_rightexpression/) 的 setter。 |
| static [Type](./type/)() |  |
