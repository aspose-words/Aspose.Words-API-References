---
title: "Aspose::Words::Fields::FieldStyleRef::get_StyleName 方法"
linktitle: "get_StyleName"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldStyleRef::get_StyleName 方法。获取或设置在 C++ 中用于格式化要搜索文本的样式名称。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.fields/fieldstyleref/get_stylename/
---
## FieldStyleRef::get_StyleName method


获取或设置用于格式化要搜索的文本的样式名称。
