---
title: "Aspose::Words::Fields::FieldStyleRef::get_SearchFromBottom 方法"
linktitle: "get_SearchFromBottom"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldStyleRef::get_SearchFromBottom 方法。获取或设置是否在 C++ 中从当前页的底部而不是顶部进行搜索。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.fields/fieldstyleref/get_searchfrombottom/
---
## FieldStyleRef::get_SearchFromBottom method


获取或设置是否从当前页的底部搜索，而不是从顶部。
