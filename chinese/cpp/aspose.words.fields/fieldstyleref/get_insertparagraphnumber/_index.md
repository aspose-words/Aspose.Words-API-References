---
title: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber 方法"
linktitle: "get_InsertParagraphNumber"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldStyleRef::get_InsertParagraphNumber 方法。获取或设置是否在 C++ 中插入引用段落的段落编号，完全按照文档中出现的方式。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/fieldstyleref/get_insertparagraphnumber/
---
## FieldStyleRef::get_InsertParagraphNumber method


获取或设置是否将引用段落的段落编号精确插入为文档中出现的形式。
