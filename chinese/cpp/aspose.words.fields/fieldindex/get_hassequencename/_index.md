---
title: "Aspose::Words::Fields::FieldIndex::get_HasSequenceName 方法"
linktitle: "get_HasSequenceName"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldIndex::get_HasSequenceName 方法。获取一个值，指示在 C++ 中构建字段结果时是否应使用序列。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.fields/fieldindex/get_hassequencename/
---
## FieldIndex::get_HasSequenceName method


获取一个值，指示在构建字段结果时是否应使用序列。
