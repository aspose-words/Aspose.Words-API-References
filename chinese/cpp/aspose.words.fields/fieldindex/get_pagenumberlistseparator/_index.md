---
title: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator 方法"
linktitle: "get_PageNumberListSeparator"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldIndex::get_PageNumberListSeparator 方法。获取或设置用于在 C++ 中的页码列表中分隔两个页码的字符序列。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.fields/fieldindex/get_pagenumberlistseparator/
---
## FieldIndex::get_PageNumberListSeparator method


获取或设置用于在页码列表中分隔两个页码的字符序列。
