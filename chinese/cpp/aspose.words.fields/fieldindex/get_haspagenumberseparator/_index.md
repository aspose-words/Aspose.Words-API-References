---
title: "Aspose::Words::Fields::FieldIndex::get_HasPageNumberSeparator 方法"
linktitle: "get_HasPageNumberSeparator"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldIndex::get_HasPageNumberSeparator 方法。获取一个值，指示页面编号分隔符是否通过字段''的代码在 C++ 中被覆盖。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.fields/fieldindex/get_haspagenumberseparator/
---
## FieldIndex::get_HasPageNumberSeparator method


获取一个值，指示是否通过字段代码覆盖页码分隔符。
