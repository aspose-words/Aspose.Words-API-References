---
title: "Aspose::Words::Fields::FieldIndex::get_Heading 方法"
linktitle: "get_Heading"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldIndex::get_Heading 方法。获取或设置在 C++ 中每个字母对应的条目集合开头出现的标题。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.fields/fieldindex/get_heading/
---
## FieldIndex::get_Heading method


获取或设置在每个给定字母的条目集合开始处出现的标题。
