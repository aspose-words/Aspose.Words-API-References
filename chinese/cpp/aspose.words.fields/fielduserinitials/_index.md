...
description: "Aspose::Words::Fields::FieldUserInitials class. 实现 USERINITIALS 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 109000
url: /zh/cpp/aspose.words.fields/fielduserinitials/
---
## FieldUserInitials class


实现 USERINITIALS 字段。要了解更多信息，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_UserInitials](./get_userinitials/)() | 获取或设置当前用户的首字母缩写。 |
...
| [set_UserInitials](./set_userinitials/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldUserInitials::get_UserInitials](./get_userinitials/) 的 setter。 |
| static [Type](./type/)() |  |
