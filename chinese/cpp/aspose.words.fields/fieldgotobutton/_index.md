---
title: "Aspose::Words::Fields::FieldGoToButton 类"
linktitle: "FieldGoToButton"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldGoToButton 类。实现 GOTOBUTTON 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 51000
url: /zh/cpp/aspose.words.fields/fieldgotobutton/
---
## FieldGoToButton class


实现 GOTOBUTTON 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_DisplayText](./get_displaytext/)() | 获取或设置文档中出现的 \"button\" 文本，以便可以选择它来激活跳转。 |
...
| [get_Location](./get_location/)() | 获取或设置书签、页码或其他跳转目标的名称。 |
...
| [set_DisplayText](./set_displaytext/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldGoToButton::get_DisplayText](./get_displaytext/) 的 setter。 |
...
| [set_Location](./set_location/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldGoToButton::get_Location](./get_location/) 的 setter。 |
