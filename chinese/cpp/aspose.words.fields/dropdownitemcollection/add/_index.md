---
title: "Aspose::Words::Fields::DropDownItemCollection::Add 方法"
linktitle: "Add"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::DropDownItemCollection::Add 方法。 在 C++ 中将字符串添加到集合的末尾。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/dropdownitemcollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | const System::String\& | 要添加到集合末尾的字符串。 |
