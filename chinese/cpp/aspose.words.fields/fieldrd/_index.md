---
title: "Aspose::Words::Fields::FieldRD 类"
linktitle: "FieldRD"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldRD 类。实现 RD 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 84000
url: /zh/cpp/aspose.words.fields/fieldrd/
---
## FieldRD class


实现 RD 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_FileName](./get_filename/)() | 获取或设置在生成目录、权威目录或索引时要包含的文件名。 |
...
| [get_IsPathRelative](./get_ispathrelative/)() | 获取或设置路径是否相对于当前文档。 |
...
| [set_FileName](./set_filename/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldRD::get_FileName](./get_filename/) 的 setter。 |
...
| [set_IsPathRelative](./set_ispathrelative/)(bool) | 用于设置 [Aspose::Words::Fields::FieldRD::get_IsPathRelative](./get_ispathrelative/) 的 setter。 |
