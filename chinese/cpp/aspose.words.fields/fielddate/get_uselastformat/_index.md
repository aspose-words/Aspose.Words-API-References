---
title: "Aspose::Words::Fields::FieldDate::get_UseLastFormat 方法"
linktitle: "get_UseLastFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDate::get_UseLastFormat 方法。获取或设置在 C++ 中插入新 DATE 字段时是否使用宿主应用程序上一次使用的格式。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.fields/fielddate/get_uselastformat/
---
## FieldDate::get_UseLastFormat method


获取或设置在插入新 DATE 字段时是否使用宿主应用程序上次使用的格式。
