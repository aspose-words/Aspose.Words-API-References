---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_ScalingFactor 方法"
linktitle: "get_ScalingFactor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_ScalingFactor 方法。获取或设置符号的缩放因子。该值以整数百分比表示，合法取值范围为 [10, 1000]（C++）。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.fields/fielddisplaybarcode/get_scalingfactor/
---
## FieldDisplayBarcode::get_ScalingFactor method


获取或设置符号的缩放因子。该值为整数百分比，有效范围为 [10, 1000]。
