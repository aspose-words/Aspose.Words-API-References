---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle 方法"
linktitle: "get_PosCodeStyle"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_PosCodeStyle 方法。获取或设置销售点条码的样式（条码类型 UPCA|UPCE|EAN13|EAN8）。有效值（不区分大小写）为 [STD|SUP2|SUP5|CASE]（C++）。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.fields/fielddisplaybarcode/get_poscodestyle/
---
## FieldDisplayBarcode::get_PosCodeStyle method


获取或设置销售点条码的样式（条码类型 UPCA|UPCE|EAN13|EAN8）。有效值（不区分大小写）为 [STD|SUP2|SUP5|CASE]。
