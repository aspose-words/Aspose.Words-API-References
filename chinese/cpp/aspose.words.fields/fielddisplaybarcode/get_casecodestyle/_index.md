---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_CaseCodeStyle 方法"
linktitle: "get_CaseCodeStyle"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_CaseCodeStyle 方法。获取或设置 ITF14 条形码类型的箱码样式。有效值为 [STD|EXT|ADD]（C++ 中）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.fields/fielddisplaybarcode/get_casecodestyle/
---
## FieldDisplayBarcode::get_CaseCodeStyle method


获取或设置 ITF14 条形码类型的箱码样式。有效值为 [STD|EXT|ADD]。
