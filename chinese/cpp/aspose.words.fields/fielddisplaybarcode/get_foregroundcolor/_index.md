---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_ForegroundColor 方法"
linktitle: "get_ForegroundColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_ForegroundColor 方法。获取或设置条形码符号的前景色。有效值范围为 [0, 0xFFFFFF]，在 C++ 中。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.fields/fielddisplaybarcode/get_foregroundcolor/
---
## FieldDisplayBarcode::get_ForegroundColor method


获取或设置条码符号的前景颜色。有效值范围为 [0, 0xFFFFFF]。
