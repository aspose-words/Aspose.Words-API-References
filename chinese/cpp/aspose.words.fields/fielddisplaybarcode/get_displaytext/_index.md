---
title: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText 方法"
linktitle: "get_DisplayText"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldDisplayBarcode::get_DisplayText 方法。获取或设置是否在 C++ 中将条形码数据（文本）与图像一起显示。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.fields/fielddisplaybarcode/get_displaytext/
---
## FieldDisplayBarcode::get_DisplayText method


获取或设置是否在图像旁显示条码数据（文本）。
