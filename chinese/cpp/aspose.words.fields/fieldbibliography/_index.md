---
title: "Aspose::Words::Fields::FieldBibliography 类"
linktitle: "FieldBibliography"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldBibliography 类。实现 BIBLIOGRAPHY 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words.fields/fieldbibliography/
---
## FieldBibliography class


实现 BIBLIOGRAPHY 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_FilterLanguageId](./get_filterlanguageid/)() | 获取用于过滤书目数据，仅保留文档中使用该语言的来源的语言 ID。 |
| [get_Format](../field/get_format/)() | 获取一个 [FieldFormat](../fieldformat/) 对象，提供对字段格式的类型化访问。 |
| [get_FormatLanguageId](./get_formatlanguageid/)() | 获取用于格式化文档中书目来源的语言 ID。 |
...
| [get_SourceTag](./get_sourcetag/)() | 获取一个值，以便仅显示标签元素值匹配的来源在书目中。 |
...
| [set_FilterLanguageId](./set_filterlanguageid/)(const System::String\&) | 设置用于过滤书目数据，仅保留文档中使用该语言的来源的语言 ID。 |
| [set_FormatLanguageId](./set_formatlanguageid/)(const System::String\&) | 设置用于格式化文档中书目来源的语言 ID。 |
...
| [set_SourceTag](./set_sourcetag/)(const System::String\&) | 设置一个值，以便仅显示标签元素值匹配的来源在书目中。 |
| static [Type](./type/)() |  |
