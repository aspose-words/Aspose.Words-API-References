---
title: "Aspose::Words::Fields::FieldSymbol::get_IsUnicode 方法"
linktitle: "get_IsUnicode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldSymbol::get_IsUnicode 方法。获取或设置字符代码是否在 C++ 中被解释为 Unicode 字符的值。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.fields/fieldsymbol/get_isunicode/
---
## FieldSymbol::get_IsUnicode method


获取或设置字符码是否被解释为 Unicode 字符的值。
