---
title: "Aspose::Words::Fields::FieldSymbol::get_IsAnsi 方法"
linktitle: "get_IsAnsi"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldSymbol::get_IsAnsi 方法。获取或设置字符代码在 C++ 中是否被解释为 ANSI 字符的值。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.fields/fieldsymbol/get_isansi/
---
## FieldSymbol::get_IsAnsi method


获取或设置字符代码是否被解释为 ANSI 字符的值。
