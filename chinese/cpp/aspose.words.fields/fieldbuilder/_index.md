---
title: "Aspose::Words::Fields::FieldBuilder 类"
linktitle: "FieldBuilder"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldBuilder 类。构建一个由字段代码标记（参数和开关）组成的字段。欲了解更多，请访问 C++ 中的文档文章。"
type: docs
weight: 20000
url: /zh/cpp/aspose.words.fields/fieldbuilder/
---
## FieldBuilder class


从字段代码标记（参数和开关）构建字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [AddArgument](./addargument/)(const System::String\&) | 添加字段的参数。 |
| [AddArgument](./addargument/)(int32_t) | 添加字段的参数。 |
| [AddArgument](./addargument/)(double) | 添加字段的参数。 |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldBuilder\>\&) | 向字段代码中添加由另一个 [FieldBuilder](./) 表示的子字段。 |
| [AddArgument](./addargument/)(const System::SharedPtr\<Aspose::Words::Fields::FieldArgumentBuilder\>\&) | 向字段代码中添加由 [FieldArgumentBuilder](../fieldargumentbuilder/) 表示的字段参数。 |
| [AddSwitch](./addswitch/)(const System::String\&) | 添加字段的开关。 |
| [AddSwitch](./addswitch/)(const System::String\&, const System::String\&) | 添加字段的开关。 |
| [AddSwitch](./addswitch/)(const System::String\&, int32_t) | 添加字段的开关。 |
| [AddSwitch](./addswitch/)(const System::String\&, double) | 添加字段的开关。 |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Inline\>\&) | 在指定的内联节点之前构建并插入字段到文档中。 |
| [BuildAndInsert](./buildandinsert/)(const System::SharedPtr\<Aspose::Words::Paragraph\>\&) | 在指定段落的末尾构建并插入字段到文档中。 |
| [FieldBuilder](./fieldbuilder/)(Aspose::Words::Fields::FieldType) | 初始化 [FieldBuilder](./) 类的实例。 |
