...
description: "Aspose::Words::Fields::FieldEnd class. 表示文档中 Word 字段的结束。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 39000
url: /zh/cpp/aspose.words.fields/fieldend/
---
## FieldEnd class


表示文档中 Word 字段的结束。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_HasSeparator](./get_hasseparator/)() const | 如果此字段具有分隔符，则返回 **true**。 |
...
| [get_NodeType](./get_nodetype/)() const override | 返回 [FieldEnd](../../aspose.words/nodetype/)。 |
