---
title: "Aspose::Words::Fields::FieldSeq::get_ResetNumber 方法"
linktitle: "get_ResetNumber"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldSeq::get_ResetNumber 方法。获取或设置用于将序列号重置到的整数。如果在 C++ 中不存在该数字，则返回 -1。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.fields/fieldseq/get_resetnumber/
---
## FieldSeq::get_ResetNumber method


获取或设置一个整数，以将序列号重置到该值。如果该数字不存在，则返回 -1。
