...
description: "Aspose::Words::Fields::FieldTA class。实现 TA 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 99000
url: /zh/cpp/aspose.words.fields/fieldta/
---
## FieldTA class


实现 TA 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_EntryCategory](./get_entrycategory/)() | 获取整数条目类别，该类别是对应类别顺序的数字。 |
...
| [set_EntryCategory](./set_entrycategory/)(const System::String\&) | 设置整数条目类别，该类别是对应类别顺序的数字。 |
| [set_IsBold](./set_isbold/)(bool) | 设置是否对条目的页码应用粗体格式。 |
| [set_IsDirty](../field/set_isdirty/)(bool) | 用于设置 [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) 的 setter。 |
| [set_IsItalic](./set_isitalic/)(bool) | 设置是否对条目的页码应用斜体格式。 |
...
| [set_LongCitation](./set_longcitation/)(const System::String\&) | 设置条目的长引用。 |
| [set_PageRangeBookmarkName](./set_pagerangebookmarkname/)(const System::String\&) | 设置标记书签名称，该书签标记一段页面范围，作为条目的页码插入。 |
| [set_Result](../field/set_result/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::Field::get_Result](../field/get_result/) 的 setter。 |
| [set_ShortCitation](./set_shortcitation/)(const System::String\&) | 设置条目的短引用。 |
| static [Type](./type/)() |  |
