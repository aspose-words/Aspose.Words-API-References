...
description: "Aspose::Words::Fields::FieldXE 类。实现 XE 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 111000
url: /zh/cpp/aspose.words.fields/fieldxe/
---
## FieldXE class


实现 XE 字段。要了解更多信息，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_EntryType](./get_entrytype/)() | 获取或设置索引条目类型。 |
...
| [get_IsBold](./get_isbold/)() | 获取或设置是否对条目的页码应用粗体格式。 |
| [get_IsDirty](../field/get_isdirty/)() | 获取或设置字段的当前结果是否因对文档的其他修改而不再正确（已过时）。 |
| [get_IsItalic](./get_isitalic/)() | 获取或设置是否对条目的页码应用斜体格式。 |
| [get_IsLocked](../field/get_islocked/)() | 获取或设置字段是否被锁定（不应重新计算其结果）。 |
| [get_LocaleId](../field/get_localeid/)() | 获取或设置字段的 LCID。 |
| [get_PageNumberReplacement](./get_pagenumberreplacement/)() | 获取或设置用于替代页码的文本。 |
| [get_PageRangeBookmarkName](./get_pagerangebookmarkname/)() | 获取或设置标记一段页面范围的书签名称，该范围将作为条目的页码插入。 |
...
| [get_Text](./get_text/)() | 获取或设置条目的文本。 |
| virtual [get_Type](../field/get_type/)() const | 获取 Microsoft Word 字段类型。 |
| [get_Yomi](./get_yomi/)() | 获取或设置索引条目的 yomi（用于索引排序的首个音标字符）。 |
...
| [set_EntryType](./set_entrytype/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldXE::get_EntryType](./get_entrytype/)。 |
| [set_IsBold](./set_isbold/)(bool) | 用于设置 [Aspose::Words::Fields::FieldXE::get_IsBold](./get_isbold/)。 |
| [set_IsDirty](../field/set_isdirty/)(bool) | 用于设置 [Aspose::Words::Fields::Field::get_IsDirty](../field/get_isdirty/) 的 setter。 |
| [set_IsItalic](./set_isitalic/)(bool) | 用于设置 [Aspose::Words::Fields::FieldXE::get_IsItalic](./get_isitalic/)。 |
...
| [set_PageNumberReplacement](./set_pagenumberreplacement/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldXE::get_PageNumberReplacement](./get_pagenumberreplacement/)。 |
| [set_PageRangeBookmarkName](./set_pagerangebookmarkname/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldXE::get_PageRangeBookmarkName](./get_pagerangebookmarkname/)。 |
| [set_Result](../field/set_result/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::Field::get_Result](../field/get_result/) 的 setter。 |
| [set_Text](./set_text/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldXE::get_Text](./get_text/)。 |
| [set_Yomi](./set_yomi/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldXE::get_Yomi](./get_yomi/)。 |
| static [Type](./type/)() |  |
