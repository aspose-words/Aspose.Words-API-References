---
title: "Aspose::Words::Fields::FieldTC 类"
linktitle: "FieldTC"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldTC 类。实现 TC 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 100000
url: /zh/cpp/aspose.words.fields/fieldtc/
---
## FieldTC class


实现 TC 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_EntryLevel](./get_entrylevel/)() | 获取条目的级别。 |
...
| [get_OmitPageNumber](./get_omitpagenumber/)() override | 获取是否应在目录中省略此字段的页码。 |
...
| [get_Text](./get_text/)() | 获取条目的文本。 |
| virtual [get_Type](../field/get_type/)() const | 获取 Microsoft Word 字段类型。 |
| [get_TypeIdentifier](./get_typeidentifier/)() | 获取此字段的类型标识符（通常是字母）。 |
...
| [set_EntryLevel](./set_entrylevel/)(const System::String\&) | 设置条目的级别。 |
...
| [set_OmitPageNumber](./set_omitpagenumber/)(bool) | 设置是否应在目录中省略此字段的页码。 |
| [set_Result](../field/set_result/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::Field::get_Result](../field/get_result/) 的 setter。 |
| [set_Text](./set_text/)(const System::String\&) | 设置条目的文本。 |
| [set_TypeIdentifier](./set_typeidentifier/)(const System::String\&) | 设置此字段的类型标识符（通常是字母）。 |
| static [Type](./type/)() |  |
