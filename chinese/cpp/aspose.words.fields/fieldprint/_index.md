---
title: "Aspose::Words::Fields::FieldPrint 类"
linktitle: "FieldPrint"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldPrint 类。实现 PRINT 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 80000
url: /zh/cpp/aspose.words.fields/fieldprint/
---
## FieldPrint class


实现 PRINT 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_PostScriptGroup](./get_postscriptgroup/)() | 获取或设置 PostScript 指令操作的绘图矩形。 |
| [get_PrinterInstructions](./get_printerinstructions/)() | 获取或设置特定于打印机的控制码字符或 PostScript 指令。 |
...
| [set_PostScriptGroup](./set_postscriptgroup/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldPrint::get_PostScriptGroup](./get_postscriptgroup/)。 |
| [set_PrinterInstructions](./set_printerinstructions/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldPrint::get_PrinterInstructions](./get_printerinstructions/)。 |
