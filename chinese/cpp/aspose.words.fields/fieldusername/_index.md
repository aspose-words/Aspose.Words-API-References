...
description: "Aspose::Words::Fields::FieldUserName class. 实现 USERNAME 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 110000
url: /zh/cpp/aspose.words.fields/fieldusername/
---
## FieldUserName class


实现 USERNAME 字段。要了解更多信息，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_UserName](./get_username/)() | 获取或设置当前用户的名称。 |
...
| [set_UserName](./set_username/)(const System::String\&) | 用于 [Aspose::Words::Fields::FieldUserName::get_UserName](./get_username/) 的 setter。 |
| static [Type](./type/)() |  |
