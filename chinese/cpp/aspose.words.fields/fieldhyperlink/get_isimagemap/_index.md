---
title: "Aspose::Words::Fields::FieldHyperlink::get_IsImageMap 方法"
linktitle: "get_IsImageMap"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldHyperlink::get_IsImageMap 方法。获取或设置是否在服务器端图像映射的超链接中附加坐标（C++）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.fields/fieldhyperlink/get_isimagemap/
---
## FieldHyperlink::get_IsImageMap method


获取或设置是否向超链接追加坐标以用于服务器端图像映射。
