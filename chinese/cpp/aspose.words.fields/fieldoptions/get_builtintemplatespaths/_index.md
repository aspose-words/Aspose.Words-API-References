---
title: "Aspose::Words::Fields::FieldOptions::get_BuiltInTemplatesPaths 方法"
linktitle: "get_BuiltInTemplatesPaths"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldOptions::get_BuiltInTemplatesPaths 方法。获取或设置 C++ 中 MS Word 内置模板的路径。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.fields/fieldoptions/get_builtintemplatespaths/
---
...
此属性被 [FieldAutoText](../../fieldautotext/) 和 [FieldGlossary](../../fieldglossary/) 字段使用，如果在 [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/) 模板中未找到引用的自动文本条目。

默认情况下，MS Word 将内置模板存储在 c:\Users\<username>\AppData\Roaming\**Microsoft**\[Document](../../../aspose.words/document/) Building Blocks\1033\16\Built-In Building Blocks.dotx 和 C:\Users\<username>\AppData\Roaming\**Microsoft**\Templates\Normal.dotm 文件中。
