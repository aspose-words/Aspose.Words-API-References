---
title: "Aspose::Words::Fields::FieldIf::get_TrueText 方法"
linktitle: "get_TrueText"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldIf::get_TrueText 方法。获取或设置当比较表达式为 true 时显示的文本（在 C++ 中）。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.fields/fieldif/get_truetext/
---
## FieldIf::get_TrueText method


获取或设置当比较表达式为 true 时显示的文本。
