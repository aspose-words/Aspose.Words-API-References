...
description: "Aspose::Words::Fields::FieldFileSize 类。实现 FILESIZE 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 42000
url: /zh/cpp/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class


实现 FILESIZE 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_IsInKilobytes](./get_isinkilobytes/)() | 获取或设置是否以千字节显示文件大小。 |
| [get_IsInMegabytes](./get_isinmegabytes/)() | 获取或设置是否以兆字节显示文件大小。 |
...
| [set_IsInKilobytes](./set_isinkilobytes/)(bool) | 用于设置 [Aspose::Words::Fields::FieldFileSize::get_IsInKilobytes](./get_isinkilobytes/) 的 setter。 |
| [set_IsInMegabytes](./set_isinmegabytes/)(bool) | 用于设置 [Aspose::Words::Fields::FieldFileSize::get_IsInMegabytes](./get_isinmegabytes/) 的 setter。 |
...
检索当前文档文件的大小，如果无法确定大小则返回 0。

在当前实现中，使用 [OriginalFileName](../../aspose.words/document/get_originalfilename/) 属性来获取用于确定文件大小的文件名。
