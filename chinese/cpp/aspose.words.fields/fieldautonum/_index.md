---
title: "Aspose::Words::Fields::FieldAutoNum 类"
linktitle: "FieldAutoNum"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldAutoNum 类。实现 AUTONUM 字段。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.fields/fieldautonum/
---
## FieldAutoNum class


实现 AUTONUM 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| [get_SeparatorCharacter](./get_separatorcharacter/)() | 获取或设置要使用的分隔符字符。 |
...
| [set_SeparatorCharacter](./set_separatorcharacter/)(const System::String\&) | 用于 [Aspose::Words::Fields::FieldAutoNum::get_SeparatorCharacter](./get_separatorcharacter/) 的设置器。 |
| static [Type](./type/)() |  |
