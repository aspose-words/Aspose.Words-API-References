...
description: "Aspose::Words::Fields::FieldAuthor 类。实现 AUTHOR 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.fields/fieldauthor/
---
## FieldAuthor class


实现 AUTHOR 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [get_AuthorName](./get_authorname/)() | 获取或设置文档作者的名称。 |
...
| [set_AuthorName](./set_authorname/)(const System::String\&) | 用于设置 [Aspose::Words::Fields::FieldAuthor::get_AuthorName](./get_authorname/) 的 setter。 |
