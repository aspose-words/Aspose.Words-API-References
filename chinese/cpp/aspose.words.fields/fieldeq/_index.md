---
title: "Aspose::Words::Fields::FieldEQ 类"
linktitle: "FieldEQ"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::FieldEQ 类。实现 EQ 字段。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 40000
url: /zh/cpp/aspose.words.fields/fieldeq/
---
## FieldEQ class


实现 EQ 字段。欲了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [AsOfficeMath](./asofficemath/)() | 返回与 EQ 字段对应的 Office [Math](../../aspose.words.math/) 对象。 |
