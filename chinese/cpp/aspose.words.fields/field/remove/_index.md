---
title: "Aspose::Words::Fields::Field::Remove 方法"
linktitle: "Remove"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::Field::Remove 方法。将字段从文档中移除。返回字段之后的节点。如果字段''的结束是其父节点的最后一个子节点，则返回其父段落。如果字段已经被移除，则在 C++ 中返回 null。"
type: docs
weight: 17000
url: /zh/cpp/aspose.words.fields/field/remove/
---
## Field::Remove method
