---
title: "Aspose::Words::Fields::Field::get_Format 方法"
linktitle: "get_Format"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Fields::Field::get_Format 方法。获取一个 FieldFormat 对象，该对象提供对字段格式的类型化访问（在 C++ 中）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.fields/field/get_format/
---
## Field::get_Format method


获取一个 [FieldFormat](../../fieldformat/) 对象，该对象提供对字段格式的类型化访问。
