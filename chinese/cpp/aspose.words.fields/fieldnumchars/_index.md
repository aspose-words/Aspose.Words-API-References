...
description: "Aspose::Words::Fields::FieldNumChars class. 实现 NUMCHARS 字段。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 73000
url: /zh/cpp/aspose.words.fields/fieldnumchars/
---
## FieldNumChars class


实现 NUMCHARS 字段。要了解更多，请访问 [Working with Fields](https://docs.aspose.com/words/cpp/working-with-fields/) 文档文章。
