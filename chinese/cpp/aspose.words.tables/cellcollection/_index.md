---
title: "Aspose::Words::Tables::CellCollection 类"
linktitle: "CellCollection"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::CellCollection 类。提供对 Cell 节点集合的类型化访问。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.tables/cellcollection/
---
## CellCollection class


提供对 [Cell](../cell/) 节点集合的类型化访问。欲了解更多，请访问 [Working with Tables](https://docs.aspose.com/words/cpp/working-with-tables/) 文档文章。
...
| [idx_get](./idx_get/)(int32_t) | 检索给定索引处的 [Cell](../cell/)。 |
...
| [ToArray](./toarray/)() | 将集合中的所有单元格复制到一个新的单元格数组中。 |
| static [Type](./type/)() |  |
