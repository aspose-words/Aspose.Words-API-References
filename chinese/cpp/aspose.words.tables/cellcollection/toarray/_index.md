---
title: "Aspose::Words::Tables::CellCollection::ToArray 方法"
linktitle: "ToArray"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::CellCollection::ToArray 方法。将集合中的所有单元格复制到 C++ 中的新单元格数组。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.tables/cellcollection/toarray/
---
## CellCollection::ToArray method


将集合中的所有单元格复制到一个新的单元格数组中。
