---
title: "Aspose::Words::Tables::Table::get_VerticalAnchor 方法"
linktitle: "get_VerticalAnchor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::Table::get_VerticalAnchor 方法。获取用于计算浮动表格垂直定位的基准对象。默认值在 C++ 中为 Margin。"
type: docs
weight: 41000
url: /zh/cpp/aspose.words.tables/table/get_verticalanchor/
---
## Table::get_VerticalAnchor method


获取用于计算浮动表格垂直定位的基准对象。默认值是 [Margin](../../../aspose.words.drawing/relativeverticalposition/)。
