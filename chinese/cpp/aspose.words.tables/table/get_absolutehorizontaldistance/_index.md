---
title: "Aspose::Words::Tables::Table::get_AbsoluteHorizontalDistance 方法"
linktitle: "get_AbsoluteHorizontalDistance"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::Table::get_AbsoluteHorizontalDistance 方法。获取或设置由表格属性指定的绝对水平浮动表格位置，单位为点。默认值在 C++ 中为 0。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.tables/table/get_absolutehorizontaldistance/
---
## Table::get_AbsoluteHorizontalDistance method


获取或设置由表格属性指定的绝对水平浮动表格位置，单位为点。默认值为 0。
