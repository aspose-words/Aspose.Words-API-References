---
title: "Aspose::Words::Tables::Table::get_BottomPadding 方法"
linktitle: "get_BottomPadding"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::Table::get_BottomPadding 方法。获取或设置在 C++ 中单元格内容下方添加的空间量（以点为单位）。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.tables/table/get_bottompadding/
---
## Table::get_BottomPadding method


获取或设置在单元格内容下方添加的空间量（以磅为单位）。
