...
description: "Aspose::Words::Tables::Table::get_LeftPadding 方法。获取或设置在 C++ 中向单元格内容左侧添加的空间量（以点为单位）。"
type: docs
weight: 27000
url: /zh/cpp/aspose.words.tables/table/get_leftpadding/
---
## Table::get_LeftPadding method


获取或设置在单元格内容左侧添加的空间量（以磅为单位）。
