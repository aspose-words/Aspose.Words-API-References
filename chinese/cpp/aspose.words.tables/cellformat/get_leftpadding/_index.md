---
title: "Aspose::Words::Tables::CellFormat::get_LeftPadding 方法"
linktitle: "get_LeftPadding"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::CellFormat::get_LeftPadding 方法。返回或设置在单元格内容左侧添加的空间量（以点为单位）（C++）。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.tables/cellformat/get_leftpadding/
---
