---
title: "Aspose::Words::Tables::CellFormat::get_TopPadding 方法"
linktitle: "get_TopPadding"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Tables::CellFormat::get_TopPadding 方法。返回或设置在单元格内容上方添加的空间量（以点为单位）（C++）。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.tables/cellformat/get_toppadding/
---
## CellFormat::get_TopPadding method


返回或设置在单元格内容上方添加的空间量（以点为单位）。
