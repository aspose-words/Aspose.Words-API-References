---
title: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints 方法"
linktitle: "get_SizeInPoints"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Rendering::NodeRendererBase::get_SizeInPoints 方法。获取形状在 C++ 中以点为单位的实际大小。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.rendering/noderendererbase/get_sizeinpoints/
---
...
此属性返回形状实际（在页面上渲染后）的边界框大小。该大小考虑了形状的旋转（如果有）。
