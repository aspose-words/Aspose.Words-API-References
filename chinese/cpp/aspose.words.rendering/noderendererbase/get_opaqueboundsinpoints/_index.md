---
title: "Aspose::Words::Rendering::NodeRendererBase::get_OpaqueBoundsInPoints 方法"
linktitle: "get_OpaqueBoundsInPoints"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Rendering::NodeRendererBase::get_OpaqueBoundsInPoints 方法。获取形状在 C++ 中以点为单位的不透明边界。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.rendering/noderendererbase/get_opaqueboundsinpoints/
---
...
此属性返回形状的不透明（即忽略形状的透明部分）边界框。该边界考虑了形状的旋转。
