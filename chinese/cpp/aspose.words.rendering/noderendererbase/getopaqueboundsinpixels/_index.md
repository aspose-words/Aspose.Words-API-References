---
title: "Aspose::Words::Rendering::NodeRendererBase::GetOpaqueBoundsInPixels 方法"
linktitle: "GetOpaqueBoundsInPixels"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Rendering::NodeRendererBase::GetOpaqueBoundsInPixels 方法。计算在指定缩放因子和分辨率下形状的像素不透明边界（C++）。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.rendering/noderendererbase/getopaqueboundsinpixels/
---
## NodeRendererBase::GetOpaqueBoundsInPixels(float, float) method


根据指定的缩放因子和分辨率计算形状的不透明像素边界。
...
此方法将 [OpaqueBoundsInPoints](../get_opaqueboundsinpoints/) 转换为像素矩形，当您想创建仅渲染形状不透明部分的位图时非常有用。
