---
title: "Aspose::Words::Rendering::ThumbnailGeneratingOptions::get_GenerateFromFirstPage 方法"
linktitle: "get_GenerateFromFirstPage"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Rendering::ThumbnailGeneratingOptions::get_GenerateFromFirstPage 方法。指定是否从文档的首页或第一张图片生成缩略图，使用 C++。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.rendering/thumbnailgeneratingoptions/get_generatefromfirstpage/
---
## ThumbnailGeneratingOptions::get_GenerateFromFirstPage method


指定是从文档的首页还是第一张图像生成缩略图。
