---
title: "Aspose::Words::Drawing::Charts::ChartAxisTitle::get_Rotation 方法"
linktitle: "get_Rotation"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartAxisTitle::get_Rotation 方法。获取或设置轴标题的旋转角度（单位为度），在 C++ 中。"
type: docs
weight: 4500
url: /zh/cpp/aspose.words.drawing.charts/chartaxistitle/get_rotation/
---
## ChartAxisTitle::get_Rotation method


获取或设置坐标轴标题的旋转角度（以度为单位）。
