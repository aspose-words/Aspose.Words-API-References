---
title: "Aspose::Words::Drawing::Charts::ChartLegend::get_LegendEntries 方法"
linktitle: "get_LegendEntries"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartLegend::get_LegendEntries 方法。返回父图表中所有系列和趋势线的图例条目集合（C++）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing.charts/chartlegend/get_legendentries/
---
## ChartLegend::get_LegendEntries method


返回父图表中所有系列和趋势线的图例条目集合。
