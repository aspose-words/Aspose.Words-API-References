---
title: "Aspose::Words::Drawing::Charts::ChartLegend::get_Font 方法"
linktitle: "get_Font"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartLegend::get_Font 方法。提供对图例条目默认字体格式的访问。要覆盖特定图例条目的字体格式，请在 C++ 中使用 theFont 属性。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing.charts/chartlegend/get_font/
---
## ChartLegend::get_Font method


提供对图例条目默认字体格式的访问。要覆盖特定图例条目的字体格式，请使用 the[Font](../../chartlegendentry/get_font/) 属性。
