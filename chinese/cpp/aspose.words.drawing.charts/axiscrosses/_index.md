---
title: "Aspose::Words::Drawing::Charts::AxisCrosses 枚举"
linktitle: "AxisCrosses"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisCrosses 枚举。指定 C++ 中轴的可能交叉点。"
type: docs
weight: 22000
url: /zh/cpp/aspose.words.drawing.charts/axiscrosses/
---
## AxisCrosses enum
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| 自动 | 0 | 类别轴在数值轴的零点交叉（如果可能），否则在最小值交叉（如果最小值大于零），或在最大值交叉（如果最大值小于零）。 |
