---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit 方法"
linktitle: "get_CustomUnit"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit 方法。获取或设置用于在值轴上缩放显示单位的用户定义除数（C++）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing.charts/axisdisplayunit/get_customunit/
---
## AxisDisplayUnit::get_CustomUnit method


获取或设置用于在数值轴上缩放显示单位的用户定义除数。
...
此属性不受 MS Office 2016 新图表支持。默认值为 1。

设置此属性会将 [Unit](../get_unit/) 属性设置为 [Custom](../../axisbuiltinunit/)。
