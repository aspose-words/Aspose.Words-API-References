---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit 方法"
linktitle: "get_Unit"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit 方法。获取或设置显示单位的缩放值（C++ 中的预定义值之一）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.drawing.charts/axisdisplayunit/get_unit/
---
## AxisDisplayUnit::get_Unit method


获取或设置显示单位的缩放值（预定义值之一）。
