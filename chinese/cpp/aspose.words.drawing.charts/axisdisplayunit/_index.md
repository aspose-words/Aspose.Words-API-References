---
title: "Aspose::Words::Drawing::Charts::AxisDisplayUnit 类"
linktitle: "AxisDisplayUnit"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisDisplayUnit 类。提供对数值轴显示单位缩放选项的访问。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing.charts/axisdisplayunit/
---
## AxisDisplayUnit class


提供对数值轴显示单位缩放选项的访问。欲了解更多信息，请访问 [Working with Charts](https://docs.aspose.com/words/cpp/working-with-charts/) 文档文章。
...
| [get_CustomUnit](./get_customunit/)() const | 获取或设置用于在数值轴上缩放显示单位的用户定义除数。 |
| [get_Document](./get_document/)() | 返回包含父图表的文档。 |
| [get_Unit](./get_unit/)() const | 获取或设置显示单位的缩放值（预定义值之一）。 |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_CustomUnit](./set_customunit/)(double) | 用于设置 [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_CustomUnit](./get_customunit/) 的 setter。 |
| [set_Unit](./set_unit/)(Aspose::Words::Drawing::Charts::AxisBuiltInUnit) | 用于设置 [Aspose::Words::Drawing::Charts::AxisDisplayUnit::get_Unit](./get_unit/) 的 setter。 |
| static [Type](./type/)() |  |
