---
title: "Aspose::Words::Drawing::Charts::ChartSeries::Clear 方法"
linktitle: "清除"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartSeries::Clear 方法。删除图表系列中的所有数据值。所有单个数据点和数据标签的格式在 C++ 中被清除。"
type: docs
weight: 1500
url: /zh/cpp/aspose.words.drawing.charts/chartseries/clear/
---
## ChartSeries::Clear method


从图表系列中移除所有数据值。所有单个数据点和数据标签的格式将被清除。
