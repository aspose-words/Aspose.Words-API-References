---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder 方法"
linktitle: "get_HasOutlineBorder"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasOutlineBorder 方法。获取或设置一个标志，指示是否显示轮廓边框，即围绕系列和类别名称的边框。默认值在 C++ 中为 true。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.drawing.charts/chartdatatable/get_hasoutlineborder/
---
## ChartDataTable::get_HasOutlineBorder method


获取或设置指示是否显示轮廓边框（即围绕系列和类别名称的边框）的标志。默认值为 **true**。
