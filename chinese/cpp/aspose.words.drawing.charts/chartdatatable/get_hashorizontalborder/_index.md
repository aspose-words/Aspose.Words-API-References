---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder 方法"
linktitle: "get_HasHorizontalBorder"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasHorizontalBorder 方法。获取或设置一个标志，指示是否显示数据表的水平边框。默认值在 C++ 中为 true。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing.charts/chartdatatable/get_hashorizontalborder/
---
## ChartDataTable::get_HasHorizontalBorder method


获取或设置指示是否显示数据表水平边框的标志。默认值为 **true**。
