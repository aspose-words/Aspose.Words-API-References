---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys 方法"
linktitle: "get_HasLegendKeys"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_HasLegendKeys 方法。获取或设置一个标志，指示是否在数据表中显示图例键。默认值在 C++ 中为 true。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.drawing.charts/chartdatatable/get_haslegendkeys/
---
## ChartDataTable::get_HasLegendKeys method


获取或设置指示是否在数据表中显示图例键的标志。默认值为 **true**。
