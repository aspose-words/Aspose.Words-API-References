---
title: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show 方法"
linktitle: "get_Show"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataTable::get_Show 方法。获取或设置一个标志，指示是否在图表中显示数据表。默认值在 C++ 中为 false。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.drawing.charts/chartdatatable/get_show/
---
## ChartDataTable::get_Show method


获取或设置指示是否在图表中显示数据表的标志。默认值为 **false**。
