...
description: "Aspose::Words::Drawing::Charts::AxisCategoryType enum. 指定 C++ 中类别轴的类型。"
type: docs
weight: 21000
url: /zh/cpp/aspose.words.drawing.charts/axiscategorytype/
---
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| 自动 | 0 | 指定类别轴的类型根据数据自动确定。 |
| Category | 1 | 指定任意类别集合的轴。 |
| Time | 2 | 指定时间类别轴。 |
