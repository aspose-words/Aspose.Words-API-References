---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode 方法"
linktitle: "get_TopMode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_TopMode 方法。获取或设置 Top 属性值的解释模式：是从图表顶部边缘设置数据标签的位置，还是从其 Position 属性指定的位置设置（在 C++ 中）。"
type: docs
weight: 16667
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabel/get_topmode/
---
## ChartDataLabel::get_TopMode method


获取或设置 [Top](../get_top/) 属性值的解释模式：是从图表顶部边缘设置数据标签的位置，还是从其 [Position](../get_position/) 属性指定的位置设置。
