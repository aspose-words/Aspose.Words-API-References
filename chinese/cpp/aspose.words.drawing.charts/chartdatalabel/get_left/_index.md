---
title: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left 方法"
linktitle: "get_Left"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabel::get_Left 方法。获取或设置数据标签相对于图表左边缘或其 Position 属性指定位置的距离（单位为点），取决于 C++ 中 LeftMode 属性的值。"
type: docs
weight: 6334
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabel/get_left/
---
## ChartDataLabel::get_Left method


获取或设置数据标签相对于图表左边缘的距离（以点为单位），或相对于其 [Position](../get_position/) 属性指定的位置，取决于 [LeftMode](../get_leftmode/) 属性的值。
