---
title: "Aspose::Words::Drawing::Charts::ChartSeriesCollection::idx_get 方法"
linktitle: "idx_get"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartSeriesCollection::idx_get 方法。返回在指定索引处的 ChartSeries（C++）。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words.drawing.charts/chartseriescollection/idx_get/
---
## ChartSeriesCollection::idx_get method


在指定索引处返回一个[ChartSeries](../../chartseries/)。
