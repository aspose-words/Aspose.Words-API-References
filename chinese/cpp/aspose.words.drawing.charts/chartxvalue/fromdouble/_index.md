---
title: "Aspose::Words::Drawing::Charts::ChartXValue::FromDouble 方法"
linktitle: "FromDouble"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartXValue::FromDouble 方法。创建一个类型为 Double 的 ChartXValue 实例（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing.charts/chartxvalue/fromdouble/
---
## ChartXValue::FromDouble method


创建一个 [ChartXValue](../) 实例，类型为 [Double](../../chartxvaluetype/)。
