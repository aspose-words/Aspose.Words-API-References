...
description: "Aspose::Words::Drawing::Charts::AxisTickMark enum. 指定 C++ 中刻度线的可能位置。"
type: docs
weight: 25000
url: /zh/cpp/aspose.words.drawing.charts/axistickmark/
---
## AxisTickMark enum
...
| --- | --- | --- |
| Cross | 0 | 指定刻度线应穿过坐标轴。 |
| Inside | 1 | 指定刻度线应位于绘图区域内部。 |
| Outside | 2 | 指定刻度线应位于绘图区域外部。 |
| None | 3 | 指定不应有刻度线。 |
