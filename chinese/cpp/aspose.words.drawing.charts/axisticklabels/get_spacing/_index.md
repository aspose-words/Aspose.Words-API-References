---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing 方法"
linktitle: "get_Spacing"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_Spacing 方法。获取或设置刻度标签绘制的间隔，在 C++ 中。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.drawing.charts/axisticklabels/get_spacing/
---
...
此属性对文本类目轴和系列轴有效。MS Office 2016 新图表不支持此属性。有效值范围为大于或等于 1。

设置此属性会将 [IsAutoSpacing](../get_isautospacing/) 属性设为 **false**。
