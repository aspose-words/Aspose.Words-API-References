---
title: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing 方法"
linktitle: "get_IsAutoSpacing"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::AxisTickLabels::get_IsAutoSpacing 方法。获取或设置一个标志，指示是否在 C++ 中使用自动间隔来绘制刻度标签。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing.charts/axisticklabels/get_isautospacing/
---
## AxisTickLabels::get_IsAutoSpacing method


获取或设置一个标志，指示是否使用自动间隔来绘制刻度标签。
...
该属性对文本类别轴和系列轴有效。MS Office 2016 新图表不支持此属性。
