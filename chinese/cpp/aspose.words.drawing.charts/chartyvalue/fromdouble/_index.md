---
title: "Aspose::Words::Drawing::Charts::ChartYValue::FromDouble 方法"
linktitle: "FromDouble"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartYValue::FromDouble 方法。在 C++ 中创建一个 Double 类型的 ChartYValue 实例。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing.charts/chartyvalue/fromdouble/
---
## ChartYValue::FromDouble method


创建一个 [ChartYValue](../) 实例，类型为 [Double](../../chartyvaluetype/)。
