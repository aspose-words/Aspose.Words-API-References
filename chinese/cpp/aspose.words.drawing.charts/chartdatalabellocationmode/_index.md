---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode 枚举"
linktitle: "ChartDataLabelLocationMode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelLocationMode 枚举。指定在 C++ 中如何解释指定数据标签位置的值——Left 和 Top 属性——。"
type: docs
weight: 27167
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabellocationmode/
---
## ChartDataLabelLocationMode enum


指定在解释指定数据标签位置的值——[Left](../chartdatalabel/get_left/) 和 [Top](../chartdatalabel/get_top/) 属性——时的方式。
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Offset | 0 | 数据标签的位置通过相对于其 [Position](../chartdatalabel/get_position/) 属性定义的位置的偏移来指定。 |
| 绝对 | 1 | 数据标签的位置使用绝对坐标指定，起始于图表的左上角。 |
