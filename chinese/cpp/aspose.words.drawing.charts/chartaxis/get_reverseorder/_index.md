---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder 方法"
linktitle: "get_ReverseOrder"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_ReverseOrder 方法。获取或设置一个标志，指示轴的值是否应以相反顺序显示，即在 C++ 中从最大到最小。"
type: docs
weight: 21000
url: /zh/cpp/aspose.words.drawing.charts/chartaxis/get_reverseorder/
---
## ChartAxis::get_ReverseOrder method


获取或设置一个标志，指示轴的值是否应以相反顺序显示，即从最大到最小。
