---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto 方法"
linktitle: "get_MinorUnitIsAuto"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MinorUnitIsAuto 方法。获取或设置一个标志，指示在 C++ 中是否应使用次刻度标记之间的默认距离。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words.drawing.charts/chartaxis/get_minorunitisauto/
---
## ChartAxis::get_MinorUnitIsAuto method


获取或设置一个标志，指示是否使用次刻度标记之间的默认距离。
