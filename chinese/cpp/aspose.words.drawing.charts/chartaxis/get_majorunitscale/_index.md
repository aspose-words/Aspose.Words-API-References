---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitScale 方法"
linktitle: "get_MajorUnitScale"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitScale 方法。返回或设置时间类别轴上主要刻度标记的比例值（C++）。"
type: docs
weight: 15000
url: /zh/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitscale/
---
## ChartAxis::get_MajorUnitScale method


获取或设置时间类别轴上主刻度标记的比例值。
