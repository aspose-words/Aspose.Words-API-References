---
title: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto 方法"
linktitle: "get_MajorUnitIsAuto"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartAxis::get_MajorUnitIsAuto 方法。获取或设置一个标志，指示是否在 C++ 中使用默认的主刻度线之间的距离。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words.drawing.charts/chartaxis/get_majorunitisauto/
---
## ChartAxis::get_MajorUnitIsAuto method


获取或设置一个标志，指示是否使用主刻度标记之间的默认距离。
