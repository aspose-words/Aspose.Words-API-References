---
title: "Aspose::Words::Drawing::Charts::ChartLegendEntry::get_IsHidden 方法"
linktitle: "get_IsHidden"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartLegendEntry::get_IsHidden 方法。获取或设置一个值，指示此条目在图表图例中是否隐藏。默认值在 C++ 中为 false。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing.charts/chartlegendentry/get_ishidden/
---
## ChartLegendEntry::get_IsHidden method


获取或设置指示此条目在图表图例中是否隐藏的值。默认值为 **false**。
