---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowLeaderLines 方法"
linktitle: "get_ShowLeaderLines"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowLeaderLines 方法。允许指定是否需要在整个系列的数据标签上显示数据标签引导线。默认值在 C++ 中为 false。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showleaderlines/
---
## ChartDataLabelCollection::get_ShowLeaderLines method


允许指定是否在整个系列的数据标签中显示数据标签引导线。默认值为 **false**。
...
仅适用于饼图。引导线在数据标签与其对应的数据点之间创建可视连接。

此属性定义的值可以通过使用 [ShowLeaderLines](../../chartdatalabel/get_showleaderlines/) 属性为单个数据标签覆盖。
