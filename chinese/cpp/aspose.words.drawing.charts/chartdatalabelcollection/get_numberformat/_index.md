---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat 方法"
linktitle: "get_NumberFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_NumberFormat 方法。获取一个 ChartNumberFormat 实例，以便在 C++ 中为整个系列的数据标签设置数字格式。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_numberformat/
---
## ChartDataLabelCollection::get_NumberFormat method


获取一个 [ChartNumberFormat](../../chartnumberformat/) 实例，以便为整个系列的数据标签设置数字格式。
