---
title: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowValue 方法"
linktitle: "get_ShowValue"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartDataLabelCollection::get_ShowValue 方法。允许指定是否在整个系列的数据标签中显示数值。默认值在 C++ 中为 false。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words.drawing.charts/chartdatalabelcollection/get_showvalue/
---
## ChartDataLabelCollection::get_ShowValue method


允许指定是否在整个系列的数据标签中显示数值。默认值为 **false**。
