---
title: "Aspose::Words::Drawing::Charts::Chart::get_DataTable 方法"
linktitle: "get_DataTable"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::Chart::get_DataTable 方法。提供对该图表数据表属性的访问。可通过在 C++ 中使用 Show 属性来显示数据表。"
type: docs
weight: 4500
url: /zh/cpp/aspose.words.drawing.charts/chart/get_datatable/
---
## Chart::get_DataTable method


提供对该图表数据表属性的访问。可通过使用 [Show](../../chartdatatable/get_show/) 属性来显示数据表。
