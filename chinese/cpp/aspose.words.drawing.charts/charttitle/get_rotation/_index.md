---
title: "Aspose::Words::Drawing::Charts::ChartTitle::get_Rotation 方法"
linktitle: "get_Rotation"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartTitle::get_Rotation 方法。获取或设置图表标题的旋转角度（以度为单位），在 C++ 中。"
type: docs
weight: 2500
url: /zh/cpp/aspose.words.drawing.charts/charttitle/get_rotation/
---
## ChartTitle::get_Rotation method


获取或设置图表标题的旋转角度（以度为单位）。
