---
title: "Aspose::Words::Drawing::Charts::ChartTitle::get_Show 方法"
linktitle: "get_Show"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartTitle::get_Show 方法。确定是否应在此图表中显示标题。默认值在 C++ 中为 true。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing.charts/charttitle/get_show/
---
## ChartTitle::get_Show method


确定是否在此图表中显示标题。默认值为 **true**。
