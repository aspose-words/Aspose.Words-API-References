---
title: "Aspose::Words::Drawing::Charts::ChartTitle::get_Overlay 方法"
linktitle: "get_Overlay"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Charts::ChartTitle::get_Overlay 方法。确定是否允许其他图表元素覆盖标题。默认情况下，overlay 为 false（在 C++ 中）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing.charts/charttitle/get_overlay/
---
## ChartTitle::get_Overlay method


确定是否允许其他图表元素覆盖标题。默认情况下，覆盖为 **false**。
