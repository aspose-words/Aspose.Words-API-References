---
title: "Aspose::Words::Lists::List::get_IsListStyleDefinition 方法"
linktitle: "get_IsListStyleDefinition"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::List::get_IsListStyleDefinition 方法。如果此列表是列表样式的定义，则返回 true（在 C++ 中）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.lists/list/get_isliststyledefinition/
---
...
当此属性为 **true** 时，[Style](../get_style/) 属性返回此列表定义的列表样式。

通过修改定义列表样式的列表的属性，您会修改该列表样式的属性。
