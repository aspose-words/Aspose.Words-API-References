---
title: "Aspose::Words::Lists::ListFormat::ApplyNumberDefault 方法"
linktitle: "ApplyNumberDefault"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListFormat::ApplyNumberDefault 方法。 在 C++ 中启动一个新的默认编号列表并将其应用于段落。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.lists/listformat/applynumberdefault/
---
...
这是一个快捷方法，使用默认编号模板创建新列表，将其应用于段落并选择第一级列表级别。
