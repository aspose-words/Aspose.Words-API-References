---
title: "Aspose::Words::Lists::ListFormat::ApplyBulletDefault 方法"
linktitle: "ApplyBulletDefault"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListFormat::ApplyBulletDefault 方法。在 C++ 中启动一个新的默认项目符号列表并将其应用于段落。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.lists/listformat/applybulletdefault/
---
...
这是一个快捷方法，使用默认项目符号模板创建新列表，将其应用于段落并选择第一级列表。
