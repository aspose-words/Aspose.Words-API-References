---
title: "Aspose::Words::Lists::ListLevel::get_IsLegal 方法"
linktitle: "get_IsLegal"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListLevel::get_IsLegal 方法。若该级别将所有继承的数字转换为阿拉伯数字则返回 true，若保持其数字样式则返回 false（在 C++ 中）。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words.lists/listlevel/get_islegal/
---
## ListLevel::get_IsLegal method


如果该级别将所有继承的编号转换为阿拉伯数字则为 true，否则如果保留其编号样式则为 false。
