---
title: "Aspose::Words::Lists::ListLevel::get_NumberPosition 方法"
linktitle: "get_NumberPosition"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListLevel::get_NumberPosition 方法。返回或设置列表级别的数字或项目符号的位置（单位为点），适用于 C++。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.lists/listlevel/get_numberposition/
---
## ListLevel::get_NumberPosition method


返回或设置列表级别的编号或项目符号的位置（以点为单位）。
