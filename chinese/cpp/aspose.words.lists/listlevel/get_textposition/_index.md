---
title: "Aspose::Words::Lists::ListLevel::get_TextPosition 方法"
linktitle: "get_TextPosition"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListLevel::get_TextPosition 方法。返回或设置列表级别第二行换行文本的位置信息（单位为点），适用于 C++。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words.lists/listlevel/get_textposition/
---
## ListLevel::get_TextPosition method


返回或设置列表级别换行文本第二行的位置（以点为单位）。
