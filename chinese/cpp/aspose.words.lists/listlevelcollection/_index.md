---
title: "Aspose::Words::Lists::ListLevelCollection 类"
linktitle: "ListLevelCollection"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Lists::ListLevelCollection 类。每个列表级别的列表格式集合。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.lists/listlevelcollection/
---
## ListLevelCollection class


一个包含列表中每个级别的列表格式的集合。要了解更多信息，请访问 [Working with Lists](https://docs.aspose.com/words/cpp/working-with-lists/) 文档文章。
...
| [end](./end/)() |  |
| [end](./end/)() const |  |
| [get_Count](./get_count/)() | 获取此列表的级别数量。 |
| [GetEnumerator](./getenumerator/)() override | 获取将在此列表中枚举级别的枚举器对象。 |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | 通过索引获取列表级别。 |
| [idx_set](./idx_set/)(int32_t, const System::SharedPtr\<Aspose::Words::Lists::ListLevel\>\&) | 通过索引获取列表级别。 |
