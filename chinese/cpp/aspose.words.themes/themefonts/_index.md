---
title: "Aspose::Words::Themes::ThemeFonts 类"
linktitle: "ThemeFonts"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Themes::ThemeFonts 类。表示字体方案中的字体集合，允许为不同语言（Latin、EastAsian 和 ComplexScript）指定不同的字体。了解更多，请访问 C++ 文档文章。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.themes/themefonts/
---
## ThemeFonts class


表示字体方案中的字体集合，允许为不同语言 [Latin](./get_latin/)、[EastAsian](./get_eastasian/) 和 [ComplexScript](./get_complexscript/) 指定不同的字体。了解更多，请访问 [Working with Styles and Themes](https://docs.aspose.com/words/cpp/working-with-styles-and-themes/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [get_ComplexScript](./get_complexscript/)() | 指定 ComplexScript 字符的字体名称。 |
| [get_EastAsian](./get_eastasian/)() | 指定 EastAsian 字符的字体名称。 |
| [get_Latin](./get_latin/)() | 指定 Latin 字符的字体名称。 |
| [GetType](./gettype/)() const override |  |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [set_ComplexScript](./set_complexscript/)(const System::String\&) | 用于 [Aspose::Words::Themes::ThemeFonts::get_ComplexScript](./get_complexscript/) 的设置器。 |
| [set_EastAsian](./set_eastasian/)(const System::String\&) | 用于 [Aspose::Words::Themes::ThemeFonts::get_EastAsian](./get_eastasian/) 的 setter。 |
| [set_Latin](./set_latin/)(const System::String\&) | 用于 [Aspose::Words::Themes::ThemeFonts::get_Latin](./get_latin/) 的 setter。 |
| static [Type](./type/)() |  |
