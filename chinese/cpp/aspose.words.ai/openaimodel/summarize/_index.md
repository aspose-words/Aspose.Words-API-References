---
title: "Aspose::Words::AI::OpenAiModel::Summarize 方法"
linktitle: "摘要"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::AI::OpenAiModel::Summarize 方法。为文档数组生成摘要，可通过选项控制摘要长度和其他设置。此方法在 C++ 中利用已连接的 AI 模型处理数组中的每个文档。"
type: docs
weight: 3334
url: /zh/cpp/aspose.words.ai/openaimodel/summarize/
---
