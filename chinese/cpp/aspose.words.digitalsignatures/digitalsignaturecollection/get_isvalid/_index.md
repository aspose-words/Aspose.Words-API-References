---
title: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid 方法"
linktitle: "get_IsValid"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DigitalSignatures::DigitalSignatureCollection::get_IsValid 方法。返回 true，如果此集合中的所有数字签名均有效且文档未被篡改；如果没有数字签名也返回 true；如果至少有一个数字签名无效，则返回 false。C++ 中使用。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.digitalsignatures/digitalsignaturecollection/get_isvalid/
---
## DigitalSignatureCollection::get_IsValid method


如果此集合中的所有数字签名均有效且文档未被篡改，则返回 **true**。如果没有数字签名，也返回 **true**。如果至少有一个数字签名无效，则返回 **false**。
