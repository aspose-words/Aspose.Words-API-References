---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion 方法"
linktitle: "get_WindowsVersion"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_WindowsVersion 方法。获取或设置数字签名的 Windows 版本。默认值在 C++ 中为 \"6.1\"。"
type: docs
weight: 8334
url: /zh/cpp/aspose.words.digitalsignatures/signoptions/get_windowsversion/
---
## SignOptions::get_WindowsVersion method


获取或设置数字签名的 Windows 版本。默认值为 "6.1"。
