---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution 方法"
linktitle: "get_HorizontalResolution"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_HorizontalResolution 方法。获取或设置数字签名的水平分辨率。默认值为 1920，在 C++ 中。"
type: docs
weight: 4334
url: /zh/cpp/aspose.words.digitalsignatures/signoptions/get_horizontalresolution/
---
## SignOptions::get_HorizontalResolution method


获取或设置数字签名的水平分辨率。默认值为 1920。
