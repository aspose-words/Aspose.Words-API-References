---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion 方法"
linktitle: "get_ApplicationVersion"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ApplicationVersion 方法。获取或设置数字签名的应用程序版本。默认值为 \"12.0\"，在 C++ 中。"
type: docs
weight: 2334
url: /zh/cpp/aspose.words.digitalsignatures/signoptions/get_applicationversion/
---
## SignOptions::get_ApplicationVersion method


获取或设置数字签名的应用程序版本。默认值为 "12.0"。
