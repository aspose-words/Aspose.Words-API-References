---
title: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth 方法"
linktitle: "get_ColorDepth"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DigitalSignatures::SignOptions::get_ColorDepth 方法。获取或设置数字签名的颜色深度。默认值为 32，在 C++ 中。"
type: docs
weight: 2667
url: /zh/cpp/aspose.words.digitalsignatures/signoptions/get_colordepth/
---
## SignOptions::get_ColorDepth method


获取或设置数字签名的颜色深度。默认值为 32。
