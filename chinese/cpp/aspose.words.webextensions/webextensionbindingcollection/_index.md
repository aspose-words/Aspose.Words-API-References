---
title: "Aspose::Words::WebExtensions::WebExtensionBindingCollection 类"
linktitle: "WebExtensionBindingCollection"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::WebExtensionBindingCollection 类。指定 Web 扩展绑定的列表。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.webextensions/webextensionbindingcollection/
---
## WebExtensionBindingCollection class


指定 Web 扩展绑定的列表。了解更多，请访问 [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) 文档文章。
