---
title: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding 构造函数"
linktitle: "WebExtensionBinding"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::WebExtensionBinding::WebExtensionBinding 构造函数。用于在 C++ 中使用指定参数创建 Web 扩展绑定。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.webextensions/webextensionbinding/webextensionbinding/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| id | const System::String\& | 绑定标识符。 |
| bindingType | Aspose::Words::WebExtensions::WebExtensionBindingType | 绑定类型。 |
| appRef | const System::String\& | 用于将此列表中的绑定条目映射到文档中绑定数据的绑定键。 |
