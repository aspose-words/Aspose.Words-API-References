---
title: "Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef 方法"
linktitle: "get_AppRef"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::WebExtensionBinding::get_AppRef 方法。指定用于将此列表中的绑定条目映射到文档中绑定数据的绑定键，使用 C++。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.webextensions/webextensionbinding/get_appref/
---
## WebExtensionBinding::get_AppRef method


指定用于将此列表中的绑定条目映射到文档中绑定数据的绑定键。
