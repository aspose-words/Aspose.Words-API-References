---
title: "Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty 构造函数"
linktitle: "WebExtensionProperty"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::WebExtensionProperty::WebExtensionProperty 构造函数。在 C++ 中使用指定的名称和值创建 Web 扩展自定义属性。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.webextensions/webextensionproperty/webextensionproperty/
---
## WebExtensionProperty::WebExtensionProperty constructor


创建具有指定名称和值的 web extension 自定义属性。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | const System::String\& | 属性名称。 |
| value | const System::String\& | 属性值。 |
