---
title: "Aspose::Words::WebExtensions::TaskPaneCollection 类"
linktitle: "TaskPaneCollection"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::TaskPaneCollection 类。指定持久化任务窗格对象的列表。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.webextensions/taskpanecollection/
---
## TaskPaneCollection class


指定持久化任务窗格对象的列表。了解更多，请访问 [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) 文档文章。
