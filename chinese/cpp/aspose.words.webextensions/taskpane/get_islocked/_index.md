---
title: "Aspose::Words::WebExtensions::TaskPane::get_IsLocked 方法"
linktitle: "get_IsLocked"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::TaskPane::get_IsLocked 方法。指定任务窗格在 UI 中是否锁定到文档，且用户在 C++ 中无法关闭。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.webextensions/taskpane/get_islocked/
---
## TaskPane::get_IsLocked method


指定任务窗格在 UI 中是否锁定到文档且用户无法关闭。
