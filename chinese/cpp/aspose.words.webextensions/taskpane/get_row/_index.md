---
title: "Aspose::Words::WebExtensions::TaskPane::get_Row 方法"
linktitle: "get_Row"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::TaskPane::get_Row 方法。指定此任务窗格在 C++ 中与其他停靠在相同默认位置的持久化任务窗格之间的索引（从外到内枚举）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.webextensions/taskpane/get_row/
---
## TaskPane::get_Row method


指定此任务窗格在同一默认位置停靠的其他持久任务窗格中的索引（从外到内枚举）。
