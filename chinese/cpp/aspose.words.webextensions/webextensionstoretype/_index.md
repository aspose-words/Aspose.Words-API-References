---
title: "Aspose::Words::WebExtensions::WebExtensionStoreType 枚举"
linktitle: "WebExtensionStoreType"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::WebExtensions::WebExtensionStoreType 枚举。枚举 C++ 中 Web 扩展商店的可用类型。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.webextensions/webextensionstoretype/
---
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| SPCatalog | 0 | 指定存储类型为 SharePoint 企业目录。 |
| OMEX | 1 | 指定存储类型为 Office.com。 |
| SPApp | 2 | 指定存储类型为 SharePoint Web 应用程序。 |
| Exchange | 3 | 指定存储类型为 Exchange 服务器。 |
| FileSystem | 4 | 指定存储类型为文件系统共享。 |
| Registry | 5 | 指定存储类型为系统注册表。 |
| ExCatalog | 6 | 指定存储类型为通过 Exchange 的集中部署。 |
| Default | n/a | 默认值。 |
