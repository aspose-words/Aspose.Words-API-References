...
description: "Aspose::Words::WebExtensions::WebExtensionPropertyCollection 类。指定一组 Web 扩展自定义属性。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.webextensions/webextensionpropertycollection/
---
## WebExtensionPropertyCollection class


指定一组 Web 扩展的自定义属性。了解更多，请访问 [Work with Office Add-ins](https://docs.aspose.com/words/cpp/work-with-office-add-ins/) 文档文章。
