...
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Version method. 表示创建文档的应用程序的版本号，使用 C++。"
type: docs
weight: 32000
url: /zh/cpp/aspose.words.properties/builtindocumentproperties/get_version/
---
...
当文档由 Microsoft Word 创建时，高 16 位表示主版本号，低 16 位表示构建号。
