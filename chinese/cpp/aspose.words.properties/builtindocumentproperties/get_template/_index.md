---
title: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Template 方法"
linktitle: "get_Template"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Properties::BuiltInDocumentProperties::get_Template 方法。获取或设置文档模板的说明性名称，在 C++ 中。"
type: docs
weight: 27000
url: /zh/cpp/aspose.words.properties/builtindocumentproperties/get_template/
---
...
在 Microsoft Word 中，此属性仅用于提供信息，通常只包含模板的文件名而不包括路径。

空字符串表示文档附加的是 Normal 模板。

要获取或设置附加模板的实际名称，请使用 [AttachedTemplate](../../../aspose.words/document/get_attachedtemplate/) 属性。
