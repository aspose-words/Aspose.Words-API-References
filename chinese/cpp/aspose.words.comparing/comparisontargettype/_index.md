---
title: "Aspose::Words::Comparing::ComparisonTargetType 枚举"
linktitle: "ComparisonTargetType"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Comparing::ComparisonTargetType 枚举。允许指定在比较期间使用的基准文档。默认值在 C++ 中为 Current。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.comparing/comparisontargettype/
---
## ComparisonTargetType enum


允许指定在比较期间使用的基准文档。默认值为 [Current](./)。
