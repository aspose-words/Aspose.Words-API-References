---
title: "Aspose::Words::Drawing::GlowFormat::get_Radius 方法"
linktitle: "get_Radius"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GlowFormat::get_Radius 方法。获取或设置一个 double 值，表示辉光效果半径的长度（单位为点 (pt)）。在 C++ 中默认值为 0.0。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing/glowformat/get_radius/
---
## GlowFormat::get_Radius method


获取或设置一个 double 值，表示发光效果半径的长度（单位为点 (pt)）。默认值为 0.0。
