---
title: "Aspose::Words::Drawing::Fill::get_BackThemeColor 方法"
linktitle: "get_BackThemeColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::Fill::get_BackThemeColor 方法。获取或设置一个 ThemeColor 对象，表示填充的背景颜色（在 C++ 中）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing/fill/get_backthemecolor/
---
## Fill::get_BackThemeColor method


获取或设置表示填充背景颜色的 ThemeColor 对象。
