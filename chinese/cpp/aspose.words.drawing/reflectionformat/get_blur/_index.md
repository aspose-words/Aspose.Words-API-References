---
title: "Aspose::Words::Drawing::ReflectionFormat::get_Blur 方法"
linktitle: "get_Blur"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ReflectionFormat::get_Blur 方法。获取或设置一个 double 值，指定以点为单位应用于反射效果的模糊程度。默认值在 C++ 中为 0.0。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing/reflectionformat/get_blur/
---
## ReflectionFormat::get_Blur method


获取或设置一个 double 值，指定以点为单位应用于反射效果的模糊程度。默认值为 0.0。
