---
title: "Aspose::Words::Drawing::TextBox::get_Next 方法"
linktitle: "get_Next"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::TextBox::get_Next 方法。返回或设置一个 TextBox，表示形状序列中的下一个 TextBox（C++）。"
type: docs
weight: 9000
url: /zh/cpp/aspose.words.drawing/textbox/get_next/
---
## TextBox::get_Next method


返回或设置一个 [TextBox](../)，它表示形状序列中的下一个 [TextBox](../)。
...
if (textBox3->get_Next() == nullptr && textBox3->get_Previous() != nullptr)
{
    ...
    // 断开 textBox2 与 textBox3 之间的前向链接，然后验证它们不再链接。
