---
title: "Aspose::Words::Drawing::TextBox::get_Previous 方法"
linktitle: "get_Previous"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::TextBox::get_Previous 方法。返回一个 TextBox，表示形状序列中前一个 TextBox（在 C++ 中）。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words.drawing/textbox/get_previous/
---
## TextBox::get_Previous method


返回一个 [TextBox](../)，它表示形状序列中前一个 [TextBox](../)。
