---
title: "Aspose::Words::Drawing::OleFormat::get_AutoUpdate 方法"
linktitle: "get_AutoUpdate"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::get_AutoUpdate 方法。指定在 Microsoft Word 中链接到 OLE 对象是否自动更新（在 C++ 中）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing/oleformat/get_autoupdate/
---
## OleFormat::get_AutoUpdate method


指定在 Microsoft Word 中是否自动更新指向 OLE 对象的链接。
