---
title: "Aspose::Words::Drawing::OleFormat::get_SuggestedExtension 方法"
linktitle: "get_SuggestedExtension"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::get_SuggestedExtension 方法。获取当前嵌入对象的建议文件扩展名，如果您想在 C++ 中将其保存为文件。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words.drawing/oleformat/get_suggestedextension/
---
## OleFormat::get_SuggestedExtension method


获取当前嵌入对象的建议文件扩展名（如果您想将其保存为文件）。
