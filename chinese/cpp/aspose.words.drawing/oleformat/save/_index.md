---
title: "Aspose::Words::Drawing::OleFormat::Save 方法"
linktitle: "保存"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::Save 方法。将嵌入对象的数据保存到 C++ 中指定的流。"
type: docs
weight: 19000
url: /zh/cpp/aspose.words.drawing/oleformat/save/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 流 | const System::SharedPtr\<System::IO::Stream\>\& | 对象数据的保存位置。 |
## 备注
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| 文件名 | const System::String\& | 用于保存 OLE 对象数据的文件名。 |
