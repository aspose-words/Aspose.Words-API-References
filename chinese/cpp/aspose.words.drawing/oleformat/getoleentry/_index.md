---
title: "Aspose::Words::Drawing::OleFormat::GetOleEntry 方法"
linktitle: "GetOleEntry"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::GetOleEntry 方法。获取 OLE 对象的数据条目（在 C++ 中）。"
type: docs
weight: 15000
url: /zh/cpp/aspose.words.drawing/oleformat/getoleentry/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| oleEntryName | const System::String\& | OLE 数据流的区分大小写名称。 |
