---
title: "Aspose::Words::Drawing::OleFormat::get_IsLink 方法"
linktitle: "get_IsLink"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::get_IsLink 方法。返回 true，如果 OLE 对象已链接（当指定 SourceFullName 时）在 C++ 中。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.drawing/oleformat/get_islink/
---
## OleFormat::get_IsLink method


如果 OLE 对象已链接（当指定 [SourceFullName](../get_sourcefullname/) 时），返回 **true**。
