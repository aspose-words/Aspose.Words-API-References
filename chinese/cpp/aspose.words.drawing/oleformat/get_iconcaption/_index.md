---
title: "Aspose::Words::Drawing::OleFormat::get_IconCaption 方法"
linktitle: "get_IconCaption"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::OleFormat::get_IconCaption 方法。获取 OLE 对象的图标标题。如果 OLE 对象没有图标或无法检索标题，则在 C++ 中返回空字符串。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing/oleformat/get_iconcaption/
---
## OleFormat::get_IconCaption method


获取 OLE 对象的图标标题。如果 OLE 对象没有图标或无法检索标题，则返回空字符串。
