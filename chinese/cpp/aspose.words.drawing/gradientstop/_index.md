---
title: "Aspose::Words::Drawing::GradientStop 类"
linktitle: "GradientStop"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStop 类。表示一个渐变停止点。要了解更多，请访问 C++ 文档文章。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing/gradientstop/
---
## GradientStop class


表示一个渐变停止点。要了解更多信息，请访问 [Working with Graphic Elements](https://docs.aspose.com/words/cpp/working-with-graphic-elements/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [get_BaseColor](./get_basecolor/)() | 获取一个值，表示渐变停止点的颜色（不含任何修饰）。 |
| [get_Color](./get_color/)() | 获取或设置一个值，表示渐变停止点的颜色。 |
| [get_Position](./get_position/)() const | 获取或设置一个值，表示渐变中停止点的位置，以 0.0 到 1.0 范围内的百分比表示。 |
| [get_Transparency](./get_transparency/)() const | 获取或设置一个值，表示渐变填充的透明度，以 0.0 到 1.0 范围内的百分比表示。 |
| [GetType](./gettype/)() const override |  |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double) | 初始化 [GradientStop](./) 类的新实例。 |
| [GradientStop](./gradientstop/)(System::Drawing::Color, double, double) | 初始化 [GradientStop](./) 类的新实例。 |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Remove](./remove/)() | 从父级 [GradientStopCollection](../gradientstopcollection/) 中移除渐变停止点。 |
| [set_Color](./set_color/)(System::Drawing::Color) | 用于 [Aspose::Words::Drawing::GradientStop::get_Color](./get_color/) 的设置器。 |
| [set_Position](./set_position/)(double) | 用于 [Aspose::Words::Drawing::GradientStop::get_Position](./get_position/) 的设置器。 |
| [set_Transparency](./set_transparency/)(double) | 用于 [Aspose::Words::Drawing::GradientStop::get_Transparency](./get_transparency/) 的设置器。 |
| static [Type](./type/)() |  |
