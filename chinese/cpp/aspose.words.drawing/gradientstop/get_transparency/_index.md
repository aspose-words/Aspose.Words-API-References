---
title: "Aspose::Words::Drawing::GradientStop::get_Transparency 方法"
linktitle: "get_Transparency"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStop::get_Transparency 方法。获取或设置一个值，表示渐变填充的透明度，以百分比形式表示，范围为 0.0 到 1.0（C++ 中）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.drawing/gradientstop/get_transparency/
---
## GradientStop::get_Transparency method


获取或设置一个值，表示渐变填充的透明度，以 0.0 到 1.0 范围内的百分比表示。
