---
title: "Aspose::Words::Drawing::GradientStop::get_BaseColor 方法"
linktitle: "get_BaseColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStop::get_BaseColor 方法。获取一个表示渐变停止点颜色的值，该值不包含任何修饰符（C++）。"
type: docs
weight: 2500
url: /zh/cpp/aspose.words.drawing/gradientstop/get_basecolor/
---
## GradientStop::get_BaseColor method


获取一个值，表示渐变停止点的颜色（不含任何修饰）。
