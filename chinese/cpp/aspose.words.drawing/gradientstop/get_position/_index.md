---
title: "Aspose::Words::Drawing::GradientStop::get_Position 方法"
linktitle: "get_Position"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStop::get_Position 方法。获取或设置一个值，表示渐变中停止点的位置，以 0.0 到 1.0 范围内的百分比表示（C++）。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing/gradientstop/get_position/
---
## GradientStop::get_Position method


获取或设置一个值，表示渐变中停止点的位置，以 0.0 到 1.0 范围内的百分比表示。
