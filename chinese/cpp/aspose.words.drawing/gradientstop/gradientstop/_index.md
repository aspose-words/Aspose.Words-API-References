---
title: "Aspose::Words::Drawing::GradientStop::GradientStop 构造函数"
linktitle: "GradientStop"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStop::GradientStop 构造函数。初始化 GradientStop 类的新实例（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing/gradientstop/gradientstop/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| color | System::Drawing::Color | 表示渐变停止点的颜色。 |
| 位置 | double | 表示渐变中停止点的位置，以 0.0 到 1.0 范围内的百分比表示。 |
...
| color | System::Drawing::Color | 表示渐变停止点的颜色。 |
| 位置 | double | 表示渐变中停止点的位置，以 0.0 到 1.0 范围内的百分比表示。 |
| 透明度 | double | 表示渐变中停止点的透明度，以 0.0 到 1.0 范围内的百分比表示。 |
