---
title: "Aspose::Words::Drawing::SignatureLine::get_AllowComments 方法"
linktitle: "get_AllowComments"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::SignatureLine::get_AllowComments 方法。获取或设置一个值，指示签署人在签名对话框中是否可以添加评论。此属性在 C++ 中的默认值为 false。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words.drawing/signatureline/get_allowcomments/
---
## SignatureLine::get_AllowComments method


获取或设置一个值，指示签署人在签名对话框中是否可以添加评论。此属性的默认值为 **false**。
