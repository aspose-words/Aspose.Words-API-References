---
title: "Aspose::Words::Drawing::SignatureLine::get_Signer 方法"
linktitle: "get_Signer"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::SignatureLine::get_Signer 方法。获取或设置签名行的建议签署人。此属性在 C++ 中的默认值为空字符串。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.drawing/signatureline/get_signer/
---
## SignatureLine::get_Signer method


获取或设置签名行的建议签署人。此属性的默认值为 **empty string**。
