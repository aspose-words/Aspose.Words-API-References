---
title: "Aspose::Words::Drawing::SignatureLine::get_DefaultInstructions 方法"
linktitle: "get_DefaultInstructions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::SignatureLine::get_DefaultInstructions 方法。获取或设置一个值，指示在签名对话框中是否显示默认说明。此属性在 C++ 中的默认值为 true。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.drawing/signatureline/get_defaultinstructions/
---
## SignatureLine::get_DefaultInstructions method


获取或设置一个值，指示在签名对话框中是否显示默认说明。此属性的默认值为 **true**。
