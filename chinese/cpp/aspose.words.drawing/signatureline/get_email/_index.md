---
title: "Aspose::Words::Drawing::SignatureLine::get_Email 方法"
linktitle: "get_Email"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::SignatureLine::get_Email 方法。获取或设置建议签署人的电子邮件地址。此属性在 C++ 中的默认值为空字符串。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing/signatureline/get_email/
---
## SignatureLine::get_Email method


获取或设置建议的签署人电子邮件地址。此属性的默认值为 **empty string**。
