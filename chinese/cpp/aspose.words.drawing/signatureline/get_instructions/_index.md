---
title: "Aspose::Words::Drawing::SignatureLine::get_Instructions 方法"
linktitle: "get_Instructions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::SignatureLine::get_Instructions 方法。获取或设置在签署签名行时显示给签署人的说明。如果设置了 DefaultInstructions，则此属性将被忽略。此属性在 C++ 中的默认值为空字符串。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.drawing/signatureline/get_instructions/
---
## SignatureLine::get_Instructions method


获取或设置在签署签名行时显示给签署人的说明。如果设置了 [DefaultInstructions](../get_defaultinstructions/)，则此属性将被忽略。此属性的默认值为 **empty string**。
