---
title: "Aspose::Words::Drawing::ShapeBase::get_DistanceBottom 方法"
linktitle: "get_DistanceBottom"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ShapeBase::get_DistanceBottom 方法。返回或设置文档文本与形状底部边缘之间的距离（以点为单位），适用于 C++。"
type: docs
weight: 15000
url: /zh/cpp/aspose.words.drawing/shapebase/get_distancebottom/
---
## ShapeBase::get_DistanceBottom method


返回或设置文档文本与形状底部边缘之间的距离（单位为点）。
