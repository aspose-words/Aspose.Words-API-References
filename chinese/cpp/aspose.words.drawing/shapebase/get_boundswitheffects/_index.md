---
title: "Aspose::Words::Drawing::ShapeBase::get_BoundsWithEffects 方法"
linktitle: "get_BoundsWithEffects"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ShapeBase::get_BoundsWithEffects 方法。获取此形状对象在应用绘图效果后的最终范围。该值在 C++ 中以点为单位测量。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.drawing/shapebase/get_boundswitheffects/
---
## ShapeBase::get_BoundsWithEffects method


获取此形状对象在应用绘图效果后最终的范围。值以点为单位。
