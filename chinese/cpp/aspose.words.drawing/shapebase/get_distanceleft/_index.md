---
title: "Aspose::Words::Drawing::ShapeBase::get_DistanceLeft 方法"
linktitle: "get_DistanceLeft"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ShapeBase::get_DistanceLeft 方法。返回或设置文档文本与形状左边缘之间的距离（以点为单位），在 C++ 中。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.drawing/shapebase/get_distanceleft/
---
## ShapeBase::get_DistanceLeft method


返回或设置文档文本与形状左侧边缘之间的距离（单位为点）。
