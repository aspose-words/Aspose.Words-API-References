---
title: "Aspose::Words::Drawing::GradientStyle 枚举"
linktitle: "GradientStyle"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::GradientStyle 枚举。指定 C++ 中渐变填充的样式。"
type: docs
weight: 24000
url: /zh/cpp/aspose.words.drawing/gradientstyle/
---
## GradientStyle enum
...
| --- | --- | --- |
| None | -1 | 无渐变。 |
| Horizontal | 1 | 水平跨越对象的渐变。 |
| Vertical | 2 | 垂直向下跨越对象的渐变。 |
| DiagonalUp | 3 | 从底部角向对角上方移动的对角渐变。 |
| DiagonalDown | 4 | 从顶部角向对角下方移动的对角渐变。 |
| FromCorner | 5 | 渐变从一个角落延伸到其他三个角落。 |
| FromCenter | 6 | 渐变从中心向四个角落扩展。 |
