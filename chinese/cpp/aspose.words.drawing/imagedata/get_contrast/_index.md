---
title: "Aspose::Words::Drawing::ImageData::get_Contrast 方法"
linktitle: "get_Contrast"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ImageData::get_Contrast 方法。获取或设置指定图片的对比度。此属性的取值必须是 0.0（最低对比度）到 1.0（最高对比度）之间的数字，适用于 C++。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.drawing/imagedata/get_contrast/
---
## ImageData::get_Contrast method


获取或设置指定图片的对比度。此属性的值必须是 0.0（最低对比度）到 1.0（最高对比度）之间的数字。
