...
description: "Aspose::Words::Drawing::ImageData::get_Brightness 方法。获取或设置图片的亮度。此属性的值必须是 0.0（最暗）到 1.0（最亮）之间的数字（C++）。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.drawing/imagedata/get_brightness/
---
## ImageData::get_Brightness method


获取或设置图片的亮度。此属性的值必须是 0.0（最暗）到 1.0（最亮）之间的数字。
