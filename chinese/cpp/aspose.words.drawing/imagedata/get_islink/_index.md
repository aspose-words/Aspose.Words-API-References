---
title: "Aspose::Words::Drawing::ImageData::get_IsLink 方法"
linktitle: "get_IsLink"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Drawing::ImageData::get_IsLink 方法。若图像链接到形状（当指定 SourceFullName 时），则在 C++ 中返回 true。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words.drawing/imagedata/get_islink/
---
## ImageData::get_IsLink method


如果图像链接到形状（当指定 [SourceFullName](../get_sourcefullname/) 时），则返回 **true**。
