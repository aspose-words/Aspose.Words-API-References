---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add 方法"
linktitle: "Add"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Add 方法。 在 C++ 中向集合添加书签。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | const System::String\& | 要添加的书签的大小写不敏感名称。 |
| outlineLevel | int32_t | 书签的轮廓级别。有效范围为 0 到 9。 |
