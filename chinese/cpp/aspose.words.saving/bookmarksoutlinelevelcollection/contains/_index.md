---
title: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains 方法"
linktitle: "Contains"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::BookmarksOutlineLevelCollection::Contains 方法。确定集合中是否包含具有给定名称的书签（C++）。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.saving/bookmarksoutlinelevelcollection/contains/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | const System::String\& | 要定位的书签的大小写不敏感名称。 |
