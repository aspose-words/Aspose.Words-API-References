---
title: "Aspose::Words::Saving::DocSaveOptions::get_Password 方法"
linktitle: "get_Password"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::DocSaveOptions::get_Password 方法。获取/设置用于使用 RC4 加密方法加密文档的密码，在 C++ 中。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.saving/docsaveoptions/get_password/
---
## DocSaveOptions::get_Password method


获取/设置用于使用 RC4 加密方法加密文档的密码。
