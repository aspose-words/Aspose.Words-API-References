---
title: "Aspose::Words::Saving::PclSaveOptions 类"
linktitle: "PclSaveOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::PclSaveOptions 类。可用于在将文档保存为 Pcl 格式时指定其他选项。要了解更多信息，请访问 C++ 中的文档文章。"
type: docs
weight: 21000
url: /zh/cpp/aspose.words.saving/pclsaveoptions/
---
## PclSaveOptions class


可用于在将文档保存为 [Pcl](../../aspose.words/saveformat/) 格式时指定其他选项。要了解更多信息，请访问 [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [AddPrinterFont](./addprinterfont/)(const System::String\&, const System::String\&) | 添加由制造商上传到打印机的字体信息。 |
...
| [get_FallbackFontName](./get_fallbackfontname/)() const | 如果在打印机和内置字体集合中未找到预期的字体，将使用的字体名称。 |
...
| [get_RasterizeTransformedElements](./get_rasterizetransformedelements/)() const | 获取或设置一个值，以确定在保存为 PCL 文档之前是否应对复杂的变换元素进行光栅化。默认值为 **true**。 |
| [get_SaveFormat](./get_saveformat/)() override | 指定使用此保存选项对象时文档将保存的格式。只能是 [Pcl](../../aspose.words/saveformat/)。 |
...
| [set_FallbackFontName](./set_fallbackfontname/)(const System::String\&) | 用于设置 [Aspose::Words::Saving::PclSaveOptions::get_FallbackFontName](./get_fallbackfontname/) 的 setter。 |
...
| [set_RasterizeTransformedElements](./set_rasterizetransformedelements/)(bool) | 用于设置 [Aspose::Words::Saving::PclSaveOptions::get_RasterizeTransformedElements](./get_rasterizetransformedelements/) 的 setter。 |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | 用于设置 [Aspose::Words::Saving::PclSaveOptions::get_SaveFormat](./get_saveformat/) 的 setter。 |
