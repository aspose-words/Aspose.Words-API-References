---
title: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels 方法"
linktitle: "get_ExportListLabels"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::HtmlSaveOptions::get_ExportListLabels 方法。控制列表标签如何输出到 HTML、MHTML 或 EPUB。默认值在 C++ 中为 Auto。"
type: docs
weight: 21000
url: /zh/cpp/aspose.words.saving/htmlsaveoptions/get_exportlistlabels/
---
## HtmlSaveOptions::get_ExportListLabels method


控制列表标签如何输出到 HTML、MHTML 或 EPUB。默认值为 [Auto](../../exportlistlabels/)。
