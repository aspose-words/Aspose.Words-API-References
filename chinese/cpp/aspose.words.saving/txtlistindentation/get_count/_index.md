---
title: "Aspose::Words::Saving::TxtListIndentation::get_Count 方法"
linktitle: "get_Count"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::TxtListIndentation::get_Count 方法。获取或设置每个列表级别使用的字符数量作为缩进。默认值为 0，表示在 C++ 中没有缩进。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.saving/txtlistindentation/get_count/
---
## TxtListIndentation::get_Count method


获取或设置每个列表级别使用的 [Character](../get_character/) 数量作为缩进。默认值为 0，表示没有缩进。
