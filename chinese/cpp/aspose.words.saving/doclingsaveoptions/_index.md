---
title: "Aspose::Words::Saving::DoclingSaveOptions 类"
linktitle: "DoclingSaveOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::DoclingSaveOptions 类。可用于在将文档保存为 Docling 格式时指定附加选项。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 2750
url: /zh/cpp/aspose.words.saving/doclingsaveoptions/
---
## DoclingSaveOptions class


可用于在将文档保存为 [Docling](../../aspose.words/saveformat/) 格式时指定附加选项。要了解更多信息，请访问 [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) 文档文章。
...
| [get_RenderNonImageShapes](./get_rendernonimageshapes/)() const | 获取或设置一个值，指示是否应渲染非图像形状并将其写入输出的 Docling JSON 文档。 |
| [get_SaveFormat](./get_saveformat/)() override | 指定在使用此保存选项对象时文档将被保存的格式。只能是 [Docling](../../aspose.words/saveformat/)。 |
...
| [set_RenderNonImageShapes](./set_rendernonimageshapes/)(bool) | 用于 [Aspose::Words::Saving::DoclingSaveOptions::get_RenderNonImageShapes](./get_rendernonimageshapes/) 的设置器。 |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | 用于 [Aspose::Words::Saving::DoclingSaveOptions::get_SaveFormat](./get_saveformat/) 的设置器。 |
