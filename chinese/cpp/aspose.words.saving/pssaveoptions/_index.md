---
title: "Aspose::Words::Saving::PsSaveOptions 类"
linktitle: "PsSaveOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::PsSaveOptions 类。可用于在将文档保存为 Ps 格式时指定其他选项。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 26000
url: /zh/cpp/aspose.words.saving/pssaveoptions/
---
## PsSaveOptions class


可用于在将文档保存为 [Ps](../../aspose.words/saveformat/) 格式时指定其他选项。要了解更多信息，请访问 [指定保存选项](https://docs.aspose.com/words/cpp/specify-save-options/) 文档文章。
...
| [get_SaveFormat](./get_saveformat/)() override | 指定如果使用此保存选项对象，文档将被保存的格式。只能是 [Ps](../../aspose.words/saveformat/)。 |
...
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | 用于 [Aspose::Words::Saving::PsSaveOptions::get_SaveFormat](./get_saveformat/) 的 setter。 |
...
| [set_UseBookFoldPrintingSettings](./set_usebookfoldprintingsettings/)(bool) | 用于 [Aspose::Words::Saving::PsSaveOptions::get_UseBookFoldPrintingSettings](./get_usebookfoldprintingsettings/) 的 setter。 |
