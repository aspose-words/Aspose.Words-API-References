---
title: "Aspose::Words::Saving::HtmlMetafileFormat 枚举"
linktitle: "HtmlMetafileFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::HtmlMetafileFormat 枚举。指示在 C++ 中将元文件保存到 HTML 文档的格式。"
type: docs
weight: 60000
url: /zh/cpp/aspose.words.saving/htmlmetafileformat/
---
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Png | 0 | 元文件被渲染为栅格 PNG 图像。 |
| Svg | 1 | 元文件被转换为矢量 SVG 图像。 |
| EmfOrWmf | 2 | 元文件保持原样保存，不进行转换。 |
