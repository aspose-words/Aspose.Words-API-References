---
title: "Aspose::Words::Saving::XamlFlowSaveOptions 类"
linktitle: "XamlFlowSaveOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::XamlFlowSaveOptions 类。可用于在将文档保存为 XamlFlow 或 XamlFlowPack 格式时指定其他选项。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 37000
url: /zh/cpp/aspose.words.saving/xamlflowsaveoptions/
---
## XamlFlowSaveOptions class


可用于在将文档保存为 [XamlFlow](../../aspose.words/saveformat/) 或 [XamlFlowPack](../../aspose.words/saveformat/) 格式时指定其他选项。要了解更多信息，请访问 [Specify Save Options](https://docs.aspose.com/words/cpp/specify-save-options/) 文档文章。
...
| [get_ImageSavingCallback](./get_imagesavingcallback/)() const | 允许控制文档保存为 XAML 时图像的保存方式。 |
| [get_ImagesFolder](./get_imagesfolder/)() const | 指定在将文档导出为 XAML 格式时保存图像的物理文件夹。默认是空字符串。 |
| [get_ImagesFolderAlias](./get_imagesfolderalias/)() const | 指定用于构建写入 XAML 文档的图像 URI 的文件夹名称。默认是空字符串。 |
...
| [get_SaveFormat](./get_saveformat/)() override | 指定如果使用此保存选项对象，文档将保存的格式。只能是 [XamlFlow](../../aspose.words/saveformat/)。 |
...
| [set_ImageSavingCallback](./set_imagesavingcallback/)(const System::SharedPtr\<Aspose::Words::Saving::IImageSavingCallback\>\&) | 允许控制文档保存为 XAML 时图像的保存方式。 |
| [set_ImagesFolder](./set_imagesfolder/)(const System::String\&) | 用于设置 [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolder](./get_imagesfolder/) 的 setter。 |
| [set_ImagesFolderAlias](./set_imagesfolderalias/)(const System::String\&) | 用于设置 [Aspose::Words::Saving::XamlFlowSaveOptions::get_ImagesFolderAlias](./get_imagesfolderalias/) 的 setter。 |
...
| [set_ReplaceBackslashWithYenSign](./set_replacebackslashwithyensign/)(bool) | 用于设置 [Aspose::Words::Saving::XamlFlowSaveOptions::get_ReplaceBackslashWithYenSign](./get_replacebackslashwithyensign/) 的 setter。 |
| [set_SaveFormat](./set_saveformat/)(Aspose::Words::SaveFormat) override | 指定如果使用此保存选项对象，文档将保存的格式。只能是 [XamlFlow](../../aspose.words/saveformat/)。 |
...
| static [Type](./type/)() |  |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)() | 初始化此类的新实例，可用于以 [XamlFlow](../../aspose.words/saveformat/) 格式保存文档。 |
| [XamlFlowSaveOptions](./xamlflowsaveoptions/)(Aspose::Words::SaveFormat) | 初始化此类的新实例，可用于以 [XamlFlow](../../aspose.words/saveformat/) 或 [XamlFlowPack](../../aspose.words/saveformat/) 格式保存文档。 |
## 另见
