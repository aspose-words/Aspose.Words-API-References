---
title: "Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode 方法"
linktitle: "get_Zip64Mode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::OoxmlSaveOptions::get_Zip64Mode 方法。指定是否对输出文档使用 ZIP64 格式扩展。默认值在 C++ 中为 Never。"
type: docs
weight: 7500
url: /zh/cpp/aspose.words.saving/ooxmlsaveoptions/get_zip64mode/
---
## OoxmlSaveOptions::get_Zip64Mode method


指定是否对输出文档使用 ZIP64 格式扩展。默认值为 [Never](../../zip64mode/)。
