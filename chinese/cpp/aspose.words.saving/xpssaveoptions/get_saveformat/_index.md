---
title: "Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat 方法"
linktitle: "get_SaveFormat"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::XpsSaveOptions::get_SaveFormat 方法。指定在使用此保存选项对象时文档将被保存的格式。在 C++ 中只能是 Xps。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words.saving/xpssaveoptions/get_saveformat/
---
## XpsSaveOptions::get_SaveFormat method


指定如果使用此保存选项对象，文档将以何种格式保存。只能是 [Xps](../../../aspose.words/saveformat/)。
