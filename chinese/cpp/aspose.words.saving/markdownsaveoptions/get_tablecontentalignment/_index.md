---
title: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment 方法"
linktitle: "get_TableContentAlignment"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Saving::MarkdownSaveOptions::get_TableContentAlignment 方法。获取或设置一个值，指定在导出为 Markdown 格式时表格中内容的对齐方式。默认值在 C++ 中为 Auto。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words.saving/markdownsaveoptions/get_tablecontentalignment/
---
## MarkdownSaveOptions::get_TableContentAlignment method


获取或设置一个值，指定在导出为 [Markdown](../../../aspose.words/saveformat/) 格式时表格中内容的对齐方式。默认值为 [Auto](../../tablecontentalignment/)。
