---
title: "Aspose::Words::Run::Run 构造函数"
linktitle: "运行"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Run::Run 构造函数。 在 C++ 中初始化 Run 类的新实例。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words/run/run/
---
...
当创建 [Run](../) 时，它属于指定的文档，但尚未成为文档的一部分，并且 [ParentNode](../../node/get_parentnode/) 为 **null**。

要将 [Run](../) 追加到文档中，请在希望插入运行的段落上使用 [InsertAfter1()</see> 或 <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../)。
