---
title: "Aspose::Words::EditableRangeStart 类"
linktitle: "EditableRangeStart"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::EditableRangeStart 类。表示 Word 文档中可编辑范围的起始位置。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 26000
url: /zh/cpp/aspose.words/editablerangestart/
---
## EditableRangeStart class


表示 Word 文档中可编辑范围的开始。要了解更多信息，请访问 [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/) 文档文章。
...
| [get_EditableRange](./get_editablerange/)() | 获取封装此可编辑范围起始和结束的外观对象。 |
...
| [get_NodeType](./get_nodetype/)() const override | 返回 [EditableRangeStart](../nodetype/)。 |
...
| [set_Id](./set_id/)(int32_t) | 用于 [Aspose::Words::EditableRangeStart::get_Id](./get_id/) 的设置器。 |
...
Word 文档中的完整可编辑范围由一个 [EditableRangeStart](./) 和一个具有相同 Id 的匹配的 [EditableRangeEnd](../editablerangeend/) 组成。
...
使用 [EditableRange](./get_editablerange/) 类作为"facade"，以将可编辑范围作为单个对象进行操作。
