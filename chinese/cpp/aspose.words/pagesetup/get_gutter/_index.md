---
title: "Aspose::Words::PageSetup::get_Gutter 方法"
linktitle: "get_Gutter"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::PageSetup::get_Gutter 方法。获取或设置在 C++ 中为文档装订在页边距上添加的额外空间量。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words/pagesetup/get_gutter/
---
## PageSetup::get_Gutter method


获取或设置为文档装订在页边距中添加的额外空间量。
