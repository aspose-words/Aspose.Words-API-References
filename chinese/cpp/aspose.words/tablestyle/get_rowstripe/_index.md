---
title: "Aspose::Words::TableStyle::get_RowStripe 方法"
linktitle: "get_RowStripe"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::TableStyle::get_RowStripe 方法。获取或设置在 C++ 中当样式指定奇偶行分条时要包含在分条中的行数。"
type: docs
weight: 13000
url: /zh/cpp/aspose.words/tablestyle/get_rowstripe/
---
## TableStyle::get_RowStripe method


获取或设置在样式指定奇偶行分带时要包含的行数。
