---
title: "Aspose::Words::DocumentBuilder::StartColumnBookmark 方法"
linktitle: "StartColumnBookmark"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DocumentBuilder::StartColumnBookmark 方法。将文档中的当前位置标记为列书签的起始位置。该位置必须位于 C++ 中的表格单元格内。"
type: docs
weight: 69000
url: /zh/cpp/aspose.words/documentbuilder/startcolumnbookmark/
---
## DocumentBuilder::StartColumnBookmark method


将文档中当前位置标记为列书签起始位置。该位置必须位于表格单元格中。
...
插入的 [BookmarkStart](../../bookmarkstart/) 节点的实际位置可能与当前文档生成器的位置不同。
