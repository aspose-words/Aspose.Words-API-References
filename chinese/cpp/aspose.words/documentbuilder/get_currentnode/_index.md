---
title: "Aspose::Words::DocumentBuilder::get_CurrentNode 方法"
linktitle: "get_CurrentNode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DocumentBuilder::get_CurrentNode 方法。获取当前在此 DocumentBuilder 中选中的节点（C++）。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words/documentbuilder/get_currentnode/
---
## DocumentBuilder::get_CurrentNode method


获取当前在此 [DocumentBuilder](../) 中选中的节点。
...
当当前段落为空或光标位于段落或结构化文档标签的结束前时，[CurrentNode](./) 返回 **null**。
