---
title: "Aspose::Words::DocumentBuilder::StartEditableRange 方法"
linktitle: "StartEditableRange"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DocumentBuilder::StartEditableRange 方法。将文档中当前的位置标记为可编辑范围的起始点，使用 C++。"
type: docs
weight: 70000
url: /zh/cpp/aspose.words/documentbuilder/starteditablerange/
---
## DocumentBuilder::StartEditableRange method


将文档中当前位置标记为可编辑范围的起始位置。
...
文档中的可编辑范围可以重叠并跨越任意范围。要创建有效的可编辑范围，需要同时调用 [StartEditableRange](./) 和 [EndEditableRange](../endeditablerange/) 或 [EndEditableRange()](../) 方法。
