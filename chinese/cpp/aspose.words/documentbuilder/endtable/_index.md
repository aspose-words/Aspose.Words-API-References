...
description: "Aspose::Words::DocumentBuilder::EndTable 方法。 在 C++ 中结束文档中的表格。"
type: docs
weight: 8000
url: /zh/cpp/aspose.words/documentbuilder/endtable/
---
...
此方法应仅在调用了 [EndRow](../endrow/) 之后调用一次。调用时，[EndTable](./) 将光标从当前单元格移出，指向表格之后。
