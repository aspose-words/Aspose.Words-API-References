---
title: "Aspose::Words::DocumentBuilder::StartTable 方法"
linktitle: "StartTable"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::DocumentBuilder::StartTable 方法。在 C++ 中在文档中启动表格。"
type: docs
weight: 71000
url: /zh/cpp/aspose.words/documentbuilder/starttable/
---
...
接下来要调用的方法是 [InsertCell](../insertcell/)。

在单元格内部调用时，此方法会启动嵌套表格。
