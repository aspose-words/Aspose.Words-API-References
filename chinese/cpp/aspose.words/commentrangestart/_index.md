---
title: "Aspose::Words::CommentRangeStart 类"
linktitle: "CommentRangeStart"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::CommentRangeStart 类。表示具有关联评论的文本区域的起始位置。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words/commentrangestart/
---
## CommentRangeStart class


表示与评论关联的文本区域的开始。要了解更多信息，请访问 [Working with Comments](https://docs.aspose.com/words/cpp/working-with-comments/) 文档文章。
...
| [CommentRangeStart](./commentrangestart/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, int32_t) | 初始化此类的新实例。 |
...
| [get_NodeType](./get_nodetype/)() const override | 返回 [CommentRangeStart](../nodetype/)。 |
...
要创建锚定到文本区域的评论，您需要创建一个 [Comment](../comment/)，然后创建 [CommentRangeStart](./) 和 [CommentRangeEnd](../commentrangeend/)，并将它们的标识符设置为相同的 [Id](../comment/get_id/) 值。
