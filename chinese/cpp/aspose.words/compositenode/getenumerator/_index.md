---
title: "Aspose::Words::CompositeNode::GetEnumerator 方法"
linktitle: "GetEnumerator"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::CompositeNode::GetEnumerator 方法。提供对该节点子节点进行 foreach 风格迭代的支持（在 C++ 中）。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words/compositenode/getenumerator/
---
## CompositeNode::GetEnumerator method


提供对该节点的子节点进行 foreach 样式迭代的支持。
