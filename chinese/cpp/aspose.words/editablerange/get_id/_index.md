---
title: "Aspose::Words::EditableRange::get_Id 方法"
linktitle: "get_Id"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::EditableRange::get_Id 方法。获取可编辑范围的标识符（在 C++ 中）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words/editablerange/get_id/
---
...
该区域必须使用 [EditableRangeStart](../get_editablerangestart/) 和 [EditableRangeEnd](../get_editablerangeend/) 标记。

可编辑范围标识符应在整个文档中唯一，Aspose.Words 在加载、保存和合并文档时会自动维护这些标识符。
