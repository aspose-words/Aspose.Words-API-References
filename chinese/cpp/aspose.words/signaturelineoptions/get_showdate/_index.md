---
title: "Aspose::Words::SignatureLineOptions::get_ShowDate 方法"
linktitle: "get_ShowDate"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::SignatureLineOptions::get_ShowDate 方法。获取或设置一个值，指示在签名行中显示签署日期。此属性的默认值在 C++ 中为 true。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words/signaturelineoptions/get_showdate/
---
## SignatureLineOptions::get_ShowDate method


获取或设置一个值，指示签名行中是否显示签署日期。此属性的默认值为 **true**。
