---
title: "Aspose::Words::SignatureLineOptions::get_Instructions 方法"
linktitle: "get_Instructions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::SignatureLineOptions::get_Instructions 方法。获取或设置在签署签名行时显示给签署人的指示。此属性的默认值在 C++ 中为空字符串。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/signaturelineoptions/get_instructions/
---
## SignatureLineOptions::get_Instructions method


获取或设置在签署签名行时显示给签署人的说明。此属性的默认值为 **empty string**。
