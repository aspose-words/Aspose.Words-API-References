---
title: "Aspose::Words::PageExtractOptions::get_UnlinkPagesNumberFields 方法"
linktitle: "get_UnlinkPagesNumberFields"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::PageExtractOptions::get_UnlinkPagesNumberFields 方法。 指定在生成的文档中，NUMPAGES 字段是否会被其实际的结果值替换。 默认值在 C++ 中为 true。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words/pageextractoptions/get_unlinkpagesnumberfields/
---
## PageExtractOptions::get_UnlinkPagesNumberFields method


指定结果文档中的 NUMPAGES 字段是否会被其实际结果值替换。默认值为 **true**。
