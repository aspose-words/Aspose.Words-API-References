---
title: "Aspose::Words::Node::PreviousPreOrder 方法"
linktitle: "PreviousPreOrder"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Node::PreviousPreOrder 方法。根据前序树遍历算法在 C++ 中获取前一个节点。"
type: docs
weight: 19000
url: /zh/cpp/aspose.words/node/previouspreorder/
---
...
前序顺序中的前一个节点。如果已到达 *rootNode*，则为 Null。
