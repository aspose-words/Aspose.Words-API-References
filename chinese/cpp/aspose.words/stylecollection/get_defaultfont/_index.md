...
description: "Aspose::Words::StyleCollection::get_DefaultFont method. 在 C++ 中获取文档的默认文本格式。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/stylecollection/get_defaultfont/
---
...
请注意，文档范围的默认设置是在 Microsoft Word 2007 中引入的，仅在 OOXML 格式（[Docx](../../loadformat/)）中得到完整支持。早期的文档格式对该功能的支持有限，仅能存储字体名称。
