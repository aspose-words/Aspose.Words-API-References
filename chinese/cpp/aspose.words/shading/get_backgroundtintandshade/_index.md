---
title: "Aspose::Words::Shading::get_BackgroundTintAndShade 方法"
linktitle: "get_BackgroundTintAndShade"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Shading::get_BackgroundTintAndShade 方法。获取或设置一个双精度值，以在 C++ 中调亮或调暗背景主题颜色。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/shading/get_backgroundtintandshade/
---
## Shading::get_BackgroundTintAndShade method


获取或设置用于调亮或调暗背景主题颜色的 double 值。
