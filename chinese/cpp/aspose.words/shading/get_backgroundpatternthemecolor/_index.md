---
title: "Aspose::Words::Shading::get_BackgroundPatternThemeColor 方法"
linktitle: "get_BackgroundPatternThemeColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Shading::get_BackgroundPatternThemeColor 方法。获取或设置与此 Shading 对象关联的已应用配色方案中的背景图案主题颜色（在 C++ 中）。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words/shading/get_backgroundpatternthemecolor/
---
## Shading::get_BackgroundPatternThemeColor method


获取或设置与此 [Shading](../) 对象关联的已应用配色方案中的背景图案主题颜色。
