---
title: "Aspose::Words::Bookmark::get_LastColumn 方法"
linktitle: "get_LastColumn"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Bookmark::get_LastColumn 方法。获取与书签关联的表列范围中最后一列的零基索引（C++）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/bookmark/get_lastcolumn/
---
## Bookmark::get_LastColumn method


获取与书签关联的表列范围的最后一列的零基索引。
