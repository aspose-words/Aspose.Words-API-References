---
title: "Aspose::Words::ConditionalStyleCollection::idx_get 方法"
linktitle: "idx_get"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ConditionalStyleCollection::idx_get 方法。检索 C++ 中按条件样式类型获取 ConditionalStyle 对象。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words/conditionalstylecollection/idx_get/
---
## ConditionalStyleCollection::idx_get(Aspose::Words::ConditionalStyleType) method


按条件样式类型检索一个 [ConditionalStyle](../../conditionalstyle/) 对象。
...
按索引检索一个 [ConditionalStyle](../../conditionalstyle/) 对象。
