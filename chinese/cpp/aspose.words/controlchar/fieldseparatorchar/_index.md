---
title: "Aspose::Words::ControlChar::FieldSeparatorChar 字段"
linktitle: "FieldSeparatorChar"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::FieldSeparatorChar 字段。字段分隔符字符用于将字段代码与字段值分开。在某些字段中是可选的。值：(char)20 在 C++ 中。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words/controlchar/fieldseparatorchar/
---
## FieldSeparatorChar field


字段分隔符字符用于分隔字段代码和字段值。某些字段中可选。值: (char)20。
