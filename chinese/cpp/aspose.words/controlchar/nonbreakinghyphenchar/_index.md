---
title: "Aspose::Words::ControlChar::NonBreakingHyphenChar 字段"
linktitle: "NonBreakingHyphenChar"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::NonBreakingHyphenChar 字段。Microsoft Word 中的不换行连字符是 (char)30（在 C++ 中）。"
type: docs
weight: 22000
url: /zh/cpp/aspose.words/controlchar/nonbreakinghyphenchar/
---
## NonBreakingHyphenChar field


Microsoft Word 中的不换行连字符是 (char)30。
...
Microsoft Word 中的不换行连字符并不对应 Unicode 字符 U+2011（不换行连字符），而是表示内部信息，告诉 Microsoft Word 显示连字符且不换行。

有用信息： [http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks](http://www.cs.tut.fi/~jkorpela/dashes.html#linebreaks)。
