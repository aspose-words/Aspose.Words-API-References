---
title: "Aspose::Words::ControlChar::CellChar 字段"
linktitle: "CellChar"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::CellChar 字段。表格单元格结束或表格行结束字符：(char)7 或 \\\"\\\\a\\\"（在 C++ 中）。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words/controlchar/cellchar/
---
## CellChar field


表格单元格结束或表格行结束字符: (char)7 或 "\a"。
