---
title: "Aspose::Words::ControlChar::CrLf 方法"
linktitle: "CrLf"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::CrLf 方法。回车加换行字符：\\\"\\\\x000d\\\\x000a\\\" 或 \\\"\\\\r\\\\n\\\"。在 Microsoft Word 文档中不以这种形式使用，但在 C++ 的文本文件中常用于段落换行。"
type: docs
weight: 4000
url: /zh/cpp/aspose.words/controlchar/crlf/
---
## ControlChar::CrLf method


回车后跟换行字符："\x000d\x000a" 或 "\r\n"。在 Microsoft Word 文档中并非如此使用，但在文本文件中常用于段落换行。
