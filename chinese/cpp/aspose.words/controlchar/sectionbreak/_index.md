...
description: "Aspose::Words::ControlChar::SectionBreak method. 章节结束字符: \"\\\\x000c\" 或 \"\\\\f\"。注意它在 C++ 中的值与 PageBreak 相同。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words/controlchar/sectionbreak/
---
## ControlChar::SectionBreak method


章节结束字符: "\\x000c" 或 "\\f"。注意它的值与 [PageBreak](../pagebreak/) 相同。
