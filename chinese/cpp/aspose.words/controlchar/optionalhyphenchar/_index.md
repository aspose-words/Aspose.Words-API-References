---
title: "Aspose::Words::ControlChar::OptionalHyphenChar 字段"
linktitle: "OptionalHyphenChar"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::OptionalHyphenChar 字段。Microsoft Word 中的可选连字符是 (char)31 在 C++ 中。"
type: docs
weight: 24000
url: /zh/cpp/aspose.words/controlchar/optionalhyphenchar/
---
...
Microsoft Word 中的可选连字符并不对应 Unicode 字符 U+00AD（软连字符）。相反，它插入内部信息，告诉 Word 一个可能的断字点。
