---
title: "Aspose::Words::ControlChar::Cell 方法"
linktitle: "单元格"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ControlChar::Cell 方法。表格单元格结束或表格行结束字符：\\\"\\\\x0007\\\" 或 \\\"\\\\a\\\"（在 C++ 中）。"
type: docs
weight: 1000
url: /zh/cpp/aspose.words/controlchar/cell/
---
## ControlChar::Cell method


表格单元格结束或表格行结束字符："\x0007" 或 "\a"。
