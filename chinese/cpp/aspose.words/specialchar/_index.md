---
title: "Aspose::Words::SpecialChar 类"
linktitle: "SpecialChar"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::SpecialChar 类。文档中特殊字符的基类。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 62000
url: /zh/cpp/aspose.words/specialchar/
---
## SpecialChar class


文档中特殊字符的基类。要了解更多，请访问 [Aspose.Words Document Object Model (DOM)](https://docs.aspose.com/words/cpp/aspose-words-document-object-model/) 文档文章。
...
| [get_NodeType](./get_nodetype/)() const override | 返回 [SpecialChar](../nodetype/)。 |
...
| [GetText](./gettext/)() override | 获取此节点表示的特殊字符。 |
...
Microsoft Word 文档可以包含多种特殊字符，这些字符代表字段、表单字段、形状、OLE 对象、脚注等。有关特殊字符列表，请参阅 [ControlChar](../controlchar/)。
