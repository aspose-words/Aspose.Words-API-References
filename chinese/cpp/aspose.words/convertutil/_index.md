...
description: "Aspose::Words::ConvertUtil class. 提供用于在各种计量单位之间转换的辅助函数。要了解更多信息，请访问 C++ 文档文章。"
type: docs
weight: 19000
url: /zh/cpp/aspose.words/convertutil/
---
## ConvertUtil class


提供在各种测量单位之间转换的辅助函数。要了解更多信息，请访问 [Convert Between Measurement Units](https://docs.aspose.com/words/cpp/convert-between-measurement-units/) 文档文章。
...
| static [InchToPoint](./inchtopoint/)(double) | 将英寸转换为点。 |
| static [MillimeterToPoint](./millimetertopoint/)(double) | 将毫米转换为点。 |
| static [PixelToNewDpi](./pixeltonewdpi/)(double, double, double) | 将像素从一种分辨率转换为另一种分辨率。 |
| static [PixelToPoint](./pixeltopoint/)(double) | 在 96 dpi 下将像素转换为点。 |
| static [PixelToPoint](./pixeltopoint/)(double, double) | 在指定的像素分辨率下将像素转换为点。 |
| static [PointToInch](./pointtoinch/)(double) | 将点转换为英寸。 |
| static [PointToPixel](./pointtopixel/)(double) | 在 96 dpi 下将点转换为像素。 |
| static [PointToPixel](./pointtopixel/)(double, double) | 在指定的像素分辨率下将点转换为像素。 |
