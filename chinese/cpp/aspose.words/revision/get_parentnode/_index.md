---
title: "Aspose::Words::Revision::get_ParentNode 方法"
linktitle: "get_ParentNode"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Revision::get_ParentNode 方法。获取此修订的直接父节点（所有者）。此属性适用于除 StyleDefinitionChange 之外的任何修订类型（在 C++ 中）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/revision/get_parentnode/
---
## Revision::get_ParentNode method


获取此修订的直接父节点（所有者）。此属性适用于除 [StyleDefinitionChange](../../revisiontype/) 之外的任何修订类型。
