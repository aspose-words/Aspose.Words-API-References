---
title: "Aspose::Words::Revision::get_ParentStyle 方法"
linktitle: "get_ParentStyle"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Revision::get_ParentStyle 方法。获取此修订的直接父样式（所有者）。此属性仅适用于 C++ 中的 StyleDefinitionChange 修订类型。"
type: docs
weight: 7000
url: /zh/cpp/aspose.words/revision/get_parentstyle/
---
## Revision::get_ParentStyle method


获取此修订的直接父样式（所有者）。此属性仅适用于 [StyleDefinitionChange](../../revisiontype/) 修订类型。
