---
title: "Aspose::Words::Document::get_HasMacros 方法"
linktitle: "get_HasMacros"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::get_HasMacros 方法。若文档在 C++ 中具有 VBA 项目（宏），则返回 true。"
type: docs
weight: 30000
url: /zh/cpp/aspose.words/document/get_hasmacros/
---
## Document::get_HasMacros method


如果文档具有 VBA 项目（宏），则返回 **true**。
