---
title: "Aspose::Words::Document::get_TrackRevisions 方法"
linktitle: "get_TrackRevisions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::get_TrackRevisions 方法。如果在 C++ 中使用 Microsoft Word 编辑此文档时跟踪更改，则为 True。"
type: docs
weight: 54000
url: /zh/cpp/aspose.words/document/get_trackrevisions/
---
## Document::get_TrackRevisions method


如果在 Microsoft Word 中编辑此文档时跟踪更改，则为 True。
...
设置此选项仅指示 Microsoft Word 是否打开或关闭跟踪更改。此属性对通过 Aspose.Words 以编程方式对文档所做的更改没有影响。

如果您希望在 [Aspose.Words](../../) 以编程方式对该文档进行更改时自动跟踪更改，请使用 [StartTrackRevisions()](../) 方法。
