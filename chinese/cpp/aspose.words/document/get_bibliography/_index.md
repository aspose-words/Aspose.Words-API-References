---
title: "Aspose::Words::Document::get_Bibliography 方法"
linktitle: "get_Bibliography"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::get_Bibliography 方法。获取表示文档中可用来源列表的 Bibliography 对象（在 C++ 中）。"
type: docs
weight: 14500
url: /zh/cpp/aspose.words/document/get_bibliography/
---
## Document::get_Bibliography method


获取表示文档中可用来源列表的 [Bibliography](./) 对象。
