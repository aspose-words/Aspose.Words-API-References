---
title: "Aspose::Words::Document::get_Revisions 方法"
linktitle: "get_Revisions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::get_Revisions 方法。获取此文档中在 C++ 中存在的修订（已跟踪的更改）集合。"
type: docs
weight: 46000
url: /zh/cpp/aspose.words/document/get_revisions/
---
## Document::get_Revisions method


获取此文档中存在的修订（已跟踪更改）集合。
