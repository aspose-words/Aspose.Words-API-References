---
title: "Aspose::Words::Document::get_CustomXmlParts 方法"
linktitle: "get_CustomXmlParts"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::get_CustomXmlParts 方法。获取或设置 Custom XML 数据存储部件的集合（C++）。"
type: docs
weight: 19000
url: /zh/cpp/aspose.words/document/get_customxmlparts/
---
## Document::get_CustomXmlParts method


获取或设置自定义 XML 数据存储部件的集合。
...
Aspose.Words 仅将 Custom XML 部件加载和保存到 OOXML 和 DOC 文档中。
