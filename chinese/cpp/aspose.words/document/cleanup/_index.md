---
title: "Aspose::Words::Document::Cleanup 方法"
linktitle: "Cleanup"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Document::Cleanup 方法。清理文档中未使用的样式和列表（C++）。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/document/cleanup/
---
...
// 结合内置样式，文档现在有八种样式。
// 当自定义样式应用于文档的某个部分时，它被视为“已使用”，
// 这意味着我们添加的四个样式目前是未使用的。
ASSERT_EQ(8, doc->get_Styles()->get_Count());

// 应用自定义字符样式，然后是自定义列表样式。这样会将这些样式标记为“已使用”。
...
根据给定的 [CleanupOptions](../../cleanupoptions/) 清理文档中未使用的样式和列表。
