...
description: "Aspose::Words::Paragraph::get_ListLabel 方法。获取一个 ListLabel 对象，提供对该段落的列表编号值和格式的访问，使用 C++。"
type: docs
weight: 19000
url: /zh/cpp/aspose.words/paragraph/get_listlabel/
---
## Paragraph::get_ListLabel method


获取一个 [ListLabel](./) 对象，提供对该段落的列表编号值和格式的访问。
