...
description: "Aspose::Words::Paragraph::get_IsListItem 方法。当段落在原始修订中是项目符号或编号列表的项时返回 true（C++）。"
type: docs
weight: 15000
url: /zh/cpp/aspose.words/paragraph/get_islistitem/
---
## Paragraph::get_IsListItem method


当段落在原始修订中是项目符号或编号列表的项时，为 True。
