...
description: "Aspose::Words::Paragraph::Paragraph 构造函数。初始化 Paragraph 类的一个新实例，使用 C++。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words/paragraph/paragraph/
---
## Paragraph::Paragraph constructor


初始化 [Paragraph](../) 类的一个新实例。
...
当创建 [Paragraph](../) 时，它属于指定的文档，但尚未成为文档的一部分，并且 [ParentNode](../../node/get_parentnode/) 为 **null**。

要将 [Paragraph](../) 追加到文档，请在希望插入段落的故事上使用 [InsertAfter1()</see> or <see cref=\"Aspose::Words::CompositeNode::InsertBefore</tt>1(System::SharedPtr<<tt>0\\>, System::SharedPtr\\<Aspose::Words::Node\\>)\">InsertBefore1()](../)。
