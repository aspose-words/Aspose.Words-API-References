...
description: "Aspose::Words::Paragraph::get_IsMoveToRevision 方法。若在启用更改跟踪的 Microsoft Word 中此对象被移动（插入），则返回 true，使用 C++。"
type: docs
weight: 17000
url: /zh/cpp/aspose.words/paragraph/get_ismovetorevision/
---
