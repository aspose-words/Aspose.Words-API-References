---
title: "Aspose::Words::Body::Body 构造函数"
linktitle: "Body"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Body::Body 构造函数。初始化 Body 类在 C++ 中的新实例。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words/body/body/
---
...
当创建 [Body](../) 时，它属于指定的文档，但尚未成为文档的一部分，并且 [ParentNode](../../node/get_parentnode/) 为 **null**。

要将 [Body](../) 附加到 [Section](../../section/)，请使用 [AppendChild](../)、[InsertAfter](../) 或 [InsertBefore](../) 方法。
