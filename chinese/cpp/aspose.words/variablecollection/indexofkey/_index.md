---
title: "Aspose::Words::VariableCollection::IndexOfKey 方法"
linktitle: "IndexOfKey"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::VariableCollection::IndexOfKey 方法。返回集合中指定文档变量的零基索引（C++）。"
type: docs
weight: 14000
url: /zh/cpp/aspose.words/variablecollection/indexofkey/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | const System::String\& | 变量的不区分大小写的名称。 |
