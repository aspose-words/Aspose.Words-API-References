---
title: "Aspose::Words::VariableCollection::idx_get 方法"
linktitle: "idx_get"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::VariableCollection::idx_get 方法。通过不区分大小写的名称获取或设置文档变量。赋值右侧不允许为 null 值，null 将在 C++ 中被替换为空字符串。"
type: docs
weight: 12000
url: /zh/cpp/aspose.words/variablecollection/idx_get/
---
## VariableCollection::idx_get(const System::String\&) method


获取或设置文档变量，使用不区分大小写的名称。**null** 值不允许作为赋值的右侧，将被替换为空字符串。
...
获取或设置指定索引处的文档变量。**null** 值不允许作为赋值的右侧，将被替换为空字符串。
