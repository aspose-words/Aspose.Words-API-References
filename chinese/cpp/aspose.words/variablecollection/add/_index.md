---
title: "Aspose::Words::VariableCollection::Add 方法"
linktitle: "Add"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::VariableCollection::Add 方法。向集合中添加文档变量（C++）。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words/variablecollection/add/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| name | const System::String\& | 要添加的变量的名称（不区分大小写）。 |
| value | const System::String\& | 变量的值。该值不能为 **null**，如果值为 null 将使用空字符串代替。 |
