---
title: "Aspose::Words::TextColumnCollection::get_EvenlySpaced 方法"
linktitle: "get_EvenlySpaced"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::TextColumnCollection::get_EvenlySpaced 方法。如果文本列宽度相等且间距均匀，则返回 true（在 C++ 中）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words/textcolumncollection/get_evenlyspaced/
---
## TextColumnCollection::get_EvenlySpaced method


如果文本列宽度相等且间距均匀，则为 True。
