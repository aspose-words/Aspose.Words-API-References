---
title: "Aspose::Words::RevisionType 枚举"
linktitle: "RevisionType"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::RevisionType 枚举。指定在 C++ 中 Revision 所跟踪的更改类型。"
type: docs
weight: 113000
url: /zh/cpp/aspose.words/revisiontype/
---
## RevisionType enum


指定在 [Revision](../revision/) 中跟踪的更改类型。
...
| Deletion | 1 | 文档中的内容已被删除。 |
| FormatChange | 2 | 对父节点应用了格式更改。 |
| StyleDefinitionChange | 3 | 对父样式应用了格式更改。 |
| Moving | 4 | 文档中的内容已被移动。 |
