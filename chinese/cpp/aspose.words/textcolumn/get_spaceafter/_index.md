---
title: "Aspose::Words::TextColumn::get_SpaceAfter 方法"
linktitle: "get_SpaceAfter"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::TextColumn::get_SpaceAfter 方法。获取或设置此列与下一列之间的间距（单位：点）。在 C++ 中，最后一列不需要此设置。"
type: docs
weight: 2000
url: /zh/cpp/aspose.words/textcolumn/get_spaceafter/
---
## TextColumn::get_SpaceAfter method


获取或设置此列与下一列之间的间距（单位为点）。最后一列不需要此设置。
