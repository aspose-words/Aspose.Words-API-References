---
title: "Aspose::Words::ConditionalStyle::get_TopPadding 方法"
linktitle: "get_TopPadding"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ConditionalStyle::get_TopPadding 方法。获取或设置在 C++ 中在表格单元格内容上方添加的空间量（以点为单位）。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words/conditionalstyle/get_toppadding/
---
## ConditionalStyle::get_TopPadding method


获取或设置在表格单元格内容上方添加的空间量（以点为单位）。
