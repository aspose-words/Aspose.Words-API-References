---
title: "Aspose::Words::ConditionalStyle::get_Shading 方法"
linktitle: "get_Shading"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ConditionalStyle::get_Shading 方法。获取一个 Shading 对象，该对象引用此条件样式在 C++ 中的底纹格式。"
type: docs
weight: 10000
url: /zh/cpp/aspose.words/conditionalstyle/get_shading/
---
## ConditionalStyle::get_Shading method


获取一个指向此条件样式底纹格式的 [Shading](../../shading/) 对象。
