---
title: "Aspose::Words::Font::get_LocaleIdFarEast 方法"
linktitle: "get_LocaleIdFarEast"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Font::get_LocaleIdFarEast 方法。获取或设置 C++ 中已格式化的亚洲字符的区域标识符（语言）。"
type: docs
weight: 24000
url: /zh/cpp/aspose.words/font/get_localeidfareast/
---
## Font::get_LocaleIdFarEast method


获取或设置已格式化的亚洲字符的区域标识符（语言）。
