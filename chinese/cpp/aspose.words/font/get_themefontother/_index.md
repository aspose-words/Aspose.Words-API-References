---
title: "Aspose::Words::Font::get_ThemeFontOther 方法"
linktitle: "get_ThemeFontOther"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Font::get_ThemeFontOther 方法。获取或设置在 C++ 中与此 Font 对象关联的应用字体方案中，用于字符代码 128 到 255 的主题字体。"
type: docs
weight: 53000
url: /zh/cpp/aspose.words/font/get_themefontother/
---
## Font::get_ThemeFontOther method


获取或设置在与此 [Font](../) 对象关联的应用字体方案中，用于字符代码 128 到 255 的主题字体。
