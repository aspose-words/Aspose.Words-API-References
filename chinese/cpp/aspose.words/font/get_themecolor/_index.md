---
title: "Aspose::Words::Font::get_ThemeColor 方法"
linktitle: "get_ThemeColor"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Font::get_ThemeColor 方法。获取或设置与此 Font 对象关联的已应用配色方案中的主题颜色（C++）。"
type: docs
weight: 48000
url: /zh/cpp/aspose.words/font/get_themecolor/
---
## Font::get_ThemeColor method


获取或设置与此 [Font](../) 对象关联的已应用配色方案中的主题颜色。
