---
title: "Aspose::Words::Font::get_ThemeFontAscii 方法"
linktitle: "get_ThemeFontAscii"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Font::get_ThemeFontAscii 方法。获取或设置与此 Font 对象关联的已应用字体方案中用于拉丁文本（字符代码从 0（零）到 127）的主题字体（C++）。"
type: docs
weight: 50000
url: /zh/cpp/aspose.words/font/get_themefontascii/
---
## Font::get_ThemeFontAscii method


获取或设置与此 [Font](../) 对象关联的已应用字体方案中用于拉丁文本（字符代码从 0（零）到 127）的主题字体。
