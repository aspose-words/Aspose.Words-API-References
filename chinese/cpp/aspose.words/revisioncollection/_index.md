...
description: "Aspose::Words::RevisionCollection class。 一个 Revision 对象的集合，表示文档中的修订。欲了解更多，请访问 C++ 中的文档文章。"
type: docs
weight: 53000
url: /zh/cpp/aspose.words/revisioncollection/
---
## RevisionCollection class


一个 [Revision](../revision/) 对象的集合，表示文档中的修订。欲了解更多，请访问 [Track Changes in a Document](https://docs.aspose.com/words/cpp/track-changes-in-a-document/) 文档文章。
...
| 方法 | 描述 |
| --- | --- |
| [Accept](./accept/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | 接受符合指定条件的修订。 |
| [AcceptAll](./acceptall/)() | 接受此集合中的所有修订。 |
| [get_Count](./get_count/)() | 返回集合中修订的数量。 |
| [get_Groups](./get_groups/)() | 修订组的集合。 |
| [GetEnumerator](./getenumerator/)() override | 返回一个枚举器对象。 |
| [GetType](./gettype/)() const override |  |
| [idx_get](./idx_get/)(int32_t) | 在指定索引处返回一个 [Revision](../revision/)。 |
| [Is](./is/)(const System::TypeInfo\&) const override |  |
| [Reject](./reject/)(const System::SharedPtr\<Aspose::Words::IRevisionCriteria\>\&) | 拒绝符合指定条件的修订。 |
| [RejectAll](./rejectall/)() | 拒绝此集合中的所有修订。 |
| static [Type](./type/)() |  |
## 备注


您不能直接创建此类的实例。使用 [Revisions](../document/get_revisions/) 属性获取文档中存在的修订。
