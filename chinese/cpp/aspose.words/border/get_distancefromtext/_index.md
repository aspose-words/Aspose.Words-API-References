---
title: "Aspose::Words::Border::get_DistanceFromText 方法"
linktitle: "get_DistanceFromText"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Border::get_DistanceFromText 方法。获取或设置边框距文本或页面边缘的距离（单位为点），在 C++ 中。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words/border/get_distancefromtext/
---
## Border::get_DistanceFromText method


获取或设置边框距离文本或页面边缘的距离（单位：点）。
