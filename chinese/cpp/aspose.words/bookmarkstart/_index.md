---
title: "Aspose::Words::BookmarkStart 类"
linktitle: "BookmarkStart"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::BookmarkStart 类。表示 Word 文档中书签的起始位置。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words/bookmarkstart/
---
## BookmarkStart class


表示 Word 文档中书签的起始位置。欲了解更多，请访问[书签使用指南](https://docs.aspose.com/words/cpp/working-with-bookmarks/)文档文章。
...
| [BookmarkStart](./bookmarkstart/)(const System::SharedPtr\<Aspose::Words::DocumentBase\>\&, const System::String\&) | 初始化 [BookmarkStart](./) 类的新实例。 |
| [Clone](../node/clone/)(bool) | 创建节点的副本。 |
| [get_Bookmark](./get_bookmark/)() | 获取封装此书签起始和结束的外观对象。 |
...
| [get_NodeType](./get_nodetype/)() const override | 返回 [BookmarkStart](../nodetype/)。 |
...
| [GetText](./gettext/)() override | 返回空字符串。 |
...
Word 文档中的完整书签由一个 [BookmarkStart](./) 和一个匹配的 [BookmarkEnd](../bookmarkend/) 组成，二者具有相同的书签名称。
...
使用 [Bookmark](./get_bookmark/) 类作为“外观”，以将书签作为单个对象进行操作。
## 另见
