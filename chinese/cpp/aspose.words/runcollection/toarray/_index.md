---
title: "Aspose::Words::RunCollection::ToArray 方法"
linktitle: "ToArray"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::RunCollection::ToArray 方法。将集合中的所有 Run 复制到 C++ 中的新 Run 数组。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words/runcollection/toarray/
---
## RunCollection::ToArray method


将集合中的所有 run 复制到一个新的 run 数组中。
