---
title: "Aspose::Words::CleanupOptions::get_UnusedLists 方法"
linktitle: "get_UnusedLists"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::CleanupOptions::get_UnusedLists 方法。指定是否应从文档中删除未使用的列表及其定义。默认值在 C++ 中为 true。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words/cleanupoptions/get_unusedlists/
---
## CleanupOptions::get_UnusedLists method


指定是否应从文档中删除未使用的列表及列表定义。默认值为 **true**。
