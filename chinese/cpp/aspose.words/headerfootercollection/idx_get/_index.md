---
title: "Aspose::Words::HeaderFooterCollection::idx_get 方法"
linktitle: "idx_get"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::HeaderFooterCollection::idx_get 方法。检索指定类型的 HeaderFooter（在 C++ 中）。"
type: docs
weight: 3000
url: /zh/cpp/aspose.words/headerfootercollection/idx_get/
---
## HeaderFooterCollection::idx_get(Aspose::Words::HeaderFooterType) method


检索指定类型的 [HeaderFooter](../../headerfooter/)。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| headerFooterType | Aspose::Words::HeaderFooterType | 一个指定要检索的页眉/页脚类型的 [HeaderFooterType](../../headerfootertype/) 值。 |
...
在给定索引处检索一个 [HeaderFooter](../../headerfooter/)。
