---
title: "Aspose::Words::ParagraphFormat::get_IsListItem 方法"
linktitle: "get_IsListItem"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ParagraphFormat::get_IsListItem 方法。当段落是项目符号或编号列表中的项时为 True（在 C++ 中）。"
type: docs
weight: 16000
url: /zh/cpp/aspose.words/paragraphformat/get_islistitem/
---
## ParagraphFormat::get_IsListItem method


当段落是项目符号或编号列表中的项目时为 True。
