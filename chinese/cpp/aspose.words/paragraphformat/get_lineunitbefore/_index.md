---
title: "Aspose::Words::ParagraphFormat::get_LineUnitBefore 方法"
linktitle: "get_LineUnitBefore"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ParagraphFormat::get_LineUnitBefore 方法。获取或设置段落之前的间距量（以网格线计），使用 C++。"
type: docs
weight: 24000
url: /zh/cpp/aspose.words/paragraphformat/get_lineunitbefore/
---
## ParagraphFormat::get_LineUnitBefore method


获取或设置段落之前的间距量（以网格线为单位）。
