---
title: "Aspose::Words::ParagraphFormat::get_SpaceBeforeAuto 方法"
linktitle: "get_SpaceBeforeAuto"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ParagraphFormat::get_SpaceBeforeAuto 方法。如果段落前的间距量在 C++ 中被自动设置，则为 True。"
type: docs
weight: 34000
url: /zh/cpp/aspose.words/paragraphformat/get_spacebeforeauto/
---
## ParagraphFormat::get_SpaceBeforeAuto method


如果段落之前的间距量是自动设置的，则为 True。
...
设置为 **true** 时，会覆盖 [SpaceBefore](../get_spacebefore/) 的效果。
