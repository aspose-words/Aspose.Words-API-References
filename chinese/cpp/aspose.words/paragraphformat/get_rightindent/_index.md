---
title: "Aspose::Words::ParagraphFormat::get_RightIndent 方法"
linktitle: "get_RightIndent"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::ParagraphFormat::get_RightIndent 方法。获取或设置表示段落右缩进的值（单位为点），适用于 C++。"
type: docs
weight: 28000
url: /zh/cpp/aspose.words/paragraphformat/get_rightindent/
---
## ParagraphFormat::get_RightIndent method


获取或设置表示段落右缩进的值（以点为单位）。
