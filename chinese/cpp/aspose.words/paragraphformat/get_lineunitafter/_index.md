...
description: "Aspose::Words::ParagraphFormat::get_LineUnitAfter 方法。获取或设置在 C++ 中段落之后的间距量（以网格线为单位）。"
type: docs
weight: 23000
url: /zh/cpp/aspose.words/paragraphformat/get_lineunitafter/
---
## ParagraphFormat::get_LineUnitAfter method


获取或设置段落之后的间距量（以网格线为单位）。
