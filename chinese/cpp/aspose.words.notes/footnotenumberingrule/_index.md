...
description: "Aspose::Words::Notes::FootnoteNumberingRule enum。确定在 C++ 中何时重新启动自动脚注或尾注编号。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.notes/footnotenumberingrule/
---
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| Continuous | 0 | 整个文档的编号是连续的。 |
| RestartSection | 1 | 每个章节的编号会重新开始。 |
| RestartPage | 2 | 每页的编号会重新开始。仅对脚注有效。 |
| Default | n/a | 等于 [Continuous](./)。 |
