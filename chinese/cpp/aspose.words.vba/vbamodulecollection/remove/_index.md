...
description: "Aspose::Words::Vba::VbaModuleCollection::Remove 方法。在 C++ 中从集合中删除指定的模块。"
type: docs
weight: 11000
url: /zh/cpp/aspose.words.vba/vbamodulecollection/remove/
---
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| module_ | const System::SharedPtr\<Aspose::Words::Vba::VbaModule\>\& | 要删除的模块。 |
