---
title: "Aspose::Words::Loading::TxtLoadOptions::get_LeadingSpacesOptions 方法"
linktitle: "get_LeadingSpacesOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Loading::TxtLoadOptions::get_LeadingSpacesOptions 方法。获取或设置前导空格处理的首选选项。默认值在 C++ 中为 ConvertToIndent。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.loading/txtloadoptions/get_leadingspacesoptions/
---
## TxtLoadOptions::get_LeadingSpacesOptions method


获取或设置前导空格处理的首选选项。默认值为 [ConvertToIndent](../../txtleadingspacesoptions/)。
