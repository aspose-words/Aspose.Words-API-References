...
description: "Aspose::Words::Loading::HtmlLoadOptions::get_IgnoreNoscriptElements 方法。获取或设置一个值，指示是否忽略 <noscript> HTML 元素。默认值在 C++ 中为 false。"
type: docs
weight: 5000
url: /zh/cpp/aspose.words.loading/htmlloadoptions/get_ignorenoscriptelements/
---
## HtmlLoadOptions::get_IgnoreNoscriptElements method


获取或设置一个值，指示是否忽略 <noscript> HTML 元素。默认值为 **false**。
