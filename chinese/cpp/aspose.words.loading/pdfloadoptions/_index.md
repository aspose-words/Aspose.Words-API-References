---
title: "Aspose::Words::Loading::PdfLoadOptions 类"
linktitle: "PdfLoadOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Loading::PdfLoadOptions 类。允许在将 PDF 文档加载到 Document 对象时指定其他选项。欲了解更多，请访问 C++ 文档文章。"
type: docs
weight: 6000
url: /zh/cpp/aspose.words.loading/pdfloadoptions/
---
## PdfLoadOptions class


允许在将 PDF 文档加载到 [Document](../../aspose.words/document/) 对象时指定其他选项。欲了解更多，请访问 [Specify Load Options](https://docs.aspose.com/words/cpp/specify-load-options/) 文档文章。
...
| [get_PageCount](./get_pagecount/)() const | 获取要读取的页数。默认值为 MaxValue，表示将读取文档的所有页。 |
| [get_PageIndex](./get_pageindex/)() const | 获取要读取的第一页的 0 基索引。默认值为 0。 |
...
| [get_SkipPdfImages](./get_skippdfimages/)() const | 获取指示在加载 PDF 文档时是否必须跳过图像的标志。默认值为 **false**。 |
...
| [set_PageCount](./set_pagecount/)(int32_t) | 设置要读取的页数。默认值为 MaxValue，表示将读取文档的所有页。 |
| [set_PageIndex](./set_pageindex/)(int32_t) | 设置要读取的第一页的 0 基索引。默认值为 0。 |
...
| [set_SkipPdfImages](./set_skippdfimages/)(bool) | 设置指示在加载 PDF 文档时是否必须跳过图像的标志。默认值为 **false**。 |
