---
title: "Aspose::Words::Loading::TxtLeadingSpacesOptions 枚举"
linktitle: "TxtLeadingSpacesOptions"
second_title: "Aspose.Words for C++ API 参考"
description: "Aspose::Words::Loading::TxtLeadingSpacesOptions 枚举。指定在 C++ 中从文本文件导入时对前导空格处理的可用选项。"
type: docs
weight: 18000
url: /zh/cpp/aspose.words.loading/txtleadingspacesoptions/
---
## TxtLeadingSpacesOptions enum


指定在从 [Text](../../aspose.words/loadformat/) 文件导入时对前导空格处理的可用选项。
...
| 名称 | 值 | 描述 |
| --- | --- | --- |
| ConvertToIndent | 0 | 前导空格被移除并转换为左缩进。 |
| 修剪 | 1 | 前导空格被修剪。 |
| 保留 | 2 | 前导空格被保留。 |
