...
description: 探索 AxisDisplayUnit CustomUnit 属性，轻松使用用户定义的缩放比例自定义值轴显示单位，以增强数据清晰度。
type: docs
weight: 20
...
MS Office 2016 新图表不支持此属性。默认值为 1。

设置此属性将设置[`Unit`](../unit/)属性 to Custom。
