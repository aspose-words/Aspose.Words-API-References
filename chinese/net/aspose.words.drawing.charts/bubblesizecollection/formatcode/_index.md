...
description: 探索 BubbleSizeCollection 的 FormatCode 属性，轻松自定义气泡大小。使用自定义格式选项增强数据可视化效果。
type: docs
weight: 20
url: /zh/net/aspose.words.drawing.charts/bubblesizecollection/formatcode/
---
