...
| 姓名 | 描述 |
| --- | --- |
| [Level1](../../aspose.words.drawing.charts/chartmultilevelvalue/level1/) { get; } | 获取该值引用的图表顶层的名称。 |
| [Level2](../../aspose.words.drawing.charts/chartmultilevelvalue/level2/) { get; } | 获取该值引用的图表中间级别的名称。 |
| [Level3](../../aspose.words.drawing.charts/chartmultilevelvalue/level3/) { get; } | 获取该值引用的图表底部级别的名称。 |
