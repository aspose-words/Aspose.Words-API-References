...
description: ChartAxis HasMinorGridlines 财产. 获取或设置一个标志指示轴是否有次要网格线 在 C#.
type: docs
weight: 90
url: /zh/net/aspose.words.drawing.charts/chartaxis/hasminorgridlines/
---
## ChartAxis.HasMinorGridlines property

获取或设置一个标志，指示轴是否有次要网格线。
