...
description: 调整 ChartDataLabel Top 属性以控制数据标签的位置，从而增强图表清晰度。轻松优化您的数据可视化呈现！
type: docs
weight: 210
url: /zh/net/aspose.words.drawing.charts/chartdatalabel/top/
---
## ChartDataLabel.Top property

获取或设置数据标签与图表顶部边缘或其指定位置的距离（以点为单位）[`Position`](../position/)财产，取决于[`TopMode`](../topmode/) 属性.
