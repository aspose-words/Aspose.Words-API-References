...
description: 使用 ChartDataLabel 的 ShowCategoryName 属性增强您的图表。轻松在数据标签上显示类别名称，获得更清晰的洞察和更佳的视觉效果。
type: docs
weight: 140
url: /zh/net/aspose.words.drawing.charts/chartdatalabel/showcategoryname/
---
## ChartDataLabel.ShowCategoryName property

允许指定是否在图表上显示数据标签的类别名称。 默认值为`错误的`.
