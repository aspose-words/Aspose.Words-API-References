...
description: 探索 Aspose.Words.FootnoteOptions 类，用于自定义文档和章节中的脚注编号。立即提升文档的清晰度！
type: docs
weight: 4970
...
| 姓名 | 描述 |
| --- | --- |
| [Columns](../../aspose.words.notes/footnoteoptions/columns/) { get; set; } | 指定脚注区域格式的列数。 |
...
| [StartNumber](../../aspose.words.notes/footnoteoptions/startnumber/) { get; set; } | 指定第一个自动编号的脚注的起始数字或字符。 |
