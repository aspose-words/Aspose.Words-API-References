...
description: 探索 Aspose.Words.Lists.ListLevelCollection，通过可自定义的列表级别简化文档格式，以增强清晰度和呈现效果。
type: docs
weight: 3970
...
| [Item](../../aspose.words.lists/listlevelcollection/item/) { get; set; } | 通过索引获取列表级别。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| [GetEnumerator](../../aspose.words.lists/listlevelcollection/getenumerator/)() | 获取将枚举此列表中的级别的枚举器对象。 |
