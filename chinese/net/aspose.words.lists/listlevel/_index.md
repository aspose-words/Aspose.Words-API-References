...
| static [GetEffectiveValue](../../aspose.words.lists/listlevel/geteffectivevalue/)(*int, [NumberStyle](../../aspose.words/numberstyle/), string*) | 报告`ListLevel`列表项的指定 index 的对象。参数指定[`NumberStyle`](../../aspose.words/numberstyle/)和一个可选的格式 string 使用时Custom已指定。 |
