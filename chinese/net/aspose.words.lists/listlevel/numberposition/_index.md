...
description: 发现 ListLevel NumberPosition 属性，轻松调整点中的项目符号或数字位置，以增强列表格式和清晰度。
type: docs
weight: 80
url: /zh/net/aspose.words.lists/listlevel/numberposition/
---
## ListLevel.NumberPosition property

返回或设置列表级别的编号或项目符号的位置（以磅为单位）。
...
`NumberPosition`对应于段落的 LeftIndent 加上 FirstLineIndent。
