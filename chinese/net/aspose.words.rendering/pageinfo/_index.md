...
| [PaperSize](../../aspose.words.rendering/pageinfo/papersize) { get; } | 获取纸张大小作为枚举。 |
...
| 姓名 | 描述 |
| --- | --- |
| [GetDotNetPaperSize](../../aspose.words.rendering/pageinfo/getdotnetpapersize)(PaperSizeCollection) | 获取适合打印的PaperSize对象 this 所代表的页面[`PageInfo`](../pageinfo)。 |
...
| [GetSpecifiedPrinterPaperSource](../../aspose.words.rendering/pageinfo/getspecifiedprinterpapersource)(PaperSourceCollection, PaperSource) | 获取适合打印的PaperSource对象 this 所代表的页面[`PageInfo`](../pageinfo)。 |

### 评论

此对象返回的页面宽度和高度表示页面的“最终”大小，例如它们是 已经旋转到正确的方向。

### 例子

显示如何打印Word 文档中每一页的页面大小和方向信息。
