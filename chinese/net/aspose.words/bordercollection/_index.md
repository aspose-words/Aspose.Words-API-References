...
description: 探索 Aspose.Words.BorderCollection，这是您轻松管理和自定义 Border 对象以增强文档格式的解决方案。
type: docs
weight: 280
...
| [Count](../../aspose.words/bordercollection/count/) { get; } | 获取集合中的边框数量。 |
| [DistanceFromText](../../aspose.words/bordercollection/distancefromtext/) { get; set; } | 获取或设置边框与文本之间的距离（以磅为单位）。 |
...
| [LineWidth](../../aspose.words/bordercollection/linewidth/) { get; set; } | 获取或设置边框宽度（以点为单位）。 |
...
| [Equals](../../aspose.words/bordercollection/equals/#equals)(*BorderCollection*) | 比较边界集合。 |
| [GetEnumerator](../../aspose.words/bordercollection/getenumerator/)() | 返回一个枚举器对象，可用于遍历集合中的所有边界。 |

## 评论

不同的文档元素有不同的边框。 例如，[`ParagraphFormat`](../paragraphformat/)有[`Bottom`](./bottom/)，[`Left`](./left/)，[`Right`](./right/)和[`Top`](./top/)边框。 您可以为每个边框单独指定不同的格式，或者 枚举所有边框并应用相同的格式。
