...
description: ParagraphFormat AddSpaceBetweenFarEastAndDigit 财产. 获取或设置一个标志该标志指示是否在当前段落中东亚文本的数字和区域之间自动调整字符间距  在 C#.
type: docs
weight: 20
...
获取或设置一个标志，该标志指示是否在当前段落中东亚文本的数字和区域之间自动调整字符间距 。
