...
description: Aspose.Words.TableStyle 班级. 表示表格样式 在 C#.
type: docs
weight: 6220
...
| [AutomaticallyUpdate](../../aspose.words/style/automaticallyupdate/) { get; set; } |  |
...
| 姓名 | 描述 |
| --- | --- |
| [Equals](../../aspose.words/style/equals/)(*[Style](../style/)*) | 与指定的样式进行比较。 样式 Istds 仅针对内置样式进行比较。 样式默认值不包括在比较中。 基本样式、链接样式和下一段样式进行递归比较。 |
