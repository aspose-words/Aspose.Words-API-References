...
description: Aspose.Words.CommentRangeEnd 班级. 表示具有关联注释的文本区域的末尾
type: docs
weight: 250
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words/commentrangeend/accept/)(DocumentVisitor) | 接受访客。 |
...
`CommentRangeEnd`是一个内联级节点并且只能是[`Paragraph`](../paragraph/)。
