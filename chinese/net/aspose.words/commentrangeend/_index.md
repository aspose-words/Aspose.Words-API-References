...
| 姓名 | 描述 |
| --- | --- |
| [CommentRangeEnd](commentrangeend)(DocumentBase, int) | 初始化此类的新实例。 |
...
| [Id](../../aspose.words/commentrangeend/id) { get; set; } | 指定该区域链接到的注释的标识符。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words/commentrangeend/accept)(DocumentVisitor) | 接受访问者。 |
...
要创建锚定到文本区域的注释，您需要创建[`Comment`](../comment)和 然后创建[`CommentRangeStart`](../commentrangestart)和[`CommentRangeEnd`](../commentrangeend)并将它们的标识符 设置为相同的[`Id`](../comment/id)值。

[`CommentRangeEnd`](../commentrangeend)是内联级节点，只能是T的子节点:Aspose.Words.Paragraph。
