...
description: Aspose.Words.DocumentBuilder 班级. 提供插入文本图像和其他内容指定字体段落和部分格式的方法 在 C#.
type: docs
weight: 450
...
| [InsertField](../../aspose.words/documentbuilder/insertfield/#insertfield)(*[FieldType](../../aspose.words.fields/fieldtype/), bool*) | 将 Word 字段插入文档并可选择更新字段结果。 |
...
| [InsertHtml](../../aspose.words/documentbuilder/inserthtml/#inserthtml_1)(*string, [HtmlInsertOptions](../htmlinsertoptions/)*) | 将 HTML 字符串插入到文档中。允许指定附加选项。 |
...
| [InsertShape](../../aspose.words/documentbuilder/insertshape/#insertshape_1)(*[ShapeType](../../aspose.words.drawing/shapetype/), double, double*) | 插入指定类型和大小的内联形状。 |
...
| [MoveToField](../../aspose.words/documentbuilder/movetofield/)(*[Field](../../aspose.words.fields/field/), bool*) | 将光标移动到文档中的字段。 |
| [MoveToHeaderFooter](../../aspose.words/documentbuilder/movetoheaderfooter/)(*[HeaderFooterType](../headerfootertype/)*) | 将光标移动到当前节中页眉或页脚的开头。 |
...
| [MoveToStructuredDocumentTag](../../aspose.words/documentbuilder/movetostructureddocumenttag/#movetostructureddocumenttag)(*[StructuredDocumentTag](../../aspose.words.markup/structureddocumenttag/), int*) | 将光标移至结构化文档标签。 |
