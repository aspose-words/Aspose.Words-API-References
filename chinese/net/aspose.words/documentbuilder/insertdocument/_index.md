...
description: DocumentBuilder InsertDocument 方法. 在光标位置插入一个文档 在 C#.
type: docs
weight: 310
...
此方法模仿 MS Word 的行为，好像按下了 CTRL+'A'（选择所有内容）， 然后 CTRL+'C'（将所选内容复制到缓冲区中）在一个文档中 ，然后 CTRL+'V'（从缓冲区）在另一个文档中。
