...
description: 了解如何使用 CompositeNode 的 AcceptEnd 方法增强文档处理。简化访问者模式的实现，以获得最佳性能。
type: docs
weight: 60
url: /zh/net/aspose.words/compositenode/acceptend/
---
## CompositeNode.AcceptEnd method

在派生类中实现时，调用指定文档访问者的 VisitXXXEnd 方法。
