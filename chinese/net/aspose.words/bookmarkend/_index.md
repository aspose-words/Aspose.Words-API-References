...
description: Aspose.Words.BookmarkEnd 班级. 表示 Word 文档中书签的结尾
type: docs
weight: 60
...
| 姓名 | 描述 |
| --- | --- |
| [BookmarkEnd](bookmarkend/)(DocumentBase, string) | 初始化一个新实例`BookmarkEnd`类. |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words/bookmarkend/accept/)(DocumentVisitor) | 接受访客。 |
