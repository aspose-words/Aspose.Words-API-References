...
description: Aspose.Words.FileFormatUtil 班级. 提供处理文件格式的实用方法例如检测文件格式 或将文件扩展名与文件格式枚举相互转换 在 C#.
type: docs
weight: 2820
...
| static [LoadFormatToSaveFormat](../../aspose.words/fileformatutil/loadformattosaveformat/)(*[LoadFormat](../loadformat/)*) | 转换[`LoadFormat`](../loadformat/)值对一个[`SaveFormat`](../saveformat/)如果可能的话值。 |
...
| static [SaveFormatToLoadFormat](../../aspose.words/fileformatutil/saveformattoloadformat/)(*[SaveFormat](../saveformat/)*) | 转换[`SaveFormat`](../saveformat/)值对一个[`LoadFormat`](../loadformat/)如果可能的话值。 |
