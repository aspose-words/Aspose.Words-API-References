...
description: 探索 Aspose.Words.EditableRangeEnd 类，旨在有效管理 Word 文档中的可编辑范围，实现无缝文档编辑。
type: docs
weight: 1840
...
Word 文档中完整的可编辑范围包括[`EditableRangeStart`](./editablerangestart/) 和匹配的`EditableRangeEnd`具有相同的 ID。
