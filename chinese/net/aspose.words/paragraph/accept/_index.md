...
description: 探索段落接受方法，提升访客参与度并改善用户体验。立即提升您网站的互动性！
type: docs
weight: 230
...
呼叫[`VisitParagraphStart`](../../documentvisitor/visitparagraphstart/)，然后调用[`Accept`](../../node/accept/)对于段落的所有子节点 并调用[`VisitParagraphEnd`](../../documentvisitor/visitparagraphend/)在最后。
