...
description: 返回应用于该段落的所有制表位的数组包括由样式或列表间接应用的
type: docs
weight: 250
...
返回应用于该段落的所有制表位的数组，包括由样式或列表间接应用的。
...
Paragraph para = doc.FirstSection.Body.FirstParagraph;
 ...
 // 如果我们在这个集合中没有制表位的段落，
 // 在 Microsoft Word 中，每按一次 Tab 键，光标就会跳 36 个点。
...
// 通过“查看”启用标尺，我们可以在 Microsoft Word 中看到这些制表位 -> “显示”-> “尺子”.
Assert.AreEqual(3, para.GetEffectiveTabStops().Length);

 // 我们添加的任何制表符都将使用标尺上的制表位，并且可能，
 // 根据选项卡领导的值，在选项卡出发和到达目的地之间留一条线。
