...
description: Aspose.Words.Paragraph 班级. 代表一段文字 在 C#.
type: docs
weight: 4390
...
| 姓名 | 描述 |
| --- | --- |
| [Paragraph](paragraph/)(*[DocumentBase](../documentbase/)*) | 初始化**段落**类. |
...
| [AppendField](../../aspose.words/paragraph/appendfield/#appendfield)(*[FieldType](../../aspose.words.fields/fieldtype/), bool*) | 将一个字段附加到本段。 |
...
| [InsertField](../../aspose.words/paragraph/insertfield/#insertfield_1)(*string, [Node](../node/), bool*) | 在本段中插入一个字段。 |
| [InsertField](../../aspose.words/paragraph/insertfield/#insertfield)(*[FieldType](../../aspose.words.fields/fieldtype/), bool, [Node](../node/), bool*) | 在本段中插入一个字段。 |
| [InsertField](../../aspose.words/paragraph/insertfield/#insertfield_2)(*string, string, [Node](../node/), bool*) | 在本段中插入一个字段。 |
