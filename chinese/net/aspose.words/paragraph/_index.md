...
| 姓名 | 描述 |
| --- | --- |
| [Paragraph](paragraph)(DocumentBase) | 初始化 **段落** 类的新实例。 |
...
| [IsEndOfCell](../../aspose.words/paragraph/isendofcell) { get; } | 如果此段落是[`Cell`](../../aspose.words.tables/cell)中的最后一段，则为真；否则为假。 |
| [IsEndOfDocument](../../aspose.words/paragraph/isendofdocument) { get; } | 如果此段落是文档最后一段中的最后一段，则为真。 |
| [IsEndOfHeaderFooter](../../aspose.words/paragraph/isendofheaderfooter) { get; } | 如果此段落是 **HeaderFooter** （正文故事）中的最后一段，则为真 **部分** ;否则为假。 |
| [IsEndOfSection](../../aspose.words/paragraph/isendofsection) { get; } | 如果此段落是 **正文** （正文故事）中的最后一段，则为真 **部分** ;否则为假。 |
| [IsFormatRevision](../../aspose.words/paragraph/isformatrevision) { get; } | 如果启用更改跟踪时在 Microsoft Word 中更改了对象的格式，则返回 true。 |
| [IsInCell](../../aspose.words/paragraph/isincell) { get; } | 如果此段落是[`Cell`](../../aspose.words.tables/cell)的直接子级，则为真；否则为假。 |
...
| [IsMoveFromRevision](../../aspose.words/paragraph/ismovefromrevision) { get; } | 返回 **true** 如果在启用更改跟踪时在 Microsoft Word 中移动（删除）此对象。 |
| [IsMoveToRevision](../../aspose.words/paragraph/ismovetorevision) { get; } | 返回 **true** 如果此对象在 Microsoft Word 中被移动（插入）而启用更改跟踪。 |
| [LastChild](../../aspose.words/compositenode/lastchild) { get; } | 获取节点的最后一个子节点。 |
| [ListFormat](../../aspose.words/paragraph/listformat) { get; } | 提供对段落列表格式属性的访问。 |
| [ListLabel](../../aspose.words/paragraph/listlabel) { get; } | 获取[`ListLabel`](./listlabel)对象，该对象提供对列表编号值和格式的访问 对于本段。 |
| [NextSibling](../../aspose.words/node/nextsibling) { get; } | 获取紧跟该节点的节点。 |
| override [NodeType](../../aspose.words/paragraph/nodetype) { get; } | 返回 **NodeType.Paragraph** 。 |
...
| [ParentSection](../../aspose.words/paragraph/parentsection) { get; } | 检索段落的父[`Section`](../section)。 |
| [ParentStory](../../aspose.words/paragraph/parentstory) { get; } | 检索可以是[`Body`](../body)或HeaderFooter。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words/paragraph/accept)(DocumentVisitor) | 接受访问者。 |
| [AppendChild](../../aspose.words/compositenode/appendchild)(Node) | 将指定节点添加到此节点的子节点列表的末尾。 |
| [AppendField](../../aspose.words/paragraph/appendfield#appendfield_1)(string) | 将字段附加到本段。 |
| [AppendField](../../aspose.words/paragraph/appendfield#appendfield)(FieldType, bool) | 将字段附加到本段。 |
| [AppendField](../../aspose.words/paragraph/appendfield#appendfield_2)(string, string) | 将字段附加到本段。 |
...
| [GetEffectiveTabStops](../../aspose.words/paragraph/geteffectivetabstops)() | 返回应用于该段落的所有制表位的数组，包括由样式或列表间接应用的。 |
...
| [InsertField](../../aspose.words/paragraph/insertfield#insertfield_1)(string, Node, bool) | 在此段落中插入一个字段。 |
| [InsertField](../../aspose.words/paragraph/insertfield#insertfield)(FieldType, bool, Node, bool) | 在此段落中插入一个字段。 |
| [InsertField](../../aspose.words/paragraph/insertfield#insertfield_2)(string, string, Node, bool) | 在此段落中插入一个字段。 |
...
[`Paragraph`](../paragraph)是一个块-级别节点，并且可以是派生自 [`Story`](../story)或[`InlineStory`](../inlinestory)的类的子级。

[`Paragraph`](../paragraph)可以包含任意数量的内联级节点和书签。

段落中可能出现的子节点的完整列表包括 [`BookmarkStart`](../bookmarkstart),[`BookmarkEnd`](../bookmarkend), [`FieldStart`](../../aspose.words.fields/fieldstart),[`FieldSeparator`](../../aspose.words.fields/fieldseparator), [`FieldEnd`](../../aspose.words.fields/fieldend),Fields。FormField, [`Comment`](../comment),[`Footnote`](../../aspose.words.notes/footnote), [`Run`](../run),[`SpecialChar`](../specialchar), [`Shape`](../../aspose.words.drawing/shape),[`GroupShape`](../../aspose.words.drawing/groupshape), [`SmartTag`](../../aspose.words.markup/smarttag).

Microsoft Word 中的有效段落始终以换行符结尾，并且 最小有效段落仅包含换行符。 **Paragraph** 类自动在末尾附加适当的分节符 并且该字符不是 **段落** 的子节点，因此 a **段落** 可以为空。

不包括段落结尾[`ControlChar.ParagraphBreak`](../controlchar/paragraphbreak) 或单元格结尾[`ControlChar.Cell`](../controlchar/cell):::47 文本内的 个字符:::段落，因为在 Microsoft Word 中打开文档时，它可能使段落无效。
