...
description: Revision./revision对象的集合代表文档中的修订
type: docs
weight: 4460
...
[`Revision`](../revision)对象的集合，代表文档中的修订。
...
| [Item](../../aspose.words/revisioncollection/item) { get; } | 返回指定索引处的修订。 |
...
您不要直接创建此类的实例。使用[`Revisions`](../document/revisions)属性来获取文档中存在的修订。
