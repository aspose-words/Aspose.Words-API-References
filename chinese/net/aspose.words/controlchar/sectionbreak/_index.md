...
description: ControlChar SectionBreak 场地. 节结束字符x000c或f请注意它的值与PageBreak 在 C#.
type: docs
weight: 240
url: /zh/net/aspose.words/controlchar/sectionbreak/
---
## ControlChar.SectionBreak field

节结束字符：“\x000c”或“\f”。请注意，它的值与[`PageBreak`](../pagebreak/).
