...
description: 探索 ControlChar ParagraphBreak 字段。使用 x000d 字符轻松管理段落分隔符，实现无缝文本格式化并提升可读性。
type: docs
weight: 220
url: /zh/net/aspose.words/controlchar/paragraphbreak/
---
## ControlChar.ParagraphBreak field

段落结束字符：“\x000d”或“\r”。与[`Cr`](../cr/)
