...
description: ControlChar NonBreakingHyphenChar 场地. Microsoft Word 中的不间断连字符为 char30 在 C#.
type: docs
weight: 160
...
Microsoft Word 中的不间断连字符为 (char)30.
...
Microsoft Word 中的不间断连字符不对应于 Unicode 字符U+2011 不间断连字符，而是表示 告诉Microsoft Word 显示连字符而不是换行的内部信息。
