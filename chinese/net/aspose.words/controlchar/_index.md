...
| 姓名 | 描述 |
| --- | --- |
| static readonly [Cell](../../aspose.words/controlchar/cell/) | 表格单元格结尾或表格行字符结尾：“\x0007”或“\a”。 |
| const [CellChar](../../aspose.words/controlchar/cellchar/) | 表格单元格结尾或表格行字符结尾：(char)7 或“\a”。 |
...
| static readonly [Cr](../../aspose.words/controlchar/cr/) | 回车符：“\x000d”或“\r”。与...一样[`ParagraphBreak`](./paragraphbreak/). |
...
| const [FieldEndChar](../../aspose.words/controlchar/fieldendchar/) | MS Word 字段字符结束：(char)21. |
| const [FieldSeparatorChar](../../aspose.words/controlchar/fieldseparatorchar/) | 字段分隔符将字段代码与字段值分隔开。某些字段可选。值：（字符）20. |
| const [FieldStartChar](../../aspose.words/controlchar/fieldstartchar/) | MS Word 字段字符的开头：(char)19. |
| static readonly [Lf](../../aspose.words/controlchar/lf/) | 换行符：“\x000a”或“\n”。与...一样[`LineFeed`](./linefeed/). |
...
| static readonly [ParagraphBreak](../../aspose.words/controlchar/paragraphbreak/) | 段落结束字符：“\x000d”或“\r”。与...一样[`Cr`](./cr/) |
...
| const [SectionBreakChar](../../aspose.words/controlchar/sectionbreakchar/) | 节结束字符：(char)12 或“\f”. |
