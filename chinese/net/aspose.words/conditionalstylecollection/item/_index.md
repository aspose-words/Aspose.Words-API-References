...
description: ConditionalStyleCollection Item 财产. 检索一个ConditionalStyle按条件样式类型的对象 在 C#.
type: docs
weight: 80
...
检索一个[`ConditionalStyle`](../../conditionalstyle/)按条件样式类型的对象。
...
检索一个[`ConditionalStyle`](../../conditionalstyle/)按索引的对象.
