...
注意:不访问词汇表文档节点及其子节点当您在[`Document`](../../document)上执行 访问者时。如果要在 词汇表文档上执行访问者，则需要调用[`Accept`](../../../aspose.words.buildingblocks/glossarydocument/accept)。
