...
description: 了解 DocumentVisitor VisitSpecialChar 方法如何通过有效处理 SpecialChar 节点来提高性能，从而增强文档处理能力。
type: docs
weight: 430
...
当[`SpecialChar`](../../specialchar/)文档中遇到节点。
...
该方法不能被通用控制字符调用（见[`ControlChar`](../../controlchar/) 可以出现在文档中。
