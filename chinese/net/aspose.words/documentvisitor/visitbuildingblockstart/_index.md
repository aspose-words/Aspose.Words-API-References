...
description: 探索 DocumentVisitor 的 VisitBuildingBlockStart 方法，该方法对于启动构建块枚举至关重要。立即提升您的编码效率！
type: docs
weight: 70
...
注意：在执行 a Visitor 时，不会访问构建块节点及其子节点[`Document`](../../document/)。如果您想对 a 构建块执行访问者，则需要对[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument/)or 呼叫[`Accept`](../../../aspose.words.buildingblocks/buildingblock/accept/).
