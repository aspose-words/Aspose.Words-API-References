...
注意:不访问构建块节点及其子节点当您在[`Document`](../../document)上执行 访问者时。如果要通过 构建块执行访问者，则需要通过[`GlossaryDocument`](../../../aspose.words.buildingblocks/glossarydocument)或:::47::执行访问者:调用[`Accept`](../../../aspose.words.buildingblocks/buildingblock/accept)。
