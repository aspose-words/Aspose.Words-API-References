...
description: Aspose.Words.DocumentBase 班级. 为 Word 文档的主文档和词汇表文档提供抽象基类 在 C#.
type: docs
weight: 440
...
| [ImportNode](../../aspose.words/documentbase/importnode/#importnode_1)(*[Node](../node/), bool, [ImportFormatMode](../importformatmode/)*) | 将节点从另一个文档导入到当前文档，并带有控制格式的选项。 |
