...
description: Aspose.Words.DocumentBase 班级. 提供Word文档的主文档和词汇表文档的抽象基类
type: docs
weight: 440
...
| [ImportNode](../../aspose.words/documentbase/importnode/#importnode_1)(Node, bool, ImportFormatMode) | 将节点从另一个文档导入到当前文档，并提供控制格式的选项。 |
