...
description: 探索 Aspose.Words.StyleCollection 类，它具有丰富的内置和自定义样式对象，可增强文档的格式和设计。
type: docs
weight: 6990
...
的集合[`Style`](../style/)代表文档中的内置样式和用户定义样式的对象。
...
| [GetEnumerator](../../aspose.words/stylecollection/getenumerator/)() | 获取一个枚举器对象，该对象将按照名称的字母顺序枚举样式。 |
