...
description: Document RemovePersonalInformation 财产. 获取或设置一个标志指示 Microsoft Word 在保存文档时将从注释修订和 文档属性中删除所有用户信息 在 C#.
type: docs
weight: 340
...
获取或设置一个标志，指示 Microsoft Word 在保存文档时将从注释、修订和 文档属性中删除所有用户信息。
...
// 当我们使用 Microsoft Word 手动保存时，个人数据将从带有标记的文档中删除。
