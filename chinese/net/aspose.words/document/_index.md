...
| [CompatibilityOptions](../../aspose.words/document/compatibilityoptions) { get; } | 提供对文档兼容性选项的访问（即，在 **Compatibility** ::上输入的用户首选项Word 中 **选项** 对话框的:47:::选项卡）。 |
...
考虑使用[`DocumentBuilder`](../documentbuilder)以简化以编程方式创建::的任务:47:::或填充文档树。
