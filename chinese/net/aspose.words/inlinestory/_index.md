...
**InlineStory** 是块级节点[`Paragraph`](../paragraph)和[`Table`](../../aspose.words.tables/table)的容器。

派生自 **InlineStory** 的类是可以包含:::47 的内联级节点:::自己的文本（段落和表格）。例如，一个 **评论** 节点包含评论文本 和一个 **脚注** 包含脚注文本。
