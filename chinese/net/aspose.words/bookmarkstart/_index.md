...
description: Aspose.Words.BookmarkStart 班级. 表示 Word 文档中书签的开始
type: docs
weight: 60
...
| 姓名 | 描述 |
| --- | --- |
| [BookmarkStart](bookmarkstart/)(DocumentBase, string) | 初始化`BookmarkStart`类. |
...
`BookmarkStart`和[`BookmarkEnd`](../bookmarkend/)只是 document 中的标记，用于指定书签的开始和结束位置。
