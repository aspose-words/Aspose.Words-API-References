...
description: Aspose.Words.IWarningCallback 界面. 如果您希望调用自己的自定义方法来 捕获可能在文档加载或保存期间发生的保真度丢失警告请实施此接口 在 C#.
type: docs
weight: 3210
...
| 姓名 | 描述 |
| --- | --- |
| [Warning](../../aspose.words/iwarningcallback/warning/)(*[WarningInfo](../warninginfo/)*) | Aspose.Words 在文档加载 或保存可能导致格式丢失或数据保真度丢失的问题时调用此方法。 |
