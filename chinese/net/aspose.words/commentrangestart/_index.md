...
description: Aspose.Words.CommentRangeStart 班级. 表示具有关联注释的文本区域的开始 在 C#.
type: docs
weight: 260
...
| 姓名 | 描述 |
| --- | --- |
| [CommentRangeStart](commentrangestart/)(*[DocumentBase](../documentbase/), int*) | 初始化这个类的一个新实例。 |
...
`CommentRangeStart`是一个内联级节点，只能是[`Paragraph`](../paragraph/).
