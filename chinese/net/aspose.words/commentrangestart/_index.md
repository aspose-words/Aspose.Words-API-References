...
description: 探索 Aspose.Words.CommentRangeStart 类，标记与注释相关的文本区域，以增强文档管理和编辑效率。
type: docs
weight: 450
...
| [Id](../../aspose.words/commentrangestart/id/) { get; set; } | 指定此区域链接到的注释的标识符。 |
...
要创建锚定到文本区域的评论，您需要创建一个[`Comment`](../comment/)and 然后创建`CommentRangeStart`和[`CommentRangeEnd`](../commentrangeend/)并将其标识符 设置为相同的[`Id`](../comment/id/)价值。

`CommentRangeStart`是内联级节点，并且只能是[`Paragraph`](../paragraph/)。
