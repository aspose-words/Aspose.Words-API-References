...
description: CommentRangeStart 构造函数. 初始化这个类的一个新实例 在 C#.
type: docs
weight: 10
...
| id | Int32 | 此对象链接到的注释标识符。 |

## 评论

什么时候[`CommentRangeStart`](../)被创建，它属于指定的文档，但不是 还不是文档的一部分，并且[`ParentNode`](../../node/parentnode/)一片空白。

追加一个[`CommentRangeStart`](../)在要插入注释的段落上使用 InsertAfter 或 InsertBefore 到文档中。
