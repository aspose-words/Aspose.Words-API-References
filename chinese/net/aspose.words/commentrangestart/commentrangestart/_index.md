...
description: 探索 CommentRangeStart 构造函数。轻松创建此类的新实例，以提高编码效率并简化开发流程。
type: docs
weight: 10
...
什么时候[`CommentRangeStart`](../)已创建，它属于指定文档，但尚未成为文档的一部分，并且[`ParentNode`](../../node/parentnode/)是`无效的`。

附加[`CommentRangeStart`](../)在文档中，在想要插入注释的段落上使用 InsertAfter 或 InsertBefore 。
