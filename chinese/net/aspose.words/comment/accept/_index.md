...
description: 探索“评论接受”方法，提升访客参与度，并在您的网站上创造有意义的互动。立即提升您的在线社区！
type: docs
weight: 130
...
呼叫[`VisitCommentStart`](../../documentvisitor/visitcommentstart/)，然后调用[`Accept`](../../node/accept/)对于 all 子节点的评论和调用[`VisitCommentEnd`](../../documentvisitor/visitcommentend/)在最后。
