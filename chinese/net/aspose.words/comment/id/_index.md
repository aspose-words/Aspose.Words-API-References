...
注释标识符允许将注释锚定到文档中的文本区域。 必须使用[`CommentRangeStart`](../../commentrangestart)和[`CommentRangeEnd`](../../commentrangeend):::47:划分区域::对象与[`Comment`](../../comment)对象共享相同的标识符值。

在查找[`CommentRangeStart`](../../commentrangestart)和 ::时将使用此值:R5:T:Aspose.Words.CommentRangeEnd:::链接到此评论的节点。

注释标识符在文档中应该是唯一的，Aspose.Words 自动 在加载、保存和组合文档时维护注释标识符。
