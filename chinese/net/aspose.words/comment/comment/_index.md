...
当 **注释** 是创建后，它属于指定的文档，但不是 文档的一部分，并且 **ParentNode** 为空。

要将 **注释** 附加到文档，请使用 InsertAfter 或 InsertBefore on要插入评论的段落。

创建评论后，别忘了设置它的[`Author`](../author), [`Initial`](../initial)和[`DateTime`](../datetime)属性。
