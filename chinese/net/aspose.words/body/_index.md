...
description: Aspose.Words.Body 班级. 表示一个部分的主要文本的容器 在 C#.
type: docs
weight: 30
...
| 姓名 | 描述 |
| --- | --- |
| [Body](body/)(*[DocumentBase](../documentbase/)*) | 初始化**身体**类. |
...
| override [NodeType](../../aspose.words/body/nodetype/) { get; } | 返回**节点类型.Body**. |
...
**身体**是节级节点，只能是**部分** 只能有一个**身体**在一个**部分**.
