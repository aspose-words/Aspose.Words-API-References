...
| Exception | 文档有问题，应该报告给 Aspose.Words 开发者。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| fileName | String | 要从中提取文本的文件名. |
| loadOptions | LoadOptions | 加载文档时使用的附加选项。可以为空。 |
...
显示如何以纯文本形式加载加密的 Microsoft Word 文档的内容。
...
| NotSupportedException | 流不支持读取或查找。 |
| ObjectDisposedException | 流是已处置的对象。 |
...
显示如何使用流以纯文本形式加载 Microsoft Word 文档的内容。
...
显示如何使用流以纯文本形式加载加密的 Microsoft Word 文档的内容。
