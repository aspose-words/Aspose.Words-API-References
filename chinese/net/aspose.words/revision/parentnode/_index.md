...
description: 探索 Revision ParentNode 属性，该属性标识除 StyleDefinitionChange 之外的任何修订类型的直接父节点。提升您的编码效率！
type: docs
weight: 40
...
获取此修订的直接父节点（所有者）。 此属性适用于除以下修订类型之外的任何修订类型StyleDefinitionChange.
...
如果此修订涉及样式格式的更改，请使用[`ParentStyle`](../parentstyle/)而是。
