...
description: Revision ParentNode 财产. 获取此修订的直接父节点所有者 此属性适用于除此之外的任何修订类型StyleDefinitionChange 在 C#.
type: docs
weight: 40
...
获取此修订的直接父节点（所有者）。 此属性适用于除此之外的任何修订类型StyleDefinitionChange.
...
如果此修订涉及样式格式的更改，请使用[`ParentStyle`](../parentstyle/)
