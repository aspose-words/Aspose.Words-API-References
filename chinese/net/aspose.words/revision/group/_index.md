...
description: Revision Group 财产. 获取修订组如果修订不属于任何组则返回 null 在 C#.
type: docs
weight: 30
...
如果修订类型为 RevisionType.StyleDefinitionChange 或 如果修订在文档上下文中不再存在（接受/拒绝），则修订没有组。
