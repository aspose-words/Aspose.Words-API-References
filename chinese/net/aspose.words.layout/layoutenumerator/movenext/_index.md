...
description: LayoutEnumerator MoveNext 方法. 按视觉顺序移动到下一个同级实体 当迭代跨页中断的段落的行时此方法 不会移动到下一页而是移动到同一页上的下一个实体 在 C#.
type: docs
weight: 120
url: /zh/net/aspose.words.layout/layoutenumerator/movenext/
---
## LayoutEnumerator.MoveNext method

按视觉顺序移动到下一个同级实体。 当迭代跨页中断的段落的行时，此方法 不会移动到下一页，而是移动到同一页上的下一个实体。
