...
description: 探索 LayoutEnumerator Kind 属性，该属性用于标识当前实体类型。此重要功能可确保数据清晰明了。
type: docs
weight: 50
...
这是当前实体的更具体类型，例如书签跨度具有Span类型 and 可能有 BOOKMARKSTART 或 BOOKMARKEND 类型。
