...
description: LayoutEnumerator Kind 财产. 获取当前实体的种类这可以是一个空字符串但绝不是 null 在 C#.
type: docs
weight: 50
...
获取当前实体的种类。这可以是一个空字符串，但绝不是 null.
...
这是当前实体的更具体类型，例如书签跨度有Spantype and 可能有 BOOKMARKSTART 或 BOOKMARKEND 类型。
