...
description: 使用 DeletedTextColor 属性自定义 RevisionOptions，突出显示已删除的内容。默认为 ByAuthor。提升文档的清晰度！
type: docs
weight: 30
url: /zh/net/aspose.words.layout/revisionoptions/deletedtextcolor/
---
## RevisionOptions.DeletedTextColor property

允许指定已删除内容所使用的颜色Deletion. 默认值是ByAuthor.
