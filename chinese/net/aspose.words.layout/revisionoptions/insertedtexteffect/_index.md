...
description: 允许指定应用于插入内容的效果Insertion 默认值为Underline
type: docs
weight: 50
...
Hidden和:::R5 的值:F:Aspose.Words.Layout.RevisionTextEffect.DoubleStrikeThrough::: 是不允许的，会导致ArgumentOutOfRangeException。
