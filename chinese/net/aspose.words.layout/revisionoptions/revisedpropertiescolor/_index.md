...
description: RevisionOptions RevisedPropertiesColor 财产. 允许指定用于更改格式属性的内容的颜色FormatChange 默认值为NoHighlight 在 C#.
type: docs
weight: 110
...
允许指定用于更改格式属性的内容的颜色FormatChange 默认值为NoHighlight.
