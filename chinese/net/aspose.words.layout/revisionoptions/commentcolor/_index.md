...
description: 使用 RevisionOptions 的 CommentColor 属性自定义您的注释。轻松设置您喜欢的颜色（默认为红色），以增强可见性！
type: docs
weight: 10
url: /zh/net/aspose.words.layout/revisionoptions/commentcolor/
---
...
如果将此属性设置为ByAuthor或者NoHighlight值， 结果此属性将被设置为默认颜色。
