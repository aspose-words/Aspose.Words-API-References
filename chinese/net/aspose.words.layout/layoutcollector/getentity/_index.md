...
description: 返回一个不透明的位置LayoutEnumeratoraspose.words.layout/layoutenumerator/对应于指定的节点 您可以使用返回值作为参数Currentaspose.words.layout/layoutenumerator/current/给定正在 枚举的文档和节点的文档相同.
type: docs
weight: 50
