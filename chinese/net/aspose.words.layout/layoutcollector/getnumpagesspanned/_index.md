...
description: 获取指定节点跨越的页数如果节点在单个页面内则为 0 这与GetEndPageIndexaspose.words.layout/layoutcollector/getendpageindex-Node
type: docs
weight: 60
...
获取指定节点跨越的页数。如果节点在单个页面内，则为 0。 这与[`GetEndPageIndex`](../getendpageindex)-Node)。
