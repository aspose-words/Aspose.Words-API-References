...
description: 获取指定节点跨越的页数如果节点在单个页面内则为 0 这与GetEndPageIndexaspose.words.layout/layoutcollector/getendpageindex-GetStartPageIndexaspose.words.layout/layoutcollector/getstartpageindex.
type: docs
weight: 60
