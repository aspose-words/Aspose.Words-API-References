...
description: 了解 Aspose.Words.Layout.ShowInBalloons 枚举如何通过控制气球中的可见修订来实现清晰的协作，从而增强文档编辑功能。
type: docs
weight: 3860
...
| 姓名 | 价值 | 描述 |
| --- | --- | --- |
| None | `0` | 以内联方式呈现插入、删除和格式化修订。 |
| Format | `1` | 以内联方式呈现插入和删除修订，在气球中格式化修订。 |
| FormatAndDelete | `2` | 渲染插入修订内联、删除和格式化气球中的修订。 |
