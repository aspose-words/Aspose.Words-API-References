...
description: 探索 Aspose.Words.Fields.FieldCreateDate 类，实现无缝文档管理。轻松实现 CREATEDATE 字段并增强您的工作流程。
type: docs
weight: 2130
...
| [UseLunarCalendar](../../aspose.words.fields/fieldcreatedate/uselunarcalendar/) { get; set; } | 获取或设置是否使用伊斯兰历或希伯来历。 |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldcreatedate/usesakaeracalendar/) { get; set; } | 获取或设置是否使用萨迦历法。 |
