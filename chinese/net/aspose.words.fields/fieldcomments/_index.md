...
description: 探索 Aspose.Words.Fields.FieldComments 类，高效实现和管理文档中的 COMMENTS 字段。立即增强您的文档处理能力！
type: docs
weight: 2110
...
| [Text](../../aspose.words.fields/fieldcomments/text/) { get; set; } | 获取或设置评论的文本。 |
...
检索并选择性地设置与当前文档相关的注释，如[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/)内置文档属性的 property 。
