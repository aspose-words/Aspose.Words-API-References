...
description: Aspose.Words.Fields.FieldComments 班级. 实现 COMMENTS 字段 在 C#.
type: docs
weight: 1700
...
检索并可选择设置与当前文档相关的注释，如记录在[`Comments`](../../aspose.words.properties/builtindocumentproperties/comments/)property 内置文档属性.
...
// 用 Text 属性的值覆盖“Comments”内置属性的当前值，
// 然后显示新值。
