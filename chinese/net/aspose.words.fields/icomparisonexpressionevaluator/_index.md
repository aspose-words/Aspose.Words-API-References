...
description: 使用 Aspose.Words.Fields.IComparisonExpressionEvaluator 增强您的文档处理能力。轻松自定义 FieldIf 和 FieldCompare 字段的比较评估！
type: docs
weight: 3090
...
实现后，允许覆盖默认比较表达式评估[`FieldIf`](../fieldif/)和[`FieldCompare`](../fieldcompare/)字段.
