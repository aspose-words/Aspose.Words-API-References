...
description: Aspose.Words.Fields.FieldIncludeText 班级. 实现 INCLUDETEXT 字段 在 C#.
type: docs
weight: 2050
...
| 姓名 | 描述 |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldincludetext/bookmarkname/) { get; set; } | 获取或设置文档中要包含的书签的名称。 |
| [DisplayResult](../../aspose.words.fields/field/displayresult/) { get; } | 获取表示显示的字段结果的文本。 |
| [Encoding](../../aspose.words.fields/fieldincludetext/encoding/) { get; set; } | 获取或设置应用于引用文件内数据的编码。 |
...
| [LockFields](../../aspose.words.fields/fieldincludetext/lockfields/) { get; set; } | 获取或设置是否阻止更新所包含文档中的字段。 |
...
| [XslTransformation](../../aspose.words.fields/fieldincludetext/xsltransformation/) { get; set; } | 获取或设置用于格式化 XML 数据的 XSL 转换的位置。 |
