...
description: 探索 Aspose.Words.Fields.FieldDatabaseDataTable 类，这是您高效获取 FieldDatabase 字段结果的首选解决方案。立即解锁无缝数据集成！
type: docs
weight: 2170
...
为[`FieldDatabase`](../fielddatabase/)字段结果。请参阅DataTable实例.
...
| 姓名 | 描述 |
| --- | --- |
| [ColumnNames](../../aspose.words.fields/fielddatabasedatatable/columnnames/) { get; } | 获取属于此表的列。 |
| [Rows](../../aspose.words.fields/fielddatabasedatatable/rows/) { get; } | 获取属于此表的行。 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| static [CreateFrom](../../aspose.words.fields/fielddatabasedatatable/createfrom/)(*DataTable*) | 初始化`FieldDatabaseDataTable`class 来自DataTable实例. |
