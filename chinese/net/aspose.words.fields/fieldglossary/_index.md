...
description: Aspose.Words.Fields.FieldGlossary 班级. 实现 GLOSSARY 字段 在 C#.
type: docs
weight: 1960
url: /zh/net/aspose.words.fields/fieldglossary/
---
## FieldGlossary class
...
| 姓名 | 描述 |
| --- | --- |
| [FieldGlossary](fieldglossary/)() | 默认构造函数。 |
...
| [EntryName](../../aspose.words.fields/fieldglossary/entryname/) { get; set; } | 获取或设置要插入的词汇表条目的名称。 |
