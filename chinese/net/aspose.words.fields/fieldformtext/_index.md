...
description: Aspose.Words.Fields.FieldFormText 班级. 实现 FORMTEXT 字段 在 C#.
type: docs
weight: 1930
url: /zh/net/aspose.words.fields/fieldformtext/
---
## FieldFormText class
...
| 姓名 | 描述 |
| --- | --- |
| [FieldFormText](fieldformtext/)() | 默认构造函数。 |
...
演示如何处理 FORMCHECKBOX、FORMDROPDOWN 和 FORMTEXT 字段。

```csharp
// 这些字段是 FormField 的旧版本。我们可以使用 Aspose.Words 读取这些字段，但不能创建这些字段。
// 在 Microsoft Word 中，我们可以通过“开发人员”选项卡中的“旧版工具”菜单插入这些字段。
