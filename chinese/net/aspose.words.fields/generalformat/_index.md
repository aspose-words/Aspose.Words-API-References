...
description: Aspose.Words.Fields.GeneralFormat 枚举. 指定应用于数字文本或任何字段结果的通用格式 字段可能有通用格式的组合 在 C#.
type: docs
weight: 2640
...
指定应用于数字、文本或任何字段结果的通用格式。 字段可能有通用格式的组合。
...
| LowercaseAlphabetic | `3` | 数字格式。将数值结果格式化为一个或多个小写拉丁字母字符。 |
...
| Chosung | `13` | 数字格式。使用韩国 Chosung 格式的序号格式化数字结果。 |
| CircleNum | `14` | 数字格式。使用包围在圆圈中的十进制编号格式化数字结果，对 1–20. 范围内的数字使用 封闭的字母数字字形字符 |
...
| GB3 | `24` | 数字格式。使用 封闭的字母数字字形字符，使用圆圈中的十进制编号格式化数字结果。 |
| GB4 | `25` | 数字格式。使用 封闭的字母数字字形字符，使用圆圈中的十进制编号格式化数字结果。 |
...
| KanjiNum1 | `34` | 数字格式。使用适当的计数系统使用日文样式格式化数字结果。 |
...
| ThaiLetter | `44` | 数字格式。使用泰文字母格式化数字结果。 |
| VietCardText | `45` | 数字格式。使用越南数字格式化数字结果。 |
| Zodiac1 | `46` | 数字格式。使用顺序数字传统象形文字格式化数字结果。 |
| Zodiac2 | `47` | 数字格式。使用连续的生肖象形文字格式化数字结果。 |
