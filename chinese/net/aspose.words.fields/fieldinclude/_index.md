...
description: 探索 Aspose.Words.Fields.FieldInclude 类，以便在文档中无缝实现 INCLUDE 字段，从而提高自动化和效率。
type: docs
weight: 2440
...
| 姓名 | 描述 |
| --- | --- |
| [BookmarkName](../../aspose.words.fields/fieldinclude/bookmarkname/) { get; set; } | 获取或设置要包含的文档中的书签的名称。 |
