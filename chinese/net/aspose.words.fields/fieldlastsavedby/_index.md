...
description: 探索 Aspose.Words.Fields.FieldLastSavedBy 类，使用 LASTSAVEDBY 字段功能增强文档管理。立即优化您的工作流程！
type: docs
weight: 2510
...
检索最后修改并保存当前文档的用户的名称，如**最后修改者**内置文档属性的 属性。

## 例子

展示如何使用 LASTSAVEDBY 字段。

```csharp
Document doc = new Document();
DocumentBuilder builder = new DocumentBuilder(doc);

// 如果我们在 Microsoft Word 中创建一个文档，它将在“上次保存者”内置属性中包含用户的名称。
 // 如果我们以编程方式创建文档，则此属性将为空，并且我们需要分配一个值。
doc.BuiltInDocumentProperties.LastSavedBy = "John Doe";

// 我们可以使用 LASTSAVEDBY 字段在文档中显示此属性的值。
