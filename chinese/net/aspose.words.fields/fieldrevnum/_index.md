...
description: Aspose.Words.Fields.FieldRevNum 班级. 实现 REVNUM 字段 在 C#.
type: docs
weight: 2340
...
// 该属性计算文档在 Microsoft Word 中保存的次数，
// 并且与跟踪的修订无关。我们可以通过在Windows资源管理器中右键单击该文档来找到它
// 通过属性 ->细节。我们可以手动更新此属性。
