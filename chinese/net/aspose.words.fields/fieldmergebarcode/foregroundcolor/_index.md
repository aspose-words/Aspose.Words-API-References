...
description: 探索 FieldMergeBarcode ForegroundColor 属性，自定义条形码的外观。轻松设置颜色值，范围从 0 到 0xFFFFFF！
type: docs
weight: 100
url: /zh/net/aspose.words.fields/fieldmergebarcode/foregroundcolor/
---
## FieldMergeBarcode.ForegroundColor property

获取或设置条形码符号的前景色。有效值范围为 [0, 0xFFFFFF]
