...
description: 探索 FieldMergeBarcode SymbolRotation 属性，轻松自定义条形码符号旋转。使用 0 和 3 等有效值增强数据呈现效果。
type: docs
weight: 140
url: /zh/net/aspose.words.fields/fieldmergebarcode/symbolrotation/
---
## FieldMergeBarcode.SymbolRotation property

获取或设置条形码符号的旋转角度。有效值为 [0, 3]
