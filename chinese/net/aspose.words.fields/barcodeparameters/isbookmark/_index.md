...
description: 探索 BarcodeParameters 的 IsBookmark 属性！了解 PostalAddress 如何通过高效的书签解决方案增强您的文档管理。
type: docs
weight: 120
url: /zh/net/aspose.words.fields/barcodeparameters/isbookmark/
---
## BarcodeParameters.IsBookmark property

是否[`PostalAddress`](../postaladdress/)是书签的名称。
