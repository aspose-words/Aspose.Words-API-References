...
description: 探索 Aspose.Words.Fields.FieldHyperlink 类，轻松在文档中实现 HYPERLINK 字段并增强交互性。
type: docs
weight: 2400
...
| [OpenInNewWindow](../../aspose.words.fields/fieldhyperlink/openinnewwindow/) { get; set; } | 获取或设置是否在新 Web 浏览器窗口中打开目标站点。 |
...
| [SubAddress](../../aspose.words.fields/fieldhyperlink/subaddress/) { get; set; } | 获取或设置文件中的某个位置，例如书签，此超链接跳转至该位置。 |
