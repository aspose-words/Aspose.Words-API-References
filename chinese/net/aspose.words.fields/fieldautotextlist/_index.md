...
description: Aspose.Words.Fields.FieldAutoTextList 班级. 实现 AUTOTEXTLIST 字段 在 C#.
type: docs
weight: 1620
...
| [ListStyle](../../aspose.words.fields/fieldautotextlist/liststyle/) { get; set; } | 获取或设置包含条目的列表所基于的样式名称。 |
