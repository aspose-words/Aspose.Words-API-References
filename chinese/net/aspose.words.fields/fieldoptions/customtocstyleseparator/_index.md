...
description: 发现 FieldOptions CustomTocStyleSeparator 属性，轻松自定义 FieldToc 字段的样式分隔符，以增强文档导航。
type: docs
weight: 60
...
默认情况下，由 \t 开关定义的自定义样式[`FieldToc`](../../fieldtoc/)字段由取自当前文化的分隔符分隔。 此属性通过指定用户定义的分隔符覆盖该行为。
