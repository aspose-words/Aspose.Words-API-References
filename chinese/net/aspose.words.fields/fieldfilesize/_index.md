...
description: Aspose.Words.Fields.FieldFileSize 班级. 实现 FILESIZE 字段 在 C#.
type: docs
weight: 1880
url: /zh/net/aspose.words.fields/fieldfilesize/
---
## FieldFileSize class
...
| 姓名 | 描述 |
| --- | --- |
| [FieldFileSize](fieldfilesize/)() | 默认构造函数。 |
...
| [IsInKilobytes](../../aspose.words.fields/fieldfilesize/isinkilobytes/) { get; set; } | 获取或设置是否以千字节为单位显示文件大小。 |
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes/) { get; set; } | 获取或设置是否以兆字节为单位显示文件大小。 |
...
检索当前文档文件的大小；如果无法确定大小，则检索 0。

在当前的实现中，使用[`OriginalFileName`](../../aspose.words/document/originalfilename/)属性retrieve 用于确定文件大小的文件名。
