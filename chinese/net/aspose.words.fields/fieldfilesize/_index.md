...
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes/) { get; set; } | 获取或设置是否显示文件大小，以兆字节为单位。 |
...
在当前的实现中，使用[`OriginalFileName`](../../aspose.words/document/originalfilename/)属性来检索 用于确定文件大小的文件名。
