...
description: 探索 Aspose.Words.Fields.FieldFileSize 类，轻松实现 FILESIZE 字段，轻松增强文档管理。
type: docs
weight: 2290
...
| [IsInKilobytes](../../aspose.words.fields/fieldfilesize/isinkilobytes/) { get; set; } | 获取或设置是否以千字节显示文件大小。 |
| [IsInMegabytes](../../aspose.words.fields/fieldfilesize/isinmegabytes/) { get; set; } | 获取或设置是否以兆字节显示文件大小。 |
...
在当前实现中，使用[`OriginalFileName`](../../aspose.words/document/originalfilename/)属性来检索 用于确定文件大小的文件名。
