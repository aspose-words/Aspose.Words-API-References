...
description: 探索 FieldDdeAuto InsertAsHtml 属性。通过将链接对象插入为 HTML 文本，轻松管理链接对象，实现无缝集成和增强功能。
type: docs
weight: 30
url: /zh/net/aspose.words.fields/fieldddeauto/insertashtml/
---
## FieldDdeAuto.InsertAsHtml property

获取或设置是否将链接对象插入为 HTML 格式的文本。
