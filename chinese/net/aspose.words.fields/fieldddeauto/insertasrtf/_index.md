...
description: 发现 FieldDdeAuto InsertAsRtf 属性，轻松管理富文本格式 (RTF) 的链接对象，以增强文档集成和多功能性。
type: docs
weight: 50
url: /zh/net/aspose.words.fields/fieldddeauto/insertasrtf/
---
## FieldDdeAuto.InsertAsRtf property

获取或设置是否以富文本格式 (RTF) 插入链接对象。
