...
description: 探索 Aspose.Words.Fields.FieldDdeAuto 类，实现无缝 DDEAUTO 字段集成，增强项目中的文档自动化和效率。
type: docs
weight: 2200
...
| [InsertAsHtml](../../aspose.words.fields/fieldddeauto/insertashtml/) { get; set; } | 获取或设置是否将链接对象插入为 HTML 格式的文本。 |
| [InsertAsPicture](../../aspose.words.fields/fieldddeauto/insertaspicture/) { get; set; } | 获取或设置是否将链接对象作为图片插入。 |
| [InsertAsRtf](../../aspose.words.fields/fieldddeauto/insertasrtf/) { get; set; } | 获取或设置是否以富文本格式 (RTF) 插入链接对象。 |
| [InsertAsText](../../aspose.words.fields/fieldddeauto/insertastext/) { get; set; } | 获取或设置是否以纯文本格式插入链接对象。 |
| [InsertAsUnicode](../../aspose.words.fields/fieldddeauto/insertasunicode/) { get; set; } | 获取或设置是否将链接对象插入为 Unicode 文本。 |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | 获取或设置字段的当前结果是否由于对文档所做的其他修改而不再正确（陈旧）。 |
| [IsLinked](../../aspose.words.fields/fieldddeauto/islinked/) { get; set; } | 获取或设置是否通过不将图形数据与文档一起存储来减小文件大小。 |
...
对于从其他应用程序复制的信息，此字段使用 DDE 将该信息链接到其原始源文件并自动更新。
