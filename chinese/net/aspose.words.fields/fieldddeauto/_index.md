...
| [InsertAsHtml](../../aspose.words.fields/fieldddeauto/insertashtml) { get; set; } | 获取或设置是否将链接对象作为 HTML 格式文本插入。 |
...
| [IsLinked](../../aspose.words.fields/fieldddeauto/islinked) { get; set; } | 获取或设置是否通过不在文档中存储图形数据来减小文件大小。 |
