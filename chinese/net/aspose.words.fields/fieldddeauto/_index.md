...
| [InsertAsHtml](../../aspose.words.fields/fieldddeauto/insertashtml/) { get; set; } | 获取或设置是否以 HTML 格式文本插入链接对象。 |
...
| [InsertAsUnicode](../../aspose.words.fields/fieldddeauto/insertasunicode/) { get; set; } | 获取或设置是否将链接对象作为 Unicode 文本插入。 |
