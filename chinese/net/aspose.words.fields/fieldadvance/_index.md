...
description: Aspose.Words.Fields.FieldAdvance 班级. 实现 ADVANCE 字段 在 C#.
type: docs
weight: 1540
...
| [HorizontalPosition](../../aspose.words.fields/fieldadvance/horizontalposition/) { get; set; } | 获取或设置字段后面的文本应从列、框架或文本框的左边缘水平移动 的点数。 |
...
| [VerticalPosition](../../aspose.words.fields/fieldadvance/verticalposition/) { get; set; } | 获取或设置字段后面的文本应从页面顶部边缘垂直移动 的点数。 |
