...
| [HorizontalPosition](../../aspose.words.fields/fieldadvance/horizontalposition) { get; set; } | 获取或设置字段后面的文本应从列左边缘水平移动的点数 ，或文本框。 |
...
将显示在词法上跟随字段的文本的起点向右或向左移动, 向上或向下，或到特定的水平或垂直位置。
