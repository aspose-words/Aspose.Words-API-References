...
description: Aspose.Words.Fields.FieldDocVariable 班级. 实现 DOCVARIABLE 字段 在 C#.
type: docs
weight: 1820
url: /zh/net/aspose.words.fields/fielddocvariable/
---
...
| 姓名 | 描述 |
| --- | --- |
| [FieldDocVariable](fielddocvariable/)() | 默认构造函数。 |
...
| [VariableName](../../aspose.words.fields/fielddocvariable/variablename/) { get; set; } | 获取或设置要检索的文档变量的名称。 |
