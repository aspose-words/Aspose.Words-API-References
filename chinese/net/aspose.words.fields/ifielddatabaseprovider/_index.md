...
description: 使用 Aspose.Words.Fields.IFieldDatabaseProvider 接口增强您的文档自动化。无缝地为 FieldDatabase 更新提供数据。
type: docs
weight: 3100
...
实现此接口来为[`FieldDatabase`](../fielddatabase/)字段更新时。
...
| 姓名 | 描述 |
| --- | --- |
| [GetQueryResult](../../aspose.words.fields/ifielddatabaseprovider/getqueryresult/)(*string, string, string, [FieldDatabase](../fielddatabase/)*) | 返回查询结果。 |
