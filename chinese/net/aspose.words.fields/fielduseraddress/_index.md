...
description: 探索 Aspose.Words.Fields.FieldUserAddress 类，以实现 USERADDRESS 字段的无缝集成，增强文档自动化和个性化。
type: docs
weight: 2990
...
| [UserAddress](../../aspose.words.fields/fielduseraddress/useraddress/) { get; set; } | 获取或设置当前用户的邮政地址。 |
