...
description: Aspose.Words.Fields.FieldSaveDate 班级. 实现 SAVEDATE 字段 在 C#.
type: docs
weight: 2350
...
| [UseLunarCalendar](../../aspose.words.fields/fieldsavedate/uselunarcalendar/) { get; set; } | 获取或设置是否使用回历农历或希伯来农历。 |
| [UseSakaEraCalendar](../../aspose.words.fields/fieldsavedate/usesakaeracalendar/) { get; set; } | 获取或设置是否使用Saka Era日历。 |
