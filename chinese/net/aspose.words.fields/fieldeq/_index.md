...
description: Aspose.Words.Fields.FieldEQ 班级. 实现 EQ 字段 在 C#.
type: docs
weight: 1830
...
public void FieldEQ()
{
    ...
    // 这里我们使用文档构建器插入一个 EQ 字段，带有“\f”开关，对应于“Fraction”。
