...
description: Aspose.Words.Fields.FieldNoteRef 班级. 实现 NOTEREF 字段 在 C#.
type: docs
weight: 2200
...
| [InsertHyperlink](../../aspose.words.fields/fieldnoteref/inserthyperlink/) { get; set; } | 获取或设置是否插入书签段落的超链接。 |
