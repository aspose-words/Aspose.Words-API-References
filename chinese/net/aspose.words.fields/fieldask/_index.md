...
description: Aspose.Words.Fields.FieldAsk 班级. 实现 ASK 字段 在 C#.
type: docs
weight: 1560
...
| [PromptOnceOnMailMerge](../../aspose.words.fields/fieldask/promptonceonmailmerge/) { get; set; } | 获取或设置每次邮件合并操作是否应接收一次用户响应。 |
