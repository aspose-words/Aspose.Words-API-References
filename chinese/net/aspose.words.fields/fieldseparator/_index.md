...
description: 表示一个 Word 字段分隔符用于将字段代码与字段结果分开
type: docs
weight: 2190
...
表示一个 Word 字段分隔符，用于将字段代码与字段结果分开。
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldseparator/accept)(DocumentVisitor) | 接受访问者。 |
...
[`FieldSeparator`](../fieldseparator)是一个内联级节点，并由文档中的[`FieldSeparatorChar`](../../aspose.words/controlchar/fieldseparatorchar)控制字符表示 。

[`FieldSeparator`](../fieldseparator)只能是Words的子级。段落。
