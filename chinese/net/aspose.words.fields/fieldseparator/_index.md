...
description: Aspose.Words.Fields.FieldSeparator 班级. 表示一个 Word 字段分隔符用于分隔字段代码和字段结果 在 C#.
type: docs
weight: 2380
...
`FieldSeparator`是一个内联级节点并由 表示[`FieldSeparatorChar`](../../aspose.words/controlchar/fieldseparatorchar/)文档中的控制字符。
