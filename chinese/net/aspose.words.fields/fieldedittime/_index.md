...
description: 探索 Aspose.Words.Fields.FieldEditTime 类，实现高效的文档编辑。使用强大的 EDITTIME 字段管理功能，简化您的工作流程。
type: docs
weight: 2250
...
// 此内置文档属性用于跟踪会议记录。Microsoft Word 使用此属性
// 跟踪文档打开所花费的时间。我们也可以自己编辑它。
...
// 该字段不会实时更新，因此也必须
// 每当我们需要准确的值时，请在 Microsoft Word 中手动更新。
doc.UpdateFields();
