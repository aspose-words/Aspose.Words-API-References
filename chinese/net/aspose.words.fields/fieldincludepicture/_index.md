...
description: 探索 Aspose.Words.Fields.FieldIncludePicture 类，轻松实现 INCLUDEPICTURE 字段，增强文档自动化和图像集成。
type: docs
weight: 2450
...
| [GraphicFilter](../../aspose.words.fields/fieldincludepicture/graphicfilter/) { get; set; } | 获取或设置要插入的图形格式的过滤器的名称。 |
| [IsDirty](../../aspose.words.fields/field/isdirty/) { get; set; } | 获取或设置字段的当前结果是否由于对文档所做的其他修改而不再正确（陈旧）。 |
| [IsLinked](../../aspose.words.fields/fieldincludepicture/islinked/) { get; set; } | 获取或设置是否通过不将图形数据与文档一起存储来减小文件大小。 |
| [IsLocked](../../aspose.words.fields/field/islocked/) { get; set; } | 获取或设置字段是否被锁定（不应重新计算其结果）。 |
| [LocaleId](../../aspose.words.fields/field/localeid/) { get; set; } | 获取或设置字段的 LCID。 |
| [ResizeHorizontally](../../aspose.words.fields/fieldincludepicture/resizehorizontally/) { get; set; } | 获取或设置是否从源水平调整图片大小。 |
