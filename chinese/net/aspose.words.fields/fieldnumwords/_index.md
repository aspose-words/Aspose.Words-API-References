...
description: 探索 Aspose.Words.Fields.FieldNumWords 类，轻松管理文档中的字数统计。使用这个强大的功能增强您的文本处理能力！
type: docs
weight: 2640
url: /zh/net/aspose.words.fields/fieldnumwords/
---
## FieldNumWords class
...
| 姓名 | 描述 |
| --- | --- |
| [FieldNumWords](fieldnumwords/)() | 默认构造函数。 |
