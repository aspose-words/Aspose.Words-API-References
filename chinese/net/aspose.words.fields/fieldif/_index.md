...
description: 探索 Aspose.Words.Fields.FieldIf 类 - 有效实现 IF 字段以增强文档自动化并简化您的工作流程。
type: docs
weight: 2410
...
| [FalseText](../../aspose.words.fields/fieldif/falsetext/) { get; set; } | 获取或设置比较表达式为`错误的`. |
...
| [RightExpression](../../aspose.words.fields/fieldif/rightexpression/) { get; set; } | 获取或设置比较表达式的正确部分。 |
