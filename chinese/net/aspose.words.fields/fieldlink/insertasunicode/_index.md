...
description: 发现 FieldLink InsertAsUnicode 属性，可以轻松地将链接对象作为 Unicode 文本进行管理，从而增强数据兼容性和灵活性。
type: docs
weight: 90
url: /zh/net/aspose.words.fields/fieldlink/insertasunicode/
---
## FieldLink.InsertAsUnicode property

获取或设置是否将链接对象插入为 Unicode 文本。
