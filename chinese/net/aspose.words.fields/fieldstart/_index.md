...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words.fields/fieldstart/accept)(DocumentVisitor) | 接受访问者。 |
...
[`FieldStart`](../fieldstart)是内联级节点，由文档中的 [`FieldStartChar`](../../aspose.words/controlchar/fieldstartchar)控制字符表示。

[`FieldStart`](../fieldstart)只能是Words的子级。段落。
