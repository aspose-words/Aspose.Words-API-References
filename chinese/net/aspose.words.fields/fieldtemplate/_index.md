...
description: 探索 Aspose.Words.Fields.FieldTemplate 类，实现无缝 TEMPLATE 字段。使用强大的功能增强您的文档处理能力！
type: docs
weight: 2900
url: /zh/net/aspose.words.fields/fieldtemplate/
---
## FieldTemplate class
...
| 姓名 | 描述 |
| --- | --- |
| [FieldTemplate](fieldtemplate/)() | 默认构造函数。 |
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | 获取或设置是否包含完整文件路径名。 |
