...
description: Aspose.Words.Fields.FieldTemplate 班级. 实现 TEMPLATE 字段 在 C#.
type: docs
weight: 2490
...
| [IncludeFullPath](../../aspose.words.fields/fieldtemplate/includefullpath/) { get; set; } | 获取或设置是否包含完整的文件路径名。 |
