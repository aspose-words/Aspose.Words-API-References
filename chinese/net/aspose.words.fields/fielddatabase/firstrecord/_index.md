...
description: 探索 FieldDatabase 中的 FirstRecord 属性，轻松管理您的初始数据记录数，实现无缝数据插入并提高效率。
type: docs
weight: 40
url: /zh/net/aspose.words.fields/fielddatabase/firstrecord/
---
## FieldDatabase.FirstRecord property

获取或设置要插入的第一个数据记录的整数记录号。
