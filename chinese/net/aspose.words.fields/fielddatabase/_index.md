...
| [FormatAttributes](../../aspose.words.fields/fielddatabase/formatattributes) { get; set; } | 获取或设置格式的哪些属性将应用于表。 |
| [InsertHeadings](../../aspose.words.fields/fielddatabase/insertheadings) { get; set; } | 获取或设置是否将数据库中的字段名称作为列标题插入到 结果表中。 |
