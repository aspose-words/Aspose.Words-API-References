...
description: FieldToa UsePassim 财产. 获取或设置是否将对同一 权威的五个或更多不同页面引用替换为passim用于指示某个单词或段落在引用的作品中频繁出现  在 C#.
type: docs
weight: 110
...
获取或设置是否将对同一 权威的五个或更多不同页面引用替换为“passim”，用于指示某个单词或段落在引用的作品中频繁出现 。
