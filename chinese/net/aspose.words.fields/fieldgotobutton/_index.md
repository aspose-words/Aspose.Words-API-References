...
description: 探索 Aspose.Words.Fields.FieldGoToButton 类，实现与 GOTOBUTTON 字段的无缝导航。立即增强您的文档交互性！
type: docs
weight: 2380
...
| [DisplayText](../../aspose.words.fields/fieldgotobutton/displaytext/) { get; set; } | 获取或设置文档中出现的“按钮”的文本，以便可以选择它来激活跳转。 |
...
| [Location](../../aspose.words.fields/fieldgotobutton/location/) { get; set; } | 获取或设置书签名称、页码或其他要跳转的项目。 |
...
插入跳转命令，这样当它被激活时，文档的插入点就移动到指定位置。
