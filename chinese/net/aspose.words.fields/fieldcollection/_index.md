...
description: Field./field对象的集合表示指定范围内的字段
type: docs
weight: 1520
...
[`FieldCollection`](../fieldcollection)集合不拥有它包含的字段，而只是一个选择字段。

[`FieldCollection`](../fieldcollection)集合是“活的”，即更改节点对象的子对象:创建它的::47:::立即反映在[`FieldCollection`](../fieldcollection) 属性和方法返回的字段中。
