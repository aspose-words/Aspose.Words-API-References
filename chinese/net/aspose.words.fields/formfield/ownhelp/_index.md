...
description: 探索 FormField OwnHelp 属性。当用户在焦点表单域上按下 F1 键时，通过自定义帮助消息轻松提升用户体验。
type: docs
weight: 150
...
指定当表单字段具有焦点并且用户按下 F1 时显示在消息框中的文本的来源。
...
如果`真的` ，由指定的文本[`HelpText`](../helptext/)属性显示。 如果`错误的` ，由指定的自动图文集条目中的文本[`HelpText`](../helptext/)属性被显示。
