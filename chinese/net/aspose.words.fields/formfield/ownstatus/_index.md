...
description: 了解当表单字段获得焦点时 FormField OwnStatus 属性如何通过自定义状态栏文本来增强用户体验。
type: docs
weight: 160
...
如果`真的` ，由指定的文本[`StatusText`](../statustext/)属性显示。 如果`错误的`，由指定的自动图文集条目的文本[`StatusText`](../statustext/)属性被显示。
