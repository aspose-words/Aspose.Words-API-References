...
description: FormField CalculateOnExit 财产. 如果对指定表单字段的引用在退出字段时自动更新则为真 在 C#.
type: docs
weight: 10
...
环境**计算退出**仅在 在 Microsoft Word 中打开文档时影响表单域的行为。 Aspose.Words 从不将references 更新到表单字段。
