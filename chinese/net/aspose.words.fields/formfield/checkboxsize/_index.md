...
description: 获取或设置复选框的大小以磅为单位仅当IsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsize为真时有效
type: docs
weight: 20
...
获取或设置复选框的大小（以磅为单位）。仅当[`IsCheckBoxExactSize`](../ischeckboxexactsize)为真时有效。
...
显示如何插入不同类型的表单字段到文档中，并使用文档访问者实现来处理它们。
