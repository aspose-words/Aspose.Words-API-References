...
description: 获取或设置复选框的大小以磅为单位仅在以下情况下生效IsCheckBoxExactSizeaspose.words.fields/formfield/ischeckboxexactsize/是真的
type: docs
weight: 20
...
获取或设置复选框的大小（以磅为单位）。仅在以下情况下生效[`IsCheckBoxExactSize`](../ischeckboxexactsize/)是真的。
