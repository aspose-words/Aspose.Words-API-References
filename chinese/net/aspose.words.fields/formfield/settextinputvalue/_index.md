...
description: 应用TextInputFormataspose.words.fields/formfield/textinputformat中指定的文本格式并将值存储在R5 中PAspose.Words.Fields.FormField.Result
type: docs
weight: 250
...
应用[`TextInputFormat`](../textinputformat)中指定的文本格式并将值存储在:::R5 中:P:Aspose.Words.Fields.FormField.Result:::。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| newValue | Object | 可以是字符串、数字或 DateTime 对象。 |

### 评论

[`TextInputDefault`](../textinputdefault)值适用于*newValue*是` null` 。
