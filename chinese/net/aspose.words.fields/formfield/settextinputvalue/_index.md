...
description: 应用指定的文本格式TextInputFormataspose.words.fields/formfield/textinputformat/并将值存储在Resultaspose.words.fields/formfield/result/.
type: docs
weight: 250
...
应用指定的文本格式[`TextInputFormat`](../textinputformat/)并将值存储在[`Result`](../result/).
...
这[`TextInputDefault`](../textinputdefault/)如果应用值*newValue*是`无效的`.
