...
description: FormField StatusText 财产. 返回或设置表单域获得焦点时在状态栏中显示的文本 在 C#.
type: docs
weight: 180
...
如果 OwnStatus 属性设置为 true，则 StatusText 属性指定状态栏文本。 如果 OwnStatus 属性设置为 false，则 StatusText 属性指定包含表单域状态栏文本的 AutoText 条目的名称。
