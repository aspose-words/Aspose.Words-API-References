...
description: 探索 FormField StatusText 属性，自定义表单字段聚焦时的状态栏消息。轻松提升用户体验！
type: docs
weight: 180
...
如果[`OwnStatus`](../ownstatus/)属性设置为`真的`， 这`StatusText`属性指定状态栏文本。 如果[`OwnStatus`](../ownstatus/)属性设置为`错误的`， 这`StatusText`属性指定包含表单字段的状态栏文本的 AutoText 条目的名称。
