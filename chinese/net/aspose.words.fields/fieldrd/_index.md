...
description: 探索 Aspose.Words.Fields.FieldRD 类 - 有效实现 RD 字段，以增强项目中的文档处理和自动化。
type: docs
weight: 2730
...
| [FileName](../../aspose.words.fields/fieldrd/filename/) { get; set; } | 获取或设置生成目录、引文表或索引时要包含的文件的名称。 |
...
标识创建目录、引文表或索引时要包含的文件 其中包含 TOC、TOA 或 INDEX 字段
