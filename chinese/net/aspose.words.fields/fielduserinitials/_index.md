...
description: Aspose.Words.Fields.FieldUserInitials 班级. 实现 USERINITIALS 字段 在 C#.
type: docs
weight: 2590
...
| [UserInitials](../../aspose.words.fields/fielduserinitials/userinitials/) { get; set; } | 获取或设置当前用户的姓名缩写。 |
