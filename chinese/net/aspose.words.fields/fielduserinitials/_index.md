...
description: 探索 Aspose.Words.Fields.FieldUserInitials 类，轻松实现 USERINITIALS 字段，增强文档个性化和用户参与度。
type: docs
weight: 3000
url: /zh/net/aspose.words.fields/fielduserinitials/
---
...
| 姓名 | 描述 |
| --- | --- |
| [FieldUserInitials](fielduserinitials/)() | 默认构造函数。 |
...
| [UserInitials](../../aspose.words.fields/fielduserinitials/userinitials/) { get; set; } | 获取或设置当前用户的姓名首字母。 |
