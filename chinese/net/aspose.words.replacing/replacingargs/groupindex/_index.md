...
description: 按索引标识Matchaspose.words.replacing/replacingargs/match47中的捕获组将被替换为Replacementaspose.words.replacing/replacingargs/replacement字符串
type: docs
weight: 10
...
按索引标识[`Match`](../match):::47::中的捕获组:将被替换为[`Replacement`](../replacement)字符串。
