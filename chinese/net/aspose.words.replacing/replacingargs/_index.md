...
| 姓名 | 描述 |
| --- | --- |
| [GroupIndex](../../aspose.words.replacing/replacingargs/groupindex) { get; set; } | 按索引标识[`Match`](./match)中的捕获组:将被替换为PAspose.Words.Replacing.ReplacingArgs.Replacement字符串。 |
| [GroupName](../../aspose.words.replacing/replacingargs/groupname) { get; set; } | 按名称标识[`Match`](./match)中的捕获组:将被替换为PAspose.Words.Replacing.ReplacingArgs.Replacement字符串。 |
