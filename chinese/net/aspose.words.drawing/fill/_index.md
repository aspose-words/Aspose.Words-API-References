...
description: 探索 Aspose.Words.Drawing.Fill 类以获得高级填充格式选项，轻松增强您的文档设计和视觉吸引力。
type: docs
weight: 1270
...
| 姓名 | 描述 |
| --- | --- |
| [BackColor](../../aspose.words.drawing/fill/backcolor/) { get; set; } | 获取或设置代表填充背景颜色的 Color 对象。 |
| [BackThemeColor](../../aspose.words.drawing/fill/backthemecolor/) { get; set; } | 获取或设置代表填充背景颜色的 ThemeColor 对象。 |
| [BackTintAndShade](../../aspose.words.drawing/fill/backtintandshade/) { get; set; } | 获取或设置使背景颜色变亮或变暗的双精度值。 |
| [BaseForeColor](../../aspose.words.drawing/fill/baseforecolor/) { get; } | 获取表示填充的基本前景色的 Color 对象，不带任何修饰符。 |
| [Color](../../aspose.words.drawing/fill/color/) { get; set; } | 获取或设置代表填充前景色的 Color 对象。 |
| [FillType](../../aspose.words.drawing/fill/filltype/) { get; } | 获取填充类型。 |
| [ForeColor](../../aspose.words.drawing/fill/forecolor/) { get; set; } | 获取或设置代表填充前景色的 Color 对象。 |
| [ForeThemeColor](../../aspose.words.drawing/fill/forethemecolor/) { get; set; } | 获取或设置代表填充前景色的 ThemeColor 对象。 |
...
| [GradientStops](../../aspose.words.drawing/fill/gradientstops/) { get; } | 获取[`GradientStop`](../gradientstop/)填充的对象。 |
...
| [Opacity](../../aspose.words.drawing/fill/opacity/) { get; set; } | 获取或设置指定填充的不透明度，其值为 0.0（透明）至 1.0（不透明）之间的值。 |
...
| [Transparency](../../aspose.words.drawing/fill/transparency/) { get; set; } | 获取或设置指定填充的透明度，值为 0.0（不透明）和 1.0（透明）之间的值。 |
...
| 姓名 | 描述 |
| --- | --- |
| [OneColorGradient](../../aspose.words.drawing/fill/onecolorgradient/#onecolorgradient)(*[GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/), double*) | 将指定的填充设置为单色渐变。 |
...
| [Patterned](../../aspose.words.drawing/fill/patterned/#patterned)(*[PatternType](../patterntype/)*) | 将指定的填充设置为图案。 |
| [Patterned](../../aspose.words.drawing/fill/patterned/#patterned_1)(*[PatternType](../patterntype/), Color, Color*) | 将指定的填充设置为图案。 |
...
| [TwoColorGradient](../../aspose.words.drawing/fill/twocolorgradient/#twocolorgradient)(*[GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/)*) | 将指定的填充设置为双色渐变。 |
| [TwoColorGradient](../../aspose.words.drawing/fill/twocolorgradient/#twocolorgradient_1)(*Color, Color, [GradientStyle](../gradientstyle/), [GradientVariant](../gradientvariant/)*) | 将指定的填充设置为双色渐变。 |

## 评论

使用[`Fill`](../shapebase/fill/)或者[`Fill`](../../aspose.words/font/fill/)属性来访问对象的填充属性。 您不创建`Fill`直接上课。
