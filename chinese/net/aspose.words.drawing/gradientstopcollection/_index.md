...
description: Aspose.Words.Drawing.GradientStopCollection 班级. 包含一个集合GradientStop对象 在 C#.
type: docs
weight: 990
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.words.drawing/gradientstopcollection/add/)(*[GradientStop](../gradientstop/)*) | 添加一个指定的[`GradientStop`](../gradientstop/)到一个渐变. |
