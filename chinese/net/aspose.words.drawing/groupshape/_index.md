...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words.drawing/groupshape/accept)(DocumentVisitor) | 接受访问者。 |
...
A[`GroupShape`](../groupshape)是一个复合节点，可以有[`Shape`](../shape)和 [`GroupShape`](../groupshape)节点为孩子们。

每个[`GroupShape`](../groupshape)为其子形状定义一个新的坐标系。 坐标系使用[`CoordSize`](../shapebase/coordsize)和 CoordOrigin属性。
