...
调用[`VisitShapeStart`](../../../aspose.words/documentvisitor/visitshapestart), 然后为形状的所有子节点调用[`Accept`](../../../aspose.words/node/accept) 并调用[`VisitShapeEnd`](../../../aspose.words/documentvisitor/visitshapeend)最后。
