...
description: Aspose.Words.Drawing.Shape 班级. 表示绘图层中的对象例如自选图形文本框自由格式OLE 对象ActiveX 控件或图片
type: docs
weight: 1100
...
| [Chart](../../aspose.words.drawing/shape/chart/) { get; } | 如果此形状有图表，则提供对图表属性的访问。 |
...
| [Filled](../../aspose.words.drawing/shape/filled/) { get; set; } | 确定形状的闭合路径是否会被填充。 |
...
| [HasChart](../../aspose.words.drawing/shape/haschart/) { get; } | 如果此 Shape 有一个[`Chart`](./chart/). |
...
| [SignatureLine](../../aspose.words.drawing/shape/signatureline/) { get; } | 获取[`SignatureLine`](./signatureline/)如果形状是签名线，则对象。退货 **无效的**否则。 |
...
| [StrokeColor](../../aspose.words.drawing/shape/strokecolor/) { get; set; } | 定义笔画的颜色。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words.drawing/shape/accept/)(DocumentVisitor) | 接受访客。 |
