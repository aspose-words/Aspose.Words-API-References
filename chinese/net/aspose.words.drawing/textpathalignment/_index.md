...
description: 探索 Aspose.Words.Drawing.TextPathAlignment 枚举，实现精确的艺术字对齐。使用丰富的文本选项增强您的文档设计！
type: docs
weight: 1770
...
| 姓名 | 价值 | 描述 |
| --- | --- | --- |
| Stretch | `0` | 拉伸每行文本以适应宽度。 |
| Center | `1` | 文本居中，宽度居中。 |
| Left | `2` | 左对齐。 |
| Right | `3` | 右对齐。 |
| LetterJustify | `4` | 展开字母以适合宽度。 |
| WordJustify | `5` | 展开单词以适应宽度。 |
