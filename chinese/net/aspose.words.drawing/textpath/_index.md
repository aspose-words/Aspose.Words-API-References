...
| [Size](../../aspose.words.drawing/textpath/size) { get; set; } | 以磅为单位定义字体的大小。 |
...
| [StrikeThrough](../../aspose.words.drawing/textpath/strikethrough) { get; set; } | 如果字体格式设置为删除线文本，则为真。 |
...
| [Underline](../../aspose.words.drawing/textpath/underline) { get; set; } | 如果字体有下划线，则为真。 |
| [XScale](../../aspose.words.drawing/textpath/xscale) { get; set; } | 确定是否将使用直文本路径而不是形状路径。 |

### 评论

使用[`TextPath`](../shape/textpath)属性来访问形状的艺术字属性。 您不会直接创建[`TextPath`](../textpath)类的实例。
