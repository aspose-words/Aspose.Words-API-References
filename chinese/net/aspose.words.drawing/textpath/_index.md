...
| 姓名 | 描述 |
| --- | --- |
| [Bold](../../aspose.words.drawing/textpath/bold/) { get; set; } | 如果字体格式为粗体，则为 True。 |
...
| [Italic](../../aspose.words.drawing/textpath/italic/) { get; set; } | 如果字体格式为斜体，则为 True。 |
...
| [SameLetterHeights](../../aspose.words.drawing/textpath/sameletterheights/) { get; set; } | 确定所有字母是否具有相同的高度，无论初始大小写如何。 |
| [Shadow](../../aspose.words.drawing/textpath/shadow/) { get; set; } | 定义是否将阴影应用于文本路径上的文本。 |
| [Size](../../aspose.words.drawing/textpath/size/) { get; set; } | 定义字体大小（以磅为单位）。 |
| [SmallCaps](../../aspose.words.drawing/textpath/smallcaps/) { get; set; } | 如果字体格式为小写大写字母，则为 True。 |
| [Spacing](../../aspose.words.drawing/textpath/spacing/) { get; set; } | 定义文本的间距量。 1 表示 100%. |
| [StrikeThrough](../../aspose.words.drawing/textpath/strikethrough/) { get; set; } | 如果字体格式为删除线文本，则为 True。 |
...
| [Trim](../../aspose.words.drawing/textpath/trim/) { get; set; } | 确定是否删除文本上方和下方的额外空格。 |
