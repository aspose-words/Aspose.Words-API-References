...
description: 探索 TextPath SameLetterHeights 属性以确保统一的字母高度，增强整个项目的文本可读性和设计一致性。
type: docs
weight: 100
url: /zh/net/aspose.words.drawing/textpath/sameletterheights/
---
## TextPath.SameLetterHeights property

确定所有字母是否具有相同的高度，无论首字母大小写如何。
