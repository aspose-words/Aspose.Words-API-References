...
description: ShapeBase IsWordArt 财产. 如果此形状是艺术字对象则返回 true 在 C#.
type: docs
weight: 360
url: /zh/net/aspose.words.drawing/shapebase/iswordart/
---
## ShapeBase.IsWordArt property

如果此形状是艺术字对象，则返回 true。
...
工作到 2007 年兼容模式。 在 2010 年和更高的兼容模式下，艺术字只是一个带有精美字体的文本框。
