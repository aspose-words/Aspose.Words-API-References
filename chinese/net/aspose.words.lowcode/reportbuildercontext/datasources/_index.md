...
description: 探索 ReportBuilderContext 的 DataSources 属性，以便使用根据您的需求定制的多功能数据源来无缝创建报告。
type: docs
weight: 20
url: /zh/net/aspose.words.lowcode/reportbuildercontext/datasources/
---
...
键代表数据源，值是数据源名称。 数据源名称可以为 null 或空字符串； 在这种情况下，报表引擎将自动从指定的数据源中检测数据源名称。
