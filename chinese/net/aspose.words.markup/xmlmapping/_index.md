...
description: Aspose.Words.Markup.XmlMapping 班级. 指定用于在 parent 结构化文档标记和存储在文档的自定义 XML 数据部分中的 XML 元素之间建立映射的信息 在 C#.
type: docs
weight: 4100
...
| [SetMapping](../../aspose.words.markup/xmlmapping/setmapping/)(*[CustomXmlPart](../customxmlpart/), string, string*) | 设置父结构化文档标记和自定义 XML 数据部分的 XML 节点之间的映射。 |
