...
description: 了解如何管理 CustomXmlPart Id 属性，以便轻松识别和自定义 OOXML 文档中的 XML 部分，从而增强文档管理。
type: docs
weight: 40
...
ISO/IEC 29500 规定此值必须是 GUID，但旧版本的 Microsoft Word 允许此处使用任何 字符串。Aspose.Words 对 ECMA-376 格式也允许使用任何 字符串。但请注意，Microsoft Word Online 无法使用 打开使用非 GUID 值创建的文档。因此，GUID 是此属性的首选值。

有效值必须是此文档中所有自定义 XML 数据部分中唯一的标识符。
