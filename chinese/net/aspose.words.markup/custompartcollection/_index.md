...
description: 表示CustomPart./custompart对象的集合
type: docs
weight: 3620
...
表示[`CustomPart`](../custompart)对象的集合。
...
通常不需要创建此类的实例。您可以通过[`PackageCustomParts`](../../aspose.words/document/packagecustomparts)属性访问与 OOXML 包相关的自定义部件 。
