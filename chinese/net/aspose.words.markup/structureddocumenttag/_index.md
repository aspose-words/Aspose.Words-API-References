...
description: Aspose.Words.Markup.StructuredDocumentTag 班级. 表示文档中的结构化文档标签SDT 或内容控制 在 C#.
type: docs
weight: 4060
...
| 姓名 | 描述 |
| --- | --- |
| [StructuredDocumentTag](structureddocumenttag/)(*[DocumentBase](../../aspose.words/documentbase/), [SdtType](../sdttype/), [MarkupLevel](../markuplevel/)*) | 初始化一个新实例**结构化文档标签**类. |
