...
description: Aspose.Words.Markup.StructuredDocumentTag 班级. 表示文档中的结构化文档标签SDT 或内容控件
type: docs
weight: 3820
...
| 姓名 | 描述 |
| --- | --- |
| [StructuredDocumentTag](structureddocumenttag/)(DocumentBase, SdtType, MarkupLevel) | 初始化 **结构化文档标签**类. |
