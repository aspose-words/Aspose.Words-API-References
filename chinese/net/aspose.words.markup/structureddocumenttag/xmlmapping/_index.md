...
description: 了解 StructuredDocumentTag XmlMapping 属性如何将您的标签连接到 XML 数据，从而增强文档定制和集成，实现无缝工作流程。
type: docs
weight: 320
...
获取一个对象，该对象表示此结构化文档标签到当前文档的自定义 XML 部分中的 XML 数据的映射。
...
您可以使用[`SetMapping`](../../xmlmapping/setmapping/)此对象的方法将结构化文档标签映射到 XML 数据。
