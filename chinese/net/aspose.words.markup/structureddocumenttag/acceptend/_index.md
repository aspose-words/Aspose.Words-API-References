...
description: 探索 StructuredDocumentTag AcceptEnd 方法——有效管理结构化文档末尾的访问者交互，实现无缝处理。
type: docs
weight: 340
url: /zh/net/aspose.words.markup/structureddocumenttag/acceptend/
---
## StructuredDocumentTag.AcceptEnd method

接受访问者访问 StructuredDocumentTag 的末尾。
