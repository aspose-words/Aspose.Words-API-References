...
description: StructuredDocumentTag Placeholder 财产. 获取BuildingBlock包含当此 SDT 运行内容为空时应显示的占位符文本 关联的映射 XML 元素为空如通过XmlMappingelement 或IsShowingPlaceholderText元素为真 在 C#.
type: docs
weight: 230
