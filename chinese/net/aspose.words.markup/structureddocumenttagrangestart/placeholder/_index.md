...
获取[`BuildingBlock`](../../../aspose.words.buildingblocks/buildingblock/)包含当 此结构化文档标记运行内容为空时应显示的占位符文本，关联的映射 XML 元素为空，如指定的 所示[`XmlMapping`](../xmlmapping/)元素或[`IsShowingPlaceholderText`](../isshowingplaceholdertext/)元素是`真的`。
