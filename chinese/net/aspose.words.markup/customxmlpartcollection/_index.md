...
description: Aspose.Words.Markup.CustomXmlPartCollection 班级. 表示自定义 XML 部件的集合项目是CustomXmlPart对象 在 C#.
type: docs
weight: 3930
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.words.markup/customxmlpartcollection/add/#add_1)(*[CustomXmlPart](../customxmlpart/)*) | 将一个项目添加到集合中。 |
