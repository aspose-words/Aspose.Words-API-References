...
使用 XML 架构定义文件使用 XML 文件中的数据创建新数据源。默认选项 用于 XML 数据加载。
...
使用 XML 模式定义流使用 XML 流中的数据创建新数据源。默认选项 用于 XML 数据加载。
...
使用指定的 XML 数据加载选项使用来自 XML 文件的数据创建新数据源。
...
使用 XML 架构定义文件使用 XML 文件中的数据创建新数据源。指定的 选项用于 XML 数据加载。
...
使用 XML 模式定义流使用 XML 流中的数据创建新数据源。指定的 选项用于 XML 数据加载。
