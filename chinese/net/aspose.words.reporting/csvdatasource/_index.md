...
| [CsvDataSource](csvdatasource/#constructor_1)(*Stream, [CsvDataLoadOptions](../csvdataloadoptions/)*) | 使用用于解析 CSV 数据的指定选项，使用来自 CSV 流的数据创建新数据源。 |
| [CsvDataSource](csvdatasource/#constructor_3)(*string, [CsvDataLoadOptions](../csvdataloadoptions/)*) | 使用用于解析 CSV 数据的指定选项使用 CSV 文件中的数据创建新数据源。 |
