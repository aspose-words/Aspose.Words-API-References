...
| 姓名 | 描述 |
| --- | --- |
| [Table](table/)(*[DocumentBase](../../aspose.words/documentbase/)*) | 初始化**桌子**类. |
...
| [DistanceBottom](../../aspose.words.tables/table/distancebottom/) { get; set; } | 获取表格底部和周围文本之间的距离，以磅为单位。 |
| [DistanceLeft](../../aspose.words.tables/table/distanceleft/) { get; set; } | 获取表格左侧与周围文本之间的距离，以磅为单位。 |
| [DistanceRight](../../aspose.words.tables/table/distanceright/) { get; set; } | 获取表格右侧和周围文本之间的距离，以磅为单位。 |
| [DistanceTop](../../aspose.words.tables/table/distancetop/) { get; set; } | 获取桌面和周围文本之间的距离，以磅为单位。 |
...
| [SetBorder](../../aspose.words.tables/table/setborder/)(*[BorderType](../../aspose.words/bordertype/), [LineStyle](../../aspose.words/linestyle/), double, Color, bool*) | 将指定的表格边框设置为指定的线型、宽度和颜色。 |
| [SetBorders](../../aspose.words.tables/table/setborders/)(*[LineStyle](../../aspose.words/linestyle/), double, Color*) | 将所有表格边框设置为指定的线型、宽度和颜色。 |
| [SetShading](../../aspose.words.tables/table/setshading/)(*[TextureIndex](../../aspose.words/textureindex/), Color, Color*) | 为整个表的指定值设置底纹。 |
