...
description: Aspose.Words.Tables.Table 班级. 表示 Word 文档中的表格
type: docs
weight: 6340
...
| 姓名 | 描述 |
| --- | --- |
| [Table](table/)(DocumentBase) | 初始化一个新实例`Table`类. |
...
| [SetBorder](../../aspose.words.tables/table/setborder/)(BorderType, LineStyle, double, Color, bool) | 将指定的表格边框设置为指定的线条样式、宽度和颜色。 |
| [SetBorders](../../aspose.words.tables/table/setborders/)(LineStyle, double, Color) | 将所有表格边框设置为指定的线条样式、宽度和颜色。 |
| [SetShading](../../aspose.words.tables/table/setshading/)(TextureIndex, Color, Color) | 将整个表的底纹设置为指定值。 |
