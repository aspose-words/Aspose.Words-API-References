...
description: 探索 Table Accept 方法，实现无缝访客管理。轻松提升用户体验，简化交互！
type: docs
weight: 350
...
呼叫[`VisitTableStart`](../../../aspose.words/documentvisitor/visittablestart/)，然后调用[`Accept`](../../../aspose.words/node/accept/)对于 section 的所有子节点并调用[`VisitTableEnd`](../../../aspose.words/documentvisitor/visittableend/)在最后。
