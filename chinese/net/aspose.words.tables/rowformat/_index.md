...
| [HeadingFormat](../../aspose.words.tables/rowformat/headingformat) { get; set; } | 当表格跨越多页时，如果该行作为表格标题在每一页上重复，则为真。 |
| [Height](../../aspose.words.tables/rowformat/height) { get; set; } | 获取或设置表格行的高度（以磅为单位）。 |
| [HeightRule](../../aspose.words.tables/rowformat/heightrule) { get; set; } | 获取或设置确定表格行高的规则。 |
