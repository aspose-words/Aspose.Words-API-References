...
description: Aspose.Words.Tables.Cell 班级. 表示一个表格单元格 在 C#.
type: docs
weight: 6240
...
| 姓名 | 描述 |
| --- | --- |
| [Cell](cell/)(*[DocumentBase](../../aspose.words/documentbase/)*) | 初始化**细胞**类. |
...
| [NextCell](../../aspose.words.tables/cell/nextcell/) { get; } |  |
...
| [PreviousCell](../../aspose.words.tables/cell/previouscell/) { get; } |  |
