...
description: Aspose.Words.Tables.RowCollection 班级. 提供对集合的类型化访问Row节点 在 C#.
type: docs
weight: 6320
...
| [Item](../../aspose.words.tables/rowcollection/item/) { get; } | 检索[`Row`](../row/)在给定的索引. (2 indexers) |
...
| [ToArray](../../aspose.words.tables/rowcollection/toarray/#toarray_1)() | 将集合中的所有行复制到新的行数组。 (2 methods) |
