...
description: 探索 Aspose.Words.Tables.RowCollection，高效访问 Row 节点。使用我们强大的类型化集合功能，增强文档处理能力。
type: docs
weight: 7170
...
| [Item](../../aspose.words.tables/rowcollection/item/) { get; } | 检索[`Row`](../row/)在给定的索引处。 (2 indexers) |
