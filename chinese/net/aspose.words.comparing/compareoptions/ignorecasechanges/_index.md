...
description: CompareOptions IgnoreCaseChanges 财产. True 表示文档比较不区分大小写 默认情况下比较区分大小写 在 C#.
type: docs
weight: 40
url: /zh/net/aspose.words.comparing/compareoptions/ignorecasechanges/
---
## CompareOptions.IgnoreCaseChanges property

True 表示文档比较不区分大小写。 默认情况下比较区分大小写。
