...
description: 探索 WebExtensionReference Id 属性——目录提供商中 Web 扩展程序的唯一标识符。立即提升您的扩展程序的可见性！
type: docs
weight: 20
url: /zh/net/aspose.words.webextensions/webextensionreference/id/
---
## WebExtensionReference.Id property

与目录提供商内的 Web 扩展关联的标识符。
