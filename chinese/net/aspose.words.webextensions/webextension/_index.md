...
description: 探索 Aspose.Words.WebExtensions.WebExtension 类，这是您在文档中创建动态 Web 扩展的首选解决方案。轻松增强功能！
type: docs
weight: 7590
...
| 姓名 | 描述 |
| --- | --- |
| [AlternateReferences](../../aspose.words.webextensions/webextension/alternatereferences/) { get; } | 指定对 Web 扩展的备用引用。 |
...
| [IsFrozen](../../aspose.words.webextensions/webextension/isfrozen/) { get; set; } | 指定用户是否可以与 Web 扩展进行交互。 |
