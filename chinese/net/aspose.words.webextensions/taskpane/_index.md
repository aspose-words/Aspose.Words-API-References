...
| [IsLocked](../../aspose.words.webextensions/taskpane/islocked/) { get; set; } | 指定任务窗格是否锁定到 UI 中的文档且无法由用户关闭。 |
| [IsVisible](../../aspose.words.webextensions/taskpane/isvisible/) { get; set; } | 指定文档打开时任务窗格是否默认显示为可见。 |
| [Row](../../aspose.words.webextensions/taskpane/row/) { get; set; } | 指定此任务窗格在停靠在同一默认位置的其他 persisted 任务窗格中的索引，从外到内枚举。 |
