...
description: 探索 Aspose.Words.WebExtensions 命名空间，使用可自定义的 XML 元素和属性增强 Office 插件。立即提升您的文档自动化水平！
type: docs
weight: 310
url: /zh/net/aspose.words.webextensions/
---
这**Aspose.Words.WebExtensions**命名空间提供了允许 to 自定义元素和属性的类，这些元素和属性扩展了用于表示 Office 加载项的 XML 词汇表。
...
| [WebExtensionReference](./webextensionreference/) | 表示对 Web 扩展的引用。该引用用于识别 扩展的提供程序位置和版本。 |
...
| [WebExtensionBindingType](./webextensionbindingtype/) | 枚举 Web 扩展和文档中的数据之间的可用绑定类型。 |
| [WebExtensionStoreType](./webextensionstoretype/) | 枚举 Web 扩展商店的可用类型。 |
