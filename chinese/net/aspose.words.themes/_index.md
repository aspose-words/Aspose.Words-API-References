...
description: Aspose.Words.Themes 命名空间提供允许访问 Microsoft Word 中的主题信息的类文件
type: docs
weight: 260
url: /zh/net/aspose.words.themes/
---
**Aspose.Words.Themes** 命名空间提供允许访问 Microsoft Word 中的主题信息的类文件。
...
| [ThemeColors](./themecolors) | 代表文档主题的配色方案，包含十二种颜色。 |
...
| [ThemeFont](./themefont) | 指定文档主题的主题字体名称的类型。 |
