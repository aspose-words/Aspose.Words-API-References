...
description: Aspose.Words.Themes.ThemeFonts 班级. 表示字体方案中字体的集合允许为不同的语言指定不同的字体LatinEastAsian和ComplexScript 在 C#.
type: docs
weight: 6500
...
表示字体方案中字体的集合，允许为不同的语言指定不同的字体[`Latin`](./latin/),[`EastAsian`](./eastasian/)和[`ComplexScript`](./complexscript/).
