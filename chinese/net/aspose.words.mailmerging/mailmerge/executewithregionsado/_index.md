...
description: 执行从 ADO Recordset 对象到具有邮件合并区域的文档的邮件合并
type: docs
weight: 210
...
执行从 ADO Recordset 对象到具有邮件合并区域的文档的邮件合并。
...
当您打算将 Aspose.Words 类用作:::47 时，此方法很有用:::来自非托管代码的 COM 对象，例如使用 ASP 或 Visual Basic 6.0 构建的应用程序。
...
展示如何使用来自 ADO 数据集的数据编译的多个区域运行邮件合并。
