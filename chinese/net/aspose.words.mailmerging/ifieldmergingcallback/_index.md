...
description: Aspose.Words.MailMerging.IFieldMergingCallback 界面. 如果您想控制在邮件合并操作期间如何将数据插入到合并字段中请实施此接口 在 C#.
type: docs
weight: 3790
...
如果您想控制在邮件合并操作期间如何将数据插入到合并字段中，请实施此接口。
...
| 姓名 | 描述 |
| --- | --- |
| [FieldMerging](../../aspose.words.mailmerging/ifieldmergingcallback/fieldmerging/)(*[FieldMergingArgs](../fieldmergingargs/)*) | 当 Aspose.Words 邮件合并引擎即将向文档中的合并字段插入数据时调用。 |
| [ImageFieldMerging](../../aspose.words.mailmerging/ifieldmergingcallback/imagefieldmerging/)(*[ImageFieldMergingArgs](../imagefieldmergingargs/)*) | 当 Aspose.Words 邮件合并引擎即将将图像插入合并字段时调用。 |
