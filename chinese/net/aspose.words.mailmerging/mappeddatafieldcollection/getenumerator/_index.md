...
description: 探索 MappedDataFieldCollection GetEnumerator 方法，使用强大的字典枚举器高效地迭代您的数据，实现无缝访问。
type: docs
weight: 70
url: /zh/net/aspose.words.mailmerging/mappeddatafieldcollection/getenumerator/
---
