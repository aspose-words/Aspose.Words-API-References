...
description: FieldMergingArgs./fieldmergingargs和ImageFieldMergingArgs的基类
type: docs
weight: 3510
...
[`FieldMergingArgs`](../fieldmergingargs)和ImageFieldMergingArgs的基类。
...
| 姓名 | 描述 |
| --- | --- |
| [Document](../../aspose.words.mailmerging/fieldmergingargsbase/document) { get; } | 返回执行邮件合并的[`Document`](./document)对象。 |
