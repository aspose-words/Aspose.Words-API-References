...
description: 探索 BuildingBlock Gallery 的独特功能，实现高效分类和流畅的用户界面排序。立即提升您的组织效率！
type: docs
weight: 60
...
Microsoft Word 用户界面中的构建块被排列成 库。每个`Gallery`可以有多个类别。每个区块 within a[`Category`](../category/)有一个[`Name`](../name/)。
