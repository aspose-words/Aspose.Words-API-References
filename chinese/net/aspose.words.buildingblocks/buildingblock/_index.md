...
| 姓名 | 描述 |
| --- | --- |
| [BuildingBlock](buildingblock/)(*[GlossaryDocument](../glossarydocument/)*) | 初始化这个类的一个新实例。 |
...
| [Gallery](../../aspose.words.buildingblocks/buildingblock/gallery/) { get; set; } | 指定构建块的第一级分类，用于 分类或用户界面排序。 |
...
| [Type](../../aspose.words.buildingblocks/buildingblock/type/) { get; set; } | 指定积木类型。 |
...
对应于**文档部分**,**docPartPr**和**docPartBody**OOXML 中的元素。
