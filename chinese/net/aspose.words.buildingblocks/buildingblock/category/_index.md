...
description: 探索我们的 BuildingBlock 类别属性，以增强二级分类，简化您的项目并提高组织效率。
type: docs
weight: 30
...
Microsoft Word 用户界面中的构建块被排列成 库。每个[`Gallery`](../gallery/)可以有多个类别。每个区块 within a`Category`有一个[`Name`](../name/)。
