...
description: 探索 BuildingBlock Type 属性，它对于定义项目中的构建块类型至关重要。清晰精准地提升您的设计！
type: docs
weight: 120
url: /zh/net/aspose.words.buildingblocks/buildingblock/type/
---
...
构建块类型可以影响 Microsoft Word 中 构建块的可见性和行为。

对应于**docPartPr.类型** OOXML 中的元素。
