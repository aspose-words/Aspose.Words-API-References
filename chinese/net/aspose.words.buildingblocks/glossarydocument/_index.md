...
| [PageColor](../../aspose.words/documentbase/pagecolor) { get; set; } | 获取或设置文档的页面颜色。此属性是[`BackgroundShape`](../../aspose.words/documentbase/backgroundshape)的更简单版本。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Accept](../../aspose.words.buildingblocks/glossarydocument/accept)(DocumentVisitor) | 接受访问者。 |
...
| [GetBuildingBlock](../../aspose.words.buildingblocks/glossarydocument/getbuildingblock)(BuildingBlockGallery, string, string) | 使用指定的画廊、类别和名称查找构建块。 |
...
一些文档，通常是模板，可以包含自动图文集、自动更正条目 和/或 Building Blocks（也称为 词汇表文档条目 , 文档部分 或 构建块 ）。

要访问构建块，您需要将文档加载到[`Document`](../../aspose.words/document) 目的。构建块将通过[`GlossaryDocument`](../../aspose.words/document/glossarydocument)属性提供。

[`GlossaryDocument`](../glossarydocument)可以包含任意数量的[`BuildingBlock`](../buildingblock)对象。 每个[`BuildingBlock`](../buildingblock)代表一个文档部分。

对应于 **词汇表** 和 **docParts**OOXML 中的 元素。
