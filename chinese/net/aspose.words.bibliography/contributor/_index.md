...
description: 探索 Aspose.Words.Bibliography.Contributor 类，这是管理书目贡献者（包括组织和个人）的首选解决方案。
type: docs
weight: 150
url: /zh/net/aspose.words.bibliography/contributor/
---
## Contributor class

代表参考文献来源贡献者。可以是企业（组织）或人员列表。
