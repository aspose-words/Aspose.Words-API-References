...
description: 探索 Aspose.Words.Bibliography 类，这是您高效、轻松地管理文档中参考书目来源的重要工具。
type: docs
weight: 140
url: /zh/net/aspose.words.bibliography/bibliography/
---
## Bibliography class
...
| 姓名 | 描述 |
| --- | --- |
| [BibliographyStyle](../../aspose.words.bibliography/bibliography/bibliographystyle/) { get; set; } | 获取或设置一个字符串，该字符串表示用于参考书目的活动样式的名称。 |
| [Sources](../../aspose.words.bibliography/bibliography/sources/) { get; } | 获取代表参考书目中包含的所有来源的集合。 |
