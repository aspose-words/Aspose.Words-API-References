...
description: 探索 Aspose.Words.Bibliography.Person 类，用于管理参考文献中的个人贡献者。提升文档的引用准确性！
type: docs
weight: 180
url: /zh/net/aspose.words.bibliography/person/
---
## Person class
...
| 姓名 | 描述 |
| --- | --- |
| [Person](person/)(*string, string, string*) | 初始化`Person`类. |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [First](../../aspose.words.bibliography/person/first/) { get; set; } | 获取或设置一个人的名字。 |
| [Last](../../aspose.words.bibliography/person/last/) { get; set; } | 获取或设置一个人的姓氏。 |
| [Middle](../../aspose.words.bibliography/person/middle/) { get; set; } | 获取或设置一个人的中间名。 |
