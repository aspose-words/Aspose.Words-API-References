...
description: MailMergeSettings ViewMergedData 财产. 指定Microsoft Word 应显示来自已插入合并字段 的指定外部数据源的数据例如预览合并数据默认值为错误的 在 C#.
type: docs
weight: 170
...
指定Microsoft Word 应显示来自已插入合并字段 的指定外部数据源的数据（例如预览合并数据）。默认值为`错误的`.
