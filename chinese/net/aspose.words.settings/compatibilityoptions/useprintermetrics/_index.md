...
description: 使用 CompatibilityOptions 的 UsePrinterMetrics 属性优化打印，实现精准的文档显示。轻松提升性能和质量！
type: docs
weight: 640
...
打印机指标可能因所使用的驱动程序而异。 例如，Windows“Microsoft OpenXPS Class Driver 2”和“Microsoft Print to PDF”提供的指标略有不同。 因此，如果启用此选项，最终文档的布局可能会发生变化。
