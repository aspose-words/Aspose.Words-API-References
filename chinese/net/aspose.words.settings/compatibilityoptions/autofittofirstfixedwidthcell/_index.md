...
description: 了解 AutofitToFirstFixedWidthCell 属性如何通过允许列超过首选宽度以实现最佳显示来增强表格布局。
type: docs
weight: 50
...
在 MS Word 2013 用户界面中，该选项称为“使用 Word 2003 表格自动调整规则”。 实际上，它也会影响固定布局表格的网格计算方式（在某些情况下）。
