...
description: 使用 CompatibilityOptions 中的 OptimizeFor 方法增强您的文档。针对特定的 MS Word 版本定制 Aspose.Words 行为，以获得最佳效果。
type: docs
weight: 720
...
允许优化文档内容以及默认 Aspose.Words 行为以适应特定版本的 MS Word。

使用此方法可以防止 MS Word 在文档加载时显示“兼容模式”功能区。 （请注意，您可能还需要设置[`Compliance`](../../../aspose.words.saving/ooxmlsaveoptions/compliance/)属性 to Iso29500_2008_Transitional或更高。）
