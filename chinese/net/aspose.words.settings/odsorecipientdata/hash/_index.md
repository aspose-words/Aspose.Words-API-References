...
description: 表示此记录的哈希码 有时 Microsoft Word 使用Hashaspose.words.settings/odsorecipientdata/hash/整条记录而不是UniqueTagaspose.words.settings/odsorecipientdata/uniquetag/value. 默认值为 0.
type: docs
weight: 40
