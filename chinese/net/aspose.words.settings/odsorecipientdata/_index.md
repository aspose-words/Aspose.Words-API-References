...
| 姓名 | 描述 |
| --- | --- |
| [Active](../../aspose.words.settings/odsorecipientdata/active/) { get; set; } | 指定执行邮件合并时是否将数据源中的记录导入到文档中。 默认值为`真的`. |
| [Column](../../aspose.words.settings/odsorecipientdata/column/) { get; set; } | 指定数据源中包含当前记录的唯一数据的列。 默认值为 0。 |
| [Hash](../../aspose.words.settings/odsorecipientdata/hash/) { get; set; } | 表示该记录的哈希码。 有时 Microsoft Word 使用[`Hash`](./hash/)整个记录而不是[`UniqueTag`](./uniquetag/)值. 默认值为 0. |
