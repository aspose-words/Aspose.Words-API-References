...
description: 允许在将 Pdf 文档加载到Document../aspose.words/document对象时指定其他选项
type: docs
weight: 3420
...
允许在将 Pdf 文档加载到[`Document`](../../aspose.words/document)对象时指定其他选项。
...
| [SkipPdfImages](../../aspose.words.loading/pdfloadoptions/skippdfimages) { get; set; } | 获取或设置指示在加载 PDF 文档时是否必须跳过图像的标志。默认为假。 |
