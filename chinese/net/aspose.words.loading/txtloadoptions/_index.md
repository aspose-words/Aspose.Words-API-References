...
description: Aspose.Words.Loading.TxtLoadOptions 班级. 允许在加载时指定其他选项Text文档成一个Document对象 在 C#.
type: docs
weight: 3730
...
| 姓名 | 描述 |
| --- | --- |
| [AutoNumberingDetection](../../aspose.words.loading/txtloadoptions/autonumberingdetection/) { get; set; } |  |
