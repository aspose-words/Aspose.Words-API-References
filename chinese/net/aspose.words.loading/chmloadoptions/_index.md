...
description: 允许在将 CHM 文档加载到Document../aspose.words/document对象时指定其他选项
type: docs
weight: 3320
...
允许在将 CHM 文档加载到[`Document`](../../aspose.words/document)对象时指定其他选项。
...
| [OriginalFileName](../../aspose.words.loading/chmloadoptions/originalfilename) { get; set; } | CHM 文件的名称。 默认值为` null` 。 |
