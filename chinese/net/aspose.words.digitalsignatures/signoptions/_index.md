...
| [SignatureLineImage](../../aspose.words.digitalsignatures/signoptions/signaturelineimage) { get; set; } | 将在关联[`SignatureLine`](../../aspose.words.drawing/signatureline)中显示的图像。 默认值为` null` 。 |
