...
description: Aspose.Words.Saving.WordML2003SaveOptions 班级. 可用于在将文档保存到WordML格式.
type: docs
weight: 5680
...
| override [SaveFormat](../../aspose.words.saving/wordml2003saveoptions/saveformat/) { get; set; } | 指定使用此保存选项对象时保存文档的格式。 只能是WordML. |
...
目前仅提供[`SaveFormat`](./saveformat/)属性，但将来可能会添加其他选项。
