...
description: 可用于在将文档保存为WordML格式时指定其他选项
type: docs
weight: 5350
...
| override [SaveFormat](../../aspose.words.saving/wordml2003saveoptions/saveformat) { get; set; } | 如果使用此保存选项对象，则指定保存文档的格式。 只能是WordML。 |
...
目前只提供SaveFormat属性，但将来可能会添加其他选项。
...
builder.Writeln("Hello world!");
 ...
 // 创建一个“WordML2003SaveOptions”对象以传递给文档的“保存”方法
