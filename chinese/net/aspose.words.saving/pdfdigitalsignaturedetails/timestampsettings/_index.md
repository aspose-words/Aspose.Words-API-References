...
description: 发现 PdfDigitalSignatureDetails TimestampSettings 属性，轻松管理数字签名时间戳，从而增强文档安全性和合规性。
type: docs
weight: 70
...
默认值为`无效的`并且数字签名将不带有时间戳。 当此属性设置为有效[`PdfDigitalSignatureTimestampSettings`](../../pdfdigitalsignaturetimestampsettings/)object, 则 PDF 文档中的数字签名将被加盖时间戳。
