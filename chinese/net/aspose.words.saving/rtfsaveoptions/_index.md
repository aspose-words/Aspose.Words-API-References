...
description: Aspose.Words.Saving.RtfSaveOptions 班级. 可用于在将文档保存到Rtf格式 在 C#.
type: docs
weight: 5570
...
| [ExportCompactSize](../../aspose.words.saving/rtfsaveoptions/exportcompactsize/) { get; set; } | 允许缩小输出 RTF 文档的大小，但如果它们包含 RTL（从右到左）文本，则将无法正确显示。 默认值为`错误的`. |
...
| override [SaveFormat](../../aspose.words.saving/rtfsaveoptions/saveformat/) { get; set; } | 指定使用此保存选项对象时保存文档的格式。 只能是Rtf. |
| [SaveImagesAsWmf](../../aspose.words.saving/rtfsaveoptions/saveimagesaswmf/) { get; set; } | 当`真的`所有图像都将保存为 WMF. |
