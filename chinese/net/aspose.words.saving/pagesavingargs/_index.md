...
description: Aspose.Words.Saving.PageSavingArgs 班级. 为PageSaving事件 在 C#.
type: docs
weight: 5380
...
| [PageFileName](../../aspose.words.saving/pagesavingargs/pagefilename/) { get; set; } | 获取或设置文档页面保存到的文件名。 |
