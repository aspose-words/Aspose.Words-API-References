...
description: 获取或设置确定 FloydSteinberg 方法中二值化误差的 value 的阈值 当ImageBinarizationMethodaspose.words.saving/imagebinarizationmethod/是 ImageBinarizationMethod.FloydSteinbergDithering.
type: docs
weight: 150
