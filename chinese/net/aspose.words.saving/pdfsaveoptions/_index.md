...
| 姓名 | 描述 |
| --- | --- |
| [PdfSaveOptions](pdfsaveoptions/)() | 初始化此类的新实例，该实例可用于在 中保存文档Pdf格式. |
...
| [EmbedAttachments](../../aspose.words.saving/pdfsaveoptions/embedattachments/) { get; set; } | 获取或设置一个值，确定是否将附件嵌入到 PDF 文档中。 |
...
| [ExportDocumentStructure](../../aspose.words.saving/pdfsaveoptions/exportdocumentstructure/) { get; set; } | 获取或设置决定是否导出文档结构的值。 |
...
| [ImageCompression](../../aspose.words.saving/pdfsaveoptions/imagecompression/) { get; set; } | 指定文档中所有图像要使用的压缩类型。 |
| [ImlRenderingMode](../../aspose.words.saving/saveoptions/imlrenderingmode/) { get; set; } | 获取或设置一个值，确定如何呈现墨迹 (InkML) 对象。 |
| [InterpolateImages](../../aspose.words.saving/pdfsaveoptions/interpolateimages/) { get; set; } | 指示图像插值是否应由合格读取器执行的标志。 当`错误的`指定后，该标志不会写入输出文档，并且 改为使用阅读器的默认行为。 |
| [JpegQuality](../../aspose.words.saving/pdfsaveoptions/jpegquality/) { get; set; } | 获取或设置决定 PDF 文档内 JPEG 图像质量的值。 |
...
| [OpenHyperlinksInNewWindow](../../aspose.words.saving/pdfsaveoptions/openhyperlinksinnewwindow/) { get; set; } | 获取或设置一个值，该值确定是否强制在浏览器的新窗口（或选项卡）中打开输出 Pdf 文档 中的超链接。 |
...
| [PageMode](../../aspose.words.saving/pdfsaveoptions/pagemode/) { get; set; } | 指定在 PDF 阅读器中打开 PDF 文档时应如何显示。 |
...
| [PreblendImages](../../aspose.words.saving/pdfsaveoptions/preblendimages/) { get; set; } | 获取或设置一个值，确定是否预混合具有黑色背景颜色的透明图像。 |
| [PreserveFormFields](../../aspose.words.saving/pdfsaveoptions/preserveformfields/) { get; set; } | 指定是将 Microsoft Word 表单字段保留为 PDF 中的表单字段还是将其转换为文本。 默认为`错误的`. |
...
| override [SaveFormat](../../aspose.words.saving/pdfsaveoptions/saveformat/) { get; set; } | 指定使用此保存选项对象时保存文档的格式。 只能是Pdf. |
...
| [UseBookFoldPrintingSettings](../../aspose.words.saving/pdfsaveoptions/usebookfoldprintingsettings/) { get; set; } | 获取或设置一个布尔值，指示是否应使用小册子打印布局保存文档， 如果通过指定[`MultiplePages`](../../aspose.words/pagesetup/multiplepages/). |
...
| [ZoomFactor](../../aspose.words.saving/pdfsaveoptions/zoomfactor/) { get; set; } | 获取或设置确定文档缩放系数（以百分比表示）的值。 |
