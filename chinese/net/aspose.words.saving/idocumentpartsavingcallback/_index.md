...
description: 如果您想接收通知并控制 Aspose.Words 在将文档导出到R5 时如何保存文档部分请实现此接口FAspose.Words.SaveFormat.Html 或Epub格式
type: docs
weight: 4830
...
如果您想接收通知并控制 Aspose.Words 在将文档导出到:::R5 时如何保存文档部分，请实现此接口:F:Aspose.Words.SaveFormat.Html::: 或Epub格式。
