...
description: Aspose.Words.Saving.IFontSavingCallback 界面. 如果您想接收通知并控制如何接收通知请实现此接口 Aspose.Words 在将文档导出为 HTML 格式时保存字体 在 C#.
type: docs
weight: 5160
...
| 姓名 | 描述 |
| --- | --- |
| [FontSaving](../../aspose.words.saving/ifontsavingcallback/fontsaving/)(*[FontSavingArgs](../fontsavingargs/)*) | 在 Aspose.Words 即将保存字体资源时调用。 |
