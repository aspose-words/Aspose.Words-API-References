...
description: Aspose.Words.Saving.ICssSavingCallback 界面. 如果您想控制 Aspose.Words 在 将文档保存为 HTML 时如何保存 CSS层叠样式表请实现此接口 在 C#.
type: docs
weight: 5130
...
| 姓名 | 描述 |
| --- | --- |
| [CssSaving](../../aspose.words.saving/icsssavingcallback/csssaving/)(*[CssSavingArgs](../csssavingargs/)*) | 在 Aspose.Words 保存 CSS（层叠样式表）时调用。 |
