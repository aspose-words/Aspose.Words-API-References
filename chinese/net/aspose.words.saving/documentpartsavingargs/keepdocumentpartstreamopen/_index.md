...
默认为` false` 并且 Aspose.Words 将在将文档部分写入其中后关闭您在[`DocumentPartStream`](../documentpartstream)属性中提供的 流。 指定` true` 以保持流打开。请注意主输出流 在调用[`Save`](../../../aspose.words/document/save)或 [`Save`](../../../aspose.words/document/save)永远不会被 Aspose.Words关闭即使`KeepDocumentPartStreamOpen`设置为` false` 。
