...
description: Aspose.Words.Saving.DocumentPartSavingArgs 班级. 为DocumentPartSaving回调 在 C#.
type: docs
weight: 4940
...
| [KeepDocumentPartStreamOpen](../../aspose.words.saving/documentpartsavingargs/keepdocumentpartstreamopen/) { get; set; } | 指定 Aspose.Words 是在保存文档部分后保持流打开还是关闭它。 |
