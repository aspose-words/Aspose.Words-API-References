...
description: Aspose.Words.Saving.IPageSavingCallback 界面. 如果您想控制 Aspose.Words 在 将文档保存为固定页面格式时如何保存单独的页面请实现此接口
type: docs
weight: 4920
...
| 姓名 | 描述 |
| --- | --- |
| [PageSaving](../../aspose.words.saving/ipagesavingcallback/pagesaving/)(PageSavingArgs) | 当 Aspose.Words 将单独的页面保存为固定页面格式时调用。 |
