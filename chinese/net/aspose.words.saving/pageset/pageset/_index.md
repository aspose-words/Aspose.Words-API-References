...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| page | Int32 | 页面从零开始的索引。 |

### 评论

如果遇到不在文档中的页面，渲染时会抛出异常。 MaxValue表示文档的最后一页。
...
XpsSaveOptions xpsOptions = new XpsSaveOptions();
 ...
 // 使用“PageSet”属性选择一组文档页面保存到输出 XPS.
...
如果遇到从文档最后一页开始的范围， 会抛出异常在渲染过程中。 在最后一页之后结束的所有范围都被截断以适合文档。
