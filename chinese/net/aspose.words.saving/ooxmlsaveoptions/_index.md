...
description: Aspose.Words.Saving.OoxmlSaveOptions 班级. 可用于在将文档保存到Docx  DocmDotxDotmor FlatOpc格式 在 C#.
type: docs
weight: 5350
...
| [OoxmlSaveOptions](ooxmlsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | 初始化此类的新实例，该实例可用于将文档保存在Docx , Docm,Dotx,Dotmor FlatOpc格式. |
