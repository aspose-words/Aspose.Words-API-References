...
description: Aspose.Words.Saving.OdtSaveOptions 班级. 可用于在将文档保存到Odtor Ott格式 在 C#.
type: docs
weight: 5330
...
| [OdtSaveOptions](odtsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | 初始化此类的新实例，该实例可用于将文档保存在Odtor Ott格式. |
