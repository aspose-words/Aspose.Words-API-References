...
| override [SaveFormat](../../aspose.words.saving/docsaveoptions/saveformat/) { get; set; } | 指定使用此保存选项对象时保存文档的格式。 可以Doc或者Dot. |
| [SavePictureBullet](../../aspose.words.saving/docsaveoptions/savepicturebullet/) { get; set; } | 当`错误的` , PictureBullet 数据不保存到输出文档。 默认值为`真的`. |
| [SaveRoutingSlip](../../aspose.words.saving/docsaveoptions/saveroutingslip/) { get; set; } | 当`错误的` RoutingSlip 数据不保存到输出文档。 默认值为`真的`. |
