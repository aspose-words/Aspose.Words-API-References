...
description: Aspose.Words.Saving.DocSaveOptions 班级. 可用于在将文档保存到Docor Dot格式 在 C#.
type: docs
weight: 4930
...
| [DocSaveOptions](docsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | 初始化此类的新实例，该实例可用于将文档保存在Docor Dot格式. |
