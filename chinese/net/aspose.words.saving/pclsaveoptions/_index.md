...
description: 探索 Aspose.Words.PclSaveOptions，通过可自定义的 PCL 格式功能增强您的文档保存功能。立即优化您的工作流程！
type: docs
weight: 6180
...
| [FallbackFontName](../../aspose.words.saving/pclsaveoptions/fallbackfontname/) { get; set; } | 如果在打印机和内置字体集合中未找到所需字体，则将使用的字体名称。 |
...
| [RasterizeTransformedElements](../../aspose.words.saving/pclsaveoptions/rasterizetransformedelements/) { get; set; } | 获取或设置一个值，确定在保存到 PCL 文档之前是否应将复杂转换元素 光栅化。 默认值为`真的`. |
| override [SaveFormat](../../aspose.words.saving/pclsaveoptions/saveformat/) { get; set; } | 指定如果使用此保存选项对象，文档将以哪种格式保存。 只能是Pcl. |
...
| 姓名 | 描述 |
| --- | --- |
| [AddPrinterFont](../../aspose.words.saving/pclsaveoptions/addprinterfont/)(*string, string*) | 添加制造商上传到打印机的字体信息。 |
