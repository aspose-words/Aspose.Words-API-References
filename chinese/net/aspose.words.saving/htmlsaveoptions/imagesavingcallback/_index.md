...
description: 使用 HtmlSaveOptions 的 ImageSavingCallback 控制图像保存。优化文档导出为 HTML、MHTML 或 EPUB，以获得无缝的用户体验。
type: docs
weight: 350
url: /zh/net/aspose.words.saving/htmlsaveoptions/imagesavingcallback/
---
## HtmlSaveOptions.ImageSavingCallback property

允许控制将文档保存为 HTML、MHTML 或 EPUB 时如何保存图像。
