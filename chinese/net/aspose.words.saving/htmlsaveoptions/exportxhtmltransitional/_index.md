...
description: HtmlSaveOptions ExportXhtmlTransitional 财产. 指定保存为 HTML 或 MHTML 时是否编写 DOCTYPE 声明 何时真的 在根元素之前的文档中写入 DOCTYPE 声明 默认值为错误的. 保存到 EPUB 或 HTML5 时 Html5  DOCTYPE 声明总是被写入 在 C#.
type: docs
weight: 280
