...
description: Aspose.Words.Saving.HtmlSaveOptions 班级. 可用于在将文档保存到Html  Mhtml或者Epub格式 在 C#.
type: docs
weight: 5110
...
| [HtmlSaveOptions](htmlsaveoptions/#constructor_1)(*[SaveFormat](../../aspose.words/saveformat/)*) | 初始化此类的新实例，该实例可用于将文档 保存在Html,Mhtml 或Epub格式. |
...
| [NavigationMapLevel](../../aspose.words.saving/htmlsaveoptions/navigationmaplevel/) { get; set; } |  |
