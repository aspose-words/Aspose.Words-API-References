...
description: 探索 FontSavingArgs IsSubsettingNeeded 属性，控制字体子集，从而优化字体资源导出。立即增强您的设计工作流程！
type: docs
weight: 70
...
字体可以导出为完整的原始字体文件，也可以将其子集化，仅包含文档中使用的 characters 。子集化可以减少最终字体资源的大小。

默认情况下，Aspose.Words 通过将原始字体文件大小 与指定的大小进行比较来决定是否执行子集[`FontResourcesSubsettingSizeThreshold`](../../htmlsaveoptions/fontresourcessubsettingsizethreshold/) 您可以通过设置`IsSubsettingNeeded`财产。
