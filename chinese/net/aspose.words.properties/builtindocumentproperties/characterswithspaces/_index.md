...
description: 探索 BuiltInDocumentProperties CharactersWithSpaces 属性，该属性可估算字符数（包括空格），以实现高效的文档管理。
type: docs
weight: 50
url: /zh/net/aspose.words.properties/builtindocumentproperties/characterswithspaces/
---
...
Aspose.Words 会在您调用时更新此属性[`UpdateWordCount`](../../../aspose.words/document/updatewordcount/)。
