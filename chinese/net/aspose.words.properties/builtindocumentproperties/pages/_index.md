...
description: 发现 BuiltInDocumentProperties Pages 属性，它可以准确估计文档的页数，从而实现高效的管理和组织。
type: docs
weight: 230
...
Aspose.Words 会在您调用时更新此属性[`UpdatePageLayout`](../../../aspose.words/document/updatepagelayout/)。
