...
该对的第一个元素是String并指定标题名称。 该对的第二个元素是Int32并在:::中指定该标题的文档 部分的计数R5:P:Aspose.Words.Properties.BuiltInDocumentProperties.TitlesOfParts:::属性。

此属性中所有标题对的总计数必须等于:::R5 中的 元素数:P:Aspose.Words.Properties.BuiltInDocumentProperties.TitlesOfParts:::属性。
