...
| [getFieldCount()](#getFieldCount--) | 获取当前行的列数。 |
| [getFieldType(int i)](#getFieldType-int-) | 获取与将返回的 java.lang.Object 的类型相对应的 java.lang.Class 信息[getValue(int)](../../com.aspose.words.net.system.data/idatarecord\#getValue-int-). |
...
获取与将返回的 java.lang.Object 的类型相对应的 java.lang.Class 信息[getValue(int)](../../com.aspose.words.net.system.data/idatarecord\#getValue-int-).
...
**退货:**
 java.lang.Class - 对应于 java.lang.Object 类型的 java.lang.Class 信息，将从中返回[getValue(int)](../../com.aspose.words.net.system.data/idatarecord\#getValue-int-).
