...
| [add(String name)](#add-java.lang.String-) | 创建一个[DataTable](../../com.aspose.words.net.system.data/datatable)使用指定的名称创建对象并将其添加到集合中。 |
...
创建一个[DataTable](../../com.aspose.words.net.system.data/datatable)使用指定的名称创建对象并将其添加到集合中。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| index | int | 从零开始的指数[DataTable](../../com.aspose.words.net.system.data/datatable)找到。 |
