...
**退货：**
boolean - 如果规则被强制执行，则为 true；否则为假。默认为真。
...
**退货：**
[XmlReadMode](../../com.aspose.words.net.system.data/xmlreadmode) - 这[XmlReadMode](../../com.aspose.words.net.system.data/xmlreadmode)用于读取数据。返回值是其中之一[XmlReadMode](../../com.aspose.words.net.system.data/xmlreadmode)常数。
...
**退货：**
[XmlReadMode](../../com.aspose.words.net.system.data/xmlreadmode) - 用于读取数据的 XmlReadMode。返回值是其中之一[XmlReadMode](../../com.aspose.words.net.system.data/xmlreadmode)常数。
...
重置[DataSet](../../com.aspose.words.net.system.data/dataset)到原来的状态。子类应该覆盖[reset()](../../com.aspose.words.net.system.data/dataset\#reset--)恢复一个[DataSet](../../com.aspose.words.net.system.data/dataset)到原来的状态。
