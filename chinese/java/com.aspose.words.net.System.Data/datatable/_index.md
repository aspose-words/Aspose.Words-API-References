...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| tableName | java.lang.String | 给表的名称。如果 tableName 为 null 或空字符串，则在添加到[DataTableCollection](../../com.aspose.words.net.system.data/datatablecollection). |
...
**退货：**
布尔值 -`true`是列可以通过给定找到`columnName`
### equals(Object arg0) {#equals-java.lang.Object-}
```
...
**退货：**
[DataRowCollection](../../com.aspose.words.net.system.data/datarowcollection) - 一个[DataRowCollection](../../com.aspose.words.net.system.data/datarowcollection)包含[DataRow](../../com.aspose.words.net.system.data/datarow)对象；如果没有，则为空值[DataRow](../../com.aspose.words.net.system.data/datarow)对象存在。
...
**退货：**
[DataRow](../../com.aspose.words.net.system.data/datarow) - 一个[DataRow](../../com.aspose.words.net.system.data/datarow)与相同的模式[DataTable](../../com.aspose.words.net.system.data/datatable).
### notify() {#notify--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [DataColumn\[\]](../../com.aspose.words.net.system.data/datacolumn) | 的数组[DataColumn](../../com.aspose.words.net.system.data/datacolumn)对象。 |
