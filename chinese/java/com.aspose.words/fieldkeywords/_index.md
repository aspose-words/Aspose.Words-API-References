...
```
public class 字段Keywords extends 字段
```
...
| [setText(String value)](#setText-java.lang.String-) | 设置关键字的文本。 |
| [toString()](#toString--) |  |
