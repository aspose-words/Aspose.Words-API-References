...
可用于在将文档保存到[SaveFormat.WORD\_ML](../../com.aspose.words/saveformat\#WORD-ML)格式。
...
如果使用此保存选项对象，则指定保存文档的格式。只能是[SaveFormat.WORD\_ML](../../com.aspose.words/saveformat\#WORD-ML).
