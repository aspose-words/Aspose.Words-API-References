...
| [get(int index)](#get-int-) | 检索一个**HeaderFooter**在给定的指数。 |
...
| [linkToPrevious(boolean isLinkToPrevious)](#linkToPrevious-boolean-) | 将所有页眉和页脚链接或取消链接到上一节中相应的页眉和页脚。 |
...
| [toArray()](#toArray--) | 将集合中的所有 HeaderFoorter 复制到新的 HeaderFoorter 数组。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货：**
com.aspose.words.HeaderFooter[] - HeaderFoorter 的数组。
### toString() {#toString--}
```
