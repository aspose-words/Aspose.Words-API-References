...
description: "表示 Java 中图表系列的 Y 值集合。"
type: docs
weight: 98
url: /zh/java/com.aspose.words/chartyvaluecollection/
---
...
集合中除 **null** 之外的所有项必须具有相同的 [ChartYValue.getValueType()](../../com.aspose.words/chartyvalue/\#getValueType)。

该集合仅允许更改 Y 值。若要向图表系列添加或插入新值，或删除值，可使用 [ChartSeries](../../com.aspose.words/chartseries/) 类的相应方法。
...
| 方法 | 描述 |
| --- | --- |
| [get(int index)](#get-int) | 获取指定索引处的 Y 值。 |
| [getCount()](#getCount) | 获取此集合中的项数。 |
| [getFormatCode()](#getFormatCode) | 获取应用于 Y 值的格式代码。 |
| [iterator()](#iterator) | 返回一个枚举器对象。 |
| [set(int index, ChartYValue value)](#set-int-com.aspose.words.ChartYValue) | 设置指定索引处的 Y 值。 |
| [setFormatCode(String value)](#setFormatCode-java.lang.String) | 设置应用于 Y 值的格式代码。 |
...
| --- | --- | --- |
| 索引 | int |  |
| value | [ChartYValue](../../com.aspose.words/chartyvalue/) | 指定索引处的 Y 值。 |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 应用于 Y 值的格式代码。 |
