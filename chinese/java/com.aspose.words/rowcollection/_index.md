...
type: docs
weight: 493
url: /zh/java/com.aspose.words/rowcollection/
---
...
提供对集合的类型化访问[Row](../../com.aspose.words/row)节点。
...
| [get(int index)](#get-int-) | 检索一个**Row**在给定的索引处。 |
| [get班级()](#get班级--) |  |
...
| [toArray()](#toArray--) | 将集合中的所有行复制到新的行数组中。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货:**
[Node](../../com.aspose.words/node) - 相应的[Row](../../com.aspose.words/row)价值。
### get班级() {#get班级--}
```
