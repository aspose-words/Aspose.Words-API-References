...
| 构造函数 | 描述 |
| --- | --- |
| [XpsSaveOptions()](#XpsSaveOptions--) | 初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.XPS](../../com.aspose.words/saveformat\#XPS)格式。 |
...
初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.XPS](../../com.aspose.words/saveformat\#XPS)格式。
