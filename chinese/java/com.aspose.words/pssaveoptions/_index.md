...
type: docs
weight: 471
url: /zh/java/com.aspose.words/pssaveoptions/
---
...
可用于在将文档保存到[SaveFormat.PS](../../com.aspose.words/saveformat\#PS)格式。
...
如果使用此保存选项对象，则指定保存文档的格式。只能是[SaveFormat.PS](../../com.aspose.words/saveformat\#PS).
