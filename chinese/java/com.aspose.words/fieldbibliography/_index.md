...
```
public class 字段Bibliography extends 字段
```
...
| [getFormatLanguageId()](#getFormatLanguageId--) | 获取用于格式化文档中的书目来源的语言 ID。 |
...
| [setFormatLanguageId(String value)](#setFormatLanguageId-java.lang.String-) | 设置用于格式化文档中书目来源的语言 ID。 |
...
获取用于格式化文档中的书目来源的语言 ID。

**退货:**
java.lang.String - 用于格式化文档中的书目来源的语言 ID。
...
设置用于格式化文档中书目来源的语言 ID。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 用于格式化文档中的书目来源的语言 ID。 |
