...
description: 包含有关 PDF 文档的加密和访问权限的详细信息。
type: docs
weight: 454
...
| [getPermissions()](#getPermissions--) | 指定允许用户对加密的 PDF 文档执行的操作。 |
...
| [setPermissions(int value)](#setPermissions-int-) | 指定允许用户对加密的 PDF 文档执行的操作。 |
...
所有者密码允许用户打开加密的 PDF 文档，而无需在[getPermissions()](../../com.aspose.words/pdfencryptiondetails\#getPermissions--) / [setPermissions(int)](../../com.aspose.words/pdfencryptiondetails\#setPermissions-int-).
...
指定允许用户对加密的 PDF 文档执行的操作。默认值为[PdfPermissions.DISALLOW\_ALL](../../com.aspose.words/pdfpermissions\#DISALLOW-ALL).

**退货：**
 int - 相应的 int 值。返回值是按位组合[PdfPermissions](../../com.aspose.words/pdfpermissions)常数。
...
需要用户密码才能打开加密的 PDF 文档进行查看。中指定的权限[getPermissions()](../../com.aspose.words/pdfencryptiondetails\#getPermissions--) / [setPermissions(int)](../../com.aspose.words/pdfencryptiondetails\#setPermissions-int-)将由阅读器软件执行。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是按位组合[PdfPermissions](../../com.aspose.words/pdfpermissions)常数。 |
