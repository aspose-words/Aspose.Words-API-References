...
| [getNode类型()](#getNode类型--) | 退货[Node类型.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START). |
...
退货[Node类型.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START).

**退货:**
诠释 -\{[Node类型.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START) .返回值是以下之一[Node类型](../../com.aspose.words/nodetype)常数。
### getParentIdInternal() {#getParentIdInternal--}
```
