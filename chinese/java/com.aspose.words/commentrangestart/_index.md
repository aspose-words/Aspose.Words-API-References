...
什么时候[CommentRangeStart](../../com.aspose.words/commentrangestart)已创建，它属于指定的文档，但还不是文档的一部分，并且[Node.getParentNode()](../../com.aspose.words/node\#getParentNode--)一片空白。

追加一个[CommentRangeStart](../../com.aspose.words/commentrangestart)在要插入注释的段落上使用 InsertAfter 或 InsertBefore 到文档。
