...
description: 表示具有与之关联的注释的文本区域的开始。
type: docs
weight: 80
...
| [getNodeType()](#getNodeType--) | 退货[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START). |
...
什么时候[CommentRangeStart](../../com.aspose.words/commentrangestart)已创建，它属于指定文档，但还不是文档的一部分，并且[Node.getParentNode()](../../com.aspose.words/node\#getParentNode--)一片空白。

附加一个[CommentRangeStart](../../com.aspose.words/commentrangestart)在要插入注释的段落上使用 InsertAfter 或 InsertBefore 到文档。
...
来电[DocumentVisitor.visitCommentRangeStart(com.aspose.words.CommentRangeStart)](../../com.aspose.words/documentvisitor\#visitCommentRangeStart-com.aspose.words.CommentRangeStart-).
...
退货[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START).

**退货：**
整数 -\{[NodeType.COMMENT\_RANGE\_START](../../com.aspose.words/nodetype\#COMMENT-RANGE-START) .返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
### getParentIdInternal() {#getParentIdInternal--}
```
