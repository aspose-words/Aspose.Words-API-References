...
description: 指定形状或文本框的水平位置相对于什么。
type: docs
weight: 473
...
| 场地 | 描述 |
| --- | --- |
| [CHARACTER](#CHARACTER) | 该对象相对于段落的左侧定位。 |
| [COLUMN](#COLUMN) | 对象相对于列的左侧定位。 |
| [DEFAULT](#DEFAULT) | 默认值为[COLUMN](../../com.aspose.words/relativehorizontalposition\#COLUMN). |
| [INSIDE_MARGIN](#INSIDE-MARGIN) | 指定水平定位应相对于当前页的内边距（奇数页左边距，偶数页右边距）。 |
| [LEFT_MARGIN](#LEFT-MARGIN) | 指定水平定位应相对于页面的左边距。 |
| [MARGIN](#MARGIN) | 指定水平定位应相对于页边距。 |
| [OUTSIDE_MARGIN](#OUTSIDE-MARGIN) | 指定水平定位应相对于当前页的外边距（奇数页的右边距，偶数页的左边距）。 |
| [PAGE](#PAGE) | 该对象相对于页面的左边缘定位。 |
...
默认值为[COLUMN](../../com.aspose.words/relativehorizontalposition\#COLUMN).
...
指定水平定位应相对于当前页的内边距（奇数页左边距，偶数页右边距）。
