...
description: "OptionButton 控件在 Java 中允许在有限的一组互斥选项中进行单选。"
type: docs
weight: 506
url: /zh/java/com.aspose.words/optionbuttoncontrol/
---
...
OptionButton 控件在有限的一组互斥选项中实现单选。
...
| [getSelected()](#getSelected) | 获取一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。 |
...
| [setSelected(boolean value)](#setSelected-boolean) | 设置一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。 |
...
获取一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。

 **Remarks:** 

注意，此属性允许您在一组具有相同 [Forms2OleControl.getGroupName()](../../com.aspose.words/forms2olecontrol/\#getGroupName) / [Forms2OleControl.setGroupName(java.lang.String)](../../com.aspose.words/forms2olecontrol/\#setGroupName-java.lang.String) 的 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 中选择多个项目。您需要自行在将此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 设为选中时，取消先前已选中的项目。
...
**Returns:**
boolean - 一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。
### getType() {#getType}
```
public int getType()
```
...
设置一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 一个布尔值，指示此 [OptionButtonControl](../../com.aspose.words/optionbuttoncontrol/) 是否被选中。 |
