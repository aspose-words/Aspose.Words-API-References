...
description: 表示 SubDocument - 这是对外部存储文档的引用。
type: docs
weight: 540
...
[SubDocument](../../com.aspose.words/subdocument)只能是孩子[Paragraph](../../com.aspose.words/paragraph).
## 方法
...
| [getNodeType()](#getNodeType--) | 退货**NodeType.SubDocument** |
...
退货**NodeType.SubDocument**

**退货：**
整数 -**NodeType.SubDocument**返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
