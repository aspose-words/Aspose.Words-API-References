...
description: "表示一组方法，旨在使用 Java 中的一行代码转换各种不同类型的文档。"
type: docs
weight: 132
url: /zh/java/com.aspose.words/converter/
---
...
表示一组方法，旨在使用单行代码转换各种不同类型的文档。

 **Remarks:** 

指定的输入和输出文件或流，以及所需的保存格式，用于将给定的输入文档（一种格式）转换为另一个指定格式的输出文档。

转换功能支持超过 35 种不同的文件格式。

该 **M:Aspose.Words.LowCode.Converter.ConvertToImages(System.String,Aspose.Words.SaveFormat)** 方法组旨在将文档转换为图像，每页转换为单独的图像文件。这些方法还可以直接将 PDF 文档转换为固定页格式，而无需加载到文档模型中，从而提升性能和准确性。

使用 [ImageSaveOptions.getPageSet()](../../com.aspose.words/imagesaveoptions/\#getPageSet) / [ImageSaveOptions.setPageSet(com.aspose.words.PageSet)](../../com.aspose.words/imagesaveoptions/\#setPageSet-com.aspose.words.PageSet)，您可以指定要转换为图像的特定页面集合。
## 方法
...
| [convert(String inputFile, LoadOptions loadOptions, String outputFile, SaveOptions saveOptions)](#convert-java.lang.String-com.aspose.words.LoadOptions-java.lang.String-com.aspose.words.SaveOptions) | 使用指定的输入输出文件名及其加载/保存选项，将给定的输入文档转换为输出文档。 |
| [convert(String inputFile, String outputFile)](#convert-java.lang.String-java.lang.String) | 使用指定的输入输出文件名及其扩展名，将给定的输入文档转换为输出文档。 |
| [convert(String inputFile, String outputFile, SaveOptions saveOptions)](#convert-java.lang.String-java.lang.String-com.aspose.words.SaveOptions) | 使用指定的输入输出文件名和保存选项，将给定的输入文档转换为输出文档。 |
| [convert(String inputFile, String outputFile, int saveFormat)](#convert-java.lang.String-java.lang.String-int) |  |
| [convertToImages(Document doc, ImageSaveOptions saveOptions)](#convertToImages-com.aspose.words.Document-com.aspose.words.ImageSaveOptions) | 使用指定的保存选项将指定文档的页面转换为图像，并返回包含这些图像的流数组。 |
| [convertToImages(Document doc, int saveFormat)](#convertToImages-com.aspose.words.Document-int) |  |
| [convertToImages(InputStream inputStream, ImageSaveOptions saveOptions)](#convertToImages-java.io.InputStream-com.aspose.words.ImageSaveOptions) | 使用指定的保存选项将指定输入流的页面转换为图像，并返回包含这些图像的流数组。 |
| [convertToImages(InputStream inputStream, LoadOptions loadOptions, ImageSaveOptions saveOptions)](#convertToImages-java.io.InputStream-com.aspose.words.LoadOptions-com.aspose.words.ImageSaveOptions) | 使用提供的加载和保存选项将指定输入流的页面转换为图像，并返回包含这些图像的流数组。 |
| [convertToImages(InputStream inputStream, int saveFormat)](#convertToImages-java.io.InputStream-int) |  |
| [convertToImages(String inputFile, ImageSaveOptions saveOptions)](#convertToImages-java.lang.String-com.aspose.words.ImageSaveOptions) | 使用指定的保存选项将指定输入文件的页面转换为图像，并返回包含这些图像的流数组。 |
| [convertToImages(String inputFile, LoadOptions loadOptions, String outputFile, ImageSaveOptions saveOptions)](#convertToImages-java.lang.String-com.aspose.words.LoadOptions-java.lang.String-com.aspose.words.ImageSaveOptions) | 使用提供的加载和保存选项将指定输入文件的页面转换为图像文件。 |
| [convertToImages(String inputFile, int saveFormat)](#convertToImages-java.lang.String-int) |  |
| [convertToImages(String inputFile, String outputFile)](#convertToImages-java.lang.String-java.lang.String) | 将指定输入文件的页面转换为图像文件。 |
| [convertToImages(String inputFile, String outputFile, ImageSaveOptions saveOptions)](#convertToImages-java.lang.String-java.lang.String-com.aspose.words.ImageSaveOptions) | 使用指定的保存选项将指定输入文件的页面转换为图像文件。 |
...
| [create(ConverterContext context)](#create-com.aspose.words.ConverterContext) | 创建转换处理器的新实例。 |
...
| loadOptions | [LoadOptions](../../com.aspose.words/loadoptions/) | 输入文档的加载选项。 |
...
使用指定的保存选项将指定文档的页面转换为图像，并返回包含这些图像的流数组。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| doc | [Document](../../com.aspose.words/document/) | 输入文档。 |
| saveOptions | [ImageSaveOptions](../../com.aspose.words/imagesaveoptions/) | 图像保存选项。 |

**Returns:**
java.io.OutputStream[] - 返回图像流数组。流应由最终用户释放。
### convertToImages(Document doc, int saveFormat) {#convertToImages-com.aspose.words.Document-int}
```
...
使用指定的保存选项将指定输入流的页面转换为图像，并返回包含这些图像的流数组。
...
使用提供的加载和保存选项将指定输入流的页面转换为图像，并返回包含这些图像的流数组。
...
使用指定的保存选项将指定输入文件的页面转换为图像，并返回包含这些图像的流数组。
...
| inputFile | java.lang.String | 输入文件名。 |
| loadOptions | [LoadOptions](../../com.aspose.words/loadoptions/) | 输入文档的加载选项。 |
| outputFile | java.lang.String | 用于根据规则 "outputFile\\_pageIndex.extension" 生成页面图像文件名的输出文件名。 |
| saveOptions | [ImageSaveOptions](../../com.aspose.words/imagesaveoptions/) | 图像保存选项。 |
