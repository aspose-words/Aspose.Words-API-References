---
title: 字段GreetingLine
second_title: Aspose.Words for Java API Reference
description: 实现 GREETINGLINE 字段。
type: docs
weight: 198
url: /zh/java/com.aspose.words/fieldgreetingline/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段GreetingLine extends 字段
```
...
| [getAlternateText()](#getAlternateText--) | 如果名称为空，则获取要包含在字段中的文本。 |
| [get班级()](#get班级--) |  |
...
| [getLanguageId()](#getLanguageId--) | 获取用于格式化名称的语言 ID。 |
| [getLocaleId()](#getLocaleId--) | 获取字段的 LCID。 |
| [getMergeFormat()](#getMergeFormat--) |  |
| [getNameFormat()](#getNameFormat--) | 获取字段中包含的名称的格式。 |
...
| [setAlternateText(String value)](#setAlternateText-java.lang.String-) | 如果名称为空，则设置要包含在字段中的文本。 |
| [setLanguageId(String value)](#setLanguageId-java.lang.String-) | 设置用于格式化名称的语言 ID。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setNameFormat(String value)](#setNameFormat-java.lang.String-) | 设置字段中包含的名称格式。 |
...
如果名称为空，则获取要包含在字段中的文本。

**退货:**
java.lang.String - 如果名称为空，则包含在字段中的文本。
### get班级() {#get班级--}
```
...
**退货:**
java.lang.String - 用于格式化名称的语言 ID。
...
如果名称为空，则设置要包含在字段中的文本。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 如果名称为空，则要包含在字段中的文本。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 用于格式化名称的语言 ID。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 字段中包含的名称格式。 |
