...
| [getFieldNames()](#getFieldNames--) | 返回字段使用的邮件合并字段名称的集合。 |
...
| [setNameFormat(String value)](#setNameFormat-java.lang.String-) | 设置字段中包含的名称的格式。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 如果名称为空，则包含在字段中的文本。 |
