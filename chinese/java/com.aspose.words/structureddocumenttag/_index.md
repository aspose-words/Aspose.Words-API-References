...
| [getListItems()](#getListItems--) | 得到[SdtListItemCollection](../../com.aspose.words/sdtlistitemcollection)与此相关**SDT**. |
...
**退货：**
int - 相应的 int 值。返回值是其中之一[SdtAppearance](../../com.aspose.words/sdtappearance)常数。
...
**退货：**
int - 相应的 int 值。返回值是其中之一[SdtCalendarType](../../com.aspose.words/sdtcalendartype)常数。
...
**退货：**
int - 相应的 int 值。返回值是其中之一[SdtDateStorageFormat](../../com.aspose.words/sdtdatestorageformat)常数。
### getDirectRunAttr(int key) {#getDirectRunAttr-int-}
```
...
得到[SdtListItemCollection](../../com.aspose.words/sdtlistitemcollection)与此相关**SDT**.
...
获取[BuildingBlock](../../com.aspose.words/buildingblock)包含应在此 SDT 运行内容为空时显示的占位符文本，关联的映射 XML 元素为空，如通过[getXmlMapping()](../../com.aspose.words/structureddocumenttag\#getXmlMapping--)元素或[isShowingPlaceholderText()](../../com.aspose.words/structureddocumenttag\#isShowingPlaceholderText--) / [isShowingPlaceholderText(boolean)](../../com.aspose.words/structureddocumenttag\#isShowingPlaceholderText-boolean-)元素为真。可以为空，表示占位符不适用于此 Sdt。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[SdtAppearance](../../com.aspose.words/sdtappearance)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[SdtCalendarType](../../com.aspose.words/sdtcalendartype)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[SdtDateStorageFormat](../../com.aspose.words/sdtdatestorageformat)常数。 |
