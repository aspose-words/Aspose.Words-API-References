...
| [get(int index)](#get-int-) | 检索一个**Run**在给定的索引处。 |
| [getClass()](#getClass--) |  |
...
| [toArray()](#toArray--) | 将集合中的所有运行复制到新的运行数组。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货:**
[Node](../../com.aspose.words/node) - 相应的[Run](../../com.aspose.words/run)价值。
### getClass() {#getClass--}
```
