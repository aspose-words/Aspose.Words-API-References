...
| [setDefaultResponse(String value)](#setDefaultResponse-java.lang.String-) | 设置默认用户响应（提示窗口中包含的初始值）。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setPromptOnceOnMailMerge(boolean value)](#setPromptOnceOnMailMerge-boolean-) | 设置是否应在每个邮件合并操作中接收一次用户响应。 |
...
设置默认用户响应（提示窗口中包含的初始值）。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 默认用户响应（提示窗口中包含的初始值）。 |
...
设置是否应在每个邮件合并操作中接收一次用户响应。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 每次邮件合并操作是否应接收一次用户响应。 |
