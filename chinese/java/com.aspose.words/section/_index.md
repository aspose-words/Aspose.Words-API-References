...
**Section**可以有一个[getBody()](../../com.aspose.words/section\#getBody--)最多一个[HeaderFooter](../../com.aspose.words/headerfooter)每个[HeaderFooterType](../../com.aspose.words/headerfootertype). **Body**和**HeaderFooter**节点可以在里面以任何顺序**Section**.
