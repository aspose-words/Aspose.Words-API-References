...
**Section**可以有一个[getBody()](../../com.aspose.words/section\#getBody--)最多一个[HeaderFooter](../../com.aspose.words/headerfooter)每个[HeaderFooter类型](../../com.aspose.words/headerfootertype). **Body**和**HeaderFooter**节点可以在里面任意顺序**Section**.

最小有效部分需要有**Body**与一个**Paragraph**.
...
| [getNode类型()](#getNode类型--) | 退货**Node类型.Section**. |
...
| [prependContent(Section sourceSection)](#prependContent-com.aspose.words.Section-) | 在此部分的开头插入源部分内容的副本。 |
...
| [setProtectedForForms(boolean value)](#setProtectedForForms-boolean-) | 如果该部分受表单保护，则为真。 |
...
**退货:**
诠释 -**Node类型.Section** .返回值是以下之一[Node类型](../../com.aspose.words/nodetype)常数。
