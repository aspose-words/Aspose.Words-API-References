...
如果将文档保存到文件中并提供文件名，Aspose.Words 默认将图像保存在保存文档文件的同一文件夹中。利用[getImagesFolder()](../../com.aspose.words/xamlflowsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/xamlflowsaveoptions\#setImagesFolder-java.lang.String-)覆盖此行为。
