...
| [getWordWrap()](#getWordWrap--) | 如果这个属性是**false**单词中间的拉丁文本可以换行为当前段落。 |
| [hashCode()](#hashCode--) |  |
...
| [setCharacterUnitFirstLineIndent(double value)](#setCharacterUnitFirstLineIndent-double-) | 设置第一行缩进或悬挂缩进的值（以字符为单位）。 |
| [setCharacterUnitLeftIndent(double value)](#setCharacterUnitLeftIndent-double-) | 设置指定段落的左缩进值（以字符为单位）。 |
| [setCharacterUnitRightIndent(double value)](#setCharacterUnitRightIndent-double-) | 为指定段落设置右缩进值（以字符为单位）。 |
...
| [setLeftIndent(double value)](#setLeftIndent-double-) | 设置表示段落左缩进的值（以磅为单位）。 |
...
| [setLineUnitAfter(double value)](#setLineUnitAfter-double-) | 设置段落后的间距量（以网格线表示）。 |
| [setLineUnitBefore(double value)](#setLineUnitBefore-double-) | 设置段落前的间距量（以网格线表示）。 |
...
| [setWordWrap(boolean value)](#setWordWrap-boolean-) | 如果这个属性是**false**单词中间的拉丁文本可以换行为当前段落。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货：**
int - 段落的文本对齐方式。返回值是其中之一[ParagraphAlignment](../../com.aspose.words/paragraphalignment)常数。
### getBidi() {#getBidi--}
```
...
**退货：**
 int - 首字下沉文本的位置。返回值是其中之一[DropCapPosition](../../com.aspose.words/dropcapposition)常数。
...
**退货：**
 int - 段落的行距。返回值是其中之一[LineSpacingRule](../../com.aspose.words/linespacingrule)常数。
...
**退货：**
int - 相应的 int 值。返回值是其中之一[OutlineLevel](../../com.aspose.words/outlinelevel)常数。
...
**退货：**
 int - 应用于此格式的段落样式的区域独立样式标识符。返回值是其中之一[StyleIdentifier](../../com.aspose.words/styleidentifier)常数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 指示是否将东亚换行规则应用于当前段落的标志。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 指示是否为当前段落启用悬挂标点符号的标志。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[OutlineLevel](../../com.aspose.words/outlinelevel)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 应用于此格式的段落样式的区域独立样式标识符。该值必须是其中之一[StyleIdentifier](../../com.aspose.words/styleidentifier)常数。 |
