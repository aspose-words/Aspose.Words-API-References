...
| [get(int index)](#get-int-) | 检索一个**Paragraph**在给定的索引处。 |
| [get班级()](#get班级--) |  |
...
| [toArray()](#toArray--) | 将集合中的所有段落复制到新的段落数组中。 |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
**退货:**
[Node](../../com.aspose.words/node) - 相应的[Paragraph](../../com.aspose.words/paragraph)价值。
### get班级() {#get班级--}
```
