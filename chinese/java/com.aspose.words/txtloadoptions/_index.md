...
允许在加载时指定附加选项[LoadFormat.TEXT](../../com.aspose.words/loadformat\#TEXT)文件成[Document](../../com.aspose.words/document)目的。
...
| [getLeadingSpacesOptions()](#getLeadingSpacesOptions--) | 获取前导空格处理的首选选项。 |
...
| [setLeadingSpacesOptions(int value)](#setLeadingSpacesOptions-int-) | 设置前导空格处理的首选选项。 |
...
**退货：**
boolean - 一个布尔值，表示加载文档时将执行自动编号检测。
...
如果此选项设置为 false，当列表编号以点、右括号或项目符号（例如“\\u2022", "\*”、“-”或“o”）。
...
**退货：**
int - 文档方向。返回值是其中之一[DocumentDirection](../../com.aspose.words/documentdirection)常数。
...
获取前导空格处理的首选选项。默认值为[TxtLeadingSpacesOptions.CONVERT\_TO\_INDENT](../../com.aspose.words/txtleadingspacesoptions\#CONVERT-TO-INDENT).

**退货：**
int - 领先空间处理的首选选项。返回值是其中之一[TxtLeadingSpacesOptions](../../com.aspose.words/txtleadingspacesoptions)常数。
...
**退货：**
int - 尾随空格处理的首选选项。返回值是其中之一[TxtTrailingSpacesOptions](../../com.aspose.words/txttrailingspacesoptions)常数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 文档方向。该值必须是其中之一[DocumentDirection](../../com.aspose.words/documentdirection)常数。 |
...
设置前导空格处理的首选选项。默认值为[TxtLeadingSpacesOptions.CONVERT\_TO\_INDENT](../../com.aspose.words/txtleadingspacesoptions\#CONVERT-TO-INDENT).

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 领先空间处理的首选选项。该值必须是其中之一[TxtLeadingSpacesOptions](../../com.aspose.words/txtleadingspacesoptions)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 尾随空格处理的首选选项。该值必须是其中之一[TxtTrailingSpacesOptions](../../com.aspose.words/txttrailingspacesoptions)常数。 |
