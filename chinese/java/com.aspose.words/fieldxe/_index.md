...
| [getEntry类型()](#getEntry类型--) | 获取索引条目类型。 |
...
| [getYomi()](#getYomi--) | 获取索引条目的 yomi（排序索引的第一个音标） |
| [hashCode()](#hashCode--) |  |
...
| [setEntry类型(String value)](#setEntry类型-java.lang.String-) | 设置索引条目类型。 |
...
| [setYomi(String value)](#setYomi-java.lang.String-) | 为索引条目设置 yomi（排序索引的第一个音标） |
| [toString()](#toString--) |  |
