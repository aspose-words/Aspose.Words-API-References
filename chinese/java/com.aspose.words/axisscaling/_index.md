...
设置此属性会设置[getType()](../../com.aspose.words/axisscaling\#getType--) / [setType(int)](../../com.aspose.words/axisscaling\#setType-int-)财产[AxisScaleType.LOGARITHMIC](../../com.aspose.words/axisscaletype\#LOGARITHMIC).
...
**退货：**
 int - 轴的缩放类型。返回值是其中之一[AxisScaleType](../../com.aspose.words/axisscaletype)常数。
### hashCode() {#hashCode--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 轴的缩放类型。该值必须是其中之一[AxisScaleType](../../com.aspose.words/axisscaletype)常数。 |
