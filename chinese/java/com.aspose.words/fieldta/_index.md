...
| [getEntryCategory()](#getEntryCategory--) | 获取积分条目类别，这是一个数字，对应于类别的顺序。 |
...
| [getPageRangeBookmarkName()](#getPageRangeBookmarkName--) | 获取标记作为条目页码插入的页面范围的书签的名称。 |
...
| [setEntryCategory(String value)](#setEntryCategory-java.lang.String-) | 设置积分条目类别，这是一个数字，对应于类别的顺序。 |
