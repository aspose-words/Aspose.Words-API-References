...
description: 实现 GLOSSARY 字段。
type: docs
weight: 196
url: /zh/java/com.aspose.words/fieldglossary/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段Glossary extends 字段
```
...
| [getEntryName()](#getEntryName--) | 获取要插入的词汇表条目的名称。 |
...
| [setEntryName(String value)](#setEntryName-java.lang.String-) | 设置要插入的词汇表条目的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要插入的词汇表条目的名称。 |
