...
据说 Word 文档的文本由多个故事组成。正文存储在由 代表的正文故事中[Body](../../com.aspose.words/body)，每个页眉和页脚都存储在一个单独的故事中，由[HeaderFooter](../../com.aspose.words/headerfooter).
## 构造函数
