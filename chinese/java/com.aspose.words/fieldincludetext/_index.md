...
| [getMimeType()](#getMimeType--) | 获取引用文件的 MIME 类型。 |
...
| [setMimeType(String value)](#setMimeType-java.lang.String-) | 设置引用文件的 MIME 类型。 |
...
**退货：**
java.lang.String - XPath 查询的名称空间映射。
### getResult() {#getResult--}
```
...
**退货：**
java.lang.String - 格式化 XML 数据的 XSL 转换位置。
### hashCode() {#hashCode--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | XPath 查询的命名空间映射。 |
