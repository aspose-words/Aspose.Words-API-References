...
| [getPrefixedSequenceIdentifier()](#getPrefixedSequenceIdentifier--) | 获取应为其条目的页码添加前缀的序列的标识符。 |
| [getPreserveLineBreaks()](#getPreserveLineBreaks--) | 获取是否在表条目中保留换行符。 |
| [getPreserveTabs()](#getPreserveTabs--) | 获取是否在表格条目中保留选项卡条目。 |
...
| [getTableOfFiguresLabel()](#getTableOfFiguresLabel--) | 获取构建图表时使用的序列标识符的名称。 |
...
| [setCaptionlessTableOfFiguresLabel(String value)](#setCaptionlessTableOfFiguresLabel-java.lang.String-) | 设置在构建不包括标题标签和编号的图表时使用的序列标识符的名称。 |
| [setCustomStyles(String value)](#setCustomStyles-java.lang.String-) | 设置要包含在目录中的除内置标题样式之外的样式列表。 |
...
| [setHeadingLevelRange(String value)](#setHeadingLevelRange-java.lang.String-) | 设置要包含的标题级别范围。 |
| [setHideInWebLayout(boolean value)](#setHideInWebLayout-boolean-) | 设置是否在 Web 布局视图中隐藏制表符前导符和页码。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 构建不包括标题标签和编号的图表时使用的序列标识符的名称。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 应与包含的 TC 字段的类型标识符相匹配的字符串。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 要包含的目录条目的级别范围。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 分隔条目及其页码的一系列字符。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 是否在 Web 布局视图中隐藏制表符前导符和页码。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 目录条目的级别范围，从中省略页码。 |
