...
description: "在 Java 中，CommandButton 控件运行宏，在用户点击时执行操作。"
type: docs
weight: 107
url: /zh/java/com.aspose.words/commandbuttoncontrol/
---
...
CommandButton 控件运行宏，在用户点击时执行操作。
...
| 构造函数 | 描述 |
| --- | --- |
| [CommandButtonControl()](#CommandButtonControl) | 初始化 [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/) 类的新实例。 |
## 方法
...
初始化 [CommandButtonControl](../../com.aspose.words/commandbuttoncontrol/) 类的新实例。
