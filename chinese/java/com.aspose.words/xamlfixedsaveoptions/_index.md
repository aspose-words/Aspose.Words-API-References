...
| [getResourcesFolderAlias()](#getResourcesFolderAlias--) | 指定用于构建写入固定页面 Xaml 文档的图像 URI 的文件夹的名称。 |
...
| [setResourcesFolderAlias(String value)](#setResourcesFolderAlias-java.lang.String-) | 指定用于构建写入固定页面 Xaml 文档的图像 URI 的文件夹的名称。 |
...
指定用于构建写入固定页面 Xaml 文档的图像 URI 的文件夹的名称。默认为空。
