...
description: 在将文档保存为格式时指定其他选项的类。
type: docs
weight: 388
...
类以在将文档保存到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。
...
| 构造函数 | 描述 |
| --- | --- |
| [MarkdownSaveOptions()](#MarkdownSaveOptions--) | 初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
## 方法
...
| [getImageSavingCallback()](#getImageSavingCallback--) | 允许控制将文档保存到时图像的保存方式[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
| [getImagesFolder()](#getImagesFolder--) | 指定导出文档时保存图像的物理文件夹[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
...
| [getParagraphBreak()](#getParagraphBreak--) | 指定在以文本格式导出时用作分段符的字符串。 |
...
| [setImageSavingCallback(IImageSavingCallback value)](#setImageSavingCallback-com.aspose.words.IImageSavingCallback-) | 允许控制将文档保存到时图像的保存方式[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
| [setImagesFolder(String value)](#setImagesFolder-java.lang.String-) | 指定导出文档时保存图像的物理文件夹[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
...
| [setParagraphBreak(String value)](#setParagraphBreak-java.lang.String-) | 指定在以文本格式导出时用作分段符的字符串。 |
...
| [setTableContentAlignment(int value)](#setTableContentAlignment-int-) | 设置一个值，该值指定在导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
...
初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。
...
**退货：**
int - 相应的 int 值。返回值是其中之一[TxtExportHeadersFootersMode](../../com.aspose.words/txtexportheadersfootersmode)常数。
...
该属性仅影响显式插入文档的分页符。它与 MS Word 在每页末尾自动插入的分页符无关。
...
允许控制将文档保存到时图像的保存方式[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。
...
指定导出文档时保存图像的物理文件夹[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。默认为空字符串。
...
如果指定的文件夹[getImagesFolder()](../../com.aspose.words/markdownsaveoptions\#getImagesFolder--) / [setImagesFolder(java.lang.String)](../../com.aspose.words/markdownsaveoptions\#setImagesFolder-java.lang.String-)不存在，会自动创建。
...
如果使用此保存选项对象，则指定保存文档的格式。只能是[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN).
...
获取一个值，该值指定在导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。默认值为[TableContentAlignment.AUTO](../../com.aspose.words/tablecontentalignment\#AUTO).

**退货：**
int - 一个值，指定在导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。返回值是其中之一[TableContentAlignment](../../com.aspose.words/tablecontentalignment)常数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[TxtExportHeadersFootersMode](../../com.aspose.words/txtexportheadersfootersmode)常数。 |
...
设置一个值，该值指定在导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。默认值为[TableContentAlignment.AUTO](../../com.aspose.words/tablecontentalignment\#AUTO).

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 一个值，指定在导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。该值必须是其中之一[TableContentAlignment](../../com.aspose.words/tablecontentalignment)常数。 |
