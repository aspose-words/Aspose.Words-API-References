...
| [setImageSavingCallback(IImageSavingCallback value)](#setImageSavingCallback-com.aspose.words.IImageSavingCallback-) | 允许控制在将文档保存到时如何保存图像[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
| [setImagesFolder(String value)](#setImagesFolder-java.lang.String-) | 指定将文档导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。 |
...
初始化此类的新实例，该实例可用于将文档保存在[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。
...
允许控制在将文档保存到时如何保存图像[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。
...
指定将文档导出到[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。默认为空字符串。
...
**退货:**
int - 一个值，用于指定导出到表中时如何对齐表中的内容[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。返回值是以下之一[TableContentAlignment](../../com.aspose.words/tablecontentalignment)常数。
...
设置一个值，该值指定导出到表中时如何对齐表中的内容[SaveFormat.MARKDOWN](../../com.aspose.words/saveformat\#MARKDOWN)格式。默认值为[TableContentAlignment.AUTO](../../com.aspose.words/tablecontentalignment\#AUTO).
