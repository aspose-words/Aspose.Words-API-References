...
description: "Java 中的文档拆分器上下文。"
type: docs
weight: 632
url: /zh/java/com.aspose.words/splittercontext/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [SplitterContext()](#SplitterContext) | 初始化此类的新实例。 |
## 方法
...
| [getSplitOptions()](#getSplitOptions) | 文档拆分选项。 |
