...
| [getSignatureDate()](#getSignatureDate--) | 获取签名日期。 |
...
| [setSignatureDate(Date value)](#setSignatureDate-java.util.Date-) | 设置签名日期。 |
...
| reason | java.lang.String | 签约原因。 |
| location | java.lang.String | 签到地点。 |
| signatureDate | java.util.Date | 签署的日期和时间。 |
...
**退货：**
int - 哈希算法。返回值是其中之一[PdfDigitalSignatureHashAlgorithm](../../com.aspose.words/pdfdigitalsignaturehashalgorithm)常数。
