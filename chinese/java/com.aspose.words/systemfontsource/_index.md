...
description: 表示安装到系统的所有 TrueType 字体。
type: docs
weight: 543
...
如果文件夹不可访问，则返回系统字体文件夹或空数组。在某些平台上，Aspose.Words 不仅可以通过文件夹搜索系统字体，还可以在其他来源中搜索系统字体。例如，在 Windows 平台上 Aspose.Words 搜索字体也在注册表中。
