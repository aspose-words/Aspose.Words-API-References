...
description: "CheckBox 控件在 Java 中切换一个值。"
type: docs
weight: 100
url: /zh/java/com.aspose.words/checkboxcontrol/
---
...
它有三种可能的状态：已选中、已清除，以及既未选中也未清除，这意味着开和关状态的组合。

 **Examples:** 

展示如何更改 CheckBox 控件的状态。
...
| [getChecked()](#getChecked) | 获取一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。 |
...
| [setChecked(boolean value)](#setChecked-boolean) | 设置一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。 |
...
获取一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。默认值为 false。
...
**Returns:**
boolean - 一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。
...
设置一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。默认值为 false。
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 一个布尔值，指示此 [CheckBoxControl](../../com.aspose.words/checkboxcontrol/) 是否被选中。 |
