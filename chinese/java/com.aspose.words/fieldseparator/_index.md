...
description: 表示将域代码与域结果分隔开的 Word 域分隔符。
type: docs
weight: 240
...
表示将域代码与域结果分隔开的 Word 域分隔符。

要了解更多信息，请访问**Working with Fields**文档文章。

[FieldSeparator](../../com.aspose.words/fieldseparator)是一个内联级节点，由[ControlChar.FIELD\_SEPARATOR\_CHAR](../../com.aspose.words/controlchar\#FIELD-SEPARATOR-CHAR)文档中的控制字符。

[FieldSeparator](../../com.aspose.words/fieldseparator)只能是孩子[Paragraph](../../com.aspose.words/paragraph).
...
| [getNodeType()](#getNodeType--) | 退货[NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype\#FIELD-SEPARATOR). |
...
来电[DocumentVisitor.visitFieldSeparator(com.aspose.words.FieldSeparator)](../../com.aspose.words/documentvisitor\#visitFieldSeparator-com.aspose.words.FieldSeparator-).
...
退货[NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype\#FIELD-SEPARATOR).

**退货：**
整数 -\{[NodeType.FIELD\_SEPARATOR](../../com.aspose.words/nodetype\#FIELD-SEPARATOR) .返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
