...
description: 在页面布局模型构建和呈现期间引发的事件代码。
type: docs
weight: 436
...
| 场地 | 描述 |
| --- | --- |
| [BUILD_FINISHED](#BUILD-FINISHED) | 页面布局的构建已完成。 |
...
| [NONE](#NONE) | 默认值 |
| [PART_REFLOW_FINISHED](#PART-REFLOW-FINISHED) | 页面回流已完成。 |
| [PART_REFLOW_STARTED](#PART-REFLOW-STARTED) | 页面回流已经开始。 |
...
页面布局的构建已完成。发射过一次。这是最后一次发生的事件[Document.updatePageLayout()](../../com.aspose.words/document\#updatePageLayout--)叫做。
