...
初始化此类的新实例，该实例可用于将文档保存在[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX)格式。
...
**退货:**
int - 对应的 int 值。返回值是以下之一[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance)常数。
...
**退货:**
int - 对应的 int 值。返回值是以下之一[CompressionLevel](../../com.aspose.words/compressionlevel)常数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的 int 值。该值必须是以下之一[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的 int 值。该值必须是以下之一[CompressionLevel](../../com.aspose.words/compressionlevel)常数。 |
