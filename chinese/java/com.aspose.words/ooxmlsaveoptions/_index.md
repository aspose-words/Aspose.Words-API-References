...
| 构造函数 | 描述 |
| --- | --- |
| [OoxmlSaveOptions()](#OoxmlSaveOptions--) | 初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX)格式。 |
...
| [getClass()](#getClass--) |  |
| [getCompliance()](#getCompliance--) | 指定输出文档的 OOXML 版本。 |
| [getCompressionLevel()](#getCompressionLevel--) | 指定用于保存文档的压缩级别。 |
...
| [getKeepLegacyControlChars()](#getKeepLegacyControlChars--) | 保留遗留控制字符的原始表示。 |
| [getMemoryOptimization()](#getMemoryOptimization--) | 获取确定在保存文档之前是否应执行内存优化的值。 |
| [getPassword()](#getPassword--) | 获取/设置使用 ECMA376 标准加密算法加密文档的密码。 |
...
| [setCompliance(int value)](#setCompliance-int-) | 指定输出文档的 OOXML 版本。 |
| [setCompressionLevel(int value)](#setCompressionLevel-int-) | 指定用于保存文档的压缩级别。 |
...
| [setKeepLegacyControlChars(boolean value)](#setKeepLegacyControlChars-boolean-) | 保留遗留控制字符的原始表示。 |
| [setMemoryOptimization(boolean value)](#setMemoryOptimization-boolean-) | 设置确定在保存文档之前是否应执行内存优化的值。 |
| [setPassword(String value)](#setPassword-java.lang.String-) | 获取/设置使用 ECMA376 标准加密算法加密文档的密码。 |
...
初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX)格式。
...
指定输出文档的 OOXML 版本。默认值为[OoxmlCompliance.ECMA\_376\_2006](../../com.aspose.words/ooxmlcompliance\#ECMA-376-2006).

**退货：**
int - 相应的 int 值。返回值是其中之一[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance)常数。
...
指定用于保存文档的压缩级别。默认值为[CompressionLevel.NORMAL](../../com.aspose.words/compressionlevel\#NORMAL).

**退货：**
int - 相应的 int 值。返回值是其中之一[CompressionLevel](../../com.aspose.words/compressionlevel)常数。
...
如果使用此保存选项对象，则指定保存文档的格式。可[SaveFormat.DOCX](../../com.aspose.words/saveformat\#DOCX), [SaveFormat.DOCM](../../com.aspose.words/saveformat\#DOCM), [SaveFormat.DOTX](../../com.aspose.words/saveformat\#DOTX), [SaveFormat.DOTM](../../com.aspose.words/saveformat\#DOTM)或者[SaveFormat.FLAT\_OPC](../../com.aspose.words/saveformat\#FLAT-OPC).
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[OoxmlCompliance](../../com.aspose.words/ooxmlcompliance)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[CompressionLevel](../../com.aspose.words/compressionlevel)常数。 |
