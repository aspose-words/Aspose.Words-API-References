...
| 构造函数 | 描述 |
| --- | --- |
| [OdtSaveOptions()](#OdtSaveOptions--) | 初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT)格式。 |
| [OdtSaveOptions(String password)](#OdtSaveOptions-java.lang.String-) | 初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT)使用密码加密的格式。 |
...
| [getPassword()](#getPassword--) | 获取加密文档的密码。 |
...
| [hashCode()](#hashCode--) |  |
| [isStrictSchema11()](#isStrictSchema11--) | 指定导出是否应严格对应 ODT 规范 1.1。 |
| [isStrictSchema11(boolean value)](#isStrictSchema11-boolean-) | 指定导出是否应严格对应 ODT 规范 1.1。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT)格式。
...
初始化此类的一个新实例，该实例可用于将文档保存在[SaveFormat.ODT](../../com.aspose.words/saveformat\#ODT)使用密码加密的格式。
...
**退货：**
int - 相应的 int 值。返回值是其中之一[OdtSaveMeasureUnit](../../com.aspose.words/odtsavemeasureunit)常数。
...
指定导出是否应严格对应 ODT 规范 1.1。当文件包含 ODT 1.2 的元素和属性时，OOo 3.0 可以正确显示文件。为此使用“false”，或“true”表示严格符合规范 1.1。默认值为**false**.
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[OdtSaveMeasureUnit](../../com.aspose.words/odtsavemeasureunit)常数。 |
