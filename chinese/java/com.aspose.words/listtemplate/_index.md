...
description: 指定 Microsoft Word 中可用的一种预定义列表格式。
type: docs
weight: 375
...
指定 Microsoft Word 中可用的一种预定义列表格式。

列表模板值用作**M:Aspose.Words.Lists.ListCollection.Add(Aspose.Words.Lists.ListTemplate)**方法。
...
| [OUTLINE_NUMBERS](#OUTLINE-NUMBERS) | 层次编号为“1”、a)、i)、(1)、(a)、(i)、1.、a.、i. 的大纲列表。 |
| [length](#length) |  |
## 方法
...
第一关的子弹是一个箭头形的翼鼎字。其余级别与 BulletDefault 中的相同。

对应于 Microsoft Word 项目符号和编号对话框中的第 6 个项目符号列表模板。
...
对应于 Microsoft Word 中项目符号和编号对话框中的第二个项目符号列表模板。
...
具有 9 个级别的默认项目符号列表。第一级子弹是圆盘，第二级子弹是圆形，第三级子弹是方形。然后对剩余级别重复格式化。

每个级别相对于上一个级别向右缩进 0.25"。

对应于 Microsoft Word 中“项目符号和编号”对话框中的第一个项目符号列表模板。
...
第一级的子弹是一个4钻翼丁角色。其余级别与 BulletDefault 中的相同。
...
第一关的子弹是一个滴答翼丁字。其余级别与 BulletDefault 中的相同。

对应于 Microsoft Word 项目符号和编号对话框中的第 7 个项目符号列表模板。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第一个编号列表模板。
...
具有 9 个级别的默认编号列表。第一级为阿拉伯编号（1., 2., 3., ...），第二级为小写字母编号（a., b., c., ...），小写罗马编号（i., ii., iii., ...) 用于第三级。然后对剩余级别重复格式化。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第 7 个编号列表模板。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第 3 个编号列表模板。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第 3 个大纲列表模板。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第 4 个大纲列表模板。
...
对应于 Microsoft Word 中项目符号和编号对话框中的第 7 个大纲列表模板。
...
对应于 Microsoft Word 中“项目符号和编号”对话框中的第 5 个大纲列表模板。
