...
| [getFieldUpdatingCallback()](#getFieldUpdatingCallback--) | 获取[IFieldUpdatingCallback](../../com.aspose.words/ifieldupdatingcallback)执行 |
...
| [setCustomTocStyleSeparator(String value)](#setCustomTocStyleSeparator-java.lang.String-) | 设置自定义样式分隔符\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)场地。 |
| [setDefaultDocumentAuthor(String value)](#setDefaultDocumentAuthor-java.lang.String-) | 设置默认文档作者的姓名。 |
| [setFieldDatabaseProvider(IFieldDatabaseProvider value)](#setFieldDatabaseProvider-com.aspose.words.IFieldDatabaseProvider-) | 设置返回查询结果的提供程序[FieldDatabase](../../com.aspose.words/fielddatabase)场地。 |
...
| [setFieldUpdateCultureProvider(IFieldUpdateCultureProvider value)](#setFieldUpdateCultureProvider-com.aspose.words.IFieldUpdateCultureProvider-) | 设置一个提供程序，该提供程序返回特定于每个特定字段的区域性对象。 |
...
获取自定义样式分隔符\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)场地。默认情况下，由\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)字段由取自当前区域性的分隔符分隔。此属性通过指定用户定义的分隔符来覆盖该行为。

**退货:**
 java.lang.String - 自定义样式分隔符\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)场地。
...
**退货:**
整数-A[getFieldIndexFormat()](../../com.aspose.words/fieldoptions\#getFieldIndexFormat--) / [setFieldIndexFormat(int)](../../com.aspose.words/fieldoptions\#setFieldIndexFormat-int-)表示格式的[FieldIndex](../../com.aspose.words/fieldindex)文档中的字段。返回值是以下之一[FieldIndexFormat](../../com.aspose.words/fieldindexformat)常数。
...
**退货:**
int - 对应的 int 值。返回值是以下之一[FieldUpdateCultureSource](../../com.aspose.words/fieldupdateculturesource)常数。
...
获取[IFieldUpdatingCallback](../../com.aspose.words/ifieldupdatingcallback)执行
...
目前这个属性只影响[FieldDocProperty](../../com.aspose.words/fielddocproperty)场地。

默认值为**null**.当此属性设置为**null**， 这[FieldDocProperty](../../com.aspose.words/fielddocproperty)字段的值使用受控制的区域性进行预处理[getFieldUpdateCultureSource()](../../com.aspose.words/fieldoptions\#getFieldUpdateCultureSource--) / [setFieldUpdateCultureSource(int)](../../com.aspose.words/fieldoptions\#setFieldUpdateCultureSource-int-)财产。
...
如果此属性的值设置为**null**，需要用户响应提示的字段（例如[FieldAsk](../../com.aspose.words/fieldask)或者[FieldFillIn](../../com.aspose.words/fieldfillin)不更新。

默认值为**null**.

**退货:**
[IFieldUserPromptRespondent](../../com.aspose.words/ifielduserpromptrespondent) - 字段更新期间用户提示的受访者。
### hashCode() {#hashCode--}
```
...
设置自定义样式分隔符\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)场地。默认情况下，由\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)字段由取自当前区域性的分隔符分隔。此属性通过指定用户定义的分隔符来覆盖该行为。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 自定义样式分隔符\\t 切换[FieldToc](../../com.aspose.words/fieldtoc)场地。 |
...
设置返回查询结果的提供程序[FieldDatabase](../../com.aspose.words/fielddatabase)场地。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的 int 值。该值必须是以下之一[FieldUpdateCultureSource](../../com.aspose.words/fieldupdateculturesource)常数。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | [IFieldUserPromptRespondent](../../com.aspose.words/ifielduserpromptrespondent) | 字段更新期间用户提示的被访者。 |
