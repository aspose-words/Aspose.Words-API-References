...
| [getFirstParagraph()](#getFirstParagraph--) | 获取直接子项中的第一段。 |
| [getLastChild()](#getLastChild--) | 获取节点的最后一个子节点。 |
| [getLastParagraph()](#getLastParagraph--) | 获取直接子项中的最后一段。 |
| [getNextMatchingNode(Node curNode)](#getNextMatchingNode-com.aspose.words.Node-) |  |
| [getNextSibling()](#getNextSibling--) | 获取紧跟在该节点之后的节点。 |
| [getNodeType()](#getNodeType--) | 退货**NodeType.Cell**. |
| [getParagraphs()](#getParagraphs--) | 获取作为单元格直接子级的段落的集合。 |
...
什么时候**Cell**已创建，它属于指定文档，但还不是文档的一部分，并且**ParentNode**一片空白。

追加**Cell**对于文档，在要插入单元格的行上使用 InsertAfter 或 InsertBefore。
...
**退货：**
[Paragraph](../../com.aspose.words/paragraph) - 直接子项中的第一段。
...
**退货：**
[Paragraph](../../com.aspose.words/paragraph) - 直接孩子中的最后一段。
### getNextMatchingNode(Node curNode) {#getNextMatchingNode-com.aspose.words.Node-}
```
...
**退货：**
整数 -**NodeType.Cell** .返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
...
**退货：**
[ParagraphCollection](../../com.aspose.words/paragraphcollection) - 作为单元格的直接子级的段落集合。
...
返回单元格的父行。等同于 (Row)FirstNonMarkupParentNode 。
...
**退货：**
[TableCollection](../../com.aspose.words/tablecollection) 是单元格的直接子级的表的集合。
### getText() {#getText--}
```
