...
description: "Java 中的邮件合并上下文。"
type: docs
weight: 447
url: /zh/java/com.aspose.words/mailmergercontext/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MailMergerContext()](#MailMergerContext) | 初始化此类的新实例。 |
## 方法
...
| [getMailMergeOptions()](#getMailMergeOptions) | 邮件合并选项。 |
...
| [setRegionsDataSource(System.Data.DataSet dataSet)](#setRegionsDataSource-com.aspose.words.net.System.Data.DataSet) | 设置用于执行带区域的邮件合并的数据源。 |
| [setRegionsDataSource(System.Data.DataTable dataTable)](#setRegionsDataSource-com.aspose.words.net.System.Data.DataTable) | 设置用于执行带区域的邮件合并的数据源。 |
| [setSimpleDataSource(System.Data.DataRow dataRow)](#setSimpleDataSource-com.aspose.words.net.System.Data.DataRow) | 设置用于执行简单邮件合并的数据源。 |
| [setSimpleDataSource(System.Data.DataTable dataTable)](#setSimpleDataSource-com.aspose.words.net.System.Data.DataTable) | 设置用于执行简单邮件合并的数据源。 |
| [setSimpleDataSource(String[] fieldNames, Object[] fieldValues)](#setSimpleDataSource-java.lang.String---java.lang.Object) | 设置用于执行简单邮件合并的数据源。 |
...
如果同时指定了简单邮件合并的数据源和带区域的邮件合并的数据源，则先执行带区域的邮件合并，然后执行简单邮件合并。
