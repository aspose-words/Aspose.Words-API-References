...
description: "指定在 Java 中如何解释这些值 u200bu200b，这些值指定数据标签的位置——ChartDataLabel.getLeft / ChartDataLabel.setLeftdouble 和 ChartDataLabel.getTop / ChartDataLabel.setTopdouble 属性。"
type: docs
weight: 73
url: /zh/java/com.aspose.words/chartdatalabellocationmode/
---
...
| 字段 | 描述 |
| --- | --- |
| [ABSOLUTE](#ABSOLUTE) | 数据标签的位置是使用绝对坐标指定的，起始点为图表的左上角。 |
| [OFFSET](#OFFSET) | 数据标签的位置是通过相对于其由 [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int) 属性定义的位置的偏移来指定的。 |
| [length](#length) |  |
## 方法
...
数据标签的位置是通过相对于其由 [ChartDataLabel.getPosition()](../../com.aspose.words/chartdatalabel/\#getPosition) / [ChartDataLabel.setPosition(int)](../../com.aspose.words/chartdatalabel/\#setPosition-int) 属性定义的位置的偏移来指定的。
