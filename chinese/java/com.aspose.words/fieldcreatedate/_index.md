...
type: docs
weight: 172
url: /zh/java/com.aspose.words/fieldcreatedate/
---
...
| [getUseSakaEraCalendar()](#getUseSakaEraCalendar--) | 获取是否使用坂历。 |
...
| [setUseSakaEraCalendar(boolean value)](#setUseSakaEraCalendar-boolean-) | 设置是否使用坂历。 |
