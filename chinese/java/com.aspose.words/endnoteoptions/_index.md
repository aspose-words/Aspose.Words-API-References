...
**退货：**
int - 相应的 int 值。返回值是其中之一[EndnotePosition](../../com.aspose.words/endnoteposition)常数。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | int | 对应的int值。该值必须是其中之一[EndnotePosition](../../com.aspose.words/endnoteposition)常数。 |
