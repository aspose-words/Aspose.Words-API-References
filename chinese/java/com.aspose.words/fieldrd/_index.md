...
description:实现 RD 字段。
type: docs
weight: 234
url: /zh/java/com.aspose.words/fieldrd/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段RD extends 字段
```
...
标识创建目录、规范表或具有 TOC、TOA 或 INDEX 字段的索引时要包含的文件
## 方法s
...
| [getFileName()](#getFileName--) | 获取在生成目录、权限表或索引时要包含的文件的名称。 |
...
| [isPathRelative()](#isPathRelative--) | 获取路径是否相对于当前文档。 |
| [isPathRelative(boolean value)](#isPathRelative-boolean-) | 设置路径是否相对于当前文档。 |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove()](#remove--) | 从文档中删除字段。 |
| [setFileName(String value)](#setFileName-java.lang.String-) | 设置在生成目录、权限表或索引时要包含的文件的名称。 |
...
获取在生成目录、权限表或索引时要包含的文件的名称。

**退货:**
java.lang.String - 生成目录、权限表或索引时要包含的文件的名称。
### getFormat() {#getFormat--}
```
...
设置在生成目录、权限表或索引时要包含的文件的名称。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 生成目录、权限表或索引时要包含的文件的名称。 |
