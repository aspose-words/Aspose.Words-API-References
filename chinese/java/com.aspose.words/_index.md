...
description: com.aspose.words 包提供了无需使用 Microsoft Word 即可生成转换修改渲染和打印 Microsoft Word 文档的类。
type: docs
weight: 10
...
这**com.aspose.words**包提供了无需使用 Microsoft Word 即可生成、转换、修改、呈现和打印 Microsoft Word 文档的类。

Aspose.Words 完全用 Java 编写。使用 Aspose.Words 不需要 Microsoft Word。

中的类**com.aspose.words**包借鉴了两个著名框架的最佳实践：Microsoft Word Automation 和 System.Xml。 Aspose.Words 中的文档由节点树表示，与 XML DOM 非常相似。在可能的情况下，类、方法和属性名称与 Microsoft Word Automation 中的名称相匹配。
...
| 班级 | 描述 |
| --- | --- |
| [AbsolutePositionTab](../com.aspose.words/absolutepositiontab) | 绝对位置制表符是一个字符，用于在显示此 WordprocessingML 内容时推进当前文本行的位置。 |
...
| [AxisDisplayUnit](../com.aspose.words/axisdisplayunit) | 提供对值轴显示单位的缩放选项的访问。 |
| [AxisScaleType](../com.aspose.words/axisscaletype) | 指定轴的可能刻度类型。 |
...
| [Body](../com.aspose.words/body) | 代表一个部分的主要文本的容器。 |
| [Bookmark](../com.aspose.words/bookmark) | 代表单个书签。 |
| [BookmarkCollection](../com.aspose.words/bookmarkcollection) | 的集合[Bookmark](../com.aspose.words/bookmark)表示指定范围内书签的对象。 |
...
| [BorderCollection](../com.aspose.words/bordercollection) | Border 对象的集合。 |
| [BorderType](../com.aspose.words/bordertype) | 指定边框的边。 |
| [BreakType](../com.aspose.words/breaktype) | 指定文档内的中断类型。 |
| [BuildVersionInfo](../com.aspose.words/buildversioninfo) | 提供有关当前产品名称和版本的信息。 |
| [BuildingBlock](../com.aspose.words/buildingblock) | 表示词汇表文档条目，例如 Building Block、AutoText 或 AutoCorrect 条目。 |
| [BuildingBlockBehavior](../com.aspose.words/buildingblockbehavior) | 指定将构建块插入主文档时应应用于构建块内容的行为。 |
| [BuildingBlockCollection](../com.aspose.words/buildingblockcollection) | 的集合[BuildingBlock](../com.aspose.words/buildingblock)文档中的对象。 |
| [BuildingBlockGallery](../com.aspose.words/buildingblockgallery) | 指定构建基块所属的预定义库。 |
| [BuildingBlockType](../com.aspose.words/buildingblocktype) | 指定构建基块类型。 |
| [BuiltInDocumentProperties](../com.aspose.words/builtindocumentproperties) | 内置文档属性的集合。 |
| [CalendarType](../com.aspose.words/calendartype) | 指定日历的类型。 |
| [Cell](../com.aspose.words/cell) | 代表一个表格单元格。 |
...
| [ChartAxisType](../com.aspose.words/chartaxistype) | 指定图表轴的类型。 |
| [ChartDataLabel](../com.aspose.words/chartdatalabel) | 表示图表点或趋势线上的数据标签。 |
| [ChartDataLabelCollection](../com.aspose.words/chartdatalabelcollection) | 代表集合[ChartDataLabel](../com.aspose.words/chartdatalabel). |
...
| [ChartType](../com.aspose.words/charttype) | 指定图表的类型。 |
...
| [Comment](../com.aspose.words/comment) | 表示评论文本的容器。 |
| [CommentCollection](../com.aspose.words/commentcollection) | 提供对集合的类型化访问[Comment](../com.aspose.words/comment)节点。 |
| [CommentDisplayMode](../com.aspose.words/commentdisplaymode) | 指定文档评论的渲染模式。 |
| [CommentRangeEnd](../com.aspose.words/commentrangeend) | 表示具有与之关联的注释的文本区域的结尾。 |
| [CommentRangeStart](../com.aspose.words/commentrangestart) | 表示具有与之关联的注释的文本区域的开始。 |
...
| [ComparisonTargetType](../com.aspose.words/comparisontargettype) | 允许指定将在比较期间使用的基本文档。 |
...
| [ConditionalStyleCollection](../com.aspose.words/conditionalstylecollection) | 代表集合[ConditionalStyle](../com.aspose.words/conditionalstyle)对象。 |
| [ConditionalStyleType](../com.aspose.words/conditionalstyletype) | 表示可以在表格样式中定义条件格式的可能表格区域。 |
| [ContentDisposition](../com.aspose.words/contentdisposition) | 枚举在客户端浏览器中呈现文档的不同方式。 |
| [ContinuousSectionRestart](../com.aspose.words/continuoussectionrestart) | 表示在重新开始页码的连续部分中计算页码时的不同行为。 |
| [ControlChar](../com.aspose.words/controlchar) | 文档中经常遇到的控制字符。 |
| [ConvertUtil](../com.aspose.words/convertutil) | 提供帮助函数以在各种测量单位之间进行转换。 |
| [CssSavingArgs](../com.aspose.words/csssavingargs) | 提供数据[ICssSavingCallback.\#cssSaving(com.aspose.words.CssSavingArgs)](../com.aspose.words/icsssavingcallback\#cssSaving-com.aspose.words.CssSavingArgs-)事件。 |
| [CssStyleSheetType](../com.aspose.words/cssstylesheettype) | 指定如何将 CSS（层叠样式表）样式导出到 HTML。 |
| [CsvDataLoadOptions](../com.aspose.words/csvdataloadoptions) | 表示解析 CSV 数据的选项。 |
...
| [CustomPart](../com.aspose.words/custompart) | 表示自定义（任意内容）部分，未由 ISO/IEC 29500 标准定义。 |
| [CustomPartCollection](../com.aspose.words/custompartcollection) | 代表集合[CustomPart](../com.aspose.words/custompart)对象。 |
| [CustomXmlPart](../com.aspose.words/customxmlpart) | 表示自定义 XML 数据存储部件（包内的自定义 XML 数据）。 |
...
| [CustomXmlSchemaCollection](../com.aspose.words/customxmlschemacollection) | 表示与自定义 XML 部分关联的 XML 架构的字符串集合。 |
...
| [DigitalSignatureType](../com.aspose.words/digitalsignaturetype) | 指定数字签名的类型。 |
| [DigitalSignatureUtil](../com.aspose.words/digitalsignatureutil) | 提供签署文件的方法。 |
| [Direction](../com.aspose.words/direction) |  |
| [Dml3DEffectsRenderingMode](../com.aspose.words/dml3deffectsrenderingmode) | 指定如何呈现 3D 形状效果。 |
...
| [DocumentBuilder](../com.aspose.words/documentbuilder) | 提供插入文本、图像和其他内容、指定字体、段落和节格式的方法。 |
| [DocumentDirection](../com.aspose.words/documentdirection) | 允许指定文档中文本的流动方向。 |
| [DocumentLoadingArgs](../com.aspose.words/documentloadingargs) | 参数传入[IDocumentLoadingCallback.\#notify(com.aspose.words.DocumentLoadingArgs)](../com.aspose.words/idocumentloadingcallback\#notify-com.aspose.words.DocumentLoadingArgs-). |
| [DocumentPartSavingArgs](../com.aspose.words/documentpartsavingargs) | 提供数据[IDocumentPartSavingCallback.\#documentPartSaving(com.aspose.words.DocumentPartSavingArgs)](../com.aspose.words/idocumentpartsavingcallback\#documentPartSaving-com.aspose.words.DocumentPartSavingArgs-)打回来。 |
| [DocumentProperty](../com.aspose.words/documentproperty) | 表示自定义或内置文档属性。 |
| [DocumentPropertyCollection](../com.aspose.words/documentpropertycollection) | 基类为[BuiltInDocumentProperties](../com.aspose.words/builtindocumentproperties)和[CustomDocumentProperties](../com.aspose.words/customdocumentproperties)收藏品。 |
| [DocumentReaderPluginLoadException](../com.aspose.words/documentreaderpluginloadexception) | 文档加载时，无法加载读取文档格式所需的插件时抛出。 |
| [DocumentSavingArgs](../com.aspose.words/documentsavingargs) | 参数传入[IDocumentSavingCallback.\#notify(com.aspose.words.DocumentSavingArgs)](../com.aspose.words/idocumentsavingcallback\#notify-com.aspose.words.DocumentSavingArgs-). |
| [DocumentSecurity](../com.aspose.words/documentsecurity) | 用作值[BuiltInDocumentProperties.\#getSecurity()](../com.aspose.words/builtindocumentproperties\#getSecurity--) / [BuiltInDocumentProperties.\#setSecurity(int)](../com.aspose.words/builtindocumentproperties\#setSecurity-int-)财产。 |
| [DocumentSplitCriteria](../com.aspose.words/documentsplitcriteria) | 指定在保存到时文档如何拆分为多个部分[SaveFormat.\#HTML](../com.aspose.words/saveformat\#HTML), [SaveFormat.\#EPUB](../com.aspose.words/saveformat\#EPUB)或者[SaveFormat.\#AZW\_3](../com.aspose.words/saveformat\#AZW-3)格式。 |
...
| [DropDownItemCollection](../com.aspose.words/dropdownitemcollection) | 代表下拉表单字段中所有项目的字符串集合。 |
...
| [EditorType](../com.aspose.words/editortype) | 指定一组可能的别名（或编辑组），这些别名可用作别名以确定是否允许当前用户编辑由文档中的可编辑范围定义的单个范围。 |
| [EmbeddedFontFormat](../com.aspose.words/embeddedfontformat) | 指定内部特定嵌入字体的格式[FontInfo](../com.aspose.words/fontinfo)目的。 |
| [EmbeddedFontStyle](../com.aspose.words/embeddedfontstyle) | 指定嵌入字体内的样式[FontInfo](../com.aspose.words/fontinfo)目的。 |
| [EmfPlusDualRenderingMode](../com.aspose.words/emfplusdualrenderingmode) | 指定 Aspose.Words 应如何呈现 EMF+ Dual 图元文件。 |
| [EmphasisMark](../com.aspose.words/emphasismark) | 指定可能的强调标记类型。 |
| [EndCap](../com.aspose.words/endcap) | 指定线帽样式。 |
| [EndnoteOptions](../com.aspose.words/endnoteoptions) | 表示文档或节的尾注编号选项。 |
...
| [ExportHeadersFootersMode](../com.aspose.words/exportheadersfootersmode) | 指定如何将页眉和页脚导出为 HTML、MHTML 或 EPUB。 |
| [ExportListLabels](../com.aspose.words/exportlistlabels) | 指定列表标签如何导出为 HTML、MHTML 和 EPUB。 |
| [Field](../com.aspose.words/field) | 表示 Microsoft Word 文档字段。 |
| [FieldAddIn](../com.aspose.words/fieldaddin) | 实现 ADDIN 字段。 |
| [FieldAddressBlock](../com.aspose.words/fieldaddressblock) | 实现 ADDRESSBLOCK 字段。 |
| [FieldAdvance](../com.aspose.words/fieldadvance) | 实现 ADVANCE 字段。 |
| [FieldArgumentBuilder](../com.aspose.words/fieldargumentbuilder) | 构建由字段、节点和纯文本组成的复杂字段参数。 |
| [FieldAsk](../com.aspose.words/fieldask) | 实现 ASK 字段。 |
| [FieldAuthor](../com.aspose.words/fieldauthor) | 实现 AUTHOR 字段。 |
| [FieldAutoNum](../com.aspose.words/fieldautonum) | 实现 AUTONUM 字段。 |
| [FieldAutoNumLgl](../com.aspose.words/fieldautonumlgl) | 实现 AUTONUMLGL 字段。 |
| [FieldAutoNumOut](../com.aspose.words/fieldautonumout) | 实现 AUTONUMOUT 字段。 |
| [FieldAutoText](../com.aspose.words/fieldautotext) | 实现 AUTOTEXT 字段。 |
| [FieldAutoTextList](../com.aspose.words/fieldautotextlist) | 实现 AUTOTEXTLIST 字段。 |
| [FieldBarcode](../com.aspose.words/fieldbarcode) | 实现 BARCODE 字段。 |
| [FieldBibliography](../com.aspose.words/fieldbibliography) | 实现书目字段。 |
| [FieldBidiOutline](../com.aspose.words/fieldbidioutline) | 实现 BIDIOUTLINE 字段。 |
| [FieldBuilder](../com.aspose.words/fieldbuilder) | 从域代码标记（参数和开关）构建一个域。 |
| [FieldChar](../com.aspose.words/fieldchar) | 表示文档中字段字符的节点的基类。 |
| [FieldCitation](../com.aspose.words/fieldcitation) | 实现 CITATION 字段。 |
| [FieldCollection](../com.aspose.words/fieldcollection) | 的集合[Field](../com.aspose.words/field)表示指定范围内的字段的对象。 |
| [FieldComments](../com.aspose.words/fieldcomments) | 实现 COMMENTS 字段。 |
| [FieldCompare](../com.aspose.words/fieldcompare) | 实现 COMPARE 字段。 |
| [FieldCreateDate](../com.aspose.words/fieldcreatedate) | 实现 CREATEDATE 字段。 |
| [FieldData](../com.aspose.words/fielddata) | 实现 DATA 字段。 |
| [FieldDatabase](../com.aspose.words/fielddatabase) | 实现 DATABASE 字段。 |
| [FieldDatabaseDataRow](../com.aspose.words/fielddatabasedatarow) | 提供数据[FieldDatabase](../com.aspose.words/fielddatabase)场结果。 |
| [FieldDatabaseDataTable](../com.aspose.words/fielddatabasedatatable) | 提供数据[FieldDatabase](../com.aspose.words/fielddatabase)场结果。 |
| [FieldDate](../com.aspose.words/fielddate) | 实现 DATE 字段。 |
| [FieldDde](../com.aspose.words/fielddde) | 实现 DDE 字段。 |
| [FieldDdeAuto](../com.aspose.words/fieldddeauto) | 实现 DDEAUTO 字段。 |
| [FieldDisplayBarcode](../com.aspose.words/fielddisplaybarcode) | 实现 DISPLAYBARCODE 字段。 |
| [FieldDocProperty](../com.aspose.words/fielddocproperty) | 实现 DOCPROPERTY 字段。 |
| [FieldDocVariable](../com.aspose.words/fielddocvariable) | 实现 DOCVARIABLE 字段。 |
| [FieldEQ](../com.aspose.words/fieldeq) | 实现 EQ 字段。 |
| [FieldEditTime](../com.aspose.words/fieldedittime) | 实现 EDITTIME 字段。 |
| [FieldEmbed](../com.aspose.words/fieldembed) | 实现 EMBED 字段。 |
| [FieldEnd](../com.aspose.words/fieldend) | 表示文档中 Word 字段的结尾。 |
| [FieldFileName](../com.aspose.words/fieldfilename) | 实现 FILENAME 字段。 |
| [FieldFileSize](../com.aspose.words/fieldfilesize) | 实现 FILESIZE 字段。 |
| [FieldFillIn](../com.aspose.words/fieldfillin) | 实现 FILLIN 字段。 |
| [FieldFootnoteRef](../com.aspose.words/fieldfootnoteref) | 实现 FOOTNOTEREF 字段。 |
| [FieldFormCheckBox](../com.aspose.words/fieldformcheckbox) | 实现 FORMCHECKBOX 字段。 |
| [FieldFormDropDown](../com.aspose.words/fieldformdropdown) | 实现 FORMDROPDOWN 字段。 |
| [FieldFormText](../com.aspose.words/fieldformtext) | 实现 FORMTEXT 字段。 |
| [FieldFormat](../com.aspose.words/fieldformat) | 提供对字段的数字、日期和时间以及一般格式的键入访问。 |
| [FieldFormula](../com.aspose.words/fieldformula) | 实现 =（公式）字段。 |
| [FieldGlossary](../com.aspose.words/fieldglossary) | 实现 GLOSSARY 字段。 |
| [FieldGoToButton](../com.aspose.words/fieldgotobutton) | 实现 GOTOBUTTON 字段。 |
| [FieldGreetingLine](../com.aspose.words/fieldgreetingline) | 实现 GREETINGLINE 字段。 |
| [FieldHyperlink](../com.aspose.words/fieldhyperlink) | 实现 HYPERLINK 字段 |
| [FieldIf](../com.aspose.words/fieldif) | 实现 IF 字段。 |
| [FieldIfComparisonResult](../com.aspose.words/fieldifcomparisonresult) | 指定 IF 字段条件评估的结果。 |
| [FieldImport](../com.aspose.words/fieldimport) | 实施 IMPORT 字段。 |
| [FieldInclude](../com.aspose.words/fieldinclude) | 实现 INCLUDE 字段。 |
| [FieldIncludePicture](../com.aspose.words/fieldincludepicture) | 实现 INCLUDEPICTURE 字段。 |
| [FieldIncludeText](../com.aspose.words/fieldincludetext) | 实现 INCLUDETEXT 字段。 |
| [FieldIndex](../com.aspose.words/fieldindex) | 实现 INDEX 字段。 |
| [FieldIndexFormat](../com.aspose.words/fieldindexformat) | 指定格式[FieldIndex](../com.aspose.words/fieldindex)文档中的字段。 |
| [FieldInfo](../com.aspose.words/fieldinfo) | 实现 INFO 字段。 |
| [FieldKeywords](../com.aspose.words/fieldkeywords) | 实现 KEYWORDS 字段。 |
| [FieldLastSavedBy](../com.aspose.words/fieldlastsavedby) | 实现 LASTSAVEDBY 字段。 |
| [FieldLink](../com.aspose.words/fieldlink) | 实现 LINK 字段。 |
| [FieldListNum](../com.aspose.words/fieldlistnum) | 实现 LISTNUM 字段。 |
| [FieldMacroButton](../com.aspose.words/fieldmacrobutton) | 实现 MACROBUTTON 字段。 |
| [FieldMergeBarcode](../com.aspose.words/fieldmergebarcode) | 实现 MERGEBARCODE 字段。 |
| [FieldMergeField](../com.aspose.words/fieldmergefield) | 实现 MERGEFIELD 字段。 |
| [FieldMergeRec](../com.aspose.words/fieldmergerec) | 实现 MERGEREC 字段。 |
| [FieldMergeSeq](../com.aspose.words/fieldmergeseq) | 实现 MERGESEQ 字段。 |
| [FieldMergingArgs](../com.aspose.words/fieldmergingargs) | 提供数据**MergeField**事件。 |
| [FieldMergingArgsBase](../com.aspose.words/fieldmergingargsbase) | 基类为[FieldMergingArgs](../com.aspose.words/fieldmergingargs)和[ImageFieldMergingArgs](../com.aspose.words/imagefieldmergingargs). |
| [FieldNext](../com.aspose.words/fieldnext) | 实现 NEXT 字段。 |
| [FieldNextIf](../com.aspose.words/fieldnextif) | 实现 NEXTIF 字段。 |
| [FieldNoteRef](../com.aspose.words/fieldnoteref) | 实现 NOTEREF 字段。 |
| [FieldNumChars](../com.aspose.words/fieldnumchars) | 实现 NUMCHARS 字段。 |
| [FieldNumPages](../com.aspose.words/fieldnumpages) | 实现 NUMPAGES 字段。 |
| [FieldNumWords](../com.aspose.words/fieldnumwords) | 实现 NUMWORDS 字段。 |
| [FieldOcx](../com.aspose.words/fieldocx) | 实现 OCX 字段。 |
| [FieldOptions](../com.aspose.words/fieldoptions) | 表示控制文档中字段处理的选项。 |
| [FieldPage](../com.aspose.words/fieldpage) | 实现 PAGE 字段。 |
| [FieldPageRef](../com.aspose.words/fieldpageref) | 实现 PAGEREF 字段。 |
| [FieldPrint](../com.aspose.words/fieldprint) | 实现 PRINT 字段。 |
| [FieldPrintDate](../com.aspose.words/fieldprintdate) | 实现 PRINTDATE 字段。 |
| [FieldPrivate](../com.aspose.words/fieldprivate) | 实现 PRIVATE 字段。 |
| [FieldQuote](../com.aspose.words/fieldquote) | 实现 QUOTE 字段。 |
| [FieldRD](../com.aspose.words/fieldrd) | 实现 RD 字段。 |
| [FieldRef](../com.aspose.words/fieldref) | 实现 REF 字段。 |
| [FieldRevNum](../com.aspose.words/fieldrevnum) | 实现 REVNUM 字段。 |
| [FieldSaveDate](../com.aspose.words/fieldsavedate) | 实现 SAVEDATE 字段。 |
| [FieldSection](../com.aspose.words/fieldsection) | 实现 SECTION 字段。 |
| [FieldSectionPages](../com.aspose.words/fieldsectionpages) | 实现 SECTIONPAGES 字段。 |
| [FieldSeparator](../com.aspose.words/fieldseparator) | 表示将域代码与域结果分隔开的 Word 域分隔符。 |
| [FieldSeq](../com.aspose.words/fieldseq) | 实现 SEQ 字段。 |
| [FieldSet](../com.aspose.words/fieldset) | 实现 SET 字段。 |
| [FieldShape](../com.aspose.words/fieldshape) | 实现 SHAPE 字段。 |
| [FieldSkipIf](../com.aspose.words/fieldskipif) | 实现 SKIPIF 字段。 |
| [FieldStart](../com.aspose.words/fieldstart) | 表示文档中 Word 字段的开始。 |
| [FieldStyleRef](../com.aspose.words/fieldstyleref) | 实现 STYLEREF 字段。 |
| [FieldSubject](../com.aspose.words/fieldsubject) | 实现 SUBJECT 字段。 |
| [FieldSymbol](../com.aspose.words/fieldsymbol) | 实现 SYMBOL 字段。 |
| [FieldTA](../com.aspose.words/fieldta) | 实现 TA 字段。 |
| [FieldTC](../com.aspose.words/fieldtc) | 实现 TC 字段。 |
| [FieldTemplate](../com.aspose.words/fieldtemplate) | 实现 TEMPLATE 字段。 |
| [FieldTime](../com.aspose.words/fieldtime) | 实现 TIME 字段。 |
| [FieldTitle](../com.aspose.words/fieldtitle) | 实现 TITLE 字段。 |
| [FieldToa](../com.aspose.words/fieldtoa) | 实现 TOA 字段。 |
| [FieldToc](../com.aspose.words/fieldtoc) | 实现 TOC 字段。 |
| [FieldType](../com.aspose.words/fieldtype) | 指定 Microsoft Word 字段类型。 |
| [FieldUnknown](../com.aspose.words/fieldunknown) | 实现未知或无法识别的字段。 |
| [FieldUpdateCultureSource](../com.aspose.words/fieldupdateculturesource) | 指示在字段更新期间要使用的区域性。 |
| [FieldUserAddress](../com.aspose.words/fielduseraddress) | 实现 USERADDRESS 字段。 |
| [FieldUserInitials](../com.aspose.words/fielduserinitials) | 实现 USERINITIALS 字段。 |
| [FieldUserName](../com.aspose.words/fieldusername) | 实现 USERNAME 字段。 |
| [FieldXE](../com.aspose.words/fieldxe) | 实现 XE 字段。 |
| [FileCorruptedException](../com.aspose.words/filecorruptedexception) | 在文档加载期间抛出，当文档看起来已损坏且无法加载时。 |
| [FileFontSource](../com.aspose.words/filefontsource) | 表示存储在文件系统中的单个 TrueType 字体文件。 |
...
| [FillType](../com.aspose.words/filltype) | 指定可填充对象的填充类型。 |
...
| [FolderFontSource](../com.aspose.words/folderfontsource) | 表示包含 TrueType 字体文件的文件夹。 |
...
| [FontSavingArgs](../com.aspose.words/fontsavingargs) | 提供数据[IFontSavingCallback.\#fontSaving(com.aspose.words.FontSavingArgs)](../com.aspose.words/ifontsavingcallback\#fontSaving-com.aspose.words.FontSavingArgs-)事件。 |
| [FontSettings](../com.aspose.words/fontsettings) | 指定文档的字体设置。 |
| [FontSourceBase](../com.aspose.words/fontsourcebase) | 这是允许用户指定各种字体源的类的抽象基类。 |
| [FontSourceType](../com.aspose.words/fontsourcetype) | 指定字体源的类型。 |
...
| [FootnoteNumberingRule](../com.aspose.words/footnotenumberingrule) | 确定何时重新开始自动脚注或尾注编号。 |
| [FootnoteOptions](../com.aspose.words/footnoteoptions) | 表示文档或节的脚注编号选项。 |
| [FootnotePosition](../com.aspose.words/footnoteposition) | 定义脚注位置。 |
| [FootnoteType](../com.aspose.words/footnotetype) | 指定这是脚注还是尾注。 |
| [FormField](../com.aspose.words/formfield) | 表示单个表单字段。 |
| [FormFieldCollection](../com.aspose.words/formfieldcollection) | 的集合**FormField**表示范围内所有表单域的对象。 |
...
| [GeneralFormatCollection](../com.aspose.words/generalformatcollection) | 表示通用格式的类型化集合。 |
...
| [Granularity](../com.aspose.words/granularity) | 指定比较两个文档时要跟踪的更改粒度。 |
...
| [HeaderFooterCollection](../com.aspose.words/headerfootercollection) | 提供类型访问[HeaderFooter](../com.aspose.words/headerfooter)的节点**Section**. |
| [HeaderFooterType](../com.aspose.words/headerfootertype) | 标识在 Word 文件中找到的页眉或页脚的类型。 |
...
| [HtmlControlType](../com.aspose.words/htmlcontroltype) | 表示从 HTML 导入的元素的文档节点类型。 |
...
| [ImageBinarizationMethod](../com.aspose.words/imagebinarizationmethod) | 指定用于二值化图像的方法。 |
| [ImageColorMode](../com.aspose.words/imagecolormode) | 指定生成的文档页面图像的颜色模式。 |
| [ImageData](../com.aspose.words/imagedata) | 定义形状的图像。 |
| [ImageFieldMergingArgs](../com.aspose.words/imagefieldmergingargs) | 提供数据[IFieldMergingCallback.\#imageFieldMerging(com.aspose.words.ImageFieldMergingArgs)](../com.aspose.words/ifieldmergingcallback\#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs-)事件。 |
...
| [ImageSavingArgs](../com.aspose.words/imagesavingargs) | 提供数据[IImageSavingCallback.\#imageSaving(com.aspose.words.ImageSavingArgs)](../com.aspose.words/iimagesavingcallback\#imageSaving-com.aspose.words.ImageSavingArgs-)事件。 |
| [ImageSize](../com.aspose.words/imagesize) | 包含有关图像大小和分辨率的信息。 |
| [ImageType](../com.aspose.words/imagetype) | 指定 Microsoft Word 文档中图像的类型（格式）。 |
...
| [JsonSimpleValueParseMode](../com.aspose.words/jsonsimplevalueparsemode) | 指定在加载 JSON 时解析 JSON 简单值（空值、布尔值、数字、整数和字符串）的模式。 |
| [KnownTypeSet](../com.aspose.words/knowntypeset) | 表示无序集合（即 |
...
| [LayoutEntityType](../com.aspose.words/layoutentitytype) | 布局实体的类型。 |
| [LayoutEnumerator](../com.aspose.words/layoutenumerator) | 枚举文档的页面布局实体。 |
| [LayoutFlow](../com.aspose.words/layoutflow) | 确定文本框中文本布局的流程。 |
| [LayoutOptions](../com.aspose.words/layoutoptions) | 保留允许控制文档布局过程的选项。 |
| [LegendPosition](../com.aspose.words/legendposition) | 指定图表图例的可能位置。 |
| [License](../com.aspose.words/license) | 提供许可组件的方法。 |
| [LineNumberRestartMode](../com.aspose.words/linenumberrestartmode) | 确定自动行编号何时重新启动。 |
| [LineSpacingRule](../com.aspose.words/linespacingrule) | 指定段落的行距值。 |
| [LineStyle](../com.aspose.words/linestyle) | 指定 a 的线条样式[Border](../com.aspose.words/border). |
| [List](../com.aspose.words/list) | 表示列表的格式。 |
| [ListCollection](../com.aspose.words/listcollection) | 存储和管理文档中使用的项目符号列表和编号列表的格式。 |
...
| [ListLevelCollection](../com.aspose.words/listlevelcollection) | 列表中每个级别的列表格式的集合。 |
| [ListTemplate](../com.aspose.words/listtemplate) | 指定 Microsoft Word 中可用的一种预定义列表格式。 |
...
| [MailMergeDataType](../com.aspose.words/mailmergedatatype) | 指定外部邮件合并数据源的类型。 |
| [MailMergeDestination](../com.aspose.words/mailmergedestination) | 指定在文档上执行邮件合并时可能生成的可能结果。 |
| [MailMergeMainDocumentType](../com.aspose.words/mailmergemaindocumenttype) | 指定邮件合并源文档的可能类型。 |
...
| [MappedDataFieldCollection](../com.aspose.words/mappeddatafieldcollection) | 允许在数据源中的字段名称和文档中的邮件合并字段名称之间自动映射。 |
| [MarkdownSaveOptions](../com.aspose.words/markdownsaveoptions) | 类以在将文档保存到[SaveFormat.\#MARKDOWN](../com.aspose.words/saveformat\#MARKDOWN)格式。 |
| [MarkerSymbol](../com.aspose.words/markersymbol) | 指定标记符号样式。 |
| [MarkupLevel](../com.aspose.words/markuplevel) | 指定文档树中特定的级别[StructuredDocumentTag](../com.aspose.words/structureddocumenttag)可能发生。 |
| [MathObjectType](../com.aspose.words/mathobjecttype) | 指定 Office Math 对象的类型。 |
| [MeasurementUnits](../com.aspose.words/measurementunits) | 指定测量单位。 |
| [MemoryFontSource](../com.aspose.words/memoryfontsource) | 表示存储在内存中的单个 TrueType 字体文件。 |
| [MergeFieldImageDimension](../com.aspose.words/mergefieldimagedimension) | 表示图像维度（即 |
| [MergeFieldImageDimensionUnit](../com.aspose.words/mergefieldimagedimensionunit) | 指定图像尺寸的单位（即 |
| [MetafileRenderingMode](../com.aspose.words/metafilerenderingmode) | 指定 Aspose.Words 应如何呈现 WMF 和 EMF 图元文件。 |
| [MetafileRenderingOptions](../com.aspose.words/metafilerenderingoptions) | 允许指定额外的图元文件呈现选项。 |
| [Metered](../com.aspose.words/metered) | 提供设置计量密钥的方法。 |
| [MsWordVersion](../com.aspose.words/mswordversion) | 允许 Aspose.Wods 模仿 MS Word 特定版本的应用程序行为。 |
| [MultiplePagesType](../com.aspose.words/multiplepagestype) | 指定文档的打印方式。 |
| [Node](../com.aspose.words/node) | Word 文档所有节点的基类。 |
...
| [NodeCollection](../com.aspose.words/nodecollection) | 表示特定类型的节点集合。 |
| [NodeImporter](../com.aspose.words/nodeimporter) | 允许有效地执行节点从一个文档到另一个文档的重复导入。 |
| [NodeList](../com.aspose.words/nodelist) | 表示与使用[CompositeNode.\#selectNodes(java.lang.String)](../com.aspose.words/compositenode\#selectNodes-java.lang.String-)方法。 |
| [NodeRendererBase](../com.aspose.words/noderendererbase) | 基类为[ShapeRenderer](../com.aspose.words/shaperenderer)和[OfficeMathRenderer](../com.aspose.words/officemathrenderer). |
| [NodeType](../com.aspose.words/nodetype) | 指定 Word 文档节点的类型。 |
...
| [OdsoDataSourceType](../com.aspose.words/odsodatasourcetype) | 指定要连接的外部数据源的类型作为 ODSO 连接信息的一部分。 |
| [OdsoFieldMapData](../com.aspose.words/odsofieldmapdata) | 指定外部数据源中的列应如何映射到文档中预定义的合并字段。 |
| [OdsoFieldMapDataCollection](../com.aspose.words/odsofieldmapdatacollection) | 的类型集合[OdsoFieldMapData](../com.aspose.words/odsofieldmapdata)对象。 |
| [OdsoFieldMappingType](../com.aspose.words/odsofieldmappingtype) | 指定用于指示给定邮件合并字段是否已映射到给定外部数据源中的列的可能类型。 |
| [OdsoRecipientData](../com.aspose.words/odsorecipientdata) | 表示有关外部数据源中要从邮件合并中排除的单个记录的信息。 |
...
| [OdtSaveMeasureUnit](../com.aspose.words/odtsavemeasureunit) | 在保存期间应用于可测量文档内容（例如形状、宽度和其他）的指定测量单位。 |
...
| [OfficeMathDisplayType](../com.aspose.words/officemathdisplaytype) | 指定公式的显示格式类型。 |
| [OfficeMathJustification](../com.aspose.words/officemathjustification) | 指定等式的理由。 |
| [OfficeMathRenderer](../com.aspose.words/officemathrenderer) | 提供呈现个体的方法[OfficeMath](../com.aspose.words/officemath)到光栅或矢量图像或到 Graphics 对象。 |
| [OleControl](../com.aspose.words/olecontrol) | 表示 OLE ActiveX 控件。 |
| [OleFormat](../com.aspose.words/oleformat) | 提供对 OLE 对象或 ActiveX 控件数据的访问。 |
| [OlePackage](../com.aspose.words/olepackage) | 允许访问 OLE 包属性。 |
| [OoxmlCompliance](../com.aspose.words/ooxmlcompliance) | 允许指定在以 DOCX 格式保存时将使用哪个 OOXML 规范。 |
...
| [PageBorderAppliesTo](../com.aspose.words/pageborderappliesto) | 指定在哪些页面上打印页面边框。 |
| [PageBorderDistanceFrom](../com.aspose.words/pageborderdistancefrom) | 指定页面边框相对于页边距的定位。 |
| [PageInfo](../com.aspose.words/pageinfo) | 表示有关特定文档页面的信息。 |
| [PageLayoutCallbackArgs](../com.aspose.words/pagelayoutcallbackargs) | 参数传入[IPageLayoutCallback.\#notify(com.aspose.words.PageLayoutCallbackArgs)](../com.aspose.words/ipagelayoutcallback\#notify-com.aspose.words.PageLayoutCallbackArgs-) |
| [PageLayoutEvent](../com.aspose.words/pagelayoutevent) | 在页面布局模型构建和呈现期间引发的事件代码。 |
| [PageRange](../com.aspose.words/pagerange) | 表示连续范围的页面。 |
| [PageSavingArgs](../com.aspose.words/pagesavingargs) | 提供数据[IPageSavingCallback.\#pageSaving(com.aspose.words.PageSavingArgs)](../com.aspose.words/ipagesavingcallback\#pageSaving-com.aspose.words.PageSavingArgs-)事件。 |
| [PageSet](../com.aspose.words/pageset) | 描述一组随机页面。 |
...
| [PaperSize](../com.aspose.words/papersize) | 指定纸张大小。 |
...
| [PatternType](../com.aspose.words/patterntype) | 指定用于填充形状的填充图案。 |
...
| [PdfEncryptionDetails](../com.aspose.words/pdfencryptiondetails) | 包含有关 PDF 文档的加密和访问权限的详细信息。 |
| [PdfFontEmbeddingMode](../com.aspose.words/pdffontembeddingmode) | 指定 Aspose.Words 应如何嵌入字体。 |
| [PdfImageColorSpaceExportMode](../com.aspose.words/pdfimagecolorspaceexportmode) | 指定如何为 PDF 文档中的图像选择颜色空间。 |
...
| [PdfPageMode](../com.aspose.words/pdfpagemode) | 指定在 PDF 阅读器中打开 PDF 文档时应如何显示。 |
| [PdfPermissions](../com.aspose.words/pdfpermissions) | 指定允许用户对加密的 PDF 文档执行的操作。 |
...
| [PdfZoomBehavior](../com.aspose.words/pdfzoombehavior) | 指定在 PDF 查看器中打开 PDF 文档时应用的缩放类型。 |
...
| [PreferredWidthType](../com.aspose.words/preferredwidthtype) | 指定表格或单元格的首选宽度的测量单位。 |
| [PresetTexture](../com.aspose.words/presettexture) | 指定用于填充形状的纹理。 |
| [PropertyType](../com.aspose.words/propertytype) | 指定文档属性的数据类型。 |
| [ProtectionType](../com.aspose.words/protectiontype) | 文档的保护类型。 |
...
| [ResourceLoadingArgs](../com.aspose.words/resourceloadingargs) | 提供数据[IResourceLoadingCallback.\#resourceLoading(com.aspose.words.ResourceLoadingArgs)](../com.aspose.words/iresourceloadingcallback\#resourceLoading-com.aspose.words.ResourceLoadingArgs-)方法。 |
| [ResourceSavingArgs](../com.aspose.words/resourcesavingargs) | 提供数据[IResourceSavingCallback.\#resourceSaving(com.aspose.words.ResourceSavingArgs)](../com.aspose.words/iresourcesavingcallback\#resourceSaving-com.aspose.words.ResourceSavingArgs-)事件。 |
| [ResourceType](../com.aspose.words/resourcetype) | 加载资源的类型。 |
| [Revision](../com.aspose.words/revision) | 表示文档节点或样式中的修订（跟踪更改）。 |
| [RevisionCollection](../com.aspose.words/revisioncollection) | 的集合[Revision](../com.aspose.words/revision)表示文档修订的对象。 |
| [RevisionColor](../com.aspose.words/revisioncolor) | 允许指定文档修订的颜色。 |
| [RevisionGroup](../com.aspose.words/revisiongroup) | 表示一组顺序[Revision](../com.aspose.words/revision)对象。 |
| [RevisionGroupCollection](../com.aspose.words/revisiongroupcollection) | 的集合[RevisionGroup](../com.aspose.words/revisiongroup)表示文档中修订组的对象。 |
...
| [RevisionType](../com.aspose.words/revisiontype) | 指定正在跟踪的更改类型[Revision](../com.aspose.words/revision). |
| [RevisionsView](../com.aspose.words/revisionsview) | 允许指定是使用文档的原始版本还是修订版本。 |
| [Row](../com.aspose.words/row) | 代表表格行。 |
| [RowCollection](../com.aspose.words/rowcollection) | 提供对集合的类型化访问[Row](../com.aspose.words/row)节点。 |
| [RowFormat](../com.aspose.words/rowformat) | 表示表行的所有格式。 |
| [RtfLoadOptions](../com.aspose.words/rtfloadoptions) | 允许在加载时指定附加选项[LoadFormat.\#RTF](../com.aspose.words/loadformat\#RTF)文件成[Document](../com.aspose.words/document)目的。 |
...
| [SaveOutputParameters](../com.aspose.words/saveoutputparameters) | 此对象在保存文档后返回给调用者，并包含在保存操作期间生成或计算的附加信息。 |
| [ScriptShapingLevel](../com.aspose.words/scriptshapinglevel) |  |
| [SdtAppearance](../com.aspose.words/sdtappearance) | 指定结构化文档标签的外观。 |
| [SdtCalendarType](../com.aspose.words/sdtcalendartype) | 指定可用于指定的可能的日历类型[StructuredDocumentTag.\#getCalendarType()](../com.aspose.words/structureddocumenttag\#getCalendarType--) / [StructuredDocumentTag.\#setCalendarType(int)](../com.aspose.words/structureddocumenttag\#setCalendarType-int-)在 Office Open XML 文档中。 |
| [SdtDateStorageFormat](../com.aspose.words/sdtdatestorageformat) | 指定当 SDT 绑定到文档数据存储中的 XML 节点时如何存储/检索日期 SDT 的日期。 |
| [SdtListItem](../com.aspose.words/sdtlistitem) | 此元素指定父项中的单个列表项[SdtType.\#COMBO\_BOX](../com.aspose.words/sdttype\#COMBO-BOX)或者[SdtType.\#DROP\_DOWN\_LIST](../com.aspose.words/sdttype\#DROP-DOWN-LIST)结构化文档标签。 |
| [SdtListItemCollection](../com.aspose.words/sdtlistitemcollection) | 提供访问[SdtListItem](../com.aspose.words/sdtlistitem)结构化文档标签的元素。 |
| [SdtType](../com.aspose.words/sdttype) | 指定结构化文档标签 (SDT) 节点的类型。 |
| [Section](../com.aspose.words/section) | 表示文档中的单个部分。 |
| [SectionCollection](../com.aspose.words/sectioncollection) | 的集合**Section**文档中的对象。 |
...
| [ShadowType](../com.aspose.words/shadowtype) | 指定形状阴影的类型。 |
...
| [ShapeRenderer](../com.aspose.words/shaperenderer) | 提供呈现个体的方法[Shape](../com.aspose.words/shape)或者[GroupShape](../com.aspose.words/groupshape)到光栅或矢量图像或到 Graphics 对象。 |
| [ShapeType](../com.aspose.words/shapetype) | 指定 Microsoft Word 文档中的形状类型。 |
...
| [StoryType](../com.aspose.words/storytype) | Word 文档的文本存储在故事中。 |
| [StreamFontSource](../com.aspose.words/streamfontsource) | 用户定义的流字体源的基类。 |
| [Stroke](../com.aspose.words/stroke) | 定义形状的描边。 |
| [StructuredDocumentTag](../com.aspose.words/structureddocumenttag) | 表示文档中的结构化文档标签（SDT 或内容控件）。 |
| [StructuredDocumentTagCollection](../com.aspose.words/structureddocumenttagcollection) | 的集合[IStructuredDocumentTag](../com.aspose.words/istructureddocumenttag)表示指定范围内的结构化文档标签的实例。 |
| [StructuredDocumentTagRangeEnd](../com.aspose.words/structureddocumenttagrangeend) | 代表结束**ranged**接受多节内容的结构化文档标签。 |
| [StructuredDocumentTagRangeStart](../com.aspose.words/structureddocumenttagrangestart) | 代表开始**ranged**接受多节内容的结构化文档标签。 |
| [Style](../com.aspose.words/style) | 表示单个内置或用户定义的样式。 |
| [StyleCollection](../com.aspose.words/stylecollection) | Style 对象的集合，表示文档中的内置样式和用户定义样式。 |
| [StyleIdentifier](../com.aspose.words/styleidentifier) | 与语言环境无关的样式标识符。 |
| [StyleType](../com.aspose.words/styletype) | 表示样式的类型。 |
...
| [SystemFontSource](../com.aspose.words/systemfontsource) | 表示安装到系统的所有 TrueType 字体。 |
| [TabAlignment](../com.aspose.words/tabalignment) | 指定制表位的对齐方式/类型。 |
| [TabLeader](../com.aspose.words/tableader) | 指定制表符下方显示的引出线的类型。 |
| [TabStop](../com.aspose.words/tabstop) | 表示单个自定义制表位。 |
| [TabStopCollection](../com.aspose.words/tabstopcollection) | 的集合[TabStop](../com.aspose.words/tabstop)表示段落或样式的自定义选项卡的对象。 |
...
| [TableStyle](../com.aspose.words/tablestyle) | 代表表格样式。 |
...
| [TextBox](../com.aspose.words/textbox) | 定义指定文本在形状内的显示方式的属性。 |
| [TextBoxAnchor](../com.aspose.words/textboxanchor) | 指定用于形状文本垂直对齐的值。 |
| [TextBoxWrapMode](../com.aspose.words/textboxwrapmode) | 指定文本如何在形状内换行。 |
| [TextColumn](../com.aspose.words/textcolumn) | 表示单个文本列。 |
| [TextColumnCollection](../com.aspose.words/textcolumncollection) | 的集合[TextColumn](../com.aspose.words/textcolumn)表示文档的一部分中所有文本列的对象。 |
| [TextDmlEffect](../com.aspose.words/textdmleffect) | 文本运行的 Dml 文本效果。 |
| [TextEffect](../com.aspose.words/texteffect) | 文本运行的动画效果。 |
| [TextFormFieldType](../com.aspose.words/textformfieldtype) | 指定文本表单域的类型。 |
...
| [TxtLoadOptions](../com.aspose.words/txtloadoptions) | 允许在加载时指定附加选项[LoadFormat.\#TEXT](../com.aspose.words/loadformat\#TEXT)文件成[Document](../com.aspose.words/document)目的。 |
...
| [VbaModuleCollection](../com.aspose.words/vbamodulecollection) | 代表集合[VbaModule](../com.aspose.words/vbamodule)对象。 |
| [VbaModuleType](../com.aspose.words/vbamoduletype) | 指定 VBA 项目中模型的类型。 |
| [VbaProject](../com.aspose.words/vbaproject) | 提供对 VBA 项目信息的访问。 |
| [VbaReference](../com.aspose.words/vbareference) | 实现对自动化类型库或 VBA 项目的引用。 |
| [VbaReferenceCollection](../com.aspose.words/vbareferencecollection) | 代表集合[VbaReference](../com.aspose.words/vbareference)对象。 |
| [VbaReferenceType](../com.aspose.words/vbareferencetype) | 允许指定类型[VbaReference](../com.aspose.words/vbareference)目的。 |
...
| [ViewType](../com.aspose.words/viewtype) | Microsoft Word 中视图模式的可能值。 |
...
| [WarningType](../com.aspose.words/warningtype) | 指定在文档加载或保存期间由 Aspose.Words 发出的警告的类型。 |
| [Watermark](../com.aspose.words/watermark) | 表示使用文档水印的类。 |
| [WatermarkLayout](../com.aspose.words/watermarklayout) | 定义相对于水印中心的水印布局。 |
| [WatermarkType](../com.aspose.words/watermarktype) | 指定水印类型。 |
| [WebExtension](../com.aspose.words/webextension) | 表示一个 Web 扩展对象。 |
| [WebExtensionBinding](../com.aspose.words/webextensionbinding) | 指定 Web 扩展和文档中数据之间的绑定关系。 |
| [WebExtensionBindingCollection](../com.aspose.words/webextensionbindingcollection) | 指定 Web 扩展绑定的列表。 |
| [WebExtensionBindingType](../com.aspose.words/webextensionbindingtype) | 枚举 Web 扩展和文档中数据之间可用的绑定类型。 |
| [WebExtensionProperty](../com.aspose.words/webextensionproperty) | 指定 Web 扩展自定义属性。 |
| [WebExtensionPropertyCollection](../com.aspose.words/webextensionpropertycollection) | 指定一组 Web 扩展自定义属性。 |
...
| [WebExtensionStoreType](../com.aspose.words/webextensionstoretype) | 枚举可用类型的 Web 扩展存储。 |
...
| [WrapType](../com.aspose.words/wraptype) | 指定文本环绕形状或图片的方式。 |
...
| [XmlDataLoadOptions](../com.aspose.words/xmldataloadoptions) | 代表 XML 数据加载的选项。 |
| [XmlDataSource](../com.aspose.words/xmldatasource) | 提供对要在报告中使用的 XML 文件或流的数据的访问。 |
| [XmlMapping](../com.aspose.words/xmlmapping) | 指定用于在父结构化文档标记和文档中自定义 XML 数据部分中存储的 XML 元素之间建立映射的信息。 |
| [XpsSaveOptions](../com.aspose.words/xpssaveoptions) | 可用于在将文档保存到[SaveFormat.\#XPS](../com.aspose.words/saveformat\#XPS)格式。 |
| [ZoomType](../com.aspose.words/zoomtype) | 文档在 Microsoft Word 屏幕上显示的大小的可能值。 |
...
| [IComparisonExpressionEvaluator](../com.aspose.words/icomparisonexpressionevaluator) | 实施时，允许覆盖默认比较表达式评估[FieldIf](../com.aspose.words/fieldif)和[FieldCompare](../com.aspose.words/fieldcompare)字段。 |
...
| [IFieldDatabaseProvider](../com.aspose.words/ifielddatabaseprovider) | 实现此接口以提供数据[FieldDatabase](../com.aspose.words/fielddatabase)更新时的字段。 |
| [IFieldMergingCallback](../com.aspose.words/ifieldmergingcallback) | 如果要控制在邮件合并操作期间如何将数据插入合并字段，请实现此接口。 |
| [IFieldResultFormatter](../com.aspose.words/ifieldresultformatter) | 如果您想控制字段结果的格式，请实现此接口。 |
| [IFieldUpdateCultureProvider](../com.aspose.words/ifieldupdatecultureprovider) | 实施时，提供[CultureInfo](../com.aspose.words.net.system.globalization/cultureinfo)在更新特定字段期间应使用的对象。 |
| [IFieldUpdatingCallback](../com.aspose.words/ifieldupdatingcallback) | 如果您想在字段更新期间调用自己的自定义方法，请实现此接口。 |
| [IFieldUserPromptRespondent](../com.aspose.words/ifielduserpromptrespondent) | 表示字段更新期间用户提示的响应者。 |
| [IFontSavingCallback](../com.aspose.words/ifontsavingcallback) | 如果您想接收通知并控制 Aspose.Words 在将文档导出为 HTML 格式时如何保存字体，请实现此接口。 |
| [IHyphenationCallback](../com.aspose.words/ihyphenationcallback) | 由可以注册断字字典的类实现。 |
| [IImageSavingCallback](../com.aspose.words/iimagesavingcallback) | 如果您想在将文档保存为 HTML 时控制 Aspose.Words 如何保存图像，请实现此接口。 |
| [IMailMergeCallback](../com.aspose.words/imailmergecallback) | 如果您想在执行邮件合并时接收通知，请实现此接口。 |
| [IMailMergeDataSource](../com.aspose.words/imailmergedatasource) | 实现此接口以允许从自定义数据源（例如对象列表）合并邮件。 |
| [IMailMergeDataSourceRoot](../com.aspose.words/imailmergedatasourceroot) | 实现此接口以允许来自自定义数据源的邮件与主从数据合并。 |
| [INodeChangingCallback](../com.aspose.words/inodechangingcallback) | 如果您想在文档中插入或删除节点时收到通知，请实现此接口。 |
| [IPageLayoutCallback](../com.aspose.words/ipagelayoutcallback) | 如果您想在页面布局模型的构建和呈现期间调用自己的自定义方法，请实现此接口。 |
| [IPageSavingCallback](../com.aspose.words/ipagesavingcallback) | 如果您想控制 Aspose.Words 在将文档保存为固定页面格式时如何保存单独的页面，请实现此接口。 |
| [IReplacingCallback](../com.aspose.words/ireplacingcallback) | 如果您想在查找和替换操作期间调用自己的自定义方法，请实现此接口。 |
| [IResourceLoadingCallback](../com.aspose.words/iresourceloadingcallback) | 如果你想控制 Aspose.Words 在导入文档和插入图像时如何加载外部资源，请实现此接口[DocumentBuilder](../com.aspose.words/documentbuilder). |
| [IResourceSavingCallback](../com.aspose.words/iresourcesavingcallback) | 如果您想在将文档保存为固定页面 HTML 或 SVG 时控制 Aspose.Words 如何保存外部资源（图像、字体和 css），请实现此接口。 |
...
| [IWarningCallback](../com.aspose.words/iwarningcallback) | 如果您想要调用自己的自定义方法来捕获文档加载或保存期间可能发生的保真度丢失警告，请实现此接口。 |