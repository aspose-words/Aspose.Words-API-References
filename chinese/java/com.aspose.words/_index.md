...
课程中的**com.aspose.words**包借鉴了两个著名框架的最佳实践：Microsoft Word Automation 和 System.Xml。 Aspose.Words 中的文档由节点树表示，很像 XML DOM。在可能的情况下，类、方法和属性名称与 Microsoft Word Automation 中的名称相匹配。

该命名空间中的主要类是：

 *  **Document**是表示 Microsoft Word 文档的对象模型的主要类。
 *  **DocumentBuilder**提供了一种将内容和格式插入文档的简便方法。
 *  **Node**是文档中所有节点的基类。
...
| [ArrowType](../com.aspose.words/arrowtype) | 指定线端的箭头类型。 |
...
| [AxisScaleType](../com.aspose.words/axisscaletype) | 指定轴的可能比例类型。 |
...
| [BuildingBlockType](../com.aspose.words/buildingblocktype) | 指定构建块类型。 |
...
| [CssStyleSheetType](../com.aspose.words/cssstylesheettype) | 指定如何将 CSS（层叠样式表）样式导出为 HTML。 |
...
| [EditorType](../com.aspose.words/editortype) | 指定一组可能的别名（或编辑组），可用作别名以确定是否允许当前用户编辑由文档内的可编辑范围定义的单个范围。 |
...
| [FieldAutoText](../com.aspose.words/fieldautotext) | 实现自动文本字段。 |
...
| [FieldDatabaseDataRow](../com.aspose.words/fielddatabasedatarow) | 提供数据为[FieldDatabase](../com.aspose.words/fielddatabase)场结果。 |
| [FieldDatabaseDataTable](../com.aspose.words/fielddatabasedatatable) | 提供数据为[FieldDatabase](../com.aspose.words/fielddatabase)场结果。 |
...
| [FieldMergingArgs](../com.aspose.words/fieldmergingargs) | 提供数据为**MergeField**事件。 |
...
| [FieldSymbol](../com.aspose.words/fieldsymbol) | 实现一个符号字段。 |
...
| [FileFormatInfo](../com.aspose.words/fileformatinfo) | 包含返回的数据[FileFormatUtil](../com.aspose.words/fileformatutil)文档格式检测方法。 |
| [FileFormatUtil](../com.aspose.words/fileformatutil) | 提供用于处理文件格式的实用方法，例如检测文件格式或将文件扩展名与文件格式枚举相互转换。 |
...
| [FixedPageSaveOptions](../com.aspose.words/fixedpagesaveoptions) | 包含将文档保存为固定页面格式（PDF、XPS、图像等）时可以指定的常用选项。 |
...
| [FontFamily](../com.aspose.words/fontfamily) | 代表字体系列。 |
...
| [FormField](../com.aspose.words/formfield) | 表示单个表单域。 |
...
| [ImageFieldMergingArgs](../com.aspose.words/imagefieldmergingargs) | 提供数据为[IFieldMergingCallback.\#imageFieldMerging(com.aspose.words.ImageFieldMergingArgs)](../com.aspose.words/ifieldmergingcallback\#imageFieldMerging-com.aspose.words.ImageFieldMergingArgs-)事件。 |
...
| [KnownTypeSet](../com.aspose.words/knowntypeset) | 表示一个无序集（即 |
...
| [MergeFieldImageDimension](../com.aspose.words/mergefieldimagedimension) | 表示图像尺寸（即 |
...
| [MultiplePagesType](../com.aspose.words/multiplepagestype) | 指定如何打印文档。 |
...
| [OdsoDataSourceType](../com.aspose.words/odsodatasourcetype) | 指定要连接到的外部数据源的类型，作为 ODSO 连接信息的一部分。 |
| [OdsoFieldMapData](../com.aspose.words/odsofieldmapdata) | 指定如何将外部数据源中的列映射到文档中的预定义合并字段。 |
| [OdsoFieldMapDataCollection](../com.aspose.words/odsofieldmapdatacollection) | 的类型化集合[OdsoFieldMapData](../com.aspose.words/odsofieldmapdata)对象。 |
...
| [OfficeMathDisplayType](../com.aspose.words/officemathdisplaytype) | 指定方程的显示格式类型。 |
...
| [PreferredWidthType](../com.aspose.words/preferredwidthtype) | 指定表格或单元格的首选宽度的度量单位。 |
...
| [Range](../com.aspose.words/range) | 表示文档中的连续区域。 |
| [RelativeHorizontalPosition](../com.aspose.words/relativehorizontalposition) | 指定形状或文本框的水平位置相对于什么。 |
| [RelativeVerticalPosition](../com.aspose.words/relativeverticalposition) | 指定形状或文本框的垂直位置相对于什么。 |
| [ReplaceAction](../com.aspose.words/replaceaction) | 允许用户指定在替换操作期间对当前匹配项发生的情况。 |
...
| [ReportingEngine](../com.aspose.words/reportingengine) | 提供用数据填充模板文档的例程和一组控制这些例程的设置。 |
| [ResourceLoadingAction](../com.aspose.words/resourceloadingaction) | 指定资源加载的方式。 |
...
| [RevisionCollection](../com.aspose.words/revisioncollection) | 的集合[Revision](../com.aspose.words/revision)表示文档中的修订的对象。 |
...
| [RevisionType](../com.aspose.words/revisiontype) | 指定跟踪的更改类型[Revision](../com.aspose.words/revision). |
...
| [TabStopCollection](../com.aspose.words/tabstopcollection) | 的集合[TabStop](../com.aspose.words/tabstop)代表段落或样式的自定义选项卡的对象。 |
...
| [TextColumnCollection](../com.aspose.words/textcolumncollection) | 的集合[TextColumn](../com.aspose.words/textcolumn)表示文档部分中所有文本列的对象。 |
| [TextDmlEffect](../com.aspose.words/textdmleffect) | 文本运行的 Dml 文本效果。 |
| [TextEffect](../com.aspose.words/texteffect) | 文本运行的动画效果。 |
| [TextFormFieldType](../com.aspose.words/textformfieldtype) | 指定文本表单字段的类型。 |
| [TextOrientation](../com.aspose.words/textorientation) | 指定页面上、表格单元格或文本框中文本的方向。 |
| [TextPath](../com.aspose.words/textpath) | 定义（艺术字对象的）文本路径的文本和格式。 |
| [TextPathAlignment](../com.aspose.words/textpathalignment) | 艺术字对齐。 |
| [TextWatermarkOptions](../com.aspose.words/textwatermarkoptions) | 包含在添加带有文本的水印时可以指定的选项。 |
| [TextWrapping](../com.aspose.words/textwrapping) | 指定文本环绕表格的方式。 |
...
| [ThemeColors](../com.aspose.words/themecolors) | 表示文档主题的配色方案，包含十二种颜色。 |
...
| [WebExtensionBindingType](../com.aspose.words/webextensionbindingtype) | 枚举 Web 扩展和文档中数据之间的可用绑定类型。 |
...
| [WebExtensionStoreType](../com.aspose.words/webextensionstoretype) | 枚举 Web 扩展商店的可用类型。 |
...
| [WrapType](../com.aspose.words/wraptype) | 指定文本如何环绕形状或图片。 |
