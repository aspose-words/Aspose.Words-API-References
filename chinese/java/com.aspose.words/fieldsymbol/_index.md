...
检索代码点值以十进制或十六进制指定的字符。
## 方法

| 方法 | 描述 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getCharacterCode()](#getCharacterCode--) | 获取字符的十进制或十六进制代码点值。 |
| [getClass()](#getClass--) |  |
| [getDisplayResult()](#getDisplayResult--) | 获取表示显示的字段结果的文本。 |
| [getDontAffectsLineSpacing()](#getDontAffectsLineSpacing--) | 获取字段检索到的字符是否影响段落的行间距。 |
...
| [getFontSize()](#getFontSize--) | 获取字段检索到的字符字体的大小（以磅为单位）。 |
...
| [isAnsi(boolean value)](#isAnsi-boolean-) | 设置是否将字符代码解释为 ANSI 字符的值。 |
...
| [isShiftJis(boolean value)](#isShiftJis-boolean-) | 设置是否将字符代码解释为 SHIFT-JIS 字符的值。 |
...
| [setDontAffectsLineSpacing(boolean value)](#setDontAffectsLineSpacing-boolean-) | 设置字段检索到的字符是否影响段落的行间距。 |
| [setFontName(String value)](#setFontName-java.lang.String-) | 设置字段检索到的字符的字体名称。 |
| [setFontSize(String value)](#setFontSize-java.lang.String-) | 设置字段检索到的字符字体的大小（以磅为单位）。 |
...
**退货：**
java.lang.String - 字符的十进制或十六进制代码点值。
### getClass() {#getClass--}
```
...
获取字段检索到的字符是否影响段落的行间距。

**退货：**
boolean - 字段检索到的字符是否影响段落的行间距。
### getEnd() {#getEnd--}
```
...
获取字段检索到的字符字体的大小（以磅为单位）。

**退货：**
java.lang.String - 字段检索到的字符字体的大小（以磅为单位）。
### getFormat() {#getFormat--}
```
...
设置是否将字符代码解释为 SHIFT-JIS 字符的值。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 字符代码是否解释为 SHIFT-JIS 字符的值。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 字符的十进制或十六进制代码点值。 |
...
设置字段检索到的字符是否影响段落的行间距。

**参数：**

| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | boolean | 字段检索到的字符是否影响段落的行间距。 |
