...
要了解更多信息，请访问**Working with Bookmarks**文档文章。
 ...
 Word 文档中的完整书签包括[BookmarkStart](../../com.aspose.words/bookmarkstart)和一个匹配[BookmarkEnd](../../com.aspose.words/bookmarkend)具有相同的书签名称。

[BookmarkStart](../../com.aspose.words/bookmarkstart)和[BookmarkEnd](../../com.aspose.words/bookmarkend)只是文档内的标记，用于指定书签的开始和结束位置。

使用[getBookmark()](../../com.aspose.words/bookmarkstart\#getBookmark--)类作为“外观”以将书签作为单个对象使用。
## 构造函数
...
| [getNodeType()](#getNodeType--) | 退货[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START). |
...
| name | java.lang.String | 书签名称。不能为空。 |
...
退货[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START).

**退货:**
整数 -\{[NodeType.BOOKMARK\_START](../../com.aspose.words/nodetype\#BOOKMARK-START) .返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
