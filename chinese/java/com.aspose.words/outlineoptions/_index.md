...
| [getClass()](#getClass--) |  |
| [getCreateMissingOutlineLevels()](#getCreateMissingOutlineLevels--) | 获取或设置一个值，该值确定在导出文档时是否创建缺失的大纲级别。 |
| [getCreateOutlinesForHeadingsInTables()](#getCreateOutlinesForHeadingsInTables--) | 指定是否在表内为标题（使用标题样式格式化的段落）创建大纲。 |
| [getDefaultBookmarksOutlineLevel()](#getDefaultBookmarksOutlineLevel--) | 指定文档大纲中显示 Word 书签的默认级别。 |
| [getExpandedOutlineLevels()](#getExpandedOutlineLevels--) | 指定在查看文件时文档大纲中显示展开的级别。 |
| [getHeadingsOutlineLevels()](#getHeadingsOutlineLevels--) | 指定要包含在文档大纲中的标题级别（使用标题样式格式化的段落）。 |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCreateMissingOutlineLevels(boolean value)](#setCreateMissingOutlineLevels-boolean-) | 获取或设置一个值，该值确定在导出文档时是否创建缺失的大纲级别。 |
| [setCreateOutlinesForHeadingsInTables(boolean value)](#setCreateOutlinesForHeadingsInTables-boolean-) | 指定是否在表内为标题（使用标题样式格式化的段落）创建大纲。 |
| [setDefaultBookmarksOutlineLevel(int value)](#setDefaultBookmarksOutlineLevel-int-) | 指定文档大纲中显示 Word 书签的默认级别。 |
| [setExpandedOutlineLevels(int value)](#setExpandedOutlineLevels-int-) | 指定在查看文件时文档大纲中显示展开的级别。 |
...
获取或设置一个值，该值确定在导出文档时是否创建缺失的大纲级别。
...
指定 0，Word 书签将不会显示在文档大纲中。指定1，Word书签将显示在文档大纲的第1层； 2 表示 2 级，依此类推。
...
指定在查看文件时文档大纲中显示展开的级别。

请注意，此选项在保存为 XPS 时不起作用。

指定 0 文档大纲将被折叠；指定 1，大纲中的第一级项目将展开，依此类推。
