...
```
public class 字段Template extends 字段
```
...
| [getIncludeFullPath()](#getIncludeFullPath--) | 获取是否包含完整的文件路径名。 |
...
| [setIncludeFullPath(boolean value)](#setIncludeFullPath-boolean-) | 设置是否包含完整的文件路径名。 |
