...
提供数据[IFontSavingCallback.fontSaving(com.aspose.words.FontSavingArgs)](../../com.aspose.words/ifontsavingcallback\#fontSaving-com.aspose.words.FontSavingArgs-)事件。

要了解更多信息，请访问**Save a Document**文档文章。

当 Aspose.Words 将文档保存为 HTML 或相关格式并且[HtmlSaveOptions.getExportFontResources()](../../com.aspose.words/htmlsaveoptions\#getExportFontResources--) / [HtmlSaveOptions.setExportFontResources(boolean)](../../com.aspose.words/htmlsaveoptions\#setExportFontResources-boolean-)被设定为**true**，它将每个字体主题保存到一个单独的文件中以供导出。
...
默认为 false 并且 Aspose.Words 将关闭您在**P:Aspose.Words.Saving.FontSavingArgs.FontStream**写入字体后的属性。指定 true 以保持流打开。
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 字体将保存到的文件名（不带路径）。 |
