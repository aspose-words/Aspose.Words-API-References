...
```
public class 字段Database extends 字段
```
...
| [getQuery()](#getQuery--) | 获取一组查询数据库的 SQL 指令。 |
...
| [setQuery(String value)](#setQuery-java.lang.String-) | 设置一组查询数据库的 SQL 指令。 |
| [setResult(String value)](#setResult-java.lang.String-) | 设置字段分隔符和字段结尾之间的文本。 |
| [setTableFormat(String value)](#setTableFormat-java.lang.String-) | 设置要应用于数据库查询结果的格式。 |
| [toString()](#toString--) |  |
