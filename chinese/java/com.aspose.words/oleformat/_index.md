...
使用[Shape.getOleFormat()](../../com.aspose.words/shape\#getOleFormat--)属性访问 OLE 对象的数据。您不创建的实例[OleFormat](../../com.aspose.words/oleformat)直接上课。
## 方法

| 方法 | 描述 |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [getAutoUpdate()](#getAutoUpdate--) | 指定指向 OLE 对象的链接是否在 Microsoft Word 中自动更新。 |
| [getClass()](#getClass--) |  |
| [getClsid()](#getClsid--) | 获取 OLE 对象的 CLSID。 |
| [getIconCaption()](#getIconCaption--) | 获取 OLE 对象的图标标题。 |
| [getOleControl()](#getOleControl--) | 得到[getOleControl()](../../com.aspose.words/oleformat\#getOleControl--)对象，如果此 OLE 对象是 ActiveX 控件。 |
...
| [setAutoUpdate(boolean value)](#setAutoUpdate-boolean-) | 指定指向 OLE 对象的链接是否在 Microsoft Word 中自动更新。 |
...
得到[getOleControl()](../../com.aspose.words/oleformat\#getOleControl--)对象，如果此 OLE 对象是 ActiveX 控件。否则此属性为空。

**退货：**
[OleControl](../../com.aspose.words/olecontrol) -\{[getOleControl()](../../com.aspose.words/oleformat\#getOleControl--)对象，如果此 OLE 对象是 ActiveX 控件。
### getOleEntry(String oleEntryName) {#getOleEntry-java.lang.String-}
```
...
提供访问权限[OlePackage](../../com.aspose.words/olepackage)如果 OLE 对象是 OLE 包。否则返回 null。 OLE 包是一种遗留技术，它允许将 Windows 系统的 OLE 注册表中不存在的任何文件格式包装到一个通用包中，从而允许将几乎所有内容嵌入到文档中。看[OlePackage](../../com.aspose.words/olepackage)键入以获取更多信息。
