...
| [getNodeType()](#getNodeType--) | 退货**NodeType.Row**. |
...
| [getText()](#getText--) | 获取此行中所有单元格的文本，包括行尾字符。 |
...
| [isFirstRow()](#isFirstRow--) | 如果这是表格中的第一行，则为真；否则为真。否则为假。 |
...
**退货:**
整数 -**NodeType.Row** .返回值是其中之一[NodeType](../../com.aspose.words/nodetype)常数。
