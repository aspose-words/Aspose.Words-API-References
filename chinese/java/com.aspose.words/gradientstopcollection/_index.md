...
您不直接创建此类的实例。使用[Fill.getGradientStops()](../../com.aspose.words/fill\#getGradientStops--)属性以访问填充对象的渐变停止点。
## 方法

| 方法 | 描述 |
| --- | --- |
| [add(GradientStop gradientStop)](#add-com.aspose.words.GradientStop-) | 添加一个指定的[GradientStop](../../com.aspose.words/gradientstop)到一个梯度。 |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [get(int index)](#get-int-) | 得到一个[GradientStop](../../com.aspose.words/gradientstop)集合中的对象。 |
| [getClass()](#getClass--) |  |
| [getCount()](#getCount--) | 获取一个整数值，该值指示集合中的项数。 |
| [hashCode()](#hashCode--) |  |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [remove(GradientStop gradientStop)](#remove-com.aspose.words.GradientStop-) | 删除指定的[GradientStop](../../com.aspose.words/gradientstop)从集合中。 |
...
添加一个指定的[GradientStop](../../com.aspose.words/gradientstop)到一个梯度。
...
删除指定的[GradientStop](../../com.aspose.words/gradientstop)从集合中。
...
**退货：**
boolean - 如果梯度停止被成功移除则为 True，否则为 false。
...
**退货：**
[GradientStop](../../com.aspose.words/gradientstop) - 删除[GradientStop](../../com.aspose.words/gradientstop).
