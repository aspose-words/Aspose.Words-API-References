...
type: docs
weight: 259
url: /zh/java/com.aspose.words/fielduseraddress/
---

**遗产:**
java.lang.Object, [com.aspose.words.字段](../../com.aspose.words/field)
```
public class 字段UserAddress extends 字段
```
...
| [getUserAddress()](#getUserAddress--) | 获取当前用户的邮寄地址。 |
| [hashCode()](#hashCode--) |  |
...
| [setUserAddress(String value)](#setUserAddress-java.lang.String-) | 设置当前用户的邮寄地址。 |
| [toString()](#toString--) |  |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 当前用户的邮寄地址。 |
