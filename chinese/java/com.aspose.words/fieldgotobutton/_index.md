...
```
public class 字段GoToButton extends 字段
```
...
| [getDisplayText()](#getDisplayText--) | 获取文档中出现的“按钮”的文本，以便可以选择它来激活跳转。 |
...
| [getLocation()](#getLocation--) | 获取书签的名称、页码或其他要跳转的项目。 |
...
| [setLocation(String value)](#setLocation-java.lang.String-) | 设置书签的名称、页码或其他要跳转的项目。 |
...
获取文档中出现的“按钮”的文本，以便可以选择它来激活跳转。

**退货:**
java.lang.String - 出现在文档中的“按钮”的文本，可以选择它来激活跳转。
### getEnd() {#getEnd--}
```
public 字段End getEnd()
```
...
**退货:**
java.lang.String - 书签的名称、页码或其他要跳转的项目。
### getResult() {#getResult--}
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 出现在文档中的“按钮”的文本，可以选择它来激活跳转。 |
