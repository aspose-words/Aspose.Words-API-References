...
插入一个跳转命令，这样当它被激活时，文档的插入点被移动到指定的位置。
## 方法
...
| [getDisplayText()](#getDisplayText--) | 获取出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。 |
...
| [getLocation()](#getLocation--) | 获取书签的名称、页码或其他要跳转到的项目。 |
...
| [setDisplayText(String value)](#setDisplayText-java.lang.String-) | 设置出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。 |
| [setLocaleId(int value)](#setLocaleId-int-) | 设置字段的 LCID。 |
| [setLocation(String value)](#setLocation-java.lang.String-) | 设置书签名称、页码或其他要跳转到的项目。 |
...
获取出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。

**退货:**
java.lang.String - 出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。
### getEnd() {#getEnd--}
```
...
获取书签的名称、页码或其他要跳转到的项目。

**退货:**
java.lang.String - 书签名称、页码或其他要跳转到的项目。
### getResult() {#getResult--}
```
...
设置出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。

**参数:**
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 出现在文档中的“按钮”的文本，以便可以选择它来激活跳转。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| value | java.lang.String | 书签的名称、页码或其他要跳转到的项目。 |
