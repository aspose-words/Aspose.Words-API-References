...
| [getRecognizeUtf8Text()](#getRecognizeUtf8Text--) | 当设置为真时，**T:Aspose.Charset.CharsetDetector**将尝试检测 UTF8 字符，它们将在导入过程中被保留。 |
...
| [setRecognizeUtf8Text(boolean value)](#setRecognizeUtf8Text-boolean-) | 当设置为真时，**T:Aspose.Charset.CharsetDetector**将尝试检测 UTF8 字符，它们将在导入过程中被保留。 |
...
当设置为真时，**T:Aspose.Charset.CharsetDetector**将尝试检测 UTF8 字符，它们将在导入过程中被保留。
