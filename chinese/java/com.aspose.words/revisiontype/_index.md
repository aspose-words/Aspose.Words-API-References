...
| [INSERTION](#INSERTION) | 新内容被插入到文档中。 |
...
| [fromName(String revision类型Name)](#fromName-java.lang.String-) |  |
| [get班级()](#get班级--) |  |
| [getName(int revision类型)](#getName-int-) |  |
| [getValues()](#getValues--) |  |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [toString()](#toString--) |  |
| [toString(int revision类型)](#toString-int-) |  |
| [wait()](#wait--) |  |
...
### fromName(String revision类型Name) {#fromName-java.lang.String-}
```
public static int fromName(String revision类型Name)
```
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| revision类型Name | java.lang.String |  |
...
### getName(int revision类型) {#getName-int-}
```
public static String getName(int revision类型)
```
...
### toString(int revision类型) {#toString-int-}
```
public static String toString(int revision类型)
```
